...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "vue-template-compiler" % "2.6.11-ac629f",
  "org.scalablytyped.japgolly" %%% "vue__component-compiler-utils" % "3.1.1-6b810f",
