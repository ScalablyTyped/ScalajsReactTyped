package typingsJapgolly.validateNpmPackageName

import typingsJapgolly.validateNpmPackageName.validateNpmPackageNameBooleans.`false`
import typingsJapgolly.validateNpmPackageName.validateNpmPackageNameBooleans.`true`
