package typingsJapgolly.validatorjs
...
object mod extends Shortcut {
  ...
  object Errors {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(add = js.Any.fromFunction2((t0: String, t1: String) => (add(t0, t1)).runNow()), all = all.toJsFn, errors = errors.asInstanceOf[js.Any], first = js.Any.fromFunction1(first), get = js.Any.fromFunction1(get), has = js.Any.fromFunction1(has))
    ...
    extension [Self <: Errors](x: Self) {
      ...
      inline def setAll(value: CallbackTo[ValidationErrors]): Self = StObject.set(x, "all", value.toJsFn)
