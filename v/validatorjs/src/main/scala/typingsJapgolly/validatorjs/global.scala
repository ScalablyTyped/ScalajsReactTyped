...
import typingsJapgolly.validatorjs.mod.ErrorMessages
import typingsJapgolly.validatorjs.mod.Rules
import typingsJapgolly.validatorjs.mod.ValidatorStatic
...
object global {
  ...
  object Validator extends Shortcut {
    ...
    open class ^[A] protected ()
      extends StObject
         with typingsJapgolly.validatorjs.mod.Validator[A] {
