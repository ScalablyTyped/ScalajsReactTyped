...
import typingsJapgolly.vanillaSwipe.vanillaSwipeInts.`0`
import typingsJapgolly.vanillaSwipe.vanillaSwipeInts.`10`
...
object libTypesMod {
  ...
  object ConstructorProps {
    ...
    extension [Self <: ConstructorProps](x: Self) {
      ...
      inline def setOnSwipeStart(value: (/* e */ Event, /* data */ EventData) => Callback): Self = StObject.set(x, "onSwipeStart", js.Any.fromFunction2((t0: /* e */ Event, t1: /* data */ EventData) => (value(t0, t1)).runNow()))
      
      inline def setOnSwipeStartUndefined: Self = StObject.set(x, "onSwipeStart", js.undefined)
      
      inline def setOnSwiped(value: (/* e */ Event, /* data */ EventData) => Callback): Self = StObject.set(x, "onSwiped", js.Any.fromFunction2((t0: /* e */ Event, t1: /* data */ EventData) => (value(t0, t1)).runNow()))
      
      inline def setOnSwipedUndefined: Self = StObject.set(x, "onSwiped", js.undefined)
      
      inline def setOnSwiping(value: (/* e */ Event, /* data */ EventData) => Callback): Self = StObject.set(x, "onSwiping", js.Any.fromFunction2((t0: /* e */ Event, t1: /* data */ EventData) => (value(t0, t1)).runNow()))
      
      inline def setOnSwipingUndefined: Self = StObject.set(x, "onSwiping", js.undefined)
      
      inline def setOnTap(value: (/* e */ Event, /* data */ EventData) => Callback): Self = StObject.set(x, "onTap", js.Any.fromFunction2((t0: /* e */ Event, t1: /* data */ EventData) => (value(t0, t1)).runNow()))
