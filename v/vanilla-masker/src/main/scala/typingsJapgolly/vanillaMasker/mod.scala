...
import typingsJapgolly.vanillaMasker.anon.MaskAlphaNum
...
object mod {
  ...
  inline def apply(el: NodeList[Element & Node]): MaskAlphaNum = ^.asInstanceOf[js.Dynamic].apply(el.asInstanceOf[js.Any]).asInstanceOf[MaskAlphaNum]
