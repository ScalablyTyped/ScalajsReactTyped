...
trait StyleHTMLAttributes
  ...
  var scoped: js.UndefOr[Booleanish] = js.undefined
...
object StyleHTMLAttributes {
  ...
  extension [Self <: StyleHTMLAttributes](x: Self) {
    ...
    inline def setScoped(value: Booleanish): Self = StObject.set(x, "scoped", value.asInstanceOf[js.Any])
