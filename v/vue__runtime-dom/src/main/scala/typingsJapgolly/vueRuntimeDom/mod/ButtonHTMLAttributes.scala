...
import typingsJapgolly.vueRuntimeDom.vueRuntimeDomStrings.button
import typingsJapgolly.vueRuntimeDom.vueRuntimeDomStrings.reset
import typingsJapgolly.vueRuntimeDom.vueRuntimeDomStrings.submit
