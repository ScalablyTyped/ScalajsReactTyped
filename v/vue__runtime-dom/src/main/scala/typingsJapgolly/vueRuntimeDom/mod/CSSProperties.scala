...
/* v */ StringDictionary[js.UndefOr[String | Double]]
  ...
  /**
    ...
    * @deprecated
    */
  var `-o-transition`: js.UndefOr[typingsJapgolly.csstype.mod.Property.Transition[String]] = js.undefined
...
object CSSProperties {
  ...
  extension [Self <: CSSProperties](x: Self) {
    ...
    inline def `set-o-transition`(value: typingsJapgolly.csstype.mod.Property.Transition[String]): Self = StObject.set(x, "-o-transition", value.asInstanceOf[js.Any])
