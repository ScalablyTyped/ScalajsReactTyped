...
trait WebViewHTMLAttributes
  ...
  var allowpopups: js.UndefOr[Booleanish] = js.undefined
  
  var autoFocus: js.UndefOr[Booleanish] = js.undefined
  
  var autosize: js.UndefOr[Booleanish] = js.undefined
  
  var blinkfeatures: js.UndefOr[String] = js.undefined
  
  var disableblinkfeatures: js.UndefOr[String] = js.undefined
  
  var disableguestresize: js.UndefOr[Booleanish] = js.undefined
  
  var disablewebsecurity: js.UndefOr[Booleanish] = js.undefined
  
  var guestinstance: js.UndefOr[String] = js.undefined
  
  var httpreferrer: js.UndefOr[String] = js.undefined
  
  var nodeintegration: js.UndefOr[Booleanish] = js.undefined
  
  var partition: js.UndefOr[String] = js.undefined
  
  var plugins: js.UndefOr[Booleanish] = js.undefined
...
object WebViewHTMLAttributes {
  ...
  extension [Self <: WebViewHTMLAttributes](x: Self) {
    ...
    inline def setAllowpopups(value: Booleanish): Self = StObject.set(x, "allowpopups", value.asInstanceOf[js.Any])
    ...
    inline def setAutosize(value: Booleanish): Self = StObject.set(x, "autosize", value.asInstanceOf[js.Any])
    ...
    inline def setDisableguestresize(value: Booleanish): Self = StObject.set(x, "disableguestresize", value.asInstanceOf[js.Any])
    
    inline def setDisableguestresizeUndefined: Self = StObject.set(x, "disableguestresize", js.undefined)
    
    inline def setDisablewebsecurity(value: Booleanish): Self = StObject.set(x, "disablewebsecurity", value.asInstanceOf[js.Any])
    ...
    inline def setNodeintegration(value: Booleanish): Self = StObject.set(x, "nodeintegration", value.asInstanceOf[js.Any])
    ...
    inline def setPlugins(value: Booleanish): Self = StObject.set(x, "plugins", value.asInstanceOf[js.Any])
