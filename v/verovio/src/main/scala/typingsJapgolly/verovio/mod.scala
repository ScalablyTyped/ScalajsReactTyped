...
import typingsJapgolly.verovio.anon.Notes
import typingsJapgolly.verovio.anon.RealTimeOffsetMilliseconds
import typingsJapgolly.verovio.availableOptionsMod.AvailableOptions
import typingsJapgolly.verovio.editorActionMod.EditorAction
import typingsJapgolly.verovio.verovioOptionsMod.VerovioOptions
...
object mod {
  ...
  object VerovioModule {
    ...
    inline def apply(
      FS_createDataFile: (String, String, String, Boolean, Boolean, Boolean) => Callback,
      FS_unlink: String => Callback,
      onRuntimeInitialized: Callback
    ): VerovioModule = {
      val __obj = js.Dynamic.literal(FS_createDataFile = js.Any.fromFunction6((t0: String, t1: String, t2: String, t3: Boolean, t4: Boolean, t5: Boolean) => (FS_createDataFile(t0, t1, t2, t3, t4, t5)).runNow()), FS_unlink = js.Any.fromFunction1((t0: String) => FS_unlink(t0).runNow()), onRuntimeInitialized = onRuntimeInitialized.toJsFn)
      __obj.asInstanceOf[VerovioModule]
    }
    
    extension [Self <: VerovioModule](x: Self) {
      
      inline def setFS_createDataFile(value: (String, String, String, Boolean, Boolean, Boolean) => Callback): Self = StObject.set(x, "FS_createDataFile", js.Any.fromFunction6((t0: String, t1: String, t2: String, t3: Boolean, t4: Boolean, t5: Boolean) => (value(t0, t1, t2, t3, t4, t5)).runNow()))
      
      inline def setFS_unlink(value: String => Callback): Self = StObject.set(x, "FS_unlink", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
