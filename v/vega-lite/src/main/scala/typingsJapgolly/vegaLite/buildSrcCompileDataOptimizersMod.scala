...
import typingsJapgolly.vegaLite.buildSrcCompileDataOptimizerMod.BottomUpOptimizer
import typingsJapgolly.vegaLite.buildSrcCompileDataOptimizerMod.Optimizer
import typingsJapgolly.vegaLite.buildSrcCompileDataOptimizerMod.TopDownOptimizer
