...
import typingsJapgolly.vegaLite.anon.PartialAxisComponentProps
...
object buildSrcCompileAxisComponentMod {
  ...
  val AXIS_COMPONENT_PROPERTIES: js.Array[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 81, starting with typingsJapgolly.vegaLite.vegaLiteStrings.values, typingsJapgolly.vegaLite.vegaLiteStrings.offset, typingsJapgolly.vegaLite.vegaLiteStrings.grid */ Any
  ] = js.native
