...
import typingsJapgolly.vegaLite.anon.Escape
...
import typingsJapgolly.vegaLite.buildSrcCompileSelectionProjectMod.SelectionProjection
import typingsJapgolly.vegaLite.buildSrcCompileSelectionProjectMod.SelectionProjectionComponent
...
import typingsJapgolly.vegaLite.buildSrcSelectionMod.BrushConfig
...
import typingsJapgolly.vegaLite.vegaLiteStrings.scales
...
object buildSrcCompileSelectionMod {
  ...
  object SelectionCompiler {
    ...
    extension [Self <: SelectionCompiler[?], T /* <: SelectionType */](x: Self & SelectionCompiler[T]) {
      ...
      inline def setParse(
        value: (/* model */ UnitModel, /* selCmpt */ SelectionComponent[T], /* def */ SelectionParameter[T]) => Callback
      ): Self = StObject.set(x, "parse", js.Any.fromFunction3((t0: /* model */ UnitModel, t1: /* selCmpt */ SelectionComponent[T], t2: /* def */ SelectionParameter[T]) => (value(t0, t1, t2)).runNow()))
