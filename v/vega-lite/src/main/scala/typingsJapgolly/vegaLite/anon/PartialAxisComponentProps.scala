...
trait PartialAxisComponentProps extends StObject {
  ...
  var formatType: js.UndefOr[typingsJapgolly.vegaTypings.typesSpecAxisMod.FormatType | SignalRef] = js.undefined
  ...
  var title: js.UndefOr[
    Text | (js.Array[FieldDefBase[String, typingsJapgolly.vegaLite.buildSrcBinMod.Bin]]) | SignalRef
  ] = js.undefined
...
object PartialAxisComponentProps {
  ...
  extension [Self <: PartialAxisComponentProps](x: Self) {
    ...
    inline def setFormatType(value: typingsJapgolly.vegaTypings.typesSpecAxisMod.FormatType | SignalRef): Self = StObject.set(x, "formatType", value.asInstanceOf[js.Any])
    ...
    inline def setTitle(
      value: Text | (js.Array[FieldDefBase[String, typingsJapgolly.vegaLite.buildSrcBinMod.Bin]]) | SignalRef
    ...
    inline def setTitleVarargs(value: ((FieldDefBase[String, typingsJapgolly.vegaLite.buildSrcBinMod.Bin]) | String)*): Self = StObject.set(x, "title", js.Array(value*))
