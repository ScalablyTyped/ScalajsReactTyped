...
trait ClipHeight extends StObject {
  ...
  var formatType: js.UndefOr[SignalRef | typingsJapgolly.vegaTypings.typesSpecAxisMod.FormatType] = js.undefined
...
object ClipHeight {
  ...
  extension [Self <: ClipHeight](x: Self) {
    ...
    inline def setFormatType(value: SignalRef | typingsJapgolly.vegaTypings.typesSpecAxisMod.FormatType): Self = StObject.set(x, "formatType", value.asInstanceOf[js.Any])
