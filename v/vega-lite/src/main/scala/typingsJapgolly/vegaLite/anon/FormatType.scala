...
trait FormatType extends StObject {
  ...
  var labelOrient: typingsJapgolly.vegaTypings.typesSpecEncodeMod.Orient
  ...
  var titleOrient: typingsJapgolly.vegaTypings.typesSpecEncodeMod.Orient
...
object FormatType {
  ...
  inline def apply(
    labelOrient: typingsJapgolly.vegaTypings.typesSpecEncodeMod.Orient,
    titleOrient: typingsJapgolly.vegaTypings.typesSpecEncodeMod.Orient
  ): FormatType = {
  ...
  extension [Self <: FormatType](x: Self) {
    ...
    inline def setLabelOrient(value: typingsJapgolly.vegaTypings.typesSpecEncodeMod.Orient): Self = StObject.set(x, "labelOrient", value.asInstanceOf[js.Any])
    ...
    inline def setTitleOrient(value: typingsJapgolly.vegaTypings.typesSpecEncodeMod.Orient): Self = StObject.set(x, "titleOrient", value.asInstanceOf[js.Any])
