...
trait CornerRadiusBottomLeft extends StObject {
...
object CornerRadiusBottomLeft {
  
  inline def apply(ariaRoleDescription: `3`, description: SignalRef | ValueString): CornerRadiusBottomLeft = {
    ...
    __obj.asInstanceOf[CornerRadiusBottomLeft]
  }
  
  extension [Self <: CornerRadiusBottomLeft](x: Self) {
