...
trait PartialVgTitle extends StObject {
  ...
  var encode: js.UndefOr[
    TitleEncode | typingsJapgolly.vegaTypings.typesSpecEncodeMod.Encode[TextEncodeEntry]
  ] = js.undefined
...
object PartialVgTitle {
  ...
  extension [Self <: PartialVgTitle](x: Self) {
    ...
    inline def setEncode(value: TitleEncode | typingsJapgolly.vegaTypings.typesSpecEncodeMod.Encode[TextEncodeEntry]): Self = StObject.set(x, "encode", value.asInstanceOf[js.Any])
