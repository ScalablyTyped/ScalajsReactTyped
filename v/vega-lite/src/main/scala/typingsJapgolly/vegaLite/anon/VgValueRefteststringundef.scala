...
trait VgValueRefteststringundef extends StObject {
  ...
  var value: js.UndefOr[typingsJapgolly.vegaLite.buildSrcChanneldefMod.Value[scala.Nothing]] = js.undefined
}
object VgValueRefteststringundef {
  ...
  extension [Self <: VgValueRefteststringundef](x: Self) {
    ...
    inline def setValue(value: typingsJapgolly.vegaLite.buildSrcChanneldefMod.Value[scala.Nothing]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
