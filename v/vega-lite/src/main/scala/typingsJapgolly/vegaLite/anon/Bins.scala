...
import typingsJapgolly.vegaLite.buildSrcTransformMod.TimeUnitTransform
...
trait Bins extends StObject {
  ...
  var encoding: typingsJapgolly.vegaLite.buildSrcEncodingMod.Encoding[String]
...
object Bins {
  ...
  inline def apply(
    ...
    encoding: typingsJapgolly.vegaLite.buildSrcEncodingMod.Encoding[String],
