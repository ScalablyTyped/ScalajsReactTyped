...
trait BandPosition extends StObject {
  ...
  /**
    ...
    */
  var aggregate: js.UndefOr[typingsJapgolly.vegaLite.buildSrcAggregateMod.Aggregate | CompositeAggregate] = js.undefined
  ...
  /**
    ...
    */
  var timeUnit: js.UndefOr[typingsJapgolly.vegaLite.buildSrcTimeunitMod.TimeUnit | TimeUnitParams] = js.undefined
...
object BandPosition {
  ...
  inline def apply(sort: Encoding): BandPosition = {
  ...
  extension [Self <: BandPosition](x: Self) {
    ...
    inline def setAggregate(value: typingsJapgolly.vegaLite.buildSrcAggregateMod.Aggregate | CompositeAggregate): Self = StObject.set(x, "aggregate", value.asInstanceOf[js.Any])
