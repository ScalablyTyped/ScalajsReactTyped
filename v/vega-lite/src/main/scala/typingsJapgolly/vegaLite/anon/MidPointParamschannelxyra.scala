...
trait MidPointParamschannelxyra extends StObject {
  ...
  var channel: typingsJapgolly.vegaLite.buildSrcChannelMod.Channel & (x | y | radius | theta)
...
object MidPointParamschannelxyra {
  ...
  inline def apply(
    channel: typingsJapgolly.vegaLite.buildSrcChannelMod.Channel & (x | y | radius | theta),
  ...
  extension [Self <: MidPointParamschannelxyra](x: Self) {
    ...
    inline def setChannel(
      value: typingsJapgolly.vegaLite.buildSrcChannelMod.Channel & (typingsJapgolly.vegaLite.vegaLiteStrings.x | y | radius | theta)
