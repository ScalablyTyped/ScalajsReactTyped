...
import typingsJapgolly.vegaLite.buildSrcSpecToplevelMod.Datasets
...
import typingsJapgolly.vegaLite.buildSrcSpecUnitMod.TopLevelUnitSpec
import typingsJapgolly.vegaLite.buildSrcSpecUnitMod.UnitSpec
import typingsJapgolly.vegaLite.buildSrcSpecUnitMod.UnitSpecWithFrame
...
object buildSrcSpecMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaLite.buildSrcSpecUnitMod.TopLevelUnitSpec[typingsJapgolly.vegaLite.buildSrcChanneldefMod.Field]
    - typingsJapgolly.vegaLite.buildSrcSpecMod.TopLevelFacetSpec
    - typingsJapgolly.vegaLite.anon.TopLevelLayerSpecField
    - typingsJapgolly.vegaLite.buildSrcSpecToplevelMod.TopLevel[typingsJapgolly.vegaLite.buildSrcSpecRepeatMod.RepeatSpec]
    - typingsJapgolly.vegaLite.anon.TopLevelGenericConcatSpec
    - typingsJapgolly.vegaLite.anon.TopLevelGenericVConcatSpe
    - typingsJapgolly.vegaLite.anon.TopLevelGenericHConcatSpe
  */
  ...
  object _TopLevelSpec {
    ...
    inline def TopLevelFacetSpec(
      ...
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], facet = facet.asInstanceOf[js.Any], spec = spec.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.buildSrcSpecMod.TopLevelFacetSpec]
    }
    
    inline def TopLevelGenericConcatSpec(concat: js.Array[NonNormalizedSpec]): typingsJapgolly.vegaLite.anon.TopLevelGenericConcatSpec = {
      val __obj = js.Dynamic.literal(concat = concat.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.anon.TopLevelGenericConcatSpec]
    }
    
    inline def TopLevelGenericHConcatSpe(hconcat: js.Array[NonNormalizedSpec]): typingsJapgolly.vegaLite.anon.TopLevelGenericHConcatSpe = {
      val __obj = js.Dynamic.literal(hconcat = hconcat.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.anon.TopLevelGenericHConcatSpe]
    }
    
    inline def TopLevelGenericVConcatSpe(vconcat: js.Array[NonNormalizedSpec]): typingsJapgolly.vegaLite.anon.TopLevelGenericVConcatSpe = {
      val __obj = js.Dynamic.literal(vconcat = vconcat.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.anon.TopLevelGenericVConcatSpe]
    }
    
    inline def TopLevelLayerSpecField(layer: js.Array[LayerSpec[Field] | UnitSpec[Field]]): typingsJapgolly.vegaLite.anon.TopLevelLayerSpecField = {
      val __obj = js.Dynamic.literal(layer = layer.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.anon.TopLevelLayerSpecField]
    }
  }
}
