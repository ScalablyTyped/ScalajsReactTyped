...
import typingsJapgolly.vegaLite.buildSrcChanneldefMod.ConditionValueDefMixins
...
object buildSrcGuideMod {
  ...
  val VL_ONLY_LEGEND_CONFIG: js.Array[
    /* keyof vega-lite.vega-lite/build/src/legend.LegendConfig<any> */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 75, starting with typingsJapgolly.vegaLite.vegaLiteStrings.labelOverlap, typingsJapgolly.vegaLite.vegaLiteStrings.direction, typingsJapgolly.vegaLite.vegaLiteStrings.orient */ Any
  ] = js.native
