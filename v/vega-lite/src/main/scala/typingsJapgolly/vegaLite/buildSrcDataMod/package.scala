...
import typingsJapgolly.vegaLite.buildSrcDataMod.^
...
/* Rewritten from type alias, can be one of: 
  - scala.Null
  - java.lang.String
  - typingsJapgolly.vegaLite.vegaLiteStrings.string
  - typingsJapgolly.vegaLite.vegaLiteStrings.boolean
  - typingsJapgolly.vegaLite.vegaLiteStrings.date
  - typingsJapgolly.vegaLite.vegaLiteStrings.number
*/
