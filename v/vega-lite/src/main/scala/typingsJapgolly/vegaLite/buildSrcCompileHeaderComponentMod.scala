...
object buildSrcCompileHeaderComponentMod {
  ...
  */
  ...
  object HeaderChannel {
    ...
    inline def column: typingsJapgolly.vegaLite.vegaLiteStrings.column = "column".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.column]
    
    inline def row: typingsJapgolly.vegaLite.vegaLiteStrings.row = "row".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.row]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaLite.vegaLiteStrings.header
    - typingsJapgolly.vegaLite.vegaLiteStrings.footer
  */
  trait HeaderType extends StObject
  object HeaderType {
    
    inline def footer: typingsJapgolly.vegaLite.vegaLiteStrings.footer = "footer".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.footer]
    
    inline def header: typingsJapgolly.vegaLite.vegaLiteStrings.header = "header".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.header]
  }
