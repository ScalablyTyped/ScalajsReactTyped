...
import typingsJapgolly.vegaLite.anon.ChannelLegend
import typingsJapgolly.vegaLite.anon.Direction
import typingsJapgolly.vegaLite.anon.Legend
...
import typingsJapgolly.vegaLite.buildSrcChanneldefMod.MarkPropFieldOrDatumDef
...
import typingsJapgolly.vegaLite.vegaLiteStrings.horizontal
...
import typingsJapgolly.vegaTypings.typesSpecEncodeMod.SymbolShape
...
import typingsJapgolly.vegaTypings.typesSpecLegendMod.LegendEncode
...
object buildSrcCompileLegendPropertiesMod {
  ...
  inline def defaultType(hasChannelTimeUnitScaleType: typingsJapgolly.vegaLite.anon.ScaleType): LegendType = ^.asInstanceOf[js.Dynamic].applyDynamic("defaultType")(hasChannelTimeUnitScaleType.asInstanceOf[js.Any]).asInstanceOf[LegendType]
