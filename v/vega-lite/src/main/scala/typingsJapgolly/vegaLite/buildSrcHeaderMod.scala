...
import typingsJapgolly.vegaLite.buildSrcGuideMod.VlOnlyGuideConfig
import typingsJapgolly.vegaLite.vegaLiteStrings.align
import typingsJapgolly.vegaLite.vegaLiteStrings.anchor
...
import typingsJapgolly.vegaLite.vegaLiteStrings.frame
import typingsJapgolly.vegaLite.vegaLiteStrings.header
import typingsJapgolly.vegaLite.vegaLiteStrings.headerColumn
import typingsJapgolly.vegaLite.vegaLiteStrings.headerFacet
import typingsJapgolly.vegaLite.vegaLiteStrings.headerRow
...
import typingsJapgolly.vegaLite.vegaLiteStrings.subtitleColor
import typingsJapgolly.vegaLite.vegaLiteStrings.subtitleFont
import typingsJapgolly.vegaLite.vegaLiteStrings.subtitleFontSize
import typingsJapgolly.vegaLite.vegaLiteStrings.subtitleFontStyle
import typingsJapgolly.vegaLite.vegaLiteStrings.subtitleFontWeight
import typingsJapgolly.vegaLite.vegaLiteStrings.subtitleLineHeight
import typingsJapgolly.vegaLite.vegaLiteStrings.subtitlePadding
...
object buildSrcHeaderMod {
  ...
  object HEADER_LABEL_PROPERTIES_MAP {
    ...
    def orient: js.UndefOr[
        subtitleFont | fontWeight | lineHeight | color | dx | anchor | aria | offset | subtitlePadding | fontStyle | limit | typingsJapgolly.vegaLite.vegaLiteStrings.orient | font | subtitleFontStyle | fontSize | baseline | angle | subtitleFontWeight | subtitleColor | zindex | frame | dy | subtitleFontSize | subtitleLineHeight | align
      ] = js.native
    inline def orient_=(
      x: js.UndefOr[
          subtitleFont | fontWeight | lineHeight | color | dx | anchor | aria | offset | subtitlePadding | fontStyle | limit | orient | font | subtitleFontStyle | fontSize | baseline | angle | subtitleFontWeight | subtitleColor | zindex | frame | dy | subtitleFontSize | subtitleLineHeight | align
  ...
  - typingsJapgolly.vegaLite.buildSrcChanneldefMod.FormatMixins because Already inherited
  - typingsJapgolly.vegaLite.buildSrcGuideMod.Guide because var conflicts: format, formatType. Inlined  */ trait Header[ES /* <: ExprRef | SignalRef */]
    extends StObject
       with CoreHeader[ES]
       with TitleMixins
  object Header {
