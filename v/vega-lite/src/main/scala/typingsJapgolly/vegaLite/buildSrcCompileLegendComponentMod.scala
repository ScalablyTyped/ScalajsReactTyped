...
object buildSrcCompileLegendComponentMod {
  ...
  val LEGEND_COMPONENT_PROPERTIES: js.Array[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 76, starting with typingsJapgolly.vegaLite.vegaLiteStrings.labelExpr, typingsJapgolly.vegaLite.vegaLiteStrings.disable, typingsJapgolly.vegaLite.vegaLiteStrings.size */ Any
  ] = js.native
