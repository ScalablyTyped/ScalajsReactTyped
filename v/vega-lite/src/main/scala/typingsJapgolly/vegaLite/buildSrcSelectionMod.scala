...
object buildSrcSelectionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.vegaLite.buildSrcSelectionMod.LegendStreamBinding
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaLite.anon.Param
    - typingsJapgolly.vegaLite.anon.EncodingParam
  */
  ...
  object ParameterExtent {
    ...
    inline def EncodingParam(param: ParameterName): typingsJapgolly.vegaLite.anon.EncodingParam = {
      val __obj = js.Dynamic.literal(param = param.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.anon.EncodingParam]
    }
    
    inline def Param(param: ParameterName): typingsJapgolly.vegaLite.anon.Param = {
      val __obj = js.Dynamic.literal(param = param.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.anon.Param]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaLite.vegaLiteStrings.global
    - typingsJapgolly.vegaLite.vegaLiteStrings.union
    - typingsJapgolly.vegaLite.vegaLiteStrings.intersect
  */
  trait SelectionResolution extends StObject
  object SelectionResolution {
    
    inline def global: typingsJapgolly.vegaLite.vegaLiteStrings.global = "global".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.global]
    
    inline def intersect: typingsJapgolly.vegaLite.vegaLiteStrings.intersect = "intersect".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.intersect]
    
    inline def union: typingsJapgolly.vegaLite.vegaLiteStrings.union = "union".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.union]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaLite.vegaLiteStrings.point
    - typingsJapgolly.vegaLite.vegaLiteStrings.interval
  */
  trait SelectionType extends StObject
  object SelectionType {
    
    inline def interval: typingsJapgolly.vegaLite.vegaLiteStrings.interval = "interval".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.interval]
    
    inline def point: typingsJapgolly.vegaLite.vegaLiteStrings.point = "point".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.point]
  }
