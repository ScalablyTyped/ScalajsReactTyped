...
import typingsJapgolly.vegaLite.buildSrcSpecBaseMod.ResolveMixins
...
object buildSrcSpecRepeatMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaLite.buildSrcSpecRepeatMod.NonLayerRepeatSpec
    - typingsJapgolly.vegaLite.buildSrcSpecRepeatMod.LayerRepeatSpec
  */
  trait RepeatSpec extends StObject
  object RepeatSpec {
    
    inline def LayerRepeatSpec(repeat: LayerRepeatMapping, spec: LayerSpec[Field] | UnitSpec[Field]): typingsJapgolly.vegaLite.buildSrcSpecRepeatMod.LayerRepeatSpec = {
      val __obj = js.Dynamic.literal(repeat = repeat.asInstanceOf[js.Any], spec = spec.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.buildSrcSpecRepeatMod.LayerRepeatSpec]
    }
    
    inline def NonLayerRepeatSpec(repeat: js.Array[String] | RepeatMapping, spec: NonNormalizedSpec): typingsJapgolly.vegaLite.buildSrcSpecRepeatMod.NonLayerRepeatSpec = {
      val __obj = js.Dynamic.literal(repeat = repeat.asInstanceOf[js.Any], spec = spec.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.buildSrcSpecRepeatMod.NonLayerRepeatSpec]
    }
  }
}
