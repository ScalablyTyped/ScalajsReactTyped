...
object buildSrcResolveMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaLite.vegaLiteStrings.independent
    - typingsJapgolly.vegaLite.vegaLiteStrings.shared
  */
  trait ResolveMode extends StObject
  object ResolveMode {
    
    inline def independent: typingsJapgolly.vegaLite.vegaLiteStrings.independent = "independent".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.independent]
    
    inline def shared: typingsJapgolly.vegaLite.vegaLiteStrings.shared = "shared".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.shared]
  }
