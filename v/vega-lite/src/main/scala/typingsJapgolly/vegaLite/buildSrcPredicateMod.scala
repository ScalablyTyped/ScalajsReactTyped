...
object buildSrcPredicateMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldEqualPredicate
    - typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldLTPredicate
    - typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldGTPredicate
    - typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldLTEPredicate
    - typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldGTEPredicate
    - typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldRangePredicate
    - typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldOneOfPredicate
    - typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldValidPredicate_
  */
  trait FieldPredicate extends StObject
  object FieldPredicate {
    
    inline def FieldEqualPredicate(equal: String | Double | Boolean | DateTime | ExprRef | SignalRef, field: FieldName): typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldEqualPredicate = {
      val __obj = js.Dynamic.literal(equal = equal.asInstanceOf[js.Any], field = field.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldEqualPredicate]
    }
    
    inline def FieldGTEPredicate(field: FieldName, gte: String | Double | DateTime | ExprRef | SignalRef): typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldGTEPredicate = {
      val __obj = js.Dynamic.literal(field = field.asInstanceOf[js.Any], gte = gte.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldGTEPredicate]
    }
    
    inline def FieldGTPredicate(field: FieldName, gt: String | Double | DateTime | ExprRef | SignalRef): typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldGTPredicate = {
      val __obj = js.Dynamic.literal(field = field.asInstanceOf[js.Any], gt = gt.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldGTPredicate]
    }
    
    inline def FieldLTEPredicate(field: FieldName, lte: String | Double | DateTime | ExprRef | SignalRef): typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldLTEPredicate = {
      val __obj = js.Dynamic.literal(field = field.asInstanceOf[js.Any], lte = lte.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldLTEPredicate]
    }
    
    inline def FieldLTPredicate(field: FieldName, lt: String | Double | DateTime | ExprRef | SignalRef): typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldLTPredicate = {
      val __obj = js.Dynamic.literal(field = field.asInstanceOf[js.Any], lt = lt.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldLTPredicate]
    }
    
    inline def FieldOneOfPredicate(field: FieldName, oneOf: js.Array[Boolean | DateTime | Double | String]): typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldOneOfPredicate = {
      val __obj = js.Dynamic.literal(field = field.asInstanceOf[js.Any], oneOf = oneOf.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldOneOfPredicate]
    }
    ...
    inline def FieldRangePredicate(
      ...
      __obj.asInstanceOf[typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldRangePredicate]
    }
    
    inline def FieldValidPredicate_(field: FieldName, valid: Boolean): typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldValidPredicate_ = {
      val __obj = js.Dynamic.literal(field = field.asInstanceOf[js.Any], valid = valid.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldValidPredicate_]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldGTEPredicate
    - typingsJapgolly.vegaLite.buildSrcPredicateMod.FieldValidPredicate_
    - typingsJapgolly.vegaLite.buildSrcPredicateMod.ParameterPredicate
    - java.lang.String
  */
  ...
  object _Predicate {
    ...
    inline def ParameterPredicate(param: ParameterName): typingsJapgolly.vegaLite.buildSrcPredicateMod.ParameterPredicate = {
      val __obj = js.Dynamic.literal(param = param.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaLite.buildSrcPredicateMod.ParameterPredicate]
    }
  }
}
