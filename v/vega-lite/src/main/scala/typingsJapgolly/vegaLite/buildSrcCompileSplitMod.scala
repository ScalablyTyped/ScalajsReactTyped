...
object buildSrcCompileSplitMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaLite.vegaLiteStrings.scale
    - typingsJapgolly.vegaLite.vegaLiteStrings.axis
    - typingsJapgolly.vegaLite.vegaLiteStrings.legend
    - typingsJapgolly.vegaLite.vegaLiteStrings._empty
  */
  trait SplitParentProperty extends StObject
  object SplitParentProperty {
    
    inline def _empty: typingsJapgolly.vegaLite.vegaLiteStrings._empty = "".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings._empty]
    
    inline def axis: typingsJapgolly.vegaLite.vegaLiteStrings.axis = "axis".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.axis]
    
    inline def legend: typingsJapgolly.vegaLite.vegaLiteStrings.legend = "legend".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.legend]
    
    inline def scale: typingsJapgolly.vegaLite.vegaLiteStrings.scale = "scale".asInstanceOf[typingsJapgolly.vegaLite.vegaLiteStrings.scale]
  }
}
