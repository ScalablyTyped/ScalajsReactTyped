...
import typingsJapgolly.vegaLite.anon.Column
import typingsJapgolly.vegaLite.anon.PartialRecordExtendedChan
...
import typingsJapgolly.vegaLite.buildSrcCompileLayoutsizeComponentMod.LayoutSizeComponent
import typingsJapgolly.vegaLite.buildSrcCompileLayoutsizeComponentMod.LayoutSizeType
import typingsJapgolly.vegaLite.buildSrcCompileLegendComponentMod.LegendComponentIndex
import typingsJapgolly.vegaLite.buildSrcCompileProjectionComponentMod.ProjectionComponent
import typingsJapgolly.vegaLite.buildSrcCompileScaleComponentMod.ScaleComponent
import typingsJapgolly.vegaLite.buildSrcCompileScaleComponentMod.ScaleComponentIndex
...
import typingsJapgolly.vegaLite.buildSrcDataMod.DataSourceType
...
import typingsJapgolly.vegaLite.buildSrcSpecBaseMod.GenericCompositionLayoutWithColumns
...
import typingsJapgolly.vegaLite.buildSrcVegaDotschemaMod.VgLayout
...
object buildSrcCompileModelMod {
  
  @JSImport("vega-lite/build/src/compile/model", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* note: abstract class */ @JSImport("vega-lite/build/src/compile/model", "Model")
  @js.native
  ...
  /* note: abstract class */ @JSImport("vega-lite/build/src/compile/model", "ModelWithField")
  @js.native
  open class ModelWithField protected () extends Model {
    def this(
      spec: NormalizedSpec,
      `type`: SpecType,
      parent: Model,
  ...
  object NameMapInterface {
    ...
    inline def apply(get: String => String, has: String => Boolean, rename: (String, String) => Callback): NameMapInterface = {
      val __obj = js.Dynamic.literal(get = js.Any.fromFunction1(get), has = js.Any.fromFunction1(has), rename = js.Any.fromFunction2((t0: String, t1: String) => (rename(t0, t1)).runNow()))
