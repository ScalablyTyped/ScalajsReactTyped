package typingsJapgolly.victoryBrushContainer.anon
...
trait AllowDrag extends StObject {
  ...
  var containerId: Requireable[String | Double]
  
  var containerRef: Requireable[js.Function1[/* repeated */ Any, Any]]
  
  var defaultBrushArea: Requireable[String]
  ...
  var onBrushCleared: Requireable[js.Function1[/* repeated */ Any, Any]]
  
  var onBrushDomainChange: Requireable[js.Function1[/* repeated */ Any, Any]]
  
  var onBrushDomainChangeEnd: Requireable[js.Function1[/* repeated */ Any, Any]]
  
  var origin: Requireable[InferProps[XRequireable]]
  
  var ouiaId: Requireable[String | Double]
  
  var ouiaSafe: Requireable[Boolean]
  
  var ouiaType: Requireable[String]
  
  var polar: Requireable[Boolean]
  
  var portalComponent: Requireable[ReactElementLike]
  
  var portalZIndex: Requireable[js.UndefOr[Double]]
  
  var preserveAspectRatio: Requireable[String]
  
  var responsive: Requireable[Boolean]
  
  var role: Requireable[String]
...
object AllowDrag {
  ...
  inline def apply(
    ...
    `aria-labelledby`: Requireable[String],
    brushComponent: Requireable[ReactElementLike],
    brushDimension: Requireable[String],
    brushDomain: Requireable[InferProps[XY]],
    brushStyle: Requireable[js.Object],
    children: Requireable[String | Double | Boolean | ReactElementLike | ReactNodeArray],
    className: Requireable[String],
    containerId: Requireable[String | Double],
    containerRef: Requireable[js.Function1[/* repeated */ Any, Any]],
    defaultBrushArea: Requireable[String],
    ...
    onBrushCleared: Requireable[js.Function1[/* repeated */ Any, Any]],
    onBrushDomainChange: Requireable[js.Function1[/* repeated */ Any, Any]],
    onBrushDomainChangeEnd: Requireable[js.Function1[/* repeated */ Any, Any]],
    ...
    portalComponent: Requireable[ReactElementLike],
    portalZIndex: Requireable[js.UndefOr[Double]],
    preserveAspectRatio: Requireable[String],
    responsive: Requireable[Boolean],
    ...
    val __obj = js.Dynamic.literal(allowDrag = allowDrag.asInstanceOf[js.Any], allowDraw = allowDraw.asInstanceOf[js.Any], allowResize = allowResize.asInstanceOf[js.Any], brushComponent = brushComponent.asInstanceOf[js.Any], brushDimension = brushDimension.asInstanceOf[js.Any], brushDomain = brushDomain.asInstanceOf[js.Any], brushStyle = brushStyle.asInstanceOf[js.Any], children = children.asInstanceOf[js.Any], className = className.asInstanceOf[js.Any], containerId = containerId.asInstanceOf[js.Any], containerRef = containerRef.asInstanceOf[js.Any], defaultBrushArea = defaultBrushArea.asInstanceOf[js.Any], desc = desc.asInstanceOf[js.Any], disable = disable.asInstanceOf[js.Any], events = events.asInstanceOf[js.Any], handleComponent = handleComponent.asInstanceOf[js.Any], handleStyle = handleStyle.asInstanceOf[js.Any], handleWidth = handleWidth.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], onBrushCleared = onBrushCleared.asInstanceOf[js.Any], onBrushDomainChange = onBrushDomainChange.asInstanceOf[js.Any], onBrushDomainChangeEnd = onBrushDomainChangeEnd.asInstanceOf[js.Any], origin = origin.asInstanceOf[js.Any], ouiaId = ouiaId.asInstanceOf[js.Any], ouiaSafe = ouiaSafe.asInstanceOf[js.Any], ouiaType = ouiaType.asInstanceOf[js.Any], polar = polar.asInstanceOf[js.Any], portalComponent = portalComponent.asInstanceOf[js.Any], portalZIndex = portalZIndex.asInstanceOf[js.Any], preserveAspectRatio = preserveAspectRatio.asInstanceOf[js.Any], responsive = responsive.asInstanceOf[js.Any], role = role.asInstanceOf[js.Any], style = style.asInstanceOf[js.Any], tabIndex = tabIndex.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
  ...
  extension [Self <: AllowDrag](x: Self) {
    ...
    inline def `setAria-labelledby`(value: Requireable[String]): Self = StObject.set(x, "aria-labelledby", value.asInstanceOf[js.Any])
    ...
    inline def setBrushDomain(value: Requireable[InferProps[XY]]): Self = StObject.set(x, "brushDomain", value.asInstanceOf[js.Any])
    ...
    inline def setContainerId(value: Requireable[String | Double]): Self = StObject.set(x, "containerId", value.asInstanceOf[js.Any])
    
    inline def setContainerRef(value: Requireable[js.Function1[/* repeated */ Any, Any]]): Self = StObject.set(x, "containerRef", value.asInstanceOf[js.Any])
    
    inline def setDefaultBrushArea(value: Requireable[String]): Self = StObject.set(x, "defaultBrushArea", value.asInstanceOf[js.Any])
    ...
    inline def setOnBrushCleared(value: Requireable[js.Function1[/* repeated */ Any, Any]]): Self = StObject.set(x, "onBrushCleared", value.asInstanceOf[js.Any])
    ...
    inline def setOnBrushDomainChangeEnd(value: Requireable[js.Function1[/* repeated */ Any, Any]]): Self = StObject.set(x, "onBrushDomainChangeEnd", value.asInstanceOf[js.Any])
    ...
    inline def setOuiaSafe(value: Requireable[Boolean]): Self = StObject.set(x, "ouiaSafe", value.asInstanceOf[js.Any])
    
    inline def setOuiaType(value: Requireable[String]): Self = StObject.set(x, "ouiaType", value.asInstanceOf[js.Any])
    
    inline def setPolar(value: Requireable[Boolean]): Self = StObject.set(x, "polar", value.asInstanceOf[js.Any])
    
    inline def setPortalComponent(value: Requireable[ReactElementLike]): Self = StObject.set(x, "portalComponent", value.asInstanceOf[js.Any])
    
    inline def setPortalZIndex(value: Requireable[js.UndefOr[Double]]): Self = StObject.set(x, "portalZIndex", value.asInstanceOf[js.Any])
    ...
    inline def setResponsive(value: Requireable[Boolean]): Self = StObject.set(x, "responsive", value.asInstanceOf[js.Any])
    
    inline def setRole(value: Requireable[String]): Self = StObject.set(x, "role", value.asInstanceOf[js.Any])
