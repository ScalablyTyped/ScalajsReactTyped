...
trait ComponentDidCatch extends StObject {
  ...
  def getChildren(props: Any): js.Array[String | Double | Element | ReactFragment | Null] = js.native
  
  def getCursorPointers(props: Any): XProps = js.native
  
  def getHandles(props: Any, domain: Any): js.Array[Element] | Null = js.native
  
  def getRect(props: Any): js.Array[js.Array[Element] | (DetailedReactHTMLElement[Cursor, HTMLElement]) | Null] = js.native
