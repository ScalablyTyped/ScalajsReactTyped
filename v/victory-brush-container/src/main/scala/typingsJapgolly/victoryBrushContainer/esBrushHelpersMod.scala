...
object esBrushHelpersMod {
  
  object BrushHelpers {
    
    @JSImport("victory-brush-container/es/brush-helpers", "BrushHelpers")
    @js.native
    ...
    @JSImport("victory-brush-container/es/brush-helpers", "BrushHelpers.onGlobalMouseMove")
    @js.native
