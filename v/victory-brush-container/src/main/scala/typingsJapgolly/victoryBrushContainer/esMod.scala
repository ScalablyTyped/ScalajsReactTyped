...
import typingsJapgolly.victoryBrushContainer.anon.Bottom
...
import typingsJapgolly.victoryBrushContainer.anon.X
import typingsJapgolly.victoryBrushContainer.anon.X1
import typingsJapgolly.victoryBrushContainer.anon.X1X2
import typingsJapgolly.victoryBrushContainer.anon.Y
import typingsJapgolly.victoryBrushContainer.anon.Y2
import typingsJapgolly.victoryBrushContainer.esVictoryBrushContainerMod.Constructor
import typingsJapgolly.victoryBrushContainer.victoryBrushContainerInts.`0`
...
object esMod {
  ...
  @JSImport("victory-brush-container/es", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object BrushHelpers {
    
    @JSImport("victory-brush-container/es", "BrushHelpers")
    @js.native
    val ^ : js.Any = js.native
    ...
    @JSImport("victory-brush-container/es", "BrushHelpers.onGlobalMouseMove")
    @js.native
  ...
  @JSImport("victory-brush-container/es", "VictoryBrushContainer")
  @js.native
