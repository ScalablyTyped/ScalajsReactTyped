...
import typingsJapgolly.vscodeLanguageserverProtocol.protocolMod.CompletionTriggerKind
import typingsJapgolly.vscodeLanguageserverProtocol.protocolMod.FileChangeType
import typingsJapgolly.vscodeLanguageserverProtocol.protocolMod.MessageType
import typingsJapgolly.vscodeLanguageserverProtocol.protocolMod.TextDocumentSyncKind
