...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.vscodeLanguageserverProtocol.AnonLanguage
  - typingsJapgolly.vscodeLanguageserverProtocol.AnonPattern
  - typingsJapgolly.vscodeLanguageserverProtocol.AnonScheme
*/
