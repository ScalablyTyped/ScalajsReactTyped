...
trait AnonHierarchicalDocumentSymbolSupport extends js.Object {
  /**
...
object AnonHierarchicalDocumentSymbolSupport {
  @scala.inline
  def apply(
  ...
  ): AnonHierarchicalDocumentSymbolSupport = {
    ...
    __obj.asInstanceOf[AnonHierarchicalDocumentSymbolSupport]
  }
}
