...
@JSImport("vscode-languageserver-protocol", "SemanticTokenModifiers")
@js.native
object SemanticTokenModifiers extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typingsJapgolly.vscodeLanguageserverTypes.mod.SemanticTokenModifiers & String] = js.native
