...
object VueConfiguration {
  ...
  def apply(
    ...
    __obj.updateDynamic("errorHandler")(js.Any.fromFunction3((t0: js.Error, t1: typingsJapgolly.vue.vueMod.Vue, t2: java.lang.String) => errorHandler(t0, t1, t2).runNow()))
    __obj.updateDynamic("warnHandler")(js.Any.fromFunction3((t0: java.lang.String, t1: typingsJapgolly.vue.vueMod.Vue, t2: java.lang.String) => warnHandler(t0, t1, t2).runNow()))
