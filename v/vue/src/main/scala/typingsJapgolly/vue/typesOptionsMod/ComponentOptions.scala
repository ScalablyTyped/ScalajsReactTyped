...
import typingsJapgolly.vue.Anon_Event
...
object ComponentOptions {
  ...
  def apply[V /* <: Vue */, Data, Methods, Computed, PropsDef, Props](
    ...
    if (errorCaptured != null) __obj.updateDynamic("errorCaptured")(js.Any.fromFunction3((t0: /* err */ js.Error, t1: /* vm */ typingsJapgolly.vue.typesVueMod.Vue, t2: /* info */ java.lang.String) => errorCaptured(t0, t1, t2).runNow()))
    ...
    if (render != null) __obj.updateDynamic("render")(js.Any.fromFunction2((t0: /* createElement */ typingsJapgolly.vue.typesVueMod.CreateElement, t1: /* hack */ typingsJapgolly.vue.typesOptionsMod.RenderContext[Props]) => render(t0, t1).runNow()))
    if (renderError != null) __obj.updateDynamic("renderError")(js.Any.fromFunction2((t0: /* createElement */ typingsJapgolly.vue.typesVueMod.CreateElement, t1: /* err */ js.Error) => renderError(t0, t1).runNow()))
