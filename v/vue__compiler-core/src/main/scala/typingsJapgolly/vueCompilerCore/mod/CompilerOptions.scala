...
import typingsJapgolly.vueCompilerCore.vueCompilerCoreStrings.function
import typingsJapgolly.vueCompilerCore.vueCompilerCoreStrings.module
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.vueCompilerCore.mod.CompilerCompatOptions because Already inherited
- typingsJapgolly.vueCompilerCore.mod.ErrorHandlingOptions because Already inherited
- typingsJapgolly.vueCompilerCore.mod.SharedTransformCodegenOptions because var conflicts: prefixIdentifiers. Inlined ssr, inSSR, bindingMetadata, `inline`, isTS, filename
- typingsJapgolly.vueCompilerCore.mod.CodegenOptions because var conflicts: prefixIdentifiers, scopeId. Inlined mode, sourceMap, optimizeImports, runtimeModuleName, ssrRuntimeModuleName, runtimeGlobalName
- typingsJapgolly.vueCompilerCore.mod.TransformOptions because var conflicts: compatConfig, isBuiltInComponent, isCustomElement, onError, onWarn. Inlined nodeTransforms, directiveTransforms, transformHoist, prefixIdentifiers, hoistStatic, cacheHandlers, expressionPlugins, scopeId, slotted, ssrCssVars */ trait CompilerOptions
  extends StObject
     with ParserOptions {
...
object CompilerOptions {
  ...
  extension [Self <: CompilerOptions](x: Self) {
    ...
    inline def setTransformHoist(
      value: (/* children */ js.Array[TemplateChildNode], /* context */ TransformContext, /* parent */ ParentNode2) => Callback
    ): Self = StObject.set(x, "transformHoist", js.Any.fromFunction3((t0: /* children */ js.Array[TemplateChildNode], t1: /* context */ TransformContext, t2: /* parent */ ParentNode2) => (value(t0, t1, t2)).runNow()))
