package typingsJapgolly.vueCompilerCore

import japgolly.scalajs.react.Callback
import typingsJapgolly.vueCompilerCore.mod.BindingMetadata
import typingsJapgolly.vueCompilerCore.mod.CodegenContext
...
object anon {
  ...
  object CodegenOptionsonContextCr {
    ...
    extension [Self <: CodegenOptionsonContextCr](x: Self) {
      ...
      inline def setOnContextCreated(value: /* context */ CodegenContext => Callback): Self = StObject.set(x, "onContextCreated", js.Any.fromFunction1((t0: /* context */ CodegenContext) => value(t0).runNow()))
