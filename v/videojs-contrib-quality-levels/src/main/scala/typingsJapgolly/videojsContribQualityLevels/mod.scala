...
import typingsJapgolly.videojsContribQualityLevels.anon.Call
import typingsJapgolly.videojsContribQualityLevels.srcQualityLevelMod.default
...
object mod {
  ...
  open class QualityLevelList ()
    extends typingsJapgolly.videojsContribQualityLevels.srcQualityLevelListMod.default
  ...
  object videoJsAugmentingMod {
    ...
    trait VideoJsPlayer extends StObject {
      ...
      def qualityLevels(): typingsJapgolly.videojsContribQualityLevels.srcQualityLevelListMod.default
