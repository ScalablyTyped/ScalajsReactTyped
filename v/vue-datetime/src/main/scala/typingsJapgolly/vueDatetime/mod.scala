package typingsJapgolly.vueDatetime
...
object mod extends Shortcut {
  ...
  object VueDateTimeConstructor {
    ...
    inline def apply(data: CallbackTo[VueDateTimeData], methods: Any, props: VueDateTimeProps): VueDateTimeConstructor = {
    ...
    extension [Self <: VueDateTimeConstructor](x: Self) {
      ...
      inline def setData(value: CallbackTo[VueDateTimeData]): Self = StObject.set(x, "data", value.toJsFn)
