...
object anon {
  ...
  object Data {
    ...
    inline def apply(data: CallbackTo[js.Promise[js.Array[java.lang.String]]]): Data = {
      val __obj = js.Dynamic.literal(data = data.toJsFn)
      __obj.asInstanceOf[Data]
    }
    
    extension [Self <: Data](x: Self) {
      
      inline def setData(value: CallbackTo[js.Promise[js.Array[java.lang.String]]]): Self = StObject.set(x, "data", value.toJsFn)
    }
  }
