...
import typingsJapgolly.vscodeDebugprotocol.vscodeDebugprotocolStrings.indexed
import typingsJapgolly.vscodeDebugprotocol.vscodeDebugprotocolStrings.named
