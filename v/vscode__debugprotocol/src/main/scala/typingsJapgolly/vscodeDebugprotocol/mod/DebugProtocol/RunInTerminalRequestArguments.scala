...
import typingsJapgolly.vscodeDebugprotocol.vscodeDebugprotocolStrings.external
import typingsJapgolly.vscodeDebugprotocol.vscodeDebugprotocolStrings.integrated
