...
import typingsJapgolly.vscodeDebugprotocol.mod.DebugProtocol.ChecksumAlgorithm
import typingsJapgolly.vscodeDebugprotocol.mod.DebugProtocol.CompletionItemType
...
import typingsJapgolly.vscodeDebugprotocol.mod.DebugProtocol.SteppingGranularity
import typingsJapgolly.vscodeDebugprotocol.mod.DebugProtocol._InvalidatedAreas
