...
object esVictoryLineMod {
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("victory-line/es/victory-line", "VictoryLine")
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.victoryLine.victoryLineStrings.data
    - typingsJapgolly.victoryLine.victoryLineStrings.labels
    - typingsJapgolly.victoryLine.victoryLineStrings.parent
  */
  trait VictoryLineTTargetType extends StObject
  object VictoryLineTTargetType {
    
    inline def data: typingsJapgolly.victoryLine.victoryLineStrings.data = "data".asInstanceOf[typingsJapgolly.victoryLine.victoryLineStrings.data]
    
    inline def labels: typingsJapgolly.victoryLine.victoryLineStrings.labels = "labels".asInstanceOf[typingsJapgolly.victoryLine.victoryLineStrings.labels]
    
    inline def parent: typingsJapgolly.victoryLine.victoryLineStrings.parent = "parent".asInstanceOf[typingsJapgolly.victoryLine.victoryLineStrings.parent]
  }
}
