...
package object mod {
  ...
  type RenderMethod = js.Function3[
    ...
    /* options */ js.UndefOr[typingsJapgolly.vision.mod.ServerViewsConfiguration], 
    js.Promise[java.lang.String]
  ]
  type RuntimeOptions = js.Object
  type ServerViewCompile = typingsJapgolly.vision.mod.ServerViewCompileSync | typingsJapgolly.vision.mod.ServerViewCompileAsync
  type ServerViewCompileAsync = js.Function3[
    /* template */ java.lang.String, 
    /* options */ js.Any, 
    /* next */ typingsJapgolly.vision.mod.ServerViewCompileNext, 
    scala.Unit
  ]
