...
import typingsJapgolly.vision.anon.Context
...
object mod extends Shortcut {
  ...
  object hapiAugmentingMod {
    ...
    object Request {
      ...
      inline def apply(
        render: (/* template */ String, /* context */ js.UndefOr[Any], /* options */ js.UndefOr[ServerViewsConfiguration]) => js.Promise[String]
      ): typingsJapgolly.vision.mod.hapiAugmentingMod.Request = {
        val __obj = js.Dynamic.literal(render = js.Any.fromFunction3(render))
        __obj.asInstanceOf[typingsJapgolly.vision.mod.hapiAugmentingMod.Request]
      }
      
      extension [Self <: typingsJapgolly.vision.mod.hapiAugmentingMod.Request](x: Self) {
