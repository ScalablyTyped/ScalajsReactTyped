...
object GetProcessExpandLevel extends StObject {
  ...
  /* 0 */ val None: typingsJapgolly.vsoNodeApi.interfacesWorkItemTrackingProcessInterfacesMod.GetProcessExpandLevel.None & Double = js.native
  
  @js.native
  sealed trait Projects
    extends StObject
       with GetProcessExpandLevel
  /* 1 */ val Projects: typingsJapgolly.vsoNodeApi.interfacesWorkItemTrackingProcessInterfacesMod.GetProcessExpandLevel.Projects & Double = js.native
}
