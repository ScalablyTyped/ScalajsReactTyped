...
import typingsJapgolly.vsoNodeApi.anon.EnumValuesAssignedInherited
...
object interfacesSecurityRolesInterfacesMod {
  ...
  object RoleAccess extends StObject {
    ...
    sealed trait Assigned
      extends StObject
         with RoleAccess
    /* 1 */ val Assigned: typingsJapgolly.vsoNodeApi.interfacesSecurityRolesInterfacesMod.RoleAccess.Assigned & Double = js.native
    ...
    sealed trait Inherited
      extends StObject
         with RoleAccess
    /* 2 */ val Inherited: typingsJapgolly.vsoNodeApi.interfacesSecurityRolesInterfacesMod.RoleAccess.Inherited & Double = js.native
  }
