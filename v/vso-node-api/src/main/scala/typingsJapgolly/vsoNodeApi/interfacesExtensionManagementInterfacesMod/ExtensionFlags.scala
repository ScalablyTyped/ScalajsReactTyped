...
object ExtensionFlags extends StObject {
  ...
  sealed trait BuiltIn
    extends StObject
       with ExtensionFlags
  /* 1 */ val BuiltIn: typingsJapgolly.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ExtensionFlags.BuiltIn & Double = js.native
  ...
  sealed trait Trusted
    extends StObject
       with ExtensionFlags
  /* 2 */ val Trusted: typingsJapgolly.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ExtensionFlags.Trusted & Double = js.native
}
