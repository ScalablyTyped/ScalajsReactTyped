...
object ContributionLicensingBehaviorType extends StObject {
  ...
  /* 2 */ val AlwaysInclude: typingsJapgolly.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ContributionLicensingBehaviorType.AlwaysInclude & Double = js.native
  ...
  sealed trait OnlyIfLicensed
    extends StObject
       with ContributionLicensingBehaviorType
  /* 0 */ val OnlyIfLicensed: typingsJapgolly.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ContributionLicensingBehaviorType.OnlyIfLicensed & Double = js.native
  ...
  sealed trait OnlyIfUnlicensed
    extends StObject
       with ContributionLicensingBehaviorType
  /* 1 */ val OnlyIfUnlicensed: typingsJapgolly.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ContributionLicensingBehaviorType.OnlyIfUnlicensed & Double = js.native
}
