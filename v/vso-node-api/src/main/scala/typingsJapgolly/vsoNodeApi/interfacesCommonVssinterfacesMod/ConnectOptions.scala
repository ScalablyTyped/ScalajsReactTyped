...
object ConnectOptions extends StObject {
  ...
  sealed trait IncludeInheritedDefinitionsOnly
    extends StObject
       with ConnectOptions
  /* 4 */ val IncludeInheritedDefinitionsOnly: typingsJapgolly.vsoNodeApi.interfacesCommonVssinterfacesMod.ConnectOptions.IncludeInheritedDefinitionsOnly & Double = js.native
  ...
  sealed trait IncludeLastUserAccess
    extends StObject
       with ConnectOptions
  /* 2 */ val IncludeLastUserAccess: typingsJapgolly.vsoNodeApi.interfacesCommonVssinterfacesMod.ConnectOptions.IncludeLastUserAccess & Double = js.native
  ...
  sealed trait IncludeNonInheritedDefinitionsOnly
    extends StObject
       with ConnectOptions
  /* 8 */ val IncludeNonInheritedDefinitionsOnly: typingsJapgolly.vsoNodeApi.interfacesCommonVssinterfacesMod.ConnectOptions.IncludeNonInheritedDefinitionsOnly & Double = js.native
  ...
  sealed trait IncludeServices
    extends StObject
       with ConnectOptions
  /* 1 */ val IncludeServices: typingsJapgolly.vsoNodeApi.interfacesCommonVssinterfacesMod.ConnectOptions.IncludeServices & Double = js.native
  ...
  sealed trait None
    extends StObject
       with ConnectOptions
  /* 0 */ val None: typingsJapgolly.vsoNodeApi.interfacesCommonVssinterfacesMod.ConnectOptions.None & Double = js.native
}
