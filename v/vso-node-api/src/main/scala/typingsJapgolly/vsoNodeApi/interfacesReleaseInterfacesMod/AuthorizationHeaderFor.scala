...
object AuthorizationHeaderFor extends StObject {
  ...
  /* 1 */ val OnBehalfOf: typingsJapgolly.vsoNodeApi.interfacesReleaseInterfacesMod.AuthorizationHeaderFor.OnBehalfOf & Double = js.native
  
  @js.native
  sealed trait RevalidateApproverIdentity
    extends StObject
       with AuthorizationHeaderFor
  /* 0 */ val RevalidateApproverIdentity: typingsJapgolly.vsoNodeApi.interfacesReleaseInterfacesMod.AuthorizationHeaderFor.RevalidateApproverIdentity & Double = js.native
}
