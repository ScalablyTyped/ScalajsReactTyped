...
object VariableGroupActionFilter extends StObject {
  ...
  /* 2 */ val Manage: typingsJapgolly.vsoNodeApi.interfacesReleaseInterfacesMod.VariableGroupActionFilter.Manage & Double = js.native
  
  @js.native
  sealed trait None
    extends StObject
       with VariableGroupActionFilter
  /* 0 */ val None: typingsJapgolly.vsoNodeApi.interfacesReleaseInterfacesMod.VariableGroupActionFilter.None & Double = js.native
  
  @js.native
  sealed trait Use
    extends StObject
       with VariableGroupActionFilter
  /* 16 */ val Use: typingsJapgolly.vsoNodeApi.interfacesReleaseInterfacesMod.VariableGroupActionFilter.Use & Double = js.native
}
