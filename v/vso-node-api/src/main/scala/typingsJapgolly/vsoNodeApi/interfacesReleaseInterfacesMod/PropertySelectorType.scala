...
object PropertySelectorType extends StObject {
  ...
  /* 1 */ val Exclusion: typingsJapgolly.vsoNodeApi.interfacesReleaseInterfacesMod.PropertySelectorType.Exclusion & Double = js.native
  
  @js.native
  sealed trait Inclusion
    extends StObject
       with PropertySelectorType
  /* 0 */ val Inclusion: typingsJapgolly.vsoNodeApi.interfacesReleaseInterfacesMod.PropertySelectorType.Inclusion & Double = js.native
}
