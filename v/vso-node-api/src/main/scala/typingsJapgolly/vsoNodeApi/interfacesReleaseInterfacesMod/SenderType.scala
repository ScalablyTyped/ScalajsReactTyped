...
object SenderType extends StObject {
  ...
  sealed trait RequestingUser
    extends StObject
       with SenderType
  /* 2 */ val RequestingUser: typingsJapgolly.vsoNodeApi.interfacesReleaseInterfacesMod.SenderType.RequestingUser & Double = js.native
  
  @js.native
  sealed trait ServiceAccount
    extends StObject
       with SenderType
  /* 1 */ val ServiceAccount: typingsJapgolly.vsoNodeApi.interfacesReleaseInterfacesMod.SenderType.ServiceAccount & Double = js.native
}
