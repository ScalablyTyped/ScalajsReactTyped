...
object DeploymentReason extends StObject {
  ...
  /* 2 */ val Automated: typingsJapgolly.vsoNodeApi.interfacesReleaseInterfacesMod.DeploymentReason.Automated & Double = js.native
  ...
  sealed trait Manual
    extends StObject
       with DeploymentReason
  /* 1 */ val Manual: typingsJapgolly.vsoNodeApi.interfacesReleaseInterfacesMod.DeploymentReason.Manual & Double = js.native
  ...
  sealed trait None
    extends StObject
       with DeploymentReason
  /* 0 */ val None: typingsJapgolly.vsoNodeApi.interfacesReleaseInterfacesMod.DeploymentReason.None & Double = js.native
  ...
  sealed trait Scheduled
    extends StObject
       with DeploymentReason
  /* 4 */ val Scheduled: typingsJapgolly.vsoNodeApi.interfacesReleaseInterfacesMod.DeploymentReason.Scheduled & Double = js.native
}
