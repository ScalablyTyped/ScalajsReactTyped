...
object GitRefUpdateMode extends StObject {
  ...
  /* 1 */ val AllOrNone: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.GitRefUpdateMode.AllOrNone & Double = js.native
  ...
  sealed trait BestEffort
    extends StObject
       with GitRefUpdateMode
  /* 0 */ val BestEffort: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.GitRefUpdateMode.BestEffort & Double = js.native
}
