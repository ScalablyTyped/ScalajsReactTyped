...
object GitResolutionStatus extends StObject {
  ...
  /* 1 */ val PartiallyResolved: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.GitResolutionStatus.PartiallyResolved & Double = js.native
  
  @js.native
  sealed trait Resolved
    extends StObject
       with GitResolutionStatus
  /* 2 */ val Resolved: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.GitResolutionStatus.Resolved & Double = js.native
  
  @js.native
  sealed trait Unresolved
    extends StObject
       with GitResolutionStatus
  /* 0 */ val Unresolved: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.GitResolutionStatus.Unresolved & Double = js.native
}
