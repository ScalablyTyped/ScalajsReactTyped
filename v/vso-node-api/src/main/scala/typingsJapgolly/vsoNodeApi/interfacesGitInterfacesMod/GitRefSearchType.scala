...
object GitRefSearchType extends StObject {
  ...
  /* 2 */ val Contains: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.GitRefSearchType.Contains & Double = js.native
  
  @js.native
  sealed trait Exact
    extends StObject
       with GitRefSearchType
  /* 0 */ val Exact: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.GitRefSearchType.Exact & Double = js.native
  
  @js.native
  sealed trait StartsWith
    extends StObject
       with GitRefSearchType
  /* 1 */ val StartsWith: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.GitRefSearchType.StartsWith & Double = js.native
}
