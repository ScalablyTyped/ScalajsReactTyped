...
object GitPullRequestReviewFileType extends StObject {
  ...
  /* 1 */ val Attachment: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.GitPullRequestReviewFileType.Attachment & Double = js.native
  
  @js.native
  sealed trait ChangeEntry
    extends StObject
       with GitPullRequestReviewFileType
  /* 0 */ val ChangeEntry: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.GitPullRequestReviewFileType.ChangeEntry & Double = js.native
}
