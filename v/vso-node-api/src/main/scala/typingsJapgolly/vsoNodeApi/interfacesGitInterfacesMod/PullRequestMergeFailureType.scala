...
object PullRequestMergeFailureType extends StObject {
  ...
  /* 2 */ val CaseSensitive: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.PullRequestMergeFailureType.CaseSensitive & Double = js.native
  ...
  sealed trait None
    extends StObject
       with PullRequestMergeFailureType
  /* 0 */ val None: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.PullRequestMergeFailureType.None & Double = js.native
  ...
  sealed trait ObjectTooLarge
    extends StObject
       with PullRequestMergeFailureType
  /* 3 */ val ObjectTooLarge: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.PullRequestMergeFailureType.ObjectTooLarge & Double = js.native
  ...
  sealed trait Unknown
    extends StObject
       with PullRequestMergeFailureType
  /* 1 */ val Unknown: typingsJapgolly.vsoNodeApi.interfacesGitInterfacesMod.PullRequestMergeFailureType.Unknown & Double = js.native
}
