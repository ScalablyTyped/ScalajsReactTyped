...
object PickListMetadataModel {
  ...
  inline def apply(id: String, isSuggested: Boolean, name: String, `type`: String, url: String): PickListMetadataModel = {
  ...
  extension [Self <: PickListMetadataModel](x: Self) {
    ...
    inline def setIsSuggested(value: Boolean): Self = StObject.set(x, "isSuggested", value.asInstanceOf[js.Any])
