...
import typingsJapgolly.vsoNodeApi.anon.EnumValuesCancelledFailed
...
object interfacesCommonOperationsInterfacesMod {
  ...
  object OperationStatus extends StObject {
    ...
    /* 3 */ val Cancelled: typingsJapgolly.vsoNodeApi.interfacesCommonOperationsInterfacesMod.OperationStatus.Cancelled & Double = js.native
    ...
    sealed trait Failed
      extends StObject
         with OperationStatus
    /* 5 */ val Failed: typingsJapgolly.vsoNodeApi.interfacesCommonOperationsInterfacesMod.OperationStatus.Failed & Double = js.native
    ...
    sealed trait InProgress
      extends StObject
         with OperationStatus
    /* 2 */ val InProgress: typingsJapgolly.vsoNodeApi.interfacesCommonOperationsInterfacesMod.OperationStatus.InProgress & Double = js.native
    ...
    sealed trait NotSet
      extends StObject
         with OperationStatus
    /* 0 */ val NotSet: typingsJapgolly.vsoNodeApi.interfacesCommonOperationsInterfacesMod.OperationStatus.NotSet & Double = js.native
    ...
    sealed trait Queued
      extends StObject
         with OperationStatus
    /* 1 */ val Queued: typingsJapgolly.vsoNodeApi.interfacesCommonOperationsInterfacesMod.OperationStatus.Queued & Double = js.native
    ...
    sealed trait Succeeded
      extends StObject
         with OperationStatus
    /* 4 */ val Succeeded: typingsJapgolly.vsoNodeApi.interfacesCommonOperationsInterfacesMod.OperationStatus.Succeeded & Double = js.native
  }
