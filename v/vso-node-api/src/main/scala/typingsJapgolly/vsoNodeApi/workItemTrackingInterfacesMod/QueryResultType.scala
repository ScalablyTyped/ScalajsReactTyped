...
object QueryResultType extends js.Object {
  ...
  object WorkItem
    extends TopLevel[
          typingsJapgolly.vsoNodeApi.workItemTrackingInterfacesMod.QueryResultType.WorkItem with Double
        ]
  
  /* 2 */ @js.native
  object WorkItemLink
    extends TopLevel[
          typingsJapgolly.vsoNodeApi.workItemTrackingInterfacesMod.QueryResultType.WorkItemLink with Double
        ]
