...
object FieldUsage extends js.Object {
  ...
  object WorkItem
    extends TopLevel[
          typingsJapgolly.vsoNodeApi.workItemTrackingInterfacesMod.FieldUsage.WorkItem with Double
        ]
  
  /* 2 */ @js.native
  object WorkItemLink
    extends TopLevel[
          typingsJapgolly.vsoNodeApi.workItemTrackingInterfacesMod.FieldUsage.WorkItemLink with Double
        ]
