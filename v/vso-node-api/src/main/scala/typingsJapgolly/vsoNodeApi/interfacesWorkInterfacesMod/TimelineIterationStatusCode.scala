...
object TimelineIterationStatusCode extends StObject {
  ...
  /* 1 */ val IsOverlapping: typingsJapgolly.vsoNodeApi.interfacesWorkInterfacesMod.TimelineIterationStatusCode.IsOverlapping & Double = js.native
  ...
  sealed trait OK
    extends StObject
       with TimelineIterationStatusCode
  /* 0 */ val OK: typingsJapgolly.vsoNodeApi.interfacesWorkInterfacesMod.TimelineIterationStatusCode.OK & Double = js.native
}
