...
object TimelineTeamStatusCode extends StObject {
  ...
  /* 4 */ val BacklogInError: typingsJapgolly.vsoNodeApi.interfacesWorkInterfacesMod.TimelineTeamStatusCode.BacklogInError & Double = js.native
  ...
  sealed trait DoesntExistOrAccessDenied
    extends StObject
       with TimelineTeamStatusCode
  /* 1 */ val DoesntExistOrAccessDenied: typingsJapgolly.vsoNodeApi.interfacesWorkInterfacesMod.TimelineTeamStatusCode.DoesntExistOrAccessDenied & Double = js.native
  ...
  sealed trait MaxTeamFieldsExceeded
    extends StObject
       with TimelineTeamStatusCode
  /* 3 */ val MaxTeamFieldsExceeded: typingsJapgolly.vsoNodeApi.interfacesWorkInterfacesMod.TimelineTeamStatusCode.MaxTeamFieldsExceeded & Double = js.native
  ...
  sealed trait MaxTeamsExceeded
    extends StObject
       with TimelineTeamStatusCode
  /* 2 */ val MaxTeamsExceeded: typingsJapgolly.vsoNodeApi.interfacesWorkInterfacesMod.TimelineTeamStatusCode.MaxTeamsExceeded & Double = js.native
  ...
  sealed trait MissingTeamFieldValue
    extends StObject
       with TimelineTeamStatusCode
  /* 5 */ val MissingTeamFieldValue: typingsJapgolly.vsoNodeApi.interfacesWorkInterfacesMod.TimelineTeamStatusCode.MissingTeamFieldValue & Double = js.native
  ...
  sealed trait NoIterationsExist
    extends StObject
       with TimelineTeamStatusCode
  /* 6 */ val NoIterationsExist: typingsJapgolly.vsoNodeApi.interfacesWorkInterfacesMod.TimelineTeamStatusCode.NoIterationsExist & Double = js.native
  ...
  sealed trait OK
    extends StObject
       with TimelineTeamStatusCode
  /* 0 */ val OK: typingsJapgolly.vsoNodeApi.interfacesWorkInterfacesMod.TimelineTeamStatusCode.OK & Double = js.native
}
