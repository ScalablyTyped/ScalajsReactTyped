...
object SourceControlTypes extends StObject {
  ...
  /* 2 */ val Git: typingsJapgolly.vsoNodeApi.interfacesCoreInterfacesMod.SourceControlTypes.Git & Double = js.native
  
  @js.native
  sealed trait Tfvc
    extends StObject
       with SourceControlTypes
  /* 1 */ val Tfvc: typingsJapgolly.vsoNodeApi.interfacesCoreInterfacesMod.SourceControlTypes.Tfvc & Double = js.native
}
