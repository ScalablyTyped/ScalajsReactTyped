...
import typingsJapgolly.vsoNodeApi.interfacesCommonVssinterfacesMod.PublicKey
import typingsJapgolly.vsoNodeApi.interfacesIdentitiesInterfacesMod.IdentityDescriptor
...
object ProxyAuthorization {
  ...
  extension [Self <: ProxyAuthorization](x: Self) {
