...
object InputFilterOperator extends StObject {
  ...
  /* 0 */ val Equals: typingsJapgolly.vsoNodeApi.interfacesCommonFormInputInterfacesMod.InputFilterOperator.Equals & Double = js.native
  
  @js.native
  sealed trait NotEquals
    extends StObject
       with InputFilterOperator
  /* 1 */ val NotEquals: typingsJapgolly.vsoNodeApi.interfacesCommonFormInputInterfacesMod.InputFilterOperator.NotEquals & Double = js.native
}
