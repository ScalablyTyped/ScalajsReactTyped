...
object CommentSortOrder extends StObject {
  ...
  /* 1 */ val Asc: typingsJapgolly.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.CommentSortOrder.Asc & Double = js.native
  
  @js.native
  sealed trait Desc
    extends StObject
       with CommentSortOrder
  /* 2 */ val Desc: typingsJapgolly.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.CommentSortOrder.Desc & Double = js.native
}
