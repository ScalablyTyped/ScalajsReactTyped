...
object ReportingRevisionsExpand extends StObject {
  ...
  /* 1 */ val Fields: typingsJapgolly.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.ReportingRevisionsExpand.Fields & Double = js.native
  
  @js.native
  sealed trait None
    extends StObject
       with ReportingRevisionsExpand
  /* 0 */ val None: typingsJapgolly.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.ReportingRevisionsExpand.None & Double = js.native
}
