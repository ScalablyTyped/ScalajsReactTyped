...
object QueryRecursionOption extends StObject {
  ...
  /* 1 */ val ChildFirst: typingsJapgolly.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.QueryRecursionOption.ChildFirst & Double = js.native
  ...
  sealed trait ParentFirst
    extends StObject
       with QueryRecursionOption
  /* 0 */ val ParentFirst: typingsJapgolly.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.QueryRecursionOption.ParentFirst & Double = js.native
}
