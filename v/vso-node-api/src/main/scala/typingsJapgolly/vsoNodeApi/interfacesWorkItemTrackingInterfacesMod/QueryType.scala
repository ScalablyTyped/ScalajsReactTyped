...
object QueryType extends StObject {
  ...
  sealed trait Flat
    extends StObject
       with QueryType
  /* 1 */ val Flat: typingsJapgolly.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.QueryType.Flat & Double = js.native
  ...
  sealed trait OneHop
    extends StObject
       with QueryType
  /* 3 */ val OneHop: typingsJapgolly.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.QueryType.OneHop & Double = js.native
  ...
  sealed trait Tree
    extends StObject
       with QueryType
  /* 2 */ val Tree: typingsJapgolly.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.QueryType.Tree & Double = js.native
}
