...
object AgentStatus extends StObject {
  ...
  sealed trait Available
    extends StObject
       with AgentStatus
  /* 1 */ val Available: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.AgentStatus.Available & Double = js.native
  ...
  sealed trait Offline
    extends StObject
       with AgentStatus
  /* 2 */ val Offline: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.AgentStatus.Offline & Double = js.native
  ...
  sealed trait Unavailable
    extends StObject
       with AgentStatus
  /* 0 */ val Unavailable: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.AgentStatus.Unavailable & Double = js.native
}
