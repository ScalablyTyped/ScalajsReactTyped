...
object ProcessTemplateType extends StObject {
  ...
  /* 0 */ val Custom: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.ProcessTemplateType.Custom & Double = js.native
  ...
  sealed trait Default
    extends StObject
       with ProcessTemplateType
  /* 1 */ val Default: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.ProcessTemplateType.Default & Double = js.native
  ...
  sealed trait Upgrade
    extends StObject
       with ProcessTemplateType
  /* 2 */ val Upgrade: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.ProcessTemplateType.Upgrade & Double = js.native
}
