...
import typingsJapgolly.vsoNodeApi.interfacesDistributedTaskCommonInterfacesMod.ProcessParameters
...
object BuildDefinition {
  ...
  extension [Self <: BuildDefinition](x: Self) {
    ...
    inline def setProcess(value: BuildProcess): Self = StObject.set(x, "process", value.asInstanceOf[js.Any])
