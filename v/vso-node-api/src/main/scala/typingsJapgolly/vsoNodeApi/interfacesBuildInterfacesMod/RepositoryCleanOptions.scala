...
object RepositoryCleanOptions extends StObject {
  ...
  /* 3 */ val AllBuildDir: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.RepositoryCleanOptions.AllBuildDir & Double = js.native
  
  @js.native
  sealed trait Source
    extends StObject
       with RepositoryCleanOptions
  /* 0 */ val Source: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.RepositoryCleanOptions.Source & Double = js.native
  
  @js.native
  sealed trait SourceAndOutputDir
    extends StObject
       with RepositoryCleanOptions
  /* 1 */ val SourceAndOutputDir: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.RepositoryCleanOptions.SourceAndOutputDir & Double = js.native
  ...
  sealed trait SourceDir
    extends StObject
       with RepositoryCleanOptions
  /* 2 */ val SourceDir: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.RepositoryCleanOptions.SourceDir & Double = js.native
}
