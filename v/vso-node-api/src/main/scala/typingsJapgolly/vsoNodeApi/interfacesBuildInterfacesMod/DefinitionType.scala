...
object DefinitionType extends StObject {
  ...
  sealed trait Build
    extends StObject
       with DefinitionType
  /* 2 */ val Build: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.DefinitionType.Build & Double = js.native
  
  @js.native
  sealed trait Xaml
    extends StObject
       with DefinitionType
  /* 1 */ val Xaml: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.DefinitionType.Xaml & Double = js.native
}
