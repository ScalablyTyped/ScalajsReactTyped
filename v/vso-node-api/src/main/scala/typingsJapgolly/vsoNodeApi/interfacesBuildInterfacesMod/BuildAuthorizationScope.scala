...
object BuildAuthorizationScope extends StObject {
  ...
  /* 2 */ val Project: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.BuildAuthorizationScope.Project & Double = js.native
  ...
  sealed trait ProjectCollection
    extends StObject
       with BuildAuthorizationScope
  /* 1 */ val ProjectCollection: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.BuildAuthorizationScope.ProjectCollection & Double = js.native
}
