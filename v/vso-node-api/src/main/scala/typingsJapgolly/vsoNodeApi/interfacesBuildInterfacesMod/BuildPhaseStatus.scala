...
object BuildPhaseStatus extends StObject {
  ...
  /* 1 */ val Failed: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.BuildPhaseStatus.Failed & Double = js.native
  ...
  sealed trait Succeeded
    extends StObject
       with BuildPhaseStatus
  /* 2 */ val Succeeded: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.BuildPhaseStatus.Succeeded & Double = js.native
  ...
  sealed trait Unknown
    extends StObject
       with BuildPhaseStatus
  /* 0 */ val Unknown: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.BuildPhaseStatus.Unknown & Double = js.native
}
