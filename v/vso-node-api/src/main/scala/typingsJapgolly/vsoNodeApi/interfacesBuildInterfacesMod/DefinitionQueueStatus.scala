...
object DefinitionQueueStatus extends StObject {
  ...
  /* 2 */ val Disabled: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.DefinitionQueueStatus.Disabled & Double = js.native
  ...
  sealed trait Enabled
    extends StObject
       with DefinitionQueueStatus
  /* 0 */ val Enabled: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.DefinitionQueueStatus.Enabled & Double = js.native
  ...
  sealed trait Paused
    extends StObject
       with DefinitionQueueStatus
  /* 1 */ val Paused: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.DefinitionQueueStatus.Paused & Double = js.native
}
