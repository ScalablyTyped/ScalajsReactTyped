...
object IssueType extends StObject {
  ...
  sealed trait Error
    extends StObject
       with IssueType
  /* 1 */ val Error: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.IssueType.Error & Double = js.native
  
  @js.native
  sealed trait Warning
    extends StObject
       with IssueType
  /* 2 */ val Warning: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.IssueType.Warning & Double = js.native
}
