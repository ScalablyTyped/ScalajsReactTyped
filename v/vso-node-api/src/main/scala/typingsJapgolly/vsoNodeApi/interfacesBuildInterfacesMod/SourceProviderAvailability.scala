...
object SourceProviderAvailability extends StObject {
  ...
  /* 3 */ val All: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.SourceProviderAvailability.All & Double = js.native
  ...
  sealed trait Hosted
    extends StObject
       with SourceProviderAvailability
  /* 1 */ val Hosted: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.SourceProviderAvailability.Hosted & Double = js.native
  ...
  sealed trait OnPremises
    extends StObject
       with SourceProviderAvailability
  /* 2 */ val OnPremises: typingsJapgolly.vsoNodeApi.interfacesBuildInterfacesMod.SourceProviderAvailability.OnPremises & Double = js.native
}
