...
object DashboardScope extends StObject {
  ...
  sealed trait Collection_User
    extends StObject
       with DashboardScope
  /* 0 */ val Collection_User: typingsJapgolly.vsoNodeApi.interfacesDashboardInterfacesMod.DashboardScope.Collection_User & Double = js.native
  
  @js.native
  sealed trait Project_Team
    extends StObject
       with DashboardScope
  /* 1 */ val Project_Team: typingsJapgolly.vsoNodeApi.interfacesDashboardInterfacesMod.DashboardScope.Project_Team & Double = js.native
}
