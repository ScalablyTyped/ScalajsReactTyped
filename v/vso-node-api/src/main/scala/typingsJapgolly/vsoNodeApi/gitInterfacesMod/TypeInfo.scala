...
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonActive
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonAddAdd
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonAllOrNone
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonAndroidStudio
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonAsyncOperationNotFound
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonAttachment
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonAutoMerged
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonBad
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonBadRequest
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonBase64Encoded
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonBranch
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonCaseSensitive
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonChange
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonCodeChange
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonCommit
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonConflicts
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonContains
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonCreateBranchPermissionRequired
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonEncoding
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonFirstParent
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonFolder
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonForcePush
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonFull
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonInProgress_
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonInvalidPath
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonKeepBothFiles
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonKeepSourceDeleteTarget
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonNotApplicable
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonNotSet
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonPartiallyResolved
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonPickSourceAction
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonPrevious
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonPreviousChange
import typingsJapgolly.vsoNodeApi.AnonEnumValuesAnonRename
