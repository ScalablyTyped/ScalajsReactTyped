...
object interfacesCommonVsoBaseInterfacesMod {
  ...
  object IRequestHandler {
    ...
    inline def apply(
      ...
      handleAuthentication: (Any, Any, Any, Any, Any) => Callback,
      prepareRequest: Any => Callback
    ): IRequestHandler = {
      val __obj = js.Dynamic.literal(canHandleAuthentication = js.Any.fromFunction1(canHandleAuthentication), handleAuthentication = js.Any.fromFunction5((t0: Any, t1: Any, t2: Any, t3: Any, t4: Any) => (handleAuthentication(t0, t1, t2, t3, t4)).runNow()), prepareRequest = js.Any.fromFunction1((t0: Any) => prepareRequest(t0).runNow()))
    ...
    extension [Self <: IRequestHandler](x: Self) {
      ...
      inline def setHandleAuthentication(value: (Any, Any, Any, Any, Any) => Callback): Self = StObject.set(x, "handleAuthentication", js.Any.fromFunction5((t0: Any, t1: Any, t2: Any, t3: Any, t4: Any) => (value(t0, t1, t2, t3, t4)).runNow()))
      
      inline def setPrepareRequest(value: Any => Callback): Self = StObject.set(x, "prepareRequest", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
    }
  }
