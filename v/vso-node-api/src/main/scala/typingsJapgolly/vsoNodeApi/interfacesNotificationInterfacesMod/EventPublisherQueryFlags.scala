...
object EventPublisherQueryFlags extends StObject {
  ...
  /* 2 */ val IncludeRemoteServices: typingsJapgolly.vsoNodeApi.interfacesNotificationInterfacesMod.EventPublisherQueryFlags.IncludeRemoteServices & Double = js.native
  
  @js.native
  sealed trait None
    extends StObject
       with EventPublisherQueryFlags
  /* 0 */ val None: typingsJapgolly.vsoNodeApi.interfacesNotificationInterfacesMod.EventPublisherQueryFlags.None & Double = js.native
}
