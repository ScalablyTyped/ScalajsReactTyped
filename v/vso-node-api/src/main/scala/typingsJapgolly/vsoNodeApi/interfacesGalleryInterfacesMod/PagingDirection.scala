...
object PagingDirection extends StObject {
  ...
  /* 1 */ val Backward: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.PagingDirection.Backward & Double = js.native
  ...
  sealed trait Forward
    extends StObject
       with PagingDirection
  /* 2 */ val Forward: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.PagingDirection.Forward & Double = js.native
}
