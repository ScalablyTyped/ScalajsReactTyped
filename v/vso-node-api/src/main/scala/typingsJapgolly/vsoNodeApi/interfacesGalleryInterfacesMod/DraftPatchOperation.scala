...
object DraftPatchOperation extends StObject {
  ...
  /* 2 */ val Cancel: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.DraftPatchOperation.Cancel & Double = js.native
  
  @js.native
  sealed trait Publish
    extends StObject
       with DraftPatchOperation
  /* 1 */ val Publish: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.DraftPatchOperation.Publish & Double = js.native
}
