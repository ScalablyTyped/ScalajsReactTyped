...
object PublisherFlags extends StObject {
  ...
  sealed trait Disabled
    extends StObject
       with PublisherFlags
  /* 1 */ val Disabled: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.PublisherFlags.Disabled & Double = js.native
  ...
  sealed trait None
    extends StObject
       with PublisherFlags
  /* 0 */ val None: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.PublisherFlags.None & Double = js.native
  ...
  sealed trait ServiceFlags
    extends StObject
       with PublisherFlags
  /* 3 */ val ServiceFlags: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.PublisherFlags.ServiceFlags & Double = js.native
  ...
  sealed trait UnChanged
    extends StObject
       with PublisherFlags
  /* 1073741824 */ val UnChanged: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.PublisherFlags.UnChanged & Double = js.native
  ...
  sealed trait Verified
    extends StObject
       with PublisherFlags
  /* 2 */ val Verified: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.PublisherFlags.Verified & Double = js.native
}
