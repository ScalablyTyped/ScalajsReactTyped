...
object ReviewResourceType extends StObject {
  ...
  /* 3 */ val AdminReply: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.ReviewResourceType.AdminReply & Double = js.native
  
  @js.native
  sealed trait PublisherReply
    extends StObject
       with ReviewResourceType
  /* 2 */ val PublisherReply: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.ReviewResourceType.PublisherReply & Double = js.native
  
  @js.native
  sealed trait Review
    extends StObject
       with ReviewResourceType
  /* 1 */ val Review: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.ReviewResourceType.Review & Double = js.native
}
