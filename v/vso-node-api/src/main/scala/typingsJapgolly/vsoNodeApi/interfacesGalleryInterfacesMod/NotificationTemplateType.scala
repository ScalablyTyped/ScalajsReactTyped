...
object NotificationTemplateType extends StObject {
  ...
  /* 3 */ val CustomerContactNotification: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.NotificationTemplateType.CustomerContactNotification & Double = js.native
  ...
  sealed trait PublisherMemberUpdateNotification
    extends StObject
       with NotificationTemplateType
  /* 4 */ val PublisherMemberUpdateNotification: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.NotificationTemplateType.PublisherMemberUpdateNotification & Double = js.native
  ...
  sealed trait QnaNotification
    extends StObject
       with NotificationTemplateType
  /* 2 */ val QnaNotification: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.NotificationTemplateType.QnaNotification & Double = js.native
  ...
  sealed trait ReviewNotification
    extends StObject
       with NotificationTemplateType
  /* 1 */ val ReviewNotification: typingsJapgolly.vsoNodeApi.interfacesGalleryInterfacesMod.NotificationTemplateType.ReviewNotification & Double = js.native
}
