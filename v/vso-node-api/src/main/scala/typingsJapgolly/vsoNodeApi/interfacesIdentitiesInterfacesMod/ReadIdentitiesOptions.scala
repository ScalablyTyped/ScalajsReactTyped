...
object ReadIdentitiesOptions extends StObject {
  ...
  /* 1 */ val FilterIllegalMemberships: typingsJapgolly.vsoNodeApi.interfacesIdentitiesInterfacesMod.ReadIdentitiesOptions.FilterIllegalMemberships & Double = js.native
  
  @js.native
  sealed trait None
    extends StObject
       with ReadIdentitiesOptions
  /* 0 */ val None: typingsJapgolly.vsoNodeApi.interfacesIdentitiesInterfacesMod.ReadIdentitiesOptions.None & Double = js.native
}
