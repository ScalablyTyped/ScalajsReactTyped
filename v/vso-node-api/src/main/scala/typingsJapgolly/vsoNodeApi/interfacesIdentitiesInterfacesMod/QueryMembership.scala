...
object QueryMembership extends StObject {
  ...
  /* 1 */ val Direct: typingsJapgolly.vsoNodeApi.interfacesIdentitiesInterfacesMod.QueryMembership.Direct & Double = js.native
  ...
  sealed trait Expanded
    extends StObject
       with QueryMembership
  /* 2 */ val Expanded: typingsJapgolly.vsoNodeApi.interfacesIdentitiesInterfacesMod.QueryMembership.Expanded & Double = js.native
  ...
  sealed trait ExpandedDown
    extends StObject
       with QueryMembership
  /* 4 */ val ExpandedDown: typingsJapgolly.vsoNodeApi.interfacesIdentitiesInterfacesMod.QueryMembership.ExpandedDown & Double = js.native
  ...
  sealed trait ExpandedUp
    extends StObject
       with QueryMembership
  /* 3 */ val ExpandedUp: typingsJapgolly.vsoNodeApi.interfacesIdentitiesInterfacesMod.QueryMembership.ExpandedUp & Double = js.native
  ...
  sealed trait None
    extends StObject
       with QueryMembership
  /* 0 */ val None: typingsJapgolly.vsoNodeApi.interfacesIdentitiesInterfacesMod.QueryMembership.None & Double = js.native
}
