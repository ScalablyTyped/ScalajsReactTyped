...
import typingsJapgolly.vsoNodeApi.interfacesCommonVssinterfacesMod.ConnectOptions
...
import typingsJapgolly.vsoNodeApi.interfacesLocationsInterfacesMod.ResourceAreaInfo
import typingsJapgolly.vsoNodeApi.interfacesLocationsInterfacesMod.ServiceDefinition
