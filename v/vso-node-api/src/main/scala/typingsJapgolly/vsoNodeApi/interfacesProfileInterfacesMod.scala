...
import typingsJapgolly.vsoNodeApi.anon.EnumValuesLarge
...
object interfacesProfileInterfacesMod {
  ...
  object AvatarSize extends StObject {
    ...
    sealed trait Large
      extends StObject
         with AvatarSize
    /* 2 */ val Large: typingsJapgolly.vsoNodeApi.interfacesProfileInterfacesMod.AvatarSize.Large & Double = js.native
    
    @js.native
    sealed trait Medium
      extends StObject
         with AvatarSize
    /* 1 */ val Medium: typingsJapgolly.vsoNodeApi.interfacesProfileInterfacesMod.AvatarSize.Medium & Double = js.native
    
    @js.native
    sealed trait Small
      extends StObject
         with AvatarSize
    /* 0 */ val Small: typingsJapgolly.vsoNodeApi.interfacesProfileInterfacesMod.AvatarSize.Small & Double = js.native
  }
