...
object DeploymentGroupExpands extends StObject {
  ...
  /* 2 */ val Machines: typingsJapgolly.vsoNodeApi.interfacesTaskAgentInterfacesMod.DeploymentGroupExpands.Machines & Double = js.native
  
  @js.native
  sealed trait None
    extends StObject
       with DeploymentGroupExpands
  /* 0 */ val None: typingsJapgolly.vsoNodeApi.interfacesTaskAgentInterfacesMod.DeploymentGroupExpands.None & Double = js.native
}
