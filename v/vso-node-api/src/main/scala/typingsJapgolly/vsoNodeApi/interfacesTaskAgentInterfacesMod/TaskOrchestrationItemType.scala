...
object TaskOrchestrationItemType extends StObject {
  ...
  /* 0 */ val Container: typingsJapgolly.vsoNodeApi.interfacesTaskAgentInterfacesMod.TaskOrchestrationItemType.Container & Double = js.native
  
  @js.native
  sealed trait Job
    extends StObject
       with TaskOrchestrationItemType
  /* 1 */ val Job: typingsJapgolly.vsoNodeApi.interfacesTaskAgentInterfacesMod.TaskOrchestrationItemType.Job & Double = js.native
}
