...
object AadLoginPromptOption extends StObject {
  ...
  /* 3 */ val FreshLogin: typingsJapgolly.vsoNodeApi.interfacesTaskAgentInterfacesMod.AadLoginPromptOption.FreshLogin & Double = js.native
  ...
  sealed trait Login
    extends StObject
       with AadLoginPromptOption
  /* 1 */ val Login: typingsJapgolly.vsoNodeApi.interfacesTaskAgentInterfacesMod.AadLoginPromptOption.Login & Double = js.native
  ...
  sealed trait NoOption
    extends StObject
       with AadLoginPromptOption
  /* 0 */ val NoOption: typingsJapgolly.vsoNodeApi.interfacesTaskAgentInterfacesMod.AadLoginPromptOption.NoOption & Double = js.native
  ...
  sealed trait SelectAccount
    extends StObject
       with AadLoginPromptOption
  /* 2 */ val SelectAccount: typingsJapgolly.vsoNodeApi.interfacesTaskAgentInterfacesMod.AadLoginPromptOption.SelectAccount & Double = js.native
}
