...
import typingsJapgolly.vsoNodeApi.anon.EnumValuesAny
import typingsJapgolly.vsoNodeApi.anon.EnumValuesCreated
import typingsJapgolly.vsoNodeApi.anon.EnumValuesNone
...
object interfacesFileContainerInterfacesMod {
  ...
  object ContainerItemStatus extends StObject {
    ...
    /* 1 */ val Created: typingsJapgolly.vsoNodeApi.interfacesFileContainerInterfacesMod.ContainerItemStatus.Created & Double = js.native
    ...
    sealed trait PendingUpload
      extends StObject
         with ContainerItemStatus
    /* 2 */ val PendingUpload: typingsJapgolly.vsoNodeApi.interfacesFileContainerInterfacesMod.ContainerItemStatus.PendingUpload & Double = js.native
  }
  ...
  object ContainerItemType extends StObject {
    ...
    /* 0 */ val Any: typingsJapgolly.vsoNodeApi.interfacesFileContainerInterfacesMod.ContainerItemType.Any & Double = js.native
    ...
    sealed trait File
      extends StObject
         with ContainerItemType
    /* 2 */ val File: typingsJapgolly.vsoNodeApi.interfacesFileContainerInterfacesMod.ContainerItemType.File & Double = js.native
    ...
    sealed trait Folder
      extends StObject
         with ContainerItemType
    /* 1 */ val Folder: typingsJapgolly.vsoNodeApi.interfacesFileContainerInterfacesMod.ContainerItemType.Folder & Double = js.native
  }
  ...
  object ContainerOptions extends StObject {
    ...
    /* 0 */ val None: typingsJapgolly.vsoNodeApi.interfacesFileContainerInterfacesMod.ContainerOptions.None & Double = js.native
  }
