...
import typingsJapgolly.vsoNodeApi.anon.EnumValuesHourly
import typingsJapgolly.vsoNodeApi.anon.EnumValuesPreliminary
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object interfacesProjectAnalysisInterfacesMod {
  ...
  object AggregationType extends StObject {
    ...
    /* 1 */ val Daily: typingsJapgolly.vsoNodeApi.interfacesProjectAnalysisInterfacesMod.AggregationType.Daily & Double = js.native
    
    @js.native
    sealed trait Hourly
      extends StObject
         with AggregationType
    /* 0 */ val Hourly: typingsJapgolly.vsoNodeApi.interfacesProjectAnalysisInterfacesMod.AggregationType.Hourly & Double = js.native
  }
  ...
  object ResultPhase extends StObject {
    ...
    sealed trait Full
      extends StObject
         with ResultPhase
    /* 1 */ val Full: typingsJapgolly.vsoNodeApi.interfacesProjectAnalysisInterfacesMod.ResultPhase.Full & Double = js.native
    
    @js.native
    sealed trait Preliminary
      extends StObject
         with ResultPhase
    /* 0 */ val Preliminary: typingsJapgolly.vsoNodeApi.interfacesProjectAnalysisInterfacesMod.ResultPhase.Preliminary & Double = js.native
  }
