...
object ResultObjectType extends StObject {
  ...
  /* 1 */ val TestPlan: typingsJapgolly.vsoNodeApi.interfacesTestInterfacesMod.ResultObjectType.TestPlan & Double = js.native
  
  @js.native
  sealed trait TestSuite
    extends StObject
       with ResultObjectType
  /* 0 */ val TestSuite: typingsJapgolly.vsoNodeApi.interfacesTestInterfacesMod.ResultObjectType.TestSuite & Double = js.native
}
