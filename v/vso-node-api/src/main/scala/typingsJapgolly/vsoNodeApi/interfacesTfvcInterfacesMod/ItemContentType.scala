...
object ItemContentType extends StObject {
  ...
  /* 1 */ val Base64Encoded: typingsJapgolly.vsoNodeApi.interfacesTfvcInterfacesMod.ItemContentType.Base64Encoded & Double = js.native
  
  @js.native
  sealed trait RawText
    extends StObject
       with ItemContentType
  /* 0 */ val RawText: typingsJapgolly.vsoNodeApi.interfacesTfvcInterfacesMod.ItemContentType.RawText & Double = js.native
}
