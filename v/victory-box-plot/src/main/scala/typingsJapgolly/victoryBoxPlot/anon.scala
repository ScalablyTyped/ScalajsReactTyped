...
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.boxWidth
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.datum
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.domain
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.domainPadding
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.eventKey
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.events
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.horizontal
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.labelOrientation
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.labels
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.max
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.maxComponent
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.maxLabelComponent
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.maxLabels
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.median
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.medianComponent
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.medianLabelComponent
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.medianLabels
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.min
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.minComponent
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.minLabelComponent
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.minLabels
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.q1
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.q1Component
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.q1LabelComponent
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.q1Labels
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.q3
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.q3Component
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.q3LabelComponent
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.q3Labels
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.style
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.text
import typingsJapgolly.victoryBoxPlot.victoryBoxPlotStrings.whiskerWidth
...
object anon {
  ...
  trait ContainerComponent extends StObject {
    ...
    var maxComponent: typingsJapgolly.react.mod.global.JSX.Element
    
    var maxLabelComponent: typingsJapgolly.react.mod.global.JSX.Element
    
    var medianComponent: typingsJapgolly.react.mod.global.JSX.Element
    
    var medianLabelComponent: typingsJapgolly.react.mod.global.JSX.Element
    
    var minComponent: typingsJapgolly.react.mod.global.JSX.Element
    
    var minLabelComponent: typingsJapgolly.react.mod.global.JSX.Element
    
    var q1Component: typingsJapgolly.react.mod.global.JSX.Element
    
    var q1LabelComponent: typingsJapgolly.react.mod.global.JSX.Element
    
    var q3Component: typingsJapgolly.react.mod.global.JSX.Element
    
    var q3LabelComponent: typingsJapgolly.react.mod.global.JSX.Element
  ...
  object ContainerComponent {
    ...
    inline def apply(
      ...
      maxComponent: VdomElement,
      maxLabelComponent: VdomElement,
      medianComponent: VdomElement,
      medianLabelComponent: VdomElement,
      minComponent: VdomElement,
      minLabelComponent: VdomElement,
      q1Component: VdomElement,
      q1LabelComponent: VdomElement,
      q3Component: VdomElement,
      q3LabelComponent: VdomElement,
      samples: Double,
      sortKey: String,
      sortOrder: String,
      standalone: Boolean,
      ...
      val __obj = js.Dynamic.literal(containerComponent = containerComponent.rawElement.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any], dataComponent = dataComponent.rawElement.asInstanceOf[js.Any], groupComponent = groupComponent.rawElement.asInstanceOf[js.Any], maxComponent = maxComponent.rawElement.asInstanceOf[js.Any], maxLabelComponent = maxLabelComponent.rawElement.asInstanceOf[js.Any], medianComponent = medianComponent.rawElement.asInstanceOf[js.Any], medianLabelComponent = medianLabelComponent.rawElement.asInstanceOf[js.Any], minComponent = minComponent.rawElement.asInstanceOf[js.Any], minLabelComponent = minLabelComponent.rawElement.asInstanceOf[js.Any], q1Component = q1Component.rawElement.asInstanceOf[js.Any], q1LabelComponent = q1LabelComponent.rawElement.asInstanceOf[js.Any], q3Component = q3Component.rawElement.asInstanceOf[js.Any], q3LabelComponent = q3LabelComponent.rawElement.asInstanceOf[js.Any], samples = samples.asInstanceOf[js.Any], sortKey = sortKey.asInstanceOf[js.Any], sortOrder = sortOrder.asInstanceOf[js.Any], standalone = standalone.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any])
    ...
    extension [Self <: ContainerComponent](x: Self) {
      ...
      inline def setMaxComponent(value: VdomElement): Self = StObject.set(x, "maxComponent", value.rawElement.asInstanceOf[js.Any])
      
      inline def setMaxLabelComponent(value: VdomElement): Self = StObject.set(x, "maxLabelComponent", value.rawElement.asInstanceOf[js.Any])
      
      inline def setMedianComponent(value: VdomElement): Self = StObject.set(x, "medianComponent", value.rawElement.asInstanceOf[js.Any])
      
      inline def setMedianLabelComponent(value: VdomElement): Self = StObject.set(x, "medianLabelComponent", value.rawElement.asInstanceOf[js.Any])
      
      inline def setMinComponent(value: VdomElement): Self = StObject.set(x, "minComponent", value.rawElement.asInstanceOf[js.Any])
      
      inline def setMinLabelComponent(value: VdomElement): Self = StObject.set(x, "minLabelComponent", value.rawElement.asInstanceOf[js.Any])
      
      inline def setQ1Component(value: VdomElement): Self = StObject.set(x, "q1Component", value.rawElement.asInstanceOf[js.Any])
      
      inline def setQ1LabelComponent(value: VdomElement): Self = StObject.set(x, "q1LabelComponent", value.rawElement.asInstanceOf[js.Any])
      
      inline def setQ3Component(value: VdomElement): Self = StObject.set(x, "q3Component", value.rawElement.asInstanceOf[js.Any])
      
      inline def setQ3LabelComponent(value: VdomElement): Self = StObject.set(x, "q3LabelComponent", value.rawElement.asInstanceOf[js.Any])
