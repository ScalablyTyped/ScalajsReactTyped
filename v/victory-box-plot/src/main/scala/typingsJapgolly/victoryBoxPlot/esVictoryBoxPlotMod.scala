...
import typingsJapgolly.victoryBoxPlot.anon.AddGlobalListener
import typingsJapgolly.victoryBoxPlot.anon.Instantiable
import typingsJapgolly.victoryBoxPlot.anon.TypeofVictoryBoxPlotBase
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esVictoryBoxPlotMod {
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("victory-box-plot/es/victory-box-plot", "VictoryBoxPlot")
  @js.native
  ...
  trait VictoryBoxPlotBase
    ...
    def renderBoxPlot(props: Any): Element = js.native
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify VictoryDatableProps * / any */ trait VictoryBoxPlotProps extends StObject {
    ...
    var maxComponent: js.UndefOr[Element] = js.undefined
    
    var maxLabelComponent: js.UndefOr[Element] = js.undefined
    ...
    var medianComponent: js.UndefOr[Element] = js.undefined
    
    var medianLabelComponent: js.UndefOr[Element] = js.undefined
    ...
    var minComponent: js.UndefOr[Element] = js.undefined
    
    var minLabelComponent: js.UndefOr[Element] = js.undefined
    ...
    var q1Component: js.UndefOr[Element] = js.undefined
    
    var q1LabelComponent: js.UndefOr[Element] = js.undefined
    ...
    var q3Component: js.UndefOr[Element] = js.undefined
    
    var q3LabelComponent: js.UndefOr[Element] = js.undefined
  ...
  object VictoryBoxPlotProps {
    ...
    extension [Self <: VictoryBoxPlotProps](x: Self) {
      ...
      inline def setMaxLabelsCallbackTo(value: CallbackTo[Any]): Self = StObject.set(x, "maxLabels", value.toJsFn)
      ...
      inline def setMedianLabelsCallbackTo(value: CallbackTo[Any]): Self = StObject.set(x, "medianLabels", value.toJsFn)
      ...
      inline def setMinLabelsCallbackTo(value: CallbackTo[Any]): Self = StObject.set(x, "minLabels", value.toJsFn)
      ...
      inline def setQ1LabelsCallbackTo(value: CallbackTo[Any]): Self = StObject.set(x, "q1Labels", value.toJsFn)
      ...
      inline def setQ3LabelsCallbackTo(value: CallbackTo[Any]): Self = StObject.set(x, "q3Labels", value.toJsFn)
