...
object mod {
  ...
  object Photo {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(attachFromUrl = js.Any.fromFunction2((t0: String, t1: String) => (attachFromUrl(t0, t1)).runNow()), base64 = base64.asInstanceOf[js.Any], embedFromFile = js.Any.fromFunction1((t0: String) => embedFromFile(t0).runNow()), embedFromString = js.Any.fromFunction2((t0: String, t1: String) => (embedFromString(t0, t1)).runNow()), mediaType = mediaType.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.asInstanceOf[Photo]
    }
    
    extension [Self <: Photo](x: Self) {
      
      inline def setAttachFromUrl(value: (String, String) => Callback): Self = StObject.set(x, "attachFromUrl", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
      
      inline def setBase64(value: Boolean): Self = StObject.set(x, "base64", value.asInstanceOf[js.Any])
      
      inline def setEmbedFromFile(value: String => Callback): Self = StObject.set(x, "embedFromFile", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setEmbedFromString(value: (String, String) => Callback): Self = StObject.set(x, "embedFromString", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
  ...
  object vCard {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(anniversary = anniversary.asInstanceOf[js.Any], birthday = birthday.asInstanceOf[js.Any], cellPhone = cellPhone.asInstanceOf[js.Any], email = email.asInstanceOf[js.Any], firstName = firstName.asInstanceOf[js.Any], formattedName = formattedName.asInstanceOf[js.Any], gender = gender.asInstanceOf[js.Any], getFormattedString = getFormattedString.toJsFn, getMajorVersion = getMajorVersion.toJsFn, homeAddress = homeAddress.asInstanceOf[js.Any], homeFax = homeFax.asInstanceOf[js.Any], homePhone = homePhone.asInstanceOf[js.Any], isOrganization = isOrganization.asInstanceOf[js.Any], lastName = lastName.asInstanceOf[js.Any], logo = logo.asInstanceOf[js.Any], middleName = middleName.asInstanceOf[js.Any], namePrefix = namePrefix.asInstanceOf[js.Any], nameSuffix = nameSuffix.asInstanceOf[js.Any], nickname = nickname.asInstanceOf[js.Any], note = note.asInstanceOf[js.Any], organization = organization.asInstanceOf[js.Any], otherEmail = otherEmail.asInstanceOf[js.Any], otherPhone = otherPhone.asInstanceOf[js.Any], pagerPhone = pagerPhone.asInstanceOf[js.Any], photo = photo.asInstanceOf[js.Any], role = role.asInstanceOf[js.Any], saveToFile = js.Any.fromFunction1((t0: String) => saveToFile(t0).runNow()), socialUrls = socialUrls.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any], uid = uid.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any], workAddress = workAddress.asInstanceOf[js.Any], workEmail = workEmail.asInstanceOf[js.Any], workFax = workFax.asInstanceOf[js.Any], workPhone = workPhone.asInstanceOf[js.Any], workUrl = workUrl.asInstanceOf[js.Any])
    ...
    extension [Self <: vCard](x: Self) {
      ...
      inline def setGetFormattedString(value: CallbackTo[String]): Self = StObject.set(x, "getFormattedString", value.toJsFn)
      ...
      inline def setSaveToFile(value: String => Callback): Self = StObject.set(x, "saveToFile", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
