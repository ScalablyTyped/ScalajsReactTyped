...
object StatusBarItem {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(alignment = alignment.asInstanceOf[js.Any], dispose = dispose.toJsFn, hide = hide.toJsFn, id = id.asInstanceOf[js.Any], show = show.toJsFn, text = text.asInstanceOf[js.Any])
