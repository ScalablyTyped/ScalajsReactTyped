...
object NotebookCellStatusBarAlignment extends StObject {
  ...
  /* 1 */ val Left: typingsJapgolly.vscode.mod.NotebookCellStatusBarAlignment.Left & Double = js.native
  ...
  sealed trait Right
    extends StObject
       with NotebookCellStatusBarAlignment
  /* 2 */ val Right: typingsJapgolly.vscode.mod.NotebookCellStatusBarAlignment.Right & Double = js.native
}
