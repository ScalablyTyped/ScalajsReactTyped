...
object InlayHintKind extends StObject {
  ...
  sealed trait Parameter
    extends StObject
       with InlayHintKind
  /* 2 */ val Parameter: typingsJapgolly.vscode.mod.InlayHintKind.Parameter & Double = js.native
  ...
  sealed trait Type
    extends StObject
       with InlayHintKind
  /* 1 */ val Type: typingsJapgolly.vscode.mod.InlayHintKind.Type & Double = js.native
}
