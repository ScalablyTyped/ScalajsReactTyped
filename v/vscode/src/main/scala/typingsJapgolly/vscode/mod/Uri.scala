...
import typingsJapgolly.vscode.anon.Authority
import typingsJapgolly.vscode.anon.Fragment
...
object Uri {
  ...
  /**
    ...
    * @return A new Uri instance.
    */
  inline def from(components: Authority): Uri = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(components.asInstanceOf[js.Any]).asInstanceOf[Uri]
