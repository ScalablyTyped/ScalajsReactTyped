...
object Extension {
  ...
  inline def apply[T](
    ...
    val __obj = js.Dynamic.literal(activate = activate.toJsFn, exports = exports.asInstanceOf[js.Any], extensionKind = extensionKind.asInstanceOf[js.Any], extensionPath = extensionPath.asInstanceOf[js.Any], extensionUri = extensionUri.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], isActive = isActive.asInstanceOf[js.Any], packageJSON = packageJSON.asInstanceOf[js.Any])
    __obj.asInstanceOf[Extension[T]]
  }
  
  extension [Self <: Extension[?], T](x: Self & Extension[T]) {
    
    inline def setActivate(value: CallbackTo[Thenable[T]]): Self = StObject.set(x, "activate", value.toJsFn)
