...
object InputBoxOptions {
  ...
  def apply(
    ...
    prompt: String = null,
    validateInput: /* value */ String => CallbackTo[js.UndefOr[String | Null | (Thenable[js.UndefOr[String | Null]])]] = null,
    value: String = null,
    ...
    if (validateInput != null) __obj.updateDynamic("validateInput")(js.Any.fromFunction1((t0: /* value */ java.lang.String) => validateInput(t0).runNow()))
