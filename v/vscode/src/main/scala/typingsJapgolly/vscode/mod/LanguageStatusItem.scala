...
object LanguageStatusItem {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(busy = busy.asInstanceOf[js.Any], dispose = dispose.toJsFn, id = id.asInstanceOf[js.Any], selector = selector.asInstanceOf[js.Any], severity = severity.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any])
