...
object TestRunProfile {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(dispose = dispose.toJsFn, isDefault = isDefault.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any], runHandler = js.Any.fromFunction2(runHandler))
    __obj.asInstanceOf[TestRunProfile]
  }
  
  extension [Self <: TestRunProfile](x: Self) {
    
    inline def setConfigureHandler(value: Callback): Self = StObject.set(x, "configureHandler", value.toJsFn)
