...
object InlineCompletionTriggerKind extends StObject {
  ...
  /* 1 */ val Automatic: typingsJapgolly.vscode.mod.InlineCompletionTriggerKind.Automatic & Double = js.native
  ...
  sealed trait Invoke
    extends StObject
       with InlineCompletionTriggerKind
  /* 0 */ val Invoke: typingsJapgolly.vscode.mod.InlineCompletionTriggerKind.Invoke & Double = js.native
}
