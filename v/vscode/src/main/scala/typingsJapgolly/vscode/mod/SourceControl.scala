...
object SourceControl {
  @scala.inline
  def apply(
    createResourceGroup: (String, String) => CallbackTo[SourceControlResourceGroup],
    dispose: Callback,
    id: String,
    ...
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], inputBox = inputBox.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any])
    __obj.updateDynamic("createResourceGroup")(js.Any.fromFunction2((t0: java.lang.String, t1: java.lang.String) => createResourceGroup(t0, t1).runNow()))
