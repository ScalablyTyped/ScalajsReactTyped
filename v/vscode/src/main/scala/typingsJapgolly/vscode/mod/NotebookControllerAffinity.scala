...
object NotebookControllerAffinity extends StObject {
  ...
  /* 1 */ val Default: typingsJapgolly.vscode.mod.NotebookControllerAffinity.Default & Double = js.native
  ...
  sealed trait Preferred
    extends StObject
       with NotebookControllerAffinity
  /* 2 */ val Preferred: typingsJapgolly.vscode.mod.NotebookControllerAffinity.Preferred & Double = js.native
}
