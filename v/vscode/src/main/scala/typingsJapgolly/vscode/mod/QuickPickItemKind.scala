...
object QuickPickItemKind extends StObject {
  ...
  /* 0 */ val Default: typingsJapgolly.vscode.mod.QuickPickItemKind.Default & Double = js.native
  ...
  sealed trait Separator
    extends StObject
       with QuickPickItemKind
  /* -1 */ val Separator: typingsJapgolly.vscode.mod.QuickPickItemKind.Separator & Double = js.native
}
