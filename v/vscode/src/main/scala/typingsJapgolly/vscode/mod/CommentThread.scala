...
object CommentThread {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(canReply = canReply.asInstanceOf[js.Any], collapsibleState = collapsibleState.asInstanceOf[js.Any], comments = comments.asInstanceOf[js.Any], dispose = dispose.toJsFn, range = range.asInstanceOf[js.Any], uri = uri.asInstanceOf[js.Any])
