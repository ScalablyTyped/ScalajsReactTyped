...
object TerminalLocation extends StObject {
  ...
  /* 2 */ val Editor: typingsJapgolly.vscode.mod.TerminalLocation.Editor & Double = js.native
  ...
  sealed trait Panel
    extends StObject
       with TerminalLocation
  /* 1 */ val Panel: typingsJapgolly.vscode.mod.TerminalLocation.Panel & Double = js.native
}
