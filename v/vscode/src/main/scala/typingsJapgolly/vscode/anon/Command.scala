...
trait Command extends StObject {
  ...
  /**
    ...
    */
  val command: typingsJapgolly.vscode.mod.Command
...
object Command {
  ...
  inline def apply(command: typingsJapgolly.vscode.mod.Command, kind: CodeActionKind): Command = {
  ...
  extension [Self <: Command](x: Self) {
    ...
    inline def setCommand(value: typingsJapgolly.vscode.mod.Command): Self = StObject.set(x, "command", value.asInstanceOf[js.Any])
