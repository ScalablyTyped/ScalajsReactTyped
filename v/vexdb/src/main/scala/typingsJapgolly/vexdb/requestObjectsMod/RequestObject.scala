...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.vexdb.requestObjectsMod.TeamsRequestObject
  - typingsJapgolly.vexdb.requestObjectsMod.EventsRequestObject
  - typingsJapgolly.vexdb.requestObjectsMod.MatchesRequestObject
  - typingsJapgolly.vexdb.requestObjectsMod.RankingsRequestObject
  - typingsJapgolly.vexdb.requestObjectsMod.SeasonRankingsRequestObject
  - typingsJapgolly.vexdb.requestObjectsMod.AwardsRequestObject
  - typingsJapgolly.vexdb.requestObjectsMod.SkillsRequestObject
*/
