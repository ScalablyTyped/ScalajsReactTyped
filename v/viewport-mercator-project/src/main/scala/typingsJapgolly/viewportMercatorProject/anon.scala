...
import typingsJapgolly.viewportMercatorProject.mod.CoordinatesZ
...
object anon {
  ...
  trait Bounds extends StObject {
    ...
    var bounds: typingsJapgolly.viewportMercatorProject.mod.Bounds
  ...
  object Bounds {
    ...
    inline def apply(bounds: typingsJapgolly.viewportMercatorProject.mod.Bounds, height: Double, width: Double): Bounds = {
    ...
    extension [Self <: Bounds](x: Self) {
      ...
      inline def setBounds(value: typingsJapgolly.viewportMercatorProject.mod.Bounds): Self = StObject.set(x, "bounds", value.asInstanceOf[js.Any])
