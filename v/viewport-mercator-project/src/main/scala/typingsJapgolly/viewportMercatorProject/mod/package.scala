...
import typingsJapgolly.viewportMercatorProject.anon.Altitude
import typingsJapgolly.viewportMercatorProject.anon.Bottom
import typingsJapgolly.viewportMercatorProject.anon.Latitude
import typingsJapgolly.viewportMercatorProject.mod.^
...
inline def fitBounds(options: typingsJapgolly.viewportMercatorProject.anon.Bounds): FittedBounds = ^.asInstanceOf[js.Dynamic].applyDynamic("fitBounds")(options.asInstanceOf[js.Any]).asInstanceOf[FittedBounds]
