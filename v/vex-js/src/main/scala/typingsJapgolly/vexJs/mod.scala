...
object mod extends Shortcut {
  ...
  object IVexOptions {
    ...
    extension [Self <: IVexOptions](x: Self) {
      ...
      inline def setAfterOpen(value: /* vexContent */ JQuery[HTMLElement] => Callback): Self = StObject.set(x, "afterOpen", js.Any.fromFunction1((t0: /* vexContent */ JQuery[HTMLElement]) => value(t0).runNow()))
