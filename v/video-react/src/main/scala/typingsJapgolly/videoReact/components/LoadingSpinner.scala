...
object LoadingSpinner {
  ...
  @JSImport("video-react", "LoadingSpinner")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LoadingSpinner.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
