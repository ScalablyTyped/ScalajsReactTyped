...
import typingsJapgolly.vkOpenapi.vk.OpenAPI.Nullable
...
trait API extends StObject {
  ...
  def CommunityMessages(elementId: String, groupId: Double): typingsJapgolly.vkOpenapi.vk.OpenAPI.Widgets.CommunityMessages = js.native
  def CommunityMessages(elementId: String, groupId: Double, options: CommunityMessagesOptions): typingsJapgolly.vkOpenapi.vk.OpenAPI.Widgets.CommunityMessages = js.native
