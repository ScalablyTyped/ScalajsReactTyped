...
object CommunityMessagesOptions {
  ...
  extension [Self <: CommunityMessagesOptions](x: Self) {
    ...
    inline def setOnCanNotWrite(value: /* reason */ OnCanNotWriteReason => Callback): Self = StObject.set(x, "onCanNotWrite", js.Any.fromFunction1((t0: /* reason */ OnCanNotWriteReason) => value(t0).runNow()))
