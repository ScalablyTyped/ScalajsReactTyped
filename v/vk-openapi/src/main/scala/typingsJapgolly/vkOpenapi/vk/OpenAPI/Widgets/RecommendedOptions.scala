...
import typingsJapgolly.vkOpenapi.vkOpenapiStrings.day
import typingsJapgolly.vkOpenapi.vkOpenapiStrings.month
import typingsJapgolly.vkOpenapi.vkOpenapiStrings.week
