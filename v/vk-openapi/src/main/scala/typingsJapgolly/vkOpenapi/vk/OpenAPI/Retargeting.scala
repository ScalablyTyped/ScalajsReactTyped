...
object Retargeting {
  ...
  trait API extends StObject {
    ...
    def ProductEvent(priceListId: Double, eventName: typingsJapgolly.vkOpenapi.vk.OpenAPI.Retargeting.ProductEvent): Unit = js.native
    def ProductEvent(
      priceListId: Double,
      eventName: typingsJapgolly.vkOpenapi.vk.OpenAPI.Retargeting.ProductEvent,
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_home
    - typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_category
    - typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_product
    - typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_search
    - typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_other
    - typingsJapgolly.vkOpenapi.vkOpenapiStrings.add_to_wishlist
    - typingsJapgolly.vkOpenapi.vkOpenapiStrings.add_to_cart
    - typingsJapgolly.vkOpenapi.vkOpenapiStrings.remove_from_wishlist
    - typingsJapgolly.vkOpenapi.vkOpenapiStrings.remove_from_cart
    - typingsJapgolly.vkOpenapi.vkOpenapiStrings.init_checkout
  ...
  */
  ...
  object ProductEvent {
    ...
    inline def init_checkout: typingsJapgolly.vkOpenapi.vkOpenapiStrings.init_checkout = "init_checkout".asInstanceOf[typingsJapgolly.vkOpenapi.vkOpenapiStrings.init_checkout]
    ...
    inline def remove_from_cart: typingsJapgolly.vkOpenapi.vkOpenapiStrings.remove_from_cart = "remove_from_cart".asInstanceOf[typingsJapgolly.vkOpenapi.vkOpenapiStrings.remove_from_cart]
    
    inline def remove_from_wishlist: typingsJapgolly.vkOpenapi.vkOpenapiStrings.remove_from_wishlist = "remove_from_wishlist".asInstanceOf[typingsJapgolly.vkOpenapi.vkOpenapiStrings.remove_from_wishlist]
    
    inline def view_category: typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_category = "view_category".asInstanceOf[typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_category]
    
    inline def view_home: typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_home = "view_home".asInstanceOf[typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_home]
    
    inline def view_other: typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_other = "view_other".asInstanceOf[typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_other]
    
    inline def view_product: typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_product = "view_product".asInstanceOf[typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_product]
    
    inline def view_search: typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_search = "view_search".asInstanceOf[typingsJapgolly.vkOpenapi.vkOpenapiStrings.view_search]
  }
