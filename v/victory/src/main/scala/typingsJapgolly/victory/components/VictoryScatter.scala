...
import typingsJapgolly.victory.mod.VictoryScatterProps
...
object VictoryScatter {
  def apply(
    ...
    VictoryScatterProps, 
    typingsJapgolly.victory.mod.VictoryScatter, 
    Unit, 
    VictoryScatterProps
  ] = {
  ...
  typingsJapgolly.victory.mod.VictoryScatterProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.victory.mod.VictoryScatter](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.victory.mod.VictoryScatterProps])(children: _*)
  }
