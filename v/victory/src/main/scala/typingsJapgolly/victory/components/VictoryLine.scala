...
import typingsJapgolly.victory.mod.VictoryLineProps
...
object VictoryLine {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[VictoryLineProps, typingsJapgolly.victory.mod.VictoryLine, Unit, VictoryLineProps] = {
  ...
  typingsJapgolly.victory.mod.VictoryLineProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.victory.mod.VictoryLine](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.victory.mod.VictoryLineProps])(children: _*)
  }
