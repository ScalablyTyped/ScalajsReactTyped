...
import typingsJapgolly.victory.AnonBottom
...
import typingsJapgolly.victory.mod.VictoryBarProps
...
import typingsJapgolly.victory.victoryStrings.end
import typingsJapgolly.victory.victoryStrings.labels
import typingsJapgolly.victory.victoryStrings.middle
import typingsJapgolly.victory.victoryStrings.parent
import typingsJapgolly.victory.victoryStrings.start
...
object VictoryBar {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[VictoryBarProps, typingsJapgolly.victory.mod.VictoryBar, Unit, VictoryBarProps] = {
  ...
  typingsJapgolly.victory.mod.VictoryBarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.victory.mod.VictoryBar](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.victory.mod.VictoryBarProps])(children: _*)
  }
