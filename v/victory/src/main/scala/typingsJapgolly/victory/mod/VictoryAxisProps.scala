...
trait VictoryAxisProps extends VictoryCommonProps {
  /**
    ...
    * @default <AxisLine/>
    */
  var axisComponent: js.UndefOr[Element] = js.undefined
  /**
    ...
    */
  var axisLabelComponent: js.UndefOr[Element] = js.undefined
  /**
  ...
  /**
    ...
    * @default <Tick/>
    */
  var tickComponent: js.UndefOr[Element] = js.undefined
  /**
  ...
  /**
    ...
    * @default <VictoryLabel/>
    */
  var tickLabelComponent: js.UndefOr[Element] = js.undefined
  /**
