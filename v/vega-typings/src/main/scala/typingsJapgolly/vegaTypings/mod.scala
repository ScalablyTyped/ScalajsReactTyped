...
import typingsJapgolly.vegaTypings.typesRuntimeMod.ViewOptions
...
object mod {
  ...
  @js.native
  open class Bounds ()
    extends typingsJapgolly.vegaTypings.typesRuntimeMod.Bounds
  
  @JSImport("vega-typings", "CanvasHandler")
  @js.native
  open class CanvasHandler ()
    extends typingsJapgolly.vegaTypings.typesRuntimeMod.CanvasHandler
  ...
  @js.native
  open class Handler ()
    extends typingsJapgolly.vegaTypings.typesRuntimeMod.Handler
  ...
  @js.native
  open class Operator ()
    extends typingsJapgolly.vegaTypings.typesRuntimeMod.Operator {
  ...
  open class Renderer protected ()
    extends typingsJapgolly.vegaTypings.typesRuntimeMod.Renderer {
  ...
  open class Transform ()
    extends typingsJapgolly.vegaTypings.typesRuntimeMod.Transform {
    def this(init: Any) = this()
  ...
  open class View protected ()
    extends typingsJapgolly.vegaTypings.typesRuntimeMod.View {
  ...
  inline def projection(`type`: String, projection: Any): typingsJapgolly.vegaTypings.typesRuntimeMod.View = (^.asInstanceOf[js.Dynamic].applyDynamic("projection")(`type`.asInstanceOf[js.Any], projection.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.vegaTypings.typesRuntimeMod.View]
