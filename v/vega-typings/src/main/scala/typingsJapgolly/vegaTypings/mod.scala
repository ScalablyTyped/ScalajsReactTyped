...
object mod extends js.Object {
  ...
  @js.native
  class Operator ()
    extends typingsJapgolly.vegaTypings.runtimeMod.Operator {
  ...
  class Renderer protected ()
    extends typingsJapgolly.vegaTypings.runtimeMod.Renderer {
    def this(loader: Loader_) = this()
  }
  
  @js.native
  class Transform ()
    extends typingsJapgolly.vegaTypings.runtimeMod.Transform {
    def this(init: js.Any) = this()
  ...
  class View protected ()
    extends typingsJapgolly.vegaTypings.runtimeMod.View {
