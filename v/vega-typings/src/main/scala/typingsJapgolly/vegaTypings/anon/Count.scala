...
trait Count
  ...
  var gradient: typingsJapgolly.vegaTypings.typesSpecEncodeMod.Field
...
object Count {
  ...
  inline def apply(gradient: typingsJapgolly.vegaTypings.typesSpecEncodeMod.Field): Count = {
  ...
  extension [Self <: Count](x: Self) {
    ...
    inline def setGradient(value: typingsJapgolly.vegaTypings.typesSpecEncodeMod.Field): Self = StObject.set(x, "gradient", value.asInstanceOf[js.Any])
