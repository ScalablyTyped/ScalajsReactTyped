...
import typingsJapgolly.vegaTypings.vegaTypingsStrings.timer
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined // from parsers/stream.js:eventStream -> scope.event
{  source :'timer',   type :number} & {  id :vega-typings.vega-typings/types/runtime/runtime.ID,   between :[vega-typings.vega-typings/types/runtime/runtime.ID, vega-typings.vega-typings/types/runtime/runtime.ID] | undefined,   filter :vega-typings.vega-typings/types/runtime/runtime.expr | undefined,   throttle :number | undefined,   debounce :number | undefined,   consume :true | undefined} */
trait sourcetimertypenumberidID
  extends StObject
     with Stream {
...
object sourcetimertypenumberidID {
  
  inline def apply(id: ID, `type`: Double): sourcetimertypenumberidID = {
  ...
  extension [Self <: sourcetimertypenumberidID](x: Self) {
    ...
    inline def setSource(value: timer): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
