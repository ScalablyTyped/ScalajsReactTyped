...
import typingsJapgolly.vegaTypings.typesSpecEncodeMod.Encode
...
import typingsJapgolly.vegaTypings.typesSpecLegendMod.GuideEncodeEntry
...
object typesSpecTitleMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.vegaTypings.vegaTypingsStrings.middle
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaTypings.vegaTypingsStrings.bounds
    - typingsJapgolly.vegaTypings.vegaTypingsStrings.group
  */
  trait TitleFrame extends StObject
  object TitleFrame {
    
    inline def bounds: typingsJapgolly.vegaTypings.vegaTypingsStrings.bounds = "bounds".asInstanceOf[typingsJapgolly.vegaTypings.vegaTypingsStrings.bounds]
    
    inline def group: typingsJapgolly.vegaTypings.vegaTypingsStrings.group = "group".asInstanceOf[typingsJapgolly.vegaTypings.vegaTypingsStrings.group]
  }
