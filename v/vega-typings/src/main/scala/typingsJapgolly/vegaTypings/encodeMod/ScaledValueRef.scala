...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.vegaTypings.encodeMod.BaseValueRef[T]
  - typingsJapgolly.vegaTypings.AnonScale
  - typingsJapgolly.vegaTypings.AnonFieldScale
  - typingsJapgolly.vegaTypings.AnonBand
  - typingsJapgolly.vegaTypings.AnonRange
*/
