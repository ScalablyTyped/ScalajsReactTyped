...
import typingsJapgolly.vegaExpression.mod.CodegenOptions
import typingsJapgolly.vegaTypings.anon.Ast
import typingsJapgolly.vegaTypings.anon.Data
import typingsJapgolly.vegaTypings.anon.Fill
import typingsJapgolly.vegaTypings.anon.Href
import typingsJapgolly.vegaTypings.anon.Signals
import typingsJapgolly.vegaTypings.typesRuntimeDataflowMod.Changeset_
import typingsJapgolly.vegaTypings.typesRuntimeRendererMod.RenderModule_
...
import typingsJapgolly.vegaTypings.typesRuntimeSceneMod.Scene
import typingsJapgolly.vegaTypings.typesRuntimeSceneMod.SceneGroup
...
import typingsJapgolly.vegaTypings.typesSpecConfigMod.Config
...
import typingsJapgolly.vegaTypings.vegaTypingsStrings.DEBUG
import typingsJapgolly.vegaTypings.vegaTypingsStrings.ERROR
import typingsJapgolly.vegaTypings.vegaTypingsStrings.INFO
import typingsJapgolly.vegaTypings.vegaTypingsStrings.WARN
import typingsJapgolly.vegaTypings.vegaTypingsStrings.`axis-label`
import typingsJapgolly.vegaTypings.vegaTypingsStrings.`legend-label`
import typingsJapgolly.vegaTypings.vegaTypingsStrings.`legend-symbol`
...
import typingsJapgolly.vegaTypings.vegaTypingsStrings.error_
...
import typingsJapgolly.vegaTypings.vegaTypingsStrings.mark
...
import typingsJapgolly.vegaTypings.vegaTypingsStrings.warn_
...
object typesRuntimeMod {
  ...
  @js.native
  open class Bounds ()
    extends typingsJapgolly.vegaTypings.typesRuntimeSceneMod.Bounds
  
  @JSImport("vega-typings/types/runtime", "CanvasHandler")
  @js.native
  open class CanvasHandler ()
    extends typingsJapgolly.vegaTypings.typesRuntimeRendererMod.CanvasHandler
  ...
  @js.native
  open class Handler ()
    extends typingsJapgolly.vegaTypings.typesRuntimeRendererMod.Handler
  ...
  @js.native
  open class Operator ()
    extends typingsJapgolly.vegaTypings.typesRuntimeDataflowMod.Operator {
  ...
  open class Renderer protected ()
    extends typingsJapgolly.vegaTypings.typesRuntimeRendererMod.Renderer {
  ...
  open class Transform ()
    extends typingsJapgolly.vegaTypings.typesRuntimeDataflowMod.Transform {
    def this(init: Any) = this()
  ...
  inline def log(
    method: error_ | warn_ | typingsJapgolly.vegaTypings.vegaTypingsStrings.log,
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaTypings.typesSpecDataMod.DataType
    - typingsJapgolly.vegaTypings.vegaTypingsStrings.integer
  */
