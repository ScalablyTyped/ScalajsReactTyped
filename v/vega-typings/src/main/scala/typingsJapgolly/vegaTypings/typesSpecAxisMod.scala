...
object typesSpecAxisMod {
  ...
  */
  ...
  object FormatType {
    ...
    inline def time: typingsJapgolly.vegaTypings.vegaTypingsStrings.time = "time".asInstanceOf[typingsJapgolly.vegaTypings.vegaTypingsStrings.time]
    
    inline def utc: typingsJapgolly.vegaTypings.vegaTypingsStrings.utc = "utc".asInstanceOf[typingsJapgolly.vegaTypings.vegaTypingsStrings.utc]
  }
  
  /* Rewritten from type alias, can be one of: 
    - scala.Boolean
    - typingsJapgolly.vegaTypings.vegaTypingsStrings.parity
    - typingsJapgolly.vegaTypings.vegaTypingsStrings.greedy
  */
  type LabelOverlap = _LabelOverlap | Boolean
  
  /* Rewritten from type alias, can be one of: 
    - scala.Double
    - typingsJapgolly.vegaTypings.typesSpecScaleMod.TimeInterval
    - typingsJapgolly.vegaTypings.typesSpecScaleMod.TimeIntervalStep
