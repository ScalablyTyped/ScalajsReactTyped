...
object typesSpecBindMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaTypings.typesSpecBindMod.BindCheckbox
    - typingsJapgolly.vegaTypings.typesSpecBindMod.BindRadioSelect
    - typingsJapgolly.vegaTypings.typesSpecBindMod.BindRange
    - typingsJapgolly.vegaTypings.typesSpecBindMod.BindInput
    - typingsJapgolly.vegaTypings.typesSpecBindMod.BindDirect
  */
  trait Binding extends StObject
  object Binding {
    
    inline def BindCheckbox(): typingsJapgolly.vegaTypings.typesSpecBindMod.BindCheckbox = {
      val __obj = js.Dynamic.literal(input = "checkbox")
      __obj.asInstanceOf[typingsJapgolly.vegaTypings.typesSpecBindMod.BindCheckbox]
    }
    
    inline def BindDirect(element: Element | EventTarget): typingsJapgolly.vegaTypings.typesSpecBindMod.BindDirect = {
      val __obj = js.Dynamic.literal(element = element.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaTypings.typesSpecBindMod.BindDirect]
    }
    
    inline def BindInput(): typingsJapgolly.vegaTypings.typesSpecBindMod.BindInput = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.vegaTypings.typesSpecBindMod.BindInput]
    }
    
    inline def BindRadioSelect(input: radio | select, options: js.Array[Any]): typingsJapgolly.vegaTypings.typesSpecBindMod.BindRadioSelect = {
      val __obj = js.Dynamic.literal(input = input.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vegaTypings.typesSpecBindMod.BindRadioSelect]
    }
    
    inline def BindRange(): typingsJapgolly.vegaTypings.typesSpecBindMod.BindRange = {
      val __obj = js.Dynamic.literal(input = "range")
      __obj.asInstanceOf[typingsJapgolly.vegaTypings.typesSpecBindMod.BindRange]
    }
  }
