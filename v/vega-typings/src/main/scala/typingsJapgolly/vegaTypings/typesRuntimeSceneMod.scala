...
import typingsJapgolly.vegaTypings.anon.Index
import typingsJapgolly.vegaTypings.vegaTypingsStrings.bottom
import typingsJapgolly.vegaTypings.vegaTypingsStrings.left
import typingsJapgolly.vegaTypings.vegaTypingsStrings.ltr
import typingsJapgolly.vegaTypings.vegaTypingsStrings.right
import typingsJapgolly.vegaTypings.vegaTypingsStrings.rtl
import typingsJapgolly.vegaTypings.vegaTypingsStrings.top
...
object typesRuntimeSceneMod {
  ...
  object SceneAxis {
    ...
    inline def apply(
      bounds: Bounds,
      mark: typingsJapgolly.vegaTypings.anon.Bounds,
  ...
  trait SceneItem extends StObject {
    ...
    var mark: typingsJapgolly.vegaTypings.anon.Bounds
  ...
  object SceneItem {
    ...
    inline def apply(bounds: Bounds, mark: typingsJapgolly.vegaTypings.anon.Bounds, x: Double, y: Double): SceneItem = {
    ...
    extension [Self <: SceneItem](x: Self) {
      ...
      inline def setMark(value: typingsJapgolly.vegaTypings.anon.Bounds): Self = StObject.set(x, "mark", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.vegaTypings.vegaTypingsStrings.center
    - typingsJapgolly.vegaTypings.vegaTypingsStrings.right
  */
  trait SceneTextAlign extends StObject
  object SceneTextAlign {
    
    inline def center: typingsJapgolly.vegaTypings.vegaTypingsStrings.center = "center".asInstanceOf[typingsJapgolly.vegaTypings.vegaTypingsStrings.center]
  ...
  */
  ...
  object SceneTextBaseline {
    ...
    inline def middle: typingsJapgolly.vegaTypings.vegaTypingsStrings.middle = "middle".asInstanceOf[typingsJapgolly.vegaTypings.vegaTypingsStrings.middle]
