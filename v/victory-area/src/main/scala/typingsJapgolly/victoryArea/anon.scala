...
object anon {
  ...
  trait Animate extends StObject {
    ...
    var label: typingsJapgolly.propTypes.mod.Validator[js.UndefOr[String | Null]]
  ...
  object Animate {
    ...
    inline def apply(
      ...
      label: typingsJapgolly.propTypes.mod.Validator[js.UndefOr[String | Null]]
    ): Animate = {
    ...
    extension [Self <: Animate](x: Self) {
      ...
      inline def setLabel(value: typingsJapgolly.propTypes.mod.Validator[js.UndefOr[String | Null]]): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
  ...
  object ContainerComponent {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(containerComponent = containerComponent.rawElement.asInstanceOf[js.Any], dataComponent = dataComponent.rawElement.asInstanceOf[js.Any], groupComponent = groupComponent.rawElement.asInstanceOf[js.Any], labelComponent = labelComponent.rawElement.asInstanceOf[js.Any], samples = samples.asInstanceOf[js.Any], sortKey = sortKey.asInstanceOf[js.Any], sortOrder = sortOrder.asInstanceOf[js.Any], standalone = standalone.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any])
