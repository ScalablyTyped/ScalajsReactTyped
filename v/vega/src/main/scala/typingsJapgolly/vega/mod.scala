...
import typingsJapgolly.vega.vegaInts.`0`
import typingsJapgolly.vega.vegaInts.`1`
import typingsJapgolly.vega.vegaStrings.DEBUG
import typingsJapgolly.vega.vegaStrings.ERROR
import typingsJapgolly.vega.vegaStrings.INFO
import typingsJapgolly.vega.vegaStrings.WARN
import typingsJapgolly.vega.vegaStrings.center
import typingsJapgolly.vega.vegaStrings.error_
import typingsJapgolly.vega.vegaStrings.left
import typingsJapgolly.vega.vegaStrings.log
import typingsJapgolly.vega.vegaStrings.right
import typingsJapgolly.vega.vegaStrings.warn_
...
object mod {
  ...
  @js.native
  open class Bounds ()
    extends typingsJapgolly.vegaTypings.mod.Bounds
  
  @JSImport("vega", "CanvasHandler")
  @js.native
  open class CanvasHandler ()
    extends typingsJapgolly.vegaTypings.mod.CanvasHandler
  ...
  @js.native
  open class Handler ()
    extends typingsJapgolly.vegaTypings.mod.Handler
  ...
  inline def log(
    method: error_ | warn_ | typingsJapgolly.vega.vegaStrings.log,
