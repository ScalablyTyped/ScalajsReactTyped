...
import typingsJapgolly.vegas.mod.AlignType
import typingsJapgolly.vegas.mod.Animation
import typingsJapgolly.vegas.mod.AnimationType
import typingsJapgolly.vegas.mod.Duration
import typingsJapgolly.vegas.mod.Settings
import typingsJapgolly.vegas.mod.Slide
import typingsJapgolly.vegas.mod.Transition
import typingsJapgolly.vegas.mod.TransitionType
...
object anon {
  ...
  object ReadonlySettings {
    ...
    extension [Self <: ReadonlySettings](x: Self) {
      ...
      inline def setInit(value: /* settings */ Settings => Callback): Self = StObject.set(x, "init", js.Any.fromFunction1((t0: /* settings */ Settings) => value(t0).runNow()))
