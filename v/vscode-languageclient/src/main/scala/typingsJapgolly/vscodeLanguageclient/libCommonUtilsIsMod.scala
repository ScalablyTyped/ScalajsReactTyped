...
object libCommonUtilsIsMod {
  ...
  @JSImport("vscode-languageclient/lib/common/utils/is", JSImport.Namespace)
  @js.native
  ...
  inline def thenable[T](value: Any): /* is vscode.Thenable<T> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("thenable")(value.asInstanceOf[js.Any]).asInstanceOf[/* is vscode.Thenable<T> */ Boolean]
