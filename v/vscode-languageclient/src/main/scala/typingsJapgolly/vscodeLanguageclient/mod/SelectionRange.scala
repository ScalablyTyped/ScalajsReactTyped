...
object SelectionRange extends js.Object {
  /**
    ...
    */
  def create(range: typingsJapgolly.vscodeLanguageserverTypes.mod.Range): typingsJapgolly.vscodeLanguageserverTypes.mod.SelectionRange = js.native
  def create(
  ...
  ): typingsJapgolly.vscodeLanguageserverTypes.mod.SelectionRange = js.native
