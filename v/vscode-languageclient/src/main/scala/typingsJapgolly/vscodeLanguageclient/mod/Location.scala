...
object Location {
  ...
  ): typingsJapgolly.vscodeLanguageserverTypes.mod.Location = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(uri.asInstanceOf[js.Any], range.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.vscodeLanguageserverTypes.mod.Location]
