...
@JSImport("vscode-languageclient", "SemanticTokenTypes")
@js.native
object SemanticTokenTypes extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typingsJapgolly.vscodeLanguageserverTypes.mod.SemanticTokenTypes & String] = js.native
