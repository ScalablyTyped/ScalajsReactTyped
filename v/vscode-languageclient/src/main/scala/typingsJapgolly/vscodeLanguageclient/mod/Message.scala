...
object Message {
  ...
  @JSImport("vscode-languageclient", "Message")
  @js.native
  ...
  inline def isNotification(message: typingsJapgolly.vscodeJsonrpc.libCommonMessagesMod.Message): /* is vscode-jsonrpc.vscode-jsonrpc/lib/common/messages.NotificationMessage */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNotification")(message.asInstanceOf[js.Any]).asInstanceOf[/* is vscode-jsonrpc.vscode-jsonrpc/lib/common/messages.NotificationMessage */ Boolean]
  ...
  inline def isRequest(message: typingsJapgolly.vscodeJsonrpc.libCommonMessagesMod.Message): /* is vscode-jsonrpc.vscode-jsonrpc/lib/common/messages.RequestMessage */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isRequest")(message.asInstanceOf[js.Any]).asInstanceOf[/* is vscode-jsonrpc.vscode-jsonrpc/lib/common/messages.RequestMessage */ Boolean]
  ...
  inline def isResponse(message: typingsJapgolly.vscodeJsonrpc.libCommonMessagesMod.Message): /* is vscode-jsonrpc.vscode-jsonrpc/lib/common/messages.ResponseMessage */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isResponse")(message.asInstanceOf[js.Any]).asInstanceOf[/* is vscode-jsonrpc.vscode-jsonrpc/lib/common/messages.ResponseMessage */ Boolean]
}
