...
import typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.DocumentDiagnosticReportKind.full
import typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.DocumentDiagnosticReportKind.unChanged
...
object vsdiag {
  ...
  object DocumentDiagnosticReportKind extends StObject {
    ...
    /* "full" */ val full: typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.DocumentDiagnosticReportKind.full & String = js.native
    
    @js.native
    sealed trait unChanged
      extends StObject
         with DocumentDiagnosticReportKind
    /* "unChanged" */ val unChanged: typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.DocumentDiagnosticReportKind.unChanged & String = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.RelatedFullDocumentDiagnosticReport
    - typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.RelatedUnchangedDocumentDiagnosticReport
  */
  trait DocumentDiagnosticReport extends StObject
  object DocumentDiagnosticReport {
    
    inline def RelatedFullDocumentDiagnosticReport(items: js.Array[Diagnostic], kind: full): typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.RelatedFullDocumentDiagnosticReport = {
      val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.RelatedFullDocumentDiagnosticReport]
    }
    
    inline def RelatedUnchangedDocumentDiagnosticReport(kind: unChanged, resultId: String): typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.RelatedUnchangedDocumentDiagnosticReport = {
      val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any], resultId = resultId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.RelatedUnchangedDocumentDiagnosticReport]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.WorkspaceFullDocumentDiagnosticReport
    - typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.WorkspaceUnchangedDocumentDiagnosticReport
  */
  trait WorkspaceDocumentDiagnosticReport extends StObject
  object WorkspaceDocumentDiagnosticReport {
    
    inline def WorkspaceFullDocumentDiagnosticReport(items: js.Array[Diagnostic], kind: full, uri: Uri): typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.WorkspaceFullDocumentDiagnosticReport = {
      ...
      __obj.asInstanceOf[typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.WorkspaceFullDocumentDiagnosticReport]
    }
    
    inline def WorkspaceUnchangedDocumentDiagnosticReport(kind: unChanged, resultId: String, uri: Uri): typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.WorkspaceUnchangedDocumentDiagnosticReport = {
      ...
      __obj.asInstanceOf[typingsJapgolly.vscodeLanguageclient.libCommonDiagnosticMod.vsdiag.WorkspaceUnchangedDocumentDiagnosticReport]
    }
  }
