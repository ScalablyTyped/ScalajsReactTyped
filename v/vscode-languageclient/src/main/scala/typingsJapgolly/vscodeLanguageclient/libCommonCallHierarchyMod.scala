...
import typingsJapgolly.vscode.mod.CallHierarchyIncomingCall
import typingsJapgolly.vscode.mod.CallHierarchyItem
import typingsJapgolly.vscode.mod.CallHierarchyOutgoingCall
...
import typingsJapgolly.vscodeLanguageserverProtocol.libCommonProtocolDotcallHierarchyMod.CallHierarchyOptions
...
object libCommonCallHierarchyMod {
  ...
  trait CallHierarchyProvider
    extends StObject
       with typingsJapgolly.vscode.mod.CallHierarchyProvider {
