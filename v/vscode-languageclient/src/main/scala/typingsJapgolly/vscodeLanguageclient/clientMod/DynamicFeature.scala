...
trait DynamicFeature[T] extends js.Object {
  ...
  /**
    ...
    */
  var messages: typingsJapgolly.vscodeJsonrpc.messagesMod.MessageType | js.Array[typingsJapgolly.vscodeJsonrpc.messagesMod.MessageType] = js.native
  /**
  ...
  /**
    ...
    */
  def register(message: typingsJapgolly.vscodeJsonrpc.messagesMod.MessageType, data: RegistrationData[T]): Unit = js.native
  /**
