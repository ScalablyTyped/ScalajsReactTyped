...
object DeleteFile extends js.Object {
  def create(uri: DocumentUri): typingsJapgolly.vscodeLanguageserverTypes.mod.DeleteFile = js.native
  def create(uri: DocumentUri, options: DeleteFileOptions): typingsJapgolly.vscodeLanguageserverTypes.mod.DeleteFile = js.native
