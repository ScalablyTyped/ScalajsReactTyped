...
/* Inlined vscode-languageclient.vscode-languageclient/lib/common/features.DynamicFeature<vscode-languageserver-protocol.vscode-languageserver-protocol.FileOperationRegistrationOptions> & {send (event : vscode.vscode.FileCreateEvent): std.Promise<void>} */
@js.native
trait DynamicFeatureFileOperati extends StObject {
  ...
  def send(event: FileCreateEvent): js.Promise[Unit] = js.native
