...
import typingsJapgolly.vscodeLanguageclient.libCommonCodeConverterMod.URIConverter
...
trait Code2Protocol extends StObject {
  ...
  var protocol2Code_Original: typingsJapgolly.vscodeLanguageclient.libCommonProtocolConverterMod.URIConverter
}
