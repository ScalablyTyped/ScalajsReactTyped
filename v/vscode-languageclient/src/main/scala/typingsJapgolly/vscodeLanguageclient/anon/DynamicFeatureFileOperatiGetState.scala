...
/* Inlined vscode-languageclient.vscode-languageclient/lib/common/features.DynamicFeature<vscode-languageserver-protocol.vscode-languageserver-protocol.FileOperationRegistrationOptions> & {send (event : vscode.vscode.FileWillRenameEvent): std.Promise<void>} */
@js.native
trait DynamicFeatureFileOperatiGetState extends StObject {
  ...
  def send(event: FileWillRenameEvent): js.Promise[Unit] = js.native
