...
import typingsJapgolly.vscodeLanguageclient.libCommonFeaturesMod.RegistrationData
...
/* Inlined vscode-languageclient.vscode-languageclient/lib/common/features.DynamicFeature<vscode-languageserver-protocol.vscode-languageserver-protocol.FileOperationRegistrationOptions> & {send (event : vscode.vscode.FileRenameEvent): std.Promise<void>} */
@js.native
trait DynamicFeatureFileOperatiDispose extends StObject {
  ...
  var preInitialize: js.UndefOr[
    js.Function2[
      /* capabilities */ ServerCapabilities[LSPAny], 
      /* documentSelector */ js.UndefOr[
        typingsJapgolly.vscodeLanguageserverProtocol.libCommonProtocolMod.DocumentSelector
      ], 
      Unit
    ]
  ] = js.native
  ...
  def send(event: FileRenameEvent): js.Promise[Unit] = js.native
