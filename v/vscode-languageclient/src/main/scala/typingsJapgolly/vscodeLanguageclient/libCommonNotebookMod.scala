...
import typingsJapgolly.vscodeLanguageclient.anon.Data
import typingsJapgolly.vscodeLanguageclient.anon.DidChange
...
import typingsJapgolly.vscodeLanguageclient.vscodeLanguageclientBooleans.`true`
...
object libCommonNotebookMod {
  ...
  trait NotebookCellTextDocumentFilter
    extends StObject
       with typingsJapgolly.vscodeLanguageserverProtocol.libCommonProtocolMod.NotebookCellTextDocumentFilter {
