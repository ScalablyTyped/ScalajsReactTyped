...
import typingsJapgolly.vscode.mod.FileType
...
import typingsJapgolly.vscodeLanguageclient.anon.Files
import typingsJapgolly.vscodeLanguageclient.anon.NewUri
...
object libCommonFileOperationsMod {
