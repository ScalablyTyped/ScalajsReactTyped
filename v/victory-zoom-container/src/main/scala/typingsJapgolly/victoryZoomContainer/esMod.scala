package typingsJapgolly.victoryZoomContainer
...
object esMod {
  ...
  @JSImport("victory-zoom-container/es", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object RawZoomHelpers {
    
    @JSImport("victory-zoom-container/es", "RawZoomHelpers")
    @js.native
    val ^ : js.Any = js.native
  ...
  object ZoomHelpers {
    ...
    @JSImport("victory-zoom-container/es", "ZoomHelpers")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("victory-zoom-container/es", "ZoomHelpers.checkDomainEquality")
    @js.native
    ...
    @JSImport("victory-zoom-container/es", "ZoomHelpers.onMouseDown")
    @js.native
    ...
    @JSImport("victory-zoom-container/es", "ZoomHelpers.onMouseLeave")
    @js.native
    ...
    @JSImport("victory-zoom-container/es", "ZoomHelpers.onMouseMove")
    @js.native
    ...
    @JSImport("victory-zoom-container/es", "ZoomHelpers.onMouseUp")
    @js.native
    ...
    @JSImport("victory-zoom-container/es", "ZoomHelpers.onWheel")
    @js.native
  ...
  object VictoryZoomContainerProps {
    ...
    extension [Self <: VictoryZoomContainerProps](x: Self) {
      ...
      inline def setClipContainerComponent(value: VdomElement): Self = StObject.set(x, "clipContainerComponent", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnZoomDomainChange(value: (/* domain */ Y, VictoryZoomContainerProps) => Callback): Self = StObject.set(x, "onZoomDomainChange", js.Any.fromFunction2((t0: /* domain */ Y, t1: VictoryZoomContainerProps) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.victoryZoomContainer.victoryZoomContainerStrings.x
    - typingsJapgolly.victoryZoomContainer.victoryZoomContainerStrings.y
  */
  trait ZoomDimensionType extends StObject
  object ZoomDimensionType {
    
    inline def x: typingsJapgolly.victoryZoomContainer.victoryZoomContainerStrings.x = "x".asInstanceOf[typingsJapgolly.victoryZoomContainer.victoryZoomContainerStrings.x]
    
    inline def y: typingsJapgolly.victoryZoomContainer.victoryZoomContainerStrings.y = "y".asInstanceOf[typingsJapgolly.victoryZoomContainer.victoryZoomContainerStrings.y]
  }
}
