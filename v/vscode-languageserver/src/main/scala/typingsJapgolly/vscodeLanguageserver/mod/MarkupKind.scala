...
import typingsJapgolly.vscodeLanguageserver.vscodeLanguageserverStrings.markdown
import typingsJapgolly.vscodeLanguageserver.vscodeLanguageserverStrings.plaintext
