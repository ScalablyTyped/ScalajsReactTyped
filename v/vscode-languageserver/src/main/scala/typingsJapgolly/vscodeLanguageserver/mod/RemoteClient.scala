...
trait RemoteClient extends Remote {
  ...
  /**
    ...
    */
  def register[RO](`type`: typingsJapgolly.vscodeLanguageserverProtocol.mod.NotificationType0[RO]): Thenable[typingsJapgolly.vscodeJsonrpc.eventsMod.Disposable] = js.native
  def register[RO](`type`: typingsJapgolly.vscodeLanguageserverProtocol.mod.NotificationType0[RO], registerParams: RO): Thenable[typingsJapgolly.vscodeJsonrpc.eventsMod.Disposable] = js.native
  /**
    * Registers a listener for the given notification.
  ...
  def register[P, RO](`type`: typingsJapgolly.vscodeLanguageserverProtocol.mod.NotificationType[P, RO]): Thenable[typingsJapgolly.vscodeJsonrpc.eventsMod.Disposable] = js.native
  def register[P, RO](
    `type`: typingsJapgolly.vscodeLanguageserverProtocol.mod.NotificationType[P, RO],
    registerParams: RO
  ): Thenable[typingsJapgolly.vscodeJsonrpc.eventsMod.Disposable] = js.native
  def register[P, RO](
    unregisteration: BulkUnregistration,
    `type`: typingsJapgolly.vscodeLanguageserverProtocol.mod.NotificationType[P, RO]
  ): Thenable[BulkUnregistration] = js.native
  ...
  /**
    ...
    * @return a `Disposable` to unregister the listener again.
    */
  def register[R, E, RO](`type`: typingsJapgolly.vscodeLanguageserverProtocol.mod.RequestType0[R, E, RO]): Thenable[typingsJapgolly.vscodeJsonrpc.eventsMod.Disposable] = js.native
  def register[R, E, RO](
  ...
  def register[P, R, E, RO](`type`: typingsJapgolly.vscodeLanguageserverProtocol.mod.RequestType[P, R, E, RO]): Thenable[typingsJapgolly.vscodeJsonrpc.eventsMod.Disposable] = js.native
