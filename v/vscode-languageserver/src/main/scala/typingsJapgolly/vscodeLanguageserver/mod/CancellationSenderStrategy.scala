...
object CancellationSenderStrategy {
  ...
  @JSImport("vscode-languageserver", "CancellationSenderStrategy")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("vscode-languageserver", "CancellationSenderStrategy.Message")
  @js.native
  val Message: typingsJapgolly.vscodeJsonrpc.libCommonConnectionMod.CancellationSenderStrategy = js.native
