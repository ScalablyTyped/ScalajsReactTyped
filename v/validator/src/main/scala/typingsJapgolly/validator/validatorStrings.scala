...
object validatorStrings {
  ...
  @js.native
  sealed trait IE extends PostalCodeLocale
  ...
  @js.native
  sealed trait SK extends PostalCodeLocale
  ...
  @js.native
  sealed trait `fr-BE` extends MobilePhoneLocale
  ...
  @js.native
  sealed trait `nl-BE` extends MobilePhoneLocale
