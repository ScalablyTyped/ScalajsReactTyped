...
import typingsJapgolly.validator.validatorStrings.`10`
import typingsJapgolly.validator.validatorStrings.`13`
...
object default extends js.Object {
  ...
  @JSName("isUUID")
  def isUUID_3(str: String, version: typingsJapgolly.validator.validatorStrings.`3`): Boolean = js.native
  @JSName("isUUID")
  def isUUID_4(str: String, version: typingsJapgolly.validator.validatorNumbers.`4`): Boolean = js.native
  @JSName("isUUID")
  def isUUID_4(str: String, version: `4`): Boolean = js.native
  @JSName("isUUID")
  def isUUID_5(str: String, version: `5`): Boolean = js.native
  @JSName("isUUID")
  def isUUID_5(str: String, version: typingsJapgolly.validator.validatorStrings.`5`): Boolean = js.native
  @JSName("isUUID")
