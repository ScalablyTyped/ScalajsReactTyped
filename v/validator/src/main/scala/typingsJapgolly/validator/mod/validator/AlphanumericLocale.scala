...
object AlphanumericLocale {
  ...
  @scala.inline
  def `fa-IR`: typingsJapgolly.validator.validatorStrings.`fa-IR` = this.cast("fa-IR")
  @scala.inline
  def `fr-FR`: typingsJapgolly.validator.validatorStrings.`fr-FR` = this.cast("fr-FR")
  @scala.inline
  def he: typingsJapgolly.validator.validatorStrings.he = this.cast("he")
  @scala.inline
  ...
  @scala.inline
  def `sk-SK`: typingsJapgolly.validator.validatorStrings.`sk-SK` = this.cast("sk-SK")
  @scala.inline
