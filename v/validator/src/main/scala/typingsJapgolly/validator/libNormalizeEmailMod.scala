...
object libNormalizeEmailMod {
  ...
  inline def default(email: String, options: typingsJapgolly.validator.mod.validator.NormalizeEmailOptions): String | `false` = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(email.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String | `false`]
  
  type NormalizeEmailOptions = typingsJapgolly.validator.mod.validator.NormalizeEmailOptions
}
