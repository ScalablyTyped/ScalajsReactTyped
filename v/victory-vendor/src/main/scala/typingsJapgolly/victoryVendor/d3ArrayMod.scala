package typingsJapgolly.victoryVendor
...
object d3ArrayMod {
  ...
  @JSImport("victory-vendor/d3-array", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("victory-vendor/d3-array", "Adder")
  @js.native
  /**
    * Creates a full precision adder for IEEE 754 floating point numbers, setting its initial value to 0.
    */
  open class Adder ()
    extends typingsJapgolly.d3Array.mod.Adder
  
  @JSImport("victory-vendor/d3-array", "InternMap")
  @js.native
  open class InternMap[K, V] ()
    extends typingsJapgolly.d3Array.mod.InternMap[K, V]
  
  @JSImport("victory-vendor/d3-array", "InternSet")
  @js.native
  open class InternSet[T] ()
    extends typingsJapgolly.d3Array.mod.InternSet[T]
