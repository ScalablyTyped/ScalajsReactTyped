...
import typingsJapgolly.vueCropperjs.anon.Default
import typingsJapgolly.vueCropperjs.anon.Type
import typingsJapgolly.vueCropperjs.vueCropperjsStrings.high
import typingsJapgolly.vueCropperjs.vueCropperjsStrings.low
import typingsJapgolly.vueCropperjs.vueCropperjsStrings.medium
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vueCropperjs.vueCropperjsStrings.none
    - typingsJapgolly.vueCropperjs.vueCropperjsStrings.crop
    - typingsJapgolly.vueCropperjs.vueCropperjsStrings.move
  */
  trait DragMode extends StObject
  object DragMode {
    
    inline def crop: typingsJapgolly.vueCropperjs.vueCropperjsStrings.crop = "crop".asInstanceOf[typingsJapgolly.vueCropperjs.vueCropperjsStrings.crop]
    
    inline def move: typingsJapgolly.vueCropperjs.vueCropperjsStrings.move = "move".asInstanceOf[typingsJapgolly.vueCropperjs.vueCropperjsStrings.move]
    
    inline def none: typingsJapgolly.vueCropperjs.vueCropperjsStrings.none = "none".asInstanceOf[typingsJapgolly.vueCropperjs.vueCropperjsStrings.none]
  }
  ...
  object VueCropperJsConstructor {
    ...
    inline def apply(data: Callback, methods: VueCropperMethods, props: VueCropperProps): VueCropperJsConstructor = {
    ...
    extension [Self <: VueCropperJsConstructor](x: Self) {
      ...
      inline def setData(value: Callback): Self = StObject.set(x, "data", value.toJsFn)
  ...
  object VueCropperProps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(alt = alt.asInstanceOf[js.Any], aspectRatio = aspectRatio.asInstanceOf[js.Any], autoCrop = autoCrop.asInstanceOf[js.Any], autoCropArea = autoCropArea.asInstanceOf[js.Any], background = background.asInstanceOf[js.Any], center = center.asInstanceOf[js.Any], checkCrossOrigin = checkCrossOrigin.asInstanceOf[js.Any], checkOrientation = checkOrientation.asInstanceOf[js.Any], containerStyle = containerStyle.asInstanceOf[js.Any], crop = crop.toJsFn, cropBoxMovable = cropBoxMovable.asInstanceOf[js.Any], cropBoxResizable = cropBoxResizable.asInstanceOf[js.Any], cropend = cropend.toJsFn, cropmove = cropmove.toJsFn, cropstart = cropstart.toJsFn, data = data.asInstanceOf[js.Any], dragMode = dragMode.asInstanceOf[js.Any], guides = guides.asInstanceOf[js.Any], highlight = highlight.asInstanceOf[js.Any], imgStyle = imgStyle.asInstanceOf[js.Any], initialAspectRatio = initialAspectRatio.asInstanceOf[js.Any], minCanvasHeight = minCanvasHeight.asInstanceOf[js.Any], minCanvasWidth = minCanvasWidth.asInstanceOf[js.Any], minContainerHeight = minContainerHeight.asInstanceOf[js.Any], minContainerWidth = minContainerWidth.asInstanceOf[js.Any], minCropBoxHeight = minCropBoxHeight.asInstanceOf[js.Any], minCropBoxWidth = minCropBoxWidth.asInstanceOf[js.Any], modal = modal.asInstanceOf[js.Any], movable = movable.asInstanceOf[js.Any], preview = preview.asInstanceOf[js.Any], ready = ready.toJsFn, responsive = responsive.asInstanceOf[js.Any], restore = restore.asInstanceOf[js.Any], rotatable = rotatable.asInstanceOf[js.Any], scalable = scalable.asInstanceOf[js.Any], src = src.asInstanceOf[js.Any], toggleDragModeOnDblclick = toggleDragModeOnDblclick.asInstanceOf[js.Any], viewMode = viewMode.asInstanceOf[js.Any], wheelZoomRatio = wheelZoomRatio.asInstanceOf[js.Any], zoom = zoom.toJsFn, zoomOnTouch = zoomOnTouch.asInstanceOf[js.Any], zoomOnWheel = zoomOnWheel.asInstanceOf[js.Any], zoomable = zoomable.asInstanceOf[js.Any])
    ...
    extension [Self <: VueCropperProps](x: Self) {
      ...
      inline def setCrop(value: Callback): Self = StObject.set(x, "crop", value.toJsFn)
      ...
      inline def setCropend(value: Callback): Self = StObject.set(x, "cropend", value.toJsFn)
      
      inline def setCropmove(value: Callback): Self = StObject.set(x, "cropmove", value.toJsFn)
      
      inline def setCropstart(value: Callback): Self = StObject.set(x, "cropstart", value.toJsFn)
      ...
      inline def setZoom(value: Callback): Self = StObject.set(x, "zoom", value.toJsFn)
  ...
  type previewPropType = String | js.Array[String] | Element | NodeList[Node]
}
