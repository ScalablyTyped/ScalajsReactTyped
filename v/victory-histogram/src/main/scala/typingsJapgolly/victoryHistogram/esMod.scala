package typingsJapgolly.victoryHistogram
...
object esMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.victoryHistogram.victoryHistogramStrings.data
    - typingsJapgolly.victoryHistogram.victoryHistogramStrings.labels
    - typingsJapgolly.victoryHistogram.victoryHistogramStrings.parent
  */
  trait VictoryHistogramTargetType extends StObject
  object VictoryHistogramTargetType {
    
    inline def data: typingsJapgolly.victoryHistogram.victoryHistogramStrings.data = "data".asInstanceOf[typingsJapgolly.victoryHistogram.victoryHistogramStrings.data]
    
    inline def labels: typingsJapgolly.victoryHistogram.victoryHistogramStrings.labels = "labels".asInstanceOf[typingsJapgolly.victoryHistogram.victoryHistogramStrings.labels]
    
    inline def parent: typingsJapgolly.victoryHistogram.victoryHistogramStrings.parent = "parent".asInstanceOf[typingsJapgolly.victoryHistogram.victoryHistogramStrings.parent]
  }
}
