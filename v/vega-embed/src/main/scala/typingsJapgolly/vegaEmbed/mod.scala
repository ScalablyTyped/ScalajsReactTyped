...
import typingsJapgolly.vegaEmbed.anon.Fn
import typingsJapgolly.vegaEmbed.anon.PartialCLICKTOVIEWACTIONS
import typingsJapgolly.vegaEmbed.anon.Png
import typingsJapgolly.vegaEmbed.anon.Svg
...
object mod {
  ...
  type Config = (typingsJapgolly.vegaLite.buildSrcConfigMod.Config[ExprRef | SignalRef]) | typingsJapgolly.vegaTypings.typesSpecConfigMod.Config
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaEmbed.vegaEmbedStrings.vega
    - typingsJapgolly.vegaEmbed.vegaEmbedStrings.`vega-lite`
  */
  trait Mode extends StObject
  object Mode {
    
    inline def vega: typingsJapgolly.vegaEmbed.vegaEmbedStrings.vega = "vega".asInstanceOf[typingsJapgolly.vegaEmbed.vegaEmbedStrings.vega]
    
    inline def `vega-lite`: typingsJapgolly.vegaEmbed.vegaEmbedStrings.`vega-lite` = "vega-lite".asInstanceOf[typingsJapgolly.vegaEmbed.vegaEmbedStrings.`vega-lite`]
  }
  ...
  object vega {
    ...
    type Bounds = typingsJapgolly.vega.mod.Bounds
    
    type CanvasHandler = typingsJapgolly.vega.mod.CanvasHandler
    
    type Handler = typingsJapgolly.vega.mod.Handler
    
    type Operator = typingsJapgolly.vega.mod.Operator
    
    type Renderer = typingsJapgolly.vega.mod.Renderer
    
    type Transform = typingsJapgolly.vega.mod.Transform
