...
import typingsJapgolly.voilabPdfTable.mod.VoilabPdfTable
import typingsJapgolly.voilabPdfTable.mod.VoilabPdfTablePlugin
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object pluginsFitcolumnMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `pluginsFitcolumnMod.foo` */
