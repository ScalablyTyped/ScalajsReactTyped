...
import typingsJapgolly.voilabPdfTable.mod.VoilabPdfTableHeader
import typingsJapgolly.voilabPdfTable.voilabPdfTableStrings.bottom
import typingsJapgolly.voilabPdfTable.voilabPdfTableStrings.center
import typingsJapgolly.voilabPdfTable.voilabPdfTableStrings.left
import typingsJapgolly.voilabPdfTable.voilabPdfTableStrings.right
import typingsJapgolly.voilabPdfTable.voilabPdfTableStrings.top
...
object anon {
  ...
  object Align {
    ...
    extension [Self <: Align[?], T](x: Self & Align[T]) {
      ...
      inline def setCellAdded(value: (/* table */ VoilabPdfTable[T], /* row */ T, /* draw */ Boolean) => Callback): Self = StObject.set(x, "cellAdded", js.Any.fromFunction3((t0: /* table */ VoilabPdfTable[T], t1: /* row */ T, t2: /* draw */ Boolean) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setRenderer(value: (/* table */ VoilabPdfTable[T], /* row */ T, /* draw */ Boolean) => Callback): Self = StObject.set(x, "renderer", js.Any.fromFunction3((t0: /* table */ VoilabPdfTable[T], t1: /* row */ T, t2: /* draw */ Boolean) => (value(t0, t1, t2)).runNow()))
  ...
  object Header {
    ...
    extension [Self <: Header[?], T](x: Self & Header[T]) {
      ...
      inline def setHeaderCellAdded(
        value: (/* table */ VoilabPdfTable[T], /* header */ VoilabPdfTableHeader[T], /* draw */ Boolean) => Callback
      ): Self = StObject.set(x, "headerCellAdded", js.Any.fromFunction3((t0: /* table */ VoilabPdfTable[T], t1: /* header */ VoilabPdfTableHeader[T], t2: /* draw */ Boolean) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setHeaderRenderer(
        value: (/* table */ VoilabPdfTable[T], /* header */ VoilabPdfTableHeader[T], /* draw */ Boolean) => Callback
      ): Self = StObject.set(x, "headerRenderer", js.Any.fromFunction3((t0: /* table */ VoilabPdfTable[T], t1: /* header */ VoilabPdfTableHeader[T], t2: /* draw */ Boolean) => (value(t0, t1, t2)).runNow()))
