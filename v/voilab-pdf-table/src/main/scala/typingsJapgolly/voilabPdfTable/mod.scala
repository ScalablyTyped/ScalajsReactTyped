package typingsJapgolly.voilabPdfTable

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.pdfkit.PDFKit.Mixins.TextOptions
import typingsJapgolly.pdfkit.PDFKit.PDFDocument
import typingsJapgolly.std.Partial
import typingsJapgolly.voilabPdfTable.anon.Align
import typingsJapgolly.voilabPdfTable.anon.Cancel
import typingsJapgolly.voilabPdfTable.anon.Header
import typingsJapgolly.voilabPdfTable.anon.HeaderBorder
import typingsJapgolly.voilabPdfTable.anon.X
import typingsJapgolly.voilabPdfTable.voilabPdfTableStrings.id
...
object mod {
  ...
  object VoilabPdfTablePlugin {
    ...
    inline def apply[T](configure: VoilabPdfTable[T] => Callback): VoilabPdfTablePlugin[T] = {
      val __obj = js.Dynamic.literal(configure = js.Any.fromFunction1((t0: VoilabPdfTable[T]) => configure(t0).runNow()))
      __obj.asInstanceOf[VoilabPdfTablePlugin[T]]
    }
    
    extension [Self <: VoilabPdfTablePlugin[?], T](x: Self & VoilabPdfTablePlugin[T]) {
      
      inline def setConfigure(value: VoilabPdfTable[T] => Callback): Self = StObject.set(x, "configure", js.Any.fromFunction1((t0: VoilabPdfTable[T]) => value(t0).runNow()))
    }
  }
}
