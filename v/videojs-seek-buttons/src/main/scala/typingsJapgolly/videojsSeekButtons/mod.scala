package typingsJapgolly.videojsSeekButtons

import typingsJapgolly.videojsSeekButtons.videojsSeekButtonsStrings.back
import typingsJapgolly.videojsSeekButtons.videojsSeekButtonsStrings.forward
