...
import typingsJapgolly.victoryCursorContainer.anon.EventKey
import typingsJapgolly.victoryCursorContainer.anon.Mutation
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esCursorHelpersMod {
  
  @JSImport("victory-cursor-container/es/cursor-helpers", "CursorHelpers")
  @js.native
