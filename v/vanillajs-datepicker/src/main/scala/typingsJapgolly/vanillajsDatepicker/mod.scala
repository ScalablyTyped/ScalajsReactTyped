...
import typingsJapgolly.vanillajsDatepicker.dateRangePickerMod.DateRangePickerOptions
import typingsJapgolly.vanillajsDatepicker.dateRangePickerMod.default
import typingsJapgolly.vanillajsDatepicker.datepickerMod.DatepickerOptions
...
object mod {
  ...
  open class Datepicker protected ()
    extends typingsJapgolly.vanillajsDatepicker.datepickerMod.default {
    def this(element: HTMLElement) = this()
