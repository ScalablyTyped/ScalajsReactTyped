...
import typingsJapgolly.vanillajsDatepicker.anon.Clear
import typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.auto
import typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.input
import typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.picker
...
object datepickerMod {
  ...
  open class default protected ()
    ...
    def this(
      element: HTMLElement,
      options: Unit,
      rangepicker: typingsJapgolly.vanillajsDatepicker.dateRangePickerMod.default
    ) = this()
    def this(
      element: HTMLElement,
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.left
    - typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.center
    - typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.right
    - typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.auto
  */
  trait DatepickerOptionsOrientationHorizontal extends StObject
  object DatepickerOptionsOrientationHorizontal {
    
    inline def auto: typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.auto = "auto".asInstanceOf[typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.auto]
    
    inline def center: typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.center = "center".asInstanceOf[typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.center]
    
    inline def left: typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.left = "left".asInstanceOf[typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.left]
    
    inline def right: typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.right = "right".asInstanceOf[typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.right]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.top
    - typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.middle
    - typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.bottom
    - typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.auto
  */
  ...
  object DatepickerOptionsOrientationVertical {
    ...
    inline def bottom: typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.bottom]
    
    inline def middle: typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.middle = "middle".asInstanceOf[typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.middle]
    
    inline def top: typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.top = "top".asInstanceOf[typingsJapgolly.vanillajsDatepicker.vanillajsDatepickerStrings.top]
  }
}
