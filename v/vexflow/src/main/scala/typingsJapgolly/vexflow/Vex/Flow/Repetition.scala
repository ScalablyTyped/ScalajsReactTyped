...
object Repetition {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(addEndModifier = addEndModifier.toJsFn, addModifier = addModifier.toJsFn, addToStave = js.Any.fromFunction2(addToStave), addToStaveEnd = js.Any.fromFunction2(addToStaveEnd), draw = js.Any.fromFunction2(draw), drawCodaFixed = js.Any.fromFunction2(drawCodaFixed), drawSignoFixed = js.Any.fromFunction2(drawSignoFixed), drawSymbolText = js.Any.fromFunction4(drawSymbolText), getCategory = getCategory.toJsFn, getPadding = js.Any.fromFunction1(getPadding), getPosition = getPosition.toJsFn, getStyle = getStyle.toJsFn, getWidth = getWidth.toJsFn, makeSpacer = js.Any.fromFunction1(makeSpacer), placeGlyphOnLine = js.Any.fromFunction3((t0: Glyph, t1: Stave, t2: Double) => (placeGlyphOnLine(t0, t1, t2)).runNow()), setPadding = js.Any.fromFunction1((t0: Double) => setPadding(t0).runNow()), setShiftX = js.Any.fromFunction1(setShiftX), setShiftY = js.Any.fromFunction1(setShiftY), setStyle = js.Any.fromFunction1(setStyle))
