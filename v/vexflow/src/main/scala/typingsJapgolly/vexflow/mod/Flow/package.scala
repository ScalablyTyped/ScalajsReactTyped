...
import typingsJapgolly.vexflow.anon.Betweenlines
import typingsJapgolly.vexflow.anon.Code
import typingsJapgolly.vexflow.anon.Codehead
import typingsJapgolly.vexflow.anon.Dots
import typingsJapgolly.vexflow.anon.Duration
import typingsJapgolly.vexflow.anon.Gracenotewidth
import typingsJapgolly.vexflow.anon.Line
import typingsJapgolly.vexflow.anon.Lineshift
import typingsJapgolly.vexflow.anon.Octaveshift
import typingsJapgolly.vexflow.anon.Shiftdown
import typingsJapgolly.vexflow.mod.Flow.^
...
inline def durationToFraction(duration: String): typingsJapgolly.vexflow.Vex.Flow.Fraction = ^.asInstanceOf[js.Dynamic].applyDynamic("durationToFraction")(duration.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.vexflow.Vex.Flow.Fraction]
...
inline def keyProperties(key: String, clef: String, params: Octaveshift): typingsJapgolly.vexflow.anon.Accidental = (^.asInstanceOf[js.Dynamic].applyDynamic("keyProperties")(key.asInstanceOf[js.Any], clef.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.vexflow.anon.Accidental]
