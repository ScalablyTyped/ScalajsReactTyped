...
@JSImport("vexflow", "Flow.NoteSubGroup")
@js.native
open class NoteSubGroup protected ()
  extends StObject
     with typingsJapgolly.vexflow.Vex.Flow.NoteSubGroup {
  def this(subnotes: js.Array[typingsJapgolly.vexflow.Vex.Flow.Note]) = this()
