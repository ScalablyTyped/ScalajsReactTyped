...
trait AnonLeftshiftticks extends js.Object {
  var height: Double
...
object AnonLeftshiftticks {
  @scala.inline
  def apply(height: Double, left_shift_ticks: Double, right_shift_ticks: Double, y_shift: Double): AnonLeftshiftticks = {
    ...
    __obj.asInstanceOf[AnonLeftshiftticks]
  }
}
