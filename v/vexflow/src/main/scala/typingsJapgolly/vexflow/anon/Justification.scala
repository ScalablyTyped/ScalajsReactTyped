...
trait Justification extends StObject {
  ...
  var justification: js.UndefOr[typingsJapgolly.vexflow.Vex.Flow.TextNote.Justification] = js.undefined
...
object Justification {
  ...
  extension [Self <: Justification](x: Self) {
    ...
    inline def setJustification(value: typingsJapgolly.vexflow.Vex.Flow.TextNote.Justification): Self = StObject.set(x, "justification", value.asInstanceOf[js.Any])
