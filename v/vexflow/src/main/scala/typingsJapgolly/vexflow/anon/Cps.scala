...
trait Cps extends StObject {
  ...
  var position: typingsJapgolly.vexflow.Vex.Flow.Curve.Position
...
object Cps {
  ...
  inline def apply(invert: Boolean, position: typingsJapgolly.vexflow.Vex.Flow.Curve.Position, y_shift: Double): Cps = {
  ...
  extension [Self <: Cps](x: Self) {
    ...
    inline def setPosition(value: typingsJapgolly.vexflow.Vex.Flow.Curve.Position): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
