...
trait Lastindices extends StObject {
  ...
  var first_note: js.UndefOr[typingsJapgolly.vexflow.Vex.Flow.Note] = js.undefined
  
  var last_indices: js.UndefOr[js.Array[Double]] = js.undefined
  
  var last_note: js.UndefOr[typingsJapgolly.vexflow.Vex.Flow.Note] = js.undefined
}
object Lastindices {
