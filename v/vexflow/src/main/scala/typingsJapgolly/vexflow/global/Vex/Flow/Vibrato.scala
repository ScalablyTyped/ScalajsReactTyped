...
open class Vibrato ()
  extends StObject
     with typingsJapgolly.vexflow.Vex.Flow.Vibrato {
  ...
  /* CompleteClass */
  override def setHarsh(harsh: Boolean): typingsJapgolly.vexflow.Vex.Flow.Vibrato = js.native
  ...
  /* CompleteClass */
  override def setVibratoWidth(width: Double): typingsJapgolly.vexflow.Vex.Flow.Vibrato = js.native
...
object Vibrato {
  ...
  @JSGlobal("Vex.Flow.Vibrato.CATEGORY")
  @js.native
  val CATEGORY: String = js.native
  
  /* static member */
  inline def format(
    vibratos: js.Array[typingsJapgolly.vexflow.Vex.Flow.Vibrato],
    state: Leftshift,
    context: typingsJapgolly.vexflow.Vex.Flow.ModifierContext
