...
import typingsJapgolly.vueDevtoolsApi.libEsmApiApiMod.DevtoolsPluginApi
import typingsJapgolly.vueDevtoolsApi.libEsmPluginMod.PluginDescriptor
import typingsJapgolly.vueDevtoolsApi.libEsmProxyMod.ApiProxy
import typingsJapgolly.vueDevtoolsApi.mod.SetupFunction
...
object libEsmEnvMod {
  ...
  object PluginQueueItem {
    ...
    inline def apply(pluginDescriptor: PluginDescriptor, setupFn: /* api */ DevtoolsPluginApi[Any] => Callback): PluginQueueItem = {
      val __obj = js.Dynamic.literal(pluginDescriptor = pluginDescriptor.asInstanceOf[js.Any], setupFn = js.Any.fromFunction1((t0: /* api */ DevtoolsPluginApi[Any]) => setupFn(t0).runNow()))
    ...
    extension [Self <: PluginQueueItem](x: Self) {
      ...
      inline def setSetupFn(value: /* api */ DevtoolsPluginApi[Any] => Callback): Self = StObject.set(x, "setupFn", js.Any.fromFunction1((t0: /* api */ DevtoolsPluginApi[Any]) => value(t0).runNow()))
    }
  }
}
