...
import typingsJapgolly.vscodeUri.AnonAuthority
...
object default extends js.Object {
  ...
  def revive(data: URI): URI = js.native
  def revive(data: UriComponents): URI = js.native
  @JSName("revive")
  def revive_Union(data: URI): js.UndefOr[URI] = js.native
  @JSName("revive")
  def revive_Union(data: UriComponents): js.UndefOr[URI] = js.native
}
