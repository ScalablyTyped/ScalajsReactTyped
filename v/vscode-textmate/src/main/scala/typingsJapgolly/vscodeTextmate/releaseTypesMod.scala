package typingsJapgolly.vscodeTextmate

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.vscodeTextmate.vscodeTextmateInts.`0`
import typingsJapgolly.vscodeTextmate.vscodeTextmateInts.`1`
import typingsJapgolly.vscodeTextmate.vscodeTextmateInts.`2`
import typingsJapgolly.vscodeTextmate.vscodeTextmateInts.`4`
import typingsJapgolly.vscodeTextmate.vscodeTextmateInts.`8`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object releaseTypesMod {
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vscodeTextmate.vscodeTextmateInts.`0`
    - typingsJapgolly.vscodeTextmate.vscodeTextmateInts.`1`
    - typingsJapgolly.vscodeTextmate.vscodeTextmateInts.`2`
    - typingsJapgolly.vscodeTextmate.vscodeTextmateInts.`4`
    - typingsJapgolly.vscodeTextmate.vscodeTextmateInts.`8`
  */
