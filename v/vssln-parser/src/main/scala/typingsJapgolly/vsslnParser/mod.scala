package typingsJapgolly.vsslnParser
...
object mod {
  ...
  - typingsJapgolly.vsslnParser.mod.VsSolutionSectionCollection because Already inherited */ trait VsSolutionFile
    extends StObject
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - org.scalablytyped.runtime.StObject because Already inherited
  - typingsJapgolly.vsslnParser.mod.VsSolutionSectionCollection because Already inherited */ trait VsSolutionProject
    extends StObject
       with VsSolutionSection {
