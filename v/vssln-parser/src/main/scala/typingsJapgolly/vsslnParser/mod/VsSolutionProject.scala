package typingsJapgolly.vsslnParser.mod
...
- typingsJapgolly.vsslnParser.mod.VsSolutionSectionCollection because Already inherited */ trait VsSolutionProject extends VsSolutionSection {
  var name: String
  var path: String
