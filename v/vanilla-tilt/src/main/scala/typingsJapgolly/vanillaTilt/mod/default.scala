...
object default extends js.Object {
  def init(elements: js.Array[typingsJapgolly.std.HTMLElement]): Unit = js.native
  def init(elements: js.Array[typingsJapgolly.std.HTMLElement], settings: TiltOptions): Unit = js.native
  /**
    ...
    */
  def init(elements: typingsJapgolly.std.HTMLElement): Unit = js.native
  def init(elements: typingsJapgolly.std.HTMLElement, settings: TiltOptions): Unit = js.native
}
