package typingsJapgolly.vanillaTilt
...
import typingsJapgolly.vanillaTilt.vanillaTiltStrings.x
import typingsJapgolly.vanillaTilt.vanillaTiltStrings.y
...
object mod {
  ...
  object TiltOptions {
    ...
    extension [Self <: TiltOptions](x: Self) {
      ...
      inline def setAxis(value: typingsJapgolly.vanillaTilt.vanillaTiltStrings.x | y): Self = StObject.set(x, "axis", value.asInstanceOf[js.Any])
  ...
  object VanillaTilt {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(addEventListeners = addEventListeners.toJsFn, destroy = destroy.toJsFn, getValues = getValues.toJsFn, removeEventListener = removeEventListener.toJsFn, reset = reset.toJsFn)
      __obj.asInstanceOf[VanillaTilt]
    }
    
    extension [Self <: VanillaTilt](x: Self) {
      
      inline def setAddEventListeners(value: Callback): Self = StObject.set(x, "addEventListeners", value.toJsFn)
      
      inline def setDestroy(value: Callback): Self = StObject.set(x, "destroy", value.toJsFn)
      
      inline def setGetValues(value: CallbackTo[TiltValues]): Self = StObject.set(x, "getValues", value.toJsFn)
