...
object mod extends Shortcut {
  ...
  object Types extends StObject {
    ...
    sealed trait Local
      extends StObject
         with Types
    /* "local" */ val Local: typingsJapgolly.vueLs.mod.Types.Local & String = js.native
    
    @js.native
    sealed trait Memory
      extends StObject
         with Types
    /* "memory" */ val Memory: typingsJapgolly.vueLs.mod.Types.Memory & String = js.native
    
    @js.native
    sealed trait Session
      extends StObject
         with Types
    /* "session" */ val Session: typingsJapgolly.vueLs.mod.Types.Session & String = js.native
  }
