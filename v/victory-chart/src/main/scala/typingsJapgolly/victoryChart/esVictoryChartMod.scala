...
object esVictoryChartMod {
  
  @JSImport("victory-chart/es/victory-chart", "VictoryChart")
  @js.native
  val VictoryChart: NamedExoticComponent[VictoryChartProps] = js.native
  
  trait AxesType extends StObject {
    
    var dependent: js.UndefOr[Element | Null] = js.undefined
    
    var independent: js.UndefOr[Element | Null] = js.undefined
  }
  object AxesType {
    ...
    extension [Self <: AxesType](x: Self) {
      ...
      inline def setDependent(value: VdomElement): Self = StObject.set(x, "dependent", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setIndependent(value: VdomElement): Self = StObject.set(x, "independent", value.rawElement.asInstanceOf[js.Any])
