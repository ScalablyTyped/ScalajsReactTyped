...
object esVictoryUtilPropTypesMod {
  
  @JSImport("victory-core/es/victory-util/prop-types", JSImport.Namespace)
  @js.native
  ...
  @JSImport("victory-core/es/victory-util/prop-types", "domain")
  @js.native
  val domain: Requireable[js.UndefOr[js.Tuple2[Double, Double]]] = js.native
  
  @JSImport("victory-core/es/victory-util/prop-types", "greaterThanZero")
  @js.native
  val greaterThanZero: Requireable[js.UndefOr[Double]] = js.native
  
  @JSImport("victory-core/es/victory-util/prop-types", "homogeneousArray")
  @js.native
  val homogeneousArray: Requireable[js.UndefOr[js.Array[Any]]] = js.native
  
  @JSImport("victory-core/es/victory-util/prop-types", "integer")
  @js.native
  val integer: Requireable[js.UndefOr[Double]] = js.native
  
  @JSImport("victory-core/es/victory-util/prop-types", "matchDataLength")
  @js.native
  val matchDataLength: Requireable[js.UndefOr[js.Array[Any]]] = js.native
  
  @JSImport("victory-core/es/victory-util/prop-types", "nonNegative")
  @js.native
  val nonNegative: Requireable[js.UndefOr[Double]] = js.native
  
  @JSImport("victory-core/es/victory-util/prop-types", "regExp")
  @js.native
  val regExp: Requireable[js.UndefOr[js.RegExp]] = js.native
  
  @JSImport("victory-core/es/victory-util/prop-types", "scale")
  @js.native
