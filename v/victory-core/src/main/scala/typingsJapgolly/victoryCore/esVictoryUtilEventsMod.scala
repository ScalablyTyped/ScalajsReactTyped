...
import typingsJapgolly.victoryCore.esVictoryUtilAddEventsMod.EventMixinCalculatedValues
import typingsJapgolly.victoryCore.victoryCoreStrings.parent
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esVictoryUtilEventsMod {
  
  @JSImport("victory-core/es/victory-util/events", JSImport.Namespace)
  @js.native
  ...
  type PartialEvents = StringDictionary[js.Function1[/* evt */ ReactEventFrom[Element], UpdatedProps]]
