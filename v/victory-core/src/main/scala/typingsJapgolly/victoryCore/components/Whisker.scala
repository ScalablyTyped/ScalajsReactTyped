...
import typingsJapgolly.victoryCore.esVictoryPrimitivesWhiskerMod.WhiskerAxes
...
object Whisker {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def majorWhisker(value: WhiskerAxes): this.type = set("majorWhisker", value.asInstanceOf[js.Any])
    
    inline def minorWhisker(value: WhiskerAxes): this.type = set("minorWhisker", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: Whisker.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WhiskerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
