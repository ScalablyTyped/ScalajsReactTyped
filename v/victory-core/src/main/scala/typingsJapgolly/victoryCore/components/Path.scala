...
object Path {
  ...
  @JSImport("victory-core/es", "Path")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Path.type): SharedBuilder_VictoryPrimitiveShapeProps1665464111 = new SharedBuilder_VictoryPrimitiveShapeProps1665464111(js.Array(this.component, js.Dictionary.empty))()
