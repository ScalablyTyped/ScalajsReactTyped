...
object esVictoryPortalPortalMod {
  
  @JSImport("victory-core/es/victory-portal/portal", "Portal")
  @js.native
  open class Portal protected ()
    ...
    /* CompleteClass */
    override def portalUpdate(key: Double, element: Element): Unit = js.native
  }
  /* static members */
  object Portal {
    ...
    @JSImport("victory-core/es/victory-portal/portal", "Portal.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("victory-core/es/victory-portal/portal", "Portal.propTypes")
    @js.native
