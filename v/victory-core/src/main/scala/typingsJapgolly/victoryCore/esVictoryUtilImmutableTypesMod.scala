...
import typingsJapgolly.victoryCore.anon.Done
import typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Keyed
import typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Indexed
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esVictoryUtilImmutableTypesMod {
  
  @JSImport("victory-core/es/victory-util/immutable-types", JSImport.Namespace)
  @js.native
  ...
  trait Iterable[K, V] extends StObject {
    ...
    ): /*Map*/ typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[G, /*this*/ Iterable[K, V]] = js.native
    def groupBy[G](
      grouper: js.Function3[
          /* value */ js.UndefOr[V], 
          /* key */ js.UndefOr[K], 
    ...
    /**
      ...
      *
      */
    def toKeyedSeq(): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = js.native
    ...
    /**
      ...
      */
    def toList(): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[V] = js.native
    ...
    /**
      ...
      */
    def toSetSeq(): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[V] = js.native
  ...
  object Iterable {
    ...
    inline def apply[T](array: js.Array[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(array.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
    inline def apply[T](iterable: /*ES6Iterable<T>*/ js.Object): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(iterable.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
    inline def apply[T](iterator: Iterator[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(iterator.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
    ...
    inline def apply[V](value: V): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[V] = ^.asInstanceOf[js.Dynamic].apply(value.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[V]]
    ...
    @JSImport("victory-core/es/victory-util/immutable-types", "Iterable")
    @js.native
    val ^ : js.Any = js.native
    ...
    trait Indexed[T]
      ...
      def findIndex(
        predicate: js.Function3[
              ...
              /* iter */ js.UndefOr[
                /*this*/ typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]
              ], 
              Boolean
            ]
      ): Double = js.native
      ...
      /**
        ...
        */
      def fromEntrySeq(): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[Any, Any] = js.native
      ...
      /**
        ...
        *     // Seq [ 1, 'A', 'X', 2, 'B', 'Y' ]
        */
      def interleave(iterables: (Iterable[Any, T])*): /*this*/ typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = js.native
      ...
      /**
        ...
        * in this Iterable.
        */
      def interpose(separator: T): /*this*/ typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = js.native
      ...
      /**
        ...
        *
        */
      def splice(index: Double, removeNum: Double, values: (/*Array<Iterable.Indexed<T> | T>*/ Any)*): /*this*/ typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = js.native
      ...
      /**
        ...
        *
        */
      def zip(iterables: (Iterable[Any, Any])*): /*this*/ typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[Any] = js.native
      
      def zipWith[Z](zipper: js.Function1[/* repeated */ Any, Z], iterables: (Iterable[Any, Any])*): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[Z] = js.native
      /**
        * Returns an Iterable of the same type "zipped" with the provided
        ...
        *
        */
      def zipWith[U, Z](zipper: js.Function2[/* value */ T, /* otherValue */ U, Z], otherIterable: Iterable[Any, U]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[Z] = js.native
      def zipWith[U, V, Z](
        zipper: js.Function3[/* value */ T, /* otherValue */ U, /* thirdValue */ V, Z],
        otherIterable: Iterable[Any, U],
        thirdIterable: Iterable[Any, V]
      ): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[Z] = js.native
    }
    object Indexed {
      
      inline def apply[T](array: js.Array[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(array.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
      inline def apply[T](iterable: /*Iterable<T>*/ js.Object): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(iterable.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
      inline def apply[T](iterator: Iterator[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(iterator.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
      inline def apply[T](iter: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(iter.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
      inline def apply[T](iter: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(iter.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
      inline def apply[K, V](iter: Keyed[K, V]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[/*[K,V]*/ Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(iter.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[/*[K,V]*/ Any]]
    }
    ...
    object Set {
      ...
      inline def apply[T](array: js.Array[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(array.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T]]
      inline def apply[T](iterable: /*Iterable<T>*/ js.Object): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(iterable.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T]]
      inline def apply[T](iterator: Iterator[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(iterator.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T]]
      inline def apply[T](iter: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(iter.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T]]
      inline def apply[T](iter: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(iter.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T]]
      inline def apply[K, V](iter: Keyed[K, V]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[/*[K,V]*/ Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(iter.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[/*[K,V]*/ Any]]
    }
  ...
  trait List[T]
    extends StObject
       with typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Collection.Indexed[T] {
    
    /**
      * @see `Map#asImmutable`
      */
    def asImmutable(): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    
    /**
      * @see `Map#asMutable`
      */
    def asMutable(): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    
    /**
      * Returns a new List with 0 size and no values.
      */
    def clear(): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      * @alias remove
      */
    def delete(index: Double): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      * @alias removeIn
      */
    def deleteIn(keyPath: js.Array[Any]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    def deleteIn(keyPath: Iterable[Any, Any]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      */
    def insert(index: Double, value: T): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    
    /**
      * @see `Map#merge`
      */
    def merge(
      iterables: (js.Array[T] | typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T])*
    ): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    def mergeDeepIn(
      ...
      iterables: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]*
    ): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      * in this List.
      */
    def pop(): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    
    /**
      * Returns a new List with the provided `values` appended, starting at this
      * List's `size`.
      */
    def push(values: T*): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    
    def remove(index: Double): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    
    def removeIn(keyPath: js.Array[Any]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    def removeIn(keyPath: Iterable[Any, Any]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      */
    def set(index: Double, value: T): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      * the List.
      */
    def setIn(keyPath: js.Array[Any], value: Any): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    def setIn(keyPath: Iterable[Any, Any], value: Any): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      */
    def setSize(size: Double): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      * value in this List.
      */
    def shift(): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    
    /**
      * Returns a new List with the provided `values` prepended, shifting other
      * values ahead to higher indices.
      */
    def unshift(values: T*): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    
    def update(index: Double, notSetValue: T, updater: js.Function1[/* value */ T, T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    def update(index: Double, updater: js.Function1[/* value */ T, T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    /**
    ...
    def update(
      updater: js.Function1[
          /* value */ typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T], 
          typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T]
        ]
    ): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    
    def updateIn(keyPath: js.Array[Any], notSetValue: Any, updater: js.Function1[/* value */ Any, Any]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    /**
      * @see `Map#updateIn`
      */
    def updateIn(keyPath: js.Array[Any], updater: js.Function1[/* value */ Any, Any]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    def updateIn(keyPath: Iterable[Any, Any], notSetValue: Any, updater: js.Function1[/* value */ Any, Any]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    def updateIn(keyPath: Iterable[Any, Any], updater: js.Function1[/* value */ Any, Any]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      */
    def withMutations(
      mutator: js.Function1[
          /* mutable */ typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T], 
          Any
        ]
    ): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = js.native
  }
  object List {
    ...
    inline def apply[T](): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T]]
    inline def apply[T](array: js.Array[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].apply(array.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T]]
    inline def apply[T](iterable: /*Iterable<T>*/ js.Object): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].apply(iterable.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T]]
    inline def apply[T](iterator: Iterator[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].apply(iterator.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T]]
    inline def apply[T](iter: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T]]
    inline def apply[T](iter: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T]]
    inline def apply[K, V](iter: Keyed[K, V]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[/*[K,V]*/ Any] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[/*[K,V]*/ Any]]
    
    @JSImport("victory-core/es/victory-util/immutable-types", "List")
    @js.native
    val ^ : js.Any = js.native
    ...
    /**
      ...
      */
    inline def of[T](values: T*): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("of")(values.asInstanceOf[scala.Seq[js.Any]]*).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.List[T]]
  }
  
  @js.native
  trait Map[K, V]
    extends StObject
       with typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Collection.Keyed[K, V] {
  ...
  object Map {
    ...
    @JSImport("victory-core/es/victory-util/immutable-types", "Map")
    @js.native
    val ^ : js.Any = js.native
  ...
  object OrderedMap {
    ...
    @JSImport("victory-core/es/victory-util/immutable-types", "OrderedMap")
    @js.native
    val ^ : js.Any = js.native
  ...
  object OrderedSet {
    ...
    inline def apply[T](iter: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): OrderedSet[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[OrderedSet[T]]
    inline def apply[T](iter: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T]): OrderedSet[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[OrderedSet[T]]
    ...
    @JSImport("victory-core/es/victory-util/immutable-types", "OrderedSet")
    @js.native
    val ^ : js.Any = js.native
  ...
  object Record {
    ...
    @JSImport("victory-core/es/victory-util/immutable-types", "Record")
    @js.native
    val ^ : js.Any = js.native
  ...
  object Seq {
    ...
    inline def apply[V](obj: StringDictionary[V]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[String, V] = ^.asInstanceOf[js.Dynamic].apply(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[String, V]]
    ...
    @JSImport("victory-core/es/victory-util/immutable-types", "Seq")
    @js.native
    val ^ : js.Any = js.native
    
    /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
    - typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable because Already inherited
    - typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed because var conflicts: size. Inlined fromEntrySeq, interpose, interleave, splice, zip, zipWith, zipWith, zipWith, indexOf, lastIndexOf, findIndex, findIndex, findLastIndex, findLastIndex */ @js.native
    trait Indexed[T]
      extends StObject
         with Seq[Double, T] {
      ...
      /**
        ...
        *
        */
      def zipWith[U, Z](zipper: js.Function2[T, /* otherValue */ U, Z], otherIterable: Iterable[Any, U]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[Z] = js.native
      def zipWith[U, V, Z](
    ...
    object Indexed {
      ...
      inline def apply[T](iterator: Iterator[T]): Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(iterator.asInstanceOf[js.Any]).asInstanceOf[Indexed[T]]
      inline def apply[T](seq: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(seq.asInstanceOf[js.Any]).asInstanceOf[Indexed[T]]
      inline def apply[T](seq: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T]): Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(seq.asInstanceOf[js.Any]).asInstanceOf[Indexed[T]]
      inline def apply[K, V](seq: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Keyed[K, V]): Indexed[/*[K,V]*/ Any] = ^.asInstanceOf[js.Dynamic].apply(seq.asInstanceOf[js.Any]).asInstanceOf[Indexed[/*[K,V]*/ Any]]
      
      @JSImport("victory-core/es/victory-util/immutable-types", "Seq.Indexed")
      @js.native
      val ^ : js.Any = js.native
    ...
    /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
    - typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable because Already inherited
    - typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Keyed because var conflicts: size. Inlined flip, mapKeys, mapKeys, mapEntries, mapEntries */ @js.native
    trait Keyed[K, V]
      extends StObject
         with Seq[K, V] {
      ...
      /**
        ...
        *
        */
      def flip(): /*this*/ typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Keyed[V, K] = js.native
      ...
      def mapEntries[KM, VM](
        mapper: js.Function3[
              ...
              /* index */ js.UndefOr[Double], 
              /* iter */ js.UndefOr[
                /*this*/ typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Keyed[K, V]
              ], 
              /*[KM, VM]*/ js.Array[Any]
            ]
      ): /*this*/ typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Keyed[KM, VM] = js.native
      def mapEntries[KM, VM](
        mapper: js.Function3[
              /* entry */ js.UndefOr[/*(K, V)*/ js.Array[Any]], 
              /* index */ js.UndefOr[Double], 
      ...
      ): /*this*/ typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Keyed[M, V] = js.native
      def mapKeys[M](
        mapper: js.Function3[
              /* key */ js.UndefOr[K], 
              /* value */ js.UndefOr[V], 
    ...
    object Keyed {
      ...
      inline def apply[V](obj: StringDictionary[V]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[String, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[String, V]]
      inline def apply[K, V](): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")().asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[K, V]]
      inline def apply[K, V](array: js.Array[/*[K,V]*/ Any]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(array.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[K, V]]
      inline def apply[K, V](iterable: /*Iterable<[K,V]>*/ js.Object): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(iterable.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[K, V]]
      inline def apply[K, V](iterator: Iterator[/*[K,V]*/ Any]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(iterator.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[K, V]]
      inline def apply[K, V](seq: Iterable[Any, /*[K,V]*/ Any]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(seq.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[K, V]]
      inline def apply[K, V](seq: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Keyed[K, V]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(seq.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Keyed[K, V]]
    }
    
    /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
    - typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable because Already inherited
    - typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set because var conflicts: size. Inlined  */ @js.native
    trait Set[T]
      extends StObject
         with Seq[T, T]
    object Set {
      
      inline def apply[T](): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T]]
      inline def apply[T](array: js.Array[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply(array.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T]]
      inline def apply[T](iterable: /*Iterable<T>*/ js.Object): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply(iterable.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T]]
      inline def apply[T](iterator: Iterator[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply(iterator.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T]]
      inline def apply[T](seq: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply(seq.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T]]
      inline def apply[T](seq: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply(seq.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T]]
      inline def apply[K, V](seq: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Keyed[K, V]): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[/*[K,V]*/ Any] = ^.asInstanceOf[js.Dynamic].apply(seq.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[/*[K,V]*/ Any]]
      
      @JSImport("victory-core/es/victory-util/immutable-types", "Seq.Set")
      @js.native
      val ^ : js.Any = js.native
      ...
      /**
        ...
        */
      inline def of[T](values: T*): typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("of")(values.asInstanceOf[scala.Seq[js.Any]]*).asInstanceOf[typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Seq.Set[T]]
    }
  ...
  trait Set[T]
    extends StObject
       with typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Collection.Set[T] {
  ...
  object Set {
    ...
    inline def apply[T](iter: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): Set[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[Set[T]]
    inline def apply[T](iter: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T]): Set[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[Set[T]]
    ...
    @JSImport("victory-core/es/victory-util/immutable-types", "Set")
    @js.native
    val ^ : js.Any = js.native
  ...
  object Stack {
    ...
    inline def apply[T](iter: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): Stack[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[Stack[T]]
    inline def apply[T](iter: typingsJapgolly.victoryCore.esVictoryUtilImmutableTypesMod.Iterable.Set[T]): Stack[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[Stack[T]]
    ...
    @JSImport("victory-core/es/victory-util/immutable-types", "Stack")
    @js.native
    val ^ : js.Any = js.native
  ...
  object Iterator {
    ...
    inline def apply[T](next: CallbackTo[Done[T]]): Iterator[T] = {
