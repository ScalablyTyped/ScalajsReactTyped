...
object esVictoryContainerVictoryContainerMod {
  
  @JSImport("victory-core/es/victory-container/victory-container", "VictoryContainer")
  @js.native
  ...
  object VictoryContainer {
    ...
    @JSImport("victory-core/es/victory-container/victory-container", "VictoryContainer.contextType")
    @js.native
    ...
    @JSImport("victory-core/es/victory-container/victory-container", "VictoryContainer.defaultProps")
    @js.native
    ...
    @JSImport("victory-core/es/victory-container/victory-container", "VictoryContainer.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("victory-core/es/victory-container/victory-container", "VictoryContainer.propTypes")
    @js.native
    ...
    @JSImport("victory-core/es/victory-container/victory-container", "VictoryContainer.role")
    @js.native
  ...
  trait VictoryContainerProps extends StObject {
    ...
    var portalComponent: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.undefined
  ...
  object VictoryContainerProps {
    ...
    extension [Self <: VictoryContainerProps](x: Self) {
      ...
      inline def setContainerRefFunction1(value: HTMLElement | Null => Callback): Self = StObject.set(x, "containerRef", js.Any.fromFunction1((t0: HTMLElement | Null) => value(t0).runNow()))
