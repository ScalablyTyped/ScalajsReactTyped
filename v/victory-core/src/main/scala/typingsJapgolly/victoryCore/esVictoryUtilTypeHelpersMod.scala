...
import typingsJapgolly.victoryCore.esTypesPropTypesMod.AxisType
import typingsJapgolly.victoryCore.esTypesPropTypesMod.Datum
import typingsJapgolly.victoryCore.esTypesPropTypesMod.ForAxes
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esVictoryUtilTypeHelpersMod {
  
  @JSImport("victory-core/es/victory-util/type-helpers", JSImport.Namespace)
  @js.native
  ...
  inline def hasValueForAxis[T](value: Any | ForAxes[T], axis: AxisType): /* is victory-core.victory-core/es/types/prop-types.ForAxes<T> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("hasValueForAxis")(value.asInstanceOf[js.Any], axis.asInstanceOf[js.Any])).asInstanceOf[/* is victory-core.victory-core/es/types/prop-types.ForAxes<T> */ Boolean]
  ...
  inline def isTuple[T](value: Any): /* is victory-core.victory-core/es/types/prop-types.Tuple<T> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTuple")(value.asInstanceOf[js.Any]).asInstanceOf[/* is victory-core.victory-core/es/types/prop-types.Tuple<T> */ Boolean]
}
