...
import typingsJapgolly.victoryCore.anon.Bottom
import typingsJapgolly.victoryCore.anon.ChildComponents
...
import typingsJapgolly.victoryCore.anon.Labels
...
import typingsJapgolly.victoryCore.anon.WeakValidationMapVictoryC
import typingsJapgolly.victoryCore.anon.WeakValidationMapVictoryCActive
import typingsJapgolly.victoryCore.anon.WeakValidationMapVictoryD
import typingsJapgolly.victoryCore.anon.Width
import typingsJapgolly.victoryCore.anon.X
import typingsJapgolly.victoryCore.anon.X0
import typingsJapgolly.victoryCore.anon.XAny
import typingsJapgolly.victoryCore.anon.XArray
import typingsJapgolly.victoryCore.anon.XNumber
import typingsJapgolly.victoryCore.anon.Y
import typingsJapgolly.victoryCore.anon.YArray
...
import typingsJapgolly.victoryCore.esVictoryUtilEventsMod.ComponentEventHandlers
import typingsJapgolly.victoryCore.esVictoryUtilEventsMod.ComponentEventKey
import typingsJapgolly.victoryCore.esVictoryUtilEventsMod.PartialEvents
...
import typingsJapgolly.victoryCore.esVictoryUtilTimerMod.default
...
import typingsJapgolly.victoryCore.victoryCoreStrings.negative
import typingsJapgolly.victoryCore.victoryCoreStrings.positive
...
object esVictoryUtilMod {
  
  @JSImport("victory-core/es/victory-util", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object Axis {
    
    @JSImport("victory-core/es/victory-util", "Axis")
    @js.native
    val ^ : js.Any = js.native
  ...
  object Collection {
    ...
    @JSImport("victory-core/es/victory-util", "Collection")
    @js.native
    val ^ : js.Any = js.native
  ...
  object CommonProps {
    ...
    @JSImport("victory-core/es/victory-util", "CommonProps")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("victory-core/es/victory-util", "CommonProps.baseProps")
    @js.native
    ...
    @JSImport("victory-core/es/victory-util", "CommonProps.dataProps")
    @js.native
    ...
    @JSImport("victory-core/es/victory-util", "CommonProps.primitiveProps")
    @js.native
  ...
  object Data {
    ...
    @JSImport("victory-core/es/victory-util", "Data")
    @js.native
    val ^ : js.Any = js.native
  ...
  object DefaultTransitions {
    ...
    @JSImport("victory-core/es/victory-util", "DefaultTransitions")
    @js.native
    val ^ : js.Any = js.native
  ...
  object Domain {
    ...
    @JSImport("victory-core/es/victory-util", "Domain")
    @js.native
    val ^ : js.Any = js.native
  ...
  object Events {
    ...
    @JSImport("victory-core/es/victory-util", "Events")
    @js.native
    val ^ : js.Any = js.native
  ...
  object Helpers {
    ...
    @JSImport("victory-core/es/victory-util", "Helpers")
    @js.native
    val ^ : js.Any = js.native
    ...
    inline def reduceChildren[TChildren /* <: Node */, TItem, TResult](
  ...
  object Hooks {
    ...
    @JSImport("victory-core/es/victory-util", "Hooks")
    @js.native
    val ^ : js.Any = js.native
  ...
  object Immutable {
    ...
    @JSImport("victory-core/es/victory-util", "Immutable")
    @js.native
    val ^ : js.Any = js.native
  ...
  object LabelHelpers {
    ...
    @JSImport("victory-core/es/victory-util", "LabelHelpers")
    @js.native
    val ^ : js.Any = js.native
  ...
  object LineHelpers {
    ...
    @JSImport("victory-core/es/victory-util", "LineHelpers")
    @js.native
    val ^ : js.Any = js.native
  ...
  object Log {
    ...
    @JSImport("victory-core/es/victory-util", "Log")
    @js.native
    val ^ : js.Any = js.native
  ...
  object PointPathHelpers {
    ...
    @JSImport("victory-core/es/victory-util", "PointPathHelpers")
    @js.native
    val ^ : js.Any = js.native
  ...
  object PropTypes {
    ...
    @JSImport("victory-core/es/victory-util", "PropTypes")
    @js.native
    val ^ : js.Any = js.native
    ...
    @JSImport("victory-core/es/victory-util", "PropTypes.domain")
    @js.native
    val domain: Requireable[js.UndefOr[js.Tuple2[Double, Double]]] = js.native
    
    @JSImport("victory-core/es/victory-util", "PropTypes.greaterThanZero")
    @js.native
    val greaterThanZero: Requireable[js.UndefOr[Double]] = js.native
    
    @JSImport("victory-core/es/victory-util", "PropTypes.homogeneousArray")
    @js.native
    val homogeneousArray: Requireable[js.UndefOr[js.Array[Any]]] = js.native
    
    @JSImport("victory-core/es/victory-util", "PropTypes.integer")
    @js.native
    val integer: Requireable[js.UndefOr[Double]] = js.native
    
    @JSImport("victory-core/es/victory-util", "PropTypes.matchDataLength")
    @js.native
    val matchDataLength: Requireable[js.UndefOr[js.Array[Any]]] = js.native
    
    @JSImport("victory-core/es/victory-util", "PropTypes.nonNegative")
    @js.native
    val nonNegative: Requireable[js.UndefOr[Double]] = js.native
    
    @JSImport("victory-core/es/victory-util", "PropTypes.regExp")
    @js.native
    val regExp: Requireable[js.UndefOr[js.RegExp]] = js.native
    
    @JSImport("victory-core/es/victory-util", "PropTypes.scale")
    @js.native
  ...
  object Scale {
    ...
    @JSImport("victory-core/es/victory-util", "Scale")
    @js.native
    val ^ : js.Any = js.native
  ...
  object Selection {
    ...
    @JSImport("victory-core/es/victory-util", "Selection")
    @js.native
    val ^ : js.Any = js.native
  ...
  object Style {
    ...
    @JSImport("victory-core/es/victory-util", "Style")
    @js.native
    val ^ : js.Any = js.native
  ...
  object TextSize {
    ...
    @JSImport("victory-core/es/victory-util", "TextSize")
    @js.native
    val ^ : js.Any = js.native
    ...
    object approximateTextSizeInternal {
      ...
      @JSImport("victory-core/es/victory-util", "TextSize._approximateTextSizeInternal")
      @js.native
      val ^ : js.Any = js.native
  ...
  @JSImport("victory-core/es/victory-util", "Timer")
  @js.native
  ...
  /**
    ...
    * timer.
    */
  @JSImport("victory-core/es/victory-util", "TimerContext")
  @js.native
  val TimerContext: Context[AnimationTimer] = js.native
  
  object Transitions {
    
    @JSImport("victory-core/es/victory-util", "Transitions")
    @js.native
    val ^ : js.Any = js.native
  ...
  object UserProps {
    ...
    @JSImport("victory-core/es/victory-util", "UserProps")
    @js.native
    val ^ : js.Any = js.native
    ...
    inline def withSafeUserProps(component: japgolly.scalajs.react.facade.React.Element, props: Any): japgolly.scalajs.react.facade.React.Element = (^.asInstanceOf[js.Dynamic].applyDynamic("withSafeUserProps")(component.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[japgolly.scalajs.react.facade.React.Element]
  }
  
  object Wrapper {
    
    @JSImport("victory-core/es/victory-util", "Wrapper")
    @js.native
    val ^ : js.Any = js.native
