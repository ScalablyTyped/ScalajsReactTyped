...
object esVictoryThemeVictoryThemeMod {
  
  object VictoryTheme {
    
    @JSImport("victory-core/es/victory-theme/victory-theme", "VictoryTheme")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("victory-core/es/victory-theme/victory-theme", "VictoryTheme.grayscale")
    @js.native
    ...
    @JSImport("victory-core/es/victory-theme/victory-theme", "VictoryTheme.material")
    @js.native
