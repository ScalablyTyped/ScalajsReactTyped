...
import typingsJapgolly.victoryCore.anon.ReadonlyVictoryTransition
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esVictoryTransitionVictoryTransitionMod {
  
  @JSImport("victory-core/es/victory-transition/victory-transition", "VictoryTransition")
  @js.native
  ...
  object VictoryTransition {
    ...
    @JSImport("victory-core/es/victory-transition/victory-transition", "VictoryTransition.contextType")
    @js.native
    ...
    @JSImport("victory-core/es/victory-transition/victory-transition", "VictoryTransition.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("victory-core/es/victory-transition/victory-transition", "VictoryTransition.propTypes")
    @js.native
  ...
  type VictoryTransitionChild = Element
  ...
  object VictoryTransitionProps {
    ...
    inline def apply(children: VdomElement): VictoryTransitionProps = {
