...
import typingsJapgolly.victoryCore.anon.Events
...
import typingsJapgolly.victoryCore.anon.XY
import typingsJapgolly.victoryCore.anon.`4`
import typingsJapgolly.victoryCore.anon.`5`
...
object esVictoryUtilCommonPropsMod {
  
  object CommonProps {
    
    @JSImport("victory-core/es/victory-util/common-props", "CommonProps")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("victory-core/es/victory-util/common-props", "CommonProps.baseProps")
    @js.native
    ...
    @JSImport("victory-core/es/victory-util/common-props", "CommonProps.dataProps")
    @js.native
    ...
    @JSImport("victory-core/es/victory-util/common-props", "CommonProps.primitiveProps")
    @js.native
