...
object Immutable {
  ...
  @JSImport("victory-core/es", "Immutable")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("victory-core/es", "Immutable.IMMUTABLE_ITERABLE")
  @js.native
  val IMMUTABLE_ITERABLE: /* "@@__IMMUTABLE_ITERABLE__@@" */ String = js.native
  
  @JSImport("victory-core/es", "Immutable.IMMUTABLE_LIST")
  @js.native
  val IMMUTABLE_LIST: /* "@@__IMMUTABLE_LIST__@@" */ String = js.native
  
  @JSImport("victory-core/es", "Immutable.IMMUTABLE_MAP")
  @js.native
  val IMMUTABLE_MAP: /* "@@__IMMUTABLE_MAP__@@" */ String = js.native
  
  @JSImport("victory-core/es", "Immutable.IMMUTABLE_RECORD")
  @js.native
