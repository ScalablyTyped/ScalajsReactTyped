...
/* Inlined {  style :{  data :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject | undefined,   labels :victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject | std.Array<victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject> | undefined,   flyout :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject | undefined} | undefined} & victory-core.victory-core/es/victory-util/common-props.VictoryCommonThemeProps & victory-core.victory-core/es/victory-util/common-props.VictoryDatableProps */
