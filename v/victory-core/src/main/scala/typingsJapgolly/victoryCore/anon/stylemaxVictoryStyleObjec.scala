...
import typingsJapgolly.victoryCore.esTypesPropTypesMod.ColorScalePropType
import typingsJapgolly.victoryCore.esTypesPropTypesMod.D3Scale
import typingsJapgolly.victoryCore.esTypesPropTypesMod.DomainPaddingPropType
import typingsJapgolly.victoryCore.esTypesPropTypesMod.EventCallbackInterface
import typingsJapgolly.victoryCore.esTypesPropTypesMod.RangePropType
import typingsJapgolly.victoryCore.esTypesPropTypesMod.ScalePropType
import typingsJapgolly.victoryCore.esTypesPropTypesMod.StringOrNumberOrList
...
/* Inlined {  style :{  max :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject | undefined,   maxLabels :victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject | std.Array<victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject> | undefined,   median :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject | undefined,   medianLabels :victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject | std.Array<victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject> | undefined,   min :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject | undefined,   minLabels :victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject | std.Array<victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject> | undefined,   q1 :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject | undefined,   q1Labels :victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject | std.Array<victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject> | undefined,   q3 :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject | undefined,   q3Labels :victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject | std.Array<victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject> | undefined} | undefined,   boxWidth :number | undefined} & victory-core.victory-core/es/victory-util/common-props.VictoryCommonThemeProps */
trait stylemaxVictoryStyleObjec extends StObject {
  ...
  var containerComponent: js.UndefOr[Element] = js.undefined
...
object stylemaxVictoryStyleObjec {
  
  inline def apply(): stylemaxVictoryStyleObjec = {
  ...
  extension [Self <: stylemaxVictoryStyleObjec](x: Self) {
    ...
    inline def setStyle(value: Max): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
