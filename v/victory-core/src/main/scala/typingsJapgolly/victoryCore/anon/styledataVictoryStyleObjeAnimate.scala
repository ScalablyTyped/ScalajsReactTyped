...
/* Inlined {  style :{  data :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject | undefined,   labels :victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject | std.Array<victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject> | undefined} | undefined,   candleColors :{  positive :string | undefined,   negative :string | undefined} | undefined} & victory-core.victory-core/es/victory-util/common-props.VictoryCommonThemeProps */
trait styledataVictoryStyleObjeAnimate extends StObject {
...
object styledataVictoryStyleObjeAnimate {
  
  inline def apply(): styledataVictoryStyleObjeAnimate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[styledataVictoryStyleObjeAnimate]
  }
  
  extension [Self <: styledataVictoryStyleObjeAnimate](x: Self) {
