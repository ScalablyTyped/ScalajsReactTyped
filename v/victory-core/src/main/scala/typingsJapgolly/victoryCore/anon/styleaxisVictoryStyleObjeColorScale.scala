...
/* Inlined {  style :{  axis :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject | undefined,   axisLabel :victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject | std.Array<victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject> | undefined,   grid :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject | undefined,   ticks :victory-core.victory-core/es/victory-theme/types.VictoryTickStyleObject | undefined,   tickLabels :victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject | std.Array<victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject> | undefined} | undefined} & victory-core.victory-core/es/victory-util/common-props.VictoryCommonThemeProps */
trait styleaxisVictoryStyleObjeColorScale extends StObject {
...
object styleaxisVictoryStyleObjeColorScale {
  
  inline def apply(): styleaxisVictoryStyleObjeColorScale = {
