...
/* Inlined {  gutter :number | victory-core.victory-core/es/victory-theme/types.BlockProps | undefined,   rowGutter :number | victory-core.victory-core/es/victory-theme/types.BlockProps | undefined,   orientation :string | undefined,   titleOrientation :string | undefined,   style :{  data :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject & {  type :string | undefined} | undefined,   border :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject | undefined,   labels :victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject | std.Array<victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject> | undefined,   title :victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject | undefined} | undefined,   itemsPerRow :number | undefined,   x :number | undefined,   y :number | undefined,   centerTitle :boolean | undefined,   borderPadding :number | victory-core.victory-core/es/victory-theme/types.BlockProps | undefined} & victory-core.victory-core/es/victory-util/common-props.VictoryCommonThemeProps */
