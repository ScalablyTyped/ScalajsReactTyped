...
/* Inlined {  style :{  data :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject | undefined,   labels :victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject | std.Array<victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject> | undefined} | undefined} & victory-core.victory-core/es/victory-util/common-props.VictoryCommonThemeProps & victory-core.victory-core/es/victory-util/common-props.VictoryDatableProps */
trait styledataVictoryStyleObje extends StObject {
...
object styledataVictoryStyleObje {
  
  inline def apply(): styledataVictoryStyleObje = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[styledataVictoryStyleObje]
  }
  
  extension [Self <: styledataVictoryStyleObje](x: Self) {
