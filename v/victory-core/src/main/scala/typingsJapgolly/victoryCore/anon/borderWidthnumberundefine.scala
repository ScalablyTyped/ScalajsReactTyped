...
/* Inlined {  borderWidth :number | undefined,   style :{  data :victory-core.victory-core/es/victory-theme/types.VictoryStyleObject | undefined,   labels :victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject | std.Array<victory-core.victory-core/es/victory-theme/types.VictoryLabelStyleObject> | undefined} | undefined} & victory-core.victory-core/es/victory-util/common-props.VictoryCommonThemeProps */
...
object borderWidthnumberundefine {
  ...
  inline def apply(): borderWidthnumberundefine = {
