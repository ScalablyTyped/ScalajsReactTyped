...
trait AriaLabel_ extends StObject {
  ...
  var rx: Requireable[Double]
  
  var ry: Requireable[Double]
...
object AriaLabel_ {
  ...
  inline def apply(
    ...
    rx: Requireable[Double],
    ry: Requireable[Double],
    width: Requireable[Double],
    x: Requireable[Double],
    y: Requireable[Double]
  ): AriaLabel_ = {
    val __obj = js.Dynamic.literal(circleComponent = circleComponent.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], rectComponent = rectComponent.asInstanceOf[js.Any], rx = rx.asInstanceOf[js.Any], ry = ry.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any], x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any])
  ...
  extension [Self <: AriaLabel_](x: Self) {
    ...
    inline def setRx(value: Requireable[Double]): Self = StObject.set(x, "rx", value.asInstanceOf[js.Any])
    
    inline def setRy(value: Requireable[Double]): Self = StObject.set(x, "ry", value.asInstanceOf[js.Any])
