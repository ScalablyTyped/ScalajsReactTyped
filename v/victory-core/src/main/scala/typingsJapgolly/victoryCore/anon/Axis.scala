...
import typingsJapgolly.victoryCore.esVictoryThemeTypesMod.VictoryStyleObject
import typingsJapgolly.victoryCore.esVictoryThemeTypesMod.VictoryTickStyleObject
