...
object anon {
  ...
  object ContainerComponent {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(containerComponent = containerComponent.rawElement.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any], dataComponent = dataComponent.rawElement.asInstanceOf[js.Any], groupComponent = groupComponent.rawElement.asInstanceOf[js.Any], labelComponent = labelComponent.rawElement.asInstanceOf[js.Any], samples = samples.asInstanceOf[js.Any], sortOrder = sortOrder.asInstanceOf[js.Any], standalone = standalone.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any])
