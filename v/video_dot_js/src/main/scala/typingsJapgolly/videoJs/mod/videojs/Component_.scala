...
import typingsJapgolly.videoJs.mod.videojs.Component.DimensionObject
import typingsJapgolly.videoJs.mod.videojs.Component.GenericCallback
import typingsJapgolly.videoJs.mod.videojs.Dom.Predicate
import typingsJapgolly.videoJs.videoJsStrings.height
import typingsJapgolly.videoJs.videoJsStrings.width
...
trait Component_ extends EventedMixin {
  ...
  @JSName("$")
  def $(selector: String, context: typingsJapgolly.std.Element): Element = js.native
  /**
  ...
  @JSName("$$")
  def DollarDollar(selector: String, context: typingsJapgolly.std.Element): NodeList = js.native
  /**
  ...
  def addChild(component: typingsJapgolly.std.Element): Element = js.native
  def addChild(component: typingsJapgolly.std.Element, optionsopt: js.Any): Element = js.native
  def addChild(component: typingsJapgolly.std.Element, optionsopt: js.Any, indexopt: Double): Element = js.native
