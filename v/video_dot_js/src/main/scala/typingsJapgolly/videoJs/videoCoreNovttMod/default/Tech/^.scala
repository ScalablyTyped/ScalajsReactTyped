package typingsJapgolly.videoJs.videoCoreNovttMod.default.Tech

import org.scalablytyped.runtime.Instantiable0
import org.scalablytyped.runtime.Instantiable1
import org.scalablytyped.runtime.Instantiable2
import org.scalablytyped.runtime.TopLevel
import typingsJapgolly.videoJs.TypeofTech
import typingsJapgolly.videoJs.mod.videojs.Component.ReadyCallback
import typingsJapgolly.videoJs.videoJsStrings._empty
import typingsJapgolly.videoJs.videoJsStrings.maybe
import typingsJapgolly.videoJs.videoJsStrings.problably
...
/**
  ...
  */
class ^ ()
  extends typingsJapgolly.videoJs.mod.videojs.Tech {
...
object ^
  ...
  *        Callback function to call when the `HTML5` Tech is ready.
  */
Instantiable0[typingsJapgolly.videoJs.mod.videojs.Tech]) with (Instantiable1[/* options */ js.Any, typingsJapgolly.videoJs.mod.videojs.Tech]) with (Instantiable2[
        /* options */ js.Any, 
        /* ready */ ReadyCallback, 
        typingsJapgolly.videoJs.mod.videojs.Tech
      ])
    ] {
  /**
  ...
  /**
    ...
    */
  def getTech(name: String): js.UndefOr[typingsJapgolly.videoJs.mod.videojs.Tech] = js.native
  /**
