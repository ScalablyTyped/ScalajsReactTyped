...
import typingsJapgolly.videoJs.mod.videojs.Child
...
import typingsJapgolly.videoJs.mod.videojs.XhrOptions
...
import typingsJapgolly.videoJs.videoJsStrings.hide
...
object anon {
  ...
  object BeforeRequest {
    ...
    inline def apply(beforeRequest: XhrOptions => Callback): BeforeRequest = {
      val __obj = js.Dynamic.literal(beforeRequest = js.Any.fromFunction1((t0: XhrOptions) => beforeRequest(t0).runNow()))
      __obj.asInstanceOf[BeforeRequest]
    }
    
    extension [Self <: BeforeRequest](x: Self) {
      
      inline def setBeforeRequest(value: XhrOptions => Callback): Self = StObject.set(x, "beforeRequest", js.Any.fromFunction1((t0: XhrOptions) => value(t0).runNow()))
    }
  }
  ...
  trait Instantiable
    ...
    *         The key/value store of player options.
    */
  Instantiable1[/* player */ Player, typingsJapgolly.videoJs.mod.videojs.Button]
       with Instantiable2[
          /* player */ Player, 
  ...
  trait InstantiableClickableComponent
    ...
    *         The key/value store of player options.
    */
  Instantiable1[/* player */ Player, typingsJapgolly.videoJs.mod.videojs.ClickableComponent]
       with Instantiable2[
          /* player */ Player, 
          /* options */ ClickableComponentOptions, 
          typingsJapgolly.videoJs.mod.videojs.ClickableComponent
        ]
  ...
  trait InstantiableMenu
    ...
    *
    */
  Instantiable1[/* player */ Player, typingsJapgolly.videoJs.mod.videojs.Menu]
       with Instantiable2[
          /* player */ Player, 
          /* options */ MenuOptions, 
          typingsJapgolly.videoJs.mod.videojs.Menu
        ]
  ...
  trait InstantiableMenuButton
    ...
    *        The key/value store of player options.
    */
  Instantiable1[/* player */ Player, typingsJapgolly.videoJs.mod.videojs.MenuButton]
       with Instantiable2[
          /* player */ Player, 
  ...
  trait InstantiableMenuItem
    ...
    *
    */
  Instantiable1[/* player */ Player, typingsJapgolly.videoJs.mod.videojs.MenuItem]
       with Instantiable2[
          /* player */ Player, 
          /* options */ MenuItemOptions, 
          typingsJapgolly.videoJs.mod.videojs.MenuItem
        ]
  ...
  trait InstantiableModalDialog
    ...
    *        The key/value store of player options.
    */
  Instantiable1[/* player */ Player, typingsJapgolly.videoJs.mod.videojs.ModalDialog]
       with Instantiable2[
          /* player */ Player, 
          /* options */ ModalDialogOptions, 
          typingsJapgolly.videoJs.mod.videojs.ModalDialog
        ]
  ...
  trait InstantiableMouseTimeDisplay
    ...
    *        The key/value store of player options.
    */
  Instantiable1[/* player */ Player, typingsJapgolly.videoJs.mod.videojs.MouseTimeDisplay]
       with Instantiable2[
          /* player */ Player, 
          /* options */ ComponentOptions, 
  ...
  trait InstantiableSpacer
    ...
    *        Function that gets called when the `Component` is ready.
    */
  Instantiable1[/* player */ Player, typingsJapgolly.videoJs.mod.videojs.Spacer]
       with Instantiable2[
          /* player */ Player, 
          /* options */ ComponentOptions, 
          typingsJapgolly.videoJs.mod.videojs.Spacer
        ]
       with Instantiable3[
          /* player */ Player, 
          (/* options */ ComponentOptions) | (/* options */ Unit), 
