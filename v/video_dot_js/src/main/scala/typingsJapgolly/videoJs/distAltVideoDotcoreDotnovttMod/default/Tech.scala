package typingsJapgolly.videoJs.distAltVideoDotcoreDotnovttMod.default

import typingsJapgolly.std.CanPlayTypeResult
import typingsJapgolly.videoJs.anon.CanPlaySource
...
object Tech {
  ...
  open class ^ ()
    extends StObject
       with typingsJapgolly.videoJs.mod.videojs.Tech {
  ...
  /**
    ...
    */
  inline def getTech(name: String): js.UndefOr[typingsJapgolly.videoJs.mod.videojs.Tech] = ^.asInstanceOf[js.Dynamic].applyDynamic("getTech")(name.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typingsJapgolly.videoJs.mod.videojs.Tech]]
