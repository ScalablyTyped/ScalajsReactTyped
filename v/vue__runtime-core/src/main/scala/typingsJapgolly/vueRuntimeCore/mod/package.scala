...
import typingsJapgolly.vueRuntimeCore.anon.Attrs
import typingsJapgolly.vueRuntimeCore.anon.Default
import typingsJapgolly.vueRuntimeCore.anon.ElementvnodeVNodeRenderer
import typingsJapgolly.vueRuntimeCore.anon.From
import typingsJapgolly.vueRuntimeCore.anon.Install
import typingsJapgolly.vueRuntimeCore.anon.InstallPluginInstallFunction
import typingsJapgolly.vueRuntimeCore.anon.Instantiable
...
import typingsJapgolly.vueRuntimeCore.anon.Iterator
import typingsJapgolly.vueRuntimeCore.anon.PropOptionsanyanyshouldCa
...
import typingsJapgolly.vueRuntimeCore.mod.^
...
inline def getTransitionRawChildren(
  children: js.Array[VNode[RendererNode, RendererElement, StringDictionary[Any]]],
  keepComment: Boolean,
  parentKey: String | Double | js.Symbol | Null
...
inline def inject[T](key: js.Symbol): js.UndefOr[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("inject")(key.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[T]]
inline def inject[T](key: js.Symbol, defaultValue: T): T = (^.asInstanceOf[js.Dynamic].applyDynamic("inject")(key.asInstanceOf[js.Any], defaultValue.asInstanceOf[js.Any])).asInstanceOf[T]
...
inline def inject_false[T](key: js.Symbol, defaultValue: T, treatDefaultAsFactory: `false`): T = (^.asInstanceOf[js.Dynamic].applyDynamic("inject")(key.asInstanceOf[js.Any], defaultValue.asInstanceOf[js.Any], treatDefaultAsFactory.asInstanceOf[js.Any])).asInstanceOf[T]
...
inline def inject_true[T](key: js.Symbol, defaultValue: T, treatDefaultAsFactory: `true`): T = (^.asInstanceOf[js.Dynamic].applyDynamic("inject")(key.asInstanceOf[js.Any], defaultValue.asInstanceOf[js.Any], treatDefaultAsFactory.asInstanceOf[js.Any])).asInstanceOf[T]
inline def inject_true[T](key: js.Symbol, defaultValue: js.Function0[T], treatDefaultAsFactory: `true`): T = (^.asInstanceOf[js.Dynamic].applyDynamic("inject")(key.asInstanceOf[js.Any], defaultValue.asInstanceOf[js.Any], treatDefaultAsFactory.asInstanceOf[js.Any])).asInstanceOf[T]
...
inline def provide[T](key: js.Symbol, value: T): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("provide")(key.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
...
type AsyncComponentLoader[T] = js.Function0[js.Promise[AsyncComponentResolveResult[T]]]

type AsyncComponentResolveResult[T] = T | Default[T]

type Component[Props, RawBindings, D, C /* <: ComputedOptions */, M /* <: MethodOptions */] = (ConcreteComponent[Props, RawBindings, D, C, M]) | (ComponentPublicInstanceConstructor[Props, Any, Any, Any, ComputedOptions, MethodOptions])
...
type ComponentProvideOptions = ObjectProvideOptions | js.Function
...
type ConcreteComponent[Props, RawBindings, D, C /* <: ComputedOptions */, M /* <: MethodOptions */] = (ComponentOptions[Props, RawBindings, D, C, M, Any, Any, Any]) | (FunctionalComponent[Props, Any])

type CreateAppFunction[HostElement] = js.Function2[
/* rootComponent */ Component[Any, Any, Any, ComputedOptions, MethodOptions], 
/* rootProps */ js.UndefOr[Data | Null], 
App[HostElement]]

type CreateComponentPublicInstance[P, B, D, C /* <: ComputedOptions */, M /* <: MethodOptions */, Mixin /* <: ComponentOptionsMixin */, Extends /* <: ComponentOptionsMixin */, E /* <: EmitsOptions */, PublicProps, Defaults, MakeDefaultsOptional /* <: Boolean */, PublicMixin, PublicP, PublicB, PublicD, PublicC /* <: ComputedOptions */, PublicM /* <: MethodOptions */, PublicDefaults] = ComponentPublicInstance[
PublicP, 
PublicB, 
PublicD, 
PublicC, 
...
type DebuggerHook = js.Function1[/* e */ DebuggerEvent, Unit]

type DefaultFactory[T] = js.Function1[/* props */ Data, js.UndefOr[T | Null]]

type DefaultKeys[T] = /* import warning: importer.ImportType#apply Failed type conversion: {[ K in keyof T ]: T[K] extends {  default :any} | std.BooleanConstructor | {readonly type <T>(): boolean, readonly type <T>(value : T): boolean,   type :std.BooleanConstructor}? T[K] extends {readonly type <T>(): boolean, readonly type <T>(value : T): boolean,   type :std.BooleanConstructor,   required :true}? never : K : never}[keyof T] */ js.Any

type DefineComponent_[PropsOrPropOptions, RawBindings, D, C /* <: ComputedOptions */, M /* <: MethodOptions */, Mixin /* <: ComponentOptionsMixin */, Extends /* <: ComponentOptionsMixin */, E /* <: EmitsOptions */, EE /* <: String */, PP, Props, Defaults] = (ComponentPublicInstanceConstructor[
...
Any, 
ComputedOptions, 
MethodOptions]) & (ComponentOptionsBase[Props, RawBindings, D, C, M, Mixin, Extends, E, EE, Defaults]) & PP

type Directive[T, V] = (ObjectDirective[T, V]) | (FunctionDirective[T, V])

type DirectiveArguments = js.Array[
(js.Array[Directive[Any, Any]]) | (js.Tuple2[Directive[Any, Any], Any]) | (js.Tuple3[Directive[Any, Any], Any, String]) | (js.Tuple4[Directive[Any, Any], Any, String, DirectiveModifiers])]

type DirectiveHook[T, Prev, V] = js.Function4[
/* el */ T, 
/* binding */ DirectiveBinding[V], 
/* vnode */ VNode[Any, T, StringDictionary[Any]], 
/* prevVNode */ Prev, 
Unit]
...
type HMRComponent = (ComponentOptions[js.Object, Any, Any, Any, Any, Any, Any, Any]) | ClassComponent
...
js.Object, 
`false`, 
ComponentOptionsBase[Any, Any, Any, Any, Any, Any, Any, Any, Any, js.Object]]) & LegacyPublicProperties
...
type NormalizedProp = Null | PropOptionsanyanyshouldCa
...
type ObjectInjectOptions = Record[String | js.Symbol, String | js.Symbol | From]

type ObjectProvideOptions = Record[String | js.Symbol, Any]

type OnCleanup = js.Function1[/* cleanupFn */ js.Function0[Unit], Unit]

type OptionMergeFunction = js.Function2[/* to */ Any, /* from */ Any, Any]

type OptionalKeys[T] = Exclude[/* keyof T */ String, RequiredKeys[T]]

type PatchBlockChildrenFn = js.Function7[
...
/* parentSuspense */ SuspenseBoundary | Null, 
/* isSVG */ Boolean, 
/* slotScopeIds */ js.Array[String] | Null, 
Unit]

type PatchChildrenFn = js.Function9[
...
type Plugin2 = (PluginInstallFunction & Install) | InstallPluginInstallFunction

type Prop[T, D] = (PropOptions[T, D]) | PropType[T]
...
type RemoveFn = js.Function1[/* vnode */ VNode[RendererNode, RendererElement, StringDictionary[Any]], Unit]

type RendererElement = RendererNode

type RendererNode = StringDictionary[Any]

type RequiredKeys[T] = /* import warning: importer.ImportType#apply Failed type conversion: {[ K in keyof T ]: T[K] extends {  required :true} | {  default :any} | std.BooleanConstructor | {readonly type <T>(): boolean, readonly type <T>(value : T): boolean,   type :std.BooleanConstructor}? T[K] extends {  default :undefined | (): undefined}? never : K : never}[keyof T] */ js.Any

type RootHydrateFunction = js.Function2[
/* vnode */ VNode[Node, Element, StringDictionary[Any]], 
/* container */ ElementvnodeVNodeRenderer | ShadowRootvnodeVNodeRende, 
Unit]

type RootRenderFunction[HostElement] = js.Function3[
/* vnode */ (VNode[RendererNode, RendererElement, StringDictionary[Any]]) | Null, 
/* container */ HostElement, 
/* isSVG */ js.UndefOr[Boolean], 
Unit]

type SSRDirectiveHook = js.Function2[
/* binding */ DirectiveBinding[Any], 
/* vnode */ VNode[RendererNode, RendererElement, StringDictionary[Any]], 
js.UndefOr[Data]]

type SchedulerJobs = SchedulerJob | js.Array[SchedulerJob]

type SetupRenderEffectFn = js.Function7[
/* instance */ ComponentInternalInstance, 
/* initialVNode */ VNode[RendererNode, RendererElement, StringDictionary[Any]], 
/* container */ RendererElement, 
/* anchor */ RendererNode | Null, 
...
type UnmountChildrenFn = js.Function6[
/* children */ js.Array[VNode[RendererNode, RendererElement, StringDictionary[Any]]], 
/* parentComponent */ ComponentInternalInstance | Null, 
/* parentSuspense */ SuspenseBoundary | Null, 
...
(VNode[RendererNode, RendererElement, StringDictionary[Any]]) | String | Double | Boolean | Null | Unit]
...
type VNodeRef = String | Ref_[Any] | (js.Function2[
...
/* Rewritten from type alias, can be one of: 
  - java.lang.String
  - typingsJapgolly.vueRuntimeCore.mod.VNode[
typingsJapgolly.vueRuntimeCore.mod.RendererNode, 
typingsJapgolly.vueRuntimeCore.mod.RendererElement, 
org.scalablytyped.runtime.StringDictionary[scala.Any]]
  - typingsJapgolly.vueRuntimeCore.mod.Component[
scala.Any, 
scala.Any, 
scala.Any, 
typingsJapgolly.vueRuntimeCore.mod.ComputedOptions, 
typingsJapgolly.vueRuntimeCore.mod.MethodOptions]
  - js.Symbol
  - typingsJapgolly.vueRuntimeCore.anon.IsFragment
  - typingsJapgolly.vueRuntimeCore.anon.Hydrate
  - typingsJapgolly.vueRuntimeCore.anon.Create
*/
type VNodeTypes = _VNodeTypes | (VNode[RendererNode, RendererElement, StringDictionary[Any]]) | (Component[Any, Any, Any, ComputedOptions, MethodOptions]) | String | js.Symbol

type VNodeUpdateHook = js.Function2[
/* vnode */ VNode[RendererNode, RendererElement, StringDictionary[Any]], 
/* oldVNode */ VNode[RendererNode, RendererElement, StringDictionary[Any]], 
Unit]

type WatchCallback[V, OV] = js.Function3[/* value */ V, /* oldValue */ OV, /* onCleanup */ OnCleanup, Any]

type WatchEffect_ = js.Function1[/* onCleanup */ OnCleanup, Unit]

type WatchOptionItem = String | (WatchCallback[Any, Any]) | ObjectWatchOptionItem

type WatchSource[T] = Ref_[T] | ComputedRef[T] | js.Function0[T]

type WatchStopHandle = js.Function0[Unit]
