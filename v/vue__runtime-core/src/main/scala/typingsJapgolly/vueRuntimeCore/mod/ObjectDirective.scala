...
object ObjectDirective {
  ...
  extension [Self <: ObjectDirective[?, ?], T, V](x: Self & (ObjectDirective[T, V])) {
    ...
    inline def setBeforeMount(
      value: (T, /* binding */ DirectiveBinding[V], /* vnode */ VNode[Any, T, StringDictionary[Any]], Null) => Callback
    ): Self = StObject.set(x, "beforeMount", js.Any.fromFunction4((t0: T, t1: /* binding */ DirectiveBinding[V], t2: /* vnode */ VNode[Any, T, StringDictionary[Any]], t3: Null) => (value(t0, t1, t2, t3)).runNow()))
    
    inline def setBeforeMountUndefined: Self = StObject.set(x, "beforeMount", js.undefined)
    
    inline def setBeforeUnmount(
      value: (T, /* binding */ DirectiveBinding[V], /* vnode */ VNode[Any, T, StringDictionary[Any]], Null) => Callback
    ): Self = StObject.set(x, "beforeUnmount", js.Any.fromFunction4((t0: T, t1: /* binding */ DirectiveBinding[V], t2: /* vnode */ VNode[Any, T, StringDictionary[Any]], t3: Null) => (value(t0, t1, t2, t3)).runNow()))
    
    inline def setBeforeUnmountUndefined: Self = StObject.set(x, "beforeUnmount", js.undefined)
    
    inline def setBeforeUpdate(
      value: (T, /* binding */ DirectiveBinding[V], /* vnode */ VNode[Any, T, StringDictionary[Any]], VNode[Any, T, StringDictionary[Any]]) => Callback
    ): Self = StObject.set(x, "beforeUpdate", js.Any.fromFunction4((t0: T, t1: /* binding */ DirectiveBinding[V], t2: /* vnode */ VNode[Any, T, StringDictionary[Any]], t3: VNode[Any, T, StringDictionary[Any]]) => (value(t0, t1, t2, t3)).runNow()))
    
    inline def setBeforeUpdateUndefined: Self = StObject.set(x, "beforeUpdate", js.undefined)
    
    inline def setCreated(
      value: (T, /* binding */ DirectiveBinding[V], /* vnode */ VNode[Any, T, StringDictionary[Any]], Null) => Callback
    ): Self = StObject.set(x, "created", js.Any.fromFunction4((t0: T, t1: /* binding */ DirectiveBinding[V], t2: /* vnode */ VNode[Any, T, StringDictionary[Any]], t3: Null) => (value(t0, t1, t2, t3)).runNow()))
    ...
    inline def setMounted(
      value: (T, /* binding */ DirectiveBinding[V], /* vnode */ VNode[Any, T, StringDictionary[Any]], Null) => Callback
    ): Self = StObject.set(x, "mounted", js.Any.fromFunction4((t0: T, t1: /* binding */ DirectiveBinding[V], t2: /* vnode */ VNode[Any, T, StringDictionary[Any]], t3: Null) => (value(t0, t1, t2, t3)).runNow()))
    
    inline def setMountedUndefined: Self = StObject.set(x, "mounted", js.undefined)
    
    inline def setUnmounted(
      value: (T, /* binding */ DirectiveBinding[V], /* vnode */ VNode[Any, T, StringDictionary[Any]], Null) => Callback
    ): Self = StObject.set(x, "unmounted", js.Any.fromFunction4((t0: T, t1: /* binding */ DirectiveBinding[V], t2: /* vnode */ VNode[Any, T, StringDictionary[Any]], t3: Null) => (value(t0, t1, t2, t3)).runNow()))
    
    inline def setUnmountedUndefined: Self = StObject.set(x, "unmounted", js.undefined)
    
    inline def setUpdated(
      value: (T, /* binding */ DirectiveBinding[V], /* vnode */ VNode[Any, T, StringDictionary[Any]], VNode[Any, T, StringDictionary[Any]]) => Callback
    ): Self = StObject.set(x, "updated", js.Any.fromFunction4((t0: T, t1: /* binding */ DirectiveBinding[V], t2: /* vnode */ VNode[Any, T, StringDictionary[Any]], t3: VNode[Any, T, StringDictionary[Any]]) => (value(t0, t1, t2, t3)).runNow()))
