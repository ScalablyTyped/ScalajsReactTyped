...
object AsyncComponentOptions {
  ...
  inline def apply[T](loader: CallbackTo[js.Promise[AsyncComponentResolveResult[T]]]): AsyncComponentOptions[T] = {
    val __obj = js.Dynamic.literal(loader = loader.toJsFn)
  ...
  extension [Self <: AsyncComponentOptions[?], T](x: Self & AsyncComponentOptions[T]) {
    ...
    inline def setLoader(value: CallbackTo[js.Promise[AsyncComponentResolveResult[T]]]): Self = StObject.set(x, "loader", value.toJsFn)
