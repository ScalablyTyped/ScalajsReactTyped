package typingsJapgolly.vueRuntimeCore

import typingsJapgolly.vueRuntimeCore.mod.DeprecationTypes
import typingsJapgolly.vueRuntimeCore.mod.LifecycleHooks
import typingsJapgolly.vueRuntimeCore.mod.OptionTypesKeys
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object vueRuntimeCoreStrings {
  ...
  @js.native
  sealed trait ATTR_ENUMERATED_COERCION
    extends StObject
  ...
  sealed trait bum
    extends StObject
       with LifecycleHooks
  inline def bum: bum = "bum".asInstanceOf[bum]
  ...
  @js.native
  sealed trait `in-out` extends StObject
  ...
  @js.native
  sealed trait `out-in` extends StObject
  inline def `out-in`: `out-in` = "out-in".asInstanceOf[`out-in`]
  ...
  sealed trait rtg
    extends StObject
       with LifecycleHooks
  inline def rtg: rtg = "rtg".asInstanceOf[rtg]
  ...
  @js.native
  sealed trait `suppress-warning` extends StObject
  inline def `suppress-warning`: `suppress-warning` = "suppress-warning".asInstanceOf[`suppress-warning`]
