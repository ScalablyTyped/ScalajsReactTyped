...
object anon {
  ...
  trait Call extends StObject {
    ...
    def apply(initialProps: VictoryStackProps): typingsJapgolly.react.mod.global.JSX.Element = js.native
  ...
  object ContainerComponent {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(containerComponent = containerComponent.rawElement.asInstanceOf[js.Any], fillInMissingData = fillInMissingData.asInstanceOf[js.Any], groupComponent = groupComponent.rawElement.asInstanceOf[js.Any], standalone = standalone.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any])
