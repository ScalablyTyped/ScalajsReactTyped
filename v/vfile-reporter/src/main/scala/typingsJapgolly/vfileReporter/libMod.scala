...
import typingsJapgolly.vfileReporter.vfileReporterStrings.file
import typingsJapgolly.vfileStatistics.mod.Statistics_
...
object libMod {
  ...
  inline def reporter(files: js.Array[typingsJapgolly.vfile.mod.VFile]): String = ^.asInstanceOf[js.Dynamic].applyDynamic("reporter")(files.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def reporter(files: js.Array[typingsJapgolly.vfile.mod.VFile], options: Options): String = (^.asInstanceOf[js.Dynamic].applyDynamic("reporter")(files.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def reporter(files: typingsJapgolly.vfile.mod.VFile): String = ^.asInstanceOf[js.Dynamic].applyDynamic("reporter")(files.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def reporter(files: typingsJapgolly.vfile.mod.VFile, options: Options): String = (^.asInstanceOf[js.Dynamic].applyDynamic("reporter")(files.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
