...
trait Omitdefaultexists extends StObject {
  ...
  def getComponent[T /* <: scala.Nothing */](selector: String): OmitWrapperLikeexists
  @JSName("getComponent")
  var getComponent_Original: js.Function1[/* selector */ String, OmitWrapperLikeexists]
...
object Omitdefaultexists {
  ...
  inline def apply(
    ...
    getComponent: /* selector */ String => OmitWrapperLikeexists,
  ...
  extension [Self <: Omitdefaultexists](x: Self) {
    ...
    inline def setGetComponent(value: /* selector */ String => OmitWrapperLikeexists): Self = StObject.set(x, "getComponent", js.Any.fromFunction1(value))
