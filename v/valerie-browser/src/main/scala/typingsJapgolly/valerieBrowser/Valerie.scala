...
object Valerie {
  ...
  object ModelValidationStateOptions {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(applicable = applicable.toJsFn, excludeFromSummary = excludeFromSummary.asInstanceOf[js.Any], failureMessage = failureMessage.asInstanceOf[js.Any], name = name.toJsFn, paused = paused.toJsFn)
      __obj.asInstanceOf[ModelValidationStateOptions]
    }
    
    extension [Self <: ModelValidationStateOptions](x: Self) {
      
      inline def setApplicable(value: CallbackTo[Boolean]): Self = StObject.set(x, "applicable", value.toJsFn)
      ...
      inline def setPaused(value: CallbackTo[Boolean]): Self = StObject.set(x, "paused", value.toJsFn)
    }
  }
  ...
  object ValidatableModel {
    ...
    inline def apply[T](end: CallbackTo[T], name: String => PropertyValidationState[T]): ValidatableModel[T] = {
      val __obj = js.Dynamic.literal(end = end.toJsFn, name = js.Any.fromFunction1(name))
      __obj.asInstanceOf[ValidatableModel[T]]
    }
    
    extension [Self <: ValidatableModel[?], T](x: Self & ValidatableModel[T]) {
      
      inline def setEnd(value: CallbackTo[T]): Self = StObject.set(x, "end", value.toJsFn)
  ...
  object ValidationOptions {
    ...
    extension [Self <: ValidationOptions](x: Self) {
      ...
      inline def setApplicable(value: CallbackTo[Any]): Self = StObject.set(x, "applicable", value.toJsFn)
      ...
      inline def setRequired(value: CallbackTo[Any]): Self = StObject.set(x, "required", value.toJsFn)
