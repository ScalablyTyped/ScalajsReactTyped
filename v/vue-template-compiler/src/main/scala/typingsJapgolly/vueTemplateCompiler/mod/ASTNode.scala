...
import typingsJapgolly.vueTemplateCompiler.AnonCallback
import typingsJapgolly.vueTemplateCompiler.AnonName
import typingsJapgolly.vueTemplateCompiler.AnonValue
import typingsJapgolly.vueTemplateCompiler.vueTemplateCompilerBooleans.`true`
import typingsJapgolly.vueTemplateCompiler.vueTemplateCompilerNumbers.`1`
import typingsJapgolly.vueTemplateCompiler.vueTemplateCompilerNumbers.`2`
...
object ASTNode {
  ...
  def ASTElement(
    ...
    key: String = null,
    model: AnonCallback = null,
    nativeEvents: ASTElementHandlers = null,
    ns: String = null,
    once: `true` = null,
    onceProcessed: js.UndefOr[Boolean] = js.undefined,
    parent: typingsJapgolly.vueTemplateCompiler.mod.ASTElement = null,
    ...
    scopedSlots: Record[String, typingsJapgolly.vueTemplateCompiler.mod.ASTElement] = null,
    ...
    wrapData: /* code */ String => CallbackTo[String] = null,
    wrapListeners: /* code */ String => CallbackTo[String] = null
  ): ASTNode = {
    ...
    if (wrapData != null) __obj.updateDynamic("wrapData")(js.Any.fromFunction1((t0: /* code */ java.lang.String) => wrapData(t0).runNow()))
    if (wrapListeners != null) __obj.updateDynamic("wrapListeners")(js.Any.fromFunction1((t0: /* code */ java.lang.String) => wrapListeners(t0).runNow()))
