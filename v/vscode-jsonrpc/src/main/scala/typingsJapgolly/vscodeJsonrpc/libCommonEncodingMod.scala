...
object libCommonEncodingMod {
  ...
  object StreamContentDecoder {
    ...
    inline def apply(create: CallbackTo[WritableStream], name: String): StreamContentDecoder = {
      val __obj = js.Dynamic.literal(create = create.toJsFn, name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[StreamContentDecoder]
    }
    
    extension [Self <: StreamContentDecoder](x: Self) {
      
      inline def setCreate(value: CallbackTo[WritableStream]): Self = StObject.set(x, "create", value.toJsFn)
  ...
  object StreamContentEncoder {
    ...
    inline def apply(create: CallbackTo[WritableStream], name: String): StreamContentEncoder = {
      val __obj = js.Dynamic.literal(create = create.toJsFn, name = name.asInstanceOf[js.Any])
