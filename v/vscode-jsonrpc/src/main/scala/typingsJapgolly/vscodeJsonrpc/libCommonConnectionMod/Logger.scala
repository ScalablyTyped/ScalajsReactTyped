...
object Logger {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(error = js.Any.fromFunction1((t0: String) => error(t0).runNow()), info = js.Any.fromFunction1((t0: String) => info(t0).runNow()), log = js.Any.fromFunction1((t0: String) => log(t0).runNow()), warn = js.Any.fromFunction1((t0: String) => warn(t0).runNow()))
