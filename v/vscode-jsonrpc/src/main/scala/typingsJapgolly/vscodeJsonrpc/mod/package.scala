...
package object mod {
  ...
  type GenericRequestHandler[R, E] = js.Function1[/* repeated */ js.Any, typingsJapgolly.vscodeJsonrpc.mod.HandlerResult[R, E]]
  type HandlerResult[R, E] = R | typingsJapgolly.vscodeJsonrpc.messagesMod.ResponseError[E] | (typingsJapgolly.vscodeJsonrpc.Thenable[R | typingsJapgolly.vscodeJsonrpc.messagesMod.ResponseError[E]])
  type MessageQueue = typingsJapgolly.vscodeJsonrpc.linkedMapMod.LinkedMap[java.lang.String, typingsJapgolly.vscodeJsonrpc.messagesMod.Message]
  ...
  type RequestHandler[P, R, E] = js.Function2[
    ...
    typingsJapgolly.vscodeJsonrpc.mod.HandlerResult[R, E]
  ]
  ...
  type StarRequestHandler = js.Function2[
    ...
    /* repeated */ js.Any, 
    typingsJapgolly.vscodeJsonrpc.mod.HandlerResult[js.Any, js.Any]
  ]
}
