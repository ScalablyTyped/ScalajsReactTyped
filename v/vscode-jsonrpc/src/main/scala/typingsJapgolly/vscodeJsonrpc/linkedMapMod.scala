...
import typingsJapgolly.vscodeJsonrpc.vscodeJsonrpcNumbers.`0`
import typingsJapgolly.vscodeJsonrpc.vscodeJsonrpcNumbers.`1`
import typingsJapgolly.vscodeJsonrpc.vscodeJsonrpcNumbers.`2`
...
object linkedMapMod extends js.Object {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vscodeJsonrpc.vscodeJsonrpcNumbers.`0`
    - typingsJapgolly.vscodeJsonrpc.vscodeJsonrpcNumbers.`1`
    - typingsJapgolly.vscodeJsonrpc.vscodeJsonrpcNumbers.`2`
  */
