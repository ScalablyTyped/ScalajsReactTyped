...
import typingsJapgolly.vscodeJsonrpc.vscodeJsonrpcInts.`0`
import typingsJapgolly.vscodeJsonrpc.vscodeJsonrpcInts.`1`
import typingsJapgolly.vscodeJsonrpc.vscodeJsonrpcInts.`2`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libCommonLinkedMapMod {
  ...
  open class LinkedMap[K, V] ()
    ...
    val toStringTag_LinkedMap: typingsJapgolly.vscodeJsonrpc.vscodeJsonrpcStrings.LinkedMap = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vscodeJsonrpc.vscodeJsonrpcInts.`0`
    - typingsJapgolly.vscodeJsonrpc.vscodeJsonrpcInts.`1`
    - typingsJapgolly.vscodeJsonrpc.vscodeJsonrpcInts.`2`
  */
