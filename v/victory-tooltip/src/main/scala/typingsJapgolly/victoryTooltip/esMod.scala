package typingsJapgolly.victoryTooltip
...
object esMod {
  ...
  object VictoryTooltip {
    ...
    @JSImport("victory-tooltip/es", "VictoryTooltip.defaultEvents")
    @js.native
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify VictoryLabelableProps * / any */ trait VictoryTooltipProps extends StObject {
    ...
    var events: js.UndefOr[
        StringDictionary[js.Function1[/* event */ ReactEventFrom[Any & org.scalajs.dom.Element], Unit]]
      ] = js.undefined
    
    var flyoutComponent: js.UndefOr[Element] = js.undefined
  ...
  object VictoryTooltipProps {
    ...
    extension [Self <: VictoryTooltipProps](x: Self) {
      ...
      inline def setEvents(
        value: StringDictionary[js.Function1[/* event */ ReactEventFrom[Any & org.scalajs.dom.Element], Unit]]
      ): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
      
      inline def setEventsUndefined: Self = StObject.set(x, "events", js.undefined)
      
      inline def setFlyoutComponent(value: VdomElement): Self = StObject.set(x, "flyoutComponent", value.rawElement.asInstanceOf[js.Any])
