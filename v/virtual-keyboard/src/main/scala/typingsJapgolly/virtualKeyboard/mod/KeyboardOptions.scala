...
object KeyboardOptions {
  ...
  def apply(
    ...
    accepted: (/* event */ js.UndefOr[Event_ | String], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Callback = null,
    ...
    if (accepted != null) __obj.updateDynamic("accepted")(js.Any.fromFunction3((t0: /* event */ js.UndefOr[typingsJapgolly.std.Event_ | java.lang.String], t1: /* keyboard */ js.UndefOr[org.scalajs.dom.raw.Element], t2: /* el */ js.UndefOr[org.scalajs.dom.raw.Element]) => accepted(t0, t1, t2).runNow()))
