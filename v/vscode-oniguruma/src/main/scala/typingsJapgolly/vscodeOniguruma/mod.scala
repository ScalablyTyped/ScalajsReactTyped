package typingsJapgolly.vscodeOniguruma

import japgolly.scalajs.react.Callback
import org.scalajs.dom.Response
import typingsJapgolly.std.Record
import typingsJapgolly.std.WebAssembly.ImportValue
import typingsJapgolly.std.WebAssembly.WebAssemblyInstantiatedSource
import typingsJapgolly.vscodeOniguruma.vscodeOnigurumaInts.`0`
import typingsJapgolly.vscodeOniguruma.vscodeOnigurumaInts.`1`
import typingsJapgolly.vscodeOniguruma.vscodeOnigurumaInts.`2`
import typingsJapgolly.vscodeOniguruma.vscodeOnigurumaInts.`4`
import typingsJapgolly.vscodeOniguruma.vscodeOnigurumaInts.`8`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vscodeOniguruma.vscodeOnigurumaInts.`0`
    - typingsJapgolly.vscodeOniguruma.vscodeOnigurumaInts.`1`
    - typingsJapgolly.vscodeOniguruma.vscodeOnigurumaInts.`2`
    - typingsJapgolly.vscodeOniguruma.vscodeOnigurumaInts.`4`
    - typingsJapgolly.vscodeOniguruma.vscodeOnigurumaInts.`8`
  */
  ...
  object ICommonOptions {
    ...
    extension [Self <: ICommonOptions](x: Self) {
      ...
      inline def setPrint(value: /* str */ String => Callback): Self = StObject.set(x, "print", js.Any.fromFunction1((t0: /* str */ String) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vscodeOniguruma.mod.IInstantiatorOptions
    - typingsJapgolly.vscodeOniguruma.mod.IDataOptions
  */
  trait IOptions extends StObject
  object IOptions {
    
    inline def IDataOptions(data: js.typedarray.ArrayBuffer | Response): typingsJapgolly.vscodeOniguruma.mod.IDataOptions = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.vscodeOniguruma.mod.IDataOptions]
    }
    ...
    inline def IInstantiatorOptions(
      ...
      val __obj = js.Dynamic.literal(instantiator = js.Any.fromFunction1(instantiator))
      __obj.asInstanceOf[typingsJapgolly.vscodeOniguruma.mod.IInstantiatorOptions]
    }
  }
