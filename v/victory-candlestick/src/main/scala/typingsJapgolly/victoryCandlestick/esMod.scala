package typingsJapgolly.victoryCandlestick
...
object esMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify VictoryMultiLabelableProps * / any */ trait VictoryCandlestickProps extends StObject {
    ...
    var closeLabelComponent: js.UndefOr[Element] = js.undefined
    ...
    var highLabelComponenet: js.UndefOr[Element] = js.undefined
    ...
    var lowLabelComponent: js.UndefOr[Element] = js.undefined
    ...
    var openLabelComponent: js.UndefOr[Element] = js.undefined
  ...
  object VictoryCandlestickProps {
    ...
    extension [Self <: VictoryCandlestickProps](x: Self) {
      ...
      inline def setCloseLabelComponent(value: VdomElement): Self = StObject.set(x, "closeLabelComponent", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setHighLabelComponenet(value: VdomElement): Self = StObject.set(x, "highLabelComponenet", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setLowLabelComponent(value: VdomElement): Self = StObject.set(x, "lowLabelComponent", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOpenLabelComponent(value: VdomElement): Self = StObject.set(x, "openLabelComponent", value.rawElement.asInstanceOf[js.Any])
