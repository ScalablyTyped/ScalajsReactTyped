package typingsJapgolly.vanillaModal
...
object mod {
  ...
  object VanillaModalConfig {
    ...
    extension [Self <: VanillaModalConfig](x: Self) {
      ...
      inline def setOnBeforeClose(value: Callback): Self = StObject.set(x, "onBeforeClose", value.toJsFn)
      
      inline def setOnBeforeCloseUndefined: Self = StObject.set(x, "onBeforeClose", js.undefined)
      
      inline def setOnBeforeOpen(value: Callback): Self = StObject.set(x, "onBeforeOpen", value.toJsFn)
      ...
      inline def setTransitionEnd(value: Callback): Self = StObject.set(x, "transitionEnd", value.toJsFn)
