...
object libMinurlDotsharedMod {
  
  @JSImport("vfile/lib/minurl.shared", JSImport.Namespace)
  @js.native
  ...
  object URL {
    ...
    extension [Self <: URL](x: Self) {
      ...
      inline def setSearchParams(value: Any): Self = StObject.set(x, "searchParams", value.asInstanceOf[js.Any])
