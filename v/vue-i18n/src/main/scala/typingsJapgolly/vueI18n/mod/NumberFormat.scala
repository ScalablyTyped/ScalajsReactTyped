...
object NumberFormat {
  ...
  @js.native
  def props: typingsJapgolly.vueI18n.anon.I18n = js.native
  inline def props_=(x: typingsJapgolly.vueI18n.anon.I18n): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("props")(x.asInstanceOf[js.Any])
