...
object NavigationFailureType extends StObject {
  ...
  /* 4 */ val aborted: typingsJapgolly.vueRouter.mod.NavigationFailureType.aborted & Double = js.native
  ...
  sealed trait cancelled
    extends StObject
       with NavigationFailureType
  /* 8 */ val cancelled: typingsJapgolly.vueRouter.mod.NavigationFailureType.cancelled & Double = js.native
  ...
  sealed trait duplicated
    extends StObject
       with NavigationFailureType
  /* 16 */ val duplicated: typingsJapgolly.vueRouter.mod.NavigationFailureType.duplicated & Double = js.native
}
