...
import typingsJapgolly.vueRouter.anon.IsExactActive
import typingsJapgolly.vueRouter.anon.ReadonlyArrayRouteRecordR
import typingsJapgolly.vueRouter.mod.^
import typingsJapgolly.vueRouter.vueRouterBooleans.`false`
import typingsJapgolly.vueRouter.vueRouterInts.`2`
...
/* Rewritten from type alias, can be one of: 
  - java.lang.String
  - typingsJapgolly.vueRouter.mod.RouteLocationPathRaw
  - typingsJapgolly.vueRouter.mod.RouteLocationNamedRaw
*/
