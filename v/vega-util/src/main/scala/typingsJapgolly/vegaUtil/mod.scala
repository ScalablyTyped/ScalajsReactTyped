...
import typingsJapgolly.vegaUtil.vegaUtilBooleans.`false`
import typingsJapgolly.vegaUtil.vegaUtilBooleans.`true`
import typingsJapgolly.vegaUtil.vegaUtilInts.`0`
import typingsJapgolly.vegaUtil.vegaUtilInts.`1`
import typingsJapgolly.vegaUtil.vegaUtilStrings.DEBUG
import typingsJapgolly.vegaUtil.vegaUtilStrings.ERROR
import typingsJapgolly.vegaUtil.vegaUtilStrings.INFO
import typingsJapgolly.vegaUtil.vegaUtilStrings.WARN
import typingsJapgolly.vegaUtil.vegaUtilStrings.center
import typingsJapgolly.vegaUtil.vegaUtilStrings.error_
import typingsJapgolly.vegaUtil.vegaUtilStrings.left
import typingsJapgolly.vegaUtil.vegaUtilStrings.log
import typingsJapgolly.vegaUtil.vegaUtilStrings.right
import typingsJapgolly.vegaUtil.vegaUtilStrings.warn_
...
object mod {
  ...
  inline def log(
    method: error_ | warn_ | typingsJapgolly.vegaUtil.vegaUtilStrings.log,
  ...
  object FastMap_ {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(clean = clean.toJsFn, delete = js.Any.fromFunction1((t0: String) => delete(t0).runNow()), empty = empty.asInstanceOf[js.Any], get = js.Any.fromFunction1(get), has = js.Any.fromFunction1(has), set = js.Any.fromFunction2((t0: String, t1: Any) => (set(t0, t1)).runNow()), size = size.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.vegaUtil.vegaUtilStrings.ascending
    - typingsJapgolly.vegaUtil.vegaUtilStrings.descending
  */
  trait Order extends StObject
  object Order {
    
    inline def ascending: typingsJapgolly.vegaUtil.vegaUtilStrings.ascending = "ascending".asInstanceOf[typingsJapgolly.vegaUtil.vegaUtilStrings.ascending]
    
    inline def descending: typingsJapgolly.vegaUtil.vegaUtilStrings.descending = "descending".asInstanceOf[typingsJapgolly.vegaUtil.vegaUtilStrings.descending]
  }
}
