package typingsJapgolly.vfileMessage
...
object mod {
  ...
  open class VFileMessage protected ()
    ...
    def this(reason: String, place: typingsJapgolly.unist.mod.Node[Data]) = this()
    def this(reason: String, place: typingsJapgolly.unist.mod.Point) = this()
    def this(reason: String, place: typingsJapgolly.unist.mod.Position) = this()
    def this(reason: String, place: NodeLike) = this()
    def this(reason: js.Error, place: typingsJapgolly.unist.mod.Node[Data]) = this()
    def this(reason: js.Error, place: typingsJapgolly.unist.mod.Point) = this()
    def this(reason: js.Error, place: typingsJapgolly.unist.mod.Position) = this()
    def this(reason: js.Error, place: NodeLike) = this()
    def this(reason: String, place: Unit, origin: String) = this()
    def this(reason: String, place: typingsJapgolly.unist.mod.Node[Data], origin: String) = this()
    def this(reason: String, place: typingsJapgolly.unist.mod.Point, origin: String) = this()
    def this(reason: String, place: typingsJapgolly.unist.mod.Position, origin: String) = this()
    def this(reason: String, place: NodeLike, origin: String) = this()
    def this(reason: js.Error, place: Unit, origin: String) = this()
    def this(reason: js.Error, place: typingsJapgolly.unist.mod.Node[Data], origin: String) = this()
    def this(reason: js.Error, place: typingsJapgolly.unist.mod.Point, origin: String) = this()
    def this(reason: js.Error, place: typingsJapgolly.unist.mod.Position, origin: String) = this()
