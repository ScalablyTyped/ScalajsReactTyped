...
object esMod {
  ...
  @JSImport("victory-voronoi-container/es", JSImport.Namespace)
  @js.native
  ...
  object VoronoiHelpers {
    ...
    @JSImport("victory-voronoi-container/es", "VoronoiHelpers")
    @js.native
    val ^ : js.Any = js.native
  ...
  object VictoryVoronoiContainerProps {
    ...
    extension [Self <: VictoryVoronoiContainerProps](x: Self) {
      ...
      inline def setOnActivated(value: (/* points */ js.Array[Any], VictoryVoronoiContainerProps) => Callback): Self = StObject.set(x, "onActivated", js.Any.fromFunction2((t0: /* points */ js.Array[Any], t1: VictoryVoronoiContainerProps) => (value(t0, t1)).runNow()))
      
      inline def setOnActivatedUndefined: Self = StObject.set(x, "onActivated", js.undefined)
      
      inline def setOnDeactivated(value: (/* points */ js.Array[Any], VictoryVoronoiContainerProps) => Callback): Self = StObject.set(x, "onDeactivated", js.Any.fromFunction2((t0: /* points */ js.Array[Any], t1: VictoryVoronoiContainerProps) => (value(t0, t1)).runNow()))
      ...
      inline def setVoronoiDimension(value: typingsJapgolly.victoryVoronoiContainer.victoryVoronoiContainerStrings.x | y): Self = StObject.set(x, "voronoiDimension", value.asInstanceOf[js.Any])
