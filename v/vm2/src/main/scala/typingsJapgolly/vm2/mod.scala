...
import typingsJapgolly.vm2.anon.ColumnOffset
import typingsJapgolly.vm2.anon.Compiler
import typingsJapgolly.vm2.anon.Filename
import typingsJapgolly.vm2.anon.Modules
import typingsJapgolly.vm2.anon.`0`
import typingsJapgolly.vm2.vm2Strings.coffeescript
import typingsJapgolly.vm2.vm2Strings.commonjs
import typingsJapgolly.vm2.vm2Strings.host
import typingsJapgolly.vm2.vm2Strings.inherit
import typingsJapgolly.vm2.vm2Strings.javascript
import typingsJapgolly.vm2.vm2Strings.none
import typingsJapgolly.vm2.vm2Strings.off
import typingsJapgolly.vm2.vm2Strings.redirect
import typingsJapgolly.vm2.vm2Strings.sandbox
...
object mod {
  ...
  - typingsJapgolly.vm2.mod.VM because Inheritance from two classes. Inlined sandbox, timeout, run, run, run, run, run, run, runFile, setGlobals, setGlobal, getGlobal, freeze, freeze, readonly, protect, protect */ @JSImport("vm2", "NodeVM")
  @js.native
