...
object mod {
  ...
  object VideoJsCustomHotkey {
    ...
    inline def apply(
      handler: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify VideoJsPlayer */ Any, VideoJsHotkeysOptions, KeyboardEvent) => Callback,
      ...
      val __obj = js.Dynamic.literal(handler = js.Any.fromFunction3((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify VideoJsPlayer */ Any, t1: VideoJsHotkeysOptions, t2: KeyboardEvent) => (handler(t0, t1, t2)).runNow()), key = js.Any.fromFunction2(key))
    ...
    extension [Self <: VideoJsCustomHotkey](x: Self) {
      ...
      inline def setHandler(
        value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify VideoJsPlayer */ Any, VideoJsHotkeysOptions, KeyboardEvent) => Callback
      ): Self = StObject.set(x, "handler", js.Any.fromFunction3((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify VideoJsPlayer */ Any, t1: VideoJsHotkeysOptions, t2: KeyboardEvent) => (value(t0, t1, t2)).runNow()))
