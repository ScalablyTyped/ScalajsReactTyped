...
import typingsJapgolly.virtualScroll.anon.PartialOptions
...
object mod {
  ...
  object VirtualScroll {
    ...
    inline def apply(destroy: Callback, off: VirtualScrollCallback => Callback, on: VirtualScrollCallback => Callback): VirtualScroll = {
      val __obj = js.Dynamic.literal(destroy = destroy.toJsFn, off = js.Any.fromFunction1((t0: VirtualScrollCallback) => off(t0).runNow()), on = js.Any.fromFunction1((t0: VirtualScrollCallback) => on(t0).runNow()))
    ...
    extension [Self <: VirtualScroll](x: Self) {
      ...
      inline def setOff(value: VirtualScrollCallback => Callback): Self = StObject.set(x, "off", js.Any.fromFunction1((t0: VirtualScrollCallback) => value(t0).runNow()))
      
      inline def setOn(value: VirtualScrollCallback => Callback): Self = StObject.set(x, "on", js.Any.fromFunction1((t0: VirtualScrollCallback) => value(t0).runNow()))
    }
  }
