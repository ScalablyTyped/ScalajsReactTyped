package typingsJapgolly.reactNativeMaterialDesignSearchbar
...
object mod {
  ...
  object SearchBarProps {
    ...
    extension [Self <: SearchBarProps](x: Self) {
      ...
      inline def setOnBackPress(value: Callback): Self = StObject.set(x, "onBackPress", value.toJsFn)
      ...
      inline def setOnSearchChange(value: /* text */ String => Callback): Self = StObject.set(x, "onSearchChange", js.Any.fromFunction1((t0: /* text */ String) => value(t0).runNow()))
