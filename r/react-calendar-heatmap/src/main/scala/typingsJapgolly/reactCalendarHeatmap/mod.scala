...
object mod {
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setOnClick(value: /* value */ Any => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction1((t0: /* value */ Any) => value(t0).runNow()))
      
      inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
      
      inline def setOnMouseLeave(value: (/* e */ Any, /* value */ Any) => Callback): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction2((t0: /* e */ Any, t1: /* value */ Any) => (value(t0, t1)).runNow()))
      
      inline def setOnMouseLeaveUndefined: Self = StObject.set(x, "onMouseLeave", js.undefined)
      
      inline def setOnMouseOver(value: (/* e */ Any, /* value */ Any) => Callback): Self = StObject.set(x, "onMouseOver", js.Any.fromFunction2((t0: /* e */ Any, t1: /* value */ Any) => (value(t0, t1)).runNow()))
  ...
  type ReactCalendarHeatmap = japgolly.scalajs.react.facade.React.Component[Props & js.Object, js.Object]
}
