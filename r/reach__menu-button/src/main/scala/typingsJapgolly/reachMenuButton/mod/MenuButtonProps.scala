...
trait MenuButtonProps extends js.Object {
  ...
  var onClick: js.UndefOr[
    (js.Function1[/* e */ ReactMouseEventFrom[HTMLElement], Unit]) | MouseEventHandler[HTMLButtonElement]
  ] = js.native
  // Composition Events
  ...
  var onKeyDown: js.UndefOr[
    (js.Function1[/* e */ ReactKeyboardEventFrom[HTMLElement], Unit]) | KeyboardEventHandler[HTMLButtonElement]
  ] = js.native
