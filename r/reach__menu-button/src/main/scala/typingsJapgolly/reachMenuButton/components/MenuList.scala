...
object MenuList {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MenuListProps, LegacyRef[HTMLDivElement], Unit, MenuListProps] = {
  ...
  typingsJapgolly.reachMenuButton.mod.MenuListProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLDivElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reachMenuButton.mod.MenuListProps])(children: _*)
  }
