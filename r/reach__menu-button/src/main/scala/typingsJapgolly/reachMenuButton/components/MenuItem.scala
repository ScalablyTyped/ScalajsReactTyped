...
typingsJapgolly.reachMenuButton.mod.MenuItemProps & typingsJapgolly.reachPolymorphic.anon.As[typingsJapgolly.reachMenuButton.reachMenuButtonStrings.div]] because: IArray(Could't extract props from typingsJapgolly.std.Omit[
/ * import warning: importer.ImportType#apply Failed type conversion: IntrinsicElementString extends react.react.ElementType<any> ? react.react.ComponentPropsWithRef<IntrinsicElementString> : never * / js.Any, 
...
object MenuItem {
  ...
  implicit def make(companion: MenuItem.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
