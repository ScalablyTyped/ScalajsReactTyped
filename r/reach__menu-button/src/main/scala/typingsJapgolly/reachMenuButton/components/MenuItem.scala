...
import typingsJapgolly.reachMenuButton.mod.MenuItemProps
...
object MenuItem {
  def apply(
    ...
    onClick: /* e */ ReactMouseEventFrom[(HTMLDivElement | HTMLElement) with Element] => Callback = null,
    ...
    onKeyDown: /* e */ ReactKeyboardEventFrom[(HTMLDivElement | HTMLElement) with Element] => Callback = null,
    ...
    onMouseMove: /* e */ ReactMouseEventFrom[(HTMLDivElement | HTMLElement) with Element] => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MenuItemProps, LegacyRef[HTMLDivElement], Unit, MenuItemProps] = {
  ...
  (org.scalajs.dom.raw.HTMLDivElement | org.scalajs.dom.raw.HTMLElement) with org.scalajs.dom.raw.Element]) => onClick(t0).runNow()))
  ...
  (org.scalajs.dom.raw.HTMLDivElement | org.scalajs.dom.raw.HTMLElement) with org.scalajs.dom.raw.Element]) => onKeyDown(t0).runNow()))
    ...
    if (onMouseMove != null) __obj.updateDynamic("onMouseMove")(js.Any.fromFunction1((t0: /* e */ japgolly.scalajs.react.ReactMouseEventFrom[
  (org.scalajs.dom.raw.HTMLDivElement | org.scalajs.dom.raw.HTMLElement) with org.scalajs.dom.raw.Element]) => onMouseMove(t0).runNow()))
  ...
  typingsJapgolly.reachMenuButton.mod.MenuItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLDivElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reachMenuButton.mod.MenuItemProps])(children: _*)
  }
