...
import typingsJapgolly.reachMenuButton.mod.MenuButtonProps
...
object MenuButton {
  def apply(
    ...
    onClick: /* e */ ReactMouseEventFrom[(HTMLButtonElement | HTMLElement) with Element] => Callback = null,
    ...
    onKeyDown: /* e */ ReactKeyboardEventFrom[(HTMLButtonElement | HTMLElement) with Element] => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MenuButtonProps, LegacyRef[HTMLButtonElement], Unit, MenuButtonProps] = {
  ...
  (org.scalajs.dom.raw.HTMLButtonElement | org.scalajs.dom.raw.HTMLElement) with org.scalajs.dom.raw.Element]) => onClick(t0).runNow()))
  ...
  (org.scalajs.dom.raw.HTMLButtonElement | org.scalajs.dom.raw.HTMLElement) with org.scalajs.dom.raw.Element]) => onKeyDown(t0).runNow()))
  ...
  typingsJapgolly.reachMenuButton.mod.MenuButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLButtonElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reachMenuButton.mod.MenuButtonProps])(children: _*)
  }
