package typingsJapgolly.rtlcss

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.Shortcut
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.postcss.libProcessorMod.default
import typingsJapgolly.postcss.mod.PluginCreator
import typingsJapgolly.postcss.mod.Postcss
...
object mod extends Shortcut {
  ...
  object HookOptions {
    ...
    extension [Self <: HookOptions](x: Self) {
      ...
      inline def setPost(value: (/* root */ Root_, /* postcss */ Postcss) => Callback): Self = StObject.set(x, "post", js.Any.fromFunction2((t0: /* root */ Root_, t1: /* postcss */ Postcss) => (value(t0, t1)).runNow()))
      
      inline def setPostUndefined: Self = StObject.set(x, "post", js.undefined)
      
      inline def setPre(value: (/* root */ Root_, /* postcss */ Postcss) => Callback): Self = StObject.set(x, "pre", js.Any.fromFunction2((t0: /* root */ Root_, t1: /* postcss */ Postcss) => (value(t0, t1)).runNow()))
