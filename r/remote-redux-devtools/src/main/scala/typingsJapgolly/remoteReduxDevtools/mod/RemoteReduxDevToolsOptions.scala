...
import typingsJapgolly.remoteReduxDevtools.remoteReduxDevtoolsNumbers.`0`
import typingsJapgolly.remoteReduxDevtools.remoteReduxDevtoolsNumbers.`1`
import typingsJapgolly.remoteReduxDevtools.remoteReduxDevtoolsNumbers.`2`
...
object RemoteReduxDevToolsOptions {
  ...
  def apply(
    ...
    actionSanitizer: /* action */ js.Any => CallbackTo[js.Any] = null,
    ...
    stateSanitizer: /* state */ js.Any => CallbackTo[js.Any] = null,
    ...
    if (actionSanitizer != null) __obj.updateDynamic("actionSanitizer")(js.Any.fromFunction1((t0: /* action */ js.Any) => actionSanitizer(t0).runNow()))
    ...
    if (stateSanitizer != null) __obj.updateDynamic("stateSanitizer")(js.Any.fromFunction1((t0: /* state */ js.Any) => stateSanitizer(t0).runNow()))
