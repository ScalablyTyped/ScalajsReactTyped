...
import typingsJapgolly.reactNativeScrollableTabView.TabBarPropsScrollableTabB
...
object ScrollableTabBar {
  def apply(
    ...
    typingsJapgolly.reactNativeScrollableTabView.mod.ScrollableTabBar, 
    Unit, 
    TabBarPropsScrollableTabB
  ] = {
  ...
  typingsJapgolly.reactNativeScrollableTabView.TabBarPropsScrollableTabB, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeScrollableTabView.mod.ScrollableTabBar](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeScrollableTabView.TabBarPropsScrollableTabB])(children: _*)
  }
