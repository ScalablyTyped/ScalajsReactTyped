...
object anon {
  ...
  object ActiveTab {
    ...
    extension [Self <: ActiveTab](x: Self) {
      ...
      inline def setGoToPage(value: /* pageNumber */ Double => Callback): Self = StObject.set(x, "goToPage", js.Any.fromFunction1((t0: /* pageNumber */ Double) => value(t0).runNow()))
  ...
  object TabLabel {
    ...
    extension [Self <: TabLabel](x: Self) {
      ...
      inline def setTabLabelVdomElement(value: VdomElement): Self = StObject.set(x, "tabLabel", value.rawElement.asInstanceOf[js.Any])
    }
  }
}
