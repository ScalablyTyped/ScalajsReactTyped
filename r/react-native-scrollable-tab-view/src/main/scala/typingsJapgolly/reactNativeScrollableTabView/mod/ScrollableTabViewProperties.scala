...
trait ScrollableTabViewProperties extends Props[ScrollableTabView] {
  ...
  var renderTabBar: js.UndefOr[
    (js.Function1[/* props */ typingsJapgolly.reactNativeScrollableTabView.TabBarProps, Element]) | `false`
  ] = js.undefined
  /**
...
object ScrollableTabViewProperties {
  ...
  def apply(
    ...
    renderTabBar: (js.Function1[/* props */ typingsJapgolly.reactNativeScrollableTabView.TabBarProps, Element]) | `false` = null,
