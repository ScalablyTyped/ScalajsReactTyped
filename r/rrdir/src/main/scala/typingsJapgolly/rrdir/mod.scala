...
object mod extends Shortcut {
  ...
  @js.native
  val ^ : typingsJapgolly.rrdir.mod.rrdir = js.native
  ...
  type _To = typingsJapgolly.rrdir.mod.rrdir
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: typingsJapgolly.rrdir.mod.rrdir = ^
