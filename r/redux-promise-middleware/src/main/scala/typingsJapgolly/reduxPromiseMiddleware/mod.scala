package typingsJapgolly.reduxPromiseMiddleware
...
import typingsJapgolly.reduxPromiseMiddleware.anon.Data
import typingsJapgolly.reduxPromiseMiddleware.mod.ActionType.Fulfilled
import typingsJapgolly.reduxPromiseMiddleware.mod.ActionType.Pending
import typingsJapgolly.reduxPromiseMiddleware.mod.ActionType.Rejected
...
object mod {
  ...
  object ActionType extends StObject {
    ...
    sealed trait Fulfilled
      extends StObject
         with ActionType
    /* "FULFILLED" */ val Fulfilled: typingsJapgolly.reduxPromiseMiddleware.mod.ActionType.Fulfilled & String = js.native
    
    @js.native
    sealed trait Pending
      extends StObject
         with ActionType
    /* "PENDING" */ val Pending: typingsJapgolly.reduxPromiseMiddleware.mod.ActionType.Pending & String = js.native
    
    @js.native
    sealed trait Rejected
      extends StObject
         with ActionType
    /* "REJECTED" */ val Rejected: typingsJapgolly.reduxPromiseMiddleware.mod.ActionType.Rejected & String = js.native
  }
  ...
  object AsyncAction {
    ...
    extension [Self <: AsyncAction](x: Self) {
      ...
      inline def setPayloadCallbackTo(value: CallbackTo[js.Promise[Any]]): Self = StObject.set(x, "payload", value.toJsFn)
