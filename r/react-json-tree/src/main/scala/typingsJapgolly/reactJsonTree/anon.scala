...
object anon {
  ...
  trait GetItemString extends StObject {
    ...
    def getItemString(`type`: String, data: Any, itemType: Node, itemString: String): Element
  ...
  object GetItemString {
    ...
    inline def apply(
      ...
      getItemString: (String, Any, Node, String) => Element,
      hideRoot: Boolean,
      invertTheme: Boolean,
      isCustomNode: CallbackTo[Boolean],
      ...
      val __obj = js.Dynamic.literal(collectionLimit = collectionLimit.asInstanceOf[js.Any], getItemString = js.Any.fromFunction4(getItemString), hideRoot = hideRoot.asInstanceOf[js.Any], invertTheme = invertTheme.asInstanceOf[js.Any], isCustomNode = isCustomNode.toJsFn, keyPath = keyPath.asInstanceOf[js.Any], labelRenderer = js.Any.fromFunction1(labelRenderer), postprocessValue = js.Any.fromFunction1(postprocessValue), shouldExpandNode = js.Any.fromFunction3(shouldExpandNode), valueRenderer = js.Any.fromFunction1(valueRenderer))
    ...
    extension [Self <: GetItemString](x: Self) {
      ...
      inline def setGetItemString(value: (String, Any, Node, String) => Element): Self = StObject.set(x, "getItemString", js.Any.fromFunction4(value))
      ...
      inline def setIsCustomNode(value: CallbackTo[Boolean]): Self = StObject.set(x, "isCustomNode", value.toJsFn)
