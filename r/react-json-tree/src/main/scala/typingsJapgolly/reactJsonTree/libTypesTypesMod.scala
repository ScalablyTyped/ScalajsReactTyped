...
object libTypesTypesMod {
  ...
  object JSONNestedNodeCircularPropsPassedThroughJSONTree {
    ...
    extension [Self <: JSONNestedNodeCircularPropsPassedThroughJSONTree](x: Self) {
      ...
      inline def setGetItemString(value: (String, Any, Node, String, js.Array[String | Double]) => Node): Self = StObject.set(x, "getItemString", js.Any.fromFunction5(value))
  ...
  trait JSONValueNodeCircularPropsPassedThroughJSONTree extends StObject {
    ...
    def valueRenderer(valueAsString: Any, value: Any, keyPath: (String | Double)*): Node
  }
  object JSONValueNodeCircularPropsPassedThroughJSONTree {
    
    inline def apply(valueRenderer: (Any, Any, /* repeated */ String | Double) => Node): JSONValueNodeCircularPropsPassedThroughJSONTree = {
    ...
    extension [Self <: JSONValueNodeCircularPropsPassedThroughJSONTree](x: Self) {
      ...
      inline def setValueRenderer(value: (Any, Any, /* repeated */ String | Double) => Node): Self = StObject.set(x, "valueRenderer", js.Any.fromFunction3(value))
    }
  }
  ...
  trait SharedCircularPropsPassedThroughJSONTree extends StObject {
    ...
    def labelRenderer(keyPath: js.Array[String | Double], nodeType: String, expanded: Boolean, expandable: Boolean): Node
  }
  object SharedCircularPropsPassedThroughJSONTree {
    ...
    extension [Self <: SharedCircularPropsPassedThroughJSONTree](x: Self) {
      ...
      inline def setLabelRenderer(value: (js.Array[String | Double], String, Boolean, Boolean) => Node): Self = StObject.set(x, "labelRenderer", js.Any.fromFunction4(value))
    }
  }
