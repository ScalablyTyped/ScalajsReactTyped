...
import typingsJapgolly.reactJsonTree.anon.From
import typingsJapgolly.reactJsonTree.libTypesTypesMod.CircularPropsPassedThroughItemRange
...
object libTypesItemRangeMod {
  ...
  trait Props
    ...
    def renderChildNodes(props: Props, from: Double, to: Double): Node
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setRenderChildNodes(value: (Props, Double, Double) => Node): Self = StObject.set(x, "renderChildNodes", js.Any.fromFunction3(value))
