  ...
  object ReactImgpro {
    ...
    */
    ...
    object Mode {
      ...
      inline def bezier: typingsJapgolly.reactImgpro.reactImgproStrings.bezier = "bezier".asInstanceOf[typingsJapgolly.reactImgpro.reactImgproStrings.bezier]
      
      inline def bicubic: typingsJapgolly.reactImgpro.reactImgproStrings.bicubic = "bicubic".asInstanceOf[typingsJapgolly.reactImgpro.reactImgproStrings.bicubic]
      
      inline def bilinear: typingsJapgolly.reactImgpro.reactImgproStrings.bilinear = "bilinear".asInstanceOf[typingsJapgolly.reactImgpro.reactImgproStrings.bilinear]
      
      inline def hermite: typingsJapgolly.reactImgpro.reactImgproStrings.hermite = "hermite".asInstanceOf[typingsJapgolly.reactImgpro.reactImgproStrings.hermite]
      
      inline def neighbor: typingsJapgolly.reactImgpro.reactImgproStrings.neighbor = "neighbor".asInstanceOf[typingsJapgolly.reactImgpro.reactImgproStrings.neighbor]
    }
    
    type ProcessImage = japgolly.scalajs.react.facade.React.Component[ProcessImageProps & js.Object, js.Object]
    ...
    object ProcessImageProps {
      ...
      inline def apply(image: String, onProcessFinish: Callback): ProcessImageProps = {
        val __obj = js.Dynamic.literal(image = image.asInstanceOf[js.Any], onProcessFinish = onProcessFinish.toJsFn)
      ...
      extension [Self <: ProcessImageProps](x: Self) {
        ...
        inline def setOnProcessFinish(value: Callback): Self = StObject.set(x, "onProcessFinish", value.toJsFn)
