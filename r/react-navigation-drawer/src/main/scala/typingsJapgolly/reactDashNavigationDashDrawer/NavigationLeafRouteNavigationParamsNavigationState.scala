...
trait NavigationLeafRouteNavigationParamsNavigationState extends js.Object {
  /**
...
object NavigationLeafRouteNavigationParamsNavigationState {
  @scala.inline
  def apply(
    index: Double,
    ...
    path: String = null
  ): NavigationLeafRouteNavigationParamsNavigationState = {
    ...
    __obj.asInstanceOf[NavigationLeafRouteNavigationParamsNavigationState]
  }
}
