...
object DrawerItems {
  ...
  inline def apply(
    ...
    screenProps: Any
  ): SharedBuilder_DrawerNavigatorItemsProps2141653061[typingsJapgolly.reactNavigationDrawer.mod.DrawerItems] = {
    ...
    new SharedBuilder_DrawerNavigatorItemsProps2141653061[typingsJapgolly.reactNavigationDrawer.mod.DrawerItems](js.Array(this.component, __props.asInstanceOf[DrawerNavigatorItemsProps]))
  }
  ...
  def withProps(p: DrawerNavigatorItemsProps): SharedBuilder_DrawerNavigatorItemsProps2141653061[typingsJapgolly.reactNavigationDrawer.mod.DrawerItems] = new SharedBuilder_DrawerNavigatorItemsProps2141653061[typingsJapgolly.reactNavigationDrawer.mod.DrawerItems](js.Array(this.component, p.asInstanceOf[js.Any]))
}
