...
import typingsJapgolly.reactNavigationDrawer.libTypescriptSrcTypesMod.DrawerItem
...
object ActiveItemKey {
  ...
  extension [Self <: ActiveItemKey](x: Self) {
    ...
    inline def setOnItemPress(value: /* info */ DrawerItem => Callback): Self = StObject.set(x, "onItemPress", js.Any.fromFunction1((t0: /* info */ DrawerItem) => value(t0).runNow()))
