...
import typingsJapgolly.reactTextareaAutosize.anon.Height
...
import typingsJapgolly.reactTextareaAutosize.reactTextareaAutosizeStrings.maxHeight
import typingsJapgolly.reactTextareaAutosize.reactTextareaAutosizeStrings.menu
import typingsJapgolly.reactTextareaAutosize.reactTextareaAutosizeStrings.minHeight
...
object distDeclarationsSrcMod extends Shortcut {
  ...
  type Style = (Omit[NonNullable[js.UndefOr[CSSProperties]], maxHeight | minHeight]) & Height
  
  /* Inlined parent std.Omit<react-textarea-autosize.react-textarea-autosize/dist/declarations/src.TextareaProps, 'style'> */
  trait TextareaAutosizeProps extends StObject {
    ...
    var cacheMeasurements: js.UndefOr[Boolean] = js.undefined
    ...
    var onHeightChange: js.UndefOr[js.Function2[/* height */ Double, /* meta */ TextareaHeightChangeMeta, Unit]] = js.undefined
  ...
  object TextareaAutosizeProps {
    ...
    extension [Self <: TextareaAutosizeProps](x: Self) {
      ...
      inline def setCacheMeasurements(value: Boolean): Self = StObject.set(x, "cacheMeasurements", value.asInstanceOf[js.Any])
      
      inline def setCacheMeasurementsUndefined: Self = StObject.set(x, "cacheMeasurements", js.undefined)
      ...
      inline def setOnHeightChange(value: (/* height */ Double, /* meta */ TextareaHeightChangeMeta) => Callback): Self = StObject.set(x, "onHeightChange", js.Any.fromFunction2((t0: /* height */ Double, t1: /* meta */ TextareaHeightChangeMeta) => (value(t0, t1)).runNow()))
  ...
  trait TextareaHeightChangeMeta extends StObject {
    
    var rowHeight: Double
  }
  object TextareaHeightChangeMeta {
    
    inline def apply(rowHeight: Double): TextareaHeightChangeMeta = {
  ...
  /* This means you don't have to write `default`, but can instead just say `distDeclarationsSrcMod.foo` */
