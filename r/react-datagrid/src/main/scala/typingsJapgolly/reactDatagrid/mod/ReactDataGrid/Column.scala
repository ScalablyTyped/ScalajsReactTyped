...
object Column {
  ...
  def apply(
    ...
    render: (/* value */ js.Any, /* data */ js.Any, /* cellProps */ CellProps) => CallbackTo[js.Any] = null,
    ...
    if (render != null) __obj.updateDynamic("render")(js.Any.fromFunction3((t0: /* value */ js.Any, t1: /* data */ js.Any, t2: /* cellProps */ typingsJapgolly.reactDatagrid.mod.ReactDataGrid.CellProps) => render(t0, t1, t2).runNow()))
