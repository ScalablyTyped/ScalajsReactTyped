...
trait Reconciler[Instance, TextInstance, Container, PublicInstance] extends js.Object {
  ...
  def getPublicRootInstance(container: OpaqueRoot): (Component[js.Object, js.Object]) | PublicInstance | Null = js.native
  ...
  def updateContainer(
    element: ReactNodeList,
    container: OpaqueRoot,
    parentComponent: typingsJapgolly.react.mod.Component[_, _, _],
    callback: js.Function0[js.UndefOr[Unit | Null]]
  ): ExpirationTime = js.native
