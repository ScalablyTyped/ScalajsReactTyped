...
trait FnCallThisV2V3V4V5V6Project extends StObject {
  ...
  def apply[T, R](array: js.Array[ObservableInput[T]]): Observable_[js.Array[T]] = js.native
  def apply[T, R](observables: (ObservableInput[T] | (js.Function1[/* repeated */ T, R]))*): Observable_[R] = js.native
