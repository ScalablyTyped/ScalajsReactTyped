...
object observableForkJoinObservableMod {
  ...
  object ForkJoinObservable {
    ...
    inline def create[R](sources: SubscribableOrPromise[Any]*): Observable_[R] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(sources.asInstanceOf[Seq[js.Any]]*).asInstanceOf[Observable_[R]]
    inline def create[R](sources: js.Array[SubscribableOrPromise[Any]]): Observable_[R] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(sources.asInstanceOf[js.Any]).asInstanceOf[Observable_[R]]
    ...
    inline def create_T[T](sources: SubscribableOrPromise[T]*): Observable_[js.Array[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(sources.asInstanceOf[Seq[js.Any]]*).asInstanceOf[Observable_[js.Array[T]]]
    inline def create_T[T](sources: js.Array[SubscribableOrPromise[T]]): Observable_[js.Array[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(sources.asInstanceOf[js.Any]).asInstanceOf[Observable_[js.Array[T]]]
