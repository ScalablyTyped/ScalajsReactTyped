...
object observableBoundCallbackObservableMod {
  ...
  /**
    ...
    */
  open class BoundCallbackObservable[T] () extends Observable_[T] {
  ...
  object BoundCallbackObservable {
    ...
    inline def create(callbackFunc: js.Function1[/* callback */ js.Function0[Any], Any]): js.Function0[Observable_[Unit]] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(callbackFunc.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Observable_[Unit]]]
    inline def create(callbackFunc: js.Function1[/* callback */ js.Function0[Any], Any], selector: Unit): js.Function0[Observable_[Unit]] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(callbackFunc.asInstanceOf[js.Any], selector.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Observable_[Unit]]]
    inline def create(
      callbackFunc: js.Function1[/* callback */ js.Function0[Any], Any],
      selector: Unit,
      scheduler: SchedulerLike
    ): js.Function0[Observable_[Unit]] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(callbackFunc.asInstanceOf[js.Any], selector.asInstanceOf[js.Any], scheduler.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Observable_[Unit]]]
    ...
    inline def create[T, R](callbackFunc: js.Function2[/* v1 */ T, /* callback */ js.Function1[/* result */ R, Any], Any]): js.Function1[/* v1 */ T, Observable_[R]] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(callbackFunc.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* v1 */ T, Observable_[R]]]
    ...
    inline def create_R[R](callbackFunc: js.Function1[/* callback */ js.Function1[/* result */ R, Any], Any]): js.Function0[Observable_[R]] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(callbackFunc.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Observable_[R]]]
    inline def create_R[R](callbackFunc: js.Function1[/* callback */ js.Function1[/* result */ R, Any], Any], selector: Unit): js.Function0[Observable_[R]] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(callbackFunc.asInstanceOf[js.Any], selector.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Observable_[R]]]
