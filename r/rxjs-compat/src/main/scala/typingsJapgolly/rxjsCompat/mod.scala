...
object mod {
  ...
  open class AsyncSubject[T] ()
    extends typingsJapgolly.rxjs.mod.AsyncSubject[T]
  ...
  open class ConnectableObservable[T] protected ()
    extends typingsJapgolly.rxjs.mod.ConnectableObservable[T] {
    /**
  ...
  open class ReplaySubject[T] ()
    extends typingsJapgolly.rxjs.mod.ReplaySubject[T] {
  ...
  open class Subject[T] ()
    extends typingsJapgolly.rxjs.mod.Subject[T]
  /* static members */
  object Subject {
  ...
  open class Subscriber[T] ()
    extends typingsJapgolly.rxjs.mod.Subscriber[T] {
  ...
  open class VirtualTimeScheduler ()
    extends typingsJapgolly.rxjs.mod.VirtualTimeScheduler {
