...
import typingsJapgolly.rxjs.anon.FnCall
import typingsJapgolly.rxjs.anon.With
import typingsJapgolly.rxjs.distTypesInternalAjaxAjaxMod.AjaxCreationMethod
import typingsJapgolly.rxjs.distTypesInternalAjaxErrorsMod.AjaxErrorCtor
import typingsJapgolly.rxjs.distTypesInternalAjaxErrorsMod.AjaxTimeoutErrorCtor
import typingsJapgolly.rxjs.distTypesInternalAjaxTypesMod.AjaxConfig
import typingsJapgolly.rxjs.distTypesInternalAjaxTypesMod.AjaxRequest
import typingsJapgolly.rxjs.distTypesInternalAjaxTypesMod.AjaxResponseType
...
import typingsJapgolly.rxjs.distTypesInternalTypesMod.Cons
...
import typingsJapgolly.rxjs.distTypesInternalUtilArgumentOutOfRangeErrorMod.ArgumentOutOfRangeErrorCtor
import typingsJapgolly.rxjs.distTypesInternalUtilEmptyErrorMod.EmptyErrorCtor
import typingsJapgolly.rxjs.distTypesInternalUtilObjectUnsubscribedErrorMod.ObjectUnsubscribedErrorCtor
import typingsJapgolly.rxjs.distTypesInternalUtilUnsubscriptionErrorMod.UnsubscriptionErrorCtor
import typingsJapgolly.rxjsCompat.anon.TypeofTestScheduler
import typingsJapgolly.rxjsCompat.anon.TypeofcombineAll
import typingsJapgolly.rxjsCompat.anon.Typeofexhaust
import typingsJapgolly.rxjsCompat.anon.TypeofflatMap
import typingsJapgolly.rxjsCompat.rxjsCompatBooleans.`false`
import typingsJapgolly.rxjsCompat.rxjsCompatBooleans.`true`
...
object umdMod {
  ...
  open class AjaxErrorCls protected ()
    extends StObject
       with typingsJapgolly.rxjs.distTypesInternalAjaxErrorsMod.AjaxError {
    /**
  ...
  open class AjaxResponse[T] protected ()
    extends typingsJapgolly.rxjsCompat.mod.AjaxResponse[T] {
    /**
  ...
  open class AsyncSubject[T] ()
    extends typingsJapgolly.rxjsCompat.mod.AsyncSubject[T]
  
  @JSImport("rxjs-compat/umd", "BehaviorSubject")
  @js.native
  open class BehaviorSubject[T] protected ()
    extends typingsJapgolly.rxjsCompat.mod.BehaviorSubject[T] {
  ...
  open class ConnectableObservable[T] protected ()
    extends typingsJapgolly.rxjsCompat.mod.ConnectableObservable[T] {
    /**
      ...
      */
    def this(
      source: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T],
      subjectFactory: js.Function0[typingsJapgolly.rxjs.distTypesInternalSubjectMod.Subject[T]]
    ) = this()
  }
  ...
  open class Notification[T] protected ()
    extends typingsJapgolly.rxjsCompat.mod.Notification[T] {
    /**
  ...
  open class Observable[T] ()
    extends typingsJapgolly.rxjsCompat.mod.Observable[T] {
    def this(subscribe: js.ThisFunction1[
            /* this */ typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T], 
            /* subscriber */ typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T], 
            TeardownLogic
          ]) = this()
  }
  /* static members */
  ...
  open class ReplaySubject[T] ()
    extends typingsJapgolly.rxjsCompat.mod.ReplaySubject[T] {
  ...
  open class Subject[T] ()
    extends typingsJapgolly.rxjsCompat.mod.Subject[T]
  /* static members */
  object Subject {
  ...
  open class Subscriber[T] ()
    extends typingsJapgolly.rxjsCompat.mod.Subscriber[T] {
    def this(destination: typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[Any]) = this()
  ...
  object Subscriber {
    ...
    /**
      ...
      */
    inline def create[T](): typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T]]
    inline def create[T](next: js.Function1[/* x */ js.UndefOr[T], Unit]): typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(next.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T]]
    inline def create[T](
      next: js.Function1[/* x */ js.UndefOr[T], Unit],
      error: js.Function1[/* e */ js.UndefOr[Any], Unit]
    ): typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(next.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T]]
    inline def create[T](
      next: js.Function1[/* x */ js.UndefOr[T], Unit],
      error: js.Function1[/* e */ js.UndefOr[Any], Unit],
      complete: js.Function0[Unit]
    ): typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(next.asInstanceOf[js.Any], error.asInstanceOf[js.Any], complete.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T]]
    inline def create[T](next: js.Function1[/* x */ js.UndefOr[T], Unit], error: Unit, complete: js.Function0[Unit]): typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(next.asInstanceOf[js.Any], error.asInstanceOf[js.Any], complete.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T]]
    inline def create[T](next: Unit, error: js.Function1[/* e */ js.UndefOr[Any], Unit]): typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(next.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T]]
    inline def create[T](next: Unit, error: js.Function1[/* e */ js.UndefOr[Any], Unit], complete: js.Function0[Unit]): typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(next.asInstanceOf[js.Any], error.asInstanceOf[js.Any], complete.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T]]
    inline def create[T](next: Unit, error: Unit, complete: js.Function0[Unit]): typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(next.asInstanceOf[js.Any], error.asInstanceOf[js.Any], complete.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T]]
  }
  ...
  open class Subscription ()
    extends typingsJapgolly.rxjsCompat.mod.Subscription {
  ...
  open class TestScheduler protected ()
    extends typingsJapgolly.rxjsCompat.mod.TestScheduler {
    /**
      *
  ...
  open class UnsubscriptionErrorCls protected ()
    extends StObject
       with typingsJapgolly.rxjs.distTypesInternalUtilUnsubscriptionErrorMod.UnsubscriptionError {
    /**
      * @deprecated Internal implementation detail. Do not construct error instances.
      * Cannot be tagged as internal: https://github.com/ReactiveX/rxjs/issues/6269
      */
  ...
  open class VirtualTimeScheduler ()
    extends typingsJapgolly.rxjsCompat.mod.VirtualTimeScheduler {
  ...
  object ajax {
    ...
    def AjaxResponse: Instantiable3[
        ...
        /* xhr */ XMLHttpRequest, 
        /* request */ AjaxRequest, 
        typingsJapgolly.rxjs.ajaxMod.AjaxResponse[js.Object]
      ] = js.native
    ...
    open class AjaxResponseCls[T] protected ()
      extends typingsJapgolly.rxjs.ajaxMod.AjaxResponse[T] {
      /**
        * A normalized response from an AJAX request. To get the data from the response,
        * you will want to read the `response` property.
        *
    ...
    /**
      ...
      * ```
      */
    inline def ajax[T](config: AjaxConfig): typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[typingsJapgolly.rxjs.distTypesInternalAjaxAjaxResponseMod.AjaxResponse[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("ajax")(config.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[typingsJapgolly.rxjs.distTypesInternalAjaxAjaxResponseMod.AjaxResponse[T]]]
    /**
      ...
      * ```
      */
    inline def ajax[T](url: String): typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[typingsJapgolly.rxjs.distTypesInternalAjaxAjaxResponseMod.AjaxResponse[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("ajax")(url.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[typingsJapgolly.rxjs.distTypesInternalAjaxAjaxResponseMod.AjaxResponse[T]]]
  }
  ...
  object operators {
    ...
    inline def buffer[T](closingNotifier: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]): OperatorFunction[T, js.Array[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("buffer")(closingNotifier.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[T, js.Array[T]]]
    ...
    inline def catchError[T, O /* <: ObservableInput[Any] */](
      selector: js.Function2[
          /* err */ Any, 
          /* caught */ typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T], 
          O
        ]
    ...
    inline def concatMapTo(observable: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]): OperatorFunction[
        Any, 
        ObservedValueOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]]
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("concatMapTo")(observable.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[
        Any, 
        ObservedValueOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]]
      ]]
    inline def concatMapTo(
      observable: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any],
      resultSelector: Unit
    ): OperatorFunction[
        Any, 
        ObservedValueOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]]
      ] = (^.asInstanceOf[js.Dynamic].applyDynamic("concatMapTo")(observable.asInstanceOf[js.Any], resultSelector.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[
        Any, 
        ObservedValueOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]]
      ]]
    ...
    inline def concatMapTo[T, R](
      ...
      resultSelector: js.Function4[
          /* outerValue */ T, 
          /* innerValue */ ObservedValueOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]], 
          /* outerIndex */ Double, 
          /* innerIndex */ Double, 
          R
        ]
    ...
    inline def connect[T, O /* <: ObservableInput[Any] */](
      selector: js.Function1[/* shared */ typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T], O]
    ): OperatorFunction[T, ObservedValueOf[O]] = ^.asInstanceOf[js.Dynamic].applyDynamic("connect")(selector.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[T, ObservedValueOf[O]]]
    inline def connect[T, O /* <: ObservableInput[Any] */](
      selector: js.Function1[/* shared */ typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T], O],
    ...
    inline def delayWhen[T](
      ...
      subscriptionDelay: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]
    ...
    inline def distinct[T, K](
      ...
      flushes: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]
    ...
    inline def distinct[T, K](keySelector: Unit, flushes: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]): MonoTypeOperatorFunction[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("distinct")(keySelector.asInstanceOf[js.Any], flushes.asInstanceOf[js.Any])).asInstanceOf[MonoTypeOperatorFunction[T]]
    ...
    inline def groupBy[T, K, R](
      ...
      connector: js.Function0[typingsJapgolly.rxjs.distTypesInternalSubjectMod.Subject[R]]
    ...
    inline def materialize[T](): OperatorFunction[
        T, 
        typingsJapgolly.rxjs.distTypesInternalNotificationMod.Notification[T] & ObservableNotification[T]
    ...
    inline def mergeMapTo(innerObservable: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]): OperatorFunction[
        Any, 
        ObservedValueOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]]
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("mergeMapTo")(innerObservable.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[
        Any, 
        ObservedValueOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]]
      ]]
    inline def mergeMapTo(
      innerObservable: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any],
      concurrent: Double
    ): OperatorFunction[
        Any, 
        ObservedValueOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]]
      ] = (^.asInstanceOf[js.Dynamic].applyDynamic("mergeMapTo")(innerObservable.asInstanceOf[js.Any], concurrent.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[
        Any, 
        ObservedValueOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]]
      ]]
    ...
    inline def multicast[T](subjectFactory: js.Function0[typingsJapgolly.rxjs.distTypesInternalSubjectMod.Subject[T]]): UnaryFunction[
        typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T], 
        typingsJapgolly.rxjs.distTypesInternalObservableConnectableObservableMod.ConnectableObservable[T]
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("multicast")(subjectFactory.asInstanceOf[js.Any]).asInstanceOf[UnaryFunction[
        typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T], 
        typingsJapgolly.rxjs.distTypesInternalObservableConnectableObservableMod.ConnectableObservable[T]
      ]]
    inline def multicast[T](subject: typingsJapgolly.rxjs.distTypesInternalSubjectMod.Subject[T]): UnaryFunction[
        typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T], 
        typingsJapgolly.rxjs.distTypesInternalObservableConnectableObservableMod.ConnectableObservable[T]
    ...
    inline def multicast[T, O /* <: ObservableInput[Any] */](
      subject: typingsJapgolly.rxjs.distTypesInternalSubjectMod.Subject[T],
      selector: js.Function1[/* shared */ typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T], O]
    ...
    inline def publish[T, O /* <: ObservableInput[Any] */](
      selector: js.Function1[/* shared */ typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T], O]
    ): OperatorFunction[T, ObservedValueOf[O]] = ^.asInstanceOf[js.Dynamic].applyDynamic("publish")(selector.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[T, ObservedValueOf[O]]]
    ...
    inline def repeatWhen[T](
      notifier: js.Function1[
          /* notifications */ typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Unit], 
          typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]
        ]
    ...
    inline def retryWhen[T](
      notifier: js.Function1[
          /* errors */ typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any], 
          typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]
        ]
    ...
    inline def sample[T](notifier: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]): MonoTypeOperatorFunction[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("sample")(notifier.asInstanceOf[js.Any]).asInstanceOf[MonoTypeOperatorFunction[T]]
    ...
    inline def sequenceEqual[T](compareTo: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]): OperatorFunction[T, Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("sequenceEqual")(compareTo.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[T, Boolean]]
    inline def sequenceEqual[T](
      compareTo: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T],
    ...
    inline def skipUntil[T](notifier: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]): MonoTypeOperatorFunction[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("skipUntil")(notifier.asInstanceOf[js.Any]).asInstanceOf[MonoTypeOperatorFunction[T]]
    ...
    inline def switchMapTo(observable: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]): OperatorFunction[
        Any, 
        ObservedValueOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]]
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("switchMapTo")(observable.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[
        Any, 
        ObservedValueOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]]
      ]]
    inline def switchMapTo(
      observable: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any],
      resultSelector: Unit
    ): OperatorFunction[
        Any, 
        ObservedValueOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]]
      ] = (^.asInstanceOf[js.Dynamic].applyDynamic("switchMapTo")(observable.asInstanceOf[js.Any], resultSelector.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[
        Any, 
        ObservedValueOf[typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]]
      ]]
    ...
    inline def window[T](windowBoundaries: typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[Any]): OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("window")(windowBoundaries.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]]]
    
    inline def windowCount[T](windowSize: Double): OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("windowCount")(windowSize.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]]]
    inline def windowCount[T](windowSize: Double, startWindowEvery: Double): OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("windowCount")(windowSize.asInstanceOf[js.Any], startWindowEvery.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]]]
    
    inline def windowTime[T](windowTimeSpan: Double): OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("windowTime")(windowTimeSpan.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]]]
    inline def windowTime[T](windowTimeSpan: Double, scheduler: SchedulerLike): OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("windowTime")(windowTimeSpan.asInstanceOf[js.Any], scheduler.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]]]
    inline def windowTime[T](windowTimeSpan: Double, windowCreationInterval: Double): OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("windowTime")(windowTimeSpan.asInstanceOf[js.Any], windowCreationInterval.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]]]
    inline def windowTime[T](windowTimeSpan: Double, windowCreationInterval: Double, maxWindowSize: Double): OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("windowTime")(windowTimeSpan.asInstanceOf[js.Any], windowCreationInterval.asInstanceOf[js.Any], maxWindowSize.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]]]
    inline def windowTime[T](
      windowTimeSpan: Double,
      windowCreationInterval: Double,
      maxWindowSize: Double,
      scheduler: SchedulerLike
    ): OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("windowTime")(windowTimeSpan.asInstanceOf[js.Any], windowCreationInterval.asInstanceOf[js.Any], maxWindowSize.asInstanceOf[js.Any], scheduler.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]]]
    inline def windowTime[T](windowTimeSpan: Double, windowCreationInterval: Double, scheduler: SchedulerLike): OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("windowTime")(windowTimeSpan.asInstanceOf[js.Any], windowCreationInterval.asInstanceOf[js.Any], scheduler.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]]]
    inline def windowTime[T](windowTimeSpan: Double, windowCreationInterval: Null, maxWindowSize: Double): OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("windowTime")(windowTimeSpan.asInstanceOf[js.Any], windowCreationInterval.asInstanceOf[js.Any], maxWindowSize.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]]]
    inline def windowTime[T](
      windowTimeSpan: Double,
    ...
    inline def windowTime[T](windowTimeSpan: Double, windowCreationInterval: Unit, maxWindowSize: Double): OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("windowTime")(windowTimeSpan.asInstanceOf[js.Any], windowCreationInterval.asInstanceOf[js.Any], maxWindowSize.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]]]
    inline def windowTime[T](
      windowTimeSpan: Double,
    ...
    ): OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("windowToggle")(openings.asInstanceOf[js.Any], closingSelector.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]]]
    
    inline def windowWhen[T](closingSelector: js.Function0[ObservableInput[Any]]): OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("windowWhen")(closingSelector.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[T, typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable[T]]]
  ...
  object testing {
    ...
    open class TestSchedulerCls protected ()
      extends typingsJapgolly.rxjs.testingMod.TestScheduler {
      /**
        *
        * @param assertDeepEqual A function to set up your assertion for your test harness
        */
  ...
  object webSocket {
    ...
    open class WebSocketSubject[T] protected ()
      extends typingsJapgolly.rxjs.webSocketMod.WebSocketSubject[T] {
    ...
    def WebSocketSubject: Instantiable1[
        ...
        typingsJapgolly.rxjs.webSocketMod.WebSocketSubject[js.Object]
      ] = js.native
