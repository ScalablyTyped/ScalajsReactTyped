...
/* Inlined std.Readonly<std.Omit<@react-md/menu.@react-md/menu/types/types.MenuWidgetProps, 'id' | 'children'>> */
trait ReadonlyOmitMenuWidgetPro extends StObject {
  ...
  val `aria-orientation`: js.UndefOr[typingsJapgolly.reactMdMenu.reactMdMenuStrings.horizontal | vertical] = js.undefined
  ...
  val disableElevation: js.UndefOr[Boolean] = js.undefined
  
  val draggable: js.UndefOr[Booleanish] = js.undefined
  
  val getDefaultFocusIndex: js.UndefOr[
    js.Function2[/* elements */ js.Array[HTMLElement], /* container */ HTMLDivElement, Double]
  ] = js.undefined
  ...
  val onDecrement: js.UndefOr[KeyboardFocusHandler[HTMLDivElement]] = js.undefined
  ...
  val onFocusChange: js.UndefOr[js.Function2[/* element */ HTMLElement, /* nextFocusIndex */ Double, Unit]] = js.undefined
  
  val onIncrement: js.UndefOr[KeyboardFocusHandler[HTMLDivElement]] = js.undefined
  ...
  val onJumpToFirst: js.UndefOr[KeyboardFocusHandler[HTMLDivElement]] = js.undefined
  
  val onJumpToLast: js.UndefOr[KeyboardFocusHandler[HTMLDivElement]] = js.undefined
  ...
  val onSearch: js.UndefOr[KeyboardFocusHandler[HTMLDivElement]] = js.undefined
...
object ReadonlyOmitMenuWidgetPro {
  
  inline def apply(): ReadonlyOmitMenuWidgetPro = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReadonlyOmitMenuWidgetPro]
  }
  
  extension [Self <: ReadonlyOmitMenuWidgetPro](x: Self) {
    ...
    inline def setGetDefaultFocusIndex(value: (/* elements */ js.Array[HTMLElement], /* container */ HTMLDivElement) => Double): Self = StObject.set(x, "getDefaultFocusIndex", js.Any.fromFunction2(value))
