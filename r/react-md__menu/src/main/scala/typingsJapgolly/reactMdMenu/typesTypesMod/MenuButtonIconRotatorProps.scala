...
/* Inlined std.Omit<@react-md/icon.@react-md/icon.IconRotatorProps, 'children' | 'rotated'> */
trait MenuButtonIconRotatorProps extends StObject {
...
object MenuButtonIconRotatorProps {
  
  inline def apply(): MenuButtonIconRotatorProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MenuButtonIconRotatorProps]
  }
  
  extension [Self <: MenuButtonIconRotatorProps](x: Self) {
