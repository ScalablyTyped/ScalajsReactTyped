...
object MenuWidget {
  ...
  inline def apply(id: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[LabelRequiredForA11y[MenuWidgetProps] & RefAttributes[HTMLDivElement]]))
  }
  ...
  def withProps(p: LabelRequiredForA11y[MenuWidgetProps] & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
