...
object MenuSheet {
  ...
  inline def apply(id: String, onRequestClose: Callback, visible: Boolean): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[LabelRequiredForA11y[MenuSheetProps]]))
  }
  
  @JSImport("@react-md/menu", "MenuSheet")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def menuProps(value: HTMLAttributes[HTMLDivElement]): this.type = set("menuProps", value.asInstanceOf[js.Any])
  ...
  def withProps(p: LabelRequiredForA11y[MenuSheetProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
