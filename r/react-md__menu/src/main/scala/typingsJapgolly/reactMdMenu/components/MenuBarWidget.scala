...
object MenuBarWidget {
  
  @JSImport("@react-md/menu", "MenuBarWidget")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onChange(value: ReactEventFrom[ListElement & Element] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ReactEventFrom[ListElement & Element]) => value(t0).runNow()))
  ...
  implicit def make(companion: MenuBarWidget.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MenuBarWidgetProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
