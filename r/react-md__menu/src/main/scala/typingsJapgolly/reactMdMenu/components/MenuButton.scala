...
object MenuButton {
  ...
  inline def apply(id: String, visible: Boolean): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[MenuButtonProps & RefAttributes[HTMLButtonElement]]))
  }
  ...
  def withProps(p: MenuButtonProps & RefAttributes[HTMLButtonElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
