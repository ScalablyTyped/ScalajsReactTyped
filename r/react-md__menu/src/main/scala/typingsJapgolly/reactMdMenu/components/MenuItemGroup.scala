...
object MenuItemGroup {
  ...
  implicit def make(companion: MenuItemGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MenuItemGroupProps & RefAttributes[ListElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
