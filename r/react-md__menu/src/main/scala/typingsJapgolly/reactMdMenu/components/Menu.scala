...
object Menu {
  ...
  inline def apply(id: String, visible: Boolean): Builder = {
    val __props = js.Dynamic.literal(id = id.asInstanceOf[js.Any], visible = visible.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[LabelRequiredForA11y[MenuProps] & RefAttributes[HTMLDivElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def getDefaultFocusIndex(value: (/* elements */ js.Array[HTMLElement], HTMLDivElement) => Double): this.type = set("getDefaultFocusIndex", js.Any.fromFunction2(value))
    ...
    inline def onDecrement(value: /* arg */ KeyboardFocusArg[HTMLDivElement] => Callback): this.type = set("onDecrement", js.Any.fromFunction1((t0: /* arg */ KeyboardFocusArg[HTMLDivElement]) => value(t0).runNow()))
    ...
    inline def onFocusChange(value: (/* element */ HTMLElement, /* nextFocusIndex */ Double) => Callback): this.type = set("onFocusChange", js.Any.fromFunction2((t0: /* element */ HTMLElement, t1: /* nextFocusIndex */ Double) => (value(t0, t1)).runNow()))
    
    inline def onIncrement(value: /* arg */ KeyboardFocusArg[HTMLDivElement] => Callback): this.type = set("onIncrement", js.Any.fromFunction1((t0: /* arg */ KeyboardFocusArg[HTMLDivElement]) => value(t0).runNow()))
    ...
    inline def onJumpToFirst(value: /* arg */ KeyboardFocusArg[HTMLDivElement] => Callback): this.type = set("onJumpToFirst", js.Any.fromFunction1((t0: /* arg */ KeyboardFocusArg[HTMLDivElement]) => value(t0).runNow()))
    
    inline def onJumpToLast(value: /* arg */ KeyboardFocusArg[HTMLDivElement] => Callback): this.type = set("onJumpToLast", js.Any.fromFunction1((t0: /* arg */ KeyboardFocusArg[HTMLDivElement]) => value(t0).runNow()))
    ...
    inline def onSearch(value: /* arg */ KeyboardFocusArg[HTMLDivElement] => Callback): this.type = set("onSearch", js.Any.fromFunction1((t0: /* arg */ KeyboardFocusArg[HTMLDivElement]) => value(t0).runNow()))
  ...
  def withProps(p: LabelRequiredForA11y[MenuProps] & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
