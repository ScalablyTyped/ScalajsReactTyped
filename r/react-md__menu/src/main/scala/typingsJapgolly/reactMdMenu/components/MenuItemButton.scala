...
object MenuItemButton {
  ...
  inline def apply(id: String, visible: Boolean): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[MenuItemButtonProps & RefAttributes[HTMLLIElement]]))
  }
  ...
  def withProps(p: MenuItemButtonProps & RefAttributes[HTMLLIElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
