...
object mod {
  ...
  type ModalFilterPicker[T /* <: ModalFilterPickerOption */] = japgolly.scalajs.react.facade.React.Component[ModalFilterPickerProps[T] & js.Object, js.Object]
  ...
  object ModalFilterPickerProps {
    ...
    inline def apply[T /* <: ModalFilterPickerOption */](onCancel: Callback, onSelect: String => Callback, options: js.Array[T]): ModalFilterPickerProps[T] = {
      val __obj = js.Dynamic.literal(onCancel = onCancel.toJsFn, onSelect = js.Any.fromFunction1((t0: String) => onSelect(t0).runNow()), options = options.asInstanceOf[js.Any])
    ...
    extension [Self <: ModalFilterPickerProps[?], T /* <: ModalFilterPickerOption */](x: Self & ModalFilterPickerProps[T]) {
      ...
      inline def setRenderCancelButton(value: CallbackTo[Element]): Self = StObject.set(x, "renderCancelButton", value.toJsFn)
      
      inline def setRenderCancelButtonUndefined: Self = StObject.set(x, "renderCancelButton", js.undefined)
      
      inline def setRenderList(value: CallbackTo[Element]): Self = StObject.set(x, "renderList", value.toJsFn)
