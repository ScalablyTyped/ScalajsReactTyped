...
import typingsJapgolly.reactBootstrapTable.anon.ColIndex
import typingsJapgolly.reactBootstrapTable.reactBootstrapTableInts.`1`
...
object CellEdit {
  ...
  extension [Self <: CellEdit[?], TRow /* <: js.Object */](x: Self & CellEdit[TRow]) {
    ...
    inline def setAfterSaveCell(
      value: (/* row */ TRow, /* keyof TRow */ /* cellName */ String, /* import warning: importer.ImportType#apply Failed type conversion: TRow[keyof TRow] */ /* cellValue */ js.Any, /* props */ ColIndex) => Callback
    ): Self = StObject.set(x, "afterSaveCell", js.Any.fromFunction4((t0: /* row */ TRow, t1: /* keyof TRow */ /* cellName */ String, t2: /* import warning: importer.ImportType#apply Failed type conversion: TRow[keyof TRow] */ /* cellValue */ js.Any, t3: /* props */ ColIndex) => (value(t0, t1, t2, t3)).runNow()))
    ...
    inline def setNonEditableRows(value: CallbackTo[js.Array[Double | String]]): Self = StObject.set(x, "nonEditableRows", value.toJsFn)
