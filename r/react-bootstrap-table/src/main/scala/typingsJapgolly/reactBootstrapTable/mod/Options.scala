...
trait Options[TRow /* <: js.Object */] extends StObject {
  ...
  var clearSearchBtn: js.UndefOr[
    js.Function1[
      /* onClick */ js.Function1[/* e */ ReactMouseEventFrom[Any & org.scalajs.dom.Element], Unit], 
      Element
    ]
  ] = js.undefined
  ...
  var onExpand: js.UndefOr[
    js.Function3[
      ...
      /* isExpand */ Boolean, 
      /* event */ ReactMouseEventFrom[Any & org.scalajs.dom.Element], 
      Unit
    ]
  ] = js.undefined
  ...
  var onRowDoubleClick: js.UndefOr[
    js.Function2[/* row */ TRow, /* event */ ReactMouseEventFrom[Any & org.scalajs.dom.Element], Unit]
  ] = js.undefined
  ...
  var onRowMouseOut: js.UndefOr[
    js.Function2[/* row */ TRow, /* e */ ReactMouseEventFrom[Any & org.scalajs.dom.Element], Unit]
  ] = js.undefined
...
object Options {
  ...
  extension [Self <: Options[?], TRow /* <: js.Object */](x: Self & Options[TRow]) {
    ...
    inline def setAfterColumnFilter(value: (/* filterConds */ js.Array[FilterData[Any]], /* result */ js.Array[TRow]) => Callback): Self = StObject.set(x, "afterColumnFilter", js.Any.fromFunction2((t0: /* filterConds */ js.Array[FilterData[Any]], t1: /* result */ js.Array[TRow]) => (value(t0, t1)).runNow()))
    
    inline def setAfterColumnFilterUndefined: Self = StObject.set(x, "afterColumnFilter", js.undefined)
    
    inline def setAfterDeleteRow(value: (/* rowKeys */ js.Array[Double | String], /* rows */ js.Array[TRow]) => Callback): Self = StObject.set(x, "afterDeleteRow", js.Any.fromFunction2((t0: /* rowKeys */ js.Array[Double | String], t1: /* rows */ js.Array[TRow]) => (value(t0, t1)).runNow()))
    
    inline def setAfterDeleteRowUndefined: Self = StObject.set(x, "afterDeleteRow", js.undefined)
    
    inline def setAfterInsertRow(value: /* row */ TRow => Callback): Self = StObject.set(x, "afterInsertRow", js.Any.fromFunction1((t0: /* row */ TRow) => value(t0).runNow()))
    
    inline def setAfterInsertRowUndefined: Self = StObject.set(x, "afterInsertRow", js.undefined)
    
    inline def setAfterSearch(value: (/* search */ String, /* result */ js.Array[TRow]) => Callback): Self = StObject.set(x, "afterSearch", js.Any.fromFunction2((t0: /* search */ String, t1: /* result */ js.Array[TRow]) => (value(t0, t1)).runNow()))
    
    inline def setAfterSearchUndefined: Self = StObject.set(x, "afterSearch", js.undefined)
    
    inline def setAfterTableComplete(value: Callback): Self = StObject.set(x, "afterTableComplete", value.toJsFn)
    ...
    inline def setBtnGroup(value: /* props */ ButtonGroupProps => Element): Self = StObject.set(x, "btnGroup", js.Any.fromFunction1(value))
    ...
    inline def setClearSearchBtn(
      value: /* onClick */ js.Function1[/* e */ ReactMouseEventFrom[Any & org.scalajs.dom.Element], Unit] => Element
    ...
    inline def setHandleConfirmDeleteRow(value: (/* next */ js.Function0[Unit], /* rowKeys */ js.Array[Double | String]) => Callback): Self = StObject.set(x, "handleConfirmDeleteRow", js.Any.fromFunction2((t0: /* next */ js.Function0[Unit], t1: /* rowKeys */ js.Array[Double | String]) => (value(t0, t1)).runNow()))
    ...
    inline def setInsertModal(
      value: (/* onModalClose */ js.Function0[Unit], /* onSave */ js.Function1[/* row */ TRow, Unit], /* columns */ js.Array[InsertModalColumnDescription[TRow]], /* validateState */ StringDictionary[String], /* ignoreEditable */ Boolean) => Element
    ): Self = StObject.set(x, "insertModal", js.Any.fromFunction5(value))
    
    inline def setInsertModalBody(
      value: (/* columns */ js.Array[InsertModalColumnDescription[TRow]], /* validateState */ StringDictionary[String], /* ignoreEditable */ Boolean) => Element
    ...
    inline def setInsertModalFooter(value: (/* closeModal */ js.Function0[Unit], /* save */ js.Function0[Unit]) => Element): Self = StObject.set(x, "insertModalFooter", js.Any.fromFunction2(value))
    
    inline def setInsertModalFooterUndefined: Self = StObject.set(x, "insertModalFooter", js.undefined)
    
    inline def setInsertModalHeader(value: (/* closeModal */ js.Function0[Unit], /* save */ js.Function0[Unit]) => Element): Self = StObject.set(x, "insertModalHeader", js.Any.fromFunction2(value))
    ...
    inline def setNoDataText(value: String | Element): Self = StObject.set(x, "noDataText", value.asInstanceOf[js.Any])
    
    inline def setNoDataTextUndefined: Self = StObject.set(x, "noDataText", js.undefined)
    
    inline def setNoDataTextVdomElement(value: VdomElement): Self = StObject.set(x, "noDataText", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def setOnDeleteRow(value: (/* rowKeys */ js.Array[Double | String], /* rows */ js.Array[TRow]) => Callback): Self = StObject.set(x, "onDeleteRow", js.Any.fromFunction2((t0: /* rowKeys */ js.Array[Double | String], t1: /* rows */ js.Array[TRow]) => (value(t0, t1)).runNow()))
    
    inline def setOnDeleteRowUndefined: Self = StObject.set(x, "onDeleteRow", js.undefined)
    
    inline def setOnExpand(
      value: (/* rowKey */ Double | String, /* isExpand */ Boolean, /* event */ ReactMouseEventFrom[Any & org.scalajs.dom.Element]) => Callback
    ): Self = StObject.set(x, "onExpand", js.Any.fromFunction3((t0: /* rowKey */ Double | String, t1: /* isExpand */ Boolean, t2: /* event */ ReactMouseEventFrom[Any & org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnExpandUndefined: Self = StObject.set(x, "onExpand", js.undefined)
    
    inline def setOnExportToCSV(value: CallbackTo[js.Array[TRow]]): Self = StObject.set(x, "onExportToCSV", value.toJsFn)
    
    inline def setOnExportToCSVUndefined: Self = StObject.set(x, "onExportToCSV", js.undefined)
    
    inline def setOnFilterChange(value: /* filterObject */ FilterData[Any] => Callback): Self = StObject.set(x, "onFilterChange", js.Any.fromFunction1((t0: /* filterObject */ FilterData[Any]) => value(t0).runNow()))
    ...
    inline def setOnPageChange(value: (/* page */ Double, /* sizePerPage */ Double) => Callback): Self = StObject.set(x, "onPageChange", js.Any.fromFunction2((t0: /* page */ Double, t1: /* sizePerPage */ Double) => (value(t0, t1)).runNow()))
    
    inline def setOnPageChangeUndefined: Self = StObject.set(x, "onPageChange", js.undefined)
    
    inline def setOnRowClick(
      value: (/* row */ TRow, /* columnIndex */ Double, /* rowIndex */ Double, /* event */ ReactMouseEventFrom[Any & org.scalajs.dom.Element]) => Callback
    ): Self = StObject.set(x, "onRowClick", js.Any.fromFunction4((t0: /* row */ TRow, t1: /* columnIndex */ Double, t2: /* rowIndex */ Double, t3: /* event */ ReactMouseEventFrom[Any & org.scalajs.dom.Element]) => (value(t0, t1, t2, t3)).runNow()))
    
    inline def setOnRowClickUndefined: Self = StObject.set(x, "onRowClick", js.undefined)
    
    inline def setOnRowDoubleClick(
      value: (/* row */ TRow, /* event */ ReactMouseEventFrom[Any & org.scalajs.dom.Element]) => Callback
    ): Self = StObject.set(x, "onRowDoubleClick", js.Any.fromFunction2((t0: /* row */ TRow, t1: /* event */ ReactMouseEventFrom[Any & org.scalajs.dom.Element]) => (value(t0, t1)).runNow()))
    
    inline def setOnRowDoubleClickUndefined: Self = StObject.set(x, "onRowDoubleClick", js.undefined)
    
    inline def setOnRowMouseOut(value: (/* row */ TRow, /* e */ ReactMouseEventFrom[Any & org.scalajs.dom.Element]) => Callback): Self = StObject.set(x, "onRowMouseOut", js.Any.fromFunction2((t0: /* row */ TRow, t1: /* e */ ReactMouseEventFrom[Any & org.scalajs.dom.Element]) => (value(t0, t1)).runNow()))
    
    inline def setOnRowMouseOutUndefined: Self = StObject.set(x, "onRowMouseOut", js.undefined)
    
    inline def setOnRowMouseOver(value: (/* row */ TRow, /* e */ ReactMouseEventFrom[Any & org.scalajs.dom.Element]) => Callback): Self = StObject.set(x, "onRowMouseOver", js.Any.fromFunction2((t0: /* row */ TRow, t1: /* e */ ReactMouseEventFrom[Any & org.scalajs.dom.Element]) => (value(t0, t1)).runNow()))
    
    inline def setOnRowMouseOverUndefined: Self = StObject.set(x, "onRowMouseOver", js.undefined)
    
    inline def setOnSearchChange(
      value: (/* searchText */ String, /* colInfos */ js.Array[ColumnDescription[TRow]], /* multiColumnSearch */ Boolean) => Callback
    ): Self = StObject.set(x, "onSearchChange", js.Any.fromFunction3((t0: /* searchText */ String, t1: /* colInfos */ js.Array[ColumnDescription[TRow]], t2: /* multiColumnSearch */ Boolean) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnSearchChangeUndefined: Self = StObject.set(x, "onSearchChange", js.undefined)
    
    inline def setOnSizePerPageList(value: /* sizePerPage */ Double => Callback): Self = StObject.set(x, "onSizePerPageList", js.Any.fromFunction1((t0: /* sizePerPage */ Double) => value(t0).runNow()))
    
    inline def setOnSizePerPageListUndefined: Self = StObject.set(x, "onSizePerPageList", js.undefined)
    
    inline def setOnSortChange(
      value: ((/* sortName */ js.Array[/* keyof TRow */ String]) | (/* keyof TRow */ /* sortName */ String), (/* sortOrder */ js.Array[SortOrder]) | (/* sortOrder */ SortOrder)) => Callback
    ): Self = StObject.set(x, "onSortChange", js.Any.fromFunction2((t0: (/* sortName */ js.Array[/* keyof TRow */ String]) | (/* keyof TRow */ /* sortName */ String), t1: (/* sortOrder */ js.Array[SortOrder]) | (/* sortOrder */ SortOrder)) => (value(t0, t1)).runNow()))
    ...
    inline def setPaginationPanel(value: /* props */ PaginationPanelProps => Element): Self = StObject.set(x, "paginationPanel", js.Any.fromFunction1(value))
    ...
    inline def setPaginationShowsTotal(
      value: Boolean | (js.Function3[/* start */ Double, /* to */ Double, /* total */ Double, String | Element])
    ): Self = StObject.set(x, "paginationShowsTotal", value.asInstanceOf[js.Any])
    
    inline def setPaginationShowsTotalFunction3(value: (/* start */ Double, /* to */ Double, /* total */ Double) => String | Element): Self = StObject.set(x, "paginationShowsTotal", js.Any.fromFunction3(value))
    ...
    inline def setSearchField(value: /* props */ SearchFieldProps => Element): Self = StObject.set(x, "searchField", js.Any.fromFunction1(value))
    
    inline def setSearchFieldUndefined: Self = StObject.set(x, "searchField", js.undefined)
    
    inline def setSearchPanel(value: /* props */ SearchPanelProps => Element): Self = StObject.set(x, "searchPanel", js.Any.fromFunction1(value))
    
    inline def setSearchPanelUndefined: Self = StObject.set(x, "searchPanel", js.undefined)
    
    inline def setShowSelectedOnlyBtn(
      value: (/* onClick */ js.Function1[/* e */ ReactMouseEventFrom[Any & org.scalajs.dom.Element], Unit], /* showSelected */ Boolean) => Element
    ...
    inline def setSizePerPageDropDown(value: /* props */ SizePerPageFunctionProps => Element): Self = StObject.set(x, "sizePerPageDropDown", js.Any.fromFunction1(value))
    ...
    inline def setToolBar(value: /* props */ ToolBarProps => Element): Self = StObject.set(x, "toolBar", js.Any.fromFunction1(value))
