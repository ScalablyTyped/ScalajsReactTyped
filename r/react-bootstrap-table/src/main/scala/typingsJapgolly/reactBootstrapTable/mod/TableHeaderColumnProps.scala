...
trait TableHeaderColumnProps extends StObject {
  ...
  var caretRender: js.UndefOr[
    js.Function2[/* direction */ SortOrder | Null, /* fieldName */ String, String | Element]
  ] = js.undefined
...
object TableHeaderColumnProps {
  ...
  extension [Self <: TableHeaderColumnProps](x: Self) {
    ...
    inline def setAutoValueCallbackTo(value: CallbackTo[Any]): Self = StObject.set(x, "autoValue", value.toJsFn)
    
    inline def setAutoValueUndefined: Self = StObject.set(x, "autoValue", js.undefined)
    
    inline def setCaretRender(value: (/* direction */ SortOrder | Null, /* fieldName */ String) => String | Element): Self = StObject.set(x, "caretRender", js.Any.fromFunction2(value))
    ...
    inline def setRefFunction1(value: TableHeaderColumn | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: TableHeaderColumn | Null) => value(t0).runNow()))
