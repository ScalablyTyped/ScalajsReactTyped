...
import typingsJapgolly.reactBootstrapTable.AnonValues
...
object Editable {
  ...
  def apply[TRow /* <: js.Object */, K /* <: String */](
    ...
    validator: (/* import warning: importer.ImportType#apply Failed type conversion: TRow[K] */ /* cell */ js.Any, /* row */ TRow) => CallbackTo[Boolean | String | EditValidatorObject] = null
  ): Editable[TRow, K] = {
    ...
    if (validator != null) __obj.updateDynamic("validator")(js.Any.fromFunction2((t0: /* import warning: importer.ImportType#apply Failed type conversion: TRow[K] */ /* cell */ js.Any, t1: /* row */ TRow) => validator(t0, t1).runNow()))
