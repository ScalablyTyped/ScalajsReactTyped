...
trait ColumnDescription[TRow /* <: js.Object */] extends StObject {
  ...
  /**
    ...
    */
  def format(cell: Any, row: TRow, formatExtraData: Any, rowIndex: Double): String | Element
...
object ColumnDescription {
  ...
  inline def apply[TRow /* <: js.Object */](
    ...
    format: (Any, TRow, Any, Double) => String | Element,
    formatExtraData: Any,
    hidden: Boolean,
  ...
  extension [Self <: ColumnDescription[?], TRow /* <: js.Object */](x: Self & ColumnDescription[TRow]) {
    ...
    inline def setFormat(value: (Any, TRow, Any, Double) => String | Element): Self = StObject.set(x, "format", js.Any.fromFunction4(value))
    ...
    inline def setText(value: String | Double | Boolean | Element): Self = StObject.set(x, "text", value.asInstanceOf[js.Any])
