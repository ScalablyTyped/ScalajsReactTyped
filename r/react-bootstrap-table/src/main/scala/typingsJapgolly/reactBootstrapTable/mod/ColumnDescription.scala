...
trait ColumnDescription[TRow /* <: js.Object */] extends js.Object {
  ...
  /**
  	 ...
  	 */
  var text: String | Double | Boolean | Element
  /**
  ...
  /**
  	 ...
  	 */
  def format(cell: js.Any, row: TRow, formatExtraData: js.Any, rowIndex: Double): String | Element
  /**
...
object ColumnDescription {
  ...
  def apply[TRow /* <: js.Object */](
    ...
    filterValue: (js.Any, TRow) => CallbackTo[js.Any],
    format: (js.Any, TRow, js.Any, Double) => CallbackTo[String | Element],
    ...
    searchable: Boolean,
    sort: Boolean,
    sortFunc: (TRow, TRow, SortOrder, String, js.Any) => CallbackTo[Double],
    sortFuncExtraData: js.Any,
    style: CSSProperties,
    text: String | Double | Boolean | Element,
    width: String
  ): ColumnDescription[TRow] = {
    val __obj = js.Dynamic.literal(align = align.asInstanceOf[js.Any], attrs = attrs.asInstanceOf[js.Any], className = className.asInstanceOf[js.Any], columnTitle = columnTitle.asInstanceOf[js.Any], customEditor = customEditor.asInstanceOf[js.Any], editAttrs = editAttrs.asInstanceOf[js.Any], editClassName = editClassName.asInstanceOf[js.Any], editable = editable.asInstanceOf[js.Any], expandable = expandable.asInstanceOf[js.Any], export = export.asInstanceOf[js.Any], filterFormatted = filterFormatted.asInstanceOf[js.Any], formatExtraData = formatExtraData.asInstanceOf[js.Any], hidden = hidden.asInstanceOf[js.Any], hiddenOnInsert = hiddenOnInsert.asInstanceOf[js.Any], invalidEditColumnClassName = invalidEditColumnClassName.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], searchable = searchable.asInstanceOf[js.Any], sort = sort.asInstanceOf[js.Any], sortFuncExtraData = sortFuncExtraData.asInstanceOf[js.Any], style = style.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
    __obj.updateDynamic("filterValue")(js.Any.fromFunction2((t0: js.Any, t1: TRow) => filterValue(t0, t1).runNow()))
    __obj.updateDynamic("format")(js.Any.fromFunction4((t0: js.Any, t1: TRow, t2: js.Any, t3: scala.Double) => format(t0, t1, t2, t3).runNow()))
    __obj.updateDynamic("sortFunc")(js.Any.fromFunction5((t0: TRow, t1: TRow, t2: typingsJapgolly.reactBootstrapTable.mod.SortOrder, t3: java.lang.String, t4: js.Any) => sortFunc(t0, t1, t2, t3, t4).runNow()))
