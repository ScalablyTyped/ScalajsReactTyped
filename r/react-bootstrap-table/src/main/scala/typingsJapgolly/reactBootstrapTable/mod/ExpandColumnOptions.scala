...
object ExpandColumnOptions {
  ...
  extension [Self <: ExpandColumnOptions](x: Self) {
    ...
    inline def setExpandColumnComponent(value: /* props */ ExpandColumnComponentProps => String | Element): Self = StObject.set(x, "expandColumnComponent", js.Any.fromFunction1(value))
    ...
    inline def setExpandedColumnHeaderComponent(value: /* props */ ExpandedColumnHeaderProps => String | Element): Self = StObject.set(x, "expandedColumnHeaderComponent", js.Any.fromFunction1(value))
