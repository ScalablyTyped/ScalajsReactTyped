...
object SizePerPageDropDownProps {
  ...
  extension [Self <: SizePerPageDropDownProps](x: Self) {
    ...
    inline def setOnClick(value: /* toggleDropDown */ js.Function0[Unit] => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction1((t0: /* toggleDropDown */ js.Function0[Unit]) => value(t0).runNow()))
