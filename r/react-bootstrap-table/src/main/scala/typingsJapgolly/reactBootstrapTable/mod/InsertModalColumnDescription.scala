...
object InsertModalColumnDescription {
  ...
  inline def apply[TRow /* <: js.Object */](
    customInsertEditor: (InsertModalColumnDescription[TRow], EditableAttrs, String, Boolean, /* import warning: importer.ImportType#apply Failed type conversion: TRow[keyof TRow] */ js.Any) => Element | Boolean,
  ...
  extension [Self <: InsertModalColumnDescription[?], TRow /* <: js.Object */](x: Self & InsertModalColumnDescription[TRow]) {
    ...
    inline def setCustomInsertEditor(
      value: (InsertModalColumnDescription[TRow], EditableAttrs, String, Boolean, /* import warning: importer.ImportType#apply Failed type conversion: TRow[keyof TRow] */ js.Any) => Element | Boolean
