...
trait BootstrapTableProps extends StObject {
  ...
  /**
    ...
    */
  var autoCollapse: js.UndefOr[typingsJapgolly.reactBootstrapTable.anon.Filter] = js.undefined
  ...
  /**
    ...
    */
  var expandComponent: js.UndefOr[js.Function1[/* row */ Any, String | Element]] = js.undefined
...
object BootstrapTableProps {
  ...
  extension [Self <: BootstrapTableProps](x: Self) {
    ...
    inline def setAutoCollapse(value: typingsJapgolly.reactBootstrapTable.anon.Filter): Self = StObject.set(x, "autoCollapse", value.asInstanceOf[js.Any])
    ...
    inline def setCsvFileNameCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "csvFileName", value.toJsFn)
    ...
    inline def setExpandComponent(value: /* row */ Any => String | Element): Self = StObject.set(x, "expandComponent", js.Any.fromFunction1(value))
    ...
    inline def setRefFunction1(value: BootstrapTable | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: BootstrapTable | Null) => value(t0).runNow()))
