...
class Ractive[T /* <: Ractive[T] */] () extends js.Object {
  ...
  def getContext(nodeOrQuery: typingsJapgolly.std.HTMLElement): ContextHelper = js.native
  /**
  ...
  /**
  	 ...
  	 * @param opts
  	 */
  def transition(transition: String, node: typingsJapgolly.std.HTMLElement): js.Promise[Unit] = js.native
  def transition(
    transition: String,
    node: typingsJapgolly.std.HTMLElement,
    opts: typingsJapgolly.ractive.TransitionOpts
  ): js.Promise[Unit] = js.native
  def transition(transition: String, opts: typingsJapgolly.ractive.TransitionOpts): js.Promise[Unit] = js.native
  def transition(transition: Transition): js.Promise[Unit] = js.native
  def transition(transition: Transition, node: typingsJapgolly.std.HTMLElement): js.Promise[Unit] = js.native
  def transition(
    transition: Transition,
    node: typingsJapgolly.std.HTMLElement,
    opts: typingsJapgolly.ractive.TransitionOpts
  ): js.Promise[Unit] = js.native
  def transition(transition: Transition, opts: typingsJapgolly.ractive.TransitionOpts): js.Promise[Unit] = js.native
  /**
