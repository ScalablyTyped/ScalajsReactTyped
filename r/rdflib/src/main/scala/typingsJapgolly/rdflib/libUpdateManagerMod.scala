...
import typingsJapgolly.rdflib.anon.Setobject
...
object libUpdateManagerMod {
  ...
  trait UpdateManager extends StObject {
    ...
    def editable(uri: String, kb: typingsJapgolly.rdflib.libStoreMod.default): js.UndefOr[String | Boolean] = js.native
    def editable(uri: NamedNode): js.UndefOr[String | Boolean] = js.native
    def editable(uri: NamedNode, kb: typingsJapgolly.rdflib.libStoreMod.default): js.UndefOr[String | Boolean] = js.native
    ...
    /**
      ...
      */
    def put(
      doc: typingsJapgolly.rdflib.libNamedNodeMod.default,
      data: String,
      contentType: String,
  ...
  trait UpdateManagerFormula
    ...
    @JSName("fetcher")
    var fetcher_UpdateManagerFormula: typingsJapgolly.rdflib.libFetcherMod.default = js.native
  }
