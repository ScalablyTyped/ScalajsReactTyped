...
object libRdfxmlparserMod {
  ...
  object RDFParser {
    ...
    extension [Self <: RDFParser](x: Self) {
      ...
      inline def setParseDOM(value: Any => Callback): Self = StObject.set(x, "parseDOM", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
