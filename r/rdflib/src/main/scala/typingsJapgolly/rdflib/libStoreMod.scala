...
import typingsJapgolly.rdflib.anon.Delete
import typingsJapgolly.rdflib.libFormulaMod.FormulaOpts
import typingsJapgolly.rdflib.libQueryMod.Query
...
import typingsJapgolly.rdflib.rdflibStrings.FunctionalProperty
import typingsJapgolly.rdflib.rdflibStrings.InverseFunctionalProperty
import typingsJapgolly.rdflib.rdflibStrings.`two-direction`
import typingsJapgolly.rdflib.rdflibStrings.delete_
import typingsJapgolly.rdflib.rdflibStrings.sameAs
...
object libStoreMod {
  ...
  trait IndexedFormula
    ...
    var _existentialVariables: js.UndefOr[js.Array[typingsJapgolly.rdflib.libBlankNodeMod.default]] = js.native
    
    var _universalVariables: js.UndefOr[js.Array[typingsJapgolly.rdflib.libNamedNodeMod.default]] = js.native
    ...
    def add(
      subj: QuadSubject | (Quad[QuadSubject, QuadPredicate, QuadObject, QuadGraph]) | (js.Array[
          (Quad[QuadSubject, QuadPredicate, QuadObject, QuadGraph]) | (typingsJapgolly.rdflib.libStatementMod.default[SubjectType, PredicateType, ObjectType, GraphType])
        ]) | (typingsJapgolly.rdflib.libStatementMod.default[SubjectType, PredicateType, ObjectType, GraphType]),
    ...
    var aliases: js.Array[Any] = js.native
    
    /**
      * Return all equivalent URIs by which this is known
      * @param x A named node
      */
    def allAliases(x: typingsJapgolly.rdflib.libNamedNodeMod.default): js.Array[typingsJapgolly.rdflib.libNamedNodeMod.default] = js.native
    ...
    /**
      ...
      */
    def canon(): typingsJapgolly.rdflib.libNodeMod.default = js.native
    def canon(term: Term): typingsJapgolly.rdflib.libNodeMod.default = js.native
    ...
    /* private */ var dataCallbacks: Any = js.native
    ...
    /**
      ...
      */
    def declareExistential(x: typingsJapgolly.rdflib.libBlankNodeMod.default): typingsJapgolly.rdflib.libBlankNodeMod.default = js.native
    ...
    def query(
      myQuery: Query,
      callback: js.Function1[/* bindings */ Bindings, Unit],
      fetcher: typingsJapgolly.rdflib.libFetcherMod.default
    ): Unit = js.native
    def query(
      myQuery: Query,
      callback: js.Function1[/* bindings */ Bindings, Unit],
    ...
    /**
      ...
      * @param myQuery The query to be run
      */
    def querySync(myQuery: Query): js.Array[Any] = js.native
    
    /** Function to remove quads from the store arrays with */
    /* private */ var rdfArrayRemove: Any = js.native
    
    /** Redirect to lexically smaller equivalent symbol */
    var redirections: js.Array[Any] = js.native
    ...
    /**
      ...
      */
    def sameThings(
      x: typingsJapgolly.rdflib.libNamedNodeMod.default,
      y: typingsJapgolly.rdflib.libNamedNodeMod.default
    ): Boolean = js.native
    ...
    /**
      ...
      */
    var updater: js.UndefOr[typingsJapgolly.rdflib.libUpdateManagerMod.default] = js.native
