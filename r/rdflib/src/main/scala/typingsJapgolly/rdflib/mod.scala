...
import typingsJapgolly.rdflib.anon.ATTRIBUTE
import typingsJapgolly.rdflib.anon.Flags
import typingsJapgolly.rdflib.anon.Pattern
import typingsJapgolly.rdflib.anon.RDF
import typingsJapgolly.rdflib.libBlankNodeMod.default
import typingsJapgolly.rdflib.libFetcherMod.Handler
import typingsJapgolly.rdflib.libFetcherMod.Options
import typingsJapgolly.rdflib.libFormulaMod.FormulaOpts
import typingsJapgolly.rdflib.libN3parserMod.SinkParser
import typingsJapgolly.rdflib.libParseMod.CallbackFunc
import typingsJapgolly.rdflib.libStoreMod.FeaturesType
...
import typingsJapgolly.rdflib.libTypesMod.IRDFlibDataFactory
...
import typingsJapgolly.rdflib.rdflibBooleans.`false`
...
object mod {
  ...
  @js.native
  open class Collection[T /* <: typingsJapgolly.rdflib.libNodeInternalMod.default */] ()
    extends typingsJapgolly.rdflib.libCollectionMod.default[T] {
  ...
  open class ConnectedStore protected ()
    extends typingsJapgolly.rdflib.libStoreMod.default {
    def this(features: Any) = this()
    
    @JSName("fetcher")
    var fetcher_ConnectedStore: typingsJapgolly.rdflib.libFetcherMod.default = js.native
  }
  ...
  @js.native
  open class Empty ()
    extends typingsJapgolly.rdflib.libEmptyMod.default
  
  @JSImport("rdflib", "Fetcher")
  @js.native
  open class Fetcher_ protected ()
    extends typingsJapgolly.rdflib.libFetcherMod.default {
    def this(store: typingsJapgolly.rdflib.libStoreMod.default) = this()
    def this(store: typingsJapgolly.rdflib.libStoreMod.default, options: Options) = this()
  }
  /* static members */
  object Fetcher_ {
  ...
  /**
    ...
    */
  open class Formula ()
    extends typingsJapgolly.rdflib.libFormulaMod.default {
  ...
  open class Literal protected ()
    extends typingsJapgolly.rdflib.libLiteralMod.default {
    /**
  ...
  object Literal {
    ...
    /**
      ...
      */
    inline def fromBoolean(value: Boolean): typingsJapgolly.rdflib.libLiteralMod.Literal = ^.asInstanceOf[js.Dynamic].applyDynamic("fromBoolean")(value.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rdflib.libLiteralMod.Literal]
    
    /**
      * Builds a literal node from a date value
      * @param value The value
      */
    inline def fromDate(value: js.Date): typingsJapgolly.rdflib.libLiteralMod.Literal = ^.asInstanceOf[js.Dynamic].applyDynamic("fromDate")(value.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rdflib.libLiteralMod.Literal]
    
    /**
      * Builds a literal node from a number value
      * @param value - The value
      */
    inline def fromNumber(value: Double): typingsJapgolly.rdflib.libLiteralMod.Literal = ^.asInstanceOf[js.Dynamic].applyDynamic("fromNumber")(value.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rdflib.libLiteralMod.Literal]
    ...
    inline def toNT(literal: typingsJapgolly.rdflib.libLiteralMod.Literal): String = ^.asInstanceOf[js.Dynamic].applyDynamic("toNT")(literal.asInstanceOf[js.Any]).asInstanceOf[String]
  }
  ...
  open class LiveStore protected () extends ConnectedStore {
    ...
    @JSName("updater")
    var updater_LiveStore: typingsJapgolly.rdflib.libUpdateManagerMod.default = js.native
  }
  ...
  open class NamedNode protected ()
    extends typingsJapgolly.rdflib.libNamedNodeMod.default {
    /**
  ...
  inline def Namespace(nsuri: String): js.Function1[/* ln */ String, typingsJapgolly.rdflib.libTfTypesMod.NamedNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("Namespace")(nsuri.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ln */ String, typingsJapgolly.rdflib.libTfTypesMod.NamedNode]]
  inline def Namespace(nsuri: String, factory: RdfJsDataFactory): js.Function1[/* ln */ String, typingsJapgolly.rdflib.libTfTypesMod.NamedNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("Namespace")(nsuri.asInstanceOf[js.Any], factory.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ln */ String, typingsJapgolly.rdflib.libTfTypesMod.NamedNode]]
  ...
  open class Node protected ()
    extends typingsJapgolly.rdflib.libNodeMod.default {
  ...
  open class Query protected ()
    extends typingsJapgolly.rdflib.libQueryMod.Query {
  ...
  open class RDFParser protected ()
    extends typingsJapgolly.rdflib.libRdfxmlparserMod.default {
  ...
  open class RDFaProcessor protected ()
    extends typingsJapgolly.rdflib.libRdfaparserMod.default {
  ...
  inline def SPARQLToQuery(SPARQL: Any, testMode: Any, kb: Any): `false` | typingsJapgolly.rdflib.libQueryMod.Query = (^.asInstanceOf[js.Dynamic].applyDynamic("SPARQLToQuery")(SPARQL.asInstanceOf[js.Any], testMode.asInstanceOf[js.Any], kb.asInstanceOf[js.Any])).asInstanceOf[`false` | typingsJapgolly.rdflib.libQueryMod.Query]
  
  inline def Serializer(store: Any): typingsJapgolly.rdflib.libSerializerMod.Serializer = ^.asInstanceOf[js.Dynamic].applyDynamic("Serializer")(store.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rdflib.libSerializerMod.Serializer]
  
  @JSImport("rdflib", "Statement")
  @js.native
  open class Statement[S /* <: SubjectType */, P /* <: PredicateType */, O /* <: ObjectType */, G /* <: GraphType */] protected ()
    extends typingsJapgolly.rdflib.libStatementMod.default[S, P, O, G] {
    /**
  ...
  open class UpdateManager ()
    extends typingsJapgolly.rdflib.libUpdateManagerMod.default {
    def this(store: typingsJapgolly.rdflib.libStoreMod.default) = this()
  }
  ...
  open class UpdatesSocket protected ()
    extends typingsJapgolly.rdflib.libUpdatesViaMod.UpdatesSocket {
  ...
  open class UpdatesVia protected ()
    extends typingsJapgolly.rdflib.libUpdatesViaMod.UpdatesVia {
  ...
  object Util {
    ...
    inline def linkRelationProperty(relation: Any): typingsJapgolly.rdflib.libNamedNodeMod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("linkRelationProperty")(relation.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rdflib.libNamedNodeMod.default]
    ...
    inline def mediaTypeClass(mediaType: Any): typingsJapgolly.rdflib.libNamedNodeMod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("mediaTypeClass")(mediaType.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rdflib.libNamedNodeMod.default]
    ...
    object uri {
      ...
      inline def document(x: String): typingsJapgolly.rdflib.libNamedNodeMod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("document")(x.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rdflib.libNamedNodeMod.default]
  ...
  /**
    ...
    */
  open class Variable ()
    extends typingsJapgolly.rdflib.libVariableMod.default {
  ...
  /* import warning: parser.TsParser#tsDeclVar Dropped IArray(graph, lit, st, namedNode, variable, blankNode, defaultGraph, literal, quad, triple) */ inline def fetcher(store: typingsJapgolly.rdflib.libStoreMod.default, options: Any): typingsJapgolly.rdflib.libFetcherMod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("fetcher")(store.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.rdflib.libFetcherMod.default]
  ...
  inline def parse(str: String, kb: typingsJapgolly.rdflib.libFormulaMod.default, base: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("parse")(str.asInstanceOf[js.Any], kb.asInstanceOf[js.Any], base.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def parse(str: String, kb: typingsJapgolly.rdflib.libFormulaMod.default, base: String, contentType: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("parse")(str.asInstanceOf[js.Any], kb.asInstanceOf[js.Any], base.asInstanceOf[js.Any], contentType.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def parse(
    str: String,
  ...
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("parse")(str.asInstanceOf[js.Any], kb.asInstanceOf[js.Any], base.asInstanceOf[js.Any], contentType.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def parse(
    str: String,
    kb: typingsJapgolly.rdflib.libFormulaMod.default,
    base: String,
  ...
  target: typingsJapgolly.rdflib.libFormulaMod.default | typingsJapgolly.rdflib.libTfTypesMod.NamedNode | typingsJapgolly.rdflib.libTfTypesMod.BlankNode | Null,
    /** The store */
  kb: typingsJapgolly.rdflib.libFormulaMod.default,
    base: js.UndefOr[Any],
    /**
  ...
  inline def sparqlUpdateParser(str: Any, kb: Any, base: Any): typingsJapgolly.rdflib.anon.Query = (^.asInstanceOf[js.Dynamic].applyDynamic("sparqlUpdateParser")(str.asInstanceOf[js.Any], kb.asInstanceOf[js.Any], base.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.rdflib.anon.Query]
