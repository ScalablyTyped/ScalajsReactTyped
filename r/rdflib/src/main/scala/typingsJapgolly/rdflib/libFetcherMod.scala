...
import typingsJapgolly.rdflib.anon.Q
import typingsJapgolly.rdflib.anon.TypeofHandler
import typingsJapgolly.rdflib.anon.reqBlankNodeoriginalQuadS
import typingsJapgolly.rdflib.anon.reqBlankNoderesourceQuadS
import typingsJapgolly.rdflib.anon.reqQuadSubjectoriginalQua
...
object libFetcherMod {
  ...
  object AutoInitOptions {
    ...
    extension [Self <: AutoInitOptions](x: Self) {
      ...
      inline def setFetch(
        value: (/* input */ RequestInfo, /* init */ js.UndefOr[org.scalajs.dom.RequestInit]) => js.Promise[ExtendedResponse]
  ...
  type Fetch = js.Function2[
    /* input */ RequestInfo, 
    /* init */ js.UndefOr[org.scalajs.dom.RequestInit], 
  ...
  trait Fetcher
    ...
    def _fetch(input: RequestInfo, init: org.scalajs.dom.RequestInit): js.Promise[ExtendedResponse] = js.native
    @JSName("_fetch")
    ...
    def addType(
      rdfType: NamedNode,
      req: QuadSubject,
      kb: typingsJapgolly.rdflib.libStoreMod.default,
      locURI: String
    ): Unit = js.native
    ...
    /**
      ...
      */
    def createContainer(parentURI: String, folderName: String, data: String): js.Promise[org.scalajs.dom.Response] = js.native
    ...
    /** Create an empty resource if it really does not exist
      ...
      */
    def createIfNotExists(doc: typingsJapgolly.rdflib.libNamedNodeMod.default): js.Promise[ExtendedResponse] = js.native
    def createIfNotExists(doc: typingsJapgolly.rdflib.libNamedNodeMod.default, contentType: Unit, data: String): js.Promise[ExtendedResponse] = js.native
    @JSName("createIfNotExists")
    def createIfNotExists_textturtle(doc: typingsJapgolly.rdflib.libNamedNodeMod.default, contentType: textSlashturtle): js.Promise[ExtendedResponse] = js.native
    @JSName("createIfNotExists")
    def createIfNotExists_textturtle(doc: typingsJapgolly.rdflib.libNamedNodeMod.default, contentType: textSlashturtle, data: String): js.Promise[ExtendedResponse] = js.native
    ...
    def doneFetch(options: reqQuadSubjectoriginalQua, response: ExtendedResponse): org.scalajs.dom.Response = js.native
    ...
    def load(uri: String): /* import warning: importer.ImportType#apply Failed type conversion: string extends std.Array<string | rdflib.rdflib/lib/tf-types.NamedNode> ? std.Promise<std.Array<rdflib.rdflib/lib/fetcher.Result>> : std.Promise<rdflib.rdflib/lib/fetcher.Result> */ js.Any = js.native
    def load(uri: String, options: Options): /* import warning: importer.ImportType#apply Failed type conversion: string extends std.Array<string | rdflib.rdflib/lib/tf-types.NamedNode> ? std.Promise<std.Array<rdflib.rdflib/lib/fetcher.Result>> : std.Promise<rdflib.rdflib/lib/fetcher.Result> */ js.Any = js.native
    def load(uri: js.Array[String | NamedNode]): /* import warning: importer.ImportType#apply Failed type conversion: std.Array<string | rdflib.rdflib/lib/tf-types.NamedNode> extends std.Array<string | rdflib.rdflib/lib/tf-types.NamedNode> ? std.Promise<std.Array<rdflib.rdflib/lib/fetcher.Result>> : std.Promise<rdflib.rdflib/lib/fetcher.Result> */ js.Any = js.native
    def load(uri: js.Array[String | NamedNode], options: Options): /* import warning: importer.ImportType#apply Failed type conversion: std.Array<string | rdflib.rdflib/lib/tf-types.NamedNode> extends std.Array<string | rdflib.rdflib/lib/tf-types.NamedNode> ? std.Promise<std.Array<rdflib.rdflib/lib/fetcher.Result>> : std.Promise<rdflib.rdflib/lib/fetcher.Result> */ js.Any = js.native
    /**
      ...
      */
    def load(uri: NamedNode): /* import warning: importer.ImportType#apply Failed type conversion: rdflib.rdflib/lib/tf-types.NamedNode extends std.Array<string | rdflib.rdflib/lib/tf-types.NamedNode> ? std.Promise<std.Array<rdflib.rdflib/lib/fetcher.Result>> : std.Promise<rdflib.rdflib/lib/fetcher.Result> */ js.Any = js.native
    def load(uri: NamedNode, options: Options): /* import warning: importer.ImportType#apply Failed type conversion: rdflib.rdflib/lib/tf-types.NamedNode extends std.Array<string | rdflib.rdflib/lib/tf-types.NamedNode> ? std.Promise<std.Array<rdflib.rdflib/lib/fetcher.Result>> : std.Promise<rdflib.rdflib/lib/fetcher.Result> */ js.Any = js.native
    ...
    /**
      ...
      */
    def lookUpThing(term: QuadSubject, rterm: QuadSubject): js.Promise[org.scalajs.dom.Response] | js.Array[js.Promise[org.scalajs.dom.Response]] = js.native
    ...
    def pendingFetchPromise(uri: String, originalUri: String, options: AutoInitOptions): js.Promise[org.scalajs.dom.Response] = js.native
    
    def putBack(uri: String): js.Promise[org.scalajs.dom.Response] = js.native
    def putBack(uri: String, options: Options): js.Promise[org.scalajs.dom.Response] = js.native
    /**
      * Writes back to the web what we have in the store for this uri
      */
    def putBack(uri: NamedNode): js.Promise[org.scalajs.dom.Response] = js.native
    def putBack(uri: NamedNode, options: Options): js.Promise[org.scalajs.dom.Response] = js.native
    ...
    def retryNoCredentials(docuri: String, options: Any): js.Promise[org.scalajs.dom.Response] = js.native
    ...
    def saveResponseMetadata(response: org.scalajs.dom.Response, options: reqBlankNoderesourceQuadS): BlankNode = js.native
    
    def setRequestTimeout(uri: String, options: reqQuadSubjectoriginalQua): js.Promise[Double | FetchError] = js.native
    
    var store: typingsJapgolly.rdflib.libStoreMod.default = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rdflib.rdflibStrings.GET
    - typingsJapgolly.rdflib.rdflibStrings.PUT
    - typingsJapgolly.rdflib.rdflibStrings.POST
    - typingsJapgolly.rdflib.rdflibStrings.PATCH
    - typingsJapgolly.rdflib.rdflibStrings.HEAD
    - typingsJapgolly.rdflib.rdflibStrings.DELETE
    - typingsJapgolly.rdflib.rdflibStrings.CONNECT
    - typingsJapgolly.rdflib.rdflibStrings.TRACE
    - typingsJapgolly.rdflib.rdflibStrings.OPTIONS
  */
  trait HTTPMethods extends StObject
  object HTTPMethods {
    
    inline def CONNECT: typingsJapgolly.rdflib.rdflibStrings.CONNECT = "CONNECT".asInstanceOf[typingsJapgolly.rdflib.rdflibStrings.CONNECT]
    
    inline def DELETE: typingsJapgolly.rdflib.rdflibStrings.DELETE = "DELETE".asInstanceOf[typingsJapgolly.rdflib.rdflibStrings.DELETE]
    
    inline def GET: typingsJapgolly.rdflib.rdflibStrings.GET = "GET".asInstanceOf[typingsJapgolly.rdflib.rdflibStrings.GET]
    
    inline def HEAD: typingsJapgolly.rdflib.rdflibStrings.HEAD = "HEAD".asInstanceOf[typingsJapgolly.rdflib.rdflibStrings.HEAD]
    
    inline def OPTIONS: typingsJapgolly.rdflib.rdflibStrings.OPTIONS = "OPTIONS".asInstanceOf[typingsJapgolly.rdflib.rdflibStrings.OPTIONS]
    
    inline def PATCH: typingsJapgolly.rdflib.rdflibStrings.PATCH = "PATCH".asInstanceOf[typingsJapgolly.rdflib.rdflibStrings.PATCH]
    
    inline def POST: typingsJapgolly.rdflib.rdflibStrings.POST = "POST".asInstanceOf[typingsJapgolly.rdflib.rdflibStrings.POST]
    
    inline def PUT: typingsJapgolly.rdflib.rdflibStrings.PUT = "PUT".asInstanceOf[typingsJapgolly.rdflib.rdflibStrings.PUT]
    
    inline def TRACE: typingsJapgolly.rdflib.rdflibStrings.TRACE = "TRACE".asInstanceOf[typingsJapgolly.rdflib.rdflibStrings.TRACE]
  }
  ...
  type Result = org.scalajs.dom.Response
  
  /* Rewritten from type alias, can be one of: 
    - scala.Unit
    - typingsJapgolly.rdflib.rdflibBooleans.`true`
    - typingsJapgolly.rdflib.rdflibStrings.done
    - typingsJapgolly.rdflib.rdflibInts.`401`
    - typingsJapgolly.rdflib.rdflibInts.`403`
    - typingsJapgolly.rdflib.rdflibInts.`404`
    - typingsJapgolly.rdflib.rdflibStrings.redirected
    - typingsJapgolly.rdflib.rdflibStrings.failed
    - typingsJapgolly.rdflib.rdflibStrings.parse_error
    - typingsJapgolly.rdflib.rdflibStrings.unsupported_protocol
    - typingsJapgolly.rdflib.rdflibStrings.timeout
