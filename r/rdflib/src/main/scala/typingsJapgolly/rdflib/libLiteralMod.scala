...
object libLiteralMod {
  ...
  - typingsJapgolly.rdflib.libTfTypesMod.Literal because var conflicts: termType, value. Inlined language, datatype */ @js.native
  trait Literal
    ...
    /**
      ...
      */
    var datatype: NamedNode | typingsJapgolly.rdflib.libNamedNodeMod.default = js.native
    ...
    @JSName("termType")
    var termType_Literal: typingsJapgolly.rdflib.rdflibStrings.Literal = js.native
  }
}
