...
import typingsJapgolly.reactElemental.mod.ButtonProps
...
object Button {
  ...
  ): UnmountedWithRoot[ButtonProps, typingsJapgolly.reactElemental.mod.Button, Unit, ButtonProps] = {
  ...
  typingsJapgolly.reactElemental.mod.ButtonProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.reactElemental.mod.Button](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactElemental.mod.ButtonProps])
  }
