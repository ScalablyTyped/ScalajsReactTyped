...
import typingsJapgolly.reactElemental.mod.ImageProps
...
object Image {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ImageProps, typingsJapgolly.reactElemental.mod.Image, Unit, ImageProps] = {
  ...
  typingsJapgolly.reactElemental.mod.ImageProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactElemental.mod.Image](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactElemental.mod.ImageProps])(children: _*)
  }
