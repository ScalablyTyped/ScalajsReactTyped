...
object Image {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactElemental.mod.Image] {
    ...
    inline def imgStyle(value: CSSProperties): this.type = set("imgStyle", value.asInstanceOf[js.Any])
    ...
    inline def showIntermediate(value: Boolean): this.type = set("showIntermediate", value.asInstanceOf[js.Any])
