...
import typingsJapgolly.reactElemental.mod.TextFieldProps
...
object TextField {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextFieldProps, typingsJapgolly.reactElemental.mod.TextField, Unit, TextFieldProps] = {
  ...
  typingsJapgolly.reactElemental.mod.TextFieldProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactElemental.mod.TextField](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactElemental.mod.TextFieldProps])(children: _*)
  }
