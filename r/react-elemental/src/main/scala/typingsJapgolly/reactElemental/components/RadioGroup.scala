...
import typingsJapgolly.reactElemental.mod.RadioGroupProps
...
object RadioGroup {
  def apply(
    ...
    onChange: ReactEventFrom[HTMLDivElement] | (/* value */ String) => Callback = null,
    ...
    radioRenderer: (/* option */ Element, /* idx */ Double, /* options */ js.Array[Element]) => CallbackTo[Element] = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RadioGroupProps, typingsJapgolly.reactElemental.mod.RadioGroup, Unit, RadioGroupProps] = {
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLDivElement] | (/* value */ java.lang.String)) => onChange(t0).runNow()))
    ...
    if (radioRenderer != null) __obj.updateDynamic("radioRenderer")(js.Any.fromFunction3((t0: /* option */ japgolly.scalajs.react.raw.React.Element, t1: /* idx */ scala.Double, t2: /* options */ js.Array[japgolly.scalajs.react.raw.React.Element]) => radioRenderer(t0, t1, t2).runNow()))
  ...
  typingsJapgolly.reactElemental.mod.RadioGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactElemental.mod.RadioGroup](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactElemental.mod.RadioGroupProps])(children: _*)
  }
