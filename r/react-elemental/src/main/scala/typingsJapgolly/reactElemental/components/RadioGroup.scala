...
object RadioGroup {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactElemental.mod.RadioGroup] {
    ...
    inline def idleColor(value: String): this.type = set("idleColor", value.asInstanceOf[js.Any])
    ...
    inline def radioRenderer(
      value: (/* option */ japgolly.scalajs.react.facade.React.Element, /* idx */ Double, /* options */ js.Array[japgolly.scalajs.react.facade.React.Element]) => japgolly.scalajs.react.facade.React.Element
