...
object Link {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactElemental.mod.Link] {
    ...
    inline def ref(value: String): this.type = set("ref", value.asInstanceOf[js.Any])
    ...
    inline def `type`(value: LinkType): this.type = set("type", value.asInstanceOf[js.Any])
