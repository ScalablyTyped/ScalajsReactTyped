...
import typingsJapgolly.reactElemental.mod.LinkProps
import typingsJapgolly.reactElemental.mod.LinkType
...
object Link {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[LinkProps, typingsJapgolly.reactElemental.mod.Link, Unit, LinkProps] = {
  ...
  typingsJapgolly.reactElemental.mod.LinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactElemental.mod.Link](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactElemental.mod.LinkProps])(children: _*)
  }
