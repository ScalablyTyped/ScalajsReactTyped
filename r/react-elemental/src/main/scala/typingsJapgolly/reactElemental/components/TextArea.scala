...
object TextArea {
  def apply(
    ...
    TextAreaProps, 
    MountedWithRawType[TextAreaProps, js.Object, RawMounted[TextAreaProps, js.Object]]
  ] = {
  ...
  typingsJapgolly.reactElemental.mod.TextAreaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactElemental.mod.TextAreaProps])(children: _*)
  }
