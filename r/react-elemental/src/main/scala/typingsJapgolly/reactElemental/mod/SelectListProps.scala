...
trait SelectListProps extends StObject {
  ...
  val options: js.UndefOr[js.Array[typingsJapgolly.reactElemental.anon.Label]] = js.undefined
...
object SelectListProps {
  ...
  extension [Self <: SelectListProps](x: Self) {
    ...
    inline def setOptions(value: js.Array[typingsJapgolly.reactElemental.anon.Label]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
    
    inline def setOptionsUndefined: Self = StObject.set(x, "options", js.undefined)
    
    inline def setOptionsVarargs(value: typingsJapgolly.reactElemental.anon.Label*): Self = StObject.set(x, "options", js.Array(value*))
