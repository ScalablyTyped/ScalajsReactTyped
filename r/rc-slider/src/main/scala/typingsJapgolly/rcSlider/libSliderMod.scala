...
object libSliderMod extends Shortcut {
  ...
  trait SliderProps[ValueType] extends StObject {
    ...
    var marks: js.UndefOr[Record[String | Double, Node | MarkObj]] = js.undefined
  ...
  object SliderProps {
    ...
    extension [Self <: SliderProps[?], ValueType](x: Self & SliderProps[ValueType]) {
      ...
      inline def setMarks(value: Record[String | Double, Node | MarkObj]): Self = StObject.set(x, "marks", value.asInstanceOf[js.Any])
      ...
      inline def setOnAfterChange(value: /* value */ ValueType => Callback): Self = StObject.set(x, "onAfterChange", js.Any.fromFunction1((t0: /* value */ ValueType) => value(t0).runNow()))
      
      inline def setOnAfterChangeUndefined: Self = StObject.set(x, "onAfterChange", js.undefined)
      
      inline def setOnBeforeChange(value: /* value */ ValueType => Callback): Self = StObject.set(x, "onBeforeChange", js.Any.fromFunction1((t0: /* value */ ValueType) => value(t0).runNow()))
      
      inline def setOnBeforeChangeUndefined: Self = StObject.set(x, "onBeforeChange", js.undefined)
      
      inline def setOnBlur(value: /* e */ ReactFocusEventFrom[HTMLDivElement] => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: /* e */ ReactFocusEventFrom[HTMLDivElement]) => value(t0).runNow()))
      
      inline def setOnBlurUndefined: Self = StObject.set(x, "onBlur", js.undefined)
      
      inline def setOnChange(value: /* value */ ValueType => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* value */ ValueType) => value(t0).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnFocus(value: /* e */ ReactFocusEventFrom[HTMLDivElement] => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: /* e */ ReactFocusEventFrom[HTMLDivElement]) => value(t0).runNow()))
  ...
  object SliderRef {
    ...
    inline def apply(blur: Callback, focus: Callback): SliderRef = {
