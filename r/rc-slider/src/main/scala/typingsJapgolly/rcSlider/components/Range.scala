...
import typingsJapgolly.rcSlider.mod.RangeProps
...
object Range {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RangeProps, typingsJapgolly.rcSlider.mod.Range, Unit, RangeProps] = {
  ...
  typingsJapgolly.rcSlider.mod.RangeProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.rcSlider.mod.Range](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rcSlider.mod.RangeProps])(children: _*)
  }
