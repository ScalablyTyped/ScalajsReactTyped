...
object RcSlider {
  ...
  implicit def make(companion: RcSlider.type): SharedBuilder_SliderPropsRefAttributes_2091559504[SliderRef] = new SharedBuilder_SliderPropsRefAttributes_2091559504[SliderRef](js.Array(this.component, js.Dictionary.empty))()
