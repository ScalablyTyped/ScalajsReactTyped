...
object RequireConfig {
  ...
  extension [Self <: RequireConfig](x: Self) {
    ...
    inline def setOnNodeCreated(
      value: (/* node */ HTMLScriptElement, RequireConfig, /* moduleName */ String, /* url */ String) => Callback
    ): Self = StObject.set(x, "onNodeCreated", js.Any.fromFunction4((t0: /* node */ HTMLScriptElement, t1: RequireConfig, t2: /* moduleName */ String, t3: /* url */ String) => (value(t0, t1, t2, t3)).runNow()))
