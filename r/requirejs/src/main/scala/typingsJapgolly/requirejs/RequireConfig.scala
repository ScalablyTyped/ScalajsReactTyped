...
object RequireConfig {
  ...
  def apply(
    ...
    onNodeCreated: (/* node */ HTMLScriptElement, /* config */ RequireConfig, /* moduleName */ String, /* url */ String) => Callback = null,
    ...
    if (!js.isUndefined(enforceDefine)) __obj.updateDynamic("enforceDefine")(enforceDefine.asInstanceOf[js.Any])
    if (map != null) __obj.updateDynamic("map")(map.asInstanceOf[js.Any])
    if (onNodeCreated != null) __obj.updateDynamic("onNodeCreated")(js.Any.fromFunction4((t0: /* node */ org.scalajs.dom.raw.HTMLScriptElement, t1: /* config */ typingsJapgolly.requirejs.RequireConfig, t2: /* moduleName */ java.lang.String, t3: /* url */ java.lang.String) => onNodeCreated(t0, t1, t2, t3).runNow()))
    ...
    if (!js.isUndefined(skipDataMain)) __obj.updateDynamic("skipDataMain")(skipDataMain.asInstanceOf[js.Any])
