...
object AriaModalProps {
  ...
  def apply(
    ...
    getApplicationNode: js.UndefOr[CallbackTo[Node | Element]] = js.undefined,
    includeDefaultStyles: js.UndefOr[Boolean] = js.undefined,
    initialFocus: String = null,
    mounted: js.UndefOr[Boolean] = js.undefined,
    onEnter: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    onExit: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    getApplicationNode.foreach(p => __obj.updateDynamic("getApplicationNode")(p.toJsFn))
