...
import typingsJapgolly.reactGa.reactGaStrings.beacon
import typingsJapgolly.reactGa.reactGaStrings.image
import typingsJapgolly.reactGa.reactGaStrings.xhr
...
object mod {
  ...
  @js.native
  open class OutboundLink_ protected ()
    extends Component[OutboundLinkProps & HTMLProps[HTMLAnchorElement], js.Object, Any] {
  ...
  @JSImport("react-ga", "OutboundLink")
  @js.native
  val OutboundLink_ : ComponentClassP[OutboundLinkProps & HTMLProps[HTMLAnchorElement] & js.Object] = js.native
