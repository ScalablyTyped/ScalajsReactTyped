...
object OutboundLink {
  ...
  inline def apply(eventLabel: String, to: String): Builder = {
    val __props = js.Dynamic.literal(eventLabel = eventLabel.asInstanceOf[js.Any], to = to.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[OutboundLinkProps & HTMLProps[HTMLAnchorElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[OutboundLink_] {
    ...
    inline def trackerNames(value: TrackerNames): this.type = set("trackerNames", value.asInstanceOf[js.Any])
    
    inline def trackerNamesVarargs(value: String*): this.type = set("trackerNames", js.Array(value*))
  ...
  def withProps(p: OutboundLinkProps & HTMLProps[HTMLAnchorElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
