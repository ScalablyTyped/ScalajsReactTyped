...
object OmitDateTimePickerPropsop {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[OmitDateTimePickerPropsop, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[OmitDateTimePickerPropsop, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.reactFlatpickr.OmitDateTimePickerPropsop, 
