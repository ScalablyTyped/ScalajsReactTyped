...
object SkipToMainContent {
  
  inline def apply(mainId: String): Builder = {
    val __props = js.Dynamic.literal(mainId = mainId.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[SkipToMainContentProps & RefAttributes[HTMLAnchorElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def unstyled(value: Boolean): this.type = set("unstyled", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: SkipToMainContentProps & RefAttributes[HTMLAnchorElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
