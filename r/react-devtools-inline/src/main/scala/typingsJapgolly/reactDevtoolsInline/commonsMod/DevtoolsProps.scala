...
object DevtoolsProps {
  ...
  extension [Self <: DevtoolsProps](x: Self) {
    ...
    inline def setHookNamesModuleLoaderFunction(value: CallbackTo[PromiseLike[ParseHookNamesModule]]): Self = StObject.set(x, "hookNamesModuleLoaderFunction", value.toJsFn)
    ...
    inline def setViewAttributeSourceFunction(value: (/* id */ Double, /* path */ js.Array[String | Double]) => Callback): Self = StObject.set(x, "viewAttributeSourceFunction", js.Any.fromFunction2((t0: /* id */ Double, t1: /* path */ js.Array[String | Double]) => (value(t0, t1)).runNow()))
    ...
    inline def setViewElementSourceFunction(value: (/* id */ Double, /* inspectedElement */ InspectedElement) => Callback): Self = StObject.set(x, "viewElementSourceFunction", js.Any.fromFunction2((t0: /* id */ Double, t1: /* inspectedElement */ InspectedElement) => (value(t0, t1)).runNow()))
