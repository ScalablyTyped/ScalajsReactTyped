...
object ReactRenderer {
  ...
  inline def apply(
    ...
    setRefreshHandler: AnyFn => Callback,
    version: String
  ): ReactRenderer = {
    val __obj = js.Dynamic.literal(bundleType = bundleType.asInstanceOf[js.Any], findFiberByHostInstance = js.Any.fromFunction1(findFiberByHostInstance), rendererPackageName = rendererPackageName.asInstanceOf[js.Any], setRefreshHandler = js.Any.fromFunction1((t0: AnyFn) => setRefreshHandler(t0).runNow()), version = version.asInstanceOf[js.Any])
  ...
  extension [Self <: ReactRenderer](x: Self) {
    ...
    inline def setGetCurrentFiber(value: CallbackTo[Fiber | Null]): Self = StObject.set(x, "getCurrentFiber", value.toJsFn)
    
    inline def setGetCurrentFiberUndefined: Self = StObject.set(x, "getCurrentFiber", js.undefined)
    
    inline def setGetLaneLabelMap(value: CallbackTo[(Map[Double, String]) | Null]): Self = StObject.set(x, "getLaneLabelMap", value.toJsFn)
    
    inline def setGetLaneLabelMapUndefined: Self = StObject.set(x, "getLaneLabelMap", js.undefined)
    
    inline def setInjectProfilingHooks(value: /* profilingHooks */ DevToolsProfilingHooks => Callback): Self = StObject.set(x, "injectProfilingHooks", js.Any.fromFunction1((t0: /* profilingHooks */ DevToolsProfilingHooks) => value(t0).runNow()))
    ...
    inline def setOverrideHookState(
      value: (/* fiber */ Record[String, Any], /* id */ Double, /* path */ js.Array[String | Double], /* value */ Any) => Callback
    ): Self = StObject.set(x, "overrideHookState", js.Any.fromFunction4((t0: /* fiber */ Record[String, Any], t1: /* id */ Double, t2: /* path */ js.Array[String | Double], t3: /* value */ Any) => (value(t0, t1, t2, t3)).runNow()))
    
    inline def setOverrideHookStateDeletePath(
      value: (/* fiber */ Record[String, Any], /* id */ Double, /* path */ js.Array[String | Double]) => Callback
    ): Self = StObject.set(x, "overrideHookStateDeletePath", js.Any.fromFunction3((t0: /* fiber */ Record[String, Any], t1: /* id */ Double, t2: /* path */ js.Array[String | Double]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setOverrideHookStateRenamePath(
      value: (/* fiber */ Record[String, Any], /* id */ Double, /* oldPath */ js.Array[String | Double], /* newPath */ js.Array[String | Double]) => Callback
    ): Self = StObject.set(x, "overrideHookStateRenamePath", js.Any.fromFunction4((t0: /* fiber */ Record[String, Any], t1: /* id */ Double, t2: /* oldPath */ js.Array[String | Double], t3: /* newPath */ js.Array[String | Double]) => (value(t0, t1, t2, t3)).runNow()))
    ...
    inline def setOverrideProps(
      value: (/* fiber */ Record[String, Any], /* path */ js.Array[String | Double], /* value */ Any) => Callback
    ): Self = StObject.set(x, "overrideProps", js.Any.fromFunction3((t0: /* fiber */ Record[String, Any], t1: /* path */ js.Array[String | Double], t2: /* value */ Any) => (value(t0, t1, t2)).runNow()))
    
    inline def setOverridePropsDeletePath(value: (/* fiber */ Record[String, Any], /* path */ js.Array[String | Double]) => Callback): Self = StObject.set(x, "overridePropsDeletePath", js.Any.fromFunction2((t0: /* fiber */ Record[String, Any], t1: /* path */ js.Array[String | Double]) => (value(t0, t1)).runNow()))
    ...
    inline def setOverridePropsRenamePath(
      value: (/* fiber */ Record[String, Any], /* oldPath */ js.Array[String | Double], /* newPath */ js.Array[String | Double]) => Callback
    ): Self = StObject.set(x, "overridePropsRenamePath", js.Any.fromFunction3((t0: /* fiber */ Record[String, Any], t1: /* oldPath */ js.Array[String | Double], t2: /* newPath */ js.Array[String | Double]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setScheduleUpdate(value: /* fiber */ Record[String, Any] => Callback): Self = StObject.set(x, "scheduleUpdate", js.Any.fromFunction1((t0: /* fiber */ Record[String, Any]) => value(t0).runNow()))
    ...
    inline def setSetErrorHandler(
      value: /* shouldError */ js.Function1[/* fiber */ Record[String, Any], js.UndefOr[Boolean | Null]] => Callback
    ): Self = StObject.set(x, "setErrorHandler", js.Any.fromFunction1((t0: /* shouldError */ js.Function1[/* fiber */ Record[String, Any], js.UndefOr[Boolean | Null]]) => value(t0).runNow()))
    ...
    inline def setSetRefreshHandler(value: AnyFn => Callback): Self = StObject.set(x, "setRefreshHandler", js.Any.fromFunction1((t0: AnyFn) => value(t0).runNow()))
    
    inline def setSetSuspenseHandler(value: /* shouldSuspend */ js.Function1[/* fiber */ Record[String, Any], Boolean] => Callback): Self = StObject.set(x, "setSuspenseHandler", js.Any.fromFunction1((t0: /* shouldSuspend */ js.Function1[/* fiber */ Record[String, Any], Boolean]) => value(t0).runNow()))
