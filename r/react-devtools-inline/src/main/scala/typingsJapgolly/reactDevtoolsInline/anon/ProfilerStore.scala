...
trait ProfilerStore extends StObject {
  ...
  var profilerStore: typingsJapgolly.reactDevtoolsInline.commonsMod.ProfilerStore
...
object ProfilerStore {
  ...
  inline def apply(
    commitIndex: Double,
    profilerStore: typingsJapgolly.reactDevtoolsInline.commonsMod.ProfilerStore,
    rootID: Double
  ): ProfilerStore = {
  ...
  extension [Self <: ProfilerStore](x: Self) {
    ...
    inline def setProfilerStore(value: typingsJapgolly.reactDevtoolsInline.commonsMod.ProfilerStore): Self = StObject.set(x, "profilerStore", value.asInstanceOf[js.Any])
