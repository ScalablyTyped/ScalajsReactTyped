...
object DateTimeSpinner {
  
  def apply(p: Any*): Default[js.Object] = new Default[js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @JSImport("rc-easyui", "DateTimeSpinner")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: DateTimeSpinner.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
