...
import typingsJapgolly.rcEasyui.anon.Invalid
...
open class FieldBase protected ()
  ...
  def componentDidMount_MFieldBase(): Unit = js.native
  
  @JSName("componentDidUpdate")
  def componentDidUpdate_MFieldBase(e: Any): Unit = js.native
  
  @JSName("componentWillUnmount")
  def componentWillUnmount_MFieldBase(): Unit = js.native
  
  def getFieldName(): Any = js.native
}
/* static members */
object FieldBase {
  ...
  @JSImport("rc-easyui", "FieldBase.defaultProps")
  @js.native
  def defaultProps: Invalid = js.native
  inline def defaultProps_=(x: Invalid): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
