...
open class Menu protected ()
  ...
  def alignTo(e: Any, args: Any*): Unit = js.native
  ...
  def containerStyle(): Any = js.native
  ...
  def show(e: Any, n: Any): Any = js.native
  
  def showAt(e: Any, args: Any*): Any = js.native
  
  def showContextMenu(e: Any, t: Any): Any = js.native
}
/* static members */
object Menu {
