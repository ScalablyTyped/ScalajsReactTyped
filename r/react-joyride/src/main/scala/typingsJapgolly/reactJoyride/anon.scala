...
object anon {
  ...
  object Arialabel {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(onClick = js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLElement]) => onClick(t0).runNow()), role = role.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any])
  ...
  object Ariamodal {
    ...
    inline def apply(`aria-modal`: Boolean, ref: HTMLElement | Null => Callback, role: String): Ariamodal = {
      val __obj = js.Dynamic.literal(ref = js.Any.fromFunction1((t0: HTMLElement | Null) => ref(t0).runNow()), role = role.asInstanceOf[js.Any])
