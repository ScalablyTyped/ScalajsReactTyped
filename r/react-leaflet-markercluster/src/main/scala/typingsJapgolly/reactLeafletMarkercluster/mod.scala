...
object mod extends Shortcut {
  ...
  object MarkerClusterGroupProps {
    ...
    extension [Self <: MarkerClusterGroupProps](x: Self) {
      ...
      inline def setChunkProgress(value: (/* processed */ Double, /* total */ Double, /* elapsed */ Double) => Callback): Self = StObject.set(x, "chunkProgress", js.Any.fromFunction3((t0: /* processed */ Double, t1: /* total */ Double, t2: /* elapsed */ Double) => (value(t0, t1, t2)).runNow()))
