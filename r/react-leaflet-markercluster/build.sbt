...
version := "2.0-dt-20181121Z-ca4f71"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "leaflet_dot_markercluster" % "1.4-dt-20191223Z-998fd3",
  "org.scalablytyped.japgolly" %%% "prop-types" % "15.7-dt-20190924Z-d18e40",
  "org.scalablytyped.japgolly" %%% "react" % "16.9-dt-20200227Z-a90427",
  "org.scalablytyped.japgolly" %%% "react-leaflet" % "2.5-dt-20200225Z-d3e4f7",
