package typingsJapgolly.riotGamesApi.RiotGamesAPI
...
object MatchList {
  ...
  object MatchList {
    ...
    inline def apply(endIndex: Double, matches: js.Array[MatchReference], startIndex: Double, totalGames: Double): typingsJapgolly.riotGamesApi.RiotGamesAPI.MatchList.MatchList = {
      ...
      __obj.asInstanceOf[typingsJapgolly.riotGamesApi.RiotGamesAPI.MatchList.MatchList]
    }
    
    extension [Self <: typingsJapgolly.riotGamesApi.RiotGamesAPI.MatchList.MatchList](x: Self) {
