...
object FeaturedGames {
  ...
  object FeaturedGames {
    ...
    inline def apply(clientRefreshInterval: Double, gameList: js.Array[FeaturedGameInfo]): typingsJapgolly.riotGamesApi.RiotGamesAPI.FeaturedGames.FeaturedGames = {
      ...
      __obj.asInstanceOf[typingsJapgolly.riotGamesApi.RiotGamesAPI.FeaturedGames.FeaturedGames]
    }
    
    extension [Self <: typingsJapgolly.riotGamesApi.RiotGamesAPI.FeaturedGames.FeaturedGames](x: Self) {
