...
/** NOTE: Conditional type definitions are impossible to translate to Scala.
  ...
  */
@js.native
trait ElementRef[C /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 219, starting with typingsJapgolly.rax.mod.ForwardRefExoticComponent[scala.Any], typingsJapgolly.rax.anon.Instantiable, js.Function2[
/ * props * / scala.Any, 
/ * context * / js.UndefOr[scala.Any], 
(typingsJapgolly.rax.mod.RaxElement[
  scala.Any, 
  java.lang.String | typingsJapgolly.rax.mod.JSXElementConstructor[scala.Any]
