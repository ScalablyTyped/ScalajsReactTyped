...
import typingsJapgolly.rax.mod.^
...
inline def Fragment: ExoticComponent[typingsJapgolly.rax.anon.Children] = ^.asInstanceOf[js.Dynamic].selectDynamic("Fragment").asInstanceOf[ExoticComponent[typingsJapgolly.rax.anon.Children]]
...
type PropsWithChildren[P] = P & typingsJapgolly.rax.anon.Children

type Provider[T] = ProviderExoticComponent[ProviderProps[T]]

type RaxChild = (RaxElement[Any, String | Any]) | RaxText

type RaxComponentElement[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 217, starting with typingsJapgolly.rax.raxStrings.a_, typingsJapgolly.rax.raxStrings.abbr, typingsJapgolly.rax.raxStrings.address */ Any */, P] = RaxElement[P, T]
