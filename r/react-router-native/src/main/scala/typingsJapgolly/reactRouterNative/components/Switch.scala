...
object Switch {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SwitchProps, typingsJapgolly.reactRouterNative.mod.Switch, Unit, SwitchProps] = {
  ...
  typingsJapgolly.reactRouterNative.mod.Switch](this.componentImport)
