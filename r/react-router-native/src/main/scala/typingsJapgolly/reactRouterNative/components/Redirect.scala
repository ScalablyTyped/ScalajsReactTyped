...
object Redirect {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RedirectProps, typingsJapgolly.reactRouterNative.mod.Redirect, Unit, RedirectProps] = {
  ...
  typingsJapgolly.reactRouterNative.mod.Redirect](this.componentImport)
