...
object Prompt {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PromptProps, typingsJapgolly.reactRouterNative.mod.Prompt, Unit, PromptProps] = {
  ...
  typingsJapgolly.reactRouterNative.mod.Prompt](this.componentImport)
