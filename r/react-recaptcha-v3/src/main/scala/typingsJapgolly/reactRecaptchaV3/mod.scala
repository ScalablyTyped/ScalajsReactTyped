package typingsJapgolly.reactRecaptchaV3
  ...
  object ReCaptcha {
    ...
    object ReCaptchaProps {
      ...
      extension [Self <: ReCaptchaProps](x: Self) {
        ...
        inline def setVerifyCallback(value: /* response */ String => Callback): Self = StObject.set(x, "verifyCallback", js.Any.fromFunction1((t0: /* response */ String) => value(t0).runNow()))
