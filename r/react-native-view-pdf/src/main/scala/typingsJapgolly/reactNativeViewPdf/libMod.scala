...
object libMod {
  ...
  object PDFViewProps {
    ...
    extension [Self <: PDFViewProps](x: Self) {
      ...
      inline def setOnError(value: /* error */ Message => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* error */ Message) => value(t0).runNow()))
      ...
      inline def setOnPageChanged(value: (/* page */ Double, /* pageCount */ Double) => Callback): Self = StObject.set(x, "onPageChanged", js.Any.fromFunction2((t0: /* page */ Double, t1: /* pageCount */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnPageChangedUndefined: Self = StObject.set(x, "onPageChanged", js.undefined)
      
      inline def setOnScrolled(value: /* offset */ Double => Callback): Self = StObject.set(x, "onScrolled", js.Any.fromFunction1((t0: /* offset */ Double) => value(t0).runNow()))
