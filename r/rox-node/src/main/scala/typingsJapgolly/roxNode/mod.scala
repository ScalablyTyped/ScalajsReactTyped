...
object mod {
  ...
  object RoxErrorTrigger extends StObject {
    ...
    /* "CONFIGURATION_FETCHED_HANDLER" */ val CONFIGURATION_FETCHED_HANDLER: typingsJapgolly.roxNode.mod.RoxErrorTrigger.CONFIGURATION_FETCHED_HANDLER & String = js.native
    
    @js.native
    sealed trait CUSTOM_PROPERTY_GENERATOR
      extends StObject
         with RoxErrorTrigger
    /* "CUSTOM_PROPERTY_GENERATOR" */ val CUSTOM_PROPERTY_GENERATOR: typingsJapgolly.roxNode.mod.RoxErrorTrigger.CUSTOM_PROPERTY_GENERATOR & String = js.native
    
    @js.native
    sealed trait DYNAMIC_PROPERTIES_RULE
      extends StObject
         with RoxErrorTrigger
    /* "DYNAMIC_PROPERTIES_RULE" */ val DYNAMIC_PROPERTIES_RULE: typingsJapgolly.roxNode.mod.RoxErrorTrigger.DYNAMIC_PROPERTIES_RULE & String = js.native
    
    @js.native
    sealed trait IMPRESSION_HANDLER
      extends StObject
         with RoxErrorTrigger
    /* "IMPRESSION_HANDLER" */ val IMPRESSION_HANDLER: typingsJapgolly.roxNode.mod.RoxErrorTrigger.IMPRESSION_HANDLER & String = js.native
  }
  ...
  object RoxFetcherStatus extends StObject {
    ...
    /* "APPLIED_FROM_CACHE" */ val AppliedFromCache: typingsJapgolly.roxNode.mod.RoxFetcherStatus.AppliedFromCache & String = js.native
    
    @js.native
    sealed trait AppliedFromEmbedded
      extends StObject
         with RoxFetcherStatus
    /* "APPLIED_FROM_EMBEDDED" */ val AppliedFromEmbedded: typingsJapgolly.roxNode.mod.RoxFetcherStatus.AppliedFromEmbedded & String = js.native
    
    @js.native
    sealed trait AppliedFromNetwork
      extends StObject
         with RoxFetcherStatus
    /* "APPLIED_FROM_NETWORK" */ val AppliedFromNetwork: typingsJapgolly.roxNode.mod.RoxFetcherStatus.AppliedFromNetwork & String = js.native
    
    @js.native
    sealed trait ErrorFetchFailed
      extends StObject
         with RoxFetcherStatus
    /* "ERROR_FETCH_FAILED" */ val ErrorFetchFailed: typingsJapgolly.roxNode.mod.RoxFetcherStatus.ErrorFetchFailed & String = js.native
  }
