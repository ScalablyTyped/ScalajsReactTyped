package typingsJapgolly.reactNativeFirebaseApp

import typingsJapgolly.reactNativeFirebaseApp.mod.ReactNativeFirebase.FirebaseApp
...
object anon {
  ...
  trait FirebaseModuleWithStatics extends StObject {
    ...
    var FilePath: typingsJapgolly.reactNativeFirebaseApp.mod.Utils_.FilePath = js.native
