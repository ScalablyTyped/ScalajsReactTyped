...
import typingsJapgolly.reactNativeFirebaseApp.anon.Call
import typingsJapgolly.reactNativeFirebaseApp.anon.SDKVERSION
...
object ReactNativeFirebase {
  ...
  trait FirebaseApp extends StObject {
    ...
    def utils(): typingsJapgolly.reactNativeFirebaseApp.mod.Utils_.Module
  }
  object FirebaseApp {
    ...
    inline def apply(
      ...
      utils: CallbackTo[typingsJapgolly.reactNativeFirebaseApp.mod.Utils_.Module]
    ): FirebaseApp = {
      val __obj = js.Dynamic.literal(delete = delete.toJsFn, name = name.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], utils = utils.toJsFn)
    ...
    extension [Self <: FirebaseApp](x: Self) {
      ...
      inline def setUtils(value: CallbackTo[typingsJapgolly.reactNativeFirebaseApp.mod.Utils_.Module]): Self = StObject.set(x, "utils", value.toJsFn)
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.debug
    - typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.verbose
    - typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.info
    - typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.warn
    - typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.error
    - typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.silent
  */
  trait LogLevelString extends StObject
  object LogLevelString {
    
    inline def debug: typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.debug = "debug".asInstanceOf[typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.debug]
    
    inline def error: typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.error = "error".asInstanceOf[typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.error]
    
    inline def info: typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.info = "info".asInstanceOf[typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.info]
    
    inline def silent: typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.silent = "silent".asInstanceOf[typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.silent]
    
    inline def verbose: typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.verbose = "verbose".asInstanceOf[typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.verbose]
    
    inline def warn: typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.warn = "warn".asInstanceOf[typingsJapgolly.reactNativeFirebaseApp.reactNativeFirebaseAppStrings.warn]
  }
  ...
  trait Module extends StObject {
    ...
    /**
      ...
      */
    var utils: typingsJapgolly.reactNativeFirebaseApp.anon.FirebaseModuleWithStatics = js.native
  }
