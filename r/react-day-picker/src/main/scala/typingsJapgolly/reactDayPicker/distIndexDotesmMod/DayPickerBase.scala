...
import typingsJapgolly.reactDayPicker.anon.PartialFormattersFormatCaption
import typingsJapgolly.reactDayPicker.anon.PartialLabelsLabelDay
...
trait DayPickerBase extends StObject {
  ...
  /**
    ...
    * functions.
    */
  var formatters: js.UndefOr[PartialFormattersFormatCaption] = js.undefined
  ...
  /**
    ...
    */
  var labels: js.UndefOr[PartialLabelsLabelDay] = js.undefined
...
object DayPickerBase {
  ...
  extension [Self <: DayPickerBase](x: Self) {
    ...
    inline def setFormatters(value: PartialFormattersFormatCaption): Self = StObject.set(x, "formatters", value.asInstanceOf[js.Any])
    ...
    inline def setLabels(value: PartialLabelsLabelDay): Self = StObject.set(x, "labels", value.asInstanceOf[js.Any])
    ...
    ): Self = StObject.set(x, "onDayBlur", js.Any.fromFunction3((t0: /* day */ js.Date, t1: /* activeModifiers */ ActiveModifiers, t2: /* e */ ReactFocusEventFrom[org.scalajs.dom.Element] | ReactKeyboardEventFrom[org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
    ...
    ): Self = StObject.set(x, "onDayClick", js.Any.fromFunction3((t0: /* day */ js.Date, t1: /* activeModifiers */ ActiveModifiers, t2: /* e */ ReactMouseEventFrom[org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnDayClickUndefined: Self = StObject.set(x, "onDayClick", js.undefined)
    
    inline def setOnDayFocus(
      value: (/* day */ js.Date, /* activeModifiers */ ActiveModifiers, /* e */ ReactFocusEventFrom[org.scalajs.dom.Element] | ReactKeyboardEventFrom[org.scalajs.dom.Element]) => Callback
    ): Self = StObject.set(x, "onDayFocus", js.Any.fromFunction3((t0: /* day */ js.Date, t1: /* activeModifiers */ ActiveModifiers, t2: /* e */ ReactFocusEventFrom[org.scalajs.dom.Element] | ReactKeyboardEventFrom[org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
    ...
    ): Self = StObject.set(x, "onDayKeyDown", js.Any.fromFunction3((t0: /* day */ js.Date, t1: /* activeModifiers */ ActiveModifiers, t2: /* e */ ReactKeyboardEventFrom[org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnDayKeyDownUndefined: Self = StObject.set(x, "onDayKeyDown", js.undefined)
    
    inline def setOnDayKeyPress(
      value: (/* day */ js.Date, /* activeModifiers */ ActiveModifiers, /* e */ ReactKeyboardEventFrom[org.scalajs.dom.Element]) => Callback
    ): Self = StObject.set(x, "onDayKeyPress", js.Any.fromFunction3((t0: /* day */ js.Date, t1: /* activeModifiers */ ActiveModifiers, t2: /* e */ ReactKeyboardEventFrom[org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnDayKeyPressUndefined: Self = StObject.set(x, "onDayKeyPress", js.undefined)
    
    inline def setOnDayKeyUp(
      value: (/* day */ js.Date, /* activeModifiers */ ActiveModifiers, /* e */ ReactKeyboardEventFrom[org.scalajs.dom.Element]) => Callback
    ): Self = StObject.set(x, "onDayKeyUp", js.Any.fromFunction3((t0: /* day */ js.Date, t1: /* activeModifiers */ ActiveModifiers, t2: /* e */ ReactKeyboardEventFrom[org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnDayKeyUpUndefined: Self = StObject.set(x, "onDayKeyUp", js.undefined)
    
    inline def setOnDayMouseEnter(
      value: (/* day */ js.Date, /* activeModifiers */ ActiveModifiers, /* e */ ReactMouseEventFrom[org.scalajs.dom.Element]) => Callback
    ): Self = StObject.set(x, "onDayMouseEnter", js.Any.fromFunction3((t0: /* day */ js.Date, t1: /* activeModifiers */ ActiveModifiers, t2: /* e */ ReactMouseEventFrom[org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnDayMouseEnterUndefined: Self = StObject.set(x, "onDayMouseEnter", js.undefined)
    
    inline def setOnDayMouseLeave(
      value: (/* day */ js.Date, /* activeModifiers */ ActiveModifiers, /* e */ ReactMouseEventFrom[org.scalajs.dom.Element]) => Callback
    ): Self = StObject.set(x, "onDayMouseLeave", js.Any.fromFunction3((t0: /* day */ js.Date, t1: /* activeModifiers */ ActiveModifiers, t2: /* e */ ReactMouseEventFrom[org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
    ...
    ): Self = StObject.set(x, "onDayTouchCancel", js.Any.fromFunction3((t0: /* day */ js.Date, t1: /* activeModifiers */ ActiveModifiers, t2: /* e */ ReactTouchEventFrom[org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnDayTouchCancelUndefined: Self = StObject.set(x, "onDayTouchCancel", js.undefined)
    
    inline def setOnDayTouchEnd(
      value: (/* day */ js.Date, /* activeModifiers */ ActiveModifiers, /* e */ ReactTouchEventFrom[org.scalajs.dom.Element]) => Callback
    ): Self = StObject.set(x, "onDayTouchEnd", js.Any.fromFunction3((t0: /* day */ js.Date, t1: /* activeModifiers */ ActiveModifiers, t2: /* e */ ReactTouchEventFrom[org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnDayTouchEndUndefined: Self = StObject.set(x, "onDayTouchEnd", js.undefined)
    
    inline def setOnDayTouchMove(
      value: (/* day */ js.Date, /* activeModifiers */ ActiveModifiers, /* e */ ReactTouchEventFrom[org.scalajs.dom.Element]) => Callback
    ): Self = StObject.set(x, "onDayTouchMove", js.Any.fromFunction3((t0: /* day */ js.Date, t1: /* activeModifiers */ ActiveModifiers, t2: /* e */ ReactTouchEventFrom[org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnDayTouchMoveUndefined: Self = StObject.set(x, "onDayTouchMove", js.undefined)
    
    inline def setOnDayTouchStart(
      value: (/* day */ js.Date, /* activeModifiers */ ActiveModifiers, /* e */ ReactTouchEventFrom[org.scalajs.dom.Element]) => Callback
    ): Self = StObject.set(x, "onDayTouchStart", js.Any.fromFunction3((t0: /* day */ js.Date, t1: /* activeModifiers */ ActiveModifiers, t2: /* e */ ReactTouchEventFrom[org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setOnNextClick(value: /* month */ js.Date => Callback): Self = StObject.set(x, "onNextClick", js.Any.fromFunction1((t0: /* month */ js.Date) => value(t0).runNow()))
    
    inline def setOnNextClickUndefined: Self = StObject.set(x, "onNextClick", js.undefined)
    
    inline def setOnPrevClick(value: /* month */ js.Date => Callback): Self = StObject.set(x, "onPrevClick", js.Any.fromFunction1((t0: /* month */ js.Date) => value(t0).runNow()))
    ...
    ): Self = StObject.set(x, "onWeekNumberClick", js.Any.fromFunction3((t0: /* weekNumber */ Double, t1: /* dates */ js.Array[js.Date], t2: /* e */ ReactMouseEventFrom[org.scalajs.dom.Element]) => (value(t0, t1, t2)).runNow()))
