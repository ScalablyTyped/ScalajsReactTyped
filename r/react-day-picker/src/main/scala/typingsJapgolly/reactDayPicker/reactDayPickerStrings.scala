...
import typingsJapgolly.reactDayPicker.mod.DaySelectionMode
import typingsJapgolly.reactDayPicker.mod.EventName
import typingsJapgolly.reactDayPicker.mod.InternalModifiersElement
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object reactDayPickerStrings {
  
  @js.native
  sealed trait default
    extends StObject
       with DaySelectionMode
       with typingsJapgolly.reactDayPicker.distIndexDotesmMod.DaySelectionMode
  ...
  sealed trait buttons
    extends StObject
       with CaptionLayout
       with typingsJapgolly.reactDayPicker.distIndexDotesmMod.CaptionLayout
  ...
  sealed trait day_disabled
    extends StObject
       ...
       with typingsJapgolly.reactDayPicker.distIndexDotesmMod.InternalModifiersElement
  ...
  sealed trait onBlur
    extends StObject
       with EventName
       with typingsJapgolly.reactDayPicker.distIndexDotesmMod.EventName
