...
object HeadRow {
  ...
  @JSImport("react-day-picker", "HeadRow")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: HeadRow.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
