...
import typingsJapgolly.reactDayPicker.mod.RootContext
...
object RootProvider {
  ...
  @JSImport("react-day-picker", "RootProvider")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def selected(value: Matcher | js.Array[Matcher]): this.type = set("selected", value.asInstanceOf[js.Any])
    
    inline def selectedFunction1(value: /* date */ js.Date => Boolean): this.type = set("selected", js.Any.fromFunction1(value))
    
    inline def selectedVarargs(value: (js.Date | Matcher)*): this.type = set("selected", js.Array(value*))
  ...
  implicit def make(companion: RootProvider.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RootContext): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
