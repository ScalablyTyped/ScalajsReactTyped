...
trait DayPickerProps extends js.Object {
  ...
  var captionElement: js.UndefOr[
    Element | (ComponentClassP[CaptionElementProps with js.Object]) | SFC[CaptionElementProps]
  ] = js.undefined
  ...
  var navbarElement: js.UndefOr[
    Element | (ComponentClassP[NavbarElementProps with js.Object]) | SFC[NavbarElementProps]
  ] = js.undefined
  ...
  var onCaptionClick: js.UndefOr[
    js.Function2[/* month */ js.Date, /* e */ ReactMouseEventFrom[HTMLDivElement], Unit]
  ] = js.undefined
  var onDayClick: js.UndefOr[
    js.Function3[
      /* day */ js.Date, 
      /* modifiers */ DayModifiers, 
      /* e */ ReactMouseEventFrom[HTMLDivElement], 
      Unit
    ]
  ] = js.undefined
  var onDayKeyDown: js.UndefOr[
    js.Function3[
      /* day */ js.Date, 
      /* modifiers */ DayModifiers, 
      /* e */ ReactKeyboardEventFrom[HTMLDivElement], 
      Unit
    ]
  ] = js.undefined
  ...
  var onDayTouchEnd: js.UndefOr[
    js.Function3[
      /* day */ js.Date, 
      /* modifiers */ DayModifiers, 
      /* e */ ReactTouchEventFrom[HTMLDivElement], 
      Unit
    ]
  ] = js.undefined
  ...
  var onTodayButtonClick: js.UndefOr[
    js.Function3[
      /* day */ js.Date, 
      /* modifiers */ DayModifiers, 
      /* e */ ReactMouseEventFrom[HTMLButtonElement], 
      Unit
    ]
  ] = js.undefined
  ...
  var renderDay: js.UndefOr[js.Function2[/* date */ js.Date, /* modifiers */ DayModifiers, Node]] = js.undefined
  var renderWeek: js.UndefOr[
    js.Function3[/* weekNumber */ Double, /* week */ js.Array[js.Date], /* month */ js.Date, Node]
  ] = js.undefined
  ...
  var weekdayElement: js.UndefOr[
    Element | (ComponentClassP[WeekdayElementProps with js.Object]) | SFC[WeekdayElementProps]
  ] = js.undefined
