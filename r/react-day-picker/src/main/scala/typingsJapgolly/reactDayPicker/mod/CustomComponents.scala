...
object CustomComponents {
  ...
  extension [Self <: CustomComponents](x: Self) {
    ...
    inline def setFooter(value: CallbackTo[Element | Null]): Self = StObject.set(x, "Footer", value.toJsFn)
    
    inline def setFooterUndefined: Self = StObject.set(x, "Footer", js.undefined)
    
    inline def setHead(value: CallbackTo[Element | Null]): Self = StObject.set(x, "Head", value.toJsFn)
    
    inline def setHeadRow(value: CallbackTo[Element | Null]): Self = StObject.set(x, "HeadRow", value.toJsFn)
