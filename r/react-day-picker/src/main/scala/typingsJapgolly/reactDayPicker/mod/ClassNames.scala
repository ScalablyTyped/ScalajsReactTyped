...
/* Inlined std.Partial<react-day-picker.react-day-picker.StyledElement<string>> */
trait ClassNames extends StObject {
  
  var button: js.UndefOr[String] = js.undefined
  
  var button_reset: js.UndefOr[String] = js.undefined
  
  var caption: js.UndefOr[String] = js.undefined
  
  var caption_between: js.UndefOr[String] = js.undefined
  
  var caption_dropdowns: js.UndefOr[String] = js.undefined
  
  var caption_end: js.UndefOr[String] = js.undefined
  
  var caption_label: js.UndefOr[String] = js.undefined
  
  var caption_start: js.UndefOr[String] = js.undefined
  
  var cell: js.UndefOr[String] = js.undefined
  
  var day: js.UndefOr[String] = js.undefined
  
  var day_disabled: js.UndefOr[String] = js.undefined
  
  var day_hidden: js.UndefOr[String] = js.undefined
  
  var day_outside: js.UndefOr[String] = js.undefined
  
  var day_range_end: js.UndefOr[String] = js.undefined
  
  var day_range_middle: js.UndefOr[String] = js.undefined
  
  var day_range_start: js.UndefOr[String] = js.undefined
  
  var day_selected: js.UndefOr[String] = js.undefined
  
  var day_today: js.UndefOr[String] = js.undefined
  
  var dropdown: js.UndefOr[String] = js.undefined
  
  var dropdown_icon: js.UndefOr[String] = js.undefined
  
  var dropdown_month: js.UndefOr[String] = js.undefined
  
  var dropdown_year: js.UndefOr[String] = js.undefined
  
  var head: js.UndefOr[String] = js.undefined
  
  var head_cell: js.UndefOr[String] = js.undefined
  
  var head_row: js.UndefOr[String] = js.undefined
  
  var month: js.UndefOr[String] = js.undefined
  
  var months: js.UndefOr[String] = js.undefined
  
  var multiple_months: js.UndefOr[String] = js.undefined
  
  var nav: js.UndefOr[String] = js.undefined
  
  var nav_button: js.UndefOr[String] = js.undefined
  
  var nav_button_next: js.UndefOr[String] = js.undefined
  
  var nav_button_previous: js.UndefOr[String] = js.undefined
  
  var nav_icon: js.UndefOr[String] = js.undefined
  ...
  var tbody: js.UndefOr[String] = js.undefined
  
  var tfoot: js.UndefOr[String] = js.undefined
  
  var vhidden: js.UndefOr[String] = js.undefined
  
  var weeknumber: js.UndefOr[String] = js.undefined
  
  var with_weeknumber: js.UndefOr[String] = js.undefined
}
object ClassNames {
