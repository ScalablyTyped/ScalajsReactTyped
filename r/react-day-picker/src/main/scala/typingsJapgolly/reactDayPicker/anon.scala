...
import typingsJapgolly.reactDayPicker.mod.DateFormatter
import typingsJapgolly.reactDayPicker.mod.DayLabel
import typingsJapgolly.reactDayPicker.mod.NavButtonLabel
import typingsJapgolly.reactDayPicker.mod.WeekNumberFormatter
import typingsJapgolly.reactDayPicker.mod.WeekNumberLabel
import typingsJapgolly.reactDayPicker.mod.WeekdayLabel
...
object anon {
  ...
  object PartialFormatters {
    ...
    extension [Self <: PartialFormatters](x: Self) {
      ...
      inline def setFormatCaption(value: (/* date */ js.Date, /* options */ js.UndefOr[Locale]) => Node): Self = StObject.set(x, "formatCaption", js.Any.fromFunction2(value))
      
      inline def setFormatCaptionUndefined: Self = StObject.set(x, "formatCaption", js.undefined)
      
      inline def setFormatDay(value: (/* date */ js.Date, /* options */ js.UndefOr[Locale]) => Node): Self = StObject.set(x, "formatDay", js.Any.fromFunction2(value))
      
      inline def setFormatDayUndefined: Self = StObject.set(x, "formatDay", js.undefined)
      
      inline def setFormatMonthCaption(value: (/* date */ js.Date, /* options */ js.UndefOr[Locale]) => Node): Self = StObject.set(x, "formatMonthCaption", js.Any.fromFunction2(value))
      
      inline def setFormatMonthCaptionUndefined: Self = StObject.set(x, "formatMonthCaption", js.undefined)
      
      inline def setFormatWeekNumber(value: (/* weekNumber */ Double, /* options */ js.UndefOr[Locale]) => Node): Self = StObject.set(x, "formatWeekNumber", js.Any.fromFunction2(value))
      
      inline def setFormatWeekNumberUndefined: Self = StObject.set(x, "formatWeekNumber", js.undefined)
      
      inline def setFormatWeekdayName(value: (/* date */ js.Date, /* options */ js.UndefOr[Locale]) => Node): Self = StObject.set(x, "formatWeekdayName", js.Any.fromFunction2(value))
      
      inline def setFormatWeekdayNameUndefined: Self = StObject.set(x, "formatWeekdayName", js.undefined)
      
      inline def setFormatYearCaption(value: (/* date */ js.Date, /* options */ js.UndefOr[Locale]) => Node): Self = StObject.set(x, "formatYearCaption", js.Any.fromFunction2(value))
  ...
  trait PartialFormattersFormatCaption extends StObject {
    ...
    var formatCaption: js.UndefOr[typingsJapgolly.reactDayPicker.distIndexDotesmMod.DateFormatter] = js.undefined
    
    var formatDay: js.UndefOr[typingsJapgolly.reactDayPicker.distIndexDotesmMod.DateFormatter] = js.undefined
    
    var formatMonthCaption: js.UndefOr[typingsJapgolly.reactDayPicker.distIndexDotesmMod.DateFormatter] = js.undefined
    
    var formatWeekNumber: js.UndefOr[typingsJapgolly.reactDayPicker.distIndexDotesmMod.WeekNumberFormatter] = js.undefined
    
    var formatWeekdayName: js.UndefOr[typingsJapgolly.reactDayPicker.distIndexDotesmMod.DateFormatter] = js.undefined
    
    var formatYearCaption: js.UndefOr[typingsJapgolly.reactDayPicker.distIndexDotesmMod.DateFormatter] = js.undefined
  }
  ...
  trait PartialLabelsLabelDay extends StObject {
    ...
    var labelDay: js.UndefOr[typingsJapgolly.reactDayPicker.distIndexDotesmMod.DayLabel] = js.undefined
    
    var labelMonthDropdown: js.UndefOr[js.Function0[String]] = js.undefined
    
    var labelNext: js.UndefOr[typingsJapgolly.reactDayPicker.distIndexDotesmMod.NavButtonLabel] = js.undefined
    
    var labelPrevious: js.UndefOr[typingsJapgolly.reactDayPicker.distIndexDotesmMod.NavButtonLabel] = js.undefined
    
    var labelWeekNumber: js.UndefOr[typingsJapgolly.reactDayPicker.distIndexDotesmMod.WeekNumberLabel] = js.undefined
    
    var labelWeekday: js.UndefOr[typingsJapgolly.reactDayPicker.distIndexDotesmMod.WeekdayLabel] = js.undefined
  ...
  object PartialLabelsLabelDay {
    ...
    extension [Self <: PartialLabelsLabelDay](x: Self) {
      ...
      inline def setLabelDay(
        value: (/* day */ js.Date, /* activeModifiers */ typingsJapgolly.reactDayPicker.distIndexDotesmMod.ActiveModifiers, /* options */ js.UndefOr[Locale]) => String
      ): Self = StObject.set(x, "labelDay", js.Any.fromFunction3(value))
