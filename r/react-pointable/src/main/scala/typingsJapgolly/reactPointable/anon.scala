package typingsJapgolly.reactPointable
...
import typingsJapgolly.reactPointable.reactPointableStrings.auto
import typingsJapgolly.reactPointable.reactPointableStrings.div
...
object anon {
  ...
  object TagName {
    ...
    inline def apply(): TagName = {
      val __obj = js.Dynamic.literal(tagName = "div", touchAction = "auto")
      __obj.asInstanceOf[TagName]
    }
    
    extension [Self <: TagName](x: Self) {
      
      inline def setTagName(value: div): Self = StObject.set(x, "tagName", value.asInstanceOf[js.Any])
      
      inline def setTouchAction(value: auto): Self = StObject.set(x, "touchAction", value.asInstanceOf[js.Any])
    }
  }
}
