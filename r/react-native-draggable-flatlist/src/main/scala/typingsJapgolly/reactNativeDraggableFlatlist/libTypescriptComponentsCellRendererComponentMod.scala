...
object libTypescriptComponentsCellRendererComponentMod {
  
  @JSImport("react-native-draggable-flatlist/lib/typescript/components/CellRendererComponent", JSImport.Namespace)
  @js.native
