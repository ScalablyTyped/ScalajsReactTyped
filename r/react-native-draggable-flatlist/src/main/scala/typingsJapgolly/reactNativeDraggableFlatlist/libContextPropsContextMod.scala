...
object libContextPropsContextMod {
  ...
  object Props {
    ...
    inline def apply[T](
      ...
      val __obj = js.Dynamic.literal(animationConfig = animationConfig.asInstanceOf[js.Any], children = children.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any], keyExtractor = js.Any.fromFunction2(keyExtractor), outerScrollOffset = outerScrollOffset.asInstanceOf[js.Any], renderItem = js.Any.fromFunction1(renderItem))
