...
import typingsJapgolly.reactNative.mod.VirtualizedListWithoutRenderItemProps
...
trait DraggableFlatListProps[Item] extends VirtualizedListWithoutRenderItemProps[Item] {
  ...
  /**
    ...
    */
  def renderItem(info: RenderItemInfo[Item]): Element | Null
}
...
object DraggableFlatListProps {
  ...
  def apply[Item](
    ...
    indicatorStyle: typingsJapgolly.reactNative.reactNativeStrings.default | black | white = null,
