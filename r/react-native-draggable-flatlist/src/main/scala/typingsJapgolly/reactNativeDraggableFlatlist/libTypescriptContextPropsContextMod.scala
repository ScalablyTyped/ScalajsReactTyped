...
import typingsJapgolly.reactNativeDraggableFlatlist.libTypescriptTypesMod.DragEndParams
...
import typingsJapgolly.reactNativeDraggableFlatlist.libTypescriptTypesMod.RenderPlaceholder
...
object libTypescriptContextPropsContextMod {
  ...
  trait Props[T] extends StObject {
    ...
    var ListEmptyComponent: js.UndefOr[ComponentType[Any] | japgolly.scalajs.react.facade.React.Element | Null] = js.undefined
    
    var ListFooterComponent: js.UndefOr[ComponentType[Any] | japgolly.scalajs.react.facade.React.Element | Null] = js.undefined
    
    var ListFooterComponentStyle: js.UndefOr[StyleProp[ViewStyle]] = js.undefined
    
    var ListHeaderComponent: js.UndefOr[ComponentType[Any] | japgolly.scalajs.react.facade.React.Element | Null] = js.undefined
  ...
  object Props {
    ...
    inline def apply[T](
      ...
      val __obj = js.Dynamic.literal(animationConfig = animationConfig.asInstanceOf[js.Any], children = children.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any], keyExtractor = js.Any.fromFunction2(keyExtractor), renderItem = js.Any.fromFunction1(renderItem))
