...
object libTypesMod {
  ...
  object DefaultProps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(activationDistance = activationDistance.asInstanceOf[js.Any], animationConfig = animationConfig.asInstanceOf[js.Any], autoscrollSpeed = autoscrollSpeed.asInstanceOf[js.Any], autoscrollThreshold = autoscrollThreshold.asInstanceOf[js.Any], dragItemOverflow = dragItemOverflow.asInstanceOf[js.Any], outerScrollOffset = outerScrollOffset.asInstanceOf[js.Any], scrollEnabled = scrollEnabled.asInstanceOf[js.Any])
  ...
  /* Inlined react-native-draggable-flatlist.react-native-draggable-flatlist/lib/types.Modify<react-native.react-native.FlatListProps<T>, {  data :std.Array<T>,   activationDistance :number | undefined,   animationConfig :std.Partial<react-native-reanimated.react-native-reanimated.default.SpringConfig> | undefined,   autoscrollSpeed :number | undefined,   autoscrollThreshold :number | undefined,   containerStyle :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   debug :boolean | undefined,   dragItemOverflow :boolean | undefined, keyExtractor (item : T, index : number): string,   onDragBegin :(index : number): void | undefined,   onDragEnd :(params : react-native-draggable-flatlist.react-native-draggable-flatlist/lib/types.DragEndParams<T>): void | undefined,   onPlaceholderIndexChange :(placeholderIndex : number): void | undefined,   onRelease :(index : number): void | undefined,   onScrollOffsetChange :(scrollOffset : number): void | undefined,   renderItem :react-native-draggable-flatlist.react-native-draggable-flatlist/lib/types.RenderItem<T>,   renderPlaceholder :react-native-draggable-flatlist.react-native-draggable-flatlist/lib/types.RenderPlaceholder<T> | undefined,   simultaneousHandlers :react.react.Ref<any> | std.Array<react.react.Ref<any>> | undefined,   outerScrollOffset :std.Node | undefined,   onAnimValInit :(animVals : std.ReturnType<(): {  activationDistance :react-native-reanimated.react-native-reanimated.default.Value,   activeCellOffset :react-native-reanimated.react-native-reanimated.default.Value,   activeCellSize :react-native-reanimated.react-native-reanimated.default.Value,   activeIndexAnim :react-native-reanimated.react-native-reanimated.default.Value,   containerSize :react-native-reanimated.react-native-reanimated.default.Value,   disabled :react-native-reanimated.react-native-reanimated.default.Value,   horizontalAnim :react-native-reanimated.react-native-reanimated.default.Value,   hoverAnim :std.Node,   hoverAnimConstrained :std.Node,   hoverAnimUnconstrained :std.Node,   hoverOffset :std.Node,   isDraggingCell :std.Node,   isTouchActiveNative :react-native-reanimated.react-native-reanimated.default.Value,   panGestureState :react-native-reanimated.react-native-reanimated.default.Value,   placeholderOffset :react-native-reanimated.react-native-reanimated.default.Value,   resetTouchedCell :std.Node,   scrollOffset :react-native-reanimated.react-native-reanimated.default.Value,   scrollViewSize :react-native-reanimated.react-native-reanimated.default.Value,   spacerIndexAnim :react-native-reanimated.react-native-reanimated.default.Value,   touchAbsolute :react-native-reanimated.react-native-reanimated.default.Value,   touchCellOffset :std.Node,   touchInit :react-native-reanimated.react-native-reanimated.default.Value}>): void | undefined} & std.Partial<react-native-draggable-flatlist.react-native-draggable-flatlist/lib/types.DefaultProps>> */
  trait DraggableFlatListProps[T] extends StObject {
    ...
    var outerScrollOffset: js.UndefOr[org.scalajs.dom.Node] & js.UndefOr[Value]
  ...
  object DraggableFlatListProps {
    ...
    inline def apply[T](
      ...
      outerScrollOffset: js.UndefOr[org.scalajs.dom.Node] & js.UndefOr[Value],
    ...
    extension [Self <: DraggableFlatListProps[?], T](x: Self & DraggableFlatListProps[T]) {
      ...
      inline def setOnAnimValInit(value: /* animVals */ ReturnType[js.Function0[ActivationDistance]] => Callback): Self = StObject.set(x, "onAnimValInit", js.Any.fromFunction1((t0: /* animVals */ ReturnType[js.Function0[ActivationDistance]]) => value(t0).runNow()))
      ...
      inline def setOuterScrollOffset(value: js.UndefOr[org.scalajs.dom.Node] & js.UndefOr[Value]): Self = StObject.set(x, "outerScrollOffset", value.asInstanceOf[js.Any])
  ...
  object RenderItemParams {
    ...
    inline def apply[T](drag: Callback, isActive: Boolean, item: T): RenderItemParams[T] = {
      val __obj = js.Dynamic.literal(drag = drag.toJsFn, isActive = isActive.asInstanceOf[js.Any], item = item.asInstanceOf[js.Any])
