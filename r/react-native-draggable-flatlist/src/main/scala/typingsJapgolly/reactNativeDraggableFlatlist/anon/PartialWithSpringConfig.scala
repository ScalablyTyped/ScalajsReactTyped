...
/* Inlined std.Partial<react-native-reanimated.react-native-reanimated.WithSpringConfig> */
trait PartialWithSpringConfig extends StObject {
...
object PartialWithSpringConfig {
  
  inline def apply(): PartialWithSpringConfig = {
