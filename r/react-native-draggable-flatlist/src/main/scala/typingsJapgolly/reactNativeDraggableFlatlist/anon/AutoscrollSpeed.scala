...
object AutoscrollSpeed {
  ...
  extension [Self <: AutoscrollSpeed[?], T](x: Self & AutoscrollSpeed[T]) {
    ...
    inline def setOnAnimValInit(value: /* animVals */ ActiveCellOffset => Callback): Self = StObject.set(x, "onAnimValInit", js.Any.fromFunction1((t0: /* animVals */ ActiveCellOffset) => value(t0).runNow()))
