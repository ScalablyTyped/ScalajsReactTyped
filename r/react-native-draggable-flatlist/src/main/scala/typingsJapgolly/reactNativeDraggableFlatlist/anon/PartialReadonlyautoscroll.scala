...
trait PartialReadonlyautoscroll extends StObject {
  ...
  var outerScrollOffset: js.UndefOr[Value] = js.undefined
  
  var scrollEnabled: js.UndefOr[Boolean] = js.undefined
}
object PartialReadonlyautoscroll {
  
  inline def apply(): PartialReadonlyautoscroll = {
