...
import typingsJapgolly.reactNativeGestureHandler.libTypescriptStateMod.State
import typingsJapgolly.reactNativeReanimated.mod.SharedValue
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ActiveIndexAnim extends StObject {
  ...
  var autoScrollDistance: Readonlyvaluenumber
  ...
  var hoverAnim: Readonlyvaluenumber
  
  var hoverOffset: Readonlyvaluenumber
  
  var isDraggingCell: Readonlyvalueboolean
...
object ActiveIndexAnim {
  ...
  extension [Self <: ActiveIndexAnim](x: Self) {
    ...
    inline def setAutoScrollDistance(value: Readonlyvaluenumber): Self = StObject.set(x, "autoScrollDistance", value.asInstanceOf[js.Any])
    ...
    inline def setHoverAnim(value: Readonlyvaluenumber): Self = StObject.set(x, "hoverAnim", value.asInstanceOf[js.Any])
    
    inline def setHoverOffset(value: Readonlyvaluenumber): Self = StObject.set(x, "hoverOffset", value.asInstanceOf[js.Any])
    
    inline def setIsDraggingCell(value: Readonlyvalueboolean): Self = StObject.set(x, "isDraggingCell", value.asInstanceOf[js.Any])
    ...
    inline def setResetTouchedCell(value: Callback): Self = StObject.set(x, "resetTouchedCell", value.toJsFn)
    ...
    inline def setTouchPositionDiff(value: Readonlyvaluenumber): Self = StObject.set(x, "touchPositionDiff", value.asInstanceOf[js.Any])
