...
trait Clock extends StObject {
  ...
  var clock: typingsJapgolly.reactNativeReanimated.mod.Clock
...
object Clock {
  ...
  inline def apply(clock: typingsJapgolly.reactNativeReanimated.mod.Clock, config: SpringConfig, state: Finished): Clock = {
  ...
  extension [Self <: Clock](x: Self) {
    ...
    inline def setClock(value: typingsJapgolly.reactNativeReanimated.mod.Clock): Self = StObject.set(x, "clock", value.asInstanceOf[js.Any])
