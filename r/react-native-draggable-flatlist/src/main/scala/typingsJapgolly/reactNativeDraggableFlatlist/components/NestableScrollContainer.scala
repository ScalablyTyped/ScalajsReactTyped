...
object NestableScrollContainer {
  
  @JSImport("react-native-draggable-flatlist", "NestableScrollContainer")
  @js.native
  ...
  implicit def make(companion: NestableScrollContainer.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
