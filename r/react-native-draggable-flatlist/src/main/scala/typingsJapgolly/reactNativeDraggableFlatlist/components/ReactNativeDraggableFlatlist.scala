...
import typingsJapgolly.reactNativeDraggableFlatlist.mod.DraggableFlatListProps
import typingsJapgolly.reactNativeDraggableFlatlist.mod.OnMoveEndInfo
import typingsJapgolly.reactNativeDraggableFlatlist.mod.RenderItemInfo
...
object ReactNativeDraggableFlatlist {
  def apply[Item](
    renderItem: RenderItemInfo[Item] => CallbackTo[Element | Null],
    ...
    getItem: (/* data */ js.Any, /* index */ Double) => CallbackTo[Item] = null,
    getItemCount: /* data */ js.Any => CallbackTo[Double] = null,
    getItemLayout: (/* data */ js.Any, /* index */ Double) => CallbackTo[AnonIndex] = null,
    ...
    keyExtractor: (Item, /* index */ Double) => CallbackTo[String] = null,
    ...
    onMoveBegin: /* index */ Double => Callback = null,
    onMoveEnd: /* info */ OnMoveEndInfo[Item] => Callback = null,
    ...
    typingsJapgolly.reactNativeDraggableFlatlist.mod.default[Item], 
    Unit, 
    DraggableFlatListProps[Item]
  ] = {
    val __obj = js.Dynamic.literal()
  
      __obj.updateDynamic("renderItem")(js.Any.fromFunction1((t0: typingsJapgolly.reactNativeDraggableFlatlist.mod.RenderItemInfo[Item]) => renderItem(t0).runNow()))
    ...
    if (getItemLayout != null) __obj.updateDynamic("getItemLayout")(js.Any.fromFunction2((t0: /* data */ js.Any, t1: /* index */ scala.Double) => getItemLayout(t0, t1).runNow()))
    ...
    if (keyExtractor != null) __obj.updateDynamic("keyExtractor")(js.Any.fromFunction2((t0: Item, t1: /* index */ scala.Double) => keyExtractor(t0, t1).runNow()))
    ...
    if (onMoveBegin != null) __obj.updateDynamic("onMoveBegin")(js.Any.fromFunction1((t0: /* index */ scala.Double) => onMoveBegin(t0).runNow()))
    if (onMoveEnd != null) __obj.updateDynamic("onMoveEnd")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.reactNativeDraggableFlatlist.mod.OnMoveEndInfo[Item]) => onMoveEnd(t0).runNow()))
  ...
  typingsJapgolly.reactNativeDraggableFlatlist.mod.DraggableFlatListProps[Item], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeDraggableFlatlist.mod.default[Item]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeDraggableFlatlist.mod.DraggableFlatListProps[Item]])(children: _*)
  }
