...
object NestableDraggableFlatList {
  ...
  inline def apply[T](
    ...
    val __props = js.Dynamic.literal(animationConfig = animationConfig.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any], keyExtractor = js.Any.fromFunction2(keyExtractor), renderItem = js.Any.fromFunction1(renderItem))
    new Builder[T](js.Array(this.component, __props.asInstanceOf[DraggableFlatListProps[T]]))
  }
  
  @JSImport("react-native-draggable-flatlist/lib/typescript", "NestableDraggableFlatList")
  @js.native
  ...
  open class Builder[T] (val args: js.Array[Any])
    ...
    inline def onAnimValInit(value: /* animVals */ ReturnType[js.Function0[ActiveIndexAnim]] => Callback): this.type = set("onAnimValInit", js.Any.fromFunction1((t0: /* animVals */ ReturnType[js.Function0[ActiveIndexAnim]]) => value(t0).runNow()))
    
    inline def onContainerLayout(value: /* params */ Layout => Callback): this.type = set("onContainerLayout", js.Any.fromFunction1((t0: /* params */ Layout) => value(t0).runNow()))
    ...
    inline def outerScrollOffset(value: SharedValue[Double]): this.type = set("outerScrollOffset", value.asInstanceOf[js.Any])
