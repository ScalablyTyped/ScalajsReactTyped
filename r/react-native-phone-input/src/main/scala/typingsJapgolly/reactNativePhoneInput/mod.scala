...
import typingsJapgolly.reactNativePhoneInput.anon.TypeofTextInput
...
object mod {
  ...
  object ReactNativePhoneInputProps {
    ...
    extension [Self <: ReactNativePhoneInputProps[?], TextComponentType /* <: ComponentType[js.Object] */](x: Self & ReactNativePhoneInputProps[TextComponentType]) {
      ...
      inline def setOnChangePhoneNumber(value: /* number */ String => Callback): Self = StObject.set(x, "onChangePhoneNumber", js.Any.fromFunction1((t0: /* number */ String) => value(t0).runNow()))
      
      inline def setOnChangePhoneNumberUndefined: Self = StObject.set(x, "onChangePhoneNumber", js.undefined)
      
      inline def setOnPressCancel(value: Callback): Self = StObject.set(x, "onPressCancel", value.toJsFn)
      
      inline def setOnPressCancelUndefined: Self = StObject.set(x, "onPressCancel", js.undefined)
      
      inline def setOnPressConfirm(value: Callback): Self = StObject.set(x, "onPressConfirm", value.toJsFn)
      
      inline def setOnPressConfirmUndefined: Self = StObject.set(x, "onPressConfirm", js.undefined)
      
      inline def setOnPressFlag(value: Callback): Self = StObject.set(x, "onPressFlag", value.toJsFn)
      
      inline def setOnPressFlagUndefined: Self = StObject.set(x, "onPressFlag", js.undefined)
      
      inline def setOnSelectCountry(value: /* iso2 */ String => Callback): Self = StObject.set(x, "onSelectCountry", js.Any.fromFunction1((t0: /* iso2 */ String) => value(t0).runNow()))
