...
import typingsJapgolly.reactSimpleCodeEditor.mod.Padding
import typingsJapgolly.reactSimpleCodeEditor.mod.Props
...
object ReactSimpleCodeEditor {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def preClassName(value: String): this.type = set("preClassName", value.asInstanceOf[js.Any])
    ...
    inline def textareaClassName(value: String): this.type = set("textareaClassName", value.asInstanceOf[js.Any])
    
    inline def textareaId(value: String): this.type = set("textareaId", value.asInstanceOf[js.Any])
