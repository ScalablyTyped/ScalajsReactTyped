package typingsJapgolly.reactSimpleCodeEditor.components
...
import typingsJapgolly.reactSimpleCodeEditor.DetailedHTMLPropsHTMLAttr
import typingsJapgolly.reactSimpleCodeEditor.mod.default
...
object ReactSimpleCodeEditor {
  def apply(
    value: String,
    highlight: String => CallbackTo[String | Node],
    ...
    onBlur: ReactFocusEventFrom[(HTMLDivElement | HTMLTextAreaElement) with Element] => Callback = null,
    ...
    onClick: /* e */ ReactMouseEventFrom[(HTMLDivElement | HTMLTextAreaElement) with Element] => Callback = null,
    ...
    onFocus: ReactFocusEventFrom[(HTMLDivElement | HTMLTextAreaElement) with Element] => Callback = null,
    onInput: ReactEventFrom[HTMLDivElement] => Callback = null,
    onInvalid: ReactEventFrom[HTMLDivElement] => Callback = null,
    onKeyDown: /* e */ ReactKeyboardEventFrom[(HTMLDivElement | HTMLTextAreaElement) with Element] => Callback = null,
    onKeyPress: ReactKeyboardEventFrom[HTMLDivElement] => Callback = null,
    onKeyUp: /* e */ ReactKeyboardEventFrom[(HTMLDivElement | HTMLTextAreaElement) with Element] => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DetailedHTMLPropsHTMLAttr, default, Unit, DetailedHTMLPropsHTMLAttr] = {
    val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
  
      __obj.updateDynamic("highlight")(js.Any.fromFunction1((t0: java.lang.String) => highlight(t0).runNow()))
    __obj.updateDynamic("onValueChange")(js.Any.fromFunction1((t0: java.lang.String) => onValueChange(t0).runNow()))
  ...
  (org.scalajs.dom.raw.HTMLDivElement | org.scalajs.dom.raw.HTMLTextAreaElement) with org.scalajs.dom.raw.Element]) => onBlur(t0).runNow()))
    ...
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction1((t0: /* e */ japgolly.scalajs.react.ReactMouseEventFrom[
  (org.scalajs.dom.raw.HTMLDivElement | org.scalajs.dom.raw.HTMLTextAreaElement) with org.scalajs.dom.raw.Element]) => onClick(t0).runNow()))
  ...
  (org.scalajs.dom.raw.HTMLDivElement | org.scalajs.dom.raw.HTMLTextAreaElement) with org.scalajs.dom.raw.Element]) => onFocus(t0).runNow()))
    ...
    if (onKeyDown != null) __obj.updateDynamic("onKeyDown")(js.Any.fromFunction1((t0: /* e */ japgolly.scalajs.react.ReactKeyboardEventFrom[
  (org.scalajs.dom.raw.HTMLDivElement | org.scalajs.dom.raw.HTMLTextAreaElement) with org.scalajs.dom.raw.Element]) => onKeyDown(t0).runNow()))
    ...
    if (onKeyUp != null) __obj.updateDynamic("onKeyUp")(js.Any.fromFunction1((t0: /* e */ japgolly.scalajs.react.ReactKeyboardEventFrom[
  (org.scalajs.dom.raw.HTMLDivElement | org.scalajs.dom.raw.HTMLTextAreaElement) with org.scalajs.dom.raw.Element]) => onKeyUp(t0).runNow()))
  ...
  typingsJapgolly.reactSimpleCodeEditor.DetailedHTMLPropsHTMLAttr, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSimpleCodeEditor.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSimpleCodeEditor.DetailedHTMLPropsHTMLAttr])(children: _*)
  }
