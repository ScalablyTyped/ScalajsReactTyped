...
object anon {
  ...
  trait History extends StObject {
    ...
    var history: typingsJapgolly.reactSimpleCodeEditor.mod.History
  }
  object History {
    
    inline def apply(history: typingsJapgolly.reactSimpleCodeEditor.mod.History): History = {
    ...
    extension [Self <: History](x: Self) {
      ...
      inline def setHistory(value: typingsJapgolly.reactSimpleCodeEditor.mod.History): Self = StObject.set(x, "history", value.asInstanceOf[js.Any])
    }
  }
