...
object totextMod extends js.Object {
  ...
  class default protected () extends ToText {
    def this(rrule: typingsJapgolly.rrule.mod.default) = this()
    def this(rrule: typingsJapgolly.rrule.mod.default, gettext: GetText) = this()
    def this(rrule: typingsJapgolly.rrule.mod.default, gettext: GetText, language: Language) = this()
    def this(
      rrule: typingsJapgolly.rrule.mod.default,
      gettext: GetText,
      language: Language,
  ...
  object default extends js.Object {
    ...
    /**
      ...
      * @return {Boolean}
      */
    def isFullyConvertible(rrule: typingsJapgolly.rrule.mod.default): Boolean = js.native
  }
