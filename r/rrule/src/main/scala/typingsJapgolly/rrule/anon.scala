...
import typingsJapgolly.rrule.distEsmTypesMod.ByWeekday
import typingsJapgolly.rrule.distEsmTypesMod.Frequency
...
object anon {
  ...
  trait ParsedOptions extends StObject {
    ...
    var parsedOptions: typingsJapgolly.rrule.distEsmTypesMod.ParsedOptions
  }
  object ParsedOptions {
    
    inline def apply(parsedOptions: typingsJapgolly.rrule.distEsmTypesMod.ParsedOptions): ParsedOptions = {
    ...
    extension [Self <: ParsedOptions](x: Self) {
      ...
      inline def setParsedOptions(value: typingsJapgolly.rrule.distEsmTypesMod.ParsedOptions): Self = StObject.set(x, "parsedOptions", value.asInstanceOf[js.Any])
    }
  }
