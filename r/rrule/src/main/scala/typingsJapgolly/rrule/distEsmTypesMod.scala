...
object distEsmTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rrule.distEsmWeekdayMod.WeekdayStr
    - scala.Double
    - typingsJapgolly.rrule.distEsmWeekdayMod.Weekday
  */
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait IterResultType[M /* <: QueryMethodTypes */] extends StObject
  ...
  /* keyof rrule.rrule/dist/esm/types.QueryMethods */ /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rrule.rruleStrings.all
  ...
  */
  ...
  object QueryMethods {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(after = js.Any.fromFunction2(after), all = all.toJsFn, before = js.Any.fromFunction2(before), between = js.Any.fromFunction3(between))
    ...
    extension [Self <: QueryMethods](x: Self) {
      ...
      inline def setAll(value: CallbackTo[js.Array[js.Date]]): Self = StObject.set(x, "all", value.toJsFn)
