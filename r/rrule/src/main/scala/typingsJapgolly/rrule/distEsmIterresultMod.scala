...
object distEsmIterresultMod {
  ...
  object IterResult {
    ...
    inline def apply[M /* <: QueryMethodTypes */](
      ...
      val __obj = js.Dynamic.literal(_result = _result.asInstanceOf[js.Any], accept = js.Any.fromFunction1(accept), add = js.Any.fromFunction1(add), args = args.asInstanceOf[js.Any], getValue = getValue.toJsFn, method = method.asInstanceOf[js.Any], total = total.asInstanceOf[js.Any], maxDate = null, minDate = null)
    ...
    extension [Self <: IterResult[?], M /* <: QueryMethodTypes */](x: Self & IterResult[M]) {
      ...
      inline def setGetValue(value: CallbackTo[IterResultType[M]]): Self = StObject.set(x, "getValue", value.toJsFn)
