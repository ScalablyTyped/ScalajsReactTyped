package typingsJapgolly.rcTextarea.components
...
object ResizableTextArea {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[ResizableTextAreaRef] {
    ...
    inline def onPressEnter(value: ReactKeyboardEventFrom[HTMLTextAreaElement & Element] => Callback): this.type = set("onPressEnter", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLTextAreaElement & Element]) => value(t0).runNow()))
  ...
  implicit def make(companion: ResizableTextArea.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaProps & RefAttributes[ResizableTextAreaRef]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
