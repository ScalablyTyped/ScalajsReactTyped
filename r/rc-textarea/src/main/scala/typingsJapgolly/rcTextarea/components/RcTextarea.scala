...
import typingsJapgolly.rcTextarea.mod.default
...
object RcTextarea {
  ...
  implicit def make(companion: RcTextarea.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
