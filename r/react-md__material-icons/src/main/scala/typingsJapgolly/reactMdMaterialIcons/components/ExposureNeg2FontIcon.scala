...
object ExposureNeg2FontIcon {
  
  @JSImport("@react-md/material-icons", "ExposureNeg2FontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ExposureNeg2FontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
