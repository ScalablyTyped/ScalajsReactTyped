...
object LibraryMusicFontIcon {
  
  @JSImport("@react-md/material-icons", "LibraryMusicFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LibraryMusicFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
