...
object PeopleOutlineFontIcon {
  
  @JSImport("@react-md/material-icons", "PeopleOutlineFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: PeopleOutlineFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
