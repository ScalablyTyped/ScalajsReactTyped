...
object FlightTakeoffFontIcon {
  
  @JSImport("@react-md/material-icons", "FlightTakeoffFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: FlightTakeoffFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
