...
object Filter7FontIcon {
  
  @JSImport("@react-md/material-icons", "Filter7FontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Filter7FontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
