...
object ImportContactsFontIcon {
  
  @JSImport("@react-md/material-icons", "ImportContactsFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ImportContactsFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
