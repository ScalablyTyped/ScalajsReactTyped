...
object LibraryAddFontIcon {
  
  @JSImport("@react-md/material-icons", "LibraryAddFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LibraryAddFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
