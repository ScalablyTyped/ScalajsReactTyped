...
object Brightness4FontIcon {
  
  @JSImport("@react-md/material-icons", "Brightness4FontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Brightness4FontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
