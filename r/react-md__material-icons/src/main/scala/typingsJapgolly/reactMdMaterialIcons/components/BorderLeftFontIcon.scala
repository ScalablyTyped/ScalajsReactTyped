...
object BorderLeftFontIcon {
  
  @JSImport("@react-md/material-icons", "BorderLeftFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: BorderLeftFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
