...
object ZoomOutFontIcon {
  
  @JSImport("@react-md/material-icons", "ZoomOutFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ZoomOutFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
