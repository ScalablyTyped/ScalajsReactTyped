...
object MovieFilterFontIcon {
  
  @JSImport("@react-md/material-icons", "MovieFilterFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: MovieFilterFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
