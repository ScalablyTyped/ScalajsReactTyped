...
object ComputerFontIcon {
  
  @JSImport("@react-md/material-icons", "ComputerFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ComputerFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
