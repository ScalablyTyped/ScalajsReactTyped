...
object Filter1FontIcon {
  
  @JSImport("@react-md/material-icons", "Filter1FontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Filter1FontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
