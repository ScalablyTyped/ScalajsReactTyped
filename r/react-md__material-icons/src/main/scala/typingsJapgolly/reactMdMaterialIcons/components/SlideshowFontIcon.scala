...
object SlideshowFontIcon {
  
  @JSImport("@react-md/material-icons", "SlideshowFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SlideshowFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
