...
object ContactMailFontIcon {
  
  @JSImport("@react-md/material-icons", "ContactMailFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ContactMailFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
