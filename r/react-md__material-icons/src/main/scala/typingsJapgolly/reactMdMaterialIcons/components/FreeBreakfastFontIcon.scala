...
object FreeBreakfastFontIcon {
  
  @JSImport("@react-md/material-icons", "FreeBreakfastFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: FreeBreakfastFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
