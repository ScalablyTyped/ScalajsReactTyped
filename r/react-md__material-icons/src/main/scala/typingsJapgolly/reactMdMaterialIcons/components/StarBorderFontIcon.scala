...
object StarBorderFontIcon {
  
  @JSImport("@react-md/material-icons", "StarBorderFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: StarBorderFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
