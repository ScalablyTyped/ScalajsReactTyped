...
object ArtTrackFontIcon {
  
  @JSImport("@react-md/material-icons", "ArtTrackFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ArtTrackFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
