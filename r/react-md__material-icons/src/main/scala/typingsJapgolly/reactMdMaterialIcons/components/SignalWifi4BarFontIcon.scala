...
object SignalWifi4BarFontIcon {
  
  @JSImport("@react-md/material-icons", "SignalWifi4BarFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SignalWifi4BarFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
