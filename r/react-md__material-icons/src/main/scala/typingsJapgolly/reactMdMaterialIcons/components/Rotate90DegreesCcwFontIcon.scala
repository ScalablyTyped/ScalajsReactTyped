...
object Rotate90DegreesCcwFontIcon {
  
  @JSImport("@react-md/material-icons", "Rotate90DegreesCcwFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Rotate90DegreesCcwFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
