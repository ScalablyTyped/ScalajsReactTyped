...
object AirlineSeatReclineExtraFontIcon {
  ...
  implicit def make(companion: AirlineSeatReclineExtraFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
