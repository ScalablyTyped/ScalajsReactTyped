...
object Looks5FontIcon {
  
  @JSImport("@react-md/material-icons", "Looks5FontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Looks5FontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
