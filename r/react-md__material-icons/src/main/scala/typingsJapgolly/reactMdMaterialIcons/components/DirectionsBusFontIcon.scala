...
object DirectionsBusFontIcon {
  
  @JSImport("@react-md/material-icons", "DirectionsBusFontIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: DirectionsBusFontIcon.type): SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement] = new SharedBuilder_FontIconPropsRefAttributes_1255488271[HTMLElement](js.Array(this.component, js.Dictionary.empty))()
