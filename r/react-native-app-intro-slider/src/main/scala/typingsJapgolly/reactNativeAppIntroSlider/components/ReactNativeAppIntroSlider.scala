...
import typingsJapgolly.reactNativeAppIntroSlider.mod.Props
...
object ReactNativeAppIntroSlider {
  ...
  open class Builder[ItemT] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[default[ItemT]] {
    ...
    inline def onDone(value: Callback): this.type = set("onDone", value.toJsFn)
    ...
    inline def onSkip(value: Callback): this.type = set("onSkip", value.toJsFn)
    
    inline def onSlideChange(value: (/* a */ Double, /* b */ Double) => Callback): this.type = set("onSlideChange", js.Any.fromFunction2((t0: /* a */ Double, t1: /* b */ Double) => (value(t0, t1)).runNow()))
    ...
    inline def renderDoneButton(value: CallbackTo[Node]): this.type = set("renderDoneButton", value.toJsFn)
    
    inline def renderNextButton(value: CallbackTo[Node]): this.type = set("renderNextButton", value.toJsFn)
    
    inline def renderPagination(value: /* activeIndex */ Double => Node): this.type = set("renderPagination", js.Any.fromFunction1(value))
    
    inline def renderPrevButton(value: CallbackTo[Node]): this.type = set("renderPrevButton", value.toJsFn)
    ...
    inline def renderSkipButton(value: CallbackTo[Node]): this.type = set("renderSkipButton", value.toJsFn)
  ...
  def withProps[ItemT](p: Props[ItemT]): Builder[ItemT] = new Builder[ItemT](js.Array(this.component, p.asInstanceOf[js.Any]))
}
