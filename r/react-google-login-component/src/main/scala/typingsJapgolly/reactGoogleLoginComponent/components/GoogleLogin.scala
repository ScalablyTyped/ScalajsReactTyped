...
object GoogleLogin {
  def apply(
    socialId: String,
    responseHandler: GoogleLoginInfo => Callback,
    about: String = null,
    ...
    GoogleLoginProps, 
    typingsJapgolly.reactGoogleLoginComponent.mod.GoogleLogin, 
    Unit, 
    GoogleLoginProps
  ] = {
    val __obj = js.Dynamic.literal(socialId = socialId.asInstanceOf[js.Any])
  
      __obj.updateDynamic("responseHandler")(js.Any.fromFunction1((t0: typingsJapgolly.reactGoogleLoginComponent.mod.GoogleLoginInfo) => responseHandler(t0).runNow()))
  ...
  typingsJapgolly.reactGoogleLoginComponent.mod.GoogleLoginProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactGoogleLoginComponent.mod.GoogleLogin](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactGoogleLoginComponent.mod.GoogleLoginProps])(children: _*)
  }
