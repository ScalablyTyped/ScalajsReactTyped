package typingsJapgolly.reactGoogleLoginComponent.components
...
import typingsJapgolly.reactGoogleLoginComponent.mod.GoogleLoginInfo
import typingsJapgolly.reactGoogleLoginComponent.mod.GoogleLoginProps
...
object GoogleLogin {
  ...
  inline def apply(responseHandler: GoogleLoginInfo => Callback, socialId: String): Builder = {
    val __props = js.Dynamic.literal(responseHandler = js.Any.fromFunction1((t0: GoogleLoginInfo) => responseHandler(t0).runNow()), socialId = socialId.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[GoogleLoginProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactGoogleLoginComponent.mod.GoogleLogin] {
    ...
    inline def fetchBasicProfile(value: Boolean): this.type = set("fetchBasicProfile", value.asInstanceOf[js.Any])
    ...
    inline def prompt(value: String): this.type = set("prompt", value.asInstanceOf[js.Any])
  ...
  def withProps(p: GoogleLoginProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
