...
object libPropsTypeMod {
  ...
  object PropsType {
    ...
    extension [Self <: PropsType](x: Self) {
      ...
      inline def setOnChange(value: (/* tab */ TabData, /* index */ Double) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* tab */ TabData, t1: /* index */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnTabClick(value: (/* tab */ TabData, /* index */ Double) => Callback): Self = StObject.set(x, "onTabClick", js.Any.fromFunction2((t0: /* tab */ TabData, t1: /* index */ Double) => (value(t0, t1)).runNow()))
      ...
      inline def setRenderTabBar(value: (js.Function1[/* props */ TabBarPropsType, Node]) | `false`): Self = StObject.set(x, "renderTabBar", value.asInstanceOf[js.Any])
      
      inline def setRenderTabBarFunction1(value: /* props */ TabBarPropsType => Node): Self = StObject.set(x, "renderTabBar", js.Any.fromFunction1(value))
  ...
  trait TabBarPropsType extends StObject {
    ...
    var renderUnderline: js.UndefOr[js.Function1[/* style */ CSSProperties | Any, Node]] = js.undefined
  ...
  object TabBarPropsType {
    ...
    extension [Self <: TabBarPropsType](x: Self) {
      ...
      inline def setGoToTab(value: Double => Callback): Self = StObject.set(x, "goToTab", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      ...
      inline def setRenderUnderline(value: /* style */ CSSProperties | Any => Node): Self = StObject.set(x, "renderUnderline", js.Any.fromFunction1(value))
