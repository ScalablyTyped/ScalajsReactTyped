...
import typingsJapgolly.rmcTabs.libDefaultTabBarMod.DefaultTabBar
...
import typingsJapgolly.rmcTabs.libTabsDotbaseMod.StateType
...
object anon {
  ...
  trait TypeofDefaultTabBar
    extends StObject
       with Instantiable1[/* props */ typingsJapgolly.rmcTabs.libDefaultTabBarMod.PropsType, DefaultTabBar] {
    
    var defaultProps: typingsJapgolly.rmcTabs.libDefaultTabBarMod.PropsType = js.native
  }
}
