package typingsJapgolly.refNapi

import japgolly.scalajs.react.Callback
import typingsJapgolly.node.bufferMod.global.BufferEncoding
import typingsJapgolly.refNapi.mod.global.Buffer
import typingsJapgolly.refNapi.refNapiInts.`0`
import typingsJapgolly.refNapi.refNapiStrings.BE
import typingsJapgolly.refNapi.refNapiStrings.CString
import typingsJapgolly.refNapi.refNapiStrings.LE
import typingsJapgolly.refNapi.refNapiStrings.Object
import typingsJapgolly.refNapi.refNapiStrings.bool
import typingsJapgolly.refNapi.refNapiStrings.byte
import typingsJapgolly.refNapi.refNapiStrings.char
import typingsJapgolly.refNapi.refNapiStrings.double
import typingsJapgolly.refNapi.refNapiStrings.float
import typingsJapgolly.refNapi.refNapiStrings.int
import typingsJapgolly.refNapi.refNapiStrings.int16
import typingsJapgolly.refNapi.refNapiStrings.int32
import typingsJapgolly.refNapi.refNapiStrings.int64
import typingsJapgolly.refNapi.refNapiStrings.int8
import typingsJapgolly.refNapi.refNapiStrings.long
import typingsJapgolly.refNapi.refNapiStrings.longlong
import typingsJapgolly.refNapi.refNapiStrings.pointer
import typingsJapgolly.refNapi.refNapiStrings.short
import typingsJapgolly.refNapi.refNapiStrings.size_t
import typingsJapgolly.refNapi.refNapiStrings.string
import typingsJapgolly.refNapi.refNapiStrings.uchar
import typingsJapgolly.refNapi.refNapiStrings.uint
import typingsJapgolly.refNapi.refNapiStrings.uint16
import typingsJapgolly.refNapi.refNapiStrings.uint32
import typingsJapgolly.refNapi.refNapiStrings.uint64
import typingsJapgolly.refNapi.refNapiStrings.uint8
import typingsJapgolly.refNapi.refNapiStrings.ulong
import typingsJapgolly.refNapi.refNapiStrings.ulonglong
import typingsJapgolly.refNapi.refNapiStrings.ushort
import typingsJapgolly.refNapi.refNapiStrings.void
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.refNapi.refNapiStrings.string
    - typingsJapgolly.refNapi.refNapiStrings.pointer
    - typingsJapgolly.refNapi.refNapiStrings.void
    - typingsJapgolly.refNapi.refNapiStrings.int64
    - typingsJapgolly.refNapi.refNapiStrings.ushort
    - typingsJapgolly.refNapi.refNapiStrings.int
    - typingsJapgolly.refNapi.refNapiStrings.uint64
    - typingsJapgolly.refNapi.refNapiStrings.float
    - typingsJapgolly.refNapi.refNapiStrings.uint
    - typingsJapgolly.refNapi.refNapiStrings.long
    - typingsJapgolly.refNapi.refNapiStrings.double
    - typingsJapgolly.refNapi.refNapiStrings.int8
    - typingsJapgolly.refNapi.refNapiStrings.ulong
    - typingsJapgolly.refNapi.refNapiStrings.Object
    - typingsJapgolly.refNapi.refNapiStrings.uint8
    - typingsJapgolly.refNapi.refNapiStrings.longlong
    - typingsJapgolly.refNapi.refNapiStrings.CString
    - typingsJapgolly.refNapi.refNapiStrings.int16
    - typingsJapgolly.refNapi.refNapiStrings.ulonglong
    - typingsJapgolly.refNapi.refNapiStrings.bool
    - typingsJapgolly.refNapi.refNapiStrings.uint16
    - typingsJapgolly.refNapi.refNapiStrings.char
    - typingsJapgolly.refNapi.refNapiStrings.byte
    - typingsJapgolly.refNapi.refNapiStrings.int32
    - typingsJapgolly.refNapi.refNapiStrings.uchar
    - typingsJapgolly.refNapi.refNapiStrings.size_t
    - typingsJapgolly.refNapi.refNapiStrings.uint32
    - typingsJapgolly.refNapi.refNapiStrings.short
  ...
  */
  ...
  object Type {
    ...
    inline def apply[T](
      get: (Buffer, Double) => T,
      indirection: Double,
      set: (Buffer, Double, T) => Callback,
      size: Double
    ): Type[T] = {
      val __obj = js.Dynamic.literal(get = js.Any.fromFunction2(get), indirection = indirection.asInstanceOf[js.Any], set = js.Any.fromFunction3((t0: Buffer, t1: Double, t2: T) => (set(t0, t1, t2)).runNow()), size = size.asInstanceOf[js.Any])
    ...
    extension [Self <: Type[?], T](x: Self & Type[T]) {
      ...
      inline def setSet(value: (Buffer, Double, T) => Callback): Self = StObject.set(x, "set", js.Any.fromFunction3((t0: Buffer, t1: Double, t2: T) => (value(t0, t1, t2)).runNow()))
