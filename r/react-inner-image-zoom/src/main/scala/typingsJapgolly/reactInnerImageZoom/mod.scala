package typingsJapgolly.reactInnerImageZoom
...
object mod {
  ...
  object InnerImageZoomProps {
    ...
    extension [Self <: InnerImageZoomProps](x: Self) {
      ...
      inline def setAfterZoomIn(value: Callback): Self = StObject.set(x, "afterZoomIn", value.toJsFn)
      
      inline def setAfterZoomInUndefined: Self = StObject.set(x, "afterZoomIn", js.undefined)
      
      inline def setAfterZoomOut(value: Callback): Self = StObject.set(x, "afterZoomOut", value.toJsFn)
