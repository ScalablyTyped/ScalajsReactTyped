package typingsJapgolly.reactNativePushNotification

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.Shortcut
import typingsJapgolly.reactNativePushNotification.anon.Id
import typingsJapgolly.reactNativePushNotification.anon.OmitReceivedNotificationu
import typingsJapgolly.reactNativePushNotification.anon.Os
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.`private`
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.alert
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.badge
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.day
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.high
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.hour
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.low
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.max
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.min
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.minute
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.none
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.public
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.secret
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.sound
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.time
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.unspecified
import typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.week
...
object mod extends Shortcut {
  ...
  object Importance extends StObject {
    ...
    sealed trait DEFAULT
      extends StObject
         with Importance
    /* 3 */ val DEFAULT: typingsJapgolly.reactNativePushNotification.mod.Importance.DEFAULT & Double = js.native
    
    @js.native
    sealed trait HIGH
      extends StObject
         with Importance
    /* 4 */ val HIGH: typingsJapgolly.reactNativePushNotification.mod.Importance.HIGH & Double = js.native
    
    @js.native
    sealed trait LOW
      extends StObject
         with Importance
    /* 2 */ val LOW: typingsJapgolly.reactNativePushNotification.mod.Importance.LOW & Double = js.native
    
    @js.native
    sealed trait MIN
      extends StObject
         with Importance
    /* 1 */ val MIN: typingsJapgolly.reactNativePushNotification.mod.Importance.MIN & Double = js.native
    
    @js.native
    sealed trait NONE
      extends StObject
         with Importance
    /* 0 */ val NONE: typingsJapgolly.reactNativePushNotification.mod.Importance.NONE & Double = js.native
    
    @js.native
    sealed trait UNSPECIFIED
      extends StObject
         with Importance
    /* -1000 */ val UNSPECIFIED: typingsJapgolly.reactNativePushNotification.mod.Importance.UNSPECIFIED & Double = js.native
  }
  ...
  open class PushNotificationObject () extends StObject {
    ...
    var importance: js.UndefOr[
        typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.default | max | high | low | min | none | unspecified
      ] = js.native
    ...
    var priority: js.UndefOr[
        max | high | low | min | typingsJapgolly.reactNativePushNotification.reactNativePushNotificationStrings.default
      ] = js.native
  ...
  object PushNotificationOptions {
    ...
    extension [Self <: PushNotificationOptions](x: Self) {
      ...
      inline def setOnAction(value: /* notification */ ReceivedNotification => Callback): Self = StObject.set(x, "onAction", js.Any.fromFunction1((t0: /* notification */ ReceivedNotification) => value(t0).runNow()))
      
      inline def setOnActionUndefined: Self = StObject.set(x, "onAction", js.undefined)
      
      inline def setOnNotification(value: /* notification */ OmitReceivedNotificationu => Callback): Self = StObject.set(x, "onNotification", js.Any.fromFunction1((t0: /* notification */ OmitReceivedNotificationu) => value(t0).runNow()))
      
      inline def setOnNotificationUndefined: Self = StObject.set(x, "onNotification", js.undefined)
      
      inline def setOnRegister(value: /* token */ Os => Callback): Self = StObject.set(x, "onRegister", js.Any.fromFunction1((t0: /* token */ Os) => value(t0).runNow()))
      
      inline def setOnRegisterUndefined: Self = StObject.set(x, "onRegister", js.undefined)
      
      inline def setOnRegistrationError(value: /* error */ Any => Callback): Self = StObject.set(x, "onRegistrationError", js.Any.fromFunction1((t0: /* error */ Any) => value(t0).runNow()))
      
      inline def setOnRegistrationErrorUndefined: Self = StObject.set(x, "onRegistrationError", js.undefined)
      
      inline def setOnRemoteFetch(value: /* notificationData */ Any => Callback): Self = StObject.set(x, "onRemoteFetch", js.Any.fromFunction1((t0: /* notificationData */ Any) => value(t0).runNow()))
