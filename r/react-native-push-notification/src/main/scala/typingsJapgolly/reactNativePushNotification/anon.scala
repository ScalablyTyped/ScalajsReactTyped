...
object anon {
  ...
  object OmitReceivedNotificationu {
    ...
    inline def apply(
      ...
      finish: /* fetchResult */ String => Callback,
      foreground: Boolean,
      id: String,
    ...
    extension [Self <: OmitReceivedNotificationu](x: Self) {
      ...
      inline def setFinish(value: /* fetchResult */ String => Callback): Self = StObject.set(x, "finish", js.Any.fromFunction1((t0: /* fetchResult */ String) => value(t0).runNow()))
