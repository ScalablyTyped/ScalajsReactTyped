...
- typingsJapgolly.leaflet.mod.GridLayerOptions because var conflicts: attribution, pane. Inlined minNativeZoom, maxZoom, tileSize, updateWhenIdle, maxNativeZoom, bounds, minZoom, noWrap, updateWhenZooming, className, zIndex, opacity, keepBuffer, updateInterval */ trait GridLayerProps
  extends StObject
     with MapLayerProps {
