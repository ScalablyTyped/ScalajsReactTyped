...
- typingsJapgolly.leaflet.mod.PathOptions because var conflicts: attribution, pane. Inlined lineCap, fillOpacity, stroke, lineJoin, fillColor, dashOffset, color, renderer, fillRule, fill, className, dashArray, opacity, weight
- typingsJapgolly.leaflet.mod.CircleMarkerOptions because var conflicts: attribution, pane. Inlined radius */ trait CircleProps
  extends StObject
     with MapLayerProps
     with PathEvents {
