...
import typingsJapgolly.reactLeaflet.mod.LayersControl.BaseLayer
...
object LayersControlBaseLayer {
  def apply[P /* <: ControlledLayerProps */](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[P with js.Object, BaseLayer[P], Unit, P with js.Object] = {
  ...
  typingsJapgolly.reactLeaflet.mod.LayersControl.BaseLayer[P]](this.componentImport)
