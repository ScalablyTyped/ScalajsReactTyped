...
object MapControl {
  def apply[P /* <: MapControlProps */, E /* <: Control_ */](
    ...
    P with js.Object, 
    typingsJapgolly.reactLeaflet.mod.MapControl[P, E], 
    Unit, 
    P with js.Object
  ] = {
  ...
  typingsJapgolly.reactLeaflet.mod.MapControl[P, E]](this.componentImport)
