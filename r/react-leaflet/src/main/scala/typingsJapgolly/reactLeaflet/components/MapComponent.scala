...
object MapComponent {
  def apply[P /* <: MapComponentProps */, E /* <: Evented */](
    ...
    P with js.Object, 
    typingsJapgolly.reactLeaflet.mod.MapComponent[P, E], 
    Unit, 
    P with js.Object
  ] = {
  ...
  typingsJapgolly.reactLeaflet.mod.MapComponent[P, E]](this.componentImport)
