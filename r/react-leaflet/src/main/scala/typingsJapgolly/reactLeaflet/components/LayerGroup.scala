...
object LayerGroup {
  def apply[P /* <: MapLayerProps */, E /* <: LayerGroup_[js.Any] */](
    ...
    P with js.Object, 
    typingsJapgolly.reactLeaflet.mod.LayerGroup[P, E], 
    Unit, 
    P with js.Object
  ] = {
  ...
  typingsJapgolly.reactLeaflet.mod.LayerGroup[P, E]](this.componentImport)
