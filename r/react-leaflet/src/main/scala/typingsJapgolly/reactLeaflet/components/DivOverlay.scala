...
object DivOverlay {
  def apply[P /* <: DivOverlayProps */, E /* <: DivOverlayTypes */](
    ...
    P with js.Object, 
    typingsJapgolly.reactLeaflet.mod.DivOverlay[P, E], 
    Unit, 
    P with js.Object
  ] = {
  ...
  typingsJapgolly.reactLeaflet.mod.DivOverlay[P, E]](this.componentImport)
