...
object CircleMarker {
  def apply[P /* <: CircleMarkerProps */, E /* <: CircleMarker_[js.Any] */](
    ...
    P with js.Object, 
    typingsJapgolly.reactLeaflet.mod.CircleMarker[P, E], 
    Unit, 
    P with js.Object
  ] = {
  ...
  typingsJapgolly.reactLeaflet.mod.CircleMarker[P, E]](this.componentImport)
