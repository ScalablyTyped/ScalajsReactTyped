...
object ZoomControl {
  def apply[P /* <: ZoomControlProps */, E /* <: Zoom */](
    ...
    P with js.Object, 
    typingsJapgolly.reactLeaflet.mod.ZoomControl[P, E], 
    Unit, 
    P with js.Object
  ] = {
  ...
  typingsJapgolly.reactLeaflet.mod.ZoomControl[P, E]](this.componentImport)
