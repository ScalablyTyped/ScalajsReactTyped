...
import typingsJapgolly.reactLeaflet.mod.LayersControl.Overlay
...
object LayersControlOverlay {
  def apply[P /* <: ControlledLayerProps */](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[P with js.Object, Overlay[P], Unit, P with js.Object] = {
  ...
  typingsJapgolly.reactLeaflet.mod.LayersControl.Overlay[P]](this.componentImport)
