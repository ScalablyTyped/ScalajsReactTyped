...
object GeoJSON {
  def apply[P /* <: GeoJSONProps */, E /* <: GeoJSON_[js.Any] */](
    ...
    P with js.Object, 
    typingsJapgolly.reactLeaflet.mod.GeoJSON[P, E], 
    Unit, 
    P with js.Object
  ] = {
  ...
  typingsJapgolly.reactLeaflet.mod.GeoJSON[P, E]](this.componentImport)
