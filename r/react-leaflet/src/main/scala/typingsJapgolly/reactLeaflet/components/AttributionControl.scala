...
object AttributionControl {
  def apply[P /* <: AttributionControlProps */, E /* <: Attribution */](
    ...
    P with js.Object, 
    typingsJapgolly.reactLeaflet.mod.AttributionControl[P, E], 
    Unit, 
    P with js.Object
  ] = {
  ...
  typingsJapgolly.reactLeaflet.mod.AttributionControl[P, E]](this.componentImport)
