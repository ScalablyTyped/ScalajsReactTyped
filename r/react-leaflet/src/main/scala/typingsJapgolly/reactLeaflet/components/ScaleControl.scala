...
object ScaleControl {
  def apply[P /* <: ScaleControlProps */, E /* <: Scale */](
    ...
    P with js.Object, 
    typingsJapgolly.reactLeaflet.mod.ScaleControl[P, E], 
    Unit, 
    P with js.Object
  ] = {
  ...
  typingsJapgolly.reactLeaflet.mod.ScaleControl[P, E]](this.componentImport)
