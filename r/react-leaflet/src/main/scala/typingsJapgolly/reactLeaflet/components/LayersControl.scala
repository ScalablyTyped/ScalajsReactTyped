...
import typingsJapgolly.reactLeaflet.mod.LayersControl_
...
object LayersControl {
  def apply[P /* <: LayersControlProps */, E /* <: Layers */](
    props: P with js.Object,
    key: js.UndefOr[Key] = js.undefined,
    _overrides: StringDictionary[js.Any] = null
  )(
    children: ChildArg*
  ): UnmountedWithRoot[P with js.Object, LayersControl_[P, E], Unit, P with js.Object] = {
  ...
  typingsJapgolly.reactLeaflet.mod.LayersControl_[P, E]](this.componentImport)
