package typingsJapgolly.readlineSync
...
object mod {
  ...
  object BasicOptions {
    ...
    extension [Self <: BasicOptions](x: Self) {
      ...
      inline def setPrint(value: (/* display */ String, /* encoding */ String) => Callback): Self = StObject.set(x, "print", js.Any.fromFunction2((t0: /* display */ String, t1: /* encoding */ String) => (value(t0, t1)).runNow()))
