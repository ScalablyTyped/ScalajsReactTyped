...
object NormalizedInputOptions {
  ...
  inline def apply(
    ...
    onwarn: /* warning */ RollupWarning => Callback,
    perf: Boolean,
  ...
  extension [Self <: NormalizedInputOptions](x: Self) {
    ...
    inline def setOnwarn(value: /* warning */ RollupWarning => Callback): Self = StObject.set(x, "onwarn", js.Any.fromFunction1((t0: /* warning */ RollupWarning) => value(t0).runNow()))
