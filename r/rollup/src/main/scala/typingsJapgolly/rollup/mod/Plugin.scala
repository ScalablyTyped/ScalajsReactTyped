...
object Plugin {
  ...
  def apply(
    ...
    watchChange: /* id */ String => Callback = null,
    ...
    if (watchChange != null) __obj.updateDynamic("watchChange")(js.Any.fromFunction1((t0: /* id */ java.lang.String) => watchChange(t0).runNow()))
