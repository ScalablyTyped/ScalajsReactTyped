...
import typingsJapgolly.rollup.rollupStrings.ifRelativeSource
...
object InputOptions {
  ...
  extension [Self <: InputOptions](x: Self) {
    ...
    inline def setAcornInjectPluginsCallbackTo(value: CallbackTo[Any]): Self = StObject.set(x, "acornInjectPlugins", value.toJsFn)
    ...
    inline def setOnwarn(value: (/* warning */ RollupWarning, /* defaultHandler */ WarningHandler) => Callback): Self = StObject.set(x, "onwarn", js.Any.fromFunction2((t0: /* warning */ RollupWarning, t1: /* defaultHandler */ WarningHandler) => (value(t0, t1)).runNow()))
