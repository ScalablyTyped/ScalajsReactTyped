...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.relayCompiler.iRMod.ObjectFieldValue
...
object IR {
  ...
  @scala.inline
  def Literal(kind: typingsJapgolly.relayCompiler.relayCompilerStrings.Literal, loc: Location, value: js.Any): IR = {
