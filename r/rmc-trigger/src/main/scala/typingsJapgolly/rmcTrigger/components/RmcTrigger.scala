...
import typingsJapgolly.rmcTrigger.mod.default
...
object RmcTrigger {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ITriggerProps, default, Unit, ITriggerProps] = {
  ...
  typingsJapgolly.rmcTrigger.propsTypeMod.ITriggerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.rmcTrigger.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rmcTrigger.propsTypeMod.ITriggerProps])(children: _*)
  }
