...
object LineProps {
  ...
  def apply(
    ...
    onMouseDown: ReactMouseEventFrom[SVGPathElement] => Callback = null,
    onMouseEnter: ReactMouseEventFrom[SVGPathElement] => Callback = null,
    onMouseLeave: ReactMouseEventFrom[SVGPathElement] => Callback = null,
    ...
    onMouseUp: ReactMouseEventFrom[SVGPathElement] => Callback = null,
    ...
    onTimeUpdate: ReactEventFrom[SVGPathElement] => Callback = null,
    onTouchCancel: ReactTouchEventFrom[SVGPathElement] => Callback = null,
    onTouchEnd: ReactTouchEventFrom[SVGPathElement] => Callback = null
  ): LineProps = {
    ...
    if (onMouseDown != null) __obj.updateDynamic("onMouseDown")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.SVGPathElement]) => onMouseDown(t0).runNow()))
    if (onMouseEnter != null) __obj.updateDynamic("onMouseEnter")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.SVGPathElement]) => onMouseEnter(t0).runNow()))
    if (onMouseLeave != null) __obj.updateDynamic("onMouseLeave")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.SVGPathElement]) => onMouseLeave(t0).runNow()))
    ...
    if (onMouseUp != null) __obj.updateDynamic("onMouseUp")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.SVGPathElement]) => onMouseUp(t0).runNow()))
    ...
    if (onTimeUpdate != null) __obj.updateDynamic("onTimeUpdate")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.SVGPathElement]) => onTimeUpdate(t0).runNow()))
    if (onTouchCancel != null) __obj.updateDynamic("onTouchCancel")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactTouchEventFrom[org.scalajs.dom.raw.SVGPathElement]) => onTouchCancel(t0).runNow()))
    if (onTouchEnd != null) __obj.updateDynamic("onTouchEnd")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactTouchEventFrom[org.scalajs.dom.raw.SVGPathElement]) => onTouchEnd(t0).runNow()))
