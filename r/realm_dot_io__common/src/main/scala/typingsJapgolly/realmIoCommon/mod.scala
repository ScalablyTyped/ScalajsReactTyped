package typingsJapgolly.realmIoCommon

import typingsJapgolly.realmIoCommon.anon.ArgsObject
...
object mod {
  ...
  @JSImport("@realm.io/common", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@realm.io/common", "safeGlobalThis")
  @js.native
