package typingsJapgolly.reactNativeHighlightWords.components
...
import typingsJapgolly.reactNativeHighlightWords.mod.HighlighterProps
import typingsJapgolly.reactNativeHighlightWords.mod.default
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ReactNativeHighlightWords {
  
  inline def apply(searchWords: js.Array[String], textToHighlight: String): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def highlightStyle(value: StyleProp[TextStyle]): this.type = set("highlightStyle", value.asInstanceOf[js.Any])
    
    inline def highlightStyleNull: this.type = set("highlightStyle", null)
