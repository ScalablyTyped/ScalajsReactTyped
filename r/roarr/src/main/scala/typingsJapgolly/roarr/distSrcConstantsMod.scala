...
object distSrcConstantsMod {
  ...
  object logLevels {
    ...
    @JSImport("roarr/dist/src/constants", "logLevels")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("roarr/dist/src/constants", "logLevels.debug")
    @js.native
    ...
    @JSImport("roarr/dist/src/constants", "logLevels.error")
    @js.native
    ...
    @JSImport("roarr/dist/src/constants", "logLevels.fatal")
    @js.native
    ...
    @JSImport("roarr/dist/src/constants", "logLevels.warn")
    @js.native
