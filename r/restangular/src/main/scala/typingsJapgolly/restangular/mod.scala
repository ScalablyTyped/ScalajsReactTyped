...
import typingsJapgolly.restangular.anon.Element
import typingsJapgolly.restangular.anon.Method
...
object mod {
  ...
  trait ICollectionPromise[T]
    extends StObject
       with typingsJapgolly.angular.mod.IPromise[js.Array[T]] {
  ...
  trait IPromise[T]
    extends StObject
       with typingsJapgolly.angular.mod.IPromise[T] {
