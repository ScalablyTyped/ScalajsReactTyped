package typingsJapgolly.reactPaginate
...
object mod extends Shortcut {
  ...
  open class default protected ()
    extends Component[ReactPaginateProps, js.Object, Any] {
    def this(props: ReactPaginateProps) = this()
    def this(props: ReactPaginateProps, context: Any) = this()
  }
  @JSImport("react-paginate", JSImport.Default)
  @js.native
  val default: ComponentClassP[ReactPaginateProps & js.Object] = js.native
  ...
  trait ReactPaginateProps extends StObject {
    ...
    /**
      * Label for ellipsis.
      */
    var breakLabel: js.UndefOr[String | Node] = js.undefined
    ...
    /**
      ...
      */
    var nextLabel: js.UndefOr[String | Node] = js.undefined
    ...
    /**
      ...
      */
    var pageLabelBuilder: js.UndefOr[js.Function1[/* page */ Double, String | Node]] = js.undefined
    ...
    /**
      ...
      */
    var previousLabel: js.UndefOr[String | Node] = js.undefined
  ...
  object ReactPaginateProps {
    ...
    extension [Self <: ReactPaginateProps](x: Self) {
      ...
      inline def setAriaLabelBuilder(value: (/* pageIndex */ Double, /* selectedPage */ Double) => Callback): Self = StObject.set(x, "ariaLabelBuilder", js.Any.fromFunction2((t0: /* pageIndex */ Double, t1: /* selectedPage */ Double) => (value(t0, t1)).runNow()))
      ...
      inline def setBreakLabel(value: String | Node): Self = StObject.set(x, "breakLabel", value.asInstanceOf[js.Any])
      
      inline def setBreakLabelNull: Self = StObject.set(x, "breakLabel", null)
      
      inline def setBreakLabelUndefined: Self = StObject.set(x, "breakLabel", js.undefined)
      
      inline def setBreakLabelVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "breakLabel", js.Array(value*))
      
      inline def setBreakLabelVdomElement(value: VdomElement): Self = StObject.set(x, "breakLabel", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setHrefBuilder(value: (/* pageIndex */ Double, /* pageCount */ Double, /* selectedPage */ Double) => Callback): Self = StObject.set(x, "hrefBuilder", js.Any.fromFunction3((t0: /* pageIndex */ Double, t1: /* pageCount */ Double, t2: /* selectedPage */ Double) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setNextLabel(value: String | Node): Self = StObject.set(x, "nextLabel", value.asInstanceOf[js.Any])
      ...
      inline def setNextLabelVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "nextLabel", js.Array(value*))
      ...
      inline def setOnPageActive(value: /* selectedItem */ Selected => Callback): Self = StObject.set(x, "onPageActive", js.Any.fromFunction1((t0: /* selectedItem */ Selected) => value(t0).runNow()))
      
      inline def setOnPageActiveUndefined: Self = StObject.set(x, "onPageActive", js.undefined)
      
      inline def setOnPageChange(value: /* selectedItem */ Selected => Callback): Self = StObject.set(x, "onPageChange", js.Any.fromFunction1((t0: /* selectedItem */ Selected) => value(t0).runNow()))
      ...
      inline def setPageLabelBuilder(value: /* page */ Double => String | Node): Self = StObject.set(x, "pageLabelBuilder", js.Any.fromFunction1(value))
      ...
      inline def setPreviousLabel(value: String | Node): Self = StObject.set(x, "previousLabel", value.asInstanceOf[js.Any])
      ...
      inline def setPreviousLabelVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "previousLabel", js.Array(value*))
  ...
  type _To = ComponentClassP[ReactPaginateProps & js.Object]
  
  /* This means you don't have to write `default`, but can instead just say `mod.foo` */
  override def _to: ComponentClassP[ReactPaginateProps & js.Object] = default
}
