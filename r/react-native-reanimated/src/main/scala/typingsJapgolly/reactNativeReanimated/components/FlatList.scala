...
object FlatList {
  ...
  inline def apply[T](): Builder[T] = {
    ...
    new Builder[T](js.Array(this.component, __props.asInstanceOf[ViewProps]))
  }
  ...
  open class Builder[T] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeReanimated.mod.default.FlatList[T]] {
  ...
  implicit def make[T](companion: FlatList.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps[T](p: ViewProps): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
