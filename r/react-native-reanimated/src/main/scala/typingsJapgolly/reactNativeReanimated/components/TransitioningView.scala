...
import typingsJapgolly.reactNativeReanimated.mod.TransitioningViewProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TransitioningView {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeReanimated.mod.TransitioningView] {
    ...
    inline def transition(value: VdomNode): this.type = set("transition", value.rawNode.asInstanceOf[js.Any])
    
    inline def transitionNull: this.type = set("transition", null)
    
    inline def transitionVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("transition", js.Array(value*))
    
    inline def transitionVdomElement(value: VdomElement): this.type = set("transition", value.rawElement.asInstanceOf[js.Any])
  ...
  implicit def make(companion: TransitioningView.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TransitioningViewProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
