...
/* Inlined std.Partial<react-native-reanimated.react-native-reanimated.Animated.AnimateProps<react-native.react-native.ScrollViewProps>> */
trait PartialAnimatePropsScroll extends StObject {
  ...
  var animatedProps: js.UndefOr[Partial[AnimateProps[ScrollViewProps]]] = js.undefined
...
object PartialAnimatePropsScroll {
  
  inline def apply(): PartialAnimatePropsScroll = {
  ...
  extension [Self <: PartialAnimatePropsScroll](x: Self) {
    ...
    inline def setAnimatedProps(value: Partial[AnimateProps[ScrollViewProps]]): Self = StObject.set(x, "animatedProps", value.asInstanceOf[js.Any])
