...
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.resize
...
object AnimatePropsImageProps {
  ...
  extension [Self <: AnimatePropsImageProps](x: Self) {
    ...
    inline def setOnErrorFunction1(value: /* error */ NativeSyntheticEvent[ImageErrorEventData] => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* error */ NativeSyntheticEvent[ImageErrorEventData]) => value(t0).runNow()))
    ...
    inline def setOnLoadEndCallback(value: Callback): Self = StObject.set(x, "onLoadEnd", value.toJsFn)
    
    inline def setOnLoadEndUndefined: Self = StObject.set(x, "onLoadEnd", js.undefined)
    
    inline def setOnLoadFunction1(value: /* event */ NativeSyntheticEvent[ImageLoadEventData] => Callback): Self = StObject.set(x, "onLoad", js.Any.fromFunction1((t0: /* event */ NativeSyntheticEvent[ImageLoadEventData]) => value(t0).runNow()))
    ...
    inline def setOnLoadStartCallback(value: Callback): Self = StObject.set(x, "onLoadStart", value.toJsFn)
    ...
    inline def setOnPartialLoadCallback(value: Callback): Self = StObject.set(x, "onPartialLoad", value.toJsFn)
    ...
    inline def setOnProgressFunction1(value: /* event */ NativeSyntheticEvent[ImageProgressEventDataIOS] => Callback): Self = StObject.set(x, "onProgress", js.Any.fromFunction1((t0: /* event */ NativeSyntheticEvent[ImageProgressEventDataIOS]) => value(t0).runNow()))
