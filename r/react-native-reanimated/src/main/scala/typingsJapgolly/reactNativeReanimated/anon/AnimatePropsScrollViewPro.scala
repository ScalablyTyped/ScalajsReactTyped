...
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.`on-drag`
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.always
...
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.automatic
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.black
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.center
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.default
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.end
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.fast
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.handled
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.interactive
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.never
...
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.scrollableAxes
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.start
import typingsJapgolly.reactNativeReanimated.reactNativeReanimatedStrings.white
...
trait AnimatePropsScrollViewPro extends StObject {
  ...
  var refreshControl: js.UndefOr[Element | AnimatedNode[js.UndefOr[Element]]] = js.undefined
...
object AnimatePropsScrollViewPro {
  ...
  extension [Self <: AnimatePropsScrollViewPro](x: Self) {
    ...
    inline def setOnContentSizeChangeFunction2(value: (/* w */ Double, /* h */ Double) => Callback): Self = StObject.set(x, "onContentSizeChange", js.Any.fromFunction2((t0: /* w */ Double, t1: /* h */ Double) => (value(t0, t1)).runNow()))
    ...
    inline def setOnMomentumScrollBeginFunction1(value: /* event */ NativeSyntheticEvent[NativeScrollEvent] => Callback): Self = StObject.set(x, "onMomentumScrollBegin", js.Any.fromFunction1((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent]) => value(t0).runNow()))
    ...
    inline def setOnMomentumScrollEndFunction1(value: /* event */ NativeSyntheticEvent[NativeScrollEvent] => Callback): Self = StObject.set(x, "onMomentumScrollEnd", js.Any.fromFunction1((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent]) => value(t0).runNow()))
    ...
    inline def setOnScrollAnimationEndCallback(value: Callback): Self = StObject.set(x, "onScrollAnimationEnd", value.toJsFn)
    ...
    inline def setOnScrollBeginDragFunction1(value: /* event */ NativeSyntheticEvent[NativeScrollEvent] => Callback): Self = StObject.set(x, "onScrollBeginDrag", js.Any.fromFunction1((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent]) => value(t0).runNow()))
    ...
    inline def setOnScrollEndDragFunction1(value: /* event */ NativeSyntheticEvent[NativeScrollEvent] => Callback): Self = StObject.set(x, "onScrollEndDrag", js.Any.fromFunction1((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent]) => value(t0).runNow()))
    
    inline def setOnScrollEndDragUndefined: Self = StObject.set(x, "onScrollEndDrag", js.undefined)
    
    inline def setOnScrollFunction1(value: /* event */ NativeSyntheticEvent[NativeScrollEvent] => Callback): Self = StObject.set(x, "onScroll", js.Any.fromFunction1((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent]) => value(t0).runNow()))
    ...
    inline def setOnScrollToTopFunction1(value: /* event */ NativeSyntheticEvent[NativeScrollEvent] => Callback): Self = StObject.set(x, "onScrollToTop", js.Any.fromFunction1((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent]) => value(t0).runNow()))
    ...
    inline def setRefreshControl(value: Element | AnimatedNode[js.UndefOr[Element]]): Self = StObject.set(x, "refreshControl", value.asInstanceOf[js.Any])
