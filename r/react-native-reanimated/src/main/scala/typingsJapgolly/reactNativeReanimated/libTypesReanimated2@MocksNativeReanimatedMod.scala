...
object `libTypesReanimated2@MocksNativeReanimatedMod` {
  ...
  object default {
    ...
    inline def makeMutable(init: Any): typingsJapgolly.reactNativeReanimated.`libTypesReanimated2@MocksMutableValueMod`.default = ^.asInstanceOf[js.Dynamic].applyDynamic("makeMutable")(init.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.reactNativeReanimated.`libTypesReanimated2@MocksMutableValueMod`.default]
