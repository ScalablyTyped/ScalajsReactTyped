...
object libTypesReanimated2InterpolationMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNativeReanimated.libTypesReanimated2InterpolationMod.ExtrapolationConfig
    - typingsJapgolly.reactNativeReanimated.libTypesReanimated2InterpolationMod.Extrapolation
    - java.lang.String
    - scala.Unit
  */
