...
object libTypesReanimated2HookUseAnimatedKeyboardMod {
  
  @JSImport("react-native-reanimated/lib/types/reanimated2/hook/useAnimatedKeyboard", JSImport.Namespace)
  @js.native
