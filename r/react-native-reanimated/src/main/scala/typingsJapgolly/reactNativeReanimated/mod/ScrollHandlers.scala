...
object ScrollHandlers {
  ...
  extension [Self <: ScrollHandlers[?], TContext /* <: Context */](x: Self & ScrollHandlers[TContext]) {
    ...
    inline def setOnBeginDrag(value: (/* event */ NativeScrollEvent, TContext) => Callback): Self = StObject.set(x, "onBeginDrag", js.Any.fromFunction2((t0: /* event */ NativeScrollEvent, t1: TContext) => (value(t0, t1)).runNow()))
    
    inline def setOnBeginDragUndefined: Self = StObject.set(x, "onBeginDrag", js.undefined)
    
    inline def setOnEndDrag(value: (/* event */ NativeScrollEvent, TContext) => Callback): Self = StObject.set(x, "onEndDrag", js.Any.fromFunction2((t0: /* event */ NativeScrollEvent, t1: TContext) => (value(t0, t1)).runNow()))
    
    inline def setOnEndDragUndefined: Self = StObject.set(x, "onEndDrag", js.undefined)
    
    inline def setOnMomentumBegin(value: (/* event */ NativeScrollEvent, TContext) => Callback): Self = StObject.set(x, "onMomentumBegin", js.Any.fromFunction2((t0: /* event */ NativeScrollEvent, t1: TContext) => (value(t0, t1)).runNow()))
    
    inline def setOnMomentumBeginUndefined: Self = StObject.set(x, "onMomentumBegin", js.undefined)
    
    inline def setOnMomentumEnd(value: (/* event */ NativeScrollEvent, TContext) => Callback): Self = StObject.set(x, "onMomentumEnd", js.Any.fromFunction2((t0: /* event */ NativeScrollEvent, t1: TContext) => (value(t0, t1)).runNow()))
    
    inline def setOnMomentumEndUndefined: Self = StObject.set(x, "onMomentumEnd", js.undefined)
    
    inline def setOnScroll(value: (/* event */ NativeScrollEvent, TContext) => Callback): Self = StObject.set(x, "onScroll", js.Any.fromFunction2((t0: /* event */ NativeScrollEvent, t1: TContext) => (value(t0, t1)).runNow()))
