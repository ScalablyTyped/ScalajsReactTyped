...
object ColorSpace extends StObject {
  ...
  sealed trait HSV
    extends StObject
       with ColorSpace
  /* 1 */ val HSV: typingsJapgolly.reactNativeReanimated.mod.ColorSpace.HSV & Double = js.native
  
  @js.native
  sealed trait RGB
    extends StObject
       with ColorSpace
  /* 0 */ val RGB: typingsJapgolly.reactNativeReanimated.mod.ColorSpace.RGB & Double = js.native
}
