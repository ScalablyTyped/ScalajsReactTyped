...
import typingsJapgolly.reactNativeGestureHandler.libTypescriptHandlersGestureHandlerTypesCompatMod.GestureHandlerGestureEvent
...
import typingsJapgolly.reactNativeReanimated.anon.X
import typingsJapgolly.reactNativeReanimated.mod.Animated.AnimatedClock
import typingsJapgolly.reactNativeReanimated.mod.Animated.AnimatedNode
import typingsJapgolly.reactNativeReanimated.mod.Animated.AnimatedValue
...
import typingsJapgolly.reactNativeReanimated.mod.SensorType.ROTATION
import typingsJapgolly.reactNativeReanimated.mod.^
...
inline def SpringUtils: typingsJapgolly.reactNativeReanimated.mod.Animated.SpringUtils = ^.asInstanceOf[js.Dynamic].selectDynamic("SpringUtils").asInstanceOf[typingsJapgolly.reactNativeReanimated.mod.Animated.SpringUtils]
...
inline def block[T1 /* <: typingsJapgolly.reactNativeReanimated.mod.Animated.Value */, T2 /* <: typingsJapgolly.reactNativeReanimated.mod.Animated.Value */](items: js.Array[typingsJapgolly.reactNativeReanimated.mod.Animated.Adaptable[T2]]): AnimatedNode[T1] = ^.asInstanceOf[js.Dynamic].applyDynamic("block")(items.asInstanceOf[js.Any]).asInstanceOf[AnimatedNode[T1]]
...
/* a */ js.UndefOr[typingsJapgolly.reactNativeReanimated.mod.Animated.Adaptable[Double]], 
...
/* repeated */ typingsJapgolly.reactNativeReanimated.mod.Animated.Adaptable[Double | String], 
...
/* value */ typingsJapgolly.reactNativeReanimated.mod.Animated.Adaptable[Any], 
...
inline def getRelativeCoords(ref: RefHandle[Component[js.Object, js.Object]], x: Double, y: Double): X = (^.asInstanceOf[js.Dynamic].applyDynamic("getRelativeCoords")(ref.asInstanceOf[js.Any], x.asInstanceOf[js.Any], y.asInstanceOf[js.Any])).asInstanceOf[X]
...
inline def measure[T /* <: Component[js.Object, js.Object] */](ref: RefHandle[T]): MeasuredDimensions | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("measure")(ref.asInstanceOf[js.Any]).asInstanceOf[MeasuredDimensions | Null]
...
inline def useAnimatedRef[T /* <: Component[js.Object, js.Object] */](): RefHandle[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("useAnimatedRef")().asInstanceOf[RefHandle[T]]
...
inline def useHandler[T, TContext /* <: Context */](handlers: Record[String, Handler[T, TContext]]): typingsJapgolly.reactNativeReanimated.anon.Context[TContext] = ^.asInstanceOf[js.Dynamic].applyDynamic("useHandler")(handlers.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.reactNativeReanimated.anon.Context[TContext]]
inline def useHandler[T, TContext /* <: Context */](handlers: Record[String, Handler[T, TContext]], deps: DependencyList): typingsJapgolly.reactNativeReanimated.anon.Context[TContext] = (^.asInstanceOf[js.Dynamic].applyDynamic("useHandler")(handlers.asInstanceOf[js.Any], deps.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.reactNativeReanimated.anon.Context[TContext]]
...
inline def useScrollViewOffset(aref: RefHandle[typingsJapgolly.reactNativeReanimated.mod.Animated.ScrollView]): SharedValue[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("useScrollViewOffset")(aref.asInstanceOf[js.Any]).asInstanceOf[SharedValue[Double]]
...
type AdaptTransforms[T] = typingsJapgolly.reactNativeReanimated.mod.Animated.AdaptTransforms[T]

type Adaptable[T] = typingsJapgolly.reactNativeReanimated.mod.Animated.Adaptable[T]

type AnimatableValue = Double | String | js.Array[Double]

type AnimateProps[P /* <: js.Object */] = typingsJapgolly.reactNativeReanimated.mod.Animated.AnimateProps[P]

type AnimateStyle[S] = typingsJapgolly.reactNativeReanimated.mod.Animated.AnimateStyle[S]

type AnimatedStyleProp[T] = AnimateStyle[T] | RegisteredStyle[AnimateStyle[T]]

type AnimatedTransform = typingsJapgolly.reactNativeReanimated.mod.Animated.AnimatedTransform
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.reactNativeReanimated.mod.ExtrapolationConfig
  - typingsJapgolly.reactNativeReanimated.mod.Extrapolation
  - java.lang.String
  - scala.Unit
*/
...
type SharedValue[T] = typingsJapgolly.reactNativeReanimated.mod.Animated.SharedValue[T]
...
type TransformStyleTypes = typingsJapgolly.reactNativeReanimated.mod.Animated.TransformStyleTypes
