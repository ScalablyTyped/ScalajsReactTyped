...
object libTypesReanimated2HookUseAnimatedGestureHandlerMod {
  ...
  object EventType extends StObject {
    ...
    sealed trait ACTIVE
      extends StObject
         with EventType
    /* 4 */ val ACTIVE: typingsJapgolly.reactNativeReanimated.libTypesReanimated2HookUseAnimatedGestureHandlerMod.EventType.ACTIVE & Double = js.native
    
    @js.native
    sealed trait BEGAN
      extends StObject
         with EventType
    /* 2 */ val BEGAN: typingsJapgolly.reactNativeReanimated.libTypesReanimated2HookUseAnimatedGestureHandlerMod.EventType.BEGAN & Double = js.native
    
    @js.native
    sealed trait CANCELLED
      extends StObject
         with EventType
    /* 3 */ val CANCELLED: typingsJapgolly.reactNativeReanimated.libTypesReanimated2HookUseAnimatedGestureHandlerMod.EventType.CANCELLED & Double = js.native
    
    @js.native
    sealed trait END
      extends StObject
         with EventType
    /* 5 */ val END: typingsJapgolly.reactNativeReanimated.libTypesReanimated2HookUseAnimatedGestureHandlerMod.EventType.END & Double = js.native
    
    @js.native
    sealed trait FAILED
      extends StObject
         with EventType
    /* 1 */ val FAILED: typingsJapgolly.reactNativeReanimated.libTypesReanimated2HookUseAnimatedGestureHandlerMod.EventType.FAILED & Double = js.native
    
    @js.native
    sealed trait UNDETERMINED
      extends StObject
         with EventType
    /* 0 */ val UNDETERMINED: typingsJapgolly.reactNativeReanimated.libTypesReanimated2HookUseAnimatedGestureHandlerMod.EventType.UNDETERMINED & Double = js.native
  }
