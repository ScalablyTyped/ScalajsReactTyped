...
import typingsJapgolly.reactNativeReanimated.libTypesReanimated2EasingMod.EasingFactoryFn
...
object libTypesReanimated2AnimationTimingMod {
  ...
  object InnerTimingAnimation {
    ...
    inline def apply(
      ...
      onStart: (/* nextAnimation */ TimingAnimation, /* import warning: importer.ImportType#apply Failed type conversion: react-native-reanimated.react-native-reanimated/lib/types/reanimated2/animation/timing.TimingAnimation extends react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.NumericAnimation ? number : react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.AnimatableValue */ /* current */ js.Any, /* timestamp */ Timestamp, /* previousAnimation */ TimingAnimation) => Callback,
      progress: Double,
      startTime: Timestamp,
      ...
      val __obj = js.Dynamic.literal(callback = js.Any.fromFunction2((t0: /* finished */ js.UndefOr[Boolean], t1: /* current */ js.UndefOr[AnimatableValue]) => (callback(t0, t1)).runNow()), current = current.asInstanceOf[js.Any], easing = js.Any.fromFunction1(easing), onFrame = js.Any.fromFunction2(onFrame), onStart = js.Any.fromFunction4((t0: /* nextAnimation */ TimingAnimation, t1: /* import warning: importer.ImportType#apply Failed type conversion: react-native-reanimated.react-native-reanimated/lib/types/reanimated2/animation/timing.TimingAnimation extends react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.NumericAnimation ? number : react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.AnimatableValue */ /* current */ js.Any, t2: /* timestamp */ Timestamp, t3: /* previousAnimation */ TimingAnimation) => (onStart(t0, t1, t2, t3)).runNow()), progress = progress.asInstanceOf[js.Any], startTime = startTime.asInstanceOf[js.Any], startValue = startValue.asInstanceOf[js.Any], toValue = toValue.asInstanceOf[js.Any])
    ...
    extension [Self <: InnerTimingAnimation](x: Self) {
      ...
      inline def setOnStart(
        value: (/* nextAnimation */ TimingAnimation, /* import warning: importer.ImportType#apply Failed type conversion: react-native-reanimated.react-native-reanimated/lib/types/reanimated2/animation/timing.TimingAnimation extends react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.NumericAnimation ? number : react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.AnimatableValue */ /* current */ js.Any, /* timestamp */ Timestamp, /* previousAnimation */ TimingAnimation) => Callback
      ): Self = StObject.set(x, "onStart", js.Any.fromFunction4((t0: /* nextAnimation */ TimingAnimation, t1: /* import warning: importer.ImportType#apply Failed type conversion: react-native-reanimated.react-native-reanimated/lib/types/reanimated2/animation/timing.TimingAnimation extends react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.NumericAnimation ? number : react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.AnimatableValue */ /* current */ js.Any, t2: /* timestamp */ Timestamp, t3: /* previousAnimation */ TimingAnimation) => (value(t0, t1, t2, t3)).runNow()))
  ...
  object TimingAnimation {
    ...
    inline def apply(
      ...
      onStart: (TimingAnimation, /* import warning: importer.ImportType#apply Failed type conversion: T extends react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.NumericAnimation ? number : react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.AnimatableValue */ js.Any, Timestamp, TimingAnimation) => Callback,
      progress: Double,
      startTime: Timestamp,
      startValue: AnimatableValue,
      ...
      val __obj = js.Dynamic.literal(callback = js.Any.fromFunction2((t0: /* finished */ js.UndefOr[Boolean], t1: /* current */ js.UndefOr[AnimatableValue]) => (callback(t0, t1)).runNow()), current = current.asInstanceOf[js.Any], easing = js.Any.fromFunction1(easing), onFrame = js.Any.fromFunction2(onFrame), onStart = js.Any.fromFunction4((t0: TimingAnimation, t1: /* import warning: importer.ImportType#apply Failed type conversion: T extends react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.NumericAnimation ? number : react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.AnimatableValue */ js.Any, t2: Timestamp, t3: TimingAnimation) => (onStart(t0, t1, t2, t3)).runNow()), progress = progress.asInstanceOf[js.Any], startTime = startTime.asInstanceOf[js.Any], startValue = startValue.asInstanceOf[js.Any], toValue = toValue.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
