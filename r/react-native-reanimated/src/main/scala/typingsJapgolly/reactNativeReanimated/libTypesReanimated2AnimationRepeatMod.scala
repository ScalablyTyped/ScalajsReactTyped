...
object libTypesReanimated2AnimationRepeatMod {
  ...
  object InnerRepeatAnimation {
    ...
    inline def apply(
      ...
      onStart: (/* nextAnimation */ RepeatAnimation, /* import warning: importer.ImportType#apply Failed type conversion: react-native-reanimated.react-native-reanimated/lib/types/reanimated2/animation/commonTypes.RepeatAnimation extends react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.NumericAnimation ? number : react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.AnimatableValue */ /* current */ js.Any, /* timestamp */ Timestamp, /* previousAnimation */ RepeatAnimation) => Callback,
      reps: Double,
      startValue: Double,
      toValue: Double
    ): InnerRepeatAnimation = {
      val __obj = js.Dynamic.literal(callback = js.Any.fromFunction2((t0: /* finished */ js.UndefOr[Boolean], t1: /* current */ js.UndefOr[AnimatableValue]) => (callback(t0, t1)).runNow()), onFrame = js.Any.fromFunction2(onFrame), onStart = js.Any.fromFunction4((t0: /* nextAnimation */ RepeatAnimation, t1: /* import warning: importer.ImportType#apply Failed type conversion: react-native-reanimated.react-native-reanimated/lib/types/reanimated2/animation/commonTypes.RepeatAnimation extends react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.NumericAnimation ? number : react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.AnimatableValue */ /* current */ js.Any, t2: /* timestamp */ Timestamp, t3: /* previousAnimation */ RepeatAnimation) => (onStart(t0, t1, t2, t3)).runNow()), reps = reps.asInstanceOf[js.Any], startValue = startValue.asInstanceOf[js.Any], toValue = toValue.asInstanceOf[js.Any])
    ...
    extension [Self <: InnerRepeatAnimation](x: Self) {
      ...
      inline def setOnStart(
        value: (/* nextAnimation */ RepeatAnimation, /* import warning: importer.ImportType#apply Failed type conversion: react-native-reanimated.react-native-reanimated/lib/types/reanimated2/animation/commonTypes.RepeatAnimation extends react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.NumericAnimation ? number : react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.AnimatableValue */ /* current */ js.Any, /* timestamp */ Timestamp, /* previousAnimation */ RepeatAnimation) => Callback
      ): Self = StObject.set(x, "onStart", js.Any.fromFunction4((t0: /* nextAnimation */ RepeatAnimation, t1: /* import warning: importer.ImportType#apply Failed type conversion: react-native-reanimated.react-native-reanimated/lib/types/reanimated2/animation/commonTypes.RepeatAnimation extends react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.NumericAnimation ? number : react-native-reanimated.react-native-reanimated/lib/types/reanimated2/commonTypes.AnimatableValue */ /* current */ js.Any, t2: /* timestamp */ Timestamp, t3: /* previousAnimation */ RepeatAnimation) => (value(t0, t1, t2, t3)).runNow()))
