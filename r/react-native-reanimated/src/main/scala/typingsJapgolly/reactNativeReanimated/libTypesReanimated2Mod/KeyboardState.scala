...
@JSImport("react-native-reanimated/lib/types/reanimated2", "KeyboardState")
@js.native
object KeyboardState extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[
    typingsJapgolly.reactNativeReanimated.libTypesReanimated2CommonTypesMod.KeyboardState & Double
  ] = js.native
