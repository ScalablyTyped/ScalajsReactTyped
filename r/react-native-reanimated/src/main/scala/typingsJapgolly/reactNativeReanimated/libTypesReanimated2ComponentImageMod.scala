...
object libTypesReanimated2ComponentImageMod extends Shortcut {
  
  @JSImport("react-native-reanimated/lib/types/reanimated2/component/Image", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libTypesReanimated2ComponentImageMod.foo` */
