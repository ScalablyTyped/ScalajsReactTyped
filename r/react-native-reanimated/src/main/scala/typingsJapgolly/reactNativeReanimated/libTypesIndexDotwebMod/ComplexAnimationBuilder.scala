...
@JSImport("react-native-reanimated/lib/types/index.web", "ComplexAnimationBuilder")
@js.native
open class ComplexAnimationBuilder ()
  extends typingsJapgolly.reactNativeReanimated.libTypesReanimated2Mod.ComplexAnimationBuilder
/* static members */
