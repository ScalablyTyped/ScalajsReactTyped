...
object libTypesReanimated2ComponentTextMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `libTypesReanimated2ComponentTextMod.foo` */
