...
import typingsJapgolly.reactQuery.reactQueryStrings.continue
import typingsJapgolly.reactQuery.reactQueryStrings.error
import typingsJapgolly.reactQuery.reactQueryStrings.failed
import typingsJapgolly.reactQuery.reactQueryStrings.loading
import typingsJapgolly.reactQuery.reactQueryStrings.pause
import typingsJapgolly.reactQuery.reactQueryStrings.setState
import typingsJapgolly.reactQuery.reactQueryStrings.success
import typingsJapgolly.reactQuery.typesCoreMutationCacheMod.MutationCache
import typingsJapgolly.reactQuery.typesCoreMutationObserverMod.MutationObserver
import typingsJapgolly.reactQuery.typesCoreTypesMod.MutationMeta
...
object typesCoreMutationMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactQuery.typesCoreMutationMod.ContinueAction
    - typingsJapgolly.reactQuery.typesCoreMutationMod.ErrorAction[TError]
    - typingsJapgolly.reactQuery.typesCoreMutationMod.FailedAction
    - typingsJapgolly.reactQuery.typesCoreMutationMod.LoadingAction[TVariables, TContext]
    - typingsJapgolly.reactQuery.typesCoreMutationMod.PauseAction
    - typingsJapgolly.reactQuery.typesCoreMutationMod.SetStateAction[TData, TError, TVariables, TContext]
    - typingsJapgolly.reactQuery.typesCoreMutationMod.SuccessAction[TData]
  */
  trait Action[TData, TError, TVariables, TContext] extends StObject
  object Action {
    
    inline def ContinueAction(): typingsJapgolly.reactQuery.typesCoreMutationMod.ContinueAction = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("continue")
      __obj.asInstanceOf[typingsJapgolly.reactQuery.typesCoreMutationMod.ContinueAction]
    }
    
    inline def ErrorAction[TError](error: TError): typingsJapgolly.reactQuery.typesCoreMutationMod.ErrorAction[TError] = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("error")
      __obj.asInstanceOf[typingsJapgolly.reactQuery.typesCoreMutationMod.ErrorAction[TError]]
    }
    
    inline def FailedAction(): typingsJapgolly.reactQuery.typesCoreMutationMod.FailedAction = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("failed")
      __obj.asInstanceOf[typingsJapgolly.reactQuery.typesCoreMutationMod.FailedAction]
    }
    
    inline def LoadingAction[TVariables, TContext](): typingsJapgolly.reactQuery.typesCoreMutationMod.LoadingAction[TVariables, TContext] = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("loading")
      __obj.asInstanceOf[typingsJapgolly.reactQuery.typesCoreMutationMod.LoadingAction[TVariables, TContext]]
    }
    
    inline def PauseAction(): typingsJapgolly.reactQuery.typesCoreMutationMod.PauseAction = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("pause")
      __obj.asInstanceOf[typingsJapgolly.reactQuery.typesCoreMutationMod.PauseAction]
    }
    
    inline def SetStateAction[TData, TError, TVariables, TContext](state: MutationState[TData, TError, TVariables, TContext]): typingsJapgolly.reactQuery.typesCoreMutationMod.SetStateAction[TData, TError, TVariables, TContext] = {
      val __obj = js.Dynamic.literal(state = state.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("setState")
      __obj.asInstanceOf[typingsJapgolly.reactQuery.typesCoreMutationMod.SetStateAction[TData, TError, TVariables, TContext]]
    }
    
    inline def SuccessAction[TData](data: TData): typingsJapgolly.reactQuery.typesCoreMutationMod.SuccessAction[TData] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("success")
      __obj.asInstanceOf[typingsJapgolly.reactQuery.typesCoreMutationMod.SuccessAction[TData]]
    }
  }
