...
import typingsJapgolly.reactQuery.anon.Mutate
import typingsJapgolly.reactQuery.anon.MutateAsync
...
import typingsJapgolly.reactQuery.typesCoreTypesMod.MutationObserverResult
