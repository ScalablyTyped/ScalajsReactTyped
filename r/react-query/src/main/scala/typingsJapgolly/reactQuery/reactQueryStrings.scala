...
import typingsJapgolly.reactQuery.typesCoreTypesMod.MutationStatus
import typingsJapgolly.reactQuery.typesCoreTypesMod.QueryStatus
import typingsJapgolly.reactQuery.typesCoreUtilsMod.QueryStatusFilter
...
object reactQueryStrings {
  ...
  @js.native
  sealed trait Numbersign006bff extends StObject
  inline def Numbersign006bff: Numbersign006bff = "#006bff".asInstanceOf[Numbersign006bff]
  
  @js.native
  sealed trait Numbersign00ab52 extends StObject
  inline def Numbersign00ab52: Numbersign00ab52 = "#00ab52".asInstanceOf[Numbersign00ab52]
  
  @js.native
  sealed trait Numbersign0b1521 extends StObject
  inline def Numbersign0b1521: Numbersign0b1521 = "#0b1521".asInstanceOf[Numbersign0b1521]
  
  @js.native
  sealed trait Numbersign132337 extends StObject
  inline def Numbersign132337: Numbersign132337 = "#132337".asInstanceOf[Numbersign132337]
  
  @js.native
  sealed trait Numbersign222e3e extends StObject
  inline def Numbersign222e3e: Numbersign222e3e = "#222e3e".asInstanceOf[Numbersign222e3e]
  
  @js.native
  sealed trait Numbersign3f4e60 extends StObject
  inline def Numbersign3f4e60: Numbersign3f4e60 = "#3f4e60".asInstanceOf[Numbersign3f4e60]
  
  @js.native
  sealed trait Numbersignff0085 extends StObject
  inline def Numbersignff0085: Numbersignff0085 = "#ff0085".asInstanceOf[Numbersignff0085]
  
  @js.native
  sealed trait Numbersignffb200 extends StObject
  inline def Numbersignffb200: Numbersignffb200 = "#ffb200".asInstanceOf[Numbersignffb200]
  ...
  @js.native
  sealed trait fetching extends StObject
  inline def fetching: fetching = "fetching".asInstanceOf[fetching]
  ...
  @js.native
  sealed trait fresh extends StObject
  inline def fresh: fresh = "fresh".asInstanceOf[fresh]
  ...
  @js.native
  sealed trait mutationFn extends StObject
  inline def mutationFn: mutationFn = "mutationFn".asInstanceOf[mutationFn]
  
  @js.native
  sealed trait mutationKey extends StObject
  inline def mutationKey: mutationKey = "mutationKey".asInstanceOf[mutationKey]
  ...
  @js.native
  sealed trait observerAdded extends StObject
  inline def observerAdded: observerAdded = "observerAdded".asInstanceOf[observerAdded]
  
  @js.native
  sealed trait observerRemoved extends StObject
  inline def observerRemoved: observerRemoved = "observerRemoved".asInstanceOf[observerRemoved]
  
  @js.native
  sealed trait observerResultsUpdated extends StObject
  inline def observerResultsUpdated: observerResultsUpdated = "observerResultsUpdated".asInstanceOf[observerResultsUpdated]
  ...
  @js.native
  sealed trait queryAdded extends StObject
  inline def queryAdded: queryAdded = "queryAdded".asInstanceOf[queryAdded]
  
  @js.native
  sealed trait queryFn extends StObject
  inline def queryFn: queryFn = "queryFn".asInstanceOf[queryFn]
  
  @js.native
  sealed trait queryKey extends StObject
  inline def queryKey: queryKey = "queryKey".asInstanceOf[queryKey]
  
  @js.native
  sealed trait queryRemoved extends StObject
  inline def queryRemoved: queryRemoved = "queryRemoved".asInstanceOf[queryRemoved]
  
  @js.native
  sealed trait queryUpdated extends StObject
  inline def queryUpdated: queryUpdated = "queryUpdated".asInstanceOf[queryUpdated]
  ...
  @js.native
  sealed trait tracked extends StObject
