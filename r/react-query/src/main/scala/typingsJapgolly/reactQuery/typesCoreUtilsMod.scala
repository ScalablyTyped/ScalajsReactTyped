...
object typesCoreUtilsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactQuery.reactQueryStrings.all
    - typingsJapgolly.reactQuery.reactQueryStrings.active
    - typingsJapgolly.reactQuery.reactQueryStrings.inactive
    - typingsJapgolly.reactQuery.reactQueryStrings.none
  */
  trait QueryStatusFilter extends StObject
  object QueryStatusFilter {
    
    inline def active: typingsJapgolly.reactQuery.reactQueryStrings.active = "active".asInstanceOf[typingsJapgolly.reactQuery.reactQueryStrings.active]
    
    inline def all: typingsJapgolly.reactQuery.reactQueryStrings.all = "all".asInstanceOf[typingsJapgolly.reactQuery.reactQueryStrings.all]
    
    inline def inactive: typingsJapgolly.reactQuery.reactQueryStrings.inactive = "inactive".asInstanceOf[typingsJapgolly.reactQuery.reactQueryStrings.inactive]
    
    inline def none: typingsJapgolly.reactQuery.reactQueryStrings.none = "none".asInstanceOf[typingsJapgolly.reactQuery.reactQueryStrings.none]
  }
