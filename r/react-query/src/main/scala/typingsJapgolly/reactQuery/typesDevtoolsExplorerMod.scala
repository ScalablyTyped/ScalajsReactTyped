...
object typesDevtoolsExplorerMod {
  ...
  object ExplorerProps {
    ...
    extension [Self <: ExplorerProps](x: Self) {
      ...
      inline def setHandleEntry(value: /* props */ typingsJapgolly.reactQuery.anon.Entry => Element): Self = StObject.set(x, "HandleEntry", js.Any.fromFunction1(value))
      ...
      inline def setToggleExpanded(value: Callback): Self = StObject.set(x, "toggleExpanded", value.toJsFn)
  ...
  type HandleEntryComponent = js.Function1[/* props */ typingsJapgolly.reactQuery.anon.Entry, Element]
