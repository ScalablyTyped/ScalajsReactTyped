...
object Label {
  ...
  implicit def make(companion: Label.type): SharedBuilder_HTMLAttributesRefAttributes298282053[HTMLSpanElement] = new SharedBuilder_HTMLAttributesRefAttributes298282053[HTMLSpanElement](js.Array(this.component, js.Dictionary.empty))()
