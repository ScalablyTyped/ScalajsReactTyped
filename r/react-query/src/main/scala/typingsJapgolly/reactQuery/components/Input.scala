...
import typingsJapgolly.reactQuery.anon.PickDetailedHTMLPropsInpu
...
object Input {
  ...
  def withProps(p: PickDetailedHTMLPropsInpu): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
