...
object SubEntries {
  ...
  implicit def make(companion: SubEntries.type): SharedBuilder_HTMLAttributesRefAttributes_1417115160[HTMLDivElement] = new SharedBuilder_HTMLAttributesRefAttributes_1417115160[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
