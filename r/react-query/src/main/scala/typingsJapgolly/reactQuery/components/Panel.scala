...
object Panel {
  ...
  implicit def make(companion: Panel.type): SharedBuilder_HTMLAttributesRefAttributes_1417115160[HTMLDivElement] = new SharedBuilder_HTMLAttributesRefAttributes_1417115160[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
