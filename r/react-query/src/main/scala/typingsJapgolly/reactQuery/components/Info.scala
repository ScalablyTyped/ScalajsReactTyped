...
object Info {
  ...
  implicit def make(companion: Info.type): SharedBuilder_HTMLAttributesRefAttributes298282053[HTMLSpanElement] = new SharedBuilder_HTMLAttributesRefAttributes298282053[HTMLSpanElement](js.Array(this.component, js.Dictionary.empty))()
