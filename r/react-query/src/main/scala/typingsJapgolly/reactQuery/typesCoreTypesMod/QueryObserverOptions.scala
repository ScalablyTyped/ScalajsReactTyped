...
import typingsJapgolly.reactQuery.reactQueryStrings.always
import typingsJapgolly.reactQuery.reactQueryStrings.tracked
...
object QueryObserverOptions {
  ...
  extension [Self <: QueryObserverOptions[?, ?, ?, ?, ?], TQueryFnData, TError, TData, TQueryData, TQueryKey /* <: QueryKey */](x: Self & (QueryObserverOptions[TQueryFnData, TError, TData, TQueryData, TQueryKey])) {
    ...
    inline def setOnError(value: /* err */ TError => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* err */ TError) => value(t0).runNow()))
    
    inline def setOnErrorUndefined: Self = StObject.set(x, "onError", js.undefined)
    
    inline def setOnSettled(value: (/* data */ js.UndefOr[TData], /* error */ TError | Null) => Callback): Self = StObject.set(x, "onSettled", js.Any.fromFunction2((t0: /* data */ js.UndefOr[TData], t1: /* error */ TError | Null) => (value(t0, t1)).runNow()))
    ...
    inline def setPlaceholderDataCallbackTo(value: CallbackTo[js.UndefOr[TQueryData]]): Self = StObject.set(x, "placeholderData", value.toJsFn)
