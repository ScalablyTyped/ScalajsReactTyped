...
import typingsJapgolly.reactQuery.typesCoreQueryMod.QueryBehavior
import typingsJapgolly.reactQuery.typesCoreRetryerMod.RetryDelayValue
import typingsJapgolly.reactQuery.typesCoreRetryerMod.RetryValue
...
object QueryOptions {
  ...
  extension [Self <: QueryOptions[?, ?, ?, ?], TQueryFnData, TError, TData, TQueryKey /* <: QueryKey */](x: Self & (QueryOptions[TQueryFnData, TError, TData, TQueryKey])) {
    ...
    inline def setInitialDataCallbackTo(value: CallbackTo[js.UndefOr[TData]]): Self = StObject.set(x, "initialData", value.toJsFn)
    ...
    inline def setInitialDataUpdatedAtCallbackTo(value: CallbackTo[js.UndefOr[Double]]): Self = StObject.set(x, "initialDataUpdatedAt", value.toJsFn)
