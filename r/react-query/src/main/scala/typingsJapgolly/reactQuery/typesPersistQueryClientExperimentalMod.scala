...
import typingsJapgolly.typeFest.sourcePromisableMod.Promisable
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object typesPersistQueryClientExperimentalMod {
  ...
  object Persistor {
    ...
    inline def apply(
      ...
      removeClient: CallbackTo[Promisable[Unit]],
      restoreClient: CallbackTo[Promisable[js.UndefOr[PersistedClient]]]
    ): Persistor = {
      val __obj = js.Dynamic.literal(persistClient = js.Any.fromFunction1(persistClient), removeClient = removeClient.toJsFn, restoreClient = restoreClient.toJsFn)
    ...
    extension [Self <: Persistor](x: Self) {
      ...
      inline def setRemoveClient(value: CallbackTo[Promisable[Unit]]): Self = StObject.set(x, "removeClient", value.toJsFn)
      
      inline def setRestoreClient(value: CallbackTo[Promisable[js.UndefOr[PersistedClient]]]): Self = StObject.set(x, "restoreClient", value.toJsFn)
    }
  }
}
