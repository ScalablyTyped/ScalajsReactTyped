...
object mod extends Shortcut {
  ...
  object DownloadTaskState extends StObject {
    ...
    /* "DONE" */ val DONE: typingsJapgolly.reactNativeBackgroundDownloader.mod.DownloadTaskState.DONE & String = js.native
    
    @js.native
    sealed trait DOWNLOADING
      extends StObject
         with DownloadTaskState
    /* "DOWNLOADING" */ val DOWNLOADING: typingsJapgolly.reactNativeBackgroundDownloader.mod.DownloadTaskState.DOWNLOADING & String = js.native
    
    @js.native
    sealed trait FAILED
      extends StObject
         with DownloadTaskState
    /* "FAILED" */ val FAILED: typingsJapgolly.reactNativeBackgroundDownloader.mod.DownloadTaskState.FAILED & String = js.native
    
    @js.native
    sealed trait PAUSED
      extends StObject
         with DownloadTaskState
    /* "PAUSED" */ val PAUSED: typingsJapgolly.reactNativeBackgroundDownloader.mod.DownloadTaskState.PAUSED & String = js.native
    
    @js.native
    sealed trait STOPPED
      extends StObject
         with DownloadTaskState
    /* "STOPPED" */ val STOPPED: typingsJapgolly.reactNativeBackgroundDownloader.mod.DownloadTaskState.STOPPED & String = js.native
  }
  ...
  object DownloadTask {
    ...
    inline def apply(
      ...
      id: String,
      pause: CallbackTo[Any],
      percent: Double,
      progress: ProgressHandler => DownloadTask,
      resume: CallbackTo[Any],
      state: DownloadTaskState,
      stop: CallbackTo[Any],
      totalBytes: Double
    ): DownloadTask = {
      val __obj = js.Dynamic.literal(_beginHandler = js.Any.fromFunction1(_beginHandler), _doneHandler = _doneHandler.toJsFn, _errorHandler = js.Any.fromFunction2(_errorHandler), _progressHandler = js.Any.fromFunction3(_progressHandler), begin = js.Any.fromFunction1(begin), bytesWritten = bytesWritten.asInstanceOf[js.Any], done = js.Any.fromFunction1(done), error = js.Any.fromFunction1(error), id = id.asInstanceOf[js.Any], pause = pause.toJsFn, percent = percent.asInstanceOf[js.Any], progress = js.Any.fromFunction1(progress), resume = resume.toJsFn, state = state.asInstanceOf[js.Any], stop = stop.toJsFn, totalBytes = totalBytes.asInstanceOf[js.Any])
    ...
    extension [Self <: DownloadTask](x: Self) {
      ...
      inline def setResume(value: CallbackTo[Any]): Self = StObject.set(x, "resume", value.toJsFn)
      ...
      inline def set_doneHandler(value: CallbackTo[Any]): Self = StObject.set(x, "_doneHandler", value.toJsFn)
  ...
  trait RNBackgroundDownloader extends StObject {
    ...
    var Network: typingsJapgolly.reactNativeBackgroundDownloader.mod.Network
    
    var Priority: typingsJapgolly.reactNativeBackgroundDownloader.mod.Priority
  ...
  object RNBackgroundDownloader {
    ...
    inline def apply(
      Network: Network,
      Priority: Priority,
      checkForExistingDownloads: CallbackTo[js.Promise[js.Array[DownloadTask]]],
      directories: Directories_,
      download: /* options */ DownloadOption => DownloadTask,
      setHeaders: /* h */ DownloadHeaders => Callback
    ): RNBackgroundDownloader = {
      val __obj = js.Dynamic.literal(Network = Network.asInstanceOf[js.Any], Priority = Priority.asInstanceOf[js.Any], checkForExistingDownloads = checkForExistingDownloads.toJsFn, directories = directories.asInstanceOf[js.Any], download = js.Any.fromFunction1(download), setHeaders = js.Any.fromFunction1((t0: /* h */ DownloadHeaders) => setHeaders(t0).runNow()))
      __obj.asInstanceOf[RNBackgroundDownloader]
    }
    
    extension [Self <: RNBackgroundDownloader](x: Self) {
      
      inline def setCheckForExistingDownloads(value: CallbackTo[js.Promise[js.Array[DownloadTask]]]): Self = StObject.set(x, "checkForExistingDownloads", value.toJsFn)
      ...
      inline def setSetHeaders(value: /* h */ DownloadHeaders => Callback): Self = StObject.set(x, "setHeaders", js.Any.fromFunction1((t0: /* h */ DownloadHeaders) => value(t0).runNow()))
    }
  }
