...
trait RNBackgroundDownloader extends js.Object {
  var Network: typingsJapgolly.reactNativeBackgroundDownloader.mod.Network = js.native
  var Priority: typingsJapgolly.reactNativeBackgroundDownloader.mod.Priority = js.native
