...
object mod {
  ...
  object Events {
    ...
    extension [Self <: Events](x: Self) {
      ...
      inline def setOnKeyPress(value: CallbackTo[Any]): Self = StObject.set(x, "onKeyPress", value.toJsFn)
      
      inline def setOnKeyPressUndefined: Self = StObject.set(x, "onKeyPress", js.undefined)
      
      inline def setOnSliderDragEnd(value: CallbackTo[Any]): Self = StObject.set(x, "onSliderDragEnd", value.toJsFn)
      
      inline def setOnSliderDragEndUndefined: Self = StObject.set(x, "onSliderDragEnd", js.undefined)
      
      inline def setOnSliderDragMove(value: CallbackTo[Any]): Self = StObject.set(x, "onSliderDragMove", value.toJsFn)
      
      inline def setOnSliderDragMoveUndefined: Self = StObject.set(x, "onSliderDragMove", js.undefined)
      
      inline def setOnSliderDragStart(value: CallbackTo[Any]): Self = StObject.set(x, "onSliderDragStart", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rheostat.rheostatStrings.horizontal
    - typingsJapgolly.rheostat.rheostatStrings.vertical
  */
  trait Orientation extends StObject
  object Orientation {
    
    inline def horizontal: typingsJapgolly.rheostat.rheostatStrings.horizontal = "horizontal".asInstanceOf[typingsJapgolly.rheostat.rheostatStrings.horizontal]
    
    inline def vertical: typingsJapgolly.rheostat.rheostatStrings.vertical = "vertical".asInstanceOf[typingsJapgolly.rheostat.rheostatStrings.vertical]
  }
  ...
  trait Props
    ...
    var background: js.UndefOr[ElementType] = js.undefined
    
    var className: js.UndefOr[String] = js.undefined
    
    var disabled: js.UndefOr[Boolean] = js.undefined
    
    var handle: js.UndefOr[ElementType] = js.undefined
    ...
    var pitComponent: js.UndefOr[ElementType] = js.undefined
    
    var pitPoints: js.UndefOr[js.Array[Double]] = js.undefined
    
    var progressBar: js.UndefOr[ElementType] = js.undefined
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setBackground(value: ElementType): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
      ...
      inline def setHandle(value: ElementType): Self = StObject.set(x, "handle", value.asInstanceOf[js.Any])
      ...
      inline def setPitComponent(value: ElementType): Self = StObject.set(x, "pitComponent", value.asInstanceOf[js.Any])
      ...
      inline def setProgressBar(value: ElementType): Self = StObject.set(x, "progressBar", value.asInstanceOf[js.Any])
  ...
  type Rheostat = japgolly.scalajs.react.facade.React.Component[Props & js.Object, js.Object]
}
