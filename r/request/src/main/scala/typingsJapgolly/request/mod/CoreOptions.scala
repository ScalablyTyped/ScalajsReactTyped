...
import typingsJapgolly.request.requestInts.`4`
import typingsJapgolly.request.requestInts.`6`
...
trait CoreOptions extends StObject {
  ...
  var agentOptions: js.UndefOr[AgentOptions | typingsJapgolly.node.httpsMod.AgentOptions] = js.undefined
...
object CoreOptions {
  ...
  extension [Self <: CoreOptions](x: Self) {
    ...
    inline def setAgentOptions(value: AgentOptions | typingsJapgolly.node.httpsMod.AgentOptions): Self = StObject.set(x, "agentOptions", value.asInstanceOf[js.Any])
    ...
    inline def setCallback(value: (/* error */ Any, /* response */ Response, /* body */ Any) => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction3((t0: /* error */ Any, t1: /* response */ Response, t2: /* body */ Any) => (value(t0, t1, t2)).runNow()))
