...
import typingsJapgolly.caseless.mod.Httpified
...
import typingsJapgolly.request.anon.Urlhrefstringpathnamestri
import typingsJapgolly.request.requestBooleans.`false`
import typingsJapgolly.request.requestBooleans.`true`
import typingsJapgolly.request.requestStrings.complete
import typingsJapgolly.request.requestStrings.data
import typingsJapgolly.request.requestStrings.error
import typingsJapgolly.request.requestStrings.pipe
import typingsJapgolly.request.requestStrings.request
import typingsJapgolly.request.requestStrings.response
import typingsJapgolly.request.requestStrings.socket
...
trait Request
  ...
  var agent: `false` | Agent | typingsJapgolly.node.httpsMod.Agent = js.native
  ...
  def form(): typingsJapgolly.formData.mod.^ = js.native
