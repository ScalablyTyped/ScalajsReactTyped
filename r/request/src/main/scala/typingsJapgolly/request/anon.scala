...
import typingsJapgolly.request.mod.MultipartBody
import typingsJapgolly.request.mod.NameValuePair
...
object anon {
  ...
  trait keystringAgentAgentExtraP
    extends StObject
       with /* key */ StringDictionary[Agent | typingsJapgolly.node.httpsMod.Agent]
       with PoolOptions {
