...
object Image {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[ImageCls] {
  ...
  def withProps(p: AnimatableProperties[ImageStyle] & ImageProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
