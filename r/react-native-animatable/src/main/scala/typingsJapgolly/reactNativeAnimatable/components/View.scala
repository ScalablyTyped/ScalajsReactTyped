...
import typingsJapgolly.reactNativeAnimatable.mod.ViewCls
...
object View {
  def apply(
    ...
    AnimatableProperties[ViewStyle] with ViewProperties, 
    ViewCls, 
    Unit, 
    AnimatableProperties[ViewStyle] with ViewProperties
  ] = {
  ...
  typingsJapgolly.reactNativeAnimatable.mod.AnimatableProperties[typingsJapgolly.reactNative.mod.ViewStyle] with typingsJapgolly.reactNative.mod.ViewProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeAnimatable.mod.ViewCls](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeAnimatable.mod.AnimatableProperties[typingsJapgolly.reactNative.mod.ViewStyle] with typingsJapgolly.reactNative.mod.ViewProperties])(children: _*)
  }
