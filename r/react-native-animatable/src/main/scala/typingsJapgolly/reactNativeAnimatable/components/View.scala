...
object View {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[ViewCls] {
  ...
  def withProps(p: AnimatableProperties[ViewStyle] & ViewProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
