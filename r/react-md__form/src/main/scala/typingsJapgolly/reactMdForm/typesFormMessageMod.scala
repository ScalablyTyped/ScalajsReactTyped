...
import typingsJapgolly.reactMdForm.reactMdFormStrings.alert
...
object typesFormMessageMod {
  
  @JSImport("@react-md/form/types/FormMessage", "FormMessage")
  @js.native
  val FormMessage: ForwardRefExoticComponent[FormMessagePropsPartialFo] = js.native
  
  trait FormMessageInputLengthCounterProps extends StObject {
    
    /**
      * An optional className to apply to the counter wrapper element.
      */
    var counterClassName: js.UndefOr[String] = js.undefined
    
    /**
      * An optional style to apply to the counter wrapper element.
      */
    var counterStyle: js.UndefOr[CSSProperties] = js.undefined
  ...
  object FormMessageInputLengthCounterProps {
    
    inline def apply(length: Double, maxLength: Double): FormMessageInputLengthCounterProps = {
    ...
    extension [Self <: FormMessageInputLengthCounterProps](x: Self) {
      ...
      inline def setCounterClassNameUndefined: Self = StObject.set(x, "counterClassName", js.undefined)
      
      inline def setCounterStyle(value: CSSProperties): Self = StObject.set(x, "counterStyle", value.asInstanceOf[js.Any])
  ...
  object FormMessageProps {
    ...
    inline def apply(id: String): FormMessageProps = {
  ...
  trait FormMessageWithCounterProps
    extends StObject
       with FormMessageProps
       with FormMessageInputLengthCounterProps
  object FormMessageWithCounterProps {
    
    inline def apply(id: String, length: Double, maxLength: Double): FormMessageWithCounterProps = {
