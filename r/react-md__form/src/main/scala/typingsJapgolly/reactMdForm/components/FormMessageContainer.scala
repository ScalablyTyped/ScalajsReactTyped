...
object FormMessageContainer {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def messageProps(value: MessageProps): this.type = set("messageProps", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: FormMessageContainer.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FormMessageContainerProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
