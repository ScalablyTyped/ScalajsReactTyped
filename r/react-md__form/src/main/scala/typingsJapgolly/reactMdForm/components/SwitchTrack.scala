...
object SwitchTrack {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def ballClassName(value: String): this.type = set("ballClassName", value.asInstanceOf[js.Any])
    
    inline def ballStyle(value: CSSProperties): this.type = set("ballStyle", value.asInstanceOf[js.Any])
    ...
    inline def containerProps(value: PropsWithRef[HTMLAttributes[HTMLSpanElement], HTMLSpanElement]): this.type = set("containerProps", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: SwitchTrack.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SwitchTrackProps & RefAttributes[HTMLInputElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
