...
object MenuItemCheckbox {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[MenuItemCheckboxProps & RefAttributes[HTMLLIElement]]))
  }
  ...
  def withProps(p: MenuItemCheckboxProps & RefAttributes[HTMLLIElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
