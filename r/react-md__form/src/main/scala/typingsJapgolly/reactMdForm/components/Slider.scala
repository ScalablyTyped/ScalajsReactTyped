...
object Slider {
  ...
  inline def apply(
    ...
    minimum: Callback,
    persist: Callback,
    setValue: SetStateAction[typingsJapgolly.reactMdForm.typesSliderTypesMod.SliderValue] => Callback,
    step: Double,
    value: typingsJapgolly.reactMdForm.typesSliderTypesMod.SliderValue
  ): Builder = {
    val __props = js.Dynamic.literal(baseId = baseId.asInstanceOf[js.Any], decrement = decrement.toJsFn, decrementJump = decrementJump.toJsFn, increment = increment.toJsFn, incrementJump = incrementJump.toJsFn, max = max.asInstanceOf[js.Any], maximum = maximum.toJsFn, min = min.asInstanceOf[js.Any], minimum = minimum.toJsFn, persist = persist.toJsFn, setValue = js.Any.fromFunction1((t0: SetStateAction[typingsJapgolly.reactMdForm.typesSliderTypesMod.SliderValue]) => setValue(t0).runNow()), step = step.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[SliderProps & RefAttributes[HTMLDivElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def thumbLabel(value: String): this.type = set("thumbLabel", value.asInstanceOf[js.Any])
    
    inline def thumbLabelledBy(value: String): this.type = set("thumbLabelledBy", value.asInstanceOf[js.Any])
    
    inline def thumbProps(value: PropsWithRef[HTMLAttributes[HTMLSpanElement], HTMLSpanElement]): this.type = set("thumbProps", value.asInstanceOf[js.Any])
  ...
  def withProps(p: SliderProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
