...
import typingsJapgolly.reactMdForm.anon.FormMessagePropsrefRefHTM
import typingsJapgolly.reactMdForm.anon.HTMLAttributesHTMLDivElem
...
object TextAreaWithMessage {
  
  inline def apply(id: String): Builder = {
    val __props = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[TextAreaPropsmessageProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def areaClassName(value: String): this.type = set("areaClassName", value.asInstanceOf[js.Any])
    
    inline def areaStyle(value: CSSProperties): this.type = set("areaStyle", value.asInstanceOf[js.Any])
    ...
    inline def messageContainerProps(value: HTMLAttributesHTMLDivElem): this.type = set("messageContainerProps", value.asInstanceOf[js.Any])
    
    inline def messageProps(value: FormMessagePropsrefRefHTM): this.type = set("messageProps", value.asInstanceOf[js.Any])
    ...
    inline def onSelect(value: ReactEventFrom[HTMLTextAreaElement & org.scalajs.dom.Element] => Callback): this.type = set("onSelect", js.Any.fromFunction1((t0: ReactEventFrom[HTMLTextAreaElement & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def resize(value: TextAreaResize): this.type = set("resize", value.asInstanceOf[js.Any])
  ...
  def withProps(p: TextAreaPropsmessageProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
