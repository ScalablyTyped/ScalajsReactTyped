...
import typingsJapgolly.reactMdForm.reactMdFormStrings.label
import typingsJapgolly.reactMdForm.reactMdFormStrings.span
import typingsJapgolly.reactMdForm.typesLabelFloatingLabelMod.FloatingLabelProps
...
object FloatingLabel {
  ...
  inline def apply(htmlFor: String, valued: Boolean): Builder = {
    val __props = js.Dynamic.literal(htmlFor = htmlFor.asInstanceOf[js.Any], valued = valued.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[FloatingLabelProps & RefAttributes[HTMLLabelElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def component(value: label | span): this.type = set("component", value.asInstanceOf[js.Any])
  ...
  def withProps(p: FloatingLabelProps & RefAttributes[HTMLLabelElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
