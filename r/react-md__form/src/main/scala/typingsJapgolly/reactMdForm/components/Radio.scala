...
object Radio {
  ...
  inline def apply(id: String, value: js.Array[String] | String | Double): Builder = {
    val __props = js.Dynamic.literal(id = id.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[RadioProps & RefAttributes[HTMLInputElement]]))
  }
  ...
  def withProps(p: RadioProps & RefAttributes[HTMLInputElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
