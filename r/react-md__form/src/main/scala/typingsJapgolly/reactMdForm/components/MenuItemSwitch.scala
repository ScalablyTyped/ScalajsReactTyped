...
object MenuItemSwitch {
  
  inline def apply(
    checked: Boolean,
    id: String,
    onCheckedChange: (/* checked */ Boolean, /* event */ ReactMouseEventFrom[HTMLLIElement]) => Callback
  ): Builder = {
    val __props = js.Dynamic.literal(checked = checked.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], onCheckedChange = js.Any.fromFunction2((t0: /* checked */ Boolean, t1: /* event */ ReactMouseEventFrom[HTMLLIElement]) => (onCheckedChange(t0, t1)).runNow()))
    new Builder(js.Array(this.component, __props.asInstanceOf[MenuItemSwitchProps & RefAttributes[HTMLLIElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def addon(value: VdomNode): this.type = set("addon", value.rawNode.asInstanceOf[js.Any])
    
    inline def addonNull: this.type = set("addon", null)
    
    inline def addonPosition(value: ListItemAddonPosition): this.type = set("addonPosition", value.asInstanceOf[js.Any])
    
    inline def addonType(value: ListItemAddonType): this.type = set("addonType", value.asInstanceOf[js.Any])
  ...
  def withProps(p: MenuItemSwitchProps & RefAttributes[HTMLLIElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
