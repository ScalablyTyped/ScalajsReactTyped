...
object TextFieldContainer {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def label(value: Boolean): this.type = set("label", value.asInstanceOf[js.Any])
  ...
  def withProps(p: TextFieldContainerProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
