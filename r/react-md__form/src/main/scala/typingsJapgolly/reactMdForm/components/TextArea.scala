...
object TextArea {
  ...
  inline def apply(id: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[TextAreaProps & RefAttributes[HTMLTextAreaElement]]))
  }
  ...
  def withProps(p: TextAreaProps & RefAttributes[HTMLTextAreaElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
