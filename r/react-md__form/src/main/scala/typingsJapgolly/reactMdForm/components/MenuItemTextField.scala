...
import typingsJapgolly.reactMdForm.typesTextFieldTextFieldMod.SupportedInputTypes
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object MenuItemTextField {
  
  inline def apply(id: String): Builder = {
    val __props = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[MenuItemTextFieldProps & RefAttributes[HTMLInputElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def liProps(value: ReadonlyPropsWithRefHTMLA): this.type = set("liProps", value.asInstanceOf[js.Any])
    ...
    inline def `type`(value: SupportedInputTypes): this.type = set("type", value.asInstanceOf[js.Any])
  ...
  def withProps(p: MenuItemTextFieldProps & RefAttributes[HTMLInputElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
