...
object Select {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[SelectProps & RefAttributes[HTMLDivElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def disableLeftAddon(value: Boolean): this.type = set("disableLeftAddon", value.asInstanceOf[js.Any])
    ...
    inline def displayLabelClassName(value: String): this.type = set("displayLabelClassName", value.asInstanceOf[js.Any])
    
    inline def displayLabelStyle(value: CSSProperties): this.type = set("displayLabelStyle", value.asInstanceOf[js.Any])
    
    inline def draggable(value: Booleanish): this.type = set("draggable", value.asInstanceOf[js.Any])
    
    inline def error(value: Boolean): this.type = set("error", value.asInstanceOf[js.Any])
    
    inline def getDisplayLabel(value: (/* option */ ListboxOption, /* labelKey */ String, /* includeLeft */ Boolean) => Node): this.type = set("getDisplayLabel", js.Any.fromFunction3(value))
  ...
  def withProps(p: SelectProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
