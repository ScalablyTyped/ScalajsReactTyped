...
object TextField {
  ...
  inline def apply(id: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[TextFieldProps & RefAttributes[HTMLInputElement]]))
  }
  ...
  def withProps(p: TextFieldProps & RefAttributes[HTMLInputElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
