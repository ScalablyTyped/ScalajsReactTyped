...
object Switch {
  ...
  inline def apply(id: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[SwitchProps & RefAttributes[HTMLInputElement]]))
  }
  ...
  def withProps(p: SwitchProps & RefAttributes[HTMLInputElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
