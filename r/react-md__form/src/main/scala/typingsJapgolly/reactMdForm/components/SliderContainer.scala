...
object SliderContainer {
  
  inline def apply(labelId: String): Builder = {
    val __props = js.Dynamic.literal(labelId = labelId.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[SliderContainerProps & RefAttributes[HTMLDivElement]]))
  }
  ...
  def withProps(p: SliderContainerProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
