...
object MenuItemRadio {
  ...
  inline def apply(
    ...
    val __props = js.Dynamic.literal(checked = checked.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], onCheckedChange = js.Any.fromFunction2((t0: Boolean, t1: ReactMouseEventFrom[HTMLLIElement]) => (onCheckedChange(t0, t1)).runNow()))
    new Builder(js.Array(this.component, __props.asInstanceOf[BaseMenuItemInputToggleProps & RefAttributes[HTMLLIElement]]))
  }
  ...
  def withProps(p: BaseMenuItemInputToggleProps & RefAttributes[HTMLLIElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
