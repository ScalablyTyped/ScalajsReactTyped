...
object TextFieldWithMessage {
  
  inline def apply(id: String): Builder = {
    val __props = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[TextFieldPropsmessageProp]))
  }
  ...
  def withProps(p: TextFieldPropsmessageProp): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
