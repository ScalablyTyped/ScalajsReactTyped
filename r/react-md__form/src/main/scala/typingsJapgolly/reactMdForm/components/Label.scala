...
object Label {
  ...
  inline def apply(htmlFor: String): Builder = {
    val __props = js.Dynamic.literal(htmlFor = htmlFor.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[LabelProps & RefAttributes[HTMLLabelElement]]))
  }
  ...
  def withProps(p: LabelProps & RefAttributes[HTMLLabelElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
