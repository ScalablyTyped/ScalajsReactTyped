...
object AsyncSwitch {
  ...
  inline def apply(id: String, loading: Boolean): Builder = {
    val __props = js.Dynamic.literal(id = id.asInstanceOf[js.Any], loading = loading.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[AsyncSwitchProps & RefAttributes[HTMLInputElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def labelDisabled(value: Boolean): this.type = set("labelDisabled", value.asInstanceOf[js.Any])
    ...
    inline def progressClassName(value: String): this.type = set("progressClassName", value.asInstanceOf[js.Any])
  ...
  def withProps(p: AsyncSwitchProps & RefAttributes[HTMLInputElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
