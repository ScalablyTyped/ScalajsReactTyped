...
import typingsJapgolly.reactMdForm.typesTextFieldPasswordMod.ConfigurableVisibilityIcon
...
object Password {
  ...
  inline def apply(id: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PasswordProps & RefAttributes[HTMLInputElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def disableVisibility(value: Boolean): this.type = set("disableVisibility", value.asInstanceOf[js.Any])
    ...
    inline def getVisibilityIcon(value: /* type */ text | password => Node): this.type = set("getVisibilityIcon", js.Any.fromFunction1(value))
    ...
    inline def onVisibilityClick(value: ReactMouseEventFrom[HTMLButtonElement & org.scalajs.dom.Element] => Callback): this.type = set("onVisibilityClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def visibilityClassName(value: String): this.type = set("visibilityClassName", value.asInstanceOf[js.Any])
    
    inline def visibilityIcon(value: Node | ConfigurableVisibilityIcon): this.type = set("visibilityIcon", value.asInstanceOf[js.Any])
    
    inline def visibilityIconNull: this.type = set("visibilityIcon", null)
    
    inline def visibilityIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("visibilityIcon", js.Array(value*))
    
    inline def visibilityIconVdomElement(value: VdomElement): this.type = set("visibilityIcon", value.rawElement.asInstanceOf[js.Any])
    
    inline def visibilityLabel(value: String): this.type = set("visibilityLabel", value.asInstanceOf[js.Any])
    
    inline def visibilityStyle(value: CSSProperties): this.type = set("visibilityStyle", value.asInstanceOf[js.Any])
  ...
  def withProps(p: PasswordProps & RefAttributes[HTMLInputElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
