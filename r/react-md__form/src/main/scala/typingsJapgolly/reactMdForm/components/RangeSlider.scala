...
object RangeSlider {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def afterAddon(value: VdomNode): this.type = set("afterAddon", value.rawNode.asInstanceOf[js.Any])
    
    inline def afterAddonNull: this.type = set("afterAddon", null)
    
    inline def afterAddonVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("afterAddon", js.Array(value*))
    
    inline def afterAddonVdomElement(value: VdomElement): this.type = set("afterAddon", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def beforeAddon(value: VdomNode): this.type = set("beforeAddon", value.rawNode.asInstanceOf[js.Any])
    
    inline def beforeAddonNull: this.type = set("beforeAddon", null)
    
    inline def beforeAddonVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("beforeAddon", js.Array(value*))
    
    inline def beforeAddonVdomElement(value: VdomElement): this.type = set("beforeAddon", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def discrete(value: Boolean): this.type = set("discrete", value.asInstanceOf[js.Any])
    
    inline def draggable(value: Booleanish): this.type = set("draggable", value.asInstanceOf[js.Any])
    
    inline def getValueText(value: /* value */ Double => String): this.type = set("getValueText", js.Any.fromFunction1(value))
    ...
    inline def labelProps(value: PropsWithRef[HTMLAttributes[HTMLSpanElement], HTMLSpanElement]): this.type = set("labelProps", value.asInstanceOf[js.Any])
    ...
    inline def thumb1Label(value: String): this.type = set("thumb1Label", value.asInstanceOf[js.Any])
    
    inline def thumb1LabelledBy(value: String): this.type = set("thumb1LabelledBy", value.asInstanceOf[js.Any])
    
    inline def thumb1Props(value: PropsWithRef[HTMLAttributes[HTMLSpanElement], HTMLSpanElement]): this.type = set("thumb1Props", value.asInstanceOf[js.Any])
    
    inline def thumb2Label(value: String): this.type = set("thumb2Label", value.asInstanceOf[js.Any])
    
    inline def thumb2LabelledBy(value: String): this.type = set("thumb2LabelledBy", value.asInstanceOf[js.Any])
    
    inline def thumb2Props(value: PropsWithRef[HTMLAttributes[HTMLSpanElement], HTMLSpanElement]): this.type = set("thumb2Props", value.asInstanceOf[js.Any])
    
    inline def title(value: String): this.type = set("title", value.asInstanceOf[js.Any])
    
    inline def trackProps(value: PropsWithRef[HTMLAttributes[HTMLSpanElement], HTMLSpanElement]): this.type = set("trackProps", value.asInstanceOf[js.Any])
  ...
  def withProps(p: RangeSliderProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
