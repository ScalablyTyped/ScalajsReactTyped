...
object Option {
  ...
  inline def apply(focused: Boolean, selected: Boolean): Builder = {
    val __props = js.Dynamic.literal(focused = focused.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[OptionProps & RefAttributes[HTMLLIElement]]))
  }
  ...
  def withProps(p: OptionProps & RefAttributes[HTMLLIElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
