...
object Fieldset {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def legendClassName(value: String): this.type = set("legendClassName", value.asInstanceOf[js.Any])
    
    inline def legendNull: this.type = set("legend", null)
    
    inline def legendSROnly(value: Boolean): this.type = set("legendSROnly", value.asInstanceOf[js.Any])
    
    inline def legendStyle(value: CSSProperties): this.type = set("legendStyle", value.asInstanceOf[js.Any])
  ...
  def withProps(p: FieldsetProps & RefAttributes[HTMLFieldSetElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
