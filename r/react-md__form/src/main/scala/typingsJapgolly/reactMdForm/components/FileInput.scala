...
object FileInput {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def disableIconSpacing(value: Boolean): this.type = set("disableIconSpacing", value.asInstanceOf[js.Any])
  ...
  def withProps(p: FileInputProps & RefAttributes[HTMLInputElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
