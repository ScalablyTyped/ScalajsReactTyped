...
/* Inlined std.Readonly<@react-md/utils.@react-md/utils.PropsWithRef<react.react.HTMLAttributes<std.HTMLLIElement>, std.HTMLLIElement>> */
trait ReadonlyPropsWithRefHTMLA extends StObject {
  ...
  val ref: js.UndefOr[Ref[HTMLLIElement]] = js.undefined
...
object ReadonlyPropsWithRefHTMLA {
  
  inline def apply(): ReadonlyPropsWithRefHTMLA = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReadonlyPropsWithRefHTMLA]
  }
  
  extension [Self <: ReadonlyPropsWithRefHTMLA](x: Self) {
