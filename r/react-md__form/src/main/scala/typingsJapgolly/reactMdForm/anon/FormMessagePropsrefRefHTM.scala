...
/* Inlined @react-md/form.@react-md/form.FormMessageProps & {  ref :react.react.Ref<std.HTMLDivElement> | undefined} */
trait FormMessagePropsrefRefHTM extends StObject {
...
object FormMessagePropsrefRefHTM {
  
  inline def apply(id: String): FormMessagePropsrefRefHTM = {
