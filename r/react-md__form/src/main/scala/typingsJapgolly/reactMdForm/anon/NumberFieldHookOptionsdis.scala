...
import typingsJapgolly.reactMdForm.reactMdFormBooleans.`true`
...
/* Inlined @react-md/form.@react-md/form/types/text-field/useNumberField.NumberFieldHookOptions & {  disableMessage :true} */
trait NumberFieldHookOptionsdis extends StObject {
...
object NumberFieldHookOptionsdis {
  
  inline def apply(disableMessage: js.UndefOr[Boolean] & `true`, id: String): NumberFieldHookOptionsdis = {
    val __obj = js.Dynamic.literal(disableMessage = disableMessage.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[NumberFieldHookOptionsdis]
  }
  
  extension [Self <: NumberFieldHookOptionsdis](x: Self) {
