...
/* Inlined @react-md/form.@react-md/form/types/text-field/useTextField.TextFieldHookOptions & {  disableMessage :true} */
trait TextFieldHookOptionsdisab extends StObject {
...
object TextFieldHookOptionsdisab {
  
  inline def apply(disableMessage: js.UndefOr[Boolean] & `true`, id: String): TextFieldHookOptionsdisab = {
    val __obj = js.Dynamic.literal(disableMessage = disableMessage.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[TextFieldHookOptionsdisab]
  }
  
  extension [Self <: TextFieldHookOptionsdisab](x: Self) {
