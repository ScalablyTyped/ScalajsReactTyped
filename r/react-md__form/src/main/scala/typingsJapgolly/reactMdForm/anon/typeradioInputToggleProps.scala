...
/* Inlined {  type :'radio'} & @react-md/form.@react-md/form/types/toggle/InputToggle.InputToggleProps */
trait typeradioInputToggleProps
  extends StObject
     with Props {
  ...
  /**
    ...
    */
  var labelDisabled: js.UndefOr[Boolean] = js.undefined
...
object typeradioInputToggleProps {
  
  inline def apply(id: String): typeradioInputToggleProps = {
  ...
  extension [Self <: typeradioInputToggleProps](x: Self) {
    ...
    inline def setLabelDisabled(value: Boolean): Self = StObject.set(x, "labelDisabled", value.asInstanceOf[js.Any])
