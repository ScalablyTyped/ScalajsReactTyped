...
trait MessageContainerProps extends StObject {
  ...
  /**
    ...
    */
  var messageContainerProps: js.UndefOr[typingsJapgolly.reactMdForm.typesFormMessageContainerMod.MessageContainerProps] = js.undefined
...
object MessageContainerProps {
  ...
  extension [Self <: MessageContainerProps](x: Self) {
    ...
    inline def setMessageContainerProps(value: typingsJapgolly.reactMdForm.typesFormMessageContainerMod.MessageContainerProps): Self = StObject.set(x, "messageContainerProps", value.asInstanceOf[js.Any])
