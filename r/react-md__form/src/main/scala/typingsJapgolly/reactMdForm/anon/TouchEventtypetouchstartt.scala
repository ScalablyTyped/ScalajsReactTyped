...
import typingsJapgolly.reactMdForm.reactMdFormStrings.touchend
import typingsJapgolly.reactMdForm.reactMdFormStrings.touchmove
import typingsJapgolly.reactMdForm.reactMdFormStrings.touchstart
