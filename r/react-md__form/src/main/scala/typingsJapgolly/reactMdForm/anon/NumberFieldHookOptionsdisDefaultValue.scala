...
/* Inlined @react-md/form.@react-md/form/types/text-field/useNumberField.NumberFieldHookOptions & {  disableMessage :boolean | undefined} */
trait NumberFieldHookOptionsdisDefaultValue extends StObject {
...
object NumberFieldHookOptionsdisDefaultValue {
  
  inline def apply(id: String): NumberFieldHookOptionsdisDefaultValue = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[NumberFieldHookOptionsdisDefaultValue]
  }
  
  extension [Self <: NumberFieldHookOptionsdisDefaultValue](x: Self) {
