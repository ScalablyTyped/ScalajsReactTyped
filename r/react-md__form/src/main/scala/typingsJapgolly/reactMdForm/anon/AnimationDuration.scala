...
object AnimationDuration {
  ...
  extension [Self <: AnimationDuration](x: Self) {
    ...
    inline def setRefFunction1(value: (HTMLSpanElement | Null) | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: (HTMLSpanElement | Null) | Null) => value(t0).runNow()))
    ...
    inline def setThumb1RefFunction1(value: (HTMLSpanElement | Null) | Null => Callback): Self = StObject.set(x, "thumb1Ref", js.Any.fromFunction1((t0: (HTMLSpanElement | Null) | Null) => value(t0).runNow()))
    ...
    inline def setThumb2RefFunction1(value: (HTMLSpanElement | Null) | Null => Callback): Self = StObject.set(x, "thumb2Ref", js.Any.fromFunction1((t0: (HTMLSpanElement | Null) | Null) => value(t0).runNow()))
