...
/* Inlined @react-md/form.@react-md/form/types/FormMessage.FormMessageProps & std.Partial<@react-md/form.@react-md/form/types/FormMessage.FormMessageInputLengthCounterProps> & react.react.RefAttributes<std.HTMLDivElement> */
trait FormMessagePropsPartialFo extends StObject {
...
object FormMessagePropsPartialFo {
  
  inline def apply(id: String): FormMessagePropsPartialFo = {
