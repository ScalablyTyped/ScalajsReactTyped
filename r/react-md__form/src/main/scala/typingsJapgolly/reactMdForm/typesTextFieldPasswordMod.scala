...
import typingsJapgolly.reactMdForm.reactMdFormStrings.password
...
object typesTextFieldPasswordMod {
  
  @JSImport("@react-md/form/types/text-field/Password", "Password")
  @js.native
  val Password: ForwardRefExoticComponent[PasswordProps & RefAttributes[HTMLInputElement]] = js.native
  
  trait ConfigurableVisibilityIcon extends StObject {
  ...
  object ConfigurableVisibilityIcon {
    ...
    inline def apply(): ConfigurableVisibilityIcon = {
      val __obj = js.Dynamic.literal(invisible = null, visible = null)
      __obj.asInstanceOf[ConfigurableVisibilityIcon]
    }
    
    extension [Self <: ConfigurableVisibilityIcon](x: Self) {
      
      inline def setInvisible(value: VdomNode): Self = StObject.set(x, "invisible", value.rawNode.asInstanceOf[js.Any])
      
      inline def setInvisibleNull: Self = StObject.set(x, "invisible", null)
      
      inline def setInvisibleVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "invisible", js.Array(value*))
      
      inline def setInvisibleVdomElement(value: VdomElement): Self = StObject.set(x, "invisible", value.rawElement.asInstanceOf[js.Any])
      
      inline def setVisible(value: VdomNode): Self = StObject.set(x, "visible", value.rawNode.asInstanceOf[js.Any])
      
      inline def setVisibleNull: Self = StObject.set(x, "visible", null)
      
      inline def setVisibleVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "visible", js.Array(value*))
      
      inline def setVisibleVdomElement(value: VdomElement): Self = StObject.set(x, "visible", value.rawElement.asInstanceOf[js.Any])
    }
  }
  
  type GetVisibilityIcon = js.Function1[/* type */ text | password, Node]
  
  /* Inlined parent std.Omit<@react-md/form.@react-md/form/types/text-field/TextField.TextFieldProps, 'type'> */
  trait PasswordProps extends StObject {
    ...
    /**
      ...
      */
    var disableVisibility: js.UndefOr[Boolean] = js.undefined
    ...
    /**
      ...
      */
    var getVisibilityIcon: js.UndefOr[GetVisibilityIcon] = js.undefined
    ...
    /**
      ...
      * implement your own `Password` component using the native `TextField`.
      */
    var onVisibilityClick: js.UndefOr[MouseEventHandler[HTMLButtonElement]] = js.undefined
    ...
    /**
      ...
      */
    var visibilityClassName: js.UndefOr[String] = js.undefined
    ...
    /**
      ...
      */
    var visibilityIcon: js.UndefOr[Node | ConfigurableVisibilityIcon] = js.undefined
    ...
    /**
      ...
      */
    var visibilityLabel: js.UndefOr[String] = js.undefined
    
    /**
      * An optional style to apply to the visibility toggle button.
      */
    var visibilityStyle: js.UndefOr[CSSProperties] = js.undefined
  ...
  object PasswordProps {
    ...
    inline def apply(id: String): PasswordProps = {
    ...
    extension [Self <: PasswordProps](x: Self) {
      ...
      inline def setDisableVisibility(value: Boolean): Self = StObject.set(x, "disableVisibility", value.asInstanceOf[js.Any])
      
      inline def setDisableVisibilityUndefined: Self = StObject.set(x, "disableVisibility", js.undefined)
      ...
      inline def setGetVisibilityIcon(value: /* type */ text | password => Node): Self = StObject.set(x, "getVisibilityIcon", js.Any.fromFunction1(value))
      
      inline def setGetVisibilityIconUndefined: Self = StObject.set(x, "getVisibilityIcon", js.undefined)
      ...
      inline def setOnVisibilityClick(value: ReactMouseEventFrom[HTMLButtonElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onVisibilityClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement & org.scalajs.dom.Element]) => value(t0).runNow()))
      
      inline def setOnVisibilityClickUndefined: Self = StObject.set(x, "onVisibilityClick", js.undefined)
      ...
      inline def setVisibilityClassName(value: String): Self = StObject.set(x, "visibilityClassName", value.asInstanceOf[js.Any])
      
      inline def setVisibilityClassNameUndefined: Self = StObject.set(x, "visibilityClassName", js.undefined)
      
      inline def setVisibilityIcon(value: Node | ConfigurableVisibilityIcon): Self = StObject.set(x, "visibilityIcon", value.asInstanceOf[js.Any])
      
      inline def setVisibilityIconNull: Self = StObject.set(x, "visibilityIcon", null)
      
      inline def setVisibilityIconUndefined: Self = StObject.set(x, "visibilityIcon", js.undefined)
      
      inline def setVisibilityIconVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "visibilityIcon", js.Array(value*))
      
      inline def setVisibilityIconVdomElement(value: VdomElement): Self = StObject.set(x, "visibilityIcon", value.rawElement.asInstanceOf[js.Any])
      
      inline def setVisibilityLabel(value: String): Self = StObject.set(x, "visibilityLabel", value.asInstanceOf[js.Any])
      
      inline def setVisibilityLabelUndefined: Self = StObject.set(x, "visibilityLabel", js.undefined)
      
      inline def setVisibilityStyle(value: CSSProperties): Self = StObject.set(x, "visibilityStyle", value.asInstanceOf[js.Any])
      
      inline def setVisibilityStyleUndefined: Self = StObject.set(x, "visibilityStyle", js.undefined)
