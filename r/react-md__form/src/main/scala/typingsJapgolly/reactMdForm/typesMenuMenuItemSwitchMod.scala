...
object typesMenuMenuItemSwitchMod {
  ...
  trait MenuItemSwitchProps extends StObject {
    ...
    var onCheckedChange: js.Function2[/* checked */ Boolean, /* event */ ReactMouseEventFrom[HTMLLIElement], Unit]
  ...
  object MenuItemSwitchProps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(checked = checked.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], onCheckedChange = js.Any.fromFunction2((t0: /* checked */ Boolean, t1: /* event */ ReactMouseEventFrom[HTMLLIElement]) => (onCheckedChange(t0, t1)).runNow()))
    ...
    extension [Self <: MenuItemSwitchProps](x: Self) {
      ...
      inline def setOnCheckedChange(value: (/* checked */ Boolean, /* event */ ReactMouseEventFrom[HTMLLIElement]) => Callback): Self = StObject.set(x, "onCheckedChange", js.Any.fromFunction2((t0: /* checked */ Boolean, t1: /* event */ ReactMouseEventFrom[HTMLLIElement]) => (value(t0, t1)).runNow()))
