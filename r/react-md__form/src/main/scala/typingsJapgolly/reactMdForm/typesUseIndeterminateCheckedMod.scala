...
object typesUseIndeterminateCheckedMod {
  ...
  object BaseIndeterminateCheckedHookReturnValue {
    ...
    inline def apply[V /* <: String */](checkedValues: js.Array[V], setCheckedValues: SetStateAction[js.Array[V]] => Callback): BaseIndeterminateCheckedHookReturnValue[V] = {
      val __obj = js.Dynamic.literal(checkedValues = checkedValues.asInstanceOf[js.Any], setCheckedValues = js.Any.fromFunction1((t0: SetStateAction[js.Array[V]]) => setCheckedValues(t0).runNow()))
    ...
    extension [Self <: BaseIndeterminateCheckedHookReturnValue[?], V /* <: String */](x: Self & BaseIndeterminateCheckedHookReturnValue[V]) {
      ...
      inline def setSetCheckedValues(value: SetStateAction[js.Array[V]] => Callback): Self = StObject.set(x, "setCheckedValues", js.Any.fromFunction1((t0: SetStateAction[js.Array[V]]) => value(t0).runNow()))
    }
  }
  ...
  object CombinedIndeterminateCheckedHookReturnValue {
    ...
    inline def apply[V /* <: String */](
      ...
      setCheckedValues: SetStateAction[js.Array[V]] => Callback
    ): CombinedIndeterminateCheckedHookReturnValue[V] = {
      val __obj = js.Dynamic.literal(checkedValues = checkedValues.asInstanceOf[js.Any], getProps = js.Any.fromFunction1(getProps), rootProps = rootProps.asInstanceOf[js.Any], setCheckedValues = js.Any.fromFunction1((t0: SetStateAction[js.Array[V]]) => setCheckedValues(t0).runNow()))
  ...
  object IndeterminateCheckedHookOptions {
    ...
    extension [Self <: IndeterminateCheckedHookOptions[?], V /* <: String */](x: Self & IndeterminateCheckedHookOptions[V]) {
      ...
      inline def setDefaultCheckedValuesCallbackTo(value: CallbackTo[js.Array[V]]): Self = StObject.set(x, "defaultCheckedValues", value.toJsFn)
      ...
      inline def setOnChange(value: /* values */ js.Array[V] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* values */ js.Array[V]) => value(t0).runNow()))
  ...
  object ProvidedCombinedIndeterminateControlledProps {
    ...
    extension [Self <: ProvidedCombinedIndeterminateControlledProps[?], V /* <: String */](x: Self & ProvidedCombinedIndeterminateControlledProps[V]) {
      ...
      inline def setOnCheckedChange(value: Callback): Self = StObject.set(x, "onCheckedChange", value.toJsFn)
  ...
  object ProvidedIndeterminateCheckboxProps {
    ...
    inline def apply(checked: Boolean, indeterminate: Boolean, onChange: Callback): ProvidedIndeterminateCheckboxProps = {
      val __obj = js.Dynamic.literal(checked = checked.asInstanceOf[js.Any], indeterminate = indeterminate.asInstanceOf[js.Any], onChange = onChange.toJsFn)
  ...
  object ProvidedIndeterminateControlledCheckboxProps {
    ...
    inline def apply[V /* <: String */](checked: Boolean, onChange: Callback, value: V): ProvidedIndeterminateControlledCheckboxProps[V] = {
      val __obj = js.Dynamic.literal(checked = checked.asInstanceOf[js.Any], onChange = onChange.toJsFn, value = value.asInstanceOf[js.Any])
  ...
  object ProvidedIndeterminateControlledMenuItemCheckboxProps {
    ...
    inline def apply[V /* <: String */](checked: Boolean, onCheckedChange: Callback, value: V): ProvidedIndeterminateControlledMenuItemCheckboxProps[V] = {
      val __obj = js.Dynamic.literal(checked = checked.asInstanceOf[js.Any], onCheckedChange = onCheckedChange.toJsFn, value = value.asInstanceOf[js.Any])
  ...
  object ProvidedIndeterminateMenuItemCheckboxProps {
    ...
    inline def apply(checked: Boolean, indeterminate: Boolean, onCheckedChange: Callback): ProvidedIndeterminateMenuItemCheckboxProps = {
      val __obj = js.Dynamic.literal(checked = checked.asInstanceOf[js.Any], indeterminate = indeterminate.asInstanceOf[js.Any], onCheckedChange = onCheckedChange.toJsFn)
