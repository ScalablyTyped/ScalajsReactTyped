...
import typingsJapgolly.reactMdForm.typesFormMessageContainerMod.MessageContainerProps
import typingsJapgolly.reactMdForm.typesFormMessageContainerMod.MessageProps
...
object typesTextFieldTextAreaWithMessageMod {
  
  @JSImport("@react-md/form/types/text-field/TextAreaWithMessage", "TextAreaWithMessage")
  @js.native
  val TextAreaWithMessage: ForwardRefExoticComponent[TextAreaPropsmessageProps] = js.native
  
  /* Inlined @react-md/form.@react-md/form/types/FormMessageContainer.FieldMessageContainerExtension<@react-md/form.@react-md/form/types/text-field/TextArea.TextAreaProps> */
  trait TextAreaWithMessageProps extends StObject {
    ...
    /**
      ...
      */
    var messageContainerProps: js.UndefOr[MessageContainerProps] = js.undefined
  ...
  object TextAreaWithMessageProps {
    
    inline def apply(id: String): TextAreaWithMessageProps = {
    ...
    extension [Self <: TextAreaWithMessageProps](x: Self) {
      ...
      inline def setMessageContainerProps(value: MessageContainerProps): Self = StObject.set(x, "messageContainerProps", value.asInstanceOf[js.Any])
