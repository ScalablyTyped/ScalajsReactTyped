...
object typesTextFieldTextFieldMod {
  
  @JSImport("@react-md/form/types/text-field/TextField", "TextField")
  @js.native
  val TextField: ForwardRefExoticComponent[TextFieldProps & RefAttributes[HTMLInputElement]] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMdForm.reactMdFormStrings.text
    - typingsJapgolly.reactMdForm.reactMdFormStrings.password
    - typingsJapgolly.reactMdForm.reactMdFormStrings.number
    - typingsJapgolly.reactMdForm.reactMdFormStrings.tel
    - typingsJapgolly.reactMdForm.reactMdFormStrings.email
    - typingsJapgolly.reactMdForm.reactMdFormStrings.date
    - typingsJapgolly.reactMdForm.reactMdFormStrings.time
    - typingsJapgolly.reactMdForm.reactMdFormStrings.`datetime-local`
    - typingsJapgolly.reactMdForm.reactMdFormStrings.month
    - typingsJapgolly.reactMdForm.reactMdFormStrings.week
    - typingsJapgolly.reactMdForm.reactMdFormStrings.url
    - typingsJapgolly.reactMdForm.reactMdFormStrings.color
    - typingsJapgolly.reactMdForm.reactMdFormStrings.search
  */
  trait SupportedInputTypes extends StObject
  object SupportedInputTypes {
    
    inline def color: typingsJapgolly.reactMdForm.reactMdFormStrings.color = "color".asInstanceOf[typingsJapgolly.reactMdForm.reactMdFormStrings.color]
    
    inline def date: typingsJapgolly.reactMdForm.reactMdFormStrings.date = "date".asInstanceOf[typingsJapgolly.reactMdForm.reactMdFormStrings.date]
    
    inline def `datetime-local`: typingsJapgolly.reactMdForm.reactMdFormStrings.`datetime-local` = "datetime-local".asInstanceOf[typingsJapgolly.reactMdForm.reactMdFormStrings.`datetime-local`]
    
    inline def email: typingsJapgolly.reactMdForm.reactMdFormStrings.email = "email".asInstanceOf[typingsJapgolly.reactMdForm.reactMdFormStrings.email]
    
    inline def month: typingsJapgolly.reactMdForm.reactMdFormStrings.month = "month".asInstanceOf[typingsJapgolly.reactMdForm.reactMdFormStrings.month]
    
    inline def number: typingsJapgolly.reactMdForm.reactMdFormStrings.number = "number".asInstanceOf[typingsJapgolly.reactMdForm.reactMdFormStrings.number]
    
    inline def password: typingsJapgolly.reactMdForm.reactMdFormStrings.password = "password".asInstanceOf[typingsJapgolly.reactMdForm.reactMdFormStrings.password]
    
    inline def search: typingsJapgolly.reactMdForm.reactMdFormStrings.search = "search".asInstanceOf[typingsJapgolly.reactMdForm.reactMdFormStrings.search]
    
    inline def tel: typingsJapgolly.reactMdForm.reactMdFormStrings.tel = "tel".asInstanceOf[typingsJapgolly.reactMdForm.reactMdFormStrings.tel]
    
    inline def text: typingsJapgolly.reactMdForm.reactMdFormStrings.text = "text".asInstanceOf[typingsJapgolly.reactMdForm.reactMdFormStrings.text]
    
    inline def time: typingsJapgolly.reactMdForm.reactMdFormStrings.time = "time".asInstanceOf[typingsJapgolly.reactMdForm.reactMdFormStrings.time]
    
    inline def url: typingsJapgolly.reactMdForm.reactMdFormStrings.url = "url".asInstanceOf[typingsJapgolly.reactMdForm.reactMdFormStrings.url]
    
    inline def week: typingsJapgolly.reactMdForm.reactMdFormStrings.week = "week".asInstanceOf[typingsJapgolly.reactMdForm.reactMdFormStrings.week]
  }
  
  /* Inlined std.Omit<react.react.InputHTMLAttributes<std.HTMLInputElement>, 'type'> */
  trait TextFieldAttributes extends StObject {
  ...
  object TextFieldAttributes {
    ...
    inline def apply(): TextFieldAttributes = {
  ...
  trait TextFieldProps
    ...
    /**
      ...
      */
    @JSName("defaultValue")
    var defaultValue_TextFieldProps: js.UndefOr[String] = js.undefined
    
    /**
      * The id for the text field. This is required for accessibility.
      */
    @JSName("id")
    var id_TextFieldProps: String
    ...
    /**
      ...
      */
    @JSName("value")
    var value_TextFieldProps: js.UndefOr[String] = js.undefined
  }
  object TextFieldProps {
    
    inline def apply(id: String): TextFieldProps = {
