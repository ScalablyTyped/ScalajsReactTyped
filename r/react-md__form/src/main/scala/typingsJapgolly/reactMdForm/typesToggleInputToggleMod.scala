...
object typesToggleInputToggleMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMdForm.anon.typeradioInputToggleProps
    - typingsJapgolly.reactMdForm.anon.typecheckboxindeterminate
  */
  trait Props extends StObject
  object Props {
    
    inline def typecheckboxindeterminate(id: String): typingsJapgolly.reactMdForm.anon.typecheckboxindeterminate = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("checkbox")
      __obj.asInstanceOf[typingsJapgolly.reactMdForm.anon.typecheckboxindeterminate]
    }
    
    inline def typeradioInputToggleProps(id: String): typingsJapgolly.reactMdForm.anon.typeradioInputToggleProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("radio")
      __obj.asInstanceOf[typingsJapgolly.reactMdForm.anon.typeradioInputToggleProps]
    }
  }
}
