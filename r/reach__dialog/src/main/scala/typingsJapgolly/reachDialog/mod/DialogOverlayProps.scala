...
/* Inlined {  initialFocusRef ? :react.react.RefObject<std.HTMLElement>} & @reach/dialog.@reach/dialog.DialogProps */
trait DialogOverlayProps extends js.Object {
  // RDFa Attributes
  ...
  var initialFocusRef: js.UndefOr[RefHandle[HTMLElement]] = js.undefined
...
object DialogOverlayProps {
  ...
  def apply(
    ...
    id: String = null,
    initialFocusRef: RefHandle[HTMLElement] = null,
    inlist: js.Any = null,
