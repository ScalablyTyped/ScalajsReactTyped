...
object DialogOverlay {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DialogOverlayProps, LegacyRef[HTMLDivElement], Unit, DialogOverlayProps] = {
  ...
  typingsJapgolly.reachDialog.mod.DialogOverlayProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLDivElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reachDialog.mod.DialogOverlayProps])(children: _*)
  }
