...
object Dialog {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DialogProps, LegacyRef[HTMLDivElement], Unit, DialogProps] = {
  ...
  typingsJapgolly.reachDialog.mod.DialogProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLDivElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reachDialog.mod.DialogProps])(children: _*)
  }
