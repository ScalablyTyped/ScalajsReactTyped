...
object DialogInner {
  ...
  implicit def make(companion: DialogInner.type): SharedBuilder_Merge_1713583902 = new SharedBuilder_Merge_1713583902(js.Array(this.component, js.Dictionary.empty))()
