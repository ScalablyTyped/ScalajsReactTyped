...
object DialogContent {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DialogContentProps, LegacyRef[HTMLDivElement], Unit, DialogContentProps] = {
  ...
  typingsJapgolly.reachDialog.mod.DialogContentProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLDivElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reachDialog.mod.DialogContentProps])(children: _*)
  }
