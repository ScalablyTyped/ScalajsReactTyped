...
object mod {
  ...
  trait DialogProps extends StObject {
    ...
    /**
      ...
      */
    var initialFocusRef: js.UndefOr[RefHandle[Any]] = js.undefined
    ...
    var onDismiss: js.UndefOr[
        js.Function1[
          /* event */ ReactMouseEventFrom[org.scalajs.dom.Element] | ReactKeyboardEventFrom[org.scalajs.dom.Element], 
          Unit
        ]
      ] = js.undefined
  ...
  object DialogProps {
    ...
    extension [Self <: DialogProps](x: Self) {
      ...
      inline def setInitialFocusRef(value: RefHandle[Any]): Self = StObject.set(x, "initialFocusRef", value.asInstanceOf[js.Any])
      ...
      ): Self = StObject.set(x, "onDismiss", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[org.scalajs.dom.Element] | ReactKeyboardEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
