...
import typingsJapgolly.realm.Realm.Sync.ClientResyncMode
import typingsJapgolly.realm.Realm.Sync.ErrorCallback
...
import typingsJapgolly.realm.Realm.Sync.SSLVerifyCallback
import typingsJapgolly.realm.Realm.Sync.SSLVerifyObject
import typingsJapgolly.realm.Realm.Sync.Session
import typingsJapgolly.realm.Realm.Sync.SessionStopPolicy
import typingsJapgolly.realm.Realm.Sync.SyncError
...
object PartialSyncConfiguration {
  ...
  def apply(
    ...
    error: (/* session */ Session, /* error */ SyncError) => Callback = null,
    ...
    open_ssl_verify_callback: /* sslVerifyObject */ SSLVerifyObject => CallbackTo[Boolean] = null,
    ...
    if (error != null) __obj.updateDynamic("error")(js.Any.fromFunction2((t0: /* session */ typingsJapgolly.realm.Realm.Sync.Session, t1: /* error */ typingsJapgolly.realm.Realm.Sync.SyncError) => error(t0, t1).runNow()))
    ...
    if (open_ssl_verify_callback != null) __obj.updateDynamic("open_ssl_verify_callback")(js.Any.fromFunction1((t0: /* sslVerifyObject */ typingsJapgolly.realm.Realm.Sync.SSLVerifyObject) => open_ssl_verify_callback(t0).runNow()))
