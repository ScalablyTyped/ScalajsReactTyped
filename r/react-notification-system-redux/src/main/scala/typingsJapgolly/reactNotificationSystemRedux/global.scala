...
import typingsJapgolly.reactNotificationSystemRedux.mod.NotificationShow
import typingsJapgolly.reactNotificationSystemRedux.mod.NotificationsReducer
...
object global {
  ...
  object Notifications {
    ...
    @js.native
    open class ^ ()
      extends typingsJapgolly.reactNotificationSystemRedux.mod.^
