...
import typingsJapgolly.reactLive.mod.LiveProviderProps
import typingsJapgolly.reactLive.mod.TranspileOptions
...
object LiveProvider {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactLive.mod.LiveProvider] {
    ...
    inline def noInline(value: Boolean): this.type = set("noInline", value.asInstanceOf[js.Any])
    ...
    inline def transformCode(value: /* code */ String => String): this.type = set("transformCode", js.Any.fromFunction1(value))
    
    inline def translate(value: yes | no): this.type = set("translate", value.asInstanceOf[js.Any])
    
    inline def transpileOptions(value: TranspileOptions): this.type = set("transpileOptions", value.asInstanceOf[js.Any])
