...
object LiveError {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactLive.mod.LiveError] {
  ...
  implicit def make(companion: LiveError.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
