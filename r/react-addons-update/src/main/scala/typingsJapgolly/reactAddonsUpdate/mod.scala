...
import typingsJapgolly.reactAddonsUpdate.mod.reactAugmentingMod.UpdateArraySpec
import typingsJapgolly.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpec
...
object mod {
  ...
  object reactAugmentingMod {
    ...
    /* Rewritten from type alias, can be one of: 
      ...
      - typingsJapgolly.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpecCommand
      - typingsJapgolly.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpecPath
    */
    ...
    object _UpdateSpec {
      ...
      inline def UpdateSpecCommand(): typingsJapgolly.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpecCommand = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpecCommand]
      }
      
      inline def UpdateSpecPath(): typingsJapgolly.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpecPath = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.reactAddonsUpdate.mod.reactAugmentingMod.UpdateSpecPath]
      }
    }
  }
}
