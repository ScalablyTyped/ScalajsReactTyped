...
object mod {
  ...
  object ReactNativeSideMenuProps {
    ...
    inline def apply(): ReactNativeSideMenuProps = {
      val __obj = js.Dynamic.literal(menu = null)
    ...
    extension [Self <: ReactNativeSideMenuProps](x: Self) {
      ...
      inline def setOnAnimationComplete(value: /* event */ EndCallback => Callback): Self = StObject.set(x, "onAnimationComplete", js.Any.fromFunction1((t0: /* event */ EndCallback) => value(t0).runNow()))
      
      inline def setOnAnimationCompleteUndefined: Self = StObject.set(x, "onAnimationComplete", js.undefined)
      
      inline def setOnChange(value: /* isOpen */ Boolean => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* isOpen */ Boolean) => value(t0).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnMove(value: /* left */ Double => Callback): Self = StObject.set(x, "onMove", js.Any.fromFunction1((t0: /* left */ Double) => value(t0).runNow()))
      
      inline def setOnMoveUndefined: Self = StObject.set(x, "onMove", js.undefined)
      
      inline def setOnSliding(value: /* fraction */ Double => Callback): Self = StObject.set(x, "onSliding", js.Any.fromFunction1((t0: /* fraction */ Double) => value(t0).runNow()))
