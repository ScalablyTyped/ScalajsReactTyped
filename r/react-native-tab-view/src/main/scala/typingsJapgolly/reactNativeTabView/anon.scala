...
object anon {
  ...
  object EventEmitterPropsposition {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(addEnterListener = js.Any.fromFunction1(addEnterListener), jumpTo = js.Any.fromFunction1((t0: String) => jumpTo(t0).runNow()), position = position.asInstanceOf[js.Any], render = js.Any.fromFunction1(render))
  ...
  trait Focused[T /* <: typingsJapgolly.reactNativeTabView.libTypescriptTypesMod.Route */] extends StObject {
  ...
  object Focused {
    ...
    inline def apply[T /* <: typingsJapgolly.reactNativeTabView.libTypescriptTypesMod.Route */](color: String, focused: Boolean, route: T): Focused[T] = {
    ...
    extension [Self <: Focused[?], T /* <: typingsJapgolly.reactNativeTabView.libTypescriptTypesMod.Route */](x: Self & Focused[T]) {
  ...
  trait NavigationState[T /* <: typingsJapgolly.reactNativeTabView.libTypescriptTypesMod.Route */] extends StObject {
    
    var navigationState: typingsJapgolly.reactNativeTabView.libTypescriptTypesMod.NavigationState[T]
  }
  object NavigationState {
    
    inline def apply[T /* <: typingsJapgolly.reactNativeTabView.libTypescriptTypesMod.Route */](navigationState: typingsJapgolly.reactNativeTabView.libTypescriptTypesMod.NavigationState[T]): NavigationState[T] = {
      val __obj = js.Dynamic.literal(navigationState = navigationState.asInstanceOf[js.Any])
      __obj.asInstanceOf[NavigationState[T]]
    }
    
    extension [Self <: NavigationState[?], T /* <: typingsJapgolly.reactNativeTabView.libTypescriptTypesMod.Route */](x: Self & NavigationState[T]) {
      
      inline def setNavigationState(value: typingsJapgolly.reactNativeTabView.libTypescriptTypesMod.NavigationState[T]): Self = StObject.set(x, "navigationState", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait Route[T /* <: typingsJapgolly.reactNativeTabView.libTypescriptTypesMod.Route */] extends StObject {
    
    var route: T
  }
  object Route {
    
    inline def apply[T /* <: typingsJapgolly.reactNativeTabView.libTypescriptTypesMod.Route */](route: T): Route[T] = {
      val __obj = js.Dynamic.literal(route = route.asInstanceOf[js.Any])
      __obj.asInstanceOf[Route[T]]
    }
    
    extension [Self <: Route[?], T /* <: typingsJapgolly.reactNativeTabView.libTypescriptTypesMod.Route */](x: Self & Route[T]) {
