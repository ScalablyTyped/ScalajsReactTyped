...
object libTypescriptPagerViewAdapterMod {
  ...
  object Props {
    ...
    inline def apply[T /* <: Route */](
      ...
      val __obj = js.Dynamic.literal(children = js.Any.fromFunction1(children), navigationState = navigationState.asInstanceOf[js.Any], onIndexChange = js.Any.fromFunction1((t0: Double) => onIndexChange(t0).runNow()))
