package typingsJapgolly.reactNativeTabView.touchableItemMod
...
import typingsJapgolly.reactNativeTabView.reactNativeTabViewStrings.`box-none`
import typingsJapgolly.reactNativeTabView.reactNativeTabViewStrings.`box-only`
import typingsJapgolly.reactNativeTabView.reactNativeTabViewStrings.`no-hide-descendants`
import typingsJapgolly.reactNativeTabView.reactNativeTabViewStrings.assertive
import typingsJapgolly.reactNativeTabView.reactNativeTabViewStrings.auto
import typingsJapgolly.reactNativeTabView.reactNativeTabViewStrings.button
import typingsJapgolly.reactNativeTabView.reactNativeTabViewStrings.no
import typingsJapgolly.reactNativeTabView.reactNativeTabViewStrings.none
import typingsJapgolly.reactNativeTabView.reactNativeTabViewStrings.polite
import typingsJapgolly.reactNativeTabView.reactNativeTabViewStrings.radiobutton_checked
import typingsJapgolly.reactNativeTabView.reactNativeTabViewStrings.radiobutton_unchecked
import typingsJapgolly.reactNativeTabView.reactNativeTabViewStrings.yes
