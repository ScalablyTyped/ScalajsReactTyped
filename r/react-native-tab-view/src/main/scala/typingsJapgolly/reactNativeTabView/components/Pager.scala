...
import typingsJapgolly.reactNativeTabView.pagerMod.default
...
object Pager {
  ...
  typingsJapgolly.reactNativeTabView.pagerMod.Props[T], 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.reactNativeTabView.pagerMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeTabView.pagerMod.Props[T]])
  }
