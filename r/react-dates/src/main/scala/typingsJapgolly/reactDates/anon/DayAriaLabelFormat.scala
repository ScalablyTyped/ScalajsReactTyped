...
trait DayAriaLabelFormat extends StObject {
  ...
  var renderCalendarDay: js.UndefOr[js.Function1[/* props */ CalendarDayShape, Node]] = js.undefined
...
object DayAriaLabelFormat {
  ...
  extension [Self <: DayAriaLabelFormat](x: Self) {
    ...
    inline def setOnMonthSelect(value: (/* currentMonth */ Moment, /* newMonthVal */ String) => Callback): Self = StObject.set(x, "onMonthSelect", js.Any.fromFunction2((t0: /* currentMonth */ Moment, t1: /* newMonthVal */ String) => (value(t0, t1)).runNow()))
    
    inline def setOnMonthSelectUndefined: Self = StObject.set(x, "onMonthSelect", js.undefined)
    
    inline def setOnYearSelect(value: (/* currentMonth */ Moment, /* newMonthVal */ String) => Callback): Self = StObject.set(x, "onYearSelect", js.Any.fromFunction2((t0: /* currentMonth */ Moment, t1: /* newMonthVal */ String) => (value(t0, t1)).runNow()))
    ...
    inline def setRenderCalendarDay(value: /* props */ CalendarDayShape => Node): Self = StObject.set(x, "renderCalendarDay", js.Any.fromFunction1(value))
    
    inline def setRenderCalendarDayUndefined: Self = StObject.set(x, "renderCalendarDay", js.undefined)
    
    inline def setSetMonthTitleHeight(value: /* captionHeight */ Double => Callback): Self = StObject.set(x, "setMonthTitleHeight", js.Any.fromFunction1((t0: /* captionHeight */ Double) => value(t0).runNow()))
