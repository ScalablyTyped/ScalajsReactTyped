...
object SingleDatePickerPhrases {
  ...
  def apply(
    ...
    chooseAvailableDate: /* date */ String => CallbackTo[String] = null,
    ...
    if (chooseAvailableDate != null) __obj.updateDynamic("chooseAvailableDate")(js.Any.fromFunction1((t0: /* date */ java.lang.String) => chooseAvailableDate(t0).runNow()))
