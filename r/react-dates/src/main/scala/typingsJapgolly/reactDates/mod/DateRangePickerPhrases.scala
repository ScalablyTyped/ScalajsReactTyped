...
object DateRangePickerPhrases {
  ...
  def apply(
    ...
    chooseAvailableEndDate: /* date */ String => CallbackTo[String] = null,
    chooseAvailableStartDate: /* date */ String => CallbackTo[String] = null,
    clearDates: String = null,
    closeDatePicker: String = null,
    dateIsSelected: /* date */ String => CallbackTo[String] = null,
    dateIsUnavailable: /* date */ String => CallbackTo[String] = null,
    ...
    if (chooseAvailableEndDate != null) __obj.updateDynamic("chooseAvailableEndDate")(js.Any.fromFunction1((t0: /* date */ java.lang.String) => chooseAvailableEndDate(t0).runNow()))
    if (chooseAvailableStartDate != null) __obj.updateDynamic("chooseAvailableStartDate")(js.Any.fromFunction1((t0: /* date */ java.lang.String) => chooseAvailableStartDate(t0).runNow()))
    ...
    if (dateIsSelected != null) __obj.updateDynamic("dateIsSelected")(js.Any.fromFunction1((t0: /* date */ java.lang.String) => dateIsSelected(t0).runNow()))
    if (dateIsUnavailable != null) __obj.updateDynamic("dateIsUnavailable")(js.Any.fromFunction1((t0: /* date */ java.lang.String) => dateIsUnavailable(t0).runNow()))
