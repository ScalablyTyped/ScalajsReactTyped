...
object libComponentsDayPickerMod extends Shortcut {
  
  @JSImport("react-dates/lib/components/DayPicker", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsDayPickerMod.foo` */
