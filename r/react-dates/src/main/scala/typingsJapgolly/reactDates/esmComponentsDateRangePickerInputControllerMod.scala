...
object esmComponentsDateRangePickerInputControllerMod extends Shortcut {
  
  @JSImport("react-dates/esm/components/DateRangePickerInputController", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `esmComponentsDateRangePickerInputControllerMod.foo` */
