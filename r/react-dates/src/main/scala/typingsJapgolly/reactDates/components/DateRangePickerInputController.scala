...
import typingsJapgolly.reactDates.mod.DateRangePickerInputControllerCls
...
object DateRangePickerInputController {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[DateRangePickerInputControllerCls] {
    ...
    inline def displayFormat(value: String | js.Function0[String]): this.type = set("displayFormat", value.asInstanceOf[js.Any])
    
    inline def displayFormatCallbackTo(value: CallbackTo[String]): this.type = set("displayFormat", value.toJsFn)
    
    inline def endDate(value: Moment): this.type = set("endDate", value.asInstanceOf[js.Any])
    ...
    inline def isOutsideRange(value: /* day */ Moment => Boolean): this.type = set("isOutsideRange", js.Any.fromFunction1(value))
    ...
    inline def keepOpenOnDateSelect(value: Boolean): this.type = set("keepOpenOnDateSelect", value.asInstanceOf[js.Any])
    
    inline def minimumNights(value: Double): this.type = set("minimumNights", value.asInstanceOf[js.Any])
    
    inline def noBorder(value: Boolean): this.type = set("noBorder", value.asInstanceOf[js.Any])
    
    inline def onClose(value: /* final */ EndDate => Callback): this.type = set("onClose", js.Any.fromFunction1((t0: /* final */ EndDate) => value(t0).runNow()))
    
    inline def onDatesChange(value: /* arg */ EndDate => Callback): this.type = set("onDatesChange", js.Any.fromFunction1((t0: /* arg */ EndDate) => value(t0).runNow()))
    
    inline def onFocusChange(value: /* arg */ FocusedInputShape | Null => Callback): this.type = set("onFocusChange", js.Any.fromFunction1((t0: /* arg */ FocusedInputShape | Null) => value(t0).runNow()))
    ...
    inline def reopenPickerOnClearDates(value: Boolean): this.type = set("reopenPickerOnClearDates", value.asInstanceOf[js.Any])
    ...
    inline def startDate(value: Moment): this.type = set("startDate", value.asInstanceOf[js.Any])
    ...
    inline def withFullScreenPortal(value: Boolean): this.type = set("withFullScreenPortal", value.asInstanceOf[js.Any])
  }
