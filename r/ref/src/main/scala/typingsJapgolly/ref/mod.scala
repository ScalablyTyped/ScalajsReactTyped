...
object mod {
  ...
  object Type {
    ...
    inline def apply(
      ...
      indirection: Double,
      set: (Buffer, Double, Any) => Callback,
      size: Double
    ): Type = {
      val __obj = js.Dynamic.literal(get = js.Any.fromFunction2(get), indirection = indirection.asInstanceOf[js.Any], set = js.Any.fromFunction3((t0: Buffer, t1: Double, t2: Any) => (set(t0, t1, t2)).runNow()), size = size.asInstanceOf[js.Any])
    ...
    extension [Self <: Type](x: Self) {
      ...
      inline def setSet(value: (Buffer, Double, Any) => Callback): Self = StObject.set(x, "set", js.Any.fromFunction3((t0: Buffer, t1: Double, t2: Any) => (value(t0, t1, t2)).runNow()))
