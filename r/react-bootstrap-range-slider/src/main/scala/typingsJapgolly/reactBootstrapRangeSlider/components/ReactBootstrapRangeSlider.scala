...
object ReactBootstrapRangeSlider {
  ...
  implicit def make(companion: ReactBootstrapRangeSlider.type): SharedBuilder_PropsWithoutRefRefAttributes867626992[HTMLInputElement] = new SharedBuilder_PropsWithoutRefRefAttributes867626992[HTMLInputElement](js.Array(this.component, js.Dictionary.empty))()
