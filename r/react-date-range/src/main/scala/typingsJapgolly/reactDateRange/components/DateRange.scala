...
object DateRange {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactDateRange.mod.DateRange] {
  ...
  implicit def make(companion: DateRange.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DateRangeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
