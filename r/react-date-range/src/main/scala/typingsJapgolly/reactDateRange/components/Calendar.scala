...
object Calendar {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactDateRange.mod.Calendar] {
    ...
    inline def onPreviewChange(value: /* previewDate */ js.UndefOr[js.Date] => Callback): this.type = set("onPreviewChange", js.Any.fromFunction1((t0: /* previewDate */ js.UndefOr[js.Date]) => value(t0).runNow()))
