...
import typingsJapgolly.router5.distTypesBaseMod.CancelFn
import typingsJapgolly.router5.distTypesBaseMod.DoneFn
import typingsJapgolly.router5.distTypesBaseMod.NavigationOptions
import typingsJapgolly.router5.distTypesBaseMod.Params
import typingsJapgolly.router5.distTypesBaseMod.SimpleState
import typingsJapgolly.router5.distTypesBaseMod.State
import typingsJapgolly.router5.distTypesBaseMod.Unsubscribe
...
object distTypesRouterMod {
  ...
  object Plugin {
    ...
    extension [Self <: Plugin](x: Self) {
      ...
      inline def setOnTransitionCancel(value: (/* toState */ js.UndefOr[State], /* fromState */ js.UndefOr[State]) => Callback): Self = StObject.set(x, "onTransitionCancel", js.Any.fromFunction2((t0: /* toState */ js.UndefOr[State], t1: /* fromState */ js.UndefOr[State]) => (value(t0, t1)).runNow()))
      ...
      inline def setOnTransitionError(
        value: (/* toState */ js.UndefOr[State], /* fromState */ js.UndefOr[State], /* err */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "onTransitionError", js.Any.fromFunction3((t0: /* toState */ js.UndefOr[State], t1: /* fromState */ js.UndefOr[State], t2: /* err */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnTransitionErrorUndefined: Self = StObject.set(x, "onTransitionError", js.undefined)
      
      inline def setOnTransitionStart(value: (/* toState */ js.UndefOr[State], /* fromState */ js.UndefOr[State]) => Callback): Self = StObject.set(x, "onTransitionStart", js.Any.fromFunction2((t0: /* toState */ js.UndefOr[State], t1: /* fromState */ js.UndefOr[State]) => (value(t0, t1)).runNow()))
      ...
      inline def setOnTransitionSuccess(
        value: (/* toState */ js.UndefOr[State], /* fromState */ js.UndefOr[State], /* opts */ js.UndefOr[NavigationOptions]) => Callback
      ): Self = StObject.set(x, "onTransitionSuccess", js.Any.fromFunction3((t0: /* toState */ js.UndefOr[State], t1: /* fromState */ js.UndefOr[State], t2: /* opts */ js.UndefOr[NavigationOptions]) => (value(t0, t1, t2)).runNow()))
