...
import typingsJapgolly.rollupPluginutils.anon.Resolve
...
object mod {
  ...
  object AttachedScope {
    ...
    inline def apply(
      addDeclaration: (BaseNode, Boolean, Boolean) => Callback,
      contains: String => Boolean,
      declarations: StringDictionary[Boolean],
      isBlockScope: Boolean
    ): AttachedScope = {
      val __obj = js.Dynamic.literal(addDeclaration = js.Any.fromFunction3((t0: BaseNode, t1: Boolean, t2: Boolean) => (addDeclaration(t0, t1, t2)).runNow()), contains = js.Any.fromFunction1(contains), declarations = declarations.asInstanceOf[js.Any], isBlockScope = isBlockScope.asInstanceOf[js.Any])
      __obj.asInstanceOf[AttachedScope]
    }
    
    extension [Self <: AttachedScope](x: Self) {
      
      inline def setAddDeclaration(value: (BaseNode, Boolean, Boolean) => Callback): Self = StObject.set(x, "addDeclaration", js.Any.fromFunction3((t0: BaseNode, t1: Boolean, t2: Boolean) => (value(t0, t1, t2)).runNow()))
