package typingsJapgolly.reactNativeCryptoJs

import typingsJapgolly.reactNativeCryptoJs.anon.Hasher
import typingsJapgolly.reactNativeCryptoJs.anon.PartialCipherParams
import typingsJapgolly.reactNativeCryptoJs.mod.BlockCipherMode
import typingsJapgolly.reactNativeCryptoJs.mod.CipherHelper
import typingsJapgolly.reactNativeCryptoJs.mod.CipherOption
import typingsJapgolly.reactNativeCryptoJs.mod.CipherParams
import typingsJapgolly.reactNativeCryptoJs.mod.CipherStatic
import typingsJapgolly.reactNativeCryptoJs.mod.Encoder
import typingsJapgolly.reactNativeCryptoJs.mod.Format_
import typingsJapgolly.reactNativeCryptoJs.mod.HasherHelper
import typingsJapgolly.reactNativeCryptoJs.mod.HasherStatic
import typingsJapgolly.reactNativeCryptoJs.mod.HmacHasherHelper
import typingsJapgolly.reactNativeCryptoJs.mod.KDFOption
import typingsJapgolly.reactNativeCryptoJs.mod.Padding
import typingsJapgolly.reactNativeCryptoJs.mod.WordArray
import typingsJapgolly.reactNativeCryptoJs.mod.X64Word
import typingsJapgolly.reactNativeCryptoJs.mod.X64WordArray
...
object x64CoreMod {
  ...
  object algo {
    ...
    @js.native
    open class EvpKDF ()
      extends typingsJapgolly.reactNativeCryptoJs.mod.algo.EvpKDF
    object EvpKDF {
      ...
      inline def create(cfg: Hasher): typingsJapgolly.reactNativeCryptoJs.mod.global.RNCryptoJS.algo.EvpKDF = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(cfg.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.reactNativeCryptoJs.mod.global.RNCryptoJS.algo.EvpKDF]
    }
    ...
    @js.native
    open class HMAC ()
      extends typingsJapgolly.reactNativeCryptoJs.mod.algo.HMAC
    object HMAC {
      ...
      inline def create(hasher: HasherStatic, key: String): typingsJapgolly.reactNativeCryptoJs.mod.global.RNCryptoJS.algo.HMAC = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(hasher.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.reactNativeCryptoJs.mod.global.RNCryptoJS.algo.HMAC]
      /**
        ...
        */
      /* static member */
      inline def create(hasher: HasherStatic, key: WordArray): typingsJapgolly.reactNativeCryptoJs.mod.global.RNCryptoJS.algo.HMAC = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(hasher.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.reactNativeCryptoJs.mod.global.RNCryptoJS.algo.HMAC]
    }
    ...
    @js.native
    open class PBKDF2 ()
      extends typingsJapgolly.reactNativeCryptoJs.mod.algo.PBKDF2
    object PBKDF2 {
