...
object X64WordArray {
  ...
  inline def apply(sigBytes: Double, toX32: CallbackTo[WordArray], words: js.Array[Double]): X64WordArray = {
    val __obj = js.Dynamic.literal(sigBytes = sigBytes.asInstanceOf[js.Any], toX32 = toX32.toJsFn, words = words.asInstanceOf[js.Any])
  ...
  extension [Self <: X64WordArray](x: Self) {
    ...
    inline def setToX32(value: CallbackTo[WordArray]): Self = StObject.set(x, "toX32", value.toJsFn)
