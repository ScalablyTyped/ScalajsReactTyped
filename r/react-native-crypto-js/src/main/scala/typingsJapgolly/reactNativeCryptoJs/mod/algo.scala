...
object algo {
  ...
  @js.native
  open class EvpKDF ()
    extends typingsJapgolly.reactNativeCryptoJs.mod.global.RNCryptoJS.algo.EvpKDF
  object EvpKDF {
  ...
  @js.native
  open class HMAC ()
    extends typingsJapgolly.reactNativeCryptoJs.mod.global.RNCryptoJS.algo.HMAC
  object HMAC {
  ...
  @js.native
  open class PBKDF2 ()
    extends typingsJapgolly.reactNativeCryptoJs.mod.global.RNCryptoJS.algo.PBKDF2
  object PBKDF2 {
