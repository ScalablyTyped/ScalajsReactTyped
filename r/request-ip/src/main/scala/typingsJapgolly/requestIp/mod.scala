...
import typingsJapgolly.requestIp.anon.RemoteAddress
import typingsJapgolly.requestIp.anon.Socket
  ...
  object global {
    ...
    object Express {
      ...
      object Request {
        ...
        inline def apply(): typingsJapgolly.requestIp.mod.global.Express.Request = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsJapgolly.requestIp.mod.global.Express.Request]
        }
        
        extension [Self <: typingsJapgolly.requestIp.mod.global.Express.Request](x: Self) {
