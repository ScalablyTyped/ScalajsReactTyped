...
import typingsJapgolly.reactNativeGoogleAnalyticsBridge.distModelsCustomMod.CustomDimensionsByField
import typingsJapgolly.reactNativeGoogleAnalyticsBridge.distModelsCustomMod.CustomDimensionsByIndex
import typingsJapgolly.reactNativeGoogleAnalyticsBridge.distModelsCustomMod.CustomMetrics
import typingsJapgolly.reactNativeGoogleAnalyticsBridge.distModelsProductMod.Product
import typingsJapgolly.reactNativeGoogleAnalyticsBridge.distModelsProductMod.ProductAction
...
object distModelsAnalyticsMod {
  ...
  object SessionState extends StObject {
    ...
    sealed trait End
      extends StObject
         with SessionState
    /* "end" */ val End: typingsJapgolly.reactNativeGoogleAnalyticsBridge.distModelsAnalyticsMod.SessionState.End & String = js.native
    
    @js.native
    sealed trait Start
      extends StObject
         with SessionState
    /* "start" */ val Start: typingsJapgolly.reactNativeGoogleAnalyticsBridge.distModelsAnalyticsMod.SessionState.Start & String = js.native
  }
