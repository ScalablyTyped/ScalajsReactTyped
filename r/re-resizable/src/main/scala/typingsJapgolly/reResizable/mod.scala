...
import typingsJapgolly.reResizable.anon.As
import typingsJapgolly.reResizable.anon.Height
import typingsJapgolly.reResizable.anon.HeightWidth
import typingsJapgolly.reResizable.anon.MaxHeight
import typingsJapgolly.reResizable.anon.NewHeight
import typingsJapgolly.reResizable.anon.Width
import typingsJapgolly.reResizable.anon.X
import typingsJapgolly.reResizable.anon.Y
import typingsJapgolly.reResizable.libResizerMod.Direction
import typingsJapgolly.reResizable.mod.global.Window
...
object mod {
  ...
  open class Resizable protected () extends PureComponent[ResizableProps, State, Any] {
    ...
    def onResizeStart(event: ReactMouseEventFrom[HTMLElement], direction: Direction): Unit = js.native
    def onResizeStart(event: ReactTouchEventFrom[HTMLElement], direction: Direction): Unit = js.native
  ...
  trait HandleComponent extends StObject {
    ...
    var bottom: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.undefined
    
    var bottomLeft: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.undefined
    
    var bottomRight: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.undefined
    
    var left: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.undefined
    
    var right: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.undefined
    
    var top: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.undefined
    
    var topLeft: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.undefined
    
    var topRight: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.undefined
  }
  ...
  object ResizableProps {
    ...
    extension [Self <: ResizableProps](x: Self) {
      ...
      ): Self = StObject.set(x, "onResize", js.Any.fromFunction4((t0: /* event */ MouseEvent | TouchEvent, t1: /* direction */ Direction, t2: /* elementRef */ HTMLElement, t3: /* delta */ NumberSize) => (value(t0, t1, t2, t3)).runNow()))
      ...
      inline def setOnResizeStop(
        value: (/* event */ MouseEvent | TouchEvent, /* direction */ Direction, /* elementRef */ HTMLElement, /* delta */ NumberSize) => Callback
      ): Self = StObject.set(x, "onResizeStop", js.Any.fromFunction4((t0: /* event */ MouseEvent | TouchEvent, t1: /* direction */ Direction, t2: /* elementRef */ HTMLElement, t3: /* delta */ NumberSize) => (value(t0, t1, t2, t3)).runNow()))
