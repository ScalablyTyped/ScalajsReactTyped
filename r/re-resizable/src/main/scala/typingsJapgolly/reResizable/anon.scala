...
object anon {
  ...
  object As {
    ...
    extension [Self <: As](x: Self) {
      ...
      inline def setOnResizeStart(value: Callback): Self = StObject.set(x, "onResizeStart", value.toJsFn)
      
      inline def setOnResizeStop(value: Callback): Self = StObject.set(x, "onResizeStop", value.toJsFn)
