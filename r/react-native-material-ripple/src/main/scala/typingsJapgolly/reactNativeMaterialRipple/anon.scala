...
object anon {
  ...
  trait AnimatedPropsViewProps extends StObject {
    ...
    var accessibilityHint: js.UndefOr[
    ...
    var accessibilityLabel: js.UndefOr[
    ...
    var accessibilityLanguage: js.UndefOr[
    ...
    var tvParallaxMagnification: js.UndefOr[
    ...
    var tvParallaxShiftDistanceX: js.UndefOr[
    ...
    var tvParallaxShiftDistanceY: js.UndefOr[
    ...
    var tvParallaxTiltAngle: js.UndefOr[
  ...
  object Disabled {
    ...
    extension [Self <: Disabled](x: Self) {
      ...
      inline def setOnRippleAnimation(value: (/* animation */ CompositeAnimation, /* callback */ js.Function0[Unit]) => Callback): Self = StObject.set(x, "onRippleAnimation", js.Any.fromFunction2((t0: /* animation */ CompositeAnimation, t1: /* callback */ js.Function0[Unit]) => (value(t0, t1)).runNow()))
