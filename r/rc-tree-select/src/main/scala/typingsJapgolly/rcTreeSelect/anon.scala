...
object anon {
  ...
  trait TreeSelectPropsanyDefault extends StObject {
    ...
    var fieldNames: js.UndefOr[typingsJapgolly.rcTreeSelect.esTreeSelectMod.FieldNames] = js.undefined
    ...
    var onChange: js.UndefOr[
        js.Function3[/* value */ Any, /* labelList */ js.Array[Node], /* extra */ ChangeEventExtra, Unit]
      ] = js.undefined
    ...
    var onTreeExpand: js.UndefOr[js.Function1[/* expandedKeys */ js.Array[typingsJapgolly.react.mod.Key], Unit]] = js.undefined
    
    var onTreeLoad: js.UndefOr[js.Function1[/* loadedKeys */ js.Array[typingsJapgolly.react.mod.Key], Unit]] = js.undefined
    ...
    var treeDefaultExpandedKeys: js.UndefOr[js.Array[typingsJapgolly.react.mod.Key]] = js.undefined
    
    var treeExpandAction: js.UndefOr[ExpandAction] = js.undefined
    
    var treeExpandedKeys: js.UndefOr[js.Array[typingsJapgolly.react.mod.Key]] = js.undefined
    
    var treeIcon: js.UndefOr[IconType] = js.undefined
    
    var treeLine: js.UndefOr[Boolean] = js.undefined
    
    var treeLoadedKeys: js.UndefOr[js.Array[typingsJapgolly.react.mod.Key]] = js.undefined
  ...
  object TreeSelectPropsanyDefault {
    ...
    extension [Self <: TreeSelectPropsanyDefault](x: Self) {
      ...
      inline def setFieldNames(value: typingsJapgolly.rcTreeSelect.esTreeSelectMod.FieldNames): Self = StObject.set(x, "fieldNames", value.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: (/* value */ Any, /* labelList */ js.Array[Node], /* extra */ ChangeEventExtra) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction3((t0: /* value */ Any, t1: /* labelList */ js.Array[Node], t2: /* extra */ ChangeEventExtra) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnDeselect(
        value: (LabelInValueType | typingsJapgolly.rcSelect.libSelectMod.RawValueType | ArrayElementType[Any], DefaultOptionType) => Callback
      ): Self = StObject.set(x, "onDeselect", js.Any.fromFunction2((t0: LabelInValueType | typingsJapgolly.rcSelect.libSelectMod.RawValueType | ArrayElementType[Any], t1: DefaultOptionType) => (value(t0, t1)).runNow()))
      ...
      inline def setOnSelect(
        value: (LabelInValueType | typingsJapgolly.rcSelect.libSelectMod.RawValueType | ArrayElementType[Any], DefaultOptionType) => Callback
      ): Self = StObject.set(x, "onSelect", js.Any.fromFunction2((t0: LabelInValueType | typingsJapgolly.rcSelect.libSelectMod.RawValueType | ArrayElementType[Any], t1: DefaultOptionType) => (value(t0, t1)).runNow()))
      
      inline def setOnSelectUndefined: Self = StObject.set(x, "onSelect", js.undefined)
      
      inline def setOnTreeExpand(value: /* expandedKeys */ js.Array[typingsJapgolly.react.mod.Key] => Callback): Self = StObject.set(x, "onTreeExpand", js.Any.fromFunction1((t0: /* expandedKeys */ js.Array[typingsJapgolly.react.mod.Key]) => value(t0).runNow()))
      
      inline def setOnTreeExpandUndefined: Self = StObject.set(x, "onTreeExpand", js.undefined)
      
      inline def setOnTreeLoad(value: /* loadedKeys */ js.Array[typingsJapgolly.react.mod.Key] => Callback): Self = StObject.set(x, "onTreeLoad", js.Any.fromFunction1((t0: /* loadedKeys */ js.Array[typingsJapgolly.react.mod.Key]) => value(t0).runNow()))
      ...
      inline def setSwitcherIconFunction1(value: /* props */ typingsJapgolly.rcTree.esTreeNodeMod.TreeNodeProps[DataNode] => Node): Self = StObject.set(x, "switcherIcon", js.Any.fromFunction1(value))
      ...
      inline def setTreeDefaultExpandedKeys(value: js.Array[typingsJapgolly.react.mod.Key]): Self = StObject.set(x, "treeDefaultExpandedKeys", value.asInstanceOf[js.Any])
      
      inline def setTreeDefaultExpandedKeysUndefined: Self = StObject.set(x, "treeDefaultExpandedKeys", js.undefined)
      
      inline def setTreeDefaultExpandedKeysVarargs(value: typingsJapgolly.react.mod.Key*): Self = StObject.set(x, "treeDefaultExpandedKeys", js.Array(value*))
      ...
      inline def setTreeExpandedKeys(value: js.Array[typingsJapgolly.react.mod.Key]): Self = StObject.set(x, "treeExpandedKeys", value.asInstanceOf[js.Any])
      
      inline def setTreeExpandedKeysUndefined: Self = StObject.set(x, "treeExpandedKeys", js.undefined)
      
      inline def setTreeExpandedKeysVarargs(value: typingsJapgolly.react.mod.Key*): Self = StObject.set(x, "treeExpandedKeys", js.Array(value*))
      ...
      inline def setTreeLoadedKeys(value: js.Array[typingsJapgolly.react.mod.Key]): Self = StObject.set(x, "treeLoadedKeys", value.asInstanceOf[js.Any])
      
      inline def setTreeLoadedKeysUndefined: Self = StObject.set(x, "treeLoadedKeys", js.undefined)
      
      inline def setTreeLoadedKeysVarargs(value: typingsJapgolly.react.mod.Key*): Self = StObject.set(x, "treeLoadedKeys", js.Array(value*))
