...
import typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerBooleans.`false`
import typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerBooleans.`true`
