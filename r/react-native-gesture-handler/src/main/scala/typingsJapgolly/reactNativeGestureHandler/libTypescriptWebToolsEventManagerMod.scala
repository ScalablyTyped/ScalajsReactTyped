...
object libTypescriptWebToolsEventManagerMod {
  
  /* note: abstract class */ @JSImport("react-native-gesture-handler/lib/typescript/web/tools/EventManager", JSImport.Default)
  @js.native
