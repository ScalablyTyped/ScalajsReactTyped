...
import typingsJapgolly.reactNativeGestureHandler.anon.ActiveOpacity
import typingsJapgolly.reactNativeGestureHandler.anon.DelayLongPress
import typingsJapgolly.reactNativeGestureHandler.anon.DrawerLayoutAndroidPropsc
import typingsJapgolly.reactNativeGestureHandler.anon.DrawerLockMode
...
import typingsJapgolly.reactNativeGestureHandler.anon.UnderlayColor
import typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsDrawerLayoutMod.DrawerLayoutProps
import typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsDrawerLayoutMod.default
...
import typingsJapgolly.reactNativeGestureHandler.libTypescriptHandlersForceTouchGestureHandlerMod.ForceTouchFallback
...
object mod {
  ...
  open class BaseButton protected ()
    extends typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsGestureButtonsMod.BaseButton {
  ...
  open class BorderlessButton protected ()
    extends typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsGestureButtonsMod.BorderlessButton {
  ...
  inline def FlatList[ItemT](
    props: PropsWithChildren[
      FlatListProps[ItemT] & (RefAttributes[
        typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsGestureComponentsMod.FlatList[ItemT]
      ]) & NativeViewGestureHandlerProps_
    ],
    ref: ForwardedRef[
      typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsGestureComponentsMod.FlatList[ItemT]
    ]
  ): Element | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("FlatList")(props.asInstanceOf[js.Any], ref.asInstanceOf[js.Any])).asInstanceOf[Element | Null]
  ...
  object Gesture {
    ...
    /**
      ...
      */
    inline def Exclusive(
      gestures: typingsJapgolly.reactNativeGestureHandler.libTypescriptHandlersGesturesGestureMod.Gesture*
    ): ExclusiveGesture = ^.asInstanceOf[js.Dynamic].applyDynamic("Exclusive")(gestures.asInstanceOf[Seq[js.Any]]*).asInstanceOf[ExclusiveGesture]
    ...
    inline def Race(
      gestures: typingsJapgolly.reactNativeGestureHandler.libTypescriptHandlersGesturesGestureMod.Gesture*
    ): ComposedGesture = ^.asInstanceOf[js.Dynamic].applyDynamic("Race")(gestures.asInstanceOf[Seq[js.Any]]*).asInstanceOf[ComposedGesture]
    ...
    /**
      ...
      */
    inline def Simultaneous(
      gestures: typingsJapgolly.reactNativeGestureHandler.libTypescriptHandlersGesturesGestureMod.Gesture*
    ): SimultaneousGesture = ^.asInstanceOf[js.Dynamic].applyDynamic("Simultaneous")(gestures.asInstanceOf[Seq[js.Any]]*).asInstanceOf[SimultaneousGesture]
    
    inline def Tap(): TapGesture = ^.asInstanceOf[js.Dynamic].applyDynamic("Tap")().asInstanceOf[TapGesture]
  }
  
  inline def GestureDetector(props: GestureDetectorProps): typingsJapgolly.react.mod.global.JSX.Element = ^.asInstanceOf[js.Dynamic].applyDynamic("GestureDetector")(props.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.react.mod.global.JSX.Element]
  
  inline def GestureHandlerRootView(props: GestureHandlerRootViewProps): typingsJapgolly.react.mod.global.JSX.Element = ^.asInstanceOf[js.Dynamic].applyDynamic("GestureHandlerRootView")(props.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.react.mod.global.JSX.Element]
  ...
  open class RectButton protected ()
    extends typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsGestureButtonsMod.RectButton {
  ...
  open class Swipeable protected ()
    extends typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsSwipeableMod.default {
