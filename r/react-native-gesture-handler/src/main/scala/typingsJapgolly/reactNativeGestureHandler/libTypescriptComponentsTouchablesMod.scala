...
import typingsJapgolly.reactNativeGestureHandler.anon.DelayPressOut
import typingsJapgolly.reactNativeGestureHandler.anon.GenericTouchablePropschil
...
import typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsTouchablesTouchableHighlightMod.default
...
object libTypescriptComponentsTouchablesMod {
  ...
  open class TouchableNativeFeedback protected ()
    extends typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsTouchablesTouchableNativeFeedbackMod.default {
  ...
  open class TouchableOpacity ()
    extends typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsTouchablesTouchableOpacityMod.default
  /* static members */
