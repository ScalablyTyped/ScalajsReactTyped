...
object libTypescriptComponentsGestureButtonsMod {
  ...
  object BaseButtonProps {
    ...
    extension [Self <: BaseButtonProps](x: Self) {
      ...
      inline def setOnActiveStateChange(value: /* active */ Boolean => Callback): Self = StObject.set(x, "onActiveStateChange", js.Any.fromFunction1((t0: /* active */ Boolean) => value(t0).runNow()))
      ...
      inline def setOnPress(value: /* pointerInside */ Boolean => Callback): Self = StObject.set(x, "onPress", js.Any.fromFunction1((t0: /* pointerInside */ Boolean) => value(t0).runNow()))
