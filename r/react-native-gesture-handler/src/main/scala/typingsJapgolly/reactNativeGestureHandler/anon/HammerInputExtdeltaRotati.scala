...
trait HammerInputExtdeltaRotati extends StObject {
  ...
  var eventType: typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`1` | typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`2` | `4` | `8`
...
object HammerInputExtdeltaRotati {
  ...
  inline def apply(
    ...
    direction: Double,
    distance: Double,
    eventType: typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`1` | typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`2` | `4` | `8`,
    isFinal: Boolean,
    isFirst: Boolean,
    maxPointers: Double,
  ...
  extension [Self <: HammerInputExtdeltaRotati](x: Self) {
    ...
    inline def setEventType(
      value: typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`1` | typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`2` | `4` | `8`
