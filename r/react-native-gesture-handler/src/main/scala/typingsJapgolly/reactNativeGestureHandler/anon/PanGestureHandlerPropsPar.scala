...
object PanGestureHandlerPropsPar {
  ...
  extension [Self <: PanGestureHandlerPropsPar](x: Self) {
    ...
    inline def setOnGestureEvent(value: /* event */ GestureEvent[PanGestureHandlerEventPayload] => Callback): Self = StObject.set(x, "onGestureEvent", js.Any.fromFunction1((t0: /* event */ GestureEvent[PanGestureHandlerEventPayload]) => value(t0).runNow()))
    
    inline def setOnGestureEventUndefined: Self = StObject.set(x, "onGestureEvent", js.undefined)
    
    inline def setOnHandlerStateChange(value: /* event */ HandlerStateChangeEvent[PanGestureHandlerEventPayload] => Callback): Self = StObject.set(x, "onHandlerStateChange", js.Any.fromFunction1((t0: /* event */ HandlerStateChangeEvent[PanGestureHandlerEventPayload]) => value(t0).runNow()))
