...
import typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsTouchablesGenericTouchableMod.default
...
object GenericTouchablePropschil {
  ...
  extension [Self <: GenericTouchablePropschil](x: Self) {
    ...
    inline def setRefFunction1(value: default | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: default | Null) => value(t0).runNow()))
