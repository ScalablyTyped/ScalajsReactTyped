...
trait ACTIVE extends StObject {
  ...
  val BEGAN: typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`2`
  
  val CANCELLED: `3`
  
  val END: `5`
  
  val FAILED: typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`1`
...
object ACTIVE {
  ...
  extension [Self <: ACTIVE](x: Self) {
    ...
    inline def setBEGAN(value: typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`2`): Self = StObject.set(x, "BEGAN", value.asInstanceOf[js.Any])
    ...
    inline def setFAILED(value: typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`1`): Self = StObject.set(x, "FAILED", value.asInstanceOf[js.Any])
