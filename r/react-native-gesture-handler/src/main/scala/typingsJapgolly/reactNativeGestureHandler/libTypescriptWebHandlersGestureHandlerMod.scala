...
import typingsJapgolly.reactNativeGestureHandler.libTypescriptWebInterfacesMod.PointerType
...
object libTypescriptWebHandlersGestureHandlerMod {
  ...
  trait GestureHandler extends StObject {
    ...
    /* protected */ var eventManagers: js.Array[
        typingsJapgolly.reactNativeGestureHandler.libTypescriptWebToolsEventManagerMod.default
      ] = js.native
    ...
    def getTracker(): typingsJapgolly.reactNativeGestureHandler.libTypescriptWebToolsPointerTrackerMod.default = js.native
    ...
    /* protected */ def init(ref: Double, propsRef: RefHandle[Any]): Unit = js.native
    ...
    /* protected */ var tracker: typingsJapgolly.reactNativeGestureHandler.libTypescriptWebToolsPointerTrackerMod.default = js.native
