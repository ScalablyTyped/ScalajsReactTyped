...
import typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsTouchablesGenericTouchableMod.InternalProps
import typingsJapgolly.reactNativeGestureHandler.libTypescriptComponentsTouchablesGenericTouchableMod.TouchableState
...
object GenericTouchable {
  
  inline def apply(extraButtonProps: TouchableNativeFeedbackExtraProps): Builder = {
    val __props = js.Dynamic.literal(extraButtonProps = extraButtonProps.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[GenericTouchableProps & InternalProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onStateChange(value: (/* oldState */ TouchableState, /* newState */ TouchableState) => Callback): this.type = set("onStateChange", js.Any.fromFunction2((t0: /* oldState */ TouchableState, t1: /* newState */ TouchableState) => (value(t0, t1)).runNow()))
  ...
  def withProps(p: GenericTouchableProps & InternalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
