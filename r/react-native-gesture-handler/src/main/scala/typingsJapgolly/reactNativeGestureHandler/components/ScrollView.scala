...
import typingsJapgolly.reactNative.mod.ScrollViewProperties
...
object ScrollView {
  def apply(
    ...
    NativeViewGestureHandlerProperties with ScrollViewProperties, 
    typingsJapgolly.reactNativeGestureHandler.mod.ScrollView, 
    Unit, 
    NativeViewGestureHandlerProperties with ScrollViewProperties
  ] = {
  ...
  typingsJapgolly.reactNativeGestureHandler.mod.NativeViewGestureHandlerProperties with typingsJapgolly.reactNative.mod.ScrollViewProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeGestureHandler.mod.ScrollView](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeGestureHandler.mod.NativeViewGestureHandlerProperties with typingsJapgolly.reactNative.mod.ScrollViewProperties])(children: _*)
  }
