...
object NativeViewGestureHandler {
  def apply(
    ...
    typingsJapgolly.reactNativeGestureHandler.mod.NativeViewGestureHandler, 
    Unit, 
    NativeViewGestureHandlerProperties
  ] = {
  ...
  typingsJapgolly.reactNativeGestureHandler.mod.NativeViewGestureHandlerProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeGestureHandler.mod.NativeViewGestureHandler](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeGestureHandler.mod.NativeViewGestureHandlerProperties])(children: _*)
  }
