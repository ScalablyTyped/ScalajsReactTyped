...
object BorderlessButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeGestureHandler.mod.BorderlessButton] {
  ...
  def withProps(p: BorderlessButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
