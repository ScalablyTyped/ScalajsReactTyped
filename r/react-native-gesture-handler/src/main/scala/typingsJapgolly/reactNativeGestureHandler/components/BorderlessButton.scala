...
import typingsJapgolly.reactNativeGestureHandler.mod.BorderlessButtonProperties
...
object BorderlessButton {
  def apply(
    ...
    typingsJapgolly.reactNativeGestureHandler.mod.BorderlessButton, 
    Unit, 
    BorderlessButtonProperties
  ] = {
  ...
  typingsJapgolly.reactNativeGestureHandler.mod.BorderlessButtonProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeGestureHandler.mod.BorderlessButton](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeGestureHandler.mod.BorderlessButtonProperties])(children: _*)
  }
