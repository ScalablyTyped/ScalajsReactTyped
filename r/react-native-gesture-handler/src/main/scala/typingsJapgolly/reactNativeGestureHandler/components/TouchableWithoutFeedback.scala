...
object TouchableWithoutFeedback {
  def TouchableWithoutFeedbackProps(
    ...
    typingsJapgolly.reactNative.mod.TouchableWithoutFeedbackProps, 
    typingsJapgolly.reactNativeGestureHandler.mod.TouchableWithoutFeedback, 
    Unit, 
    typingsJapgolly.reactNative.mod.TouchableWithoutFeedbackProps
  ] = {
  ...
  typingsJapgolly.reactNativeGestureHandler.mod.TouchableWithoutFeedback](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.TouchableWithoutFeedbackProps])(children: _*)
  }
