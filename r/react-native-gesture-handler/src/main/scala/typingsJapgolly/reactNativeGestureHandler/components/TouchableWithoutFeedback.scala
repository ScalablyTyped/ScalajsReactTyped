...
object TouchableWithoutFeedback {
  ...
  @JSImport("react-native-gesture-handler/lib/typescript/mocks", "default.TouchableWithoutFeedback")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[
          typingsJapgolly.reactNativeGestureHandler.libTypescriptMocksMod.default.TouchableWithoutFeedback
        ] {
