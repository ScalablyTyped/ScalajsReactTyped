...
object ForceTouchGestureHandler {
  ...
  @JSImport("react-native-gesture-handler/lib/typescript/mocks", "default.ForceTouchGestureHandler")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[
          typingsJapgolly.reactNativeGestureHandler.libTypescriptMocksMod.default.ForceTouchGestureHandler
        ] {
