...
object PinchGestureHandler {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onGestureEvent(value: /* event */ GestureEvent[PinchGestureHandlerEventPayload] => Callback): this.type = set("onGestureEvent", js.Any.fromFunction1((t0: /* event */ GestureEvent[PinchGestureHandlerEventPayload]) => value(t0).runNow()))
    
    inline def onHandlerStateChange(value: /* event */ HandlerStateChangeEvent[PinchGestureHandlerEventPayload] => Callback): this.type = set("onHandlerStateChange", js.Any.fromFunction1((t0: /* event */ HandlerStateChangeEvent[PinchGestureHandlerEventPayload]) => value(t0).runNow()))
  ...
  def withProps(p: PinchGestureHandlerProps & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
