...
object RectButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeGestureHandler.mod.RectButton] {
  ...
  def withProps(p: RectButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
