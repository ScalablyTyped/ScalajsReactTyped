...
import typingsJapgolly.reactNativeGestureHandler.mod.RectButtonProperties
...
object RectButton {
  def apply(
    ...
    typingsJapgolly.reactNativeGestureHandler.mod.RectButton, 
    Unit, 
    RectButtonProperties
  ] = {
  ...
  typingsJapgolly.reactNativeGestureHandler.mod.RectButtonProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeGestureHandler.mod.RectButton](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeGestureHandler.mod.RectButtonProperties])(children: _*)
  }
