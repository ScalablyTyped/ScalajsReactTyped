...
object TouchableNativeFeedback {
  def TouchableNativeFeedbackProps(
    ...
    typingsJapgolly.reactNativeGestureHandler.mod.TouchableNativeFeedback, 
    Unit, 
    typingsJapgolly.reactNative.mod.TouchableNativeFeedbackProps
  ] = {
  ...
  typingsJapgolly.reactNativeGestureHandler.mod.TouchableNativeFeedback](this.componentImport)
