...
import typingsJapgolly.reactNative.mod.FlatListProperties
...
object FlatList {
  def apply[ItemT](
    ...
    NativeViewGestureHandlerProperties with FlatListProperties[ItemT], 
    typingsJapgolly.reactNativeGestureHandler.mod.FlatList[ItemT], 
    Unit, 
    NativeViewGestureHandlerProperties with FlatListProperties[ItemT]
  ] = {
  ...
  typingsJapgolly.reactNativeGestureHandler.mod.NativeViewGestureHandlerProperties with typingsJapgolly.reactNative.mod.FlatListProperties[ItemT], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeGestureHandler.mod.FlatList[ItemT]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeGestureHandler.mod.NativeViewGestureHandlerProperties with typingsJapgolly.reactNative.mod.FlatListProperties[ItemT]])(children: _*)
  }
