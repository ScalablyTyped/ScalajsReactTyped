...
object FlatList {
  ...
  inline def apply[ItemT](): Builder[ItemT] = {
    ...
    new Builder[ItemT](js.Array(this.component, __props.asInstanceOf[PropsWithChildren[
  ...
  ): Builder[ItemT] = new Builder[ItemT](js.Array(this.component, p.asInstanceOf[js.Any]))
}
