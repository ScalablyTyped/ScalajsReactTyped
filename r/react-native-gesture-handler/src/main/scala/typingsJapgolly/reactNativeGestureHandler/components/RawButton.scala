...
object RawButton {
  ...
  def withProps(p: RawButtonProps & NativeViewGestureHandlerProps_ & RefAttributes[ComponentType[Any]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
