...
object LongPressGestureHandler {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def minDurationMs(value: Double): this.type = set("minDurationMs", value.asInstanceOf[js.Any])
    ...
    inline def onGestureEvent(value: /* event */ GestureEvent[LongPressGestureHandlerEventPayload] => Callback): this.type = set("onGestureEvent", js.Any.fromFunction1((t0: /* event */ GestureEvent[LongPressGestureHandlerEventPayload]) => value(t0).runNow()))
    
    inline def onHandlerStateChange(value: /* event */ HandlerStateChangeEvent[LongPressGestureHandlerEventPayload] => Callback): this.type = set("onHandlerStateChange", js.Any.fromFunction1((t0: /* event */ HandlerStateChangeEvent[LongPressGestureHandlerEventPayload]) => value(t0).runNow()))
  ...
  def withProps(p: LongPressGestureHandlerProps_ & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
