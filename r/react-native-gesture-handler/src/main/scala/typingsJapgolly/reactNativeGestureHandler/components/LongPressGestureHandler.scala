...
import typingsJapgolly.reactNativeGestureHandler.mod.LongPressGestureHandlerGestureEvent
import typingsJapgolly.reactNativeGestureHandler.mod.LongPressGestureHandlerProperties
import typingsJapgolly.reactNativeGestureHandler.mod.LongPressGestureHandlerStateChangeEvent
...
object LongPressGestureHandler {
  def apply(
    ...
    typingsJapgolly.reactNativeGestureHandler.mod.LongPressGestureHandler, 
    Unit, 
    LongPressGestureHandlerProperties
  ] = {
  ...
  typingsJapgolly.reactNativeGestureHandler.mod.LongPressGestureHandlerProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeGestureHandler.mod.LongPressGestureHandler](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeGestureHandler.mod.LongPressGestureHandlerProperties])(children: _*)
  }
