...
object Switch {
  ...
  def withProps(p: SwitchProps & NativeViewGestureHandlerProps_ & RefAttributes[ComponentType[Any]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
