...
object Switch {
  def apply(
    ...
    NativeViewGestureHandlerProperties with SwitchProperties, 
    typingsJapgolly.reactNativeGestureHandler.mod.Switch, 
    Unit, 
    NativeViewGestureHandlerProperties with SwitchProperties
  ] = {
  ...
  typingsJapgolly.reactNativeGestureHandler.mod.NativeViewGestureHandlerProperties with typingsJapgolly.reactNative.mod.SwitchProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeGestureHandler.mod.Switch](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeGestureHandler.mod.NativeViewGestureHandlerProperties with typingsJapgolly.reactNative.mod.SwitchProperties])(children: _*)
  }
