...
object TapGestureHandler {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def maxDelayMs(value: Double): this.type = set("maxDelayMs", value.asInstanceOf[js.Any])
    
    inline def maxDeltaX(value: Double): this.type = set("maxDeltaX", value.asInstanceOf[js.Any])
    
    inline def maxDeltaY(value: Double): this.type = set("maxDeltaY", value.asInstanceOf[js.Any])
    
    inline def maxDist(value: Double): this.type = set("maxDist", value.asInstanceOf[js.Any])
    
    inline def maxDurationMs(value: Double): this.type = set("maxDurationMs", value.asInstanceOf[js.Any])
    
    inline def minPointers(value: Double): this.type = set("minPointers", value.asInstanceOf[js.Any])
    
    inline def numberOfTaps(value: Double): this.type = set("numberOfTaps", value.asInstanceOf[js.Any])
    ...
    inline def onGestureEvent(value: /* event */ GestureEvent[TapGestureHandlerEventPayload] => Callback): this.type = set("onGestureEvent", js.Any.fromFunction1((t0: /* event */ GestureEvent[TapGestureHandlerEventPayload]) => value(t0).runNow()))
    
    inline def onHandlerStateChange(value: /* event */ HandlerStateChangeEvent[TapGestureHandlerEventPayload] => Callback): this.type = set("onHandlerStateChange", js.Any.fromFunction1((t0: /* event */ HandlerStateChangeEvent[TapGestureHandlerEventPayload]) => value(t0).runNow()))
  ...
  def withProps(p: TapGestureHandlerProps_ & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
