...
object TouchableOpacity {
  def TouchableOpacityProps(
    ...
    typingsJapgolly.reactNative.mod.TouchableOpacityProps, 
    typingsJapgolly.reactNativeGestureHandler.mod.TouchableOpacity, 
    Unit, 
    typingsJapgolly.reactNative.mod.TouchableOpacityProps
  ] = {
  ...
  typingsJapgolly.reactNativeGestureHandler.mod.TouchableOpacity](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.TouchableOpacityProps])(children: _*)
  }
