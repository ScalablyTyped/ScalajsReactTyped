...
object TouchableHighlight {
  ...
  @JSImport("react-native-gesture-handler/lib/typescript/mocks", "default.TouchableHighlight")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[
          typingsJapgolly.reactNativeGestureHandler.libTypescriptMocksMod.default.TouchableHighlight
        ] {
