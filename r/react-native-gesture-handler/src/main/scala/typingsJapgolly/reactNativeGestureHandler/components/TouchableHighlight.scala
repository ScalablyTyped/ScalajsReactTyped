...
object TouchableHighlight {
  def TouchableHighlightProps(
    ...
    typingsJapgolly.reactNative.mod.TouchableHighlightProps, 
    typingsJapgolly.reactNativeGestureHandler.mod.TouchableHighlight, 
    Unit, 
    typingsJapgolly.reactNative.mod.TouchableHighlightProps
  ] = {
  ...
  typingsJapgolly.reactNativeGestureHandler.mod.TouchableHighlight](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.TouchableHighlightProps])(children: _*)
  }
  def ContainedTouchableProperties(
    ...
    typingsJapgolly.reactNativeGestureHandler.mod.ContainedTouchableProperties, 
    typingsJapgolly.reactNativeGestureHandler.mod.TouchableHighlight, 
    Unit, 
    typingsJapgolly.reactNativeGestureHandler.mod.ContainedTouchableProperties
  ] = {
  ...
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeGestureHandler.mod.TouchableHighlight](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeGestureHandler.mod.ContainedTouchableProperties])(children: _*)
  }
