...
object TextInput {
  def apply(
    ...
    NativeViewGestureHandlerProperties with TextInputProperties, 
    typingsJapgolly.reactNativeGestureHandler.mod.TextInput, 
    Unit, 
    NativeViewGestureHandlerProperties with TextInputProperties
  ] = {
  ...
  typingsJapgolly.reactNativeGestureHandler.mod.NativeViewGestureHandlerProperties with typingsJapgolly.reactNative.mod.TextInputProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeGestureHandler.mod.TextInput](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeGestureHandler.mod.NativeViewGestureHandlerProperties with typingsJapgolly.reactNative.mod.TextInputProperties])(children: _*)
  }
