...
object TextInput {
  ...
  def withProps(p: TextInputProps & NativeViewGestureHandlerProps_ & RefAttributes[ComponentType[Any]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
