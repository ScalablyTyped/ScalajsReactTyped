...
object libTypescriptFabricRngesturehandlerrootviewnativecomponentMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `libTypescriptFabricRngesturehandlerrootviewnativecomponentMod.foo` */
