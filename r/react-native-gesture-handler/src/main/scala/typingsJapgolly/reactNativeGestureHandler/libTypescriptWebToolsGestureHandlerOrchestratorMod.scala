...
object libTypescriptWebToolsGestureHandlerOrchestratorMod {
  ...
  trait GestureHandlerOrchestrator extends StObject {
    ...
    def cancelMouseAndPenGestures(
      currentHandler: typingsJapgolly.reactNativeGestureHandler.libTypescriptWebHandlersGestureHandlerMod.default
    ): Unit = js.native
    ...
    def recordHandlerIfNotPresent(
      handler: typingsJapgolly.reactNativeGestureHandler.libTypescriptWebHandlersGestureHandlerMod.default
    ): Unit = js.native
    
    def removeHandlerFromOrchestrator(
      handler: typingsJapgolly.reactNativeGestureHandler.libTypescriptWebHandlersGestureHandlerMod.default
    ): Unit = js.native
