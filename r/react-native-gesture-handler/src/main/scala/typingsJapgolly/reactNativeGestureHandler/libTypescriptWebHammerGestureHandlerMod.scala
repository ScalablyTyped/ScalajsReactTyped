...
import typingsJapgolly.hammerjs.HammerPoint
import typingsJapgolly.hammerjs.RecognizerStatic
import typingsJapgolly.reactNativeGestureHandler.anon.Dictx
import typingsJapgolly.reactNativeGestureHandler.anon.FailedSuccess
import typingsJapgolly.reactNativeGestureHandler.anon.NativeEvent
import typingsJapgolly.reactNativeGestureHandler.anon.PartialenabledbooleanminP
import typingsJapgolly.reactNativeGestureHandler.anon.Pointers
import typingsJapgolly.reactNativeGestureHandler.anon.RequiredConfig
...
import typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerStrings.`1`
import typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerStrings.`2`
import typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerStrings.`4`
import typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerStrings.`8`
...
object libTypescriptWebHammerGestureHandlerMod {
  ...
  trait HammerInputExt extends StObject {
    ...
    var eventType: typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`1` | typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`2` | typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`4` | typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`8`
  ...
  object HammerInputExt {
    ...
    extension [Self <: HammerInputExt](x: Self) {
      ...
      inline def setEventType(
        value: typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`1` | typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`2` | typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`4` | typingsJapgolly.reactNativeGestureHandler.reactNativeGestureHandlerInts.`8`
