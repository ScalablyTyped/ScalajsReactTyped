...
object DrawerLayoutAndroid {
  ...
  typingsJapgolly.reactDashNativeDashGestureDashHandler.reactDashNativeDashGestureDashHandlerMod.DrawerLayoutAndroid](js.constructorOf[typingsJapgolly.reactDashNativeDashGestureDashHandler.reactDashNativeDashGestureDashHandlerMod.DrawerLayoutAndroid])
