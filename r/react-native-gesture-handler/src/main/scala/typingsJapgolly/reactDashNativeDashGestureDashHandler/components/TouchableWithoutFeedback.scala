...
import typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableWithoutFeedbackProperties
...
object TouchableWithoutFeedback {
  def apply(
    ...
    typingsJapgolly.reactDashNativeDashGestureDashHandler.reactDashNativeDashGestureDashHandlerMod.TouchableWithoutFeedback, 
    Unit, 
    TouchableWithoutFeedbackProperties
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableWithoutFeedbackProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNativeDashGestureDashHandler.reactDashNativeDashGestureDashHandlerMod.TouchableWithoutFeedback](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableWithoutFeedbackProperties])(children: _*)
  }
