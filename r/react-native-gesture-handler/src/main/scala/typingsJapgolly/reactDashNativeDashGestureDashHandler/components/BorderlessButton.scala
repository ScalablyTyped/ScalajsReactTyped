...
import typingsJapgolly.reactDashNativeDashGestureDashHandler.reactDashNativeDashGestureDashHandlerMod.BorderlessButtonProperties
...
object BorderlessButton {
  def apply(
    ...
    typingsJapgolly.reactDashNativeDashGestureDashHandler.reactDashNativeDashGestureDashHandlerMod.BorderlessButton, 
    Unit, 
    BorderlessButtonProperties
  ] = {
