...
import typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableOpacityProperties
...
object TouchableOpacity {
  def apply(
    ...
    typingsJapgolly.reactDashNativeDashGestureDashHandler.reactDashNativeDashGestureDashHandlerMod.TouchableOpacity, 
    Unit, 
    TouchableOpacityProperties
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableOpacityProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNativeDashGestureDashHandler.reactDashNativeDashGestureDashHandlerMod.TouchableOpacity](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableOpacityProperties])(children: _*)
  }
