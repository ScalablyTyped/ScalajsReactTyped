...
import typingsJapgolly.reactNativeEasyUpgrade.AnonAllowedInMetered
import typingsJapgolly.reactNativeEasyUpgrade.AnonHasNewVersion
import typingsJapgolly.reactNativeEasyUpgrade.AnonVERSIONCODE
