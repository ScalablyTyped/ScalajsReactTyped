...
import typingsJapgolly.rdfjsTermMap.rdfjsTermMapStrings.termMap
...
object factoryMod {
  ...
  trait Factory extends StObject {
    ...
    def termMap[T /* <: Term */, V](): typingsJapgolly.rdfjsTermMap.mod.default[T, V] = js.native
    def termMap[T /* <: Term */, V](entries: js.Array[js.Tuple2[Term, V]]): typingsJapgolly.rdfjsTermMap.mod.default[T, V] = js.native
  }
}
