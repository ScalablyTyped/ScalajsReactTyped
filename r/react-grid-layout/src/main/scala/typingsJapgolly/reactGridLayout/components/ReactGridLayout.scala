...
object ReactGridLayout {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def containerPadding(value: js.Tuple2[Double, Double]): this.type = set("containerPadding", value.asInstanceOf[js.Any])
    ...
    inline def layout(value: js.Array[Layout]): this.type = set("layout", value.asInstanceOf[js.Any])
    
    inline def layoutVarargs(value: Layout*): this.type = set("layout", js.Array(value*))
    
    inline def margin(value: js.Tuple2[Double, Double]): this.type = set("margin", value.asInstanceOf[js.Any])
    ...
    inline def onLayoutChange(value: /* layout */ js.Array[Layout] => Callback): this.type = set("onLayoutChange", js.Any.fromFunction1((t0: /* layout */ js.Array[Layout]) => value(t0).runNow()))
