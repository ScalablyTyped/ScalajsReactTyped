...
import typingsJapgolly.reactWidgets.esmListOptionGroupMod.Props
...
object ListOptionGroup {
  ...
  implicit def make(companion: ListOptionGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
