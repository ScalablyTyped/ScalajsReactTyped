...
import typingsJapgolly.reactWidgets.esmDatePickerInputMod.DatePickerInputProps
...
object DatePickerInput {
  
  inline def apply(
    editing: Boolean,
    formatter: RequiredDateMethods,
    localizer: Localizer[Any, Any],
    onChange: (js.Date | Null, String) => Callback,
    parse: String => js.Date | Null
  ): Builder = {
    val __props = js.Dynamic.literal(editing = editing.asInstanceOf[js.Any], formatter = formatter.asInstanceOf[js.Any], localizer = localizer.asInstanceOf[js.Any], onChange = js.Any.fromFunction2((t0: js.Date | Null, t1: String) => (onChange(t0, t1)).runNow()), parse = js.Any.fromFunction1(parse))
    new Builder(js.Array(this.component, __props.asInstanceOf[DatePickerInputProps[Any] & RefAttributes[HTMLInputElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def displayFormat(value: Any): this.type = set("displayFormat", value.asInstanceOf[js.Any])
    
    inline def download(value: Any): this.type = set("download", value.asInstanceOf[js.Any])
    
    inline def draggable(value: Booleanish): this.type = set("draggable", value.asInstanceOf[js.Any])
    
    inline def editFormat(value: Any): this.type = set("editFormat", value.asInstanceOf[js.Any])
  ...
  def withProps(p: DatePickerInputProps[Any] & RefAttributes[HTMLInputElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
