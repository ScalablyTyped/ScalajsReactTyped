...
object MultiselectInput {
  ...
  implicit def make(companion: MultiselectInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PickHTMLPropsHTMLInputEle): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
