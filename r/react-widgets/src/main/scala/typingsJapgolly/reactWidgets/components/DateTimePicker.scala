...
object DateTimePicker {
  ...
  implicit def make(companion: DateTimePicker.type): SharedBuilder_DatePickerPropsRefAttributes2034774610[DatePickerHandle] = new SharedBuilder_DatePickerPropsRefAttributes2034774610[DatePickerHandle](js.Array(this.component, js.Dictionary.empty))()
