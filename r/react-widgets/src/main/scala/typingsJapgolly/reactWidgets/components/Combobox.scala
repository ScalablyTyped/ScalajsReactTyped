...
import typingsJapgolly.reactWidgets.esmComboboxMod.ComboboxHandle
import typingsJapgolly.reactWidgets.esmComboboxMod.ComboboxProps
...
object Combobox {
  ...
  inline def apply[TDataItem](): Builder[TDataItem] = {
    ...
    new Builder[TDataItem](js.Array(this.component, __props.asInstanceOf[ComboboxProps[TDataItem] & RefAttributes[ComboboxHandle]]))
  }
  ...
  open class Builder[TDataItem] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[ComboboxHandle & js.Object] {
    ...
    inline def autoSelectMatches(value: Boolean): this.type = set("autoSelectMatches", value.asInstanceOf[js.Any])
    ...
    inline def defaultValue(value: String | TDataItem): this.type = set("defaultValue", value.asInstanceOf[js.Any])
    ...
    inline def hideCaret(value: Boolean): this.type = set("hideCaret", value.asInstanceOf[js.Any])
    
    inline def hideEmptyPopup(value: Boolean): this.type = set("hideEmptyPopup", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (TDataItem | String, /* metadata */ Source) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: TDataItem | String, t1: /* metadata */ Source) => (value(t0, t1)).runNow()))
    ...
    inline def onSelect(value: (TDataItem | String, /* metadata */ `0`) => Callback): this.type = set("onSelect", js.Any.fromFunction2((t0: TDataItem | String, t1: /* metadata */ `0`) => (value(t0, t1)).runNow()))
    ...
    inline def value(value: String | TDataItem): this.type = set("value", value.asInstanceOf[js.Any])
  }
  
  implicit def make[TDataItem](companion: Combobox.type): Builder[TDataItem] = new Builder[TDataItem](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps[TDataItem](p: ComboboxProps[TDataItem] & RefAttributes[ComboboxHandle]): Builder[TDataItem] = new Builder[TDataItem](js.Array(this.component, p.asInstanceOf[js.Any]))
}
