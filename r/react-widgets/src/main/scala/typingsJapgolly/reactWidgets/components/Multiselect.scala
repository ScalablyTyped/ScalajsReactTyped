...
import typingsJapgolly.reactWidgets.esmMultiselectMod.MultiselectHandle
import typingsJapgolly.reactWidgets.esmMultiselectMod.MultiselectProps
...
object Multiselect {
  ...
  inline def apply[TDataItem](): Builder[TDataItem] = {
    ...
    new Builder[TDataItem](js.Array(this.component, __props.asInstanceOf[MultiselectProps[TDataItem] & RefAttributes[MultiselectHandle]]))
  }
  ...
  open class Builder[TDataItem] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[MultiselectHandle & js.Object] {
    ...
    inline def clearTagIcon(value: VdomNode): this.type = set("clearTagIcon", value.rawNode.asInstanceOf[js.Any])
    
    inline def clearTagIconNull: this.type = set("clearTagIcon", null)
    
    inline def clearTagIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("clearTagIcon", js.Array(value*))
    
    inline def clearTagIconVdomElement(value: VdomElement): this.type = set("clearTagIcon", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def defaultValue(value: js.Array[Any]): this.type = set("defaultValue", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* dataItem */ js.Array[TDataItem], /* metadata */ OriginalEvent[TDataItem]) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* dataItem */ js.Array[TDataItem], t1: /* metadata */ OriginalEvent[TDataItem]) => (value(t0, t1)).runNow()))
    ...
    inline def renderTagValue(value: Item[TDataItem] => Node): this.type = set("renderTagValue", js.Any.fromFunction1(value))
    ...
    inline def showPlaceholderWithValues(value: Boolean): this.type = set("showPlaceholderWithValues", value.asInstanceOf[js.Any])
    
    inline def showSelectedItemsInList(value: Boolean): this.type = set("showSelectedItemsInList", value.asInstanceOf[js.Any])
    ...
    inline def tagListComponent(value: ComponentType[MultiselectTagListProps[DataItem]]): this.type = set("tagListComponent", value.asInstanceOf[js.Any])
    
    inline def tagOptionComponent(value: TagComponentProp): this.type = set("tagOptionComponent", value.asInstanceOf[js.Any])
  ...
  implicit def make[TDataItem](companion: Multiselect.type): Builder[TDataItem] = new Builder[TDataItem](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps[TDataItem](p: MultiselectProps[TDataItem] & RefAttributes[MultiselectHandle]): Builder[TDataItem] = new Builder[TDataItem](js.Array(this.component, p.asInstanceOf[js.Any]))
}
