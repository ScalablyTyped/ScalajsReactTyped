...
object TimeInput {
  ...
  inline def apply(precision: minutes | seconds | milliseconds): Builder = {
    val __props = js.Dynamic.literal(precision = precision.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[TimeInputProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def datePart(value: js.Date): this.type = set("datePart", value.asInstanceOf[js.Any])
    ...
    inline def emptyCharacter(value: String): this.type = set("emptyCharacter", value.asInstanceOf[js.Any])
    
    inline def focused(value: Boolean): this.type = set("focused", value.asInstanceOf[js.Any])
    
    inline def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    
    inline def hoursAddon(value: VdomNode): this.type = set("hoursAddon", value.rawNode.asInstanceOf[js.Any])
    
    inline def hoursAddonNull: this.type = set("hoursAddon", null)
    
    inline def hoursAddonVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("hoursAddon", js.Array(value*))
    
    inline def hoursAddonVdomElement(value: VdomElement): this.type = set("hoursAddon", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def millisecondsAddon(value: VdomNode): this.type = set("millisecondsAddon", value.rawNode.asInstanceOf[js.Any])
    
    inline def millisecondsAddonNull: this.type = set("millisecondsAddon", null)
    
    inline def millisecondsAddonVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("millisecondsAddon", js.Array(value*))
    
    inline def millisecondsAddonVdomElement(value: VdomElement): this.type = set("millisecondsAddon", value.rawElement.asInstanceOf[js.Any])
    
    inline def minutesAddon(value: VdomNode): this.type = set("minutesAddon", value.rawNode.asInstanceOf[js.Any])
    
    inline def minutesAddonNull: this.type = set("minutesAddon", null)
    
    inline def minutesAddonVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("minutesAddon", js.Array(value*))
    
    inline def minutesAddonVdomElement(value: VdomElement): this.type = set("minutesAddon", value.rawElement.asInstanceOf[js.Any])
    
    inline def noClearButton(value: Boolean): this.type = set("noClearButton", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* date */ js.Date | Null, /* ctx */ js.UndefOr[Any]) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* date */ js.Date | Null, t1: /* ctx */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    ...
    inline def padValues(value: Boolean): this.type = set("padValues", value.asInstanceOf[js.Any])
    ...
    inline def secondsAddon(value: VdomNode): this.type = set("secondsAddon", value.rawNode.asInstanceOf[js.Any])
    
    inline def secondsAddonNull: this.type = set("secondsAddon", null)
    
    inline def secondsAddonVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("secondsAddon", js.Array(value*))
    
    inline def secondsAddonVdomElement(value: VdomElement): this.type = set("secondsAddon", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def use12HourClock(value: Boolean): this.type = set("use12HourClock", value.asInstanceOf[js.Any])
  ...
  def withProps(p: TimeInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
