...
import typingsJapgolly.reactWidgets.esmWidgetMod.WidgetProps
...
object Widget {
  ...
  @JSImport("react-widgets/esm/Widget", JSImport.Default)
  @js.native
  ...
  def withProps(p: WidgetProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
