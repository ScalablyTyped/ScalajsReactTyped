...
import typingsJapgolly.reactWidgets.esmInputMod.InputProps
...
object Input {
  ...
  def withProps(p: InputProps & RefAttributes[HTMLInputElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
