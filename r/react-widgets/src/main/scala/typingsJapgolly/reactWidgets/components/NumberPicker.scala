...
import typingsJapgolly.reactWidgets.anon.Decrement
import typingsJapgolly.reactWidgets.anon.RawValue
...
import typingsJapgolly.reactWidgets.reactWidgetsStrings.auto
...
object NumberPicker {
  ...
  @JSImport("react-widgets/esm", "NumberPicker")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def decrementIcon(value: VdomNode): this.type = set("decrementIcon", value.rawNode.asInstanceOf[js.Any])
    
    inline def decrementIconNull: this.type = set("decrementIcon", null)
    
    inline def decrementIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("decrementIcon", js.Array(value*))
    
    inline def decrementIconVdomElement(value: VdomElement): this.type = set("decrementIcon", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def incrementIcon(value: VdomNode): this.type = set("incrementIcon", value.rawNode.asInstanceOf[js.Any])
    
    inline def incrementIconNull: this.type = set("incrementIcon", null)
    
    inline def incrementIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("incrementIcon", js.Array(value*))
    
    inline def incrementIconVdomElement(value: VdomElement): this.type = set("incrementIcon", value.rawElement.asInstanceOf[js.Any])
    
    inline def inlist(value: Any): this.type = set("inlist", value.asInstanceOf[js.Any])
    
    inline def inputMode(value: none | text | tel | url | email | numeric | decimal | search): this.type = set("inputMode", value.asInstanceOf[js.Any])
    
    inline def inputProps(value: HtmlHTMLAttributes[HTMLInputElement]): this.type = set("inputProps", value.asInstanceOf[js.Any])
    ...
    inline def localizer(value: Localizer[Any, Any]): this.type = set("localizer", value.asInstanceOf[js.Any])
    
    inline def max(value: Double): this.type = set("max", value.asInstanceOf[js.Any])
    
    inline def messages(value: Decrement): this.type = set("messages", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* nextValue */ Double | Null, /* ctx */ RawValue) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* nextValue */ Double | Null, t1: /* ctx */ RawValue) => (value(t0, t1)).runNow()))
    ...
    inline def onKeyPress(value: /* event */ ReactKeyboardEventFrom[HTMLDivElement] => Callback): this.type = set("onKeyPress", js.Any.fromFunction1((t0: /* event */ ReactKeyboardEventFrom[HTMLDivElement]) => value(t0).runNow()))
    ...
    inline def onKeyUp(value: /* event */ ReactKeyboardEventFrom[HTMLDivElement] => Callback): this.type = set("onKeyUp", js.Any.fromFunction1((t0: /* event */ ReactKeyboardEventFrom[HTMLDivElement]) => value(t0).runNow()))
    ...
    inline def precision(value: Double | auto): this.type = set("precision", value.asInstanceOf[js.Any])
