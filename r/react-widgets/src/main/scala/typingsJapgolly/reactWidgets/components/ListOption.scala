...
object ListOption {
  ...
  inline def apply[TDataItem](
    dataItem: TDataItem,
    onSelect: (TDataItem, ReactMouseEventFrom[Element]) => Callback,
    selected: Boolean
  ): Builder[TDataItem] = {
    val __props = js.Dynamic.literal(dataItem = dataItem.asInstanceOf[js.Any], onSelect = js.Any.fromFunction2((t0: TDataItem, t1: ReactMouseEventFrom[Element]) => (onSelect(t0, t1)).runNow()), selected = selected.asInstanceOf[js.Any])
    new Builder[TDataItem](js.Array(this.component, __props.asInstanceOf[ListOptionProps[TDataItem]]))
  }
  ...
  def withProps[TDataItem](p: ListOptionProps[TDataItem]): Builder[TDataItem] = new Builder[TDataItem](js.Array(this.component, p.asInstanceOf[js.Any]))
}
