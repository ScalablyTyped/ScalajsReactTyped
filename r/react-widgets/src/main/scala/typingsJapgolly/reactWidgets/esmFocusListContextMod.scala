...
import typingsJapgolly.reactWidgets.reactWidgetsStrings.loop
import typingsJapgolly.reactWidgets.reactWidgetsStrings.stop
...
object esmFocusListContextMod {
  ...
  inline def useListOption[TDataItem, T /* <: HTMLElement */](dataItem: TDataItem): js.Tuple3[RefHandle[T], Boolean, js.UndefOr[String]] = ^.asInstanceOf[js.Dynamic].applyDynamic("useListOption")(dataItem.asInstanceOf[js.Any]).asInstanceOf[js.Tuple3[RefHandle[T], Boolean, js.UndefOr[String]]]
