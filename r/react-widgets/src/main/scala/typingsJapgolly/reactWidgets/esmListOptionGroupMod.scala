...
object esmListOptionGroupMod {
  ...
  object default {
    ...
    object propTypes {
      ...
      @JSImport("react-widgets/esm/ListOptionGroup", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-widgets/esm/ListOptionGroup", "default.propTypes.className")
      @js.native
      ...
      @JSImport("react-widgets/esm/ListOptionGroup", "default.propTypes.component")
      @js.native
