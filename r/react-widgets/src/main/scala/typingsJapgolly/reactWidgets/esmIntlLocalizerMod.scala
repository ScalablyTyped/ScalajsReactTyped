...
import typingsJapgolly.reactWidgets.anon.Culture
import typingsJapgolly.reactWidgets.anon.CultureUndefined
import typingsJapgolly.reactWidgets.esmLocalizationMod.DateTimePart
...
object esmIntlLocalizerMod {
  ...
  trait IntlNumberLocalizer
    extends StObject
       with typingsJapgolly.reactWidgets.esmLocalizationMod.NumberLocalizer[NumberFormatOptions] {
