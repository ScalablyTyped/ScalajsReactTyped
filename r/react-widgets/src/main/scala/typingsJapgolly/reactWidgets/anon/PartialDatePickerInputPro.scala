...
object PartialDatePickerInputPro {
  ...
  extension [Self <: PartialDatePickerInputPro](x: Self) {
    ...
    inline def setOnChange(value: (/* date */ js.Date | Null, /* rawValue */ String) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* date */ js.Date | Null, t1: /* rawValue */ String) => (value(t0, t1)).runNow()))
