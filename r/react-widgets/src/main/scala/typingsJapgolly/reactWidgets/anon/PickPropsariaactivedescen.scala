...
trait PickPropsariaactivedescen extends StObject {
  ...
  var ref: js.UndefOr[typingsJapgolly.react.mod.Ref[HTMLInputElement]] = js.undefined
...
object PickPropsariaactivedescen {
  
  inline def apply(max: Double, min: Double, onChange: ReactEventFrom[HTMLInputElement & Element] => Callback): PickPropsariaactivedescen = {
    val __obj = js.Dynamic.literal(max = max.asInstanceOf[js.Any], min = min.asInstanceOf[js.Any], onChange = js.Any.fromFunction1((t0: ReactEventFrom[HTMLInputElement & Element]) => onChange(t0).runNow()))
    __obj.asInstanceOf[PickPropsariaactivedescen]
  }
  
  extension [Self <: PickPropsariaactivedescen](x: Self) {
    ...
    inline def setRef(value: typingsJapgolly.react.mod.Ref[HTMLInputElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
