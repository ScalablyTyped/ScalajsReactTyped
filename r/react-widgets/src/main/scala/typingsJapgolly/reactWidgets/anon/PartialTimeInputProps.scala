...
object PartialTimeInputProps {
  ...
  extension [Self <: PartialTimeInputProps](x: Self) {
    ...
    inline def setHoursAddonVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "hoursAddon", js.Array(value*))
    ...
    inline def setMillisecondsAddonVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "millisecondsAddon", js.Array(value*))
    ...
    inline def setMinutesAddonVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "minutesAddon", js.Array(value*))
    ...
    inline def setSecondsAddonVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "secondsAddon", js.Array(value*))
