...
object esmTimeInputMod {
  ...
  trait TimeInputProps extends StObject {
    ...
    var hoursAddon: js.UndefOr[Node] = js.undefined
    ...
    var millisecondsAddon: js.UndefOr[Node] = js.undefined
    
    var minutesAddon: js.UndefOr[Node] = js.undefined
    ...
    var secondsAddon: js.UndefOr[Node] = js.undefined
  ...
  object TimeInputProps {
    ...
    extension [Self <: TimeInputProps](x: Self) {
      ...
      inline def setHoursAddon(value: VdomNode): Self = StObject.set(x, "hoursAddon", value.rawNode.asInstanceOf[js.Any])
      
      inline def setHoursAddonNull: Self = StObject.set(x, "hoursAddon", null)
      
      inline def setHoursAddonUndefined: Self = StObject.set(x, "hoursAddon", js.undefined)
      
      inline def setHoursAddonVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "hoursAddon", js.Array(value*))
      
      inline def setHoursAddonVdomElement(value: VdomElement): Self = StObject.set(x, "hoursAddon", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setMillisecondsAddon(value: VdomNode): Self = StObject.set(x, "millisecondsAddon", value.rawNode.asInstanceOf[js.Any])
      
      inline def setMillisecondsAddonNull: Self = StObject.set(x, "millisecondsAddon", null)
      
      inline def setMillisecondsAddonUndefined: Self = StObject.set(x, "millisecondsAddon", js.undefined)
      
      inline def setMillisecondsAddonVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "millisecondsAddon", js.Array(value*))
      
      inline def setMillisecondsAddonVdomElement(value: VdomElement): Self = StObject.set(x, "millisecondsAddon", value.rawElement.asInstanceOf[js.Any])
      
      inline def setMinutesAddon(value: VdomNode): Self = StObject.set(x, "minutesAddon", value.rawNode.asInstanceOf[js.Any])
      
      inline def setMinutesAddonNull: Self = StObject.set(x, "minutesAddon", null)
      
      inline def setMinutesAddonUndefined: Self = StObject.set(x, "minutesAddon", js.undefined)
      
      inline def setMinutesAddonVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "minutesAddon", js.Array(value*))
      
      inline def setMinutesAddonVdomElement(value: VdomElement): Self = StObject.set(x, "minutesAddon", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: (/* date */ js.Date | Null, /* ctx */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* date */ js.Date | Null, t1: /* ctx */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
      ...
      inline def setSecondsAddon(value: VdomNode): Self = StObject.set(x, "secondsAddon", value.rawNode.asInstanceOf[js.Any])
      
      inline def setSecondsAddonNull: Self = StObject.set(x, "secondsAddon", null)
      
      inline def setSecondsAddonUndefined: Self = StObject.set(x, "secondsAddon", js.undefined)
      
      inline def setSecondsAddonVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "secondsAddon", js.Array(value*))
      
      inline def setSecondsAddonVdomElement(value: VdomElement): Self = StObject.set(x, "secondsAddon", value.rawElement.asInstanceOf[js.Any])
