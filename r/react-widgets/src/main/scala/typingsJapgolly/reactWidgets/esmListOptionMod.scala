...
object esmListOptionMod {
  ...
  trait ListOptionProps[TDataItem] extends StObject {
    ...
    def onSelect(dataItem: TDataItem, event: ReactMouseEventFrom[org.scalajs.dom.Element]): Unit
  ...
  object ListOptionProps {
    ...
    inline def apply[TDataItem](
      dataItem: TDataItem,
      onSelect: (TDataItem, ReactMouseEventFrom[org.scalajs.dom.Element]) => Callback,
      selected: Boolean
    ): ListOptionProps[TDataItem] = {
      val __obj = js.Dynamic.literal(dataItem = dataItem.asInstanceOf[js.Any], onSelect = js.Any.fromFunction2((t0: TDataItem, t1: ReactMouseEventFrom[org.scalajs.dom.Element]) => (onSelect(t0, t1)).runNow()), selected = selected.asInstanceOf[js.Any])
    ...
    extension [Self <: ListOptionProps[?], TDataItem](x: Self & ListOptionProps[TDataItem]) {
      ...
      inline def setOnSelect(value: (TDataItem, ReactMouseEventFrom[org.scalajs.dom.Element]) => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction2((t0: TDataItem, t1: ReactMouseEventFrom[org.scalajs.dom.Element]) => (value(t0, t1)).runNow()))
