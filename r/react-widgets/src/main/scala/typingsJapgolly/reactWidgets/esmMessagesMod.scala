...
object esmMessagesMod {
  ...
  inline def useMessagesWithDefaults(defaults: PartialMessages): ProcessedMessages = ^.asInstanceOf[js.Dynamic].applyDynamic("useMessagesWithDefaults")(defaults.asInstanceOf[js.Any]).asInstanceOf[ProcessedMessages]
  
  type LabelMessage = String | (js.Function1[/* ctx */ Any, String])
  
  trait Messages extends StObject {
    
    def createOption(_value: Any, searchTerm: String): Node
  ...
  type RenderableMessage = Node | js.Function0[Node]
