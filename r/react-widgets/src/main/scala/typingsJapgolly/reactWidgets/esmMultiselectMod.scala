...
import typingsJapgolly.reactWidgets.esmMultiselectTagListMod.MultiselectTagListProps
import typingsJapgolly.reactWidgets.esmMultiselectTagListMod.RenderTagProp
import typingsJapgolly.reactWidgets.esmMultiselectTagListMod.TagComponentProp
import typingsJapgolly.reactWidgets.esmPopupMod.PopupProps
import typingsJapgolly.reactWidgets.esmSharedMod.AllowCreate
import typingsJapgolly.reactWidgets.esmSharedMod.SearchHandler
...
object esmMultiselectMod extends Shortcut {
  ...
  /**
    ...
    * @public
    */
  @JSImport("react-widgets/esm/Multiselect", JSImport.Default)
  @js.native
  ...
  trait Multiselect extends StObject {
    ...
    def apply[TDataItem](props: MultiselectProps[TDataItem] & RefAttributes[MultiselectHandle]): Element | Null = js.native
  ...
  /* Inlined parent react-widgets.react-widgets/esm/shared.WidgetProps */
  /* Inlined parent react-widgets.react-widgets/esm/shared.PopupWidgetProps */
  /* Inlined parent react-widgets.react-widgets/esm/shared.Filterable<TDataItem> */
  /* Inlined parent react-widgets.react-widgets/esm/shared.Searchable */
  /* Inlined parent std.Omit<react-widgets.react-widgets/esm/shared.BaseListboxInputProps<TDataItem, std.Array<unknown>>, 'onChange'> */
  trait MultiselectProps[TDataItem] extends StObject {
    ...
    var clearTagIcon: js.UndefOr[Node] = js.undefined
  ...
  object MultiselectProps {
    ...
    extension [Self <: MultiselectProps[?], TDataItem](x: Self & MultiselectProps[TDataItem]) {
      ...
      inline def setClearTagIconVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "clearTagIcon", js.Array(value*))
      ...
      inline def setOnChange(value: (/* dataItem */ js.Array[TDataItem], /* metadata */ OriginalEvent[TDataItem]) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* dataItem */ js.Array[TDataItem], t1: /* metadata */ OriginalEvent[TDataItem]) => (value(t0, t1)).runNow()))
  ...
  /* This means you don't have to write `default`, but can instead just say `esmMultiselectMod.foo` */
