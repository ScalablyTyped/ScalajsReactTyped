package typingsJapgolly.reactWidgets.dateTimePickerMod
...
import typingsJapgolly.reactWidgets.commonPropsMod.AutoFocus
import typingsJapgolly.reactWidgets.commonPropsMod.ReactWidgetsCommonDropdownProps
...
trait DateTimePickerProps
  ...
  /**
    ...
    * changed.
    */
  var onSelect: js.UndefOr[js.Function1[/* date */ js.UndefOr[js.Date], Unit]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var parse: js.UndefOr[(js.Function1[/* str */ String, js.Date]) | js.Array[String] | String] = js.undefined
  /**
...
object DateTimePickerProps {
  ...
  def apply(
    ...
    onKeyDown: /* event */ ReactKeyboardEventFrom[org.scalajs.dom.raw.Element] => Callback = null,
    onKeyPress: /* event */ ReactKeyboardEventFrom[org.scalajs.dom.raw.Element] => Callback = null,
