...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "date-arithmetic" % "4.1-dt-20211202Z-265ae3",
  "org.scalablytyped.japgolly" %%% "prop-types" % "15.7-dt-20220407Z-2e1de8",
  "org.scalablytyped.japgolly" %%% "react" % "18.0-dt-20220922Z-c9da7d",
  "org.scalablytyped.japgolly" %%% "react-transition-group" % "4.4-dt-20220622Z-62a161",
