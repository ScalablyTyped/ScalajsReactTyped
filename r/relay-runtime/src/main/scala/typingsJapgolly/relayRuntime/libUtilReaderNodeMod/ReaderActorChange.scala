...
trait ReaderActorChange
  ...
  val fragmentSpread: ReaderFragmentSpread
...
object ReaderActorChange {
  
  inline def apply(fragmentSpread: ReaderFragmentSpread, kind: String, name: String): ReaderActorChange = {
  ...
  extension [Self <: ReaderActorChange](x: Self) {
    ...
    inline def setFragmentSpread(value: ReaderFragmentSpread): Self = StObject.set(x, "fragmentSpread", value.asInstanceOf[js.Any])
