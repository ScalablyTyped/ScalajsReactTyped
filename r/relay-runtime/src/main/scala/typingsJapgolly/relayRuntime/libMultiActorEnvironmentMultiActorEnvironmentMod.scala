...
import typingsJapgolly.relayRuntime.libMultiActorEnvironmentMultiActorEnvironmentTypesMod.ActorEnvironment
import typingsJapgolly.relayRuntime.libMultiActorEnvironmentMultiActorEnvironmentTypesMod.MultiActorStoreUpdater
...
object libMultiActorEnvironmentMultiActorEnvironmentMod {
  ...
  open class MultiActorEnvironment protected ()
    extends StObject
       with typingsJapgolly.relayRuntime.libMultiActorEnvironmentMultiActorEnvironmentTypesMod.MultiActorEnvironment {
  ...
  object MultiActorEnvironmentConfig {
    ...
    extension [Self <: MultiActorEnvironmentConfig](x: Self) {
      ...
      inline def setLogFn(value: /* logEvent */ LogEvent => Callback): Self = StObject.set(x, "logFn", js.Any.fromFunction1((t0: /* logEvent */ LogEvent) => value(t0).runNow()))
