...
import typingsJapgolly.relayRuntime.anon.Column
...
object libNetworkRelayNetworkTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithData
    - typingsJapgolly.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithExtensionsOnly
    - typingsJapgolly.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithoutData
  */
  trait GraphQLSingularResponse extends StObject
  object GraphQLSingularResponse {
    
    inline def GraphQLResponseWithData(data: PayloadData): typingsJapgolly.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithData = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithData]
    }
    
    inline def GraphQLResponseWithExtensionsOnly(data: Null, extensions: PayloadExtensions): typingsJapgolly.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithExtensionsOnly = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], extensions = extensions.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithExtensionsOnly]
    }
    
    inline def GraphQLResponseWithoutData(errors: js.Array[PayloadError]): typingsJapgolly.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithoutData = {
      val __obj = js.Dynamic.literal(errors = errors.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithoutData]
    }
  }
  ...
  object LegacyObserver {
    ...
    extension [Self <: LegacyObserver[?], T](x: Self & LegacyObserver[T]) {
      ...
      inline def setOnNext(value: /* data */ T => Callback): Self = StObject.set(x, "onNext", js.Any.fromFunction1((t0: /* data */ T) => value(t0).runNow()))
