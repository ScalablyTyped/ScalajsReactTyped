...
import typingsJapgolly.relayRuntime.relayConnectionMod.ConnectionReference
import typingsJapgolly.relayRuntime.relayConnectionMod.ConnectionResolver
import typingsJapgolly.relayRuntime.relayConnectionMod.ConnectionSnapshot
