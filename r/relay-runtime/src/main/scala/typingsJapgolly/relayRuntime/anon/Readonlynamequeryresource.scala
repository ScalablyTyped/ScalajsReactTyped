...
trait Readonlynamequeryresource
  ...
  val fetchPolicy: typingsJapgolly.relayRuntime.libUtilRelayRuntimeTypesMod.FetchPolicy
...
object Readonlynamequeryresource {
  ...
  inline def apply(
    fetchPolicy: typingsJapgolly.relayRuntime.libUtilRelayRuntimeTypesMod.FetchPolicy,
