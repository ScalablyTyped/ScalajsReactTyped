...
import typingsJapgolly.relayRuntime.libStoreRelayStoreTypesMod.Scheduler
...
object GcReleaseBufferSize {
  ...
  extension [Self <: GcReleaseBufferSize](x: Self) {
    ...
    inline def setGcScheduler(value: /* callback */ js.Function0[Unit] => Callback): Self = StObject.set(x, "gcScheduler", js.Any.fromFunction1((t0: /* callback */ js.Function0[Unit]) => value(t0).runNow()))
