...
object libStoreRelayRecordStateMod {
  ...
  object default extends StObject {
    ...
    /* "EXISTENT" */ val EXISTENT: typingsJapgolly.relayRuntime.libStoreRelayRecordStateMod.RelayRecordState.EXISTENT & String = js.native
    
    /* "NONEXISTENT" */ val NONEXISTENT: typingsJapgolly.relayRuntime.libStoreRelayRecordStateMod.RelayRecordState.NONEXISTENT & String = js.native
    
    /* "UNKNOWN" */ val UNKNOWN: typingsJapgolly.relayRuntime.libStoreRelayRecordStateMod.RelayRecordState.UNKNOWN & String = js.native
  }
