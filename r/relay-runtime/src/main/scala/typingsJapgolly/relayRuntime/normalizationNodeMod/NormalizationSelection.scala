...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.relayRuntime.normalizationNodeMod.NormalizationCondition
  - typingsJapgolly.relayRuntime.normalizationNodeMod.NormalizationClientExtension
  - typingsJapgolly.relayRuntime.normalizationNodeMod.NormalizationField
  - typingsJapgolly.relayRuntime.normalizationNodeMod.NormalizationHandle
  - typingsJapgolly.relayRuntime.normalizationNodeMod.NormalizationInlineFragment
  - typingsJapgolly.relayRuntime.normalizationNodeMod.NormalizationMatchField
*/
