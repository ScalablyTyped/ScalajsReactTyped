...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.relayRuntime.normalizationNodeMod.NormalizationDefer
  - typingsJapgolly.relayRuntime.normalizationNodeMod.NormalizationOperation
  - typingsJapgolly.relayRuntime.normalizationNodeMod.NormalizationSplitOperation
  - typingsJapgolly.relayRuntime.normalizationNodeMod.NormalizationStream
*/
