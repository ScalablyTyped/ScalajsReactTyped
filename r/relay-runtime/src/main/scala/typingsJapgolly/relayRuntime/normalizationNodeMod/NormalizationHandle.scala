...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.relayRuntime.normalizationNodeMod.NormalizationScalarHandle
  - typingsJapgolly.relayRuntime.normalizationNodeMod.NormalizationLinkedHandle
*/
