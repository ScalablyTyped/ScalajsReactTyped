...
object libNetworkRelayObservableMod {
  ...
  object Observer {
    ...
    extension [Self <: Observer[?], T](x: Self & Observer[T]) {
      ...
      inline def setUnsubscribe(value: /* subscription */ Subscription => Callback): Self = StObject.set(x, "unsubscribe", js.Any.fromFunction1((t0: /* subscription */ Subscription) => value(t0).runNow()))
