package typingsJapgolly.rdfjsNamespace

import typingsJapgolly.rdfjsNamespace.mod.NamespaceBuilder
import typingsJapgolly.rdfjsNamespace.rdfjsNamespaceStrings.namespace
