...
object mod {
  ...
  type ImageZoom = japgolly.scalajs.react.facade.React.Component[ImageZoomProps & js.Object, js.Object]
  ...
  object ImageZoomProps {
    ...
    extension [Self <: ImageZoomProps](x: Self) {
      ...
      inline def setOnUnzoom(value: CallbackTo[js.Object]): Self = StObject.set(x, "onUnzoom", value.toJsFn)
      
      inline def setOnUnzoomUndefined: Self = StObject.set(x, "onUnzoom", js.undefined)
      
      inline def setOnZoom(value: CallbackTo[js.Object]): Self = StObject.set(x, "onZoom", value.toJsFn)
      
      inline def setOnZoomUndefined: Self = StObject.set(x, "onZoom", js.undefined)
      
      inline def setShouldHandleZoom(value: CallbackTo[Boolean]): Self = StObject.set(x, "shouldHandleZoom", value.toJsFn)
