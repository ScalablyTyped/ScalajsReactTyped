...
abstract class SharedApply_HelmetProps1285037561[ComponentRef] () {
  ...
  def apply(
    ...
    if (onChangeClientState != null) __obj.updateDynamic("onChangeClientState")(js.Any.fromFunction3((t0: /* newState */ js.Any, t1: /* addedTags */ typingsJapgolly.reactHelmetWithVisor.mod.HelmetTags, t2: /* removedTags */ typingsJapgolly.reactHelmetWithVisor.mod.HelmetTags) => onChangeClientState(t0, t1, t2).runNow()))
  ...
  typingsJapgolly.reactHelmetWithVisor.mod.HelmetProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactHelmetWithVisor.mod.HelmetProps])(children: _*)
  }
}
