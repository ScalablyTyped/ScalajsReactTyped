...
import typingsJapgolly.reactNativeVideo.anon.Bitrate
import typingsJapgolly.reactNativeVideo.anon.Height
import typingsJapgolly.reactNativeVideo.anon.Index
