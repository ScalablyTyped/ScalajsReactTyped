...
import typingsJapgolly.remotedevServer.remotedevServerBooleans.`true`
import typingsJapgolly.remotedevServer.remotedevServerStrings.http
import typingsJapgolly.remotedevServer.remotedevServerStrings.https
...
object mod {
  ...
  inline def apply(argv: Options): js.Promise[typingsJapgolly.socketcluster.mod.^ | PortUsedError] = ^.asInstanceOf[js.Dynamic].apply(argv.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.socketcluster.mod.^ | PortUsedError]]
  ...
  object LogLevel extends StObject {
    ...
    sealed trait ERROR
      extends StObject
         with LogLevel
    /* 1 */ val ERROR: typingsJapgolly.remotedevServer.mod.LogLevel.ERROR & Double = js.native
    
    @js.native
    sealed trait INFO
      extends StObject
         with LogLevel
    /* 3 */ val INFO: typingsJapgolly.remotedevServer.mod.LogLevel.INFO & Double = js.native
    
    @js.native
    sealed trait NONE
      extends StObject
         with LogLevel
    /* 0 */ val NONE: typingsJapgolly.remotedevServer.mod.LogLevel.NONE & Double = js.native
    
    @js.native
    sealed trait WARN
      extends StObject
         with LogLevel
    /* 2 */ val WARN: typingsJapgolly.remotedevServer.mod.LogLevel.WARN & Double = js.native
  }
  ...
  object PortUsedError {
    ...
    inline def apply(on: (String, js.Function0[Unit]) => Callback): PortUsedError = {
      val __obj = js.Dynamic.literal(on = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (on(t0, t1)).runNow()), portAlreadyUsed = true)
