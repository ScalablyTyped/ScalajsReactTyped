...
import typingsJapgolly.reactNativeRatings.anon.BackgroundColor
...
object distSwipeRatingMod {
  ...
  object SwipeRatingProps {
    ...
    extension [Self <: SwipeRatingProps](x: Self) {
      ...
      inline def setRatingImageVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "ratingImage", js.Array(value*))
