...
object distComponentsStarMod extends Shortcut {
  ...
  object StarProps {
    ...
    extension [Self <: StarProps](x: Self) {
      ...
      inline def setStarSelectedInPosition(value: /* number */ Any => Callback): Self = StObject.set(x, "starSelectedInPosition", js.Any.fromFunction1((t0: /* number */ Any) => value(t0).runNow()))
