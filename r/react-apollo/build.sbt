...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "apollo__react-components" % "3.1.3-0b32c6",
  "org.scalablytyped.japgolly" %%% "apollo__react-hoc" % "3.1.3-e65380",
  "org.scalablytyped.japgolly" %%% "apollo__react-hooks" % "3.1.3-b2a79d",
  "org.scalablytyped.japgolly" %%% "apollo__react-ssr" % "3.1.3-aa6e0b",
