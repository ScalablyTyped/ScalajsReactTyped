...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.reactPlaidLink.mod.PlaidLinkOptionsWithPublicKey
  - typingsJapgolly.reactPlaidLink.mod.PlaidLinkOptionsWithLinkToken
*/
trait PlaidLinkOptions extends StObject
object PlaidLinkOptions {
  
  inline def PlaidLinkOptionsWithLinkToken(onSuccess: (/* public_token */ String, /* metadata */ PlaidLinkOnSuccessMetadata) => Callback): typingsJapgolly.reactPlaidLink.mod.PlaidLinkOptionsWithLinkToken = {
    ...
    __obj.asInstanceOf[typingsJapgolly.reactPlaidLink.mod.PlaidLinkOptionsWithLinkToken]
  }
  ...
  inline def PlaidLinkOptionsWithPublicKey(
    ...
    __obj.asInstanceOf[typingsJapgolly.reactPlaidLink.mod.PlaidLinkOptionsWithPublicKey]
  }
}
