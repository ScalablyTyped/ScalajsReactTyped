package typingsJapgolly.reactPlaidLink.distIndexDotumdDotminMod
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.reactPlaidLink.distIndexDotumdDotminMod.PlaidLinkOptionsWithPublicKey
  - typingsJapgolly.reactPlaidLink.distIndexDotumdDotminMod.PlaidLinkOptionsWithLinkToken
*/
trait PlaidLinkOptions extends StObject
object PlaidLinkOptions {
  
  inline def PlaidLinkOptionsWithLinkToken(onSuccess: (/* public_token */ String, /* metadata */ PlaidLinkOnSuccessMetadata) => Callback): typingsJapgolly.reactPlaidLink.distIndexDotumdDotminMod.PlaidLinkOptionsWithLinkToken = {
    ...
    __obj.asInstanceOf[typingsJapgolly.reactPlaidLink.distIndexDotumdDotminMod.PlaidLinkOptionsWithLinkToken]
  }
  ...
  inline def PlaidLinkOptionsWithPublicKey(
    ...
    __obj.asInstanceOf[typingsJapgolly.reactPlaidLink.distIndexDotumdDotminMod.PlaidLinkOptionsWithPublicKey]
  }
}
