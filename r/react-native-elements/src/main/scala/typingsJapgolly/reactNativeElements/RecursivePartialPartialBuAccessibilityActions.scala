...
trait RecursivePartialPartialBuAccessibilityActions extends js.Object {
  var TouchableComponent: js.UndefOr[RecursivePartial[js.UndefOr[ComponentClassP[js.Object]]]] = js.undefined
...
object RecursivePartialPartialBuAccessibilityActions {
  @scala.inline
  def apply(
    TouchableComponent: RecursivePartial[js.UndefOr[ComponentClassP[js.Object]]] = null,
    ...
    onBlur: RecursivePartial[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]]] = null,
    onFocus: RecursivePartial[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]]] = null,
    onLayout: RecursivePartial[js.UndefOr[js.Function1[/* event */ LayoutChangeEvent, Unit]]] = null,
    onLongPress: RecursivePartial[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]]] = null,
    onMagicTap: RecursivePartial[js.UndefOr[js.Function0[Unit]]] = null,
    onPress: RecursivePartial[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]]] = null,
    onPressIn: RecursivePartial[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]]] = null,
    onPressOut: RecursivePartial[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]]] = null,
