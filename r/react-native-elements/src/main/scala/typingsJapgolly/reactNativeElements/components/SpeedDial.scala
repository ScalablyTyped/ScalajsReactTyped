...
object SpeedDial {
  ...
  inline def apply(
    ...
    theme: Theme[SpeedDialProps],
    updateTheme: RecursivePartialFullThemeAvatar => Callback
  ): Builder = {
    val __props = js.Dynamic.literal(children = children.asInstanceOf[js.Any], isOpen = isOpen.asInstanceOf[js.Any], onClose = onClose.toJsFn, onOpen = onOpen.toJsFn, replaceTheme = js.Any.fromFunction1((t0: RecursivePartialFullThemeAvatar) => replaceTheme(t0).runNow()), theme = theme.asInstanceOf[js.Any], updateTheme = js.Any.fromFunction1((t0: RecursivePartialFullThemeAvatar) => updateTheme(t0).runNow()))
    new Builder(js.Array(this.component, __props.asInstanceOf[SpeedDialProps & Partial[ThemeProps[SpeedDialProps]]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def openIcon(value: IconNode): this.type = set("openIcon", value.asInstanceOf[js.Any])
  ...
  def withProps(p: SpeedDialProps & Partial[ThemeProps[SpeedDialProps]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
