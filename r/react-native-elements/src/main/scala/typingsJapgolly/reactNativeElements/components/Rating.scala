...
object Rating {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RatingProps, typingsJapgolly.reactNativeElements.mod.Rating, Unit, RatingProps] = {
  ...
  typingsJapgolly.reactNativeElements.mod.Rating](this.componentImport)
