...
object Overlay {
  ...
  inline def apply(
    ...
    theme: Theme[OverlayProps],
    updateTheme: RecursivePartialFullThemeAvatar => Callback
  ): Builder = {
    val __props = js.Dynamic.literal(isVisible = isVisible.asInstanceOf[js.Any], replaceTheme = js.Any.fromFunction1((t0: RecursivePartialFullThemeAvatar) => replaceTheme(t0).runNow()), theme = theme.asInstanceOf[js.Any], updateTheme = js.Any.fromFunction1((t0: RecursivePartialFullThemeAvatar) => updateTheme(t0).runNow()))
    new Builder(js.Array(this.component, __props.asInstanceOf[OverlayProps & Partial[ThemeProps[OverlayProps]]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onRequestClose(value: ReactEventFrom[NodeHandle & Element] => Callback): this.type = set("onRequestClose", js.Any.fromFunction1((t0: ReactEventFrom[NodeHandle & Element]) => value(t0).runNow()))
  ...
  def withProps(p: OverlayProps & Partial[ThemeProps[OverlayProps]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
