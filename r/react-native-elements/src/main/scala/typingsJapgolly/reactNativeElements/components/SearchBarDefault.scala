...
import typingsJapgolly.reactNativeElements.anon.PartialThemePropsSearchBaReplaceTheme
...
object SearchBarDefault {
  ...
  inline def apply(
    ...
    val __props = js.Dynamic.literal(lightTheme = lightTheme.asInstanceOf[js.Any], onBlur = onBlur.toJsFn, onChangeText = onChangeText.toJsFn, onClear = onClear.toJsFn, onFocus = onFocus.toJsFn, platform = platform.asInstanceOf[js.Any], round = round.asInstanceOf[js.Any], showLoading = showLoading.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[SearchBarDefaultProps & PartialThemePropsSearchBaReplaceTheme]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeElements.distSearchbarSearchBarDefaultMod.default] {
    ...
    inline def theme(value: Theme[SearchBarDefaultProps]): this.type = set("theme", value.asInstanceOf[js.Any])
  ...
  def withProps(p: SearchBarDefaultProps & PartialThemePropsSearchBaReplaceTheme): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
