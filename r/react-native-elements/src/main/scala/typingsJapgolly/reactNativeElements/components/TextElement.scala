...
object TextElement {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[TextProps & Partial[ThemeProps[TextProps]]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def h1(value: Boolean): this.type = set("h1", value.asInstanceOf[js.Any])
    
    inline def h1Style(value: StyleProp[TextStyle]): this.type = set("h1Style", value.asInstanceOf[js.Any])
    
    inline def h1StyleNull: this.type = set("h1Style", null)
    
    inline def h2(value: Boolean): this.type = set("h2", value.asInstanceOf[js.Any])
    
    inline def h2Style(value: StyleProp[TextStyle]): this.type = set("h2Style", value.asInstanceOf[js.Any])
    
    inline def h2StyleNull: this.type = set("h2Style", null)
    
    inline def h3(value: Boolean): this.type = set("h3", value.asInstanceOf[js.Any])
    
    inline def h3Style(value: StyleProp[TextStyle]): this.type = set("h3Style", value.asInstanceOf[js.Any])
    
    inline def h3StyleNull: this.type = set("h3Style", null)
    
    inline def h4(value: Boolean): this.type = set("h4", value.asInstanceOf[js.Any])
    
    inline def h4Style(value: StyleProp[TextStyle]): this.type = set("h4Style", value.asInstanceOf[js.Any])
    
    inline def h4StyleNull: this.type = set("h4Style", null)
  ...
  def withProps(p: TextProps & Partial[ThemeProps[TextProps]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
