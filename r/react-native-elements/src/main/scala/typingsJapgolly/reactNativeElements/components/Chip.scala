...
import typingsJapgolly.reactNativeElements.distButtonsChipMod.ChipProps
...
object Chip {
  ...
  inline def apply(
    ...
    theme: Theme[ChipProps],
    `type`: (js.UndefOr[solid | clear | outline]) & (js.UndefOr[solid | outline]),
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ChipProps & Partial[ThemeProps[ChipProps]]]))
  }
  ...
  def withProps(p: ChipProps & Partial[ThemeProps[ChipProps]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
