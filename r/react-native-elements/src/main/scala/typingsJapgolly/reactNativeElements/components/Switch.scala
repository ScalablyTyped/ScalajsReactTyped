...
object Switch {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[SwitchProps & Partial[ThemeProps[SwitchProps]]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onChange(value: ReactEventFrom[NodeHandle & Element] => js.Promise[Unit] | Unit): this.type = set("onChange", js.Any.fromFunction1(value))
  ...
  def withProps(p: SwitchProps & Partial[ThemeProps[SwitchProps]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
