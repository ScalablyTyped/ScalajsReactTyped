...
object FAB {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[FABProps & Partial[ThemeProps[FABProps]]]))
  }
  
  @JSImport("react-native-elements/dist/buttons/FAB", "FAB")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def placement(value: left | right): this.type = set("placement", value.asInstanceOf[js.Any])
  ...
  def withProps(p: FABProps & Partial[ThemeProps[FABProps]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
