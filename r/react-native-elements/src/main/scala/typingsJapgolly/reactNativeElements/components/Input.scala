...
object Input {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputProps, typingsJapgolly.reactNativeElements.mod.Input, Unit, InputProps] = {
  ...
  typingsJapgolly.reactNativeElements.mod.InputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeElements.mod.Input](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeElements.mod.InputProps])(children: _*)
  }
