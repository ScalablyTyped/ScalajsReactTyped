...
object Input {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeElements.distInputInputMod.Input] {
    ...
    inline def theme(value: Theme[InputProps]): this.type = set("theme", value.asInstanceOf[js.Any])
  ...
  def withProps(p: InputProps & PartialThemePropsInputPro): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
