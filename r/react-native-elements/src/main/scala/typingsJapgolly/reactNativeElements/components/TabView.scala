...
object TabView {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[TabViewProps & Partial[ThemeProps[TabViewProps]]]))
  }
  ...
  object Item {
    ...
    inline def apply(
      replaceTheme: RecursivePartialFullThemeAvatar => Callback,
      theme: Theme[ViewProps],
      updateTheme: RecursivePartialFullThemeAvatar => Callback
    ): typingsJapgolly.reactNativeElements.components.TabView.Item.Builder = {
      val __props = js.Dynamic.literal(replaceTheme = js.Any.fromFunction1((t0: RecursivePartialFullThemeAvatar) => replaceTheme(t0).runNow()), theme = theme.asInstanceOf[js.Any], updateTheme = js.Any.fromFunction1((t0: RecursivePartialFullThemeAvatar) => updateTheme(t0).runNow()))
      new typingsJapgolly.reactNativeElements.components.TabView.Item.Builder(js.Array(this.component, __props.asInstanceOf[ViewProps & Partial[ThemeProps[ViewProps]]]))
    }
    
    @JSImport("react-native-elements", "TabView.Item")
    @js.native
    ...
    def withProps(p: ViewProps & Partial[ThemeProps[ViewProps]]): typingsJapgolly.reactNativeElements.components.TabView.Item.Builder = new typingsJapgolly.reactNativeElements.components.TabView.Item.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def animationConfig(value: OmitSpringAnimationConfig): this.type = set("animationConfig", value.asInstanceOf[js.Any])
    
    inline def animationType(value: spring | timing): this.type = set("animationType", value.asInstanceOf[js.Any])
    
    inline def onChange(value: /* value */ Double => Any): this.type = set("onChange", js.Any.fromFunction1(value))
    
    inline def value(value: Double): this.type = set("value", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: TabViewProps & Partial[ThemeProps[TabViewProps]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
