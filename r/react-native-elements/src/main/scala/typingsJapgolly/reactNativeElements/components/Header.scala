...
import typingsJapgolly.reactNativeElements.mod.HeaderProps
...
object Header {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[HeaderProps, typingsJapgolly.reactNativeElements.mod.Header, Unit, HeaderProps] = {
  ...
  typingsJapgolly.reactNativeElements.mod.HeaderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeElements.mod.Header](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeElements.mod.HeaderProps])(children: _*)
  }
