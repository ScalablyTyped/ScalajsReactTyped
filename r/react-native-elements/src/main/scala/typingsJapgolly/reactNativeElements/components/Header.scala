...
object Header {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[HeaderProps & Partial[ThemeProps[HeaderProps]]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def backgroundImage(value: ImageSourcePropType): this.type = set("backgroundImage", value.asInstanceOf[js.Any])
    
    inline def backgroundImageStyle(value: ImageStyle): this.type = set("backgroundImageStyle", value.asInstanceOf[js.Any])
    
    inline def backgroundImageVarargs(value: ImageURISource*): this.type = set("backgroundImage", js.Array(value*))
    
    inline def barStyle(value: StatusBarStyle): this.type = set("barStyle", value.asInstanceOf[js.Any])
    
    inline def centerComponent(value: HeaderSubComponent): this.type = set("centerComponent", value.asInstanceOf[js.Any])
    
    inline def centerComponentVdomElement(value: VdomElement): this.type = set("centerComponent", value.rawElement.asInstanceOf[js.Any])
    
    inline def centerContainerStyle(value: StyleProp[ViewStyle]): this.type = set("centerContainerStyle", value.asInstanceOf[js.Any])
    
    inline def centerContainerStyleNull: this.type = set("centerContainerStyle", null)
    ...
    inline def elevated(value: Boolean): this.type = set("elevated", value.asInstanceOf[js.Any])
    ...
    inline def leftComponent(value: HeaderSubComponent): this.type = set("leftComponent", value.asInstanceOf[js.Any])
    
    inline def leftComponentVdomElement(value: VdomElement): this.type = set("leftComponent", value.rawElement.asInstanceOf[js.Any])
    
    inline def leftContainerStyle(value: StyleProp[ViewStyle]): this.type = set("leftContainerStyle", value.asInstanceOf[js.Any])
    
    inline def leftContainerStyleNull: this.type = set("leftContainerStyle", null)
    ...
    inline def placement(value: left | center | right): this.type = set("placement", value.asInstanceOf[js.Any])
    ...
    inline def rightComponent(value: HeaderSubComponent): this.type = set("rightComponent", value.asInstanceOf[js.Any])
    
    inline def rightComponentVdomElement(value: VdomElement): this.type = set("rightComponent", value.rawElement.asInstanceOf[js.Any])
    
    inline def rightContainerStyle(value: StyleProp[ViewStyle]): this.type = set("rightContainerStyle", value.asInstanceOf[js.Any])
    
    inline def rightContainerStyleNull: this.type = set("rightContainerStyle", null)
    
    inline def shouldRasterizeIOS(value: Boolean): this.type = set("shouldRasterizeIOS", value.asInstanceOf[js.Any])
    
    inline def statusBarProps(value: StatusBarProps): this.type = set("statusBarProps", value.asInstanceOf[js.Any])
  ...
  def withProps(p: HeaderProps & Partial[ThemeProps[HeaderProps]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
