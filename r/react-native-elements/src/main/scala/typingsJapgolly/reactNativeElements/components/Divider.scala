...
object Divider {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ViewProps, typingsJapgolly.reactNativeElements.mod.Divider, Unit, ViewProps] = {
  ...
  typingsJapgolly.reactNative.mod.ViewProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeElements.mod.Divider](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.ViewProps])(children: _*)
  }
