...
object Divider {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[DividerProps & Partial[ThemeProps[DividerProps]]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def insetType(value: left | right | middle): this.type = set("insetType", value.asInstanceOf[js.Any])
    ...
    inline def subHeader(value: String): this.type = set("subHeader", value.asInstanceOf[js.Any])
    
    inline def subHeaderStyle(value: StyleProp[TextStyle]): this.type = set("subHeaderStyle", value.asInstanceOf[js.Any])
    
    inline def subHeaderStyleNull: this.type = set("subHeaderStyle", null)
  ...
  def withProps(p: DividerProps & Partial[ThemeProps[DividerProps]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
