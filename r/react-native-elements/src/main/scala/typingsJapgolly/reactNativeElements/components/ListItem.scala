...
import typingsJapgolly.reactNativeElements.mod.ListItemProps
...
object ListItem {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ListItemProps, typingsJapgolly.reactNativeElements.mod.ListItem, Unit, ListItemProps] = {
  ...
  typingsJapgolly.reactNativeElements.mod.ListItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeElements.mod.ListItem](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeElements.mod.ListItemProps])(children: _*)
  }
