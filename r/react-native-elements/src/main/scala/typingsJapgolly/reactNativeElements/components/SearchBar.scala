...
import typingsJapgolly.reactNativeElements.PartialTouchableOpacityPr
import typingsJapgolly.reactNativeElements.mod.IconNode
import typingsJapgolly.reactNativeElements.mod.SearchBarProps
...
object SearchBar {
  def apply(
    ...
    platform: typingsJapgolly.reactNativeElements.reactNativeElementsStrings.default | ios | android = null,
    ...
    SearchBarProps, 
    typingsJapgolly.reactNativeElements.mod.SearchBar, 
    Unit, 
    SearchBarProps
  ] = {
  ...
  typingsJapgolly.reactNativeElements.mod.SearchBarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeElements.mod.SearchBar](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeElements.mod.SearchBarProps])(children: _*)
  }
