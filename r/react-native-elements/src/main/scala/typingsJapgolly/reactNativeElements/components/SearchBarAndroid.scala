...
object SearchBarAndroid {
  ...
  inline def apply(
    ...
    val __props = js.Dynamic.literal(onBlur = onBlur.toJsFn, onCancel = onCancel.toJsFn, onChangeText = onChangeText.toJsFn, onClear = onClear.toJsFn, onFocus = onFocus.toJsFn, platform = platform.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[SearchBarAndroidProps & PartialThemePropsSearchBa]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeElements.distSearchbarSearchBarAndroidMod.default] {
    ...
    inline def cancelIcon(value: IconNode): this.type = set("cancelIcon", value.asInstanceOf[js.Any])
    
    inline def cancelIconVdomElement(value: VdomElement): this.type = set("cancelIcon", value.rawElement.asInstanceOf[js.Any])
    
    inline def clearIcon(value: IconNode): this.type = set("clearIcon", value.asInstanceOf[js.Any])
    ...
    inline def searchIcon(value: IconNode): this.type = set("searchIcon", value.asInstanceOf[js.Any])
    
    inline def searchIconVdomElement(value: VdomElement): this.type = set("searchIcon", value.rawElement.asInstanceOf[js.Any])
    
    inline def showLoading(value: Boolean): this.type = set("showLoading", value.asInstanceOf[js.Any])
    
    inline def theme(value: Theme[SearchBarAndroidProps]): this.type = set("theme", value.asInstanceOf[js.Any])
  ...
  def withProps(p: SearchBarAndroidProps & PartialThemePropsSearchBa): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
