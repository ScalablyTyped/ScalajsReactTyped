...
object Text {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextProps, typingsJapgolly.reactNativeElements.mod.Text, Unit, TextProps] = {
  ...
  typingsJapgolly.reactNativeElements.mod.Text](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeElements.mod.TextProps])(children: _*)
  }
