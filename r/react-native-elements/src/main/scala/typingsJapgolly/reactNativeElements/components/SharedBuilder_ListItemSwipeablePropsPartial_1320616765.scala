...
@scala.inline
open class SharedBuilder_ListItemSwipeablePropsPartial_1320616765 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def leftContent(value: VdomNode): this.type = set("leftContent", value.rawNode.asInstanceOf[js.Any])
  
  inline def leftContentNull: this.type = set("leftContent", null)
  
  inline def leftContentVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("leftContent", js.Array(value*))
  
  inline def leftContentVdomElement(value: VdomElement): this.type = set("leftContent", value.rawElement.asInstanceOf[js.Any])
  ...
  inline def leftWidth(value: Double): this.type = set("leftWidth", value.asInstanceOf[js.Any])
  ...
  inline def rightContent(value: VdomNode): this.type = set("rightContent", value.rawNode.asInstanceOf[js.Any])
  
  inline def rightContentNull: this.type = set("rightContent", null)
  
  inline def rightContentVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("rightContent", js.Array(value*))
  
  inline def rightContentVdomElement(value: VdomElement): this.type = set("rightContent", value.rawElement.asInstanceOf[js.Any])
  ...
  inline def rightWidth(value: Double): this.type = set("rightWidth", value.asInstanceOf[js.Any])
