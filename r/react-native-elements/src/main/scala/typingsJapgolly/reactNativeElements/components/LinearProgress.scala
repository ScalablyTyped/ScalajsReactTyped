...
object LinearProgress {
  ...
  inline def apply(
    ...
    theme: Theme[LinearProgressProps],
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[LinearProgressProps & Partial[ThemeProps[LinearProgressProps]]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: primary | secondary | String): this.type = set("color", value.asInstanceOf[js.Any])
  ...
  def withProps(p: LinearProgressProps & Partial[ThemeProps[LinearProgressProps]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
