...
object RecursivePartialPartialSe {
  ...
  def apply(
    ...
    onChange: RecursivePartial[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]]] = null,
    ...
    onContentSizeChange: RecursivePartial[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]]] = null,
    onEndEditing: RecursivePartial[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]]] = null,
    onFocus: RecursivePartial[js.UndefOr[js.Function0[Unit]]] = null,
    onKeyPress: RecursivePartial[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]]] = null,
    ...
    onScroll: RecursivePartial[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]]] = null,
    onSelectionChange: RecursivePartial[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]]] = null,
    ...
    onSubmitEditing: RecursivePartial[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]]] = null,
