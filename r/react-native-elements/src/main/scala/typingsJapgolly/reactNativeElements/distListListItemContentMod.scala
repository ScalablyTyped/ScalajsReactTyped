...
object distListListItemContentMod extends Shortcut {
  
  @JSImport("react-native-elements/dist/list/ListItemContent", JSImport.Default)
  @js.native
  val default: FunctionComponent[PickstyleStylePropTextSty] | ForwardRefExoticComponent[styleStylePropTextStyleunAccessibilityActions] = js.native
  
  /* Inlined react-native-elements.react-native-elements/dist/text/Text.TextProps & {  right :boolean | undefined} */
  trait ItemContentProps extends StObject {
  ...
  type _To = FunctionComponent[PickstyleStylePropTextSty] | ForwardRefExoticComponent[styleStylePropTextStyleunAccessibilityActions]
  
  /* This means you don't have to write `default`, but can instead just say `distListListItemContentMod.foo` */
  override def _to: FunctionComponent[PickstyleStylePropTextSty] | ForwardRefExoticComponent[styleStylePropTextStyleunAccessibilityActions] = default
}
