...
import typingsJapgolly.reactNativeElements.anon.PicktitlestringReactEleme
import typingsJapgolly.reactNativeElements.anon.TypeofComponent
import typingsJapgolly.reactNativeElements.anon.titlestringReactElementun
...
object distButtonsFabMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `distButtonsFabMod.foo` */
