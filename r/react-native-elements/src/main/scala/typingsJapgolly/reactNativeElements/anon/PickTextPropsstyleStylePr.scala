...
object PickTextPropsstyleStylePr {
  
  inline def apply(): PickTextPropsstyleStylePr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickTextPropsstyleStylePr]
  }
  
  extension [Self <: PickTextPropsstyleStylePr](x: Self) {
