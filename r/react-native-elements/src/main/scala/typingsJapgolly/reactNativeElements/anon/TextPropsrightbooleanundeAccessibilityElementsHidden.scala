...
/* Inlined react-native.react-native.TextProps & {  right :boolean | undefined} & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements/dist/list/ListItemSubtitle.SubtitleProps>> */
trait TextPropsrightbooleanundeAccessibilityElementsHidden extends StObject {
  ...
  var theme: js.UndefOr[ThemeSubtitleProps] = js.undefined
  
  var updateTheme: js.UndefOr[js.Function1[/* updates */ RecursivePartialFullTheme, Unit]] = js.undefined
}
object TextPropsrightbooleanundeAccessibilityElementsHidden {
  
  inline def apply(): TextPropsrightbooleanundeAccessibilityElementsHidden = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TextPropsrightbooleanundeAccessibilityElementsHidden]
  }
  
  extension [Self <: TextPropsrightbooleanundeAccessibilityElementsHidden](x: Self) {
    ...
    inline def setTheme(value: ThemeSubtitleProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
