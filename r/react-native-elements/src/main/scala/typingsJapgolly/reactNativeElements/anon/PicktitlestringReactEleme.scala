...
object PicktitlestringReactEleme {
  
  inline def apply(): PicktitlestringReactEleme = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PicktitlestringReactEleme]
  }
  
  extension [Self <: PicktitlestringReactEleme](x: Self) {
