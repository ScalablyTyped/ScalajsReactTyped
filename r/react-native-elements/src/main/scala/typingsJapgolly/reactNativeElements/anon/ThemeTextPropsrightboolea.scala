...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native.react-native.TextProps & {  right :boolean | undefined}> */
trait ThemeTextPropsrightboolea extends StObject {
...
object ThemeTextPropsrightboolea {
  
  inline def apply(): ThemeTextPropsrightboolea = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeTextPropsrightboolea]
  }
  
  extension [Self <: ThemeTextPropsrightboolea](x: Self) {
