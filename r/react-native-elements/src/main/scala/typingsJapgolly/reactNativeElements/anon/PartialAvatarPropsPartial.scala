...
/* Inlined std.Partial<react-native-elements.react-native-elements/dist/avatar/Avatar.AvatarProps & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements/dist/avatar/Avatar.AvatarProps>>> */
trait PartialAvatarPropsPartial extends StObject {
...
object PartialAvatarPropsPartial {
  
  inline def apply(): PartialAvatarPropsPartial = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAvatarPropsPartial]
  }
  
  extension [Self <: PartialAvatarPropsPartial](x: Self) {
