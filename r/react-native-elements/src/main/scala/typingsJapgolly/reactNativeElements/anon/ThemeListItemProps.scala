...
trait ThemeListItemProps extends StObject {
...
object ThemeListItemProps {
  
  inline def apply(): ThemeListItemProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeListItemProps]
  }
  
  extension [Self <: ThemeListItemProps](x: Self) {
