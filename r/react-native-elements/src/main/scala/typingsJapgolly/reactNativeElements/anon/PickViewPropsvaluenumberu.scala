...
object PickViewPropsvaluenumberu {
  
  inline def apply(): PickViewPropsvaluenumberu = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickViewPropsvaluenumberu]
  }
  
  extension [Self <: PickViewPropsvaluenumberu](x: Self) {
