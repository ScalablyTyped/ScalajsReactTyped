...
/* Inlined std.Partial<react-native.react-native.ViewProps> */
trait PartialViewProps extends StObject {
...
object PartialViewProps {
  
  inline def apply(): PartialViewProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialViewProps]
  }
  
  extension [Self <: PartialViewProps](x: Self) {
