...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/divider/Divider.DividerProps> */
trait ThemeDividerPropsAccessibilityActions extends StObject {
...
object ThemeDividerPropsAccessibilityActions {
  
  inline def apply(): ThemeDividerPropsAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeDividerPropsAccessibilityActions]
  }
  
  extension [Self <: ThemeDividerPropsAccessibilityActions](x: Self) {
