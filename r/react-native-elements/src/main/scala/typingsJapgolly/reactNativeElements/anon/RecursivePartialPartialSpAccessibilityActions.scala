...
/* Inlined react-native-elements.react-native-elements/dist/config/ThemeProvider.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/buttons/SpeedDial.SpeedDialActionProps>> */
trait RecursivePartialPartialSpAccessibilityActions extends StObject {
...
object RecursivePartialPartialSpAccessibilityActions {
  
  inline def apply(): RecursivePartialPartialSpAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialSpAccessibilityActions]
  }
  
  extension [Self <: RecursivePartialPartialSpAccessibilityActions](x: Self) {
    ...
    inline def setTitle(value: RecursivePartial[js.UndefOr[String | Element]]): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
