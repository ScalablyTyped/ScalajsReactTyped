...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements.ButtonGroupProps> */
trait ThemeButtonGroupPropsActiveOpacity extends StObject {
...
object ThemeButtonGroupPropsActiveOpacity {
  
  inline def apply(): ThemeButtonGroupPropsActiveOpacity = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeButtonGroupPropsActiveOpacity]
  }
  
  extension [Self <: ThemeButtonGroupPropsActiveOpacity](x: Self) {
