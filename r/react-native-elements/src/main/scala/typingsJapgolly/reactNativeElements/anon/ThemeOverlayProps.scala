...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/overlay/Overlay.OverlayProps> */
trait ThemeOverlayProps extends StObject {
...
object ThemeOverlayProps {
  
  inline def apply(isVisible: Boolean): ThemeOverlayProps = {
