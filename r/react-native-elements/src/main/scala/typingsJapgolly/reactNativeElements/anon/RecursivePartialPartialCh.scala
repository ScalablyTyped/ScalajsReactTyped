...
trait RecursivePartialPartialCh extends StObject {
  ...
  var checkedIcon: js.UndefOr[RecursivePartial[js.UndefOr[String | Element]]] = js.undefined
  ...
  var uncheckedIcon: js.UndefOr[RecursivePartial[js.UndefOr[String | Element]]] = js.undefined
...
object RecursivePartialPartialCh {
  ...
  extension [Self <: RecursivePartialPartialCh](x: Self) {
    ...
    inline def setCheckedIcon(value: RecursivePartial[js.UndefOr[String | Element]]): Self = StObject.set(x, "checkedIcon", value.asInstanceOf[js.Any])
    ...
    inline def setUncheckedIcon(value: RecursivePartial[js.UndefOr[String | Element]]): Self = StObject.set(x, "uncheckedIcon", value.asInstanceOf[js.Any])
