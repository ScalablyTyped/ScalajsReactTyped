...
import typingsJapgolly.reactNativeElements.reactNativeElementsStrings.InputComponent
...
trait Pickplatformiosandroiddef extends StObject {
  ...
  var platform: ios | android | default
...
object Pickplatformiosandroiddef {
  ...
  inline def apply(
    ...
    showCancel: Boolean,
    value: String
  ): Pickplatformiosandroiddef = {
    val __obj = js.Dynamic.literal(cancelButtonTitle = cancelButtonTitle.asInstanceOf[js.Any], lightTheme = lightTheme.asInstanceOf[js.Any], platform = platform.asInstanceOf[js.Any], round = round.asInstanceOf[js.Any], showCancel = showCancel.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
  ...
  extension [Self <: Pickplatformiosandroiddef](x: Self) {
    ...
    inline def setPlatform(value: ios | android | default): Self = StObject.set(x, "platform", value.asInstanceOf[js.Any])
