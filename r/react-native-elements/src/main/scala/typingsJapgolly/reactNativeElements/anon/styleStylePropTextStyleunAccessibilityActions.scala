...
trait styleStylePropTextStyleunAccessibilityActions extends StObject {
  ...
  var theme: js.UndefOr[ThemeItemContentProps] = js.undefined
  
  var updateTheme: js.UndefOr[js.Function1[/* updates */ RecursivePartialFullTheme, Unit]] = js.undefined
}
object styleStylePropTextStyleunAccessibilityActions {
  
  inline def apply(): styleStylePropTextStyleunAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[styleStylePropTextStyleunAccessibilityActions]
  }
  
  extension [Self <: styleStylePropTextStyleunAccessibilityActions](x: Self) {
    ...
    inline def setTheme(value: ThemeItemContentProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
