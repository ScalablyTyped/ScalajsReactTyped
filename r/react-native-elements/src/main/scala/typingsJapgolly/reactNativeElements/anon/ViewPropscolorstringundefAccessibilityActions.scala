...
trait ViewPropscolorstringundefAccessibilityActions extends StObject {
  ...
  var insetType: js.UndefOr[middle | left | right] = js.undefined
  ...
  var theme: js.UndefOr[ThemeDividerPropsAccessibilityActions] = js.undefined
...
object ViewPropscolorstringundefAccessibilityActions {
  
  inline def apply(): ViewPropscolorstringundefAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ViewPropscolorstringundefAccessibilityActions]
  }
  
  extension [Self <: ViewPropscolorstringundefAccessibilityActions](x: Self) {
    ...
    inline def setInsetType(value: middle | left | right): Self = StObject.set(x, "insetType", value.asInstanceOf[js.Any])
    ...
    inline def setTheme(value: ThemeDividerPropsAccessibilityActions): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
