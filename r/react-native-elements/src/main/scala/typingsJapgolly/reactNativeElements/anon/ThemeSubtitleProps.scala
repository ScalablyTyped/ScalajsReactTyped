...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/list/ListItemSubtitle.SubtitleProps> */
trait ThemeSubtitleProps extends StObject {
...
object ThemeSubtitleProps {
  
  inline def apply(): ThemeSubtitleProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeSubtitleProps]
  }
  
  extension [Self <: ThemeSubtitleProps](x: Self) {
