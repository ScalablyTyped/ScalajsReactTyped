...
trait PickAvatarPropsPartialThe extends StObject {
...
object PickAvatarPropsPartialThe {
  
  inline def apply(): PickAvatarPropsPartialThe = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickAvatarPropsPartialThe]
  }
  
  extension [Self <: PickAvatarPropsPartialThe](x: Self) {
