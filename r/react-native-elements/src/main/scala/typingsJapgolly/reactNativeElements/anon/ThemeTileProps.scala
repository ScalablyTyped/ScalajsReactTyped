...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/tile/Tile.TileProps> */
trait ThemeTileProps extends StObject {
...
object ThemeTileProps {
  
  inline def apply(): ThemeTileProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeTileProps]
  }
  
  extension [Self <: ThemeTileProps](x: Self) {
