...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/tile/Tile.TileProps>> */
trait RecursivePartialPartialTiAccessibilityElementsHidden extends StObject {
  ...
  var caption: js.UndefOr[RecursivePartial[js.UndefOr[Node]]] = js.undefined
...
object RecursivePartialPartialTiAccessibilityElementsHidden {
  
  inline def apply(): RecursivePartialPartialTiAccessibilityElementsHidden = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialTiAccessibilityElementsHidden]
  }
  
  extension [Self <: RecursivePartialPartialTiAccessibilityElementsHidden](x: Self) {
    ...
    inline def setCaption(value: RecursivePartial[js.UndefOr[Node]]): Self = StObject.set(x, "caption", value.asInstanceOf[js.Any])
