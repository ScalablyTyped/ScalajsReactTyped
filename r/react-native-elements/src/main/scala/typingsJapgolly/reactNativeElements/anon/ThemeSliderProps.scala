...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/slider/Slider.SliderProps> */
trait ThemeSliderProps extends StObject {
...
object ThemeSliderProps {
  
  inline def apply(): ThemeSliderProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeSliderProps]
  }
  
  extension [Self <: ThemeSliderProps](x: Self) {
