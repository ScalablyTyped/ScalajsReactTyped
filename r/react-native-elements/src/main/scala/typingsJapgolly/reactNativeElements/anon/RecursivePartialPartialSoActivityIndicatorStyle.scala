...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/social/SocialIcon.SocialIconProps>> */
trait RecursivePartialPartialSoActivityIndicatorStyle extends StObject {
...
object RecursivePartialPartialSoActivityIndicatorStyle {
  
  inline def apply(): RecursivePartialPartialSoActivityIndicatorStyle = {
  ...
  extension [Self <: RecursivePartialPartialSoActivityIndicatorStyle](x: Self) {
    ...
    inline def setFontStyle(value: RecursivePartial[js.UndefOr[StyleProp[TextStyle]]]): Self = StObject.set(x, "fontStyle", value.asInstanceOf[js.Any])
    
    inline def setFontStyleUndefined: Self = StObject.set(x, "fontStyle", js.undefined)
    
    inline def setFontWeight(value: RecursivePartial[js.UndefOr[String]]): Self = StObject.set(x, "fontWeight", value.asInstanceOf[js.Any])
    
    inline def setFontWeightUndefined: Self = StObject.set(x, "fontWeight", js.undefined)
    
    inline def setIconColor(value: RecursivePartial[js.UndefOr[String]]): Self = StObject.set(x, "iconColor", value.asInstanceOf[js.Any])
    
    inline def setIconColorUndefined: Self = StObject.set(x, "iconColor", js.undefined)
    
    inline def setIconSize(value: RecursivePartial[js.UndefOr[Double]]): Self = StObject.set(x, "iconSize", value.asInstanceOf[js.Any])
    
    inline def setIconSizeUndefined: Self = StObject.set(x, "iconSize", js.undefined)
    
    inline def setIconStyle(value: RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]): Self = StObject.set(x, "iconStyle", value.asInstanceOf[js.Any])
    ...
    inline def setType(value: RecursivePartial[js.UndefOr[SocialMediaType]]): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
