...
/* Inlined react-native-elements.react-native-elements/dist/image/Image.ImageProps & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements/dist/image/Image.ImageProps>> */
trait ImagePropsPartialThemePro extends StObject {
...
object ImagePropsPartialThemePro {
  
  inline def apply(): ImagePropsPartialThemePro = {
