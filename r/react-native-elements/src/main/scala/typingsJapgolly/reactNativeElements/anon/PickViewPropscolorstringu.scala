...
object PickViewPropscolorstringu {
  
  inline def apply(): PickViewPropscolorstringu = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickViewPropscolorstringu]
  }
  
  extension [Self <: PickViewPropscolorstringu](x: Self) {
