...
trait PartialThemePropsSearchBaTheme extends StObject {
  ...
  var theme: js.UndefOr[typingsJapgolly.reactNativeElements.distConfigThemeMod.Theme[SearchBarIosProps]] = js.undefined
...
object PartialThemePropsSearchBaTheme {
  ...
  extension [Self <: PartialThemePropsSearchBaTheme](x: Self) {
    ...
    inline def setTheme(value: typingsJapgolly.reactNativeElements.distConfigThemeMod.Theme[SearchBarIosProps]): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
