...
import typingsJapgolly.reactNativeElements.reactNativeElementsStrings.disk
import typingsJapgolly.reactNativeElements.reactNativeElementsStrings.diskSlashmemory
import typingsJapgolly.reactNativeElements.reactNativeElementsStrings.memory
