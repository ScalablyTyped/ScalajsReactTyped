...
/* Inlined react-native-elements.react-native-elements/dist/config/ThemeProvider.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/switch/switch.SwitchProps>> */
trait RecursivePartialPartialSwAccessibilityActions extends StObject {
...
object RecursivePartialPartialSwAccessibilityActions {
  
  inline def apply(): RecursivePartialPartialSwAccessibilityActions = {
