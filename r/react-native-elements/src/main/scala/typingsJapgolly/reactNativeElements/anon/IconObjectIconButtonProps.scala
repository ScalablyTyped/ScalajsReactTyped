...
import typingsJapgolly.reactNativeElements.reactNativeElementsStrings.icon
...
trait IconObjectIconButtonProps extends StObject {
  ...
  var Component: js.UndefOr[
    TypeofComponent & (Instantiable1[
      ...
      japgolly.scalajs.react.facade.React.Component[icon & js.Object, js.Object]
    ])
  ] = js.undefined
...
object IconObjectIconButtonProps {
  ...
  extension [Self <: IconObjectIconButtonProps](x: Self) {
