...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/overlay/Overlay.OverlayProps>> */
trait RecursivePartialPartialOvAccessibilityActions extends StObject {
  ...
  var backdropStyle: js.UndefOr[RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]] = js.undefined
  
  var children: js.UndefOr[RecursivePartial[js.UndefOr[Node]]] = js.undefined
  ...
  var onOrientationChange: js.UndefOr[
    RecursivePartial[js.UndefOr[js.Function1[/* event */ NativeSyntheticEvent[Any], Unit]]]
  ] = js.undefined
...
object RecursivePartialPartialOvAccessibilityActions {
  
  inline def apply(): RecursivePartialPartialOvAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialOvAccessibilityActions]
  }
  
  extension [Self <: RecursivePartialPartialOvAccessibilityActions](x: Self) {
    ...
    inline def setAnimated(value: RecursivePartial[js.UndefOr[Boolean]]): Self = StObject.set(x, "animated", value.asInstanceOf[js.Any])
    
    inline def setAnimatedUndefined: Self = StObject.set(x, "animated", js.undefined)
    
    inline def setAnimationType(value: RecursivePartial[js.UndefOr[none | slide | fade]]): Self = StObject.set(x, "animationType", value.asInstanceOf[js.Any])
    
    inline def setAnimationTypeUndefined: Self = StObject.set(x, "animationType", js.undefined)
    
    inline def setBackdropStyle(value: RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]): Self = StObject.set(x, "backdropStyle", value.asInstanceOf[js.Any])
    
    inline def setBackdropStyleUndefined: Self = StObject.set(x, "backdropStyle", js.undefined)
    
    inline def setChildren(value: RecursivePartial[js.UndefOr[Node]]): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
    ...
    inline def setFullScreen(value: RecursivePartial[js.UndefOr[Boolean]]): Self = StObject.set(x, "fullScreen", value.asInstanceOf[js.Any])
    
    inline def setFullScreenUndefined: Self = StObject.set(x, "fullScreen", js.undefined)
    
    inline def setHardwareAccelerated(value: RecursivePartial[js.UndefOr[Boolean]]): Self = StObject.set(x, "hardwareAccelerated", value.asInstanceOf[js.Any])
    ...
    inline def setOnBackdropPress(value: RecursivePartial[js.UndefOr[js.Function0[Unit]]]): Self = StObject.set(x, "onBackdropPress", value.asInstanceOf[js.Any])
    
    inline def setOnBackdropPressUndefined: Self = StObject.set(x, "onBackdropPress", js.undefined)
    
    inline def setOnDismiss(value: RecursivePartial[js.UndefOr[js.Function0[Unit]]]): Self = StObject.set(x, "onDismiss", value.asInstanceOf[js.Any])
    ...
    inline def setOnOrientationChange(value: RecursivePartial[js.UndefOr[js.Function1[/* event */ NativeSyntheticEvent[Any], Unit]]]): Self = StObject.set(x, "onOrientationChange", value.asInstanceOf[js.Any])
    ...
    inline def setOnRequestClose(value: RecursivePartial[js.UndefOr[js.Function1[/* event */ NativeSyntheticEvent[Any], Unit]]]): Self = StObject.set(x, "onRequestClose", value.asInstanceOf[js.Any])
    ...
    inline def setOnShow(value: RecursivePartial[js.UndefOr[js.Function1[/* event */ NativeSyntheticEvent[Any], Unit]]]): Self = StObject.set(x, "onShow", value.asInstanceOf[js.Any])
    ...
    inline def setOverlayStyle(value: RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]): Self = StObject.set(x, "overlayStyle", value.asInstanceOf[js.Any])
    ...
    inline def setPresentationStyle(value: RecursivePartial[js.UndefOr[fullScreen | pageSheet | formSheet | overFullScreen]]): Self = StObject.set(x, "presentationStyle", value.asInstanceOf[js.Any])
    ...
    inline def setStatusBarTranslucent(value: RecursivePartial[js.UndefOr[Boolean]]): Self = StObject.set(x, "statusBarTranslucent", value.asInstanceOf[js.Any])
    ...
    inline def setTransparent(value: RecursivePartial[js.UndefOr[Boolean]]): Self = StObject.set(x, "transparent", value.asInstanceOf[js.Any])
