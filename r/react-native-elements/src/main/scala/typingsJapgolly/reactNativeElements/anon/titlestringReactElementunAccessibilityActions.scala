...
trait titlestringReactElementunAccessibilityActions extends StObject {
  ...
  var theme: js.UndefOr[ThemeTabItemProps] = js.undefined
...
object titlestringReactElementunAccessibilityActions {
  
  inline def apply(): titlestringReactElementunAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[titlestringReactElementunAccessibilityActions]
  }
  
  extension [Self <: titlestringReactElementunAccessibilityActions](x: Self) {
    ...
    inline def setTheme(value: ThemeTabItemProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
