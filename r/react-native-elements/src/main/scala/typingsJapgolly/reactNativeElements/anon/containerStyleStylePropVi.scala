...
trait containerStyleStylePropVi extends StObject {
  ...
  var theme: js.UndefOr[ThemeListItemAccordionPro] = js.undefined
...
object containerStyleStylePropVi {
  
  inline def apply(children: js.UndefOr[Any] & js.UndefOr[Node]): containerStyleStylePropVi = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    __obj.asInstanceOf[containerStyleStylePropVi]
  }
  
  extension [Self <: containerStyleStylePropVi](x: Self) {
    ...
    inline def setTheme(value: ThemeListItemAccordionPro): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
