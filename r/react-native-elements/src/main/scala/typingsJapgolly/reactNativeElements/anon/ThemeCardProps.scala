...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/card/Card.CardProps> */
trait ThemeCardProps extends StObject {
...
object ThemeCardProps {
  
  inline def apply(): ThemeCardProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeCardProps]
  }
  
  extension [Self <: ThemeCardProps](x: Self) {
