...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/list/ListItemContent.ItemContentProps> */
trait ThemeItemContentProps extends StObject {
...
object ThemeItemContentProps {
  
  inline def apply(): ThemeItemContentProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeItemContentProps]
  }
  
  extension [Self <: ThemeItemContentProps](x: Self) {
