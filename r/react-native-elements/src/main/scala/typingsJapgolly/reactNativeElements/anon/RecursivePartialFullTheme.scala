...
object RecursivePartialFullTheme {
  ...
  inline def apply(): RecursivePartialFullTheme = {
  ...
  extension [Self <: RecursivePartialFullTheme](x: Self) {
    ...
    inline def setColors(value: RecursivePartialRecursive): Self = StObject.set(x, "colors", value.asInstanceOf[js.Any])
    ...
    inline def setTile(value: RecursivePartialPartialTi): Self = StObject.set(x, "Tile", value.asInstanceOf[js.Any])
