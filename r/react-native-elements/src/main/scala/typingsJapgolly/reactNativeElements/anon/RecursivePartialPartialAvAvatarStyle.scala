...
trait RecursivePartialPartialAvAvatarStyle extends StObject {
  ...
  var ImageComponent: js.UndefOr[RecursivePartial[js.UndefOr[ComponentClassP[js.Object]]]] = js.undefined
  ...
  var renderPlaceholderContent: js.UndefOr[RecursivePartial[js.UndefOr[Element]]] = js.undefined
...
object RecursivePartialPartialAvAvatarStyle {
  ...
  extension [Self <: RecursivePartialPartialAvAvatarStyle](x: Self) {
    ...
    inline def setImageComponent(value: RecursivePartial[js.UndefOr[ComponentClassP[js.Object]]]): Self = StObject.set(x, "ImageComponent", value.asInstanceOf[js.Any])
    ...
    inline def setRenderPlaceholderContent(value: RecursivePartial[js.UndefOr[Element]]): Self = StObject.set(x, "renderPlaceholderContent", value.asInstanceOf[js.Any])
