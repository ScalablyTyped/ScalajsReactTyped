...
/* Inlined react-native.react-native.SwitchProps & {  color :string | undefined} & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements/dist/switch/switch.SwitchProps>> */
trait SwitchPropscolorstringund extends StObject {
  ...
  var theme: js.UndefOr[ThemeSwitchProps] = js.undefined
...
object SwitchPropscolorstringund {
  
  inline def apply(): SwitchPropscolorstringund = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SwitchPropscolorstringund]
  }
  
  extension [Self <: SwitchPropscolorstringund](x: Self) {
    ...
    inline def setTheme(value: ThemeSwitchProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
