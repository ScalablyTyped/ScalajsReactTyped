...
trait PartialThemePropsSearchBaUpdateTheme extends StObject {
  ...
  var theme: js.UndefOr[typingsJapgolly.reactNativeElements.distConfigThemeMod.Theme[SearchBarProps]] = js.undefined
...
object PartialThemePropsSearchBaUpdateTheme {
  ...
  extension [Self <: PartialThemePropsSearchBaUpdateTheme](x: Self) {
    ...
    inline def setTheme(value: typingsJapgolly.reactNativeElements.distConfigThemeMod.Theme[SearchBarProps]): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
