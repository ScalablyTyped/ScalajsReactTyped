...
/* Inlined std.Partial<react-native.react-native.TouchableHighlightProps & {  containerStyle :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   disabledStyle :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   topDivider :boolean | undefined,   bottomDivider :boolean | undefined,   pad :number | undefined,   Component :{  contextType :react.react.Context<any> | undefined} & new <P = {}, S = {}, SS = any>(props : std.Readonly</ * import warning: RewrittenClass.unapply cls was tparam P * / any>): react.react.Component<P, S, SS> | undefined,   ViewComponent :{  contextType :react.react.Context<any> | undefined} & new <P = {}, S = {}, SS = any>(props : std.Readonly</ * import warning: RewrittenClass.unapply cls was tparam P * / any>): react.react.Component<P, S, SS> | undefined,   linearGradientProps :any | undefined,   children :any | undefined} & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements/dist/list/ListItemBase.ListItemProps>>> */
trait PartialTouchableHighlight extends StObject {
  ...
  var theme: js.UndefOr[ThemeListItemProps] = js.undefined
...
object PartialTouchableHighlight {
  
  inline def apply(): PartialTouchableHighlight = {
  ...
  extension [Self <: PartialTouchableHighlight](x: Self) {
    ...
    inline def setTheme(value: ThemeListItemProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
