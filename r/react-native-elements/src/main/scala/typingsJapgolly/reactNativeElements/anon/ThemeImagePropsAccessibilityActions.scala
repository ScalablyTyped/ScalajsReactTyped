...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/image/Image.ImageProps> */
trait ThemeImagePropsAccessibilityActions extends StObject {
...
object ThemeImagePropsAccessibilityActions {
  
  inline def apply(): ThemeImagePropsAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeImagePropsAccessibilityActions]
  }
  
  extension [Self <: ThemeImagePropsAccessibilityActions](x: Self) {
