...
/* Inlined react-native-elements.react-native-elements/dist/config/ThemeProvider.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/tab/Tab.TabItemProps>> */
trait RecursivePartialPartialTaAccessibilityElementsHidden extends StObject {
...
object RecursivePartialPartialTaAccessibilityElementsHidden {
  
  inline def apply(): RecursivePartialPartialTaAccessibilityElementsHidden = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialTaAccessibilityElementsHidden]
  }
  
  extension [Self <: RecursivePartialPartialTaAccessibilityElementsHidden](x: Self) {
