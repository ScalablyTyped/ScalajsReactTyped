...
trait isOpenbooleanonOpenvoidon extends StObject {
  ...
  var children: js.UndefOr[js.Array[ReactChild]] & js.UndefOr[Node]
...
object isOpenbooleanonOpenvoidon {
  ...
  inline def apply(
    children: js.UndefOr[js.Array[ReactChild]] & js.UndefOr[Node],
    isOpen: Boolean,
    onClose: Callback,
    onOpen: Callback
  ): isOpenbooleanonOpenvoidon = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], isOpen = isOpen.asInstanceOf[js.Any], onClose = onClose.toJsFn, onOpen = onOpen.toJsFn)
  ...
  extension [Self <: isOpenbooleanonOpenvoidon](x: Self) {
    ...
    inline def setChildren(value: js.UndefOr[js.Array[ReactChild]] & js.UndefOr[Node]): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
