...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<{}> */
trait ThemeAirbnbRating extends StObject {
...
object ThemeAirbnbRating {
  
  inline def apply(): ThemeAirbnbRating = {
