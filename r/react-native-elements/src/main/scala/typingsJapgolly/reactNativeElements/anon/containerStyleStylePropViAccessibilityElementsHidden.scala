...
trait containerStyleStylePropViAccessibilityElementsHidden extends StObject {
  ...
  var children: js.UndefOr[Any] & js.UndefOr[Node]
  ...
  var theme: js.UndefOr[ThemeListItemAccordionProAccessibilityActions] = js.undefined
...
object containerStyleStylePropViAccessibilityElementsHidden {
  ...
  inline def apply(children: js.UndefOr[Any] & js.UndefOr[Node]): containerStyleStylePropViAccessibilityElementsHidden = {
  ...
  extension [Self <: containerStyleStylePropViAccessibilityElementsHidden](x: Self) {
    ...
    inline def setTheme(value: ThemeListItemAccordionProAccessibilityActions): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
