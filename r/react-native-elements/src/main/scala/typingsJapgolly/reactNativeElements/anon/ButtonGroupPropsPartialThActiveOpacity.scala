...
/* Inlined react-native-elements.react-native-elements.ButtonGroupProps & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements.ButtonGroupProps>> */
trait ButtonGroupPropsPartialThActiveOpacity extends StObject {
  ...
  var theme: js.UndefOr[ThemeButtonGroupPropsActiveOpacity] = js.undefined
...
object ButtonGroupPropsPartialThActiveOpacity {
  
  inline def apply(): ButtonGroupPropsPartialThActiveOpacity = {
  ...
  extension [Self <: ButtonGroupPropsPartialThActiveOpacity](x: Self) {
    ...
    inline def setTheme(value: ThemeButtonGroupPropsActiveOpacity): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
