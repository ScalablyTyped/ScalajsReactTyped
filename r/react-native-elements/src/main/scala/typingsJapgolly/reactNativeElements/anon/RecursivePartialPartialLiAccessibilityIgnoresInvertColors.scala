...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/linearProgress.LinearProgressProps>> */
trait RecursivePartialPartialLiAccessibilityIgnoresInvertColors extends StObject {
...
object RecursivePartialPartialLiAccessibilityIgnoresInvertColors {
  
  inline def apply(): RecursivePartialPartialLiAccessibilityIgnoresInvertColors = {
