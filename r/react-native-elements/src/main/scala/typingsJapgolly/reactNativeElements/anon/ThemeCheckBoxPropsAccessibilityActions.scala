...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements.CheckBoxProps> */
trait ThemeCheckBoxPropsAccessibilityActions extends StObject {
  ...
  var titleProps: js.UndefOr[typingsJapgolly.reactNative.mod.TextProps] = js.undefined
...
object ThemeCheckBoxPropsAccessibilityActions {
  
  inline def apply(): ThemeCheckBoxPropsAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeCheckBoxPropsAccessibilityActions]
  }
  
  extension [Self <: ThemeCheckBoxPropsAccessibilityActions](x: Self) {
    ...
    inline def setTitleProps(value: typingsJapgolly.reactNative.mod.TextProps): Self = StObject.set(x, "titleProps", value.asInstanceOf[js.Any])
