...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/pricing/PricingCard.PricingCardProps> */
trait ThemePricingCardProps extends StObject {
...
object ThemePricingCardProps {
  
  inline def apply(): ThemePricingCardProps = {
