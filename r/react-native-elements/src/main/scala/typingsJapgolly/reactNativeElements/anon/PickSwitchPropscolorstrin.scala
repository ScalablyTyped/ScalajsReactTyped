...
object PickSwitchPropscolorstrin {
  
  inline def apply(): PickSwitchPropscolorstrin = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickSwitchPropscolorstrin]
  }
  
  extension [Self <: PickSwitchPropscolorstrin](x: Self) {
