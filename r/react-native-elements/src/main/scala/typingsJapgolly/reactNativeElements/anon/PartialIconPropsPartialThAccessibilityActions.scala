...
/* Inlined std.Partial<react-native-elements.react-native-elements/dist/icons/Icon.IconProps> & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<std.Partial<react-native-elements.react-native-elements/dist/icons/Icon.IconProps>>> */
trait PartialIconPropsPartialThAccessibilityActions extends StObject {
  ...
  var theme: js.UndefOr[ThemePartialIconPropsAccessibilityActions] = js.undefined
...
object PartialIconPropsPartialThAccessibilityActions {
  
  inline def apply(): PartialIconPropsPartialThAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIconPropsPartialThAccessibilityActions]
  }
  
  extension [Self <: PartialIconPropsPartialThAccessibilityActions](x: Self) {
    ...
    inline def setTheme(value: ThemePartialIconPropsAccessibilityActions): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
