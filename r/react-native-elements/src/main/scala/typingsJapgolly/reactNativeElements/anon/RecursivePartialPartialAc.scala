...
/* Inlined react-native-elements.react-native-elements/dist/config/ThemeProvider.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/avatar/Accessory.AccessoryProps>> */
trait RecursivePartialPartialAc extends StObject {
...
object RecursivePartialPartialAc {
  
  inline def apply(): RecursivePartialPartialAc = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialAc]
  }
  
  extension [Self <: RecursivePartialPartialAc](x: Self) {
