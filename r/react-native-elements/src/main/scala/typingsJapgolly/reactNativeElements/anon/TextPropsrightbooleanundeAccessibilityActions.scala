...
/* Inlined react-native.react-native.TextProps & {  right :boolean | undefined} & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements/dist/list/ListItemTitle.TitleProps>> */
trait TextPropsrightbooleanundeAccessibilityActions extends StObject {
  ...
  var theme: js.UndefOr[ThemeTitleProps] = js.undefined
  
  var updateTheme: js.UndefOr[js.Function1[/* updates */ RecursivePartialFullTheme, Unit]] = js.undefined
}
object TextPropsrightbooleanundeAccessibilityActions {
  
  inline def apply(): TextPropsrightbooleanundeAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TextPropsrightbooleanundeAccessibilityActions]
  }
  
  extension [Self <: TextPropsrightbooleanundeAccessibilityActions](x: Self) {
    ...
    inline def setTheme(value: ThemeTitleProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
