...
trait TouchableOpacityPropsChecAccessibilityElementsHidden extends StObject {
  ...
  var theme: js.UndefOr[ThemeCheckBoxProps] = js.undefined
...
object TouchableOpacityPropsChecAccessibilityElementsHidden {
  
  inline def apply(): TouchableOpacityPropsChecAccessibilityElementsHidden = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TouchableOpacityPropsChecAccessibilityElementsHidden]
  }
  
  extension [Self <: TouchableOpacityPropsChecAccessibilityElementsHidden](x: Self) {
    ...
    inline def setTheme(value: ThemeCheckBoxProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
