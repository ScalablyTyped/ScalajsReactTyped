...
trait TextInputPropsRefAttributAccessibilityActions extends StObject {
...
object TextInputPropsRefAttributAccessibilityActions {
  
  inline def apply(): TextInputPropsRefAttributAccessibilityActions = {
