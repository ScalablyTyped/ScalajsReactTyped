...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/checkbox/CheckBox.CheckBoxProps>> */
trait RecursivePartialPartialChAccessibilityActions extends StObject {
...
object RecursivePartialPartialChAccessibilityActions {
  
  inline def apply(): RecursivePartialPartialChAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialChAccessibilityActions]
  }
  
  extension [Self <: RecursivePartialPartialChAccessibilityActions](x: Self) {
