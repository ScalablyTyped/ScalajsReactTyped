...
trait TextInputPropsRefAttributAccessibilityElementsHidden extends StObject {
...
object TextInputPropsRefAttributAccessibilityElementsHidden {
  
  inline def apply(): TextInputPropsRefAttributAccessibilityElementsHidden = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TextInputPropsRefAttributAccessibilityElementsHidden]
  }
  
  extension [Self <: TextInputPropsRefAttributAccessibilityElementsHidden](x: Self) {
