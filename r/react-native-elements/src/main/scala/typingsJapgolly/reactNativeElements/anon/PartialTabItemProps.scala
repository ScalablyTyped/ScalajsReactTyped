...
/* Inlined std.Partial<react-native-elements.react-native-elements/dist/tab/Tab.TabItemProps> */
trait PartialTabItemProps extends StObject {
...
object PartialTabItemProps {
  
  inline def apply(): PartialTabItemProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTabItemProps]
  }
  
  extension [Self <: PartialTabItemProps](x: Self) {
