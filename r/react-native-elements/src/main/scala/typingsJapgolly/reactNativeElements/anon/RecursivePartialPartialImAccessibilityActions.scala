...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/image/Image.ImageProps>> */
trait RecursivePartialPartialImAccessibilityActions extends StObject {
  ...
  var PlaceholderContent: js.UndefOr[RecursivePartial[js.UndefOr[Element]]] = js.undefined
...
object RecursivePartialPartialImAccessibilityActions {
  
  inline def apply(): RecursivePartialPartialImAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialImAccessibilityActions]
  }
  
  extension [Self <: RecursivePartialPartialImAccessibilityActions](x: Self) {
    ...
    inline def setPlaceholderContent(value: RecursivePartial[js.UndefOr[Element]]): Self = StObject.set(x, "PlaceholderContent", value.asInstanceOf[js.Any])
    ...
    inline def setStyle(value: RecursivePartial[js.UndefOr[StyleProp[ImageStyle]]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
