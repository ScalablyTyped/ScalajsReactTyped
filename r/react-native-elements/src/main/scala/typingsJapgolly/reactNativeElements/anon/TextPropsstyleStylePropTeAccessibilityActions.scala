...
trait TextPropsstyleStylePropTeAccessibilityActions extends StObject {
  ...
  var theme: js.UndefOr[ThemeTextPropsAccessibilityActions] = js.undefined
  
  var updateTheme: js.UndefOr[js.Function1[/* updates */ RecursivePartialFullTheme, Unit]] = js.undefined
}
object TextPropsstyleStylePropTeAccessibilityActions {
  
  inline def apply(): TextPropsstyleStylePropTeAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TextPropsstyleStylePropTeAccessibilityActions]
  }
  
  extension [Self <: TextPropsstyleStylePropTeAccessibilityActions](x: Self) {
    ...
    inline def setTheme(value: ThemeTextPropsAccessibilityActions): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
