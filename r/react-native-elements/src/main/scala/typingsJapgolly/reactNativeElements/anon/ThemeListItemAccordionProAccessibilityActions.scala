...
trait ThemeListItemAccordionProAccessibilityActions extends StObject {
...
object ThemeListItemAccordionProAccessibilityActions {
  
  inline def apply(): ThemeListItemAccordionProAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeListItemAccordionProAccessibilityActions]
  }
  
  extension [Self <: ThemeListItemAccordionProAccessibilityActions](x: Self) {
