...
trait TextPropsstyleStylePropTe extends StObject {
  ...
  var theme: js.UndefOr[ThemeTextProps] = js.undefined
  
  var updateTheme: js.UndefOr[js.Function1[/* updates */ RecursivePartialFullThemeAirbnbRating, Unit]] = js.undefined
}
object TextPropsstyleStylePropTe {
  
  inline def apply(): TextPropsstyleStylePropTe = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TextPropsstyleStylePropTe]
  }
  
  extension [Self <: TextPropsstyleStylePropTe](x: Self) {
    ...
    inline def setTheme(value: ThemeTextProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
