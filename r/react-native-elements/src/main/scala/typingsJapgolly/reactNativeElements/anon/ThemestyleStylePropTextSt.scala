...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<{  style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   h1 :boolean | undefined,   h2 :boolean | undefined,   h3 :boolean | undefined,   h4 :boolean | undefined,   h1Style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   h2Style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   h3Style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   h4Style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   right :boolean | undefined} & react-native.react-native.TextProps> */
trait ThemestyleStylePropTextSt extends StObject {
...
object ThemestyleStylePropTextSt {
  
  inline def apply(): ThemestyleStylePropTextSt = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemestyleStylePropTextSt]
  }
  
  extension [Self <: ThemestyleStylePropTextSt](x: Self) {
