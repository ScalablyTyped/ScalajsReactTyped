...
object PartialButtonGroupProps {
  ...
  def apply(
    ...
    onPress: /* selectedIndex */ Double => Callback = null,
    ...
    if (onPress != null) __obj.updateDynamic("onPress")(js.Any.fromFunction1((t0: /* selectedIndex */ scala.Double) => onPress(t0).runNow()))
