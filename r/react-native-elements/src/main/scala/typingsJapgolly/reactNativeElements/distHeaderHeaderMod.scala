...
import typingsJapgolly.reactNativeElements.anon.PickHeaderPropsstyleonLay
...
object distHeaderHeaderMod extends Shortcut {
  ...
  type HeaderSubComponent = japgolly.scalajs.react.facade.React.Element | TextProps | HeaderIcon
