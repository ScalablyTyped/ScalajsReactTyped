...
import typingsJapgolly.reactNativeElements.anon.ForwardRefExoticComponent
import typingsJapgolly.reactNativeElements.anon.FunctionComponentPickAvat
...
object distAvatarAvatarMod extends Shortcut {
  
  @JSImport("react-native-elements/dist/avatar/Avatar", JSImport.Default)
  @js.native
  val default: FunctionComponentPickAvat | ForwardRefExoticComponent = js.native
  
  @JSImport("react-native-elements/dist/avatar/Avatar", "Avatar")
  @js.native
  val Avatar: NamedExoticComponent[AvatarPropsPartialThemePr] = js.native
  type Avatar = RneFunctionComponent[AvatarProps]
  ...
  type _To = FunctionComponentPickAvat | ForwardRefExoticComponent
  
  /* This means you don't have to write `default`, but can instead just say `distAvatarAvatarMod.foo` */
  override def _to: FunctionComponentPickAvat | ForwardRefExoticComponent = default
}
