...
object distButtonsButtonMod extends Shortcut {
  ...
  - typingsJapgolly.reactNative.mod.TouchableWithoutFeedbackPropsAndroid because Already inherited
  - typingsJapgolly.reactNative.mod.TouchableWithoutFeedbackPropsIOS because Already inherited
  - typingsJapgolly.reactNative.mod.TVProps because Already inherited
