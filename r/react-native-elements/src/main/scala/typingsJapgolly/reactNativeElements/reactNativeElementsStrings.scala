...
import typingsJapgolly.reactNativeElements.distIconsIconMod._IconType
...
object reactNativeElementsStrings {
  ...
  sealed trait entypo
    extends StObject
       with _IconType
  inline def entypo: entypo = "entypo".asInstanceOf[entypo]
  ...
  sealed trait evilicon
    extends StObject
       with _IconType
  inline def evilicon: evilicon = "evilicon".asInstanceOf[evilicon]
  ...
  sealed trait `font-awesome-5`
    extends StObject
       with _IconType
  inline def `font-awesome-5`: `font-awesome-5` = "font-awesome-5".asInstanceOf[`font-awesome-5`]
  ...
  sealed trait ionicon
    extends StObject
       with _IconType
  inline def ionicon: ionicon = "ionicon".asInstanceOf[ionicon]
  ...
  sealed trait `material-community`
    extends StObject
       with _IconType
  inline def `material-community`: `material-community` = "material-community".asInstanceOf[`material-community`]
  ...
  sealed trait octicon
    extends StObject
       with _IconType
  inline def octicon: octicon = "octicon".asInstanceOf[octicon]
  ...
  sealed trait `simple-line-icon`
    extends StObject
       with _IconType
  inline def `simple-line-icon`: `simple-line-icon` = "simple-line-icon".asInstanceOf[`simple-line-icon`]
  ...
  inline def updateTheme: updateTheme = "updateTheme".asInstanceOf[updateTheme]
  ...
  sealed trait zocial
    extends StObject
       with _IconType
  inline def zocial: zocial = "zocial".asInstanceOf[zocial]
}
