...
object mod {
  ...
  @js.native
  open class Back protected ()
    extends Component[BackProps, js.Object, Any] {
    def this(props: BackProps) = this()
    def this(props: BackProps, context: Any) = this()
  }
  @JSImport("react-native-flip-card", "Back")
  @js.native
  val Back: ComponentClassP[BackProps & js.Object] = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("react-native-flip-card", "Face")
  @js.native
  open class Face protected ()
    extends Component[FaceProps, js.Object, Any] {
    def this(props: FaceProps) = this()
    def this(props: FaceProps, context: Any) = this()
  }
  @JSImport("react-native-flip-card", "Face")
  @js.native
  val Face: ComponentClassP[FaceProps & js.Object] = js.native
  ...
  type FlipCard = japgolly.scalajs.react.facade.React.Component[FlipCardProps & js.Object, js.Object]
  ...
  object FlipCardProps {
    ...
    extension [Self <: FlipCardProps](x: Self) {
      ...
      inline def setOnFlipEnd(value: Callback): Self = StObject.set(x, "onFlipEnd", value.toJsFn)
      
      inline def setOnFlipEndUndefined: Self = StObject.set(x, "onFlipEnd", js.undefined)
      
      inline def setOnFlipStart(value: Callback): Self = StObject.set(x, "onFlipStart", value.toJsFn)
