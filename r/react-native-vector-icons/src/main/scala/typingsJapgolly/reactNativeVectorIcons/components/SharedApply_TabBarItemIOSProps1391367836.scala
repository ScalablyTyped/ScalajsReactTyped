...
import typingsJapgolly.reactNative.reactNativeStrings.`most-recent`
import typingsJapgolly.reactNative.reactNativeStrings.`most-viewed`
import typingsJapgolly.reactNative.reactNativeStrings.`no-hide-descendants`
import typingsJapgolly.reactNative.reactNativeStrings.`top-rated`
...
import typingsJapgolly.reactNative.reactNativeStrings.bookmarks
import typingsJapgolly.reactNative.reactNativeStrings.button
import typingsJapgolly.reactNative.reactNativeStrings.contacts
import typingsJapgolly.reactNative.reactNativeStrings.downloads
import typingsJapgolly.reactNative.reactNativeStrings.favorites
import typingsJapgolly.reactNative.reactNativeStrings.featured
import typingsJapgolly.reactNative.reactNativeStrings.history
import typingsJapgolly.reactNative.reactNativeStrings.more
...
import typingsJapgolly.reactNative.reactNativeStrings.recents
import typingsJapgolly.reactNative.reactNativeStrings.search
...
abstract class SharedApply_TabBarItemIOSProps1391367836[ComponentRef] () {
  ...
  typingsJapgolly.reactNativeVectorIcons.iconMod.TabBarItemIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeVectorIcons.iconMod.TabBarItemIOSProps])(children: _*)
  }
}
