...
import typingsJapgolly.reactNativeVectorIcons.materialCommunityIconsMod.default
...
object MaterialCommunityIcons {
  ...
  object Button {
    ...
    inline def apply(name: String): SharedBuilder_IconButtonProps_77438457[typingsJapgolly.reactNativeVectorIcons.materialCommunityIconsMod.default.Button] = {
      val __props = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      new SharedBuilder_IconButtonProps_77438457[typingsJapgolly.reactNativeVectorIcons.materialCommunityIconsMod.default.Button](js.Array(this.component, __props.asInstanceOf[IconButtonProps]))
    }
    ...
    def withProps(p: IconButtonProps): SharedBuilder_IconButtonProps_77438457[typingsJapgolly.reactNativeVectorIcons.materialCommunityIconsMod.default.Button] = new SharedBuilder_IconButtonProps_77438457[typingsJapgolly.reactNativeVectorIcons.materialCommunityIconsMod.default.Button](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object TabBarItem {
    
    inline def apply(iconName: String): SharedBuilder_TabBarItemIOSProps_1118788793[
        typingsJapgolly.reactNativeVectorIcons.materialCommunityIconsMod.default.TabBarItem
      ] = {
      val __props = js.Dynamic.literal(iconName = iconName.asInstanceOf[js.Any])
      new SharedBuilder_TabBarItemIOSProps_1118788793[
        typingsJapgolly.reactNativeVectorIcons.materialCommunityIconsMod.default.TabBarItem
    ...
    def withProps(p: TabBarItemIOSProps): SharedBuilder_TabBarItemIOSProps_1118788793[
        typingsJapgolly.reactNativeVectorIcons.materialCommunityIconsMod.default.TabBarItem
      ] = new SharedBuilder_TabBarItemIOSProps_1118788793[
        typingsJapgolly.reactNativeVectorIcons.materialCommunityIconsMod.default.TabBarItem
  ...
  object TabBarItemIOS {
    ...
    inline def apply(iconName: String): SharedBuilder_TabBarItemIOSProps_1118788793[
        typingsJapgolly.reactNativeVectorIcons.materialCommunityIconsMod.default.TabBarItemIOS
      ] = {
      val __props = js.Dynamic.literal(iconName = iconName.asInstanceOf[js.Any])
      new SharedBuilder_TabBarItemIOSProps_1118788793[
        typingsJapgolly.reactNativeVectorIcons.materialCommunityIconsMod.default.TabBarItemIOS
