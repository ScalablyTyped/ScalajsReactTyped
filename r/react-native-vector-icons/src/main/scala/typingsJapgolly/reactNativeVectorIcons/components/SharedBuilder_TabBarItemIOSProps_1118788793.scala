...
@scala.inline
open class SharedBuilder_TabBarItemIOSProps_1118788793[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def iconColor(value: ColorValue | Double): this.type = set("iconColor", value.asInstanceOf[js.Any])
  ...
  inline def selectedIconColor(value: String): this.type = set("selectedIconColor", value.asInstanceOf[js.Any])
  
  inline def selectedIconName(value: String): this.type = set("selectedIconName", value.asInstanceOf[js.Any])
