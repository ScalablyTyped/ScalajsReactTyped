...
import typingsJapgolly.reactDashNative.reactDashNativeMod.ToolbarAndroidAction
...
abstract class SharedApply_typingsJapgollyreactDashNativeDashVectorDashIconsiconModToolbarAndroidProps1373982361[ComponentRef] () {
  ...
  def apply(
    ...
    onActionSelected: /* position */ Double => Callback = null,
    onIconClicked: js.UndefOr[Callback] = js.undefined,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ToolbarAndroidProps, ComponentRef, Unit, ToolbarAndroidProps] = {
    ...
    if (onActionSelected != null) __obj.updateDynamic("onActionSelected")(js.Any.fromFunction1((t0: /* position */ scala.Double) => onActionSelected(t0).runNow()))
    onIconClicked.foreach(p => __obj.updateDynamic("onIconClicked")(p.toJsFn))
  ...
  typingsJapgolly.reactDashNativeDashVectorDashIcons.iconMod.ToolbarAndroidProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](__component)
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNativeDashVectorDashIcons.iconMod.ToolbarAndroidProps])(children: _*)
  }
}
