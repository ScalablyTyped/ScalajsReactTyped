package typingsJapgolly.reactElementToJsxString
...
object mod {
  ...
  inline def default(element: Node): String = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(element.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def default(element: Node, options: ReactElementToJSXStringOptions): String = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(element.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  
  type FilterPropsFunction = js.Function2[/* value */ Any, /* key */ String, Boolean]
  
  trait ReactElementToJSXStringOptions extends StObject {
    
    var displayName: js.UndefOr[js.Function1[/* element */ Node, String]] = js.undefined
  ...
  object ReactElementToJSXStringOptions {
    ...
    extension [Self <: ReactElementToJSXStringOptions](x: Self) {
      ...
      inline def setDisplayName(value: /* element */ Node => String): Self = StObject.set(x, "displayName", js.Any.fromFunction1(value))
