...
import typingsJapgolly.reactCodesandboxer.anon.Content
...
import typingsJapgolly.reactCodesandboxer.reactCodesandboxerStrings.bitbucket
import typingsJapgolly.reactCodesandboxer.reactCodesandboxerStrings.github
...
object mod {
  ...
  type CodeSandboxDeployer = japgolly.scalajs.react.facade.React.Component[Props & js.Object, js.Object]
  ...
  trait Props extends StObject {
    ...
    def children(obj: IsLoading): Node
    ...
    var onLoadComplete: js.UndefOr[
        js.Function1[
          /* arg */ typingsJapgolly.reactCodesandboxer.anon.Files | typingsJapgolly.reactCodesandboxer.anon.Error, 
          Any
        ]
      ] = js.undefined
  ...
  object Props {
    ...
    inline def apply(children: IsLoading => Node, examplePath: String, gitInfo: GitInfo): Props = {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setChildren(value: IsLoading => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      inline def setOnLoadComplete(
        value: /* arg */ typingsJapgolly.reactCodesandboxer.anon.Files | typingsJapgolly.reactCodesandboxer.anon.Error => Any
