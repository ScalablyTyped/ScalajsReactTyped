...
name := "react-markings"
version := "1.3-dt-20211202Z-0e7e3b"
scalaVersion := "3.1.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.github.japgolly.scalajs-react" %%% "core" % "2.1.1",
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped.japgolly" %%% "commonmark" % "0.27-dt-20211202Z-c2674c",
  "org.scalablytyped.japgolly" %%% "commonmark-react-renderer" % "4.3-dt-20211202Z-36317c",
