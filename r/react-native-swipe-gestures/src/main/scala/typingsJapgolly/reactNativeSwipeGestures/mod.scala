package typingsJapgolly.reactNativeSwipeGestures
...
object mod {
  ...
  type GestureRecognizer = japgolly.scalajs.react.facade.React.Component[GestureRecognizerProps & js.Object, js.Object]
  ...
  object GestureRecognizerProps {
    ...
    extension [Self <: GestureRecognizerProps](x: Self) {
      ...
      inline def setOnSwipe(value: (/* gestureName */ String, /* gestureState */ PanResponderGestureState) => Callback): Self = StObject.set(x, "onSwipe", js.Any.fromFunction2((t0: /* gestureName */ String, t1: /* gestureState */ PanResponderGestureState) => (value(t0, t1)).runNow()))
      
      inline def setOnSwipeDown(value: /* gestureState */ PanResponderGestureState => Callback): Self = StObject.set(x, "onSwipeDown", js.Any.fromFunction1((t0: /* gestureState */ PanResponderGestureState) => value(t0).runNow()))
      
      inline def setOnSwipeDownUndefined: Self = StObject.set(x, "onSwipeDown", js.undefined)
      
      inline def setOnSwipeLeft(value: /* gestureState */ PanResponderGestureState => Callback): Self = StObject.set(x, "onSwipeLeft", js.Any.fromFunction1((t0: /* gestureState */ PanResponderGestureState) => value(t0).runNow()))
      
      inline def setOnSwipeLeftUndefined: Self = StObject.set(x, "onSwipeLeft", js.undefined)
      
      inline def setOnSwipeRight(value: /* gestureState */ PanResponderGestureState => Callback): Self = StObject.set(x, "onSwipeRight", js.Any.fromFunction1((t0: /* gestureState */ PanResponderGestureState) => value(t0).runNow()))
      ...
      inline def setOnSwipeUp(value: /* gestureState */ PanResponderGestureState => Callback): Self = StObject.set(x, "onSwipeUp", js.Any.fromFunction1((t0: /* gestureState */ PanResponderGestureState) => value(t0).runNow()))
