package typingsJapgolly.reactNativeSwipeGestures.mod
...
object GestureRecognizerProps {
  ...
  def apply(
    ...
    onSwipe: (/* gestureName */ String, /* gestureState */ PanResponderGestureState) => Callback = null,
    onSwipeDown: /* gestureState */ PanResponderGestureState => Callback = null,
    onSwipeLeft: /* gestureState */ PanResponderGestureState => Callback = null,
    onSwipeRight: /* gestureState */ PanResponderGestureState => Callback = null,
    onSwipeUp: /* gestureState */ PanResponderGestureState => Callback = null,
    ...
    if (onSwipe != null) __obj.updateDynamic("onSwipe")(js.Any.fromFunction2((t0: /* gestureName */ java.lang.String, t1: /* gestureState */ typingsJapgolly.reactNative.mod.PanResponderGestureState) => onSwipe(t0, t1).runNow()))
    if (onSwipeDown != null) __obj.updateDynamic("onSwipeDown")(js.Any.fromFunction1((t0: /* gestureState */ typingsJapgolly.reactNative.mod.PanResponderGestureState) => onSwipeDown(t0).runNow()))
    if (onSwipeLeft != null) __obj.updateDynamic("onSwipeLeft")(js.Any.fromFunction1((t0: /* gestureState */ typingsJapgolly.reactNative.mod.PanResponderGestureState) => onSwipeLeft(t0).runNow()))
    if (onSwipeRight != null) __obj.updateDynamic("onSwipeRight")(js.Any.fromFunction1((t0: /* gestureState */ typingsJapgolly.reactNative.mod.PanResponderGestureState) => onSwipeRight(t0).runNow()))
    if (onSwipeUp != null) __obj.updateDynamic("onSwipeUp")(js.Any.fromFunction1((t0: /* gestureState */ typingsJapgolly.reactNative.mod.PanResponderGestureState) => onSwipeUp(t0).runNow()))
