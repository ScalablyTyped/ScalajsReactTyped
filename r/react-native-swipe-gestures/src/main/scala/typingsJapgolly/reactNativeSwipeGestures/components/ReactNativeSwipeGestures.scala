package typingsJapgolly.reactNativeSwipeGestures.components
...
import typingsJapgolly.reactNativeSwipeGestures.mod.GestureRecognizerConfig
import typingsJapgolly.reactNativeSwipeGestures.mod.GestureRecognizerProps
import typingsJapgolly.reactNativeSwipeGestures.mod.default
...
object ReactNativeSwipeGestures {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def config(value: GestureRecognizerConfig): this.type = set("config", value.asInstanceOf[js.Any])
    ...
    inline def onSwipe(value: (/* gestureName */ String, /* gestureState */ PanResponderGestureState) => Callback): this.type = set("onSwipe", js.Any.fromFunction2((t0: /* gestureName */ String, t1: /* gestureState */ PanResponderGestureState) => (value(t0, t1)).runNow()))
    
    inline def onSwipeDown(value: /* gestureState */ PanResponderGestureState => Callback): this.type = set("onSwipeDown", js.Any.fromFunction1((t0: /* gestureState */ PanResponderGestureState) => value(t0).runNow()))
    
    inline def onSwipeLeft(value: /* gestureState */ PanResponderGestureState => Callback): this.type = set("onSwipeLeft", js.Any.fromFunction1((t0: /* gestureState */ PanResponderGestureState) => value(t0).runNow()))
    
    inline def onSwipeRight(value: /* gestureState */ PanResponderGestureState => Callback): this.type = set("onSwipeRight", js.Any.fromFunction1((t0: /* gestureState */ PanResponderGestureState) => value(t0).runNow()))
    
    inline def onSwipeUp(value: /* gestureState */ PanResponderGestureState => Callback): this.type = set("onSwipeUp", js.Any.fromFunction1((t0: /* gestureState */ PanResponderGestureState) => value(t0).runNow()))
