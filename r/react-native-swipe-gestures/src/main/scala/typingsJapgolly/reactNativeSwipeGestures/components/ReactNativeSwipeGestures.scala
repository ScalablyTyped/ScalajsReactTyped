...
object ReactNativeSwipeGestures {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[GestureRecognizerProps, default, Unit, GestureRecognizerProps] = {
  ...
  typingsJapgolly.reactNativeSwipeGestures.mod.GestureRecognizerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSwipeGestures.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSwipeGestures.mod.GestureRecognizerProps])(children: _*)
  }
