...
import typingsJapgolly.ramda.ramdaBooleans.`false`
...
import typingsJapgolly.ramda.ramdaStrings.Array
import typingsJapgolly.ramda.ramdaStrings.Function
import typingsJapgolly.ramda.ramdaStrings.Number
import typingsJapgolly.ramda.ramdaStrings.Object
import typingsJapgolly.ramda.ramdaStrings.Undefined
...
import typingsJapgolly.ramda.toolsMod.AssocPartialOne
...
import typingsJapgolly.ramda.toolsMod.Filter
import typingsJapgolly.ramda.toolsMod.Functor
...
object mod extends js.Object {
  ...
  {[ Key in keyof Obj ]: std.ReturnType<Obj[Key]>}
    */ typingsJapgolly.ramda.ramdaStrings.applySpec with Obj
  ] = js.native
  ...
  def `type`(`val`: js.Any): Object | Number | typingsJapgolly.ramda.ramdaStrings.Boolean | typingsJapgolly.ramda.ramdaStrings.String | typingsJapgolly.ramda.ramdaStrings.Null | Array | typingsJapgolly.ramda.ramdaStrings.RegExp | Function | Undefined = js.native
