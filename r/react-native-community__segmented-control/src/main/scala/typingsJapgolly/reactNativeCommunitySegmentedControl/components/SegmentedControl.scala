package typingsJapgolly.reactNativeCommunitySegmentedControl.components
...
import typingsJapgolly.reactNativeCommunitySegmentedControl.mod.FontStyle
import typingsJapgolly.reactNativeCommunitySegmentedControl.mod.NativeSegmentedControlIOSChangeEvent
import typingsJapgolly.reactNativeCommunitySegmentedControl.mod.SegmentedControlProps
import typingsJapgolly.reactNativeCommunitySegmentedControl.mod.default
...
object SegmentedControl {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def activeFontStyle(value: FontStyle): this.type = set("activeFontStyle", value.asInstanceOf[js.Any])
    
    inline def appearance(value: dark | light): this.type = set("appearance", value.asInstanceOf[js.Any])
    ...
    inline def momentary(value: Boolean): this.type = set("momentary", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* event */ NativeSyntheticEvent[NativeSegmentedControlIOSChangeEvent] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* event */ NativeSyntheticEvent[NativeSegmentedControlIOSChangeEvent]) => value(t0).runNow()))
