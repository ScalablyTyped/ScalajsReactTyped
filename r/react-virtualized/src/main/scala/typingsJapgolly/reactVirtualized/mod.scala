...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactVirtualized.reactVirtualizedStrings.auto
    - typingsJapgolly.reactVirtualized.reactVirtualizedStrings.end
    - typingsJapgolly.reactVirtualized.reactVirtualizedStrings.start
    - typingsJapgolly.reactVirtualized.reactVirtualizedStrings.center
  */
  trait Alignment extends StObject
  object Alignment {
    
    inline def auto: typingsJapgolly.reactVirtualized.reactVirtualizedStrings.auto = "auto".asInstanceOf[typingsJapgolly.reactVirtualized.reactVirtualizedStrings.auto]
    
    inline def center: typingsJapgolly.reactVirtualized.reactVirtualizedStrings.center = "center".asInstanceOf[typingsJapgolly.reactVirtualized.reactVirtualizedStrings.center]
    
    inline def end: typingsJapgolly.reactVirtualized.reactVirtualizedStrings.end = "end".asInstanceOf[typingsJapgolly.reactVirtualized.reactVirtualizedStrings.end]
    
    inline def start: typingsJapgolly.reactVirtualized.reactVirtualizedStrings.start = "start".asInstanceOf[typingsJapgolly.reactVirtualized.reactVirtualizedStrings.start]
  }
