...
object MultiGrid {
  ...
  /* key */ StringDictionary[js.Any] = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MultiGridProps, typingsJapgolly.reactVirtualized.mod.MultiGrid, Unit, MultiGridProps] = {
  ...
  typingsJapgolly.reactVirtualized.esMultiGridMod.MultiGridProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactVirtualized.mod.MultiGrid](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactVirtualized.esMultiGridMod.MultiGridProps])(children: _*)
  }
