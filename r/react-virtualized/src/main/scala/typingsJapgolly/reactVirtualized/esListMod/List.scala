...
import typingsJapgolly.reactVirtualized.AnonAutoHeight
import typingsJapgolly.reactVirtualized.PartialCellPosition
import typingsJapgolly.reactVirtualized.esCellMeasurerMod.CellPosition
...
class List ()
  ...
  var Grid: js.UndefOr[typingsJapgolly.reactVirtualized.esGridMod.Grid] = js.native
