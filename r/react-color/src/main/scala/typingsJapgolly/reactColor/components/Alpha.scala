...
import typingsJapgolly.reactColor.libComponentsCommonAlphaMod.AlphaProps
...
object Alpha {
  ...
  inline def apply(onChange: (/* color */ ColorResult, /* event */ ReactEventFrom[HTMLInputElement]) => Callback): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[AlphaProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactColor.libComponentsCommonMod.Alpha] {
  ...
  def withProps(p: AlphaProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
