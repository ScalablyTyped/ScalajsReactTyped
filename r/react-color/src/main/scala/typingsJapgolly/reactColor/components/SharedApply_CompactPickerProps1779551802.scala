...
import typingsJapgolly.reactColor.compactMod.CompactPickerProps
...
abstract class SharedApply_CompactPickerProps1779551802[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CompactPickerProps, ComponentRef, Unit, CompactPickerProps] = {
  ...
  typingsJapgolly.reactColor.compactMod.CompactPickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactColor.compactMod.CompactPickerProps])(children: _*)
  }
}
