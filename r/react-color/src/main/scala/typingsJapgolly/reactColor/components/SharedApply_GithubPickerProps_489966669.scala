...
import typingsJapgolly.reactColor.githubMod.GithubPickerProps
...
abstract class SharedApply_GithubPickerProps_489966669[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[GithubPickerProps, ComponentRef, Unit, GithubPickerProps] = {
  ...
  typingsJapgolly.reactColor.githubMod.GithubPickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactColor.githubMod.GithubPickerProps])(children: _*)
  }
}
