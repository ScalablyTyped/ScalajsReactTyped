...
import typingsJapgolly.reactColor.anon.PartialClassesChromePicke
...
@scala.inline
open class SharedBuilder_ChromePickerProps1743727706[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def styles(value: PartialClassesChromePicke): this.type = set("styles", value.asInstanceOf[js.Any])
}
