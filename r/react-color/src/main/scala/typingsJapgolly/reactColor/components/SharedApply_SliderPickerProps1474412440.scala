...
abstract class SharedApply_SliderPickerProps1474412440[ComponentRef] () {
  ...
  def apply(
    ...
    ColorPickerProps[typingsJapgolly.reactColor.sliderMod.SliderPicker], 
    ComponentRef, 
    Unit, 
    ColorPickerProps[typingsJapgolly.reactColor.sliderMod.SliderPicker]
  ] = {
  ...
  typingsJapgolly.reactColor.mod.ColorPickerProps[typingsJapgolly.reactColor.sliderMod.SliderPicker], 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactColor.mod.ColorPickerProps[typingsJapgolly.reactColor.sliderMod.SliderPicker]])(children: _*)
  }
}
