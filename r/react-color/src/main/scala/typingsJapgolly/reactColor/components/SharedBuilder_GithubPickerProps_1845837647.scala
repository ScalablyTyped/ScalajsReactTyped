...
@scala.inline
open class SharedBuilder_GithubPickerProps_1845837647[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def styles(value: PartialClassesGithubPicke): this.type = set("styles", value.asInstanceOf[js.Any])
