...
@scala.inline
open class SharedBuilder_SliderPickerProps_1430347861[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def styles(value: PartialClassesSliderPicke): this.type = set("styles", value.asInstanceOf[js.Any])
}
