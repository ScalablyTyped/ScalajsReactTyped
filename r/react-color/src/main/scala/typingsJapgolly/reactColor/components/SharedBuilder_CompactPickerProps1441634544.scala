...
@scala.inline
open class SharedBuilder_CompactPickerProps1441634544[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def styles(value: PartialClassesCompactPick): this.type = set("styles", value.asInstanceOf[js.Any])
}
