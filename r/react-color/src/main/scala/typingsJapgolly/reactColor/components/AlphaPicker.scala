...
import typingsJapgolly.reactColor.libComponentsAlphaAlphaMod.AlphaPickerProps
...
object AlphaPicker {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactColor.mod.AlphaPicker] {
    ...
    inline def styles(value: PartialClassesAlphaPicker): this.type = set("styles", value.asInstanceOf[js.Any])
