...
import typingsJapgolly.reactColor.alphaMod.AlphaPickerProps
...
abstract class SharedApply_AlphaPickerProps_1093524020[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[AlphaPickerProps, ComponentRef, Unit, AlphaPickerProps] = {
  ...
  typingsJapgolly.reactColor.alphaMod.AlphaPickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactColor.alphaMod.AlphaPickerProps])(children: _*)
  }
}
