...
import typingsJapgolly.reactColor.blockMod.BlockPickerProps
...
abstract class SharedApply_BlockPickerProps1108534051[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BlockPickerProps, ComponentRef, Unit, BlockPickerProps] = {
  ...
  typingsJapgolly.reactColor.blockMod.BlockPickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactColor.blockMod.BlockPickerProps])(children: _*)
  }
}
