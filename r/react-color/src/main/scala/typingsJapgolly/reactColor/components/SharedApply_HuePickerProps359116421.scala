...
import typingsJapgolly.reactColor.hueHueMod.HuePickerProps
...
abstract class SharedApply_HuePickerProps359116421[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[HuePickerProps, ComponentRef, Unit, HuePickerProps] = {
  ...
  typingsJapgolly.reactColor.hueHueMod.HuePickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactColor.hueHueMod.HuePickerProps])(children: _*)
  }
}
