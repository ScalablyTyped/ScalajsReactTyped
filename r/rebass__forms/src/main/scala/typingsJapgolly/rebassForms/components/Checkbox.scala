...
import typingsJapgolly.rebassForms.mod.CheckboxProps
...
object Checkbox {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CheckboxProps, typingsJapgolly.rebassForms.mod.Checkbox, Unit, CheckboxProps] = {
  ...
  typingsJapgolly.rebassForms.mod.CheckboxProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.rebassForms.mod.Checkbox](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rebassForms.mod.CheckboxProps])(children: _*)
  }
