...
import typingsJapgolly.rebassForms.mod.RadioProps
...
object Radio {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RadioProps, typingsJapgolly.rebassForms.mod.Radio, Unit, RadioProps] = {
  ...
  typingsJapgolly.rebassForms.mod.RadioProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.rebassForms.mod.Radio](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rebassForms.mod.RadioProps])(children: _*)
  }
