...
import typingsJapgolly.rebassForms.mod.SliderProps
...
object Slider {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SliderProps, typingsJapgolly.rebassForms.mod.Slider, Unit, SliderProps] = {
  ...
  typingsJapgolly.rebassForms.mod.SliderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.rebassForms.mod.Slider](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rebassForms.mod.SliderProps])(children: _*)
  }
