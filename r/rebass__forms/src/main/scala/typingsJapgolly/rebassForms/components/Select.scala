...
import typingsJapgolly.rebassForms.mod.SelectProps
...
object Select {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SelectProps, typingsJapgolly.rebassForms.mod.Select, Unit, SelectProps] = {
  ...
  typingsJapgolly.rebassForms.mod.SelectProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.rebassForms.mod.Select](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rebassForms.mod.SelectProps])(children: _*)
  }
