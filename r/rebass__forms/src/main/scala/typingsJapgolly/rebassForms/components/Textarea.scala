...
import typingsJapgolly.rebassForms.mod.TextareaProps
...
object Textarea {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextareaProps, typingsJapgolly.rebassForms.mod.Textarea, Unit, TextareaProps] = {
  ...
  typingsJapgolly.rebassForms.mod.TextareaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.rebassForms.mod.Textarea](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rebassForms.mod.TextareaProps])(children: _*)
  }
