...
import typingsJapgolly.rebassForms.mod.InputProps
...
object Input {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputProps, typingsJapgolly.rebassForms.mod.Input, Unit, InputProps] = {
  ...
  typingsJapgolly.rebassForms.mod.InputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.rebassForms.mod.Input](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rebassForms.mod.InputProps])(children: _*)
  }
