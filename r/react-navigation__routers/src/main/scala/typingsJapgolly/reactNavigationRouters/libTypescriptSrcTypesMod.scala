...
import typingsJapgolly.reactNavigationRouters.anon.KeyName
import typingsJapgolly.reactNavigationRouters.anon.KeyState
import typingsJapgolly.reactNavigationRouters.anon.RouterConfigOptionsrouteK
import typingsJapgolly.reactNavigationRouters.anon.Routes
import typingsJapgolly.reactNavigationRouters.anon.State
import typingsJapgolly.reactNavigationRouters.anon.`0`
import typingsJapgolly.reactNavigationRouters.anon.`1`
...
import typingsJapgolly.reactNavigationRouters.reactNavigationRoutersStrings.routes
import typingsJapgolly.reactNavigationRouters.reactNavigationRoutersStrings.stale
  ...
  trait InitialState extends StObject {
    ...
    val routes: js.Array[
        (Omit[
          ...
          typingsJapgolly.reactNavigationRouters.reactNavigationRoutersStrings.key
        ]) & State
      ]
