...
object anon {
  ...
  trait Pathname extends StObject {
    ...
    var pathname: typingsJapgolly.history.mod.Pathname
  }
  object Pathname {
    
    inline def apply(pathname: typingsJapgolly.history.mod.Pathname): Pathname = {
    ...
    extension [Self <: Pathname](x: Self) {
      ...
      inline def setPathname(value: typingsJapgolly.history.mod.Pathname): Self = StObject.set(x, "pathname", value.asInstanceOf[js.Any])
    }
  }
}
