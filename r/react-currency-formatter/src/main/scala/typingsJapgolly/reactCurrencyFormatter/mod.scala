package typingsJapgolly.reactCurrencyFormatter
...
object mod extends Shortcut {
  ...
  open class ^ protected ()
    extends Component[CurrencyFormatterProps, js.Object, Any] {
    def this(props: CurrencyFormatterProps) = this()
    def this(props: CurrencyFormatterProps, context: Any) = this()
  }
  @JSImport("react-currency-formatter", JSImport.Namespace)
  @js.native
  val ^ : js.Object & (ComponentClass[CurrencyFormatterProps, js.Object]) = js.native
  ...
  object CurrencyFormatterProps {
    ...
    extension [Self <: CurrencyFormatterProps](x: Self) {
  ...
  type _To = js.Object & (ComponentClass[CurrencyFormatterProps, js.Object])
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: js.Object & (ComponentClass[CurrencyFormatterProps, js.Object]) = ^
}
