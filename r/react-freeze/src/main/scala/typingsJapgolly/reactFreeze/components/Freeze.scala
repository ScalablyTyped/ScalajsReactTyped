package typingsJapgolly.reactFreeze.components
...
import typingsJapgolly.reactFreeze.distMod.Props
...
object Freeze {
  ...
  inline def apply(freeze: Boolean): Builder = {
    val __props = js.Dynamic.literal(freeze = freeze.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[Props]))
  }
  
  @JSImport("react-freeze/dist", "Freeze")
  @js.native
