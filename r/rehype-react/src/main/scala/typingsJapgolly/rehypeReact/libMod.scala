...
import typingsJapgolly.rehypeReact.libComplexTypesMod.ComponentsWithNodeOptions
import typingsJapgolly.rehypeReact.libComplexTypesMod.ComponentsWithoutNodeOptions
