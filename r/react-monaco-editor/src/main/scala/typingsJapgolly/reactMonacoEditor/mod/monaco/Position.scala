...
open class Position protected ()
  extends typingsJapgolly.monacoEditor.mod.Position {
...
object Position {
  ...
  /**
    ...
    */
  inline def lift(pos: IPosition): typingsJapgolly.monacoEditor.mod.Position = ^.asInstanceOf[js.Dynamic].applyDynamic("lift")(pos.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.monacoEditor.mod.Position]
}
