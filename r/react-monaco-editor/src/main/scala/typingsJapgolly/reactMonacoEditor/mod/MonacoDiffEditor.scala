...
open class MonacoDiffEditor protected ()
  extends typingsJapgolly.reactMonacoEditor.libDiffMod.default {
...
object MonacoDiffEditor {
  ...
  object defaultProps {
    ...
    @JSImport("react-monaco-editor", "MonacoDiffEditor.defaultProps.className")
    @js.native
    ...
    @JSImport("react-monaco-editor", "MonacoDiffEditor.defaultProps.editorWillUnmount")
    @js.native
  ...
  object propTypes {
    ...
    @JSImport("react-monaco-editor", "MonacoDiffEditor.propTypes.className")
    @js.native
    ...
    @JSImport("react-monaco-editor", "MonacoDiffEditor.propTypes.editorWillUnmount")
    @js.native
