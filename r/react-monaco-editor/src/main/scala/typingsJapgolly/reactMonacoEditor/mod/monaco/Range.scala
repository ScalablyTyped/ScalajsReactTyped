...
open class Range protected ()
  extends typingsJapgolly.monacoEditor.mod.Range {
...
object Range {
  ...
  /**
    ...
    */
  inline def collapseToStart(range: IRange): typingsJapgolly.monacoEditor.mod.Range = ^.asInstanceOf[js.Dynamic].applyDynamic("collapseToStart")(range.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.monacoEditor.mod.Range]
  ...
  inline def fromPositions(start: IPosition): typingsJapgolly.monacoEditor.mod.Range = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPositions")(start.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.monacoEditor.mod.Range]
  inline def fromPositions(start: IPosition, end: IPosition): typingsJapgolly.monacoEditor.mod.Range = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPositions")(start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.monacoEditor.mod.Range]
  
  /**
    * Return the end position (which will be after or equal to the start position)
    */
  inline def getEndPosition(range: IRange): typingsJapgolly.monacoEditor.mod.Position = ^.asInstanceOf[js.Dynamic].applyDynamic("getEndPosition")(range.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.monacoEditor.mod.Position]
  
  /**
    * Return the start position (which will be before or equal to the end position)
    */
  inline def getStartPosition(range: IRange): typingsJapgolly.monacoEditor.mod.Position = ^.asInstanceOf[js.Dynamic].applyDynamic("getStartPosition")(range.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.monacoEditor.mod.Position]
  
  /**
    * A intersection of the two ranges.
    */
  inline def intersectRanges(a: IRange, b: IRange): typingsJapgolly.monacoEditor.mod.Range | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("intersectRanges")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.monacoEditor.mod.Range | Null]
  ...
  inline def lift(range: IRange): typingsJapgolly.monacoEditor.mod.Range | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("lift")(range.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.monacoEditor.mod.Range | Null]
  
  inline def lift_Range(range: IRange): typingsJapgolly.monacoEditor.mod.Range = ^.asInstanceOf[js.Dynamic].applyDynamic("lift")(range.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.monacoEditor.mod.Range]
  
  inline def lift_Union(): typingsJapgolly.monacoEditor.mod.Range | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("lift")().asInstanceOf[typingsJapgolly.monacoEditor.mod.Range | Null]
  
  /**
    * A reunion of the two ranges.
    * The smallest position will be used as the start point, and the largest one as the end point.
    */
  inline def plusRange(a: IRange, b: IRange): typingsJapgolly.monacoEditor.mod.Range = (^.asInstanceOf[js.Dynamic].applyDynamic("plusRange")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.monacoEditor.mod.Range]
