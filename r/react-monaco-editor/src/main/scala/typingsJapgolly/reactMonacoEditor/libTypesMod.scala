...
object libTypesMod {
  ...
  object MonacoDiffEditorProps {
    ...
    extension [Self <: MonacoDiffEditorProps](x: Self) {
      ...
      inline def setEditorDidMount(value: (/* editor */ IStandaloneDiffEditor, /* monaco */ TypeofmonacoEditor) => Callback): Self = StObject.set(x, "editorDidMount", js.Any.fromFunction2((t0: /* editor */ IStandaloneDiffEditor, t1: /* monaco */ TypeofmonacoEditor) => (value(t0, t1)).runNow()))
      ...
      inline def setEditorWillUnmount(value: (/* editor */ IStandaloneDiffEditor, /* monaco */ TypeofmonacoEditor) => Callback): Self = StObject.set(x, "editorWillUnmount", js.Any.fromFunction2((t0: /* editor */ IStandaloneDiffEditor, t1: /* monaco */ TypeofmonacoEditor) => (value(t0, t1)).runNow()))
      
      inline def setEditorWillUnmountUndefined: Self = StObject.set(x, "editorWillUnmount", js.undefined)
      
      inline def setOnChange(value: (/* value */ String, /* event */ IModelContentChangedEvent) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* value */ String, t1: /* event */ IModelContentChangedEvent) => (value(t0, t1)).runNow()))
  ...
  object MonacoEditorProps {
    ...
    extension [Self <: MonacoEditorProps](x: Self) {
      ...
      inline def setEditorDidMount(value: (/* editor */ IStandaloneCodeEditor, /* monaco */ TypeofmonacoEditor) => Callback): Self = StObject.set(x, "editorDidMount", js.Any.fromFunction2((t0: /* editor */ IStandaloneCodeEditor, t1: /* monaco */ TypeofmonacoEditor) => (value(t0, t1)).runNow()))
