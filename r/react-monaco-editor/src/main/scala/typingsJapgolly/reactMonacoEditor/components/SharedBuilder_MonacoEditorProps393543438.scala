...
import typingsJapgolly.reactMonacoEditor.libTypesMod.EditorConstructionOptions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@scala.inline
open class SharedBuilder_MonacoEditorProps393543438[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def editorDidMount(value: (/* editor */ IStandaloneCodeEditor, /* monaco */ TypeofmonacoEditor) => Callback): this.type = set("editorDidMount", js.Any.fromFunction2((t0: /* editor */ IStandaloneCodeEditor, t1: /* monaco */ TypeofmonacoEditor) => (value(t0, t1)).runNow()))
  
  inline def editorWillMount(value: /* monaco */ TypeofmonacoEditor => Unit | EditorConstructionOptions): this.type = set("editorWillMount", js.Any.fromFunction1(value))
  
  inline def editorWillUnmount(
    value: (/* editor */ IStandaloneCodeEditor, /* monaco */ TypeofmonacoEditor) => Unit | EditorConstructionOptions
  ): this.type = set("editorWillUnmount", js.Any.fromFunction2(value))
  ...
  inline def options(value: IStandaloneEditorConstructionOptions): this.type = set("options", value.asInstanceOf[js.Any])
