...
import typingsJapgolly.rollupPluginSvelteSvg.rollupPluginSvelteSvgStrings.post
import typingsJapgolly.rollupPluginSvelteSvg.rollupPluginSvelteSvgStrings.pre
