...
object ReduxInfiniteScroll {
  ...
  inline def apply(loadMore: Callback): Builder = {
    val __props = js.Dynamic.literal(loadMore = loadMore.toJsFn)
    new Builder(js.Array(this.component, __props.asInstanceOf[InfiniteScrollerProps & HTMLProps[HTMLDivElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def containerHeight(value: Double | String): this.type = set("containerHeight", value.asInstanceOf[js.Any])
    ...
    inline def elementIsScrollable(value: Boolean): this.type = set("elementIsScrollable", value.asInstanceOf[js.Any])
    ...
    inline def holderType(value: String): this.type = set("holderType", value.asInstanceOf[js.Any])
    ...
    inline def items(value: js.Array[Element]): this.type = set("items", value.asInstanceOf[js.Any])
    
    inline def itemsVarargs(value: Element*): this.type = set("items", js.Array(value*))
    ...
    inline def loader(value: Any): this.type = set("loader", value.asInstanceOf[js.Any])
    
    inline def loadingMore(value: Boolean): this.type = set("loadingMore", value.asInstanceOf[js.Any])
  ...
  def withProps(p: InfiniteScrollerProps & HTMLProps[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
