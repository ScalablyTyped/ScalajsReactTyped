...
import typingsJapgolly.redisJson.distCommandsGetMod.GetOptions
import typingsJapgolly.redisJson.distCommandsMod.RedisJSON
import typingsJapgolly.redisJson.distCommandsRespMod.RESPReply
import typingsJapgolly.redisJson.distCommandsSetMod.NX
import typingsJapgolly.redisJson.distCommandsSetMod.XX
import typingsJapgolly.redisJson.distCommandsStrappendMod.AppendArguments
import typingsJapgolly.redisJson.distCommandsStrappendMod.AppendWithPathArguments
import typingsJapgolly.redisJson.redisJsonStrings.OK
...
object anon {
  ...
  object TypeofARRAPPEND {
    ...
    inline def apply(
      ...
      transformReply: CallbackTo[Double | js.Array[Double]]
    ): TypeofARRAPPEND = {
    ...
    extension [Self <: TypeofARRAPPEND](x: Self) {
      ...
      inline def setTransformReply(value: CallbackTo[Double | js.Array[Double]]): Self = StObject.set(x, "transformReply", value.toJsFn)
    }
  }
