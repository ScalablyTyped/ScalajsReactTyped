...
import typingsJapgolly.rcTabs.rcTabsStrings.`additions removals`
import typingsJapgolly.rcTabs.rcTabsStrings.`additions text`
import typingsJapgolly.rcTabs.rcTabsStrings.`inline`
import typingsJapgolly.rcTabs.rcTabsStrings.`removals additions`
import typingsJapgolly.rcTabs.rcTabsStrings.`removals text`
import typingsJapgolly.rcTabs.rcTabsStrings.`text additions`
import typingsJapgolly.rcTabs.rcTabsStrings.`text removals`
import typingsJapgolly.rcTabs.rcTabsStrings.additions
import typingsJapgolly.rcTabs.rcTabsStrings.all
import typingsJapgolly.rcTabs.rcTabsStrings.ascending
import typingsJapgolly.rcTabs.rcTabsStrings.assertive
import typingsJapgolly.rcTabs.rcTabsStrings.both
import typingsJapgolly.rcTabs.rcTabsStrings.copy
import typingsJapgolly.rcTabs.rcTabsStrings.date
import typingsJapgolly.rcTabs.rcTabsStrings.decimal
import typingsJapgolly.rcTabs.rcTabsStrings.descending
import typingsJapgolly.rcTabs.rcTabsStrings.dialog
import typingsJapgolly.rcTabs.rcTabsStrings.email
import typingsJapgolly.rcTabs.rcTabsStrings.execute
import typingsJapgolly.rcTabs.rcTabsStrings.grammar
import typingsJapgolly.rcTabs.rcTabsStrings.grid
import typingsJapgolly.rcTabs.rcTabsStrings.horizontal
import typingsJapgolly.rcTabs.rcTabsStrings.inherit
import typingsJapgolly.rcTabs.rcTabsStrings.link
import typingsJapgolly.rcTabs.rcTabsStrings.list
import typingsJapgolly.rcTabs.rcTabsStrings.listbox
import typingsJapgolly.rcTabs.rcTabsStrings.location
import typingsJapgolly.rcTabs.rcTabsStrings.ltr
import typingsJapgolly.rcTabs.rcTabsStrings.menu
import typingsJapgolly.rcTabs.rcTabsStrings.mixed
import typingsJapgolly.rcTabs.rcTabsStrings.move
import typingsJapgolly.rcTabs.rcTabsStrings.no
import typingsJapgolly.rcTabs.rcTabsStrings.none
import typingsJapgolly.rcTabs.rcTabsStrings.numeric
import typingsJapgolly.rcTabs.rcTabsStrings.off
import typingsJapgolly.rcTabs.rcTabsStrings.on
import typingsJapgolly.rcTabs.rcTabsStrings.other
import typingsJapgolly.rcTabs.rcTabsStrings.page
import typingsJapgolly.rcTabs.rcTabsStrings.polite
import typingsJapgolly.rcTabs.rcTabsStrings.popup
import typingsJapgolly.rcTabs.rcTabsStrings.removals
import typingsJapgolly.rcTabs.rcTabsStrings.rtl
import typingsJapgolly.rcTabs.rcTabsStrings.search
import typingsJapgolly.rcTabs.rcTabsStrings.spelling
import typingsJapgolly.rcTabs.rcTabsStrings.step
import typingsJapgolly.rcTabs.rcTabsStrings.tel
import typingsJapgolly.rcTabs.rcTabsStrings.text
import typingsJapgolly.rcTabs.rcTabsStrings.time
import typingsJapgolly.rcTabs.rcTabsStrings.tree
import typingsJapgolly.rcTabs.rcTabsStrings.url
import typingsJapgolly.rcTabs.rcTabsStrings.vertical
import typingsJapgolly.rcTabs.rcTabsStrings.yes
...
@scala.inline
open class SharedBuilder_TabsPropsRefAttributes_266785819[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def animated(value: Boolean | AnimatedConfig): this.type = set("animated", value.asInstanceOf[js.Any])
  ...
  inline def items(value: js.Array[Tab]): this.type = set("items", value.asInstanceOf[js.Any])
  
  inline def itemsVarargs(value: Tab*): this.type = set("items", js.Array(value*))
  ...
  inline def onChange(value: /* activeKey */ String => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* activeKey */ String) => value(t0).runNow()))
  ...
  inline def onTabClick(
    value: (/* activeKey */ String, /* e */ ReactKeyboardEventFrom[org.scalajs.dom.Element] | ReactMouseEventFrom[org.scalajs.dom.Element]) => Callback
  ): this.type = set("onTabClick", js.Any.fromFunction2((t0: /* activeKey */ String, t1: /* e */ ReactKeyboardEventFrom[org.scalajs.dom.Element] | ReactMouseEventFrom[org.scalajs.dom.Element]) => (value(t0, t1)).runNow()))
  ...
  inline def renderTabBar(
    value: (/* props */ RenderTabBarProps, /* DefaultTabBar */ ComponentType[TabNavListProps]) => Element
  ...
  inline def tabBarStyle(value: CSSProperties): this.type = set("tabBarStyle", value.asInstanceOf[js.Any])
  
  inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
  
  inline def tabPosition(value: TabPosition): this.type = set("tabPosition", value.asInstanceOf[js.Any])
