...
object esTabsMod extends Shortcut {
  ...
  trait TabsProps extends StObject {
    ...
    var onTabClick: js.UndefOr[
        js.Function2[
          /* activeKey */ String, 
          /* e */ ReactKeyboardEventFrom[Element] | ReactMouseEventFrom[Element], 
          Unit
        ]
      ] = js.undefined
  ...
  object TabsProps {
    ...
    extension [Self <: TabsProps](x: Self) {
      ...
      inline def setOnTabClick(
        value: (/* activeKey */ String, /* e */ ReactKeyboardEventFrom[Element] | ReactMouseEventFrom[Element]) => Callback
      ): Self = StObject.set(x, "onTabClick", js.Any.fromFunction2((t0: /* activeKey */ String, t1: /* e */ ReactKeyboardEventFrom[Element] | ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
