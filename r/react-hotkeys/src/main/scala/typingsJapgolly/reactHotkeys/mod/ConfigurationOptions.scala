...
object ConfigurationOptions {
  ...
  def apply(
    ...
    ignoreEventsCondition: /* keyEvent */ KeyboardEvent => CallbackTo[Boolean] = null,
    ...
    if (ignoreEventsCondition != null) __obj.updateDynamic("ignoreEventsCondition")(js.Any.fromFunction1((t0: /* keyEvent */ org.scalajs.dom.raw.KeyboardEvent) => ignoreEventsCondition(t0).runNow()))
