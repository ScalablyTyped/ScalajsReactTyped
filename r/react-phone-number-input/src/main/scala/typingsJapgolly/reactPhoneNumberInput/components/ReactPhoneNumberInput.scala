package typingsJapgolly.reactPhoneNumberInput.components
...
import typingsJapgolly.reactPhoneNumberInput.mod.CountrySelectComponentProps
import typingsJapgolly.reactPhoneNumberInput.mod.FlagsMap
import typingsJapgolly.reactPhoneNumberInput.mod.PhoneInputProps
import typingsJapgolly.reactPhoneNumberInput.mod.default
...
object ReactPhoneNumberInput {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PhoneInputProps, default, Unit, PhoneInputProps] = {
  ...
  typingsJapgolly.reactPhoneNumberInput.mod.PhoneInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactPhoneNumberInput.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactPhoneNumberInput.mod.PhoneInputProps])(children: _*)
  }
