...
import typingsJapgolly.reactMdMedia.typesMediaOverlayMod.MediaOverlayPosition
...
object MediaOverlay {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def position(value: MediaOverlayPosition): this.type = set("position", value.asInstanceOf[js.Any])
  ...
  def withProps(p: MediaOverlayProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
