package typingsJapgolly.reactMdMedia.components
...
object MediaContainer {
  ...
  object MediaContainerPropsRefAttributes {
    ...
    def withProps(p: MediaContainerProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object MediaContainerWithAspectRatioPropsRefAttributes {
    ...
    inline def apply(height: Double, width: Double): Builder = {
      ...
      new Builder(js.Array(this.component, __props.asInstanceOf[MediaContainerWithAspectRatioProps & RefAttributes[HTMLDivElement]]))
    }
    ...
    def withProps(p: MediaContainerWithAspectRatioProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
