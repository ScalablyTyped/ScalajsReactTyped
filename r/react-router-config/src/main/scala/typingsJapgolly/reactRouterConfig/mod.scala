package typingsJapgolly.reactRouterConfig
...
object mod {
  ...
  trait RouteConfig
    ...
    var render: js.UndefOr[js.Function1[/* props */ RouteConfigComponentProps[Any], Node]] = js.undefined
  ...
  object RouteConfig {
    ...
    extension [Self <: RouteConfig](x: Self) {
      ...
      inline def setRender(value: /* props */ RouteConfigComponentProps[Any] => Node): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
