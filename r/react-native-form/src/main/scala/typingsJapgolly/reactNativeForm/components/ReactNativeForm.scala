package typingsJapgolly.reactNativeForm.components
...
import typingsJapgolly.reactNativeForm.mod.FormProps
import typingsJapgolly.reactNativeForm.mod.default
...
object ReactNativeForm {
  ...
  typingsJapgolly.reactNativeForm.mod.FormProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeForm.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeForm.mod.FormProps])(children: _*)
  }
