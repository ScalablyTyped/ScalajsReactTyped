...
import typingsJapgolly.rotJs.anon.PartialOptions
import typingsJapgolly.rotJs.libPathPathMod.PassableCallback
...
object libPathDijkstraMod {
  ...
  @js.native
  trait Dijkstra
    extends typingsJapgolly.rotJs.libPathPathMod.default {
