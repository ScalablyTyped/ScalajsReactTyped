...
object libFovFovMod {
  ...
  object FOV {
    ...
    inline def apply(
      ...
      _options: Options,
      compute: (Double, Double, Double, VisibilityCallback) => Callback
    ): FOV = {
      val __obj = js.Dynamic.literal(_getCircle = js.Any.fromFunction3(_getCircle), _lightPasses = js.Any.fromFunction2(_lightPasses), _options = _options.asInstanceOf[js.Any], compute = js.Any.fromFunction4((t0: Double, t1: Double, t2: Double, t3: VisibilityCallback) => (compute(t0, t1, t2, t3)).runNow()))
      __obj.asInstanceOf[FOV]
    }
    
    extension [Self <: FOV](x: Self) {
      
      inline def setCompute(value: (Double, Double, Double, VisibilityCallback) => Callback): Self = StObject.set(x, "compute", js.Any.fromFunction4((t0: Double, t1: Double, t2: Double, t3: VisibilityCallback) => (value(t0, t1, t2, t3)).runNow()))
