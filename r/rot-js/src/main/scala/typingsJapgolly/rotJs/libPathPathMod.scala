...
object libPathPathMod {
  ...
  object Path {
    ...
    inline def apply(
      ...
      _toX: Double,
      _toY: Double,
      compute: (Double, Double, ComputeCallback) => Callback
    ): Path = {
      val __obj = js.Dynamic.literal(_dirs = _dirs.asInstanceOf[js.Any], _getNeighbors = js.Any.fromFunction2(_getNeighbors), _options = _options.asInstanceOf[js.Any], _passableCallback = js.Any.fromFunction2(_passableCallback), _toX = _toX.asInstanceOf[js.Any], _toY = _toY.asInstanceOf[js.Any], compute = js.Any.fromFunction3((t0: Double, t1: Double, t2: ComputeCallback) => (compute(t0, t1, t2)).runNow()))
      __obj.asInstanceOf[Path]
    }
    
    extension [Self <: Path](x: Self) {
      
      inline def setCompute(value: (Double, Double, ComputeCallback) => Callback): Self = StObject.set(x, "compute", js.Any.fromFunction3((t0: Double, t1: Double, t2: ComputeCallback) => (value(t0, t1, t2)).runNow()))
