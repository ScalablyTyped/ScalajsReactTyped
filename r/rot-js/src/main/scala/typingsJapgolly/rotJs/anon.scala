...
import typingsJapgolly.rotJs.libDisplayRectMod.default
import typingsJapgolly.rotJs.libDisplayTypesMod.LayoutType
import typingsJapgolly.rotJs.rotJsInts.`4`
import typingsJapgolly.rotJs.rotJsInts.`6`
import typingsJapgolly.rotJs.rotJsInts.`8`
...
object anon {
  ...
  trait TypeofTileGL
    extends StObject
       with Instantiable0[typingsJapgolly.rotJs.libDisplayTileGlMod.default] {
