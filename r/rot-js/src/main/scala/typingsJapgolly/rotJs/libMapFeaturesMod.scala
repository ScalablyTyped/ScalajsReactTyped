...
object libMapFeaturesMod {
  ...
  object Feature {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(create = js.Any.fromFunction1((t0: DigCallback) => create(t0).runNow()), debug = debug.toJsFn, isValid = js.Any.fromFunction2(isValid))
      __obj.asInstanceOf[Feature]
    }
    
    extension [Self <: Feature](x: Self) {
      
      inline def setCreate(value: DigCallback => Callback): Self = StObject.set(x, "create", js.Any.fromFunction1((t0: DigCallback) => value(t0).runNow()))
