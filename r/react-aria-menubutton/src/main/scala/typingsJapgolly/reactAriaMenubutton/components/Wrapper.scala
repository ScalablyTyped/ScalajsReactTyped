...
object Wrapper {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactAriaMenubutton.mod.Wrapper] {
    ...
    inline def onMenuToggle(value: /* obj */ WrapperState => Any): this.type = set("onMenuToggle", js.Any.fromFunction1(value))
    ...
    inline def onSelection(value: (/* value */ Any, /* event */ ReactEventFrom[HTMLElement & Element]) => Any): this.type = set("onSelection", js.Any.fromFunction2(value))
    ...
    inline def tag(value: /* import warning: importer.ImportType#apply Failed type conversion: T['tagName'] */ js.Any): this.type = set("tag", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: Wrapper.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WrapperProps[HTMLElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
