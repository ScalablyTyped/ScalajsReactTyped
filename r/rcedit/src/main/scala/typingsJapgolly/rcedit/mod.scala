...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rcedit.rceditStrings.asInvoker
    - typingsJapgolly.rcedit.rceditStrings.highestAvailable
    - typingsJapgolly.rcedit.rceditStrings.requireAdministrator
  */
  trait RequestedExecutionLevel extends StObject
  object RequestedExecutionLevel {
    
    inline def asInvoker: typingsJapgolly.rcedit.rceditStrings.asInvoker = "asInvoker".asInstanceOf[typingsJapgolly.rcedit.rceditStrings.asInvoker]
    
    inline def highestAvailable: typingsJapgolly.rcedit.rceditStrings.highestAvailable = "highestAvailable".asInstanceOf[typingsJapgolly.rcedit.rceditStrings.highestAvailable]
    
    inline def requireAdministrator: typingsJapgolly.rcedit.rceditStrings.requireAdministrator = "requireAdministrator".asInstanceOf[typingsJapgolly.rcedit.rceditStrings.requireAdministrator]
  }
