...
/** This type represents all the known supported options in the `ui:options` property, kept separate in order to
  ...
  */
/* Inlined std.Partial<std.Omit<@rjsf/utils.@rjsf/utils.TemplatesType<T, F>, 'ButtonTemplates'>> & {  classNames :string | undefined,   title :string | undefined,   description :string | undefined,   placeholder :string | undefined,   help :string | undefined,   autofocus :boolean | undefined,   autocomplete :std.HTMLInputElement['autocomplete'] | undefined,   disabled :boolean | undefined,   emptyValue :any | undefined,   enumDisabled :std.Array<string | number | boolean> | undefined,   hideError :boolean | undefined,   readonly :boolean | undefined,   order :std.Array<string> | undefined,   addable :boolean | undefined,   orderable :boolean | undefined,   removable :boolean | undefined,   inline :boolean | undefined,   inputType :string | undefined,   label :boolean | undefined,   rows :number | undefined,   submitButtonOptions :@rjsf/utils.@rjsf/utils.UISchemaSubmitButtonOptions | undefined,   widget :@rjsf/utils.@rjsf/utils.Widget<T, F> | string | undefined,   duplicateKeySuffixSeparator :string | undefined} */
trait UIOptionsBaseType[T, F] extends StObject {
...
object UIOptionsBaseType {
  
  inline def apply[T, F](): UIOptionsBaseType[T, F] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UIOptionsBaseType[T, F]]
  }
  
  extension [Self <: UIOptionsBaseType[?, ?], T, F](x: Self & (UIOptionsBaseType[T, F])) {
