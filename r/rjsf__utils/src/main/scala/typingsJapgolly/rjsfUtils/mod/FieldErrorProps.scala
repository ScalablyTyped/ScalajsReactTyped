...
trait FieldErrorProps[T, F] extends StObject {
  ...
  var errors: js.UndefOr[js.Array[String | Element]] = js.undefined
...
object FieldErrorProps {
  ...
  extension [Self <: FieldErrorProps[?, ?], T, F](x: Self & (FieldErrorProps[T, F])) {
    ...
    inline def setErrors(value: js.Array[String | Element]): Self = StObject.set(x, "errors", value.asInstanceOf[js.Any])
    
    inline def setErrorsUndefined: Self = StObject.set(x, "errors", js.undefined)
    
    inline def setErrorsVarargs(value: (String | Element)*): Self = StObject.set(x, "errors", js.Array(value*))
