...
import typingsJapgolly.rjsfUtils.anon.Blob
import typingsJapgolly.rjsfUtils.mod.^
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.ArrayFieldDescriptionTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.ArrayFieldItemTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.ArrayFieldTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.ArrayFieldTitleTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.BaseInputTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.ButtonTemplates
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.DescriptionFieldTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.ErrorListTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.FieldErrorTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.FieldHelpTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.FieldTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.ObjectFieldTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.TitleFieldTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.UnsupportedFieldTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.WrapIfAdditionalTemplate
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.`null`
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.`object`
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.array
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.boolean
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.number
import typingsJapgolly.rjsfUtils.rjsfUtilsStrings.string
...
/** Determines whether the given `component` should be rerendered by comparing its current set of props and state
  ...
  */
inline def shouldRender(component: Component[js.Object, js.Object], nextProps: Any, nextState: Any): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("shouldRender")(component.asInstanceOf[js.Any], nextProps.asInstanceOf[js.Any], nextState.asInstanceOf[js.Any])).asInstanceOf[Boolean]
