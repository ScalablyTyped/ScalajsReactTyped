package typingsJapgolly.refArray.mod
...
object ^
  extends TopLevel[
      (Instantiable1[/* type */ Type, ArrayType[js.Object]]) with (Instantiable1[/* type */ String, ArrayType[js.Object]]) with (Instantiable2[/* type */ String, /* length */ Double, ArrayType[js.Object]]) with (Instantiable2[/* type */ Type, /* length */ Double, ArrayType[js.Object]])
    ] {
