...
object distReactSpringCoreDotcjsMod {
  
  @JSImport("@react-spring/core/dist/react-spring-core.cjs", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@react-spring/core/dist/react-spring-core.cjs", "BailSignal")
  @js.native
  open class BailSignal ()
    extends typingsJapgolly.reactSpringCore.distDeclarationsSrcMod.BailSignal
  
  @JSImport("@react-spring/core/dist/react-spring-core.cjs", "Controller")
  @js.native
  open class Controller[State /* <: Lookup[Any] */] ()
    extends typingsJapgolly.reactSpringCore.distDeclarationsSrcMod.Controller[State] {
  ...
  /* note: abstract class */ @JSImport("@react-spring/core/dist/react-spring-core.cjs", "FrameValue")
  @js.native
  open class FrameValue[T] ()
    extends typingsJapgolly.reactSpringCore.distDeclarationsSrcMod.FrameValue[T]
  
  @JSImport("@react-spring/core/dist/react-spring-core.cjs", "Interpolation")
  @js.native
  open class Interpolation[Input, Output] protected ()
    extends typingsJapgolly.reactSpringCore.distDeclarationsSrcMod.Interpolation[Input, Output] {
  ...
  object SpringContext {
    ...
    @JSImport("@react-spring/core/dist/react-spring-core.cjs", "SpringContext")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@react-spring/core/dist/react-spring-core.cjs", "SpringContext.Consumer")
    @js.native
    ...
    @JSImport("@react-spring/core/dist/react-spring-core.cjs", "SpringContext.Provider")
    @js.native
  ...
  @JSImport("@react-spring/core/dist/react-spring-core.cjs", "SpringValue")
  @js.native
  open class SpringValue[T] ()
    extends typingsJapgolly.reactSpringCore.distDeclarationsSrcMod.SpringValue[T] {
  ...
  object config extends Shortcut {
    ...
    @JSImport("@react-spring/core/dist/react-spring-core.cjs", "config.default")
    @js.native
    val default: Friction = js.native
    
    @JSImport("@react-spring/core/dist/react-spring-core.cjs", "config.gentle")
    @js.native
    val gentle: Tension = js.native
    
    @JSImport("@react-spring/core/dist/react-spring-core.cjs", "config.molasses")
    @js.native
    val molasses: `2` = js.native
    
    @JSImport("@react-spring/core/dist/react-spring-core.cjs", "config.slow")
    @js.native
    val slow: `1` = js.native
    
    @JSImport("@react-spring/core/dist/react-spring-core.cjs", "config.stiff")
    @js.native
    val stiff: `0` = js.native
    
    @JSImport("@react-spring/core/dist/react-spring-core.cjs", "config.wobbly")
    @js.native
  ...
  @JSImport("@react-spring/core/dist/react-spring-core.cjs", "easings")
  @js.native
  ...
  @JSImport("@react-spring/core/dist/react-spring-core.cjs", "interpolate")
  @js.native
  val interpolate: Interpolator = js.native
  
  @JSImport("@react-spring/core/dist/react-spring-core.cjs", "to")
  @js.native
