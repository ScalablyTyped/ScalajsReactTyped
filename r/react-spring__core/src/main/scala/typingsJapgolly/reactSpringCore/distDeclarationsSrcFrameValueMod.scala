...
import typingsJapgolly.reactSpringCore.reactSpringCoreStrings.change
import typingsJapgolly.reactSpringCore.reactSpringCoreStrings.idle
import typingsJapgolly.reactSpringCore.reactSpringCoreStrings.priority
...
object distDeclarationsSrcFrameValueMod {
  ...
  object FrameValue {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.reactSpringCore.distDeclarationsSrcFrameValueMod.FrameValue.ChangeEvent[T]
      - typingsJapgolly.reactSpringCore.distDeclarationsSrcFrameValueMod.FrameValue.PriorityEvent[T]
      - typingsJapgolly.reactSpringCore.distDeclarationsSrcFrameValueMod.FrameValue.IdleEvent[T]
    */
    trait Event[T] extends StObject
    object Event {
      
      inline def ChangeEvent[T](idle: Boolean, parent: FrameValue[T], value: T): typingsJapgolly.reactSpringCore.distDeclarationsSrcFrameValueMod.FrameValue.ChangeEvent[T] = {
        val __obj = js.Dynamic.literal(idle = idle.asInstanceOf[js.Any], parent = parent.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
        __obj.updateDynamic("type")("change")
        __obj.asInstanceOf[typingsJapgolly.reactSpringCore.distDeclarationsSrcFrameValueMod.FrameValue.ChangeEvent[T]]
      }
      
      inline def IdleEvent[T](parent: FrameValue[T]): typingsJapgolly.reactSpringCore.distDeclarationsSrcFrameValueMod.FrameValue.IdleEvent[T] = {
        val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
        __obj.updateDynamic("type")("idle")
        __obj.asInstanceOf[typingsJapgolly.reactSpringCore.distDeclarationsSrcFrameValueMod.FrameValue.IdleEvent[T]]
      }
      
      inline def PriorityEvent[T](parent: FrameValue[T], priority: Double): typingsJapgolly.reactSpringCore.distDeclarationsSrcFrameValueMod.FrameValue.PriorityEvent[T] = {
        ...
        __obj.asInstanceOf[typingsJapgolly.reactSpringCore.distDeclarationsSrcFrameValueMod.FrameValue.PriorityEvent[T]]
      }
    }
