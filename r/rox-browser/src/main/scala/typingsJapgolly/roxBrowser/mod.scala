...
import typingsJapgolly.roxBrowser.roxBrowserStrings.verbose
...
object mod {
  ...
  object RoxSetupOptions {
    ...
    extension [Self <: RoxSetupOptions](x: Self) {
      ...
      inline def setConfigurationFetchedHandler(value: /* fetcherResult */ RoxFetcherResult => Callback): Self = StObject.set(x, "configurationFetchedHandler", js.Any.fromFunction1((t0: /* fetcherResult */ RoxFetcherResult) => value(t0).runNow()))
      ...
      inline def setImpressionHandler(value: (/* reporting */ RoxReporting, /* context */ Any) => Callback): Self = StObject.set(x, "impressionHandler", js.Any.fromFunction2((t0: /* reporting */ RoxReporting, t1: /* context */ Any) => (value(t0, t1)).runNow()))
