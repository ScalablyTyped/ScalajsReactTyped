...
object RoxSetupOptions {
  ...
  def apply(
    ...
    if (configurationFetchedHandler != null) __obj.updateDynamic("configurationFetchedHandler")(js.Any.fromFunction1((t0: /* fetcherResult */ typingsJapgolly.roxBrowser.mod.RoxFetcherResult) => configurationFetchedHandler(t0).runNow()))
    ...
    if (impressionHandler != null) __obj.updateDynamic("impressionHandler")(js.Any.fromFunction3((t0: /* reporting */ typingsJapgolly.roxBrowser.mod.RoxReporting, t1: /* experiment */ typingsJapgolly.roxBrowser.mod.RoxExperiment, t2: /* context */ js.Any) => impressionHandler(t0, t1, t2).runNow()))
