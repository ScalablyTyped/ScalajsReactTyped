package typingsJapgolly.roxBrowser

import typingsJapgolly.roxBrowser.mod.RoxContainer
import typingsJapgolly.roxBrowser.mod.RoxErrorTrigger
import typingsJapgolly.roxBrowser.mod.RoxFlagOptions
import typingsJapgolly.roxBrowser.mod.RoxOverridesPosition
import typingsJapgolly.roxBrowser.mod.RoxSetupOptions
...
object global {
  ...
  object Rox {
    ...
    @js.native
    open class Flag ()
      extends typingsJapgolly.roxBrowser.mod.Flag {
    ...
    object RoxErrorTrigger extends StObject {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[typingsJapgolly.roxBrowser.mod.RoxErrorTrigger & String] = js.native
      
      /* "CONFIGURATION_FETCHED_HANDLER" */ val CONFIGURATION_FETCHED_HANDLER: typingsJapgolly.roxBrowser.mod.RoxErrorTrigger.CONFIGURATION_FETCHED_HANDLER & String = js.native
      
      /* "CUSTOM_PROPERTY_GENERATOR" */ val CUSTOM_PROPERTY_GENERATOR: typingsJapgolly.roxBrowser.mod.RoxErrorTrigger.CUSTOM_PROPERTY_GENERATOR & String = js.native
      
      /* "DYNAMIC_PROPERTIES_RULE" */ val DYNAMIC_PROPERTIES_RULE: typingsJapgolly.roxBrowser.mod.RoxErrorTrigger.DYNAMIC_PROPERTIES_RULE & String = js.native
      
      /* "IMPRESSION_HANDLER" */ val IMPRESSION_HANDLER: typingsJapgolly.roxBrowser.mod.RoxErrorTrigger.IMPRESSION_HANDLER & String = js.native
    }
    ...
    object RoxFetcherStatus extends StObject {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[typingsJapgolly.roxBrowser.mod.RoxFetcherStatus & String] = js.native
      
      /* "APPLIED_FROM_CACHE" */ val AppliedFromCache: typingsJapgolly.roxBrowser.mod.RoxFetcherStatus.AppliedFromCache & String = js.native
      
      /* "APPLIED_FROM_EMBEDDED" */ val AppliedFromEmbedded: typingsJapgolly.roxBrowser.mod.RoxFetcherStatus.AppliedFromEmbedded & String = js.native
      
      /* "APPLIED_FROM_NETWORK" */ val AppliedFromNetwork: typingsJapgolly.roxBrowser.mod.RoxFetcherStatus.AppliedFromNetwork & String = js.native
      
      /* "ERROR_FETCH_FAILED" */ val ErrorFetchFailed: typingsJapgolly.roxBrowser.mod.RoxFetcherStatus.ErrorFetchFailed & String = js.native
    }
    ...
    object RoxFlagFreezeLevel extends StObject {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[typingsJapgolly.roxBrowser.mod.RoxFlagFreezeLevel & String] = js.native
      
      /* "none" */ val None: typingsJapgolly.roxBrowser.mod.RoxFlagFreezeLevel.None & String = js.native
      
      /* "untilForeground" */ val UntilForeground: typingsJapgolly.roxBrowser.mod.RoxFlagFreezeLevel.UntilForeground & String = js.native
      
      /* "untilLaunch" */ val UntilLaunch: typingsJapgolly.roxBrowser.mod.RoxFlagFreezeLevel.UntilLaunch & String = js.native
    }
    ...
    open class RoxNumber protected ()
      extends typingsJapgolly.roxBrowser.mod.RoxNumber {
    ...
    object RoxOverridesPosition extends StObject {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[typingsJapgolly.roxBrowser.mod.RoxOverridesPosition & String] = js.native
      
      /* "bottom left" */ val BottomLeft: typingsJapgolly.roxBrowser.mod.RoxOverridesPosition.BottomLeft & String = js.native
      
      /* "bottom right" */ val BottomRight: typingsJapgolly.roxBrowser.mod.RoxOverridesPosition.BottomRight & String = js.native
      
      /* "top left" */ val TopLeft: typingsJapgolly.roxBrowser.mod.RoxOverridesPosition.TopLeft & String = js.native
      
      /* "top right" */ val TopRight: typingsJapgolly.roxBrowser.mod.RoxOverridesPosition.TopRight & String = js.native
    }
    ...
    open class RoxString protected ()
      extends typingsJapgolly.roxBrowser.mod.RoxString {
    ...
    @JSGlobal("Rox.flags")
    @js.native
    val flags: js.Array[typingsJapgolly.roxBrowser.mod.Flag] = js.native
