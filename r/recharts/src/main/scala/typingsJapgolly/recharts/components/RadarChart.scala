...
import typingsJapgolly.recharts.mod.RadarChartProps
...
object RadarChart {
  ...
  ): UnmountedWithRoot[RadarChartProps, typingsJapgolly.recharts.mod.RadarChart, Unit, RadarChartProps] = {
  ...
  typingsJapgolly.recharts.mod.RadarChartProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.recharts.mod.RadarChart](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.RadarChartProps])
  }
