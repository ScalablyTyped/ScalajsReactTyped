...
import typingsJapgolly.recharts.mod.ScatterChartProps
...
object ScatterChart {
  ...
  ): UnmountedWithRoot[ScatterChartProps, typingsJapgolly.recharts.mod.ScatterChart, Unit, ScatterChartProps] = {
  ...
  typingsJapgolly.recharts.mod.ScatterChartProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.recharts.mod.ScatterChart](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.ScatterChartProps])
  }
