...
import typingsJapgolly.recharts.mod.ChartOffset
...
object CartesianGrid {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.CartesianGrid] {
    ...
    inline def horizontal(value: js.Object | Element | (ContentRenderer[LineProps & CartesianGridProps]) | Boolean): this.type = set("horizontal", value.asInstanceOf[js.Any])
    
    inline def horizontalCoordinatesGenerator(value: /* arg */ Offset => js.Array[Double]): this.type = set("horizontalCoordinatesGenerator", js.Any.fromFunction1(value))
    
    inline def horizontalFill(value: js.Array[String]): this.type = set("horizontalFill", value.asInstanceOf[js.Any])
    
    inline def horizontalFillVarargs(value: String*): this.type = set("horizontalFill", js.Array(value*))
    
    inline def horizontalFunction1(value: LineProps & CartesianGridProps => Node): this.type = set("horizontal", js.Any.fromFunction1(value))
    
    inline def horizontalPoints(value: js.Array[Double]): this.type = set("horizontalPoints", value.asInstanceOf[js.Any])
    
    inline def horizontalPointsVarargs(value: Double*): this.type = set("horizontalPoints", js.Array(value*))
    
    inline def horizontalVdomElement(value: VdomElement): this.type = set("horizontal", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def offset(value: ChartOffset): this.type = set("offset", value.asInstanceOf[js.Any])
    ...
    inline def vertical(value: js.Object | Element | (ContentRenderer[LineProps & CartesianGridProps]) | Boolean): this.type = set("vertical", value.asInstanceOf[js.Any])
    
    inline def verticalCoordinatesGenerator(value: /* arg */ Width => js.Array[Double]): this.type = set("verticalCoordinatesGenerator", js.Any.fromFunction1(value))
    
    inline def verticalFill(value: js.Array[String]): this.type = set("verticalFill", value.asInstanceOf[js.Any])
    
    inline def verticalFillVarargs(value: String*): this.type = set("verticalFill", js.Array(value*))
    
    inline def verticalFunction1(value: LineProps & CartesianGridProps => Node): this.type = set("vertical", js.Any.fromFunction1(value))
    
    inline def verticalPoints(value: js.Array[Double]): this.type = set("verticalPoints", value.asInstanceOf[js.Any])
    
    inline def verticalPointsVarargs(value: Double*): this.type = set("verticalPoints", js.Array(value*))
    
    inline def verticalVdomElement(value: VdomElement): this.type = set("vertical", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def xAxis(value: XAxisProps): this.type = set("xAxis", value.asInstanceOf[js.Any])
    
    inline def y(value: Double): this.type = set("y", value.asInstanceOf[js.Any])
    
    inline def yAxis(value: YAxisProps): this.type = set("yAxis", value.asInstanceOf[js.Any])
  }
