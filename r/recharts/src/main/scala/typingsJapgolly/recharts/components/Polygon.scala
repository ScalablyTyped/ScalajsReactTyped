...
object Polygon {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.Polygon] {
    ...
    inline def points(value: js.Array[PolygonPoint]): this.type = set("points", value.asInstanceOf[js.Any])
    
    inline def pointsVarargs(value: PolygonPoint*): this.type = set("points", js.Array(value*))
