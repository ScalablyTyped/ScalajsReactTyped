...
import typingsJapgolly.recharts.mod.PolygonPoint
import typingsJapgolly.recharts.mod.PolygonProps
...
object Polygon {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PolygonProps, typingsJapgolly.recharts.mod.Polygon, Unit, PolygonProps] = {
  ...
  typingsJapgolly.recharts.mod.PolygonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.Polygon](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.PolygonProps])(children: _*)
  }
