...
object Line {
  def apply(
    ...
    label: Boolean | js.Object | Element | ContentRenderer[_] = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[LineProps, typingsJapgolly.recharts.mod.Line, Unit, LineProps] = {
  ...
  typingsJapgolly.recharts.mod.LineProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.Line](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.LineProps])(children: _*)
  }
