...
import typingsJapgolly.recharts.mod.LineChartProps
...
object LineChart {
  ...
  ): UnmountedWithRoot[LineChartProps, typingsJapgolly.recharts.mod.LineChart, Unit, LineChartProps] = {
  ...
  typingsJapgolly.recharts.mod.LineChartProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.recharts.mod.LineChart](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.LineChartProps])
  }
