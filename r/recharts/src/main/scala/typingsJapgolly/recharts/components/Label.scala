...
object Label {
  ...
  ): UnmountedWithRoot[LabelProps, typingsJapgolly.recharts.mod.Label, Unit, LabelProps] = {
  ...
  typingsJapgolly.recharts.mod.LabelProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.recharts.mod.Label](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.LabelProps])
  }
