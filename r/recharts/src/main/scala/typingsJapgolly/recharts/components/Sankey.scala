...
import typingsJapgolly.recharts.anon.Links
...
import typingsJapgolly.recharts.mod.SankeyProps
...
object Sankey {
  ...
  inline def apply(data: Links): Builder = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[SankeyProps]))
  }
  
  @JSImport("recharts", "Sankey")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.Sankey] {
    ...
    inline def link(value: js.Object | ContentRenderer[Any] | Element): this.type = set("link", value.asInstanceOf[js.Any])
    
    inline def linkCurvature(value: Double): this.type = set("linkCurvature", value.asInstanceOf[js.Any])
    
    inline def linkFunction1(value: Any => Node): this.type = set("link", js.Any.fromFunction1(value))
    ...
    inline def node(value: js.Object | ContentRenderer[Any] | Element): this.type = set("node", value.asInstanceOf[js.Any])
    
    inline def nodeFunction1(value: Any => Node): this.type = set("node", js.Any.fromFunction1(value))
    
    inline def nodePadding(value: Double): this.type = set("nodePadding", value.asInstanceOf[js.Any])
    
    inline def nodeVdomElement(value: VdomElement): this.type = set("node", value.rawElement.asInstanceOf[js.Any])
    
    inline def nodeWidth(value: Double): this.type = set("nodeWidth", value.asInstanceOf[js.Any])
  ...
  def withProps(p: SankeyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
