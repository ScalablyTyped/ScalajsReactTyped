...
import typingsJapgolly.recharts.mod.CartesianAxisProps
...
object CartesianAxis {
  def apply(
    ...
    ticksGenerator: /* noTicksProps */ js.Object => CallbackTo[js.Array[js.Any]] = null,
    ...
    CartesianAxisProps, 
    typingsJapgolly.recharts.mod.CartesianAxis, 
    Unit, 
    CartesianAxisProps
  ] = {
    ...
    if (ticksGenerator != null) __obj.updateDynamic("ticksGenerator")(js.Any.fromFunction1((t0: /* noTicksProps */ js.Object) => ticksGenerator(t0).runNow()))
  ...
  typingsJapgolly.recharts.mod.CartesianAxisProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.CartesianAxis](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.CartesianAxisProps])(children: _*)
  }
