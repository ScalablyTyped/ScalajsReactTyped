...
object CartesianAxis {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.CartesianAxis] {
    ...
    inline def orientation(value: top | bottom | left | right): this.type = set("orientation", value.asInstanceOf[js.Any])
    ...
    inline def ticksGenerator(value: /* noTicksProps */ js.Object => js.Array[Any]): this.type = set("ticksGenerator", js.Any.fromFunction1(value))
