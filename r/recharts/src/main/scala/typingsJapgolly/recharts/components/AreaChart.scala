...
object AreaChart {
  ...
  ): UnmountedWithRoot[AreaChartProps, typingsJapgolly.recharts.mod.AreaChart, Unit, AreaChartProps] = {
  ...
  typingsJapgolly.recharts.mod.AreaChartProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.recharts.mod.AreaChart](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.AreaChartProps])
  }
