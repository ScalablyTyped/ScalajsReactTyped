...
object PolarRadiusAxis {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.PolarRadiusAxis] {
    ...
    inline def domain(value: js.Tuple2[PolarRadiusAxisDomain, PolarRadiusAxisDomain]): this.type = set("domain", value.asInstanceOf[js.Any])
    ...
    inline def orientation(value: left | right | middle): this.type = set("orientation", value.asInstanceOf[js.Any])
    ...
    inline def tick(value: Boolean | js.Object | Element | ContentRenderer[Any]): this.type = set("tick", value.asInstanceOf[js.Any])
    ...
    inline def ticks(value: js.Array[PolarRadiusAxisTick]): this.type = set("ticks", value.asInstanceOf[js.Any])
    
    inline def ticksVarargs(value: PolarRadiusAxisTick*): this.type = set("ticks", js.Array(value*))
