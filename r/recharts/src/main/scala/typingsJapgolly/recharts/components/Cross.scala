...
object Cross {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CrossProps, typingsJapgolly.recharts.mod.Cross, Unit, CrossProps] = {
  ...
  typingsJapgolly.recharts.mod.CrossProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.Cross](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.CrossProps])(children: _*)
  }
