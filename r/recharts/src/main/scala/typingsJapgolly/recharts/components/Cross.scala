...
import typingsJapgolly.recharts.mod.CrossProps
...
object Cross {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.Cross] {
  ...
  implicit def make(companion: Cross.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CrossProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
