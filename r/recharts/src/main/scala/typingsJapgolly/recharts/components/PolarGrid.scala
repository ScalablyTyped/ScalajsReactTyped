...
object PolarGrid {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PolarGridProps, typingsJapgolly.recharts.mod.PolarGrid, Unit, PolarGridProps] = {
  ...
  typingsJapgolly.recharts.mod.PolarGridProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.PolarGrid](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.PolarGridProps])(children: _*)
  }
