...
import typingsJapgolly.recharts.mod.PolarGridProps
...
object PolarGrid {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.PolarGrid] {
    ...
    inline def gridType(value: polygon | circle): this.type = set("gridType", value.asInstanceOf[js.Any])
    ...
    inline def polarAngles(value: js.Array[Double]): this.type = set("polarAngles", value.asInstanceOf[js.Any])
    
    inline def polarAnglesVarargs(value: Double*): this.type = set("polarAngles", js.Array(value*))
    
    inline def polarRadius(value: js.Array[Double]): this.type = set("polarRadius", value.asInstanceOf[js.Any])
    
    inline def polarRadiusVarargs(value: Double*): this.type = set("polarRadius", js.Array(value*))
