...
object RadialBar {
  def apply(
    ...
    background: Boolean | Element | ContentRenderer[_] | js.Object = null,
    ...
    label: Boolean | Element | ContentRenderer[_] | js.Object = null,
    ...
    shape: ContentRenderer[_] | Element = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RadialBarProps, typingsJapgolly.recharts.mod.RadialBar, Unit, RadialBarProps] = {
  ...
  typingsJapgolly.recharts.mod.RadialBarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.RadialBar](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.RadialBarProps])(children: _*)
  }
