...
import typingsJapgolly.recharts.mod.RadarPoint
import typingsJapgolly.recharts.mod.RadarProps
...
object Radar {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.Radar] {
    ...
    inline def dot(value: js.Object | Element | ContentRenderer[DotProps] | Boolean): this.type = set("dot", value.asInstanceOf[js.Any])
    
    inline def dotFunction1(value: DotProps => Node): this.type = set("dot", js.Any.fromFunction1(value))
    ...
    inline def label(value: js.Object | Element | ContentRenderer[Any] | Boolean): this.type = set("label", value.asInstanceOf[js.Any])
    ...
    inline def points(value: js.Array[RadarPoint]): this.type = set("points", value.asInstanceOf[js.Any])
    
    inline def pointsVarargs(value: RadarPoint*): this.type = set("points", js.Array(value*))
    
    inline def r(value: Double): this.type = set("r", value.asInstanceOf[js.Any])
    
    inline def shape(value: Element | ContentRenderer[RadarProps]): this.type = set("shape", value.asInstanceOf[js.Any])
    
    inline def shapeFunction1(value: RadarProps => Node): this.type = set("shape", js.Any.fromFunction1(value))
