...
object Radar {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RadarProps, typingsJapgolly.recharts.mod.Radar, Unit, RadarProps] = {
  ...
  typingsJapgolly.recharts.mod.RadarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.Radar](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.RadarProps])(children: _*)
  }
