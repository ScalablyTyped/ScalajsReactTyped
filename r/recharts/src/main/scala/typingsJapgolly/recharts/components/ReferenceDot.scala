...
import typingsJapgolly.recharts.EventAttributesPartialPre
...
object ReferenceDot {
  def apply(
    ...
    label: String | Double | Element | RechartsFunction = null,
    ...
    r: Int | Double = null,
    shape: ContentRenderer[EventAttributesPartialPre] | Element = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ReferenceDotProps, typingsJapgolly.recharts.mod.ReferenceDot, Unit, ReferenceDotProps] = {
  ...
  typingsJapgolly.recharts.mod.ReferenceDotProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.ReferenceDot](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.ReferenceDotProps])(children: _*)
  }
