...
import typingsJapgolly.recharts.anon.EventAttributesPartialPre
import typingsJapgolly.recharts.mod.ContentRenderer
import typingsJapgolly.recharts.mod.IfOverflowType
import typingsJapgolly.recharts.mod.RechartsFunction
import typingsJapgolly.recharts.mod.ReferenceDotAxisConfiguration
import typingsJapgolly.recharts.mod.ReferenceDotProps
...
object ReferenceDot {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.ReferenceDot] {
    
    inline def alignmentBaseline(value: String): this.type = set("alignmentBaseline", value.asInstanceOf[js.Any])
    
    inline def alwaysShow(value: Boolean): this.type = set("alwaysShow", value.asInstanceOf[js.Any])
    ...
    inline def className(value: Double | String): this.type = set("className", value.asInstanceOf[js.Any])
    ...
    inline def ifOverflow(value: IfOverflowType): this.type = set("ifOverflow", value.asInstanceOf[js.Any])
    ...
    inline def isFront(value: Boolean): this.type = set("isFront", value.asInstanceOf[js.Any])
    
    inline def kerning(value: Double | String): this.type = set("kerning", value.asInstanceOf[js.Any])
    
    inline def label(value: String | Double | Element | RechartsFunction): this.type = set("label", value.asInstanceOf[js.Any])
    ...
    inline def shape(value: ContentRenderer[EventAttributesPartialPre] | Element): this.type = set("shape", value.asInstanceOf[js.Any])
    
    inline def shapeFunction1(value: EventAttributesPartialPre => Node): this.type = set("shape", js.Any.fromFunction1(value))
    ...
    inline def xAxis(value: ReferenceDotAxisConfiguration): this.type = set("xAxis", value.asInstanceOf[js.Any])
    ...
    inline def yAxis(value: ReferenceDotAxisConfiguration): this.type = set("yAxis", value.asInstanceOf[js.Any])
    
    inline def yAxisId(value: String | Double): this.type = set("yAxisId", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: ReferenceDot.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ReferenceDotProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
