...
object Rectangle {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RectangleProps, typingsJapgolly.recharts.mod.Rectangle, Unit, RectangleProps] = {
  ...
  typingsJapgolly.recharts.mod.RectangleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.Rectangle](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.RectangleProps])(children: _*)
  }
