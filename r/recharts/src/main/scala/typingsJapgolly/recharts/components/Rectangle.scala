...
object Rectangle {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.Rectangle] {
    ...
    inline def radius(value: Double | js.Array[Any]): this.type = set("radius", value.asInstanceOf[js.Any])
    
    inline def radiusVarargs(value: Any*): this.type = set("radius", js.Array(value*))
