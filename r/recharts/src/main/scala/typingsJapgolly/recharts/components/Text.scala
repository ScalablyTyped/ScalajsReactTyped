...
object Text {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextProps, typingsJapgolly.recharts.mod.Text, Unit, TextProps] = {
  ...
  typingsJapgolly.recharts.mod.TextProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.Text](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.TextProps])(children: _*)
  }
