...
import typingsJapgolly.recharts.mod.TextProps
...
object Text {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.Text] {
    ...
    inline def capHeight(value: String): this.type = set("capHeight", value.asInstanceOf[js.Any])
    ...
    inline def scaleToFit(value: Boolean): this.type = set("scaleToFit", value.asInstanceOf[js.Any])
    ...
    inline def textAnchor(value: start | middle | end | inherit): this.type = set("textAnchor", value.asInstanceOf[js.Any])
    ...
    inline def verticalAnchor(value: start | middle | end): this.type = set("verticalAnchor", value.asInstanceOf[js.Any])
