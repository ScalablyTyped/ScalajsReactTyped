...
import typingsJapgolly.recharts.mod.RectangleProps
import typingsJapgolly.recharts.mod.ReferenceAreaProps
...
object ReferenceArea {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.ReferenceArea] {
    ...
    inline def label(value: String | Double | ContentRenderer[Any] | Element): this.type = set("label", value.asInstanceOf[js.Any])
    ...
    inline def shape(value: (ContentRenderer[ReferenceAreaProps & RectangleProps]) | Element): this.type = set("shape", value.asInstanceOf[js.Any])
    
    inline def shapeFunction1(value: ReferenceAreaProps & RectangleProps => Node): this.type = set("shape", js.Any.fromFunction1(value))
