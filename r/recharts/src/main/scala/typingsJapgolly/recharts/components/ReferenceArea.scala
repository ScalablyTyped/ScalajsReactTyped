...
object ReferenceArea {
  def apply(
    ...
    r: Int | Double = null,
    shape: (ContentRenderer[ReferenceAreaProps with RectangleProps]) | Element = null,
    ...
    ReferenceAreaProps, 
    typingsJapgolly.recharts.mod.ReferenceArea, 
    Unit, 
    ReferenceAreaProps
  ] = {
  ...
  typingsJapgolly.recharts.mod.ReferenceAreaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.ReferenceArea](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.ReferenceAreaProps])(children: _*)
  }
