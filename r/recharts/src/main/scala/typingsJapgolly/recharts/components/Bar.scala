...
object Bar {
  def apply(
    ...
    label: Boolean | typingsJapgolly.recharts.mod.Label | LabelProps | SFC[LabelProps] | Element | ContentRenderer[_] = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BarProps, typingsJapgolly.recharts.mod.Bar, Unit, BarProps] = {
  ...
  typingsJapgolly.recharts.mod.BarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.Bar](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.BarProps])(children: _*)
  }
