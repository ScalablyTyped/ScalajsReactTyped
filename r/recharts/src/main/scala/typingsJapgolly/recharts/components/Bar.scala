...
import typingsJapgolly.recharts.mod.BarData
import typingsJapgolly.recharts.mod.BarProps
...
object Bar {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.Bar] {
    ...
    inline def data(value: js.Array[BarData]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: BarData*): this.type = set("data", js.Array(value*))
    ...
    inline def label(
      value: Boolean | typingsJapgolly.recharts.mod.Label | LabelProps | FC[LabelProps] | Element | ContentRenderer[Any]
    ...
    inline def radius(value: Double | js.Array[Double]): this.type = set("radius", value.asInstanceOf[js.Any])
    
    inline def radiusVarargs(value: Double*): this.type = set("radius", js.Array(value*))
    
    inline def shape(value: Element | ContentRenderer[RectangleProps]): this.type = set("shape", value.asInstanceOf[js.Any])
    
    inline def shapeFunction1(value: RectangleProps => Node): this.type = set("shape", js.Any.fromFunction1(value))
