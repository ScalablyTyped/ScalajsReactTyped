...
import typingsJapgolly.recharts.mod.CellProps
...
object Cell {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CellProps, typingsJapgolly.recharts.mod.Cell, Unit, CellProps] = {
  ...
  typingsJapgolly.recharts.mod.CellProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.Cell](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.CellProps])(children: _*)
  }
