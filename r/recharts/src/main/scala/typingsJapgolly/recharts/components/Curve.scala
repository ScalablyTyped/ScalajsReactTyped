...
import typingsJapgolly.recharts.mod.CurveProps
...
object Curve {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.Curve] {
    ...
    inline def baseLine(value: Double | js.Array[Any]): this.type = set("baseLine", value.asInstanceOf[js.Any])
    
    inline def baseLineVarargs(value: Any*): this.type = set("baseLine", js.Array(value*))
    ...
    inline def pathRef(value: Ref[Any]): this.type = set("pathRef", value.asInstanceOf[js.Any])
    
    inline def pathRefFunction1(value: Any | Null => Callback): this.type = set("pathRef", js.Any.fromFunction1((t0: Any | Null) => value(t0).runNow()))
    
    inline def pathRefNull: this.type = set("pathRef", null)
    
    inline def pointerEvents(value: String): this.type = set("pointerEvents", value.asInstanceOf[js.Any])
    
    inline def points(value: js.Array[js.Object]): this.type = set("points", value.asInstanceOf[js.Any])
    
    inline def pointsVarargs(value: js.Object*): this.type = set("points", js.Array(value*))
