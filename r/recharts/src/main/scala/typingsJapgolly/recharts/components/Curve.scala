...
object Curve {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CurveProps, typingsJapgolly.recharts.mod.Curve, Unit, CurveProps] = {
  ...
  typingsJapgolly.recharts.mod.CurveProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.Curve](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.CurveProps])(children: _*)
  }
