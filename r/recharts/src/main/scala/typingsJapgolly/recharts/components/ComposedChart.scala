...
object ComposedChart {
  def apply(
    ...
    ComposedChartProps, 
    typingsJapgolly.recharts.mod.ComposedChart, 
    Unit, 
    ComposedChartProps
  ] = {
  ...
  typingsJapgolly.recharts.mod.ComposedChartProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.recharts.mod.ComposedChart](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.ComposedChartProps])
  }
