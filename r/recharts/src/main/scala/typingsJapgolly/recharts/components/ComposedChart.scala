...
import typingsJapgolly.recharts.mod.ComposedChartProps
...
object ComposedChart {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.ComposedChart] {
  ...
  implicit def make(companion: ComposedChart.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ComposedChartProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
