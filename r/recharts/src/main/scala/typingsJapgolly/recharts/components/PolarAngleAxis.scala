...
object PolarAngleAxis {
  def apply(
    ...
    PolarAngleAxisProps, 
    typingsJapgolly.recharts.mod.PolarAngleAxis, 
    Unit, 
    PolarAngleAxisProps
  ] = {
  ...
  typingsJapgolly.recharts.mod.PolarAngleAxisProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.PolarAngleAxis](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.PolarAngleAxisProps])(children: _*)
  }
