...
import typingsJapgolly.recharts.mod.Percentage
import typingsJapgolly.recharts.mod.PolarAngleAxisProps
import typingsJapgolly.recharts.mod.PolarAngleAxisTick
...
object PolarAngleAxis {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.PolarAngleAxis] {
    ...
    inline def axisLineType(value: polygon | circle): this.type = set("axisLineType", value.asInstanceOf[js.Any])
    ...
    inline def orientation(value: inner | outer): this.type = set("orientation", value.asInstanceOf[js.Any])
    ...
    inline def radius(value: Percentage | Double): this.type = set("radius", value.asInstanceOf[js.Any])
    ...
    inline def ticks(value: js.Array[PolarAngleAxisTick]): this.type = set("ticks", value.asInstanceOf[js.Any])
    
    inline def ticksVarargs(value: PolarAngleAxisTick*): this.type = set("ticks", js.Array(value*))
