...
import typingsJapgolly.recharts.anon.PartialXPadding
...
object XAxis {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.XAxis] {
    ...
    inline def orientation(value: top | bottom): this.type = set("orientation", value.asInstanceOf[js.Any])
    
    inline def padding(value: PartialXPadding): this.type = set("padding", value.asInstanceOf[js.Any])
