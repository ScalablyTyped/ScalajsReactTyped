...
object Symbols {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SymbolsProps, typingsJapgolly.recharts.mod.Symbols, Unit, SymbolsProps] = {
  ...
  typingsJapgolly.recharts.mod.SymbolsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.Symbols](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.SymbolsProps])(children: _*)
  }
