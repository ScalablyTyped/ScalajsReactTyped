...
import typingsJapgolly.recharts.mod.SymbolsProps
...
import typingsJapgolly.recharts.rechartsStrings.area
...
import typingsJapgolly.recharts.rechartsStrings.diameter
...
object Symbols {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.Symbols] {
    ...
    inline def sizeType(value: area | diameter): this.type = set("sizeType", value.asInstanceOf[js.Any])
    ...
    inline def `type`(value: circle | cross | diamond | square | star | triangle | wye): this.type = set("type", value.asInstanceOf[js.Any])
