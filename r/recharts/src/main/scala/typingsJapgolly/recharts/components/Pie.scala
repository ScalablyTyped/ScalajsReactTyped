...
import typingsJapgolly.recharts.AnonOffsetRadius
...
object Pie {
  def apply(
    ...
    activeShape: js.Object | ContentRenderer[_] | Element = null,
    ...
    label: AnonOffsetRadius | Element | ContentRenderer[PieLabelRenderProps] | Boolean = null,
    labelLine: js.Object | (ContentRenderer[LineProps with js.Any]) | Element | Boolean = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PieProps, typingsJapgolly.recharts.mod.Pie, Unit, PieProps] = {
  ...
  typingsJapgolly.recharts.mod.PieProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.Pie](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.PieProps])(children: _*)
  }
