...
import typingsJapgolly.recharts.anon.OffsetRadius
...
import typingsJapgolly.recharts.mod.PieLabelRenderProps
import typingsJapgolly.recharts.mod.PieProps
...
object Pie {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.Pie] {
    ...
    inline def blendStroke(value: Boolean): this.type = set("blendStroke", value.asInstanceOf[js.Any])
    ...
    inline def label(value: OffsetRadius | Element | ContentRenderer[PieLabelRenderProps] | Boolean): this.type = set("label", value.asInstanceOf[js.Any])
    
    inline def labelFunction1(value: PieLabelRenderProps => Node): this.type = set("label", js.Any.fromFunction1(value))
    
    inline def labelLine(value: js.Object | (ContentRenderer[LineProps & Any]) | Element | Boolean): this.type = set("labelLine", value.asInstanceOf[js.Any])
    
    inline def labelLineFunction1(value: LineProps & Any => Node): this.type = set("labelLine", js.Any.fromFunction1(value))
    
    inline def labelLineVdomElement(value: VdomElement): this.type = set("labelLine", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def maxRadius(value: Double): this.type = set("maxRadius", value.asInstanceOf[js.Any])
    
    inline def midAngle(value: Double): this.type = set("midAngle", value.asInstanceOf[js.Any])
    
    inline def minAngle(value: Double): this.type = set("minAngle", value.asInstanceOf[js.Any])
    
    inline def nameKey(value: String | Double | (js.Function1[/* dataObject */ Any, Double])): this.type = set("nameKey", value.asInstanceOf[js.Any])
    
    inline def nameKeyFunction1(value: /* dataObject */ Any => Double): this.type = set("nameKey", js.Any.fromFunction1(value))
    ...
    inline def paddingAngle(value: Double): this.type = set("paddingAngle", value.asInstanceOf[js.Any])
    ...
    inline def sectors(value: js.Array[js.Object]): this.type = set("sectors", value.asInstanceOf[js.Any])
    
    inline def sectorsVarargs(value: js.Object*): this.type = set("sectors", js.Array(value*))
    ...
    inline def valueKey(value: String | Double | (js.Function1[/* dataObject */ Any, Double])): this.type = set("valueKey", value.asInstanceOf[js.Any])
    
    inline def valueKeyFunction1(value: /* dataObject */ Any => Double): this.type = set("valueKey", js.Any.fromFunction1(value))
