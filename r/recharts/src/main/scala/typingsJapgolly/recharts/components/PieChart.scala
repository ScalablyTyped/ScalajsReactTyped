...
import typingsJapgolly.recharts.mod.PieChartProps
...
object PieChart {
  ...
  ): UnmountedWithRoot[PieChartProps, typingsJapgolly.recharts.mod.PieChart, Unit, PieChartProps] = {
  ...
  typingsJapgolly.recharts.mod.PieChartProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.recharts.mod.PieChart](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.PieChartProps])
  }
