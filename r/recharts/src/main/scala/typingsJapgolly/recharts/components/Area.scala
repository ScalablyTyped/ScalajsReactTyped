...
object Area {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.Area] {
    
    inline def activeDot(value: Boolean | js.Object | Element | ContentRenderer[Any]): this.type = set("activeDot", value.asInstanceOf[js.Any])
    ...
    inline def dot(value: Boolean | js.Object | Element | ContentRenderer[DotPropspayloadany]): this.type = set("dot", value.asInstanceOf[js.Any])
    ...
    inline def label(value: Boolean | js.Object | ContentRenderer[Any] | Element): this.type = set("label", value.asInstanceOf[js.Any])
    ...
    inline def stackId(value: String | Double): this.type = set("stackId", value.asInstanceOf[js.Any])
