...
object Sector {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SectorProps, typingsJapgolly.recharts.mod.Sector, Unit, SectorProps] = {
  ...
  typingsJapgolly.recharts.mod.SectorProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.Sector](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.SectorProps])(children: _*)
  }
