...
object Scatter {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ScatterProps, typingsJapgolly.recharts.mod.Scatter, Unit, ScatterProps] = {
  ...
  typingsJapgolly.recharts.mod.ScatterProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.recharts.mod.Scatter](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.ScatterProps])(children: _*)
  }
