...
import typingsJapgolly.recharts.mod.ScatterPoint
import typingsJapgolly.recharts.mod.ScatterProps
...
object Scatter {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.recharts.mod.Scatter] {
    
    inline def activeIndex(value: Double): this.type = set("activeIndex", value.asInstanceOf[js.Any])
    
    inline def activeShape(value: js.Object | RechartsFunction | Element): this.type = set("activeShape", value.asInstanceOf[js.Any])
    ...
    inline def line(value: Boolean | js.Object | RechartsFunction | Element): this.type = set("line", value.asInstanceOf[js.Any])
    
    inline def lineJointType(value: LineType): this.type = set("lineJointType", value.asInstanceOf[js.Any])
    
    inline def lineJointTypeFunction1(value: /* context */ CanvasRenderingContext2D | Path_ => CurveGenerator): this.type = set("lineJointType", js.Any.fromFunction1(value))
    
    inline def lineType(value: joint | fitting): this.type = set("lineType", value.asInstanceOf[js.Any])
    
    inline def lineVdomElement(value: VdomElement): this.type = set("line", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def points(value: js.Array[ScatterPoint]): this.type = set("points", value.asInstanceOf[js.Any])
    
    inline def pointsVarargs(value: ScatterPoint*): this.type = set("points", js.Array(value*))
    
    inline def r(value: Double): this.type = set("r", value.asInstanceOf[js.Any])
    
    inline def shape(value: circle | cross | diamond | square | star | triangle | wye | Element | ContentRenderer[Any]): this.type = set("shape", value.asInstanceOf[js.Any])
