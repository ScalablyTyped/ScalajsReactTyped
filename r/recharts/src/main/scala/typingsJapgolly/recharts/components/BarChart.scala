...
import typingsJapgolly.recharts.mod.BarChartProps
...
object BarChart {
  ...
  ): UnmountedWithRoot[BarChartProps, typingsJapgolly.recharts.mod.BarChart, Unit, BarChartProps] = {
  ...
  typingsJapgolly.recharts.mod.BarChartProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.recharts.mod.BarChart](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.recharts.mod.BarChartProps])
  }
