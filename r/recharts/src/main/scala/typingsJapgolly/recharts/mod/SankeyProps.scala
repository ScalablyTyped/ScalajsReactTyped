...
trait SankeyProps extends StObject {
  ...
  var link: js.UndefOr[js.Object | ContentRenderer[Any] | Element] = js.undefined
  
  var linkCurvature: js.UndefOr[Double] = js.undefined
  ...
  var node: js.UndefOr[js.Object | ContentRenderer[Any] | Element] = js.undefined
...
object SankeyProps {
  ...
  inline def apply(data: Links): SankeyProps = {
  ...
  extension [Self <: SankeyProps](x: Self) {
    ...
    inline def setData(value: Links): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    inline def setLink(value: js.Object | ContentRenderer[Any] | Element): Self = StObject.set(x, "link", value.asInstanceOf[js.Any])
    
    inline def setLinkCurvature(value: Double): Self = StObject.set(x, "linkCurvature", value.asInstanceOf[js.Any])
    
    inline def setLinkCurvatureUndefined: Self = StObject.set(x, "linkCurvature", js.undefined)
    
    inline def setLinkFunction1(value: Any => Node): Self = StObject.set(x, "link", js.Any.fromFunction1(value))
    ...
    inline def setNode(value: js.Object | ContentRenderer[Any] | Element): Self = StObject.set(x, "node", value.asInstanceOf[js.Any])
    
    inline def setNodeFunction1(value: Any => Node): Self = StObject.set(x, "node", js.Any.fromFunction1(value))
