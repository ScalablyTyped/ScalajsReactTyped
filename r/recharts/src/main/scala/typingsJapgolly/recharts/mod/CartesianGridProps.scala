...
trait CartesianGridProps extends StObject {
  ...
  var horizontal: js.UndefOr[
    js.Object | Element | (ContentRenderer[LineProps & CartesianGridProps]) | Boolean
  ] = js.undefined
...
object CartesianGridProps {
  ...
  extension [Self <: CartesianGridProps](x: Self) {
    ...
    inline def setHorizontal(value: js.Object | Element | (ContentRenderer[LineProps & CartesianGridProps]) | Boolean): Self = StObject.set(x, "horizontal", value.asInstanceOf[js.Any])
    ...
    inline def setHorizontalFunction1(value: LineProps & CartesianGridProps => Node): Self = StObject.set(x, "horizontal", js.Any.fromFunction1(value))
    ...
    inline def setHorizontalVdomElement(value: VdomElement): Self = StObject.set(x, "horizontal", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def setVertical(value: js.Object | Element | (ContentRenderer[LineProps & CartesianGridProps]) | Boolean): Self = StObject.set(x, "vertical", value.asInstanceOf[js.Any])
    ...
    inline def setVerticalFunction1(value: LineProps & CartesianGridProps => Node): Self = StObject.set(x, "vertical", js.Any.fromFunction1(value))
    ...
    inline def setVerticalVdomElement(value: VdomElement): Self = StObject.set(x, "vertical", value.rawElement.asInstanceOf[js.Any])
