...
trait LineProps extends StObject {
  ...
  var dot: js.UndefOr[js.Object | Element | ContentRenderer[DotPropspayloadany] | Boolean] = js.undefined
  ...
  var label: js.UndefOr[Boolean | js.Object | Element | ContentRenderer[Any]] = js.undefined
...
object LineProps {
  ...
  inline def apply(dataKey: DataKey): LineProps = {
  ...
  extension [Self <: LineProps](x: Self) {
    ...
    inline def setDot(value: js.Object | Element | ContentRenderer[DotPropspayloadany] | Boolean): Self = StObject.set(x, "dot", value.asInstanceOf[js.Any])
    ...
    inline def setLabel(value: Boolean | js.Object | Element | ContentRenderer[Any]): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
