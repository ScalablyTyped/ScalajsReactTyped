...
object PolarAngleAxisProps {
  ...
  inline def apply(): PolarAngleAxisProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PolarAngleAxisProps]
  }
  
  extension [Self <: PolarAngleAxisProps](x: Self) {
    ...
    inline def setAxisLineType(value: polygon | circle): Self = StObject.set(x, "axisLineType", value.asInstanceOf[js.Any])
    
    inline def setAxisLineTypeUndefined: Self = StObject.set(x, "axisLineType", js.undefined)
    ...
    inline def setOrientation(value: inner | outer): Self = StObject.set(x, "orientation", value.asInstanceOf[js.Any])
    ...
    inline def setRadius(value: Percentage | Double): Self = StObject.set(x, "radius", value.asInstanceOf[js.Any])
    ...
    inline def setTicks(value: js.Array[PolarAngleAxisTick]): Self = StObject.set(x, "ticks", value.asInstanceOf[js.Any])
