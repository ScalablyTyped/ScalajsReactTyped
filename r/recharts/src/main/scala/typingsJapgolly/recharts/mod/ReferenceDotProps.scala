...
trait ReferenceDotProps extends StObject {
  ...
  var label: js.UndefOr[String | Double | Element | RechartsFunction] = js.undefined
  ...
  var shape: js.UndefOr[ContentRenderer[EventAttributesPartialPre] | Element] = js.undefined
...
object ReferenceDotProps {
  ...
  extension [Self <: ReferenceDotProps](x: Self) {
    ...
    inline def setLabel(value: String | Double | Element | RechartsFunction): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    inline def setShape(value: ContentRenderer[EventAttributesPartialPre] | Element): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    inline def setShapeFunction1(value: EventAttributesPartialPre => Node): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
