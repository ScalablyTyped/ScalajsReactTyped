...
import typingsJapgolly.recharts.anon.EventAttributesPartialPreAlignmentBaseline
...
trait ReferenceLineProps extends StObject {
  ...
  var label: js.UndefOr[String | Double | ContentRenderer[Any] | Element] = js.undefined
  ...
  var shape: js.UndefOr[ContentRenderer[EventAttributesPartialPreAlignmentBaseline] | Element] = js.undefined
...
object ReferenceLineProps {
  ...
  inline def apply(): ReferenceLineProps = {
  ...
  extension [Self <: ReferenceLineProps](x: Self) {
    ...
    inline def setClassName(value: Double | String): Self = StObject.set(x, "className", value.asInstanceOf[js.Any])
    ...
    inline def setIfOverflow(value: IfOverflowType): Self = StObject.set(x, "ifOverflow", value.asInstanceOf[js.Any])
    
    inline def setIfOverflowUndefined: Self = StObject.set(x, "ifOverflow", js.undefined)
    ...
    inline def setIsFront(value: Boolean): Self = StObject.set(x, "isFront", value.asInstanceOf[js.Any])
    
    inline def setIsFrontUndefined: Self = StObject.set(x, "isFront", js.undefined)
    ...
    inline def setLabel(value: String | Double | ContentRenderer[Any] | Element): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    inline def setPosition(value: ReferenceLinePosition): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
    ...
    inline def setSegment(value: js.Tuple2[SegmentItem, SegmentItem]): Self = StObject.set(x, "segment", value.asInstanceOf[js.Any])
    
    inline def setSegmentUndefined: Self = StObject.set(x, "segment", js.undefined)
    
    inline def setShape(value: ContentRenderer[EventAttributesPartialPreAlignmentBaseline] | Element): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    inline def setShapeFunction1(value: EventAttributesPartialPreAlignmentBaseline => Node): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
