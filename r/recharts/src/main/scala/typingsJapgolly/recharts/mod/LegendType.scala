...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.recharts.rechartsStrings.none
  - typingsJapgolly.recharts.rechartsStrings.plainline
  - typingsJapgolly.recharts.rechartsStrings.line
  - typingsJapgolly.recharts.rechartsStrings.square
  - typingsJapgolly.recharts.rechartsStrings.rect
  - typingsJapgolly.recharts.rechartsStrings.circle
  - typingsJapgolly.recharts.rechartsStrings.cross
  - typingsJapgolly.recharts.rechartsStrings.diamond
  - typingsJapgolly.recharts.rechartsStrings.star
...
object LegendType {
  ...
  inline def none: typingsJapgolly.recharts.rechartsStrings.none = "none".asInstanceOf[typingsJapgolly.recharts.rechartsStrings.none]
