...
trait RadialBarProps extends StObject {
  ...
  var label: js.UndefOr[Boolean | Element | ContentRenderer[Any] | js.Object] = js.undefined
  ...
  var shape: js.UndefOr[ContentRenderer[Any] | Element] = js.undefined
...
object RadialBarProps {
  ...
  extension [Self <: RadialBarProps](x: Self) {
    ...
    inline def setLabel(value: Boolean | Element | ContentRenderer[Any] | js.Object): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    inline def setShape(value: ContentRenderer[Any] | Element): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
