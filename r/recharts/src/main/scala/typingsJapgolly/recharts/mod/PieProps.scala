...
trait PieProps extends StObject {
  ...
  var activeShape: js.UndefOr[js.Object | ContentRenderer[Any] | Element] = js.undefined
  ...
  var label: js.UndefOr[OffsetRadius | Element | ContentRenderer[PieLabelRenderProps] | Boolean] = js.undefined
  
  var labelLine: js.UndefOr[js.Object | (ContentRenderer[LineProps & Any]) | Element | Boolean] = js.undefined
...
object PieProps {
  ...
  extension [Self <: PieProps](x: Self) {
    ...
    inline def setActiveShape(value: js.Object | ContentRenderer[Any] | Element): Self = StObject.set(x, "activeShape", value.asInstanceOf[js.Any])
    
    inline def setActiveShapeFunction1(value: Any => Node): Self = StObject.set(x, "activeShape", js.Any.fromFunction1(value))
    ...
    inline def setLabel(value: OffsetRadius | Element | ContentRenderer[PieLabelRenderProps] | Boolean): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    
    inline def setLabelFunction1(value: PieLabelRenderProps => Node): Self = StObject.set(x, "label", js.Any.fromFunction1(value))
    
    inline def setLabelLine(value: js.Object | (ContentRenderer[LineProps & Any]) | Element | Boolean): Self = StObject.set(x, "labelLine", value.asInstanceOf[js.Any])
    
    inline def setLabelLineFunction1(value: LineProps & Any => Node): Self = StObject.set(x, "labelLine", js.Any.fromFunction1(value))
    
    inline def setLabelLineUndefined: Self = StObject.set(x, "labelLine", js.undefined)
    
    inline def setLabelLineVdomElement(value: VdomElement): Self = StObject.set(x, "labelLine", value.rawElement.asInstanceOf[js.Any])
