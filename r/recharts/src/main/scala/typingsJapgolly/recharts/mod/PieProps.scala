...
trait PieProps extends js.Object {
  ...
  var activeShape: js.UndefOr[js.Object | ContentRenderer[_] | Element] = js.undefined
  ...
  var label: js.UndefOr[AnonOffsetRadius | Element | ContentRenderer[PieLabelRenderProps] | Boolean] = js.undefined
  var labelLine: js.UndefOr[js.Object | (ContentRenderer[LineProps with js.Any]) | Element | Boolean] = js.undefined
