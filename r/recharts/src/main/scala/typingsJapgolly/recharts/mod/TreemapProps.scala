...
trait TreemapProps
  ...
  var content: js.UndefOr[Element | ContentRenderer[Any]] = js.undefined
...
object TreemapProps {
  ...
  extension [Self <: TreemapProps](x: Self) {
    ...
    inline def setContent(value: Element | ContentRenderer[Any]): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
    
    inline def setContentFunction1(value: Any => Node): Self = StObject.set(x, "content", js.Any.fromFunction1(value))
