...
trait AreaProps extends StObject {
  ...
  var activeDot: js.UndefOr[Boolean | js.Object | Element | ContentRenderer[Any]] = js.undefined
  ...
  var dot: js.UndefOr[Boolean | js.Object | Element | ContentRenderer[DotPropspayloadany]] = js.undefined
  ...
  var label: js.UndefOr[Boolean | js.Object | ContentRenderer[Any] | Element] = js.undefined
...
object AreaProps {
  ...
  inline def apply(dataKey: DataKey): AreaProps = {
  ...
  extension [Self <: AreaProps](x: Self) {
    ...
    inline def setActiveDot(value: Boolean | js.Object | Element | ContentRenderer[Any]): Self = StObject.set(x, "activeDot", value.asInstanceOf[js.Any])
    ...
    inline def setDot(value: Boolean | js.Object | Element | ContentRenderer[DotPropspayloadany]): Self = StObject.set(x, "dot", value.asInstanceOf[js.Any])
    
    inline def setDotFunction1(value: DotPropspayloadany => Node): Self = StObject.set(x, "dot", js.Any.fromFunction1(value))
    ...
    inline def setLabel(value: Boolean | js.Object | ContentRenderer[Any] | Element): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    inline def setTypeFunction1(value: /* context */ CanvasRenderingContext2D | Path_ => CurveGenerator): Self = StObject.set(x, "type", js.Any.fromFunction1(value))
