...
trait PolarRadiusAxisProps extends StObject {
  ...
  var tick: js.UndefOr[Boolean | js.Object | Element | ContentRenderer[Any]] = js.undefined
...
object PolarRadiusAxisProps {
  ...
  inline def apply(): PolarRadiusAxisProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PolarRadiusAxisProps]
  }
  
  extension [Self <: PolarRadiusAxisProps](x: Self) {
    ...
    inline def setDomain(value: js.Tuple2[PolarRadiusAxisDomain, PolarRadiusAxisDomain]): Self = StObject.set(x, "domain", value.asInstanceOf[js.Any])
    ...
    inline def setOrientation(value: left | right | middle): Self = StObject.set(x, "orientation", value.asInstanceOf[js.Any])
    ...
    inline def setRadiusAxisId(value: String | Double): Self = StObject.set(x, "radiusAxisId", value.asInstanceOf[js.Any])
    ...
    inline def setTick(value: Boolean | js.Object | Element | ContentRenderer[Any]): Self = StObject.set(x, "tick", value.asInstanceOf[js.Any])
    ...
    inline def setTicks(value: js.Array[PolarRadiusAxisTick]): Self = StObject.set(x, "ticks", value.asInstanceOf[js.Any])
