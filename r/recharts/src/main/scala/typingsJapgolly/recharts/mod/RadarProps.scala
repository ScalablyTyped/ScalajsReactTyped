...
trait RadarProps extends js.Object {
  var activeDot: js.UndefOr[js.Object | Element | ContentRenderer[_] | Boolean] = js.undefined
  ...
  var label: js.UndefOr[js.Object | Element | ContentRenderer[_] | Boolean] = js.undefined
...
object RadarProps {
  ...
  def apply(
    dataKey: DataKey,
    activeDot: js.Object | Element | ContentRenderer[_] | Boolean = null,
    ...
    dot: js.Object | Element | ContentRenderer[DotProps] | Boolean = null,
    dx: Int | Double = null,
    dy: Int | Double = null,
    ...
    label: js.Object | Element | ContentRenderer[_] | Boolean = null,
    ...
    r: Int | Double = null,
    shape: Element | ContentRenderer[RadarProps] = null,
