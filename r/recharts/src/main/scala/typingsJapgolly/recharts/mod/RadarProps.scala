...
trait RadarProps extends StObject {
  ...
  var activeDot: js.UndefOr[js.Object | Element | ContentRenderer[Any] | Boolean] = js.undefined
  ...
  var dot: js.UndefOr[js.Object | Element | ContentRenderer[DotProps] | Boolean] = js.undefined
  ...
  var label: js.UndefOr[js.Object | Element | ContentRenderer[Any] | Boolean] = js.undefined
  ...
  var shape: js.UndefOr[Element | ContentRenderer[RadarProps]] = js.undefined
...
object RadarProps {
  ...
  inline def apply(dataKey: DataKey): RadarProps = {
  ...
  extension [Self <: RadarProps](x: Self) {
    ...
    inline def setActiveDot(value: js.Object | Element | ContentRenderer[Any] | Boolean): Self = StObject.set(x, "activeDot", value.asInstanceOf[js.Any])
    
    inline def setActiveDotFunction1(value: Any => Node): Self = StObject.set(x, "activeDot", js.Any.fromFunction1(value))
    
    inline def setActiveDotUndefined: Self = StObject.set(x, "activeDot", js.undefined)
    
    inline def setActiveDotVdomElement(value: VdomElement): Self = StObject.set(x, "activeDot", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def setDot(value: js.Object | Element | ContentRenderer[DotProps] | Boolean): Self = StObject.set(x, "dot", value.asInstanceOf[js.Any])
    
    inline def setDotFunction1(value: DotProps => Node): Self = StObject.set(x, "dot", js.Any.fromFunction1(value))
    ...
    inline def setLabel(value: js.Object | Element | ContentRenderer[Any] | Boolean): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    
    inline def setLabelFunction1(value: Any => Node): Self = StObject.set(x, "label", js.Any.fromFunction1(value))
    ...
    inline def setPoints(value: js.Array[RadarPoint]): Self = StObject.set(x, "points", value.asInstanceOf[js.Any])
    ...
    inline def setShape(value: Element | ContentRenderer[RadarProps]): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    inline def setShapeFunction1(value: RadarProps => Node): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
