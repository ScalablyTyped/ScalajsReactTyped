...
trait SymbolsProps extends StObject {
...
object SymbolsProps {
  ...
  extension [Self <: SymbolsProps](x: Self) {
    ...
    inline def setSizeType(value: area | diameter): Self = StObject.set(x, "sizeType", value.asInstanceOf[js.Any])
    ...
    inline def setType(value: circle | cross | diamond | square | star | triangle | wye): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
