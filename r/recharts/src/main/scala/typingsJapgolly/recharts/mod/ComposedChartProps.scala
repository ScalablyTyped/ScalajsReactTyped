...
- typingsJapgolly.recharts.mod.EventAttributes because var conflicts: onClick, onMouseDown, onMouseEnter, onMouseLeave, onMouseMove, onMouseUp. Inlined onMouseOver, onMouseOut, onTouchEnd, onTouchMove, onTouchStart, onTouchCancel */ trait ComposedChartProps
  extends StObject
...
object ComposedChartProps {
  
  inline def apply(): ComposedChartProps = {
