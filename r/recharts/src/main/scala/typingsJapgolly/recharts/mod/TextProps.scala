...
import typingsJapgolly.recharts.rechartsStrings.end
...
import typingsJapgolly.recharts.rechartsStrings.start
...
object TextProps {
  ...
  extension [Self <: TextProps](x: Self) {
    ...
    inline def setScaleToFit(value: Boolean): Self = StObject.set(x, "scaleToFit", value.asInstanceOf[js.Any])
    
    inline def setScaleToFitUndefined: Self = StObject.set(x, "scaleToFit", js.undefined)
    ...
    inline def setTextAnchor(value: start | middle | end | inherit): Self = StObject.set(x, "textAnchor", value.asInstanceOf[js.Any])
    ...
    inline def setVerticalAnchor(value: start | middle | end): Self = StObject.set(x, "verticalAnchor", value.asInstanceOf[js.Any])
