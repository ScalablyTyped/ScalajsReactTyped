...
object distLibClientCommandsQueueMod {
  ...
  object PubSubSubscribeCommands extends StObject {
    ...
    /* "PSUBSCRIBE" */ val PSUBSCRIBE: typingsJapgolly.redisClient.distLibClientCommandsQueueMod.PubSubSubscribeCommands.PSUBSCRIBE & String = js.native
    
    @js.native
    sealed trait SUBSCRIBE
      extends StObject
         with PubSubSubscribeCommands
    /* "SUBSCRIBE" */ val SUBSCRIBE: typingsJapgolly.redisClient.distLibClientCommandsQueueMod.PubSubSubscribeCommands.SUBSCRIBE & String = js.native
  }
  ...
  object PubSubUnsubscribeCommands extends StObject {
    ...
    /* "PUNSUBSCRIBE" */ val PUNSUBSCRIBE: typingsJapgolly.redisClient.distLibClientCommandsQueueMod.PubSubUnsubscribeCommands.PUNSUBSCRIBE & String = js.native
    
    @js.native
    sealed trait UNSUBSCRIBE
      extends StObject
         with PubSubUnsubscribeCommands
    /* "UNSUBSCRIBE" */ val UNSUBSCRIBE: typingsJapgolly.redisClient.distLibClientCommandsQueueMod.PubSubUnsubscribeCommands.UNSUBSCRIBE & String = js.native
  }
