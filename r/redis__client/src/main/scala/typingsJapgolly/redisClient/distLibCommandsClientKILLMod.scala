...
import typingsJapgolly.redisClient.distLibCommandsClientKILLMod.ClientKillFilters.ADDRESS
import typingsJapgolly.redisClient.distLibCommandsClientKILLMod.ClientKillFilters.ID
import typingsJapgolly.redisClient.distLibCommandsClientKILLMod.ClientKillFilters.LOCAL_ADDRESS
import typingsJapgolly.redisClient.distLibCommandsClientKILLMod.ClientKillFilters.TYPE
import typingsJapgolly.redisClient.distLibCommandsClientKILLMod.ClientKillFilters.USER
import typingsJapgolly.redisClient.distLibCommandsMod.RedisCommandArguments
import typingsJapgolly.redisClient.redisClientStrings.master
import typingsJapgolly.redisClient.redisClientStrings.normal
import typingsJapgolly.redisClient.redisClientStrings.pubsub
import typingsJapgolly.redisClient.redisClientStrings.replica
...
object distLibCommandsClientKILLMod {
  ...
  object ClientKillFilters extends StObject {
    ...
    /* "ADDR" */ val ADDRESS: typingsJapgolly.redisClient.distLibCommandsClientKILLMod.ClientKillFilters.ADDRESS & String = js.native
    
    @js.native
    sealed trait ID
      extends StObject
         with ClientKillFilters
    /* "ID" */ val ID: typingsJapgolly.redisClient.distLibCommandsClientKILLMod.ClientKillFilters.ID & String = js.native
    
    @js.native
    sealed trait LOCAL_ADDRESS
      extends StObject
         with ClientKillFilters
    /* "LADDR" */ val LOCAL_ADDRESS: typingsJapgolly.redisClient.distLibCommandsClientKILLMod.ClientKillFilters.LOCAL_ADDRESS & String = js.native
    ...
    sealed trait SKIP_ME
      extends StObject
         with ClientKillFilters
         with KillSkipMe
    /* "SKIPME" */ val SKIP_ME: typingsJapgolly.redisClient.distLibCommandsClientKILLMod.ClientKillFilters.SKIP_ME & String = js.native
    
    @js.native
    sealed trait TYPE
      extends StObject
         with ClientKillFilters
    /* "TYPE" */ val TYPE: typingsJapgolly.redisClient.distLibCommandsClientKILLMod.ClientKillFilters.TYPE & String = js.native
    
    @js.native
    sealed trait USER
      extends StObject
         with ClientKillFilters
    /* "USER" */ val USER: typingsJapgolly.redisClient.distLibCommandsClientKILLMod.ClientKillFilters.USER & String = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.redisClient.distLibCommandsClientKILLMod.KillAddress
    - typingsJapgolly.redisClient.distLibCommandsClientKILLMod.KillLocalAddress
    - typingsJapgolly.redisClient.distLibCommandsClientKILLMod.KillId
    - typingsJapgolly.redisClient.distLibCommandsClientKILLMod.KillType
    - typingsJapgolly.redisClient.distLibCommandsClientKILLMod.KillUser
    - typingsJapgolly.redisClient.distLibCommandsClientKILLMod.KillSkipMe
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.redisClient.distLibCommandsClientKILLMod.ClientKillFilters.SKIP_ME
    - typingsJapgolly.redisClient.anon.KillFilterSKIPMEskipMeboo
  */
  trait KillSkipMe
    extends StObject
       with KillFilters
