...
object distLibCommandsCommandLISTMod {
  ...
  object FilterBy extends StObject {
    ...
    sealed trait ACLCAT
      extends StObject
         with FilterBy
    /* "ACLCAT" */ val ACLCAT: typingsJapgolly.redisClient.distLibCommandsCommandLISTMod.FilterBy.ACLCAT & String = js.native
    
    @js.native
    sealed trait MODULE
      extends StObject
         with FilterBy
    /* "MODULE" */ val MODULE: typingsJapgolly.redisClient.distLibCommandsCommandLISTMod.FilterBy.MODULE & String = js.native
    
    @js.native
    sealed trait PATTERN
      extends StObject
         with FilterBy
    /* "PATTERN" */ val PATTERN: typingsJapgolly.redisClient.distLibCommandsCommandLISTMod.FilterBy.PATTERN & String = js.native
  }
