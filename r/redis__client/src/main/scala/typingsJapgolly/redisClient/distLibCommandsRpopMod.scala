...
object distLibCommandsRpopMod {
  
  @JSImport("@redis/client/dist/lib/commands/RPOP", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/RPOP", "FIRST_KEY_INDEX")
  @js.native
