...
trait TypeofimportedSMEMBERS extends StObject {
...
object TypeofimportedSMEMBERS {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedSMEMBERS]
  }
  
  extension [Self <: TypeofimportedSMEMBERS](x: Self) {
