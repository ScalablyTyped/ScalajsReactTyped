...
object TypeofCLUSTERMYID {
  ...
  inline def apply(transformArguments: CallbackTo[js.Array[String]], transformReply: CallbackTo[String]): TypeofCLUSTERMYID = {
  ...
  extension [Self <: TypeofCLUSTERMYID](x: Self) {
