...
trait TypeofimportedXGROUPCREFIRSTKEYINDEX extends StObject {
...
object TypeofimportedXGROUPCREFIRSTKEYINDEX {
  ...
  inline def apply(
  ...
  ): TypeofimportedXGROUPCREFIRSTKEYINDEX = {
    ...
    __obj.asInstanceOf[TypeofimportedXGROUPCREFIRSTKEYINDEX]
  }
  
  extension [Self <: TypeofimportedXGROUPCREFIRSTKEYINDEX](x: Self) {
