...
trait TypeofSAVE extends StObject {
...
object TypeofSAVE {
  ...
  inline def apply(transformArguments: CallbackTo[js.Array[String]], transformReply: CallbackTo[RedisCommandArgument]): TypeofSAVE = {
