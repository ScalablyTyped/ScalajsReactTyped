...
trait TypeofimportedPSETEX extends StObject {
...
object TypeofimportedPSETEX {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedPSETEX]
  }
  
  extension [Self <: TypeofimportedPSETEX](x: Self) {
