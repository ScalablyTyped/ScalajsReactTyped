...
trait TypeofZRANDMEMBERCOUNT extends StObject {
...
object TypeofZRANDMEMBERCOUNT {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofZRANDMEMBERCOUNT]
  }
  
  extension [Self <: TypeofZRANDMEMBERCOUNT](x: Self) {
