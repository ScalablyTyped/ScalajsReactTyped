...
trait TypeofimportedPERSIST extends StObject {
...
object TypeofimportedPERSIST {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedPERSIST]
  }
  
  extension [Self <: TypeofimportedPERSIST](x: Self) {
