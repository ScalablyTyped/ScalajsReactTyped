...
trait TypeofimportedLCS extends StObject {
...
object TypeofimportedLCS {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedLCS]
  }
  
  extension [Self <: TypeofimportedLCS](x: Self) {
    ...
    inline def setTransformReply(value: CallbackTo[String | Buffer]): Self = StObject.set(x, "transformReply", value.toJsFn)
  }
}
