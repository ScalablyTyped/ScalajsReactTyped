...
trait TypeofimportedGETSET extends StObject {
...
object TypeofimportedGETSET {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedGETSET]
  }
  
  extension [Self <: TypeofimportedGETSET](x: Self) {
