...
object TypeofimportedHGET {
  ...
  inline def apply(
    ...
    transformReply: CallbackTo[js.UndefOr[RedisCommandArgument]]
  ): TypeofimportedHGET = {
  ...
  extension [Self <: TypeofimportedHGET](x: Self) {
    ...
    inline def setTransformReply(value: CallbackTo[js.UndefOr[RedisCommandArgument]]): Self = StObject.set(x, "transformReply", value.toJsFn)
  }
}
