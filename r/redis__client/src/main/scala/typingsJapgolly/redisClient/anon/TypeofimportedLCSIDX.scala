...
import typingsJapgolly.redisClient.distLibCommandsLcsIDXMod.RawReply
import typingsJapgolly.redisClient.distLibCommandsLcsIDXMod.Reply
...
trait TypeofimportedLCSIDX extends StObject {
...
object TypeofimportedLCSIDX {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedLCSIDX]
  }
  
  extension [Self <: TypeofimportedLCSIDX](x: Self) {
