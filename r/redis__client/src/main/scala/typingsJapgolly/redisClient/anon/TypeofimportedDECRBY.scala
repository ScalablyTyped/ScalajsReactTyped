...
trait TypeofimportedDECRBY extends StObject {
...
object TypeofimportedDECRBY {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedDECRBY]
  }
  
  extension [Self <: TypeofimportedDECRBY](x: Self) {
