...
trait TypeofimportedZLEXCOUNT extends StObject {
...
object TypeofimportedZLEXCOUNT {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedZLEXCOUNT]
  }
  
  extension [Self <: TypeofimportedZLEXCOUNT](x: Self) {
