...
trait TypeofimportedSISMEMBER extends StObject {
...
object TypeofimportedSISMEMBER {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedSISMEMBER]
  }
  
  extension [Self <: TypeofimportedSISMEMBER](x: Self) {
