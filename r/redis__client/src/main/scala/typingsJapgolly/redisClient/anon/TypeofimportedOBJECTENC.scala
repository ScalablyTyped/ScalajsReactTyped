...
trait TypeofimportedOBJECTENC extends StObject {
...
object TypeofimportedOBJECTENC {
  
  inline def apply(
    FIRST_KEY_INDEX: /* 2 */ Double,
    IS_READ_ONLY: /* true */ Boolean,
    transformArguments: RedisCommandArgument => RedisCommandArguments,
    transformReply: CallbackTo[String | Null]
  ): TypeofimportedOBJECTENC = {
    ...
    __obj.asInstanceOf[TypeofimportedOBJECTENC]
  }
  
  extension [Self <: TypeofimportedOBJECTENC](x: Self) {
