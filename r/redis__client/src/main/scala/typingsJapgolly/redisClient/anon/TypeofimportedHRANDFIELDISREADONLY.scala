...
trait TypeofimportedHRANDFIELDISREADONLY extends StObject {
...
object TypeofimportedHRANDFIELDISREADONLY {
  ...
  inline def apply(
  ...
  ): TypeofimportedHRANDFIELDISREADONLY = {
    ...
    __obj.asInstanceOf[TypeofimportedHRANDFIELDISREADONLY]
  }
  
  extension [Self <: TypeofimportedHRANDFIELDISREADONLY](x: Self) {
