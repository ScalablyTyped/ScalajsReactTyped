...
trait TypeofimportedRENAMENX extends StObject {
...
object TypeofimportedRENAMENX {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedRENAMENX]
  }
  
  extension [Self <: TypeofimportedRENAMENX](x: Self) {
