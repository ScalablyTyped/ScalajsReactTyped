...
object distLibCommandsHstrlenMod {
  
  @JSImport("@redis/client/dist/lib/commands/HSTRLEN", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/HSTRLEN", "FIRST_KEY_INDEX")
  @js.native
