...
object distLibCommandsExpiretimeMod {
  
  @JSImport("@redis/client/dist/lib/commands/EXPIRETIME", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/EXPIRETIME", "FIRST_KEY_INDEX")
  @js.native
