...
object distLibCommandsSrandmemberMod {
  
  @JSImport("@redis/client/dist/lib/commands/SRANDMEMBER", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/SRANDMEMBER", "FIRST_KEY_INDEX")
  @js.native
