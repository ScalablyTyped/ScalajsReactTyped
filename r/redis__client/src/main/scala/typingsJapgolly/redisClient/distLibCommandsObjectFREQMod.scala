...
object distLibCommandsObjectFREQMod {
  
  @JSImport("@redis/client/dist/lib/commands/OBJECT_FREQ", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/OBJECT_FREQ", "FIRST_KEY_INDEX")
  @js.native
  val FIRST_KEY_INDEX: /* 2 */ Double = js.native
  
  @JSImport("@redis/client/dist/lib/commands/OBJECT_FREQ", "IS_READ_ONLY")
  @js.native
