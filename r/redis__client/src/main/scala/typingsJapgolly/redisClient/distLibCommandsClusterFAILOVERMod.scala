...
object distLibCommandsClusterFAILOVERMod {
  ...
  object FailoverModes extends StObject {
    ...
    sealed trait FORCE
      extends StObject
         with FailoverModes
    /* "FORCE" */ val FORCE: typingsJapgolly.redisClient.distLibCommandsClusterFAILOVERMod.FailoverModes.FORCE & String = js.native
    
    @js.native
    sealed trait TAKEOVER
      extends StObject
         with FailoverModes
    /* "TAKEOVER" */ val TAKEOVER: typingsJapgolly.redisClient.distLibCommandsClusterFAILOVERMod.FailoverModes.TAKEOVER & String = js.native
  }
