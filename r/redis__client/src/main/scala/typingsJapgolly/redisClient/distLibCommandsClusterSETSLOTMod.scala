...
object distLibCommandsClusterSETSLOTMod {
  ...
  object ClusterSlotStates extends StObject {
    ...
    /* "IMPORTING" */ val IMPORTING: typingsJapgolly.redisClient.distLibCommandsClusterSETSLOTMod.ClusterSlotStates.IMPORTING & String = js.native
    
    @js.native
    sealed trait MIGRATING
      extends StObject
         with ClusterSlotStates
    /* "MIGRATING" */ val MIGRATING: typingsJapgolly.redisClient.distLibCommandsClusterSETSLOTMod.ClusterSlotStates.MIGRATING & String = js.native
    
    @js.native
    sealed trait NODE
      extends StObject
         with ClusterSlotStates
    /* "NODE" */ val NODE: typingsJapgolly.redisClient.distLibCommandsClusterSETSLOTMod.ClusterSlotStates.NODE & String = js.native
    
    @js.native
    sealed trait STABLE
      extends StObject
         with ClusterSlotStates
    /* "STABLE" */ val STABLE: typingsJapgolly.redisClient.distLibCommandsClusterSETSLOTMod.ClusterSlotStates.STABLE & String = js.native
  }
