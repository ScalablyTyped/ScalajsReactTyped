...
object distLibCommandsClientTRACKINGMod {
  ...
  inline def transformArguments_true[M /* <: Boolean */](
    mode: M,
  ...
  ): RedisCommandArguments = (^.asInstanceOf[js.Dynamic].applyDynamic("transformArguments")(mode.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[RedisCommandArguments]
