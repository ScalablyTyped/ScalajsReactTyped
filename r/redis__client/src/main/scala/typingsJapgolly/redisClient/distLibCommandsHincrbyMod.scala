...
object distLibCommandsHincrbyMod {
  
  @JSImport("@redis/client/dist/lib/commands/HINCRBY", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/HINCRBY", "FIRST_KEY_INDEX")
  @js.native
