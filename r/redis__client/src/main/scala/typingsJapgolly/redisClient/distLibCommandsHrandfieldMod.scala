...
object distLibCommandsHrandfieldMod {
  
  @JSImport("@redis/client/dist/lib/commands/HRANDFIELD", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/HRANDFIELD", "FIRST_KEY_INDEX")
  @js.native
  val FIRST_KEY_INDEX: /* 1 */ Double = js.native
  
  @JSImport("@redis/client/dist/lib/commands/HRANDFIELD", "IS_READ_ONLY")
  @js.native
