...
object distLibCommandsPexpiretimeMod {
  
  @JSImport("@redis/client/dist/lib/commands/PEXPIRETIME", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/PEXPIRETIME", "FIRST_KEY_INDEX")
  @js.native
