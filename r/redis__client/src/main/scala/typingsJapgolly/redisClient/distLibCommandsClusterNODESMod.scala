...
import typingsJapgolly.redisClient.anon.From
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distLibCommandsClusterNODESMod {
  ...
  object RedisClusterNodeLinkStates extends StObject {
    ...
    /* "connected" */ val CONNECTED: typingsJapgolly.redisClient.distLibCommandsClusterNODESMod.RedisClusterNodeLinkStates.CONNECTED & String = js.native
    
    @js.native
    sealed trait DISCONNECTED
      extends StObject
         with RedisClusterNodeLinkStates
    /* "disconnected" */ val DISCONNECTED: typingsJapgolly.redisClient.distLibCommandsClusterNODESMod.RedisClusterNodeLinkStates.DISCONNECTED & String = js.native
  }
