...
object distLibCommandsIncrbyMod {
  
  @JSImport("@redis/client/dist/lib/commands/INCRBY", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/INCRBY", "FIRST_KEY_INDEX")
  @js.native
