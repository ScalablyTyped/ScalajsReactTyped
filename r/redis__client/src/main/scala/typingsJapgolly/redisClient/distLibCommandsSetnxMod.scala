...
object distLibCommandsSetnxMod {
  
  @JSImport("@redis/client/dist/lib/commands/SETNX", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/SETNX", "FIRST_KEY_INDEX")
  @js.native
