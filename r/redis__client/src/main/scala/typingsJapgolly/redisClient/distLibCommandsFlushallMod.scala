...
object distLibCommandsFlushallMod {
  ...
  object RedisFlushModes extends StObject {
    ...
    /* "ASYNC" */ val ASYNC: typingsJapgolly.redisClient.distLibCommandsFlushallMod.RedisFlushModes.ASYNC & String = js.native
    
    @js.native
    sealed trait SYNC
      extends StObject
         with RedisFlushModes
    /* "SYNC" */ val SYNC: typingsJapgolly.redisClient.distLibCommandsFlushallMod.RedisFlushModes.SYNC & String = js.native
  }
