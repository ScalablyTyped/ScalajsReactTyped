...
import typingsJapgolly.rcPicker.rcPickerStrings.hideHeader
...
object esPickerMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rcPicker.esPickerMod.PickerBaseProps[DateType]
    - typingsJapgolly.rcPicker.esPickerMod.PickerDateProps[DateType]
    - typingsJapgolly.rcPicker.esPickerMod.PickerTimeProps[DateType]
  */
  trait PickerProps[DateType] extends StObject
  object PickerProps {
    
    inline def PickerBaseProps[DateType](generateConfig: GenerateConfig[DateType], locale: Locale, picker: Exclude[PickerMode, date | time]): typingsJapgolly.rcPicker.esPickerMod.PickerBaseProps[DateType] = {
      val __obj = js.Dynamic.literal(generateConfig = generateConfig.asInstanceOf[js.Any], locale = locale.asInstanceOf[js.Any], picker = picker.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.rcPicker.esPickerMod.PickerBaseProps[DateType]]
    }
    
    inline def PickerDateProps[DateType](generateConfig: GenerateConfig[DateType], locale: Locale): typingsJapgolly.rcPicker.esPickerMod.PickerDateProps[DateType] = {
      val __obj = js.Dynamic.literal(generateConfig = generateConfig.asInstanceOf[js.Any], locale = locale.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.rcPicker.esPickerMod.PickerDateProps[DateType]]
    }
    
    inline def PickerTimeProps[DateType](generateConfig: GenerateConfig[DateType], locale: Locale): typingsJapgolly.rcPicker.esPickerMod.PickerTimeProps[DateType] = {
      ...
      __obj.asInstanceOf[typingsJapgolly.rcPicker.esPickerMod.PickerTimeProps[DateType]]
    }
  }
  ...
  object PickerRefConfig {
    ...
    inline def apply(blur: Callback, focus: Callback): PickerRefConfig = {
