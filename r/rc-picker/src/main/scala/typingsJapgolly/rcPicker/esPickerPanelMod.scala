...
object esPickerPanelMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rcPicker.esPickerPanelMod.PickerPanelBaseProps[DateType]
    - typingsJapgolly.rcPicker.esPickerPanelMod.PickerPanelDateProps[DateType]
    - typingsJapgolly.rcPicker.esPickerPanelMod.PickerPanelTimeProps[DateType]
  */
  trait PickerPanelProps[DateType] extends StObject
  object PickerPanelProps {
    
    inline def PickerPanelBaseProps[DateType](generateConfig: GenerateConfig[DateType], locale: Locale, picker: Exclude[PickerMode, date | time]): typingsJapgolly.rcPicker.esPickerPanelMod.PickerPanelBaseProps[DateType] = {
      val __obj = js.Dynamic.literal(generateConfig = generateConfig.asInstanceOf[js.Any], locale = locale.asInstanceOf[js.Any], picker = picker.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.rcPicker.esPickerPanelMod.PickerPanelBaseProps[DateType]]
    }
    
    inline def PickerPanelDateProps[DateType](generateConfig: GenerateConfig[DateType], locale: Locale): typingsJapgolly.rcPicker.esPickerPanelMod.PickerPanelDateProps[DateType] = {
      val __obj = js.Dynamic.literal(generateConfig = generateConfig.asInstanceOf[js.Any], locale = locale.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.rcPicker.esPickerPanelMod.PickerPanelDateProps[DateType]]
    }
    
    inline def PickerPanelTimeProps[DateType](generateConfig: GenerateConfig[DateType], locale: Locale): typingsJapgolly.rcPicker.esPickerPanelMod.PickerPanelTimeProps[DateType] = {
      ...
      __obj.asInstanceOf[typingsJapgolly.rcPicker.esPickerPanelMod.PickerPanelTimeProps[DateType]]
    }
  }
  ...
  - typingsJapgolly.rcPicker.esPanelsTimePanelMod.SharedTimeProps because var conflicts: defaultValue. Inlined format, showNow, showHour, showMinute, showSecond, use12Hours, hourStep, minuteStep, secondStep, hideDisabledOptions, disabledHours, disabledMinutes, disabledSeconds, disabledTime */ trait PickerPanelTimeProps[DateType]
    extends StObject
       with PickerPanelSharedProps[DateType]
       with PickerPanelProps[DateType] {
