...
@scala.inline
open class SharedBuilder_PickerProps1039078429[R <: js.Object, DateType] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def onChange(value: (/* value */ DateType | Null, /* dateString */ String) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* value */ DateType | Null, t1: /* dateString */ String) => (value(t0, t1)).runNow()))
