...
object esUtilsUiUtilMod {
  ...
  object KeyboardConfig {
    ...
    extension [Self <: KeyboardConfig](x: Self) {
      ...
      inline def setOnCtrlLeftRight(value: /* diff */ Double => Callback): Self = StObject.set(x, "onCtrlLeftRight", js.Any.fromFunction1((t0: /* diff */ Double) => value(t0).runNow()))
      ...
      inline def setOnLeftRight(value: /* diff */ Double => Callback): Self = StObject.set(x, "onLeftRight", js.Any.fromFunction1((t0: /* diff */ Double) => value(t0).runNow()))
      ...
      inline def setOnPageUpDown(value: /* diff */ Double => Callback): Self = StObject.set(x, "onPageUpDown", js.Any.fromFunction1((t0: /* diff */ Double) => value(t0).runNow()))
      ...
      inline def setOnUpDown(value: /* diff */ Double => Callback): Self = StObject.set(x, "onUpDown", js.Any.fromFunction1((t0: /* diff */ Double) => value(t0).runNow()))
