...
import typingsJapgolly.rcPicker.anon.CellDate
import typingsJapgolly.rcPicker.anon.FormatList
import typingsJapgolly.rcPicker.anon.GenerateConfig
...
object esUtilsDateUtilMod {
  ...
  inline def getQuarter[DateType](generateConfig: typingsJapgolly.rcPicker.esGenerateMod.GenerateConfig[DateType], date: DateType): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getQuarter")(generateConfig.asInstanceOf[js.Any], date.asInstanceOf[js.Any])).asInstanceOf[Double]
