...
object esPanelsDecadePanelDecadeBodyMod {
  ...
  object YearBodyProps {
    ...
    inline def apply[DateType](
      ...
      val __obj = js.Dynamic.literal(generateConfig = generateConfig.asInstanceOf[js.Any], onSelect = js.Any.fromFunction1((t0: DateType) => onSelect(t0).runNow()), prefixCls = prefixCls.asInstanceOf[js.Any], viewDate = viewDate.asInstanceOf[js.Any])
