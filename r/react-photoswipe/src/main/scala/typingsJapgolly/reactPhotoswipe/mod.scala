package typingsJapgolly.reactPhotoswipe
...
object mod {
  ...
  object PhotoSwipeGalleryProps {
    ...
    inline def apply(items: js.Array[PhotoSwipeGalleryItem], thumbnailContent: PhotoSwipeGalleryItem => Node): PhotoSwipeGalleryProps = {
    ...
    extension [Self <: PhotoSwipeGalleryProps](x: Self) {
      ...
      inline def setAfterChange(value: /* instance */ PhotoSwipe => Callback): Self = StObject.set(x, "afterChange", js.Any.fromFunction1((t0: /* instance */ PhotoSwipe) => value(t0).runNow()))
      
      inline def setAfterChangeUndefined: Self = StObject.set(x, "afterChange", js.undefined)
      
      inline def setBeforeChange(value: /* instance */ PhotoSwipe => Callback): Self = StObject.set(x, "beforeChange", js.Any.fromFunction1((t0: /* instance */ PhotoSwipe) => value(t0).runNow()))
      ...
      inline def setClose(value: /* instance */ PhotoSwipe => Callback): Self = StObject.set(x, "close", js.Any.fromFunction1((t0: /* instance */ PhotoSwipe) => value(t0).runNow()))
      
      inline def setCloseUndefined: Self = StObject.set(x, "close", js.undefined)
      
      inline def setDestroy(value: /* instance */ PhotoSwipe => Callback): Self = StObject.set(x, "destroy", js.Any.fromFunction1((t0: /* instance */ PhotoSwipe) => value(t0).runNow()))
      
      inline def setDestroyUndefined: Self = StObject.set(x, "destroy", js.undefined)
      
      inline def setGettingData(value: (/* instance */ PhotoSwipe, /* index */ Double, /* item */ Item) => Callback): Self = StObject.set(x, "gettingData", js.Any.fromFunction3((t0: /* instance */ PhotoSwipe, t1: /* index */ Double, t2: /* item */ Item) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setImageLoadComplete(value: (/* instance */ PhotoSwipe, /* index */ Double, /* item */ Item) => Callback): Self = StObject.set(x, "imageLoadComplete", js.Any.fromFunction3((t0: /* instance */ PhotoSwipe, t1: /* index */ Double, t2: /* item */ Item) => (value(t0, t1, t2)).runNow()))
      
      inline def setImageLoadCompleteUndefined: Self = StObject.set(x, "imageLoadComplete", js.undefined)
      
      inline def setInitialZoomIn(value: /* instance */ PhotoSwipe => Callback): Self = StObject.set(x, "initialZoomIn", js.Any.fromFunction1((t0: /* instance */ PhotoSwipe) => value(t0).runNow()))
      
      inline def setInitialZoomInEnd(value: /* instance */ PhotoSwipe => Callback): Self = StObject.set(x, "initialZoomInEnd", js.Any.fromFunction1((t0: /* instance */ PhotoSwipe) => value(t0).runNow()))
      ...
      inline def setInitialZoomOut(value: /* instance */ PhotoSwipe => Callback): Self = StObject.set(x, "initialZoomOut", js.Any.fromFunction1((t0: /* instance */ PhotoSwipe) => value(t0).runNow()))
      
      inline def setInitialZoomOutEnd(value: /* instance */ PhotoSwipe => Callback): Self = StObject.set(x, "initialZoomOutEnd", js.Any.fromFunction1((t0: /* instance */ PhotoSwipe) => value(t0).runNow()))
      ...
      inline def setMouseUsed(value: /* instance */ PhotoSwipe => Callback): Self = StObject.set(x, "mouseUsed", js.Any.fromFunction1((t0: /* instance */ PhotoSwipe) => value(t0).runNow()))
      ...
      inline def setParseVerticalMargin(value: (/* instance */ PhotoSwipe, /* item */ Item) => Callback): Self = StObject.set(x, "parseVerticalMargin", js.Any.fromFunction2((t0: /* instance */ PhotoSwipe, t1: /* item */ Item) => (value(t0, t1)).runNow()))
      ...
      inline def setPreventDragEvent(
        value: (/* instance */ PhotoSwipe, /* e */ MouseEvent, /* isDown */ Boolean, /* preventObj */ Prevent) => Callback
      ): Self = StObject.set(x, "preventDragEvent", js.Any.fromFunction4((t0: /* instance */ PhotoSwipe, t1: /* e */ MouseEvent, t2: /* isDown */ Boolean, t3: /* preventObj */ Prevent) => (value(t0, t1, t2, t3)).runNow()))
      
      inline def setPreventDragEventUndefined: Self = StObject.set(x, "preventDragEvent", js.undefined)
      
      inline def setResize(value: /* instance */ PhotoSwipe => Callback): Self = StObject.set(x, "resize", js.Any.fromFunction1((t0: /* instance */ PhotoSwipe) => value(t0).runNow()))
      
      inline def setResizeUndefined: Self = StObject.set(x, "resize", js.undefined)
      
      inline def setShareLinkClick(value: (/* instance */ PhotoSwipe, /* e */ MouseEvent, /* item */ Item) => Callback): Self = StObject.set(x, "shareLinkClick", js.Any.fromFunction3((t0: /* instance */ PhotoSwipe, t1: /* e */ MouseEvent, t2: /* item */ Item) => (value(t0, t1, t2)).runNow()))
      
      inline def setShareLinkClickUndefined: Self = StObject.set(x, "shareLinkClick", js.undefined)
      
      inline def setThumbnailContent(value: PhotoSwipeGalleryItem => Node): Self = StObject.set(x, "thumbnailContent", js.Any.fromFunction1(value))
      
      inline def setUnbindEvents(value: /* instance */ PhotoSwipe => Callback): Self = StObject.set(x, "unbindEvents", js.Any.fromFunction1((t0: /* instance */ PhotoSwipe) => value(t0).runNow()))
      
      inline def setUnbindEventsUndefined: Self = StObject.set(x, "unbindEvents", js.undefined)
      
      inline def setUpdateScrollOffset(value: (/* instance */ PhotoSwipe, /* _offset */ X) => Callback): Self = StObject.set(x, "updateScrollOffset", js.Any.fromFunction2((t0: /* instance */ PhotoSwipe, t1: /* _offset */ X) => (value(t0, t1)).runNow()))
