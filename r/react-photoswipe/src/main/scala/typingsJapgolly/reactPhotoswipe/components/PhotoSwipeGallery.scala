...
object PhotoSwipeGallery {
  def apply(
    ...
    typingsJapgolly.reactPhotoswipe.mod.PhotoSwipeGallery, 
    Unit, 
    PhotoSwipeGalleryProps
  ] = {
  ...
  typingsJapgolly.reactPhotoswipe.mod.PhotoSwipeGalleryProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactPhotoswipe.mod.PhotoSwipeGallery](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactPhotoswipe.mod.PhotoSwipeGalleryProps])(children: _*)
  }
