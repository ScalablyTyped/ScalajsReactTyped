...
import typingsJapgolly.reactTextMask.AnonIndexesOfPipedChars
import typingsJapgolly.reactTextMask.mod.MaskedInputProps
import typingsJapgolly.reactTextMask.mod.default
import typingsJapgolly.reactTextMask.mod.maskArray
...
object ReactTextMask {
  def apply(
    ...
    pattern: String = null,
    pipe: (/* conformedValue */ String, /* config */ js.Any) => CallbackTo[`false` | String | AnonIndexesOfPipedChars] = null,
    ...
    render: (/* ref */ js.Function1[/* inputElement */ HTMLElement, Unit], /* props */ js.Any) => CallbackTo[js.Any] = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MaskedInputProps, default, Unit, MaskedInputProps] = {
    ...
    if (pipe != null) __obj.updateDynamic("pipe")(js.Any.fromFunction2((t0: /* conformedValue */ java.lang.String, t1: /* config */ js.Any) => pipe(t0, t1).runNow()))
    ...
    if (render != null) __obj.updateDynamic("render")(js.Any.fromFunction2((t0: /* ref */ js.Function1[/* inputElement */ org.scalajs.dom.raw.HTMLElement, scala.Unit], t1: /* props */ js.Any) => render(t0, t1).runNow()))
  ...
  typingsJapgolly.reactTextMask.mod.MaskedInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactTextMask.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactTextMask.mod.MaskedInputProps])(children: _*)
  }
