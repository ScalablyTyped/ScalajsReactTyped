package typingsJapgolly.reactTextMask.components
...
import typingsJapgolly.reactTextMask.anon.DefaultValue
import typingsJapgolly.reactTextMask.anon.IndexesOfPipedChars
import typingsJapgolly.reactTextMask.mod.Mask
import typingsJapgolly.reactTextMask.mod.MaskedInputProps
import typingsJapgolly.reactTextMask.mod.PipeConfig
import typingsJapgolly.reactTextMask.mod.default
import typingsJapgolly.reactTextMask.reactTextMaskBooleans.`false`
...
object ReactTextMask {
  ...
  inline def apply(mask: Mask | (js.Function1[/* value */ String, Mask])): Builder = {
    val __props = js.Dynamic.literal(mask = mask.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[MaskedInputProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def guide(value: Boolean): this.type = set("guide", value.asInstanceOf[js.Any])
    ...
    inline def keepCharPositions(value: Boolean): this.type = set("keepCharPositions", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("pipe", js.Any.fromFunction2(value))
    
    inline def placeholder(value: String): this.type = set("placeholder", value.asInstanceOf[js.Any])
    
    inline def placeholderChar(value: String): this.type = set("placeholderChar", value.asInstanceOf[js.Any])
    ...
    inline def render(
      value: (/* ref */ js.Function1[/* inputElement */ HTMLElement, Unit], /* props */ DefaultValue) => Node
    ...
    inline def showMask(value: Boolean): this.type = set("showMask", value.asInstanceOf[js.Any])
