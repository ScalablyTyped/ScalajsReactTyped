...
object libModalMod {
  ...
  trait ModalProps
    extends StObject
       ...
       with HTMLProps[japgolly.scalajs.react.facade.React.Component[ModalProps & js.Object, js.Object]] {
  ...
  object ModalProps {
    ...
    extension [Self <: ModalProps](x: Self) {
      ...
      inline def setTransition(value: VdomElement): Self = StObject.set(x, "transition", value.rawElement.asInstanceOf[js.Any])
