...
object libUtilsStyleConfigMod {
  ...
  object SIZE_MAP {
    ...
    inline def md_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("md")(x.asInstanceOf[js.Any])
    ...
    inline def xs_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("xs")(x.asInstanceOf[js.Any])
    
    @JSImport("react-bootstrap/lib/utils/StyleConfig", "SIZE_MAP.xsmall")
    @js.native
    def xsmall: String = js.native
    inline def xsmall_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("xsmall")(x.asInstanceOf[js.Any])
  }
  ...
  object State {
    ...
    inline def DANGER_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DANGER")(x.asInstanceOf[js.Any])
  ...
  object Style {
    ...
    inline def INVERSE_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("INVERSE")(x.asInstanceOf[js.Any])
