...
import typingsJapgolly.reactBootstrap.libCarouselItemMod.CarouselItemProps
import typingsJapgolly.reactBootstrap.libCarouselMod.CarouselProps
...
object Carousel {
  ...
  object Caption {
    ...
    implicit def make(companion: Caption.type): SharedBuilder_CarouselCaptionProps_1691608149[typingsJapgolly.reactBootstrap.mod.Carousel.Caption] = new SharedBuilder_CarouselCaptionProps_1691608149[typingsJapgolly.reactBootstrap.mod.Carousel.Caption](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: CarouselCaptionProps): SharedBuilder_CarouselCaptionProps_1691608149[typingsJapgolly.reactBootstrap.mod.Carousel.Caption] = new SharedBuilder_CarouselCaptionProps_1691608149[typingsJapgolly.reactBootstrap.mod.Carousel.Caption](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Item {
    ...
    implicit def make(companion: Item.type): SharedBuilder_CarouselItemProps509952649[typingsJapgolly.reactBootstrap.mod.Carousel.Item] = new SharedBuilder_CarouselItemProps509952649[typingsJapgolly.reactBootstrap.mod.Carousel.Item](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: CarouselItemProps): SharedBuilder_CarouselItemProps509952649[typingsJapgolly.reactBootstrap.mod.Carousel.Item] = new SharedBuilder_CarouselItemProps509952649[typingsJapgolly.reactBootstrap.mod.Carousel.Item](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactBootstrap.mod.Carousel] {
    ...
    inline def indicators(value: Boolean): this.type = set("indicators", value.asInstanceOf[js.Any])
    ...
    inline def intervalNull: this.type = set("interval", null)
    ...
    inline def onSlideEnd(value: js.Function): this.type = set("onSlideEnd", value.asInstanceOf[js.Any])
    ...
    inline def slide(value: Boolean): this.type = set("slide", value.asInstanceOf[js.Any])
