...
import typingsJapgolly.reactBootstrap.dropdownToggleMod.DropdownToggleProps
import typingsJapgolly.reactBootstrap.dropdownToggleMod.^
...
object DropdownToggle {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DropdownToggleProps, ^, Unit, DropdownToggleProps] = {
  ...
  typingsJapgolly.reactBootstrap.dropdownToggleMod.DropdownToggleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactBootstrap.dropdownToggleMod.^](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactBootstrap.dropdownToggleMod.DropdownToggleProps])(children: _*)
  }
