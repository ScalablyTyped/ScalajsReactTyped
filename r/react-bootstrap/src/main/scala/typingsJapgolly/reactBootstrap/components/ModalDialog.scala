...
object ModalDialog {
  def apply(
    AllHTMLAttributes: AllHTMLAttributes[typingsJapgolly.reactBootstrap.modalDialogMod.ModalDialog] = null,
    ClassAttributes: ClassAttributes[typingsJapgolly.reactBootstrap.modalDialogMod.ModalDialog] = null,
    bsClass: String = null,
    bsSize: Sizes = null,
    ...
    ModalDialogProps, 
    typingsJapgolly.reactBootstrap.mod.ModalDialog, 
    Unit, 
    ModalDialogProps
  ] = {
  ...
  typingsJapgolly.reactBootstrap.modalDialogMod.ModalDialogProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactBootstrap.mod.ModalDialog](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactBootstrap.modalDialogMod.ModalDialogProps])(children: _*)
  }
