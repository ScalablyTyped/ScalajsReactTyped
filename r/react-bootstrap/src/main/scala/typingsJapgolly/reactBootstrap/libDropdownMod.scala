...
object libDropdownMod {
  ...
  trait DropdownBaseProps extends StObject {
    ...
    var onToggle: js.UndefOr[
        js.Function3[/* isOpen */ Boolean, /* event */ ReactEventFrom[Element], /* metadata */ Source, Unit]
      ] = js.undefined
  ...
  object DropdownBaseProps {
    ...
    extension [Self <: DropdownBaseProps](x: Self) {
      ...
      ): Self = StObject.set(x, "onToggle", js.Any.fromFunction3((t0: /* isOpen */ Boolean, t1: /* event */ ReactEventFrom[Element], t2: /* metadata */ Source) => (value(t0, t1, t2)).runNow()))
    ...
    extension [Self <: DropdownProps](x: Self) {
      ...
      inline def setOnAbort(
        value: ReactEventFrom[
              (japgolly.scalajs.react.facade.React.Component[DropdownProps & js.Object, js.Object]) & Element
            ] => Callback
