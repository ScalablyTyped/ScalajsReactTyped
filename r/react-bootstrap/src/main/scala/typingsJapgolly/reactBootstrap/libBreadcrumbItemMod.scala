...
object libBreadcrumbItemMod {
  ...
  trait BreadcrumbItemProps extends StObject {
    ...
    var ref: js.UndefOr[
        LegacyRef[
          japgolly.scalajs.react.facade.React.Component[BreadcrumbItemProps & js.Object, js.Object]
        ]
      ] = js.undefined
  ...
  object BreadcrumbItemProps {
    ...
    extension [Self <: BreadcrumbItemProps](x: Self) {
      ...
      inline def setRefFunction1(
        value: (japgolly.scalajs.react.facade.React.Component[BreadcrumbItemProps & js.Object, js.Object]) | Null => Callback
      ): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: (japgolly.scalajs.react.facade.React.Component[BreadcrumbItemProps & js.Object, js.Object]) | Null) => value(t0).runNow()))
