...
@scala.inline
open class SharedBuilder_ReCAPTCHAProps1894066745[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def asyncScriptOnLoad(value: Callback): this.type = set("asyncScriptOnLoad", value.toJsFn)
  ...
  inline def badge(value: Badge): this.type = set("badge", value.asInstanceOf[js.Any])
  ...
  inline def grecaptcha(value: js.Object): this.type = set("grecaptcha", value.asInstanceOf[js.Any])
  ...
  inline def onChange(value: /* token */ String | Null => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* token */ String | Null) => value(t0).runNow()))
  ...
  inline def onErrored(value: Callback): this.type = set("onErrored", value.toJsFn)
  
  inline def onExpired(value: Callback): this.type = set("onExpired", value.toJsFn)
  ...
  inline def stoken(value: String): this.type = set("stoken", value.asInstanceOf[js.Any])
