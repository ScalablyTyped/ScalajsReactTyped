...
object TextValidator {
  def apply(
    ...
    ValidatorComponentProps with TextFieldProps, 
    typingsJapgolly.reactMaterialUiFormValidator.mod.TextValidator, 
    Unit, 
    ValidatorComponentProps with TextFieldProps
  ] = {
  ...
  typingsJapgolly.reactMaterialUiFormValidator.mod.ValidatorComponentProps with typingsJapgolly.materialUi.MaterialUI.TextFieldProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactMaterialUiFormValidator.mod.TextValidator](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactMaterialUiFormValidator.mod.ValidatorComponentProps with typingsJapgolly.materialUi.MaterialUI.TextFieldProps])(children: _*)
  }
