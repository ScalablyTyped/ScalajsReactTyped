...
object FilePlaceholder {
  ...
  @JSImport("react-file-utils/dist/components/FilePlaceholder", "FilePlaceholder")
  @js.native
  ...
  implicit def make(companion: FilePlaceholder.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
