...
@scala.inline
open class SharedBuilder_IconPropsV21827914504[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def `type`(value: IconTypeV2): this.type = set("type", value.asInstanceOf[js.Any])
