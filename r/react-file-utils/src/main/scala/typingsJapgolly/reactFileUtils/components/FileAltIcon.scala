...
object FileAltIcon {
  ...
  @JSImport("react-file-utils/dist/components/FileIcon/FileIconSet/v1", "FileAltIcon")
  @js.native
  ...
  implicit def make(companion: FileAltIcon.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: IconPropsV1): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
