...
object distComponentsImageDropzoneMod {
  ...
  object ImageDropzoneProps {
    ...
    extension [Self <: ImageDropzoneProps](x: Self) {
      ...
      inline def setHandleFiles(value: /* files */ FileList | js.Array[File] => Callback): Self = StObject.set(x, "handleFiles", js.Any.fromFunction1((t0: /* files */ FileList | js.Array[File]) => value(t0).runNow()))
