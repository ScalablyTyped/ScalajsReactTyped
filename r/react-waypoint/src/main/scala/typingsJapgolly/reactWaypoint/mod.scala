package typingsJapgolly.reactWaypoint
...
object mod {
  ...
  object Waypoint {
    ...
    object WaypointProps {
      ...
      extension [Self <: WaypointProps](x: Self) {
        ...
        inline def setOnEnter(value: /* args */ CallbackArgs => Callback): Self = StObject.set(x, "onEnter", js.Any.fromFunction1((t0: /* args */ CallbackArgs) => value(t0).runNow()))
        
        inline def setOnEnterUndefined: Self = StObject.set(x, "onEnter", js.undefined)
        
        inline def setOnLeave(value: /* args */ CallbackArgs => Callback): Self = StObject.set(x, "onLeave", js.Any.fromFunction1((t0: /* args */ CallbackArgs) => value(t0).runNow()))
        
        inline def setOnLeaveUndefined: Self = StObject.set(x, "onLeave", js.undefined)
        
        inline def setOnPositionChange(value: /* args */ CallbackArgs => Callback): Self = StObject.set(x, "onPositionChange", js.Any.fromFunction1((t0: /* args */ CallbackArgs) => value(t0).runNow()))
  ...
  type Waypoint = Component[WaypointProps & js.Object, js.Object]
}
