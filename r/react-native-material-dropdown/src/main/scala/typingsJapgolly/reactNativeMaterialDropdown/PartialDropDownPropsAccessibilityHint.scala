...
object PartialDropDownPropsAccessibilityHint {
  ...
  def apply(
    ...
    label: String = null,
    labelExtractor: (PartialDropDownPropsAccessibilityHint, /* index */ Double) => CallbackTo[String] = null,
    ...
    onChangeText: (/* value */ String, /* index */ Double, /* data */ js.Array[PartialDropDownPropsAccessibilityHint]) => Callback = null,
    ...
    propsExtractor: (PartialDropDownPropsAccessibilityHint, /* index */ Double) => CallbackTo[PartialDropDownPropsAccessibilityElementsHidden] = null,
    ...
    valueExtractor: (PartialDropDownPropsAccessibilityHint, /* index */ Double) => CallbackTo[String] = null
    ...
    if (labelExtractor != null) __obj.updateDynamic("labelExtractor")(js.Any.fromFunction2((t0: typingsJapgolly.reactNativeMaterialDropdown.PartialDropDownPropsAccessibilityHint, t1: /* index */ scala.Double) => labelExtractor(t0, t1).runNow()))
  ...
  typingsJapgolly.reactNativeMaterialDropdown.PartialDropDownPropsAccessibilityHint]) => onChangeText(t0, t1, t2).runNow()))
    ...
    if (propsExtractor != null) __obj.updateDynamic("propsExtractor")(js.Any.fromFunction2((t0: typingsJapgolly.reactNativeMaterialDropdown.PartialDropDownPropsAccessibilityHint, t1: /* index */ scala.Double) => propsExtractor(t0, t1).runNow()))
    ...
    if (valueExtractor != null) __obj.updateDynamic("valueExtractor")(js.Any.fromFunction2((t0: typingsJapgolly.reactNativeMaterialDropdown.PartialDropDownPropsAccessibilityHint, t1: /* index */ scala.Double) => valueExtractor(t0, t1).runNow()))
