...
object PartialDropDownPropsAccessibilityComponentType {
  ...
  def apply(
    ...
    label: String = null,
    labelExtractor: (PartialDropDownPropsAccessibilityComponentType, /* index */ Double) => CallbackTo[String] = null,
    ...
    onChangeText: (/* value */ String, /* index */ Double, /* data */ js.Array[PartialDropDownPropsAccessibilityComponentType]) => Callback = null,
    ...
    propsExtractor: (PartialDropDownPropsAccessibilityComponentType, /* index */ Double) => CallbackTo[Partial[DropDownProps]] = null,
    ...
    valueExtractor: (PartialDropDownPropsAccessibilityComponentType, /* index */ Double) => CallbackTo[String] = null
    ...
    if (labelExtractor != null) __obj.updateDynamic("labelExtractor")(js.Any.fromFunction2((t0: typingsJapgolly.reactNativeMaterialDropdown.PartialDropDownPropsAccessibilityComponentType, t1: /* index */ scala.Double) => labelExtractor(t0, t1).runNow()))
  ...
  typingsJapgolly.reactNativeMaterialDropdown.PartialDropDownPropsAccessibilityComponentType]) => onChangeText(t0, t1, t2).runNow()))
    ...
    if (propsExtractor != null) __obj.updateDynamic("propsExtractor")(js.Any.fromFunction2((t0: typingsJapgolly.reactNativeMaterialDropdown.PartialDropDownPropsAccessibilityComponentType, t1: /* index */ scala.Double) => propsExtractor(t0, t1).runNow()))
    ...
    if (valueExtractor != null) __obj.updateDynamic("valueExtractor")(js.Any.fromFunction2((t0: typingsJapgolly.reactNativeMaterialDropdown.PartialDropDownPropsAccessibilityComponentType, t1: /* index */ scala.Double) => valueExtractor(t0, t1).runNow()))
