...
import typingsJapgolly.reactNativeMaterialDropdown.anon.PartialDropDownProps
...
object mod {
  ...
  trait DropDownProps
    ...
    @JSName("onLayout")
    var onLayout_DropDownProps: js.UndefOr[js.Function1[/* event */ LayoutChangeEvent, Unit]] = js.undefined
