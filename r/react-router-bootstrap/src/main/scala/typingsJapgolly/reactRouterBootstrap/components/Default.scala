...
import typingsJapgolly.reactRouterBootstrap.linkContainerMod.defaultCls
...
object Default {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[NavLinkProps[LocationState], defaultCls, Unit, NavLinkProps[LocationState]] = {
  ...
  typingsJapgolly.reactRouterDom.mod.NavLinkProps[typingsJapgolly.history.mod.LocationState], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactRouterBootstrap.linkContainerMod.defaultCls](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactRouterDom.mod.NavLinkProps[typingsJapgolly.history.mod.LocationState]])(children: _*)
  }
