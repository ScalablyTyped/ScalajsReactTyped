...
import typingsJapgolly.rollup.mod.PluginImpl
...
object mod extends Shortcut {
  ...
  object RPT2Options {
    ...
    extension [Self <: RPT2Options](x: Self) {
      ...
      inline def setSourceMapCallback(value: (/* id */ String, /* map */ String) => Callback): Self = StObject.set(x, "sourceMapCallback", js.Any.fromFunction2((t0: /* id */ String, t1: /* map */ String) => (value(t0, t1)).runNow()))
