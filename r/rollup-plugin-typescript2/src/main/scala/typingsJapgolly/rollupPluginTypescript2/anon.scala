...
import typingsJapgolly.rollupPluginTypescript2.rollupPluginTypescript2Booleans.`false`
import typingsJapgolly.rollupPluginTypescript2.rollupPluginTypescript2Strings.dts
import typingsJapgolly.rollupPluginTypescript2.rollupPluginTypescript2Strings.js_
import typingsJapgolly.rollupPluginTypescript2.rollupPluginTypescript2Strings.quit
...
import typingsJapgolly.typescript.mod.EmitFlags
...
import typingsJapgolly.typescript.mod.GeneratedIdentifierFlags
...
import typingsJapgolly.typescript.mod.LanguageVariant
...
import typingsJapgolly.typescript.mod.TokenFlags
...
object anon {
  ...
  trait TypeoftsTypes extends StObject {
    ...
    var OperationCanceledException: Instantiable0[typingsJapgolly.typescript.mod.OperationCanceledException] = js.native
    ...
    def createLiteral(value: Boolean): PrimaryExpression = js.native
    /** @deprecated Use `factory.createStringLiteral`, `factory.createStringLiteralFromNode`, `factory.createNumericLiteral`, `factory.createBigIntLiteral`, `factory.createTrue`, `factory.createFalse`, or the factory supplied by your transformation context instead. */
    ...
    def createLiteral_BooleanLiteral(value: Boolean): BooleanLiteral = js.native
    /** @deprecated Use `factory.createStringLiteral`, `factory.createStringLiteralFromNode`, `factory.createNumericLiteral`, `factory.createBigIntLiteral`, `factory.createTrue`, `factory.createFalse`, or the factory supplied by your transformation context instead. */
    @JSName("createLiteral")
    ...
    def createTypeOperatorNode(operator: typingsJapgolly.typescript.mod.SyntaxKind.ReadonlyKeyword, `type`: TypeNode): TypeOperatorNode = js.native
    ...
    def escapeLeadingUnderscores(identifier: String): typingsJapgolly.typescript.mod.String = js.native
    ...
    /**
      ...
      */
    def unescapeLeadingUnderscores(identifier: typingsJapgolly.typescript.mod.String): String = js.native
    ...
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](nodes: NodeArray[T]): js.UndefOr[NodeArray[T]] = js.native
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](nodes: NodeArray[T], visitor: Unit, test: js.Function1[/* node */ Node, Boolean]): js.UndefOr[NodeArray[T]] = js.native
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](nodes: NodeArray[T], visitor: Unit, test: js.Function1[/* node */ Node, Boolean], start: Double): js.UndefOr[NodeArray[T]] = js.native
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](
      nodes: NodeArray[T],
      visitor: Unit,
      test: js.Function1[/* node */ Node, Boolean],
      start: Double,
    ...
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](nodes: NodeArray[T], visitor: Unit, test: Unit, start: Double): js.UndefOr[NodeArray[T]] = js.native
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](nodes: NodeArray[T], visitor: Unit, test: Unit, start: Double, count: Double): js.UndefOr[NodeArray[T]] = js.native
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](nodes: NodeArray[T], visitor: Unit, test: Unit, start: Unit, count: Double): js.UndefOr[NodeArray[T]] = js.native
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](nodes: NodeArray[T], visitor: Visitor): js.UndefOr[NodeArray[T]] = js.native
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](nodes: NodeArray[T], visitor: Visitor, test: js.Function1[/* node */ Node, Boolean]): js.UndefOr[NodeArray[T]] = js.native
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](nodes: NodeArray[T], visitor: Visitor, test: js.Function1[/* node */ Node, Boolean], start: Double): js.UndefOr[NodeArray[T]] = js.native
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](
      nodes: NodeArray[T],
      visitor: Visitor,
    ...
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](nodes: NodeArray[T], visitor: Visitor, test: Unit, start: Double): js.UndefOr[NodeArray[T]] = js.native
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](nodes: NodeArray[T], visitor: Visitor, test: Unit, start: Double, count: Double): js.UndefOr[NodeArray[T]] = js.native
    @JSName("visitNodes")
    def visitNodes_T_Union[T /* <: Node */](nodes: NodeArray[T], visitor: Visitor, test: Unit, start: Unit, count: Double): js.UndefOr[NodeArray[T]] = js.native
