...
object TableInspector {
  ...
  implicit def make(companion: TableInspector.type): SharedBuilder_Dictx1508287499 = new SharedBuilder_Dictx1508287499(js.Array(this.component, js.Dictionary.empty))()
