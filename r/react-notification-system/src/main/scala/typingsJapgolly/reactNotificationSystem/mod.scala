package typingsJapgolly.reactNotificationSystem
...
import typingsJapgolly.reactNotificationSystem.reactNotificationSystemStrings.both
import typingsJapgolly.reactNotificationSystem.reactNotificationSystemStrings.br
import typingsJapgolly.reactNotificationSystem.reactNotificationSystemStrings.button
import typingsJapgolly.reactNotificationSystem.reactNotificationSystemStrings.click
import typingsJapgolly.reactNotificationSystem.reactNotificationSystemStrings.error
import typingsJapgolly.reactNotificationSystem.reactNotificationSystemStrings.hide
import typingsJapgolly.reactNotificationSystem.reactNotificationSystemStrings.info
import typingsJapgolly.reactNotificationSystem.reactNotificationSystemStrings.none
...
object mod {
  ...
  object Notification {
    ...
    extension [Self <: Notification](x: Self) {
      ...
      inline def setOnAdd(value: /* notification */ Notification => Callback): Self = StObject.set(x, "onAdd", js.Any.fromFunction1((t0: /* notification */ Notification) => value(t0).runNow()))
      
      inline def setOnAddUndefined: Self = StObject.set(x, "onAdd", js.undefined)
      
      inline def setOnRemove(value: /* notification */ Notification => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction1((t0: /* notification */ Notification) => value(t0).runNow()))
