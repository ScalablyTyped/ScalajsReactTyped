package typingsJapgolly.reactNativeSquareInAppPayments.mod
...
object SQIPApplePay {
  ...
  object ApplePayPaymentType extends StObject {
    ...
    /* 2 */ val PaymentTypeFinal: typingsJapgolly.reactNativeSquareInAppPayments.mod.SQIPApplePay.ApplePayPaymentType.PaymentTypeFinal & Double = js.native
    ...
    sealed trait PaymentTypePending
      extends StObject
         with ApplePayPaymentType
    /* 1 */ val PaymentTypePending: typingsJapgolly.reactNativeSquareInAppPayments.mod.SQIPApplePay.ApplePayPaymentType.PaymentTypePending & Double = js.native
  }
