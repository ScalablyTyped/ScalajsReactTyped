...
object SQIPGooglePay {
  ...
  object GooglePayEnvironment extends StObject {
    ...
    /* 1 */ val EnvironmentProduction: typingsJapgolly.reactNativeSquareInAppPayments.mod.SQIPGooglePay.GooglePayEnvironment.EnvironmentProduction & Double = js.native
    ...
    sealed trait EnvironmentTest
      extends StObject
         with GooglePayEnvironment
    /* 3 */ val EnvironmentTest: typingsJapgolly.reactNativeSquareInAppPayments.mod.SQIPGooglePay.GooglePayEnvironment.EnvironmentTest & Double = js.native
  }
  ...
  object GooglePayPriceStatus extends StObject {
    ...
    /* 2 */ val TotalPriceStatusEstimated: typingsJapgolly.reactNativeSquareInAppPayments.mod.SQIPGooglePay.GooglePayPriceStatus.TotalPriceStatusEstimated & Double = js.native
    ...
    sealed trait TotalPriceStatusFinal
      extends StObject
         with GooglePayPriceStatus
    /* 3 */ val TotalPriceStatusFinal: typingsJapgolly.reactNativeSquareInAppPayments.mod.SQIPGooglePay.GooglePayPriceStatus.TotalPriceStatusFinal & Double = js.native
    ...
    sealed trait TotalPriceStatusNotCurrentlyKnown
      extends StObject
         with GooglePayPriceStatus
    /* 1 */ val TotalPriceStatusNotCurrentlyKnown: typingsJapgolly.reactNativeSquareInAppPayments.mod.SQIPGooglePay.GooglePayPriceStatus.TotalPriceStatusNotCurrentlyKnown & Double = js.native
  }
