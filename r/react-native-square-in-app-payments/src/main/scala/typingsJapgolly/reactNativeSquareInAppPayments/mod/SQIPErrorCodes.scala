...
object SQIPErrorCodes extends StObject {
  ...
  sealed trait CANCELED
    extends StObject
       with SQIPErrorCodes
  /* "canceled" */ val CANCELED: typingsJapgolly.reactNativeSquareInAppPayments.mod.SQIPErrorCodes.CANCELED & String = js.native
  ...
  sealed trait FAILED
    extends StObject
       with SQIPErrorCodes
  /* "failed" */ val FAILED: typingsJapgolly.reactNativeSquareInAppPayments.mod.SQIPErrorCodes.FAILED & String = js.native
  ...
  sealed trait NO_NETWORK
    extends StObject
       with SQIPErrorCodes
  /* "noNetwork" */ val NO_NETWORK: typingsJapgolly.reactNativeSquareInAppPayments.mod.SQIPErrorCodes.NO_NETWORK & String = js.native
  ...
  sealed trait UNSUPPORTED_SDK_VERSION
    extends StObject
       with SQIPErrorCodes
  /* "unsupportedSDKVersion" */ val UNSUPPORTED_SDK_VERSION: typingsJapgolly.reactNativeSquareInAppPayments.mod.SQIPErrorCodes.UNSUPPORTED_SDK_VERSION & String = js.native
  ...
  sealed trait USAGE_ERROR
    extends StObject
       with SQIPErrorCodes
  /* "usageError" */ val USAGE_ERROR: typingsJapgolly.reactNativeSquareInAppPayments.mod.SQIPErrorCodes.USAGE_ERROR & String = js.native
}
