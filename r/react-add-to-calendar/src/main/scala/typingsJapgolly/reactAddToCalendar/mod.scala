...
object mod extends Shortcut {
  ...
  open class default protected ()
    extends Component[AddToCalendarProps, js.Object, Any] {
    def this(props: AddToCalendarProps) = this()
    def this(props: AddToCalendarProps, context: Any) = this()
  }
  @JSImport("react-add-to-calendar", JSImport.Default)
  @js.native
  val default: ComponentClassP[AddToCalendarProps & js.Object] = js.native
  ...
  type _To = ComponentClassP[AddToCalendarProps & js.Object]
  
  /* This means you don't have to write `default`, but can instead just say `mod.foo` */
  override def _to: ComponentClassP[AddToCalendarProps & js.Object] = default
}
