package typingsJapgolly.reactSpeechRecognition
...
object anon {
  ...
  object BrowserSupportsSpeechRecognition {
    ...
    extension [Self <: BrowserSupportsSpeechRecognition](x: Self) {
      ...
      inline def setResetTranscript(value: Callback): Self = StObject.set(x, "resetTranscript", value.toJsFn)
