...
object anon {
  ...
  object Delete {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(_store = _store.asInstanceOf[js.Any], delete = js.Any.fromFunction1((t0: String) => delete(t0).runNow()), get = js.Any.fromFunction1(get), has = js.Any.fromFunction1(has), set = js.Any.fromFunction2(set), size = size.asInstanceOf[js.Any])
