package typingsJapgolly.reactTextMarquee.components
...
import typingsJapgolly.reactTextMarquee.mod.MarqueeProps
import typingsJapgolly.reactTextMarquee.mod.default
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ReactTextMarquee {
  
  inline def apply(text: String): Builder = {
    val __props = js.Dynamic.literal(text = text.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[MarqueeProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def hoverToStop(value: Boolean): this.type = set("hoverToStop", value.asInstanceOf[js.Any])
