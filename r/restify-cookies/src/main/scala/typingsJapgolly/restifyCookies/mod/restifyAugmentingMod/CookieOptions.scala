package typingsJapgolly.restifyCookies.mod.restifyAugmentingMod
...
object CookieOptions {
  ...
  def apply(
    domain: String = null,
    encode: /* input */ String => CallbackTo[String] = null,
    ...
    if (encode != null) __obj.updateDynamic("encode")(js.Any.fromFunction1((t0: /* input */ java.lang.String) => encode(t0).runNow()))
