package typingsJapgolly.regenerate
...
object mod {
  ...
  /**
    ...
    */
  inline def apply(values: RegenerateArgValueOrArray*): typingsJapgolly.regenerate.mod.regenerate = ^.asInstanceOf[js.Dynamic].apply(values.asInstanceOf[Seq[js.Any]]*).asInstanceOf[typingsJapgolly.regenerate.mod.regenerate]
  
  @JSImport("regenerate", JSImport.Namespace)
  @js.native
  open class ^ protected ()
    extends StObject
       with typingsJapgolly.regenerate.mod.regenerate {
  ...
  type RegenerateArgValue = String | Double | typingsJapgolly.regenerate.mod.regenerate
  ...
  trait regenerate extends StObject {
    ...
    /**
      ...
      */
    def intersection(argument: typingsJapgolly.regenerate.mod.regenerate): this.type = js.native
