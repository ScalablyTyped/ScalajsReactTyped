...
import typingsJapgolly.reactNativeSortableGrid.anon.DeleteModeOn
...
object mod {
  ...
  object SortableGridItemProps {
    ...
    extension [Self <: SortableGridItemProps](x: Self) {
      ...
      inline def setOnDoubleTap(value: Callback): Self = StObject.set(x, "onDoubleTap", value.toJsFn)
  ...
  object SortableGridProps {
    ...
    extension [Self <: SortableGridProps](x: Self) {
      ...
      inline def setOnDeleteItem(value: /* deletedItem */ OrderedItem => Callback): Self = StObject.set(x, "onDeleteItem", js.Any.fromFunction1((t0: /* deletedItem */ OrderedItem) => value(t0).runNow()))
      
      inline def setOnDeleteItemUndefined: Self = StObject.set(x, "onDeleteItem", js.undefined)
      
      inline def setOnDragRelease(value: /* itemOrder */ ItemOrder => Callback): Self = StObject.set(x, "onDragRelease", js.Any.fromFunction1((t0: /* itemOrder */ ItemOrder) => value(t0).runNow()))
      
      inline def setOnDragReleaseUndefined: Self = StObject.set(x, "onDragRelease", js.undefined)
      
      inline def setOnDragStart(value: /* item */ OrderedItem => Callback): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1((t0: /* item */ OrderedItem) => value(t0).runNow()))
