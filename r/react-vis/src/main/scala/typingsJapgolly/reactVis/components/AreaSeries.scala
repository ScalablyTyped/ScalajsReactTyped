...
import typingsJapgolly.reactVis.mod.AreaSeriesPoint
import typingsJapgolly.reactVis.mod.AreaSeriesProps
...
object AreaSeries {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.AreaSeries] {
    ...
    inline def data(value: js.Array[AreaSeriesPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (AreaSeriesPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    
    inline def fill(value: String | Double): this.type = set("fill", value.asInstanceOf[js.Any])
    
    inline def getColor(
      value: AreaSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any
    ...
    inline def getNull(value: AreaSeriesPoint => Any): this.type = set("getNull", js.Any.fromFunction1(value))
    ...
    inline def onNearestX(value: (AreaSeriesPoint, /* data */ RVNearestXData[AreaSeriesPoint]) => Callback): this.type = set("onNearestX", js.Any.fromFunction2((t0: AreaSeriesPoint, t1: /* data */ RVNearestXData[AreaSeriesPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(value: (AreaSeriesPoint, /* data */ RVNearestXYData[AreaSeriesPoint]) => Callback): this.type = set("onNearestXY", js.Any.fromFunction2((t0: AreaSeriesPoint, t1: /* data */ RVNearestXYData[AreaSeriesPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (AreaSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: AreaSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (AreaSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: AreaSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (AreaSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: AreaSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (AreaSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: AreaSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
  ...
  implicit def make(companion: AreaSeries.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AreaSeriesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
