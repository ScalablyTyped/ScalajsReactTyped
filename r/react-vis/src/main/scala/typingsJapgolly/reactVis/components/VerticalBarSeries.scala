...
import typingsJapgolly.reactVis.mod.VerticalBarSeriesPoint
import typingsJapgolly.reactVis.mod.VerticalBarSeriesProps
...
object VerticalBarSeries {
  ...
  inline def apply(barWidth: Double): Builder = {
    val __props = js.Dynamic.literal(barWidth = barWidth.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[VerticalBarSeriesProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.VerticalBarSeries] {
    ...
    inline def data(value: js.Array[VerticalBarSeriesPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (VerticalBarSeriesPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    
    inline def fill(value: String | Double): this.type = set("fill", value.asInstanceOf[js.Any])
    
    inline def getColor(
      value: VerticalBarSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any
    ...
    inline def onNearestX(value: (VerticalBarSeriesPoint, /* data */ RVNearestXData[VerticalBarSeriesPoint]) => Callback): this.type = set("onNearestX", js.Any.fromFunction2((t0: VerticalBarSeriesPoint, t1: /* data */ RVNearestXData[VerticalBarSeriesPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(value: (VerticalBarSeriesPoint, /* data */ RVNearestXYData[VerticalBarSeriesPoint]) => Callback): this.type = set("onNearestXY", js.Any.fromFunction2((t0: VerticalBarSeriesPoint, t1: /* data */ RVNearestXYData[VerticalBarSeriesPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (VerticalBarSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: VerticalBarSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (VerticalBarSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: VerticalBarSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (VerticalBarSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: VerticalBarSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (VerticalBarSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: VerticalBarSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
  ...
  def withProps(p: VerticalBarSeriesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
