...
import typingsJapgolly.reactVis.mod.DecorativeAxisPoint
import typingsJapgolly.reactVis.mod.DecorativeAxisProps
...
object DecorativeAxis {
  
  inline def apply(axisDomain: js.Array[Double], axisEnd: Y, axisStart: Y): Builder = {
    val __props = js.Dynamic.literal(axisDomain = axisDomain.asInstanceOf[js.Any], axisEnd = axisEnd.asInstanceOf[js.Any], axisStart = axisStart.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[DecorativeAxisProps]))
  }
  
  @JSImport("react-vis", "DecorativeAxis")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.DecorativeAxis] {
    ...
    inline def data(value: js.Array[DecorativeAxisPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (DecorativeAxisPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    
    inline def fill(value: String | Double): this.type = set("fill", value.asInstanceOf[js.Any])
    
    inline def getColor(
      value: DecorativeAxisPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any
    ...
    inline def onNearestX(value: (DecorativeAxisPoint, /* data */ RVNearestXData[DecorativeAxisPoint]) => Callback): this.type = set("onNearestX", js.Any.fromFunction2((t0: DecorativeAxisPoint, t1: /* data */ RVNearestXData[DecorativeAxisPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(value: (DecorativeAxisPoint, /* data */ RVNearestXYData[DecorativeAxisPoint]) => Callback): this.type = set("onNearestXY", js.Any.fromFunction2((t0: DecorativeAxisPoint, t1: /* data */ RVNearestXYData[DecorativeAxisPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (DecorativeAxisPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: DecorativeAxisPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (DecorativeAxisPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: DecorativeAxisPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (DecorativeAxisPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: DecorativeAxisPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (DecorativeAxisPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: DecorativeAxisPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    ...
    inline def tickValue(value: /* x */ Any => String | Double): this.type = set("tickValue", js.Any.fromFunction1(value))
  ...
  def withProps(p: DecorativeAxisProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
