...
import typingsJapgolly.reactVis.mod.LineSeriesCanvasProps
...
object LineSeriesCanvas {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.LineSeriesCanvas] {
  ...
  implicit def make(companion: LineSeriesCanvas.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LineSeriesCanvasProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
