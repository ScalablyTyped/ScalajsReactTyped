...
object HorizontalRectSeries {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.HorizontalRectSeries] {
  ...
  implicit def make(companion: HorizontalRectSeries.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
