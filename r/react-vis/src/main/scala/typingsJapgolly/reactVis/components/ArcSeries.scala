...
import typingsJapgolly.reactVis.anon.X
import typingsJapgolly.reactVis.mod.AnimationParam
import typingsJapgolly.reactVis.mod.ArcSeriesPoint
import typingsJapgolly.reactVis.mod.ArcSeriesProps
...
object ArcSeries {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.ArcSeries] {
    
    inline def _angleValue(
    ...
    inline def angleBaseValue(value: Double): this.type = set("angleBaseValue", value.asInstanceOf[js.Any])
    
    inline def angleDistance(value: Double): this.type = set("angleDistance", value.asInstanceOf[js.Any])
    
    inline def angleDomain(value: js.Array[Double]): this.type = set("angleDomain", value.asInstanceOf[js.Any])
    
    inline def angleDomainVarargs(value: Double*): this.type = set("angleDomain", js.Array(value*))
    
    inline def angleRange(value: js.Array[Double]): this.type = set("angleRange", value.asInstanceOf[js.Any])
    
    inline def angleRangeVarargs(value: Double*): this.type = set("angleRange", js.Array(value*))
    
    inline def angleType(value: Scale): this.type = set("angleType", value.asInstanceOf[js.Any])
    
    inline def animation(value: String | AnimationParam | Boolean): this.type = set("animation", value.asInstanceOf[js.Any])
    
    inline def arcClassName(value: String): this.type = set("arcClassName", value.asInstanceOf[js.Any])
    ...
    inline def data(value: js.Array[ArcSeriesPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (ArcSeriesPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    ...
    inline def onNearestX(value: (ArcSeriesPoint, /* data */ RVNearestXData[ArcSeriesPoint]) => Callback): this.type = set("onNearestX", js.Any.fromFunction2((t0: ArcSeriesPoint, t1: /* data */ RVNearestXData[ArcSeriesPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(value: (ArcSeriesPoint, /* data */ RVNearestXYData[ArcSeriesPoint]) => Callback): this.type = set("onNearestXY", js.Any.fromFunction2((t0: ArcSeriesPoint, t1: /* data */ RVNearestXYData[ArcSeriesPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (ArcSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: ArcSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (ArcSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: ArcSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (ArcSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: ArcSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (ArcSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: ArcSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    ...
    inline def radiusBaseValue(value: Double): this.type = set("radiusBaseValue", value.asInstanceOf[js.Any])
    
    inline def radiusDistance(value: Double): this.type = set("radiusDistance", value.asInstanceOf[js.Any])
    
    inline def radiusDomain(value: js.Array[Double]): this.type = set("radiusDomain", value.asInstanceOf[js.Any])
    
    inline def radiusDomainVarargs(value: Double*): this.type = set("radiusDomain", js.Array(value*))
    
    inline def radiusRange(value: js.Array[Double]): this.type = set("radiusRange", value.asInstanceOf[js.Any])
    
    inline def radiusRangeVarargs(value: Double*): this.type = set("radiusRange", js.Array(value*))
    
    inline def radiusType(value: Scale): this.type = set("radiusType", value.asInstanceOf[js.Any])
