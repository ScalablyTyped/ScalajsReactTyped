...
import typingsJapgolly.reactVis.mod.WhiskerSeriesPoint
import typingsJapgolly.reactVis.mod.WhiskerSeriesProps
...
object WhiskerSeries {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.WhiskerSeries] {
    ...
    inline def data(value: js.Array[WhiskerSeriesPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (WhiskerSeriesPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    ...
    inline def onNearestX(value: (WhiskerSeriesPoint, /* data */ RVNearestXData[WhiskerSeriesPoint]) => Callback): this.type = set("onNearestX", js.Any.fromFunction2((t0: WhiskerSeriesPoint, t1: /* data */ RVNearestXData[WhiskerSeriesPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(value: (WhiskerSeriesPoint, /* data */ RVNearestXYData[WhiskerSeriesPoint]) => Callback): this.type = set("onNearestXY", js.Any.fromFunction2((t0: WhiskerSeriesPoint, t1: /* data */ RVNearestXYData[WhiskerSeriesPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (WhiskerSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: WhiskerSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (WhiskerSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: WhiskerSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (WhiskerSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: WhiskerSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (WhiskerSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: WhiskerSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
