...
import typingsJapgolly.reactVis.mod.ContourSeriesProps
...
object ContourSeries {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.ContourSeries] {
    ...
    inline def bandwidth(value: Double): this.type = set("bandwidth", value.asInstanceOf[js.Any])
