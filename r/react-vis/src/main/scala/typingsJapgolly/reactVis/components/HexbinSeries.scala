...
import typingsJapgolly.reactVis.mod.ContourSeriesPoint
import typingsJapgolly.reactVis.mod.HexbinSeriesProps
...
object HexbinSeries {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.HexbinSeries] {
    ...
    inline def data(value: js.Array[ContourSeriesPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (ContourSeriesPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    
    inline def fill(value: String | Double): this.type = set("fill", value.asInstanceOf[js.Any])
    
    inline def getColor(
      value: ContourSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any
    ...
    inline def onNearestX(value: (ContourSeriesPoint, /* data */ RVNearestXData[ContourSeriesPoint]) => Callback): this.type = set("onNearestX", js.Any.fromFunction2((t0: ContourSeriesPoint, t1: /* data */ RVNearestXData[ContourSeriesPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(value: (ContourSeriesPoint, /* data */ RVNearestXYData[ContourSeriesPoint]) => Callback): this.type = set("onNearestXY", js.Any.fromFunction2((t0: ContourSeriesPoint, t1: /* data */ RVNearestXYData[ContourSeriesPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (ContourSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: ContourSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (ContourSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: ContourSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (ContourSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: ContourSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (ContourSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: ContourSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    ...
    inline def sizeHexagonsWithCount(value: Boolean): this.type = set("sizeHexagonsWithCount", value.asInstanceOf[js.Any])
    ...
    inline def yOffset(value: Double): this.type = set("yOffset", value.asInstanceOf[js.Any])
