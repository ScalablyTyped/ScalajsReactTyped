...
import typingsJapgolly.reactVis.mod.HeatmapSeriesPoint
...
object HeatmapSeries {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.HeatmapSeries] {
    ...
    inline def data(value: js.Array[HeatmapSeriesPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (HeatmapSeriesPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    ...
    inline def onNearestX(value: (HeatmapSeriesPoint, /* data */ RVNearestXData[HeatmapSeriesPoint]) => Callback): this.type = set("onNearestX", js.Any.fromFunction2((t0: HeatmapSeriesPoint, t1: /* data */ RVNearestXData[HeatmapSeriesPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(value: (HeatmapSeriesPoint, /* data */ RVNearestXYData[HeatmapSeriesPoint]) => Callback): this.type = set("onNearestXY", js.Any.fromFunction2((t0: HeatmapSeriesPoint, t1: /* data */ RVNearestXYData[HeatmapSeriesPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (HeatmapSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: HeatmapSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (HeatmapSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: HeatmapSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (HeatmapSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: HeatmapSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (HeatmapSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: HeatmapSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
