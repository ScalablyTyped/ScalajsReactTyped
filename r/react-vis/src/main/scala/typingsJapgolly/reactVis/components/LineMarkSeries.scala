...
import typingsJapgolly.reactVis.mod.LineMarkSeriesProps
...
object LineMarkSeries {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.LineMarkSeries] {
    ...
    inline def getNull(value: LineMarkSeriesPoint => Any): this.type = set("getNull", js.Any.fromFunction1(value))
    ...
    inline def lineStyle(value: CSSProperties): this.type = set("lineStyle", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: LineMarkSeries.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LineMarkSeriesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
