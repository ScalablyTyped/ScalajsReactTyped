...
import typingsJapgolly.reactVis.mod.CustomSVGSeriesPoint
import typingsJapgolly.reactVis.mod.CustomSVGSeriesProps
...
object CustomSVGSeries {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.CustomSVGSeries] {
    ...
    inline def customComponent(value: String | (js.Function1[/* row */ Any, Any])): this.type = set("customComponent", value.asInstanceOf[js.Any])
    
    inline def customComponentFunction1(value: /* row */ Any => Any): this.type = set("customComponent", js.Any.fromFunction1(value))
    
    inline def data(value: js.Array[CustomSVGSeriesPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (CustomSVGSeriesPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    ...
    inline def onNearestX(value: (CustomSVGSeriesPoint, /* data */ RVNearestXData[CustomSVGSeriesPoint]) => Callback): this.type = set("onNearestX", js.Any.fromFunction2((t0: CustomSVGSeriesPoint, t1: /* data */ RVNearestXData[CustomSVGSeriesPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(value: (CustomSVGSeriesPoint, /* data */ RVNearestXYData[CustomSVGSeriesPoint]) => Callback): this.type = set("onNearestXY", js.Any.fromFunction2((t0: CustomSVGSeriesPoint, t1: /* data */ RVNearestXYData[CustomSVGSeriesPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (CustomSVGSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: CustomSVGSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (CustomSVGSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: CustomSVGSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (CustomSVGSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: CustomSVGSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (CustomSVGSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: CustomSVGSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
