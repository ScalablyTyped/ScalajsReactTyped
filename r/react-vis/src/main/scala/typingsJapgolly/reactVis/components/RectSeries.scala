...
import typingsJapgolly.reactVis.mod.RectSeriesProps
...
object RectSeries {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.RectSeries] {
    ...
    inline def linePosAttr(value: String): this.type = set("linePosAttr", value.asInstanceOf[js.Any])
    
    inline def lineSizeAttr(value: String): this.type = set("lineSizeAttr", value.asInstanceOf[js.Any])
    ...
    inline def valuePosAttr(value: String): this.type = set("valuePosAttr", value.asInstanceOf[js.Any])
    
    inline def valueSizeAttr(value: String): this.type = set("valueSizeAttr", value.asInstanceOf[js.Any])
