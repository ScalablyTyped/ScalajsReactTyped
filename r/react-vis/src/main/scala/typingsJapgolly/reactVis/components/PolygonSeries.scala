...
import typingsJapgolly.reactVis.mod.PolygonSeriesPoint
...
object PolygonSeries {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.PolygonSeries] {
    ...
    inline def data(value: js.Array[PolygonSeriesPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (PolygonSeriesPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    ...
    inline def onNearestX(value: (PolygonSeriesPoint, /* data */ RVNearestXData[PolygonSeriesPoint]) => Callback): this.type = set("onNearestX", js.Any.fromFunction2((t0: PolygonSeriesPoint, t1: /* data */ RVNearestXData[PolygonSeriesPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(value: (PolygonSeriesPoint, /* data */ RVNearestXYData[PolygonSeriesPoint]) => Callback): this.type = set("onNearestXY", js.Any.fromFunction2((t0: PolygonSeriesPoint, t1: /* data */ RVNearestXYData[PolygonSeriesPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (PolygonSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: PolygonSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (PolygonSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: PolygonSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (PolygonSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: PolygonSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (PolygonSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: PolygonSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
