...
import typingsJapgolly.reactVis.mod.HorizontalRectSeriesPoint
...
object HorizontalRectSeriesCanvas {
  
  @JSImport("react-vis", "HorizontalRectSeriesCanvas")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.HorizontalRectSeriesCanvas] {
    ...
    inline def data(value: js.Array[HorizontalRectSeriesPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (HorizontalRectSeriesPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    
    inline def fill(value: String | Double): this.type = set("fill", value.asInstanceOf[js.Any])
    
    inline def getColor(
      value: HorizontalRectSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any
    ...
    inline def onNearestX(
      value: (HorizontalRectSeriesPoint, /* data */ RVNearestXData[HorizontalRectSeriesPoint]) => Callback
    ): this.type = set("onNearestX", js.Any.fromFunction2((t0: HorizontalRectSeriesPoint, t1: /* data */ RVNearestXData[HorizontalRectSeriesPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(
      value: (HorizontalRectSeriesPoint, /* data */ RVNearestXYData[HorizontalRectSeriesPoint]) => Callback
    ): this.type = set("onNearestXY", js.Any.fromFunction2((t0: HorizontalRectSeriesPoint, t1: /* data */ RVNearestXYData[HorizontalRectSeriesPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (HorizontalRectSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: HorizontalRectSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (HorizontalRectSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: HorizontalRectSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (HorizontalRectSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: HorizontalRectSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (HorizontalRectSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: HorizontalRectSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
  ...
  implicit def make(companion: HorizontalRectSeriesCanvas.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AbstractSeriesProps[HorizontalRectSeriesPoint]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
