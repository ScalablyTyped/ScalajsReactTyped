...
import typingsJapgolly.reactVis.mod.LabelSeriesPoint
import typingsJapgolly.reactVis.mod.LabelSeriesProps
...
object LabelSeries {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.LabelSeries] {
    ...
    inline def allowOffsetToBeReversed(value: Boolean): this.type = set("allowOffsetToBeReversed", value.asInstanceOf[js.Any])
    ...
    inline def data(value: js.Array[LabelSeriesPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (LabelSeriesPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    ...
    inline def labelAnchorX(value: String): this.type = set("labelAnchorX", value.asInstanceOf[js.Any])
    
    inline def labelAnchorY(value: String): this.type = set("labelAnchorY", value.asInstanceOf[js.Any])
    ...
    inline def onNearestX(value: (LabelSeriesPoint, /* data */ RVNearestXData[LabelSeriesPoint]) => Callback): this.type = set("onNearestX", js.Any.fromFunction2((t0: LabelSeriesPoint, t1: /* data */ RVNearestXData[LabelSeriesPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(value: (LabelSeriesPoint, /* data */ RVNearestXYData[LabelSeriesPoint]) => Callback): this.type = set("onNearestXY", js.Any.fromFunction2((t0: LabelSeriesPoint, t1: /* data */ RVNearestXYData[LabelSeriesPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (LabelSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: LabelSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (LabelSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: LabelSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (LabelSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: LabelSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (LabelSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: LabelSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
