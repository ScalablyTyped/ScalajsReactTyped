...
import typingsJapgolly.reactVis.mod.VerticalRectSeriesPoint
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object VerticalRectSeriesCanvas {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.VerticalRectSeriesCanvas] {
    ...
    inline def data(value: js.Array[VerticalRectSeriesPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (VerticalRectSeriesPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    
    inline def fill(value: String | Double): this.type = set("fill", value.asInstanceOf[js.Any])
    
    inline def getColor(
      value: VerticalRectSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any
    ...
    inline def onNearestX(value: (VerticalRectSeriesPoint, /* data */ RVNearestXData[VerticalRectSeriesPoint]) => Callback): this.type = set("onNearestX", js.Any.fromFunction2((t0: VerticalRectSeriesPoint, t1: /* data */ RVNearestXData[VerticalRectSeriesPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(value: (VerticalRectSeriesPoint, /* data */ RVNearestXYData[VerticalRectSeriesPoint]) => Callback): this.type = set("onNearestXY", js.Any.fromFunction2((t0: VerticalRectSeriesPoint, t1: /* data */ RVNearestXYData[VerticalRectSeriesPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (VerticalRectSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: VerticalRectSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (VerticalRectSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: VerticalRectSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (VerticalRectSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: VerticalRectSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (VerticalRectSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: VerticalRectSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
  ...
  implicit def make(companion: VerticalRectSeriesCanvas.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AbstractSeriesProps[VerticalRectSeriesPoint]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
