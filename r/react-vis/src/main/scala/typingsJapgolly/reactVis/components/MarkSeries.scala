...
import typingsJapgolly.reactVis.mod.MarkSeriesPoint
import typingsJapgolly.reactVis.mod.MarkSeriesProps
...
object MarkSeries {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.MarkSeries] {
    ...
    inline def data(value: js.Array[MarkSeriesPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (MarkSeriesPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    ...
    inline def getNull(value: MarkSeriesPoint => Any): this.type = set("getNull", js.Any.fromFunction1(value))
    ...
    inline def onNearestX(value: (MarkSeriesPoint, /* data */ RVNearestXData[MarkSeriesPoint]) => Callback): this.type = set("onNearestX", js.Any.fromFunction2((t0: MarkSeriesPoint, t1: /* data */ RVNearestXData[MarkSeriesPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(value: (MarkSeriesPoint, /* data */ RVNearestXYData[MarkSeriesPoint]) => Callback): this.type = set("onNearestXY", js.Any.fromFunction2((t0: MarkSeriesPoint, t1: /* data */ RVNearestXYData[MarkSeriesPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (MarkSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: MarkSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (MarkSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: MarkSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (MarkSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: MarkSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (MarkSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: MarkSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
