...
import typingsJapgolly.reactVis.mod.HorizontalBarSeriesCanvasProps
import typingsJapgolly.reactVis.mod.HorizontalBarSeriesPoint
...
object HorizontalBarSeriesCanvas {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactVis.mod.HorizontalBarSeriesCanvas] {
    ...
    inline def data(value: js.Array[HorizontalBarSeriesPoint | js.Array[Any]]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataVarargs(value: (HorizontalBarSeriesPoint | js.Array[Any])*): this.type = set("data", js.Array(value*))
    ...
    inline def onNearestX(value: (HorizontalBarSeriesPoint, /* data */ RVNearestXData[HorizontalBarSeriesPoint]) => Callback): this.type = set("onNearestX", js.Any.fromFunction2((t0: HorizontalBarSeriesPoint, t1: /* data */ RVNearestXData[HorizontalBarSeriesPoint]) => (value(t0, t1)).runNow()))
    
    inline def onNearestXY(
      value: (HorizontalBarSeriesPoint, /* data */ RVNearestXYData[HorizontalBarSeriesPoint]) => Callback
    ): this.type = set("onNearestXY", js.Any.fromFunction2((t0: HorizontalBarSeriesPoint, t1: /* data */ RVNearestXYData[HorizontalBarSeriesPoint]) => (value(t0, t1)).runNow()))
    ...
    inline def onValueClick(value: (HorizontalBarSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueClick", js.Any.fromFunction2((t0: HorizontalBarSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOut(value: (HorizontalBarSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOut", js.Any.fromFunction2((t0: HorizontalBarSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueMouseOver(value: (HorizontalBarSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueMouseOver", js.Any.fromFunction2((t0: HorizontalBarSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def onValueRightClick(value: (HorizontalBarSeriesPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): this.type = set("onValueRightClick", js.Any.fromFunction2((t0: HorizontalBarSeriesPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
