...
object HighlightProps {
  ...
  extension [Self <: HighlightProps](x: Self) {
    ...
    inline def setOnBrush(value: /* area */ HighlightArea | Null => Callback): Self = StObject.set(x, "onBrush", js.Any.fromFunction1((t0: /* area */ HighlightArea | Null) => value(t0).runNow()))
    
    inline def setOnBrushEnd(value: /* area */ HighlightArea | Null => Callback): Self = StObject.set(x, "onBrushEnd", js.Any.fromFunction1((t0: /* area */ HighlightArea | Null) => value(t0).runNow()))
    
    inline def setOnBrushEndUndefined: Self = StObject.set(x, "onBrushEnd", js.undefined)
    
    inline def setOnBrushStart(value: /* area */ HighlightArea | Null => Callback): Self = StObject.set(x, "onBrushStart", js.Any.fromFunction1((t0: /* area */ HighlightArea | Null) => value(t0).runNow()))
    ...
    inline def setOnDrag(value: /* area */ HighlightArea | Null => Callback): Self = StObject.set(x, "onDrag", js.Any.fromFunction1((t0: /* area */ HighlightArea | Null) => value(t0).runNow()))
    
    inline def setOnDragEnd(value: /* area */ HighlightArea | Null => Callback): Self = StObject.set(x, "onDragEnd", js.Any.fromFunction1((t0: /* area */ HighlightArea | Null) => value(t0).runNow()))
    
    inline def setOnDragEndUndefined: Self = StObject.set(x, "onDragEnd", js.undefined)
    
    inline def setOnDragStart(value: /* area */ HighlightArea | Null => Callback): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1((t0: /* area */ HighlightArea | Null) => value(t0).runNow()))
