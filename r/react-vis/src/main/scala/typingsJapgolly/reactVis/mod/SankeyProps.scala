...
import typingsJapgolly.reactVis.anon.Links
import typingsJapgolly.reactVis.anon.Source
import typingsJapgolly.reactVis.reactVisStrings.center
import typingsJapgolly.reactVis.reactVisStrings.justify
...
object SankeyProps {
  ...
  extension [Self <: SankeyProps](x: Self) {
    ...
    inline def setOnLinkClick(value: (SankeyPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onLinkClick", js.Any.fromFunction2((t0: SankeyPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnLinkClickUndefined: Self = StObject.set(x, "onLinkClick", js.undefined)
    
    inline def setOnLinkMouseOut(value: (SankeyPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onLinkMouseOut", js.Any.fromFunction2((t0: SankeyPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnLinkMouseOutUndefined: Self = StObject.set(x, "onLinkMouseOut", js.undefined)
    
    inline def setOnLinkMouseOver(value: (SankeyPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onLinkMouseOver", js.Any.fromFunction2((t0: SankeyPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnLinkMouseOverUndefined: Self = StObject.set(x, "onLinkMouseOver", js.undefined)
    
    inline def setOnValueClick(value: (SankeyPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onValueClick", js.Any.fromFunction2((t0: SankeyPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnValueClickUndefined: Self = StObject.set(x, "onValueClick", js.undefined)
    
    inline def setOnValueMouseOut(value: (SankeyPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onValueMouseOut", js.Any.fromFunction2((t0: SankeyPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnValueMouseOutUndefined: Self = StObject.set(x, "onValueMouseOut", js.undefined)
    
    inline def setOnValueMouseOver(value: (SankeyPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onValueMouseOver", js.Any.fromFunction2((t0: SankeyPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
