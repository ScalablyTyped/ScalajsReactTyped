...
import typingsJapgolly.reactVis.reactVisStrings.color0
import typingsJapgolly.reactVis.reactVisStrings.opacity
import typingsJapgolly.reactVis.reactVisStrings.opacity0
import typingsJapgolly.reactVis.reactVisStrings.size
import typingsJapgolly.reactVis.reactVisStrings.size0
import typingsJapgolly.reactVis.reactVisStrings.x
import typingsJapgolly.reactVis.reactVisStrings.x0
import typingsJapgolly.reactVis.reactVisStrings.y
import typingsJapgolly.reactVis.reactVisStrings.y0
...
object AbstractSeriesProps {
  ...
  extension [Self <: AbstractSeriesProps[?], T /* <: AbstractSeriesPoint */](x: Self & AbstractSeriesProps[T]) {
    ...
    inline def setOnNearestX(value: (T, /* data */ RVNearestXData[T]) => Callback): Self = StObject.set(x, "onNearestX", js.Any.fromFunction2((t0: T, t1: /* data */ RVNearestXData[T]) => (value(t0, t1)).runNow()))
    
    inline def setOnNearestXUndefined: Self = StObject.set(x, "onNearestX", js.undefined)
    
    inline def setOnNearestXY(value: (T, /* data */ RVNearestXYData[T]) => Callback): Self = StObject.set(x, "onNearestXY", js.Any.fromFunction2((t0: T, t1: /* data */ RVNearestXYData[T]) => (value(t0, t1)).runNow()))
    
    inline def setOnNearestXYUndefined: Self = StObject.set(x, "onNearestXY", js.undefined)
    
    inline def setOnSeriesClick(value: ReactMouseEventFrom[HTMLElement & Element] => Callback): Self = StObject.set(x, "onSeriesClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLElement & Element]) => value(t0).runNow()))
    
    inline def setOnSeriesClickUndefined: Self = StObject.set(x, "onSeriesClick", js.undefined)
    
    inline def setOnSeriesMouseOut(value: ReactMouseEventFrom[HTMLElement & Element] => Callback): Self = StObject.set(x, "onSeriesMouseOut", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLElement & Element]) => value(t0).runNow()))
    
    inline def setOnSeriesMouseOutUndefined: Self = StObject.set(x, "onSeriesMouseOut", js.undefined)
    
    inline def setOnSeriesMouseOver(value: ReactMouseEventFrom[HTMLElement & Element] => Callback): Self = StObject.set(x, "onSeriesMouseOver", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLElement & Element]) => value(t0).runNow()))
    
    inline def setOnSeriesMouseOverUndefined: Self = StObject.set(x, "onSeriesMouseOver", js.undefined)
    
    inline def setOnSeriesRightClick(value: ReactMouseEventFrom[HTMLElement & Element] => Callback): Self = StObject.set(x, "onSeriesRightClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLElement & Element]) => value(t0).runNow()))
    
    inline def setOnSeriesRightClickUndefined: Self = StObject.set(x, "onSeriesRightClick", js.undefined)
    
    inline def setOnValueClick(value: (T, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onValueClick", js.Any.fromFunction2((t0: T, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnValueClickUndefined: Self = StObject.set(x, "onValueClick", js.undefined)
    
    inline def setOnValueMouseOut(value: (T, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onValueMouseOut", js.Any.fromFunction2((t0: T, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnValueMouseOutUndefined: Self = StObject.set(x, "onValueMouseOut", js.undefined)
    
    inline def setOnValueMouseOver(value: (T, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onValueMouseOver", js.Any.fromFunction2((t0: T, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnValueMouseOverUndefined: Self = StObject.set(x, "onValueMouseOver", js.undefined)
    
    inline def setOnValueRightClick(value: (T, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onValueRightClick", js.Any.fromFunction2((t0: T, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
