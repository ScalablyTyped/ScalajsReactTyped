...
object SunburstProps {
  ...
  extension [Self <: SunburstProps](x: Self) {
    ...
    inline def setOnValueClick(value: (SunburstPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onValueClick", js.Any.fromFunction2((t0: SunburstPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnValueClickUndefined: Self = StObject.set(x, "onValueClick", js.undefined)
    
    inline def setOnValueMouseOut(value: (SunburstPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onValueMouseOut", js.Any.fromFunction2((t0: SunburstPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnValueMouseOutUndefined: Self = StObject.set(x, "onValueMouseOut", js.undefined)
    
    inline def setOnValueMouseOver(value: (SunburstPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onValueMouseOver", js.Any.fromFunction2((t0: SunburstPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
