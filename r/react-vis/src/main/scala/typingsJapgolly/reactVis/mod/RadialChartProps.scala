...
import typingsJapgolly.reactVis.anon.Angle
import typingsJapgolly.reactVis.reactVisStrings.angle
import typingsJapgolly.reactVis.reactVisStrings.angle0
import typingsJapgolly.reactVis.reactVisStrings.label
import typingsJapgolly.reactVis.reactVisStrings.radius
import typingsJapgolly.reactVis.reactVisStrings.radius0
...
object RadialChartProps {
  ...
  extension [Self <: RadialChartProps](x: Self) {
    ...
    inline def setOnValueClick(value: (RadialChartPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onValueClick", js.Any.fromFunction2((t0: RadialChartPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnValueClickUndefined: Self = StObject.set(x, "onValueClick", js.undefined)
    
    inline def setOnValueMouseOut(value: (RadialChartPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onValueMouseOut", js.Any.fromFunction2((t0: RadialChartPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnValueMouseOutUndefined: Self = StObject.set(x, "onValueMouseOut", js.undefined)
    
    inline def setOnValueMouseOver(value: (RadialChartPoint, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onValueMouseOver", js.Any.fromFunction2((t0: RadialChartPoint, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
