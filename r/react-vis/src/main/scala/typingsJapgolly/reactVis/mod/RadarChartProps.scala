...
import typingsJapgolly.reactVis.anon.Domain
import typingsJapgolly.reactVis.anon.Labels
...
object RadarChartProps {
  ...
  extension [Self <: RadarChartProps](x: Self) {
    ...
    inline def setDataVarargs(value: RadarChartPoint*): Self = StObject.set(x, "data", js.Array(value*))
