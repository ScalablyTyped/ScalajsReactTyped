...
import typingsJapgolly.reactWindow.mod.FixedSizeGridProps
...
object FixedSizeGrid {
  ...
  inline def apply[T](
    ...
    new Builder[T](js.Array(this.component, __props.asInstanceOf[FixedSizeGridProps[T]]))
  }
  ...
  open class Builder[T] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactWindow.mod.FixedSizeGrid[T]] {
  ...
  def withProps[T](p: FixedSizeGridProps[T]): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
