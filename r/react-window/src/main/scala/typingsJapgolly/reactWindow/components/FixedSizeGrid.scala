...
object FixedSizeGrid {
  def apply(
    ...
    FixedSizeGridProps, 
    typingsJapgolly.reactWindow.mod.FixedSizeGrid, 
    Unit, 
    FixedSizeGridProps
  ] = {
  ...
  typingsJapgolly.reactWindow.mod.FixedSizeGridProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.reactWindow.mod.FixedSizeGrid](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactWindow.mod.FixedSizeGridProps])
  }
