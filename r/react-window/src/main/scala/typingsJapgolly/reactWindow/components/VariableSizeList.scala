...
object VariableSizeList {
  ...
  inline def apply[T](
    ...
    new Builder[T](js.Array(this.component, __props.asInstanceOf[VariableSizeListProps[T]]))
  }
  ...
  open class Builder[T] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactWindow.mod.VariableSizeList[T]] {
    
    inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def direction(value: CSSDirection | Direction): this.type = set("direction", value.asInstanceOf[js.Any])
    
    inline def estimatedItemSize(value: Double): this.type = set("estimatedItemSize", value.asInstanceOf[js.Any])
  ...
  def withProps[T](p: VariableSizeListProps[T]): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
