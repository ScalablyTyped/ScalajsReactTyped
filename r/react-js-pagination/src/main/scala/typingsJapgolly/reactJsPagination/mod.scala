package typingsJapgolly.reactJsPagination
...
object mod extends Shortcut {
  ...
  object ReactJsPaginationProps {
    ...
    inline def apply(activePage: Double, onChange: Double => Callback, totalItemsCount: Double): ReactJsPaginationProps = {
      val __obj = js.Dynamic.literal(activePage = activePage.asInstanceOf[js.Any], onChange = js.Any.fromFunction1((t0: Double) => onChange(t0).runNow()), totalItemsCount = totalItemsCount.asInstanceOf[js.Any])
    ...
    extension [Self <: ReactJsPaginationProps](x: Self) {
      ...
      inline def setFirstPageTextVdomElement(value: VdomElement): Self = StObject.set(x, "firstPageText", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setLastPageTextVdomElement(value: VdomElement): Self = StObject.set(x, "lastPageText", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setNextPageTextVdomElement(value: VdomElement): Self = StObject.set(x, "nextPageText", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setPrevPageText(value: String | Element): Self = StObject.set(x, "prevPageText", value.asInstanceOf[js.Any])
      
      inline def setPrevPageTextUndefined: Self = StObject.set(x, "prevPageText", js.undefined)
      
      inline def setPrevPageTextVdomElement(value: VdomElement): Self = StObject.set(x, "prevPageText", value.rawElement.asInstanceOf[js.Any])
