...
object SafeAreaProvider {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def initialMetrics(value: Metrics): this.type = set("initialMetrics", value.asInstanceOf[js.Any])
    
    inline def initialMetricsNull: this.type = set("initialMetrics", null)
    
    inline def initialSafeAreaInsets(value: EdgeInsets): this.type = set("initialSafeAreaInsets", value.asInstanceOf[js.Any])
    
    inline def initialSafeAreaInsetsNull: this.type = set("initialSafeAreaInsets", null)
  ...
  def withProps(p: SafeAreaProviderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
