...
import typingsJapgolly.reactNativeSafeAreaContext.libTypescriptSafeAreaDottypesMod.Edge
...
object SafeAreaView {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[NativeSafeAreaViewInstance & js.Object] {
    ...
    inline def edges(value: js.Array[Edge]): this.type = set("edges", value.asInstanceOf[js.Any])
    
    inline def edgesVarargs(value: Edge*): this.type = set("edges", js.Array(value*))
    ...
    inline def mode(value: padding | margin): this.type = set("mode", value.asInstanceOf[js.Any])
  ...
  def withProps(p: SafeAreaViewProps & RefAttributes[NativeSafeAreaViewInstance]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
