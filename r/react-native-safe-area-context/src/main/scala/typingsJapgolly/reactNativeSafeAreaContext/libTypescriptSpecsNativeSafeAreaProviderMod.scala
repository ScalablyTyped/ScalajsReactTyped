...
import typingsJapgolly.reactNative.librariesTypesCodegenTypesMod.DirectEventHandler
import typingsJapgolly.reactNative.mod.HostComponent
import typingsJapgolly.reactNative.mod.NodeHandle
import typingsJapgolly.reactNative.mod.ViewProps
import typingsJapgolly.reactNativeSafeAreaContext.anon.ReadonlytopDoublerightDou
import typingsJapgolly.reactNativeSafeAreaContext.anon.ReadonlyxDoubleyDoublewid
import typingsJapgolly.reactNativeSafeAreaContext.reactNativeSafeAreaContextStrings.paperInsetsChange
...
object libTypescriptSpecsNativeSafeAreaProviderMod extends Shortcut {
  ...
  object NativeProps {
    ...
    extension [Self <: NativeProps](x: Self) {
      ...
      inline def setOnInsetsChange(value: ReactEventFrom[NodeHandle & Element] => Unit | js.Promise[Unit]): Self = StObject.set(x, "onInsetsChange", js.Any.fromFunction1(value))
