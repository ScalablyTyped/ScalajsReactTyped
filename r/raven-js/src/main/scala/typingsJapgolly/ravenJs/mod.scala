...
import typingsJapgolly.ravenJs.anon.ErrorrequestXMLHttpReques
import typingsJapgolly.ravenJs.anon.Sentryclient
...
object mod extends Shortcut {
  ...
  */
  ...
  object BreadcrumbType {
    ...
    inline def http: typingsJapgolly.ravenJs.ravenJsStrings.http = "http".asInstanceOf[typingsJapgolly.ravenJs.ravenJsStrings.http]
    
    inline def navigation: typingsJapgolly.ravenJs.ravenJsStrings.navigation = "navigation".asInstanceOf[typingsJapgolly.ravenJs.ravenJsStrings.navigation]
  }
  ...
  */
  ...
  object LogLevel {
    ...
    inline def critical: typingsJapgolly.ravenJs.ravenJsStrings.critical = "critical".asInstanceOf[typingsJapgolly.ravenJs.ravenJsStrings.critical]
    
    inline def debug: typingsJapgolly.ravenJs.ravenJsStrings.debug = "debug".asInstanceOf[typingsJapgolly.ravenJs.ravenJsStrings.debug]
    
    inline def error: typingsJapgolly.ravenJs.ravenJsStrings.error = "error".asInstanceOf[typingsJapgolly.ravenJs.ravenJsStrings.error]
    
    inline def fatal: typingsJapgolly.ravenJs.ravenJsStrings.fatal = "fatal".asInstanceOf[typingsJapgolly.ravenJs.ravenJsStrings.fatal]
    
    inline def info: typingsJapgolly.ravenJs.ravenJsStrings.info = "info".asInstanceOf[typingsJapgolly.ravenJs.ravenJsStrings.info]
    
    inline def log: typingsJapgolly.ravenJs.ravenJsStrings.log = "log".asInstanceOf[typingsJapgolly.ravenJs.ravenJsStrings.log]
    
    inline def warn: typingsJapgolly.ravenJs.ravenJsStrings.warn = "warn".asInstanceOf[typingsJapgolly.ravenJs.ravenJsStrings.warn]
    
    inline def warning: typingsJapgolly.ravenJs.ravenJsStrings.warning = "warning".asInstanceOf[typingsJapgolly.ravenJs.ravenJsStrings.warning]
  }
  ...
  object RavenOptions {
    ...
    extension [Self <: RavenOptions](x: Self) {
      ...
      inline def setTransport(value: /* options */ RavenTransportOptions => Callback): Self = StObject.set(x, "transport", js.Any.fromFunction1((t0: /* options */ RavenTransportOptions) => value(t0).runNow()))
  ...
  object RavenTransportOptions {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(auth = auth.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any], onError = js.Any.fromFunction1((t0: ErrorrequestXMLHttpReques) => onError(t0).runNow()), onSuccess = onSuccess.toJsFn, url = url.asInstanceOf[js.Any])
    ...
    extension [Self <: RavenTransportOptions](x: Self) {
      ...
      inline def setOnError(value: ErrorrequestXMLHttpReques => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: ErrorrequestXMLHttpReques) => value(t0).runNow()))
