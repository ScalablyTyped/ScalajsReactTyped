...
object RavenOptions {
  ...
  def apply(
    ...
    breadcrumbCallback: /* data */ js.Any => CallbackTo[js.Any] = null,
    captureUnhandledRejections: js.UndefOr[Boolean] = js.undefined,
    dataCallback: /* data */ js.Any => CallbackTo[js.Any] = null,
    ...
    shouldSendCallback: /* data */ js.Any => CallbackTo[Boolean] = null,
    stacktrace: js.UndefOr[Boolean] = js.undefined,
    tags: StringDictionary[String] = null,
    transport: /* options */ RavenTransportOptions => Callback = null,
    ...
    if (breadcrumbCallback != null) __obj.updateDynamic("breadcrumbCallback")(js.Any.fromFunction1((t0: /* data */ js.Any) => breadcrumbCallback(t0).runNow()))
    ...
    if (dataCallback != null) __obj.updateDynamic("dataCallback")(js.Any.fromFunction1((t0: /* data */ js.Any) => dataCallback(t0).runNow()))
    ...
    if (shouldSendCallback != null) __obj.updateDynamic("shouldSendCallback")(js.Any.fromFunction1((t0: /* data */ js.Any) => shouldSendCallback(t0).runNow()))
    if (!js.isUndefined(stacktrace)) __obj.updateDynamic("stacktrace")(stacktrace.asInstanceOf[js.Any])
    if (tags != null) __obj.updateDynamic("tags")(tags.asInstanceOf[js.Any])
    if (transport != null) __obj.updateDynamic("transport")(js.Any.fromFunction1((t0: /* options */ typingsJapgolly.ravenJs.mod.RavenTransportOptions) => transport(t0).runNow()))
