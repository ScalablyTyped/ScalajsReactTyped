...
import typingsJapgolly.reactFloater.anon.PartialApplyStylesModifie
import typingsJapgolly.reactFloater.anon.PartialArrowModifier
import typingsJapgolly.reactFloater.anon.PartialComputeStylesModif
import typingsJapgolly.reactFloater.anon.PartialEventListenersModi
import typingsJapgolly.reactFloater.anon.PartialFlipModifier
import typingsJapgolly.reactFloater.anon.PartialHideModifier
import typingsJapgolly.reactFloater.anon.PartialOffsetModifier
import typingsJapgolly.reactFloater.anon.PartialPopperOffsetsModif
import typingsJapgolly.reactFloater.anon.PartialPreventOverflowMod
...
object libTypesPopperMod {
  ...
  type PopperInstance = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Instance */ Any
  ...
  type PopperPlacement = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Placement */ Any
}
