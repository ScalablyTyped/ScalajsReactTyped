...
import typingsJapgolly.reactFloater.reactFloaterStrings.popperOffsets
...
trait PartialPopperOffsetsModif extends StObject {
...
object PartialPopperOffsetsModif {
  ...
  inline def apply(): PartialPopperOffsetsModif = {
  ...
  extension [Self <: PartialPopperOffsetsModif](x: Self) {
    ...
    inline def setName(value: popperOffsets): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
