...
trait PartialOptionsOffset extends StObject {
  ...
  var offset: js.UndefOr[typingsJapgolly.popperjsCore.libModifiersOffsetMod.Offset] = js.undefined
}
object PartialOptionsOffset {
  ...
  extension [Self <: PartialOptionsOffset](x: Self) {
    ...
    inline def setOffset(value: typingsJapgolly.popperjsCore.libModifiersOffsetMod.Offset): Self = StObject.set(x, "offset", value.asInstanceOf[js.Any])
