package typingsJapgolly.reactMdTree.components
...
object TreeItem {
  ...
  object PickTreeItemWithContentCo {
    ...
    inline def apply(
      ...
      new Builder(js.Array(this.component, __props.asInstanceOf[typingsJapgolly.reactMdTree.anon.PickTreeItemWithContentCo]))
    }
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def contentComponent(value: ElementType): this.type = set("contentComponent", value.asInstanceOf[js.Any])
      ...
      inline def expanderIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("expanderIcon", js.Array(value*))
      
      inline def expanderIconVdomElement(value: VdomElement): this.type = set("expanderIcon", value.rawElement.asInstanceOf[js.Any])
      
      inline def expanderLeft(value: Boolean): this.type = set("expanderLeft", value.asInstanceOf[js.Any])
      ...
      inline def liClassName(value: String): this.type = set("liClassName", value.asInstanceOf[js.Any])
      
      inline def liRef(value: Ref[HTMLLIElement]): this.type = set("liRef", value.asInstanceOf[js.Any])
      
      inline def liRefFunction1(value: HTMLLIElement | Null => Callback): this.type = set("liRef", js.Any.fromFunction1((t0: HTMLLIElement | Null) => value(t0).runNow()))
      
      inline def liRefNull: this.type = set("liRef", null)
      
      inline def liStyle(value: CSSProperties): this.type = set("liStyle", value.asInstanceOf[js.Any])
      ...
      inline def renderChildItems(value: CallbackTo[Node]): this.type = set("renderChildItems", value.toJsFn)
    ...
    def withProps(p: typingsJapgolly.reactMdTree.anon.PickTreeItemWithContentCo): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object TreeItemPropsRefAttributes {
    ...
    inline def apply(
      ...
      val __props = js.Dynamic.literal(depth = depth.asInstanceOf[js.Any], expanded = expanded.asInstanceOf[js.Any], focused = focused.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], itemIndex = itemIndex.asInstanceOf[js.Any], listSize = listSize.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[TreeItemProps & RefAttributes[HTMLLIElement]]))
    }
    ...
    def withProps(p: TreeItemProps & RefAttributes[HTMLLIElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
