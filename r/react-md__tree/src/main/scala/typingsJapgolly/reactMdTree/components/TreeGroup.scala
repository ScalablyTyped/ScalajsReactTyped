...
object TreeGroup {
  ...
  inline def apply(collapsed: Boolean): Builder = {
    val __props = js.Dynamic.literal(collapsed = collapsed.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[TreeGroupProps & RefAttributes[ListElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def nodeRef(value: Ref[ListElement]): this.type = set("nodeRef", value.asInstanceOf[js.Any])
    
    inline def nodeRefFunction1(value: ListElement | Null => Callback): this.type = set("nodeRef", js.Any.fromFunction1((t0: ListElement | Null) => value(t0).runNow()))
  ...
  def withProps(p: TreeGroupProps & RefAttributes[ListElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
