...
object typesTreeGroupMod {
  ...
  object TreeGroupProps {
    ...
    extension [Self <: TreeGroupProps](x: Self) {
      ...
      inline def setNodeRefFunction1(value: ListElement | Null => Callback): Self = StObject.set(x, "nodeRef", js.Any.fromFunction1((t0: ListElement | Null) => value(t0).runNow()))
      ...
      inline def setOnChange(value: ReactEventFrom[ListElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: ReactEventFrom[ListElement & org.scalajs.dom.Element]) => value(t0).runNow()))
