package typingsJapgolly.reactLinesEllipsis.components
...
import typingsJapgolly.reactLinesEllipsis.libLooseMod.^
import typingsJapgolly.reactLinesEllipsis.mod.LinesEllipsisLooseProps
...
object Loose {
  ...
  @JSImport("react-lines-ellipsis/lib/loose", JSImport.Namespace)
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def basedOn(value: letters | words): this.type = set("basedOn", value.asInstanceOf[js.Any])
    ...
    inline def ellipsis(value: String): this.type = set("ellipsis", value.asInstanceOf[js.Any])
    ...
    inline def maxLine(value: Double | String): this.type = set("maxLine", value.asInstanceOf[js.Any])
    ...
    inline def onReflow(value: /* hasClampedText */ Clamped => Callback): this.type = set("onReflow", js.Any.fromFunction1((t0: /* hasClampedText */ Clamped) => value(t0).runNow()))
    ...
    inline def overflowFallback(value: Boolean): this.type = set("overflowFallback", value.asInstanceOf[js.Any])
    ...
    inline def trimRight(value: Boolean): this.type = set("trimRight", value.asInstanceOf[js.Any])
    ...
    inline def winWidth(value: Double): this.type = set("winWidth", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: Loose.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LinesEllipsisLooseProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
