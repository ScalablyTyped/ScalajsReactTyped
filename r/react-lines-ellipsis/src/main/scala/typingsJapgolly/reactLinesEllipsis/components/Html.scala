...
import typingsJapgolly.reactLinesEllipsis.libHtmlMod.^
import typingsJapgolly.reactLinesEllipsis.mod.HTMLEllipsisProps
...
object Html {
  ...
  @JSImport("react-lines-ellipsis/lib/html", JSImport.Namespace)
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def ellipsisHTML(value: String): this.type = set("ellipsisHTML", value.asInstanceOf[js.Any])
    ...
    inline def unsafeHTML(value: String): this.type = set("unsafeHTML", value.asInstanceOf[js.Any])
  ...
  def withProps(p: HTMLEllipsisProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
