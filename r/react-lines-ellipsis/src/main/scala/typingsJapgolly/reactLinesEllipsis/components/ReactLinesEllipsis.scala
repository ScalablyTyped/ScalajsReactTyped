...
import typingsJapgolly.reactLinesEllipsis.mod.ReactLinesEllipsisProps
import typingsJapgolly.reactLinesEllipsis.mod.^
...
object ReactLinesEllipsis {
  ...
  implicit def make(companion: ReactLinesEllipsis.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ReactLinesEllipsisProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
