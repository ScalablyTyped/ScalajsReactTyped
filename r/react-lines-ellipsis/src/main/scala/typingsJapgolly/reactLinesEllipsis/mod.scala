...
import typingsJapgolly.reactLinesEllipsis.anon.Clamped
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.`additions removals`
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.`additions text`
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.`inline`
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.`removals additions`
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.`removals text`
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.`text additions`
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.`text removals`
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.additions
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.all
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.ascending
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.assertive
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.both
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.copy
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.date
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.decimal
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.descending
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.dialog
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.email
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.execute
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.grammar
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.grid
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.horizontal
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.inherit
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.letters
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.link
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.list
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.listbox
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.location
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.menu
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.mixed
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.move
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.no
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.none
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.numeric
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.off
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.on
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.other
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.page
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.polite
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.popup
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.removals
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.search
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.spelling
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.step
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.tel
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.text
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.time
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.tree
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.url
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.vertical
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.words
import typingsJapgolly.reactLinesEllipsis.reactLinesEllipsisStrings.yes
...
object mod {
  ...
  @JSImport("react-lines-ellipsis", JSImport.Namespace)
  @js.native
  open class ^ ()
    extends Component[ReactLinesEllipsisProps, js.Object, Any]
  @JSImport("react-lines-ellipsis", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* static member */
  @JSImport("react-lines-ellipsis", "defaultProps")
  @js.native
  def defaultProps: js.UndefOr[ReactLinesEllipsisProps] = js.native
  inline def defaultProps_=(x: js.UndefOr[ReactLinesEllipsisProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
  
  trait CommonReactLinesEllipsisProps
    extends StObject
       with HTMLAttributes[HTMLDivElement] {
    
    var basedOn: js.UndefOr[letters | words] = js.undefined
    ...
    var winWidth: js.UndefOr[Double] = js.undefined
  }
  object CommonReactLinesEllipsisProps {
    
    inline def apply(): CommonReactLinesEllipsisProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CommonReactLinesEllipsisProps]
    }
    
    extension [Self <: CommonReactLinesEllipsisProps](x: Self) {
      
      inline def setBasedOn(value: letters | words): Self = StObject.set(x, "basedOn", value.asInstanceOf[js.Any])
      ...
      inline def setOnReflow(value: /* hasClampedText */ Clamped => Callback): Self = StObject.set(x, "onReflow", js.Any.fromFunction1((t0: /* hasClampedText */ Clamped) => value(t0).runNow()))
      
      inline def setOnReflowUndefined: Self = StObject.set(x, "onReflow", js.undefined)
      
      inline def setTrimRight(value: Boolean): Self = StObject.set(x, "trimRight", value.asInstanceOf[js.Any])
      
      inline def setTrimRightUndefined: Self = StObject.set(x, "trimRight", js.undefined)
      
      inline def setWinWidth(value: Double): Self = StObject.set(x, "winWidth", value.asInstanceOf[js.Any])
      
      inline def setWinWidthUndefined: Self = StObject.set(x, "winWidth", js.undefined)
    }
  }
  
  /* Inlined react-lines-ellipsis.react-lines-ellipsis.CommonReactLinesEllipsisProps & {  unsafeHTML :string | undefined,   ellipsisHTML :string | undefined} */
  trait HTMLEllipsisProps extends StObject {
    ...
    var ellipsisHTML: js.UndefOr[String] = js.undefined
  ...
  object HTMLEllipsisProps {
    
    inline def apply(): HTMLEllipsisProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[HTMLEllipsisProps]
    }
    
    extension [Self <: HTMLEllipsisProps](x: Self) {
      ...
      inline def setEllipsisHTML(value: String): Self = StObject.set(x, "ellipsisHTML", value.asInstanceOf[js.Any])
      
      inline def setEllipsisHTMLUndefined: Self = StObject.set(x, "ellipsisHTML", js.undefined)
  ...
  type LinesEllipsis = japgolly.scalajs.react.facade.React.Component[ReactLinesEllipsisProps & js.Object, js.Object]
  
  /* Inlined react-lines-ellipsis.react-lines-ellipsis.CommonReactLinesEllipsisProps & {  lineHeight :number | undefined,   overflowFallback :boolean | undefined} */
  trait LinesEllipsisLooseProps extends StObject {
    ...
    var overflowFallback: js.UndefOr[Boolean] = js.undefined
  ...
  object LinesEllipsisLooseProps {
    
    inline def apply(): LinesEllipsisLooseProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[LinesEllipsisLooseProps]
    }
    
    extension [Self <: LinesEllipsisLooseProps](x: Self) {
      ...
      inline def setOverflowFallback(value: Boolean): Self = StObject.set(x, "overflowFallback", value.asInstanceOf[js.Any])
      
      inline def setOverflowFallbackUndefined: Self = StObject.set(x, "overflowFallback", js.undefined)
  ...
  /* Inlined react-lines-ellipsis.react-lines-ellipsis.CommonReactLinesEllipsisProps & {  text :string | undefined} */
  trait ReactLinesEllipsisProps extends StObject {
  ...
  object ReactLinesEllipsisProps {
    
    inline def apply(): ReactLinesEllipsisProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ReactLinesEllipsisProps]
    }
    
    extension [Self <: ReactLinesEllipsisProps](x: Self) {
