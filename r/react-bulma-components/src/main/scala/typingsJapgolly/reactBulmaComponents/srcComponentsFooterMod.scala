...
object srcComponentsFooterMod extends Shortcut {
  
  @JSImport("react-bulma-components/src/components/footer", JSImport.Default)
  @js.native
  val default: BulmaComponent[js.Object, div] = js.native
  
  type _To = BulmaComponent[js.Object, div]
  
  /* This means you don't have to write `default`, but can instead just say `srcComponentsFooterMod.foo` */
