...
import typingsJapgolly.reactBulmaComponents.srcComponentsFormMod.RadioProps
...
object Radio {
  ...
  @JSImport("react-bulma-components", "Form.Radio")
  @js.native
  ...
  def withProps(p: OmitKeys[RadioProps & (ElementProps[RadioProps, input]), renderAs]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
