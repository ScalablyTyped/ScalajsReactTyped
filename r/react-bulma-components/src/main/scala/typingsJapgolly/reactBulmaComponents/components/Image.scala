...
import typingsJapgolly.reactBulmaComponents.srcComponentsImageMod.ImageProps
...
object Image {
  ...
  inline def apply(src: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[/* props */ ImageProps & (Omit[ElementProps[ImageProps, figure], renderAs])]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def domRef(value: RefHandle[figure]): this.type = set("domRef", value.asInstanceOf[js.Any])
    ...
    inline def renderAs(value: figure): this.type = set("renderAs", value.asInstanceOf[js.Any])
  ...
  def withProps(p: /* props */ ImageProps & (Omit[ElementProps[ImageProps, figure], renderAs])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
