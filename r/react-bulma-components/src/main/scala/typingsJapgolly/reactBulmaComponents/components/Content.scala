...
import typingsJapgolly.reactBulmaComponents.srcComponentsContentMod.ContentProps
...
object Content {
  ...
  def withProps(p: /* props */ ContentProps & (ElementProps[ContentProps, div])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
