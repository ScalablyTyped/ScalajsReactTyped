...
import typingsJapgolly.reactBulmaComponents.srcComponentsFormMod.HelpProps
...
object Help {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def domRef(value: RefHandle[p]): this.type = set("domRef", value.asInstanceOf[js.Any])
    ...
    inline def renderAs(value: p): this.type = set("renderAs", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: Help.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: /* props */ HelpProps & (ElementProps[HelpProps, p])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
