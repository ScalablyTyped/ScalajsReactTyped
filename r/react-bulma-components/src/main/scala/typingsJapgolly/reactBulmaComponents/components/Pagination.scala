...
import typingsJapgolly.reactBulmaComponents.srcComponentsPaginationMod.PaginationProps
...
object Pagination {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def align(value: center | right): this.type = set("align", value.asInstanceOf[js.Any])
    ...
    inline def delta(value: Double): this.type = set("delta", value.asInstanceOf[js.Any])
    ...
    inline def domRef(value: RefHandle[nav]): this.type = set("domRef", value.asInstanceOf[js.Any])
    ...
    inline def next(value: VdomNode): this.type = set("next", value.rawNode.asInstanceOf[js.Any])
    
    inline def nextNull: this.type = set("next", null)
    
    inline def nextVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("next", js.Array(value*))
    
    inline def nextVdomElement(value: VdomElement): this.type = set("next", value.rawElement.asInstanceOf[js.Any])
    
    inline def onChange(value: /* page */ Double => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* page */ Double) => value(t0).runNow()))
    ...
    inline def previous(value: VdomNode): this.type = set("previous", value.rawNode.asInstanceOf[js.Any])
    
    inline def previousNull: this.type = set("previous", null)
    
    inline def previousVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("previous", js.Array(value*))
    
    inline def previousVdomElement(value: VdomElement): this.type = set("previous", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def renderAs(value: nav): this.type = set("renderAs", value.asInstanceOf[js.Any])
    ...
    inline def showFirstLast(value: Boolean): this.type = set("showFirstLast", value.asInstanceOf[js.Any])
    
    inline def showPrevNext(value: Boolean): this.type = set("showPrevNext", value.asInstanceOf[js.Any])
  ...
  def withProps(p: /* props */ PaginationProps & (ElementProps[PaginationProps, nav])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
