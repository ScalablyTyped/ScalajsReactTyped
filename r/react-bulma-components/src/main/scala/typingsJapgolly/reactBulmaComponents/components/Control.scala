...
import typingsJapgolly.reactBulmaComponents.srcComponentsFormMod.ControlProps
...
object Control {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def iconType(value: ElementType): this.type = set("iconType", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: Control.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: /* props */ ControlProps & (ElementProps[ControlProps, div])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
