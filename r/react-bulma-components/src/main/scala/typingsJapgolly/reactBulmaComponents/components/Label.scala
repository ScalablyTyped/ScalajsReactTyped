...
import typingsJapgolly.reactBulmaComponents.srcComponentsFormMod.LabelProps
...
object Label {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def domRef(value: RefHandle[label]): this.type = set("domRef", value.asInstanceOf[js.Any])
    ...
    inline def renderAs(value: label): this.type = set("renderAs", value.asInstanceOf[js.Any])
  ...
  def withProps(p: /* props */ LabelProps & (Omit[ElementProps[LabelProps, label], renderAs])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
