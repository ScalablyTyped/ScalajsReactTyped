...
import typingsJapgolly.reactBulmaComponents.srcComponentsFormMod.SelectProps
...
object Select {
  ...
  inline def apply[TValue](): Builder[TValue] = {
    ...
    new Builder[TValue](js.Array(this.component, __props.asInstanceOf[OmitKeys[
    SelectProps[TValue] & (ElementProps[SelectProps[TValue], select]), 
    renderAs | readonly
  ]]))
  }
  
  @JSImport("react-bulma-components", "Form.Select")
  @js.native
  ...
  open class Builder[TValue] (val args: js.Array[Any])
    ...
    inline def domRef(value: RefHandle[select]): this.type = set("domRef", value.asInstanceOf[js.Any])
    ...
    inline def renderAs(value: select): this.type = set("renderAs", value.asInstanceOf[js.Any])
    ...
    inline def status(value: focus | hover): this.type = set("status", value.asInstanceOf[js.Any])
    ...
    inline def value(value: TValue): this.type = set("value", value.asInstanceOf[js.Any])
    
    inline def widescreen(value: ResponsiveModifiersonlyBo): this.type = set("widescreen", value.asInstanceOf[js.Any])
  }
  
  implicit def make[TValue](companion: Select.type): Builder[TValue] = new Builder[TValue](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps[TValue](
    p: OmitKeys[
      SelectProps[TValue] & (ElementProps[SelectProps[TValue], select]), 
      renderAs | readonly
    ]
  ): Builder[TValue] = new Builder[TValue](js.Array(this.component, p.asInstanceOf[js.Any]))
}
