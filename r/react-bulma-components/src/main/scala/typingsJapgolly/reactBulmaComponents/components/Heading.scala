...
import typingsJapgolly.reactBulmaComponents.srcComponentsHeadingMod.HeadingProps
...
object Heading {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def domRef(value: RefHandle[h1]): this.type = set("domRef", value.asInstanceOf[js.Any])
    ...
    inline def heading(value: Boolean): this.type = set("heading", value.asInstanceOf[js.Any])
    ...
    inline def renderAs(value: h1): this.type = set("renderAs", value.asInstanceOf[js.Any])
    
    inline def shadowless(value: Boolean): this.type = set("shadowless", value.asInstanceOf[js.Any])
    
    inline def size(value: `1` | `2` | `3` | `4` | `5` | `6`): this.type = set("size", value.asInstanceOf[js.Any])
    
    inline def spaced(value: Boolean): this.type = set("spaced", value.asInstanceOf[js.Any])
    
    inline def srOnly(value: Boolean): this.type = set("srOnly", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSProperties): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def subtitle(value: Boolean): this.type = set("subtitle", value.asInstanceOf[js.Any])
    ...
    inline def weight(value: light | normal | semibold | bold): this.type = set("weight", value.asInstanceOf[js.Any])
  ...
  def withProps(p: /* props */ HeadingProps & (ElementProps[HeadingProps, h1])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
