...
import typingsJapgolly.reactBulmaComponents.srcComponentsFormMod.InputProps
...
object Input {
  ...
  @JSImport("react-bulma-components", "Form.Input")
  @js.native
  ...
  open class Builder[TValue] (val args: js.Array[Any])
    ...
    inline def isStatic(value: Boolean): this.type = set("isStatic", value.asInstanceOf[js.Any])
  ...
  implicit def make[TValue](companion: Input.type): Builder[TValue] = new Builder[TValue](js.Array(this.component, js.Dictionary.empty))()
