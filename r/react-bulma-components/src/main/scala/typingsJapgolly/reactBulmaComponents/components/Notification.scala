...
import typingsJapgolly.reactBulmaComponents.srcComponentsNotificationMod.NotificationProps
...
object Notification {
  ...
  def withProps(p: /* props */ NotificationProps & (ElementProps[NotificationProps, div])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
