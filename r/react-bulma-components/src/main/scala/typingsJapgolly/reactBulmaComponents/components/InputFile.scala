...
import typingsJapgolly.reactBulmaComponents.srcComponentsFormMod.InputFileProps
...
object InputFile {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def boxed(value: Boolean): this.type = set("boxed", value.asInstanceOf[js.Any])
    ...
    inline def inputProps(value: OmitKeys[onChange, HTMLAttributes[input]]): this.type = set("inputProps", value.asInstanceOf[js.Any])
    ...
    inline def value(value: FileList): this.type = set("value", value.asInstanceOf[js.Any])
    
    inline def widescreen(value: ResponsiveModifiersonlyBo): this.type = set("widescreen", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: InputFile.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: /* props */ InputFileProps & (ElementProps[InputFileProps, div])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
