...
import typingsJapgolly.reactBulmaComponents.srcComponentsContainerMod.ContainerProps
...
object Container {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def breakpoint(value: Breakpoint | fluid): this.type = set("breakpoint", value.asInstanceOf[js.Any])
    ...
    inline def max(value: Boolean): this.type = set("max", value.asInstanceOf[js.Any])
  ...
  def withProps(p: /* props */ ContainerProps & (ElementProps[ContainerProps, div])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
