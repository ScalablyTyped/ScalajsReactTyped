...
import typingsJapgolly.reactBulmaComponents.srcComponentsSectionMod.SectionProps
...
object Section {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def domRef(value: RefHandle[section]): this.type = set("domRef", value.asInstanceOf[js.Any])
    ...
    inline def renderAs(value: section): this.type = set("renderAs", value.asInstanceOf[js.Any])
    
    inline def shadowless(value: Boolean): this.type = set("shadowless", value.asInstanceOf[js.Any])
    
    inline def size(value: Exclude[Size, small]): this.type = set("size", value.asInstanceOf[js.Any])
  ...
  def withProps(p: /* props */ SectionProps & (ElementProps[SectionProps, section])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
