...
import typingsJapgolly.reactBulmaComponents.srcComponentsFormMod.TextareaProps
...
object Textarea {
  ...
  @JSImport("react-bulma-components", "Form.Textarea")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def domRef(value: RefHandle[textarea]): this.type = set("domRef", value.asInstanceOf[js.Any])
    
    inline def fixedSize(value: Boolean): this.type = set("fixedSize", value.asInstanceOf[js.Any])
    ...
    inline def renderAs(value: textarea): this.type = set("renderAs", value.asInstanceOf[js.Any])
  ...
  def withProps(p: OmitKeys[TextareaProps & (ElementProps[TextareaProps, textarea]), renderAs | readonly]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
