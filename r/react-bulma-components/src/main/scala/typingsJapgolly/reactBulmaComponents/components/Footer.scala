...
object Footer {
  ...
  implicit def make(companion: Footer.type): SharedBuilder_ObjectElementProps1309836731 = new SharedBuilder_ObjectElementProps1309836731(js.Array(this.component, js.Dictionary.empty))()
