...
import typingsJapgolly.reactBulmaComponents.reactBulmaComponentsStrings.progress
...
import typingsJapgolly.reactBulmaComponents.srcComponentsProgressMod.ProgressProps
...
object Progress {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def domRef(value: RefHandle[progress]): this.type = set("domRef", value.asInstanceOf[js.Any])
    ...
    inline def renderAs(value: progress): this.type = set("renderAs", value.asInstanceOf[js.Any])
  ...
  def withProps(p: /* props */ ProgressProps & (Omit[ElementProps[ProgressProps, progress], renderAs])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
