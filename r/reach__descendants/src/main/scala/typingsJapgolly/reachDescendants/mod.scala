...
import typingsJapgolly.reachDescendants.anon.Callback
import typingsJapgolly.reachDescendants.anon.Children
import typingsJapgolly.reachDescendants.reachDescendantsStrings.index
...
object mod {
  ...
  /**
    ...
    * @param options
    */
  inline def useDescendantKeyDown[DescendantType /* <: Descendant[HTMLElement] */, K /* <: /* keyof DescendantType */ String */](context: Context[DescendantContextValue[DescendantType]], options: Callback[K, DescendantType]): js.Function1[/* event */ ReactKeyboardEventFrom[org.scalajs.dom.Element], Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("useDescendantKeyDown")(context.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* event */ ReactKeyboardEventFrom[org.scalajs.dom.Element], Unit]]
