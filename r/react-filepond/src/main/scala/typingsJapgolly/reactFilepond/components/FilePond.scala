...
import typingsJapgolly.reactFilepond.mod.FilePondErrorDescription
...
object FilePond {
  def apply(
    ...
    beforeRemoveFile: /* file */ typingsJapgolly.reactFilepond.mod.File => CallbackTo[Boolean] = null,
    ...
    files: js.Array[typingsJapgolly.reactFilepond.mod.File] = null,
    ...
    name: String = null,
    onaddfile: (/* error */ FilePondErrorDescription, /* file */ typingsJapgolly.reactFilepond.mod.File) => Callback = null,
    onaddfileprogress: (/* file */ typingsJapgolly.reactFilepond.mod.File, /* progress */ Double) => Callback = null,
    onaddfilestart: /* file */ typingsJapgolly.reactFilepond.mod.File => Callback = null,
    onerror: (/* error */ FilePondErrorDescription, /* file */ js.UndefOr[typingsJapgolly.reactFilepond.mod.File], /* status */ js.UndefOr[js.Any]) => Callback = null,
    oninit: js.UndefOr[Callback] = js.undefined,
    onpreparefile: (/* file */ typingsJapgolly.reactFilepond.mod.File, /* output */ js.Any) => Callback = null,
    onprocessfile: (/* error */ FilePondErrorDescription, /* file */ typingsJapgolly.reactFilepond.mod.File) => Callback = null,
    onprocessfileabort: /* file */ typingsJapgolly.reactFilepond.mod.File => Callback = null,
    onprocessfileprogress: (/* file */ typingsJapgolly.reactFilepond.mod.File, /* progress */ Double) => Callback = null,
    onprocessfilestart: /* file */ typingsJapgolly.reactFilepond.mod.File => Callback = null,
    onprocessfileundo: /* file */ typingsJapgolly.reactFilepond.mod.File => Callback = null,
    onremovefile: /* file */ typingsJapgolly.reactFilepond.mod.File => Callback = null,
    onupdatefiles: /* fileItems */ js.Array[typingsJapgolly.reactFilepond.mod.File] => Callback = null,
    onwarning: (/* error */ js.Any, /* file */ js.UndefOr[typingsJapgolly.reactFilepond.mod.File], /* status */ js.UndefOr[js.Any]) => Callback = null,
  ...
  ): UnmountedWithRoot[FilePondProps, typingsJapgolly.reactFilepond.mod.FilePond, Unit, FilePondProps] = {
  ...
  typingsJapgolly.reactFilepond.mod.FilePondProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.reactFilepond.mod.FilePond](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactFilepond.mod.FilePondProps])
  }
