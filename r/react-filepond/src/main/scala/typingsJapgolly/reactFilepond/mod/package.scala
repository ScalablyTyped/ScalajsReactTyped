...
package object mod {
  type FetchServerConfigFunction = js.Function6[
    ...
    /* load */ js.Function1[/* file */ typingsJapgolly.reactFilepond.mod.ActualFileObject, scala.Unit], 
    /* error */ js.Function1[/* errorText */ java.lang.String, scala.Unit], 
    /* progress */ typingsJapgolly.reactFilepond.mod.ProgressServerConfigFunction, 
  ...
  type ProcessServerConfigFunction = js.Function7[
    ...
    /* file */ typingsJapgolly.reactFilepond.mod.ActualFileObject, 
