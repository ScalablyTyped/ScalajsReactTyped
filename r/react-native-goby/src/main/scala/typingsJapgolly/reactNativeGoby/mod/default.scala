...
object default {
  ...
  object CheckFrequency extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.reactNativeGoby.mod.Goby.CheckFrequency & Double] = js.native
    
    /* 2 */ val MANUAL: typingsJapgolly.reactNativeGoby.mod.Goby.CheckFrequency.MANUAL & Double = js.native
    
    /* 1 */ val ON_APP_RESUME: typingsJapgolly.reactNativeGoby.mod.Goby.CheckFrequency.ON_APP_RESUME & Double = js.native
    
    /* 0 */ val ON_APP_START: typingsJapgolly.reactNativeGoby.mod.Goby.CheckFrequency.ON_APP_START & Double = js.native
  }
  ...
  object DeploymentStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.reactNativeGoby.mod.Goby.DeploymentStatus & Double] = js.native
    
    /* 0 */ val FAILED: typingsJapgolly.reactNativeGoby.mod.Goby.DeploymentStatus.FAILED & Double = js.native
    
    /* 1 */ val SUCCEEDED: typingsJapgolly.reactNativeGoby.mod.Goby.DeploymentStatus.SUCCEEDED & Double = js.native
  }
  ...
  object InstallMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.reactNativeGoby.mod.Goby.InstallMode & Double] = js.native
    
    /* 0 */ val IMMEDIATE: typingsJapgolly.reactNativeGoby.mod.Goby.InstallMode.IMMEDIATE & Double = js.native
    
    /* 1 */ val ON_NEXT_RESTART: typingsJapgolly.reactNativeGoby.mod.Goby.InstallMode.ON_NEXT_RESTART & Double = js.native
    
    /* 2 */ val ON_NEXT_RESUME: typingsJapgolly.reactNativeGoby.mod.Goby.InstallMode.ON_NEXT_RESUME & Double = js.native
  }
  ...
  object SyncStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.reactNativeGoby.mod.Goby.SyncStatus & Double] = js.native
    
    /* 1 */ val AWAITING_USER_ACTION: typingsJapgolly.reactNativeGoby.mod.Goby.SyncStatus.AWAITING_USER_ACTION & Double = js.native
    
    /* 0 */ val CHECKING_FOR_UPDATE: typingsJapgolly.reactNativeGoby.mod.Goby.SyncStatus.CHECKING_FOR_UPDATE & Double = js.native
    
    /* 2 */ val DOWNLOADING_PACKAGE: typingsJapgolly.reactNativeGoby.mod.Goby.SyncStatus.DOWNLOADING_PACKAGE & Double = js.native
    
    /* 3 */ val INSTALLING_UPDATE: typingsJapgolly.reactNativeGoby.mod.Goby.SyncStatus.INSTALLING_UPDATE & Double = js.native
    
    /* 7 */ val SYNC_IN_PROGRESS: typingsJapgolly.reactNativeGoby.mod.Goby.SyncStatus.SYNC_IN_PROGRESS & Double = js.native
    
    /* 8 */ val UNKNOWN_ERROR: typingsJapgolly.reactNativeGoby.mod.Goby.SyncStatus.UNKNOWN_ERROR & Double = js.native
    
    /* 5 */ val UPDATE_IGNORED: typingsJapgolly.reactNativeGoby.mod.Goby.SyncStatus.UPDATE_IGNORED & Double = js.native
    
    /* 6 */ val UPDATE_INSTALLED: typingsJapgolly.reactNativeGoby.mod.Goby.SyncStatus.UPDATE_INSTALLED & Double = js.native
    
    /* 4 */ val UP_TO_DATE: typingsJapgolly.reactNativeGoby.mod.Goby.SyncStatus.UP_TO_DATE & Double = js.native
  }
  ...
  object UpdateState extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.reactNativeGoby.mod.Goby.UpdateState & Double] = js.native
    
    /* 2 */ val LATEST: typingsJapgolly.reactNativeGoby.mod.Goby.UpdateState.LATEST & Double = js.native
    
    /* 1 */ val PENDING: typingsJapgolly.reactNativeGoby.mod.Goby.UpdateState.PENDING & Double = js.native
    
    /* 0 */ val RUNNING: typingsJapgolly.reactNativeGoby.mod.Goby.UpdateState.RUNNING & Double = js.native
  }
