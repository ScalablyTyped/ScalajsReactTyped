...
import typingsJapgolly.reactNativePermissions.anon.ReadonlyreadonlyANDROIDRe
import typingsJapgolly.reactNativePermissions.anon.ReadonlyreadonlyAPPTRACKI
import typingsJapgolly.reactNativePermissions.anon.ReadonlyreadonlyUNAVAILAB
...
object mod {
  ...
  object default {
    ...
    inline def PERMISSIONS_=(x: ReadonlyreadonlyANDROIDRe): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PERMISSIONS")(x.asInstanceOf[js.Any])
    
    @JSImport("react-native-permissions", "default.RESULTS")
    @js.native
    def RESULTS: ReadonlyreadonlyUNAVAILAB = js.native
    inline def RESULTS_=(x: ReadonlyreadonlyUNAVAILAB): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RESULTS")(x.asInstanceOf[js.Any])
    
    inline def check(permission: Permission): js.Promise[PermissionStatus] = ^.asInstanceOf[js.Dynamic].applyDynamic("check")(permission.asInstanceOf[js.Any]).asInstanceOf[js.Promise[PermissionStatus]]
    ...
    inline def checkMultiple[P /* <: js.Array[Permission] */](permissions: P): js.Promise[
        Record[
          /* import warning: importer.ImportType#apply Failed type conversion: P[number] */ js.Any, 
          PermissionStatus
        ]
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("checkMultiple")(permissions.asInstanceOf[js.Any]).asInstanceOf[js.Promise[
        Record[
          /* import warning: importer.ImportType#apply Failed type conversion: P[number] */ js.Any, 
          PermissionStatus
        ]
    ...
    inline def request(permission: Permission): js.Promise[PermissionStatus] = ^.asInstanceOf[js.Dynamic].applyDynamic("request")(permission.asInstanceOf[js.Any]).asInstanceOf[js.Promise[PermissionStatus]]
    inline def request(permission: Permission, rationale: Rationale): js.Promise[PermissionStatus] = (^.asInstanceOf[js.Dynamic].applyDynamic("request")(permission.asInstanceOf[js.Any], rationale.asInstanceOf[js.Any])).asInstanceOf[js.Promise[PermissionStatus]]
    
    inline def requestLocationAccuracy(options: LocationAccuracyOptions): js.Promise[LocationAccuracy] = ^.asInstanceOf[js.Dynamic].applyDynamic("requestLocationAccuracy")(options.asInstanceOf[js.Any]).asInstanceOf[js.Promise[LocationAccuracy]]
    
    inline def requestMultiple[P_1 /* <: js.Array[Permission] */](permissions: P_1): js.Promise[
        Record[
          /* import warning: importer.ImportType#apply Failed type conversion: P_1[number] */ js.Any, 
          PermissionStatus
        ]
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("requestMultiple")(permissions.asInstanceOf[js.Any]).asInstanceOf[js.Promise[
        Record[
          /* import warning: importer.ImportType#apply Failed type conversion: P_1[number] */ js.Any, 
          PermissionStatus
        ]
  ...
  inline def requestMultiple[P /* <: js.Array[Permission] */](permissions: P): js.Promise[
    Record[
      /* import warning: importer.ImportType#apply Failed type conversion: P[number] */ js.Any, 
      PermissionStatus
    ]
