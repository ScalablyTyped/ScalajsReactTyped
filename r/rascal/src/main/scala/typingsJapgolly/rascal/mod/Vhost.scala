...
import typingsJapgolly.amqplib.mod.Channel
...
@js.native
open class Vhost () extends EventEmitter {
  ...
  def bounce(next: js.Function2[/* err */ js.UndefOr[js.Error], /* result */ js.UndefOr[Any], Unit]): Unit = js.native
