...
import typingsJapgolly.rgroveParseXml.rgroveParseXmlStrings.document
...
object mod {
  ...
  */
  ...
  object Node {
    ...
    inline def CData(text: String): typingsJapgolly.rgroveParseXml.mod.CData = {
      val __obj = js.Dynamic.literal(text = text.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("cdata")
      __obj.asInstanceOf[typingsJapgolly.rgroveParseXml.mod.CData]
    }
    
    inline def Comment(content: String): typingsJapgolly.rgroveParseXml.mod.Comment = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("comment")
      __obj.asInstanceOf[typingsJapgolly.rgroveParseXml.mod.Comment]
    }
    
    inline def Element(attributes: StringDictionary[String], children: js.Array[NodeBase], name: String): typingsJapgolly.rgroveParseXml.mod.Element = {
      val __obj = js.Dynamic.literal(attributes = attributes.asInstanceOf[js.Any], children = children.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("element")
      __obj.asInstanceOf[typingsJapgolly.rgroveParseXml.mod.Element]
    }
    
    inline def Text(text: String): typingsJapgolly.rgroveParseXml.mod.Text = {
      val __obj = js.Dynamic.literal(text = text.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("text")
      __obj.asInstanceOf[typingsJapgolly.rgroveParseXml.mod.Text]
    }
  }
