...
object distEs5ContextMod {
  ...
  trait UIDProps extends StObject {
    ...
    def children(id: String, uid: js.Function2[/* item */ Any, /* index */ js.UndefOr[Double], String]): Node
  ...
  object UIDProps {
    ...
    inline def apply(children: (String, js.Function2[/* item */ Any, /* index */ js.UndefOr[Double], String]) => Node): UIDProps = {
    ...
    extension [Self <: UIDProps](x: Self) {
      ...
      inline def setChildren(value: (String, js.Function2[/* item */ Any, /* index */ js.UndefOr[Double], String]) => Node): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
