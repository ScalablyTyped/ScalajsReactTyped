...
import typingsJapgolly.reactNavigationNative.anon.AccessibilityRole
import typingsJapgolly.reactNavigationNative.anon.DocumentTitle
import typingsJapgolly.reactNavigationNative.anon.ServerContextTypechildren
import typingsJapgolly.reactNavigationNative.libTypescriptSrcLinkMod.Props
...
import typingsJapgolly.reactNavigationNative.reactNavigationNativeStrings.key
...
object mod {
  ...
  @js.native
  val LinkingContext: Context[typingsJapgolly.reactNavigationNative.anon.Options] = js.native
  
  inline def NavigationContainer[RootParamList /* <: js.Object */](props: DocumentTitle[RootParamList] & NavigationContainerProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("NavigationContainer")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  inline def PreventRemoveProvider(hasChildren: typingsJapgolly.reactNavigationCore.libTypescriptSrcPreventRemoveProviderMod.Props): typingsJapgolly.react.mod.global.JSX.Element = ^.asInstanceOf[js.Dynamic].applyDynamic("PreventRemoveProvider")(hasChildren.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.react.mod.global.JSX.Element]
  
  @JSImport("@react-navigation/native", "PrivateValueStore")
  @js.native
  open class PrivateValueStore[T /* <: js.Tuple3[Any, Any, Any] */] ()
    extends typingsJapgolly.reactNavigationCore.mod.PrivateValueStore[T]
  ...
  inline def ThemeProvider(
    hasValueChildren: typingsJapgolly.reactNavigationNative.libTypescriptSrcThemingThemeProviderMod.Props
  ): typingsJapgolly.react.mod.global.JSX.Element = ^.asInstanceOf[js.Dynamic].applyDynamic("ThemeProvider")(hasValueChildren.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.react.mod.global.JSX.Element]
  ...
  inline def useLinkProps[ParamList /* <: RootParamList */](
    hasToAction: typingsJapgolly.reactNavigationNative.libTypescriptSrcUseLinkPropsMod.Props[ParamList]
  ): AccessibilityRole = ^.asInstanceOf[js.Dynamic].applyDynamic("useLinkProps")(hasToAction.asInstanceOf[js.Any]).asInstanceOf[AccessibilityRole]
