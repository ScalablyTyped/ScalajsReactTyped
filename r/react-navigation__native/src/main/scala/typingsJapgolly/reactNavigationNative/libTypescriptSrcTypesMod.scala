...
import typingsJapgolly.reactNavigationNative.anon.Background
import typingsJapgolly.reactNavigationNative.anon.Fn0
import typingsJapgolly.reactNavigationNative.anon.FnCall
import typingsJapgolly.reactNavigationNative.anon.FnCallStateOptions
import typingsJapgolly.reactNavigationNative.anon.InitialRouteName
...
object libTypescriptSrcTypesMod {
  ...
  object LinkingOptions {
    ...
    extension [Self <: LinkingOptions[?], ParamList /* <: js.Object */](x: Self & LinkingOptions[ParamList]) {
      ...
      inline def setGetInitialURL(value: CallbackTo[js.UndefOr[String | Null | (js.Promise[js.UndefOr[String | Null]])]]): Self = StObject.set(x, "getInitialURL", value.toJsFn)
