...
package object RSVP {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rsvp.mod.RSVP.Resolved[T]
    - typingsJapgolly.rsvp.mod.RSVP.Rejected[js.Any]
    - typingsJapgolly.rsvp.mod.RSVP.Pending
  */
  type PromiseState[T] = typingsJapgolly.rsvp.mod.RSVP._PromiseState[T] | typingsJapgolly.rsvp.mod.RSVP.Rejected[js.Any]
}
