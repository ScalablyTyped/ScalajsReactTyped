package typingsJapgolly.redactAxiosError
...
object mod {
  ...
  open class AxiosErrorGroomer ()
    extends typingsJapgolly.redactAxiosError.axiosErrorGroomerMod.AxiosErrorGroomer {
  ...
  @js.native
  val config: typingsJapgolly.redactAxiosError.axiosErrorGroomerMod.AxiosErrorGroomer | Null = js.native
  ...
  inline def getAxiosErrorInterceptor(axiosErrorGroomer: typingsJapgolly.redactAxiosError.axiosErrorGroomerMod.AxiosErrorGroomer): js.Function1[/* error */ Any, js.Promise[scala.Nothing]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getAxiosErrorInterceptor")(axiosErrorGroomer.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* error */ Any, js.Promise[scala.Nothing]]]
}
