...
object distUtilsThresholdMod {
  ...
  inline def parseThreshold(scrollThreshold: String): typingsJapgolly.reactInfiniteScrollComponent.anon.Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("parseThreshold")(scrollThreshold.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.reactInfiniteScrollComponent.anon.Unit]
  inline def parseThreshold(scrollThreshold: Double): typingsJapgolly.reactInfiniteScrollComponent.anon.Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("parseThreshold")(scrollThreshold.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.reactInfiniteScrollComponent.anon.Unit]
}
