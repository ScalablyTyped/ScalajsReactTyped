...
object distPdfjsDistMod {
  ...
  object default {
    ...
    open class AnnotationEditorLayer protected ()
      extends typingsJapgolly.pdfjsDist.mod.AnnotationEditorLayer {
      /**
    ...
    open class AnnotationEditorUIManager protected ()
      extends typingsJapgolly.pdfjsDist.mod.AnnotationEditorUIManager {
    ...
    open class AnnotationLayer ()
      extends typingsJapgolly.pdfjsDist.mod.AnnotationLayer
    /* static members */
    ...
    open class InvalidPDFException protected ()
      extends typingsJapgolly.pdfjsDist.mod.InvalidPDFException {
    ...
    open class LoopbackPort ()
      extends typingsJapgolly.pdfjsDist.mod.LoopbackPort
    
    @JSImport("react-pdf/dist/pdfjs-dist", "default.MissingPDFException")
    @js.native
    open class MissingPDFException protected ()
      extends typingsJapgolly.pdfjsDist.mod.MissingPDFException {
      def this(msg: Any) = this()
    }
    ...
    open class PDFDataRangeTransport protected ()
      extends typingsJapgolly.pdfjsDist.mod.PDFDataRangeTransport {
      /**
        * @param {number} length
    ...
    open class PDFDateString ()
      extends typingsJapgolly.pdfjsDist.mod.PDFDateString
    /* static members */
    ...
    open class PDFWorker ()
      extends typingsJapgolly.pdfjsDist.mod.PDFWorker {
    ...
    open class PixelsPerInch ()
      extends typingsJapgolly.pdfjsDist.mod.PixelsPerInch
    /* static members */
    ...
    open class RenderingCancelledException protected ()
      extends typingsJapgolly.pdfjsDist.mod.RenderingCancelledException {
    ...
    open class UnexpectedResponseException protected ()
      extends typingsJapgolly.pdfjsDist.mod.UnexpectedResponseException {
    ...
    @js.native
    open class Util ()
      extends typingsJapgolly.pdfjsDist.mod.Util
    /* static members */
    object Util {
    ...
    @js.native
    open class XfaLayer ()
      extends typingsJapgolly.pdfjsDist.mod.XfaLayer
    /* static members */
    object XfaLayer {
