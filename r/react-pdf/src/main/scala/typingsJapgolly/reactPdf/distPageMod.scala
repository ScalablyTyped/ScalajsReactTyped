...
import typingsJapgolly.reactPdf.reactPdfInts.`0`
import typingsJapgolly.reactPdf.reactPdfInts.`180`
import typingsJapgolly.reactPdf.reactPdfInts.`270`
import typingsJapgolly.reactPdf.reactPdfInts.`90`
...
object distPageMod {
  ...
  @js.native
  trait PDFPageProxy
    extends typingsJapgolly.pdfjsDist.typesSrcDisplayApiMod.PDFPageProxy {
  ...
  type Page = japgolly.scalajs.react.facade.React.Component[Props & js.Object, js.Object]
  ...
  trait Props extends StObject {
    ...
    /**
      ...
      */
    var error: js.UndefOr[String | japgolly.scalajs.react.facade.React.Element | RenderFunction] = js.undefined
    ...
    /**
      ...
      */
    var loading: js.UndefOr[String | japgolly.scalajs.react.facade.React.Element | RenderFunction] = js.undefined
    
    /**
      * Defines what the component should display in case of no data.
      * @default 'No page specified.'
      */
    var noData: js.UndefOr[String | japgolly.scalajs.react.facade.React.Element | RenderFunction] = js.undefined
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setError(value: String | japgolly.scalajs.react.facade.React.Element | RenderFunction): Self = StObject.set(x, "error", value.asInstanceOf[js.Any])
      
      inline def setErrorCallbackTo(value: CallbackTo[Element]): Self = StObject.set(x, "error", value.toJsFn)
      ...
      inline def setLoading(value: String | japgolly.scalajs.react.facade.React.Element | RenderFunction): Self = StObject.set(x, "loading", value.asInstanceOf[js.Any])
      
      inline def setLoadingCallbackTo(value: CallbackTo[Element]): Self = StObject.set(x, "loading", value.toJsFn)
      ...
      inline def setNoData(value: String | japgolly.scalajs.react.facade.React.Element | RenderFunction): Self = StObject.set(x, "noData", value.asInstanceOf[js.Any])
      
      inline def setNoDataCallbackTo(value: CallbackTo[Element]): Self = StObject.set(x, "noData", value.toJsFn)
      ...
      ): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[org.scalajs.dom.Element], t1: /* page */ PDFPageProxy) => (value(t0, t1)).runNow()))
      
      inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
      
      inline def setOnGetAnnotationsError(value: /* error */ js.Error => Callback): Self = StObject.set(x, "onGetAnnotationsError", js.Any.fromFunction1((t0: /* error */ js.Error) => value(t0).runNow()))
      
      inline def setOnGetAnnotationsErrorUndefined: Self = StObject.set(x, "onGetAnnotationsError", js.undefined)
      
      inline def setOnGetAnnotationsSuccess(value: /* annotations */ Any => Callback): Self = StObject.set(x, "onGetAnnotationsSuccess", js.Any.fromFunction1((t0: /* annotations */ Any) => value(t0).runNow()))
      
      inline def setOnGetAnnotationsSuccessUndefined: Self = StObject.set(x, "onGetAnnotationsSuccess", js.undefined)
      
      inline def setOnGetTextError(value: /* error */ js.Error => Callback): Self = StObject.set(x, "onGetTextError", js.Any.fromFunction1((t0: /* error */ js.Error) => value(t0).runNow()))
      
      inline def setOnGetTextErrorUndefined: Self = StObject.set(x, "onGetTextError", js.undefined)
      
      inline def setOnGetTextSuccess(value: /* items */ js.Array[TextItem] => Callback): Self = StObject.set(x, "onGetTextSuccess", js.Any.fromFunction1((t0: /* items */ js.Array[TextItem]) => value(t0).runNow()))
      ...
      inline def setOnLoadSuccess(value: /* page */ PDFPageProxy => Callback): Self = StObject.set(x, "onLoadSuccess", js.Any.fromFunction1((t0: /* page */ PDFPageProxy) => value(t0).runNow()))
      
      inline def setOnLoadSuccessUndefined: Self = StObject.set(x, "onLoadSuccess", js.undefined)
      
      inline def setOnRenderError(value: /* error */ js.Error => Callback): Self = StObject.set(x, "onRenderError", js.Any.fromFunction1((t0: /* error */ js.Error) => value(t0).runNow()))
      
      inline def setOnRenderErrorUndefined: Self = StObject.set(x, "onRenderError", js.undefined)
      
      inline def setOnRenderSuccess(value: /* page */ PDFPageProxy => Callback): Self = StObject.set(x, "onRenderSuccess", js.Any.fromFunction1((t0: /* page */ PDFPageProxy) => value(t0).runNow()))
