...
import typingsJapgolly.reactCountdownCircleTimer.libMod.ColorHex
import typingsJapgolly.reactCountdownCircleTimer.libMod.OnComplete
import typingsJapgolly.reactCountdownCircleTimer.libMod.Props
...
object anon {
  ...
  trait MultipleColorsdurationnum
    ...
    var children: js.UndefOr[js.Function1[/* props */ TimeProps, Node]] = js.undefined
  ...
  object MultipleColorsdurationnum {
    ...
    extension [Self <: MultipleColorsdurationnum](x: Self) {
      ...
      inline def setChildren(value: /* props */ TimeProps => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      inline def setOnUpdate(value: /* remainingTime */ Double => Callback): Self = StObject.set(x, "onUpdate", js.Any.fromFunction1((t0: /* remainingTime */ Double) => value(t0).runNow()))
