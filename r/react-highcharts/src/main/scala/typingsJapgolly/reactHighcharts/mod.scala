package typingsJapgolly.reactHighcharts
...
object mod {
  ...
  /**
    * React interface for highcharts.
    */
  type ReactHighcharts = japgolly.scalajs.react.facade.React.Component[ReactHighchartsProps & js.Object, js.Object]
  ...
  object ReactHighchartsProps {
    ...
    extension [Self <: ReactHighchartsProps](x: Self) {
      ...
      ): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Highcharts.ChartObject */ /* chart */ Any) => value(t0).runNow()))
