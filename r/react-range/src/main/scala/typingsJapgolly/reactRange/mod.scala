...
import typingsJapgolly.reactRange.libRangeMod.default
import typingsJapgolly.reactRange.libTypesMod.Direction
import typingsJapgolly.reactRange.libTypesMod.IProps
import typingsJapgolly.reactRange.libTypesMod.ITrackBackground
...
object mod {
  ...
  object Direction extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.reactRange.libTypesMod.Direction & String] = js.native
