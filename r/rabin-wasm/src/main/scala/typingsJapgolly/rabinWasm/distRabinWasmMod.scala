...
import typingsJapgolly.rabinWasm.distRabinWasmMod.ASModule.i32
import typingsJapgolly.rabinWasm.distRabinWasmMod.ASModule.u32
import typingsJapgolly.rabinWasm.distRabinWasmMod.ASModule.u64
import typingsJapgolly.rabinWasm.distRabinWasmMod.ASModule.usize
...
object distRabinWasmMod {
  ...
  object default {
    ...
    open class Rabin protected ()
      extends StObject
         with typingsJapgolly.rabinWasm.distRabinWasmMod.ASModule.Rabin {
