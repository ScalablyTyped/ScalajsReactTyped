...
import typingsJapgolly.restifyPlugins.AnonHeaders
import typingsJapgolly.restifyPlugins.AnonMessage
import typingsJapgolly.restifyPlugins.AnonUserAgentRegExp
