...
object mod {
  ...
  trait AuditLoggerOptions extends StObject {
    ...
    /**
      ...
      */
    var server: js.UndefOr[typingsJapgolly.restify.mod.Server] = js.undefined
  }
  object AuditLoggerOptions {
    
    inline def apply(log: typingsJapgolly.bunyan.mod.^): AuditLoggerOptions = {
  ...
  object BodyParserOptions {
    ...
    extension [Self <: BodyParserOptions](x: Self) {
      ...
      inline def setMultipartFileHandler(value: Callback): Self = StObject.set(x, "multipartFileHandler", value.toJsFn)
      
      inline def setMultipartFileHandlerUndefined: Self = StObject.set(x, "multipartFileHandler", js.undefined)
      
      inline def setMultipartHandler(value: Callback): Self = StObject.set(x, "multipartHandler", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.restifyPlugins.restifyPluginsStrings.close
    - typingsJapgolly.restifyPlugins.restifyPluginsStrings.aborted
    - scala.Unit
  */
