package typingsJapgolly.riotApiNodejs

import typingsJapgolly.riotGamesApi.RiotGamesAPI.Champion.ChampionDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.Champion.ChampionListDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.ChampionMastery.ChampionMasteryDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.CurrentGame.CurrentGameInfo
import typingsJapgolly.riotGamesApi.RiotGamesAPI.FeaturedGames.FeaturedGames
import typingsJapgolly.riotGamesApi.RiotGamesAPI.Game.RecentGamesDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.League.LeagueDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStaticData.ItemDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStaticData.ItemListDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStaticData.LanguageStringsDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStaticData.MapDataDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStaticData.MasteryDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStaticData.MasteryListDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStaticData.RealmDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStaticData.RuneDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStaticData.RuneListDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStaticData.SummonerSpellDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStaticData.SummonerSpellListDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStatus.Shard
import typingsJapgolly.riotGamesApi.RiotGamesAPI.Match.MatchDetail
import typingsJapgolly.riotGamesApi.RiotGamesAPI.MatchList.MatchList
import typingsJapgolly.riotGamesApi.RiotGamesAPI.Stats.PlayerStatsSummaryListDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.Stats.RankedStatsDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.Summoner.MasteryPagesDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.Summoner.RunePagesDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.Summoner.SummonerDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.Team.TeamDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.TournamentProvider.LobbyEventDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.TournamentProvider.TournamentCodeDto
import typingsJapgolly.riotGamesApi.RiotGamesAPI.TournamentProvider.TournamentCodeParameters
import typingsJapgolly.riotGamesApi.RiotGamesAPI.TournamentProvider.TournamentCodeUpdateParameters
...
object mod {
  ...
  open class ClassicAPI protected () extends API {
    ...
    /**
      ...
      */
    def staticDataChampionById(championsId: Double): js.Promise[typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStaticData.ChampionDto] = js.native
    
    /**
      * get Champions (static data)
      * @param     {RiotGamesAPI.LolStaticData.ChampionListDto}    callback    data callback
      */
    def staticDataChampions(): js.Promise[typingsJapgolly.riotGamesApi.RiotGamesAPI.LolStaticData.ChampionListDto] = js.native
  ...
  object regionE extends StObject {
    ...
    sealed trait BR
      extends StObject
         with regionE
    /* 0 */ val BR: typingsJapgolly.riotApiNodejs.mod.regionE.BR & Double = js.native
    
    @js.native
    sealed trait EUNE
      extends StObject
         with regionE
    /* 1 */ val EUNE: typingsJapgolly.riotApiNodejs.mod.regionE.EUNE & Double = js.native
    
    @js.native
    sealed trait EUW
      extends StObject
         with regionE
    /* 2 */ val EUW: typingsJapgolly.riotApiNodejs.mod.regionE.EUW & Double = js.native
    
    @js.native
    sealed trait KR
      extends StObject
         with regionE
    /* 3 */ val KR: typingsJapgolly.riotApiNodejs.mod.regionE.KR & Double = js.native
    
    @js.native
    sealed trait LAN
      extends StObject
         with regionE
    /* 4 */ val LAN: typingsJapgolly.riotApiNodejs.mod.regionE.LAN & Double = js.native
    
    @js.native
    sealed trait LAS
      extends StObject
         with regionE
    /* 5 */ val LAS: typingsJapgolly.riotApiNodejs.mod.regionE.LAS & Double = js.native
    
    @js.native
    sealed trait NA
      extends StObject
         with regionE
    /* 6 */ val NA: typingsJapgolly.riotApiNodejs.mod.regionE.NA & Double = js.native
    
    @js.native
    sealed trait OCE
      extends StObject
         with regionE
    /* 7 */ val OCE: typingsJapgolly.riotApiNodejs.mod.regionE.OCE & Double = js.native
    
    @js.native
    sealed trait PBE
      extends StObject
         with regionE
    /* 10 */ val PBE: typingsJapgolly.riotApiNodejs.mod.regionE.PBE & Double = js.native
    
    @js.native
    sealed trait RU
      extends StObject
         with regionE
    /* 9 */ val RU: typingsJapgolly.riotApiNodejs.mod.regionE.RU & Double = js.native
    
    @js.native
    sealed trait TR
      extends StObject
         with regionE
    /* 8 */ val TR: typingsJapgolly.riotApiNodejs.mod.regionE.TR & Double = js.native
  }
}
