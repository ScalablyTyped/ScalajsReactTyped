...
import typingsJapgolly.reactNativeLinearGradient.anon.X
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@scala.inline
open class SharedBuilder_LinearGradientProps1232983835[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def angleCenter(value: X): this.type = set("angleCenter", value.asInstanceOf[js.Any])
  
  inline def collapsable(value: Boolean): this.type = set("collapsable", value.asInstanceOf[js.Any])
  
  inline def end(value: X): this.type = set("end", value.asInstanceOf[js.Any])
  ...
  inline def start(value: X): this.type = set("start", value.asInstanceOf[js.Any])
  ...
  inline def useAngle(value: Boolean): this.type = set("useAngle", value.asInstanceOf[js.Any])
}
