...
import typingsJapgolly.reactNativeLinearGradient.AnonX
import typingsJapgolly.reactNativeLinearGradient.mod.LinearGradientProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_LinearGradientProps_711380662[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[LinearGradientProps, ComponentRef, Unit, LinearGradientProps] = {
  ...
  typingsJapgolly.reactNativeLinearGradient.mod.LinearGradientProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeLinearGradient.mod.LinearGradientProps])(children: _*)
  }
}
