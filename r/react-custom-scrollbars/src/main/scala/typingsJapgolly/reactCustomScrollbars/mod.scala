package typingsJapgolly.reactCustomScrollbars
...
object mod {
  ...
  object ScrollbarProps {
    ...
    extension [Self <: ScrollbarProps](x: Self) {
      ...
      inline def setOnScrollFrame(value: /* values */ positionValues => Callback): Self = StObject.set(x, "onScrollFrame", js.Any.fromFunction1((t0: /* values */ positionValues) => value(t0).runNow()))
      ...
      inline def setOnScrollStop(value: Callback): Self = StObject.set(x, "onScrollStop", value.toJsFn)
      
      inline def setOnScrollStopUndefined: Self = StObject.set(x, "onScrollStop", js.undefined)
      
      inline def setOnScrollUndefined: Self = StObject.set(x, "onScroll", js.undefined)
      
      inline def setOnUpdate(value: /* values */ positionValues => Callback): Self = StObject.set(x, "onUpdate", js.Any.fromFunction1((t0: /* values */ positionValues) => value(t0).runNow()))
