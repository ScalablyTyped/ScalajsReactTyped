...
object ReactFontawesome {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def cssModule(value: Any): this.type = set("cssModule", value.asInstanceOf[js.Any])
    ...
    inline def flip(value: FontAwesomeFlip): this.type = set("flip", value.asInstanceOf[js.Any])
    ...
    inline def size(value: FontAwesomeSize): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    inline def stack(value: FontAwesomeStack): this.type = set("stack", value.asInstanceOf[js.Any])
