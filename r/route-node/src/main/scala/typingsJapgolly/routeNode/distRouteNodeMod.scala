...
import typingsJapgolly.routeNode.routeNodeStrings.query
import typingsJapgolly.routeNode.routeNodeStrings.url
...
object distRouteNodeMod {
  ...
  */
  ...
  object QueryParamsMode {
    ...
    inline def default: typingsJapgolly.routeNode.routeNodeStrings.default = "default".asInstanceOf[typingsJapgolly.routeNode.routeNodeStrings.default]
    
    inline def loose: typingsJapgolly.routeNode.routeNodeStrings.loose = "loose".asInstanceOf[typingsJapgolly.routeNode.routeNodeStrings.loose]
    
    inline def strict: typingsJapgolly.routeNode.routeNodeStrings.strict = "strict".asInstanceOf[typingsJapgolly.routeNode.routeNodeStrings.strict]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.routeNode.distRouteNodeMod.RouteNode
    - typingsJapgolly.routeNode.distRouteNodeMod.RouteDefinition
  */
  ...
  */
  ...
  object TrailingSlashMode {
    ...
    inline def always: typingsJapgolly.routeNode.routeNodeStrings.always = "always".asInstanceOf[typingsJapgolly.routeNode.routeNodeStrings.always]
    
    inline def never: typingsJapgolly.routeNode.routeNodeStrings.never = "never".asInstanceOf[typingsJapgolly.routeNode.routeNodeStrings.never]
  }
}
