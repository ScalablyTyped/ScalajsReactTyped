...
object AsyncTypeahead {
  def apply[T /* <: TypeaheadModel */](
    ...
    typingsJapgolly.reactBootstrapTypeahead.mod.AsyncTypeahead[T], 
    Unit, 
    AsyncTypeaheadProps[T]
  ] = {
  ...
  typingsJapgolly.reactBootstrapTypeahead.mod.AsyncTypeaheadProps[T], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactBootstrapTypeahead.mod.AsyncTypeahead[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactBootstrapTypeahead.mod.AsyncTypeaheadProps[T]])(children: _*)
  }
