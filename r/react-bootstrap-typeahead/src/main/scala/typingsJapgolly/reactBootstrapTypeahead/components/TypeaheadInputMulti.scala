...
object TypeaheadInputMulti {
  def apply[T /* <: TypeaheadModel */](
    ...
    typingsJapgolly.reactBootstrapTypeahead.mod.TypeaheadInputMulti[T], 
    Unit, 
    TypeaheadMulitInputWithHocProps[T]
  ] = {
  ...
  typingsJapgolly.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.input with org.scalajs.dom.raw.Element]) => onAbort(t0).runNow()))
    if (onAdd != null) __obj.updateDynamic("onAdd")(js.Any.fromFunction1((t0: T) => onAdd(t0).runNow()))
  ...
  typingsJapgolly.reactBootstrapTypeahead.mod.TypeaheadMulitInputWithHocProps[T], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactBootstrapTypeahead.mod.TypeaheadInputMulti[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactBootstrapTypeahead.mod.TypeaheadMulitInputWithHocProps[T]])(children: _*)
  }
