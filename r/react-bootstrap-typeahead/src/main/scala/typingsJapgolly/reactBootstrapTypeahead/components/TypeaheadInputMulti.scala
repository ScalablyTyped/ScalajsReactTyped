...
import typingsJapgolly.reactBootstrapTypeahead.mod.TypeaheadMulitInputWithHocProps
...
object TypeaheadInputMulti {
  ...
  inline def apply[T /* <: TypeaheadModel */](
    ...
    __props.updateDynamic("aria-haspopup")("listbox")
  ...
  open class Builder[T /* <: TypeaheadModel */] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactBootstrapTypeahead.mod.TypeaheadInputMulti[T]] {
    ...
    inline def hintText(value: String): this.type = set("hintText", value.asInstanceOf[js.Any])
    
    inline def id(value: String): this.type = set("id", value.asInstanceOf[js.Any])
    
    inline def initialItem(value: T): this.type = set("initialItem", value.asInstanceOf[js.Any])
    ...
    inline def onAdd(value: T => Callback): this.type = set("onAdd", js.Any.fromFunction1((t0: T) => value(t0).runNow()))
    ...
    inline def shouldSelectHint(value: (/* shouldSelect */ Boolean, /* e */ ReactKeyboardEventFrom[HTMLInputElement]) => Boolean): this.type = set("shouldSelectHint", js.Any.fromFunction2(value))
