...
object Token {
  ...
  inline def apply(option: Option): Builder = {
    val __props = js.Dynamic.literal(option = option.asInstanceOf[js.Any])
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactBootstrapTypeahead.mod.Token] {
