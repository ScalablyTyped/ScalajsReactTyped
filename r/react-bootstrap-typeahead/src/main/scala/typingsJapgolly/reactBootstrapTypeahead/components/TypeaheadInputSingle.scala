...
import typingsJapgolly.reactBootstrapTypeahead.mod.TypeaheadSingleInputWithHocProps
...
object TypeaheadInputSingle {
  def apply[T /* <: TypeaheadModel */](
    ...
    typingsJapgolly.reactBootstrapTypeahead.mod.TypeaheadInputSingle[T], 
    Unit, 
    TypeaheadSingleInputWithHocProps[T]
  ] = {
  ...
  typingsJapgolly.reactBootstrapTypeahead.mod.TypeaheadSingleInputWithHocProps[T], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactBootstrapTypeahead.mod.TypeaheadInputSingle[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactBootstrapTypeahead.mod.TypeaheadSingleInputWithHocProps[T]])(children: _*)
  }
