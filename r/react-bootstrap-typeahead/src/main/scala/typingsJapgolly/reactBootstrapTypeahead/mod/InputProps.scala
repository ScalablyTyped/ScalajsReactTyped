...
/* Inlined parent react-bootstrap-typeahead.react-bootstrap-typeahead.Omit<react.react.InputHTMLAttributes<'input'>, 'onBlur' | 'onChange' | 'onFocus' | 'onKeyDown'> */
trait InputProps extends js.Object {
  ...
  var onClick: js.UndefOr[MouseEventHandler[input]] = js.undefined
...
object InputProps {
  ...
  def apply(
    ...
    onClick: ReactMouseEventFrom[input with Element] => Callback = null,
  ...
  typingsJapgolly.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.input with org.scalajs.dom.raw.Element]) => onClick(t0).runNow()))
