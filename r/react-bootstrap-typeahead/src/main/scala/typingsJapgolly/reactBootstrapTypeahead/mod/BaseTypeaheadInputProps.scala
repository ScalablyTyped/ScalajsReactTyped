...
object BaseTypeaheadInputProps {
  ...
  def apply(
    ...
    `aria-relevant`: additions | (`additions text`) | all | removals | typingsJapgolly.react.reactStrings.text = null,
    ...
    id: String = null,
    inlist: js.Any = null,
    inputMode: none | typingsJapgolly.react.reactStrings.text | tel | url | email | numeric | decimal | search = null,
    is: String = null,
    itemID: String = null,
    ...
    onBlur: ReactFocusEventFrom[input with Element] => Callback = null,
    ...
    onChange: ReactEventFrom[input with Element] => Callback = null,
    ...
    onFocus: ReactFocusEventFrom[input with Element] => Callback = null,
    onInput: ReactEventFrom[input with Element] => Callback = null,
    onInvalid: ReactEventFrom[input with Element] => Callback = null,
    onKeyDown: ReactKeyboardEventFrom[input with Element] => Callback = null,
  ...
  typingsJapgolly.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.input with org.scalajs.dom.raw.Element]) => onBlur(t0).runNow()))
  ...
  typingsJapgolly.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.input with org.scalajs.dom.raw.Element]) => onChange(t0).runNow()))
  ...
  typingsJapgolly.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.input with org.scalajs.dom.raw.Element]) => onFocus(t0).runNow()))
  ...
  typingsJapgolly.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.input with org.scalajs.dom.raw.Element]) => onKeyDown(t0).runNow()))
