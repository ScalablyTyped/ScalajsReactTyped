...
trait TypeaheadMulitInputWithHocProps[T /* <: TypeaheadModel */] extends StObject {
  ...
  var onBlur: js.Function1[/* e */ ReactEventFrom[Element], Unit]
  ...
  var onClick: js.Function1[/* e */ ReactEventFrom[HTMLInputElement], Unit]
  ...
  var onFocus: js.Function1[/* e */ ReactEventFrom[Element], Unit]
  ...
  var onKeyDown: js.Function1[/* e */ ReactEventFrom[Element], Unit]
  ...
  var shouldSelectHint: js.UndefOr[ShouldSelect] = js.undefined
...
object TypeaheadMulitInputWithHocProps {
  ...
  inline def apply[T /* <: TypeaheadModel */](
    ...
    onBlur: /* e */ ReactEventFrom[Element] => Callback,
    onChange: /* selected */ js.Array[T] => Callback,
    onClick: /* e */ ReactEventFrom[HTMLInputElement] => Callback,
    onFocus: /* e */ ReactEventFrom[Element] => Callback,
    onKeyDown: /* e */ ReactEventFrom[Element] => Callback,
    onRemove: Event => Callback,
    renderToken: (T, TypeaheadMenuProps[T], Double) => Node,
    selected: js.Array[T],
    value: String
  ): TypeaheadMulitInputWithHocProps[T] = {
    val __obj = js.Dynamic.literal(autoComplete = autoComplete.asInstanceOf[js.Any], disabled = disabled.asInstanceOf[js.Any], inputClassName = inputClassName.asInstanceOf[js.Any], labelKey = labelKey.asInstanceOf[js.Any], onBlur = js.Any.fromFunction1((t0: /* e */ ReactEventFrom[Element]) => onBlur(t0).runNow()), onChange = js.Any.fromFunction1((t0: /* selected */ js.Array[T]) => onChange(t0).runNow()), onClick = js.Any.fromFunction1((t0: /* e */ ReactEventFrom[HTMLInputElement]) => onClick(t0).runNow()), onFocus = js.Any.fromFunction1((t0: /* e */ ReactEventFrom[Element]) => onFocus(t0).runNow()), onKeyDown = js.Any.fromFunction1((t0: /* e */ ReactEventFrom[Element]) => onKeyDown(t0).runNow()), onRemove = js.Any.fromFunction1((t0: Event) => onRemove(t0).runNow()), renderToken = js.Any.fromFunction3(renderToken), role = "", selected = selected.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any], inputRef = null)
  ...
  extension [Self <: TypeaheadMulitInputWithHocProps[?], T /* <: TypeaheadModel */](x: Self & TypeaheadMulitInputWithHocProps[T]) {
    ...
    inline def setOnBlur(value: /* e */ ReactEventFrom[Element] => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: /* e */ ReactEventFrom[Element]) => value(t0).runNow()))
    ...
    inline def setOnClick(value: /* e */ ReactEventFrom[HTMLInputElement] => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction1((t0: /* e */ ReactEventFrom[HTMLInputElement]) => value(t0).runNow()))
    ...
    inline def setOnFocus(value: /* e */ ReactEventFrom[Element] => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: /* e */ ReactEventFrom[Element]) => value(t0).runNow()))
    ...
    inline def setOnKeyDown(value: /* e */ ReactEventFrom[Element] => Callback): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1((t0: /* e */ ReactEventFrom[Element]) => value(t0).runNow()))
    ...
    inline def setOnMouseDown(value: ReactMouseEventFrom[HTMLInputElement & Element] => Callback): Self = StObject.set(x, "onMouseDown", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLInputElement & Element]) => value(t0).runNow()))
    ...
    inline def setOnMouseUp(value: ReactMouseEventFrom[HTMLInputElement & Element] => Callback): Self = StObject.set(x, "onMouseUp", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLInputElement & Element]) => value(t0).runNow()))
    ...
    inline def setOnRemove(value: Event => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction1((t0: Event) => value(t0).runNow()))
    ...
    inline def setRenderToken(value: (T, TypeaheadMenuProps[T], Double) => Node): Self = StObject.set(x, "renderToken", js.Any.fromFunction3(value))
    ...
    inline def setShouldSelectHint(value: (/* shouldSelect */ Boolean, /* e */ ReactKeyboardEventFrom[HTMLInputElement]) => Boolean): Self = StObject.set(x, "shouldSelectHint", js.Any.fromFunction2(value))
    
    inline def setShouldSelectHintUndefined: Self = StObject.set(x, "shouldSelectHint", js.undefined)
