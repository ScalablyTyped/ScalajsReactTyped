...
trait TypeaheadProps[T /* <: TypeaheadModel */] extends StObject {
  ...
  var children: js.UndefOr[Node | (js.Function1[/* props */ Any, Node])] = js.undefined
  ...
  var renderInput: js.UndefOr[
    js.Function2[/* inputProps */ InputContainerPropsSingle[T], /* state */ TypeaheadState[T], Node]
  ] = js.undefined
...
object TypeaheadProps {
  ...
  extension [Self <: TypeaheadProps[?], T /* <: TypeaheadModel */](x: Self & TypeaheadProps[T]) {
    ...
    inline def setChildren(value: Node | (js.Function1[/* props */ Any, Node])): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
    
    inline def setChildrenFunction1(value: /* props */ Any => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    ...
    inline def setEmptyLabelVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "emptyLabel", js.Array(value*))
    ...
    inline def setOnInputChange(value: (/* input */ String, /* e */ Event) => Callback): Self = StObject.set(x, "onInputChange", js.Any.fromFunction2((t0: /* input */ String, t1: /* e */ Event) => (value(t0, t1)).runNow()))
    ...
    inline def setOnPaginate(value: (/* e */ Event, /* numResults */ Double) => Callback): Self = StObject.set(x, "onPaginate", js.Any.fromFunction2((t0: /* e */ Event, t1: /* numResults */ Double) => (value(t0, t1)).runNow()))
    ...
    inline def setRenderInput(value: (/* inputProps */ InputContainerPropsSingle[T], /* state */ TypeaheadState[T]) => Node): Self = StObject.set(x, "renderInput", js.Any.fromFunction2(value))
