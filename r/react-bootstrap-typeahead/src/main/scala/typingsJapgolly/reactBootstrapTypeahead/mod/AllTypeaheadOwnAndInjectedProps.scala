...
- typingsJapgolly.reactBootstrapTypeahead.mod.TypeaheadContainerProps because var conflicts: selected. Inlined activeIndex, activeItem, initialItem, isFocused, showMenu, shownResults, text */ trait AllTypeaheadOwnAndInjectedProps[T /* <: TypeaheadModel */]
  extends StObject
