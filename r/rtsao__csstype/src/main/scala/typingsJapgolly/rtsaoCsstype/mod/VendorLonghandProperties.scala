...
object VendorLonghandProperties {
  ...
  extension [Self <: VendorLonghandProperties[?], TLength](x: Self & VendorLonghandProperties[TLength]) {
    ...
    inline def setMsGridColumns(value: GridAutoColumnsProperty[TLength]): Self = StObject.set(x, "msGridColumns", value.asInstanceOf[js.Any])
    
    inline def setMsGridColumnsUndefined: Self = StObject.set(x, "msGridColumns", js.undefined)
    
    inline def setMsGridRows(value: GridAutoRowsProperty[TLength]): Self = StObject.set(x, "msGridRows", value.asInstanceOf[js.Any])
    ...
    inline def setMsTextSizeAdjust(value: TextSizeAdjustProperty): Self = StObject.set(x, "msTextSizeAdjust", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitColorAdjust(value: ColorAdjustProperty): Self = StObject.set(x, "WebkitColorAdjust", value.asInstanceOf[js.Any])
