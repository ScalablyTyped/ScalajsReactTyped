...
object CounterStyleFallback {
  ...
  extension [Self <: CounterStyleFallback](x: Self) {
    ...
    inline def setAdditiveSymbolsVarargs(value: String*): Self = StObject.set(x, "additiveSymbols", js.Array(value*))
    ...
    inline def setSpeakAsVarargs(value: CounterStyleSpeakAsProperty*): Self = StObject.set(x, "speakAs", js.Array(value*))
