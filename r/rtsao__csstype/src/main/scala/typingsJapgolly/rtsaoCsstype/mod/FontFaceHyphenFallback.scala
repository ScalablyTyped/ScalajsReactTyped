...
object FontFaceHyphenFallback {
  ...
  extension [Self <: FontFaceHyphenFallback](x: Self) {
    ...
    inline def `set-moz-font-feature-settingsVarargs`(value: FontFaceFontFeatureSettingsProperty*): Self = StObject.set(x, "-moz-font-feature-settings", js.Array(value*))
    ...
    inline def `setFont-displayVarargs`(value: FontFaceFontDisplayProperty*): Self = StObject.set(x, "font-display", js.Array(value*))
    ...
    inline def `setFont-familyVarargs`(value: String*): Self = StObject.set(x, "font-family", js.Array(value*))
    ...
    inline def `setFont-feature-settingsVarargs`(value: FontFaceFontFeatureSettingsProperty*): Self = StObject.set(x, "font-feature-settings", js.Array(value*))
    ...
    inline def `setFont-stretchVarargs`(value: FontFaceFontStretchProperty*): Self = StObject.set(x, "font-stretch", js.Array(value*))
    ...
    inline def `setFont-styleVarargs`(value: FontFaceFontStyleProperty*): Self = StObject.set(x, "font-style", js.Array(value*))
    ...
    inline def `setFont-variantVarargs`(value: FontFaceFontVariantProperty*): Self = StObject.set(x, "font-variant", js.Array(value*))
    ...
    inline def `setFont-variation-settingsVarargs`(value: FontFaceFontVariationSettingsProperty*): Self = StObject.set(x, "font-variation-settings", js.Array(value*))
    ...
    inline def `setFont-weightVarargs`(value: FontFaceFontWeightProperty*): Self = StObject.set(x, "font-weight", js.Array(value*))
    ...
    inline def `setUnicode-rangeVarargs`(value: String*): Self = StObject.set(x, "unicode-range", js.Array(value*))
  }
}
