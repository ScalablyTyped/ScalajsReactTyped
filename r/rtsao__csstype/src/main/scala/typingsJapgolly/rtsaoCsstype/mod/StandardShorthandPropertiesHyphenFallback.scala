...
object StandardShorthandPropertiesHyphenFallback {
  ...
  extension [Self <: StandardShorthandPropertiesHyphenFallback[?], TLength](x: Self & StandardShorthandPropertiesHyphenFallback[TLength]) {
    ...
    inline def `setBorder-block-endVarargs`(value: BorderBlockEndProperty[TLength]*): Self = StObject.set(x, "border-block-end", js.Array(value*))
    ...
    inline def `setBorder-block-startVarargs`(value: BorderBlockStartProperty[TLength]*): Self = StObject.set(x, "border-block-start", js.Array(value*))
    
    inline def `setBorder-blockUndefined`: Self = StObject.set(x, "border-block", js.undefined)
    
    inline def `setBorder-blockVarargs`(value: BorderBlockProperty[TLength]*): Self = StObject.set(x, "border-block", js.Array(value*))
    ...
    inline def `setBorder-bottomVarargs`(value: BorderBottomProperty[TLength]*): Self = StObject.set(x, "border-bottom", js.Array(value*))
    ...
    inline def `setBorder-colorVarargs`(value: BorderColorProperty*): Self = StObject.set(x, "border-color", js.Array(value*))
    ...
    inline def `setBorder-imageVarargs`(value: BorderImageProperty*): Self = StObject.set(x, "border-image", js.Array(value*))
    ...
    inline def `setBorder-inline-endVarargs`(value: BorderInlineEndProperty[TLength]*): Self = StObject.set(x, "border-inline-end", js.Array(value*))
    ...
    inline def `setBorder-inline-startVarargs`(value: BorderInlineStartProperty[TLength]*): Self = StObject.set(x, "border-inline-start", js.Array(value*))
    
    inline def `setBorder-inlineUndefined`: Self = StObject.set(x, "border-inline", js.undefined)
    
    inline def `setBorder-inlineVarargs`(value: BorderInlineProperty[TLength]*): Self = StObject.set(x, "border-inline", js.Array(value*))
    ...
    inline def `setBorder-leftVarargs`(value: BorderLeftProperty[TLength]*): Self = StObject.set(x, "border-left", js.Array(value*))
    ...
    inline def `setBorder-radiusVarargs`(value: BorderRadiusProperty[TLength]*): Self = StObject.set(x, "border-radius", js.Array(value*))
    ...
    inline def `setBorder-rightVarargs`(value: BorderRightProperty[TLength]*): Self = StObject.set(x, "border-right", js.Array(value*))
    ...
    inline def `setBorder-styleVarargs`(value: BorderStyleProperty*): Self = StObject.set(x, "border-style", js.Array(value*))
    ...
    inline def `setBorder-topVarargs`(value: BorderTopProperty[TLength]*): Self = StObject.set(x, "border-top", js.Array(value*))
    ...
    inline def `setBorder-widthVarargs`(value: BorderWidthProperty[TLength]*): Self = StObject.set(x, "border-width", js.Array(value*))
    ...
    inline def `setColumn-ruleVarargs`(value: ColumnRuleProperty[TLength]*): Self = StObject.set(x, "column-rule", js.Array(value*))
    ...
    inline def `setFlex-flowVarargs`(value: FlexFlowProperty*): Self = StObject.set(x, "flex-flow", js.Array(value*))
    ...
    inline def `setGrid-areaVarargs`(value: GridAreaProperty*): Self = StObject.set(x, "grid-area", js.Array(value*))
    ...
    inline def `setGrid-columnVarargs`(value: GridColumnProperty*): Self = StObject.set(x, "grid-column", js.Array(value*))
    ...
    inline def `setGrid-rowVarargs`(value: GridRowProperty*): Self = StObject.set(x, "grid-row", js.Array(value*))
    ...
    inline def `setGrid-templateVarargs`(value: GridTemplateProperty*): Self = StObject.set(x, "grid-template", js.Array(value*))
    ...
    inline def `setLine-clampVarargs`(value: LineClampProperty*): Self = StObject.set(x, "line-clamp", js.Array(value*))
    ...
    inline def `setList-styleVarargs`(value: ListStyleProperty*): Self = StObject.set(x, "list-style", js.Array(value*))
    ...
    inline def `setMask-borderVarargs`(value: MaskBorderProperty*): Self = StObject.set(x, "mask-border", js.Array(value*))
    ...
    inline def `setPlace-itemsVarargs`(value: PlaceItemsProperty*): Self = StObject.set(x, "place-items", js.Array(value*))
    ...
    inline def `setPlace-selfVarargs`(value: PlaceSelfProperty*): Self = StObject.set(x, "place-self", js.Array(value*))
    
    inline def `setText-decoration`(value: TextDecorationProperty | js.Array[TextDecorationProperty]): Self = StObject.set(x, "text-decoration", value.asInstanceOf[js.Any])
    
    inline def `setText-decorationUndefined`: Self = StObject.set(x, "text-decoration", js.undefined)
    
    inline def `setText-decorationVarargs`(value: TextDecorationProperty*): Self = StObject.set(x, "text-decoration", js.Array(value*))
    ...
    inline def `setText-emphasisVarargs`(value: TextEmphasisProperty*): Self = StObject.set(x, "text-emphasis", js.Array(value*))
