...
trait VendorLonghandPropertiesFallback[TLength] extends StObject {
  ...
  /**
    ...
    * **Initial value**: `auto` for smartphone browsers supporting inflation, `none` in other cases (and then not modifiable).
    */
  var msTextSizeAdjust: js.UndefOr[TextSizeAdjustProperty | js.Array[TextSizeAdjustProperty]] = js.undefined
...
object VendorLonghandPropertiesFallback {
  ...
  extension [Self <: VendorLonghandPropertiesFallback[?], TLength](x: Self & VendorLonghandPropertiesFallback[TLength]) {
    ...
    inline def setMozAnimationDelayVarargs(value: GlobalsString*): Self = StObject.set(x, "MozAnimationDelay", js.Array(value*))
    ...
    inline def setMozAnimationDirectionVarargs(value: AnimationDirectionProperty*): Self = StObject.set(x, "MozAnimationDirection", js.Array(value*))
    ...
    inline def setMozAnimationDurationVarargs(value: GlobalsString*): Self = StObject.set(x, "MozAnimationDuration", js.Array(value*))
    ...
    inline def setMozAnimationFillModeVarargs(value: AnimationFillModeProperty*): Self = StObject.set(x, "MozAnimationFillMode", js.Array(value*))
    ...
    inline def setMozAnimationIterationCountVarargs(value: AnimationIterationCountProperty*): Self = StObject.set(x, "MozAnimationIterationCount", js.Array(value*))
    ...
    inline def setMozAnimationNameVarargs(value: AnimationNameProperty*): Self = StObject.set(x, "MozAnimationName", js.Array(value*))
    ...
    inline def setMozAnimationPlayStateVarargs(value: AnimationPlayStateProperty*): Self = StObject.set(x, "MozAnimationPlayState", js.Array(value*))
    ...
    inline def setMozAnimationTimingFunctionVarargs(value: AnimationTimingFunctionProperty*): Self = StObject.set(x, "MozAnimationTimingFunction", js.Array(value*))
    ...
    inline def setMozAppearanceVarargs(value: MozAppearanceProperty*): Self = StObject.set(x, "MozAppearance", js.Array(value*))
    ...
    inline def setMozBackfaceVisibilityVarargs(value: BackfaceVisibilityProperty*): Self = StObject.set(x, "MozBackfaceVisibility", js.Array(value*))
    ...
    inline def setMozBorderBottomColorsVarargs(value: MozBorderBottomColorsProperty*): Self = StObject.set(x, "MozBorderBottomColors", js.Array(value*))
    ...
    inline def setMozBorderEndColorVarargs(value: BorderInlineEndColorProperty*): Self = StObject.set(x, "MozBorderEndColor", js.Array(value*))
    ...
    inline def setMozBorderEndStyleVarargs(value: BorderInlineEndStyleProperty*): Self = StObject.set(x, "MozBorderEndStyle", js.Array(value*))
    ...
    inline def setMozBorderEndWidthVarargs(value: BorderInlineEndWidthProperty[TLength]*): Self = StObject.set(x, "MozBorderEndWidth", js.Array(value*))
    ...
    inline def setMozBorderLeftColorsVarargs(value: MozBorderLeftColorsProperty*): Self = StObject.set(x, "MozBorderLeftColors", js.Array(value*))
    ...
    inline def setMozBorderRightColorsVarargs(value: MozBorderRightColorsProperty*): Self = StObject.set(x, "MozBorderRightColors", js.Array(value*))
    ...
    inline def setMozBorderStartColorVarargs(value: BorderInlineStartColorProperty*): Self = StObject.set(x, "MozBorderStartColor", js.Array(value*))
    ...
    inline def setMozBorderStartStyleVarargs(value: BorderInlineStartStyleProperty*): Self = StObject.set(x, "MozBorderStartStyle", js.Array(value*))
    ...
    inline def setMozBorderTopColorsVarargs(value: MozBorderTopColorsProperty*): Self = StObject.set(x, "MozBorderTopColors", js.Array(value*))
    ...
    inline def setMozBoxSizingVarargs(value: BoxSizingProperty*): Self = StObject.set(x, "MozBoxSizing", js.Array(value*))
    ...
    inline def setMozColumnCountVarargs(value: ColumnCountProperty*): Self = StObject.set(x, "MozColumnCount", js.Array(value*))
    ...
    inline def setMozColumnFillVarargs(value: ColumnFillProperty*): Self = StObject.set(x, "MozColumnFill", js.Array(value*))
    ...
    inline def setMozColumnGapVarargs(value: ColumnGapProperty[TLength]*): Self = StObject.set(x, "MozColumnGap", js.Array(value*))
    ...
    inline def setMozColumnRuleColorVarargs(value: ColumnRuleColorProperty*): Self = StObject.set(x, "MozColumnRuleColor", js.Array(value*))
    ...
    inline def setMozColumnRuleStyleVarargs(value: ColumnRuleStyleProperty*): Self = StObject.set(x, "MozColumnRuleStyle", js.Array(value*))
    ...
    inline def setMozColumnRuleWidthVarargs(value: ColumnRuleWidthProperty[TLength]*): Self = StObject.set(x, "MozColumnRuleWidth", js.Array(value*))
    ...
    inline def setMozColumnWidthVarargs(value: ColumnWidthProperty[TLength]*): Self = StObject.set(x, "MozColumnWidth", js.Array(value*))
    ...
    inline def setMozContextPropertiesVarargs(value: MozContextPropertiesProperty*): Self = StObject.set(x, "MozContextProperties", js.Array(value*))
    ...
    inline def setMozFloatEdgeVarargs(value: MozFloatEdgeProperty*): Self = StObject.set(x, "MozFloatEdge", js.Array(value*))
    ...
    inline def setMozFontFeatureSettingsVarargs(value: FontFeatureSettingsProperty*): Self = StObject.set(x, "MozFontFeatureSettings", js.Array(value*))
    ...
    inline def setMozFontLanguageOverrideVarargs(value: FontLanguageOverrideProperty*): Self = StObject.set(x, "MozFontLanguageOverride", js.Array(value*))
    ...
    inline def setMozForceBrokenImageIconVarargs(value: GlobalsNumber*): Self = StObject.set(x, "MozForceBrokenImageIcon", js.Array(value*))
    ...
    inline def setMozHyphensVarargs(value: HyphensProperty*): Self = StObject.set(x, "MozHyphens", js.Array(value*))
    ...
    inline def setMozImageRegionVarargs(value: MozImageRegionProperty*): Self = StObject.set(x, "MozImageRegion", js.Array(value*))
    ...
    inline def setMozMarginEndVarargs(value: MarginInlineEndProperty[TLength]*): Self = StObject.set(x, "MozMarginEnd", js.Array(value*))
    ...
    inline def setMozMarginStartVarargs(value: MarginInlineStartProperty[TLength]*): Self = StObject.set(x, "MozMarginStart", js.Array(value*))
    ...
    inline def setMozOrientVarargs(value: MozOrientProperty*): Self = StObject.set(x, "MozOrient", js.Array(value*))
    ...
    inline def setMozOutlineRadiusBottomleftVarargs(value: MozOutlineRadiusBottomleftProperty[TLength]*): Self = StObject.set(x, "MozOutlineRadiusBottomleft", js.Array(value*))
    ...
    inline def setMozOutlineRadiusBottomrightVarargs(value: MozOutlineRadiusBottomrightProperty[TLength]*): Self = StObject.set(x, "MozOutlineRadiusBottomright", js.Array(value*))
    ...
    inline def setMozOutlineRadiusTopleftVarargs(value: MozOutlineRadiusTopleftProperty[TLength]*): Self = StObject.set(x, "MozOutlineRadiusTopleft", js.Array(value*))
    ...
    inline def setMozOutlineRadiusToprightVarargs(value: MozOutlineRadiusToprightProperty[TLength]*): Self = StObject.set(x, "MozOutlineRadiusTopright", js.Array(value*))
    ...
    inline def setMozPaddingEndVarargs(value: PaddingInlineEndProperty[TLength]*): Self = StObject.set(x, "MozPaddingEnd", js.Array(value*))
    ...
    inline def setMozPaddingStartVarargs(value: PaddingInlineStartProperty[TLength]*): Self = StObject.set(x, "MozPaddingStart", js.Array(value*))
    ...
    inline def setMozPerspectiveOriginVarargs(value: PerspectiveOriginProperty[TLength]*): Self = StObject.set(x, "MozPerspectiveOrigin", js.Array(value*))
    
    inline def setMozPerspectiveUndefined: Self = StObject.set(x, "MozPerspective", js.undefined)
    
    inline def setMozPerspectiveVarargs(value: PerspectiveProperty[TLength]*): Self = StObject.set(x, "MozPerspective", js.Array(value*))
    ...
    inline def setMozStackSizingVarargs(value: MozStackSizingProperty*): Self = StObject.set(x, "MozStackSizing", js.Array(value*))
    ...
    inline def setMozTabSizeVarargs(value: TabSizeProperty[TLength]*): Self = StObject.set(x, "MozTabSize", js.Array(value*))
    ...
    inline def setMozTextSizeAdjustVarargs(value: TextSizeAdjustProperty*): Self = StObject.set(x, "MozTextSizeAdjust", js.Array(value*))
    ...
    inline def setMozTransformOriginVarargs(value: TransformOriginProperty[TLength]*): Self = StObject.set(x, "MozTransformOrigin", js.Array(value*))
    ...
    inline def setMozTransformStyleVarargs(value: TransformStyleProperty*): Self = StObject.set(x, "MozTransformStyle", js.Array(value*))
    ...
    inline def setMozTransitionDelayVarargs(value: GlobalsString*): Self = StObject.set(x, "MozTransitionDelay", js.Array(value*))
    ...
    inline def setMozTransitionDurationVarargs(value: GlobalsString*): Self = StObject.set(x, "MozTransitionDuration", js.Array(value*))
    ...
    inline def setMozTransitionPropertyVarargs(value: TransitionPropertyProperty*): Self = StObject.set(x, "MozTransitionProperty", js.Array(value*))
    ...
    inline def setMozTransitionTimingFunctionVarargs(value: TransitionTimingFunctionProperty*): Self = StObject.set(x, "MozTransitionTimingFunction", js.Array(value*))
    ...
    inline def setMozUserFocusVarargs(value: MozUserFocusProperty*): Self = StObject.set(x, "MozUserFocus", js.Array(value*))
    ...
    inline def setMozUserModifyVarargs(value: MozUserModifyProperty*): Self = StObject.set(x, "MozUserModify", js.Array(value*))
    ...
    inline def setMozUserSelectVarargs(value: UserSelectProperty*): Self = StObject.set(x, "MozUserSelect", js.Array(value*))
    ...
    inline def setMozWindowDraggingVarargs(value: MozWindowDraggingProperty*): Self = StObject.set(x, "MozWindowDragging", js.Array(value*))
    ...
    inline def setMozWindowShadowVarargs(value: MozWindowShadowProperty*): Self = StObject.set(x, "MozWindowShadow", js.Array(value*))
    ...
    inline def setMsAcceleratorVarargs(value: MsAcceleratorProperty*): Self = StObject.set(x, "msAccelerator", js.Array(value*))
    ...
    inline def setMsAlignSelfVarargs(value: AlignSelfProperty*): Self = StObject.set(x, "msAlignSelf", js.Array(value*))
    ...
    inline def setMsBlockProgressionVarargs(value: MsBlockProgressionProperty*): Self = StObject.set(x, "msBlockProgression", js.Array(value*))
    ...
    inline def setMsContentZoomChainingVarargs(value: MsContentZoomChainingProperty*): Self = StObject.set(x, "msContentZoomChaining", js.Array(value*))
    ...
    inline def setMsContentZoomLimitMaxVarargs(value: GlobalsString*): Self = StObject.set(x, "msContentZoomLimitMax", js.Array(value*))
    ...
    inline def setMsContentZoomLimitMinVarargs(value: GlobalsString*): Self = StObject.set(x, "msContentZoomLimitMin", js.Array(value*))
    ...
    inline def setMsContentZoomSnapPointsVarargs(value: GlobalsString*): Self = StObject.set(x, "msContentZoomSnapPoints", js.Array(value*))
    ...
    inline def setMsContentZoomSnapTypeVarargs(value: MsContentZoomSnapTypeProperty*): Self = StObject.set(x, "msContentZoomSnapType", js.Array(value*))
    ...
    inline def setMsContentZoomingVarargs(value: MsContentZoomingProperty*): Self = StObject.set(x, "msContentZooming", js.Array(value*))
    ...
    inline def setMsFilterVarargs(value: GlobalsString*): Self = StObject.set(x, "msFilter", js.Array(value*))
    ...
    inline def setMsFlexDirectionVarargs(value: FlexDirectionProperty*): Self = StObject.set(x, "msFlexDirection", js.Array(value*))
    ...
    inline def setMsFlexPositiveVarargs(value: GlobalsNumber*): Self = StObject.set(x, "msFlexPositive", js.Array(value*))
    ...
    inline def setMsFlowFromVarargs(value: MsFlowFromProperty*): Self = StObject.set(x, "msFlowFrom", js.Array(value*))
    ...
    inline def setMsFlowIntoVarargs(value: MsFlowIntoProperty*): Self = StObject.set(x, "msFlowInto", js.Array(value*))
    
    inline def setMsGridColumns(value: GridAutoColumnsProperty[TLength] | js.Array[GridAutoColumnsProperty[TLength]]): Self = StObject.set(x, "msGridColumns", value.asInstanceOf[js.Any])
    
    inline def setMsGridColumnsUndefined: Self = StObject.set(x, "msGridColumns", js.undefined)
    
    inline def setMsGridColumnsVarargs(value: GridAutoColumnsProperty[TLength]*): Self = StObject.set(x, "msGridColumns", js.Array(value*))
    
    inline def setMsGridRows(value: GridAutoRowsProperty[TLength] | js.Array[GridAutoRowsProperty[TLength]]): Self = StObject.set(x, "msGridRows", value.asInstanceOf[js.Any])
    
    inline def setMsGridRowsUndefined: Self = StObject.set(x, "msGridRows", js.undefined)
    
    inline def setMsGridRowsVarargs(value: GridAutoRowsProperty[TLength]*): Self = StObject.set(x, "msGridRows", js.Array(value*))
    ...
    inline def setMsHighContrastAdjustVarargs(value: MsHighContrastAdjustProperty*): Self = StObject.set(x, "msHighContrastAdjust", js.Array(value*))
    ...
    inline def setMsHyphenateLimitCharsVarargs(value: MsHyphenateLimitCharsProperty*): Self = StObject.set(x, "msHyphenateLimitChars", js.Array(value*))
    ...
    inline def setMsHyphenateLimitLinesVarargs(value: MsHyphenateLimitLinesProperty*): Self = StObject.set(x, "msHyphenateLimitLines", js.Array(value*))
    ...
    inline def setMsHyphenateLimitZoneVarargs(value: MsHyphenateLimitZoneProperty[TLength]*): Self = StObject.set(x, "msHyphenateLimitZone", js.Array(value*))
    ...
    inline def setMsHyphensVarargs(value: HyphensProperty*): Self = StObject.set(x, "msHyphens", js.Array(value*))
    ...
    inline def setMsImeAlignVarargs(value: MsImeAlignProperty*): Self = StObject.set(x, "msImeAlign", js.Array(value*))
    ...
    inline def setMsLineBreakVarargs(value: LineBreakProperty*): Self = StObject.set(x, "msLineBreak", js.Array(value*))
    ...
    inline def setMsOrderVarargs(value: GlobalsNumber*): Self = StObject.set(x, "msOrder", js.Array(value*))
    ...
    inline def setMsOverflowStyleVarargs(value: MsOverflowStyleProperty*): Self = StObject.set(x, "msOverflowStyle", js.Array(value*))
    ...
    inline def setMsOverflowXVarargs(value: OverflowXProperty*): Self = StObject.set(x, "msOverflowX", js.Array(value*))
    ...
    inline def setMsOverflowYVarargs(value: OverflowYProperty*): Self = StObject.set(x, "msOverflowY", js.Array(value*))
    ...
    inline def setMsScrollChainingVarargs(value: MsScrollChainingProperty*): Self = StObject.set(x, "msScrollChaining", js.Array(value*))
    ...
    inline def setMsScrollLimitXMaxVarargs(value: MsScrollLimitXMaxProperty[TLength]*): Self = StObject.set(x, "msScrollLimitXMax", js.Array(value*))
    ...
    inline def setMsScrollLimitXMinVarargs(value: MsScrollLimitXMinProperty[TLength]*): Self = StObject.set(x, "msScrollLimitXMin", js.Array(value*))
    ...
    inline def setMsScrollLimitYMaxVarargs(value: MsScrollLimitYMaxProperty[TLength]*): Self = StObject.set(x, "msScrollLimitYMax", js.Array(value*))
    ...
    inline def setMsScrollLimitYMinVarargs(value: MsScrollLimitYMinProperty[TLength]*): Self = StObject.set(x, "msScrollLimitYMin", js.Array(value*))
    ...
    inline def setMsScrollRailsVarargs(value: MsScrollRailsProperty*): Self = StObject.set(x, "msScrollRails", js.Array(value*))
    ...
    inline def setMsScrollSnapPointsXVarargs(value: GlobalsString*): Self = StObject.set(x, "msScrollSnapPointsX", js.Array(value*))
    ...
    inline def setMsScrollSnapPointsYVarargs(value: GlobalsString*): Self = StObject.set(x, "msScrollSnapPointsY", js.Array(value*))
    ...
    inline def setMsScrollSnapTypeVarargs(value: MsScrollSnapTypeProperty*): Self = StObject.set(x, "msScrollSnapType", js.Array(value*))
    ...
    inline def setMsScrollTranslationVarargs(value: MsScrollTranslationProperty*): Self = StObject.set(x, "msScrollTranslation", js.Array(value*))
    ...
    inline def setMsTextAutospaceVarargs(value: MsTextAutospaceProperty*): Self = StObject.set(x, "msTextAutospace", js.Array(value*))
    ...
    inline def setMsTextCombineHorizontalVarargs(value: TextCombineUprightProperty*): Self = StObject.set(x, "msTextCombineHorizontal", js.Array(value*))
    ...
    inline def setMsTextOverflowVarargs(value: TextOverflowProperty*): Self = StObject.set(x, "msTextOverflow", js.Array(value*))
    
    inline def setMsTextSizeAdjust(value: TextSizeAdjustProperty | js.Array[TextSizeAdjustProperty]): Self = StObject.set(x, "msTextSizeAdjust", value.asInstanceOf[js.Any])
    
    inline def setMsTextSizeAdjustUndefined: Self = StObject.set(x, "msTextSizeAdjust", js.undefined)
    
    inline def setMsTextSizeAdjustVarargs(value: TextSizeAdjustProperty*): Self = StObject.set(x, "msTextSizeAdjust", js.Array(value*))
    ...
    inline def setMsTouchActionVarargs(value: TouchActionProperty*): Self = StObject.set(x, "msTouchAction", js.Array(value*))
    ...
    inline def setMsTouchSelectVarargs(value: MsTouchSelectProperty*): Self = StObject.set(x, "msTouchSelect", js.Array(value*))
    ...
    inline def setMsTransformOriginVarargs(value: TransformOriginProperty[TLength]*): Self = StObject.set(x, "msTransformOrigin", js.Array(value*))
    
    inline def setMsTransformUndefined: Self = StObject.set(x, "msTransform", js.undefined)
    
    inline def setMsTransformVarargs(value: TransformProperty*): Self = StObject.set(x, "msTransform", js.Array(value*))
    ...
    inline def setMsUserSelectVarargs(value: MsUserSelectProperty*): Self = StObject.set(x, "msUserSelect", js.Array(value*))
    ...
    inline def setMsWordBreakVarargs(value: WordBreakProperty*): Self = StObject.set(x, "msWordBreak", js.Array(value*))
    ...
    inline def setMsWrapFlowVarargs(value: MsWrapFlowProperty*): Self = StObject.set(x, "msWrapFlow", js.Array(value*))
    ...
    inline def setMsWrapMarginVarargs(value: MsWrapMarginProperty[TLength]*): Self = StObject.set(x, "msWrapMargin", js.Array(value*))
    ...
    inline def setMsWrapThroughVarargs(value: MsWrapThroughProperty*): Self = StObject.set(x, "msWrapThrough", js.Array(value*))
    ...
    inline def setMsWritingModeVarargs(value: WritingModeProperty*): Self = StObject.set(x, "msWritingMode", js.Array(value*))
    ...
    inline def setOObjectFitVarargs(value: ObjectFitProperty*): Self = StObject.set(x, "OObjectFit", js.Array(value*))
    ...
    inline def setOObjectPositionVarargs(value: ObjectPositionProperty[TLength]*): Self = StObject.set(x, "OObjectPosition", js.Array(value*))
    ...
    inline def setOTabSizeVarargs(value: TabSizeProperty[TLength]*): Self = StObject.set(x, "OTabSize", js.Array(value*))
    ...
    inline def setOTextOverflowVarargs(value: TextOverflowProperty*): Self = StObject.set(x, "OTextOverflow", js.Array(value*))
    ...
    inline def setOTransformOriginVarargs(value: TransformOriginProperty[TLength]*): Self = StObject.set(x, "OTransformOrigin", js.Array(value*))
    ...
    inline def setWebkitAlignContentVarargs(value: AlignContentProperty*): Self = StObject.set(x, "WebkitAlignContent", js.Array(value*))
    ...
    inline def setWebkitAlignItemsVarargs(value: AlignItemsProperty*): Self = StObject.set(x, "WebkitAlignItems", js.Array(value*))
    ...
    inline def setWebkitAlignSelfVarargs(value: AlignSelfProperty*): Self = StObject.set(x, "WebkitAlignSelf", js.Array(value*))
    ...
    inline def setWebkitAnimationDelayVarargs(value: GlobalsString*): Self = StObject.set(x, "WebkitAnimationDelay", js.Array(value*))
    ...
    inline def setWebkitAnimationDirectionVarargs(value: AnimationDirectionProperty*): Self = StObject.set(x, "WebkitAnimationDirection", js.Array(value*))
    ...
    inline def setWebkitAnimationDurationVarargs(value: GlobalsString*): Self = StObject.set(x, "WebkitAnimationDuration", js.Array(value*))
    ...
    inline def setWebkitAnimationFillModeVarargs(value: AnimationFillModeProperty*): Self = StObject.set(x, "WebkitAnimationFillMode", js.Array(value*))
    ...
    inline def setWebkitAnimationIterationCountVarargs(value: AnimationIterationCountProperty*): Self = StObject.set(x, "WebkitAnimationIterationCount", js.Array(value*))
    ...
    inline def setWebkitAnimationNameVarargs(value: AnimationNameProperty*): Self = StObject.set(x, "WebkitAnimationName", js.Array(value*))
    ...
    inline def setWebkitAnimationPlayStateVarargs(value: AnimationPlayStateProperty*): Self = StObject.set(x, "WebkitAnimationPlayState", js.Array(value*))
    ...
    inline def setWebkitAnimationTimingFunctionVarargs(value: AnimationTimingFunctionProperty*): Self = StObject.set(x, "WebkitAnimationTimingFunction", js.Array(value*))
    ...
    inline def setWebkitAppearanceVarargs(value: WebkitAppearanceProperty*): Self = StObject.set(x, "WebkitAppearance", js.Array(value*))
    ...
    inline def setWebkitBackdropFilterVarargs(value: BackdropFilterProperty*): Self = StObject.set(x, "WebkitBackdropFilter", js.Array(value*))
    ...
    inline def setWebkitBackfaceVisibilityVarargs(value: BackfaceVisibilityProperty*): Self = StObject.set(x, "WebkitBackfaceVisibility", js.Array(value*))
    ...
    inline def setWebkitBackgroundClipVarargs(value: BackgroundClipProperty*): Self = StObject.set(x, "WebkitBackgroundClip", js.Array(value*))
    ...
    inline def setWebkitBackgroundOriginVarargs(value: BackgroundOriginProperty*): Self = StObject.set(x, "WebkitBackgroundOrigin", js.Array(value*))
    ...
    inline def setWebkitBackgroundSizeVarargs(value: BackgroundSizeProperty[TLength]*): Self = StObject.set(x, "WebkitBackgroundSize", js.Array(value*))
    ...
    inline def setWebkitBorderBeforeColorVarargs(value: WebkitBorderBeforeColorProperty*): Self = StObject.set(x, "WebkitBorderBeforeColor", js.Array(value*))
    ...
    inline def setWebkitBorderBeforeStyleVarargs(value: WebkitBorderBeforeStyleProperty*): Self = StObject.set(x, "WebkitBorderBeforeStyle", js.Array(value*))
    ...
    inline def setWebkitBorderBeforeWidthVarargs(value: WebkitBorderBeforeWidthProperty[TLength]*): Self = StObject.set(x, "WebkitBorderBeforeWidth", js.Array(value*))
    ...
    inline def setWebkitBorderBottomLeftRadiusVarargs(value: BorderBottomLeftRadiusProperty[TLength]*): Self = StObject.set(x, "WebkitBorderBottomLeftRadius", js.Array(value*))
    ...
    inline def setWebkitBorderBottomRightRadiusVarargs(value: BorderBottomRightRadiusProperty[TLength]*): Self = StObject.set(x, "WebkitBorderBottomRightRadius", js.Array(value*))
    ...
    inline def setWebkitBorderImageSliceVarargs(value: BorderImageSliceProperty*): Self = StObject.set(x, "WebkitBorderImageSlice", js.Array(value*))
    ...
    inline def setWebkitBorderTopLeftRadiusVarargs(value: BorderTopLeftRadiusProperty[TLength]*): Self = StObject.set(x, "WebkitBorderTopLeftRadius", js.Array(value*))
    ...
    inline def setWebkitBorderTopRightRadiusVarargs(value: BorderTopRightRadiusProperty[TLength]*): Self = StObject.set(x, "WebkitBorderTopRightRadius", js.Array(value*))
    ...
    inline def setWebkitBoxDecorationBreakVarargs(value: BoxDecorationBreakProperty*): Self = StObject.set(x, "WebkitBoxDecorationBreak", js.Array(value*))
    ...
    inline def setWebkitBoxReflectVarargs(value: WebkitBoxReflectProperty[TLength]*): Self = StObject.set(x, "WebkitBoxReflect", js.Array(value*))
    ...
    inline def setWebkitBoxShadowVarargs(value: BoxShadowProperty*): Self = StObject.set(x, "WebkitBoxShadow", js.Array(value*))
    ...
    inline def setWebkitBoxSizingVarargs(value: BoxSizingProperty*): Self = StObject.set(x, "WebkitBoxSizing", js.Array(value*))
    ...
    inline def setWebkitClipPathVarargs(value: ClipPathProperty*): Self = StObject.set(x, "WebkitClipPath", js.Array(value*))
    
    inline def setWebkitColorAdjust(value: ColorAdjustProperty | js.Array[ColorAdjustProperty]): Self = StObject.set(x, "WebkitColorAdjust", value.asInstanceOf[js.Any])
    
    inline def setWebkitColorAdjustUndefined: Self = StObject.set(x, "WebkitColorAdjust", js.undefined)
    
    inline def setWebkitColorAdjustVarargs(value: ColorAdjustProperty*): Self = StObject.set(x, "WebkitColorAdjust", js.Array(value*))
    ...
    inline def setWebkitColumnCountVarargs(value: ColumnCountProperty*): Self = StObject.set(x, "WebkitColumnCount", js.Array(value*))
    ...
    inline def setWebkitColumnGapVarargs(value: ColumnGapProperty[TLength]*): Self = StObject.set(x, "WebkitColumnGap", js.Array(value*))
    ...
    inline def setWebkitColumnRuleColorVarargs(value: ColumnRuleColorProperty*): Self = StObject.set(x, "WebkitColumnRuleColor", js.Array(value*))
    ...
    inline def setWebkitColumnRuleStyleVarargs(value: ColumnRuleStyleProperty*): Self = StObject.set(x, "WebkitColumnRuleStyle", js.Array(value*))
    ...
    inline def setWebkitColumnRuleWidthVarargs(value: ColumnRuleWidthProperty[TLength]*): Self = StObject.set(x, "WebkitColumnRuleWidth", js.Array(value*))
    ...
    inline def setWebkitColumnSpanVarargs(value: ColumnSpanProperty*): Self = StObject.set(x, "WebkitColumnSpan", js.Array(value*))
    ...
    inline def setWebkitColumnWidthVarargs(value: ColumnWidthProperty[TLength]*): Self = StObject.set(x, "WebkitColumnWidth", js.Array(value*))
    ...
    inline def setWebkitFilterVarargs(value: FilterProperty*): Self = StObject.set(x, "WebkitFilter", js.Array(value*))
    ...
    inline def setWebkitFlexBasisVarargs(value: FlexBasisProperty[TLength]*): Self = StObject.set(x, "WebkitFlexBasis", js.Array(value*))
    ...
    inline def setWebkitFlexDirectionVarargs(value: FlexDirectionProperty*): Self = StObject.set(x, "WebkitFlexDirection", js.Array(value*))
    ...
    inline def setWebkitFlexGrowVarargs(value: GlobalsNumber*): Self = StObject.set(x, "WebkitFlexGrow", js.Array(value*))
    ...
    inline def setWebkitFlexShrinkVarargs(value: GlobalsNumber*): Self = StObject.set(x, "WebkitFlexShrink", js.Array(value*))
    ...
    inline def setWebkitFlexWrapVarargs(value: FlexWrapProperty*): Self = StObject.set(x, "WebkitFlexWrap", js.Array(value*))
    ...
    inline def setWebkitFontFeatureSettingsVarargs(value: FontFeatureSettingsProperty*): Self = StObject.set(x, "WebkitFontFeatureSettings", js.Array(value*))
    ...
    inline def setWebkitFontKerningVarargs(value: FontKerningProperty*): Self = StObject.set(x, "WebkitFontKerning", js.Array(value*))
    ...
    inline def setWebkitFontVariantLigaturesVarargs(value: FontVariantLigaturesProperty*): Self = StObject.set(x, "WebkitFontVariantLigatures", js.Array(value*))
    ...
    inline def setWebkitHyphensVarargs(value: HyphensProperty*): Self = StObject.set(x, "WebkitHyphens", js.Array(value*))
    ...
    inline def setWebkitJustifyContentVarargs(value: JustifyContentProperty*): Self = StObject.set(x, "WebkitJustifyContent", js.Array(value*))
    ...
    inline def setWebkitLineBreakVarargs(value: LineBreakProperty*): Self = StObject.set(x, "WebkitLineBreak", js.Array(value*))
    ...
    inline def setWebkitMarginEndVarargs(value: MarginInlineEndProperty[TLength]*): Self = StObject.set(x, "WebkitMarginEnd", js.Array(value*))
    ...
    inline def setWebkitMarginStartVarargs(value: MarginInlineStartProperty[TLength]*): Self = StObject.set(x, "WebkitMarginStart", js.Array(value*))
    ...
    inline def setWebkitMaskAttachmentVarargs(value: WebkitMaskAttachmentProperty*): Self = StObject.set(x, "WebkitMaskAttachment", js.Array(value*))
    ...
    inline def setWebkitMaskClipVarargs(value: WebkitMaskClipProperty*): Self = StObject.set(x, "WebkitMaskClip", js.Array(value*))
    ...
    inline def setWebkitMaskCompositeVarargs(value: WebkitMaskCompositeProperty*): Self = StObject.set(x, "WebkitMaskComposite", js.Array(value*))
    ...
    inline def setWebkitMaskImageVarargs(value: WebkitMaskImageProperty*): Self = StObject.set(x, "WebkitMaskImage", js.Array(value*))
    ...
    inline def setWebkitMaskOriginVarargs(value: WebkitMaskOriginProperty*): Self = StObject.set(x, "WebkitMaskOrigin", js.Array(value*))
    ...
    inline def setWebkitMaskPositionVarargs(value: WebkitMaskPositionProperty[TLength]*): Self = StObject.set(x, "WebkitMaskPosition", js.Array(value*))
    ...
    inline def setWebkitMaskPositionXVarargs(value: WebkitMaskPositionXProperty[TLength]*): Self = StObject.set(x, "WebkitMaskPositionX", js.Array(value*))
    ...
    inline def setWebkitMaskPositionYVarargs(value: WebkitMaskPositionYProperty[TLength]*): Self = StObject.set(x, "WebkitMaskPositionY", js.Array(value*))
    ...
    inline def setWebkitMaskRepeatVarargs(value: WebkitMaskRepeatProperty*): Self = StObject.set(x, "WebkitMaskRepeat", js.Array(value*))
    ...
    inline def setWebkitMaskRepeatXVarargs(value: WebkitMaskRepeatXProperty*): Self = StObject.set(x, "WebkitMaskRepeatX", js.Array(value*))
    ...
    inline def setWebkitMaskRepeatYVarargs(value: WebkitMaskRepeatYProperty*): Self = StObject.set(x, "WebkitMaskRepeatY", js.Array(value*))
    ...
    inline def setWebkitMaskSizeVarargs(value: WebkitMaskSizeProperty[TLength]*): Self = StObject.set(x, "WebkitMaskSize", js.Array(value*))
    ...
    inline def setWebkitMaxInlineSizeVarargs(value: MaxInlineSizeProperty[TLength]*): Self = StObject.set(x, "WebkitMaxInlineSize", js.Array(value*))
    ...
    inline def setWebkitOrderVarargs(value: GlobalsNumber*): Self = StObject.set(x, "WebkitOrder", js.Array(value*))
    ...
    inline def setWebkitOverflowScrollingVarargs(value: WebkitOverflowScrollingProperty*): Self = StObject.set(x, "WebkitOverflowScrolling", js.Array(value*))
    ...
    inline def setWebkitPaddingEndVarargs(value: PaddingInlineEndProperty[TLength]*): Self = StObject.set(x, "WebkitPaddingEnd", js.Array(value*))
    ...
    inline def setWebkitPaddingStartVarargs(value: PaddingInlineStartProperty[TLength]*): Self = StObject.set(x, "WebkitPaddingStart", js.Array(value*))
    ...
    inline def setWebkitPerspectiveOriginVarargs(value: PerspectiveOriginProperty[TLength]*): Self = StObject.set(x, "WebkitPerspectiveOrigin", js.Array(value*))
    
    inline def setWebkitPerspectiveUndefined: Self = StObject.set(x, "WebkitPerspective", js.undefined)
    
    inline def setWebkitPerspectiveVarargs(value: PerspectiveProperty[TLength]*): Self = StObject.set(x, "WebkitPerspective", js.Array(value*))
    ...
    inline def setWebkitScrollSnapTypeVarargs(value: ScrollSnapTypeProperty*): Self = StObject.set(x, "WebkitScrollSnapType", js.Array(value*))
    ...
    inline def setWebkitShapeMarginVarargs(value: ShapeMarginProperty[TLength]*): Self = StObject.set(x, "WebkitShapeMargin", js.Array(value*))
    ...
    inline def setWebkitTapHighlightColorVarargs(value: WebkitTapHighlightColorProperty*): Self = StObject.set(x, "WebkitTapHighlightColor", js.Array(value*))
    ...
    inline def setWebkitTextCombineVarargs(value: TextCombineUprightProperty*): Self = StObject.set(x, "WebkitTextCombine", js.Array(value*))
    ...
    inline def setWebkitTextDecorationColorVarargs(value: TextDecorationColorProperty*): Self = StObject.set(x, "WebkitTextDecorationColor", js.Array(value*))
    ...
    inline def setWebkitTextDecorationLineVarargs(value: TextDecorationLineProperty*): Self = StObject.set(x, "WebkitTextDecorationLine", js.Array(value*))
    ...
    inline def setWebkitTextDecorationSkipVarargs(value: TextDecorationSkipProperty*): Self = StObject.set(x, "WebkitTextDecorationSkip", js.Array(value*))
    ...
    inline def setWebkitTextDecorationStyleVarargs(value: TextDecorationStyleProperty*): Self = StObject.set(x, "WebkitTextDecorationStyle", js.Array(value*))
    ...
    inline def setWebkitTextEmphasisColorVarargs(value: TextEmphasisColorProperty*): Self = StObject.set(x, "WebkitTextEmphasisColor", js.Array(value*))
    ...
    inline def setWebkitTextEmphasisPositionVarargs(value: GlobalsString*): Self = StObject.set(x, "WebkitTextEmphasisPosition", js.Array(value*))
    ...
    inline def setWebkitTextEmphasisStyleVarargs(value: TextEmphasisStyleProperty*): Self = StObject.set(x, "WebkitTextEmphasisStyle", js.Array(value*))
    ...
    inline def setWebkitTextFillColorVarargs(value: WebkitTextFillColorProperty*): Self = StObject.set(x, "WebkitTextFillColor", js.Array(value*))
    ...
    inline def setWebkitTextOrientationVarargs(value: TextOrientationProperty*): Self = StObject.set(x, "WebkitTextOrientation", js.Array(value*))
    ...
    inline def setWebkitTextSizeAdjustVarargs(value: TextSizeAdjustProperty*): Self = StObject.set(x, "WebkitTextSizeAdjust", js.Array(value*))
    ...
    inline def setWebkitTextStrokeColorVarargs(value: WebkitTextStrokeColorProperty*): Self = StObject.set(x, "WebkitTextStrokeColor", js.Array(value*))
    ...
    inline def setWebkitTextStrokeWidthVarargs(value: WebkitTextStrokeWidthProperty[TLength]*): Self = StObject.set(x, "WebkitTextStrokeWidth", js.Array(value*))
    ...
    inline def setWebkitTouchCalloutVarargs(value: WebkitTouchCalloutProperty*): Self = StObject.set(x, "WebkitTouchCallout", js.Array(value*))
    ...
    inline def setWebkitTransformOriginVarargs(value: TransformOriginProperty[TLength]*): Self = StObject.set(x, "WebkitTransformOrigin", js.Array(value*))
    ...
    inline def setWebkitTransformStyleVarargs(value: TransformStyleProperty*): Self = StObject.set(x, "WebkitTransformStyle", js.Array(value*))
    
    inline def setWebkitTransformUndefined: Self = StObject.set(x, "WebkitTransform", js.undefined)
    
    inline def setWebkitTransformVarargs(value: TransformProperty*): Self = StObject.set(x, "WebkitTransform", js.Array(value*))
    ...
    inline def setWebkitTransitionDelayVarargs(value: GlobalsString*): Self = StObject.set(x, "WebkitTransitionDelay", js.Array(value*))
    ...
    inline def setWebkitTransitionDurationVarargs(value: GlobalsString*): Self = StObject.set(x, "WebkitTransitionDuration", js.Array(value*))
    ...
    inline def setWebkitTransitionPropertyVarargs(value: TransitionPropertyProperty*): Self = StObject.set(x, "WebkitTransitionProperty", js.Array(value*))
    ...
    inline def setWebkitTransitionTimingFunctionVarargs(value: TransitionTimingFunctionProperty*): Self = StObject.set(x, "WebkitTransitionTimingFunction", js.Array(value*))
    ...
    inline def setWebkitUserModifyVarargs(value: WebkitUserModifyProperty*): Self = StObject.set(x, "WebkitUserModify", js.Array(value*))
    ...
    inline def setWebkitUserSelectVarargs(value: UserSelectProperty*): Self = StObject.set(x, "WebkitUserSelect", js.Array(value*))
    ...
    inline def setWebkitWritingModeVarargs(value: WritingModeProperty*): Self = StObject.set(x, "WebkitWritingMode", js.Array(value*))
  }
}
