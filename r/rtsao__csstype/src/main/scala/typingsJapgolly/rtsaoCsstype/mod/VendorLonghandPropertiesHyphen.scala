...
object VendorLonghandPropertiesHyphen {
  ...
  extension [Self <: VendorLonghandPropertiesHyphen[?], TLength](x: Self & VendorLonghandPropertiesHyphen[TLength]) {
    ...
    inline def `set-ms-text-size-adjust`(value: TextSizeAdjustProperty): Self = StObject.set(x, "-ms-text-size-adjust", value.asInstanceOf[js.Any])
    ...
    inline def `set-webkit-color-adjust`(value: ColorAdjustProperty): Self = StObject.set(x, "-webkit-color-adjust", value.asInstanceOf[js.Any])
