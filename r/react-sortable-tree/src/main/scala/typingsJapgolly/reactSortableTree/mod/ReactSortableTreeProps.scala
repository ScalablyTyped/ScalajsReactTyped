...
object ReactSortableTreeProps {
  ...
  inline def apply[T](onChange: js.Array[TreeItem[T]] => Callback, treeData: js.Array[TreeItem[T]]): ReactSortableTreeProps[T] = {
    val __obj = js.Dynamic.literal(onChange = js.Any.fromFunction1((t0: js.Array[TreeItem[T]]) => onChange(t0).runNow()), treeData = treeData.asInstanceOf[js.Any])
  ...
  extension [Self <: ReactSortableTreeProps[?], T](x: Self & ReactSortableTreeProps[T]) {
    ...
    inline def setOnChange(value: js.Array[TreeItem[T]] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: js.Array[TreeItem[T]]) => value(t0).runNow()))
    
    inline def setOnDragStateChanged(value: /* data */ OnDragStateChangedData[T] => Callback): Self = StObject.set(x, "onDragStateChanged", js.Any.fromFunction1((t0: /* data */ OnDragStateChangedData[T]) => value(t0).runNow()))
    
    inline def setOnDragStateChangedUndefined: Self = StObject.set(x, "onDragStateChanged", js.undefined)
    
    inline def setOnMoveNode(value: /* data */ NodeData[T] & FullTree[T] & OnMovePreviousAndNextLocation[T] => Callback): Self = StObject.set(x, "onMoveNode", js.Any.fromFunction1((t0: /* data */ NodeData[T] & FullTree[T] & OnMovePreviousAndNextLocation[T]) => value(t0).runNow()))
    
    inline def setOnMoveNodeUndefined: Self = StObject.set(x, "onMoveNode", js.undefined)
    
    inline def setOnVisibilityToggle(value: /* data */ OnVisibilityToggleData[T] => Callback): Self = StObject.set(x, "onVisibilityToggle", js.Any.fromFunction1((t0: /* data */ OnVisibilityToggleData[T]) => value(t0).runNow()))
    ...
    inline def setSearchFinishCallback(value: /* matches */ js.Array[NodeData[T]] => Callback): Self = StObject.set(x, "searchFinishCallback", js.Any.fromFunction1((t0: /* matches */ js.Array[NodeData[T]]) => value(t0).runNow()))
