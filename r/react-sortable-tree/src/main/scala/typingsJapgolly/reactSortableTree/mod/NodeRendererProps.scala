...
object NodeRendererProps {
  ...
  inline def apply[T](
    canDrag: Boolean,
    connectDragPreview: (/* elementOrNode */ ConnectableElement, /* options */ js.UndefOr[DragPreviewOptions]) => japgolly.scalajs.react.facade.React.Element | Null,
    connectDragSource: (/* elementOrNode */ ConnectableElement, /* options */ js.UndefOr[DragSourceOptions]) => japgolly.scalajs.react.facade.React.Element | Null,
    didDrop: Boolean,
    endDrag: Any,
    isDragging: Boolean,
    isOver: Boolean,
  ...
  extension [Self <: NodeRendererProps[?], T](x: Self & NodeRendererProps[T]) {
    ...
    inline def setConnectDragPreview(
      value: (/* elementOrNode */ ConnectableElement, /* options */ js.UndefOr[DragPreviewOptions]) => japgolly.scalajs.react.facade.React.Element | Null
    ): Self = StObject.set(x, "connectDragPreview", js.Any.fromFunction2(value))
    
    inline def setConnectDragSource(
      value: (/* elementOrNode */ ConnectableElement, /* options */ js.UndefOr[DragSourceOptions]) => japgolly.scalajs.react.facade.React.Element | Null
    ...
    inline def setToggleChildrenVisibility(value: /* data */ NodeData[T] => Callback): Self = StObject.set(x, "toggleChildrenVisibility", js.Any.fromFunction1((t0: /* data */ NodeData[T]) => value(t0).runNow()))
