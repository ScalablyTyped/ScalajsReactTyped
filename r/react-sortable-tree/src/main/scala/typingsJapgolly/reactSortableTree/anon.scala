...
import typingsJapgolly.reactSortableTree.mod.GetTreeItemChildren
import typingsJapgolly.reactSortableTree.mod.GetTreeItemChildrenFn
...
import typingsJapgolly.reactSortableTree.reactSortableTreeStrings.children
import typingsJapgolly.reactSortableTree.utilsTreeDataUtilsMod.GetNodeKeyFunction
...
object anon {
  ...
  object Children {
    ...
    extension [Self <: Children[?], T](x: Self & Children[T]) {
      ...
      inline def setChildrenFunction1(value: /* data */ GetTreeItemChildren[T] => Callback): Self = StObject.set(x, "children", js.Any.fromFunction1((t0: /* data */ GetTreeItemChildren[T]) => value(t0).runNow()))
