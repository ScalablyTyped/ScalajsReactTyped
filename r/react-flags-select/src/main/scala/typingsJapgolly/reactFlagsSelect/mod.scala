package typingsJapgolly.reactFlagsSelect
...
object mod {
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setOnSelect(value: /* countryCode */ String => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction1((t0: /* countryCode */ String) => value(t0).runNow()))
