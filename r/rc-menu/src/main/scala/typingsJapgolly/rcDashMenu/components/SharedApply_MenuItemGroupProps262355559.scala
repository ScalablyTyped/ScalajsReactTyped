...
import typingsJapgolly.rcDashMenu.libMenuItemGroupMod.MenuItemGroupProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_MenuItemGroupProps262355559[ComponentRef] () {
  ...
  typingsJapgolly.rcDashMenu.libMenuItemGroupMod.MenuItemGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rcDashMenu.libMenuItemGroupMod.MenuItemGroupProps])(children: _*)
  }
}
