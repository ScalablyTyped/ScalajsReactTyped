...
import typingsJapgolly.rcDashMenu.libInterfaceMod.OpenAnimation
...
abstract class SharedApply_MenuProps_628125769[ComponentRef] () {
  ...
  typingsJapgolly.rcDashMenu.libMenuMod.MenuProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rcDashMenu.libMenuMod.MenuProps])(children: _*)
  }
}
