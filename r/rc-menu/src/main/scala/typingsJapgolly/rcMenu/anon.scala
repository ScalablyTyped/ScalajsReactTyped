...
object anon {
  ...
  object DomEvent {
    ...
    inline def apply(domEvent: ReactMouseEventFrom[HTMLElement], key: String): DomEvent = {
    ...
    extension [Self <: DomEvent](x: Self) {
      ...
      inline def setDomEvent(value: ReactMouseEventFrom[HTMLElement]): Self = StObject.set(x, "domEvent", value.asInstanceOf[js.Any])
