...
import typingsJapgolly.rcMenu.menuItemGroupMod.MenuItemGroupProps
...
abstract class SharedApply_MenuItemGroupProps1562318406[ComponentRef] () {
  ...
  typingsJapgolly.rcMenu.menuItemGroupMod.MenuItemGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rcMenu.menuItemGroupMod.MenuItemGroupProps])(children: _*)
  }
}
