...
import typingsJapgolly.rcMenu.interfaceMod.OpenAnimation
...
abstract class SharedApply_MenuProps948433381[ComponentRef] () {
  ...
  typingsJapgolly.rcMenu.menuMod.MenuProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rcMenu.menuMod.MenuProps])(children: _*)
  }
}
