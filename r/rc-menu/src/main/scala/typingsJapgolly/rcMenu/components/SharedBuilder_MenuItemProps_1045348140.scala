...
@scala.inline
open class SharedBuilder_MenuItemProps_1045348140 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def attribute(value: Record[String, String]): this.type = set("attribute", value.asInstanceOf[js.Any])
