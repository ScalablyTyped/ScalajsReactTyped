...
import typingsJapgolly.rcMenu.esInterfaceMod.SelectEventHandler
...
object esMenuMod extends Shortcut {
  
  @JSImport("rc-menu/es/Menu", JSImport.Default)
  @js.native
  val default: ForwardRefExoticComponent[MenuProps & RefAttributes[MenuRef]] = js.native
  
  /* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLUListElement>, 'onClick' | 'onSelect' | 'dir'> */
  ...
  object MenuProps {
    ...
    extension [Self <: MenuProps](x: Self) {
      ...
      inline def setOnDeselect(value: /* info */ SelectInfo => Callback): Self = StObject.set(x, "onDeselect", js.Any.fromFunction1((t0: /* info */ SelectInfo) => value(t0).runNow()))
      ...
      inline def setOnOpenChange(value: /* openKeys */ js.Array[String] => Callback): Self = StObject.set(x, "onOpenChange", js.Any.fromFunction1((t0: /* openKeys */ js.Array[String]) => value(t0).runNow()))
      ...
      inline def setOnSelect(value: /* info */ SelectInfo => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction1((t0: /* info */ SelectInfo) => value(t0).runNow()))
      ...
      inline def setOverflowedIndicator(value: VdomNode): Self = StObject.set(x, "overflowedIndicator", value.rawNode.asInstanceOf[js.Any])
      
      inline def setOverflowedIndicatorNull: Self = StObject.set(x, "overflowedIndicator", null)
      ...
      inline def setOverflowedIndicatorVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "overflowedIndicator", js.Array(value*))
      
      inline def setOverflowedIndicatorVdomElement(value: VdomElement): Self = StObject.set(x, "overflowedIndicator", value.rawElement.asInstanceOf[js.Any])
  ...
  type _To = ForwardRefExoticComponent[MenuProps & RefAttributes[MenuRef]]
  
  /* This means you don't have to write `default`, but can instead just say `esMenuMod.foo` */
  override def _to: ForwardRefExoticComponent[MenuProps & RefAttributes[MenuRef]] = default
}
