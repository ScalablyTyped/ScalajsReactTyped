...
object NavTab {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[NavTabProps, typingsJapgolly.reactRouterTabs.mod.NavTab, Unit, NavTabProps] = {
  ...
  typingsJapgolly.reactRouterTabs.mod.NavTabProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactRouterTabs.mod.NavTab](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactRouterTabs.mod.NavTabProps])(children: _*)
  }
