...
import typingsJapgolly.reactRouterTabs.mod.AriaCurrent
import typingsJapgolly.reactRouterTabs.mod.NavTabProps
...
object NavTab {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def allowClickOnActive(value: Boolean): this.type = set("allowClickOnActive", value.asInstanceOf[js.Any])
    ...
    inline def `aria-current`(value: AriaCurrent): this.type = set("aria-current", value.asInstanceOf[js.Any])
