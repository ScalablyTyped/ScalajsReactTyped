package typingsJapgolly.reactNativeSnackbarComponent
...
object mod {
  ...
  type SnackbarComponent = japgolly.scalajs.react.facade.React.Component[SnackbarComponentProps & js.Object, js.Object]
  ...
  object SnackbarComponentProps {
    ...
    extension [Self <: SnackbarComponentProps](x: Self) {
      ...
      inline def setDistanceCallback(value: Callback): Self = StObject.set(x, "distanceCallback", value.toJsFn)
