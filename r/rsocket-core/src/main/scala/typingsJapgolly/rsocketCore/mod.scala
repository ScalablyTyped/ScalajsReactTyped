...
import typingsJapgolly.rsocketCore.anon.ErrorsourceErrorSource
import typingsJapgolly.rsocketCore.authMetadataMod.AuthMetadata
import typingsJapgolly.rsocketCore.authMetadataMod.UsernameAndPassword
import typingsJapgolly.rsocketCore.compositeMetadataMod.Entry
...
object mod {
  ...
  @js.native
  val BEARER: typingsJapgolly.rsocketCore.wellKnownAuthTypeMod.WellKnownAuthType = js.native
  ...
  @js.native
  val MESSAGE_RSOCKET_ACCEPT_MIMETYPES: typingsJapgolly.rsocketCore.wellKnownMimeTypeMod.WellKnownMimeType = js.native
  
  @JSImport("rsocket-core", "MESSAGE_RSOCKET_AUTHENTICATION")
  @js.native
  val MESSAGE_RSOCKET_AUTHENTICATION: typingsJapgolly.rsocketCore.wellKnownMimeTypeMod.WellKnownMimeType = js.native
  ...
  @js.native
  val MESSAGE_RSOCKET_MIMETYPE: typingsJapgolly.rsocketCore.wellKnownMimeTypeMod.WellKnownMimeType = js.native
  ...
  @js.native
  val SIMPLE: typingsJapgolly.rsocketCore.wellKnownAuthTypeMod.WellKnownAuthType = js.native
  ...
  @js.native
  val UNKNOWN_RESERVED_AUTH_TYPE: typingsJapgolly.rsocketCore.wellKnownAuthTypeMod.WellKnownAuthType = js.native
  ...
  @js.native
  val UNPARSEABLE_AUTH_TYPE: typingsJapgolly.rsocketCore.wellKnownAuthTypeMod.WellKnownAuthType = js.native
  ...
  open class WellKnownAuthType protected ()
    extends typingsJapgolly.rsocketCore.wellKnownAuthTypeMod.default {
  ...
  object WellKnownAuthType {
    ...
    /**
      ...
      */
    inline def fromIdentifier(id: Double): typingsJapgolly.rsocketCore.wellKnownAuthTypeMod.WellKnownAuthType = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdentifier")(id.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rsocketCore.wellKnownAuthTypeMod.WellKnownAuthType]
    ...
    /**
      ...
      *     matches
      */
    inline def fromString(authTypeString: String): typingsJapgolly.rsocketCore.wellKnownAuthTypeMod.WellKnownAuthType = ^.asInstanceOf[js.Dynamic].applyDynamic("fromString")(authTypeString.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rsocketCore.wellKnownAuthTypeMod.WellKnownAuthType]
  }
  ...
  object WellKnownMimeType {
    ...
    /**
      ...
      *     is merely reserved but unknown to this implementation.
      */
    inline def fromIdentifier(id: Double): typingsJapgolly.rsocketCore.wellKnownMimeTypeMod.WellKnownMimeType = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdentifier")(id.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rsocketCore.wellKnownMimeTypeMod.WellKnownMimeType]
    ...
    /**
      ...
      */
    inline def fromString(mimeType: String): typingsJapgolly.rsocketCore.wellKnownMimeTypeMod.WellKnownMimeType = ^.asInstanceOf[js.Dynamic].applyDynamic("fromString")(mimeType.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.rsocketCore.wellKnownMimeTypeMod.WellKnownMimeType]
  }
  ...
  inline def encodeCompositeMetadata(
    metadata: js.Array[
      js.Tuple2[
        String | typingsJapgolly.rsocketCore.wellKnownMimeTypeMod.default | Double, 
  ...
  inline def encodeWellKnownAuthMetadata(authType: typingsJapgolly.rsocketCore.wellKnownAuthTypeMod.default, authPayloadBuffer: Buffer): Buffer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeWellKnownAuthMetadata")(authType.asInstanceOf[js.Any], authPayloadBuffer.asInstanceOf[js.Any])).asInstanceOf[Buffer]
