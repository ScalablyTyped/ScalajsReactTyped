...
object Bag {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(chunkInfos = chunkInfos.asInstanceOf[js.Any], connections = connections.asInstanceOf[js.Any], header = header.asInstanceOf[js.Any], open = open.toJsFn, readMessages = js.Any.fromFunction2(readMessages), reader = reader.asInstanceOf[js.Any])
