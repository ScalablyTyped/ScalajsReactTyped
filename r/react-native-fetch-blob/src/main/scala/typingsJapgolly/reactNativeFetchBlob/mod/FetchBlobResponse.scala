...
object FetchBlobResponse {
  ...
  def apply(
    ...
    __obj.updateDynamic("readFile")(js.Any.fromFunction1((t0: typingsJapgolly.reactNativeFetchBlob.mod.Encoding) => readFile(t0).runNow()))
    __obj.updateDynamic("readStream")(js.Any.fromFunction1((t0: typingsJapgolly.reactNativeFetchBlob.mod.Encoding) => readStream(t0).runNow()))
