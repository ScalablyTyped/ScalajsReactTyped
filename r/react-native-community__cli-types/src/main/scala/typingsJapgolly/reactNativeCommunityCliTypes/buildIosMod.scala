...
object buildIosMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNativeCommunityCliTypes.anon.scriptstringnamestringshe
    - typingsJapgolly.reactNativeCommunityCliTypes.anon.pathstringnamestringshell
  */
  trait IOSScriptPhase extends StObject
  object IOSScriptPhase {
    
    inline def pathstringnamestringshell(name: String, path: String): typingsJapgolly.reactNativeCommunityCliTypes.anon.pathstringnamestringshell = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reactNativeCommunityCliTypes.anon.pathstringnamestringshell]
    }
    
    inline def scriptstringnamestringshe(name: String, script: String): typingsJapgolly.reactNativeCommunityCliTypes.anon.scriptstringnamestringshe = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], script = script.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reactNativeCommunityCliTypes.anon.scriptstringnamestringshe]
    }
  }
}
