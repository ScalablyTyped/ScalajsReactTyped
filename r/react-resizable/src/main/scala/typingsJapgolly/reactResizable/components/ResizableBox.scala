...
object ResizableBox {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ResizableProps, typingsJapgolly.reactResizable.mod.ResizableBox, Unit, ResizableProps] = {
  ...
  typingsJapgolly.reactResizable.mod.ResizableBox](this.componentImport)
