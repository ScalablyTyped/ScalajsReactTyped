...
object Options {
  ...
  extension [Self <: Options[?, ?], TKeys, TState](x: Self & (Options[TKeys, TState])) {
    ...
    inline def setCreateHistory(value: CallbackTo[History]): Self = StObject.set(x, "createHistory", value.toJsFn)
    
    inline def setCreateHistoryUndefined: Self = StObject.set(x, "createHistory", js.undefined)
    
    inline def setDisplayConfirmLeave(
      value: (/* message */ String, /* callback */ js.Function1[/* unblock */ Boolean, Unit]) => Callback
    ): Self = StObject.set(x, "displayConfirmLeave", js.Any.fromFunction2((t0: /* message */ String, t1: /* callback */ js.Function1[/* unblock */ Boolean, Unit]) => (value(t0, t1)).runNow()))
    ...
    inline def setOnAfterChange(
      value: (/* dispatch */ Dispatch[Any], /* getState */ StateGetter[TState], /* bag */ Bag) => Callback
    ): Self = StObject.set(x, "onAfterChange", js.Any.fromFunction3((t0: /* dispatch */ Dispatch[Any], t1: /* getState */ StateGetter[TState], t2: /* bag */ Bag) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnAfterChangeUndefined: Self = StObject.set(x, "onAfterChange", js.undefined)
    
    inline def setOnBackNext(
      value: (/* dispatch */ Dispatch[Any], /* getState */ StateGetter[TState], /* bag */ Bag) => Callback
    ): Self = StObject.set(x, "onBackNext", js.Any.fromFunction3((t0: /* dispatch */ Dispatch[Any], t1: /* getState */ StateGetter[TState], t2: /* bag */ Bag) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnBackNextUndefined: Self = StObject.set(x, "onBackNext", js.undefined)
    
    inline def setOnBeforeChange(
      value: (/* dispatch */ Dispatch[Any], /* getState */ StateGetter[TState], /* bag */ Bag) => Callback
    ): Self = StObject.set(x, "onBeforeChange", js.Any.fromFunction3((t0: /* dispatch */ Dispatch[Any], t1: /* getState */ StateGetter[TState], t2: /* bag */ Bag) => (value(t0, t1, t2)).runNow()))
