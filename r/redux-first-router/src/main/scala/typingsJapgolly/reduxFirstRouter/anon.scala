...
import typingsJapgolly.reduxFirstRouter.mod.Bag
...
object anon {
  ...
  object Enhancer {
    ...
    extension [Self <: Enhancer[?, ?], TKeys, TState](x: Self & (Enhancer[TKeys, TState])) {
      ...
      inline def setInitialDispatch(value: Callback): Self = StObject.set(x, "initialDispatch", value.toJsFn)
  ...
  trait Params extends StObject {
    ...
    var params: Nullable[typingsJapgolly.reduxFirstRouter.mod.Params]
  ...
  object Params {
    ...
    extension [Self <: Params](x: Self) {
      ...
      inline def setParams(value: Nullable[typingsJapgolly.reduxFirstRouter.mod.Params]): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
