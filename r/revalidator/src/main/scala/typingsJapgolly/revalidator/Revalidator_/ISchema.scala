...
object ISchema {
  ...
  def apply[T](
    ...
    conform: (/* value */ js.Any, /* data */ js.UndefOr[T]) => CallbackTo[Boolean] = null,
    default: js.Any = null,
    ...
    if (conform != null) __obj.updateDynamic("conform")(js.Any.fromFunction2((t0: /* value */ js.Any, t1: /* data */ js.UndefOr[T]) => conform(t0, t1).runNow()))
