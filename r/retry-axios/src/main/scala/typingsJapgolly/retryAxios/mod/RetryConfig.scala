...
object RetryConfig {
  ...
  def apply(
    ...
    onRetryAttempt: /* err */ AxiosError[js.Any] => Callback = null,
    retry: Int | Double = null,
    retryDelay: Int | Double = null,
    shouldRetry: /* err */ AxiosError[js.Any] => CallbackTo[Boolean] = null,
    ...
    if (onRetryAttempt != null) __obj.updateDynamic("onRetryAttempt")(js.Any.fromFunction1((t0: /* err */ typingsJapgolly.axios.mod.AxiosError[js.Any]) => onRetryAttempt(t0).runNow()))
    if (retry != null) __obj.updateDynamic("retry")(retry.asInstanceOf[js.Any])
    if (retryDelay != null) __obj.updateDynamic("retryDelay")(retryDelay.asInstanceOf[js.Any])
    if (shouldRetry != null) __obj.updateDynamic("shouldRetry")(js.Any.fromFunction1((t0: /* err */ typingsJapgolly.axios.mod.AxiosError[js.Any]) => shouldRetry(t0).runNow()))
