package typingsJapgolly.retryAxios
...
import typingsJapgolly.retryAxios.retryAxiosStrings.exponential
import typingsJapgolly.retryAxios.retryAxiosStrings.linear
import typingsJapgolly.retryAxios.retryAxiosStrings.static
...
object mod {
  ...
  object RetryConfig {
    ...
    extension [Self <: RetryConfig](x: Self) {
      ...
      inline def setOnRetryAttempt(value: /* err */ AxiosError[Any, Any] => Callback): Self = StObject.set(x, "onRetryAttempt", js.Any.fromFunction1((t0: /* err */ AxiosError[Any, Any]) => value(t0).runNow()))
  ...
  object axiosAugmentingMod {
    ...
    object AxiosRequestConfig {
      ...
      inline def apply(): typingsJapgolly.retryAxios.mod.axiosAugmentingMod.AxiosRequestConfig = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.retryAxios.mod.axiosAugmentingMod.AxiosRequestConfig]
      }
      
      extension [Self <: typingsJapgolly.retryAxios.mod.axiosAugmentingMod.AxiosRequestConfig](x: Self) {
