...
trait StackedAreaChartProps[T]
  ...
  var renderGradient: js.UndefOr[
    js.Function1[
      /* props */ Color[T], 
      Component[(LinearGradientProps | RadialGradientProps) & js.Object, js.Object]
    ]
  ] = js.undefined
...
object StackedAreaChartProps {
  ...
  extension [Self <: StackedAreaChartProps[?], T](x: Self & StackedAreaChartProps[T]) {
    ...
    inline def setOffset(value: (/* series */ Series[Any, Any], /* order */ js.Array[Double]) => Callback): Self = StObject.set(x, "offset", js.Any.fromFunction2((t0: /* series */ Series[Any, Any], t1: /* order */ js.Array[Double]) => (value(t0, t1)).runNow()))
    ...
    inline def setRenderDecorator(value: CallbackTo[js.Object]): Self = StObject.set(x, "renderDecorator", value.toJsFn)
