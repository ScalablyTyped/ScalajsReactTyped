...
object BarChart {
  def apply[T](
    ...
    BarChartProps[T], 
    typingsJapgolly.reactNativeSvgCharts.mod.BarChart[T], 
    Unit, 
    BarChartProps[T]
  ] = {
  ...
  typingsJapgolly.reactNativeSvgCharts.mod.BarChartProps[T], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSvgCharts.mod.BarChart[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvgCharts.mod.BarChartProps[T]])(children: _*)
  }
