...
import typingsJapgolly.reactNativeSvgCharts.AnonColor
...
object StackedAreaChart {
  def apply[T](
    ...
    renderDecorator: js.UndefOr[CallbackTo[js.Object]] = js.undefined,
    renderGradient: /* props */ AnonColor[T] => CallbackTo[Component[(LinearGradientProps | RadialGradientProps) with js.Object, js.Object]] = null,
    ...
    typingsJapgolly.reactNativeSvgCharts.mod.StackedAreaChart[T], 
    Unit, 
    StackedAreaChartProps[T]
  ] = {
    ...
    renderDecorator.foreach(p => __obj.updateDynamic("renderDecorator")(p.toJsFn))
    if (renderGradient != null) __obj.updateDynamic("renderGradient")(js.Any.fromFunction1((t0: /* props */ typingsJapgolly.reactNativeSvgCharts.AnonColor[T]) => renderGradient(t0).runNow()))
  ...
  typingsJapgolly.reactNativeSvgCharts.mod.StackedAreaChartProps[T], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSvgCharts.mod.StackedAreaChart[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvgCharts.mod.StackedAreaChartProps[T]])(children: _*)
  }
