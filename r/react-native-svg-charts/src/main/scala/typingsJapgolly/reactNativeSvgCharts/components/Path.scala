...
object Path {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeSvgCharts.mod.Path] {
    ...
    inline def renderPlaceholder(value: CallbackTo[Any]): this.type = set("renderPlaceholder", value.toJsFn)
