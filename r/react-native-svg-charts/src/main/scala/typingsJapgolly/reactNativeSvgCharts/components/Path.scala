...
import typingsJapgolly.reactNativeSvgCharts.mod.AnimatedPathProps
...
object Path {
  def apply(
    ...
    renderPlaceholder: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    AnimatedPathProps, 
    typingsJapgolly.reactNativeSvgCharts.mod.Path, 
    Unit, 
    AnimatedPathProps
  ] = {
    ...
    renderPlaceholder.foreach(p => __obj.updateDynamic("renderPlaceholder")(p.toJsFn))
  ...
  typingsJapgolly.reactNativeSvgCharts.mod.AnimatedPathProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSvgCharts.mod.Path](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvgCharts.mod.AnimatedPathProps])(children: _*)
  }
