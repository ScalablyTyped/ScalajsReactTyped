...
trait PickViewPropsRefAttributeAccessibilityIgnoresInvertColors extends StObject {
...
object PickViewPropsRefAttributeAccessibilityIgnoresInvertColors {
  
  inline def apply(): PickViewPropsRefAttributeAccessibilityIgnoresInvertColors = {
