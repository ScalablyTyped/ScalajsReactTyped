...
/* Inlined react-native.react-native.SwitchProps & react.react.RefAttributes<react-native.react-native.Switch> & {  disabled :boolean | undefined,   value :boolean | undefined,   color :string | undefined,   onValueChange :std.Function | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} */
trait SwitchPropsRefAttributesS extends StObject {
