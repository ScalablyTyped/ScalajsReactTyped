...
trait PickthemeDeepPartialThemeAccessibilityActions extends StObject {
...
object PickthemeDeepPartialThemeAccessibilityActions {
  ...
  inline def apply(): PickthemeDeepPartialThemeAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickthemeDeepPartialThemeAccessibilityActions]
  }
  
  extension [Self <: PickthemeDeepPartialThemeAccessibilityActions](x: Self) {
