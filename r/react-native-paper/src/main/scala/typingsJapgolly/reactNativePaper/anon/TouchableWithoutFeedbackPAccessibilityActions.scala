...
/* Inlined react-native.react-native.TouchableWithoutFeedbackProps & react.react.RefAttributes<react-native.react-native.TouchableWithoutFeedback> & {  children :react.react.ReactNode,   numeric :boolean | undefined,   sortDirection :'ascending' | 'descending' | undefined,   numberOfLines :number | undefined,   onPress :(): void | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   textStyle :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} */
trait TouchableWithoutFeedbackPAccessibilityActions extends StObject {
  ...
  var ref: js.UndefOr[typingsJapgolly.react.mod.Ref[TouchableWithoutFeedback]] = js.undefined
...
object TouchableWithoutFeedbackPAccessibilityActions {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], onPress = onPress.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[TouchableWithoutFeedbackPAccessibilityActions]
  }
  
  extension [Self <: TouchableWithoutFeedbackPAccessibilityActions](x: Self) {
    ...
    inline def setRef(value: typingsJapgolly.react.mod.Ref[TouchableWithoutFeedback]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: TouchableWithoutFeedback | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: TouchableWithoutFeedback | Null) => value(t0).runNow()))
