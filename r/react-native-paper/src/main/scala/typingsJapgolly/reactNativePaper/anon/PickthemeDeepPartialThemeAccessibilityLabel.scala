...
trait PickthemeDeepPartialThemeAccessibilityLabel extends StObject {
...
object PickthemeDeepPartialThemeAccessibilityLabel {
  
  inline def apply(): PickthemeDeepPartialThemeAccessibilityLabel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickthemeDeepPartialThemeAccessibilityLabel]
  }
  
  extension [Self <: PickthemeDeepPartialThemeAccessibilityLabel](x: Self) {
