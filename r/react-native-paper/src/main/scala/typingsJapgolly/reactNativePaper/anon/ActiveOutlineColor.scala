...
object ActiveOutlineColor {
  ...
  inline def apply(theme: typingsJapgolly.reactNativePaper.libTypescriptTypesMod.global.ReactNativePaper.Theme): ActiveOutlineColor = {
  ...
  extension [Self <: ActiveOutlineColor](x: Self) {
    ...
    inline def setOnBlur(value: /* args */ Any => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: /* args */ Any) => value(t0).runNow()))
    ...
    inline def setOnFocus(value: /* args */ Any => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: /* args */ Any) => value(t0).runNow()))
