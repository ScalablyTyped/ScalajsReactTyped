...
trait PickPropslabelstylecoloroAccessibilityLabel extends StObject {
...
object PickPropslabelstylecoloroAccessibilityLabel {
  
  inline def apply(label: String, value: String): PickPropslabelstylecoloroAccessibilityLabel = {
