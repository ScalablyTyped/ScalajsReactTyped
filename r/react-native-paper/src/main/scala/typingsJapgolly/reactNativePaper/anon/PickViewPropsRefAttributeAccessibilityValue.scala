...
/* Inlined std.Pick<react-native.react-native.ViewProps & react.react.RefAttributes<react-native.react-native.View> & {  title :string | undefined,   children :react.react.ReactNode,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme,   titleStyle :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined}, 'title' | keyof react-native.react-native.ViewProps | keyof react.react.RefAttributes<react-native.react-native.View> | 'titleStyle'> & {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined} */
trait PickViewPropsRefAttributeAccessibilityValue extends StObject {
...
object PickViewPropsRefAttributeAccessibilityValue {
  
  inline def apply(): PickViewPropsRefAttributeAccessibilityValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickViewPropsRefAttributeAccessibilityValue]
  }
  
  extension [Self <: PickViewPropsRefAttributeAccessibilityValue](x: Self) {
