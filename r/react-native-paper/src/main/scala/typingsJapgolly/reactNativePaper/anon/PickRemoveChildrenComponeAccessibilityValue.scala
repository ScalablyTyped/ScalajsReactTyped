...
trait PickRemoveChildrenComponeAccessibilityValue extends StObject {
  ...
  var small: js.UndefOr[Any] = js.undefined
  ...
  var uppercase: js.UndefOr[Any] = js.undefined
  
  var visible: js.UndefOr[Any] = js.undefined
}
object PickRemoveChildrenComponeAccessibilityValue {
  
  inline def apply(): PickRemoveChildrenComponeAccessibilityValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickRemoveChildrenComponeAccessibilityValue]
  }
  
  extension [Self <: PickRemoveChildrenComponeAccessibilityValue](x: Self) {
    ...
    inline def setUppercase(value: Any): Self = StObject.set(x, "uppercase", value.asInstanceOf[js.Any])
