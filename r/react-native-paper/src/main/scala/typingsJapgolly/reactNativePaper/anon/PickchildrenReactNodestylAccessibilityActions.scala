...
/* Inlined std.Pick<{  children :react.react.ReactNode,   style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} & react-native.react-native.TextProps, keyof react-native.react-native.TextProps> & {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined} */
trait PickchildrenReactNodestylAccessibilityActions extends StObject {
...
object PickchildrenReactNodestylAccessibilityActions {
  
  inline def apply(): PickchildrenReactNodestylAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickchildrenReactNodestylAccessibilityActions]
  }
  
  extension [Self <: PickchildrenReactNodestylAccessibilityActions](x: Self) {
