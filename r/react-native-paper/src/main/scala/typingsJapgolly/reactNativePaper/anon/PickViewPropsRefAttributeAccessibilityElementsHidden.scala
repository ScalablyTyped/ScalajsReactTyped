...
object PickViewPropsRefAttributeAccessibilityElementsHidden {
  
  inline def apply(source: AvatarImageSource): PickViewPropsRefAttributeAccessibilityElementsHidden = {
    val __obj = js.Dynamic.literal(source = source.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickViewPropsRefAttributeAccessibilityElementsHidden]
  }
  
  extension [Self <: PickViewPropsRefAttributeAccessibilityElementsHidden](x: Self) {
