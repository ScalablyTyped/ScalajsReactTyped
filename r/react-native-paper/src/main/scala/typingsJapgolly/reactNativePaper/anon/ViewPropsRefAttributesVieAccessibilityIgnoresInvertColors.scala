...
import typingsJapgolly.reactNative.mod.Animated.WithAnimatedArray
import typingsJapgolly.reactNative.mod.Falsy
import typingsJapgolly.reactNative.mod.GestureResponderEvent
import typingsJapgolly.reactNative.mod.Insets
import typingsJapgolly.reactNative.mod.LayoutChangeEvent
import typingsJapgolly.reactNative.mod.PointerEvent
import typingsJapgolly.reactNative.mod.RecursiveArray
...
import typingsJapgolly.reactNativePaper.reactNativePaperBooleans.`false`
...
trait ViewPropsRefAttributesVieAccessibilityIgnoresInvertColors extends StObject {
  ...
  var style: js.UndefOr[StyleProp[ViewStyle]] & (js.UndefOr[
    `false` | RegisteredStyle[ViewStyle] | typingsJapgolly.reactNative.mod.Animated.Value | (AnimatedInterpolation[Double | String]) | WithAnimatedObjectViewSty | (WithAnimatedArray[
...
object ViewPropsRefAttributesVieAccessibilityIgnoresInvertColors {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], style = style.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any])
