...
trait PickViewPropsRefAttributeAccessibilityLabel extends StObject {
...
object PickViewPropsRefAttributeAccessibilityLabel {
  
  inline def apply(): PickViewPropsRefAttributeAccessibilityLabel = {
    val __obj = js.Dynamic.literal(title = null)
    __obj.asInstanceOf[PickViewPropsRefAttributeAccessibilityLabel]
  }
  
  extension [Self <: PickViewPropsRefAttributeAccessibilityLabel](x: Self) {
