...
trait PickRemoveChildrenComponeAccessibilityElementsHidden extends StObject {
  ...
  var uncheckedColor: js.UndefOr[Any] = js.undefined
  
  var underlayColor: js.UndefOr[Any] = js.undefined
}
object PickRemoveChildrenComponeAccessibilityElementsHidden {
  
  inline def apply(): PickRemoveChildrenComponeAccessibilityElementsHidden = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickRemoveChildrenComponeAccessibilityElementsHidden]
  }
  
  extension [Self <: PickRemoveChildrenComponeAccessibilityElementsHidden](x: Self) {
    ...
    inline def setUncheckedColor(value: Any): Self = StObject.set(x, "uncheckedColor", value.asInstanceOf[js.Any])
