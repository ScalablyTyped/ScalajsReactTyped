...
trait PickPropsstylenavigationS extends StObject {
  ...
  var renderScene: js.Function1[/* props */ JumpTo, Node | Null]
...
object PickPropsstylenavigationS {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(navigationState = navigationState.asInstanceOf[js.Any], onIndexChange = js.Any.fromFunction1((t0: /* index */ Double) => onIndexChange(t0).runNow()), renderScene = js.Any.fromFunction1(renderScene))
  ...
  extension [Self <: PickPropsstylenavigationS](x: Self) {
    ...
    inline def setRenderScene(value: /* props */ JumpTo => Node | Null): Self = StObject.set(x, "renderScene", js.Any.fromFunction1(value))
