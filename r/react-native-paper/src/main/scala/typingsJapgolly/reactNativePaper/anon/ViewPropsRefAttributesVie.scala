...
/* Inlined react-native.react-native.ViewProps & react.react.RefAttributes<react-native.react-native.View> & {  animating :boolean | undefined,   color :string | undefined,   size :number | 'small' | 'large' | undefined,   hidesWhenStopped :boolean | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} */
trait ViewPropsRefAttributesVie extends StObject {
...
object ViewPropsRefAttributesVie {
  
  inline def apply(theme: typingsJapgolly.reactNativePaper.libTypescriptTypesMod.global.ReactNativePaper.Theme): ViewPropsRefAttributesVie = {
    val __obj = js.Dynamic.literal(theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[ViewPropsRefAttributesVie]
  }
  
  extension [Self <: ViewPropsRefAttributesVie](x: Self) {
