...
trait PickRemoveChildrenComponeAccessibilityViewIsModal extends StObject {
  ...
  var description: js.UndefOr[Any] = js.undefined
  
  var descriptionEllipsizeMode: js.UndefOr[Any] = js.undefined
  
  var descriptionNumberOfLines: js.UndefOr[Any] = js.undefined
  
  var descriptionStyle: js.UndefOr[Any] = js.undefined
  ...
  var titleEllipsizeMode: js.UndefOr[Any] = js.undefined
  
  var titleNumberOfLines: js.UndefOr[Any] = js.undefined
...
object PickRemoveChildrenComponeAccessibilityViewIsModal {
  
  inline def apply(): PickRemoveChildrenComponeAccessibilityViewIsModal = {
  ...
  extension [Self <: PickRemoveChildrenComponeAccessibilityViewIsModal](x: Self) {
    ...
    inline def setDescriptionEllipsizeMode(value: Any): Self = StObject.set(x, "descriptionEllipsizeMode", value.asInstanceOf[js.Any])
    
    inline def setDescriptionEllipsizeModeUndefined: Self = StObject.set(x, "descriptionEllipsizeMode", js.undefined)
    
    inline def setDescriptionNumberOfLines(value: Any): Self = StObject.set(x, "descriptionNumberOfLines", value.asInstanceOf[js.Any])
    
    inline def setDescriptionNumberOfLinesUndefined: Self = StObject.set(x, "descriptionNumberOfLines", js.undefined)
    
    inline def setDescriptionStyle(value: Any): Self = StObject.set(x, "descriptionStyle", value.asInstanceOf[js.Any])
    ...
    inline def setTitleEllipsizeMode(value: Any): Self = StObject.set(x, "titleEllipsizeMode", value.asInstanceOf[js.Any])
    
    inline def setTitleEllipsizeModeUndefined: Self = StObject.set(x, "titleEllipsizeMode", js.undefined)
    
    inline def setTitleNumberOfLines(value: Any): Self = StObject.set(x, "titleNumberOfLines", value.asInstanceOf[js.Any])
