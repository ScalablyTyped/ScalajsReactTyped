...
object PickViewPropsRefAttributeAccessibilityLiveRegion {
  ...
  inline def apply(numberOfPages: Double, onPageChange: /* page */ Double => Callback, page: Double): PickViewPropsRefAttributeAccessibilityLiveRegion = {
    val __obj = js.Dynamic.literal(numberOfPages = numberOfPages.asInstanceOf[js.Any], onPageChange = js.Any.fromFunction1((t0: /* page */ Double) => onPageChange(t0).runNow()), page = page.asInstanceOf[js.Any])
