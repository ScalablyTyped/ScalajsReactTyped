...
trait PickPropsstyletitleonPresAccessibilityLabel extends StObject {
...
object PickPropsstyletitleonPresAccessibilityLabel {
  
  inline def apply(): PickPropsstyletitleonPresAccessibilityLabel = {
    val __obj = js.Dynamic.literal(title = null)
    __obj.asInstanceOf[PickPropsstyletitleonPresAccessibilityLabel]
  }
  
  extension [Self <: PickPropsstyletitleonPresAccessibilityLabel](x: Self) {
