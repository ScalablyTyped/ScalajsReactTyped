...
object pagenumbernumberOfPagesnu {
  
  inline def apply(
    numberOfPages: Double,
    onPageChange: Double => Callback,
    page: Double,
    theme: typingsJapgolly.reactNativePaper.libTypescriptTypesMod.global.ReactNativePaper.Theme
  ): pagenumbernumberOfPagesnu = {
    val __obj = js.Dynamic.literal(numberOfPages = numberOfPages.asInstanceOf[js.Any], onPageChange = js.Any.fromFunction1((t0: Double) => onPageChange(t0).runNow()), page = page.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[pagenumbernumberOfPagesnu]
  }
  
  extension [Self <: pagenumbernumberOfPagesnu](x: Self) {
