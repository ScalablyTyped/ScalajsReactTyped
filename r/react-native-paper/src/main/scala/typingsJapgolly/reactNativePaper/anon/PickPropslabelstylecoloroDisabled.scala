...
trait PickPropslabelstylecoloroDisabled extends StObject {
...
object PickPropslabelstylecoloroDisabled {
  
  inline def apply(label: String, value: String): PickPropslabelstylecoloroDisabled = {
    val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPropslabelstylecoloroDisabled]
  }
  
  extension [Self <: PickPropslabelstylecoloroDisabled](x: Self) {
