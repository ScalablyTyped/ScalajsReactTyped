...
import typingsJapgolly.reactNativePaper.libTypescriptComponentsTextInputTextInputMod.TextInputHandles
...
trait TextInputPropsRefAttribut extends StObject {
  ...
  var ref: js.UndefOr[typingsJapgolly.react.mod.Ref[TextInput]] & js.UndefOr[typingsJapgolly.react.mod.Ref[TextInputHandles]]
...
object TextInputPropsRefAttribut {
  ...
  inline def apply(
    ...
    ref: js.UndefOr[typingsJapgolly.react.mod.Ref[TextInput]] & js.UndefOr[typingsJapgolly.react.mod.Ref[TextInputHandles]],
  ...
  extension [Self <: TextInputPropsRefAttribut](x: Self) {
    ...
    inline def setRef(
      value: js.UndefOr[typingsJapgolly.react.mod.Ref[TextInput]] & js.UndefOr[typingsJapgolly.react.mod.Ref[TextInputHandles]]
