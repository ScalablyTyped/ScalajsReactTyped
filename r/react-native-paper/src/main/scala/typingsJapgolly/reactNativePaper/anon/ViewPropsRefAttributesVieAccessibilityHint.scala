...
/* Inlined react-native.react-native.ViewProps & react.react.RefAttributes<react-native.react-native.View> & {  label :string,   size :number | undefined,   color :string | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   labelStyle :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} */
trait ViewPropsRefAttributesVieAccessibilityHint extends StObject {
...
object ViewPropsRefAttributesVieAccessibilityHint {
  ...
  ): ViewPropsRefAttributesVieAccessibilityHint = {
  ...
  extension [Self <: ViewPropsRefAttributesVieAccessibilityHint](x: Self) {
