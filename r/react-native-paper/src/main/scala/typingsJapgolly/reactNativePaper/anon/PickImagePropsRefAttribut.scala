...
import typingsJapgolly.reactNativePaper.reactNativePaperStrings.resize
import typingsJapgolly.reactNativePaper.reactNativePaperStrings.scale
...
trait PickImagePropsRefAttribut extends StObject {
  ...
  var ref: js.UndefOr[typingsJapgolly.react.mod.Ref[Image]] = js.undefined
...
object PickImagePropsRefAttribut {
  
  inline def apply(): PickImagePropsRefAttribut = {
  ...
  extension [Self <: PickImagePropsRefAttribut](x: Self) {
    ...
    inline def setRef(value: typingsJapgolly.react.mod.Ref[Image]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: Image | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: Image | Null) => value(t0).runNow()))
