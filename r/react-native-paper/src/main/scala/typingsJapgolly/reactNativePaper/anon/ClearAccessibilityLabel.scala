...
object ClearAccessibilityLabel {
  ...
  extension [Self <: ClearAccessibilityLabel](x: Self) {
    ...
    inline def setClearIconFunction1(value: /* props */ IconPropscolorstring => Node): Self = StObject.set(x, "clearIcon", js.Any.fromFunction1(value))
    ...
    inline def setOnChangeText(value: /* query */ String => Callback): Self = StObject.set(x, "onChangeText", js.Any.fromFunction1((t0: /* query */ String) => value(t0).runNow()))
