...
/* Inlined std.Pick<react-native.react-native.ViewProps & react.react.RefAttributes<react-native.react-native.View> & {  label :string,   icon :react-native-paper.react-native-paper/lib/typescript/components/Icon.IconSource | undefined,   active :boolean | undefined,   onPress :(): void | undefined,   accessibilityLabel :string | undefined,   right :(props : {  color :string}): react.react.ReactNode | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme}, 'label' | 'onPress' | 'icon' | 'right' | keyof react-native.react-native.ViewProps | keyof react.react.RefAttributes<react-native.react-native.View> | 'active'> & {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined} */
trait PickViewPropsRefAttributeAccessibilityRole extends StObject {
...
object PickViewPropsRefAttributeAccessibilityRole {
  
  inline def apply(label: String): PickViewPropsRefAttributeAccessibilityRole = {
    val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickViewPropsRefAttributeAccessibilityRole]
  }
  
  extension [Self <: PickViewPropsRefAttributeAccessibilityRole](x: Self) {
