...
import typingsJapgolly.reactNative.anon.False
...
import typingsJapgolly.reactNative.mod.SwitchChangeEvent
...
/* Inlined std.Pick<react-native.react-native.SwitchProps & react.react.RefAttributes<react-native.react-native.Switch> & {  disabled :boolean | undefined,   value :boolean | undefined,   color :string | undefined,   onValueChange :std.Function | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme}, 'color' | keyof react-native.react-native.SwitchProps | keyof react.react.RefAttributes<react-native.react-native.Switch>> & {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined} */
trait PickSwitchPropsRefAttribu extends StObject {
  ...
  var ref: js.UndefOr[typingsJapgolly.react.mod.Ref[Switch]] = js.undefined
...
object PickSwitchPropsRefAttribu {
  
  inline def apply(): PickSwitchPropsRefAttribu = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickSwitchPropsRefAttribu]
  }
  
  extension [Self <: PickSwitchPropsRefAttribu](x: Self) {
    ...
    inline def setRef(value: typingsJapgolly.react.mod.Ref[Switch]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: Switch | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: Switch | Null) => value(t0).runNow()))
