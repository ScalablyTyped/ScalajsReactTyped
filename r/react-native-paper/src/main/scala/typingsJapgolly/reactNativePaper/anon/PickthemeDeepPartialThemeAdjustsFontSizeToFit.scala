...
/* Inlined std.Pick<{  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme,   style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined} & std.Pick<react-native.react-native.TextProps & {  style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} & react.react.RefAttributes<{}>, keyof react-native.react-native.TextProps | keyof react.react.RefAttributes<{}>>, keyof react-native.react-native.TextProps | keyof react.react.RefAttributes<{}>> & {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined} */
trait PickthemeDeepPartialThemeAdjustsFontSizeToFit extends StObject {
...
object PickthemeDeepPartialThemeAdjustsFontSizeToFit {
  ...
  inline def apply(): PickthemeDeepPartialThemeAdjustsFontSizeToFit = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickthemeDeepPartialThemeAdjustsFontSizeToFit]
  }
  
  extension [Self <: PickthemeDeepPartialThemeAdjustsFontSizeToFit](x: Self) {
