...
object ViewPropsRefAttributesVieAccessibilityLabel {
  ...
  inline def apply(theme: typingsJapgolly.reactNativePaper.libTypescriptTypesMod.global.ReactNativePaper.Theme): ViewPropsRefAttributesVieAccessibilityLabel = {
