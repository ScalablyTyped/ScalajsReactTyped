...
trait PickthemeDeepPartialThemeAccessibilityValue extends StObject {
...
object PickthemeDeepPartialThemeAccessibilityValue {
  ...
  inline def apply(): PickthemeDeepPartialThemeAccessibilityValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickthemeDeepPartialThemeAccessibilityValue]
  }
  
  extension [Self <: PickthemeDeepPartialThemeAccessibilityValue](x: Self) {
