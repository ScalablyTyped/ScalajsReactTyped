...
object PickthemeDeepPartialThemeChildren {
  ...
  inline def apply(onDismiss: Callback, visible: Boolean): PickthemeDeepPartialThemeChildren = {
    val __obj = js.Dynamic.literal(onDismiss = onDismiss.toJsFn, visible = visible.asInstanceOf[js.Any])
