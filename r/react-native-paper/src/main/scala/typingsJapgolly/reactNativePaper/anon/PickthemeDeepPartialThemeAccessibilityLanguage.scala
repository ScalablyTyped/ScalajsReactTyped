...
import typingsJapgolly.reactNativePaper.reactNativePaperStrings.contained
...
object PickthemeDeepPartialThemeAccessibilityLanguage {
  
  inline def apply(): PickthemeDeepPartialThemeAccessibilityLanguage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickthemeDeepPartialThemeAccessibilityLanguage]
  }
  
  extension [Self <: PickthemeDeepPartialThemeAccessibilityLanguage](x: Self) {
