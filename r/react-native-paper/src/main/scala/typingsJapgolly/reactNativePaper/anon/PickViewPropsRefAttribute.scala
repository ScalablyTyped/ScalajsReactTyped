...
import typingsJapgolly.reactNativePaper.reactNativePaperStrings.large
...
import typingsJapgolly.reactNativePaper.reactNativePaperStrings.small
import typingsJapgolly.reactNativePaper.reactNativePaperStrings.yes
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Pick<react-native.react-native.ViewProps & react.react.RefAttributes<react-native.react-native.View> & {  animating :boolean | undefined,   color :string | undefined,   size :number | 'small' | 'large' | undefined,   hidesWhenStopped :boolean | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme}, 'color' | 'size' | keyof react-native.react-native.ViewProps | keyof react.react.RefAttributes<react-native.react-native.View> | 'animating' | 'hidesWhenStopped'> & {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined} */
trait PickViewPropsRefAttribute extends StObject {
  ...
  var size: js.UndefOr[Double | small | large] = js.undefined
...
object PickViewPropsRefAttribute {
  
  inline def apply(): PickViewPropsRefAttribute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickViewPropsRefAttribute]
  }
  
  extension [Self <: PickViewPropsRefAttribute](x: Self) {
    ...
    inline def setSize(value: Double | small | large): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
