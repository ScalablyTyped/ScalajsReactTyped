...
import typingsJapgolly.reactNativePaper.reactNativePaperStrings.disk
import typingsJapgolly.reactNativePaper.reactNativePaperStrings.diskSlashmemory
import typingsJapgolly.reactNativePaper.reactNativePaperStrings.memory
