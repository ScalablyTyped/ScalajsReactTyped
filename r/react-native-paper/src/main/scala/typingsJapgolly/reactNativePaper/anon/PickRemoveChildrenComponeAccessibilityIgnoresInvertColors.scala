...
object PickRemoveChildrenComponeAccessibilityIgnoresInvertColors {
  
  inline def apply(): PickRemoveChildrenComponeAccessibilityIgnoresInvertColors = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickRemoveChildrenComponeAccessibilityIgnoresInvertColors]
  }
  
  extension [Self <: PickRemoveChildrenComponeAccessibilityIgnoresInvertColors](x: Self) {
