...
/* Inlined std.Partial<react-native.react-native.ViewProps & react.react.RefAttributes<react-native.react-native.View>> & {  dark :boolean | undefined,   children :react.react.ReactNode,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined} */
trait PartialViewPropsRefAttrib extends StObject {
