...
trait PickthemeDeepPartialThemeAccessibilityHint extends StObject {
...
object PickthemeDeepPartialThemeAccessibilityHint {
  
  inline def apply(): PickthemeDeepPartialThemeAccessibilityHint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickthemeDeepPartialThemeAccessibilityHint]
  }
  
  extension [Self <: PickthemeDeepPartialThemeAccessibilityHint](x: Self) {
