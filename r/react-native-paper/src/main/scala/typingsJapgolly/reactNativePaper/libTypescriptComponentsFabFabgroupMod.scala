...
import typingsJapgolly.reactNativePaper.anon.CallHasActionsIconOpenOnPressAccessibilityLabelThemeStyleFabStyleVisibleTestIDOnStateChangeColorPropBackdropColor
...
object libTypescriptComponentsFabFabgroupMod extends Shortcut {
  ...
  object Props {
    ...
    inline def apply(
      ...
      icon: IconSource,
      onStateChange: Open => Callback,
      open: Boolean,
      theme: Theme,
      visible: Boolean
    ): Props = {
      val __obj = js.Dynamic.literal(actions = actions.asInstanceOf[js.Any], icon = icon.asInstanceOf[js.Any], onStateChange = js.Any.fromFunction1((t0: Open) => onStateChange(t0).runNow()), open = open.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any], visible = visible.asInstanceOf[js.Any])
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setOnStateChange(value: Open => Callback): Self = StObject.set(x, "onStateChange", js.Any.fromFunction1((t0: Open) => value(t0).runNow()))
