...
import typingsJapgolly.reactNativePaper.anon.PickTouchableWithoutFeedbAccessibilityIgnoresInvertColors
...
object TouchableRippleDotnative {
  
  @JSImport("react-native-paper/lib/typescript/components/TouchableRipple/TouchableRipple.native", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: TouchableRippleDotnative.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PickTouchableWithoutFeedbAccessibilityIgnoresInvertColors): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
