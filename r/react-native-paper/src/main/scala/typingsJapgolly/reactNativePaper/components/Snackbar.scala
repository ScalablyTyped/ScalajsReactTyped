...
import typingsJapgolly.reactNativePaper.anon.LabelString
import typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeAccessibilityIgnoresInvertColors
import typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeAccessibilityLabel
...
object Snackbar {
  ...
  object PickthemeDeepPartialThemeAction {
    ...
    inline def apply(onDismiss: Callback, visible: Boolean): Builder = {
      ...
      new Builder(js.Array(this.component, __props.asInstanceOf[typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeAction]))
    }
    ...
    def withProps(p: typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeAction): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object PickthemeDeepPartialThemeChildren {
    ...
    inline def apply(onDismiss: Callback, visible: Boolean): Builder = {
      val __props = js.Dynamic.literal(onDismiss = onDismiss.toJsFn, visible = visible.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeChildren]))
    }
    ...
    def withProps(p: typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeChildren): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
