...
import typingsJapgolly.reactNativePaper.anon.PickRemoveChildrenComponeBackground
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object RadioButtonIOS {
  
  @JSImport("react-native-paper/lib/typescript/components/RadioButton/RadioButtonIOS", JSImport.Default)
  @js.native
  ...
  implicit def make(companion: RadioButtonIOS.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PickRemoveChildrenComponeBackground): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
