...
object ActivityIndicator {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def size(value: Double | small | large): this.type = set("size", value.asInstanceOf[js.Any])
  ...
  def withProps(p: PickViewPropsRefAttribute): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
