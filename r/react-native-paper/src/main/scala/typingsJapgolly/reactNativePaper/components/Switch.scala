...
object Switch {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNative.mod.Switch] {
    ...
    inline def ios_backgroundColor(value: ColorValue): this.type = set("ios_backgroundColor", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* event */ SwitchChangeEvent => js.Promise[Unit] | Unit): this.type = set("onChange", js.Any.fromFunction1(value))
    ...
    inline def onTintColor(value: ColorValue): this.type = set("onTintColor", value.asInstanceOf[js.Any])
    ...
    inline def onValueChange(value: /* value */ Boolean => js.Promise[Unit] | Unit): this.type = set("onValueChange", js.Any.fromFunction1(value))
    
    inline def onValueChangeNull: this.type = set("onValueChange", null)
  ...
  def withProps(p: PickSwitchPropsRefAttribu): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
