...
import typingsJapgolly.reactNativePaper.anon.PickRemoveChildrenComponeAccessible
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object RadioButtonAndroid {
  ...
  implicit def make(companion: RadioButtonAndroid.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PickRemoveChildrenComponeAccessible): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
