...
object DataTableRow {
  ...
  implicit def make(companion: DataTableRow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PickRemoveChildrenComponeAccessibilityRole): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
