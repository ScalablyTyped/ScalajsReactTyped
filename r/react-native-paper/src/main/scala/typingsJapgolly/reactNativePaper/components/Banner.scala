...
object Banner {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onHideAnimationFinished(value: Any): this.type = set("onHideAnimationFinished", value.asInstanceOf[js.Any])
    ...
    inline def onShowAnimationFinished(value: Any): this.type = set("onShowAnimationFinished", value.asInstanceOf[js.Any])
  ...
  def withProps(p: PickRemoveChildrenComponeAccessibilityActions): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
