...
@scala.inline
open class SharedBuilder_PickRemoveChildrenComponeAccessibilityState_1863688116 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def animateFrom(value: Any): this.type = set("animateFrom", value.asInstanceOf[js.Any])
  ...
  inline def extended(value: Any): this.type = set("extended", value.asInstanceOf[js.Any])
  ...
  inline def iconMode(value: Any): this.type = set("iconMode", value.asInstanceOf[js.Any])
  ...
  inline def uppercase(value: Any): this.type = set("uppercase", value.asInstanceOf[js.Any])
