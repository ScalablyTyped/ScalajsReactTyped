...
object TouchableRipple {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def background(value: js.Object): this.type = set("background", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: TouchableRipple.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PickTouchableWithoutFeedb): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
