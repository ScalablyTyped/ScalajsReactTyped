...
import typingsJapgolly.reactNativePaper.anon.PickRemoveChildrenComponeAccessibilityHint
...
object CheckboxIOS {
  ...
  implicit def make(companion: CheckboxIOS.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PickRemoveChildrenComponeAccessibilityHint): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
