...
object Chip {
  ...
  object PickthemeDeepPartialThemeAccessibilityViewIsModal {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def closeIcon(value: IconSource): this.type = set("closeIcon", value.asInstanceOf[js.Any])
      
      inline def closeIconAccessibilityLabel(value: String): this.type = set("closeIconAccessibilityLabel", value.asInstanceOf[js.Any])
      
      inline def closeIconFunction1(value: /* props */ IconPropscolorstring => Node): this.type = set("closeIcon", js.Any.fromFunction1(value))
      
      inline def closeIconVarargs(value: ImageURISource*): this.type = set("closeIcon", js.Array(value*))
      
      inline def collapsable(value: Boolean): this.type = set("collapsable", value.asInstanceOf[js.Any])
      
      inline def disabled(value: Boolean): this.type = set("disabled", value.asInstanceOf[js.Any])
      
      inline def ellipsizeMode(value: EllipsizeProp): this.type = set("ellipsizeMode", value.asInstanceOf[js.Any])
    ...
    implicit def make(companion: PickthemeDeepPartialThemeAccessibilityViewIsModal.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeAccessibilityViewIsModal): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object PickthemeDeepPartialThemeAccessible {
    ...
    implicit def make(companion: PickthemeDeepPartialThemeAccessible.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeAccessible): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
