...
object Button {
  ...
  object PickthemeDeepPartialThemeAccessibilityLabelledBy {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def mode(value: text | outlined | contained): this.type = set("mode", value.asInstanceOf[js.Any])
    ...
    implicit def make(companion: PickthemeDeepPartialThemeAccessibilityLabelledBy.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeAccessibilityLabelledBy): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object PickthemeDeepPartialThemeAccessibilityLanguage {
    ...
    implicit def make(companion: PickthemeDeepPartialThemeAccessibilityLanguage.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeAccessibilityLanguage): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
