...
object DrawerSection {
  ...
  implicit def make(companion: DrawerSection.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PickViewPropsRefAttributeAccessibilityState): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
