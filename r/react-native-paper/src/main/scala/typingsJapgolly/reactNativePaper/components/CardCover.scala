...
object CardCover {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNative.mod.Image] {
  ...
  def withProps(p: PickImagePropsRefAttributAccessibilityActions): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
