...
import typingsJapgolly.reactNativePaper.anon.PickPropslabelstylecoloroAccessibilityLabel
...
object RadioButtonItem {
  ...
  inline def apply(label: String, value: String): Builder = {
    val __props = js.Dynamic.literal(label = label.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[PickPropslabelstylecoloroAccessibilityLabel]))
  }
  ...
  def withProps(p: PickPropslabelstylecoloroAccessibilityLabel): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
