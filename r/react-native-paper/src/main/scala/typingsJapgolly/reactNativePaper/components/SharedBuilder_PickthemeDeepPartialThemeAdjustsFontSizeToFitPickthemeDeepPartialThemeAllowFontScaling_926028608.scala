...
@scala.inline
open class SharedBuilder_PickthemeDeepPartialThemeAdjustsFontSizeToFitPickthemeDeepPartialThemeAllowFontScaling_926028608[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
