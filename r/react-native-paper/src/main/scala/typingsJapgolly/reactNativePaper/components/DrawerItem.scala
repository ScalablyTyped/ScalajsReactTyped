...
object DrawerItem {
  ...
  inline def apply(label: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PickViewPropsRefAttributeAccessibilityRole]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def right(value: /* props */ ColorString => Node): this.type = set("right", js.Any.fromFunction1(value))
  ...
  def withProps(p: PickViewPropsRefAttributeAccessibilityRole): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
