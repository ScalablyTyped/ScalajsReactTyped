...
object FAB {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def loading(value: Any): this.type = set("loading", value.asInstanceOf[js.Any])
    ...
    inline def small(value: Any): this.type = set("small", value.asInstanceOf[js.Any])
  ...
  def withProps(p: PickRemoveChildrenComponeAccessibilityValue): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
