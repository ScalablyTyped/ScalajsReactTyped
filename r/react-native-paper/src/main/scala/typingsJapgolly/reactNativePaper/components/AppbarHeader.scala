...
object AppbarHeader {
  ...
  object PickthemeDeepPartialTheme {
    ...
    implicit def make(companion: PickthemeDeepPartialTheme.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialTheme): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object PickthemeDeepPartialThemeAccessibilityActions {
    ...
    implicit def make(companion: PickthemeDeepPartialThemeAccessibilityActions.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeAccessibilityActions): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
