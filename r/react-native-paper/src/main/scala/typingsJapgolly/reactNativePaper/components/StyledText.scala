...
object StyledText {
  ...
  object PickthemeDeepPartialThemeAlpha {
    ...
    inline def apply(alpha: Double, family: light | regular | medium | thin): Builder = {
      val __props = js.Dynamic.literal(alpha = alpha.asInstanceOf[js.Any], family = family.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeAlpha]))
    }
    ...
    def withProps(p: typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeAlpha): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object PickthemeDeepPartialThemeAndroidhyphenationFrequency {
    
    inline def apply(alpha: Double, family: light | regular | medium | thin): Builder = {
      val __props = js.Dynamic.literal(alpha = alpha.asInstanceOf[js.Any], family = family.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeAndroidhyphenationFrequency]))
    }
    ...
    def withProps(p: typingsJapgolly.reactNativePaper.anon.PickthemeDeepPartialThemeAndroidhyphenationFrequency): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
