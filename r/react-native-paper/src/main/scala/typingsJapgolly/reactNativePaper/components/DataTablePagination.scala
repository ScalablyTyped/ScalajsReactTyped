...
object DataTablePagination {
  ...
  inline def apply(numberOfPages: Double, onPageChange: /* page */ Double => Callback, page: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PickViewPropsRefAttributeAccessibilityLiveRegion]))
  }
  ...
  def withProps(p: PickViewPropsRefAttributeAccessibilityLiveRegion): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
