...
import typingsJapgolly.reactNativePaper.anon.ForceFocus
import typingsJapgolly.reactNativePaper.anon.Measured
import typingsJapgolly.reactNativePaper.anon.PaddingRight
import typingsJapgolly.reactNativePaper.anon.Width
import typingsJapgolly.reactNativePaper.libTypescriptComponentsTextInputTextInputMod.Props
...
import typingsJapgolly.reactNativePaper.reactNativePaperStrings.mode
...
object libTypescriptComponentsTextInputTypesMod {
  ...
  object LabelProps {
    ...
    inline def apply(
      ...
      fontSize: Double,
      labelScale: Double,
      onLayoutAnimatedText: Any => Callback,
    ...
    extension [Self <: LabelProps](x: Self) {
      ...
      inline def setOnLayoutAnimatedText(value: Any => Callback): Self = StObject.set(x, "onLayoutAnimatedText", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
  ...
  type TextInputLabelProp = String | Element
