...
import typingsJapgolly.reactNativePaper.anon.PickViewPropsRefAttributeAccessibilityLiveRegion
import typingsJapgolly.reactNativePaper.anon.SelectPageDropdownAccessibilityLabel
import typingsJapgolly.reactNativePaper.anon.TypeofView
import typingsJapgolly.reactNativePaper.anon.ViewPropsRefAttributesVieAccessibilityLanguage
...
object libTypescriptComponentsDataTableDataTablePaginationMod extends Shortcut {
  ...
  object PaginationControlsProps {
    ...
    inline def apply(numberOfPages: Double, onPageChange: Double => Callback, page: Double): PaginationControlsProps = {
      val __obj = js.Dynamic.literal(numberOfPages = numberOfPages.asInstanceOf[js.Any], onPageChange = js.Any.fromFunction1((t0: Double) => onPageChange(t0).runNow()), page = page.asInstanceOf[js.Any])
    ...
    extension [Self <: PaginationControlsProps](x: Self) {
      ...
      inline def setOnPageChange(value: Double => Callback): Self = StObject.set(x, "onPageChange", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
  ...
  object PaginationDropdownProps {
    ...
    extension [Self <: PaginationDropdownProps](x: Self) {
      ...
      inline def setOnItemsPerPageChange(value: /* numberOfItemsPerPage */ Double => Callback): Self = StObject.set(x, "onItemsPerPageChange", js.Any.fromFunction1((t0: /* numberOfItemsPerPage */ Double) => value(t0).runNow()))
