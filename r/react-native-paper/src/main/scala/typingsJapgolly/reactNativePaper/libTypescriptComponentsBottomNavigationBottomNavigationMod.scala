...
object libTypescriptComponentsBottomNavigationBottomNavigationMod extends Shortcut {
  ...
  trait Props extends StObject {
    ...
    var getAccessibilityLabel: js.UndefOr[
        js.Function1[/* props */ typingsJapgolly.reactNativePaper.anon.Route, js.UndefOr[String]]
      ] = js.undefined
    ...
    var getBadge: js.UndefOr[
        js.Function1[
          /* props */ typingsJapgolly.reactNativePaper.anon.Route, 
    ...
    /**
      ...
      */
    var renderIcon: js.UndefOr[js.Function1[/* props */ Focused, Node]] = js.undefined
    
    /**
      * Callback which React Element to be used as tab label.
      */
    var renderLabel: js.UndefOr[js.Function1[/* props */ Focused, Node]] = js.undefined
    ...
    /**
      ...
      * ```
      */
    def renderScene(props: JumpTo): Node | Null
    
    /**
      * Callback which returns a React element to be used as the touchable for the tab item.
      * Renders a `TouchableRipple` on Android and `TouchableWithoutFeedback` with `View` on iOS.
      */
    var renderTouchable: js.UndefOr[js.Function1[/* props */ TouchableProps, Node]] = js.undefined
  ...
  object Props {
    ...
    inline def apply(
      ...
      renderScene: JumpTo => Node | Null,
      theme: Theme
    ): Props = {
      val __obj = js.Dynamic.literal(navigationState = navigationState.asInstanceOf[js.Any], onIndexChange = js.Any.fromFunction1((t0: Double) => onIndexChange(t0).runNow()), renderScene = js.Any.fromFunction1(renderScene), theme = theme.asInstanceOf[js.Any])
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setGetAccessibilityLabel(value: /* props */ typingsJapgolly.reactNativePaper.anon.Route => js.UndefOr[String]): Self = StObject.set(x, "getAccessibilityLabel", js.Any.fromFunction1(value))
      
      inline def setGetAccessibilityLabelUndefined: Self = StObject.set(x, "getAccessibilityLabel", js.undefined)
      
      inline def setGetBadge(
        value: /* props */ typingsJapgolly.reactNativePaper.anon.Route => js.UndefOr[Boolean | Double | String]
      ): Self = StObject.set(x, "getBadge", js.Any.fromFunction1(value))
      
      inline def setGetBadgeUndefined: Self = StObject.set(x, "getBadge", js.undefined)
      
      inline def setGetColor(value: /* props */ typingsJapgolly.reactNativePaper.anon.Route => js.UndefOr[String]): Self = StObject.set(x, "getColor", js.Any.fromFunction1(value))
      
      inline def setGetColorUndefined: Self = StObject.set(x, "getColor", js.undefined)
      
      inline def setGetLabelText(value: /* props */ typingsJapgolly.reactNativePaper.anon.Route => js.UndefOr[String]): Self = StObject.set(x, "getLabelText", js.Any.fromFunction1(value))
      
      inline def setGetLabelTextUndefined: Self = StObject.set(x, "getLabelText", js.undefined)
      
      inline def setGetTestID(value: /* props */ typingsJapgolly.reactNativePaper.anon.Route => js.UndefOr[String]): Self = StObject.set(x, "getTestID", js.Any.fromFunction1(value))
      ...
      inline def setOnTabPress(value: /* props */ routeRouteTabPressEvent => Callback): Self = StObject.set(x, "onTabPress", js.Any.fromFunction1((t0: /* props */ routeRouteTabPressEvent) => value(t0).runNow()))
      
      inline def setOnTabPressUndefined: Self = StObject.set(x, "onTabPress", js.undefined)
      
      inline def setRenderIcon(value: /* props */ Focused => Node): Self = StObject.set(x, "renderIcon", js.Any.fromFunction1(value))
      
      inline def setRenderIconUndefined: Self = StObject.set(x, "renderIcon", js.undefined)
      
      inline def setRenderLabel(value: /* props */ Focused => Node): Self = StObject.set(x, "renderLabel", js.Any.fromFunction1(value))
      
      inline def setRenderLabelUndefined: Self = StObject.set(x, "renderLabel", js.undefined)
      
      inline def setRenderScene(value: JumpTo => Node | Null): Self = StObject.set(x, "renderScene", js.Any.fromFunction1(value))
      
      inline def setRenderTouchable(value: /* props */ TouchableProps => Node): Self = StObject.set(x, "renderTouchable", js.Any.fromFunction1(value))
  ...
  object TabPressEvent {
    ...
    inline def apply(defaultPrevented: Boolean, preventDefault: Callback): TabPressEvent = {
  ...
  trait TouchableProps
    ...
    @JSName("children")
    var children_TouchableProps: Node
  ...
  object TouchableProps {
    ...
    inline def apply(key: String, route: Route): TouchableProps = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], route = route.asInstanceOf[js.Any], children = null)
  ...
  /* This means you don't have to write `default`, but can instead just say `libTypescriptComponentsBottomNavigationBottomNavigationMod.foo` */
