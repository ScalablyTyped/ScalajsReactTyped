...
import typingsJapgolly.reactTether.reactTetherStrings.string
...
object anon {
  ...
  trait ElementComponent extends StObject {
    
    var elementComponent: (Unit & Element) | Null
    
    var targetComponent: (Unit & Element) | Null
  }
  object ElementComponent {
    
    inline def apply(): ElementComponent = {
      val __obj = js.Dynamic.literal(elementComponent = null, targetComponent = null)
      __obj.asInstanceOf[ElementComponent]
    }
    
    extension [Self <: ElementComponent](x: Self) {
      
      inline def setElementComponent(value: Unit & Element): Self = StObject.set(x, "elementComponent", value.asInstanceOf[js.Any])
      
      inline def setElementComponentNull: Self = StObject.set(x, "elementComponent", null)
      
      inline def setTargetComponent(value: Unit & Element): Self = StObject.set(x, "targetComponent", value.asInstanceOf[js.Any])
      
      inline def setTargetComponentNull: Self = StObject.set(x, "targetComponent", null)
    }
  }
  ...
  object Left {
    ...
    inline def apply(top: String): Left = {
      val __obj = js.Dynamic.literal(left = "string", top = top.asInstanceOf[js.Any])
