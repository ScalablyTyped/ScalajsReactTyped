...
object RadioGroup {
  ...
  object RadioGroup {
    ...
    implicit def make(companion: RadioGroup.type): typingsJapgolly.reactRadioGroup.components.RadioGroup.RadioGroup.Builder = new typingsJapgolly.reactRadioGroup.components.RadioGroup.RadioGroup.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: RadioGroupProps): typingsJapgolly.reactRadioGroup.components.RadioGroup.RadioGroup.Builder = new typingsJapgolly.reactRadioGroup.components.RadioGroup.RadioGroup.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  @JSImport("react-radio-group", "RadioGroup")
  @js.native
  val component: js.Object = js.native
