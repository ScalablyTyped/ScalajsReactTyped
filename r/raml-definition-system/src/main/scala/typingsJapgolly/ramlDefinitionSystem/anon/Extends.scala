...
object Extends {
  ...
  extension [Self <: Extends](x: Self) {
    ...
    inline def setExtends(value: NameString): Self = StObject.set(x, "extends", value.asInstanceOf[js.Any])
