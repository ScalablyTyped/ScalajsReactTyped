...
object ReactInputAutosize {
  def apply(
    ...
    inputRef: /* instance */ HTMLInputElement | Null => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[AutosizeInputProps, default, Unit, AutosizeInputProps] = {
  ...
  typingsJapgolly.reactInputAutosize.mod.AutosizeInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactInputAutosize.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactInputAutosize.mod.AutosizeInputProps])(children: _*)
  }
