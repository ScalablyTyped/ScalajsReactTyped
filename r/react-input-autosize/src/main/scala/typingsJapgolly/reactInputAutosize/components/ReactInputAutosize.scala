package typingsJapgolly.reactInputAutosize.components
...
import typingsJapgolly.reactInputAutosize.mod.AutosizeInputProps
import typingsJapgolly.reactInputAutosize.mod.default
...
object ReactInputAutosize {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def extraWidth(value: String | Double): this.type = set("extraWidth", value.asInstanceOf[js.Any])
    ...
    inline def injectStyles(value: Boolean): this.type = set("injectStyles", value.asInstanceOf[js.Any])
    ...
    inline def inputRef(value: /* instance */ HTMLInputElement | Null => Callback): this.type = set("inputRef", js.Any.fromFunction1((t0: /* instance */ HTMLInputElement | Null) => value(t0).runNow()))
    ...
    inline def onAutosize(value: /* inputWidth */ String | Double => Callback): this.type = set("onAutosize", js.Any.fromFunction1((t0: /* inputWidth */ String | Double) => value(t0).runNow()))
    ...
    inline def placeholderIsMinWidth(value: Boolean): this.type = set("placeholderIsMinWidth", value.asInstanceOf[js.Any])
