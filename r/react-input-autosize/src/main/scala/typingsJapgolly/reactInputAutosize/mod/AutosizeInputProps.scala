package typingsJapgolly.reactInputAutosize.mod
...
trait AutosizeInputProps
  ...
  var inputRef: js.UndefOr[js.Function1[/* instance */ org.scalajs.dom.raw.HTMLInputElement | Null, Unit]] = js.undefined
...
object AutosizeInputProps {
  ...
  def apply(
    ...
    inputRef: /* instance */ org.scalajs.dom.raw.HTMLInputElement | Null => Callback = null,
    ...
    onAutosize: /* inputWidth */ String | Double => Callback = null,
    ...
    ref: LegacyRef[org.scalajs.dom.raw.HTMLInputElement] = null,
    ...
    if (inputRef != null) __obj.updateDynamic("inputRef")(js.Any.fromFunction1((t0: /* instance */ org.scalajs.dom.raw.HTMLInputElement | scala.Null) => inputRef(t0).runNow()))
    ...
    if (onAutosize != null) __obj.updateDynamic("onAutosize")(js.Any.fromFunction1((t0: /* inputWidth */ java.lang.String | scala.Double) => onAutosize(t0).runNow()))
