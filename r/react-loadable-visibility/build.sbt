...
version := "3.0-dt-20191126Z-1a3f4a"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "loadable__component" % "5.10-dt-20190711Z-e55a7b",
  ...
  "org.scalablytyped.japgolly" %%% "react-loadable" % "5.5-dt-20200225Z-c79d3f",
