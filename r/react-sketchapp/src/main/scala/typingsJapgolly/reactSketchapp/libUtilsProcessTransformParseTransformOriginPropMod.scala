...
object libUtilsProcessTransformParseTransformOriginPropMod {
  
  @JSImport("react-sketchapp/lib/utils/processTransform/parseTransformOriginProp", JSImport.Namespace)
  @js.native
