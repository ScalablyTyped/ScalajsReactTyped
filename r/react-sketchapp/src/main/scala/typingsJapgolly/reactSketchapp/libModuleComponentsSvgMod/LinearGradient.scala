...
import typingsJapgolly.reactSketchapp.libModuleComponentsSvgLinearGradientMod.Props
...
open class LinearGradient protected ()
  extends typingsJapgolly.reactSketchapp.libModuleComponentsSvgLinearGradientMod.LinearGradient {
