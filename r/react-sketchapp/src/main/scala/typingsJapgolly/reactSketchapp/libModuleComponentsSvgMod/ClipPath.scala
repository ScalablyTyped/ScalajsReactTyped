...
import typingsJapgolly.reactSketchapp.libModuleComponentsSvgClipPathMod.Props
...
open class ClipPath protected ()
  extends typingsJapgolly.reactSketchapp.libModuleComponentsSvgClipPathMod.ClipPath {
