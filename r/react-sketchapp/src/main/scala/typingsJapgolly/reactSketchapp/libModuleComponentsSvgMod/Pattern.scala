...
import typingsJapgolly.reactSketchapp.libModuleComponentsSvgPatternMod.Props
...
open class Pattern protected ()
  extends typingsJapgolly.reactSketchapp.libModuleComponentsSvgPatternMod.Pattern {
