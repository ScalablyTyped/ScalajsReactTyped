...
import typingsJapgolly.reactSketchapp.libModuleComponentsSvgTextPathMod.Props
...
open class TextPath protected ()
  extends typingsJapgolly.reactSketchapp.libModuleComponentsSvgTextPathMod.TextPath {
