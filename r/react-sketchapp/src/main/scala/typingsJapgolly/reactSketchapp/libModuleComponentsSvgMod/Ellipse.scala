...
import typingsJapgolly.reactSketchapp.libModuleComponentsSvgEllipseMod.Props
...
open class Ellipse protected ()
  extends typingsJapgolly.reactSketchapp.libModuleComponentsSvgEllipseMod.Ellipse {
