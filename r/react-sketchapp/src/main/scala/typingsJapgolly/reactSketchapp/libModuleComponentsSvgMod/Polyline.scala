...
import typingsJapgolly.reactSketchapp.libModuleComponentsSvgPolylineMod.Props
...
open class Polyline protected ()
  extends typingsJapgolly.reactSketchapp.libModuleComponentsSvgPolylineMod.Polyline {
