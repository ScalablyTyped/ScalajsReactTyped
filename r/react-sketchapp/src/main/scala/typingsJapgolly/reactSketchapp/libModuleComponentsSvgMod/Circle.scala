...
import typingsJapgolly.reactSketchapp.anon.Cx
import typingsJapgolly.reactSketchapp.libModuleComponentsSvgCircleMod.Props
...
open class Circle protected ()
  extends typingsJapgolly.reactSketchapp.libModuleComponentsSvgCircleMod.Circle {
...
object Circle {
  ...
  @js.native
  def propTypes: typingsJapgolly.reactSketchapp.anon.ClipPath = js.native
  inline def propTypes_=(x: typingsJapgolly.reactSketchapp.anon.ClipPath): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("propTypes")(x.asInstanceOf[js.Any])
}
