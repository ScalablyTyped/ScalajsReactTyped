...
import typingsJapgolly.reactSketchapp.libModuleComponentsSvgImageMod.Props
import typingsJapgolly.reactSketchapp.libModuleComponentsSvgImageMod.SVGImage
