...
import typingsJapgolly.reactSketchapp.libComponentsSvgTextMod.Props
...
open class Text protected ()
  extends typingsJapgolly.reactSketchapp.libComponentsSvgTextMod.Text {
...
object Text {
  ...
  @JSImport("react-sketchapp/lib/components/Svg", "Text.childContextTypes")
  @js.native
  ...
  @JSImport("react-sketchapp/lib/components/Svg", "Text.propTypes")
  @js.native
