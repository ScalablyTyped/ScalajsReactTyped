...
object libModuleJsonUtilsModelsMod {
  
  @JSImport("react-sketchapp/lib/module/jsonUtils/models", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-sketchapp/lib/module/jsonUtils/models", "emptyGradient")
  @js.native
