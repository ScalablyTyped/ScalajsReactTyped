...
import typingsJapgolly.reactSketchapp.anon.FontScale
import typingsJapgolly.reactSketchapp.anon.Name
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libComponentsArtboardMod {
  
  @JSImport("react-sketchapp/lib/components/Artboard", "Artboard")
  @js.native
  ...
  object Artboard {
    ...
    @JSImport("react-sketchapp/lib/components/Artboard", "Artboard.defaultProps")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/components/Artboard", "Artboard.propTypes")
    @js.native
  ...
  object ArtboardPropTypes {
    ...
    @JSImport("react-sketchapp/lib/components/Artboard", "ArtboardPropTypes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-sketchapp/lib/components/Artboard", "ArtboardPropTypes.children")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/components/Artboard", "ArtboardPropTypes.isHome")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/components/Artboard", "ArtboardPropTypes.name")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/components/Artboard", "ArtboardPropTypes.style")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/components/Artboard", "ArtboardPropTypes.viewport")
    @js.native
