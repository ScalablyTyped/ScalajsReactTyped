...
object libModuleComponentsSvgRadialGradientMod {
  
  @JSImport("react-sketchapp/lib/module/components/Svg/RadialGradient", "RadialGradient")
  @js.native
  ...
  object RadialGradient {
    ...
    @JSImport("react-sketchapp/lib/module/components/Svg/RadialGradient", "RadialGradient.defaultProps")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/module/components/Svg/RadialGradient", "RadialGradient.propTypes")
    @js.native
