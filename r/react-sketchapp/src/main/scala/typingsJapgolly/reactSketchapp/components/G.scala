...
import typingsJapgolly.reactSketchapp.gMod.default
...
object G {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[GProps, default, Unit, GProps] = {
  ...
  typingsJapgolly.reactSketchapp.gMod.GProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSketchapp.gMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSketchapp.gMod.GProps])(children: _*)
  }
