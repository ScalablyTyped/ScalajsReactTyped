...
import typingsJapgolly.reactSketchapp.useMod.default
...
object Use {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[UseProps, default, Unit, UseProps] = {
  ...
  typingsJapgolly.reactSketchapp.useMod.UseProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSketchapp.useMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSketchapp.useMod.UseProps])(children: _*)
  }
