...
import typingsJapgolly.reactSketchapp.pathMod.default
...
object Path {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PathProps, default, Unit, PathProps] = {
  ...
  typingsJapgolly.reactSketchapp.pathMod.PathProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSketchapp.pathMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSketchapp.pathMod.PathProps])(children: _*)
  }
