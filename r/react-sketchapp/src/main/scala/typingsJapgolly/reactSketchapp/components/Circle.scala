...
import typingsJapgolly.reactSketchapp.circleMod.default
...
object Circle {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CircleProps, default, Unit, CircleProps] = {
  ...
  typingsJapgolly.reactSketchapp.circleMod.CircleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSketchapp.circleMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSketchapp.circleMod.CircleProps])(children: _*)
  }
