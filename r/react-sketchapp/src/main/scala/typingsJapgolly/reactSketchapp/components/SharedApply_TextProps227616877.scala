...
abstract class SharedApply_TextProps227616877[ComponentRef] () {
  ...
  typingsJapgolly.reactSketchapp.propsMod.TextProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSketchapp.propsMod.TextProps])(children: _*)
  }
}
