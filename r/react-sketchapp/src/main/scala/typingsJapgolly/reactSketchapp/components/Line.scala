...
import typingsJapgolly.reactSketchapp.lineMod.default
...
object Line {
  ...
  typingsJapgolly.reactSketchapp.lineMod.LineProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSketchapp.lineMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSketchapp.lineMod.LineProps])(children: _*)
  }
