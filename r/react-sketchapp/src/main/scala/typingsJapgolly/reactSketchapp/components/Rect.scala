...
import typingsJapgolly.reactSketchapp.rectMod.default
...
object Rect {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RectProps, default, Unit, RectProps] = {
  ...
  typingsJapgolly.reactSketchapp.rectMod.RectProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSketchapp.rectMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSketchapp.rectMod.RectProps])(children: _*)
  }
