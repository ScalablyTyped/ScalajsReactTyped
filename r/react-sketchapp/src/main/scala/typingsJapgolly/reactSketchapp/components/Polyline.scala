...
import typingsJapgolly.reactSketchapp.polylineMod.default
...
object Polyline {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PolylineProps, default, Unit, PolylineProps] = {
  ...
  typingsJapgolly.reactSketchapp.polylineMod.PolylineProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSketchapp.polylineMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSketchapp.polylineMod.PolylineProps])(children: _*)
  }
