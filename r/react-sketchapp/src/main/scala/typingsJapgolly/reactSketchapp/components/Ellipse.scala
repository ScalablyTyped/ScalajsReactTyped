...
import typingsJapgolly.reactSketchapp.ellipseMod.default
...
object Ellipse {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[EllipseProps, default, Unit, EllipseProps] = {
  ...
  typingsJapgolly.reactSketchapp.ellipseMod.EllipseProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSketchapp.ellipseMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSketchapp.ellipseMod.EllipseProps])(children: _*)
  }
