...
import typingsJapgolly.reactSketchapp.anon.BorderOptions
import typingsJapgolly.reactSketchapp.libModuleTypesMod.LayoutInfo
...
object libModuleJsonUtilsBordersMod {
  
  @JSImport("react-sketchapp/lib/module/jsonUtils/borders", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-sketchapp/lib/module/jsonUtils/borders", "DEFAULT_BORDER_STYLE")
  @js.native
