...
object libComponentsViewMod {
  ...
  @JSImport("react-sketchapp/lib/components/View", "View")
  @js.native
  ...
  object View {
    ...
    @JSImport("react-sketchapp/lib/components/View", "View.defaultProps")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/components/View", "View.propTypes")
    @js.native
  ...
  object ViewPropTypes {
    ...
    @JSImport("react-sketchapp/lib/components/View", "ViewPropTypes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-sketchapp/lib/components/View", "ViewPropTypes.children")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/components/View", "ViewPropTypes.flow")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/components/View", "ViewPropTypes.name")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/components/View", "ViewPropTypes.resizingConstraint")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/components/View", "ViewPropTypes.shadows")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/components/View", "ViewPropTypes.style")
    @js.native
