...
object libModuleComponentsSvgPolygonMod {
  
  @JSImport("react-sketchapp/lib/module/components/Svg/Polygon", "Polygon")
  @js.native
  ...
  object Polygon {
    ...
    @JSImport("react-sketchapp/lib/module/components/Svg/Polygon", "Polygon.defaultProps")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/module/components/Svg/Polygon", "Polygon.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("react-sketchapp/lib/module/components/Svg/Polygon", "Polygon.propTypes")
    @js.native
