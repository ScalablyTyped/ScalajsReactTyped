...
import typingsJapgolly.reactSketchapp.AnonStyle
import typingsJapgolly.reactSketchapp.reactSketchappNumbers.`1`
...
object StyleSheet extends js.Object {
  ...
  {[ P in keyof T ]: react-sketchapp.react-sketchapp.StyleReference}
    */ typingsJapgolly.reactSketchapp.reactSketchappStrings.StyleSheet with js.Any = js.native
