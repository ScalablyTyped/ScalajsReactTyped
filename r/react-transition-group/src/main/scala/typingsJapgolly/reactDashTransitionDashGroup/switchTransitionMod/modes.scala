...
object modes extends js.Object {
  ...
  /* "in-out" */ val in: typingsJapgolly.reactDashTransitionDashGroup.switchTransitionMod.modes.in with String = js.native
  /* "out-in" */ val out: typingsJapgolly.reactDashTransitionDashGroup.switchTransitionMod.modes.out with String = js.native
  @JSBracketAccess
