...
object anon {
  ...
  trait ReadonlyEditorProps extends StObject {
    ...
    val onTab: js.UndefOr[js.Function1[ReactKeyboardEventFrom[js.Object & Element], Unit]] = js.undefined
    ...
    val toolbarCustomButtons: js.UndefOr[js.Array[japgolly.scalajs.react.facade.React.Element]] = js.undefined
