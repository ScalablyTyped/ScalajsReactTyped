...
import typingsJapgolly.reactDraftWysiwyg.anon.ReadonlyEditorProps
...
object mod {
  ...
  trait EditorProps extends StObject {
    ...
    var handleReturn: js.UndefOr[
        js.Function2[ReactKeyboardEventFrom[js.Object & Element], /* editorState */ EditorState, Boolean]
      ] = js.undefined
    ...
    var toolbarCustomButtons: js.UndefOr[js.Array[japgolly.scalajs.react.facade.React.Element]] = js.undefined
  ...
  object EditorProps {
    ...
    extension [Self <: EditorProps](x: Self) {
      ...
      inline def setEditorRef(value: /* ref */ js.Object => Callback): Self = StObject.set(x, "editorRef", js.Any.fromFunction1((t0: /* ref */ js.Object) => value(t0).runNow()))
      ...
      inline def setHandleReturn(value: (ReactKeyboardEventFrom[js.Object & Element], /* editorState */ EditorState) => Boolean): Self = StObject.set(x, "handleReturn", js.Any.fromFunction2(value))
      ...
      inline def setOnBlur(value: /* event */ SyntheticEvent => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: /* event */ SyntheticEvent) => value(t0).runNow()))
      
      inline def setOnBlurUndefined: Self = StObject.set(x, "onBlur", js.undefined)
      
      inline def setOnChange(value: /* contentState */ RawDraftContentState => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* contentState */ RawDraftContentState) => value(t0).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnContentStateChange(value: /* contentState */ RawDraftContentState => Callback): Self = StObject.set(x, "onContentStateChange", js.Any.fromFunction1((t0: /* contentState */ RawDraftContentState) => value(t0).runNow()))
      
      inline def setOnContentStateChangeUndefined: Self = StObject.set(x, "onContentStateChange", js.undefined)
      
      inline def setOnEditorStateChange(value: /* editorState */ EditorState => Callback): Self = StObject.set(x, "onEditorStateChange", js.Any.fromFunction1((t0: /* editorState */ EditorState) => value(t0).runNow()))
      
      inline def setOnEditorStateChangeUndefined: Self = StObject.set(x, "onEditorStateChange", js.undefined)
      
      inline def setOnFocus(value: /* event */ SyntheticEvent => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: /* event */ SyntheticEvent) => value(t0).runNow()))
      ...
      inline def setToolbarCustomButtons(value: js.Array[japgolly.scalajs.react.facade.React.Element]): Self = StObject.set(x, "toolbarCustomButtons", value.asInstanceOf[js.Any])
      
      inline def setToolbarCustomButtonsUndefined: Self = StObject.set(x, "toolbarCustomButtons", js.undefined)
      
      inline def setToolbarCustomButtonsVarargs(value: japgolly.scalajs.react.facade.React.Element*): Self = StObject.set(x, "toolbarCustomButtons", js.Array(value*))
  ...
  type RawDraftContentState = typingsJapgolly.draftJs.mod.Draft.Model.Encoding.RawDraftContentState
