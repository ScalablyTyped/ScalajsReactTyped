package typingsJapgolly.rest.oAuthMod
...
object Config {
  ...
  def apply(
    ...
    oAuthCallback: /* hash */ String => Callback = null,
    oAuthCallbackName: String = null,
    redirectUrl: String = null,
    scope: String = null,
    token: String = null,
    windowStrategy: /* url */ String => CallbackTo[DismissWindow] = null
  ): Config = {
    val __obj = js.Dynamic.literal()
    if (authorizationUrl != null) __obj.updateDynamic("authorizationUrl")(authorizationUrl.asInstanceOf[js.Any])
    if (clientId != null) __obj.updateDynamic("clientId")(clientId.asInstanceOf[js.Any])
    if (oAuthCallback != null) __obj.updateDynamic("oAuthCallback")(js.Any.fromFunction1((t0: /* hash */ java.lang.String) => oAuthCallback(t0).runNow()))
    ...
    if (windowStrategy != null) __obj.updateDynamic("windowStrategy")(js.Any.fromFunction1((t0: /* url */ java.lang.String) => windowStrategy(t0).runNow()))
