...
object typesJsonprettyDotmonikaiMod {
  
  @JSImport("react-json-pretty/types/JSONPretty.monikai", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-json-pretty/types/JSONPretty.monikai", "boolean")
  @js.native
  ...
  @JSImport("react-json-pretty/types/JSONPretty.monikai", "value")
  @js.native
