...
object typesAcaiMod {
  ...
  @JSImport("react-json-pretty/types/acai", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-json-pretty/types/acai", "boolean")
  @js.native
  ...
  @JSImport("react-json-pretty/types/acai", "error")
  @js.native
  ...
  @JSImport("react-json-pretty/types/acai", "value")
  @js.native
