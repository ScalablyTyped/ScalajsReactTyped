package typingsJapgolly.reactJsonPretty.components
...
import typingsJapgolly.reactJsonPretty.mod.IProps
import typingsJapgolly.reactJsonPretty.mod.ITheme
import typingsJapgolly.reactJsonPretty.mod.^
...
object ReactJsonPretty {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def booleanStyle(value: String): this.type = set("booleanStyle", value.asInstanceOf[js.Any])
    ...
    inline def errorStyle(value: String): this.type = set("errorStyle", value.asInstanceOf[js.Any])
    ...
    inline def json(value: Any): this.type = set("json", value.asInstanceOf[js.Any])
    
    inline def keyStyle(value: String): this.type = set("keyStyle", value.asInstanceOf[js.Any])
    
    inline def lang(value: String): this.type = set("lang", value.asInstanceOf[js.Any])
    
    inline def mainStyle(value: String): this.type = set("mainStyle", value.asInstanceOf[js.Any])
    ...
    inline def onJSONPrettyError(value: /* e */ js.Error => Callback): this.type = set("onJSONPrettyError", js.Any.fromFunction1((t0: /* e */ js.Error) => value(t0).runNow()))
    ...
    inline def replacer(value: (/* key */ String, /* value */ Any) => Any | Null): this.type = set("replacer", js.Any.fromFunction2(value))
    ...
    inline def silent(value: Boolean): this.type = set("silent", value.asInstanceOf[js.Any])
    
    inline def slot(value: String): this.type = set("slot", value.asInstanceOf[js.Any])
    
    inline def space(value: Double | String): this.type = set("space", value.asInstanceOf[js.Any])
    
    inline def spellCheck(value: Booleanish): this.type = set("spellCheck", value.asInstanceOf[js.Any])
    
    inline def stringStyle(value: String): this.type = set("stringStyle", value.asInstanceOf[js.Any])
    ...
    inline def themeClassName(value: String): this.type = set("themeClassName", value.asInstanceOf[js.Any])
    ...
    inline def valueStyle(value: String): this.type = set("valueStyle", value.asInstanceOf[js.Any])
