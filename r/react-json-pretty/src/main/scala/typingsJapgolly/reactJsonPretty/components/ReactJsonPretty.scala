...
object ReactJsonPretty {
  def apply(
    ...
    onJSONPrettyError: /* e */ js.Error => Callback = null,
    ...
    replacer: (/* key */ String, /* value */ js.Any) => CallbackTo[js.Any | Null] = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IProps, ^, Unit, IProps] = {
    ...
    if (onJSONPrettyError != null) __obj.updateDynamic("onJSONPrettyError")(js.Any.fromFunction1((t0: /* e */ js.Error) => onJSONPrettyError(t0).runNow()))
  ...
  typingsJapgolly.reactJsonPretty.mod.IProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactJsonPretty.mod.^](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactJsonPretty.mod.IProps])(children: _*)
  }
