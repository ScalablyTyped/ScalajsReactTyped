...
object typesMonikaiMod {
  
  @JSImport("react-json-pretty/types/monikai", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-json-pretty/types/monikai", "boolean")
  @js.native
  ...
  @JSImport("react-json-pretty/types/monikai", "error")
  @js.native
  ...
  @JSImport("react-json-pretty/types/monikai", "value")
  @js.native
