package typingsJapgolly.reactJsonPretty

import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object typesJsonprettyDot1337Mod {
  
  @JSImport("react-json-pretty/types/JSONPretty.1337", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-json-pretty/types/JSONPretty.1337", "boolean")
  @js.native
  ...
  @JSImport("react-json-pretty/types/JSONPretty.1337", "value")
  @js.native
