package typingsJapgolly.reactTypingEffect
...
object mod {
  ...
  type ReactTypingEffect = japgolly.scalajs.react.facade.React.Component[ReactTypingEffectProps & js.Object, js.Object]
