...
object InternalFormInstance {
  ...
  inline def apply(
    ...
    setFieldValue: (/* name */ NamePath, /* value */ Any) => Callback,
  ...
  extension [Self <: InternalFormInstance](x: Self) {
    ...
    inline def setResetFields(value: /* fields */ js.UndefOr[js.Array[NamePath]] => Callback): Self = StObject.set(x, "resetFields", js.Any.fromFunction1((t0: /* fields */ js.UndefOr[js.Array[NamePath]]) => value(t0).runNow()))
    
    inline def setSetFieldValue(value: (/* name */ NamePath, /* value */ Any) => Callback): Self = StObject.set(x, "setFieldValue", js.Any.fromFunction2((t0: /* name */ NamePath, t1: /* value */ Any) => (value(t0, t1)).runNow()))
