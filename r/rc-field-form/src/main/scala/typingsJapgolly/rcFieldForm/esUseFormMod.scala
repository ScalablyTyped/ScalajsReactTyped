...
object esUseFormMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rcFieldForm.esUseFormMod.UpdateAction
    - typingsJapgolly.rcFieldForm.esUseFormMod.ValidateAction
  */
  trait ReducerAction extends StObject
  object ReducerAction {
    
    inline def UpdateAction(namePath: InternalNamePath, value: StoreValue): typingsJapgolly.rcFieldForm.esUseFormMod.UpdateAction = {
      ...
      __obj.asInstanceOf[typingsJapgolly.rcFieldForm.esUseFormMod.UpdateAction]
    }
    
    inline def ValidateAction(namePath: InternalNamePath, triggerName: String): typingsJapgolly.rcFieldForm.esUseFormMod.ValidateAction = {
      ...
      __obj.asInstanceOf[typingsJapgolly.rcFieldForm.esUseFormMod.ValidateAction]
    }
  }
