...
object StyledTextArea {
  def apply(
    ...
    StyledProps with TextareaHTMLAttributes[HTMLTextAreaElement], 
    MountedWithRawType[
      StyledProps with TextareaHTMLAttributes[HTMLTextAreaElement], 
      js.Object, 
      RawMounted[StyledProps with TextareaHTMLAttributes[HTMLTextAreaElement], js.Object]
    ]
  ] = {
  ...
  typingsJapgolly.reactForm.mod.StyledProps with typingsJapgolly.react.mod.TextareaHTMLAttributes[org.scalajs.dom.raw.HTMLTextAreaElement], 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactForm.mod.StyledProps with typingsJapgolly.react.mod.TextareaHTMLAttributes[org.scalajs.dom.raw.HTMLTextAreaElement]])(children: _*)
  }
