...
object StyledText {
  def apply(
    ...
    StyledProps with InputHTMLAttributes[HTMLInputElement], 
    MountedWithRawType[
      StyledProps with InputHTMLAttributes[HTMLInputElement], 
      js.Object, 
      RawMounted[StyledProps with InputHTMLAttributes[HTMLInputElement], js.Object]
    ]
  ] = {
  ...
  typingsJapgolly.reactForm.mod.StyledProps with typingsJapgolly.react.mod.InputHTMLAttributes[org.scalajs.dom.raw.HTMLInputElement], 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactForm.mod.StyledProps with typingsJapgolly.react.mod.InputHTMLAttributes[org.scalajs.dom.raw.HTMLInputElement]])(children: _*)
  }
