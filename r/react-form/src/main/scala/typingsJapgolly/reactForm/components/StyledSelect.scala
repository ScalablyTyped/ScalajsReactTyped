...
import typingsJapgolly.reactForm.mod.SelectOptions
import typingsJapgolly.reactForm.mod.SelectProps
import typingsJapgolly.reactForm.mod.StyledProps
...
object StyledSelect {
  def apply(
    ...
    StyledProps with SelectProps with InputHTMLAttributes[HTMLSelectElement], 
    MountedWithRawType[
      StyledProps with SelectProps with InputHTMLAttributes[HTMLSelectElement], 
      js.Object, 
      RawMounted[
  ...
  typingsJapgolly.reactForm.mod.StyledProps with typingsJapgolly.reactForm.mod.SelectProps with typingsJapgolly.react.mod.InputHTMLAttributes[org.scalajs.dom.raw.HTMLSelectElement], 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactForm.mod.StyledProps with typingsJapgolly.reactForm.mod.SelectProps with typingsJapgolly.react.mod.InputHTMLAttributes[org.scalajs.dom.raw.HTMLSelectElement]])(children: _*)
  }
