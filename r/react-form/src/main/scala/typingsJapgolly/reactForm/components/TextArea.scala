...
object TextArea {
  def apply(
    ...
    FieldProps with TextareaHTMLAttributes[HTMLTextAreaElement], 
    MountedWithRawType[
      FieldProps with TextareaHTMLAttributes[HTMLTextAreaElement], 
      js.Object, 
      RawMounted[FieldProps with TextareaHTMLAttributes[HTMLTextAreaElement], js.Object]
    ]
  ] = {
  ...
  typingsJapgolly.reactForm.mod.FieldProps with typingsJapgolly.react.mod.TextareaHTMLAttributes[org.scalajs.dom.raw.HTMLTextAreaElement], 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactForm.mod.FieldProps with typingsJapgolly.react.mod.TextareaHTMLAttributes[org.scalajs.dom.raw.HTMLTextAreaElement]])(children: _*)
  }
