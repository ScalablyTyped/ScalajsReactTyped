...
object Form {
  def apply(
    ...
    typingsJapgolly.reactForm.mod.Form, 
    Unit, 
    FormPropschildrenpropsFor
  ] = {
  ...
  typingsJapgolly.reactForm.FormPropschildrenpropsFor, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.reactForm.mod.Form](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactForm.FormPropschildrenpropsFor])
  }
