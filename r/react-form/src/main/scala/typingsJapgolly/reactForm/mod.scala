...
import typingsJapgolly.reactForm.anon.IsTouched
import typingsJapgolly.reactForm.anon.TypeofComponent
import typingsJapgolly.reactForm.reactFormBooleans.`false`
...
object mod {
  ...
  object UseFieldInstancePropsType {
    ...
    inline def apply[ValueType](
      onBlur: ReactEventFrom[Element & Element] => Callback,
      onChange: ReactEventFrom[Element & Element] => Callback,
      value: ValueType
    ): UseFieldInstancePropsType[ValueType] = {
      val __obj = js.Dynamic.literal(onBlur = js.Any.fromFunction1((t0: ReactEventFrom[Element & Element]) => onBlur(t0).runNow()), onChange = js.Any.fromFunction1((t0: ReactEventFrom[Element & Element]) => onChange(t0).runNow()), value = value.asInstanceOf[js.Any])
    ...
    extension [Self <: UseFieldInstancePropsType[?], ValueType](x: Self & UseFieldInstancePropsType[ValueType]) {
      ...
      inline def setOnBlur(value: ReactEventFrom[Element & Element] => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: ReactEventFrom[Element & Element]) => value(t0).runNow()))
  ...
  trait UseFormInstance[ValueType, ErrorType, EventType, FieldMetaType /* <: UseFieldInstanceMeta[ErrorType] */, FormMetaType /* <: UseFormInstanceMeta[ErrorType] */]
    ...
    def handleSubmit(event: ReactEventFrom[EventType & Element]): Unit = js.native
