...
import typingsJapgolly.reactForm.mod.FormApi
import typingsJapgolly.reactForm.mod.FormErrors
import typingsJapgolly.reactForm.mod.FormFunctionProps
import typingsJapgolly.reactForm.mod.FormState
import typingsJapgolly.reactForm.mod.FormValue
import typingsJapgolly.reactForm.mod.FormValues
import typingsJapgolly.reactForm.mod.RenderReturn
import typingsJapgolly.reactForm.mod.ValidateValuesFunction
...
object FormPropschildrenpropsFor {
  ...
  def apply(
    ...
    children: (js.Function1[/* props */ FormFunctionProps, RenderReturn]) | RenderReturn = null,
