  ...
  object SourcemapsPluginOptions {
    ...
    extension [Self <: SourcemapsPluginOptions](x: Self) {
      ...
      inline def setReadFile(
        value: (/* path */ String, /* callback */ js.Function2[/* error */ js.Error | Null, /* data */ Buffer | String, Unit]) => Callback
      ): Self = StObject.set(x, "readFile", js.Any.fromFunction2((t0: /* path */ String, t1: /* callback */ js.Function2[/* error */ js.Error | Null, /* data */ Buffer | String, Unit]) => (value(t0, t1)).runNow()))
