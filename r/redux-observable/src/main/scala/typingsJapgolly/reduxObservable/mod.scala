...
import typingsJapgolly.reduxObservable.distTypesCreateEpicMiddlewareMod.EpicMiddleware
import typingsJapgolly.reduxObservable.distTypesCreateEpicMiddlewareMod.Options
...
object mod {
  ...
  open class StateObservable[S] protected ()
    extends typingsJapgolly.reduxObservable.distTypesStateObservableMod.StateObservable[S] {
