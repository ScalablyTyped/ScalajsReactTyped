...
object mod {
  ...
  object FetchProps {
    ...
    extension [Self <: FetchProps[?], T](x: Self & FetchProps[T]) {
      ...
      inline def setAfterFetch(value: /* args */ FetchResponse[T] => Callback): Self = StObject.set(x, "afterFetch", js.Any.fromFunction1((t0: /* args */ FetchResponse[T]) => value(t0).runNow()))
      
      inline def setAfterFetchUndefined: Self = StObject.set(x, "afterFetch", js.undefined)
      
      inline def setChildren(value: /* renderProps */ RenderProps[T] => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
  ...
  */
  ...
  object ResponseType {
    ...
    inline def arrayBuffer: typingsJapgolly.reactRequest.reactRequestStrings.arrayBuffer = "arrayBuffer".asInstanceOf[typingsJapgolly.reactRequest.reactRequestStrings.arrayBuffer]
    
    inline def blob: typingsJapgolly.reactRequest.reactRequestStrings.blob = "blob".asInstanceOf[typingsJapgolly.reactRequest.reactRequestStrings.blob]
    
    inline def formData: typingsJapgolly.reactRequest.reactRequestStrings.formData = "formData".asInstanceOf[typingsJapgolly.reactRequest.reactRequestStrings.formData]
    
    inline def json: typingsJapgolly.reactRequest.reactRequestStrings.json = "json".asInstanceOf[typingsJapgolly.reactRequest.reactRequestStrings.json]
    
    inline def text: typingsJapgolly.reactRequest.reactRequestStrings.text = "text".asInstanceOf[typingsJapgolly.reactRequest.reactRequestStrings.text]
  }
}
