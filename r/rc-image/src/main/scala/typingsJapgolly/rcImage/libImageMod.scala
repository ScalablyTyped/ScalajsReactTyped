...
object libImageMod extends Shortcut {
  ...
  trait ImagePreviewType extends StObject {
    ...
    var mask: js.UndefOr[Node] = js.undefined
  ...
  object ImagePreviewType {
    ...
    inline def apply(): ImagePreviewType = {
    ...
    extension [Self <: ImagePreviewType](x: Self) {
      ...
      inline def setMask(value: VdomNode): Self = StObject.set(x, "mask", value.rawNode.asInstanceOf[js.Any])
      ...
      inline def setMaskVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "mask", js.Array(value*))
      
      inline def setMaskVdomElement(value: VdomElement): Self = StObject.set(x, "mask", value.rawElement.asInstanceOf[js.Any])
  ...
  trait ImageProps extends StObject {
    ...
    var onError: js.UndefOr[js.Function1[/* e */ ReactEventFrom[HTMLImageElement], Unit]] = js.undefined
    ...
    /**
      ...
      */
    var onPreviewClose: js.UndefOr[js.Function2[/* value */ Boolean, /* prevValue */ Boolean, Unit]] = js.undefined
    ...
    var preview: js.UndefOr[Boolean | ImagePreviewType] = js.undefined
  ...
  object ImageProps {
    ...
    extension [Self <: ImageProps](x: Self) {
      ...
      inline def setOnError(value: /* e */ ReactEventFrom[HTMLImageElement] => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* e */ ReactEventFrom[HTMLImageElement]) => value(t0).runNow()))
      ...
      inline def setOnPreviewClose(value: (/* value */ Boolean, /* prevValue */ Boolean) => Callback): Self = StObject.set(x, "onPreviewClose", js.Any.fromFunction2((t0: /* value */ Boolean, t1: /* prevValue */ Boolean) => (value(t0, t1)).runNow()))
      
      inline def setOnPreviewCloseUndefined: Self = StObject.set(x, "onPreviewClose", js.undefined)
      ...
      inline def setPreview(value: Boolean | ImagePreviewType): Self = StObject.set(x, "preview", value.asInstanceOf[js.Any])
