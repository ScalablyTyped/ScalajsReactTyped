...
import typingsJapgolly.abstractThings.mod.Thing
import typingsJapgolly.node.bufferMod.global.Buffer
import typingsJapgolly.rifatMiio.rifatMiioBooleans.`true`
import typingsJapgolly.rifatMiio.rifatMiioStrings.`typeColonair-purifier`
...
object deviceMod {
  ...
  object MiioDeviceOptions {
    ...
    extension [Self <: MiioDeviceOptions](x: Self) {
