...
trait RequiredIContentLoaderProps extends js.Object {
  ...
  var vectorEffect: js.UndefOr[
    none | `non-scaling-stroke` | nonScalingStroke | typingsJapgolly.reactContentLoader.reactContentLoaderStrings.default | inherit | uri
  ] = js.undefined
...
object RequiredIContentLoaderProps {
  ...
  def apply(
    ...
    vectorEffect: none | `non-scaling-stroke` | nonScalingStroke | typingsJapgolly.reactContentLoader.reactContentLoaderStrings.default | inherit | uri = null,
    viewBox: String = null,
