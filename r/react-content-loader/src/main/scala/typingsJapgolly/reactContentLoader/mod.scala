package typingsJapgolly.reactContentLoader
...
import typingsJapgolly.reactContentLoader.reactContentLoaderStrings.`left-right`
import typingsJapgolly.reactContentLoader.reactContentLoaderStrings.`top-bottom`
...
object mod extends Shortcut {
  ...
  object IContentLoaderProps {
    ...
    extension [Self <: IContentLoaderProps](x: Self) {
      ...
      inline def setBeforeMask(value: VdomElement): Self = StObject.set(x, "beforeMask", value.rawElement.asInstanceOf[js.Any])
