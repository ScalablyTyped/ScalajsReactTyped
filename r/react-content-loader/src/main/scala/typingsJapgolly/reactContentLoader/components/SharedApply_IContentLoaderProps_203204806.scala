...
abstract class SharedApply_IContentLoaderProps_203204806 () {
  ...
  typingsJapgolly.reactContentLoader.interfaceMod.IContentLoaderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactContentLoader.interfaceMod.IContentLoaderProps])(children: _*)
  }
}
