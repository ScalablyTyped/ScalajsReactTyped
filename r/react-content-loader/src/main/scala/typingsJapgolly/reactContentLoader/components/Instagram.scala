...
object Instagram {
  ...
  implicit def make(companion: Instagram.type): SharedBuilder_IContentLoaderProps732959227 = new SharedBuilder_IContentLoaderProps732959227(js.Array(this.component, js.Dictionary.empty))()
