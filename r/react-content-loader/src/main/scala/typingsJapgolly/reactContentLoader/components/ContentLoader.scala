...
object ContentLoader {
  ...
  implicit def make(companion: ContentLoader.type): SharedBuilder_IContentLoaderProps732959227 = new SharedBuilder_IContentLoaderProps732959227(js.Array(this.component, js.Dictionary.empty))()
