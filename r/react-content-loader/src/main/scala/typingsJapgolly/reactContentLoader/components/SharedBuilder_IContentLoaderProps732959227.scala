...
@scala.inline
open class SharedBuilder_IContentLoaderProps732959227 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def animateBegin(value: String): this.type = set("animateBegin", value.asInstanceOf[js.Any])
  ...
  inline def backgroundOpacity(value: Double): this.type = set("backgroundOpacity", value.asInstanceOf[js.Any])
  ...
  inline def beforeMask(value: VdomElement): this.type = set("beforeMask", value.rawElement.asInstanceOf[js.Any])
  ...
  inline def foregroundColor(value: String): this.type = set("foregroundColor", value.asInstanceOf[js.Any])
  
  inline def foregroundOpacity(value: Double): this.type = set("foregroundOpacity", value.asInstanceOf[js.Any])
  ...
  inline def gradientDirection(value: `left-right` | `top-bottom`): this.type = set("gradientDirection", value.asInstanceOf[js.Any])
  
  inline def gradientRatio(value: Double): this.type = set("gradientRatio", value.asInstanceOf[js.Any])
  ...
  inline def uniqueKey(value: String): this.type = set("uniqueKey", value.asInstanceOf[js.Any])
