...
object InstagramStyle {
  ...
  implicit def make(companion: InstagramStyle.type): SharedBuilder_IContentLoaderProps732959227 = new SharedBuilder_IContentLoaderProps732959227(js.Array(this.component, js.Dictionary.empty))()
