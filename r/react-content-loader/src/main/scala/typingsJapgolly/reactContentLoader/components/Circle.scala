...
object Circle {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CircleProps, typingsJapgolly.reactContentLoader.nativeMod.Circle, Unit, CircleProps] = {
  ...
  typingsJapgolly.reactContentLoader.nativeMod.Circle](this.componentImport)
