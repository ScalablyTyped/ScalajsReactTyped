...
object Rect {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RectProps, typingsJapgolly.reactContentLoader.nativeMod.Rect, Unit, RectProps] = {
  ...
  typingsJapgolly.reactNativeSvg.mod.RectProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactContentLoader.nativeMod.Rect](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvg.mod.RectProps])(children: _*)
  }
