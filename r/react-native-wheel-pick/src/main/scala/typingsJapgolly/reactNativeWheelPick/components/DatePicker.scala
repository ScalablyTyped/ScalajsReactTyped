package typingsJapgolly.reactNativeWheelPick.components
...
import typingsJapgolly.reactNativeWheelPick.mod.DatePickerProps
...
object DatePicker {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWheelPick.mod.DatePicker] {
    ...
    inline def itemSpace(value: Double): this.type = set("itemSpace", value.asInstanceOf[js.Any])
    
    inline def labelUnit(value: Date): this.type = set("labelUnit", value.asInstanceOf[js.Any])
    ...
    inline def order(value: String): this.type = set("order", value.asInstanceOf[js.Any])
