...
import typingsJapgolly.reactNativeWheelPick.mod.PickerProps
...
object Picker {
  ...
  inline def apply[T](onValueChange: T => Callback, pickerData: js.Array[T]): Builder[T] = {
    val __props = js.Dynamic.literal(onValueChange = js.Any.fromFunction1((t0: T) => onValueChange(t0).runNow()), pickerData = pickerData.asInstanceOf[js.Any])
  ...
  open class Builder[T] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWheelPick.mod.Picker[T]] {
    ...
    inline def selectedValue(value: T): this.type = set("selectedValue", value.asInstanceOf[js.Any])
