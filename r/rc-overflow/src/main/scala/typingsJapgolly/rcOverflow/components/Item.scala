package typingsJapgolly.rcOverflow.components
...
import typingsJapgolly.rcOverflow.esItemMod.ItemProps
...
object Item {
  ...
  inline def apply(
    ...
    order: Double,
    prefixCls: String,
    registerSize: (Key, js.UndefOr[Double]) => Callback
  ): Builder = {
    val __props = js.Dynamic.literal(display = display.asInstanceOf[js.Any], order = order.asInstanceOf[js.Any], prefixCls = prefixCls.asInstanceOf[js.Any], registerSize = js.Any.fromFunction2((t0: Key, t1: js.UndefOr[Double]) => (registerSize(t0, t1)).runNow()))
    new Builder(js.Array(this.component, __props.asInstanceOf[ItemProps[Any] & RefAttributes[Any]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def component(value: ComponentType): this.type = set("component", value.asInstanceOf[js.Any])
    ...
    inline def invalidate(value: Boolean): this.type = set("invalidate", value.asInstanceOf[js.Any])
    ...
    inline def itemKey(value: Key): this.type = set("itemKey", value.asInstanceOf[js.Any])
    ...
    inline def renderItem(value: Any => Node): this.type = set("renderItem", js.Any.fromFunction1(value))
    
    inline def resource(value: String): this.type = set("resource", value.asInstanceOf[js.Any])
    
    inline def responsive(value: Boolean): this.type = set("responsive", value.asInstanceOf[js.Any])
    
    inline def responsiveDisabled(value: Boolean): this.type = set("responsiveDisabled", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ItemProps[Any] & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
