...
import typingsJapgolly.reduxRouter.mod.ReduxRouter.StaticRouter
...
object ReduxRouterStaticRouter {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[StaticRouterProps, StaticRouter, Unit, StaticRouterProps] = {
  ...
  typingsJapgolly.reduxRouter.mod.ReduxRouter.StaticRouter](this.componentImport)
