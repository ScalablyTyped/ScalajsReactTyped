...
import typingsJapgolly.reduxRouter.mod.ReduxRouter.Route
...
object ReduxRouterRoute {
  def apply[T /* <: RouteProps */](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[T with js.Object, Route[T], Unit, T with js.Object] = {
  ...
  typingsJapgolly.reduxRouter.mod.ReduxRouter.Route[T]](this.componentImport)
