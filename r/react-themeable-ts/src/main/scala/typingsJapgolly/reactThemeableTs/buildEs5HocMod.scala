...
import typingsJapgolly.reactThemeableTs.buildEs5ThemeableMod.IStaticFnReturn
...
object buildEs5HocMod {
  ...
  type TDecComponent[P] = (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify React.SFC<P> */ Any) | (ComponentClassP[P & js.Object])
}
