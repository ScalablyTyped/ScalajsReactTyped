...
object umdOptionsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.initializeDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.initializedDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.resizeDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.resizedDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.refreshDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.refreshedDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.dragDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.draggedDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.translateDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.translatedDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.changeDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.changedDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.loadDotowlDotlazy
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.loadedDotowlDotlazy
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.stopDotowlDotvideo
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.playDotowlDotvideo
  */
  trait OnEvent extends StObject
  object OnEvent {
    
    inline def changeDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.changeDotowlDotcarousel = "change.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.changeDotowlDotcarousel]
    
    inline def changedDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.changedDotowlDotcarousel = "changed.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.changedDotowlDotcarousel]
    
    inline def dragDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.dragDotowlDotcarousel = "drag.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.dragDotowlDotcarousel]
    
    inline def draggedDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.draggedDotowlDotcarousel = "dragged.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.draggedDotowlDotcarousel]
    
    inline def initializeDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.initializeDotowlDotcarousel = "initialize.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.initializeDotowlDotcarousel]
    
    inline def initializedDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.initializedDotowlDotcarousel = "initialized.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.initializedDotowlDotcarousel]
    
    inline def loadDotowlDotlazy: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.loadDotowlDotlazy = "load.owl.lazy".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.loadDotowlDotlazy]
    
    inline def loadedDotowlDotlazy: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.loadedDotowlDotlazy = "loaded.owl.lazy".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.loadedDotowlDotlazy]
    
    inline def playDotowlDotvideo: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.playDotowlDotvideo = "play.owl.video".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.playDotowlDotvideo]
    
    inline def refreshDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.refreshDotowlDotcarousel = "refresh.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.refreshDotowlDotcarousel]
    
    inline def refreshedDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.refreshedDotowlDotcarousel = "refreshed.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.refreshedDotowlDotcarousel]
    
    inline def resizeDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.resizeDotowlDotcarousel = "resize.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.resizeDotowlDotcarousel]
    
    inline def resizedDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.resizedDotowlDotcarousel = "resized.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.resizedDotowlDotcarousel]
    
    inline def stopDotowlDotvideo: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.stopDotowlDotvideo = "stop.owl.video".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.stopDotowlDotvideo]
    
    inline def translateDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.translateDotowlDotcarousel = "translate.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.translateDotowlDotcarousel]
    
    inline def translatedDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.translatedDotowlDotcarousel = "translated.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.translatedDotowlDotcarousel]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.refreshDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.nextDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.prevDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.toDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.destroyDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.replaceDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.addDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.removeDotowlDotcarousel
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.playDotowlDotautoplay
    - typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.stopDotowlDotautoplay
  */
  trait TriggerEvent extends StObject
  object TriggerEvent {
    
    inline def addDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.addDotowlDotcarousel = "add.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.addDotowlDotcarousel]
    
    inline def destroyDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.destroyDotowlDotcarousel = "destroy.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.destroyDotowlDotcarousel]
    
    inline def nextDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.nextDotowlDotcarousel = "next.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.nextDotowlDotcarousel]
    
    inline def playDotowlDotautoplay: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.playDotowlDotautoplay = "play.owl.autoplay".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.playDotowlDotautoplay]
    
    inline def prevDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.prevDotowlDotcarousel = "prev.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.prevDotowlDotcarousel]
    
    inline def refreshDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.refreshDotowlDotcarousel = "refresh.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.refreshDotowlDotcarousel]
    
    inline def removeDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.removeDotowlDotcarousel = "remove.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.removeDotowlDotcarousel]
    
    inline def replaceDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.replaceDotowlDotcarousel = "replace.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.replaceDotowlDotcarousel]
    
    inline def stopDotowlDotautoplay: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.stopDotowlDotautoplay = "stop.owl.autoplay".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.stopDotowlDotautoplay]
    
    inline def toDotowlDotcarousel: typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.toDotowlDotcarousel = "to.owl.carousel".asInstanceOf[typingsJapgolly.reactOwlCarousel.reactOwlCarouselStrings.toDotowlDotcarousel]
  }
}
