...
object ReactOwlCarousel {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[OwlCarouselProps, default, Unit, OwlCarouselProps] = {
  ...
  typingsJapgolly.reactOwlCarousel.mod.OwlCarouselProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactOwlCarousel.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactOwlCarousel.mod.OwlCarouselProps])(children: _*)
  }
