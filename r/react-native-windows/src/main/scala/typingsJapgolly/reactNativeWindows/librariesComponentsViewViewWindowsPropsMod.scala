...
object librariesComponentsViewViewWindowsPropsMod {
  ...
  object IViewWindowsProps {
    ...
    extension [Self <: IViewWindowsProps](x: Self) {
      ...
      inline def setOnMouseEnter(value: /* args */ IMouseEvent => Callback): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction1((t0: /* args */ IMouseEvent) => value(t0).runNow()))
      
      inline def setOnMouseEnterUndefined: Self = StObject.set(x, "onMouseEnter", js.undefined)
      
      inline def setOnMouseLeave(value: /* args */ IMouseEvent => Callback): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction1((t0: /* args */ IMouseEvent) => value(t0).runNow()))
