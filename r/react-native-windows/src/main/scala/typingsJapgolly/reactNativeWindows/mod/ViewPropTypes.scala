...
object ViewPropTypes {
  ...
  def onMoveShouldSetResponder: js.UndefOr[
    Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Boolean]]]
  ] = js.native
  ...
  @js.native
  def onResponderEnd: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onResponderEnd_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onResponderEnd")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows", "ViewPropTypes.onResponderGrant")
  @js.native
  def onResponderGrant: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onResponderGrant_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onResponderGrant")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows", "ViewPropTypes.onResponderMove")
  @js.native
  def onResponderMove: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onResponderMove_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onResponderMove")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows", "ViewPropTypes.onResponderReject")
  @js.native
  def onResponderReject: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onResponderReject_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onResponderReject")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows", "ViewPropTypes.onResponderRelease")
  @js.native
  def onResponderRelease: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onResponderRelease_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onResponderRelease")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows", "ViewPropTypes.onResponderStart")
  @js.native
  def onResponderStart: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onResponderStart_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onResponderStart")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows", "ViewPropTypes.onResponderTerminate")
  @js.native
  def onResponderTerminate: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onResponderTerminate_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onResponderTerminate")(x.asInstanceOf[js.Any])
  ...
  inline def onResponderTerminationRequest_=(
    x: js.UndefOr[
      Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Boolean]]]
    ]
  ...
  @js.native
  def onTouchCancel: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onTouchCancel_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onTouchCancel")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows", "ViewPropTypes.onTouchEnd")
  @js.native
  def onTouchEnd: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  
  @JSImport("react-native-windows", "ViewPropTypes.onTouchEndCapture")
  @js.native
  def onTouchEndCapture: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onTouchEndCapture_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onTouchEndCapture")(x.asInstanceOf[js.Any])
  
  inline def onTouchEnd_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onTouchEnd")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows", "ViewPropTypes.onTouchMove")
  @js.native
  def onTouchMove: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onTouchMove_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onTouchMove")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows", "ViewPropTypes.onTouchStart")
  @js.native
  def onTouchStart: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onTouchStart_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onTouchStart")(x.asInstanceOf[js.Any])
