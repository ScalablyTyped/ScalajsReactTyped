...
import typingsJapgolly.reactNativeWindows.rntypesMod.RippleBackgroundPropType
import typingsJapgolly.reactNativeWindows.rntypesMod.ThemeAttributeBackgroundPropType
...
open class TouchableNativeFeedback ()
  extends typingsJapgolly.reactNativeWindows.rntypesMod.TouchableNativeFeedback
/* static members */
