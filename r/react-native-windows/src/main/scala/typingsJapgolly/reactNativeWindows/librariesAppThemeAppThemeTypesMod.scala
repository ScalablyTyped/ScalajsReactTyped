...
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.highContrastChanged
  ...
  object AppTheme {
    ...
    extension [Self <: AppTheme](x: Self) {
      ...
      inline def setRemoveListener(
        value: (highContrastChanged, js.Function1[/* nativeEvent */ IHighContrastChangedEvent, Unit]) => Callback
      ): Self = StObject.set(x, "removeListener", js.Any.fromFunction2((t0: highContrastChanged, t1: js.Function1[/* nativeEvent */ IHighContrastChangedEvent, Unit]) => (value(t0, t1)).runNow()))
    }
  }
