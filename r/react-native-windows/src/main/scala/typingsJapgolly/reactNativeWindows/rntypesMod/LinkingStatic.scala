...
import typingsJapgolly.reactNativeWindows.anon.Key
import typingsJapgolly.reactNativeWindows.anon.Url
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.url_
...
trait LinkingStatic
  ...
  def removeEventListener_url(`type`: url_, handler: js.Function1[/* event */ Url, Unit]): Unit = js.native
