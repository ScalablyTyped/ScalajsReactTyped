...
/* Inlined parent std.Pick<react-native-windows.react-native-windows/rntypes.TouchableNativeFeedbackProps & react-native-windows.react-native-windows/rntypes.TouchableOpacityProps, 'accessibilityLabel' | 'accessibilityState' | 'hasTVPreferredFocus' | 'nextFocusDown' | 'nextFocusForward' | 'nextFocusLeft' | 'nextFocusRight' | 'nextFocusUp' | 'testID' | 'disabled' | 'onPress' | 'touchSoundDisabled'> */
