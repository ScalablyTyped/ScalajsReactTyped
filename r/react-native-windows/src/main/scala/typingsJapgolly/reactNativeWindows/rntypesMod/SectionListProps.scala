...
import typingsJapgolly.reactNativeWindows.anon.Length
import typingsJapgolly.reactNativeWindows.anon.Section
...
trait SectionListProps[ItemT, SectionT]
  ...
  /**
    ...
    */
  var SectionSeparatorComponent: js.UndefOr[ComponentType[Any] | Element | Null] = js.undefined
  ...
  /**
    ...
    */
  var renderSectionFooter: js.UndefOr[js.Function1[/* info */ Section[ItemT, SectionT], Element | Null]] = js.undefined
  
  /**
    * Rendered at the top of each section. Sticky headers are not yet supported.
    */
  var renderSectionHeader: js.UndefOr[js.Function1[/* info */ Section[ItemT, SectionT], Element | Null]] = js.undefined
...
object SectionListProps {
  ...
  extension [Self <: SectionListProps[?, ?], ItemT, SectionT](x: Self & (SectionListProps[ItemT, SectionT])) {
    ...
    inline def setRenderSectionFooter(value: /* info */ Section[ItemT, SectionT] => Element | Null): Self = StObject.set(x, "renderSectionFooter", js.Any.fromFunction1(value))
    
    inline def setRenderSectionFooterUndefined: Self = StObject.set(x, "renderSectionFooter", js.undefined)
    
    inline def setRenderSectionHeader(value: /* info */ Section[ItemT, SectionT] => Element | Null): Self = StObject.set(x, "renderSectionHeader", js.Any.fromFunction1(value))
