...
trait DatePickerAndroidStatic extends StObject {
  ...
  /**
    ...
    */
  var dateSetAction: typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.dateSetAction = js.native
  
  /**
    * The dialog has been dismissed.
    */
  var dismissedAction: typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.dismissedAction = js.native
