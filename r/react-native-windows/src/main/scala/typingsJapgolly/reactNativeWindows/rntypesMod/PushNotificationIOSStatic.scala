...
import typingsJapgolly.reactNativeWindows.anon.Code
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.localNotification
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.notification
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.register
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.registrationError
...
trait PushNotificationIOSStatic extends StObject {
  ...
  /**
    ...
    */
  var FetchResult: typingsJapgolly.reactNativeWindows.rntypesMod.FetchResult = js.native
