...
trait TimePickerAndroidStatic extends StObject {
  ...
  /**
    ...
    */
  var dismissedAction: typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.dismissedAction
  ...
  /**
    ...
    */
  var timeSetAction: typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.timeSetAction
}
