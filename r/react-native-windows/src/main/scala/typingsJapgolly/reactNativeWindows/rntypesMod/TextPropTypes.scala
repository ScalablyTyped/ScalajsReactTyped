...
object TextPropTypes {
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-native-windows/rntypes", "TextPropTypes.accessibilityActions")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.accessibilityElementsHidden")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.accessibilityHint")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.accessibilityIgnoresInvertColors")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.accessibilityLabel")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.accessibilityLiveRegion")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.accessibilityRole")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.accessibilityState")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.accessibilityValue")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.accessibilityViewIsModal")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.accessible")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.adjustsFontSizeToFit")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.allowFontScaling")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.android_hyphenationFrequency")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.children")
  @js.native
  def children: js.UndefOr[Validator[js.UndefOr[Node]]] = js.native
  inline def children_=(x: js.UndefOr[Validator[js.UndefOr[Node]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("children")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows/rntypes", "TextPropTypes.dataDetectorType")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.ellipsizeMode")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.importantForAccessibility")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.lineBreakMode")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.maxFontSizeMultiplier")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.minimumFontScale")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.nativeID")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.numberOfLines")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.onAccessibilityAction")
  @js.native
  def onAccessibilityAction: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onAccessibilityAction_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onAccessibilityAction")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows/rntypes", "TextPropTypes.onAccessibilityEscape")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.onAccessibilityTap")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.onLayout")
  @js.native
  def onLayout: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onLayout_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onLayout")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows/rntypes", "TextPropTypes.onLongPress")
  @js.native
  def onLongPress: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onLongPress_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onLongPress")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows/rntypes", "TextPropTypes.onMagicTap")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.onPress")
  @js.native
  def onPress: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  
  @JSImport("react-native-windows/rntypes", "TextPropTypes.onPressIn")
  @js.native
  def onPressIn: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onPressIn_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onPressIn")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows/rntypes", "TextPropTypes.onPressOut")
  @js.native
  def onPressOut: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onPressOut_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onPressOut")(x.asInstanceOf[js.Any])
  
  inline def onPress_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onPress")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows/rntypes", "TextPropTypes.onTextLayout")
  @js.native
  def onTextLayout: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]] = js.native
  inline def onTextLayout_=(x: js.UndefOr[Validator[js.UndefOr[js.Function1[ReactEventFrom[NodeHandle & Element], Unit]]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onTextLayout")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-windows/rntypes", "TextPropTypes.selectable")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.selectionColor")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.style")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.suppressHighlighting")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.testID")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "TextPropTypes.textBreakStrategy")
  @js.native
