...
import typingsJapgolly.reactNativeWindows.anon.Index
import typingsJapgolly.reactNativeWindows.anon.Item
import typingsJapgolly.reactNativeWindows.anon.Offset
import typingsJapgolly.reactNativeWindows.anon.TypeofView
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("react-native-windows/rntypes", "FlatList")
@js.native
open class FlatList[ItemT] protected ()
  ...
  def scrollToEnd(params: typingsJapgolly.reactNativeWindows.anon.Animated): Unit = js.native
