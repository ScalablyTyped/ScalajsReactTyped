...
import typingsJapgolly.reactNativeWindows.anon.ReadonlyNativeMethods
...
trait HostComponent[P]
  ...
  var defaultProps: js.UndefOr[
    Partial[typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.defaultProps]
  ] = js.native
  ...
  var getDerivedStateFromError: js.UndefOr[
    GetDerivedStateFromError[
      typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.getDerivedStateFromError, 
      js.Object
    ]
  ] = js.native
  ...
  var getDerivedStateFromProps: js.UndefOr[
    GetDerivedStateFromProps[
      typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.getDerivedStateFromProps, 
      js.Object
    ]
  ] = js.native
  
  var propTypes: js.UndefOr[
    WeakValidationMap[typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.propTypes]
  ] = js.native
}
