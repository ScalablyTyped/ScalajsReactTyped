...
import typingsJapgolly.reactNativeWindows.anon.DictoptionName
...
object global {
  ...
  open class AbortController ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.AbortController {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val signal: typingsJapgolly.reactNativeWindows.AbortSignal = js.native
  }
  ...
  open class AbortSignal ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.AbortSignal
  ...
  open class Blob ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.Blob {
    def this(blobParts: js.Array[typingsJapgolly.reactNativeWindows.Blob | String]) = this()
    def this(blobParts: js.Array[typingsJapgolly.reactNativeWindows.Blob | String], options: BlobOptions) = this()
  ...
  open class FileReader ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.FileReader
  object FileReader {
  ...
  open class FormData ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.FormData {
  ...
  open class Headers ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.Headers {
  ...
  open class MessageQueue ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.MessageQueue {
  ...
  open class Request protected ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.Request {
    def this(input: String) = this()
    def this(input: typingsJapgolly.reactNativeWindows.Request) = this()
    def this(input: String, init: RequestInit) = this()
    def this(input: typingsJapgolly.reactNativeWindows.Request, init: RequestInit) = this()
    
    /* CompleteClass */
    override def arrayBuffer(): js.Promise[js.typedarray.ArrayBuffer] = js.native
    
    /* CompleteClass */
    override def blob(): js.Promise[typingsJapgolly.reactNativeWindows.Blob] = js.native
    ...
    /* CompleteClass */
    override def formData(): js.Promise[typingsJapgolly.reactNativeWindows.FormData] = js.native
    ...
    /* CompleteClass */
    override val headers: typingsJapgolly.reactNativeWindows.Headers = js.native
  ...
  open class Response ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.Response {
  ...
  object Response {
    ...
    inline def error(): typingsJapgolly.reactNativeWindows.Response = ^.asInstanceOf[js.Dynamic].applyDynamic("error")().asInstanceOf[typingsJapgolly.reactNativeWindows.Response]
    
    inline def redirect(url: String): typingsJapgolly.reactNativeWindows.Response = ^.asInstanceOf[js.Dynamic].applyDynamic("redirect")(url.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.reactNativeWindows.Response]
    inline def redirect(url: String, status: Double): typingsJapgolly.reactNativeWindows.Response = (^.asInstanceOf[js.Dynamic].applyDynamic("redirect")(url.asInstanceOf[js.Any], status.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.reactNativeWindows.Response]
  }
  ...
  open class URL protected ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.URL {
    ...
    /* CompleteClass */
    override val searchParams: typingsJapgolly.reactNativeWindows.URLSearchParams = js.native
  ...
  object URL {
    ...
    /* static member */
    inline def createObjectURL(blob: typingsJapgolly.reactNativeWindows.Blob): String = ^.asInstanceOf[js.Dynamic].applyDynamic("createObjectURL")(blob.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  open class URLSearchParams ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.URLSearchParams {
    def this(init: String) = this()
    def this(init: js.Array[js.Array[String]]) = this()
    def this(init: typingsJapgolly.reactNativeWindows.URLSearchParams) = this()
  ...
  open class WebSocket protected ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.WebSocket {
  ...
  open class XMLHttpRequest ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.XMLHttpRequest
  ...
  open class XMLHttpRequestUpload ()
    extends StObject
       with typingsJapgolly.reactNativeWindows.XMLHttpRequestUpload
  ...
  inline def fetch(input: RequestInfo): js.Promise[typingsJapgolly.reactNativeWindows.Response] = js.Dynamic.global.applyDynamic("fetch")(input.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.reactNativeWindows.Response]]
  inline def fetch(input: RequestInfo, init: RequestInit): js.Promise[typingsJapgolly.reactNativeWindows.Response] = (js.Dynamic.global.applyDynamic("fetch")(input.asInstanceOf[js.Any], init.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.reactNativeWindows.Response]]
