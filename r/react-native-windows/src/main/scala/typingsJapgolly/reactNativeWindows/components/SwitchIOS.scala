...
import typingsJapgolly.reactNativeWindows.rntypesMod.SwitchIOSProps
...
object SwitchIOS {
  ...
  @JSImport("react-native-windows", "SwitchIOS")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.SwitchIOS] {
    ...
    inline def onValueChange(value: /* value */ Boolean => Callback): this.type = set("onValueChange", js.Any.fromFunction1((t0: /* value */ Boolean) => value(t0).runNow()))
  ...
  implicit def make(companion: SwitchIOS.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SwitchIOSProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
