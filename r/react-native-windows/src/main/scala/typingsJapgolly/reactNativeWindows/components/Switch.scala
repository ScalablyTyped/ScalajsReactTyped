...
import typingsJapgolly.reactNativeWindows.rntypesMod.SwitchChangeEvent
import typingsJapgolly.reactNativeWindows.rntypesMod.SwitchProps
...
object Switch {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.Switch] {
