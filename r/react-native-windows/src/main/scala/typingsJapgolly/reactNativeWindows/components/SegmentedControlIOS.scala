...
import typingsJapgolly.reactNativeWindows.rntypesMod.SegmentedControlIOSProps
...
object SegmentedControlIOS {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.SegmentedControlIOS] {
