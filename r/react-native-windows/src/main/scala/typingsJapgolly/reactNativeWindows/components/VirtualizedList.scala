...
import typingsJapgolly.reactNativeWindows.anon.AverageItemLength
import typingsJapgolly.reactNativeWindows.anon.Changed
import typingsJapgolly.reactNativeWindows.anon.DistanceFromEnd
...
import typingsJapgolly.reactNativeWindows.rntypesMod.ListRenderItemInfo
...
import typingsJapgolly.reactNativeWindows.rntypesMod.ViewabilityConfig
import typingsJapgolly.reactNativeWindows.rntypesMod.ViewabilityConfigCallbackPair
import typingsJapgolly.reactNativeWindows.rntypesMod.ViewabilityConfigCallbackPairs
...
object VirtualizedList {
  ...
  open class Builder[ItemT] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.VirtualizedList[ItemT]] {
    ...
    inline def getItemLayout(value: (/* data */ Any, /* index */ Double) => Length): this.type = set("getItemLayout", js.Any.fromFunction2(value))
