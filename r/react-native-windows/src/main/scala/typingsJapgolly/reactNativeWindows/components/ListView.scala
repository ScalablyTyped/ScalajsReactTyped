...
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.fast
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.handled
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.interactive
...
import typingsJapgolly.reactNativeWindows.rntypesMod.ListViewDataSource
import typingsJapgolly.reactNativeWindows.rntypesMod.ListViewProps
import typingsJapgolly.reactNativeWindows.rntypesMod.NodeHandle
import typingsJapgolly.reactNativeWindows.rntypesMod.PointPropType
import typingsJapgolly.reactNativeWindows.rntypesMod.ScrollViewProps
...
object ListView {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.ListView] {
    ...
    inline def contentOffset(value: PointPropType): this.type = set("contentOffset", value.asInstanceOf[js.Any])
    ...
    inline def enableEmptySections(value: Boolean): this.type = set("enableEmptySections", value.asInstanceOf[js.Any])
    ...
    inline def initialListSize(value: Double): this.type = set("initialListSize", value.asInstanceOf[js.Any])
    ...
    inline def onChangeVisibleRows(
      value: (/* visibleRows */ js.Array[StringDictionary[StringDictionary[Boolean]]], /* changedRows */ js.Array[StringDictionary[StringDictionary[Boolean]]]) => Callback
    ): this.type = set("onChangeVisibleRows", js.Any.fromFunction2((t0: /* visibleRows */ js.Array[StringDictionary[StringDictionary[Boolean]]], t1: /* changedRows */ js.Array[StringDictionary[StringDictionary[Boolean]]]) => (value(t0, t1)).runNow()))
    ...
    inline def onEndReached(value: Callback): this.type = set("onEndReached", value.toJsFn)
    ...
    inline def renderSectionHeader(value: (/* sectionData */ Any, /* sectionId */ String | Double) => Element): this.type = set("renderSectionHeader", js.Any.fromFunction2(value))
    
    inline def renderSeparator(
      value: (/* sectionID */ String | Double, /* rowID */ String | Double, /* adjacentRowHighlighted */ js.UndefOr[Boolean]) => Element
    ...
    inline def scrollRenderAheadDistance(value: Double): this.type = set("scrollRenderAheadDistance", value.asInstanceOf[js.Any])
