...
import typingsJapgolly.reactNativeWindows.rntypesMod.RefreshControlProps
...
object RefreshControl {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.RefreshControl] {
