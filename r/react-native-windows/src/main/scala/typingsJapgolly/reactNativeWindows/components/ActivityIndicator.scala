...
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.large_
...
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.small_
...
import typingsJapgolly.reactNativeWindows.rntypesMod.ActivityIndicatorProps
...
object ActivityIndicator {
  ...
  @JSImport("react-native-windows", "ActivityIndicator")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.ActivityIndicator] {
    ...
    inline def size(value: Double | small_ | large_): this.type = set("size", value.asInstanceOf[js.Any])
