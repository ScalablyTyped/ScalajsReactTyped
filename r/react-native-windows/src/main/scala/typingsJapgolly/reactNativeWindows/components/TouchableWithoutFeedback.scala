...
import typingsJapgolly.reactNativeWindows.rntypesMod.TouchableWithoutFeedbackProps
...
object TouchableWithoutFeedback {
  ...
  @JSImport("react-native-windows", "TouchableWithoutFeedback")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.TouchableWithoutFeedback] {
