...
import typingsJapgolly.reactNativeWindows.rntypesMod.KeyboardAvoidingViewProps
...
object KeyboardAvoidingView {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.KeyboardAvoidingView] {
