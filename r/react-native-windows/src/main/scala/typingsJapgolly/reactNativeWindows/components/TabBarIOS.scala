...
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.fill
...
import typingsJapgolly.reactNativeWindows.rntypesMod.TabBarIOSProps
...
object TabBarIOS {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.TabBarIOS] {
    ...
    inline def itemPositioning(value: fill | center | auto): this.type = set("itemPositioning", value.asInstanceOf[js.Any])
    ...
    inline def unselectedItemTintColor(value: ColorValue): this.type = set("unselectedItemTintColor", value.asInstanceOf[js.Any])
    
    inline def unselectedTintColor(value: ColorValue): this.type = set("unselectedTintColor", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: TabBarIOS.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
