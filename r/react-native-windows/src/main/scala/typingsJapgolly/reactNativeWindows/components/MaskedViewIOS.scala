...
import typingsJapgolly.reactNativeWindows.rntypesMod.MaskedViewIOSProps
...
object MaskedViewIOS {
  ...
  inline def apply(maskElement: VdomElement): Builder = {
    val __props = js.Dynamic.literal(maskElement = maskElement.rawElement.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[MaskedViewIOSProps]))
  }
  
  @JSImport("react-native-windows", "MaskedViewIOS")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.MaskedViewIOS] {
  ...
  def withProps(p: MaskedViewIOSProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
