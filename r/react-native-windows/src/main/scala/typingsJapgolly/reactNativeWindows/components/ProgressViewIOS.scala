...
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.bar
...
import typingsJapgolly.reactNativeWindows.rntypesMod.ProgressViewIOSProps
...
object ProgressViewIOS {
  ...
  @JSImport("react-native-windows", "ProgressViewIOS")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.ProgressViewIOS] {
    ...
    inline def progressImage(value: ImageURISource | js.Array[ImageURISource]): this.type = set("progressImage", value.asInstanceOf[js.Any])
    
    inline def progressImageVarargs(value: ImageURISource*): this.type = set("progressImage", js.Array(value*))
    
    inline def progressTintColor(value: ColorValue): this.type = set("progressTintColor", value.asInstanceOf[js.Any])
    
    inline def progressViewStyle(value: default | bar): this.type = set("progressViewStyle", value.asInstanceOf[js.Any])
    ...
    inline def trackImage(value: ImageURISource | js.Array[ImageURISource]): this.type = set("trackImage", value.asInstanceOf[js.Any])
    
    inline def trackImageVarargs(value: ImageURISource*): this.type = set("trackImage", js.Array(value*))
    
    inline def trackTintColor(value: ColorValue): this.type = set("trackTintColor", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ProgressViewIOS.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ProgressViewIOSProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
