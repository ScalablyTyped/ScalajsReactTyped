...
import typingsJapgolly.reactNativeWindows.rntypesMod.TouchableOpacityProps
...
object TouchableOpacity {
  ...
  @JSImport("react-native-windows", "TouchableOpacity")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.TouchableOpacity] {
