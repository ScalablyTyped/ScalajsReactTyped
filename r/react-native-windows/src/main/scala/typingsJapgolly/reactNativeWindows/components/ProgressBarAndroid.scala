...
import typingsJapgolly.reactNativeWindows.rntypesMod.ProgressBarAndroidProps
...
object ProgressBarAndroid {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.ProgressBarAndroid] {
