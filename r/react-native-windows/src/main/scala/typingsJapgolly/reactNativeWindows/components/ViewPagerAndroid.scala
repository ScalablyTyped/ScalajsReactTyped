...
import typingsJapgolly.reactNativeWindows.rntypesMod.ViewPagerAndroidProps
...
object ViewPagerAndroid {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.ViewPagerAndroid] {
  ...
  implicit def make(companion: ViewPagerAndroid.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
