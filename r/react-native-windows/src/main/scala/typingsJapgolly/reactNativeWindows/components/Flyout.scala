...
object Flyout {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.Flyout] {
    ...
    inline def horizontalOffset(value: Double): this.type = set("horizontalOffset", value.asInstanceOf[js.Any])
    ...
    inline def isLightDismissEnabled(value: Boolean): this.type = set("isLightDismissEnabled", value.asInstanceOf[js.Any])
    
    inline def isOpen(value: Boolean): this.type = set("isOpen", value.asInstanceOf[js.Any])
    
    inline def isOverlayEnabled(value: Boolean): this.type = set("isOverlayEnabled", value.asInstanceOf[js.Any])
    ...
    inline def onDismiss(value: /* isOpen */ Boolean => Callback): this.type = set("onDismiss", js.Any.fromFunction1((t0: /* isOpen */ Boolean) => value(t0).runNow()))
    ...
    inline def shouldConstrainToRootBounds(value: Boolean): this.type = set("shouldConstrainToRootBounds", value.asInstanceOf[js.Any])
    
    inline def shouldRasterizeIOS(value: Boolean): this.type = set("shouldRasterizeIOS", value.asInstanceOf[js.Any])
    
    inline def showMode(value: ShowMode): this.type = set("showMode", value.asInstanceOf[js.Any])
    ...
    inline def targetVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("target", js.Array(value*))
    ...
    inline def verticalOffset(value: Double): this.type = set("verticalOffset", value.asInstanceOf[js.Any])
  }
