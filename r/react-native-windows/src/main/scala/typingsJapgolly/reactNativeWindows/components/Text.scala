...
import typingsJapgolly.reactNativeWindows.rntypesMod.TextProps
...
object Text {
  ...
  @JSImport("react-native-windows", "Text")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.Text] {
    ...
    inline def android_hyphenationFrequency(value: normal_ | none | full | high | balanced): this.type = set("android_hyphenationFrequency", value.asInstanceOf[js.Any])
