...
import typingsJapgolly.reactNativeWindows.rntypesMod.SectionListData
import typingsJapgolly.reactNativeWindows.rntypesMod.SectionListProps
import typingsJapgolly.reactNativeWindows.rntypesMod.SectionListRenderItemInfo
...
object SectionList {
  ...
  open class Builder[ItemT, SectionT] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.SectionList[ItemT, SectionT]] {
