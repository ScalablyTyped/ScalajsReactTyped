...
import typingsJapgolly.reactNativeWindows.librariesComponentsGlyphGlyphPropsMod.GlyphStyle
...
object Glyph {
  ...
  inline def apply(fontUri: String, glyph: String): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.Glyph] {
    ...
    inline def colorEnabled(value: Boolean): this.type = set("colorEnabled", value.asInstanceOf[js.Any])
    
    inline def emSize(value: Double): this.type = set("emSize", value.asInstanceOf[js.Any])
    ...
    inline def style(value: StyleProp[GlyphStyle]): this.type = set("style", value.asInstanceOf[js.Any])
