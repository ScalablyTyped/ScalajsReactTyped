...
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.`landscape-left`
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.`landscape-right`
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.`no-hide-descendants`
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.`portrait-upside-down`
...
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.formSheet
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.fullScreen
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.landscape
...
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.overFullScreen
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.pageSheet
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.polite
import typingsJapgolly.reactNativeWindows.reactNativeWindowsStrings.portrait
...
import typingsJapgolly.reactNativeWindows.rntypesMod.ModalProps
...
object Modal {
  ...
  @JSImport("react-native-windows", "Modal")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.Modal] {
    ...
    inline def onOrientationChange(value: ReactEventFrom[NodeHandle & Element] => Callback): this.type = set("onOrientationChange", js.Any.fromFunction1((t0: ReactEventFrom[NodeHandle & Element]) => value(t0).runNow()))
    ...
    inline def onShow(value: ReactEventFrom[NodeHandle & Element] => Callback): this.type = set("onShow", js.Any.fromFunction1((t0: ReactEventFrom[NodeHandle & Element]) => value(t0).runNow()))
