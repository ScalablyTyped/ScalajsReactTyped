...
import typingsJapgolly.reactNativeWindows.rntypesMod.BackgroundPropType
...
import typingsJapgolly.reactNativeWindows.rntypesMod.TouchableNativeFeedbackProps
...
object TouchableNativeFeedback {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.TouchableNativeFeedback] {
  ...
  implicit def make(companion: TouchableNativeFeedback.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TouchableNativeFeedbackProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
