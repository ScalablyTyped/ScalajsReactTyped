...
import typingsJapgolly.reactNativeWindows.rntypesMod.SnapshotViewIOSProps
...
object SnapshotViewIOS {
  ...
  inline def apply(onSnapshotReady: CallbackTo[Any], testIdentifier: String): Builder = {
    val __props = js.Dynamic.literal(onSnapshotReady = onSnapshotReady.toJsFn, testIdentifier = testIdentifier.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[SnapshotViewIOSProps]))
  }
  
  @JSImport("react-native-windows", "SnapshotViewIOS")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeWindows.mod.SnapshotViewIOS] {
