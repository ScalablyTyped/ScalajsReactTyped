...
object librariesComponentsKeyboardKeyboardExtPropsMod {
  ...
  object EventPhase extends StObject {
    ...
    sealed trait AtTarget
      extends StObject
         with EventPhase
    /* 2 */ val AtTarget: typingsJapgolly.reactNativeWindows.librariesComponentsKeyboardKeyboardExtPropsMod.EventPhase.AtTarget & Double = js.native
    
    @js.native
    sealed trait Bubbling
      extends StObject
         with EventPhase
    /* 3 */ val Bubbling: typingsJapgolly.reactNativeWindows.librariesComponentsKeyboardKeyboardExtPropsMod.EventPhase.Bubbling & Double = js.native
    
    @js.native
    sealed trait Capturing
      extends StObject
         with EventPhase
    /* 1 */ val Capturing: typingsJapgolly.reactNativeWindows.librariesComponentsKeyboardKeyboardExtPropsMod.EventPhase.Capturing & Double = js.native
    
    @js.native
    sealed trait None
      extends StObject
         with EventPhase
    /* 0 */ val None: typingsJapgolly.reactNativeWindows.librariesComponentsKeyboardKeyboardExtPropsMod.EventPhase.None & Double = js.native
  }
  ...
  object HandledEventPhase extends StObject {
    ...
    /* 3 */ val Bubbling: typingsJapgolly.reactNativeWindows.librariesComponentsKeyboardKeyboardExtPropsMod.HandledEventPhase.Bubbling & Double = js.native
    
    @js.native
    sealed trait Capturing
      extends StObject
         with HandledEventPhase
    /* 1 */ val Capturing: typingsJapgolly.reactNativeWindows.librariesComponentsKeyboardKeyboardExtPropsMod.HandledEventPhase.Capturing & Double = js.native
  }
  ...
  object IKeyboardProps {
    ...
    extension [Self <: IKeyboardProps](x: Self) {
      ...
      inline def setOnKeyDown(value: /* args */ IKeyboardEvent => Callback): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1((t0: /* args */ IKeyboardEvent) => value(t0).runNow()))
      
      inline def setOnKeyDownCapture(value: /* args */ IKeyboardEvent => Callback): Self = StObject.set(x, "onKeyDownCapture", js.Any.fromFunction1((t0: /* args */ IKeyboardEvent) => value(t0).runNow()))
      
      inline def setOnKeyDownCaptureUndefined: Self = StObject.set(x, "onKeyDownCapture", js.undefined)
      
      inline def setOnKeyDownUndefined: Self = StObject.set(x, "onKeyDown", js.undefined)
      
      inline def setOnKeyUp(value: /* args */ IKeyboardEvent => Callback): Self = StObject.set(x, "onKeyUp", js.Any.fromFunction1((t0: /* args */ IKeyboardEvent) => value(t0).runNow()))
      
      inline def setOnKeyUpCapture(value: /* args */ IKeyboardEvent => Callback): Self = StObject.set(x, "onKeyUpCapture", js.Any.fromFunction1((t0: /* args */ IKeyboardEvent) => value(t0).runNow()))
