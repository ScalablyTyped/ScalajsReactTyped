...
object PulseIndicator {
  def apply(
    ...
    PulseIndicatorProps, 
    typingsJapgolly.reactNativeIndicators.mod.PulseIndicator, 
    Unit, 
    PulseIndicatorProps
  ] = {
  ...
  typingsJapgolly.reactNativeIndicators.mod.PulseIndicatorProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeIndicators.mod.PulseIndicator](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeIndicators.mod.PulseIndicatorProps])(children: _*)
  }
