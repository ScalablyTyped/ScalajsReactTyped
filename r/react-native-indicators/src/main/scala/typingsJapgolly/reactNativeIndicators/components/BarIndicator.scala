...
import typingsJapgolly.reactNativeIndicators.mod.BarIndicatorProps
...
object BarIndicator {
  def apply(
    ...
    BarIndicatorProps, 
    typingsJapgolly.reactNativeIndicators.mod.BarIndicator, 
    Unit, 
    BarIndicatorProps
  ] = {
  ...
  typingsJapgolly.reactNativeIndicators.mod.BarIndicatorProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeIndicators.mod.BarIndicator](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeIndicators.mod.BarIndicatorProps])(children: _*)
  }
