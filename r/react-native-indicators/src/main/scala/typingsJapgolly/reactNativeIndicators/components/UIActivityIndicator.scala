...
import typingsJapgolly.reactNativeIndicators.mod.UIActivityIndicatorProps
...
object UIActivityIndicator {
  def apply(
    ...
    typingsJapgolly.reactNativeIndicators.mod.UIActivityIndicator, 
    Unit, 
    UIActivityIndicatorProps
  ] = {
  ...
  typingsJapgolly.reactNativeIndicators.mod.UIActivityIndicatorProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeIndicators.mod.UIActivityIndicator](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeIndicators.mod.UIActivityIndicatorProps])(children: _*)
  }
