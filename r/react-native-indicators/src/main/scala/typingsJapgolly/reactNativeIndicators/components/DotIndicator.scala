...
import typingsJapgolly.reactNativeIndicators.mod.DotIndicatorProps
...
object DotIndicator {
  def apply(
    ...
    DotIndicatorProps, 
    typingsJapgolly.reactNativeIndicators.mod.DotIndicator, 
    Unit, 
    DotIndicatorProps
  ] = {
  ...
  typingsJapgolly.reactNativeIndicators.mod.DotIndicatorProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeIndicators.mod.DotIndicator](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeIndicators.mod.DotIndicatorProps])(children: _*)
  }
