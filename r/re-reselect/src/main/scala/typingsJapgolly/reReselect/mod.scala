...
import typingsJapgolly.reReselect.anon.Cache
import typingsJapgolly.reReselect.anon.CacheSize
import typingsJapgolly.reReselect.anon.ClearCache
import typingsJapgolly.reReselect.anon.InputSelectors
...
object mod {
  ...
  object ICacheObject {
    ...
    inline def apply(clear: Callback, get: Any => Any, remove: Any => Callback, set: (Any, Any) => Callback): ICacheObject = {
      val __obj = js.Dynamic.literal(clear = clear.toJsFn, get = js.Any.fromFunction1(get), remove = js.Any.fromFunction1((t0: Any) => remove(t0).runNow()), set = js.Any.fromFunction2((t0: Any, t1: Any) => (set(t0, t1)).runNow()))
  ...
  type ParametricKeySelectorCreator[S, P, C, D] = js.Function1[
    /* selectorInputs */ typingsJapgolly.reReselect.anon.KeySelector[D, C, S, P], 
  ...
  object ParametricOptions {
    ...
    extension [Self <: ParametricOptions[?, ?, ?, ?], S, P, C, D](x: Self & (ParametricOptions[S, P, C, D])) {
      ...
      inline def setKeySelectorCreator(
        value: /* selectorInputs */ typingsJapgolly.reReselect.anon.KeySelector[D, C, S, P] => ParametricKeySelector[S, P]
