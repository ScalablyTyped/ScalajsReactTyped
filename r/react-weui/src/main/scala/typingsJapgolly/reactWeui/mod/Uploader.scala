...
import typingsJapgolly.reactWeui.anon.Files
...
@js.native
open class Uploader protected () extends StObject {
  def this(args: Any*) = this()
  
  def detectVerticalSquash(img: Any): Any = js.native
  
  def handleChange(e: Any): Unit = js.native
  
  def handleFile(file: Any, cb: Any, args: Any*): Unit = js.native
  
  def render(): Any = js.native
  
  def renderFiles(): Any = js.native
}
/* static members */
object Uploader {
