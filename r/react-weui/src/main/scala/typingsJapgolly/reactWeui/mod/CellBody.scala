...
object CellBody {
  ...
  @JSImport("react-weui", "CellBody")
  @js.native
  val ^ : js.Any = js.native
  
  object defaultProps {
    
    @JSImport("react-weui", "CellBody.defaultProps")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-weui", "CellBody.defaultProps.primary")
    @js.native
  ...
  object propTypes {
    ...
    object primary {
      ...
      @JSImport("react-weui", "CellBody.propTypes.primary")
      @js.native
      val ^ : js.Any = js.native
