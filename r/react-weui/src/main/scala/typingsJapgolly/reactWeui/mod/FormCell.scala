...
@js.native
open class FormCell protected () extends StObject {
...
object FormCell {
  ...
  @js.native
  def defaultProps: typingsJapgolly.reactWeui.anon.Radio = js.native
  inline def defaultProps_=(x: typingsJapgolly.reactWeui.anon.Radio): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
