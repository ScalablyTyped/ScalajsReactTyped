...
object Form {
  ...
  @js.native
  def defaultProps: typingsJapgolly.reactWeui.anon.Checkbox = js.native
  inline def defaultProps_=(x: typingsJapgolly.reactWeui.anon.Checkbox): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
