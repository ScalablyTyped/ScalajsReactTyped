...
object Cell {
  ...
  object defaultProps {
    ...
    inline def access_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("access")(x.asInstanceOf[js.Any])
    
    @JSImport("react-weui", "Cell.defaultProps.link")
    @js.native
    def link: Boolean = js.native
    inline def link_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("link")(x.asInstanceOf[js.Any])
  }
