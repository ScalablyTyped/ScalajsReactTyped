...
trait ChannelsClockRateMediaTypeName extends StObject {
  ...
  var channels: typingsJapgolly.rtpParser.rtpParserInts.`2`
...
object ChannelsClockRateMediaTypeName {
  ...
  extension [Self <: ChannelsClockRateMediaTypeName](x: Self) {
    ...
    inline def setChannels(value: typingsJapgolly.rtpParser.rtpParserInts.`2`): Self = StObject.set(x, "channels", value.asInstanceOf[js.Any])
