...
import typingsJapgolly.redlock.redlockStrings.clientError
...
object mod {
  ...
  open class Lock protected () extends StObject {
    ...
    def extend(ttl: Double): typingsJapgolly.bluebird.mod.^[Lock] = js.native
    def extend(ttl: Double, callback: Callback[Lock]): typingsJapgolly.bluebird.mod.^[Lock] = js.native
    
    var redlock: Redlock = js.native
    
    var resource: String = js.native
    
    def unlock(): typingsJapgolly.bluebird.mod.^[Unit] = js.native
    def unlock(callback: Callback[Unit]): typingsJapgolly.bluebird.mod.^[Unit] = js.native
  ...
  trait Redlock extends EventEmitter {
    ...
    /**
      ...
      */
    def acquire(resource: String, ttl: Double): typingsJapgolly.bluebird.mod.^[Lock] = js.native
    def acquire(resource: String, ttl: Double, callback: Callback[Lock]): typingsJapgolly.bluebird.mod.^[Lock] = js.native
    def acquire(resource: js.Array[String], ttl: Double): typingsJapgolly.bluebird.mod.^[Lock] = js.native
    def acquire(resource: js.Array[String], ttl: Double, callback: Callback[Lock]): typingsJapgolly.bluebird.mod.^[Lock] = js.native
    ...
    /**
      ...
      */
    def extend(lock: Lock, ttl: Double): typingsJapgolly.bluebird.mod.^[Lock] = js.native
    def extend(lock: Lock, ttl: Double, callback: Callback[Lock]): typingsJapgolly.bluebird.mod.^[Lock] = js.native
    ...
    /**
      ...
      * @param ttl - how long to keep the lock (milliseconds)
      */
    def lock(resource: String, ttl: Double): typingsJapgolly.bluebird.mod.^[Lock] = js.native
    def lock(resource: String, ttl: Double, callback: Callback[Lock]): typingsJapgolly.bluebird.mod.^[Lock] = js.native
    def lock(resource: js.Array[String], ttl: Double): typingsJapgolly.bluebird.mod.^[Lock] = js.native
    def lock(resource: js.Array[String], ttl: Double, callback: Callback[Lock]): typingsJapgolly.bluebird.mod.^[Lock] = js.native
    ...
    /**
      ...
      */
    def quit(): typingsJapgolly.bluebird.mod.^[Unit] = js.native
    def quit(callback: Callback[Unit]): typingsJapgolly.bluebird.mod.^[Unit] = js.native
    ...
    /**
      ...
      */
    def release(lock: Lock): typingsJapgolly.bluebird.mod.^[Unit] = js.native
    def release(lock: Lock, callback: Callback[Unit]): typingsJapgolly.bluebird.mod.^[Unit] = js.native
    ...
    /**
      ...
      * @param callback - be notified once lock has been released by the clients
      */
    def unlock(lock: Lock): typingsJapgolly.bluebird.mod.^[Unit] = js.native
    def unlock(lock: Lock, callback: Callback[Unit]): typingsJapgolly.bluebird.mod.^[Unit] = js.native
  }
