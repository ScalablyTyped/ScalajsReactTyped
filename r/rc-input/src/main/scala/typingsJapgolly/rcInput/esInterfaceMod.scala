...
import typingsJapgolly.rcInput.anon.Count
import typingsJapgolly.rcInput.esUtilsCommonUtilsMod.InputFocusOptions
...
import typingsJapgolly.rcInput.rcInputStrings.backward
...
import typingsJapgolly.rcInput.rcInputStrings.forward
...
object esInterfaceMod {
  ...
  trait BaseInputProps
    ...
    var inputElement: japgolly.scalajs.react.facade.React.Element
  ...
  object BaseInputProps {
    ...
    inline def apply(inputElement: VdomElement): BaseInputProps = {
      val __obj = js.Dynamic.literal(inputElement = inputElement.rawElement.asInstanceOf[js.Any])
    ...
    extension [Self <: BaseInputProps](x: Self) {
      ...
      inline def setHandleReset(value: ReactMouseEventFrom[Element & Element] => Callback): Self = StObject.set(x, "handleReset", js.Any.fromFunction1((t0: ReactMouseEventFrom[Element & Element]) => value(t0).runNow()))
  ...
  object CommonInputProps {
    ...
    extension [Self <: CommonInputProps](x: Self) {
      ...
      inline def setAddonAfterVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "addonAfter", js.Array(value*))
      ...
      inline def setAddonBeforeVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "addonBefore", js.Array(value*))
  ...
  object InputProps {
    ...
    extension [Self <: InputProps](x: Self) {
      ...
      inline def setOnPressEnter(value: ReactKeyboardEventFrom[HTMLInputElement & Element] => Callback): Self = StObject.set(x, "onPressEnter", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLInputElement & Element]) => value(t0).runNow()))
  ...
  trait ShowCountProps extends StObject {
    ...
    def formatter(args: Count): Node
  }
  object ShowCountProps {
    
    inline def apply(formatter: Count => Node): ShowCountProps = {
    ...
    extension [Self <: ShowCountProps](x: Self) {
      ...
      inline def setFormatter(value: Count => Node): Self = StObject.set(x, "formatter", js.Any.fromFunction1(value))
    }
  }
}
