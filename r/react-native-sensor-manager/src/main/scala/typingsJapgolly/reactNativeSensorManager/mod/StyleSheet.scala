...
import typingsJapgolly.reactNative.mod.StyleSheet.AbsoluteFillStyle
...
object StyleSheet {
  ...
  @JSImport("react-native-sensor-manager", "StyleSheet")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-native-sensor-manager", "StyleSheet.absoluteFill")
  @js.native
  val absoluteFill: RegisteredStyle[AbsoluteFillStyle] = js.native
  
  @JSImport("react-native-sensor-manager", "StyleSheet.absoluteFillObject")
  @js.native
  ...
  @JSImport("react-native-sensor-manager", "StyleSheet.hairlineWidth")
  @js.native
