...
object SwipeableListView {
  ...
  inline def apply(
  ...
  ): Default[typingsJapgolly.reactNativeSensorManager.mod.SwipeableListView] = {
    ...
    new Default[typingsJapgolly.reactNativeSensorManager.mod.SwipeableListView](js.Array(this.component, __props.asInstanceOf[SwipeableListViewProps]))
  }
  ...
  def withProps(p: SwipeableListViewProps): Default[typingsJapgolly.reactNativeSensorManager.mod.SwipeableListView] = new Default[typingsJapgolly.reactNativeSensorManager.mod.SwipeableListView](js.Array(this.component, p.asInstanceOf[js.Any]))
}
