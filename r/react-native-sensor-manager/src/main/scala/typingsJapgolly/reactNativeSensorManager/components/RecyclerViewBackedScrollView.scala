...
object RecyclerViewBackedScrollView {
  ...
  @JSImport("react-native-sensor-manager", "RecyclerViewBackedScrollView")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeSensorManager.mod.RecyclerViewBackedScrollView] {
