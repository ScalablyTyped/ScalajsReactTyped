...
import typingsJapgolly.reactNative.mod.DatePickerIOSProps
...
object DatePickerIOS {
  ...
  @JSImport("react-native-sensor-manager", "DatePickerIOS")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeSensorManager.mod.DatePickerIOS] {
