...
import typingsJapgolly.reactNative.mod.KeyboardAvoidingViewProps
...
import typingsJapgolly.reactNative.reactNativeStrings.height
import typingsJapgolly.reactNative.reactNativeStrings.no
import typingsJapgolly.reactNative.reactNativeStrings.none
import typingsJapgolly.reactNative.reactNativeStrings.padding
import typingsJapgolly.reactNative.reactNativeStrings.polite
import typingsJapgolly.reactNative.reactNativeStrings.position
...
object KeyboardAvoidingView {
  ...
  @JSImport("react-native-sensor-manager", "KeyboardAvoidingView")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeSensorManager.mod.KeyboardAvoidingView] {
    ...
    inline def behavior(value: height | position | padding): this.type = set("behavior", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: KeyboardAvoidingView.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: KeyboardAvoidingViewProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
