...
object TouchableWithoutFeedback {
  ...
  @JSImport("react-native-sensor-manager", "TouchableWithoutFeedback")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeSensorManager.mod.TouchableWithoutFeedback] {
