...
import typingsJapgolly.reactNative.mod.MaskedViewIOSProps
...
object MaskedViewIOS {
  ...
  @JSImport("react-native-sensor-manager", "MaskedViewIOS")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeSensorManager.mod.MaskedViewIOS] {
