...
import typingsJapgolly.reactNative.mod.SliderProps
...
object Slider {
  ...
  @JSImport("react-native-sensor-manager", "Slider")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeSensorManager.mod.Slider] {
    ...
    inline def maximumTrackTintColor(value: ColorValue): this.type = set("maximumTrackTintColor", value.asInstanceOf[js.Any])
    ...
    inline def minimumTrackTintColor(value: ColorValue): this.type = set("minimumTrackTintColor", value.asInstanceOf[js.Any])
