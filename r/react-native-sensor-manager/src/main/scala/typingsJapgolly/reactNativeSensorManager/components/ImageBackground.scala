...
object ImageBackground {
  ...
  @JSImport("react-native-sensor-manager", "ImageBackground")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeSensorManager.mod.ImageBackground] {
    ...
    inline def imageRef(value: /* image */ typingsJapgolly.reactNative.mod.Image => Callback): this.type = set("imageRef", js.Any.fromFunction1((t0: /* image */ typingsJapgolly.reactNative.mod.Image) => value(t0).runNow()))
  ...
  implicit def make(companion: ImageBackground.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
