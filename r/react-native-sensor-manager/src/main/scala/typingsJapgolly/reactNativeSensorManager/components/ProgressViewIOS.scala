...
import typingsJapgolly.reactNative.mod.ProgressViewIOSProps
...
import typingsJapgolly.reactNative.reactNativeStrings.bar
...
object ProgressViewIOS {
  ...
  @JSImport("react-native-sensor-manager", "ProgressViewIOS")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeSensorManager.mod.ProgressViewIOS] {
