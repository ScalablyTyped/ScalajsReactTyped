...
import typingsJapgolly.reactNativeSensorManager.reactNativeSensorManagerStrings.center
import typingsJapgolly.reactNativeSensorManager.reactNativeSensorManagerStrings.fill
