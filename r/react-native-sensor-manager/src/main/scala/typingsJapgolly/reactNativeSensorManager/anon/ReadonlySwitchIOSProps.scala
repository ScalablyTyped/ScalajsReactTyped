...
import typingsJapgolly.reactNativeSensorManager.reactNativeSensorManagerStrings.`box-none`
import typingsJapgolly.reactNativeSensorManager.reactNativeSensorManagerStrings.`box-only`
import typingsJapgolly.reactNativeSensorManager.reactNativeSensorManagerStrings.`no-hide-descendants`
import typingsJapgolly.reactNativeSensorManager.reactNativeSensorManagerStrings.assertive
import typingsJapgolly.reactNativeSensorManager.reactNativeSensorManagerStrings.auto
import typingsJapgolly.reactNativeSensorManager.reactNativeSensorManagerStrings.no
import typingsJapgolly.reactNativeSensorManager.reactNativeSensorManagerStrings.none
import typingsJapgolly.reactNativeSensorManager.reactNativeSensorManagerStrings.polite
import typingsJapgolly.reactNativeSensorManager.reactNativeSensorManagerStrings.yes
