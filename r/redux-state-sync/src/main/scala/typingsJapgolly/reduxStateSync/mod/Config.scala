...
object Config {
  ...
  def apply(
    ...
    channel: String = null,
    predicate: /* action */ AnyAction => CallbackTo[Boolean | Null] = null,
    ...
    if (predicate != null) __obj.updateDynamic("predicate")(js.Any.fromFunction1((t0: /* action */ typingsJapgolly.redux.mod.AnyAction) => predicate(t0).runNow()))
