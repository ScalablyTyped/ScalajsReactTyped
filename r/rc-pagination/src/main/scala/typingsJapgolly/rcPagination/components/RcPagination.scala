...
object RcPagination {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def jumpNextIcon(value: ComponentType[js.Object] | Node): this.type = set("jumpNextIcon", value.asInstanceOf[js.Any])
    
    inline def jumpNextIconNull: this.type = set("jumpNextIcon", null)
    
    inline def jumpNextIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("jumpNextIcon", js.Array(value*))
    
    inline def jumpNextIconVdomElement(value: VdomElement): this.type = set("jumpNextIcon", value.rawElement.asInstanceOf[js.Any])
    
    inline def jumpPrevIcon(value: ComponentType[js.Object] | Node): this.type = set("jumpPrevIcon", value.asInstanceOf[js.Any])
    
    inline def jumpPrevIconNull: this.type = set("jumpPrevIcon", null)
    
    inline def jumpPrevIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("jumpPrevIcon", js.Array(value*))
    ...
    inline def nextIcon(value: ComponentType[js.Object] | Node): this.type = set("nextIcon", value.asInstanceOf[js.Any])
    ...
    inline def prevIcon(value: ComponentType[js.Object] | Node): this.type = set("prevIcon", value.asInstanceOf[js.Any])
    ...
    inline def showTotal(value: (/* total */ Double, /* range */ js.Tuple2[Double, Double]) => Node): this.type = set("showTotal", js.Any.fromFunction2(value))
