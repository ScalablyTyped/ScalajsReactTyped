...
object mod extends Shortcut {
  ...
  type HTMLViewNodeRenderer = js.Function2[/* node */ js.Array[HTMLViewNode], /* parent */ HTMLViewNode | Nullish, Node]
  ...
  object HTMLViewProps {
    ...
    extension [Self <: HTMLViewProps](x: Self) {
      ...
      inline def setOnLinkLongPress(value: /* url */ String => Callback): Self = StObject.set(x, "onLinkLongPress", js.Any.fromFunction1((t0: /* url */ String) => value(t0).runNow()))
      
      inline def setOnLinkLongPressUndefined: Self = StObject.set(x, "onLinkLongPress", js.undefined)
      
      inline def setOnLinkPress(value: /* url */ String => Callback): Self = StObject.set(x, "onLinkPress", js.Any.fromFunction1((t0: /* url */ String) => value(t0).runNow()))
