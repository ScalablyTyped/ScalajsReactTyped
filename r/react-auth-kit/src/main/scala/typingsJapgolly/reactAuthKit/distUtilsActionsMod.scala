...
import typingsJapgolly.reactAuthKit.anon.ExpiresAt
import typingsJapgolly.reactAuthKit.anon.Token
import typingsJapgolly.reactAuthKit.distTypesMod.AuthStateUserObject
import typingsJapgolly.reactAuthKit.distUtilsActionsMod.ActionType.RefreshToken
import typingsJapgolly.reactAuthKit.distUtilsActionsMod.ActionType.SignIn
import typingsJapgolly.reactAuthKit.distUtilsActionsMod.ActionType.SignOut
...
object distUtilsActionsMod {
  ...
  object ActionType extends StObject {
    ...
    sealed trait RefreshToken
      extends StObject
         with ActionType
    /* 2 */ val RefreshToken: typingsJapgolly.reactAuthKit.distUtilsActionsMod.ActionType.RefreshToken & Double = js.native
    
    @js.native
    sealed trait SignIn
      extends StObject
         with ActionType
    /* 0 */ val SignIn: typingsJapgolly.reactAuthKit.distUtilsActionsMod.ActionType.SignIn & Double = js.native
    
    @js.native
    sealed trait SignOut
      extends StObject
         with ActionType
    /* 1 */ val SignOut: typingsJapgolly.reactAuthKit.distUtilsActionsMod.ActionType.SignOut & Double = js.native
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactAuthKit.distUtilsActionsMod.SignInAction
    - typingsJapgolly.reactAuthKit.distUtilsActionsMod.SignOutAction
    - typingsJapgolly.reactAuthKit.distUtilsActionsMod.RefreshTokenAction
  */
  trait AuthActions extends StObject
  object AuthActions {
    
    inline def RefreshTokenAction(payload: RefreshTokenActionPayload, `type`: RefreshToken): typingsJapgolly.reactAuthKit.distUtilsActionsMod.RefreshTokenAction = {
      val __obj = js.Dynamic.literal(payload = payload.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reactAuthKit.distUtilsActionsMod.RefreshTokenAction]
    }
    
    inline def SignInAction(payload: SignInActionPayload, `type`: SignIn): typingsJapgolly.reactAuthKit.distUtilsActionsMod.SignInAction = {
      val __obj = js.Dynamic.literal(payload = payload.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reactAuthKit.distUtilsActionsMod.SignInAction]
    }
    
    inline def SignOutAction(`type`: SignOut): typingsJapgolly.reactAuthKit.distUtilsActionsMod.SignOutAction = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reactAuthKit.distUtilsActionsMod.SignOutAction]
    }
  }
