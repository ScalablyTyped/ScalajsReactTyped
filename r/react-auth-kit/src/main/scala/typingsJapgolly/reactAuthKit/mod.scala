...
import typingsJapgolly.reactAuthKit.distHigherOrderComponentsWithAuthHeaderMod.withAuthHeaderProps
import typingsJapgolly.reactAuthKit.distHigherOrderComponentsWithAuthUserMod.withAuthProps
import typingsJapgolly.reactAuthKit.distHigherOrderComponentsWithSignInMod.withSignInProps
import typingsJapgolly.reactAuthKit.distHigherOrderComponentsWithSignOutMod.withSignOutProps
...
object mod {
  ...
  /**
    ...
    * @param Component
    */
  inline def withIsAuthenticated[P /* <: typingsJapgolly.reactAuthKit.distHigherOrderComponentsWithIsAuthenticatedMod.withAuthHeaderProps */](Component: ComponentType[P]): FunctionComponent[P] = ^.asInstanceOf[js.Dynamic].applyDynamic("withIsAuthenticated")(Component.asInstanceOf[js.Any]).asInstanceOf[FunctionComponent[P]]
