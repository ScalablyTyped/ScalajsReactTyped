...
import typingsJapgolly.reactAuthKit.anon.AuthToken
...
import typingsJapgolly.reactAuthKit.reactAuthKitStrings.Bearer
...
object distTypesMod {
  ...
  object AuthContextInterface {
    ...
    inline def apply(authState: AuthKitStateInterface, dispatch: AuthActions => Callback): AuthContextInterface = {
      val __obj = js.Dynamic.literal(authState = authState.asInstanceOf[js.Any], dispatch = js.Any.fromFunction1((t0: AuthActions) => dispatch(t0).runNow()))
    ...
    extension [Self <: AuthContextInterface](x: Self) {
      ...
      inline def setDispatch(value: AuthActions => Callback): Self = StObject.set(x, "dispatch", js.Any.fromFunction1((t0: AuthActions) => value(t0).runNow()))
    }
  }
  ...
  object AuthProviderProps {
    ...
    inline def apply(authName: String, authType: cookie | localstorage): AuthProviderProps = {
      val __obj = js.Dynamic.literal(authName = authName.asInstanceOf[js.Any], authType = authType.asInstanceOf[js.Any], children = null)
