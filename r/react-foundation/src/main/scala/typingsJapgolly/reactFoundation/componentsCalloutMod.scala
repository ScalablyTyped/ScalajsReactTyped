...
object componentsCalloutMod {
  ...
  object CalloutProps {
    ...
    extension [Self <: CalloutProps](x: Self) {
      ...
      inline def setColor(value: CalloutColors | String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      ...
      inline def setSize(value: CalloutSizes): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
