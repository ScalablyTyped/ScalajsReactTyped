...
object MediaObjectSection {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def alignment(value: HorizontalAlignments): this.type = set("alignment", value.asInstanceOf[js.Any])
    ...
    inline def isBottom(value: Boolean): this.type = set("isBottom", value.asInstanceOf[js.Any])
    ...
    inline def isMain(value: Boolean): this.type = set("isMain", value.asInstanceOf[js.Any])
    
    inline def isMiddle(value: Boolean): this.type = set("isMiddle", value.asInstanceOf[js.Any])
