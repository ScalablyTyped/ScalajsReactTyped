...
object ButtonGroup {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: ButtonGroupColors | String): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def isStacked(value: Boolean): this.type = set("isStacked", value.asInstanceOf[js.Any])
    ...
    inline def size(value: ButtonGroupSizes): this.type = set("size", value.asInstanceOf[js.Any])
    
    inline def slot(value: String): this.type = set("slot", value.asInstanceOf[js.Any])
    
    inline def spellCheck(value: Booleanish): this.type = set("spellCheck", value.asInstanceOf[js.Any])
    
    inline def stackFor(value: Breakpoints): this.type = set("stackFor", value.asInstanceOf[js.Any])
