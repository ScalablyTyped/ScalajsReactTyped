...
import typingsJapgolly.reactFoundation.componentsSliderMod.SliderProps
...
object Slider {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactFoundation.mod.Slider] {
    ...
    inline def handle(value: SliderHandleProps): this.type = set("handle", value.asInstanceOf[js.Any])
