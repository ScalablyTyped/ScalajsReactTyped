...
object ProgressMeter {
  ...
  implicit def make(companion: ProgressMeter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ProgressMeterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
