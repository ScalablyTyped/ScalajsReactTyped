...
object Link {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: ButtonColors | String): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def isArrowOnly(value: Boolean): this.type = set("isArrowOnly", value.asInstanceOf[js.Any])
    ...
    inline def isHollow(value: Boolean): this.type = set("isHollow", value.asInstanceOf[js.Any])
    ...
    inline def size(value: ButtonSizes): this.type = set("size", value.asInstanceOf[js.Any])
