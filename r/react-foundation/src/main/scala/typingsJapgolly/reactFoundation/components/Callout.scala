...
import typingsJapgolly.reactFoundation.enumsMod.CalloutColors
import typingsJapgolly.reactFoundation.enumsMod.CalloutSizes
...
object Callout {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: CalloutColors | String): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def size(value: CalloutSizes): this.type = set("size", value.asInstanceOf[js.Any])
