...
import typingsJapgolly.reactFoundation.componentsResponsiveMod.ResponsiveNavigationProps
...
object ResponsiveNavigation {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactFoundation.mod.ResponsiveNavigation] {
    ...
    inline def menuIcon(value: MenuIconProps): this.type = set("menuIcon", value.asInstanceOf[js.Any])
    ...
    inline def titleBar(value: TitleBarProps): this.type = set("titleBar", value.asInstanceOf[js.Any])
    
    inline def titleBarTitle(value: TitleBarTitleProps): this.type = set("titleBarTitle", value.asInstanceOf[js.Any])
    
    inline def topBar(value: TopBarProps): this.type = set("topBar", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ResponsiveNavigation.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ResponsiveNavigationProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
