...
object FlexVideo {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def isVimeo(value: Boolean): this.type = set("isVimeo", value.asInstanceOf[js.Any])
    
    inline def isWidescreen(value: Boolean): this.type = set("isWidescreen", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: FlexVideo.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlexVideoProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
