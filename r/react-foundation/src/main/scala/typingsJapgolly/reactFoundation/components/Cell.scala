...
object Cell {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def auto(value: ExtendedBreakpoints): this.type = set("auto", value.asInstanceOf[js.Any])
    ...
    inline def shrink(value: ExtendedBreakpoints): this.type = set("shrink", value.asInstanceOf[js.Any])
