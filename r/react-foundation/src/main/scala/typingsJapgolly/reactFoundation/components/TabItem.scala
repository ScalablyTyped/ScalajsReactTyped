...
object TabItem {
  ...
  implicit def make(companion: TabItem.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TabItemProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
