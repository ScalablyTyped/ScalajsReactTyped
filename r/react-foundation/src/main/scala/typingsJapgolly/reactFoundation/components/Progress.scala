...
import typingsJapgolly.reactFoundation.componentsProgressBarMod.PaginationProps
...
object Progress {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def meter(value: ProgressMeterWithTextProps): this.type = set("meter", value.asInstanceOf[js.Any])
