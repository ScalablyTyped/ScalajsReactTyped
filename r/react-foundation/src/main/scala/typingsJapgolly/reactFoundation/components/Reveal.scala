...
import typingsJapgolly.reactFoundation.componentsRevealMod.PaginationProps
...
object Reveal {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def isLarge(value: Boolean): this.type = set("isLarge", value.asInstanceOf[js.Any])
    
    inline def isSmall(value: Boolean): this.type = set("isSmall", value.asInstanceOf[js.Any])
    
    inline def isTiny(value: Boolean): this.type = set("isTiny", value.asInstanceOf[js.Any])
