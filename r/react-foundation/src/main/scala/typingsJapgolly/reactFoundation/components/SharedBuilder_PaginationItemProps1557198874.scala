...
@scala.inline
open class SharedBuilder_PaginationItemProps1557198874 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def isCurrent(value: Boolean): this.type = set("isCurrent", value.asInstanceOf[js.Any])
