...
object Thumbnail {
  ...
  implicit def make(companion: Thumbnail.type): SharedBuilder_ThumbnailProps936810432 = new SharedBuilder_ThumbnailProps936810432(js.Array(this.component, js.Dictionary.empty))()
