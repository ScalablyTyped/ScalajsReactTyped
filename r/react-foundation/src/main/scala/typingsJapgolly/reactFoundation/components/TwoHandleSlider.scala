...
import typingsJapgolly.reactFoundation.componentsSliderMod.TwoHandleSliderProps
...
object TwoHandleSlider {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactFoundation.mod.TwoHandleSlider] {
    ...
    inline def fill(value: SliderFillProps): this.type = set("fill", value.asInstanceOf[js.Any])
    
    inline def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    
    inline def id(value: String): this.type = set("id", value.asInstanceOf[js.Any])
    
    inline def initialEnd(value: Double): this.type = set("initialEnd", value.asInstanceOf[js.Any])
    
    inline def initialStart(value: Double): this.type = set("initialStart", value.asInstanceOf[js.Any])
    ...
    inline def maxHandle(value: SliderHandleProps): this.type = set("maxHandle", value.asInstanceOf[js.Any])
    
    inline def minHandle(value: SliderHandleProps): this.type = set("minHandle", value.asInstanceOf[js.Any])
