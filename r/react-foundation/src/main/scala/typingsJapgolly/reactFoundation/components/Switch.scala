...
import typingsJapgolly.reactFoundation.enumsMod.SwitchSizes
...
object Switch {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def active(value: SwitchActiveProps): this.type = set("active", value.asInstanceOf[js.Any])
    ...
    inline def inactive(value: SwitchInactiveProps): this.type = set("inactive", value.asInstanceOf[js.Any])
    
    inline def inlist(value: Any): this.type = set("inlist", value.asInstanceOf[js.Any])
    
    inline def input(value: SwitchInputProps): this.type = set("input", value.asInstanceOf[js.Any])
    ...
    inline def paddle(value: SwitchPaddleProps): this.type = set("paddle", value.asInstanceOf[js.Any])
    ...
    inline def size(value: SwitchSizes): this.type = set("size", value.asInstanceOf[js.Any])
