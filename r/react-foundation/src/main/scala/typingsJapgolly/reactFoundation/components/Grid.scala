...
import typingsJapgolly.reactFoundation.enumsMod.GutterTypes
...
object Grid {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def collapseOnLarge(value: GutterTypes): this.type = set("collapseOnLarge", value.asInstanceOf[js.Any])
    
    inline def collapseOnMedium(value: GutterTypes): this.type = set("collapseOnMedium", value.asInstanceOf[js.Any])
    
    inline def collapseOnSmall(value: GutterTypes): this.type = set("collapseOnSmall", value.asInstanceOf[js.Any])
    ...
    inline def gridFrame(value: ExtendedBreakpoints): this.type = set("gridFrame", value.asInstanceOf[js.Any])
    
    inline def gutters(value: GutterTypes): this.type = set("gutters", value.asInstanceOf[js.Any])
