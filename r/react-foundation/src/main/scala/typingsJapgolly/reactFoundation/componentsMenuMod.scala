...
object componentsMenuMod {
  ...
  object MenuProps {
    ...
    extension [Self <: MenuProps](x: Self) {
      ...
      inline def setAlignment(value: MenuAlignments): Self = StObject.set(x, "alignment", value.asInstanceOf[js.Any])
      ...
      inline def setHorizontalOnMedium(value: Boolean): Self = StObject.set(x, "horizontalOnMedium", value.asInstanceOf[js.Any])
      
      inline def setHorizontalOnMediumUndefined: Self = StObject.set(x, "horizontalOnMedium", js.undefined)
      
      inline def setIconsOnTop(value: Boolean): Self = StObject.set(x, "iconsOnTop", value.asInstanceOf[js.Any])
      
      inline def setIconsOnTopUndefined: Self = StObject.set(x, "iconsOnTop", js.undefined)
      ...
      inline def setIsDropdown(value: Boolean): Self = StObject.set(x, "isDropdown", value.asInstanceOf[js.Any])
      
      inline def setIsDropdownUndefined: Self = StObject.set(x, "isDropdown", js.undefined)
      ...
      inline def setIsSimpleUndefined: Self = StObject.set(x, "isSimple", js.undefined)
