...
object componentsCloseButtonMod {
  ...
  - typingsJapgolly.react.mod.ButtonHTMLAttributes because var conflicts: className. Inlined formAction, formEncType, form, value, name, disabled, formMethod, formTarget, autoFocus, `type`, formNoValidate */ trait CloseButtonProps
    extends StObject
