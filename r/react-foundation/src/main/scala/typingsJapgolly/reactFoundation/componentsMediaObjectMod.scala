...
object componentsMediaObjectMod {
  ...
  object MediaObjectProps {
    ...
    inline def apply(): MediaObjectProps = {
    ...
    extension [Self <: MediaObjectProps](x: Self) {
      ...
      inline def setStackForSmall(value: Boolean): Self = StObject.set(x, "stackForSmall", value.asInstanceOf[js.Any])
      
      inline def setStackForSmallUndefined: Self = StObject.set(x, "stackForSmall", js.undefined)
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results */ trait MediaObjectSectionProps
    extends StObject
       with FlexboxPropTypes
       with AriaAttributes
       with DOMAttributes[HTMLDivElement] {
    ...
    var alignment: js.UndefOr[HorizontalAlignments] = js.undefined
    ...
    var isBottom: js.UndefOr[Boolean] = js.undefined
    
    var isMain: js.UndefOr[Boolean] = js.undefined
    
    var isMiddle: js.UndefOr[Boolean] = js.undefined
  ...
  object MediaObjectSectionProps {
    ...
    inline def apply(): MediaObjectSectionProps = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: MediaObjectSectionProps](x: Self) {
      ...
      inline def setAlignment(value: HorizontalAlignments): Self = StObject.set(x, "alignment", value.asInstanceOf[js.Any])
      ...
      inline def setIsBottom(value: Boolean): Self = StObject.set(x, "isBottom", value.asInstanceOf[js.Any])
      
      inline def setIsBottomUndefined: Self = StObject.set(x, "isBottom", js.undefined)
      
      inline def setIsMain(value: Boolean): Self = StObject.set(x, "isMain", value.asInstanceOf[js.Any])
      
      inline def setIsMainUndefined: Self = StObject.set(x, "isMain", js.undefined)
      
      inline def setIsMiddle(value: Boolean): Self = StObject.set(x, "isMiddle", value.asInstanceOf[js.Any])
      
      inline def setIsMiddleUndefined: Self = StObject.set(x, "isMiddle", js.undefined)
