...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.reactFoundation.reactFoundationStrings.auto
  - typingsJapgolly.reactFoundation.reactFoundationStrings.grow
  - typingsJapgolly.reactFoundation.reactFoundationStrings.shrink
*/
