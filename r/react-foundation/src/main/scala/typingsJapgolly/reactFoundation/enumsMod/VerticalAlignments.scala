...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.reactFoundation.reactFoundationStrings.top
  - typingsJapgolly.reactFoundation.reactFoundationStrings.middle
  - typingsJapgolly.reactFoundation.reactFoundationStrings.bottom
  - typingsJapgolly.reactFoundation.reactFoundationStrings.stretch
*/
