...
object componentsXyGridMod {
  ...
  object CellProps {
    ...
    extension [Self <: CellProps](x: Self) {
      ...
      inline def setAuto(value: ExtendedBreakpoints): Self = StObject.set(x, "auto", value.asInstanceOf[js.Any])
      ...
      inline def setShrink(value: ExtendedBreakpoints): Self = StObject.set(x, "shrink", value.asInstanceOf[js.Any])
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results */ trait GridContainerProps
    extends StObject
       with FlexboxPropTypes
       with AriaAttributes
       with DOMAttributes[HTMLDivElement] {
  ...
  object GridContainerProps {
    ...
    inline def apply(): GridContainerProps = {
      val __obj = js.Dynamic.literal()
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results */ trait GridProps
    extends StObject
       with FlexboxPropTypes
       with AriaAttributes
       with DOMAttributes[HTMLDivElement] {
  ...
  object GridProps {
    ...
    extension [Self <: GridProps](x: Self) {
      ...
      inline def setCollapseOnLarge(value: GutterTypes): Self = StObject.set(x, "collapseOnLarge", value.asInstanceOf[js.Any])
      
      inline def setCollapseOnLargeUndefined: Self = StObject.set(x, "collapseOnLarge", js.undefined)
      
      inline def setCollapseOnMedium(value: GutterTypes): Self = StObject.set(x, "collapseOnMedium", value.asInstanceOf[js.Any])
      
      inline def setCollapseOnMediumUndefined: Self = StObject.set(x, "collapseOnMedium", js.undefined)
      
      inline def setCollapseOnSmall(value: GutterTypes): Self = StObject.set(x, "collapseOnSmall", value.asInstanceOf[js.Any])
      ...
      inline def setGridFrame(value: ExtendedBreakpoints): Self = StObject.set(x, "gridFrame", value.asInstanceOf[js.Any])
      
      inline def setGridFrameUndefined: Self = StObject.set(x, "gridFrame", js.undefined)
      
      inline def setGutters(value: GutterTypes): Self = StObject.set(x, "gutters", value.asInstanceOf[js.Any])
