...
import typingsJapgolly.reactFoundation.utilsMod.GeneralPropTypes
...
object componentsSwitchMod {
  ...
  object SwitchActiveProps {
    ...
    inline def apply(): SwitchActiveProps = {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results */ trait SwitchInactiveProps
    extends StObject
       with GeneralPropTypes
       with AriaAttributes
       with DOMAttributes[HTMLSpanElement] {
  ...
  object SwitchInactiveProps {
    ...
    inline def apply(): SwitchInactiveProps = {
      val __obj = js.Dynamic.literal()
  ...
  - typingsJapgolly.react.mod.InputHTMLAttributes because var conflicts: className. Inlined formAction, alt, src, max, required, multiple, height, enterKeyHint, min, capture, size, maxLength, formEncType, pattern, form, accept, step, value, minLength, readOnly, name, disabled, formMethod, width, formTarget, autoFocus, crossOrigin, `type`, checked, onChange_InputHTMLAttributes, formNoValidate, list, autoComplete */ trait SwitchInputProps
    extends StObject
       with GeneralPropTypes
       with AriaAttributes
    ...
    var `type`: js.UndefOr[HTMLInputTypeAttribute | SwitchInputTypes] = js.undefined
  ...
  object SwitchInputProps {
    ...
    inline def apply(): SwitchInputProps = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: SwitchInputProps](x: Self) {
      ...
      inline def setType(value: HTMLInputTypeAttribute | SwitchInputTypes): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results
  - typingsJapgolly.react.mod.LabelHTMLAttributes because var conflicts: className. Inlined form, htmlFor */ trait SwitchPaddleProps
    extends StObject
       with GeneralPropTypes
       with AriaAttributes
       with DOMAttributes[HTMLLabelElement] {
  ...
  object SwitchPaddleProps {
    ...
    inline def apply(): SwitchPaddleProps = {
      val __obj = js.Dynamic.literal()
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results */ trait SwitchProps
    extends StObject
  ...
  object SwitchProps {
    ...
    extension [Self <: SwitchProps](x: Self) {
      ...
      inline def setActive(value: SwitchActiveProps): Self = StObject.set(x, "active", value.asInstanceOf[js.Any])
      ...
      inline def setInactive(value: SwitchInactiveProps): Self = StObject.set(x, "inactive", value.asInstanceOf[js.Any])
      ...
      inline def setInput(value: SwitchInputProps): Self = StObject.set(x, "input", value.asInstanceOf[js.Any])
      ...
      inline def setPaddle(value: SwitchPaddleProps): Self = StObject.set(x, "paddle", value.asInstanceOf[js.Any])
      
      inline def setPaddleUndefined: Self = StObject.set(x, "paddle", js.undefined)
      ...
      inline def setSize(value: SwitchSizes): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
