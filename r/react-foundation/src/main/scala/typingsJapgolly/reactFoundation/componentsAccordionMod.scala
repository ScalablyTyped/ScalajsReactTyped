...
object componentsAccordionMod {
  ...
  object AccordianContentProps {
    ...
    inline def apply(): AccordianContentProps = {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results */ trait AccordianItemProps
    extends StObject
       with FlexboxPropTypes
       with AriaAttributes
  ...
  object AccordianItemProps {
    ...
    inline def apply(): AccordianItemProps = {
      val __obj = js.Dynamic.literal()
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results */ trait AccordianProps
    extends StObject
       with FlexboxPropTypes
       with AriaAttributes
  ...
  object AccordianProps {
    ...
    inline def apply(): AccordianProps = {
      val __obj = js.Dynamic.literal()
  ...
  - typingsJapgolly.react.mod.AnchorHTMLAttributes because var conflicts: className. Inlined target, media, rel, ping, referrerPolicy, href, download, `type`, hrefLang */ trait AccordionTitleProps
    extends StObject
       with FlexboxPropTypes
       with AriaAttributes
