...
object componentsThumbnailMod {
  ...
  - typingsJapgolly.react.mod.ImgHTMLAttributes because var conflicts: className. Inlined alt, src, sizes, height, useMap, loading, referrerPolicy, width, decoding, crossOrigin, srcSet */ trait ThumbnailProps
    extends StObject
