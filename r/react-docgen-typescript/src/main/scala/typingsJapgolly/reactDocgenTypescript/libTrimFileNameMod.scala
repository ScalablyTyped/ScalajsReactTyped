...
import typingsJapgolly.reactDocgenTypescript.reactDocgenTypescriptStrings.posix
import typingsJapgolly.reactDocgenTypescript.reactDocgenTypescriptStrings.win32
