...
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.`Close the modal by clicking here`
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.`You just opened the modal video`
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.`modal-video-body`
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.`modal-video-close-btn`
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.`modal-video-close`
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.`modal-video-effect`
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.`modal-video-inner`
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.`modal-video-movie-wrap`
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.`modal-video`
