package typingsJapgolly.reactModalVideo

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.react.mod.Component
import typingsJapgolly.reactModalVideo.anon.DismissBtnMessage
import typingsJapgolly.reactModalVideo.reactModalVideoBooleans.`false`
import typingsJapgolly.reactModalVideo.reactModalVideoBooleans.`true`
import typingsJapgolly.reactModalVideo.reactModalVideoInts.`0`
import typingsJapgolly.reactModalVideo.reactModalVideoInts.`1`
import typingsJapgolly.reactModalVideo.reactModalVideoInts.`300`
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.`16Colon9`
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.`red Verticalline white`
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.custom
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.playlist
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.user_uploads
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.vimeo
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.youku
import typingsJapgolly.reactModalVideo.reactModalVideoStrings.youtube
...
object mod {
  ...
  object default {
    ...
    object defaultProps {
      ...
      @js.native
      def classNames: typingsJapgolly.reactModalVideo.anon.ModalVideo = js.native
      inline def classNames_=(x: typingsJapgolly.reactModalVideo.anon.ModalVideo): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("classNames")(x.asInstanceOf[js.Any])
  ...
  type ModalVideo = japgolly.scalajs.react.facade.React.Component[ModalVideoProps & js.Object, js.Object]
