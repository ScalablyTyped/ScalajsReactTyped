...
import typingsJapgolly.reduxDoghouse.anon.FnCall
import typingsJapgolly.reduxDoghouse.mod.ActionFactoriesMap
...
object global {
  ...
  object ReduxDoghouse {
    ...
    open class ScopedActionFactory[A /* <: ActionCreator[Any] | ActionCreatorsMapObject[Any] */] protected ()
      extends typingsJapgolly.reduxDoghouse.mod.ScopedActionFactory[A] {
    ...
    inline def bindActionCreatorsDeep_AFS_F[A /* <: ActionCreator[Any] | ActionCreatorsMapObject[Any] */, F /* <: typingsJapgolly.reduxDoghouse.mod.ScopedActionFactory[A] */, S](actionFactories: F, dispatch: Dispatch[S]): F = (^.asInstanceOf[js.Dynamic].applyDynamic("bindActionCreatorsDeep")(actionFactories.asInstanceOf[js.Any], dispatch.asInstanceOf[js.Any])).asInstanceOf[F]
    ...
    inline def bindScopedActionFactories_AFS_F[A /* <: ActionCreator[Any] | ActionCreatorsMapObject[Any] */, F /* <: typingsJapgolly.reduxDoghouse.mod.ScopedActionFactory[A] */, S](actionFactories: F, dispatch: Dispatch[S], bindFn: FnCall): F = (^.asInstanceOf[js.Dynamic].applyDynamic("bindScopedActionFactories")(actionFactories.asInstanceOf[js.Any], dispatch.asInstanceOf[js.Any], bindFn.asInstanceOf[js.Any])).asInstanceOf[F]
