...
import typingsJapgolly.reactChartjs2.mod.LinearComponentProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_LinearComponentProps379116933[ComponentRef] () {
  val componentImport: js.Any
  def apply(
    data: typingsJapgolly.reactChartjs2.mod.ChartData[ChartData],
    ...
    children: ChildArg*
  ): UnmountedWithRoot[LinearComponentProps, ComponentRef, Unit, LinearComponentProps] = {
  ...
  typingsJapgolly.reactChartjs2.mod.LinearComponentProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactChartjs2.mod.LinearComponentProps])(children: _*)
  }
}
