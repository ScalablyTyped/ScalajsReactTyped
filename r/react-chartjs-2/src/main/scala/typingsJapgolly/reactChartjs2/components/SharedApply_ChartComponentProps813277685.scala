...
import typingsJapgolly.reactChartjs2.mod.ChartComponentProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_ChartComponentProps813277685[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ChartComponentProps, ComponentRef, Unit, ChartComponentProps] = {
  ...
  typingsJapgolly.reactChartjs2.mod.ChartComponentProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactChartjs2.mod.ChartComponentProps])(children: _*)
  }
}
