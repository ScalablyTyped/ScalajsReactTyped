...
object Online {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactDetectOffline.mod.Online] {
  ...
  implicit def make(companion: Online.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
