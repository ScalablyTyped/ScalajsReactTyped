...
abstract class SharedApply_PlatformTouchableProps1927850804[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PlatformTouchableProps, ComponentRef, Unit, PlatformTouchableProps] = {
  ...
  typingsJapgolly.reactNativePlatformTouchable.mod.PlatformTouchableProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativePlatformTouchable.mod.PlatformTouchableProps])(children: _*)
  }
}
