...
@scala.inline
open class SharedBuilder_PlatformTouchableProps_1066354137[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def foreground(value: BackgroundPropType): this.type = set("foreground", value.asInstanceOf[js.Any])
