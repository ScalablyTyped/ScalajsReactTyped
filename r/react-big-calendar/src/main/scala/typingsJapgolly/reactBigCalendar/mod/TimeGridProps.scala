...
object TimeGridProps {
  ...
  extension [Self <: TimeGridProps[?, ?], TEvent /* <: js.Object */, TResource /* <: js.Object */](x: Self & (TimeGridProps[TEvent, TResource])) {
    ...
    inline def setGetNow(value: CallbackTo[js.Date]): Self = StObject.set(x, "getNow", value.toJsFn)
    ...
    inline def setOnNavigate(value: /* action */ NavigateAction => Callback): Self = StObject.set(x, "onNavigate", js.Any.fromFunction1((t0: /* action */ NavigateAction) => value(t0).runNow()))
