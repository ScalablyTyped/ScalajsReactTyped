...
trait ViewProps[TEvent /* <: js.Object */, TResource /* <: js.Object */] extends StObject {
  ...
  var onDoubleClickEvent: (js.UndefOr[js.Function2[/* event */ TEvent, /* e */ ReactEventFrom[HTMLElement], Unit]]) & Any
  ...
  var onSelectEvent: (js.UndefOr[js.Function2[/* event */ TEvent, /* e */ ReactEventFrom[HTMLElement], Unit]]) & Any
...
object ViewProps {
  ...
  inline def apply[TEvent /* <: js.Object */, TResource /* <: js.Object */](
    ...
    onDoubleClickEvent: (js.UndefOr[js.Function2[/* event */ TEvent, /* e */ ReactEventFrom[HTMLElement], Unit]]) & Any,
    onDrillDown: (js.UndefOr[js.Function2[/* date */ js.Date, /* view */ View, Unit]]) & Any,
    onNavigate: (js.UndefOr[
      js.Function3[/* newDate */ js.Date, /* view */ View, /* action */ NavigateAction, Unit]
    ]) & Any,
    onSelectEvent: (js.UndefOr[js.Function2[/* event */ TEvent, /* e */ ReactEventFrom[HTMLElement], Unit]]) & Any,
  ...
  extension [Self <: ViewProps[?, ?], TEvent /* <: js.Object */, TResource /* <: js.Object */](x: Self & (ViewProps[TEvent, TResource])) {
    ...
    inline def setOnDoubleClickEvent(
      value: (js.UndefOr[js.Function2[/* event */ TEvent, /* e */ ReactEventFrom[HTMLElement], Unit]]) & Any
