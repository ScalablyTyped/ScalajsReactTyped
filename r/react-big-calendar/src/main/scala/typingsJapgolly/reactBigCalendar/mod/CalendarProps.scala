...
trait CalendarProps[TEvent /* <: js.Object */, TResource /* <: js.Object */] extends StObject {
  ...
  var onKeyPressEvent: js.UndefOr[js.Function2[/* event */ TEvent, /* e */ ReactEventFrom[HTMLElement], Unit]] = js.undefined
...
object CalendarProps {
  ...
  extension [Self <: CalendarProps[?, ?], TEvent /* <: js.Object */, TResource /* <: js.Object */](x: Self & (CalendarProps[TEvent, TResource])) {
    ...
    ): Self = StObject.set(x, "getDrilldownView", js.Any.fromFunction3((t0: /* targetDate */ js.Date, t1: /* currentViewName */ View, t2: /* configuredViewNames */ js.Array[View]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setGetNow(value: CallbackTo[js.UndefOr[stringOrDate]]): Self = StObject.set(x, "getNow", value.toJsFn)
    
    inline def setGetNowUndefined: Self = StObject.set(x, "getNow", js.undefined)
    
    inline def setHandleDragStart(value: /* event */ TEvent => Callback): Self = StObject.set(x, "handleDragStart", js.Any.fromFunction1((t0: /* event */ TEvent) => value(t0).runNow()))
    ...
    inline def setOnDoubleClickEvent(value: (/* event */ TEvent, /* e */ ReactEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onDoubleClickEvent", js.Any.fromFunction2((t0: /* event */ TEvent, t1: /* e */ ReactEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnDoubleClickEventUndefined: Self = StObject.set(x, "onDoubleClickEvent", js.undefined)
    
    inline def setOnDrillDown(value: (/* date */ js.Date, /* view */ View) => Callback): Self = StObject.set(x, "onDrillDown", js.Any.fromFunction2((t0: /* date */ js.Date, t1: /* view */ View) => (value(t0, t1)).runNow()))
    
    inline def setOnDrillDownUndefined: Self = StObject.set(x, "onDrillDown", js.undefined)
    
    inline def setOnKeyPressEvent(value: (/* event */ TEvent, /* e */ ReactEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onKeyPressEvent", js.Any.fromFunction2((t0: /* event */ TEvent, t1: /* e */ ReactEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnKeyPressEventUndefined: Self = StObject.set(x, "onKeyPressEvent", js.undefined)
    
    inline def setOnNavigate(value: (/* newDate */ js.Date, /* view */ View, /* action */ NavigateAction) => Callback): Self = StObject.set(x, "onNavigate", js.Any.fromFunction3((t0: /* newDate */ js.Date, t1: /* view */ View, t2: /* action */ NavigateAction) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setOnSelectEvent(value: (/* event */ TEvent, /* e */ ReactEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onSelectEvent", js.Any.fromFunction2((t0: /* event */ TEvent, t1: /* e */ ReactEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnSelectEventUndefined: Self = StObject.set(x, "onSelectEvent", js.undefined)
    
    inline def setOnSelectSlot(value: /* slotInfo */ SlotInfo => Callback): Self = StObject.set(x, "onSelectSlot", js.Any.fromFunction1((t0: /* slotInfo */ SlotInfo) => value(t0).runNow()))
    ...
    inline def setOnShowMore(value: (/* events */ js.Array[TEvent], /* date */ js.Date) => Callback): Self = StObject.set(x, "onShowMore", js.Any.fromFunction2((t0: /* events */ js.Array[TEvent], t1: /* date */ js.Date) => (value(t0, t1)).runNow()))
    
    inline def setOnShowMoreUndefined: Self = StObject.set(x, "onShowMore", js.undefined)
    
    inline def setOnView(value: /* view */ View => Callback): Self = StObject.set(x, "onView", js.Any.fromFunction1((t0: /* view */ View) => value(t0).runNow()))
    ...
    inline def setRefFunction1(value: (Calendar[TEvent, TResource]) | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: (Calendar[TEvent, TResource]) | Null) => value(t0).runNow()))
    ...
    inline def setSlotGroupPropGetter(value: CallbackTo[HTMLAttributes[HTMLDivElement]]): Self = StObject.set(x, "slotGroupPropGetter", value.toJsFn)
