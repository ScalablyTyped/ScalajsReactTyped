...
object ViewStatic {
  ...
  def apply(
    ...
    __obj.updateDynamic("navigate")(js.Any.fromFunction3((t0: js.Date, t1: typingsJapgolly.reactDashBigDashCalendar.reactDashBigDashCalendarMod.NavigateAction, t2: js.Any) => navigate(t0, t1, t2).runNow()))
    __obj.updateDynamic("title")(js.Any.fromFunction2((t0: js.Date, t1: typingsJapgolly.reactDashBigDashCalendar.reactDashBigDashCalendarMod.TitleOptions) => title(t0, t1).runNow()))
