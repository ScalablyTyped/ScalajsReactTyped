...
object Messages {
  ...
  def apply(
    ...
    showMore: /* count */ Double => CallbackTo[String] = null,
    time: String = null,
    today: String = null,
    ...
    if (showMore != null) __obj.updateDynamic("showMore")(js.Any.fromFunction1((t0: /* count */ scala.Double) => showMore(t0).runNow()))
