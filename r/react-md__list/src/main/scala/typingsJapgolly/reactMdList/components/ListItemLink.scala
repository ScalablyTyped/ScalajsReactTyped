...
object ListItemLink {
  ...
  object ListItemLinkPropsRefAttributes {
    ...
    def withProps(p: ListItemLinkProps & (RefAttributes[HTMLAnchorElement | ElementType])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object PickListItemLinkWithCompo {
    ...
    inline def apply(component: ElementType): Builder = {
      ...
      new Builder(js.Array(this.component, __props.asInstanceOf[typingsJapgolly.reactMdList.anon.PickListItemLinkWithCompo]))
    }
    ...
    def withProps(p: typingsJapgolly.reactMdList.anon.PickListItemLinkWithCompo): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
