...
import typingsJapgolly.reactNativeImageGallery.anon.Uri
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.`box-none`
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.`box-only`
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.`no-hide-descendants`
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.`on-drag`
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.always
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.assertive
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.auto
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.automatic
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.black
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.center
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.end
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.fast
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.handled
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.interactive
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.never
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.no
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.none
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.normal
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.polite
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.scrollableAxes
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.start
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.white
import typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.yes
...
object mod {
  ...
  object ScrollState extends StObject {
    ...
    sealed trait DRAGGING
      extends StObject
         with ScrollState
    /* "dragging" */ val DRAGGING: typingsJapgolly.reactNativeImageGallery.mod.ScrollState.DRAGGING & String = js.native
    
    @js.native
    sealed trait IDLE
      extends StObject
         with ScrollState
    /* "idle" */ val IDLE: typingsJapgolly.reactNativeImageGallery.mod.ScrollState.IDLE & String = js.native
    
    @js.native
    sealed trait SETTLING
      extends StObject
         with ScrollState
    /* "settling" */ val SETTLING: typingsJapgolly.reactNativeImageGallery.mod.ScrollState.SETTLING & String = js.native
  }
  ...
  trait FlatListProps extends StObject {
    ...
    var indicatorStyle: js.UndefOr[
        typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.default | black | white
      ] = js.undefined
  ...
  object FlatListProps {
    ...
    extension [Self <: FlatListProps](x: Self) {
      ...
      inline def setIndicatorStyle(
        value: typingsJapgolly.reactNativeImageGallery.reactNativeImageGalleryStrings.default | black | white
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNativeImageGallery.mod.LocalImage
    - typingsJapgolly.reactNativeImageGallery.mod.RemoteImage
  */
  trait Image extends StObject
  object Image {
    
    inline def LocalImage(dimensions: ImageDimensions, source: Double): typingsJapgolly.reactNativeImageGallery.mod.LocalImage = {
      val __obj = js.Dynamic.literal(dimensions = dimensions.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reactNativeImageGallery.mod.LocalImage]
    }
    
    inline def RemoteImage(source: Uri): typingsJapgolly.reactNativeImageGallery.mod.RemoteImage = {
      val __obj = js.Dynamic.literal(source = source.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reactNativeImageGallery.mod.RemoteImage]
    }
  }
  ...
  trait Props
    ...
    /**
      ...
      */
    var errorComponent: js.UndefOr[js.Function0[Node]] = js.undefined
    ...
    var imageComponent: js.UndefOr[
        js.Function2[/* imageProps */ ImageProps, /* imageDimensions */ ImageDimensions, Node]
      ] = js.undefined
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setErrorComponent(value: CallbackTo[Node]): Self = StObject.set(x, "errorComponent", value.toJsFn)
      ...
      inline def setImageComponent(value: (/* imageProps */ ImageProps, /* imageDimensions */ ImageDimensions) => Node): Self = StObject.set(x, "imageComponent", js.Any.fromFunction2(value))
      ...
      inline def setOnLongPress(value: /* state */ GestureState => Callback): Self = StObject.set(x, "onLongPress", js.Any.fromFunction1((t0: /* state */ GestureState) => value(t0).runNow()))
      
      inline def setOnLongPressUndefined: Self = StObject.set(x, "onLongPress", js.undefined)
      
      inline def setOnPageScroll(value: /* event */ ScrollEvent => Callback): Self = StObject.set(x, "onPageScroll", js.Any.fromFunction1((t0: /* event */ ScrollEvent) => value(t0).runNow()))
      
      inline def setOnPageScrollStateChanged(value: /* state */ ScrollState => Callback): Self = StObject.set(x, "onPageScrollStateChanged", js.Any.fromFunction1((t0: /* state */ ScrollState) => value(t0).runNow()))
      ...
      inline def setOnPageSelected(value: /* page */ Double => Callback): Self = StObject.set(x, "onPageSelected", js.Any.fromFunction1((t0: /* page */ Double) => value(t0).runNow()))
      
      inline def setOnPageSelectedUndefined: Self = StObject.set(x, "onPageSelected", js.undefined)
      
      inline def setOnSingleTapConfirmed(value: /* page */ Double => Callback): Self = StObject.set(x, "onSingleTapConfirmed", js.Any.fromFunction1((t0: /* page */ Double) => value(t0).runNow()))
