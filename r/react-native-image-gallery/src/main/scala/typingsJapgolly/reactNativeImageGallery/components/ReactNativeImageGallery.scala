package typingsJapgolly.reactNativeImageGallery.components
...
import typingsJapgolly.reactNativeImageGallery.mod.FlatListProps
import typingsJapgolly.reactNativeImageGallery.mod.GestureState
import typingsJapgolly.reactNativeImageGallery.mod.Image
import typingsJapgolly.reactNativeImageGallery.mod.ImageDimensions
import typingsJapgolly.reactNativeImageGallery.mod.Props
import typingsJapgolly.reactNativeImageGallery.mod.ScrollEvent
import typingsJapgolly.reactNativeImageGallery.mod.ScrollState
import typingsJapgolly.reactNativeImageGallery.mod.default
...
object ReactNativeImageGallery {
  ...
  inline def apply(images: js.Array[Image]): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def errorComponent(value: CallbackTo[Node]): this.type = set("errorComponent", value.toJsFn)
    
    inline def flatListProps(value: FlatListProps): this.type = set("flatListProps", value.asInstanceOf[js.Any])
    ...
    inline def imageComponent(value: (/* imageProps */ ImageProps, /* imageDimensions */ ImageDimensions) => Node): this.type = set("imageComponent", js.Any.fromFunction2(value))
    ...
    inline def onLongPress(value: /* state */ GestureState => Callback): this.type = set("onLongPress", js.Any.fromFunction1((t0: /* state */ GestureState) => value(t0).runNow()))
    ...
    inline def onPageScroll(value: /* event */ ScrollEvent => Callback): this.type = set("onPageScroll", js.Any.fromFunction1((t0: /* event */ ScrollEvent) => value(t0).runNow()))
    
    inline def onPageScrollStateChanged(value: /* state */ ScrollState => Callback): this.type = set("onPageScrollStateChanged", js.Any.fromFunction1((t0: /* state */ ScrollState) => value(t0).runNow()))
    
    inline def onPageSelected(value: /* page */ Double => Callback): this.type = set("onPageSelected", js.Any.fromFunction1((t0: /* page */ Double) => value(t0).runNow()))
    ...
    inline def onSingleTapConfirmed(value: /* page */ Double => Callback): this.type = set("onSingleTapConfirmed", js.Any.fromFunction1((t0: /* page */ Double) => value(t0).runNow()))
    ...
    inline def scrollViewStyle(value: StyleProp[ViewStyle]): this.type = set("scrollViewStyle", value.asInstanceOf[js.Any])
    
    inline def scrollViewStyleNull: this.type = set("scrollViewStyle", null)
