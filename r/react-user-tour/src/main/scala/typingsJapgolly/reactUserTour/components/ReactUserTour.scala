...
object ReactUserTour {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TourProps, default, Unit, TourProps] = {
  ...
  typingsJapgolly.reactUserTour.mod.TourProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactUserTour.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactUserTour.mod.TourProps])(children: _*)
  }
