package typingsJapgolly.reactUserTour.components
...
import typingsJapgolly.reactUserTour.mod.TourProps
import typingsJapgolly.reactUserTour.mod.TourStep
import typingsJapgolly.reactUserTour.mod.default
...
object ReactUserTour {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def arrow(value: Any): this.type = set("arrow", value.asInstanceOf[js.Any])
    
    inline def arrowColor(value: String): this.type = set("arrowColor", value.asInstanceOf[js.Any])
    
    inline def arrowSize(value: Double): this.type = set("arrowSize", value.asInstanceOf[js.Any])
    ...
    inline def backButtonText(value: String): this.type = set("backButtonText", value.asInstanceOf[js.Any])
    
    inline def buttonContainerStyle(value: Any): this.type = set("buttonContainerStyle", value.asInstanceOf[js.Any])
    
    inline def buttonStyle(value: Any): this.type = set("buttonStyle", value.asInstanceOf[js.Any])
    
    inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def closeButtonText(value: String): this.type = set("closeButtonText", value.asInstanceOf[js.Any])
    ...
    inline def doneButtonText(value: String): this.type = set("doneButtonText", value.asInstanceOf[js.Any])
    
    inline def draggable(value: Booleanish): this.type = set("draggable", value.asInstanceOf[js.Any])
    
    inline def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    
    inline def hideButtons(value: Boolean): this.type = set("hideButtons", value.asInstanceOf[js.Any])
