...
object anon {
  ...
  trait History extends StObject {
    ...
    var history: typingsJapgolly.history.mod.History
  ...
  object History {
    ...
    inline def apply(history: typingsJapgolly.history.mod.History, location: Location, `match`: IsExact): History = {
    ...
    extension [Self <: History](x: Self) {
      ...
      inline def setHistory(value: typingsJapgolly.history.mod.History): Self = StObject.set(x, "history", value.asInstanceOf[js.Any])
