...
typingsJapgolly.reachTabs.mod.TabProps & typingsJapgolly.reachPolymorphic.anon.As[typingsJapgolly.reachTabs.reachTabsStrings.button]] because: IArray(Could't extract props from typingsJapgolly.std.Omit[
/ * import warning: importer.ImportType#apply Failed type conversion: IntrinsicElementString extends react.react.ElementType<any> ? react.react.ComponentPropsWithRef<IntrinsicElementString> : never * / js.Any, 
...
object Tab {
  ...
  implicit def make(companion: Tab.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
