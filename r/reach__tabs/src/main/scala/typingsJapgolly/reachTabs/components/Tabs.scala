...
typingsJapgolly.reachTabs.mod.TabsProps & typingsJapgolly.reachPolymorphic.anon.As[typingsJapgolly.reachTabs.reachTabsStrings.div]] because: IArray(Could't extract props from typingsJapgolly.std.Omit[
/ * import warning: importer.ImportType#apply Failed type conversion: IntrinsicElementString extends react.react.ElementType<any> ? react.react.ComponentPropsWithRef<IntrinsicElementString> : never * / js.Any, 
