...
import typingsJapgolly.reachTabs.mod.TabsProps
import typingsJapgolly.reachTabs.reachTabsStrings.`additions text`
import typingsJapgolly.reachTabs.reachTabsStrings.`inline`
import typingsJapgolly.reachTabs.reachTabsStrings.additions
import typingsJapgolly.reachTabs.reachTabsStrings.all
import typingsJapgolly.reachTabs.reachTabsStrings.ascending
import typingsJapgolly.reachTabs.reachTabsStrings.assertive
import typingsJapgolly.reachTabs.reachTabsStrings.both
import typingsJapgolly.reachTabs.reachTabsStrings.copy
import typingsJapgolly.reachTabs.reachTabsStrings.date
import typingsJapgolly.reachTabs.reachTabsStrings.decimal
import typingsJapgolly.reachTabs.reachTabsStrings.descending
import typingsJapgolly.reachTabs.reachTabsStrings.dialog
import typingsJapgolly.reachTabs.reachTabsStrings.email
import typingsJapgolly.reachTabs.reachTabsStrings.execute
import typingsJapgolly.reachTabs.reachTabsStrings.grammar
import typingsJapgolly.reachTabs.reachTabsStrings.grid
import typingsJapgolly.reachTabs.reachTabsStrings.horizontal
import typingsJapgolly.reachTabs.reachTabsStrings.inherit
import typingsJapgolly.reachTabs.reachTabsStrings.link
import typingsJapgolly.reachTabs.reachTabsStrings.list
import typingsJapgolly.reachTabs.reachTabsStrings.listbox
import typingsJapgolly.reachTabs.reachTabsStrings.location
import typingsJapgolly.reachTabs.reachTabsStrings.menu
import typingsJapgolly.reachTabs.reachTabsStrings.mixed
import typingsJapgolly.reachTabs.reachTabsStrings.move
import typingsJapgolly.reachTabs.reachTabsStrings.none
import typingsJapgolly.reachTabs.reachTabsStrings.numeric
import typingsJapgolly.reachTabs.reachTabsStrings.off
import typingsJapgolly.reachTabs.reachTabsStrings.other
import typingsJapgolly.reachTabs.reachTabsStrings.page
import typingsJapgolly.reachTabs.reachTabsStrings.polite
import typingsJapgolly.reachTabs.reachTabsStrings.popup
import typingsJapgolly.reachTabs.reachTabsStrings.removals
import typingsJapgolly.reachTabs.reachTabsStrings.search
import typingsJapgolly.reachTabs.reachTabsStrings.spelling
import typingsJapgolly.reachTabs.reachTabsStrings.step
import typingsJapgolly.reachTabs.reachTabsStrings.tel
import typingsJapgolly.reachTabs.reachTabsStrings.text
import typingsJapgolly.reachTabs.reachTabsStrings.time
import typingsJapgolly.reachTabs.reachTabsStrings.tree
import typingsJapgolly.reachTabs.reachTabsStrings.url
...
object Tabs {
  def apply(
    ...
    onChange: /* index */ Double => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TabsProps, LegacyRef[HTMLDivElement], Unit, TabsProps] = {
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: /* index */ scala.Double) => onChange(t0).runNow()))
  ...
  typingsJapgolly.reachTabs.mod.TabsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLDivElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reachTabs.mod.TabsProps])(children: _*)
  }
