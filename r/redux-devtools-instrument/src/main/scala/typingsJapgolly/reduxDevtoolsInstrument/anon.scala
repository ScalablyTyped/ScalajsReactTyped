package typingsJapgolly.reduxDevtoolsInstrument
...
import typingsJapgolly.reduxDevtoolsInstrument.reduxDevtoolsInstrumentStrings.PERFORM_ACTION
...
object anon {
  ...
  trait Action[A /* <: typingsJapgolly.redux.mod.Action[Any] */] extends StObject {
  ...
  object Action {
    ...
    inline def apply[A /* <: typingsJapgolly.redux.mod.Action[Any] */](action: A, timestamp: Double): Action[A] = {
    ...
    extension [Self <: Action[?], A /* <: typingsJapgolly.redux.mod.Action[Any] */](x: Self & Action[A]) {
  ...
  trait LiftedStore[S, A /* <: typingsJapgolly.redux.mod.Action[Any] */, MonitorState, NextStateExt] extends StObject {
    
    var liftedStore: Store[(LiftedState[S, A, MonitorState]) & NextStateExt, LiftedAction[S, A, MonitorState]]
  }
  object LiftedStore {
    
    inline def apply[S, A /* <: typingsJapgolly.redux.mod.Action[Any] */, MonitorState, NextStateExt](
    ...
    extension [Self <: LiftedStore[?, ?, ?, ?], S, A /* <: typingsJapgolly.redux.mod.Action[Any] */, MonitorState, NextStateExt](x: Self & (LiftedStore[S, A, MonitorState, NextStateExt])) {
