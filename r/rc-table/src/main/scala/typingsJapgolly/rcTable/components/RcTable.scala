...
object RcTable {
  ...
  implicit def make[RecordType /* <: DefaultRecordType */](companion: RcTable.type): SharedBuilder_TableProps_2076786734[RecordType] = new SharedBuilder_TableProps_2076786734[RecordType](js.Array(this.component, js.Dictionary.empty))()
