...
import typingsJapgolly.rcTable.anon.Cell
...
object TableComponents {
  ...
  extension [Self <: TableComponents[?], RecordType](x: Self & TableComponents[RecordType]) {
    ...
    inline def setBodyFunction2(value: (/* data */ js.Array[RecordType], /* info */ OnScroll) => Node): Self = StObject.set(x, "body", js.Any.fromFunction2(value))
