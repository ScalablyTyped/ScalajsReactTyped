package typingsJapgolly.rsmqWorker.mod
...
object Options {
  ...
  def apply(
    ...
    customExceedCheck: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RedisSMQ.Message */ /* message */ js.Any => CallbackTo[Boolean] = null,
    ...
    if (customExceedCheck != null) __obj.updateDynamic("customExceedCheck")(js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RedisSMQ.Message */ /* message */ js.Any) => customExceedCheck(t0).runNow()))
