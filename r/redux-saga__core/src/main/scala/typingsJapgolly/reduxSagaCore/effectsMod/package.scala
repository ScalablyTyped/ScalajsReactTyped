...
package object effectsMod {
  ...
  type AllButLast[L /* <: js.Array[_] */] = typingsJapgolly.typescriptTuple.libMod.Reverse[
    typingsJapgolly.reduxSagaCore.effectsMod.Tail[typingsJapgolly.typescriptTuple.libMod.Reverse[L]]
  ]
  ...
  ]) | typingsJapgolly.reduxSagaCore.effectsMod.SELF_CANCELLATION
  ...
  type CpsFunctionParameters[Fn /* <: js.Function1[/* repeated */ js.Any, _] */] = typingsJapgolly.reduxSagaCore.effectsMod.AllButLast[typingsJapgolly.std.Parameters[Fn]]
  ...
  type FlushEffectDescriptor[T] = typingsJapgolly.reduxSagaCore.typesMod.FlushableChannel[T]
  ...
  type HelperWorkerParameters[T, Fn /* <: js.Function1[/* repeated */ js.Any, _] */] = typingsJapgolly.std.Parameters[Fn] | typingsJapgolly.reduxSagaCore.effectsMod.AllButLast[typingsJapgolly.std.Parameters[Fn]]
  ...
  type PutEffect[A /* <: typingsJapgolly.redux.mod.Action[_] */] = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SimpleEffect<'PUT', PutEffectDescriptor<A>> */ js.Any
  ...
  type SELF_CANCELLATION = typingsJapgolly.reduxSagaCore.reduxSagaCoreStrings.`@@redux-sagaSlashSELF_CANCELLATION`
