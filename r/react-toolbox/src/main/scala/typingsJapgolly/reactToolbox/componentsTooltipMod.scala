...
import typingsJapgolly.reactToolbox.reactToolboxStrings.bottom
...
import typingsJapgolly.reactToolbox.reactToolboxStrings.top
...
object componentsTooltipMod {
  ...
  type tooltipHOC[P] = js.Function1[/* componentClass */ ComponentClassP[P & js.Object], TooltippedComponentClass[P]]
}
