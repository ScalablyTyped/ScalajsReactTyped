...
import typingsJapgolly.reactToolbox.componentsSwitchMod.default
import typingsJapgolly.reactToolbox.componentsSwitchSwitchMod.SwitchProps
import typingsJapgolly.reactToolbox.componentsSwitchSwitchMod.SwitchTheme
...
object Switch {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def theme(value: SwitchTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
