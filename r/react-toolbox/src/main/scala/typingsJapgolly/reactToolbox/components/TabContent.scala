...
import typingsJapgolly.reactToolbox.componentsTabsTabContentMod.TabContentProps
import typingsJapgolly.reactToolbox.componentsTabsTabContentMod.TabContentTheme
import typingsJapgolly.reactToolbox.componentsTabsTabContentMod.default
...
object TabContent {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def theme(value: TabContentTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
