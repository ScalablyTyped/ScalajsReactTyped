...
import typingsJapgolly.reactToolbox.componentsListListMod.ListProps
import typingsJapgolly.reactToolbox.componentsListListMod.ListTheme
...
object List {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsListMod.List] {
    ...
    inline def theme(value: ListTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
