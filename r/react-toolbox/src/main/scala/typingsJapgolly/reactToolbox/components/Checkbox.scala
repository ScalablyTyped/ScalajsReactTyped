...
import typingsJapgolly.reactToolbox.componentsCheckboxCheckboxMod.CheckboxProps
import typingsJapgolly.reactToolbox.componentsCheckboxCheckboxMod.CheckboxTheme
import typingsJapgolly.reactToolbox.componentsCheckboxMod.default
...
object Checkbox {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def theme(value: CheckboxTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
