...
import typingsJapgolly.reactToolbox.componentsLayoutSidebarMod.SidebarProps
import typingsJapgolly.reactToolbox.componentsLayoutSidebarMod.SidebarTheme
...
object Sidebar {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsLayoutMod.Sidebar] {
    ...
    inline def theme(value: SidebarTheme): this.type = set("theme", value.asInstanceOf[js.Any])
