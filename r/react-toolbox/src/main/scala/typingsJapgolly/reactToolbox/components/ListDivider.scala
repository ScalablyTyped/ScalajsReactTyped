...
import typingsJapgolly.reactToolbox.componentsListListDividerMod.ListDividerProps
import typingsJapgolly.reactToolbox.componentsListListDividerMod.ListDividerTheme
...
object ListDivider {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsListMod.ListDivider] {
    ...
    inline def theme(value: ListDividerTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
