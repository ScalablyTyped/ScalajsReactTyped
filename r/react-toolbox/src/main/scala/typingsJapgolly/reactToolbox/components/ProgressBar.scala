...
import typingsJapgolly.reactToolbox.libProgressBarMod.default
import typingsJapgolly.reactToolbox.libProgressBarProgressBarMod.ProgressBarProps
import typingsJapgolly.reactToolbox.libProgressBarProgressBarMod.ProgressBarTheme
...
object ProgressBar {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ProgressBarProps, default, Unit, ProgressBarProps] = {
  ...
  typingsJapgolly.reactToolbox.libProgressBarProgressBarMod.ProgressBarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactToolbox.libProgressBarMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactToolbox.libProgressBarProgressBarMod.ProgressBarProps])(children: _*)
  }
