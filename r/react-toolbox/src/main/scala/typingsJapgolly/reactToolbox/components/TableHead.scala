...
import typingsJapgolly.reactToolbox.componentsTableTableHeadMod.TableHeadTheme
...
object TableHead {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsTableMod.TableHead] {
    
    inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def displaySelect(value: Boolean): this.type = set("displaySelect", value.asInstanceOf[js.Any])
    ...
    inline def theme(value: TableHeadTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
