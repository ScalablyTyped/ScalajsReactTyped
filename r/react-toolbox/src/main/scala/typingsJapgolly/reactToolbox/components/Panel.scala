...
import typingsJapgolly.reactToolbox.componentsLayoutPanelMod.PanelProps
import typingsJapgolly.reactToolbox.componentsLayoutPanelMod.PanelTheme
...
object Panel {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsLayoutMod.Panel] {
    
    inline def bodyScroll(value: Boolean): this.type = set("bodyScroll", value.asInstanceOf[js.Any])
    ...
    inline def theme(value: PanelTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
