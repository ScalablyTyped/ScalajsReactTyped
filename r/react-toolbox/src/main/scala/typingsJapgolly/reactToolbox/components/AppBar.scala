...
import typingsJapgolly.reactToolbox.componentsAppBarAppBarMod.AppBarProps
import typingsJapgolly.reactToolbox.componentsAppBarAppBarMod.AppBarTheme
import typingsJapgolly.reactToolbox.componentsAppBarMod.default
...
object AppBar {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onLeftIconClick(value: js.Function): this.type = set("onLeftIconClick", value.asInstanceOf[js.Any])
    ...
    inline def onRightIconClick(value: js.Function): this.type = set("onRightIconClick", value.asInstanceOf[js.Any])
    ...
    inline def theme(value: AppBarTheme): this.type = set("theme", value.asInstanceOf[js.Any])
