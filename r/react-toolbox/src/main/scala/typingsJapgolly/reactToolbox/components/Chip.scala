...
import typingsJapgolly.reactToolbox.componentsChipChipMod.ChipProps
import typingsJapgolly.reactToolbox.componentsChipChipMod.ChipTheme
import typingsJapgolly.reactToolbox.componentsChipMod.default
...
object Chip {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onDeleteClick(value: js.Function): this.type = set("onDeleteClick", value.asInstanceOf[js.Any])
    ...
    inline def theme(value: ChipTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
