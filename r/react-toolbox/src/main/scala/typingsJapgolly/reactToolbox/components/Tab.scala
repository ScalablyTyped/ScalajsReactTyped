...
import typingsJapgolly.reactToolbox.tabsTabMod.TabProps
import typingsJapgolly.reactToolbox.tabsTabMod.TabTheme
import typingsJapgolly.reactToolbox.tabsTabMod.default
...
object Tab {
  ...
  typingsJapgolly.reactToolbox.tabsTabMod.TabProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactToolbox.tabsTabMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactToolbox.tabsTabMod.TabProps])(children: _*)
  }
  @JSImport("react-toolbox/lib/tabs/Tab", JSImport.Default)
  @js.native
