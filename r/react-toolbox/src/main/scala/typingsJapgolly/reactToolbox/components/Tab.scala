...
import typingsJapgolly.reactToolbox.componentsTabsTabMod.TabTheme
...
object Tab {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsTabsMod.Tab] {
    ...
    inline def onActive(value: js.Function): this.type = set("onActive", value.asInstanceOf[js.Any])
    ...
    inline def theme(value: TabTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
