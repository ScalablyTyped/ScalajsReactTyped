...
import typingsJapgolly.reactToolbox.componentsTableTableRowMod.TableRowTheme
...
object TableRow {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsTableMod.TableRow] {
    
    inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def idx(value: Double): this.type = set("idx", value.asInstanceOf[js.Any])
    ...
    inline def theme(value: TableRowTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
