...
import typingsJapgolly.reactToolbox.componentsCardCardMod.CardProps
import typingsJapgolly.reactToolbox.componentsCardCardMod.CardTheme
import typingsJapgolly.reactToolbox.componentsCardMod.default
...
object Card {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def theme(value: CardTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
