...
import typingsJapgolly.reactToolbox.componentsButtonBrowseButtonMod.BrowseButtonProps
import typingsJapgolly.reactToolbox.componentsButtonBrowseButtonMod.BrowseButtonTheme
...
object BrowseButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsButtonMod.BrowseButton] {
    ...
    inline def theme(value: BrowseButtonTheme): this.type = set("theme", value.asInstanceOf[js.Any])
