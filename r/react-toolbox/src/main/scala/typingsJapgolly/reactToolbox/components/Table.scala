...
import typingsJapgolly.reactToolbox.componentsTableMod.default
import typingsJapgolly.reactToolbox.componentsTableTableMod.TableProps
import typingsJapgolly.reactToolbox.componentsTableTableMod.TableTheme
...
object Table {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onRowSelect(value: js.Function): this.type = set("onRowSelect", value.asInstanceOf[js.Any])
    ...
    inline def theme(value: TableTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
