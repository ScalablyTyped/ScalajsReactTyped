...
import typingsJapgolly.reactToolbox.libSnackbarMod.default
import typingsJapgolly.reactToolbox.libSnackbarSnackbarMod.SnackbarProps
import typingsJapgolly.reactToolbox.libSnackbarSnackbarMod.SnackbarTheme
...
object Snackbar {
  ...
  typingsJapgolly.reactToolbox.libSnackbarSnackbarMod.SnackbarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactToolbox.libSnackbarMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactToolbox.libSnackbarSnackbarMod.SnackbarProps])(children: _*)
  }
