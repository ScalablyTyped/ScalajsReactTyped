...
import typingsJapgolly.reactToolbox.componentsListListSubHeaderMod.ListSubHeaderProps
import typingsJapgolly.reactToolbox.componentsListListSubHeaderMod.ListSubHeaderTheme
...
object ListSubHeader {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsListMod.ListSubHeader] {
    ...
    inline def theme(value: ListSubHeaderTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
