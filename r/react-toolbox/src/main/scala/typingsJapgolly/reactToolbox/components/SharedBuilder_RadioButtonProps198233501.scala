...
import typingsJapgolly.reactToolbox.componentsRadioRadioButtonMod.RadioButtonTheme
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@scala.inline
open class SharedBuilder_RadioButtonProps198233501[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def theme(value: RadioButtonTheme & RadioTheme): this.type = set("theme", value.asInstanceOf[js.Any])
