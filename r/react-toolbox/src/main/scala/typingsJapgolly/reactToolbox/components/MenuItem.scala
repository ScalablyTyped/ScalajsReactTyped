...
import typingsJapgolly.reactToolbox.componentsMenuMenuItemMod.MenuItemProps
import typingsJapgolly.reactToolbox.componentsMenuMenuItemMod.MenuItemTheme
...
object MenuItem {
  ...
  inline def apply(caption: String): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsMenuMod.MenuItem] {
    ...
    inline def shortcut(value: String): this.type = set("shortcut", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSProperties): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def theme(value: MenuItemTheme): this.type = set("theme", value.asInstanceOf[js.Any])
