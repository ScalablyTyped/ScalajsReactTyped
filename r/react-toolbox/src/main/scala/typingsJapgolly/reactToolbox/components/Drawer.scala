...
import typingsJapgolly.reactToolbox.componentsDrawerDrawerMod.DrawerProps
import typingsJapgolly.reactToolbox.componentsDrawerDrawerMod.DrawerTheme
import typingsJapgolly.reactToolbox.componentsDrawerMod.default
...
object Drawer {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def theme(value: DrawerTheme): this.type = set("theme", value.asInstanceOf[js.Any])
