...
import typingsJapgolly.reactToolbox.componentsHocPortalMod.PortalProps
import typingsJapgolly.reactToolbox.componentsHocPortalMod.default
...
object Portal {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def lockBody(value: Boolean): this.type = set("lockBody", value.asInstanceOf[js.Any])
