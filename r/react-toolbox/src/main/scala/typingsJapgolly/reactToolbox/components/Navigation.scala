...
import typingsJapgolly.reactToolbox.componentsNavigationMod.default
import typingsJapgolly.reactToolbox.componentsNavigationNavigationMod.NavigationProps
import typingsJapgolly.reactToolbox.componentsNavigationNavigationMod.NavigationTheme
...
object Navigation {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def actions(value: js.Array[Any]): this.type = set("actions", value.asInstanceOf[js.Any])
    
    inline def actionsVarargs(value: Any*): this.type = set("actions", js.Array(value*))
    ...
    inline def theme(value: NavigationTheme): this.type = set("theme", value.asInstanceOf[js.Any])
    
    inline def `type`(value: vertical | horizontal): this.type = set("type", value.asInstanceOf[js.Any])
  }
