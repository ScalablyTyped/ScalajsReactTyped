...
import typingsJapgolly.reactToolbox.componentsButtonMod.default
import typingsJapgolly.reactToolbox.componentsRippleMod.RippleTheme
...
object Button {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onRippleEnded(value: js.Function): this.type = set("onRippleEnded", value.asInstanceOf[js.Any])
    ...
    inline def spread(value: Double): this.type = set("spread", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSProperties): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def target(value: String): this.type = set("target", value.asInstanceOf[js.Any])
    
    inline def theme(value: ButtonTheme | RippleTheme): this.type = set("theme", value.asInstanceOf[js.Any])
