...
import typingsJapgolly.reactToolbox.libButtonMod.default
...
object Button {
  ...
  typingsJapgolly.reactToolbox.libButtonButtonMod.ButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactToolbox.libButtonMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactToolbox.libButtonButtonMod.ButtonProps])(children: _*)
  }
