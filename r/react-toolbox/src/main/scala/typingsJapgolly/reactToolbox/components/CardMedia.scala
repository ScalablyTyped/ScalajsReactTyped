...
import typingsJapgolly.reactToolbox.componentsCardCardMediaMod.CardMediaProps
import typingsJapgolly.reactToolbox.componentsCardCardMediaMod.CardMediaTheme
...
object CardMedia {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsCardMod.CardMedia] {
    
    inline def aspectRatio(value: wide | square): this.type = set("aspectRatio", value.asInstanceOf[js.Any])
    
    inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def contentOverlay(value: Boolean): this.type = set("contentOverlay", value.asInstanceOf[js.Any])
    ...
    inline def theme(value: CardMediaTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
