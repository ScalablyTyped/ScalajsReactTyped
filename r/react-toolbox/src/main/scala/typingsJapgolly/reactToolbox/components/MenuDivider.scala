...
import typingsJapgolly.reactToolbox.componentsMenuMenuDividerMod.MenuDividerProps
import typingsJapgolly.reactToolbox.componentsMenuMenuDividerMod.MenuDividerTheme
...
object MenuDivider {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsMenuMod.MenuDivider] {
    ...
    inline def theme(value: MenuDividerTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
