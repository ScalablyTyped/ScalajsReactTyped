...
import typingsJapgolly.reactToolbox.componentsCardCardActionsMod.CardActionsProps
import typingsJapgolly.reactToolbox.componentsCardCardActionsMod.CardActionsTheme
...
object CardActions {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsCardMod.CardActions] {
    ...
    inline def theme(value: CardActionsTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
