...
import typingsJapgolly.reactToolbox.componentsCardCardTextMod.CardTextProps
import typingsJapgolly.reactToolbox.componentsCardCardTextMod.CardTextTheme
...
object CardText {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsCardMod.CardText] {
    ...
    inline def theme(value: CardTextTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
