...
import typingsJapgolly.reactToolbox.componentsListListItemTextMod.ListItemTextProps
...
object ListItemText {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsListMod.ListItemText] {
    ...
    inline def theme(value: ListItemTextTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
