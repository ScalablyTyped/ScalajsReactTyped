...
object ListItemText {
  ...
  /* key */ StringDictionary[js.Any] = null,
    ...
    ListItemTextProps, 
    typingsJapgolly.reactToolbox.libListMod.ListItemText, 
    Unit, 
    ListItemTextProps
  ] = {
  ...
  typingsJapgolly.reactToolbox.listListItemTextMod.ListItemTextProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactToolbox.libListMod.ListItemText](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactToolbox.listListItemTextMod.ListItemTextProps])(children: _*)
  }
