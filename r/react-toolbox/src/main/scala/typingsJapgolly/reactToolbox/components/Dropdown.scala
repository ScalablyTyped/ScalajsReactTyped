...
import typingsJapgolly.reactToolbox.componentsDropdownDropdownMod.DropdownTheme
import typingsJapgolly.reactToolbox.componentsDropdownMod.default
...
object Dropdown {
  ...
  inline def apply(source: js.Array[Any]): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def allowBlank(value: Boolean): this.type = set("allowBlank", value.asInstanceOf[js.Any])
    ...
    inline def template(value: js.Function): this.type = set("template", value.asInstanceOf[js.Any])
    
    inline def theme(value: DropdownTheme): this.type = set("theme", value.asInstanceOf[js.Any])
