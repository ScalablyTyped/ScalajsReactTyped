...
import typingsJapgolly.reactToolbox.libDialogDialogMod.DialogActionProps
import typingsJapgolly.reactToolbox.libDialogDialogMod.DialogProps
import typingsJapgolly.reactToolbox.libDialogDialogMod.DialogTheme
import typingsJapgolly.reactToolbox.libDialogMod.default
...
object Dialog {
  ...
  typingsJapgolly.reactToolbox.libDialogDialogMod.DialogProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactToolbox.libDialogMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactToolbox.libDialogDialogMod.DialogProps])(children: _*)
  }
