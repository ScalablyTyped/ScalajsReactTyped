...
import typingsJapgolly.reactToolbox.listListCheckboxMod.ListCheckboxTheme
...
object ListCheckbox {
  def apply(
    ...
    ListCheckboxProps, 
    typingsJapgolly.reactToolbox.mod.ListCheckbox, 
    Unit, 
    ListCheckboxProps
  ] = {
  ...
  typingsJapgolly.reactToolbox.listListCheckboxMod.ListCheckboxProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactToolbox.mod.ListCheckbox](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactToolbox.listListCheckboxMod.ListCheckboxProps])(children: _*)
  }
