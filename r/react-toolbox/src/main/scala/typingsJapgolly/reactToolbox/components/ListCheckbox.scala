...
import typingsJapgolly.reactToolbox.componentsListListCheckboxMod.ListCheckboxProps
import typingsJapgolly.reactToolbox.componentsListListCheckboxMod.ListCheckboxTheme
...
object ListCheckbox {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactToolbox.componentsListMod.ListCheckbox] {
    ...
    inline def theme(value: ListCheckboxTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  }
