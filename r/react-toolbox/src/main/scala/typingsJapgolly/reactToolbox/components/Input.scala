...
import typingsJapgolly.reactToolbox.libInputMod.default
...
object Input {
  ...
  typingsJapgolly.reactToolbox.libInputInputMod.InputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactToolbox.libInputMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactToolbox.libInputInputMod.InputProps])(children: _*)
  }
