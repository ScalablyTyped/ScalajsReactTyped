...
object componentsButtonButtonMod {
  ...
  - typingsJapgolly.reactToolbox.componentsRippleMod.RippleProps because Inheritance from two classes. Inlined onRippleEnded, spread, theme */ trait ButtonProps
    extends StObject
