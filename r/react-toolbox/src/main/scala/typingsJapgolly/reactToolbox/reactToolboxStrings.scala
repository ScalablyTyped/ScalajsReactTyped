...
object reactToolboxStrings {
  ...
  @js.native
  sealed trait lgTablet extends StObject
  inline def lgTablet: lgTablet = "lgTablet".asInstanceOf[lgTablet]
  ...
  @js.native
  sealed trait smTablet extends StObject
  inline def smTablet: smTablet = "smTablet".asInstanceOf[smTablet]
  ...
  @js.native
  sealed trait unmounted extends StObject
  ...
  @js.native
  sealed trait xxxl extends StObject
