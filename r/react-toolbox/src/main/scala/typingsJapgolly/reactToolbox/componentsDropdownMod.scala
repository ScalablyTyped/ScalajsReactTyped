...
import typingsJapgolly.reactToolbox.componentsDropdownDropdownMod.DropdownProps
...
object componentsDropdownMod {
  ...
  open class default protected ()
    extends typingsJapgolly.reactToolbox.componentsDropdownDropdownMod.Dropdown {
  ...
  @JSImport("react-toolbox/components/dropdown", "Dropdown")
  @js.native
