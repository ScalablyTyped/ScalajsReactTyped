package typingsJapgolly.reactToolbox.libTabsTabsMod
...
- typingsJapgolly.reactToolbox.tabsTabContentMod.TabContentTheme because var conflicts: active. Inlined tab */ trait TabsTheme extends TabTheme {
  /**
