...
import typingsJapgolly.rdfjsSerializerJsonldExt.rdfjsSerializerJsonldExtStrings.`object`
import typingsJapgolly.rdfjsSerializerJsonldExt.rdfjsSerializerJsonldExtStrings.string
