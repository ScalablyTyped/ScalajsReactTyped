package typingsJapgolly.randexp
...
object mod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var defaultRange: typingsJapgolly.drange.mod.^ = js.native
  ...
  trait RandExp_ extends StObject {
    ...
    var defaultRange: typingsJapgolly.drange.mod.^
  ...
  object RandExp_ {
    ...
    inline def apply(
      defaultRange: typingsJapgolly.drange.mod.^,
      gen: CallbackTo[String],
      max: Double,
      randInt: (Double, Double) => Double
    ): RandExp_ = {
      val __obj = js.Dynamic.literal(defaultRange = defaultRange.asInstanceOf[js.Any], gen = gen.toJsFn, max = max.asInstanceOf[js.Any], randInt = js.Any.fromFunction2(randInt))
      __obj.asInstanceOf[RandExp_]
    }
    
    extension [Self <: RandExp_](x: Self) {
      
      inline def setDefaultRange(value: typingsJapgolly.drange.mod.^): Self = StObject.set(x, "defaultRange", value.asInstanceOf[js.Any])
      
      inline def setGen(value: CallbackTo[String]): Self = StObject.set(x, "gen", value.toJsFn)
