...
object anon {
  ...
  object Callback {
    ...
    inline def apply(callback: japgolly.scalajs.react.Callback, icon: String, text: String): Callback = {
      val __obj = js.Dynamic.literal(callback = callback.toJsFn, icon = icon.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any])
  ...
  object EnableShiftSelect {
    ...
    extension [Self <: EnableShiftSelect[?], T](x: Self & EnableShiftSelect[T]) {
      ...
      inline def setOnRowsDeselected(value: /* rows */ js.Array[SelectionParams[T]] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onRowsDeselected", js.Any.fromFunction1((t0: /* rows */ js.Array[SelectionParams[T]]) => value(t0).runNow()))
      
      inline def setOnRowsDeselectedUndefined: Self = StObject.set(x, "onRowsDeselected", js.undefined)
      
      inline def setOnRowsSelected(value: /* rows */ js.Array[SelectionParams[T]] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onRowsSelected", js.Any.fromFunction1((t0: /* rows */ js.Array[SelectionParams[T]]) => value(t0).runNow()))
