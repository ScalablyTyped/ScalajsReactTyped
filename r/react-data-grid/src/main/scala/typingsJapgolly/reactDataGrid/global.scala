...
object global {
  ...
  object AdazzleReactDataGrid {
    ...
    open class ReactDataGrid[T] ()
      extends typingsJapgolly.reactDataGrid.AdazzleReactDataGrid.ReactDataGrid[T]
    ...
    object SCROLL_DIRECTION extends StObject {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[typingsJapgolly.reactDataGrid.AdazzleReactDataGrid.SCROLL_DIRECTION & String] = js.native
      
      /* "downwards" */ val DOWN: typingsJapgolly.reactDataGrid.AdazzleReactDataGrid.SCROLL_DIRECTION.DOWN & String = js.native
      
      /* "left" */ val LEFT: typingsJapgolly.reactDataGrid.AdazzleReactDataGrid.SCROLL_DIRECTION.LEFT & String = js.native
      
      /* "none" */ val NONE: typingsJapgolly.reactDataGrid.AdazzleReactDataGrid.SCROLL_DIRECTION.NONE & String = js.native
      
      /* "right" */ val RIGHT: typingsJapgolly.reactDataGrid.AdazzleReactDataGrid.SCROLL_DIRECTION.RIGHT & String = js.native
      
      /* "upwards" */ val UP: typingsJapgolly.reactDataGrid.AdazzleReactDataGrid.SCROLL_DIRECTION.UP & String = js.native
    }
  }
