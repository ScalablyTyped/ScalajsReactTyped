...
trait Column[T] extends js.Object {
  ...
  var editor: js.UndefOr[
    Element | (ComponentClassP[EditorBaseProps with js.Object]) | StatelessComponent[EditorBaseProps]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var filterRenderer: js.UndefOr[Element | ComponentClassP[js.Object] | StatelessComponent[_]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var formatter: js.UndefOr[Element | ComponentClassP[js.Object] | StatelessComponent[_]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var headerRenderer: js.UndefOr[Element | ComponentClassP[js.Object] | StatelessComponent[_]] = js.undefined
  /**
...
object Column {
  ...
  def apply[T](
    ...
    editor: Element | (ComponentClassP[EditorBaseProps with js.Object]) | StatelessComponent[EditorBaseProps] = null,
    events: StringDictionary[ColumnEventCallback] = null,
    filterRenderer: Element | ComponentClassP[js.Object] | StatelessComponent[_] = null,
    filterable: js.UndefOr[Boolean] = js.undefined,
    formatter: Element | ComponentClassP[js.Object] | StatelessComponent[_] = null,
    getRowMetaData: (/* rowdata */ T, /* column */ js.UndefOr[Column[T]]) => CallbackTo[js.Any] = null,
    headerRenderer: Element | ComponentClassP[js.Object] | StatelessComponent[_] = null,
    ...
    if (getRowMetaData != null) __obj.updateDynamic("getRowMetaData")(js.Any.fromFunction2((t0: /* rowdata */ T, t1: /* column */ js.UndefOr[typingsJapgolly.reactDataGrid.AdazzleReactDataGrid.Column[T]]) => getRowMetaData(t0, t1).runNow()))
