...
trait DragHandleDoubleClickEvent[T] extends StObject {
  ...
  /**
    ...
    */
  var e: ReactEventFrom[Any & Element]
...
object DragHandleDoubleClickEvent {
  ...
  inline def apply[T](e: ReactEventFrom[Any & Element], idx: Double, rowData: T, rowIdx: Double): DragHandleDoubleClickEvent[T] = {
  ...
  extension [Self <: DragHandleDoubleClickEvent[?], T](x: Self & DragHandleDoubleClickEvent[T]) {
    ...
    inline def setE(value: ReactEventFrom[Any & Element]): Self = StObject.set(x, "e", value.asInstanceOf[js.Any])
