...
trait GridProps[T] extends StObject {
  ...
  /**
    ...
    */
  var emptyRowsView: js.UndefOr[(ComponentClassP[Any & js.Object]) | FunctionComponent[Any]] = js.undefined
  ...
  /**
    ...
    */
  var rowActionsCell: js.UndefOr[(ComponentClassP[Any & js.Object]) | FunctionComponent[Any]] = js.undefined
  ...
  /**
    ...
    */
  var rowRenderer: js.UndefOr[Element | (ComponentClassP[Any & js.Object]) | FunctionComponent[Any]] = js.undefined
  ...
  /**
    ...
    */
  var selectAllRenderer: js.UndefOr[(ComponentClassP[Any & js.Object]) | FunctionComponent[Any]] = js.undefined
...
object GridProps {
  ...
  extension [Self <: GridProps[?], T](x: Self & GridProps[T]) {
    ...
    inline def setContextMenu(value: VdomElement): Self = StObject.set(x, "contextMenu", value.rawElement.asInstanceOf[js.Any])
    
    inline def setContextMenuUndefined: Self = StObject.set(x, "contextMenu", js.undefined)
    
    inline def setEmptyRowsView(value: (ComponentClassP[Any & js.Object]) | FunctionComponent[Any]): Self = StObject.set(x, "emptyRowsView", value.asInstanceOf[js.Any])
    ...
    inline def setOnAddFilter(value: /* filter */ Filter => Callback): Self = StObject.set(x, "onAddFilter", js.Any.fromFunction1((t0: /* filter */ Filter) => value(t0).runNow()))
    
    inline def setOnAddFilterUndefined: Self = StObject.set(x, "onAddFilter", js.undefined)
    
    inline def setOnCellCopyPaste(value: /* e */ CellCopyPasteEvent => Callback): Self = StObject.set(x, "onCellCopyPaste", js.Any.fromFunction1((t0: /* e */ CellCopyPasteEvent) => value(t0).runNow()))
    
    inline def setOnCellCopyPasteUndefined: Self = StObject.set(x, "onCellCopyPaste", js.undefined)
    
    inline def setOnCellDeSelected(value: /* coordinates */ Idx => Callback): Self = StObject.set(x, "onCellDeSelected", js.Any.fromFunction1((t0: /* coordinates */ Idx) => value(t0).runNow()))
    
    inline def setOnCellDeSelectedUndefined: Self = StObject.set(x, "onCellDeSelected", js.undefined)
    
    inline def setOnCellExpand(value: /* e */ CellExpandEvent[T] => Callback): Self = StObject.set(x, "onCellExpand", js.Any.fromFunction1((t0: /* e */ CellExpandEvent[T]) => value(t0).runNow()))
    
    inline def setOnCellExpandUndefined: Self = StObject.set(x, "onCellExpand", js.undefined)
    
    inline def setOnCellSelected(value: /* coordinates */ Idx => Callback): Self = StObject.set(x, "onCellSelected", js.Any.fromFunction1((t0: /* coordinates */ Idx) => value(t0).runNow()))
    
    inline def setOnCellSelectedUndefined: Self = StObject.set(x, "onCellSelected", js.undefined)
    
    inline def setOnCellsDragged(value: /* e */ CellDragEvent => Callback): Self = StObject.set(x, "onCellsDragged", js.Any.fromFunction1((t0: /* e */ CellDragEvent) => value(t0).runNow()))
    
    inline def setOnCellsDraggedUndefined: Self = StObject.set(x, "onCellsDragged", js.undefined)
    
    inline def setOnClearFilters(value: Callback): Self = StObject.set(x, "onClearFilters", value.toJsFn)
    
    inline def setOnClearFiltersUndefined: Self = StObject.set(x, "onClearFilters", js.undefined)
    
    inline def setOnColumnResize(value: (/* index */ Double, /* width */ Double) => Callback): Self = StObject.set(x, "onColumnResize", js.Any.fromFunction2((t0: /* index */ Double, t1: /* width */ Double) => (value(t0, t1)).runNow()))
    
    inline def setOnColumnResizeUndefined: Self = StObject.set(x, "onColumnResize", js.undefined)
    
    inline def setOnDragHandleDoubleClick(value: /* e */ DragHandleDoubleClickEvent[T] => Callback): Self = StObject.set(x, "onDragHandleDoubleClick", js.Any.fromFunction1((t0: /* e */ DragHandleDoubleClickEvent[T]) => value(t0).runNow()))
    
    inline def setOnDragHandleDoubleClickUndefined: Self = StObject.set(x, "onDragHandleDoubleClick", js.undefined)
    
    inline def setOnGridRowsUpdated(value: /* e */ GridRowsUpdatedEvent[T] => Callback): Self = StObject.set(x, "onGridRowsUpdated", js.Any.fromFunction1((t0: /* e */ GridRowsUpdatedEvent[T]) => value(t0).runNow()))
    
    inline def setOnGridRowsUpdatedUndefined: Self = StObject.set(x, "onGridRowsUpdated", js.undefined)
    
    inline def setOnGridSort(value: (/* sortColumn */ String, /* sortDirection */ ASC | DESC | NONE) => Callback): Self = StObject.set(x, "onGridSort", js.Any.fromFunction2((t0: /* sortColumn */ String, t1: /* sortDirection */ ASC | DESC | NONE) => (value(t0, t1)).runNow()))
    
    inline def setOnGridSortUndefined: Self = StObject.set(x, "onGridSort", js.undefined)
    
    inline def setOnRowClick(value: (/* rowIdx */ Double, /* row */ T) => Callback): Self = StObject.set(x, "onRowClick", js.Any.fromFunction2((t0: /* rowIdx */ Double, t1: /* row */ T) => (value(t0, t1)).runNow()))
    
    inline def setOnRowClickUndefined: Self = StObject.set(x, "onRowClick", js.undefined)
    
    inline def setOnRowExpandToggle(value: /* props */ OnRowExpandToggle => Callback): Self = StObject.set(x, "onRowExpandToggle", js.Any.fromFunction1((t0: /* props */ OnRowExpandToggle) => value(t0).runNow()))
    
    inline def setOnRowExpandToggleUndefined: Self = StObject.set(x, "onRowExpandToggle", js.undefined)
    
    inline def setOnRowSelect(value: /* rows */ js.Array[T] => Callback): Self = StObject.set(x, "onRowSelect", js.Any.fromFunction1((t0: /* rows */ js.Array[T]) => value(t0).runNow()))
    
    inline def setOnRowSelectUndefined: Self = StObject.set(x, "onRowSelect", js.undefined)
    
    inline def setOnRowUpdated(value: /* e */ RowUpdateEvent[T] => Callback): Self = StObject.set(x, "onRowUpdated", js.Any.fromFunction1((t0: /* e */ RowUpdateEvent[T]) => value(t0).runNow()))
    
    inline def setOnRowUpdatedUndefined: Self = StObject.set(x, "onRowUpdated", js.undefined)
    
    inline def setOnScroll(value: /* scrollState */ ScrollState => Callback): Self = StObject.set(x, "onScroll", js.Any.fromFunction1((t0: /* scrollState */ ScrollState) => value(t0).runNow()))
    
    inline def setOnScrollUndefined: Self = StObject.set(x, "onScroll", js.undefined)
    
    inline def setRowActionsCell(value: (ComponentClassP[Any & js.Object]) | FunctionComponent[Any]): Self = StObject.set(x, "rowActionsCell", value.asInstanceOf[js.Any])
    ...
    inline def setRowRenderer(value: Element | (ComponentClassP[Any & js.Object]) | FunctionComponent[Any]): Self = StObject.set(x, "rowRenderer", value.asInstanceOf[js.Any])
    
    inline def setRowRendererUndefined: Self = StObject.set(x, "rowRenderer", js.undefined)
    
    inline def setRowRendererVdomElement(value: VdomElement): Self = StObject.set(x, "rowRenderer", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def setSelectAllRenderer(value: (ComponentClassP[Any & js.Object]) | FunctionComponent[Any]): Self = StObject.set(x, "selectAllRenderer", value.asInstanceOf[js.Any])
    ...
    inline def setToolbar(value: VdomElement): Self = StObject.set(x, "toolbar", value.rawElement.asInstanceOf[js.Any])
