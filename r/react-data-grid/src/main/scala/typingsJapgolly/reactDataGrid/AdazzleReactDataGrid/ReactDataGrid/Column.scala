...
import typingsJapgolly.reactDataGrid.AdazzleReactDataGrid.ColumnEventCallback
...
object Column {
  ...
  def apply[T](
    ...
    getRowMetaData: (/* rowdata */ T, /* column */ js.UndefOr[typingsJapgolly.reactDataGrid.AdazzleReactDataGrid.Column[T]]) => CallbackTo[js.Any] = null,
