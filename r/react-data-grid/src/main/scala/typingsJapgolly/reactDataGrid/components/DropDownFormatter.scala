...
object DropDownFormatter {
  def apply(
    ...
    typingsJapgolly.reactDataGrid.AdazzleReactDataGridPlugins.Formatters.DropDownFormatter, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.reactDataGrid.AdazzleReactDataGridPlugins.Formatters.DropDownFormatter](this.componentImport)
