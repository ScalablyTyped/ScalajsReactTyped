...
object MenuHeader {
  def apply(
    ...
    typingsJapgolly.reactDataGrid.AdazzleReactDataGridPlugins.Menu.MenuHeader, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.reactDataGrid.AdazzleReactDataGridPlugins.Menu.MenuHeader](this.componentImport)
