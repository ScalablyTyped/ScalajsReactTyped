...
object SimpleTextEditor {
  def apply(
    ...
    typingsJapgolly.reactDataGrid.AdazzleReactDataGridPlugins.Editors.SimpleTextEditor, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.reactDataGrid.AdazzleReactDataGridPlugins.Editors.SimpleTextEditor](this.componentImport)
