...
object MenuItem {
  def apply(
    ...
    typingsJapgolly.reactDataGrid.AdazzleReactDataGridPlugins.Menu.MenuItem, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.reactDataGrid.AdazzleReactDataGridPlugins.Menu.MenuItem](this.componentImport)
