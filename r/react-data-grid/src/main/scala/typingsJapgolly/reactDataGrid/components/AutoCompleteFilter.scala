...
object AutoCompleteFilter {
  def apply(
    ...
    typingsJapgolly.reactDataGrid.AdazzleReactDataGridPlugins.Filters.AutoCompleteFilter, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.reactDataGrid.AdazzleReactDataGridPlugins.Filters.AutoCompleteFilter](this.componentImport)
