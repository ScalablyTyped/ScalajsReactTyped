...
object ReactFileReaderInput {
  ...
  inline def apply(onChange: (ReactEventFrom[HTMLInputElement], js.Array[Result]) => Callback): Builder = {
    val __props = js.Dynamic.literal(onChange = js.Any.fromFunction2((t0: ReactEventFrom[HTMLInputElement], t1: js.Array[Result]) => (onChange(t0, t1)).runNow()))
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def as(value: Format): this.type = set("as", value.asInstanceOf[js.Any])
