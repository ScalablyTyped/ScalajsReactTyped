package typingsJapgolly.reactFileReaderInput
...
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.`additions removals`
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.`additions text`
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.`inline`
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.`removals additions`
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.`removals text`
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.`text additions`
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.`text removals`
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.additions
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.all
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.ascending
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.assertive
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.both
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.copy
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.date
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.decimal
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.descending
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.dialog
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.done
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.email
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.enter
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.environment
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.execute
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.go
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.grammar
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.grid
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.horizontal
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.inherit
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.link
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.list
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.listbox
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.location
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.menu
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.mixed
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.move
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.next
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.no
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.none
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.numeric
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.off
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.on
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.other
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.page
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.polite
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.popup
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.previous
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.removals
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.search
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.send
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.spelling
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.step
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.tel
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.text
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.time
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.tree
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.url
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.user
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.vertical
import typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.yes
...
object mod {
  ...
  type FileInput = japgolly.scalajs.react.facade.React.Component[Props & js.Object, js.Object]
  ...
  */
  ...
  object Format {
    ...
    inline def binary: typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.binary = "binary".asInstanceOf[typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.binary]
    
    inline def buffer: typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.buffer = "buffer".asInstanceOf[typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.buffer]
    
    inline def text: typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.text = "text".asInstanceOf[typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.text]
    
    inline def url: typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.url = "url".asInstanceOf[typingsJapgolly.reactFileReaderInput.reactFileReaderInputStrings.url]
  }
  ...
  trait Props extends StObject {
    ...
    /**
      ...
      */
    def onChange(event: ReactEventFrom[HTMLInputElement], results: js.Array[Result]): Unit
  ...
  object Props {
    ...
    inline def apply(onChange: (ReactEventFrom[HTMLInputElement], js.Array[Result]) => Callback): Props = {
      val __obj = js.Dynamic.literal(onChange = js.Any.fromFunction2((t0: ReactEventFrom[HTMLInputElement], t1: js.Array[Result]) => (onChange(t0, t1)).runNow()))
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setAs(value: Format): Self = StObject.set(x, "as", value.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: (ReactEventFrom[HTMLInputElement], js.Array[Result]) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: ReactEventFrom[HTMLInputElement], t1: js.Array[Result]) => (value(t0, t1)).runNow()))
