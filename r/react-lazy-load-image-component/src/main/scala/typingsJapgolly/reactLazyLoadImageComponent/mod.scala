package typingsJapgolly.reactLazyLoadImageComponent
...
import typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.`additions removals`
...
import typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.`removals additions`
import typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.`removals text`
import typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.`text additions`
import typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.`text removals`
...
object mod {
  ...
  @js.native
  val LazyLoadComponent: FunctionComponent[LazyLoadComponentProps] = js.native
  
  @JSImport("react-lazy-load-image-component", "LazyLoadImage")
  @js.native
  val LazyLoadImage: FunctionComponent[LazyLoadImageProps] = js.native
  
  inline def trackWindowScroll[P /* <: LazyComponentProps */](BaseComponent: ComponentType[P]): ComponentType[Omit[P, scrollPosition]] = ^.asInstanceOf[js.Dynamic].applyDynamic("trackWindowScroll")(BaseComponent.asInstanceOf[js.Any]).asInstanceOf[ComponentType[Omit[P, scrollPosition]]]
  
  trait CommonProps extends StObject {
    
    /** Function called after the image has been completely loaded. */
    var afterLoad: js.UndefOr[js.Function0[Any]] = js.undefined
    
    /** Function called right before the placeholder is replaced with the image element. */
    var beforeLoad: js.UndefOr[js.Function0[Any]] = js.undefined
  ...
  object CommonProps {
    ...
    extension [Self <: CommonProps](x: Self) {
      ...
      inline def setAfterLoad(value: CallbackTo[Any]): Self = StObject.set(x, "afterLoad", value.toJsFn)
      
      inline def setAfterLoadUndefined: Self = StObject.set(x, "afterLoad", js.undefined)
      
      inline def setBeforeLoad(value: CallbackTo[Any]): Self = StObject.set(x, "beforeLoad", value.toJsFn)
      
      inline def setBeforeLoadUndefined: Self = StObject.set(x, "beforeLoad", js.undefined)
      
      inline def setDelayMethod(value: DelayMethod): Self = StObject.set(x, "delayMethod", value.asInstanceOf[js.Any])
      
      inline def setDelayMethodUndefined: Self = StObject.set(x, "delayMethod", js.undefined)
      ...
      inline def setUseIntersectionObserver(value: Boolean): Self = StObject.set(x, "useIntersectionObserver", value.asInstanceOf[js.Any])
      
      inline def setUseIntersectionObserverUndefined: Self = StObject.set(x, "useIntersectionObserver", js.undefined)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.debounce
    - typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.throttle
  */
  trait DelayMethod extends StObject
  object DelayMethod {
    
    inline def debounce: typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.debounce = "debounce".asInstanceOf[typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.debounce]
    
    inline def throttle: typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.throttle = "throttle".asInstanceOf[typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.throttle]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.blur
    - typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.`black-and-white`
    - typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.opacity
  */
  trait Effect extends StObject
  object Effect {
    
    inline def `black-and-white`: typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.`black-and-white` = "black-and-white".asInstanceOf[typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.`black-and-white`]
    
    inline def blur: typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.blur = "blur".asInstanceOf[typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.blur]
    
    inline def opacity: typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.opacity = "opacity".asInstanceOf[typingsJapgolly.reactLazyLoadImageComponent.reactLazyLoadImageComponentStrings.opacity]
  }
  ...
  object LazyComponentProps {
    ...
    inline def apply(scrollPosition: ScrollPosition): LazyComponentProps = {
  ...
  object LazyLoadComponentProps {
    ...
    inline def apply(): LazyLoadComponentProps = {
  ...
  object LazyLoadImageProps {
    ...
    inline def apply(): LazyLoadImageProps = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: LazyLoadImageProps](x: Self) {
      ...
      inline def setPlaceholderSrc(value: String): Self = StObject.set(x, "placeholderSrc", value.asInstanceOf[js.Any])
      
      inline def setPlaceholderSrcUndefined: Self = StObject.set(x, "placeholderSrc", js.undefined)
      ...
      inline def setWrapperProps(value: HTMLAttributes[HTMLSpanElement]): Self = StObject.set(x, "wrapperProps", value.asInstanceOf[js.Any])
  ...
  object ScrollPosition {
    ...
    inline def apply(x: Double, y: Double): ScrollPosition = {
