...
import typingsJapgolly.reactLazyLoadImageComponent.mod.Effect
import typingsJapgolly.reactLazyLoadImageComponent.mod.LazyLoadImageProps
...
object LazyLoadImage {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def placeholderSrc(value: String): this.type = set("placeholderSrc", value.asInstanceOf[js.Any])
    ...
    inline def wrapperProps(value: HTMLAttributes[HTMLSpanElement]): this.type = set("wrapperProps", value.asInstanceOf[js.Any])
  }
