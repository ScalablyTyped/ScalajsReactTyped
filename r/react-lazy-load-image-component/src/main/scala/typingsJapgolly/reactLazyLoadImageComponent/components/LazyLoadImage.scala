...
object LazyLoadImage {
  def apply(
    ...
    LazyLoadImageProps, 
    MountedWithRawType[LazyLoadImageProps, js.Object, RawMounted[LazyLoadImageProps, js.Object]]
  ] = {
  ...
  typingsJapgolly.reactLazyLoadImageComponent.mod.LazyLoadImageProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactLazyLoadImageComponent.mod.LazyLoadImageProps])(children: _*)
  }
