...
import typingsJapgolly.reactNativeCommunityViewpager.mod.ViewPagerAndroidProps
...
object Viewpager {
  def apply(
    ...
    keyboardDismissMode: typingsJapgolly.reactNativeCommunityViewpager.reactNativeCommunityViewpagerStrings.none | `on-drag` = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ViewPagerAndroidProps, default, Unit, ViewPagerAndroidProps] = {
  ...
  typingsJapgolly.reactNativeCommunityViewpager.mod.ViewPagerAndroidProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeCommunityViewpager.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeCommunityViewpager.mod.ViewPagerAndroidProps])(children: _*)
  }
