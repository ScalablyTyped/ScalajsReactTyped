...
import typingsJapgolly.reactMdAutocomplete.typesTypesMod.PreconfiguredFilterFunction
...
object reactMdAutocompleteStrings {
  ...
  inline def `case-insensitive`: `case-insensitive` = "case-insensitive".asInstanceOf[`case-insensitive`]
