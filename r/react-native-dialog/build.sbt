...
version := "5.6-dt-20191108Z-3288b5"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "react-native-animatable" % "1.3.3-db2eaa",
  "org.scalablytyped.japgolly" %%% "react-native-modal" % "11.5.3-261e07",
