...
import typingsJapgolly.reactNativeDialog.libCodeInputMod.DialogCodeInputProps
...
object CodeInput {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def codeLength(value: Double): this.type = set("codeLength", value.asInstanceOf[js.Any])
    ...
    inline def digitContainerFocusedStyle(value: StyleProp[ViewStyle]): this.type = set("digitContainerFocusedStyle", value.asInstanceOf[js.Any])
    
    inline def digitContainerFocusedStyleNull: this.type = set("digitContainerFocusedStyle", null)
    
    inline def digitContainerStyle(value: StyleProp[ViewStyle]): this.type = set("digitContainerStyle", value.asInstanceOf[js.Any])
    
    inline def digitContainerStyleNull: this.type = set("digitContainerStyle", null)
    
    inline def digitStyle(value: StyleProp[TextStyle]): this.type = set("digitStyle", value.asInstanceOf[js.Any])
    ...
    inline def onCodeChange(value: /* code */ String => Callback): this.type = set("onCodeChange", js.Any.fromFunction1((t0: /* code */ String) => value(t0).runNow()))
  ...
  implicit def make(companion: CodeInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DialogCodeInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
