...
object Switch {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onChange(value: ReactEventFrom[NodeHandle & org.scalajs.dom.Element] => js.Promise[Unit] | Unit): this.type = set("onChange", js.Any.fromFunction1(value))
  ...
  def withProps(p: DialogSwitchProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
