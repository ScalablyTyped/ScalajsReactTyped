...
import typingsJapgolly.reactNativeDialog.mod.TitleProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class `SharedApply_<intersection>_172182747`[ComponentRef] () {
  ...
  def apply(
    ...
    TitleProps with ViewProps with TextProps, 
    ComponentRef, 
    Unit, 
    TitleProps with ViewProps with TextProps
  ] = {
  ...
  typingsJapgolly.reactNativeDialog.mod.TitleProps with typingsJapgolly.reactNative.mod.ViewProps with typingsJapgolly.reactNative.mod.TextProps, 
  japgolly.scalajs.react.Children.None, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeDialog.mod.TitleProps with typingsJapgolly.reactNative.mod.ViewProps with typingsJapgolly.reactNative.mod.TextProps])
  }
}
