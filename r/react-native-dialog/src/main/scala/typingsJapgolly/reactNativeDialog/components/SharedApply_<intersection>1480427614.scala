...
import typingsJapgolly.reactNativeDialog.mod.DescriptionProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class `SharedApply_<intersection>1480427614`[ComponentRef] () {
  ...
  def apply(
    ...
    DescriptionProps with ViewProps with TextProps, 
    ComponentRef, 
    Unit, 
    DescriptionProps with ViewProps with TextProps
  ] = {
  ...
  typingsJapgolly.reactNativeDialog.mod.DescriptionProps with typingsJapgolly.reactNative.mod.ViewProps with typingsJapgolly.reactNative.mod.TextProps, 
  japgolly.scalajs.react.Children.None, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeDialog.mod.DescriptionProps with typingsJapgolly.reactNative.mod.ViewProps with typingsJapgolly.reactNative.mod.TextProps])
  }
}
