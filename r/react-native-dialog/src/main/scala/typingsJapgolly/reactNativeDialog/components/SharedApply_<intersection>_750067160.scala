...
import typingsJapgolly.reactNativeDialog.mod.InputProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class `SharedApply_<intersection>_750067160`[ComponentRef] () {
  ...
  def apply[T](
    ...
    InputProps[T] with ViewProps with TextInputProps, 
    ComponentRef, 
    Unit, 
    InputProps[T] with ViewProps with TextInputProps
  ] = {
  ...
  typingsJapgolly.reactNativeDialog.mod.InputProps[T] with typingsJapgolly.reactNative.mod.ViewProps with typingsJapgolly.reactNative.mod.TextInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeDialog.mod.InputProps[T] with typingsJapgolly.reactNative.mod.ViewProps with typingsJapgolly.reactNative.mod.TextInputProps])(children: _*)
  }
}
