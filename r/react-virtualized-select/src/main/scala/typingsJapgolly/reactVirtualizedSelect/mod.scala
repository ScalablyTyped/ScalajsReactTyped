...
import typingsJapgolly.reactVirtualizedSelect.anon.Async
import typingsJapgolly.reactVirtualizedSelect.anon.Option
...
object mod {
  ...
  trait AdditionalVirtualizedSelectProps[TValue] extends StObject {
    ...
    var selectComponent: js.UndefOr[(ComponentClassP[Any & js.Object]) | FunctionComponent[Any]] = js.undefined
  }
  object AdditionalVirtualizedSelectProps {
    ...
    extension [Self <: AdditionalVirtualizedSelectProps[?], TValue](x: Self & AdditionalVirtualizedSelectProps[TValue]) {
      ...
      inline def setSelectComponent(value: (ComponentClassP[Any & js.Object]) | FunctionComponent[Any]): Self = StObject.set(x, "selectComponent", value.asInstanceOf[js.Any])
  ...
  object VirtualizedOptionRenderOptions {
    ...
    inline def apply[T](
      ...
      val __obj = js.Dynamic.literal(focusOption = js.Any.fromFunction1((t0: T) => focusOption(t0).runNow()), focusedOption = focusedOption.asInstanceOf[js.Any], focusedOptionIndex = focusedOptionIndex.asInstanceOf[js.Any], key = key.asInstanceOf[js.Any], labelKey = labelKey.asInstanceOf[js.Any], listProps = listProps.asInstanceOf[js.Any], option = option.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], selectValue = js.Any.fromFunction1((t0: T) => selectValue(t0).runNow()), style = style.asInstanceOf[js.Any], valueArray = valueArray.asInstanceOf[js.Any])
    ...
    extension [Self <: VirtualizedOptionRenderOptions[?], T](x: Self & VirtualizedOptionRenderOptions[T]) {
      ...
      inline def setFocusOption(value: T => Callback): Self = StObject.set(x, "focusOption", js.Any.fromFunction1((t0: T) => value(t0).runNow()))
      ...
      inline def setSelectValue(value: T => Callback): Self = StObject.set(x, "selectValue", js.Any.fromFunction1((t0: T) => value(t0).runNow()))
