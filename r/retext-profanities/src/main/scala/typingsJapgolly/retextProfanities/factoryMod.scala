...
import typingsJapgolly.retextProfanities.anon.Plural
import typingsJapgolly.retextProfanities.retextProfanitiesInts.`0`
import typingsJapgolly.retextProfanities.retextProfanitiesInts.`1`
import typingsJapgolly.retextProfanities.retextProfanitiesInts.`2`
import typingsJapgolly.std.Record
import typingsJapgolly.unified.mod.Processor
...
object factoryMod {
  ...
  inline def factory(config: Config): js.ThisFunction1[
    /* this */ Processor[Unit, typingsJapgolly.nlcst.mod.Root, Unit, Unit], 
    /* options */ js.UndefOr[Options], 
    Unit | (Transformer[typingsJapgolly.nlcst.mod.Root, typingsJapgolly.nlcst.mod.Root])
