package typingsJapgolly.reactWow
...
object mod {
  ...
  type ReactWOW = japgolly.scalajs.react.facade.React.Component[ReactWOWProps & js.Object, js.Object]
  ...
  trait ReactWOWProps extends StObject {
    ...
    /**
      ...
      */
    var animation: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 76, starting with typingsJapgolly.reactWow.reactWowStrings.bounce, typingsJapgolly.reactWow.reactWowStrings.flash, typingsJapgolly.reactWow.reactWowStrings.pulse */ Any
  ...
  object ReactWOWProps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(animation = animation.asInstanceOf[js.Any], children = children.rawElement.asInstanceOf[js.Any])
    ...
    extension [Self <: ReactWOWProps](x: Self) {
      ...
      inline def setAnimation(
        value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 76, starting with typingsJapgolly.reactWow.reactWowStrings.bounce, typingsJapgolly.reactWow.reactWowStrings.flash, typingsJapgolly.reactWow.reactWowStrings.pulse */ Any
