package typingsJapgolly.reactSpringTypes

import typingsJapgolly.reactSpringTypes.animatedMod.Animatable
import typingsJapgolly.reactSpringTypes.utilMod.Arrify
...
object interpolationMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactSpringTypes.reactSpringTypesStrings.identity
    - typingsJapgolly.reactSpringTypes.reactSpringTypesStrings.clamp
    - typingsJapgolly.reactSpringTypes.reactSpringTypesStrings.extend
  */
  trait ExtrapolateType extends StObject
  object ExtrapolateType {
    
    inline def clamp: typingsJapgolly.reactSpringTypes.reactSpringTypesStrings.clamp = "clamp".asInstanceOf[typingsJapgolly.reactSpringTypes.reactSpringTypesStrings.clamp]
    
    inline def extend: typingsJapgolly.reactSpringTypes.reactSpringTypesStrings.extend = "extend".asInstanceOf[typingsJapgolly.reactSpringTypes.reactSpringTypesStrings.extend]
    
    inline def identity: typingsJapgolly.reactSpringTypes.reactSpringTypesStrings.identity = "identity".asInstanceOf[typingsJapgolly.reactSpringTypes.reactSpringTypesStrings.identity]
  }
