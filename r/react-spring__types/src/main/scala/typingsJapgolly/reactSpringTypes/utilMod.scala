...
import typingsJapgolly.reactSpringTypes.reactSpringTypesBooleans.`false`
import typingsJapgolly.reactSpringTypes.reactSpringTypesStrings.prototype
...
object utilMod {
  ...
  type ComponentType[P] = (ComponentClassP[P & js.Object]) | LeafFunctionComponent[P]
  ...
  type ElementType[P] = japgolly.scalajs.react.facade.React.ElementType | LeafFunctionComponent[P]
