...
object mod {
  ...
  object SQLErrors extends StObject {
    ...
    sealed trait CONSTRAINT_ERR
      extends StObject
         with SQLErrors
    /* 6 */ val CONSTRAINT_ERR: typingsJapgolly.reactNativeSqliteStorage.mod.SQLErrors.CONSTRAINT_ERR & Double = js.native
    
    @js.native
    sealed trait DATABASE_ERR
      extends StObject
         with SQLErrors
    /* 1 */ val DATABASE_ERR: typingsJapgolly.reactNativeSqliteStorage.mod.SQLErrors.DATABASE_ERR & Double = js.native
    
    @js.native
    sealed trait QUOTA_ERR
      extends StObject
         with SQLErrors
    /* 4 */ val QUOTA_ERR: typingsJapgolly.reactNativeSqliteStorage.mod.SQLErrors.QUOTA_ERR & Double = js.native
    
    @js.native
    sealed trait SYNTAX_ERR
      extends StObject
         with SQLErrors
    /* 5 */ val SYNTAX_ERR: typingsJapgolly.reactNativeSqliteStorage.mod.SQLErrors.SYNTAX_ERR & Double = js.native
    
    @js.native
    sealed trait TIMEOUT_ERR
      extends StObject
         with SQLErrors
    /* 7 */ val TIMEOUT_ERR: typingsJapgolly.reactNativeSqliteStorage.mod.SQLErrors.TIMEOUT_ERR & Double = js.native
    
    @js.native
    sealed trait TOO_LARGE_ERR
      extends StObject
         with SQLErrors
    /* 3 */ val TOO_LARGE_ERR: typingsJapgolly.reactNativeSqliteStorage.mod.SQLErrors.TOO_LARGE_ERR & Double = js.native
    
    @js.native
    sealed trait UNKNOWN_ERR
      extends StObject
         with SQLErrors
    /* 0 */ val UNKNOWN_ERR: typingsJapgolly.reactNativeSqliteStorage.mod.SQLErrors.UNKNOWN_ERR & Double = js.native
    
    @js.native
    sealed trait VERSION_ERR
      extends StObject
         with SQLErrors
    /* 2 */ val VERSION_ERR: typingsJapgolly.reactNativeSqliteStorage.mod.SQLErrors.VERSION_ERR & Double = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNativeSqliteStorage.mod.DatabaseParamsIOS
    - typingsJapgolly.reactNativeSqliteStorage.mod.DatabaseParamsAndroid
  */
  trait DatabaseParams extends StObject
  object DatabaseParams {
    
    inline def DatabaseParamsAndroid(name: String): typingsJapgolly.reactNativeSqliteStorage.mod.DatabaseParamsAndroid = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reactNativeSqliteStorage.mod.DatabaseParamsAndroid]
    }
    
    inline def DatabaseParamsIOS(location: Location, name: String): typingsJapgolly.reactNativeSqliteStorage.mod.DatabaseParamsIOS = {
      val __obj = js.Dynamic.literal(location = location.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reactNativeSqliteStorage.mod.DatabaseParamsIOS]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNativeSqliteStorage.reactNativeSqliteStorageStrings.default
    - typingsJapgolly.reactNativeSqliteStorage.reactNativeSqliteStorageStrings.Library
    - typingsJapgolly.reactNativeSqliteStorage.reactNativeSqliteStorageStrings.Documents
    - typingsJapgolly.reactNativeSqliteStorage.reactNativeSqliteStorageStrings.Shared
  */
  trait Location extends StObject
  object Location {
    
    inline def default: typingsJapgolly.reactNativeSqliteStorage.reactNativeSqliteStorageStrings.default = "default".asInstanceOf[typingsJapgolly.reactNativeSqliteStorage.reactNativeSqliteStorageStrings.default]
    
    inline def Documents: typingsJapgolly.reactNativeSqliteStorage.reactNativeSqliteStorageStrings.Documents = "Documents".asInstanceOf[typingsJapgolly.reactNativeSqliteStorage.reactNativeSqliteStorageStrings.Documents]
    
    inline def Library: typingsJapgolly.reactNativeSqliteStorage.reactNativeSqliteStorageStrings.Library = "Library".asInstanceOf[typingsJapgolly.reactNativeSqliteStorage.reactNativeSqliteStorageStrings.Library]
    
    inline def Shared: typingsJapgolly.reactNativeSqliteStorage.reactNativeSqliteStorageStrings.Shared = "Shared".asInstanceOf[typingsJapgolly.reactNativeSqliteStorage.reactNativeSqliteStorageStrings.Shared]
  }
  ...
  object ResultSetRowList {
    ...
    inline def apply(item: Double => Any, length: Double, raw: CallbackTo[js.Array[Any]]): ResultSetRowList = {
      val __obj = js.Dynamic.literal(item = js.Any.fromFunction1(item), length = length.asInstanceOf[js.Any], raw = raw.toJsFn)
    ...
    extension [Self <: ResultSetRowList](x: Self) {
      ...
      inline def setRaw(value: CallbackTo[js.Array[Any]]): Self = StObject.set(x, "raw", value.toJsFn)
    }
  }
