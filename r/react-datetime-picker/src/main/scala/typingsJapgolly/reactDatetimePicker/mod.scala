...
object mod {
  ...
  object DateTimePickerProps {
    ...
    extension [Self <: DateTimePickerProps](x: Self) {
      ...
      inline def setCalendarIcon(value: VdomElement): Self = StObject.set(x, "calendarIcon", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setClearIcon(value: VdomElement): Self = StObject.set(x, "clearIcon", value.rawElement.asInstanceOf[js.Any])
