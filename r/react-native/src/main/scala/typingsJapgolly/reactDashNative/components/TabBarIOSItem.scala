...
import typingsJapgolly.reactDashNative.reactDashNativeMod.TabBarIOSItemProps
...
object TabBarIOSItem {
  def apply(
    ...
    TabBarIOSItemProps, 
    typingsJapgolly.reactDashNative.reactDashNativeMod.TabBarIOSItem, 
    Unit, 
    TabBarIOSItemProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.TabBarIOSItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.TabBarIOSItem](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.TabBarIOSItem])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.TabBarIOSItemProps])(children: _*)
  }
}
