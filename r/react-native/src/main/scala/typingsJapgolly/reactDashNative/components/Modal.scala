...
import typingsJapgolly.reactDashNative.reactDashNativeMod.ModalProps
...
object Modal {
  def apply(
    props: ModalProps with js.Object,
    key: js.UndefOr[Key] = js.undefined,
    overrides: StringDictionary[js.Any] = null
  )(
    children: ChildArg*
  ): UnmountedWithRoot[
    ModalProps with js.Object, 
    typingsJapgolly.reactDashNative.reactDashNativeMod.Modal, 
    Unit, 
    ModalProps with js.Object
  ] = {
