...
import typingsJapgolly.reactDashNative.reactDashNativeMod.PickerIOSProps
...
object PickerIOS {
  def apply(
    ...
    PickerIOSProps, 
    typingsJapgolly.reactDashNative.reactDashNativeMod.PickerIOS, 
    Unit, 
    PickerIOSProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.PickerIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.PickerIOS](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.PickerIOS])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.PickerIOSProps])(children: _*)
  }
}
