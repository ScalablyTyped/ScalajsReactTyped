...
object TouchableHighlight {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableHighlight](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableHighlight])
