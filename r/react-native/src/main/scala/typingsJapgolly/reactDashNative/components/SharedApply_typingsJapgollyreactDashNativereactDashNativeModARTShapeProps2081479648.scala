...
import typingsJapgolly.reactDashNative.reactDashNativeMod.ARTShapeProps
...
abstract class SharedApply_typingsJapgollyreactDashNativereactDashNativeModARTShapeProps2081479648[ComponentRef] () {
