...
import typingsJapgolly.reactDashNative.reactDashNativeMod.TabBarIOSProps
...
import typingsJapgolly.reactDashNative.reactDashNativeStrings.fill
...
object TabBarIOS {
  def apply(
    ...
    TabBarIOSProps, 
    typingsJapgolly.reactDashNative.reactDashNativeMod.TabBarIOS, 
    Unit, 
    TabBarIOSProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.TabBarIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.TabBarIOS](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.TabBarIOS])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.TabBarIOSProps])(children: _*)
  }
}
