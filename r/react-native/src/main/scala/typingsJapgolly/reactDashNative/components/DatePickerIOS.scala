...
import typingsJapgolly.reactDashNative.reactDashNativeMod.DatePickerIOSProps
...
object DatePickerIOS {
  def apply(
    ...
    DatePickerIOSProps, 
    typingsJapgolly.reactDashNative.reactDashNativeMod.DatePickerIOS, 
    Unit, 
    DatePickerIOSProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.DatePickerIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.DatePickerIOS](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.DatePickerIOS])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.DatePickerIOSProps])(children: _*)
  }
}
