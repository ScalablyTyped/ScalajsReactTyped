...
import typingsJapgolly.reactDashNative.reactDashNativeMod.SegmentedControlIOSProps
...
object SegmentedControlIOS {
  def apply(
    ...
    typingsJapgolly.reactDashNative.reactDashNativeMod.SegmentedControlIOS, 
    Unit, 
    SegmentedControlIOSProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.SegmentedControlIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.SegmentedControlIOS](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.SegmentedControlIOS])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.SegmentedControlIOSProps])(children: _*)
  }
}
