...
import typingsJapgolly.reactDashNative.reactDashNativeMod.PickerProps
...
object Picker {
  def apply(
    ...
    PickerProps, 
    typingsJapgolly.reactDashNative.reactDashNativeMod.Picker, 
    Unit, 
    PickerProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.PickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.Picker](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.Picker])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.PickerProps])(children: _*)
  }
}
