...
import typingsJapgolly.reactDashNative.reactDashNativeMod.RefreshControlProps
...
object RefreshControl {
  def apply(
    ...
    RefreshControlProps, 
    typingsJapgolly.reactDashNative.reactDashNativeMod.RefreshControl, 
    Unit, 
    RefreshControlProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.RefreshControlProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.RefreshControl](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.RefreshControl])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.RefreshControlProps])(children: _*)
  }
}
