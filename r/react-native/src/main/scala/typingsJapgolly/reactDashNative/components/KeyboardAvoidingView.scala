...
import typingsJapgolly.reactDashNative.reactDashNativeMod.KeyboardAvoidingViewProps
...
import typingsJapgolly.reactDashNative.reactDashNativeStrings.height
...
import typingsJapgolly.reactDashNative.reactDashNativeStrings.padding
import typingsJapgolly.reactDashNative.reactDashNativeStrings.polite
import typingsJapgolly.reactDashNative.reactDashNativeStrings.position
...
object KeyboardAvoidingView {
  def apply(
    ...
    typingsJapgolly.reactDashNative.reactDashNativeMod.KeyboardAvoidingView, 
    Unit, 
    KeyboardAvoidingViewProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.KeyboardAvoidingViewProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.KeyboardAvoidingView](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.KeyboardAvoidingView])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.KeyboardAvoidingViewProps])(children: _*)
  }
}
