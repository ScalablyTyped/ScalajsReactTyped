...
import typingsJapgolly.reactDashNative.reactDashNativeMod.SliderProps
...
object Slider {
  def apply(
    ...
    SliderProps, 
    typingsJapgolly.reactDashNative.reactDashNativeMod.Slider, 
    Unit, 
    SliderProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.SliderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.Slider](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.Slider])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.SliderProps])(children: _*)
  }
}
