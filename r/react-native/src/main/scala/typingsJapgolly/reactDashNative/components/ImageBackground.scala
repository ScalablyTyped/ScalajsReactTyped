...
import typingsJapgolly.reactDashNative.reactDashNativeMod.ImageBackgroundProps
...
object ImageBackground {
  def apply(
    ...
    imageRef: /* image */ typingsJapgolly.reactDashNative.reactDashNativeMod.Image => Callback = null,
    ...
    typingsJapgolly.reactDashNative.reactDashNativeMod.ImageBackground, 
    Unit, 
    ImageBackgroundProps
  ] = {
