...
import typingsJapgolly.reactDashNative.Anon_False
...
import typingsJapgolly.reactDashNative.reactDashNativeMod.SwitchProps
...
object Switch {
  def apply(
    ...
    onValueChange: /* value */ Boolean => Callback = null,
    ...
    SwitchProps, 
    typingsJapgolly.reactDashNative.reactDashNativeMod.Switch, 
    Unit, 
    SwitchProps
  ] = {
    ...
    if (onValueChange != null) __obj.updateDynamic("onValueChange")(js.Any.fromFunction1((t0: /* value */ scala.Boolean) => onValueChange(t0).runNow()))
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.SwitchProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.Switch](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.Switch])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.SwitchProps])(children: _*)
  }
}
