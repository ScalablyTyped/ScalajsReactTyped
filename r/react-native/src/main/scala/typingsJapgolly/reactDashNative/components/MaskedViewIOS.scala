...
import typingsJapgolly.reactDashNative.reactDashNativeMod.MaskedViewIOSProps
...
object MaskedViewIOS {
  def apply(
    ...
    MaskedViewIOSProps, 
    typingsJapgolly.reactDashNative.reactDashNativeMod.MaskedViewIOS, 
    Unit, 
    MaskedViewIOSProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.MaskedViewIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.MaskedViewIOS](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.MaskedViewIOS])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.MaskedViewIOSProps])(children: _*)
  }
}
