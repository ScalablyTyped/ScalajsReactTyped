...
import typingsJapgolly.reactDashNative.reactDashNativeMod.ARTGroupProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_typingsJapgollyreactDashNativereactDashNativeModARTGroupProps_845250071[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ARTGroupProps, ComponentRef, Unit, ARTGroupProps] = {
