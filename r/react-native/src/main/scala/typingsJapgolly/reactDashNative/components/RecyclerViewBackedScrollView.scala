...
import typingsJapgolly.reactDashNative.reactDashNativeMod.RecyclerViewBackedScrollViewProps
...
object RecyclerViewBackedScrollView {
  def apply(
    ...
    typingsJapgolly.reactDashNative.reactDashNativeMod.RecyclerViewBackedScrollView, 
    Unit, 
    RecyclerViewBackedScrollViewProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.RecyclerViewBackedScrollViewProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.RecyclerViewBackedScrollView](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.RecyclerViewBackedScrollView])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.RecyclerViewBackedScrollViewProps])(children: _*)
  }
}
