...
object FlatList {
  def apply[ItemT](
    ...
    FlatListProps[ItemT], 
    typingsJapgolly.reactDashNative.reactDashNativeMod.FlatList[ItemT], 
    Unit, 
    FlatListProps[ItemT]
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.FlatList[ItemT]](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.FlatList[ItemT]])
