...
import typingsJapgolly.reactDashNative.reactDashNativeMod.SnapshotViewIOSProps
...
object SnapshotViewIOS {
  def apply(
    ...
    onSnapshotReady: CallbackTo[js.Any],
    ...
    typingsJapgolly.reactDashNative.reactDashNativeMod.SnapshotViewIOS, 
    Unit, 
    SnapshotViewIOSProps
  ] = {
    val __obj = js.Dynamic.literal(testIdentifier = testIdentifier.asInstanceOf[js.Any])
  
      __obj.updateDynamic("onSnapshotReady")(onSnapshotReady.toJsFn)
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.SnapshotViewIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.SnapshotViewIOS](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.SnapshotViewIOS])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.SnapshotViewIOSProps])(children: _*)
  }
}
