...
import typingsJapgolly.reactDashNative.reactDashNativeMod.TextProps
...
object Text {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextProps, typingsJapgolly.reactDashNative.reactDashNativeMod.Text, Unit, TextProps] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.TextProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.Text](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.Text])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.TextProps])(children: _*)
  }
}
