...
import typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableNativeFeedbackProps
...
object TouchableNativeFeedback {
  def apply(
    ...
    typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableNativeFeedback, 
    Unit, 
    TouchableNativeFeedbackProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableNativeFeedbackProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableNativeFeedback](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableNativeFeedback])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.TouchableNativeFeedbackProps])(children: _*)
  }
}
