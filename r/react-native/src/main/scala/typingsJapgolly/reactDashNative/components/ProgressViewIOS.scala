...
import typingsJapgolly.reactDashNative.reactDashNativeMod.ProgressViewIOSProps
...
import typingsJapgolly.reactDashNative.reactDashNativeStrings.bar
...
object ProgressViewIOS {
  def apply(
    ...
    typingsJapgolly.reactDashNative.reactDashNativeMod.ProgressViewIOS, 
    Unit, 
    ProgressViewIOSProps
  ] = {
    ...
    if (progressTintColor != null) __obj.updateDynamic("progressTintColor")(progressTintColor.asInstanceOf[js.Any])
    ...
    if (trackTintColor != null) __obj.updateDynamic("trackTintColor")(trackTintColor.asInstanceOf[js.Any])
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.ProgressViewIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.ProgressViewIOS](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.ProgressViewIOS])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.ProgressViewIOSProps])(children: _*)
  }
}
