...
import typingsJapgolly.reactDashNative.reactDashNativeMod.ProgressBarAndroidProps
...
import typingsJapgolly.reactDashNative.reactDashNativeStrings.Horizontal
import typingsJapgolly.reactDashNative.reactDashNativeStrings.Inverse
import typingsJapgolly.reactDashNative.reactDashNativeStrings.Large
import typingsJapgolly.reactDashNative.reactDashNativeStrings.LargeInverse
import typingsJapgolly.reactDashNative.reactDashNativeStrings.Normal
import typingsJapgolly.reactDashNative.reactDashNativeStrings.Small
import typingsJapgolly.reactDashNative.reactDashNativeStrings.SmallInverse
...
object ProgressBarAndroid {
  def apply(
    ...
    typingsJapgolly.reactDashNative.reactDashNativeMod.ProgressBarAndroid, 
    Unit, 
    ProgressBarAndroidProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.ProgressBarAndroidProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.ProgressBarAndroid](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.ProgressBarAndroid])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.ProgressBarAndroidProps])(children: _*)
  }
}
