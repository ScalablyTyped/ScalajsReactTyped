...
import typingsJapgolly.reactDashNative.reactDashNativeMod.ViewPagerAndroidProps
...
object ViewPagerAndroid {
  def apply(
    ...
    typingsJapgolly.reactDashNative.reactDashNativeMod.ViewPagerAndroid, 
    Unit, 
    ViewPagerAndroidProps
  ] = {
    ...
    if (onPageScroll != null) __obj.updateDynamic("onPageScroll")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[typingsJapgolly.reactDashNative.NodeHandle with org.scalajs.dom.raw.Element]) => onPageScroll(t0).runNow()))
    if (onPageScrollStateChanged != null) __obj.updateDynamic("onPageScrollStateChanged")(js.Any.fromFunction1((t0: /* state */ typingsJapgolly.reactDashNative.reactDashNativeStrings.Idle | typingsJapgolly.reactDashNative.reactDashNativeStrings.Dragging | typingsJapgolly.reactDashNative.reactDashNativeStrings.Settling) => onPageScrollStateChanged(t0).runNow()))
    if (onPageSelected != null) __obj.updateDynamic("onPageSelected")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[typingsJapgolly.reactDashNative.NodeHandle with org.scalajs.dom.raw.Element]) => onPageSelected(t0).runNow()))
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.ViewPagerAndroidProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.ViewPagerAndroid](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.ViewPagerAndroid])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.ViewPagerAndroidProps])(children: _*)
  }
}
