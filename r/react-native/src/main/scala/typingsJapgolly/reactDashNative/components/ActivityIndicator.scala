...
import typingsJapgolly.reactDashNative.reactDashNativeMod.ActivityIndicatorProps
...
import typingsJapgolly.reactDashNative.reactDashNativeStrings.large_
...
import typingsJapgolly.reactDashNative.reactDashNativeStrings.small_
...
object ActivityIndicator {
  def apply(
    ...
    typingsJapgolly.reactDashNative.reactDashNativeMod.ActivityIndicator, 
    Unit, 
    ActivityIndicatorProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.ActivityIndicatorProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.ActivityIndicator](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.ActivityIndicator])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.ActivityIndicatorProps])(children: _*)
  }
}
