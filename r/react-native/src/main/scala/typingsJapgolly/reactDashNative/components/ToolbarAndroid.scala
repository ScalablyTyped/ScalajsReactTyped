...
import typingsJapgolly.reactDashNative.reactDashNativeMod.ToolbarAndroidProps
...
object ToolbarAndroid {
  def apply(
    ...
    ToolbarAndroidProps, 
    typingsJapgolly.reactDashNative.reactDashNativeMod.ToolbarAndroid, 
    Unit, 
    ToolbarAndroidProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.ToolbarAndroidProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.ToolbarAndroid](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.ToolbarAndroid])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.ToolbarAndroidProps])(children: _*)
  }
}
