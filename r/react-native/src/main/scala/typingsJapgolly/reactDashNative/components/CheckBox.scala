...
import typingsJapgolly.reactDashNative.reactDashNativeMod.CheckBoxProps
...
object CheckBox {
  def apply(
    ...
    CheckBoxProps, 
    typingsJapgolly.reactDashNative.reactDashNativeMod.CheckBox, 
    Unit, 
    CheckBoxProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.CheckBoxProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.CheckBox](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.CheckBox])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.CheckBoxProps])(children: _*)
  }
}
