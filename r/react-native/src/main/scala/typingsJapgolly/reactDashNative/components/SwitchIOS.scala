...
import typingsJapgolly.reactDashNative.reactDashNativeMod.SwitchIOSProps
...
object SwitchIOS {
  def apply(
    ...
    SwitchIOSProps, 
    typingsJapgolly.reactDashNative.reactDashNativeMod.SwitchIOS, 
    Unit, 
    SwitchIOSProps
  ] = {
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.SwitchIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNative.reactDashNativeMod.SwitchIOS](js.constructorOf[typingsJapgolly.reactDashNative.reactDashNativeMod.SwitchIOS])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.SwitchIOSProps])(children: _*)
  }
}
