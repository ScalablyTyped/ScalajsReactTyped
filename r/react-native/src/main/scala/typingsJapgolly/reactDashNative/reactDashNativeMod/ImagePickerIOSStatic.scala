...
object ImagePickerIOSStatic {
  ...
  def apply(
    ...
    __obj.updateDynamic("openCameraDialog")(js.Any.fromFunction3((t0: typingsJapgolly.reactDashNative.reactDashNativeMod.OpenCameraDialogOptions, t1: js.Function1[
  /* args */ typingsJapgolly.reactDashNative.reactDashNativeMod.ImagePickerResult, 
  scala.Unit], t2: js.Function1[/* args */ js.Array[js.Any], scala.Unit]) => openCameraDialog(t0, t1, t2).runNow()))
    __obj.updateDynamic("openSelectDialog")(js.Any.fromFunction3((t0: typingsJapgolly.reactDashNative.reactDashNativeMod.OpenSelectDialogOptions, t1: js.Function1[
  /* args */ typingsJapgolly.reactDashNative.reactDashNativeMod.ImagePickerResult, 
  scala.Unit], t2: js.Function1[/* args */ js.Array[js.Any], scala.Unit]) => openSelectDialog(t0, t1, t2).runNow()))
