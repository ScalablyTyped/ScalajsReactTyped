...
trait ARTStatic extends js.Object {
  var ClippingRectangle: Instantiable0[typingsJapgolly.reactDashNative.reactDashNativeMod.ClippingRectangle]
  var Group: Instantiable0[typingsJapgolly.reactDashNative.reactDashNativeMod.Group]
  var Shape: Instantiable0[typingsJapgolly.reactDashNative.reactDashNativeMod.Shape]
  var Surface: Instantiable0[typingsJapgolly.reactDashNative.reactDashNativeMod.Surface]
