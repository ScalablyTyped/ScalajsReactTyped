...
object ImageEditorStatic {
  ...
  def apply(
    ...
    __obj.updateDynamic("cropImage")(js.Any.fromFunction4((t0: java.lang.String, t1: typingsJapgolly.reactDashNative.reactDashNativeMod.ImageCropData, t2: js.Function1[/* uri */ java.lang.String, scala.Unit], t3: js.Function1[/* error */ js.Object, scala.Unit]) => cropImage(t0, t1, t2, t3).runNow()))
