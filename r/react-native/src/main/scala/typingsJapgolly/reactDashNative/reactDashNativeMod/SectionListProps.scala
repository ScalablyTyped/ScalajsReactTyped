...
trait SectionListProps[ItemT] extends VirtualizedListWithoutRenderItemProps[ItemT] {
  ...
  /**
    ...
    */
  var renderSectionFooter: js.UndefOr[js.Function1[/* info */ Anon_Section[ItemT], Element | Null]] = js.undefined
  /**
    * Rendered at the top of each section. Sticky headers are not yet supported.
    */
  var renderSectionHeader: js.UndefOr[js.Function1[/* info */ Anon_Section[ItemT], Element | Null]] = js.undefined
  /**
...
object SectionListProps {
  ...
  def apply[ItemT](
    ...
    getItemLayout: (/* data */ js.Array[SectionListData[ItemT]] | Null, /* index */ Double) => CallbackTo[Anon_Index] = null,
    ...
    renderSectionFooter: /* info */ Anon_Section[ItemT] => CallbackTo[Element | Null] = null,
    renderSectionHeader: /* info */ Anon_Section[ItemT] => CallbackTo[Element | Null] = null,
    ...
    if (getItemLayout != null) __obj.updateDynamic("getItemLayout")(js.Any.fromFunction2((t0: /* data */ js.Array[typingsJapgolly.reactDashNative.reactDashNativeMod.SectionListData[ItemT]] | scala.Null, t1: /* index */ scala.Double) => getItemLayout(t0, t1).runNow()))
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.NodeHandle with org.scalajs.dom.raw.Element]) => onTouchStart(t0).runNow()))
    ...
    if (renderSectionFooter != null) __obj.updateDynamic("renderSectionFooter")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.reactDashNative.Anon_Section[ItemT]) => renderSectionFooter(t0).runNow()))
    if (renderSectionHeader != null) __obj.updateDynamic("renderSectionHeader")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.reactDashNative.Anon_Section[ItemT]) => renderSectionHeader(t0).runNow()))
