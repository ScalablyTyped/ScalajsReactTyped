...
object AccessibilityInfoStatic {
  ...
  def apply(
    ...
    __obj.updateDynamic("addEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.reactDashNative.reactDashNativeMod.AccessibilityEventName, t1: js.Function1[
  /* event */ typingsJapgolly.reactDashNative.reactDashNativeMod.AccessibilityEvent, 
  scala.Unit]) => addEventListener(t0, t1).runNow()))
    ...
    __obj.updateDynamic("removeEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.reactDashNative.reactDashNativeMod.AccessibilityEventName, t1: js.Function1[
  /* event */ typingsJapgolly.reactDashNative.reactDashNativeMod.AccessibilityEvent, 
