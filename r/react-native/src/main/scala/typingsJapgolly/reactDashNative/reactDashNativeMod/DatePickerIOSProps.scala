...
import typingsJapgolly.reactDashNative.reactDashNativeNumbers.`10`
import typingsJapgolly.reactDashNative.reactDashNativeNumbers.`12`
import typingsJapgolly.reactDashNative.reactDashNativeNumbers.`15`
import typingsJapgolly.reactDashNative.reactDashNativeNumbers.`1`
import typingsJapgolly.reactDashNative.reactDashNativeNumbers.`20`
import typingsJapgolly.reactDashNative.reactDashNativeNumbers.`2`
import typingsJapgolly.reactDashNative.reactDashNativeNumbers.`30`
import typingsJapgolly.reactDashNative.reactDashNativeNumbers.`3`
import typingsJapgolly.reactDashNative.reactDashNativeNumbers.`4`
import typingsJapgolly.reactDashNative.reactDashNativeNumbers.`5`
import typingsJapgolly.reactDashNative.reactDashNativeNumbers.`6`
...
import typingsJapgolly.reactDashNative.reactDashNativeStrings.date
import typingsJapgolly.reactDashNative.reactDashNativeStrings.datetime
...
import typingsJapgolly.reactDashNative.reactDashNativeStrings.time
...
object DatePickerIOSProps {
  ...
  def apply(
    ...
    __obj.updateDynamic("onDateChange")(js.Any.fromFunction1((t0: js.Date) => onDateChange(t0).runNow()))
