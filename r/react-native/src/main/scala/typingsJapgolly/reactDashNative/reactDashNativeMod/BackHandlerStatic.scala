...
object BackHandlerStatic {
  ...
  def apply(
    ...
    __obj.updateDynamic("addEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.reactDashNative.reactDashNativeMod.BackPressEventName, t1: js.Function0[scala.Unit]) => addEventListener(t0, t1).runNow()))
    __obj.updateDynamic("exitApp")(exitApp.toJsFn)
    __obj.updateDynamic("removeEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.reactDashNative.reactDashNativeMod.BackPressEventName, t1: js.Function0[scala.Unit]) => removeEventListener(t0, t1).runNow()))
