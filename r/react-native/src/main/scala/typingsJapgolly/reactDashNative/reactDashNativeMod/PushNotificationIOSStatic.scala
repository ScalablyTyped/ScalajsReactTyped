...
import typingsJapgolly.reactDashNative.Anon_Code
import typingsJapgolly.reactDashNative.reactDashNativeStrings.localNotification
import typingsJapgolly.reactDashNative.reactDashNativeStrings.notification
import typingsJapgolly.reactDashNative.reactDashNativeStrings.register
import typingsJapgolly.reactDashNative.reactDashNativeStrings.registrationError
...
trait PushNotificationIOSStatic extends js.Object {
  /**
    ...
    */
  var FetchResult: typingsJapgolly.reactDashNative.reactDashNativeMod.FetchResult = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("addEventListener")
  def addEventListener_registrationError(`type`: registrationError, handler: js.Function1[/* error */ Anon_Code, Unit]): Unit = js.native
  /**
  ...
  def removeEventListener(
    ...
    handler: js.Function1[
      (/* error */ Anon_Code) | (/* notification */ PushNotification) | (/* deviceToken */ String), 
      Unit
    ]
  ): Unit = js.native
  /**
  ...
  def requestPermissions_Unit(): Unit = js.native
  /**
