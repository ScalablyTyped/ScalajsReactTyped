...
object CameraRollAssetType {
  @scala.inline
  def All: typingsJapgolly.reactDashNative.reactDashNativeStrings.All = this.cast("All")
  @scala.inline
  def Photos: typingsJapgolly.reactDashNative.reactDashNativeStrings.Photos = this.cast("Photos")
  @scala.inline
  def Videos: typingsJapgolly.reactDashNative.reactDashNativeStrings.Videos = this.cast("Videos")
  @scala.inline
