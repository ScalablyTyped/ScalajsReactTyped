...
object ErrorUtils {
  ...
  def apply(
    ...
    __obj.updateDynamic("setGlobalHandler")(js.Any.fromFunction1((t0: typingsJapgolly.reactDashNative.reactDashNativeMod.ErrorHandlerCallback) => setGlobalHandler(t0).runNow()))
