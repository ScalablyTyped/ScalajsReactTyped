...
trait ShareStatic extends js.Object {
  var dismissedAction: typingsJapgolly.reactDashNative.reactDashNativeStrings.dismissedAction = js.native
  var sharedAction: typingsJapgolly.reactDashNative.reactDashNativeStrings.sharedAction = js.native
  /**
