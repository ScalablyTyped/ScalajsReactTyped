...
object NativeMethodsMixinStatic {
  ...
  def apply(
    ...
    __obj.updateDynamic("measure")(js.Any.fromFunction1((t0: typingsJapgolly.reactDashNative.reactDashNativeMod.MeasureOnSuccessCallback) => measure(t0).runNow()))
    __obj.updateDynamic("measureInWindow")(js.Any.fromFunction1((t0: typingsJapgolly.reactDashNative.reactDashNativeMod.MeasureInWindowOnSuccessCallback) => measureInWindow(t0).runNow()))
    __obj.updateDynamic("measureLayout")(js.Any.fromFunction3((t0: scala.Double, t1: typingsJapgolly.reactDashNative.reactDashNativeMod.MeasureLayoutOnSuccessCallback, t2: js.Function0[scala.Unit]) => measureLayout(t0, t1, t2).runNow()))
