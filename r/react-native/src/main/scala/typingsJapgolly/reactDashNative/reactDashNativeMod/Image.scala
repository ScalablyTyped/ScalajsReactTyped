...
import typingsJapgolly.reactDashNative.reactDashNativeStrings.`disk/memory`
import typingsJapgolly.reactDashNative.reactDashNativeStrings.disk
import typingsJapgolly.reactDashNative.reactDashNativeStrings.memory
