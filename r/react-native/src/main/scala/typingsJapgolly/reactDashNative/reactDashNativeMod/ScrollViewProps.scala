...
trait ScrollViewProps
  ...
  /**
    ...
    */
  var onMomentumScrollBegin: js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]] = js.undefined
  /**
    * Fires when scroll view has finished moving
    */
  var onMomentumScrollEnd: js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var onScrollBeginDrag: js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]] = js.undefined
  /**
    * Fires when a user has finished scrolling.
    */
  var onScrollEndDrag: js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var refreshControl: js.UndefOr[japgolly.scalajs.react.raw.React.Element] = js.undefined
  /**
