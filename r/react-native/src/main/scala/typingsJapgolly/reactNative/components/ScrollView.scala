...
object ScrollView {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ScrollViewProps, typingsJapgolly.reactNative.mod.ScrollView, Unit, ScrollViewProps] = {
  ...
  typingsJapgolly.reactNative.mod.ScrollViewProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.ScrollView](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.ScrollViewProps])(children: _*)
  }
