...
object Slider {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SliderProps, typingsJapgolly.reactNative.mod.Slider, Unit, SliderProps] = {
  ...
  typingsJapgolly.reactNative.mod.SliderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.Slider](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.SliderProps])(children: _*)
  }
