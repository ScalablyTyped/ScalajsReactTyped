...
import typingsJapgolly.reactNative.mod.PickerIOSProps
...
object PickerIOS {
  def apply(
    ...
    onValueChange: /* value */ String | Double => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PickerIOSProps, typingsJapgolly.reactNative.mod.PickerIOS, Unit, PickerIOSProps] = {
    ...
    if (onValueChange != null) __obj.updateDynamic("onValueChange")(js.Any.fromFunction1((t0: /* value */ java.lang.String | scala.Double) => onValueChange(t0).runNow()))
  ...
  typingsJapgolly.reactNative.mod.PickerIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.PickerIOS](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.PickerIOSProps])(children: _*)
  }
