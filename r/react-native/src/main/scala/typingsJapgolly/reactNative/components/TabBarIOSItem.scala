...
import typingsJapgolly.reactNative.mod.TabBarIOSItemProps
...
object TabBarIOSItem {
  def apply(
    ...
    TabBarIOSItemProps, 
    typingsJapgolly.reactNative.mod.TabBarIOSItem, 
    Unit, 
    TabBarIOSItemProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.TabBarIOSItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.TabBarIOSItem](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.TabBarIOSItemProps])(children: _*)
  }
