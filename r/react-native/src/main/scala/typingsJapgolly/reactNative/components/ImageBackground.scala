...
object ImageBackground {
  def apply(
    ...
    imageRef: /* image */ typingsJapgolly.reactNative.mod.Image => Callback = null,
    ...
    typingsJapgolly.reactNative.mod.ImageBackground, 
    Unit, 
    ImageBackgroundProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.ImageBackgroundProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.ImageBackground](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.ImageBackgroundProps])(children: _*)
  }
