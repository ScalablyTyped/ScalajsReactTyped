...
object RefreshControl {
  def apply(
    ...
    RefreshControlProps, 
    typingsJapgolly.reactNative.mod.RefreshControl, 
    Unit, 
    RefreshControlProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.RefreshControlProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.RefreshControl](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.RefreshControlProps])(children: _*)
  }
