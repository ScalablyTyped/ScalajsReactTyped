...
object Switch {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SwitchProps, typingsJapgolly.reactNative.mod.Switch, Unit, SwitchProps] = {
  ...
  typingsJapgolly.reactNative.mod.SwitchProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.Switch](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.SwitchProps])(children: _*)
  }
