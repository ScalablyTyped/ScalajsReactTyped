...
import typingsJapgolly.reactNative.reactNativeNumbers.`10`
import typingsJapgolly.reactNative.reactNativeNumbers.`12`
import typingsJapgolly.reactNative.reactNativeNumbers.`15`
import typingsJapgolly.reactNative.reactNativeNumbers.`1`
import typingsJapgolly.reactNative.reactNativeNumbers.`20`
import typingsJapgolly.reactNative.reactNativeNumbers.`2`
import typingsJapgolly.reactNative.reactNativeNumbers.`30`
import typingsJapgolly.reactNative.reactNativeNumbers.`3`
import typingsJapgolly.reactNative.reactNativeNumbers.`4`
import typingsJapgolly.reactNative.reactNativeNumbers.`5`
import typingsJapgolly.reactNative.reactNativeNumbers.`6`
...
object DatePickerIOS {
  def apply(
    ...
    DatePickerIOSProps, 
    typingsJapgolly.reactNative.mod.DatePickerIOS, 
    Unit, 
    DatePickerIOSProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.DatePickerIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.DatePickerIOS](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.DatePickerIOSProps])(children: _*)
  }
