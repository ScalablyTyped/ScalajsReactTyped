...
import typingsJapgolly.reactNative.mod.CheckBoxProps
...
object CheckBox {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CheckBoxProps, typingsJapgolly.reactNative.mod.CheckBox, Unit, CheckBoxProps] = {
  ...
  typingsJapgolly.reactNative.mod.CheckBoxProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.CheckBox](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.CheckBoxProps])(children: _*)
  }
