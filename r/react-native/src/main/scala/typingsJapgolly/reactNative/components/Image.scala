...
object Image {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ImageProps, typingsJapgolly.reactNative.mod.Image, Unit, ImageProps] = {
  ...
  typingsJapgolly.reactNative.mod.ImageProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.Image](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.ImageProps])(children: _*)
  }
