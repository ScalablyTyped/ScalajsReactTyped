...
object DrawerLayoutAndroid {
  def apply(
    ...
    typingsJapgolly.reactNative.mod.DrawerLayoutAndroid, 
    Unit, 
    DrawerLayoutAndroidProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.DrawerLayoutAndroidProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.DrawerLayoutAndroid](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.DrawerLayoutAndroidProps])(children: _*)
  }
