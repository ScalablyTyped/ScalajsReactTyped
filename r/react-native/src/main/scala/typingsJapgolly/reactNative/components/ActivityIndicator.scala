...
object ActivityIndicator {
  def apply(
    ...
    typingsJapgolly.reactNative.mod.ActivityIndicator, 
    Unit, 
    ActivityIndicatorProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.ActivityIndicatorProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.ActivityIndicator](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.ActivityIndicatorProps])(children: _*)
  }
