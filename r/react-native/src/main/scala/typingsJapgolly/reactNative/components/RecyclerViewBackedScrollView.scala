...
object RecyclerViewBackedScrollView {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNative.mod.RecyclerViewBackedScrollView] {
  ...
  implicit def make(companion: RecyclerViewBackedScrollView.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
