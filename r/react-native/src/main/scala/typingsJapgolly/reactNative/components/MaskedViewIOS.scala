...
object MaskedViewIOS {
  def apply(
    ...
    MaskedViewIOSProps, 
    typingsJapgolly.reactNative.mod.MaskedViewIOS, 
    Unit, 
    MaskedViewIOSProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.MaskedViewIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.MaskedViewIOS](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.MaskedViewIOSProps])(children: _*)
  }
