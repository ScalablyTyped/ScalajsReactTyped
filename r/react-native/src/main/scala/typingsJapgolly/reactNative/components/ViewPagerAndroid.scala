...
object ViewPagerAndroid {
  def apply(
    ...
    typingsJapgolly.reactNative.mod.ViewPagerAndroid, 
    Unit, 
    ViewPagerAndroidProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.ViewPagerAndroidProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.ViewPagerAndroid](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.ViewPagerAndroidProps])(children: _*)
  }
