...
import typingsJapgolly.reactNative.mod.ARTTextProps
...
object ARTText {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ARTTextProps, typingsJapgolly.reactNative.mod.ARTText, Unit, ARTTextProps] = {
  ...
  typingsJapgolly.reactNative.mod.ARTTextProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.ARTText](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.ARTTextProps])(children: _*)
  }
