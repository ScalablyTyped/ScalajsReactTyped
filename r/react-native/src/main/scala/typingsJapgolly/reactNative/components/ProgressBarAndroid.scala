...
object ProgressBarAndroid {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNative.mod.ProgressBarAndroid] {
    ...
    inline def styleAttr(value: Horizontal | Normal | Small | Large | Inverse | SmallInverse | LargeInverse): this.type = set("styleAttr", value.asInstanceOf[js.Any])
