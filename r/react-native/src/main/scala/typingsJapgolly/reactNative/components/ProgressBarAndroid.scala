...
import typingsJapgolly.reactNative.mod.ProgressBarAndroidProps
import typingsJapgolly.reactNative.mod.StyleProp
import typingsJapgolly.reactNative.mod.TVParallaxProperties
import typingsJapgolly.reactNative.mod.ViewStyle
import typingsJapgolly.reactNative.reactNativeStrings.Horizontal
import typingsJapgolly.reactNative.reactNativeStrings.Inverse
import typingsJapgolly.reactNative.reactNativeStrings.Large
import typingsJapgolly.reactNative.reactNativeStrings.LargeInverse
import typingsJapgolly.reactNative.reactNativeStrings.Normal
import typingsJapgolly.reactNative.reactNativeStrings.Small
import typingsJapgolly.reactNative.reactNativeStrings.SmallInverse
...
object ProgressBarAndroid {
  def apply(
    ...
    typingsJapgolly.reactNative.mod.ProgressBarAndroid, 
    Unit, 
    ProgressBarAndroidProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.ProgressBarAndroidProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.ProgressBarAndroid](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.ProgressBarAndroidProps])(children: _*)
  }
