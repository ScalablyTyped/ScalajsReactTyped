...
object SwitchIOS {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SwitchIOSProps, typingsJapgolly.reactNative.mod.SwitchIOS, Unit, SwitchIOSProps] = {
  ...
  typingsJapgolly.reactNative.mod.SwitchIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.SwitchIOS](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.SwitchIOSProps])(children: _*)
  }
