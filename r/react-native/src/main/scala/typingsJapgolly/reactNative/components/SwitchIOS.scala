...
import typingsJapgolly.reactNative.mod.SwitchIOSProps
...
object SwitchIOS {
  ...
  @JSImport("react-native", "SwitchIOS")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNative.mod.SwitchIOS] {
