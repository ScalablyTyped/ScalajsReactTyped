...
import typingsJapgolly.reactNative.mod.ToolbarAndroidProps
...
object ToolbarAndroid {
  def apply(
    ...
    ToolbarAndroidProps, 
    typingsJapgolly.reactNative.mod.ToolbarAndroid, 
    Unit, 
    ToolbarAndroidProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.ToolbarAndroidProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.ToolbarAndroid](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.ToolbarAndroidProps])(children: _*)
  }
