...
object TouchableNativeFeedback {
  def apply(
    ...
    typingsJapgolly.reactNative.mod.TouchableNativeFeedback, 
    Unit, 
    TouchableNativeFeedbackProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.TouchableNativeFeedbackProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.TouchableNativeFeedback](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.TouchableNativeFeedbackProps])(children: _*)
  }
