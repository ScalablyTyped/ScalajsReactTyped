...
object ProgressViewIOS {
  def apply(
    ...
    typingsJapgolly.reactNative.mod.ProgressViewIOS, 
    Unit, 
    ProgressViewIOSProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.ProgressViewIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.ProgressViewIOS](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.ProgressViewIOSProps])(children: _*)
  }
