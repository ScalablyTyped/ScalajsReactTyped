...
import typingsJapgolly.reactNative.mod.SegmentedControlIOSProps
...
object SegmentedControlIOS {
  def apply(
    ...
    typingsJapgolly.reactNative.mod.SegmentedControlIOS, 
    Unit, 
    SegmentedControlIOSProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.SegmentedControlIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.SegmentedControlIOS](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.SegmentedControlIOSProps])(children: _*)
  }
