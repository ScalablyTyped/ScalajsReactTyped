...
object TabBarIOS {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TabBarIOSProps, typingsJapgolly.reactNative.mod.TabBarIOS, Unit, TabBarIOSProps] = {
  ...
  typingsJapgolly.reactNative.mod.TabBarIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.TabBarIOS](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.TabBarIOSProps])(children: _*)
  }
