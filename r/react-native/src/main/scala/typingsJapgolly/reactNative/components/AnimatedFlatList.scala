...
object AnimatedFlatList {
  def apply(
    props: AnimatedProps[ComponentProps[typingsJapgolly.reactNative.mod.FlatList[js.Any]]] with js.Object,
    key: js.UndefOr[Key] = js.undefined,
    _overrides: StringDictionary[js.Any] = null
  )(
    children: ChildArg*
  ): UnmountedSimple[
    AnimatedProps[ComponentProps[typingsJapgolly.reactNative.mod.FlatList[js.Any]]] with js.Object, 
    MountedWithRawType[
      AnimatedProps[ComponentProps[typingsJapgolly.reactNative.mod.FlatList[js.Any]]] with js.Object, 
      js.Object, 
      RawMounted[
