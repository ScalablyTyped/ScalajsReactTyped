...
import typingsJapgolly.reactNative.mod.SnapshotViewIOSProps
...
object SnapshotViewIOS {
  def apply(
    ...
    typingsJapgolly.reactNative.mod.SnapshotViewIOS, 
    Unit, 
    SnapshotViewIOSProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.SnapshotViewIOSProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.SnapshotViewIOS](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.SnapshotViewIOSProps])(children: _*)
  }
