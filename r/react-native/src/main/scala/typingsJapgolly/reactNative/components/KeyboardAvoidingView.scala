...
object KeyboardAvoidingView {
  def apply(
    ...
    typingsJapgolly.reactNative.mod.KeyboardAvoidingView, 
    Unit, 
    KeyboardAvoidingViewProps
  ] = {
  ...
  typingsJapgolly.reactNative.mod.KeyboardAvoidingViewProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.KeyboardAvoidingView](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.KeyboardAvoidingViewProps])(children: _*)
  }
