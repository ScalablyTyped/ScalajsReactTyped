...
object FlatList {
  ...
  open class Builder[ItemT] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNative.mod.FlatList[ItemT]] {
    ...
    inline def data(value: js.Array[ItemT]): this.type = set("data", value.asInstanceOf[js.Any])
    
    inline def dataNull: this.type = set("data", null)
    
    inline def dataVarargs(value: ItemT*): this.type = set("data", js.Array(value*))
