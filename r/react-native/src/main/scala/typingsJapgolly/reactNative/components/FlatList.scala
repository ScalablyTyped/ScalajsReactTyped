...
object FlatList {
  def apply[ItemT](
    ...
    getItemLayout: (/* data */ js.UndefOr[js.Array[ItemT] | Null], /* index */ Double) => CallbackTo[AnonIndex] = null,
    ...
    renderItem: /* info */ ListRenderItemInfo[ItemT] => CallbackTo[Element | Null] = null,
    ...
    FlatListProps[ItemT], 
    typingsJapgolly.reactNative.mod.FlatList[ItemT], 
    Unit, 
    FlatListProps[ItemT]
  ] = {
    ...
    if (getItemLayout != null) __obj.updateDynamic("getItemLayout")(js.Any.fromFunction2((t0: /* data */ js.UndefOr[js.Array[ItemT] | scala.Null], t1: /* index */ scala.Double) => getItemLayout(t0, t1).runNow()))
    ...
    if (renderItem != null) __obj.updateDynamic("renderItem")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.reactNative.mod.ListRenderItemInfo[ItemT]) => renderItem(t0).runNow()))
  ...
  typingsJapgolly.reactNative.mod.FlatListProps[ItemT], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.FlatList[ItemT]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.FlatListProps[ItemT]])(children: _*)
  }
