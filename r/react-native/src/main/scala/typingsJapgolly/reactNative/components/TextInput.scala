...
object TextInput {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextInputProps, typingsJapgolly.reactNative.mod.TextInput, Unit, TextInputProps] = {
  ...
  typingsJapgolly.reactNative.mod.TextInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNative.mod.TextInput](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.TextInputProps])(children: _*)
  }
