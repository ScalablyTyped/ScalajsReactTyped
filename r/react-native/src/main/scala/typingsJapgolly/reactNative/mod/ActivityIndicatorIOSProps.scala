...
import typingsJapgolly.reactNative.AnonNativeEvent
...
import typingsJapgolly.reactNative.reactNativeStrings.large_
...
import typingsJapgolly.reactNative.reactNativeStrings.small_
...
object ActivityIndicatorIOSProps {
  ...
  def apply(
    ...
    onLayout: /* event */ AnonNativeEvent => Callback = null,
    ...
    if (onLayout != null) __obj.updateDynamic("onLayout")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.reactNative.AnonNativeEvent) => onLayout(t0).runNow()))
