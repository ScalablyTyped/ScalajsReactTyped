...
trait SectionListProps[ItemT] extends VirtualizedListWithoutRenderItemProps[ItemT] {
  ...
  /**
    ...
    */
  var SectionSeparatorComponent: js.UndefOr[ComponentType[_] | Element | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var renderSectionFooter: js.UndefOr[js.Function1[/* info */ AnonSection[ItemT], Element | Null]] = js.undefined
  /**
    * Rendered at the top of each section. Sticky headers are not yet supported.
    */
  var renderSectionHeader: js.UndefOr[js.Function1[/* info */ AnonSection[ItemT], Element | Null]] = js.undefined
  /**
...
object SectionListProps {
  ...
  def apply[ItemT](
    ...
    getItem: (/* data */ js.Any, /* index */ Double) => CallbackTo[ItemT] = null,
    getItemCount: /* data */ js.Any => CallbackTo[Double] = null,
    getItemLayout: (/* data */ js.Array[SectionListData[ItemT]] | Null, /* index */ Double) => CallbackTo[AnonIndex] = null,
    ...
    renderSectionFooter: /* info */ AnonSection[ItemT] => CallbackTo[Element | Null] = null,
    renderSectionHeader: /* info */ AnonSection[ItemT] => CallbackTo[Element | Null] = null,
    ...
    if (getItemLayout != null) __obj.updateDynamic("getItemLayout")(js.Any.fromFunction2((t0: /* data */ js.Array[typingsJapgolly.reactNative.mod.SectionListData[ItemT]] | scala.Null, t1: /* index */ scala.Double) => getItemLayout(t0, t1).runNow()))
    ...
    if (renderSectionFooter != null) __obj.updateDynamic("renderSectionFooter")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.reactNative.AnonSection[ItemT]) => renderSectionFooter(t0).runNow()))
    if (renderSectionHeader != null) __obj.updateDynamic("renderSectionHeader")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.reactNative.AnonSection[ItemT]) => renderSectionHeader(t0).runNow()))
