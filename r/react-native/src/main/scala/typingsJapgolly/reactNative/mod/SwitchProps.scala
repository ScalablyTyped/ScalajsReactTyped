...
trait SwitchProps
  ...
  var onChange: js.UndefOr[
    (js.Function1[ReactEventFrom[NodeHandle & Element], js.Promise[Unit] | Unit]) | Null
  ] = js.undefined
...
object SwitchProps {
  ...
  extension [Self <: SwitchProps](x: Self) {
    ...
    inline def setOnChange(value: ReactEventFrom[NodeHandle & Element] => js.Promise[Unit] | Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
