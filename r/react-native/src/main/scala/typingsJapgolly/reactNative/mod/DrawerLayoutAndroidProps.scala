...
object DrawerLayoutAndroidProps {
  ...
  def apply(
    ...
    if (onDrawerSlide != null) __obj.updateDynamic("onDrawerSlide")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[typingsJapgolly.reactNative.mod.NodeHandle with org.scalajs.dom.raw.Element]) => onDrawerSlide(t0).runNow()))
    if (onDrawerStateChanged != null) __obj.updateDynamic("onDrawerStateChanged")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.reactNative.reactNativeStrings.Idle | typingsJapgolly.reactNative.reactNativeStrings.Dragging | typingsJapgolly.reactNative.reactNativeStrings.Settling) => onDrawerStateChanged(t0).runNow()))
