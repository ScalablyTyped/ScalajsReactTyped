...
import typingsJapgolly.reactNative.reactNativeStrings.day
import typingsJapgolly.reactNative.reactNativeStrings.hour
import typingsJapgolly.reactNative.reactNativeStrings.minute
