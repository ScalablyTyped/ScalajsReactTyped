...
import typingsJapgolly.reactNative.reactNativeStrings.cancel
import typingsJapgolly.reactNative.reactNativeStrings.default
import typingsJapgolly.reactNative.reactNativeStrings.destructive
...
object AlertButton {
  ...
  extension [Self <: AlertButton](x: Self) {
    ...
    inline def setOnPress(value: /* value */ js.UndefOr[String] => Callback): Self = StObject.set(x, "onPress", js.Any.fromFunction1((t0: /* value */ js.UndefOr[String]) => value(t0).runNow()))
