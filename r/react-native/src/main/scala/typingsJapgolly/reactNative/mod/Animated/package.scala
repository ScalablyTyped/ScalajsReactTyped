...
import typingsJapgolly.reactNative.mod.Animated.^
...
): AnimatedAddition[OutputT] = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[AnimatedAddition[OutputT]]
...
inline def diffClamp[OutputT /* <: Double | String */](a: typingsJapgolly.reactNative.mod.Animated.Animated, min: Double, max: Double): AnimatedDiffClamp[OutputT] = (^.asInstanceOf[js.Dynamic].applyDynamic("diffClamp")(a.asInstanceOf[js.Any], min.asInstanceOf[js.Any], max.asInstanceOf[js.Any])).asInstanceOf[AnimatedDiffClamp[OutputT]]

inline def divide[OutputT /* <: Double | String */](
  a: typingsJapgolly.reactNative.mod.Animated.Animated,
  b: typingsJapgolly.reactNative.mod.Animated.Animated
): AnimatedDivision[OutputT] = (^.asInstanceOf[js.Dynamic].applyDynamic("divide")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[AnimatedDivision[OutputT]]
...
inline def modulo[OutputT /* <: Double | String */](a: typingsJapgolly.reactNative.mod.Animated.Animated, modulus: Double): AnimatedModulo[OutputT] = (^.asInstanceOf[js.Dynamic].applyDynamic("modulo")(a.asInstanceOf[js.Any], modulus.asInstanceOf[js.Any])).asInstanceOf[AnimatedModulo[OutputT]]

inline def multiply[OutputT /* <: Double | String */](
  a: typingsJapgolly.reactNative.mod.Animated.Animated,
  b: typingsJapgolly.reactNative.mod.Animated.Animated
): AnimatedMultiplication[OutputT] = (^.asInstanceOf[js.Dynamic].applyDynamic("multiply")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[AnimatedMultiplication[OutputT]]
...
inline def subtract[OutputT /* <: Double | String */](
  a: typingsJapgolly.reactNative.mod.Animated.Animated,
  b: typingsJapgolly.reactNative.mod.Animated.Animated
): AnimatedSubtraction[OutputT] = (^.asInstanceOf[js.Dynamic].applyDynamic("subtract")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[AnimatedSubtraction[OutputT]]
...
type ValueListenerCallback = js.Function1[/* state */ typingsJapgolly.reactNative.anon.Value, Unit]
