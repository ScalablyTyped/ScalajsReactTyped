...
object ViewPagerAndroidProps {
  ...
  def apply(
    ...
    if (onPageScrollStateChanged != null) __obj.updateDynamic("onPageScrollStateChanged")(js.Any.fromFunction1((t0: /* state */ typingsJapgolly.reactNative.reactNativeStrings.Idle | typingsJapgolly.reactNative.reactNativeStrings.Dragging | typingsJapgolly.reactNative.reactNativeStrings.Settling) => onPageScrollStateChanged(t0).runNow()))
