...
import typingsJapgolly.reactNative.anon.Code
import typingsJapgolly.reactNative.reactNativeStrings.localNotification
import typingsJapgolly.reactNative.reactNativeStrings.notification
import typingsJapgolly.reactNative.reactNativeStrings.register
import typingsJapgolly.reactNative.reactNativeStrings.registrationError
...
trait PushNotificationIOSStatic extends StObject {
  ...
  /**
    ...
    */
  var FetchResult: typingsJapgolly.reactNative.mod.FetchResult = js.native
