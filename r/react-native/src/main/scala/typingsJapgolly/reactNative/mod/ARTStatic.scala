...
trait ARTStatic extends js.Object {
  var ClippingRectangle: Instantiable0[typingsJapgolly.reactNative.mod.ClippingRectangle]
  var Group: Instantiable0[typingsJapgolly.reactNative.mod.Group]
  var Shape: Instantiable0[typingsJapgolly.reactNative.mod.Shape]
  var Surface: Instantiable0[typingsJapgolly.reactNative.mod.Surface]
