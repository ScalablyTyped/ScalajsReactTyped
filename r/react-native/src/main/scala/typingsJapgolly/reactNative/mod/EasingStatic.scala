...
object EasingStatic {
  ...
  def apply(
    ...
    __obj.updateDynamic("in")(js.Any.fromFunction1((t0: typingsJapgolly.reactNative.mod.EasingFunction) => in(t0).runNow()))
    __obj.updateDynamic("inOut")(js.Any.fromFunction1((t0: typingsJapgolly.reactNative.mod.EasingFunction) => inOut(t0).runNow()))
    __obj.updateDynamic("linear")(js.Any.fromFunction1((t0: /* value */ scala.Double) => linear(t0).runNow()))
    __obj.updateDynamic("out")(js.Any.fromFunction1((t0: typingsJapgolly.reactNative.mod.EasingFunction) => out(t0).runNow()))
