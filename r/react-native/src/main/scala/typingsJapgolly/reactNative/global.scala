...
import typingsJapgolly.reactNative.anon.DictoptionName
...
object global {
  ...
  open class AbortController ()
    extends StObject
       with typingsJapgolly.reactNative.AbortController {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val signal: typingsJapgolly.reactNative.AbortSignal = js.native
  }
  ...
  open class AbortSignal ()
    extends StObject
       with typingsJapgolly.reactNative.AbortSignal
  ...
  open class Blob ()
    extends StObject
       with typingsJapgolly.reactNative.Blob {
    def this(blobParts: js.Array[typingsJapgolly.reactNative.Blob | String]) = this()
    def this(blobParts: js.Array[typingsJapgolly.reactNative.Blob | String], options: BlobOptions) = this()
  ...
  open class FileReader ()
    extends StObject
       with typingsJapgolly.reactNative.FileReader
  object FileReader {
  ...
  open class FormData ()
    extends StObject
       with typingsJapgolly.reactNative.FormData {
  ...
  open class Headers ()
    extends StObject
       with typingsJapgolly.reactNative.Headers {
  ...
  open class MessageQueue ()
    extends StObject
       with typingsJapgolly.reactNative.MessageQueue {
  ...
  open class Request protected ()
    extends StObject
       with typingsJapgolly.reactNative.Request {
    def this(input: String) = this()
    def this(input: typingsJapgolly.reactNative.Request) = this()
    def this(input: String, init: RequestInit) = this()
    def this(input: typingsJapgolly.reactNative.Request, init: RequestInit) = this()
    
    /* CompleteClass */
    override def arrayBuffer(): js.Promise[js.typedarray.ArrayBuffer] = js.native
    
    /* CompleteClass */
    override def blob(): js.Promise[typingsJapgolly.reactNative.Blob] = js.native
    ...
    /* CompleteClass */
    override def formData(): js.Promise[typingsJapgolly.reactNative.FormData] = js.native
    ...
    /* CompleteClass */
    override val headers: typingsJapgolly.reactNative.Headers = js.native
  ...
  open class Response ()
    extends StObject
       with typingsJapgolly.reactNative.Response {
  ...
  object Response {
    ...
    inline def error(): typingsJapgolly.reactNative.Response = ^.asInstanceOf[js.Dynamic].applyDynamic("error")().asInstanceOf[typingsJapgolly.reactNative.Response]
    
    inline def redirect(url: String): typingsJapgolly.reactNative.Response = ^.asInstanceOf[js.Dynamic].applyDynamic("redirect")(url.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.reactNative.Response]
    inline def redirect(url: String, status: Double): typingsJapgolly.reactNative.Response = (^.asInstanceOf[js.Dynamic].applyDynamic("redirect")(url.asInstanceOf[js.Any], status.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.reactNative.Response]
  }
  ...
  open class URL protected ()
    extends StObject
       with typingsJapgolly.reactNative.URL {
    ...
    /* CompleteClass */
    override val searchParams: typingsJapgolly.reactNative.URLSearchParams = js.native
  ...
  object URL {
    ...
    /* static member */
    inline def createObjectURL(blob: typingsJapgolly.reactNative.Blob): String = ^.asInstanceOf[js.Dynamic].applyDynamic("createObjectURL")(blob.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  open class URLSearchParams ()
    extends StObject
       with typingsJapgolly.reactNative.URLSearchParams {
    def this(init: String) = this()
    def this(init: js.Array[js.Array[String]]) = this()
    def this(init: typingsJapgolly.reactNative.URLSearchParams) = this()
  ...
  open class WebSocket protected ()
    extends StObject
       with typingsJapgolly.reactNative.WebSocket {
  ...
  open class XMLHttpRequest ()
    extends StObject
       with typingsJapgolly.reactNative.XMLHttpRequest
  ...
  open class XMLHttpRequestUpload ()
    extends StObject
       with typingsJapgolly.reactNative.XMLHttpRequestUpload
  ...
  inline def fetch(input: RequestInfo): js.Promise[typingsJapgolly.reactNative.Response] = js.Dynamic.global.applyDynamic("fetch")(input.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.reactNative.Response]]
  inline def fetch(input: RequestInfo, init: RequestInit): js.Promise[typingsJapgolly.reactNative.Response] = (js.Dynamic.global.applyDynamic("fetch")(input.asInstanceOf[js.Any], init.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.reactNative.Response]]
