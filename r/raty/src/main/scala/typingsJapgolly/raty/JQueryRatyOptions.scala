...
object JQueryRatyOptions {
  ...
  extension [Self <: JQueryRatyOptions](x: Self) {
    ...
    inline def setClick(value: (/* score */ Double, /* event */ JQueryEventObject) => Callback): Self = StObject.set(x, "click", js.Any.fromFunction2((t0: /* score */ Double, t1: /* event */ JQueryEventObject) => (value(t0, t1)).runNow()))
    ...
    inline def setMouseout(value: (/* score */ Double, /* event */ JQueryEventObject) => Callback): Self = StObject.set(x, "mouseout", js.Any.fromFunction2((t0: /* score */ Double, t1: /* event */ JQueryEventObject) => (value(t0, t1)).runNow()))
    
    inline def setMouseoutUndefined: Self = StObject.set(x, "mouseout", js.undefined)
    
    inline def setMouseover(value: (/* score */ Double, /* event */ JQueryEventObject) => Callback): Self = StObject.set(x, "mouseover", js.Any.fromFunction2((t0: /* score */ Double, t1: /* event */ JQueryEventObject) => (value(t0, t1)).runNow()))
