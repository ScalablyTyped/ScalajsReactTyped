...
object mod {
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setOnCaptionsDisabled(value: Callback): Self = StObject.set(x, "onCaptionsDisabled", value.toJsFn)
      
      inline def setOnCaptionsDisabledUndefined: Self = StObject.set(x, "onCaptionsDisabled", js.undefined)
      
      inline def setOnCaptionsEnabled(value: Callback): Self = StObject.set(x, "onCaptionsEnabled", value.toJsFn)
      ...
      inline def setOnEnterFullscreen(value: Callback): Self = StObject.set(x, "onEnterFullscreen", value.toJsFn)
      
      inline def setOnEnterFullscreenUndefined: Self = StObject.set(x, "onEnterFullscreen", js.undefined)
      
      inline def setOnExitFullscreen(value: Callback): Self = StObject.set(x, "onExitFullscreen", value.toJsFn)
      
      inline def setOnExitFullscreenUndefined: Self = StObject.set(x, "onExitFullscreen", js.undefined)
      
      inline def setOnLoadedData(value: Callback): Self = StObject.set(x, "onLoadedData", value.toJsFn)
      ...
      inline def setOnReady(value: /* player */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "onReady", js.Any.fromFunction1((t0: /* player */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setOnReadyUndefined: Self = StObject.set(x, "onReady", js.undefined)
      
      inline def setOnSeeked(value: /* time */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "onSeeked", js.Any.fromFunction1((t0: /* time */ js.UndefOr[Double]) => value(t0).runNow()))
      
      inline def setOnSeekedUndefined: Self = StObject.set(x, "onSeeked", js.undefined)
      
      inline def setOnTimeUpdate(value: /* time */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "onTimeUpdate", js.Any.fromFunction1((t0: /* time */ js.UndefOr[Double]) => value(t0).runNow()))
      
      inline def setOnTimeUpdateUndefined: Self = StObject.set(x, "onTimeUpdate", js.undefined)
      
      inline def setOnVolumeChange(value: /* params */ OnVolumeChangeParam => Callback): Self = StObject.set(x, "onVolumeChange", js.Any.fromFunction1((t0: /* params */ OnVolumeChangeParam) => value(t0).runNow()))
