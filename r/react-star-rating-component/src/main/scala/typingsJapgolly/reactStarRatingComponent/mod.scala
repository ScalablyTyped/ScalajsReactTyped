package typingsJapgolly.reactStarRatingComponent
...
object mod {
  ...
  type StarRatingComponent = japgolly.scalajs.react.facade.React.Component[StarRatingComponentProps & js.Object, js.Object]
  ...
  object StarRatingComponentProps {
    ...
    extension [Self <: StarRatingComponentProps](x: Self) {
      ...
      inline def setOnStarClick(value: (/* nextValue */ Double, /* prevValue */ Double, /* name */ String) => Callback): Self = StObject.set(x, "onStarClick", js.Any.fromFunction3((t0: /* nextValue */ Double, t1: /* prevValue */ Double, t2: /* name */ String) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnStarClickUndefined: Self = StObject.set(x, "onStarClick", js.undefined)
      
      inline def setOnStarHover(value: (/* nextValue */ Double, /* prevValue */ Double, /* name */ String) => Callback): Self = StObject.set(x, "onStarHover", js.Any.fromFunction3((t0: /* nextValue */ Double, t1: /* prevValue */ Double, t2: /* name */ String) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnStarHoverOut(value: (/* nextValue */ Double, /* prevValue */ Double, /* name */ String) => Callback): Self = StObject.set(x, "onStarHoverOut", js.Any.fromFunction3((t0: /* nextValue */ Double, t1: /* prevValue */ Double, t2: /* name */ String) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setRenderStarIcon(value: (/* nextValue */ Double, /* prevValue */ Double, /* name */ String) => Node | String): Self = StObject.set(x, "renderStarIcon", js.Any.fromFunction3(value))
      
      inline def setRenderStarIconHalf(value: (/* nextValue */ Double, /* prevValue */ Double, /* name */ String) => Node | String): Self = StObject.set(x, "renderStarIconHalf", js.Any.fromFunction3(value))
