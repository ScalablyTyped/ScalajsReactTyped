...
object mod {
  ...
  type Keyboard = japgolly.scalajs.react.facade.React.Component[KeyboardProps & js.Object, js.Object]
  ...
  object KeyboardProps {
    ...
    extension [Self <: KeyboardProps](x: Self) {
      ...
      ): Self = StObject.set(x, "callbackParent", js.Any.fromFunction3((t0: /* event */ js.UndefOr[String | Event], t1: /* keyboard */ js.UndefOr[Element], t2: /* el */ js.UndefOr[Element]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnAccepted(
        value: (/* event */ js.UndefOr[String | Event], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Callback
      ): Self = StObject.set(x, "onAccepted", js.Any.fromFunction3((t0: /* event */ js.UndefOr[String | Event], t1: /* keyboard */ js.UndefOr[Element], t2: /* el */ js.UndefOr[Element]) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnAcceptedUndefined: Self = StObject.set(x, "onAccepted", js.undefined)
      
      inline def setOnChange(
        value: (/* event */ js.UndefOr[String | Event], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Callback
      ): Self = StObject.set(x, "onChange", js.Any.fromFunction3((t0: /* event */ js.UndefOr[String | Event], t1: /* keyboard */ js.UndefOr[Element], t2: /* el */ js.UndefOr[Element]) => (value(t0, t1, t2)).runNow()))
