...
trait Alternative
  ...
  @JSName("type")
  var type_Alternative: typingsJapgolly.regexpp.regexppStrings.Alternative
}
object Alternative {
  ...
  extension [Self <: Alternative](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.regexpp.regexppStrings.Alternative): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
