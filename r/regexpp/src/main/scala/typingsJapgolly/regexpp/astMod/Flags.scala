...
trait Flags
  ...
  @JSName("type")
  var type_Flags: typingsJapgolly.regexpp.regexppStrings.Flags
...
object Flags {
  ...
  extension [Self <: Flags](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.regexpp.regexppStrings.Flags): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
