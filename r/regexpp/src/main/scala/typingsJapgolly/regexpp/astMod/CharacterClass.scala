...
trait CharacterClass
  ...
  @JSName("type")
  var type_CharacterClass: typingsJapgolly.regexpp.regexppStrings.CharacterClass
}
object CharacterClass {
  ...
  extension [Self <: CharacterClass](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.regexpp.regexppStrings.CharacterClass): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
