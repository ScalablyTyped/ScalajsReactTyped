...
object anon {
  ...
  trait Children extends StObject {
    ...
    def children(childProps: PaginationProps): Element | Null
    
    var pagination: js.UndefOr[PaginationCtxOptions] = js.undefined
  }
  object Children {
    
    inline def apply(children: PaginationProps => Element | Null): Children = {
    ...
    extension [Self <: Children](x: Self) {
      ...
      inline def setChildren(value: PaginationProps => Element | Null): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
