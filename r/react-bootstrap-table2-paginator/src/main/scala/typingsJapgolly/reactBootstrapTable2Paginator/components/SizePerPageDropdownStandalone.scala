...
import typingsJapgolly.reactBootstrapTable2Paginator.mod.SizePerPageDropdownStandaloneProps
...
object SizePerPageDropdownStandalone {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def btnContextual(value: Boolean): this.type = set("btnContextual", value.asInstanceOf[js.Any])
    ...
    inline def variation(value: dropdown | dropup): this.type = set("variation", value.asInstanceOf[js.Any])
