...
import typingsJapgolly.reactScroll.linkMod.default
...
object Link {
  ...
  typingsJapgolly.reactScroll.linkMod.LinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactScroll.linkMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactScroll.linkMod.LinkProps])(children: _*)
  }
