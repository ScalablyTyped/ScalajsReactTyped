...
import typingsJapgolly.reactScroll.modulesComponentsButtonMod.ButtonProps
...
object Button {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactScroll.mod.Button] {
    ...
    inline def duration(value: Double | String | (js.Function1[/* distance */ Double, Double])): this.type = set("duration", value.asInstanceOf[js.Any])
    
    inline def durationFunction1(value: /* distance */ Double => Double): this.type = set("duration", js.Any.fromFunction1(value))
    ...
    inline def hashSpy(value: Boolean): this.type = set("hashSpy", value.asInstanceOf[js.Any])
    ...
    inline def ignoreCancelEvents(value: Boolean): this.type = set("ignoreCancelEvents", value.asInstanceOf[js.Any])
    ...
    inline def isDynamic(value: Boolean): this.type = set("isDynamic", value.asInstanceOf[js.Any])
    ...
    inline def onSetActive(value: (/* to */ String, /* element */ HTMLElement) => Callback): this.type = set("onSetActive", js.Any.fromFunction2((t0: /* to */ String, t1: /* element */ HTMLElement) => (value(t0, t1)).runNow()))
    
    inline def onSetInactive(value: (/* to */ String, /* element */ HTMLElement) => Callback): this.type = set("onSetInactive", js.Any.fromFunction2((t0: /* to */ String, t1: /* element */ HTMLElement) => (value(t0, t1)).runNow()))
    ...
    inline def saveHashHistory(value: Boolean): this.type = set("saveHashHistory", value.asInstanceOf[js.Any])
    ...
    inline def smooth(value: Boolean | String): this.type = set("smooth", value.asInstanceOf[js.Any])
    
    inline def span(value: Double): this.type = set("span", value.asInstanceOf[js.Any])
    
    inline def spellCheck(value: Booleanish): this.type = set("spellCheck", value.asInstanceOf[js.Any])
    
    inline def spy(value: Boolean): this.type = set("spy", value.asInstanceOf[js.Any])
