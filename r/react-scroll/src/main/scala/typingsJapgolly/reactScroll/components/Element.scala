...
import typingsJapgolly.reactScroll.modulesComponentsElementMod.ElementProps
...
object Element {
  ...
  inline def apply(name: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ElementProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactScroll.mod.Element] {
  ...
  def withProps(p: ElementProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
