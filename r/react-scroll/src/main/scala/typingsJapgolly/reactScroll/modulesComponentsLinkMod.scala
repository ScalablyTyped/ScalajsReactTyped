...
object modulesComponentsLinkMod {
  ...
  - typingsJapgolly.react.mod.HTMLProps because var conflicts: onClick. Inlined  */ trait LinkProps
    extends StObject
  ...
  object ReactScrollLinkProps {
    ...
    extension [Self <: ReactScrollLinkProps](x: Self) {
      ...
      inline def setOnSetActive(value: (/* to */ String, /* element */ HTMLElement) => Callback): Self = StObject.set(x, "onSetActive", js.Any.fromFunction2((t0: /* to */ String, t1: /* element */ HTMLElement) => (value(t0, t1)).runNow()))
      
      inline def setOnSetActiveUndefined: Self = StObject.set(x, "onSetActive", js.undefined)
      
      inline def setOnSetInactive(value: (/* to */ String, /* element */ HTMLElement) => Callback): Self = StObject.set(x, "onSetInactive", js.Any.fromFunction2((t0: /* to */ String, t1: /* element */ HTMLElement) => (value(t0, t1)).runNow()))
