...
object mod {
  ...
  @js.native
  open class Button ()
    extends typingsJapgolly.reactScroll.modulesMod.Button
  
  @JSImport("react-scroll", "Element")
  @js.native
  open class Element ()
    extends typingsJapgolly.reactScroll.modulesMod.Element
  ...
  @js.native
  open class Link ()
    extends typingsJapgolly.reactScroll.modulesMod.Link
