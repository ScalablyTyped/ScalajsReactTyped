package typingsJapgolly.reactComponentBenchmark
...
object mod extends Shortcut {
  ...
  object BenchmarkProps {
    ...
    inline def apply(component: ComponentType[Any], onComplete: BenchResultsType => Callback, samples: Double): BenchmarkProps = {
      val __obj = js.Dynamic.literal(component = component.asInstanceOf[js.Any], onComplete = js.Any.fromFunction1((t0: BenchResultsType) => onComplete(t0).runNow()), samples = samples.asInstanceOf[js.Any])
    ...
    extension [Self <: BenchmarkProps](x: Self) {
      ...
      inline def setOnComplete(value: BenchResultsType => Callback): Self = StObject.set(x, "onComplete", js.Any.fromFunction1((t0: BenchResultsType) => value(t0).runNow()))
  ...
  object BenchmarkRef {
    ...
    inline def apply(start: Callback): BenchmarkRef = {
      val __obj = js.Dynamic.literal(start = start.toJsFn)
