...
import typingsJapgolly.rnMaterialUiTextfield.mod.ContentInset
import typingsJapgolly.rnMaterialUiTextfield.mod.LabelOffset
...
@scala.inline
open class SharedBuilder_TextFieldProps1999016579[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def activeLineWidth(value: Double): this.type = set("activeLineWidth", value.asInstanceOf[js.Any])
  
  inline def affixTextStyle(value: StyleProp[TextStyle]): this.type = set("affixTextStyle", value.asInstanceOf[js.Any])
  
  inline def affixTextStyleNull: this.type = set("affixTextStyle", null)
  ...
  inline def baseColor(value: ColorValue): this.type = set("baseColor", value.asInstanceOf[js.Any])
  ...
  inline def characterRestriction(value: Double): this.type = set("characterRestriction", value.asInstanceOf[js.Any])
  ...
  inline def disabledLineType(
    value: solid | dotted | dashed | typingsJapgolly.rnMaterialUiTextfield.rnMaterialUiTextfieldStrings.none
  ): this.type = set("disabledLineType", value.asInstanceOf[js.Any])
  
  inline def disabledLineWidth(value: Double): this.type = set("disabledLineWidth", value.asInstanceOf[js.Any])
  ...
  inline def errorColor(value: ColorValue): this.type = set("errorColor", value.asInstanceOf[js.Any])
  ...
  inline def formatText(value: /* text */ String => String): this.type = set("formatText", js.Any.fromFunction1(value))
  ...
  inline def inputRef(value: RefHandle[Any]): this.type = set("inputRef", value.asInstanceOf[js.Any])
  ...
  inline def labelOffset(value: LabelOffset): this.type = set("labelOffset", value.asInstanceOf[js.Any])
  ...
  inline def onBlur(value: /* event */ NativeSyntheticEvent[TextInputChangeEventData] => Callback): this.type = set("onBlur", js.Any.fromFunction1((t0: /* event */ NativeSyntheticEvent[TextInputChangeEventData]) => value(t0).runNow()))
  ...
  inline def onFocus(value: /* event */ NativeSyntheticEvent[TextInputFocusEventData] => Callback): this.type = set("onFocus", js.Any.fromFunction1((t0: /* event */ NativeSyntheticEvent[TextInputFocusEventData]) => value(t0).runNow()))
  ...
  inline def renderLeftAccessory(value: CallbackTo[typingsJapgolly.react.mod.global.JSX.Element]): this.type = set("renderLeftAccessory", value.toJsFn)
  
  inline def renderRightAccessory(value: CallbackTo[typingsJapgolly.react.mod.global.JSX.Element]): this.type = set("renderRightAccessory", value.toJsFn)
  ...
  inline def textColor(value: ColorValue): this.type = set("textColor", value.asInstanceOf[js.Any])
