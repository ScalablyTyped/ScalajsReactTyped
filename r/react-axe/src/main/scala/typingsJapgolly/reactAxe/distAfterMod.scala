...
object distAfterMod {
  ...
  inline def apply(host: Component[js.Object, js.Object], name: String, cb: js.Function): Unit = (^.asInstanceOf[js.Dynamic].apply(host.asInstanceOf[js.Any], name.asInstanceOf[js.Any], cb.asInstanceOf[js.Any])).asInstanceOf[Unit]
