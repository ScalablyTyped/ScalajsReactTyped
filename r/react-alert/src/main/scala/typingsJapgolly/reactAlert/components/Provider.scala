...
import typingsJapgolly.reactAlert.mod.AlertComponentPropsWithStyle
import typingsJapgolly.reactAlert.mod.AlertManager
...
object Provider {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[AlertProviderProps, typingsJapgolly.reactAlert.mod.Provider, Unit, AlertProviderProps] = {
  ...
  typingsJapgolly.reactAlert.mod.AlertProviderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactAlert.mod.Provider](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactAlert.mod.AlertProviderProps])(children: _*)
  }
