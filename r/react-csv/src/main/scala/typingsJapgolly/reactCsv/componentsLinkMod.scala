...
import typingsJapgolly.reactCsv.reactCsvStrings.`additions removals`
import typingsJapgolly.reactCsv.reactCsvStrings.`additions text`
import typingsJapgolly.reactCsv.reactCsvStrings.`inline`
import typingsJapgolly.reactCsv.reactCsvStrings.`removals additions`
import typingsJapgolly.reactCsv.reactCsvStrings.`removals text`
import typingsJapgolly.reactCsv.reactCsvStrings.`text additions`
import typingsJapgolly.reactCsv.reactCsvStrings.`text removals`
...
object componentsLinkMod {
  ...
  object LinkProps {
    ...
    extension [Self <: LinkProps](x: Self) {
      ...
      inline def setDataCallbackTo(value: CallbackTo[String | Data]): Self = StObject.set(x, "data", value.toJsFn)
      ...
      ): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* event */ MouseEventHandler[HTMLAnchorElement], t1: /* done */ js.Function1[/* proceed */ js.UndefOr[Boolean], Unit]) => (value(t0, t1)).runNow()))
