...
import typingsJapgolly.reactCsv.linkMod.LinkProps
...
abstract class SharedApply_LinkProps_251515974[ComponentRef] () {
  ...
  typingsJapgolly.reactCsv.linkMod.LinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactCsv.linkMod.LinkProps])(children: _*)
  }
}
