...
import typingsJapgolly.reselect.anon.Length
import typingsJapgolly.reselect.anon.ToStringTag
...
object esTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reselect.reselectStrings.`0`
    - typingsJapgolly.reselect.reselectStrings.`1`
  */
  trait Bool extends StObject
  object Bool {
    
    inline def `0`: typingsJapgolly.reselect.reselectStrings.`0` = "0".asInstanceOf[typingsJapgolly.reselect.reselectStrings.`0`]
    
    inline def `1`: typingsJapgolly.reselect.reselectStrings.`1` = "1".asInstanceOf[typingsJapgolly.reselect.reselectStrings.`1`]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reselect.reselectInts.`0`
    - typingsJapgolly.reselect.reselectInts.`1`
  */
  trait Boolean2 extends StObject
  object Boolean2 {
    
    inline def `0`: typingsJapgolly.reselect.reselectInts.`0` = 0.asInstanceOf[typingsJapgolly.reselect.reselectInts.`0`]
    
    inline def `1`: typingsJapgolly.reselect.reselectInts.`1` = 1.asInstanceOf[typingsJapgolly.reselect.reselectInts.`1`]
  }
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait Longest[L /* <: typingsJapgolly.reselect.esTypesMod.List[Any] */, L1 /* <: typingsJapgolly.reselect.esTypesMod.List[Any] */] extends StObject
  ...
  object OutputSelectorFields {
    ...
    inline def apply[Combiner /* <: UnknownFunction */](
      ...
      lastResult: CallbackTo[ReturnType[Combiner]],
      ...
      val __obj = js.Dynamic.literal(dependencies = dependencies.asInstanceOf[js.Any], lastResult = lastResult.toJsFn, memoizedResultFunc = memoizedResultFunc.asInstanceOf[js.Any], recomputations = recomputations.toJsFn, resetRecomputations = resetRecomputations.toJsFn, resultFunc = resultFunc.asInstanceOf[js.Any])
    ...
    extension [Self <: OutputSelectorFields[?], Combiner /* <: UnknownFunction */](x: Self & OutputSelectorFields[Combiner]) {
      ...
      inline def setLastResult(value: CallbackTo[ReturnType[Combiner]]): Self = StObject.set(x, "lastResult", value.toJsFn)
      
      inline def setMemoizedResultFunc(value: Combiner): Self = StObject.set(x, "memoizedResultFunc", value.asInstanceOf[js.Any])
      
      inline def setRecomputations(value: CallbackTo[Double]): Self = StObject.set(x, "recomputations", value.toJsFn)
      
      inline def setResetRecomputations(value: CallbackTo[Double]): Self = StObject.set(x, "resetRecomputations", value.toJsFn)
