...
object LinearProgress {
  ...
  inline def apply(id: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[LinearProgressProps & RefAttributes[HTMLSpanElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def barClassName(value: String): this.type = set("barClassName", value.asInstanceOf[js.Any])
    
    inline def barStyle(value: CSSProperties): this.type = set("barStyle", value.asInstanceOf[js.Any])
    ...
    inline def verticalHeight(value: Double): this.type = set("verticalHeight", value.asInstanceOf[js.Any])
    
    inline def verticalHeightNull: this.type = set("verticalHeight", null)
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: LinearProgressProps & RefAttributes[HTMLSpanElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
