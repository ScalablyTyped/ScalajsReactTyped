...
package object reactDashReduxMod {
  import typingsJapgolly.hoistDashNonDashReactDashStatics.hoistDashNonDashReactDashStaticsMod.NonReactStatics
  import typingsJapgolly.react.reactMod.ComponentType
  import typingsJapgolly.react.reactMod.NamedExoticComponent
  import typingsJapgolly.react.reactMod._Global_.JSX.LibraryManagedAttributes
  import typingsJapgolly.reactDashRedux.Anon_WrappedComponent
  ...
  {[ P in keyof DecorationTargetProps ]: P extends keyof InjectedProps? InjectedProps[P] extends DecorationTargetProps[P]? DecorationTargetProps[P] : InjectedProps[P] : DecorationTargetProps[P]}
    */ typingsJapgolly.reactDashRedux.reactDashReduxStrings.Matching with js.Any
  ...
  {[ C in keyof TDispatchProps ]: react-redux.react-redux.HandleThunkActionCreator<TDispatchProps[C]>}
    */ typingsJapgolly.reactDashRedux.reactDashReduxStrings.ResolveThunks with TDispatchProps)
  ...
  {[ P in std.Extract<keyof InjectedProps, keyof DecorationTargetProps> ]:? InjectedProps[P] extends DecorationTargetProps[P]? DecorationTargetProps[P] : never}
    */ typingsJapgolly.reactDashRedux.reactDashReduxStrings.Shared with js.Any
