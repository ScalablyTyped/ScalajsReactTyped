...
import typingsJapgolly.reactRedux.esUtilsSubscriptionMod.Subscription
...
object esComponentsContextMod extends Shortcut {
  ...
  object ReactReduxContextValue {
    ...
    extension [Self <: ReactReduxContextValue[?, ?], SS, A /* <: Action[Any] */](x: Self & (ReactReduxContextValue[SS, A])) {
      ...
      inline def setGetServerState(value: CallbackTo[SS]): Self = StObject.set(x, "getServerState", value.toJsFn)
