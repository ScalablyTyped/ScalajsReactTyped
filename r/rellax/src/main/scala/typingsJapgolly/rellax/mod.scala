...
import typingsJapgolly.rellax.anon.X
...
object mod extends Shortcut {
  ...
  trait RellaxInstance extends StObject {
    ...
    /**
      * Rellax elements
      */
    var elms: (NodeList[Element & Node]) | js.Array[Element]
  ...
  object RellaxInstance {
    ...
    inline def apply(
      destroy: Callback,
      elms: (NodeList[Element & Node]) | js.Array[Element],
      options: RellaxOptions,
      refresh: Callback
    ): RellaxInstance = {
      val __obj = js.Dynamic.literal(destroy = destroy.toJsFn, elms = elms.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], refresh = refresh.toJsFn)
    ...
    extension [Self <: RellaxInstance](x: Self) {
      ...
      inline def setElms(value: (NodeList[Element & Node]) | js.Array[Element]): Self = StObject.set(x, "elms", value.asInstanceOf[js.Any])
  ...
  object RellaxOptions {
    ...
    extension [Self <: RellaxOptions](x: Self) {
      ...
      inline def setCallback(value: /* positions */ X => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* positions */ X) => value(t0).runNow()))
