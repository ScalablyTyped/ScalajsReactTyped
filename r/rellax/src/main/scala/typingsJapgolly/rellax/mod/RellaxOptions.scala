...
import typingsJapgolly.rellax.AnonX
...
object RellaxOptions {
  @scala.inline
  def apply(
    callback: /* positions */ AnonX => Callback = null,
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction1((t0: /* positions */ typingsJapgolly.rellax.AnonX) => callback(t0).runNow()))
