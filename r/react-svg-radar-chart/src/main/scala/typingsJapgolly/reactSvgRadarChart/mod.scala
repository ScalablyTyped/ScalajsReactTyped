package typingsJapgolly.reactSvgRadarChart

import japgolly.scalajs.react.CallbackTo
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.react.mod.Component
import typingsJapgolly.reactSvgRadarChart.anon.ClassName
import typingsJapgolly.reactSvgRadarChart.anon.Color
import typingsJapgolly.reactSvgRadarChart.anon.Fill
import typingsJapgolly.reactSvgRadarChart.anon.FontFamily
...
object mod {
  ...
  object ChartOptionsProps {
    ...
    extension [Self <: ChartOptionsProps](x: Self) {
      ...
      inline def setAxisProps(value: CallbackTo[ClassName]): Self = StObject.set(x, "axisProps", value.toJsFn)
      ...
      inline def setCaptionProps(value: CallbackTo[FontFamily]): Self = StObject.set(x, "captionProps", value.toJsFn)
      ...
      inline def setDotProps(value: CallbackTo[ClassName]): Self = StObject.set(x, "dotProps", value.toJsFn)
      ...
      inline def setScaleProps(value: CallbackTo[Fill]): Self = StObject.set(x, "scaleProps", value.toJsFn)
      ...
      inline def setShapeProps(value: CallbackTo[ClassName]): Self = StObject.set(x, "shapeProps", value.toJsFn)
  ...
  type RadarChart = japgolly.scalajs.react.facade.React.Component[ChartProps & js.Object, js.Object]
}
