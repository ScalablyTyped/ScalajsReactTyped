...
import typingsJapgolly.resourceLoader.anon.FnCall
...
import typingsJapgolly.resourceLoader.distLoaderMod.Loader.OnCompleteSignal
import typingsJapgolly.resourceLoader.distLoaderMod.Loader.OnErrorSignal
import typingsJapgolly.resourceLoader.distLoaderMod.Loader.OnLoadSignal
import typingsJapgolly.resourceLoader.distLoaderMod.Loader.OnProgressSignal
import typingsJapgolly.resourceLoader.distLoaderMod.Loader.OnStartSignal
import typingsJapgolly.resourceLoader.distLoaderMod.Loader.ResourceMap
import typingsJapgolly.resourceLoader.distLoaderMod.Loader.UrlResolverFn
import typingsJapgolly.resourceLoader.distResourceMod.IResourceOptions
import typingsJapgolly.resourceLoader.distResourceMod.Resource
...
object distLoaderMod {
  ...
  trait IAddOptions
    ...
    var onComplete: js.UndefOr[typingsJapgolly.resourceLoader.distResourceMod.Resource.OnCompleteSignal] = js.undefined
  ...
  object IAddOptions {
    ...
    extension [Self <: IAddOptions](x: Self) {
      ...
      inline def setOnComplete(value: /* resource */ Resource => Callback): Self = StObject.set(x, "onComplete", js.Any.fromFunction1((t0: /* resource */ Resource) => value(t0).runNow()))
