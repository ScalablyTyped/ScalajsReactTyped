...
import typingsJapgolly.resourceLoader.resourceLoaderMod.Resource.XHR_RESPONSE_TYPE
...
object IAddOptions {
  @scala.inline
  def apply(
    callback: /* resource */ Resource => Callback = null,
    crossOrigin: String | Boolean = null,
    key: String = null,
    loadType: LOAD_TYPE = null,
    metadata: IMetadata = null,
    name: String = null,
    onComplete: /* resource */ Resource => Callback = null,
    timeout: Int | Double = null,
    url: String = null,
    xhrType: XHR_RESPONSE_TYPE = null
  ): IAddOptions = {
    val __obj = js.Dynamic.literal()
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction1((t0: /* resource */ typingsJapgolly.resourceLoader.resourceLoaderMod.Resource) => callback(t0).runNow()))
    ...
    if (onComplete != null) __obj.updateDynamic("onComplete")(js.Any.fromFunction1((t0: /* resource */ typingsJapgolly.resourceLoader.resourceLoaderMod.Resource) => onComplete(t0).runNow()))
