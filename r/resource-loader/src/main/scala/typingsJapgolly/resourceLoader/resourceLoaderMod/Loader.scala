...
import typingsJapgolly.resourceLoader.resourceLoaderMod.Loader.OnCompleteSignal
import typingsJapgolly.resourceLoader.resourceLoaderMod.Loader.OnErrorSignal
import typingsJapgolly.resourceLoader.resourceLoaderMod.Loader.OnLoadSignal
import typingsJapgolly.resourceLoader.resourceLoaderMod.Loader.OnProgressSignal
import typingsJapgolly.resourceLoader.resourceLoaderMod.Loader.OnStartSignal
...
class Loader () extends js.Object {
  ...
  def add(
    name: String,
    url: String,
    callback: typingsJapgolly.resourceLoader.resourceLoaderMod.Resource.OnCompleteSignal
  ): this.type = js.native
  ...
  def add(url: String, callback: typingsJapgolly.resourceLoader.resourceLoaderMod.Resource.OnCompleteSignal): this.type = js.native
