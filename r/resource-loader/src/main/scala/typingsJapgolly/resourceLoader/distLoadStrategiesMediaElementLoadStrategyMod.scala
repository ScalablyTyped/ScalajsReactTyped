...
object distLoadStrategiesMediaElementLoadStrategyMod {
  
  /* note: abstract class */ @JSImport("resource-loader/dist/load_strategies/MediaElementLoadStrategy", "MediaElementLoadStrategy")
  @js.native
  open class MediaElementLoadStrategy protected () extends AbstractLoadStrategy[IMediaElementLoadConfig] {
