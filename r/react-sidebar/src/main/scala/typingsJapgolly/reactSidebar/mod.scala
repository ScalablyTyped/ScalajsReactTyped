package typingsJapgolly.reactSidebar
...
import typingsJapgolly.reactSidebar.anon.PartialCSSStyleDeclaratio
...
object mod {
  ...
  type Sidebar = japgolly.scalajs.react.facade.React.Component[SidebarProps & js.Object, js.Object]
  ...
  object SidebarProps {
    ...
    extension [Self <: SidebarProps](x: Self) {
      ...
      inline def setOnSetOpen(value: /* open */ Boolean => Callback): Self = StObject.set(x, "onSetOpen", js.Any.fromFunction1((t0: /* open */ Boolean) => value(t0).runNow()))
