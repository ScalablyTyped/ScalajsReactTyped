...
object TextareaAutosize {
  ...
  implicit def make(companion: TextareaAutosize.type): SharedBuilder_PickHTMLPropsHTMLTextArea1234167464[HTMLTextAreaElement] = new SharedBuilder_PickHTMLPropsHTMLTextArea1234167464[HTMLTextAreaElement](js.Array(this.component, js.Dictionary.empty))()
