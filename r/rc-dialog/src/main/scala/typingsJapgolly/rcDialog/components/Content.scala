...
object Content {
  ...
  inline def apply(
    ...
    val __props = js.Dynamic.literal(ariaId = ariaId.asInstanceOf[js.Any], motionName = motionName.asInstanceOf[js.Any], onVisibleChanged = js.Any.fromFunction1((t0: Boolean) => onVisibleChanged(t0).runNow()), prefixCls = prefixCls.asInstanceOf[js.Any])
