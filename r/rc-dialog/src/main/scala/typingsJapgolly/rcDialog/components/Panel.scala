...
object Panel {
  ...
  inline def apply(prefixCls: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PanelProps & RefAttributes[ContentRef]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[ContentRef] {
    ...
    inline def ariaId(value: String): this.type = set("ariaId", value.asInstanceOf[js.Any])
    ...
    inline def holderRef(value: Ref[HTMLDivElement]): this.type = set("holderRef", value.asInstanceOf[js.Any])
    
    inline def holderRefFunction1(value: HTMLDivElement | Null => Callback): this.type = set("holderRef", js.Any.fromFunction1((t0: HTMLDivElement | Null) => value(t0).runNow()))
    
    inline def holderRefNull: this.type = set("holderRef", null)
  ...
  def withProps(p: PanelProps & RefAttributes[ContentRef]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
