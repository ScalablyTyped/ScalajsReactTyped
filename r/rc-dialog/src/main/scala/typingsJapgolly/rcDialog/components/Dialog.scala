...
import typingsJapgolly.rcDialog.dialogMod.IDialogChildProps
import typingsJapgolly.rcDialog.dialogMod.default
...
object Dialog {
  ...
  ): UnmountedWithRoot[IDialogChildProps, default, Unit, IDialogChildProps] = {
  ...
  typingsJapgolly.rcDialog.dialogMod.IDialogChildProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.rcDialog.dialogMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rcDialog.dialogMod.IDialogChildProps])
  }
