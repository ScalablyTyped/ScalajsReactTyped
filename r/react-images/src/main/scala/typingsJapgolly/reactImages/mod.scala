package typingsJapgolly.reactImages
...
import typingsJapgolly.reactImages.anon.Download
import typingsJapgolly.reactImages.anon.Props
import typingsJapgolly.reactImages.reactImagesBooleans.`false`
import typingsJapgolly.reactImages.reactImagesStrings.auto
import typingsJapgolly.reactImages.reactImagesStrings.height
import typingsJapgolly.reactImages.reactImagesStrings.mouse
import typingsJapgolly.reactImages.reactImagesStrings.touch
import typingsJapgolly.reactImages.reactImagesStrings.width
import typingsJapgolly.reactImages.reactImagesStrings.x
import typingsJapgolly.reactImages.reactImagesStrings.y
...
object mod extends Shortcut {
  ...
  trait CarouselModalProps extends StObject {
    ...
    var onClose: js.UndefOr[js.Function1[/* event */ ReactEventFrom[HTMLButtonElement], Unit]] = js.undefined
  ...
  object CarouselModalProps {
    ...
    extension [Self <: CarouselModalProps](x: Self) {
      ...
      inline def setOnClose(value: /* event */ ReactEventFrom[HTMLButtonElement] => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[HTMLButtonElement]) => value(t0).runNow()))
  ...
  object TrackProps {
    ...
    extension [Self <: TrackProps](x: Self) {
      ...
      inline def setAxis(value: typingsJapgolly.reactImages.reactImagesStrings.x | y): Self = StObject.set(x, "axis", value.asInstanceOf[js.Any])
      ...
      inline def setOnSwipeMove(value: Callback): Self = StObject.set(x, "onSwipeMove", value.toJsFn)
      ...
      inline def setOnViewChange(value: /* view */ Double => Callback): Self = StObject.set(x, "onViewChange", js.Any.fromFunction1((t0: /* view */ Double) => value(t0).runNow()))
