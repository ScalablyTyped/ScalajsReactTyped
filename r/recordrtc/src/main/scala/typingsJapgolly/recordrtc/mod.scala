...
import typingsJapgolly.recordrtc.anon.Height
import typingsJapgolly.recordrtc.anon.Image
import typingsJapgolly.recordrtc.anon.KinDiskStorageTypeBlob
import typingsJapgolly.recordrtc.anon.OnRecordingStopped
import typingsJapgolly.recordrtc.recordrtcInts.`1024`
import typingsJapgolly.recordrtc.recordrtcInts.`16384`
import typingsJapgolly.recordrtc.recordrtcInts.`1`
import typingsJapgolly.recordrtc.recordrtcInts.`2048`
import typingsJapgolly.recordrtc.recordrtcInts.`256`
import typingsJapgolly.recordrtc.recordrtcInts.`2`
import typingsJapgolly.recordrtc.recordrtcInts.`4096`
import typingsJapgolly.recordrtc.recordrtcInts.`512`
import typingsJapgolly.recordrtc.recordrtcInts.`8192`
import typingsJapgolly.recordrtc.recordrtcStrings.`videoSlashx-matroskaSemicoloncodecsEqualssignavc1`
import typingsJapgolly.recordrtc.recordrtcStrings.all
import typingsJapgolly.recordrtc.recordrtcStrings.audio
import typingsJapgolly.recordrtc.recordrtcStrings.audioSlashogg
import typingsJapgolly.recordrtc.recordrtcStrings.audioSlashwav
import typingsJapgolly.recordrtc.recordrtcStrings.audioSlashwebm
import typingsJapgolly.recordrtc.recordrtcStrings.audioSlashwebmSemicoloncodecsEqualssignpcm
import typingsJapgolly.recordrtc.recordrtcStrings.canvas
import typingsJapgolly.recordrtc.recordrtcStrings.gif
import typingsJapgolly.recordrtc.recordrtcStrings.video
import typingsJapgolly.recordrtc.recordrtcStrings.videoSlashmp4
import typingsJapgolly.recordrtc.recordrtcStrings.videoSlashmpeg
import typingsJapgolly.recordrtc.recordrtcStrings.videoSlashwebm
import typingsJapgolly.recordrtc.recordrtcStrings.videoSlashwebmSemicoloncodecsEqualssignh264
import typingsJapgolly.recordrtc.recordrtcStrings.videoSlashwebmSemicoloncodecsEqualssignvp8
import typingsJapgolly.recordrtc.recordrtcStrings.videoSlashwebmSemicoloncodecsEqualssignvp9
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.recordrtc.recordrtcStrings.audioBlob
    - typingsJapgolly.recordrtc.recordrtcStrings.videoBlob
    - typingsJapgolly.recordrtc.recordrtcStrings.gifBlob
  */
  trait DiskStorageType extends StObject
  object DiskStorageType {
    
    inline def audioBlob: typingsJapgolly.recordrtc.recordrtcStrings.audioBlob = "audioBlob".asInstanceOf[typingsJapgolly.recordrtc.recordrtcStrings.audioBlob]
    
    inline def gifBlob: typingsJapgolly.recordrtc.recordrtcStrings.gifBlob = "gifBlob".asInstanceOf[typingsJapgolly.recordrtc.recordrtcStrings.gifBlob]
    
    inline def videoBlob: typingsJapgolly.recordrtc.recordrtcStrings.videoBlob = "videoBlob".asInstanceOf[typingsJapgolly.recordrtc.recordrtcStrings.videoBlob]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.recordrtc.recordrtcStrings.videoinput
    - typingsJapgolly.recordrtc.recordrtcStrings.audioinput
    - typingsJapgolly.recordrtc.recordrtcStrings.audiooutput
  */
  trait MediaStreamKind extends StObject
  object MediaStreamKind {
    
    inline def audioinput: typingsJapgolly.recordrtc.recordrtcStrings.audioinput = "audioinput".asInstanceOf[typingsJapgolly.recordrtc.recordrtcStrings.audioinput]
    
    inline def audiooutput: typingsJapgolly.recordrtc.recordrtcStrings.audiooutput = "audiooutput".asInstanceOf[typingsJapgolly.recordrtc.recordrtcStrings.audiooutput]
    
    inline def videoinput: typingsJapgolly.recordrtc.recordrtcStrings.videoinput = "videoinput".asInstanceOf[typingsJapgolly.recordrtc.recordrtcStrings.videoinput]
  }
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnTimeStamp(value: (/* timestamp */ Double, /* timestamps */ js.Array[Double]) => Callback): Self = StObject.set(x, "onTimeStamp", js.Any.fromFunction2((t0: /* timestamp */ Double, t1: /* timestamps */ js.Array[Double]) => (value(t0, t1)).runNow()))
      
      inline def setOnTimeStampUndefined: Self = StObject.set(x, "onTimeStamp", js.undefined)
      
      inline def setOndataavailable(value: /* blob */ Blob => Callback): Self = StObject.set(x, "ondataavailable", js.Any.fromFunction1((t0: /* blob */ Blob) => value(t0).runNow()))
      
      inline def setOndataavailableUndefined: Self = StObject.set(x, "ondataavailable", js.undefined)
      
      inline def setPreviewStream(value: /* stream */ MediaStream => Callback): Self = StObject.set(x, "previewStream", js.Any.fromFunction1((t0: /* stream */ MediaStream) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.recordrtc.mod.MediaStreamRecorder
    - typingsJapgolly.recordrtc.mod.StereoAudioRecorder
    - typingsJapgolly.recordrtc.mod.WebAssemblyRecorder
    - typingsJapgolly.recordrtc.mod.CanvasRecorder
    - typingsJapgolly.recordrtc.mod.GifRecorder
    - typingsJapgolly.recordrtc.mod.WhammyRecorder
    - typingsJapgolly.recordrtc.mod.MultiStreamsMixer
    - typingsJapgolly.recordrtc.mod.MultiStreamRecorder
    - typingsJapgolly.recordrtc.mod.RecordRTCPromisesHandler
  */
  trait Recorder extends StObject
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.recordrtc.recordrtcStrings.inactive
    - typingsJapgolly.recordrtc.recordrtcStrings.recording
    - typingsJapgolly.recordrtc.recordrtcStrings.stopped
    - typingsJapgolly.recordrtc.recordrtcStrings.paused
    - typingsJapgolly.recordrtc.recordrtcStrings.destroyed
  */
  trait State extends StObject
  object State {
    
    inline def destroyed: typingsJapgolly.recordrtc.recordrtcStrings.destroyed = "destroyed".asInstanceOf[typingsJapgolly.recordrtc.recordrtcStrings.destroyed]
    
    inline def inactive: typingsJapgolly.recordrtc.recordrtcStrings.inactive = "inactive".asInstanceOf[typingsJapgolly.recordrtc.recordrtcStrings.inactive]
    
    inline def paused: typingsJapgolly.recordrtc.recordrtcStrings.paused = "paused".asInstanceOf[typingsJapgolly.recordrtc.recordrtcStrings.paused]
    
    inline def recording: typingsJapgolly.recordrtc.recordrtcStrings.recording = "recording".asInstanceOf[typingsJapgolly.recordrtc.recordrtcStrings.recording]
    
    inline def stopped: typingsJapgolly.recordrtc.recordrtcStrings.stopped = "stopped".asInstanceOf[typingsJapgolly.recordrtc.recordrtcStrings.stopped]
  }
}
