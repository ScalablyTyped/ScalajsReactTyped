...
import typingsJapgolly.reactRouterNavigationCore.anon.Cards
import typingsJapgolly.reactRouterNavigationCore.anon.ForceSync
import typingsJapgolly.reactRouterNavigationCore.anon.LoadedTabs
import typingsJapgolly.reactRouterNavigationCore.anon.Params
import typingsJapgolly.reactRouterNavigationCore.anon.TestID
...
object mod {
  ...
  inline def build[Item](children: js.Array[Element]): js.Array[Item] = ^.asInstanceOf[js.Dynamic].applyDynamic("build")(children.asInstanceOf[js.Any]).asInstanceOf[js.Array[Item]]
  inline def build[Item](children: js.Array[Element], oldBuild: js.Array[Item]): js.Array[Item] = (^.asInstanceOf[js.Dynamic].applyDynamic("build")(children.asInstanceOf[js.Any], oldBuild.asInstanceOf[js.Any])).asInstanceOf[js.Array[Item]]
  ...
  inline def renderSubView(render: js.Function2[/* propsA */ Any, /* propsB */ Any, Node]): js.Function1[/* ownProps */ Any, Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("renderSubView")(render.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* ownProps */ Any, Node]]
  inline def renderSubView(render: js.Function2[/* propsA */ Any, /* propsB */ Any, Node], additionalProps: Any): js.Function1[/* ownProps */ Any, Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("renderSubView")(render.asInstanceOf[js.Any], additionalProps.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ownProps */ Any, Node]]
  ...
  object CardStackProps {
    ...
    inline def apply(render: CardsRendererProps => Node): CardStackProps = {
    ...
    extension [Self <: CardStackProps](x: Self) {
      ...
      inline def setRender(value: CardsRendererProps => Node): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
    }
  }
  ...
  trait RouteProps extends StObject {
    ...
    var component: js.UndefOr[ComponentClassP[RouterProps & js.Object]] = js.undefined
  ...
  object RouteProps {
    ...
    extension [Self <: RouteProps](x: Self) {
      ...
      inline def setChildren(value: (js.Function1[/* props */ RouterProps, Node]) | Node): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      inline def setChildrenFunction1(value: /* props */ RouterProps => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      inline def setComponent(value: ComponentClassP[RouterProps & js.Object]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      inline def setRender(value: /* props */ RouterProps => Node): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
  ...
  object TabStackProps {
    ...
    inline def apply(render: TabsRendererProps => Node): TabStackProps = {
      val __obj = js.Dynamic.literal(render = js.Any.fromFunction1(render))
    ...
    extension [Self <: TabStackProps](x: Self) {
      ...
      inline def setRender(value: TabsRendererProps => Node): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
  ...
  object TabsRendererProps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(loadedTabs = loadedTabs.asInstanceOf[js.Any], navigationState = navigationState.asInstanceOf[js.Any], onIndexChange = js.Any.fromFunction1((t0: Double) => onIndexChange(t0).runNow()), tabs = tabs.asInstanceOf[js.Any])
