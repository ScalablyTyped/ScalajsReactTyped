...
import typingsJapgolly.rmcDialog.rmcDialogDoubles.`1.05`
import typingsJapgolly.rmcDialog.rmcDialogInts.`0`
import typingsJapgolly.rmcDialog.rmcDialogInts.`1`
