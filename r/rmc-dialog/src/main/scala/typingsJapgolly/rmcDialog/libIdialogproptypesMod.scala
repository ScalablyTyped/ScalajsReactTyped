...
object libIdialogproptypesMod {
  ...
  object IDialogPropTypes {
    ...
    extension [Self <: IDialogPropTypes](x: Self) {
      ...
      inline def setOnAnimateLeave(value: Callback): Self = StObject.set(x, "onAnimateLeave", value.toJsFn)
      
      inline def setOnAnimateLeaveUndefined: Self = StObject.set(x, "onAnimateLeave", js.undefined)
      
      inline def setOnClose(value: /* e */ Any => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* e */ Any) => value(t0).runNow()))
