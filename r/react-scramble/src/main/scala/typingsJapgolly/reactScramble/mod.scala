package typingsJapgolly.reactScramble

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.Shortcut
import typingsJapgolly.react.mod.FC
import typingsJapgolly.reactScramble.reactScrambleStrings.Plussign
import typingsJapgolly.reactScramble.reactScrambleStrings.`-_`
import typingsJapgolly.reactScramble.reactScrambleStrings.all
import typingsJapgolly.reactScramble.reactScrambleStrings.fast
import typingsJapgolly.reactScramble.reactScrambleStrings.forward
...
import typingsJapgolly.reactScramble.reactScrambleStrings.random
...
object mod extends Shortcut {
  ...
  object AnimationControls {
    ...
    inline def apply(pause: Callback, start: Callback): AnimationControls = {
      val __obj = js.Dynamic.literal(pause = pause.toJsFn, start = start.toJsFn)
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setBindMethod(value: /* c */ AnimationControls => Callback): Self = StObject.set(x, "bindMethod", js.Any.fromFunction1((t0: /* c */ AnimationControls) => value(t0).runNow()))
