package typingsJapgolly.reactStickyEl
...
import typingsJapgolly.reactStickyEl.mod.Sticky.Props
import typingsJapgolly.reactStickyEl.reactStickyElStrings.bottom
import typingsJapgolly.reactStickyEl.reactStickyElStrings.top
...
object mod {
  ...
  object Sticky {
    ...
    trait Props[HolderProps /* <: js.Object */]
      ...
      var holderCmp: js.UndefOr[
            /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 118, starting with typingsJapgolly.reactStickyEl.reactStickyElStrings.a, typingsJapgolly.reactStickyEl.reactStickyElStrings.abbr, typingsJapgolly.reactStickyEl.reactStickyElStrings.address */ Any
          ] = js.undefined
    ...
    object Props {
      ...
      extension [Self <: Props[?], HolderProps /* <: js.Object */](x: Self & Props[HolderProps]) {
        ...
        inline def setHolderCmp(
          value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 118, starting with typingsJapgolly.reactStickyEl.reactStickyElStrings.a, typingsJapgolly.reactStickyEl.reactStickyElStrings.abbr, typingsJapgolly.reactStickyEl.reactStickyElStrings.address */ Any
        ...
        inline def setOnFixedToggle(value: /* fixed */ Boolean => Callback): Self = StObject.set(x, "onFixedToggle", js.Any.fromFunction1((t0: /* fixed */ Boolean) => value(t0).runNow()))
  ...
  type Sticky = japgolly.scalajs.react.facade.React.Component[Props[js.Object] & js.Object, js.Object]
}
