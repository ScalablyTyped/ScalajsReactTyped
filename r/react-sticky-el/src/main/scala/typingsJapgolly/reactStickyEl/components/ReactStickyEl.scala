package typingsJapgolly.reactStickyEl.components
...
import typingsJapgolly.reactStickyEl.mod.default
...
object ReactStickyEl {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def boundaryElement(value: String): this.type = set("boundaryElement", value.asInstanceOf[js.Any])
    ...
    inline def hideOnBoundaryHit(value: Boolean): this.type = set("hideOnBoundaryHit", value.asInstanceOf[js.Any])
    
    inline def holderCmp(
    ...
    ): this.type = set("holderCmp", value.asInstanceOf[js.Any])
    
    inline def holderProps(value: js.Object): this.type = set("holderProps", value.asInstanceOf[js.Any])
    ...
    inline def mode(value: top | bottom): this.type = set("mode", value.asInstanceOf[js.Any])
    ...
    inline def onFixedToggle(value: /* fixed */ Boolean => Callback): this.type = set("onFixedToggle", js.Any.fromFunction1((t0: /* fixed */ Boolean) => value(t0).runNow()))
    ...
    inline def positionRecheckInterval(value: Double): this.type = set("positionRecheckInterval", value.asInstanceOf[js.Any])
    ...
    inline def scrollElement(value: String): this.type = set("scrollElement", value.asInstanceOf[js.Any])
    ...
    inline def stickyStyle(value: CSSProperties): this.type = set("stickyStyle", value.asInstanceOf[js.Any])
    ...
    inline def wrapperCmp(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 118, starting with typingsJapgolly.reactStickyEl.reactStickyElStrings.a, typingsJapgolly.reactStickyEl.reactStickyElStrings.abbr, typingsJapgolly.reactStickyEl.reactStickyElStrings.address */ Any
    ): this.type = set("wrapperCmp", value.asInstanceOf[js.Any])
  }
