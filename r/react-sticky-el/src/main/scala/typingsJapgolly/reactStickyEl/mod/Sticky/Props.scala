package typingsJapgolly.reactStickyEl.mod.Sticky
...
object Props {
  ...
  def apply[HolderProps /* <: js.Object */](
    ...
    onFixedToggle: /* fixed */ Boolean => Callback = null,
    ...
    if (onFixedToggle != null) __obj.updateDynamic("onFixedToggle")(js.Any.fromFunction1((t0: /* fixed */ scala.Boolean) => onFixedToggle(t0).runNow()))
