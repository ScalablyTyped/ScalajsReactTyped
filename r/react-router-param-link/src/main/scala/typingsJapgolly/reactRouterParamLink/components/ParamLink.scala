...
object ParamLink {
  def apply(
    ...
    typingsJapgolly.reactRouterParamLink.mod.ParamLink, 
    Unit, 
    LinkProps[LocationState]
  ] = {
  ...
  typingsJapgolly.reactRouterDom.mod.LinkProps[typingsJapgolly.history.mod.LocationState], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactRouterParamLink.mod.ParamLink](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactRouterDom.mod.LinkProps[typingsJapgolly.history.mod.LocationState]])(children: _*)
  }
