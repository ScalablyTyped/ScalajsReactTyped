...
object CreditCard {
  ...
  implicit def make(companion: CreditCard.type): SharedBuilder_KawaiiProps1504151659 = new SharedBuilder_KawaiiProps1504151659(js.Array(this.component, js.Dictionary.empty))()
