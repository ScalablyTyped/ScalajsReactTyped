...
object IceCream {
  ...
  implicit def make(companion: IceCream.type): SharedBuilder_KawaiiProps1504151659 = new SharedBuilder_KawaiiProps1504151659(js.Array(this.component, js.Dictionary.empty))()
