...
object Cat {
  ...
  implicit def make(companion: Cat.type): SharedBuilder_KawaiiProps1504151659 = new SharedBuilder_KawaiiProps1504151659(js.Array(this.component, js.Dictionary.empty))()
