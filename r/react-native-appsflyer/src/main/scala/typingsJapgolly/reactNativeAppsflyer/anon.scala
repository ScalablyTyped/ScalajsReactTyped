...
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerStrings.`false`
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerStrings.`true`
