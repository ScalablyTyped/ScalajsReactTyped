...
import typingsJapgolly.reactNativeAppsflyer.anon.Afadset
import typingsJapgolly.reactNativeAppsflyer.anon.Afsub1
import typingsJapgolly.reactNativeAppsflyer.anon.Dictkey
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerInts.`0`
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerInts.`3`
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerStrings.Error
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerStrings.FOUND
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerStrings.NOT_FOUND
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerStrings.failure
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerStrings.onAppOpenAttribution
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerStrings.onAttributionFailure
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerStrings.onDeepLinking
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerStrings.onInstallConversionDataLoaded
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerStrings.onInstallConversionFailure
...
object mod {
  ...
  object AF_EMAIL_CRYPT_TYPE extends StObject {
    ...
    /* 0 */ val NONE: typingsJapgolly.reactNativeAppsflyer.mod.AF_EMAIL_CRYPT_TYPE.NONE & Double = js.native
    
    @js.native
    sealed trait SHA256
      extends StObject
         with AF_EMAIL_CRYPT_TYPE
    /* 1 */ val SHA256: typingsJapgolly.reactNativeAppsflyer.mod.AF_EMAIL_CRYPT_TYPE.SHA256 & Double = js.native
  }
