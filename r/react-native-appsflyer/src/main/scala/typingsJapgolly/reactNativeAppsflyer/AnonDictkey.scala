...
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerStrings.Organic
import typingsJapgolly.reactNativeAppsflyer.reactNativeAppsflyerStrings.`Non-organic`
