...
object accordionMod {
  ...
  type Accordion[T] = japgolly.scalajs.react.facade.React.Component[AccordionProps[T] & js.Object, js.Object]
  ...
  object AccordionProps {
    ...
    inline def apply[T](
      ...
      val __obj = js.Dynamic.literal(activeSections = activeSections.asInstanceOf[js.Any], onChange = js.Any.fromFunction1((t0: js.Array[Double]) => onChange(t0).runNow()), renderContent = js.Any.fromFunction4(renderContent), renderHeader = js.Any.fromFunction4(renderHeader), sections = sections.asInstanceOf[js.Any])
    ...
    extension [Self <: AccordionProps[?], T](x: Self & AccordionProps[T]) {
      ...
      inline def setRenderContent(value: (T, Double, Boolean, js.Array[T]) => Element): Self = StObject.set(x, "renderContent", js.Any.fromFunction4(value))
      
      inline def setRenderFooter(
        value: (/* content */ T, /* index */ Double, /* isActive */ Boolean, /* sections */ js.Array[T]) => Element
      ...
      inline def setRenderHeader(value: (T, Double, Boolean, js.Array[T]) => Element): Self = StObject.set(x, "renderHeader", js.Any.fromFunction4(value))
