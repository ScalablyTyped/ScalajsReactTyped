package typingsJapgolly.reactTypist
...
object mod {
  ...
  object default {
    ...
    open class Backspace protected ()
      extends typingsJapgolly.reactTypist.mod.Typist.Backspace {
    ...
    open class Delay protected ()
      extends typingsJapgolly.reactTypist.mod.Typist.Delay {
  ...
  object TypistProps {
    ...
    extension [Self <: TypistProps](x: Self) {
      ...
      inline def setOnCharacterTyped(value: (/* char */ String, /* charIndex */ Double) => Callback): Self = StObject.set(x, "onCharacterTyped", js.Any.fromFunction2((t0: /* char */ String, t1: /* charIndex */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnCharacterTypedUndefined: Self = StObject.set(x, "onCharacterTyped", js.undefined)
      
      inline def setOnLineTyped(value: (/* line */ String, /* lineIndex */ Double) => Callback): Self = StObject.set(x, "onLineTyped", js.Any.fromFunction2((t0: /* line */ String, t1: /* lineIndex */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnLineTypedUndefined: Self = StObject.set(x, "onLineTyped", js.undefined)
      
      inline def setOnTypingDone(value: Callback): Self = StObject.set(x, "onTypingDone", value.toJsFn)
