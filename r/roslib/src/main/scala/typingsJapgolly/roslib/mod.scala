...
import typingsJapgolly.roslib.anon.Topics
...
import typingsJapgolly.roslib.roslibStrings.close
import typingsJapgolly.roslib.roslibStrings.connection
import typingsJapgolly.roslib.roslibStrings.error
...
object mod {
  ...
  open class UrdfModel protected () extends StObject {
    /**
      ...
      */
    def this(options: typingsJapgolly.roslib.anon.String) = this()
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.roslib.mod.UrdfSphere
    - typingsJapgolly.roslib.mod.UrdfBox
    - typingsJapgolly.roslib.mod.UrdfCylinder
    - typingsJapgolly.roslib.mod.UrdfMesh
  */
