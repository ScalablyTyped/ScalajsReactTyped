...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "react-motion" % "0.0-unknown-dt-20200227Z-0112eb",
  "org.scalablytyped.japgolly" %%% "resize-observer-polyfill" % "1.5.1-9bdcd9",
