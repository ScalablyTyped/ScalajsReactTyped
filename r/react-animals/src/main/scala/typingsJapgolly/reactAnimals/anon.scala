package typingsJapgolly.reactAnimals
...
object anon {
  ...
  trait PartialAnimalProps extends StObject {
    ...
    var name: js.UndefOr[
        /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 72, starting with typingsJapgolly.reactAnimals.reactAnimalsStrings.alligator, typingsJapgolly.reactAnimals.reactAnimalsStrings.anteater, typingsJapgolly.reactAnimals.reactAnimalsStrings.armadillo */ Any
      ] = js.undefined
  ...
  object PartialAnimalProps {
    ...
    extension [Self <: PartialAnimalProps](x: Self) {
