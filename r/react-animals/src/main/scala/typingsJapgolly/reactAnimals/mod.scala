...
object mod extends Shortcut {
  ...
  trait AnimalProps extends StObject {
    ...
    var name: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 71, starting with typingsJapgolly.reactAnimals.reactAnimalsStrings.alligator, typingsJapgolly.reactAnimals.reactAnimalsStrings.anteater, typingsJapgolly.reactAnimals.reactAnimalsStrings.armadillo */ Any
  ...
  object AnimalProps {
    ...
    inline def apply(
      circle: Boolean,
      dance: Boolean,
      name: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 71, starting with typingsJapgolly.reactAnimals.reactAnimalsStrings.alligator, typingsJapgolly.reactAnimals.reactAnimalsStrings.anteater, typingsJapgolly.reactAnimals.reactAnimalsStrings.armadillo */ Any,
      rounded: Boolean,
      square: Boolean
    ): AnimalProps = {
    ...
    extension [Self <: AnimalProps](x: Self) {
      ...
      inline def setName(
        value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 71, starting with typingsJapgolly.reactAnimals.reactAnimalsStrings.alligator, typingsJapgolly.reactAnimals.reactAnimalsStrings.anteater, typingsJapgolly.reactAnimals.reactAnimalsStrings.armadillo */ Any
