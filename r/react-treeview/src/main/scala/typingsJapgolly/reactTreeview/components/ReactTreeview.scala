package typingsJapgolly.reactTreeview.components
...
import typingsJapgolly.reactTreeview.mod.TreeProps
import typingsJapgolly.reactTreeview.mod.^
...
object ReactTreeview {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def childrenClassName(value: String): this.type = set("childrenClassName", value.asInstanceOf[js.Any])
    ...
    inline def nodeLabel(value: VdomNode): this.type = set("nodeLabel", value.rawNode.asInstanceOf[js.Any])
    
    inline def nodeLabelNull: this.type = set("nodeLabel", null)
    
    inline def nodeLabelVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("nodeLabel", js.Array(value*))
    
    inline def nodeLabelVdomElement(value: VdomElement): this.type = set("nodeLabel", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def treeViewClassName(value: String): this.type = set("treeViewClassName", value.asInstanceOf[js.Any])
