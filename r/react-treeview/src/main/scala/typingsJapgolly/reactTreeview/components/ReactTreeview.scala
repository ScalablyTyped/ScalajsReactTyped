...
object ReactTreeview {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TreeProps, ^, Unit, TreeProps] = {
  ...
  typingsJapgolly.reactTreeview.mod.TreeProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactTreeview.mod.^](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactTreeview.mod.TreeProps])(children: _*)
  }
