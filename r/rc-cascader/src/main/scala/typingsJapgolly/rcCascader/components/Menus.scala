...
import typingsJapgolly.rcCascader.menusMod.MenusProps
import typingsJapgolly.rcCascader.menusMod.default
...
object Menus {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MenusProps, default, Unit, MenusProps] = {
  ...
  typingsJapgolly.rcCascader.menusMod.MenusProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.rcCascader.menusMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rcCascader.menusMod.MenusProps])(children: _*)
  }
