...
object OptionList {
  ...
  def withProps(p: RefAttributes[RefOptionListProps]): Default[RefOptionListProps] = new Default[RefOptionListProps](js.Array(this.component, p.asInstanceOf[js.Any]))
}
