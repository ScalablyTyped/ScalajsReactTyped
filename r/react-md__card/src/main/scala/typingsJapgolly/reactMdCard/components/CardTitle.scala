...
import typingsJapgolly.reactMdCard.typesCardTitleMod.CardTitleProps
...
object CardTitle {
  ...
  def withProps(p: CardTitleProps & RefAttributes[HTMLHeadingElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
