...
import typingsJapgolly.reactMdCard.typesCardSubtitleMod.CardSubtitleProps
...
object CardSubtitle {
  ...
  def withProps(p: CardSubtitleProps & RefAttributes[HTMLHeadingElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
