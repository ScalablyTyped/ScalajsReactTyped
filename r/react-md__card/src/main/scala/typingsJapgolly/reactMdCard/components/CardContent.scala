package typingsJapgolly.reactMdCard.components
...
import typingsJapgolly.reactMdCard.typesCardContentMod.CardContentProps
...
object CardContent {
  ...
  @JSImport("@react-md/card", "CardContent")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def disableExtraPadding(value: Boolean): this.type = set("disableExtraPadding", value.asInstanceOf[js.Any])
  ...
  def withProps(p: CardContentProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
