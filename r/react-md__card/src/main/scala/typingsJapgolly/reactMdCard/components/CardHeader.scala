...
import typingsJapgolly.reactMdCard.typesCardHeaderMod.CardHeaderProps
...
object CardHeader {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def afterChildren(value: VdomNode): this.type = set("afterChildren", value.rawNode.asInstanceOf[js.Any])
    
    inline def afterChildrenNull: this.type = set("afterChildren", null)
    
    inline def afterChildrenVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("afterChildren", js.Array(value*))
    
    inline def afterChildrenVdomElement(value: VdomElement): this.type = set("afterChildren", value.rawElement.asInstanceOf[js.Any])
    
    inline def align(value: top | center | bottom | none): this.type = set("align", value.asInstanceOf[js.Any])
    ...
    inline def beforeChildren(value: VdomNode): this.type = set("beforeChildren", value.rawNode.asInstanceOf[js.Any])
    
    inline def beforeChildrenNull: this.type = set("beforeChildren", null)
    
    inline def beforeChildrenVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("beforeChildren", js.Array(value*))
    
    inline def beforeChildrenVdomElement(value: VdomElement): this.type = set("beforeChildren", value.rawElement.asInstanceOf[js.Any])
  ...
  def withProps(p: CardHeaderProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
