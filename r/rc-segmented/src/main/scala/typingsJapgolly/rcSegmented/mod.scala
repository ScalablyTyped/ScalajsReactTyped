...
object mod extends Shortcut {
  ...
  trait SegmentedLabeledOption extends StObject {
    ...
    var value: SegmentedRawOption
  }
  object SegmentedLabeledOption {
    
    inline def apply(value: SegmentedRawOption): SegmentedLabeledOption = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any], label = null)
      __obj.asInstanceOf[SegmentedLabeledOption]
    }
    
    extension [Self <: SegmentedLabeledOption](x: Self) {
      ...
      inline def setValue(value: SegmentedRawOption): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
    }
  }
  
  type SegmentedOptions = js.Array[SegmentedRawOption | SegmentedLabeledOption]
  
  /* Inlined parent std.Omit<react.react.HTMLProps<std.HTMLDivElement>, 'onChange'> */
  trait SegmentedProps extends StObject {
  ...
  object SegmentedProps {
    
    inline def apply(options: SegmentedOptions): SegmentedProps = {
