...
import typingsJapgolly.rcSegmented.mod.SegmentedLabeledOption
...
object anon {
  ...
  object PickSegmentedPropsonChang {
    
    inline def apply(options: SegmentedOptions): PickSegmentedPropsonChang = {
    ...
    extension [Self <: PickSegmentedPropsonChang](x: Self) {
      ...
      inline def setOptions(value: SegmentedOptions): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
