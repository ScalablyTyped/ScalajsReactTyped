...
object Hits {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[HitsProps[T], typingsJapgolly.reactInstantsearchDom.mod.Hits[T], Unit, HitsProps[T]] = {
  ...
  typingsJapgolly.reactInstantsearchDom.mod.Hits[T]](this.componentImport)
