...
object anon {
  ...
  trait Hit[T] extends StObject {
    ...
    var hit: typingsJapgolly.reactInstantsearchCore.mod.Hit[T]
  }
  object Hit {
    
    inline def apply[T](hit: typingsJapgolly.reactInstantsearchCore.mod.Hit[T]): Hit[T] = {
    ...
    extension [Self <: Hit[?], T](x: Self & Hit[T]) {
      ...
      inline def setHit(value: typingsJapgolly.reactInstantsearchCore.mod.Hit[T]): Self = StObject.set(x, "hit", value.asInstanceOf[js.Any])
    }
  }
