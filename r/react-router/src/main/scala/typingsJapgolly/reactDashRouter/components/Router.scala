...
object Router {
  def apply(
    ...
    RouterProps, 
    typingsJapgolly.reactDashRouter.reactDashRouterMod.Router, 
    Unit, 
    RouterProps
  ] = {
  ...
  typingsJapgolly.reactDashRouter.reactDashRouterMod.Router](js.constructorOf[typingsJapgolly.reactDashRouter.reactDashRouterMod.Router])
