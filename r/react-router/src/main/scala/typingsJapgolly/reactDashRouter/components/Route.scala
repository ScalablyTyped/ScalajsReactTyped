...
object Route {
  def apply(
    ...
    RouteProps, 
    typingsJapgolly.reactDashRouter.reactDashRouterMod.Route[RouteProps], 
    Unit, 
    RouteProps
  ] = {
  ...
  typingsJapgolly.reactDashRouter.reactDashRouterMod.Route[typingsJapgolly.reactDashRouter.reactDashRouterMod.RouteProps]](js.constructorOf[typingsJapgolly.reactDashRouter.reactDashRouterMod.Route[typingsJapgolly.reactDashRouter.reactDashRouterMod.RouteProps]])
