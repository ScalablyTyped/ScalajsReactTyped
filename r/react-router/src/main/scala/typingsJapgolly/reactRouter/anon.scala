...
import typingsJapgolly.reactRouter.distLibContextMod.DataRouteObject
...
object anon {
  ...
  object Location {
    ...
    inline def apply(error: Any, location: typingsJapgolly.remixRunRouter.distHistoryMod.Location): Location = {
  ...
  object Revalidate {
    ...
    inline def apply(revalidate: Callback, state: RevalidationState): Revalidate = {
      val __obj = js.Dynamic.literal(revalidate = revalidate.toJsFn, state = state.asInstanceOf[js.Any])
