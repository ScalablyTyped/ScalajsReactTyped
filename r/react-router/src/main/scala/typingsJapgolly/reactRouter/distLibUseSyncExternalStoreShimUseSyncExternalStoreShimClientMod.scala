...
object distLibUseSyncExternalStoreShimUseSyncExternalStoreShimClientMod {
  
  @JSImport("react-router/dist/lib/use-sync-external-store-shim/useSyncExternalStoreShimClient", JSImport.Namespace)
  @js.native
