...
object Route {
  def apply[T /* <: RouteProps */](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[T with js.Object, typingsJapgolly.reactRouter.mod.Route[T], Unit, T with js.Object] = {
  ...
  typingsJapgolly.reactRouter.mod.Route[T]](this.componentImport)
