...
object Redirect {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RedirectProps, typingsJapgolly.reactRouter.mod.Redirect, Unit, RedirectProps] = {
  ...
  typingsJapgolly.reactRouter.mod.Redirect](this.componentImport)
