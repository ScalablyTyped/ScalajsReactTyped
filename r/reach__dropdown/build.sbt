...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "reach__descendants" % "0.18.0-e121a2",
  "org.scalablytyped.japgolly" %%% "reach__polymorphic" % "0.18.0-025f39",
  "org.scalablytyped.japgolly" %%% "reach__popover" % "0.18.0-790959",
  "org.scalablytyped.japgolly" %%% "reach__rect" % "0.18.0-8749b1",
