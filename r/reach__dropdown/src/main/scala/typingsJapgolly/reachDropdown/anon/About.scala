...
trait About extends StObject {
  ...
  def onClick(event: ReactMouseEventFrom[HTMLDivElement]): Any
  ...
  def onDragStart(event: ReactDragEventFrom[HTMLDivElement]): Any
  ...
  def onFocus(event: ReactFocusEventFrom[HTMLDivElement]): Any
  ...
  def onMouseDown(event: ReactMouseEventFrom[HTMLDivElement]): Any
  
  var onMouseDownCapture: js.UndefOr[MouseEventHandler[HTMLDivElement]] = js.undefined
  
  def onMouseEnter(event: ReactMouseEventFrom[HTMLDivElement]): Any
  
  def onMouseLeave(event: ReactMouseEventFrom[HTMLDivElement]): Any
  
  def onMouseMove(event: ReactMouseEventFrom[HTMLDivElement]): Any
  ...
  def onMouseUp(event: ReactMouseEventFrom[HTMLDivElement]): Any
...
object About {
  ...
  inline def apply(
    ...
    onClick: ReactMouseEventFrom[HTMLDivElement] => Any,
    onDragStart: ReactDragEventFrom[HTMLDivElement] => Any,
    onFocus: ReactFocusEventFrom[HTMLDivElement] => Any,
    onMouseDown: ReactMouseEventFrom[HTMLDivElement] => Any,
    onMouseEnter: ReactMouseEventFrom[HTMLDivElement] => Any,
    onMouseLeave: ReactMouseEventFrom[HTMLDivElement] => Any,
    onMouseMove: ReactMouseEventFrom[HTMLDivElement] => Any,
    onMouseUp: ReactMouseEventFrom[HTMLDivElement] => Any,
    ref: Any => Callback,
    tabIndex: Double
  ): About = {
    val __obj = js.Dynamic.literal(onClick = js.Any.fromFunction1(onClick), onDragStart = js.Any.fromFunction1(onDragStart), onFocus = js.Any.fromFunction1(onFocus), onMouseDown = js.Any.fromFunction1(onMouseDown), onMouseEnter = js.Any.fromFunction1(onMouseEnter), onMouseLeave = js.Any.fromFunction1(onMouseLeave), onMouseMove = js.Any.fromFunction1(onMouseMove), onMouseUp = js.Any.fromFunction1(onMouseUp), ref = js.Any.fromFunction1((t0: Any) => ref(t0).runNow()), tabIndex = tabIndex.asInstanceOf[js.Any], children = null)
  ...
  extension [Self <: About](x: Self) {
    ...
    inline def setOnClick(value: ReactMouseEventFrom[HTMLDivElement] => Any): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
    ...
    inline def setOnDragStart(value: ReactDragEventFrom[HTMLDivElement] => Any): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: ReactFocusEventFrom[HTMLDivElement] => Any): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
    ...
    inline def setOnMouseDown(value: ReactMouseEventFrom[HTMLDivElement] => Any): Self = StObject.set(x, "onMouseDown", js.Any.fromFunction1(value))
    ...
    inline def setOnMouseEnter(value: ReactMouseEventFrom[HTMLDivElement] => Any): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction1(value))
    
    inline def setOnMouseLeave(value: ReactMouseEventFrom[HTMLDivElement] => Any): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction1(value))
    
    inline def setOnMouseMove(value: ReactMouseEventFrom[HTMLDivElement] => Any): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction1(value))
    ...
    inline def setOnMouseUp(value: ReactMouseEventFrom[HTMLDivElement] => Any): Self = StObject.set(x, "onMouseUp", js.Any.fromFunction1(value))
