...
trait DropdownRef extends StObject {
  ...
  var dropdownRef: js.UndefOr[RefHandle[HTMLElement | Null]] = js.undefined
...
object DropdownRef {
  ...
  extension [Self <: DropdownRef](x: Self) {
    ...
    inline def setDropdownRef(value: RefHandle[HTMLElement | Null]): Self = StObject.set(x, "dropdownRef", value.asInstanceOf[js.Any])
