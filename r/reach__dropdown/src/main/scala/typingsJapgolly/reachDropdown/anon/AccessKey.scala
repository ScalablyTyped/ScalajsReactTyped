...
trait AccessKey extends StObject {
  ...
  def onKeyDown(event: ReactKeyboardEventFrom[HTMLDivElement]): Any
...
object AccessKey {
  ...
  inline def apply(onKeyDown: ReactKeyboardEventFrom[HTMLDivElement] => Any, ref: Any => Callback, tabIndex: Double): AccessKey = {
    val __obj = js.Dynamic.literal(onKeyDown = js.Any.fromFunction1(onKeyDown), ref = js.Any.fromFunction1((t0: Any) => ref(t0).runNow()), tabIndex = tabIndex.asInstanceOf[js.Any], children = null)
  ...
  extension [Self <: AccessKey](x: Self) {
    ...
    inline def setOnKeyDown(value: ReactKeyboardEventFrom[HTMLDivElement] => Any): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
