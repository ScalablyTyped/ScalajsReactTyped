...
object reachDropdownStrings {
  
  @js.native
  sealed trait CLEAR_SELECTION_INDEX extends StObject
  inline def CLEAR_SELECTION_INDEX: CLEAR_SELECTION_INDEX = "CLEAR_SELECTION_INDEX".asInstanceOf[CLEAR_SELECTION_INDEX]
  
  @js.native
  sealed trait CLICK_MENU_ITEM extends StObject
  inline def CLICK_MENU_ITEM: CLICK_MENU_ITEM = "CLICK_MENU_ITEM".asInstanceOf[CLICK_MENU_ITEM]
  
  @js.native
  sealed trait CLOSE_MENU extends StObject
  inline def CLOSE_MENU: CLOSE_MENU = "CLOSE_MENU".asInstanceOf[CLOSE_MENU]
  
  @js.native
  sealed trait OPEN_MENU_AT_FIRST_ITEM extends StObject
  inline def OPEN_MENU_AT_FIRST_ITEM: OPEN_MENU_AT_FIRST_ITEM = "OPEN_MENU_AT_FIRST_ITEM".asInstanceOf[OPEN_MENU_AT_FIRST_ITEM]
  
  @js.native
  sealed trait OPEN_MENU_AT_INDEX extends StObject
  inline def OPEN_MENU_AT_INDEX: OPEN_MENU_AT_INDEX = "OPEN_MENU_AT_INDEX".asInstanceOf[OPEN_MENU_AT_INDEX]
  
  @js.native
  sealed trait OPEN_MENU_CLEARED extends StObject
  inline def OPEN_MENU_CLEARED: OPEN_MENU_CLEARED = "OPEN_MENU_CLEARED".asInstanceOf[OPEN_MENU_CLEARED]
  
  @js.native
  sealed trait SEARCH_FOR_ITEM extends StObject
  inline def SEARCH_FOR_ITEM: SEARCH_FOR_ITEM = "SEARCH_FOR_ITEM".asInstanceOf[SEARCH_FOR_ITEM]
  
  @js.native
  sealed trait SELECT_ITEM_AT_INDEX extends StObject
  inline def SELECT_ITEM_AT_INDEX: SELECT_ITEM_AT_INDEX = "SELECT_ITEM_AT_INDEX".asInstanceOf[SELECT_ITEM_AT_INDEX]
  
  @js.native
  sealed trait SET_BUTTON_ID extends StObject
  inline def SET_BUTTON_ID: SET_BUTTON_ID = "SET_BUTTON_ID".asInstanceOf[SET_BUTTON_ID]
