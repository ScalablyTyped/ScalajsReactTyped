...
import typingsJapgolly.reachDropdown.mod.DropdownItemsProps
...
object DropdownItems {
  ...
  implicit def make(companion: DropdownItems.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
