...
import typingsJapgolly.rethinkdb.rethinkdbStrings.`object`
import typingsJapgolly.rethinkdb.rethinkdbStrings.array
...
trait Sequence
  ...
  def distinct(opts: typingsJapgolly.rethinkdb.anon.Index): Sequence = js.native
