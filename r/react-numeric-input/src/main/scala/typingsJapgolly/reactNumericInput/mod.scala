...
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.`additions removals`
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.`additions text`
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.`inline`
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.`removals additions`
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.`removals text`
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.`text additions`
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.`text removals`
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.additions
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.all
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.ascending
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.assertive
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.auto
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.both
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.copy
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.date
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.decimal
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.descending
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.dialog
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.done
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.email
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.enter
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.environment
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.execute
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.go
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.grammar
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.grid
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.horizontal
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.inherit
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.link
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.list
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.listbox
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.location
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.menu
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.mixed
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.move
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.next
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.no
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.none
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.numeric
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.off
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.on
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.other
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.page
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.polite
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.popup
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.previous
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.removals
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.search
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.send
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.spelling
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.step
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.tel
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.text
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.time
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.tree
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.url
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.user
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.vertical
import typingsJapgolly.reactNumericInput.reactNumericInputStrings.yes
...
object mod {
  ...
  @js.native
  open class ^ () extends Component[NumericInputProps, NumericInputState, Any]
  @JSImport("react-numeric-input", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* static member */
  @JSImport("react-numeric-input", "DIRECTION_DOWN")
  @js.native
  def DIRECTION_DOWN: String = js.native
  inline def DIRECTION_DOWN_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DIRECTION_DOWN")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("react-numeric-input", "DIRECTION_UP")
  @js.native
  def DIRECTION_UP: String = js.native
  inline def DIRECTION_UP_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DIRECTION_UP")(x.asInstanceOf[js.Any])
  
  type BoundsFunctionProp = Double | (js.Function1[
    japgolly.scalajs.react.facade.React.Component[NumericInputProps & js.Object, js.Object], 
    js.UndefOr[Double]
  ])
  
  type NumericInput = japgolly.scalajs.react.facade.React.Component[NumericInputProps & js.Object, js.Object]
  ...
  trait NumericInputProps extends StObject {
  ...
  object NumericInputProps {
    ...
    inline def apply(): NumericInputProps = {
    ...
    extension [Self <: NumericInputProps](x: Self) {
      ...
      inline def setFormat(value: /* value */ Double | Null => String): Self = StObject.set(x, "format", js.Any.fromFunction1(value))
      ...
      inline def setMax(value: BoundsFunctionProp): Self = StObject.set(x, "max", value.asInstanceOf[js.Any])
      
      inline def setMaxFunction1(
        value: japgolly.scalajs.react.facade.React.Component[NumericInputProps & js.Object, js.Object] => js.UndefOr[Double]
      ...
      inline def setMin(value: BoundsFunctionProp): Self = StObject.set(x, "min", value.asInstanceOf[js.Any])
      ...
      inline def setMobile(
        value: Boolean | auto | (js.Function1[
              japgolly.scalajs.react.facade.React.Component[NumericInputProps & js.Object, js.Object], 
              Boolean
            ])
      ): Self = StObject.set(x, "mobile", value.asInstanceOf[js.Any])
      
      inline def setMobileFunction1(
        value: japgolly.scalajs.react.facade.React.Component[NumericInputProps & js.Object, js.Object] => Boolean
      ): Self = StObject.set(x, "mobile", js.Any.fromFunction1(value))
      ...
      inline def setOnBlur(
        value: ReactFocusEventFrom[(HTMLDivElement | HTMLInputElement) & org.scalajs.dom.Element] => Callback
      ): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: ReactFocusEventFrom[(HTMLDivElement | HTMLInputElement) & org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setOnChange(
        value: (/* value */ Double | Null, /* stringValue */ String, /* input */ HTMLInputElement) => Callback
      ): Self = StObject.set(x, "onChange", js.Any.fromFunction3((t0: /* value */ Double | Null, t1: /* stringValue */ String, t2: /* input */ HTMLInputElement) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnFocus(
        value: ReactFocusEventFrom[(HTMLDivElement | HTMLInputElement) & org.scalajs.dom.Element] => Callback
      ): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: ReactFocusEventFrom[(HTMLDivElement | HTMLInputElement) & org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setOnInvalid(value: (/* error */ String, /* value */ Double | Null, /* stringValue */ String) => Callback): Self = StObject.set(x, "onInvalid", js.Any.fromFunction3((t0: /* error */ String, t1: /* value */ Double | Null, t2: /* stringValue */ String) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnInvalidUndefined: Self = StObject.set(x, "onInvalid", js.undefined)
      
      inline def setOnKeyDown(
        value: ReactKeyboardEventFrom[(HTMLDivElement | HTMLInputElement) & org.scalajs.dom.Element] => Callback
      ): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[(HTMLDivElement | HTMLInputElement) & org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setOnValid(value: (/* value */ Double | Null, /* stringValue */ String) => Callback): Self = StObject.set(x, "onValid", js.Any.fromFunction2((t0: /* value */ Double | Null, t1: /* stringValue */ String) => (value(t0, t1)).runNow()))
      ...
      inline def setParse(value: /* stringValue */ String => Double | Null): Self = StObject.set(x, "parse", js.Any.fromFunction1(value))
      ...
      inline def setPrecisionFunction1(
        value: japgolly.scalajs.react.facade.React.Component[NumericInputProps & js.Object, js.Object] => js.UndefOr[Double | Null]
      ): Self = StObject.set(x, "precision", js.Any.fromFunction1(value))
      ...
      inline def setStepFunction2(
        value: (japgolly.scalajs.react.facade.React.Component[NumericInputProps & js.Object, js.Object], /* direction */ String) => js.UndefOr[Double]
      ...
      inline def setStyle(value: StringDictionary[CSSProperties] | Boolean): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
  ...
  trait NumericInputState extends StObject {
  ...
  object NumericInputState {
    ...
    inline def apply(): NumericInputState = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: NumericInputState](x: Self) {
      ...
      inline def setBtnDownActiveUndefined: Self = StObject.set(x, "btnDownActive", js.undefined)
      
      inline def setBtnDownHover(value: Boolean): Self = StObject.set(x, "btnDownHover", value.asInstanceOf[js.Any])
      
      inline def setBtnDownHoverUndefined: Self = StObject.set(x, "btnDownHover", js.undefined)
      
      inline def setBtnUpActive(value: Boolean): Self = StObject.set(x, "btnUpActive", value.asInstanceOf[js.Any])
      
      inline def setBtnUpActiveUndefined: Self = StObject.set(x, "btnUpActive", js.undefined)
      
      inline def setBtnUpHover(value: Boolean): Self = StObject.set(x, "btnUpHover", value.asInstanceOf[js.Any])
      
      inline def setBtnUpHoverUndefined: Self = StObject.set(x, "btnUpHover", js.undefined)
