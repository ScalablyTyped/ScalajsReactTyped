package typingsJapgolly.reactNumericInput.components
...
import typingsJapgolly.reactNumericInput.mod.BoundsFunctionProp
import typingsJapgolly.reactNumericInput.mod.NumericInputProps
import typingsJapgolly.reactNumericInput.mod.^
...
object ReactNumericInput {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def defaultValue(value: Double | String): this.type = set("defaultValue", value.asInstanceOf[js.Any])
    ...
    inline def format(value: /* value */ Double | Null => String): this.type = set("format", js.Any.fromFunction1(value))
    ...
    inline def max(value: BoundsFunctionProp): this.type = set("max", value.asInstanceOf[js.Any])
    
    inline def maxFunction1(value: Component[NumericInputProps & js.Object, js.Object] => js.UndefOr[Double]): this.type = set("max", js.Any.fromFunction1(value))
    
    inline def maxLength(value: Double): this.type = set("maxLength", value.asInstanceOf[js.Any])
    
    inline def min(value: BoundsFunctionProp): this.type = set("min", value.asInstanceOf[js.Any])
    
    inline def minFunction1(value: Component[NumericInputProps & js.Object, js.Object] => js.UndefOr[Double]): this.type = set("min", js.Any.fromFunction1(value))
    
    inline def minLength(value: Double): this.type = set("minLength", value.asInstanceOf[js.Any])
    
    inline def mobile(
      value: Boolean | auto | (js.Function1[Component[NumericInputProps & js.Object, js.Object], Boolean])
    ): this.type = set("mobile", value.asInstanceOf[js.Any])
    
    inline def mobileFunction1(value: Component[NumericInputProps & js.Object, js.Object] => Boolean): this.type = set("mobile", js.Any.fromFunction1(value))
    ...
    inline def noValidate(value: Boolean | String): this.type = set("noValidate", value.asInstanceOf[js.Any])
    ...
    inline def onBlur(value: ReactFocusEventFrom[(HTMLDivElement | HTMLInputElement) & Element] => Callback): this.type = set("onBlur", js.Any.fromFunction1((t0: ReactFocusEventFrom[(HTMLDivElement | HTMLInputElement) & Element]) => value(t0).runNow()))
    ...
    ): this.type = set("onChange", js.Any.fromFunction3((t0: /* value */ Double | Null, t1: /* stringValue */ String, t2: /* input */ HTMLInputElement) => (value(t0, t1, t2)).runNow()))
    ...
    inline def onFocus(value: ReactFocusEventFrom[(HTMLDivElement | HTMLInputElement) & Element] => Callback): this.type = set("onFocus", js.Any.fromFunction1((t0: ReactFocusEventFrom[(HTMLDivElement | HTMLInputElement) & Element]) => value(t0).runNow()))
    ...
    inline def onInvalid(value: (/* error */ String, /* value */ Double | Null, /* stringValue */ String) => Callback): this.type = set("onInvalid", js.Any.fromFunction3((t0: /* error */ String, t1: /* value */ Double | Null, t2: /* stringValue */ String) => (value(t0, t1, t2)).runNow()))
    
    inline def onKeyDown(value: ReactKeyboardEventFrom[(HTMLDivElement | HTMLInputElement) & Element] => Callback): this.type = set("onKeyDown", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[(HTMLDivElement | HTMLInputElement) & Element]) => value(t0).runNow()))
    ...
    inline def onValid(value: (/* value */ Double | Null, /* stringValue */ String) => Callback): this.type = set("onValid", js.Any.fromFunction2((t0: /* value */ Double | Null, t1: /* stringValue */ String) => (value(t0, t1)).runNow()))
    ...
    inline def parse(value: /* stringValue */ String => Double | Null): this.type = set("parse", js.Any.fromFunction1(value))
    ...
    inline def precision(
      value: Double | (js.Function1[Component[NumericInputProps & js.Object, js.Object], js.UndefOr[Double | Null]])
    ): this.type = set("precision", value.asInstanceOf[js.Any])
    
    inline def precisionFunction1(value: Component[NumericInputProps & js.Object, js.Object] => js.UndefOr[Double | Null]): this.type = set("precision", js.Any.fromFunction1(value))
    ...
    inline def step(
      value: Double | (js.Function2[
          Component[NumericInputProps & js.Object, js.Object], 
          /* direction */ String, 
          js.UndefOr[Double]
        ])
    ): this.type = set("step", value.asInstanceOf[js.Any])
    
    inline def stepFunction2(
      value: (Component[NumericInputProps & js.Object, js.Object], /* direction */ String) => js.UndefOr[Double]
    ): this.type = set("step", js.Any.fromFunction2(value))
    
    inline def strict(value: Boolean): this.type = set("strict", value.asInstanceOf[js.Any])
    
    inline def style(value: StringDictionary[CSSProperties] | Boolean): this.type = set("style", value.asInstanceOf[js.Any])
