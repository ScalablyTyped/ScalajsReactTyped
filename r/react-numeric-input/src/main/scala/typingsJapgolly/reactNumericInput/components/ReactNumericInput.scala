...
object ReactNumericInput {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[NumericInputProps, ^, Unit, NumericInputProps] = {
  ...
  typingsJapgolly.reactNumericInput.mod.NumericInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNumericInput.mod.^](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNumericInput.mod.NumericInputProps])(children: _*)
  }
