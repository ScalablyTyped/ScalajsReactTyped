...
- typingsJapgolly.reactNativeMaterialKit.mod.FloatingLabelProperties because var conflicts: allowFontScaling. Inlined floatingLabelEnabled, floatingLabelAniDuration, floatingLabelBottomMargin, floatingLabelFont */ trait MKTextFieldProperties
  extends StObject
     with TextInputProps {
...
object MKTextFieldProperties {
  ...
  extension [Self <: MKTextFieldProperties](x: Self) {
    ...
    inline def setOnTextChange(value: /* val */ String => Callback): Self = StObject.set(x, "onTextChange", js.Any.fromFunction1((t0: /* val */ String) => value(t0).runNow()))
