...
import typingsJapgolly.reactNativeMaterialKit.mod.MKProgress.Indeterminate
...
object MKProgressIndeterminate {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IndeterminateProgressProperties, Indeterminate, Unit, IndeterminateProgressProperties] = {
  ...
  typingsJapgolly.reactNativeMaterialKit.mod.IndeterminateProgressProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaterialKit.mod.MKProgress.Indeterminate](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaterialKit.mod.IndeterminateProgressProperties])(children: _*)
  }
