...
object MKTextField {
  def apply(
    ...
    onTextChange: /* val */ String => Callback = null,
    ...
    typingsJapgolly.reactNativeMaterialKit.mod.MKTextField, 
    Unit, 
    MKTextFieldProperties
  ] = {
    ...
    if (onTextChange != null) __obj.updateDynamic("onTextChange")(js.Any.fromFunction1((t0: /* val */ java.lang.String) => onTextChange(t0).runNow()))
  ...
  typingsJapgolly.reactNativeMaterialKit.mod.MKTextFieldProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaterialKit.mod.MKTextField](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaterialKit.mod.MKTextFieldProperties])(children: _*)
  }
