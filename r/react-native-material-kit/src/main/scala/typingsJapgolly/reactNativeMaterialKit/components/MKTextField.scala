...
import typingsJapgolly.reactNativeMaterialKit.mod.MKTextFieldProperties
...
object MKTextField {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeMaterialKit.mod.MKTextField] {
    ...
    inline def additionalInputProps(value: TextInputProps): this.type = set("additionalInputProps", value.asInstanceOf[js.Any])
    ...
    inline def floatingLabelAniDuration(value: Double): this.type = set("floatingLabelAniDuration", value.asInstanceOf[js.Any])
    
    inline def floatingLabelBottomMargin(value: Double): this.type = set("floatingLabelBottomMargin", value.asInstanceOf[js.Any])
    
    inline def floatingLabelEnabled(value: Boolean): this.type = set("floatingLabelEnabled", value.asInstanceOf[js.Any])
    
    inline def floatingLabelFont(value: font): this.type = set("floatingLabelFont", value.asInstanceOf[js.Any])
    ...
    inline def highlightColor(value: String): this.type = set("highlightColor", value.asInstanceOf[js.Any])
    ...
    inline def onTextChange(value: /* val */ String => Callback): this.type = set("onTextChange", js.Any.fromFunction1((t0: /* val */ String) => value(t0).runNow()))
    ...
    inline def password(value: Boolean): this.type = set("password", value.asInstanceOf[js.Any])
    ...
    inline def textInputStyle(value: TextStyle): this.type = set("textInputStyle", value.asInstanceOf[js.Any])
    ...
    inline def underlineEnabled(value: Boolean): this.type = set("underlineEnabled", value.asInstanceOf[js.Any])
    
    inline def underlineSize(value: Double): this.type = set("underlineSize", value.asInstanceOf[js.Any])
