...
import typingsJapgolly.reactNativeMaterialKit.AnonChecked
...
object MKCheckbox {
  def apply(
    ...
    onCheckedChange: /* opts */ AnonChecked => Callback = null,
    ...
    typingsJapgolly.reactNativeMaterialKit.mod.MKCheckbox, 
    Unit, 
    MKCheckboxProperties
  ] = {
    ...
    if (onCheckedChange != null) __obj.updateDynamic("onCheckedChange")(js.Any.fromFunction1((t0: /* opts */ typingsJapgolly.reactNativeMaterialKit.AnonChecked) => onCheckedChange(t0).runNow()))
  ...
  typingsJapgolly.reactNativeMaterialKit.mod.MKCheckboxProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaterialKit.mod.MKCheckbox](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaterialKit.mod.MKCheckboxProperties])(children: _*)
  }
