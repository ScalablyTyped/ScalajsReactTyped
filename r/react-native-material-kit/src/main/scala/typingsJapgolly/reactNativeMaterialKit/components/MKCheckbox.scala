...
import typingsJapgolly.reactNativeMaterialKit.mod.MKCheckboxProperties
...
object MKCheckbox {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeMaterialKit.mod.MKCheckbox] {
    ...
    inline def borderOffColor(value: String): this.type = set("borderOffColor", value.asInstanceOf[js.Any])
    
    inline def borderOnColor(value: String): this.type = set("borderOnColor", value.asInstanceOf[js.Any])
    ...
    inline def extraRippleRadius(value: Double): this.type = set("extraRippleRadius", value.asInstanceOf[js.Any])
    ...
    inline def inset(value: Double): this.type = set("inset", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: MKCheckbox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MKCheckboxProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
