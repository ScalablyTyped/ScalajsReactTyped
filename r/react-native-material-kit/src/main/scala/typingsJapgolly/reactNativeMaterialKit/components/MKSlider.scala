...
import typingsJapgolly.reactNativeMaterialKit.mod.MKSliderProperties
...
object MKSlider {
  def apply(
    ...
    MKSliderProperties, 
    typingsJapgolly.reactNativeMaterialKit.mod.MKSlider, 
    Unit, 
    MKSliderProperties
  ] = {
  ...
  typingsJapgolly.reactNativeMaterialKit.mod.MKSliderProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaterialKit.mod.MKSlider](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaterialKit.mod.MKSliderProperties])(children: _*)
  }
