...
object MKSwitch {
  def apply(
    ...
    MKSwitchProperties, 
    typingsJapgolly.reactNativeMaterialKit.mod.MKSwitch, 
    Unit, 
    MKSwitchProperties
  ] = {
  ...
  typingsJapgolly.reactNativeMaterialKit.mod.MKSwitchProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaterialKit.mod.MKSwitch](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaterialKit.mod.MKSwitchProperties])(children: _*)
  }
