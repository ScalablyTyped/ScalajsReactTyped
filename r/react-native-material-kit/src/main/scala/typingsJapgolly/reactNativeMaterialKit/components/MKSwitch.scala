...
import typingsJapgolly.reactNativeMaterialKit.mod.MKSwitchProperties
...
object MKSwitch {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeMaterialKit.mod.MKSwitch] {
    ...
    inline def offColor(value: String): this.type = set("offColor", value.asInstanceOf[js.Any])
    ...
    inline def onCheckedChange(value: /* opts */ Checked => Callback): this.type = set("onCheckedChange", js.Any.fromFunction1((t0: /* opts */ Checked) => value(t0).runNow()))
    
    inline def onColor(value: String): this.type = set("onColor", value.asInstanceOf[js.Any])
    ...
    inline def rippleAniDuration(value: Double): this.type = set("rippleAniDuration", value.asInstanceOf[js.Any])
    ...
    inline def thumbAniDuration(value: Double): this.type = set("thumbAniDuration", value.asInstanceOf[js.Any])
    
    inline def thumbOffColor(value: String): this.type = set("thumbOffColor", value.asInstanceOf[js.Any])
    
    inline def thumbOnColor(value: String): this.type = set("thumbOnColor", value.asInstanceOf[js.Any])
    ...
    inline def trackLength(value: Double): this.type = set("trackLength", value.asInstanceOf[js.Any])
