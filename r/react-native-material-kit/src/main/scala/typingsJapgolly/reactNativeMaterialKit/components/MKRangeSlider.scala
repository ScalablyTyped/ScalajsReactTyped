...
import typingsJapgolly.reactNativeMaterialKit.AnonMax
...
object MKRangeSlider {
  def apply(
    ...
    onChange: /* curValue */ AnonMax => Callback = null,
    onConfirm: /* curValue */ AnonMax => Callback = null,
    ...
    typingsJapgolly.reactNativeMaterialKit.mod.MKRangeSlider, 
    Unit, 
    MKRangeSliderProperties
  ] = {
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: /* curValue */ typingsJapgolly.reactNativeMaterialKit.AnonMax) => onChange(t0).runNow()))
    if (onConfirm != null) __obj.updateDynamic("onConfirm")(js.Any.fromFunction1((t0: /* curValue */ typingsJapgolly.reactNativeMaterialKit.AnonMax) => onConfirm(t0).runNow()))
  ...
  typingsJapgolly.reactNativeMaterialKit.mod.MKRangeSliderProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaterialKit.mod.MKRangeSlider](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaterialKit.mod.MKRangeSliderProperties])(children: _*)
  }
