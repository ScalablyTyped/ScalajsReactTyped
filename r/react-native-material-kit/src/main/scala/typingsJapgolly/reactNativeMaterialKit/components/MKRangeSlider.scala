...
import typingsJapgolly.reactNativeMaterialKit.mod.MKRangeSliderProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object MKRangeSlider {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeMaterialKit.mod.MKRangeSlider] {
    ...
    inline def lowerTrackColor(value: String): this.type = set("lowerTrackColor", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* curValue */ Max => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* curValue */ Max) => value(t0).runNow()))
    
    inline def onConfirm(value: /* curValue */ Max => Callback): this.type = set("onConfirm", js.Any.fromFunction1((t0: /* curValue */ Max) => value(t0).runNow()))
    ...
    inline def thumbPadding(value: Double): this.type = set("thumbPadding", value.asInstanceOf[js.Any])
    
    inline def thumbRadius(value: Double): this.type = set("thumbRadius", value.asInstanceOf[js.Any])
    ...
    inline def upperTrackColor(value: String): this.type = set("upperTrackColor", value.asInstanceOf[js.Any])
    
    inline def value(value: Double): this.type = set("value", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: MKRangeSlider.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MKRangeSliderProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
