...
import typingsJapgolly.reactNativeMaterialKit.mod.MKSpinnerProperties
...
object MKSpinner {
  ...
  @JSImport("react-native-material-kit", "MKSpinner")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeMaterialKit.mod.MKSpinner] {
    ...
    inline def spinnerAniDuration(value: Double): this.type = set("spinnerAniDuration", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: MKSpinner.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MKSpinnerProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
