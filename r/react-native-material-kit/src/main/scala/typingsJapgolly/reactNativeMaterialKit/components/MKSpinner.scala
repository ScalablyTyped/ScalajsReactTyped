...
object MKSpinner {
  def apply(
    ...
    MKSpinnerProperties, 
    typingsJapgolly.reactNativeMaterialKit.mod.MKSpinner, 
    Unit, 
    MKSpinnerProperties
  ] = {
  ...
  typingsJapgolly.reactNativeMaterialKit.mod.MKSpinnerProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaterialKit.mod.MKSpinner](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaterialKit.mod.MKSpinnerProperties])(children: _*)
  }
