...
object MKProgress {
  def apply(
    ...
    typingsJapgolly.reactNativeMaterialKit.mod.MKProgress, 
    Unit, 
    MKProgressProperties
  ] = {
  ...
  typingsJapgolly.reactNativeMaterialKit.mod.MKProgressProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaterialKit.mod.MKProgress](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaterialKit.mod.MKProgressProperties])(children: _*)
  }
