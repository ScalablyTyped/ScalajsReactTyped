...
import typingsJapgolly.reactNativeMaterialKit.mod.IndeterminateProgressProperties
import typingsJapgolly.reactNativeMaterialKit.mod.MKProgressProperties
...
object MKProgress {
  ...
  object Indeterminate {
    ...
    open class Builder (val args: js.Array[Any])
      extends AnyVal
         with StBuildingComponent[typingsJapgolly.reactNativeMaterialKit.mod.MKProgress.Indeterminate] {
      ...
      inline def progressAniDuration(value: Double): this.type = set("progressAniDuration", value.asInstanceOf[js.Any])
    ...
    implicit def make(companion: Indeterminate.type): typingsJapgolly.reactNativeMaterialKit.components.MKProgress.Indeterminate.Builder = new typingsJapgolly.reactNativeMaterialKit.components.MKProgress.Indeterminate.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: IndeterminateProgressProperties): typingsJapgolly.reactNativeMaterialKit.components.MKProgress.Indeterminate.Builder = new typingsJapgolly.reactNativeMaterialKit.components.MKProgress.Indeterminate.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeMaterialKit.mod.MKProgress] {
    ...
    inline def bufferAniDuration(value: Double): this.type = set("bufferAniDuration", value.asInstanceOf[js.Any])
    
    inline def bufferColor(value: String): this.type = set("bufferColor", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: MKProgress.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MKProgressProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
