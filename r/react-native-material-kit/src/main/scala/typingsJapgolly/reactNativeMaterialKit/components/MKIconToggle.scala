...
object MKIconToggle {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeMaterialKit.mod.MKIconToggle] {
    ...
    inline def onCheckedChange(value: /* checked */ Boolean => Callback): this.type = set("onCheckedChange", js.Any.fromFunction1((t0: /* checked */ Boolean) => value(t0).runNow()))
