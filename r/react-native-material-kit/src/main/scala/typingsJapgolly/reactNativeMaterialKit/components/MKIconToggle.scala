...
import typingsJapgolly.reactNativeMaterialKit.mod.MKIconToggleProperties
...
object MKIconToggle {
  def apply(
    ...
    onCheckedChange: /* checked */ Boolean => Callback = null,
    ...
    typingsJapgolly.reactNativeMaterialKit.mod.MKIconToggle, 
    Unit, 
    MKIconToggleProperties
  ] = {
    ...
    if (onCheckedChange != null) __obj.updateDynamic("onCheckedChange")(js.Any.fromFunction1((t0: /* checked */ scala.Boolean) => onCheckedChange(t0).runNow()))
  ...
  typingsJapgolly.reactNativeMaterialKit.mod.MKIconToggleProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaterialKit.mod.MKIconToggle](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaterialKit.mod.MKIconToggleProperties])(children: _*)
  }
