...
object MKButton {
  def apply(
    ...
    MKButtonProperties, 
    typingsJapgolly.reactNativeMaterialKit.mod.MKButton, 
    Unit, 
    MKButtonProperties
  ] = {
  ...
  typingsJapgolly.reactNativeMaterialKit.mod.MKButtonProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaterialKit.mod.MKButton](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaterialKit.mod.MKButtonProperties])(children: _*)
  }
