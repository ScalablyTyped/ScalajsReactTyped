...
import typingsJapgolly.reactNativeMaterialKit.mod.MKRadioButtonGroup
import typingsJapgolly.reactNativeMaterialKit.mod.MKRadioButtonProperties
...
object MKRadioButton {
  def apply(
    ...
    typingsJapgolly.reactNativeMaterialKit.mod.MKRadioButton, 
    Unit, 
    MKRadioButtonProperties
  ] = {
  ...
  typingsJapgolly.reactNativeMaterialKit.mod.MKRadioButtonProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaterialKit.mod.MKRadioButton](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaterialKit.mod.MKRadioButtonProperties])(children: _*)
  }
