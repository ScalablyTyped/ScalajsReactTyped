...
object MKRadioButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeMaterialKit.mod.MKRadioButton] {
    ...
    inline def group(value: MKRadioButtonGroup): this.type = set("group", value.asInstanceOf[js.Any])
