...
import typingsJapgolly.reactNativeMaterialKit.mod.MKRippleProperties
...
object MKRipple {
  def apply(
    ...
    MKRippleProperties, 
    typingsJapgolly.reactNativeMaterialKit.mod.MKRipple, 
    Unit, 
    MKRippleProperties
  ] = {
  ...
  typingsJapgolly.reactNativeMaterialKit.mod.MKRippleProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaterialKit.mod.MKRipple](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaterialKit.mod.MKRippleProperties])(children: _*)
  }
