...
trait PieChartProps
  ...
  var styledCenterText: js.UndefOr[typingsJapgolly.reactNativeChartsWrapper.anon.Color] = js.undefined
...
object PieChartProps {
  ...
  extension [Self <: PieChartProps](x: Self) {
    ...
    inline def setStyledCenterText(value: typingsJapgolly.reactNativeChartsWrapper.anon.Color): Self = StObject.set(x, "styledCenterText", value.asInstanceOf[js.Any])
