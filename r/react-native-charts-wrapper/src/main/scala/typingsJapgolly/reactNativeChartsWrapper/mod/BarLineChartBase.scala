...
trait BarLineChartBase
  ...
  var zoom: js.UndefOr[typingsJapgolly.reactNativeChartsWrapper.anon.AxisDependency] = js.undefined
}
object BarLineChartBase {
  ...
  extension [Self <: BarLineChartBase](x: Self) {
    ...
    inline def setZoom(value: typingsJapgolly.reactNativeChartsWrapper.anon.AxisDependency): Self = StObject.set(x, "zoom", value.asInstanceOf[js.Any])
