...
object BubbleChart {
  def apply(
    ...
    BubbleChartProps, 
    typingsJapgolly.reactNativeChartsWrapper.mod.BubbleChart, 
    Unit, 
    BubbleChartProps
  ] = {
  ...
  typingsJapgolly.reactNativeChartsWrapper.mod.BubbleChartProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeChartsWrapper.mod.BubbleChart](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeChartsWrapper.mod.BubbleChartProps])(children: _*)
  }
