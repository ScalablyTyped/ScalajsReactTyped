...
import typingsJapgolly.reactNativeChartsWrapper.mod.yAxis
...
object RadarChart {
  def apply(
    ...
    RadarChartProps, 
    typingsJapgolly.reactNativeChartsWrapper.mod.RadarChart, 
    Unit, 
    RadarChartProps
  ] = {
  ...
  typingsJapgolly.reactNativeChartsWrapper.mod.RadarChartProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeChartsWrapper.mod.RadarChart](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeChartsWrapper.mod.RadarChartProps])(children: _*)
  }
