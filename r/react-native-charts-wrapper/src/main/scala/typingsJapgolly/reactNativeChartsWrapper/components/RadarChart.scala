...
import typingsJapgolly.reactNativeChartsWrapper.mod.RadarChartProps
import typingsJapgolly.reactNativeChartsWrapper.mod.RadarData
...
object RadarChart {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeChartsWrapper.mod.RadarChart] {
    ...
    inline def data(value: RadarData): this.type = set("data", value.asInstanceOf[js.Any])
    ...
    inline def drawWeb(value: Boolean): this.type = set("drawWeb", value.asInstanceOf[js.Any])
    ...
    inline def skipWebLineCount(value: Double): this.type = set("skipWebLineCount", value.asInstanceOf[js.Any])
    ...
    inline def webAlpha(value: Double): this.type = set("webAlpha", value.asInstanceOf[js.Any])
    
    inline def webColor(value: Color): this.type = set("webColor", value.asInstanceOf[js.Any])
    
    inline def webColorInner(value: Color): this.type = set("webColorInner", value.asInstanceOf[js.Any])
    
    inline def webLineWidth(value: Double): this.type = set("webLineWidth", value.asInstanceOf[js.Any])
    
    inline def webLineWidthInner(value: Double): this.type = set("webLineWidthInner", value.asInstanceOf[js.Any])
    
    inline def xAxis(value: typingsJapgolly.reactNativeChartsWrapper.mod.xAxis): this.type = set("xAxis", value.asInstanceOf[js.Any])
    
    inline def yAxis(value: typingsJapgolly.reactNativeChartsWrapper.mod.yAxis): this.type = set("yAxis", value.asInstanceOf[js.Any])
  }
