...
@scala.inline
open class SharedBuilder_BarChartProps_1954619961[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def drawBarShadow(value: Boolean): this.type = set("drawBarShadow", value.asInstanceOf[js.Any])
  ...
  inline def drawValueAboveBar(value: Boolean): this.type = set("drawValueAboveBar", value.asInstanceOf[js.Any])
  ...
  inline def highlightFullBarEnabled(value: Boolean): this.type = set("highlightFullBarEnabled", value.asInstanceOf[js.Any])
