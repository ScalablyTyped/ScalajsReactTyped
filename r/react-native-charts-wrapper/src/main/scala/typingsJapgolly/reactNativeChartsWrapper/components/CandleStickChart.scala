...
import typingsJapgolly.reactNativeChartsWrapper.mod.CandleStickChartProps
import typingsJapgolly.reactNativeChartsWrapper.mod.CandleStickData
...
object CandleStickChart {
  def apply(
    ...
    typingsJapgolly.reactNativeChartsWrapper.mod.CandleStickChart, 
    Unit, 
    CandleStickChartProps
  ] = {
  ...
  typingsJapgolly.reactNativeChartsWrapper.mod.CandleStickChartProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeChartsWrapper.mod.CandleStickChart](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeChartsWrapper.mod.CandleStickChartProps])(children: _*)
  }
