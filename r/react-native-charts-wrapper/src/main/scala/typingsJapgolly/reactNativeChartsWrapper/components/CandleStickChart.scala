...
object CandleStickChart {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeChartsWrapper.mod.CandleStickChart] {
    ...
    inline def data(value: CandleStickData): this.type = set("data", value.asInstanceOf[js.Any])
