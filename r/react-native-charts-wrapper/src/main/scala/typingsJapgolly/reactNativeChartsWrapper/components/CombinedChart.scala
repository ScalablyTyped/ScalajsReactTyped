...
import typingsJapgolly.reactNativeChartsWrapper.mod.CombinedChartProps
import typingsJapgolly.reactNativeChartsWrapper.mod.CombinedData
import typingsJapgolly.reactNativeChartsWrapper.mod.Offsets
import typingsJapgolly.reactNativeChartsWrapper.reactNativeChartsWrapperStrings.BAR
import typingsJapgolly.reactNativeChartsWrapper.reactNativeChartsWrapperStrings.BUBBLE
import typingsJapgolly.reactNativeChartsWrapper.reactNativeChartsWrapperStrings.CANDLE
import typingsJapgolly.reactNativeChartsWrapper.reactNativeChartsWrapperStrings.LINE
import typingsJapgolly.reactNativeChartsWrapper.reactNativeChartsWrapperStrings.SCATTER
...
object CombinedChart {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeChartsWrapper.mod.CombinedChart] {
    ...
    inline def data(value: CombinedData): this.type = set("data", value.asInstanceOf[js.Any])
    ...
    inline def drawOrder(value: js.Array[BAR | BUBBLE | LINE | CANDLE | SCATTER]): this.type = set("drawOrder", value.asInstanceOf[js.Any])
    
    inline def drawOrderVarargs(value: (BAR | BUBBLE | LINE | CANDLE | SCATTER)*): this.type = set("drawOrder", js.Array(value*))
