...
object CombinedChart {
  def apply(
    ...
    CombinedChartProps, 
    typingsJapgolly.reactNativeChartsWrapper.mod.CombinedChart, 
    Unit, 
    CombinedChartProps
  ] = {
  ...
  typingsJapgolly.reactNativeChartsWrapper.mod.CombinedChartProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeChartsWrapper.mod.CombinedChart](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeChartsWrapper.mod.CombinedChartProps])(children: _*)
  }
