...
abstract class SharedApply_BarChartProps_1193189453[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BarChartProps, ComponentRef, Unit, BarChartProps] = {
  ...
  typingsJapgolly.reactNativeChartsWrapper.mod.BarChartProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeChartsWrapper.mod.BarChartProps])(children: _*)
  }
}
