...
import typingsJapgolly.reactNativeChartsWrapper.mod.ScatterChartProps
import typingsJapgolly.reactNativeChartsWrapper.mod.ScatterData
...
object ScatterChart {
  def apply(
    ...
    ScatterChartProps, 
    typingsJapgolly.reactNativeChartsWrapper.mod.ScatterChart, 
    Unit, 
    ScatterChartProps
  ] = {
  ...
  typingsJapgolly.reactNativeChartsWrapper.mod.ScatterChartProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeChartsWrapper.mod.ScatterChart](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeChartsWrapper.mod.ScatterChartProps])(children: _*)
  }
