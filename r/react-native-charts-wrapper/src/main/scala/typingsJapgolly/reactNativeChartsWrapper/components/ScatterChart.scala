...
object ScatterChart {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeChartsWrapper.mod.ScatterChart] {
    ...
    inline def data(value: ScatterData): this.type = set("data", value.asInstanceOf[js.Any])
