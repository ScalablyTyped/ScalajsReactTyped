...
import typingsJapgolly.reactNativeChartsWrapper.AnonColor
...
object PieChart {
  def apply(
    ...
    PieChartProps, 
    typingsJapgolly.reactNativeChartsWrapper.mod.PieChart, 
    Unit, 
    PieChartProps
  ] = {
  ...
  typingsJapgolly.reactNativeChartsWrapper.mod.PieChartProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeChartsWrapper.mod.PieChart](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeChartsWrapper.mod.PieChartProps])(children: _*)
  }
