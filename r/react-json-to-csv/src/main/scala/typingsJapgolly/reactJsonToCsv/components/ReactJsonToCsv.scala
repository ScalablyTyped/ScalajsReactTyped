package typingsJapgolly.reactJsonToCsv.components
...
import typingsJapgolly.reactJsonToCsv.mod.CsvDownloadProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ReactJsonToCsv {
  
  inline def apply(data: js.Object | js.Array[js.Object]): Builder = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[CsvDownloadProps]))
  }
  
  @JSImport("react-json-to-csv", JSImport.Default)
  @js.native
  ...
  def withProps(p: CsvDownloadProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
