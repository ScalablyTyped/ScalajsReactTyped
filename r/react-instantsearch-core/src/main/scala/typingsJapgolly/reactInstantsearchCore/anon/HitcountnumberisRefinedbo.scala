...
trait HitcountnumberisRefinedbo extends StObject {
  ...
  /**
    ...
    * will not exist.
    */
  var _highlightResult: typingsJapgolly.reactInstantsearchCore.mod.HighlightResult[Value]
...
object HitcountnumberisRefinedbo {
  ...
  inline def apply(
    _highlightResult: typingsJapgolly.reactInstantsearchCore.mod.HighlightResult[Value],
    count: Double,
    isRefined: Boolean,
    label: String,
    objectID: String,
  ...
  extension [Self <: HitcountnumberisRefinedbo](x: Self) {
    ...
    inline def set_highlightResult(value: typingsJapgolly.reactInstantsearchCore.mod.HighlightResult[Value]): Self = StObject.set(x, "_highlightResult", value.asInstanceOf[js.Any])
  }
}
