...
trait HitBasicDoc
  ...
  /**
    ...
    * will not exist.
    */
  var _highlightResult: typingsJapgolly.reactInstantsearchCore.mod.HighlightResult[BasicDoc]
...
object HitBasicDoc {
  ...
  inline def apply(
    _highlightResult: typingsJapgolly.reactInstantsearchCore.mod.HighlightResult[BasicDoc],
    objectID: String
  ): HitBasicDoc = {
  ...
  extension [Self <: HitBasicDoc](x: Self) {
    ...
    inline def set_highlightResult(value: typingsJapgolly.reactInstantsearchCore.mod.HighlightResult[BasicDoc]): Self = StObject.set(x, "_highlightResult", value.asInstanceOf[js.Any])
  }
}
