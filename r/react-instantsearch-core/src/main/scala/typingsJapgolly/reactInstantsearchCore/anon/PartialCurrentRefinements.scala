...
object PartialCurrentRefinements {
  ...
  extension [Self <: PartialCurrentRefinements](x: Self) {
    ...
    inline def setRefine(value: /* refinement */ RefinementValue | (js.Array[Refinement | RefinementValue]) => Callback): Self = StObject.set(x, "refine", js.Any.fromFunction1((t0: /* refinement */ RefinementValue | (js.Array[Refinement | RefinementValue])) => value(t0).runNow()))
