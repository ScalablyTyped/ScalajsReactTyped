...
trait HighlightResult[TDoc] extends StObject {
  ...
  /**
    ...
    * will not exist.
    */
  var _highlightResult: typingsJapgolly.reactInstantsearchCore.mod.HighlightResult[TDoc]
...
object HighlightResult {
  ...
  inline def apply[TDoc](
    _highlightResult: typingsJapgolly.reactInstantsearchCore.mod.HighlightResult[TDoc],
    objectID: String
  ): HighlightResult[TDoc] = {
  ...
  extension [Self <: HighlightResult[?], TDoc](x: Self & HighlightResult[TDoc]) {
    ...
    inline def set_highlightResult(value: typingsJapgolly.reactInstantsearchCore.mod.HighlightResult[TDoc]): Self = StObject.set(x, "_highlightResult", value.asInstanceOf[js.Any])
  }
}
