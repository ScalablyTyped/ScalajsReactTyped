...
object GeoSearchProvided {
  ...
  inline def apply[THit](
    ...
    val __obj = js.Dynamic.literal(createURL = js.Any.fromFunction1(createURL), currentRefinement = currentRefinement.asInstanceOf[js.Any], hits = hits.asInstanceOf[js.Any], isRefinedWithMap = isRefinedWithMap.asInstanceOf[js.Any], position = position.asInstanceOf[js.Any], refine = js.Any.fromFunction1((t0: NESW) => refine(t0).runNow()))
  ...
  extension [Self <: GeoSearchProvided[?], THit](x: Self & GeoSearchProvided[THit]) {
    ...
    inline def setRefine(value: NESW => Callback): Self = StObject.set(x, "refine", js.Any.fromFunction1((t0: NESW) => value(t0).runNow()))
  }
}
