...
import typingsJapgolly.reactInstantsearchCore.reactInstantsearchCoreStrings.full
import typingsJapgolly.reactInstantsearchCore.reactInstantsearchCoreStrings.none
import typingsJapgolly.reactInstantsearchCore.reactInstantsearchCoreStrings.partial
