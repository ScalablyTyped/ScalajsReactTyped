...
trait ConnectorDescription[TProvided, TExposed] extends js.Object {
  ...
  var cleanUp: js.UndefOr[
    js.ThisFunction2[
      /* this */ Component[TExposed with js.Object, js.Object], 
      /* props */ TExposed, 
...
object ConnectorDescription {
  ...
  def apply[TProvided, TExposed](
    displayName: String,
    getProvidedProps: (TExposed, SearchState, ConnectorSearchResults[js.Any], js.Any, js.Any) => CallbackTo[TProvided],
    ...
    __obj.updateDynamic("getProvidedProps")(js.Any.fromFunction5((t0: TExposed, t1: typingsJapgolly.reactInstantsearchCore.mod.SearchState, t2: typingsJapgolly.reactInstantsearchCore.mod.ConnectorSearchResults[js.Any], t3: js.Any, t4: js.Any) => getProvidedProps(t0, t1, t2, t3, t4).runNow()))
