...
import typingsJapgolly.reactInstantsearchCore.anon.Label
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.reactInstantsearchCore.anon.itemsundefinedcurrentRefi
  - typingsJapgolly.reactInstantsearchCore.anon.itemsArraylabelstringvalu
*/
...
object Refinement {
  ...
  inline def itemsArraylabelstringvalu(
    ...
    __obj.asInstanceOf[typingsJapgolly.reactInstantsearchCore.anon.itemsArraylabelstringvalu]
  }
  ...
  inline def itemsundefinedcurrentRefi(
    ...
    val __obj = js.Dynamic.literal(attribute = attribute.asInstanceOf[js.Any], currentRefinement = currentRefinement.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any], value = js.Any.fromFunction1(value))
    __obj.asInstanceOf[typingsJapgolly.reactInstantsearchCore.anon.itemsundefinedcurrentRefi]
  }
}
