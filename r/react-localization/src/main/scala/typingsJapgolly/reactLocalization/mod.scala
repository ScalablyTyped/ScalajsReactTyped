package typingsJapgolly.reactLocalization
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setCustomLanguageInterface(value: CallbackTo[String]): Self = StObject.set(x, "customLanguageInterface", value.toJsFn)
