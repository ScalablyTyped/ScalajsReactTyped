package typingsJapgolly.reactAliceCarousel.anon
...
import typingsJapgolly.reactAliceCarousel.libTypesMod.SlideInfo
...
object PartialProps {
  ...
  extension [Self <: PartialProps](x: Self) {
    ...
    inline def setOnInitialized(value: /* e */ EventObject => Callback): Self = StObject.set(x, "onInitialized", js.Any.fromFunction1((t0: /* e */ EventObject) => value(t0).runNow()))
    ...
    inline def setOnResized(value: /* e */ EventObject => Callback): Self = StObject.set(x, "onResized", js.Any.fromFunction1((t0: /* e */ EventObject) => value(t0).runNow()))
    
    inline def setOnResizedUndefined: Self = StObject.set(x, "onResized", js.undefined)
    
    inline def setOnSlideChange(value: /* e */ EventObject => Callback): Self = StObject.set(x, "onSlideChange", js.Any.fromFunction1((t0: /* e */ EventObject) => value(t0).runNow()))
    
    inline def setOnSlideChangeUndefined: Self = StObject.set(x, "onSlideChange", js.undefined)
    
    inline def setOnSlideChanged(value: /* e */ EventObject => Callback): Self = StObject.set(x, "onSlideChanged", js.Any.fromFunction1((t0: /* e */ EventObject) => value(t0).runNow()))
