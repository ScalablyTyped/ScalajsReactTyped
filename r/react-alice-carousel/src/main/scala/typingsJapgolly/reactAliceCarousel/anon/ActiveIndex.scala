...
object ActiveIndex {
  ...
  extension [Self <: ActiveIndex](x: Self) {
    ...
    inline def setOnInitialized(value: Callback): Self = StObject.set(x, "onInitialized", value.toJsFn)
    
    inline def setOnResizeEvent(value: Unit): Self = StObject.set(x, "onResizeEvent", value.asInstanceOf[js.Any])
    
    inline def setOnResized(value: Callback): Self = StObject.set(x, "onResized", value.toJsFn)
    
    inline def setOnSlideChange(value: Callback): Self = StObject.set(x, "onSlideChange", value.toJsFn)
    
    inline def setOnSlideChanged(value: Callback): Self = StObject.set(x, "onSlideChanged", value.toJsFn)
