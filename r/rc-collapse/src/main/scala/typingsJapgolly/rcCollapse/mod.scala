...
import typingsJapgolly.rcCollapse.anon.Typeofdefault
...
object mod {
  ...
  open class default protected ()
    extends typingsJapgolly.rcCollapse.esCollapseMod.default {
  ...
  object default {
    ...
    @js.native
    open class Panel ()
      extends typingsJapgolly.rcCollapse.esCollapseMod.default.Panel
    /* was `typeof CollapsePanel` */
    object Panel {
  ...
  @JSImport("rc-collapse", "Panel")
  @js.native
  val Panel: Instantiable0[typingsJapgolly.rcCollapse.esPanelMod.default] & Typeofdefault = js.native
}
