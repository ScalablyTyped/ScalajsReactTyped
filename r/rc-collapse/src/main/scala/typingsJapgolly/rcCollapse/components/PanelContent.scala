...
import typingsJapgolly.rcCollapse.anon.CollapsePanelPropschildre
...
object PanelContent {
  ...
  inline def apply(children: js.UndefOr[Node] & Node): Builder = {
    val __props = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[CollapsePanelPropschildre]))
  }
