...
@scala.inline
open class SharedBuilder_CollapsePanelProps755478353[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def extra(value: String | Node): this.type = set("extra", value.asInstanceOf[js.Any])
  ...
  inline def headerClass(value: String): this.type = set("headerClass", value.asInstanceOf[js.Any])
  ...
  inline def onItemClick(value: /* panelKey */ String | Double => Callback): this.type = set("onItemClick", js.Any.fromFunction1((t0: /* panelKey */ String | Double) => value(t0).runNow()))
  ...
  inline def panelKey(value: String | Double): this.type = set("panelKey", value.asInstanceOf[js.Any])
