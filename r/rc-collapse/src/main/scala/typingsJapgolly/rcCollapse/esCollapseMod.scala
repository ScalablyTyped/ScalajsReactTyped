...
import typingsJapgolly.rcCollapse.anon.PartialCollapseState
...
object esCollapseMod {
  ...
  object default {
    ...
    @js.native
    open class Panel ()
      extends typingsJapgolly.rcCollapse.esPanelMod.default
    /* was `typeof CollapsePanel` */
    object Panel {
  ...
  trait Collapse extends Component[CollapseProps, CollapseState, Any] {
    ...
    def getNewChild(child: Element, index: Double): Element = js.native
  ...
  object Collapse {
    ...
    /* was `typeof CollapsePanel` */
    type Panel = typingsJapgolly.rcCollapse.esPanelMod.default
  }
