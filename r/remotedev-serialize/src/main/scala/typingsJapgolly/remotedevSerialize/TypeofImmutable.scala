...
trait TypeofImmutable extends js.Object {
  ...
  def fromJS(
    ...
    reviver: js.Function3[
      /* key */ String | Double, 
      /* sequence */ (Keyed[String, _]) | typingsJapgolly.immutable.Immutable.Collection.Indexed[_], 
  ...
  def get[K, V](collection: typingsJapgolly.immutable.Immutable.Collection[K, V], key: K): js.UndefOr[V] = js.native
  ...
  def get[TProps, K /* <: String */](record: typingsJapgolly.immutable.Immutable.Record[TProps], key: K, notSetValue: js.Any): /* import warning: importer.ImportType#apply Failed type conversion: TProps[K] */ js.Any = js.native
  def get[K, V, NSV](collection: typingsJapgolly.immutable.Immutable.Collection[K, V], key: K, notSetValue: NSV): V | NSV = js.native
  ...
  def remove[K, C /* <: typingsJapgolly.immutable.Immutable.Collection[K, _] */](collection: C, key: K): C = js.native
  ...
  @JSName("remove")
  def remove_TPropsC_RecordTPropsK_String[TProps, C /* <: typingsJapgolly.immutable.Immutable.Record[TProps] */, K /* <: String */](collection: C, key: K): C = js.native
  ...
  def set[K, V, C /* <: typingsJapgolly.immutable.Immutable.Collection[K, V] */](collection: C, key: K, value: V): C = js.native
  def setIn[C](collection: C, keyPath: js.Iterable[_], value: js.Any): C = js.native
  @JSName("set")
  def set_TPropsC_RecordTPropsK_String[TProps, C /* <: typingsJapgolly.immutable.Immutable.Record[TProps] */, K /* <: String */](
    record: C,
    key: K,
  ...
  @JSName("update")
  def update_KVC_CollectionKV[K, V, C /* <: typingsJapgolly.immutable.Immutable.Collection[K, V] */](collection: C, key: K, updater: js.Function1[/* value */ V, V]): C = js.native
  @JSName("update")
  def update_KVC_CollectionKVNSV[K, V, C /* <: typingsJapgolly.immutable.Immutable.Collection[K, V] */, NSV](collection: C, key: K, notSetValue: NSV, updater: js.Function1[/* value */ V | NSV, V]): C = js.native
  @JSName("update")
  def update_TPropsC_RecordTPropsK_String[TProps, C /* <: typingsJapgolly.immutable.Immutable.Record[TProps] */, K /* <: String */](
    record: C,
    key: K,
    updater: js.Function1[
  ...
  @JSName("update")
  def update_TPropsC_RecordTPropsK_StringNSV[TProps, C /* <: typingsJapgolly.immutable.Immutable.Record[TProps] */, K /* <: String */, NSV](
    record: C,
    key: K,
    notSetValue: NSV,
    updater: js.Function1[
