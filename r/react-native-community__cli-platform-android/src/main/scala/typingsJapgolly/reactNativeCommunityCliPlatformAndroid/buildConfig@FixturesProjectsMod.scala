...
import typingsJapgolly.reactNativeCommunityCliPlatformAndroid.anon.Android
import typingsJapgolly.reactNativeCommunityCliPlatformAndroid.anon.App
import typingsJapgolly.reactNativeCommunityCliPlatformAndroid.anon.Buildgradle
