...
object anon {
  ...
  trait Blob extends StObject {
    ...
    var blob: org.scalajs.dom.Blob
    
    var name: String
  }
  object Blob {
    
    inline def apply(blob: org.scalajs.dom.Blob, name: String): Blob = {
    ...
    extension [Self <: Blob](x: Self) {
      ...
      inline def setBlob(value: org.scalajs.dom.Blob): Self = StObject.set(x, "blob", value.asInstanceOf[js.Any])
  ...
  object Content {
    ...
    inline def apply(content: VdomElement, disabled: Boolean, name: String, readonly: Boolean): Content = {
      val __obj = js.Dynamic.literal(content = content.rawElement.asInstanceOf[js.Any], disabled = disabled.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], readonly = readonly.asInstanceOf[js.Any])
  ...
  object Description {
    ...
    inline def apply(description: String | Element, id: String): Description = {
  ...
  trait ErrorSchema extends StObject {
    ...
    var errorSchema: typingsJapgolly.reactJsonschemaForm.mod.ErrorSchema
    
    var errors: js.Array[AjvError]
  }
  object ErrorSchema {
    
    inline def apply(errorSchema: typingsJapgolly.reactJsonschemaForm.mod.ErrorSchema, errors: js.Array[AjvError]): ErrorSchema = {
    ...
    extension [Self <: ErrorSchema](x: Self) {
      ...
      inline def setErrorSchema(value: typingsJapgolly.reactJsonschemaForm.mod.ErrorSchema): Self = StObject.set(x, "errorSchema", value.asInstanceOf[js.Any])
