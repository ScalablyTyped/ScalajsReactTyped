...
import typingsJapgolly.reactJsonschemaForm.anon.Blob
import typingsJapgolly.reactJsonschemaForm.anon.Definitions
import typingsJapgolly.reactJsonschemaForm.anon.Label
...
object libUtilsMod {
  ...
  inline def setState(instance: Component[js.Object, js.Object], state: Any, callback: js.Function): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setState")(instance.asInstanceOf[js.Any], state.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def shouldRender(comp: Component[js.Object, js.Object], nextProps: Any, nextState: Any): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("shouldRender")(comp.asInstanceOf[js.Any], nextProps.asInstanceOf[js.Any], nextState.asInstanceOf[js.Any])).asInstanceOf[Boolean]
