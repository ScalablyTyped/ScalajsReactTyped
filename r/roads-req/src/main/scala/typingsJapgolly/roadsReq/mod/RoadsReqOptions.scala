package typingsJapgolly.roadsReq.mod

import typingsJapgolly.node.httpMod.RequestOptions
import typingsJapgolly.roadsReq.AnonEncoding
import typingsJapgolly.roadsReq.AnonPw
...
trait RoadsReqOptions extends js.Object {
  ...
  var request: RequestOptions | typingsJapgolly.node.httpsMod.RequestOptions
...
object RoadsReqOptions {
  @scala.inline
  def apply(
    request: RequestOptions | typingsJapgolly.node.httpsMod.RequestOptions,
