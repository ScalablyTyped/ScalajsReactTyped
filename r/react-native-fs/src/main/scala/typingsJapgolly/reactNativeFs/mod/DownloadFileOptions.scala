...
object DownloadFileOptions {
  ...
  def apply(
    ...
    begin: /* res */ DownloadBeginCallbackResult => Callback = null,
    ...
    progress: /* res */ DownloadProgressCallbackResult => Callback = null,
    progressDivider: Int | Double = null,
    progressInterval: Int | Double = null,
    readTimeout: Int | Double = null,
    resumable: js.UndefOr[Callback] = js.undefined
  ): DownloadFileOptions = {
    ...
    if (begin != null) __obj.updateDynamic("begin")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.reactNativeFs.mod.DownloadBeginCallbackResult) => begin(t0).runNow()))
    ...
    if (progress != null) __obj.updateDynamic("progress")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.reactNativeFs.mod.DownloadProgressCallbackResult) => progress(t0).runNow()))
    ...
    resumable.foreach(p => __obj.updateDynamic("resumable")(p.toJsFn))
