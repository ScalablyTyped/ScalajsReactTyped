...
object UploadFileOptions {
  ...
  extension [Self <: UploadFileOptions](x: Self) {
    ...
    inline def setBegin(value: /* res */ UploadBeginCallbackResult => Callback): Self = StObject.set(x, "begin", js.Any.fromFunction1((t0: /* res */ UploadBeginCallbackResult) => value(t0).runNow()))
    
    inline def setBeginCallback(value: /* res */ UploadBeginCallbackResult => Callback): Self = StObject.set(x, "beginCallback", js.Any.fromFunction1((t0: /* res */ UploadBeginCallbackResult) => value(t0).runNow()))
    ...
    inline def setProgress(value: /* res */ UploadProgressCallbackResult => Callback): Self = StObject.set(x, "progress", js.Any.fromFunction1((t0: /* res */ UploadProgressCallbackResult) => value(t0).runNow()))
    
    inline def setProgressCallback(value: /* res */ UploadProgressCallbackResult => Callback): Self = StObject.set(x, "progressCallback", js.Any.fromFunction1((t0: /* res */ UploadProgressCallbackResult) => value(t0).runNow()))
