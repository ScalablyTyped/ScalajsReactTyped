...
object mod {
  ...
  trait CalendarPickerProps extends StObject {
    ...
    var nextComponent: js.UndefOr[Node] = js.undefined
    ...
    var previousComponent: js.UndefOr[Node] = js.undefined
  ...
  object CalendarPickerProps {
    ...
    extension [Self <: CalendarPickerProps](x: Self) {
      ...
      inline def setNextComponent(value: VdomNode): Self = StObject.set(x, "nextComponent", value.rawNode.asInstanceOf[js.Any])
      
      inline def setNextComponentNull: Self = StObject.set(x, "nextComponent", null)
      
      inline def setNextComponentUndefined: Self = StObject.set(x, "nextComponent", js.undefined)
      
      inline def setNextComponentVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "nextComponent", js.Array(value*))
      
      inline def setNextComponentVdomElement(value: VdomElement): Self = StObject.set(x, "nextComponent", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnDateChange(value: (/* date */ Moment, /* type */ START_DATE | END_DATE) => Callback): Self = StObject.set(x, "onDateChange", js.Any.fromFunction2((t0: /* date */ Moment, t1: /* type */ START_DATE | END_DATE) => (value(t0, t1)).runNow()))
      
      inline def setOnDateChangeUndefined: Self = StObject.set(x, "onDateChange", js.undefined)
      
      inline def setOnMonthChange(value: (/* date */ Moment, /* type */ START_DATE | END_DATE) => Callback): Self = StObject.set(x, "onMonthChange", js.Any.fromFunction2((t0: /* date */ Moment, t1: /* type */ START_DATE | END_DATE) => (value(t0, t1)).runNow()))
      
      inline def setOnMonthChangeUndefined: Self = StObject.set(x, "onMonthChange", js.undefined)
      
      inline def setPreviousComponent(value: VdomNode): Self = StObject.set(x, "previousComponent", value.rawNode.asInstanceOf[js.Any])
      
      inline def setPreviousComponentNull: Self = StObject.set(x, "previousComponent", null)
      
      inline def setPreviousComponentUndefined: Self = StObject.set(x, "previousComponent", js.undefined)
      
      inline def setPreviousComponentVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "previousComponent", js.Array(value*))
      
      inline def setPreviousComponentVdomElement(value: VdomElement): Self = StObject.set(x, "previousComponent", value.rawElement.asInstanceOf[js.Any])
