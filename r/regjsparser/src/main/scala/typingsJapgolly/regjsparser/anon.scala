package typingsJapgolly.regjsparser

import typingsJapgolly.regjsparser.mod.Features
import typingsJapgolly.regjsparser.mod.Identifier
import typingsJapgolly.regjsparser.mod.RootNode
import typingsJapgolly.regjsparser.regjsparserStrings.ignore
import typingsJapgolly.regjsparser.regjsparserStrings.lookahead
import typingsJapgolly.regjsparser.regjsparserStrings.lookbehind
import typingsJapgolly.regjsparser.regjsparserStrings.negativeLookahead
import typingsJapgolly.regjsparser.regjsparserStrings.negativeLookbehind
import typingsJapgolly.regjsparser.regjsparserStrings.normal
...
object anon {
  ...
  trait ModifierFlags extends StObject {
    ...
    var modifierFlags: js.UndefOr[typingsJapgolly.regjsparser.mod.ModifierFlags] = js.undefined
  }
  object ModifierFlags {
    ...
    extension [Self <: ModifierFlags](x: Self) {
      ...
      inline def setModifierFlags(value: typingsJapgolly.regjsparser.mod.ModifierFlags): Self = StObject.set(x, "modifierFlags", value.asInstanceOf[js.Any])
