...
object mod {
  ...
  trait InfiniteLoaderProps extends StObject {
    ...
    def children(props: typingsJapgolly.reactWindowInfiniteLoader.anon.OnItemsRendered): Node
  ...
  object InfiniteLoaderProps {
    ...
    inline def apply(
      children: typingsJapgolly.reactWindowInfiniteLoader.anon.OnItemsRendered => Node,
    ...
    extension [Self <: InfiniteLoaderProps](x: Self) {
      ...
      inline def setChildren(value: typingsJapgolly.reactWindowInfiniteLoader.anon.OnItemsRendered => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
