...
object mod {
  ...
  type TextInputMask = japgolly.scalajs.react.facade.React.Component[TextInputMaskProps & js.Object, js.Object]
  ...
  object TextInputMaskProps {
    ...
    inline def apply(onChangeText: (/* formatted */ String, /* extracted */ js.UndefOr[String]) => Callback): TextInputMaskProps = {
      val __obj = js.Dynamic.literal(onChangeText = js.Any.fromFunction2((t0: /* formatted */ String, t1: /* extracted */ js.UndefOr[String]) => (onChangeText(t0, t1)).runNow()))
    ...
    extension [Self <: TextInputMaskProps](x: Self) {
      ...
      inline def setOnChange(value: /* event */ NativeEvent => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* event */ NativeEvent) => value(t0).runNow()))
      
      inline def setOnChangeText(value: (/* formatted */ String, /* extracted */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "onChangeText", js.Any.fromFunction2((t0: /* formatted */ String, t1: /* extracted */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnContentSizeChange(value: /* event */ NativeEventContentSizeHeight => Callback): Self = StObject.set(x, "onContentSizeChange", js.Any.fromFunction1((t0: /* event */ NativeEventContentSizeHeight) => value(t0).runNow()))
      
      inline def setOnContentSizeChangeUndefined: Self = StObject.set(x, "onContentSizeChange", js.undefined)
      
      inline def setOnEndEditing(value: /* event */ NativeEventText => Callback): Self = StObject.set(x, "onEndEditing", js.Any.fromFunction1((t0: /* event */ NativeEventText) => value(t0).runNow()))
      ...
      inline def setOnSubmitEditing(value: /* event */ NativeEventText => Callback): Self = StObject.set(x, "onSubmitEditing", js.Any.fromFunction1((t0: /* event */ NativeEventText) => value(t0).runNow()))
      ...
      inline def setRefInput(value: /* ref */ Any => Callback): Self = StObject.set(x, "refInput", js.Any.fromFunction1((t0: /* ref */ Any) => value(t0).runNow()))
