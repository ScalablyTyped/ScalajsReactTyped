...
object ReactNativeTextInputMask {
  def apply(
    ...
    autoCapitalize: typingsJapgolly.reactNativeTextInputMask.reactNativeTextInputMaskStrings.none | sentences | words | characters = null,
    ...
    TextInputMaskProps, 
    typingsJapgolly.reactNativeTextInputMask.mod.default, 
    Unit, 
    TextInputMaskProps
  ] = {
  ...
  typingsJapgolly.reactNativeTextInputMask.mod.TextInputMaskProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeTextInputMask.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeTextInputMask.mod.TextInputMaskProps])(children: _*)
  }
