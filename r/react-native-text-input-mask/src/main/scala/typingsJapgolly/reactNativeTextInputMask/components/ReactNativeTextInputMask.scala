package typingsJapgolly.reactNativeTextInputMask.components
...
import typingsJapgolly.reactNativeTextInputMask.anon.End
import typingsJapgolly.reactNativeTextInputMask.anon.NativeEvent
import typingsJapgolly.reactNativeTextInputMask.anon.NativeEventContentSizeHeight
import typingsJapgolly.reactNativeTextInputMask.anon.NativeEventText
import typingsJapgolly.reactNativeTextInputMask.mod.TextInputMaskProps
import typingsJapgolly.reactNativeTextInputMask.mod.default
...
object ReactNativeTextInputMask {
  ...
  inline def apply(onChangeText: (/* formatted */ String, /* extracted */ js.UndefOr[String]) => Callback): Builder = {
    val __props = js.Dynamic.literal(onChangeText = js.Any.fromFunction2((t0: /* formatted */ String, t1: /* extracted */ js.UndefOr[String]) => (onChangeText(t0, t1)).runNow()))
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def autoCapitalize(
      value: typingsJapgolly.reactNativeTextInputMask.reactNativeTextInputMaskStrings.none | sentences | words | characters
    ...
    inline def maskDefaultValue(value: Boolean): this.type = set("maskDefaultValue", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* event */ NativeEvent => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* event */ NativeEvent) => value(t0).runNow()))
    
    inline def onContentSizeChange(value: /* event */ NativeEventContentSizeHeight => Callback): this.type = set("onContentSizeChange", js.Any.fromFunction1((t0: /* event */ NativeEventContentSizeHeight) => value(t0).runNow()))
    
    inline def onEndEditing(value: /* event */ NativeEventText => Callback): this.type = set("onEndEditing", js.Any.fromFunction1((t0: /* event */ NativeEventText) => value(t0).runNow()))
    ...
    inline def onSubmitEditing(value: /* event */ NativeEventText => Callback): this.type = set("onSubmitEditing", js.Any.fromFunction1((t0: /* event */ NativeEventText) => value(t0).runNow()))
    ...
    inline def refInput(value: /* ref */ Any => Callback): this.type = set("refInput", js.Any.fromFunction1((t0: /* ref */ Any) => value(t0).runNow()))
