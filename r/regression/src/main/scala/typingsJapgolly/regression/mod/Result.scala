...
object Result {
  ...
  def apply(
    ...
    predict: Double => CallbackTo[DataPoint],
    r2: Double,
    string: String
  ): Result = {
    val __obj = js.Dynamic.literal(equation = equation.asInstanceOf[js.Any], points = points.asInstanceOf[js.Any], r2 = r2.asInstanceOf[js.Any], string = string.asInstanceOf[js.Any])
    __obj.updateDynamic("predict")(js.Any.fromFunction1((t0: scala.Double) => predict(t0).runNow()))
