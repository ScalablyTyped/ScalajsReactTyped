package typingsJapgolly.reactSlick.components
...
import typingsJapgolly.reactSlick.mod.LazyLoadTypes
import typingsJapgolly.reactSlick.mod.ResponsiveObject
import typingsJapgolly.reactSlick.mod.Settings
import typingsJapgolly.reactSlick.mod.Slider
import typingsJapgolly.reactSlick.mod.SwipeDirection
import typingsJapgolly.reactSlick.mod.default
...
object ReactSlick {
  def apply(
    ...
    if (onEdge != null) __obj.updateDynamic("onEdge")(js.Any.fromFunction1((t0: /* swipeDirection */ typingsJapgolly.reactSlick.mod.SwipeDirection) => onEdge(t0).runNow()))
    ...
    if (onSwipe != null) __obj.updateDynamic("onSwipe")(js.Any.fromFunction1((t0: /* swipeDirection */ typingsJapgolly.reactSlick.mod.SwipeDirection) => onSwipe(t0).runNow()))
    ...
    if (swipeEvent != null) __obj.updateDynamic("swipeEvent")(js.Any.fromFunction1((t0: /* swipeDirection */ typingsJapgolly.reactSlick.mod.SwipeDirection) => swipeEvent(t0).runNow()))
  ...
  typingsJapgolly.reactSlick.mod.Settings, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSlick.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSlick.mod.Settings])(children: _*)
  }
