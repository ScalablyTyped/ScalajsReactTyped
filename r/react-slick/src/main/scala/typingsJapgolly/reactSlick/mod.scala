...
import typingsJapgolly.reactSlick.reactSlickStrings.unslick
...
object mod {
  ...
  type ComponentConstructor[TProps] = (ComponentClassP[TProps & js.Object]) | FunctionComponent[TProps]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactSlick.reactSlickStrings.ondemand
    - typingsJapgolly.reactSlick.reactSlickStrings.progressive
    - typingsJapgolly.reactSlick.reactSlickStrings.anticipated
  */
  trait LazyLoadTypes extends StObject
  object LazyLoadTypes {
    
    inline def anticipated: typingsJapgolly.reactSlick.reactSlickStrings.anticipated = "anticipated".asInstanceOf[typingsJapgolly.reactSlick.reactSlickStrings.anticipated]
    
    inline def ondemand: typingsJapgolly.reactSlick.reactSlickStrings.ondemand = "ondemand".asInstanceOf[typingsJapgolly.reactSlick.reactSlickStrings.ondemand]
    
    inline def progressive: typingsJapgolly.reactSlick.reactSlickStrings.progressive = "progressive".asInstanceOf[typingsJapgolly.reactSlick.reactSlickStrings.progressive]
  }
  ...
  trait Settings extends StObject {
    ...
    var appendDots: js.UndefOr[js.Function1[/* dots */ Node, typingsJapgolly.react.mod.global.JSX.Element]] = js.undefined
    ...
    var customPaging: js.UndefOr[js.Function1[/* index */ Double, typingsJapgolly.react.mod.global.JSX.Element]] = js.undefined
    ...
    var nextArrow: js.UndefOr[typingsJapgolly.react.mod.global.JSX.Element] = js.undefined
    ...
    var prevArrow: js.UndefOr[typingsJapgolly.react.mod.global.JSX.Element] = js.undefined
  ...
  object Settings {
    ...
    extension [Self <: Settings](x: Self) {
      ...
      inline def setAppendDots(value: /* dots */ Node => typingsJapgolly.react.mod.global.JSX.Element): Self = StObject.set(x, "appendDots", js.Any.fromFunction1(value))
      ...
      inline def setCustomPaging(value: /* index */ Double => typingsJapgolly.react.mod.global.JSX.Element): Self = StObject.set(x, "customPaging", js.Any.fromFunction1(value))
      ...
      inline def setOnEdge(value: /* swipeDirection */ SwipeDirection => Callback): Self = StObject.set(x, "onEdge", js.Any.fromFunction1((t0: /* swipeDirection */ SwipeDirection) => value(t0).runNow()))
      ...
      inline def setOnLazyLoad(value: /* slidesToLoad */ js.Array[Double] => Callback): Self = StObject.set(x, "onLazyLoad", js.Any.fromFunction1((t0: /* slidesToLoad */ js.Array[Double]) => value(t0).runNow()))
      
      inline def setOnLazyLoadUndefined: Self = StObject.set(x, "onLazyLoad", js.undefined)
      
      inline def setOnReInit(value: Callback): Self = StObject.set(x, "onReInit", value.toJsFn)
      
      inline def setOnReInitUndefined: Self = StObject.set(x, "onReInit", js.undefined)
      
      inline def setOnSwipe(value: /* swipeDirection */ SwipeDirection => Callback): Self = StObject.set(x, "onSwipe", js.Any.fromFunction1((t0: /* swipeDirection */ SwipeDirection) => value(t0).runNow()))
      ...
      inline def setSwipeEvent(value: /* swipeDirection */ SwipeDirection => Callback): Self = StObject.set(x, "swipeEvent", js.Any.fromFunction1((t0: /* swipeDirection */ SwipeDirection) => value(t0).runNow()))
