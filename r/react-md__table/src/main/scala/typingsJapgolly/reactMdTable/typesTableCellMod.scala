...
import typingsJapgolly.reactMdTable.reactMdTableStrings.colSpan
...
import typingsJapgolly.reactMdTable.reactMdTableStrings.scope
import typingsJapgolly.reactMdTable.typesConfigMod.TableCellConfig
...
object typesTableCellMod {
  ...
  - Dropped {[ P in std.Exclude<keyof react.react.TdHTMLAttributes<std.HTMLTableCellElement> | react.react.ThHTMLAttributes<std.HTMLTableCellElement>, 'colSpan' | 'scope'> ]: react.react.TdHTMLAttributes<std.HTMLTableCellElement> | react.react.ThHTMLAttributes<std.HTMLTableCellElement>[P]} */ trait TableCellProps
    ...
    /**
      ...
      * prop to `null`.
      */
    var sortIcon: js.UndefOr[Node] = js.undefined
  ...
  object TableCellProps {
    ...
    extension [Self <: TableCellProps](x: Self) {
      ...
      inline def setSortIcon(value: VdomNode): Self = StObject.set(x, "sortIcon", value.rawNode.asInstanceOf[js.Any])
      ...
      inline def setSortIconVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "sortIcon", js.Array(value*))
      
      inline def setSortIconVdomElement(value: VdomElement): Self = StObject.set(x, "sortIcon", value.rawElement.asInstanceOf[js.Any])
    }
  }
}
