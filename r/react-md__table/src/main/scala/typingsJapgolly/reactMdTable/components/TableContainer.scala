...
import typingsJapgolly.reactMdTable.typesTableContainerMod.TableContainerProps
...
object TableContainer {
  ...
  def withProps(p: TableContainerProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
