...
object typesConfigMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMdTable.reactMdTableStrings.left
    - typingsJapgolly.reactMdTable.reactMdTableStrings.center
    - typingsJapgolly.reactMdTable.reactMdTableStrings.right
  */
  trait TableCellHorizontalAlignment extends StObject
  object TableCellHorizontalAlignment {
    
    inline def center: typingsJapgolly.reactMdTable.reactMdTableStrings.center = "center".asInstanceOf[typingsJapgolly.reactMdTable.reactMdTableStrings.center]
    
    inline def left: typingsJapgolly.reactMdTable.reactMdTableStrings.left = "left".asInstanceOf[typingsJapgolly.reactMdTable.reactMdTableStrings.left]
    
    inline def right: typingsJapgolly.reactMdTable.reactMdTableStrings.right = "right".asInstanceOf[typingsJapgolly.reactMdTable.reactMdTableStrings.right]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMdTable.reactMdTableStrings.top
    - typingsJapgolly.reactMdTable.reactMdTableStrings.middle
    - typingsJapgolly.reactMdTable.reactMdTableStrings.bottom
  */
  trait TableCellVerticalAlignment extends StObject
  object TableCellVerticalAlignment {
    
    inline def bottom: typingsJapgolly.reactMdTable.reactMdTableStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.reactMdTable.reactMdTableStrings.bottom]
    
    inline def middle: typingsJapgolly.reactMdTable.reactMdTableStrings.middle = "middle".asInstanceOf[typingsJapgolly.reactMdTable.reactMdTableStrings.middle]
    
    inline def top: typingsJapgolly.reactMdTable.reactMdTableStrings.top = "top".asInstanceOf[typingsJapgolly.reactMdTable.reactMdTableStrings.top]
  }
