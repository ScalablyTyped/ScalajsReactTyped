...
import typingsJapgolly.recurlyRecurlyJs.lib3dSecureMod.RiskOptions
import typingsJapgolly.recurlyRecurlyJs.lib3dSecureMod.ThreeDSecureEmitter
...
trait ThreeDSecure extends StObject {
  ...
  /**
    ...
    */
  @JSName("ThreeDSecure")
  var ThreeDSecure_Original: typingsJapgolly.recurlyRecurlyJs.lib3dSecureMod.ThreeDSecure
}
object ThreeDSecure {
