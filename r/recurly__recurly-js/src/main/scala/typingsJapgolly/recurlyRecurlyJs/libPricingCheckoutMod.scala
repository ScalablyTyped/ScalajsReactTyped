...
import typingsJapgolly.recurlyRecurlyJs.anon.Adjustments
import typingsJapgolly.recurlyRecurlyJs.anon.Code
import typingsJapgolly.recurlyRecurlyJs.libAddressMod.Address
import typingsJapgolly.recurlyRecurlyJs.libPricingMod.PricingInstance
import typingsJapgolly.recurlyRecurlyJs.libPricingMod.Tax
import typingsJapgolly.recurlyRecurlyJs.libPricingPromiseMod.PricingPromise
import typingsJapgolly.recurlyRecurlyJs.libPricingSubscriptionMod.SubscriptionPricingState
...
object libPricingCheckoutMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.recurlyRecurlyJs.libPricingCheckoutMod.ItemAdjustment
    - typingsJapgolly.recurlyRecurlyJs.libPricingCheckoutMod.NonItemAdjustment
  */
  trait Adjustment extends StObject
  object Adjustment {
    
    inline def ItemAdjustment(itemCode: String, quantity: Double): typingsJapgolly.recurlyRecurlyJs.libPricingCheckoutMod.ItemAdjustment = {
      val __obj = js.Dynamic.literal(itemCode = itemCode.asInstanceOf[js.Any], quantity = quantity.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.recurlyRecurlyJs.libPricingCheckoutMod.ItemAdjustment]
    }
    
    inline def NonItemAdjustment(amount: Double, quantity: Double, taxCode: String, taxExempt: Boolean): typingsJapgolly.recurlyRecurlyJs.libPricingCheckoutMod.NonItemAdjustment = {
      ...
      __obj.asInstanceOf[typingsJapgolly.recurlyRecurlyJs.libPricingCheckoutMod.NonItemAdjustment]
    }
  }
