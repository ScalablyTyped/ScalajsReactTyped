...
import typingsJapgolly.recurlyRecurlyJs.libErrorMod.RecurlyError
import typingsJapgolly.recurlyRecurlyJs.libTokenMod.TokenHandler
import typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.bacs
import typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.becs
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libBankAccountMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.recurlyRecurlyJs.libBankAccountMod.SepaBillingInfo
    - typingsJapgolly.recurlyRecurlyJs.libBankAccountMod.BacsBillingInfo
    - typingsJapgolly.recurlyRecurlyJs.libBankAccountMod.BecsBillingInfo
    - typingsJapgolly.recurlyRecurlyJs.libBankAccountMod.BankAccountBillingInfo
  */
  ...
  object BillingInfo {
    ...
    inline def BacsBillingInfo(
      ...
      val __obj = js.Dynamic.literal(account_number = account_number.asInstanceOf[js.Any], account_number_confirmation = account_number_confirmation.asInstanceOf[js.Any], name_on_account = name_on_account.asInstanceOf[js.Any], sort_code = sort_code.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("bacs")
      __obj.asInstanceOf[typingsJapgolly.recurlyRecurlyJs.libBankAccountMod.BacsBillingInfo]
    }
    ...
    inline def BankAccountBillingInfo(
      ...
      val __obj = js.Dynamic.literal(account_number = account_number.asInstanceOf[js.Any], account_number_confirmation = account_number_confirmation.asInstanceOf[js.Any], name_on_account = name_on_account.asInstanceOf[js.Any], routing_number = routing_number.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.recurlyRecurlyJs.libBankAccountMod.BankAccountBillingInfo]
    }
    ...
    inline def BecsBillingInfo(
      ...
      val __obj = js.Dynamic.literal(account_number = account_number.asInstanceOf[js.Any], account_number_confirmation = account_number_confirmation.asInstanceOf[js.Any], branch_code = branch_code.asInstanceOf[js.Any], name_on_account = name_on_account.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("becs")
      __obj.asInstanceOf[typingsJapgolly.recurlyRecurlyJs.libBankAccountMod.BecsBillingInfo]
    }
    
    inline def SepaBillingInfo(iban: String, name_on_account: String): typingsJapgolly.recurlyRecurlyJs.libBankAccountMod.SepaBillingInfo = {
      val __obj = js.Dynamic.literal(iban = iban.asInstanceOf[js.Any], name_on_account = name_on_account.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.recurlyRecurlyJs.libBankAccountMod.SepaBillingInfo]
    }
  }
