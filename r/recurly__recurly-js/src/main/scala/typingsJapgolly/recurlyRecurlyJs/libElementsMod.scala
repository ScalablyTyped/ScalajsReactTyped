...
import typingsJapgolly.recurlyRecurlyJs.anon.CommonElementStyleinvalid
import typingsJapgolly.recurlyRecurlyJs.anon.CommonElementStyleinvalidFontColor
import typingsJapgolly.recurlyRecurlyJs.libEmitterMod.Emitter
import typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.submit
...
object libElementsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.focus
    - typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.blur
    - typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.submit
    - typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.attach
    - typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.remove
  */
  trait ElementEvent extends StObject
  object ElementEvent {
    
    inline def attach: typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.attach = "attach".asInstanceOf[typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.attach]
    
    inline def blur: typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.blur = "blur".asInstanceOf[typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.blur]
    ...
    inline def focus: typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.focus = "focus".asInstanceOf[typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.focus]
    
    inline def remove: typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.remove = "remove".asInstanceOf[typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.remove]
    
    inline def submit: typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.submit = "submit".asInstanceOf[typingsJapgolly.recurlyRecurlyJs.recurlyRecurlyJsStrings.submit]
  }
  ...
  trait ElementsInstance
    ...
    /**
      ...
      */
    def CardElement(): typingsJapgolly.recurlyRecurlyJs.libElementsMod.CardElement = js.native
    def CardElement(cardElementOptions: CardElementOptions): typingsJapgolly.recurlyRecurlyJs.libElementsMod.CardElement = js.native
