...
object MentionsProps {
  ...
  def apply(
    ...
    if (validateSearch != null) __obj.updateDynamic("validateSearch")(js.Any.fromFunction2((t0: /* text */ java.lang.String, t1: typingsJapgolly.rcDashMentions.libMentionsMod.MentionsProps) => validateSearch(t0, t1).runNow()))
