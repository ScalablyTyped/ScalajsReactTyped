...
import typingsJapgolly.rcDashMentions.libMod.default
...
object Lib {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MentionsProps, default, Unit, MentionsProps] = {
  ...
  typingsJapgolly.rcDashMentions.libMentionsMod.MentionsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.rcDashMentions.libMod.default](js.constructorOf[typingsJapgolly.rcDashMentions.libMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.rcDashMentions.libMentionsMod.MentionsProps])(children: _*)
  }
}
