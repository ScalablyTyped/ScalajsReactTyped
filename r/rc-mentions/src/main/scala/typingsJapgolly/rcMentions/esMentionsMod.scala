...
object esMentionsMod {
  ...
  object BaseTextareaAttrs {
    ...
    extension [Self <: BaseTextareaAttrs](x: Self) {
      ...
      inline def setOnPressEnter(value: ReactKeyboardEventFrom[HTMLTextAreaElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onPressEnter", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLTextAreaElement & org.scalajs.dom.Element]) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rcMentions.rcMentionsStrings.ltr
    - typingsJapgolly.rcMentions.rcMentionsStrings.rtl
  */
  trait Direction extends StObject
  object Direction {
    
    inline def ltr: typingsJapgolly.rcMentions.rcMentionsStrings.ltr = "ltr".asInstanceOf[typingsJapgolly.rcMentions.rcMentionsStrings.ltr]
    
    inline def rtl: typingsJapgolly.rcMentions.rcMentionsStrings.rtl = "rtl".asInstanceOf[typingsJapgolly.rcMentions.rcMentionsStrings.rtl]
  }
  ...
  object MentionsProps {
    ...
    extension [Self <: MentionsProps](x: Self) {
      ...
      inline def setOnSearch(value: (/* text */ String, /* prefix */ String) => Callback): Self = StObject.set(x, "onSearch", js.Any.fromFunction2((t0: /* text */ String, t1: /* prefix */ String) => (value(t0, t1)).runNow()))
      
      inline def setOnSearchUndefined: Self = StObject.set(x, "onSearch", js.undefined)
      
      inline def setOnSelect(value: (/* option */ OptionProps, /* prefix */ String) => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction2((t0: /* option */ OptionProps, t1: /* prefix */ String) => (value(t0, t1)).runNow()))
  ...
  object MentionsRef {
    ...
    inline def apply(blur: Callback, focus: Callback): MentionsRef = {
      val __obj = js.Dynamic.literal(blur = blur.toJsFn, focus = focus.toJsFn, textarea = null)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rcMentions.rcMentionsStrings.top
    - typingsJapgolly.rcMentions.rcMentionsStrings.bottom
  */
  trait Placement extends StObject
  object Placement {
    
    inline def bottom: typingsJapgolly.rcMentions.rcMentionsStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.rcMentions.rcMentionsStrings.bottom]
    
    inline def top: typingsJapgolly.rcMentions.rcMentionsStrings.top = "top".asInstanceOf[typingsJapgolly.rcMentions.rcMentionsStrings.top]
  }
}
