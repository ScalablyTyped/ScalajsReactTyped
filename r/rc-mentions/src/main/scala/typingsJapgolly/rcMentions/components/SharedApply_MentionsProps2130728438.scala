...
abstract class SharedApply_MentionsProps2130728438[ComponentRef] () {
  ...
  def apply(
    ...
    if (onSelect != null) __obj.updateDynamic("onSelect")(js.Any.fromFunction2((t0: /* option */ typingsJapgolly.rcMentions.optionMod.OptionProps, t1: /* prefix */ java.lang.String) => onSelect(t0, t1).runNow()))
    ...
    if (validateSearch != null) __obj.updateDynamic("validateSearch")(js.Any.fromFunction2((t0: /* text */ java.lang.String, t1: typingsJapgolly.rcMentions.mentionsMod.MentionsProps) => validateSearch(t0, t1).runNow()))
  ...
  typingsJapgolly.rcMentions.mentionsMod.MentionsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rcMentions.mentionsMod.MentionsProps])(children: _*)
  }
}
