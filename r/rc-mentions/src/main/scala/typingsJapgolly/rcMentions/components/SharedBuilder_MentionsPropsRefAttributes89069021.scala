...
@scala.inline
open class SharedBuilder_MentionsPropsRefAttributes89069021[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def filterOption(value: `false` | (js.Function2[/* input */ String, /* hasValue */ OptionProps, Boolean])): this.type = set("filterOption", value.asInstanceOf[js.Any])
  
  inline def filterOptionFunction2(value: (/* input */ String, /* hasValue */ OptionProps) => Boolean): this.type = set("filterOption", js.Any.fromFunction2(value))
  ...
  inline def onSelect(value: (/* option */ OptionProps, /* prefix */ String) => Callback): this.type = set("onSelect", js.Any.fromFunction2((t0: /* option */ OptionProps, t1: /* prefix */ String) => (value(t0, t1)).runNow()))
  ...
  inline def validateSearch(value: (/* text */ String, MentionsProps) => Boolean): this.type = set("validateSearch", js.Any.fromFunction2(value))
