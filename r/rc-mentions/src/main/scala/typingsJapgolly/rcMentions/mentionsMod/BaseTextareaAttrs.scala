...
/* Inlined rc-mentions.rc-mentions/lib/util.Omit<react.react.TextareaHTMLAttributes<std.HTMLTextAreaElement>, 'prefix' | 'onChange' | 'onSelect'> */
trait BaseTextareaAttrs extends js.Object {
