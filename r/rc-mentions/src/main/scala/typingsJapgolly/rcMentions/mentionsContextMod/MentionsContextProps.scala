package typingsJapgolly.rcMentions.mentionsContextMod
...
object MentionsContextProps {
  ...
  def apply(
    ...
    __obj.updateDynamic("selectOption")(js.Any.fromFunction1((t0: typingsJapgolly.rcMentions.optionMod.OptionProps) => selectOption(t0).runNow()))
