...
import typingsJapgolly.rebass.mod.ButtonProps
...
object Button {
  ...
  typingsJapgolly.rebass.mod.ButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rebass.mod.ButtonProps])(children: _*)
  }
