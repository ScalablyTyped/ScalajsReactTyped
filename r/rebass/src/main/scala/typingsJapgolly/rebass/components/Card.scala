...
import typingsJapgolly.rebass.mod.BoxKnownProps
...
object Card {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BoxKnownProps, Ref, Unit, BoxKnownProps] = {
  ...
  typingsJapgolly.rebass.mod.BoxKnownProps, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rebass.mod.BoxKnownProps])(children: _*)
  }
