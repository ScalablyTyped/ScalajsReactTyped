package typingsJapgolly.reactUltimatePagination.mod
...
object PaginationComponentProps {
  @scala.inline
  def apply(isActive: Boolean, isDisabled: Boolean, onClick: Callback, value: Double): PaginationComponentProps = {
    val __obj = js.Dynamic.literal(isActive = isActive.asInstanceOf[js.Any], isDisabled = isDisabled.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
