...
import typingsJapgolly.reactNativeFirebase.anon.Authenticated
...
object auth {
  ...
  trait AuthStatics extends StObject {
    ...
    var EmailAuthProvider: typingsJapgolly.reactNativeFirebase.mod.RNFirebase.auth.EmailAuthProvider
