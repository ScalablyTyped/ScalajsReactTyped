...
import typingsJapgolly.reactNativeFirebase.reactNativeFirebaseStrings.SHORT
import typingsJapgolly.reactNativeFirebase.reactNativeFirebaseStrings.UNGUESSABLE
...
object links {
  ...
  object Links {
    ...
    inline def apply(
      ...
      getInitialLink: CallbackTo[js.Promise[String | Null]],
      onLink: js.Function1[/* url */ String, Unit] => js.Function0[Unit]
    ): Links = {
      val __obj = js.Dynamic.literal(createDynamicLink = js.Any.fromFunction1(createDynamicLink), createShortDynamicLink = js.Any.fromFunction2(createShortDynamicLink), getInitialLink = getInitialLink.toJsFn, onLink = js.Any.fromFunction1(onLink))
    ...
    extension [Self <: Links](x: Self) {
      ...
      inline def setGetInitialLink(value: CallbackTo[js.Promise[String | Null]]): Self = StObject.set(x, "getInitialLink", value.toJsFn)
  ...
  trait LinksStatics extends StObject {
    ...
    var DynamicLink: Instantiable2[
        ...
        typingsJapgolly.reactNativeFirebase.mod.RNFirebase.links.DynamicLink
      ]
  }
  object LinksStatics {
