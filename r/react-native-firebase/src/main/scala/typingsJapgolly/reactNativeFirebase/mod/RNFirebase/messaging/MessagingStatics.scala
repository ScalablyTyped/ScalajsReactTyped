package typingsJapgolly.reactNativeFirebase.mod.RNFirebase.messaging
...
trait MessagingStatics extends js.Object {
  var RemoteMessage: Instantiable0[typingsJapgolly.reactNativeFirebase.mod.RNFirebase.messaging.RemoteMessage]
}
