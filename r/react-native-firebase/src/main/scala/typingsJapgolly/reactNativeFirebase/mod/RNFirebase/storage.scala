...
import typingsJapgolly.reactNativeFirebase.anon.CACHESDIRECTORYPATH
import typingsJapgolly.reactNativeFirebase.anon.Complete
...
object storage {
  ...
  object TaskEvent extends StObject {
    ...
    sealed trait STATE_CHANGED
      extends StObject
         with TaskEvent
    /* "state_changed" */ val STATE_CHANGED: typingsJapgolly.reactNativeFirebase.mod.RNFirebase.storage.TaskEvent.STATE_CHANGED & String = js.native
  }
  ...
  object TaskState extends StObject {
    ...
    sealed trait CANCELLED
      extends StObject
         with TaskState
    /* "cancelled" */ val CANCELLED: typingsJapgolly.reactNativeFirebase.mod.RNFirebase.storage.TaskState.CANCELLED & String = js.native
    
    @js.native
    sealed trait ERROR
      extends StObject
         with TaskState
    /* "error" */ val ERROR: typingsJapgolly.reactNativeFirebase.mod.RNFirebase.storage.TaskState.ERROR & String = js.native
    
    @js.native
    sealed trait PAUSED
      extends StObject
         with TaskState
    /* "paused" */ val PAUSED: typingsJapgolly.reactNativeFirebase.mod.RNFirebase.storage.TaskState.PAUSED & String = js.native
    
    @js.native
    sealed trait RUNNING
      extends StObject
         with TaskState
    /* "running" */ val RUNNING: typingsJapgolly.reactNativeFirebase.mod.RNFirebase.storage.TaskState.RUNNING & String = js.native
    
    @js.native
    sealed trait SUCCESS
      extends StObject
         with TaskState
    /* "success" */ val SUCCESS: typingsJapgolly.reactNativeFirebase.mod.RNFirebase.storage.TaskState.SUCCESS & String = js.native
  }
