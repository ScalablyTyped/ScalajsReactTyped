...
import typingsJapgolly.reactNativeFirebase.AnonCACHESDIRECTORYPATH
...
trait StorageStatics extends js.Object {
  ...
  var TaskEvent: typingsJapgolly.reactNativeFirebase.mod.RNFirebase.storage.TaskEvent
  var TaskState: typingsJapgolly.reactNativeFirebase.mod.RNFirebase.storage.TaskState
}
