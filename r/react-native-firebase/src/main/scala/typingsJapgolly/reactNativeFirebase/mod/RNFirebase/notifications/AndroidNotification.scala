...
import typingsJapgolly.reactNativeFirebase.mod.RNFirebase.notifications.Android.BadgeIconType
import typingsJapgolly.reactNativeFirebase.mod.RNFirebase.notifications.Android.Category
import typingsJapgolly.reactNativeFirebase.mod.RNFirebase.notifications.Android.Defaults
import typingsJapgolly.reactNativeFirebase.mod.RNFirebase.notifications.Android.GroupAlert
import typingsJapgolly.reactNativeFirebase.mod.RNFirebase.notifications.Android.Lights
import typingsJapgolly.reactNativeFirebase.mod.RNFirebase.notifications.Android.Priority
import typingsJapgolly.reactNativeFirebase.mod.RNFirebase.notifications.Android.Progress
import typingsJapgolly.reactNativeFirebase.mod.RNFirebase.notifications.Android.Visibility
