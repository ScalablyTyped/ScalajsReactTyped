...
object firestore extends Shortcut {
  ...
  @js.native
  open class Blob ()
    extends typingsJapgolly.reactNativeFirebase.mod.RNFirebase.firestore.Blob
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("react-native-firebase", "firestore.FieldPath")
  @js.native
  open class FieldPath protected ()
    extends typingsJapgolly.reactNativeFirebase.mod.RNFirebase.firestore.FieldPath {
  ...
  open class FieldValue ()
    extends typingsJapgolly.reactNativeFirebase.mod.RNFirebase.firestore.FieldValue
  ...
  open class Timestamp protected ()
    extends typingsJapgolly.reactNativeFirebase.mod.RNFirebase.firestore.Timestamp {
