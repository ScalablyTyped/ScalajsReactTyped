...
import typingsJapgolly.reactStonecutter.reactStonecutterStrings.deg
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactStonecutter.reactStonecutterStrings.px
    - typingsJapgolly.reactStonecutter.reactStonecutterStrings.em
    - typingsJapgolly.reactStonecutter.reactStonecutterStrings.rem
  */
  trait LengthUnit extends StObject
  object LengthUnit {
    
    inline def em: typingsJapgolly.reactStonecutter.reactStonecutterStrings.em = "em".asInstanceOf[typingsJapgolly.reactStonecutter.reactStonecutterStrings.em]
    
    inline def px: typingsJapgolly.reactStonecutter.reactStonecutterStrings.px = "px".asInstanceOf[typingsJapgolly.reactStonecutter.reactStonecutterStrings.px]
    
    inline def rem: typingsJapgolly.reactStonecutter.reactStonecutterStrings.rem = "rem".asInstanceOf[typingsJapgolly.reactStonecutter.reactStonecutterStrings.rem]
  }
