...
import typingsJapgolly.reactStonecutter.mod.CSSGridProps
import typingsJapgolly.reactStonecutter.mod.Easing
...
object CSSGrid {
  ...
  inline def apply(columnWidth: Double, columns: Double, duration: Double): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactStonecutter.mod.CSSGrid] {
