...
object libComponentsPoseElementTypesMod {
  ...
  object ChildRegistration {
    ...
    inline def apply(element: Element, onRegistered: DomPopmotionPoser => Callback, poseConfig: DomPopmotionConfig): ChildRegistration = {
      val __obj = js.Dynamic.literal(element = element.asInstanceOf[js.Any], onRegistered = js.Any.fromFunction1((t0: DomPopmotionPoser) => onRegistered(t0).runNow()), poseConfig = poseConfig.asInstanceOf[js.Any])
    ...
    extension [Self <: ChildRegistration](x: Self) {
      ...
      inline def setOnRegistered(value: DomPopmotionPoser => Callback): Self = StObject.set(x, "onRegistered", js.Any.fromFunction1((t0: DomPopmotionPoser) => value(t0).runNow()))
  ...
  object PoseContextProps {
    ...
    extension [Self <: PoseContextProps](x: Self) {
      ...
      inline def setGetInitialPoseFromParent(value: CallbackTo[CurrentPose | Unit]): Self = StObject.set(x, "getInitialPoseFromParent", value.toJsFn)
      
      inline def setGetInitialPoseFromParentUndefined: Self = StObject.set(x, "getInitialPoseFromParent", js.undefined)
      
      inline def setGetParentPoseConfig(value: CallbackTo[DomPopmotionConfig]): Self = StObject.set(x, "getParentPoseConfig", value.toJsFn)
      ...
      inline def setRegisterChild(value: /* props */ ChildRegistration => Callback): Self = StObject.set(x, "registerChild", js.Any.fromFunction1((t0: /* props */ ChildRegistration) => value(t0).runNow()))
