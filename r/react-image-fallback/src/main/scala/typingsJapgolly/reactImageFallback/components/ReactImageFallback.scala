...
object ReactImageFallback {
  ...
  typingsJapgolly.reactImageFallback.mod.ReactImageFallbackProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  ...
  typingsJapgolly.reactImageFallback.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactImageFallback.mod.ReactImageFallbackProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.ImgHTMLAttributes[org.scalajs.dom.raw.HTMLImageElement], 
