package typingsJapgolly.reactImageFallback.components
...
import typingsJapgolly.reactImageFallback.mod.ReactImageFallbackProps
import typingsJapgolly.reactImageFallback.mod.default
...
object ReactImageFallback {
  ...
  inline def apply(fallbackImage: String | Element | (js.Array[js.UndefOr[Element | String]])): Builder = {
    val __props = js.Dynamic.literal(fallbackImage = fallbackImage.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[ReactImageFallbackProps & (DetailedHTMLProps[ImgHTMLAttributes[HTMLImageElement], HTMLImageElement])]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def initialImage(value: String | Element): this.type = set("initialImage", value.asInstanceOf[js.Any])
    
    inline def initialImageVdomElement(value: VdomElement): this.type = set("initialImage", value.rawElement.asInstanceOf[js.Any])
    
    inline def initialTimeout(value: Double): this.type = set("initialTimeout", value.asInstanceOf[js.Any])
  ...
  def withProps(
    p: ReactImageFallbackProps & (DetailedHTMLProps[ImgHTMLAttributes[HTMLImageElement], HTMLImageElement])
