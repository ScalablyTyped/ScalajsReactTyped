package typingsJapgolly.reactMdExpansionPanel.components
...
object ExpansionPanel {
  ...
  inline def apply(
    ...
    val __props = js.Dynamic.literal(expanded = expanded.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], onExpandClick = js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement & Element]) => onExpandClick(t0).runNow()))
    new Builder(js.Array(this.component, __props.asInstanceOf[ExpansionPanelProps & RefAttributes[HTMLDivElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def customHeader(value: VdomNode): this.type = set("customHeader", value.rawNode.asInstanceOf[js.Any])
    
    inline def customHeaderNull: this.type = set("customHeader", null)
    
    inline def customHeaderVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("customHeader", js.Array(value*))
    
    inline def customHeaderVdomElement(value: VdomElement): this.type = set("customHeader", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def disableParagraphMargin(value: Boolean): this.type = set("disableParagraphMargin", value.asInstanceOf[js.Any])
    
    inline def disableSecondaryColor(value: Boolean): this.type = set("disableSecondaryColor", value.asInstanceOf[js.Any])
    ...
    inline def expanderIcon(value: VdomNode): this.type = set("expanderIcon", value.rawNode.asInstanceOf[js.Any])
    
    inline def expanderIconNull: this.type = set("expanderIcon", null)
    
    inline def expanderIconVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("expanderIcon", js.Array(value*))
    
    inline def expanderIconVdomElement(value: VdomElement): this.type = set("expanderIcon", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def headerRef(value: Ref[HTMLButtonElement]): this.type = set("headerRef", value.asInstanceOf[js.Any])
    
    inline def headerRefFunction1(value: HTMLButtonElement | Null => Callback): this.type = set("headerRef", js.Any.fromFunction1((t0: HTMLButtonElement | Null) => value(t0).runNow()))
    ...
    inline def headerVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("header", js.Array(value*))
    ...
    inline def marginTop(value: Boolean): this.type = set("marginTop", value.asInstanceOf[js.Any])
    ...
    inline def raiseable(value: Boolean): this.type = set("raiseable", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ExpansionPanelProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
