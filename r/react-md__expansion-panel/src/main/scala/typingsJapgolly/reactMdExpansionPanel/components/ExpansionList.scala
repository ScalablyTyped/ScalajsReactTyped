...
object ExpansionList {
  ...
  inline def apply(onKeyDown: ReactKeyboardEventFrom[HTMLDivElement & Element] => Callback): Builder = {
    val __props = js.Dynamic.literal(onKeyDown = js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLDivElement & Element]) => onKeyDown(t0).runNow()))
    new Builder(js.Array(this.component, __props.asInstanceOf[ExpansionListProps & RefAttributes[HTMLDivElement]]))
  }
  ...
  def withProps(p: ExpansionListProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
