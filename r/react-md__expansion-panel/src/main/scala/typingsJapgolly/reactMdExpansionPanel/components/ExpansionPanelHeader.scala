...
object ExpansionPanelHeader {
  ...
  inline def apply(
    ...
    val __props = js.Dynamic.literal(expanded = expanded.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], onClick = js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement & Element]) => onClick(t0).runNow()))
    new Builder(js.Array(this.component, __props.asInstanceOf[ExpansionPanelHeaderProps & RefAttributes[HTMLButtonElement]]))
  }
  ...
  def withProps(p: ExpansionPanelHeaderProps & RefAttributes[HTMLButtonElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
