...
object Link {
  def apply[S](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[LinkProps[S], typingsJapgolly.reactRouterGuard.mod.Link[S], Unit, LinkProps[S]] = {
  ...
  typingsJapgolly.reactRouterGuard.mod.Link[S]](this.componentImport)
