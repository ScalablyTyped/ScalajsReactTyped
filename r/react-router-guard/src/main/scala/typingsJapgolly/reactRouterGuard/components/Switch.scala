...
object Switch {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SwitchProps, typingsJapgolly.reactRouterGuard.mod.Switch, Unit, SwitchProps] = {
  ...
  typingsJapgolly.reactRouterGuard.mod.Switch](this.componentImport)
