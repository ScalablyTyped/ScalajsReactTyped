...
object Redirect {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RedirectProps, typingsJapgolly.reactRouterGuard.mod.Redirect, Unit, RedirectProps] = {
  ...
  typingsJapgolly.reactRouterGuard.mod.Redirect](this.componentImport)
