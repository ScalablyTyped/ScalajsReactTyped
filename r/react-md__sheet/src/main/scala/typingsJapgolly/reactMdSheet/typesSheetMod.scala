...
object typesSheetMod {
  ...
  object AllowedDialogProps {
    ...
    inline def apply(id: String, onRequestClose: Callback, visible: Boolean): AllowedDialogProps = {
    ...
    extension [Self <: AllowedDialogProps](x: Self) {
      ...
      inline def setUnmountFocusFallbackCallbackTo(value: CallbackTo[HTMLElement | Null]): Self = StObject.set(x, "unmountFocusFallback", value.toJsFn)
  ...
  object BaseSheetProps {
    ...
    inline def apply(id: String, onRequestClose: Callback, visible: Boolean): BaseSheetProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], onRequestClose = onRequestClose.toJsFn, visible = visible.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMdSheet.reactMdSheetStrings.none
    - typingsJapgolly.reactMdSheet.reactMdSheetStrings.media
    - typingsJapgolly.reactMdSheet.reactMdSheetStrings.touch
    - typingsJapgolly.reactMdSheet.reactMdSheetStrings.static
  */
  trait SheetHorizontalSize extends StObject
  object SheetHorizontalSize {
    
    inline def media: typingsJapgolly.reactMdSheet.reactMdSheetStrings.media = "media".asInstanceOf[typingsJapgolly.reactMdSheet.reactMdSheetStrings.media]
    
    inline def none: typingsJapgolly.reactMdSheet.reactMdSheetStrings.none = "none".asInstanceOf[typingsJapgolly.reactMdSheet.reactMdSheetStrings.none]
    
    inline def static: typingsJapgolly.reactMdSheet.reactMdSheetStrings.static = "static".asInstanceOf[typingsJapgolly.reactMdSheet.reactMdSheetStrings.static]
    
    inline def touch: typingsJapgolly.reactMdSheet.reactMdSheetStrings.touch = "touch".asInstanceOf[typingsJapgolly.reactMdSheet.reactMdSheetStrings.touch]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMdSheet.reactMdSheetStrings.top
    - typingsJapgolly.reactMdSheet.reactMdSheetStrings.right
    - typingsJapgolly.reactMdSheet.reactMdSheetStrings.bottom
    - typingsJapgolly.reactMdSheet.reactMdSheetStrings.left
  */
  trait SheetPosition extends StObject
  object SheetPosition {
    
    inline def bottom: typingsJapgolly.reactMdSheet.reactMdSheetStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.reactMdSheet.reactMdSheetStrings.bottom]
    
    inline def left: typingsJapgolly.reactMdSheet.reactMdSheetStrings.left = "left".asInstanceOf[typingsJapgolly.reactMdSheet.reactMdSheetStrings.left]
    
    inline def right: typingsJapgolly.reactMdSheet.reactMdSheetStrings.right = "right".asInstanceOf[typingsJapgolly.reactMdSheet.reactMdSheetStrings.right]
    
    inline def top: typingsJapgolly.reactMdSheet.reactMdSheetStrings.top = "top".asInstanceOf[typingsJapgolly.reactMdSheet.reactMdSheetStrings.top]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMdSheet.reactMdSheetStrings.none
    - typingsJapgolly.reactMdSheet.reactMdSheetStrings.touch
    - typingsJapgolly.reactMdSheet.reactMdSheetStrings.recommended
  */
  ...
  object SheetVerticalSize {
    ...
    inline def recommended: typingsJapgolly.reactMdSheet.reactMdSheetStrings.recommended = "recommended".asInstanceOf[typingsJapgolly.reactMdSheet.reactMdSheetStrings.recommended]
