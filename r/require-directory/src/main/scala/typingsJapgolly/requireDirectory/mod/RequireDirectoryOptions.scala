...
object RequireDirectoryOptions {
  ...
  def apply[T, U](
    ...
    rename: /* name */ String => CallbackTo[String] = null,
    visit: /* obj */ T => CallbackTo[U | Unit] = null
    ...
    if (rename != null) __obj.updateDynamic("rename")(js.Any.fromFunction1((t0: /* name */ java.lang.String) => rename(t0).runNow()))
    if (visit != null) __obj.updateDynamic("visit")(js.Any.fromFunction1((t0: /* obj */ T) => visit(t0).runNow()))
