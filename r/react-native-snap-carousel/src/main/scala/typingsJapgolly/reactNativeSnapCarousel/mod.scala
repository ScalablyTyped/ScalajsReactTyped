...
import typingsJapgolly.reactNativeSnapCarousel.anon.Index
...
object mod {
  ...
  trait AdditionalParallaxProps extends StObject {
    ...
    var carouselRef: js.UndefOr[
        japgolly.scalajs.react.facade.React.Component[FlatListProps[Any] & js.Object, js.Object]
      ] = js.undefined
  ...
  object AdditionalParallaxProps {
    ...
    extension [Self <: AdditionalParallaxProps](x: Self) {
      ...
      inline def setCarouselRef(value: japgolly.scalajs.react.facade.React.Component[FlatListProps[Any] & js.Object, js.Object]): Self = StObject.set(x, "carouselRef", value.asInstanceOf[js.Any])
  ...
  trait CarouselProps[T] extends StObject {
    ...
    /**
      ...
      */
    def renderItem(item: Index[T]): Node = js.native
    def renderItem(item: Index[T], parallaxProps: AdditionalParallaxProps): Node = js.native
  ...
  trait PaginationProperties
    ...
    var ref: js.UndefOr[LegacyRef[ComponentClassP[PaginationProps & js.Object]]] = js.undefined
  }
  object PaginationProperties {
    ...
    extension [Self <: PaginationProperties](x: Self) {
      ...
      inline def setRef(value: LegacyRef[ComponentClassP[PaginationProps & js.Object]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      inline def setRefFunction1(value: (ComponentClassP[PaginationProps & js.Object]) | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: (ComponentClassP[PaginationProps & js.Object]) | Null) => value(t0).runNow()))
  ...
  trait PaginationProps extends StObject {
    ...
    var renderDots: js.UndefOr[
        js.Function3[/* activeIndex */ Double, /* total */ Double, /* context */ Any, Node]
      ] = js.undefined
  ...
  object PaginationProps {
    ...
    extension [Self <: PaginationProps](x: Self) {
      ...
      inline def setDotElement(value: VdomNode): Self = StObject.set(x, "dotElement", value.rawNode.asInstanceOf[js.Any])
      
      inline def setDotElementNull: Self = StObject.set(x, "dotElement", null)
      
      inline def setDotElementUndefined: Self = StObject.set(x, "dotElement", js.undefined)
      
      inline def setDotElementVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "dotElement", js.Array(value*))
      
      inline def setDotElementVdomElement(value: VdomElement): Self = StObject.set(x, "dotElement", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setInactiveDotElement(value: VdomNode): Self = StObject.set(x, "inactiveDotElement", value.rawNode.asInstanceOf[js.Any])
      
      inline def setInactiveDotElementNull: Self = StObject.set(x, "inactiveDotElement", null)
      
      inline def setInactiveDotElementUndefined: Self = StObject.set(x, "inactiveDotElement", js.undefined)
      
      inline def setInactiveDotElementVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "inactiveDotElement", js.Array(value*))
      
      inline def setInactiveDotElementVdomElement(value: VdomElement): Self = StObject.set(x, "inactiveDotElement", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setRenderDots(value: (/* activeIndex */ Double, /* total */ Double, /* context */ Any) => Node): Self = StObject.set(x, "renderDots", js.Any.fromFunction3(value))
  ...
  type PaginationStatic = ComponentClassP[PaginationProps & js.Object]
  ...
  trait ParallaxImageProperties
    ...
    var ref: js.UndefOr[LegacyRef[ComponentClassP[ParallaxImageProps & js.Object]]] = js.undefined
  }
  object ParallaxImageProperties {
    ...
    extension [Self <: ParallaxImageProperties](x: Self) {
      ...
      inline def setRef(value: LegacyRef[ComponentClassP[ParallaxImageProps & js.Object]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      inline def setRefFunction1(value: (ComponentClassP[ParallaxImageProps & js.Object]) | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: (ComponentClassP[ParallaxImageProps & js.Object]) | Null) => value(t0).runNow()))
  ...
  type ParallaxImageStatic = ComponentClassP[ParallaxImageProps & js.Object]
}
