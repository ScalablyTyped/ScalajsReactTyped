...
import typingsJapgolly.reactNativeSnapCarousel.anon.Height
...
object ParallaxImage {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeSnapCarousel.mod.ParallaxImage] {
    ...
    inline def dimensions(value: Height): this.type = set("dimensions", value.asInstanceOf[js.Any])
    ...
    inline def parallaxFactor(value: Double): this.type = set("parallaxFactor", value.asInstanceOf[js.Any])
    ...
    inline def scrollPosition(value: Value): this.type = set("scrollPosition", value.asInstanceOf[js.Any])
    
    inline def showSpinner(value: Boolean): this.type = set("showSpinner", value.asInstanceOf[js.Any])
    ...
    inline def spinnerColor(value: String): this.type = set("spinnerColor", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ParallaxImage.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ParallaxImageProperties): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
