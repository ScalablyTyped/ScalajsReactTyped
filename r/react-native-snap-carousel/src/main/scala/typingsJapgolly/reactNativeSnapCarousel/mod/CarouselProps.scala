...
trait CarouselProps[T] extends Props[ScrollViewProps] {
  ...
  var layout: js.UndefOr[
    typingsJapgolly.reactNativeSnapCarousel.reactNativeSnapCarouselStrings.default | stack | tinder
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var onScroll: js.UndefOr[js.Function1[ReactEventFrom[NodeHandle with Element], Unit]] = js.native
  /**
  ...
  /**
    ...
    */
  def renderItem(item: AnonIndex[T]): Node = js.native
  def renderItem(item: AnonIndex[T], parallaxProps: AdditionalParallaxProps): Node = js.native
}
