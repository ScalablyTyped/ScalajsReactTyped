...
import typingsJapgolly.resemblejs.mod.Analysis
import typingsJapgolly.resemblejs.mod.ComparisonCallback
import typingsJapgolly.resemblejs.mod.ComparisonOptions
