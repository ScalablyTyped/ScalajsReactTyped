package typingsJapgolly.resemblejs

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import org.scalajs.dom.ImageData
import typingsJapgolly.node.bufferMod.global.Buffer
import typingsJapgolly.resemblejs.anon.Blue
import typingsJapgolly.resemblejs.anon.Height
...
object mod {
  ...
  object Comparison {
    ...
    inline def apply(
      ignoreAlpha: CallbackTo[Comparison],
      ignoreAntialiasing: CallbackTo[Comparison],
      ignoreColors: CallbackTo[Comparison],
      ignoreLess: CallbackTo[Comparison],
      ignoreNothing: CallbackTo[Comparison],
      onComplete: js.Function1[/* data */ ComparisonResult, Unit] => Comparison,
      outputSettings: OutputSettings_ => Comparison,
      repaint: CallbackTo[Comparison],
      scaleToSameSize: CallbackTo[Comparison],
      setCustomTolerance: Tolerance => Callback,
      setReturnEarlyThreshold: Double => Comparison,
      useOriginalSize: CallbackTo[Comparison]
    ): Comparison = {
      val __obj = js.Dynamic.literal(ignoreAlpha = ignoreAlpha.toJsFn, ignoreAntialiasing = ignoreAntialiasing.toJsFn, ignoreColors = ignoreColors.toJsFn, ignoreLess = ignoreLess.toJsFn, ignoreNothing = ignoreNothing.toJsFn, onComplete = js.Any.fromFunction1(onComplete), outputSettings = js.Any.fromFunction1(outputSettings), repaint = repaint.toJsFn, scaleToSameSize = scaleToSameSize.toJsFn, setCustomTolerance = js.Any.fromFunction1((t0: Tolerance) => setCustomTolerance(t0).runNow()), setReturnEarlyThreshold = js.Any.fromFunction1(setReturnEarlyThreshold), useOriginalSize = useOriginalSize.toJsFn)
      __obj.asInstanceOf[Comparison]
    }
    
    extension [Self <: Comparison](x: Self) {
      
      inline def setIgnoreAlpha(value: CallbackTo[Comparison]): Self = StObject.set(x, "ignoreAlpha", value.toJsFn)
      
      inline def setIgnoreAntialiasing(value: CallbackTo[Comparison]): Self = StObject.set(x, "ignoreAntialiasing", value.toJsFn)
      
      inline def setIgnoreColors(value: CallbackTo[Comparison]): Self = StObject.set(x, "ignoreColors", value.toJsFn)
      
      inline def setIgnoreLess(value: CallbackTo[Comparison]): Self = StObject.set(x, "ignoreLess", value.toJsFn)
      
      inline def setIgnoreNothing(value: CallbackTo[Comparison]): Self = StObject.set(x, "ignoreNothing", value.toJsFn)
      ...
      inline def setRepaint(value: CallbackTo[Comparison]): Self = StObject.set(x, "repaint", value.toJsFn)
      
      inline def setScaleToSameSize(value: CallbackTo[Comparison]): Self = StObject.set(x, "scaleToSameSize", value.toJsFn)
      
      inline def setSetCustomTolerance(value: Tolerance => Callback): Self = StObject.set(x, "setCustomTolerance", js.Any.fromFunction1((t0: Tolerance) => value(t0).runNow()))
      ...
      inline def setUseOriginalSize(value: CallbackTo[Comparison]): Self = StObject.set(x, "useOriginalSize", value.toJsFn)
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.resemblejs.resemblejsStrings.nothing
    - typingsJapgolly.resemblejs.resemblejsStrings.less
    - typingsJapgolly.resemblejs.resemblejsStrings.antialiasing
    - typingsJapgolly.resemblejs.resemblejsStrings.colors
    - typingsJapgolly.resemblejs.resemblejsStrings.alpha
  */
  trait ComparisonIgnoreOption extends StObject
  object ComparisonIgnoreOption {
    
    inline def alpha: typingsJapgolly.resemblejs.resemblejsStrings.alpha = "alpha".asInstanceOf[typingsJapgolly.resemblejs.resemblejsStrings.alpha]
    
    inline def antialiasing: typingsJapgolly.resemblejs.resemblejsStrings.antialiasing = "antialiasing".asInstanceOf[typingsJapgolly.resemblejs.resemblejsStrings.antialiasing]
    
    inline def colors: typingsJapgolly.resemblejs.resemblejsStrings.colors = "colors".asInstanceOf[typingsJapgolly.resemblejs.resemblejsStrings.colors]
    
    inline def less: typingsJapgolly.resemblejs.resemblejsStrings.less = "less".asInstanceOf[typingsJapgolly.resemblejs.resemblejsStrings.less]
    
    inline def nothing: typingsJapgolly.resemblejs.resemblejsStrings.nothing = "nothing".asInstanceOf[typingsJapgolly.resemblejs.resemblejsStrings.nothing]
  }
  ...
  object ComparisonResult {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(analysisTime = analysisTime.asInstanceOf[js.Any], diffBounds = diffBounds.asInstanceOf[js.Any], dimensionDifference = dimensionDifference.asInstanceOf[js.Any], getImageDataUrl = getImageDataUrl.toJsFn, isSameDimensions = isSameDimensions.asInstanceOf[js.Any], misMatchPercentage = misMatchPercentage.asInstanceOf[js.Any], rawMisMatchPercentage = rawMisMatchPercentage.asInstanceOf[js.Any])
    ...
    extension [Self <: ComparisonResult](x: Self) {
      ...
      inline def setGetImageDataUrl(value: CallbackTo[String]): Self = StObject.set(x, "getImageDataUrl", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.resemblejs.resemblejsStrings.flat
    - typingsJapgolly.resemblejs.resemblejsStrings.movement
    - typingsJapgolly.resemblejs.resemblejsStrings.flatDifferenceIntensity
    - typingsJapgolly.resemblejs.resemblejsStrings.movementDifferenceIntensity
    - typingsJapgolly.resemblejs.resemblejsStrings.diffOnly
  */
  trait OutputErrorType extends StObject
  object OutputErrorType {
    
    inline def diffOnly: typingsJapgolly.resemblejs.resemblejsStrings.diffOnly = "diffOnly".asInstanceOf[typingsJapgolly.resemblejs.resemblejsStrings.diffOnly]
    
    inline def flat: typingsJapgolly.resemblejs.resemblejsStrings.flat = "flat".asInstanceOf[typingsJapgolly.resemblejs.resemblejsStrings.flat]
    
    inline def flatDifferenceIntensity: typingsJapgolly.resemblejs.resemblejsStrings.flatDifferenceIntensity = "flatDifferenceIntensity".asInstanceOf[typingsJapgolly.resemblejs.resemblejsStrings.flatDifferenceIntensity]
    
    inline def movement: typingsJapgolly.resemblejs.resemblejsStrings.movement = "movement".asInstanceOf[typingsJapgolly.resemblejs.resemblejsStrings.movement]
    
    inline def movementDifferenceIntensity: typingsJapgolly.resemblejs.resemblejsStrings.movementDifferenceIntensity = "movementDifferenceIntensity".asInstanceOf[typingsJapgolly.resemblejs.resemblejsStrings.movementDifferenceIntensity]
  }
  ...
  object OutputSettings_ {
    ...
    extension [Self <: OutputSettings_](x: Self) {
      ...
      inline def setErrorPixel(
        value: (/* px */ js.Array[Double], /* offset */ Double, /* d1 */ Color, /* d2 */ Color) => Callback
      ): Self = StObject.set(x, "errorPixel", js.Any.fromFunction4((t0: /* px */ js.Array[Double], t1: /* offset */ Double, t2: /* d1 */ Color, t3: /* d2 */ Color) => (value(t0, t1, t2, t3)).runNow()))
