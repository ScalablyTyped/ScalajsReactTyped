...
import typingsJapgolly.raml1Parser.distParserAstDotcoreNamespaceResolverMod.NamespaceResolver
...
import typingsJapgolly.raml1Parser.distParserLowLevelASTMod.LineMapper
import typingsJapgolly.raml1Parser.distParserLowLevelASTMod.TextChangeCommand
...
object distParserJsyamlJsyaml2lowLevelMod {
  ...
  open class CompilationUnit protected ()
    ...
    /* CompleteClass */
    override def highLevel(): typingsJapgolly.raml1Parser.mod.IParseResult = js.native
  ...
  open class HTTPResolverImpl ()
    ...
    /**
      ...
      **/
    /* CompleteClass */
    override def getResource(url: String): typingsJapgolly.raml1Parser.distParserJsyamlResolversApiMod.Response = js.native
    ...
    /**
      ...
      **/
    /* CompleteClass */
    override def getResourceAsync(url: String): js.Promise[typingsJapgolly.raml1Parser.distParserJsyamlResolversApiMod.Response] = js.native
  ...
  object InsertionPointType extends StObject {
    ...
    /* 2 */ val END: typingsJapgolly.raml1Parser.distParserJsyamlJsyaml2lowLevelMod.InsertionPointType.END & Double = js.native
    
    @js.native
    sealed trait NONE
      extends StObject
         with InsertionPointType
    /* 0 */ val NONE: typingsJapgolly.raml1Parser.distParserJsyamlJsyaml2lowLevelMod.InsertionPointType.NONE & Double = js.native
    
    @js.native
    sealed trait POINT
      extends StObject
         with InsertionPointType
    /* 3 */ val POINT: typingsJapgolly.raml1Parser.distParserJsyamlJsyaml2lowLevelMod.InsertionPointType.POINT & Double = js.native
    
    @js.native
    sealed trait START
      extends StObject
         with InsertionPointType
    /* 1 */ val START: typingsJapgolly.raml1Parser.distParserJsyamlJsyaml2lowLevelMod.InsertionPointType.START & Double = js.native
  }
  ...
  object Kind {
    ...
    @js.native
    def SCALAR: typingsJapgolly.yamlAstParser.distSrcYamlASTMod.Kind = js.native
    inline def SCALAR_=(x: typingsJapgolly.yamlAstParser.distSrcYamlASTMod.Kind): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SCALAR")(x.asInstanceOf[js.Any])
  }
  ...
  type Response = typingsJapgolly.raml1Parser.distParserJsyamlResolversApiMod.Response
}
