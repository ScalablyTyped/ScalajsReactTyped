...
import typingsJapgolly.raml1Parser.distParserWrappedAstDefaultCalculatorMod.AttributeDefaultsCalculator
...
object distParserWrappedAstParserCoreMod {
  ...
  open class AttributeNodeImpl protected ()
    ...
    /* CompleteClass */
    override def meta(): typingsJapgolly.raml1Parser.distParserWrappedAstParserCoreApiMod.ValueMetadata = js.native
    ...
    /* CompleteClass */
    override def parent(): typingsJapgolly.raml1Parser.distParserWrappedAstParserCoreApiMod.BasicNode = js.native
    ...
    def toJSON(serializeOptions: typingsJapgolly.raml1Parser.distUtilJsonSerializerMod.SerializeOptions): Any = js.native
  ...
  open class BasicNodeImpl protected ()
    extends StObject
       with typingsJapgolly.raml1Parser.distParserHighLevelASTMod.BasicNode {
    /**
      * @hidden
      **/
  ...
  open class NodeMetadataImpl ()
    extends ValueMetadataImpl
       with typingsJapgolly.raml1Parser.distParserHighLevelASTMod.NodeMetadata {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def primitiveValuesMeta(): StringDictionary[typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ValueMetadata] = js.native
  ...
  open class ValueMetadataImpl ()
    extends StObject
       with typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ValueMetadata {
    def this(_insertedAsDefault: Boolean) = this()
    def this(_insertedAsDefault: Boolean, _calculated: Boolean) = this()
    def this(_insertedAsDefault: Unit, _calculated: Boolean) = this()
    def this(_insertedAsDefault: Boolean, _calculated: Boolean, _optional: Boolean) = this()
  ...
  type NodeMetadata = typingsJapgolly.raml1Parser.distParserHighLevelASTMod.NodeMetadata
  
  type RamlParserError = typingsJapgolly.raml1Parser.distParserHighLevelASTMod.RamlParserError
  
  type SerializeOptions = typingsJapgolly.raml1Parser.distParserHighLevelASTMod.SerializeOptions
  
  type ValueMetaData_ = typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ValueMetadata
