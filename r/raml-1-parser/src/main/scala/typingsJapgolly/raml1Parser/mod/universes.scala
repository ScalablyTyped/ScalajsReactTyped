...
import typingsJapgolly.raml1Parser.anon.AbstractSecurityScheme
import typingsJapgolly.raml1Parser.anon.Annotable
...
object universes {
  ...
  @JSImport("raml-1-parser", "universes")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("raml-1-parser", "universes.Universe08")
  @js.native
  ...
  @JSImport("raml-1-parser", "universes.Universe10")
  @js.native
