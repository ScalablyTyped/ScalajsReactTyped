...
object utils {
  ...
  open class PointOfViewValidationAcceptorImpl protected ()
    extends typingsJapgolly.raml1Parser.distUtilsMod.PointOfViewValidationAcceptorImpl {
    def this(
      errors: js.Array[ValidationIssue],
      primaryUnitRoot: typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IParseResult
    ) = this()
  }
  ...
  open class UnitLink protected ()
    extends typingsJapgolly.raml1Parser.distUtilsMod.UnitLink {
    def this(
      node: typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IParseResult,
      targetUnitRoot: typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IParseResult
    ) = this()
  }
  ...
  inline def genStructuredValue(
    ...
    pr: typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IProperty
  ...
  inline def getFragmentDefenitionName(node: typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IHighLevelNode): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getFragmentDefenitionName")(node.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  @js.native
  def updateType: js.Function1[
    /* node */ typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IHighLevelNode, 
    Unit
  ] = js.native
  inline def updateType_=(
    x: js.Function1[
      /* node */ typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IHighLevelNode, 
      Unit
    ]
  ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("updateType")(x.asInstanceOf[js.Any])
}
