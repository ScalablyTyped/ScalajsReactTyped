...
- typingsJapgolly.raml1Parser.distTypingsSpec1Dot0DatamodelMod.FileTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations. Inlined fileTypes, minLength, maxLength */ trait FileTypeFragment
  extends StObject
