...
import typingsJapgolly.raml1Parser.anon.Errors
...
import typingsJapgolly.raml1Parser.distParserAstDotcoreReferencePatcherLLMod.ReferencePatcher
import typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IHighLevelNode
import typingsJapgolly.raml1Parser.distParserHighLevelImplMod.OverlayMergeMode
...
object distParserAstDotcoreExpanderLLMod {
  ...
  open class ValueTransformer protected ()
    extends StObject
       with typingsJapgolly.raml1Parser.distParserAstDotcoreLowLevelASTProxyMod.ValueTransformer {
