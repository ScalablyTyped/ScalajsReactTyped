...
import typingsJapgolly.raml1Parser.anon.Entry
import typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IAttribute
import typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IEditableHighLevelNode
...
import typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IProperty
...
import typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IValueTypeDefinition
import typingsJapgolly.raml1Parser.distParserHighLevelASTMod.RamlParserError
import typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ValidationAcceptor
import typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ValidationIssue
...
import typingsJapgolly.raml1Parser.distUtilContentproviderMod.ContentProvider
import typingsJapgolly.ramlDefinitionSystem.mod.SourceProvider
import typingsJapgolly.ramlDefinitionSystem.mod.Universe
import typingsJapgolly.std.RegExpMatchArray
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distParserHighLevelImplMod {
  ...
  object OverlayMergeMode extends StObject {
    ...
    /* 1 */ val AGGREGATE: typingsJapgolly.raml1Parser.distParserHighLevelImplMod.OverlayMergeMode.AGGREGATE & Double = js.native
    
    @js.native
    sealed trait MERGE
      extends StObject
         with OverlayMergeMode
    /* 0 */ val MERGE: typingsJapgolly.raml1Parser.distParserHighLevelImplMod.OverlayMergeMode.MERGE & Double = js.native
  }
  ...
  inline def auxiliaryTypeForExample(node: IHighLevelNode): typingsJapgolly.ramlTypesystem.distSrcNominalInterfacesMod.ITypeDefinition = ^.asInstanceOf[js.Dynamic].applyDynamic("auxiliaryTypeForExample")(node.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ramlTypesystem.distSrcNominalInterfacesMod.ITypeDefinition]
  ...
  object ParseNode {
    ...
    inline def apply(
      ...
      children: CallbackTo[js.Array[ParseNode]],
      getMeta: String => Any,
      key: CallbackTo[String],
      kind: CallbackTo[Double],
      path: CallbackTo[String],
      value: CallbackTo[Any]
    ): ParseNode = {
      val __obj = js.Dynamic.literal(addMeta = js.Any.fromFunction2(addMeta), childWithKey = js.Any.fromFunction1(childWithKey), children = children.toJsFn, getMeta = js.Any.fromFunction1(getMeta), key = key.toJsFn, kind = kind.toJsFn, path = path.toJsFn, value = value.toJsFn)
    ...
    extension [Self <: ParseNode](x: Self) {
      ...
      inline def setChildren(value: CallbackTo[js.Array[ParseNode]]): Self = StObject.set(x, "children", value.toJsFn)
      ...
      inline def setKind(value: CallbackTo[Double]): Self = StObject.set(x, "kind", value.toJsFn)
