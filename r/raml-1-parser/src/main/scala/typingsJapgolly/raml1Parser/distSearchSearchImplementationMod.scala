...
import typingsJapgolly.ramlDefinitionSystem.mod.Property
...
object distSearchSearchImplementationMod {
  ...
  object LocationKind extends StObject {
    ...
    sealed trait ANNOTATION_COMPLETION
      extends StObject
         with LocationKind
    /* 5 */ val ANNOTATION_COMPLETION: typingsJapgolly.raml1Parser.distSearchSearchImplementationMod.LocationKind.ANNOTATION_COMPLETION & Double = js.native
    
    @js.native
    sealed trait DIRECTIVE_COMPLETION
      extends StObject
         with LocationKind
    /* 3 */ val DIRECTIVE_COMPLETION: typingsJapgolly.raml1Parser.distSearchSearchImplementationMod.LocationKind.DIRECTIVE_COMPLETION & Double = js.native
    
    @js.native
    sealed trait INCOMMENT
      extends StObject
         with LocationKind
    /* 7 */ val INCOMMENT: typingsJapgolly.raml1Parser.distSearchSearchImplementationMod.LocationKind.INCOMMENT & Double = js.native
    
    @js.native
    sealed trait KEY_COMPLETION
      extends StObject
         with LocationKind
    /* 1 */ val KEY_COMPLETION: typingsJapgolly.raml1Parser.distSearchSearchImplementationMod.LocationKind.KEY_COMPLETION & Double = js.native
    
    @js.native
    sealed trait PATH_COMPLETION
      extends StObject
         with LocationKind
    /* 2 */ val PATH_COMPLETION: typingsJapgolly.raml1Parser.distSearchSearchImplementationMod.LocationKind.PATH_COMPLETION & Double = js.native
    
    @js.native
    sealed trait SEQUENCE_KEY_COPLETION
      extends StObject
         with LocationKind
    /* 6 */ val SEQUENCE_KEY_COPLETION: typingsJapgolly.raml1Parser.distSearchSearchImplementationMod.LocationKind.SEQUENCE_KEY_COPLETION & Double = js.native
    
    @js.native
    sealed trait VALUE_COMPLETION
      extends StObject
         with LocationKind
    /* 0 */ val VALUE_COMPLETION: typingsJapgolly.raml1Parser.distSearchSearchImplementationMod.LocationKind.VALUE_COMPLETION & Double = js.native
    
    @js.native
    sealed trait VERSION_COMPLETION
      extends StObject
         with LocationKind
    /* 4 */ val VERSION_COMPLETION: typingsJapgolly.raml1Parser.distSearchSearchImplementationMod.LocationKind.VERSION_COMPLETION & Double = js.native
  }
  ...
  inline def findAllSubTypes(p: IProperty, n: IHighLevelNode): js.Array[typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ITypeDefinition] = (^.asInstanceOf[js.Dynamic].applyDynamic("findAllSubTypes")(p.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ITypeDefinition]]
  ...
  inline def nodesDeclaringType(range: typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ITypeDefinition, n: IHighLevelNode): js.Array[IHighLevelNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("nodesDeclaringType")(range.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[js.Array[IHighLevelNode]]
  ...
  inline def schemasWithName(
    ...
    backup: StringDictionary[typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ITypeDefinition]
  ): typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ITypeDefinition = (^.asInstanceOf[js.Dynamic].applyDynamic("schemasWithName")(tname.asInstanceOf[js.Any], parentNode.asInstanceOf[js.Any], backup.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ITypeDefinition]
  
  inline def subTypesWithLocals(
    range: typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ITypeDefinition,
    parentNode: IHighLevelNode
  ): js.Array[ITypeDefinition] = (^.asInstanceOf[js.Dynamic].applyDynamic("subTypesWithLocals")(range.asInstanceOf[js.Any], parentNode.asInstanceOf[js.Any])).asInstanceOf[js.Array[ITypeDefinition]]
  
  inline def subTypesWithName(
    tname: String,
    parentNode: IHighLevelNode,
    backup: StringDictionary[typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ITypeDefinition]
  ): typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ITypeDefinition = (^.asInstanceOf[js.Dynamic].applyDynamic("subTypesWithName")(tname.asInstanceOf[js.Any], parentNode.asInstanceOf[js.Any], backup.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ITypeDefinition]
  ...
  type ITypeDefinition = typingsJapgolly.raml1Parser.distParserHighLevelASTMod.ITypeDefinition
}
