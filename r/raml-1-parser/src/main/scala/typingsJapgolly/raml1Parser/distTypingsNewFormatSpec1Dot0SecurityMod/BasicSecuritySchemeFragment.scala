...
- typingsJapgolly.raml1Parser.distTypingsNewFormatSpec1Dot0SecurityMod.BasicSecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait BasicSecuritySchemeFragment
  extends StObject
  ...
  /**
    ...
    */
  var settings: js.UndefOr[BasicSecuritySettings10] = js.undefined
...
object BasicSecuritySchemeFragment {
  ...
  inline def apply(name: String, `type`: String): BasicSecuritySchemeFragment = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[BasicSecuritySchemeFragment]
  }
  
  extension [Self <: BasicSecuritySchemeFragment](x: Self) {
