...
- typingsJapgolly.raml1Parser.distTypingsNewFormatSpec1Dot0SecurityMod.SecuritySchemeBase10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, settings, sourceMap. Inlined name, description, describedBy, `type`
- typingsJapgolly.raml1Parser.distTypingsNewFormatSpec1Dot0SecurityMod.OAuth20SecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait OAuth20SecuritySchemeFragment
  extends StObject
  ...
  /**
    ...
    */
  var settings: js.UndefOr[OAuth20SecuritySettings10] = js.undefined
...
object OAuth20SecuritySchemeFragment {
  ...
  inline def apply(name: String, `type`: String): OAuth20SecuritySchemeFragment = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[OAuth20SecuritySchemeFragment]
  }
  
  extension [Self <: OAuth20SecuritySchemeFragment](x: Self) {
