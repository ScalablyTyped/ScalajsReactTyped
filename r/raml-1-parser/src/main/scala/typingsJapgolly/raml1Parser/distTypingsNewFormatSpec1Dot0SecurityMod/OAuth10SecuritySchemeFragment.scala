...
- typingsJapgolly.raml1Parser.distTypingsNewFormatSpec1Dot0SecurityMod.OAuth10SecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait OAuth10SecuritySchemeFragment
  extends StObject
