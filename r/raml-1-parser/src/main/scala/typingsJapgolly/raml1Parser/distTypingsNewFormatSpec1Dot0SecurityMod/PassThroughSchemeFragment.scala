...
- typingsJapgolly.raml1Parser.distTypingsNewFormatSpec1Dot0SecurityMod.PassThroughSecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait PassThroughSchemeFragment
  extends StObject
  ...
  /**
    ...
    */
  var settings: js.UndefOr[PassThroughSecuritySettings10] = js.undefined
...
object PassThroughSchemeFragment {
  ...
  inline def apply(name: String, `type`: String): PassThroughSchemeFragment = {
