...
- typingsJapgolly.raml1Parser.distTypingsNewFormatSpec1Dot0SecurityMod.DigestSecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait DigestSecuritySchemeFragment
  extends StObject
  ...
  /**
    ...
    */
  var settings: js.UndefOr[DigestSecuritySettings10] = js.undefined
...
object DigestSecuritySchemeFragment {
  ...
  inline def apply(name: String, `type`: String): DigestSecuritySchemeFragment = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[DigestSecuritySchemeFragment]
  }
  
  extension [Self <: DigestSecuritySchemeFragment](x: Self) {
