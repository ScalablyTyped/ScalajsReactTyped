...
- typingsJapgolly.raml1Parser.distTypingsNewFormatSpec1Dot0SecurityMod.CustomSecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait CustomSecuritySchemeFragment
  extends StObject
