...
object PropertiesAnnotationsNameString {
  ...
  inline def apply(name: java.lang.String, properties: AnnotationsNameString): PropertiesAnnotationsNameString = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], properties = properties.asInstanceOf[js.Any])
    __obj.asInstanceOf[PropertiesAnnotationsNameString]
  }
  
  extension [Self <: PropertiesAnnotationsNameString](x: Self) {
