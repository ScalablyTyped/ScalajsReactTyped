...
@JSImport("raml-1-parser/dist/parser/artifacts/raml08parser", "JSonSchemaStringImpl")
@js.native
open class JSonSchemaStringImpl protected () extends SchemaStringImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object JSonSchemaStringImpl {
