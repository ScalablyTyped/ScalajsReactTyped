...
@JSImport("raml-1-parser/dist/parser/artifacts/raml08parser", "DateTypeDeclarationImpl")
@js.native
open class DateTypeDeclarationImpl protected () extends ParameterImpl {
...
/* static members */
object DateTypeDeclarationImpl {
