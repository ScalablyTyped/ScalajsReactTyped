...
@JSImport("raml-1-parser/dist/parser/artifacts/raml08parser", "SchemaStringImpl")
@js.native
open class SchemaStringImpl protected () extends StringTypeImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object SchemaStringImpl {
