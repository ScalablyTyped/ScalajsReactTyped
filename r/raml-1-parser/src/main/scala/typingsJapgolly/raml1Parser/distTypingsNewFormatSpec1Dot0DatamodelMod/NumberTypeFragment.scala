...
- typingsJapgolly.raml1Parser.distTypingsNewFormatSpec1Dot0DatamodelMod.NumberTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined `enum`, minimum, maximum, format, multipleOf */ trait NumberTypeFragment
  extends StObject
