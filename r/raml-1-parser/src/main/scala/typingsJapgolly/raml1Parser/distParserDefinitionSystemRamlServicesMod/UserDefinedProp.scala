...
@JSImport("raml-1-parser/dist/parser/definition-system/ramlServices", "UserDefinedProp")
@js.native
...
object UserDefinedProp {
  ...
  @JSImport("raml-1-parser/dist/parser/definition-system/ramlServices", "UserDefinedProp.CLASS_IDENTIFIER")
  @js.native
