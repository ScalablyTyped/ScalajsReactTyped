...
open class NodeClass protected ()
  extends typingsJapgolly.ramlDefinitionSystem.mod.NodeClass {
  def this(_name: String, universe: typingsJapgolly.ramlDefinitionSystem.mod.Universe, path: String) = this()
  def this(
    _name: String,
