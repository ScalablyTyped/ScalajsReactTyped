...
import typingsJapgolly.raml1Parser.distParserDefinitionSystemRamlServicesMod.^
import typingsJapgolly.ramlDefinitionSystem.mod.IType
import typingsJapgolly.ramlDefinitionSystem.mod.UniverseProvider
...
inline def prop(
  name: String,
  desc: String,
  domain: typingsJapgolly.ramlDefinitionSystem.mod.NodeClass,
  range: IType
): typingsJapgolly.ramlDefinitionSystem.mod.Property = (^.asInstanceOf[js.Dynamic].applyDynamic("prop")(name.asInstanceOf[js.Any], desc.asInstanceOf[js.Any], domain.asInstanceOf[js.Any], range.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.ramlDefinitionSystem.mod.Property]
inline def prop(
  name: String,
  desc: String,
  domain: typingsJapgolly.ramlDefinitionSystem.mod.NodeClass,
  range: IType,
  custom: Boolean
): typingsJapgolly.ramlDefinitionSystem.mod.Property = (^.asInstanceOf[js.Dynamic].applyDynamic("prop")(name.asInstanceOf[js.Any], desc.asInstanceOf[js.Any], domain.asInstanceOf[js.Any], range.asInstanceOf[js.Any], custom.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.ramlDefinitionSystem.mod.Property]
