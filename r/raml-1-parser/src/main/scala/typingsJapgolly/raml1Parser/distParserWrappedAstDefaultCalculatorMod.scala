...
object distParserWrappedAstDefaultCalculatorMod {
  ...
  object InsertionKind extends StObject {
    ...
    sealed trait BY_DEFAULT
      extends StObject
         with InsertionKind
    /* 1 */ val BY_DEFAULT: typingsJapgolly.raml1Parser.distParserWrappedAstDefaultCalculatorMod.InsertionKind.BY_DEFAULT & Double = js.native
    
    @js.native
    sealed trait CALCULATED
      extends StObject
         with InsertionKind
    /* 0 */ val CALCULATED: typingsJapgolly.raml1Parser.distParserWrappedAstDefaultCalculatorMod.InsertionKind.CALCULATED & Double = js.native
  }
