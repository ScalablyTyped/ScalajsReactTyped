...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "UnionTypeDeclarationImpl")
@js.native
open class UnionTypeDeclarationImpl protected () extends TypeDeclarationImpl {
...
/* static members */
object UnionTypeDeclarationImpl {
