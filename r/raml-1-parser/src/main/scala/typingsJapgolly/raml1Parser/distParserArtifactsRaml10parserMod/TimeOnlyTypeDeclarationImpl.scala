...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "TimeOnlyTypeDeclarationImpl")
@js.native
open class TimeOnlyTypeDeclarationImpl protected () extends TypeDeclarationImpl {
...
/* static members */
object TimeOnlyTypeDeclarationImpl {
