...
import typingsJapgolly.raml1Parser.distParserArtifactsRaml10parserapiMod.PassThroughSecurityScheme
import typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IHighLevelNode
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "PassThroughSecuritySchemeImpl")
@js.native
open class PassThroughSecuritySchemeImpl protected ()
  extends AbstractSecuritySchemeImpl
     with PassThroughSecurityScheme {
...
/* static members */
object PassThroughSecuritySchemeImpl {
