...
import typingsJapgolly.raml1Parser.distParserArtifactsRaml10parserapiMod.DateTimeTypeDeclaration
import typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IHighLevelNode
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "DateTimeTypeDeclarationImpl")
@js.native
open class DateTimeTypeDeclarationImpl protected ()
  extends TypeDeclarationImpl
     with DateTimeTypeDeclaration {
...
/* static members */
object DateTimeTypeDeclarationImpl {
