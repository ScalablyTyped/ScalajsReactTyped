...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "TimeOnlyTypeImpl")
@js.native
open class TimeOnlyTypeImpl protected () extends ValueTypeImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object TimeOnlyTypeImpl {
