...
import typingsJapgolly.raml1Parser.distParserArtifactsRaml10parserapiMod.UsesDeclaration
import typingsJapgolly.raml1Parser.distParserHighLevelASTMod.IHighLevelNode
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "DocumentationItemImpl")
@js.native
open class DocumentationItemImpl protected ()
  extends AnnotableImpl
     with DocumentationItem {
