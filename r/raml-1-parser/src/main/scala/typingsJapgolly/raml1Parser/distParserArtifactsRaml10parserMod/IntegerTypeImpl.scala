...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "IntegerTypeImpl")
@js.native
open class IntegerTypeImpl protected () extends ValueTypeImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object IntegerTypeImpl {
