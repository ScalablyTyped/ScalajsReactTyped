...
import typingsJapgolly.raml1Parser.distParserArtifactsRaml10parserapiMod.NumberType
...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "NumberTypeImpl")
@js.native
