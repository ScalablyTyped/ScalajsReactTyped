...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "CustomSecuritySchemeImpl")
@js.native
open class CustomSecuritySchemeImpl protected () extends AbstractSecuritySchemeImpl {
...
/* static members */
object CustomSecuritySchemeImpl {
