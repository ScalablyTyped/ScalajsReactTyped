...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "ExtensionImpl")
@js.native
open class ExtensionImpl protected ()
  extends ApiImpl
     with Extension {
  ...
  /**
    ...
    * Set extends value
    **/
  def setExtends(param: String): this.type = js.native
