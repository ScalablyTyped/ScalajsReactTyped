...
import typingsJapgolly.raml1Parser.anon.ActionBody
import typingsJapgolly.raml1Parser.anon.ActionString
import typingsJapgolly.raml1Parser.anon.BodyHeaders
import typingsJapgolly.raml1Parser.anon.Delete
import typingsJapgolly.raml1Parser.anon.Get
import typingsJapgolly.raml1Parser.anon.OneOf
import typingsJapgolly.raml1Parser.anon.OneOfArray
import typingsJapgolly.raml1Parser.anon._empty
import typingsJapgolly.raml1Parser.distParserAstDotcoreExpanderLLMod.DefaultTransformer
...
import typingsJapgolly.raml1Parser.distParserAstDotcoreReferencePatcherMod.PatchMode
import typingsJapgolly.raml1Parser.distParserAstDotcoreReferencePatcherMod.PatchedReference
...
object distParserAstDotcoreReferencePatcherLLMod {
  ...
  object TransitionKind extends StObject {
    ...
    sealed trait ACTION
      extends StObject
         with TransitionKind
    /* 2 */ val ACTION: typingsJapgolly.raml1Parser.distParserAstDotcoreReferencePatcherLLMod.TransitionKind.ACTION & Double = js.native
    
    @js.native
    sealed trait BASIC
      extends StObject
         with TransitionKind
    /* 0 */ val BASIC: typingsJapgolly.raml1Parser.distParserAstDotcoreReferencePatcherLLMod.TransitionKind.BASIC & Double = js.native
    
    @js.native
    sealed trait MIXED
      extends StObject
         with TransitionKind
    /* 3 */ val MIXED: typingsJapgolly.raml1Parser.distParserAstDotcoreReferencePatcherLLMod.TransitionKind.MIXED & Double = js.native
    
    @js.native
    sealed trait ONE_OF
      extends StObject
         with TransitionKind
    /* 1 */ val ONE_OF: typingsJapgolly.raml1Parser.distParserAstDotcoreReferencePatcherLLMod.TransitionKind.ONE_OF & Double = js.native
  }
  ...
  object transitions {
    ...
    @js.native
    def Response: typingsJapgolly.raml1Parser.anon.String = js.native
    inline def Response_=(x: typingsJapgolly.raml1Parser.anon.String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Response")(x.asInstanceOf[js.Any])
    
    @JSImport("raml-1-parser/dist/parser/ast.core/referencePatcherLL", "transitions.SecuritySchemeReferences")
    @js.native
    def SecuritySchemeReferences: typingsJapgolly.raml1Parser.anon.Action = js.native
    inline def SecuritySchemeReferences_=(x: typingsJapgolly.raml1Parser.anon.Action): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SecuritySchemeReferences")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def TraitReferences: typingsJapgolly.raml1Parser.anon.Action = js.native
    inline def TraitReferences_=(x: typingsJapgolly.raml1Parser.anon.Action): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TraitReferences")(x.asInstanceOf[js.Any])
