...
import typingsJapgolly.raml1Parser.distParserWrappedAstParserCoreMod.TypeInstanceImpl
import typingsJapgolly.raml1Parser.distParserWrappedAstParserCoreMod.TypeInstancePropertyImpl
