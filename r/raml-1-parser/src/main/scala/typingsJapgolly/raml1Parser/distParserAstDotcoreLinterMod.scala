...
import typingsJapgolly.raml1Parser.distParserHighLevelImplMod.BasicASTNode
...
object distParserAstDotcoreLinterMod {
  ...
  inline def typeOfContainingTemplate(h: IParseResult): typingsJapgolly.ramlDefinitionSystem.mod.ITypeDefinition = ^.asInstanceOf[js.Dynamic].applyDynamic("typeOfContainingTemplate")(h.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ramlDefinitionSystem.mod.ITypeDefinition]
