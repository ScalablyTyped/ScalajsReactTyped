...
object mod {
  ...
  object SignatureCaptureProps {
    ...
    extension [Self <: SignatureCaptureProps](x: Self) {
      ...
      inline def setOnDragEvent(value: /* event */ Any => Callback): Self = StObject.set(x, "onDragEvent", js.Any.fromFunction1((t0: /* event */ Any) => value(t0).runNow()))
      
      inline def setOnDragEventUndefined: Self = StObject.set(x, "onDragEvent", js.undefined)
      
      inline def setOnSaveEvent(value: /* params */ SaveEventParams => Callback): Self = StObject.set(x, "onSaveEvent", js.Any.fromFunction1((t0: /* params */ SaveEventParams) => value(t0).runNow()))
