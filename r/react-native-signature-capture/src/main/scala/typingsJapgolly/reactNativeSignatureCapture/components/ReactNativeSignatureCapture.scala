package typingsJapgolly.reactNativeSignatureCapture.components
...
import typingsJapgolly.reactNativeSignatureCapture.mod.SaveEventParams
import typingsJapgolly.reactNativeSignatureCapture.mod.SignatureCaptureProps
import typingsJapgolly.reactNativeSignatureCapture.mod.default
...
object ReactNativeSignatureCapture {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onDragEvent(value: /* event */ Any => Callback): this.type = set("onDragEvent", js.Any.fromFunction1((t0: /* event */ Any) => value(t0).runNow()))
    ...
    inline def onSaveEvent(value: /* params */ SaveEventParams => Callback): this.type = set("onSaveEvent", js.Any.fromFunction1((t0: /* params */ SaveEventParams) => value(t0).runNow()))
    ...
    inline def saveImageFileInExtStorage(value: Boolean): this.type = set("saveImageFileInExtStorage", value.asInstanceOf[js.Any])
    ...
    inline def showNativeButtons(value: Boolean): this.type = set("showNativeButtons", value.asInstanceOf[js.Any])
    
    inline def showTitleLabel(value: Boolean): this.type = set("showTitleLabel", value.asInstanceOf[js.Any])
    ...
    inline def viewMode(value: portrait | landscape): this.type = set("viewMode", value.asInstanceOf[js.Any])
  }
