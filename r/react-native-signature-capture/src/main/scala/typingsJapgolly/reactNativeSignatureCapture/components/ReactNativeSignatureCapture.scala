...
object ReactNativeSignatureCapture {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SignatureCaptureProps, default, Unit, SignatureCaptureProps] = {
  ...
  typingsJapgolly.reactNativeSignatureCapture.mod.SignatureCaptureProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSignatureCapture.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSignatureCapture.mod.SignatureCaptureProps])(children: _*)
  }
