...
import typingsJapgolly.reactNativeCommunityCli.mod.Config_
...
object AnonDefault {
  ...
  def apply(
    ...
    parse: /* val */ String => CallbackTo[js.Any] = null
  ): AnonDefault = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    if (default != null) __obj.updateDynamic("default")(default.asInstanceOf[js.Any])
    if (description != null) __obj.updateDynamic("description")(description.asInstanceOf[js.Any])
    if (parse != null) __obj.updateDynamic("parse")(js.Any.fromFunction1((t0: /* val */ java.lang.String) => parse(t0).runNow()))
