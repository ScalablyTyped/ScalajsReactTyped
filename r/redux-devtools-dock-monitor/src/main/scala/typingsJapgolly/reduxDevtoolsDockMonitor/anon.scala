...
import typingsJapgolly.reduxDevtools.libCreateDevToolsMod.Monitor
import typingsJapgolly.reduxDevtoolsDockMonitor.libActionsMod.DockMonitorAction
import typingsJapgolly.reduxDevtoolsDockMonitor.libDockMonitorMod.DefaultProps
import typingsJapgolly.reduxDevtoolsDockMonitor.libDockMonitorMod.ExternalProps
...
object anon {
  ...
  trait ComponentClassExternalPro
    extends StObject
       with Instantiable1[
          ...
          Component[(ExternalProps[Any, Action[Any]]) & js.Object, js.Object]
        ]
       with Instantiable2[
          /* props */ ExternalProps[Any, Action[Any]], 
          /* context */ Any, 
  ...
  trait FunctionComponentExternal extends StObject {
    ...
    def apply(props: ExternalProps[Any, Action[Any]]): Element | Null = js.native
    def apply(props: ExternalProps[Any, Action[Any]], context: Any): Element | Null = js.native
