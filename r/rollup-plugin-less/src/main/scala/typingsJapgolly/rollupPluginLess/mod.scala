package typingsJapgolly.rollupPluginLess
...
object mod {
  ...
  trait Options extends StObject {
    ...
    var option: js.UndefOr[typingsJapgolly.less.Less.Options] = js.undefined
    
    var output: js.UndefOr[String | Boolean | js.Function0[String]] = js.undefined
    
    var plugins: js.UndefOr[js.Array[typingsJapgolly.less.Less.Plugin]] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOption(value: typingsJapgolly.less.Less.Options): Self = StObject.set(x, "option", value.asInstanceOf[js.Any])
      ...
      inline def setOutputCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "output", value.toJsFn)
      
      inline def setOutputUndefined: Self = StObject.set(x, "output", js.undefined)
      
      inline def setPlugins(value: js.Array[typingsJapgolly.less.Less.Plugin]): Self = StObject.set(x, "plugins", value.asInstanceOf[js.Any])
      
      inline def setPluginsUndefined: Self = StObject.set(x, "plugins", js.undefined)
      
      inline def setPluginsVarargs(value: typingsJapgolly.less.Less.Plugin*): Self = StObject.set(x, "plugins", js.Array(value*))
