...
import typingsJapgolly.std.Range
...
trait RangyRange extends Range {
  ...
  def setStartAndEnd(startNode: Node, startOffset: Double, endNode: typingsJapgolly.std.Node): js.Any = js.native
  def setStartAndEnd(startNode: Node, startOffset: Double, endNode: typingsJapgolly.std.Node, endOffset: Double): js.Any = js.native
