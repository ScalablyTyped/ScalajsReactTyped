...
object mod {
  ...
  /* private */ open class MersenneTwister19937 ()
    extends typingsJapgolly.randomJs.distEngineMersenneTwister19937Mod.MersenneTwister19937
  /* static members */
  object MersenneTwister19937 {
    ...
    /**
      ...
      */
    inline def autoSeed(): typingsJapgolly.randomJs.distEngineMersenneTwister19937Mod.MersenneTwister19937 = ^.asInstanceOf[js.Dynamic].applyDynamic("autoSeed")().asInstanceOf[typingsJapgolly.randomJs.distEngineMersenneTwister19937Mod.MersenneTwister19937]
    
    /**
      * Returns a MersenneTwister19937 seeded with an initial int32 value
      * @param initial the initial seed value
      */
    inline def seed(initial: Double): typingsJapgolly.randomJs.distEngineMersenneTwister19937Mod.MersenneTwister19937 = ^.asInstanceOf[js.Dynamic].applyDynamic("seed")(initial.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.randomJs.distEngineMersenneTwister19937Mod.MersenneTwister19937]
    
    /**
      * Returns a MersenneTwister19937 seeded with zero or more int32 values
      * @param source A series of int32 values
      */
    inline def seedWithArray(source: ArrayLike[Double]): typingsJapgolly.randomJs.distEngineMersenneTwister19937Mod.MersenneTwister19937 = ^.asInstanceOf[js.Dynamic].applyDynamic("seedWithArray")(source.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.randomJs.distEngineMersenneTwister19937Mod.MersenneTwister19937]
  }
  ...
  /**
    ...
    */
  open class Random ()
    extends typingsJapgolly.randomJs.distRandomMod.Random {
