...
object mod extends js.Object {
  ...
  class MersenneTwister19937 protected ()
    extends typingsJapgolly.randomJs.mersenneTwister19937Mod.MersenneTwister19937
  ...
  /**
    ...
    */
  class Random ()
    extends typingsJapgolly.randomJs.randomMod.Random {
  ...
  object MersenneTwister19937 extends js.Object {
    /**
      ...
      */
    def autoSeed(): typingsJapgolly.randomJs.mersenneTwister19937Mod.MersenneTwister19937 = js.native
    /**
      * Returns a MersenneTwister19937 seeded with an initial int32 value
      * @param initial the initial seed value
      */
    def seed(initial: Double): typingsJapgolly.randomJs.mersenneTwister19937Mod.MersenneTwister19937 = js.native
    /**
      * Returns a MersenneTwister19937 seeded with zero or more int32 values
      * @param source A series of int32 values
      */
    def seedWithArray(source: ArrayLike[Double]): typingsJapgolly.randomJs.mersenneTwister19937Mod.MersenneTwister19937 = js.native
  }
