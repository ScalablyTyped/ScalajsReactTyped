...
object mod {
  ...
  object HeaderProps {
    ...
    extension [Self <: HeaderProps](x: Self) {
      ...
      inline def setHeaderRef(value: Callback): Self = StObject.set(x, "headerRef", value.toJsFn)
  ...
  object ItemProps {
    ...
    extension [Self <: ItemProps](x: Self) {
      ...
      inline def setArrowIcon(value: VdomNode): Self = StObject.set(x, "arrowIcon", value.rawNode.asInstanceOf[js.Any])
      
      inline def setArrowIconNull: Self = StObject.set(x, "arrowIcon", null)
      
      inline def setArrowIconUndefined: Self = StObject.set(x, "arrowIcon", js.undefined)
      
      inline def setArrowIconVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "arrowIcon", js.Array(value*))
      
      inline def setArrowIconVdomElement(value: VdomElement): Self = StObject.set(x, "arrowIcon", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setItemRef(value: Callback): Self = StObject.set(x, "itemRef", value.toJsFn)
      ...
      inline def setRightSideContent(value: VdomNode): Self = StObject.set(x, "rightSideContent", value.rawNode.asInstanceOf[js.Any])
      
      inline def setRightSideContentNull: Self = StObject.set(x, "rightSideContent", null)
      
      inline def setRightSideContentUndefined: Self = StObject.set(x, "rightSideContent", js.undefined)
      
      inline def setRightSideContentVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "rightSideContent", js.Array(value*))
      
      inline def setRightSideContentVdomElement(value: VdomElement): Self = StObject.set(x, "rightSideContent", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setSwitchOnValueChange(value: Callback): Self = StObject.set(x, "switchOnValueChange", value.toJsFn)
  ...
  object SettingsList {
    ...
    type Header = japgolly.scalajs.react.facade.React.Component[HeaderProps & js.Object, js.Object]
    
    type Item = japgolly.scalajs.react.facade.React.Component[ItemProps & js.Object, js.Object]
  }
  type SettingsList = japgolly.scalajs.react.facade.React.Component[SettingsListProps & js.Object, js.Object]
