...
object mod {
  ...
  open class HelmetData protected () extends StObject {
    ...
    var context: typingsJapgolly.reactHelmetAsync.anon.Helmet = js.native
  }
  ...
  trait HelmetDatum extends StObject {
    ...
    def toComponent(): japgolly.scalajs.react.facade.React.Component[Any & js.Object, js.Object]
  }
  object HelmetDatum {
    
    inline def apply(toComponent: CallbackTo[japgolly.scalajs.react.facade.React.Component[Any & js.Object, js.Object]]): HelmetDatum = {
    ...
    extension [Self <: HelmetDatum](x: Self) {
      ...
      inline def setToComponent(value: CallbackTo[japgolly.scalajs.react.facade.React.Component[Any & js.Object, js.Object]]): Self = StObject.set(x, "toComponent", value.toJsFn)
    }
  }
