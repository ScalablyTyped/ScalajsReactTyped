...
import typingsJapgolly.reactNativeCanvas.anon.A
...
object mod {
  ...
  trait CanvasProps extends StObject {
    ...
    var ref: (js.Function1[/* canvas */ Canvas, Any]) | RefHandle[Canvas]
    
    var style: js.UndefOr[StyleProp[ViewStyle]] = js.undefined
  }
  object CanvasProps {
    
    inline def apply(ref: (js.Function1[/* canvas */ Canvas, Any]) | RefHandle[Canvas]): CanvasProps = {
    ...
    extension [Self <: CanvasProps](x: Self) {
      ...
      inline def setRef(value: (js.Function1[/* canvas */ Canvas, Any]) | RefHandle[Canvas]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
