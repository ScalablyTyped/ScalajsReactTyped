...
object esRateMod {
  ...
  trait Rate extends Component[RateProps, RateState, Any] {
    ...
    def onClick(event: ReactKeyboardEventFrom[Element], index: Double): Unit = js.native
    def onClick(event: ReactMouseEventFrom[Element], index: Double): Unit = js.native
    
    def onFocus(): Unit = js.native
    
    def onHover(event: ReactMouseEventFrom[HTMLDivElement], index: Double): Unit = js.native
    ...
    def saveRef(index: Double): js.Function1[/* node */ typingsJapgolly.rcRate.esStarMod.default, Unit] = js.native
    
    var stars: Record[String, typingsJapgolly.rcRate.esStarMod.default] = js.native
  }
  ...
  trait RateProps extends StObject {
    ...
    var character: js.UndefOr[Node | (js.Function1[/* props */ StarProps, Node])] = js.undefined
    
    var characterRender: js.UndefOr[
        js.Function2[
          /* origin */ japgolly.scalajs.react.facade.React.Element, 
          /* props */ StarProps, 
          Node
        ]
      ] = js.undefined
  ...
  object RateProps {
    ...
    extension [Self <: RateProps](x: Self) {
      ...
      inline def setCharacter(value: Node | (js.Function1[/* props */ StarProps, Node])): Self = StObject.set(x, "character", value.asInstanceOf[js.Any])
      
      inline def setCharacterFunction1(value: /* props */ StarProps => Node): Self = StObject.set(x, "character", js.Any.fromFunction1(value))
      
      inline def setCharacterNull: Self = StObject.set(x, "character", null)
      
      inline def setCharacterRender(value: (/* origin */ japgolly.scalajs.react.facade.React.Element, /* props */ StarProps) => Node): Self = StObject.set(x, "characterRender", js.Any.fromFunction2(value))
      ...
      inline def setCharacterVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "character", js.Array(value*))
      ...
      inline def setOnHoverChange(value: /* value */ Double => Callback): Self = StObject.set(x, "onHoverChange", js.Any.fromFunction1((t0: /* value */ Double) => value(t0).runNow()))
      
      inline def setOnHoverChangeUndefined: Self = StObject.set(x, "onHoverChange", js.undefined)
      
      inline def setOnKeyDown(value: ReactKeyboardEventFrom[HTMLUListElement & Element] => Callback): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLUListElement & Element]) => value(t0).runNow()))
