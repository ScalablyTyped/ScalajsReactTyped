package typingsJapgolly.reachAlert.components

import typingsJapgolly.StBuildingComponent.Default
import typingsJapgolly.reachAlert.mod.AlertProps
...
typingsJapgolly.reachAlert.mod.AlertProps & typingsJapgolly.reachPolymorphic.anon.As[typingsJapgolly.reachAlert.reachAlertStrings.div]] because: IArray(Could't extract props from typingsJapgolly.std.Omit[
/ * import warning: importer.ImportType#apply Failed type conversion: IntrinsicElementString extends react.react.ElementType<any> ? react.react.ComponentPropsWithRef<IntrinsicElementString> : never * / js.Any, 
...
object Alert {
  ...
  implicit def make(companion: Alert.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
