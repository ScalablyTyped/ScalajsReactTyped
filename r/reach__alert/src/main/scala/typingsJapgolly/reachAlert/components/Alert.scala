...
object Alert {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[AlertProps, LegacyRef[HTMLDivElement], Unit, AlertProps] = {
  ...
  typingsJapgolly.reachAlert.mod.AlertProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLDivElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reachAlert.mod.AlertProps])(children: _*)
  }
