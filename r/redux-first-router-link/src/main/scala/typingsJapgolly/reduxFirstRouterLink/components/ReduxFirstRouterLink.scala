...
object ReduxFirstRouterLink {
  ...
  typingsJapgolly.reduxFirstRouterLink.mod.LinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reduxFirstRouterLink.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reduxFirstRouterLink.mod.LinkProps])(children: _*)
  }
