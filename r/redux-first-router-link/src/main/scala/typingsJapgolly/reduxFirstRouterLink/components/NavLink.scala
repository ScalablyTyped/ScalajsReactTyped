...
object NavLink {
  def apply(
    ...
    is: String = null,
    isActive: (/* match */ Match[js.Object], /* location */ Location) => CallbackTo[Boolean] = null,
    itemID: String = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[NavLinkProps, typingsJapgolly.reduxFirstRouterLink.mod.NavLink, Unit, NavLinkProps] = {
    ...
    if (isActive != null) __obj.updateDynamic("isActive")(js.Any.fromFunction2((t0: /* match */ typingsJapgolly.reduxFirstRouterLink.mod.Match[js.Object], t1: /* location */ typingsJapgolly.reduxFirstRouter.mod.Location) => isActive(t0, t1).runNow()))
  ...
  typingsJapgolly.reduxFirstRouterLink.mod.NavLinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reduxFirstRouterLink.mod.NavLink](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reduxFirstRouterLink.mod.NavLinkProps])(children: _*)
  }
