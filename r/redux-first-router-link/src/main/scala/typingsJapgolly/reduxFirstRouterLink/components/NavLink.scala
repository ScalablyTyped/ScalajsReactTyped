package typingsJapgolly.reduxFirstRouterLink.components
...
import typingsJapgolly.reduxFirstRouterLink.mod.Match
import typingsJapgolly.reduxFirstRouterLink.mod.NavLinkProps
import typingsJapgolly.reduxFirstRouterLink.mod.To
...
object NavLink {
  ...
  inline def apply(to: To): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[NavLinkProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reduxFirstRouterLink.mod.NavLink] {
    ...
    inline def down(value: Boolean): this.type = set("down", value.asInstanceOf[js.Any])
    ...
    inline def isActive(value: (/* match */ Match[js.Object], /* location */ Location) => Boolean): this.type = set("isActive", js.Any.fromFunction2(value))
    ...
    inline def redirect(value: Boolean): this.type = set("redirect", value.asInstanceOf[js.Any])
    ...
    inline def shouldDispatch(value: Boolean): this.type = set("shouldDispatch", value.asInstanceOf[js.Any])
  ...
  def withProps(p: NavLinkProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
