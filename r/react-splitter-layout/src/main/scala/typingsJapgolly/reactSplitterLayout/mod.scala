...
object mod {
  ...
  object SplitterLayoutProps {
    ...
    extension [Self <: SplitterLayoutProps](x: Self) {
      ...
      inline def setOnSecondaryPaneSizeChange(value: /* value */ Double => Callback): Self = StObject.set(x, "onSecondaryPaneSizeChange", js.Any.fromFunction1((t0: /* value */ Double) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactSplitterLayout.reactSplitterLayoutInts.`0`
    - typingsJapgolly.reactSplitterLayout.reactSplitterLayoutInts.`1`
  */
  trait TPrimaryIndex extends StObject
  object TPrimaryIndex {
    
    inline def `0`: typingsJapgolly.reactSplitterLayout.reactSplitterLayoutInts.`0` = 0.asInstanceOf[typingsJapgolly.reactSplitterLayout.reactSplitterLayoutInts.`0`]
    
    inline def `1`: typingsJapgolly.reactSplitterLayout.reactSplitterLayoutInts.`1` = 1.asInstanceOf[typingsJapgolly.reactSplitterLayout.reactSplitterLayoutInts.`1`]
  }
}
