package typingsJapgolly.reactNativeStarRating
...
object mod {
  ...
  type StarRating = japgolly.scalajs.react.facade.React.Component[StarRatingProps & js.Object, js.Object]
  ...
  object StarRatingProps {
    ...
    extension [Self <: StarRatingProps](x: Self) {
      ...
      inline def setSelectedStar(value: /* rating */ Double => Callback): Self = StObject.set(x, "selectedStar", js.Any.fromFunction1((t0: /* rating */ Double) => value(t0).runNow()))
