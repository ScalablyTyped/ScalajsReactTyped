package typingsJapgolly.reactNativeDrawerLayout.components
...
import typingsJapgolly.reactNativeDrawerLayout.mod.DrawerLayoutProperties
import typingsJapgolly.reactNativeDrawerLayout.mod.DrawerLayoutSlideEvent
...
object ReactNativeDrawerLayout {
  ...
  inline def apply(drawerPosition: left | right, drawerWidth: Double, renderNavigationView: CallbackTo[Node]): Builder = {
    val __props = js.Dynamic.literal(drawerPosition = drawerPosition.asInstanceOf[js.Any], drawerWidth = drawerWidth.asInstanceOf[js.Any], renderNavigationView = renderNavigationView.toJsFn)
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def keyboardDismissMode(value: typingsJapgolly.reactNativeDrawerLayout.reactNativeDrawerLayoutStrings.none | `on-drag`): this.type = set("keyboardDismissMode", value.asInstanceOf[js.Any])
    ...
    inline def onDrawerSlide(value: /* event */ DrawerLayoutSlideEvent => Callback): this.type = set("onDrawerSlide", js.Any.fromFunction1((t0: /* event */ DrawerLayoutSlideEvent) => value(t0).runNow()))
    
    inline def onDrawerStateChanged(value: /* state */ String => Callback): this.type = set("onDrawerStateChanged", js.Any.fromFunction1((t0: /* state */ String) => value(t0).runNow()))
    ...
    inline def statusBarBackgroundColor(value: String): this.type = set("statusBarBackgroundColor", value.asInstanceOf[js.Any])
