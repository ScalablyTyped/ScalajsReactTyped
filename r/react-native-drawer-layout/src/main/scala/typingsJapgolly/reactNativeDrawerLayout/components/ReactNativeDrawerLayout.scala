...
object ReactNativeDrawerLayout {
  def apply(
    ...
    keyboardDismissMode: typingsJapgolly.reactNativeDrawerLayout.reactNativeDrawerLayoutStrings.none | `on-drag` = null,
  ...
  typingsJapgolly.reactNativeDrawerLayout.mod.DrawerLayoutProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeDrawerLayout.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeDrawerLayout.mod.DrawerLayoutProperties])(children: _*)
  }
