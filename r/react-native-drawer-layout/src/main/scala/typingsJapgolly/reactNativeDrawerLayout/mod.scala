...
import typingsJapgolly.reactNativeDrawerLayout.anon.Left
import typingsJapgolly.reactNativeDrawerLayout.anon.Offset
...
object mod {
  ...
  object DrawerLayoutProperties {
    ...
    inline def apply(drawerPosition: left | right, drawerWidth: Double, renderNavigationView: CallbackTo[Node]): DrawerLayoutProperties = {
      val __obj = js.Dynamic.literal(drawerPosition = drawerPosition.asInstanceOf[js.Any], drawerWidth = drawerWidth.asInstanceOf[js.Any], renderNavigationView = renderNavigationView.toJsFn)
    ...
    extension [Self <: DrawerLayoutProperties](x: Self) {
      ...
      inline def setOnDrawerSlide(value: /* event */ DrawerLayoutSlideEvent => Callback): Self = StObject.set(x, "onDrawerSlide", js.Any.fromFunction1((t0: /* event */ DrawerLayoutSlideEvent) => value(t0).runNow()))
      
      inline def setOnDrawerSlideUndefined: Self = StObject.set(x, "onDrawerSlide", js.undefined)
      
      inline def setOnDrawerStateChanged(value: /* state */ String => Callback): Self = StObject.set(x, "onDrawerStateChanged", js.Any.fromFunction1((t0: /* state */ String) => value(t0).runNow()))
      
      inline def setOnDrawerStateChangedUndefined: Self = StObject.set(x, "onDrawerStateChanged", js.undefined)
      
      inline def setRenderNavigationView(value: CallbackTo[Node]): Self = StObject.set(x, "renderNavigationView", value.toJsFn)
