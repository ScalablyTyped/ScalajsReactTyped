package typingsJapgolly.reactImageMagnifiers
...
object mod {
  ...
  trait CommonProps extends StObject {
    ...
    var onImageLoad: js.UndefOr[js.Function1[/* ev */ ReactEventFrom[Element], Unit]] = js.undefined
    
    var onLargeImageLoad: js.UndefOr[js.Function1[/* ev */ ReactEventFrom[Element], Unit]] = js.undefined
    
    var onZoomEnd: js.UndefOr[js.Function0[Unit]] = js.undefined
    
    var onZoomStart: js.UndefOr[js.Function0[Unit]] = js.undefined
    
    var renderOverlay: js.UndefOr[js.Function1[/* state */ Boolean, Node]] = js.undefined
  ...
  object CommonProps {
    ...
    extension [Self <: CommonProps](x: Self) {
      ...
      inline def setOnImageLoad(value: /* ev */ ReactEventFrom[Element] => Callback): Self = StObject.set(x, "onImageLoad", js.Any.fromFunction1((t0: /* ev */ ReactEventFrom[Element]) => value(t0).runNow()))
      
      inline def setOnImageLoadUndefined: Self = StObject.set(x, "onImageLoad", js.undefined)
      
      inline def setOnLargeImageLoad(value: /* ev */ ReactEventFrom[Element] => Callback): Self = StObject.set(x, "onLargeImageLoad", js.Any.fromFunction1((t0: /* ev */ ReactEventFrom[Element]) => value(t0).runNow()))
      
      inline def setOnLargeImageLoadUndefined: Self = StObject.set(x, "onLargeImageLoad", js.undefined)
      
      inline def setOnZoomEnd(value: Callback): Self = StObject.set(x, "onZoomEnd", value.toJsFn)
      
      inline def setOnZoomEndUndefined: Self = StObject.set(x, "onZoomEnd", js.undefined)
      
      inline def setOnZoomStart(value: Callback): Self = StObject.set(x, "onZoomStart", value.toJsFn)
      
      inline def setOnZoomStartUndefined: Self = StObject.set(x, "onZoomStart", js.undefined)
      
      inline def setRenderOverlay(value: /* state */ Boolean => Node): Self = StObject.set(x, "renderOverlay", js.Any.fromFunction1(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.click
    - typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.doubleClick
  */
  trait MouseActivation extends StObject
  object MouseActivation {
    
    inline def click: typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.click = "click".asInstanceOf[typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.click]
    
    inline def doubleClick: typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.doubleClick = "doubleClick".asInstanceOf[typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.doubleClick]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.tap
    - typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.doubleTap
    - typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.longTouch
  */
  trait TouchActivation extends StObject
  object TouchActivation {
    
    inline def doubleTap: typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.doubleTap = "doubleTap".asInstanceOf[typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.doubleTap]
    
    inline def longTouch: typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.longTouch = "longTouch".asInstanceOf[typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.longTouch]
    
    inline def tap: typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.tap = "tap".asInstanceOf[typingsJapgolly.reactImageMagnifiers.reactImageMagnifiersStrings.tap]
  }
}
