package typingsJapgolly.reactNativeWindowsFs.anon
...
import typingsJapgolly.reactNativeWindowsFs.reactNativeWindowsFsStrings.buffer
...
trait Typeoffs extends StObject {
  ...
  var Dir: Instantiable0[typingsJapgolly.gracefulFs.mod.Dir] = js.native
  
  var Dirent: Instantiable0[typingsJapgolly.gracefulFs.mod.Dirent] = js.native
  
  var ReadStream: Instantiable0[typingsJapgolly.gracefulFs.mod.ReadStream] = js.native
  
  var Stats: Instantiable0[typingsJapgolly.gracefulFs.mod.Stats] = js.native
  
  var WriteStream: Instantiable0[typingsJapgolly.gracefulFs.mod.WriteStream] = js.native
