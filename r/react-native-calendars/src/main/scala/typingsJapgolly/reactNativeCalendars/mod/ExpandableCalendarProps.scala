...
object ExpandableCalendarProps {
  ...
  extension [Self <: ExpandableCalendarProps](x: Self) {
    ...
    inline def setOnCalendarToggled(value: /* isOpen */ Boolean => Callback): Self = StObject.set(x, "onCalendarToggled", js.Any.fromFunction1((t0: /* isOpen */ Boolean) => value(t0).runNow()))
