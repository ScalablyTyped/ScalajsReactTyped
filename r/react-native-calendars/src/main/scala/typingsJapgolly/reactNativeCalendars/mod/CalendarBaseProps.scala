...
trait CalendarBaseProps extends StObject {
  ...
  /**
    ...
    */
  var customHeader: js.UndefOr[js.Function1[/* props */ HeaderComponentProps, Node]] = js.undefined
  
  /**
    *  Provide custom day rendering component.
    */
  var dayComponent: js.UndefOr[(Component[DayComponentProps & js.Object, js.Object]) | FC[DayComponentProps]] = js.undefined
...
object CalendarBaseProps {
  ...
  extension [Self <: CalendarBaseProps](x: Self) {
    ...
    inline def setCustomHeader(value: /* props */ HeaderComponentProps => Node): Self = StObject.set(x, "customHeader", js.Any.fromFunction1(value))
    
    inline def setCustomHeaderUndefined: Self = StObject.set(x, "customHeader", js.undefined)
    
    inline def setDayComponent(value: (Component[DayComponentProps & js.Object, js.Object]) | FC[DayComponentProps]): Self = StObject.set(x, "dayComponent", value.asInstanceOf[js.Any])
    ...
    inline def setOnDayLongPress(value: /* date */ DateObject => Callback): Self = StObject.set(x, "onDayLongPress", js.Any.fromFunction1((t0: /* date */ DateObject) => value(t0).runNow()))
    ...
    inline def setOnMonthChange(value: /* date */ DateObject => Callback): Self = StObject.set(x, "onMonthChange", js.Any.fromFunction1((t0: /* date */ DateObject) => value(t0).runNow()))
    
    inline def setOnMonthChangeUndefined: Self = StObject.set(x, "onMonthChange", js.undefined)
    
    inline def setOnPressArrowLeft(value: /* substractMonth */ js.Function0[Unit] => Callback): Self = StObject.set(x, "onPressArrowLeft", js.Any.fromFunction1((t0: /* substractMonth */ js.Function0[Unit]) => value(t0).runNow()))
    ...
    inline def setOnVisibleMonthsChange(value: /* months */ js.Array[DateObject] => Callback): Self = StObject.set(x, "onVisibleMonthsChange", js.Any.fromFunction1((t0: /* months */ js.Array[DateObject]) => value(t0).runNow()))
