package typingsJapgolly.reactAddonsCssTransitionGroup
...
object mod extends Shortcut {
  ...
  open class Class protected ()
    extends Component[CSSTransitionGroupProps, js.Object, Any] {
    def this(props: CSSTransitionGroupProps) = this()
    def this(props: CSSTransitionGroupProps, context: Any) = this()
  }
  
  type ReactCSSTransitionGroup = ComponentClassP[CSSTransitionGroupProps & js.Object]
