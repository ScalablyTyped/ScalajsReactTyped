...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setAfterToggle(value: (/* trigger */ Element, /* element */ Element, /* expanded */ Boolean) => Callback): Self = StObject.set(x, "afterToggle", js.Any.fromFunction3((t0: /* trigger */ Element, t1: /* element */ Element, t2: /* expanded */ Boolean) => (value(t0, t1, t2)).runNow()))
      
      inline def setAfterToggleUndefined: Self = StObject.set(x, "afterToggle", js.undefined)
      
      inline def setBeforeToggle(value: (/* trigger */ Element, /* element */ Element, /* expanded */ Boolean) => Callback): Self = StObject.set(x, "beforeToggle", js.Any.fromFunction3((t0: /* trigger */ Element, t1: /* element */ Element, t2: /* expanded */ Boolean) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setBlockProcessed(value: (/* element */ Element, /* collapsable */ Boolean) => Callback): Self = StObject.set(x, "blockProcessed", js.Any.fromFunction2((t0: /* element */ Element, t1: /* collapsable */ Boolean) => (value(t0, t1)).runNow()))
  ...
  trait Readmore extends StObject {
    ...
    def toggle(element: NodeList[Node]): Unit = js.native
  }
}
