...
import typingsJapgolly.resumablejs.resumablejsStrings.DELETE
import typingsJapgolly.resumablejs.resumablejsStrings.GET
import typingsJapgolly.resumablejs.resumablejsStrings.OPTIONS
import typingsJapgolly.resumablejs.resumablejsStrings.POST
import typingsJapgolly.resumablejs.resumablejsStrings.PUT
...
import typingsJapgolly.resumablejs.resumablejsStrings.multipart
import typingsJapgolly.resumablejs.resumablejsStrings.octet
...
object Resumable {
  ...
  object ConfigurationHash {
    ...
    extension [Self <: ConfigurationHash](x: Self) {
      ...
      inline def setFileTypeErrorCallback(value: (/* file */ Any, /* errorCount */ Any) => Callback): Self = StObject.set(x, "fileTypeErrorCallback", js.Any.fromFunction2((t0: /* file */ Any, t1: /* errorCount */ Any) => (value(t0, t1)).runNow()))
      ...
      inline def setGenerateUniqueIdentifier(value: CallbackTo[String]): Self = StObject.set(x, "generateUniqueIdentifier", value.toJsFn)
      ...
      inline def setMaxFileSizeErrorCallback(value: (/* file */ Any, /* errorCount */ Any) => Callback): Self = StObject.set(x, "maxFileSizeErrorCallback", js.Any.fromFunction2((t0: /* file */ Any, t1: /* errorCount */ Any) => (value(t0, t1)).runNow()))
      ...
      inline def setMaxFilesErrorCallback(value: (/* files */ Any, /* errorCount */ Any) => Callback): Self = StObject.set(x, "maxFilesErrorCallback", js.Any.fromFunction2((t0: /* files */ Any, t1: /* errorCount */ Any) => (value(t0, t1)).runNow()))
      ...
      inline def setMinFileSizeErrorCallback(value: (/* file */ Any, /* errorCount */ Any) => Callback): Self = StObject.set(x, "minFileSizeErrorCallback", js.Any.fromFunction2((t0: /* file */ Any, t1: /* errorCount */ Any) => (value(t0, t1)).runNow()))
  ...
  object ResumableFile {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(abort = abort.toJsFn, bootstrap = bootstrap.toJsFn, cancel = cancel.toJsFn, chunks = chunks.asInstanceOf[js.Any], file = file.asInstanceOf[js.Any], fileName = fileName.asInstanceOf[js.Any], isComplete = isComplete.toJsFn, isUploading = isUploading.toJsFn, progress = js.Any.fromFunction1(progress), relativePath = relativePath.asInstanceOf[js.Any], resumableObj = resumableObj.asInstanceOf[js.Any], retry = retry.toJsFn, size = size.asInstanceOf[js.Any], uniqueIdentifier = uniqueIdentifier.asInstanceOf[js.Any])
    ...
    extension [Self <: ResumableFile](x: Self) {
      ...
      inline def setResumableObj(value: typingsJapgolly.resumablejs.Resumable.Resumable): Self = StObject.set(x, "resumableObj", value.asInstanceOf[js.Any])
