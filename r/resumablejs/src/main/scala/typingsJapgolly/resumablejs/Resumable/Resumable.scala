...
import typingsJapgolly.resumablejs.resumablejsStrings.beforeCancel
import typingsJapgolly.resumablejs.resumablejsStrings.cancel
import typingsJapgolly.resumablejs.resumablejsStrings.catchAll
import typingsJapgolly.resumablejs.resumablejsStrings.chunkingComplete
import typingsJapgolly.resumablejs.resumablejsStrings.chunkingProgress
import typingsJapgolly.resumablejs.resumablejsStrings.chunkingStart
import typingsJapgolly.resumablejs.resumablejsStrings.complete
import typingsJapgolly.resumablejs.resumablejsStrings.error
import typingsJapgolly.resumablejs.resumablejsStrings.fileAdded
import typingsJapgolly.resumablejs.resumablejsStrings.fileError
import typingsJapgolly.resumablejs.resumablejsStrings.fileProgress
import typingsJapgolly.resumablejs.resumablejsStrings.fileRetry
import typingsJapgolly.resumablejs.resumablejsStrings.fileSuccess
import typingsJapgolly.resumablejs.resumablejsStrings.filesAdded
import typingsJapgolly.resumablejs.resumablejsStrings.pause
import typingsJapgolly.resumablejs.resumablejsStrings.progress
import typingsJapgolly.resumablejs.resumablejsStrings.uploadStart
