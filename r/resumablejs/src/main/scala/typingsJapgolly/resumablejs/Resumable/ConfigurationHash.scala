...
object ConfigurationHash {
  ...
  def apply(
    ...
    fileTypeErrorCallback: (/* file */ js.Any, /* errorCount */ js.Any) => Callback = null,
    forceChunkSize: js.UndefOr[Boolean] = js.undefined,
    generateUniqueIdentifier: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    maxFileSizeErrorCallback: (/* file */ js.Any, /* errorCount */ js.Any) => Callback = null,
    maxFiles: Int | Double = null,
    maxFilesErrorCallback: (/* files */ js.Any, /* errorCount */ js.Any) => Callback = null,
    method: multipart | octet = null,
    minFileSize: js.UndefOr[Boolean] = js.undefined,
    minFileSizeErrorCallback: (/* file */ js.Any, /* errorCount */ js.Any) => Callback = null,
    parameterNamespace: String = null,
    preprocess: /* chunk */ ResumableChunk => CallbackTo[ResumableChunk] = null,
    ...
    if (fileTypeErrorCallback != null) __obj.updateDynamic("fileTypeErrorCallback")(js.Any.fromFunction2((t0: /* file */ js.Any, t1: /* errorCount */ js.Any) => fileTypeErrorCallback(t0, t1).runNow()))
    if (!js.isUndefined(forceChunkSize)) __obj.updateDynamic("forceChunkSize")(forceChunkSize.asInstanceOf[js.Any])
    generateUniqueIdentifier.foreach(p => __obj.updateDynamic("generateUniqueIdentifier")(p.toJsFn))
    ...
    if (maxFileSizeErrorCallback != null) __obj.updateDynamic("maxFileSizeErrorCallback")(js.Any.fromFunction2((t0: /* file */ js.Any, t1: /* errorCount */ js.Any) => maxFileSizeErrorCallback(t0, t1).runNow()))
    if (maxFiles != null) __obj.updateDynamic("maxFiles")(maxFiles.asInstanceOf[js.Any])
    if (maxFilesErrorCallback != null) __obj.updateDynamic("maxFilesErrorCallback")(js.Any.fromFunction2((t0: /* files */ js.Any, t1: /* errorCount */ js.Any) => maxFilesErrorCallback(t0, t1).runNow()))
    if (method != null) __obj.updateDynamic("method")(method.asInstanceOf[js.Any])
    if (!js.isUndefined(minFileSize)) __obj.updateDynamic("minFileSize")(minFileSize.asInstanceOf[js.Any])
    if (minFileSizeErrorCallback != null) __obj.updateDynamic("minFileSizeErrorCallback")(js.Any.fromFunction2((t0: /* file */ js.Any, t1: /* errorCount */ js.Any) => minFileSizeErrorCallback(t0, t1).runNow()))
    if (parameterNamespace != null) __obj.updateDynamic("parameterNamespace")(parameterNamespace.asInstanceOf[js.Any])
    if (preprocess != null) __obj.updateDynamic("preprocess")(js.Any.fromFunction1((t0: /* chunk */ typingsJapgolly.resumablejs.Resumable.ResumableChunk) => preprocess(t0).runNow()))
