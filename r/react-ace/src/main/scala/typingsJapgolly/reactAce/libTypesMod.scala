...
import typingsJapgolly.aceBuilds.mod.Ace.MarkerRenderer
import typingsJapgolly.aceBuilds.mod.Ace.Range
import typingsJapgolly.aceBuilds.mod.Ace.VirtualRenderer
import typingsJapgolly.reactAce.reactAceBooleans.`false`
import typingsJapgolly.reactAce.reactAceBooleans.`true`
import typingsJapgolly.reactAce.reactAceStrings.ace
import typingsJapgolly.reactAce.reactAceStrings.always
import typingsJapgolly.reactAce.reactAceStrings.error
import typingsJapgolly.reactAce.reactAceStrings.fullLine
import typingsJapgolly.reactAce.reactAceStrings.info
import typingsJapgolly.reactAce.reactAceStrings.line
import typingsJapgolly.reactAce.reactAceStrings.screenLine
import typingsJapgolly.reactAce.reactAceStrings.slim
import typingsJapgolly.reactAce.reactAceStrings.smooth
import typingsJapgolly.reactAce.reactAceStrings.text
import typingsJapgolly.reactAce.reactAceStrings.warning
import typingsJapgolly.reactAce.reactAceStrings.wide
...
object libTypesMod {
  ...
  object ICommandManager {
    ...
    inline def apply(
      addCommand: Any => Callback,
      addCommands: js.Array[Any] => Callback,
      byName: Any,
      commands: Any,
      exec: (String, Any, Any) => Callback,
      platform: String
    ): ICommandManager = {
      val __obj = js.Dynamic.literal(addCommand = js.Any.fromFunction1((t0: Any) => addCommand(t0).runNow()), addCommands = js.Any.fromFunction1((t0: js.Array[Any]) => addCommands(t0).runNow()), byName = byName.asInstanceOf[js.Any], commands = commands.asInstanceOf[js.Any], exec = js.Any.fromFunction3((t0: String, t1: Any, t2: Any) => (exec(t0, t1, t2)).runNow()), platform = platform.asInstanceOf[js.Any])
      __obj.asInstanceOf[ICommandManager]
    }
    
    extension [Self <: ICommandManager](x: Self) {
      
      inline def setAddCommand(value: Any => Callback): Self = StObject.set(x, "addCommand", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      
      inline def setAddCommands(value: js.Array[Any] => Callback): Self = StObject.set(x, "addCommands", js.Any.fromFunction1((t0: js.Array[Any]) => value(t0).runNow()))
      
      inline def setBindKey(value: (/* bindKey */ Any, /* command */ Any) => Callback): Self = StObject.set(x, "bindKey", js.Any.fromFunction2((t0: /* bindKey */ Any, t1: /* command */ Any) => (value(t0, t1)).runNow()))
      ...
      inline def setExec(value: (String, Any, Any) => Callback): Self = StObject.set(x, "exec", js.Any.fromFunction3((t0: String, t1: Any, t2: Any) => (value(t0, t1, t2)).runNow()))
  ...
  object IMarker {
    ...
    extension [Self <: IMarker](x: Self) {
      ...
      ): Self = StObject.set(x, "type", js.Any.fromFunction5((t0: /* html */ js.Array[String], t1: /* range */ Range, t2: /* left */ Double, t3: /* top */ Double, t4: /* config */ Any) => (value(t0, t1, t2, t3, t4)).runNow()))
    }
  }
