...
import typingsJapgolly.rrdtool.mod.ConsolidationFunction
import typingsJapgolly.rrdtool.mod.DataSourceType
import typingsJapgolly.rrdtool.mod.DataSourceType_
