...
import typingsJapgolly.reactMosaicComponent.libMosaicWindowMod.InternalMosaicWindowProps
...
object InternalMosaicWindow {
  ...
  open class Builder[T /* <: MosaicKey */] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMosaicComponent.libMosaicWindowMod.InternalMosaicWindow[T]] {
    ...
    inline def draggedMosaicId(value: String): this.type = set("draggedMosaicId", value.asInstanceOf[js.Any])
