...
object libContextTypesMod {
  ...
  trait MosaicWindowActions extends StObject {
    ...
    /**
      ...
      */
    def connectDragSource(connectedElements: Element): Element | Null
  ...
  object MosaicWindowActions {
    ...
    inline def apply(
      connectDragSource: Element => Element | Null,
      getPath: CallbackTo[MosaicPath],
      replaceWithNew: /* repeated */ Any => js.Promise[Unit],
      setAdditionalControlsOpen: Boolean => Callback,
      split: /* repeated */ Any => js.Promise[Unit]
    ): MosaicWindowActions = {
      val __obj = js.Dynamic.literal(connectDragSource = js.Any.fromFunction1(connectDragSource), getPath = getPath.toJsFn, replaceWithNew = js.Any.fromFunction1(replaceWithNew), setAdditionalControlsOpen = js.Any.fromFunction1((t0: Boolean) => setAdditionalControlsOpen(t0).runNow()), split = js.Any.fromFunction1(split))
      __obj.asInstanceOf[MosaicWindowActions]
    }
    
    extension [Self <: MosaicWindowActions](x: Self) {
      
      inline def setConnectDragSource(value: Element => Element | Null): Self = StObject.set(x, "connectDragSource", js.Any.fromFunction1(value))
      
      inline def setGetPath(value: CallbackTo[MosaicPath]): Self = StObject.set(x, "getPath", value.toJsFn)
      ...
      inline def setSetAdditionalControlsOpen(value: Boolean => Callback): Self = StObject.set(x, "setAdditionalControlsOpen", js.Any.fromFunction1((t0: Boolean) => value(t0).runNow()))
