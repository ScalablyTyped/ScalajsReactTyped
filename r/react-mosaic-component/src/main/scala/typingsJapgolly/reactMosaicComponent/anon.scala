...
object anon {
  ...
  object BlueprintNamespace {
    ...
    inline def apply(blueprintNamespace: String, className: String, onChange: Callback, zeroStateView: VdomElement): BlueprintNamespace = {
      val __obj = js.Dynamic.literal(blueprintNamespace = blueprintNamespace.asInstanceOf[js.Any], className = className.asInstanceOf[js.Any], onChange = onChange.toJsFn, zeroStateView = zeroStateView.rawElement.asInstanceOf[js.Any])
    ...
    extension [Self <: BlueprintNamespace](x: Self) {
      ...
      inline def setZeroStateView(value: VdomElement): Self = StObject.set(x, "zeroStateView", value.rawElement.asInstanceOf[js.Any])
    }
  }
  ...
  trait ClassName extends StObject {
    ...
    def onClick(event: ReactMouseEventFrom[Any & org.scalajs.dom.Element]): Any
  ...
  object ClassName {
    ...
    inline def apply(
      className: String,
      onClick: ReactMouseEventFrom[Any & org.scalajs.dom.Element] => Any,
      title: String
    ): ClassName = {
    ...
    extension [Self <: ClassName](x: Self) {
      ...
      inline def setOnClick(value: ReactMouseEventFrom[Any & org.scalajs.dom.Element] => Any): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
  ...
  object MinimumPaneSizePercentage {
    ...
    inline def apply(minimumPaneSizePercentage: Double, onChange: Callback, onRelease: Callback): MinimumPaneSizePercentage = {
      val __obj = js.Dynamic.literal(minimumPaneSizePercentage = minimumPaneSizePercentage.asInstanceOf[js.Any], onChange = onChange.toJsFn, onRelease = onRelease.toJsFn)
    ...
    extension [Self <: MinimumPaneSizePercentage](x: Self) {
      ...
      inline def setOnRelease(value: Callback): Self = StObject.set(x, "onRelease", value.toJsFn)
    }
  }
  ...
  object PartialInternalMosaicWind {
    ...
    extension [Self <: PartialInternalMosaicWind](x: Self) {
      ...
      inline def setToolbarControlsVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "toolbarControls", js.Array(value*))
