...
import typingsJapgolly.reactMosaicComponent.anon.MinimumPaneSizePercentage
import typingsJapgolly.reactMosaicComponent.libTypesMod.EnabledResizeOptions
...
object libSplitMod {
  ...
  object SplitProps {
    ...
    extension [Self <: SplitProps](x: Self) {
      ...
      inline def setOnChange(value: /* percentOfParent */ Double => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* percentOfParent */ Double) => value(t0).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnRelease(value: /* percentOfParent */ Double => Callback): Self = StObject.set(x, "onRelease", js.Any.fromFunction1((t0: /* percentOfParent */ Double) => value(t0).runNow()))
