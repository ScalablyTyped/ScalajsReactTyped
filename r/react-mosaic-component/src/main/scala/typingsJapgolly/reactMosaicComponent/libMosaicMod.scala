...
import typingsJapgolly.reactMosaicComponent.libTypesMod.TileRenderer
...
object libMosaicMod {
  ...
  object MosaicBaseProps {
    ...
    extension [Self <: MosaicBaseProps[?], T /* <: MosaicKey */](x: Self & MosaicBaseProps[T]) {
      ...
      inline def setOnChange(value: /* newNode */ MosaicNode[T] | Null => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* newNode */ MosaicNode[T] | Null) => value(t0).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnRelease(value: /* newNode */ MosaicNode[T] | Null => Callback): Self = StObject.set(x, "onRelease", js.Any.fromFunction1((t0: /* newNode */ MosaicNode[T] | Null) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMosaicComponent.libMosaicMod.MosaicControlledProps[T]
    - typingsJapgolly.reactMosaicComponent.libMosaicMod.MosaicUncontrolledProps[T]
  */
