...
import typingsJapgolly.immutabilityHelper.mod.Spec
...
object libTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMosaicComponent.reactMosaicComponentStrings.first
    - typingsJapgolly.reactMosaicComponent.reactMosaicComponentStrings.second
  */
  trait MosaicBranch extends StObject
  object MosaicBranch {
    
    inline def first: typingsJapgolly.reactMosaicComponent.reactMosaicComponentStrings.first = "first".asInstanceOf[typingsJapgolly.reactMosaicComponent.reactMosaicComponentStrings.first]
    
    inline def second: typingsJapgolly.reactMosaicComponent.reactMosaicComponentStrings.second = "second".asInstanceOf[typingsJapgolly.reactMosaicComponent.reactMosaicComponentStrings.second]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMosaicComponent.reactMosaicComponentStrings.row
    - typingsJapgolly.reactMosaicComponent.reactMosaicComponentStrings.column
  */
  trait MosaicDirection extends StObject
  object MosaicDirection {
    
    inline def column: typingsJapgolly.reactMosaicComponent.reactMosaicComponentStrings.column = "column".asInstanceOf[typingsJapgolly.reactMosaicComponent.reactMosaicComponentStrings.column]
    
    inline def row: typingsJapgolly.reactMosaicComponent.reactMosaicComponentStrings.row = "row".asInstanceOf[typingsJapgolly.reactMosaicComponent.reactMosaicComponentStrings.row]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMosaicComponent.reactMosaicComponentStrings.DISABLED
    - typingsJapgolly.reactMosaicComponent.libTypesMod.EnabledResizeOptions
  */
