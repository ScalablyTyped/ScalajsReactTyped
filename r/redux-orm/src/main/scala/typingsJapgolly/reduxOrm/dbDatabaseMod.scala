...
import typingsJapgolly.reduxOrm.modelMod.Serializable
import typingsJapgolly.reduxOrm.ormMod.IndexedModelClasses
import typingsJapgolly.reduxOrm.ormMod.OrmState
import typingsJapgolly.reduxOrm.sessionMod.BatchToken
...
object dbDatabaseMod {
  ...
  object Database {
    ...
    inline def apply[I /* <: IndexedModelClasses[
      ...
      getEmptyState: CallbackTo[OrmState[I]],
      query: (QuerySpec, OrmState[I]) => QueryResult[js.Object],
      update: (UpdateSpec[Any], Transaction, OrmState[I]) => UpdateResult[I, js.Object]
    ): Database[I, Tables] = {
      val __obj = js.Dynamic.literal(describe = js.Any.fromFunction1(describe), getEmptyState = getEmptyState.toJsFn, query = js.Any.fromFunction2(query), update = js.Any.fromFunction3(update))
    ...
    extension [Self <: Database[?, ?], I /* <: IndexedModelClasses[
      ...
      inline def setGetEmptyState(value: CallbackTo[OrmState[I]]): Self = StObject.set(x, "getEmptyState", value.toJsFn)
