...
import typingsJapgolly.reduxOrm.fieldsMod.AttrCreator
import typingsJapgolly.reduxOrm.fieldsMod.AttributeOpts
import typingsJapgolly.reduxOrm.fieldsMod.AttributeWithDefault
import typingsJapgolly.reduxOrm.fieldsMod.FieldSpecMap
import typingsJapgolly.reduxOrm.fieldsMod.FkCreator
import typingsJapgolly.reduxOrm.fieldsMod.ManyCreator
import typingsJapgolly.reduxOrm.fieldsMod.OneToOneCreator
import typingsJapgolly.reduxOrm.fieldsMod.RelationalFieldOpts
import typingsJapgolly.reduxOrm.helpersMod.OptionalKeys
import typingsJapgolly.reduxOrm.modelMod.AnyModel
import typingsJapgolly.reduxOrm.modelMod.CreateProps
import typingsJapgolly.reduxOrm.modelMod.FieldSpecKeys
import typingsJapgolly.reduxOrm.modelMod.IdKeyOpt
import typingsJapgolly.reduxOrm.modelMod.IdType
import typingsJapgolly.reduxOrm.modelMod.ModelClass
import typingsJapgolly.reduxOrm.modelMod.ModelFieldMap
import typingsJapgolly.reduxOrm.modelMod.ModelFields
...
import typingsJapgolly.reduxOrm.modelMod.UpsertProps
import typingsJapgolly.reduxOrm.ormMod.IndexedModelClasses
import typingsJapgolly.reduxOrm.ormMod.ORMOpts
...
import typingsJapgolly.reduxOrm.reduxMod.ORMReducer
import typingsJapgolly.reduxOrm.reduxMod.ORMSelector
import typingsJapgolly.reduxOrm.reduxMod.Selector
import typingsJapgolly.reduxOrm.reduxMod.defaultUpdater
...
object mod {
  ...
  open class default[MClass /* <: Instantiable0[AnyModel] */, Fields /* <: ModelFieldMap */] protected ()
    extends typingsJapgolly.reduxOrm.modelMod.default[MClass, Fields] {
    /**
  ...
  object default {
    ...
    /**
      ...
      */
    inline def exclude(props: LookupSpec[typingsJapgolly.reduxOrm.modelMod.Model[Instantiable0[AnyModel], Any]]): typingsJapgolly.reduxOrm.querySetMod.default[Any, js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("exclude")(props.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.reduxOrm.querySetMod.default[Any, js.Object]]
    ...
    /**
      ...
      */
    inline def exists(props: Partial[Ref[typingsJapgolly.reduxOrm.modelMod.Model[Instantiable0[AnyModel], Any]]]): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("exists")(props.asInstanceOf[js.Any]).asInstanceOf[Boolean]
    ...
    /**
      ...
      */
    inline def filter(props: LookupSpec[typingsJapgolly.reduxOrm.modelMod.Model[Instantiable0[AnyModel], Any]]): typingsJapgolly.reduxOrm.querySetMod.default[Any, js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(props.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.reduxOrm.querySetMod.default[Any, js.Object]]
    ...
    inline def orderBy(
      iteratees: js.Array[
          SortIteratee[typingsJapgolly.reduxOrm.modelMod.Model[Instantiable0[AnyModel], Any]]
        ]
    ): typingsJapgolly.reduxOrm.querySetMod.default[Any, js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(iteratees.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.reduxOrm.querySetMod.default[Any, js.Object]]
    inline def orderBy(
      iteratees: js.Array[
          SortIteratee[typingsJapgolly.reduxOrm.modelMod.Model[Instantiable0[AnyModel], Any]]
        ],
    ...
    /**
      ...
      */
    inline def update(props: UpdateProps[typingsJapgolly.reduxOrm.modelMod.Model[Instantiable0[AnyModel], Any]]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("update")(props.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  open class Attribute ()
    extends typingsJapgolly.reduxOrm.fieldsMod.Attribute {
  ...
  open class ForeignKey protected ()
    extends typingsJapgolly.reduxOrm.fieldsMod.ForeignKey {
  ...
  open class ManyToMany protected ()
    extends typingsJapgolly.reduxOrm.fieldsMod.ManyToMany {
    def this(opts: RelationalFieldOpts) = this()
    def this(toModelName: String) = this()
    def this(toModelName: String, relatedName: String) = this()
  }
  ...
  open class ORM[I /* <: IndexedModelClasses[
    ...
    extends typingsJapgolly.reduxOrm.ormMod.ORM[I, ModelNames] {
  ...
  open class OneToOne_ protected ()
    extends typingsJapgolly.reduxOrm.fieldsMod.OneToOne_ {
    def this(opts: RelationalFieldOpts) = this()
    def this(toModelName: String) = this()
    def this(toModelName: String, relatedName: String) = this()
  }
  ...
  open class QuerySet[M /* <: AnyModel */, InstanceProps /* <: js.Object */] protected ()
    extends typingsJapgolly.reduxOrm.querySetMod.default[M, InstanceProps] {
    /**
  ...
  ] */, TAction /* <: Any */](orm: typingsJapgolly.reduxOrm.ormMod.ORM[I, /* keyof I */ String]): ORMReducer[I, TAction] = ^.asInstanceOf[js.Dynamic].applyDynamic("createReducer")(orm.asInstanceOf[js.Any]).asInstanceOf[ORMReducer[I, TAction]]
  inline def createReducer[I /* <: IndexedModelClasses[
    js.Object, 
    Extract[
      /* keyof {} */ String, 
    ...
    orm: typingsJapgolly.reduxOrm.ormMod.ORM[I, /* keyof I */ String],
    updater: defaultUpdater[I, TAction]
  ): ORMReducer[I, TAction] = (^.asInstanceOf[js.Dynamic].applyDynamic("createReducer")(orm.asInstanceOf[js.Any], updater.asInstanceOf[js.Any])).asInstanceOf[ORMReducer[I, TAction]]
