...
import typingsJapgolly.reduxOrm.reduxOrmBooleans.`false`
import typingsJapgolly.reduxOrm.reduxOrmBooleans.`true`
...
object fieldsMod {
  ...
  open class Attribute () extends Field {
    ...
    var `type`: typingsJapgolly.reduxOrm.reduxOrmStrings.attr = js.native
  }
  ...
  open class ForeignKey protected () extends RelationalField {
    ...
    var `type`: typingsJapgolly.reduxOrm.reduxOrmStrings.fk = js.native
  }
  ...
  open class ManyToMany protected () extends RelationalField {
    ...
    var `type`: typingsJapgolly.reduxOrm.reduxOrmStrings.many = js.native
  }
  ...
  open class OneToOne_ protected () extends RelationalField {
    ...
    var `type`: typingsJapgolly.reduxOrm.reduxOrmStrings.oneToOne = js.native
  }
  ...
  object AttributeOpts {
    ...
    extension [Self <: AttributeOpts](x: Self) {
      ...
      inline def setGetDefault(value: CallbackTo[Any]): Self = StObject.set(x, "getDefault", value.toJsFn)
