...
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.`additions removals`
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.`additions text`
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.`inline`
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.`removals additions`
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.`removals text`
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.`text additions`
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.`text removals`
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.additions
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.all
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.ascending
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.assertive
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.both
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.copy
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.date
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.decimal
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.descending
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.dialog
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.email
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.execute
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.grammar
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.grid
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.horizontal
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.inherit
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.link
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.list
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.listbox
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.location
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.menu
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.mixed
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.move
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.no
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.none
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.numeric
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.off
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.on
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.other
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.page
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.polite
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.popup
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.removals
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.search
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.spelling
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.step
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.tel
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.text
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.time
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.tree
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.url
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.vertical
import typingsJapgolly.reactMdTabs.reactMdTabsStrings.yes
...
object Tab {
  ...
  inline def apply(active: Boolean, id: String): Builder = {
    val __props = js.Dynamic.literal(active = active.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[TabProps & RefAttributes[HTMLButtonElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def panelId(value: String): this.type = set("panelId", value.asInstanceOf[js.Any])
  ...
  def withProps(p: TabProps & RefAttributes[HTMLButtonElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
