...
object TabsList {
  ...
  inline def apply(activeIndex: Double, onActiveIndexChange: Double => Callback): Builder = {
    val __props = js.Dynamic.literal(activeIndex = activeIndex.asInstanceOf[js.Any], onActiveIndexChange = js.Any.fromFunction1((t0: Double) => onActiveIndexChange(t0).runNow()))
    new Builder(js.Array(this.component, __props.asInstanceOf[TabsListProps & RefAttributes[HTMLDivElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def align(value: TabsAlignment): this.type = set("align", value.asInstanceOf[js.Any])
    ...
    inline def automatic(value: Boolean): this.type = set("automatic", value.asInstanceOf[js.Any])
    ...
    inline def orientation(
      value: typingsJapgolly.reactMdTabs.reactMdTabsStrings.horizontal | typingsJapgolly.reactMdTabs.reactMdTabsStrings.vertical
  ...
  def withProps(p: TabsListProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
