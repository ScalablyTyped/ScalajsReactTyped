...
object TabPanels {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def disableScrollFix(value: Boolean): this.type = set("disableScrollFix", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: TabPanels.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TabPanelsProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
