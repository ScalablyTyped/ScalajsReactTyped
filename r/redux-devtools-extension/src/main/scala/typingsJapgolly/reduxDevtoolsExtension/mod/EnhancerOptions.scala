...
import typingsJapgolly.reduxDevtoolsExtension.AnonDate
import typingsJapgolly.reduxDevtoolsExtension.AnonDispatch
...
object EnhancerOptions {
  ...
  def apply(
    ...
    if (actionSanitizer != null) __obj.updateDynamic("actionSanitizer")(js.Any.fromFunction2((t0: /* action */ typingsJapgolly.redux.mod.Action[js.Any], t1: /* id */ scala.Double) => actionSanitizer(t0, t1).runNow()))
    ...
    if (predicate != null) __obj.updateDynamic("predicate")(js.Any.fromFunction2((t0: /* state */ js.Any, t1: /* action */ typingsJapgolly.redux.mod.Action[js.Any]) => predicate(t0, t1).runNow()))
