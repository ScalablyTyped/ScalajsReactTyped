...
import typingsJapgolly.redux.mod.Func0
import typingsJapgolly.redux.mod.Func1
import typingsJapgolly.redux.mod.Func2
import typingsJapgolly.redux.mod.Func3
import typingsJapgolly.reduxDevtoolsExtension.reduxDevtoolsExtensionStrings.custom
...
object anon {
  ...
  trait FnCall extends StObject {
    ...
    def apply(): js.Function1[/* a */ Any, Any] = js.native
    def apply[R](f1: js.Function1[/* b */ Any, R], funcs: js.Function*): js.Function1[/* repeated */ Any, R] = js.native
    def apply[F /* <: js.Function */](f: F): F = js.native
    def apply[R](funcs: js.Function*): js.Function1[/* repeated */ Any, R] = js.native
