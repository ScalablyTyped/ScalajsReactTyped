...
import typingsJapgolly.redux.reduxMod.ActionCreator
import typingsJapgolly.reduxDashDevtoolsDashExtension.Anon_Custom
import typingsJapgolly.reduxDashDevtoolsDashExtension.Anon_Date
...
object EnhancerOptions {
  ...
  def apply(
    ...
    predicate: (/* state */ js.Any, /* action */ Action[js.Any]) => CallbackTo[Boolean] = null,
    ...
    if (actionSanitizer != null) __obj.updateDynamic("actionSanitizer")(js.Any.fromFunction2((t0: /* action */ typingsJapgolly.redux.reduxMod.Action[js.Any], t1: /* id */ scala.Double) => actionSanitizer(t0, t1).runNow()))
    ...
    if (predicate != null) __obj.updateDynamic("predicate")(js.Any.fromFunction2((t0: /* state */ js.Any, t1: /* action */ typingsJapgolly.redux.reduxMod.Action[js.Any]) => predicate(t0, t1).runNow()))
    ...
    if (stateSanitizer != null) __obj.updateDynamic("stateSanitizer")(js.Any.fromFunction2((t0: /* state */ js.Any, t1: /* index */ scala.Double) => stateSanitizer(t0, t1).runNow()))
