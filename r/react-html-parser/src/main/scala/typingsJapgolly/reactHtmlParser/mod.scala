package typingsJapgolly.reactHtmlParser
...
object mod {
  ...
  inline def default(html: String): js.Array[Element] = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(html.asInstanceOf[js.Any]).asInstanceOf[js.Array[Element]]
  inline def default(html: String, options: Options): js.Array[Element] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(html.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[Element]]
  ...
  inline def convertNodeToElement(
    ...
    index: Double,
    transform: Transform
  ): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("convertNodeToElement")(node.asInstanceOf[js.Any], index.asInstanceOf[js.Any], transform.asInstanceOf[js.Any])).asInstanceOf[Element]
  ...
  inline def processNodes(
    ...
    transform: Transform
  ): js.Array[Element] = (^.asInstanceOf[js.Dynamic].applyDynamic("processNodes")(nodes.asInstanceOf[js.Any], transform.asInstanceOf[js.Any])).asInstanceOf[js.Array[Element]]
