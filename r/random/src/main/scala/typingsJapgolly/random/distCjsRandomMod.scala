...
object distCjsRandomMod {
  
  @JSImport("random/dist/cjs/random", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("random/dist/cjs/random", JSImport.Default)
  @js.native
  val default: Random = js.native
  
  /* note: abstract class */ @JSImport("random/dist/cjs/random", "RNG")
  @js.native
  open class RNG ()
  ...
  @JSImport("random/dist/cjs/random", "Random")
  @js.native
  open class Random () extends StObject {
    ...
    var _patch: js.UndefOr[js.Function0[Double]] = js.native
    
    var _rng: typingsJapgolly.random.distCjsRngMod.default = js.native
    ...
    /**
      ...
      */
    def rng: typingsJapgolly.random.distCjsRngMod.default = js.native
    ...
    /**
      ...
      */
    def use(
      /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type [RNG] is not an array type */ args: js.Array[typingsJapgolly.random.distCjsRngMod.default]
    ): Unit = js.native
  }
  ...
  object ICacheEntry {
    ...
    inline def apply[T](distribution: CallbackTo[T], key: String): ICacheEntry[T] = {
      val __obj = js.Dynamic.literal(distribution = distribution.toJsFn, key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[ICacheEntry[T]]
    }
    
    extension [Self <: ICacheEntry[?], T](x: Self & ICacheEntry[T]) {
      
      inline def setDistribution(value: CallbackTo[T]): Self = StObject.set(x, "distribution", value.toJsFn)
