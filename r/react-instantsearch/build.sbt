...
version := "5.2-dt-20191126Z-4003a8"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "react-instantsearch-dom" % "5.2-dt-20191126Z-d5ead2",
  "org.scalablytyped.japgolly" %%% "react-instantsearch-native" % "5.3-dt-20190909Z-ceb946",
