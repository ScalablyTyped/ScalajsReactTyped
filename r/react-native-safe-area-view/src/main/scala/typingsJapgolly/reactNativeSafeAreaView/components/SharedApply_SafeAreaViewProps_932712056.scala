package typingsJapgolly.reactNativeSafeAreaView.components
...
import typingsJapgolly.reactNativeSafeAreaView.mod.SafeAreaViewProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_SafeAreaViewProps_932712056[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SafeAreaViewProps, ComponentRef, Unit, SafeAreaViewProps] = {
  ...
  typingsJapgolly.reactNativeSafeAreaView.mod.SafeAreaViewProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSafeAreaView.mod.SafeAreaViewProps])(children: _*)
  }
}
