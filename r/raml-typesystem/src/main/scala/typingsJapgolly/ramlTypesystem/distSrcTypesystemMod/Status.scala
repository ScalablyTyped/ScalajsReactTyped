...
open class Status protected ()
  ...
  /* CompleteClass */
  override def getInternalPath(): typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath = js.native
  ...
  /* CompleteClass */
  override def getValidationPath(): typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath = js.native
  ...
  /* protected */ var internalPath: typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath = js.native
  ...
  def setInternalPath(ip: typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath): Unit = js.native
  ...
  /* CompleteClass */
  override def setValidationPath(p: typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath): Unit = js.native
  ...
  /* protected */ var vp: typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath = js.native
}
/* static members */
object Status {
