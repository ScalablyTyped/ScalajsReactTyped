...
import typingsJapgolly.ramlTypesystem.anon.InstantiableT
import typingsJapgolly.ramlTypesystem.anon.`0`
import typingsJapgolly.ramlTypesystem.distSrcRestrictionsMod.MatchesProperty
import typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.ElementSourceInfo
import typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.HasSource
...
import typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IParsedTypeCollection
...
open class AbstractType protected ()
  ...
  def validateDirect(
    ...
    autoClose: Boolean,
    nullAllowed: Boolean,
    path: typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath
  ): Status = js.native
  def validateDirect(
    i: Any,
    autoClose: Boolean,
