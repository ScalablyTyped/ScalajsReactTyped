...
import typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IAnnotatedElement
import typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IParsedType
import typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IStatus
import typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.ITypeRegistry
import typingsJapgolly.ramlTypesystem.distSrcTypesystemMod.^
...
inline def patchPath(p: typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath): typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath = ^.asInstanceOf[js.Dynamic].applyDynamic("patchPath")(p.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath]

inline def setValidationPath(_s: IStatus, _c: typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setValidationPath")(_s.asInstanceOf[js.Any], _c.asInstanceOf[js.Any])).asInstanceOf[Unit]
