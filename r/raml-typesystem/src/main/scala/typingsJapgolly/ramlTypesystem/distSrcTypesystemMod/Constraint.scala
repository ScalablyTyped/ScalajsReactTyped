...
import typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IConstraint
...
open class Constraint ()
  ...
  def check(i: Any, parentPath: typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath): Status = js.native
