...
object ITypeRegistry {
  ...
  inline def apply(
    get: String => IParsedType,
    getByChain: String => IParsedType,
    types: CallbackTo[js.Array[IParsedType]]
  ): ITypeRegistry = {
    val __obj = js.Dynamic.literal(get = js.Any.fromFunction1(get), getByChain = js.Any.fromFunction1(getByChain), types = types.toJsFn)
