...
object nominalTypes {
  ...
  open class AbstractType protected ()
    extends typingsJapgolly.ramlTypesystem.distSrcNominalTypesMod.AbstractType {
  ...
  open class Adaptable ()
    extends typingsJapgolly.ramlTypesystem.distSrcNominalTypesMod.Adaptable
  /* static members */
  object Adaptable {
  ...
  open class Annotation protected ()
    extends typingsJapgolly.ramlTypesystem.distSrcNominalTypesMod.Annotation {
  ...
  open class Array protected ()
    extends typingsJapgolly.ramlTypesystem.distSrcNominalTypesMod.Array {
    def this(_name: String) = this()
    def this(_name: String, _universe: IUniverse) = this()
    def this(_name: String, _universe: Unit, _path: String) = this()
    def this(_name: String, _universe: IUniverse, _path: String) = this()
  ...
  open class Described protected ()
    extends typingsJapgolly.ramlTypesystem.distSrcNominalTypesMod.Described {
    def this(_name: String) = this()
  ...
  @js.native
  open class Empty ()
    extends typingsJapgolly.ramlTypesystem.distSrcNominalTypesMod.Empty
  
  @JSImport("raml-typesystem", "nominalTypes.ExternalType")
  @js.native
  open class ExternalType protected ()
    extends typingsJapgolly.ramlTypesystem.distSrcNominalTypesMod.ExternalType {
    def this(_name: String) = this()
    def this(_name: String, _universe: IUniverse) = this()
    def this(_name: String, _universe: Unit, _path: String) = this()
    def this(_name: String, _universe: IUniverse, _path: String) = this()
  ...
  open class Property protected ()
    extends typingsJapgolly.ramlTypesystem.distSrcNominalTypesMod.Property {
    def this(_name: String) = this()
    def this(_name: String, _description: String) = this()
  }
  /* static members */
  ...
  open class StructuredType protected ()
    extends typingsJapgolly.ramlTypesystem.distSrcNominalTypesMod.StructuredType {
    def this(_name: String) = this()
    def this(_name: String, _universe: IUniverse) = this()
    def this(_name: String, _universe: Unit, _path: String) = this()
    def this(_name: String, _universe: IUniverse, _path: String) = this()
  ...
  open class Union protected ()
    extends typingsJapgolly.ramlTypesystem.distSrcNominalTypesMod.Union {
    def this(_name: String) = this()
    def this(_name: String, _universe: IUniverse) = this()
    def this(_name: String, _universe: Unit, _path: String) = this()
    def this(_name: String, _universe: IUniverse, _path: String) = this()
  ...
  open class ValueType protected ()
    extends typingsJapgolly.ramlTypesystem.distSrcNominalTypesMod.ValueType {
