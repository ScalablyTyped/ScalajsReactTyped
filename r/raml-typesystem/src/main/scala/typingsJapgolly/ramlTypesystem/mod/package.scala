...
import typingsJapgolly.ramlTypesystem.mod.^
...
inline def toValidationPath(p: String): typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath = ^.asInstanceOf[js.Dynamic].applyDynamic("toValidationPath")(p.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath]
...
type ElementSourceInfo = typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IHasExtra

type IAnnotation = typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IAnnotation

type IConstraint = typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IConstraint

type IExample = typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IExample

type IHasExtra = typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IHasExtra

type IParsedType = typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IParsedType

type IParsedTypeCollection = typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IParsedTypeCollection

type IPropertyInfo = typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IPropertyInfo

type IStatus = typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IStatus

type ITypeFacet = typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.ITypeFacet

type ITypeRegistry = typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.ITypeRegistry

type IValidationPath = typingsJapgolly.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath
