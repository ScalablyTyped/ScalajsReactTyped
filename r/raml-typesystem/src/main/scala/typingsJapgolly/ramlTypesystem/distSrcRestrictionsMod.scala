...
import typingsJapgolly.ramlTypesystem.distSrcTypesystemMod.Constraint
...
object distSrcRestrictionsMod {
  ...
  open class MatchesProperty protected () extends Constraint {
    ...
    def patchPath(p: typingsJapgolly.ramlTypesystem.distSrcTypesystemMod.IValidationPath, name: String): IValidationPath = js.native
    ...
    def validateProp(
      ...
      n: String,
      t: AbstractType,
      q: typingsJapgolly.ramlTypesystem.distSrcTypesystemMod.IValidationPath
    ): Status = js.native
  }
  /* static members */
  ...
  type IValidationPath = typingsJapgolly.ramlTypesystem.distSrcTypesystemMod.IValidationPath
}
