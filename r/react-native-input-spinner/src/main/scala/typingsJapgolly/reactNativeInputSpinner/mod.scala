package typingsJapgolly.reactNativeInputSpinner
...
object mod {
  ...
  type InputSpinner = japgolly.scalajs.react.facade.React.Component[ReactNativeInputSpinnerProps & js.Object, js.Object]
  ...
  trait ReactNativeInputSpinnerProps extends StObject {
    ...
    var append: js.UndefOr[Element] = js.undefined
    ...
    var buttonLeftImage: js.UndefOr[Element] = js.undefined
    
    var buttonLeftText: js.UndefOr[String] = js.undefined
    
    var buttonPressLeftImage: js.UndefOr[Element] = js.undefined
    
    var buttonPressRightImage: js.UndefOr[Element] = js.undefined
    ...
    var buttonRightImage: js.UndefOr[Element] = js.undefined
    ...
    var prepend: js.UndefOr[Element] = js.undefined
  ...
  object ReactNativeInputSpinnerProps {
    ...
    extension [Self <: ReactNativeInputSpinnerProps](x: Self) {
      ...
      inline def setAppend(value: VdomElement): Self = StObject.set(x, "append", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setButtonLeftImage(value: VdomElement): Self = StObject.set(x, "buttonLeftImage", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setButtonPressLeftImage(value: VdomElement): Self = StObject.set(x, "buttonPressLeftImage", value.rawElement.asInstanceOf[js.Any])
      
      inline def setButtonPressLeftImageUndefined: Self = StObject.set(x, "buttonPressLeftImage", js.undefined)
      
      inline def setButtonPressRightImage(value: VdomElement): Self = StObject.set(x, "buttonPressRightImage", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setButtonRightImage(value: VdomElement): Self = StObject.set(x, "buttonRightImage", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setPrepend(value: VdomElement): Self = StObject.set(x, "prepend", value.rawElement.asInstanceOf[js.Any])
