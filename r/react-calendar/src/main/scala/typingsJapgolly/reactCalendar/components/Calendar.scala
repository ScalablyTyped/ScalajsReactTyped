...
object Calendar {
  ...
  implicit def make(companion: Calendar.type): SharedBuilder_CalendarProps_135001147 = new SharedBuilder_CalendarProps_135001147(js.Array(this.component, js.Dictionary.empty))()
