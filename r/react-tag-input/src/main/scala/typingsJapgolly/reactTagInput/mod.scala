package typingsJapgolly.reactTagInput
...
object mod {
  ...
  trait ReactTagsProps extends StObject {
    ...
    var removeComponent: js.UndefOr[japgolly.scalajs.react.facade.React.Component[Any & js.Object, js.Object]] = js.undefined
  ...
  object ReactTagsProps {
    ...
    inline def apply(handleAddition: Id => Callback, handleDelete: Double => Callback): ReactTagsProps = {
      val __obj = js.Dynamic.literal(handleAddition = js.Any.fromFunction1((t0: Id) => handleAddition(t0).runNow()), handleDelete = js.Any.fromFunction1((t0: Double) => handleDelete(t0).runNow()))
    ...
    extension [Self <: ReactTagsProps](x: Self) {
      ...
      inline def setHandleAddition(value: Id => Callback): Self = StObject.set(x, "handleAddition", js.Any.fromFunction1((t0: Id) => value(t0).runNow()))
      
      inline def setHandleDelete(value: Double => Callback): Self = StObject.set(x, "handleDelete", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      
      inline def setHandleDrag(value: (/* tag */ Id, /* currPos */ Double, /* newPos */ Double) => Callback): Self = StObject.set(x, "handleDrag", js.Any.fromFunction3((t0: /* tag */ Id, t1: /* currPos */ Double, t2: /* newPos */ Double) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setHandleInputBlur(value: /* textInputValue */ String => Callback): Self = StObject.set(x, "handleInputBlur", js.Any.fromFunction1((t0: /* textInputValue */ String) => value(t0).runNow()))
      
      inline def setHandleInputBlurUndefined: Self = StObject.set(x, "handleInputBlur", js.undefined)
      
      inline def setHandleInputChange(value: /* value */ String => Callback): Self = StObject.set(x, "handleInputChange", js.Any.fromFunction1((t0: /* value */ String) => value(t0).runNow()))
      
      inline def setHandleInputChangeUndefined: Self = StObject.set(x, "handleInputChange", js.undefined)
      
      inline def setHandleInputFocus(value: /* value */ String => Callback): Self = StObject.set(x, "handleInputFocus", js.Any.fromFunction1((t0: /* value */ String) => value(t0).runNow()))
      
      inline def setHandleInputFocusUndefined: Self = StObject.set(x, "handleInputFocus", js.undefined)
      
      inline def setHandleTagClick(value: /* i */ Double => Callback): Self = StObject.set(x, "handleTagClick", js.Any.fromFunction1((t0: /* i */ Double) => value(t0).runNow()))
      ...
      inline def setRemoveComponent(value: japgolly.scalajs.react.facade.React.Component[Any & js.Object, js.Object]): Self = StObject.set(x, "removeComponent", value.asInstanceOf[js.Any])
