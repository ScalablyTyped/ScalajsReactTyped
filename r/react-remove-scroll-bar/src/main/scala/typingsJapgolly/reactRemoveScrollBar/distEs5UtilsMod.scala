...
object distEs5UtilsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactRemoveScrollBar.reactRemoveScrollBarStrings.padding
    - typingsJapgolly.reactRemoveScrollBar.reactRemoveScrollBarStrings.margin
  */
  trait GapMode extends StObject
  object GapMode {
    
    inline def margin: typingsJapgolly.reactRemoveScrollBar.reactRemoveScrollBarStrings.margin = "margin".asInstanceOf[typingsJapgolly.reactRemoveScrollBar.reactRemoveScrollBarStrings.margin]
    
    inline def padding: typingsJapgolly.reactRemoveScrollBar.reactRemoveScrollBarStrings.padding = "padding".asInstanceOf[typingsJapgolly.reactRemoveScrollBar.reactRemoveScrollBarStrings.padding]
  }
