...
import typingsJapgolly.reactRouterDom.anon.IsActive
import typingsJapgolly.reactRouterDom.anon.PreventScrollReset
import typingsJapgolly.reactRouterDom.anon.Relative
import typingsJapgolly.reactRouterDom.distDomMod.SubmitOptions
import typingsJapgolly.reactRouterDom.distDomMod.URLSearchParamsInit
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.`additions removals`
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.`additions text`
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.`inline`
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.`removals additions`
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.`removals text`
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.`text additions`
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.`text removals`
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.additions
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.all
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.ascending
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.assertive
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.both
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.copy
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.date
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.decimal
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.descending
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.dialog
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.email
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.execute
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.grammar
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.grid
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.horizontal
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.inherit
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.link
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.list
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.listbox
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.location
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.menu
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.mixed
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.move
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.no
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.none
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.numeric
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.off
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.on
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.other
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.page
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.polite
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.popup
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.removals
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.search
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.spelling
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.step
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.tel
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.text
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.time
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.tree
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.url
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.vertical
import typingsJapgolly.reactRouterDom.reactRouterDomStrings.yes
...
import typingsJapgolly.remixRunRouter.distRouterMod.GetScrollRestorationKeyFunction
import typingsJapgolly.remixRunRouter.distRouterMod.HydrationState
...
import typingsJapgolly.remixRunRouter.distRouterMod.UseMatchesMatch
...
import typingsJapgolly.remixRunRouter.distUtilsMod.FormMethod
...
object mod {
  ...
  @JSImport("react-router-dom", "AbortedDeferredError")
  @js.native
  ...
  object ScrollRestoration {
    ...
    @JSImport("react-router-dom", "ScrollRestoration.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("react-router-dom", "UNSAFE_DataRouterContext")
  @js.native
  val UNSAFEDataRouterContext: Context[DataRouterContextObject | Null] = js.native
  
  @JSImport("react-router-dom", "UNSAFE_DataRouterStateContext")
  @js.native
  ...
  @JSImport("react-router-dom", "UNSAFE_NavigationContext")
  @js.native
  val UNSAFENavigationContext: Context[NavigationContextObject] = js.native
  
  @JSImport("react-router-dom", "UNSAFE_RouteContext")
  @js.native
  ...
  object global {
    ...
    @JSGlobal("__staticRouterHydrationData")
    @js.native
    def staticRouterHydrationData: js.UndefOr[HydrationState] = js.native
  ...
  object unstableHistoryRouter {
    ...
    @JSImport("react-router-dom", "unstable_HistoryRouter.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  }
  ...
  type FetcherWithComponents[TData] = Fetcher[TData] & typingsJapgolly.reactRouterDom.anon.Form
  ...
  trait HistoryRouterProps extends StObject {
  ...
  object HistoryRouterProps {
    
    inline def apply(history: History): HistoryRouterProps = {
  ...
  /* Inlined parent std.Omit<react-router-dom.react-router-dom.LinkProps, 'className' | 'style' | 'children'> */
  trait NavLinkProps extends StObject {
    ...
    var children: js.UndefOr[Node | (js.Function1[/* props */ IsActive, Node])] = js.undefined
    ...
    var style: js.UndefOr[CSSProperties | (js.Function1[/* props */ IsActive, js.UndefOr[CSSProperties]])] = js.undefined
  ...
  object NavLinkProps {
    ...
    extension [Self <: NavLinkProps](x: Self) {
      ...
      inline def setChildren(value: Node | (js.Function1[/* props */ IsActive, Node])): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      inline def setChildrenFunction1(value: /* props */ IsActive => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      inline def setClassNameFunction1(value: /* props */ IsActive => js.UndefOr[String]): Self = StObject.set(x, "className", js.Any.fromFunction1(value))
      ...
      inline def setStyle(value: CSSProperties | (js.Function1[/* props */ IsActive, js.UndefOr[CSSProperties]])): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
      
      inline def setStyleFunction1(value: /* props */ IsActive => js.UndefOr[CSSProperties]): Self = StObject.set(x, "style", js.Any.fromFunction1(value))
  ...
  trait ScrollRestorationProps extends StObject {
    
    var getKey: js.UndefOr[GetScrollRestorationKeyFunction] = js.undefined
    
    var storageKey: js.UndefOr[String] = js.undefined
  }
  object ScrollRestorationProps {
    
    inline def apply(): ScrollRestorationProps = {
      val __obj = js.Dynamic.literal()
  ...
  type SetURLSearchParams = js.Function2[
    /* nextInit */ js.UndefOr[
      URLSearchParamsInit | (js.Function1[/* prev */ URLSearchParams, URLSearchParamsInit])
    ], 
    /* navigateOpts */ js.UndefOr[NavigateOptions], 
    Unit
  ]
  
  type SubmitFunction = js.Function2[/* target */ SubmitTarget, /* options */ js.UndefOr[SubmitOptions], Unit]
  
  type SubmitTarget = HTMLFormElement | HTMLButtonElement | HTMLInputElement | FormData | URLSearchParams | StringDictionary[String] | Null
}
