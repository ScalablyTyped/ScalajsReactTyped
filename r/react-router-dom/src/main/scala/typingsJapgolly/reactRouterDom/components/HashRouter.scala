...
object HashRouter {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[HashRouterProps, typingsJapgolly.reactRouterDom.mod.HashRouter, Unit, HashRouterProps] = {
  ...
  typingsJapgolly.reactRouterDom.mod.HashRouter](this.componentImport)
