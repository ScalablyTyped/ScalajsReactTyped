...
object Form {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def method(value: FormMethod): this.type = set("method", value.asInstanceOf[js.Any])
  ...
  def withProps(p: FormProps & RefAttributes[HTMLFormElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
