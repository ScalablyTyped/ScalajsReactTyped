...
object NavLink {
  ...
  inline def apply(to: To): Builder = {
    val __props = js.Dynamic.literal(to = to.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[NavLinkProps & RefAttributes[HTMLAnchorElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def children(value: Node | (js.Function1[/* props */ IsActive, Node])): this.type = set("children", value.asInstanceOf[js.Any])
    
    inline def childrenFunction1(value: /* props */ IsActive => Node): this.type = set("children", js.Any.fromFunction1(value))
  ...
  def withProps(p: NavLinkProps & RefAttributes[HTMLAnchorElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
