...
object NavLink {
  def apply[S](
    ...
    is: String = null,
    isActive: (/* match */ `match`[js.Any], /* location */ Location[S]) => CallbackTo[Boolean] = null,
    itemID: String = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[NavLinkProps[S], typingsJapgolly.reactRouterDom.mod.NavLink[S], Unit, NavLinkProps[S]] = {
    ...
    if (isActive != null) __obj.updateDynamic("isActive")(js.Any.fromFunction2((t0: /* match */ typingsJapgolly.reactRouter.mod.`match`[js.Any], t1: /* location */ typingsJapgolly.history.mod.Location[S]) => isActive(t0, t1).runNow()))
  ...
  typingsJapgolly.reactRouterDom.mod.NavLinkProps[S], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactRouterDom.mod.NavLink[S]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactRouterDom.mod.NavLinkProps[S]])(children: _*)
  }
