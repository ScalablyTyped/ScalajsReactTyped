...
object Router {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RouterProps, typingsJapgolly.reactRouterDom.mod.Router, Unit, RouterProps] = {
  ...
  typingsJapgolly.reactRouterDom.mod.Router](this.componentImport)
