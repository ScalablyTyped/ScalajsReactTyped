...
object Switch {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SwitchProps, typingsJapgolly.reactRouterDom.mod.Switch, Unit, SwitchProps] = {
  ...
  typingsJapgolly.reactRouterDom.mod.Switch](this.componentImport)
