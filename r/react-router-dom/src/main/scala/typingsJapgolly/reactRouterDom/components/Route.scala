...
object Route {
  def apply[T /* <: RouteProps */](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[T with js.Object, typingsJapgolly.reactRouterDom.mod.Route[T], Unit, T with js.Object] = {
  ...
  typingsJapgolly.reactRouterDom.mod.Route[T]](this.componentImport)
