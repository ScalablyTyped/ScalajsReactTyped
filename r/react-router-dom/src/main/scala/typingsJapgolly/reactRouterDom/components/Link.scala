...
object Link {
  def apply[S](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[LinkProps[S], typingsJapgolly.reactRouterDom.mod.Link[S], Unit, LinkProps[S]] = {
  ...
  typingsJapgolly.reactRouterDom.mod.LinkProps[S], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactRouterDom.mod.Link[S]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactRouterDom.mod.LinkProps[S]])(children: _*)
  }
