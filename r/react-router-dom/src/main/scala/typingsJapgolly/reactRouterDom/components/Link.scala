...
object Link {
  ...
  inline def apply(to: To): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[LinkProps & RefAttributes[HTMLAnchorElement]]))
  }
  ...
  def withProps(p: LinkProps & RefAttributes[HTMLAnchorElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
