...
object Redirect {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RedirectProps, typingsJapgolly.reactRouterDom.mod.Redirect, Unit, RedirectProps] = {
  ...
  typingsJapgolly.reactRouterDom.mod.Redirect](this.componentImport)
