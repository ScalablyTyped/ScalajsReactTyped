...
import typingsJapgolly.reactDashRouterDashDom.reactDashRouterDashDomMod.LinkProps
...
object Link {
  def apply[S](
    ...
    LinkProps[S], 
    typingsJapgolly.reactDashRouterDashDom.reactDashRouterDashDomMod.Link[S], 
    Unit, 
    LinkProps[S]
  ] = {
