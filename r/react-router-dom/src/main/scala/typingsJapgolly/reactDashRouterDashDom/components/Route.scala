...
object Route {
  def apply[T /* <: RouteProps */](
    ...
    T with js.Object, 
    typingsJapgolly.reactDashRouterDashDom.reactDashRouterDashDomMod.Route[T], 
    Unit, 
    T with js.Object
  ] = {
  ...
  typingsJapgolly.reactDashRouterDashDom.reactDashRouterDashDomMod.Route[T]](this.componentImport)
