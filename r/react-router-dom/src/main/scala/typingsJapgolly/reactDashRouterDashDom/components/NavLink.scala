...
import typingsJapgolly.reactDashRouterDashDom.reactDashRouterDashDomMod.NavLinkProps
...
object NavLink {
  def apply[S](
    ...
    NavLinkProps[S], 
    typingsJapgolly.reactDashRouterDashDom.reactDashRouterDashDomMod.NavLink[S], 
    Unit, 
    NavLinkProps[S]
  ] = {
    ...
    if (isActive != null) __obj.updateDynamic("isActive")(js.Any.fromFunction2((t0: /* match */ typingsJapgolly.reactDashRouter.reactDashRouterMod.`match`[js.Any], t1: /* location */ typingsJapgolly.history.historyMod.Location[S]) => isActive(t0, t1).runNow()))
