...
import typingsJapgolly.rcMotion.esInterfaceMod.MotionEndEventHandler
import typingsJapgolly.rcMotion.esInterfaceMod.MotionEvent
import typingsJapgolly.rcMotion.esInterfaceMod.MotionEventHandler
import typingsJapgolly.rcMotion.esInterfaceMod.MotionPrepareEventHandler
import typingsJapgolly.rcMotion.esUtilDiffMod.KeyObject
...
object esCssmotionlistMod {
  ...
  @js.native
  open class default protected () extends Component[CSSMotionListProps, Any, Any] {
    def this(props: CSSMotionListProps) = this()
    def this(props: CSSMotionListProps, context: Any) = this()
  }
  @JSImport("rc-motion/es/CSSMotionList", JSImport.Default)
  @js.native
  val default: ComponentClassP[CSSMotionListProps & js.Object] = js.native
  
  inline def genCSSMotionList(transitionSupport: Boolean): ComponentClassP[CSSMotionListProps & js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("genCSSMotionList")(transitionSupport.asInstanceOf[js.Any]).asInstanceOf[ComponentClassP[CSSMotionListProps & js.Object]]
  inline def genCSSMotionList(transitionSupport: Boolean, CSSMotion: ForwardRefExoticComponent[CSSMotionPropsrefRefanyun]): ComponentClassP[CSSMotionListProps & js.Object] = (^.asInstanceOf[js.Dynamic].applyDynamic("genCSSMotionList")(transitionSupport.asInstanceOf[js.Any], CSSMotion.asInstanceOf[js.Any])).asInstanceOf[ComponentClassP[CSSMotionListProps & js.Object]]
  ...
  trait CSSMotionListProps extends StObject {
    ...
    var children: js.UndefOr[
        js.Function2[/* props */ Dictkey, /* ref */ js.Function1[/* node */ Any, Unit], Element]
      ] = js.undefined
    ...
    var onAllRemoved: js.UndefOr[js.Function0[Unit]] = js.undefined
    ...
    var onVisibleChanged: js.UndefOr[
        js.Function2[/* visible */ Boolean, /* info */ typingsJapgolly.rcMotion.anon.Key, Unit]
      ] = js.undefined
  ...
  object CSSMotionListProps {
    ...
    extension [Self <: CSSMotionListProps](x: Self) {
      ...
      inline def setChildren(value: (/* props */ Dictkey, /* ref */ js.Function1[/* node */ Any, Unit]) => Element): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
      ...
      inline def setInternalRefFunction1(value: Any | Null => Callback): Self = StObject.set(x, "internalRef", js.Any.fromFunction1((t0: Any | Null) => value(t0).runNow()))
      ...
      inline def setKeysVarargs(value: (Key | Dictname)*): Self = StObject.set(x, "keys", js.Array(value*))
      ...
      inline def setOnVisibleChanged(value: (/* visible */ Boolean, /* info */ typingsJapgolly.rcMotion.anon.Key) => Callback): Self = StObject.set(x, "onVisibleChanged", js.Any.fromFunction2((t0: /* visible */ Boolean, t1: /* info */ typingsJapgolly.rcMotion.anon.Key) => (value(t0, t1)).runNow()))
  ...
  object CSSMotionListState {
    ...
    extension [Self <: CSSMotionListState](x: Self) {
      ...
      inline def setKeyEntitiesVarargs(value: KeyObject*): Self = StObject.set(x, "keyEntities", js.Array(value*))
    }
  }
}
