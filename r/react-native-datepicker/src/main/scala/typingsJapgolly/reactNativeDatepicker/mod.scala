...
object mod {
  ...
  trait DatePickerProps extends StObject {
    ...
    var TouchableComponent: js.UndefOr[japgolly.scalajs.react.facade.React.Component[js.Object, js.Object]] = js.undefined
  ...
  object DatePickerProps {
    ...
    extension [Self <: DatePickerProps](x: Self) {
      ...
      inline def setIconComponent(value: VdomElement): Self = StObject.set(x, "iconComponent", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnCloseModal(value: Callback): Self = StObject.set(x, "onCloseModal", value.toJsFn)
      
      inline def setOnCloseModalUndefined: Self = StObject.set(x, "onCloseModal", js.undefined)
      
      inline def setOnDateChange(value: (/* dateStr */ String, /* date */ js.Date) => Callback): Self = StObject.set(x, "onDateChange", js.Any.fromFunction2((t0: /* dateStr */ String, t1: /* date */ js.Date) => (value(t0, t1)).runNow()))
      
      inline def setOnDateChangeUndefined: Self = StObject.set(x, "onDateChange", js.undefined)
      
      inline def setOnOpenModal(value: Callback): Self = StObject.set(x, "onOpenModal", value.toJsFn)
      
      inline def setOnOpenModalUndefined: Self = StObject.set(x, "onOpenModal", js.undefined)
      
      inline def setOnPressMask(value: Callback): Self = StObject.set(x, "onPressMask", value.toJsFn)
      ...
      inline def setTouchableComponent(value: japgolly.scalajs.react.facade.React.Component[js.Object, js.Object]): Self = StObject.set(x, "TouchableComponent", value.asInstanceOf[js.Any])
