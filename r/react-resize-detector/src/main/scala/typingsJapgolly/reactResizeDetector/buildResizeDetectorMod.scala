...
object buildResizeDetectorMod {
  ...
  trait ChildFunctionProps[ElementT /* <: HTMLElement */]
    ...
    var targetRef: js.UndefOr[RefHandle[ElementT]] = js.undefined
  }
  object ChildFunctionProps {
    ...
    extension [Self <: ChildFunctionProps[?], ElementT /* <: HTMLElement */](x: Self & ChildFunctionProps[ElementT]) {
      ...
      inline def setTargetRef(value: RefHandle[ElementT]): Self = StObject.set(x, "targetRef", value.asInstanceOf[js.Any])
  ...
  trait ComponentsProps[ElementT /* <: HTMLElement */]
    ...
    var children: js.UndefOr[Node | (js.Function1[/* props */ ChildFunctionProps[ElementT], Node])] = js.undefined
    ...
    var nodeType: js.UndefOr[
        /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 176, starting with typingsJapgolly.reactResizeDetector.reactResizeDetectorStrings.a, typingsJapgolly.reactResizeDetector.reactResizeDetectorStrings.abbr, typingsJapgolly.reactResizeDetector.reactResizeDetectorStrings.address */ Any
      ] = js.undefined
  ...
  object ComponentsProps {
    ...
    extension [Self <: ComponentsProps[?], ElementT /* <: HTMLElement */](x: Self & ComponentsProps[ElementT]) {
      ...
      inline def setChildren(value: Node | (js.Function1[/* props */ ChildFunctionProps[ElementT], Node])): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      inline def setChildrenFunction1(value: /* props */ ChildFunctionProps[ElementT] => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      inline def setRender(value: /* props */ ReactResizeDetectorDimensions => Node): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setOnResize(value: (/* width */ js.UndefOr[Double], /* height */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "onResize", js.Any.fromFunction2((t0: /* width */ js.UndefOr[Double], t1: /* height */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
  ...
  trait ResizeDetector[ElementT /* <: HTMLElement */] extends PureComponent[ComponentsProps[ElementT], ReactResizeDetectorDimensions, Any] {
    ...
    def getElement(): org.scalajs.dom.Element | Text | Null = js.native
