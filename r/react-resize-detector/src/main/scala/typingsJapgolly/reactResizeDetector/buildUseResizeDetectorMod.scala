...
import typingsJapgolly.reactResizeDetector.anon.FnCall
import typingsJapgolly.reactResizeDetector.buildResizeDetectorMod.Props
...
object buildUseResizeDetectorMod {
