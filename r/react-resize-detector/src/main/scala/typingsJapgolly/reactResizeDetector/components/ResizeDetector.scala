...
import typingsJapgolly.reactResizeDetector.buildResizeDetectorMod.default
...
object ResizeDetector {
  ...
  implicit def make[ElementT /* <: HTMLElement */](companion: ResizeDetector.type): SharedBuilder_ComponentsProps2056989417[default[ElementT], ElementT] = new SharedBuilder_ComponentsProps2056989417[default[ElementT], ElementT](js.Array(this.component, js.Dictionary.empty))()
