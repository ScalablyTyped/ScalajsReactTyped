package typingsJapgolly.reactSvgMap
...
object mod {
  ...
  trait BaseMapProps extends StObject {
    ...
    var childrenAfter: js.UndefOr[Element] = js.undefined
    
    var childrenBefore: js.UndefOr[Element] = js.undefined
  ...
  object BaseMapProps {
    ...
    extension [Self <: BaseMapProps](x: Self) {
      ...
      inline def setChildrenAfter(value: VdomElement): Self = StObject.set(x, "childrenAfter", value.rawElement.asInstanceOf[js.Any])
      
      inline def setChildrenAfterUndefined: Self = StObject.set(x, "childrenAfter", js.undefined)
      
      inline def setChildrenBefore(value: VdomElement): Self = StObject.set(x, "childrenBefore", value.rawElement.asInstanceOf[js.Any])
