...
version := "14.1-dt-20220824Z-6e11da"
scalaVersion := "3.1.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "react-relay" % "14.1-dt-20220927Z-d767d9",
  "org.scalablytyped.japgolly" %%% "relay-runtime" % "14.1-dt-20220915Z-b0d13f",
