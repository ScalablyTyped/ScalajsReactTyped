...
version := "6.0-dt-20191003Z-a5a266"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "react-relay" % "7.0-dt-20191126Z-b6a35c",
  "org.scalablytyped.japgolly" %%% "relay-runtime" % "8.0-dt-20200225Z-58674b",
