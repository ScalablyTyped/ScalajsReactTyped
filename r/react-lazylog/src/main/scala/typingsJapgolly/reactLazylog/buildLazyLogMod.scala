...
object buildLazyLogMod {
  ...
  object WebsocketOptions {
    ...
    extension [Self <: WebsocketOptions](x: Self) {
      ...
      inline def setOnClose(value: /* e */ CloseEvent => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* e */ CloseEvent) => value(t0).runNow()))
      ...
      inline def setOnOpen(value: (/* e */ Event, /* socket */ WebSocket) => Callback): Self = StObject.set(x, "onOpen", js.Any.fromFunction2((t0: /* e */ Event, t1: /* socket */ WebSocket) => (value(t0, t1)).runNow()))
