...
trait DropPosition extends StObject {
  ...
  var direction: typingsJapgolly.rcTree.esInterfaceMod.Direction
...
object DropPosition {
  ...
  extension [Self <: DropPosition](x: Self) {
    ...
    inline def setDirection(value: typingsJapgolly.rcTree.esInterfaceMod.Direction): Self = StObject.set(x, "direction", value.asInstanceOf[js.Any])
