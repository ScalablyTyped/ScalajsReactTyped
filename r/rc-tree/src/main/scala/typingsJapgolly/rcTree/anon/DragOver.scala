...
trait DragOver extends StObject {
  ...
  var eventKey: typingsJapgolly.rcTree.esInterfaceMod.Key
...
object DragOver {
  ...
  inline def apply(
    ...
    eventKey: typingsJapgolly.rcTree.esInterfaceMod.Key,
    expanded: Boolean,
    halfChecked: Boolean,
    loaded: Boolean,
    loading: Boolean,
  ...
  extension [Self <: DragOver](x: Self) {
    ...
    inline def setEventKey(value: typingsJapgolly.rcTree.esInterfaceMod.Key): Self = StObject.set(x, "eventKey", value.asInstanceOf[js.Any])
