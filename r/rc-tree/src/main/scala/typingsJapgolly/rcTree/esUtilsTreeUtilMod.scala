...
import typingsJapgolly.rcTree.anon.ChildrenPropName
import typingsJapgolly.rcTree.anon.DragOver
import typingsJapgolly.rcTree.anon.Index
import typingsJapgolly.rcTree.anon.KeyEntities
import typingsJapgolly.rcTree.anon.RequiredFieldNames
...
import typingsJapgolly.rcTree.esInterfaceMod.GetKey
...
object esUtilsTreeUtilMod {
  ...
  inline def convertTreeToData(rootNodes: Node): js.Array[DataNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("convertTreeToData")(rootNodes.asInstanceOf[js.Any]).asInstanceOf[js.Array[DataNode]]
