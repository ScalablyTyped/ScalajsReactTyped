...
import typingsJapgolly.rcTree.esTreeNodeMod.InternalTreeNodeProps
...
object InternalTreeNode {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.rcTree.esTreeNodeMod.InternalTreeNode] {
    ...
    inline def context(value: TreeContextProps[DataNode]): this.type = set("context", value.asInstanceOf[js.Any])
