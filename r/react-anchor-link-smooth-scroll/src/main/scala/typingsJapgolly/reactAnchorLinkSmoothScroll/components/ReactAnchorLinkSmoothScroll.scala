package typingsJapgolly.reactAnchorLinkSmoothScroll.components
...
import typingsJapgolly.reactAnchorLinkSmoothScroll.mod.AnchorLinkProps
import typingsJapgolly.reactAnchorLinkSmoothScroll.mod.default
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ReactAnchorLinkSmoothScroll {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def offset(value: String | Double | js.Function0[Double]): this.type = set("offset", value.asInstanceOf[js.Any])
    
    inline def offsetCallbackTo(value: CallbackTo[Double]): this.type = set("offset", value.toJsFn)
  ...
  implicit def make(companion: ReactAnchorLinkSmoothScroll.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
