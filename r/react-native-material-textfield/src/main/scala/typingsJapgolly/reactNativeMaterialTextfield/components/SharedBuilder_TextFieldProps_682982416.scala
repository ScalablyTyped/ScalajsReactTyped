...
import typingsJapgolly.reactNativeMaterialTextfield.mod.ContentInset
import typingsJapgolly.reactNativeMaterialTextfield.mod.LabelOffset
...
@scala.inline
open class SharedBuilder_TextFieldProps_682982416[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def disabledLineType(
    value: solid | dotted | dashed | typingsJapgolly.reactNativeMaterialTextfield.reactNativeMaterialTextfieldStrings.none
  ...
  inline def onPress(value: /* event */ Event => Callback): this.type = set("onPress", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
