...
abstract class SharedApply_TextFieldProps_139653960[ComponentRef] () {
  ...
  def apply(
    ...
    disabledLineType: solid | dotted | dashed | typingsJapgolly.reactNativeMaterialTextfield.reactNativeMaterialTextfieldStrings.none = null,
    ...
    lineType: solid | dotted | dashed | typingsJapgolly.reactNativeMaterialTextfield.reactNativeMaterialTextfieldStrings.none = null,
    ...
    renderLeftAccessory: js.UndefOr[CallbackTo[japgolly.scalajs.react.raw.React.Element]] = js.undefined,
    renderRightAccessory: js.UndefOr[CallbackTo[japgolly.scalajs.react.raw.React.Element]] = js.undefined,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextFieldProps, ComponentRef, Unit, TextFieldProps] = {
  ...
  typingsJapgolly.reactNativeMaterialTextfield.mod.TextFieldProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaterialTextfield.mod.TextFieldProps])(children: _*)
  }
}
