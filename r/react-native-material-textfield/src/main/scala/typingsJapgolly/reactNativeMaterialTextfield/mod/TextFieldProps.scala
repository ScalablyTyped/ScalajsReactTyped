package typingsJapgolly.reactNativeMaterialTextfield.mod
...
import typingsJapgolly.reactNativeMaterialTextfield.reactNativeMaterialTextfieldStrings.dashed
import typingsJapgolly.reactNativeMaterialTextfield.reactNativeMaterialTextfieldStrings.dotted
import typingsJapgolly.reactNativeMaterialTextfield.reactNativeMaterialTextfieldStrings.none
import typingsJapgolly.reactNativeMaterialTextfield.reactNativeMaterialTextfieldStrings.solid
...
trait TextFieldProps extends TextInputProps {
  ...
  var onPress: js.UndefOr[js.Function1[/* event */ Event_, Unit]] = js.undefined
...
object TextFieldProps {
  ...
  def apply(
    ...
    autoCapitalize: typingsJapgolly.reactNative.reactNativeStrings.none | sentences | words | characters = null,
    ...
    formatText: /* text */ String => CallbackTo[String] = null,
    ...
    onPress: /* event */ Event_ => Callback = null,
    ...
    renderLeftAccessory: js.UndefOr[CallbackTo[Element]] = js.undefined,
    renderRightAccessory: js.UndefOr[CallbackTo[Element]] = js.undefined,
    ...
    if (formatText != null) __obj.updateDynamic("formatText")(js.Any.fromFunction1((t0: /* text */ java.lang.String) => formatText(t0).runNow()))
    ...
    if (onPress != null) __obj.updateDynamic("onPress")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onPress(t0).runNow()))
    ...
    renderLeftAccessory.foreach(p => __obj.updateDynamic("renderLeftAccessory")(p.toJsFn))
    renderRightAccessory.foreach(p => __obj.updateDynamic("renderRightAccessory")(p.toJsFn))
