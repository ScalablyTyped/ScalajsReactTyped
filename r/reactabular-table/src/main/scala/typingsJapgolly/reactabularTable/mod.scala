...
import typingsJapgolly.reactabularTable.anon.Cell
import typingsJapgolly.reactabularTable.anon.ColumnIndex
import typingsJapgolly.reactabularTable.anon.Draggable
import typingsJapgolly.reactabularTable.anon.Formatters
import typingsJapgolly.reactabularTable.anon.PartialCSSStyleDeclaratio
import typingsJapgolly.reactabularTable.anon.Property
import typingsJapgolly.reactabularTable.anon.Row
import typingsJapgolly.reactabularTable.anon.RowData
...
object mod {
  ...
  type CellFormatter = js.Function2[
    /* value */ Any, 
    /* props */ typingsJapgolly.reactabularTable.anon.Column, 
    String | Element
  ]
  ...
  object Renderers {
    ...
    extension [Self <: Renderers](x: Self) {
      ...
      inline def setTableCallbackTo(value: CallbackTo[Element]): Self = StObject.set(x, "table", value.toJsFn)
