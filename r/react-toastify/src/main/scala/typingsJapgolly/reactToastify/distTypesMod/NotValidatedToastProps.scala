...
trait NotValidatedToastProps extends StObject {
  ...
  var closeButton: js.UndefOr[Boolean | (js.Function1[/* props */ CloseButtonProps, Node]) | Element] = js.undefined
  ...
  var icon: js.UndefOr[
    Boolean | (js.Function1[/* props */ IconProps, Node]) | Element | String | Double | Node
  ] = js.undefined
  ...
  var onClick: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[org.scalajs.dom.Element], Unit]] = js.undefined
