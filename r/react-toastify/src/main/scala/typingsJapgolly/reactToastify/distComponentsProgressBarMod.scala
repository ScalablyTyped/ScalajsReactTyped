...
object distComponentsProgressBarMod {
  ...
  object ProgressBarProps {
    ...
    inline def apply(closeToast: Callback, delay: Double, isRunning: Boolean, theme: Theme, `type`: TypeOptions): ProgressBarProps = {
      val __obj = js.Dynamic.literal(closeToast = closeToast.toJsFn, delay = delay.asInstanceOf[js.Any], isRunning = isRunning.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any])
