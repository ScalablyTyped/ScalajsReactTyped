...
import typingsJapgolly.reactCssThemr.anon.MapThemrProps
import typingsJapgolly.reactCssThemr.anon.Theme
...
object mod {
  ...
  inline def themr(identifier: String): js.Function1[
    ...
    ]) | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify React.SFC<P> */ Any), 
  ...
  type ThemedComponent[P, S] = japgolly.scalajs.react.facade.React.Component[P & js.Object, js.Object]
  
  @js.native
  trait ThemedComponentClass[P, S]
    extends StObject
       with ComponentClass[P, js.Object]
       with Instantiable0[japgolly.scalajs.react.facade.React.Component[P & js.Object, js.Object]]
}
