...
import typingsJapgolly.reactLottie.anon.ClassName
...
object mod {
  ...
  object EventListener {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(callback = callback.toJsFn, eventName = eventName.asInstanceOf[js.Any])
  ...
  /**
    * Lottie allows you to render an animation from a JSON structure exported from Adobe After Effects using the Bodymovin plugin
    */
  type Lottie = japgolly.scalajs.react.facade.React.Component[LottieProps & js.Object, js.Object]
