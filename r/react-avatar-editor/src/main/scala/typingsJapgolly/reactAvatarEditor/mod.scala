package typingsJapgolly.reactAvatarEditor
...
object mod {
  ...
  object AvatarEditorProps {
    ...
    extension [Self <: AvatarEditorProps](x: Self) {
      ...
      inline def setOnImageChange(value: Callback): Self = StObject.set(x, "onImageChange", value.toJsFn)
      
      inline def setOnImageChangeUndefined: Self = StObject.set(x, "onImageChange", js.undefined)
      
      inline def setOnImageReady(value: /* event */ Event => Callback): Self = StObject.set(x, "onImageReady", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
      
      inline def setOnImageReadyUndefined: Self = StObject.set(x, "onImageReady", js.undefined)
      
      inline def setOnLoadFailure(value: /* event */ Event => Callback): Self = StObject.set(x, "onLoadFailure", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
      
      inline def setOnLoadFailureUndefined: Self = StObject.set(x, "onLoadFailure", js.undefined)
      
      inline def setOnLoadSuccess(value: /* imgInfo */ ImageState => Callback): Self = StObject.set(x, "onLoadSuccess", js.Any.fromFunction1((t0: /* imgInfo */ ImageState) => value(t0).runNow()))
      
      inline def setOnLoadSuccessUndefined: Self = StObject.set(x, "onLoadSuccess", js.undefined)
      
      inline def setOnMouseMove(value: /* event */ Event => Callback): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
      ...
      inline def setOnPositionChange(value: /* position */ Position => Callback): Self = StObject.set(x, "onPositionChange", js.Any.fromFunction1((t0: /* position */ Position) => value(t0).runNow()))
