...
import typingsJapgolly.rdfUtilsFs.fromFileMod.Options
...
object mod {
  ...
  def toFile: js.Function3[
    /* stream */ Stream[Quad], 
    /* filename */ PathLike, 
    /* options */ js.UndefOr[typingsJapgolly.rdfUtilsFs.toFileMod.Options], 
    js.Promise[Unit]
  ] = js.native
  ...
  inline def toFile(stream: Stream[Quad], filename: PathLike, options: typingsJapgolly.rdfUtilsFs.toFileMod.Options): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("toFile")(stream.asInstanceOf[js.Any], filename.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  inline def toFile_=(
    x: js.Function3[
      /* stream */ Stream[Quad], 
      /* filename */ PathLike, 
