package typingsJapgolly.reactToggle.components
...
import typingsJapgolly.reactToggle.mod.ToggleIcons
import typingsJapgolly.reactToggle.mod.ToggleProps
import typingsJapgolly.reactToggle.mod.default
...
object ReactToggle {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def icons(value: Boolean | ToggleIcons): this.type = set("icons", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ReactToggle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
