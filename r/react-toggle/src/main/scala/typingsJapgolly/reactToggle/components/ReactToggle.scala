...
object ReactToggle {
  ...
  typingsJapgolly.reactToggle.mod.ToggleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactToggle.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactToggle.mod.ToggleProps])(children: _*)
  }
