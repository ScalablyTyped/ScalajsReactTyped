...
object DotLoader {
  ...
  @JSImport("react-spinners/esm", "DotLoader")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: DotLoader.type): SharedBuilder_LoaderSizeProps_16572679[HTMLSpanElement] = new SharedBuilder_LoaderSizeProps_16572679[HTMLSpanElement](js.Array(this.component, js.Dictionary.empty))()
