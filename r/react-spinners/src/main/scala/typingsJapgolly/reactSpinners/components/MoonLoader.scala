...
object MoonLoader {
  ...
  @JSImport("react-spinners/esm", "MoonLoader")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: MoonLoader.type): SharedBuilder_LoaderSizeProps_16572679[HTMLSpanElement] = new SharedBuilder_LoaderSizeProps_16572679[HTMLSpanElement](js.Array(this.component, js.Dictionary.empty))()
