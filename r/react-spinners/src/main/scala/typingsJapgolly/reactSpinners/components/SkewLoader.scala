...
object SkewLoader {
  ...
  @JSImport("react-spinners/esm", "SkewLoader")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SkewLoader.type): SharedBuilder_LoaderSizeProps_16572679[HTMLSpanElement] = new SharedBuilder_LoaderSizeProps_16572679[HTMLSpanElement](js.Array(this.component, js.Dictionary.empty))()
