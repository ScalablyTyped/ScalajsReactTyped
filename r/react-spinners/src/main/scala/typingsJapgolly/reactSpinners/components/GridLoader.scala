...
object GridLoader {
  ...
  @JSImport("react-spinners/esm", "GridLoader")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: GridLoader.type): SharedBuilder_LoaderSizeMarginProps_1327159610[HTMLSpanElement] = new SharedBuilder_LoaderSizeMarginProps_1327159610[HTMLSpanElement](js.Array(this.component, js.Dictionary.empty))()
