...
import typingsJapgolly.rmcInputNumber.anon.Max
import typingsJapgolly.rmcInputNumber.rmcInputNumberStrings.down
import typingsJapgolly.rmcInputNumber.rmcInputNumberStrings.up
...
object libBaseMod {
  ...
  /* note: abstract class */ @JSImport("rmc-input-number/lib/base", JSImport.Default)
  @js.native
  open class default[P /* <: PropsType */, S /* <: StateType */] protected () extends BaseComponent[P, S] {
  ...
  object PropsType {
    ...
    extension [Self <: PropsType](x: Self) {
      ...
      inline def setOnBlur(value: /* e */ Any => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: /* e */ Any) => value(t0).runNow()))
      ...
      inline def setOnFocus(value: /* e */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: /* e */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setOnFocusUndefined: Self = StObject.set(x, "onFocus", js.undefined)
      
      inline def setParser(value: /* v */ Any => Callback): Self = StObject.set(x, "parser", js.Any.fromFunction1((t0: /* v */ Any) => value(t0).runNow()))
