...
import typingsJapgolly.reactMentions.AnonTarget
...
object MentionsInput {
  def apply(
    ...
    inputRef: RefHandle[HTMLInputElement | HTMLTextAreaElement] = null,
    is: String = null,
    itemID: String = null,
    ...
    onBlur: (/* event */ ReactFocusEventFrom[(HTMLInputElement | HTMLTextAreaElement) with Element], /* clickedSuggestion */ Boolean) => Callback = null,
    ...
    onChange: (/* event */ AnonTarget, /* newValue */ String, /* newPlainTextValue */ String, /* mentions */ js.Array[MentionItem]) => Callback = null,
    ...
    onKeyDown: /* event */ ReactKeyboardEventFrom[(HTMLInputElement | HTMLTextAreaElement) with Element] => Callback = null,
    ...
    onSelect: /* event */ ReactUIEventFrom[Element] => Callback = null,
    ...
    children: japgolly.scalajs.react.raw.React.Element | js.Array[japgolly.scalajs.react.raw.React.Element]
  ): UnmountedWithRoot[
    MentionsInputProps, 
    typingsJapgolly.reactMentions.mod.MentionsInput, 
    Unit, 
    MentionsInputProps
  ] = {
    ...
    if (onBlur != null) __obj.updateDynamic("onBlur")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactFocusEventFrom[
  (org.scalajs.dom.raw.HTMLInputElement | org.scalajs.dom.raw.HTMLTextAreaElement) with org.scalajs.dom.raw.Element], t1: /* clickedSuggestion */ scala.Boolean) => onBlur(t0, t1).runNow()))
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction4((t0: /* event */ typingsJapgolly.reactMentions.AnonTarget, t1: /* newValue */ java.lang.String, t2: /* newPlainTextValue */ java.lang.String, t3: /* mentions */ js.Array[typingsJapgolly.reactMentions.mod.MentionItem]) => onChange(t0, t1, t2, t3).runNow()))
    ...
    if (onKeyDown != null) __obj.updateDynamic("onKeyDown")(js.Any.fromFunction1((t0: /* event */ japgolly.scalajs.react.ReactKeyboardEventFrom[
  (org.scalajs.dom.raw.HTMLInputElement | org.scalajs.dom.raw.HTMLTextAreaElement) with org.scalajs.dom.raw.Element]) => onKeyDown(t0).runNow()))
    ...
    if (onSelect != null) __obj.updateDynamic("onSelect")(js.Any.fromFunction1((t0: /* event */ japgolly.scalajs.react.ReactUIEventFrom[org.scalajs.dom.raw.Element]) => onSelect(t0).runNow()))
  ...
  typingsJapgolly.reactMentions.mod.MentionsInputProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.reactMentions.mod.MentionsInput](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactMentions.mod.MentionsInputProps])
  }
