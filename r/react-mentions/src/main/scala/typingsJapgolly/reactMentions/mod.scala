...
import typingsJapgolly.reactMentions.anon.Target
import typingsJapgolly.reactMentions.reactMentionsStrings.`additions removals`
import typingsJapgolly.reactMentions.reactMentionsStrings.`additions text`
import typingsJapgolly.reactMentions.reactMentionsStrings.`inline`
import typingsJapgolly.reactMentions.reactMentionsStrings.`removals additions`
import typingsJapgolly.reactMentions.reactMentionsStrings.`removals text`
import typingsJapgolly.reactMentions.reactMentionsStrings.`text additions`
import typingsJapgolly.reactMentions.reactMentionsStrings.`text removals`
import typingsJapgolly.reactMentions.reactMentionsStrings.additions
import typingsJapgolly.reactMentions.reactMentionsStrings.all
import typingsJapgolly.reactMentions.reactMentionsStrings.ascending
import typingsJapgolly.reactMentions.reactMentionsStrings.assertive
import typingsJapgolly.reactMentions.reactMentionsStrings.both
import typingsJapgolly.reactMentions.reactMentionsStrings.copy
import typingsJapgolly.reactMentions.reactMentionsStrings.date
import typingsJapgolly.reactMentions.reactMentionsStrings.decimal
import typingsJapgolly.reactMentions.reactMentionsStrings.descending
import typingsJapgolly.reactMentions.reactMentionsStrings.dialog
import typingsJapgolly.reactMentions.reactMentionsStrings.email
import typingsJapgolly.reactMentions.reactMentionsStrings.execute
import typingsJapgolly.reactMentions.reactMentionsStrings.grammar
import typingsJapgolly.reactMentions.reactMentionsStrings.grid
import typingsJapgolly.reactMentions.reactMentionsStrings.horizontal
import typingsJapgolly.reactMentions.reactMentionsStrings.inherit
import typingsJapgolly.reactMentions.reactMentionsStrings.link
import typingsJapgolly.reactMentions.reactMentionsStrings.list
import typingsJapgolly.reactMentions.reactMentionsStrings.listbox
import typingsJapgolly.reactMentions.reactMentionsStrings.location
import typingsJapgolly.reactMentions.reactMentionsStrings.menu
import typingsJapgolly.reactMentions.reactMentionsStrings.mixed
import typingsJapgolly.reactMentions.reactMentionsStrings.move
import typingsJapgolly.reactMentions.reactMentionsStrings.no
import typingsJapgolly.reactMentions.reactMentionsStrings.none
import typingsJapgolly.reactMentions.reactMentionsStrings.numeric
import typingsJapgolly.reactMentions.reactMentionsStrings.off
import typingsJapgolly.reactMentions.reactMentionsStrings.on
import typingsJapgolly.reactMentions.reactMentionsStrings.other
import typingsJapgolly.reactMentions.reactMentionsStrings.page
import typingsJapgolly.reactMentions.reactMentionsStrings.polite
import typingsJapgolly.reactMentions.reactMentionsStrings.popup
import typingsJapgolly.reactMentions.reactMentionsStrings.removals
import typingsJapgolly.reactMentions.reactMentionsStrings.search
import typingsJapgolly.reactMentions.reactMentionsStrings.spelling
import typingsJapgolly.reactMentions.reactMentionsStrings.step
import typingsJapgolly.reactMentions.reactMentionsStrings.tel
import typingsJapgolly.reactMentions.reactMentionsStrings.text
import typingsJapgolly.reactMentions.reactMentionsStrings.time
import typingsJapgolly.reactMentions.reactMentionsStrings.tree
import typingsJapgolly.reactMentions.reactMentionsStrings.url
import typingsJapgolly.reactMentions.reactMentionsStrings.vertical
import typingsJapgolly.reactMentions.reactMentionsStrings.yes
...
object mod {
  ...
  @js.native
  open class MentionsInput protected ()
  ...
  @JSImport("react-mentions", "MentionsInput")
  @js.native
  val MentionsInput: ComponentClassP[MentionsInputProps & js.Object] = js.native
  ...
  object MentionProps {
    ...
    extension [Self <: MentionProps](x: Self) {
      ...
      inline def setOnAdd(value: (/* id */ String | Double, /* display */ String) => Callback): Self = StObject.set(x, "onAdd", js.Any.fromFunction2((t0: /* id */ String | Double, t1: /* display */ String) => (value(t0, t1)).runNow()))
  ...
  type MentionsInputClass = ComponentClassP[MentionsInputProps & js.Object]
  ...
  trait MentionsInputProps extends StObject {
    ...
    var customSuggestionsContainer: js.UndefOr[js.Function1[/* children */ Node, js.UndefOr[Node]]] = js.undefined
    ...
    var onBlur: js.UndefOr[
        js.Function2[
          /* event */ ReactFocusEventFrom[(HTMLInputElement | HTMLTextAreaElement) & org.scalajs.dom.Element], 
    ...
    var onKeyDown: js.UndefOr[
        js.Function1[
          /* event */ ReactKeyboardEventFrom[(HTMLInputElement | HTMLTextAreaElement) & org.scalajs.dom.Element], 
          Unit
        ]
      ] = js.undefined
    ...
    var onSelect: js.UndefOr[js.Function1[/* event */ ReactUIEventFrom[org.scalajs.dom.Element], Unit]] = js.undefined
    ...
    var suggestionsPortalHost: js.UndefOr[org.scalajs.dom.Element] = js.undefined
  ...
  object MentionsInputProps {
    ...
    inline def apply(children: Element | js.Array[Element]): MentionsInputProps = {
    ...
    extension [Self <: MentionsInputProps](x: Self) {
      ...
      inline def setCustomSuggestionsContainer(value: /* children */ Node => js.UndefOr[Node]): Self = StObject.set(x, "customSuggestionsContainer", js.Any.fromFunction1(value))
      ...
      inline def setOnBlur(
        value: (/* event */ ReactFocusEventFrom[(HTMLInputElement | HTMLTextAreaElement) & org.scalajs.dom.Element], /* clickedSuggestion */ Boolean) => Callback
      ): Self = StObject.set(x, "onBlur", js.Any.fromFunction2((t0: /* event */ ReactFocusEventFrom[(HTMLInputElement | HTMLTextAreaElement) & org.scalajs.dom.Element], t1: /* clickedSuggestion */ Boolean) => (value(t0, t1)).runNow()))
      ...
      inline def setOnChange(
        value: (/* event */ Target, /* newValue */ String, /* newPlainTextValue */ String, /* mentions */ js.Array[MentionItem]) => Callback
      ): Self = StObject.set(x, "onChange", js.Any.fromFunction4((t0: /* event */ Target, t1: /* newValue */ String, t2: /* newPlainTextValue */ String, t3: /* mentions */ js.Array[MentionItem]) => (value(t0, t1, t2, t3)).runNow()))
      ...
      inline def setOnKeyDown(
        value: /* event */ ReactKeyboardEventFrom[(HTMLInputElement | HTMLTextAreaElement) & org.scalajs.dom.Element] => Callback
      ): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1((t0: /* event */ ReactKeyboardEventFrom[(HTMLInputElement | HTMLTextAreaElement) & org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setOnSelect(value: /* event */ ReactUIEventFrom[org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction1((t0: /* event */ ReactUIEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setSuggestionsPortalHost(value: org.scalajs.dom.Element): Self = StObject.set(x, "suggestionsPortalHost", value.asInstanceOf[js.Any])
