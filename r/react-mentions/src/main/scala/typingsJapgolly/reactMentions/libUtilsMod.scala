...
import typingsJapgolly.reactMentions.anon.PartialConfig
import typingsJapgolly.reactMentions.anon.Results
import typingsJapgolly.reactMentions.libUtilsApplyChangeToValueMod.Config
import typingsJapgolly.reactMentions.libUtilsApplyChangeToValueMod.Options
import typingsJapgolly.reactMentions.libUtilsGetMentionsMod.Mention
import typingsJapgolly.reactMentions.libUtilsIterateMentionsMarkupMod.MarkupIterateeFunction
import typingsJapgolly.reactMentions.libUtilsIterateMentionsMarkupMod.TextIterateeFunction
import typingsJapgolly.reactMentions.reactMentionsInts.`0`
import typingsJapgolly.reactMentions.reactMentionsInts.`1`
...
import typingsJapgolly.reactMentions.reactMentionsStrings.display
import typingsJapgolly.reactMentions.reactMentionsStrings.id
...
object libUtilsMod {
  ...
  object PLACEHOLDERS extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.reactMentions.libUtilsPlaceholdersMod.PLACEHOLDERS & String] = js.native
  ...
  inline def readConfigFromChildren(children: Node): js.Array[Config] = ^.asInstanceOf[js.Dynamic].applyDynamic("readConfigFromChildren")(children.asInstanceOf[js.Any]).asInstanceOf[js.Array[Config]]
