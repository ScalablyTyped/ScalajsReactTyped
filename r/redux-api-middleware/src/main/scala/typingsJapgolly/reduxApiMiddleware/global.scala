...
import typingsJapgolly.reduxApiMiddleware.mod.CreateMiddlewareOptions
import typingsJapgolly.reduxApiMiddleware.mod.RSAAAction
import typingsJapgolly.reduxApiMiddleware.mod.RSAACall
...
object global {
  ...
  object ReduxApiMiddleware {
    ...
    open class ApiError[T] protected ()
      extends typingsJapgolly.reduxApiMiddleware.mod.ApiError[T] {
    ...
    open class InternalError protected ()
      extends typingsJapgolly.reduxApiMiddleware.mod.InternalError {
    ...
    open class InvalidRSAA protected ()
      extends typingsJapgolly.reduxApiMiddleware.mod.InvalidRSAA {
    ...
    open class RequestError protected ()
      extends typingsJapgolly.reduxApiMiddleware.mod.RequestError {
      def this(message: String) = this()
    }
