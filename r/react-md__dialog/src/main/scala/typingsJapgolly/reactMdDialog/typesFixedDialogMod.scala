...
object typesFixedDialogMod {
  ...
  trait BaseFixedDialogProps extends StObject {
    ...
    /**
      ...
      * - null
      */
    var fixedTo: RefHandle[HTMLElement]
  ...
  object BaseFixedDialogProps {
    ...
    inline def apply(fixedTo: RefHandle[HTMLElement], id: String, onRequestClose: Callback, visible: Boolean): BaseFixedDialogProps = {
      val __obj = js.Dynamic.literal(fixedTo = fixedTo.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], onRequestClose = onRequestClose.toJsFn, visible = visible.asInstanceOf[js.Any])
    ...
    extension [Self <: BaseFixedDialogProps](x: Self) {
      ...
      inline def setFixedTo(value: RefHandle[HTMLElement]): Self = StObject.set(x, "fixedTo", value.asInstanceOf[js.Any])
      ...
      inline def setGetOptions(value: CallbackTo[CalculateFixedPositionOptions]): Self = StObject.set(x, "getOptions", value.toJsFn)
