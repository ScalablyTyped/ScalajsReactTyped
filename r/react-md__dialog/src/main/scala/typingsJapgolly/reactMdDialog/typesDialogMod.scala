...
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.`full-page`
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.alertdialog
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.centered
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.custom
...
import typingsJapgolly.reactMdUtils.typesWiaAriaFocusContainerMod.FocusContainerOptionsProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object typesDialogMod {
  ...
  object BaseDialogProps {
    ...
    inline def apply(id: String, onRequestClose: Callback, visible: Boolean): BaseDialogProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], onRequestClose = onRequestClose.toJsFn, visible = visible.asInstanceOf[js.Any])
