...
object DialogFooter {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def align(value: DialogFooterAlignment): this.type = set("align", value.asInstanceOf[js.Any])
  ...
  def withProps(p: DialogFooterProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
