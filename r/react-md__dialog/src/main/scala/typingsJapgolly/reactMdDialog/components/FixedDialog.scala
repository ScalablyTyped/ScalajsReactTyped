...
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.`additions removals`
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.`additions text`
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.`inline`
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.`removals additions`
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.`removals text`
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.`text additions`
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.`text removals`
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.additions
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.alertdialog
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.all
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.ascending
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.assertive
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.both
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.copy
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.date
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.decimal
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.descending
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.dialog
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.div
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.email
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.execute
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.first
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.grammar
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.grid
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.horizontal
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.inherit
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.last
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.link
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.list
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.listbox
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.location
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.menu
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.mixed
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.move
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.nav
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.no
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.none
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.numeric
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.off
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.on
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.other
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.page
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.polite
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.popup
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.removals
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.search
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.spelling
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.step
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.tel
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.text
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.time
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.tree
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.url
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.vertical
import typingsJapgolly.reactMdDialog.reactMdDialogStrings.yes
...
object FixedDialog {
  ...
  inline def apply(fixedTo: RefHandle[HTMLElement], id: String, onRequestClose: Callback, visible: Boolean): Builder = {
    val __props = js.Dynamic.literal(fixedTo = fixedTo.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], onRequestClose = onRequestClose.toJsFn, visible = visible.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[FixedDialogProps & RefAttributes[HTMLDivElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def forceContainer(value: Boolean): this.type = set("forceContainer", value.asInstanceOf[js.Any])
    
    inline def getOptions(value: CallbackTo[CalculateFixedPositionOptions]): this.type = set("getOptions", value.toJsFn)
    ...
    inline def options(value: CalculateFixedPositionOptions): this.type = set("options", value.asInstanceOf[js.Any])
    ...
    inline def role(value: dialog | alertdialog | menu | none): this.type = set("role", value.asInstanceOf[js.Any])
  ...
  def withProps(p: FixedDialogProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
