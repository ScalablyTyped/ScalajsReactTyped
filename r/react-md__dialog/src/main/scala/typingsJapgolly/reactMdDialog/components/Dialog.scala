...
object Dialog {
  ...
  inline def apply(id: String, onRequestClose: Callback, visible: Boolean): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[DialogProps & RefAttributes[HTMLDivElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def role(
      value: typingsJapgolly.reactMdDialog.reactMdDialogStrings.dialog | alertdialog | typingsJapgolly.reactMdDialog.reactMdDialogStrings.menu | typingsJapgolly.reactMdDialog.reactMdDialogStrings.none
    ): this.type = set("role", value.asInstanceOf[js.Any])
    ...
    inline def `type`(value: `full-page` | centered | custom): this.type = set("type", value.asInstanceOf[js.Any])
  ...
  def withProps(p: DialogProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
