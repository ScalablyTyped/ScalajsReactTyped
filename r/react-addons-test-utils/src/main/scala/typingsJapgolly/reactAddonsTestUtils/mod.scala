...
object mod {
  ...
  inline def isCompositeComponentWithType[T /* <: Component[Any & js.Object, js.Object] */, C /* <: ComponentClassP[Any & js.Object] */](instance: ReactInstance, `type`: ClassType[Any, T, C]): T = (^.asInstanceOf[js.Dynamic].applyDynamic("isCompositeComponentWithType")(instance.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  inline def isElementOfType_PTC[P, T /* <: Component[P & js.Object, js.Object] */, C /* <: ComponentClassP[P & js.Object] */](element: japgolly.scalajs.react.facade.React.Element, `type`: ClassType[P, T, C]): /* is react.react.CElement<P, T> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isElementOfType")(element.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[/* is react.react.CElement<P, T> */ Boolean]
  ...
  inline def renderIntoDocument[T /* <: Component[Any & js.Object, js.Object] */](element: CElement[Any, T]): T = ^.asInstanceOf[js.Dynamic].applyDynamic("renderIntoDocument")(element.asInstanceOf[js.Any]).asInstanceOf[T]
