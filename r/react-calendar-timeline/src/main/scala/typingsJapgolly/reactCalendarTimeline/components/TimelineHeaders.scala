...
object TimelineHeaders {
  def apply(
    ...
    typingsJapgolly.reactCalendarTimeline.mod.TimelineHeaders, 
    Unit, 
    HTMLAttributes[Element]
  ] = {
  ...
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.Element], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactCalendarTimeline.mod.TimelineHeaders](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.Element]])(children: _*)
  }
