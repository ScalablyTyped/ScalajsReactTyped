package typingsJapgolly.riderizePassportStravaOauth2

import typingsJapgolly.express.mod.Request_
import typingsJapgolly.riderizePassportStravaOauth2.anon.FamilyName
import typingsJapgolly.riderizePassportStravaOauth2.anon.Value
import typingsJapgolly.riderizePassportStravaOauth2.riderizePassportStravaOauth2Booleans.`true`
