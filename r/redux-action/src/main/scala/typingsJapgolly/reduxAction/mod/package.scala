...
package object mod {
  ...
  type ReducerHandler[State] = js.Function3[
    ...
    /* action */ js.UndefOr[typingsJapgolly.reduxAction.mod.BaseAction], 
    State
  ]
  type ReducerHandlers[State] = org.scalablytyped.runtime.StringDictionary[typingsJapgolly.reduxAction.mod.ReducerHandler[State]]
  type ThunkAction[Payload] = js.Function2[
    /* dispatch */ typingsJapgolly.redux.mod.Dispatch[js.Any], 
    /* getState */ js.Function0[js.Any], 
    js.Promise[typingsJapgolly.reduxAction.mod.Action[Payload]]
  ]
  type ThunkMetaAction[Payload, Meta] = js.Function2[
    /* dispatch */ typingsJapgolly.redux.mod.Dispatch[js.Any], 
    /* getState */ js.Function0[js.Any], 
    js.Promise[typingsJapgolly.reduxAction.mod.MetaAction[Payload, Meta]]
  ]
}
