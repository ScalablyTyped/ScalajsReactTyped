package typingsJapgolly.reactNativeGoogleSignin

import japgolly.scalajs.react.Callback
import typingsJapgolly.react.mod.Component
import typingsJapgolly.reactNative.mod.ViewProps
import typingsJapgolly.reactNativeGoogleSignin.anon.Email
import typingsJapgolly.reactNativeGoogleSignin.mod.GoogleSigninButton.Color
import typingsJapgolly.reactNativeGoogleSignin.mod.GoogleSigninButton.Size
  ...
  object GoogleSigninButton {
    ...
    object Color extends StObject {
      ...
      sealed trait Dark
        extends StObject
           with Color
      /* 1 */ val Dark: typingsJapgolly.reactNativeGoogleSignin.mod.GoogleSigninButton.Color.Dark & Double = js.native
      
      @js.native
      sealed trait Light
        extends StObject
           with Color
      /* 0 */ val Light: typingsJapgolly.reactNativeGoogleSignin.mod.GoogleSigninButton.Color.Light & Double = js.native
    }
    ...
    object Size extends StObject {
      ...
      sealed trait Icon
        extends StObject
           with Size
      /* 2 */ val Icon: typingsJapgolly.reactNativeGoogleSignin.mod.GoogleSigninButton.Size.Icon & Double = js.native
      
      @js.native
      sealed trait Standard
        extends StObject
           with Size
      /* 0 */ val Standard: typingsJapgolly.reactNativeGoogleSignin.mod.GoogleSigninButton.Size.Standard & Double = js.native
      
      @js.native
      sealed trait Wide
        extends StObject
           with Size
      /* 1 */ val Wide: typingsJapgolly.reactNativeGoogleSignin.mod.GoogleSigninButton.Size.Wide & Double = js.native
    }
  }
