package typingsJapgolly.reactNativeGoogleSignin.components
...
import typingsJapgolly.reactNativeGoogleSignin.mod.GoogleSigninButtonProps
...
object GoogleSigninButton {
  def apply(
    ...
    typingsJapgolly.reactNativeGoogleSignin.mod.GoogleSigninButton, 
    Unit, 
    GoogleSigninButtonProps
  ] = {
  ...
  typingsJapgolly.reactNativeGoogleSignin.mod.GoogleSigninButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeGoogleSignin.mod.GoogleSigninButton](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeGoogleSignin.mod.GoogleSigninButtonProps])(children: _*)
  }
