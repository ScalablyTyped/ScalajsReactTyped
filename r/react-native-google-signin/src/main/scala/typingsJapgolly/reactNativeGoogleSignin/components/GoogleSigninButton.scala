...
object GoogleSigninButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeGoogleSignin.mod.GoogleSigninButton] {
  ...
  implicit def make(companion: GoogleSigninButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GoogleSigninButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
