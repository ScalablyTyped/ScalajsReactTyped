...
import typingsJapgolly.redisSearch.distCommandsSuggetWITHSCORESMod.SuggestionWithScores
...
object distCommandsSuggetWITHSCORESWITHPAYLOADSMod {
  ...
  - typingsJapgolly.redisSearch.distCommandsSuggetWITHPAYLOADSMod.SuggestionWithPayload because var conflicts: suggestion. Inlined payload */ trait SuggestionWithScoresAndPayloads
    extends StObject
