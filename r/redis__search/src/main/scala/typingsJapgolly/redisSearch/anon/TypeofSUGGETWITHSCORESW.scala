...
import typingsJapgolly.redisSearch.distCommandsSuggetMod.SugGetOptions
import typingsJapgolly.redisSearch.distCommandsSuggetWITHSCORESWITHPAYLOADSMod.SuggestionWithScoresAndPayloads
