...
object FontIcon {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def forceFontSize(value: Boolean): this.type = set("forceFontSize", value.asInstanceOf[js.Any])
  ...
  def withProps(p: FontIconProps & RefAttributes[HTMLElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
