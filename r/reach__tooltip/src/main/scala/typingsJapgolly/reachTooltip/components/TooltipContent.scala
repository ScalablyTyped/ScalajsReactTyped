...
object TooltipContent {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BaseTooltipProps, LegacyRef[HTMLDivElement], Unit, BaseTooltipProps] = {
  ...
  typingsJapgolly.reachTooltip.mod.BaseTooltipProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLDivElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reachTooltip.mod.BaseTooltipProps])(children: _*)
  }
