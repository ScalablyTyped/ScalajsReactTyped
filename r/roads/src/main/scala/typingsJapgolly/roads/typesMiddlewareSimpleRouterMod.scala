...
import typingsJapgolly.roads.typesCoreRoadMod.NextCallback
...
object typesMiddlewareSimpleRouterMod {
  ...
  open class SimpleRouter () extends StObject {
    ...
    /* protected */ def _middleware(
      ...
      next: NextCallback
    ): js.Promise[typingsJapgolly.roads.typesCoreResponseMod.default | String] = js.native
  ...
  type Route[ContextType /* <: Context */] = js.ThisFunction4[
    ...
    /* next */ NextCallback, 
    js.Promise[typingsJapgolly.roads.typesCoreResponseMod.default]
  ]
  ...
  trait RouteDetails extends StObject {
    ...
    def route(path: SimpleRouterURL, body: String, headers: IncomingHeaders, next: NextCallback): js.Promise[typingsJapgolly.roads.typesCoreResponseMod.default]
    @JSName("route")
