...
object requestMod extends js.Object {
  ...
  trait Request extends js.Object {
    ...
    /**
      ...
      */
    def request(method: String, path: String): js.Promise[typingsJapgolly.roads.responseMod.default] = js.native
    def request(method: String, path: String, body: String): js.Promise[typingsJapgolly.roads.responseMod.default] = js.native
    def request(method: String, path: String, body: String, headers: StringDictionary[js.Any]): js.Promise[typingsJapgolly.roads.responseMod.default] = js.native
  }
