...
object typesCoreRoadMod {
  ...
  type Middleware[MiddlewareContext /* <: Context */] = js.ThisFunction5[
    ...
    /* next */ NextCallback, 
    (js.Promise[typingsJapgolly.roads.typesCoreResponseMod.default | String]) | typingsJapgolly.roads.typesCoreResponseMod.default | String
  ]
  
  type NextCallback = js.Function0[js.Promise[typingsJapgolly.roads.typesCoreResponseMod.default | String]]
  ...
  trait Road extends StObject {
    ...
    /**
      ...
      */
    def request(method: String, url: String): js.Promise[typingsJapgolly.roads.typesCoreResponseMod.default] = js.native
    def request(method: String, url: String, body: String): js.Promise[typingsJapgolly.roads.typesCoreResponseMod.default] = js.native
    def request(method: String, url: String, body: String, headers: IncomingHeaders): js.Promise[typingsJapgolly.roads.typesCoreResponseMod.default] = js.native
    def request(method: String, url: String, body: Unit, headers: IncomingHeaders): js.Promise[typingsJapgolly.roads.typesCoreResponseMod.default] = js.native
