package typingsJapgolly.roads.roadMod
...
trait Road extends js.Object {
  ...
  /**
    ...
    */
  /* protected */ def _executeRoute(route: ResponseMiddleware): js.Promise[typingsJapgolly.roads.responseMod.default] = js.native
  /**
    *
    ...
    */
  def request(method: String, url: String): js.Promise[typingsJapgolly.roads.responseMod.default] = js.native
  def request(method: String, url: String, body: String): js.Promise[typingsJapgolly.roads.responseMod.default] = js.native
  def request(method: String, url: String, body: String, headers: js.Object): js.Promise[typingsJapgolly.roads.responseMod.default] = js.native
  /**
