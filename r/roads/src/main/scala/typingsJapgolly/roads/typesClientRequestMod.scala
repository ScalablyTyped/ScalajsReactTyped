...
import typingsJapgolly.roads.typesCoreRoadMod.IncomingHeaders
...
object typesClientRequestMod {
  ...
  trait Request extends StObject {
    ...
    /**
      ...
      */
    def request(method: String, path: String): js.Promise[typingsJapgolly.roads.typesCoreResponseMod.default] = js.native
    def request(method: String, path: String, body: String): js.Promise[typingsJapgolly.roads.typesCoreResponseMod.default] = js.native
    def request(method: String, path: String, body: String, headers: IncomingHeaders): js.Promise[typingsJapgolly.roads.typesCoreResponseMod.default] = js.native
    def request(method: String, path: String, body: Unit, headers: IncomingHeaders): js.Promise[typingsJapgolly.roads.typesCoreResponseMod.default] = js.native
