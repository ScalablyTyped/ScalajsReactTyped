...
import typingsJapgolly.roads.simpleRouterMod.default
...
object middlewareMod extends js.Object {
  ...
  class SimpleRouter () extends default {
    def this(road: typingsJapgolly.roads.roadMod.default) = this()
  }
  ...
  def reroute(key: String, road: typingsJapgolly.roads.roadMod.default): Middleware = js.native
}
