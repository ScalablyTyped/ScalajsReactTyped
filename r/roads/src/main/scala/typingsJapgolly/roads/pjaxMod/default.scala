...
class default protected () extends RoadsPjax {
  ...
  /* CompleteClass */
  override var _road: typingsJapgolly.roads.roadMod.default = js.native
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def render(response_object: typingsJapgolly.roads.responseMod.default): Unit = js.native
}
