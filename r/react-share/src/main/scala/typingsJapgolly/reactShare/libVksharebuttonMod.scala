...
object libVksharebuttonMod extends Shortcut {
  
  @JSImport("react-share/lib/VKShareButton", JSImport.Default)
  @js.native
  val default: ForwardRefExoticComponent[OmitPropsOptionsforwardedAriaactivedescendant] = js.native
  ...
  type _To = ForwardRefExoticComponent[OmitPropsOptionsforwardedAriaactivedescendant]
  
  /* This means you don't have to write `default`, but can instead just say `libVksharebuttonMod.foo` */
  override def _to: ForwardRefExoticComponent[OmitPropsOptionsforwardedAriaactivedescendant] = default
}
