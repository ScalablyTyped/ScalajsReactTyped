...
import typingsJapgolly.reactShare.anon.OmitPropstitlestringundefAriaatomic
...
object TwitterShareButton {
  ...
  inline def apply(url: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitPropstitlestringundefAriaatomic]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def hashtags(value: js.Array[String]): this.type = set("hashtags", value.asInstanceOf[js.Any])
    
    inline def hashtagsVarargs(value: String*): this.type = set("hashtags", js.Array(value*))
    ...
    inline def related(value: js.Array[String]): this.type = set("related", value.asInstanceOf[js.Any])
    
    inline def relatedVarargs(value: String*): this.type = set("related", js.Array(value*))
    ...
    inline def via(value: String): this.type = set("via", value.asInstanceOf[js.Any])
  ...
  def withProps(p: OmitPropstitlestringundefAriaatomic): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
