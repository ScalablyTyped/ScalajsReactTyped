...
import typingsJapgolly.reactShare.anon.OmitPropsmediastringdescr
...
object PinterestShareButton {
  ...
  inline def apply(media: String, url: String): Builder = {
    val __props = js.Dynamic.literal(media = media.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitPropsmediastringdescr]))
  }
  ...
  def withProps(p: OmitPropsmediastringdescr): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
