...
import typingsJapgolly.reactShare.CommonShareButtonPropsquo
...
abstract class SharedApply_CommonShareButtonPropsquo_1974579907 () {
  ...
  def apply(
    ...
    MountedWithRawType[
      CommonShareButtonPropsquo, 
      js.Object, 
      RawMounted[CommonShareButtonPropsquo, js.Object]
    ]
  ] = {
  ...
  typingsJapgolly.reactShare.CommonShareButtonPropsquo, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactShare.CommonShareButtonPropsquo])(children: _*)
  }
}
