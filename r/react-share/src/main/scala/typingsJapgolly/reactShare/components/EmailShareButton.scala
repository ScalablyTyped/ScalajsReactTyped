...
object EmailShareButton {
  ...
  inline def apply(url: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitPropsOptionsforwarded]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def body(value: String): this.type = set("body", value.asInstanceOf[js.Any])
    ...
    inline def subject(value: String): this.type = set("subject", value.asInstanceOf[js.Any])
  ...
  def withProps(p: OmitPropsOptionsforwarded): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
