...
object FacebookMessengerShareButton {
  
  inline def apply(appId: String, url: String): Builder = {
    val __props = js.Dynamic.literal(appId = appId.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitPropsOptionsforwardedAbout]))
  }
  ...
  def withProps(p: OmitPropsOptionsforwardedAbout): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
