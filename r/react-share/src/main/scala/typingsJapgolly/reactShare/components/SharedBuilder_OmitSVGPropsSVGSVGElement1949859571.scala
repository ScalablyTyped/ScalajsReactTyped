...
@scala.inline
open class SharedBuilder_OmitSVGPropsSVGSVGElement1949859571[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def bgStyle(value: CSSProperties): this.type = set("bgStyle", value.asInstanceOf[js.Any])
  ...
  inline def iconFillColor(value: String): this.type = set("iconFillColor", value.asInstanceOf[js.Any])
