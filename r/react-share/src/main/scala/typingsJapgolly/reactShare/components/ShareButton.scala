...
import typingsJapgolly.reactShare.libShareButtonMod.default
...
object ShareButton {
  ...
  inline def apply[LinkOptions](
    ...
    val __props = js.Dynamic.literal(networkLink = js.Any.fromFunction2(networkLink), networkName = networkName.asInstanceOf[js.Any], opts = opts.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    new Builder[LinkOptions](js.Array(this.component, __props.asInstanceOf[Props[LinkOptions]]))
  }
  ...
  @scala.inline
  open class Builder[LinkOptions] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[default[LinkOptions]] {
    ...
    inline def beforeOnClick(value: CallbackTo[js.Promise[Unit] | Unit]): this.type = set("beforeOnClick", value.toJsFn)
    ...
    inline def disabledStyle(value: CSSProperties): this.type = set("disabledStyle", value.asInstanceOf[js.Any])
    ...
    inline def forwardedRef(value: Ref[HTMLButtonElement]): this.type = set("forwardedRef", value.asInstanceOf[js.Any])
    
    inline def forwardedRefFunction1(value: HTMLButtonElement | Null => Callback): this.type = set("forwardedRef", js.Any.fromFunction1((t0: HTMLButtonElement | Null) => value(t0).runNow()))
    ...
    inline def onClick(value: (/* event */ ReactMouseEventFrom[HTMLButtonElement], /* link */ String) => Callback): this.type = set("onClick", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[HTMLButtonElement], t1: /* link */ String) => (value(t0, t1)).runNow()))
    ...
    inline def onShareWindowClose(value: Callback): this.type = set("onShareWindowClose", value.toJsFn)
    ...
    inline def openShareDialogOnClick(value: Boolean): this.type = set("openShareDialogOnClick", value.asInstanceOf[js.Any])
    ...
    inline def resetButtonStyle(value: Boolean): this.type = set("resetButtonStyle", value.asInstanceOf[js.Any])
    ...
    inline def windowHeight(value: Double): this.type = set("windowHeight", value.asInstanceOf[js.Any])
    
    inline def windowPosition(value: WindowPosition): this.type = set("windowPosition", value.asInstanceOf[js.Any])
    
    inline def windowWidth(value: Double): this.type = set("windowWidth", value.asInstanceOf[js.Any])
  }
  
  def withProps[LinkOptions](p: Props[LinkOptions]): Builder[LinkOptions] = new Builder[LinkOptions](js.Array(this.component, p.asInstanceOf[js.Any]))
}
