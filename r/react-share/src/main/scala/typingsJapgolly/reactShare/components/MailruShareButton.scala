...
import typingsJapgolly.reactShare.anon.OmitPropstitlestringundefAccessKey
...
object MailruShareButton {
  ...
  inline def apply(url: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitPropstitlestringundefAccessKey]))
  }
  ...
  def withProps(p: OmitPropstitlestringundefAccessKey): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
