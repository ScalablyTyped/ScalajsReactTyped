...
import typingsJapgolly.reactShare.anon.OmitPropsOptionsforwardedAccessKey
...
object LinkedinShareButton {
  ...
  inline def apply(url: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitPropsOptionsforwardedAccessKey]))
  }
  ...
  def withProps(p: OmitPropsOptionsforwardedAccessKey): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
