...
object VKShareButton {
  ...
  inline def apply(url: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitPropsOptionsforwardedAriaactivedescendant]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def noParse(value: Boolean): this.type = set("noParse", value.asInstanceOf[js.Any])
    
    inline def noVkLinks(value: Boolean): this.type = set("noVkLinks", value.asInstanceOf[js.Any])
  ...
  def withProps(p: OmitPropsOptionsforwardedAriaactivedescendant): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
