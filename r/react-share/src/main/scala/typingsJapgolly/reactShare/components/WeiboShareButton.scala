...
object WeiboShareButton {
  ...
  inline def apply(url: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitPropstitlestringundefAriabusy]))
  }
  ...
  def withProps(p: OmitPropstitlestringundefAriabusy): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
