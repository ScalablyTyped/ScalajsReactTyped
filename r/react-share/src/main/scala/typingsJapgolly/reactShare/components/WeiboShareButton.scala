...
import typingsJapgolly.reactShare.CommonShareButtonPropstitDisabled
...
object WeiboShareButton {
  def apply(
    ...
    MountedWithRawType[
      CommonShareButtonPropstitDisabled, 
      js.Object, 
      RawMounted[CommonShareButtonPropstitDisabled, js.Object]
    ]
  ] = {
  ...
  typingsJapgolly.reactShare.CommonShareButtonPropstitDisabled, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactShare.CommonShareButtonPropstitDisabled])(children: _*)
  }
