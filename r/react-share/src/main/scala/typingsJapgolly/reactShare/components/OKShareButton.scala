...
object OKShareButton {
  ...
  inline def apply(url: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitPropstitlestringundefAriaactivedescendant]))
  }
  ...
  def withProps(p: OmitPropstitlestringundefAriaactivedescendant): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
