...
abstract class SharedApply_CommonShareButtonPropstitAdditionalProps395465909 () {
  ...
  def apply(
    ...
    MountedWithRawType[
      CommonShareButtonPropstitAdditionalProps, 
      js.Object, 
      RawMounted[CommonShareButtonPropstitAdditionalProps, js.Object]
    ]
  ] = {
  ...
  typingsJapgolly.reactShare.CommonShareButtonPropstitAdditionalProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactShare.CommonShareButtonPropstitAdditionalProps])(children: _*)
  }
}
