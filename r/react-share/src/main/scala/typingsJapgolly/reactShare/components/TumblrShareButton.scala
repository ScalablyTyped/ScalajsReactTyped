...
import typingsJapgolly.reactShare.anon.OmitPropsOptionstagsstrin
...
object TumblrShareButton {
  ...
  inline def apply(url: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitPropsOptionstagsstrin]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def posttype(value: link | String): this.type = set("posttype", value.asInstanceOf[js.Any])
    ...
    inline def tags(value: js.Array[String]): this.type = set("tags", value.asInstanceOf[js.Any])
    
    inline def tagsVarargs(value: String*): this.type = set("tags", js.Array(value*))
  ...
  def withProps(p: OmitPropsOptionstagsstrin): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
