...
@scala.inline
open class SharedBuilder_OmitPropsquotestringundef_647970447[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def hashtag(value: String): this.type = set("hashtag", value.asInstanceOf[js.Any])
  ...
  inline def quote(value: String): this.type = set("quote", value.asInstanceOf[js.Any])
