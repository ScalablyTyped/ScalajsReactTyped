...
/* Inlined std.Omit<react-share.react-share/lib/ShareButton.Props<react-share.react-share/lib/FacebookMessengerShareButton.Options>, 'forwardedRef' | 'networkName' | 'networkLink' | 'opts'> & react-share.react-share/lib/FacebookMessengerShareButton.Options & react.react.RefAttributes<std.HTMLButtonElement> */
trait OmitPropsOptionsforwardedAbout extends StObject {
...
object OmitPropsOptionsforwardedAbout {
  
  inline def apply(appId: String, url: String): OmitPropsOptionsforwardedAbout = {
    val __obj = js.Dynamic.literal(appId = appId.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], children = null)
    __obj.asInstanceOf[OmitPropsOptionsforwardedAbout]
  }
  
  extension [Self <: OmitPropsOptionsforwardedAbout](x: Self) {
