...
/* Inlined std.Omit<react-share.react-share/lib/hocs/createShareCount.SocialMediaShareCountProps, 'getCount'> */
trait OmitSocialMediaShareCount extends StObject {
...
object OmitSocialMediaShareCount {
  
  inline def apply(url: String): OmitSocialMediaShareCount = {
