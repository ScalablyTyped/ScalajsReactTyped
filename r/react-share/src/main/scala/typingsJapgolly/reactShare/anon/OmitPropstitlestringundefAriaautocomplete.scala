...
/* Inlined std.Omit<react-share.react-share/lib/ShareButton.Props<{  title :string | undefined,   separator :string | undefined}>, 'forwardedRef' | 'networkName' | 'networkLink' | 'opts'> & {  title :string | undefined,   separator :string | undefined} & react.react.RefAttributes<std.HTMLButtonElement> */
trait OmitPropstitlestringundefAriaautocomplete extends StObject {
...
object OmitPropstitlestringundefAriaautocomplete {
  
  inline def apply(url: String): OmitPropstitlestringundefAriaautocomplete = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any], children = null)
    __obj.asInstanceOf[OmitPropstitlestringundefAriaautocomplete]
  }
  
  extension [Self <: OmitPropstitlestringundefAriaautocomplete](x: Self) {
