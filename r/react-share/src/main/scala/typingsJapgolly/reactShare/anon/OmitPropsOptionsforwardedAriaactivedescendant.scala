...
/* Inlined std.Omit<react-share.react-share/lib/ShareButton.Props<react-share.react-share/lib/VKShareButton.Options>, 'forwardedRef' | 'networkName' | 'networkLink' | 'opts'> & react-share.react-share/lib/VKShareButton.Options & react.react.RefAttributes<std.HTMLButtonElement> */
trait OmitPropsOptionsforwardedAriaactivedescendant extends StObject {
...
object OmitPropsOptionsforwardedAriaactivedescendant {
  
  inline def apply(url: String): OmitPropsOptionsforwardedAriaactivedescendant = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any], children = null)
    __obj.asInstanceOf[OmitPropsOptionsforwardedAriaactivedescendant]
  }
  
  extension [Self <: OmitPropsOptionsforwardedAriaactivedescendant](x: Self) {
