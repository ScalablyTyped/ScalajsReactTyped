...
/* Inlined std.Omit<react-share.react-share/lib/ShareButton.Props<{  title :string | undefined,   image :string | undefined}>, 'forwardedRef' | 'networkName' | 'networkLink' | 'opts'> & {  title :string | undefined,   image :string | undefined} & react.react.RefAttributes<std.HTMLButtonElement> */
trait OmitPropstitlestringundefAriabusy extends StObject {
...
object OmitPropstitlestringundefAriabusy {
  
  inline def apply(url: String): OmitPropstitlestringundefAriabusy = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any], children = null)
    __obj.asInstanceOf[OmitPropstitlestringundefAriabusy]
  }
  
  extension [Self <: OmitPropstitlestringundefAriabusy](x: Self) {
