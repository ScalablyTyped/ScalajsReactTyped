...
trait OmitPropstitlestringundefAriaatomic extends StObject {
...
object OmitPropstitlestringundefAriaatomic {
  
  inline def apply(url: String): OmitPropstitlestringundefAriaatomic = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any], children = null)
    __obj.asInstanceOf[OmitPropstitlestringundefAriaatomic]
  }
  
  extension [Self <: OmitPropstitlestringundefAriaatomic](x: Self) {
