...
/* Inlined std.Omit<react-share.react-share/lib/ShareButton.Props<{  quote :string | undefined,   hashtag :string | undefined}>, 'forwardedRef' | 'networkName' | 'networkLink' | 'opts'> & {  quote :string | undefined,   hashtag :string | undefined} & react.react.RefAttributes<std.HTMLButtonElement> */
trait OmitPropsquotestringundef extends StObject {
...
object OmitPropsquotestringundef {
  
  inline def apply(url: String): OmitPropsquotestringundef = {
