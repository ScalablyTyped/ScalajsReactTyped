...
/* Inlined std.Omit<react-share.react-share/lib/ShareButton.Props<{  media :string,   description :string | undefined}>, 'forwardedRef' | 'networkName' | 'networkLink' | 'opts'> & {  media :string,   description :string | undefined} & react.react.RefAttributes<std.HTMLButtonElement> */
trait OmitPropsmediastringdescr extends StObject {
...
object OmitPropsmediastringdescr {
  
  inline def apply(media: String, url: String): OmitPropsmediastringdescr = {
    val __obj = js.Dynamic.literal(media = media.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], children = null)
