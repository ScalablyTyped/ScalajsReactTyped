...
import typingsJapgolly.reactShare.anon.DisabledStyle
...
object libShareButtonMod {
  
  @JSImport("react-share/lib/ShareButton", JSImport.Default)
  @js.native
  open class default[LinkOptions] () extends ShareButton[LinkOptions]
  /* static members */
  object default {
    ...
    @JSImport("react-share/lib/ShareButton", "default.defaultProps")
    @js.native
    def defaultProps: DisabledStyle = js.native
    inline def defaultProps_=(x: DisabledStyle): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
  }
  
  trait CustomProps[LinkOptions] extends StObject {
    ...
    var forwardedRef: js.UndefOr[Ref[HTMLButtonElement]] = js.undefined
    
    var networkLink: NetworkLink[LinkOptions]
  ...
  object CustomProps {
    ...
    inline def apply[LinkOptions](
      networkLink: (/* url */ String, LinkOptions) => String,
      networkName: String,
      opts: LinkOptions,
      url: String
    ): CustomProps[LinkOptions] = {
      val __obj = js.Dynamic.literal(networkLink = js.Any.fromFunction2(networkLink), networkName = networkName.asInstanceOf[js.Any], opts = opts.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], children = null)
    ...
    extension [Self <: CustomProps[?], LinkOptions](x: Self & CustomProps[LinkOptions]) {
      ...
      inline def setForwardedRef(value: Ref[HTMLButtonElement]): Self = StObject.set(x, "forwardedRef", value.asInstanceOf[js.Any])
      
      inline def setForwardedRefFunction1(value: HTMLButtonElement | Null => Callback): Self = StObject.set(x, "forwardedRef", js.Any.fromFunction1((t0: HTMLButtonElement | Null) => value(t0).runNow()))
      ...
      inline def setOpts(value: LinkOptions): Self = StObject.set(x, "opts", value.asInstanceOf[js.Any])
  ...
  type NetworkLink[LinkOptions] = js.Function2[/* url */ String, /* options */ LinkOptions, String]
  
  /* Inlined std.Omit<react.react.ButtonHTMLAttributes<std.HTMLButtonElement>, keyof react-share.react-share/lib/ShareButton.CustomProps<LinkOptions>> & react-share.react-share/lib/ShareButton.CustomProps<LinkOptions> */
  trait Props[LinkOptions] extends StObject {
  ...
  @js.native
  trait ShareButton[LinkOptions]
    extends Component[Props[LinkOptions], js.Object, Any] {
    
    def handleClick(event: ReactMouseEventFrom[HTMLButtonElement]): js.Promise[Unit] = js.native
    
    def openShareDialog(link: String): Unit = js.native
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactShare.reactShareStrings.windowCenter
    - typingsJapgolly.reactShare.reactShareStrings.screenCenter
  */
  trait WindowPosition extends StObject
  object WindowPosition {
    
    inline def screenCenter: typingsJapgolly.reactShare.reactShareStrings.screenCenter = "screenCenter".asInstanceOf[typingsJapgolly.reactShare.reactShareStrings.screenCenter]
    
    inline def windowCenter: typingsJapgolly.reactShare.reactShareStrings.windowCenter = "windowCenter".asInstanceOf[typingsJapgolly.reactShare.reactShareStrings.windowCenter]
  }
}
