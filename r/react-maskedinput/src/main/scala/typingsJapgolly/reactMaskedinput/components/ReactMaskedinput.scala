package typingsJapgolly.reactMaskedinput.components
...
import typingsJapgolly.reactMaskedinput.mod.CharsFormatters
import typingsJapgolly.reactMaskedinput.mod.MaskedInputProps
import typingsJapgolly.reactMaskedinput.mod.default
...
object ReactMaskedinput {
  ...
  typingsJapgolly.reactMaskedinput.mod.MaskedInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactMaskedinput.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactMaskedinput.mod.MaskedInputProps])(children: _*)
  }
