...
import typingsJapgolly.reactBurgerMenu.anon.PartialCSSStyleDeclaratio
...
object mod {
  ...
  trait Props extends StObject {
    ...
    var customOnKeyDown: js.UndefOr[js.Function1[/* event */ ReactKeyboardEventFrom[org.scalajs.dom.Element], Unit]] = js.undefined
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setCustomBurgerIconVdomElement(value: VdomElement): Self = StObject.set(x, "customBurgerIcon", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setCustomCrossIconVdomElement(value: VdomElement): Self = StObject.set(x, "customCrossIcon", value.rawElement.asInstanceOf[js.Any])
      
      inline def setCustomOnKeyDown(value: /* event */ ReactKeyboardEventFrom[org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "customOnKeyDown", js.Any.fromFunction1((t0: /* event */ ReactKeyboardEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setDisableOverlayClickCallbackTo(value: CallbackTo[Boolean]): Self = StObject.set(x, "disableOverlayClick", value.toJsFn)
      ...
      inline def setOnIconHoverChange(value: /* state */ HoverState => Callback): Self = StObject.set(x, "onIconHoverChange", js.Any.fromFunction1((t0: /* state */ HoverState) => value(t0).runNow()))
      ...
      inline def setOnStateChange(value: /* state */ State => Callback): Self = StObject.set(x, "onStateChange", js.Any.fromFunction1((t0: /* state */ State) => value(t0).runNow()))
