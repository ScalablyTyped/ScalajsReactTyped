...
trait InputHTMLAttributesminmax extends StObject {
  ...
  var onBlur: js.UndefOr[js.Function1[/* e */ ReactFocusEventFrom[Any & Element], Unit]] = js.undefined
  
  var onChange: js.UndefOr[js.Function1[/* e */ ReactEventFrom[Any & Element], Unit]] = js.undefined
  
  var onFocus: js.UndefOr[js.Function1[/* e */ ReactFocusEventFrom[Any & Element], Unit]] = js.undefined
...
object InputHTMLAttributesminmax {
  ...
  extension [Self <: InputHTMLAttributesminmax](x: Self) {
    ...
    inline def setOnBlur(value: /* e */ ReactFocusEventFrom[Any & Element] => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: /* e */ ReactFocusEventFrom[Any & Element]) => value(t0).runNow()))
    ...
    inline def setOnFocus(value: /* e */ ReactFocusEventFrom[Any & Element] => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: /* e */ ReactFocusEventFrom[Any & Element]) => value(t0).runNow()))
