...
import typingsJapgolly.reactOnsenui.anon.Animation
...
object ActionSheet {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactOnsenui.mod.ActionSheet] {
    
    inline def animation(value: String): this.type = set("animation", value.asInstanceOf[js.Any])
    
    inline def animationOptions(value: js.Object): this.type = set("animationOptions", value.asInstanceOf[js.Any])
  ...
  def withProps(p: HTMLAttributesidclassName & Animation): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
