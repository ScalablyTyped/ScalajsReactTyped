...
import typingsJapgolly.reactOnsenui.anon.SecondaryValue
...
object ProgressCircular {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactOnsenui.mod.ProgressCircular] {
    ...
    inline def secondaryValue(value: Boolean): this.type = set("secondaryValue", value.asInstanceOf[js.Any])
  ...
  def withProps(p: HTMLAttributesidclassName & SecondaryValue): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
