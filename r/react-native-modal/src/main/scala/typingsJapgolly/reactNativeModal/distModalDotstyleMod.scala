...
import typingsJapgolly.reactNativeModal.anon.BackgroundColor
import typingsJapgolly.reactNativeModal.anon.Flex
import typingsJapgolly.reactNativeModal.anon.Opacity
