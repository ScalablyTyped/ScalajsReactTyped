...
import typingsJapgolly.nlcstSearch.mod.Handler
...
object libFactoryMod {
  ...
  type Parent = typingsJapgolly.nlcst.mod.Parent
  
  type Pattern = typingsJapgolly.retextEquality.libEnMod.Pattern
  
  type Root = typingsJapgolly.nlcst.mod.Root
  
  type SearchHandle = Handler
  
  type Sentence = typingsJapgolly.nlcst.mod.Sentence
  
  type SentenceContent = typingsJapgolly.nlcst.mod.SentenceContent
