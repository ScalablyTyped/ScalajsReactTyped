...
- typingsJapgolly.reactMdTransition.typesTypesMod.CSSTransitionElementProps because var conflicts: ref. Inlined className */ trait CSSTransitionHookReturnValue[E /* <: HTMLElement */]
  extends StObject
...
object CSSTransitionHookReturnValue {
  ...
  inline def apply[E /* <: HTMLElement */](
    ...
    val __obj = js.Dynamic.literal(appearing = appearing.asInstanceOf[js.Any], elementProps = elementProps.asInstanceOf[js.Any], ref = js.Any.fromFunction1((t0: E | Null) => ref(t0).runNow()), rendered = rendered.asInstanceOf[js.Any], stage = stage.asInstanceOf[js.Any], transitionTo = js.Any.fromFunction1((t0: TransitionStage) => transitionTo(t0).runNow()))
