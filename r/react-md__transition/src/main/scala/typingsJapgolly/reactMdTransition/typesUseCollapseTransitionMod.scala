...
import typingsJapgolly.reactMdTransition.typesTypesMod.CSSTransitionElementProps
...
import typingsJapgolly.reactMdTransition.typesTypesMod.TransitionStage
...
object typesUseCollapseTransitionMod {
  ...
  object CollapseElementProps {
    ...
    inline def apply[E /* <: HTMLElement */](hidden: Boolean, ref: E | Null => Callback, style: CSSProperties): CollapseElementProps[E] = {
      val __obj = js.Dynamic.literal(hidden = hidden.asInstanceOf[js.Any], ref = js.Any.fromFunction1((t0: E | Null) => ref(t0).runNow()), style = style.asInstanceOf[js.Any])
  ...
  - typingsJapgolly.reactMdTransition.typesTypesMod.CSSTransitionElementProps because Already inherited
  - typingsJapgolly.reactMdTransition.typesUseCollapseTransitionMod.CollapseElementProps because var conflicts: className, ref. Inlined style, hidden */ trait CollapseTransitionHookReturnValue[E /* <: HTMLElement */]
    extends StObject
  ...
  object CollapseTransitionHookReturnValue {
    ...
    inline def apply[E /* <: HTMLElement */](
      ...
      val __obj = js.Dynamic.literal(appearing = appearing.asInstanceOf[js.Any], elementProps = elementProps.asInstanceOf[js.Any], hidden = hidden.asInstanceOf[js.Any], ref = js.Any.fromFunction1((t0: E | Null) => ref(t0).runNow()), rendered = rendered.asInstanceOf[js.Any], stage = stage.asInstanceOf[js.Any], style = style.asInstanceOf[js.Any], transitionTo = js.Any.fromFunction1((t0: TransitionStage) => transitionTo(t0).runNow()))
