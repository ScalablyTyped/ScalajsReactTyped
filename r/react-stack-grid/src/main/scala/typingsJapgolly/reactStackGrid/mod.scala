...
import typingsJapgolly.reactStackGrid.anon.Appear
...
object mod {
  ...
  object Grid {
    ...
    inline def apply(updateLayout: Callback): Grid = {
      val __obj = js.Dynamic.literal(updateLayout = updateLayout.toJsFn)
      __obj.asInstanceOf[Grid]
    }
    
    extension [Self <: Grid](x: Self) {
      
      inline def setUpdateLayout(value: Callback): Self = StObject.set(x, "updateLayout", value.toJsFn)
    }
  }
  
  type StackGrid = japgolly.scalajs.react.facade.React.Component[StackGridProps & js.Object, js.Object]
  ...
  object StackGridProps {
    ...
    extension [Self <: StackGridProps](x: Self) {
      ...
      inline def setGridRef(value: /* grid */ Grid => Callback): Self = StObject.set(x, "gridRef", js.Any.fromFunction1((t0: /* grid */ Grid) => value(t0).runNow()))
      ...
      inline def setOnLayout(value: Callback): Self = StObject.set(x, "onLayout", value.toJsFn)
