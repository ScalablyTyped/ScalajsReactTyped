...
import typingsJapgolly.reactMdUtils.reactMdUtilsStrings.absolute
import typingsJapgolly.reactMdUtils.reactMdUtilsStrings.fixed
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object typesPositioningTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.left
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.right
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.center
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.`inner-left`
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.`inner-right`
  */
  trait HorizontalPosition extends StObject
  object HorizontalPosition {
    
    inline def center: typingsJapgolly.reactMdUtils.reactMdUtilsStrings.center = "center".asInstanceOf[typingsJapgolly.reactMdUtils.reactMdUtilsStrings.center]
    
    inline def `inner-left`: typingsJapgolly.reactMdUtils.reactMdUtilsStrings.`inner-left` = "inner-left".asInstanceOf[typingsJapgolly.reactMdUtils.reactMdUtilsStrings.`inner-left`]
    
    inline def `inner-right`: typingsJapgolly.reactMdUtils.reactMdUtilsStrings.`inner-right` = "inner-right".asInstanceOf[typingsJapgolly.reactMdUtils.reactMdUtilsStrings.`inner-right`]
    
    inline def left: typingsJapgolly.reactMdUtils.reactMdUtilsStrings.left = "left".asInstanceOf[typingsJapgolly.reactMdUtils.reactMdUtilsStrings.left]
    
    inline def right: typingsJapgolly.reactMdUtils.reactMdUtilsStrings.right = "right".asInstanceOf[typingsJapgolly.reactMdUtils.reactMdUtilsStrings.right]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.auto
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.equal
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.min
  */
  trait PositionWidth extends StObject
  object PositionWidth {
    
    inline def auto: typingsJapgolly.reactMdUtils.reactMdUtilsStrings.auto = "auto".asInstanceOf[typingsJapgolly.reactMdUtils.reactMdUtilsStrings.auto]
    
    inline def equal: typingsJapgolly.reactMdUtils.reactMdUtilsStrings.equal = "equal".asInstanceOf[typingsJapgolly.reactMdUtils.reactMdUtilsStrings.equal]
    
    inline def min: typingsJapgolly.reactMdUtils.reactMdUtilsStrings.min = "min".asInstanceOf[typingsJapgolly.reactMdUtils.reactMdUtilsStrings.min]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.above
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.below
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.left
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.right
  */
  ...
  object SimplePosition {
    ...
    inline def above: typingsJapgolly.reactMdUtils.reactMdUtilsStrings.above = "above".asInstanceOf[typingsJapgolly.reactMdUtils.reactMdUtilsStrings.above]
    
    inline def below: typingsJapgolly.reactMdUtils.reactMdUtilsStrings.below = "below".asInstanceOf[typingsJapgolly.reactMdUtils.reactMdUtilsStrings.below]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.below
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.center
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.top
    - typingsJapgolly.reactMdUtils.reactMdUtilsStrings.bottom
  */
  ...
  object VerticalPosition {
    ...
    inline def bottom: typingsJapgolly.reactMdUtils.reactMdUtilsStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.reactMdUtils.reactMdUtilsStrings.bottom]
    
    inline def center: typingsJapgolly.reactMdUtils.reactMdUtilsStrings.center = "center".asInstanceOf[typingsJapgolly.reactMdUtils.reactMdUtilsStrings.center]
    
    inline def top: typingsJapgolly.reactMdUtils.reactMdUtilsStrings.top = "top".asInstanceOf[typingsJapgolly.reactMdUtils.reactMdUtilsStrings.top]
  }
}
