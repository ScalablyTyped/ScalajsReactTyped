...
object typesEventsUtilsMod {
  ...
  object DelegatedEventHandler {
    ...
    inline def apply(add: EventListener => Callback, remove: EventListener => Callback): DelegatedEventHandler = {
      val __obj = js.Dynamic.literal(add = js.Any.fromFunction1((t0: EventListener) => add(t0).runNow()), remove = js.Any.fromFunction1((t0: EventListener) => remove(t0).runNow()))
      __obj.asInstanceOf[DelegatedEventHandler]
    }
    
    extension [Self <: DelegatedEventHandler](x: Self) {
      
      inline def setAdd(value: EventListener => Callback): Self = StObject.set(x, "add", js.Any.fromFunction1((t0: EventListener) => value(t0).runNow()))
      
      inline def setRemove(value: EventListener => Callback): Self = StObject.set(x, "remove", js.Any.fromFunction1((t0: EventListener) => value(t0).runNow()))
    }
  }
