...
import typingsJapgolly.reactMdUtils.typesLayoutGridCellMod.GridCSSProperties
...
object GridCell {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def colEnd(value: Double | String): this.type = set("colEnd", value.asInstanceOf[js.Any])
    
    inline def colSpan(value: Double): this.type = set("colSpan", value.asInstanceOf[js.Any])
    
    inline def colStart(value: Double | String): this.type = set("colStart", value.asInstanceOf[js.Any])
    ...
    inline def desktop(value: GridCSSProperties): this.type = set("desktop", value.asInstanceOf[js.Any])
    ...
    inline def largeDesktop(value: GridCSSProperties): this.type = set("largeDesktop", value.asInstanceOf[js.Any])
    ...
    inline def phone(value: GridCSSProperties): this.type = set("phone", value.asInstanceOf[js.Any])
    ...
    inline def rowEnd(value: Double | String): this.type = set("rowEnd", value.asInstanceOf[js.Any])
    
    inline def rowSpan(value: Double): this.type = set("rowSpan", value.asInstanceOf[js.Any])
    
    inline def rowStart(value: Double | String): this.type = set("rowStart", value.asInstanceOf[js.Any])
    ...
    inline def tablet(value: GridCSSProperties): this.type = set("tablet", value.asInstanceOf[js.Any])
  ...
  def withProps(p: GridCellProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
