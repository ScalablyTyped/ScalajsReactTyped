...
import typingsJapgolly.reactMdUtils.typesLayoutGridListMod.RenderGridListChildren
...
object GridList {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def cellMargin(value: String): this.type = set("cellMargin", value.asInstanceOf[js.Any])
    
    inline def children(value: Node | RenderGridListChildren): this.type = set("children", value.asInstanceOf[js.Any])
    
    inline def childrenFunction1(value: /* size */ GridListSize => Node): this.type = set("children", js.Any.fromFunction1(value))
    ...
    inline def defaultSize(value: GridListSize | js.Function0[GridListSize]): this.type = set("defaultSize", value.asInstanceOf[js.Any])
    
    inline def defaultSizeCallbackTo(value: CallbackTo[GridListSize]): this.type = set("defaultSize", value.toJsFn)
    ...
    inline def disableHeightObserver(value: Boolean): this.type = set("disableHeightObserver", value.asInstanceOf[js.Any])
    
    inline def disableWidth(value: Boolean): this.type = set("disableWidth", value.asInstanceOf[js.Any])
    
    inline def disableWidthObserver(value: Boolean): this.type = set("disableWidthObserver", value.asInstanceOf[js.Any])
    ...
    inline def maxCellSize(value: Double): this.type = set("maxCellSize", value.asInstanceOf[js.Any])
    ...
    inline def wrapOnly(value: Boolean): this.type = set("wrapOnly", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: GridList.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridListProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
