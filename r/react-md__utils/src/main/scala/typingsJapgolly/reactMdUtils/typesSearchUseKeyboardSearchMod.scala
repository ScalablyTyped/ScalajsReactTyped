...
import typingsJapgolly.reactMdUtils.typesSearchUtilsMod.BaseSearchOptions
...
object typesSearchUseKeyboardSearchMod {
  ...
  object BaseKeyboardSearchOptions {
    ...
    inline def apply[D, E /* <: HTMLElement */](items: js.Array[D], onChange: /* data */ SearchData[D, E] => Callback): BaseKeyboardSearchOptions[D, E] = {
      val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any], onChange = js.Any.fromFunction1((t0: /* data */ SearchData[D, E]) => onChange(t0).runNow()))
    ...
    extension [Self <: BaseKeyboardSearchOptions[?, ?], D, E /* <: HTMLElement */](x: Self & (BaseKeyboardSearchOptions[D, E])) {
      ...
      inline def setOnChange(value: /* data */ SearchData[D, E] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* data */ SearchData[D, E]) => value(t0).runNow()))
  ...
  object KeyboardSearchOptions {
    ...
    inline def apply[D, E /* <: HTMLElement */](items: js.Array[D], onChange: /* data */ SearchData[D, E] => Callback, searchIndex: Double): KeyboardSearchOptions[D, E] = {
      val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any], onChange = js.Any.fromFunction1((t0: /* data */ SearchData[D, E]) => onChange(t0).runNow()), searchIndex = searchIndex.asInstanceOf[js.Any])
