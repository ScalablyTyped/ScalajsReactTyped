...
object typesLayoutUseGridListMod {
  ...
  trait CSSProperties
    extends StObject
       with typingsJapgolly.react.mod.CSSProperties
  ...
  trait ProvidedGridListProps[E /* <: HTMLElement */] extends StObject {
    ...
    var ref: RefFn[E | Null]
    
    var style: CSSProperties
  }
  object ProvidedGridListProps {
    
    inline def apply[E /* <: HTMLElement */](className: String, ref: (E | Null) | Null => Callback, style: CSSProperties): ProvidedGridListProps[E] = {
      val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any], ref = js.Any.fromFunction1((t0: (E | Null) | Null) => ref(t0).runNow()), style = style.asInstanceOf[js.Any])
    ...
    extension [Self <: ProvidedGridListProps[?], E /* <: HTMLElement */](x: Self & ProvidedGridListProps[E]) {
      ...
      inline def setRef(value: (E | Null) | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: (E | Null) | Null) => value(t0).runNow()))
  ...
  trait UseGridListOptions extends StObject {
    ...
    /**
      ...
      * object.
      */
    var style: js.UndefOr[typingsJapgolly.react.mod.CSSProperties] = js.undefined
  }
  object UseGridListOptions {
    ...
    extension [Self <: UseGridListOptions](x: Self) {
      ...
      inline def setDefaultSizeCallbackTo(value: CallbackTo[GridListSize]): Self = StObject.set(x, "defaultSize", value.toJsFn)
      ...
      inline def setStyle(value: typingsJapgolly.react.mod.CSSProperties): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
