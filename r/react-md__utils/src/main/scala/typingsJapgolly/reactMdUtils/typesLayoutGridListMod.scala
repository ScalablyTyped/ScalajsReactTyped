...
object typesLayoutGridListMod {
  ...
  - typingsJapgolly.reactMdUtils.typesLayoutUseGridListMod.UseGridListOptions because var conflicts: className, style. Inlined disableHeight, disableWidth, cellMargin, maxCellSize, defaultSize, containerPadding */ trait GridListProps
    extends StObject
    ...
    /**
      ...
      */
    @JSName("children")
    var children_GridListProps: Node | RenderGridListChildren
  ...
  object GridListProps {
    ...
    extension [Self <: GridListProps](x: Self) {
      ...
      inline def setChildren(value: Node | RenderGridListChildren): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      inline def setChildrenFunction1(value: /* size */ GridListSize => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
  ...
  type RenderGridListChildren = js.Function1[/* size */ GridListSize, Node]
}
