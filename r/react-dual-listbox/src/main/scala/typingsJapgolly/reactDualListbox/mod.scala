...
object mod {
  ...
  object CommonProperties {
    ...
    extension [Self <: CommonProperties[?], T](x: Self & CommonProperties[T]) {
      ...
      inline def setAvailableRef(value: /* availableInput */ HTMLSelectElement => Callback): Self = StObject.set(x, "availableRef", js.Any.fromFunction1((t0: /* availableInput */ HTMLSelectElement) => value(t0).runNow()))
      ...
      inline def setSelectedRef(value: /* availableInput */ HTMLSelectElement => Callback): Self = StObject.set(x, "selectedRef", js.Any.fromFunction1((t0: /* availableInput */ HTMLSelectElement) => value(t0).runNow()))
  ...
  type DualListBox[P, F /* <: Boolean */, V /* <: Boolean */] = japgolly.scalajs.react.facade.React.Component[(DualListBoxProperties[P, F, V]) & js.Object, js.Object]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactDualListbox.mod.ValueOption[T]
    - typingsJapgolly.reactDualListbox.mod.CategoryOption[T]
  */
  trait Option[T] extends StObject
  object Option {
    
    inline def CategoryOption[T](label: String, options: js.Array[Option[T]]): typingsJapgolly.reactDualListbox.mod.CategoryOption[T] = {
      val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reactDualListbox.mod.CategoryOption[T]]
    }
    
    inline def ValueOption[T](label: String, value: T): typingsJapgolly.reactDualListbox.mod.ValueOption[T] = {
      val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reactDualListbox.mod.ValueOption[T]]
    }
  }
  ...
  object ValueProperties {
    ...
    extension [Self <: ValueProperties[?, ?], T, V /* <: Boolean */](x: Self & (ValueProperties[T, V])) {
      ...
      ): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* import warning: importer.ImportType#apply Failed type conversion: V extends true ? std.Array<T> : std.Array<react-dual-listbox.react-dual-listbox.Option<T>> */ /* selected */ js.Any) => value(t0).runNow()))
