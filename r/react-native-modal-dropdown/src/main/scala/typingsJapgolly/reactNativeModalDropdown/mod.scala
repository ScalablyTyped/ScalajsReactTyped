...
object mod {
  ...
  trait ModalDropdownProps[T]
    ...
    var renderButtonComponent: js.UndefOr[ComponentClassP[js.Object] | FC[js.Object]] = js.undefined
    ...
    var renderRightComponent: js.UndefOr[ComponentClassP[js.Object] | FC[js.Object]] = js.undefined
    
    var renderRow: js.UndefOr[js.Function3[/* option */ T, /* index */ String, /* isSelected */ Boolean, Node]] = js.undefined
    
    var renderRowComponent: js.UndefOr[ComponentClassP[js.Object] | FC[js.Object]] = js.undefined
    
    var renderRowProps: js.UndefOr[Any] = js.undefined
    
    var renderRowText: js.UndefOr[js.Function1[/* item */ T, String]] = js.undefined
    
    var renderSearch: js.UndefOr[js.Function0[js.UndefOr[Node]]] = js.undefined
    
    var renderSeparator: js.UndefOr[
        js.Function3[/* sectionID */ String, /* index */ String, /* adjacentRowHighlighted */ Boolean, Node]
      ] = js.undefined
  ...
  object ModalDropdownProps {
    ...
    extension [Self <: ModalDropdownProps[?], T](x: Self & ModalDropdownProps[T]) {
      ...
      inline def setOnDropdownWillHide(value: CallbackTo[Unit | Boolean]): Self = StObject.set(x, "onDropdownWillHide", value.toJsFn)
      
      inline def setOnDropdownWillHideUndefined: Self = StObject.set(x, "onDropdownWillHide", js.undefined)
      
      inline def setOnDropdownWillShow(value: CallbackTo[Unit | Boolean]): Self = StObject.set(x, "onDropdownWillShow", value.toJsFn)
      ...
      inline def setRenderButtonComponent(value: ComponentClassP[js.Object] | FC[js.Object]): Self = StObject.set(x, "renderButtonComponent", value.asInstanceOf[js.Any])
      ...
      inline def setRenderRightComponent(value: ComponentClassP[js.Object] | FC[js.Object]): Self = StObject.set(x, "renderRightComponent", value.asInstanceOf[js.Any])
      
      inline def setRenderRightComponentUndefined: Self = StObject.set(x, "renderRightComponent", js.undefined)
      
      inline def setRenderRow(value: (/* option */ T, /* index */ String, /* isSelected */ Boolean) => Node): Self = StObject.set(x, "renderRow", js.Any.fromFunction3(value))
      
      inline def setRenderRowComponent(value: ComponentClassP[js.Object] | FC[js.Object]): Self = StObject.set(x, "renderRowComponent", value.asInstanceOf[js.Any])
      ...
      inline def setRenderSearch(value: CallbackTo[js.UndefOr[Node]]): Self = StObject.set(x, "renderSearch", value.toJsFn)
      
      inline def setRenderSearchUndefined: Self = StObject.set(x, "renderSearch", js.undefined)
      
      inline def setRenderSeparator(value: (/* sectionID */ String, /* index */ String, /* adjacentRowHighlighted */ Boolean) => Node): Self = StObject.set(x, "renderSeparator", js.Any.fromFunction3(value))
