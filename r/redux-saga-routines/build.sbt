...
version := "3.1-dt-20190417Z-206372"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "redux-actions" % "2.6-dt-20190508Z-fe6c1f",
  "org.scalablytyped.japgolly" %%% "redux-form" % "8.2-dt-20200227Z-7e8197",
