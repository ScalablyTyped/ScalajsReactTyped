...
version := "3.1-dt-20220624Z-dfdfe9"
scalaVersion := "3.1.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "redux-actions" % "2.6-dt-20211202Z-dc4cb1",
  "org.scalablytyped.japgolly" %%% "redux-form" % "8.3-dt-20220426Z-f16113",
