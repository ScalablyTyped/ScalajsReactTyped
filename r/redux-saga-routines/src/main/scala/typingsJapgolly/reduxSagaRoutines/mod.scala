...
import typingsJapgolly.reduxActions.mod.ActionFunction0
import typingsJapgolly.reduxActions.mod.ActionFunction1
import typingsJapgolly.reduxActions.mod.ActionFunction2
import typingsJapgolly.reduxActions.mod.ActionFunction3
import typingsJapgolly.reduxActions.mod.ActionFunction4
import typingsJapgolly.reduxActions.mod.ActionFunctionAny
import typingsJapgolly.reduxActions.mod.ActionMeta
import typingsJapgolly.reduxForm.libReduxFormMod.FormSubmitHandler
import typingsJapgolly.reduxSagaRoutines.anon.FAILURE_
import typingsJapgolly.reduxSagaRoutines.anon.FULFILL
import typingsJapgolly.reduxSagaRoutines.anon.Failure
import typingsJapgolly.reduxSagaRoutines.anon.keyinRoutineStagesstring
...
object mod {
  ...
  */
  ...
  object RoutineStages {
    ...
    inline def FAILURE: typingsJapgolly.reduxSagaRoutines.reduxSagaRoutinesStrings.FAILURE = "FAILURE".asInstanceOf[typingsJapgolly.reduxSagaRoutines.reduxSagaRoutinesStrings.FAILURE]
    
    inline def FULFILL: typingsJapgolly.reduxSagaRoutines.reduxSagaRoutinesStrings.FULFILL = "FULFILL".asInstanceOf[typingsJapgolly.reduxSagaRoutines.reduxSagaRoutinesStrings.FULFILL]
    
    inline def REQUEST: typingsJapgolly.reduxSagaRoutines.reduxSagaRoutinesStrings.REQUEST = "REQUEST".asInstanceOf[typingsJapgolly.reduxSagaRoutines.reduxSagaRoutinesStrings.REQUEST]
    
    inline def SUCCESS: typingsJapgolly.reduxSagaRoutines.reduxSagaRoutinesStrings.SUCCESS = "SUCCESS".asInstanceOf[typingsJapgolly.reduxSagaRoutines.reduxSagaRoutinesStrings.SUCCESS]
    
    inline def TRIGGER: typingsJapgolly.reduxSagaRoutines.reduxSagaRoutinesStrings.TRIGGER = "TRIGGER".asInstanceOf[typingsJapgolly.reduxSagaRoutines.reduxSagaRoutinesStrings.TRIGGER]
  }
