...
object Link {
  def apply[TState](
    ...
    LinkProps[TState], 
    typingsJapgolly.reachRouter.mod.Link[TState], 
    Unit, 
    LinkProps[TState]
  ] = {
  ...
  typingsJapgolly.reachRouter.mod.LinkProps[TState], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reachRouter.mod.Link[TState]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reachRouter.mod.LinkProps[TState]])(children: _*)
  }
