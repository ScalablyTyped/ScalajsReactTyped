...
object Effect {
  ...
  inline def apply(setLockProps: LockProps => Callback): Builder = {
    val __props = js.Dynamic.literal(setLockProps = js.Any.fromFunction1((t0: LockProps) => setLockProps(t0).runNow()))
    new Builder(js.Array(this.component, __props.asInstanceOf[EffectProps]))
  }
  
  @JSImport("react-focus-on/dist/es5/Effect", "Effect")
  @js.native
  ...
  def withProps(p: EffectProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
