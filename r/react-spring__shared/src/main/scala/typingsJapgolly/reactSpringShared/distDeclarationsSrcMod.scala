...
import typingsJapgolly.reactSpringShared.distDeclarationsSrcFluidsMod.FluidEvent
import typingsJapgolly.reactSpringShared.distDeclarationsSrcFluidsMod.FluidObserver
import typingsJapgolly.reactSpringShared.distDeclarationsSrcFluidsMod.GetFluidObservers_
import typingsJapgolly.reactSpringShared.distDeclarationsSrcFluidsMod.GetFluidValue_
import typingsJapgolly.reactSpringShared.distDeclarationsSrcFrameLoopMod.OpaqueAnimation
import typingsJapgolly.reactSpringShared.distDeclarationsSrcGlobalsMod.AnimatedGlobals
import typingsJapgolly.reactSpringShared.distDeclarationsSrcHelpersMod.EachFn
import typingsJapgolly.reactSpringShared.distDeclarationsSrcHelpersMod.Eachable
import typingsJapgolly.reactSpringShared.distDeclarationsSrcHelpersMod.IsType
...
object distDeclarationsSrcMod {
  ...
  open class FluidValue[T, E /* <: FluidEvent[T] */] ()
    extends typingsJapgolly.reactSpringShared.distDeclarationsSrcFluidsMod.FluidValue[T, E] {
  ...
  object Globals {
    ...
    def to: js.Function2[
        /* source */ OneOrMore[
          typingsJapgolly.reactSpringShared.distDeclarationsSrcFluidsMod.FluidValue[Any, Any]
        ], 
  ...
  inline def addFluidObserver[T, E /* <: FluidEvent[Any] */](
    target: typingsJapgolly.reactSpringShared.distDeclarationsSrcFluidsMod.FluidValue[T, E],
  ...
  inline def callFluidObservers[E /* <: FluidEvent[Any] */](
    target: typingsJapgolly.reactSpringShared.distDeclarationsSrcFluidsMod.FluidValue[Any, E],
    event: E
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("callFluidObservers")(target.asInstanceOf[js.Any], event.asInstanceOf[js.Any])).asInstanceOf[Unit]
