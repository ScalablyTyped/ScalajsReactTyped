...
object distDeclarationsSrcFrameLoopMod {
  ...
  object OpaqueAnimation {
    ...
    inline def apply(advance: Double => Callback, idle: Boolean, priority: Double): OpaqueAnimation = {
      val __obj = js.Dynamic.literal(advance = js.Any.fromFunction1((t0: Double) => advance(t0).runNow()), idle = idle.asInstanceOf[js.Any], priority = priority.asInstanceOf[js.Any])
