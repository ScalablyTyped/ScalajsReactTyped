...
import typingsJapgolly.reactSpringShared.anon.FnCall
import typingsJapgolly.reactSpringShared.distDeclarationsSrcFluidsMod.FluidValue
...
object distDeclarationsSrcGlobalsMod {
  ...
  object AnimatedGlobals {
    ...
    extension [Self <: AnimatedGlobals](x: Self) {
      ...
      inline def setRequestAnimationFrame(value: /* cb */ js.Function0[Unit] => Callback): Self = StObject.set(x, "requestAnimationFrame", js.Any.fromFunction1((t0: /* cb */ js.Function0[Unit]) => value(t0).runNow()))
      ...
      inline def setWillAdvance(value: /* animation */ OpaqueAnimation => Callback): Self = StObject.set(x, "willAdvance", js.Any.fromFunction1((t0: /* animation */ OpaqueAnimation) => value(t0).runNow()))
