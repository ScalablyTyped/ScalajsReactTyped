...
import typingsJapgolly.reapop.distReducersNotificationsTypesMod.NotificationButton
...
object anon {
  ...
  trait DismissNotification extends StObject {
    ...
    var dismissNotification: typingsJapgolly.reapop.distComponentsNotificationsSystemMod.DismissNotification
    
    var notification: typingsJapgolly.reapop.distReducersNotificationsTypesMod.Notification
  }
  object DismissNotification {
    
    inline def apply(
      dismissNotification: /* id */ String => Callback,
      notification: typingsJapgolly.reapop.distReducersNotificationsTypesMod.Notification
    ): DismissNotification = {
      val __obj = js.Dynamic.literal(dismissNotification = js.Any.fromFunction1((t0: /* id */ String) => dismissNotification(t0).runNow()), notification = notification.asInstanceOf[js.Any])
    ...
    extension [Self <: DismissNotification](x: Self) {
      ...
      inline def setNotification(value: typingsJapgolly.reapop.distReducersNotificationsTypesMod.Notification): Self = StObject.set(x, "notification", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait FnCall extends StObject {
    ...
    ): typingsJapgolly.reapop.distReducersNotificationsTypesMod.Notification = js.native
    def apply(message: String): typingsJapgolly.reapop.distReducersNotificationsTypesMod.Notification = js.native
    def apply(message: String, options: PartialNotification): typingsJapgolly.reapop.distReducersNotificationsTypesMod.Notification = js.native
    def apply(message: String, status: Status): typingsJapgolly.reapop.distReducersNotificationsTypesMod.Notification = js.native
    def apply(message: String, status: Status, options: PartialNotification): typingsJapgolly.reapop.distReducersNotificationsTypesMod.Notification = js.native
    def apply(notification: PartialNotification): typingsJapgolly.reapop.distReducersNotificationsTypesMod.Notification = js.native
  }
  ...
  object Notification {
    ...
    inline def apply(notification: typingsJapgolly.reapop.distReducersNotificationsTypesMod.Notification): Notification = {
  ...
  object PartialNotificationConfig {
    ...
    extension [Self <: PartialNotificationConfig](x: Self) {
      ...
      inline def setCustomizeNotification(value: /* notification */ NewNotification => Callback): Self = StObject.set(x, "customizeNotification", js.Any.fromFunction1((t0: /* notification */ NewNotification) => value(t0).runNow()))
