...
object ReactSwipeableViews {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def animateHeight(value: Boolean): this.type = set("animateHeight", value.asInstanceOf[js.Any])
    ...
    inline def axis(value: AxisType): this.type = set("axis", value.asInstanceOf[js.Any])
    ...
    inline def disableLazyLoading(value: Boolean): this.type = set("disableLazyLoading", value.asInstanceOf[js.Any])
    ...
    inline def enableMouseEvents(value: Boolean): this.type = set("enableMouseEvents", value.asInstanceOf[js.Any])
    ...
    inline def ignoreNativeScroll(value: Boolean): this.type = set("ignoreNativeScroll", value.asInstanceOf[js.Any])
    ...
    inline def onChangeIndex(value: (/* index */ Double, /* indexLatest */ Double) => Callback): this.type = set("onChangeIndex", js.Any.fromFunction2((t0: /* index */ Double, t1: /* indexLatest */ Double) => (value(t0, t1)).runNow()))
    ...
    inline def onSwitching(value: (/* index */ Double, /* type */ OnSwitchingCallbackTypeDescriptor) => Callback): this.type = set("onSwitching", js.Any.fromFunction2((t0: /* index */ Double, t1: /* type */ OnSwitchingCallbackTypeDescriptor) => (value(t0, t1)).runNow()))
    ...
    inline def slideClassName(value: String): this.type = set("slideClassName", value.asInstanceOf[js.Any])
    
    inline def slideStyle(value: CSSProperties): this.type = set("slideStyle", value.asInstanceOf[js.Any])
    ...
    inline def springConfig(value: SpringConfig): this.type = set("springConfig", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ReactSwipeableViews.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SwipeableViewsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
