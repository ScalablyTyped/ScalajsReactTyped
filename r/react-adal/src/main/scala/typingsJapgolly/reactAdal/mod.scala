...
import typingsJapgolly.reactAdal.anon.ACCESSTOKENKEY
import typingsJapgolly.reactAdal.anon.ERROR
import typingsJapgolly.reactAdal.anon.`0`
import typingsJapgolly.reactAdal.reactAdalInts.`483`
import typingsJapgolly.reactAdal.reactAdalInts.`600`
...
object mod {
  ...
  inline def withAdalLogin(authContext: AuthenticationContext, resource: String): js.Function3[
    /* wrappedComponent */ ComponentClassP[js.Object] | FunctionComponent[js.Object], 
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactAdal.reactAdalInts.`0`
    - typingsJapgolly.reactAdal.reactAdalInts.`1`
    - typingsJapgolly.reactAdal.reactAdalInts.`2`
    - typingsJapgolly.reactAdal.reactAdalInts.`3`
  */
  trait LoggingLevel extends StObject
  object LoggingLevel {
    
    inline def `0`: typingsJapgolly.reactAdal.reactAdalInts.`0` = 0.asInstanceOf[typingsJapgolly.reactAdal.reactAdalInts.`0`]
    
    inline def `1`: typingsJapgolly.reactAdal.reactAdalInts.`1` = 1.asInstanceOf[typingsJapgolly.reactAdal.reactAdalInts.`1`]
    
    inline def `2`: typingsJapgolly.reactAdal.reactAdalInts.`2` = 2.asInstanceOf[typingsJapgolly.reactAdal.reactAdalInts.`2`]
    
    inline def `3`: typingsJapgolly.reactAdal.reactAdalInts.`3` = 3.asInstanceOf[typingsJapgolly.reactAdal.reactAdalInts.`3`]
  }
  ...
  */
  ...
  object RequestType {
    ...
    inline def LOGIN: typingsJapgolly.reactAdal.reactAdalStrings.LOGIN = "LOGIN".asInstanceOf[typingsJapgolly.reactAdal.reactAdalStrings.LOGIN]
    
    inline def RENEW_TOKEN: typingsJapgolly.reactAdal.reactAdalStrings.RENEW_TOKEN = "RENEW_TOKEN".asInstanceOf[typingsJapgolly.reactAdal.reactAdalStrings.RENEW_TOKEN]
    
    inline def UNKNOWN: typingsJapgolly.reactAdal.reactAdalStrings.UNKNOWN = "UNKNOWN".asInstanceOf[typingsJapgolly.reactAdal.reactAdalStrings.UNKNOWN]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactAdal.reactAdalStrings.`id_token token`
    - typingsJapgolly.reactAdal.reactAdalStrings.token
  */
  trait ResponseType extends StObject
  object ResponseType {
    
    inline def `id_token token`: typingsJapgolly.reactAdal.reactAdalStrings.`id_token token` = ("id_token token").asInstanceOf[typingsJapgolly.reactAdal.reactAdalStrings.`id_token token`]
    
    inline def token: typingsJapgolly.reactAdal.reactAdalStrings.token = "token".asInstanceOf[typingsJapgolly.reactAdal.reactAdalStrings.token]
  }
