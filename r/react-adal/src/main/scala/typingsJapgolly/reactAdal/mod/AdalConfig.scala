...
import typingsJapgolly.reactAdal.reactAdalStrings.localStorage
import typingsJapgolly.reactAdal.reactAdalStrings.sessionStorage
...
object AdalConfig {
  ...
  def apply(
    ...
    callback: (/* errorDesc */ String | Null, /* token */ String | Null, /* error */ js.Any) => Callback = null,
    correlationId: String = null,
    displayCall: /* url */ String => Callback = null,
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction3((t0: /* errorDesc */ java.lang.String | scala.Null, t1: /* token */ java.lang.String | scala.Null, t2: /* error */ js.Any) => callback(t0, t1, t2).runNow()))
    if (correlationId != null) __obj.updateDynamic("correlationId")(correlationId.asInstanceOf[js.Any])
    if (displayCall != null) __obj.updateDynamic("displayCall")(js.Any.fromFunction1((t0: /* url */ java.lang.String) => displayCall(t0).runNow()))
