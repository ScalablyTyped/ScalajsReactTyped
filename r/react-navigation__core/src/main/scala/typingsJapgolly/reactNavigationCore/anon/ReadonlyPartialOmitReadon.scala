...
trait ReadonlyPartialOmitReadon extends StObject {
  ...
  val routes: js.Array[
    (Omit[
      typingsJapgolly.reactNavigationRouters.libTypescriptSrcTypesMod.Route[String, js.UndefOr[js.Object]], 
      typingsJapgolly.reactNavigationCore.reactNavigationCoreStrings.key
    ]) & Any
  ]
