...
import typingsJapgolly.reactNavigationCore.anon.Data2
import typingsJapgolly.reactNavigationCore.anon.DataNoop
import typingsJapgolly.reactNavigationCore.anon.DataOptionsObject
