...
import typingsJapgolly.reactRnd.anon.Bottom
import typingsJapgolly.reactRnd.anon.Current
import typingsJapgolly.reactRnd.anon.Height
import typingsJapgolly.reactRnd.anon.HeightWidth
import typingsJapgolly.reactRnd.anon.Left
import typingsJapgolly.reactRnd.anon.Right
import typingsJapgolly.reactRnd.anon.Top
import typingsJapgolly.reactRnd.anon.Width
...
object mod {
  ...
  open class Rnd protected () extends PureComponent[Props, State, Any] {
    ...
    def onResizeStart(e: ReactMouseEventFrom[HTMLElement], dir: ResizeDirection, elementRef: HTMLElement): Unit = js.native
    def onResizeStart(e: ReactTouchEventFrom[HTMLElement], dir: ResizeDirection, elementRef: HTMLElement): Unit = js.native
  ...
  object DefaultProps {
    ...
    inline def apply(
      maxHeight: Double,
      maxWidth: Double,
      onDrag: (/* e */ DraggableEvent, /* data */ typingsJapgolly.reactDraggable.mod.DraggableData) => Unit | typingsJapgolly.reactDraggable.reactDraggableBooleans.`false`,
      onDragStart: (/* e */ DraggableEvent, /* data */ typingsJapgolly.reactDraggable.mod.DraggableData) => Unit | typingsJapgolly.reactDraggable.reactDraggableBooleans.`false`,
      onDragStop: (/* e */ DraggableEvent, /* data */ typingsJapgolly.reactDraggable.mod.DraggableData) => Unit | typingsJapgolly.reactDraggable.reactDraggableBooleans.`false`,
      onResize: (/* e */ MouseEvent | TouchEvent, /* dir */ ResizeDirection, /* elementRef */ HTMLElement, /* delta */ ResizableDelta, /* position */ Position) => Callback,
      onResizeStart: (/* e */ ReactMouseEventFrom[HTMLElement] | ReactTouchEventFrom[HTMLElement], /* dir */ ResizeDirection, /* elementRef */ HTMLElement) => Unit | Boolean,
      onResizeStop: (/* e */ MouseEvent | TouchEvent, /* dir */ ResizeDirection, /* elementRef */ HTMLElement, /* delta */ ResizableDelta, /* position */ Position) => Callback,
      scale: Double
    ): DefaultProps = {
      val __obj = js.Dynamic.literal(maxHeight = maxHeight.asInstanceOf[js.Any], maxWidth = maxWidth.asInstanceOf[js.Any], onDrag = js.Any.fromFunction2(onDrag), onDragStart = js.Any.fromFunction2(onDragStart), onDragStop = js.Any.fromFunction2(onDragStop), onResize = js.Any.fromFunction5((t0: /* e */ MouseEvent | TouchEvent, t1: /* dir */ ResizeDirection, t2: /* elementRef */ HTMLElement, t3: /* delta */ ResizableDelta, t4: /* position */ Position) => (onResize(t0, t1, t2, t3, t4)).runNow()), onResizeStart = js.Any.fromFunction3(onResizeStart), onResizeStop = js.Any.fromFunction5((t0: /* e */ MouseEvent | TouchEvent, t1: /* dir */ ResizeDirection, t2: /* elementRef */ HTMLElement, t3: /* delta */ ResizableDelta, t4: /* position */ Position) => (onResizeStop(t0, t1, t2, t3, t4)).runNow()), scale = scale.asInstanceOf[js.Any])
    ...
    extension [Self <: DefaultProps](x: Self) {
      ...
      inline def setOnDrag(
        value: (/* e */ DraggableEvent, /* data */ typingsJapgolly.reactDraggable.mod.DraggableData) => Unit | typingsJapgolly.reactDraggable.reactDraggableBooleans.`false`
      ...
      ): Self = StObject.set(x, "onResize", js.Any.fromFunction5((t0: /* e */ MouseEvent | TouchEvent, t1: /* dir */ ResizeDirection, t2: /* elementRef */ HTMLElement, t3: /* delta */ ResizableDelta, t4: /* position */ Position) => (value(t0, t1, t2, t3, t4)).runNow()))
      ...
      inline def setOnResizeStop(
        value: (/* e */ MouseEvent | TouchEvent, /* dir */ ResizeDirection, /* elementRef */ HTMLElement, /* delta */ ResizableDelta, /* position */ Position) => Callback
      ): Self = StObject.set(x, "onResizeStop", js.Any.fromFunction5((t0: /* e */ MouseEvent | TouchEvent, t1: /* dir */ ResizeDirection, t2: /* elementRef */ HTMLElement, t3: /* delta */ ResizableDelta, t4: /* position */ Position) => (value(t0, t1, t2, t3, t4)).runNow()))
  ...
  object HandleComponent {
    ...
    extension [Self <: HandleComponent](x: Self) {
      ...
      inline def setBottom(value: VdomElement): Self = StObject.set(x, "bottom", value.rawElement.asInstanceOf[js.Any])
      
      inline def setBottomLeft(value: VdomElement): Self = StObject.set(x, "bottomLeft", value.rawElement.asInstanceOf[js.Any])
      
      inline def setBottomLeftUndefined: Self = StObject.set(x, "bottomLeft", js.undefined)
      
      inline def setBottomRight(value: VdomElement): Self = StObject.set(x, "bottomRight", value.rawElement.asInstanceOf[js.Any])
      
      inline def setBottomRightUndefined: Self = StObject.set(x, "bottomRight", js.undefined)
      
      inline def setBottomUndefined: Self = StObject.set(x, "bottom", js.undefined)
      
      inline def setLeft(value: VdomElement): Self = StObject.set(x, "left", value.rawElement.asInstanceOf[js.Any])
      
      inline def setLeftUndefined: Self = StObject.set(x, "left", js.undefined)
      
      inline def setRight(value: VdomElement): Self = StObject.set(x, "right", value.rawElement.asInstanceOf[js.Any])
      
      inline def setRightUndefined: Self = StObject.set(x, "right", js.undefined)
      
      inline def setTop(value: VdomElement): Self = StObject.set(x, "top", value.rawElement.asInstanceOf[js.Any])
      
      inline def setTopLeft(value: VdomElement): Self = StObject.set(x, "topLeft", value.rawElement.asInstanceOf[js.Any])
      
      inline def setTopLeftUndefined: Self = StObject.set(x, "topLeft", js.undefined)
      
      inline def setTopRight(value: VdomElement): Self = StObject.set(x, "topRight", value.rawElement.asInstanceOf[js.Any])
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setDragAxis(value: typingsJapgolly.reactRnd.reactRndStrings.x | y | both | none): Self = StObject.set(x, "dragAxis", value.asInstanceOf[js.Any])
      ...
      inline def setOnMouseUp(value: /* e */ MouseEvent => Callback): Self = StObject.set(x, "onMouseUp", js.Any.fromFunction1((t0: /* e */ MouseEvent) => value(t0).runNow()))
  ...
  type RndDragEvent = (ReactMouseEventFrom[(HTMLElement | SVGElement) & org.scalajs.dom.Element]) | (ReactTouchEventFrom[(HTMLElement | SVGElement) & org.scalajs.dom.Element]) | MouseEvent | TouchEvent
