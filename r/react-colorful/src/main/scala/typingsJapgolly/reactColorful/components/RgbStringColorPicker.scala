...
object RgbStringColorPicker {
  
  @JSImport("react-colorful", "RgbStringColorPicker")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RgbStringColorPicker.type): SharedBuilder_PartialColorPickerBasePro2010714988 = new SharedBuilder_PartialColorPickerBasePro2010714988(js.Array(this.component, js.Dictionary.empty))()
