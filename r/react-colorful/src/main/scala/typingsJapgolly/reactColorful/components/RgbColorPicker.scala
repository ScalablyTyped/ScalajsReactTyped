...
import typingsJapgolly.reactColorful.anon.PartialColorPickerBaseProAriaautocomplete
...
object RgbColorPicker {
  
  @JSImport("react-colorful", "RgbColorPicker")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: RgbColor): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* newColor */ RgbColor => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* newColor */ RgbColor) => value(t0).runNow()))
  ...
  implicit def make(companion: RgbColorPicker.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PartialColorPickerBaseProAriaautocomplete): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
