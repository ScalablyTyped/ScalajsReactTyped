...
import typingsJapgolly.reactColorful.anon.PartialColorPickerBaseProAriaatomic
...
object HsvaColorPicker {
  
  @JSImport("react-colorful", "HsvaColorPicker")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: HsvaColor): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* newColor */ HsvaColor => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* newColor */ HsvaColor) => value(t0).runNow()))
  ...
  implicit def make(companion: HsvaColorPicker.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PartialColorPickerBaseProAriaatomic): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
