...
object HsvaStringColorPicker {
  
  @JSImport("react-colorful", "HsvaStringColorPicker")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: HsvaStringColorPicker.type): SharedBuilder_PartialColorPickerBasePro2010714988 = new SharedBuilder_PartialColorPickerBasePro2010714988(js.Array(this.component, js.Dictionary.empty))()
