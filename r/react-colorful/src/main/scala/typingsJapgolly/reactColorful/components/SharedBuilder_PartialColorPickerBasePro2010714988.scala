...
@scala.inline
open class SharedBuilder_PartialColorPickerBasePro2010714988 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def onChange(value: /* newColor */ String => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* newColor */ String) => value(t0).runNow()))
