...
import typingsJapgolly.reactColorful.anon.PartialColorPickerBaseProAriabusy
...
object RgbaColorPicker {
  
  @JSImport("react-colorful", "RgbaColorPicker")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: RgbaColor): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* newColor */ RgbaColor => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* newColor */ RgbaColor) => value(t0).runNow()))
  ...
  implicit def make(companion: RgbaColorPicker.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PartialColorPickerBaseProAriabusy): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
