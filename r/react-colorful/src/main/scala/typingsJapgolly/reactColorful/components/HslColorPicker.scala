...
import typingsJapgolly.reactColorful.anon.PartialColorPickerBaseProAbout
import typingsJapgolly.reactColorful.distTypesMod.HslColor
...
object HslColorPicker {
  
  @JSImport("react-colorful", "HslColorPicker")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: HslColor): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* newColor */ HslColor => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* newColor */ HslColor) => value(t0).runNow()))
  ...
  implicit def make(companion: HslColorPicker.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PartialColorPickerBaseProAbout): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
