...
import typingsJapgolly.reactColorful.distComponentsHexColorInputMod.HexColorInputProps
...
object HexColorInput {
  
  @JSImport("react-colorful", "HexColorInput")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def alpha(value: Boolean): this.type = set("alpha", value.asInstanceOf[js.Any])
    ...
    inline def prefixed(value: Boolean): this.type = set("prefixed", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: HexColorInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HexColorInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
