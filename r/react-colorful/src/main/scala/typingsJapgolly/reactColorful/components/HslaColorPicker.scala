...
import typingsJapgolly.reactColorful.anon.PartialColorPickerBaseProAccessKey
...
object HslaColorPicker {
  
  @JSImport("react-colorful", "HslaColorPicker")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: HslaColor): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* newColor */ HslaColor => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* newColor */ HslaColor) => value(t0).runNow()))
  ...
  implicit def make(companion: HslaColorPicker.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PartialColorPickerBaseProAccessKey): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
