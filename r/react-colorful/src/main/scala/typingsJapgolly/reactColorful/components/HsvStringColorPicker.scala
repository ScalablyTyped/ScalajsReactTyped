...
object HsvStringColorPicker {
  
  @JSImport("react-colorful", "HsvStringColorPicker")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: HsvStringColorPicker.type): SharedBuilder_PartialColorPickerBasePro2010714988 = new SharedBuilder_PartialColorPickerBasePro2010714988(js.Array(this.component, js.Dictionary.empty))()
