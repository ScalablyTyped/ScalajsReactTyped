...
import typingsJapgolly.reactColorful.anon.PartialColorPickerBaseProAriaactivedescendant
...
object HsvColorPicker {
  ...
  @JSImport("react-colorful", "HsvColorPicker")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: HsvColor): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* newColor */ HsvColor => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* newColor */ HsvColor) => value(t0).runNow()))
  ...
  implicit def make(companion: HsvColorPicker.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PartialColorPickerBaseProAriaactivedescendant): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
