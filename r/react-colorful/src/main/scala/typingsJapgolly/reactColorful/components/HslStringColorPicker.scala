...
object HslStringColorPicker {
  
  @JSImport("react-colorful", "HslStringColorPicker")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: HslStringColorPicker.type): SharedBuilder_PartialColorPickerBasePro2010714988 = new SharedBuilder_PartialColorPickerBasePro2010714988(js.Array(this.component, js.Dictionary.empty))()
