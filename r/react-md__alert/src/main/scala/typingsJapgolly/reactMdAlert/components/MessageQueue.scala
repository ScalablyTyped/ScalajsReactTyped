package typingsJapgolly.reactMdAlert.components
...
import typingsJapgolly.reactMdAlert.typesSnackbarMod.SnackbarPosition
...
object MessageQueue {
  ...
  inline def apply[M /* <: ToastMessage */](id: String): Builder[M] = {
  ...
  @scala.inline
  open class Builder[M /* <: ToastMessage */] (val args: js.Array[Any])
    extends AnyVal
    ...
    inline def defaultQueue(value: js.Array[M]): this.type = set("defaultQueue", value.asInstanceOf[js.Any])
    
    inline def defaultQueueVarargs(value: M*): this.type = set("defaultQueue", js.Array(value*))
    ...
    inline def duplicates(value: DuplicateBehavior): this.type = set("duplicates", value.asInstanceOf[js.Any])
    ...
    inline def onActionClick(value: (M, /* event */ ReactMouseEventFrom[HTMLButtonElement]) => Callback): this.type = set("onActionClick", js.Any.fromFunction2((t0: M, t1: /* event */ ReactMouseEventFrom[HTMLButtonElement]) => (value(t0, t1)).runNow()))
    ...
    inline def position(value: SnackbarPosition): this.type = set("position", value.asInstanceOf[js.Any])
