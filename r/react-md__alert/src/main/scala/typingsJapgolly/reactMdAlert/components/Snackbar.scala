...
object Snackbar {
  ...
  inline def apply(id: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[SnackbarProps & RefAttributes[HTMLDivElement]]))
  }
  ...
  def withProps(p: SnackbarProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
