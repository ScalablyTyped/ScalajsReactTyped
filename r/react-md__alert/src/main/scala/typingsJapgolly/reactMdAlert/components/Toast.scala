...
object Toast {
  ...
  inline def apply(visible: Boolean): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ToastProps & RefAttributes[HTMLDivElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def twoLines(value: Boolean): this.type = set("twoLines", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ToastProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
