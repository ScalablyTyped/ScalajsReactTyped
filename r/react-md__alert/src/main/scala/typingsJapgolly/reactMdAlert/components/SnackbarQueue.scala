...
import typingsJapgolly.reactMdAlert.typesSnackbarQueueMod.SnackbarQueueProps
...
object SnackbarQueue {
  ...
  inline def apply(id: String, queue: js.Array[Any]): Builder = {
    val __props = js.Dynamic.literal(id = id.asInstanceOf[js.Any], queue = queue.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[SnackbarQueueProps[Any] & RefAttributes[HTMLDivElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onActionClick(value: (Any, /* event */ ReactMouseEventFrom[HTMLButtonElement]) => Callback): this.type = set("onActionClick", js.Any.fromFunction2((t0: Any, t1: /* event */ ReactMouseEventFrom[HTMLButtonElement]) => (value(t0, t1)).runNow()))
  ...
  def withProps(p: SnackbarQueueProps[Any] & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
