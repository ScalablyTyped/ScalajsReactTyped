...
object mod {
  ...
  inline def componentFromStream[TProps](propsToReactNode: mapper[Subscribable[TProps], Subscribable[Node]]): ComponentType[TProps] = ^.asInstanceOf[js.Dynamic].applyDynamic("componentFromStream")(propsToReactNode.asInstanceOf[js.Any]).asInstanceOf[ComponentType[TProps]]
  ...
  inline def createEagerElement(`type`: String): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("createEagerElement")(`type`.asInstanceOf[js.Any]).asInstanceOf[Element]
  inline def createEagerElement(`type`: String, props: js.Object): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("createEagerElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[Element]
  inline def createEagerElement(`type`: String, props: js.Object, children: Node): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("createEagerElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[Element]
  inline def createEagerElement(`type`: String, props: Unit, children: Node): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("createEagerElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[Element]
  inline def createEagerElement(`type`: ComponentType[Any]): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("createEagerElement")(`type`.asInstanceOf[js.Any]).asInstanceOf[Element]
  inline def createEagerElement(`type`: ComponentType[Any], props: js.Object): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("createEagerElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[Element]
  inline def createEagerElement(`type`: ComponentType[Any], props: js.Object, children: Node): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("createEagerElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[Element]
  inline def createEagerElement(`type`: ComponentType[Any], props: Unit, children: Node): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("createEagerElement")(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[Element]
  ...
  inline def createSink(callback: js.Function1[/* props */ js.Object, Unit]): ComponentClassP[Any & js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("createSink")(callback.asInstanceOf[js.Any]).asInstanceOf[ComponentClassP[Any & js.Object]]
  ...
  inline def nest(Components: (String | ComponentType[Any])*): ComponentClassP[Any & js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("nest")(Components.asInstanceOf[Seq[js.Any]]*).asInstanceOf[ComponentClassP[Any & js.Object]]
  ...
  type ComponentEnhancer[TInner, TOutter] = js.Function1[/* component */ ComponentType[TInner], ComponentClassP[TOutter & js.Object]]
  ...
  object EventHandlerOf {
    ...
    inline def apply[T, TSubs /* <: Subscribable[T] */](handler: T => Callback, stream: TSubs): EventHandlerOf[T, TSubs] = {
      val __obj = js.Dynamic.literal(handler = js.Any.fromFunction1((t0: T) => handler(t0).runNow()), stream = stream.asInstanceOf[js.Any])
    ...
    extension [Self <: EventHandlerOf[?, ?], T, TSubs /* <: Subscribable[T] */](x: Self & (EventHandlerOf[T, TSubs])) {
      ...
      inline def setHandler(value: T => Callback): Self = StObject.set(x, "handler", js.Any.fromFunction1((t0: T) => value(t0).runNow()))
  ...
  type componentFactory = js.Function2[/* props */ js.UndefOr[js.Object], /* children */ js.UndefOr[Node], Element]
