...
import typingsJapgolly.reactNativeMaps.anon.Duration
import typingsJapgolly.reactNativeMaps.anon.Frame
import typingsJapgolly.reactNativeMaps.anon.PartialCamera
import typingsJapgolly.reactNativeMaps.anon.PartialNativePropsAccessibilityIgnoresInvertColors
import typingsJapgolly.reactNativeMaps.anon.TypeofMapView
import typingsJapgolly.reactNativeMaps.libMapViewDottypesMod.Address
import typingsJapgolly.reactNativeMaps.libMapViewDottypesMod.BoundingBox
...
import typingsJapgolly.reactNativeMaps.libMapViewDottypesMod.FitToOptions
...
import typingsJapgolly.reactNativeMaps.libMapViewDottypesMod.SnapshotOptions
...
object libMapViewMod {
  ...
  object MapViewProps {
    ...
    extension [Self <: MapViewProps](x: Self) {
      ...
      inline def setOnRegionChange(value: (/* region */ Region, /* details */ Details) => Callback): Self = StObject.set(x, "onRegionChange", js.Any.fromFunction2((t0: /* region */ Region, t1: /* details */ Details) => (value(t0, t1)).runNow()))
      
      inline def setOnRegionChangeComplete(value: (/* region */ Region, /* details */ Details) => Callback): Self = StObject.set(x, "onRegionChangeComplete", js.Any.fromFunction2((t0: /* region */ Region, t1: /* details */ Details) => (value(t0, t1)).runNow()))
  ...
  trait NativeProps extends StObject {
    ...
    var ref: RefHandle[MapViewNativeComponentType]
  ...
  object NativeProps {
    ...
    inline def apply(ref: RefHandle[MapViewNativeComponentType]): NativeProps = {
