...
import typingsJapgolly.reactNativeMaps.mod.MapPolylineProps
...
object Polyline {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MapPolylineProps, typingsJapgolly.reactNativeMaps.mod.Polyline, Unit, MapPolylineProps] = {
  ...
  typingsJapgolly.reactNativeMaps.mod.MapPolylineProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaps.mod.Polyline](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaps.mod.MapPolylineProps])(children: _*)
  }
