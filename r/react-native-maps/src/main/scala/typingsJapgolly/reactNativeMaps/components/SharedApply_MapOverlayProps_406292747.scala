...
import typingsJapgolly.reactNativeMaps.mod.Coordinate
import typingsJapgolly.reactNativeMaps.mod.MapOverlayProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_MapOverlayProps_406292747[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MapOverlayProps, ComponentRef, Unit, MapOverlayProps] = {
  ...
  typingsJapgolly.reactNativeMaps.mod.MapOverlayProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaps.mod.MapOverlayProps])(children: _*)
  }
}
