...
@scala.inline
open class SharedBuilder_MapUrlTileProps717996563[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def doubleTileSize(value: Boolean): this.type = set("doubleTileSize", value.asInstanceOf[js.Any])
  
  inline def flipY(value: Boolean): this.type = set("flipY", value.asInstanceOf[js.Any])
  ...
  inline def maximumNativeZ(value: Double): this.type = set("maximumNativeZ", value.asInstanceOf[js.Any])
  
  inline def maximumZ(value: Double): this.type = set("maximumZ", value.asInstanceOf[js.Any])
  
  inline def minimumZ(value: Double): this.type = set("minimumZ", value.asInstanceOf[js.Any])
  ...
  inline def offlineMode(value: Boolean): this.type = set("offlineMode", value.asInstanceOf[js.Any])
  ...
  inline def shouldReplaceMapContent(value: Boolean): this.type = set("shouldReplaceMapContent", value.asInstanceOf[js.Any])
  ...
  inline def tileCacheMaxAge(value: Double): this.type = set("tileCacheMaxAge", value.asInstanceOf[js.Any])
  
  inline def tileCachePath(value: String): this.type = set("tileCachePath", value.asInstanceOf[js.Any])
