...
import typingsJapgolly.reactNativeMaps.mod.MapUrlTileProps
...
object UrlTile {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MapUrlTileProps, typingsJapgolly.reactNativeMaps.mod.UrlTile, Unit, MapUrlTileProps] = {
  ...
  typingsJapgolly.reactNativeMaps.mod.MapUrlTileProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaps.mod.UrlTile](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaps.mod.MapUrlTileProps])(children: _*)
  }
