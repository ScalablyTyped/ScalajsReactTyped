...
@scala.inline
open class SharedBuilder_MapMarkerProps_165459233[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def anchor(value: Point): this.type = set("anchor", value.asInstanceOf[js.Any])
  
  inline def calloutAnchor(value: Point): this.type = set("calloutAnchor", value.asInstanceOf[js.Any])
  
  inline def calloutOffset(value: Point): this.type = set("calloutOffset", value.asInstanceOf[js.Any])
  
  inline def centerOffset(value: Point): this.type = set("centerOffset", value.asInstanceOf[js.Any])
  ...
  inline def icon(value: ImageURISource | ImageRequireSource): this.type = set("icon", value.asInstanceOf[js.Any])
  ...
  inline def isPreselected(value: Boolean): this.type = set("isPreselected", value.asInstanceOf[js.Any])
  ...
  inline def onDeselect(value: /* event */ MarkerDeselectEvent => Callback): this.type = set("onDeselect", js.Any.fromFunction1((t0: /* event */ MarkerDeselectEvent) => value(t0).runNow()))
  
  inline def onDrag(value: /* event */ MarkerDragEvent => Callback): this.type = set("onDrag", js.Any.fromFunction1((t0: /* event */ MarkerDragEvent) => value(t0).runNow()))
  
  inline def onDragEnd(value: /* event */ MarkerDragStartEndEvent => Callback): this.type = set("onDragEnd", js.Any.fromFunction1((t0: /* event */ MarkerDragStartEndEvent) => value(t0).runNow()))
  
  inline def onDragStart(value: /* event */ MarkerDragStartEndEvent => Callback): this.type = set("onDragStart", js.Any.fromFunction1((t0: /* event */ MarkerDragStartEndEvent) => value(t0).runNow()))
  ...
  inline def onPress(value: /* event */ MarkerPressEvent => Callback): this.type = set("onPress", js.Any.fromFunction1((t0: /* event */ MarkerPressEvent) => value(t0).runNow()))
  ...
  inline def onSelect(value: /* event */ MarkerSelectEvent => Callback): this.type = set("onSelect", js.Any.fromFunction1((t0: /* event */ MarkerSelectEvent) => value(t0).runNow()))
  ...
  inline def pinColor(value: String): this.type = set("pinColor", value.asInstanceOf[js.Any])
  ...
  inline def tracksInfoWindowChanges(value: Boolean): this.type = set("tracksInfoWindowChanges", value.asInstanceOf[js.Any])
