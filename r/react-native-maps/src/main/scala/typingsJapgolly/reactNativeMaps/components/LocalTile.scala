...
import typingsJapgolly.reactNativeMaps.mod.MapLocalTileProps
...
object LocalTile {
  def apply(
    ...
    MapLocalTileProps, 
    typingsJapgolly.reactNativeMaps.mod.LocalTile, 
    Unit, 
    MapLocalTileProps
  ] = {
  ...
  typingsJapgolly.reactNativeMaps.mod.MapLocalTileProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaps.mod.LocalTile](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaps.mod.MapLocalTileProps])(children: _*)
  }
