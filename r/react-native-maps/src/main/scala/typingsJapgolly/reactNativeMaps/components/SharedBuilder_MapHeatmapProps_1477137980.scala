...
@scala.inline
open class SharedBuilder_MapHeatmapProps_1477137980[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def gradient(value: ColorMapSize): this.type = set("gradient", value.asInstanceOf[js.Any])
  ...
  inline def points(value: js.Array[WeightedLatLng]): this.type = set("points", value.asInstanceOf[js.Any])
  
  inline def pointsVarargs(value: WeightedLatLng*): this.type = set("points", js.Array(value*))
