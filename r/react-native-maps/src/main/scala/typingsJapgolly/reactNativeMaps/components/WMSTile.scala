...
import typingsJapgolly.reactNativeMaps.mod.MapWMSTileProps
...
object WMSTile {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MapWMSTileProps, typingsJapgolly.reactNativeMaps.mod.WMSTile, Unit, MapWMSTileProps] = {
  ...
  typingsJapgolly.reactNativeMaps.mod.MapWMSTileProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaps.mod.WMSTile](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaps.mod.MapWMSTileProps])(children: _*)
  }
