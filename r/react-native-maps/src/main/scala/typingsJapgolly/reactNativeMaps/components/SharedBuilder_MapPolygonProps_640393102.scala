...
@scala.inline
open class SharedBuilder_MapPolygonProps_640393102[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def geodesic(value: Boolean): this.type = set("geodesic", value.asInstanceOf[js.Any])
  ...
  inline def holes(value: js.Array[js.Array[LatLng]]): this.type = set("holes", value.asInstanceOf[js.Any])
  
  inline def holesVarargs(value: js.Array[LatLng]*): this.type = set("holes", js.Array(value*))
  ...
  inline def onPress(value: /* event */ PolygonPressEvent => Callback): this.type = set("onPress", js.Any.fromFunction1((t0: /* event */ PolygonPressEvent) => value(t0).runNow()))
