...
import typingsJapgolly.reactNativeMaps.mod.AnimatedRegion
import typingsJapgolly.reactNativeMaps.mod.LatLng
import typingsJapgolly.reactNativeMaps.mod.MarkerProps
import typingsJapgolly.reactNativeMaps.mod.Point
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_MarkerProps1069043699[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MarkerProps, ComponentRef, Unit, MarkerProps] = {
  ...
  typingsJapgolly.reactNativeMaps.mod.MarkerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaps.mod.MarkerProps])(children: _*)
  }
}
