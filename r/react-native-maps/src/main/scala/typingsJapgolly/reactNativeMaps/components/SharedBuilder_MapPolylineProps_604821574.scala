...
@scala.inline
open class SharedBuilder_MapPolylineProps_604821574[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def onPress(value: /* event */ PolylinePressEvent => Callback): this.type = set("onPress", js.Any.fromFunction1((t0: /* event */ PolylinePressEvent) => value(t0).runNow()))
  ...
  inline def strokeColors(value: js.Array[String]): this.type = set("strokeColors", value.asInstanceOf[js.Any])
  
  inline def strokeColorsVarargs(value: String*): this.type = set("strokeColors", js.Array(value*))
