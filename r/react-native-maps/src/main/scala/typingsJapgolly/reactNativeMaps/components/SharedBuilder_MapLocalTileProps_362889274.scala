...
@scala.inline
open class SharedBuilder_MapLocalTileProps_362889274[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def useAssets(value: Boolean): this.type = set("useAssets", value.asInstanceOf[js.Any])
