...
import typingsJapgolly.reactNativeMaps.mod.MapPolygonProps
...
object Polygon {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MapPolygonProps, typingsJapgolly.reactNativeMaps.mod.Polygon, Unit, MapPolygonProps] = {
  ...
  typingsJapgolly.reactNativeMaps.mod.MapPolygonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaps.mod.Polygon](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaps.mod.MapPolygonProps])(children: _*)
  }
