...
import typingsJapgolly.reactNativeMaps.mod.MapCircleProps
...
object Circle {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MapCircleProps, typingsJapgolly.reactNativeMaps.mod.Circle, Unit, MapCircleProps] = {
  ...
  typingsJapgolly.reactNativeMaps.mod.MapCircleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaps.mod.Circle](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaps.mod.MapCircleProps])(children: _*)
  }
