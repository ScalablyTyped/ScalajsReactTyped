...
@scala.inline
open class SharedBuilder_MapCalloutProps_219889337[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def alphaHitTest(value: Boolean): this.type = set("alphaHitTest", value.asInstanceOf[js.Any])
  ...
  inline def onPress(value: /* event */ CalloutPressEvent => Callback): this.type = set("onPress", js.Any.fromFunction1((t0: /* event */ CalloutPressEvent) => value(t0).runNow()))
