...
import typingsJapgolly.reactNativeMaps.mod.MapCalloutSubviewProps
...
object CalloutSubview {
  def apply(
    ...
    typingsJapgolly.reactNativeMaps.mod.CalloutSubview, 
    Unit, 
    MapCalloutSubviewProps
  ] = {
  ...
  typingsJapgolly.reactNativeMaps.mod.MapCalloutSubviewProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaps.mod.CalloutSubview](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaps.mod.MapCalloutSubviewProps])(children: _*)
  }
