...
import typingsJapgolly.reactNativeMaps.libMapCalloutSubviewMod.CalloutSubviewPressEvent
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@scala.inline
open class SharedBuilder_MapCalloutSubviewProps_1542353043[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def onPress(value: /* event */ CalloutSubviewPressEvent => Callback): this.type = set("onPress", js.Any.fromFunction1((t0: /* event */ CalloutSubviewPressEvent) => value(t0).runNow()))
