...
import typingsJapgolly.reactNativeMaps.mod.MapCalloutProps
...
object Callout {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MapCalloutProps, typingsJapgolly.reactNativeMaps.mod.Callout, Unit, MapCalloutProps] = {
  ...
  typingsJapgolly.reactNativeMaps.mod.MapCalloutProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeMaps.mod.Callout](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeMaps.mod.MapCalloutProps])(children: _*)
  }
  @JSImport("react-native-maps", "Callout")
  @js.native
