...
import typingsJapgolly.reactNativeMaps.anon.PartialNativePropsAccessibilityElementsHidden
...
object libMapMarkerMod {
  ...
  trait NativeProps extends StObject {
    ...
    var ref: RefHandle[MapMarkerNativeComponentType]
  ...
  object NativeProps {
    ...
    inline def apply(coordinate: LatLng, ref: RefHandle[MapMarkerNativeComponentType]): NativeProps = {
