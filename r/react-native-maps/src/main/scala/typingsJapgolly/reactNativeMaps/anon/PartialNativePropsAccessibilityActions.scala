...
import typingsJapgolly.reactNativeMaps.libMapHeatmapMod.WeightedLatLng
...
/* Inlined std.Partial<react-native-maps.react-native-maps/lib/MapHeatmap.NativeProps> */
trait PartialNativePropsAccessibilityActions extends StObject {
...
object PartialNativePropsAccessibilityActions {
  
  inline def apply(): PartialNativePropsAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialNativePropsAccessibilityActions]
  }
  
  extension [Self <: PartialNativePropsAccessibilityActions](x: Self) {
