...
import typingsJapgolly.reactNativeMaps.libMapPolylineMod.PolylinePressEvent
...
/* Inlined std.Partial<react-native-maps.react-native-maps/lib/MapPolyline.NativeProps> */
trait PartialNativePropsAccessibilityHint extends StObject {
...
object PartialNativePropsAccessibilityHint {
  
  inline def apply(): PartialNativePropsAccessibilityHint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialNativePropsAccessibilityHint]
  }
  
  extension [Self <: PartialNativePropsAccessibilityHint](x: Self) {
