...
import typingsJapgolly.reactNativeMaps.libMapPolygonMod.PolygonPressEvent
...
/* Inlined std.Partial<react-native-maps.react-native-maps/lib/MapPolygon.MapPolygonProps> */
trait PartialMapPolygonProps extends StObject {
  ...
  var onPress: js.UndefOr[js.Function1[/* event */ PolygonPressEvent, Unit]] = js.undefined
...
object PartialMapPolygonProps {
  
  inline def apply(): PartialMapPolygonProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMapPolygonProps]
  }
  
  extension [Self <: PartialMapPolygonProps](x: Self) {
    ...
    inline def setOnPress(value: /* event */ PolygonPressEvent => Callback): Self = StObject.set(x, "onPress", js.Any.fromFunction1((t0: /* event */ PolygonPressEvent) => value(t0).runNow()))
