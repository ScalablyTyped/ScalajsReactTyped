...
/* Inlined std.Partial<react-native-maps.react-native-maps/lib/MapCircle.NativeProps> */
trait PartialNativeProps extends StObject {
...
object PartialNativeProps {
  
  inline def apply(): PartialNativeProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialNativeProps]
  }
  
  extension [Self <: PartialNativeProps](x: Self) {
