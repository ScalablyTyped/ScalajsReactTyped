...
import typingsJapgolly.reactNativeMaps.reactNativeMapsStrings.point
import typingsJapgolly.reactNativeMaps.reactNativeMapsStrings.polygon_
import typingsJapgolly.reactNativeMaps.reactNativeMapsStrings.polyline_
...
object libGeojsonMod {
  ...
  trait GeojsonProps extends StObject {
    ...
    /**
      ...
      * @platform Android: Supported
      */
    var markerComponent: js.UndefOr[Node] = js.undefined
  ...
  object GeojsonProps {
    ...
    extension [Self <: GeojsonProps](x: Self) {
      ...
      inline def setMarkerComponent(value: VdomNode): Self = StObject.set(x, "markerComponent", value.rawNode.asInstanceOf[js.Any])
      
      inline def setMarkerComponentNull: Self = StObject.set(x, "markerComponent", null)
      
      inline def setMarkerComponentUndefined: Self = StObject.set(x, "markerComponent", js.undefined)
      
      inline def setMarkerComponentVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "markerComponent", js.Array(value*))
      
      inline def setMarkerComponentVdomElement(value: VdomElement): Self = StObject.set(x, "markerComponent", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnPress(value: /* event */ OverlayPressEvent => Callback): Self = StObject.set(x, "onPress", js.Any.fromFunction1((t0: /* event */ OverlayPressEvent) => value(t0).runNow()))
