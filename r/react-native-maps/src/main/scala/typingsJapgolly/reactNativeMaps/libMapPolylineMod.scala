...
import typingsJapgolly.reactNativeMaps.anon.PartialNativePropsAccessibilityHint
import typingsJapgolly.reactNativeMaps.anon.Position
...
object libMapPolylineMod {
  
  /* was `typeof MapPolyline` */
  @JSImport("react-native-maps/lib/MapPolyline", JSImport.Default)
  @js.native
  open class default protected () extends MapPolyline {
    def this(props: MapPolylineProps) = this()
  }
  
  @JSImport("react-native-maps/lib/MapPolyline", "MapPolyline")
  @js.native
  open class MapPolyline protected ()
    extends Component[MapPolylineProps, js.Object, Any] {
    def this(props: MapPolylineProps) = this()
    
    @JSName("context")
    var context_MapPolyline: ContextType[Context[Provider]] = js.native
    ...
    /* private */ var polyline: Any = js.native
    
    def setNativeProps(props: PartialNativePropsAccessibilityHint): Unit = js.native
  }
  ...
  trait MapPolylineProps
    ...
    /**
      ...
      * @platform Android: Supported
      */
    var onPress: js.UndefOr[js.Function1[/* event */ PolylinePressEvent, Unit]] = js.undefined
  ...
  object MapPolylineProps {
    ...
    extension [Self <: MapPolylineProps](x: Self) {
      ...
      inline def setOnPress(value: /* event */ PolylinePressEvent => Callback): Self = StObject.set(x, "onPress", js.Any.fromFunction1((t0: /* event */ PolylinePressEvent) => value(t0).runNow()))
      ...
      inline def setStrokeColorsVarargs(value: String*): Self = StObject.set(x, "strokeColors", js.Array(value*))
  ...
  /* Inlined react-native-maps.react-native-maps/lib/MapPolyline.MapPolylineProps & {  ref :react.react.RefObject<react-native.react-native.View>} */
  ...
  object NativeProps {
    ...
    inline def apply(coordinates: js.Array[LatLng], ref: RefHandle[View]): NativeProps = {
      val __obj = js.Dynamic.literal(coordinates = coordinates.asInstanceOf[js.Any], ref = ref.asInstanceOf[js.Any])
  ...
  type PolylinePressEvent = NativeSyntheticEvent[Position]
  
  /* was `typeof MapPolyline` */
  type _default = MapPolyline
}
