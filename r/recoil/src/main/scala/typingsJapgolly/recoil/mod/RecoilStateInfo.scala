...
import typingsJapgolly.recoil.anon.Components
...
trait RecoilStateInfo[T] extends StObject {
  ...
  var `type`: typingsJapgolly.recoil.recoilStrings.atom | typingsJapgolly.recoil.recoilStrings.selector
}
object RecoilStateInfo {
  ...
  inline def apply[T](
    ...
    `type`: typingsJapgolly.recoil.recoilStrings.atom | typingsJapgolly.recoil.recoilStrings.selector
  ): RecoilStateInfo[T] = {
  ...
  extension [Self <: RecoilStateInfo[?], T](x: Self & RecoilStateInfo[T]) {
    ...
    inline def setType(value: typingsJapgolly.recoil.recoilStrings.atom | typingsJapgolly.recoil.recoilStrings.selector): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
