...
version := "2.3.5-15fcd4"
scalaVersion := "3.1.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.github.japgolly.scalajs-react" %%% "core" % "2.1.1",
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped.japgolly" %%% "callstack__react-theme-provider" % "3.0.8-1bd67a",
  ...
  "org.scalablytyped.japgolly" %%% "react-native-paper" % "4.12.5-a3685d",
