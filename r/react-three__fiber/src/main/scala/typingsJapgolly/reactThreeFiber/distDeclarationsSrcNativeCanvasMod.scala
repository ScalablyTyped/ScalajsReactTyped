...
import typingsJapgolly.reactThreeFiber.reactThreeFiberStrings.`box-none`
import typingsJapgolly.reactThreeFiber.reactThreeFiberStrings.`box-only`
import typingsJapgolly.reactThreeFiber.reactThreeFiberStrings.`no-hide-descendants`
...
import typingsJapgolly.reactThreeFiber.reactThreeFiberStrings.auto
...
object distDeclarationsSrcNativeCanvasMod {
  
  @JSImport("@react-three/fiber/dist/declarations/src/native/Canvas", "Canvas")
  @js.native
  val Canvas: ForwardRefExoticComponent[Props & RefAttributes[View]] = js.native
  
  /* Inlined parent std.Omit<@react-three/fiber.@react-three/fiber/dist/declarations/src/core.RenderProps<std.HTMLCanvasElement>, 'size' | 'dpr'> */
  /* Inlined parent react-native.react-native.ViewProps */
