...
import typingsJapgolly.reactThreeFiber.distDeclarationsSrcThreeTypesMod.Euler
import typingsJapgolly.reactThreeFiber.distDeclarationsSrcThreeTypesMod.Layers
import typingsJapgolly.reactThreeFiber.distDeclarationsSrcThreeTypesMod.Matrix4
import typingsJapgolly.reactThreeFiber.distDeclarationsSrcThreeTypesMod.Quaternion
import typingsJapgolly.reactThreeFiber.distDeclarationsSrcThreeTypesMod.Vector3
...
object Dispose {
  ...
  extension [Self <: Dispose](x: Self) {
    ...
    inline def setMatrixFunction16(
      value: (/* n11 */ Double, /* n12 */ Double, /* n13 */ Double, /* n14 */ Double, /* n21 */ Double, /* n22 */ Double, /* n23 */ Double, /* n24 */ Double, /* n31 */ Double, /* n32 */ Double, /* n33 */ Double, /* n34 */ Double, /* n41 */ Double, /* n42 */ Double, /* n43 */ Double, /* n44 */ Double) => typingsJapgolly.three.srcMathMatrix4Mod.Matrix4
