...
object mod {
  ...
  inline def generateTrigger(PortalComponent: Any): ComponentClassP[TriggerProps & js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("generateTrigger")(PortalComponent.asInstanceOf[js.Any]).asInstanceOf[ComponentClassP[TriggerProps & js.Object]]
  ...
  trait TriggerProps extends StObject {
    ...
    var popup: Node | js.Function0[Node]
  ...
  object TriggerProps {
    ...
    inline def apply(children: VdomElement): TriggerProps = {
      val __obj = js.Dynamic.literal(children = children.rawElement.asInstanceOf[js.Any], popup = null)
    ...
    extension [Self <: TriggerProps](x: Self) {
      ...
      inline def setAfterPopupVisibleChange(value: /* visible */ Boolean => Callback): Self = StObject.set(x, "afterPopupVisibleChange", js.Any.fromFunction1((t0: /* visible */ Boolean) => value(t0).runNow()))
      ...
      inline def setOnPopupClick(value: ReactMouseEventFrom[HTMLDivElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onPopupClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLDivElement & org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setPopup(value: Node | js.Function0[Node]): Self = StObject.set(x, "popup", value.asInstanceOf[js.Any])
      ...
      inline def setPopupCallbackTo(value: CallbackTo[Node]): Self = StObject.set(x, "popup", value.toJsFn)
      ...
      inline def setPopupVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "popup", js.Array(value*))
