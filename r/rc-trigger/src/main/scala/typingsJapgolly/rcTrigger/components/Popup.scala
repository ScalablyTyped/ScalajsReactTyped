...
import typingsJapgolly.rcTrigger.esPopupMod.PopupProps
...
object Popup {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PopupProps & RefAttributes[PopupInnerRef]]))
  }
  ...
  def withProps(p: PopupProps & RefAttributes[PopupInnerRef]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
