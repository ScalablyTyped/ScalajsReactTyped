...
import typingsJapgolly.rcTrigger.esPopupMobilePopupInnerMod.MobilePopupInnerProps
...
object MobilePopupInner {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[MobilePopupInnerProps & RefAttributes[PopupInnerRef]]))
  }
  ...
  def withProps(p: MobilePopupInnerProps & RefAttributes[PopupInnerRef]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
