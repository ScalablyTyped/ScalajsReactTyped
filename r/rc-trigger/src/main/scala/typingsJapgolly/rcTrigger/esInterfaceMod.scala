...
import typingsJapgolly.rcTrigger.anon.AdjustX
...
object esInterfaceMod {
  ...
  object CommonEventHandler {
    ...
    inline def apply(remove: Callback): CommonEventHandler = {
  ...
  trait MobileConfig extends StObject {
    ...
    var popupRender: js.UndefOr[js.Function1[/* originNode */ Node, Node]] = js.undefined
  ...
  object MobileConfig {
    ...
    extension [Self <: MobileConfig](x: Self) {
      ...
      inline def setPopupRender(value: /* originNode */ Node => Node): Self = StObject.set(x, "popupRender", js.Any.fromFunction1(value))
