...
import typingsJapgolly.remarkable.anon.Ruler
import typingsJapgolly.remarkable.anon.`0`
import typingsJapgolly.remarkable.anon.`1`
...
trait Remarkable extends StObject {
  ...
  var renderer: typingsJapgolly.remarkable.libRendererMod.^ = js.native
