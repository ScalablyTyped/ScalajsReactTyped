...
import typingsJapgolly.remarkable.Anon0
import typingsJapgolly.remarkable.Anon1
import typingsJapgolly.remarkable.AnonRuler
...
trait Remarkable extends js.Object {
  ...
  var renderer: typingsJapgolly.remarkable.rendererMod.^ = js.native
  /**
