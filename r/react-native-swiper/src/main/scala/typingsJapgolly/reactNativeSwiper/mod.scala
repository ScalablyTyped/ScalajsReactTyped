package typingsJapgolly.reactNativeSwiper
...
import typingsJapgolly.reactNativeSwiper.anon.X
import typingsJapgolly.reactNativeSwiper.reactNativeSwiperBooleans.`false`
...
object mod {
  ...
  trait SwiperProps extends StObject {
    ...
    var activeDot: js.UndefOr[Node] = js.undefined
    ...
    var indicatorStyle: js.UndefOr[
        typingsJapgolly.reactNativeSwiper.reactNativeSwiperStrings.default | black | white
      ] = js.undefined
    ...
    var loadMinimalLoader: js.UndefOr[Node] = js.undefined
    ...
    var renderPagination: js.UndefOr[js.Function3[/* index */ Double, /* total */ Double, /* swiper */ Swiper, Node]] = js.undefined
  ...
  object SwiperProps {
    ...
    extension [Self <: SwiperProps](x: Self) {
      ...
      inline def setActiveDot(value: VdomNode): Self = StObject.set(x, "activeDot", value.rawNode.asInstanceOf[js.Any])
      ...
      inline def setActiveDotNull: Self = StObject.set(x, "activeDot", null)
      ...
      inline def setActiveDotVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "activeDot", js.Array(value*))
      ...
      inline def setIndicatorStyle(value: typingsJapgolly.reactNativeSwiper.reactNativeSwiperStrings.default | black | white): Self = StObject.set(x, "indicatorStyle", value.asInstanceOf[js.Any])
      ...
      inline def setLoadMinimalLoader(value: VdomNode): Self = StObject.set(x, "loadMinimalLoader", value.rawNode.asInstanceOf[js.Any])
      
      inline def setLoadMinimalLoaderNull: Self = StObject.set(x, "loadMinimalLoader", null)
      
      inline def setLoadMinimalLoaderUndefined: Self = StObject.set(x, "loadMinimalLoader", js.undefined)
      
      inline def setLoadMinimalLoaderVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "loadMinimalLoader", js.Array(value*))
      
      inline def setLoadMinimalLoaderVdomElement(value: VdomElement): Self = StObject.set(x, "loadMinimalLoader", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnIndexChanged(value: /* index */ Double => Callback): Self = StObject.set(x, "onIndexChanged", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
      ...
      ): Self = StObject.set(x, "onMomentumScrollEnd", js.Any.fromFunction3((t0: /* e */ NativeSyntheticEvent[NativeScrollEvent], t1: /* state */ SwiperInternals, t2: /* swiper */ Swiper) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnScrollBeginDrag(
        value: (/* e */ NativeSyntheticEvent[NativeScrollEvent], /* state */ SwiperInternals, /* swiper */ Swiper) => Callback
      ): Self = StObject.set(x, "onScrollBeginDrag", js.Any.fromFunction3((t0: /* e */ NativeSyntheticEvent[NativeScrollEvent], t1: /* state */ SwiperInternals, t2: /* swiper */ Swiper) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setRenderPagination(value: (/* index */ Double, /* total */ Double, /* swiper */ Swiper) => Node): Self = StObject.set(x, "renderPagination", js.Any.fromFunction3(value))
  ...
  object SwiperStates {
    ...
    extension [Self <: SwiperStates](x: Self) {
      ...
      inline def setDir(value: typingsJapgolly.reactNativeSwiper.reactNativeSwiperStrings.x | y): Self = StObject.set(x, "dir", value.asInstanceOf[js.Any])
