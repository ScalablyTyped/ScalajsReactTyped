...
object Cell {
  ...
  inline def apply(col: Double): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMdl.mod.Cell] {
    ...
    inline def hideDesktop(value: Boolean): this.type = set("hideDesktop", value.asInstanceOf[js.Any])
    
    inline def hidePhone(value: Boolean): this.type = set("hidePhone", value.asInstanceOf[js.Any])
    
    inline def hideTablet(value: Boolean): this.type = set("hideTablet", value.asInstanceOf[js.Any])
    ...
    inline def offsetDesktop(value: Double): this.type = set("offsetDesktop", value.asInstanceOf[js.Any])
    
    inline def offsetPhone(value: Double): this.type = set("offsetPhone", value.asInstanceOf[js.Any])
    
    inline def offsetTablet(value: Double): this.type = set("offsetTablet", value.asInstanceOf[js.Any])
    ...
    inline def phone(value: Double): this.type = set("phone", value.asInstanceOf[js.Any])
    ...
    inline def tablet(value: Double): this.type = set("tablet", value.asInstanceOf[js.Any])
