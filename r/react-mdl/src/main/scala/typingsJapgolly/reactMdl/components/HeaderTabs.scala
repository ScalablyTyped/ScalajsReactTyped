...
object HeaderTabs {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMdl.mod.HeaderTabs] {
    ...
    inline def onChange(value: ReactEventFrom[typingsJapgolly.reactMdl.mod.Header & Element] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ReactEventFrom[typingsJapgolly.reactMdl.mod.Header & Element]) => value(t0).runNow()))
  ...
  implicit def make(companion: HeaderTabs.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HeaderTabsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
