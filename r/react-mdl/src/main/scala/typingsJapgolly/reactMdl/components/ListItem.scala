...
object ListItem {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMdl.mod.ListItem] {
    ...
    inline def threeLine(value: Boolean): this.type = set("threeLine", value.asInstanceOf[js.Any])
    
    inline def title(value: String): this.type = set("title", value.asInstanceOf[js.Any])
    
    inline def translate(value: yes | no): this.type = set("translate", value.asInstanceOf[js.Any])
    
    inline def twoLine(value: Boolean): this.type = set("twoLine", value.asInstanceOf[js.Any])
