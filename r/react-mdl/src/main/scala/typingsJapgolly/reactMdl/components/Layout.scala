...
object Layout {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMdl.mod.Layout] {
    ...
    inline def fixedDrawer(value: Boolean): this.type = set("fixedDrawer", value.asInstanceOf[js.Any])
    
    inline def fixedHeader(value: Boolean): this.type = set("fixedHeader", value.asInstanceOf[js.Any])
    
    inline def fixedTabs(value: Boolean): this.type = set("fixedTabs", value.asInstanceOf[js.Any])
