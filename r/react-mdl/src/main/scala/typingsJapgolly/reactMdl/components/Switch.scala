...
object Switch {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMdl.mod.Switch] {
    ...
    inline def onChange(value: ReactEventFrom[typingsJapgolly.reactMdl.mod.Switch & Element] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ReactEventFrom[typingsJapgolly.reactMdl.mod.Switch & Element]) => value(t0).runNow()))
