...
object Dialog {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMdl.mod.Dialog] {
    ...
    inline def onCancel(value: /* e */ Any => Callback): this.type = set("onCancel", js.Any.fromFunction1((t0: /* e */ Any) => value(t0).runNow()))
