...
import typingsJapgolly.reactMdl.mod.TextfieldProps
...
object Textfield {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextfieldProps, typingsJapgolly.reactMdl.mod.Textfield, Unit, TextfieldProps] = {
  ...
  typingsJapgolly.reactMdl.mod.TextfieldProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactMdl.mod.Textfield](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactMdl.mod.TextfieldProps])(children: _*)
  }
