...
object Textfield {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMdl.mod.Textfield] {
    ...
    inline def expandableIcon(value: String): this.type = set("expandableIcon", value.asInstanceOf[js.Any])
