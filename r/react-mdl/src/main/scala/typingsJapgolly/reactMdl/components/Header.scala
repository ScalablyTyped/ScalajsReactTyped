...
object Header {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMdl.mod.Header] {
    ...
    inline def hideSpacer(value: Boolean): this.type = set("hideSpacer", value.asInstanceOf[js.Any])
    
    inline def hideTop(value: Boolean): this.type = set("hideTop", value.asInstanceOf[js.Any])
    ...
    inline def seamed(value: Boolean): this.type = set("seamed", value.asInstanceOf[js.Any])
    ...
    inline def waterfall(value: Boolean): this.type = set("waterfall", value.asInstanceOf[js.Any])
