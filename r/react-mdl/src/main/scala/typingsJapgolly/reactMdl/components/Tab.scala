...
object Tab {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMdl.mod.Tab] {
    ...
    inline def component(value: String | Element | js.Function): this.type = set("component", value.asInstanceOf[js.Any])
    ...
    inline def cssPrefix(value: String): this.type = set("cssPrefix", value.asInstanceOf[js.Any])
    ...
    inline def onTabClick(value: /* tabId */ Double => Any): this.type = set("onTabClick", js.Any.fromFunction1(value))
    ...
    inline def tabId(value: Double): this.type = set("tabId", value.asInstanceOf[js.Any])
