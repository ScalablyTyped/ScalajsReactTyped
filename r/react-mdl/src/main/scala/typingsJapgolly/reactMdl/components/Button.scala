...
object Button {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMdl.mod.Button] {
    ...
    inline def colored(value: Boolean): this.type = set("colored", value.asInstanceOf[js.Any])
  ...
  def withProps(p: StandardButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
