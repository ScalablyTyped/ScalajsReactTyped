...
object Chip {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMdl.mod.Chip] {
    ...
    inline def onClick(value: ReactMouseEventFrom[typingsJapgolly.reactMdl.mod.Chip & Element] => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[typingsJapgolly.reactMdl.mod.Chip & Element]) => value(t0).runNow()))
    
    inline def onClose(value: ReactMouseEventFrom[typingsJapgolly.reactMdl.mod.Chip & Element] => Callback): this.type = set("onClose", js.Any.fromFunction1((t0: ReactMouseEventFrom[typingsJapgolly.reactMdl.mod.Chip & Element]) => value(t0).runNow()))
