...
object Spacer {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMdl.mod.Spacer] {
  ...
  implicit def make(companion: Spacer.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HTMLProps[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
