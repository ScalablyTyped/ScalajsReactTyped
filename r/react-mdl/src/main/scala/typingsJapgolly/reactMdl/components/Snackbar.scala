...
object Snackbar {
  ...
  inline def apply(active: Boolean, onTimeout: CallbackTo[Any]): Builder = {
    val __props = js.Dynamic.literal(active = active.asInstanceOf[js.Any], onTimeout = onTimeout.toJsFn)
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactMdl.mod.Snackbar] {
    ...
    inline def onActionClick(value: ReactMouseEventFrom[typingsJapgolly.reactMdl.mod.Snackbar & Element] => Callback): this.type = set("onActionClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[typingsJapgolly.reactMdl.mod.Snackbar & Element]) => value(t0).runNow()))
