...
object mod {
  ...
  @js.native
  open class MorphReplace protected ()
    extends Component[MorphReplaceProps, js.Object, Any] {
    def this(props: MorphReplaceProps) = this()
    def this(props: MorphReplaceProps, context: Any) = this()
  }
  @JSImport("react-svg-morph", "MorphReplace")
  @js.native
  val MorphReplace: ComponentClassP[MorphReplaceProps & js.Object] = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("react-svg-morph", "MorphReplaceResize")
  @js.native
  open class MorphReplaceResize protected ()
    extends Component[MorphReplaceProps, js.Object, Any] {
    def this(props: MorphReplaceProps) = this()
    def this(props: MorphReplaceProps, context: Any) = this()
  }
  @JSImport("react-svg-morph", "MorphReplaceResize")
  @js.native
  val MorphReplaceResize: ComponentClassP[MorphReplaceProps & js.Object] = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("react-svg-morph", "MorphTransition")
  @js.native
  open class MorphTransition protected ()
    extends Component[MorphTransitionProps, js.Object, Any] {
    def this(props: MorphTransitionProps) = this()
    def this(props: MorphTransitionProps, context: Any) = this()
  }
  @JSImport("react-svg-morph", "MorphTransition")
  @js.native
  val MorphTransition: ComponentClassP[MorphTransitionProps & js.Object] = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("react-svg-morph", "MorphTransitionResize")
  @js.native
  open class MorphTransitionResize protected ()
    extends Component[MorphTransitionProps, js.Object, Any] {
    def this(props: MorphTransitionProps) = this()
    def this(props: MorphTransitionProps, context: Any) = this()
  }
  @JSImport("react-svg-morph", "MorphTransitionResize")
  @js.native
  val MorphTransitionResize: ComponentClassP[MorphTransitionProps & js.Object] = js.native
  ...
  object MorphReplaceProps {
    ...
    inline def apply(children: VdomElement): MorphReplaceProps = {
