...
object TriggerableView {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeAdManager.mod.TriggerableView] {
  ...
  implicit def make(companion: TriggerableView.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
