...
import typingsJapgolly.reactNativeAdManager.helperTypesMod.AdLoadedEvent
...
@scala.inline
open class SharedBuilder_BannerProps285303575[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  ): this.type = set("adSize", value.asInstanceOf[js.Any])
  
  inline def adUnitID(value: String): this.type = set("adUnitID", value.asInstanceOf[js.Any])
  ...
  inline def onAdClosed(value: Callback): this.type = set("onAdClosed", value.toJsFn)
  
  inline def onAdFailedToLoad(value: /* error */ Any => Callback): this.type = set("onAdFailedToLoad", js.Any.fromFunction1((t0: /* error */ Any) => value(t0).runNow()))
  
  inline def onAdLeftApplication(value: Callback): this.type = set("onAdLeftApplication", value.toJsFn)
  
  inline def onAdLoaded(value: /* event */ AdLoadedEvent => Callback): this.type = set("onAdLoaded", js.Any.fromFunction1((t0: /* event */ AdLoadedEvent) => value(t0).runNow()))
  
  inline def onAdOpened(value: Callback): this.type = set("onAdOpened", value.toJsFn)
  
  inline def onAppEvent(value: /* event */ Info => Callback): this.type = set("onAppEvent", js.Any.fromFunction1((t0: /* event */ Info) => value(t0).runNow()))
  ...
  inline def onSizeChange(value: /* event */ Height => Callback): this.type = set("onSizeChange", js.Any.fromFunction1((t0: /* event */ Height) => value(t0).runNow()))
  ...
  inline def targeting(value: Targeting): this.type = set("targeting", value.asInstanceOf[js.Any])
  
  inline def testDevices(value: js.Array[String]): this.type = set("testDevices", value.asInstanceOf[js.Any])
  
  inline def testDevicesVarargs(value: String*): this.type = set("testDevices", js.Array(value*))
  ...
  inline def validAdSizes(value: js.Array[String]): this.type = set("validAdSizes", value.asInstanceOf[js.Any])
  
  inline def validAdSizesVarargs(value: String*): this.type = set("validAdSizes", js.Array(value*))
}
