...
object esListMod {
  ...
  inline def RawList[T](props: ListProps[T], ref: typingsJapgolly.react.mod.Ref[ListRef]): typingsJapgolly.react.mod.global.JSX.Element = (^.asInstanceOf[js.Dynamic].applyDynamic("RawList")(props.asInstanceOf[js.Any], ref.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.react.mod.global.JSX.Element]
  ...
  trait ListProps[T] extends StObject {
    ...
    var component: js.UndefOr[String | FC[Any] | (ComponentClassP[Any & js.Object])] = js.undefined
    ...
    var onVisibleChange: js.UndefOr[js.Function2[/* visibleList */ js.Array[T], /* fullList */ js.Array[T], Unit]] = js.undefined
  ...
  object ListProps {
    ...
    inline def apply[T](
      children: (T, /* index */ Double, /* props */ Style) => Node,
      data: js.Array[T],
    ...
    extension [Self <: ListProps[?], T](x: Self & ListProps[T]) {
      ...
      inline def setChildren(value: (T, /* index */ Double, /* props */ Style) => Node): Self = StObject.set(x, "children", js.Any.fromFunction3(value))
      ...
      inline def setComponent(value: String | FC[Any] | (ComponentClassP[Any & js.Object])): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      inline def setOnVisibleChange(value: (/* visibleList */ js.Array[T], /* fullList */ js.Array[T]) => Callback): Self = StObject.set(x, "onVisibleChange", js.Any.fromFunction2((t0: /* visibleList */ js.Array[T], t1: /* fullList */ js.Array[T]) => (value(t0, t1)).runNow()))
  ...
  object ListRef {
    ...
    inline def apply(scrollTo: /* arg */ Double | ScrollConfig => Callback): ListRef = {
      val __obj = js.Dynamic.literal(scrollTo = js.Any.fromFunction1((t0: /* arg */ Double | ScrollConfig) => scrollTo(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rcVirtualList.rcVirtualListStrings.top
    - typingsJapgolly.rcVirtualList.rcVirtualListStrings.bottom
    - typingsJapgolly.rcVirtualList.rcVirtualListStrings.auto
  */
  trait ScrollAlign extends StObject
  object ScrollAlign {
    
    inline def auto: typingsJapgolly.rcVirtualList.rcVirtualListStrings.auto = "auto".asInstanceOf[typingsJapgolly.rcVirtualList.rcVirtualListStrings.auto]
    
    inline def bottom: typingsJapgolly.rcVirtualList.rcVirtualListStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.rcVirtualList.rcVirtualListStrings.bottom]
    
    inline def top: typingsJapgolly.rcVirtualList.rcVirtualListStrings.top = "top".asInstanceOf[typingsJapgolly.rcVirtualList.rcVirtualListStrings.top]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rcVirtualList.anon.Align
    - typingsJapgolly.rcVirtualList.anon.Key
  */
  trait ScrollConfig extends StObject
  object ScrollConfig {
    
    inline def Align(index: Double): typingsJapgolly.rcVirtualList.anon.Align = {
      val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.rcVirtualList.anon.Align]
    }
    
    inline def Key(key: typingsJapgolly.react.mod.Key): typingsJapgolly.rcVirtualList.anon.Key = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.rcVirtualList.anon.Key]
    }
  }
