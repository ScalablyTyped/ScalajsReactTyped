...
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.`additions removals`
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.`additions text`
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.`inline`
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.`removals additions`
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.`removals text`
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.`text additions`
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.`text removals`
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.additions
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.all
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.ascending
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.assertive
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.both
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.copy
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.date
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.decimal
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.descending
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.dialog
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.email
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.execute
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.grammar
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.grid
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.horizontal
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.inherit
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.link
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.list
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.listbox
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.location
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.menu
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.mixed
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.move
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.no
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.none
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.numeric
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.off
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.on
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.other
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.page
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.polite
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.popup
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.removals
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.search
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.spelling
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.step
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.tel
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.text
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.time
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.tree
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.url
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.vertical
import typingsJapgolly.rcVirtualList.rcVirtualListStrings.yes
...
object RcVirtualList {
  ...
  inline def apply[Item](
    children: (Item, /* index */ Double, /* props */ Style) => Node,
    data: js.Array[Item],
    ...
    new Builder[Item](js.Array(this.component, __props.asInstanceOf[ListProps[Item] & Ref]))
  }
  ...
  open class Builder[Item] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[ListRef] {
    ...
    inline def component(value: String | FC[Any] | (ComponentClassP[Any & js.Object])): this.type = set("component", value.asInstanceOf[js.Any])
    ...
    inline def fullHeight(value: Boolean): this.type = set("fullHeight", value.asInstanceOf[js.Any])
    ...
    inline def onVisibleChange(value: (/* visibleList */ js.Array[Item], /* fullList */ js.Array[Item]) => Callback): this.type = set("onVisibleChange", js.Any.fromFunction2((t0: /* visibleList */ js.Array[Item], t1: /* fullList */ js.Array[Item]) => (value(t0, t1)).runNow()))
  ...
  def withProps[Item](p: ListProps[Item] & Ref): Builder[Item] = new Builder[Item](js.Array(this.component, p.asInstanceOf[js.Any]))
}
