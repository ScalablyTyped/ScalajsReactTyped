...
object RawList {
  ...
  open class Builder[T] (val args: js.Array[Any])
    ...
    inline def onVisibleChange(value: (/* visibleList */ js.Array[T], /* fullList */ js.Array[T]) => Callback): this.type = set("onVisibleChange", js.Any.fromFunction2((t0: /* visibleList */ js.Array[T], t1: /* fullList */ js.Array[T]) => (value(t0, t1)).runNow()))
