package typingsJapgolly.requestPromise.mod
...
object RequestPromiseOptions {
  ...
  def apply(
    ...
    transform: (/* body */ js.Any, /* response */ Response, /* resolveWithFullResponse */ js.UndefOr[Boolean]) => CallbackTo[js.Any] = null,
    ...
    if (transform != null) __obj.updateDynamic("transform")(js.Any.fromFunction3((t0: /* body */ js.Any, t1: /* response */ typingsJapgolly.request.mod.Response, t2: /* resolveWithFullResponse */ js.UndefOr[scala.Boolean]) => transform(t0, t1, t2).runNow()))
