...
object errorsMod {
  ...
  trait RequestError
    ...
    @JSName("name")
    var name_RequestError: typingsJapgolly.requestPromise.requestPromiseStrings.RequestError
  ...
  object RequestError {
    ...
    extension [Self <: RequestError](x: Self) {
      ...
      inline def setName(value: typingsJapgolly.requestPromise.requestPromiseStrings.RequestError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
  ...
  open class RequestErrorCls protected ()
    ...
    /* CompleteClass */
    @JSName("name")
    var name_RequestError: typingsJapgolly.requestPromise.requestPromiseStrings.RequestError = js.native
  ...
  trait StatusCodeError
    ...
    @JSName("name")
    var name_StatusCodeError: typingsJapgolly.requestPromise.requestPromiseStrings.StatusCodeError
  ...
  object StatusCodeError {
    ...
    extension [Self <: StatusCodeError](x: Self) {
      ...
      inline def setName(value: typingsJapgolly.requestPromise.requestPromiseStrings.StatusCodeError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
  ...
  open class StatusCodeErrorCls protected ()
    ...
    /* CompleteClass */
    @JSName("name")
    var name_StatusCodeError: typingsJapgolly.requestPromise.requestPromiseStrings.StatusCodeError = js.native
  ...
  trait TransformError
    ...
    @JSName("name")
    var name_TransformError: typingsJapgolly.requestPromise.requestPromiseStrings.TransformError
  ...
  object TransformError {
    ...
    extension [Self <: TransformError](x: Self) {
      ...
      inline def setName(value: typingsJapgolly.requestPromise.requestPromiseStrings.TransformError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
  ...
  open class TransformErrorCls protected ()
    ...
    /* CompleteClass */
    @JSName("name")
    var name_TransformError: typingsJapgolly.requestPromise.requestPromiseStrings.TransformError = js.native
