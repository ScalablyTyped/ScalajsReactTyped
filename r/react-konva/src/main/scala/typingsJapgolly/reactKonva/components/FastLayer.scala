...
object FastLayer {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.FastLayer & js.Object] {
  ...
  def withProps(
    p: typingsJapgolly.konva.mod.Konva.LayerConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.FastLayer]
