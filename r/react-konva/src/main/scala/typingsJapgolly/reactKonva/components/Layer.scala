...
object Layer {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.Layer & js.Object] {
    ...
    inline def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[LayerConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
    ...
    inline def hitGraphEnabled(value: Boolean): this.type = set("hitGraphEnabled", value.asInstanceOf[js.Any])
    
    inline def id(value: String): this.type = set("id", value.asInstanceOf[js.Any])
    
    inline def imageSmoothingEnabled(value: Boolean): this.type = set("imageSmoothingEnabled", value.asInstanceOf[js.Any])
  ...
  def withProps(
    p: typingsJapgolly.konva.mod.Konva.LayerConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Layer]
