...
import typingsJapgolly.konva.libShapesRectMod.RectConfig
...
object Rect {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.Rect & js.Object] {
    
    inline def cornerRadius(value: Double | js.Array[Double]): this.type = set("cornerRadius", value.asInstanceOf[js.Any])
    
    inline def cornerRadiusVarargs(value: Double*): this.type = set("cornerRadius", js.Array(value*))
    ...
    inline def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[RectConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
    ...
    inline def hitFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[RectConfig]) => Callback
    ): this.type = set("hitFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[RectConfig]) => (value(t0, t1)).runNow()))
    ...
    inline def sceneFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[RectConfig]) => Callback
    ): this.type = set("sceneFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[RectConfig]) => (value(t0, t1)).runNow()))
  ...
  def withProps(
    p: typingsJapgolly.konva.mod.Konva.RectConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Rect]
