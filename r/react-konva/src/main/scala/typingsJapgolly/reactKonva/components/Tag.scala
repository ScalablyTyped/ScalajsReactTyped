...
import typingsJapgolly.konva.libShapesLabelMod.TagConfig
...
object Tag {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.Tag & js.Object] {
    ...
    inline def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[TagConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
    ...
    inline def hitFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[TagConfig]) => Callback
    ): this.type = set("hitFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[TagConfig]) => (value(t0, t1)).runNow()))
    ...
    inline def pointerDirection(value: String): this.type = set("pointerDirection", value.asInstanceOf[js.Any])
    
    inline def pointerHeight(value: Double): this.type = set("pointerHeight", value.asInstanceOf[js.Any])
    ...
    inline def sceneFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[TagConfig]) => Callback
    ): this.type = set("sceneFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[TagConfig]) => (value(t0, t1)).runNow()))
  ...
  def withProps(
    p: typingsJapgolly.konva.mod.Konva.TagConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Tag]
