...
object Ellipse {
  ...
  inline def apply(radiusX: Double, radiusY: Double): Builder = {
    val __props = js.Dynamic.literal(radiusX = radiusX.asInstanceOf[js.Any], radiusY = radiusY.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[EllipseConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Ellipse]]))
  }
  
  @JSImport("react-konva", "Ellipse")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.Ellipse & js.Object] {
    ...
    inline def dragBoundFunc(
      value: js.ThisFunction1[
          /* this */ Node[typingsJapgolly.konva.libShapesEllipseMod.EllipseConfig], 
          /* pos */ Vector2d, 
          Vector2d
        ]
    ...
    inline def hitFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesEllipseMod.EllipseConfig]) => Callback
    ): this.type = set("hitFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesEllipseMod.EllipseConfig]) => (value(t0, t1)).runNow()))
    ...
    inline def sceneFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesEllipseMod.EllipseConfig]) => Callback
    ): this.type = set("sceneFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesEllipseMod.EllipseConfig]) => (value(t0, t1)).runNow()))
  ...
  def withProps(p: EllipseConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Ellipse]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
