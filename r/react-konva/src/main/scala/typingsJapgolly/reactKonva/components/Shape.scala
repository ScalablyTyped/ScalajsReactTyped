...
object Shape {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.Shape & js.Object] {
    ...
    inline def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[ShapeConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
    ...
    inline def hitFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[ShapeConfig]) => Callback
    ): this.type = set("hitFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[ShapeConfig]) => (value(t0, t1)).runNow()))
    ...
    inline def sceneFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[ShapeConfig]) => Callback
    ): this.type = set("sceneFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[ShapeConfig]) => (value(t0, t1)).runNow()))
  ...
  implicit def make(companion: Shape.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(
    p: typingsJapgolly.konva.mod.Konva.ShapeConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Shape]
