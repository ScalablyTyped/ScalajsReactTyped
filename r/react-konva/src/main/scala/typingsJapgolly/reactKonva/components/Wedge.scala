...
object Wedge {
  ...
  inline def apply(angle: Double, radius: Double): Builder = {
    val __props = js.Dynamic.literal(angle = angle.asInstanceOf[js.Any], radius = radius.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[WedgeConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Wedge]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.Wedge & js.Object] {
    ...
    inline def dragBoundFunc(
      value: js.ThisFunction1[
          /* this */ Node[typingsJapgolly.konva.libShapesWedgeMod.WedgeConfig], 
          /* pos */ Vector2d, 
          Vector2d
        ]
    ...
    inline def hitFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesWedgeMod.WedgeConfig]) => Callback
    ): this.type = set("hitFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesWedgeMod.WedgeConfig]) => (value(t0, t1)).runNow()))
    ...
    inline def sceneFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesWedgeMod.WedgeConfig]) => Callback
    ): this.type = set("sceneFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesWedgeMod.WedgeConfig]) => (value(t0, t1)).runNow()))
  ...
  def withProps(p: WedgeConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Wedge]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
