...
object Ring {
  ...
  inline def apply(innerRadius: Double, outerRadius: Double): Builder = {
    val __props = js.Dynamic.literal(innerRadius = innerRadius.asInstanceOf[js.Any], outerRadius = outerRadius.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[RingConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Ring]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.Ring & js.Object] {
    ...
    inline def dragBoundFunc(
      value: js.ThisFunction1[
          /* this */ Node[typingsJapgolly.konva.libShapesRingMod.RingConfig], 
          /* pos */ Vector2d, 
          Vector2d
        ]
    ...
    inline def hitFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesRingMod.RingConfig]) => Callback
    ): this.type = set("hitFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesRingMod.RingConfig]) => (value(t0, t1)).runNow()))
    ...
    inline def sceneFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesRingMod.RingConfig]) => Callback
    ): this.type = set("sceneFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesRingMod.RingConfig]) => (value(t0, t1)).runNow()))
  ...
  def withProps(p: RingConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Ring]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
