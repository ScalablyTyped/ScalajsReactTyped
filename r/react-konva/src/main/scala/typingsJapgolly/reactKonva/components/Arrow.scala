...
object Arrow {
  ...
  inline def apply(points: js.Array[Double]): Builder = {
    val __props = js.Dynamic.literal(points = points.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[ArrowConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Arrow]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.Arrow & js.Object] {
    
    inline def bezier(value: Boolean): this.type = set("bezier", value.asInstanceOf[js.Any])
    ...
    inline def dragBoundFunc(
      value: js.ThisFunction1[
          /* this */ Node[typingsJapgolly.konva.libShapesArrowMod.ArrowConfig], 
          /* pos */ Vector2d, 
          Vector2d
        ]
    ...
    inline def hitFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesArrowMod.ArrowConfig]) => Callback
    ): this.type = set("hitFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesArrowMod.ArrowConfig]) => (value(t0, t1)).runNow()))
    ...
    inline def pointerAtBeginning(value: Boolean): this.type = set("pointerAtBeginning", value.asInstanceOf[js.Any])
    
    inline def pointerAtEnding(value: Boolean): this.type = set("pointerAtEnding", value.asInstanceOf[js.Any])
    ...
    inline def sceneFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesArrowMod.ArrowConfig]) => Callback
    ): this.type = set("sceneFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesArrowMod.ArrowConfig]) => (value(t0, t1)).runNow()))
    ...
    inline def tension(value: Double): this.type = set("tension", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ArrowConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Arrow]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
