...
object Image {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.Image & js.Object] {
    
    inline def crop(value: IRect): this.type = set("crop", value.asInstanceOf[js.Any])
    ...
    inline def dragBoundFunc(value: js.ThisFunction1[/* this */ Node[ImageConfig], /* pos */ Vector2d, Vector2d]): this.type = set("dragBoundFunc", value.asInstanceOf[js.Any])
    ...
    inline def hitFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[ImageConfig]) => Callback
    ): this.type = set("hitFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[ImageConfig]) => (value(t0, t1)).runNow()))
    
    inline def hitStrokeWidth(value: Double | String): this.type = set("hitStrokeWidth", value.asInstanceOf[js.Any])
    
    inline def id(value: String): this.type = set("id", value.asInstanceOf[js.Any])
    
    inline def image(value: CanvasImageSource): this.type = set("image", value.asInstanceOf[js.Any])
    ...
    inline def sceneFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[ImageConfig]) => Callback
    ): this.type = set("sceneFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[ImageConfig]) => (value(t0, t1)).runNow()))
  ...
  def withProps(
    p: typingsJapgolly.konva.mod.Konva.ImageConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Image]
