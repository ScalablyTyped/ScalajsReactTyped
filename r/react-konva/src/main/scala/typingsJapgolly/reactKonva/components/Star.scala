...
object Star {
  ...
  inline def apply(innerRadius: Double, numPoints: Double, outerRadius: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[StarConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Star]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.Star & js.Object] {
    ...
    inline def dragBoundFunc(
      value: js.ThisFunction1[
          /* this */ Node[typingsJapgolly.konva.libShapesStarMod.StarConfig], 
          /* pos */ Vector2d, 
          Vector2d
        ]
    ...
    inline def hitFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesStarMod.StarConfig]) => Callback
    ): this.type = set("hitFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesStarMod.StarConfig]) => (value(t0, t1)).runNow()))
    ...
    inline def sceneFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesStarMod.StarConfig]) => Callback
    ): this.type = set("sceneFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesStarMod.StarConfig]) => (value(t0, t1)).runNow()))
  ...
  def withProps(p: StarConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Star]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
