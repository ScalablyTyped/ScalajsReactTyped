...
object Sprite {
  ...
  inline def apply(animation: String, animations: Any, image: HTMLImageElement): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[SpriteConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Sprite]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.Sprite & js.Object] {
    ...
    inline def dragBoundFunc(
      value: js.ThisFunction1[
          /* this */ Node[typingsJapgolly.konva.libShapesSpriteMod.SpriteConfig], 
          /* pos */ Vector2d, 
          Vector2d
        ]
    ...
    inline def frameIndex(value: Double): this.type = set("frameIndex", value.asInstanceOf[js.Any])
    
    inline def frameRate(value: Double): this.type = set("frameRate", value.asInstanceOf[js.Any])
    ...
    inline def hitFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesSpriteMod.SpriteConfig]) => Callback
    ): this.type = set("hitFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesSpriteMod.SpriteConfig]) => (value(t0, t1)).runNow()))
    ...
    inline def sceneFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesSpriteMod.SpriteConfig]) => Callback
    ): this.type = set("sceneFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesSpriteMod.SpriteConfig]) => (value(t0, t1)).runNow()))
  ...
  def withProps(p: SpriteConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Sprite]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
