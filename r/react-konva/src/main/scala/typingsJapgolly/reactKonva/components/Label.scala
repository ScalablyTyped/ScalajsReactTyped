...
object Label {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.Label & js.Object] {
  ...
  def withProps(p: LabelConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.Label]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
