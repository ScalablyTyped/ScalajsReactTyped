...
object RegularPolygon {
  ...
  inline def apply(radius: Double, sides: Double): Builder = {
    val __props = js.Dynamic.literal(radius = radius.asInstanceOf[js.Any], sides = sides.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[RegularPolygonConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.RegularPolygon]]))
  }
  
  @JSImport("react-konva", "RegularPolygon")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.konva.mod.Konva.RegularPolygon & js.Object] {
    ...
    inline def dragBoundFunc(
      value: js.ThisFunction1[
          /* this */ Node[typingsJapgolly.konva.libShapesRegularPolygonMod.RegularPolygonConfig], 
          /* pos */ Vector2d, 
          Vector2d
        ]
    ...
    inline def hitFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesRegularPolygonMod.RegularPolygonConfig]) => Callback
    ): this.type = set("hitFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesRegularPolygonMod.RegularPolygonConfig]) => (value(t0, t1)).runNow()))
    ...
    inline def sceneFunc(
      value: (/* con */ Context, /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesRegularPolygonMod.RegularPolygonConfig]) => Callback
    ): this.type = set("sceneFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ typingsJapgolly.konva.libShapeMod.Shape[typingsJapgolly.konva.libShapesRegularPolygonMod.RegularPolygonConfig]) => (value(t0, t1)).runNow()))
  ...
  def withProps(
    p: RegularPolygonConfig & KonvaNodeEvents & ClassAttributes[typingsJapgolly.konva.mod.Konva.RegularPolygon]
