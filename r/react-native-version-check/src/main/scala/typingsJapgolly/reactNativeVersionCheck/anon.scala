...
object anon {
  ...
  object CurrentVersion {
    ...
    extension [Self <: CurrentVersion](x: Self) {
      ...
      inline def setProviderCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "provider", value.toJsFn)
  ...
  object FetchOptions {
    ...
    extension [Self <: FetchOptions](x: Self) {
      ...
      inline def setPackageNameCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "packageName", value.toJsFn)
