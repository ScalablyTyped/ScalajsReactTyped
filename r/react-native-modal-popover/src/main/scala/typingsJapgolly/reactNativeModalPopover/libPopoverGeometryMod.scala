...
object libPopoverGeometryMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.top
    - typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.end
    - typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.bottom
    - typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.start
  */
  trait Placement extends StObject
  object Placement {
    
    inline def bottom: typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.bottom]
    
    inline def end: typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.end = "end".asInstanceOf[typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.end]
    
    inline def start: typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.start = "start".asInstanceOf[typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.start]
    
    inline def top: typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.top = "top".asInstanceOf[typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.top]
  }
