...
import typingsJapgolly.reactNativeModalPopover.libPopoverGeometryMod.Geometry
import typingsJapgolly.reactNativeModalPopover.libPopoverGeometryMod.Placement
import typingsJapgolly.reactNativeModalPopover.libPopoverGeometryMod.Point
...
object libPopoverMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.portrait
    - typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.`portrait-upside-down`
    - typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.landscape
    - typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.`landscape-left`
    - typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.`landscape-right`
  */
  trait Orientation extends StObject
  object Orientation {
    
    inline def landscape: typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.landscape = "landscape".asInstanceOf[typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.landscape]
    
    inline def `landscape-left`: typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.`landscape-left` = "landscape-left".asInstanceOf[typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.`landscape-left`]
    
    inline def `landscape-right`: typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.`landscape-right` = "landscape-right".asInstanceOf[typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.`landscape-right`]
    
    inline def portrait: typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.portrait = "portrait".asInstanceOf[typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.portrait]
    
    inline def `portrait-upside-down`: typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.`portrait-upside-down` = "portrait-upside-down".asInstanceOf[typingsJapgolly.reactNativeModalPopover.reactNativeModalPopoverStrings.`portrait-upside-down`]
  }
