...
class TestSchedulerCls ()
  extends typingsJapgolly.rxLiteTesting.Rx.TestScheduler {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def createColdObservable[T](records: typingsJapgolly.rxLiteTesting.Rx.Recorded*): Observable[T] = js.native
  /* CompleteClass */
  override def createHotObservable[T](records: typingsJapgolly.rxLiteTesting.Rx.Recorded*): Observable[T] = js.native
  /* CompleteClass */
  override def createObserver[T](): typingsJapgolly.rxLiteTesting.Rx.MockObserver[T] = js.native
  ...
  /* CompleteClass */
  override def startWithCreate[T](create: js.Function0[Observable[T]]): typingsJapgolly.rxLiteTesting.Rx.MockObserver[T] = js.native
  /* CompleteClass */
  override def startWithDispose[T](create: js.Function0[Observable[T]], disposedAt: Double): typingsJapgolly.rxLiteTesting.Rx.MockObserver[T] = js.native
  /* CompleteClass */
  override def startWithTiming[T](create: js.Function0[Observable[T]], createdAt: Double, subscribedAt: Double, disposedAt: Double): typingsJapgolly.rxLiteTesting.Rx.MockObserver[T] = js.native
  /* CompleteClass */
