...
import typingsJapgolly.reactMdTypography.typesTextContainerMod.TextContainerRenderFunction
...
object TextContainer {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[(HTMLDivElement | ElementType) & js.Object] {
    ...
    inline def children(value: Node | ClassNameCloneableChild[js.Object] | TextContainerRenderFunction): this.type = set("children", value.asInstanceOf[js.Any])
    ...
    inline def size(value: TextContainerSize): this.type = set("size", value.asInstanceOf[js.Any])
  ...
  def withProps(p: TextContainerProps & (RefAttributes[HTMLDivElement | ElementType])): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
