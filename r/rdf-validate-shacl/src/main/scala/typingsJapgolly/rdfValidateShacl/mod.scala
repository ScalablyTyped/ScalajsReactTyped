...
object mod {
  ...
  open class ^[F /* <: Factory[Quad, Quad, DatasetCore[Quad, Quad]] */] protected ()
    ...
    /* CompleteClass */
    override def validate(data: DatasetCore[Quad, Quad]): typingsJapgolly.rdfValidateShacl.srcValidationReportMod.^[F] = js.native
  }
  ...
  trait SHACLValidator[F /* <: Factory[Quad, Quad, DatasetCore[Quad, Quad]] */] extends StObject {
    ...
    def validate(data: DatasetCore[Quad, Quad]): typingsJapgolly.rdfValidateShacl.srcValidationReportMod.^[F]
  }
  object SHACLValidator {
    ...
    inline def apply[F /* <: Factory[Quad, Quad, DatasetCore[Quad, Quad]] */](
      ...
      validate: DatasetCore[Quad, Quad] => typingsJapgolly.rdfValidateShacl.srcValidationReportMod.^[F]
    ): SHACLValidator[F] = {
    ...
    extension [Self <: SHACLValidator[?], F /* <: Factory[Quad, Quad, DatasetCore[Quad, Quad]] */](x: Self & SHACLValidator[F]) {
      ...
      inline def setValidate(value: DatasetCore[Quad, Quad] => typingsJapgolly.rdfValidateShacl.srcValidationReportMod.^[F]): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
    }
  }
}
