...
object anon {
  ...
  object Load {
    ...
    inline def apply(_validParam_ : Boolean, load: js.Function0[Unit] => Callback, version: String): Load = {
      val __obj = js.Dynamic.literal(_validParam_ = _validParam_.asInstanceOf[js.Any], load = js.Any.fromFunction1((t0: js.Function0[Unit]) => load(t0).runNow()), version = version.asInstanceOf[js.Any])
