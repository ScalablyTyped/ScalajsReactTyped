...
object libLoadPostcodeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactDaumPostcode.reactDaumPostcodeStrings.FORCE_CLOSE
    - typingsJapgolly.reactDaumPostcode.reactDaumPostcodeStrings.COMPLETE_CLOSE
  */
  trait State extends StObject
  object State {
    
    inline def COMPLETE_CLOSE: typingsJapgolly.reactDaumPostcode.reactDaumPostcodeStrings.COMPLETE_CLOSE = "COMPLETE_CLOSE".asInstanceOf[typingsJapgolly.reactDaumPostcode.reactDaumPostcodeStrings.COMPLETE_CLOSE]
    
    inline def FORCE_CLOSE: typingsJapgolly.reactDaumPostcode.reactDaumPostcodeStrings.FORCE_CLOSE = "FORCE_CLOSE".asInstanceOf[typingsJapgolly.reactDaumPostcode.reactDaumPostcodeStrings.FORCE_CLOSE]
  }
  ...
  object global {
    ...
    trait Window extends StObject {
      ...
      var daum: js.UndefOr[typingsJapgolly.reactDaumPostcode.anon.Postcode] = js.undefined
    }
    object Window {
      ...
      extension [Self <: Window](x: Self) {
        ...
        inline def setDaum(value: typingsJapgolly.reactDaumPostcode.anon.Postcode): Self = StObject.set(x, "daum", value.asInstanceOf[js.Any])
