...
import typingsJapgolly.reactDaumPostcode.libUseDaumPostcodePopupMod.DaumPostcodePopupParams
...
object mod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.reactDaumPostcode.libDaumPostcodeEmbedMod.default
  object default {
