...
import typingsJapgolly.rcDrawer.drawerChildMod.default
import typingsJapgolly.rcDrawer.idrawerproptypesMod.IDrawerChildProps
import typingsJapgolly.rcDrawer.idrawerproptypesMod.ILevelMove
import typingsJapgolly.rcDrawer.idrawerproptypesMod.IPlacement
...
object DrawerChild {
  def apply(
    ...
    getOpenCount: js.UndefOr[CallbackTo[Double]] = js.undefined,
    ...
    switchScrollingEffect: /* close */ js.UndefOr[Boolean] => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IDrawerChildProps, default, Unit, IDrawerChildProps] = {
    ...
    getOpenCount.foreach(p => __obj.updateDynamic("getOpenCount")(p.toJsFn))
    ...
    if (switchScrollingEffect != null) __obj.updateDynamic("switchScrollingEffect")(js.Any.fromFunction1((t0: /* close */ js.UndefOr[scala.Boolean]) => switchScrollingEffect(t0).runNow()))
  ...
  typingsJapgolly.rcDrawer.idrawerproptypesMod.IDrawerChildProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.rcDrawer.drawerChildMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rcDrawer.idrawerproptypesMod.IDrawerChildProps])(children: _*)
  }
