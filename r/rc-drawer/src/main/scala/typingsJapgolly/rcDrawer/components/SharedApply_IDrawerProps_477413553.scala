...
import typingsJapgolly.rcDrawer.idrawerproptypesMod.IStringOrHtmlElement
...
abstract class SharedApply_IDrawerProps_477413553[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IDrawerProps, ComponentRef, Unit, IDrawerProps] = {
  ...
  typingsJapgolly.rcDrawer.idrawerproptypesMod.IDrawerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.rcDrawer.idrawerproptypesMod.IDrawerProps])(children: _*)
  }
}
