...
object Modal {
  ...
  inline def apply(
    ...
    val __props = js.Dynamic.literal(animationType = animationType.asInstanceOf[js.Any], blurOnUnmount = blurOnUnmount.asInstanceOf[js.Any], onRequestClose = onRequestClose.toJsFn, transparent = transparent.asInstanceOf[js.Any], visible = visible.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[RNNModalProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeNavigation.mod.Modal] {
    ...
    inline def accessibilityLiveRegion(value: typingsJapgolly.reactNative.reactNativeStrings.none | polite | assertive): this.type = set("accessibilityLiveRegion", value.asInstanceOf[js.Any])
    ...
    inline def onShow(value: CallbackTo[Any]): this.type = set("onShow", value.toJsFn)
    ...
    inline def pointerEvents(value: `box-none` | typingsJapgolly.reactNative.reactNativeStrings.none | `box-only` | auto): this.type = set("pointerEvents", value.asInstanceOf[js.Any])
  ...
  def withProps(p: RNNModalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
