...
import typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.bezel
import typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.entireScreen
