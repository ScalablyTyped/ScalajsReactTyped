...
object libDistSrcInterfacesComponentEventsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.Component
    - typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.TopBarTitle
    - typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.TopBarBackground
    - typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.TopBarButton
  */
  trait ComponentType extends StObject
  object ComponentType {
    
    inline def Component: typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.Component = "Component".asInstanceOf[typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.Component]
    
    inline def TopBarBackground: typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.TopBarBackground = "TopBarBackground".asInstanceOf[typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.TopBarBackground]
    
    inline def TopBarButton: typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.TopBarButton = "TopBarButton".asInstanceOf[typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.TopBarButton]
    
    inline def TopBarTitle: typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.TopBarTitle = "TopBarTitle".asInstanceOf[typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.TopBarTitle]
  }
