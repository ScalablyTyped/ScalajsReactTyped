...
import typingsJapgolly.reactNativeNavigation.libDistSrcComponentsComponentWrapperMod.IWrappedComponent
...
object libDistSrcComponentsStoreMod {
  ...
  open class Store () extends StObject {
    ...
    def getWrappedComponent(componentName: String): ComponentClassP[Any & js.Object] = js.native
    def getWrappedComponent(componentName: Double): ComponentClassP[Any & js.Object] = js.native
    ...
    def setWrappedComponent(componentName: String, wrappedComponent: ComponentClassP[Any & js.Object]): Unit = js.native
    def setWrappedComponent(componentName: Double, wrappedComponent: ComponentClassP[Any & js.Object]): Unit = js.native
