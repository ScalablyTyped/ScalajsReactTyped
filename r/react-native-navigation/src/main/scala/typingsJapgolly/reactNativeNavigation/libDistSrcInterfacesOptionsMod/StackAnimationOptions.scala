...
import typingsJapgolly.reactNativeNavigation.anon.Enter
...
trait StackAnimationOptions extends StObject {
  ...
  /**
    ...
    */
  var bottomTabs: js.UndefOr[ViewAnimationOptions | Enter] = js.undefined
  
  /**
    * Configure animations for the content (Screen)
    */
  var content: js.UndefOr[ViewAnimationOptions | Enter] = js.undefined
  ...
  /**
    ...
    */
  var topBar: js.UndefOr[ViewAnimationOptions | Enter] = js.undefined
...
object StackAnimationOptions {
  ...
  extension [Self <: StackAnimationOptions](x: Self) {
    ...
    inline def setContent(value: ViewAnimationOptions | Enter): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
    ...
    inline def setTopBar(value: ViewAnimationOptions | Enter): Self = StObject.set(x, "topBar", value.asInstanceOf[js.Any])
