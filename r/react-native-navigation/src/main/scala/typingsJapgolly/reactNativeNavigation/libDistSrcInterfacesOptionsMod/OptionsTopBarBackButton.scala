...
import typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.generic
import typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.minimal
