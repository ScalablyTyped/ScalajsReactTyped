...
import typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.exit
import typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.first
import typingsJapgolly.reactNativeNavigation.reactNativeNavigationStrings.previous
