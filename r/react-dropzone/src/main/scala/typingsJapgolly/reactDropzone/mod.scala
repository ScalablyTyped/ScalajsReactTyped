...
object mod {
  ...
  object ErrorCode extends StObject {
    ...
    sealed trait FileInvalidType
      extends StObject
         with ErrorCode
    /* "file-invalid-type" */ val FileInvalidType: typingsJapgolly.reactDropzone.mod.ErrorCode.FileInvalidType & String = js.native
    
    @js.native
    sealed trait FileTooLarge
      extends StObject
         with ErrorCode
    /* "file-too-large" */ val FileTooLarge: typingsJapgolly.reactDropzone.mod.ErrorCode.FileTooLarge & String = js.native
    
    @js.native
    sealed trait FileTooSmall
      extends StObject
         with ErrorCode
    /* "file-too-small" */ val FileTooSmall: typingsJapgolly.reactDropzone.mod.ErrorCode.FileTooSmall & String = js.native
    
    @js.native
    sealed trait TooManyFiles
      extends StObject
         with ErrorCode
    /* "too-many-files" */ val TooManyFiles: typingsJapgolly.reactDropzone.mod.ErrorCode.TooManyFiles & String = js.native
  }
  ...
  object DropzoneOptions {
    ...
    extension [Self <: DropzoneOptions](x: Self) {
      ...
      ): Self = StObject.set(x, "onDrop", js.Any.fromFunction3((t0: /* acceptedFiles */ js.Array[File], t1: /* fileRejections */ js.Array[FileRejection], t2: /* event */ DropEvent) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnDropAccepted(value: (/* files */ js.Array[File], /* event */ DropEvent) => Callback): Self = StObject.set(x, "onDropAccepted", js.Any.fromFunction2((t0: /* files */ js.Array[File], t1: /* event */ DropEvent) => (value(t0, t1)).runNow()))
      
      inline def setOnDropAcceptedUndefined: Self = StObject.set(x, "onDropAccepted", js.undefined)
      
      inline def setOnDropRejected(value: (/* fileRejections */ js.Array[FileRejection], /* event */ DropEvent) => Callback): Self = StObject.set(x, "onDropRejected", js.Any.fromFunction2((t0: /* fileRejections */ js.Array[FileRejection], t1: /* event */ DropEvent) => (value(t0, t1)).runNow()))
      ...
      inline def setOnFileDialogOpen(value: Callback): Self = StObject.set(x, "onFileDialogOpen", value.toJsFn)
