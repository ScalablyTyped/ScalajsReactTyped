...
object distTypesInternalAjaxTypesMod {
  ...
  trait AjaxConfig extends StObject {
    ...
    /**
      ...
      */
    var progressSubscriber: js.UndefOr[PartialObserver[ProgressEvent]] = js.undefined
  ...
  object AjaxConfig {
    ...
    extension [Self <: AjaxConfig](x: Self) {
      ...
      inline def setCreateXHR(value: CallbackTo[XMLHttpRequest]): Self = StObject.set(x, "createXHR", value.toJsFn)
      ...
      inline def setProgressSubscriber(value: PartialObserver[ProgressEvent]): Self = StObject.set(x, "progressSubscriber", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rxjs.rxjsStrings.upload
    - typingsJapgolly.rxjs.rxjsStrings.download
  */
  trait AjaxDirection extends StObject
  object AjaxDirection {
    
    inline def download: typingsJapgolly.rxjs.rxjsStrings.download = "download".asInstanceOf[typingsJapgolly.rxjs.rxjsStrings.download]
    
    inline def upload: typingsJapgolly.rxjs.rxjsStrings.upload = "upload".asInstanceOf[typingsJapgolly.rxjs.rxjsStrings.upload]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rxjs.rxjsStrings.loadstart
    - typingsJapgolly.rxjs.rxjsStrings.progress
    - typingsJapgolly.rxjs.rxjsStrings.load
  */
  trait ProgressEventType extends StObject
  object ProgressEventType {
    
    inline def load: typingsJapgolly.rxjs.rxjsStrings.load = "load".asInstanceOf[typingsJapgolly.rxjs.rxjsStrings.load]
    
    inline def loadstart: typingsJapgolly.rxjs.rxjsStrings.loadstart = "loadstart".asInstanceOf[typingsJapgolly.rxjs.rxjsStrings.loadstart]
    
    inline def progress: typingsJapgolly.rxjs.rxjsStrings.progress = "progress".asInstanceOf[typingsJapgolly.rxjs.rxjsStrings.progress]
  }
}
