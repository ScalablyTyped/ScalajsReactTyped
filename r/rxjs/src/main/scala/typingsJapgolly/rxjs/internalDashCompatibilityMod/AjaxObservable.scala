...
import typingsJapgolly.rxjs.internalObservableDomAjaxObservableMod.AjaxCreationMethod
...
class AjaxObservable[T] protected ()
  extends typingsJapgolly.rxjs.internalObservableDomAjaxObservableMod.AjaxObservable[T] {
...
object AjaxObservable extends js.Object {
  ...
  /**
    ...
    * @nocollapse
    */
  def create(urlOrRequest: String): Observable[typingsJapgolly.rxjs.internalObservableDomAjaxObservableMod.AjaxResponse] = js.native
  def create(urlOrRequest: AjaxRequest): Observable[typingsJapgolly.rxjs.internalObservableDomAjaxObservableMod.AjaxResponse] = js.native
}
