...
class Notification[T] protected ()
  extends typingsJapgolly.rxjs.notificationMod.Notification[T] {
...
object Notification extends js.Object {
  ...
  /**
    ...
    * @nocollapse
    */
  def createComplete(): typingsJapgolly.rxjs.notificationMod.Notification[_] = js.native
  /**
    ...
    * @nocollapse
    */
  def createError[T](): typingsJapgolly.rxjs.notificationMod.Notification[T] = js.native
  def createError[T](err: js.Any): typingsJapgolly.rxjs.notificationMod.Notification[T] = js.native
  /**
    ...
    * @nocollapse
    */
  def createNext[T](value: T): typingsJapgolly.rxjs.notificationMod.Notification[T] = js.native
}
