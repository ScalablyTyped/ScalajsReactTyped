...
import typingsJapgolly.rxjs.distTypesInternalConfigMod.GlobalConfig
import typingsJapgolly.rxjs.distTypesInternalFirstValueFromMod.FirstValueFromConfig
import typingsJapgolly.rxjs.distTypesInternalLastValueFromMod.LastValueFromConfig
...
import typingsJapgolly.rxjs.distTypesInternalUtilSequenceErrorMod.SequenceErrorCtor
...
import typingsJapgolly.rxjs.rxjsInts.`0`
...
object distTypesMod {
  ...
  open class AsyncSubject[T] ()
    extends typingsJapgolly.rxjs.distTypesInternalAsyncSubjectMod.AsyncSubject[T]
  
  @JSImport("rxjs/dist/types", "BehaviorSubject")
  @js.native
  open class BehaviorSubject[T] protected ()
    extends typingsJapgolly.rxjs.distTypesInternalBehaviorSubjectMod.BehaviorSubject[T] {
  ...
  open class ReplaySubject[T] ()
    extends typingsJapgolly.rxjs.distTypesInternalReplaySubjectMod.ReplaySubject[T] {
  ...
  open class Scheduler protected ()
    extends typingsJapgolly.rxjs.distTypesInternalSchedulerMod.Scheduler {
    def this(schedulerActionCtor: Instantiable2[
            /* scheduler */ typingsJapgolly.rxjs.distTypesInternalSchedulerMod.Scheduler, 
  ...
  open class Subject[T] ()
    extends typingsJapgolly.rxjs.distTypesInternalSubjectMod.Subject[T]
  /* static members */
  object Subject {
  ...
  open class Subscriber[T] ()
    extends typingsJapgolly.rxjs.distTypesInternalSubscriberMod.Subscriber[T] {
  ...
  open class VirtualAction[T] protected ()
    extends typingsJapgolly.rxjs.distTypesInternalSchedulerVirtualTimeSchedulerMod.VirtualAction[T] {
    def this(
      scheduler: typingsJapgolly.rxjs.distTypesInternalSchedulerVirtualTimeSchedulerMod.VirtualTimeScheduler,
  ...
  open class VirtualTimeScheduler ()
    extends typingsJapgolly.rxjs.distTypesInternalSchedulerVirtualTimeSchedulerMod.VirtualTimeScheduler {
    def this(schedulerActionCtor: Instantiable2[
