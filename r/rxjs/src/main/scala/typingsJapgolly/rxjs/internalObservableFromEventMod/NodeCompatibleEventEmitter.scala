...
object NodeCompatibleEventEmitter {
  ...
  def apply(
    ...
    __obj.updateDynamic("addListener")(js.Any.fromFunction2((t0: java.lang.String, t1: typingsJapgolly.rxjs.internalObservableFromEventMod.NodeEventHandler) => addListener(t0, t1).runNow()))
    __obj.updateDynamic("removeListener")(js.Any.fromFunction2((t0: java.lang.String, t1: typingsJapgolly.rxjs.internalObservableFromEventMod.NodeEventHandler) => removeListener(t0, t1).runNow()))
