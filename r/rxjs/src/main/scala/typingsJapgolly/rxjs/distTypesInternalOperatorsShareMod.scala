...
object distTypesInternalOperatorsShareMod {
  ...
  object ShareConfig {
    ...
    extension [Self <: ShareConfig[?], T](x: Self & ShareConfig[T]) {
      ...
      inline def setResetOnCompleteCallbackTo(value: CallbackTo[Observable[Any]]): Self = StObject.set(x, "resetOnComplete", value.toJsFn)
      ...
      inline def setResetOnRefCountZeroCallbackTo(value: CallbackTo[Observable[Any]]): Self = StObject.set(x, "resetOnRefCountZero", value.toJsFn)
