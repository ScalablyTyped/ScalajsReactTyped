...
object bindCallback extends js.Object {
  def apply(callbackFunc: js.Function): js.Function1[/* repeated */ js.Any, typingsJapgolly.rxjs.internalObservableMod.Observable[_]] = js.native
  def apply(callbackFunc: js.Function1[/* callback */ js.Function0[_], _]): js.Function0[typingsJapgolly.rxjs.internalObservableMod.Observable[Unit]] = js.native
  def apply(callbackFunc: js.Function1[/* callback */ js.Function0[_], _], scheduler: SchedulerLike): js.Function0[typingsJapgolly.rxjs.internalObservableMod.Observable[Unit]] = js.native
  ...
  def apply(callbackFunc: js.Function, scheduler: SchedulerLike): js.Function1[/* repeated */ js.Any, typingsJapgolly.rxjs.internalObservableMod.Observable[_]] = js.native
  def apply[A1](callbackFunc: js.Function2[/* arg1 */ A1, /* callback */ js.Function0[_], _]): js.Function1[/* arg1 */ A1, typingsJapgolly.rxjs.internalObservableMod.Observable[Unit]] = js.native
  def apply[A1](
