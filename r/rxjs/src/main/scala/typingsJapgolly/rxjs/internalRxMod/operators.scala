...
object operators extends js.Object {
  ...
  def buffer[T](closingNotifier: typingsJapgolly.rxjs.internalObservableMod.Observable[_]): OperatorFunction[T, js.Array[T]] = js.native
  ...
  def bufferWhen[T](closingSelector: js.Function0[typingsJapgolly.rxjs.internalObservableMod.Observable[_]]): OperatorFunction[T, js.Array[T]] = js.native
  def catchError[T, O /* <: ObservableInput[_] */](
    selector: js.Function2[
      /* err */ js.Any, 
      /* caught */ typingsJapgolly.rxjs.internalObservableMod.Observable[T], 
      O
    ]
  ...
  def delayWhen[T](
    delayDurationSelector: js.Function2[
      /* value */ T, 
      /* index */ Double, 
      typingsJapgolly.rxjs.internalObservableMod.Observable[_ | scala.Nothing]
    ]
  ...
  def delayWhen[T](
    ...
    subscriptionDelay: typingsJapgolly.rxjs.internalObservableMod.Observable[_]
  ): MonoTypeOperatorFunction[T] = js.native
  def dematerialize[T](): OperatorFunction[typingsJapgolly.rxjs.internalNotificationMod.Notification[T], T] = js.native
  ...
  def distinct[T, K](
    ...
    flushes: typingsJapgolly.rxjs.internalObservableMod.Observable[_]
  ): MonoTypeOperatorFunction[T] = js.native
  ...
  def groupBy[T, K](
    ...
    durationSelector: js.Function1[
      ...
      typingsJapgolly.rxjs.internalObservableMod.Observable[_]
    ]
  ...
  def groupBy[T, K, R](
    ...
    subjectSelector: js.Function0[typingsJapgolly.rxjs.internalSubjectMod.Subject[R]]
  ): OperatorFunction[T, GroupedObservable[K, R]] = js.native
  @JSName("groupBy")
  ...
  def materialize[T](): OperatorFunction[T, typingsJapgolly.rxjs.internalNotificationMod.Notification[T]] = js.native
  ...
  def multicast[T](
    subjectFactory: js.ThisFunction0[
      ...
      typingsJapgolly.rxjs.internalSubjectMod.Subject[T]
    ]
  ): UnaryFunction[
    typingsJapgolly.rxjs.internalObservableMod.Observable[T], 
    typingsJapgolly.rxjs.internalObservableConnectableObservableMod.ConnectableObservable[T]
  ] = js.native
  def multicast[T](subject: typingsJapgolly.rxjs.internalSubjectMod.Subject[T]): UnaryFunction[
    typingsJapgolly.rxjs.internalObservableMod.Observable[T], 
    typingsJapgolly.rxjs.internalObservableConnectableObservableMod.ConnectableObservable[T]
  ] = js.native
  def multicast[T, O /* <: ObservableInput[_] */](
    ...
    selector: js.Function1[/* shared */ typingsJapgolly.rxjs.internalObservableMod.Observable[T], O]
  ): OperatorFunction[T, ObservedValueOf[O]] = js.native
  def multicast[T, O /* <: ObservableInput[_] */](
    subject: typingsJapgolly.rxjs.internalSubjectMod.Subject[T],
    selector: js.Function1[/* shared */ typingsJapgolly.rxjs.internalObservableMod.Observable[T], O]
  ): UnaryFunction[
    typingsJapgolly.rxjs.internalObservableMod.Observable[T], 
    typingsJapgolly.rxjs.internalObservableConnectableObservableMod.ConnectableObservable[ObservedValueOf[O]]
  ] = js.native
  ...
  @JSName("publish")
  def publish_TO_ObservableInputWildcard_OperatorFunction[T, O /* <: ObservableInput[_] */](selector: js.Function1[/* shared */ typingsJapgolly.rxjs.internalObservableMod.Observable[T], O]): OperatorFunction[T, ObservedValueOf[O]] = js.native
  def race[T](
    observables: (typingsJapgolly.rxjs.internalObservableMod.Observable[T] | js.Array[typingsJapgolly.rxjs.internalObservableMod.Observable[T]])*
  ): MonoTypeOperatorFunction[T] = js.native
  def race[T](observables: js.Array[typingsJapgolly.rxjs.internalObservableMod.Observable[T]]): MonoTypeOperatorFunction[T] = js.native
  @JSName("race")
  def race_TR_OperatorFunction[T, R](
    observables: (typingsJapgolly.rxjs.internalObservableMod.Observable[_] | js.Array[typingsJapgolly.rxjs.internalObservableMod.Observable[_]])*
  ): OperatorFunction[T, R] = js.native
  @JSName("race")
  def race_TR_OperatorFunction[T, R](observables: js.Array[typingsJapgolly.rxjs.internalObservableMod.Observable[T]]): OperatorFunction[T, R] = js.native
  ...
  def repeatWhen[T](
    notifier: js.Function1[
      /* notifications */ typingsJapgolly.rxjs.internalObservableMod.Observable[_], 
      typingsJapgolly.rxjs.internalObservableMod.Observable[_]
    ]
  ): MonoTypeOperatorFunction[T] = js.native
  ...
  def retryWhen[T](
    notifier: js.Function1[
      /* errors */ typingsJapgolly.rxjs.internalObservableMod.Observable[_], 
      typingsJapgolly.rxjs.internalObservableMod.Observable[_]
    ]
  ): MonoTypeOperatorFunction[T] = js.native
  def sample[T](notifier: typingsJapgolly.rxjs.internalObservableMod.Observable[_]): MonoTypeOperatorFunction[T] = js.native
  ...
  def sequenceEqual[T](compareTo: typingsJapgolly.rxjs.internalObservableMod.Observable[T]): OperatorFunction[T, Boolean] = js.native
  def sequenceEqual[T](
    compareTo: typingsJapgolly.rxjs.internalObservableMod.Observable[T],
  ...
  def skipUntil[T](notifier: typingsJapgolly.rxjs.internalObservableMod.Observable[_]): MonoTypeOperatorFunction[T] = js.native
  ...
  def takeUntil[T](notifier: typingsJapgolly.rxjs.internalObservableMod.Observable[_]): MonoTypeOperatorFunction[T] = js.native
  ...
  def timeInterval[T](): OperatorFunction[T, typingsJapgolly.rxjs.internalOperatorsTimeIntervalMod.TimeInterval[T]] = js.native
  def timeInterval[T](scheduler: SchedulerLike): OperatorFunction[T, typingsJapgolly.rxjs.internalOperatorsTimeIntervalMod.TimeInterval[T]] = js.native
  ...
  def timestamp[T](): OperatorFunction[T, typingsJapgolly.rxjs.internalOperatorsTimestampMod.Timestamp[T]] = js.native
  def timestamp[T](scheduler: SchedulerLike): OperatorFunction[T, typingsJapgolly.rxjs.internalOperatorsTimestampMod.Timestamp[T]] = js.native
  def toArray[T](): OperatorFunction[T, js.Array[T]] = js.native
  def window[T](windowBoundaries: typingsJapgolly.rxjs.internalObservableMod.Observable[_]): OperatorFunction[T, typingsJapgolly.rxjs.internalObservableMod.Observable[T]] = js.native
  def windowCount[T](windowSize: Double): OperatorFunction[T, typingsJapgolly.rxjs.internalObservableMod.Observable[T]] = js.native
  def windowCount[T](windowSize: Double, startWindowEvery: Double): OperatorFunction[T, typingsJapgolly.rxjs.internalObservableMod.Observable[T]] = js.native
  def windowTime[T](windowTimeSpan: Double): OperatorFunction[T, typingsJapgolly.rxjs.internalObservableMod.Observable[T]] = js.native
  def windowTime[T](windowTimeSpan: Double, scheduler: SchedulerLike): OperatorFunction[T, typingsJapgolly.rxjs.internalObservableMod.Observable[T]] = js.native
  def windowTime[T](windowTimeSpan: Double, windowCreationInterval: Double): OperatorFunction[T, typingsJapgolly.rxjs.internalObservableMod.Observable[T]] = js.native
  def windowTime[T](windowTimeSpan: Double, windowCreationInterval: Double, maxWindowSize: Double): OperatorFunction[T, typingsJapgolly.rxjs.internalObservableMod.Observable[T]] = js.native
  def windowTime[T](
    windowTimeSpan: Double,
    windowCreationInterval: Double,
    maxWindowSize: Double,
    scheduler: SchedulerLike
  ): OperatorFunction[T, typingsJapgolly.rxjs.internalObservableMod.Observable[T]] = js.native
  def windowTime[T](windowTimeSpan: Double, windowCreationInterval: Double, scheduler: SchedulerLike): OperatorFunction[T, typingsJapgolly.rxjs.internalObservableMod.Observable[T]] = js.native
  def windowToggle[T, O](
    openings: typingsJapgolly.rxjs.internalObservableMod.Observable[O],
    closingSelector: js.Function1[/* openValue */ O, typingsJapgolly.rxjs.internalObservableMod.Observable[_]]
  ): OperatorFunction[T, typingsJapgolly.rxjs.internalObservableMod.Observable[T]] = js.native
  def windowWhen[T](closingSelector: js.Function0[typingsJapgolly.rxjs.internalObservableMod.Observable[_]]): OperatorFunction[T, typingsJapgolly.rxjs.internalObservableMod.Observable[T]] = js.native
