...
object mod {
  ...
  open class AsyncSubject[T] ()
    extends typingsJapgolly.rxjs.distTypesMod.AsyncSubject[T]
  
  @JSImport("rxjs", "BehaviorSubject")
  @js.native
  open class BehaviorSubject[T] protected ()
    extends typingsJapgolly.rxjs.distTypesMod.BehaviorSubject[T] {
  ...
  open class ConnectableObservable[T] protected ()
    extends typingsJapgolly.rxjs.distTypesMod.ConnectableObservable[T] {
    /**
  ...
  open class Notification[T] protected ()
    extends typingsJapgolly.rxjs.distTypesMod.Notification[T] {
    /**
  ...
  open class Observable_[T] ()
    extends typingsJapgolly.rxjs.distTypesMod.Observable_[T] {
  ...
  open class ReplaySubject[T] ()
    extends typingsJapgolly.rxjs.distTypesMod.ReplaySubject[T] {
  ...
  open class Scheduler protected ()
    extends typingsJapgolly.rxjs.distTypesMod.Scheduler {
  ...
  open class Subject[T] ()
    extends typingsJapgolly.rxjs.distTypesMod.Subject[T]
  /* static members */
  object Subject {
  ...
  open class Subscriber[T] ()
    extends typingsJapgolly.rxjs.distTypesMod.Subscriber[T] {
  ...
  open class Subscription ()
    extends typingsJapgolly.rxjs.distTypesMod.Subscription {
  ...
  open class VirtualAction[T] protected ()
    extends typingsJapgolly.rxjs.distTypesMod.VirtualAction[T] {
    def this(
  ...
  open class VirtualTimeScheduler ()
    extends typingsJapgolly.rxjs.distTypesMod.VirtualTimeScheduler {
    def this(schedulerActionCtor: Instantiable2[
