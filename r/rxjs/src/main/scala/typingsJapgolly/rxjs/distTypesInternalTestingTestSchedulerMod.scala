...
import typingsJapgolly.rxjs.anon.Fn0
import typingsJapgolly.rxjs.anon.FnCallMarblesValuesError
import typingsJapgolly.rxjs.anon.FnCallObservableSubscriptionMarbles
import typingsJapgolly.rxjs.anon.ToBe
import typingsJapgolly.rxjs.anon.ToBeSubscriptionLogsToBeFn
import typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable
import typingsJapgolly.rxjs.distTypesInternalSchedulerVirtualTimeSchedulerMod.VirtualTimeScheduler
...
object distTypesInternalTestingTestSchedulerMod {
  ...
  object RunHelpers {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(animate = js.Any.fromFunction1((t0: String) => animate(t0).runNow()), cold = cold.asInstanceOf[js.Any], expectObservable = expectObservable.asInstanceOf[js.Any], expectSubscriptions = js.Any.fromFunction1(expectSubscriptions), flush = flush.toJsFn, hot = hot.asInstanceOf[js.Any], time = js.Any.fromFunction1(time))
      __obj.asInstanceOf[RunHelpers]
    }
    
    extension [Self <: RunHelpers](x: Self) {
      
      inline def setAnimate(value: String => Callback): Self = StObject.set(x, "animate", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
