...
import typingsJapgolly.rxjs.distTypesInternalTypesMod.SubscriptionLike
...
object distTypesInternalSubscriptionMod {
  ...
  - typingsJapgolly.rxjs.distTypesInternalTypesMod._TeardownLogic because Already inherited */ @JSImport("rxjs/dist/types/internal/Subscription", "Subscription")
  @js.native
  /**
