...
object operators extends js.Object {
  ...
  def dematerialize[T](): OperatorFunction[typingsJapgolly.rxjs.notificationMod.Notification[T], T] = js.native
  ...
  def groupBy[T, K, R](
    ...
    subjectSelector: js.Function0[typingsJapgolly.rxjs.subjectMod.Subject[R]]
  ): OperatorFunction[T, GroupedObservable[K, R]] = js.native
  @JSName("groupBy")
  ...
  def materialize[T](): OperatorFunction[T, typingsJapgolly.rxjs.notificationMod.Notification[T]] = js.native
  ...
  def multicast[T](
    subjectFactory: js.ThisFunction0[
      ...
      typingsJapgolly.rxjs.subjectMod.Subject[T]
    ]
  ): UnaryFunction[
    typingsJapgolly.rxjs.internalObservableMod.Observable[T], 
    typingsJapgolly.rxjs.connectableObservableMod.ConnectableObservable[T]
  ] = js.native
  def multicast[T](subject: typingsJapgolly.rxjs.subjectMod.Subject[T]): UnaryFunction[
    typingsJapgolly.rxjs.internalObservableMod.Observable[T], 
    typingsJapgolly.rxjs.connectableObservableMod.ConnectableObservable[T]
  ] = js.native
  ...
  def multicast[T, O /* <: ObservableInput[_] */](
    subject: typingsJapgolly.rxjs.subjectMod.Subject[T],
    selector: js.Function1[/* shared */ typingsJapgolly.rxjs.internalObservableMod.Observable[T], O]
  ): UnaryFunction[
    typingsJapgolly.rxjs.internalObservableMod.Observable[T], 
    typingsJapgolly.rxjs.connectableObservableMod.ConnectableObservable[ObservedValueOf[O]]
  ] = js.native
