...
import typingsJapgolly.rxjs.anon.Instantiable
import typingsJapgolly.rxjs.distTypesInternalObservableMod.Observable
import typingsJapgolly.rxjs.distTypesInternalSubjectMod.AnonymousSubject
import typingsJapgolly.rxjs.distTypesInternalTypesMod.NextObserver
...
object distTypesInternalObservableDomWebSocketSubjectMod {
  ...
  object WebSocketSubjectConfig {
    ...
    extension [Self <: WebSocketSubjectConfig[?], T](x: Self & WebSocketSubjectConfig[T]) {
      ...
      inline def setDeserializer(value: /* e */ MessageEvent => T): Self = StObject.set(x, "deserializer", js.Any.fromFunction1(value))
      ...
      inline def setResultSelector(value: /* e */ MessageEvent => T): Self = StObject.set(x, "resultSelector", js.Any.fromFunction1(value))
