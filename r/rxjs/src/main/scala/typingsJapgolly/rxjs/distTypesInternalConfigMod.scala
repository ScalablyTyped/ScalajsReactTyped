...
object distTypesInternalConfigMod {
  ...
  object GlobalConfig {
    ...
    extension [Self <: GlobalConfig](x: Self) {
      ...
      inline def setOnStoppedNotification(
        value: (/* notification */ ObservableNotification[Any], /* subscriber */ Subscriber[Any]) => Callback
      ): Self = StObject.set(x, "onStoppedNotification", js.Any.fromFunction2((t0: /* notification */ ObservableNotification[Any], t1: /* subscriber */ Subscriber[Any]) => (value(t0, t1)).runNow()))
      
      inline def setOnStoppedNotificationNull: Self = StObject.set(x, "onStoppedNotification", null)
      
      inline def setOnUnhandledError(value: /* err */ Any => Callback): Self = StObject.set(x, "onUnhandledError", js.Any.fromFunction1((t0: /* err */ Any) => value(t0).runNow()))
