...
/**
  ...
  */
class Subscriber[T] ()
  extends typingsJapgolly.rxjs.subscriberMod.Subscriber[T] {
...
object Subscriber extends js.Object {
  /**
    ...
    * @nocollapse
    */
  def create[T](): typingsJapgolly.rxjs.subscriberMod.Subscriber[T] = js.native
  def create[T](next: js.Function1[/* x */ js.UndefOr[T], Unit]): typingsJapgolly.rxjs.subscriberMod.Subscriber[T] = js.native
  def create[T](
