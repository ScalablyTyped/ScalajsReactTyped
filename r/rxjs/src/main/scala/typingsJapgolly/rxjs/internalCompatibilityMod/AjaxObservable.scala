...
class AjaxObservable[T] protected ()
  extends typingsJapgolly.rxjs.ajaxObservableMod.AjaxObservable[T] {
...
object AjaxObservable extends js.Object {
  ...
  /**
    ...
    * @nocollapse
    */
  def create(urlOrRequest: String): Observable[typingsJapgolly.rxjs.ajaxObservableMod.AjaxResponse] = js.native
  def create(urlOrRequest: AjaxRequest): Observable[typingsJapgolly.rxjs.ajaxObservableMod.AjaxResponse] = js.native
}
