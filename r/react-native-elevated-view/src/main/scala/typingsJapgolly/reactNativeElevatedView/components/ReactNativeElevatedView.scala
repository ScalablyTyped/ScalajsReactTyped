package typingsJapgolly.reactNativeElevatedView.components
...
import typingsJapgolly.reactNativeElevatedView.mod.ElevatedViewProperties
import typingsJapgolly.reactNativeElevatedView.mod.default
...
object ReactNativeElevatedView {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ElevatedViewProperties, default, Unit, ElevatedViewProperties] = {
  ...
  typingsJapgolly.reactNativeElevatedView.mod.ElevatedViewProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeElevatedView.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeElevatedView.mod.ElevatedViewProperties])(children: _*)
  }
