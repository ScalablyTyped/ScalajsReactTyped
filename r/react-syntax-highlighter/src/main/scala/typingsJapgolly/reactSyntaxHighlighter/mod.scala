...
object mod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.reactSyntaxHighlighter.distEsmDefaultHighlightMod.default
  /* static members */
  object default {
  ...
  @js.native
  open class Light ()
    extends typingsJapgolly.reactSyntaxHighlighter.distEsmLightMod.default
  /* static members */
  object Light {
  ...
  open class LightAsync ()
    extends typingsJapgolly.reactSyntaxHighlighter.distEsmLightAsyncMod.default
  /* static members */
  object LightAsync {
  ...
  @js.native
  open class Prism ()
    extends typingsJapgolly.reactSyntaxHighlighter.distEsmPrismMod.default
  /* static members */
  object Prism {
  ...
  open class PrismAsync ()
    extends typingsJapgolly.reactSyntaxHighlighter.distEsmPrismAsyncMod.default
  
  @JSImport("react-syntax-highlighter", "PrismAsyncLight")
  @js.native
  open class PrismAsyncLight ()
    extends typingsJapgolly.reactSyntaxHighlighter.distEsmPrismAsyncLightMod.default
  /* static members */
  ...
  open class PrismLight ()
    extends typingsJapgolly.reactSyntaxHighlighter.distEsmPrismLightMod.default
  /* static members */
  object PrismLight {
  ...
  inline def createElement(props: createElementProps): Node = ^.asInstanceOf[js.Dynamic].applyDynamic("createElement")(props.asInstanceOf[js.Any]).asInstanceOf[Node]
  ...
  trait SyntaxHighlighterProps
    ...
    var renderer: js.UndefOr[js.Function1[/* props */ rendererProps, Node]] = js.undefined
  ...
  object SyntaxHighlighterProps {
    ...
    extension [Self <: SyntaxHighlighterProps](x: Self) {
      ...
      inline def setRenderer(value: /* props */ rendererProps => Node): Self = StObject.set(x, "renderer", js.Any.fromFunction1(value))
