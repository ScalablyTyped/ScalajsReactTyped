...
object Component {
  def apply[TOfStore /* <: Instantiable0[Store] */, P, S](
    ...
    P with js.Object, 
    typingsJapgolly.reflux.mod.Component[TOfStore, P, S], 
    Unit, 
    P with js.Object
  ] = {
  ...
  typingsJapgolly.reflux.mod.Component[TOfStore, P, S]](this.componentImport)
