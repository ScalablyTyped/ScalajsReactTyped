...
import typingsJapgolly.reactNative.mod.MeasureInWindowOnSuccessCallback
import typingsJapgolly.reactNative.mod.MeasureLayoutOnSuccessCallback
import typingsJapgolly.reactNative.mod.MeasureOnSuccessCallback
...
import typingsJapgolly.reactNativeSvg.anon.ObjectwidthNumberPropunde
...
object libTypescriptElementsSvgMod {
  ...
  @js.native
  trait Svg
    extends typingsJapgolly.reactNativeSvg.libTypescriptElementsShapeMod.default[SvgProps] {
