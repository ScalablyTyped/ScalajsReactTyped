...
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod._BaselineShift
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod._FontWeight
