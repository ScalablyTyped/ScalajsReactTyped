...
import typingsJapgolly.reactNativeSvg.reactNativeSvgStrings.`no-hide-descendants`
import typingsJapgolly.reactNativeSvg.reactNativeSvgStrings.assertive
import typingsJapgolly.reactNativeSvg.reactNativeSvgStrings.auto
import typingsJapgolly.reactNativeSvg.reactNativeSvgStrings.no
import typingsJapgolly.reactNativeSvg.reactNativeSvgStrings.none
import typingsJapgolly.reactNativeSvg.reactNativeSvgStrings.polite
import typingsJapgolly.reactNativeSvg.reactNativeSvgStrings.yes
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libTypescriptFabricUtilsMod {
  
  /* Inlined parent std.Omit<react-native.react-native.ViewProps, 'pointerEvents'> */
