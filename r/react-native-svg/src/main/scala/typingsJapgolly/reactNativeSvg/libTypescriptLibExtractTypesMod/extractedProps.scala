...
trait extractedProps
  ...
  var ref: js.UndefOr[js.Function1[/* instance */ (Component[js.Object, js.Object]) | Null, Unit]] = js.undefined
}
object extractedProps {
  ...
  extension [Self <: extractedProps](x: Self) {
    ...
    inline def setRef(value: /* instance */ (Component[js.Object, js.Object]) | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: /* instance */ (Component[js.Object, js.Object]) | Null) => value(t0).runNow()))
