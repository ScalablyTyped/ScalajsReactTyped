...
object ResponderInstanceProps {
  ...
  extension [Self <: ResponderInstanceProps](x: Self) {
    ...
    inline def setTouchableHandleResponderGrant(value: /* e */ GestureResponderEvent => Callback): Self = StObject.set(x, "touchableHandleResponderGrant", js.Any.fromFunction1((t0: /* e */ GestureResponderEvent) => value(t0).runNow()))
    
    inline def setTouchableHandleResponderGrantUndefined: Self = StObject.set(x, "touchableHandleResponderGrant", js.undefined)
    
    inline def setTouchableHandleResponderMove(value: /* e */ GestureResponderEvent => Callback): Self = StObject.set(x, "touchableHandleResponderMove", js.Any.fromFunction1((t0: /* e */ GestureResponderEvent) => value(t0).runNow()))
    
    inline def setTouchableHandleResponderMoveUndefined: Self = StObject.set(x, "touchableHandleResponderMove", js.undefined)
    
    inline def setTouchableHandleResponderRelease(value: /* e */ GestureResponderEvent => Callback): Self = StObject.set(x, "touchableHandleResponderRelease", js.Any.fromFunction1((t0: /* e */ GestureResponderEvent) => value(t0).runNow()))
    
    inline def setTouchableHandleResponderReleaseUndefined: Self = StObject.set(x, "touchableHandleResponderRelease", js.undefined)
    
    inline def setTouchableHandleResponderTerminate(value: /* e */ GestureResponderEvent => Callback): Self = StObject.set(x, "touchableHandleResponderTerminate", js.Any.fromFunction1((t0: /* e */ GestureResponderEvent) => value(t0).runNow()))
