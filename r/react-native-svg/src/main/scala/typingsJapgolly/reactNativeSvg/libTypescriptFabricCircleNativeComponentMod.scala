...
object libTypescriptFabricCircleNativeComponentMod extends Shortcut {
  
  @JSImport("react-native-svg/lib/typescript/fabric/CircleNativeComponent", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libTypescriptFabricCircleNativeComponentMod.foo` */
