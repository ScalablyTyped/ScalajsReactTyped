...
import typingsJapgolly.reactNativeSvg.reactNativeSvgInts.`-1`
...
object libTypescriptFabricMarkerNativeComponentMod extends Shortcut {
  
  @JSImport("react-native-svg/lib/typescript/fabric/MarkerNativeComponent", JSImport.Default)
  @js.native
  ...
  trait NativeProps
    ...
    var markerHeight: js.UndefOr[String] = js.undefined
    
    var markerUnits: js.UndefOr[String] = js.undefined
    
    var markerWidth: js.UndefOr[String] = js.undefined
    ...
    var refX: js.UndefOr[String] = js.undefined
    
    var refY: js.UndefOr[String] = js.undefined
  ...
  object NativeProps {
    ...
    extension [Self <: NativeProps](x: Self) {
      ...
      inline def setMarkerHeight(value: String): Self = StObject.set(x, "markerHeight", value.asInstanceOf[js.Any])
      ...
      inline def setMarkerWidth(value: String): Self = StObject.set(x, "markerWidth", value.asInstanceOf[js.Any])
      ...
      inline def setRefX(value: String): Self = StObject.set(x, "refX", value.asInstanceOf[js.Any])
      
      inline def setRefXUndefined: Self = StObject.set(x, "refX", js.undefined)
      
      inline def setRefY(value: String): Self = StObject.set(x, "refY", value.asInstanceOf[js.Any])
  ...
  trait SvgRenderableCommonProps extends StObject {
    ...
    var strokeWidth: js.UndefOr[WithDefault[String, typingsJapgolly.reactNativeSvg.reactNativeSvgStrings.`1`]] = js.undefined
  ...
  object SvgRenderableCommonProps {
    ...
    extension [Self <: SvgRenderableCommonProps](x: Self) {
      ...
      inline def setStrokeWidth(value: WithDefault[String, typingsJapgolly.reactNativeSvg.reactNativeSvgStrings.`1`]): Self = StObject.set(x, "strokeWidth", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `default`, but can instead just say `libTypescriptFabricMarkerNativeComponentMod.foo` */
