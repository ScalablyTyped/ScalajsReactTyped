...
object libTypescriptElementsStopMod {
  ...
  trait StopProps extends StObject {
    ...
    var parent: js.UndefOr[japgolly.scalajs.react.facade.React.Component[js.Object, js.Object]] = js.undefined
  ...
  object StopProps {
    ...
    extension [Self <: StopProps](x: Self) {
      ...
      inline def setParent(value: japgolly.scalajs.react.facade.React.Component[js.Object, js.Object]): Self = StObject.set(x, "parent", value.asInstanceOf[js.Any])
