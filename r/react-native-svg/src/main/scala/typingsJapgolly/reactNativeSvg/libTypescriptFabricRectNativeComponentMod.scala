...
object libTypescriptFabricRectNativeComponentMod extends Shortcut {
  
  @JSImport("react-native-svg/lib/typescript/fabric/RectNativeComponent", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libTypescriptFabricRectNativeComponentMod.foo` */
