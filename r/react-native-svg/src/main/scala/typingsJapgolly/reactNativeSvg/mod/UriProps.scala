...
object UriProps {
  ...
  def apply(
    ...
    uri: String = null,
    vectorEffect: typingsJapgolly.reactNativeSvg.reactNativeSvgStrings.none | `non-scaling-stroke` | nonScalingStroke | typingsJapgolly.reactNativeSvg.reactNativeSvgStrings.default | inherit | uri = null,
    viewBox: String = null,
