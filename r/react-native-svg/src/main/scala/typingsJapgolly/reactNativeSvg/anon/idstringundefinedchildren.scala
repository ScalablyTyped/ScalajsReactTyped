...
import typingsJapgolly.reactNativeSvg.reactNativeSvgStrings.objectBoundingBox
import typingsJapgolly.reactNativeSvg.reactNativeSvgStrings.userSpaceOnUse
