...
import typingsJapgolly.reactNativeSvg.anon.ObjectpointsstringArrayNu
...
object libTypescriptElementsPolylineMod {
  ...
  @js.native
  trait Polyline
    extends typingsJapgolly.reactNativeSvg.libTypescriptElementsShapeMod.default[PolylineProps] {
