...
object RNSVGImage {
  ...
  @JSImport("react-native-svg", "RNSVGImage")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGImage.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
