...
object RNSVGTSpan {
  ...
  @JSImport("react-native-svg", "RNSVGTSpan")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGTSpan.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
