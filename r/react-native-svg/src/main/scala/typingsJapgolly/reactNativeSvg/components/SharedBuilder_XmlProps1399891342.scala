...
@scala.inline
open class SharedBuilder_XmlProps1399891342[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def onError(value: /* error */ js.Error => Callback): this.type = set("onError", js.Any.fromFunction1((t0: /* error */ js.Error) => value(t0).runNow()))
  ...
  inline def xml(value: String): this.type = set("xml", value.asInstanceOf[js.Any])
  
  inline def xmlNull: this.type = set("xml", null)
