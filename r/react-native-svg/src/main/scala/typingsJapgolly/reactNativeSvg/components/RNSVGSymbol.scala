...
object RNSVGSymbol {
  ...
  @JSImport("react-native-svg", "RNSVGSymbol")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGSymbol.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
