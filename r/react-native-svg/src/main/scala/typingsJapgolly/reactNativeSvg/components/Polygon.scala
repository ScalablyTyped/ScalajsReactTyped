...
import typingsJapgolly.reactNativeSvg.mod.PolygonProps
...
object Polygon {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PolygonProps, typingsJapgolly.reactNativeSvg.mod.Polygon, Unit, PolygonProps] = {
  ...
  typingsJapgolly.reactNativeSvg.mod.PolygonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSvg.mod.Polygon](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvg.mod.PolygonProps])(children: _*)
  }
