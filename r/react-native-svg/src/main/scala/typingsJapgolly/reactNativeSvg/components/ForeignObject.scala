...
import typingsJapgolly.reactNativeSvg.libTypescriptElementsForeignObjectMod.ForeignObjectProps
...
object ForeignObject {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeSvg.mod.ForeignObject] {
  ...
  def withProps(p: GProps & ForeignObjectProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
