...
object RNSVGGroup {
  ...
  @JSImport("react-native-svg", "RNSVGGroup")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGGroup.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
