...
object RNSVGPath {
  ...
  @JSImport("react-native-svg", "RNSVGPath")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGPath.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
