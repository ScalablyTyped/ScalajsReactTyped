...
object RNSVGPattern {
  ...
  @JSImport("react-native-svg", "RNSVGPattern")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGPattern.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
