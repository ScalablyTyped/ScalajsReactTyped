...
import typingsJapgolly.reactNativeSvg.mod.EllipseProps
...
object Ellipse {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[EllipseProps, typingsJapgolly.reactNativeSvg.mod.Ellipse, Unit, EllipseProps] = {
  ...
  typingsJapgolly.reactNativeSvg.mod.EllipseProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSvg.mod.Ellipse](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvg.mod.EllipseProps])(children: _*)
  }
