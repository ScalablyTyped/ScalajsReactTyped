...
import typingsJapgolly.reactNativeSvg.mod.PathProps
...
object Path {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PathProps, typingsJapgolly.reactNativeSvg.mod.Path, Unit, PathProps] = {
  ...
  typingsJapgolly.reactNativeSvg.mod.PathProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSvg.mod.Path](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvg.mod.PathProps])(children: _*)
  }
