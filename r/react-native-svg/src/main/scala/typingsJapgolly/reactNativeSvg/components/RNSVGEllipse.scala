...
object RNSVGEllipse {
  ...
  @JSImport("react-native-svg", "RNSVGEllipse")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGEllipse.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
