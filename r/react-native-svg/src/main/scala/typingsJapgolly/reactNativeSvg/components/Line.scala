...
import typingsJapgolly.reactNativeSvg.mod.LineProps
...
object Line {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[LineProps, typingsJapgolly.reactNativeSvg.mod.Line, Unit, LineProps] = {
  ...
  typingsJapgolly.reactNativeSvg.mod.LineProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSvg.mod.Line](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvg.mod.LineProps])(children: _*)
  }
