...
abstract class SharedApply_SvgProps_1423145859[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SvgProps, ComponentRef, Unit, SvgProps] = {
  ...
  typingsJapgolly.reactNativeSvg.mod.SvgProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvg.mod.SvgProps])(children: _*)
  }
}
