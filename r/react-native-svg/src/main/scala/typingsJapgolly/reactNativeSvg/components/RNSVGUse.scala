...
object RNSVGUse {
  ...
  @JSImport("react-native-svg", "RNSVGUse")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGUse.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
