...
object RNSVGDefs {
  ...
  @JSImport("react-native-svg", "RNSVGDefs")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGDefs.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
