...
object Mask {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MaskProps, typingsJapgolly.reactNativeSvg.mod.Mask, Unit, MaskProps] = {
  ...
  typingsJapgolly.reactNativeSvg.mod.MaskProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSvg.mod.Mask](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvg.mod.MaskProps])(children: _*)
  }
