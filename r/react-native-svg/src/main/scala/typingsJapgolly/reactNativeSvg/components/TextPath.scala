...
import typingsJapgolly.reactNativeSvg.libTypescriptElementsTextPathMod.TextPathProps
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractExtractTextMod.TextChild
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod.AlignmentBaseline
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod.BaselineShift
...
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod.LengthAdjust
...
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod.TextPathMethod
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod.TextPathMidLine
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod.TextPathSpacing
...
object TextPath {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeSvg.mod.TextPath] {
    
    inline def alignmentBaseline(value: AlignmentBaseline): this.type = set("alignmentBaseline", value.asInstanceOf[js.Any])
    
    inline def baselineShift(value: BaselineShift): this.type = set("baselineShift", value.asInstanceOf[js.Any])
    
    inline def baselineShiftVarargs(value: NumberProp*): this.type = set("baselineShift", js.Array(value*))
    ...
    inline def lengthAdjust(value: LengthAdjust): this.type = set("lengthAdjust", value.asInstanceOf[js.Any])
    ...
    inline def method(value: TextPathMethod): this.type = set("method", value.asInstanceOf[js.Any])
    
    inline def midLine(value: TextPathMidLine): this.type = set("midLine", value.asInstanceOf[js.Any])
    ...
    inline def side(value: String): this.type = set("side", value.asInstanceOf[js.Any])
    ...
    inline def spacing(value: TextPathSpacing): this.type = set("spacing", value.asInstanceOf[js.Any])
    
    inline def startOffset(value: NumberProp): this.type = set("startOffset", value.asInstanceOf[js.Any])
    ...
    inline def textLength(value: NumberProp): this.type = set("textLength", value.asInstanceOf[js.Any])
    ...
    inline def verticalAlign(value: NumberProp): this.type = set("verticalAlign", value.asInstanceOf[js.Any])
