...
import typingsJapgolly.reactNativeSvg.mod.TextPathMethod
import typingsJapgolly.reactNativeSvg.mod.TextPathMidLine
import typingsJapgolly.reactNativeSvg.mod.TextPathProps
import typingsJapgolly.reactNativeSvg.mod.TextPathSpacing
...
object TextPath {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextPathProps, typingsJapgolly.reactNativeSvg.mod.TextPath, Unit, TextPathProps] = {
  ...
  typingsJapgolly.reactNativeSvg.mod.TextPathProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSvg.mod.TextPath](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvg.mod.TextPathProps])(children: _*)
  }
