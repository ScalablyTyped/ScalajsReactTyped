...
object RNSVGCircle {
  ...
  @JSImport("react-native-svg", "RNSVGCircle")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGCircle.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
