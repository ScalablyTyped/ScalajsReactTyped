...
object RNSVGSvg {
  ...
  @JSImport("react-native-svg", "RNSVGSvg")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGSvg.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
