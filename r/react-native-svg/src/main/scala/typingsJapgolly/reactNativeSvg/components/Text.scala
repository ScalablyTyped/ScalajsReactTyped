...
import typingsJapgolly.reactNativeSvg.mod.TextProps
...
object Text {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextProps, typingsJapgolly.reactNativeSvg.mod.Text, Unit, TextProps] = {
  ...
  typingsJapgolly.reactNativeSvg.mod.TextProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSvg.mod.Text](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvg.mod.TextProps])(children: _*)
  }
