...
object SvgFromUri {
  ...
  implicit def make(companion: SvgFromUri.type): SharedBuilder_UriProps1755440291 = new SharedBuilder_UriProps1755440291(js.Array(this.component, js.Dictionary.empty))()
