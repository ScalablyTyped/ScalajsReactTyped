...
object RNSVGMask {
  ...
  @JSImport("react-native-svg", "RNSVGMask")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGMask.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
