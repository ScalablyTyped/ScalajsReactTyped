...
import typingsJapgolly.reactNativeSvg.mod.GProps
...
object G {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[GProps, typingsJapgolly.reactNativeSvg.mod.G, Unit, GProps] = {
  ...
  typingsJapgolly.reactNativeSvg.mod.GProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSvg.mod.G](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvg.mod.GProps])(children: _*)
  }
