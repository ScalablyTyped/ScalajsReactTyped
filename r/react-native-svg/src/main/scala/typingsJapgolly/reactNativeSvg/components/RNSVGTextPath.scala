...
object RNSVGTextPath {
  
  def apply(p: Any): Default[js.Object] = new Default[js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @JSImport("react-native-svg", "RNSVGTextPath")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGTextPath.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
