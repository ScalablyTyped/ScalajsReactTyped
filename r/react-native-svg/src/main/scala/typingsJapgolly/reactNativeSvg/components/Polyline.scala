...
import typingsJapgolly.reactNativeSvg.libTypescriptElementsPolylineMod.PolylineProps
...
object Polyline {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNativeSvg.mod.Polyline] {
    ...
    inline def points(value: String | js.Array[NumberProp]): this.type = set("points", value.asInstanceOf[js.Any])
    
    inline def pointsVarargs(value: NumberProp*): this.type = set("points", js.Array(value*))
