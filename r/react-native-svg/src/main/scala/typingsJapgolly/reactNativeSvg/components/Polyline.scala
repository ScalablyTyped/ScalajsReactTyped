...
import typingsJapgolly.reactNativeSvg.mod.PolylineProps
...
object Polyline {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PolylineProps, typingsJapgolly.reactNativeSvg.mod.Polyline, Unit, PolylineProps] = {
  ...
  typingsJapgolly.reactNativeSvg.mod.PolylineProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSvg.mod.Polyline](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvg.mod.PolylineProps])(children: _*)
  }
