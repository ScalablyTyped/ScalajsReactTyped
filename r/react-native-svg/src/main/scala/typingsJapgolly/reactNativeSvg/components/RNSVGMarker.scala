...
object RNSVGMarker {
  ...
  @JSImport("react-native-svg", "RNSVGMarker")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGMarker.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
