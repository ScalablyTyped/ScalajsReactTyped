...
object RNSVGRect {
  ...
  @JSImport("react-native-svg", "RNSVGRect")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RNSVGRect.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
