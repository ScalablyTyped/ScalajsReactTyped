...
import typingsJapgolly.reactNativeSvg.mod.UseProps
...
object Use {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[UseProps, typingsJapgolly.reactNativeSvg.mod.Use, Unit, UseProps] = {
  ...
  typingsJapgolly.reactNativeSvg.mod.UseProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeSvg.mod.Use](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeSvg.mod.UseProps])(children: _*)
  }
