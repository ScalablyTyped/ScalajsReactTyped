...
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod.ClipProps
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod.CommonMaskProps
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod.NativeProps
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod.NumberProp
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod.ResponderProps
import typingsJapgolly.reactNativeSvg.libTypescriptLibExtractTypesMod.TouchableProps
...
object libTypescriptElementsImageMod {
  ...
  @js.native
  trait SvgImage
    extends typingsJapgolly.reactNativeSvg.libTypescriptElementsShapeMod.default[ImageProps]
}
