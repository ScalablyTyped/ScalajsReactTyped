...
import typingsJapgolly.reduxReactSession.reducerMod.SessionState
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reduxReactSession.actionsMod.GetSessionSuccessAction
    - typingsJapgolly.reduxReactSession.actionsMod.GetSessionErrorAction
    - typingsJapgolly.reduxReactSession.actionsMod.GetUserSessionSuccessAction[UserType]
    - typingsJapgolly.reduxReactSession.actionsMod.GetUserSessionErrorAction
    - typingsJapgolly.reduxReactSession.actionsMod.InvalidSessionAction
  */
  trait ActionTypes[UserType] extends StObject
  object ActionTypes {
    
    inline def GetSessionErrorAction(): typingsJapgolly.reduxReactSession.actionsMod.GetSessionErrorAction = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("@@redux-react-session/GET_SESSION_ERROR")
      __obj.asInstanceOf[typingsJapgolly.reduxReactSession.actionsMod.GetSessionErrorAction]
    }
    
    inline def GetSessionSuccessAction(): typingsJapgolly.reduxReactSession.actionsMod.GetSessionSuccessAction = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("@@redux-react-session/GET_SESSION_SUCCESS")
      __obj.asInstanceOf[typingsJapgolly.reduxReactSession.actionsMod.GetSessionSuccessAction]
    }
    
    inline def GetUserSessionErrorAction(): typingsJapgolly.reduxReactSession.actionsMod.GetUserSessionErrorAction = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("@@redux-react-session/GET_USER_SESSION_ERROR")
      __obj.asInstanceOf[typingsJapgolly.reduxReactSession.actionsMod.GetUserSessionErrorAction]
    }
    
    inline def GetUserSessionSuccessAction[UserType](user: UserType): typingsJapgolly.reduxReactSession.actionsMod.GetUserSessionSuccessAction[UserType] = {
      val __obj = js.Dynamic.literal(user = user.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("@@redux-react-session/GET_USER_SESSION_SUCCESS")
      __obj.asInstanceOf[typingsJapgolly.reduxReactSession.actionsMod.GetUserSessionSuccessAction[UserType]]
    }
    
    inline def InvalidSessionAction(): typingsJapgolly.reduxReactSession.actionsMod.InvalidSessionAction = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("@@redux-react-session/INVALID_SESSION")
      __obj.asInstanceOf[typingsJapgolly.reduxReactSession.actionsMod.InvalidSessionAction]
    }
  }
