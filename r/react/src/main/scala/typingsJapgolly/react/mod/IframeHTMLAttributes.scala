...
trait IframeHTMLAttributes[T]
  ...
  var loading: js.UndefOr[eager | typingsJapgolly.react.reactStrings.`lazy`] = js.undefined
...
object IframeHTMLAttributes {
  ...
  extension [Self <: IframeHTMLAttributes[?], T](x: Self & IframeHTMLAttributes[T]) {
    ...
    inline def setLoading(value: eager | typingsJapgolly.react.reactStrings.`lazy`): Self = StObject.set(x, "loading", value.asInstanceOf[js.Any])
