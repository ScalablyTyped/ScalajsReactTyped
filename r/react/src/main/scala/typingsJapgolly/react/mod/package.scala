...
package object mod {
  ...
  type ComponentPropsWithRef[T /* <: japgolly.scalajs.react.raw.React.ElementType */] = typingsJapgolly.react.mod.PropsWithRef[typingsJapgolly.react.mod.ComponentProps[T]] | (typingsJapgolly.react.mod.PropsWithoutRef[_] with typingsJapgolly.react.mod.RefAttributes[typingsJapgolly.std.InstanceType[T]])
  ...
  type MergePropTypes[P, T] = ((typingsJapgolly.std.Pick[P, typingsJapgolly.react.mod.NotExactlyAnyPropertyKeys[P]]) with (typingsJapgolly.std.Pick[
    T, 
    typingsJapgolly.std.Exclude[java.lang.String, typingsJapgolly.react.mod.NotExactlyAnyPropertyKeys[P]]
  ]) with (typingsJapgolly.std.Pick[P, typingsJapgolly.std.Exclude[java.lang.String, java.lang.String]])) | P | T
  ...
  type NotExactlyAnyPropertyKeys[T] = typingsJapgolly.std.Exclude[java.lang.String, typingsJapgolly.react.mod.ExactlyAnyPropertyKeys[T]]
  ...
  type ProfilerOnRenderCallback = js.Function7[
    ...
    /* interactions */ typingsJapgolly.std.Set[typingsJapgolly.react.mod.SchedulerInteraction], 
    scala.Unit
  ]
  type PropsWithChildren[P] = P with typingsJapgolly.react.AnonChildren
  /** Ensures that the props do not include string ref, which cannot be forwarded */
  type PropsWithRef[P] = P | (typingsJapgolly.react.mod.PropsWithoutRef[P] with typingsJapgolly.react.AnonRefExclude)
  /** Ensures that the props do not include ref at all */
  type PropsWithoutRef[P] = P | (typingsJapgolly.std.Pick[
    P, 
    typingsJapgolly.std.Exclude[java.lang.String, typingsJapgolly.react.reactStrings.ref]
  ])
  ...
  type ReactManagedAttributes[C, P] = P | (typingsJapgolly.react.mod.Defaultize[
    (typingsJapgolly.react.mod.MergePropTypes[P, typingsJapgolly.propTypes.mod.InferProps[js.Any]]) | P, 
    js.Any
  ]) | (typingsJapgolly.react.mod.MergePropTypes[P, typingsJapgolly.propTypes.mod.InferProps[js.Any]])
  ...
  type ReducerStateWithoutAction[R /* <: typingsJapgolly.react.mod.ReducerWithoutAction[_] */] = js.Any
  // If useReducer accepts a reducer without action, dispatch may be called without any parameters.
  type ReducerWithoutAction[S] = js.Function1[/* prevState */ S, S]
  type Ref[T] = typingsJapgolly.react.mod.RefCallback[T] | japgolly.scalajs.react.raw.React.RefHandle[T] | scala.Null
  ...
  /**
    ...
    *             "real" component.
    */
  type RefForwardingComponent[T, P] = typingsJapgolly.react.mod.ForwardRefRenderFunction[T, P]
