...
package object reactMod {
  ...
  import typingsJapgolly.propDashTypes.propDashTypesMod.InferProps
  ...
  type ComponentPropsWithRef[T /* <: japgolly.scalajs.react.raw.React.ElementType */] = PropsWithRef[ComponentProps[T]] | (PropsWithoutRef[_] with RefAttributes[InstanceType[T]])
  ...
  type Requireable[T] = typingsJapgolly.propDashTypes.propDashTypesMod.Requireable[T]
  //
  // Class Interfaces
  // ----------------------------------------------------------------------
  /**
  ...
  type TransitionStartFunction = js.Function1[
    /* callback */ typingsJapgolly.react.experimentalMod.reactMod.TransitionFunction, 
    Unit
  ]
  type UIEventHandler[T] = EventHandler[UIEvent[T]]
  type ValidationMap[T] = typingsJapgolly.propDashTypes.propDashTypesMod.ValidationMap[T]
  //
  // React.PropTypes
  // ----------------------------------------------------------------------
  type Validator[T] = typingsJapgolly.propDashTypes.propDashTypesMod.Validator[T]
