...
object ComponentLifecycle {
  ...
  def apply[P, S, SS](
    ...
    if (componentDidCatch != null) __obj.updateDynamic("componentDidCatch")(js.Any.fromFunction2((t0: /* error */ js.Error, t1: /* errorInfo */ typingsJapgolly.react.reactMod.ErrorInfo) => componentDidCatch(t0, t1).runNow()))
