...
- typingsJapgolly.raphael.mod.RaphaelHslComponentInfo because var conflicts: h, s. Inlined l
- typingsJapgolly.raphael.mod.RaphaelHsbComponentInfo because var conflicts: b. Inlined h, s */ trait RaphaelFullComponentInfo
  extends StObject
