...
trait RaphaelStatic extends js.Object {
  ...
  def bezierBBox(bez: js.Array[_]): AnonMax = js.native
  def bezierBBox(
    p1x: Double,
    p1y: Double,
    c1x: Double,
  ...
  def color(clr: String): AnonB = js.native
  ...
  def pathIntersection(path1: String, path2: String): js.Array[AnonBez1] = js.native
