...
object anon {
  ...
  trait ComponentWillMount extends StObject {
    ...
    def getContent(): String | japgolly.scalajs.react.facade.React.Element | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify React.SFCElement<{[x: string] : any, ref (picker : any): void}> */ Any) = js.native
  ...
  trait ReadonlyIPopupPickerProps extends StObject {
    ...
    val content: js.UndefOr[japgolly.scalajs.react.facade.React.Element | String] = js.undefined
    
    val disabled: js.UndefOr[Boolean] = js.undefined
    
    val dismissText: js.UndefOr[String | japgolly.scalajs.react.facade.React.Element] = js.undefined
    
    val maskTransitionName: js.UndefOr[String] = js.undefined
    
    val okText: js.UndefOr[String | japgolly.scalajs.react.facade.React.Element] = js.undefined
    ...
    val title: js.UndefOr[String | japgolly.scalajs.react.facade.React.Element] = js.undefined
  ...
  object ReadonlyIPopupPickerProps {
    ...
    extension [Self <: ReadonlyIPopupPickerProps](x: Self) {
      ...
      inline def setContent(value: japgolly.scalajs.react.facade.React.Element | String): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
      ...
      inline def setDismissText(value: String | japgolly.scalajs.react.facade.React.Element): Self = StObject.set(x, "dismissText", value.asInstanceOf[js.Any])
      ...
      inline def setOkText(value: String | japgolly.scalajs.react.facade.React.Element): Self = StObject.set(x, "okText", value.asInstanceOf[js.Any])
      ...
      inline def setTitle(value: String | japgolly.scalajs.react.facade.React.Element): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
  ...
  trait ReadonlychildrenReactNode extends StObject {
    ...
    val children: js.UndefOr[Node] & js.UndefOr[Any]
  ...
  object ReadonlychildrenReactNode {
    ...
    inline def apply(children: js.UndefOr[Node] & js.UndefOr[Any]): ReadonlychildrenReactNode = {
