package typingsJapgolly.reactNativeMultiSlider
...
object mod {
  ...
  object MultiSliderProps {
    ...
    extension [Self <: MultiSliderProps](x: Self) {
      ...
      inline def setOnValuesChange(value: /* change */ js.Array[Double] => Callback): Self = StObject.set(x, "onValuesChange", js.Any.fromFunction1((t0: /* change */ js.Array[Double]) => value(t0).runNow()))
      
      inline def setOnValuesChangeFinish(value: /* change */ js.Array[Double] => Callback): Self = StObject.set(x, "onValuesChangeFinish", js.Any.fromFunction1((t0: /* change */ js.Array[Double]) => value(t0).runNow()))
