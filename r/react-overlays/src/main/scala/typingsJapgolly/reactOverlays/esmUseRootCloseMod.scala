...
object esmUseRootCloseMod {
  ...
  @JSImport("react-overlays/esm/useRootClose", JSImport.Namespace)
  @js.native
  ...
  /**
    ...
    */
  inline def default(ref: RefHandle[Element], onRootClose: js.Function1[/* e */ Event, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(ref.asInstanceOf[js.Any], onRootClose.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def default(
