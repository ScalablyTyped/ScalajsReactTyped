...
import typingsJapgolly.reactResponsive.anon.PartialMediaQueryAllQuery
import typingsJapgolly.reactResponsive.anon.PartialMediaQueryAllQueryAll
...
object mod {
  ...
  @js.native
  val Context: typingsJapgolly.react.mod.Context[PartialMediaQueryAllQuery] = js.native
  ...
  type MediaQuery = japgolly.scalajs.react.facade.React.Component[MediaQueryProps & js.Object, js.Object]
  ...
  object MediaQueryProps {
    ...
    extension [Self <: MediaQueryProps](x: Self) {
      ...
      inline def setChildren(value: Node | (js.Function1[/* matches */ Boolean, Node])): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      ...
      inline def setOnBeforeChange(value: /* matches */ Boolean => Callback): Self = StObject.set(x, "onBeforeChange", js.Any.fromFunction1((t0: /* matches */ Boolean) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactResponsive.reactResponsiveStrings.all
    - typingsJapgolly.reactResponsive.reactResponsiveStrings.grid
    - typingsJapgolly.reactResponsive.reactResponsiveStrings.aural
    - typingsJapgolly.reactResponsive.reactResponsiveStrings.braille
    - typingsJapgolly.reactResponsive.reactResponsiveStrings.handheld
    - typingsJapgolly.reactResponsive.reactResponsiveStrings.print
    - typingsJapgolly.reactResponsive.reactResponsiveStrings.projection
    - typingsJapgolly.reactResponsive.reactResponsiveStrings.screen
    - typingsJapgolly.reactResponsive.reactResponsiveStrings.tty
    - typingsJapgolly.reactResponsive.reactResponsiveStrings.tv
    - typingsJapgolly.reactResponsive.reactResponsiveStrings.embossed
  */
