...
object ReactResponsive {
  ...
  ): UnmountedWithRoot[MediaQueryProps, default, Unit, MediaQueryProps] = {
  ...
  typingsJapgolly.reactResponsive.mod.MediaQueryProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.reactResponsive.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactResponsive.mod.MediaQueryProps])
  }
