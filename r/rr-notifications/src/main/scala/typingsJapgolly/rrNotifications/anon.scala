package typingsJapgolly.rrNotifications

import japgolly.scalajs.react.Callback
import typingsJapgolly.react.mod.global.JSX.Element
import typingsJapgolly.rrNotifications.mod.NotificationPayload
...
object anon {
  ...
  object Payload {
    ...
    inline def apply(payload: NotificationPayload, removeNotification: Callback): Payload = {
      val __obj = js.Dynamic.literal(payload = payload.asInstanceOf[js.Any], removeNotification = removeNotification.toJsFn)
    ...
    extension [Self <: Payload](x: Self) {
      ...
      inline def setRemoveNotification(value: Callback): Self = StObject.set(x, "removeNotification", value.toJsFn)
    }
  }
}
