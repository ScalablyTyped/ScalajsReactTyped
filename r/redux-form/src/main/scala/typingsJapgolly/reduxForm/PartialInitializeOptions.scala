...
object PartialInitializeOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(keepDirty)) __obj.updateDynamic("keepDirty")(keepDirty.asInstanceOf[js.Any])
    if (!js.isUndefined(keepSubmitSucceeded)) __obj.updateDynamic("keepSubmitSucceeded")(keepSubmitSucceeded.asInstanceOf[js.Any])
    if (!js.isUndefined(keepValues)) __obj.updateDynamic("keepValues")(keepValues.asInstanceOf[js.Any])
