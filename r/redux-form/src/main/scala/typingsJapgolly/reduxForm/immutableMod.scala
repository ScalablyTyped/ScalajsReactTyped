...
object immutableMod {
  ...
  open class Field[P /* <: GenericFieldHTMLAttributes | BaseFieldProps[js.Object] */] protected ()
    extends typingsJapgolly.reduxForm.mod.Field[P] {
  ...
  open class FieldArray[P, FieldValue] protected ()
    extends typingsJapgolly.reduxForm.mod.FieldArray[P, FieldValue] {
  ...
  open class Fields[P] protected ()
    extends typingsJapgolly.reduxForm.mod.Fields[P] {
  ...
  open class Form[FormData, P, ErrorType] protected ()
    extends typingsJapgolly.reduxForm.mod.Form[FormData, P, ErrorType] {
  ...
  open class FormSection[P] protected ()
    extends typingsJapgolly.reduxForm.mod.FormSection[P] {
