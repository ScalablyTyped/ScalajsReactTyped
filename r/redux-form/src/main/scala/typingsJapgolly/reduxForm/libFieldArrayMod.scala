...
import typingsJapgolly.reduxForm.anon.Props
...
object libFieldArrayMod {
  ...
  trait GenericFieldArray[FieldValue, P]
    ...
    def getRenderedComponent(): japgolly.scalajs.react.facade.React.Component[WrappedFieldArrayProps[FieldValue] & P & js.Object, js.Object] = js.native
