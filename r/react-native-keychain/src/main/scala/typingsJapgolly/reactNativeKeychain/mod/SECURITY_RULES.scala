...
object SECURITY_RULES extends StObject {
  ...
  sealed trait AUTOMATIC_UPGRADE
    extends StObject
       with SECURITY_RULES
  /* "automaticUpgradeToMoreSecuredStorage" */ val AUTOMATIC_UPGRADE: typingsJapgolly.reactNativeKeychain.mod.SECURITY_RULES.AUTOMATIC_UPGRADE & String = js.native
  
  @js.native
  sealed trait NONE
    extends StObject
       with SECURITY_RULES
  /* "none" */ val NONE: typingsJapgolly.reactNativeKeychain.mod.SECURITY_RULES.NONE & String = js.native
}
