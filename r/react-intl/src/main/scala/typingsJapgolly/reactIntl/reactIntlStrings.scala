...
object reactIntlStrings {
  ...
  @js.native
  sealed trait defaultFormats extends StObject
  inline def defaultFormats: defaultFormats = "defaultFormats".asInstanceOf[defaultFormats]
  
  @js.native
  sealed trait defaultLocale extends StObject
  inline def defaultLocale: defaultLocale = "defaultLocale".asInstanceOf[defaultLocale]
  ...
  @js.native
  sealed trait fallbackOnEmptyString extends StObject
  inline def fallbackOnEmptyString: fallbackOnEmptyString = "fallbackOnEmptyString".asInstanceOf[fallbackOnEmptyString]
  ...
  @js.native
  sealed trait textComponent extends StObject
  inline def textComponent: textComponent = "textComponent".asInstanceOf[textComponent]
