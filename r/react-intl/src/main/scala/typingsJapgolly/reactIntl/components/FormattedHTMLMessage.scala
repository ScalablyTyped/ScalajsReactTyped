...
object FormattedHTMLMessage {
  def apply(
    ...
    Props3[Record[String, PrimitiveType]], 
    typingsJapgolly.reactIntl.mod.FormattedHTMLMessage, 
    Unit, 
    Props3[Record[String, PrimitiveType]]
  ] = {
  ...
  typingsJapgolly.reactIntl.mod.Props3[
    typingsJapgolly.std.Record[java.lang.String, typingsJapgolly.intlMessageformat.mod.PrimitiveType]
  ], 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.reactIntl.mod.FormattedHTMLMessage](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactIntl.mod.Props3[
  typingsJapgolly.std.Record[java.lang.String, typingsJapgolly.intlMessageformat.mod.PrimitiveType]]])
  }
