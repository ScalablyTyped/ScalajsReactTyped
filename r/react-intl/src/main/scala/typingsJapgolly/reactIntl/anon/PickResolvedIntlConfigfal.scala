...
trait PickResolvedIntlConfigfal extends StObject {
...
object PickResolvedIntlConfigfal {
  
  inline def apply(): PickResolvedIntlConfigfal = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickResolvedIntlConfigfal]
  }
  
  extension [Self <: PickResolvedIntlConfigfal](x: Self) {
