package typingsJapgolly.reactNativeAutocompleteInput
...
object mod extends Shortcut {
  ...
  trait AutocompleteProps[T]
    ...
    /**
      ...
      */
    @JSName("onStartShouldSetResponderCapture")
    var onStartShouldSetResponderCapture_AutocompleteProps: js.UndefOr[js.Function1[/* event */ GestureResponderEvent, Boolean]] = js.undefined
    
    /**
      * function
      * render custom result list. Can be used to replace FlatList. All props passed to this function.
      */
    var renderResultList: js.UndefOr[js.Function1[/* props */ AutocompleteProps[T], Node]] = js.undefined
    
    /**
      * function
      * render custom TextInput. All props passed to this function.
      */
    var renderTextInput: js.UndefOr[js.Function1[/* props */ AutocompleteProps[T], Node]] = js.undefined
  }
  object AutocompleteProps {
    ...
    extension [Self <: AutocompleteProps[?], T](x: Self & AutocompleteProps[T]) {
      ...
      inline def setOnShowResults(value: /* showResults */ Boolean => Callback): Self = StObject.set(x, "onShowResults", js.Any.fromFunction1((t0: /* showResults */ Boolean) => value(t0).runNow()))
      ...
      inline def setRenderResultList(value: /* props */ AutocompleteProps[T] => Node): Self = StObject.set(x, "renderResultList", js.Any.fromFunction1(value))
      
      inline def setRenderResultListUndefined: Self = StObject.set(x, "renderResultList", js.undefined)
      
      inline def setRenderTextInput(value: /* props */ AutocompleteProps[T] => Node): Self = StObject.set(x, "renderTextInput", js.Any.fromFunction1(value))
