...
@scala.inline
open class SharedBuilder_AutocompleteProps_685489640 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def flatListProps(value: Partial[FlatListProps[Any]]): this.type = set("flatListProps", value.asInstanceOf[js.Any])
  ...
  inline def hideResults(value: Boolean): this.type = set("hideResults", value.asInstanceOf[js.Any])
  ...
  inline def listStyle(value: StyleProp[ViewStyle]): this.type = set("listStyle", value.asInstanceOf[js.Any])
  ...
  inline def onShowResults(value: /* showResults */ Boolean => Callback): this.type = set("onShowResults", js.Any.fromFunction1((t0: /* showResults */ Boolean) => value(t0).runNow()))
  ...
  inline def renderResultList(value: /* props */ AutocompleteProps[Any] => Node): this.type = set("renderResultList", js.Any.fromFunction1(value))
  
  inline def renderTextInput(value: /* props */ AutocompleteProps[Any] => Node): this.type = set("renderTextInput", js.Any.fromFunction1(value))
