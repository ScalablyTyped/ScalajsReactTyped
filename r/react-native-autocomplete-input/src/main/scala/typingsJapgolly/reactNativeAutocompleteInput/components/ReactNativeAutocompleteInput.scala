...
object ReactNativeAutocompleteInput {
  def apply[T](
    data: js.Array[T],
    ...
    keyExtractor: (T, /* i */ Double) => CallbackTo[String] = null,
    ...
    renderSeparator: (/* sectionID */ String | Double, /* rowID */ String | Double, /* adjacentRowHighlighted */ js.UndefOr[Boolean]) => CallbackTo[japgolly.scalajs.react.raw.React.Element] = null,
    ...
    AutocompleteProps[T], 
    typingsJapgolly.reactNativeAutocompleteInput.mod.default[T], 
    Unit, 
    AutocompleteProps[T]
  ] = {
    ...
    if (keyExtractor != null) __obj.updateDynamic("keyExtractor")(js.Any.fromFunction2((t0: T, t1: /* i */ scala.Double) => keyExtractor(t0, t1).runNow()))
  ...
  typingsJapgolly.reactNativeAutocompleteInput.mod.AutocompleteProps[T], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNativeAutocompleteInput.mod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeAutocompleteInput.mod.AutocompleteProps[T]])(children: _*)
  }
