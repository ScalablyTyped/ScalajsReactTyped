...
import typingsJapgolly.rjsfCore.rjsfCoreStrings.schemaUtils
import typingsJapgolly.rjsfCore.rjsfCoreStrings.submitted
import typingsJapgolly.rjsfUtils.mod.CustomValidator
import typingsJapgolly.rjsfUtils.mod.ErrorSchema
import typingsJapgolly.rjsfUtils.mod.ErrorTransformer
import typingsJapgolly.rjsfUtils.mod.FormValidation
import typingsJapgolly.rjsfUtils.mod.IdSchema
import typingsJapgolly.rjsfUtils.mod.PathSchema
import typingsJapgolly.rjsfUtils.mod.RJSFSchema
import typingsJapgolly.rjsfUtils.mod.RJSFValidationError
import typingsJapgolly.rjsfUtils.mod.Registry
import typingsJapgolly.rjsfUtils.mod.RegistryFieldsType
import typingsJapgolly.rjsfUtils.mod.RegistryWidgetsType
import typingsJapgolly.rjsfUtils.mod.SchemaUtilsType
import typingsJapgolly.rjsfUtils.mod.TemplatesType
import typingsJapgolly.rjsfUtils.mod.UiSchema
import typingsJapgolly.rjsfUtils.mod.ValidationData
...
object mod {
  ...
  trait Form[T, F] extends Component[FormProps[T, F], FormState[T, F], Any] {
    ...
    /** The ref used to hold the `form` element, this needs to be `any` because `tagName` or `_internalFormWrapper` can
      ...
      */
    var formElement: RefHandle[Any] = js.native
    ...
    /** Callback function to handle when the form is submitted. First, it prevents the default event behavior. Nothing
      ...
      */
    def onSubmit(event: ReactEventFrom[Any & Element]): Unit = js.native
    
    /** Renders any errors contained in the `state` in using the `ErrorList`, if not disabled by `showErrorList`. */
    def renderErrors(registry: Registry[T, F]): typingsJapgolly.react.mod.global.JSX.Element | Null = js.native
  ...
  trait FormProps[T, F] extends StObject {
    ...
    /**
      ...
      */
    var _internalFormWrapper: js.UndefOr[ElementType] = js.undefined
    ...
    var onSubmit: js.UndefOr[
        js.Function2[/* data */ IChangeEvent[T, F], /* event */ ReactEventFrom[Any & Element], Unit]
      ] = js.undefined
    ...
    var templates: js.UndefOr[
        (Partial[Omit[TemplatesType[T, F], ButtonTemplates]]) & (typingsJapgolly.rjsfCore.anon.ButtonTemplates[T, F])
      ] = js.undefined
  ...
  object FormProps {
    ...
    extension [Self <: FormProps[?, ?], T, F](x: Self & (FormProps[T, F])) {
      ...
      inline def setOnBlur(value: (/* id */ String, /* data */ Any) => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction2((t0: /* id */ String, t1: /* data */ Any) => (value(t0, t1)).runNow()))
      
      inline def setOnBlurUndefined: Self = StObject.set(x, "onBlur", js.undefined)
      
      inline def setOnChange(value: (/* data */ IChangeEvent[T, F], /* id */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* data */ IChangeEvent[T, F], t1: /* id */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnError(value: /* errors */ js.Array[RJSFValidationError] => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* errors */ js.Array[RJSFValidationError]) => value(t0).runNow()))
      
      inline def setOnErrorUndefined: Self = StObject.set(x, "onError", js.undefined)
      
      inline def setOnFocus(value: (/* id */ String, /* data */ Any) => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction2((t0: /* id */ String, t1: /* data */ Any) => (value(t0, t1)).runNow()))
      
      inline def setOnFocusUndefined: Self = StObject.set(x, "onFocus", js.undefined)
      
      inline def setOnSubmit(value: (/* data */ IChangeEvent[T, F], /* event */ ReactEventFrom[Any & Element]) => Callback): Self = StObject.set(x, "onSubmit", js.Any.fromFunction2((t0: /* data */ IChangeEvent[T, F], t1: /* event */ ReactEventFrom[Any & Element]) => (value(t0, t1)).runNow()))
      ...
      inline def set_internalFormWrapper(value: ElementType): Self = StObject.set(x, "_internalFormWrapper", value.asInstanceOf[js.Any])
