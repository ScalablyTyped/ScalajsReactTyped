...
object utilsAjaxMod {
  ...
  object AjaxOptions {
    ...
    extension [Self <: AjaxOptions](x: Self) {
      ...
      inline def setBeforeSend(value: (/* xhr */ XMLHttpRequest, AjaxOptions) => Callback): Self = StObject.set(x, "beforeSend", js.Any.fromFunction2((t0: /* xhr */ XMLHttpRequest, t1: AjaxOptions) => (value(t0, t1)).runNow()))
      
      inline def setBeforeSendUndefined: Self = StObject.set(x, "beforeSend", js.undefined)
      
      inline def setComplete(value: (/* xhr */ XMLHttpRequest, /* statusText */ String) => Callback): Self = StObject.set(x, "complete", js.Any.fromFunction2((t0: /* xhr */ XMLHttpRequest, t1: /* statusText */ String) => (value(t0, t1)).runNow()))
      ...
      inline def setError(value: (/* response */ Any, /* statusText */ String, /* xhr */ XMLHttpRequest) => Callback): Self = StObject.set(x, "error", js.Any.fromFunction3((t0: /* response */ Any, t1: /* statusText */ String, t2: /* xhr */ XMLHttpRequest) => (value(t0, t1, t2)).runNow()))
      
      inline def setErrorUndefined: Self = StObject.set(x, "error", js.undefined)
      
      inline def setSuccess(value: (/* response */ Any, /* statusText */ String, /* xhr */ XMLHttpRequest) => Callback): Self = StObject.set(x, "success", js.Any.fromFunction3((t0: /* response */ Any, t1: /* statusText */ String, t2: /* xhr */ XMLHttpRequest) => (value(t0, t1, t2)).runNow()))
