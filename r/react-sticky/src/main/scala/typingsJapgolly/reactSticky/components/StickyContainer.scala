...
object StickyContainer {
  def apply(
    ...
    typingsJapgolly.reactSticky.mod.StickyContainer, 
    Unit, 
    HTMLAttributes[HTMLDivElement]
  ] = {
  ...
  typingsJapgolly.reactSticky.mod.StickyContainer](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement]])(children: _*)
  }
