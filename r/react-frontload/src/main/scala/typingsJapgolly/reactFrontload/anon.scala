...
import typingsJapgolly.reactFrontload.mod.FrontloadData
import typingsJapgolly.reactFrontload.mod.FrontloadServerRenderFunction
...
object anon {
  ...
  trait Children extends StObject {
    ...
    var initialState: typingsJapgolly.reactFrontload.mod.FrontloadState
  }
  object Children {
    
    inline def apply(children: Any, initialState: typingsJapgolly.reactFrontload.mod.FrontloadState): Children = {
    ...
    extension [Self <: Children](x: Self) {
      ...
      inline def setInitialState(value: typingsJapgolly.reactFrontload.mod.FrontloadState): Self = StObject.set(x, "initialState", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait FrontloadState[T] extends StObject {
    ...
    var frontloadState: typingsJapgolly.reactFrontload.mod.FrontloadState
  ...
  object FrontloadState {
    ...
    inline def apply[T](
      frontloadState: typingsJapgolly.reactFrontload.mod.FrontloadState,
      render: /* args */ IsFinalRender => T
    ): FrontloadState[T] = {
    ...
    extension [Self <: FrontloadState[?], T](x: Self & FrontloadState[T]) {
      ...
      inline def setFrontloadState(value: typingsJapgolly.reactFrontload.mod.FrontloadState): Self = StObject.set(x, "frontloadState", value.asInstanceOf[js.Any])
