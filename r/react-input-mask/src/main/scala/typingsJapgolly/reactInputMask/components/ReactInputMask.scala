package typingsJapgolly.reactInputMask.components
...
import typingsJapgolly.reactInputMask.mod.InputState
import typingsJapgolly.reactInputMask.mod.MaskOptions
import typingsJapgolly.reactInputMask.mod.Props
import typingsJapgolly.reactInputMask.mod.default
...
object ReactInputMask {
  def apply(
    ...
    beforeMaskedValueChange: (/* newState */ InputState, /* oldState */ InputState, /* userInput */ String, /* maskOptions */ MaskOptions) => CallbackTo[InputState] = null,
    ...
    if (beforeMaskedValueChange != null) __obj.updateDynamic("beforeMaskedValueChange")(js.Any.fromFunction4((t0: /* newState */ typingsJapgolly.reactInputMask.mod.InputState, t1: /* oldState */ typingsJapgolly.reactInputMask.mod.InputState, t2: /* userInput */ java.lang.String, t3: /* maskOptions */ typingsJapgolly.reactInputMask.mod.MaskOptions) => beforeMaskedValueChange(t0, t1, t2, t3).runNow()))
  ...
  typingsJapgolly.reactInputMask.mod.Props, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactInputMask.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactInputMask.mod.Props])(children: _*)
  }
