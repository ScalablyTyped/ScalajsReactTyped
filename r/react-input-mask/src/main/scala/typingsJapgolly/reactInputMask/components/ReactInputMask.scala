...
import typingsJapgolly.reactInputMask.mod.BeforeMaskedStateChangeStates
...
object ReactInputMask {
  ...
  inline def apply(mask: String | (js.Array[String | js.RegExp])): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def alwaysShowMask(value: Boolean): this.type = set("alwaysShowMask", value.asInstanceOf[js.Any])
    ...
    inline def beforeMaskedStateChange(value: /* states */ BeforeMaskedStateChangeStates => InputState): this.type = set("beforeMaskedStateChange", js.Any.fromFunction1(value))
    ...
    inline def maskPlaceholder(value: String): this.type = set("maskPlaceholder", value.asInstanceOf[js.Any])
    
    inline def maskPlaceholderNull: this.type = set("maskPlaceholder", null)
