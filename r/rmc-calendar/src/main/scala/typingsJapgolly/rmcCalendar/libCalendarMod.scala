...
import typingsJapgolly.rmcCalendar.anon.EndDate
import typingsJapgolly.rmcCalendar.anon.ReadonlychildrenReactNode
...
object libCalendarMod {
  ...
  type ExtraData = typingsJapgolly.rmcCalendar.libDateDataTypesMod.Models.ExtraData
}
