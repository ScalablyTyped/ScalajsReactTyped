...
object libCalendarPropsMod {
  ...
  trait PropsType extends StObject {
    ...
    /** 替换标题栏 */
    var renderHeader: js.UndefOr[js.Function1[/* prop */ this.type, Node]] = js.undefined
  ...
  object PropsType {
    ...
    extension [Self <: PropsType](x: Self) {
      ...
      inline def setRenderHeader(value: PropsType => Node): Self = StObject.set(x, "renderHeader", js.Any.fromFunction1(value))
