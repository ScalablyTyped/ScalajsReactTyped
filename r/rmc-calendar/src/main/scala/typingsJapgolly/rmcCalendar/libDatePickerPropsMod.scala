...
object libDatePickerPropsMod {
  ...
  object PropsType {
    ...
    extension [Self <: PropsType](x: Self) {
      ...
      inline def setOnCellClick(value: /* date */ js.Date => Callback): Self = StObject.set(x, "onCellClick", js.Any.fromFunction1((t0: /* date */ js.Date) => value(t0).runNow()))
      
      inline def setOnCellClickUndefined: Self = StObject.set(x, "onCellClick", js.undefined)
      
      inline def setOnLayout(value: /* clientHight */ Double => Callback): Self = StObject.set(x, "onLayout", js.Any.fromFunction1((t0: /* clientHight */ Double) => value(t0).runNow()))
