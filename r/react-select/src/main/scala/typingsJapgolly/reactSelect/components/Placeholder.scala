...
import typingsJapgolly.reactSelect.componentsPlaceholderMod.default
...
object Placeholder {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PlaceholderProps[js.Any], default, Unit, PlaceholderProps[js.Any]] = {
  ...
  typingsJapgolly.reactSelect.componentsPlaceholderMod.PlaceholderProps[js.Any], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSelect.componentsPlaceholderMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSelect.componentsPlaceholderMod.PlaceholderProps[js.Any]])(children: _*)
  }
