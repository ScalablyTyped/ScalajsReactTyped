...
object CrossIcon {
  ...
  implicit def make(companion: CrossIcon.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CrossIconProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
