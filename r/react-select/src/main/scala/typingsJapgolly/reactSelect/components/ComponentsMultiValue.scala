...
object ComponentsMultiValue {
  def apply(
    ...
    MultiValueProps[js.Any], 
    MountedWithRawType[MultiValueProps[js.Any], js.Object, RawMounted[MultiValueProps[js.Any], js.Object]]
  ] = {
  ...
  typingsJapgolly.reactSelect.componentsMultiValueMod.MultiValueProps[js.Any], 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSelect.componentsMultiValueMod.MultiValueProps[js.Any]])(children: _*)
  }
