...
import typingsJapgolly.reactSelect.anon.InnerRef
...
object DummyInput {
  ...
  @JSImport("react-select/dist/declarations/src/internal", "DummyInput")
  @js.native
  ...
  implicit def make(companion: DummyInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: (DetailedHTMLProps[InputHTMLAttributes[HTMLInputElement], HTMLInputElement]) & InnerRef): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
