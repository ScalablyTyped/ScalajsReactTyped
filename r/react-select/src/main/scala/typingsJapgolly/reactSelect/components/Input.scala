...
import typingsJapgolly.reactSelect.distDeclarationsSrcComponentsInputMod.InputSpecificProps
...
object Input {
  ...
  inline def apply[Option_7, IsMulti_7 /* <: Boolean */, Group_7 /* <: GroupBase[Option_7] */](
    clearValue: Callback,
    ...
    getValue: CallbackTo[Options[Option_7]],
    hasValue: Boolean,
    isHidden: Boolean,
    isMulti: Boolean,
    isRtl: Boolean,
    options: OptionsOrGroups[Option_7, Group_7],
    selectOption: Option_7 => Callback,
    selectProps: Props[Option_7, IsMulti_7, Group_7],
    setValue: (OnChangeValue[Option_7, IsMulti_7], SetValueAction, js.UndefOr[Option_7]) => Callback,
    theme: Theme
  ): Builder[Option_7, IsMulti_7, Group_7] = {
    val __props = js.Dynamic.literal(clearValue = clearValue.toJsFn, cx = js.Any.fromFunction2(cx), getStyles = js.Any.fromFunction2(getStyles), getValue = getValue.toJsFn, hasValue = hasValue.asInstanceOf[js.Any], isHidden = isHidden.asInstanceOf[js.Any], isMulti = isMulti.asInstanceOf[js.Any], isRtl = isRtl.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], selectOption = js.Any.fromFunction1((t0: Option_7) => selectOption(t0).runNow()), selectProps = selectProps.asInstanceOf[js.Any], setValue = js.Any.fromFunction3((t0: OnChangeValue[Option_7, IsMulti_7], t1: SetValueAction, t2: js.UndefOr[Option_7]) => (setValue(t0, t1, t2)).runNow()), theme = theme.asInstanceOf[js.Any])
    new Builder[Option_7, IsMulti_7, Group_7](js.Array(this.component, __props.asInstanceOf[InputSpecificProps[Option_7, IsMulti_7, Group_7]]))
  }
  ...
  @scala.inline
  open class Builder[Option_7, IsMulti_7 /* <: Boolean */, Group_7 /* <: GroupBase[Option_7] */] (val args: js.Array[Any])
    extends AnyVal
    ...
    inline def innerRef(value: /* instance */ HTMLInputElement | Null => Callback): this.type = set("innerRef", js.Any.fromFunction1((t0: /* instance */ HTMLInputElement | Null) => value(t0).runNow()))
  ...
  def withProps[Option_7, IsMulti_7 /* <: Boolean */, Group_7 /* <: GroupBase[Option_7] */](p: InputSpecificProps[Option_7, IsMulti_7, Group_7]): Builder[Option_7, IsMulti_7, Group_7] = new Builder[Option_7, IsMulti_7, Group_7](js.Array(this.component, p.asInstanceOf[js.Any]))
}
