...
import typingsJapgolly.reactSelect.asyncMod.default
...
object Async {
  ...
  typingsJapgolly.reactSelect.srcAsyncMod.Props[OptionType], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSelect.asyncMod.default[OptionType]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSelect.srcAsyncMod.Props[OptionType]])(children: _*)
  }
