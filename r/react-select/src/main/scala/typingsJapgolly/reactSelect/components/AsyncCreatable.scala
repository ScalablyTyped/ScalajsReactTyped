...
import typingsJapgolly.reactSelect.asyncCreatableMod.default
...
object AsyncCreatable {
  def apply[OptionType /* <: OptionTypeBase */](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[Props[OptionType], default[OptionType], Unit, Props[OptionType]] = {
  ...
  typingsJapgolly.reactSelect.srcAsyncCreatableMod.Props[OptionType], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSelect.asyncCreatableMod.default[OptionType]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSelect.srcAsyncCreatableMod.Props[OptionType]])(children: _*)
  }
