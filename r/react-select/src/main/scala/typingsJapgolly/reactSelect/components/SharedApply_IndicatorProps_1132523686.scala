...
import typingsJapgolly.reactSelect.indicatorsMod.IndicatorProps
...
abstract class SharedApply_IndicatorProps_1132523686[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IndicatorProps[js.Any], ComponentRef, Unit, IndicatorProps[js.Any]] = {
    val __obj = js.Dynamic.literal(hasValue = hasValue.asInstanceOf[js.Any], innerProps = innerProps.asInstanceOf[js.Any], isFocused = isFocused.asInstanceOf[js.Any], isMulti = isMulti.asInstanceOf[js.Any], isRtl = isRtl.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], selectProps = selectProps.asInstanceOf[js.Any])
  ...
  typingsJapgolly.reactSelect.indicatorsMod.IndicatorProps[js.Any], 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSelect.indicatorsMod.IndicatorProps[js.Any]])(children: _*)
  }
}
