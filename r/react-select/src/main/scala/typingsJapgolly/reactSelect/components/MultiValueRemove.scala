...
import typingsJapgolly.reactSelect.distDeclarationsSrcComponentsMultiValueMod.MultiValueRemoveProps
...
object MultiValueRemove {
  ...
  inline def apply[Option, IsMulti /* <: Boolean */, Group /* <: GroupBase[Option] */](
    ...
    new Builder[Option, IsMulti, Group](js.Array(this.component, __props.asInstanceOf[MultiValueRemoveProps[Option, IsMulti, Group]]))
  }
  ...
  def withProps[Option, IsMulti /* <: Boolean */, Group /* <: GroupBase[Option] */](p: MultiValueRemoveProps[Option, IsMulti, Group]): Builder[Option, IsMulti, Group] = new Builder[Option, IsMulti, Group](js.Array(this.component, p.asInstanceOf[js.Any]))
}
