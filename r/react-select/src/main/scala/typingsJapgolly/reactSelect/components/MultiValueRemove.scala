...
import typingsJapgolly.reactSelect.AnonOnTouchEnd
import typingsJapgolly.reactSelect.componentsMultiValueMod.MultiValueRemoveProps
...
object MultiValueRemove {
  def apply[OptionType /* <: OptionTypeBase */](
    ...
    typingsJapgolly.reactSelect.componentsMultiValueMod.MultiValueRemove[OptionType], 
    Unit, 
    MultiValueRemoveProps[OptionType]
  ] = {
    val __obj = js.Dynamic.literal(hasValue = hasValue.asInstanceOf[js.Any], innerProps = innerProps.asInstanceOf[js.Any], isMulti = isMulti.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], selectProps = selectProps.asInstanceOf[js.Any])
  ...
  typingsJapgolly.reactSelect.componentsMultiValueMod.MultiValueRemoveProps[OptionType], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSelect.componentsMultiValueMod.MultiValueRemove[OptionType]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSelect.componentsMultiValueMod.MultiValueRemoveProps[OptionType]])(children: _*)
  }
