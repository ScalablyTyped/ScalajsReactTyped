...
object StateManager {
  ...
  implicit def make(companion: StateManager.type): SharedBuilder_StateManagerPropsRefAttributes_349678716[default[Any, `false`, GroupBase[Any]]] = new SharedBuilder_StateManagerPropsRefAttributes_349678716[default[Any, `false`, GroupBase[Any]]](js.Array(this.component, js.Dictionary.empty))()
