...
import typingsJapgolly.reactSelect.componentsSingleValueMod.default
...
object SingleValue {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SingleValueProps[js.Any], default, Unit, SingleValueProps[js.Any]] = {
  ...
  typingsJapgolly.reactSelect.componentsSingleValueMod.default](this.componentImport)
