...
import typingsJapgolly.reactSelect.selectMod.default
import typingsJapgolly.reactSelect.stateManagerMod.StateProps
...
abstract class `SharedApply_<intersection>_1319172604`[ComponentRef] () {
  val componentImport: js.Any
  def apply[OptionType /* <: OptionTypeBase */, T /* <: default[OptionType] */](
    ...
    StateProps[Props[OptionType]] with typingsJapgolly.reactSelect.stateManagerMod.Props[OptionType] with Props[OptionType], 
    ComponentRef, 
    Unit, 
    StateProps[Props[OptionType]] with typingsJapgolly.reactSelect.stateManagerMod.Props[OptionType] with Props[OptionType]
  ] = {
  ...
  typingsJapgolly.reactSelect.stateManagerMod.StateProps[typingsJapgolly.reactSelect.selectMod.Props[OptionType]] with typingsJapgolly.reactSelect.stateManagerMod.Props[OptionType] with typingsJapgolly.reactSelect.selectMod.Props[OptionType], 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSelect.stateManagerMod.StateProps[typingsJapgolly.reactSelect.selectMod.Props[OptionType]] with typingsJapgolly.reactSelect.stateManagerMod.Props[OptionType] with typingsJapgolly.reactSelect.selectMod.Props[OptionType]])(children: _*)
  }
}
