...
abstract class SharedApply_NoticeProps_378999398[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[NoticeProps[js.Any], ComponentRef, Unit, NoticeProps[js.Any]] = {
  ...
  typingsJapgolly.reactSelect.menuMod.NoticeProps[js.Any], 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSelect.menuMod.NoticeProps[js.Any]])(children: _*)
  }
}
