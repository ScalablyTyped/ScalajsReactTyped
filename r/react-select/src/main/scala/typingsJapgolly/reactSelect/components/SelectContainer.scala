...
import typingsJapgolly.reactSelect.AnonOnKeyDown
...
object SelectContainer {
  def apply(
    ...
    typingsJapgolly.reactSelect.containersMod.SelectContainer, 
    Unit, 
    ContainerProps[js.Any]
  ] = {
    val __obj = js.Dynamic.literal(hasValue = hasValue.asInstanceOf[js.Any], innerProps = innerProps.asInstanceOf[js.Any], isDisabled = isDisabled.asInstanceOf[js.Any], isMulti = isMulti.asInstanceOf[js.Any], isRtl = isRtl.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], selectProps = selectProps.asInstanceOf[js.Any])
  ...
  typingsJapgolly.reactSelect.containersMod.ContainerProps[js.Any], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSelect.containersMod.SelectContainer](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSelect.containersMod.ContainerProps[js.Any]])(children: _*)
  }
