...
import typingsJapgolly.reactSelect.controlMod.default
...
object Control {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ControlProps[js.Any], default, Unit, ControlProps[js.Any]] = {
    val __obj = js.Dynamic.literal(hasValue = hasValue.asInstanceOf[js.Any], innerProps = innerProps.asInstanceOf[js.Any], isDisabled = isDisabled.asInstanceOf[js.Any], isFocused = isFocused.asInstanceOf[js.Any], isMulti = isMulti.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], selectProps = selectProps.asInstanceOf[js.Any])
  ...
  typingsJapgolly.reactSelect.controlMod.ControlProps[js.Any], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSelect.controlMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSelect.controlMod.ControlProps[js.Any]])(children: _*)
  }
