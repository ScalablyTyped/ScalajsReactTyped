...
object ComponentsValueContainer {
  def apply(
    hasValue: Boolean,
    isMulti: Boolean,
    ...
    MountedWithRawType[
      ValueContainerProps[js.Any], 
      js.Object, 
      RawMounted[ValueContainerProps[js.Any], js.Object]
    ]
  ] = {
    val __obj = js.Dynamic.literal(hasValue = hasValue.asInstanceOf[js.Any], isMulti = isMulti.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], selectProps = selectProps.asInstanceOf[js.Any])
  ...
  typingsJapgolly.reactSelect.containersMod.ValueContainerProps[js.Any], 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSelect.containersMod.ValueContainerProps[js.Any]])(children: _*)
  }
