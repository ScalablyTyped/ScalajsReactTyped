...
object NoOptionsMessage {
  ...
  inline def apply[Option_13, IsMulti_13 /* <: Boolean */, Group_13 /* <: GroupBase[Option_13] */](
    clearValue: Callback,
    ...
    getValue: CallbackTo[Options[Option_13]],
    hasValue: Boolean,
    innerProps: DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement],
    isMulti: Boolean,
    isRtl: Boolean,
    options: OptionsOrGroups[Option_13, Group_13],
    selectOption: Option_13 => Callback,
    selectProps: Props[Option_13, IsMulti_13, Group_13],
    setValue: (OnChangeValue[Option_13, IsMulti_13], SetValueAction, js.UndefOr[Option_13]) => Callback,
    theme: Theme
  ): Builder[Option_13, IsMulti_13, Group_13] = {
    val __props = js.Dynamic.literal(clearValue = clearValue.toJsFn, cx = js.Any.fromFunction2(cx), getStyles = js.Any.fromFunction2(getStyles), getValue = getValue.toJsFn, hasValue = hasValue.asInstanceOf[js.Any], innerProps = innerProps.asInstanceOf[js.Any], isMulti = isMulti.asInstanceOf[js.Any], isRtl = isRtl.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], selectOption = js.Any.fromFunction1((t0: Option_13) => selectOption(t0).runNow()), selectProps = selectProps.asInstanceOf[js.Any], setValue = js.Any.fromFunction3((t0: OnChangeValue[Option_13, IsMulti_13], t1: SetValueAction, t2: js.UndefOr[Option_13]) => (setValue(t0, t1, t2)).runNow()), theme = theme.asInstanceOf[js.Any])
    new Builder[Option_13, IsMulti_13, Group_13](js.Array(this.component, __props.asInstanceOf[NoticeProps[Option_13, IsMulti_13, Group_13]]))
  }
  ...
  @scala.inline
  open class Builder[Option_13, IsMulti_13 /* <: Boolean */, Group_13 /* <: GroupBase[Option_13] */] (val args: js.Array[Any])
    extends AnyVal
  ...
  def withProps[Option_13, IsMulti_13 /* <: Boolean */, Group_13 /* <: GroupBase[Option_13] */](p: NoticeProps[Option_13, IsMulti_13, Group_13]): Builder[Option_13, IsMulti_13, Group_13] = new Builder[Option_13, IsMulti_13, Group_13](js.Array(this.component, p.asInstanceOf[js.Any]))
}
