...
object ComponentsSingleValue {
  def apply(
    ...
    MountedWithRawType[SingleValueProps[js.Any], js.Object, RawMounted[SingleValueProps[js.Any], js.Object]]
  ] = {
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], hasValue = hasValue.asInstanceOf[js.Any], innerProps = innerProps.asInstanceOf[js.Any], isDisabled = isDisabled.asInstanceOf[js.Any], isMulti = isMulti.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], selectProps = selectProps.asInstanceOf[js.Any])
  ...
  typingsJapgolly.reactSelect.componentsSingleValueMod.SingleValueProps[js.Any], 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSelect.componentsSingleValueMod.SingleValueProps[js.Any]])(children: _*)
  }
