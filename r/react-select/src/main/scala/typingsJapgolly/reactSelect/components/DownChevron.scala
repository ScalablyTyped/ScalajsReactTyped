...
object DownChevron {
  ...
  implicit def make(companion: DownChevron.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DownChevronProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
