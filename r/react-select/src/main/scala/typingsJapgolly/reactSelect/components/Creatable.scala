...
import typingsJapgolly.reactSelect.distDeclarationsSrcCreatableMod.CreatableProps
...
object Creatable {
  ...
  implicit def make(companion: Creatable.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(
    p: /* props */ (CreatableProps[Any, `false`, GroupBase[Any]]) & (RefAttributes[default[Any, `false`, GroupBase[Any]]])
