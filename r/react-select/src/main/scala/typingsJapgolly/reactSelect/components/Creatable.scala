...
import typingsJapgolly.reactSelect.creatableMod.default
...
object Creatable {
  ...
  typingsJapgolly.reactSelect.srcCreatableMod.Props[OptionType], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactSelect.creatableMod.default[OptionType]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactSelect.srcCreatableMod.Props[OptionType]])(children: _*)
  }
