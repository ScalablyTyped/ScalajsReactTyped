...
object Arialive {
  ...
  inline def apply(
    ...
    loadingMessage: CallbackTo[String],
    ...
    noOptionsMessage: CallbackTo[String],
  ...
  extension [Self <: Arialive](x: Self) {
    ...
    inline def setLoadingMessage(value: CallbackTo[String]): Self = StObject.set(x, "loadingMessage", value.toJsFn)
    ...
    inline def setNoOptionsMessage(value: CallbackTo[String]): Self = StObject.set(x, "noOptionsMessage", value.toJsFn)
