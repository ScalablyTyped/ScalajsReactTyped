...
trait AriaSelection extends StObject {
  ...
  var ariaSelection: (typingsJapgolly.reactSelect.distDeclarationsSrcAccessibilityMod.AriaSelection[Any, Boolean]) | Null
...
object AriaSelection {
  ...
  extension [Self <: AriaSelection](x: Self) {
    ...
    inline def setAriaSelection(value: typingsJapgolly.reactSelect.distDeclarationsSrcAccessibilityMod.AriaSelection[Any, Boolean]): Self = StObject.set(x, "ariaSelection", value.asInstanceOf[js.Any])
