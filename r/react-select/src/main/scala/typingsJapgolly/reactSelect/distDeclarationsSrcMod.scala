...
object distDeclarationsSrcMod {
  ...
  open class NonceProvider protected ()
    extends typingsJapgolly.reactSelect.distDeclarationsSrcNonceProviderMod.default {
  ...
  type SelectInstance[Option, IsMulti /* <: Boolean */, Group /* <: GroupBase[Option] */] = typingsJapgolly.reactSelect.distDeclarationsSrcSelectMod.default[Option, IsMulti, Group]
}
