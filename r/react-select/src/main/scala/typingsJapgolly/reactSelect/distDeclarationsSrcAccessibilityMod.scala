...
import typingsJapgolly.reactSelect.anon.IsDisabled
...
import typingsJapgolly.reactSelect.distDeclarationsSrcTypesMod.InitialInputFocusedActionMeta
...
object distDeclarationsSrcAccessibilityMod {
  ...
  type AriaSelection[Option, IsMulti /* <: Boolean */] = (InitialInputFocusedActionMeta[Option, IsMulti]) | (ActionMeta[Option] & (typingsJapgolly.reactSelect.anon.Options[Option, IsMulti]))
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactSelect.reactSelectStrings.menu
    - typingsJapgolly.reactSelect.reactSelectStrings.input
    - typingsJapgolly.reactSelect.reactSelectStrings.value
  */
  trait GuidanceContext extends StObject
  object GuidanceContext {
    
    inline def input: typingsJapgolly.reactSelect.reactSelectStrings.input = "input".asInstanceOf[typingsJapgolly.reactSelect.reactSelectStrings.input]
