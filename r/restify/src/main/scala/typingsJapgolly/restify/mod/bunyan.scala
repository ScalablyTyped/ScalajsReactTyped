...
import typingsJapgolly.bunyan.mod.Serializer
...
object bunyan {
  ...
  inline def createLogger(name: String): typingsJapgolly.bunyan.mod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("createLogger")(name.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bunyan.mod.^]
  ...
  trait RequestCaptureOptions extends StObject {
    ...
    var stream: js.UndefOr[typingsJapgolly.bunyan.mod.Stream] = js.undefined
    
    /** The streams to which to write when dumping captured records. */
    var streams: js.UndefOr[js.Array[typingsJapgolly.bunyan.mod.Stream]] = js.undefined
  }
  object RequestCaptureOptions {
    ...
    extension [Self <: RequestCaptureOptions](x: Self) {
      ...
      inline def setStream(value: typingsJapgolly.bunyan.mod.Stream): Self = StObject.set(x, "stream", value.asInstanceOf[js.Any])
      
      inline def setStreamUndefined: Self = StObject.set(x, "stream", js.undefined)
      
      inline def setStreams(value: js.Array[typingsJapgolly.bunyan.mod.Stream]): Self = StObject.set(x, "streams", value.asInstanceOf[js.Any])
      
      inline def setStreamsUndefined: Self = StObject.set(x, "streams", js.undefined)
      
      inline def setStreamsVarargs(value: typingsJapgolly.bunyan.mod.Stream*): Self = StObject.set(x, "streams", js.Array(value*))
    }
  }
}
