...
object RouterRegistryRadix {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(add = js.Any.fromFunction1(add), get = get.toJsFn, lookup = js.Any.fromFunction2(lookup), remove = js.Any.fromFunction1(remove))
  ...
  extension [Self <: RouterRegistryRadix](x: Self) {
    ...
    inline def setGet(value: CallbackTo[js.Array[Route]]): Self = StObject.set(x, "get", value.toJsFn)
