...
import typingsJapgolly.restify.anon.MaxBodySize
import typingsJapgolly.restify.anon.Server
...
import typingsJapgolly.restify.mod.Route
import typingsJapgolly.restify.mod.plugins.^
