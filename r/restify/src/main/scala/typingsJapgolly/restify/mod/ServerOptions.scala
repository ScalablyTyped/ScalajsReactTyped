...
trait ServerOptions extends StObject {
  ...
  var httpsServerOptions: js.UndefOr[
    typingsJapgolly.node.httpsMod.ServerOptions[
  ...
  var spdy: js.UndefOr[typingsJapgolly.spdy.mod.ServerOptions] = js.undefined
...
object ServerOptions {
  ...
  extension [Self <: ServerOptions](x: Self) {
    ...
    inline def setHttpsServerOptions(
      value: typingsJapgolly.node.httpsMod.ServerOptions[
          Instantiable1[/* socket */ Socket, IncomingMessage], 
          Instantiable1[
            /* import warning: RewrittenClass.unapply cls was tparam Request */ /* req */ Any, 
            ServerResponse[typingsJapgolly.node.httpMod.IncomingMessage]
    ...
    inline def setSpdy(value: typingsJapgolly.spdy.mod.ServerOptions): Self = StObject.set(x, "spdy", value.asInstanceOf[js.Any])
