...
trait ServerOptions extends js.Object {
  ...
  var httpsServerOptions: js.UndefOr[typingsJapgolly.node.httpsMod.ServerOptions] = js.undefined
...
object ServerOptions {
  ...
  def apply(
    ...
    http2: js.Any = null,
    httpsServerOptions: typingsJapgolly.node.httpsMod.ServerOptions = null,
    ...
    spdy: typingsJapgolly.spdy.mod.ServerOptions = null,
