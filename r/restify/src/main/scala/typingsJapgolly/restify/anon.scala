...
object anon {
  ...
  trait Server extends StObject {
    ...
    var server: typingsJapgolly.restify.mod.Server
  }
  object Server {
    
    inline def apply(server: typingsJapgolly.restify.mod.Server): Server = {
    ...
    extension [Self <: Server](x: Self) {
      ...
      inline def setServer(value: typingsJapgolly.restify.mod.Server): Self = StObject.set(x, "server", value.asInstanceOf[js.Any])
    }
  }
