package typingsJapgolly.reactStarRatings
...
object mod {
  ...
  object StarRatingProps {
    ...
    extension [Self <: StarRatingProps](x: Self) {
      ...
      inline def setChangeRating(value: /* rating */ Double => Callback): Self = StObject.set(x, "changeRating", js.Any.fromFunction1((t0: /* rating */ Double) => value(t0).runNow()))
  ...
  type StarRatings = japgolly.scalajs.react.facade.React.Component[StarRatingProps & js.Object, js.Object]
}
