...
import typingsJapgolly.reactBootstrapTable2Filter.anon.ComparatorNumber
import typingsJapgolly.reactBootstrapTable2Filter.anon.Label
import typingsJapgolly.reactBootstrapTable2Filter.anon.Number
import typingsJapgolly.reactBootstrapTable2Filter.anon.PartialMultiSelectFilterP
import typingsJapgolly.reactBootstrapTable2Filter.anon.PartialNumberFilterPropsa
import typingsJapgolly.reactBootstrapTable2Filter.anon.PartialSelectFilterPropsa
import typingsJapgolly.reactBootstrapTable2Filter.anon.PartialTextFilterPropsany
import typingsJapgolly.reactBootstrapTableNext.mod.ColumnDescription
import typingsJapgolly.reactBootstrapTableNext.mod.TableColumnFilterProps
...
object mod {
  ...
  object Comparator extends StObject {
    ...
    sealed trait EQ
      extends StObject
         with Comparator
    /* "=" */ val EQ: typingsJapgolly.reactBootstrapTable2Filter.mod.Comparator.EQ & String = js.native
    
    @js.native
    sealed trait GE
      extends StObject
         with Comparator
    /* ">=" */ val GE: typingsJapgolly.reactBootstrapTable2Filter.mod.Comparator.GE & String = js.native
    
    @js.native
    sealed trait GT
      extends StObject
         with Comparator
    /* ">" */ val GT: typingsJapgolly.reactBootstrapTable2Filter.mod.Comparator.GT & String = js.native
    
    @js.native
    sealed trait LE
      extends StObject
         with Comparator
    /* "<=" */ val LE: typingsJapgolly.reactBootstrapTable2Filter.mod.Comparator.LE & String = js.native
    
    @js.native
    sealed trait LIKE
      extends StObject
         with Comparator
    /* "LIKE" */ val LIKE: typingsJapgolly.reactBootstrapTable2Filter.mod.Comparator.LIKE & String = js.native
    
    @js.native
    sealed trait LT
      extends StObject
         with Comparator
    /* "<" */ val LT: typingsJapgolly.reactBootstrapTable2Filter.mod.Comparator.LT & String = js.native
    
    @js.native
    sealed trait NE
      extends StObject
         with Comparator
    /* "!=" */ val NE: typingsJapgolly.reactBootstrapTable2Filter.mod.Comparator.NE & String = js.native
  }
  ...
  object FILTER_TYPES extends StObject {
    ...
    sealed trait DATE
      extends StObject
         with FILTER_TYPES
    /* "DATE" */ val DATE: typingsJapgolly.reactBootstrapTable2Filter.mod.FILTER_TYPES.DATE & String = js.native
    
    @js.native
    sealed trait MULTISELECT
      extends StObject
         with FILTER_TYPES
    /* "MULTISELECT" */ val MULTISELECT: typingsJapgolly.reactBootstrapTable2Filter.mod.FILTER_TYPES.MULTISELECT & String = js.native
    
    @js.native
    sealed trait NUMBER
      extends StObject
         with FILTER_TYPES
    /* "NUMBER" */ val NUMBER: typingsJapgolly.reactBootstrapTable2Filter.mod.FILTER_TYPES.NUMBER & String = js.native
    
    @js.native
    sealed trait SELECT
      extends StObject
         with FILTER_TYPES
    /* "SELECT" */ val SELECT: typingsJapgolly.reactBootstrapTable2Filter.mod.FILTER_TYPES.SELECT & String = js.native
    
    @js.native
    sealed trait TEXT
      extends StObject
         with FILTER_TYPES
    /* "TEXT" */ val TEXT: typingsJapgolly.reactBootstrapTable2Filter.mod.FILTER_TYPES.TEXT & String = js.native
  }
  ...
  trait DateFilterProps[T /* <: js.Object */]
    ...
    @JSName("defaultValue")
    var defaultValue_DateFilterProps: js.UndefOr[typingsJapgolly.reactBootstrapTable2Filter.anon.Comparator] = js.undefined
  ...
  object DateFilterProps {
    ...
    extension [Self <: DateFilterProps[?], T /* <: js.Object */](x: Self & DateFilterProps[T]) {
      ...
      inline def setDefaultValue(value: typingsJapgolly.reactBootstrapTable2Filter.anon.Comparator): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
  ...
  object FilterFactoryProps {
    ...
    extension [Self <: FilterFactoryProps[?], T /* <: js.Object */](x: Self & FilterFactoryProps[T]) {
      ...
      inline def setAfterFilter(value: (/* newResult */ js.Array[T], /* newFilters */ js.UndefOr[js.Array[Any]]) => Callback): Self = StObject.set(x, "afterFilter", js.Any.fromFunction2((t0: /* newResult */ js.Array[T], t1: /* newFilters */ js.UndefOr[js.Array[Any]]) => (value(t0, t1)).runNow()))
  ...
  object TextFilterProps {
    ...
    extension [Self <: TextFilterProps[?], T /* <: js.Object */](x: Self & TextFilterProps[T]) {
      ...
      inline def setGetFilter(value: /* filter */ js.Function1[/* value */ String, Unit | js.Array[T]] => Callback): Self = StObject.set(x, "getFilter", js.Any.fromFunction1((t0: /* filter */ js.Function1[/* value */ String, Unit | js.Array[T]]) => value(t0).runNow()))
