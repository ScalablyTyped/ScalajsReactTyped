...
import typingsJapgolly.reactAutocomplete.anon.FnCall
import typingsJapgolly.reactAutocomplete.anon.FnCallStartEndDirection
...
object mod {
  ...
  trait Props extends StObject {
    ...
    /**
      ...
      */
    var onChange: js.UndefOr[js.Function2[/* e */ ReactEventFrom[HTMLInputElement], /* value */ String, Unit]] = js.native
    ...
    /**
      ...
      */
    var renderInput: js.UndefOr[js.Function1[/* props */ HTMLProps[HTMLInputElement], Node]] = js.native
    ...
    /**
      ...
      */
    def renderItem(item: Any, isHighlighted: Boolean): Node = js.native
    def renderItem(item: Any, isHighlighted: Boolean, styles: CSSProperties): Node = js.native
    ...
    var renderMenu: js.UndefOr[
        js.Function3[/* items */ js.Array[Node], /* value */ String, /* styles */ CSSProperties, Node]
      ] = js.native
