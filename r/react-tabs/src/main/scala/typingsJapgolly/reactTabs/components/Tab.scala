...
object Tab {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def className(value: String | js.Array[String] | StringDictionary[Boolean]): this.type = set("className", value.asInstanceOf[js.Any])
    ...
    inline def selectedClassName(value: String): this.type = set("selectedClassName", value.asInstanceOf[js.Any])
