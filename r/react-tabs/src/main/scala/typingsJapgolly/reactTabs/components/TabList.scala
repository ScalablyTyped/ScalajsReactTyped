...
object TabList {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TabListProps, typingsJapgolly.reactTabs.mod.TabList, Unit, TabListProps] = {
  ...
  typingsJapgolly.reactTabs.mod.TabListProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactTabs.mod.TabList](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactTabs.mod.TabListProps])(children: _*)
  }
