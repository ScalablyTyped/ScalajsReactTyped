...
object Tabs {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def defaultFocus(value: Boolean): this.type = set("defaultFocus", value.asInstanceOf[js.Any])
    ...
    inline def disableUpDownKeys(value: Boolean): this.type = set("disableUpDownKeys", value.asInstanceOf[js.Any])
    
    inline def disabled(value: Boolean): this.type = set("disabled", value.asInstanceOf[js.Any])
    
    inline def disabledTabClassName(value: String): this.type = set("disabledTabClassName", value.asInstanceOf[js.Any])
    
    inline def domRef(value: /* node */ js.UndefOr[HTMLElement] => Callback): this.type = set("domRef", js.Any.fromFunction1((t0: /* node */ js.UndefOr[HTMLElement]) => value(t0).runNow()))
    ...
    inline def environment(value: Window): this.type = set("environment", value.asInstanceOf[js.Any])
    
    inline def focusTabOnClick(value: Boolean): this.type = set("focusTabOnClick", value.asInstanceOf[js.Any])
    
    inline def forceRenderTabPanel(value: Boolean): this.type = set("forceRenderTabPanel", value.asInstanceOf[js.Any])
    ...
    inline def onSelect(value: (/* index */ Double, /* last */ Double, /* event */ Event) => Boolean | Unit): this.type = set("onSelect", js.Any.fromFunction3(value))
    ...
    inline def selectedTabClassName(value: String): this.type = set("selectedTabClassName", value.asInstanceOf[js.Any])
    
    inline def selectedTabPanelClassName(value: String): this.type = set("selectedTabPanelClassName", value.asInstanceOf[js.Any])
