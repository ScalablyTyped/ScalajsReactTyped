...
import typingsJapgolly.reactTabs.mod.TabPanelProps
...
object TabPanel {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TabPanelProps, typingsJapgolly.reactTabs.mod.TabPanel, Unit, TabPanelProps] = {
  ...
  typingsJapgolly.reactTabs.mod.TabPanelProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactTabs.mod.TabPanel](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactTabs.mod.TabPanelProps])(children: _*)
  }
