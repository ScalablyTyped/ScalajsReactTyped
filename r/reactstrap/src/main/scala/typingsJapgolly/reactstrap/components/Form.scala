...
import typingsJapgolly.reactstrap.typesLibFormMod.FormProps
...
object Form {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Form] {
    ...
    inline def innerRef(value: Ref[HTMLFormElement]): this.type = set("innerRef", value.asInstanceOf[js.Any])
    
    inline def innerRefFunction1(value: HTMLFormElement | Null => Callback): this.type = set("innerRef", js.Any.fromFunction1((t0: HTMLFormElement | Null) => value(t0).runNow()))
