...
import typingsJapgolly.reactstrap.cardMod.CardProps
import typingsJapgolly.reactstrap.cardMod.default
...
object Card {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardProps, default[T], Unit, CardProps] = {
  ...
  typingsJapgolly.reactstrap.cardMod.CardProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.cardMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.cardMod.CardProps])(children: _*)
  }
