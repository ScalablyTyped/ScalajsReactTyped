...
import typingsJapgolly.reactstrap.typesLibCarouselMod.CarouselProps
...
object Carousel {
  ...
  inline def apply(next: Callback, previous: Callback): Builder = {
    val __props = js.Dynamic.literal(next = next.toJsFn, previous = previous.toJsFn)
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Carousel] {
