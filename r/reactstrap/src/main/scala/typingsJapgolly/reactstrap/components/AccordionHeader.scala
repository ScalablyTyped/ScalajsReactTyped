...
import typingsJapgolly.reactstrap.typesLibAccordionHeaderMod.AccordionHeaderProps
...
object AccordionHeader {
  ...
  inline def apply(targetId: String): Builder = {
    val __props = js.Dynamic.literal(targetId = targetId.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[AccordionHeaderProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.AccordionHeader] {
  ...
  def withProps(p: AccordionHeaderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
