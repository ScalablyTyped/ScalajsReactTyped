...
import typingsJapgolly.reactstrap.typesLibNavbarTextMod.NavbarTextProps
...
object NavbarText {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.NavbarText] {
  ...
  implicit def make(companion: NavbarText.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NavbarTextProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
