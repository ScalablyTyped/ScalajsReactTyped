...
import typingsJapgolly.reactstrap.paginationItemMod.PaginationItemProps
import typingsJapgolly.reactstrap.paginationItemMod.default
...
object PaginationItem {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PaginationItemProps, default[T], Unit, PaginationItemProps] = {
  ...
  typingsJapgolly.reactstrap.paginationItemMod.PaginationItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.paginationItemMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.paginationItemMod.PaginationItemProps])(children: _*)
  }
