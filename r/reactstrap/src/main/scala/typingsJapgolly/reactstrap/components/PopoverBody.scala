...
import typingsJapgolly.reactstrap.popoverBodyMod.PopoverBodyProps
import typingsJapgolly.reactstrap.popoverBodyMod.default
...
object PopoverBody {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PopoverBodyProps, default[T], Unit, PopoverBodyProps] = {
  ...
  typingsJapgolly.reactstrap.popoverBodyMod.PopoverBodyProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.popoverBodyMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.popoverBodyMod.PopoverBodyProps])(children: _*)
  }
