...
import typingsJapgolly.reactstrap.dropdownMod.Direction
import typingsJapgolly.reactstrap.dropdownMod.DropdownProps
...
abstract class SharedApply_DropdownProps_716425660[ComponentRef] () {
  ...
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DropdownProps, ComponentRef, Unit, DropdownProps] = {
  ...
  typingsJapgolly.reactstrap.dropdownMod.DropdownProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.dropdownMod.DropdownProps])(children: _*)
  }
}
