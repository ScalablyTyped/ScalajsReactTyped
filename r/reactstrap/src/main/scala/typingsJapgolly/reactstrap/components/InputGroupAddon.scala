...
import typingsJapgolly.reactstrap.inputGroupAddonMod.InputGroupAddonProps
import typingsJapgolly.reactstrap.inputGroupAddonMod.default
...
object InputGroupAddon {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputGroupAddonProps, default[T], Unit, InputGroupAddonProps] = {
  ...
  typingsJapgolly.reactstrap.inputGroupAddonMod.InputGroupAddonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.inputGroupAddonMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.inputGroupAddonMod.InputGroupAddonProps])(children: _*)
  }
