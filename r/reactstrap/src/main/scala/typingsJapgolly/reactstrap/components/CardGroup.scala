...
import typingsJapgolly.reactstrap.cardGroupMod.default
...
object CardGroup {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardGroupProps, default[T], Unit, CardGroupProps] = {
  ...
  typingsJapgolly.reactstrap.cardGroupMod.CardGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.cardGroupMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.cardGroupMod.CardGroupProps])(children: _*)
  }
