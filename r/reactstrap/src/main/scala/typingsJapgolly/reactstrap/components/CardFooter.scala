...
import typingsJapgolly.reactstrap.cardFooterMod.CardFooterProps
import typingsJapgolly.reactstrap.cardFooterMod.default
...
object CardFooter {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardFooterProps, default[T], Unit, CardFooterProps] = {
  ...
  typingsJapgolly.reactstrap.cardFooterMod.CardFooterProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.cardFooterMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.cardFooterMod.CardFooterProps])(children: _*)
  }
