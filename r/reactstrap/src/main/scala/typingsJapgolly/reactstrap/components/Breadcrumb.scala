...
import typingsJapgolly.reactstrap.breadcrumbMod.BreadcrumbProps
import typingsJapgolly.reactstrap.breadcrumbMod.default
...
object Breadcrumb {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BreadcrumbProps, default[T], Unit, BreadcrumbProps] = {
  ...
  typingsJapgolly.reactstrap.breadcrumbMod.BreadcrumbProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.breadcrumbMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.breadcrumbMod.BreadcrumbProps])(children: _*)
  }
