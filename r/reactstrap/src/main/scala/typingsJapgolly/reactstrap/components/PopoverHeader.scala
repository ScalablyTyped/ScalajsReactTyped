...
import typingsJapgolly.reactstrap.popoverHeaderMod.default
...
object PopoverHeader {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PopoverHeaderProps, default[T], Unit, PopoverHeaderProps] = {
  ...
  typingsJapgolly.reactstrap.popoverHeaderMod.PopoverHeaderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.popoverHeaderMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.popoverHeaderMod.PopoverHeaderProps])(children: _*)
  }
