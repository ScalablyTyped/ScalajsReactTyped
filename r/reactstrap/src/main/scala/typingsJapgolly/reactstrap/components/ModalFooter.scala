...
import typingsJapgolly.reactstrap.modalFooterMod.ModalFooterProps
import typingsJapgolly.reactstrap.modalFooterMod.default
...
object ModalFooter {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ModalFooterProps, default[T], Unit, ModalFooterProps] = {
  ...
  typingsJapgolly.reactstrap.modalFooterMod.ModalFooterProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.modalFooterMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.modalFooterMod.ModalFooterProps])(children: _*)
  }
