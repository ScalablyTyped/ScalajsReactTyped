...
import typingsJapgolly.reactstrap.typesLibCloseButtonMod.CloseButtonProps
...
object CloseButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.CloseButton] {
    ...
    inline def variant(value: white | black): this.type = set("variant", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: CloseButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
