...
import typingsJapgolly.reactstrap.inputGroupButtonDropdownMod.InputGroupButtonDropdownProps
import typingsJapgolly.reactstrap.inputGroupButtonDropdownMod.default
...
object InputGroupButtonDropdown {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputGroupButtonDropdownProps, default[T], Unit, InputGroupButtonDropdownProps] = {
  ...
  typingsJapgolly.reactstrap.inputGroupButtonDropdownMod.InputGroupButtonDropdownProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.inputGroupButtonDropdownMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.inputGroupButtonDropdownMod.InputGroupButtonDropdownProps])(children: _*)
  }
