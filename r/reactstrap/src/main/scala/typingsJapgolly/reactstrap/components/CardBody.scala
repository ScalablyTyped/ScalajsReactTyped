...
import typingsJapgolly.reactstrap.cardBodyMod.CardBodyProps
import typingsJapgolly.reactstrap.cardBodyMod.default
...
object CardBody {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardBodyProps, default[T], Unit, CardBodyProps] = {
  ...
  typingsJapgolly.reactstrap.cardBodyMod.CardBodyProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.cardBodyMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.cardBodyMod.CardBodyProps])(children: _*)
  }
