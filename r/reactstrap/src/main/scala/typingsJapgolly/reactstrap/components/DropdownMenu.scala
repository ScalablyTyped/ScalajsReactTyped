...
import typingsJapgolly.reactstrap.dropdownMenuMod.DropdownMenuProps
import typingsJapgolly.reactstrap.dropdownMenuMod.default
...
object DropdownMenu {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DropdownMenuProps, default[T], Unit, DropdownMenuProps] = {
  ...
  typingsJapgolly.reactstrap.dropdownMenuMod.DropdownMenuProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.dropdownMenuMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.dropdownMenuMod.DropdownMenuProps])(children: _*)
  }
