...
import typingsJapgolly.reactstrap.typesLibDropdownMenuMod.DropdownMenuProps
...
object DropdownMenu {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.DropdownMenu] {
    ...
    inline def updateOnSelect(value: Boolean): this.type = set("updateOnSelect", value.asInstanceOf[js.Any])
