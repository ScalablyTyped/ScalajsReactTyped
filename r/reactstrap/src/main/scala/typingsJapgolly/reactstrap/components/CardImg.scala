...
import typingsJapgolly.reactstrap.cardImgMod.CardImgProps
import typingsJapgolly.reactstrap.cardImgMod.default
...
object CardImg {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardImgProps, default[T], Unit, CardImgProps] = {
  ...
  typingsJapgolly.reactstrap.cardImgMod.CardImgProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.cardImgMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.cardImgMod.CardImgProps])(children: _*)
  }
