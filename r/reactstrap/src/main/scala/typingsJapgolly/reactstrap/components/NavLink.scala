...
import typingsJapgolly.reactstrap.typesLibNavLinkMod.NavLinkProps
...
object NavLink {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.NavLink] {
    ...
    inline def innerRef(value: Ref[HTMLAnchorElement]): this.type = set("innerRef", value.asInstanceOf[js.Any])
    
    inline def innerRefFunction1(value: HTMLAnchorElement | Null => Callback): this.type = set("innerRef", js.Any.fromFunction1((t0: HTMLAnchorElement | Null) => value(t0).runNow()))
  ...
  implicit def make(companion: NavLink.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
