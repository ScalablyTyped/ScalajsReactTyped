...
import typingsJapgolly.reactstrap.toastMod.ToastProps
import typingsJapgolly.reactstrap.toastMod.default
...
object Toast {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ToastProps, default[T], Unit, ToastProps] = {
  ...
  typingsJapgolly.reactstrap.toastMod.ToastProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.toastMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.toastMod.ToastProps])(children: _*)
  }
