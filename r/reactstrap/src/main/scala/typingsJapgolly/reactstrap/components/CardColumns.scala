...
import typingsJapgolly.reactstrap.cardColumnsMod.CardColumnsProps
import typingsJapgolly.reactstrap.cardColumnsMod.default
...
object CardColumns {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardColumnsProps, default[T], Unit, CardColumnsProps] = {
  ...
  typingsJapgolly.reactstrap.cardColumnsMod.CardColumnsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.cardColumnsMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.cardColumnsMod.CardColumnsProps])(children: _*)
  }
