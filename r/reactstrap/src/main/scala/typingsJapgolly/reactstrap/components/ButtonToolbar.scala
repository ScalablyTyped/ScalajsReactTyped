...
import typingsJapgolly.reactstrap.buttonToolbarMod.ButtonToolbarProps
import typingsJapgolly.reactstrap.buttonToolbarMod.default
...
object ButtonToolbar {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ButtonToolbarProps, default[T], Unit, ButtonToolbarProps] = {
  ...
  typingsJapgolly.reactstrap.buttonToolbarMod.ButtonToolbarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.buttonToolbarMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.buttonToolbarMod.ButtonToolbarProps])(children: _*)
  }
