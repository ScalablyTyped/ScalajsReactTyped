...
import typingsJapgolly.reactstrap.typesLibOffcanvasBodyMod.OffcanvasBodyProps
...
object OffcanvasBody {
  ...
  @JSImport("reactstrap", "OffcanvasBody")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.OffcanvasBody] {
