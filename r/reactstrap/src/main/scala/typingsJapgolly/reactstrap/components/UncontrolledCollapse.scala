...
object UncontrolledCollapse {
  ...
  inline def apply(toggler: String): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.UncontrolledCollapse] {
    ...
    inline def delay(value: Hide): this.type = set("delay", value.asInstanceOf[js.Any])
    ...
    inline def navbar(value: Boolean): this.type = set("navbar", value.asInstanceOf[js.Any])
    ...
    inline def toggleEvents(value: js.Array[String]): this.type = set("toggleEvents", value.asInstanceOf[js.Any])
    
    inline def toggleEventsVarargs(value: String*): this.type = set("toggleEvents", js.Array(value*))
