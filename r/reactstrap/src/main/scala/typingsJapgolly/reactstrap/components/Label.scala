...
import typingsJapgolly.reactstrap.typesLibLabelMod.LabelProps
...
object Label {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Label] {
    ...
    inline def lg(value: ColumnProps): this.type = set("lg", value.asInstanceOf[js.Any])
    
    inline def md(value: ColumnProps): this.type = set("md", value.asInstanceOf[js.Any])
    ...
    inline def sm(value: ColumnProps): this.type = set("sm", value.asInstanceOf[js.Any])
    ...
    inline def widths(value: js.Array[String]): this.type = set("widths", value.asInstanceOf[js.Any])
    
    inline def widthsVarargs(value: String*): this.type = set("widths", js.Array(value*))
    
    inline def xl(value: ColumnProps): this.type = set("xl", value.asInstanceOf[js.Any])
    
    inline def xs(value: ColumnProps): this.type = set("xs", value.asInstanceOf[js.Any])
    
    inline def xxl(value: ColumnProps): this.type = set("xxl", value.asInstanceOf[js.Any])
  }
