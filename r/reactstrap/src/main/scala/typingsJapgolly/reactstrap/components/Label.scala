...
import typingsJapgolly.reactstrap.labelMod.default
...
object Label {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[LabelProps, default[T], Unit, LabelProps] = {
  ...
  typingsJapgolly.reactstrap.labelMod.LabelProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.labelMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.labelMod.LabelProps])(children: _*)
  }
