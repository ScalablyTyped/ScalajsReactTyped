...
import typingsJapgolly.reactstrap.typesLibCarouselCaptionMod.CarouselCaptionProps
...
object CarouselCaption {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.CarouselCaption] {
    ...
    inline def captionHeader(value: VdomNode): this.type = set("captionHeader", value.rawNode.asInstanceOf[js.Any])
    
    inline def captionHeaderNull: this.type = set("captionHeader", null)
    
    inline def captionHeaderVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("captionHeader", js.Array(value*))
    
    inline def captionHeaderVdomElement(value: VdomElement): this.type = set("captionHeader", value.rawElement.asInstanceOf[js.Any])
    
    inline def captionText(value: VdomNode): this.type = set("captionText", value.rawNode.asInstanceOf[js.Any])
    
    inline def captionTextNull: this.type = set("captionText", null)
    
    inline def captionTextVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("captionText", js.Array(value*))
    
    inline def captionTextVdomElement(value: VdomElement): this.type = set("captionText", value.rawElement.asInstanceOf[js.Any])
