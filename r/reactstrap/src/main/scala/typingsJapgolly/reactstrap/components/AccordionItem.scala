...
import typingsJapgolly.reactstrap.typesLibAccordionItemMod.AccordionItemProps
...
object AccordionItem {
  ...
  @JSImport("reactstrap", "AccordionItem")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.AccordionItem] {
  ...
  def withProps(p: AccordionItemProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
