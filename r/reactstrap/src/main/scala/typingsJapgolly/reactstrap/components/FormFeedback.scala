...
import typingsJapgolly.reactstrap.formFeedbackMod.FormFeedbackProps
import typingsJapgolly.reactstrap.formFeedbackMod.default
...
object FormFeedback {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[FormFeedbackProps, default[T], Unit, FormFeedbackProps] = {
  ...
  typingsJapgolly.reactstrap.formFeedbackMod.FormFeedbackProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.formFeedbackMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.formFeedbackMod.FormFeedbackProps])(children: _*)
  }
