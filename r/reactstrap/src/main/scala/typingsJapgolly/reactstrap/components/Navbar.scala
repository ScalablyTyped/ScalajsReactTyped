...
import typingsJapgolly.reactstrap.typesLibNavbarMod.NavbarProps
...
object Navbar {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Navbar] {
    ...
    inline def container(value: Boolean | fluid | sm | md | lg | xl | xxl): this.type = set("container", value.asInstanceOf[js.Any])
    ...
    inline def expand(value: Boolean | String): this.type = set("expand", value.asInstanceOf[js.Any])
    
    inline def fixed(value: String): this.type = set("fixed", value.asInstanceOf[js.Any])
    ...
    inline def sticky(value: String): this.type = set("sticky", value.asInstanceOf[js.Any])
