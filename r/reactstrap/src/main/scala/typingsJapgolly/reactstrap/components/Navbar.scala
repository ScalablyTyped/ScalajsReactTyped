...
import typingsJapgolly.reactstrap.navbarMod.NavbarProps
import typingsJapgolly.reactstrap.navbarMod.default
...
object Navbar {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[NavbarProps, default[T], Unit, NavbarProps] = {
  ...
  typingsJapgolly.reactstrap.navbarMod.NavbarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.navbarMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.navbarMod.NavbarProps])(children: _*)
  }
