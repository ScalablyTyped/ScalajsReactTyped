...
import typingsJapgolly.reactstrap.typesLibCarouselIndicatorsMod.CarouselIndicatorsProps
...
object CarouselIndicators {
  ...
  inline def apply(activeIndex: Double, items: js.Array[js.Object], onClickHandler: Double => Callback): Builder = {
    val __props = js.Dynamic.literal(activeIndex = activeIndex.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any], onClickHandler = js.Any.fromFunction1((t0: Double) => onClickHandler(t0).runNow()))
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.CarouselIndicators] {
