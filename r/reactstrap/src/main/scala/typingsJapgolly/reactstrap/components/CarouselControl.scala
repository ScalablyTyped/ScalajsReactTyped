...
import typingsJapgolly.reactstrap.typesLibCarouselControlMod.CarouselControlProps
...
object CarouselControl {
  ...
  inline def apply(direction: prev | next, onClickHandler: Callback): Builder = {
    val __props = js.Dynamic.literal(direction = direction.asInstanceOf[js.Any], onClickHandler = onClickHandler.toJsFn)
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.CarouselControl] {
    ...
    inline def directionText(value: String): this.type = set("directionText", value.asInstanceOf[js.Any])
