...
import typingsJapgolly.reactstrap.dropdownMod.UncontrolledDropdownProps
...
abstract class SharedApply_UncontrolledDropdownProps_675312530[ComponentRef] () {
  ...
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[UncontrolledDropdownProps, ComponentRef, Unit, UncontrolledDropdownProps] = {
  ...
  typingsJapgolly.reactstrap.dropdownMod.UncontrolledDropdownProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.dropdownMod.UncontrolledDropdownProps])(children: _*)
  }
}
