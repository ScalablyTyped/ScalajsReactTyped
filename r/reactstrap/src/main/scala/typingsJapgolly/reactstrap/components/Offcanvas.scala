...
import typingsJapgolly.reactstrap.typesLibOffcanvasMod.Direction
import typingsJapgolly.reactstrap.typesLibOffcanvasMod.OffcanvasProps
...
object Offcanvas {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Offcanvas] {
    ...
    inline def offcanvasClassName(value: String): this.type = set("offcanvasClassName", value.asInstanceOf[js.Any])
    
    inline def offcanvasTransition(value: FadeProps): this.type = set("offcanvasTransition", value.asInstanceOf[js.Any])
    ...
    inline def toggle(value: (ReactKeyboardEventFrom[Any & Element]) | (ReactMouseEventFrom[Any & Element]) => Callback): this.type = set("toggle", js.Any.fromFunction1((t0: (ReactKeyboardEventFrom[Any & Element]) | (ReactMouseEventFrom[Any & Element])) => value(t0).runNow()))
