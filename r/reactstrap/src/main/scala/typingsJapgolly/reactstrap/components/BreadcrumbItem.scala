...
import typingsJapgolly.reactstrap.breadcrumbItemMod.BreadcrumbItemProps
import typingsJapgolly.reactstrap.breadcrumbItemMod.default
...
object BreadcrumbItem {
  ...
  /* others */ StringDictionary[js.Any] = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BreadcrumbItemProps, default[T], Unit, BreadcrumbItemProps] = {
  ...
  typingsJapgolly.reactstrap.breadcrumbItemMod.BreadcrumbItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.breadcrumbItemMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.breadcrumbItemMod.BreadcrumbItemProps])(children: _*)
  }
