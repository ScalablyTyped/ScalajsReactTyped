...
import typingsJapgolly.reactstrap.typesLibDropdownToggleMod.DropdownToggleProps
...
object DropdownToggle {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.DropdownToggle] {
    ...
    inline def `aria-haspopup`(value: Boolean): this.type = set("aria-haspopup", value.asInstanceOf[js.Any])
    ...
    inline def `data-toggle`(value: String): this.type = set("data-toggle", value.asInstanceOf[js.Any])
