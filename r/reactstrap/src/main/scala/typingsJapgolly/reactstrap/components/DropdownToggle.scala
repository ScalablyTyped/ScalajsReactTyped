...
import typingsJapgolly.reactstrap.dropdownToggleMod.default
...
object DropdownToggle {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DropdownToggleProps, default[T], Unit, DropdownToggleProps] = {
  ...
  typingsJapgolly.reactstrap.dropdownToggleMod.DropdownToggleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.dropdownToggleMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.dropdownToggleMod.DropdownToggleProps])(children: _*)
  }
