...
import typingsJapgolly.reactstrap.jumbotronMod.JumbotronProps
import typingsJapgolly.reactstrap.jumbotronMod.default
...
object Jumbotron {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[JumbotronProps, default[T], Unit, JumbotronProps] = {
  ...
  typingsJapgolly.reactstrap.jumbotronMod.JumbotronProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.jumbotronMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.jumbotronMod.JumbotronProps])(children: _*)
  }
