...
import typingsJapgolly.reactstrap.typesLibAccordionMod.AccordionProps
...
object Accordion {
  ...
  inline def apply(open: String | js.Array[String]): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Accordion] {
