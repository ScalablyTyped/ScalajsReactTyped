...
import typingsJapgolly.reactstrap.typesLibListInlineItemMod.ListInlineItemProps
import typingsJapgolly.reactstrap.typesLibUtilsMod.CSSModule
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ListInlineItem {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.ListInlineItem] {
  ...
  implicit def make(companion: ListInlineItem.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ListInlineItemProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
