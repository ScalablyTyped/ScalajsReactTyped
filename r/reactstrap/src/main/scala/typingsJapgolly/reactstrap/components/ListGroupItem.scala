...
import typingsJapgolly.reactstrap.listGroupItemMod.default
...
object ListGroupItem {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ListGroupItemProps, default[T], Unit, ListGroupItemProps] = {
  ...
  typingsJapgolly.reactstrap.listGroupItemMod.ListGroupItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.listGroupItemMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.listGroupItemMod.ListGroupItemProps])(children: _*)
  }
