...
import typingsJapgolly.reactstrap.typesLibListGroupItemMod.ListGroupItemProps
...
object ListGroupItem {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.ListGroupItem] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def action(value: Boolean): this.type = set("action", value.asInstanceOf[js.Any])
