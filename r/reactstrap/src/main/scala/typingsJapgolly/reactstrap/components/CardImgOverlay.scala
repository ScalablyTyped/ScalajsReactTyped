...
import typingsJapgolly.reactstrap.cardImgOverlayMod.CardImgOverlayProps
import typingsJapgolly.reactstrap.cardImgOverlayMod.default
...
object CardImgOverlay {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardImgOverlayProps, default[T], Unit, CardImgOverlayProps] = {
  ...
  typingsJapgolly.reactstrap.cardImgOverlayMod.CardImgOverlayProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.cardImgOverlayMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.cardImgOverlayMod.CardImgOverlayProps])(children: _*)
  }
