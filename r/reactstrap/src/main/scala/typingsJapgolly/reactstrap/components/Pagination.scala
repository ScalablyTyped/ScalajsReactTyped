...
import typingsJapgolly.reactstrap.paginationMod.default
...
object Pagination {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PaginationProps, default[T], Unit, PaginationProps] = {
  ...
  typingsJapgolly.reactstrap.paginationMod.PaginationProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.paginationMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.paginationMod.PaginationProps])(children: _*)
  }
