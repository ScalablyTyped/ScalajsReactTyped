...
import typingsJapgolly.reactstrap.typesLibPaginationMod.PaginationProps
...
object Pagination {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Pagination] {
    ...
    inline def listTag(value: ElementType): this.type = set("listTag", value.asInstanceOf[js.Any])
