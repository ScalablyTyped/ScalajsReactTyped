...
import typingsJapgolly.reactstrap.typesLibDropdownMod.Direction
...
@scala.inline
open class SharedBuilder_UncontrolledDropdownProps_1635575647[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
     with StBuildingComponent[R] {
  
  inline def a11y(value: Boolean): this.type = set("a11y", value.asInstanceOf[js.Any])
  ...
  inline def addonType(value: Boolean | prepend | append): this.type = set("addonType", value.asInstanceOf[js.Any])
  ...
  inline def group(value: Boolean): this.type = set("group", value.asInstanceOf[js.Any])
  
  inline def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
  
  inline def id(value: String): this.type = set("id", value.asInstanceOf[js.Any])
  
  inline def inNavbar(value: Boolean): this.type = set("inNavbar", value.asInstanceOf[js.Any])
  ...
  inline def menuRole(value: Boolean | String): this.type = set("menuRole", value.asInstanceOf[js.Any])
  ...
  ): this.type = set("onToggle", js.Any.fromFunction2((t0: /* event */ ReactKeyboardEventFrom[Element] | ReactMouseEventFrom[Element], t1: /* isOpen */ Boolean) => (value(t0, t1)).runNow()))
  ...
  inline def setActiveFromChild(value: Boolean): this.type = set("setActiveFromChild", value.asInstanceOf[js.Any])
