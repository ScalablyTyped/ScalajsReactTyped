...
import typingsJapgolly.reactstrap.typesLibPlaceholderButtonMod.PlaceholderButtonProps
import typingsJapgolly.reactstrap.typesLibUtilsMod.CSSModule
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object PlaceholderButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.PlaceholderButton] {
  ...
  implicit def make(companion: PlaceholderButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlaceholderButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
