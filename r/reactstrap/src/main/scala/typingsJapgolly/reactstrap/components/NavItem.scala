...
import typingsJapgolly.reactstrap.navItemMod.default
...
object NavItem {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[NavItemProps, default[T], Unit, NavItemProps] = {
  ...
  typingsJapgolly.reactstrap.navItemMod.NavItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.navItemMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.navItemMod.NavItemProps])(children: _*)
  }
