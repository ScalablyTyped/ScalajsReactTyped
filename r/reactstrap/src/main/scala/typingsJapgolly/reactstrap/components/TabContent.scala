...
import typingsJapgolly.reactstrap.tabContentMod.TabContentProps
import typingsJapgolly.reactstrap.tabContentMod.default
...
object TabContent {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TabContentProps, default[T], Unit, TabContentProps] = {
  ...
  typingsJapgolly.reactstrap.tabContentMod.TabContentProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.tabContentMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.tabContentMod.TabContentProps])(children: _*)
  }
