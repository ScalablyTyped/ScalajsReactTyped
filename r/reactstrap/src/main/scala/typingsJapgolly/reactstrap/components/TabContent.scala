...
import typingsJapgolly.reactstrap.typesLibTabContentMod.TabContentProps
...
object TabContent {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.TabContent] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def activeTab(value: Double | String): this.type = set("activeTab", value.asInstanceOf[js.Any])
