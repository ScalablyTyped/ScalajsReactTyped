...
import typingsJapgolly.reactstrap.listGroupItemTextMod.ListGroupItemTextProps
import typingsJapgolly.reactstrap.listGroupItemTextMod.default
...
object ListGroupItemText {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ListGroupItemTextProps, default[T], Unit, ListGroupItemTextProps] = {
  ...
  typingsJapgolly.reactstrap.listGroupItemTextMod.ListGroupItemTextProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.listGroupItemTextMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.listGroupItemTextMod.ListGroupItemTextProps])(children: _*)
  }
