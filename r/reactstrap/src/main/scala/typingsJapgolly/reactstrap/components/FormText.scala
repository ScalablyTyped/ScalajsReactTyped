...
import typingsJapgolly.reactstrap.formTextMod.default
...
object FormText {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[FormTextProps, default[T], Unit, FormTextProps] = {
  ...
  typingsJapgolly.reactstrap.formTextMod.FormTextProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.formTextMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.formTextMod.FormTextProps])(children: _*)
  }
