...
import typingsJapgolly.reactstrap.typesLibFormTextMod.FormTextProps
...
object FormText {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.FormText] {
  ...
  implicit def make(companion: FormText.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FormTextProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
