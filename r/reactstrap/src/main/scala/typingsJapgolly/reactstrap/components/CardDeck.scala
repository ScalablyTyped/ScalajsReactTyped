...
import typingsJapgolly.reactstrap.cardDeckMod.default
...
object CardDeck {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardDeckProps, default[T], Unit, CardDeckProps] = {
  ...
  typingsJapgolly.reactstrap.cardDeckMod.CardDeckProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.cardDeckMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.cardDeckMod.CardDeckProps])(children: _*)
  }
