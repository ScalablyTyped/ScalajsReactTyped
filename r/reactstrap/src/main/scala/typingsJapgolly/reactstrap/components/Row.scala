...
import typingsJapgolly.reactstrap.reactstrapStrings.`additions removals`
...
import typingsJapgolly.reactstrap.reactstrapStrings.`removals additions`
import typingsJapgolly.reactstrap.reactstrapStrings.`removals text`
import typingsJapgolly.reactstrap.reactstrapStrings.`text additions`
import typingsJapgolly.reactstrap.reactstrapStrings.`text removals`
...
import typingsJapgolly.reactstrap.reactstrapStrings.no
...
import typingsJapgolly.reactstrap.reactstrapStrings.on
...
import typingsJapgolly.reactstrap.reactstrapStrings.yes
import typingsJapgolly.reactstrap.typesLibRowMod.RowProps
...
object Row {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Row] {
    ...
    inline def lg(value: Double | String): this.type = set("lg", value.asInstanceOf[js.Any])
    
    inline def md(value: Double | String): this.type = set("md", value.asInstanceOf[js.Any])
    
    inline def noGutters(value: Boolean): this.type = set("noGutters", value.asInstanceOf[js.Any])
    ...
    inline def sm(value: Double | String): this.type = set("sm", value.asInstanceOf[js.Any])
    ...
    inline def xl(value: Double | String): this.type = set("xl", value.asInstanceOf[js.Any])
    
    inline def xs(value: Double | String): this.type = set("xs", value.asInstanceOf[js.Any])
    
    inline def xxl(value: Double | String): this.type = set("xxl", value.asInstanceOf[js.Any])
  }
