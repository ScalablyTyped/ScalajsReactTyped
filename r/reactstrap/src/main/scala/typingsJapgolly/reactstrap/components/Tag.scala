...
import typingsJapgolly.reactstrap.tagMod.TagProps
import typingsJapgolly.reactstrap.tagMod.default
...
object Tag {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TagProps, default[T], Unit, TagProps] = {
  ...
  typingsJapgolly.reactstrap.tagMod.TagProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.tagMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.tagMod.TagProps])(children: _*)
  }
