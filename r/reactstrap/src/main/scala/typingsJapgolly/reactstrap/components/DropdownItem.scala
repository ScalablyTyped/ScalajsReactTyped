...
import typingsJapgolly.reactstrap.dropdownItemMod.DropdownItemProps
import typingsJapgolly.reactstrap.dropdownItemMod.default
...
object DropdownItem {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DropdownItemProps, default[T], Unit, DropdownItemProps] = {
  ...
  typingsJapgolly.reactstrap.dropdownItemMod.DropdownItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.dropdownItemMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.dropdownItemMod.DropdownItemProps])(children: _*)
  }
