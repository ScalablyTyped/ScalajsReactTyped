...
import typingsJapgolly.reactstrap.typesLibAccordionBodyMod.AccordionBodyProps
...
object AccordionBody {
  ...
  inline def apply(accordionId: String): Builder = {
    val __props = js.Dynamic.literal(accordionId = accordionId.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[AccordionBodyProps]))
  }
  
  @JSImport("reactstrap", "AccordionBody")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.AccordionBody] {
  ...
  def withProps(p: AccordionBodyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
