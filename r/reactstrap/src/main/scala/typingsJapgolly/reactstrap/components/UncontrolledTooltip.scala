...
import typingsJapgolly.reactstrap.typesLibTooltipMod.UncontrolledTooltipProps
...
object UncontrolledTooltip {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.UncontrolledTooltip] {
