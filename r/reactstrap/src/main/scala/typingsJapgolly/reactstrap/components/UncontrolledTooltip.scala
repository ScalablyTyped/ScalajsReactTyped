...
import typingsJapgolly.reactstrap.tooltipMod.UncontrolledTooltipProps
...
object UncontrolledTooltip {
  def apply[T](
    ...
    typingsJapgolly.reactstrap.mod.UncontrolledTooltip[T], 
    Unit, 
    UncontrolledTooltipProps
  ] = {
  ...
  typingsJapgolly.reactstrap.tooltipMod.UncontrolledTooltipProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.mod.UncontrolledTooltip[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.tooltipMod.UncontrolledTooltipProps])(children: _*)
  }
