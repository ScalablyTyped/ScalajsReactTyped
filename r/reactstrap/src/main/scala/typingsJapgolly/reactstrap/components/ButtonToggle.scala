...
import typingsJapgolly.reactstrap.buttonToggleMod.default
...
object ButtonToggle {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ButtonToggleProps, default[T], Unit, ButtonToggleProps] = {
  ...
  typingsJapgolly.reactstrap.buttonToggleMod.ButtonToggleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.buttonToggleMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.buttonToggleMod.ButtonToggleProps])(children: _*)
  }
