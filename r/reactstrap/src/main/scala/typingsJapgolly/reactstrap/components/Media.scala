...
import typingsJapgolly.reactstrap.mediaMod.MediaProps
import typingsJapgolly.reactstrap.mediaMod.default
...
object Media {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MediaProps, default[T], Unit, MediaProps] = {
  ...
  typingsJapgolly.reactstrap.mediaMod.MediaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.mediaMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.mediaMod.MediaProps])(children: _*)
  }
