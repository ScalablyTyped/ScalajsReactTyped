...
import typingsJapgolly.reactstrap.typesLibMediaMod.MediaProps
...
object Media {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Media] {
    ...
    inline def body(value: Boolean): this.type = set("body", value.asInstanceOf[js.Any])
    ...
    inline def list(value: Boolean): this.type = set("list", value.asInstanceOf[js.Any])
    
    inline def middle(value: Boolean): this.type = set("middle", value.asInstanceOf[js.Any])
    
    inline def `object`(value: Boolean): this.type = set("object", value.asInstanceOf[js.Any])
