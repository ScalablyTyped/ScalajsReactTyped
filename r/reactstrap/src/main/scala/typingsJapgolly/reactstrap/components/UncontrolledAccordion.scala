...
object UncontrolledAccordion {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.UncontrolledAccordion] {
    ...
    inline def defaultOpen(value: String | js.Array[String]): this.type = set("defaultOpen", value.asInstanceOf[js.Any])
    
    inline def defaultOpenVarargs(value: String*): this.type = set("defaultOpen", js.Array(value*))
    ...
    inline def stayOpen(value: Boolean): this.type = set("stayOpen", value.asInstanceOf[js.Any])
  ...
  def withProps(p: UncontrolledAccordionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
