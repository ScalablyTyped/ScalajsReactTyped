...
import typingsJapgolly.reactstrap.inputGroupMod.InputGroupProps
import typingsJapgolly.reactstrap.inputGroupMod.default
...
object InputGroup {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputGroupProps, default[T], Unit, InputGroupProps] = {
  ...
  typingsJapgolly.reactstrap.inputGroupMod.InputGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.inputGroupMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.inputGroupMod.InputGroupProps])(children: _*)
  }
