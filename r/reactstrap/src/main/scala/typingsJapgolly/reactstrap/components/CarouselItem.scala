...
import typingsJapgolly.reactstrap.typesLibCarouselItemMod.CarouselItemProps
...
object CarouselItem {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.CarouselItem] {
  ...
  implicit def make(companion: CarouselItem.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CarouselItemProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
