...
import typingsJapgolly.reactstrap.typesLibTabPaneMod.TabPaneProps
...
object TabPane {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.TabPane] {
    ...
    inline def tabId(value: Double | String): this.type = set("tabId", value.asInstanceOf[js.Any])
