...
import typingsJapgolly.reactstrap.tabPaneMod.TabPaneProps
import typingsJapgolly.reactstrap.tabPaneMod.default
...
object TabPane {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TabPaneProps, default[T], Unit, TabPaneProps] = {
  ...
  typingsJapgolly.reactstrap.tabPaneMod.TabPaneProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.tabPaneMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.tabPaneMod.TabPaneProps])(children: _*)
  }
