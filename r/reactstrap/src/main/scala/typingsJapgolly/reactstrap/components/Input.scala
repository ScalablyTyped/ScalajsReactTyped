...
import typingsJapgolly.reactstrap.typesLibInputMod.InputProps
import typingsJapgolly.reactstrap.typesLibInputMod.InputType
...
object Input {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Input] {
    ...
    inline def addon(value: Boolean): this.type = set("addon", value.asInstanceOf[js.Any])
    ...
    inline def bsSize(value: lg | sm): this.type = set("bsSize", value.asInstanceOf[js.Any])
    ...
    inline def innerRef(value: Ref[HTMLInputElement | HTMLTextAreaElement]): this.type = set("innerRef", value.asInstanceOf[js.Any])
    
    inline def innerRefFunction1(value: (HTMLInputElement | HTMLTextAreaElement) | Null => Callback): this.type = set("innerRef", js.Any.fromFunction1((t0: (HTMLInputElement | HTMLTextAreaElement) | Null) => value(t0).runNow()))
    ...
    inline def plaintext(value: Boolean): this.type = set("plaintext", value.asInstanceOf[js.Any])
    ...
    inline def `type`(value: InputType): this.type = set("type", value.asInstanceOf[js.Any])
    
    inline def typeof(value: String): this.type = set("typeof", value.asInstanceOf[js.Any])
    
    inline def unselectable(value: on | off): this.type = set("unselectable", value.asInstanceOf[js.Any])
    
    inline def valid(value: Boolean): this.type = set("valid", value.asInstanceOf[js.Any])
