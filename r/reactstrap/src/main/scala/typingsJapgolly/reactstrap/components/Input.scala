...
import typingsJapgolly.reactstrap.inputMod.InputProps
import typingsJapgolly.reactstrap.inputMod.InputType
import typingsJapgolly.reactstrap.inputMod.default
...
object Input {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputProps, default[T], Unit, InputProps] = {
  ...
  typingsJapgolly.reactstrap.inputMod.InputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.inputMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.inputMod.InputProps])(children: _*)
  }
