...
import typingsJapgolly.reactstrap.typesLibListGroupItemHeadingMod.ListGroupItemHeadingProps
...
object ListGroupItemHeading {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.ListGroupItemHeading] {
