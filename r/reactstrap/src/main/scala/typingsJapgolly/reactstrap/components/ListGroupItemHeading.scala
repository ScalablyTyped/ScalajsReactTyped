...
import typingsJapgolly.reactstrap.listGroupItemHeadingMod.ListGroupItemHeadingProps
import typingsJapgolly.reactstrap.listGroupItemHeadingMod.default
...
object ListGroupItemHeading {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ListGroupItemHeadingProps, default[T], Unit, ListGroupItemHeadingProps] = {
  ...
  typingsJapgolly.reactstrap.listGroupItemHeadingMod.ListGroupItemHeadingProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.listGroupItemHeadingMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.listGroupItemHeadingMod.ListGroupItemHeadingProps])(children: _*)
  }
