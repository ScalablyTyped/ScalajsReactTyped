...
import typingsJapgolly.reactstrap.modalBodyMod.ModalBodyProps
import typingsJapgolly.reactstrap.modalBodyMod.default
...
object ModalBody {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ModalBodyProps, default[T], Unit, ModalBodyProps] = {
  ...
  typingsJapgolly.reactstrap.modalBodyMod.ModalBodyProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.modalBodyMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.modalBodyMod.ModalBodyProps])(children: _*)
  }
