...
import typingsJapgolly.reactstrap.typesLibFormGroupMod.FormGroupProps
...
object FormGroup {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.FormGroup] {
    ...
    inline def check(value: Boolean): this.type = set("check", value.asInstanceOf[js.Any])
    ...
    inline def switch(value: Boolean): this.type = set("switch", value.asInstanceOf[js.Any])
