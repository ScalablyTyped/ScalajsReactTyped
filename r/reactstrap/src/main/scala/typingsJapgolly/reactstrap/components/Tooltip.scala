...
import typingsJapgolly.reactstrap.typesLibTooltipMod.TooltipChildren
import typingsJapgolly.reactstrap.typesLibTooltipMod.TooltipProps
...
object Tooltip {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Tooltip] {
    ...
    inline def children(value: TooltipChildren): this.type = set("children", value.asInstanceOf[js.Any])
    ...
    inline def toggleFunction1(value: ReactMouseEventFrom[Any & org.scalajs.dom.Element] => Callback): this.type = set("toggle", js.Any.fromFunction1((t0: ReactMouseEventFrom[Any & org.scalajs.dom.Element]) => value(t0).runNow()))
