...
import typingsJapgolly.reactstrap.tooltipMod.TooltipProps
import typingsJapgolly.reactstrap.tooltipMod.default
...
object Tooltip {
  def apply[T](
    target: String | HTMLElement | RefHandle[HTMLElement],
    about: String = null,
    ...
    color: String = null,
    container: String | HTMLElement | RefHandle[HTMLElement] = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TooltipProps, default[T], Unit, TooltipProps] = {
  ...
  typingsJapgolly.reactstrap.tooltipMod.TooltipProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.tooltipMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.tooltipMod.TooltipProps])(children: _*)
  }
