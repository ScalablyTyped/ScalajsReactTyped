...
import typingsJapgolly.reactstrap.popoverMod.PopoverProps
import typingsJapgolly.reactstrap.popoverMod.default
...
object Popover {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PopoverProps, default[T], Unit, PopoverProps] = {
  ...
  typingsJapgolly.reactstrap.popoverMod.PopoverProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.popoverMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.popoverMod.PopoverProps])(children: _*)
  }
