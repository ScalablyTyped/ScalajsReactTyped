...
import typingsJapgolly.reactstrap.typesLibProgressMod.ProgressProps
...
object Progress {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Progress] {
    ...
    inline def bar(value: Boolean): this.type = set("bar", value.asInstanceOf[js.Any])
    
    inline def barAriaLabelledBy(value: String): this.type = set("barAriaLabelledBy", value.asInstanceOf[js.Any])
    
    inline def barAriaValueText(value: String): this.type = set("barAriaValueText", value.asInstanceOf[js.Any])
