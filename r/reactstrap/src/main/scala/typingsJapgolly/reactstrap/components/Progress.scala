...
import typingsJapgolly.reactstrap.progressMod.ProgressProps
import typingsJapgolly.reactstrap.progressMod.default
...
object Progress {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ProgressProps, default[T], Unit, ProgressProps] = {
  ...
  typingsJapgolly.reactstrap.progressMod.ProgressProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.progressMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.progressMod.ProgressProps])(children: _*)
  }
