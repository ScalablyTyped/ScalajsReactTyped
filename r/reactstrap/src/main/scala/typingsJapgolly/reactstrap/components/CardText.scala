...
import typingsJapgolly.reactstrap.cardTextMod.CardTextProps
import typingsJapgolly.reactstrap.cardTextMod.default
...
object CardText {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardTextProps, default[T], Unit, CardTextProps] = {
  ...
  typingsJapgolly.reactstrap.cardTextMod.CardTextProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.cardTextMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.cardTextMod.CardTextProps])(children: _*)
  }
