...
import typingsJapgolly.reactstrap.inputGroupTextMod.InputGroupTextProps
import typingsJapgolly.reactstrap.inputGroupTextMod.default
...
object InputGroupText {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputGroupTextProps, default[T], Unit, InputGroupTextProps] = {
  ...
  typingsJapgolly.reactstrap.inputGroupTextMod.InputGroupTextProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.inputGroupTextMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.inputGroupTextMod.InputGroupTextProps])(children: _*)
  }
