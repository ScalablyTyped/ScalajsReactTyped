...
import typingsJapgolly.reactstrap.cardTitleMod.CardTitleProps
import typingsJapgolly.reactstrap.cardTitleMod.default
...
object CardTitle {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardTitleProps, default[T], Unit, CardTitleProps] = {
  ...
  typingsJapgolly.reactstrap.cardTitleMod.CardTitleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.cardTitleMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.cardTitleMod.CardTitleProps])(children: _*)
  }
