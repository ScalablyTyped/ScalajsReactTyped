...
import typingsJapgolly.reactstrap.modalHeaderMod.ModalHeaderProps
import typingsJapgolly.reactstrap.modalHeaderMod.default
...
object ModalHeader {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ModalHeaderProps, default[T], Unit, ModalHeaderProps] = {
  ...
  typingsJapgolly.reactstrap.modalHeaderMod.ModalHeaderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.modalHeaderMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.modalHeaderMod.ModalHeaderProps])(children: _*)
  }
