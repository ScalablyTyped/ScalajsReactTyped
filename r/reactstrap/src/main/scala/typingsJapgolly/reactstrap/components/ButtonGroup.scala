...
import typingsJapgolly.reactstrap.buttonGroupMod.ButtonGroupProps
import typingsJapgolly.reactstrap.buttonGroupMod.default
...
object ButtonGroup {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ButtonGroupProps, default[T], Unit, ButtonGroupProps] = {
  ...
  typingsJapgolly.reactstrap.buttonGroupMod.ButtonGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.buttonGroupMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.buttonGroupMod.ButtonGroupProps])(children: _*)
  }
