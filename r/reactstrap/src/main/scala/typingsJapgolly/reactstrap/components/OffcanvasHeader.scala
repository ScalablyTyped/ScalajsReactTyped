...
import typingsJapgolly.reactstrap.typesLibOffcanvasHeaderMod.OffcanvasHeaderProps
import typingsJapgolly.reactstrap.typesLibUtilsMod.CSSModule
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object OffcanvasHeader {
  
  @JSImport("reactstrap", "OffcanvasHeader")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.OffcanvasHeader] {
    ...
    inline def toggle(value: ReactMouseEventFrom[Any & Element] => Callback): this.type = set("toggle", js.Any.fromFunction1((t0: ReactMouseEventFrom[Any & Element]) => value(t0).runNow()))
  ...
  implicit def make(companion: OffcanvasHeader.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OffcanvasHeaderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
