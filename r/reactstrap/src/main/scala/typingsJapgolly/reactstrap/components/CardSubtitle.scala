...
import typingsJapgolly.reactstrap.cardSubtitleMod.CardSubtitleProps
import typingsJapgolly.reactstrap.cardSubtitleMod.default
...
object CardSubtitle {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardSubtitleProps, default[T], Unit, CardSubtitleProps] = {
  ...
  typingsJapgolly.reactstrap.cardSubtitleMod.CardSubtitleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.cardSubtitleMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.cardSubtitleMod.CardSubtitleProps])(children: _*)
  }
