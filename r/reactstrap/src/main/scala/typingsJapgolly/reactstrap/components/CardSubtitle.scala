...
import typingsJapgolly.reactstrap.typesLibCardSubtitleMod.CardSubtitleProps
...
object CardSubtitle {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.CardSubtitle] {
  ...
  implicit def make(companion: CardSubtitle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CardSubtitleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
