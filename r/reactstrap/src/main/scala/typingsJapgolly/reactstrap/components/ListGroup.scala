...
import typingsJapgolly.reactstrap.typesLibListGroupMod.ListGroupProps
...
object ListGroup {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.ListGroup] {
    ...
    inline def flush(value: Boolean): this.type = set("flush", value.asInstanceOf[js.Any])
    
    inline def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    
    inline def horizontal(value: Boolean | String): this.type = set("horizontal", value.asInstanceOf[js.Any])
    ...
    inline def numbered(value: Boolean): this.type = set("numbered", value.asInstanceOf[js.Any])
