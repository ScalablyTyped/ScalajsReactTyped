...
import typingsJapgolly.reactstrap.listGroupMod.ListGroupProps
import typingsJapgolly.reactstrap.listGroupMod.default
...
object ListGroup {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ListGroupProps, default[T], Unit, ListGroupProps] = {
  ...
  typingsJapgolly.reactstrap.listGroupMod.ListGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.listGroupMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.listGroupMod.ListGroupProps])(children: _*)
  }
