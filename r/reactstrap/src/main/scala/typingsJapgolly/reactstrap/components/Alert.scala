...
import typingsJapgolly.reactstrap.alertMod.AlertProps
import typingsJapgolly.reactstrap.alertMod.default
...
object Alert {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[AlertProps, default[T], Unit, AlertProps] = {
  ...
  typingsJapgolly.reactstrap.alertMod.AlertProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.alertMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.alertMod.AlertProps])(children: _*)
  }
