...
import typingsJapgolly.reactstrap.customInputMod.CustomInputProps
import typingsJapgolly.reactstrap.customInputMod.CustomInputType
import typingsJapgolly.reactstrap.customInputMod.default
...
object CustomInput {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CustomInputProps, default[T], Unit, CustomInputProps] = {
  ...
  typingsJapgolly.reactstrap.customInputMod.CustomInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.customInputMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.customInputMod.CustomInputProps])(children: _*)
  }
