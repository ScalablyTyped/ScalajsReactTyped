...
import typingsJapgolly.reactstrap.tableMod.TableProps
import typingsJapgolly.reactstrap.tableMod.default
...
object Table {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TableProps, default[T], Unit, TableProps] = {
  ...
  typingsJapgolly.reactstrap.tableMod.TableProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.tableMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.tableMod.TableProps])(children: _*)
  }
