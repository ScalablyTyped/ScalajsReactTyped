...
import typingsJapgolly.reactstrap.buttonMod.ButtonProps
import typingsJapgolly.reactstrap.buttonMod.default
...
object Button {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ButtonProps, default[T], Unit, ButtonProps] = {
  ...
  typingsJapgolly.reactstrap.buttonMod.ButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.buttonMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.buttonMod.ButtonProps])(children: _*)
  }
