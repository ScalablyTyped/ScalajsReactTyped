...
import typingsJapgolly.reactstrap.typesLibButtonMod.ButtonProps
...
object Button {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Button] {
    ...
    inline def innerRef(value: Ref[HTMLButtonElement]): this.type = set("innerRef", value.asInstanceOf[js.Any])
    
    inline def innerRefFunction1(value: HTMLButtonElement | Null => Callback): this.type = set("innerRef", js.Any.fromFunction1((t0: HTMLButtonElement | Null) => value(t0).runNow()))
