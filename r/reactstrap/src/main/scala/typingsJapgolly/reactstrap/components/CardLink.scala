...
import typingsJapgolly.reactstrap.cardLinkMod.default
...
object CardLink {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardLinkProps, default[T], Unit, CardLinkProps] = {
  ...
  typingsJapgolly.reactstrap.cardLinkMod.CardLinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.cardLinkMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.cardLinkMod.CardLinkProps])(children: _*)
  }
