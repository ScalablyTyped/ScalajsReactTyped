...
import typingsJapgolly.reactstrap.typesLibPopoverMod.PopoverChildren
import typingsJapgolly.reactstrap.typesLibPopoverMod.UncontrolledPopoverProps
...
object UncontrolledPopover {
  ...
  inline def apply(target: String | HTMLElement | RefHandle[HTMLElement]): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.UncontrolledPopover] {
    ...
    inline def children(value: PopoverChildren): this.type = set("children", value.asInstanceOf[js.Any])
    ...
    inline def delay(value: Double | Hide): this.type = set("delay", value.asInstanceOf[js.Any])
    ...
    inline def placementPrefix(value: String): this.type = set("placementPrefix", value.asInstanceOf[js.Any])
    ...
    inline def strategy(value: String): this.type = set("strategy", value.asInstanceOf[js.Any])
    ...
    inline def toggle(value: MouseEventHandler[Any] | js.Function0[Unit]): this.type = set("toggle", value.asInstanceOf[js.Any])
    
    inline def toggleCallback(value: Callback): this.type = set("toggle", value.toJsFn)
    
    inline def toggleFunction1(value: ReactMouseEventFrom[Any & Element] => Callback): this.type = set("toggle", js.Any.fromFunction1((t0: ReactMouseEventFrom[Any & Element]) => value(t0).runNow()))
