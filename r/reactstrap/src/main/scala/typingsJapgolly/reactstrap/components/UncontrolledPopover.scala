...
import typingsJapgolly.reactstrap.popoverMod.UncontrolledPopoverProps
...
object UncontrolledPopover {
  def apply[T](
    ...
    typingsJapgolly.reactstrap.mod.UncontrolledPopover[T], 
    Unit, 
    UncontrolledPopoverProps
  ] = {
  ...
  typingsJapgolly.reactstrap.popoverMod.UncontrolledPopoverProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.mod.UncontrolledPopover[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.popoverMod.UncontrolledPopoverProps])(children: _*)
  }
