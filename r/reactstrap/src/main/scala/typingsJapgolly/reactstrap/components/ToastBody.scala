...
import typingsJapgolly.reactstrap.typesLibToastBodyMod.ToastBodyProps
...
object ToastBody {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.ToastBody] {
  ...
  implicit def make(companion: ToastBody.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ToastBodyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
