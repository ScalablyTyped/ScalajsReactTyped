...
import typingsJapgolly.reactstrap.toastBodyMod.ToastBodyProps
import typingsJapgolly.reactstrap.toastBodyMod.default
...
object ToastBody {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ToastBodyProps, default[T], Unit, ToastBodyProps] = {
  ...
  typingsJapgolly.reactstrap.toastBodyMod.ToastBodyProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.toastBodyMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.toastBodyMod.ToastBodyProps])(children: _*)
  }
