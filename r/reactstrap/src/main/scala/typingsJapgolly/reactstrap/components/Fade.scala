...
object Fade {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Fade] {
    ...
    inline def baseClassIn(value: String): this.type = set("baseClassIn", value.asInstanceOf[js.Any])
    ...
    inline def onLeave(value: Callback): this.type = set("onLeave", value.toJsFn)
