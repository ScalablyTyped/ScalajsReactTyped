...
import typingsJapgolly.reactstrap.fadeMod.default
...
object Fade {
  def apply[T](
    ...
    onLeave: js.UndefOr[Callback] = js.undefined,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[FadeProps, default[T], Unit, FadeProps] = {
    ...
    onLeave.foreach(p => __obj.updateDynamic("onLeave")(p.toJsFn))
  ...
  typingsJapgolly.reactstrap.fadeMod.FadeProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.fadeMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.fadeMod.FadeProps])(children: _*)
  }
