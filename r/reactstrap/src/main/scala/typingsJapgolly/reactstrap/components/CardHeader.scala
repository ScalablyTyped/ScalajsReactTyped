...
import typingsJapgolly.reactstrap.cardHeaderMod.default
...
object CardHeader {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardHeaderProps, default[T], Unit, CardHeaderProps] = {
  ...
  typingsJapgolly.reactstrap.cardHeaderMod.CardHeaderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.cardHeaderMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.cardHeaderMod.CardHeaderProps])(children: _*)
  }
