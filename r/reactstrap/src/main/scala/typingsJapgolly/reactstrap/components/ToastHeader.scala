...
import typingsJapgolly.reactstrap.typesLibToastHeaderMod.ToastHeaderProps
...
object ToastHeader {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.ToastHeader] {
    ...
    inline def close(value: VdomNode): this.type = set("close", value.rawNode.asInstanceOf[js.Any])
    
    inline def closeAriaLabel(value: String): this.type = set("closeAriaLabel", value.asInstanceOf[js.Any])
    
    inline def closeNull: this.type = set("close", null)
    
    inline def closeVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("close", js.Array(value*))
    
    inline def closeVdomElement(value: VdomElement): this.type = set("close", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def icon(value: String | Node): this.type = set("icon", value.asInstanceOf[js.Any])
    ...
    inline def toggle(value: ReactMouseEventFrom[Any & org.scalajs.dom.Element] => Callback): this.type = set("toggle", js.Any.fromFunction1((t0: ReactMouseEventFrom[Any & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def wrapTag(value: ElementType): this.type = set("wrapTag", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: ToastHeader.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ToastHeaderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
