...
import typingsJapgolly.reactstrap.toastHeaderMod.ToastHeaderProps
import typingsJapgolly.reactstrap.toastHeaderMod.default
...
object ToastHeader {
  def apply[T](
    ...
    title: String = null,
    toggle: ReactMouseEventFrom[Element] => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ToastHeaderProps, default[T], Unit, ToastHeaderProps] = {
    ...
    if (toggle != null) __obj.updateDynamic("toggle")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.Element]) => toggle(t0).runNow()))
  ...
  typingsJapgolly.reactstrap.toastHeaderMod.ToastHeaderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.toastHeaderMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.toastHeaderMod.ToastHeaderProps])(children: _*)
  }
