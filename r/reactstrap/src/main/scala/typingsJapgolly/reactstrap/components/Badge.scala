...
import typingsJapgolly.reactstrap.badgeMod.default
...
object Badge {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BadgeProps, default[T], Unit, BadgeProps] = {
  ...
  typingsJapgolly.reactstrap.badgeMod.BadgeProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.badgeMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.badgeMod.BadgeProps])(children: _*)
  }
