...
import typingsJapgolly.reactstrap.typesLibBadgeMod.BadgeProps
...
object Badge {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Badge] {
    ...
    inline def pill(value: Boolean): this.type = set("pill", value.asInstanceOf[js.Any])
