...
import typingsJapgolly.reactstrap.typesLibContainerMod.ContainerProps
...
object Container {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Container] {
    ...
    inline def fluid(value: Boolean | String): this.type = set("fluid", value.asInstanceOf[js.Any])
