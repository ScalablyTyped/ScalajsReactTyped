...
import typingsJapgolly.reactstrap.containerMod.default
...
object Container {
  def apply[T](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ContainerProps, default[T], Unit, ContainerProps] = {
  ...
  typingsJapgolly.reactstrap.containerMod.ContainerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.containerMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.containerMod.ContainerProps])(children: _*)
  }
