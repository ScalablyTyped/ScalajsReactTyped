...
object UncontrolledAlert {
  def apply[T](
    ...
    typingsJapgolly.reactstrap.mod.UncontrolledAlert[T], 
    Unit, 
    UncontrolledAlertProps
  ] = {
  ...
  typingsJapgolly.reactstrap.alertMod.UncontrolledAlertProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.mod.UncontrolledAlert[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.alertMod.UncontrolledAlertProps])(children: _*)
  }
