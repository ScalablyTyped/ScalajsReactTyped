...
object UncontrolledAlert {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.UncontrolledAlert] {
    ...
    inline def closeClassName(value: String): this.type = set("closeClassName", value.asInstanceOf[js.Any])
    ...
    inline def transition(value: FadeProps): this.type = set("transition", value.asInstanceOf[js.Any])
