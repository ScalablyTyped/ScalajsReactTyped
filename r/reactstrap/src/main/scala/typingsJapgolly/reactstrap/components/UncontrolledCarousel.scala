...
object UncontrolledCarousel {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.UncontrolledCarousel] {
    ...
    inline def enableTouch(value: Boolean): this.type = set("enableTouch", value.asInstanceOf[js.Any])
    ...
    inline def interval(value: Double | String | Boolean): this.type = set("interval", value.asInstanceOf[js.Any])
    ...
    inline def mouseEnter(value: Callback): this.type = set("mouseEnter", value.toJsFn)
    
    inline def mouseExit(value: Callback): this.type = set("mouseExit", value.toJsFn)
    
    inline def next(value: Callback): this.type = set("next", value.toJsFn)
    ...
    inline def pause(value: hover | `false`): this.type = set("pause", value.asInstanceOf[js.Any])
    
    inline def placeholder(value: String): this.type = set("placeholder", value.asInstanceOf[js.Any])
    
    inline def prefix(value: String): this.type = set("prefix", value.asInstanceOf[js.Any])
    
    inline def previous(value: Callback): this.type = set("previous", value.toJsFn)
    ...
    inline def ride(value: carousel): this.type = set("ride", value.asInstanceOf[js.Any])
  ...
  def withProps(p: UncontrolledCarouselProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
