...
import typingsJapgolly.reactstrap.carouselMod.UncontrolledCarouselProps
...
object UncontrolledCarousel {
  def apply[T](
    ...
    typingsJapgolly.reactstrap.mod.UncontrolledCarousel[T], 
    Unit, 
    UncontrolledCarouselProps
  ] = {
  ...
  typingsJapgolly.reactstrap.carouselMod.UncontrolledCarouselProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.mod.UncontrolledCarousel[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.carouselMod.UncontrolledCarouselProps])(children: _*)
  }
