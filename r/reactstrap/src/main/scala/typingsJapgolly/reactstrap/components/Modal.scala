...
import typingsJapgolly.reactstrap.modalMod.ModalProps
import typingsJapgolly.reactstrap.modalMod.default
...
object Modal {
  def apply[T](
    ...
    title: String = null,
    toggle: ReactKeyboardEventFrom[Element] | ReactMouseEventFrom[Element] => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ModalProps, default[T], Unit, ModalProps] = {
    ...
    if (external != null) __obj.updateDynamic("external")(external.rawNode.asInstanceOf[js.Any])
    ...
    if (toggle != null) __obj.updateDynamic("toggle")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactKeyboardEventFrom[org.scalajs.dom.raw.Element] | japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.Element]) => toggle(t0).runNow()))
  ...
  typingsJapgolly.reactstrap.modalMod.ModalProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactstrap.modalMod.default[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactstrap.modalMod.ModalProps])(children: _*)
  }
