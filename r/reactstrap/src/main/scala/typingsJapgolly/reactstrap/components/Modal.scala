...
import typingsJapgolly.reactstrap.typesLibModalMod.ModalProps
...
object Modal {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactstrap.mod.Modal] {
    ...
    inline def backdrop(value: Boolean | static): this.type = set("backdrop", value.asInstanceOf[js.Any])
    
    inline def backdropClassName(value: String): this.type = set("backdropClassName", value.asInstanceOf[js.Any])
    
    inline def backdropTransition(value: FadeProps): this.type = set("backdropTransition", value.asInstanceOf[js.Any])
    ...
    inline def container(value: String | HTMLElement | RefHandle[HTMLElement]): this.type = set("container", value.asInstanceOf[js.Any])
    ...
    inline def cssModule(value: CSSModule): this.type = set("cssModule", value.asInstanceOf[js.Any])
    ...
    inline def external(value: VdomNode): this.type = set("external", value.rawNode.asInstanceOf[js.Any])
    
    inline def externalNull: this.type = set("external", null)
    
    inline def externalVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("external", js.Array(value*))
    
    inline def externalVdomElement(value: VdomElement): this.type = set("external", value.rawElement.asInstanceOf[js.Any])
    
    inline def fade(value: Boolean): this.type = set("fade", value.asInstanceOf[js.Any])
    
    inline def fullscreen(value: Boolean | sm | md | lg | xl): this.type = set("fullscreen", value.asInstanceOf[js.Any])
    ...
    inline def labelledBy(value: String): this.type = set("labelledBy", value.asInstanceOf[js.Any])
    
    inline def lang(value: String): this.type = set("lang", value.asInstanceOf[js.Any])
    
    inline def modalClassName(value: String): this.type = set("modalClassName", value.asInstanceOf[js.Any])
    
    inline def modalTransition(value: FadeProps): this.type = set("modalTransition", value.asInstanceOf[js.Any])
    ...
    inline def returnFocusAfterClose(value: Boolean): this.type = set("returnFocusAfterClose", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("toggle", js.Any.fromFunction1((t0: (ReactKeyboardEventFrom[Any & org.scalajs.dom.Element]) | (ReactMouseEventFrom[Any & org.scalajs.dom.Element])) => value(t0).runNow()))
    ...
    inline def unmountOnClose(value: Boolean): this.type = set("unmountOnClose", value.asInstanceOf[js.Any])
    ...
    inline def zIndex(value: Double | String): this.type = set("zIndex", value.asInstanceOf[js.Any])
  }
