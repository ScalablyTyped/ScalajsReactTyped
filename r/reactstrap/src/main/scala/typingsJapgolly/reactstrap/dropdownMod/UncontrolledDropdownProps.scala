package typingsJapgolly.reactstrap.dropdownMod
...
object UncontrolledDropdownProps {
  ...
  def apply(
    ...
    onToggle: (/* event */ ReactKeyboardEventFrom[Element] | ReactMouseEventFrom[Element], /* isOpen */ Boolean) => Callback = null,
    ...
    if (onToggle != null) __obj.updateDynamic("onToggle")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactKeyboardEventFrom[org.scalajs.dom.raw.Element] | japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.Element], t1: /* isOpen */ scala.Boolean) => onToggle(t0, t1).runNow()))
