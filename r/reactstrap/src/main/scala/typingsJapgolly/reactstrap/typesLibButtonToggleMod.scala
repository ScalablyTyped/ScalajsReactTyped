...
import typingsJapgolly.reactstrap.reactstrapStrings.button
...
import typingsJapgolly.reactstrap.reactstrapStrings.reset
...
import typingsJapgolly.reactstrap.reactstrapStrings.submit
...
object typesLibButtonToggleMod {
  
  @JSImport("reactstrap/types/lib/ButtonToggle", JSImport.Default)
  @js.native
  open class default ()
    extends Component[ButtonToggleProps, js.Object, Any]
  
  type ButtonToggle = japgolly.scalajs.react.facade.React.Component[ButtonToggleProps & js.Object, js.Object]
  
  /* Inlined parent reactstrap.reactstrap/types/lib/ButtonToggle.Omit<react.react.ButtonHTMLAttributes<std.HTMLButtonElement>, 'defaultValue'> */
  ...
  object ButtonToggleProps {
    ...
    inline def apply(): ButtonToggleProps = {
