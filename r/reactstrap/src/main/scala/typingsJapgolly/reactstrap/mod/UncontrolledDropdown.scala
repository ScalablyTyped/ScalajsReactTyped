...
import typingsJapgolly.reactstrap.typesLibDropdownMod.UncontrolledDropdownProps
...
open class UncontrolledDropdown protected ()
  extends typingsJapgolly.reactstrap.typesLibUncontrolledMod.UncontrolledDropdown {
