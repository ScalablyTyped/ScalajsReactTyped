...
import typingsJapgolly.ora.mod.Options
import typingsJapgolly.reactNativeCommunityCliTools.anon.Data
import typingsJapgolly.reactNativeCommunityCliTools.buildLoaderMod.Loader
import typingsJapgolly.reactNativeCommunityCliTools.buildLoaderMod.OraNoop
import typingsJapgolly.reactNativeCommunityCliTools.reactNativeCommunityCliToolsStrings.not_running
import typingsJapgolly.reactNativeCommunityCliTools.reactNativeCommunityCliToolsStrings.running
import typingsJapgolly.reactNativeCommunityCliTools.reactNativeCommunityCliToolsStrings.unrecognized
...
object buildMod {
  ...
  open class CLIError protected ()
    extends typingsJapgolly.reactNativeCommunityCliTools.buildErrorsMod.CLIError {
