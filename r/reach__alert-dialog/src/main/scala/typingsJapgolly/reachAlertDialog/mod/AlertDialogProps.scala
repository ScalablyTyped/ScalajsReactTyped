package typingsJapgolly.reachAlertDialog.mod
...
import typingsJapgolly.reachAlertDialog.reachAlertDialogStrings.no
...
import typingsJapgolly.reachAlertDialog.reachAlertDialogStrings.on
...
import typingsJapgolly.reachAlertDialog.reachAlertDialogStrings.yes
...
trait AlertDialogProps extends js.Object {
  ...
  var leastDestructiveRef: RefHandle[HTMLElement]
...
object AlertDialogProps {
  @scala.inline
  def apply(
    leastDestructiveRef: RefHandle[HTMLElement],
    about: String = null,
    accept: String = null,
