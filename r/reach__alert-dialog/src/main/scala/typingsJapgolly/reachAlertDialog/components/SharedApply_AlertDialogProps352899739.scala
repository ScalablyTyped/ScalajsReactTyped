...
abstract class SharedApply_AlertDialogProps352899739 () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[AlertDialogProps, LegacyRef[HTMLDivElement], Unit, AlertDialogProps] = {
  ...
  typingsJapgolly.reachAlertDialog.mod.AlertDialogProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLDivElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reachAlertDialog.mod.AlertDialogProps])(children: _*)
  }
}
