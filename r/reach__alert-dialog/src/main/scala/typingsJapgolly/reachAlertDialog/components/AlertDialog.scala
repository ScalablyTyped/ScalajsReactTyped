...
object AlertDialog {
  ...
  implicit def make(companion: AlertDialog.type): SharedBuilder_Merge_1356725188 = new SharedBuilder_Merge_1356725188(js.Array(this.component, js.Dictionary.empty))()
