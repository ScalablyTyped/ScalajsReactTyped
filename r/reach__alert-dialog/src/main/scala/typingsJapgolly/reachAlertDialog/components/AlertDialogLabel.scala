...
import typingsJapgolly.reachAlertDialog.mod.AlertDialogLabelProps
...
object AlertDialogLabel {
  ...
  implicit def make(companion: AlertDialogLabel.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
