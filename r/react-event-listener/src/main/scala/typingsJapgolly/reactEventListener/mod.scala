...
object mod {
  ...
  trait EventListenerProps[T /* <: EventTarget | WindowEventTargets */] extends StObject {
    ...
    var onMessage: js.UndefOr[
        js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ MessageEvent, Any]
      ] = js.undefined
    ...
    var onProgress: js.UndefOr[
        js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ ProgressEvent, Any]
      ] = js.undefined
  ...
  object EventListenerProps {
    ...
    extension [Self <: EventListenerProps[?], T /* <: EventTarget | WindowEventTargets */](x: Self & EventListenerProps[T]) {
      ...
      inline def setOnMessage(value: js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ MessageEvent, Any]): Self = StObject.set(x, "onMessage", value.asInstanceOf[js.Any])
      
      inline def setOnMessageCapture(value: js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ MessageEvent, Any]): Self = StObject.set(x, "onMessageCapture", value.asInstanceOf[js.Any])
      ...
      inline def setOnProgress(value: js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ ProgressEvent, Any]): Self = StObject.set(x, "onProgress", value.asInstanceOf[js.Any])
      
      inline def setOnProgressCapture(value: js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ ProgressEvent, Any]): Self = StObject.set(x, "onProgressCapture", value.asInstanceOf[js.Any])
      ...
      inline def setOnReadyStateChange(value: js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ ProgressEvent, Any]): Self = StObject.set(x, "onReadyStateChange", value.asInstanceOf[js.Any])
      
      inline def setOnReadyStateChangeCapture(value: js.ThisFunction1[/* this */ EventListenerThisType[T], /* ev */ ProgressEvent, Any]): Self = StObject.set(x, "onReadyStateChangeCapture", value.asInstanceOf[js.Any])
