...
import typingsJapgolly.hastUtilFromParse5.libMod.Space
...
object libMod {
  ...
  /* keyof rehype-parse.anon.AbandonedHeadElementChild */ /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rehypeParse.rehypeParseStrings.abandonedHeadElementChild
    - typingsJapgolly.rehypeParse.rehypeParseStrings.abruptClosingOfEmptyComment
    - typingsJapgolly.rehypeParse.rehypeParseStrings.abruptDoctypePublicIdentifier
    - typingsJapgolly.rehypeParse.rehypeParseStrings.abruptDoctypeSystemIdentifier
    - typingsJapgolly.rehypeParse.rehypeParseStrings.absenceOfDigitsInNumericCharacterReference
    - typingsJapgolly.rehypeParse.rehypeParseStrings.cdataInHtmlContent
    - typingsJapgolly.rehypeParse.rehypeParseStrings.characterReferenceOutsideUnicodeRange
    - typingsJapgolly.rehypeParse.rehypeParseStrings.closingOfElementWithOpenChildElements
    - typingsJapgolly.rehypeParse.rehypeParseStrings.controlCharacterInInputStream
    - typingsJapgolly.rehypeParse.rehypeParseStrings.controlCharacterReference
    - typingsJapgolly.rehypeParse.rehypeParseStrings.disallowedContentInNoscriptInHead
    - typingsJapgolly.rehypeParse.rehypeParseStrings.duplicateAttribute
    - typingsJapgolly.rehypeParse.rehypeParseStrings.endTagWithAttributes
    - typingsJapgolly.rehypeParse.rehypeParseStrings.endTagWithTrailingSolidus
    - typingsJapgolly.rehypeParse.rehypeParseStrings.endTagWithoutMatchingOpenElement
    - typingsJapgolly.rehypeParse.rehypeParseStrings.eofBeforeTagName
    - typingsJapgolly.rehypeParse.rehypeParseStrings.eofInCdata
    - typingsJapgolly.rehypeParse.rehypeParseStrings.eofInComment
    - typingsJapgolly.rehypeParse.rehypeParseStrings.eofInDoctype
    - typingsJapgolly.rehypeParse.rehypeParseStrings.eofInElementThatCanContainOnlyText
    - typingsJapgolly.rehypeParse.rehypeParseStrings.eofInScriptHtmlCommentLikeText
    - typingsJapgolly.rehypeParse.rehypeParseStrings.eofInTag
    - typingsJapgolly.rehypeParse.rehypeParseStrings.incorrectlyClosedComment
    - typingsJapgolly.rehypeParse.rehypeParseStrings.incorrectlyOpenedComment
    - typingsJapgolly.rehypeParse.rehypeParseStrings.invalidCharacterSequenceAfterDoctypeName
    - typingsJapgolly.rehypeParse.rehypeParseStrings.invalidFirstCharacterOfTagName
    - typingsJapgolly.rehypeParse.rehypeParseStrings.misplacedDoctype
    - typingsJapgolly.rehypeParse.rehypeParseStrings.misplacedStartTagForHeadElement
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingAttributeValue
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingDoctype
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingDoctypeName
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingDoctypePublicIdentifier
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingDoctypeSystemIdentifier
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingEndTagName
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingQuoteBeforeDoctypePublicIdentifier
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingQuoteBeforeDoctypeSystemIdentifier
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingSemicolonAfterCharacterReference
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingWhitespaceAfterDoctypePublicKeyword
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingWhitespaceAfterDoctypeSystemKeyword
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingWhitespaceBeforeDoctypeName
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingWhitespaceBetweenAttributes
    - typingsJapgolly.rehypeParse.rehypeParseStrings.missingWhitespaceBetweenDoctypePublicAndSystemIdentifiers
    - typingsJapgolly.rehypeParse.rehypeParseStrings.nestedComment
    - typingsJapgolly.rehypeParse.rehypeParseStrings.nestedNoscriptInHead
    - typingsJapgolly.rehypeParse.rehypeParseStrings.nonConformingDoctype
    - typingsJapgolly.rehypeParse.rehypeParseStrings.nonVoidHtmlElementStartTagWithTrailingSolidus
    - typingsJapgolly.rehypeParse.rehypeParseStrings.noncharacterCharacterReference
    - typingsJapgolly.rehypeParse.rehypeParseStrings.noncharacterInInputStream
    - typingsJapgolly.rehypeParse.rehypeParseStrings.nullCharacterReference
    - typingsJapgolly.rehypeParse.rehypeParseStrings.openElementsLeftAfterEof
    - typingsJapgolly.rehypeParse.rehypeParseStrings.surrogateCharacterReference
    - typingsJapgolly.rehypeParse.rehypeParseStrings.surrogateInInputStream
    - typingsJapgolly.rehypeParse.rehypeParseStrings.unexpectedCharacterAfterDoctypeSystemIdentifier
    - typingsJapgolly.rehypeParse.rehypeParseStrings.unexpectedCharacterInAttributeName
    - typingsJapgolly.rehypeParse.rehypeParseStrings.unexpectedCharacterInUnquotedAttributeValue
    - typingsJapgolly.rehypeParse.rehypeParseStrings.unexpectedEqualsSignBeforeAttributeName
    - typingsJapgolly.rehypeParse.rehypeParseStrings.unexpectedNullCharacter
    - typingsJapgolly.rehypeParse.rehypeParseStrings.unexpectedQuestionMarkInsteadOfTagName
    - typingsJapgolly.rehypeParse.rehypeParseStrings.unexpectedSolidusInTag
    - typingsJapgolly.rehypeParse.rehypeParseStrings.unknownNamedCharacterReference
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.rehypeParse.rehypeParseInts.`0`
    - typingsJapgolly.rehypeParse.rehypeParseInts.`1`
    - typingsJapgolly.rehypeParse.rehypeParseInts.`2`
    - scala.Boolean
    - scala.Null
    - scala.Unit
  */
