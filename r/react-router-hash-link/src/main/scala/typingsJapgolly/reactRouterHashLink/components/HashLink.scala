...
object HashLink {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[HashLinkProps, typingsJapgolly.reactRouterHashLink.mod.HashLink, Unit, HashLinkProps] = {
  ...
  typingsJapgolly.reactRouterHashLink.mod.HashLinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactRouterHashLink.mod.HashLink](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactRouterHashLink.mod.HashLinkProps])(children: _*)
  }
