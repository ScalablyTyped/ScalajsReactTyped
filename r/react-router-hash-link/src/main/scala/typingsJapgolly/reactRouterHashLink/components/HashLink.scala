...
import typingsJapgolly.reactRouterHashLink.mod.HashLinkProps
...
object HashLink {
  ...
  inline def apply(to: To): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[HashLinkProps & RefAttributes[HTMLAnchorElement]]))
  }
  ...
  def withProps(p: HashLinkProps & RefAttributes[HTMLAnchorElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
