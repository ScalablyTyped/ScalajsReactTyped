package typingsJapgolly.reactRouterHashLink.components
...
import typingsJapgolly.reactRouterHashLink.mod.NavHashLinkProps
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.`additions removals`
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.`additions text`
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.`inline`
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.`removals additions`
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.`removals text`
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.`text additions`
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.`text removals`
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.additions
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.all
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.ascending
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.assertive
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.both
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.copy
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.date
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.decimal
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.descending
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.dialog
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.email
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.execute
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.grammar
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.grid
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.horizontal
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.inherit
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.link
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.list
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.listbox
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.location
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.menu
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.mixed
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.move
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.no
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.none
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.numeric
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.off
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.on
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.other
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.page
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.polite
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.popup
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.removals
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.search
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.spelling
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.step
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.tel
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.text
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.time
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.tree
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.url
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.vertical
import typingsJapgolly.reactRouterHashLink.reactRouterHashLinkStrings.yes
...
object NavHashLink {
  ...
  inline def apply(
    children: (js.UndefOr[Node | (js.Function1[/* props */ IsActive, Node])]) & js.UndefOr[Node],
    to: To
  ): Builder = {
    val __props = js.Dynamic.literal(children = children.asInstanceOf[js.Any], to = to.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[NavHashLinkProps & RefAttributes[HTMLAnchorElement]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def className(value: String | (js.Function1[/* props */ IsActive, js.UndefOr[String]])): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def classNameFunction1(value: /* props */ IsActive => js.UndefOr[String]): this.type = set("className", js.Any.fromFunction1(value))
    ...
    inline def end(value: Boolean): this.type = set("end", value.asInstanceOf[js.Any])
    ...
    inline def preventScrollReset(value: Boolean): this.type = set("preventScrollReset", value.asInstanceOf[js.Any])
    ...
    inline def relative(value: RelativeRoutingType): this.type = set("relative", value.asInstanceOf[js.Any])
    
    inline def reloadDocument(value: Boolean): this.type = set("reloadDocument", value.asInstanceOf[js.Any])
    ...
    inline def scroll(value: /* element */ HTMLElement => Callback): this.type = set("scroll", js.Any.fromFunction1((t0: /* element */ HTMLElement) => value(t0).runNow()))
    ...
    inline def style(value: CSSProperties | (js.Function1[/* props */ IsActive, js.UndefOr[CSSProperties]])): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def styleFunction1(value: /* props */ IsActive => js.UndefOr[CSSProperties]): this.type = set("style", js.Any.fromFunction1(value))
  ...
  def withProps(p: NavHashLinkProps & RefAttributes[HTMLAnchorElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
