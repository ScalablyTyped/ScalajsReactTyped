...
object NavHashLink {
  def apply(
    ...
    is: String = null,
    isActive: (/* match */ `match`[js.Any], /* location */ Location[LocationState]) => CallbackTo[Boolean] = null,
    itemID: String = null,
    ...
    role: String = null,
    scroll: /* element */ HTMLElement => Callback = null,
    ...
    NavHashLinkProps, 
    typingsJapgolly.reactRouterHashLink.mod.NavHashLink, 
    Unit, 
    NavHashLinkProps
  ] = {
    ...
    if (isActive != null) __obj.updateDynamic("isActive")(js.Any.fromFunction2((t0: /* match */ typingsJapgolly.reactRouter.mod.`match`[js.Any], t1: /* location */ typingsJapgolly.history.mod.Location[typingsJapgolly.history.mod.LocationState]) => isActive(t0, t1).runNow()))
    ...
    if (scroll != null) __obj.updateDynamic("scroll")(js.Any.fromFunction1((t0: /* element */ org.scalajs.dom.raw.HTMLElement) => scroll(t0).runNow()))
  ...
  typingsJapgolly.reactRouterHashLink.mod.NavHashLinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactRouterHashLink.mod.NavHashLink](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactRouterHashLink.mod.NavHashLinkProps])(children: _*)
  }
