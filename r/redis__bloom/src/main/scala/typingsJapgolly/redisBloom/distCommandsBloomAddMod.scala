...
object distCommandsBloomAddMod {
  
  @JSImport("@redis/bloom/dist/commands/bloom/ADD", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/bloom/dist/commands/bloom/ADD", "FIRST_KEY_INDEX")
  @js.native
