...
trait TransformArgumentsTransformReply extends StObject {
  ...
  def transformArguments(
    key: String,
    items: js.Array[IncrByItem | typingsJapgolly.redisBloom.distCommandsTopKIncrbyMod.IncrByItem]
  ): js.Array[String] = js.native
  def transformArguments(key: String, items: IncrByItem): js.Array[String] = js.native
  def transformArguments(key: String, items: typingsJapgolly.redisBloom.distCommandsTopKIncrbyMod.IncrByItem): js.Array[String] = js.native
