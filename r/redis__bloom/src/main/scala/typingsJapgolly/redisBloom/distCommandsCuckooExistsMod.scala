...
object distCommandsCuckooExistsMod {
  
  @JSImport("@redis/bloom/dist/commands/cuckoo/EXISTS", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/bloom/dist/commands/cuckoo/EXISTS", "FIRST_KEY_INDEX")
  @js.native
  val FIRST_KEY_INDEX: /* 1 */ Double = js.native
  
  @JSImport("@redis/bloom/dist/commands/cuckoo/EXISTS", "IS_READ_ONLY")
  @js.native
