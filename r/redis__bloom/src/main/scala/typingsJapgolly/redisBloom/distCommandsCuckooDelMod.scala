...
object distCommandsCuckooDelMod {
  
  @JSImport("@redis/bloom/dist/commands/cuckoo/DEL", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/bloom/dist/commands/cuckoo/DEL", "FIRST_KEY_INDEX")
  @js.native
