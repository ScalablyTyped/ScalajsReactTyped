...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNativeAwesomeCardIo.reactNativeAwesomeCardIoStrings.IMAGE_AND_NUMBER
    - typingsJapgolly.reactNativeAwesomeCardIo.reactNativeAwesomeCardIoStrings.IMAGE
    - typingsJapgolly.reactNativeAwesomeCardIo.reactNativeAwesomeCardIoStrings.AUTOMATIC
  */
  trait CardIODetectionMode extends StObject
  object CardIODetectionMode {
    
    inline def AUTOMATIC: typingsJapgolly.reactNativeAwesomeCardIo.reactNativeAwesomeCardIoStrings.AUTOMATIC = "AUTOMATIC".asInstanceOf[typingsJapgolly.reactNativeAwesomeCardIo.reactNativeAwesomeCardIoStrings.AUTOMATIC]
    
    inline def IMAGE: typingsJapgolly.reactNativeAwesomeCardIo.reactNativeAwesomeCardIoStrings.IMAGE = "IMAGE".asInstanceOf[typingsJapgolly.reactNativeAwesomeCardIo.reactNativeAwesomeCardIoStrings.IMAGE]
    
    inline def IMAGE_AND_NUMBER: typingsJapgolly.reactNativeAwesomeCardIo.reactNativeAwesomeCardIoStrings.IMAGE_AND_NUMBER = "IMAGE_AND_NUMBER".asInstanceOf[typingsJapgolly.reactNativeAwesomeCardIo.reactNativeAwesomeCardIoStrings.IMAGE_AND_NUMBER]
  }
  ...
  object CardIOViewProps {
    ...
    inline def apply(didScanCard: CardDetails => Callback): CardIOViewProps = {
      val __obj = js.Dynamic.literal(didScanCard = js.Any.fromFunction1((t0: CardDetails) => didScanCard(t0).runNow()))
      __obj.asInstanceOf[CardIOViewProps]
    }
    
    extension [Self <: CardIOViewProps](x: Self) {
      
      inline def setDidScanCard(value: CardDetails => Callback): Self = StObject.set(x, "didScanCard", js.Any.fromFunction1((t0: CardDetails) => value(t0).runNow()))
