...
trait ErroredInputs extends StObject {
  ...
  /**
    ...
    */
  var erroredInputs: typingsJapgolly.reactPaymentInputs.mod.ErroredInputs
...
object ErroredInputs {
  ...
  inline def apply(
    ...
    error: String,
    erroredInputs: typingsJapgolly.reactPaymentInputs.mod.ErroredInputs,
    focused: Boolean,
    isTouched: Boolean,
    touchedInputs: Cvc
  ): ErroredInputs = {
  ...
  extension [Self <: ErroredInputs](x: Self) {
    ...
    inline def setErroredInputs(value: typingsJapgolly.reactPaymentInputs.mod.ErroredInputs): Self = StObject.set(x, "erroredInputs", value.asInstanceOf[js.Any])
