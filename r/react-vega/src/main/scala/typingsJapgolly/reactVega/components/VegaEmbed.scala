...
import typingsJapgolly.reactVega.libVegaEmbedMod.VegaEmbedProps
import typingsJapgolly.reactVega.libVegaEmbedMod.default
...
import typingsJapgolly.vegaEmbed.vegaEmbedStrings.dark
import typingsJapgolly.vegaEmbed.vegaEmbedStrings.excel
import typingsJapgolly.vegaEmbed.vegaEmbedStrings.ggplot2
import typingsJapgolly.vegaEmbed.vegaEmbedStrings.quartz
import typingsJapgolly.vegaEmbed.vegaEmbedStrings.vox
...
object VegaEmbed {
  ...
  inline def apply(spec: VisualizationSpec): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[VegaEmbedProps]))
  }
  ...
  def withProps(p: VegaEmbedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
