...
object VegaLite {
  ...
  inline def apply(spec: VisualizationSpec): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[VegaLiteProps]))
  }
  
  @JSImport("react-vega", "VegaLite")
  @js.native
  ...
  def withProps(p: VegaLiteProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
