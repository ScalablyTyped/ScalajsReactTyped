...
import typingsJapgolly.reactVega.mod.VegaPropsWithoutSpec
...
object VegaWithSpec {
  def apply(
    ...
    typingsJapgolly.reactVega.mod.VegaWithSpec, 
    Unit, 
    VegaPropsWithoutSpec
  ] = {
  ...
  typingsJapgolly.reactVega.mod.VegaPropsWithoutSpec, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactVega.mod.VegaWithSpec](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactVega.mod.VegaPropsWithoutSpec])(children: _*)
  }
