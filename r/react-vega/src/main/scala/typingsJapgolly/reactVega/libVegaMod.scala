...
import typingsJapgolly.vega.mod.View
...
object libVegaMod {
  ...
  @JSImport("react-vega/lib/Vega", JSImport.Default)
  @js.native
  open class default () extends Vega
  /* static members */
  object default {
    ...
    @JSImport("react-vega/lib/Vega", "default.defaultProps")
    @js.native
  ...
  @js.native
  trait Vega
    extends PureComponent[VegaProps, js.Object, Any] {
    
    @JSName("componentDidMount")
    def componentDidMount_MVega(): Unit = js.native
    
    @JSName("componentDidUpdate")
    def componentDidUpdate_MVega(prevProps: VegaProps): Unit = js.native
    
    var handleNewView: ViewListener = js.native
    
    def update(): Unit = js.native
    
    var vegaEmbed: RefHandle[typingsJapgolly.reactVega.libVegaEmbedMod.default] = js.native
  }
  
  /* Inlined react-vega.react-vega/lib/VegaEmbed.VegaEmbedProps & {  data :react-vega.react-vega/lib/types.PlainObject | undefined} */
  trait VegaProps extends StObject {
  ...
  object VegaProps {
    ...
    inline def apply(spec: VisualizationSpec): VegaProps = {
    ...
    extension [Self <: VegaProps](x: Self) {
      ...
      inline def setOnNewView(value: /* view */ typingsJapgolly.reactVega.libTypesMod.View => Callback): Self = StObject.set(x, "onNewView", js.Any.fromFunction1((t0: /* view */ typingsJapgolly.reactVega.libTypesMod.View) => value(t0).runNow()))
      ...
      ): Self = StObject.set(x, "tooltip", js.Any.fromFunction4((t0: /* handler */ Any, t1: /* event */ MouseEvent, t2: /* item */ Item[Any], t3: /* value */ Any) => (value(t0, t1, t2, t3)).runNow()))
