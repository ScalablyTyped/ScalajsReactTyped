...
object libCreateClassFromSpecMod {
  ...
  trait FixedVegaChartProps extends StObject {
    ...
    var mode: js.UndefOr[typingsJapgolly.vegaEmbed.mod.Mode] = js.undefined
  ...
  object FixedVegaChartProps {
    ...
    extension [Self <: FixedVegaChartProps](x: Self) {
      ...
      inline def setMode(value: typingsJapgolly.vegaEmbed.mod.Mode): Self = StObject.set(x, "mode", value.asInstanceOf[js.Any])
