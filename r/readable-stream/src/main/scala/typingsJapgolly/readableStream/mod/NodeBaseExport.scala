...
import typingsJapgolly.readableStream.readableStreamStrings.close
import typingsJapgolly.readableStream.readableStreamStrings.data
import typingsJapgolly.readableStream.readableStreamStrings.end
import typingsJapgolly.readableStream.readableStreamStrings.error
import typingsJapgolly.readableStream.readableStreamStrings.readable
...
@js.native
object NodeBaseExport extends js.Object {
  var Duplex: typingsJapgolly.node.streamMod.Duplex = js.native
  var PassThrough: typingsJapgolly.node.streamMod.PassThrough = js.native
  var Readable: typingsJapgolly.node.streamMod.Readable = js.native
  var Stream: typingsJapgolly.node.streamMod.^ = js.native
  var Transform: typingsJapgolly.node.streamMod.Transform = js.native
  var Writable: typingsJapgolly.node.streamMod.Writable = js.native
