...
- typingsJapgolly.readableStream.mod.IEventEmitter because Already inherited
- typingsJapgolly.readableStream.mod.IWritable because Already inherited
- typingsJapgolly.readableStream.mod.IReadable because Already inherited
- typingsJapgolly.readableStream.mod.IDuplex because var conflicts: writable. Inlined  */ @JSImport("readable-stream", "Duplex")
@js.native
// end-Readable
