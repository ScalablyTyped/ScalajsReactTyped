...
import typingsJapgolly.raygun.buildRaygunDotbatchMod.RaygunBatchTransport
import typingsJapgolly.raygun.buildTypesMod.CustomData
import typingsJapgolly.raygun.buildTypesMod.Hook
import typingsJapgolly.raygun.buildTypesMod.IOfflineStorage
import typingsJapgolly.raygun.buildTypesMod.Message
import typingsJapgolly.raygun.buildTypesMod.OfflineStorageOptions
import typingsJapgolly.raygun.buildTypesMod.RawUserData
import typingsJapgolly.raygun.buildTypesMod.RaygunOptions
import typingsJapgolly.raygun.buildTypesMod.Tag
import typingsJapgolly.raygun.buildTypesMod.Transport
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object buildRaygunREMOTE11095Mod {
  
  @JSImport("raygun/build/raygun_REMOTE_11095", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object default {
    
    @JSImport("raygun/build/raygun_REMOTE_11095", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("raygun/build/raygun_REMOTE_11095", "default.Client")
    @js.native
    open class Client ()
      extends StObject
         with Raygun
    ...
    @JSImport("raygun/build/raygun_REMOTE_11095", "default.addBreadcrumb")
    @js.native
    ...
    @JSImport("raygun/build/raygun_REMOTE_11095", "default.runWithBreadcrumbs")
    @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("raygun/build/raygun_REMOTE_11095", "Client")
  @js.native
  open class Client ()
    extends StObject
       with Raygun
