...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.raygun.anon.hoststringCommonRequestPa
  - typingsJapgolly.raygun.anon.hostnamestringCommonReque
*/
...
object RequestParams {
  ...
  inline def hostnamestringCommonReque(
    ...
    __obj.asInstanceOf[typingsJapgolly.raygun.anon.hostnamestringCommonReque]
  }
  ...
  inline def hoststringCommonRequestPa(
    ...
    __obj.asInstanceOf[typingsJapgolly.raygun.anon.hoststringCommonRequestPa]
  }
}
