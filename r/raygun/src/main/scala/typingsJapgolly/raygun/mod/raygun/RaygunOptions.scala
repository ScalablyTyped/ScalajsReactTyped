...
object RaygunOptions {
  ...
  def apply(
    ...
    onBeforeSend: (/* payload */ RaygunPayload, /* exception */ js.Error, /* customData */ KeyValueObject, /* request */ RaygunRequest, /* tags */ js.Array[String]) => CallbackTo[Boolean | RaygunPayload] = null,
    ...
    if (onBeforeSend != null) __obj.updateDynamic("onBeforeSend")(js.Any.fromFunction5((t0: /* payload */ typingsJapgolly.raygun.mod.raygun.RaygunPayload, t1: /* exception */ js.Error, t2: /* customData */ typingsJapgolly.raygun.mod.raygun.KeyValueObject, t3: /* request */ typingsJapgolly.raygun.mod.raygun.RaygunRequest, t4: /* tags */ js.Array[java.lang.String]) => onBeforeSend(t0, t1, t2, t3, t4).runNow()))
