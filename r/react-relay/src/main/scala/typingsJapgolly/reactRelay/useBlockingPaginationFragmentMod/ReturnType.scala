package typingsJapgolly.reactRelay.useBlockingPaginationFragmentMod
...
object ReturnType {
  ...
  def apply[TQuery /* <: OperationType */, TKey, TFragmentData](
    ...
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], hasNext = hasNext.asInstanceOf[js.Any], hasPrevious = hasPrevious.asInstanceOf[js.Any], refetch = refetch.asInstanceOf[js.Any])
