...
package object useFragmentMod {
  type ArrayKeyReturnType[T /* <: typingsJapgolly.reactRelay.useFragmentMod.ArrayKeyType */] = js.Function1[
    /* arg */ T, 
    /* import warning: importer.ImportType#apply Failed type conversion: std.NonNullable<std.NonNullable<T[0]>[' $data']>[0] */ js.Any
  ]
  type ArrayKeyType = js.Array[typingsJapgolly.reactRelay.AnonDataReadonlyArray | scala.Null]
  ...
  type KeyReturnType[T /* <: typingsJapgolly.reactRelay.useFragmentMod.KeyType */] = js.Function1[
    /* arg */ T, 
    typingsJapgolly.std.NonNullable[
