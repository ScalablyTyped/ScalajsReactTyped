...
/** NOTE: Conditional type definitions are impossible to translate to Scala.
  ...
  * TS definition: {{{
  TEntryPointComponent extends react-relay.react-relay/relay-hooks/EntryPointTypes.EntryPointComponent<infer TPreloadedQueries, infer TPreloadedEntryPoints, infer TRuntimeProps, infer TExtraProps> ? std.Readonly<{  dispose :relay-runtime.relay-runtime/lib/util/RelayRuntimeTypes.DisposeFn,   entryPoints :TPreloadedEntryPoints,   extraProps :TExtraProps, getComponent (): TEntryPointComponent,   isDisposed :boolean,   queries :react-relay.react-relay/relay-hooks/EntryPointTypes.PreloadedQueries<TPreloadedQueries>,   rootModuleID :string}> : never
  }}}
  */
@js.native
