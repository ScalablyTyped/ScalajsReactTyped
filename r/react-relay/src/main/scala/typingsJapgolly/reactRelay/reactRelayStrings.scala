...
import typingsJapgolly.reactRelay.entryPointTypesMod.PreloadFetchPolicy
...
import typingsJapgolly.reactRelay.useLoadMoreFunctionMod.Direction
...
object reactRelayStrings {
  ...
  sealed trait `network-only`
    extends FetchPolicy
       with typingsJapgolly.reactRelay.mod.FetchPolicy
