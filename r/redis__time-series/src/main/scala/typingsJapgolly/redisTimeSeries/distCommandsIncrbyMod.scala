...
object distCommandsIncrbyMod {
  
  @JSImport("@redis/time-series/dist/commands/INCRBY", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/time-series/dist/commands/INCRBY", "FIRST_KEY_INDEX")
  @js.native
