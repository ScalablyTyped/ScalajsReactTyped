...
import typingsJapgolly.redisTimeSeries.distCommandsInfoDEBUGMod.InfoDebugRawReply
import typingsJapgolly.redisTimeSeries.distCommandsInfoDEBUGMod.InfoDebugReply
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait TypeofINFODEBUG extends StObject {
  ...
  def transformReply(rawReply: InfoDebugRawReply): InfoDebugReply
}
object TypeofINFODEBUG {
  
  inline def apply(
    FIRST_KEY_INDEX: /* 1 */ Double,
    IS_READ_ONLY: /* true */ Boolean,
    transformArguments: String => js.Array[String],
    transformReply: InfoDebugRawReply => InfoDebugReply
  ): TypeofINFODEBUG = {
  ...
  extension [Self <: TypeofINFODEBUG](x: Self) {
    ...
    inline def setTransformReply(value: InfoDebugRawReply => InfoDebugReply): Self = StObject.set(x, "transformReply", js.Any.fromFunction1(value))
  }
}
