package typingsJapgolly.reactImage.components
...
object Img {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def container(value: /* children */ Node => Element): this.type = set("container", js.Any.fromFunction1(value))
    ...
    inline def decode(value: Boolean): this.type = set("decode", value.asInstanceOf[js.Any])
    ...
    inline def imgPromise(value: /* repeated */ Any => js.Promise[Unit]): this.type = set("imgPromise", js.Any.fromFunction1(value))
    ...
    inline def loaderContainer(value: /* children */ Node => Element): this.type = set("loaderContainer", js.Any.fromFunction1(value))
    ...
    inline def onClick(value: ReactMouseEventFrom[HTMLImageElement & org.scalajs.dom.Element] => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLImageElement & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def onError(value: ReactEventFrom[HTMLImageElement & org.scalajs.dom.Element] => Callback): this.type = set("onError", js.Any.fromFunction1((t0: ReactEventFrom[HTMLImageElement & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def unloader(value: VdomElement): this.type = set("unloader", value.rawElement.asInstanceOf[js.Any])
    
    inline def unloaderContainer(value: /* children */ Node => Element): this.type = set("unloaderContainer", js.Any.fromFunction1(value))
    
    inline def unloaderNull: this.type = set("unloader", null)
