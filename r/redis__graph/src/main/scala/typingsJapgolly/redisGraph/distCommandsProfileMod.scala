...
object distCommandsProfileMod {
  
  @JSImport("@redis/graph/dist/commands/PROFILE", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/graph/dist/commands/PROFILE", "FIRST_KEY_INDEX")
  @js.native
  val FIRST_KEY_INDEX: /* 1 */ Double = js.native
  
  @JSImport("@redis/graph/dist/commands/PROFILE", "IS_READ_ONLY")
  @js.native
