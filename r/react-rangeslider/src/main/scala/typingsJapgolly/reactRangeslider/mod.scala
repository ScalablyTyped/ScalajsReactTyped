...
object mod {
  ...
  type Slider = japgolly.scalajs.react.facade.React.Component[SliderProps & js.Object, js.Object]
  ...
  object SliderProps {
    ...
    extension [Self <: SliderProps](x: Self) {
      ...
      inline def setOnChangeComplete(value: /* value */ Double => Callback): Self = StObject.set(x, "onChangeComplete", js.Any.fromFunction1((t0: /* value */ Double) => value(t0).runNow()))
      
      inline def setOnChangeCompleteUndefined: Self = StObject.set(x, "onChangeComplete", js.undefined)
      
      inline def setOnChangeStart(value: /* value */ Double => Callback): Self = StObject.set(x, "onChangeStart", js.Any.fromFunction1((t0: /* value */ Double) => value(t0).runNow()))
