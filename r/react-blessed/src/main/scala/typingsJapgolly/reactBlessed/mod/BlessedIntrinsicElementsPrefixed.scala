...
trait BlessedIntrinsicElementsPrefixed extends StObject {
  ...
  var layout: DetailedBlessedProps[typingsJapgolly.blessed.mod.Widgets.LayoutElement]
  ...
  var terminal: DetailedBlessedProps[typingsJapgolly.blessed.mod.Widgets.TerminalElement]
...
object BlessedIntrinsicElementsPrefixed {
  ...
  extension [Self <: BlessedIntrinsicElementsPrefixed](x: Self) {
    ...
    inline def setLayout(value: DetailedBlessedProps[typingsJapgolly.blessed.mod.Widgets.LayoutElement]): Self = StObject.set(x, "layout", value.asInstanceOf[js.Any])
    ...
    inline def setTerminal(value: DetailedBlessedProps[typingsJapgolly.blessed.mod.Widgets.TerminalElement]): Self = StObject.set(x, "terminal", value.asInstanceOf[js.Any])
