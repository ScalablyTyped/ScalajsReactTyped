...
import typingsJapgolly.reduxUi.AnonPure
...
object uiParams {
  ...
  def apply[UIStateShape](
    state: UIStateShape,
    key: String = null,
    mergeProps: (/* stateProps */ js.Any, /* dispatchProps */ js.Any, /* ownProps */ js.Any) => CallbackTo[js.Any] = null,
    options: AnonPure = null,
    persist: js.UndefOr[Boolean] = js.undefined,
    reducer: (/* state */ js.Any, /* action */ js.Any) => CallbackTo[js.Any] = null
  ): uiParams[UIStateShape] = {
    val __obj = js.Dynamic.literal(state = state.asInstanceOf[js.Any])
    if (key != null) __obj.updateDynamic("key")(key.asInstanceOf[js.Any])
    if (mergeProps != null) __obj.updateDynamic("mergeProps")(js.Any.fromFunction3((t0: /* stateProps */ js.Any, t1: /* dispatchProps */ js.Any, t2: /* ownProps */ js.Any) => mergeProps(t0, t1, t2).runNow()))
    if (options != null) __obj.updateDynamic("options")(options.asInstanceOf[js.Any])
    if (!js.isUndefined(persist)) __obj.updateDynamic("persist")(persist.asInstanceOf[js.Any])
    if (reducer != null) __obj.updateDynamic("reducer")(js.Any.fromFunction2((t0: /* state */ js.Any, t1: /* action */ js.Any) => reducer(t0, t1).runNow()))
