package typingsJapgolly.rollupPluginCssOnly

import japgolly.scalajs.react.Callback
import typingsJapgolly.rollup.mod.OutputBundle
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOutputFunction3(
        value: (/* styles */ String, /* styleNodes */ Record[String, String], /* bundle */ OutputBundle) => Callback
      ): Self = StObject.set(x, "output", js.Any.fromFunction3((t0: /* styles */ String, t1: /* styleNodes */ Record[String, String], t2: /* bundle */ OutputBundle) => (value(t0, t1, t2)).runNow()))
