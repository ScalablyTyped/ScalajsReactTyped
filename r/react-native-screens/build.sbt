...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "react-native-reanimated" % "2.11.0-2274f2",
  ...
  "org.scalablytyped.japgolly" %%% "react-navigation__core" % "6.4.0-a686b2",
  "org.scalablytyped.japgolly" %%% "react-navigation__routers" % "6.1.3-5c2868",
