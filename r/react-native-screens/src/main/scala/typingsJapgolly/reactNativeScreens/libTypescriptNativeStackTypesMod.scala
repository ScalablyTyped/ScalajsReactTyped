...
import typingsJapgolly.reactNativeScreens.anon.BackgroundColor
import typingsJapgolly.reactNativeScreens.anon.BlurEffect
import typingsJapgolly.reactNativeScreens.anon.Color
import typingsJapgolly.reactNativeScreens.anon.Data
import typingsJapgolly.reactNativeScreens.anon.DataClosingBoolean
import typingsJapgolly.reactNativeScreens.anon.FontFamily
import typingsJapgolly.reactNativeScreens.anon.`0`
...
import typingsJapgolly.reactNavigationRouters.libTypescriptSrcStackRouterMod.StackActionHelpers
...
object libTypescriptNativeStackTypesMod {
  ...
  trait NativeStackNavigationOptions extends StObject {
    ...
    /**
      ...
      */
    var headerCenter: js.UndefOr[js.Function1[/* props */ `0`, Node]] = js.undefined
    ...
    /**
      ...
      */
    var headerLeft: js.UndefOr[js.Function1[/* props */ `0`, Node]] = js.undefined
  ...
  object NativeStackNavigationOptions {
    ...
    extension [Self <: NativeStackNavigationOptions](x: Self) {
      ...
      inline def setHeaderCenter(value: /* props */ `0` => Node): Self = StObject.set(x, "headerCenter", js.Any.fromFunction1(value))
      ...
      inline def setHeaderLeft(value: /* props */ `0` => Node): Self = StObject.set(x, "headerLeft", js.Any.fromFunction1(value))
