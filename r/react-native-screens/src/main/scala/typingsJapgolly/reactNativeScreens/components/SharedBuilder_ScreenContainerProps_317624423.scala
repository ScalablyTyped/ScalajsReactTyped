...
@scala.inline
open class SharedBuilder_ScreenContainerProps_317624423 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def hasTwoStates(value: Boolean): this.type = set("hasTwoStates", value.asInstanceOf[js.Any])
