...
object ScreenStack {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onFinishTransitioning(value: /* e */ NativeSyntheticEvent[TargetedEvent] => Callback): this.type = set("onFinishTransitioning", js.Any.fromFunction1((t0: /* e */ NativeSyntheticEvent[TargetedEvent]) => value(t0).runNow()))
