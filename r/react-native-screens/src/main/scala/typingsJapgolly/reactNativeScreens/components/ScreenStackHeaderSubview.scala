...
import typingsJapgolly.reactNativeScreens.anon.PropsWithChildrenViewProp
import typingsJapgolly.reactNativeScreens.libTypescriptTypesMod.HeaderSubviewTypes
...
object ScreenStackHeaderSubview {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def `type`(value: HeaderSubviewTypes): this.type = set("type", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: ScreenStackHeaderSubview.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PropsWithChildrenViewProp): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
