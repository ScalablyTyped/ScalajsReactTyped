...
object ScreenStackHeaderSearchBarView {
  
  @JSImport("react-native-screens", "ScreenStackHeaderSearchBarView")
  @js.native
  ...
  implicit def make(companion: ScreenStackHeaderSearchBarView.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PropsWithChildren[SearchBarProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
