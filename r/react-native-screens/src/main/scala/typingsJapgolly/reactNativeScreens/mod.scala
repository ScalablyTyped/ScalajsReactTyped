...
import typingsJapgolly.reactNativeScreens.anon.Closing
...
import typingsJapgolly.reactNativeScreens.libTypescriptTypesMod.ScreenStackHeaderConfigProps
import typingsJapgolly.reactNativeScreens.libTypescriptTypesMod.ScreenStackProps
