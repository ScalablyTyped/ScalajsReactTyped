...
trait PickScreenPropschildrenac extends StObject {
  ...
  var active: js.UndefOr[
    typingsJapgolly.reactNativeScreens.reactNativeScreensInts.`0` | `1` | (AnimatedInterpolation[Double | String])
  ] = js.undefined
  
  var activityState: js.UndefOr[
    typingsJapgolly.reactNativeScreens.reactNativeScreensInts.`0` | `1` | `2` | (AnimatedInterpolation[Double | String])
  ] = js.undefined
  ...
  var ref: js.UndefOr[Ref[ComponentClassP[AnimateProps[js.Object] & js.Object]]] = js.undefined
...
object PickScreenPropschildrenac {
  ...
  extension [Self <: PickScreenPropschildrenac](x: Self) {
    ...
    inline def setActive(
      value: typingsJapgolly.reactNativeScreens.reactNativeScreensInts.`0` | `1` | (AnimatedInterpolation[Double | String])
    ): Self = StObject.set(x, "active", value.asInstanceOf[js.Any])
    
    inline def setActiveUndefined: Self = StObject.set(x, "active", js.undefined)
    
    inline def setActivityState(
      value: typingsJapgolly.reactNativeScreens.reactNativeScreensInts.`0` | `1` | `2` | (AnimatedInterpolation[Double | String])
    ...
    inline def setOnAppear(value: /* e */ NativeSyntheticEvent[TargetedEvent] => Callback): Self = StObject.set(x, "onAppear", js.Any.fromFunction1((t0: /* e */ NativeSyntheticEvent[TargetedEvent]) => value(t0).runNow()))
    
    inline def setOnAppearUndefined: Self = StObject.set(x, "onAppear", js.undefined)
    
    inline def setOnComponentRef(value: /* view */ Any => Callback): Self = StObject.set(x, "onComponentRef", js.Any.fromFunction1((t0: /* view */ Any) => value(t0).runNow()))
    
    inline def setOnComponentRefUndefined: Self = StObject.set(x, "onComponentRef", js.undefined)
    
    inline def setOnDisappear(value: /* e */ NativeSyntheticEvent[TargetedEvent] => Callback): Self = StObject.set(x, "onDisappear", js.Any.fromFunction1((t0: /* e */ NativeSyntheticEvent[TargetedEvent]) => value(t0).runNow()))
    
    inline def setOnDisappearUndefined: Self = StObject.set(x, "onDisappear", js.undefined)
    
    inline def setOnDismissed(value: /* e */ NativeSyntheticEvent[DismissCount] => Callback): Self = StObject.set(x, "onDismissed", js.Any.fromFunction1((t0: /* e */ NativeSyntheticEvent[DismissCount]) => value(t0).runNow()))
    
    inline def setOnDismissedUndefined: Self = StObject.set(x, "onDismissed", js.undefined)
    
    inline def setOnHeaderBackButtonClicked(value: Callback): Self = StObject.set(x, "onHeaderBackButtonClicked", value.toJsFn)
    ...
    inline def setOnNativeDismissCancelled(value: /* e */ NativeSyntheticEvent[DismissCount] => Callback): Self = StObject.set(x, "onNativeDismissCancelled", js.Any.fromFunction1((t0: /* e */ NativeSyntheticEvent[DismissCount]) => value(t0).runNow()))
    ...
    inline def setOnTransitionProgress(value: /* e */ NativeSyntheticEvent[TransitionProgressEventType] => Callback): Self = StObject.set(x, "onTransitionProgress", js.Any.fromFunction1((t0: /* e */ NativeSyntheticEvent[TransitionProgressEventType]) => value(t0).runNow()))
    
    inline def setOnTransitionProgressUndefined: Self = StObject.set(x, "onTransitionProgress", js.undefined)
    
    inline def setOnWillAppear(value: /* e */ NativeSyntheticEvent[TargetedEvent] => Callback): Self = StObject.set(x, "onWillAppear", js.Any.fromFunction1((t0: /* e */ NativeSyntheticEvent[TargetedEvent]) => value(t0).runNow()))
    
    inline def setOnWillAppearUndefined: Self = StObject.set(x, "onWillAppear", js.undefined)
    
    inline def setOnWillDisappear(value: /* e */ NativeSyntheticEvent[TargetedEvent] => Callback): Self = StObject.set(x, "onWillDisappear", js.Any.fromFunction1((t0: /* e */ NativeSyntheticEvent[TargetedEvent]) => value(t0).runNow()))
    ...
    inline def setRef(value: Ref[ComponentClassP[AnimateProps[js.Object] & js.Object]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: (ComponentClassP[AnimateProps[js.Object] & js.Object]) | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: (ComponentClassP[AnimateProps[js.Object] & js.Object]) | Null) => value(t0).runNow()))
