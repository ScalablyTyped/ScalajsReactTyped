...
import typingsJapgolly.reactNativeScreens.anon.TintColor
import typingsJapgolly.reactNativeScreens.reactNativeScreensStrings.containedModal
import typingsJapgolly.reactNativeScreens.reactNativeScreensStrings.modal
...
object libTypescriptCreateNativeStackNavigatorMod {
  ...
  - typingsJapgolly.reactNativeScreens.libTypescriptCreateNativeStackNavigatorMod.BackButtonProps because var conflicts: headerBackTitleStyle, headerTintColor. Inlined headerBackImage, headerPressColorAndroid, backButtonTitle, truncatedBackButtonTitle, backTitleVisible, layoutPreset */ trait NativeStackNavigationOptions
    extends StObject
       with StackNavigatorOptions
       with typingsJapgolly.reactNativeScreens.libTypescriptNativeStackTypesMod.NativeStackNavigationOptions {
  ...
  object NativeStackNavigationOptions {
    ...
    extension [Self <: NativeStackNavigationOptions](x: Self) {
      ...
      inline def setOnAppear(value: Callback): Self = StObject.set(x, "onAppear", value.toJsFn)
      
      inline def setOnAppearUndefined: Self = StObject.set(x, "onAppear", js.undefined)
      
      inline def setOnDisappear(value: Callback): Self = StObject.set(x, "onDisappear", value.toJsFn)
      
      inline def setOnDisappearUndefined: Self = StObject.set(x, "onDisappear", js.undefined)
      
      inline def setOnWillAppear(value: Callback): Self = StObject.set(x, "onWillAppear", value.toJsFn)
      
      inline def setOnWillAppearUndefined: Self = StObject.set(x, "onWillAppear", js.undefined)
      
      inline def setOnWillDisappear(value: Callback): Self = StObject.set(x, "onWillDisappear", value.toJsFn)
