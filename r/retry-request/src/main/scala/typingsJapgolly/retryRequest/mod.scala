...
import typingsJapgolly.retryRequest.anon.Abort
...
object mod {
  ...
  inline def apply(requestOpts: typingsJapgolly.request.mod.Options): Abort = ^.asInstanceOf[js.Dynamic].apply(requestOpts.asInstanceOf[js.Any]).asInstanceOf[Abort]
  inline def apply(requestOpts: typingsJapgolly.request.mod.Options, callback: RequestCallback): Abort = (^.asInstanceOf[js.Dynamic].apply(requestOpts.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Abort]
  inline def apply(requestOpts: typingsJapgolly.request.mod.Options, opts: Options): Abort = (^.asInstanceOf[js.Dynamic].apply(requestOpts.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Abort]
  inline def apply(requestOpts: typingsJapgolly.request.mod.Options, opts: Options, callback: RequestCallback): Abort = (^.asInstanceOf[js.Dynamic].apply(requestOpts.asInstanceOf[js.Any], opts.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Abort]
