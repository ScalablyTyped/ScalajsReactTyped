...
import typingsJapgolly.reactChatWidget.anon.Label
import typingsJapgolly.reactChatWidget.anon.Link
...
object global {
  ...
  object ReactChatWidget {
    
    @JSGlobal("ReactChatWidget")
    @js.native
    ...
    inline def renderCustomComponent(component: ElementType, props: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("renderCustomComponent")(component.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def renderCustomComponent(component: ElementType, props: Any, showAvatar: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("renderCustomComponent")(component.asInstanceOf[js.Any], props.asInstanceOf[js.Any], showAvatar.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def renderCustomComponent(component: ElementType, props: Any, showAvatar: Boolean, id: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("renderCustomComponent")(component.asInstanceOf[js.Any], props.asInstanceOf[js.Any], showAvatar.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[Unit]
