package typingsJapgolly.reactDevUtils.inlineChunkHtmlPluginMod
...
class ^ protected () extends Plugin {
  def this(
    htmlWebpackPlugin: Instantiable0[typingsJapgolly.htmlWebpackPlugin.mod.^],
    tests: js.Array[js.RegExp]
  ) = this()
}
