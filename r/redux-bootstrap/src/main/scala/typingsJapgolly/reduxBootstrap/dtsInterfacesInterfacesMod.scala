...
import typingsJapgolly.reduxBootstrap.anon.Accept
...
object dtsInterfacesInterfacesMod {
  ...
  object interfaces {
    ...
    object BoostrapOptions {
      ...
      inline def apply(reducers: ReducersOption, routes: VdomElement): BoostrapOptions = {
        val __obj = js.Dynamic.literal(reducers = reducers.asInstanceOf[js.Any], routes = routes.rawElement.asInstanceOf[js.Any])
      ...
      extension [Self <: BoostrapOptions](x: Self) {
        ...
        inline def setRoutes(value: VdomElement): Self = StObject.set(x, "routes", value.rawElement.asInstanceOf[js.Any])
      }
    }
    ...
    object BootstrapResult {
      ...
      inline def apply(history: History, output: Any, root: VdomElement, store: Store[Any, AnyAction]): BootstrapResult = {
        val __obj = js.Dynamic.literal(history = history.asInstanceOf[js.Any], output = output.asInstanceOf[js.Any], root = root.rawElement.asInstanceOf[js.Any], store = store.asInstanceOf[js.Any])
      ...
      extension [Self <: BootstrapResult](x: Self) {
        ...
        inline def setRoot(value: VdomElement): Self = StObject.set(x, "root", value.rawElement.asInstanceOf[js.Any])
    ...
    object RootComponentProps {
      ...
      inline def apply(history: History, routes: VdomElement, store: Store[Any, AnyAction]): RootComponentProps = {
        val __obj = js.Dynamic.literal(history = history.asInstanceOf[js.Any], routes = routes.rawElement.asInstanceOf[js.Any], store = store.asInstanceOf[js.Any])
    ...
    object RouterProps {
      ...
      extension [Self <: RouterProps](x: Self) {
        ...
        inline def setOnUpdate(value: CallbackTo[Any]): Self = StObject.set(x, "onUpdate", value.toJsFn)
