package typingsJapgolly.reactTextfit.components
...
import typingsJapgolly.reactTextfit.mod.TextfitProps
import typingsJapgolly.reactTextfit.reactTextfitStrings.multi
import typingsJapgolly.reactTextfit.reactTextfitStrings.single
...
object Textfit {
  ...
  @JSImport("react-textfit", "Textfit")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def forceSingleModeWidth(value: Boolean): this.type = set("forceSingleModeWidth", value.asInstanceOf[js.Any])
    ...
    inline def mode(value: single | multi): this.type = set("mode", value.asInstanceOf[js.Any])
    ...
    inline def onReady(value: /* fontSize */ Double => Callback): this.type = set("onReady", js.Any.fromFunction1((t0: /* fontSize */ Double) => value(t0).runNow()))
  ...
  implicit def make(companion: Textfit.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextfitProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
