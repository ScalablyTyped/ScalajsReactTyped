package typingsJapgolly.reactTextfit
...
object mod {
  ...
  object TextfitProps {
    ...
    extension [Self <: TextfitProps](x: Self) {
      ...
      inline def setOnReady(value: /* fontSize */ Double => Callback): Self = StObject.set(x, "onReady", js.Any.fromFunction1((t0: /* fontSize */ Double) => value(t0).runNow()))
