...
import typingsJapgolly.rcUpload.anon.File
import typingsJapgolly.rcUpload.esInterfaceMod.Action
import typingsJapgolly.rcUpload.esInterfaceMod.BeforeUploadFileType
import typingsJapgolly.rcUpload.esInterfaceMod.RcFile
import typingsJapgolly.rcUpload.esInterfaceMod.UploadProgressEvent
import typingsJapgolly.rcUpload.esInterfaceMod.UploadRequestHeader
import typingsJapgolly.rcUpload.esInterfaceMod.UploadRequestMethod
...
@scala.inline
open class SharedBuilder_UploadProps1578786420[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def action(value: Action): this.type = set("action", value.asInstanceOf[js.Any])
  
  inline def actionFunction1(value: /* file */ RcFile => String | PromiseLike[String]): this.type = set("action", js.Any.fromFunction1(value))
  ...
  inline def component(value: JSXElementConstructor[Any]): this.type = set("component", value.asInstanceOf[js.Any])
  
  inline def componentFunction1(value: Any => Element | Null): this.type = set("component", js.Any.fromFunction1(value))
  ...
  inline def customRequest(value: /* option */ UploadRequestOption[Any] => Callback): this.type = set("customRequest", js.Any.fromFunction1((t0: /* option */ UploadRequestOption[Any]) => value(t0).runNow()))
  ...
  inline def dataFunction1(value: /* file */ RcFile | String | Blob => Record[String, Any]): this.type = set("data", js.Any.fromFunction1(value))
  ...
  inline def headers(value: UploadRequestHeader): this.type = set("headers", value.asInstanceOf[js.Any])
  ...
  inline def method(value: UploadRequestMethod): this.type = set("method", value.asInstanceOf[js.Any])
  ...
  inline def onBatchStart(value: /* fileList */ js.Array[File] => Callback): this.type = set("onBatchStart", js.Any.fromFunction1((t0: /* fileList */ js.Array[File]) => value(t0).runNow()))
  ...
  ): this.type = set("onClick", js.Any.fromFunction1((t0: /* e */ ReactMouseEventFrom[HTMLDivElement] | ReactKeyboardEventFrom[HTMLDivElement]) => value(t0).runNow()))
  ...
  inline def onError(value: (/* error */ js.Error, /* ret */ Record[String, Any], /* file */ RcFile) => Callback): this.type = set("onError", js.Any.fromFunction3((t0: /* error */ js.Error, t1: /* ret */ Record[String, Any], t2: /* file */ RcFile) => (value(t0, t1, t2)).runNow()))
  ...
  inline def onMouseEnter(value: /* e */ ReactMouseEventFrom[HTMLDivElement] => Callback): this.type = set("onMouseEnter", js.Any.fromFunction1((t0: /* e */ ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
  
  inline def onMouseLeave(value: /* e */ ReactMouseEventFrom[HTMLDivElement] => Callback): this.type = set("onMouseLeave", js.Any.fromFunction1((t0: /* e */ ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
  ...
  inline def onProgress(value: (/* event */ UploadProgressEvent, /* file */ RcFile) => Callback): this.type = set("onProgress", js.Any.fromFunction2((t0: /* event */ UploadProgressEvent, t1: /* file */ RcFile) => (value(t0, t1)).runNow()))
  ...
  inline def onStart(value: /* file */ RcFile => Callback): this.type = set("onStart", js.Any.fromFunction1((t0: /* file */ RcFile) => value(t0).runNow()))
  ...
  ): this.type = set("onSuccess", js.Any.fromFunction3((t0: /* response */ Record[String, Any], t1: /* file */ RcFile, t2: /* xhr */ XMLHttpRequest) => (value(t0, t1, t2)).runNow()))
