...
import typingsJapgolly.reactGoogleMapsLoader.anon.Typeofgeometry
...
object mod {
  ...
  object ReactGoogleMapsLoader {
    ...
    trait Props extends StObject {
      ...
      def render(googleMaps: GoogleMaps): Node = js.native
      def render(googleMaps: GoogleMaps, error: String): Node = js.native
    }
  }
  type ReactGoogleMapsLoader = japgolly.scalajs.react.facade.React.Component[Props & js.Object, js.Object]
}
