...
object mod {
  ...
  */
  ...
  object _ReducerMapValue {
    ...
    inline def ReducerMap[State, Payload](): typingsJapgolly.reduxActions.mod.ReducerMap[State, Payload] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.reduxActions.mod.ReducerMap[State, Payload]]
    }
    
    inline def ReducerNextThrow[State, Payload](): typingsJapgolly.reduxActions.mod.ReducerNextThrow[State, Payload] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.reduxActions.mod.ReducerNextThrow[State, Payload]]
    }
  }
}
