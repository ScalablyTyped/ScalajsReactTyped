...
import typingsJapgolly.reactDashNavigationDashStack.libTypescriptViewsHeaderHeaderBackButtonMod.Props
...
object HeaderBackButton {
  ...
  typingsJapgolly.reactDashNavigationDashStack.libTypescriptViewsHeaderHeaderBackButtonMod.Props, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNavigationDashStack.libTypescriptViewsHeaderHeaderBackButtonMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNavigationDashStack.libTypescriptViewsHeaderHeaderBackButtonMod.Props])(children: _*)
  }
