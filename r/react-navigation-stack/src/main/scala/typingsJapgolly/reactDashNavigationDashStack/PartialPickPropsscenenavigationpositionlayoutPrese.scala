...
object PartialPickPropsscenenavigationpositionlayoutPrese {
  ...
  def apply(
    ...
    if (layoutInterpolator != null) __obj.updateDynamic("layoutInterpolator")(js.Any.fromFunction1((t0: /* props */ typingsJapgolly.reactDashNavigationDashStack.libTypescriptTypesMod.SceneInterpolatorProps) => layoutInterpolator(t0).runNow()))
    if (layoutPreset != null) __obj.updateDynamic("layoutPreset")(layoutPreset.asInstanceOf[js.Any])
    if (leftButtonInterpolator != null) __obj.updateDynamic("leftButtonInterpolator")(js.Any.fromFunction1((t0: /* props */ typingsJapgolly.reactDashNavigationDashStack.libTypescriptTypesMod.SceneInterpolatorProps) => leftButtonInterpolator(t0).runNow()))
    ...
    if (leftLabelInterpolator != null) __obj.updateDynamic("leftLabelInterpolator")(js.Any.fromFunction1((t0: /* props */ typingsJapgolly.reactDashNavigationDashStack.libTypescriptTypesMod.SceneInterpolatorProps) => leftLabelInterpolator(t0).runNow()))
    ...
    if (titleFromLeftInterpolator != null) __obj.updateDynamic("titleFromLeftInterpolator")(js.Any.fromFunction1((t0: /* props */ typingsJapgolly.reactDashNavigationDashStack.libTypescriptTypesMod.SceneInterpolatorProps) => titleFromLeftInterpolator(t0).runNow()))
