...
trait ViewPropsenabledbooleanac extends StObject {
  ...
  var active: typingsJapgolly.reactNavigationStack.reactNavigationStackInts.`0` | `1` | `2` | (AnimatedInterpolation[Double | String])
...
object ViewPropsenabledbooleanac {
  ...
  inline def apply(
    active: typingsJapgolly.reactNavigationStack.reactNavigationStackInts.`0` | `1` | `2` | (AnimatedInterpolation[Double | String]),
    children: js.UndefOr[Node] & Node,
    enabled: Boolean
  ): ViewPropsenabledbooleanac = {
    val __obj = js.Dynamic.literal(active = active.asInstanceOf[js.Any], children = children.asInstanceOf[js.Any], enabled = enabled.asInstanceOf[js.Any])
  ...
  extension [Self <: ViewPropsenabledbooleanac](x: Self) {
    ...
    inline def setActive(
      value: typingsJapgolly.reactNavigationStack.reactNavigationStackInts.`0` | `1` | `2` | (AnimatedInterpolation[Double | String])
