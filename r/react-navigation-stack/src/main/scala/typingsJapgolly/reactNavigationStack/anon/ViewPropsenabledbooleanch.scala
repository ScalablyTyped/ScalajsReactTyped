...
object ViewPropsenabledbooleanch {
  ...
  inline def apply(children: js.UndefOr[Node] & Node, enabled: Boolean): ViewPropsenabledbooleanch = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], enabled = enabled.asInstanceOf[js.Any])
