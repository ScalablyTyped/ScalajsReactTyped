...
object ReadonlyState {
  ...
  extension [Self <: ReadonlyState](x: Self) {
    ...
    inline def setPreviousRoutesVarargs(value: typingsJapgolly.reactNavigationStack.libTypescriptSrcVendorTypesMod.Route[String]*): Self = StObject.set(x, "previousRoutes", js.Array(value*))
