...
object ViewPropsenabledbooleanla {
  ...
  inline def apply(children: js.UndefOr[Node] & Node, enabled: Boolean, layout: Width): ViewPropsenabledbooleanla = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], enabled = enabled.asInstanceOf[js.Any], layout = layout.asInstanceOf[js.Any])
