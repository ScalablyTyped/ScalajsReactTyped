...
import typingsJapgolly.reactNavigationStack.AnonHorizontal
import typingsJapgolly.reactNavigationStack.AnonTintColor
import typingsJapgolly.reactNavigationStack.TextPropschildrenstring
import typingsJapgolly.reactNavigationStack.reactNavigationStackStrings.inverted
...
trait NavigationStackOptions extends js.Object {
  ...
  var headerBackImage: js.UndefOr[js.Function1[/* props */ AnonTintColor, Node]] = js.undefined
...
object NavigationStackOptions {
  ...
  def apply(
    ...
    headerBackImage: /* props */ AnonTintColor => CallbackTo[Node] = null,
    ...
    if (header != null) __obj.updateDynamic("header")(js.Any.fromFunction1((t0: /* props */ typingsJapgolly.reactNavigationStack.typesMod.HeaderProps) => header(t0).runNow()))
    ...
    if (headerBackImage != null) __obj.updateDynamic("headerBackImage")(js.Any.fromFunction1((t0: /* props */ typingsJapgolly.reactNavigationStack.AnonTintColor) => headerBackImage(t0).runNow()))
