...
import typingsJapgolly.reactNavigationStack.anon.ViewPropsenabledbooleanac
...
object MaybeScreen {
  ...
  inline def apply(
    active: `0` | `1` | `2` | (AnimatedInterpolation[Double | String]),
    children: js.UndefOr[Node] & Node,
    enabled: Boolean
  ): Builder = {
    val __props = js.Dynamic.literal(active = active.asInstanceOf[js.Any], children = children.asInstanceOf[js.Any], enabled = enabled.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[ViewPropsenabledbooleanac]))
  }
  
  @JSImport("react-navigation-stack/lib/typescript/src/vendor/views/Screens", "MaybeScreen")
  @js.native
