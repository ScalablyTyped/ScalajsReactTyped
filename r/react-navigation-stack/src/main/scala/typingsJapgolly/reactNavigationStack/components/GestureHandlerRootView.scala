...
object GestureHandlerRootView {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[
          typingsJapgolly.reactNavigationStack.libTypescriptSrcVendorViewsGestureHandlerMod.GestureHandlerRootView
        ] {
  ...
  implicit def make(companion: GestureHandlerRootView.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
