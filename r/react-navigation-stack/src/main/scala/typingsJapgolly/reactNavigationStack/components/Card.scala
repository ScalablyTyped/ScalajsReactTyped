...
import typingsJapgolly.reactNavigationStack.libTypescriptSrcVendorViewsStackCardMod.Props
import typingsJapgolly.reactNavigationStack.libTypescriptSrcVendorViewsStackCardMod.default
...
object Card {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def next(value: AnimatedInterpolation[Double | String]): this.type = set("next", value.asInstanceOf[js.Any])
    ...
    inline def onGestureBegin(value: Callback): this.type = set("onGestureBegin", value.toJsFn)
    
    inline def onGestureCanceled(value: Callback): this.type = set("onGestureCanceled", value.toJsFn)
    
    inline def onGestureEnd(value: Callback): this.type = set("onGestureEnd", value.toJsFn)
    ...
    inline def onTransition(value: /* props */ Gesture => Callback): this.type = set("onTransition", js.Any.fromFunction1((t0: /* props */ Gesture) => value(t0).runNow()))
