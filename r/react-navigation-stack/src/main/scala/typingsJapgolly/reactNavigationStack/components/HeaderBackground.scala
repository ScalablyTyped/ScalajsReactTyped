...
import typingsJapgolly.reactNavigationStack.libTypescriptSrcVendorViewsHeaderHeaderBackgroundMod.Props
...
object HeaderBackground {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def style(value: WithAnimatedValue[StyleProp[ViewStyle]]): this.type = set("style", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: HeaderBackground.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
