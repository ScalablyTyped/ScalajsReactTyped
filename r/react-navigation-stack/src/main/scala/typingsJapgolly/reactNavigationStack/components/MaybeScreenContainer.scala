...
import typingsJapgolly.reactNavigationStack.anon.ViewPropsenabledbooleanch
...
object MaybeScreenContainer {
  ...
  inline def apply(children: js.UndefOr[Node] & Node, enabled: Boolean): Builder = {
    val __props = js.Dynamic.literal(children = children.asInstanceOf[js.Any], enabled = enabled.asInstanceOf[js.Any])
