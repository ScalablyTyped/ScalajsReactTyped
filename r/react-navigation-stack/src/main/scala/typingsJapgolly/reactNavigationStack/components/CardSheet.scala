...
import typingsJapgolly.reactNavigationStack.anon.ViewPropsenabledbooleanla
import typingsJapgolly.reactNavigationStack.anon.Width
import typingsJapgolly.reactNavigationStack.reactNavigationStackStrings.`box-none`
import typingsJapgolly.reactNavigationStack.reactNavigationStackStrings.`box-only`
...
object CardSheet {
  ...
  inline def apply(children: js.UndefOr[Node] & Node, enabled: Boolean, layout: Width): Builder = {
    val __props = js.Dynamic.literal(children = children.asInstanceOf[js.Any], enabled = enabled.asInstanceOf[js.Any], layout = layout.asInstanceOf[js.Any])
