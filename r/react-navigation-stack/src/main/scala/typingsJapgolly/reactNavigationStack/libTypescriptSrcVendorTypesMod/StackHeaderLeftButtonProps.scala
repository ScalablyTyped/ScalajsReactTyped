...
trait StackHeaderLeftButtonProps extends StObject {
  ...
  /**
    ...
    */
  var backImage: js.UndefOr[js.Function1[/* props */ TintColor, Node]] = js.undefined
...
object StackHeaderLeftButtonProps {
  ...
  extension [Self <: StackHeaderLeftButtonProps](x: Self) {
    ...
    inline def setBackImage(value: /* props */ TintColor => Node): Self = StObject.set(x, "backImage", js.Any.fromFunction1(value))
    ...
    inline def setOnLabelLayout(value: /* e */ LayoutChangeEvent => Callback): Self = StObject.set(x, "onLabelLayout", js.Any.fromFunction1((t0: /* e */ LayoutChangeEvent) => value(t0).runNow()))
