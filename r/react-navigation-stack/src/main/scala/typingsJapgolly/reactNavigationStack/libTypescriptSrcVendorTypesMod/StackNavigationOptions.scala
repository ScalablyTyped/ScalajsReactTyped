...
import typingsJapgolly.reactNavigationStack.anon.Left
import typingsJapgolly.reactNavigationStack.anon.Style
...
import typingsJapgolly.reactNavigationStack.anon.`0`
import typingsJapgolly.reactNavigationStack.reactNavigationStackStrings.center
import typingsJapgolly.reactNavigationStack.reactNavigationStackStrings.left
import typingsJapgolly.reactNavigationStack.reactNavigationStackStrings.pop
import typingsJapgolly.reactNavigationStack.reactNavigationStackStrings.push
...
trait StackNavigationOptions extends StObject {
  ...
  /**
    ...
    */
  var header: js.UndefOr[js.Function1[/* props */ StackHeaderProps, Node]] = js.undefined
  ...
  /**
    ...
    */
  var headerBackImage: js.UndefOr[js.Function1[/* props */ TintColor, Node]] = js.undefined
  ...
  /**
    ...
    */
  var headerBackground: js.UndefOr[js.Function1[/* props */ Style, Node]] = js.undefined
  
  /**
    * Function which returns a React Element to display on the left side of the header.
    * It receives a number of arguments when rendered (`onPress`, `label`, `labelStyle` and more.
    */
  var headerLeft: js.UndefOr[js.Function1[/* props */ StackHeaderLeftButtonProps, Node]] = js.undefined
  ...
  /**
    ...
    */
  var headerRight: js.UndefOr[js.Function1[/* props */ `0`, Node]] = js.undefined
  ...
  /**
    ...
    */
  var headerTitle: js.UndefOr[String | (js.Function1[/* props */ StackHeaderTitleProps, Node])] = js.undefined
...
object StackNavigationOptions {
  ...
  extension [Self <: StackNavigationOptions](x: Self) {
    ...
    inline def setHeader(value: /* props */ StackHeaderProps => Node): Self = StObject.set(x, "header", js.Any.fromFunction1(value))
    ...
    inline def setHeaderBackImage(value: /* props */ TintColor => Node): Self = StObject.set(x, "headerBackImage", js.Any.fromFunction1(value))
    ...
    inline def setHeaderBackground(value: /* props */ Style => Node): Self = StObject.set(x, "headerBackground", js.Any.fromFunction1(value))
    
    inline def setHeaderBackgroundUndefined: Self = StObject.set(x, "headerBackground", js.undefined)
    
    inline def setHeaderLeft(value: /* props */ StackHeaderLeftButtonProps => Node): Self = StObject.set(x, "headerLeft", js.Any.fromFunction1(value))
    ...
    inline def setHeaderRight(value: /* props */ `0` => Node): Self = StObject.set(x, "headerRight", js.Any.fromFunction1(value))
    ...
    inline def setHeaderTitle(value: String | (js.Function1[/* props */ StackHeaderTitleProps, Node])): Self = StObject.set(x, "headerTitle", value.asInstanceOf[js.Any])
    ...
    inline def setHeaderTitleFunction1(value: /* props */ StackHeaderTitleProps => Node): Self = StObject.set(x, "headerTitle", js.Any.fromFunction1(value))
    ...
    inline def setOnTransitionEnd(value: /* props */ TransitionCallbackProps => Callback): Self = StObject.set(x, "onTransitionEnd", js.Any.fromFunction1((t0: /* props */ TransitionCallbackProps) => value(t0).runNow()))
    
    inline def setOnTransitionEndUndefined: Self = StObject.set(x, "onTransitionEnd", js.undefined)
    
    inline def setOnTransitionStart(value: /* props */ TransitionCallbackProps => Callback): Self = StObject.set(x, "onTransitionStart", js.Any.fromFunction1((t0: /* props */ TransitionCallbackProps) => value(t0).runNow()))
