...
import typingsJapgolly.registryAuthToken.anon.DictregistryUrls
import typingsJapgolly.registryAuthToken.registryAuthTokenStrings.Basic
import typingsJapgolly.registryAuthToken.registryAuthTokenStrings.Bearer
