...
object RadiumConfig {
  @scala.inline
  def apply(
    matchMedia: /* mediaQuery */ String => CallbackTo[MediaQueryList] = null,
    plugins: js.Array[_] = null,
    userAgent: String = null
  ): RadiumConfig = {
    val __obj = js.Dynamic.literal()
    if (matchMedia != null) __obj.updateDynamic("matchMedia")(js.Any.fromFunction1((t0: /* mediaQuery */ java.lang.String) => matchMedia(t0).runNow()))
