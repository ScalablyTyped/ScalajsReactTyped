...
object mod {
  ...
  trait AuthConfig extends StObject {
    ...
    var AuthenticatingComponent: js.UndefOr[ElementType] = js.undefined
  ...
  object AuthConfig {
    ...
    extension [Self <: AuthConfig](x: Self) {
      ...
      inline def setAuthenticatingComponent(value: ElementType): Self = StObject.set(x, "AuthenticatingComponent", value.asInstanceOf[js.Any])
  ...
  type AuthWrapperDecorator[Props] = js.Function1[/* component */ ComponentType[Props], ComponentClassP[Props & js.Object]]
