...
object MapboxProps {
  ...
  extension [Self <: MapboxProps](x: Self) {
    ...
    inline def setOnError(value: /* e */ MapError => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* e */ MapError) => value(t0).runNow()))
    
    inline def setOnErrorUndefined: Self = StObject.set(x, "onError", js.undefined)
    
    inline def setOnLoad(value: /* event */ MapLoadEvent => Callback): Self = StObject.set(x, "onLoad", js.Any.fromFunction1((t0: /* event */ MapLoadEvent) => value(t0).runNow()))
