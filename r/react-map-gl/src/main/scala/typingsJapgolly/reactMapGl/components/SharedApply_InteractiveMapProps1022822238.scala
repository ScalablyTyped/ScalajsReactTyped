...
abstract class SharedApply_InteractiveMapProps1022822238[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InteractiveMapProps, ComponentRef, Unit, InteractiveMapProps] = {
  ...
  typingsJapgolly.reactMapGl.mod.InteractiveMapProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactMapGl.mod.InteractiveMapProps])(children: _*)
  }
}
