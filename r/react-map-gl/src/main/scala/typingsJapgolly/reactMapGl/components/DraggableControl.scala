...
object DraggableControl {
  def apply[T /* <: DraggableControlProps */](
    ...
    T with js.Object, 
    typingsJapgolly.reactMapGl.mod.DraggableControl[T], 
    Unit, 
    T with js.Object
  ] = {
  ...
  typingsJapgolly.reactMapGl.mod.DraggableControl[T]](this.componentImport)
