...
import typingsJapgolly.reactDatepicker.mod.CalendarContainerProps
import typingsJapgolly.reactDatepicker.mod.HighlightDates
import typingsJapgolly.reactDatepicker.mod.ReactDatePickerCustomHeaderProps
...
object ReactDatepicker {
  ...
  open class Builder[CustomModifierNames /* <: String */, WithRange /* <: js.UndefOr[Boolean] */] (val args: js.Array[Any])
    ...
    inline def formatWeekDay(value: /* formattedDate */ String => Node): this.type = set("formatWeekDay", js.Any.fromFunction1(value))
