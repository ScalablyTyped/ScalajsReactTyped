...
object ^ extends js.Object {
  ...
  def apply(server: typingsJapgolly.node.httpsMod.Server): StatsEmitter = js.native
  def apply(server: typingsJapgolly.node.httpsMod.Server, statsCallback: StatsCallback): StatsEmitter = js.native
}
