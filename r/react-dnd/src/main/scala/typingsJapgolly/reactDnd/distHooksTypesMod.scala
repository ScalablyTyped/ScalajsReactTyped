...
object distHooksTypesMod {
  ...
  object DragSourceHookSpec {
    ...
    extension [Self <: DragSourceHookSpec[?, ?, ?], DragObject, DropResult, CollectedProps](x: Self & (DragSourceHookSpec[DragObject, DropResult, CollectedProps])) {
      ...
      inline def setEnd(
        value: (/* draggedItem */ DragObject, /* monitor */ DragSourceMonitor[DragObject, DropResult]) => Callback
      ): Self = StObject.set(x, "end", js.Any.fromFunction2((t0: /* draggedItem */ DragObject, t1: /* monitor */ DragSourceMonitor[DragObject, DropResult]) => (value(t0, t1)).runNow()))
  ...
  object DropTargetHookSpec {
    ...
    extension [Self <: DropTargetHookSpec[?, ?, ?], DragObject, DropResult, CollectedProps](x: Self & (DropTargetHookSpec[DragObject, DropResult, CollectedProps])) {
      ...
      inline def setHover(
        value: (/* item */ DragObject, /* monitor */ DropTargetMonitor[DragObject, DropResult]) => Callback
      ): Self = StObject.set(x, "hover", js.Any.fromFunction2((t0: /* item */ DragObject, t1: /* monitor */ DropTargetMonitor[DragObject, DropResult]) => (value(t0, t1)).runNow()))
