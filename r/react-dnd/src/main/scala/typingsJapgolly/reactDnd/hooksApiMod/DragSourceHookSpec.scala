...
object DragSourceHookSpec {
  ...
  def apply[DragObject /* <: DragObjectWithType */, DropResult, CollectedProps](
    item: DragObject,
    begin: /* monitor */ DragSourceMonitor => CallbackTo[js.UndefOr[DragObject | Unit]] = null,
    canDrag: Boolean | (js.Function1[/* monitor */ DragSourceMonitor, Boolean]) = null,
    collect: /* monitor */ DragSourceMonitor => CallbackTo[CollectedProps] = null,
    end: (/* dropResult */ js.UndefOr[DropResult], /* monitor */ DragSourceMonitor) => Callback = null,
    isDragging: /* monitor */ DragSourceMonitor => CallbackTo[Boolean] = null,
    options: DragSourceOptions = null,
    previewOptions: DragPreviewOptions = null
  ): DragSourceHookSpec[DragObject, DropResult, CollectedProps] = {
    val __obj = js.Dynamic.literal(item = item.asInstanceOf[js.Any])
    if (begin != null) __obj.updateDynamic("begin")(js.Any.fromFunction1((t0: /* monitor */ typingsJapgolly.reactDnd.monitorsMod.DragSourceMonitor) => begin(t0).runNow()))
    if (canDrag != null) __obj.updateDynamic("canDrag")(canDrag.asInstanceOf[js.Any])
    if (collect != null) __obj.updateDynamic("collect")(js.Any.fromFunction1((t0: /* monitor */ typingsJapgolly.reactDnd.monitorsMod.DragSourceMonitor) => collect(t0).runNow()))
    if (end != null) __obj.updateDynamic("end")(js.Any.fromFunction2((t0: /* dropResult */ js.UndefOr[DropResult], t1: /* monitor */ typingsJapgolly.reactDnd.monitorsMod.DragSourceMonitor) => end(t0, t1).runNow()))
    if (isDragging != null) __obj.updateDynamic("isDragging")(js.Any.fromFunction1((t0: /* monitor */ typingsJapgolly.reactDnd.monitorsMod.DragSourceMonitor) => isDragging(t0).runNow()))
