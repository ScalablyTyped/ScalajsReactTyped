...
import typingsJapgolly.redux.anon.DispatchExt
import typingsJapgolly.redux.anon.`0`
import typingsJapgolly.redux.anon.`1`
import typingsJapgolly.redux.anon.`2`
import typingsJapgolly.redux.anon.`3`
...
object mod {
  ...
  inline def applyMiddleware[Ext1, S](middleware1: Middleware[Ext1, S, Any]): StoreEnhancer[typingsJapgolly.redux.anon.Dispatch[Ext1], js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("applyMiddleware")(middleware1.asInstanceOf[js.Any]).asInstanceOf[StoreEnhancer[typingsJapgolly.redux.anon.Dispatch[Ext1], js.Object]]
  ...
  object MiddlewareAPI {
    ...
    inline def apply[D /* <: Dispatch[AnyAction] */, S](dispatch: D, getState: CallbackTo[S]): MiddlewareAPI[D, S] = {
      val __obj = js.Dynamic.literal(dispatch = dispatch.asInstanceOf[js.Any], getState = getState.toJsFn)
  ...
  trait Observable[T] extends StObject {
    ...
    /**
      ...
      */
    def subscribe(observer: Observer[T]): typingsJapgolly.redux.anon.Unsubscribe = js.native
  }
