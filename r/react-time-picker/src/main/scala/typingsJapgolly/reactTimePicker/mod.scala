package typingsJapgolly.reactTimePicker

import japgolly.scalajs.react.Callback
import typingsJapgolly.reactTimePicker.reactTimePickerStrings.hour
import typingsJapgolly.reactTimePicker.reactTimePickerStrings.minute
import typingsJapgolly.reactTimePicker.reactTimePickerStrings.second
...
object mod {
  ...
  object TimePickerProps {
    ...
    extension [Self <: TimePickerProps[?], T](x: Self & TimePickerProps[T]) {
      ...
      inline def setOnChange(value: /* value */ T => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* value */ T) => value(t0).runNow()))
