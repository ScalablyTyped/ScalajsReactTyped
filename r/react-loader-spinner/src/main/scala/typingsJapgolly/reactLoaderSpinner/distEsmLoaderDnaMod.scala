...
object distEsmLoaderDnaMod {
  
  @JSImport("react-loader-spinner/dist/esm/loader/Dna", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def default(hasVisibleWidthHeightWrapperClassWrapperStyleAriaLabel: DNAProps): Element | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(hasVisibleWidthHeightWrapperClassWrapperStyleAriaLabel.asInstanceOf[js.Any]).asInstanceOf[Element | Null]
