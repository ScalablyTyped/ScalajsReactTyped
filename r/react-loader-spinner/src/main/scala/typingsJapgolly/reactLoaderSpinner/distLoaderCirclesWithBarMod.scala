...
object distLoaderCirclesWithBarMod extends Shortcut {
  
  @JSImport("react-loader-spinner/dist/loader/CirclesWithBar", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distLoaderCirclesWithBarMod.foo` */
