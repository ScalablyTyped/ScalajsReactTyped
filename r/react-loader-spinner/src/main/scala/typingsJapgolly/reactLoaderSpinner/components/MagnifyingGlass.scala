...
import typingsJapgolly.reactLoaderSpinner.distLoaderMagnifyingGlassMod.MagnifyingGlassProps
import typingsJapgolly.reactLoaderSpinner.distTypeMod.Style
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object MagnifyingGlass {
  
  @JSImport("react-loader-spinner", "MagnifyingGlass")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def glassColor(value: String): this.type = set("glassColor", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: MagnifyingGlass.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MagnifyingGlassProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
