...
import typingsJapgolly.reactLoaderSpinner.distLoaderDiscussMod.DiscussProps
...
object Discuss {
  ...
  @JSImport("react-loader-spinner", "Discuss")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def colors(value: js.Tuple2[String, String]): this.type = set("colors", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: Discuss.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DiscussProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
