...
import typingsJapgolly.reactLoaderSpinner.distLoaderWatchMod.WatchProps
...
object Watch {
  ...
  implicit def make(companion: Watch.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WatchProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
