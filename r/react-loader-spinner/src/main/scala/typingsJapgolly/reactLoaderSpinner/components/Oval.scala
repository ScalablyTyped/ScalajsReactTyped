...
import typingsJapgolly.reactLoaderSpinner.distLoaderOvalMod.OvalProps
...
object Oval {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def strokeWidth(value: String | Double): this.type = set("strokeWidth", value.asInstanceOf[js.Any])
    
    inline def strokeWidthSecondary(value: String | Double): this.type = set("strokeWidthSecondary", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: Oval.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OvalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
