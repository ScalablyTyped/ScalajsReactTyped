...
import typingsJapgolly.reactLoaderSpinner.distLoaderRevolvingDotMod.RevolvingDotProps
...
object RevolvingDot {
  ...
  implicit def make(companion: RevolvingDot.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RevolvingDotProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
