...
import typingsJapgolly.reactLoaderSpinner.distLoaderPuffMod.PuffProps
...
object Puff {
  ...
  implicit def make(companion: Puff.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PuffProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
