...
import typingsJapgolly.reactLoaderSpinner.distLoaderColorRingMod.ColorRingProps
...
object ColorRing {
  ...
  @JSImport("react-loader-spinner", "ColorRing")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def colors(value: js.Tuple5[String, String, String, String, String]): this.type = set("colors", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ColorRing.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ColorRingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
