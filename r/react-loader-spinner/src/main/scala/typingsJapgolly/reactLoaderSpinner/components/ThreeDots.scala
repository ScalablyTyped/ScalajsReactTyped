...
import typingsJapgolly.reactLoaderSpinner.distLoaderThreeDotsMod.ThreeDotsProps
...
object ThreeDots {
  ...
  implicit def make(companion: ThreeDots.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ThreeDotsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
