...
import typingsJapgolly.reactLoaderSpinner.distLoaderRotatingSquareMod.RotatingSquareProps
import typingsJapgolly.reactLoaderSpinner.distTypeMod.Style
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object RotatingSquare {
  ...
  implicit def make(companion: RotatingSquare.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RotatingSquareProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
