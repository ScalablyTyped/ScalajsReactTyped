...
import typingsJapgolly.reactLoaderSpinner.distLoaderMutatingDotsMod.MutatingDotsProps
...
object MutatingDots {
  ...
  implicit def make(companion: MutatingDots.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MutatingDotsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
