...
import typingsJapgolly.reactLoaderSpinner.distLoaderRingsMod.RingsProps
...
object Rings {
  ...
  implicit def make(companion: Rings.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RingsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
