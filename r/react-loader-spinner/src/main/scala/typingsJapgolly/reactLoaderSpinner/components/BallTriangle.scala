...
import typingsJapgolly.reactLoaderSpinner.distLoaderBallTriangleMod.BallTriangleProps
...
object BallTriangle {
  ...
  implicit def make(companion: BallTriangle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BallTriangleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
