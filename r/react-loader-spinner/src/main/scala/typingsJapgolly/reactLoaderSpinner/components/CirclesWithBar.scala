...
import typingsJapgolly.reactLoaderSpinner.distLoaderCirclesWithBarMod.Props
import typingsJapgolly.reactLoaderSpinner.distTypeMod.Style
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object CirclesWithBar {
  ...
  implicit def make(companion: CirclesWithBar.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
