...
object distEsmLoaderRotatingLinesMod {
  ...
  inline def default(hasStrokeColorStrokeWidthAnimationDurationWidthVisibleAriaLabel: Props): Element | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(hasStrokeColorStrokeWidthAnimationDurationWidthVisibleAriaLabel.asInstanceOf[js.Any]).asInstanceOf[Element | Null]
