...
object mod {
  ...
  @js.native
  open class ^ ()
    extends typingsJapgolly.rdfExt.libDataFactoryMod.^
  @JSImport("rdf-ext", JSImport.Namespace)
  @js.native
  ...
  type DataFactoryExt = typingsJapgolly.rdfExt.libDataFactoryMod.^
  ...
  object SinkMap {
    ...
    inline def apply[InputStream /* <: EventEmitter */, OutputStream /* <: EventEmitter */](
      ...
      val __obj = js.Dynamic.literal(find = js.Any.fromFunction1(find), list = list.toJsFn)
