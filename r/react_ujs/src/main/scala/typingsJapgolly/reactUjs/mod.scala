...
import typingsJapgolly.reactUjs.anon.FnCall
import typingsJapgolly.reactUjs.anon.FnCallTypeListenerOptions
import typingsJapgolly.reactUjs.anon.PartialEvent
...
object mod {
  ...
  /**
    ...
    */
  inline def findDOMNodes(): JQuery[HTMLElement] | NodeList[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("findDOMNodes")().asInstanceOf[JQuery[HTMLElement] | NodeList[Node]]
  inline def findDOMNodes(searchSelector: SearchSelector): JQuery[HTMLElement] | NodeList[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("findDOMNodes")(searchSelector.asInstanceOf[js.Any]).asInstanceOf[JQuery[HTMLElement] | NodeList[Node]]
  ...
  /**
    ...
    */
  @JSImport("react_ujs", "handleEvent")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("react_ujs", "removeEvent")
  @js.native
  ...
  /**
    ...
    */
  type SearchSelector = js.UndefOr[String | org.scalajs.dom.Element | Document | JQuery[HTMLElement]]
  
  /**
    * WebpackRequireContext represents an object returned from Webpack's `require.context`.
    */
  type WebpackRequireContext = js.Function1[/* id */ String, Any]
}
