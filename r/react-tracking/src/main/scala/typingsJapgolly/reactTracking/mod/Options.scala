...
object Options {
  @scala.inline
  def apply[T](
    dispatch: /* data */ T => CallbackTo[js.Any] = null,
    dispatchOnMount: Boolean | (js.Function1[/* contextData */ T, T]) = null,
    process: /* ownTrackingData */ T => CallbackTo[T | Falsy] = null
  ): Options[T] = {
    val __obj = js.Dynamic.literal()
    if (dispatch != null) __obj.updateDynamic("dispatch")(js.Any.fromFunction1((t0: /* data */ T) => dispatch(t0).runNow()))
    if (dispatchOnMount != null) __obj.updateDynamic("dispatchOnMount")(dispatchOnMount.asInstanceOf[js.Any])
    if (process != null) __obj.updateDynamic("process")(js.Any.fromFunction1((t0: /* ownTrackingData */ T) => process(t0).runNow()))
