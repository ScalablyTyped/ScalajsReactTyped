...
import typingsJapgolly.reactDraggableList.anon.AutoScrollMaxSpeed
import typingsJapgolly.reactDraggableList.anon.PartialPropsanyanyany
import typingsJapgolly.reactDraggableList.anon.PartialState
...
object distSrcMod {
  ...
  @js.native
  open class default[I, C, T /* <: Component[(Partial[TemplateProps[I, C]]) & js.Object, js.Object] */] () extends DraggableList[I, C, T]
  /* static members */
  object default {
  ...
  @js.native
  trait DraggableList[I, C, T /* <: Component[(Partial[TemplateProps[I, C]]) & js.Object, js.Object] */]
    extends typingsJapgolly.react.mod.Component[Props[I, C, T], State, Any] {
  ...
  object Props {
    ...
    extension [Self <: Props[?, ?, ?], I, C, T](x: Self & (Props[I, C, T])) {
      ...
      inline def setOnMoveEnd(
        value: (/* newList */ js.Array[I], /* movedItem */ I, /* oldIndex */ Double, /* newIndex */ Double) => Callback
      ): Self = StObject.set(x, "onMoveEnd", js.Any.fromFunction4((t0: /* newList */ js.Array[I], t1: /* movedItem */ I, t2: /* oldIndex */ Double, t3: /* newIndex */ Double) => (value(t0, t1, t2, t3)).runNow()))
