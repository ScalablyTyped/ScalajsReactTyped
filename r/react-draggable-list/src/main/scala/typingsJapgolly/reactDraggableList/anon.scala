...
import typingsJapgolly.reactDraggableList.distSrcMod.Drag
...
object anon {
  ...
  object List {
    ...
    inline def apply(list: js.Array[Name | Subtitle], useContainer: Boolean): typingsJapgolly.reactDraggableList.anon.List = {
      val __obj = js.Dynamic.literal(list = list.asInstanceOf[js.Any], useContainer = useContainer.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reactDraggableList.anon.List]
    }
    
    extension [Self <: typingsJapgolly.reactDraggableList.anon.List](x: Self) {
  ...
  object PartialPropsanyanyany {
    ...
    extension [Self <: PartialPropsanyanyany](x: Self) {
      ...
      inline def setContainer(value: CallbackTo[js.UndefOr[HTMLElement | Null]]): Self = StObject.set(x, "container", value.toJsFn)
      ...
      inline def setOnMoveEnd(
        value: (/* newList */ js.Array[Any], /* movedItem */ Any, /* oldIndex */ Double, /* newIndex */ Double) => Callback
      ): Self = StObject.set(x, "onMoveEnd", js.Any.fromFunction4((t0: /* newList */ js.Array[Any], t1: /* movedItem */ Any, t2: /* oldIndex */ Double, t3: /* newIndex */ Double) => (value(t0, t1, t2, t3)).runNow()))
