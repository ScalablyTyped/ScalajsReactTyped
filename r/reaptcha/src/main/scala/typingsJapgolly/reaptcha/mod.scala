...
import typingsJapgolly.reaptcha.anon.Invisible
import typingsJapgolly.reaptcha.anon.ReadonlyProps
...
object mod {
  ...
  object default {
    ...
    object defaultProps {
      ...
      @js.native
      def children: js.UndefOr[js.Function1[/* renderProps */ RenderProps, Node]] = js.native
      inline def children_=(x: js.UndefOr[js.Function1[/* renderProps */ RenderProps, Node]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("children")(x.asInstanceOf[js.Any])
  ...
  trait Props
    ...
    var children: js.UndefOr[js.Function1[/* renderProps */ RenderProps, Node]] = js.undefined
  ...
  object Props {
    ...
    inline def apply(onVerify: String => Callback, sitekey: String): Props = {
      val __obj = js.Dynamic.literal(onVerify = js.Any.fromFunction1((t0: String) => onVerify(t0).runNow()), sitekey = sitekey.asInstanceOf[js.Any])
  ...
  object RenderProps {
    ...
    inline def apply(
      execute: CallbackTo[js.Promise[Unit]],
      getResponse: CallbackTo[js.Promise[String]],
      renderExplicitly: CallbackTo[js.Promise[Unit]],
      reset: CallbackTo[js.Promise[Unit]]
    ): RenderProps = {
      val __obj = js.Dynamic.literal(execute = execute.toJsFn, getResponse = getResponse.toJsFn, renderExplicitly = renderExplicitly.toJsFn, reset = reset.toJsFn, recaptchaComponent = null)
      __obj.asInstanceOf[RenderProps]
    }
    
    extension [Self <: RenderProps](x: Self) {
      
      inline def setExecute(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "execute", value.toJsFn)
      
      inline def setGetResponse(value: CallbackTo[js.Promise[String]]): Self = StObject.set(x, "getResponse", value.toJsFn)
      
      inline def setRecaptchaComponent(value: VdomNode): Self = StObject.set(x, "recaptchaComponent", value.rawNode.asInstanceOf[js.Any])
      
      inline def setRecaptchaComponentNull: Self = StObject.set(x, "recaptchaComponent", null)
      
      inline def setRecaptchaComponentVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "recaptchaComponent", js.Array(value*))
      
      inline def setRecaptchaComponentVdomElement(value: VdomElement): Self = StObject.set(x, "recaptchaComponent", value.rawElement.asInstanceOf[js.Any])
      
      inline def setRenderExplicitly(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "renderExplicitly", value.toJsFn)
