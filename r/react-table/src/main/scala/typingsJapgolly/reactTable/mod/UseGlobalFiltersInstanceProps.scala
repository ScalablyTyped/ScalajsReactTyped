...
object UseGlobalFiltersInstanceProps {
  ...
  extension [Self <: UseGlobalFiltersInstanceProps[?], D /* <: js.Object */](x: Self & UseGlobalFiltersInstanceProps[D]) {
    ...
    inline def setSetGlobalFilter(value: FilterValue => Callback): Self = StObject.set(x, "setGlobalFilter", js.Any.fromFunction1((t0: FilterValue) => value(t0).runNow()))
  }
}
