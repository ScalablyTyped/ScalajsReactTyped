...
import typingsJapgolly.reactTable.mod.CellProps
import typingsJapgolly.reactTable.mod.CellValue
import typingsJapgolly.reactTable.mod.Column
...
import typingsJapgolly.reactTable.mod.TableInstance
