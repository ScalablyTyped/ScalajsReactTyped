...
import typingsJapgolly.draftJs.mod.EditorState
import typingsJapgolly.react.mod.Component
import typingsJapgolly.reactRte.reactRteStrings.STYLE
...
object mod {
  ...
  type CustControlFunc = js.Function3[/* set */ SetControlState, /* get */ GetControlState, /* state */ EditorState, Node]
  ...
  type CustomControl = Node | CustControlFunc
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactRte.reactRteStrings.INLINE_STYLE_BUTTONS
    - typingsJapgolly.reactRte.reactRteStrings.BLOCK_TYPE_BUTTONS
    - typingsJapgolly.reactRte.reactRteStrings.LINK_BUTTONS
    - typingsJapgolly.reactRte.reactRteStrings.BLOCK_TYPE_DROPDOWN
    - typingsJapgolly.reactRte.reactRteStrings.HISTORY_BUTTONS
    - typingsJapgolly.reactRte.reactRteStrings.IMAGE_BUTTON
  */
  trait GroupName extends StObject
  object GroupName {
    
    inline def BLOCK_TYPE_BUTTONS: typingsJapgolly.reactRte.reactRteStrings.BLOCK_TYPE_BUTTONS = "BLOCK_TYPE_BUTTONS".asInstanceOf[typingsJapgolly.reactRte.reactRteStrings.BLOCK_TYPE_BUTTONS]
    
    inline def BLOCK_TYPE_DROPDOWN: typingsJapgolly.reactRte.reactRteStrings.BLOCK_TYPE_DROPDOWN = "BLOCK_TYPE_DROPDOWN".asInstanceOf[typingsJapgolly.reactRte.reactRteStrings.BLOCK_TYPE_DROPDOWN]
    
    inline def HISTORY_BUTTONS: typingsJapgolly.reactRte.reactRteStrings.HISTORY_BUTTONS = "HISTORY_BUTTONS".asInstanceOf[typingsJapgolly.reactRte.reactRteStrings.HISTORY_BUTTONS]
    
    inline def IMAGE_BUTTON: typingsJapgolly.reactRte.reactRteStrings.IMAGE_BUTTON = "IMAGE_BUTTON".asInstanceOf[typingsJapgolly.reactRte.reactRteStrings.IMAGE_BUTTON]
    
    inline def INLINE_STYLE_BUTTONS: typingsJapgolly.reactRte.reactRteStrings.INLINE_STYLE_BUTTONS = "INLINE_STYLE_BUTTONS".asInstanceOf[typingsJapgolly.reactRte.reactRteStrings.INLINE_STYLE_BUTTONS]
    
    inline def LINK_BUTTONS: typingsJapgolly.reactRte.reactRteStrings.LINK_BUTTONS = "LINK_BUTTONS".asInstanceOf[typingsJapgolly.reactRte.reactRteStrings.LINK_BUTTONS]
  }
  ...
  trait InlineCreators extends StObject {
    ...
    def Style(style: String): typingsJapgolly.reactRte.mod.Style = js.native
  }
  ...
  type RichTextEditor = japgolly.scalajs.react.facade.React.Component[Props & js.Object, js.Object]
