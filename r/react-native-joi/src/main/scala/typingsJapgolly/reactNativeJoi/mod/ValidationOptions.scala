...
import typingsJapgolly.reactNativeJoi.anon.Arrays
...
object ValidationOptions {
  ...
  extension [Self <: ValidationOptions](x: Self) {
    ...
    inline def setPresence(
      value: typingsJapgolly.reactNativeJoi.reactNativeJoiStrings.optional | typingsJapgolly.reactNativeJoi.reactNativeJoiStrings.required | typingsJapgolly.reactNativeJoi.reactNativeJoiStrings.forbidden
