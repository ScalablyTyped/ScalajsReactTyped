...
import typingsJapgolly.reactIcons.reactIconsStrings.`additions removals`
...
import typingsJapgolly.reactIcons.reactIconsStrings.`removals additions`
import typingsJapgolly.reactIcons.reactIconsStrings.`removals text`
import typingsJapgolly.reactIcons.reactIconsStrings.`text additions`
import typingsJapgolly.reactIcons.reactIconsStrings.`text removals`
...
object anon {
  ...
  object IconBasePropsattrundefine {
    ...
    extension [Self <: IconBasePropsattrundefine](x: Self) {
