...
import typingsJapgolly.reactPlotlyJs.reactPlotlyJsNumbers.`2`
...
object PartialConfig {
  ...
  def apply(
    ...
    setBackground: js.UndefOr[CallbackTo[String | opaque | transparent]] = js.undefined,
    ...
    setBackground.foreach(p => __obj.updateDynamic("setBackground")(p.toJsFn))
