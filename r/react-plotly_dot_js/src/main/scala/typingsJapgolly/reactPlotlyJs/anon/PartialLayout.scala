...
import typingsJapgolly.plotlyJs.mod.Template
...
import typingsJapgolly.reactPlotlyJs.reactPlotlyJsStrings.`x unified`
import typingsJapgolly.reactPlotlyJs.reactPlotlyJsStrings.`y unified`
...
import typingsJapgolly.reactPlotlyJs.reactPlotlyJsStrings.event
import typingsJapgolly.reactPlotlyJs.reactPlotlyJsStrings.eventPlussignselect
...
import typingsJapgolly.reactPlotlyJs.reactPlotlyJsStrings.none
...
object PartialLayout {
  ...
  extension [Self <: PartialLayout](x: Self) {
    ...
    inline def setHovermode(
      value: closest | typingsJapgolly.reactPlotlyJs.reactPlotlyJsStrings.x | y | (`x unified`) | (`y unified`) | `false`
