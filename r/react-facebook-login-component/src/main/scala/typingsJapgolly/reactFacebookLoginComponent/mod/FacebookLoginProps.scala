...
object FacebookLoginProps {
  @scala.inline
  def apply(
    responseHandler: FacebookLoginInfo => Callback,
    socialId: String,
    about: String = null,
    ...
    onClick: ReactMouseEventFrom[org.scalajs.dom.raw.HTMLButtonElement] => Callback = null,
    ...
    __obj.updateDynamic("responseHandler")(js.Any.fromFunction1((t0: typingsJapgolly.reactFacebookLoginComponent.mod.FacebookLoginInfo) => responseHandler(t0).runNow()))
