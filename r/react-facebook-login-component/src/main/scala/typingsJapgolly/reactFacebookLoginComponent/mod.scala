package typingsJapgolly.reactFacebookLoginComponent
...
object mod {
  ...
  object FacebookLoginProps {
    ...
    inline def apply(responseHandler: FacebookLoginInfo => Callback, socialId: String): FacebookLoginProps = {
      val __obj = js.Dynamic.literal(responseHandler = js.Any.fromFunction1((t0: FacebookLoginInfo) => responseHandler(t0).runNow()), socialId = socialId.asInstanceOf[js.Any])
    ...
    extension [Self <: FacebookLoginProps](x: Self) {
      ...
      inline def setResponseHandler(value: FacebookLoginInfo => Callback): Self = StObject.set(x, "responseHandler", js.Any.fromFunction1((t0: FacebookLoginInfo) => value(t0).runNow()))
