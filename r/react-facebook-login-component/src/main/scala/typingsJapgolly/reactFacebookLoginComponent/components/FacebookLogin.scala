package typingsJapgolly.reactFacebookLoginComponent.components
...
import typingsJapgolly.reactFacebookLoginComponent.mod.FacebookLoginInfo
import typingsJapgolly.reactFacebookLoginComponent.mod.FacebookLoginProps
...
object FacebookLogin {
  ...
  inline def apply(responseHandler: FacebookLoginInfo => Callback, socialId: String): Builder = {
    val __props = js.Dynamic.literal(responseHandler = js.Any.fromFunction1((t0: FacebookLoginInfo) => responseHandler(t0).runNow()), socialId = socialId.asInstanceOf[js.Any])
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactFacebookLoginComponent.mod.FacebookLogin] {
