...
object FacebookLogin {
  def apply(
    ...
    FacebookLoginProps, 
    typingsJapgolly.reactFacebookLoginComponent.mod.FacebookLogin, 
    Unit, 
    FacebookLoginProps
  ] = {
  ...
  typingsJapgolly.reactFacebookLoginComponent.mod.FacebookLoginProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactFacebookLoginComponent.mod.FacebookLogin](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactFacebookLoginComponent.mod.FacebookLoginProps])(children: _*)
  }
