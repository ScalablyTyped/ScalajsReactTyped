...
import typingsJapgolly.reactLoadable.anon.Default
...
object LoadableExport {
  ...
  object CommonOptions {
    ...
    extension [Self <: CommonOptions](x: Self) {
      ...
      inline def setWebpack(value: CallbackTo[js.Array[String | Double]]): Self = StObject.set(x, "webpack", value.toJsFn)
  ...
  object LoadableCaptureProps {
    ...
    inline def apply(report: String => Callback): LoadableCaptureProps = {
      val __obj = js.Dynamic.literal(report = js.Any.fromFunction1((t0: String) => report(t0).runNow()))
      __obj.asInstanceOf[LoadableCaptureProps]
    }
    
    extension [Self <: LoadableCaptureProps](x: Self) {
      
      inline def setReport(value: String => Callback): Self = StObject.set(x, "report", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    }
  }
  ...
  object LoadableComponent {
    ...
    inline def apply(preload: Callback): LoadableComponent = {
      val __obj = js.Dynamic.literal(preload = preload.toJsFn)
      __obj.asInstanceOf[LoadableComponent]
    }
    
    extension [Self <: LoadableComponent](x: Self) {
      
      inline def setPreload(value: Callback): Self = StObject.set(x, "preload", value.toJsFn)
    }
  }
  ...
  object LoadingComponentProps {
    ...
    inline def apply(error: Any, isLoading: Boolean, pastDelay: Boolean, retry: Callback, timedOut: Boolean): LoadingComponentProps = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any], isLoading = isLoading.asInstanceOf[js.Any], pastDelay = pastDelay.asInstanceOf[js.Any], retry = retry.toJsFn, timedOut = timedOut.asInstanceOf[js.Any])
  ...
  */
  ...
  object Options {
    ...
    inline def OptionsWithRender[Props, Exports /* <: js.Object */](
      ...
      render: (Exports, Props) => Node
    ): typingsJapgolly.reactLoadable.LoadableExport.OptionsWithRender[Props, Exports] = {
      val __obj = js.Dynamic.literal(loader = loader.toJsFn, loading = loading.asInstanceOf[js.Any], render = js.Any.fromFunction2(render))
      __obj.asInstanceOf[typingsJapgolly.reactLoadable.LoadableExport.OptionsWithRender[Props, Exports]]
    }
    
    inline def OptionsWithoutRender[Props](
      loader: CallbackTo[js.Promise[ComponentType[Props] | Default[Props]]],
      loading: ComponentType[LoadingComponentProps]
    ): typingsJapgolly.reactLoadable.LoadableExport.OptionsWithoutRender[Props] = {
      val __obj = js.Dynamic.literal(loader = loader.toJsFn, loading = loading.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reactLoadable.LoadableExport.OptionsWithoutRender[Props]]
    }
  }
  ...
  object OptionsWithMap {
    ...
    extension [Self <: OptionsWithMap[?, ?], Props, Exports /* <: StringDictionary[Any] */](x: Self & (OptionsWithMap[Props, Exports])) {
      ...
      inline def setRender(value: (Exports, Props) => Node): Self = StObject.set(x, "render", js.Any.fromFunction2(value))
    }
  }
  ...
  object OptionsWithRender {
    ...
    extension [Self <: OptionsWithRender[?, ?], Props, Exports /* <: js.Object */](x: Self & (OptionsWithRender[Props, Exports])) {
      ...
      inline def setLoader(value: CallbackTo[js.Promise[Exports]]): Self = StObject.set(x, "loader", value.toJsFn)
  ...
  object OptionsWithoutRender {
    ...
    extension [Self <: OptionsWithoutRender[?], Props](x: Self & OptionsWithoutRender[Props]) {
      ...
      inline def setLoader(value: CallbackTo[js.Promise[ComponentType[Props] | Default[Props]]]): Self = StObject.set(x, "loader", value.toJsFn)
    }
  }
}
