...
object anon {
  ...
  object Handler {
    ...
    extension [Self <: Handler](x: Self) {
      ...
      inline def setHandler(value: (/* context */ Any, /* ev */ Event, /* biding */ Any) => Callback): Self = StObject.set(x, "handler", js.Any.fromFunction3((t0: /* context */ Any, t1: /* ev */ Event, t2: /* biding */ Any) => (value(t0, t1, t2)).runNow()))
