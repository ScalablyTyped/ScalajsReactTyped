...
object AnonHandler {
  @scala.inline
  def apply(
    handler: (/* context */ js.Any, /* ev */ Event_, /* biding */ js.Any) => Callback = null,
    prefix: String = null,
    ...
    if (handler != null) __obj.updateDynamic("handler")(js.Any.fromFunction3((t0: /* context */ js.Any, t1: /* ev */ typingsJapgolly.std.Event_, t2: /* biding */ js.Any) => handler(t0, t1, t2).runNow()))
