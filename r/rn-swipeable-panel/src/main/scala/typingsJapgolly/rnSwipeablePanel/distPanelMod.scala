...
import typingsJapgolly.rnSwipeablePanel.rnSwipeablePanelStrings.landscape
import typingsJapgolly.rnSwipeablePanel.rnSwipeablePanelStrings.portrait
...
object distPanelMod {
  ...
  object SwipeablePanelProps {
    ...
    inline def apply(isActive: Boolean, onClose: Callback): SwipeablePanelProps = {
      val __obj = js.Dynamic.literal(isActive = isActive.asInstanceOf[js.Any], onClose = onClose.toJsFn)
