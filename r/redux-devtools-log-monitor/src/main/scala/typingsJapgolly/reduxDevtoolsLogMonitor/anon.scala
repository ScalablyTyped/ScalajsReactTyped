...
import typingsJapgolly.reduxDevtoolsDockMonitor.libReducersMod.DockMonitorState
...
import typingsJapgolly.reduxDevtoolsLogMonitor.libLogMonitorMod.DefaultProps
import typingsJapgolly.reduxDevtoolsLogMonitor.libLogMonitorMod.ExternalProps
...
import typingsJapgolly.reduxDevtoolsLogMonitor.reduxDevtoolsLogMonitorStrings.default
...
object anon {
  ...
  trait ComponentClassExternalPro
    extends StObject
       with Instantiable1[
          /* props */ ExternalProps[Any, typingsJapgolly.redux.mod.Action[Any]], 
          Component[(ExternalProps[Any, typingsJapgolly.redux.mod.Action[Any]]) & js.Object, js.Object]
        ]
       with Instantiable2[
          /* props */ ExternalProps[Any, typingsJapgolly.redux.mod.Action[Any]], 
          /* context */ Any, 
    ...
    var getDerivedStateFromError: js.UndefOr[
        GetDerivedStateFromError[ExternalProps[Any, typingsJapgolly.redux.mod.Action[Any]], Any]
      ] = js.native
    
    var getDerivedStateFromProps: js.UndefOr[
        GetDerivedStateFromProps[ExternalProps[Any, typingsJapgolly.redux.mod.Action[Any]], Any]
      ] = js.native
    
    var propTypes: js.UndefOr[WeakValidationMapExternal] = js.native
    
    def update(
      monitorProps: ExternalProps[Any, typingsJapgolly.redux.mod.Action[Any]],
      state: Unit,
  ...
  trait FunctionComponentExternal extends StObject {
    ...
    def apply(props: ExternalProps[Any, typingsJapgolly.redux.mod.Action[Any]]): Element | Null = js.native
    def apply(props: ExternalProps[Any, typingsJapgolly.redux.mod.Action[Any]], context: Any): Element | Null = js.native
  ...
  trait PartialExternalPropsunkno extends StObject {
    ...
    var dispatch: js.UndefOr[
        typingsJapgolly.redux.mod.Dispatch[
          LogMonitorAction | (LiftedAction[Any, typingsJapgolly.redux.mod.Action[Any], LogMonitorState])
        ]
      ] = js.undefined
  ...
  object PartialExternalPropsunkno {
    ...
    extension [Self <: PartialExternalPropsunkno](x: Self) {
      ...
      inline def setDispatch(
        value: LogMonitorAction | (LiftedAction[Any, typingsJapgolly.redux.mod.Action[Any], LogMonitorState]) => LogMonitorAction | (LiftedAction[Any, typingsJapgolly.redux.mod.Action[Any], LogMonitorState])
