...
object libActionsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reduxDevtoolsLogMonitor.libActionsMod.UpdateScrollTopAction
    - typingsJapgolly.reduxDevtoolsLogMonitor.libActionsMod.StartConsecutiveToggleAction
  */
  trait LogMonitorAction extends StObject
  object LogMonitorAction {
    
    inline def StartConsecutiveToggleAction(`type`: /* "@@redux-devtools-log-monitor/START_CONSECUTIVE_TOGGLE" */ String): typingsJapgolly.reduxDevtoolsLogMonitor.libActionsMod.StartConsecutiveToggleAction = {
      val __obj = js.Dynamic.literal(id = null)
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reduxDevtoolsLogMonitor.libActionsMod.StartConsecutiveToggleAction]
    }
    
    inline def UpdateScrollTopAction(scrollTop: Double, `type`: /* "@@redux-devtools-log-monitor/UPDATE_SCROLL_TOP" */ String): typingsJapgolly.reduxDevtoolsLogMonitor.libActionsMod.UpdateScrollTopAction = {
      val __obj = js.Dynamic.literal(scrollTop = scrollTop.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.reduxDevtoolsLogMonitor.libActionsMod.UpdateScrollTopAction]
    }
  }
