...
import typingsJapgolly.reactSpringAnimated.anon.Animated
...
object distDeclarationsSrcCreateHostMod {
  ...
  trait HostConfig extends StObject {
    ...
    def createAnimatedStyle(style: Lookup[Any]): typingsJapgolly.reactSpringAnimated.distDeclarationsSrcAnimatedMod.Animated[Any]
  ...
  object HostConfig {
    ...
    inline def apply(
      ...
      createAnimatedStyle: Lookup[Any] => typingsJapgolly.reactSpringAnimated.distDeclarationsSrcAnimatedMod.Animated[Any],
    ...
    extension [Self <: HostConfig](x: Self) {
      ...
      inline def setCreateAnimatedStyle(
        value: Lookup[Any] => typingsJapgolly.reactSpringAnimated.distDeclarationsSrcAnimatedMod.Animated[Any]
