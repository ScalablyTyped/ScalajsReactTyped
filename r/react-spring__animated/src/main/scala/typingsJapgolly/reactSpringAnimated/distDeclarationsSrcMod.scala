...
object distDeclarationsSrcMod {
  ...
  open class Animated[T] ()
    extends typingsJapgolly.reactSpringAnimated.distDeclarationsSrcAnimatedMod.Animated[T]
  
  @JSImport("@react-spring/animated/dist/declarations/src", "AnimatedArray")
  @js.native
  open class AnimatedArray[T /* <: js.Array[Value] */] protected ()
    extends typingsJapgolly.reactSpringAnimated.distDeclarationsSrcAnimatedArrayMod.AnimatedArray[T] {
  ...
  open class AnimatedObject protected ()
    extends typingsJapgolly.reactSpringAnimated.distDeclarationsSrcAnimatedObjectMod.AnimatedObject {
  ...
  open class AnimatedString protected ()
    extends typingsJapgolly.reactSpringAnimated.distDeclarationsSrcAnimatedStringMod.AnimatedString {
  ...
  open class AnimatedValue[T] protected ()
    extends typingsJapgolly.reactSpringAnimated.distDeclarationsSrcAnimatedValueMod.AnimatedValue[T] {
