...
object libTypescriptTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.horizontal
    - typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.vertical
  */
  trait Orientation extends StObject
  object Orientation {
    
    inline def horizontal: typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.horizontal = "horizontal".asInstanceOf[typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.horizontal]
    
    inline def vertical: typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.vertical = "vertical".asInstanceOf[typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.vertical]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.auto
    - typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.always
    - typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.never
  */
  trait OverScrollMode extends StObject
  object OverScrollMode {
    
    inline def always: typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.always = "always".asInstanceOf[typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.always]
    
    inline def auto: typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.auto = "auto".asInstanceOf[typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.auto]
    
    inline def never: typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.never = "never".asInstanceOf[typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.never]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.idle
    - typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.dragging
    - typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.settling
  */
  trait PageScrollState extends StObject
  object PageScrollState {
    
    inline def dragging: typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.dragging = "dragging".asInstanceOf[typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.dragging]
    
    inline def idle: typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.idle = "idle".asInstanceOf[typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.idle]
    
    inline def settling: typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.settling = "settling".asInstanceOf[typingsJapgolly.reactNativePagerView.reactNativePagerViewStrings.settling]
  }
  ...
  object PagerViewProps {
    ...
    extension [Self <: PagerViewProps](x: Self) {
      ...
      inline def setOnPageScroll(value: /* event */ PagerViewOnPageScrollEvent => Callback): Self = StObject.set(x, "onPageScroll", js.Any.fromFunction1((t0: /* event */ PagerViewOnPageScrollEvent) => value(t0).runNow()))
      ...
      inline def setOnPageSelected(value: /* event */ PagerViewOnPageSelectedEvent => Callback): Self = StObject.set(x, "onPageSelected", js.Any.fromFunction1((t0: /* event */ PagerViewOnPageSelectedEvent) => value(t0).runNow()))
