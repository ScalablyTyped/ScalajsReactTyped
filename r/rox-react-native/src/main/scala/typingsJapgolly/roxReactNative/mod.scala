...
import typingsJapgolly.roxReactNative.roxReactNativeStrings.`false`
import typingsJapgolly.roxReactNative.roxReactNativeStrings.`true`
...
object mod {
  ...
  object FreezeOptions extends StObject {
    ...
    sealed trait freezeOptionNone
      extends StObject
         with FreezeOptions
    /* 3 */ val freezeOptionNone: typingsJapgolly.roxReactNative.mod.FreezeOptions.freezeOptionNone & Double = js.native
    
    @js.native
    sealed trait freezeOptionUntilForeground
      extends StObject
         with FreezeOptions
    /* 2 */ val freezeOptionUntilForeground: typingsJapgolly.roxReactNative.mod.FreezeOptions.freezeOptionUntilForeground & Double = js.native
    
    @js.native
    sealed trait freezeOptionUntilLaunch
      extends StObject
         with FreezeOptions
    /* 1 */ val freezeOptionUntilLaunch: typingsJapgolly.roxReactNative.mod.FreezeOptions.freezeOptionUntilLaunch & Double = js.native
  }
  ...
  object RoxErrorTrigger extends StObject {
    ...
    /* "CONFIGURATION_FETCHED_HANDLER" */ val CONFIGURATION_FETCHED_HANDLER: typingsJapgolly.roxReactNative.mod.RoxErrorTrigger.CONFIGURATION_FETCHED_HANDLER & String = js.native
    
    @js.native
    sealed trait CUSTOM_PROPERTY_GENERATOR
      extends StObject
         with RoxErrorTrigger
    /* "CUSTOM_PROPERTY_GENERATOR" */ val CUSTOM_PROPERTY_GENERATOR: typingsJapgolly.roxReactNative.mod.RoxErrorTrigger.CUSTOM_PROPERTY_GENERATOR & String = js.native
    
    @js.native
    sealed trait DYNAMIC_PROPERTIES_RULE
      extends StObject
         with RoxErrorTrigger
    /* "DYNAMIC_PROPERTIES_RULE" */ val DYNAMIC_PROPERTIES_RULE: typingsJapgolly.roxReactNative.mod.RoxErrorTrigger.DYNAMIC_PROPERTIES_RULE & String = js.native
    
    @js.native
    sealed trait IMPRESSION_HANDLER
      extends StObject
         with RoxErrorTrigger
    /* "IMPRESSION_HANDLER" */ val IMPRESSION_HANDLER: typingsJapgolly.roxReactNative.mod.RoxErrorTrigger.IMPRESSION_HANDLER & String = js.native
  }
  ...
  object RoxFetcherStatus extends StObject {
    ...
    /* "APPLIED_FROM_CACHE" */ val AppliedFromCache: typingsJapgolly.roxReactNative.mod.RoxFetcherStatus.AppliedFromCache & String = js.native
    
    @js.native
    sealed trait AppliedFromEmbedded
      extends StObject
         with RoxFetcherStatus
    /* "APPLIED_FROM_EMBEDDED" */ val AppliedFromEmbedded: typingsJapgolly.roxReactNative.mod.RoxFetcherStatus.AppliedFromEmbedded & String = js.native
    
    @js.native
    sealed trait AppliedFromNetwork
      extends StObject
         with RoxFetcherStatus
    /* "APPLIED_FROM_NETWORK" */ val AppliedFromNetwork: typingsJapgolly.roxReactNative.mod.RoxFetcherStatus.AppliedFromNetwork & String = js.native
    
    @js.native
    sealed trait ErrorFetchFailed
      extends StObject
         with RoxFetcherStatus
    /* "ERROR_FETCH_FAILED" */ val ErrorFetchFailed: typingsJapgolly.roxReactNative.mod.RoxFetcherStatus.ErrorFetchFailed & String = js.native
  }
