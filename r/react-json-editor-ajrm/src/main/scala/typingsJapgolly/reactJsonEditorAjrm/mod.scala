package typingsJapgolly.reactJsonEditorAjrm

import typingsJapgolly.react.mod.Component
import typingsJapgolly.reactJsonEditorAjrm.anon.Ampersand
import typingsJapgolly.reactJsonEditorAjrm.anon.Array
import typingsJapgolly.reactJsonEditorAjrm.anon.Curly
import typingsJapgolly.reactJsonEditorAjrm.anon.MissingClose
import typingsJapgolly.reactJsonEditorAjrm.anon.NumberAndLetterMissingQuotes
import typingsJapgolly.reactJsonEditorAjrm.anon.TermSequence
...
object mod {
  ...
  type JSONInput = japgolly.scalajs.react.facade.React.Component[JSONInputProperties & js.Object, js.Object]
  
  trait JSONInputProperties extends StObject {
    
    var colors: js.UndefOr[typingsJapgolly.reactJsonEditorAjrm.mod.colors] = js.undefined
    
    var confirmGood: js.UndefOr[Boolean] = js.undefined
    
    var error: js.UndefOr[typingsJapgolly.reactJsonEditorAjrm.mod.error] = js.undefined
    
    var height: js.UndefOr[String] = js.undefined
    
    var id: js.UndefOr[String] = js.undefined
    
    var locale: typingsJapgolly.reactJsonEditorAjrm.mod.locale
    ...
    var style: js.UndefOr[typingsJapgolly.reactJsonEditorAjrm.mod.style] = js.undefined
