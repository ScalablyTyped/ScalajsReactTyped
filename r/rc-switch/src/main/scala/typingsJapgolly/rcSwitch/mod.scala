package typingsJapgolly.rcSwitch
...
object mod extends Shortcut {
  ...
  @js.native
  val default: ForwardRefExoticComponent[SwitchProps & RefAttributes[HTMLButtonElement]] = js.native
  
  type SwitchChangeEventHandler = js.Function2[
    /* checked */ Boolean, 
    /* event */ ReactMouseEventFrom[HTMLButtonElement] | ReactKeyboardEventFrom[HTMLButtonElement], 
    Unit
  ]
  
  type SwitchClickEventHandler = SwitchChangeEventHandler
  
  /* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLButtonElement>, 'onChange' | 'onClick'> */
  ...
  object SwitchProps {
    ...
    extension [Self <: SwitchProps](x: Self) {
      ...
      ): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* checked */ Boolean, t1: /* event */ ReactMouseEventFrom[HTMLButtonElement] | ReactKeyboardEventFrom[HTMLButtonElement]) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnClick(
        value: (/* checked */ Boolean, /* event */ ReactMouseEventFrom[HTMLButtonElement] | ReactKeyboardEventFrom[HTMLButtonElement]) => Callback
      ): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* checked */ Boolean, t1: /* event */ ReactMouseEventFrom[HTMLButtonElement] | ReactKeyboardEventFrom[HTMLButtonElement]) => (value(t0, t1)).runNow()))
  ...
  type _To = ForwardRefExoticComponent[SwitchProps & RefAttributes[HTMLButtonElement]]
  
  /* This means you don't have to write `default`, but can instead just say `mod.foo` */
  override def _to: ForwardRefExoticComponent[SwitchProps & RefAttributes[HTMLButtonElement]] = default
}
