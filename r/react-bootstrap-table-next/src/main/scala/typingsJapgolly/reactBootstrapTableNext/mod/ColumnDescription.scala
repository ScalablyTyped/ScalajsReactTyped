...
import typingsJapgolly.reactBootstrapTableNext.anon.OnClick
import typingsJapgolly.reactBootstrapTableNext.anon.TooltipFormatter
import typingsJapgolly.reactBootstrapTableNext.anon.Type
...
object ColumnDescription {
  ...
  extension [Self <: ColumnDescription[?, ?], T /* <: js.Object */, E](x: Self & (ColumnDescription[T, E])) {
    ...
    inline def setCsvFormatter(value: (Any, T, /* rowIndex */ Double, /* formatExtraData */ js.UndefOr[E]) => Node): Self = StObject.set(x, "csvFormatter", js.Any.fromFunction4(value))
    ...
    inline def setFooterFormatter(value: (/* column */ ColumnDescription[T, E], /* columnIndex */ Double) => Callback): Self = StObject.set(x, "footerFormatter", js.Any.fromFunction2((t0: /* column */ ColumnDescription[T, E], t1: /* columnIndex */ Double) => (value(t0, t1)).runNow()))
    ...
    inline def setFormatter(value: (Any, T, /* rowIndex */ Double, /* formatExtraData */ js.UndefOr[E]) => Node): Self = StObject.set(x, "formatter", js.Any.fromFunction4(value))
    ...
    inline def setHeaderFormatter(
      value: (/* column */ ColumnDescription[T, Any], /* colIndex */ Double, /* components */ FilterElement) => Node
    ...
    inline def setHeaderStyleCallbackTo(value: CallbackTo[CSSProperties]): Self = StObject.set(x, "headerStyle", value.toJsFn)
