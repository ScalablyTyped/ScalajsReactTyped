...
object PaginationOptions {
  ...
  extension [Self <: PaginationOptions](x: Self) {
    ...
    inline def setOnSizePerPageChange(value: (/* page */ Double, /* sizePerPage */ Double) => Callback): Self = StObject.set(x, "onSizePerPageChange", js.Any.fromFunction2((t0: /* page */ Double, t1: /* sizePerPage */ Double) => (value(t0, t1)).runNow()))
    ...
    inline def setPrePageTextVdomElement(value: VdomElement): Self = StObject.set(x, "prePageText", value.rawElement.asInstanceOf[js.Any])
