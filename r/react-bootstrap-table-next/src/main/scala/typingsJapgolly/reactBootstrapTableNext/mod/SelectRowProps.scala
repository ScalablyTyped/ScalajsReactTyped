...
import typingsJapgolly.reactBootstrapTableNext.anon.Checked
import typingsJapgolly.reactBootstrapTableNext.anon.Disabled
import typingsJapgolly.reactBootstrapTableNext.anon.Indeterminate
...
trait SelectRowProps[T] extends StObject {
  ...
  var selectionHeaderRenderer: js.UndefOr[
    js.Function1[/* options */ Indeterminate, typingsJapgolly.react.mod.global.JSX.Element]
  ] = js.undefined
  
  var selectionRenderer: js.UndefOr[
    js.Function1[/* options */ Checked, typingsJapgolly.react.mod.global.JSX.Element]
  ] = js.undefined
...
object SelectRowProps {
  ...
  extension [Self <: SelectRowProps[?], T](x: Self & SelectRowProps[T]) {
    ...
    inline def setOnSelect(
      value: (/* row */ T, /* isSelected */ Boolean, /* rowIndex */ Double, /* e */ ReactEventFrom[Element]) => Unit | Boolean
    ): Self = StObject.set(x, "onSelect", js.Any.fromFunction4(value))
    
    inline def setOnSelectAll(
      value: (/* isSelect */ Boolean, /* rows */ js.Array[T], /* e */ ReactEventFrom[Element]) => Unit | js.Array[Double]
    ...
    inline def setSelectionHeaderRenderer(value: /* options */ Indeterminate => typingsJapgolly.react.mod.global.JSX.Element): Self = StObject.set(x, "selectionHeaderRenderer", js.Any.fromFunction1(value))
    
    inline def setSelectionHeaderRendererUndefined: Self = StObject.set(x, "selectionHeaderRenderer", js.undefined)
    
    inline def setSelectionRenderer(value: /* options */ Checked => typingsJapgolly.react.mod.global.JSX.Element): Self = StObject.set(x, "selectionRenderer", js.Any.fromFunction1(value))
