...
object BootstrapTableProps {
  ...
  extension [Self <: BootstrapTableProps[?, ?], T /* <: js.Object */, K](x: Self & (BootstrapTableProps[T, K])) {
    ...
    inline def setNoDataIndicationCallbackTo(value: CallbackTo[Element | String]): Self = StObject.set(x, "noDataIndication", value.toJsFn)
    
    inline def setNoDataIndicationUndefined: Self = StObject.set(x, "noDataIndication", js.undefined)
    
    inline def setNoDataIndicationVdomElement(value: VdomElement): Self = StObject.set(x, "noDataIndication", value.rawElement.asInstanceOf[js.Any])
    
    inline def setOnDataSizeChange(value: /* props */ DataSize => Callback): Self = StObject.set(x, "onDataSizeChange", js.Any.fromFunction1((t0: /* props */ DataSize) => value(t0).runNow()))
    ...
    inline def setOnTableChange(value: (/* type */ TableChangeType, /* newState */ TableChangeState[T]) => Callback): Self = StObject.set(x, "onTableChange", js.Any.fromFunction2((t0: /* type */ TableChangeType, t1: /* newState */ TableChangeState[T]) => (value(t0, t1)).runNow()))
