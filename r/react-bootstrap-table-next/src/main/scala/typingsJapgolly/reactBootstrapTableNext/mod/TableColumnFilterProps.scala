...
object TableColumnFilterProps {
  ...
  extension [Self <: TableColumnFilterProps[?, ?], FV, T /* <: js.Object */](x: Self & (TableColumnFilterProps[FV, T])) {
    ...
    inline def setGetFilter(value: /* filter */ js.Function1[/* value */ FV, Unit | js.Array[T]] => Callback): Self = StObject.set(x, "getFilter", js.Any.fromFunction1((t0: /* filter */ js.Function1[/* value */ FV, Unit | js.Array[T]]) => value(t0).runNow()))
