...
- typingsJapgolly.reactNavigation.mod.NavigationRoute because Already inherited
- typingsJapgolly.reactNavigation.mod.NavigationState because var conflicts: index, isTransitioning, key, params, routes. Inlined  */ trait NavigationStateRoute[NavigationLeafRouteParams]
  extends StObject
