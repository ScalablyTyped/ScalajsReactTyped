...
object NavigationDescriptor {
  ...
  inline def apply[Params, Options, NavigationScreenPropType](
    ...
    val __obj = js.Dynamic.literal(getComponent = getComponent.toJsFn, key = key.asInstanceOf[js.Any], navigation = navigation.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], state = state.asInstanceOf[js.Any])
  ...
  extension [Self <: NavigationDescriptor[?, ?, ?], Params, Options, NavigationScreenPropType](x: Self & (NavigationDescriptor[Params, Options, NavigationScreenPropType])) {
    ...
    inline def setGetComponent(value: CallbackTo[ComponentType[js.Object]]): Self = StObject.set(x, "getComponent", value.toJsFn)
