...
object NavigationEvents {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onDidBlur(value: /* payload */ NavigationEventPayload => Callback): this.type = set("onDidBlur", js.Any.fromFunction1((t0: /* payload */ NavigationEventPayload) => value(t0).runNow()))
    
    inline def onDidFocus(value: /* payload */ NavigationEventPayload => Callback): this.type = set("onDidFocus", js.Any.fromFunction1((t0: /* payload */ NavigationEventPayload) => value(t0).runNow()))
    ...
    inline def onWillBlur(value: /* payload */ NavigationEventPayload => Callback): this.type = set("onWillBlur", js.Any.fromFunction1((t0: /* payload */ NavigationEventPayload) => value(t0).runNow()))
    
    inline def onWillFocus(value: /* payload */ NavigationEventPayload => Callback): this.type = set("onWillFocus", js.Any.fromFunction1((t0: /* payload */ NavigationEventPayload) => value(t0).runNow()))
