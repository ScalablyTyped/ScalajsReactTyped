...
import typingsJapgolly.reactNavigation.mod.NavigationEventPayload
import typingsJapgolly.reactNavigation.mod.NavigationEventsProps
...
object NavigationEvents {
  def apply(
    ...
    typingsJapgolly.reactNavigation.mod.NavigationEvents, 
    Unit, 
    NavigationEventsProps
  ] = {
    ...
    if (onDidBlur != null) __obj.updateDynamic("onDidBlur")(js.Any.fromFunction1((t0: /* payload */ typingsJapgolly.reactNavigation.mod.NavigationEventPayload) => onDidBlur(t0).runNow()))
    if (onDidFocus != null) __obj.updateDynamic("onDidFocus")(js.Any.fromFunction1((t0: /* payload */ typingsJapgolly.reactNavigation.mod.NavigationEventPayload) => onDidFocus(t0).runNow()))
    ...
    if (onWillBlur != null) __obj.updateDynamic("onWillBlur")(js.Any.fromFunction1((t0: /* payload */ typingsJapgolly.reactNavigation.mod.NavigationEventPayload) => onWillBlur(t0).runNow()))
    if (onWillFocus != null) __obj.updateDynamic("onWillFocus")(js.Any.fromFunction1((t0: /* payload */ typingsJapgolly.reactNavigation.mod.NavigationEventPayload) => onWillFocus(t0).runNow()))
  ...
  typingsJapgolly.reactNavigation.mod.NavigationEventsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNavigation.mod.NavigationEvents](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNavigation.mod.NavigationEventsProps])(children: _*)
  }
