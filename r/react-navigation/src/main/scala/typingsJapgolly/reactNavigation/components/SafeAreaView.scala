...
import typingsJapgolly.reactNavigation.mod.SafeAreaViewProps
...
object SafeAreaView {
  def apply(
    ...
    SafeAreaViewProps, 
    typingsJapgolly.reactNavigation.mod.SafeAreaView, 
    Unit, 
    SafeAreaViewProps
  ] = {
  ...
  typingsJapgolly.reactNavigation.mod.SafeAreaViewProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactNavigation.mod.SafeAreaView](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNavigation.mod.SafeAreaViewProps])(children: _*)
  }
