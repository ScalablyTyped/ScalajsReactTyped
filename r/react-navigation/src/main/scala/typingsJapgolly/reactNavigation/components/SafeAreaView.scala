...
object SafeAreaView {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.reactNavigation.mod.SafeAreaView] {
    ...
    inline def forceInset(value: Bottom): this.type = set("forceInset", value.asInstanceOf[js.Any])
