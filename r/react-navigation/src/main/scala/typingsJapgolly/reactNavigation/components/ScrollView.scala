...
object ScrollView {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ScrollViewProps, typingsJapgolly.reactNavigation.mod.ScrollView, Unit, ScrollViewProps] = {
  ...
  typingsJapgolly.reactNavigation.mod.ScrollView](this.componentImport)
