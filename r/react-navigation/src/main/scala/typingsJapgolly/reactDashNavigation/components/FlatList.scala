...
import typingsJapgolly.reactDashNative.reactDashNativeMod.FlatListProps
...
import typingsJapgolly.reactDashNative.reactDashNativeMod.ListRenderItemInfo
...
object FlatList {
  def apply[ItemT](
    renderItem: /* info */ ListRenderItemInfo[ItemT] => CallbackTo[Element | Null],
    ...
    getItemLayout: (/* data */ js.Array[ItemT] | Null, /* index */ Double) => CallbackTo[Anon_Index] = null,
    ...
    FlatListProps[ItemT], 
    typingsJapgolly.reactDashNavigation.reactDashNavigationMod.FlatList[ItemT], 
    Unit, 
    FlatListProps[ItemT]
  ] = {
    val __obj = js.Dynamic.literal()
  
      __obj.updateDynamic("renderItem")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.reactDashNative.reactDashNativeMod.ListRenderItemInfo[ItemT]) => renderItem(t0).runNow()))
    ...
    if (getItemLayout != null) __obj.updateDynamic("getItemLayout")(js.Any.fromFunction2((t0: /* data */ js.Array[ItemT] | scala.Null, t1: /* index */ scala.Double) => getItemLayout(t0, t1).runNow()))
  ...
  typingsJapgolly.reactDashNative.reactDashNativeMod.FlatListProps[ItemT], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNavigation.reactDashNavigationMod.FlatList[ItemT]](js.constructorOf[typingsJapgolly.reactDashNavigation.reactDashNavigationMod.FlatList[ItemT]])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNative.reactDashNativeMod.FlatListProps[ItemT]])(children: _*)
  }
}
