...
import typingsJapgolly.reactDashNavigation.reactDashNavigationMod.NavigationEventPayload
import typingsJapgolly.reactDashNavigation.reactDashNavigationMod.NavigationEventsProps
...
object NavigationEvents {
  def apply(
    ...
    onDidBlur: /* payload */ NavigationEventPayload => Callback = null,
    onDidFocus: /* payload */ NavigationEventPayload => Callback = null,
    ...
    onWillBlur: /* payload */ NavigationEventPayload => Callback = null,
    onWillFocus: /* payload */ NavigationEventPayload => Callback = null,
    ...
    typingsJapgolly.reactDashNavigation.reactDashNavigationMod.NavigationEvents, 
    Unit, 
    NavigationEventsProps
  ] = {
    ...
    if (onDidBlur != null) __obj.updateDynamic("onDidBlur")(js.Any.fromFunction1((t0: /* payload */ typingsJapgolly.reactDashNavigation.reactDashNavigationMod.NavigationEventPayload) => onDidBlur(t0).runNow()))
    if (onDidFocus != null) __obj.updateDynamic("onDidFocus")(js.Any.fromFunction1((t0: /* payload */ typingsJapgolly.reactDashNavigation.reactDashNavigationMod.NavigationEventPayload) => onDidFocus(t0).runNow()))
    ...
    if (onWillBlur != null) __obj.updateDynamic("onWillBlur")(js.Any.fromFunction1((t0: /* payload */ typingsJapgolly.reactDashNavigation.reactDashNavigationMod.NavigationEventPayload) => onWillBlur(t0).runNow()))
    if (onWillFocus != null) __obj.updateDynamic("onWillFocus")(js.Any.fromFunction1((t0: /* payload */ typingsJapgolly.reactDashNavigation.reactDashNavigationMod.NavigationEventPayload) => onWillFocus(t0).runNow()))
  ...
  typingsJapgolly.reactDashNavigation.reactDashNavigationMod.NavigationEventsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNavigation.reactDashNavigationMod.NavigationEvents](js.constructorOf[typingsJapgolly.reactDashNavigation.reactDashNavigationMod.NavigationEvents])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNavigation.reactDashNavigationMod.NavigationEventsProps])(children: _*)
  }
}
