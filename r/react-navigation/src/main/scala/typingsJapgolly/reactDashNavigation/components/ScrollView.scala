...
object ScrollView {
  def apply(
    ...
    ScrollViewProps, 
    typingsJapgolly.reactDashNavigation.reactDashNavigationMod.ScrollView, 
    Unit, 
    ScrollViewProps
  ] = {
  ...
  typingsJapgolly.reactDashNavigation.reactDashNavigationMod.ScrollView](js.constructorOf[typingsJapgolly.reactDashNavigation.reactDashNavigationMod.ScrollView])
