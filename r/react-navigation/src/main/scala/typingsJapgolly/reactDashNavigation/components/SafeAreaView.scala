...
import typingsJapgolly.reactDashNavigation.Anon_Bottom
import typingsJapgolly.reactDashNavigation.reactDashNavigationMod.SafeAreaViewProps
...
object SafeAreaView {
  def apply(
    ...
    SafeAreaViewProps, 
    typingsJapgolly.reactDashNavigation.reactDashNavigationMod.SafeAreaView, 
    Unit, 
    SafeAreaViewProps
  ] = {
  ...
  typingsJapgolly.reactDashNavigation.reactDashNavigationMod.SafeAreaViewProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.reactDashNavigation.reactDashNavigationMod.SafeAreaView](js.constructorOf[typingsJapgolly.reactDashNavigation.reactDashNavigationMod.SafeAreaView])
    f(__obj.asInstanceOf[typingsJapgolly.reactDashNavigation.reactDashNavigationMod.SafeAreaViewProps])(children: _*)
  }
}
