...
import typingsJapgolly.reactDashNavigation.reactDashNavigationStrings.history
import typingsJapgolly.reactDashNavigation.reactDashNavigationStrings.initialRoute
import typingsJapgolly.reactDashNavigation.reactDashNavigationStrings.none
import typingsJapgolly.reactDashNavigation.reactDashNavigationStrings.order
