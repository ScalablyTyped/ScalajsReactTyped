...
/* Rewritten from type alias, can be one of: 
  - typings.reactDashNavigation.reactDashNavigationMod.NavigationLeafRoute[Params]
  - typings.reactDashNavigation.reactDashNavigationMod.NavigationStateRoute[Params]
*/
