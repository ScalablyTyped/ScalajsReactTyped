package typingsJapgolly.reactHamburgerMenu
...
object mod {
  ...
  object HamburgerMenuProps {
    ...
    inline def apply(color: String, isOpen: Boolean, menuClicked: Callback): HamburgerMenuProps = {
      val __obj = js.Dynamic.literal(color = color.asInstanceOf[js.Any], isOpen = isOpen.asInstanceOf[js.Any], menuClicked = menuClicked.toJsFn)
    ...
    extension [Self <: HamburgerMenuProps](x: Self) {
      ...
      inline def setMenuClicked(value: Callback): Self = StObject.set(x, "menuClicked", value.toJsFn)
