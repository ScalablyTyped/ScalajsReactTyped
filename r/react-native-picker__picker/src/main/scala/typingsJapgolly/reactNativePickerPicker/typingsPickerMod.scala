...
import typingsJapgolly.reactNativePickerPicker.reactNativePickerPickerStrings.dialog
import typingsJapgolly.reactNativePickerPicker.reactNativePickerPickerStrings.dropdown
...
object typingsPickerMod {
  ...
  object PickerProps {
    ...
    extension [Self <: PickerProps[?], T](x: Self & PickerProps[T]) {
      ...
      inline def setOnValueChange(value: (/* itemValue */ T, /* itemIndex */ Double) => Callback): Self = StObject.set(x, "onValueChange", js.Any.fromFunction2((t0: /* itemValue */ T, t1: /* itemIndex */ Double) => (value(t0, t1)).runNow()))
