...
trait RootOptions extends js.Object {
  ...
  var hydrationOptions: js.UndefOr[typingsJapgolly.reactDashDom.experimentalMod.reactDashDomMod.HydrationOptions] = js.undefined
}
...
object RootOptions {
  ...
  def apply(
    ...
    hydrationOptions: typingsJapgolly.reactDashDom.experimentalMod.reactDashDomMod.HydrationOptions = null
  ): RootOptions = {
