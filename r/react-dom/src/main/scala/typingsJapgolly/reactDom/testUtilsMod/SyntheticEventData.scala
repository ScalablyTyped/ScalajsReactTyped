...
object SyntheticEventData {
  ...
  def apply(
    ...
    getModifierState: /* key */ String => CallbackTo[Boolean] = null,
    ...
    if (getModifierState != null) __obj.updateDynamic("getModifierState")(js.Any.fromFunction1((t0: /* key */ java.lang.String) => getModifierState(t0).runNow()))
