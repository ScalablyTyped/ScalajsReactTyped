...
import typingsJapgolly.reactDom.anon.TypeofReactTestUtils
import typingsJapgolly.reactDom.anon.UNDEFINEDVOIDONLY
...
object testUtilsMod {
  ...
  inline def findAllInRenderedTree(root: Component[Any & js.Object, js.Object], fn: js.Function1[/* i */ ReactInstance, Boolean]): js.Array[ReactInstance] = (^.asInstanceOf[js.Dynamic].applyDynamic("findAllInRenderedTree")(root.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[js.Array[ReactInstance]]
  
  inline def findRenderedComponentWithType[T /* <: Component[Any & js.Object, js.Object] */, C /* <: ComponentClassP[Any & js.Object] */](root: Component[Any & js.Object, js.Object], `type`: ClassType[Any, T, C]): T = (^.asInstanceOf[js.Dynamic].applyDynamic("findRenderedComponentWithType")(root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[T]
  
  inline def findRenderedDOMComponentWithClass(root: Component[Any & js.Object, js.Object], className: String): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("findRenderedDOMComponentWithClass")(root.asInstanceOf[js.Any], className.asInstanceOf[js.Any])).asInstanceOf[Element]
  
  inline def findRenderedDOMComponentWithTag(root: Component[Any & js.Object, js.Object], tagName: String): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("findRenderedDOMComponentWithTag")(root.asInstanceOf[js.Any], tagName.asInstanceOf[js.Any])).asInstanceOf[Element]
  ...
  inline def isCompositeComponentWithType[T /* <: Component[Any & js.Object, js.Object] */, C /* <: ComponentClassP[Any & js.Object] */](instance: ReactInstance, `type`: ClassType[Any, T, C]): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isCompositeComponentWithType")(instance.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isElementOfType[T /* <: HTMLElement */](element: japgolly.scalajs.react.facade.React.Element, `type`: String): /* is react.react.ReactHTMLElement<T> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isElementOfType")(element.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[/* is react.react.ReactHTMLElement<T> */ Boolean]
  inline def isElementOfType[P](element: japgolly.scalajs.react.facade.React.Element, `type`: FC[P]): /* is react.react.FunctionComponentElement<P> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isElementOfType")(element.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[/* is react.react.FunctionComponentElement<P> */ Boolean]
  inline def isElementOfType[P, T /* <: Component[P & js.Object, js.Object] */, C /* <: ComponentClassP[P & js.Object] */](element: japgolly.scalajs.react.facade.React.Element, `type`: ClassType[P, T, C]): /* is react.react.CElement<P, T> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isElementOfType")(element.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[/* is react.react.CElement<P, T> */ Boolean]
  
  inline def isElementOfType_PT[P /* <: DOMAttributes[js.Object] */, T /* <: Element */](element: japgolly.scalajs.react.facade.React.Element, `type`: String): /* is react.react.DOMElement<P, T> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isElementOfType")(element.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[/* is react.react.DOMElement<P, T> */ Boolean]
  ...
  inline def renderIntoDocument[T /* <: Element */](element: DomElement): T = ^.asInstanceOf[js.Dynamic].applyDynamic("renderIntoDocument")(element.asInstanceOf[js.Any]).asInstanceOf[T]
  inline def renderIntoDocument[P](element: japgolly.scalajs.react.facade.React.Element): (Component[P & js.Object, js.Object]) | Element | Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("renderIntoDocument")(element.asInstanceOf[js.Any]).asInstanceOf[(Component[P & js.Object, js.Object]) | Element | Unit]
  inline def renderIntoDocument[P, T /* <: Component[P & js.Object, js.Object] */](element: CElement[P, T]): T = ^.asInstanceOf[js.Dynamic].applyDynamic("renderIntoDocument")(element.asInstanceOf[js.Any]).asInstanceOf[T]
  
  inline def scryRenderedComponentsWithType[T /* <: Component[Any & js.Object, js.Object] */, C /* <: ComponentClassP[Any & js.Object] */](root: Component[Any & js.Object, js.Object], `type`: ClassType[Any, T, C]): js.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("scryRenderedComponentsWithType")(root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[js.Array[T]]
  
  inline def scryRenderedDOMComponentsWithClass(root: Component[Any & js.Object, js.Object], className: String): js.Array[Element] = (^.asInstanceOf[js.Dynamic].applyDynamic("scryRenderedDOMComponentsWithClass")(root.asInstanceOf[js.Any], className.asInstanceOf[js.Any])).asInstanceOf[js.Array[Element]]
  
  inline def scryRenderedDOMComponentsWithTag(root: Component[Any & js.Object, js.Object], tagName: String): js.Array[Element] = (^.asInstanceOf[js.Dynamic].applyDynamic("scryRenderedDOMComponentsWithTag")(root.asInstanceOf[js.Any], tagName.asInstanceOf[js.Any])).asInstanceOf[js.Array[Element]]
  ...
  type EventSimulator = js.Function2[
    /* element */ Element | (Component[Any & js.Object, js.Object]), 
  ...
  trait ShallowRenderer extends StObject {
    ...
    /**
      ...
      */
    def getRenderOutput[E /* <: japgolly.scalajs.react.facade.React.Element */](): E = js.native
    
    /**
      * Similar to `ReactDOM.render` but it doesn't require DOM and only renders a single level deep.
      */
    def render(element: japgolly.scalajs.react.facade.React.Element): Unit = js.native
    def render(element: japgolly.scalajs.react.facade.React.Element, context: Any): Unit = js.native
