package typingsJapgolly.reactMdBadge.components
...
object BadgedButton {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def badgeClassName(value: String): this.type = set("badgeClassName", value.asInstanceOf[js.Any])
    
    inline def badgeId(value: String): this.type = set("badgeId", value.asInstanceOf[js.Any])
    
    inline def badgeRef(value: Ref[HTMLSpanElement]): this.type = set("badgeRef", value.asInstanceOf[js.Any])
    
    inline def badgeRefFunction1(value: HTMLSpanElement | Null => Callback): this.type = set("badgeRef", js.Any.fromFunction1((t0: HTMLSpanElement | Null) => value(t0).runNow()))
    
    inline def badgeRefNull: this.type = set("badgeRef", null)
    
    inline def badgeStyle(value: CSSProperties): this.type = set("badgeStyle", value.asInstanceOf[js.Any])
    
    inline def badgeTheme(value: BadgeTheme): this.type = set("badgeTheme", value.asInstanceOf[js.Any])
    ...
    inline def disableNullOnZero(value: Boolean): this.type = set("disableNullOnZero", value.asInstanceOf[js.Any])
  ...
  def withProps(p: BadgedButtonProps & RefAttributes[HTMLButtonElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
