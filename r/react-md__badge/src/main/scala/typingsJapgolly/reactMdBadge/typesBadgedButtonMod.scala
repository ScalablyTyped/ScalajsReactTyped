...
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.`additions removals`
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.`additions text`
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.`inline`
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.`removals additions`
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.`removals text`
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.`text additions`
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.`text removals`
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.additions
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.all
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.ascending
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.assertive
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.both
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.button
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.copy
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.date
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.decimal
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.descending
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.dialog
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.email
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.execute
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.grammar
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.grid
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.horizontal
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.inherit
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.link
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.list
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.listbox
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.location
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.menu
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.mixed
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.move
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.no
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.none
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.numeric
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.off
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.on
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.other
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.page
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.polite
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.popup
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.removals
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.reset
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.search
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.spelling
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.step
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.submit
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.tel
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.text
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.time
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.tree
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.url
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.vertical
import typingsJapgolly.reactMdBadge.reactMdBadgeStrings.yes
import typingsJapgolly.reactMdBadge.typesBadgeMod.BadgeTheme
...
object typesBadgedButtonMod {
  
  @JSImport("@react-md/badge/types/BadgedButton", "BadgedButton")
  @js.native
  ...
  trait BadgedButtonProps extends StObject {
    ...
    /**
      ...
      */
    var badgeId: js.UndefOr[String] = js.undefined
    
    /**
      * An optional ref for the badge. The main `ref` will be forwarded to the
      * `button` element.
      */
    var badgeRef: js.UndefOr[Ref[HTMLSpanElement]] = js.undefined
  ...
  object BadgedButtonProps {
    ...
    inline def apply(): BadgedButtonProps = {
    ...
    extension [Self <: BadgedButtonProps](x: Self) {
      ...
      inline def setBadgeClassName(value: String): Self = StObject.set(x, "badgeClassName", value.asInstanceOf[js.Any])
      
      inline def setBadgeClassNameUndefined: Self = StObject.set(x, "badgeClassName", js.undefined)
      
      inline def setBadgeId(value: String): Self = StObject.set(x, "badgeId", value.asInstanceOf[js.Any])
      
      inline def setBadgeIdUndefined: Self = StObject.set(x, "badgeId", js.undefined)
      
      inline def setBadgeRef(value: Ref[HTMLSpanElement]): Self = StObject.set(x, "badgeRef", value.asInstanceOf[js.Any])
      
      inline def setBadgeRefFunction1(value: HTMLSpanElement | Null => Callback): Self = StObject.set(x, "badgeRef", js.Any.fromFunction1((t0: HTMLSpanElement | Null) => value(t0).runNow()))
      
      inline def setBadgeRefNull: Self = StObject.set(x, "badgeRef", null)
      
      inline def setBadgeRefUndefined: Self = StObject.set(x, "badgeRef", js.undefined)
      ...
      inline def setBadgeTheme(value: BadgeTheme): Self = StObject.set(x, "badgeTheme", value.asInstanceOf[js.Any])
      
      inline def setBadgeThemeUndefined: Self = StObject.set(x, "badgeTheme", js.undefined)
