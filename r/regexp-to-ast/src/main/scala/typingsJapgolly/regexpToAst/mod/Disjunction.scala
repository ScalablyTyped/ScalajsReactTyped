...
trait Disjunction
  ...
  @JSName("type")
  var type_Disjunction: typingsJapgolly.regexpToAst.regexpToAstStrings.Disjunction
...
object Disjunction {
  ...
  extension [Self <: Disjunction](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.regexpToAst.regexpToAstStrings.Disjunction): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
