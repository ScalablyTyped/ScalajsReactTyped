...
trait GroupBackReference
  ...
  @JSName("type")
  var type_GroupBackReference: typingsJapgolly.regexpToAst.regexpToAstStrings.GroupBackReference
...
object GroupBackReference {
  ...
  extension [Self <: GroupBackReference](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.regexpToAst.regexpToAstStrings.GroupBackReference): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
