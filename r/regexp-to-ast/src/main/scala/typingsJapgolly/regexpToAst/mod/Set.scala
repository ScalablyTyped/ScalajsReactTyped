...
trait Set
  ...
  @JSName("type")
  var type_Set: typingsJapgolly.regexpToAst.regexpToAstStrings.Set
...
object Set {
  ...
  extension [Self <: Set](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.regexpToAst.regexpToAstStrings.Set): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
