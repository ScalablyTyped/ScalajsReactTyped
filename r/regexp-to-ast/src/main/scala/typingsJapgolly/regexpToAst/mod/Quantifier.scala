...
trait Quantifier
  ...
  @JSName("type")
  var type_Quantifier: typingsJapgolly.regexpToAst.regexpToAstStrings.Quantifier
}
object Quantifier {
  ...
  extension [Self <: Quantifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.regexpToAst.regexpToAstStrings.Quantifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
