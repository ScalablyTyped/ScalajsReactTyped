...
trait Character
  ...
  @JSName("type")
  var type_Character: typingsJapgolly.regexpToAst.regexpToAstStrings.Character
...
object Character {
  ...
  extension [Self <: Character](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.regexpToAst.regexpToAstStrings.Character): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
