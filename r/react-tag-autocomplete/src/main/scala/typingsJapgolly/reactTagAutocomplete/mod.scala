package typingsJapgolly.reactTagAutocomplete
...
object mod {
  ...
  type ReactTags = japgolly.scalajs.react.facade.React.Component[ReactTagsProps & js.Object, js.Object]
  ...
  object ReactTagsProps {
    ...
    inline def apply(onAddition: Tag => Callback, onDelete: Double => Callback): ReactTagsProps = {
      val __obj = js.Dynamic.literal(onAddition = js.Any.fromFunction1((t0: Tag) => onAddition(t0).runNow()), onDelete = js.Any.fromFunction1((t0: Double) => onDelete(t0).runNow()))
    ...
    extension [Self <: ReactTagsProps](x: Self) {
      ...
      inline def setOnAddition(value: Tag => Callback): Self = StObject.set(x, "onAddition", js.Any.fromFunction1((t0: Tag) => value(t0).runNow()))
      
      inline def setOnBlur(value: Callback): Self = StObject.set(x, "onBlur", value.toJsFn)
      
      inline def setOnBlurUndefined: Self = StObject.set(x, "onBlur", js.undefined)
      
      inline def setOnDelete(value: Double => Callback): Self = StObject.set(x, "onDelete", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      
      inline def setOnFocus(value: Callback): Self = StObject.set(x, "onFocus", value.toJsFn)
      
      inline def setOnFocusUndefined: Self = StObject.set(x, "onFocus", js.undefined)
      
      inline def setOnInput(value: /* input */ String => Callback): Self = StObject.set(x, "onInput", js.Any.fromFunction1((t0: /* input */ String) => value(t0).runNow()))
  ...
  object TagComponentProps {
    ...
    inline def apply(
      ...
      onDelete: ReactMouseEventFrom[HTMLButtonElement] => Callback,
      removeButtonText: String,
      tag: Tag
    ): TagComponentProps = {
      val __obj = js.Dynamic.literal(classNames = classNames.asInstanceOf[js.Any], onDelete = js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement]) => onDelete(t0).runNow()), removeButtonText = removeButtonText.asInstanceOf[js.Any], tag = tag.asInstanceOf[js.Any])
    ...
    extension [Self <: TagComponentProps](x: Self) {
      ...
      inline def setOnDelete(value: ReactMouseEventFrom[HTMLButtonElement] => Callback): Self = StObject.set(x, "onDelete", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement]) => value(t0).runNow()))
