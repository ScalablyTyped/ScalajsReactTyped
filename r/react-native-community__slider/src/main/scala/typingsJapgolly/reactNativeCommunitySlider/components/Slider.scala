package typingsJapgolly.reactNativeCommunitySlider.components
...
import typingsJapgolly.reactNativeCommunitySlider.mod.SliderProps
import typingsJapgolly.reactNativeCommunitySlider.mod.SliderReferenceType
import typingsJapgolly.reactNativeCommunitySlider.mod.default
...
object Slider {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def accessibilityIncrements(value: js.Array[String]): this.type = set("accessibilityIncrements", value.asInstanceOf[js.Any])
    
    inline def accessibilityIncrementsVarargs(value: String*): this.type = set("accessibilityIncrements", js.Array(value*))
    ...
    inline def accessibilityUnits(value: String): this.type = set("accessibilityUnits", value.asInstanceOf[js.Any])
    ...
    inline def maximumTrackImage(value: ImageURISource): this.type = set("maximumTrackImage", value.asInstanceOf[js.Any])
    ...
    inline def minimumTrackImage(value: ImageURISource): this.type = set("minimumTrackImage", value.asInstanceOf[js.Any])
    ...
    inline def ref(value: SliderReferenceType): this.type = set("ref", value.asInstanceOf[js.Any])
    ...
    inline def tapToSeek(value: Boolean): this.type = set("tapToSeek", value.asInstanceOf[js.Any])
    
    inline def testID(value: String): this.type = set("testID", value.asInstanceOf[js.Any])
    
    inline def thumbImage(value: ImageURISource): this.type = set("thumbImage", value.asInstanceOf[js.Any])
    
    inline def thumbTintColor(value: String): this.type = set("thumbTintColor", value.asInstanceOf[js.Any])
    
    inline def trackImage(value: ImageURISource): this.type = set("trackImage", value.asInstanceOf[js.Any])
