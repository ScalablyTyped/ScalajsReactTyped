...
object mod extends Shortcut {
  ...
  object CameraProps {
    ...
    extension [Self <: CameraProps](x: Self) {
      ...
      inline def setOnCameraError(value: /* error */ js.Error => Callback): Self = StObject.set(x, "onCameraError", js.Any.fromFunction1((t0: /* error */ js.Error) => value(t0).runNow()))
      
      inline def setOnCameraErrorUndefined: Self = StObject.set(x, "onCameraError", js.undefined)
      
      inline def setOnCameraStart(value: Callback): Self = StObject.set(x, "onCameraStart", value.toJsFn)
      
      inline def setOnCameraStartUndefined: Self = StObject.set(x, "onCameraStart", js.undefined)
      
      inline def setOnCameraStop(value: Callback): Self = StObject.set(x, "onCameraStop", value.toJsFn)
      
      inline def setOnCameraStopUndefined: Self = StObject.set(x, "onCameraStop", js.undefined)
      
      inline def setOnTakePhoto(value: /* dataUri */ String => Callback): Self = StObject.set(x, "onTakePhoto", js.Any.fromFunction1((t0: /* dataUri */ String) => value(t0).runNow()))
      
      inline def setOnTakePhotoAnimationDone(value: /* dataUri */ String => Callback): Self = StObject.set(x, "onTakePhotoAnimationDone", js.Any.fromFunction1((t0: /* dataUri */ String) => value(t0).runNow()))
