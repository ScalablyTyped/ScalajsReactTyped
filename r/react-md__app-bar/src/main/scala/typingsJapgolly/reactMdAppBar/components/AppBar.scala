...
import typingsJapgolly.reactMdAppBar.typesAppBarMod.AppBarHeight
import typingsJapgolly.reactMdAppBar.typesAppBarMod.AppBarPosition
import typingsJapgolly.reactMdAppBar.typesAppBarMod.AppBarProps
import typingsJapgolly.reactMdAppBar.typesAppBarMod.AppBarTheme
...
object AppBar {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def fixedElevation(value: Boolean): this.type = set("fixedElevation", value.asInstanceOf[js.Any])
    
    inline def fixedPosition(value: AppBarPosition): this.type = set("fixedPosition", value.asInstanceOf[js.Any])
    
    inline def flexWrap(value: Boolean): this.type = set("flexWrap", value.asInstanceOf[js.Any])
    
    inline def height(value: AppBarHeight): this.type = set("height", value.asInstanceOf[js.Any])
  ...
  def withProps(p: AppBarProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
