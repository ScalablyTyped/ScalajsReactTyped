...
object AppBarTitle {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def keyline(value: Boolean): this.type = set("keyline", value.asInstanceOf[js.Any])
  ...
  def withProps(p: AppBarTitleProps & RefAttributes[HTMLHeadingElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
