...
import typingsJapgolly.regexpMatchIndices.anon.TraversalKind
import typingsJapgolly.regexpMatchIndices.anon.`0`
import typingsJapgolly.regexpMatchIndices.regexpMatchIndicesStrings.Ast
import typingsJapgolly.regexpMatchIndices.regexpMatchIndicesStrings.AstPath
import typingsJapgolly.regexpMatchIndices.regexpTreeAstMod.AstNode
import typingsJapgolly.regexpTree.astMod.Alternative
import typingsJapgolly.regexpTree.astMod.Assertion
import typingsJapgolly.regexpTree.astMod.AstRegExp
import typingsJapgolly.regexpTree.astMod.Backreference
import typingsJapgolly.regexpTree.astMod.Char
import typingsJapgolly.regexpTree.astMod.CharacterClass
import typingsJapgolly.regexpTree.astMod.ClassRange
import typingsJapgolly.regexpTree.astMod.Disjunction
import typingsJapgolly.regexpTree.astMod.Group
import typingsJapgolly.regexpTree.astMod.Quantifier
import typingsJapgolly.regexpTree.astMod.Repetition
...
object regexpTreeMod {
  ...
  object CommonTraversalHandlers {
    ...
    extension [Self <: CommonTraversalHandlers[?, ?], T /* <: AstNode */, TraversalKind /* <: Ast | AstPath */](x: Self & (CommonTraversalHandlers[T, TraversalKind])) {
      ...
      inline def setInit(value: /* ast */ T => Callback): Self = StObject.set(x, "init", js.Any.fromFunction1((t0: /* ast */ T) => value(t0).runNow()))
  ...
  trait SpecificTraversalHandlers[TraversalKind /* <: Ast | AstPath */] extends StObject {
    ...
    var Alternative: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Alternative, TraversalKind]] = js.undefined
    
    var Assertion: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Assertion, TraversalKind]] = js.undefined
    
    var Backreference: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Backreference, TraversalKind]] = js.undefined
    
    var Char: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Char, TraversalKind]] = js.undefined
    
    var CharacterClass: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.CharacterClass, TraversalKind]] = js.undefined
    
    var ClassRange: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.ClassRange, TraversalKind]] = js.undefined
    
    var Disjunction: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Disjunction, TraversalKind]] = js.undefined
    
    var Group: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Group, TraversalKind]] = js.undefined
    
    var Quantifier: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Quantifier, TraversalKind]] = js.undefined
    
    var RegExp: js.UndefOr[Traversal[AstRegExp, TraversalKind]] = js.undefined
    
    var Repetition: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Repetition, TraversalKind]] = js.undefined
  }
  ...
  trait TransformHandlers[T /* <: AstNode */] extends StObject {
    ...
    var Alternative: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Alternative, AstPath]] = js.undefined
    
    var Assertion: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Assertion, AstPath]] = js.undefined
    
    @JSName("*")
    var Asterisk: js.UndefOr[TraversalCallback[AstNode, AstPath]] = js.undefined
    
    var Backreference: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Backreference, AstPath]] = js.undefined
    
    var Char: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Char, AstPath]] = js.undefined
    
    var CharacterClass: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.CharacterClass, AstPath]] = js.undefined
    
    var ClassRange: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.ClassRange, AstPath]] = js.undefined
    
    var Disjunction: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Disjunction, AstPath]] = js.undefined
    
    var Group: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Group, AstPath]] = js.undefined
    
    var Quantifier: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Quantifier, AstPath]] = js.undefined
    
    var RegExp: js.UndefOr[Traversal[AstRegExp, AstPath]] = js.undefined
    
    var Repetition: js.UndefOr[Traversal[typingsJapgolly.regexpTree.astMod.Repetition, AstPath]] = js.undefined
