package typingsJapgolly.reactCytoscapejs
...
import typingsJapgolly.reactCytoscapejs.anon.Edges
...
object mod {
  ...
  type CytoscapeComponent = japgolly.scalajs.react.facade.React.Component[CytoscapeComponentProps & js.Object, js.Object]
  ...
  object CytoscapeComponentProps {
    ...
    extension [Self <: CytoscapeComponentProps](x: Self) {
      ...
      inline def setCy(value: /* cy */ Core => Callback): Self = StObject.set(x, "cy", js.Any.fromFunction1((t0: /* cy */ Core) => value(t0).runNow()))
      ...
      ): Self = StObject.set(x, "forEach", js.Any.fromFunction2((t0: /* list */ js.Array[Any], t1: /* iterator */ js.Function3[/* value */ Any, /* index */ Double, /* array */ js.Array[Any], Unit]) => (value(t0, t1)).runNow()))
