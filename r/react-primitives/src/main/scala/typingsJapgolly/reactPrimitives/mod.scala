...
import typingsJapgolly.reactNative.mod.EasingStatic
...
import typingsJapgolly.reactNative.mod.PixelRatioStatic
...
object mod {
  ...
  @js.native
  val Dimensions: typingsJapgolly.reactNative.mod.Dimensions = js.native
  ...
  open class Text protected ()
    extends typingsJapgolly.reactNative.mod.Text {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.reactNative.mod.PlatformOSType
    - typingsJapgolly.reactPrimitives.reactPrimitivesStrings.sketch
    - typingsJapgolly.reactPrimitives.reactPrimitivesStrings.vr
  */
  type PlatformOSType = _PlatformOSType | typingsJapgolly.reactNative.mod.PlatformOSType
