...
import typingsJapgolly.restfulJs.anon.Data
...
object mod {
  ...
  object Endpoint {
    ...
    extension [Self_ <: Endpoint[?], Self](x: Self_ & Endpoint[Self]) {
      ...
      inline def setFullRequestInterceptors(value: CallbackTo[js.Array[FullRequestInterceptor]]): Self_ = StObject.set(x, "fullRequestInterceptors", value.toJsFn)
      
      inline def setFullResponseInterceptors(value: CallbackTo[js.Array[ResponseInterceptor]]): Self_ = StObject.set(x, "fullResponseInterceptors", value.toJsFn)
      
      inline def setHeader(value: (String, Any) => Self): Self_ = StObject.set(x, "header", js.Any.fromFunction2(value))
      
      inline def setHeaders(value: CallbackTo[Headers]): Self_ = StObject.set(x, "headers", value.toJsFn)
      
      inline def setRequestInterceptors(value: CallbackTo[js.Array[RequestInterceptor]]): Self_ = StObject.set(x, "requestInterceptors", value.toJsFn)
      
      inline def setResponseInterceptors(value: CallbackTo[js.Array[ResponseInterceptor]]): Self_ = StObject.set(x, "responseInterceptors", value.toJsFn)
      
      inline def setUrl(value: CallbackTo[String]): Self_ = StObject.set(x, "url", value.toJsFn)
    }
  }
  ...
  trait MemberResponse[T]
    ...
    def apply(): typingsJapgolly.restfulJs.anon.Headers[T] = js.native
  ...
  object ResponseBase {
    ...
    inline def apply(config: CallbackTo[Any], headers: CallbackTo[Headers], status: CallbackTo[Double]): ResponseBase = {
      val __obj = js.Dynamic.literal(config = config.toJsFn, headers = headers.toJsFn, status = status.toJsFn)
      __obj.asInstanceOf[ResponseBase]
    }
    
    extension [Self <: ResponseBase](x: Self) {
      
      inline def setConfig(value: CallbackTo[Any]): Self = StObject.set(x, "config", value.toJsFn)
      
      inline def setHeaders(value: CallbackTo[Headers]): Self = StObject.set(x, "headers", value.toJsFn)
