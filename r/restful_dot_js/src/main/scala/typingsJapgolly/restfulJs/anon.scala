...
object anon {
  ...
  trait Data[T] extends StObject {
    ...
    var headers: typingsJapgolly.restfulJs.mod.Headers
  ...
  object Data {
    ...
    extension [Self <: Data[?], T](x: Self & Data[T]) {
      ...
      inline def setHeaders(value: typingsJapgolly.restfulJs.mod.Headers): Self = StObject.set(x, "headers", value.asInstanceOf[js.Any])
  ...
  object Headers {
    ...
    inline def apply[T](data: T, headers: typingsJapgolly.restfulJs.mod.Headers, status: Double, statusText: String): Headers[T] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], headers = headers.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any], statusText = statusText.asInstanceOf[js.Any])
