...
import typingsJapgolly.reactModal.anon.Content
...
object mod {
  ...
  trait Props extends StObject {
    ...
    var appElement: js.UndefOr[HTMLElement | js.Array[HTMLElement] | HTMLCollection[Any] | NodeList[Node]] = js.undefined
    ...
    var overlayElement: js.UndefOr[
        js.Function2[
          /* props */ ComponentPropsWithRef[div], 
          /* contentEl */ japgolly.scalajs.react.facade.React.Element, 
          japgolly.scalajs.react.facade.React.Element
        ]
      ] = js.undefined
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setAppElement(value: HTMLElement | js.Array[HTMLElement] | HTMLCollection[Any] | NodeList[Node]): Self = StObject.set(x, "appElement", value.asInstanceOf[js.Any])
      ...
      inline def setContentElement(
        value: (/* props */ ComponentPropsWithRef[div], /* children */ japgolly.scalajs.react.facade.React.Node) => japgolly.scalajs.react.facade.React.Element
      ): Self = StObject.set(x, "contentElement", js.Any.fromFunction2(value))
      ...
      inline def setContentRef(value: /* instance */ HTMLDivElement => Callback): Self = StObject.set(x, "contentRef", js.Any.fromFunction1((t0: /* instance */ HTMLDivElement) => value(t0).runNow()))
      ...
      inline def setOnAfterOpen(value: /* obj */ js.UndefOr[OnAfterOpenCallbackOptions] => Callback): Self = StObject.set(x, "onAfterOpen", js.Any.fromFunction1((t0: /* obj */ js.UndefOr[OnAfterOpenCallbackOptions]) => value(t0).runNow()))
      
      inline def setOnAfterOpenUndefined: Self = StObject.set(x, "onAfterOpen", js.undefined)
      
      inline def setOnRequestClose(value: /* event */ ReactMouseEventFrom[Element] | ReactKeyboardEventFrom[Element] => Callback): Self = StObject.set(x, "onRequestClose", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[Element] | ReactKeyboardEventFrom[Element]) => value(t0).runNow()))
      ...
      inline def setOverlayElement(
        value: (/* props */ ComponentPropsWithRef[div], /* contentEl */ japgolly.scalajs.react.facade.React.Element) => japgolly.scalajs.react.facade.React.Element
      ): Self = StObject.set(x, "overlayElement", js.Any.fromFunction2(value))
      
      inline def setOverlayElementUndefined: Self = StObject.set(x, "overlayElement", js.undefined)
      
      inline def setOverlayRef(value: /* instance */ HTMLDivElement => Callback): Self = StObject.set(x, "overlayRef", js.Any.fromFunction1((t0: /* instance */ HTMLDivElement) => value(t0).runNow()))
