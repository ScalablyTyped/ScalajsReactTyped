package typingsJapgolly.reactSlider
...
object mod {
  ...
  trait HTMLPropsWithRefCallback[T]
    ...
    @JSName("ref")
    var ref_HTMLPropsWithRefCallback: RefFn[T]
  }
  object HTMLPropsWithRefCallback {
    
    inline def apply[T](ref: T | Null => Callback): HTMLPropsWithRefCallback[T] = {
  ...
  object ReactSliderProps {
    ...
    extension [Self <: ReactSliderProps[?], T /* <: Double | js.Array[Double] */](x: Self & ReactSliderProps[T]) {
      ...
      inline def setOnAfterChange(value: (/* value */ T, /* index */ Double) => Callback): Self = StObject.set(x, "onAfterChange", js.Any.fromFunction2((t0: /* value */ T, t1: /* index */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnAfterChangeUndefined: Self = StObject.set(x, "onAfterChange", js.undefined)
      
      inline def setOnBeforeChange(value: (/* value */ T, /* index */ Double) => Callback): Self = StObject.set(x, "onBeforeChange", js.Any.fromFunction2((t0: /* value */ T, t1: /* index */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnBeforeChangeUndefined: Self = StObject.set(x, "onBeforeChange", js.undefined)
      
      inline def setOnChange(value: (/* value */ T, /* index */ Double) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* value */ T, t1: /* index */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnSliderClick(value: /* value */ Double => Callback): Self = StObject.set(x, "onSliderClick", js.Any.fromFunction1((t0: /* value */ Double) => value(t0).runNow()))
