...
object libAnchorAnchorMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var onClick: typingsJapgolly.nginstackEngine.libEventLegacyEventMod.^ = js.native
  ...
  @js.native
  def createProcess: Any = js.native
  inline def createProcess_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("createProcess")(x.asInstanceOf[js.Any])
  ...
  trait Anchor extends StObject {
    ...
    var onClick: typingsJapgolly.nginstackEngine.libEventLegacyEventMod.^
  ...
  object Anchor {
    ...
    inline def apply(
      ...
      _prepare: Any,
      accessible: Any,
      assign: Anchor => Callback,
      changed: Any,
      collection: Any,
      config: (Any, Any, Any) => Callback,
      convertParametersToParams: Any,
      createNewTab: Boolean,
      enabled: Boolean,
      forcingChanges_ : CallbackTo[Boolean],
      getChanges: Any,
      getParameters: Any,
      ...
      onClick: typingsJapgolly.nginstackEngine.libEventLegacyEventMod.^,
      parameters_ : Any,
      parent: Any,
    ...
    extension [Self <: Anchor](x: Self) {
      ...
      inline def setAssign(value: Anchor => Callback): Self = StObject.set(x, "assign", js.Any.fromFunction1((t0: Anchor) => value(t0).runNow()))
      ...
      inline def setConfig(value: (Any, Any, Any) => Callback): Self = StObject.set(x, "config", js.Any.fromFunction3((t0: Any, t1: Any, t2: Any) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setForcingChanges_(value: CallbackTo[Boolean]): Self = StObject.set(x, "forcingChanges_", value.toJsFn)
      ...
      inline def setOnClick(value: typingsJapgolly.nginstackEngine.libEventLegacyEventMod.^): Self = StObject.set(x, "onClick", value.asInstanceOf[js.Any])
      ...
      inline def setSetChangedProperty(value: (String, Any) => Callback): Self = StObject.set(x, "setChangedProperty", js.Any.fromFunction2((t0: String, t1: Any) => (value(t0, t1)).runNow()))
