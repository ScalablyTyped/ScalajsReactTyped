...
object libProcessProcessHelpFormatterMod {
  ...
  object ProcessHelpFormatter {
    ...
    extension [Self <: ProcessHelpFormatter](x: Self) {
      ...
      inline def setFormatProcessHelp(value: CallbackTo[String]): Self = StObject.set(x, "formatProcessHelp", value.toJsFn)
