...
object libDialogsFormDialogMod {
  ...
  trait FormDialog extends StObject {
    ...
    def addField(name: String, `type`: String): typingsJapgolly.nginstackWebFramework.libDialogsFormDialogFieldMod.^ = js.native
    def addField(name: String, `type`: String, size: Double): typingsJapgolly.nginstackWebFramework.libDialogsFormDialogFieldMod.^ = js.native
    
    def field(name: Any): typingsJapgolly.nginstackWebFramework.libDialogsFormDialogFieldMod.^ = js.native
