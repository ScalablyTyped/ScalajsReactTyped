...
object libButtonButtonTimerMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var button: typingsJapgolly.nginstackWebFramework.libButtonButtonMod.^ = js.native
  ...
  type Button = typingsJapgolly.nginstackWebFramework.libButtonButtonMod.^
  
  trait ButtonTimer extends StObject {
    
    var button: typingsJapgolly.nginstackWebFramework.libButtonButtonMod.^
  ...
  object ButtonTimer {
    ...
    inline def apply(
      button: typingsJapgolly.nginstackWebFramework.libButtonButtonMod.^,
      enabled: Boolean,
      interval: Double,
    ...
    extension [Self <: ButtonTimer](x: Self) {
      ...
      inline def setButton(value: typingsJapgolly.nginstackWebFramework.libButtonButtonMod.^): Self = StObject.set(x, "button", value.asInstanceOf[js.Any])
