...
import typingsJapgolly.nginstackWebFramework.anon.Name
...
object libClassdefGlobalActionMod {
  ...
  object GlobalAction {
    ...
    inline def apply(
      addParameter: Name => Callback,
      caption: String,
      defaultKeyParamName: String,
      enabled: Boolean,
      getParameter: String => Name,
      getParameters: CallbackTo[Any],
      help: String,
      hint: String,
      name: String,
      name_ : Any,
      ...
      val __obj = js.Dynamic.literal(addParameter = js.Any.fromFunction1((t0: Name) => addParameter(t0).runNow()), caption = caption.asInstanceOf[js.Any], defaultKeyParamName = defaultKeyParamName.asInstanceOf[js.Any], enabled = enabled.asInstanceOf[js.Any], getParameter = js.Any.fromFunction1(getParameter), getParameters = getParameters.toJsFn, help = help.asInstanceOf[js.Any], hint = hint.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], name_ = name_.asInstanceOf[js.Any], onShow = onShow.asInstanceOf[js.Any], params = params.asInstanceOf[js.Any], visible = visible.asInstanceOf[js.Any], activity = null, interaction = null, targetKey = null)
    ...
    extension [Self <: GlobalAction](x: Self) {
      ...
      inline def setAddParameter(value: Name => Callback): Self = StObject.set(x, "addParameter", js.Any.fromFunction1((t0: Name) => value(t0).runNow()))
      ...
      inline def setGetParameters(value: CallbackTo[Any]): Self = StObject.set(x, "getParameters", value.toJsFn)
