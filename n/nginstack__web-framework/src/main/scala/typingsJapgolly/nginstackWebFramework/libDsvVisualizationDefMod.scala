...
object libDsvVisualizationDefMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    var footer: typingsJapgolly.nginstackWebFramework.libDsvVisualizationFooterDefMod.^ = js.native
    
    /* CompleteClass */
    var header: typingsJapgolly.nginstackWebFramework.libDsvVisualizationHeaderDefMod.^ = js.native
  ...
  trait VisualizationDef extends StObject {
    ...
    var footer: typingsJapgolly.nginstackWebFramework.libDsvVisualizationFooterDefMod.^
    
    var header: typingsJapgolly.nginstackWebFramework.libDsvVisualizationHeaderDefMod.^
  ...
  object VisualizationDef {
    ...
    inline def apply(
      ...
      footer: typingsJapgolly.nginstackWebFramework.libDsvVisualizationFooterDefMod.^,
      header: typingsJapgolly.nginstackWebFramework.libDsvVisualizationHeaderDefMod.^,
      help: String,
    ...
    extension [Self <: VisualizationDef](x: Self) {
      ...
      inline def setFooter(value: typingsJapgolly.nginstackWebFramework.libDsvVisualizationFooterDefMod.^): Self = StObject.set(x, "footer", value.asInstanceOf[js.Any])
      
      inline def setHeader(value: typingsJapgolly.nginstackWebFramework.libDsvVisualizationHeaderDefMod.^): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
  ...
  type VisualizationFilterDef = typingsJapgolly.nginstackWebFramework.libDsvVisualizationFilterDefMod.^
}
