...
object libFileLoaderFileLoaderMod {
  ...
  trait FileLoader extends StObject {
    ...
    def authorizeDownload(files: String, options: typingsJapgolly.nginstackWebFramework.libFileLoaderDownloadOptionsMod.^): String = js.native
    ...
    def authorizeDownload(files: Double, options: typingsJapgolly.nginstackWebFramework.libFileLoaderDownloadOptionsMod.^): String = js.native
    ...
    def authorizeDownload(files: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^, options: Record[Any, Any]): String = js.native
    
    def authorizeUpload(options: typingsJapgolly.nginstackWebFramework.libFileLoaderUploadOptionsMod.^): String = js.native
    ...
    def getUploadedFiles(uploadId: String): js.Array[typingsJapgolly.nginstackWebFramework.libFileLoaderUploadedFileMod.^] = js.native
    ...
    def tryGetDownloadFile(downloadId: String): typingsJapgolly.nginstackWebFramework.libFileLoaderDownloadFileMod.^ = js.native
