...
object libNavtreeNavigationTreeMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var classe: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    ...
    /* CompleteClass */
    var collection: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    ...
    /* CompleteClass */
    var ivfs: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
  ...
  inline def createEmptyNavigationTreeCollection(): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("createEmptyNavigationTreeCollection")().asInstanceOf[typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^]
  ...
  trait NavigationTree extends StObject {
    ...
    var classe: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^
    ...
    var collection: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^
    ...
    var ivfs: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^
  ...
  object NavigationTree {
    ...
    inline def apply(
      ...
      classe: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^,
      collectImmediateLevelNavigatableChildren: (Any, Any, Any) => Any,
      collectProcessesAndLayouts: (Any, Any, Any) => Any,
      collection: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^,
      fillCollection: (Any, Any, Any, Any, Any, Any) => Callback,
      getChildren: Any => Any,
      ...
      ivfs: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^,
      logger_ : Any,
      ...
      val __obj = js.Dynamic.literal(accessibleChildren = accessibleChildren.asInstanceOf[js.Any], alwaysVisibleClasses = alwaysVisibleClasses.asInstanceOf[js.Any], classDefManager_ = classDefManager_.asInstanceOf[js.Any], classHasChildren = js.Any.fromFunction1(classHasChildren), classe = classe.asInstanceOf[js.Any], collectImmediateLevelNavigatableChildren = js.Any.fromFunction3(collectImmediateLevelNavigatableChildren), collectProcessesAndLayouts = js.Any.fromFunction3(collectProcessesAndLayouts), collection = collection.asInstanceOf[js.Any], fillCollection = js.Any.fromFunction6((t0: Any, t1: Any, t2: Any, t3: Any, t4: Any, t5: Any) => (fillCollection(t0, t1, t2, t3, t4, t5)).runNow()), getChildren = js.Any.fromFunction1(getChildren), getChildrenVersion = js.Any.fromFunction1(getChildrenVersion), getNodeVersion = js.Any.fromFunction1(getNodeVersion), getSubClassesVersion = js.Any.fromFunction1(getSubClassesVersion), getVfsVersionByMimeType = js.Any.fromFunction2(getVfsVersionByMimeType), initialize = initialize.toJsFn, ipermission = ipermission.asInstanceOf[js.Any], ivfs = ivfs.asInstanceOf[js.Any], logger_ = logger_.asInstanceOf[js.Any], nodeExists = js.Any.fromFunction1(nodeExists), reset = reset.asInstanceOf[js.Any], rootClassKey = rootClassKey.asInstanceOf[js.Any], visibilityMode = visibilityMode.asInstanceOf[js.Any])
    ...
    extension [Self <: NavigationTree](x: Self) {
      ...
      inline def setClasse(value: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): Self = StObject.set(x, "classe", value.asInstanceOf[js.Any])
      ...
      inline def setCollection(value: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): Self = StObject.set(x, "collection", value.asInstanceOf[js.Any])
      
      inline def setFillCollection(value: (Any, Any, Any, Any, Any, Any) => Callback): Self = StObject.set(x, "fillCollection", js.Any.fromFunction6((t0: Any, t1: Any, t2: Any, t3: Any, t4: Any, t5: Any) => (value(t0, t1, t2, t3, t4, t5)).runNow()))
      ...
      inline def setIvfs(value: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): Self = StObject.set(x, "ivfs", value.asInstanceOf[js.Any])
