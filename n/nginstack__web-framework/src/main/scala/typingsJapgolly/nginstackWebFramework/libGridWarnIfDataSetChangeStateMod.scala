...
object libGridWarnIfDataSetChangeStateMod {
  ...
  @js.native
  def logger: typingsJapgolly.nginstackEngine.libLogLoggerMod.^ = js.native
  
  inline def logger_=(x: typingsJapgolly.nginstackEngine.libLogLoggerMod.^): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("logger_")(x.asInstanceOf[js.Any])
