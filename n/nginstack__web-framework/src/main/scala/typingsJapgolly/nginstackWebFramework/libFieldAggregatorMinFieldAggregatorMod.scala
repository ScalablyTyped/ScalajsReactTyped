...
object libFieldAggregatorMinFieldAggregatorMod {
  ...
  @JSImport("@nginstack/web-framework/lib/field-aggregator/MinFieldAggregator", JSImport.Namespace)
  @js.native
  open class ^ protected ()
    extends StObject
       with MinFieldAggregator {
  ...
  trait MinFieldAggregator extends StObject {
