...
object libAnchorLinkMod {
  ...
  object Link {
    ...
    extension [Self <: Link](x: Self) {
      ...
      inline def setPrepare(value: Callback): Self = StObject.set(x, "prepare", value.toJsFn)
      ...
      inline def setWrite(value: (String, String, String) => Callback): Self = StObject.set(x, "write", js.Any.fromFunction3((t0: String, t1: String, t2: String) => (value(t0, t1, t2)).runNow()))
