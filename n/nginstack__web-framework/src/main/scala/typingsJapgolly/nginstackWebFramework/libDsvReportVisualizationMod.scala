...
import typingsJapgolly.nginstackWebFramework.anon.GetExporter
...
object libDsvReportVisualizationMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var columns: typingsJapgolly.nginstackWebFramework.libDsvReportVisualizationColumnsMod.^ = js.native
    ...
    /* CompleteClass */
    override def getColumn(name: String): typingsJapgolly.nginstackWebFramework.libDsvReportVisualizationColumnMod.^ = js.native
  ...
  trait ReportVisualization extends StObject {
    ...
    var columns: typingsJapgolly.nginstackWebFramework.libDsvReportVisualizationColumnsMod.^
    ...
    def getColumn(name: String): typingsJapgolly.nginstackWebFramework.libDsvReportVisualizationColumnMod.^
  ...
  object ReportVisualization {
    ...
    inline def apply(
      ...
      columns: typingsJapgolly.nginstackWebFramework.libDsvReportVisualizationColumnsMod.^,
      ...
      getColumn: String => typingsJapgolly.nginstackWebFramework.libDsvReportVisualizationColumnMod.^,
      getColumnDefs_ : Any,
      getColumnsFromDataSet_ : Any,
      getDataExporter_ : Any,
      getExportableData: CallbackTo[js.Array[GetExporter]],
      getGroupValues_ : Any,
      getPivotDataSet_ : CallbackTo[Any],
      getRawDataExporter_ : Any,
      getTotalWeightColumn_ : Any,
      headerComplement: String,
      initColumns_ : Any,
      initPivots_ : Callback,
      initProperties_ : Any,
    ...
    extension [Self <: ReportVisualization](x: Self) {
      ...
      inline def setColumns(value: typingsJapgolly.nginstackWebFramework.libDsvReportVisualizationColumnsMod.^): Self = StObject.set(x, "columns", value.asInstanceOf[js.Any])
      ...
      inline def setGetColumn(value: String => typingsJapgolly.nginstackWebFramework.libDsvReportVisualizationColumnMod.^): Self = StObject.set(x, "getColumn", js.Any.fromFunction1(value))
      ...
      inline def setGetExportableData(value: CallbackTo[js.Array[GetExporter]]): Self = StObject.set(x, "getExportableData", value.toJsFn)
      
      inline def setGetGroupValues_(value: Any): Self = StObject.set(x, "getGroupValues_", value.asInstanceOf[js.Any])
      
      inline def setGetPivotDataSet_(value: CallbackTo[Any]): Self = StObject.set(x, "getPivotDataSet_", value.toJsFn)
      ...
      inline def setInitPivots_(value: Callback): Self = StObject.set(x, "initPivots_", value.toJsFn)
  ...
  type SimpleLayoutExporter = typingsJapgolly.nginstackWebFramework.libSimpleLayoutSimpleLayoutExporterMod.^
}
