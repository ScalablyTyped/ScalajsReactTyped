...
import typingsJapgolly.nginstackWebFramework.anon.DONE
...
object libClassdefViewDefFieldMod {
  ...
  type FieldAggregator = typingsJapgolly.nginstackWebFramework.libFieldAggregatorFieldAggregatorMod.^
  ...
  type ViewDef = typingsJapgolly.nginstackWebFramework.libClassdefViewDefMod.^
  ...
  trait ViewDefField extends StObject {
    ...
    var thumbnail: typingsJapgolly.nginstackWebFramework.libClassdefCellThumbnailMod.^ = js.native
