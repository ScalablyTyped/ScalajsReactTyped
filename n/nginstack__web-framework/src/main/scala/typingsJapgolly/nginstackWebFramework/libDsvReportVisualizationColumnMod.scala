...
import typingsJapgolly.nginstackWebFramework.anon.DisplayFormat
...
object libDsvReportVisualizationColumnMod {
  ...
  object ReportVisualizationColumn {
    ...
    inline def apply(
      alias: String,
      assignFrom: Record[String, Any] => Callback,
    ...
    extension [Self <: ReportVisualizationColumn](x: Self) {
      ...
      inline def setAssignFrom(value: Record[String, Any] => Callback): Self = StObject.set(x, "assignFrom", js.Any.fromFunction1((t0: Record[String, Any]) => value(t0).runNow()))
