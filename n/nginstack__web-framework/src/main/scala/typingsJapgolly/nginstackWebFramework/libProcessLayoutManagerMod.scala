...
object libProcessLayoutManagerMod {
  ...
  object LayoutManager {
    ...
    inline def apply(
      _write: Any,
      add: (Any, Double, Double, /* repeated */ Any) => Callback,
      begin: Any,
      border: Double,
      cellStarted: Boolean,
      colStarted: Any,
