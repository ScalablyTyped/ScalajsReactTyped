...
object libProcessProcessMod {
  ...
  inline def apply(
    ...
    id: String,
    responseObject: Any,
    sourceClass: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^
  ...
  trait Process extends StObject {
    ...
    def action(name: Any, target: Any, order: Any, processKey: Any, newTab: Any): typingsJapgolly.nginstackWebFramework.libButtonButtonMod.^ = js.native
    ...
    def activity(
      ...
      args: Any*
    ): typingsJapgolly.nginstackWebFramework.libProcessInteractionMod.^ = js.native
    def activity(
      name: String,
      func: js.ThisFunction0[/* this */ this.type, Any],
      opt_permKeyWord: String,
    ...
    var currentInteraction: typingsJapgolly.nginstackWebFramework.libProcessInteractionMod.^ = js.native
    
    var currentTabId: Double = js.native
    
    var dbkey: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^ = js.native
    ...
    def download(files: String, options: typingsJapgolly.nginstackWebFramework.libFileLoaderDownloadOptionsMod.^): Unit = js.native
    def download(files: String, options: Record[Any, Any]): Unit = js.native
    def download(files: js.Array[String | Double | typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^]): Unit = js.native
    def download(
      files: js.Array[String | Double | typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^],
      options: typingsJapgolly.nginstackWebFramework.libFileLoaderDownloadOptionsMod.^
    ): Unit = js.native
    def download(
      files: js.Array[String | Double | typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^],
    ...
    def download(files: Double, options: typingsJapgolly.nginstackWebFramework.libFileLoaderDownloadOptionsMod.^): Unit = js.native
    def download(files: Double, options: Record[Any, Any]): Unit = js.native
    def download(files: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^): Unit = js.native
    def download(
      files: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^,
      options: typingsJapgolly.nginstackWebFramework.libFileLoaderDownloadOptionsMod.^
    ): Unit = js.native
    def download(files: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^, options: Record[Any, Any]): Unit = js.native
    ...
    var environment: typingsJapgolly.nginstackWebFramework.libEnvironmentEnvironmentMod.^ = js.native
    ...
    def getSimpleLayout(skinScriptKeyOrUrl: Any): typingsJapgolly.nginstackWebFramework.libSimpleLayoutSimpleLayoutMod.^ = js.native
    ...
    def grid(name: String, opt_ds: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): Grid = js.native
    def grid(name: String, opt_ds: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^, opt_classKey: Double): Grid = js.native
    def grid(
      name: String,
      opt_ds: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^,
      opt_classKey: Double,
      opt_masterGrid: Grid
    ): Grid = js.native
    def grid(
    ...
    def label(name: String): typingsJapgolly.nginstackWebFramework.libLabelLabelMod.^ = js.native
    def label(name: String, opt_text: String): typingsJapgolly.nginstackWebFramework.libLabelLabelMod.^ = js.native
    
    /* private */ var labels: Any = js.native
    
    /* private */ var labelsChanged: Any = js.native
    
    var lastInteraction: typingsJapgolly.nginstackWebFramework.libProcessInteractionMod.^ = js.native
    ...
    var layoutManager: typingsJapgolly.nginstackWebFramework.libProcessLayoutManagerMod.^ = js.native
    
    var layoutResponseObject: typingsJapgolly.nginstackEngine.libIoFileMod.^ | typingsJapgolly.nginstackEngine.libPrintSpoolMod.^ = js.native
    ...
    var sourceClass: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^ = js.native
    ...
    def upload(options: typingsJapgolly.nginstackWebFramework.libFileLoaderUploadOptionsMod.^): Any = js.native
  ...
  type UploadedFile = typingsJapgolly.nginstackWebFramework.libFileLoaderUploadedFileMod.^
}
