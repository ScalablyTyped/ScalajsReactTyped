...
import typingsJapgolly.nginstackWebFramework.anon.Callback
import typingsJapgolly.nginstackWebFramework.anon.Group
import typingsJapgolly.nginstackWebFramework.anon.PreserveExpressions
...
object libDsvVisualizationFiltersMod {
  ...
  type Grid = typingsJapgolly.nginstackWebFramework.libGridGridMod.^
  
  type Visualization = typingsJapgolly.nginstackWebFramework.libDsvVisualizationMod.^
  
  type VisualizationFilter = typingsJapgolly.nginstackWebFramework.libDsvVisualizationFilterMod.^
