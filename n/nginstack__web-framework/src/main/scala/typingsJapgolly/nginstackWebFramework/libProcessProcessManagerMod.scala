...
object libProcessProcessManagerMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    var ctrlChannel: typingsJapgolly.nginstackWebFramework.libIfpControlChannelMod.^ = js.native
    ...
    /* CompleteClass */
    override def getCurrentProcess(): typingsJapgolly.nginstackWebFramework.libProcessProcessMod.^ = js.native
    ...
    /* CompleteClass */
    override def getProcessById(id: String): typingsJapgolly.nginstackWebFramework.libProcessProcessMod.^ = js.native
  ...
  inline def parseLayoutLinkContent(content: Any): typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("parseLayoutLinkContent")(content.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^]
  
  type Controller = typingsJapgolly.nginstackWebFramework.libMessagingControllerMod.^
  ...
  trait ProcessManager extends StObject {
    ...
    var ctrlChannel: typingsJapgolly.nginstackWebFramework.libIfpControlChannelMod.^
    ...
    def getCurrentProcess(): typingsJapgolly.nginstackWebFramework.libProcessProcessMod.^
    ...
    def getProcessById(id: String): typingsJapgolly.nginstackWebFramework.libProcessProcessMod.^
  ...
  object ProcessManager {
    ...
    inline def apply(
      ...
      callHandlers: Any,
      closeProcess: Double => Callback,
      controller_ : Any,
      createProcess: Any,
      ctrlChannel: typingsJapgolly.nginstackWebFramework.libIfpControlChannelMod.^,
      ctrlSessionId: Any,
      currentProcess_ : Any,
      ...
      errorTreatment: Any,
      finalize_ : Any,
      getCurrentProcess: CallbackTo[typingsJapgolly.nginstackWebFramework.libProcessProcessMod.^],
      getDefaultProcessKeyOfClass: Any,
      getEntityShortcuts: Any,
      getFileContent: Any,
      getFileId: Any,
      getParameterFromRequestObject: Any,
      getProcessById: String => typingsJapgolly.nginstackWebFramework.libProcessProcessMod.^,
    ...
    extension [Self <: ProcessManager](x: Self) {
      ...
      inline def setCloseProcess(value: Double => Callback): Self = StObject.set(x, "closeProcess", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      ...
      inline def setCtrlChannel(value: typingsJapgolly.nginstackWebFramework.libIfpControlChannelMod.^): Self = StObject.set(x, "ctrlChannel", value.asInstanceOf[js.Any])
      ...
      inline def setGetCurrentProcess(value: CallbackTo[typingsJapgolly.nginstackWebFramework.libProcessProcessMod.^]): Self = StObject.set(x, "getCurrentProcess", value.toJsFn)
      ...
      inline def setGetProcessById(value: String => typingsJapgolly.nginstackWebFramework.libProcessProcessMod.^): Self = StObject.set(x, "getProcessById", js.Any.fromFunction1(value))
