...
import typingsJapgolly.nginstackWebFramework.anon.GridName
...
object libGridGridFieldMod {
  ...
  type DetailGrid = typingsJapgolly.nginstackWebFramework.libGridDetailGridMod.^
  ...
  trait GridField extends StObject {
    ...
    var dsTreeStructure: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
  ...
  type LookupMultipleInsertEvent = typingsJapgolly.nginstackWebFramework.libClassdefLookupMultipleInsertEventMod.^
}
