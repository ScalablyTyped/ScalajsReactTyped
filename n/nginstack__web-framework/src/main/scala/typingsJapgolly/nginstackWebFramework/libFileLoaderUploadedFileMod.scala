...
import typingsJapgolly.nginstackWebFramework.anon.Key
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libFileLoaderUploadedFileMod {
  ...
  trait UploadedFile extends StObject {
    ...
    def uploadToLobStorage(classKey: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^): Double = js.native
    def uploadToLobStorage(classKey: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^, options: Key): Double = js.native
