...
import typingsJapgolly.nginstackWebFramework.anon.Buttons
import typingsJapgolly.nginstackWebFramework.anon.Cancelable
import typingsJapgolly.nginstackWebFramework.anon.Visible
...
object libGridGridMod {
  ...
  trait Grid extends StObject {
    ...
    var classDefManager: typingsJapgolly.nginstackEngine.libClassdefClassDefManagerMod.^ = js.native
    
    var classDefinition: Any = js.native
    
    var classKey: Double = js.native
    
    var classKeyToValidatePermission: Double | typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^ = js.native
    ...
    var ds: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    ...
    def edit(field: typingsJapgolly.nginstackWebFramework.libGridGridFieldMod.^): Unit = js.native
    ...
    def field(name: String, opt_type: String, opt_size: Double, args: Any*): typingsJapgolly.nginstackEngine.libClassdefFieldMod.^ | ViewDefField = js.native
    def field(name: String, opt_type: String, opt_size: Unit, args: Any*): typingsJapgolly.nginstackEngine.libClassdefFieldMod.^ | ViewDefField = js.native
    def field(name: String, opt_type: Unit, opt_size: Double, args: Any*): typingsJapgolly.nginstackEngine.libClassdefFieldMod.^ | ViewDefField = js.native
    def field(name: String, opt_type: Unit, opt_size: Unit, args: Any*): typingsJapgolly.nginstackEngine.libClassdefFieldMod.^ | ViewDefField = js.native
    ...
    def getKeyField(): typingsJapgolly.nginstackEngine.libClassdefFieldMod.^ = js.native
    
    /* private */ var getKeyFieldExistInDs: Any = js.native
    
    def getLookupCallerField(): typingsJapgolly.nginstackEngine.libClassdefFieldMod.^ = js.native
    ...
    var groups: typingsJapgolly.nginstackWebFramework.libClassdefFieldGroupSetMod.^ = js.native
    ...
    /* protected */ def locateField(fieldName: String): typingsJapgolly.nginstackEngine.libClassdefFieldMod.^ = js.native
    ...
    def lookup(field: typingsJapgolly.nginstackWebFramework.libGridGridFieldMod.^): Unit = js.native
    ...
    /* protected */ def newEvent_(`type`: String): typingsJapgolly.nginstackWebFramework.libClassdefGridEventMod.^ = js.native
    /* protected */ def newEvent_(`type`: String, opt_options: Cancelable): typingsJapgolly.nginstackWebFramework.libClassdefGridEventMod.^ = js.native
    ...
    def scroll(action: js.Function1[/* arg0 */ typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^, Any]): Unit = js.native
    ...
    /* protected */ var tableViewBuffer: typingsJapgolly.nginstackWebFramework.libGridTableViewBufferMod.^ = js.native
    ...
    def toggleFieldVisibility(field: typingsJapgolly.nginstackEngine.libClassdefFieldMod.^): Unit = js.native
  ...
  type ViewDefField = typingsJapgolly.nginstackWebFramework.libClassdefViewDefFieldMod.^
}
