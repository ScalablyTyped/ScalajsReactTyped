...
object libPersonalizationMenuInputMod {
  ...
  object MenuInput {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(cssClassName = cssClassName.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], nodeId = nodeId.asInstanceOf[js.Any], order = order.asInstanceOf[js.Any], placeholder = placeholder.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any], toHtml = toHtml.toJsFn)
