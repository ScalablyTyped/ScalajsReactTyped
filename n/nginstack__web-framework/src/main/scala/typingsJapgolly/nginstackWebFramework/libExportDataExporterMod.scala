...
import typingsJapgolly.nginstackWebFramework.anon.OriginalIndex
...
object libExportDataExporterMod {
  ...
  type DataExporterFieldDef = typingsJapgolly.nginstackWebFramework.libExportDataExporterFieldDefMod.^
