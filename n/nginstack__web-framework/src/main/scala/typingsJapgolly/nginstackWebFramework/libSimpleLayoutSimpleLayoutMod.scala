...
import typingsJapgolly.nginstackWebFramework.anon.ALL
import typingsJapgolly.nginstackWebFramework.anon.ContentToAccumulate
import typingsJapgolly.nginstackWebFramework.anon.Group
import typingsJapgolly.nginstackWebFramework.anon.Id
...
object libSimpleLayoutSimpleLayoutMod {
  ...
  trait SimpleLayout extends StObject {
    ...
    def column(name: String): typingsJapgolly.nginstackWebFramework.libSimpleLayoutColumnMod.^ = js.native
    def column(name: String, options: Any): typingsJapgolly.nginstackWebFramework.libSimpleLayoutColumnMod.^ = js.native
    
    var columnPadding: String = js.native
    
    var columns: typingsJapgolly.nginstackEngine.libStringStringListMod.^ = js.native
    ...
    def group(
      name: String,
      link: typingsJapgolly.nginstackWebFramework.libAnchorLinkMod.^,
    ...
    var groups: typingsJapgolly.nginstackEngine.libStringStringListMod.^ = js.native
    ...
    var resultSet: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
