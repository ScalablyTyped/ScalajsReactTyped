...
object libExpressionExpressionMod {
  ...
  object Expression {
    ...
    inline def apply(
      ...
      variables: CallbackTo[js.Array[String]],
      variablesLength_ : Any,
      variables_ : Any
    ): Expression = {
      val __obj = js.Dynamic.literal(evaluate = js.Any.fromFunction1(evaluate), expression_ = expression_.asInstanceOf[js.Any], extractVariables_ = extractVariables_.asInstanceOf[js.Any], variables = variables.toJsFn, variablesLength_ = variablesLength_.asInstanceOf[js.Any], variables_ = variables_.asInstanceOf[js.Any])
    ...
    extension [Self <: Expression](x: Self) {
      ...
      inline def setVariables(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "variables", value.toJsFn)
