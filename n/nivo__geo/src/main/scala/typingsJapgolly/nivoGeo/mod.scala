...
import typingsJapgolly.nivoGeo.anon.Feature
import typingsJapgolly.nivoGeo.anon.FeatureAny
import typingsJapgolly.nivoGeo.anon.PartialBox
import typingsJapgolly.nivoGeo.nivoGeoStrings.`string VerticallineNobreakspacenumber`
...
object mod {
  ...
  object ChoroplethCommonProps {
    ...
    extension [Self <: ChoroplethCommonProps](x: Self) {
      ...
      ): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* feature */ ChoroplethBoundFeature, t1: /* event */ ReactMouseEventFrom[Any & Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
      
      inline def setOnMouseEnter(
        value: (/* feature */ ChoroplethBoundFeature, /* event */ ReactMouseEventFrom[Any & Element]) => Callback
      ): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction2((t0: /* feature */ ChoroplethBoundFeature, t1: /* event */ ReactMouseEventFrom[Any & Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnMouseEnterUndefined: Self = StObject.set(x, "onMouseEnter", js.undefined)
      
      inline def setOnMouseLeave(
        value: (/* feature */ ChoroplethBoundFeature, /* event */ ReactMouseEventFrom[Any & Element]) => Callback
      ): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction2((t0: /* feature */ ChoroplethBoundFeature, t1: /* event */ ReactMouseEventFrom[Any & Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnMouseLeaveUndefined: Self = StObject.set(x, "onMouseLeave", js.undefined)
      
      inline def setOnMouseMove(
        value: (/* feature */ ChoroplethBoundFeature, /* event */ ReactMouseEventFrom[Any & Element]) => Callback
      ): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction2((t0: /* feature */ ChoroplethBoundFeature, t1: /* event */ ReactMouseEventFrom[Any & Element]) => (value(t0, t1)).runNow()))
  ...
  type ChoroplethEventHandler = js.Function2[
    ...
    /* event */ ReactMouseEventFrom[Any & Element], 
    Unit
  ]
  ...
  object GeoMapCommonProps {
    ...
    extension [Self <: GeoMapCommonProps](x: Self) {
      ...
      inline def setOnClick(value: (/* feature */ Any, /* event */ ReactMouseEventFrom[Any & Element]) => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* feature */ Any, t1: /* event */ ReactMouseEventFrom[Any & Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
      
      inline def setOnMouseEnter(value: (/* feature */ Any, /* event */ ReactMouseEventFrom[Any & Element]) => Callback): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction2((t0: /* feature */ Any, t1: /* event */ ReactMouseEventFrom[Any & Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnMouseEnterUndefined: Self = StObject.set(x, "onMouseEnter", js.undefined)
      
      inline def setOnMouseLeave(value: (/* feature */ Any, /* event */ ReactMouseEventFrom[Any & Element]) => Callback): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction2((t0: /* feature */ Any, t1: /* event */ ReactMouseEventFrom[Any & Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnMouseLeaveUndefined: Self = StObject.set(x, "onMouseLeave", js.undefined)
      
      inline def setOnMouseMove(value: (/* feature */ Any, /* event */ ReactMouseEventFrom[Any & Element]) => Callback): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction2((t0: /* feature */ Any, t1: /* event */ ReactMouseEventFrom[Any & Element]) => (value(t0, t1)).runNow()))
  ...
  type GeoMapEventHandler = js.Function2[/* feature */ Any, /* event */ ReactMouseEventFrom[Any & Element], Unit]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nivoGeo.nivoGeoStrings.azimuthalEqualArea
    - typingsJapgolly.nivoGeo.nivoGeoStrings.azimuthalEquidistant
    - typingsJapgolly.nivoGeo.nivoGeoStrings.gnomonic
    - typingsJapgolly.nivoGeo.nivoGeoStrings.orthographic
    - typingsJapgolly.nivoGeo.nivoGeoStrings.stereographic
    - typingsJapgolly.nivoGeo.nivoGeoStrings.equalEarth
    - typingsJapgolly.nivoGeo.nivoGeoStrings.equirectangular
    - typingsJapgolly.nivoGeo.nivoGeoStrings.mercator
    - typingsJapgolly.nivoGeo.nivoGeoStrings.transverseMercator
    - typingsJapgolly.nivoGeo.nivoGeoStrings.naturalEarth1
  */
  trait GeoProjectionType extends StObject
  object GeoProjectionType {
    
    inline def azimuthalEqualArea: typingsJapgolly.nivoGeo.nivoGeoStrings.azimuthalEqualArea = "azimuthalEqualArea".asInstanceOf[typingsJapgolly.nivoGeo.nivoGeoStrings.azimuthalEqualArea]
    
    inline def azimuthalEquidistant: typingsJapgolly.nivoGeo.nivoGeoStrings.azimuthalEquidistant = "azimuthalEquidistant".asInstanceOf[typingsJapgolly.nivoGeo.nivoGeoStrings.azimuthalEquidistant]
    
    inline def equalEarth: typingsJapgolly.nivoGeo.nivoGeoStrings.equalEarth = "equalEarth".asInstanceOf[typingsJapgolly.nivoGeo.nivoGeoStrings.equalEarth]
    
    inline def equirectangular: typingsJapgolly.nivoGeo.nivoGeoStrings.equirectangular = "equirectangular".asInstanceOf[typingsJapgolly.nivoGeo.nivoGeoStrings.equirectangular]
    
    inline def gnomonic: typingsJapgolly.nivoGeo.nivoGeoStrings.gnomonic = "gnomonic".asInstanceOf[typingsJapgolly.nivoGeo.nivoGeoStrings.gnomonic]
    
    inline def mercator: typingsJapgolly.nivoGeo.nivoGeoStrings.mercator = "mercator".asInstanceOf[typingsJapgolly.nivoGeo.nivoGeoStrings.mercator]
    
    inline def naturalEarth1: typingsJapgolly.nivoGeo.nivoGeoStrings.naturalEarth1 = "naturalEarth1".asInstanceOf[typingsJapgolly.nivoGeo.nivoGeoStrings.naturalEarth1]
    
    inline def orthographic: typingsJapgolly.nivoGeo.nivoGeoStrings.orthographic = "orthographic".asInstanceOf[typingsJapgolly.nivoGeo.nivoGeoStrings.orthographic]
    
    inline def stereographic: typingsJapgolly.nivoGeo.nivoGeoStrings.stereographic = "stereographic".asInstanceOf[typingsJapgolly.nivoGeo.nivoGeoStrings.stereographic]
    
    inline def transverseMercator: typingsJapgolly.nivoGeo.nivoGeoStrings.transverseMercator = "transverseMercator".asInstanceOf[typingsJapgolly.nivoGeo.nivoGeoStrings.transverseMercator]
  }
}
