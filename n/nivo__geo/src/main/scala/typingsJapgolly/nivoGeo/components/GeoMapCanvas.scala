...
object GeoMapCanvas {
  ...
  inline def apply(features: js.Array[Any], height: Double, width: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[GeoMapCanvasProps & Dimensions]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.nivoGeo.mod.GeoMapCanvas] {
  ...
  def withProps(p: GeoMapCanvasProps & Dimensions): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
