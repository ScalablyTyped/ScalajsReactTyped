...
object GeoMapCanvas {
  def apply(
    ...
    GeoMapCanvasProps with Dimensions, 
    typingsJapgolly.nivoGeo.mod.GeoMapCanvas, 
    Unit, 
    GeoMapCanvasProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoGeo.mod.GeoMapCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoGeo.mod.GeoMapCanvas](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoGeo.mod.GeoMapCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
