...
object Choropleth {
  def apply(
    ...
    ChoroplethProps with Dimensions, 
    typingsJapgolly.nivoGeo.mod.Choropleth, 
    Unit, 
    ChoroplethProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoGeo.mod.ChoroplethProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoGeo.mod.Choropleth](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoGeo.mod.ChoroplethProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
