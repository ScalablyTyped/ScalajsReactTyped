...
object GeoMap {
  def apply(
    ...
    GeoMapProps with Dimensions, 
    typingsJapgolly.nivoGeo.mod.GeoMap, 
    Unit, 
    GeoMapProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoGeo.mod.GeoMapProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoGeo.mod.GeoMap](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoGeo.mod.GeoMapProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
