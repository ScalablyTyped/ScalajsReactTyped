...
object ChoroplethCanvas {
  def apply(
    ...
    ChoroplethCanvasProps with Dimensions, 
    typingsJapgolly.nivoGeo.mod.ChoroplethCanvas, 
    Unit, 
    ChoroplethCanvasProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoGeo.mod.ChoroplethCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoGeo.mod.ChoroplethCanvas](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoGeo.mod.ChoroplethCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
