...
object ChoroplethCanvas {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ChoroplethCanvasProps & Dimensions]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.nivoGeo.mod.ChoroplethCanvas] {
  ...
  def withProps(p: ChoroplethCanvasProps & Dimensions): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
