...
import typingsJapgolly.nivoGeo.mod.GeoMapCommonProps
...
object ResponsiveGeoMap {
  def apply(
    ...
    GeoMapCommonProps, 
    typingsJapgolly.nivoGeo.mod.ResponsiveGeoMap, 
    Unit, 
    GeoMapCommonProps
  ] = {
  ...
  typingsJapgolly.nivoGeo.mod.GeoMapCommonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoGeo.mod.ResponsiveGeoMap](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoGeo.mod.GeoMapCommonProps])(children: _*)
  }
