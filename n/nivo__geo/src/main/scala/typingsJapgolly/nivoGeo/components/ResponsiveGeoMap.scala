...
object ResponsiveGeoMap {
  ...
  inline def apply(features: js.Array[Any]): Builder = {
    val __props = js.Dynamic.literal(features = features.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[GeoMapProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.nivoGeo.mod.ResponsiveGeoMap] {
  ...
  def withProps(p: GeoMapProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
