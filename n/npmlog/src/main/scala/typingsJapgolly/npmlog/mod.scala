package typingsJapgolly.npmlog
...
object mod extends Shortcut {
  ...
  */
  ...
  object LogLevels {
    ...
    inline def error: typingsJapgolly.npmlog.npmlogStrings.error = "error".asInstanceOf[typingsJapgolly.npmlog.npmlogStrings.error]
    
    inline def http: typingsJapgolly.npmlog.npmlogStrings.http = "http".asInstanceOf[typingsJapgolly.npmlog.npmlogStrings.http]
    
    inline def info: typingsJapgolly.npmlog.npmlogStrings.info = "info".asInstanceOf[typingsJapgolly.npmlog.npmlogStrings.info]
    
    inline def notice: typingsJapgolly.npmlog.npmlogStrings.notice = "notice".asInstanceOf[typingsJapgolly.npmlog.npmlogStrings.notice]
    
    inline def silent: typingsJapgolly.npmlog.npmlogStrings.silent = "silent".asInstanceOf[typingsJapgolly.npmlog.npmlogStrings.silent]
    
    inline def silly: typingsJapgolly.npmlog.npmlogStrings.silly = "silly".asInstanceOf[typingsJapgolly.npmlog.npmlogStrings.silly]
    
    inline def timing: typingsJapgolly.npmlog.npmlogStrings.timing = "timing".asInstanceOf[typingsJapgolly.npmlog.npmlogStrings.timing]
    
    inline def verbose: typingsJapgolly.npmlog.npmlogStrings.verbose = "verbose".asInstanceOf[typingsJapgolly.npmlog.npmlogStrings.verbose]
    
    inline def warn: typingsJapgolly.npmlog.npmlogStrings.warn = "warn".asInstanceOf[typingsJapgolly.npmlog.npmlogStrings.warn]
  }
