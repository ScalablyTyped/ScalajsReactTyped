...
trait HeatMapSvgProps[Datum /* <: HeatMapDatum */, ExtraProps /* <: js.Object */] extends StObject {
  ...
  var onClick: js.UndefOr[
    js.Function2[/* cell */ ComputedCell[Datum], /* event */ ReactMouseEventFrom[Element], Unit]
  ] = js.undefined
...
object HeatMapSvgProps {
  ...
  extension [Self <: HeatMapSvgProps[?, ?], Datum /* <: HeatMapDatum */, ExtraProps /* <: js.Object */](x: Self & (HeatMapSvgProps[Datum, ExtraProps])) {
    ...
    inline def setOnClick(value: (/* cell */ ComputedCell[Datum], /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* cell */ ComputedCell[Datum], t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
    
    inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
    
    inline def setOnMouseEnter(value: (/* cell */ ComputedCell[Datum], /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction2((t0: /* cell */ ComputedCell[Datum], t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
    
    inline def setOnMouseEnterUndefined: Self = StObject.set(x, "onMouseEnter", js.undefined)
    
    inline def setOnMouseLeave(value: (/* cell */ ComputedCell[Datum], /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction2((t0: /* cell */ ComputedCell[Datum], t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
    
    inline def setOnMouseLeaveUndefined: Self = StObject.set(x, "onMouseLeave", js.undefined)
    
    inline def setOnMouseMove(value: (/* cell */ ComputedCell[Datum], /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction2((t0: /* cell */ ComputedCell[Datum], t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
