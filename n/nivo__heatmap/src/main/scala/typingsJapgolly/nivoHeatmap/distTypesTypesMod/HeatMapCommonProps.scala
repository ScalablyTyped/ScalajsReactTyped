...
trait HeatMapCommonProps[Datum /* <: HeatMapDatum */] extends StObject {
  ...
  var borderColor: InheritedColorConfig[
  ...
  var labelTextColor: InheritedColorConfig[
  ...
  def onClick(cell: ComputedCell[Datum], event: ReactMouseEventFrom[Element]): Unit
...
object HeatMapCommonProps {
  ...
  inline def apply[Datum /* <: HeatMapDatum */](
    ...
    onClick: (ComputedCell[Datum], ReactMouseEventFrom[Element]) => Callback,
    opacity: Double,
  ...
  extension [Self <: HeatMapCommonProps[?], Datum /* <: HeatMapDatum */](x: Self & HeatMapCommonProps[Datum]) {
    ...
    inline def setOnClick(value: (ComputedCell[Datum], ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: ComputedCell[Datum], t1: ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
