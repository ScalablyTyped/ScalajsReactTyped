...
object HeatMapCanvasProps {
  ...
  extension [Self <: HeatMapCanvasProps[?, ?], Datum /* <: HeatMapDatum */, ExtraProps /* <: js.Object */](x: Self & (HeatMapCanvasProps[Datum, ExtraProps])) {
    ...
    inline def setRenderCellFunction2(
      value: (/* ctx */ CanvasRenderingContext2D, /* props */ CellCanvasRendererProps[Datum]) => Callback
    ): Self = StObject.set(x, "renderCell", js.Any.fromFunction2((t0: /* ctx */ CanvasRenderingContext2D, t1: /* props */ CellCanvasRendererProps[Datum]) => (value(t0, t1)).runNow()))
