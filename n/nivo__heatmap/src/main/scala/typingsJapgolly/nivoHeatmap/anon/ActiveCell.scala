...
object ActiveCell {
  ...
  inline def apply[Datum /* <: HeatMapDatum */](
    ...
    offsetX: Double,
    offsetY: Double,
    setActiveCell: SetStateAction[ComputedCell[Datum] | Null] => Callback,
    width: Double,
    xScale: ScaleBand[
      /* import warning: importer.ImportType#apply Failed type conversion: Datum['x'] */ js.Any
    ],
  ...
  extension [Self <: ActiveCell[?], Datum /* <: HeatMapDatum */](x: Self & ActiveCell[Datum]) {
    ...
    inline def setSetActiveCell(value: SetStateAction[ComputedCell[Datum] | Null] => Callback): Self = StObject.set(x, "setActiveCell", js.Any.fromFunction1((t0: SetStateAction[ComputedCell[Datum] | Null]) => value(t0).runNow()))
