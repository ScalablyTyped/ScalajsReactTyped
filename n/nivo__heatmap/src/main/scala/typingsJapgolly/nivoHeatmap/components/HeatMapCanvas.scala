...
object HeatMapCanvas {
  def apply(
    ...
    HeatMapCanvasProps with Dimensions, 
    typingsJapgolly.nivoHeatmap.mod.HeatMapCanvas, 
    Unit, 
    HeatMapCanvasProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoHeatmap.mod.HeatMapCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoHeatmap.mod.HeatMapCanvas](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoHeatmap.mod.HeatMapCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
