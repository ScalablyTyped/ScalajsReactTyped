...
object HeatMap {
  def apply(
    ...
    HeatMapSvgProps with Dimensions, 
    typingsJapgolly.nivoHeatmap.mod.HeatMap, 
    Unit, 
    HeatMapSvgProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoHeatmap.mod.HeatMapSvgProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoHeatmap.mod.HeatMap](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoHeatmap.mod.HeatMapSvgProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
