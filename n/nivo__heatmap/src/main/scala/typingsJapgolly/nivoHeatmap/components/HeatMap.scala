...
import typingsJapgolly.nivoHeatmap.distTypesTypesMod.CustomLayer
...
object HeatMap {
  ...
  inline def apply[Datum /* <: HeatMapDatum */, ExtraProps /* <: js.Object */](data: js.Array[HeatMapSerie[Datum, ExtraProps]], height: Double, width: Double): Builder[Datum, ExtraProps] = {
    ...
    new Builder[Datum, ExtraProps](js.Array(this.component, __props.asInstanceOf[HeatMapSvgProps[Datum, ExtraProps]]))
  }
  ...
  open class Builder[Datum /* <: HeatMapDatum */, ExtraProps /* <: js.Object */] (val args: js.Array[Any])
    ...
    inline def cellComponent(value: CellShape | CellComponent[Datum]): this.type = set("cellComponent", value.asInstanceOf[js.Any])
    ...
    inline def layers(value: js.Array[LayerId | CustomLayer[Datum]]): this.type = set("layers", value.asInstanceOf[js.Any])
    
    inline def layersVarargs(value: (LayerId | CustomLayer[Datum])*): this.type = set("layers", js.Array(value*))
  ...
  def withProps[Datum /* <: HeatMapDatum */, ExtraProps /* <: js.Object */](p: HeatMapSvgProps[Datum, ExtraProps]): Builder[Datum, ExtraProps] = new Builder[Datum, ExtraProps](js.Array(this.component, p.asInstanceOf[js.Any]))
}
