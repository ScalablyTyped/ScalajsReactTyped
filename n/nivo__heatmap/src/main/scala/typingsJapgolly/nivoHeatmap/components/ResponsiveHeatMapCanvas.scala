...
import typingsJapgolly.nivoHeatmap.mod.HeatMapCanvasProps
...
object ResponsiveHeatMapCanvas {
  def apply(
    ...
    HeatMapCanvasProps, 
    typingsJapgolly.nivoHeatmap.mod.ResponsiveHeatMapCanvas, 
    Unit, 
    HeatMapCanvasProps
  ] = {
  ...
  typingsJapgolly.nivoHeatmap.mod.HeatMapCanvasProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoHeatmap.mod.ResponsiveHeatMapCanvas](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoHeatmap.mod.HeatMapCanvasProps])(children: _*)
  }
