...
object mod extends Shortcut {
  ...
  object Config {
    ...
    inline def apply(
      ...
      defs: ConfigDefs,
      findPrefix: (String, SimpleCallback[String]) => Callback,
      get: String => Any,
      getCredentialsByURI: String => Credentials,
      loadCAFile: (String, ErrorCallback) => Callback,
      loadExtras: ErrorCallback => Callback,
      loadPrefix: ErrorCallback => Callback,
      loadUid: SimpleCallback[String] => Callback,
      loaded: Boolean,
      parse: (String, String) => Any,
      rootConf: Config,
      save: (String, ErrorCallback) => Config,
      set: (String, Any) => Callback,
      setCredentialsByURI: (String, Credentials) => Callback,
      setUser: ErrorCallback => Callback,
      sources: Dictionary[ConfigSource],
      usingBuiltin: Boolean
    ): Config = {
      val __obj = js.Dynamic.literal(Conf = Conf.asInstanceOf[js.Any], add = js.Any.fromFunction2(add), addEnv = js.Any.fromFunction1(addEnv), addFile = js.Any.fromFunction2(addFile), defs = defs.asInstanceOf[js.Any], findPrefix = js.Any.fromFunction2((t0: String, t1: SimpleCallback[String]) => (findPrefix(t0, t1)).runNow()), get = js.Any.fromFunction1(get), getCredentialsByURI = js.Any.fromFunction1(getCredentialsByURI), loadCAFile = js.Any.fromFunction2((t0: String, t1: ErrorCallback) => (loadCAFile(t0, t1)).runNow()), loadExtras = js.Any.fromFunction1((t0: ErrorCallback) => loadExtras(t0).runNow()), loadPrefix = js.Any.fromFunction1((t0: ErrorCallback) => loadPrefix(t0).runNow()), loadUid = js.Any.fromFunction1((t0: SimpleCallback[String]) => loadUid(t0).runNow()), loaded = loaded.asInstanceOf[js.Any], parse = js.Any.fromFunction2(parse), rootConf = rootConf.asInstanceOf[js.Any], save = js.Any.fromFunction2(save), set = js.Any.fromFunction2((t0: String, t1: Any) => (set(t0, t1)).runNow()), setCredentialsByURI = js.Any.fromFunction2((t0: String, t1: Credentials) => (setCredentialsByURI(t0, t1)).runNow()), setUser = js.Any.fromFunction1((t0: ErrorCallback) => setUser(t0).runNow()), sources = sources.asInstanceOf[js.Any], usingBuiltin = usingBuiltin.asInstanceOf[js.Any])
    ...
    extension [Self <: Config](x: Self) {
      ...
      inline def setFindPrefix(value: (String, SimpleCallback[String]) => Callback): Self = StObject.set(x, "findPrefix", js.Any.fromFunction2((t0: String, t1: SimpleCallback[String]) => (value(t0, t1)).runNow()))
      ...
      inline def setLoadCAFile(value: (String, ErrorCallback) => Callback): Self = StObject.set(x, "loadCAFile", js.Any.fromFunction2((t0: String, t1: ErrorCallback) => (value(t0, t1)).runNow()))
      
      inline def setLoadExtras(value: ErrorCallback => Callback): Self = StObject.set(x, "loadExtras", js.Any.fromFunction1((t0: ErrorCallback) => value(t0).runNow()))
      
      inline def setLoadPrefix(value: ErrorCallback => Callback): Self = StObject.set(x, "loadPrefix", js.Any.fromFunction1((t0: ErrorCallback) => value(t0).runNow()))
      
      inline def setLoadUid(value: SimpleCallback[String] => Callback): Self = StObject.set(x, "loadUid", js.Any.fromFunction1((t0: SimpleCallback[String]) => value(t0).runNow()))
      ...
      inline def setSetCredentialsByURI(value: (String, Credentials) => Callback): Self = StObject.set(x, "setCredentialsByURI", js.Any.fromFunction2((t0: String, t1: Credentials) => (value(t0, t1)).runNow()))
      
      inline def setSetUser(value: ErrorCallback => Callback): Self = StObject.set(x, "setUser", js.Any.fromFunction1((t0: ErrorCallback) => value(t0).runNow()))
  ...
  object Spinner {
    ...
    inline def apply(int: String, start: Callback, started: Boolean, stop: Callback): Spinner = {
      val __obj = js.Dynamic.literal(int = int.asInstanceOf[js.Any], start = start.toJsFn, started = started.asInstanceOf[js.Any], stop = stop.toJsFn)
