...
object ResponsiveBullet {
  
  inline def apply(data: js.Array[Datum]): Builder = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitBulletSvgPropsheightw]))
  }
  
  @JSImport("@nivo/bullet", "ResponsiveBullet")
  @js.native
  ...
  def withProps(p: OmitBulletSvgPropsheightw): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
