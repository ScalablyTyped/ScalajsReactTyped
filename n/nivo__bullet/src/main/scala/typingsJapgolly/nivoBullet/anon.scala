...
import typingsJapgolly.nivoBullet.distTypesTypesMod.MouseEventHandler
...
import typingsJapgolly.nivoBullet.nivoBulletStrings.color
  ...
  object OmitBulletSvgPropsheightw {
    ...
    extension [Self <: OmitBulletSvgPropsheightw](x: Self) {
      ...
      inline def setOnMarkerClick(
        value: (WithDatumIdComputedMarker, /* event */ ReactMouseEventFrom[SVGLineElement & org.scalajs.dom.Element]) => Callback
      ): Self = StObject.set(x, "onMarkerClick", js.Any.fromFunction2((t0: WithDatumIdComputedMarker, t1: /* event */ ReactMouseEventFrom[SVGLineElement & org.scalajs.dom.Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnMarkerClickUndefined: Self = StObject.set(x, "onMarkerClick", js.undefined)
      
      inline def setOnMeasureClick(
        value: (WithDatumIdComputedRangeD, /* event */ ReactMouseEventFrom[SVGRectElement & org.scalajs.dom.Element]) => Callback
      ): Self = StObject.set(x, "onMeasureClick", js.Any.fromFunction2((t0: WithDatumIdComputedRangeD, t1: /* event */ ReactMouseEventFrom[SVGRectElement & org.scalajs.dom.Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnMeasureClickUndefined: Self = StObject.set(x, "onMeasureClick", js.undefined)
      
      inline def setOnRangeClick(
        value: (WithDatumIdComputedRangeD, /* event */ ReactMouseEventFrom[SVGRectElement & org.scalajs.dom.Element]) => Callback
      ): Self = StObject.set(x, "onRangeClick", js.Any.fromFunction2((t0: WithDatumIdComputedRangeD, t1: /* event */ ReactMouseEventFrom[SVGRectElement & org.scalajs.dom.Element]) => (value(t0, t1)).runNow()))
