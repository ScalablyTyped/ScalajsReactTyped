package typingsJapgolly.nrwlDevkit

import typingsJapgolly.nrwlDevkit.srcUtilsStringChangeMod.ChangeType.Delete
import typingsJapgolly.nrwlDevkit.srcUtilsStringChangeMod.ChangeType.Insert
...
object srcUtilsStringChangeMod {
  ...
  object ChangeType extends StObject {
    ...
    sealed trait Delete
      extends StObject
         with ChangeType
    /* "Delete" */ val Delete: typingsJapgolly.nrwlDevkit.srcUtilsStringChangeMod.ChangeType.Delete & String = js.native
    
    @js.native
    sealed trait Insert
      extends StObject
         with ChangeType
    /* "Insert" */ val Insert: typingsJapgolly.nrwlDevkit.srcUtilsStringChangeMod.ChangeType.Insert & String = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nrwlDevkit.srcUtilsStringChangeMod.StringInsertion
    - typingsJapgolly.nrwlDevkit.srcUtilsStringChangeMod.StringDeletion
  */
  trait StringChange extends StObject
  object StringChange {
    
    inline def StringDeletion(length: Double, start: Double, `type`: Delete): typingsJapgolly.nrwlDevkit.srcUtilsStringChangeMod.StringDeletion = {
      val __obj = js.Dynamic.literal(length = length.asInstanceOf[js.Any], start = start.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.nrwlDevkit.srcUtilsStringChangeMod.StringDeletion]
    }
    
    inline def StringInsertion(index: Double, text: String, `type`: Insert): typingsJapgolly.nrwlDevkit.srcUtilsStringChangeMod.StringInsertion = {
      val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.nrwlDevkit.srcUtilsStringChangeMod.StringInsertion]
    }
  }
