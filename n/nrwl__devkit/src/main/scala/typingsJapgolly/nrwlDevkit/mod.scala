...
import typingsJapgolly.nrwlDevkit.srcUtilsStringChangeMod.StringChange
...
object mod {
  ...
  object ChangeType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.nrwlDevkit.srcUtilsStringChangeMod.ChangeType & String] = js.native
