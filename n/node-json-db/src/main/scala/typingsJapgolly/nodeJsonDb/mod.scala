...
import typingsJapgolly.nodeJsonDb.distLibJsonDBConfigMod.JsonDBConfig
...
object mod {
  ...
  open class Config protected ()
    extends typingsJapgolly.nodeJsonDb.distLibJsonDBConfigMod.Config {
  ...
  open class DataError protected ()
    extends typingsJapgolly.nodeJsonDb.distLibErrorsMod.DataError {
  ...
  open class DatabaseError protected ()
    extends typingsJapgolly.nodeJsonDb.distLibErrorsMod.DatabaseError {
    def this(message: String, id: Number) = this()
    def this(message: String, id: Number, inner: js.Error) = this()
  }
