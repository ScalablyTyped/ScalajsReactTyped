...
object anon {
  ...
  trait Exp extends StObject {
    ...
    var exp: Boolean | typingsJapgolly.nodeJose.mod.JWS.Exp
  }
  object Exp {
    
    inline def apply(exp: Boolean | typingsJapgolly.nodeJose.mod.JWS.Exp): Exp = {
    ...
    extension [Self <: Exp](x: Self) {
      ...
      inline def setExp(value: Boolean | typingsJapgolly.nodeJose.mod.JWS.Exp): Self = StObject.set(x, "exp", value.asInstanceOf[js.Any])
    }
  }
