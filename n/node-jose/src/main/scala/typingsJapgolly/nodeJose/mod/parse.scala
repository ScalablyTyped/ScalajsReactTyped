...
import typingsJapgolly.nodeJose.nodeJoseStrings.compact
...
object parse {
  ...
  trait ParseReturn extends StObject {
    ...
    var `type`: typingsJapgolly.nodeJose.nodeJoseStrings.JWS | typingsJapgolly.nodeJose.nodeJoseStrings.JWE
  }
  object ParseReturn {
    ...
    inline def apply(
      ...
      `type`: typingsJapgolly.nodeJose.nodeJoseStrings.JWS | typingsJapgolly.nodeJose.nodeJoseStrings.JWE
    ): ParseReturn = {
    ...
    extension [Self <: ParseReturn](x: Self) {
      ...
      inline def setType(value: typingsJapgolly.nodeJose.nodeJoseStrings.JWS | typingsJapgolly.nodeJose.nodeJoseStrings.JWE): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
}
