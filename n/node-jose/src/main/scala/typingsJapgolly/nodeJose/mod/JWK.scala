...
import typingsJapgolly.nodeJose.anon.PartialKeyStoreGetOptions
...
object JWK {
  ...
  object JWEEncryptor {
    ...
    inline def apply(`final`: CallbackTo[js.Promise[String]], update: Any => JWEEncryptor): JWEEncryptor = {
    ...
    extension [Self <: JWEEncryptor](x: Self) {
      ...
      inline def setFinal(value: CallbackTo[js.Promise[String]]): Self = StObject.set(x, "final", value.toJsFn)
  ...
  */
  ...
  object KeyUse {
    ...
    inline def desc: typingsJapgolly.nodeJose.nodeJoseStrings.desc = "desc".asInstanceOf[typingsJapgolly.nodeJose.nodeJoseStrings.desc]
    
    inline def enc: typingsJapgolly.nodeJose.nodeJoseStrings.enc = "enc".asInstanceOf[typingsJapgolly.nodeJose.nodeJoseStrings.enc]
    
    inline def sig: typingsJapgolly.nodeJose.nodeJoseStrings.sig = "sig".asInstanceOf[typingsJapgolly.nodeJose.nodeJoseStrings.sig]
  }
