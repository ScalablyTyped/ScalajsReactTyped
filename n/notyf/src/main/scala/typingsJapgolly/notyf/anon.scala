...
import typingsJapgolly.notyf.notyfDotoptionsMod.DeepPartial
import typingsJapgolly.notyf.notyfDotoptionsMod.INotyfIcon
import typingsJapgolly.notyf.notyfDotoptionsMod.INotyfPosition
