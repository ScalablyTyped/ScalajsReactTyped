...
import typingsJapgolly.nodeSqlParser.anon.Algorithm
import typingsJapgolly.nodeSqlParser.anon.Db
import typingsJapgolly.nodeSqlParser.anon.Keyword
import typingsJapgolly.nodeSqlParser.anon.Lock
import typingsJapgolly.nodeSqlParser.anon.Parentheses
import typingsJapgolly.nodeSqlParser.nodeSqlParserStrings.`if not exists`
import typingsJapgolly.nodeSqlParser.nodeSqlParserStrings.create
import typingsJapgolly.nodeSqlParser.nodeSqlParserStrings.database
import typingsJapgolly.nodeSqlParser.nodeSqlParserStrings.fulltext
import typingsJapgolly.nodeSqlParser.nodeSqlParserStrings.ignore
import typingsJapgolly.nodeSqlParser.nodeSqlParserStrings.index
import typingsJapgolly.nodeSqlParser.nodeSqlParserStrings.on
import typingsJapgolly.nodeSqlParser.nodeSqlParserStrings.replace
import typingsJapgolly.nodeSqlParser.nodeSqlParserStrings.spatial
import typingsJapgolly.nodeSqlParser.nodeSqlParserStrings.table
import typingsJapgolly.nodeSqlParser.nodeSqlParserStrings.temporary
import typingsJapgolly.nodeSqlParser.nodeSqlParserStrings.unique
...
trait Create
  ...
  var temporary: js.UndefOr[typingsJapgolly.nodeSqlParser.nodeSqlParserStrings.temporary | Null] = js.undefined
