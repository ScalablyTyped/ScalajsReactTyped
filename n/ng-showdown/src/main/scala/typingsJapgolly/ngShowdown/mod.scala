...
import typingsJapgolly.showdown.mod.ShowdownOptions
...
object mod {
  ...
  object SDObject {
    ...
    inline def apply(
      ...
      getOptions: CallbackTo[ShowdownOptions],
      makeHtml: /* text */ String => String,
      stripHtml: String => String
    ): SDObject = {
      val __obj = js.Dynamic.literal(getOption = js.Any.fromFunction1(getOption), getOptions = getOptions.toJsFn, makeHtml = js.Any.fromFunction1(makeHtml), stripHtml = js.Any.fromFunction1(stripHtml))
    ...
    extension [Self <: SDObject](x: Self) {
      ...
      inline def setGetOptions(value: CallbackTo[ShowdownOptions]): Self = StObject.set(x, "getOptions", value.toJsFn)
  ...
  object ShowdownProvider {
    ...
    inline def apply(
      $get: CallbackTo[SDObject],
      getOption: String => Any,
      loadExtension: String => ShowdownProvider,
      setOption: (String, Any) => ShowdownProvider
    ): ShowdownProvider = {
      val __obj = js.Dynamic.literal($get = $get.toJsFn, getOption = js.Any.fromFunction1(getOption), loadExtension = js.Any.fromFunction1(loadExtension), setOption = js.Any.fromFunction2(setOption))
      __obj.asInstanceOf[ShowdownProvider]
    }
    
    extension [Self <: ShowdownProvider](x: Self) {
      
      inline def set$get(value: CallbackTo[SDObject]): Self = StObject.set(x, "$get", value.toJsFn)
