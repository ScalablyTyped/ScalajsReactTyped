...
import typingsJapgolly.nginstackDatasource.anon.Children
import typingsJapgolly.nginstackDatasource.anon.DerivedFrom
...
object libDataSourceColumnsMod {
  ...
  trait DataSourceColumns extends StObject {
    ...
    def column(indexOrName: String): typingsJapgolly.nginstackDatasource.libDataSourceColumnMod.^ = js.native
    def column(indexOrName: String, opt_type: String): typingsJapgolly.nginstackDatasource.libDataSourceColumnMod.^ = js.native
    def column(indexOrName: Double): typingsJapgolly.nginstackDatasource.libDataSourceColumnMod.^ = js.native
    def column(indexOrName: Double, opt_type: String): typingsJapgolly.nginstackDatasource.libDataSourceColumnMod.^ = js.native
    ...
    def findByAlias(alias: String): typingsJapgolly.nginstackDatasource.libDataSourceColumnMod.^ = js.native
    
    def findByName(name: String): typingsJapgolly.nginstackDatasource.libDataSourceColumnMod.^ = js.native
