...
import typingsJapgolly.nginstackDatasource.anon.ClassDef
...
object libDataSourceFiltersMod {
  ...
  trait DataSourceFilters extends StObject {
    ...
    def filter(id: String): typingsJapgolly.nginstackDatasource.libDataSourceFilterMod.^ = js.native
    def filter(id: String, opt_type: String): typingsJapgolly.nginstackDatasource.libDataSourceFilterMod.^ = js.native
    def filter(id: String, opt_type: String, opt_classKey: Double): typingsJapgolly.nginstackDatasource.libDataSourceFilterMod.^ = js.native
    def filter(id: String, opt_type: Unit, opt_classKey: Double): typingsJapgolly.nginstackDatasource.libDataSourceFilterMod.^ = js.native
    def filter(id: Double): typingsJapgolly.nginstackDatasource.libDataSourceFilterMod.^ = js.native
    def filter(id: Double, opt_type: String): typingsJapgolly.nginstackDatasource.libDataSourceFilterMod.^ = js.native
    def filter(id: Double, opt_type: String, opt_classKey: Double): typingsJapgolly.nginstackDatasource.libDataSourceFilterMod.^ = js.native
    def filter(id: Double, opt_type: Unit, opt_classKey: Double): typingsJapgolly.nginstackDatasource.libDataSourceFilterMod.^ = js.native
    ...
    def map(
      fn: js.Function3[
          /* arg0 */ typingsJapgolly.nginstackDatasource.libDataSourceFilterMod.^, 
          /* arg1 */ Double, 
          /* arg2 */ js.Array[typingsJapgolly.nginstackDatasource.libDataSourceFilterMod.^], 
          Any
        ]
