...
object libDataSourceColumnMod {
  ...
  @js.native
  def AGGREGATE_AVG: String = js.native
  inline def AGGREGATE_AVG_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AGGREGATE_AVG")(x.asInstanceOf[js.Any])
  
  @JSImport("@nginstack/datasource/lib/DataSourceColumn", "AGGREGATE_COUNT")
  @js.native
  def AGGREGATE_COUNT: String = js.native
  inline def AGGREGATE_COUNT_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AGGREGATE_COUNT")(x.asInstanceOf[js.Any])
  
  @JSImport("@nginstack/datasource/lib/DataSourceColumn", "AGGREGATE_MAX")
  @js.native
  def AGGREGATE_MAX: String = js.native
  inline def AGGREGATE_MAX_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AGGREGATE_MAX")(x.asInstanceOf[js.Any])
  
  @JSImport("@nginstack/datasource/lib/DataSourceColumn", "AGGREGATE_MIN")
  @js.native
  def AGGREGATE_MIN: String = js.native
  inline def AGGREGATE_MIN_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AGGREGATE_MIN")(x.asInstanceOf[js.Any])
  
  @JSImport("@nginstack/datasource/lib/DataSourceColumn", "AGGREGATE_NONE")
  @js.native
  def AGGREGATE_NONE: String = js.native
  inline def AGGREGATE_NONE_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AGGREGATE_NONE")(x.asInstanceOf[js.Any])
  
  @JSImport("@nginstack/datasource/lib/DataSourceColumn", "AGGREGATE_SUM")
  @js.native
  def AGGREGATE_SUM: String = js.native
  inline def AGGREGATE_SUM_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AGGREGATE_SUM")(x.asInstanceOf[js.Any])
  
  @JSImport("@nginstack/datasource/lib/DataSourceColumn", "DIMENSION_SEP")
  @js.native
  def DIMENSION_SEP: String = js.native
  inline def DIMENSION_SEP_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DIMENSION_SEP")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def SORT_NONE: String = js.native
  inline def SORT_NONE_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SORT_NONE")(x.asInstanceOf[js.Any])
  
  inline def colNameFromField(fld: Field, prefix: String): String = (^.asInstanceOf[js.Dynamic].applyDynamic("colNameFromField")(fld.asInstanceOf[js.Any], prefix.asInstanceOf[js.Any])).asInstanceOf[String]
  
  inline def fromField(fld: Field, prefix: String): DataSourceColumn = (^.asInstanceOf[js.Dynamic].applyDynamic("fromField")(fld.asInstanceOf[js.Any], prefix.asInstanceOf[js.Any])).asInstanceOf[DataSourceColumn]
  ...
  object DataSourceColumn {
    ...
    inline def apply(
      ...
      getBackDepth: Any,
      getDepth: Any,
      getDimensionDataSize: CallbackTo[String],
      getDimensionDataType: CallbackTo[String],
    ...
    extension [Self <: DataSourceColumn](x: Self) {
      ...
      inline def setGetDimensionDataSize(value: CallbackTo[String]): Self = StObject.set(x, "getDimensionDataSize", value.toJsFn)
      
      inline def setGetDimensionDataType(value: CallbackTo[String]): Self = StObject.set(x, "getDimensionDataType", value.toJsFn)
      ...
      inline def setSuggestAlias(value: Callback): Self = StObject.set(x, "suggestAlias", value.toJsFn)
