...
object libDataSourceExecutorMod {
  ...
  object DataSourceExecutor {
    ...
    inline def apply(addDataSource: Any, dataSources_ : Any, execute: Callback, getDataSet: Double => DataSet): DataSourceExecutor = {
      val __obj = js.Dynamic.literal(addDataSource = addDataSource.asInstanceOf[js.Any], dataSources_ = dataSources_.asInstanceOf[js.Any], execute = execute.toJsFn, getDataSet = js.Any.fromFunction1(getDataSet))
