...
object mod {
  ...
  */
  ...
  object Format {
    ...
    inline def deflate: typingsJapgolly.nodeZopfli.nodeZopfliStrings.deflate = "deflate".asInstanceOf[typingsJapgolly.nodeZopfli.nodeZopfliStrings.deflate]
    
    inline def gzip: typingsJapgolly.nodeZopfli.nodeZopfliStrings.gzip = "gzip".asInstanceOf[typingsJapgolly.nodeZopfli.nodeZopfliStrings.gzip]
    
    inline def zlib: typingsJapgolly.nodeZopfli.nodeZopfliStrings.zlib = "zlib".asInstanceOf[typingsJapgolly.nodeZopfli.nodeZopfliStrings.zlib]
  }
