...
import typingsJapgolly.nedb.anon.NewDoc
import typingsJapgolly.nedb.nedbStrings.compactionDotdone
...
object mod {
  ...
  object Cursor {
    ...
    inline def apply[T](
      exec: js.Function2[/* err */ js.Error | Null, /* documents */ js.Array[T], Unit] => Callback,
      limit: Double => Cursor[T],
      projection: Any => Cursor[T],
      skip: Double => Cursor[T],
      sort: Any => Cursor[T]
    ): Cursor[T] = {
      val __obj = js.Dynamic.literal(exec = js.Any.fromFunction1((t0: js.Function2[/* err */ js.Error | Null, /* documents */ js.Array[T], Unit]) => exec(t0).runNow()), limit = js.Any.fromFunction1(limit), projection = js.Any.fromFunction1(projection), skip = js.Any.fromFunction1(skip), sort = js.Any.fromFunction1(sort))
      __obj.asInstanceOf[Cursor[T]]
    }
    
    extension [Self <: Cursor[?], T](x: Self & Cursor[T]) {
      
      inline def setExec(value: js.Function2[/* err */ js.Error | Null, /* documents */ js.Array[T], Unit] => Callback): Self = StObject.set(x, "exec", js.Any.fromFunction1((t0: js.Function2[/* err */ js.Error | Null, /* documents */ js.Array[T], Unit]) => value(t0).runNow()))
  ...
  object CursorCount {
    ...
    inline def apply(exec: js.Function2[/* err */ js.Error | Null, /* count */ Double, Unit] => Callback): CursorCount = {
      val __obj = js.Dynamic.literal(exec = js.Any.fromFunction1((t0: js.Function2[/* err */ js.Error | Null, /* count */ Double, Unit]) => exec(t0).runNow()))
      __obj.asInstanceOf[CursorCount]
    }
    
    extension [Self <: CursorCount](x: Self) {
      
      inline def setExec(value: js.Function2[/* err */ js.Error | Null, /* count */ Double, Unit] => Callback): Self = StObject.set(x, "exec", js.Any.fromFunction1((t0: js.Function2[/* err */ js.Error | Null, /* count */ Double, Unit]) => value(t0).runNow()))
    }
  }
  ...
  object Persistence {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(compactDatafile = compactDatafile.toJsFn, setAutocompactionInterval = js.Any.fromFunction1((t0: Double) => setAutocompactionInterval(t0).runNow()), stopAutocompaction = stopAutocompaction.toJsFn)
      __obj.asInstanceOf[Persistence]
    }
    
    extension [Self <: Persistence](x: Self) {
      
      inline def setCompactDatafile(value: Callback): Self = StObject.set(x, "compactDatafile", value.toJsFn)
      
      inline def setSetAutocompactionInterval(value: Double => Callback): Self = StObject.set(x, "setAutocompactionInterval", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      
      inline def setStopAutocompaction(value: Callback): Self = StObject.set(x, "stopAutocompaction", value.toJsFn)
    }
  }
