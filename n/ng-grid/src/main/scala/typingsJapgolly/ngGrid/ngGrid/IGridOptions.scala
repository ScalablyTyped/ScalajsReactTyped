...
object IGridOptions {
  @scala.inline
  def apply(
    afterSelectionChange: (/* rowItem */ js.UndefOr[IRow], /* event */ js.UndefOr[js.Any]) => Callback = null,
    aggregateTemplate: String = null,
    beforeSelectionChange: (/* rowItem */ js.UndefOr[IRow], /* event */ js.UndefOr[js.Any]) => CallbackTo[Boolean] = null,
    ...
    selectItem: (/* idx */ Double, /* state */ Boolean) => CallbackTo[js.Any] = null,
    ...
    if (afterSelectionChange != null) __obj.updateDynamic("afterSelectionChange")(js.Any.fromFunction2((t0: /* rowItem */ js.UndefOr[typingsJapgolly.ngGrid.ngGrid.IRow], t1: /* event */ js.UndefOr[js.Any]) => afterSelectionChange(t0, t1).runNow()))
    if (aggregateTemplate != null) __obj.updateDynamic("aggregateTemplate")(aggregateTemplate.asInstanceOf[js.Any])
    if (beforeSelectionChange != null) __obj.updateDynamic("beforeSelectionChange")(js.Any.fromFunction2((t0: /* rowItem */ js.UndefOr[typingsJapgolly.ngGrid.ngGrid.IRow], t1: /* event */ js.UndefOr[js.Any]) => beforeSelectionChange(t0, t1).runNow()))
    if (checkboxCellTemplate != null) __obj.updateDynamic("checkboxCellTemplate")(checkboxCellTemplate.asInstanceOf[js.Any])
    if (checkboxHeaderTemplate != null) __obj.updateDynamic("checkboxHeaderTemplate")(checkboxHeaderTemplate.asInstanceOf[js.Any])
    ...
    if (selectItem != null) __obj.updateDynamic("selectItem")(js.Any.fromFunction2((t0: /* idx */ scala.Double, t1: /* state */ scala.Boolean) => selectItem(t0, t1).runNow()))
