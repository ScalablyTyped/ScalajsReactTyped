...
object IGridOptions {
  ...
  extension [Self <: IGridOptions](x: Self) {
    ...
    inline def setAfterSelectionChange(value: (/* rowItem */ js.UndefOr[IRow], /* event */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "afterSelectionChange", js.Any.fromFunction2((t0: /* rowItem */ js.UndefOr[IRow], t1: /* event */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
