...
import typingsJapgolly.node.workerThreadsMod.Serializable
...
object nodeColonworkerThreadsMod {
  ...
  open class BroadcastChannel protected ()
    extends typingsJapgolly.node.workerThreadsMod.BroadcastChannel {
  ...
  open class MessageChannel ()
    extends typingsJapgolly.node.workerThreadsMod.MessageChannel
  ...
  /**
    ...
    */
  inline def moveMessagePortToContext(port: typingsJapgolly.node.workerThreadsMod.MessagePort, contextifiedSandbox: Context): typingsJapgolly.node.workerThreadsMod.MessagePort = (^.asInstanceOf[js.Dynamic].applyDynamic("moveMessagePortToContext")(port.asInstanceOf[js.Any], contextifiedSandbox.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.workerThreadsMod.MessagePort]
  
  @JSImport("node:worker_threads", "parentPort")
  @js.native
  val parentPort: Null | typingsJapgolly.node.workerThreadsMod.MessagePort = js.native
  ...
  /**
    ...
    * @since v12.3.0
    */
  inline def receiveMessageOnPort(port: typingsJapgolly.node.workerThreadsMod.MessagePort): js.UndefOr[Message] = ^.asInstanceOf[js.Dynamic].applyDynamic("receiveMessageOnPort")(port.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[Message]]
