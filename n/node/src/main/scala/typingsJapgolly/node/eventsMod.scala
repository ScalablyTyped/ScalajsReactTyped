...
import typingsJapgolly.node.anon.Once
...
object eventsMod {
  ...
  object EventEmitter {
    ...
    inline def getEventListeners(emitter: typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter, name: String): js.Array[js.Function] = (^.asInstanceOf[js.Dynamic].applyDynamic("getEventListeners")(emitter.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Function]]
    inline def getEventListeners(emitter: typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter, name: js.Symbol): js.Array[js.Function] = (^.asInstanceOf[js.Dynamic].applyDynamic("getEventListeners")(emitter.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Function]]
    ...
    /**
      ...
      */
    /* static member */
    inline def listenerCount(emitter: typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter, eventName: String): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("listenerCount")(emitter.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any])).asInstanceOf[Double]
    inline def listenerCount(emitter: typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter, eventName: js.Symbol): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("listenerCount")(emitter.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any])).asInstanceOf[Double]
    ...
    /**
      ...
      */
    /* static member */
    inline def on(emitter: typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter, eventName: String): AsyncIterableIterator[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("on")(emitter.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any])).asInstanceOf[AsyncIterableIterator[Any]]
    inline def on(
      emitter: typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter,
      eventName: String,
    ...
    inline def setMaxListeners(
      n: Double,
      eventTargets: (DOMEventTarget | typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter)*
