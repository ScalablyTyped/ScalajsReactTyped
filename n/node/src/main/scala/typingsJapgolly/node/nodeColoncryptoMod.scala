...
import typingsJapgolly.node.nodeStrings.`rsa-pss`
import typingsJapgolly.node.nodeStrings.aes
import typingsJapgolly.node.nodeStrings.base64
import typingsJapgolly.node.nodeStrings.base64url
...
import typingsJapgolly.node.nodeStrings.ed25519
import typingsJapgolly.node.nodeStrings.ed448
import typingsJapgolly.node.nodeStrings.hex
import typingsJapgolly.node.nodeStrings.hmac
...
import typingsJapgolly.node.nodeStrings.x25519
import typingsJapgolly.node.nodeStrings.x448
...
object nodeColoncryptoMod {
  ...
  open class Certificate ()
    extends typingsJapgolly.node.cryptoMod.Certificate
  object Certificate {
  ...
  /* private */ open class DiffieHellman_ ()
    extends typingsJapgolly.node.cryptoMod.DiffieHellman_
  ...
  /* private */ open class ECDH ()
    extends typingsJapgolly.node.cryptoMod.ECDH
  object ECDH {
  ...
  /* private */ open class KeyObject ()
    extends typingsJapgolly.node.cryptoMod.KeyObject
  object KeyObject {
  ...
  open class X509Certificate protected ()
    extends typingsJapgolly.node.cryptoMod.X509Certificate
