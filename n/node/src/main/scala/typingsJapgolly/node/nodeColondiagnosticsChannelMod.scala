...
object nodeColondiagnosticsChannelMod {
  ...
  open class Channel_ protected ()
    extends typingsJapgolly.node.diagnosticsChannelMod.Channel_ {
  ...
  /**
    ...
    */
  inline def channel(name: String): typingsJapgolly.node.diagnosticsChannelMod.Channel_ = ^.asInstanceOf[js.Dynamic].applyDynamic("channel")(name.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.diagnosticsChannelMod.Channel_]
