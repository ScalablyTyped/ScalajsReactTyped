...
import typingsJapgolly.node.http2Mod.ClientSessionOptions
...
import typingsJapgolly.node.http2Mod.SecureClientSessionOptions
...
import typingsJapgolly.node.http2Mod.Settings
...
object nodeColonhttp2Mod {
  ...
  inline def createSecureServer(
    onRequestHandler: js.Function2[
      /* request */ typingsJapgolly.node.http2Mod.Http2ServerRequest, 
      /* response */ typingsJapgolly.node.http2Mod.Http2ServerResponse, 
      Unit
    ]
