...
object streamMod {
  ...
  object Readable {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromWeb(readableStream: typingsJapgolly.node.streamWebMod.ReadableStream[Any]): Readable = ^.asInstanceOf[js.Dynamic].applyDynamic("fromWeb")(readableStream.asInstanceOf[js.Any]).asInstanceOf[Readable]
    inline def fromWeb(
      readableStream: typingsJapgolly.node.streamWebMod.ReadableStream[Any],
      options: PickReadableOptionsencodi
    ): Readable = (^.asInstanceOf[js.Dynamic].applyDynamic("fromWeb")(readableStream.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Readable]
    ...
    /**
      ...
      */
    /* static member */
    inline def toWeb(streamReadable: Readable): typingsJapgolly.node.streamWebMod.ReadableStream[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toWeb")(streamReadable.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.streamWebMod.ReadableStream[Any]]
  }
  ...
  object Writable {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromWeb(writableStream: typingsJapgolly.node.streamWebMod.WritableStream[Any]): Writable = ^.asInstanceOf[js.Dynamic].applyDynamic("fromWeb")(writableStream.asInstanceOf[js.Any]).asInstanceOf[Writable]
    inline def fromWeb(
      writableStream: typingsJapgolly.node.streamWebMod.WritableStream[Any],
      options: PickWritableOptionsdecode
    ): Writable = (^.asInstanceOf[js.Dynamic].applyDynamic("fromWeb")(writableStream.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Writable]
    ...
    /**
      ...
      */
    /* static member */
    inline def toWeb(streamWritable: Writable): typingsJapgolly.node.streamWebMod.WritableStream[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toWeb")(streamWritable.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.streamWebMod.WritableStream[Any]]
  }
  ...
  object consumers {
    ...
    inline def arrayBuffer(stream: typingsJapgolly.node.nodeColonstreamMod.Readable): js.Promise[js.typedarray.ArrayBuffer] = ^.asInstanceOf[js.Dynamic].applyDynamic("arrayBuffer")(stream.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.typedarray.ArrayBuffer]]
    ...
    inline def blob(stream: typingsJapgolly.node.nodeColonstreamMod.Readable): js.Promise[Blob] = ^.asInstanceOf[js.Dynamic].applyDynamic("blob")(stream.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Blob]]
    ...
    inline def buffer(stream: typingsJapgolly.node.nodeColonstreamMod.Readable): js.Promise[Buffer] = ^.asInstanceOf[js.Dynamic].applyDynamic("buffer")(stream.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Buffer]]
    ...
    inline def json(stream: typingsJapgolly.node.nodeColonstreamMod.Readable): js.Promise[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("json")(stream.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Any]]
    ...
    inline def text(stream: typingsJapgolly.node.nodeColonstreamMod.Readable): js.Promise[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("text")(stream.asInstanceOf[js.Any]).asInstanceOf[js.Promise[String]]
  ...
  - typingsJapgolly.node.eventsMod.Abortable because Already inherited
  - typingsJapgolly.node.streamMod.StreamOptions because Already inherited
  - typingsJapgolly.node.streamMod.WritableOptions because var conflicts: autoDestroy, construct, destroy, emitClose, highWaterMark, objectMode, signal. Inlined decodeStrings, defaultEncoding, write, writev, `final` */ trait DuplexOptions
    extends StObject
  ...
  object Pipe {
    ...
    inline def apply(close: Callback, hasRef: CallbackTo[Boolean], ref: Callback, unref: Callback): Pipe = {
      val __obj = js.Dynamic.literal(close = close.toJsFn, hasRef = hasRef.toJsFn, ref = ref.toJsFn, unref = unref.toJsFn)
