...
import typingsJapgolly.node.nodeColontlsMod.TLSSocket
import typingsJapgolly.node.nodeColonurlMod.URL
import typingsJapgolly.node.nodeStrings.OCSPRequest
import typingsJapgolly.node.nodeStrings.checkContinue
import typingsJapgolly.node.nodeStrings.checkExpectation
import typingsJapgolly.node.nodeStrings.clientError
...
import typingsJapgolly.node.nodeStrings.keylog
import typingsJapgolly.node.nodeStrings.listening
import typingsJapgolly.node.nodeStrings.newSession
import typingsJapgolly.node.nodeStrings.request
import typingsJapgolly.node.nodeStrings.resumeSession
import typingsJapgolly.node.nodeStrings.secureConnection
import typingsJapgolly.node.nodeStrings.tlsClientError
import typingsJapgolly.node.nodeStrings.upgrade
import typingsJapgolly.node.tlsMod.CommonConnectionOptions
...
object httpsMod {
  ...
  @js.native
  open class Agent ()
    extends typingsJapgolly.node.nodeColonhttpMod.Agent {
  ...
  - typingsJapgolly.node.tlsMod.ConnectionOptions because var conflicts: host, lookup, port, timeout. Inlined path, socket, checkServerIdentity, servername, session, minDHSize, pskCallback */ trait AgentOptions
    extends StObject
       with typingsJapgolly.node.httpMod.AgentOptions
    ...
    var socket: js.UndefOr[typingsJapgolly.node.streamMod.Duplex] = js.undefined
  }
  object AgentOptions {
    ...
    extension [Self <: AgentOptions](x: Self) {
      ...
      inline def setSocket(value: typingsJapgolly.node.streamMod.Duplex): Self = StObject.set(x, "socket", value.asInstanceOf[js.Any])
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.node.httpMod.ServerOptions because var conflicts: keepAlive, keepAliveInitialDelay, noDelay. Inlined IncomingMessage, ServerResponse, maxHeaderSize, insecureHTTPParser */ trait ServerOptions[Request /* <: Instantiable1[/* socket */ Socket, IncomingMessage] */, Response /* <: Instantiable1[
    /* import warning: RewrittenClass.unapply cls was tparam Request */ /* req */ Any, 
    ServerResponse[typingsJapgolly.node.httpMod.IncomingMessage]
  ] */]
    extends StObject
