...
object domainMod {
  ...
  open class Domain () extends StObject {
    ...
    /**
      ...
      */
    def add(emitter: typingsJapgolly.node.nodeColoneventsMod.^): Unit = js.native
    ...
    /**
      ...
      * to the domain.
      */
    var members: js.Array[typingsJapgolly.node.nodeColoneventsMod.^ | Timer] = js.native
    ...
    /**
      ...
      */
    def remove(emitter: typingsJapgolly.node.nodeColoneventsMod.^): Unit = js.native
