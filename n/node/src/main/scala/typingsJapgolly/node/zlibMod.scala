...
object zlibMod {
  ...
  object ZlibParams {
    ...
    inline def apply(params: (Double, Double, js.Function0[Unit]) => Callback): ZlibParams = {
      val __obj = js.Dynamic.literal(params = js.Any.fromFunction3((t0: Double, t1: Double, t2: js.Function0[Unit]) => (params(t0, t1, t2)).runNow()))
      __obj.asInstanceOf[ZlibParams]
    }
    
    extension [Self <: ZlibParams](x: Self) {
      
      inline def setParams(value: (Double, Double, js.Function0[Unit]) => Callback): Self = StObject.set(x, "params", js.Any.fromFunction3((t0: Double, t1: Double, t2: js.Function0[Unit]) => (value(t0, t1, t2)).runNow()))
    }
  }
  ...
  object ZlibReset {
    ...
    inline def apply(reset: Callback): ZlibReset = {
      val __obj = js.Dynamic.literal(reset = reset.toJsFn)
