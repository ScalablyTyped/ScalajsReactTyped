...
object Buffer
  ...
  def alloc(size: Double, fill: typingsJapgolly.node.Buffer, encoding: BufferEncoding): typingsJapgolly.node.Buffer = js.native
  /**
    ...
    * @param size count of octets to allocate
    */
  def allocUnsafe(size: Double): typingsJapgolly.node.Buffer = js.native
  /**
    ...
    * @param size count of octets to allocate
    */
  def allocUnsafeSlow(size: Double): typingsJapgolly.node.Buffer = js.native
  /**
  ...
  /**
    ...
    */
  def from(arrayBuffer: ArrayBuffer): typingsJapgolly.node.Buffer = js.native
  def from(arrayBuffer: ArrayBuffer, byteOffset: Double): typingsJapgolly.node.Buffer = js.native
  def from(arrayBuffer: ArrayBuffer, byteOffset: Double, length: Double): typingsJapgolly.node.Buffer = js.native
  /**
  ...
  /**
    ...
    */
  def of(items: Double*): typingsJapgolly.node.Buffer = js.native
}
