...
import typingsJapgolly.node.NodeJS.RefCounted
import typingsJapgolly.node.anon.Message
...
import typingsJapgolly.node.nodeStrings.messageerror
import typingsJapgolly.node.nodeStrings.online
import typingsJapgolly.node.perfHooksMod.EventLoopUtilityFunction
import typingsJapgolly.node.perfHooksMod.EventLoopUtilization
...
object workerThreadsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.node.workerThreadsMod.MessagePort
    - typingsJapgolly.node.fsPromisesMod.FileHandle
    - typingsJapgolly.node.nodeColoncryptoMod.X509Certificate
    - typingsJapgolly.node.nodeColonbufferMod.Blob
  */
