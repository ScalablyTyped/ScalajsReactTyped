...
object v8Mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.node.nodeInts.`0`
    - typingsJapgolly.node.nodeInts.`1`
  */
  trait DoesZapCodeSpaceFlag extends StObject
  object DoesZapCodeSpaceFlag {
    
    inline def `0`: typingsJapgolly.node.nodeInts.`0` = 0.asInstanceOf[typingsJapgolly.node.nodeInts.`0`]
    
    inline def `1`: typingsJapgolly.node.nodeInts.`1` = 1.asInstanceOf[typingsJapgolly.node.nodeInts.`1`]
  }
