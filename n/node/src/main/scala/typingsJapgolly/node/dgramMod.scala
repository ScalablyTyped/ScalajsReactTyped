...
object dgramMod {
  ...
  */
  ...
  object SocketType {
    ...
    inline def udp4: typingsJapgolly.node.nodeStrings.udp4 = "udp4".asInstanceOf[typingsJapgolly.node.nodeStrings.udp4]
    
    inline def udp6: typingsJapgolly.node.nodeStrings.udp6 = "udp6".asInstanceOf[typingsJapgolly.node.nodeStrings.udp6]
  }
}
