...
import typingsJapgolly.node.nodeStrings.ERR_ASSERTION
...
object mod extends js.Object {
  ...
  def doesNotMatch(value: java.lang.String, regExp: js.RegExp, message: Error): Unit = js.native
  ...
  def `match`(value: java.lang.String, regExp: js.RegExp, message: Error): Unit = js.native
