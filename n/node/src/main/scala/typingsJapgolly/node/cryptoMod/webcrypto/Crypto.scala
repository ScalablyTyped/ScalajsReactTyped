...
import typingsJapgolly.node.anon._empty
...
object Crypto {
  ...
  inline def apply(
    ...
    randomUUID: CallbackTo[String],
    subtle: SubtleCrypto
  ): Crypto = {
    val __obj = js.Dynamic.literal(CryptoKey = CryptoKey.asInstanceOf[js.Any], getRandomValues = js.Any.fromFunction1(getRandomValues), randomUUID = randomUUID.toJsFn, subtle = subtle.asInstanceOf[js.Any])
  ...
  extension [Self <: Crypto](x: Self) {
    ...
    inline def setRandomUUID(value: CallbackTo[String]): Self = StObject.set(x, "randomUUID", value.toJsFn)
