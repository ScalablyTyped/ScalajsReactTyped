...
import typingsJapgolly.node.childUnderscoreProcessMod.ChildProcess
...
class Worker () extends EventEmitter {
  ...
  @JSName("addListener")
  def addListener_disconnect(event: typingsJapgolly.node.nodeStrings.disconnect, listener: js.Function0[Unit]): this.type = js.native
  @JSName("addListener")
  ...
  @JSName("emit")
  def emit_disconnect(event: typingsJapgolly.node.nodeStrings.disconnect): Boolean = js.native
  @JSName("emit")
  ...
  @JSName("on")
  def on_disconnect(event: typingsJapgolly.node.nodeStrings.disconnect, listener: js.Function0[Unit]): this.type = js.native
  @JSName("on")
  ...
  @JSName("once")
  def once_disconnect(event: typingsJapgolly.node.nodeStrings.disconnect, listener: js.Function0[Unit]): this.type = js.native
  @JSName("once")
  ...
  def prependListener_disconnect(event: typingsJapgolly.node.nodeStrings.disconnect, listener: js.Function0[Unit]): this.type = js.native
  @JSName("prependListener")
  ...
  def prependOnceListener_disconnect(event: typingsJapgolly.node.nodeStrings.disconnect, listener: js.Function0[Unit]): this.type = js.native
  @JSName("prependOnceListener")
