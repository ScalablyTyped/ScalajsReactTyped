...
import typingsJapgolly.node.anon.Buffered
import typingsJapgolly.node.anon.BufferedType
import typingsJapgolly.node.nodeColonasyncHooksMod.AsyncResource
import typingsJapgolly.node.nodeInts.`0`
import typingsJapgolly.node.nodeStrings.mark
import typingsJapgolly.node.nodeStrings.measure
...
object perfHooksMod {
  ...
  */
  ...
  object EntryType {
    ...
    inline def function: typingsJapgolly.node.nodeStrings.function = "function".asInstanceOf[typingsJapgolly.node.nodeStrings.function]
    
    inline def gc: typingsJapgolly.node.nodeStrings.gc = "gc".asInstanceOf[typingsJapgolly.node.nodeStrings.gc]
    
    inline def http: typingsJapgolly.node.nodeStrings.http = "http".asInstanceOf[typingsJapgolly.node.nodeStrings.http]
    
    inline def http2: typingsJapgolly.node.nodeStrings.http2 = "http2".asInstanceOf[typingsJapgolly.node.nodeStrings.http2]
    
    inline def mark: typingsJapgolly.node.nodeStrings.mark = "mark".asInstanceOf[typingsJapgolly.node.nodeStrings.mark]
    
    inline def measure: typingsJapgolly.node.nodeStrings.measure = "measure".asInstanceOf[typingsJapgolly.node.nodeStrings.measure]
    
    inline def node: typingsJapgolly.node.nodeStrings.node = "node".asInstanceOf[typingsJapgolly.node.nodeStrings.node]
  }
  ...
  object Histogram {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(exceeds = exceeds.asInstanceOf[js.Any], max = max.asInstanceOf[js.Any], mean = mean.asInstanceOf[js.Any], min = min.asInstanceOf[js.Any], percentile = js.Any.fromFunction1(percentile), percentiles = percentiles.asInstanceOf[js.Any], reset = reset.toJsFn, stddev = stddev.asInstanceOf[js.Any])
  ...
  object IntervalHistogram {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(disable = disable.toJsFn, enable = enable.toJsFn, exceeds = exceeds.asInstanceOf[js.Any], max = max.asInstanceOf[js.Any], mean = mean.asInstanceOf[js.Any], min = min.asInstanceOf[js.Any], percentile = js.Any.fromFunction1(percentile), percentiles = percentiles.asInstanceOf[js.Any], reset = reset.toJsFn, stddev = stddev.asInstanceOf[js.Any])
      __obj.asInstanceOf[IntervalHistogram]
    }
    
    extension [Self <: IntervalHistogram](x: Self) {
      
      inline def setDisable(value: CallbackTo[Boolean]): Self = StObject.set(x, "disable", value.toJsFn)
      
      inline def setEnable(value: CallbackTo[Boolean]): Self = StObject.set(x, "enable", value.toJsFn)
    }
  }
