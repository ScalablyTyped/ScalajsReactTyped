...
object SecureServerSessionOptions {
  ...
  def apply(
    ...
    createConnection: (/* authority */ URL_, SecureServerSessionOptions) => CallbackTo[Duplex] = null,
  ...
  scala.Unit]) => SNICallback(t0, t1).runNow()))
    ...
    if (createConnection != null) __obj.updateDynamic("createConnection")(js.Any.fromFunction2((t0: /* authority */ typingsJapgolly.node.urlMod.URL_, t1: typingsJapgolly.node.http2Mod.SecureServerSessionOptions) => createConnection(t0, t1).runNow()))
