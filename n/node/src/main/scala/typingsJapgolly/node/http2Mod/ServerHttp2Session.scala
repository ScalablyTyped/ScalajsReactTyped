...
import typingsJapgolly.node.anon.Origin
...
trait ServerHttp2Session extends StObject {
  ...
  @JSName("emit")
  def emit_connect(event: typingsJapgolly.node.nodeStrings.connect, session: ServerHttp2Session, socket: Socket): Boolean = js.native
  @JSName("emit")
  def emit_connect(event: typingsJapgolly.node.nodeStrings.connect, session: ServerHttp2Session, socket: TLSSocket): Boolean = js.native
  @JSName("emit")
