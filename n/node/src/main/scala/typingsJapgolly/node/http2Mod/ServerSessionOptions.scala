...
object ServerSessionOptions {
  ...
  def apply(
    ...
    createConnection: (/* authority */ URL, ServerSessionOptions) => CallbackTo[Duplex] = null,
    ...
    if (createConnection != null) __obj.updateDynamic("createConnection")(js.Any.fromFunction2((t0: /* authority */ typingsJapgolly.node.urlMod.URL, t1: typingsJapgolly.node.http2Mod.ServerSessionOptions) => createConnection(t0, t1).runNow()))
