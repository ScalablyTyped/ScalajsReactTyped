...
import typingsJapgolly.node.anon.JsMemoryEstimate
import typingsJapgolly.node.anon.Strings
import typingsJapgolly.node.bufferMod.global.Buffer
import typingsJapgolly.node.nodeStrings.afterEvaluate
...
object vmMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.node.nodeStrings.summary
    - typingsJapgolly.node.nodeStrings.detailed
  */
  trait MeasureMemoryMode extends StObject
  object MeasureMemoryMode {
    
    inline def detailed: typingsJapgolly.node.nodeStrings.detailed = "detailed".asInstanceOf[typingsJapgolly.node.nodeStrings.detailed]
    
    inline def summary: typingsJapgolly.node.nodeStrings.summary = "summary".asInstanceOf[typingsJapgolly.node.nodeStrings.summary]
  }
