...
import typingsJapgolly.node.perfHooksMod.CreateHistogramOptions
import typingsJapgolly.node.perfHooksMod.EventLoopMonitorOptions
import typingsJapgolly.node.perfHooksMod.IntervalHistogram
import typingsJapgolly.node.perfHooksMod.PerformanceObserverCallback
import typingsJapgolly.node.perfHooksMod.Performance_
import typingsJapgolly.node.perfHooksMod.RecordableHistogram
...
object nodeColonperfHooksMod {
  ...
  /* protected */ open class PerformanceEntry ()
    extends typingsJapgolly.node.perfHooksMod.PerformanceEntry
  
  @JSImport("node:perf_hooks", "PerformanceMark")
  @js.native
  /* protected */ open class PerformanceMark ()
    extends typingsJapgolly.node.perfHooksMod.PerformanceMark
  
  @JSImport("node:perf_hooks", "PerformanceMeasure")
  @js.native
  /* protected */ open class PerformanceMeasure ()
    extends typingsJapgolly.node.perfHooksMod.PerformanceMeasure
  ...
  /* protected */ open class PerformanceNodeTiming ()
    extends typingsJapgolly.node.perfHooksMod.PerformanceNodeTiming
  
  @JSImport("node:perf_hooks", "PerformanceObserver")
  @js.native
  open class PerformanceObserver protected ()
    extends typingsJapgolly.node.perfHooksMod.PerformanceObserver {
