...
import typingsJapgolly.node.bufferMod.BlobOptions
...
object nodeColonbufferMod {
  ...
  open class Blob protected ()
    extends typingsJapgolly.node.bufferMod.Blob
    ...
    /**
      ...
      */
    def this(sources: js.Array[BinaryLike | typingsJapgolly.node.bufferMod.Blob]) = this()
    def this(sources: js.Array[BinaryLike | typingsJapgolly.node.bufferMod.Blob], options: BlobOptions) = this()
  }
  ...
  inline def resolveObjectURL(id: String): js.UndefOr[typingsJapgolly.node.bufferMod.Blob] = ^.asInstanceOf[js.Dynamic].applyDynamic("resolveObjectURL")(id.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typingsJapgolly.node.bufferMod.Blob]]
