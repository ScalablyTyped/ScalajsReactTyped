...
import typingsJapgolly.node.anon.Idle
...
object osMod {
  ...
  */
  ...
  object NetworkInterfaceInfo {
    ...
    inline def NetworkInterfaceInfoIPv4(address: String, internal: Boolean, mac: String, netmask: String, scopeid: Unit): typingsJapgolly.node.osMod.NetworkInterfaceInfoIPv4 = {
      ...
      __obj.asInstanceOf[typingsJapgolly.node.osMod.NetworkInterfaceInfoIPv4]
    }
    
    inline def NetworkInterfaceInfoIPv6(address: String, internal: Boolean, mac: String, netmask: String, scopeid: Double): typingsJapgolly.node.osMod.NetworkInterfaceInfoIPv6 = {
      ...
      __obj.asInstanceOf[typingsJapgolly.node.osMod.NetworkInterfaceInfoIPv6]
    }
  }
