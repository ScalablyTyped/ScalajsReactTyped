...
import typingsJapgolly.node.v8Mod.HeapCodeStatistics
import typingsJapgolly.node.v8Mod.HeapInfo
import typingsJapgolly.node.v8Mod.HeapSpaceInfo
...
object nodeColonv8Mod {
  ...
  open class DefaultDeserializer protected ()
    extends typingsJapgolly.node.v8Mod.DefaultDeserializer {
  ...
  open class DefaultSerializer ()
    extends typingsJapgolly.node.v8Mod.DefaultSerializer
  ...
  open class Deserializer protected ()
    extends typingsJapgolly.node.v8Mod.Deserializer {
    def this(data: TypedArray) = this()
  }
  ...
  open class Serializer ()
    extends typingsJapgolly.node.v8Mod.Serializer
