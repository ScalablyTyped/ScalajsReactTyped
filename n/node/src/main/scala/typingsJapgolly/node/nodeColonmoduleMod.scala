...
import typingsJapgolly.node.moduleMod.SourceMapPayload
...
object nodeColonmoduleMod extends Shortcut {
  ...
  open class ^ protected ()
    extends typingsJapgolly.node.moduleMod.^ {
  ...
  def Module: Instantiable2[
    /* id */ String, 
    /* parent */ js.UndefOr[typingsJapgolly.node.moduleMod.Module], 
    typingsJapgolly.node.moduleMod.Module
  ] = js.native
  ...
  open class ModuleCls protected ()
    extends StObject
       with typingsJapgolly.node.NodeJS.Module {
    def this(id: String) = this()
    def this(id: String, parent: Module) = this()
    
    /* CompleteClass */
    var children: js.Array[typingsJapgolly.node.NodeJS.Module] = js.native
  ...
  open class SourceMap protected ()
    extends typingsJapgolly.node.moduleMod.SourceMap {
  ...
  /**
    ...
    * @since v13.7.0, v12.17.0
    */
  inline def findSourceMap(path: String): typingsJapgolly.node.moduleMod.SourceMap = ^.asInstanceOf[js.Dynamic].applyDynamic("findSourceMap")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.moduleMod.SourceMap]
  inline def findSourceMap(path: String, error: js.Error): typingsJapgolly.node.moduleMod.SourceMap = (^.asInstanceOf[js.Dynamic].applyDynamic("findSourceMap")(path.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.moduleMod.SourceMap]
