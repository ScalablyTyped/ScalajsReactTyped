...
import typingsJapgolly.node.tlsMod.SecurePair
...
object nodeColontlsMod {
  ...
  open class Server () extends StObject {
    ...
    def this(secureConnectionListener: js.Function1[/* socket */ typingsJapgolly.node.tlsMod.TLSSocket, Unit]) = this()
    def this(
      options: TlsOptions,
      secureConnectionListener: js.Function1[/* socket */ typingsJapgolly.node.tlsMod.TLSSocket, Unit]
    ) = this()
  }
  ...
  /**
    ...
    * @since v0.11.3
    */
  inline def connect(options: ConnectionOptions): typingsJapgolly.node.tlsMod.TLSSocket = ^.asInstanceOf[js.Dynamic].applyDynamic("connect")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.tlsMod.TLSSocket]
  inline def connect(options: ConnectionOptions, secureConnectListener: js.Function0[Unit]): typingsJapgolly.node.tlsMod.TLSSocket = (^.asInstanceOf[js.Dynamic].applyDynamic("connect")(options.asInstanceOf[js.Any], secureConnectListener.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.tlsMod.TLSSocket]
  inline def connect(port: Double): typingsJapgolly.node.tlsMod.TLSSocket = ^.asInstanceOf[js.Dynamic].applyDynamic("connect")(port.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.tlsMod.TLSSocket]
  inline def connect(port: Double, host: String): typingsJapgolly.node.tlsMod.TLSSocket = (^.asInstanceOf[js.Dynamic].applyDynamic("connect")(port.asInstanceOf[js.Any], host.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.tlsMod.TLSSocket]
  inline def connect(port: Double, host: String, options: Unit, secureConnectListener: js.Function0[Unit]): typingsJapgolly.node.tlsMod.TLSSocket = (^.asInstanceOf[js.Dynamic].applyDynamic("connect")(port.asInstanceOf[js.Any], host.asInstanceOf[js.Any], options.asInstanceOf[js.Any], secureConnectListener.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.tlsMod.TLSSocket]
  inline def connect(port: Double, host: String, options: ConnectionOptions): typingsJapgolly.node.tlsMod.TLSSocket = (^.asInstanceOf[js.Dynamic].applyDynamic("connect")(port.asInstanceOf[js.Any], host.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.tlsMod.TLSSocket]
  ...
  inline def connect(port: Double, host: Unit, options: ConnectionOptions): typingsJapgolly.node.tlsMod.TLSSocket = (^.asInstanceOf[js.Dynamic].applyDynamic("connect")(port.asInstanceOf[js.Any], host.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.tlsMod.TLSSocket]
  inline def connect(port: Double, host: Unit, options: ConnectionOptions, secureConnectListener: js.Function0[Unit]): typingsJapgolly.node.tlsMod.TLSSocket = (^.asInstanceOf[js.Dynamic].applyDynamic("connect")(port.asInstanceOf[js.Any], host.asInstanceOf[js.Any], options.asInstanceOf[js.Any], secureConnectListener.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.tlsMod.TLSSocket]
  inline def connect(port: Double, options: Unit, secureConnectListener: js.Function0[Unit]): typingsJapgolly.node.tlsMod.TLSSocket = (^.asInstanceOf[js.Dynamic].applyDynamic("connect")(port.asInstanceOf[js.Any], options.asInstanceOf[js.Any], secureConnectListener.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.tlsMod.TLSSocket]
  inline def connect(port: Double, options: ConnectionOptions): typingsJapgolly.node.tlsMod.TLSSocket = (^.asInstanceOf[js.Dynamic].applyDynamic("connect")(port.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.tlsMod.TLSSocket]
  ...
  /**
    ...
    * @since v0.3.2
    */
  inline def createServer(): typingsJapgolly.node.tlsMod.Server = ^.asInstanceOf[js.Dynamic].applyDynamic("createServer")().asInstanceOf[typingsJapgolly.node.tlsMod.Server]
  inline def createServer(options: TlsOptions): typingsJapgolly.node.tlsMod.Server = ^.asInstanceOf[js.Dynamic].applyDynamic("createServer")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.tlsMod.Server]
  inline def createServer(
    options: TlsOptions,
    secureConnectionListener: js.Function1[/* socket */ typingsJapgolly.node.tlsMod.TLSSocket, Unit]
  ): typingsJapgolly.node.tlsMod.Server = (^.asInstanceOf[js.Dynamic].applyDynamic("createServer")(options.asInstanceOf[js.Any], secureConnectionListener.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.tlsMod.Server]
  inline def createServer(secureConnectionListener: js.Function1[/* socket */ typingsJapgolly.node.tlsMod.TLSSocket, Unit]): typingsJapgolly.node.tlsMod.Server = ^.asInstanceOf[js.Dynamic].applyDynamic("createServer")(secureConnectionListener.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.tlsMod.Server]
