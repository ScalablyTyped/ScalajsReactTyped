...
object nodeColonconstantsMod {
  ...
  @JSImport("node:constants", "ALPN_ENABLED")
  @js.native
  ...
  @JSImport("node:constants", "SSL_OP_EPHEMERAL_RSA")
  @js.native
  ...
  @JSImport("node:constants", "SSL_OP_MICROSOFT_BIG_SSLV3_BUFFER")
  @js.native
  val SSL_OP_MICROSOFT_BIG_SSLV3_BUFFER: Double = js.native
  
  @JSImport("node:constants", "SSL_OP_MICROSOFT_SESS_ID_BUG")
  @js.native
  val SSL_OP_MICROSOFT_SESS_ID_BUG: Double = js.native
  
  /** Instructs OpenSSL to disable the workaround for a man-in-the-middle protocol-version vulnerability in the SSL 2.0 server implementation. */
  @JSImport("node:constants", "SSL_OP_MSIE_SSLV2_RSA_PADDING")
  @js.native
  val SSL_OP_MSIE_SSLV2_RSA_PADDING: Double = js.native
  
  @JSImport("node:constants", "SSL_OP_NETSCAPE_CA_DN_BUG")
  @js.native
  val SSL_OP_NETSCAPE_CA_DN_BUG: Double = js.native
  
  @JSImport("node:constants", "SSL_OP_NETSCAPE_CHALLENGE_BUG")
  @js.native
  val SSL_OP_NETSCAPE_CHALLENGE_BUG: Double = js.native
  
  @JSImport("node:constants", "SSL_OP_NETSCAPE_DEMO_CIPHER_CHANGE_BUG")
  @js.native
  val SSL_OP_NETSCAPE_DEMO_CIPHER_CHANGE_BUG: Double = js.native
  
  @JSImport("node:constants", "SSL_OP_NETSCAPE_REUSE_CIPHER_CHANGE_BUG")
  @js.native
  ...
  @JSImport("node:constants", "SSL_OP_PKCS1_CHECK_1")
  @js.native
  val SSL_OP_PKCS1_CHECK_1: Double = js.native
  
  @JSImport("node:constants", "SSL_OP_PKCS1_CHECK_2")
  @js.native
  val SSL_OP_PKCS1_CHECK_2: Double = js.native
  
  /** Instructs OpenSSL to always create a new key when using temporary/ephemeral DH parameters. */
  @JSImport("node:constants", "SSL_OP_SINGLE_DH_USE")
  @js.native
  val SSL_OP_SINGLE_DH_USE: Double = js.native
  
  /** Instructs OpenSSL to always create a new key when using temporary/ephemeral ECDH parameters. */
  @JSImport("node:constants", "SSL_OP_SINGLE_ECDH_USE")
  @js.native
  val SSL_OP_SINGLE_ECDH_USE: Double = js.native
  
  @JSImport("node:constants", "SSL_OP_SSLEAY_080_CLIENT_DH_BUG")
  @js.native
  val SSL_OP_SSLEAY_080_CLIENT_DH_BUG: Double = js.native
  
  @JSImport("node:constants", "SSL_OP_SSLREF2_REUSE_CERT_TYPE_BUG")
  @js.native
  val SSL_OP_SSLREF2_REUSE_CERT_TYPE_BUG: Double = js.native
  
  @JSImport("node:constants", "SSL_OP_TLS_BLOCK_PADDING_BUG")
  @js.native
  val SSL_OP_TLS_BLOCK_PADDING_BUG: Double = js.native
  
  @JSImport("node:constants", "SSL_OP_TLS_D5_BUG")
  @js.native
