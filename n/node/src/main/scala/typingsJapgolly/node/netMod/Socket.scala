...
import typingsJapgolly.node.childProcessMod.SendHandle
...
class Socket ()
  ...
  def write(str: Uint8Array, encoding: String, cb: js.Function1[/* err */ js.UndefOr[js.Error], Unit]): Boolean = js.native
}
