...
import typingsJapgolly.node.asyncHooksMod.AsyncHook
import typingsJapgolly.node.asyncHooksMod.AsyncResourceOptions
import typingsJapgolly.node.asyncHooksMod.HookCallbacks
...
object nodeColonasyncHooksMod {
  ...
  open class AsyncLocalStorage[T] ()
    extends typingsJapgolly.node.asyncHooksMod.AsyncLocalStorage[T]
  ...
  open class AsyncResource protected ()
    extends typingsJapgolly.node.asyncHooksMod.AsyncResource {
    /**
      * AsyncResource() is meant to be extended. Instantiating a
      * new AsyncResource() also triggers init. If triggerAsyncId is omitted then
      * async_hook.executionAsyncId() is used.
