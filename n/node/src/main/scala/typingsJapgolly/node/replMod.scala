...
import typingsJapgolly.node.NodeJS.ReadOnlyDict
...
import typingsJapgolly.node.nodeStrings.reset
...
object replMod {
  ...
  object ReplOptions {
    ...
    extension [Self <: ReplOptions](x: Self) {
      ...
      ): Self = StObject.set(x, "completer", js.Any.fromFunction2((t0: /* line */ String, t1: /* callback */ js.Function2[
              /* err */ js.UndefOr[Null | js.Error], 
              /* result */ js.UndefOr[CompleterResult], 
              Unit
            ]) => (value(t0, t1)).runNow()))
