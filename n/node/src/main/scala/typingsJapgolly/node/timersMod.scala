    ...
    object NodeJS {
      ...
      object Immediate {
        ...
        inline def apply(
          ...
          val __obj = js.Dynamic.literal(_onImmediate = _onImmediate.asInstanceOf[js.Any], hasRef = hasRef.toJsFn, ref = ref.toJsFn, unref = unref.toJsFn)
          __obj.asInstanceOf[Immediate]
        }
        
        extension [Self <: Immediate](x: Self) {
          
          inline def setHasRef(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasRef", value.toJsFn)
