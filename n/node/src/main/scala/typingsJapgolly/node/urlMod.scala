...
import typingsJapgolly.node.anon.TypeofURL
  ...
  object global {
    ...
    trait Global extends StObject {
      ...
      var URLSearchParams: Instantiable1[
            /* init */ js.UndefOr[
              typingsJapgolly.node.urlMod.URLSearchParams | String | (Record[String, String | js.Array[String]]) | (js.Iterable[js.Tuple2[String, String]]) | (js.Array[js.Tuple2[String, String]])
            ], 
            typingsJapgolly.node.urlMod.URLSearchParams
          ]
    }
    object Global {
