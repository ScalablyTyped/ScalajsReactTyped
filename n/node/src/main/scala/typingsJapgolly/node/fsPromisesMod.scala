...
import typingsJapgolly.node.anon.BytesWritten
import typingsJapgolly.node.anon.EncodingBufferEncoding
...
import typingsJapgolly.node.anon.ObjectEncodingOptionsflagFlag
...
import typingsJapgolly.node.anon.`2`
...
import typingsJapgolly.node.fsMod.ReadVResult
...
import typingsJapgolly.node.nodeColonfsMod.Dir
import typingsJapgolly.node.nodeColonfsMod.Dirent
import typingsJapgolly.node.nodeColonfsMod.ReadStream
import typingsJapgolly.node.nodeColonfsMod.Stats
import typingsJapgolly.node.nodeColonfsMod.WriteStream
import typingsJapgolly.node.nodeColonreadlineMod.Interface
...
import typingsJapgolly.node.workerThreadsMod._TransferListItem
...
object fsPromisesMod {
  ...
  trait FileHandle
    ...
    /**
      ...
      */
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer, offset: Double): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer, offset: Double, length: Double): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer, offset: Double, length: Double, position: Double): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer, offset: Double, length: Null, position: Double): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer, offset: Double, length: Unit, position: Double): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer, offset: Null, length: Double): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer, offset: Null, length: Double, position: Double): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer, offset: Null, length: Null, position: Double): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer, offset: Null, length: Unit, position: Double): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer, offset: Unit, length: Double): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer, offset: Unit, length: Double, position: Double): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer, offset: Unit, length: Null, position: Double): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
    def write[TBuffer /* <: js.typedarray.Uint8Array */](buffer: TBuffer, offset: Unit, length: Unit, position: Double): js.Promise[typingsJapgolly.node.anon.Buffer[TBuffer]] = js.native
