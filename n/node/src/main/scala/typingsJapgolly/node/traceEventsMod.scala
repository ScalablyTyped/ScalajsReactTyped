...
object traceEventsMod {
  ...
  object Tracing {
    ...
    inline def apply(categories: String, disable: Callback, enable: Callback, enabled: Boolean): Tracing = {
      val __obj = js.Dynamic.literal(categories = categories.asInstanceOf[js.Any], disable = disable.toJsFn, enable = enable.toJsFn, enabled = enabled.asInstanceOf[js.Any])
