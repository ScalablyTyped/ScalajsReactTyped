...
import typingsJapgolly.node.AnonStderr
import typingsJapgolly.node.AnonStderrStdout
import typingsJapgolly.node.AnonStdout
import typingsJapgolly.node.Buffer
import typingsJapgolly.node.encodingBufferEncodingExe
import typingsJapgolly.node.encodingbuffernullExecOpt
import typingsJapgolly.node.encodingstringExecOptions
import typingsJapgolly.node.encodingstringnullExecOpt
