...
- typingsJapgolly.std.Error because Already inherited
- typingsJapgolly.node.NodeJS.ErrnoException because var conflicts: cause, code, message, name, stack. Inlined errno, path, syscall */ trait ExecFileException
  extends StObject
     with ExecException {
