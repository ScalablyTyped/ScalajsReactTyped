...
open class ChildProcess () extends StObject {
  ...
  @JSName("addListener")
  def addListener_spawn(event: typingsJapgolly.node.nodeStrings.spawn, listener: js.Function0[Unit]): this.type = js.native
  ...
  @JSName("emit")
  def emit_spawn(event: typingsJapgolly.node.nodeStrings.spawn, listener: js.Function0[Unit]): Boolean = js.native
  ...
  @JSName("on")
  def on_spawn(event: typingsJapgolly.node.nodeStrings.spawn, listener: js.Function0[Unit]): this.type = js.native
  ...
  @JSName("once")
  def once_spawn(event: typingsJapgolly.node.nodeStrings.spawn, listener: js.Function0[Unit]): this.type = js.native
  ...
  @JSName("prependListener")
  def prependListener_spawn(event: typingsJapgolly.node.nodeStrings.spawn, listener: js.Function0[Unit]): this.type = js.native
  ...
  @JSName("prependOnceListener")
  def prependOnceListener_spawn(event: typingsJapgolly.node.nodeStrings.spawn, listener: js.Function0[Unit]): this.type = js.native
