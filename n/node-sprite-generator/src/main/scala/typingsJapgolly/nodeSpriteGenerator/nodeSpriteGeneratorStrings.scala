...
import typingsJapgolly.nodeSpriteGenerator.mod.BuiltinCompositors
import typingsJapgolly.nodeSpriteGenerator.mod.BuiltinLayouts
import typingsJapgolly.nodeSpriteGenerator.mod.BuiltinStylesheetFormats
import typingsJapgolly.nodeSpriteGenerator.mod.CompositorFilters
...
object nodeSpriteGeneratorStrings {
  ...
  sealed trait canvas
    extends StObject
       with BuiltinCompositors
  inline def canvas: canvas = "canvas".asInstanceOf[canvas]
  
  @js.native
  sealed trait css
    extends StObject
       with BuiltinStylesheetFormats
  ...
  sealed trait jimp
    extends StObject
       with BuiltinCompositors
  inline def jimp: jimp = "jimp".asInstanceOf[jimp]
  ...
  sealed trait paeth
    extends StObject
       with CompositorFilters
  inline def paeth: paeth = "paeth".asInstanceOf[paeth]
  
  @js.native
  sealed trait `prefixed-css`
    extends StObject
       with BuiltinStylesheetFormats
  inline def `prefixed-css`: `prefixed-css` = "prefixed-css".asInstanceOf[`prefixed-css`]
