...
import typingsJapgolly.nightwatch.anon.AwaitableNightwatchAPINigAcceptAlert
import typingsJapgolly.nightwatch.anon.AwaitableNightwatchAPINigActions
import typingsJapgolly.nightwatch.anon.AwaitableNightwatchAPINigAssert
import typingsJapgolly.nightwatch.anon.AwaitableNightwatchAPINigAxeInject
import typingsJapgolly.nightwatch.anon.AwaitableNightwatchAPINigAxeRun
import typingsJapgolly.nightwatch.anon.AwaitableNightwatchAPINigBack
import typingsJapgolly.nightwatch.anon.AwaitableNightwatchAPINigBaseUrl
...
trait NightwatchCommonAssertions extends StObject {
  ...
  var NightwatchAssertionsError: typingsJapgolly.nightwatch.mod.NightwatchAssertionsError = js.native
