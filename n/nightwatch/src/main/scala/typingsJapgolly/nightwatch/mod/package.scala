...
import typingsJapgolly.nightwatch.anon.Name
import typingsJapgolly.nightwatch.mod.^
import typingsJapgolly.nightwatch.nightwatchStrings.`then`
import typingsJapgolly.seleniumWebdriver.mod.By
import typingsJapgolly.seleniumWebdriver.mod.RelativeBy
...
/* Rewritten from type alias, can be one of: 
  - java.lang.String
  - typingsJapgolly.nightwatch.mod.ElementProperties
  - typingsJapgolly.nightwatch.mod.Element
  - typingsJapgolly.seleniumWebdriver.mod.RelativeBy
*/
