...
import typingsJapgolly.nightwatch.mod.NightwatchEnsureResult
...
/* Inlined nightwatch.nightwatch.Awaitable<nightwatch.nightwatch.NightwatchAPI, nightwatch.nightwatch.NightwatchEnsureResult> */
@js.native
trait AwaitableNightwatchAPINig extends StObject {
  ...
  def `then`[TResult1, TResult2](onfulfilled: js.Function1[/* value */ NightwatchEnsureResult, TResult1 | PromiseLike[TResult1]]): PromiseLike[TResult1 | TResult2] = js.native
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ NightwatchEnsureResult, TResult1 | PromiseLike[TResult1]],
