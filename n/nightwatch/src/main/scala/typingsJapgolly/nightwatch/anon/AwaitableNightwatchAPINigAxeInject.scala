...
import typingsJapgolly.nightwatch.mod.NightwatchAssertionsResult
...
@js.native
trait AwaitableNightwatchAPINigAxeInject extends StObject {
  ...
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ NightwatchAssertionsResult[Boolean], TResult1 | PromiseLike[TResult1]]
