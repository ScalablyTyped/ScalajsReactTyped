...
trait WriterOptions extends js.Object {
  ...
  var prefixes: js.UndefOr[Prefixes[typingsJapgolly.rdfJs.mod.NamedNode | String]] = js.undefined
}
...
object WriterOptions {
  ...
  def apply(
    ...
    format: String = null,
    prefixes: Prefixes[typingsJapgolly.rdfJs.mod.NamedNode | String] = null
  ): WriterOptions = {
