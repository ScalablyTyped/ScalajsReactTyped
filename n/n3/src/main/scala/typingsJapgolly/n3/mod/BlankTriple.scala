...
trait BlankTriple[Q /* <: typingsJapgolly.rdfjsTypes.dataModelMod.BaseQuad */] extends StObject {
...
object BlankTriple {
  ...
  inline def apply[Q /* <: typingsJapgolly.rdfjsTypes.dataModelMod.BaseQuad */](
  ...
  extension [Self <: BlankTriple[?], Q /* <: typingsJapgolly.rdfjsTypes.dataModelMod.BaseQuad */](x: Self & BlankTriple[Q]) {
