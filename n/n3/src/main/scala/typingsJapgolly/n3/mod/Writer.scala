...
@JSImport("n3", "Writer")
@js.native
open class Writer[Q /* <: typingsJapgolly.rdfjsTypes.dataModelMod.BaseQuad */] () extends StObject {
  ...
  def addPrefix(prefix: String, iri: typingsJapgolly.rdfjsTypes.dataModelMod.NamedNode[String]): Unit = js.native
  def addPrefix(
    prefix: String,
  ...
  def addPrefixes(prefixes: Prefixes[typingsJapgolly.rdfjsTypes.dataModelMod.NamedNode[String] | String]): Unit = js.native
  def addPrefixes(
    prefixes: Prefixes[typingsJapgolly.rdfjsTypes.dataModelMod.NamedNode[String] | String],
    done: js.Function0[Unit]
  ): Unit = js.native
  
  def addQuad(quad: typingsJapgolly.rdfjsTypes.dataModelMod.Quad): Unit = js.native
  def addQuad(
  ...
  def addQuads(quads: js.Array[typingsJapgolly.rdfjsTypes.dataModelMod.Quad]): Unit = js.native
  ...
  def blank(
    triple: js.Array[
      BlankTriple[typingsJapgolly.rdfjsTypes.dataModelMod.Quad] | typingsJapgolly.rdfjsTypes.dataModelMod.Quad
    ]
  ): BlankNode = js.native
  def blank(triple: BlankTriple[typingsJapgolly.rdfjsTypes.dataModelMod.Quad]): BlankNode = js.native
  def blank(triple: typingsJapgolly.rdfjsTypes.dataModelMod.Quad): BlankNode = js.native
  ...
  def quadsToString(quads: js.Array[typingsJapgolly.rdfjsTypes.dataModelMod.Quad]): String = js.native
}
