...
@JSImport("n3", "Store")
@js.native
open class Store[Q_RDF /* <: typingsJapgolly.rdfjsTypes.dataModelMod.BaseQuad */, Q_N3 /* <: BaseQuad */, OutQuad /* <: typingsJapgolly.rdfjsTypes.dataModelMod.BaseQuad */, InQuad /* <: typingsJapgolly.rdfjsTypes.dataModelMod.BaseQuad */] ()
  extends StObject
     with typingsJapgolly.rdfjsTypes.streamMod.Store[Q_RDF]
  ...
  def extractLists(): Record[String, js.Array[typingsJapgolly.rdfjsTypes.dataModelMod.Term]] = js.native
  def extractLists(options: extractListOptions): Record[String, js.Array[typingsJapgolly.rdfjsTypes.dataModelMod.Term]] = js.native
  ...
  override def `match`(
    subject: js.UndefOr[typingsJapgolly.rdfjsTypes.dataModelMod.Term | Null],
    predicate: js.UndefOr[typingsJapgolly.rdfjsTypes.dataModelMod.Term | Null],
    `object`: js.UndefOr[typingsJapgolly.rdfjsTypes.dataModelMod.Term | Null],
    graph: js.UndefOr[typingsJapgolly.rdfjsTypes.dataModelMod.Term | Null]
