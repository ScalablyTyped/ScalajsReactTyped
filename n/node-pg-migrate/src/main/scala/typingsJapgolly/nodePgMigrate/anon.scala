...
import typingsJapgolly.nodePgMigrate.distOperationsTablesTypesMod.LikeOptions
import typingsJapgolly.nodePgMigrate.distOperationsTriggersTypesMod.CreateTriggerFn
import typingsJapgolly.nodePgMigrate.distOperationsTriggersTypesMod.TriggerOptions
...
object anon {
  ...
  trait Options extends StObject {
    ...
    var table: typingsJapgolly.nodePgMigrate.distOperationsGeneralTypesMod.Name
  }
  object Options {
    
    inline def apply(table: typingsJapgolly.nodePgMigrate.distOperationsGeneralTypesMod.Name): Options = {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setTable(value: typingsJapgolly.nodePgMigrate.distOperationsGeneralTypesMod.Name): Self = StObject.set(x, "table", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Reverse {
    ...
    extension [Self <: Reverse](x: Self) {
      ...
      inline def setReverseFunction3(
        value: (/* tableName */ typingsJapgolly.nodePgMigrate.distOperationsGeneralTypesMod.Name, /* triggerName */ String, /* triggerOptions */ TriggerOptions & DropOptions) => String | js.Array[String]
  ...
  trait namestringTypeDropOptions
    extends StObject
       with /* name */ StringDictionary[typingsJapgolly.nodePgMigrate.distOperationsGeneralTypesMod.Type] {
