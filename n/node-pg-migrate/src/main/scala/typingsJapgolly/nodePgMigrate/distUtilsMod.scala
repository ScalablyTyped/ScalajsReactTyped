...
import typingsJapgolly.nodePgMigrate.anon.PublicPartPgLiteral
import typingsJapgolly.nodePgMigrate.distOperationsFunctionsTypesMod.FunctionParam
import typingsJapgolly.nodePgMigrate.distOperationsFunctionsTypesMod.FunctionParamType
...
import typingsJapgolly.nodePgMigrate.distOperationsTablesTypesMod.ColumnDefinition
import typingsJapgolly.nodePgMigrate.distOperationsTablesTypesMod.ColumnDefinitions
import typingsJapgolly.nodePgMigrate.distTypesMod.Literal
...
import typingsJapgolly.nodePgMigrate.mod.PgLiteral
...
object distUtilsMod {
  ...
  inline def createTransformer(literal: Literal): js.Function2[
    ...
    /* d */ js.UndefOr[
      StringDictionary[
        String | Double | Boolean | PgLiteral | PublicPartPgLiteral | js.Array[Value] | typingsJapgolly.nodePgMigrate.anon.Name | Null
      ]
    ], 
    String
