...
import typingsJapgolly.nodePgMigrate.anon.Options
...
import typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.ALWAYS
...
import typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.`BY DEFAULT`
...
object distOperationsTablesTypesMod {
  ...
  */
  ...
  object Action {
    ...
    inline def CASCADE: typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.CASCADE = "CASCADE".asInstanceOf[typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.CASCADE]
    
    inline def `NO ACTION`: typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.`NO ACTION` = ("NO ACTION").asInstanceOf[typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.`NO ACTION`]
    
    inline def RESTRICT: typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.RESTRICT = "RESTRICT".asInstanceOf[typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.RESTRICT]
    
    inline def `SET DEFAULT`: typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.`SET DEFAULT` = ("SET DEFAULT").asInstanceOf[typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.`SET DEFAULT`]
    
    inline def `SET NULL`: typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.`SET NULL` = ("SET NULL").asInstanceOf[typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.`SET NULL`]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.COMMENTS
    - typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.CONSTRAINTS
    - typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.DEFAULTS
    - typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.IDENTITY
    - typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.INDEXES
    - typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.STATISTICS
    - typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.STORAGE
    - typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.ALL
  */
  trait Like extends StObject
  object Like {
    
    inline def ALL: typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.ALL = "ALL".asInstanceOf[typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.ALL]
    
    inline def COMMENTS: typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.COMMENTS = "COMMENTS".asInstanceOf[typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.COMMENTS]
    
    inline def CONSTRAINTS: typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.CONSTRAINTS = "CONSTRAINTS".asInstanceOf[typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.CONSTRAINTS]
    
    inline def DEFAULTS: typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.DEFAULTS = "DEFAULTS".asInstanceOf[typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.DEFAULTS]
    
    inline def IDENTITY: typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.IDENTITY = "IDENTITY".asInstanceOf[typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.IDENTITY]
    
    inline def INDEXES: typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.INDEXES = "INDEXES".asInstanceOf[typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.INDEXES]
    
    inline def STATISTICS: typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.STATISTICS = "STATISTICS".asInstanceOf[typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.STATISTICS]
    
    inline def STORAGE: typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.STORAGE = "STORAGE".asInstanceOf[typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.STORAGE]
  }
