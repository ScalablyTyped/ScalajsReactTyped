...
import typingsJapgolly.nodePgMigrate.anon.ZzIGNOREME
...
object distOperationsGeneralTypesMod {
  ...
  type Name = String | typingsJapgolly.nodePgMigrate.anon.Name
  ...
  type Type = String | typingsJapgolly.nodePgMigrate.anon.Type
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
    - scala.Double
    - typingsJapgolly.nodePgMigrate.distOperationsPgLiteralMod.default
    - typingsJapgolly.nodePgMigrate.distOperationsGeneralTypesMod.PgLiteralValue
    - js.Array[scala.Any]
  */
