...
import typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.FULL
import typingsJapgolly.nodePgMigrate.nodePgMigrateStrings.SIMPLE
import typingsJapgolly.nodePgMigrate.precedenceALWAYSBYDEFAULT
