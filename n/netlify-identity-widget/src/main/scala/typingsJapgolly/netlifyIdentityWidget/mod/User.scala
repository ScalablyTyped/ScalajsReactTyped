...
import typingsJapgolly.netlifyIdentityWidget.AnonApiURL
import typingsJapgolly.netlifyIdentityWidget.AnonAvatarurl
import typingsJapgolly.netlifyIdentityWidget.AnonProvider
