...
import typingsJapgolly.nodeDhtSensor.anon.Test
import typingsJapgolly.nodeDhtSensor.nodeDhtSensorInts.`11`
import typingsJapgolly.nodeDhtSensor.nodeDhtSensorInts.`22`
