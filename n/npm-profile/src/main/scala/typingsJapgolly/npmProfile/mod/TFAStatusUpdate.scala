...
import typingsJapgolly.npmProfile.npmProfileStrings.`auth-and-writes`
import typingsJapgolly.npmProfile.npmProfileStrings.`auth-only`
import typingsJapgolly.npmProfile.npmProfileStrings.disable
