...
import typingsJapgolly.nodeImap.anon.New
import typingsJapgolly.nodeImap.anon.Other
import typingsJapgolly.nodeImap.nodeImapStrings.attributes
import typingsJapgolly.nodeImap.nodeImapStrings.body
import typingsJapgolly.nodeImap.nodeImapStrings.end
import typingsJapgolly.nodeImap.nodeImapStrings.error
import typingsJapgolly.nodeImap.nodeImapStrings.message
...
object mod {
  ...
  object Config {
    ...
    extension [Self <: Config](x: Self) {
      ...
      inline def setDebug(value: /* info */ String => Callback): Self = StObject.set(x, "debug", js.Any.fromFunction1((t0: /* info */ String) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nodeImap.nodeImapStrings.ARRIVAL
    - typingsJapgolly.nodeImap.nodeImapStrings.`-ARRIVAL`
    - typingsJapgolly.nodeImap.nodeImapStrings.CC
    - typingsJapgolly.nodeImap.nodeImapStrings.`-CC`
    - typingsJapgolly.nodeImap.nodeImapStrings.DATE
    - typingsJapgolly.nodeImap.nodeImapStrings.`-DATE`
    - typingsJapgolly.nodeImap.nodeImapStrings.FROM
    - typingsJapgolly.nodeImap.nodeImapStrings.`-FROM`
    - typingsJapgolly.nodeImap.nodeImapStrings.SIZE
    - typingsJapgolly.nodeImap.nodeImapStrings.`-SIZE`
    - typingsJapgolly.nodeImap.nodeImapStrings.SUBJECT
    - typingsJapgolly.nodeImap.nodeImapStrings.`-SUBJECT`
    - typingsJapgolly.nodeImap.nodeImapStrings.TO
    - typingsJapgolly.nodeImap.nodeImapStrings.`-TO`
  */
  trait SortCriteria extends StObject
  object SortCriteria {
    
    inline def `-ARRIVAL`: typingsJapgolly.nodeImap.nodeImapStrings.`-ARRIVAL` = "-ARRIVAL".asInstanceOf[typingsJapgolly.nodeImap.nodeImapStrings.`-ARRIVAL`]
    
    inline def `-CC`: typingsJapgolly.nodeImap.nodeImapStrings.`-CC` = "-CC".asInstanceOf[typingsJapgolly.nodeImap.nodeImapStrings.`-CC`]
    
    inline def `-DATE`: typingsJapgolly.nodeImap.nodeImapStrings.`-DATE` = "-DATE".asInstanceOf[typingsJapgolly.nodeImap.nodeImapStrings.`-DATE`]
    
    inline def `-FROM`: typingsJapgolly.nodeImap.nodeImapStrings.`-FROM` = "-FROM".asInstanceOf[typingsJapgolly.nodeImap.nodeImapStrings.`-FROM`]
    
    inline def `-SIZE`: typingsJapgolly.nodeImap.nodeImapStrings.`-SIZE` = "-SIZE".asInstanceOf[typingsJapgolly.nodeImap.nodeImapStrings.`-SIZE`]
    
    inline def `-SUBJECT`: typingsJapgolly.nodeImap.nodeImapStrings.`-SUBJECT` = "-SUBJECT".asInstanceOf[typingsJapgolly.nodeImap.nodeImapStrings.`-SUBJECT`]
    
    inline def `-TO`: typingsJapgolly.nodeImap.nodeImapStrings.`-TO` = "-TO".asInstanceOf[typingsJapgolly.nodeImap.nodeImapStrings.`-TO`]
