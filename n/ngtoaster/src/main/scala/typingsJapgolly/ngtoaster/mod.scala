...
object mod {
  ...
  object IToast {
    ...
    extension [Self <: IToast](x: Self) {
      ...
      inline def setClickHandler(value: /* evt */ Event => Callback): Self = StObject.set(x, "clickHandler", js.Any.fromFunction1((t0: /* evt */ Event) => value(t0).runNow()))
      ...
      inline def setOnHideCallback(value: /* toast */ IToast => Callback): Self = StObject.set(x, "onHideCallback", js.Any.fromFunction1((t0: /* toast */ IToast) => value(t0).runNow()))
      
      inline def setOnHideCallbackUndefined: Self = StObject.set(x, "onHideCallback", js.undefined)
      
      inline def setOnShowCallback(value: /* toast */ IToast => Callback): Self = StObject.set(x, "onShowCallback", js.Any.fromFunction1((t0: /* toast */ IToast) => value(t0).runNow()))
  ...
  object IToasterEventRegistry {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(setup = setup.toJsFn, subscribeToClearToastsEvent = js.Any.fromFunction1((t0: IToastEventListener) => subscribeToClearToastsEvent(t0).runNow()), subscribeToNewToastEvent = js.Any.fromFunction1((t0: IToastEventListener) => subscribeToNewToastEvent(t0).runNow()), unsubscribeToClearToastsEvent = js.Any.fromFunction1((t0: IToastEventListener) => unsubscribeToClearToastsEvent(t0).runNow()), unsubscribeToNewToastEvent = js.Any.fromFunction1((t0: IToastEventListener) => unsubscribeToNewToastEvent(t0).runNow()))
    ...
    extension [Self <: IToasterEventRegistry](x: Self) {
      ...
      inline def setSubscribeToClearToastsEvent(value: IToastEventListener => Callback): Self = StObject.set(x, "subscribeToClearToastsEvent", js.Any.fromFunction1((t0: IToastEventListener) => value(t0).runNow()))
      
      inline def setSubscribeToNewToastEvent(value: IToastEventListener => Callback): Self = StObject.set(x, "subscribeToNewToastEvent", js.Any.fromFunction1((t0: IToastEventListener) => value(t0).runNow()))
      
      inline def setUnsubscribeToClearToastsEvent(value: IToastEventListener => Callback): Self = StObject.set(x, "unsubscribeToClearToastsEvent", js.Any.fromFunction1((t0: IToastEventListener) => value(t0).runNow()))
      
      inline def setUnsubscribeToNewToastEvent(value: IToastEventListener => Callback): Self = StObject.set(x, "unsubscribeToNewToastEvent", js.Any.fromFunction1((t0: IToastEventListener) => value(t0).runNow()))
    }
  }
