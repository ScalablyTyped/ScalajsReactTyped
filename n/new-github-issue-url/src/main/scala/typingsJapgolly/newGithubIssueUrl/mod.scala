package typingsJapgolly.newGithubIssueUrl
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.newGithubIssueUrl.mod.RepoUrlOptions
    - typingsJapgolly.newGithubIssueUrl.mod.UserAndRepoOptions
  */
  trait Options extends StObject
  object Options {
    
    inline def RepoUrlOptions(repoUrl: String): typingsJapgolly.newGithubIssueUrl.mod.RepoUrlOptions = {
      val __obj = js.Dynamic.literal(repoUrl = repoUrl.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.newGithubIssueUrl.mod.RepoUrlOptions]
    }
    
    inline def UserAndRepoOptions(repo: String, user: String): typingsJapgolly.newGithubIssueUrl.mod.UserAndRepoOptions = {
      val __obj = js.Dynamic.literal(repo = repo.asInstanceOf[js.Any], user = user.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.newGithubIssueUrl.mod.UserAndRepoOptions]
    }
  }
