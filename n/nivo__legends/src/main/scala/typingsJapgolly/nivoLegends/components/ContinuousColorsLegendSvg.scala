...
object ContinuousColorsLegendSvg {
  
  inline def apply(
    scale: (ScaleSequential_[String, scala.Nothing]) | (ScaleDiverging_[String, scala.Nothing]) | (ScaleQuantize_[String, scala.Nothing])
  ): Builder = {
    val __props = js.Dynamic.literal(scale = scale.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[ContinuousColorsLegendProps]))
  }
  
  @JSImport("@nivo/legends", "ContinuousColorsLegendSvg")
  @js.native
  ...
  def withProps(p: ContinuousColorsLegendProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
