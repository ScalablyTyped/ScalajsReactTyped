...
import typingsJapgolly.nivoLegends.nivoLegendsStrings.`text-before-edge`
import typingsJapgolly.nivoLegends.nivoLegendsStrings.alphabetic
import typingsJapgolly.nivoLegends.nivoLegendsStrings.central
