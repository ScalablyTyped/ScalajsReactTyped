...
object BoxLegendSvgProps {
  ...
  extension [Self <: BoxLegendSvgProps](x: Self) {
    ...
    inline def setToggleSerieFunction1(value: /* id */ String | Double => Callback): Self = StObject.set(x, "toggleSerie", js.Any.fromFunction1((t0: /* id */ String | Double) => value(t0).runNow()))
