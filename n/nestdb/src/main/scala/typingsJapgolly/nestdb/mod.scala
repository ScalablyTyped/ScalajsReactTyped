package typingsJapgolly.nestdb

import japgolly.scalajs.react.Callback
import typingsJapgolly.nestdb.anon.NewDoc
import typingsJapgolly.nestdb.nestdbStrings.compactionDotdone
...
object mod {
  ...
  object Cursor {
    ...
    inline def apply[T](
      ...
      val __obj = js.Dynamic.literal(exec = js.Any.fromFunction1((t0: js.Function2[/* err */ js.Error, /* documents */ js.Array[T], Unit]) => exec(t0).runNow()), limit = js.Any.fromFunction1(limit), projection = js.Any.fromFunction1(projection), skip = js.Any.fromFunction1(skip), sort = js.Any.fromFunction1(sort))
      __obj.asInstanceOf[Cursor[T]]
    }
    
    extension [Self <: Cursor[?], T](x: Self & Cursor[T]) {
      
      inline def setExec(value: js.Function2[/* err */ js.Error, /* documents */ js.Array[T], Unit] => Callback): Self = StObject.set(x, "exec", js.Any.fromFunction1((t0: js.Function2[/* err */ js.Error, /* documents */ js.Array[T], Unit]) => value(t0).runNow()))
  ...
  object CursorCount {
    ...
    inline def apply(exec: js.Function2[/* err */ js.Error, /* count */ Double, Unit] => Callback): CursorCount = {
      val __obj = js.Dynamic.literal(exec = js.Any.fromFunction1((t0: js.Function2[/* err */ js.Error, /* count */ Double, Unit]) => exec(t0).runNow()))
      __obj.asInstanceOf[CursorCount]
    }
    
    extension [Self <: CursorCount](x: Self) {
      
      inline def setExec(value: js.Function2[/* err */ js.Error, /* count */ Double, Unit] => Callback): Self = StObject.set(x, "exec", js.Any.fromFunction1((t0: js.Function2[/* err */ js.Error, /* count */ Double, Unit]) => value(t0).runNow()))
    }
  }
