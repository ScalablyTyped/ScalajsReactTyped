...
import typingsJapgolly.ngPackagr.anon.FilePath
...
object libStylesStylesheetProcessorMod {
  ...
  object CssUrl extends StObject {
    ...
    sealed trait `inline`
      extends StObject
         with CssUrl
    /* "inline" */ val `inline`: typingsJapgolly.ngPackagr.libStylesStylesheetProcessorMod.CssUrl.`inline` & String = js.native
    
    @js.native
    sealed trait none
      extends StObject
         with CssUrl
    /* "none" */ val none: typingsJapgolly.ngPackagr.libStylesStylesheetProcessorMod.CssUrl.none & String = js.native
  }
