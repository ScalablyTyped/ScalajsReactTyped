...
object libPackagrMod {
  ...
  open class NgPackagr_ protected () extends StObject {
    ...
    /**
      ...
      */
    def buildAsObservable(): Observable_[Unit] = js.native
    ...
    /**
      ...
      * @return An observable result of the transformation pipeline.
      */
    def watch(): Observable_[Unit] = js.native
    def watch(options: NgPackagrOptions): Observable_[Unit] = js.native
