...
- typingsJapgolly.nvd3.mod.Nvd3Element because Already inherited
- typingsJapgolly.nvd3.mod.Chart because var conflicts: dispatch. Inlined state, interactiveLayer */ @js.native
trait SunburstChart
  extends StObject
     with Sunburst {
