...
import typingsJapgolly.nvd3.nvd3Strings.x
import typingsJapgolly.nvd3.nvd3Strings.y
...
trait Distribution
  ...
  def getData(func: js.Function1[/* d */ Any, Double]): this.type = js.native
  
  def scale(): Any = js.native
  def scale(value: Any): this.type = js.native
