package typingsJapgolly.ntlmClient
...
object mod {
  ...
  trait NtlmType2 extends StObject {
    ...
    var targetInfo: typingsJapgolly.ntlmClient.anon.Buffer
  ...
  object NtlmType2 {
    ...
    inline def apply(
      ...
      encoding: String,
      flags: Double,
      targetInfo: typingsJapgolly.ntlmClient.anon.Buffer,
      targetName: String,
      version: Double
    ): NtlmType2 = {
    ...
    extension [Self <: NtlmType2](x: Self) {
      ...
      inline def setTargetInfo(value: typingsJapgolly.ntlmClient.anon.Buffer): Self = StObject.set(x, "targetInfo", value.asInstanceOf[js.Any])
