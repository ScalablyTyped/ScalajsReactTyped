...
object mod {
  ...
  object GenericArray {
    ...
    inline def apply[T](get: Double => T, length: Double, set: (Double, T) => Callback): GenericArray[T] = {
      val __obj = js.Dynamic.literal(get = js.Any.fromFunction1(get), length = length.asInstanceOf[js.Any], set = js.Any.fromFunction2((t0: Double, t1: T) => (set(t0, t1)).runNow()))
