...
object ResponsiveWaffleCanvas {
  ...
  inline def apply[RawDatum /* <: Datum */](
    ...
    new Builder[RawDatum](js.Array(this.component, __props.asInstanceOf[CanvasProps[RawDatum]]))
  }
  
  @JSImport("@nivo/waffle/dist/types", "ResponsiveWaffleCanvas")
  @js.native
  ...
  def withProps[RawDatum /* <: Datum */](p: CanvasProps[RawDatum]): Builder[RawDatum] = new Builder[RawDatum](js.Array(this.component, p.asInstanceOf[js.Any]))
}
