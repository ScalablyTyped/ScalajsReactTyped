...
object ResponsiveWaffleHtml {
  def apply(
    ...
    WaffleHtmlProps, 
    typingsJapgolly.nivoWaffle.mod.ResponsiveWaffleHtml, 
    Unit, 
    WaffleHtmlProps
  ] = {
  ...
  typingsJapgolly.nivoWaffle.mod.WaffleHtmlProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoWaffle.mod.ResponsiveWaffleHtml](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoWaffle.mod.WaffleHtmlProps])(children: _*)
  }
