...
object WaffleCanvas {
  def apply(
    ...
    WaffleCanvasProps with Dimensions, 
    typingsJapgolly.nivoWaffle.mod.WaffleCanvas, 
    Unit, 
    WaffleCanvasProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoWaffle.mod.WaffleCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoWaffle.mod.WaffleCanvas](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoWaffle.mod.WaffleCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
