...
object Waffle {
  def apply(
    ...
    WaffleSvgProps with Dimensions, 
    typingsJapgolly.nivoWaffle.mod.Waffle, 
    Unit, 
    WaffleSvgProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoWaffle.mod.WaffleSvgProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoWaffle.mod.Waffle](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoWaffle.mod.WaffleSvgProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
