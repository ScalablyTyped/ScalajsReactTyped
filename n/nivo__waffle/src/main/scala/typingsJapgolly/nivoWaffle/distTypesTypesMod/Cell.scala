...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.nivoWaffle.distTypesTypesMod.EmptyCell
  - typingsJapgolly.nivoWaffle.distTypesTypesMod.DataCell[RawDatum]
*/
...
object Cell {
  ...
  inline def DataCell[RawDatum /* <: Datum */](
    ...
    __obj.asInstanceOf[typingsJapgolly.nivoWaffle.distTypesTypesMod.DataCell[RawDatum]]
  }
  
  inline def EmptyCell(color: String, column: Double, position: Double, row: Double, x: Double, y: Double): typingsJapgolly.nivoWaffle.distTypesTypesMod.EmptyCell = {
    ...
    __obj.asInstanceOf[typingsJapgolly.nivoWaffle.distTypesTypesMod.EmptyCell]
  }
}
