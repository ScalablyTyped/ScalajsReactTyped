...
object mod {
  ...
  inline def apply(conf: Configuration): typingsJapgolly.nsApi.mod.nsApi = ^.asInstanceOf[js.Dynamic].apply(conf.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.nsApi.mod.nsApi]
