...
trait Typeofextension extends js.Object {
  ...
  def getBackgroundPage(): typingsJapgolly.chrome.Window | Null = js.native
  def getExtensionTabs(): js.Array[typingsJapgolly.chrome.Window] = js.native
  def getExtensionTabs(windowId: Double): js.Array[typingsJapgolly.chrome.Window] = js.native
  def getURL(path: String): String = js.native
  def getViews(): js.Array[typingsJapgolly.chrome.Window] = js.native
  def getViews(fetchProperties: FetchProperties): js.Array[typingsJapgolly.chrome.Window] = js.native
