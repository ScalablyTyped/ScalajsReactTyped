...
trait ZoomChangeInfo extends StObject {
  ...
  var zoomSettings: typingsJapgolly.chrome.chrome.tabs.ZoomSettings
}
object ZoomChangeInfo {
  ...
  extension [Self <: ZoomChangeInfo](x: Self) {
    ...
    inline def setZoomSettings(value: typingsJapgolly.chrome.chrome.tabs.ZoomSettings): Self = StObject.set(x, "zoomSettings", value.asInstanceOf[js.Any])
  }
}
