...
object permissions {
  ...
  trait PermissionsAddedEvent extends StObject {
    ...
    /**
      ...
      */
    def addListener(
      callback: js.Function1[/* permissions */ typingsJapgolly.chrome.chrome.permissions.Permissions, Unit]
    ): Unit
  }
  object PermissionsAddedEvent {
    
    inline def apply(
      addListener: js.Function1[/* permissions */ typingsJapgolly.chrome.chrome.permissions.Permissions, Unit] => Callback
    ): PermissionsAddedEvent = {
      val __obj = js.Dynamic.literal(addListener = js.Any.fromFunction1((t0: js.Function1[/* permissions */ typingsJapgolly.chrome.chrome.permissions.Permissions, Unit]) => addListener(t0).runNow()))
    ...
    extension [Self <: PermissionsAddedEvent](x: Self) {
      ...
      inline def setAddListener(
        value: js.Function1[/* permissions */ typingsJapgolly.chrome.chrome.permissions.Permissions, Unit] => Callback
      ): Self = StObject.set(x, "addListener", js.Any.fromFunction1((t0: js.Function1[/* permissions */ typingsJapgolly.chrome.chrome.permissions.Permissions, Unit]) => value(t0).runNow()))
    }
  }
