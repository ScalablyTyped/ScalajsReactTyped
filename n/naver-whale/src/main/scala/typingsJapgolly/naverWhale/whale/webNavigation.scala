...
object webNavigation {
  ...
  trait GetAllFrameResultDetails
    extends StObject
       with typingsJapgolly.chrome.chrome.webNavigation.GetFrameResultDetails {
  ...
  trait WebNavigationFramedCallbackDetails
    extends StObject
       with typingsJapgolly.chrome.chrome.webNavigation.WebNavigationUrlCallbackDetails {
  ...
  trait WebNavigationFramedErrorCallbackDetails
    extends StObject
       with typingsJapgolly.chrome.chrome.webNavigation.WebNavigationFramedCallbackDetails {
  ...
  trait WebNavigationReplacementCallbackDetails
    extends StObject
       with typingsJapgolly.chrome.chrome.webNavigation.WebNavigationCallbackDetails {
