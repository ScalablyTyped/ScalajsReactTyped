...
object browserAction {
  ...
  trait BadgeBackgroundColorDetails extends StObject {
    ...
    var color: String | typingsJapgolly.chrome.chrome.browserAction.ColorArray
  ...
  object BadgeBackgroundColorDetails {
    ...
    inline def apply(color: String | typingsJapgolly.chrome.chrome.browserAction.ColorArray): BadgeBackgroundColorDetails = {
    ...
    extension [Self <: BadgeBackgroundColorDetails](x: Self) {
      ...
      inline def setColor(value: String | typingsJapgolly.chrome.chrome.browserAction.ColorArray): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
