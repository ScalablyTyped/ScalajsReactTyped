...
object proxy {
  ...
  object ProxyConfig {
    ...
    extension [Self <: ProxyConfig](x: Self) {
      ...
      inline def setPacScript(value: typingsJapgolly.chrome.chrome.proxy.PacScript): Self = StObject.set(x, "pacScript", value.asInstanceOf[js.Any])
      
      inline def setPacScriptUndefined: Self = StObject.set(x, "pacScript", js.undefined)
      
      inline def setRules(value: typingsJapgolly.chrome.chrome.proxy.ProxyRules): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
      
      inline def setRulesUndefined: Self = StObject.set(x, "rules", js.undefined)
    }
  }
  
  type ProxyErrorEvent = Event[
    js.Function1[/* details */ typingsJapgolly.chrome.chrome.proxy.ErrorDetails, Unit]
  ]
  ...
  trait ProxyRules extends StObject {
    ...
    var fallbackProxy: js.UndefOr[typingsJapgolly.chrome.chrome.proxy.ProxyServer] = js.undefined
    
    /** Optional. The proxy server to be used for FTP requests. */
    var proxyForFtp: js.UndefOr[typingsJapgolly.chrome.chrome.proxy.ProxyServer] = js.undefined
    
    /** Optional. The proxy server to be used for HTTP requests. */
    var proxyForHttp: js.UndefOr[typingsJapgolly.chrome.chrome.proxy.ProxyServer] = js.undefined
    
    /** Optional. The proxy server to be used for HTTPS requests. */
    var proxyForHttps: js.UndefOr[typingsJapgolly.chrome.chrome.proxy.ProxyServer] = js.undefined
    
    /** Optional. The proxy server to be used for all per-URL requests (that is http, https, and ftp). */
    var singleProxy: js.UndefOr[typingsJapgolly.chrome.chrome.proxy.ProxyServer] = js.undefined
  }
  object ProxyRules {
    ...
    extension [Self <: ProxyRules](x: Self) {
      ...
      inline def setFallbackProxy(value: typingsJapgolly.chrome.chrome.proxy.ProxyServer): Self = StObject.set(x, "fallbackProxy", value.asInstanceOf[js.Any])
      
      inline def setFallbackProxyUndefined: Self = StObject.set(x, "fallbackProxy", js.undefined)
      
      inline def setProxyForFtp(value: typingsJapgolly.chrome.chrome.proxy.ProxyServer): Self = StObject.set(x, "proxyForFtp", value.asInstanceOf[js.Any])
      
      inline def setProxyForFtpUndefined: Self = StObject.set(x, "proxyForFtp", js.undefined)
      
      inline def setProxyForHttp(value: typingsJapgolly.chrome.chrome.proxy.ProxyServer): Self = StObject.set(x, "proxyForHttp", value.asInstanceOf[js.Any])
      
      inline def setProxyForHttpUndefined: Self = StObject.set(x, "proxyForHttp", js.undefined)
      
      inline def setProxyForHttps(value: typingsJapgolly.chrome.chrome.proxy.ProxyServer): Self = StObject.set(x, "proxyForHttps", value.asInstanceOf[js.Any])
      
      inline def setProxyForHttpsUndefined: Self = StObject.set(x, "proxyForHttps", js.undefined)
      
      inline def setSingleProxy(value: typingsJapgolly.chrome.chrome.proxy.ProxyServer): Self = StObject.set(x, "singleProxy", value.asInstanceOf[js.Any])
