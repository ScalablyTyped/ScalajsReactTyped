...
object tts {
  ...
  object SpeakOptions {
    ...
    extension [Self <: SpeakOptions](x: Self) {
      ...
      inline def setOnEvent(value: /* event */ typingsJapgolly.chrome.chrome.tts.TtsEvent => Callback): Self = StObject.set(x, "onEvent", js.Any.fromFunction1((t0: /* event */ typingsJapgolly.chrome.chrome.tts.TtsEvent) => value(t0).runNow()))
