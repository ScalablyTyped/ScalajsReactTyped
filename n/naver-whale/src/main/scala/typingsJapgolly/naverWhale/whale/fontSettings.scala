...
import typingsJapgolly.naverWhale.naverWhaleStrings.cursive
import typingsJapgolly.naverWhale.naverWhaleStrings.fantasy
import typingsJapgolly.naverWhale.naverWhaleStrings.fixed
import typingsJapgolly.naverWhale.naverWhaleStrings.sansserif
import typingsJapgolly.naverWhale.naverWhaleStrings.serif
import typingsJapgolly.naverWhale.naverWhaleStrings.standard
...
object fontSettings {
  ...
  type DefaultFixedFontSizeChangedEvent = Event[
    js.Function1[/* details */ typingsJapgolly.chrome.chrome.fontSettings.FontSizeDetails, Unit]
  ]
  ...
  type FontChangedEvent = Event[
    js.Function1[/* details */ typingsJapgolly.chrome.chrome.fontSettings.FullFontDetails, Unit]
  ]
  ...
  trait SetFontDetails
    extends StObject
       with typingsJapgolly.chrome.chrome.fontSettings.FontDetails {
  ...
  object SetFontDetails {
    ...
    inline def apply(
      fontId: String,
      genericFamily: typingsJapgolly.chrome.chromeStrings.cursive | typingsJapgolly.chrome.chromeStrings.fantasy | typingsJapgolly.chrome.chromeStrings.fixed | typingsJapgolly.chrome.chromeStrings.sansserif | typingsJapgolly.chrome.chromeStrings.serif | typingsJapgolly.chrome.chromeStrings.standard
    ): SetFontDetails = {
