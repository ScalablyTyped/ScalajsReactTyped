...
object i18n {
  ...
  object LanguageDetectionResult {
    ...
    inline def apply(isReliable: Boolean, languages: js.Array[typingsJapgolly.chrome.chrome.i18n.DetectedLanguage]): LanguageDetectionResult = {
    ...
    extension [Self <: LanguageDetectionResult](x: Self) {
      ...
      inline def setLanguages(value: js.Array[typingsJapgolly.chrome.chrome.i18n.DetectedLanguage]): Self = StObject.set(x, "languages", value.asInstanceOf[js.Any])
      
      inline def setLanguagesVarargs(value: typingsJapgolly.chrome.chrome.i18n.DetectedLanguage*): Self = StObject.set(x, "languages", js.Array(value*))
    }
  }
}
