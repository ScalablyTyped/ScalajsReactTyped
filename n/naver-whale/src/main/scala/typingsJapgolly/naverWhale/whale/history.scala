...
object history {
  ...
  type HistoryVisitRemovedEvent = Event[
    js.Function1[/* removed */ typingsJapgolly.chrome.chrome.history.RemovedResult, Unit]
  ]
  
  type HistoryVisitedEvent = Event[
    js.Function1[/* result */ typingsJapgolly.chrome.chrome.history.HistoryItem, Unit]
  ]
