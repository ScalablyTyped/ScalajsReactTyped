...
object tabCapture {
  ...
  object CaptureOptions {
    ...
    extension [Self <: CaptureOptions](x: Self) {
      ...
      inline def setAudioConstraints(value: typingsJapgolly.chrome.chrome.tabCapture.MediaStreamConstraint): Self = StObject.set(x, "audioConstraints", value.asInstanceOf[js.Any])
      ...
      inline def setVideoConstraints(value: typingsJapgolly.chrome.chrome.tabCapture.MediaStreamConstraint): Self = StObject.set(x, "videoConstraints", value.asInstanceOf[js.Any])
  ...
  type CaptureStatusChangedEvent = Event[
    js.Function1[/* info */ typingsJapgolly.chrome.chrome.tabCapture.CaptureInfo, Unit]
  ]
