...
object cookies {
  ...
  trait Cookie extends StObject {
    ...
    /**
      ...
      * @since Chrome 51.
      */
    var sameSite: typingsJapgolly.chrome.chrome.cookies.SameSiteStatus
  ...
  object Cookie {
    ...
    inline def apply(
      ...
      name: String,
      path: String,
      sameSite: typingsJapgolly.chrome.chrome.cookies.SameSiteStatus,
      secure: Boolean,
      session: Boolean,
      storeId: String,
      value: String
    ...
    extension [Self <: Cookie](x: Self) {
      ...
      inline def setSameSite(value: typingsJapgolly.chrome.chrome.cookies.SameSiteStatus): Self = StObject.set(x, "sameSite", value.asInstanceOf[js.Any])
  ...
  object CookieChangeInfo {
    ...
    inline def apply(cause: String, cookie: typingsJapgolly.chrome.chrome.cookies.Cookie, removed: Boolean): CookieChangeInfo = {
    ...
    extension [Self <: CookieChangeInfo](x: Self) {
      ...
      inline def setCookie(value: typingsJapgolly.chrome.chrome.cookies.Cookie): Self = StObject.set(x, "cookie", value.asInstanceOf[js.Any])
  ...
  type CookieChangedEvent = Event[
    js.Function1[/* changeInfo */ typingsJapgolly.chrome.chrome.cookies.CookieChangeInfo, Unit]
  ]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.naverWhale.naverWhaleStrings.unspecified
    - typingsJapgolly.naverWhale.naverWhaleStrings.no_restriction
    - typingsJapgolly.naverWhale.naverWhaleStrings.lax
    - typingsJapgolly.naverWhale.naverWhaleStrings.strict
  */
  trait SameSiteStatus extends StObject
  object SameSiteStatus {
    
    inline def lax: typingsJapgolly.naverWhale.naverWhaleStrings.lax = "lax".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.lax]
    
    inline def no_restriction: typingsJapgolly.naverWhale.naverWhaleStrings.no_restriction = "no_restriction".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.no_restriction]
    
    inline def strict: typingsJapgolly.naverWhale.naverWhaleStrings.strict = "strict".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.strict]
    
    inline def unspecified: typingsJapgolly.naverWhale.naverWhaleStrings.unspecified = "unspecified".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.unspecified]
  }
  ...
  trait SetDetails extends StObject {
    ...
    /**
      ...
      * @since Chrome 51.
      */
    var sameSite: js.UndefOr[typingsJapgolly.chrome.chrome.cookies.SameSiteStatus] = js.undefined
