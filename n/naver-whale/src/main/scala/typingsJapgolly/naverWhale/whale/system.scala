...
object system {
  ...
  object cpu {
    ...
    trait CpuInfo extends StObject {
      ...
      var processors: js.Array[typingsJapgolly.chrome.chrome.system.cpu.ProcessorInfo]
    }
    object CpuInfo {
      ...
      inline def apply(
        ...
        processors: js.Array[typingsJapgolly.chrome.chrome.system.cpu.ProcessorInfo]
      ): CpuInfo = {
      ...
      extension [Self <: CpuInfo](x: Self) {
        ...
        inline def setProcessors(value: js.Array[typingsJapgolly.chrome.chrome.system.cpu.ProcessorInfo]): Self = StObject.set(x, "processors", value.asInstanceOf[js.Any])
        
        inline def setProcessorsVarargs(value: typingsJapgolly.chrome.chrome.system.cpu.ProcessorInfo*): Self = StObject.set(x, "processors", js.Array(value*))
      }
    }
    ...
    object ProcessorInfo {
      ...
      inline def apply(usage: typingsJapgolly.chrome.chrome.system.cpu.ProcessorUsage): ProcessorInfo = {
      ...
      extension [Self <: ProcessorInfo](x: Self) {
        ...
        inline def setUsage(value: typingsJapgolly.chrome.chrome.system.cpu.ProcessorUsage): Self = StObject.set(x, "usage", value.asInstanceOf[js.Any])
      }
    }
  ...
  object storage {
    ...
    type SystemStorageAttachedEvent = Event[
        js.Function1[/* info */ typingsJapgolly.chrome.chrome.system.storage.StorageUnitInfo, Unit]
      ]
