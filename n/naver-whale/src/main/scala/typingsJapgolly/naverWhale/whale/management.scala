...
object management {
  ...
  trait ExtensionInfo extends StObject {
    ...
    /**
      ...
      */
    var icons: js.UndefOr[js.Array[typingsJapgolly.chrome.chrome.management.IconInfo]] = js.undefined
  ...
  object ExtensionInfo {
    ...
    extension [Self <: ExtensionInfo](x: Self) {
      ...
      inline def setAvailableLaunchTypes(value: js.Array[String]): Self = StObject.set(x, "availableLaunchTypes", value.asInstanceOf[js.Any])
      ...
      inline def setDisabledReason(value: String): Self = StObject.set(x, "disabledReason", value.asInstanceOf[js.Any])
      ...
      inline def setIcons(value: js.Array[typingsJapgolly.chrome.chrome.management.IconInfo]): Self = StObject.set(x, "icons", value.asInstanceOf[js.Any])
      
      inline def setIconsUndefined: Self = StObject.set(x, "icons", js.undefined)
      
      inline def setIconsVarargs(value: typingsJapgolly.chrome.chrome.management.IconInfo*): Self = StObject.set(x, "icons", js.Array(value*))
      
      inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
      
      inline def setInstallType(value: String): Self = StObject.set(x, "installType", value.asInstanceOf[js.Any])
      
      inline def setIsApp(value: Boolean): Self = StObject.set(x, "isApp", value.asInstanceOf[js.Any])
  ...
  type ManagementDisabledEvent = Event[
    js.Function1[/* info */ typingsJapgolly.chrome.chrome.management.ExtensionInfo, Unit]
  ]
