...
trait CookieChangeInfo extends js.Object {
  ...
  var cookie: typingsJapgolly.chrome.chrome.cookies.Cookie
...
object CookieChangeInfo {
  @scala.inline
  def apply(cause: String, cookie: typingsJapgolly.chrome.chrome.cookies.Cookie, removed: Boolean): CookieChangeInfo = {
