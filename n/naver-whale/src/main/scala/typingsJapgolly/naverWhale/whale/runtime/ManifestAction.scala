...
trait ManifestAction extends StObject {
  ...
  var default_icon: js.UndefOr[typingsJapgolly.chrome.chrome.runtime.ManifestIcons] = js.undefined
...
object ManifestAction {
  ...
  extension [Self <: ManifestAction](x: Self) {
    ...
    inline def setDefault_icon(value: typingsJapgolly.chrome.chrome.runtime.ManifestIcons): Self = StObject.set(x, "default_icon", value.asInstanceOf[js.Any])
