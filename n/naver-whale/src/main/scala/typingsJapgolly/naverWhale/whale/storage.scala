...
object storage {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.naverWhale.naverWhaleStrings.TRUSTED_AND_UNTRUSTED_CONTEXTS
    - typingsJapgolly.naverWhale.naverWhaleStrings.TRUSTED_CONTEXTS
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.naverWhale.naverWhaleStrings.sync
    - typingsJapgolly.naverWhale.naverWhaleStrings.local
    - typingsJapgolly.naverWhale.naverWhaleStrings.managed
    - typingsJapgolly.naverWhale.naverWhaleStrings.session
  */
  trait AreaName extends StObject
  object AreaName {
    
    inline def local: typingsJapgolly.naverWhale.naverWhaleStrings.local = "local".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.local]
    
    inline def managed: typingsJapgolly.naverWhale.naverWhaleStrings.managed = "managed".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.managed]
    
    inline def session: typingsJapgolly.naverWhale.naverWhaleStrings.session = "session".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.session]
    
    inline def sync: typingsJapgolly.naverWhale.naverWhaleStrings.sync = "sync".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.sync]
  }
  
  @js.native
  trait LocalStorageArea
    extends StObject
       with typingsJapgolly.chrome.chrome.storage.StorageArea {
  ...
  trait StorageArea extends StObject {
    ...
    /**
      ...
      * Parameter items: Object with items in their key-value mappings.
      */
    var onChanged: typingsJapgolly.chrome.chrome.storage.StorageAreaChangedEvent = js.native
    ...
    /**
      ...
      * @since Chrome 102
      */
    def setAccessLevel(accessOptions: typingsJapgolly.chrome.anon.AccessLevel): js.Promise[Unit] = js.native
    /**
      * Sets the desired access level for the storage area. The default will be only trusted contexts.
      * @param accessOptions An object containing an accessLevel key which contains the access level of the storage area.
      * @param callback Optional.
      * @since Chrome 102
      */
    def setAccessLevel(accessOptions: typingsJapgolly.chrome.anon.AccessLevel, callback: js.Function0[Unit]): Unit = js.native
  ...
  type StorageAreaChangedEvent = Event[
    js.Function1[
      /* changes */ StringDictionary[typingsJapgolly.chrome.chrome.storage.StorageChange], 
      Unit
    ]
  ]
  ...
  type StorageChangedEvent = Event[
    js.Function2[
      /* changes */ StringDictionary[typingsJapgolly.chrome.chrome.storage.StorageChange], 
      /* areaName */ typingsJapgolly.chrome.chrome.storage.AreaName, 
      Unit
    ]
  ]
