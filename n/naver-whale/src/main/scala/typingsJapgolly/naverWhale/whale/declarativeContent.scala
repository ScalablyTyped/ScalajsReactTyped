...
object declarativeContent {
  ...
  trait PageStateMatcherProperties extends StObject {
    ...
    var pageUrl: js.UndefOr[typingsJapgolly.chrome.chrome.declarativeContent.PageStateUrlDetails] = js.undefined
  }
  object PageStateMatcherProperties {
    ...
    extension [Self <: PageStateMatcherProperties](x: Self) {
      ...
      inline def setPageUrl(value: typingsJapgolly.chrome.chrome.declarativeContent.PageStateUrlDetails): Self = StObject.set(x, "pageUrl", value.asInstanceOf[js.Any])
