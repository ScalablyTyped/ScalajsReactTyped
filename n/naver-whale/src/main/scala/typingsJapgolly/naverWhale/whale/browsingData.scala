...
object browsingData {
  ...
  trait RemovalOptions extends StObject {
    ...
    /**
      ...
      */
    var originTypes: js.UndefOr[typingsJapgolly.chrome.chrome.browsingData.OriginTypes] = js.undefined
  ...
  object RemovalOptions {
    ...
    extension [Self <: RemovalOptions](x: Self) {
      ...
      inline def setOriginTypes(value: typingsJapgolly.chrome.chrome.browsingData.OriginTypes): Self = StObject.set(x, "originTypes", value.asInstanceOf[js.Any])
  ...
  object SettingsResult {
    ...
    extension [Self <: SettingsResult](x: Self) {
      ...
      inline def setDataRemovalPermitted(value: typingsJapgolly.chrome.chrome.browsingData.DataTypeSet): Self = StObject.set(x, "dataRemovalPermitted", value.asInstanceOf[js.Any])
      
      inline def setDataToRemove(value: typingsJapgolly.chrome.chrome.browsingData.DataTypeSet): Self = StObject.set(x, "dataToRemove", value.asInstanceOf[js.Any])
      
      inline def setOptions(value: typingsJapgolly.chrome.chrome.browsingData.RemovalOptions): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
    }
  }
}
