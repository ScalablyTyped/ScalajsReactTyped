...
object windows {
  ...
  trait CreateData extends StObject {
    ...
    /**
      ...
      * @since Chrome 44.
      */
    var state: js.UndefOr[typingsJapgolly.chrome.chrome.windows.windowStateEnum] = js.undefined
    ...
    var `type`: js.UndefOr[typingsJapgolly.chrome.chrome.windows.createTypeEnum] = js.undefined
  ...
  object CreateData {
    ...
    extension [Self <: CreateData](x: Self) {
      ...
      inline def setState(value: typingsJapgolly.chrome.chrome.windows.windowStateEnum): Self = StObject.set(x, "state", value.asInstanceOf[js.Any])
      ...
      inline def setType(value: typingsJapgolly.chrome.chrome.windows.createTypeEnum): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  trait QueryOptions extends StObject {
    ...
    /**
      ...
      */
    var windowTypes: js.UndefOr[js.Array[typingsJapgolly.chrome.chrome.windows.windowTypeEnum]] = js.undefined
  }
  object QueryOptions {
    ...
    extension [Self <: QueryOptions](x: Self) {
      ...
      inline def setWindowTypes(value: js.Array[typingsJapgolly.chrome.chrome.windows.windowTypeEnum]): Self = StObject.set(x, "windowTypes", value.asInstanceOf[js.Any])
      
      inline def setWindowTypesUndefined: Self = StObject.set(x, "windowTypes", js.undefined)
      
      inline def setWindowTypesVarargs(value: typingsJapgolly.chrome.chrome.windows.windowTypeEnum*): Self = StObject.set(x, "windowTypes", js.Array(value*))
    }
  }
  ...
  trait Window extends StObject {
    ...
    /**
      ...
      */
    var `type`: js.UndefOr[typingsJapgolly.chrome.chrome.windows.windowTypeEnum] = js.undefined
  ...
  object Window {
    ...
    extension [Self <: Window](x: Self) {
      ...
      inline def setType(value: typingsJapgolly.chrome.chrome.windows.windowTypeEnum): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  trait WindowEventFilter extends StObject {
    ...
    /**
      ...
      */
    var windowTypes: js.Array[typingsJapgolly.chrome.chrome.windows.windowTypeEnum]
  }
  object WindowEventFilter {
    
    inline def apply(windowTypes: js.Array[typingsJapgolly.chrome.chrome.windows.windowTypeEnum]): WindowEventFilter = {
  ...
  trait WindowIdEvent
    ...
    def addListener(
      ...
      filters: typingsJapgolly.chrome.chrome.windows.WindowEventFilter
    ): Unit = js.native
  }
  ...
  trait WindowReferenceEvent
    extends StObject
       with Event[js.Function1[/* window */ typingsJapgolly.chrome.chrome.windows.Window, Unit]] {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.naverWhale.naverWhaleStrings.popup
    - typingsJapgolly.naverWhale.naverWhaleStrings.panel
  */
  ...
  object createTypeEnum {
    ...
    inline def panel: typingsJapgolly.naverWhale.naverWhaleStrings.panel = "panel".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.panel]
    
    inline def popup: typingsJapgolly.naverWhale.naverWhaleStrings.popup = "popup".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.popup]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.naverWhale.naverWhaleStrings.normal
    - typingsJapgolly.naverWhale.naverWhaleStrings.minimized
    - typingsJapgolly.naverWhale.naverWhaleStrings.maximized
    - typingsJapgolly.naverWhale.naverWhaleStrings.fullscreen
    - typingsJapgolly.naverWhale.naverWhaleStrings.`locked-fullscreen`
  */
  trait windowStateEnum extends StObject
  object windowStateEnum {
    
    inline def fullscreen: typingsJapgolly.naverWhale.naverWhaleStrings.fullscreen = "fullscreen".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.fullscreen]
    
    inline def `locked-fullscreen`: typingsJapgolly.naverWhale.naverWhaleStrings.`locked-fullscreen` = "locked-fullscreen".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.`locked-fullscreen`]
    
    inline def maximized: typingsJapgolly.naverWhale.naverWhaleStrings.maximized = "maximized".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.maximized]
    
    inline def minimized: typingsJapgolly.naverWhale.naverWhaleStrings.minimized = "minimized".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.minimized]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.naverWhale.naverWhaleStrings.popup
    - typingsJapgolly.naverWhale.naverWhaleStrings.panel
    - typingsJapgolly.naverWhale.naverWhaleStrings.app
    - typingsJapgolly.naverWhale.naverWhaleStrings.devtools
  */
  trait windowTypeEnum extends StObject
  object windowTypeEnum {
    
    inline def app: typingsJapgolly.naverWhale.naverWhaleStrings.app = "app".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.app]
    
    inline def devtools: typingsJapgolly.naverWhale.naverWhaleStrings.devtools = "devtools".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.devtools]
