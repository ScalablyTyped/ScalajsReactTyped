...
object devtools {
  ...
  object network {
    ...
    object Request {
      ...
      inline def apply(getContent: js.Function2[/* content */ String, /* encoding */ String, Unit] => Callback): Request = {
        val __obj = js.Dynamic.literal(getContent = js.Any.fromFunction1((t0: js.Function2[/* content */ String, /* encoding */ String, Unit]) => getContent(t0).runNow()))
        __obj.asInstanceOf[Request]
      }
      
      extension [Self <: Request](x: Self) {
        
        inline def setGetContent(value: js.Function2[/* content */ String, /* encoding */ String, Unit] => Callback): Self = StObject.set(x, "getContent", js.Any.fromFunction1((t0: js.Function2[/* content */ String, /* encoding */ String, Unit]) => value(t0).runNow()))
      }
    }
    
    type RequestFinishedEvent = Event[
        js.Function1[/* request */ typingsJapgolly.chrome.chrome.devtools.network.Request, Unit]
      ]
  }
  ...
  object panels {
    ...
    trait ElementsPanel extends StObject {
      ...
      def createSidebarPane(
        ...
        callback: js.Function1[
              /* result */ typingsJapgolly.chrome.chrome.devtools.panels.ExtensionSidebarPane, 
              Unit
            ]
      ): Unit = js.native
      
      /** Fired when an object is selected in the panel. */
      var onSelectionChanged: typingsJapgolly.chrome.chrome.devtools.panels.SelectionChangedEvent = js.native
    }
    ...
    object ExtensionPanel {
      ...
      inline def apply(
        createStatusBarButton: (String, String, Boolean) => typingsJapgolly.chrome.chrome.devtools.panels.Button,
      ...
      extension [Self <: ExtensionPanel](x: Self) {
        ...
        inline def setCreateStatusBarButton(value: (String, String, Boolean) => typingsJapgolly.chrome.chrome.devtools.panels.Button): Self = StObject.set(x, "createStatusBarButton", js.Any.fromFunction3(value))
        
        inline def setOnHidden(value: typingsJapgolly.chrome.chrome.devtools.panels.PanelHiddenEvent): Self = StObject.set(x, "onHidden", value.asInstanceOf[js.Any])
        
        inline def setOnSearch(value: typingsJapgolly.chrome.chrome.devtools.panels.PanelSearchEvent): Self = StObject.set(x, "onSearch", value.asInstanceOf[js.Any])
        
        inline def setOnShown(value: typingsJapgolly.chrome.chrome.devtools.panels.PanelShownEvent): Self = StObject.set(x, "onShown", value.asInstanceOf[js.Any])
      }
    }
    ...
    trait ExtensionSidebarPane extends StObject {
      ...
      var onHidden: typingsJapgolly.chrome.chrome.devtools.panels.ExtensionSidebarPaneHiddenEvent = js.native
      
      /** Fired when the sidebar pane becomes visible as a result of user switching to the panel that hosts it. */
      var onShown: typingsJapgolly.chrome.chrome.devtools.panels.ExtensionSidebarPaneShownEvent = js.native
    ...
    type PanelShownEvent = Event[js.Function1[/* window */ typingsJapgolly.chrome.Window, Unit]]
