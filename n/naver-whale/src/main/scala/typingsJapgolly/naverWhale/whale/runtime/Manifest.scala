...
object Manifest {
  ...
  def apply(
    ...
    browser_action: typingsJapgolly.chrome.chrome.runtime.ManifestAction = null,
    ...
    icons: typingsJapgolly.chrome.chrome.runtime.ManifestIcons = null,
    ...
    page_action: typingsJapgolly.chrome.chrome.runtime.ManifestAction = null,
