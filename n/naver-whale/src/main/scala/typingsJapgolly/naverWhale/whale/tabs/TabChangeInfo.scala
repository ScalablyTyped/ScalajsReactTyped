...
trait TabChangeInfo extends StObject {
  ...
  /**
    ...
    */
  var mutedInfo: js.UndefOr[typingsJapgolly.chrome.chrome.tabs.MutedInfo] = js.undefined
...
object TabChangeInfo {
  ...
  extension [Self <: TabChangeInfo](x: Self) {
    ...
    inline def setMutedInfo(value: typingsJapgolly.chrome.chrome.tabs.MutedInfo): Self = StObject.set(x, "mutedInfo", value.asInstanceOf[js.Any])
