...
import typingsJapgolly.chrome.anon.Acceptstlschannelid
import typingsJapgolly.chrome.anon.Actions
import typingsJapgolly.chrome.anon.Allframes
import typingsJapgolly.chrome.anon.Bookmarks
import typingsJapgolly.chrome.anon.Bookmarksui
import typingsJapgolly.chrome.anon.Chromestyle
import typingsJapgolly.chrome.anon.Clientid
import typingsJapgolly.chrome.anon.Configurable
import typingsJapgolly.chrome.anon.Contentsecuritypolicy
import typingsJapgolly.chrome.anon.Defaulttitle
import typingsJapgolly.chrome.anon.Description
import typingsJapgolly.chrome.anon.Dictionaryformat
import typingsJapgolly.chrome.anon.Homepage
import typingsJapgolly.chrome.anon.Id
import typingsJapgolly.chrome.anon.Indicator
import typingsJapgolly.chrome.anon.Keyword
import typingsJapgolly.chrome.anon.Managedschema
import typingsJapgolly.chrome.anon.Matches
import typingsJapgolly.chrome.anon.Mimetype
import typingsJapgolly.chrome.anon.Naclarch
import typingsJapgolly.chrome.anon.Path
import typingsJapgolly.chrome.anon.Voices
import typingsJapgolly.chrome.anon.Whitelist
import typingsJapgolly.chrome.anon.`3D`
...
trait ManifestBase
  ...
  var icons: js.UndefOr[typingsJapgolly.chrome.chrome.runtime.ManifestIcons] = js.undefined
...
object ManifestBase {
  ...
  extension [Self <: ManifestBase](x: Self) {
    ...
    inline def setIcons(value: typingsJapgolly.chrome.chrome.runtime.ManifestIcons): Self = StObject.set(x, "icons", value.asInstanceOf[js.Any])
