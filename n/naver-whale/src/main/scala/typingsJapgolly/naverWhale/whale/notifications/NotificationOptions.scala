...
trait NotificationOptions extends js.Object {
  ...
  var buttons: js.UndefOr[js.Array[typingsJapgolly.chrome.chrome.notifications.ButtonOptions]] = js.undefined
  /**
    * Optional.
  ...
  var items: js.UndefOr[js.Array[typingsJapgolly.chrome.chrome.notifications.ItemOptions]] = js.undefined
...
object NotificationOptions {
  ...
  def apply(
    ...
    buttons: js.Array[typingsJapgolly.chrome.chrome.notifications.ButtonOptions] = null,
    contextMessage: String = null,
    eventTime: Int | Double = null,
    iconUrl: String = null,
    imageUrl: String = null,
    isClickable: js.UndefOr[Boolean] = js.undefined,
    items: js.Array[typingsJapgolly.chrome.chrome.notifications.ItemOptions] = null,
    message: String = null,
