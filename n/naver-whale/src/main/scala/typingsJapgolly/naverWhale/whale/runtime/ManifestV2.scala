...
import typingsJapgolly.chrome.anon.Page
import typingsJapgolly.naverWhale.naverWhaleInts.`2`
...
trait ManifestV2
  ...
  // Pick one (or none)
  var browser_action: js.UndefOr[typingsJapgolly.chrome.chrome.runtime.ManifestAction] = js.undefined
  ...
  var page_action: js.UndefOr[typingsJapgolly.chrome.chrome.runtime.ManifestAction] = js.undefined
...
object ManifestV2 {
  ...
  extension [Self <: ManifestV2](x: Self) {
    ...
    inline def setBrowser_action(value: typingsJapgolly.chrome.chrome.runtime.ManifestAction): Self = StObject.set(x, "browser_action", value.asInstanceOf[js.Any])
    ...
    inline def setPage_action(value: typingsJapgolly.chrome.chrome.runtime.ManifestAction): Self = StObject.set(x, "page_action", value.asInstanceOf[js.Any])
