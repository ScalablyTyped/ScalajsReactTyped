...
object CreateProperties {
  ...
  def apply(
    ...
    id: String = null,
    onclick: (/* info */ typingsJapgolly.chrome.chrome.contextMenus.OnClickData, /* tab */ Tab) => Callback = null,
    ...
    if (onclick != null) __obj.updateDynamic("onclick")(js.Any.fromFunction2((t0: /* info */ typingsJapgolly.chrome.chrome.contextMenus.OnClickData, t1: /* tab */ typingsJapgolly.chrome.chrome.tabs.Tab) => onclick(t0, t1).runNow()))
