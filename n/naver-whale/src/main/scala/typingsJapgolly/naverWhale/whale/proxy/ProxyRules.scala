...
object ProxyRules {
  ...
  def apply(
    ...
    fallbackProxy: typingsJapgolly.chrome.chrome.proxy.ProxyServer = null,
    proxyForFtp: typingsJapgolly.chrome.chrome.proxy.ProxyServer = null,
    proxyForHttp: typingsJapgolly.chrome.chrome.proxy.ProxyServer = null,
    proxyForHttps: typingsJapgolly.chrome.chrome.proxy.ProxyServer = null,
    singleProxy: typingsJapgolly.chrome.chrome.proxy.ProxyServer = null
  ): ProxyRules = {
