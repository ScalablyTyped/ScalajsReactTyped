...
object omnibox {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.naverWhale.naverWhaleStrings.currentTab
    - typingsJapgolly.naverWhale.naverWhaleStrings.newForegroundTab
    - typingsJapgolly.naverWhale.naverWhaleStrings.newBackgroundTab
  */
  trait OnInputEnteredDisposition extends StObject
  object OnInputEnteredDisposition {
    
    inline def currentTab: typingsJapgolly.naverWhale.naverWhaleStrings.currentTab = "currentTab".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.currentTab]
    
    inline def newBackgroundTab: typingsJapgolly.naverWhale.naverWhaleStrings.newBackgroundTab = "newBackgroundTab".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.newBackgroundTab]
    
    inline def newForegroundTab: typingsJapgolly.naverWhale.naverWhaleStrings.newForegroundTab = "newForegroundTab".asInstanceOf[typingsJapgolly.naverWhale.naverWhaleStrings.newForegroundTab]
  }
