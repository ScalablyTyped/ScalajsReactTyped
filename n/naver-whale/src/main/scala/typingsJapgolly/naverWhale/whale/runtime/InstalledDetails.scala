...
trait InstalledDetails extends StObject {
  ...
  /**
    ...
    */
  var reason: typingsJapgolly.chrome.chrome.runtime.OnInstalledReason
}
object InstalledDetails {
  
  inline def apply(reason: typingsJapgolly.chrome.chrome.runtime.OnInstalledReason): InstalledDetails = {
  ...
  extension [Self <: InstalledDetails](x: Self) {
    ...
    inline def setReason(value: typingsJapgolly.chrome.chrome.runtime.OnInstalledReason): Self = StObject.set(x, "reason", value.asInstanceOf[js.Any])
  }
}
