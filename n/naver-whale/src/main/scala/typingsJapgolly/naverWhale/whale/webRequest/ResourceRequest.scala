...
trait ResourceRequest extends StObject {
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.chrome.chrome.webRequest.ResourceType
...
object ResourceRequest {
  ...
  extension [Self <: ResourceRequest](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.chrome.chrome.webRequest.ResourceType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
