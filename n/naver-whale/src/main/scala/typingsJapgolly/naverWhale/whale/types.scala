...
import typingsJapgolly.naverWhale.naverWhaleStrings.controllable_by_this_extension
import typingsJapgolly.naverWhale.naverWhaleStrings.controlled_by_other_extensions
import typingsJapgolly.naverWhale.naverWhaleStrings.controlled_by_this_extension
import typingsJapgolly.naverWhale.naverWhaleStrings.not_controllable
...
object types {
  ...
  type ChromeSettingChangedEvent = Event[typingsJapgolly.chrome.chrome.types.DetailsCallback]
  ...
  trait ChromeSettingClearDetails extends StObject {
    ...
    /**
      ...
      */
    var scope: js.UndefOr[typingsJapgolly.chrome.chrome.types.settingsScope] = js.undefined
  }
  object ChromeSettingClearDetails {
    ...
    extension [Self <: ChromeSettingClearDetails](x: Self) {
      ...
      inline def setScope(value: typingsJapgolly.chrome.chrome.types.settingsScope): Self = StObject.set(x, "scope", value.asInstanceOf[js.Any])
  ...
  trait ChromeSettingSetDetails
    extends StObject
       with typingsJapgolly.chrome.chrome.types.ChromeSettingClearDetails {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.naverWhale.naverWhaleStrings.regular
    - typingsJapgolly.naverWhale.naverWhaleStrings.regular_only
    - typingsJapgolly.naverWhale.naverWhaleStrings.incognito_persistent
    - typingsJapgolly.naverWhale.naverWhaleStrings.incognito_session_only
    - scala.Unit
  */
