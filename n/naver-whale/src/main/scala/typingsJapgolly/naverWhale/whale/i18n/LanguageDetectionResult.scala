package typingsJapgolly.naverWhale.whale.i18n
...
trait LanguageDetectionResult extends js.Object {
  ...
  var languages: js.Array[typingsJapgolly.chrome.chrome.i18n.DetectedLanguage]
}

object LanguageDetectionResult {
  @scala.inline
  def apply(isReliable: Boolean, languages: js.Array[typingsJapgolly.chrome.chrome.i18n.DetectedLanguage]): LanguageDetectionResult = {
