...
object BlockingResponse {
  ...
  extension [Self <: BlockingResponse](x: Self) {
    ...
    inline def setAuthCredentials(value: typingsJapgolly.chrome.chrome.webRequest.AuthCredentials): Self = StObject.set(x, "authCredentials", value.asInstanceOf[js.Any])
    ...
    inline def setResponseHeaders(value: js.Array[typingsJapgolly.chrome.chrome.webRequest.HttpHeader]): Self = StObject.set(x, "responseHeaders", value.asInstanceOf[js.Any])
    
    inline def setResponseHeadersUndefined: Self = StObject.set(x, "responseHeaders", js.undefined)
    
    inline def setResponseHeadersVarargs(value: typingsJapgolly.chrome.chrome.webRequest.HttpHeader*): Self = StObject.set(x, "responseHeaders", js.Array(value*))
  }
}
