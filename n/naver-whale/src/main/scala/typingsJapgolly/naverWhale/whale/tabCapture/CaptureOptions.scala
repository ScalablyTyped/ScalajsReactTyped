package typingsJapgolly.naverWhale.whale.tabCapture
...
trait CaptureOptions extends js.Object {
  ...
  /** Optional. */
  var audioConstraints: js.UndefOr[typingsJapgolly.chrome.chrome.tabCapture.MediaStreamConstraint] = js.undefined
  /** Optional. */
  var video: js.UndefOr[Boolean] = js.undefined
  /** Optional. */
  var videoConstraints: js.UndefOr[typingsJapgolly.chrome.chrome.tabCapture.MediaStreamConstraint] = js.undefined
}
...
object CaptureOptions {
  ...
  def apply(
    ...
    audioConstraints: typingsJapgolly.chrome.chrome.tabCapture.MediaStreamConstraint = null,
    video: js.UndefOr[Boolean] = js.undefined,
    videoConstraints: typingsJapgolly.chrome.chrome.tabCapture.MediaStreamConstraint = null
  ): CaptureOptions = {
