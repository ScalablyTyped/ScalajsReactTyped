...
import typingsJapgolly.chrome.chrome.webRequest.RequestFilter
...
object events {
  ...
  trait BaseEvent[T /* <: js.Function */] extends StObject {
    ...
    /**
      ...
      */
    def addRules(rules: js.Array[typingsJapgolly.chrome.chrome.events.Rule]): Unit = js.native
    def addRules(
      rules: js.Array[typingsJapgolly.chrome.chrome.events.Rule],
      callback: js.Function1[/* rules */ js.Array[typingsJapgolly.chrome.chrome.events.Rule], Unit]
    ): Unit = js.native
    ...
    /**
      ...
      * Parameter rules: Rules that were registered, the optional parameters are filled with values.
      */
    def getRules(callback: js.Function1[/* rules */ js.Array[typingsJapgolly.chrome.chrome.events.Rule], Unit]): Unit = js.native
    /**
      * Returns currently registered rules.
  ...
  trait Event[T /* <: js.Function */]
    extends StObject
       with typingsJapgolly.chrome.chrome.events.BaseEvent[T]
