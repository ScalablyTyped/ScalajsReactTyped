...
import typingsJapgolly.naverWhale.whale.contentSettings.DefaultContentSettingDetails
import typingsJapgolly.naverWhale.whale.contentSettings.ScopeEnum
import typingsJapgolly.naverWhale.whale.contextMenus.ContextItemType
import typingsJapgolly.naverWhale.whale.contextMenus.ContextType
import typingsJapgolly.naverWhale.whale.cookies.SameSiteStatus
import typingsJapgolly.naverWhale.whale.idle.IdleState
import typingsJapgolly.naverWhale.whale.notifications.TemplateType
import typingsJapgolly.naverWhale.whale.omnibox.OnInputEnteredDisposition
import typingsJapgolly.naverWhale.whale.runtime.ManifestPermissions
import typingsJapgolly.naverWhale.whale.runtime.PlatformArch
import typingsJapgolly.naverWhale.whale.runtime.PlatformNaclArch
import typingsJapgolly.naverWhale.whale.runtime.PlatformOs
import typingsJapgolly.naverWhale.whale.runtime.RequestUpdateCheckStatus
import typingsJapgolly.naverWhale.whale.storage.AccessLevel
import typingsJapgolly.naverWhale.whale.storage.AreaName
import typingsJapgolly.naverWhale.whale.types._settingsScope
import typingsJapgolly.naverWhale.whale.webRequest.ResourceType
import typingsJapgolly.naverWhale.whale.windows.createTypeEnum
import typingsJapgolly.naverWhale.whale.windows.windowStateEnum
import typingsJapgolly.naverWhale.whale.windows.windowTypeEnum
