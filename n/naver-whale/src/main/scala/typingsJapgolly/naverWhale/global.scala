  ...
  object whale {
    ...
    object runtime {
      ...
      object OnInstalledReason extends StObject {
        ...
        @JSBracketAccess
        def apply(value: String): js.UndefOr[typingsJapgolly.naverWhale.whale.runtime.OnInstalledReason & String] = js.native
        
        /* "chrome_update" */ val CHROME_UPDATE: typingsJapgolly.naverWhale.whale.runtime.OnInstalledReason.CHROME_UPDATE & String = js.native
        
        /* "install" */ val INSTALL: typingsJapgolly.naverWhale.whale.runtime.OnInstalledReason.INSTALL & String = js.native
        
        /* "shared_module_update" */ val SHARED_MODULE_UPDATE: typingsJapgolly.naverWhale.whale.runtime.OnInstalledReason.SHARED_MODULE_UPDATE & String = js.native
        
        /* "update" */ val UPDATE: typingsJapgolly.naverWhale.whale.runtime.OnInstalledReason.UPDATE & String = js.native
      }
    }
