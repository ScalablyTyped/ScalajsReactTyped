...
import typingsJapgolly.nofilter.anon.Data
...
object mod {
  ...
  trait NoFilterOptions extends StObject {
    ...
    /**
      * Input source data.
      */
    var input: js.UndefOr[String | typingsJapgolly.node.bufferMod.global.Buffer] = js.undefined
  ...
  object NoFilterOptions {
    ...
    extension [Self <: NoFilterOptions](x: Self) {
      ...
      inline def setInput(value: String | typingsJapgolly.node.bufferMod.global.Buffer): Self = StObject.set(x, "input", value.asInstanceOf[js.Any])
