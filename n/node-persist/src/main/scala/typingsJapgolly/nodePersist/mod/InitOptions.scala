...
object InitOptions {
  ...
  def apply(
    ...
    parse: /* str */ String => CallbackTo[js.Any] = null,
    stringify: /* data */ js.Any => CallbackTo[String] = null,
    ttl: Int | Double = null
  ): InitOptions = {
    ...
    if (parse != null) __obj.updateDynamic("parse")(js.Any.fromFunction1((t0: /* str */ java.lang.String) => parse(t0).runNow()))
    if (stringify != null) __obj.updateDynamic("stringify")(js.Any.fromFunction1((t0: /* data */ js.Any) => stringify(t0).runNow()))
