...
object ResponsiveVoronoi {
  
  inline def apply(data: js.Array[VoronoiDatum]): Builder = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[ResponsiveVoronoiProps]))
  }
  
  @JSImport("@nivo/voronoi", "ResponsiveVoronoi")
  @js.native
  ...
  def withProps(p: ResponsiveVoronoiProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
