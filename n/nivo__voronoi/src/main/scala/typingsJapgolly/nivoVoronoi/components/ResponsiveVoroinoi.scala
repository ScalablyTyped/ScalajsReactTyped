...
object ResponsiveVoroinoi {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[VoronoiProps, typingsJapgolly.nivoVoronoi.mod.ResponsiveVoroinoi, Unit, VoronoiProps] = {
  ...
  typingsJapgolly.nivoVoronoi.mod.VoronoiProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoVoronoi.mod.ResponsiveVoroinoi](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoVoronoi.mod.VoronoiProps])(children: _*)
  }
