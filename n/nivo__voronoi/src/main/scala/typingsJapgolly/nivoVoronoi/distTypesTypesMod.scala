...
object distTypesTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nivoVoronoi.nivoVoronoiStrings.links
    - typingsJapgolly.nivoVoronoi.nivoVoronoiStrings.cells
    - typingsJapgolly.nivoVoronoi.nivoVoronoiStrings.points
    - typingsJapgolly.nivoVoronoi.nivoVoronoiStrings.bounds
  */
  trait VoronoiLayerId extends StObject
  object VoronoiLayerId {
    
    inline def bounds: typingsJapgolly.nivoVoronoi.nivoVoronoiStrings.bounds = "bounds".asInstanceOf[typingsJapgolly.nivoVoronoi.nivoVoronoiStrings.bounds]
    
    inline def cells: typingsJapgolly.nivoVoronoi.nivoVoronoiStrings.cells = "cells".asInstanceOf[typingsJapgolly.nivoVoronoi.nivoVoronoiStrings.cells]
    
    inline def links: typingsJapgolly.nivoVoronoi.nivoVoronoiStrings.links = "links".asInstanceOf[typingsJapgolly.nivoVoronoi.nivoVoronoiStrings.links]
    
    inline def points: typingsJapgolly.nivoVoronoi.nivoVoronoiStrings.points = "points".asInstanceOf[typingsJapgolly.nivoVoronoi.nivoVoronoiStrings.points]
  }
