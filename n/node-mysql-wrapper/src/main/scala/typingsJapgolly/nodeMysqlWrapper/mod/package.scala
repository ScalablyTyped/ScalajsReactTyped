...
import typingsJapgolly.nodeMysqlWrapper.mod.^
...
/** For meteor js only
  ...
  */
inline def connect(mysqlUrlOrObjectOrMysqlAlreadyConnection: typingsJapgolly.mysql.mod.Connection, useTables: Any*): Database = ^.asInstanceOf[js.Dynamic].applyDynamic("connect")(scala.List(mysqlUrlOrObjectOrMysqlAlreadyConnection.asInstanceOf[js.Any]).`++`(useTables.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Database]
...
inline def wrap(mysqlUrlOrObjectOrMysqlAlreadyConnection: typingsJapgolly.mysql.mod.Connection, useTables: Any*): Database = ^.asInstanceOf[js.Dynamic].applyDynamic("wrap")(scala.List(mysqlUrlOrObjectOrMysqlAlreadyConnection.asInstanceOf[js.Any]).`++`(useTables.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Database]
