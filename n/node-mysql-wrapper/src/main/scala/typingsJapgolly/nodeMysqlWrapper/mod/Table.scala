...
class Table[T] protected () extends js.Object {
  ...
  def findSingle(criteriaRawJsObject: js.Any): typingsJapgolly.bluebird.mod.^[T] = js.native
  def findSingle(criteriaRawJsObject: js.Any, callback: js.Function1[/* _result */ T, _]): typingsJapgolly.bluebird.mod.^[T] = js.native
  /**
  ...
  def remove(criteriaRawObject: js.Any): typingsJapgolly.bluebird.mod.^[DeleteAnswer] = js.native
  def remove(id: String): typingsJapgolly.bluebird.mod.^[DeleteAnswer] = js.native
  def remove(id: Double): typingsJapgolly.bluebird.mod.^[DeleteAnswer] = js.native
  /**
  ...
  def save(criteriaRawJsObject: js.Any): typingsJapgolly.bluebird.mod.^[_] = js.native
  def save(criteriaRawJsObject: js.Any, callback: js.Function1[/* _result */ js.Any, _]): typingsJapgolly.bluebird.mod.^[_] = js.native
}
