...
open class Table[T] protected () extends StObject {
  ...
  def findSingle(criteriaRawJsObject: Any): typingsJapgolly.bluebird.mod.^[T] = js.native
  def findSingle(criteriaRawJsObject: Any, callback: js.Function1[/* _result */ T, Any]): typingsJapgolly.bluebird.mod.^[T] = js.native
  ...
  def remove(criteriaRawObject: Any): typingsJapgolly.bluebird.mod.^[DeleteAnswer] = js.native
  ...
  def save(criteriaRawJsObject: Any): typingsJapgolly.bluebird.mod.^[Any] = js.native
  def save(criteriaRawJsObject: Any, callback: js.Function1[/* _result */ Any, Any]): typingsJapgolly.bluebird.mod.^[Any] = js.native
}
