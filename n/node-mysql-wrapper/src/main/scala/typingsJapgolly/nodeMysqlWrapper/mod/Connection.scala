...
class Connection protected () extends EventEmitter {
  ...
  def this(connection: typingsJapgolly.mysql.mod.Connection) = this()
  def this(connection: ConnectionConfig) = this()
  /**
    * The real database connection socket.
    */
  var connection: typingsJapgolly.mysql.mod.Connection = js.native
  /**
  ...
  /**
    ...
    * @return {nothing}
    */
  def attach(connection: typingsJapgolly.mysql.mod.Connection): Unit = js.native
  /**
    * Clear all binary logs from the whole database.
    * When finish returns a promise, use it with .then(function(){});
    * @return Promise
    */
  def clearBinaryLogs(): typingsJapgolly.bluebird.mod.^[Unit] = js.native
  /**
  ...
  def create(connection: typingsJapgolly.mysql.mod.Connection): Unit = js.native
  ...
  /**
    ...
    * @return {Promise}
    */
  def fetchDatabaseInformation(): typingsJapgolly.bluebird.mod.^[Unit] = js.native
  /**
    ...
    * @return {Promise}
    */
  def link(): typingsJapgolly.bluebird.mod.^[Unit] = js.native
  def link(readyCallback: js.Function0[Unit]): typingsJapgolly.bluebird.mod.^[Unit] = js.native
  /**
