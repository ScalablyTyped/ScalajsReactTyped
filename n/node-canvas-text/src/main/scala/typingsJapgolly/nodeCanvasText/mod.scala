package typingsJapgolly.nodeCanvasText

import org.scalajs.dom.CanvasRenderingContext2D
import typingsJapgolly.nodeCanvasText.anon.PartialDrawOptions
import typingsJapgolly.nodeCanvasText.nodeCanvasTextStrings.baseline
import typingsJapgolly.nodeCanvasText.nodeCanvasTextStrings.bottom
import typingsJapgolly.nodeCanvasText.nodeCanvasTextStrings.box
import typingsJapgolly.nodeCanvasText.nodeCanvasTextStrings.center
import typingsJapgolly.nodeCanvasText.nodeCanvasTextStrings.left
import typingsJapgolly.nodeCanvasText.nodeCanvasTextStrings.right
import typingsJapgolly.nodeCanvasText.nodeCanvasTextStrings.top
...
object mod {
  ...
  object DrawRectangle {
    ...
    extension [Self <: DrawRectangle](x: Self) {
