...
import typingsJapgolly.awsSdk.kmsMod.ClientConfiguration
...
trait CredstashConfig extends js.Object {
  ...
  var dynamoOpts: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.ClientConfiguration] = js.undefined
...
object CredstashConfig {
  ...
  def apply(
    ...
    dynamoOpts: typingsJapgolly.awsSdk.dynamodbMod.ClientConfiguration = null,
    kmsKey: String = null,
