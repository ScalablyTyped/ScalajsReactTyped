...
import typingsJapgolly.awsSdk.clientsKmsMod.ClientConfiguration
import typingsJapgolly.awsSdk.clientsKmsMod.DecryptResponse
import typingsJapgolly.awsSdk.libDynamodbDocumentClientMod.DocumentClient.DeleteItemOutput
import typingsJapgolly.awsSdk.libDynamodbDocumentClientMod.DocumentClient.PutItemOutput
import typingsJapgolly.nodecredstash.anon.Context
import typingsJapgolly.nodecredstash.anon.Key
import typingsJapgolly.nodecredstash.anon.Name
import typingsJapgolly.nodecredstash.anon.NameVersion
import typingsJapgolly.nodecredstash.anon.Secret
import typingsJapgolly.nodecredstash.anon.StartsWith
import typingsJapgolly.nodecredstash.anon.Version
...
object mod {
  ...
  trait CredstashConfig extends StObject {
    ...
    var dynamoOpts: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.ClientConfiguration] = js.undefined
  ...
  object CredstashConfig {
    ...
    extension [Self <: CredstashConfig](x: Self) {
      ...
      inline def setDynamoOpts(value: typingsJapgolly.awsSdk.clientsDynamodbMod.ClientConfiguration): Self = StObject.set(x, "dynamoOpts", value.asInstanceOf[js.Any])
