...
object mod {
  ...
  */
  ...
  object Format {
    ...
    inline def deflate: typingsJapgolly.nodeZopfliEs.nodeZopfliEsStrings.deflate = "deflate".asInstanceOf[typingsJapgolly.nodeZopfliEs.nodeZopfliEsStrings.deflate]
    
    inline def gzip: typingsJapgolly.nodeZopfliEs.nodeZopfliEsStrings.gzip = "gzip".asInstanceOf[typingsJapgolly.nodeZopfliEs.nodeZopfliEsStrings.gzip]
    
    inline def zlib: typingsJapgolly.nodeZopfliEs.nodeZopfliEsStrings.zlib = "zlib".asInstanceOf[typingsJapgolly.nodeZopfliEs.nodeZopfliEsStrings.zlib]
  }
