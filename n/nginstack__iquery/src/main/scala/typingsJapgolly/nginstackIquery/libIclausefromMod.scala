...
object libIclausefromMod {
  ...
  inline def apply(iQuery: typingsJapgolly.nginstackIquery.libIqueryMod.^, classKey: Double, alias: String): Unit = (^.asInstanceOf[js.Dynamic].apply(iQuery.asInstanceOf[js.Any], classKey.asInstanceOf[js.Any], alias.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ protected ()
    extends StObject
       with IClauseFrom {
    def this(iQuery: typingsJapgolly.nginstackIquery.libIqueryMod.^, classKey: Double, alias: String) = this()
  }
  @JSImport("@nginstack/iquery/lib/IClauseFrom", JSImport.Namespace)
  @js.native
  ...
  trait IClauseFrom extends StObject {
    ...
    var iQuery: typingsJapgolly.nginstackIquery.libIqueryMod.^ = js.native
