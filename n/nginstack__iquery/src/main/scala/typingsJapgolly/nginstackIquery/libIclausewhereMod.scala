...
object libIclausewhereMod {
  ...
  trait IClauseWhere extends StObject {
    ...
    var iQuery: typingsJapgolly.nginstackIquery.libIqueryMod.^
  ...
  object IClauseWhere {
    ...
    inline def apply(
      ...
      fieldType: String,
      formatValue: Any,
      getIsGenerable: CallbackTo[Boolean],
      getValueIsNull: CallbackTo[Boolean],
      hasClassField: Boolean,
      iQuery: typingsJapgolly.nginstackIquery.libIqueryMod.^,
      isInJoinClause: Any,
      isSubSelect: Boolean,
      likeMode: String,
      operator: String,
    ...
    extension [Self <: IClauseWhere](x: Self) {
      ...
      inline def setGetIsGenerable(value: CallbackTo[Boolean]): Self = StObject.set(x, "getIsGenerable", value.toJsFn)
      
      inline def setGetValueIsNull(value: CallbackTo[Boolean]): Self = StObject.set(x, "getValueIsNull", value.toJsFn)
      
      inline def setHasClassField(value: Boolean): Self = StObject.set(x, "hasClassField", value.asInstanceOf[js.Any])
      
      inline def setIQuery(value: typingsJapgolly.nginstackIquery.libIqueryMod.^): Self = StObject.set(x, "iQuery", value.asInstanceOf[js.Any])
