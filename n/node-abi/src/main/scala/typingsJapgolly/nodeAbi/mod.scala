...
object mod {
  ...
  */
  ...
  object Runtime {
    ...
    inline def electron: typingsJapgolly.nodeAbi.nodeAbiStrings.electron = "electron".asInstanceOf[typingsJapgolly.nodeAbi.nodeAbiStrings.electron]
    
    inline def node: typingsJapgolly.nodeAbi.nodeAbiStrings.node = "node".asInstanceOf[typingsJapgolly.nodeAbi.nodeAbiStrings.node]
    
    inline def `node-webkit`: typingsJapgolly.nodeAbi.nodeAbiStrings.`node-webkit` = "node-webkit".asInstanceOf[typingsJapgolly.nodeAbi.nodeAbiStrings.`node-webkit`]
  }
