package typingsJapgolly.neverbounce

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.neverbounce.anon.Academichost
import typingsJapgolly.neverbounce.anon.Complete
import typingsJapgolly.neverbounce.anon.ContentType
import typingsJapgolly.neverbounce.anon.Remote
...
object mod {
  ...
  trait Account extends StObject {
    ...
    def info(): js.Promise[org.scalajs.dom.Response]
  }
  object Account {
    
    inline def apply(info: CallbackTo[js.Promise[org.scalajs.dom.Response]]): Account = {
      val __obj = js.Dynamic.literal(info = info.toJsFn)
      __obj.asInstanceOf[Account]
    }
    
    extension [Self <: Account](x: Self) {
      
      inline def setInfo(value: CallbackTo[js.Promise[org.scalajs.dom.Response]]): Self = StObject.set(x, "info", value.toJsFn)
    }
  }
  ...
  trait Jobs extends StObject {
    ...
    def create(input: Any, inputLocation: Any, fileName: Any): js.Promise[org.scalajs.dom.Response] = js.native
    def create(input: Any, inputLocation: Any, fileName: Any, runSample: Any): js.Promise[org.scalajs.dom.Response] = js.native
    def create(input: Any, inputLocation: Any, fileName: Any, runSample: Any, autoParse: Any): js.Promise[org.scalajs.dom.Response] = js.native
    def create(input: Any, inputLocation: Any, fileName: Any, runSample: Any, autoParse: Any, autoStart: Any): js.Promise[org.scalajs.dom.Response] = js.native
    def create(input: Any, inputLocation: Any, fileName: Any, runSample: Any, autoParse: Unit, autoStart: Any): js.Promise[org.scalajs.dom.Response] = js.native
    def create(input: Any, inputLocation: Any, fileName: Any, runSample: Unit, autoParse: Any): js.Promise[org.scalajs.dom.Response] = js.native
    def create(input: Any, inputLocation: Any, fileName: Any, runSample: Unit, autoParse: Any, autoStart: Any): js.Promise[org.scalajs.dom.Response] = js.native
    def create(input: Any, inputLocation: Any, fileName: Any, runSample: Unit, autoParse: Unit, autoStart: Any): js.Promise[org.scalajs.dom.Response] = js.native
    
    def download(jobId: Double): js.Promise[org.scalajs.dom.Response] = js.native
    
    def parse(jobId: Double): js.Promise[org.scalajs.dom.Response] = js.native
    def parse(jobId: Double, autoStart: Any): js.Promise[org.scalajs.dom.Response] = js.native
    
    def results(jobId: Double, query: Any): js.Promise[org.scalajs.dom.Response] = js.native
    
    def search(query: Any): js.Promise[org.scalajs.dom.Response] = js.native
    
    def start(jobId: Double): js.Promise[org.scalajs.dom.Response] = js.native
    def start(jobId: Double, runSample: Any): js.Promise[org.scalajs.dom.Response] = js.native
    
    def status(jobId: Double): js.Promise[org.scalajs.dom.Response] = js.native
  }
  ...
  object NeverBounce {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account = account.asInstanceOf[js.Any], errors = errors.asInstanceOf[js.Any], getConfig = getConfig.toJsFn, getRequestOpts = js.Any.fromFunction1(getRequestOpts), jobs = jobs.asInstanceOf[js.Any], poe = poe.asInstanceOf[js.Any], setApiKey = js.Any.fromFunction1((t0: String) => setApiKey(t0).runNow()), setHost = js.Any.fromFunction1((t0: String) => setHost(t0).runNow()), single = single.asInstanceOf[js.Any])
    ...
    extension [Self <: NeverBounce](x: Self) {
      ...
      inline def setSetHost(value: String => Callback): Self = StObject.set(x, "setHost", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
  ...
  trait Poe extends StObject {
    ...
    def confirm(email: String, result: String, confirmationToken: String, transactionId: String): js.Promise[org.scalajs.dom.Response]
  }
  object Poe {
    
    inline def apply(confirm: (String, String, String, String) => js.Promise[org.scalajs.dom.Response]): Poe = {
    ...
    extension [Self <: Poe](x: Self) {
      ...
      inline def setConfirm(value: (String, String, String, String) => js.Promise[org.scalajs.dom.Response]): Self = StObject.set(x, "confirm", js.Any.fromFunction4(value))
    }
  }
  ...
  trait Single extends StObject {
    ...
    def check(email: String): js.Promise[org.scalajs.dom.Response] = js.native
    def check(email: String, addressInfo: Boolean): js.Promise[org.scalajs.dom.Response] = js.native
    def check(email: String, addressInfo: Boolean, creditsInfo: Boolean): js.Promise[org.scalajs.dom.Response] = js.native
    def check(email: String, addressInfo: Boolean, creditsInfo: Boolean, timeout: Any): js.Promise[org.scalajs.dom.Response] = js.native
    def check(email: String, addressInfo: Boolean, creditsInfo: Unit, timeout: Any): js.Promise[org.scalajs.dom.Response] = js.native
    def check(email: String, addressInfo: Unit, creditsInfo: Boolean): js.Promise[org.scalajs.dom.Response] = js.native
    def check(email: String, addressInfo: Unit, creditsInfo: Boolean, timeout: Any): js.Promise[org.scalajs.dom.Response] = js.native
    def check(email: String, addressInfo: Unit, creditsInfo: Unit, timeout: Any): js.Promise[org.scalajs.dom.Response] = js.native
  }
}
