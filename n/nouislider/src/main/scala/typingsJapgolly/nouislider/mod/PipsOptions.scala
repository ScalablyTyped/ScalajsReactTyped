...
import typingsJapgolly.nouislider.nouisliderStrings.count
import typingsJapgolly.nouislider.nouisliderStrings.positions
import typingsJapgolly.nouislider.nouisliderStrings.range
import typingsJapgolly.nouislider.nouisliderStrings.steps
import typingsJapgolly.nouislider.nouisliderStrings.values
...
object PipsOptions {
  ...
  def apply(
    ...
    filter: /* repeated */ js.Any => CallbackTo[PipFilterResult] = null,
