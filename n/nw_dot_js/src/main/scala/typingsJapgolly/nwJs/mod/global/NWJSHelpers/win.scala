...
import typingsJapgolly.nwJs.nwJsStrings.`devtools-closed`
import typingsJapgolly.nwJs.nwJsStrings.`document-end`
import typingsJapgolly.nwJs.nwJsStrings.`document-start`
import typingsJapgolly.nwJs.nwJsStrings.`enter-fullscreen`
import typingsJapgolly.nwJs.nwJsStrings.`new-win-policy`
import typingsJapgolly.nwJs.nwJsStrings.blur
import typingsJapgolly.nwJs.nwJsStrings.close
import typingsJapgolly.nwJs.nwJsStrings.closed
import typingsJapgolly.nwJs.nwJsStrings.focus
import typingsJapgolly.nwJs.nwJsStrings.loaded
import typingsJapgolly.nwJs.nwJsStrings.loading
import typingsJapgolly.nwJs.nwJsStrings.maximize
import typingsJapgolly.nwJs.nwJsStrings.minimize
import typingsJapgolly.nwJs.nwJsStrings.move
import typingsJapgolly.nwJs.nwJsStrings.navigation
import typingsJapgolly.nwJs.nwJsStrings.resize
import typingsJapgolly.nwJs.nwJsStrings.restore
import typingsJapgolly.nwJs.nwJsStrings.zoom
...
trait win extends EventEmitter {
  ...
  def showDevTools(iframe: Unit, callback: js.Function1[/* dev_win */ js.UndefOr[Window], Unit]): Unit = js.native
