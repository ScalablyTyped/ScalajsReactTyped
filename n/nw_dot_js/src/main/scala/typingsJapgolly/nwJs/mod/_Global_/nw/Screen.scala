...
import typingsJapgolly.nwJs.mod._Global_.NWJSHelpers.screen
...
trait Screen extends EventEmitter {
  /**
    ...
    */
  var DesktopCaptureMonitor: typingsJapgolly.nwJs.mod._Global_.NWJSHelpers.DesktopCaptureMonitor = js.native
  /**
