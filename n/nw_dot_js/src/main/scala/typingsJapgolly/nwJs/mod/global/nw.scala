package typingsJapgolly.nwJs.mod.global

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.node.eventsMod.EventEmitter
import typingsJapgolly.nwJs.mod.global.NWJSHelpers.CreateMacBuiltinOption
...
import typingsJapgolly.nwJs.mod.global.NWJSHelpers.WindowOpenOption
import typingsJapgolly.nwJs.mod.global.NWJSHelpers.clip
import typingsJapgolly.nwJs.mod.global.NWJSHelpers.screen
import typingsJapgolly.nwJs.mod.global.NWJSHelpers.win
import typingsJapgolly.nwJs.nwJsStrings.`click `
import typingsJapgolly.nwJs.nwJsStrings.`displayAdded `
import typingsJapgolly.nwJs.nwJsStrings.`displayRemoved `
import typingsJapgolly.nwJs.nwJsStrings.active
import typingsJapgolly.nwJs.nwJsStrings.click
import typingsJapgolly.nwJs.nwJsStrings.displayBoundsChanged
import typingsJapgolly.nwJs.nwJsStrings.failed
import typingsJapgolly.nwJs.nwJsStrings.open
import typingsJapgolly.nwJs.nwJsStrings.reopen
...
object nw {
  ...
  object Clipboard {
    ...
    extension [Self <: Clipboard](x: Self) {
      ...
      inline def setGet(value: CallbackTo[clip]): Self = StObject.set(x, "get", value.toJsFn)
    }
  }
  ...
  trait Screen extends EventEmitter {
    ...
    /**
      ...
      */
    var DesktopCaptureMonitor: typingsJapgolly.nwJs.mod.global.NWJSHelpers.DesktopCaptureMonitor = js.native
  ...
  object Shell {
    ...
    extension [Self <: Shell](x: Self) {
      ...
      inline def setOpenExternal(value: String => Callback): Self = StObject.set(x, "openExternal", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setOpenItem(value: String => Callback): Self = StObject.set(x, "openItem", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setShowItemInFolder(value: String => Callback): Self = StObject.set(x, "showItemInFolder", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    }
  }
