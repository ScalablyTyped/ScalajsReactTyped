...
object Radar {
  def apply(
    ...
    RadarProps with Dimensions, 
    typingsJapgolly.nivoRadar.mod.Radar, 
    Unit, 
    RadarProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoRadar.mod.RadarProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoRadar.mod.Radar](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoRadar.mod.RadarProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
