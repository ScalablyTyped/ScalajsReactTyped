...
import typingsJapgolly.nivoRadar.anon.Fill
...
object distTypesTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nivoRadar.nivoRadarStrings.grid
    - typingsJapgolly.nivoRadar.nivoRadarStrings.layers
    - typingsJapgolly.nivoRadar.nivoRadarStrings.slices
    - typingsJapgolly.nivoRadar.nivoRadarStrings.dots
    - typingsJapgolly.nivoRadar.nivoRadarStrings.legends
  */
  trait RadarLayerId extends StObject
  object RadarLayerId {
    
    inline def dots: typingsJapgolly.nivoRadar.nivoRadarStrings.dots = "dots".asInstanceOf[typingsJapgolly.nivoRadar.nivoRadarStrings.dots]
    
    inline def grid: typingsJapgolly.nivoRadar.nivoRadarStrings.grid = "grid".asInstanceOf[typingsJapgolly.nivoRadar.nivoRadarStrings.grid]
    
    inline def layers: typingsJapgolly.nivoRadar.nivoRadarStrings.layers = "layers".asInstanceOf[typingsJapgolly.nivoRadar.nivoRadarStrings.layers]
    
    inline def legends: typingsJapgolly.nivoRadar.nivoRadarStrings.legends = "legends".asInstanceOf[typingsJapgolly.nivoRadar.nivoRadarStrings.legends]
    
    inline def slices: typingsJapgolly.nivoRadar.nivoRadarStrings.slices = "slices".asInstanceOf[typingsJapgolly.nivoRadar.nivoRadarStrings.slices]
  }
