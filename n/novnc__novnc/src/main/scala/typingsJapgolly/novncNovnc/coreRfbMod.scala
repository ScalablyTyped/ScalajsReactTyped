package typingsJapgolly.novncNovnc
...
import typingsJapgolly.novncNovnc.anon.Power
import typingsJapgolly.novncNovnc.novncNovncStrings.bell
import typingsJapgolly.novncNovnc.novncNovncStrings.capabilities
import typingsJapgolly.novncNovnc.novncNovncStrings.clipboard
import typingsJapgolly.novncNovnc.novncNovncStrings.connect
import typingsJapgolly.novncNovnc.novncNovncStrings.credentialsrequired
import typingsJapgolly.novncNovnc.novncNovncStrings.desktopname
import typingsJapgolly.novncNovnc.novncNovncStrings.disconnect
import typingsJapgolly.novncNovnc.novncNovncStrings.securityfailure
...
object coreRfbMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.novncNovnc.novncNovncStrings.detail
    - typingsJapgolly.novncNovnc.novncNovncStrings.initCustomEvent
  */
  trait NoVncEvent extends StObject
  object NoVncEvent {
    
    inline def detail: typingsJapgolly.novncNovnc.novncNovncStrings.detail = "detail".asInstanceOf[typingsJapgolly.novncNovnc.novncNovncStrings.detail]
    
    inline def initCustomEvent: typingsJapgolly.novncNovnc.novncNovncStrings.initCustomEvent = "initCustomEvent".asInstanceOf[typingsJapgolly.novncNovnc.novncNovncStrings.initCustomEvent]
  }
  ...
  trait NoVncEventTarget
    ...
    def addEventListener(`type`: String, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_bell(`type`: bell, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_capabilities(`type`: capabilities, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_clipboard(`type`: clipboard, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_connect(`type`: connect, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_credentialsrequired(`type`: credentialsrequired, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_desktopname(`type`: desktopname, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_disconnect(`type`: disconnect, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_securityfailure(`type`: securityfailure, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    
    def dispatchEvent(event: CustomEvent): Boolean = js.native
    def dispatchEvent(event: NoVncEvent): Boolean = js.native
    
    def removeEventListener(`type`: String, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("removeEventListener")
    def removeEventListener_bell(`type`: bell, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("removeEventListener")
    def removeEventListener_capabilities(`type`: capabilities, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("removeEventListener")
    def removeEventListener_clipboard(`type`: clipboard, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("removeEventListener")
    def removeEventListener_connect(`type`: connect, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("removeEventListener")
    def removeEventListener_credentialsrequired(`type`: credentialsrequired, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("removeEventListener")
    def removeEventListener_desktopname(`type`: desktopname, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("removeEventListener")
    def removeEventListener_disconnect(`type`: disconnect, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
    @JSName("removeEventListener")
    def removeEventListener_securityfailure(`type`: securityfailure, listener: js.Function1[/* event */ CustomEvent, Unit]): Unit = js.native
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.novncNovnc.novncNovncStrings.connect
    - typingsJapgolly.novncNovnc.novncNovncStrings.disconnect
    - typingsJapgolly.novncNovnc.novncNovncStrings.credentialsrequired
    - typingsJapgolly.novncNovnc.novncNovncStrings.securityfailure
    - typingsJapgolly.novncNovnc.novncNovncStrings.clipboard
    - typingsJapgolly.novncNovnc.novncNovncStrings.bell
    - typingsJapgolly.novncNovnc.novncNovncStrings.desktopname
    - typingsJapgolly.novncNovnc.novncNovncStrings.capabilities
  */
  ...
  trait NoVncEvents extends StObject {
    ...
    /**
      ...
      */
    var credentialsrequired: CustomEvent
    ...
    /**
      ...
      */
    var securityfailure: CustomEvent
  }
  object NoVncEvents {
    ...
    inline def apply(
      ...
      clipboard: CustomEvent,
      connect: CustomEvent,
      credentialsrequired: CustomEvent,
      desktopname: CustomEvent,
    ...
    extension [Self <: NoVncEvents](x: Self) {
      ...
      inline def setBell(value: CustomEvent): Self = StObject.set(x, "bell", value.asInstanceOf[js.Any])
      
      inline def setCapabilities(value: CustomEvent): Self = StObject.set(x, "capabilities", value.asInstanceOf[js.Any])
      
      inline def setClipboard(value: CustomEvent): Self = StObject.set(x, "clipboard", value.asInstanceOf[js.Any])
      
      inline def setConnect(value: CustomEvent): Self = StObject.set(x, "connect", value.asInstanceOf[js.Any])
      
      inline def setCredentialsrequired(value: CustomEvent): Self = StObject.set(x, "credentialsrequired", value.asInstanceOf[js.Any])
      
      inline def setDesktopname(value: CustomEvent): Self = StObject.set(x, "desktopname", value.asInstanceOf[js.Any])
      
      inline def setDisconnect(value: CustomEvent): Self = StObject.set(x, "disconnect", value.asInstanceOf[js.Any])
      
      inline def setSecurityfailure(value: CustomEvent): Self = StObject.set(x, "securityfailure", value.asInstanceOf[js.Any])
    }
  }
