...
import typingsJapgolly.nukaCarousel.nukaCarouselStrings.`next-cloned`
import typingsJapgolly.nukaCarousel.nukaCarouselStrings.`prev-cloned`
import typingsJapgolly.nukaCarousel.nukaCarouselStrings.assertive
import typingsJapgolly.nukaCarousel.nukaCarouselStrings.fade
import typingsJapgolly.nukaCarousel.nukaCarouselStrings.off
import typingsJapgolly.nukaCarousel.nukaCarouselStrings.polite
