...
trait CarouselProps extends StObject {
  ...
  var onDrag: js.UndefOr[
    js.Function1[
      /* e */ ReactTouchEventFrom[HTMLDivElement] | ReactMouseEventFrom[HTMLDivElement], 
      Unit
    ]
  ] = js.undefined
...
object CarouselProps {
  ...
  extension [Self <: CarouselProps](x: Self) {
    ...
    inline def setAfterSlide(value: /* index */ Double => Callback): Self = StObject.set(x, "afterSlide", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
    ...
    inline def setBeforeSlide(value: (/* currentSlideIndex */ Double, /* endSlideIndex */ Double) => Callback): Self = StObject.set(x, "beforeSlide", js.Any.fromFunction2((t0: /* currentSlideIndex */ Double, t1: /* endSlideIndex */ Double) => (value(t0, t1)).runNow()))
    ...
    ): Self = StObject.set(x, "onDrag", js.Any.fromFunction1((t0: /* e */ ReactTouchEventFrom[HTMLDivElement] | ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
    
    inline def setOnDragEnd(
      value: /* e */ ReactTouchEventFrom[HTMLDivElement] | ReactMouseEventFrom[HTMLDivElement] => Callback
    ): Self = StObject.set(x, "onDragEnd", js.Any.fromFunction1((t0: /* e */ ReactTouchEventFrom[HTMLDivElement] | ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
    
    inline def setOnDragEndUndefined: Self = StObject.set(x, "onDragEnd", js.undefined)
    
    inline def setOnDragStart(
      value: /* e */ ReactTouchEventFrom[HTMLDivElement] | ReactMouseEventFrom[HTMLDivElement] => Callback
    ): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1((t0: /* e */ ReactTouchEventFrom[HTMLDivElement] | ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
    ...
    inline def setRenderBottomCenterControls(value: /* props */ ControlProps => Node): Self = StObject.set(x, "renderBottomCenterControls", js.Any.fromFunction1(value))
    ...
    inline def setRenderBottomLeftControls(value: /* props */ ControlProps => Node): Self = StObject.set(x, "renderBottomLeftControls", js.Any.fromFunction1(value))
    ...
    inline def setRenderBottomRightControls(value: /* props */ ControlProps => Node): Self = StObject.set(x, "renderBottomRightControls", js.Any.fromFunction1(value))
    ...
    inline def setRenderCenterCenterControls(value: /* props */ ControlProps => Node): Self = StObject.set(x, "renderCenterCenterControls", js.Any.fromFunction1(value))
    ...
    inline def setRenderCenterLeftControls(value: /* props */ ControlProps => Node): Self = StObject.set(x, "renderCenterLeftControls", js.Any.fromFunction1(value))
    ...
    inline def setRenderCenterRightControls(value: /* props */ ControlProps => Node): Self = StObject.set(x, "renderCenterRightControls", js.Any.fromFunction1(value))
    ...
    inline def setRenderTopCenterControls(value: /* props */ ControlProps => Node): Self = StObject.set(x, "renderTopCenterControls", js.Any.fromFunction1(value))
    ...
    inline def setRenderTopLeftControls(value: /* props */ ControlProps => Node): Self = StObject.set(x, "renderTopLeftControls", js.Any.fromFunction1(value))
    ...
    inline def setRenderTopRightControls(value: /* props */ ControlProps => Node): Self = StObject.set(x, "renderTopRightControls", js.Any.fromFunction1(value))
