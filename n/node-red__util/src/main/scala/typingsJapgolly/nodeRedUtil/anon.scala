package typingsJapgolly.nodeRedUtil
...
object anon {
  ...
  trait Id extends StObject {
    ...
    var node: typingsJapgolly.nodeRedRegistry.mod.Node[js.Object]
  }
  object Id {
    
    inline def apply(id: String, node: typingsJapgolly.nodeRedRegistry.mod.Node[js.Object]): Id = {
    ...
    extension [Self <: Id](x: Self) {
      ...
      inline def setNode(value: typingsJapgolly.nodeRedRegistry.mod.Node[js.Object]): Self = StObject.set(x, "node", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Node {
    ...
    inline def apply(id: String, node: typingsJapgolly.nodeRedRegistry.mod.Node[js.Object], port: Double): Node = {
