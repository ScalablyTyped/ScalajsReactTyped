...
import typingsJapgolly.jsonata.mod.Expression
import typingsJapgolly.node.bufferMod.global.Buffer
import typingsJapgolly.node.eventsMod.EventEmitter
import typingsJapgolly.nodeRedRegistry.mod.NodeMessage
import typingsJapgolly.nodeRedUtil.anon.Format
import typingsJapgolly.nodeRedUtil.anon.Id
import typingsJapgolly.nodeRedUtil.anon.IdNode
import typingsJapgolly.nodeRedUtil.anon.Key
import typingsJapgolly.nodeRedUtil.anon.MaxLength
import typingsJapgolly.nodeRedUtil.anon.Msg
import typingsJapgolly.nodeRedUtil.anon.Node
import typingsJapgolly.nodeRedUtil.nodeRedUtilBooleans.`false`
import typingsJapgolly.nodeRedUtil.nodeRedUtilStrings.onComplete
import typingsJapgolly.nodeRedUtil.nodeRedUtilStrings.onReceive
import typingsJapgolly.nodeRedUtil.nodeRedUtilStrings.onSend
import typingsJapgolly.nodeRedUtil.nodeRedUtilStrings.postDeliver
import typingsJapgolly.nodeRedUtil.nodeRedUtilStrings.postInstall
import typingsJapgolly.nodeRedUtil.nodeRedUtilStrings.postReceive
import typingsJapgolly.nodeRedUtil.nodeRedUtilStrings.postUninstall
import typingsJapgolly.nodeRedUtil.nodeRedUtilStrings.preDeliver
import typingsJapgolly.nodeRedUtil.nodeRedUtilStrings.preInstall
import typingsJapgolly.nodeRedUtil.nodeRedUtilStrings.preRoute
import typingsJapgolly.nodeRedUtil.nodeRedUtilStrings.preUninstall
...
object mod extends Shortcut {
  ...
  trait Util extends StObject {
    ...
    /**
      ...
      */
    def evaluateEnvProperty(value: String, node: typingsJapgolly.nodeRedRegistry.mod.Node[js.Object]): String = js.native
    ...
    def evaluateNodeProperty(
      value: String,
      `type`: String,
      node: typingsJapgolly.nodeRedRegistry.mod.Node[js.Object],
      msg: js.Object
    ): Any = js.native
    def evaluateNodeProperty(
      value: String,
    ...
    /**
      ...
      */
    def getSetting(node: typingsJapgolly.nodeRedRegistry.mod.Node[js.Object], name: String): String = js.native
    ...
    /**
      ...
      */
    def prepareJSONataExpression(value: String, node: typingsJapgolly.nodeRedRegistry.mod.Node[js.Object]): Expression = js.native
  ...
  object UtilModule {
    ...
    inline def apply(
      hooks: Hooks,
      i18n: I18n,
      init: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify runtime.LocalSettings */ Any => Callback,
      log: Log,
      util: Util
    ): UtilModule = {
      val __obj = js.Dynamic.literal(hooks = hooks.asInstanceOf[js.Any], i18n = i18n.asInstanceOf[js.Any], init = js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify runtime.LocalSettings */ Any) => init(t0).runNow()), log = log.asInstanceOf[js.Any], util = util.asInstanceOf[js.Any])
    ...
    extension [Self <: UtilModule](x: Self) {
      ...
      inline def setInit(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify runtime.LocalSettings */ Any => Callback
      ): Self = StObject.set(x, "init", js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify runtime.LocalSettings */ Any) => value(t0).runNow()))
