package typingsJapgolly.nginstackDevops
...
object libUpdateUpdateScriptMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    var source: typingsJapgolly.nginstackEngine.libConnectionConnectionMod.^ = js.native
    
    /* CompleteClass */
    var sourceDB: typingsJapgolly.nginstackEngine.libDatabaseDatabaseMod.^ = js.native
    ...
    /* CompleteClass */
    var target: typingsJapgolly.nginstackEngine.libConnectionConnectionMod.^ = js.native
    
    /* CompleteClass */
    var targetDB: typingsJapgolly.nginstackEngine.libDatabaseDatabaseMod.^ = js.native
  ...
  trait UpdateScript extends StObject {
    ...
    var source: typingsJapgolly.nginstackEngine.libConnectionConnectionMod.^
    
    var sourceDB: typingsJapgolly.nginstackEngine.libDatabaseDatabaseMod.^
    
    /* private */ var state_ : Any
    
    /* private */ var sysEvent_ : Any
    
    var target: typingsJapgolly.nginstackEngine.libConnectionConnectionMod.^
    
    var targetDB: typingsJapgolly.nginstackEngine.libDatabaseDatabaseMod.^
  ...
  object UpdateScript {
    ...
    extension [Self <: UpdateScript](x: Self) {
      ...
      inline def setFinish(value: (String, Double) => Callback): Self = StObject.set(x, "finish", js.Any.fromFunction2((t0: String, t1: Double) => (value(t0, t1)).runNow()))
      ...
      inline def setSource(value: typingsJapgolly.nginstackEngine.libConnectionConnectionMod.^): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
      
      inline def setSourceDB(value: typingsJapgolly.nginstackEngine.libDatabaseDatabaseMod.^): Self = StObject.set(x, "sourceDB", value.asInstanceOf[js.Any])
      ...
      inline def setTarget(value: typingsJapgolly.nginstackEngine.libConnectionConnectionMod.^): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
      
      inline def setTargetDB(value: typingsJapgolly.nginstackEngine.libDatabaseDatabaseMod.^): Self = StObject.set(x, "targetDB", value.asInstanceOf[js.Any])
