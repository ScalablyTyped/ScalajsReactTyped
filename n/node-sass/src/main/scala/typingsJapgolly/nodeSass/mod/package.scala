...
import typingsJapgolly.nodeSass.mod.^
import typingsJapgolly.nodeSass.mod.types.Boolean
import typingsJapgolly.nodeSass.mod.types.Null
import typingsJapgolly.nodeSass.mod.types.ReturnValue
import typingsJapgolly.nodeSass.mod.types.Value
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.nodeSass.anon.File
  - typingsJapgolly.nodeSass.anon.Contents
  - js.Error
  - scala.Null
