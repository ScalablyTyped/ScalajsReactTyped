...
object PatternSquares {
  
  inline def apply(id: String): Builder = {
    val __props = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitPatternSquaresDeftype]))
  }
  
  @JSImport("@nivo/core", "PatternSquares")
  @js.native
  ...
  def withProps(p: OmitPatternSquaresDeftype): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
