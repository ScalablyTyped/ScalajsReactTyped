...
/* Inlined std.Partial<std.Partial<react.react.CSSProperties>> */
trait PartialPartialCSSProperti extends StObject {
  ...
  var fill: js.UndefOr[typingsJapgolly.csstype.mod.Property.Fill] = js.undefined
  ...
  var fontSize: js.UndefOr[typingsJapgolly.csstype.mod.Property.FontSize[String | Double]] = js.undefined
  ...
  var stroke: js.UndefOr[typingsJapgolly.csstype.mod.Property.Stroke] = js.undefined
...
object PartialPartialCSSProperti {
  
  inline def apply(): PartialPartialCSSProperti = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPartialCSSProperti]
  }
  
  extension [Self <: PartialPartialCSSProperti](x: Self) {
    ...
    inline def setFill(value: typingsJapgolly.csstype.mod.Property.Fill): Self = StObject.set(x, "fill", value.asInstanceOf[js.Any])
    ...
    inline def setFontSize(value: typingsJapgolly.csstype.mod.Property.FontSize[String | Double]): Self = StObject.set(x, "fontSize", value.asInstanceOf[js.Any])
    ...
    inline def setStroke(value: typingsJapgolly.csstype.mod.Property.Stroke): Self = StObject.set(x, "stroke", value.asInstanceOf[js.Any])
