...
import typingsJapgolly.nivoCore.mod.AreaCurveFactoryId
...
import typingsJapgolly.nivoCore.mod.CurveFactoryId
import typingsJapgolly.nivoCore.mod.LineCurveFactoryId
...
object nivoCoreStrings {
  ...
  sealed trait basis
    extends StObject
       with AreaCurve
       with AreaCurveFactoryId
       with CurveFactoryId
       with LineCurveFactoryId
  inline def basis: basis = "basis".asInstanceOf[basis]
  
  @js.native
  sealed trait basisClosed
    extends StObject
       with ClosedCurveFactoryId
       with CurveFactoryId
  ...
  @js.native
  sealed trait patternDots extends StObject
  inline def patternDots: patternDots = "patternDots".asInstanceOf[patternDots]
  
  @js.native
  sealed trait patternLines extends StObject
  inline def patternLines: patternLines = "patternLines".asInstanceOf[patternLines]
  
  @js.native
  sealed trait patternSquares extends StObject
  inline def patternSquares: patternSquares = "patternSquares".asInstanceOf[patternSquares]
