...
import typingsJapgolly.nivoCore.nivoCoreBooleans.`true`
import typingsJapgolly.nivoCore.nivoCoreInts.`15`
import typingsJapgolly.nivoCore.nivoCoreInts.`90`
import typingsJapgolly.nivoCore.nivoCoreStrings.default
