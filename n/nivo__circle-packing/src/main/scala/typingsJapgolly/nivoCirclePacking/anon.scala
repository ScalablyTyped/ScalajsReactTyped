...
object anon {
  ...
  trait PartialRecordonMouseMoveo extends StObject {
    ...
    var onMouseEnter: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[Element], Unit]] = js.undefined
    
    var onMouseLeave: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[Element], Unit]] = js.undefined
    
    var onMouseMove: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[Element], Unit]] = js.undefined
  }
  object PartialRecordonMouseMoveo {
    ...
    extension [Self <: PartialRecordonMouseMoveo](x: Self) {
      ...
      inline def setOnMouseEnter(value: /* event */ ReactMouseEventFrom[Element] => Callback): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[Element]) => value(t0).runNow()))
      
      inline def setOnMouseEnterUndefined: Self = StObject.set(x, "onMouseEnter", js.undefined)
      
      inline def setOnMouseLeave(value: /* event */ ReactMouseEventFrom[Element] => Callback): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[Element]) => value(t0).runNow()))
      
      inline def setOnMouseLeaveUndefined: Self = StObject.set(x, "onMouseLeave", js.undefined)
      
      inline def setOnMouseMove(value: /* event */ ReactMouseEventFrom[Element] => Callback): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[Element]) => value(t0).runNow()))
