...
object distTypesTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nivoCirclePacking.nivoCirclePackingStrings.circles
    - typingsJapgolly.nivoCirclePacking.nivoCirclePackingStrings.labels
  */
  trait CirclePackingLayerId extends StObject
  object CirclePackingLayerId {
    
    inline def circles: typingsJapgolly.nivoCirclePacking.nivoCirclePackingStrings.circles = "circles".asInstanceOf[typingsJapgolly.nivoCirclePacking.nivoCirclePackingStrings.circles]
    
    inline def labels: typingsJapgolly.nivoCirclePacking.nivoCirclePackingStrings.labels = "labels".asInstanceOf[typingsJapgolly.nivoCirclePacking.nivoCirclePackingStrings.labels]
  }
