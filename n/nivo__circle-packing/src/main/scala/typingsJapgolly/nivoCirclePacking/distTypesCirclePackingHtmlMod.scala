...
object distTypesCirclePackingHtmlMod {
  
  @JSImport("@nivo/circle-packing/dist/types/CirclePackingHtml", JSImport.Namespace)
  @js.native
  ...
  object InnerCirclePackingHtmlProps {
    
    inline def apply[RawDatum](data: RawDatum, height: Double, isInteractive: Boolean, width: Double): InnerCirclePackingHtmlProps[RawDatum] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], isInteractive = isInteractive.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
