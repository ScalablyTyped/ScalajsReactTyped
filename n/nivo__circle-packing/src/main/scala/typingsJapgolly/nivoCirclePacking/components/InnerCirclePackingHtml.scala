...
object InnerCirclePackingHtml {
  
  inline def apply[RawDatum](data: RawDatum, height: Double, isInteractive: Boolean, width: Double): Builder[RawDatum] = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], isInteractive = isInteractive.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
    new Builder[RawDatum](js.Array(this.component, __props.asInstanceOf[InnerCirclePackingHtmlProps[RawDatum]]))
  }
  
  @JSImport("@nivo/circle-packing", "InnerCirclePackingHtml")
  @js.native
  ...
  def withProps[RawDatum](p: InnerCirclePackingHtmlProps[RawDatum]): Builder[RawDatum] = new Builder[RawDatum](js.Array(this.component, p.asInstanceOf[js.Any]))
}
