...
object ResponsiveCirclePacking {
  
  inline def apply[RawDatum](data: RawDatum): Builder[RawDatum] = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder[RawDatum](js.Array(this.component, __props.asInstanceOf[ResponsiveCirclePackingProps[RawDatum]]))
  }
  
  @JSImport("@nivo/circle-packing", "ResponsiveCirclePacking")
  @js.native
  ...
  def withProps[RawDatum](p: ResponsiveCirclePackingProps[RawDatum]): Builder[RawDatum] = new Builder[RawDatum](js.Array(this.component, p.asInstanceOf[js.Any]))
}
