...
object CirclePackingHtml {
  ...
  inline def apply[RawDatum](
    ...
    new Builder[RawDatum](js.Array(this.component, __props.asInstanceOf[CirclePackingHtmlProps[RawDatum]]))
  }
  
  @JSImport("@nivo/circle-packing", "CirclePackingHtml")
  @js.native
  ...
  def withProps[RawDatum](p: CirclePackingHtmlProps[RawDatum]): Builder[RawDatum] = new Builder[RawDatum](js.Array(this.component, p.asInstanceOf[js.Any]))
}
