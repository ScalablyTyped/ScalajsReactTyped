...
object ResponsiveCirclePackingCanvas {
  
  inline def apply[RawDatum](data: RawDatum): Builder[RawDatum] = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder[RawDatum](js.Array(this.component, __props.asInstanceOf[ResponsiveCirclePackingCanvasProps[RawDatum]]))
  }
  
  @JSImport("@nivo/circle-packing", "ResponsiveCirclePackingCanvas")
  @js.native
  ...
  def withProps[RawDatum](p: ResponsiveCirclePackingCanvasProps[RawDatum]): Builder[RawDatum] = new Builder[RawDatum](js.Array(this.component, p.asInstanceOf[js.Any]))
}
