...
object CirclePacking {
  ...
  inline def apply[RawDatum](
    ...
    new Builder[RawDatum](js.Array(this.component, __props.asInstanceOf[CirclePackingSvgProps[RawDatum]]))
  }
  
  @JSImport("@nivo/circle-packing", "CirclePacking")
  @js.native
  ...
  def withProps[RawDatum](p: CirclePackingSvgProps[RawDatum]): Builder[RawDatum] = new Builder[RawDatum](js.Array(this.component, p.asInstanceOf[js.Any]))
}
