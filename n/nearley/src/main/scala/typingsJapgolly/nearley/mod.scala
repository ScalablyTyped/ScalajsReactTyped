...
import typingsJapgolly.nearley.anon.Dictkey
import typingsJapgolly.nearley.anon.Value
...
object mod {
  ...
  trait CompiledRules extends StObject {
    ...
    var Lexer: js.UndefOr[typingsJapgolly.nearley.mod.Lexer] = js.undefined
  ...
  object ParserRule {
    ...
    extension [Self <: ParserRule](x: Self) {
      ...
      inline def setPostprocess(
        value: (/* data */ js.Array[Any], /* reference */ js.UndefOr[Double], /* wantedBy */ js.UndefOr[js.Object]) => Callback
      ): Self = StObject.set(x, "postprocess", js.Any.fromFunction3((t0: /* data */ js.Array[Any], t1: /* reference */ js.UndefOr[Double], t2: /* wantedBy */ js.UndefOr[js.Object]) => (value(t0, t1, t2)).runNow()))
