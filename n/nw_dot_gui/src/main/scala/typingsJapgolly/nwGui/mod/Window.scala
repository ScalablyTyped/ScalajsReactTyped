...
import typingsJapgolly.nwGui.AnonDatatype
...
class Window () extends EventEmitter {
  ...
  def showDevTools(id: typingsJapgolly.std.HTMLIFrameElement): Unit = js.native
  def showDevTools(id: typingsJapgolly.std.HTMLIFrameElement, headless: Boolean): Unit = js.native
