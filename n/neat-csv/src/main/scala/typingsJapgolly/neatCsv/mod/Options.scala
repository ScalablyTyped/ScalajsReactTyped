package typingsJapgolly.neatCsv.mod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.neatCsv.AnonHeader
import typingsJapgolly.neatCsv.AnonIndex
...
object Options {
  ...
  def apply(
    ...
    mapHeaders: /* args */ AnonHeader => CallbackTo[String | Null] = null,
    mapValues: /* args */ AnonIndex => CallbackTo[js.Any] = null,
    ...
    if (mapHeaders != null) __obj.updateDynamic("mapHeaders")(js.Any.fromFunction1((t0: /* args */ typingsJapgolly.neatCsv.AnonHeader) => mapHeaders(t0).runNow()))
    if (mapValues != null) __obj.updateDynamic("mapValues")(js.Any.fromFunction1((t0: /* args */ typingsJapgolly.neatCsv.AnonIndex) => mapValues(t0).runNow()))
