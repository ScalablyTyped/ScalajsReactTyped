...
import typingsJapgolly.nginstackOrm.anon.Fields
...
object libEntityMod {
  ...
  type ConfigDef = typingsJapgolly.nginstackEngine.libClassdefConfigDefMod.^
  ...
  object Entity {
    ...
    inline def apply(
      CloneClass_ : Callback,
      assign: StringDictionary[Any] => Callback,
      autoPersist: Boolean,
      autoPersistVersion_ : Any,
      autoPersist_ : Any,
      bindDataSet: DataSet => Callback,
      cancel: Callback,
      ...
      val __obj = js.Dynamic.literal(CloneClass_ = CloneClass_.toJsFn, assign = js.Any.fromFunction1((t0: StringDictionary[Any]) => assign(t0).runNow()), autoPersist = autoPersist.asInstanceOf[js.Any], autoPersistVersion_ = autoPersistVersion_.asInstanceOf[js.Any], autoPersist_ = autoPersist_.asInstanceOf[js.Any], bindDataSet = js.Any.fromFunction1((t0: DataSet) => bindDataSet(t0).runNow()), cancel = cancel.toJsFn, changeableFieldNamesSet_ = changeableFieldNamesSet_.asInstanceOf[js.Any], checkIfCanChangeClass_ = checkIfCanChangeClass_.asInstanceOf[js.Any], checkIfCanChangeNegativeKey_ = checkIfCanChangeNegativeKey_.asInstanceOf[js.Any], checkIfClassIsJustToGroup_ = checkIfClassIsJustToGroup_.asInstanceOf[js.Any], checkIfFieldIsReadOnly_ = checkIfFieldIsReadOnly_.asInstanceOf[js.Any], checkIfIsEmpty_ = checkIfIsEmpty_.asInstanceOf[js.Any], checkPermission_ = checkPermission_.asInstanceOf[js.Any], checkPosition_ = checkPosition_.asInstanceOf[js.Any], checkRequiredFields_ = checkRequiredFields_.asInstanceOf[js.Any], checkStrictMode_ = checkStrictMode_.asInstanceOf[js.Any], classKey = classKey.asInstanceOf[js.Any], classKey_ = classKey_.asInstanceOf[js.Any], cloneableProperties_ = cloneableProperties_.asInstanceOf[js.Any], configDef_ = configDef_.asInstanceOf[js.Any], customModelDef_ = customModelDef_.asInstanceOf[js.Any], dataSet_ = dataSet_.asInstanceOf[js.Any], delete = delete.toJsFn, edit = edit.toJsFn, editableNegativeKeys_ = editableNegativeKeys_.asInstanceOf[js.Any], editableProductFields_ = editableProductFields_.asInstanceOf[js.Any], emitDataSetEvent_ = emitDataSetEvent_.asInstanceOf[js.Any], emitEvent_ = emitEvent_.asInstanceOf[js.Any], emitFieldChangeEvent_ = emitFieldChangeEvent_.asInstanceOf[js.Any], emitFieldEvent_ = emitFieldEvent_.asInstanceOf[js.Any], executeMasterDetailActions_ = executeMasterDetailActions_.asInstanceOf[js.Any], extraFilterFields_ = extraFilterFields_.asInstanceOf[js.Any], fieldPermissions_ = fieldPermissions_.asInstanceOf[js.Any], fieldTypeIsSupported_ = fieldTypeIsSupported_.asInstanceOf[js.Any], fieldsFilter_ = fieldsFilter_.asInstanceOf[js.Any], fieldsWithDefaultValue_ = fieldsWithDefaultValue_.asInstanceOf[js.Any], fields_ = fields_.asInstanceOf[js.Any], get = js.Any.fromFunction1(get), getExtraFilters_ = getExtraFilters_.asInstanceOf[js.Any], insert_ = insert_.toJsFn, key = key.asInstanceOf[js.Any], key_ = key_.asInstanceOf[js.Any], masterDetailFields_ = masterDetailFields_.asInstanceOf[js.Any], modelDef_ = modelDef_.asInstanceOf[js.Any], normalizeFieldValue_ = normalizeFieldValue_.asInstanceOf[js.Any], originalBookmark_ = originalBookmark_.asInstanceOf[js.Any], permissionFieldLabels_ = permissionFieldLabels_.asInstanceOf[js.Any], persist = persist.toJsFn, post = post.toJsFn, postPending = postPending.asInstanceOf[js.Any], requiredFields_ = requiredFields_.asInstanceOf[js.Any], set = js.Any.fromFunction2((t0: String, t1: Any) => (set(t0, t1)).runNow()), state = state.asInstanceOf[js.Any], stringify_ = stringify_.asInstanceOf[js.Any], suggestDefaultValues_ = suggestDefaultValues_.asInstanceOf[js.Any], toJSONSchema = toJSONSchema.toJsFn, toJSONString = toJSONString.toJsFn, updateClass_ = js.Any.fromFunction1((t0: Double) => updateClass_(t0).runNow()), userKey_ = userKey_.asInstanceOf[js.Any], validateLookupValue_ = validateLookupValue_.asInstanceOf[js.Any], visibleFieldIndexes_ = visibleFieldIndexes_.asInstanceOf[js.Any], visibleFieldNamesSet_ = visibleFieldNamesSet_.asInstanceOf[js.Any], visibleFieldNames_ = visibleFieldNames_.asInstanceOf[js.Any])
      __obj.asInstanceOf[Entity]
    }
    
    extension [Self <: Entity](x: Self) {
      
      inline def setAssign(value: StringDictionary[Any] => Callback): Self = StObject.set(x, "assign", js.Any.fromFunction1((t0: StringDictionary[Any]) => value(t0).runNow()))
      ...
      inline def setBindDataSet(value: DataSet => Callback): Self = StObject.set(x, "bindDataSet", js.Any.fromFunction1((t0: DataSet) => value(t0).runNow()))
      ...
      inline def setCloneClass_(value: Callback): Self = StObject.set(x, "CloneClass_", value.toJsFn)
      ...
      inline def setInsert_(value: Callback): Self = StObject.set(x, "insert_", value.toJsFn)
      ...
      inline def setPersist(value: CallbackTo[Double]): Self = StObject.set(x, "persist", value.toJsFn)
      ...
      inline def setUpdateClass_(value: Double => Callback): Self = StObject.set(x, "updateClass_", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
  ...
  type EntityOptions = typingsJapgolly.nginstackOrm.libEntityOptionsMod.^
  ...
  type FieldPermissions = typingsJapgolly.nginstackEngine.libSecurityFieldPermissionsMod.^
