...
import typingsJapgolly.nginstackOrm.libEntityMod.Field
...
object anon {
  ...
  trait UserKey extends StObject {
    ...
    var fields: js.Array[String] | (js.Function1[/* arg0 */ typingsJapgolly.nginstackOrm.libEntitySetMod.Field, Boolean])
  ...
  object UserKey {
    ...
    inline def apply(
      fields: js.Array[String] | (js.Function1[/* arg0 */ typingsJapgolly.nginstackOrm.libEntitySetMod.Field, Boolean]),
      userKey: Double
    ): UserKey = {
      val __obj = js.Dynamic.literal(fields = fields.asInstanceOf[js.Any], userKey = userKey.asInstanceOf[js.Any])
    ...
    extension [Self <: UserKey](x: Self) {
      ...
      inline def setFields(
        value: js.Array[String] | (js.Function1[/* arg0 */ typingsJapgolly.nginstackOrm.libEntitySetMod.Field, Boolean])
      ): Self = StObject.set(x, "fields", value.asInstanceOf[js.Any])
      
      inline def setFieldsFunction1(value: /* arg0 */ typingsJapgolly.nginstackOrm.libEntitySetMod.Field => Boolean): Self = StObject.set(x, "fields", js.Any.fromFunction1(value))
