...
object libEntityKeyMod {
  ...
  object EntityKey {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(classKey = classKey.asInstanceOf[js.Any], classKey_ = classKey_.asInstanceOf[js.Any], toJSONSchema = toJSONSchema.toJsFn, toJSONString = toJSONString.toJsFn, value_ = value_.asInstanceOf[js.Any], value = null)
