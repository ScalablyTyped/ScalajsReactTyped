...
import typingsJapgolly.nodeObjectHash.mod.Hashable
...
object distStringifiersMod {
  ...
  inline def typedArray(obj: TypedArray): String = ^.asInstanceOf[js.Dynamic].applyDynamic("_typedArray")(obj.asInstanceOf[js.Any]).asInstanceOf[String]
  
  inline def typedArraySort(obj: TypedArray): String = ^.asInstanceOf[js.Dynamic].applyDynamic("_typedArraySort")(obj.asInstanceOf[js.Any]).asInstanceOf[String]
