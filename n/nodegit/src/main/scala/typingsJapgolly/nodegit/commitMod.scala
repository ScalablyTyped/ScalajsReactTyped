...
object commitMod {
  ...
  open class Commit () extends StObject {
    ...
    def getSignature(): js.Promise[typingsJapgolly.nodegit.anon.Signature] = js.native
    def getSignature(field: String): js.Promise[typingsJapgolly.nodegit.anon.Signature] = js.native
