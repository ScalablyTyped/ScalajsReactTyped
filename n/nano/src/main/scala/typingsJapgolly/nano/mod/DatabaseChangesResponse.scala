...
object DatabaseChangesResponse {
  ...
  inline def apply(last_seq: Any, pending: Double, results: js.Array[DatabaseChangesResultItem]): DatabaseChangesResponse = {
  ...
  extension [Self <: DatabaseChangesResponse](x: Self) {
    ...
    inline def setLast_seq(value: Any): Self = StObject.set(x, "last_seq", value.asInstanceOf[js.Any])
    ...
    inline def setResultsVarargs(value: DatabaseChangesResultItem*): Self = StObject.set(x, "results", js.Array(value*))
  }
}
