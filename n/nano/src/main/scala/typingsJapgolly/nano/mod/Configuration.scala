...
object Configuration {
  ...
  extension [Self <: Configuration](x: Self) {
    ...
    inline def setLog(value: (/* id */ String, /* args */ Any) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "log", js.Any.fromFunction2((t0: /* id */ String, t1: /* args */ Any) => (value(t0, t1)).runNow()))
