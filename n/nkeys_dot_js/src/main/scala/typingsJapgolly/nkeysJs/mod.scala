...
object mod {
  ...
  @JSImport("nkeys.js", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("nkeys.js", "NKeysError")
  @js.native
  open class NKeysError protected ()
    extends typingsJapgolly.nkeysJs.libModMod.NKeysError {
    /**
  ...
  @JSImport("nkeys.js", "NKeysErrorCode")
  @js.native
