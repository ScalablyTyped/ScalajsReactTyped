...
import typingsJapgolly.nickThompsonElementary.nickThompsonElementaryStrings.gate
import typingsJapgolly.nickThompsonElementary.nickThompsonElementaryStrings.loop
import typingsJapgolly.nickThompsonElementary.nickThompsonElementaryStrings.trigger
...
object srcCorePropsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nickThompsonElementary.anon.pathstringundefineddatane
    - typingsJapgolly.nickThompsonElementary.anon.pathneverundefineddataFlo
  */
  trait TableProps extends StObject
  object TableProps {
    
    inline def pathneverundefineddataFlo(): typingsJapgolly.nickThompsonElementary.anon.pathneverundefineddataFlo = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.nickThompsonElementary.anon.pathneverundefineddataFlo]
    }
    
    inline def pathstringundefineddatane(): typingsJapgolly.nickThompsonElementary.anon.pathstringundefineddatane = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.nickThompsonElementary.anon.pathstringundefineddatane]
    }
  }
}
