...
import typingsJapgolly.nickThompsonElementary.nickThompsonElementaryStrings.controller
import typingsJapgolly.nickThompsonElementary.nickThompsonElementaryStrings.noteOff
import typingsJapgolly.nickThompsonElementary.nickThompsonElementaryStrings.noteOn
import typingsJapgolly.nickThompsonElementary.nickThompsonElementaryStrings.raw
...
object srcCoreMidiMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nickThompsonElementary.srcCoreMidiMod.MidiNoteOnEvent
    - typingsJapgolly.nickThompsonElementary.srcCoreMidiMod.MidiNoteOffEvent
    - typingsJapgolly.nickThompsonElementary.srcCoreMidiMod.MidiControllerEvent
  ...
  // MidiMetaEventEvent |
  typingsJapgolly.nickThompsonElementary.srcCoreMidiMod.MidiRawEvent
  */
  trait MidiEvent extends StObject
  object MidiEvent {
    
    inline def MidiControllerEvent(bytes: String, channel: Double, source: String, target: Double, value: Double): typingsJapgolly.nickThompsonElementary.srcCoreMidiMod.MidiControllerEvent = {
      val __obj = js.Dynamic.literal(bytes = bytes.asInstanceOf[js.Any], channel = channel.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("controller")
      __obj.asInstanceOf[typingsJapgolly.nickThompsonElementary.srcCoreMidiMod.MidiControllerEvent]
    }
    
    inline def MidiNoteOffEvent(bytes: String, noteFrequency: Double, noteName: String, noteNumber: Double, source: String): typingsJapgolly.nickThompsonElementary.srcCoreMidiMod.MidiNoteOffEvent = {
      ...
      __obj.asInstanceOf[typingsJapgolly.nickThompsonElementary.srcCoreMidiMod.MidiNoteOffEvent]
    }
    
    inline def MidiNoteOnEvent(bytes: String, noteFrequency: Double, noteName: String, noteNumber: Double, source: String): typingsJapgolly.nickThompsonElementary.srcCoreMidiMod.MidiNoteOnEvent = {
      val __obj = js.Dynamic.literal(bytes = bytes.asInstanceOf[js.Any], noteFrequency = noteFrequency.asInstanceOf[js.Any], noteName = noteName.asInstanceOf[js.Any], noteNumber = noteNumber.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("noteOn")
      __obj.asInstanceOf[typingsJapgolly.nickThompsonElementary.srcCoreMidiMod.MidiNoteOnEvent]
    }
    
    inline def MidiRawEvent(bytes: String, source: String): typingsJapgolly.nickThompsonElementary.srcCoreMidiMod.MidiRawEvent = {
      ...
      __obj.asInstanceOf[typingsJapgolly.nickThompsonElementary.srcCoreMidiMod.MidiRawEvent]
    }
  }
