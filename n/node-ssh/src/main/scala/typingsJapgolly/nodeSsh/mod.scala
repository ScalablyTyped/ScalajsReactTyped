package typingsJapgolly.nodeSsh

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.node.bufferMod.global.Buffer
import typingsJapgolly.nodeSsh.anon.ExecOptionsstreamboth
import typingsJapgolly.nodeSsh.anon.ExecOptionsstreamstdoutst
import typingsJapgolly.nodeSsh.anon.Local
import typingsJapgolly.nodeSsh.nodeSshStrings.exec
import typingsJapgolly.nodeSsh.nodeSshStrings.sftp
import typingsJapgolly.ssh2.mod.ClientChannel
...
object mod {
  ...
  object ConfigGiven {
    ...
    extension [Self <: ConfigGiven](x: Self) {
      ...
      inline def setOnKeyboardInteractive(value: CallbackTo[Unit | Boolean]): Self = StObject.set(x, "onKeyboardInteractive", value.toJsFn)
  ...
  trait ExecOptions extends StObject {
    ...
    var options: js.UndefOr[typingsJapgolly.ssh2.mod.ExecOptions] = js.undefined
  ...
  object ExecOptions {
    ...
    extension [Self <: ExecOptions](x: Self) {
      ...
      inline def setOnStderr(value: /* chunk */ Buffer => Callback): Self = StObject.set(x, "onStderr", js.Any.fromFunction1((t0: /* chunk */ Buffer) => value(t0).runNow()))
      
      inline def setOnStderrUndefined: Self = StObject.set(x, "onStderr", js.undefined)
      
      inline def setOnStdout(value: /* chunk */ Buffer => Callback): Self = StObject.set(x, "onStdout", js.Any.fromFunction1((t0: /* chunk */ Buffer) => value(t0).runNow()))
      
      inline def setOnStdoutUndefined: Self = StObject.set(x, "onStdout", js.undefined)
      
      inline def setOptions(value: typingsJapgolly.ssh2.mod.ExecOptions): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
  ...
  object PutDirectoryOptions {
    ...
    extension [Self <: PutDirectoryOptions](x: Self) {
      ...
      inline def setTick(
        value: (/* localPath */ String, /* remotePath */ String, /* error */ js.UndefOr[js.Error | Null]) => Callback
      ): Self = StObject.set(x, "tick", js.Any.fromFunction3((t0: /* localPath */ String, t1: /* remotePath */ String, t2: /* error */ js.UndefOr[js.Error | Null]) => (value(t0, t1, t2)).runNow()))
