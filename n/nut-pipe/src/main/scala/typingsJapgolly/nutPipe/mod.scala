package typingsJapgolly.nutPipe

import typingsJapgolly.awsLambda.handlerMod.Context
import typingsJapgolly.awsLambda.triggerApiGatewayProxyMod.APIGatewayProxyEventV2
import typingsJapgolly.awsLambda.triggerApiGatewayProxyMod.APIGatewayProxyStructuredResultV2
