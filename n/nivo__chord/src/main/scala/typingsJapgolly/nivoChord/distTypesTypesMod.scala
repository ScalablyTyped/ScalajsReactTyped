...
import typingsJapgolly.nivoChord.anon.EndAngle
import typingsJapgolly.nivoChord.anon.OmitArcDatumlabelcolor
import typingsJapgolly.nivoChord.anon.Source
...
object distTypesTypesMod {
  ...
  type ChordArcMouseHandler = js.Function2[/* arc */ Any, /* event */ ReactMouseEventFrom[Element], Unit]
  ...
  object ChordCanvasProps {
    ...
    extension [Self <: ChordCanvasProps](x: Self) {
      ...
      inline def setOnArcClick(value: (/* arc */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onArcClick", js.Any.fromFunction2((t0: /* arc */ Any, t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnArcClickUndefined: Self = StObject.set(x, "onArcClick", js.undefined)
      
      inline def setOnArcMouseEnter(value: (/* arc */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onArcMouseEnter", js.Any.fromFunction2((t0: /* arc */ Any, t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnArcMouseEnterUndefined: Self = StObject.set(x, "onArcMouseEnter", js.undefined)
      
      inline def setOnArcMouseLeave(value: (/* arc */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onArcMouseLeave", js.Any.fromFunction2((t0: /* arc */ Any, t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnArcMouseLeaveUndefined: Self = StObject.set(x, "onArcMouseLeave", js.undefined)
      
      inline def setOnArcMouseMove(value: (/* arc */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onArcMouseMove", js.Any.fromFunction2((t0: /* arc */ Any, t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
  ...
  object ChordCommonProps {
    ...
    inline def apply(
      ...
      onArcClick: (/* arc */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback,
      onArcMouseEnter: (/* arc */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback,
      onArcMouseLeave: (/* arc */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback,
      onArcMouseMove: (/* arc */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback,
      padAngle: Double,
  ...
  type ChordRibbonMouseHandler = js.Function2[/* ribbon */ Any, /* event */ ReactMouseEventFrom[Element], Unit]
  ...
  object ChordSvgProps {
    ...
    extension [Self <: ChordSvgProps](x: Self) {
      ...
      inline def setOnRibbonClick(value: (/* ribbon */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onRibbonClick", js.Any.fromFunction2((t0: /* ribbon */ Any, t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnRibbonClickUndefined: Self = StObject.set(x, "onRibbonClick", js.undefined)
      
      inline def setOnRibbonMouseEnter(value: (/* ribbon */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onRibbonMouseEnter", js.Any.fromFunction2((t0: /* ribbon */ Any, t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnRibbonMouseEnterUndefined: Self = StObject.set(x, "onRibbonMouseEnter", js.undefined)
      
      inline def setOnRibbonMouseLeave(value: (/* ribbon */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onRibbonMouseLeave", js.Any.fromFunction2((t0: /* ribbon */ Any, t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnRibbonMouseLeaveUndefined: Self = StObject.set(x, "onRibbonMouseLeave", js.undefined)
      
      inline def setOnRibbonMouseMove(value: (/* ribbon */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onRibbonMouseMove", js.Any.fromFunction2((t0: /* ribbon */ Any, t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nivoChord.nivoChordStrings.ribbons
    - typingsJapgolly.nivoChord.nivoChordStrings.arcs
    - typingsJapgolly.nivoChord.nivoChordStrings.labels
    - typingsJapgolly.nivoChord.nivoChordStrings.legends
  */
  trait LayerId extends StObject
  object LayerId {
    
    inline def arcs: typingsJapgolly.nivoChord.nivoChordStrings.arcs = "arcs".asInstanceOf[typingsJapgolly.nivoChord.nivoChordStrings.arcs]
    
    inline def labels: typingsJapgolly.nivoChord.nivoChordStrings.labels = "labels".asInstanceOf[typingsJapgolly.nivoChord.nivoChordStrings.labels]
    
    inline def legends: typingsJapgolly.nivoChord.nivoChordStrings.legends = "legends".asInstanceOf[typingsJapgolly.nivoChord.nivoChordStrings.legends]
    
    inline def ribbons: typingsJapgolly.nivoChord.nivoChordStrings.ribbons = "ribbons".asInstanceOf[typingsJapgolly.nivoChord.nivoChordStrings.ribbons]
  }
  ...
  type RibbonGenerator = typingsJapgolly.d3Chord.mod.RibbonGenerator[Any, RibbonDatum | Source, RibbonDatum]
