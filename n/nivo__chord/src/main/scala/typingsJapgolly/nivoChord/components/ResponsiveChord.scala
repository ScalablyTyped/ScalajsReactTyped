...
object ResponsiveChord {
  ...
  inline def apply(data: js.Array[js.Array[Double]], keys: js.Array[String]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitChordSvgPropswidthhei]))
  }
  ...
  def withProps(p: OmitChordSvgPropswidthhei): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
