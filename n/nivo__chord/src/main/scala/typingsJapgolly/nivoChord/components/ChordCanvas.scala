...
import typingsJapgolly.nivoChord.mod.ChordCanvasProps
...
object ChordCanvas {
  def apply(
    ...
    ChordCanvasProps with Dimensions, 
    typingsJapgolly.nivoChord.mod.ChordCanvas, 
    Unit, 
    ChordCanvasProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoChord.mod.ChordCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoChord.mod.ChordCanvas](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoChord.mod.ChordCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
