...
object ResponsiveChordCanvas {
  def apply(
    ...
    ChordCanvasProps, 
    typingsJapgolly.nivoChord.mod.ResponsiveChordCanvas, 
    Unit, 
    ChordCanvasProps
  ] = {
  ...
  typingsJapgolly.nivoChord.mod.ChordCanvasProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoChord.mod.ResponsiveChordCanvas](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoChord.mod.ChordCanvasProps])(children: _*)
  }
