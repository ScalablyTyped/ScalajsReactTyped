...
import typingsJapgolly.nivoChord.distTypesChordRibbonMod.ChordRibbonProps
...
object ChordRibbon {
  ...
  inline def apply(
    animatedProps: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SpringValues<RibbonAnimatedProps> */ Any,
    ...
    val __props = js.Dynamic.literal(animatedProps = animatedProps.asInstanceOf[js.Any], blendMode = blendMode.asInstanceOf[js.Any], borderWidth = borderWidth.asInstanceOf[js.Any], isInteractive = isInteractive.asInstanceOf[js.Any], ribbon = ribbon.asInstanceOf[js.Any], ribbonGenerator = ribbonGenerator.asInstanceOf[js.Any], setCurrent = js.Any.fromFunction1((t0: js.UndefOr[RibbonDatum]) => setCurrent(t0).runNow()), tooltip = tooltip.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[/* hasRibbonRibbonGeneratorAnimatedPropsBorderWidthBlendModeIsInteractiveSetCurrentOnMouseEnterOnMouseMoveOnMouseLeaveOnClickTooltip */ ChordRibbonProps]))
  }
  ...
  def withProps(
    p: /* hasRibbonRibbonGeneratorAnimatedPropsBorderWidthBlendModeIsInteractiveSetCurrentOnMouseEnterOnMouseMoveOnMouseLeaveOnClickTooltip */ ChordRibbonProps
