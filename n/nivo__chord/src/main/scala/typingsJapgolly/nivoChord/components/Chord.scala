...
object Chord {
  def apply(
    ...
    ChordProps with Dimensions, 
    typingsJapgolly.nivoChord.mod.Chord, 
    Unit, 
    ChordProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoChord.mod.ChordProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoChord.mod.Chord](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoChord.mod.ChordProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
