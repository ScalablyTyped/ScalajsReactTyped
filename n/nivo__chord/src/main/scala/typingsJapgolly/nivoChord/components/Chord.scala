...
import typingsJapgolly.nivoChord.distTypesTypesMod.ChordSvgProps
...
object Chord {
  ...
  inline def apply(data: js.Array[js.Array[Double]], height: Double, keys: js.Array[String], width: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ChordSvgProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def layers(value: js.Array[LayerId | CustomLayer]): this.type = set("layers", value.asInstanceOf[js.Any])
    
    inline def layersVarargs(value: (LayerId | CustomLayer)*): this.type = set("layers", js.Array(value*))
    ...
    inline def onRibbonClick(value: (/* ribbon */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback): this.type = set("onRibbonClick", js.Any.fromFunction2((t0: /* ribbon */ Any, t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
    
    inline def onRibbonMouseEnter(value: (/* ribbon */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback): this.type = set("onRibbonMouseEnter", js.Any.fromFunction2((t0: /* ribbon */ Any, t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
    
    inline def onRibbonMouseLeave(value: (/* ribbon */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback): this.type = set("onRibbonMouseLeave", js.Any.fromFunction2((t0: /* ribbon */ Any, t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
    
    inline def onRibbonMouseMove(value: (/* ribbon */ Any, /* event */ ReactMouseEventFrom[Element]) => Callback): this.type = set("onRibbonMouseMove", js.Any.fromFunction2((t0: /* ribbon */ Any, t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
    ...
    inline def ribbonTooltip(value: RibbonTooltipComponent): this.type = set("ribbonTooltip", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ChordSvgProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
