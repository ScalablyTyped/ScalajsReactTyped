...
import typingsJapgolly.nivoArcs.distTypesArcLabelsPropsMod.ArcLabelsProps
...
object distTypesTypesMod {
  ...
  type MouseHandler[RawDatum] = js.Function2[/* datum */ ComputedDatum[RawDatum], /* event */ ReactMouseEventFrom[Element], Unit]
  ...
  object MouseHandlers {
    ...
    extension [Self <: MouseHandlers[?], RawDatum](x: Self & MouseHandlers[RawDatum]) {
      ...
      inline def setOnClick(value: (/* datum */ ComputedDatum[RawDatum], /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* datum */ ComputedDatum[RawDatum], t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
      
      inline def setOnMouseEnter(value: (/* datum */ ComputedDatum[RawDatum], /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction2((t0: /* datum */ ComputedDatum[RawDatum], t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnMouseEnterUndefined: Self = StObject.set(x, "onMouseEnter", js.undefined)
      
      inline def setOnMouseLeave(value: (/* datum */ ComputedDatum[RawDatum], /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction2((t0: /* datum */ ComputedDatum[RawDatum], t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnMouseLeaveUndefined: Self = StObject.set(x, "onMouseLeave", js.undefined)
      
      inline def setOnMouseMove(value: (/* datum */ ComputedDatum[RawDatum], /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction2((t0: /* datum */ ComputedDatum[RawDatum], t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
  ...
  trait SunburstCommonProps[RawDatum]
    ...
    def tooltip(props: ComputedDatum[RawDatum]): typingsJapgolly.react.mod.global.JSX.Element
  ...
  object SunburstCommonProps {
    ...
    inline def apply[RawDatum](
      ...
      arcLabelsComponent: /* props */ ArcLabelProps[ComputedDatum[RawDatum]] => typingsJapgolly.react.mod.global.JSX.Element,
      ...
      role: String,
      theme: Theme,
      tooltip: ComputedDatum[RawDatum] => typingsJapgolly.react.mod.global.JSX.Element,
    ...
    extension [Self <: SunburstCommonProps[?], RawDatum](x: Self & SunburstCommonProps[RawDatum]) {
      ...
      inline def setTooltip(value: ComputedDatum[RawDatum] => typingsJapgolly.react.mod.global.JSX.Element): Self = StObject.set(x, "tooltip", js.Any.fromFunction1(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nivoSunburst.nivoSunburstStrings.arcs
    - typingsJapgolly.nivoSunburst.nivoSunburstStrings.arcLabels
  */
  trait SunburstLayerId extends StObject
  object SunburstLayerId {
    
    inline def arcLabels: typingsJapgolly.nivoSunburst.nivoSunburstStrings.arcLabels = "arcLabels".asInstanceOf[typingsJapgolly.nivoSunburst.nivoSunburstStrings.arcLabels]
    
    inline def arcs: typingsJapgolly.nivoSunburst.nivoSunburstStrings.arcs = "arcs".asInstanceOf[typingsJapgolly.nivoSunburst.nivoSunburstStrings.arcs]
  }
  ...
  object SunburstSvgProps {
    ...
    extension [Self <: SunburstSvgProps[?], RawDatum](x: Self & SunburstSvgProps[RawDatum]) {
      ...
      inline def setArcLabelsComponent(
        value: /* props */ ArcLabelProps[ComputedDatum[RawDatum]] => typingsJapgolly.react.mod.global.JSX.Element
      ): Self = StObject.set(x, "arcLabelsComponent", js.Any.fromFunction1(value))
