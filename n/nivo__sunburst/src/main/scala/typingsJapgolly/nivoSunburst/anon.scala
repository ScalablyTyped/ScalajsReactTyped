...
object anon {
  ...
  trait ArcGenerator[RawDatum] extends StObject {
    ...
    var arcGenerator: typingsJapgolly.nivoArcs.distTypesTypesMod.ArcGenerator
  ...
  object ArcGenerator {
    ...
    inline def apply[RawDatum](
      arcGenerator: typingsJapgolly.nivoArcs.distTypesTypesMod.ArcGenerator,
    ...
    extension [Self <: ArcGenerator[?], RawDatum](x: Self & ArcGenerator[RawDatum]) {
      ...
      inline def setArcGenerator(value: typingsJapgolly.nivoArcs.distTypesTypesMod.ArcGenerator): Self = StObject.set(x, "arcGenerator", value.asInstanceOf[js.Any])
