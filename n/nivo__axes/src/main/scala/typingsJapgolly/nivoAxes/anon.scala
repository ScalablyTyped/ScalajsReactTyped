...
import typingsJapgolly.nivoAxes.nivoAxesStrings.canvas
import typingsJapgolly.nivoAxes.nivoAxesStrings.svg
...
object anon {
  ...
  object Axis {
    ...
    extension [Self <: Axis[?], Value /* <: ScaleValue */](x: Self & Axis[Value]) {
      ...
      inline def setAxis(value: typingsJapgolly.nivoAxes.nivoAxesStrings.x | y): Self = StObject.set(x, "axis", value.asInstanceOf[js.Any])
  ...
  trait Length[Value /* <: ScaleValue */] extends StObject {
    ...
    var onClick: js.UndefOr[
        js.Function2[/* event */ ReactMouseEventFrom[SVGGElement], /* value */ String | Value, Unit]
      ] = js.undefined
  ...
  object Length {
    ...
    extension [Self <: Length[?], Value /* <: ScaleValue */](x: Self & Length[Value]) {
      ...
      inline def setOnClick(value: (/* event */ ReactMouseEventFrom[SVGGElement], /* value */ String | Value) => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[SVGGElement], t1: /* value */ String | Value) => (value(t0, t1)).runNow()))
