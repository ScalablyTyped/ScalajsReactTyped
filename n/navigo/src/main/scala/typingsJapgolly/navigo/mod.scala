...
import typingsJapgolly.navigo.navigoBooleans.`false`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.navigo.navigoStrings.ONE
    - typingsJapgolly.navigo.navigoStrings.ALL
  */
  trait ResolveStrategy extends StObject
  object ResolveStrategy {
    
    inline def ALL: typingsJapgolly.navigo.navigoStrings.ALL = "ALL".asInstanceOf[typingsJapgolly.navigo.navigoStrings.ALL]
    
    inline def ONE: typingsJapgolly.navigo.navigoStrings.ONE = "ONE".asInstanceOf[typingsJapgolly.navigo.navigoStrings.ONE]
  }
  ...
  object Route {
    ...
    inline def apply(
      handler: /* match */ js.UndefOr[Match] => Callback,
      hooks: RouteHooksStorage,
      name: String,
      path: String | js.RegExp
    ): Route = {
      val __obj = js.Dynamic.literal(handler = js.Any.fromFunction1((t0: /* match */ js.UndefOr[Match]) => handler(t0).runNow()), hooks = hooks.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[Route]
    }
    
    extension [Self <: Route](x: Self) {
      
      inline def setHandler(value: /* match */ js.UndefOr[Match] => Callback): Self = StObject.set(x, "handler", js.Any.fromFunction1((t0: /* match */ js.UndefOr[Match]) => value(t0).runNow()))
  ...
  object RouteHooks {
    ...
    extension [Self <: RouteHooks](x: Self) {
      ...
      inline def setAfter(value: /* match */ Match => Callback): Self = StObject.set(x, "after", js.Any.fromFunction1((t0: /* match */ Match) => value(t0).runNow()))
      
      inline def setAfterUndefined: Self = StObject.set(x, "after", js.undefined)
      
      inline def setAlready(value: /* match */ Match => Callback): Self = StObject.set(x, "already", js.Any.fromFunction1((t0: /* match */ Match) => value(t0).runNow()))
      
      inline def setAlreadyUndefined: Self = StObject.set(x, "already", js.undefined)
      
      inline def setBefore(value: (/* done */ js.Function, /* match */ Match) => Callback): Self = StObject.set(x, "before", js.Any.fromFunction2((t0: /* done */ js.Function, t1: /* match */ Match) => (value(t0, t1)).runNow()))
      
      inline def setBeforeUndefined: Self = StObject.set(x, "before", js.undefined)
      
      inline def setLeave(value: (/* done */ js.Function, /* match */ Match | js.Array[Match]) => Callback): Self = StObject.set(x, "leave", js.Any.fromFunction2((t0: /* done */ js.Function, t1: /* match */ Match | js.Array[Match]) => (value(t0, t1)).runNow()))
