...
import typingsJapgolly.nowigenceReactSimpleMaps.mod.AnnotationProps
...
object Annotation {
  ...
  inline def apply(connectorProps: SVGProps[SVGPathElement]): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def curve(value: Double): this.type = set("curve", value.asInstanceOf[js.Any])
    ...
    inline def subject(value: Point): this.type = set("subject", value.asInstanceOf[js.Any])
