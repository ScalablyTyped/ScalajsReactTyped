...
import typingsJapgolly.nowigenceReactSimpleMaps.mod.LineProps
...
object Line {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def coordinates(value: js.Array[Point]): this.type = set("coordinates", value.asInstanceOf[js.Any])
    
    inline def coordinatesVarargs(value: Point*): this.type = set("coordinates", js.Array(value*))
    ...
    inline def from(value: Point): this.type = set("from", value.asInstanceOf[js.Any])
    ...
    inline def to(value: Point): this.type = set("to", value.asInstanceOf[js.Any])
