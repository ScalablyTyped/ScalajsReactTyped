...
import typingsJapgolly.nowigenceReactSimpleMaps.mod.ComposableMapProps
import typingsJapgolly.nowigenceReactSimpleMaps.mod.ProjectionConfig
import typingsJapgolly.nowigenceReactSimpleMaps.mod.ProjectionFunction
...
object ComposableMap {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def projection(value: String | ProjectionFunction): this.type = set("projection", value.asInstanceOf[js.Any])
    
    inline def projectionConfig(value: ProjectionConfig): this.type = set("projectionConfig", value.asInstanceOf[js.Any])
    
    inline def projectionFunction3(value: (/* width */ Double, /* height */ Double, /* config */ ProjectionConfig) => GeoProjection_): this.type = set("projection", js.Any.fromFunction3(value))
