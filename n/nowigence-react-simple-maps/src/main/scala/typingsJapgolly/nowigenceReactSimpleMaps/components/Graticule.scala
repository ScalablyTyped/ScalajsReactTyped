...
import typingsJapgolly.nowigenceReactSimpleMaps.mod.GraticuleProps
import typingsJapgolly.nowigenceReactSimpleMaps.mod.Point
...
object Graticule {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def step(value: Point): this.type = set("step", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: Graticule.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GraticuleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
