...
import typingsJapgolly.nowigenceReactSimpleMaps.mod.ZoomableGroupProps
...
object ZoomableGroup {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def center(value: Point): this.type = set("center", value.asInstanceOf[js.Any])
    ...
    inline def disablePanning(value: Boolean): this.type = set("disablePanning", value.asInstanceOf[js.Any])
    
    inline def disableZooming(value: Boolean): this.type = set("disableZooming", value.asInstanceOf[js.Any])
    ...
    inline def filterZoomEvent(value: /* element */ SVGElement => Boolean): this.type = set("filterZoomEvent", js.Any.fromFunction1(value))
    ...
    inline def onMove(value: (/* position */ Dragging, /* event */ D3ZoomEvent[SVGElement, Any]) => Callback): this.type = set("onMove", js.Any.fromFunction2((t0: /* position */ Dragging, t1: /* event */ D3ZoomEvent[SVGElement, Any]) => (value(t0, t1)).runNow()))
    
    inline def onMoveEnd(value: (/* position */ Coordinates, /* event */ D3ZoomEvent[SVGElement, Any]) => Callback): this.type = set("onMoveEnd", js.Any.fromFunction2((t0: /* position */ Coordinates, t1: /* event */ D3ZoomEvent[SVGElement, Any]) => (value(t0, t1)).runNow()))
    
    inline def onMoveStart(value: (/* position */ Coordinates, /* event */ D3ZoomEvent[SVGElement, Any]) => Callback): this.type = set("onMoveStart", js.Any.fromFunction2((t0: /* position */ Coordinates, t1: /* event */ D3ZoomEvent[SVGElement, Any]) => (value(t0, t1)).runNow()))
    ...
    inline def translateExtent(value: js.Tuple2[js.Tuple2[Double, Double], js.Tuple2[Double, Double]]): this.type = set("translateExtent", value.asInstanceOf[js.Any])
    ...
    inline def zoomSensitivity(value: Double): this.type = set("zoomSensitivity", value.asInstanceOf[js.Any])
  }
