package typingsJapgolly.nowigenceReactSimpleMaps.components
...
import typingsJapgolly.nowigenceReactSimpleMaps.mod.GeographiesChildrenArgument
import typingsJapgolly.nowigenceReactSimpleMaps.mod.GeographiesProps
...
object Geographies {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def children(value: /* data */ GeographiesChildrenArgument => Callback): this.type = set("children", js.Any.fromFunction1((t0: /* data */ GeographiesChildrenArgument) => value(t0).runNow()))
    ...
    inline def geography(value: String | (Record[String, Any]) | js.Array[String]): this.type = set("geography", value.asInstanceOf[js.Any])
    
    inline def geographyVarargs(value: String*): this.type = set("geography", js.Array(value*))
    ...
    inline def parseGeographies(value: /* features */ js.Array[Feature[Any, Any]] => js.Array[Feature[Any, Any]]): this.type = set("parseGeographies", js.Any.fromFunction1(value))
