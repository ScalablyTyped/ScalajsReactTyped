...
object PartialBarCommonPropsBarD {
  ...
  extension [Self <: PartialBarCommonPropsBarD](x: Self) {
    ...
    ): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* datum */ ComputedDatumBarDatumcolo, t1: /* event */ ReactMouseEventFrom[HTMLCanvasElement]) => (value(t0, t1)).runNow()))
    ...
    ): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction2((t0: /* datum */ ComputedDatum[BarDatum], t1: /* event */ ReactMouseEventFrom[HTMLCanvasElement]) => (value(t0, t1)).runNow()))
    
    inline def setOnMouseEnterUndefined: Self = StObject.set(x, "onMouseEnter", js.undefined)
    
    inline def setOnMouseLeave(
      value: (/* datum */ ComputedDatum[BarDatum], /* event */ ReactMouseEventFrom[HTMLCanvasElement]) => Callback
    ): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction2((t0: /* datum */ ComputedDatum[BarDatum], t1: /* event */ ReactMouseEventFrom[HTMLCanvasElement]) => (value(t0, t1)).runNow()))
    ...
    inline def setRenderBar(value: (/* context */ CanvasRenderingContext2D, /* props */ RenderBarProps[BarDatum]) => Callback): Self = StObject.set(x, "renderBar", js.Any.fromFunction2((t0: /* context */ CanvasRenderingContext2D, t1: /* props */ RenderBarProps[BarDatum]) => (value(t0, t1)).runNow()))
