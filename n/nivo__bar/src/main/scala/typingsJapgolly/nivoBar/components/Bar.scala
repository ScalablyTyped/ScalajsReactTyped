...
object Bar {
  def apply(
    ...
    BarSvgProps with Dimensions, 
    typingsJapgolly.nivoBar.mod.Bar, 
    Unit, 
    BarSvgProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoBar.mod.BarSvgProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoBar.mod.Bar](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoBar.mod.BarSvgProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
