...
object ResponsiveBarCanvas {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BarCanvasProps, typingsJapgolly.nivoBar.mod.ResponsiveBarCanvas, Unit, BarCanvasProps] = {
  ...
  typingsJapgolly.nivoBar.mod.BarCanvasProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoBar.mod.ResponsiveBarCanvas](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoBar.mod.BarCanvasProps])(children: _*)
  }
