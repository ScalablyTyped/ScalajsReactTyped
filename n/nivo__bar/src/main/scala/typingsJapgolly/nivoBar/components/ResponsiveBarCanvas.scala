...
import typingsJapgolly.nivoBar.anon.OmitBarCanvasPropsBarDatu
...
object ResponsiveBarCanvas {
  ...
  inline def apply(data: js.Array[BarDatum]): Builder = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitBarCanvasPropsBarDatu]))
  }
  ...
  def withProps(p: OmitBarCanvasPropsBarDatu): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
