...
trait BarCustomLayerProps[RawDatum]
  extends StObject
     with BarCustomLayerBaseProps[RawDatum]
     with BarHandlers[RawDatum, SVGRectElement]
object BarCustomLayerProps {
  ...
  inline def apply[RawDatum](
    ...
    __obj.asInstanceOf[BarCustomLayerProps[RawDatum]]
  }
}
