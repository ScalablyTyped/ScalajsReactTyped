...
import typingsJapgolly.nodeSsdp.nodeSsdpStrings.`advertise-alive`
import typingsJapgolly.nodeSsdp.nodeSsdpStrings.`advertise-bye`
import typingsJapgolly.nodeSsdp.nodeSsdpStrings.response
...
object mod {
  ...
  object SsdpOptions {
    ...
    extension [Self <: SsdpOptions](x: Self) {
      ...
      inline def setCustomLogger(value: (/* format */ String, /* repeated */ Any) => Callback): Self = StObject.set(x, "customLogger", js.Any.fromFunction2((t0: /* format */ String, t1: /* repeated */ Any) => (value(t0, t1)).runNow()))
