...
import typingsJapgolly.nivoStream.anon.BorderWidth
...
object distTypesTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nivoStream.nivoStreamStrings.grid
    - typingsJapgolly.nivoStream.nivoStreamStrings.axes
    - typingsJapgolly.nivoStream.nivoStreamStrings.layers
    - typingsJapgolly.nivoStream.nivoStreamStrings.dots
    - typingsJapgolly.nivoStream.nivoStreamStrings.slices
    - typingsJapgolly.nivoStream.nivoStreamStrings.legends
  */
  trait StreamLayerId extends StObject
  object StreamLayerId {
    
    inline def axes: typingsJapgolly.nivoStream.nivoStreamStrings.axes = "axes".asInstanceOf[typingsJapgolly.nivoStream.nivoStreamStrings.axes]
    
    inline def dots: typingsJapgolly.nivoStream.nivoStreamStrings.dots = "dots".asInstanceOf[typingsJapgolly.nivoStream.nivoStreamStrings.dots]
    
    inline def grid: typingsJapgolly.nivoStream.nivoStreamStrings.grid = "grid".asInstanceOf[typingsJapgolly.nivoStream.nivoStreamStrings.grid]
    
    inline def layers: typingsJapgolly.nivoStream.nivoStreamStrings.layers = "layers".asInstanceOf[typingsJapgolly.nivoStream.nivoStreamStrings.layers]
    
    inline def legends: typingsJapgolly.nivoStream.nivoStreamStrings.legends = "legends".asInstanceOf[typingsJapgolly.nivoStream.nivoStreamStrings.legends]
    
    inline def slices: typingsJapgolly.nivoStream.nivoStreamStrings.slices = "slices".asInstanceOf[typingsJapgolly.nivoStream.nivoStreamStrings.slices]
  }
