...
object mod extends Shortcut {
  ...
  object HeapDiff {
    ...
    inline def apply(end: CallbackTo[HeapDiffInformation]): HeapDiff = {
    ...
    extension [Self <: HeapDiff](x: Self) {
      ...
      inline def setEnd(value: CallbackTo[HeapDiffInformation]): Self = StObject.set(x, "end", value.toJsFn)
    }
  }
