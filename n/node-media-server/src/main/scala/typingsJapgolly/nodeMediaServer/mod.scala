package typingsJapgolly.nodeMediaServer
...
object mod {
  ...
  object NodeMediaServer {
    ...
    inline def apply(
      ...
      on: (String, js.Function3[/* id */ String, /* StreamPath */ String, /* args */ js.Object, Unit]) => Callback,
      run: Callback,
      stop: Callback
    ): NodeMediaServer = {
      val __obj = js.Dynamic.literal(getSession = js.Any.fromFunction1(getSession), on = js.Any.fromFunction2((t0: String, t1: js.Function3[/* id */ String, /* StreamPath */ String, /* args */ js.Object, Unit]) => (on(t0, t1)).runNow()), run = run.toJsFn, stop = stop.toJsFn)
    ...
    extension [Self <: NodeMediaServer](x: Self) {
      ...
      inline def setOn(
        value: (String, js.Function3[/* id */ String, /* StreamPath */ String, /* args */ js.Object, Unit]) => Callback
      ): Self = StObject.set(x, "on", js.Any.fromFunction2((t0: String, t1: js.Function3[/* id */ String, /* StreamPath */ String, /* args */ js.Object, Unit]) => (value(t0, t1)).runNow()))
