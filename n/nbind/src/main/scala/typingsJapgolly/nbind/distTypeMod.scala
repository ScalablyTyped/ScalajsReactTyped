...
import typingsJapgolly.nbind.anon.GetComplexType
import typingsJapgolly.nbind.nbindInts.`0`
import typingsJapgolly.nbind.nbindInts.`10240`
import typingsJapgolly.nbind.nbindInts.`1024`
import typingsJapgolly.nbind.nbindInts.`10`
import typingsJapgolly.nbind.nbindInts.`120`
import typingsJapgolly.nbind.nbindInts.`128`
import typingsJapgolly.nbind.nbindInts.`15360`
import typingsJapgolly.nbind.nbindInts.`16`
import typingsJapgolly.nbind.nbindInts.`1`
import typingsJapgolly.nbind.nbindInts.`2048`
import typingsJapgolly.nbind.nbindInts.`256`
import typingsJapgolly.nbind.nbindInts.`2`
import typingsJapgolly.nbind.nbindInts.`3072`
import typingsJapgolly.nbind.nbindInts.`32`
import typingsJapgolly.nbind.nbindInts.`384`
import typingsJapgolly.nbind.nbindInts.`3`
import typingsJapgolly.nbind.nbindInts.`4096`
import typingsJapgolly.nbind.nbindInts.`4`
import typingsJapgolly.nbind.nbindInts.`5120`
import typingsJapgolly.nbind.nbindInts.`512`
import typingsJapgolly.nbind.nbindInts.`5`
import typingsJapgolly.nbind.nbindInts.`6144`
import typingsJapgolly.nbind.nbindInts.`640`
import typingsJapgolly.nbind.nbindInts.`64`
import typingsJapgolly.nbind.nbindInts.`6`
import typingsJapgolly.nbind.nbindInts.`7168`
import typingsJapgolly.nbind.nbindInts.`7`
import typingsJapgolly.nbind.nbindInts.`8192`
import typingsJapgolly.nbind.nbindInts.`896`
import typingsJapgolly.nbind.nbindInts.`8`
import typingsJapgolly.nbind.nbindInts.`9216`
import typingsJapgolly.nbind.nbindInts.`9`
...
object distTypeMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.nbind.nbindInts.`6`
    - typingsJapgolly.nbind.nbindInts.`7`
    - typingsJapgolly.nbind.nbindInts.`8`
    - typingsJapgolly.nbind.nbindInts.`9`
    - typingsJapgolly.nbind.nbindInts.`10`
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nbind.nbindInts.`1`
    - typingsJapgolly.nbind.nbindInts.`8`
    - typingsJapgolly.nbind.nbindInts.`128`
    - typingsJapgolly.nbind.nbindInts.`1024`
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.nbind.nbindInts.`2`
    - typingsJapgolly.nbind.nbindInts.`4`
    - typingsJapgolly.nbind.nbindInts.`120`
    - typingsJapgolly.nbind.nbindInts.`8`
    - typingsJapgolly.nbind.nbindInts.`16`
    - typingsJapgolly.nbind.nbindInts.`32`
    - typingsJapgolly.nbind.nbindInts.`64`
    - typingsJapgolly.nbind.nbindInts.`896`
    - typingsJapgolly.nbind.nbindInts.`128`
    - typingsJapgolly.nbind.nbindInts.`256`
    - typingsJapgolly.nbind.nbindInts.`384`
    - typingsJapgolly.nbind.nbindInts.`512`
    - typingsJapgolly.nbind.nbindInts.`640`
    - typingsJapgolly.nbind.nbindInts.`15360`
    - typingsJapgolly.nbind.nbindInts.`1024`
    - typingsJapgolly.nbind.nbindInts.`2048`
    - typingsJapgolly.nbind.nbindInts.`3072`
    - typingsJapgolly.nbind.nbindInts.`4096`
    - typingsJapgolly.nbind.nbindInts.`5120`
    - typingsJapgolly.nbind.nbindInts.`6144`
    - typingsJapgolly.nbind.nbindInts.`7168`
    - typingsJapgolly.nbind.nbindInts.`8192`
    - typingsJapgolly.nbind.nbindInts.`9216`
    - typingsJapgolly.nbind.nbindInts.`10240`
  */
