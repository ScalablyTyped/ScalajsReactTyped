...
import typingsJapgolly.nbind.distTypeMod.StateFlags
import typingsJapgolly.nbind.distTypeMod.StructureType
import typingsJapgolly.nbind.distTypeMod.TypeFlagBase
