...
import typingsJapgolly.nbind.anon.Bindvalue
import typingsJapgolly.nbind.distCommonMod.SignatureType
import typingsJapgolly.nbind.nbindStrings.emcc
import typingsJapgolly.nbind.nbindStrings.node
...
object mod {
  ...
  object DefaultExportType {
    ...
    extension [Self <: DefaultExportType](x: Self) {
      ...
      inline def set_nbind_value(value: (/* name */ String, /* proto */ ClassType) => Callback): Self = StObject.set(x, "_nbind_value", js.Any.fromFunction2((t0: /* name */ String, t1: /* proto */ ClassType) => (value(t0, t1)).runNow()))
