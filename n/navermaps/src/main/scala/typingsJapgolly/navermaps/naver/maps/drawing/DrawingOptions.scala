...
import typingsJapgolly.navermaps.naver.maps.EllipseOptions
import typingsJapgolly.navermaps.naver.maps.Map
import typingsJapgolly.navermaps.naver.maps.MarkerOptions
import typingsJapgolly.navermaps.naver.maps.PolygonOptions
import typingsJapgolly.navermaps.naver.maps.PolylineOptions
import typingsJapgolly.navermaps.naver.maps.RectangleOptions
...
trait DrawingOptions extends js.Object {
  ...
  var controlPointOptions: js.UndefOr[typingsJapgolly.navermaps.naver.maps.drawing.controlPointOptions] = js.undefined
  var drawingControl: js.UndefOr[js.Array[DrawingMode]] = js.undefined
  var drawingControlOptions: js.UndefOr[typingsJapgolly.navermaps.naver.maps.drawing.drawingControlOptions] = js.undefined
