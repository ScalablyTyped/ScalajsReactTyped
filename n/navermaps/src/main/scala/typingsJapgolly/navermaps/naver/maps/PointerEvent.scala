...
object PointerEvent {
  ...
  inline def apply(coord: Coord, feature: Feature, offset: Point, point: Point, pointerEvent: Event): PointerEvent = {
  ...
  extension [Self <: PointerEvent](x: Self) {
    ...
    inline def setPointerEvent(value: Event): Self = StObject.set(x, "pointerEvent", value.asInstanceOf[js.Any])
  }
}
