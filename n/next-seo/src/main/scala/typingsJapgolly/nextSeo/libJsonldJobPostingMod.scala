...
import typingsJapgolly.nextSeo.libJsonldJsonldMod.JsonLdProps
import typingsJapgolly.nextSeo.nextSeoStrings.`associate degree`
import typingsJapgolly.nextSeo.nextSeoStrings.`bachelor degree`
import typingsJapgolly.nextSeo.nextSeoStrings.`high school`
import typingsJapgolly.nextSeo.nextSeoStrings.`no requirements`
import typingsJapgolly.nextSeo.nextSeoStrings.`postgraduate degree`
import typingsJapgolly.nextSeo.nextSeoStrings.`professional certificate`
...
object libJsonldJobPostingMod {
  ...
  trait EducationalOccupationalCredential extends StObject {
    ...
    var `@type`: js.UndefOr[
        typingsJapgolly.nextSeo.nextSeoStrings.EducationalOccupationalCredential | String
      ] = js.undefined
  ...
  object EducationalOccupationalCredential {
    ...
    extension [Self <: EducationalOccupationalCredential](x: Self) {
      ...
      inline def `set@type`(value: typingsJapgolly.nextSeo.nextSeoStrings.EducationalOccupationalCredential | String): Self = StObject.set(x, "@type", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nextSeo.nextSeoStrings.FULL_TIME
    - typingsJapgolly.nextSeo.nextSeoStrings.PART_TIME
    - typingsJapgolly.nextSeo.nextSeoStrings.CONTRACTOR
    - typingsJapgolly.nextSeo.nextSeoStrings.TEMPORARY
    - typingsJapgolly.nextSeo.nextSeoStrings.INTERN
    - typingsJapgolly.nextSeo.nextSeoStrings.VOLUNTEER
    - typingsJapgolly.nextSeo.nextSeoStrings.PER_DIEM
    - typingsJapgolly.nextSeo.nextSeoStrings.OTHER
  */
  trait EmploymentType extends StObject
  object EmploymentType {
    
    inline def CONTRACTOR: typingsJapgolly.nextSeo.nextSeoStrings.CONTRACTOR = "CONTRACTOR".asInstanceOf[typingsJapgolly.nextSeo.nextSeoStrings.CONTRACTOR]
    
    inline def FULL_TIME: typingsJapgolly.nextSeo.nextSeoStrings.FULL_TIME = "FULL_TIME".asInstanceOf[typingsJapgolly.nextSeo.nextSeoStrings.FULL_TIME]
    
    inline def INTERN: typingsJapgolly.nextSeo.nextSeoStrings.INTERN = "INTERN".asInstanceOf[typingsJapgolly.nextSeo.nextSeoStrings.INTERN]
    
    inline def OTHER: typingsJapgolly.nextSeo.nextSeoStrings.OTHER = "OTHER".asInstanceOf[typingsJapgolly.nextSeo.nextSeoStrings.OTHER]
    
    inline def PART_TIME: typingsJapgolly.nextSeo.nextSeoStrings.PART_TIME = "PART_TIME".asInstanceOf[typingsJapgolly.nextSeo.nextSeoStrings.PART_TIME]
    
    inline def PER_DIEM: typingsJapgolly.nextSeo.nextSeoStrings.PER_DIEM = "PER_DIEM".asInstanceOf[typingsJapgolly.nextSeo.nextSeoStrings.PER_DIEM]
    
    inline def TEMPORARY: typingsJapgolly.nextSeo.nextSeoStrings.TEMPORARY = "TEMPORARY".asInstanceOf[typingsJapgolly.nextSeo.nextSeoStrings.TEMPORARY]
    
    inline def VOLUNTEER: typingsJapgolly.nextSeo.nextSeoStrings.VOLUNTEER = "VOLUNTEER".asInstanceOf[typingsJapgolly.nextSeo.nextSeoStrings.VOLUNTEER]
  }
  ...
  trait OccupationalExperienceRequirements extends StObject {
    ...
    var `@type`: js.UndefOr[
        typingsJapgolly.nextSeo.nextSeoStrings.OccupationalExperienceRequirements | (`no requirements`) | String
      ] = js.undefined
  ...
  object OccupationalExperienceRequirements {
    ...
    extension [Self <: OccupationalExperienceRequirements](x: Self) {
      ...
      inline def `set@type`(
        value: typingsJapgolly.nextSeo.nextSeoStrings.OccupationalExperienceRequirements | (`no requirements`) | String
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nextSeo.nextSeoStrings.HOUR
    - typingsJapgolly.nextSeo.nextSeoStrings.DAY
    - typingsJapgolly.nextSeo.nextSeoStrings.WEEK
    - typingsJapgolly.nextSeo.nextSeoStrings.MONTH
    - typingsJapgolly.nextSeo.nextSeoStrings.YEAR
  */
  trait UnitTextType extends StObject
  object UnitTextType {
    
    inline def DAY: typingsJapgolly.nextSeo.nextSeoStrings.DAY = "DAY".asInstanceOf[typingsJapgolly.nextSeo.nextSeoStrings.DAY]
    
    inline def HOUR: typingsJapgolly.nextSeo.nextSeoStrings.HOUR = "HOUR".asInstanceOf[typingsJapgolly.nextSeo.nextSeoStrings.HOUR]
    
    inline def MONTH: typingsJapgolly.nextSeo.nextSeoStrings.MONTH = "MONTH".asInstanceOf[typingsJapgolly.nextSeo.nextSeoStrings.MONTH]
    
    inline def WEEK: typingsJapgolly.nextSeo.nextSeoStrings.WEEK = "WEEK".asInstanceOf[typingsJapgolly.nextSeo.nextSeoStrings.WEEK]
    
    inline def YEAR: typingsJapgolly.nextSeo.nextSeoStrings.YEAR = "YEAR".asInstanceOf[typingsJapgolly.nextSeo.nextSeoStrings.YEAR]
  }
}
