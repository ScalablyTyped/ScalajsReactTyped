...
import typingsJapgolly.next.EmscriptenWasm.ModuleFactory
import typingsJapgolly.next.nextInts.`0`
...
object distServerLibSquooshAvifAvifEncMod {
  
  @JSImport("next/dist/server/lib/squoosh/avif/avif_enc", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("next/dist/server/lib/squoosh/avif/avif_enc", JSImport.Default)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.next.nextInts.`0`
    - typingsJapgolly.next.nextInts.`1`
    - typingsJapgolly.next.nextInts.`2`
  */
