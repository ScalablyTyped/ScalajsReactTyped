...
trait DomainLocale extends StObject {
  ...
  var domainLocale: js.UndefOr[typingsJapgolly.next.distServerConfigSharedMod.DomainLocale] = js.undefined
  
  var flightSearchParameters: js.UndefOr[Record[String, String]] = js.undefined
  
  var locale: js.UndefOr[String] = js.undefined
  
  var options: typingsJapgolly.next.distServerWebNextUrlMod.Options
...
object DomainLocale {
  ...
  inline def apply(basePath: String, options: typingsJapgolly.next.distServerWebNextUrlMod.Options, url: URL): DomainLocale = {
  ...
  extension [Self <: DomainLocale](x: Self) {
    ...
    inline def setDomainLocale(value: typingsJapgolly.next.distServerConfigSharedMod.DomainLocale): Self = StObject.set(x, "domainLocale", value.asInstanceOf[js.Any])
    ...
    inline def setOptions(value: typingsJapgolly.next.distServerWebNextUrlMod.Options): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
