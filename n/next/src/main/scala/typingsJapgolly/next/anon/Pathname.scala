...
trait Pathname extends StObject {
  ...
  var params: typingsJapgolly.next.distSharedLibRouterUtilsRouteMatcherMod.Params
...
object Pathname {
  ...
  inline def apply(
    isAppPath: Boolean,
    params: typingsJapgolly.next.distSharedLibRouterUtilsRouteMatcherMod.Params,
    pathname: String,
