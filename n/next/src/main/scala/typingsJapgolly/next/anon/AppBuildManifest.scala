...
trait AppBuildManifest extends StObject {
  ...
  var appBuildManifest: js.UndefOr[
...
object AppBuildManifest {
  ...
  extension [Self <: AppBuildManifest](x: Self) {
    ...
    inline def setAppBuildManifest(value: typingsJapgolly.next.distBuildWebpackPluginsAppBuildManifestPluginMod.AppBuildManifest): Self = StObject.set(x, "appBuildManifest", value.asInstanceOf[js.Any])
