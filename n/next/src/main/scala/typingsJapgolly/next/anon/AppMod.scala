...
trait AppMod extends StObject {
  ...
  var config: typingsJapgolly.next.distServerConfigSharedMod.NextConfig
...
object AppMod {
  ...
  inline def apply(
    ...
    config: typingsJapgolly.next.distServerConfigSharedMod.NextConfig,
    dev: Boolean,
    error500Mod: Any,
    errorMod: Any,
    page: String,
  ...
  extension [Self <: AppMod](x: Self) {
    ...
    inline def setConfig(value: typingsJapgolly.next.distServerConfigSharedMod.NextConfig): Self = StObject.set(x, "config", value.asInstanceOf[js.Any])
