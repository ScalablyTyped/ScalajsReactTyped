...
object DistDir {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(configFileName = configFileName.asInstanceOf[js.Any], distDir = distDir.asInstanceOf[js.Any], httpAgentOptions = httpAgentOptions.asInstanceOf[js.Any], page = page.asInstanceOf[js.Any], runtimeEnvConfig = runtimeEnvConfig.asInstanceOf[js.Any], serverless = serverless.asInstanceOf[js.Any])
