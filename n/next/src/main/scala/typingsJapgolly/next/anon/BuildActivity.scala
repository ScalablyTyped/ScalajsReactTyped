...
import typingsJapgolly.next.nextStrings.`bottom-left`
import typingsJapgolly.next.nextStrings.`bottom-right`
import typingsJapgolly.next.nextStrings.`top-left`
import typingsJapgolly.next.nextStrings.`top-right`
