...
trait MultiCompiler extends StObject {
  ...
  var multiCompiler: typingsJapgolly.next.distCompiledWebpackWebpackMod.webpack.MultiCompiler
...
object MultiCompiler {
  ...
  inline def apply(
    ...
    multiCompiler: typingsJapgolly.next.distCompiledWebpackWebpackMod.webpack.MultiCompiler,
  ...
  extension [Self <: MultiCompiler](x: Self) {
    ...
    inline def setMultiCompiler(value: typingsJapgolly.next.distCompiledWebpackWebpackMod.webpack.MultiCompiler): Self = StObject.set(x, "multiCompiler", value.asInstanceOf[js.Any])
