...
trait AppConfig extends StObject {
  ...
  var appConfig: js.UndefOr[typingsJapgolly.next.distBuildUtilsMod.AppConfig] = js.undefined
...
object AppConfig {
  ...
  extension [Self <: AppConfig](x: Self) {
    ...
    inline def setAppConfig(value: typingsJapgolly.next.distBuildUtilsMod.AppConfig): Self = StObject.set(x, "appConfig", value.asInstanceOf[js.Any])
