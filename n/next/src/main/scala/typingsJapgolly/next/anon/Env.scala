...
import typingsJapgolly.next.distServerWebTypesMod.NodejsRequestData
...
object Env {
  ...
  extension [Self <: Env](x: Self) {
    ...
    inline def setOnWarning(value: /* warn */ js.Error => Callback): Self = StObject.set(x, "onWarning", js.Any.fromFunction1((t0: /* warn */ js.Error) => value(t0).runNow()))
