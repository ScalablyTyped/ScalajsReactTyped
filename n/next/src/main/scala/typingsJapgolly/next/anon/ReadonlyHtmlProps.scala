...
trait ReadonlyHtmlProps extends StObject {
  ...
  val buildManifest: typingsJapgolly.next.distServerGetPageFilesMod.BuildManifest
  ...
  val head: js.UndefOr[js.Array[typingsJapgolly.react.mod.global.JSX.Element | Null]] = js.undefined
  ...
  val styles: js.UndefOr[js.Array[japgolly.scalajs.react.facade.React.Element] | ReactFragment] = js.undefined
...
object ReadonlyHtmlProps {
  ...
  extension [Self <: ReadonlyHtmlProps](x: Self) {
    ...
    inline def setStyles(value: js.Array[japgolly.scalajs.react.facade.React.Element] | ReactFragment): Self = StObject.set(x, "styles", value.asInstanceOf[js.Any])
    
    inline def setStylesUndefined: Self = StObject.set(x, "styles", js.undefined)
    
    inline def setStylesVarargs(value: japgolly.scalajs.react.facade.React.Element*): Self = StObject.set(x, "styles", js.Array(value*))
