...
import typingsJapgolly.next.nextStrings.level
...
trait Option extends StObject {
  ...
  val max: typingsJapgolly.next.nextInts.`1`
...
object Option {
  ...
  extension [Self <: Option](x: Self) {
    ...
    inline def setMax(value: typingsJapgolly.next.nextInts.`1`): Self = StObject.set(x, "max", value.asInstanceOf[js.Any])
