...
import typingsJapgolly.next.nextInts.`100`
import typingsJapgolly.next.nextStrings.quality
...
trait Max extends StObject {
  ...
  val min: typingsJapgolly.next.nextInts.`0`
...
object Max {
  ...
  extension [Self <: Max](x: Self) {
    ...
    inline def setMin(value: typingsJapgolly.next.nextInts.`0`): Self = StObject.set(x, "min", value.asInstanceOf[js.Any])
