...
trait Req extends StObject {
  ...
  var resBuffers: js.Array[typingsJapgolly.node.bufferMod.global.Buffer]
...
object Req {
  ...
  inline def apply(
    req: Any,
    res: Any,
    resBuffers: js.Array[typingsJapgolly.node.bufferMod.global.Buffer],
  ...
  extension [Self <: Req](x: Self) {
    ...
    inline def setResBuffers(value: js.Array[typingsJapgolly.node.bufferMod.global.Buffer]): Self = StObject.set(x, "resBuffers", value.asInstanceOf[js.Any])
    
    inline def setResBuffersVarargs(value: typingsJapgolly.node.bufferMod.global.Buffer*): Self = StObject.set(x, "resBuffers", js.Array(value*))
