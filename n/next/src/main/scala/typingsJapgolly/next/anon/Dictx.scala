...
import typingsJapgolly.next.nextStrings.`true`
...
trait Dictx
  ...
  var __nextCustomErrorRender: js.UndefOr[typingsJapgolly.next.nextStrings.`1`] = js.undefined
  
  var __nextDataReq: js.UndefOr[typingsJapgolly.next.nextStrings.`1`] = js.undefined
  ...
  var _nextBubbleNoFallback: js.UndefOr[typingsJapgolly.next.nextStrings.`1`] = js.undefined
  
  var amp: js.UndefOr[typingsJapgolly.next.nextStrings.`1`] = js.undefined
}
object Dictx {
  ...
  extension [Self <: Dictx](x: Self) {
    ...
    inline def setAmp(value: typingsJapgolly.next.nextStrings.`1`): Self = StObject.set(x, "amp", value.asInstanceOf[js.Any])
    
    inline def setAmpUndefined: Self = StObject.set(x, "amp", js.undefined)
    
    inline def set__nextCustomErrorRender(value: typingsJapgolly.next.nextStrings.`1`): Self = StObject.set(x, "__nextCustomErrorRender", value.asInstanceOf[js.Any])
    
    inline def set__nextCustomErrorRenderUndefined: Self = StObject.set(x, "__nextCustomErrorRender", js.undefined)
    
    inline def set__nextDataReq(value: typingsJapgolly.next.nextStrings.`1`): Self = StObject.set(x, "__nextDataReq", value.asInstanceOf[js.Any])
    ...
    inline def set_nextBubbleNoFallback(value: typingsJapgolly.next.nextStrings.`1`): Self = StObject.set(x, "_nextBubbleNoFallback", value.asInstanceOf[js.Any])
