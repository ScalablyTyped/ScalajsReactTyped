...
trait FlightSegmentPath extends StObject {
  ...
  var flightSegmentPath: typingsJapgolly.next.distServerAppRenderMod.FlightSegmentPath
...
object FlightSegmentPath {
  ...
  inline def apply(
    flightSegmentPath: typingsJapgolly.next.distServerAppRenderMod.FlightSegmentPath,
  ...
  extension [Self <: FlightSegmentPath](x: Self) {
    ...
    inline def setFlightSegmentPath(value: typingsJapgolly.next.distServerAppRenderMod.FlightSegmentPath): Self = StObject.set(x, "flightSegmentPath", value.asInstanceOf[js.Any])
