...
object FlushToDisk {
  ...
  inline def apply(
    dev: Boolean,
    fs: CacheFs,
    getPrerenderManifest: CallbackTo[PrerenderManifest],
    serverDistDir: String
  ): FlushToDisk = {
    val __obj = js.Dynamic.literal(dev = dev.asInstanceOf[js.Any], fs = fs.asInstanceOf[js.Any], getPrerenderManifest = getPrerenderManifest.toJsFn, serverDistDir = serverDistDir.asInstanceOf[js.Any])
  ...
  extension [Self <: FlushToDisk](x: Self) {
    ...
    inline def setGetPrerenderManifest(value: CallbackTo[PrerenderManifest]): Self = StObject.set(x, "getPrerenderManifest", value.toJsFn)
