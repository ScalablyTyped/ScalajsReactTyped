...
import typingsJapgolly.next.distSharedLibRouterRouterMod.AppComponent
import typingsJapgolly.next.distSharedLibRouterRouterMod.PrivateRouteInfo
import typingsJapgolly.next.distSharedLibRouterRouterMod.Subscription
...
trait Component extends StObject {
  ...
  var domainLocales: js.UndefOr[js.Array[typingsJapgolly.next.distServerConfigSharedMod.DomainLocale]] = js.undefined
...
object Component {
  ...
  extension [Self <: Component](x: Self) {
    ...
    inline def setDomainLocales(value: js.Array[typingsJapgolly.next.distServerConfigSharedMod.DomainLocale]): Self = StObject.set(x, "domainLocales", value.asInstanceOf[js.Any])
    
    inline def setDomainLocalesUndefined: Self = StObject.set(x, "domainLocales", js.undefined)
    
    inline def setDomainLocalesVarargs(value: typingsJapgolly.next.distServerConfigSharedMod.DomainLocale*): Self = StObject.set(x, "domainLocales", js.Array(value*))
