...
trait RestrictedRedirectPathsRule extends StObject {
  ...
  var rule: typingsJapgolly.next.distLibLoadCustomRoutesMod.Redirect
}
object RestrictedRedirectPathsRule {
  
  inline def apply(
    restrictedRedirectPaths: js.Array[String],
    rule: typingsJapgolly.next.distLibLoadCustomRoutesMod.Redirect
  ): RestrictedRedirectPathsRule = {
  ...
  extension [Self <: RestrictedRedirectPathsRule](x: Self) {
    ...
    inline def setRule(value: typingsJapgolly.next.distLibLoadCustomRoutesMod.Redirect): Self = StObject.set(x, "rule", value.asInstanceOf[js.Any])
  }
}
