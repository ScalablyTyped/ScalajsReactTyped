...
/* Inlined std.Omit<react.react.AnchorHTMLAttributes<std.HTMLAnchorElement>, keyof next.next/dist/client/link.InternalLinkProps> & next.next/dist/client/link.InternalLinkProps & {  children :react.react.ReactNode | undefined} & react.react.RefAttributes<std.HTMLAnchorElement> */
trait OmitAnchorHTMLAttributesH extends StObject {
  ...
  var `aria-current`: js.UndefOr[Boolean | page_ | step | location | date | time] = js.undefined
  ...
  var as: js.UndefOr[typingsJapgolly.next.distClientLinkMod.Url] = js.undefined
  ...
  var href: typingsJapgolly.next.distClientLinkMod.Url
...
object OmitAnchorHTMLAttributesH {
  ...
  inline def apply(href: typingsJapgolly.next.distClientLinkMod.Url): OmitAnchorHTMLAttributesH = {
  ...
  extension [Self <: OmitAnchorHTMLAttributesH](x: Self) {
    ...
    inline def `setAria-current`(value: Boolean | page_ | step | location | date | time): Self = StObject.set(x, "aria-current", value.asInstanceOf[js.Any])
    ...
    inline def setAs(value: typingsJapgolly.next.distClientLinkMod.Url): Self = StObject.set(x, "as", value.asInstanceOf[js.Any])
    ...
    inline def setHref(value: typingsJapgolly.next.distClientLinkMod.Url): Self = StObject.set(x, "href", value.asInstanceOf[js.Any])
    ...
    inline def setOnMouseEnter(value: /* e */ Any => Callback): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction1((t0: /* e */ Any) => value(t0).runNow()))
    ...
    inline def setOnTouchStart(value: /* e */ Any => Callback): Self = StObject.set(x, "onTouchStart", js.Any.fromFunction1((t0: /* e */ Any) => value(t0).runNow()))
