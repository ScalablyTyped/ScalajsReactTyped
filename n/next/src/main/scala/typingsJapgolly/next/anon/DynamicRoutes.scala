...
trait DynamicRoutes extends StObject {
  ...
  var rewrites: BeforeFilesFallback
...
object DynamicRoutes {
  ...
  extension [Self <: DynamicRoutes](x: Self) {
    ...
    inline def setRewrites(value: BeforeFilesFallback): Self = StObject.set(x, "rewrites", value.asInstanceOf[js.Any])
