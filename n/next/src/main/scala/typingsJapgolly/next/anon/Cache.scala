...
object Cache {
  ...
  inline def apply(
    ...
    cacheStorage: CallbackTo[CacheStorage]
  ): Cache = {
    val __obj = js.Dynamic.literal(Cache = Cache.asInstanceOf[js.Any], CacheStorage = CacheStorage.asInstanceOf[js.Any], cacheStorage = cacheStorage.toJsFn)
