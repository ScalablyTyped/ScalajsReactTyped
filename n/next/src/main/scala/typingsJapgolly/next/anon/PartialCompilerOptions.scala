...
/* Inlined std.Partial<typescript.typescript.CompilerOptions> */
trait PartialCompilerOptions extends StObject {
...
object PartialCompilerOptions {
  
  inline def apply(): PartialCompilerOptions = {
