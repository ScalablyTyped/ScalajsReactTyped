...
import typingsJapgolly.next.nextStrings.dts
import typingsJapgolly.next.nextStrings.js_
import typingsJapgolly.next.nextStrings.quit
...
trait TypeofimportedTypescript extends StObject {
  ...
  def convertCompilerOptionsFromJson(jsonOptions: Any, basePath: String): typingsJapgolly.typescript.anon.Errors = js.native
  def convertCompilerOptionsFromJson(jsonOptions: Any, basePath: String, configFileName: String): typingsJapgolly.typescript.anon.Errors = js.native
  
  def convertToObject(sourceFile: JsonSourceFile, errors: Push[Diagnostic]): Any = js.native
  
  def convertTypeAcquisitionFromJson(jsonOptions: Any, basePath: String): typingsJapgolly.typescript.anon.Options = js.native
  def convertTypeAcquisitionFromJson(jsonOptions: Any, basePath: String, configFileName: String): typingsJapgolly.typescript.anon.Options = js.native
  ...
  def getImpliedNodeFormatForFile(
    fileName: typingsJapgolly.typescript.mod.Path,
  ...
  def getParsedCommandLineOfConfigFile(
    ...
    optionsToExtend: Unit,
    host: ParseConfigFileHost,
    extendedConfigCache: typingsJapgolly.typescript.mod.Map[ExtendedConfigCacheEntry]
  ): js.UndefOr[ParsedCommandLine] = js.native
  def getParsedCommandLineOfConfigFile(
    configFileName: String,
    optionsToExtend: Unit,
  ...
  def parseConfigFileTextToJson(fileName: String, jsonText: String): typingsJapgolly.typescript.anon.Config = js.native
  ...
  def parseJsonConfigFileContent(
    ...
    resolutionStack: js.UndefOr[js.Array[typingsJapgolly.typescript.mod.Path]],
    extraFileExtensions: js.UndefOr[js.Array[FileExtensionInfo]],
    extendedConfigCache: js.UndefOr[typingsJapgolly.typescript.mod.Map[ExtendedConfigCacheEntry]],
  ...
  def readConfigFile(fileName: String, readFile: js.Function1[/* path */ String, js.UndefOr[String]]): typingsJapgolly.typescript.anon.Config = js.native
  ...
  def visitEachChild[T /* <: Node */](
    ...
    visitor: Visitor,
    context: TransformationContext,
    nodesVisitor: typingsJapgolly.typescript.anon.FnCall
  ): js.UndefOr[T] = js.native
  def visitEachChild[T /* <: Node */](
    node: T,
    visitor: Visitor,
