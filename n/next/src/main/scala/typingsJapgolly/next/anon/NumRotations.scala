...
trait NumRotations extends StObject {
  ...
  val numRotations: typingsJapgolly.next.nextInts.`0`
}
object NumRotations {
  ...
  extension [Self <: NumRotations](x: Self) {
    ...
    inline def setNumRotations(value: typingsJapgolly.next.nextInts.`0`): Self = StObject.set(x, "numRotations", value.asInstanceOf[js.Any])
  }
}
