...
import typingsJapgolly.next.distBuildWebpackLoadersGetModuleBuildInfoMod.EdgeMiddlewareMeta
import typingsJapgolly.next.distBuildWebpackLoadersGetModuleBuildInfoMod.EdgeSSRMeta
import typingsJapgolly.next.distBuildWebpackLoadersGetModuleBuildInfoMod.RSCMeta
import typingsJapgolly.next.distBuildWebpackLoadersGetModuleBuildInfoMod.RouteMeta
...
trait ImportLocByPath extends StObject {
  ...
  var importLocByPath: js.UndefOr[typingsJapgolly.std.Map[String, Any]] = js.undefined
...
object ImportLocByPath {
  ...
  extension [Self <: ImportLocByPath](x: Self) {
    ...
    inline def setImportLocByPath(value: typingsJapgolly.std.Map[String, Any]): Self = StObject.set(x, "importLocByPath", value.asInstanceOf[js.Any])
