...
import typingsJapgolly.next.anon.AppDirEnabled
...
object distBuildWebpackPluginsBuildManifestPluginMod {
  ...
  object BuildManifestPlugin {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(appDirEnabled = appDirEnabled.asInstanceOf[js.Any], apply = js.Any.fromFunction1((t0: Compiler) => apply(t0).runNow()), buildId = buildId.asInstanceOf[js.Any], createAssets = js.Any.fromFunction3(createAssets), exportRuntime = exportRuntime.asInstanceOf[js.Any], isDevFallback = isDevFallback.asInstanceOf[js.Any], rewrites = rewrites.asInstanceOf[js.Any])
