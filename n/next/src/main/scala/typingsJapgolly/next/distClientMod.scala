...
object distClientMod {
  ...
  object global {
    ...
    object Window {
      ...
      inline def apply(__NEXT_DATA__ : NEXT_DATA, __NEXT_P: js.Array[Any]): typingsJapgolly.next.distClientMod.global.Window = {
        val __obj = js.Dynamic.literal(__NEXT_DATA__ = __NEXT_DATA__.asInstanceOf[js.Any], __NEXT_P = __NEXT_P.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.next.distClientMod.global.Window]
      }
      
      extension [Self <: typingsJapgolly.next.distClientMod.global.Window](x: Self) {
        ...
        inline def set__NEXT_HYDRATED_CB(value: Callback): Self = StObject.set(x, "__NEXT_HYDRATED_CB", value.toJsFn)
        ...
        inline def set__NEXT_PRELOADREADY(value: /* ids */ js.UndefOr[js.Array[String | Double]] => Callback): Self = StObject.set(x, "__NEXT_PRELOADREADY", js.Any.fromFunction1((t0: /* ids */ js.UndefOr[js.Array[String | Double]]) => value(t0).runNow()))
