...
object distBuildWebpackLoadersErrorLoaderMod extends Shortcut {
  
  @JSImport("next/dist/build/webpack/loaders/error-loader", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distBuildWebpackLoadersErrorLoaderMod.foo` */
