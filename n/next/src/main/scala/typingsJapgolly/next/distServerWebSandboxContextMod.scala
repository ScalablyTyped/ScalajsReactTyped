...
import typingsJapgolly.next.anon.EvaluateInContext
import typingsJapgolly.next.anon.PickEdgeFunctionDefinitio
...
object distServerWebSandboxContextMod {
  ...
  object ModuleContextOptions {
    ...
    inline def apply(
      ...
      env: js.Array[String],
      moduleName: String,
      onWarning: js.Error => Callback,
      useCache: Boolean
    ): ModuleContextOptions = {
      val __obj = js.Dynamic.literal(distDir = distDir.asInstanceOf[js.Any], edgeFunctionEntry = edgeFunctionEntry.asInstanceOf[js.Any], env = env.asInstanceOf[js.Any], moduleName = moduleName.asInstanceOf[js.Any], onWarning = js.Any.fromFunction1((t0: js.Error) => onWarning(t0).runNow()), useCache = useCache.asInstanceOf[js.Any])
    ...
    extension [Self <: ModuleContextOptions](x: Self) {
      ...
      inline def setOnWarning(value: js.Error => Callback): Self = StObject.set(x, "onWarning", js.Any.fromFunction1((t0: js.Error) => value(t0).runNow()))
