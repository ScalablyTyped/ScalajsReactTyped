...
import typingsJapgolly.next.`distCompiled@edgeRuntimePrimitivesEventsMod`.EventTarget.AddOptions
import typingsJapgolly.next.`distCompiled@edgeRuntimePrimitivesEventsMod`.EventTarget.EventData
import typingsJapgolly.next.`distCompiled@edgeRuntimePrimitivesEventsMod`.EventTarget.EventListener
import typingsJapgolly.next.`distCompiled@edgeRuntimePrimitivesEventsMod`.EventTarget.FallbackEvent
import typingsJapgolly.next.`distCompiled@edgeRuntimePrimitivesEventsMod`.EventTarget.FallbackEventListener
import typingsJapgolly.next.`distCompiled@edgeRuntimePrimitivesEventsMod`.EventTarget.Options
import typingsJapgolly.next.anon.Abort
import typingsJapgolly.next.nextStrings.standard
import typingsJapgolly.next.nextStrings.strict
...
object `distCompiled@edgeRuntimePrimitivesEventsMod` {
  ...
  object EventTarget {
    ...
    object CallbackObject {
      ...
      inline def apply[TEvent /* <: Event1[String] */](handleEvent: TEvent => Callback): CallbackObject[TEvent] = {
