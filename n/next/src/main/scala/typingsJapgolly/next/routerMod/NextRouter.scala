package typingsJapgolly.next.routerMod

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.next.mittMod.MittEmitter
import typingsJapgolly.node.querystringMod.ParsedUrlQuery
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* Inlined next.next/dist/next-server/lib/router/router.BaseRouter & std.Pick<next.next/dist/next-server/lib/router/router.Router, 'push' | 'replace' | 'reload' | 'back' | 'prefetch' | 'beforePopState' | 'events'> */
...
object NextRouter {
  ...
  def apply(
    ...
    __obj.updateDynamic("beforePopState")(js.Any.fromFunction1((t0: /* cb */ typingsJapgolly.next.routerMod.BeforePopStateCallback) => beforePopState(t0).runNow()))
    __obj.updateDynamic("prefetch")(js.Any.fromFunction1((t0: /* url */ java.lang.String) => prefetch(t0).runNow()))
    __obj.updateDynamic("push")(js.Any.fromFunction3((t0: /* url */ typingsJapgolly.next.routerMod.Url, t1: /* as */ js.UndefOr[typingsJapgolly.next.routerMod.Url], t2: /* options */ js.UndefOr[js.Object]) => push(t0, t1, t2).runNow()))
    __obj.updateDynamic("reload")(reload.toJsFn)
    __obj.updateDynamic("replace")(js.Any.fromFunction3((t0: /* url */ typingsJapgolly.next.routerMod.Url, t1: /* as */ js.UndefOr[typingsJapgolly.next.routerMod.Url], t2: /* options */ js.UndefOr[js.Object]) => replace(t0, t1, t2).runNow()))
