...
object EmscriptenWasm {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.next.nextStrings.WEB
    - typingsJapgolly.next.nextStrings.NODE
    - typingsJapgolly.next.nextStrings.SHELL
    - typingsJapgolly.next.nextStrings.WORKER
  */
  trait EnvironmentType extends StObject
  object EnvironmentType {
    
    inline def NODE: typingsJapgolly.next.nextStrings.NODE = "NODE".asInstanceOf[typingsJapgolly.next.nextStrings.NODE]
    
    inline def SHELL: typingsJapgolly.next.nextStrings.SHELL = "SHELL".asInstanceOf[typingsJapgolly.next.nextStrings.SHELL]
    
    inline def WEB: typingsJapgolly.next.nextStrings.WEB = "WEB".asInstanceOf[typingsJapgolly.next.nextStrings.WEB]
    
    inline def WORKER: typingsJapgolly.next.nextStrings.WORKER = "WORKER".asInstanceOf[typingsJapgolly.next.nextStrings.WORKER]
  }
