...
import typingsJapgolly.next.distBuildAnalysisGetPageStaticInfoMod.MiddlewareMatcher
...
object distClientRouteLoaderMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.next.distClientRouteLoaderMod.LoadedEntrypointSuccess
    - typingsJapgolly.next.distClientRouteLoaderMod.LoadedEntrypointFailure
  */
  trait RouteEntrypoint extends StObject
  object RouteEntrypoint {
    
    inline def LoadedEntrypointFailure(error: Any): typingsJapgolly.next.distClientRouteLoaderMod.LoadedEntrypointFailure = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.next.distClientRouteLoaderMod.LoadedEntrypointFailure]
    }
    
    inline def LoadedEntrypointSuccess(component: ComponentType[js.Object], exports: Any): typingsJapgolly.next.distClientRouteLoaderMod.LoadedEntrypointSuccess = {
      val __obj = js.Dynamic.literal(component = component.asInstanceOf[js.Any], exports = exports.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.next.distClientRouteLoaderMod.LoadedEntrypointSuccess]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.next.distClientRouteLoaderMod.LoadedRouteSuccess
    - typingsJapgolly.next.distClientRouteLoaderMod.LoadedRouteFailure
  */
  trait RouteLoaderEntry extends StObject
  object RouteLoaderEntry {
    
    inline def LoadedRouteFailure(error: Any): typingsJapgolly.next.distClientRouteLoaderMod.LoadedRouteFailure = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.next.distClientRouteLoaderMod.LoadedRouteFailure]
    }
    
    inline def LoadedRouteSuccess(component: ComponentType[js.Object], exports: Any, styles: js.Array[RouteStyleSheet]): typingsJapgolly.next.distClientRouteLoaderMod.LoadedRouteSuccess = {
      val __obj = js.Dynamic.literal(component = component.asInstanceOf[js.Any], exports = exports.asInstanceOf[js.Any], styles = styles.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.next.distClientRouteLoaderMod.LoadedRouteSuccess]
    }
  }
  ...
  object global {
    ...
    object Window {
      ...
      inline def apply(): typingsJapgolly.next.distClientRouteLoaderMod.global.Window = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.next.distClientRouteLoaderMod.global.Window]
      }
      
      extension [Self <: typingsJapgolly.next.distClientRouteLoaderMod.global.Window](x: Self) {
