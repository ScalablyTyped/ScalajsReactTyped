...
object distClientComponentsHooksServerContextMod {
  ...
  object CONTEXT_NAMES {
    ...
    @js.native
    val CookiesContext: typingsJapgolly.next.nextStrings.CookiesContext = js.native
    
    @JSImport("next/dist/client/components/hooks-server-context", "CONTEXT_NAMES.FetchRevalidateContext")
    @js.native
    val FetchRevalidateContext: typingsJapgolly.next.nextStrings.FetchRevalidateContext = js.native
    
    @JSImport("next/dist/client/components/hooks-server-context", "CONTEXT_NAMES.HeadersContext")
    @js.native
    val HeadersContext: typingsJapgolly.next.nextStrings.HeadersContext = js.native
    
    @JSImport("next/dist/client/components/hooks-server-context", "CONTEXT_NAMES.PreviewDataContext")
    @js.native
    val PreviewDataContext: typingsJapgolly.next.nextStrings.PreviewDataContext = js.native
    
    @JSImport("next/dist/client/components/hooks-server-context", "CONTEXT_NAMES.StaticGenerationContext")
    @js.native
    val StaticGenerationContext: typingsJapgolly.next.nextStrings.StaticGenerationContext = js.native
  }
