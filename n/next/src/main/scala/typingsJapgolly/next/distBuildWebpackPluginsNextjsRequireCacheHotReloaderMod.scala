...
import typingsJapgolly.next.anon.HasServerComponents
...
object distBuildWebpackPluginsNextjsRequireCacheHotReloaderMod {
  ...
  type Compiler = typingsJapgolly.next.distCompiledWebpackWebpackMod.webpack.Compiler
  
  type WebpackPluginInstance = typingsJapgolly.next.distCompiledWebpackWebpackMod.webpack.WebpackPluginInstance
}
