...
import typingsJapgolly.next.anon.CurRevalidate
...
import typingsJapgolly.next.nextStrings.IMAGE
import typingsJapgolly.next.nextStrings.PAGE
import typingsJapgolly.next.nextStrings.REDIRECT
...
object distServerResponseCacheTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.next.distServerResponseCacheTypesMod.CachedRedirectValue
    - typingsJapgolly.next.distServerResponseCacheTypesMod.IncrementalCachedPageValue
    - typingsJapgolly.next.distServerResponseCacheTypesMod.CachedImageValue
  */
  trait IncrementalCacheValue extends StObject
  object IncrementalCacheValue {
    
    inline def CachedImageValue(buffer: Buffer, etag: String, `extension`: String): typingsJapgolly.next.distServerResponseCacheTypesMod.CachedImageValue = {
      val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any], etag = etag.asInstanceOf[js.Any], kind = "IMAGE")
      __obj.updateDynamic("extension")(`extension`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.next.distServerResponseCacheTypesMod.CachedImageValue]
    }
    
    inline def CachedRedirectValue(props: js.Object): typingsJapgolly.next.distServerResponseCacheTypesMod.CachedRedirectValue = {
      val __obj = js.Dynamic.literal(kind = "REDIRECT", props = props.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.next.distServerResponseCacheTypesMod.CachedRedirectValue]
    }
    
    inline def IncrementalCachedPageValue(html: String, pageData: js.Object): typingsJapgolly.next.distServerResponseCacheTypesMod.IncrementalCachedPageValue = {
      val __obj = js.Dynamic.literal(html = html.asInstanceOf[js.Any], kind = "PAGE", pageData = pageData.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.next.distServerResponseCacheTypesMod.IncrementalCachedPageValue]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.next.distServerResponseCacheTypesMod.CachedRedirectValue
    - typingsJapgolly.next.distServerResponseCacheTypesMod.CachedPageValue
    - typingsJapgolly.next.distServerResponseCacheTypesMod.CachedImageValue
  */
  ...
  object ResponseCacheValue {
    ...
    inline def CachedPageValue(html: default, pageData: js.Object): typingsJapgolly.next.distServerResponseCacheTypesMod.CachedPageValue = {
      val __obj = js.Dynamic.literal(html = html.asInstanceOf[js.Any], kind = "PAGE", pageData = pageData.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.next.distServerResponseCacheTypesMod.CachedPageValue]
    }
