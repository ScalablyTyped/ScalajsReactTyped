...
import typingsJapgolly.next.anon.AmpOptimizerConfig
import typingsJapgolly.next.anon.CatchAllMiddleware
import typingsJapgolly.next.anon.DevBoolean
import typingsJapgolly.next.anon.FallbackMode
import typingsJapgolly.next.anon.ForceReload
import typingsJapgolly.next.anon.GenerateEtags
import typingsJapgolly.next.anon.IsAppPath
import typingsJapgolly.next.anon.OriginalAppPath
import typingsJapgolly.next.distBuildAnalysisGetPageStaticInfoMod.MiddlewareMatcher
import typingsJapgolly.next.distBuildMod.PrerenderManifest
import typingsJapgolly.next.distBuildWebpackPluginsPagesManifestPluginMod.PagesManifest
import typingsJapgolly.next.distLibLoadCustomRoutesMod.CustomRoutes
import typingsJapgolly.next.distServerApiUtilsMod.ApiPreviewProps
...
import typingsJapgolly.next.distServerRenderMod.RenderOptsPartial
...
import typingsJapgolly.next.distServerResponseCacheTypesMod.ResponseCacheBase
import typingsJapgolly.next.distServerRouterMod.DynamicRoutes
import typingsJapgolly.next.distSharedLibRouterUtilsMiddlewareRouteMatcherMod.MiddlewareRouteMatch
...
object distServerBaseServerMod {
  ...
  trait ResponsePayload extends StObject {
    ...
    var body: typingsJapgolly.next.distServerRenderResultMod.default
  ...
  object ResponsePayload {
    ...
    inline def apply(body: typingsJapgolly.next.distServerRenderResultMod.default, `type`: html | json): ResponsePayload = {
    ...
    extension [Self <: ResponsePayload](x: Self) {
      ...
      inline def setBody(value: typingsJapgolly.next.distServerRenderResultMod.default): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
  ...
  trait Server[ServerOptions /* <: Options */] extends StObject {
    ...
    /* protected */ var router: typingsJapgolly.next.distServerRouterMod.default = js.native
