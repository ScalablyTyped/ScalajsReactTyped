...
import typingsJapgolly.next.anon.Output
...
object distLibEslintCustomFormatterMod {
  ...
  object MessageSeverity extends StObject {
    ...
    /* 2 */ val Error: typingsJapgolly.next.distLibEslintCustomFormatterMod.MessageSeverity.Error & Double = js.native
    
    @js.native
    sealed trait Warning
      extends StObject
         with MessageSeverity
    /* 1 */ val Warning: typingsJapgolly.next.distLibEslintCustomFormatterMod.MessageSeverity.Warning & Double = js.native
  }
