...
import typingsJapgolly.next.anon.IsDev
import typingsJapgolly.next.anon.PartialMiddlewareConfig
import typingsJapgolly.next.anon.Ssg
...
object distBuildAnalysisGetPageStaticInfoMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.next.nextStrings.server
    - typingsJapgolly.next.nextStrings.client
  */
  trait RSCModuleType extends StObject
  object RSCModuleType {
    
    inline def client: typingsJapgolly.next.nextStrings.client = "client".asInstanceOf[typingsJapgolly.next.nextStrings.client]
    
    inline def server: typingsJapgolly.next.nextStrings.server = "server".asInstanceOf[typingsJapgolly.next.nextStrings.server]
  }
}
