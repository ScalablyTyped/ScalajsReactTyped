...
import typingsJapgolly.next.anon.Context
import typingsJapgolly.next.anon.SriEnabled
...
import typingsJapgolly.next.nextInts.`2`
...
object distBuildWebpackPluginsMiddlewarePluginMod {
  ...
  object MiddlewarePlugin {
    ...
    inline def apply(apply: Compiler => Callback, dev: Any, sriEnabled: Any): MiddlewarePlugin = {
      val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1((t0: Compiler) => apply(t0).runNow()), dev = dev.asInstanceOf[js.Any], sriEnabled = sriEnabled.asInstanceOf[js.Any])
