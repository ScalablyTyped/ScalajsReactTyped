...
import typingsJapgolly.next.anon.AsPath
import typingsJapgolly.next.anon.PagesArray
import typingsJapgolly.next.distBuildAnalysisGetPageStaticInfoMod.MiddlewareMatcher
import typingsJapgolly.next.distClientRouteLoaderMod.RouteLoader
...
object distClientPageLoaderMod {
  ...
  object PageLoader {
    ...
    inline def apply(
      ...
      getMiddleware: CallbackTo[
          js.UndefOr[js.Array[MiddlewareMatcher] | js.Promise[js.Array[MiddlewareMatcher]]]
        ],
      getPageList: CallbackTo[js.Array[String] | js.Promise[js.Array[String]]],
    ...
    extension [Self <: PageLoader](x: Self) {
      ...
      ): Self = StObject.set(x, "getMiddleware", value.toJsFn)
      
      inline def setGetPageList(value: CallbackTo[js.Array[String] | js.Promise[js.Array[String]]]): Self = StObject.set(x, "getPageList", value.toJsFn)
  ...
  object global {
    ...
    object Window {
      ...
      inline def apply(): typingsJapgolly.next.distClientPageLoaderMod.global.Window = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.next.distClientPageLoaderMod.global.Window]
      }
      
      extension [Self <: typingsJapgolly.next.distClientPageLoaderMod.global.Window](x: Self) {
        ...
        inline def set__SSG_MANIFEST_CB(value: Callback): Self = StObject.set(x, "__SSG_MANIFEST_CB", value.toJsFn)
