...
object distServerLibSquooshWebpWebpEncMod {
  
  @JSImport("next/dist/server/lib/squoosh/webp/webp_enc", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("next/dist/server/lib/squoosh/webp/webp_enc", JSImport.Default)
  @js.native
