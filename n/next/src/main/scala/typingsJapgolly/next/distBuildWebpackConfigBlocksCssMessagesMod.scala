...
object distBuildWebpackConfigBlocksCssMessagesMod {
  
  @JSImport("next/dist/build/webpack/config/blocks/css/messages", JSImport.Namespace)
  @js.native
  ...
  inline def getLocalModuleImportError(): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getLocalModuleImportError")().asInstanceOf[String]
}
