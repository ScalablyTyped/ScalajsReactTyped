...
import typingsJapgolly.next.anon.AfterFiles
import typingsJapgolly.next.anon.Key
...
import typingsJapgolly.next.nextStrings.middleware
import typingsJapgolly.next.nextStrings.query
import typingsJapgolly.next.nextStrings.redirect_
...
object distLibLoadCustomRoutesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.next.anon.statusCodeneverundefinedp
    - typingsJapgolly.next.anon.statusCodenumberpermanent
  */
  trait Redirect extends StObject
  object Redirect {
    
    inline def statusCodeneverundefinedp(destination: String, permanent: Boolean, source: String): typingsJapgolly.next.anon.statusCodeneverundefinedp = {
      ...
      __obj.asInstanceOf[typingsJapgolly.next.anon.statusCodeneverundefinedp]
    }
    
    inline def statusCodenumberpermanent(destination: String, source: String, statusCode: Double): typingsJapgolly.next.anon.statusCodenumberpermanent = {
      ...
      __obj.asInstanceOf[typingsJapgolly.next.anon.statusCodenumberpermanent]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.next.anon.Type
    - typingsJapgolly.next.anon.KeyType
  */
  trait RouteHas extends StObject
  object RouteHas {
    
    inline def KeyType(key: Unit, value: String): typingsJapgolly.next.anon.KeyType = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("host")
      __obj.asInstanceOf[typingsJapgolly.next.anon.KeyType]
    }
    
    inline def Type(key: String, `type`: header | query | cookie): typingsJapgolly.next.anon.Type = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.next.anon.Type]
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.next.nextStrings.rewrite
    - typingsJapgolly.next.nextStrings.redirect_
    - typingsJapgolly.next.nextStrings.header
  */
  trait RouteType extends StObject
  object RouteType {
    
    inline def header: typingsJapgolly.next.nextStrings.header = "header".asInstanceOf[typingsJapgolly.next.nextStrings.header]
    
    inline def redirect: redirect_ = "redirect".asInstanceOf[redirect_]
    
    inline def rewrite: typingsJapgolly.next.nextStrings.rewrite = "rewrite".asInstanceOf[typingsJapgolly.next.nextStrings.rewrite]
  }
}
