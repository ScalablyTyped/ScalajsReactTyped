...
import typingsJapgolly.next.anon.Match
...
object distServerRouterMod {
  ...
  open class default protected ()
    extends StObject
       with Router {
    def this(hasHeadersFsRoutesRewritesRedirectsCatchAllRouteCatchAllMiddlewareDynamicRoutesPageCheckerUseFileSystemPublicRoutesNextConfig: typingsJapgolly.next.anon.DynamicRoutes) = this()
  }
