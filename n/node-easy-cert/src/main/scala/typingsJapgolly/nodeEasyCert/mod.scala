package typingsJapgolly.nodeEasyCert
...
object mod {
  ...
  */
  ...
  object CertErrors {
    ...
    inline def ROOT_CA_COMMON_NAME_UNSPECIFIED: typingsJapgolly.nodeEasyCert.nodeEasyCertStrings.ROOT_CA_COMMON_NAME_UNSPECIFIED = "ROOT_CA_COMMON_NAME_UNSPECIFIED".asInstanceOf[typingsJapgolly.nodeEasyCert.nodeEasyCertStrings.ROOT_CA_COMMON_NAME_UNSPECIFIED]
    
    inline def ROOT_CA_EXISTED: typingsJapgolly.nodeEasyCert.nodeEasyCertStrings.ROOT_CA_EXISTED = "ROOT_CA_EXISTED".asInstanceOf[typingsJapgolly.nodeEasyCert.nodeEasyCertStrings.ROOT_CA_EXISTED]
    
    inline def ROOT_CA_NOT_EXISTS: typingsJapgolly.nodeEasyCert.nodeEasyCertStrings.ROOT_CA_NOT_EXISTS = "ROOT_CA_NOT_EXISTS".asInstanceOf[typingsJapgolly.nodeEasyCert.nodeEasyCertStrings.ROOT_CA_NOT_EXISTS]
  }
  ...
  */
  ...
  object CertificateAttribute {
    ...
    inline def CertificateAttributeName(name: String, value: String): typingsJapgolly.nodeEasyCert.mod.CertificateAttributeName = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.nodeEasyCert.mod.CertificateAttributeName]
    }
    
    inline def CertificateAttributeShortName(shortName: String, value: String): typingsJapgolly.nodeEasyCert.mod.CertificateAttributeShortName = {
      val __obj = js.Dynamic.literal(shortName = shortName.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.nodeEasyCert.mod.CertificateAttributeShortName]
    }
  }
