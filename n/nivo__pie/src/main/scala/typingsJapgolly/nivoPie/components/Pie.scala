...
import typingsJapgolly.nivoPie.mod.PieSvgProps
...
object Pie {
  def apply(
    ...
    PieSvgProps with Dimensions, 
    typingsJapgolly.nivoPie.mod.Pie, 
    Unit, 
    PieSvgProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoPie.mod.PieSvgProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoPie.mod.Pie](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoPie.mod.PieSvgProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
