...
object ResponsivePie {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PieSvgProps, typingsJapgolly.nivoPie.mod.ResponsivePie, Unit, PieSvgProps] = {
  ...
  typingsJapgolly.nivoPie.mod.PieSvgProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoPie.mod.ResponsivePie](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoPie.mod.PieSvgProps])(children: _*)
  }
