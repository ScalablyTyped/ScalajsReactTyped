...
object PieCanvas {
  def apply(
    ...
    PieCanvasProps with Dimensions, 
    typingsJapgolly.nivoPie.mod.PieCanvas, 
    Unit, 
    PieCanvasProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoPie.mod.PieCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoPie.mod.PieCanvas](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoPie.mod.PieCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
