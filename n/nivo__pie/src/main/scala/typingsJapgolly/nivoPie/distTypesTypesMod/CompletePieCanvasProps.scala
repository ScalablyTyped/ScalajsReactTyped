...
object CompletePieCanvasProps {
  ...
  extension [Self <: CompletePieCanvasProps[?], RawDatum](x: Self & CompletePieCanvasProps[RawDatum]) {
    ...
    ): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* datum */ ComputedDatum[RawDatum], t1: /* event */ ReactMouseEventFrom[HTMLCanvasElement & org.scalajs.dom.Element]) => (value(t0, t1)).runNow()))
    
    inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
    
    inline def setOnMouseMove(
      value: (/* datum */ ComputedDatum[RawDatum], /* event */ ReactMouseEventFrom[HTMLCanvasElement & org.scalajs.dom.Element]) => Callback
    ): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction2((t0: /* datum */ ComputedDatum[RawDatum], t1: /* event */ ReactMouseEventFrom[HTMLCanvasElement & org.scalajs.dom.Element]) => (value(t0, t1)).runNow()))
