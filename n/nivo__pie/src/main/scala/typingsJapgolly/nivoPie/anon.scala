...
object anon {
  ...
  object ArcGenerator {
    ...
    inline def apply[RawDatum](
      ...
      setActiveId: SetStateAction[DatumId | Null] => Callback,
      toggleSerie: DatumId => Callback
    ): ArcGenerator[RawDatum] = {
      val __obj = js.Dynamic.literal(arcGenerator = arcGenerator.asInstanceOf[js.Any], dataWithArc = dataWithArc.asInstanceOf[js.Any], legendData = legendData.asInstanceOf[js.Any], setActiveId = js.Any.fromFunction1((t0: SetStateAction[DatumId | Null]) => setActiveId(t0).runNow()), toggleSerie = js.Any.fromFunction1((t0: DatumId) => toggleSerie(t0).runNow()))
    ...
    extension [Self <: ArcGenerator[?], RawDatum](x: Self & ArcGenerator[RawDatum]) {
      ...
      inline def setSetActiveId(value: SetStateAction[DatumId | Null] => Callback): Self = StObject.set(x, "setActiveId", js.Any.fromFunction1((t0: SetStateAction[DatumId | Null]) => value(t0).runNow()))
  ...
  object CenterX {
    ...
    extension [Self <: CenterX[?], RawDatum](x: Self & CenterX[RawDatum]) {
      ...
      inline def setSetActiveId(value: SetStateAction[String | Double | Null] => Callback): Self = StObject.set(x, "setActiveId", js.Any.fromFunction1((t0: SetStateAction[String | Double | Null]) => value(t0).runNow()))
