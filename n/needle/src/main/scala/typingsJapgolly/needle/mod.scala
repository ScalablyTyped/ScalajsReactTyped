...
import typingsJapgolly.needle.needleStrings.auto
import typingsJapgolly.needle.needleStrings.basic
import typingsJapgolly.needle.needleStrings.digest
...
object mod {
  ...
  ): js.Promise[typingsJapgolly.needle.mod.core.NeedleResponse] = (^.asInstanceOf[js.Dynamic].apply(method.asInstanceOf[js.Any], url.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.needle.mod.core.NeedleResponse]]
  inline def apply(
    method: typingsJapgolly.needle.mod.core.NeedleHttpVerbs,
    url: String,
    data: typingsJapgolly.needle.mod.core.BodyData,
    options: typingsJapgolly.needle.mod.core.NeedleOptions
  ): js.Promise[typingsJapgolly.needle.mod.core.NeedleResponse] = (^.asInstanceOf[js.Dynamic].apply(method.asInstanceOf[js.Any], url.asInstanceOf[js.Any], data.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.needle.mod.core.NeedleResponse]]
  /**
    * Calling needle() directly returns a Promise.
    *
    * Since needle 2.0
    * @param method Designates an HTTP verb for the request.
    */
  inline def apply(method: NeedleReadonlyHttpVerbs, url: String): js.Promise[typingsJapgolly.needle.mod.core.NeedleResponse] = (^.asInstanceOf[js.Dynamic].apply(method.asInstanceOf[js.Any], url.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.needle.mod.core.NeedleResponse]]
  inline def apply(
    method: NeedleReadonlyHttpVerbs,
    url: String,
    options: typingsJapgolly.needle.mod.core.NeedleOptions
  ): js.Promise[typingsJapgolly.needle.mod.core.NeedleResponse] = (^.asInstanceOf[js.Dynamic].apply(method.asInstanceOf[js.Any], url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.needle.mod.core.NeedleResponse]]
  ...
  type BodyData = typingsJapgolly.needle.mod.core.BodyData
  
  type Cookies = typingsJapgolly.needle.mod.core.Cookies
  
  type NeedleCallback = typingsJapgolly.needle.mod.core.NeedleCallback
  
  type NeedleHttpVerbs = typingsJapgolly.needle.mod.core.NeedleHttpVerbs
  
  type NeedleOptions = typingsJapgolly.needle.mod.core.NeedleOptions
  
  type NeedleResponse = typingsJapgolly.needle.mod.core.NeedleResponse
  
  type ReadableStream = typingsJapgolly.needle.mod.core.ReadableStream
  
  object core {
    
    type BodyData = Buffer | KeyValue | typingsJapgolly.node.NodeJS.ReadableStream | String | Null
    ...
    */
    ...
    object NeedleHttpVerbs {
      ...
      inline def delete: typingsJapgolly.needle.needleStrings.delete = "delete".asInstanceOf[typingsJapgolly.needle.needleStrings.delete]
      
      inline def get: typingsJapgolly.needle.needleStrings.get = "get".asInstanceOf[typingsJapgolly.needle.needleStrings.get]
      
      inline def head: typingsJapgolly.needle.needleStrings.head = "head".asInstanceOf[typingsJapgolly.needle.needleStrings.head]
      
      inline def patch: typingsJapgolly.needle.needleStrings.patch = "patch".asInstanceOf[typingsJapgolly.needle.needleStrings.patch]
      
      inline def post: typingsJapgolly.needle.needleStrings.post = "post".asInstanceOf[typingsJapgolly.needle.needleStrings.post]
      
      inline def put: typingsJapgolly.needle.needleStrings.put = "put".asInstanceOf[typingsJapgolly.needle.needleStrings.put]
    }
    
    /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
    - typingsJapgolly.node.httpMod.ClientRequestArgs because var conflicts: agent, auth, headers, localAddress, timeout. Inlined port, protocol, method, defaultPort, setHost, _defaultAgent, hostname, maxHeaderSize, host, socketPath, createConnection, path, family, signal, lookup
    - typingsJapgolly.node.httpsMod.RequestOptions because var conflicts: agent, auth, headers, localAddress, timeout. Inlined servername, rejectUnauthorized */ trait NeedleOptions
      extends StObject
         with RequestOptions
    ...
    object NeedleOptions {
      ...
      inline def apply(): typingsJapgolly.needle.mod.core.NeedleOptions = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.needle.mod.core.NeedleOptions]
      }
      
      extension [Self <: typingsJapgolly.needle.mod.core.NeedleOptions](x: Self) {
        
        inline def setCreateConnection(
          value: (typingsJapgolly.needle.mod.core.NeedleOptions, /* oncreate */ js.Function2[/* err */ js.Error, /* socket */ Socket, Unit]) => Socket
    ...
    */
    ...
    trait NeedleResponse extends IncomingMessage {
      ...
      var cookies: js.UndefOr[typingsJapgolly.needle.mod.core.Cookies] = js.native
    ...
    trait RequestOptions extends StObject {
      ...
      /**
        ...
        */
      var cookies: js.UndefOr[typingsJapgolly.needle.mod.core.Cookies] = js.undefined
    ...
    object RequestOptions {
      ...
      extension [Self <: RequestOptions](x: Self) {
        ...
        inline def setCookies(value: typingsJapgolly.needle.mod.core.Cookies): Self = StObject.set(x, "cookies", value.asInstanceOf[js.Any])
