...
import typingsJapgolly.nodelibFsWalk.anon.PartialFileSystemAdapter
...
object outSettingsMod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    override val fsScandirSettings: typingsJapgolly.nodelibFsScandir.mod.Settings = js.native
  ...
  object Settings {
    ...
    extension [Self <: Settings](x: Self) {
      ...
      inline def setFsScandirSettings(value: typingsJapgolly.nodelibFsScandir.mod.Settings): Self = StObject.set(x, "fsScandirSettings", value.asInstanceOf[js.Any])
