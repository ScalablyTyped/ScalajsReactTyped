...
import typingsJapgolly.nobleEd25519.anon.Head
...
object mod {
  ...
  object Signature {
    ...
    inline def apply(
      assertValidity: CallbackTo[Signature],
      r: Point,
      s: js.BigInt,
    ...
    extension [Self <: Signature](x: Self) {
      ...
      inline def setAssertValidity(value: CallbackTo[Signature]): Self = StObject.set(x, "assertValidity", value.toJsFn)
