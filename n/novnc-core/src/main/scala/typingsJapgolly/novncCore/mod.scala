...
import typingsJapgolly.novncCore.libInputDevicesMod.Keyboard
import typingsJapgolly.novncCore.libInputDevicesMod.Mouse
import typingsJapgolly.novncCore.novncCoreInts.`0`
import typingsJapgolly.novncCore.novncCoreInts.`1`
import typingsJapgolly.novncCore.novncCoreInts.`2`
...
object mod {
  ...
  */
  ...
  object NvConnectionState {
    ...
    inline def connected: typingsJapgolly.novncCore.novncCoreStrings.connected = "connected".asInstanceOf[typingsJapgolly.novncCore.novncCoreStrings.connected]
    
    inline def connecting: typingsJapgolly.novncCore.novncCoreStrings.connecting = "connecting".asInstanceOf[typingsJapgolly.novncCore.novncCoreStrings.connecting]
    
    inline def disconnected: typingsJapgolly.novncCore.novncCoreStrings.disconnected = "disconnected".asInstanceOf[typingsJapgolly.novncCore.novncCoreStrings.disconnected]
    
    inline def disconnecting: typingsJapgolly.novncCore.novncCoreStrings.disconnecting = "disconnecting".asInstanceOf[typingsJapgolly.novncCore.novncCoreStrings.disconnecting]
  }
  ...
  object NvRFBDefaults {
    ...
    extension [Self <: NvRFBDefaults](x: Self) {
      ...
      inline def setOnBell(value: /* rfb */ RFB => Callback): Self = StObject.set(x, "onBell", js.Any.fromFunction1((t0: /* rfb */ RFB) => value(t0).runNow()))
      
      inline def setOnBellUndefined: Self = StObject.set(x, "onBell", js.undefined)
      
      inline def setOnClipboard(value: (/* rfb */ RFB, /* text */ String) => Callback): Self = StObject.set(x, "onClipboard", js.Any.fromFunction2((t0: /* rfb */ RFB, t1: /* text */ String) => (value(t0, t1)).runNow()))
      
      inline def setOnClipboardUndefined: Self = StObject.set(x, "onClipboard", js.undefined)
      
      inline def setOnDesktopName(value: (/* rfb */ RFB, /* name */ String) => Callback): Self = StObject.set(x, "onDesktopName", js.Any.fromFunction2((t0: /* rfb */ RFB, t1: /* name */ String) => (value(t0, t1)).runNow()))
      
      inline def setOnDesktopNameUndefined: Self = StObject.set(x, "onDesktopName", js.undefined)
      
      inline def setOnDisconnected(value: (/* rfb */ RFB, /* reason */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "onDisconnected", js.Any.fromFunction2((t0: /* rfb */ RFB, t1: /* reason */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
      
      inline def setOnDisconnectedUndefined: Self = StObject.set(x, "onDisconnected", js.undefined)
      
      inline def setOnFBResize(value: (/* rfb */ RFB, /* width */ Double, /* height */ Double) => Callback): Self = StObject.set(x, "onFBResize", js.Any.fromFunction3((t0: /* rfb */ RFB, t1: /* width */ Double, t2: /* height */ Double) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnFBResizeUndefined: Self = StObject.set(x, "onFBResize", js.undefined)
      
      inline def setOnFBUComplete(value: (/* rfb */ RFB, /* fbu */ NvFBU) => Callback): Self = StObject.set(x, "onFBUComplete", js.Any.fromFunction2((t0: /* rfb */ RFB, t1: /* fbu */ NvFBU) => (value(t0, t1)).runNow()))
      
      inline def setOnFBUCompleteUndefined: Self = StObject.set(x, "onFBUComplete", js.undefined)
      
      inline def setOnFBUReceive(value: (/* rfb */ RFB, /* fbu */ NvFBU) => Callback): Self = StObject.set(x, "onFBUReceive", js.Any.fromFunction2((t0: /* rfb */ RFB, t1: /* fbu */ NvFBU) => (value(t0, t1)).runNow()))
      
      inline def setOnFBUReceiveUndefined: Self = StObject.set(x, "onFBUReceive", js.undefined)
      
      inline def setOnNotification(
        value: (/* rfb */ RFB, /* msg */ String, /* level */ normal | warn | error, /* options */ js.UndefOr[StringDictionary[Any]]) => Callback
      ): Self = StObject.set(x, "onNotification", js.Any.fromFunction4((t0: /* rfb */ RFB, t1: /* msg */ String, t2: /* level */ normal | warn | error, t3: /* options */ js.UndefOr[StringDictionary[Any]]) => (value(t0, t1, t2, t3)).runNow()))
      
      inline def setOnNotificationUndefined: Self = StObject.set(x, "onNotification", js.undefined)
      
      inline def setOnPasswordRequired(value: (/* rfb */ RFB, /* msg */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "onPasswordRequired", js.Any.fromFunction2((t0: /* rfb */ RFB, t1: /* msg */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
      
      inline def setOnPasswordRequiredUndefined: Self = StObject.set(x, "onPasswordRequired", js.undefined)
      
      inline def setOnUpdateState(
        value: (/* rfb */ RFB, /* state */ NvConnectionState, /* oldstate */ NvConnectionState) => Callback
      ): Self = StObject.set(x, "onUpdateState", js.Any.fromFunction3((t0: /* rfb */ RFB, t1: /* state */ NvConnectionState, t2: /* oldstate */ NvConnectionState) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnUpdateStateUndefined: Self = StObject.set(x, "onUpdateState", js.undefined)
      
      inline def setOnXvpInit(value: /* version */ Double => Callback): Self = StObject.set(x, "onXvpInit", js.Any.fromFunction1((t0: /* version */ Double) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.novncCore.novncCoreInts.`2`
    - typingsJapgolly.novncCore.novncCoreInts.`0`
    - typingsJapgolly.novncCore.novncCoreInts.`1`
  */
  ...
  trait RFB extends StObject {
    ...
    def get_display(): typingsJapgolly.novncCore.libDisplayMod.default = js.native
