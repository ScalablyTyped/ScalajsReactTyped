...
import typingsJapgolly.novncCore.devicesMod.Keyboard
import typingsJapgolly.novncCore.devicesMod.Mouse
...
trait RFB extends js.Object {
  ...
  def get_display(): typingsJapgolly.novncCore.displayMod.default = js.native
