...
object ServerSubscriptionOptions {
  ...
  def apply(
    ...
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction4((t0: /* path */ java.lang.String, t1: /* message */ js.Any, t2: /* options */ typingsJapgolly.nes.mod.ServerSubscriptionOptionsFilterOptions, t3: /* next */ js.Function2[/* isMatch */ scala.Boolean, /* override */ js.UndefOr[js.Any], scala.Unit]) => filter(t0, t1, t2, t3).runNow()))
