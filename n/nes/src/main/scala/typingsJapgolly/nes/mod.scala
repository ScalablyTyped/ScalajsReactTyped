...
import typingsJapgolly.nes.anon.Instantiable
...
object mod extends Shortcut {
  ...
  open class ClientCls protected ()
    extends typingsJapgolly.nes.clientMod.^ {
    def this(url: String) = this()
    def this(url: String, options: typingsJapgolly.nes.clientMod.ClientOptions) = this()
  }
