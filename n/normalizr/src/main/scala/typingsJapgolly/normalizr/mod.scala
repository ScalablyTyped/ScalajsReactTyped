...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.normalizr.mod.schema.Entity[T]
    - typingsJapgolly.normalizr.mod.schema.Object[T]
    - typingsJapgolly.normalizr.mod.schema.Union[T]
    - typingsJapgolly.normalizr.mod.schema.Values[T]
    - typingsJapgolly.normalizr.mod.SchemaObject[T]
    - typingsJapgolly.normalizr.mod.SchemaArray[T]
  */
  ...
  object schema {
    ...
    object Array {
      ...
      inline def apply[T](define: Schema_[Any] => Callback): typingsJapgolly.normalizr.mod.schema.Array[T] = {
        val __obj = js.Dynamic.literal(define = js.Any.fromFunction1((t0: Schema_[Any]) => define(t0).runNow()))
        __obj.asInstanceOf[typingsJapgolly.normalizr.mod.schema.Array[T]]
      }
      
      extension [Self <: typingsJapgolly.normalizr.mod.schema.Array[?], T](x: Self & typingsJapgolly.normalizr.mod.schema.Array[T]) {
        
        inline def setDefine(value: Schema_[Any] => Callback): Self = StObject.set(x, "define", js.Any.fromFunction1((t0: Schema_[Any]) => value(t0).runNow()))
      }
    }
    ...
    object Entity {
      ...
      inline def apply[T](
        ...
        define: Schema_[Any] => Callback,
        getId: (/* value */ Any, /* parent */ Any, /* key */ String) => String,
        key: String
      ): Entity[T] = {
        val __obj = js.Dynamic.literal(_processStrategy = js.Any.fromFunction3(_processStrategy), define = js.Any.fromFunction1((t0: Schema_[Any]) => define(t0).runNow()), getId = js.Any.fromFunction3(getId), key = key.asInstanceOf[js.Any])
    ...
    object Object {
      ...
      inline def apply[T](define: Schema_[Any] => Callback): Object[T] = {
        val __obj = js.Dynamic.literal(define = js.Any.fromFunction1((t0: Schema_[Any]) => define(t0).runNow()))
    ...
    object Union {
      ...
      inline def apply[T](define: Schema_[Any] => Callback): Union[T] = {
        val __obj = js.Dynamic.literal(define = js.Any.fromFunction1((t0: Schema_[Any]) => define(t0).runNow()))
    ...
    object Values {
      ...
      inline def apply[T](define: Schema_[Any] => Callback): Values[T] = {
        val __obj = js.Dynamic.literal(define = js.Any.fromFunction1((t0: Schema_[Any]) => define(t0).runNow()))
