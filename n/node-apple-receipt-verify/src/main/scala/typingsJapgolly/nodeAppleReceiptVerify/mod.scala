package typingsJapgolly.nodeAppleReceiptVerify
...
object mod {
  ...
  object ERROR_CODES extends StObject {
    ...
    sealed trait COULD_NOT_AUTHENTICATE
      extends StObject
         with ERROR_CODES
    /* 21003 */ val COULD_NOT_AUTHENTICATE: typingsJapgolly.nodeAppleReceiptVerify.mod.ERROR_CODES.COULD_NOT_AUTHENTICATE & Double = js.native
    ...
    sealed trait COULD_NOT_AUTHORIZE
      extends StObject
         with ERROR_CODES
    /* 21010 */ val COULD_NOT_AUTHORIZE: typingsJapgolly.nodeAppleReceiptVerify.mod.ERROR_CODES.COULD_NOT_AUTHORIZE & Double = js.native
    ...
    sealed trait EXPIRED_SUBSCRIPTION
      extends StObject
         with ERROR_CODES
    /* 21006 */ val EXPIRED_SUBSCRIPTION: typingsJapgolly.nodeAppleReceiptVerify.mod.ERROR_CODES.EXPIRED_SUBSCRIPTION & Double = js.native
    ...
    sealed trait INVALID_JSON
      extends StObject
         with ERROR_CODES
    /* 21000 */ val INVALID_JSON: typingsJapgolly.nodeAppleReceiptVerify.mod.ERROR_CODES.INVALID_JSON & Double = js.native
    ...
    sealed trait INVALID_RECEIPT_DATA
      extends StObject
         with ERROR_CODES
    /* 21002 */ val INVALID_RECEIPT_DATA: typingsJapgolly.nodeAppleReceiptVerify.mod.ERROR_CODES.INVALID_RECEIPT_DATA & Double = js.native
    ...
    sealed trait INVALID_SECRET
      extends StObject
         with ERROR_CODES
    /* 21004 */ val INVALID_SECRET: typingsJapgolly.nodeAppleReceiptVerify.mod.ERROR_CODES.INVALID_SECRET & Double = js.native
    ...
    sealed trait PROD_RECEIPT
      extends StObject
         with ERROR_CODES
    /* 21008 */ val PROD_RECEIPT: typingsJapgolly.nodeAppleReceiptVerify.mod.ERROR_CODES.PROD_RECEIPT & Double = js.native
    ...
    sealed trait SUCCESS
      extends StObject
         with ERROR_CODES
    /* 0 */ val SUCCESS: typingsJapgolly.nodeAppleReceiptVerify.mod.ERROR_CODES.SUCCESS & Double = js.native
    ...
    sealed trait TEST_RECEIPT
      extends StObject
         with ERROR_CODES
    /* 21007 */ val TEST_RECEIPT: typingsJapgolly.nodeAppleReceiptVerify.mod.ERROR_CODES.TEST_RECEIPT & Double = js.native
    ...
    sealed trait UNAVAILABLE
      extends StObject
         with ERROR_CODES
    /* 21005 */ val UNAVAILABLE: typingsJapgolly.nodeAppleReceiptVerify.mod.ERROR_CODES.UNAVAILABLE & Double = js.native
    ...
    sealed trait VALID_BUT_EMPTY
      extends StObject
         with ERROR_CODES
    /* 2 */ val VALID_BUT_EMPTY: typingsJapgolly.nodeAppleReceiptVerify.mod.ERROR_CODES.VALID_BUT_EMPTY & Double = js.native
  }
