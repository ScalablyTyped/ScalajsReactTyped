...
object mod {
  ...
  object Transaction {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(commit = js.Any.fromFunction1((t0: DoneCallback) => commit(t0).runNow()), cypher = js.Any.fromFunction2(cypher), expiresAt = expiresAt.asInstanceOf[js.Any], expiresIn = expiresIn.asInstanceOf[js.Any], renew = js.Any.fromFunction1((t0: DoneCallback) => renew(t0).runNow()), rollback = js.Any.fromFunction1((t0: DoneCallback) => rollback(t0).runNow()), state = state.asInstanceOf[js.Any])
      __obj.asInstanceOf[Transaction]
    }
    
    extension [Self <: Transaction](x: Self) {
      
      inline def setCommit(value: DoneCallback => Callback): Self = StObject.set(x, "commit", js.Any.fromFunction1((t0: DoneCallback) => value(t0).runNow()))
      ...
      inline def setRenew(value: DoneCallback => Callback): Self = StObject.set(x, "renew", js.Any.fromFunction1((t0: DoneCallback) => value(t0).runNow()))
      
      inline def setRollback(value: DoneCallback => Callback): Self = StObject.set(x, "rollback", js.Any.fromFunction1((t0: DoneCallback) => value(t0).runNow()))
