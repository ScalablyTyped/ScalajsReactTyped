...
import typingsJapgolly.nextServer.routerMod.RouteInfo
import typingsJapgolly.nextServer.routerMod.Subscription
...
object AnonApp {
  ...
  def apply(
    ...
    __obj.updateDynamic("subscription")(js.Any.fromFunction2((t0: /* data */ typingsJapgolly.nextServer.routerMod.RouteInfo, t1: /* App */ js.UndefOr[typingsJapgolly.react.mod.ComponentType[js.Object]]) => subscription(t0, t1).runNow()))
