...
import typingsJapgolly.nextServer.distLibUtilsMod.NextApiRequest
import typingsJapgolly.nextServer.distLibUtilsMod.NextApiResponse
import typingsJapgolly.nextServer.distServerRouterMod.Params
