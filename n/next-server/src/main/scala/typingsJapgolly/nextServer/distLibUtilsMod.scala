...
import typingsJapgolly.nextServer.anon.EnhanceApp
import typingsJapgolly.nextServer.anon.ErrorstatusCodenumberunde
import typingsJapgolly.nextServer.anon.GetInitialProps
import typingsJapgolly.nextServer.distLibRouterRouterMod.NextRouter
import typingsJapgolly.nextServer.distServerRenderMod.ManifestItem
import typingsJapgolly.nextServer.nextServerBooleans.`true`
import typingsJapgolly.node.httpMod.IncomingMessage
import typingsJapgolly.node.httpMod.ServerResponse
import typingsJapgolly.node.urlMod.URLFormatOptions
...
object distLibUtilsMod {
  ...
  object DocumentInitialProps {
    ...
    extension [Self <: DocumentInitialProps](x: Self) {
      ...
      inline def setStyles(value: js.Array[Element] | ReactFragment): Self = StObject.set(x, "styles", value.asInstanceOf[js.Any])
