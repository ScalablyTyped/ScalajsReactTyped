...
import typingsJapgolly.nextServer.anon.App
import typingsJapgolly.nextServer.distLibMittMod.MittEmitter
...
object distLibRouterRouterMod {
  ...
  object NextRouter {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(asPath = asPath.asInstanceOf[js.Any], back = back.toJsFn, beforePopState = js.Any.fromFunction1((t0: /* cb */ BeforePopStateCallback) => beforePopState(t0).runNow()), events = events.asInstanceOf[js.Any], pathname = pathname.asInstanceOf[js.Any], prefetch = js.Any.fromFunction1(prefetch), push = js.Any.fromFunction3(push), query = query.asInstanceOf[js.Any], reload = reload.toJsFn, replace = js.Any.fromFunction3(replace), route = route.asInstanceOf[js.Any])
