...
import typingsJapgolly.nextServer.anon.AmpBindInitData
import typingsJapgolly.nextServer.anon.Amphtml
...
object distServerNextServerMod {
  ...
  trait Server extends StObject {
    ...
    var router: typingsJapgolly.nextServer.distServerRouterMod.default = js.native
