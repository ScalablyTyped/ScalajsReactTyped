...
object DocumentContext {
  ...
  def apply(
    ...
    __obj.updateDynamic("renderPage")(js.Any.fromFunction1((t0: /* options */ js.UndefOr[typingsJapgolly.nextServer.libUtilsMod.ComponentsEnhancer]) => renderPage(t0).runNow()))
