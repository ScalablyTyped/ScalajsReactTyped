package typingsJapgolly.nextServer.mittMod
...
object MittEmitter {
  ...
  def apply(
    ...
    __obj.updateDynamic("off")(js.Any.fromFunction2((t0: java.lang.String, t1: typingsJapgolly.nextServer.mittMod.Handler) => off(t0, t1).runNow()))
    __obj.updateDynamic("on")(js.Any.fromFunction2((t0: java.lang.String, t1: typingsJapgolly.nextServer.mittMod.Handler) => on(t0, t1).runNow()))
