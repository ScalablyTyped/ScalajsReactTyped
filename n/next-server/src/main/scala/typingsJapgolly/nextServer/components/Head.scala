package typingsJapgolly.nextServer.components
...
object Head {
  ...
  implicit def make(companion: Head.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
