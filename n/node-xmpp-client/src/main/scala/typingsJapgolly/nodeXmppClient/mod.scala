package typingsJapgolly.nodeXmppClient
...
object mod {
  ...
  object Client {
    ...
    @js.native
    def Stanza: typingsJapgolly.nodeXmppClient.mod.Stanza = js.native
  ...
  object Bosh {
    ...
    extension [Self <: Bosh](x: Self) {
      ...
      inline def setPrebind(value: (/* error */ Any, /* data */ Any) => Callback): Self = StObject.set(x, "prebind", js.Any.fromFunction2((t0: /* error */ Any, t1: /* data */ Any) => (value(t0, t1)).runNow()))
