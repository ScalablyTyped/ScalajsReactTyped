...
object INotifyOption {
  ...
  def apply(
    ...
    notifyShow: /* e */ Event_ => CallbackTo[js.Any] = null,
    ...
    if (notifyShow != null) __obj.updateDynamic("notifyShow")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.std.Event_) => notifyShow(t0).runNow()))
