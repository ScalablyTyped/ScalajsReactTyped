...
object mod {
  ...
  object ParsedOption {
    ...
    inline def apply(argv: js.Array[String], empty: CallbackTo[Boolean], options: OptionMap): ParsedOption = {
      val __obj = js.Dynamic.literal(argv = argv.asInstanceOf[js.Any], empty = empty.toJsFn, options = options.asInstanceOf[js.Any])
