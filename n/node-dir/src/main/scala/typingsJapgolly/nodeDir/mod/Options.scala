...
object Options {
  ...
  def apply(
    ...
    exclude: js.RegExp | js.Array[String] = null,
    excludeDir: js.RegExp | js.Array[String] = null,
    `match`: js.RegExp | js.Array[String] = null,
    matchDir: js.RegExp | js.Array[String] = null,
