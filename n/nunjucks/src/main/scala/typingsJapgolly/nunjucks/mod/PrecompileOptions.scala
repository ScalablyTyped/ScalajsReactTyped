...
import typingsJapgolly.nunjucks.AnonName
...
object PrecompileOptions {
  ...
  def apply(
    ...
    name: String = null,
    wrapper: (/* templates */ AnonName, PrecompileOptions) => CallbackTo[String] = null
  ): PrecompileOptions = {
    ...
    if (wrapper != null) __obj.updateDynamic("wrapper")(js.Any.fromFunction2((t0: /* templates */ typingsJapgolly.nunjucks.AnonName, t1: typingsJapgolly.nunjucks.mod.PrecompileOptions) => wrapper(t0, t1).runNow()))
