...
import typingsJapgolly.nonogramSolver.anon.RequiredInput
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nonogramSolver.nonogramSolverInts.`0`
    - typingsJapgolly.nonogramSolver.nonogramSolverInts.`1`
    - typingsJapgolly.nonogramSolver.nonogramSolverInts.`-1`
  */
  trait State extends StObject
  object State {
    
    inline def `-1`: typingsJapgolly.nonogramSolver.nonogramSolverInts.`-1` = -1.asInstanceOf[typingsJapgolly.nonogramSolver.nonogramSolverInts.`-1`]
    
    inline def `0`: typingsJapgolly.nonogramSolver.nonogramSolverInts.`0` = 0.asInstanceOf[typingsJapgolly.nonogramSolver.nonogramSolverInts.`0`]
