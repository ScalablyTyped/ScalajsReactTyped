...
object distTypesTypesMod {
  ...
  object ScatterPlotCanvasProps {
    ...
    extension [Self <: ScatterPlotCanvasProps[?], RawDatum /* <: ScatterPlotDatum */](x: Self & ScatterPlotCanvasProps[RawDatum]) {
      ...
      ): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* node */ ScatterPlotNodeData[RawDatum], t1: /* event */ ReactMouseEventFrom[Any & Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
      
      inline def setOnMouseEnter(
        value: (/* node */ ScatterPlotNodeData[RawDatum], /* event */ ReactMouseEventFrom[Any & Element]) => Callback
      ): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction2((t0: /* node */ ScatterPlotNodeData[RawDatum], t1: /* event */ ReactMouseEventFrom[Any & Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnMouseEnterUndefined: Self = StObject.set(x, "onMouseEnter", js.undefined)
      
      inline def setOnMouseLeave(
        value: (/* node */ ScatterPlotNodeData[RawDatum], /* event */ ReactMouseEventFrom[Any & Element]) => Callback
      ): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction2((t0: /* node */ ScatterPlotNodeData[RawDatum], t1: /* event */ ReactMouseEventFrom[Any & Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnMouseLeaveUndefined: Self = StObject.set(x, "onMouseLeave", js.undefined)
      
      inline def setOnMouseMove(
        value: (/* node */ ScatterPlotNodeData[RawDatum], /* event */ ReactMouseEventFrom[Any & Element]) => Callback
      ): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction2((t0: /* node */ ScatterPlotNodeData[RawDatum], t1: /* event */ ReactMouseEventFrom[Any & Element]) => (value(t0, t1)).runNow()))
      ...
      inline def setRenderNode(value: (/* ctx */ CanvasRenderingContext2D, /* node */ ScatterPlotNodeData[RawDatum]) => Callback): Self = StObject.set(x, "renderNode", js.Any.fromFunction2((t0: /* ctx */ CanvasRenderingContext2D, t1: /* node */ ScatterPlotNodeData[RawDatum]) => (value(t0, t1)).runNow()))
  ...
  object ScatterPlotCommonProps {
    ...
    inline def apply[RawDatum /* <: ScatterPlotDatum */](
      ...
      onClick: (/* node */ ScatterPlotNodeData[RawDatum], /* event */ ReactMouseEventFrom[Any & Element]) => Callback,
      onMouseEnter: (/* node */ ScatterPlotNodeData[RawDatum], /* event */ ReactMouseEventFrom[Any & Element]) => Callback,
      onMouseLeave: (/* node */ ScatterPlotNodeData[RawDatum], /* event */ ReactMouseEventFrom[Any & Element]) => Callback,
      onMouseMove: (/* node */ ScatterPlotNodeData[RawDatum], /* event */ ReactMouseEventFrom[Any & Element]) => Callback,
      role: String,
      theme: Theme,
      ...
      val __obj = js.Dynamic.literal(annotations = annotations.asInstanceOf[js.Any], colors = colors.asInstanceOf[js.Any], debugMesh = debugMesh.asInstanceOf[js.Any], enableGridX = enableGridX.asInstanceOf[js.Any], enableGridY = enableGridY.asInstanceOf[js.Any], gridXValues = gridXValues.asInstanceOf[js.Any], gridYValues = gridYValues.asInstanceOf[js.Any], isInteractive = isInteractive.asInstanceOf[js.Any], legends = legends.asInstanceOf[js.Any], margin = margin.asInstanceOf[js.Any], nodeId = nodeId.asInstanceOf[js.Any], nodeSize = nodeSize.asInstanceOf[js.Any], onClick = js.Any.fromFunction2((t0: /* node */ ScatterPlotNodeData[RawDatum], t1: /* event */ ReactMouseEventFrom[Any & Element]) => (onClick(t0, t1)).runNow()), onMouseEnter = js.Any.fromFunction2((t0: /* node */ ScatterPlotNodeData[RawDatum], t1: /* event */ ReactMouseEventFrom[Any & Element]) => (onMouseEnter(t0, t1)).runNow()), onMouseLeave = js.Any.fromFunction2((t0: /* node */ ScatterPlotNodeData[RawDatum], t1: /* event */ ReactMouseEventFrom[Any & Element]) => (onMouseLeave(t0, t1)).runNow()), onMouseMove = js.Any.fromFunction2((t0: /* node */ ScatterPlotNodeData[RawDatum], t1: /* event */ ReactMouseEventFrom[Any & Element]) => (onMouseMove(t0, t1)).runNow()), role = role.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any], tooltip = tooltip.asInstanceOf[js.Any], useMesh = useMesh.asInstanceOf[js.Any], xFormat = xFormat.asInstanceOf[js.Any], xScale = xScale.asInstanceOf[js.Any], yFormat = yFormat.asInstanceOf[js.Any], yScale = yScale.asInstanceOf[js.Any], axisBottom = null, axisLeft = null, axisRight = null, axisTop = null)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.grid
    - typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.axes
    - typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.nodes
    - typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.markers
    - typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.mesh
    - typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.legends
    - typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.annotations
  */
  trait ScatterPlotLayerId extends StObject
  object ScatterPlotLayerId {
    
    inline def annotations: typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.annotations = "annotations".asInstanceOf[typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.annotations]
    
    inline def axes: typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.axes = "axes".asInstanceOf[typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.axes]
    
    inline def grid: typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.grid = "grid".asInstanceOf[typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.grid]
    
    inline def legends: typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.legends = "legends".asInstanceOf[typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.legends]
    
    inline def markers: typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.markers = "markers".asInstanceOf[typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.markers]
    
    inline def mesh: typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.mesh = "mesh".asInstanceOf[typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.mesh]
    
    inline def nodes: typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.nodes = "nodes".asInstanceOf[typingsJapgolly.nivoScatterplot.nivoScatterplotStrings.nodes]
  }
