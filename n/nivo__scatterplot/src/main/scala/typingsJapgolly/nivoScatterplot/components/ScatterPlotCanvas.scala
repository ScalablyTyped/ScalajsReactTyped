...
object ScatterPlotCanvas {
  def apply(
    ...
    ScatterPlotCanvasProps with Dimensions, 
    typingsJapgolly.nivoScatterplot.mod.ScatterPlotCanvas, 
    Unit, 
    ScatterPlotCanvasProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoScatterplot.mod.ScatterPlotCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoScatterplot.mod.ScatterPlotCanvas](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoScatterplot.mod.ScatterPlotCanvasProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
