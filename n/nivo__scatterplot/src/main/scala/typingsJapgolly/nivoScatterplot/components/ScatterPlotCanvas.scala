...
object ScatterPlotCanvas {
  ...
  inline def apply(data: js.Array[ScatterPlotRawSerie[ScatterPlotDatum]], height: Double, width: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PartialScatterPlotCommonP]))
  }
  ...
  def withProps(p: PartialScatterPlotCommonP): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
