...
object ResponsiveScatterPlot {
  def apply(
    ...
    ScatterPlotSvgProps, 
    typingsJapgolly.nivoScatterplot.mod.ResponsiveScatterPlot, 
    Unit, 
    ScatterPlotSvgProps
  ] = {
  ...
  typingsJapgolly.nivoScatterplot.mod.ScatterPlotSvgProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoScatterplot.mod.ResponsiveScatterPlot](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoScatterplot.mod.ScatterPlotSvgProps])(children: _*)
  }
