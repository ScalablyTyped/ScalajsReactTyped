...
import typingsJapgolly.nightmare.anon.Downloads
import typingsJapgolly.nightmare.anon.Height
import typingsJapgolly.nightmare.anon.Mode
import typingsJapgolly.nightmare.nightmareStrings.HTMLComplete
import typingsJapgolly.nightmare.nightmareStrings.HTMLOnly
import typingsJapgolly.nightmare.nightmareStrings.MHTML
import typingsJapgolly.nightmare.nightmareStrings.alert
import typingsJapgolly.nightmare.nightmareStrings.cancel
import typingsJapgolly.nightmare.nightmareStrings.confirm
import typingsJapgolly.nightmare.nightmareStrings.consoleMessage
import typingsJapgolly.nightmare.nightmareStrings.continue
import typingsJapgolly.nightmare.nightmareStrings.error
import typingsJapgolly.nightmare.nightmareStrings.initialized
import typingsJapgolly.nightmare.nightmareStrings.loadFinished
import typingsJapgolly.nightmare.nightmareStrings.loadStarted
import typingsJapgolly.nightmare.nightmareStrings.navigationRequested
import typingsJapgolly.nightmare.nightmareStrings.prompt
import typingsJapgolly.nightmare.nightmareStrings.resourceError
import typingsJapgolly.nightmare.nightmareStrings.resourceReceived
import typingsJapgolly.nightmare.nightmareStrings.resourceRequested
import typingsJapgolly.nightmare.nightmareStrings.timeout
import typingsJapgolly.nightmare.nightmareStrings.urlChanged
...
object mod {
  ...
  object INetwordRequest {
    ...
    inline def apply(abort: Callback, changeUrl: String => Callback, setHeader: (String, String) => Callback): INetwordRequest = {
