...
import typingsJapgolly.nginstackEngine.libOauth2Oauth2clientMod.TokenResponse
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libOidcOpenIdClientMod {
  ...
  type CryptoPKey = typingsJapgolly.nginstackEngine.libCryptoCryptoPKeyMod.^
  ...
  type TokenIntrospectionResponse = typingsJapgolly.nginstackEngine.libOauth2Oauth2clientMod.TokenIntrospectionResponse
}
