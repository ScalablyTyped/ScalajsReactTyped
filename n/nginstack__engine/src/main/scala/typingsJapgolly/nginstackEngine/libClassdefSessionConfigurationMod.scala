...
object libClassdefSessionConfigurationMod {
  ...
  object SessionConfiguration {
    ...
    inline def apply(
      ...
      duplicate: CallbackTo[SessionConfiguration],
      duplicating_ : Any,
    ...
    extension [Self <: SessionConfiguration](x: Self) {
      ...
      inline def setDuplicate(value: CallbackTo[SessionConfiguration]): Self = StObject.set(x, "duplicate", value.toJsFn)
