...
import typingsJapgolly.nginstackEngine.anon.AFTERINSERT
import typingsJapgolly.nginstackEngine.anon.BIGINT
import typingsJapgolly.nginstackEngine.anon.BOOLEAN
import typingsJapgolly.nginstackEngine.anon.DDD
import typingsJapgolly.nginstackEngine.anon.DDDDDDDD
import typingsJapgolly.nginstackEngine.anon.DDMM
...
object libClassdefFieldMod {
  ...
  trait Field extends StObject {
    ...
    var group: typingsJapgolly.nginstackEngine.libClassdefFieldGroupMod.^ = js.native
