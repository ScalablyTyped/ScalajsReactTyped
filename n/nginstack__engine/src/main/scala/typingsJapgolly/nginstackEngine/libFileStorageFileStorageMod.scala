...
import typingsJapgolly.nginstackEngine.anon.Attributes
...
object libFileStorageFileStorageMod {
  ...
  type FileInfo = typingsJapgolly.nginstackEngine.libFileStorageFileInfoMod.^
  ...
  trait FileStorage extends StObject {
    ...
    def addFile(originalFileName: String, content: typingsJapgolly.nginstackEngine.libIoFileMod.^, attributes: Any): Double = js.native
    def addFile(
      originalFileName: String,
      content: typingsJapgolly.nginstackEngine.libIoMemoryStreamMod.^,
      attributes: Any
    ): Double = js.native
    ...
    def updateFile(fileKey: Double, content: typingsJapgolly.nginstackEngine.libIoFileMod.^, options: Attributes): Unit = js.native
