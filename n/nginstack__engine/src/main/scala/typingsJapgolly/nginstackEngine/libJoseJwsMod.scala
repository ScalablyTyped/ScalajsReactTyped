...
import typingsJapgolly.nginstackEngine.anon.Algorithm
import typingsJapgolly.nginstackEngine.anon.DisableDefaultTimestamp
...
object libJoseJwsMod {
  ...
  inline def parse(token: String, key: typingsJapgolly.nginstackEngine.libCryptoCryptoPKeyMod.^): JWS = (^.asInstanceOf[js.Dynamic].applyDynamic("parse")(token.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[JWS]
  inline def parse(
    token: String,
    key: typingsJapgolly.nginstackEngine.libCryptoCryptoPKeyMod.^,
    options: VerifyOptions
  ): JWS = (^.asInstanceOf[js.Dynamic].applyDynamic("parse")(token.asInstanceOf[js.Any], key.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[JWS]
  ...
  inline def sign(payload: Any, key: typingsJapgolly.nginstackEngine.libCryptoCryptoPKeyMod.^): String = (^.asInstanceOf[js.Dynamic].applyDynamic("sign")(payload.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def sign(payload: Any, key: typingsJapgolly.nginstackEngine.libCryptoCryptoPKeyMod.^, options: Algorithm): String = (^.asInstanceOf[js.Dynamic].applyDynamic("sign")(payload.asInstanceOf[js.Any], key.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def verify(token: String, key: typingsJapgolly.nginstackEngine.libCryptoCryptoPKeyMod.^): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("verify")(token.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def verify(
    token: String,
    key: typingsJapgolly.nginstackEngine.libCryptoCryptoPKeyMod.^,
    options: VerifyOptions
  ): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("verify")(token.asInstanceOf[js.Any], key.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  
  @js.native
  trait JWS extends StObject {
    
    var algorithm: typingsJapgolly.nginstackEngine.libJoseAlgorithmMod.Algorithm = js.native
    ...
    def sign(key: typingsJapgolly.nginstackEngine.libCryptoCryptoPKeyMod.^): String = js.native
    def sign(key: typingsJapgolly.nginstackEngine.libCryptoCryptoPKeyMod.^, options: DisableDefaultTimestamp): String = js.native
