...
object libHttpRealmConfigMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    var application: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^ | Double = js.native
  ...
  trait RealmConfig extends StObject {
    ...
    var application: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^ | Double
  ...
  object RealmConfig {
    ...
    inline def apply(
      application: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^ | Double,
    ...
    extension [Self <: RealmConfig](x: Self) {
      ...
      inline def setApplication(value: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^ | Double): Self = StObject.set(x, "application", value.asInstanceOf[js.Any])
