...
object libHttpServerIdMod {
  ...
  inline def getInstance(): typingsJapgolly.nginstackEngine.libHttpServerIdMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("getInstance")().asInstanceOf[typingsJapgolly.nginstackEngine.libHttpServerIdMod.^]
