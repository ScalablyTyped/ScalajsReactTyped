...
object libClassdefStrictModeEvaluatorMod {
  ...
  object StrictModeEvaluator {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(disable = disable.toJsFn, enable = enable.toJsFn, enableLevel_ = enableLevel_.asInstanceOf[js.Any], enabled = enabled.asInstanceOf[js.Any], pause = pause.toJsFn, pauseLevel_ = pauseLevel_.asInstanceOf[js.Any], preserve_ = preserve_.asInstanceOf[js.Any], preserved_ = preserved_.asInstanceOf[js.Any], protectProperty_ = protectProperty_.asInstanceOf[js.Any], protect_ = protect_.asInstanceOf[js.Any], protected_ = protected_.asInstanceOf[js.Any], restoreProperty_ = restoreProperty_.asInstanceOf[js.Any], restore_ = restore_.asInstanceOf[js.Any], resume = resume.toJsFn, unprotect_ = unprotect_.asInstanceOf[js.Any])
