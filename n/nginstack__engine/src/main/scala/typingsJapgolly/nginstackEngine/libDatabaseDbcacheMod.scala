...
import typingsJapgolly.nginstackEngine.anon.RowId
...
object libDatabaseDbcacheMod {
  ...
  trait DBCache extends StObject {
    ...
    def copyTableStructure(tableName: String, ds: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): Unit = js.native
    ...
    def getTable(tableName: String): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    ...
    def isFromCache(ds: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): Boolean = js.native
    
    def newTableStructure(tableName: String): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
