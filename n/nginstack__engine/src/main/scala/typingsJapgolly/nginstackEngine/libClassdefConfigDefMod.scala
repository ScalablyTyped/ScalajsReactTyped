...
object libClassdefConfigDefMod {
  ...
  open class ^ ()
    ...
    var logger_ : typingsJapgolly.nginstackEngine.libLogLoggerMod.^ = js.native
  ...
  trait ConfigDef extends StObject {
    ...
    /* protected */ var logger_ : typingsJapgolly.nginstackEngine.libLogLoggerMod.^
    
    /* private */ var vfsToCheckStrictMode_ : Any
  }
  object ConfigDef {
    
    inline def apply(logger_ : typingsJapgolly.nginstackEngine.libLogLoggerMod.^, vfsToCheckStrictMode_ : Any): ConfigDef = {
    ...
    extension [Self <: ConfigDef](x: Self) {
      ...
      inline def setLogger_(value: typingsJapgolly.nginstackEngine.libLogLoggerMod.^): Self = StObject.set(x, "logger_", value.asInstanceOf[js.Any])
