...
object libMultipartMultipartFormDataPartMod {
  
  inline def apply(reader: MultipartFormDataReader, readFunc: js.Function1[/* arg0 */ Double, String], headers: Any): Unit = (^.asInstanceOf[js.Dynamic].apply(reader.asInstanceOf[js.Any], readFunc.asInstanceOf[js.Any], headers.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ protected ()
    ...
    def this(reader: MultipartFormDataReader, readFunc: js.Function1[/* arg0 */ Double, String], headers: Any) = this()
  }
  @JSImport("@nginstack/engine/lib/multipart/MultipartFormDataPart", JSImport.Namespace)
  @js.native
