...
import typingsJapgolly.nginstackEngine.anon.HideNotVisibleClasses
import typingsJapgolly.nginstackEngine.anon.IncludeNonDatabaseFields
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libSecurityPermissionSchemaMod {
  ...
  trait PermissionSchema extends StObject {
    ...
    def mountTabularMap(permissionFields: js.Array[String], classKey: Double, userKey: Double): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    def mountTabularMap(
