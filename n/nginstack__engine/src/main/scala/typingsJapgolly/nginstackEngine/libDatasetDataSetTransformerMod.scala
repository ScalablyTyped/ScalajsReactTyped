...
import typingsJapgolly.nginstackEngine.anon.DefaultDate
...
object libDatasetDataSetTransformerMod {
  ...
  object DistinctController {
    ...
    @JSImport("@nginstack/engine/lib/dataset/DataSetTransformer", "DistinctController")
    @js.native
    def apply(ds: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^, groupColumns: js.Array[Any]): Unit = js.native
  }
  ...
  trait DataSetTransformer extends StObject {
    ...
    def calculate(ds: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^, exprs: js.Array[Any]): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    def calculate(
      ds: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^,
      exprs: js.Array[Any],
  ...
  trait PivotResult extends StObject {
    ...
    var pivotDS: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^
  ...
  object PivotResult {
    ...
    inline def apply(
      ...
      pivotDS: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^,
      pivotFieldName: String,
    ...
    extension [Self <: PivotResult](x: Self) {
      ...
      inline def setPivotDS(value: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): Self = StObject.set(x, "pivotDS", value.asInstanceOf[js.Any])
