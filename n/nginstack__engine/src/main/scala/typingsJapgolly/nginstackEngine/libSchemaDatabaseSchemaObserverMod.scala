...
import typingsJapgolly.nginstackEngine.libSchemaDatabaseSchemaMod.ColumnDef
...
object libSchemaDatabaseSchemaObserverMod {
  ...
  trait AddTableColumnsEvent extends StObject {
    ...
    var database: typingsJapgolly.nginstackEngine.libDatabaseDatabaseMod.^
  ...
  object AddTableColumnsEvent {
    ...
    inline def apply(
      ...
      database: typingsJapgolly.nginstackEngine.libDatabaseDatabaseMod.^,
      tableName: String
    ...
    extension [Self <: AddTableColumnsEvent](x: Self) {
      ...
      inline def setDatabase(value: typingsJapgolly.nginstackEngine.libDatabaseDatabaseMod.^): Self = StObject.set(x, "database", value.asInstanceOf[js.Any])
