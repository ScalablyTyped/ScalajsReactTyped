...
object libOsNativeAppPackageManagerMod {
  ...
  object NativeAppPackageManager {
    ...
    inline def apply(
      ...
      downloadBundle_ : Any,
      extractBundle_ : Any,
      getManifest: CallbackTo[Any],
      isInstalled: CallbackTo[Boolean],
      isUpdated: CallbackTo[Boolean],
      load: Any,
      ...
      val __obj = js.Dynamic.literal(_appId = _appId.asInstanceOf[js.Any], _key = _key.asInstanceOf[js.Any], _localManifest = _localManifest.asInstanceOf[js.Any], _manifest = _manifest.asInstanceOf[js.Any], _manifestName = _manifestName.asInstanceOf[js.Any], _path = _path.asInstanceOf[js.Any], downloadBundle_ = downloadBundle_.asInstanceOf[js.Any], extractBundle_ = extractBundle_.asInstanceOf[js.Any], getManifest = getManifest.toJsFn, isInstalled = isInstalled.toJsFn, isUpdated = isUpdated.toJsFn, load = load.asInstanceOf[js.Any], loadBaseManifest_ = loadBaseManifest_.asInstanceOf[js.Any], loadDiskManifest_ = loadDiskManifest_.asInstanceOf[js.Any], logger_ = logger_.asInstanceOf[js.Any], saveManifest_ = saveManifest_.asInstanceOf[js.Any], update = update.toJsFn, verifyBundle_ = verifyBundle_.asInstanceOf[js.Any])
    ...
    extension [Self <: NativeAppPackageManager](x: Self) {
      ...
      inline def setGetManifest(value: CallbackTo[Any]): Self = StObject.set(x, "getManifest", value.toJsFn)
      
      inline def setIsInstalled(value: CallbackTo[Boolean]): Self = StObject.set(x, "isInstalled", value.toJsFn)
      
      inline def setIsUpdated(value: CallbackTo[Boolean]): Self = StObject.set(x, "isUpdated", value.toJsFn)
