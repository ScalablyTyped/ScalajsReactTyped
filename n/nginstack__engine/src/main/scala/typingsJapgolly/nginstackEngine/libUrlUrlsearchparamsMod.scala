...
object libUrlUrlsearchparamsMod {
  ...
  object URLSearchParams {
    ...
    inline def apply(
      ...
      encode_ : Any,
      findRegex_ : Any,
      forEach: (js.Function1[/* repeated */ Any, Any], Any) => Callback,
      get: String => Any,
    ...
    extension [Self <: URLSearchParams](x: Self) {
      ...
      inline def setForEach(value: (js.Function1[/* repeated */ Any, Any], Any) => Callback): Self = StObject.set(x, "forEach", js.Any.fromFunction2((t0: js.Function1[/* repeated */ Any, Any], t1: Any) => (value(t0, t1)).runNow()))
