...
object libCryptoMd5Mod {
  ...
  trait MD5 extends StObject {
    ...
    def update(data: String): MD5 = js.native
    def update(data: js.typedarray.ArrayBuffer): MD5 = js.native
    def update(data: js.typedarray.Uint8Array): MD5 = js.native
  }
}
