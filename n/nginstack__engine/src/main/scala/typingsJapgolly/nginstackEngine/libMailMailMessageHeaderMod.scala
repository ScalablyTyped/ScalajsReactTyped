...
object libMailMailMessageHeaderMod {
  
  inline def apply(): Unit = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[Unit]
  
  @JSImport("@nginstack/engine/lib/mail/MailMessageHeader", JSImport.Namespace)
  @js.native
  open class ^ ()
    extends StObject
       with MailMessageHeader {
  ...
  trait MailMessageHeader extends StObject {
