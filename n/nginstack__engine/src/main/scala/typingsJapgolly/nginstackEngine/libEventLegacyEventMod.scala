...
object libEventLegacyEventMod {
  ...
  trait LegacyEvent extends StObject {
    ...
    var _methods: js.Array[
        typingsJapgolly.nginstackEngine.libEventLegacyMethodMod.^ | (js.Function1[/* arg0 */ Any, Any])
      ] = js.native
    ...
    def set(method: typingsJapgolly.nginstackEngine.libEventLegacyMethodMod.^): Unit = js.native
  }
}
