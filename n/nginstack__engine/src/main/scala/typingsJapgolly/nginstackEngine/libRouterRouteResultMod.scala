...
import typingsJapgolly.nginstackEngine.anon.Debug
import typingsJapgolly.nginstackEngine.libHttpMediaTypeMod.MediaType
import typingsJapgolly.nginstackEngine.libHttpStatusMod.Status
...
object libRouterRouteResultMod {
  ...
  inline def apply(opt_base: RouteResult): typingsJapgolly.nginstackEngine.libRouterRouteResultMod.^ = ^.asInstanceOf[js.Dynamic].apply(opt_base.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.nginstackEngine.libRouterRouteResultMod.^]
  ...
  inline def addTransform(
    transformer: js.Function2[
      /* arg0 */ RouteResult, 
      /* arg1 */ org.scalajs.dom.Request, 
      RouteResult | js.Array[Any]
    ]
  ...
  inline def transform(result: RouteResult, request: org.scalajs.dom.Request): RouteResult = (^.asInstanceOf[js.Dynamic].applyDynamic("transform")(result.asInstanceOf[js.Any], request.asInstanceOf[js.Any])).asInstanceOf[RouteResult]
