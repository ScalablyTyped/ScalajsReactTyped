...
object libClassdefFieldGroupMod {
  ...
  object FieldGroup {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(assign = js.Any.fromFunction1((t0: FieldGroup) => assign(t0).runNow()), autoSanitize = autoSanitize.asInstanceOf[js.Any], collapsed = collapsed.asInstanceOf[js.Any], createId_ = createId_.asInstanceOf[js.Any], css = css.asInstanceOf[js.Any], getStyleText = getStyleText.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], name_ = name_.asInstanceOf[js.Any], order = order.asInstanceOf[js.Any], parent = parent.asInstanceOf[js.Any], parseStylePropertyName = parseStylePropertyName.asInstanceOf[js.Any], reservedWords = reservedWords.asInstanceOf[js.Any], setFieldsProperties = setFieldsProperties.asInstanceOf[js.Any], stringify = stringify.toJsFn)
    ...
    extension [Self <: FieldGroup](x: Self) {
      ...
      inline def setAssign(value: FieldGroup => Callback): Self = StObject.set(x, "assign", js.Any.fromFunction1((t0: FieldGroup) => value(t0).runNow()))
