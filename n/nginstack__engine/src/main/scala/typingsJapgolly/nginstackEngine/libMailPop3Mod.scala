...
object libMailPop3Mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nginstackEngine.nginstackEngineStrings.PASS
    - typingsJapgolly.nginstackEngine.nginstackEngineStrings.APOP
  */
  trait AuthMode extends StObject
  object AuthMode {
    
    inline def APOP: typingsJapgolly.nginstackEngine.nginstackEngineStrings.APOP = "APOP".asInstanceOf[typingsJapgolly.nginstackEngine.nginstackEngineStrings.APOP]
    
    inline def PASS: typingsJapgolly.nginstackEngine.nginstackEngineStrings.PASS = "PASS".asInstanceOf[typingsJapgolly.nginstackEngine.nginstackEngineStrings.PASS]
  }
