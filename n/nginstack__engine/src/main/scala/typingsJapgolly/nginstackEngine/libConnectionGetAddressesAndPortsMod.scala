...
object libConnectionGetAddressesAndPortsMod {
  ...
  inline def apply(key: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^): AddressesAndPorts = ^.asInstanceOf[js.Dynamic].apply(key.asInstanceOf[js.Any]).asInstanceOf[AddressesAndPorts]
