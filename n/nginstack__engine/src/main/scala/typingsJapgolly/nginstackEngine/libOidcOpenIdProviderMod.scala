...
import typingsJapgolly.nginstackEngine.libOauth2Oauth2clientMod.OAuth2ClientConstructorOptions
import typingsJapgolly.nginstackEngine.libOidcOpenIdClientMod.OpenIdClientConstructorOptions
...
object libOidcOpenIdProviderMod {
  ...
  trait OpenIdProvider extends StObject {
    ...
    def newOAuth2Client(): typingsJapgolly.nginstackEngine.libOauth2Oauth2clientMod.^ = js.native
    def newOAuth2Client(options: OAuth2ClientConstructorOptions): typingsJapgolly.nginstackEngine.libOauth2Oauth2clientMod.^ = js.native
    
    def newOpenIdClient(): typingsJapgolly.nginstackEngine.libOidcOpenIdClientMod.^ = js.native
    def newOpenIdClient(options: OpenIdClientConstructorOptions): typingsJapgolly.nginstackEngine.libOidcOpenIdClientMod.^ = js.native
