...
object libCryptoSha512Mod {
  
  inline def apply(): Unit = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[Unit]
  
  @JSImport("@nginstack/engine/lib/crypto/SHA512", JSImport.Namespace)
  @js.native
  open class ^ ()
    extends StObject
       with SHA512
  ...
  trait SHA512 extends StObject {
    ...
    def update(data: String): SHA512 = js.native
    def update(data: js.typedarray.ArrayBuffer): SHA512 = js.native
    def update(data: js.typedarray.Uint8Array): SHA512 = js.native
  }
}
