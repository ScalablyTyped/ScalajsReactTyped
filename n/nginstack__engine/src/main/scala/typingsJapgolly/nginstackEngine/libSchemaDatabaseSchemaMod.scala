...
import typingsJapgolly.nginstackEngine.anon.DryRun
import typingsJapgolly.nginstackEngine.anon.DryRunBoolean
import typingsJapgolly.nginstackEngine.anon.DryRunIndexTablespace
import typingsJapgolly.nginstackEngine.anon.IndexTablespace
import typingsJapgolly.nginstackEngine.anon.Online
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libSchemaDatabaseSchemaMod {
  ...
  inline def deregisterObserver(observer: typingsJapgolly.nginstackEngine.libSchemaDatabaseSchemaObserverMod.^): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("deregisterObserver")(observer.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def registerObserver(observer: typingsJapgolly.nginstackEngine.libSchemaDatabaseSchemaObserverMod.^): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("registerObserver")(observer.asInstanceOf[js.Any]).asInstanceOf[Unit]
