...
import typingsJapgolly.nginstackEngine.anon.Cancelable
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libEventEventMod {
  ...
  object Event {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(cancelable = cancelable.asInstanceOf[js.Any], cancelable_ = cancelable_.asInstanceOf[js.Any], currentTarget = currentTarget.asInstanceOf[js.Any], defaultPrevented = defaultPrevented.asInstanceOf[js.Any], defaultPrevented_ = defaultPrevented_.asInstanceOf[js.Any], immediateStopped = immediateStopped.asInstanceOf[js.Any], immediateStopped_ = immediateStopped_.asInstanceOf[js.Any], listenerIndex = listenerIndex.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, stopImmediatePropagation = stopImmediatePropagation.toJsFn, target = target.asInstanceOf[js.Any], timeStamp = timeStamp.asInstanceOf[js.Any], timeStamp_ = timeStamp_.asInstanceOf[js.Any], type_ = type_.asInstanceOf[js.Any])
