...
import typingsJapgolly.nginstackEngine.anon.OnlyFiles
...
object libIoFileMod {
  ...
  inline def createTempFile(): org.scalajs.dom.File = ^.asInstanceOf[js.Dynamic].applyDynamic("createTempFile")().asInstanceOf[org.scalajs.dom.File]
  ...
  inline def openForRead(path: String): org.scalajs.dom.File = ^.asInstanceOf[js.Dynamic].applyDynamic("openForRead")(path.asInstanceOf[js.Any]).asInstanceOf[org.scalajs.dom.File]
  ...
  type SearchRecord = typingsJapgolly.nginstackEngine.libIoSearchRecordMod.^
}
