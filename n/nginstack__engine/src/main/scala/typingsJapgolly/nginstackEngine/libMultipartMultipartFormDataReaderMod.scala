...
import typingsJapgolly.nginstackEngine.anon.Boundary
...
object libMultipartMultipartFormDataReaderMod {
  ...
  inline def apply(content: typingsJapgolly.nginstackEngine.libHttpRequestMod.^): Unit = ^.asInstanceOf[js.Dynamic].apply(content.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def apply(content: typingsJapgolly.nginstackEngine.libHttpRequestMod.^, options: Boundary): Unit = (^.asInstanceOf[js.Dynamic].apply(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def apply(content: typingsJapgolly.nginstackEngine.libIoFileMod.^): Unit = ^.asInstanceOf[js.Dynamic].apply(content.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def apply(content: typingsJapgolly.nginstackEngine.libIoFileMod.^, options: Boundary): Unit = (^.asInstanceOf[js.Dynamic].apply(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ protected ()
    ...
    def this(content: typingsJapgolly.nginstackEngine.libHttpRequestMod.^) = this()
    def this(content: typingsJapgolly.nginstackEngine.libIoFileMod.^) = this()
    def this(content: String, options: Boundary) = this()
    def this(content: typingsJapgolly.nginstackEngine.libHttpRequestMod.^, options: Boundary) = this()
    def this(content: typingsJapgolly.nginstackEngine.libIoFileMod.^, options: Boundary) = this()
  }
  @JSImport("@nginstack/engine/lib/multipart/MultipartFormDataReader", JSImport.Namespace)
  @js.native
  ...
  trait MultipartFormDataReader extends StObject {
    ...
    def nextPart(): typingsJapgolly.nginstackEngine.libMultipartMultipartFormDataPartMod.^ = js.native
    ...
    def readForm(): typingsJapgolly.nginstackEngine.libMultipartMultipartFormDataMod.^ = js.native
    def readForm(opt_options: typingsJapgolly.nginstackEngine.libMultipartMultipartFormDataOptionsMod.^): typingsJapgolly.nginstackEngine.libMultipartMultipartFormDataMod.^ = js.native
    def readForm(opt_options: Record[Any, Any]): typingsJapgolly.nginstackEngine.libMultipartMultipartFormDataMod.^ = js.native
