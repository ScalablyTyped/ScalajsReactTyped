...
object libCryptoSha256Mod {
  
  inline def apply(): Unit = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[Unit]
  
  @JSImport("@nginstack/engine/lib/crypto/SHA256", JSImport.Namespace)
  @js.native
  open class ^ ()
    extends StObject
       with SHA256
  ...
  trait SHA256 extends StObject {
    ...
    def update(data: String): SHA256 = js.native
    def update(data: js.typedarray.ArrayBuffer): SHA256 = js.native
    def update(data: js.typedarray.Uint8Array): SHA256 = js.native
  }
}
