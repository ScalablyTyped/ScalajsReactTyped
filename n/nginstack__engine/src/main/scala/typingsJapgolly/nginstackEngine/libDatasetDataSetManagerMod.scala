...
object libDatasetDataSetManagerMod {
  ...
  trait DataSetManager extends StObject {
    ...
    def addDataSet(dataSetName: String, dataSet: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): Unit = js.native
    ...
    def getDataSet(dataSetName: String): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    ...
    def setDataSet(dataSetName: String, dataSet: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): Unit = js.native
