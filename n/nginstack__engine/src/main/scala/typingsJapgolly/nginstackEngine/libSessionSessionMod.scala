...
object libSessionSessionMod {
  ...
  trait Session extends StObject {
    ...
    var application: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^ = js.native
    
    def authorizeToken(authToken: typingsJapgolly.nginstackEngine.libSecurityAuthTokenMod.^): String = js.native
    ...
    def updateAuthToken(authToken: typingsJapgolly.nginstackEngine.libSecurityAuthTokenMod.^): Unit = js.native
