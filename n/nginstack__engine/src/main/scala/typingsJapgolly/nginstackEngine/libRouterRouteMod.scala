...
import typingsJapgolly.nginstackEngine.anon.OpenParameters
...
object libRouterRouteMod {
  ...
  trait Route extends StObject {
    ...
    def assign(`def`: typingsJapgolly.nginstackEngine.libRouterRouteDefMod.^): Unit = js.native
  ...
  type RouteSet = typingsJapgolly.nginstackEngine.libRouterRouteSetMod.^
}
