...
object libDatabaseDbbackupMod {
  ...
  object DBBackup {
    ...
    inline def apply(
      backup: String => Callback,
      partialBackup: (js.Date, String) => Callback,
      restore: Double => RestoreResult
    ): DBBackup = {
      val __obj = js.Dynamic.literal(backup = js.Any.fromFunction1((t0: String) => backup(t0).runNow()), partialBackup = js.Any.fromFunction2((t0: js.Date, t1: String) => (partialBackup(t0, t1)).runNow()), restore = js.Any.fromFunction1(restore))
      __obj.asInstanceOf[DBBackup]
    }
    
    extension [Self <: DBBackup](x: Self) {
      
      inline def setBackup(value: String => Callback): Self = StObject.set(x, "backup", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setPartialBackup(value: (js.Date, String) => Callback): Self = StObject.set(x, "partialBackup", js.Any.fromFunction2((t0: js.Date, t1: String) => (value(t0, t1)).runNow()))
