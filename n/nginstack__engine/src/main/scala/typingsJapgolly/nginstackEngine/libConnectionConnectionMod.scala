...
object libConnectionConnectionMod {
  ...
  inline def fromConfig(key: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^): Connection = ^.asInstanceOf[js.Dynamic].applyDynamic("fromConfig")(key.asInstanceOf[js.Any]).asInstanceOf[Connection]
  ...
  trait Connection extends StObject {
    ...
    def applyUpdates(ArrayOfDataSets: js.Array[typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^]): Double = js.native
    def applyUpdates(
      ArrayOfDataSets: js.Array[typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^],
      insertIntoLogTable: Boolean
    ): Double = js.native
    def applyUpdates(ArrayOfDataSets: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): Double = js.native
    def applyUpdates(
      ArrayOfDataSets: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^,
      insertIntoLogTable: Boolean
    ): Double = js.native
    ...
    def cloneLocalCache(tableName: String): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    
    def cloneLocalCacheByClass(classKey: Double): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    def cloneLocalCacheByClass(classKey: Double, userKeyPermissionViewFilter: Double): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    def cloneLocalCacheByClass(classKey: Double, userKeyPermissionViewFilter: Double, securityExtraFilter: js.Array[Any]): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    def cloneLocalCacheByClass(classKey: Double, userKeyPermissionViewFilter: Unit, securityExtraFilter: js.Array[Any]): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    
    def cloneVfsByClass(classKey: Any, userKeyPermissionViewFilter: Any, securityExtraFilter: Any): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    ...
    def getClassDefinitionSource(
      classKey: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^,
      vfs: Null,
      classes: Null,
      ignoredClassKeys: js.Array[Double]
    ): String = js.native
    ...
    def getDataSet(sqlOrArrayOfSql: String): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ | js.Array[typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^] = js.native
    def getDataSet(sqlOrArrayOfSql: String, options: Any): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ | js.Array[typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^] = js.native
    def getDataSet(sqlOrArrayOfSql: js.Array[String]): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ | js.Array[typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^] = js.native
    def getDataSet(sqlOrArrayOfSql: js.Array[String], options: Any): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ | js.Array[typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^] = js.native
    
    def getDatabaseNames(): String = js.native
    
    def getExecutionPlan(sqlExpression: String): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    ...
    def getReferences(key: Double, tableName: String, maxReturnCount: Double, ignoredTables: js.Array[String]): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    def getReferences(key: Double, tableName: String, maxReturnCount: Null, ignoredTables: js.Array[String]): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = js.native
    ...
    def instanceClassDefinition(
      ...
      iClass: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^
    ): ModelDef = js.native
    def instanceClassDefinition(
      classKeyOrSource: String,
    ...
    def instanceClassDefinition(classKeyOrSource: String, iVfsOrParentKey: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): ModelDef = js.native
    def instanceClassDefinition(
      classKeyOrSource: String,
      iVfsOrParentKey: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^,
      iClass: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^
    ): ModelDef = js.native
    ...
    def instanceClassDefinition(classKeyOrSource: Double, iVfsOrParentKey: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): ModelDef = js.native
    def instanceClassDefinition(
      classKeyOrSource: Double,
      iVfsOrParentKey: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^,
      iClass: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^
    ...
    def setPassword(userKey: typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^, password: String): Unit = js.native
  ...
  type Task = typingsJapgolly.nginstackEngine.libSchedulerTaskMod.^
}
