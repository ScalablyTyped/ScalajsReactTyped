...
import typingsJapgolly.nginstackEngine.anon.IgnoreNonExistingFields
import typingsJapgolly.nginstackEngine.anon.Kind
import typingsJapgolly.nginstackEngine.anon.SharedDelta
import typingsJapgolly.nginstackEngine.anon.ToLowerCase
...
object libDatasetDataSetMod {
  ...
  trait DataSet extends StObject {
    ...
    def dbkey(expr: String): typingsJapgolly.nginstackEngine.libDbkeyDbkeyMod.^ | Null = js.native
  ...
  type DataSetFieldType = typingsJapgolly.nginstackEngine.libDatasetDataSetDataTypeMod.DataSetFieldType
  
  type DeltaInspector = typingsJapgolly.nginstackEngine.libDatasetDeltaInspectorMod.^
  
  type File = typingsJapgolly.nginstackEngine.libIoFileMod.^
  
  type GetFieldOptions = typingsJapgolly.nginstackEngine.libDatasetGetFieldOptionsMod.^
