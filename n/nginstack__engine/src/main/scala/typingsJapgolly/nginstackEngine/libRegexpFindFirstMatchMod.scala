...
object libRegexpFindFirstMatchMod {
  ...
  inline def apply(text: String, exp: typingsJapgolly.nginstackEngine.libRegexpRegexMod.^): String = (^.asInstanceOf[js.Dynamic].apply(text.asInstanceOf[js.Any], exp.asInstanceOf[js.Any])).asInstanceOf[String]
