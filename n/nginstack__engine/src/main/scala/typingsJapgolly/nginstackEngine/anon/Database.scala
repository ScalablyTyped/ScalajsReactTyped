...
trait Database extends StObject {
  ...
  var database: js.UndefOr[typingsJapgolly.nginstackEngine.libDatabaseDbtrackerMod.Database] = js.undefined
...
object Database {
  ...
  extension [Self <: Database](x: Self) {
    ...
    inline def setDatabase(value: typingsJapgolly.nginstackEngine.libDatabaseDbtrackerMod.Database): Self = StObject.set(x, "database", value.asInstanceOf[js.Any])
