...
trait Id extends StObject {
  ...
  var database: js.UndefOr[typingsJapgolly.nginstackEngine.libDatabaseDbtrackerpoolMod.Database] = js.undefined
...
object Id {
  ...
  extension [Self <: Id](x: Self) {
    ...
    inline def setDatabase(value: typingsJapgolly.nginstackEngine.libDatabaseDbtrackerpoolMod.Database): Self = StObject.set(x, "database", value.asInstanceOf[js.Any])
