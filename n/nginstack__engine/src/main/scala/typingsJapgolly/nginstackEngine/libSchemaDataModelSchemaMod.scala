...
import typingsJapgolly.nginstackEngine.anon.PartialDataModelSchemaOpt
...
object libSchemaDataModelSchemaMod {
  ...
  object DataModelSchema {
    ...
    extension [Self <: DataModelSchema](x: Self) {
      ...
      inline def setGetTables(value: CallbackTo[js.Array[TableInfo]]): Self = StObject.set(x, "getTables", value.toJsFn)
      ...
      inline def setGetUnmanagedTableNames(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "getUnmanagedTableNames", value.toJsFn)
      ...
      inline def setScanForClassDefErrors(value: CallbackTo[js.Array[ClassDefError]]): Self = StObject.set(x, "scanForClassDefErrors", value.toJsFn)
