...
object libEngineEngineMod {
  ...
  type ProgressMonitor = typingsJapgolly.nginstackEngine.libProgressProgressMonitorMod.^
  
  type SessionManager = typingsJapgolly.nginstackEngine.libSessionSessionManagerMod.^
