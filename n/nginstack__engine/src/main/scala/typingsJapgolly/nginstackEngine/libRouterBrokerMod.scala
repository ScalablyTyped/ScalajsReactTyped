...
import typingsJapgolly.nginstackEngine.anon.Action
import typingsJapgolly.nginstackEngine.anon.Path
...
object libRouterBrokerMod {
  ...
  trait Broker extends StObject {
    ...
    def handleRequest(route: Action, pathParameters: Any, opt_options: typingsJapgolly.nginstackEngine.anon.Request): Unit = js.native
