...
object libRegexpReplaceAllMod {
  ...
  inline def apply(text: String, exp: typingsJapgolly.nginstackEngine.libRegexpRegexMod.^, replacement: String): String = (^.asInstanceOf[js.Dynamic].apply(text.asInstanceOf[js.Any], exp.asInstanceOf[js.Any], replacement.asInstanceOf[js.Any])).asInstanceOf[String]
