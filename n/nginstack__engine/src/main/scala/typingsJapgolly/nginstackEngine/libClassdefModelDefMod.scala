...
import typingsJapgolly.nginstackEngine.anon.ALWAYS
import typingsJapgolly.nginstackEngine.anon.CONFIG
import typingsJapgolly.nginstackEngine.anon.Display
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libClassdefModelDefMod {
  ...
  type AdapterDescriptor = typingsJapgolly.nginstackEngine.libEventAdapterDescriptorMod.^
  
  type CachedDataOptions = Record[Any, Any]
  
  type ClassDefManager = typingsJapgolly.nginstackEngine.libClassdefClassDefManagerMod.^
  ...
  trait ModelDef extends StObject {
    ...
    var cache: typingsJapgolly.nginstackEngine.libClassdefClassDefCacheMod.^ = js.native
    ...
    var classDefManager: ClassDefManager = js.native
    ...
    def field(name: String): typingsJapgolly.nginstackEngine.libClassdefFieldMod.^ = js.native
    def field(name: String, `type`: String): typingsJapgolly.nginstackEngine.libClassdefFieldMod.^ = js.native
    def field(name: String, `type`: String, size: Double): typingsJapgolly.nginstackEngine.libClassdefFieldMod.^ = js.native
    def field(name: String, `type`: Unit, size: Double): typingsJapgolly.nginstackEngine.libClassdefFieldMod.^ = js.native
    
    def fieldClass(args: Any*): Any = js.native
    
    var fields: typingsJapgolly.nginstackEngine.libClassdefFieldListMod.^ = js.native
    ...
    def findField(name: String): typingsJapgolly.nginstackEngine.libClassdefFieldMod.^ = js.native
    ...
    def getExtraFilterFields(): js.Array[typingsJapgolly.nginstackEngine.libClassdefFieldMod.^] = js.native
    
    def getFieldsAsStringList(): typingsJapgolly.nginstackEngine.libStringStringListMod.^ = js.native
    
    def getFieldsByProperty(args: Any*): js.Array[typingsJapgolly.nginstackEngine.libClassdefFieldMod.^] = js.native
    ...
    def init(opt_parentDef: typingsJapgolly.nginstackEngine.libClassdefClassDefMod.^, args: Any*): Unit = js.native
    ...
    /* protected */ var logger_ : typingsJapgolly.nginstackEngine.libLogLoggerMod.^ = js.native
    ...
    var ownFields: js.Array[typingsJapgolly.nginstackEngine.libClassdefFieldMod.^] = js.native
