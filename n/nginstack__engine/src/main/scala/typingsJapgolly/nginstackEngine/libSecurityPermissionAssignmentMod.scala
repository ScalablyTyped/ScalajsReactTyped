...
object libSecurityPermissionAssignmentMod {
  ...
  inline def fromDataSet(data: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): PermissionAssignment = ^.asInstanceOf[js.Dynamic].applyDynamic("fromDataSet")(data.asInstanceOf[js.Any]).asInstanceOf[PermissionAssignment]
  ...
  trait PermissionAssignment extends StObject {
    ...
    def saveToDataSet(data: typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^): Unit = js.native
