...
object libTestingDatasetNewDataSetMod {
  ...
  inline def apply(fields: js.Array[FieldObj]): typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^ = ^.asInstanceOf[js.Dynamic].apply(fields.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.nginstackEngine.libDatasetDataSetMod.^]
