...
object libBarcodeBarcodeMod {
  ...
  object Barcode {
    ...
    inline def apply(
      angle: Double,
      code: String,
      getJpegImage: CallbackTo[js.typedarray.ArrayBuffer],
      height: Double,
      `type`: String
    ): Barcode = {
      val __obj = js.Dynamic.literal(angle = angle.asInstanceOf[js.Any], code = code.asInstanceOf[js.Any], getJpegImage = getJpegImage.toJsFn, height = height.asInstanceOf[js.Any])
    ...
    extension [Self <: Barcode](x: Self) {
      ...
      inline def setGetJpegImage(value: CallbackTo[js.typedarray.ArrayBuffer]): Self = StObject.set(x, "getJpegImage", value.toJsFn)
