...
import typingsJapgolly.natural.anon.DamerauLevenshteinDistanc
import typingsJapgolly.natural.anon.DamerauLevenshteinDistancDeletioncost
import typingsJapgolly.natural.anon.DamerauLevenshteinDistancInsertioncost
import typingsJapgolly.natural.mod.^
