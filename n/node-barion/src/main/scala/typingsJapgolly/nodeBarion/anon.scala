...
import typingsJapgolly.nodeBarion.mod.BankAccount
import typingsJapgolly.nodeBarion.mod.BillingAddress
import typingsJapgolly.nodeBarion.mod.Money
import typingsJapgolly.nodeBarion.mod.PayerAccountInformation
import typingsJapgolly.nodeBarion.mod.PaymentTransaction
import typingsJapgolly.nodeBarion.mod.PurchaseInformation
import typingsJapgolly.nodeBarion.mod.ShippingAddress
import typingsJapgolly.nodeBarion.mod.TransactionToFinish
import typingsJapgolly.nodeBarion.mod.TransactionToRefund
...
object anon {
  ...
  trait PartialBankTransferReques extends StObject {
    ...
    var BankAccount: js.UndefOr[typingsJapgolly.nodeBarion.mod.BankAccount] = js.undefined
