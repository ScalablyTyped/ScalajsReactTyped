...
object presetJestPresetMod {
  
  object nxPreset {
    
    @JSImport("@nrwl/jest/preset/jest-preset", "nxPreset")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@nrwl/jest/preset/jest-preset", "nxPreset.coverageReporters")
    @js.native
    ...
    @JSImport("@nrwl/jest/preset/jest-preset", "nxPreset.moduleFileExtensions")
    @js.native
    ...
    @JSImport("@nrwl/jest/preset/jest-preset", "nxPreset.resolver")
    @js.native
    ...
    @JSImport("@nrwl/jest/preset/jest-preset", "nxPreset.testEnvironment")
    @js.native
    ...
    /**
      ...
      * }
      */
    @JSImport("@nrwl/jest/preset/jest-preset", "nxPreset.testEnvironmentOptions")
    @js.native
    ...
    @JSImport("@nrwl/jest/preset/jest-preset", "nxPreset.testMatch")
    @js.native
    ...
    @JSImport("@nrwl/jest/preset/jest-preset", "nxPreset.transform")
    @js.native
