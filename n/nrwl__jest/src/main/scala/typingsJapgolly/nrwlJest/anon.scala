...
import typingsJapgolly.jestTypes.mod.InitialProjectOptions
import typingsJapgolly.jestTypes.mod.ReporterConfig
import typingsJapgolly.jestTypes.mod.TransformerConfig
import typingsJapgolly.nrwlJest.srcMigrationsUpdate1240UpdateJestPresetAngularMod.ASTTransformers
...
object anon {
  ...
  trait AstTransformers extends StObject {
    ...
    var astTransformers: ASTTransformers
  }
  object AstTransformers {
    
    inline def apply(astTransformers: ASTTransformers): AstTransformers = {
      val __obj = js.Dynamic.literal(astTransformers = astTransformers.asInstanceOf[js.Any])
      __obj.asInstanceOf[AstTransformers]
    }
    
    extension [Self <: AstTransformers](x: Self) {
      
      inline def setAstTransformers(value: ASTTransformers): Self = StObject.set(x, "astTransformers", value.asInstanceOf[js.Any])
    }
  }
  
  trait CurrentTestCases extends StObject {
    
    var currentTestCases: js.UndefOr[Any] = js.undefined
  ...
  object CurrentTestCases {
    
    inline def apply(): CurrentTestCases = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CurrentTestCases]
    }
    
    extension [Self <: CurrentTestCases](x: Self) {
      
      inline def setCurrentTestCases(value: Any): Self = StObject.set(x, "currentTestCases", value.asInstanceOf[js.Any])
  ...
  trait CustomExportConditions extends StObject {
    
    var customExportConditions: js.Array[String]
  }
  object CustomExportConditions {
    
    inline def apply(customExportConditions: js.Array[String]): CustomExportConditions = {
      val __obj = js.Dynamic.literal(customExportConditions = customExportConditions.asInstanceOf[js.Any])
      __obj.asInstanceOf[CustomExportConditions]
    }
    
    extension [Self <: CustomExportConditions](x: Self) {
      
      inline def setCustomExportConditions(value: js.Array[String]): Self = StObject.set(x, "customExportConditions", value.asInstanceOf[js.Any])
      
      inline def setCustomExportConditionsVarargs(value: String*): Self = StObject.set(x, "customExportConditions", js.Array(value*))
    }
  }
  
  trait DidUpdateRootPreset extends StObject {
    
    var didUpdateRootPreset: Boolean
  }
  object DidUpdateRootPreset {
    
    inline def apply(didUpdateRootPreset: Boolean): DidUpdateRootPreset = {
      val __obj = js.Dynamic.literal(didUpdateRootPreset = didUpdateRootPreset.asInstanceOf[js.Any])
      __obj.asInstanceOf[DidUpdateRootPreset]
    }
    
    extension [Self <: DidUpdateRootPreset](x: Self) {
      
      inline def setDidUpdateRootPreset(value: Boolean): Self = StObject.set(x, "didUpdateRootPreset", value.asInstanceOf[js.Any])
    }
  }
  
  /* Inlined std.Partial<@jest/types.@jest/types.InitialOptions> & {[index: string] : any} */
  trait PartialInitialOptionsinde
    extends StObject
    ...
    @JSName("notify")
    var notify_FPartialInitialOptionsinde: js.UndefOr[Boolean] = js.undefined
  ...
  object PartialInitialOptionsinde {
    
    inline def apply(): PartialInitialOptionsinde = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PartialInitialOptionsinde]
    }
    
    extension [Self <: PartialInitialOptionsinde](x: Self) {
  ...
  object Success {
    ...
    inline def apply(success: Boolean, terminalOutput: String): Success = {
      val __obj = js.Dynamic.literal(success = success.asInstanceOf[js.Any], terminalOutput = terminalOutput.asInstanceOf[js.Any])
    ...
    extension [Self <: Success](x: Self) {
      ...
      inline def setTerminalOutput(value: String): Self = StObject.set(x, "terminalOutput", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait Tsjshtml extends StObject {
    
    @JSName("^.+\\.(ts|js|html)$")
    var `^DotPlussignBackslashDotLeftparenthesistsVerticallinejsVerticallinehtmlRightparenthesis$`: String
  }
  object Tsjshtml {
    
    inline def apply(`^DotPlussignBackslashDotLeftparenthesistsVerticallinejsVerticallinehtmlRightparenthesis$`: String): Tsjshtml = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("^.+\\.(ts|js|html)$")(`^DotPlussignBackslashDotLeftparenthesistsVerticallinejsVerticallinehtmlRightparenthesis$`.asInstanceOf[js.Any])
      __obj.asInstanceOf[Tsjshtml]
    }
    
    extension [Self <: Tsjshtml](x: Self) {
      
      inline def `set^DotPlussignBackslashDotLeftparenthesistsVerticallinejsVerticallinehtmlRightparenthesis$`(value: String): Self = StObject.set(x, "^.+\\.(ts|js|html)$", value.asInstanceOf[js.Any])
    }
  }
  
  trait ValueAsString extends StObject {
    
    var valueAsString: Boolean
  }
  object ValueAsString {
    
    inline def apply(valueAsString: Boolean): ValueAsString = {
      val __obj = js.Dynamic.literal(valueAsString = valueAsString.asInstanceOf[js.Any])
      __obj.asInstanceOf[ValueAsString]
    }
    
    extension [Self <: ValueAsString](x: Self) {
      
      inline def setValueAsString(value: Boolean): Self = StObject.set(x, "valueAsString", value.asInstanceOf[js.Any])
    }
  }
}
