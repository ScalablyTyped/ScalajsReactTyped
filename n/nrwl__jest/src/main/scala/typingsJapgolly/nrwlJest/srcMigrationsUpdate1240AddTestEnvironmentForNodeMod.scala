...
object srcMigrationsUpdate1240AddTestEnvironmentForNodeMod {
  
  @JSImport("@nrwl/jest/src/migrations/update-12-4-0/add-test-environment-for-node", JSImport.Namespace)
  @js.native
