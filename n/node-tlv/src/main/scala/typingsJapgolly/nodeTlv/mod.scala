...
import typingsJapgolly.nodeTlv.anon.Clazz
import typingsJapgolly.nodeTlv.nodeTlvInts.`0`
import typingsJapgolly.nodeTlv.nodeTlvInts.`1`
import typingsJapgolly.nodeTlv.nodeTlvStrings.ascii
import typingsJapgolly.nodeTlv.nodeTlvStrings.buffer
import typingsJapgolly.nodeTlv.nodeTlvStrings.hex
import typingsJapgolly.nodeTlv.nodeTlvStrings.number
...
object mod {
  ...
  object DOLConstructed {
    ...
    inline def apply(
      ...
      getDolRelatedDataLength: CallbackTo[Double],
      getList: CallbackTo[js.Array[TL]],
      list: js.Array[TL],
      print: Callback,
      setValue: /* repeated */ Any => js.Array[TLV]
    ): DOLConstructed = {
      val __obj = js.Dynamic.literal(count = count.toJsFn, find = js.Any.fromFunction1(find), getDolRelatedDataLength = getDolRelatedDataLength.toJsFn, getList = getList.toJsFn, list = list.asInstanceOf[js.Any], print = print.toJsFn, setValue = js.Any.fromFunction1(setValue))
    ...
    extension [Self <: DOLConstructed](x: Self) {
      ...
      inline def setGetDolRelatedDataLength(value: CallbackTo[Double]): Self = StObject.set(x, "getDolRelatedDataLength", value.toJsFn)
      
      inline def setGetList(value: CallbackTo[js.Array[TL]]): Self = StObject.set(x, "getList", value.toJsFn)
