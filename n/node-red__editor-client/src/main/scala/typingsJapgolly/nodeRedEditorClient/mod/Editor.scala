...
import typingsJapgolly.nodeRedEditorClient.anon.Complete
import typingsJapgolly.nodeRedEditorClient.anon.Element
...
trait Editor extends StObject {
  ...
  /**
    ...
    */
  def createEditor(options: Element): typingsJapgolly.ace.AceAjax.Editor = js.native
