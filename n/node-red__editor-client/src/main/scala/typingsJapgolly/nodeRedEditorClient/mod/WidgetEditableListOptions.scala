...
import typingsJapgolly.nodeRedEditorClient.nodeRedEditorClientStrings.auto
...
object WidgetEditableListOptions {
  ...
  extension [Self <: WidgetEditableListOptions[?], T](x: Self & WidgetEditableListOptions[T]) {
    ...
    inline def setAddItem(value: (/* row */ JQuery[HTMLElement], /* index */ Double, /* data */ T) => Callback): Self = StObject.set(x, "addItem", js.Any.fromFunction3((t0: /* row */ JQuery[HTMLElement], t1: /* index */ Double, t2: /* data */ T) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setRemoveItem(value: /* data */ T => Callback): Self = StObject.set(x, "removeItem", js.Any.fromFunction1((t0: /* data */ T) => value(t0).runNow()))
    ...
    inline def setResizeItem(value: (/* row */ JQuery[HTMLElement], /* index */ Double) => Callback): Self = StObject.set(x, "resizeItem", js.Any.fromFunction2((t0: /* row */ JQuery[HTMLElement], t1: /* index */ Double) => (value(t0, t1)).runNow()))
    ...
    inline def setSortItems(value: /* items */ js.Array[JQuery[HTMLElement]] => Callback): Self = StObject.set(x, "sortItems", js.Any.fromFunction1((t0: /* items */ js.Array[JQuery[HTMLElement]]) => value(t0).runNow()))
