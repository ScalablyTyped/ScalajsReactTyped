...
trait Editor extends StObject {
  ...
  var editor: typingsJapgolly.ace.AceAjax.Editor | GetText
...
object Editor {
  ...
  inline def apply(
    editor: typingsJapgolly.ace.AceAjax.Editor | GetText,
  ...
  extension [Self <: Editor](x: Self) {
    ...
    inline def setEditor(value: typingsJapgolly.ace.AceAjax.Editor | GetText): Self = StObject.set(x, "editor", value.asInstanceOf[js.Any])
