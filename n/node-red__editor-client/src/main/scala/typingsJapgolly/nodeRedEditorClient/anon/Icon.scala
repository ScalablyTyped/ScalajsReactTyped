...
import typingsJapgolly.nodeRedEditorClient.nodeRedEditorClientStrings.default
import typingsJapgolly.nodeRedEditorClient.nodeRedEditorClientStrings.simple
