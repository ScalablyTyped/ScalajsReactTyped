...
import typingsJapgolly.nodeRedEditorClient.nodeRedEditorClientStrings.createGroup
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined {  t :'createGroup',   groups :std.Array<object> | undefined} & {  dirty :boolean | undefined,   callback :(ev : @node-red/editor-client.@node-red/editor-client.HistoryEvent): void | undefined} */
trait tcreateGroupgroupsArrayob
  extends StObject
     with HistoryEvent {
...
object tcreateGroupgroupsArrayob {
  
  inline def apply(): tcreateGroupgroupsArrayob = {
    val __obj = js.Dynamic.literal(t = "createGroup")
    __obj.asInstanceOf[tcreateGroupgroupsArrayob]
  }
  
  extension [Self <: tcreateGroupgroupsArrayob](x: Self) {
