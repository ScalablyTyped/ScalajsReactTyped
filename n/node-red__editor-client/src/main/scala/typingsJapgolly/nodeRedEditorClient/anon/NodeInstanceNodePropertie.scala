...
trait NodeInstanceNodePropertie extends StObject {
  ...
  var inputs: (js.UndefOr[typingsJapgolly.nodeRedEditorClient.nodeRedEditorClientInts.`0` | `1`]) & (typingsJapgolly.nodeRedEditorClient.nodeRedEditorClientInts.`0` | `1`) = js.native
