...
import typingsJapgolly.nodelibFsScandir.outAdaptersFsMod.FileSystemAdapter
...
object outSettingsMod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    override val fsStatSettings: typingsJapgolly.nodelibFsStat.mod.Settings = js.native
  ...
  trait Settings extends StObject {
    ...
    val fsStatSettings: typingsJapgolly.nodelibFsStat.mod.Settings
  ...
  object Settings {
    ...
    inline def apply(
      ...
      fsStatSettings: typingsJapgolly.nodelibFsStat.mod.Settings,
    ...
    extension [Self <: Settings](x: Self) {
      ...
      inline def setFsStatSettings(value: typingsJapgolly.nodelibFsStat.mod.Settings): Self = StObject.set(x, "fsStatSettings", value.asInstanceOf[js.Any])
