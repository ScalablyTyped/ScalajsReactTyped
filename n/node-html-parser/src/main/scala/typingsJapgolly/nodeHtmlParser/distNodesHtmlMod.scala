...
import typingsJapgolly.nodeHtmlParser.anon.ClosingSlash
...
object distNodesHtmlMod {
  ...
  trait HTMLElement
    ...
    /**
      ...
      */
    def appendChild[T /* <: typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default */](node: T): T = js.native
    ...
    /**
      ...
      */
    def closest(selector: String): typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default = js.native
    ...
    /**
      ...
      */
    def exchangeChild(
      oldNode: typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default,
      newNode: typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def firstChild: typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default = js.native
    ...
    /**
      ...
      */
    def lastChild: typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default = js.native
    
    def localName: String = js.native
    
    def nextElementSibling: HTMLElement = js.native
    
    def nextSibling: typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default = js.native
    
    def outerHTML: String = js.native
    
    def previousElementSibling: HTMLElement = js.native
    
    def previousSibling: typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default = js.native
    ...
    /**
      ...
      */
    def removeChild(node: typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default): this.type = js.native
    ...
    def replaceWith(nodes: (String | typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default)*): this.type = js.native
    ...
    def set_content(content: js.Array[typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default]): this.type = js.native
    def set_content(
      content: js.Array[typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default],
      options: PartialOptions
    ): this.type = js.native
    def set_content(content: typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default): this.type = js.native
    def set_content(content: typingsJapgolly.nodeHtmlParser.distNodesNodeMod.default, options: PartialOptions): this.type = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nodeHtmlParser.nodeHtmlParserStrings.beforebegin
    - typingsJapgolly.nodeHtmlParser.nodeHtmlParserStrings.afterbegin
    - typingsJapgolly.nodeHtmlParser.nodeHtmlParserStrings.beforeend
    - typingsJapgolly.nodeHtmlParser.nodeHtmlParserStrings.afterend
  */
  trait InsertPosition extends StObject
  object InsertPosition {
    
    inline def afterbegin: typingsJapgolly.nodeHtmlParser.nodeHtmlParserStrings.afterbegin = "afterbegin".asInstanceOf[typingsJapgolly.nodeHtmlParser.nodeHtmlParserStrings.afterbegin]
    
    inline def afterend: typingsJapgolly.nodeHtmlParser.nodeHtmlParserStrings.afterend = "afterend".asInstanceOf[typingsJapgolly.nodeHtmlParser.nodeHtmlParserStrings.afterend]
    
    inline def beforebegin: typingsJapgolly.nodeHtmlParser.nodeHtmlParserStrings.beforebegin = "beforebegin".asInstanceOf[typingsJapgolly.nodeHtmlParser.nodeHtmlParserStrings.beforebegin]
    
    inline def beforeend: typingsJapgolly.nodeHtmlParser.nodeHtmlParserStrings.beforeend = "beforeend".asInstanceOf[typingsJapgolly.nodeHtmlParser.nodeHtmlParserStrings.beforeend]
  }
