...
import typingsJapgolly.ngTable.srcBrowserNgTableFilterConfigMod.NgTableFilterConfig
import typingsJapgolly.ngTable.srcBrowserPublicInterfacesMod.IFilterTemplateDef
import typingsJapgolly.ngTable.srcBrowserPublicInterfacesMod.IFilterTemplateDefMap
