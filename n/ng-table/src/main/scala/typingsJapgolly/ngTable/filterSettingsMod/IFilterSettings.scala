package typingsJapgolly.ngTable.filterSettingsMod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.ngTable.filterComparatorMod.FilterComparator
import typingsJapgolly.ngTable.filterFuncMod.IFilterFunc
import typingsJapgolly.ngTable.filterFuncMod.IFilterValues
...
object IFilterSettings {
  ...
  def apply[T](
    ...
    filterFn: (/* data */ js.Array[T], /* filter */ IFilterValues, /* filterComparator */ FilterComparator[T]) => CallbackTo[js.Array[T]] = null,
    ...
    if (filterFn != null) __obj.updateDynamic("filterFn")(js.Any.fromFunction3((t0: /* data */ js.Array[T], t1: /* filter */ typingsJapgolly.ngTable.filterFuncMod.IFilterValues, t2: /* filterComparator */ typingsJapgolly.ngTable.filterComparatorMod.FilterComparator[T]) => filterFn(t0, t1, t2).runNow()))
