...
import typingsJapgolly.angular.mod.IFilterOrderBy
import typingsJapgolly.angular.mod.IFilterService
import typingsJapgolly.angular.mod.IServiceProvider
import typingsJapgolly.ngTable.filterFuncMod.IFilterFunc
import typingsJapgolly.ngTable.ngTableEventsChannelMod.NgTableEventsChannel
