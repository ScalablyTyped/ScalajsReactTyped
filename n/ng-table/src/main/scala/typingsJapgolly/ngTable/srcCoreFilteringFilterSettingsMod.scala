...
import typingsJapgolly.ngTable.srcCoreFilteringFilterComparatorMod.FilterComparator
import typingsJapgolly.ngTable.srcCoreFilteringFilterFuncMod.IFilterFunc
import typingsJapgolly.ngTable.srcCoreFilteringFilterFuncMod.IFilterValues
...
object srcCoreFilteringFilterSettingsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ngTable.ngTableStrings.stack
    - typingsJapgolly.ngTable.ngTableStrings.horizontal
  */
  trait FilterLayout extends StObject
  object FilterLayout {
    
    inline def horizontal: typingsJapgolly.ngTable.ngTableStrings.horizontal = "horizontal".asInstanceOf[typingsJapgolly.ngTable.ngTableStrings.horizontal]
    
    inline def stack: typingsJapgolly.ngTable.ngTableStrings.stack = "stack".asInstanceOf[typingsJapgolly.ngTable.ngTableStrings.stack]
  }
