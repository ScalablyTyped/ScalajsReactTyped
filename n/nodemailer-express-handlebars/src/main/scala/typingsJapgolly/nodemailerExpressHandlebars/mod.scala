package typingsJapgolly.nodemailerExpressHandlebars

import typingsJapgolly.nodemailer.libMailerMod.PluginFunction
...
object mod {
  ...
  trait HbsTransporter
    extends typingsJapgolly.nodemailer.libMailerMod.^[Any]
