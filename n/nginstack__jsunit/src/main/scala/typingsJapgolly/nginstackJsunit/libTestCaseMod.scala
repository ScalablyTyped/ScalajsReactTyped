...
object libTestCaseMod {
  ...
  object TestCase {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(event = event.asInstanceOf[js.Any], getId = getId.toJsFn, logger_ = logger_.asInstanceOf[js.Any], methodName = methodName.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], testSuite = testSuite.asInstanceOf[js.Any])
