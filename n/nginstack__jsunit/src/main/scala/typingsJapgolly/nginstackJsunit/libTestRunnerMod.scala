...
object libTestRunnerMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    override def runTest(testName: String): typingsJapgolly.nginstackJsunit.libTestResultMod.^ = js.native
  ...
  trait TestRunner extends StObject {
    ...
    def runTest(testName: String): typingsJapgolly.nginstackJsunit.libTestResultMod.^
  ...
  object TestRunner {
    ...
    inline def apply(
      ...
      loadSuite_ : Any,
      logger_ : Any,
      runTest: String => typingsJapgolly.nginstackJsunit.libTestResultMod.^,
      scriptRunner_ : Any,
      suite_ : Any,
      trackingId_ : Any
    ): TestRunner = {
    ...
    extension [Self <: TestRunner](x: Self) {
      ...
      inline def setRunTest(value: String => typingsJapgolly.nginstackJsunit.libTestResultMod.^): Self = StObject.set(x, "runTest", js.Any.fromFunction1(value))
  ...
  type TestSuite = typingsJapgolly.nginstackJsunit.libTestSuiteMod.^
}
