...
import typingsJapgolly.natUpnp.anon.ControlURL
import typingsJapgolly.natUpnp.anon.Device
import typingsJapgolly.natUpnp.anon.Devices
import typingsJapgolly.natUpnp.anon.Dictkey
import typingsJapgolly.natUpnp.anon.Host
import typingsJapgolly.natUpnp.anon.Port
import typingsJapgolly.natUpnp.anon.Service
import typingsJapgolly.natUpnp.anon._empty
import typingsJapgolly.natUpnp.anon.`0`
...
object mod {
  ...
  object Device_ {
    ...
    inline def apply(
      getService: (js.Array[String], CB[ControlURL]) => Callback,
      parseDescription: Device => Devices,
      run: (String, js.Array[js.Tuple2[String, String | Double]], CB[RawResponse]) => Callback
    ): Device_ = {
      val __obj = js.Dynamic.literal(getService = js.Any.fromFunction2((t0: js.Array[String], t1: CB[ControlURL]) => (getService(t0, t1)).runNow()), parseDescription = js.Any.fromFunction1(parseDescription), run = js.Any.fromFunction3((t0: String, t1: js.Array[js.Tuple2[String, String | Double]], t2: CB[RawResponse]) => (run(t0, t1, t2)).runNow()))
      __obj.asInstanceOf[Device_]
    }
    
    extension [Self <: Device_](x: Self) {
      
      inline def setGetService(value: (js.Array[String], CB[ControlURL]) => Callback): Self = StObject.set(x, "getService", js.Any.fromFunction2((t0: js.Array[String], t1: CB[ControlURL]) => (value(t0, t1)).runNow()))
      
      inline def setParseDescription(value: Device => Devices): Self = StObject.set(x, "parseDescription", js.Any.fromFunction1(value))
      
      inline def setRun(value: (String, js.Array[js.Tuple2[String, String | Double]], CB[RawResponse]) => Callback): Self = StObject.set(x, "run", js.Any.fromFunction3((t0: String, t1: js.Array[js.Tuple2[String, String | Double]], t2: CB[RawResponse]) => (value(t0, t1, t2)).runNow()))
    }
  }
