package typingsJapgolly.nodePowershell
...
import typingsJapgolly.nodePowershell.nodePowershellStrings.Bypass
import typingsJapgolly.nodePowershell.nodePowershellStrings.end
import typingsJapgolly.nodePowershell.nodePowershellStrings.err
import typingsJapgolly.nodePowershell.nodePowershellStrings.output
...
object mod {
  ...
  object NodePowershell {
    ...
    inline def apply(
      ...
      clear: CallbackTo[js.Promise[js.Array[Any]]],
      commands: js.Array[String],
      dispose: CallbackTo[js.Promise[String]],
      history: js.Array[Any],
      invocationStateInfo: String,
      invoke: CallbackTo[js.Promise[String]],
      on: (output | err | end, js.Function1[/* output */ String, Unit]) => Callback,
      pid: Double,
      streams: NodePowerShellStream,
      verbose: Boolean
    ): NodePowershell = {
      val __obj = js.Dynamic.literal(addArgument = js.Any.fromFunction1(addArgument), addCommand = js.Any.fromFunction1(addCommand), addParameter = js.Any.fromFunction1(addParameter), addParameters = js.Any.fromFunction1(addParameters), clear = clear.toJsFn, commands = commands.asInstanceOf[js.Any], dispose = dispose.toJsFn, history = history.asInstanceOf[js.Any], invocationStateInfo = invocationStateInfo.asInstanceOf[js.Any], invoke = invoke.toJsFn, on = js.Any.fromFunction2((t0: output | err | end, t1: js.Function1[/* output */ String, Unit]) => (on(t0, t1)).runNow()), pid = pid.asInstanceOf[js.Any], streams = streams.asInstanceOf[js.Any], verbose = verbose.asInstanceOf[js.Any])
    ...
    extension [Self <: NodePowershell](x: Self) {
      ...
      inline def setClear(value: CallbackTo[js.Promise[js.Array[Any]]]): Self = StObject.set(x, "clear", value.toJsFn)
      ...
      inline def setDispose(value: CallbackTo[js.Promise[String]]): Self = StObject.set(x, "dispose", value.toJsFn)
      ...
      inline def setInvoke(value: CallbackTo[js.Promise[String]]): Self = StObject.set(x, "invoke", value.toJsFn)
      
      inline def setOn(value: (output | err | end, js.Function1[/* output */ String, Unit]) => Callback): Self = StObject.set(x, "on", js.Any.fromFunction2((t0: output | err | end, t1: js.Function1[/* output */ String, Unit]) => (value(t0, t1)).runNow()))
