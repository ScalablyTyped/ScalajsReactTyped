...
trait ColumnDefinition[Name /* <: String */, Type]
  ...
  var references: js.UndefOr[typingsJapgolly.nodeSql2.anon.Column] = js.undefined
...
object ColumnDefinition {
  ...
  extension [Self <: ColumnDefinition[?, ?], Name /* <: String */, Type](x: Self & (ColumnDefinition[Name, Type])) {
    ...
    inline def setReferences(value: typingsJapgolly.nodeSql2.anon.Column): Self = StObject.set(x, "references", value.asInstanceOf[js.Any])
