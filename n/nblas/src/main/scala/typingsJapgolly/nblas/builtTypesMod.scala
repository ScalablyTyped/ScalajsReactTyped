...
object builtTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nblas.nblasInts.`141`
    - typingsJapgolly.nblas.nblasInts.`142`
  */
  trait MatrixLeftRight extends StObject
  object MatrixLeftRight {
    
    inline def `141`: typingsJapgolly.nblas.nblasInts.`141` = 141.asInstanceOf[typingsJapgolly.nblas.nblasInts.`141`]
    
    inline def `142`: typingsJapgolly.nblas.nblasInts.`142` = 142.asInstanceOf[typingsJapgolly.nblas.nblasInts.`142`]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nblas.nblasInts.`111`
    - typingsJapgolly.nblas.nblasInts.`112`
    - typingsJapgolly.nblas.nblasInts.`113`
  */
  trait MatrixTrans extends StObject
  object MatrixTrans {
    
    inline def `111`: typingsJapgolly.nblas.nblasInts.`111` = 111.asInstanceOf[typingsJapgolly.nblas.nblasInts.`111`]
    
    inline def `112`: typingsJapgolly.nblas.nblasInts.`112` = 112.asInstanceOf[typingsJapgolly.nblas.nblasInts.`112`]
    
    inline def `113`: typingsJapgolly.nblas.nblasInts.`113` = 113.asInstanceOf[typingsJapgolly.nblas.nblasInts.`113`]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nblas.nblasInts.`131`
    - typingsJapgolly.nblas.nblasInts.`132`
  */
  trait MatrixUnit extends StObject
  object MatrixUnit {
    
    inline def `131`: typingsJapgolly.nblas.nblasInts.`131` = 131.asInstanceOf[typingsJapgolly.nblas.nblasInts.`131`]
    
    inline def `132`: typingsJapgolly.nblas.nblasInts.`132` = 132.asInstanceOf[typingsJapgolly.nblas.nblasInts.`132`]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nblas.nblasInts.`121`
    - typingsJapgolly.nblas.nblasInts.`122`
  */
  trait MatrixUpperLower extends StObject
  object MatrixUpperLower {
    
    inline def `121`: typingsJapgolly.nblas.nblasInts.`121` = 121.asInstanceOf[typingsJapgolly.nblas.nblasInts.`121`]
    
    inline def `122`: typingsJapgolly.nblas.nblasInts.`122` = 122.asInstanceOf[typingsJapgolly.nblas.nblasInts.`122`]
  }
}
