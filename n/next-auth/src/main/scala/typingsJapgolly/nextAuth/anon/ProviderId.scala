...
trait ProviderId extends StObject {
  ...
  var providers: js.Array[typingsJapgolly.nextAuth.providersMod.Provider]
  
  var url: InternalUrl
}
object ProviderId {
  
  inline def apply(providers: js.Array[typingsJapgolly.nextAuth.providersMod.Provider], url: InternalUrl): ProviderId = {
  ...
  extension [Self <: ProviderId](x: Self) {
    ...
    inline def setProviders(value: js.Array[typingsJapgolly.nextAuth.providersMod.Provider]): Self = StObject.set(x, "providers", value.asInstanceOf[js.Any])
    
    inline def setProvidersVarargs(value: typingsJapgolly.nextAuth.providersMod.Provider*): Self = StObject.set(x, "providers", js.Array(value*))
