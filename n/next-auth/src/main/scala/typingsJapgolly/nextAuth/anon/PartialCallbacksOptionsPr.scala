...
trait PartialCallbacksOptionsPr extends StObject {
  ...
  var session: js.UndefOr[
    js.Function1[
      /* params */ SessionToken, 
      Awaitable[typingsJapgolly.nextAuth.coreTypesMod.Session]
    ]
  ] = js.undefined
...
object PartialCallbacksOptionsPr {
  ...
  extension [Self <: PartialCallbacksOptionsPr](x: Self) {
    ...
    inline def setSession(value: /* params */ SessionToken => Awaitable[typingsJapgolly.nextAuth.coreTypesMod.Session]): Self = StObject.set(x, "session", js.Any.fromFunction1(value))
