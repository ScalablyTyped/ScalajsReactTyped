...
import typingsJapgolly.nextAuth.providersOauthMod.AuthorizationEndpointHandler
...
import typingsJapgolly.nextAuth.providersOauthMod.TokenEndpointHandler
import typingsJapgolly.nextAuth.providersOauthMod.UserinfoEndpointHandler
...
trait PartialOAuthConfigany extends StObject {
  ...
  var profile: js.UndefOr[
    js.Function2[
      /* profile */ Any, 
      /* tokens */ TokenSet, 
      Awaitable[typingsJapgolly.nextAuth.coreTypesMod.User]
    ]
  ] = js.undefined
...
object PartialOAuthConfigany {
  ...
  extension [Self <: PartialOAuthConfigany](x: Self) {
    ...
    inline def setProfile(
      value: (/* profile */ Any, /* tokens */ TokenSet) => Awaitable[typingsJapgolly.nextAuth.coreTypesMod.User]
