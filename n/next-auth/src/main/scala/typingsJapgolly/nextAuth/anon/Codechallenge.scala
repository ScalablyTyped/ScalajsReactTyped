...
import typingsJapgolly.nextAuth.nextAuthStrings.S256
...
object Codechallenge {
  ...
  inline def apply(code_challenge: String, cookie: typingsJapgolly.nextAuth.coreLibCookieMod.Cookie): Codechallenge = {
