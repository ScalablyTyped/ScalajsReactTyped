...
object Albumid {
  ...
  extension [Self <: Albumid](x: Self) {
    ...
    inline def setCan_comment(value: typingsJapgolly.nextAuth.nextAuthInts.`0` | typingsJapgolly.nextAuth.nextAuthInts.`1`): Self = StObject.set(x, "can_comment", value.asInstanceOf[js.Any])
