...
trait Client[P] extends StObject {
  ...
  var client: typingsJapgolly.nextAuth.providersOauthMod.Client
...
object Client {
  ...
  inline def apply[P](client: typingsJapgolly.nextAuth.providersOauthMod.Client, provider: OAuthConfig[P] & SigninUrl): Client[P] = {
  ...
  extension [Self <: Client[?], P](x: Self & Client[P]) {
    ...
    inline def setClient(value: typingsJapgolly.nextAuth.providersOauthMod.Client): Self = StObject.set(x, "client", value.asInstanceOf[js.Any])
