...
trait Method extends StObject {
  ...
  var sessionStore: typingsJapgolly.nextAuth.coreLibCookieMod.SessionStore
}
object Method {
  ...
  inline def apply(
    ...
    sessionStore: typingsJapgolly.nextAuth.coreLibCookieMod.SessionStore
  ): Method = {
  ...
  extension [Self <: Method](x: Self) {
    ...
    inline def setSessionStore(value: typingsJapgolly.nextAuth.coreLibCookieMod.SessionStore): Self = StObject.set(x, "sessionStore", value.asInstanceOf[js.Any])
  }
}
