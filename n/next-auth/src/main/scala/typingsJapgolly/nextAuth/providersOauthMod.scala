...
import typingsJapgolly.nextAuth.anon.Checks
import typingsJapgolly.nextAuth.anon.Keys
import typingsJapgolly.nextAuth.anon.PartialClientMetadata
import typingsJapgolly.nextAuth.anon.PartialOAuthConfigany
import typingsJapgolly.nextAuth.anon.Tokens
...
import typingsJapgolly.nextAuth.nextAuthStrings.profile
import typingsJapgolly.nextAuth.providersMod.CommonProviderOptions
import typingsJapgolly.openidClient.mod.AuthorizationParameters
import typingsJapgolly.openidClient.mod.BaseClient
import typingsJapgolly.openidClient.mod.HttpOptions
import typingsJapgolly.openidClient.mod.OAuthCallbackChecks
import typingsJapgolly.openidClient.mod.OpenIDCallbackChecks
import typingsJapgolly.openidClient.mod.TypeOfGenericClient
...
object providersOauthMod {
  ...
  object AdvancedEndpointHandler {
    ...
    extension [Self <: AdvancedEndpointHandler[?, ?, ?], P /* <: UrlParams */, C, R](x: Self & (AdvancedEndpointHandler[P, C, R])) {
      ...
      inline def setRequest(value: /* context */ C & typingsJapgolly.nextAuth.anon.Client[P] => Awaitable[R]): Self = StObject.set(x, "request", js.Any.fromFunction1(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nextAuth.nextAuthStrings.pkce
    - typingsJapgolly.nextAuth.nextAuthStrings.state
    - typingsJapgolly.nextAuth.nextAuthStrings.none
    - typingsJapgolly.nextAuth.nextAuthStrings.nonce
  */
  trait ChecksType extends StObject
  object ChecksType {
    
    inline def nonce: typingsJapgolly.nextAuth.nextAuthStrings.nonce = "nonce".asInstanceOf[typingsJapgolly.nextAuth.nextAuthStrings.nonce]
    
    inline def none: typingsJapgolly.nextAuth.nextAuthStrings.none = "none".asInstanceOf[typingsJapgolly.nextAuth.nextAuthStrings.none]
    
    inline def pkce: typingsJapgolly.nextAuth.nextAuthStrings.pkce = "pkce".asInstanceOf[typingsJapgolly.nextAuth.nextAuthStrings.pkce]
    
    inline def state: typingsJapgolly.nextAuth.nextAuthStrings.state = "state".asInstanceOf[typingsJapgolly.nextAuth.nextAuthStrings.state]
  }
  ...
  type EndpointRequest[C, R, P] = js.Function1[/* context */ C & typingsJapgolly.nextAuth.anon.Client[P], Awaitable[R]]
  ...
  trait OAuthUserConfig[P] extends StObject {
    ...
    var profile: js.UndefOr[
        js.Function2[
          typingsJapgolly.nextAuth.nextAuthStrings.profile, 
          /* tokens */ TokenSet, 
          Awaitable[User]
        ]
      ] = js.undefined
