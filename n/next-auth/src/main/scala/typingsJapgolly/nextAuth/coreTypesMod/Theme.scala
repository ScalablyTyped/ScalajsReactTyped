...
import typingsJapgolly.nextAuth.nextAuthStrings.auto
import typingsJapgolly.nextAuth.nextAuthStrings.dark
import typingsJapgolly.nextAuth.nextAuthStrings.light
