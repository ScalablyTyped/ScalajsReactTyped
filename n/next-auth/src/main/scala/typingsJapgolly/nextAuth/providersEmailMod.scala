...
import typingsJapgolly.nextAuth.nextAuthStrings.Email
import typingsJapgolly.nextAuth.nextAuthStrings.email_
import typingsJapgolly.nextAuth.providersMod.CommonProviderOptions
...
object providersEmailMod {
  ...
  object EmailConfig {
    ...
    extension [Self <: EmailConfig](x: Self) {
      ...
      inline def setGenerateVerificationToken(value: CallbackTo[Awaitable[String]]): Self = StObject.set(x, "generateVerificationToken", value.toJsFn)
