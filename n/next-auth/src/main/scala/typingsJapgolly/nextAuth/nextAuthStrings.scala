...
import typingsJapgolly.nextAuth.corePagesErrorMod.ErrorType
import typingsJapgolly.nextAuth.corePagesSigninMod.SignInErrorTypes
import typingsJapgolly.nextAuth.coreTypesMod.EventType
...
import typingsJapgolly.nextAuth.providersOauthMod.ChecksType
import typingsJapgolly.nextAuth.providersOauthTypesMod.OAuthProviderType
import typingsJapgolly.nextAuth.providersWikimediaMod.WikimediaGrant
import typingsJapgolly.nextAuth.providersWikimediaMod.WikimediaGroup
import typingsJapgolly.nextAuth.providersWikimediaMod.WikimediaRight
