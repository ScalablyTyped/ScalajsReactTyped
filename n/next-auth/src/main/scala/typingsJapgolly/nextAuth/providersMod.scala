...
import typingsJapgolly.nextAuth.providersCredentialsMod.CredentialsConfig
import typingsJapgolly.nextAuth.providersCredentialsMod.CredentialsProvider
import typingsJapgolly.nextAuth.providersCredentialsMod.UserCredentialsConfig
import typingsJapgolly.nextAuth.providersEmailMod.EmailConfig
import typingsJapgolly.nextAuth.providersEmailMod.EmailProvider
import typingsJapgolly.nextAuth.providersEmailMod.EmailUserConfig
import typingsJapgolly.nextAuth.providersOauthMod.OAuthConfig
import typingsJapgolly.nextAuth.providersOauthMod.OAuthProvider
...
object providersMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nextAuth.providersMod.RedirectableProviderType
    - typingsJapgolly.nextAuth.providersOauthTypesMod.OAuthProviderType
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nextAuth.nextAuthStrings.oauth
    - typingsJapgolly.nextAuth.nextAuthStrings.email_
    - typingsJapgolly.nextAuth.nextAuthStrings.credentials_
  */
  ...
  object ProviderType {
    ...
    inline def oauth: typingsJapgolly.nextAuth.nextAuthStrings.oauth = "oauth".asInstanceOf[typingsJapgolly.nextAuth.nextAuthStrings.oauth]
  }
