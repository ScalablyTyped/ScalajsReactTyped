...
import typingsJapgolly.nextAuth.anon.ClientSecret
import typingsJapgolly.nextAuth.nextAuthInts.`0`
import typingsJapgolly.nextAuth.nextAuthInts.`1`
import typingsJapgolly.nextAuth.nextAuthInts.`2`
import typingsJapgolly.nextAuth.nextAuthStrings.`true`
import typingsJapgolly.nextAuth.nextAuthStrings.clientSecret
import typingsJapgolly.nextAuth.nextAuthStrings.httpsColonSlashSlashappleidDotappleDotcom
...
object providersAppleMod {
  ...
  - Dropped {[ P in string ]: any} */ trait AppleProfile extends StObject {
    ...
    /**
      ...
      */
    var email_verified: `true` | typingsJapgolly.nextAuth.nextAuthBooleans.`true`
  ...
  object AppleProfile {
    ...
    inline def apply(
      ...
      auth_time: Double,
      email: String,
      email_verified: `true` | typingsJapgolly.nextAuth.nextAuthBooleans.`true`,
      exp: Double,
      iat: Double,
    ...
    extension [Self <: AppleProfile](x: Self) {
      ...
      inline def setEmail_verified(value: `true` | typingsJapgolly.nextAuth.nextAuthBooleans.`true`): Self = StObject.set(x, "email_verified", value.asInstanceOf[js.Any])
