...
import typingsJapgolly.nextAuth.anon.Dictkey
...
object utilsLoggerMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nextAuth.nextAuthStrings.NEXTAUTH_URL
    - typingsJapgolly.nextAuth.nextAuthStrings.NO_SECRET
    - typingsJapgolly.nextAuth.nextAuthStrings.TWITTER_OAUTH_2_BETA
    - typingsJapgolly.nextAuth.nextAuthStrings.DEBUG_ENABLED
  */
  trait WarningCode extends StObject
  object WarningCode {
    
    inline def DEBUG_ENABLED: typingsJapgolly.nextAuth.nextAuthStrings.DEBUG_ENABLED = "DEBUG_ENABLED".asInstanceOf[typingsJapgolly.nextAuth.nextAuthStrings.DEBUG_ENABLED]
    
    inline def NEXTAUTH_URL: typingsJapgolly.nextAuth.nextAuthStrings.NEXTAUTH_URL = "NEXTAUTH_URL".asInstanceOf[typingsJapgolly.nextAuth.nextAuthStrings.NEXTAUTH_URL]
    
    inline def NO_SECRET: typingsJapgolly.nextAuth.nextAuthStrings.NO_SECRET = "NO_SECRET".asInstanceOf[typingsJapgolly.nextAuth.nextAuthStrings.NO_SECRET]
    
    inline def TWITTER_OAUTH_2_BETA: typingsJapgolly.nextAuth.nextAuthStrings.TWITTER_OAUTH_2_BETA = "TWITTER_OAUTH_2_BETA".asInstanceOf[typingsJapgolly.nextAuth.nextAuthStrings.TWITTER_OAUTH_2_BETA]
  }
}
