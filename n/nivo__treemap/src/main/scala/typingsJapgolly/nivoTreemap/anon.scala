  ...
  trait BorderColor[Datum /* <: js.Object */] extends StObject {
    ...
    var borderColor: js.UndefOr[
        InheritedColorConfig[
          typingsJapgolly.nivoTreemap.distTypesTypesMod.ComputedNodeWithoutStyles[Datum] & Color
        ]
      ] = js.undefined
    
    var colorBy: js.UndefOr[
        String | DatumIdentityAccessor[typingsJapgolly.nivoTreemap.distTypesTypesMod.ComputedNodeWithoutStyles[Datum]]
      ] = js.undefined
    
    var colors: js.UndefOr[
        OrdinalColorScaleConfig[typingsJapgolly.nivoTreemap.distTypesTypesMod.ComputedNodeWithoutStyles[Datum]]
      ] = js.undefined
    ...
    var label: js.UndefOr[
        PropertyAccessor[
          Omit[
            typingsJapgolly.nivoTreemap.distTypesTypesMod.ComputedNodeWithoutStyles[Datum], 
  ...
  object BorderColor {
    ...
    extension [Self <: BorderColor[?], Datum /* <: js.Object */](x: Self & BorderColor[Datum]) {
      ...
      inline def setColorBy(
        value: String | DatumIdentityAccessor[typingsJapgolly.nivoTreemap.distTypesTypesMod.ComputedNodeWithoutStyles[Datum]]
      ): Self = StObject.set(x, "colorBy", value.asInstanceOf[js.Any])
      
      inline def setColorByFunction1(
        value: typingsJapgolly.nivoTreemap.distTypesTypesMod.ComputedNodeWithoutStyles[Datum] => String | Double
      ): Self = StObject.set(x, "colorBy", js.Any.fromFunction1(value))
      
      inline def setColorByUndefined: Self = StObject.set(x, "colorBy", js.undefined)
      
      inline def setColors(
        value: OrdinalColorScaleConfig[typingsJapgolly.nivoTreemap.distTypesTypesMod.ComputedNodeWithoutStyles[Datum]]
      ): Self = StObject.set(x, "colors", value.asInstanceOf[js.Any])
      
      inline def setColorsFunction1(value: typingsJapgolly.nivoTreemap.distTypesTypesMod.ComputedNodeWithoutStyles[Datum] => String): Self = StObject.set(x, "colors", js.Any.fromFunction1(value))
