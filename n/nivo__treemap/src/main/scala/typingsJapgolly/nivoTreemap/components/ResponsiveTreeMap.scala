...
import typingsJapgolly.nivoTreemap.distTypesTypesMod.CustomSvgLayer
...
object ResponsiveTreeMap {
  ...
  inline def apply[Datum /* <: js.Object */](data: Datum, height: Double, width: Double): Builder[Datum] = {
    ...
    new Builder[Datum](js.Array(this.component, __props.asInstanceOf[TreeMapSvgProps[Datum]]))
  }
  
  @JSImport("@nivo/treemap", "ResponsiveTreeMap")
  @js.native
  ...
  open class Builder[Datum /* <: js.Object */] (val args: js.Array[Any])
    ...
    inline def fill(value: js.Array[Id[ComputedNode[Datum]]]): this.type = set("fill", value.asInstanceOf[js.Any])
    
    inline def fillVarargs(value: Id[ComputedNode[Datum]]*): this.type = set("fill", js.Array(value*))
    ...
    inline def layers(value: js.Array[LayerId | CustomSvgLayer[Datum]]): this.type = set("layers", value.asInstanceOf[js.Any])
    
    inline def layersVarargs(value: (LayerId | CustomSvgLayer[Datum])*): this.type = set("layers", js.Array(value*))
  ...
  def withProps[Datum /* <: js.Object */](p: TreeMapSvgProps[Datum]): Builder[Datum] = new Builder[Datum](js.Array(this.component, p.asInstanceOf[js.Any]))
}
