...
import typingsJapgolly.nivoTreemap.distTypesTypesMod.CustomCanvasLayer
...
object ResponsiveTreeMapCanvas {
  ...
  inline def apply[Datum /* <: js.Object */](data: Datum, height: Double, width: Double): Builder[Datum] = {
    ...
    new Builder[Datum](js.Array(this.component, __props.asInstanceOf[TreeMapCanvasProps[Datum]]))
  }
  
  @JSImport("@nivo/treemap", "ResponsiveTreeMapCanvas")
  @js.native
  ...
  def withProps[Datum /* <: js.Object */](p: TreeMapCanvasProps[Datum]): Builder[Datum] = new Builder[Datum](js.Array(this.component, p.asInstanceOf[js.Any]))
}
