...
import typingsJapgolly.nivoCore.mod.ModernMotionProps
...
import typingsJapgolly.nivoTreemap.nivoTreemapStrings.children
import typingsJapgolly.nivoTreemap.nivoTreemapStrings.label
import typingsJapgolly.nivoTreemap.nivoTreemapStrings.left
import typingsJapgolly.nivoTreemap.nivoTreemapStrings.nodes
...
object distTypesTypesMod {
  ...
  object ComputedNodeWithHandlers {
    ...
    extension [Self <: ComputedNodeWithHandlers[?], Datum /* <: js.Object */](x: Self & ComputedNodeWithHandlers[Datum]) {
      ...
      inline def setOnMouseMove(value: ReactMouseEventFrom[Element & Element] => Callback): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction1((t0: ReactMouseEventFrom[Element & Element]) => value(t0).runNow()))
  ...
  type NodeMouseEventHandler[Datum /* <: js.Object */] = js.Function2[/* node */ ComputedNode[Datum], /* event */ ReactMouseEventFrom[Element], Unit]
  ...
  object TreeMapCanvasProps {
    ...
    extension [Self <: TreeMapCanvasProps[?], Datum /* <: js.Object */](x: Self & TreeMapCanvasProps[Datum]) {
      ...
      inline def setOnClick(value: (/* node */ ComputedNode[Datum], /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* node */ ComputedNode[Datum], t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
      
      inline def setOnMouseMove(value: (/* node */ ComputedNode[Datum], /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction2((t0: /* node */ ComputedNode[Datum], t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
  ...
  object TreeMapCommonProps {
    ...
    inline def apply[Datum /* <: js.Object */](
      ...
      margin: Box,
      nodeOpacity: Double,
      onClick: (/* node */ ComputedNode[Datum], /* event */ ReactMouseEventFrom[Element]) => Callback,
      onMouseEnter: (/* node */ ComputedNode[Datum], /* event */ ReactMouseEventFrom[Element]) => Callback,
      onMouseLeave: (/* node */ ComputedNode[Datum], /* event */ ReactMouseEventFrom[Element]) => Callback,
      onMouseMove: (/* node */ ComputedNode[Datum], /* event */ ReactMouseEventFrom[Element]) => Callback,
      orientLabel: Boolean,
      outerPadding: Double,
    ...
    extension [Self <: TreeMapCommonProps[?], Datum /* <: js.Object */](x: Self & TreeMapCommonProps[Datum]) {
      ...
      inline def setOnMouseEnter(value: (/* node */ ComputedNode[Datum], /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction2((t0: /* node */ ComputedNode[Datum], t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnMouseLeave(value: (/* node */ ComputedNode[Datum], /* event */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction2((t0: /* node */ ComputedNode[Datum], t1: /* event */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
