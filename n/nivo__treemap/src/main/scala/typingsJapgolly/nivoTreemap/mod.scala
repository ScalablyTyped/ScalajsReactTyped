...
import typingsJapgolly.nivoTreemap.anon.ComputedNodeWithoutStyles
import typingsJapgolly.nivoTreemap.anon.OmitComputedNodeWithoutSt
import typingsJapgolly.nivoTreemap.anon.OmitComputedNodeWithoutStData
import typingsJapgolly.nivoTreemap.anon.PartialAnimationConfig
...
import typingsJapgolly.nivoTreemap.nivoTreemapStrings.binary
import typingsJapgolly.nivoTreemap.nivoTreemapStrings.bottom
import typingsJapgolly.nivoTreemap.nivoTreemapStrings.dice
...
import typingsJapgolly.nivoTreemap.nivoTreemapStrings.slice
import typingsJapgolly.nivoTreemap.nivoTreemapStrings.sliceDice
import typingsJapgolly.nivoTreemap.nivoTreemapStrings.squarify
...
object mod {
  ...
  object canvasDefaultProps {
    ...
    def colorBy: String | (DatumIdentityAccessor[
        typingsJapgolly.nivoTreemap.distTypesTypesMod.ComputedNodeWithoutStyles[DefaultTreeMapDatum]
      ]) = js.native
    inline def colorBy_=(
