package typingsJapgolly.nodeNetstat

import japgolly.scalajs.react.Callback
import typingsJapgolly.node.NodeJS.ReadableStream
import typingsJapgolly.nodeNetstat.anon.RecursivePartialAddress
...
object mod {
  ...
  object AsyncResult {
    ...
    inline def apply(cancel: Callback): AsyncResult = {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setDone(value: /* error */ js.UndefOr[String] => Callback): Self = StObject.set(x, "done", js.Any.fromFunction1((t0: /* error */ js.UndefOr[String]) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nodeNetstat.nodeNetstatStrings.darwin
    - typingsJapgolly.nodeNetstat.nodeNetstatStrings.linux
    - typingsJapgolly.nodeNetstat.nodeNetstatStrings.win32
  */
  trait Platforms extends StObject
  object Platforms {
    
    inline def darwin: typingsJapgolly.nodeNetstat.nodeNetstatStrings.darwin = "darwin".asInstanceOf[typingsJapgolly.nodeNetstat.nodeNetstatStrings.darwin]
    
    inline def linux: typingsJapgolly.nodeNetstat.nodeNetstatStrings.linux = "linux".asInstanceOf[typingsJapgolly.nodeNetstat.nodeNetstatStrings.linux]
    
    inline def win32: typingsJapgolly.nodeNetstat.nodeNetstatStrings.win32 = "win32".asInstanceOf[typingsJapgolly.nodeNetstat.nodeNetstatStrings.win32]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nodeNetstat.nodeNetstatStrings.SYN_SEND
    - typingsJapgolly.nodeNetstat.nodeNetstatStrings.SYN_RECEIVED
    - typingsJapgolly.nodeNetstat.nodeNetstatStrings.ESTABLISHED
    - typingsJapgolly.nodeNetstat.nodeNetstatStrings.LISTEN
    - typingsJapgolly.nodeNetstat.nodeNetstatStrings.FIN_WAIT_1
    - typingsJapgolly.nodeNetstat.nodeNetstatStrings.TIMED_WAIT
    - typingsJapgolly.nodeNetstat.nodeNetstatStrings.CLOSE_WAIT
    - typingsJapgolly.nodeNetstat.nodeNetstatStrings.FIN_WAIT_2
    - typingsJapgolly.nodeNetstat.nodeNetstatStrings.LAST_ACK
    - typingsJapgolly.nodeNetstat.nodeNetstatStrings.CLOSED
  */
  trait State extends StObject
  object State {
    
    inline def CLOSED: typingsJapgolly.nodeNetstat.nodeNetstatStrings.CLOSED = "CLOSED".asInstanceOf[typingsJapgolly.nodeNetstat.nodeNetstatStrings.CLOSED]
    
    inline def CLOSE_WAIT: typingsJapgolly.nodeNetstat.nodeNetstatStrings.CLOSE_WAIT = "CLOSE_WAIT".asInstanceOf[typingsJapgolly.nodeNetstat.nodeNetstatStrings.CLOSE_WAIT]
    
    inline def ESTABLISHED: typingsJapgolly.nodeNetstat.nodeNetstatStrings.ESTABLISHED = "ESTABLISHED".asInstanceOf[typingsJapgolly.nodeNetstat.nodeNetstatStrings.ESTABLISHED]
    
    inline def FIN_WAIT_1: typingsJapgolly.nodeNetstat.nodeNetstatStrings.FIN_WAIT_1 = "FIN_WAIT_1".asInstanceOf[typingsJapgolly.nodeNetstat.nodeNetstatStrings.FIN_WAIT_1]
    
    inline def FIN_WAIT_2: typingsJapgolly.nodeNetstat.nodeNetstatStrings.FIN_WAIT_2 = "FIN_WAIT_2".asInstanceOf[typingsJapgolly.nodeNetstat.nodeNetstatStrings.FIN_WAIT_2]
    
    inline def LAST_ACK: typingsJapgolly.nodeNetstat.nodeNetstatStrings.LAST_ACK = "LAST_ACK".asInstanceOf[typingsJapgolly.nodeNetstat.nodeNetstatStrings.LAST_ACK]
    
    inline def LISTEN: typingsJapgolly.nodeNetstat.nodeNetstatStrings.LISTEN = "LISTEN".asInstanceOf[typingsJapgolly.nodeNetstat.nodeNetstatStrings.LISTEN]
    
    inline def SYN_RECEIVED: typingsJapgolly.nodeNetstat.nodeNetstatStrings.SYN_RECEIVED = "SYN_RECEIVED".asInstanceOf[typingsJapgolly.nodeNetstat.nodeNetstatStrings.SYN_RECEIVED]
    
    inline def SYN_SEND: typingsJapgolly.nodeNetstat.nodeNetstatStrings.SYN_SEND = "SYN_SEND".asInstanceOf[typingsJapgolly.nodeNetstat.nodeNetstatStrings.SYN_SEND]
    
    inline def TIMED_WAIT: typingsJapgolly.nodeNetstat.nodeNetstatStrings.TIMED_WAIT = "TIMED_WAIT".asInstanceOf[typingsJapgolly.nodeNetstat.nodeNetstatStrings.TIMED_WAIT]
  }
