...
object kem {
  ...
  object rsa {
    ...
    /**
      ...
      */
    inline def create(kdf: KDF): typingsJapgolly.nodeForge.mod.kem.rsa.kem = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(kdf.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.nodeForge.mod.kem.rsa.kem]
    inline def create(kdf: KDF, options: Options): typingsJapgolly.nodeForge.mod.kem.rsa.kem = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(kdf.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.nodeForge.mod.kem.rsa.kem]
    ...
    trait Options extends StObject {
      ...
      /**
        ...
        */
      var prng: js.UndefOr[typingsJapgolly.nodeForge.mod.kem.rsa.random] = js.undefined
    }
    object Options {
      ...
      extension [Self <: Options](x: Self) {
        ...
        inline def setPrng(value: typingsJapgolly.nodeForge.mod.kem.rsa.random): Self = StObject.set(x, "prng", value.asInstanceOf[js.Any])
    ...
    object kem {
      ...
      inline def apply(decrypt: (PrivateKey, String, Double) => String, encrypt: (PublicKey, Double) => EncryptResult): typingsJapgolly.nodeForge.mod.kem.rsa.kem = {
        val __obj = js.Dynamic.literal(decrypt = js.Any.fromFunction3(decrypt), encrypt = js.Any.fromFunction2(encrypt))
        __obj.asInstanceOf[typingsJapgolly.nodeForge.mod.kem.rsa.kem]
      }
      
      extension [Self <: typingsJapgolly.nodeForge.mod.kem.rsa.kem](x: Self) {
    ...
    object random {
      ...
      inline def apply(getBytesSync: Double => Bytes): typingsJapgolly.nodeForge.mod.kem.rsa.random = {
        val __obj = js.Dynamic.literal(getBytesSync = js.Any.fromFunction1(getBytesSync))
        __obj.asInstanceOf[typingsJapgolly.nodeForge.mod.kem.rsa.random]
      }
      
      extension [Self <: typingsJapgolly.nodeForge.mod.kem.rsa.random](x: Self) {
