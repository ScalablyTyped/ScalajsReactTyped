...
trait AuthenticatedAttributes extends StObject {
  ...
  var key: typingsJapgolly.nodeForge.mod.pki.rsa.PrivateKey | String
}
object AuthenticatedAttributes {
  ...
  inline def apply(
    ...
    key: typingsJapgolly.nodeForge.mod.pki.rsa.PrivateKey | String
  ...
  extension [Self <: AuthenticatedAttributes](x: Self) {
    ...
    inline def setKey(value: typingsJapgolly.nodeForge.mod.pki.rsa.PrivateKey | String): Self = StObject.set(x, "key", value.asInstanceOf[js.Any])
  }
}
