package typingsJapgolly.nodeWindows
...
object mod {
  ...
  object LogMode extends StObject {
    ...
    sealed trait append
      extends StObject
         with LogMode
    /* "append" */ val append: typingsJapgolly.nodeWindows.mod.LogMode.append & String = js.native
    
    @js.native
    sealed trait reset
      extends StObject
         with LogMode
    /* "reset" */ val reset: typingsJapgolly.nodeWindows.mod.LogMode.reset & String = js.native
    
    @js.native
    sealed trait roll
      extends StObject
         with LogMode
    /* "roll" */ val roll: typingsJapgolly.nodeWindows.mod.LogMode.roll & String = js.native
    
    @js.native
    sealed trait rotate
      extends StObject
         with LogMode
    /* "rotate" */ val rotate: typingsJapgolly.nodeWindows.mod.LogMode.rotate & String = js.native
  }
