...
import typingsJapgolly.netgear.anon.CurrentDeviceDownBandwidth
import typingsJapgolly.netgear.anon.CurrentVersion
import typingsJapgolly.netgear.anon.DaylightSaving
import typingsJapgolly.netgear.anon.Enabled
import typingsJapgolly.netgear.anon.NTPServer1
import typingsJapgolly.netgear.anon.NewPortMappingInfo
import typingsJapgolly.netgear.netgearBooleans.`false`
import typingsJapgolly.netgear.netgearBooleans.`true`
import typingsJapgolly.netgear.netgearStrings.Allow
import typingsJapgolly.netgear.netgearStrings.Block
