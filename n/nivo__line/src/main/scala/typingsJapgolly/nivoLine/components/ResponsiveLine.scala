...
import typingsJapgolly.nivoLine.mod.AccessorFunc
import typingsJapgolly.nivoLine.mod.Datum
import typingsJapgolly.nivoLine.mod.DatumValue
import typingsJapgolly.nivoLine.mod.Layer
import typingsJapgolly.nivoLine.mod.LineSvgProps
...
object ResponsiveLine {
  ...
  inline def apply(data: js.Array[Serie]): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.nivoLine.mod.ResponsiveLine] {
    ...
    inline def areaBlendMode(value: String): this.type = set("areaBlendMode", value.asInstanceOf[js.Any])
    ...
    inline def enablePointLabel(value: Boolean): this.type = set("enablePointLabel", value.asInstanceOf[js.Any])
    ...
    inline def fill(value: js.Array[Id[Datum]]): this.type = set("fill", value.asInstanceOf[js.Any])
    
    inline def fillVarargs(value: Id[Datum]*): this.type = set("fill", js.Array(value*))
    ...
    inline def layers(value: js.Array[Layer]): this.type = set("layers", value.asInstanceOf[js.Any])
    
    inline def layersVarargs(value: Layer*): this.type = set("layers", js.Array(value*))
    ...
    inline def pointLabel(value: String | AccessorFunc): this.type = set("pointLabel", value.asInstanceOf[js.Any])
    
    inline def pointLabelFunction1(value: /* datum */ X => String): this.type = set("pointLabel", js.Any.fromFunction1(value))
    
    inline def pointLabelYOffset(value: Double): this.type = set("pointLabelYOffset", value.asInstanceOf[js.Any])
