...
object ResponsiveLine {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[LineSvgProps, typingsJapgolly.nivoLine.mod.ResponsiveLine, Unit, LineSvgProps] = {
  ...
  typingsJapgolly.nivoLine.mod.LineSvgProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoLine.mod.ResponsiveLine](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoLine.mod.LineSvgProps])(children: _*)
  }
