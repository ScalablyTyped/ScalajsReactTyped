...
object Line {
  ...
  inline def apply(data: js.Array[Serie], height: Double, width: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[LineSvgProps & Dimensions]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.nivoLine.mod.Line] {
  ...
  def withProps(p: LineSvgProps & Dimensions): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
