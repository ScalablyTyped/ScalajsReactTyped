...
object Line {
  def apply(
    ...
    LineSvgProps with Dimensions, 
    typingsJapgolly.nivoLine.mod.Line, 
    Unit, 
    LineSvgProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoLine.mod.LineSvgProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoLine.mod.Line](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoLine.mod.LineSvgProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
