...
import typingsJapgolly.nivoScales.mod.ScaleFunc
...
object LineCustomLayerProps {
  ...
  def apply(
    ...
    xScale: /* value */ String | Double | js.Date => CallbackTo[Double],
    yScale: /* value */ String | Double | js.Date => CallbackTo[Double],
    ...
    __obj.updateDynamic("xScale")(js.Any.fromFunction1((t0: /* value */ java.lang.String | scala.Double | js.Date) => xScale(t0).runNow()))
    __obj.updateDynamic("yScale")(js.Any.fromFunction1((t0: /* value */ java.lang.String | scala.Double | js.Date) => yScale(t0).runNow()))
