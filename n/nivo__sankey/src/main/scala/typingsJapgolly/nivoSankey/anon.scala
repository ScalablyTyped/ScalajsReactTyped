...
import typingsJapgolly.nivoSankey.nivoSankeyStrings.nivo
...
object anon {
  ...
  object CurrentLink {
    ...
    inline def apply[N /* <: DefaultNode */, L /* <: DefaultLink */](
      ...
      setCurrentLink: SetStateAction[(SankeyLinkDatum[N, L]) | Null] => Callback,
      setCurrentNode: SetStateAction[(SankeyNodeDatum[N, L]) | Null] => Callback
    ): CurrentLink[N, L] = {
      val __obj = js.Dynamic.literal(getLabelTextColor = getLabelTextColor.asInstanceOf[js.Any], getNodeBorderColor = getNodeBorderColor.asInstanceOf[js.Any], legendData = legendData.asInstanceOf[js.Any], links = links.asInstanceOf[js.Any], nodes = nodes.asInstanceOf[js.Any], setCurrentLink = js.Any.fromFunction1((t0: SetStateAction[(SankeyLinkDatum[N, L]) | Null]) => setCurrentLink(t0).runNow()), setCurrentNode = js.Any.fromFunction1((t0: SetStateAction[(SankeyNodeDatum[N, L]) | Null]) => setCurrentNode(t0).runNow()), currentLink = null, currentNode = null)
    ...
    extension [Self <: CurrentLink[?, ?], N /* <: DefaultNode */, L /* <: DefaultLink */](x: Self & (CurrentLink[N, L])) {
      ...
      inline def setSetCurrentLink(value: SetStateAction[(SankeyLinkDatum[N, L]) | Null] => Callback): Self = StObject.set(x, "setCurrentLink", js.Any.fromFunction1((t0: SetStateAction[(SankeyLinkDatum[N, L]) | Null]) => value(t0).runNow()))
      
      inline def setSetCurrentNode(value: SetStateAction[(SankeyNodeDatum[N, L]) | Null] => Callback): Self = StObject.set(x, "setCurrentNode", js.Any.fromFunction1((t0: SetStateAction[(SankeyNodeDatum[N, L]) | Null]) => value(t0).runNow()))
    }
  }
