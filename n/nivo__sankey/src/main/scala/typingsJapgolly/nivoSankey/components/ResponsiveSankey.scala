...
object ResponsiveSankey {
  def apply(
    ...
    Data with SankeyProps, 
    typingsJapgolly.nivoSankey.mod.ResponsiveSankey, 
    Unit, 
    Data with SankeyProps
  ] = {
  ...
  typingsJapgolly.nivoSankey.mod.Data with typingsJapgolly.nivoSankey.mod.SankeyProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoSankey.mod.ResponsiveSankey](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoSankey.mod.Data with typingsJapgolly.nivoSankey.mod.SankeyProps])(children: _*)
  }
