...
import typingsJapgolly.nodemailer.smtpConnectionMod.CustomAuthenticationHandlers
import typingsJapgolly.nodemailer.smtpConnectionMod.DSNOptions
import typingsJapgolly.nodemailer.smtpConnectionMod.ms
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typingsJapgolly.nodemailer.smtpConnectionMod.Options because var conflicts: auth. Inlined host, port, secure, ignoreTLS, requireTLS, opportunisticTLS, name, localAddress, connectionTimeout, greetingTimeout, socketTimeout, logger, transactionLog, debug, authMethod, tls, socket, connection, customAuth */ trait Options
  extends MailOptions
...
object Options {
  ...
  def apply(
    ...
    auth: typingsJapgolly.nodemailer.smtpConnectionMod.AuthenticationType = null,
    ...
    getSocket: (Options, /* callback */ js.Function2[/* err */ js.Error | Null, /* socketOptions */ js.Any, Unit]) => Callback = null,
    ...
    if (getSocket != null) __obj.updateDynamic("getSocket")(js.Any.fromFunction2((t0: typingsJapgolly.nodemailer.smtpTransportMod.Options, t1: /* callback */ js.Function2[/* err */ js.Error | scala.Null, /* socketOptions */ js.Any, scala.Unit]) => getSocket(t0, t1).runNow()))
