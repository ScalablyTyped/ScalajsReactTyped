  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setProvisionCallback(
        value: (/* user */ String, /* renew */ Boolean, /* callback */ js.Function3[/* err */ js.Error | Null, /* accessToken */ String, /* expires */ Double, Unit]) => Callback
      ): Self = StObject.set(x, "provisionCallback", js.Any.fromFunction3((t0: /* user */ String, t1: /* renew */ Boolean, t2: /* callback */ js.Function3[/* err */ js.Error | Null, /* accessToken */ String, /* expires */ Double, Unit]) => (value(t0, t1, t2)).runNow()))
