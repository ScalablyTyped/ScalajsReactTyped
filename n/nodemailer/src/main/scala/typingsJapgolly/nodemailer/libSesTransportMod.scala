...
import typingsJapgolly.nodemailer.anon.Callback
import typingsJapgolly.nodemailer.anon.Data
import typingsJapgolly.nodemailer.anon.Name
import typingsJapgolly.nodemailer.anon.Pending
...
object libSesTransportMod {
  ...
  trait SESTransport
    ...
    @JSName("mailer")
    var mailer_SESTransport: typingsJapgolly.nodemailer.libMailerMod.^[SentMessageInfo] = js.native
