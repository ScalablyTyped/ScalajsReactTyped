...
import typingsJapgolly.nodemailer.anon.Comment
import typingsJapgolly.nodemailer.anon.Prepared
import typingsJapgolly.nodemailer.anon.Value
import typingsJapgolly.nodemailer.libSharedMod.Logger
import typingsJapgolly.nodemailer.libXoauth2Mod.Token
...
import typingsJapgolly.nodemailer.nodemailerStrings.`7bit`
import typingsJapgolly.nodemailer.nodemailerStrings.`inline`
import typingsJapgolly.nodemailer.nodemailerStrings.`quoted-printable`
import typingsJapgolly.nodemailer.nodemailerStrings.attachment
import typingsJapgolly.nodemailer.nodemailerStrings.base64
...
object libMailerMod {
  ...
  trait Mail[T] extends EventEmitter {
    ...
    var MailMessage: typingsJapgolly.nodemailer.libMailerMailMessageMod.^[T] = js.native
    ...
    var dkim: typingsJapgolly.nodemailer.libDkimMod.^ = js.native
    ...
    def get(
      key: proxy_handler_http | proxy_handler_https | proxy_handler_socks | proxy_handler_socks5 | proxy_handler_socks4 | proxy_handler_socks4a
        ...
        /* callback */ js.Function2[
          /* err */ js.Error | Null, 
          /* socketOptions */ typingsJapgolly.nodemailer.anon.Connection, 
          Unit
        ], 
        Unit
      ] = js.native
    ...
    def set(
      ...
      value: js.Function3[
          ...
          /* callback */ js.Function2[
            /* err */ js.Error | Null, 
            /* socketOptions */ js.UndefOr[typingsJapgolly.nodemailer.anon.Connection], 
            Unit
          ], 
          Unit
        ]
  ...
  trait Options extends StObject {
    ...
    var dkim: js.UndefOr[typingsJapgolly.nodemailer.libDkimMod.Options] = js.undefined
    
    /** optional transfer encoding for the textual parts */
    var encoding: js.UndefOr[String] = js.undefined
    
    /** optional SMTP envelope, if auto generated envelope is not suitable */
    var envelope: js.UndefOr[Envelope | typingsJapgolly.nodemailer.libMimeNodeMod.Envelope] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setDkim(value: typingsJapgolly.nodemailer.libDkimMod.Options): Self = StObject.set(x, "dkim", value.asInstanceOf[js.Any])
      ...
      inline def setEnvelope(value: Envelope | typingsJapgolly.nodemailer.libMimeNodeMod.Envelope): Self = StObject.set(x, "envelope", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object TextEncoding {
    ...
    inline def base64: typingsJapgolly.nodemailer.nodemailerStrings.base64 = "base64".asInstanceOf[typingsJapgolly.nodemailer.nodemailerStrings.base64]
    
    inline def `quoted-printable`: typingsJapgolly.nodemailer.nodemailerStrings.`quoted-printable` = "quoted-printable".asInstanceOf[typingsJapgolly.nodemailer.nodemailerStrings.`quoted-printable`]
  }
}
