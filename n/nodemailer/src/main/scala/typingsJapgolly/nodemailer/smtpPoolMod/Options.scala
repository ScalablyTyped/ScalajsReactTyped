...
object Options {
  ...
  def apply(
    ...
    if (getSocket != null) __obj.updateDynamic("getSocket")(js.Any.fromFunction2((t0: typingsJapgolly.nodemailer.smtpPoolMod.Options, t1: /* callback */ js.Function2[/* err */ js.Error | scala.Null, /* socketOptions */ js.Any, scala.Unit]) => getSocket(t0, t1).runNow()))
