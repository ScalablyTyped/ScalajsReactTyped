...
trait Options extends js.Object {
  ...
  var dkim: js.UndefOr[typingsJapgolly.nodemailer.dkimMod.Options] = js.undefined
  ...
  var envelope: js.UndefOr[Envelope | typingsJapgolly.nodemailer.mimeNodeMod.Envelope] = js.undefined
