...
import typingsJapgolly.nodemailer.libSmtpConnectionMod.AuthenticationType
...
object libSmtpPoolMod {
  ...
  trait SMTPPool
    ...
    @JSName("mailer")
    var mailer_SMTPPool: typingsJapgolly.nodemailer.libMailerMod.^[SentMessageInfo] = js.native
  ...
  trait SentMessageInfo
    extends StObject
       with typingsJapgolly.nodemailer.libSmtpConnectionMod.SentMessageInfo {
