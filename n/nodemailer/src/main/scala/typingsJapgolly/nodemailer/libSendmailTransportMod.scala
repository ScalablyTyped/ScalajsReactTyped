...
object libSendmailTransportMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    @JSName("mailer")
    var mailer_SendmailTransport: typingsJapgolly.nodemailer.libMailerMod.^[SentMessageInfo] = js.native
  ...
  trait SendmailTransport
    ...
    @JSName("mailer")
    var mailer_SendmailTransport: typingsJapgolly.nodemailer.libMailerMod.^[SentMessageInfo]
