package typingsJapgolly.nodemailer.mailMessageMod
...
trait MailMessage extends js.Object {
  ...
  var mailer: typingsJapgolly.nodemailer.mailerMod.^ = js.native
  var message: typingsJapgolly.nodemailer.mimeNodeMod.^ = js.native
  def normalize(
