package typingsJapgolly.nodemailer.mimeNodeMod
...
import typingsJapgolly.nodemailer.AnonValue
...
trait MimeNode extends js.Object {
  ...
  def setEnvelope(envelope: typingsJapgolly.nodemailer.mailerMod.Envelope): this.type = js.native
