...
import typingsJapgolly.nodemailer.anon.Flatten
import typingsJapgolly.nodemailer.anon.`0`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libAddressparserMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nodemailer.libAddressparserMod.Address
    - typingsJapgolly.nodemailer.libAddressparserMod.Group
  */
  trait AddressOrGroup extends StObject
  object AddressOrGroup {
    
    inline def Address(address: String, name: String): typingsJapgolly.nodemailer.libAddressparserMod.Address = {
      val __obj = js.Dynamic.literal(address = address.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.nodemailer.libAddressparserMod.Address]
    }
    
    inline def Group(group: js.Array[AddressOrGroup], name: String): typingsJapgolly.nodemailer.libAddressparserMod.Group = {
      val __obj = js.Dynamic.literal(group = group.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.nodemailer.libAddressparserMod.Group]
    }
  }
