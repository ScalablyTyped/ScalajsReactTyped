...
object NavigationLink {
  def apply(
    ...
    historyAction: add | replace | typingsJapgolly.navigationReact.navigationReactStrings.none = null,
    href: String = null,
    ...
    lang: String = null,
    media: String = null,
    navigating: (/* e */ ReactMouseEventFrom[HTMLAnchorElement], /* link */ String) => CallbackTo[Boolean] = null,
    ...
    NavigationLinkProps, 
    typingsJapgolly.navigationReact.mod.NavigationLink, 
    Unit, 
    NavigationLinkProps
  ] = {
  ...
  typingsJapgolly.navigationReact.mod.NavigationLinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.navigationReact.mod.NavigationLink](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.navigationReact.mod.NavigationLinkProps])(children: _*)
  }
