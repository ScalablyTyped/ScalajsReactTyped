...
import typingsJapgolly.navigationReact.mod.NavigationLinkProps
...
object NavigationLink {
  ...
  inline def apply[NavigationInfo /* <: StringDictionary[Any] */, StateKey /* <: /* keyof NavigationInfo */ String */](stateKey: StateKey & (/* keyof NavigationInfo */ String)): Builder[NavigationInfo, StateKey] = {
    val __props = js.Dynamic.literal(stateKey = stateKey.asInstanceOf[js.Any])
    new Builder[NavigationInfo, StateKey](js.Array(this.component, __props.asInstanceOf[NavigationLinkProps[NavigationInfo, StateKey]]))
  }
  ...
  @scala.inline
  open class Builder[NavigationInfo /* <: StringDictionary[Any] */, StateKey /* <: /* keyof NavigationInfo */ String */] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.navigationReact.mod.NavigationLink[NavigationInfo, StateKey]] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def activeCssClass(value: String): this.type = set("activeCssClass", value.asInstanceOf[js.Any])
    
    inline def activeStyle(value: Any): this.type = set("activeStyle", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("currentDataKeys", value.asInstanceOf[js.Any])
    
    inline def currentDataKeysVarargs(
    ...
    ): this.type = set("currentDataKeys", js.Array(value*))
    ...
    inline def disableActive(value: Boolean): this.type = set("disableActive", value.asInstanceOf[js.Any])
    ...
    inline def historyAction(value: add | replace | typingsJapgolly.navigationReact.navigationReactStrings.none): this.type = set("historyAction", value.asInstanceOf[js.Any])
    ...
    inline def includeCurrentData(value: Boolean): this.type = set("includeCurrentData", value.asInstanceOf[js.Any])
    ...
    inline def navigating(value: (/* e */ ReactMouseEventFrom[HTMLAnchorElement], /* link */ String) => Boolean): this.type = set("navigating", js.Any.fromFunction2(value))
    
    inline def navigationData(
    ...
    ): this.type = set("navigationData", value.asInstanceOf[js.Any])
    ...
    inline def startTransition(value: /* transition */ js.Function0[Unit] => Callback): this.type = set("startTransition", js.Any.fromFunction1((t0: /* transition */ js.Function0[Unit]) => value(t0).runNow()))
  ...
  def withProps[NavigationInfo /* <: StringDictionary[Any] */, StateKey /* <: /* keyof NavigationInfo */ String */](p: NavigationLinkProps[NavigationInfo, StateKey]): Builder[NavigationInfo, StateKey] = new Builder[NavigationInfo, StateKey](js.Array(this.component, p.asInstanceOf[js.Any]))
}
