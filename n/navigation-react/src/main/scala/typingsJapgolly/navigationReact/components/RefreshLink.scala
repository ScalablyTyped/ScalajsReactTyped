...
object RefreshLink {
  def apply(
    ...
    RefreshLinkProps, 
    typingsJapgolly.navigationReact.mod.RefreshLink, 
    Unit, 
    RefreshLinkProps
  ] = {
  ...
  typingsJapgolly.navigationReact.mod.RefreshLinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.navigationReact.mod.RefreshLink](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.navigationReact.mod.RefreshLinkProps])(children: _*)
  }
