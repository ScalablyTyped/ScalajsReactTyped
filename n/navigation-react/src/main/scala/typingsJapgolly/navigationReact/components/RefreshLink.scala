...
import typingsJapgolly.navigationReact.mod.RefreshLinkProps
...
object RefreshLink {
  ...
  inline def apply[NavigationInfo /* <: StringDictionary[Any] */, Key /* <: /* keyof NavigationInfo */ String */](): Builder[NavigationInfo, Key] = {
    val __props = js.Dynamic.literal()
    new Builder[NavigationInfo, Key](js.Array(this.component, __props.asInstanceOf[RefreshLinkProps[NavigationInfo, Key]]))
  }
  ...
  @scala.inline
  open class Builder[NavigationInfo /* <: StringDictionary[Any] */, Key /* <: /* keyof NavigationInfo */ String */] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.navigationReact.mod.RefreshLink[NavigationInfo, Key]] {
  ...
  implicit def make[NavigationInfo /* <: StringDictionary[Any] */, Key /* <: /* keyof NavigationInfo */ String */](companion: RefreshLink.type): Builder[NavigationInfo, Key] = new Builder[NavigationInfo, Key](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps[NavigationInfo /* <: StringDictionary[Any] */, Key /* <: /* keyof NavigationInfo */ String */](p: RefreshLinkProps[NavigationInfo, Key]): Builder[NavigationInfo, Key] = new Builder[NavigationInfo, Key](js.Array(this.component, p.asInstanceOf[js.Any]))
}
