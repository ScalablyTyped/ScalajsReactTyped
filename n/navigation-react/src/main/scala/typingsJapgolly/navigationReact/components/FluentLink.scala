...
import typingsJapgolly.navigationReact.mod.FluentLinkProps
...
object FluentLink {
  ...
  inline def apply[NavigationInfo /* <: StringDictionary[Any] */, Key /* <: /* keyof NavigationInfo */ String */](navigate: FluentNavigator[NavigationInfo, Key] => FluentNavigator[NavigationInfo, String]): Builder[NavigationInfo, Key] = {
    val __props = js.Dynamic.literal(navigate = js.Any.fromFunction1(navigate))
    new Builder[NavigationInfo, Key](js.Array(this.component, __props.asInstanceOf[FluentLinkProps[NavigationInfo, Key]]))
  }
  ...
  open class Builder[NavigationInfo /* <: StringDictionary[Any] */, Key /* <: /* keyof NavigationInfo */ String */] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.navigationReact.mod.FluentLink[NavigationInfo, Key]] {
    ...
    inline def withContext(value: Boolean): this.type = set("withContext", value.asInstanceOf[js.Any])
  }
  
  def withProps[NavigationInfo /* <: StringDictionary[Any] */, Key /* <: /* keyof NavigationInfo */ String */](p: FluentLinkProps[NavigationInfo, Key]): Builder[NavigationInfo, Key] = new Builder[NavigationInfo, Key](js.Array(this.component, p.asInstanceOf[js.Any]))
}
