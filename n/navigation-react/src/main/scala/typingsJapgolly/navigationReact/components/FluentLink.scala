...
object FluentLink {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[FluentLinkProps, typingsJapgolly.navigationReact.mod.FluentLink, Unit, FluentLinkProps] = {
  ...
  typingsJapgolly.navigationReact.mod.FluentLinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.navigationReact.mod.FluentLink](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.navigationReact.mod.FluentLinkProps])(children: _*)
  }
