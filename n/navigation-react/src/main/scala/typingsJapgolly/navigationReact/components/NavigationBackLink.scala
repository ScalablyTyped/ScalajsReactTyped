...
import typingsJapgolly.navigationReact.mod.NavigationBackLinkProps
...
object NavigationBackLink {
  def apply(
    ...
    typingsJapgolly.navigationReact.mod.NavigationBackLink, 
    Unit, 
    NavigationBackLinkProps
  ] = {
  ...
  typingsJapgolly.navigationReact.mod.NavigationBackLinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.navigationReact.mod.NavigationBackLink](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.navigationReact.mod.NavigationBackLinkProps])(children: _*)
  }
