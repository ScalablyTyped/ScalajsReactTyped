...
object FluentLinkProps {
  @scala.inline
  def apply(
    navigate: FluentNavigator => CallbackTo[FluentNavigator],
    about: String = null,
    ...
    __obj.updateDynamic("navigate")(js.Any.fromFunction1((t0: typingsJapgolly.navigation.mod.FluentNavigator) => navigate(t0).runNow()))
