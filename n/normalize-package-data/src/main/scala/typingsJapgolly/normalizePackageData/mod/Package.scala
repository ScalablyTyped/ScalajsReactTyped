...
import typingsJapgolly.normalizePackageData.AnonEmail
import typingsJapgolly.normalizePackageData.AnonType
import typingsJapgolly.normalizePackageData.AnonUrl
