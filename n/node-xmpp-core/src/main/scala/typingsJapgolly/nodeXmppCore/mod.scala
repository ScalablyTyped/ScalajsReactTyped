...
object mod extends js.Object {
  ...
  def createStanza(name: String): typingsJapgolly.ltx.mod.Element = js.native
  def createStanza(name: String, attrs: js.Any): typingsJapgolly.ltx.mod.Element = js.native
