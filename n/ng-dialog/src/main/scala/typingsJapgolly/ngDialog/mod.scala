package typingsJapgolly.ngDialog
...
object mod {
  ...
  type IDialogClosePromise = typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogClosePromise
  
  type IDialogConfirmScope = typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogConfirmScope
  
  type IDialogOpenConfirmOptions = typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenConfirmOptions
  
  type IDialogOpenOptions = typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenOptions
  
  type IDialogOpenResult = typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenResult
  
  type IDialogOptions = typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions
  
  type IDialogProvider = typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogProvider
  
  type IDialogScope = typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogScope
  
  type IDialogService = typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogService
  ...
  object angularAugmentingMod {
    ...
    object dialog {
      ...
      object IDialogClosePromise {
        ...
        inline def apply(id: String, value: Any): typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogClosePromise = {
          val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
          __obj.asInstanceOf[typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogClosePromise]
        }
        
        extension [Self <: typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogClosePromise](x: Self) {
      ...
      trait IDialogConfirmScope
        extends StObject
           with typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogScope {
      ...
      trait IDialogOpenConfirmOptions
        extends StObject
           with typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenOptions {
        
        @JSName("scope")
        var scope_IDialogOpenConfirmOptions: js.UndefOr[typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogConfirmScope] = js.undefined
      }
      object IDialogOpenConfirmOptions {
        
        inline def apply(template: String): typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenConfirmOptions = {
          val __obj = js.Dynamic.literal(template = template.asInstanceOf[js.Any])
          __obj.asInstanceOf[typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenConfirmOptions]
        }
        
        extension [Self <: typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenConfirmOptions](x: Self) {
          
          inline def setScope(value: typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogConfirmScope): Self = StObject.set(x, "scope", value.asInstanceOf[js.Any])
      ...
      trait IDialogOpenOptions
        extends StObject
           with typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions {
      ...
      object IDialogOpenOptions {
        ...
        inline def apply(template: String): typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenOptions = {
          val __obj = js.Dynamic.literal(template = template.asInstanceOf[js.Any])
          __obj.asInstanceOf[typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenOptions]
        }
        
        extension [Self <: typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenOptions](x: Self) {
      ...
      trait IDialogOpenResult extends StObject {
        ...
        var closePromise: IPromise[typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogClosePromise] = js.native
      ...
      object IDialogOptions {
        ...
        inline def apply(): typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions]
        }
        
        extension [Self <: typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions](x: Self) {
      ...
      trait IDialogProvider
        ...
        /**
          ...
          * @returns {}
          */
        def setDefaults(defaultOptions: typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions): Unit
      ...
      object IDialogProvider {
        ...
        inline def apply(
          $get: Any,
          setDefaults: typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions => Callback,
          setForceBodyReload: Boolean => Callback,
          setForceHtmlReload: Boolean => Callback
        ): typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogProvider = {
          val __obj = js.Dynamic.literal($get = $get.asInstanceOf[js.Any], setDefaults = js.Any.fromFunction1((t0: typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions) => setDefaults(t0).runNow()), setForceBodyReload = js.Any.fromFunction1((t0: Boolean) => setForceBodyReload(t0).runNow()), setForceHtmlReload = js.Any.fromFunction1((t0: Boolean) => setForceHtmlReload(t0).runNow()))
          __obj.asInstanceOf[typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogProvider]
        }
        
        extension [Self <: typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogProvider](x: Self) {
          
          inline def setSetDefaults(value: typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions => Callback): Self = StObject.set(x, "setDefaults", js.Any.fromFunction1((t0: typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions) => value(t0).runNow()))
          
          inline def setSetForceBodyReload(value: Boolean => Callback): Self = StObject.set(x, "setForceBodyReload", js.Any.fromFunction1((t0: Boolean) => value(t0).runNow()))
          
          inline def setSetForceHtmlReload(value: Boolean => Callback): Self = StObject.set(x, "setForceHtmlReload", js.Any.fromFunction1((t0: Boolean) => value(t0).runNow()))
        }
      }
      ...
      trait IDialogService extends StObject {
        ...
        def getDefaults(): typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOptions = js.native
        ...
        def open(options: typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenOptions): typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenResult = js.native
        
        def openConfirm(options: typingsJapgolly.ngDialog.mod.angularAugmentingMod.dialog.IDialogOpenConfirmOptions): IPromise[Any] = js.native
      }
    }
  }
}
