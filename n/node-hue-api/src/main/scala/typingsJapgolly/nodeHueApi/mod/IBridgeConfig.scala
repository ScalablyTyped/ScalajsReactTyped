...
import typingsJapgolly.nodeHueApi.anon.Checkforupdate
import typingsJapgolly.nodeHueApi.anon.Communication
import typingsJapgolly.nodeHueApi.anon.Createdate
import typingsJapgolly.nodeHueApi.anon.Errorcode
