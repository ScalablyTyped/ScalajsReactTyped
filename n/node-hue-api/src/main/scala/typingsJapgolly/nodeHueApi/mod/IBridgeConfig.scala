...
import typingsJapgolly.nodeHueApi.AnonCheckforupdate
import typingsJapgolly.nodeHueApi.AnonCommunication
import typingsJapgolly.nodeHueApi.AnonCreatedate
import typingsJapgolly.nodeHueApi.AnonErrorcode
