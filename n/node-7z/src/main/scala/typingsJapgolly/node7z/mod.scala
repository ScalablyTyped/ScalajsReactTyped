package typingsJapgolly.node7z

import typingsJapgolly.node.NodeJS.ReadableStream
import typingsJapgolly.node.bufferMod.global.BufferEncoding
import typingsJapgolly.node.childProcessMod.ChildProcess
import typingsJapgolly.node.streamMod.Stream
import typingsJapgolly.node7z.node7zStrings.data
import typingsJapgolly.node7z.node7zStrings.end
import typingsJapgolly.node7z.node7zStrings.error
import typingsJapgolly.node7z.node7zStrings.pause
import typingsJapgolly.node7z.node7zStrings.progress
import typingsJapgolly.node7z.node7zStrings.readable
import typingsJapgolly.node7z.node7zStrings.resume
