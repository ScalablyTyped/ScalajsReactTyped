...
object nameMod {
  ...
  object ComponentType extends StObject {
    ...
    sealed trait GENERIC
      extends StObject
         with ComponentType
    /* 8 */ val GENERIC: typingsJapgolly.ndnJs.nameMod.ComponentType.GENERIC & Double = js.native
    
    @js.native
    sealed trait IMPLICIT_SHA256_DIGEST
      extends StObject
         with ComponentType
    /* 1 */ val IMPLICIT_SHA256_DIGEST: typingsJapgolly.ndnJs.nameMod.ComponentType.IMPLICIT_SHA256_DIGEST & Double = js.native
    
    @js.native
    sealed trait OTHER_CODE
      extends StObject
         with ComponentType
    /* 0x7fff */ val OTHER_CODE: typingsJapgolly.ndnJs.nameMod.ComponentType.OTHER_CODE & Double = js.native
    
    @js.native
    sealed trait PARAMETERS_SHA256_DIGEST
      extends StObject
         with ComponentType
    /* 2 */ val PARAMETERS_SHA256_DIGEST: typingsJapgolly.ndnJs.nameMod.ComponentType.PARAMETERS_SHA256_DIGEST & Double = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ndnJs.ndnJsInts.`-1`
    - typingsJapgolly.ndnJs.ndnJsInts.`0`
    - typingsJapgolly.ndnJs.ndnJsInts.`1`
  */
  trait CompareResult extends StObject
  object CompareResult {
    
    inline def `-1`: typingsJapgolly.ndnJs.ndnJsInts.`-1` = -1.asInstanceOf[typingsJapgolly.ndnJs.ndnJsInts.`-1`]
    
    inline def `0`: typingsJapgolly.ndnJs.ndnJsInts.`0` = 0.asInstanceOf[typingsJapgolly.ndnJs.ndnJsInts.`0`]
