...
import typingsJapgolly.nextgenEvents.nextgenEventsNumbers.`0`
import typingsJapgolly.nextgenEvents.nextgenEventsNumbers.`1`
import typingsJapgolly.nextgenEvents.nextgenEventsNumbers.`2`
...
object ^ extends js.Object {
  ...
  def groupEmit(emitters: js.Array[NextGenEvents]): Unit = js.native
  ...
  def groupWaitForEmit(emitters: js.Array[NextGenEvents]): js.Promise[Unit] = js.native
