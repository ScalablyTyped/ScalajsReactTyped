package typingsJapgolly.notie

import japgolly.scalajs.react.Callback
import typingsJapgolly.notie.anon.Overlay
import typingsJapgolly.notie.anon.PartialRecordalertforceco
import typingsJapgolly.notie.anon.PartialRecordcontainertex
import typingsJapgolly.notie.notieStrings.a
import typingsJapgolly.notie.notieStrings.an
import typingsJapgolly.notie.notieStrings.n
import typingsJapgolly.notie.notieStrings.s
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.notie.notieInts.`1`
    - typingsJapgolly.notie.notieInts.`2`
    - typingsJapgolly.notie.notieInts.`3`
    - typingsJapgolly.notie.notieInts.`4`
    - typingsJapgolly.notie.notieInts.`5`
    - typingsJapgolly.notie.notieStrings.success
    - typingsJapgolly.notie.notieStrings.warning
    - typingsJapgolly.notie.notieStrings.error
    - typingsJapgolly.notie.notieStrings.info
    - typingsJapgolly.notie.notieStrings.neutral
  */
  trait AlertType extends StObject
  object AlertType {
    
    inline def `1`: typingsJapgolly.notie.notieInts.`1` = 1.asInstanceOf[typingsJapgolly.notie.notieInts.`1`]
    
    inline def `2`: typingsJapgolly.notie.notieInts.`2` = 2.asInstanceOf[typingsJapgolly.notie.notieInts.`2`]
    
    inline def `3`: typingsJapgolly.notie.notieInts.`3` = 3.asInstanceOf[typingsJapgolly.notie.notieInts.`3`]
    
    inline def `4`: typingsJapgolly.notie.notieInts.`4` = 4.asInstanceOf[typingsJapgolly.notie.notieInts.`4`]
    
    inline def `5`: typingsJapgolly.notie.notieInts.`5` = 5.asInstanceOf[typingsJapgolly.notie.notieInts.`5`]
    
    inline def error: typingsJapgolly.notie.notieStrings.error = "error".asInstanceOf[typingsJapgolly.notie.notieStrings.error]
    
    inline def info: typingsJapgolly.notie.notieStrings.info = "info".asInstanceOf[typingsJapgolly.notie.notieStrings.info]
    
    inline def neutral: typingsJapgolly.notie.notieStrings.neutral = "neutral".asInstanceOf[typingsJapgolly.notie.notieStrings.neutral]
    
    inline def success: typingsJapgolly.notie.notieStrings.success = "success".asInstanceOf[typingsJapgolly.notie.notieStrings.success]
    
    inline def warning: typingsJapgolly.notie.notieStrings.warning = "warning".asInstanceOf[typingsJapgolly.notie.notieStrings.warning]
  }
  ...
  object ConfirmOptions {
    ...
    extension [Self <: ConfirmOptions](x: Self) {
      ...
      inline def setCancelCallback(value: Callback): Self = StObject.set(x, "cancelCallback", value.toJsFn)
      ...
      inline def setSubmitCallback(value: Callback): Self = StObject.set(x, "submitCallback", value.toJsFn)
  ...
  object DateOptions {
    ...
    extension [Self <: DateOptions](x: Self) {
      ...
      inline def setCancelCallback(value: /* date */ js.Date => Callback): Self = StObject.set(x, "cancelCallback", js.Any.fromFunction1((t0: /* date */ js.Date) => value(t0).runNow()))
      ...
      inline def setSubmitCallback(value: /* date */ js.Date => Callback): Self = StObject.set(x, "submitCallback", js.Any.fromFunction1((t0: /* date */ js.Date) => value(t0).runNow()))
  ...
  object InputOptions {
    ...
    extension [Self <: InputOptions](x: Self) {
      ...
      inline def setCancelCallback(value: /* value */ String => Callback): Self = StObject.set(x, "cancelCallback", js.Any.fromFunction1((t0: /* value */ String) => value(t0).runNow()))
      ...
      inline def setSubmitCallback(value: /* value */ String => Callback): Self = StObject.set(x, "submitCallback", js.Any.fromFunction1((t0: /* value */ String) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.notie.notieStrings.top
    - typingsJapgolly.notie.notieStrings.bottom
  */
  trait Position extends StObject
  object Position {
    
    inline def bottom: typingsJapgolly.notie.notieStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.notie.notieStrings.bottom]
    
    inline def top: typingsJapgolly.notie.notieStrings.top = "top".asInstanceOf[typingsJapgolly.notie.notieStrings.top]
  }
  ...
  object SelectChoice {
    ...
    inline def apply(handler: Callback, text: String): SelectChoice = {
      val __obj = js.Dynamic.literal(handler = handler.toJsFn, text = text.asInstanceOf[js.Any])
