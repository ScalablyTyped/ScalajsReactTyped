...
import typingsJapgolly.nodeZendesk.mod.Attachments.Methods
...
trait Client extends StObject {
  ...
  var groups: typingsJapgolly.nodeZendesk.mod.Groups.Methods
  ...
  var jobstatuses: typingsJapgolly.nodeZendesk.mod.JobStatuses.Methods
  
  var locales: Any
  
  var macros: typingsJapgolly.nodeZendesk.mod.Macros.Methods
  ...
  var organizations: typingsJapgolly.nodeZendesk.mod.Organizations.Methods
  
  var policies: Any
  
  var requests: typingsJapgolly.nodeZendesk.mod.Requests.Methods
  ...
  var ticketfields: typingsJapgolly.nodeZendesk.mod.Tickets.Fields.Methods
  ...
  var tickets: typingsJapgolly.nodeZendesk.mod.Tickets.Methods
  ...
  var userfields: typingsJapgolly.nodeZendesk.mod.Users.Fields.Methods
  
  var useridentities: typingsJapgolly.nodeZendesk.mod.Users.Identities.Methods
  
  var users: typingsJapgolly.nodeZendesk.mod.Users.Methods
...
object Client {
  ...
  inline def apply(
    ...
    groups: typingsJapgolly.nodeZendesk.mod.Groups.Methods,
    helpers: Any,
    imports: Any,
    installations: Any,
    jobstatuses: typingsJapgolly.nodeZendesk.mod.JobStatuses.Methods,
    locales: Any,
    macros: typingsJapgolly.nodeZendesk.mod.Macros.Methods,
    oauthtokens: Any,
    organizationfields: Any,
    organizationmemberships: Any,
    organizations: typingsJapgolly.nodeZendesk.mod.Organizations.Methods,
    policies: Any,
    requests: typingsJapgolly.nodeZendesk.mod.Requests.Methods,
    ...
    ticketevents: Any,
    ticketexport: Any,
    ticketfields: typingsJapgolly.nodeZendesk.mod.Tickets.Fields.Methods,
    ticketforms: Any,
    ticketimport: Any,
    ticketmetrics: Any,
    tickets: typingsJapgolly.nodeZendesk.mod.Tickets.Methods,
    topiccomments: Any,
    topics: Any,
    topicsubscriptions: Any,
    topicvotes: Any,
    triggers: Any,
    userfields: typingsJapgolly.nodeZendesk.mod.Users.Fields.Methods,
    useridentities: typingsJapgolly.nodeZendesk.mod.Users.Identities.Methods,
    users: typingsJapgolly.nodeZendesk.mod.Users.Methods,
    views: Any
  ): Client = {
  ...
  extension [Self <: Client](x: Self) {
    ...
    inline def setGroups(value: typingsJapgolly.nodeZendesk.mod.Groups.Methods): Self = StObject.set(x, "groups", value.asInstanceOf[js.Any])
    ...
    inline def setJobstatuses(value: typingsJapgolly.nodeZendesk.mod.JobStatuses.Methods): Self = StObject.set(x, "jobstatuses", value.asInstanceOf[js.Any])
    
    inline def setLocales(value: Any): Self = StObject.set(x, "locales", value.asInstanceOf[js.Any])
    
    inline def setMacros(value: typingsJapgolly.nodeZendesk.mod.Macros.Methods): Self = StObject.set(x, "macros", value.asInstanceOf[js.Any])
    ...
    inline def setOrganizations(value: typingsJapgolly.nodeZendesk.mod.Organizations.Methods): Self = StObject.set(x, "organizations", value.asInstanceOf[js.Any])
    
    inline def setPolicies(value: Any): Self = StObject.set(x, "policies", value.asInstanceOf[js.Any])
    
    inline def setRequests(value: typingsJapgolly.nodeZendesk.mod.Requests.Methods): Self = StObject.set(x, "requests", value.asInstanceOf[js.Any])
    ...
    inline def setTicketfields(value: typingsJapgolly.nodeZendesk.mod.Tickets.Fields.Methods): Self = StObject.set(x, "ticketfields", value.asInstanceOf[js.Any])
    ...
    inline def setTickets(value: typingsJapgolly.nodeZendesk.mod.Tickets.Methods): Self = StObject.set(x, "tickets", value.asInstanceOf[js.Any])
    ...
    inline def setUserfields(value: typingsJapgolly.nodeZendesk.mod.Users.Fields.Methods): Self = StObject.set(x, "userfields", value.asInstanceOf[js.Any])
    
    inline def setUseridentities(value: typingsJapgolly.nodeZendesk.mod.Users.Identities.Methods): Self = StObject.set(x, "useridentities", value.asInstanceOf[js.Any])
    
    inline def setUsers(value: typingsJapgolly.nodeZendesk.mod.Users.Methods): Self = StObject.set(x, "users", value.asInstanceOf[js.Any])
