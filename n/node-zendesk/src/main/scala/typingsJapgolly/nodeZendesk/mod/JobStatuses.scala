...
object JobStatuses {
  ...
  */
  ...
  object Status {
    ...
    inline def completed: typingsJapgolly.nodeZendesk.nodeZendeskStrings.completed = "completed".asInstanceOf[typingsJapgolly.nodeZendesk.nodeZendeskStrings.completed]
    
    inline def failed: typingsJapgolly.nodeZendesk.nodeZendeskStrings.failed = "failed".asInstanceOf[typingsJapgolly.nodeZendesk.nodeZendeskStrings.failed]
    
    inline def killed: typingsJapgolly.nodeZendesk.nodeZendeskStrings.killed = "killed".asInstanceOf[typingsJapgolly.nodeZendesk.nodeZendeskStrings.killed]
    
    inline def queued: typingsJapgolly.nodeZendesk.nodeZendeskStrings.queued = "queued".asInstanceOf[typingsJapgolly.nodeZendesk.nodeZendeskStrings.queued]
    
    inline def working: typingsJapgolly.nodeZendesk.nodeZendeskStrings.working = "working".asInstanceOf[typingsJapgolly.nodeZendesk.nodeZendeskStrings.working]
  }
}
