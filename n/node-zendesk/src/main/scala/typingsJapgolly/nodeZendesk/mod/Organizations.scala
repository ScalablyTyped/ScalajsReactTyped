...
object Organizations {
  ...
  trait Methods extends StObject {
    ...
    def createMany(organizations: CreateManyPayload): js.Promise[typingsJapgolly.nodeZendesk.mod.JobStatuses.ResponsePayload] = js.native
    def createMany(organizations: CreateManyPayload, cb: ZendeskCallback[Any, Any]): typingsJapgolly.nodeZendesk.mod.JobStatuses.ResponsePayload = js.native
    ...
    def updateMany(organizations: UpdateManyPayload): js.Promise[typingsJapgolly.nodeZendesk.mod.JobStatuses.ResponsePayload] = js.native
    def updateMany(organizations: UpdateManyPayload, cb: ZendeskCallback[Any, Any]): typingsJapgolly.nodeZendesk.mod.JobStatuses.ResponsePayload = js.native
  }
