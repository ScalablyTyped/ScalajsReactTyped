...
object Metrics {
  ...
  trait ListPayload extends StObject {
    ...
    val ticket_metrics: js.Array[typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponseModel]
  }
  object ListPayload {
    
    inline def apply(ticket_metrics: js.Array[typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponseModel]): typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ListPayload = {
      val __obj = js.Dynamic.literal(ticket_metrics = ticket_metrics.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ListPayload]
    }
    
    extension [Self <: typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ListPayload](x: Self) {
      
      inline def setTicket_metrics(value: js.Array[typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponseModel]): Self = StObject.set(x, "ticket_metrics", value.asInstanceOf[js.Any])
      
      inline def setTicket_metricsVarargs(value: typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponseModel*): Self = StObject.set(x, "ticket_metrics", js.Array(value*))
    }
  }
  ...
  object ResponseModel {
    ...
    inline def apply(created_at: String, id: ZendeskID): typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponseModel = {
      val __obj = js.Dynamic.literal(created_at = created_at.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], updated_at = null)
      __obj.asInstanceOf[typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponseModel]
    }
    
    extension [Self <: typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponseModel](x: Self) {
  ...
  trait ResponsePayload extends StObject {
    ...
    val ticket_metric: typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponseModel
  }
  object ResponsePayload {
    
    inline def apply(ticket_metric: typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponseModel): typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponsePayload = {
      val __obj = js.Dynamic.literal(ticket_metric = ticket_metric.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponsePayload]
    }
    
    extension [Self <: typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponsePayload](x: Self) {
      
      inline def setTicket_metric(value: typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponseModel): Self = StObject.set(x, "ticket_metric", value.asInstanceOf[js.Any])
    }
  }
}
