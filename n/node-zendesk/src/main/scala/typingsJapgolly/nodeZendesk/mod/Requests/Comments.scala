...
object Comments {
  ...
  object CommentsUsers {
    ...
    object ResponseModel {
      ...
      inline def apply(agent: Boolean, id: ZendeskID, name: String): typingsJapgolly.nodeZendesk.mod.Requests.Comments.CommentsUsers.ResponseModel = {
        ...
        __obj.asInstanceOf[typingsJapgolly.nodeZendesk.mod.Requests.Comments.CommentsUsers.ResponseModel]
      }
      
      extension [Self <: typingsJapgolly.nodeZendesk.mod.Requests.Comments.CommentsUsers.ResponseModel](x: Self) {
  ...
  object CreateModel {
    ...
    inline def apply(): typingsJapgolly.nodeZendesk.mod.Requests.Comments.CreateModel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.nodeZendesk.mod.Requests.Comments.CreateModel]
    }
    
    extension [Self <: typingsJapgolly.nodeZendesk.mod.Requests.Comments.CreateModel](x: Self) {
  ...
  trait ListPayload
    ...
    var comments: js.Array[typingsJapgolly.nodeZendesk.mod.Requests.Comments.ResponseModel]
  ...
  object ListPayload {
    ...
    inline def apply(
      comments: js.Array[typingsJapgolly.nodeZendesk.mod.Requests.Comments.ResponseModel],
      count: Double,
    ...
    ): typingsJapgolly.nodeZendesk.mod.Requests.Comments.ListPayload = {
      ...
      __obj.asInstanceOf[typingsJapgolly.nodeZendesk.mod.Requests.Comments.ListPayload]
    }
    
    extension [Self <: typingsJapgolly.nodeZendesk.mod.Requests.Comments.ListPayload](x: Self) {
      
      inline def setComments(value: js.Array[typingsJapgolly.nodeZendesk.mod.Requests.Comments.ResponseModel]): Self = StObject.set(x, "comments", value.asInstanceOf[js.Any])
      
      inline def setCommentsVarargs(value: typingsJapgolly.nodeZendesk.mod.Requests.Comments.ResponseModel*): Self = StObject.set(x, "comments", js.Array(value*))
      
      inline def setOrganizations(value: js.Array[typingsJapgolly.nodeZendesk.mod.Tickets.Comments.Organizations.ResponseModel]): Self = StObject.set(x, "organizations", value.asInstanceOf[js.Any])
      
      inline def setOrganizationsVarargs(value: typingsJapgolly.nodeZendesk.mod.Tickets.Comments.Organizations.ResponseModel*): Self = StObject.set(x, "organizations", js.Array(value*))
      
      inline def setUsers(value: js.Array[typingsJapgolly.nodeZendesk.mod.Requests.Comments.CommentsUsers.ResponseModel]): Self = StObject.set(x, "users", value.asInstanceOf[js.Any])
      
      inline def setUsersVarargs(value: typingsJapgolly.nodeZendesk.mod.Requests.Comments.CommentsUsers.ResponseModel*): Self = StObject.set(x, "users", js.Array(value*))
    }
  }
  ...
  */
  ...
  object RequestType {
    ...
    inline def Comment: typingsJapgolly.nodeZendesk.nodeZendeskStrings.Comment = "Comment".asInstanceOf[typingsJapgolly.nodeZendesk.nodeZendeskStrings.Comment]
    
    inline def VoiceComment: typingsJapgolly.nodeZendesk.nodeZendeskStrings.VoiceComment = "VoiceComment".asInstanceOf[typingsJapgolly.nodeZendesk.nodeZendeskStrings.VoiceComment]
  }
  ...
  object ResponseModel {
    ...
    inline def apply(
      ...
      `type`: RequestType,
      url: String
    ): typingsJapgolly.nodeZendesk.mod.Requests.Comments.ResponseModel = {
      ...
      __obj.asInstanceOf[typingsJapgolly.nodeZendesk.mod.Requests.Comments.ResponseModel]
    }
    
    extension [Self <: typingsJapgolly.nodeZendesk.mod.Requests.Comments.ResponseModel](x: Self) {
  ...
  trait ResponsePayload extends StObject {
    ...
    val comment: typingsJapgolly.nodeZendesk.mod.Requests.Comments.ResponseModel
  }
  object ResponsePayload {
    
    inline def apply(comment: typingsJapgolly.nodeZendesk.mod.Requests.Comments.ResponseModel): typingsJapgolly.nodeZendesk.mod.Requests.Comments.ResponsePayload = {
      val __obj = js.Dynamic.literal(comment = comment.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.nodeZendesk.mod.Requests.Comments.ResponsePayload]
    }
    
    extension [Self <: typingsJapgolly.nodeZendesk.mod.Requests.Comments.ResponsePayload](x: Self) {
      
      inline def setComment(value: typingsJapgolly.nodeZendesk.mod.Requests.Comments.ResponseModel): Self = StObject.set(x, "comment", value.asInstanceOf[js.Any])
    }
  }
}
