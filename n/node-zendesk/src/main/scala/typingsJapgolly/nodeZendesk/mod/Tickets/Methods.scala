...
trait Methods extends StObject {
  ...
  def createMany(tickets: CreateManyPayload): js.Promise[typingsJapgolly.nodeZendesk.mod.JobStatuses.ResponsePayload] = js.native
  def createMany(tickets: CreateManyPayload, cb: ZendeskCallback[Any, Any]): typingsJapgolly.nodeZendesk.mod.JobStatuses.ResponsePayload = js.native
  ...
  def getComments(requestId: ZendeskID): js.Promise[typingsJapgolly.nodeZendesk.mod.Tickets.Comments.ListPayload] = js.native
  /** Listing Comments */
  def getComments(requestId: ZendeskID, cb: ZendeskCallback[Any, Any]): typingsJapgolly.nodeZendesk.mod.Tickets.Comments.ListPayload = js.native
  ...
  def listCollaborators(ticketId: ZendeskID): js.Promise[typingsJapgolly.nodeZendesk.mod.Users.ListPayload] = js.native
  def listCollaborators(ticketId: ZendeskID, cb: ZendeskCallback[Any, Any]): typingsJapgolly.nodeZendesk.mod.Users.ListPayload = js.native
  ...
  def listMetrics(ticketId: ZendeskID): js.Promise[typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponsePayload] = js.native
  def listMetrics(ticketId: ZendeskID, cb: ZendeskCallback[Any, Any]): typingsJapgolly.nodeZendesk.mod.Tickets.Metrics.ResponsePayload = js.native
  ...
  def merge(ticketId: ZendeskID, mergingTickets: MergePayload): js.Promise[typingsJapgolly.nodeZendesk.mod.JobStatuses.ResponsePayload] = js.native
  /** Merging Tickets */
  def merge(ticketId: ZendeskID, mergingTickets: MergePayload, cb: ZendeskCallback[Any, Any]): typingsJapgolly.nodeZendesk.mod.JobStatuses.ResponsePayload = js.native
  ...
  def updateMany(tickets: UpdateManyPayload): js.Promise[typingsJapgolly.nodeZendesk.mod.JobStatuses.ResponsePayload] = js.native
  def updateMany(tickets: UpdateManyPayload, cb: ZendeskCallback[Any, Any]): typingsJapgolly.nodeZendesk.mod.JobStatuses.ResponsePayload = js.native
}
