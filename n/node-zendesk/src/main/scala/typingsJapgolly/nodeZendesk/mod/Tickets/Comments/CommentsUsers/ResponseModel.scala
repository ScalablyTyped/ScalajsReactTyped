package typingsJapgolly.nodeZendesk.mod.Tickets.Comments.CommentsUsers
...
trait ResponseModel
  extends typingsJapgolly.nodeZendesk.mod.Requests.Comments.CommentsUsers.ResponseModel {
  val role: Role
}
