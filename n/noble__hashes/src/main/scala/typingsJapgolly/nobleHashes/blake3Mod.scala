...
import typingsJapgolly.nobleHashes.blake2Mod.BLAKE2
import typingsJapgolly.nobleHashes.utilsMod.Hash
import typingsJapgolly.nobleHashes.utilsMod.Input
...
object blake3Mod {
  ...
  - typingsJapgolly.nobleHashes.utilsMod.Hash because Already inherited
  - typingsJapgolly.nobleHashes.utilsMod.HashXOF because var conflicts: blockLen, outputLen. Inlined xof, xofInto */ @js.native
