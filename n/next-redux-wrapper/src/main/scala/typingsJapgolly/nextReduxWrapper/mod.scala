...
import typingsJapgolly.next.distPagesAppMod.AppContext
import typingsJapgolly.next.distSharedLibUtilsMod.AppInitialProps
...
import typingsJapgolly.nextReduxWrapper.anon.Call
import typingsJapgolly.nextReduxWrapper.anon.PageProps
...
object mod {
  ...
  inline def createWrapper[S /* <: Store[Any, AnyAction] */](makeStore: MakeStore[S]): typingsJapgolly.nextReduxWrapper.anon.GetInitialAppProps[S] = ^.asInstanceOf[js.Dynamic].applyDynamic("createWrapper")(makeStore.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.nextReduxWrapper.anon.GetInitialAppProps[S]]
  inline def createWrapper[S /* <: Store[Any, AnyAction] */](makeStore: MakeStore[S], config: Config[S]): typingsJapgolly.nextReduxWrapper.anon.GetInitialAppProps[S] = (^.asInstanceOf[js.Dynamic].applyDynamic("createWrapper")(makeStore.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.nextReduxWrapper.anon.GetInitialAppProps[S]]
