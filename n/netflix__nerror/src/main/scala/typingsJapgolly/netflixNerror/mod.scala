...
import typingsJapgolly.netflixNerror.anon.Instantiable
  ...
  object VError {
    ...
    object Options {
      ...
      extension [Self <: Options](x: Self) {
        ...
        inline def setConstructorOpt(value: /* repeated */ Any => Callback): Self = StObject.set(x, "constructorOpt", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
