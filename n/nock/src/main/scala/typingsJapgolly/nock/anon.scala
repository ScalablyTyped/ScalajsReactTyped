...
object anon {
  ...
  object Context {
    ...
    inline def apply(context: BackContext, nockDone: Callback): Context = {
      val __obj = js.Dynamic.literal(context = context.asInstanceOf[js.Any], nockDone = nockDone.toJsFn)
    ...
    extension [Self <: Context](x: Self) {
      ...
      inline def setNockDone(value: Callback): Self = StObject.set(x, "nockDone", value.toJsFn)
    }
  }
