...
import typingsJapgolly.nodeRedRuntime.anon.Authenticate
import typingsJapgolly.nodeRedRuntime.anon.Console
import typingsJapgolly.nodeRedRuntime.anon.Default
import typingsJapgolly.nodeRedRuntime.anon.DeployButton
import typingsJapgolly.nodeRedRuntime.anon.Module
import typingsJapgolly.nodeRedRuntime.anon.Origin
import typingsJapgolly.nodeRedRuntime.anon.Pass
import typingsJapgolly.nodeRedRuntime.anon.Path
import typingsJapgolly.nodeRedRuntime.anon.Strategy
import typingsJapgolly.nodeRedRuntime.nodeRedRuntimeBooleans.`false`
...
object LocalSettings {
  ...
  extension [Self <: LocalSettings](x: Self) {
    ...
    ): Self = StObject.set(x, "httpNodeMiddleware", js.Any.fromFunction3((t0: /* req */ Request_[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.ParamsDictionary */ Any, 
          Any, 
          Any, 
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
    ...
    ): Self = StObject.set(x, "webSocketNodeVerifyClient", js.Any.fromFunction2((t0: /* info */ Origin, t1: /* callback */ js.Function3[
          /* result */ Boolean, 
          /* code */ js.UndefOr[String], 
          /* reason */ js.UndefOr[String], 
          Unit
