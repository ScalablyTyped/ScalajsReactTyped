...
trait Icon extends StObject {
  ...
  var strategy: typingsJapgolly.passport.mod.Strategy
}
object Icon {
  ...
  inline def apply(
    ...
    name: String,
    options: js.Object,
    strategy: typingsJapgolly.passport.mod.Strategy
  ): Icon = {
  ...
  extension [Self <: Icon](x: Self) {
    ...
    inline def setStrategy(value: typingsJapgolly.passport.mod.Strategy): Self = StObject.set(x, "strategy", value.asInstanceOf[js.Any])
  }
}
