...
import typingsJapgolly.nodeRedNodeTestHelper.nodeRedNodeTestHelperBooleans.`false`
...
object anon {
  ...
  trait NodeTestHelper extends StObject {
    ...
    var NodeTestHelper: Instantiable0[typingsJapgolly.nodeRedNodeTestHelper.mod.NodeTestHelper]
  }
  object NodeTestHelper {
    
    inline def apply(NodeTestHelper: Instantiable0[typingsJapgolly.nodeRedNodeTestHelper.mod.NodeTestHelper]): NodeTestHelper = {
    ...
    extension [Self <: NodeTestHelper](x: Self) {
      ...
      inline def setNodeTestHelper(value: Instantiable0[typingsJapgolly.nodeRedNodeTestHelper.mod.NodeTestHelper]): Self = StObject.set(x, "NodeTestHelper", value.asInstanceOf[js.Any])
    }
  }
