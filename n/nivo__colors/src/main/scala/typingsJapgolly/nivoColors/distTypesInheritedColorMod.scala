...
import typingsJapgolly.nivoColors.nivoColorsStrings.brighter
import typingsJapgolly.nivoColors.nivoColorsStrings.darker
import typingsJapgolly.nivoColors.nivoColorsStrings.opacity
...
object distTypesInheritedColorMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nivoColors.distTypesInheritedColorMod.InheritedColorConfigStaticColor
    - typingsJapgolly.nivoColors.distTypesInheritedColorMod.InheritedColorConfigCustomFunction[Datum]
    - typingsJapgolly.nivoColors.distTypesInheritedColorMod.InheritedColorConfigFromTheme
    - typingsJapgolly.nivoColors.distTypesInheritedColorMod.InheritedColorConfigFromContext
  */
