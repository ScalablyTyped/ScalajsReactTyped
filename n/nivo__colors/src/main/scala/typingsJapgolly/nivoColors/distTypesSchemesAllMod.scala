...
object distTypesSchemesAllMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nivoColors.distTypesSchemesCategoricalMod.CategoricalColorSchemeId
    - typingsJapgolly.nivoColors.distTypesSchemesDivergingMod.DivergingColorSchemeId
    - typingsJapgolly.nivoColors.distTypesSchemesSequentialMod.SequentialColorSchemeId
  */
