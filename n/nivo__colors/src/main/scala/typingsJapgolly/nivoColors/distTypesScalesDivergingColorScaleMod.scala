...
import typingsJapgolly.nivoColors.nivoColorsStrings.diverging
...
object distTypesScalesDivergingColorScaleMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nivoColors.distTypesScalesDivergingColorScaleMod.DivergingColorScaleSchemeConfig
    - typingsJapgolly.nivoColors.distTypesScalesDivergingColorScaleMod.DivergingColorScaleColorsConfig
    - typingsJapgolly.nivoColors.distTypesScalesDivergingColorScaleMod.DivergingColorScaleInterpolatorConfig
  */
