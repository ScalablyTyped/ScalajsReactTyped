...
object distTypesSchemesInterpolatorsMod {
  
  @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolatorIds")
  @js.native
  val colorInterpolatorIds: js.Array[ColorInterpolatorId] = js.native
  
  object colorInterpolators {
    
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.blue_green")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.blue_purple")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.blues")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.brown_blueGreen")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.cividis")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.cool")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.cubehelixDefault")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.green_blue")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.greens")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.greys")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.inferno")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.magma")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.orange_red")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.oranges")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.pink_yellowGreen")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.plasma")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.purple_blue")
    @js.native
    def purpleBlue: js.Function1[/* t */ Double, String] = js.native
    
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.purple_blue_green")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.purple_orange")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.purple_red")
    @js.native
    def purpleRed: js.Function1[/* t */ Double, String] = js.native
    
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.purpleRed_green")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.purples")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.rainbow")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.red_blue")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.red_grey")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.red_purple")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.red_yellow_blue")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.red_yellow_green")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.reds")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.sinebow")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.spectral")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.turbo")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.viridis")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.warm")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.yellow_green")
    @js.native
    def yellowGreen: js.Function1[/* t */ Double, String] = js.native
    
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.yellow_green_blue")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.yellow_orange_brown")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/interpolators", "colorInterpolators.yellow_orange_red")
    @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nivoColors.distTypesSchemesDivergingMod.DivergingColorInterpolatorId
    - typingsJapgolly.nivoColors.distTypesSchemesSequentialMod.SequentialColorInterpolatorId
    - typingsJapgolly.nivoColors.distTypesSchemesCyclicalMod.CyclicalColorInterpolatorId
  */
  trait ColorInterpolatorId extends StObject
}
