...
import typingsJapgolly.nivoColors.nivoColorsStrings.quantize
...
object distTypesScalesQuantizeColorScaleMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.nivoColors.distTypesScalesQuantizeColorScaleMod.QuantizeColorScaleSchemeConfig
    - typingsJapgolly.nivoColors.distTypesScalesQuantizeColorScaleMod.QuantizeColorScaleColorsConfig
  */
