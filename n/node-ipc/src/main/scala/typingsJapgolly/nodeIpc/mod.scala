...
import typingsJapgolly.nodeIpc.anon.Family
import typingsJapgolly.nodeIpc.anon.Private
import typingsJapgolly.nodeIpc.mod.NodeIPC.Client
...
object mod {
  ...
  open class IPC ()
    extends StObject
       with typingsJapgolly.nodeIpc.mod.NodeIPC.IPC
  @JSImport("node-ipc", "IPC")
  @js.native
  def IPC: Instantiable0[typingsJapgolly.nodeIpc.mod.NodeIPC.IPC] = js.native
  inline def IPC_=(x: Instantiable0[typingsJapgolly.nodeIpc.mod.NodeIPC.IPC]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("IPC")(x.asInstanceOf[js.Any])
  ...
  object NodeIPC {
    ...
    object Config {
      ...
      extension [Self <: Config](x: Self) {
        ...
        inline def setLogger(value: String => Callback): Self = StObject.set(x, "logger", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
