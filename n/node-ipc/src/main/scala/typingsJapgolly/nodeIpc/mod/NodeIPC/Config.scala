...
import typingsJapgolly.nodeIpc.AnonFamily
import typingsJapgolly.nodeIpc.AnonPrivate
import typingsJapgolly.nodeIpc.nodeIpcStrings.ascii
import typingsJapgolly.nodeIpc.nodeIpcStrings.base64
import typingsJapgolly.nodeIpc.nodeIpcStrings.hex
import typingsJapgolly.nodeIpc.nodeIpcStrings.ucs2
import typingsJapgolly.nodeIpc.nodeIpcStrings.utf16le
import typingsJapgolly.nodeIpc.nodeIpcStrings.utf8
...
object Config {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(appspace = appspace.asInstanceOf[js.Any], encoding = encoding.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], interfaces = interfaces.asInstanceOf[js.Any], logDepth = logDepth.asInstanceOf[js.Any], logInColor = logInColor.asInstanceOf[js.Any], maxConnections = maxConnections.asInstanceOf[js.Any], maxRetries = maxRetries.asInstanceOf[js.Any], networkHost = networkHost.asInstanceOf[js.Any], networkPort = networkPort.asInstanceOf[js.Any], rawBuffer = rawBuffer.asInstanceOf[js.Any], retry = retry.asInstanceOf[js.Any], silent = silent.asInstanceOf[js.Any], socketRoot = socketRoot.asInstanceOf[js.Any], stopRetrying = stopRetrying.asInstanceOf[js.Any], sync = sync.asInstanceOf[js.Any], tls = tls.asInstanceOf[js.Any], unlink = unlink.asInstanceOf[js.Any])
    __obj.updateDynamic("logger")(js.Any.fromFunction1((t0: java.lang.String) => logger(t0).runNow()))
