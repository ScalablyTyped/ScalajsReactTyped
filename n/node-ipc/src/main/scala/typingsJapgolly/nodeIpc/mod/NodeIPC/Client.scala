...
import typingsJapgolly.nodeIpc.nodeIpcStrings.connect
import typingsJapgolly.nodeIpc.nodeIpcStrings.data
import typingsJapgolly.nodeIpc.nodeIpcStrings.destroy
import typingsJapgolly.nodeIpc.nodeIpcStrings.disconnect
import typingsJapgolly.nodeIpc.nodeIpcStrings.error
import typingsJapgolly.nodeIpc.nodeIpcStrings.socketDotdisconnected
