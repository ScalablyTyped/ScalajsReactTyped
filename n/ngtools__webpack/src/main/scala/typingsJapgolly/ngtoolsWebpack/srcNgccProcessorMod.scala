...
import typingsJapgolly.ngtoolsWebpack.anon.FnCall
import typingsJapgolly.ngtoolsWebpack.anon.TypeofimportedNgcc
import typingsJapgolly.ngtoolsWebpack.srcIvySystemMod.InputFileSystem
