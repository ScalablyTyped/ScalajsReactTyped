...
import typingsJapgolly.numeral.mod.NumeralJSFormat
import typingsJapgolly.numeral.mod.NumeralJSFormats
import typingsJapgolly.numeral.mod.NumeralJSLocale
import typingsJapgolly.numeral.mod.NumeralJSLocales
import typingsJapgolly.numeral.mod.NumeralJSOptions
import typingsJapgolly.numeral.mod.NumeralJSUtils
import typingsJapgolly.numeral.mod.RegisterType
import typingsJapgolly.numeral.mod.VERSION_
...
object global {
  ...
  object numeral {
    ...
    /**
      ...
      */
    inline def apply(): typingsJapgolly.numeral.mod.Numeral = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.numeral.mod.Numeral]
    inline def apply(input: Any): typingsJapgolly.numeral.mod.Numeral = ^.asInstanceOf[js.Dynamic].apply(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.numeral.mod.Numeral]
    ...
    open class Numeral protected ()
      extends typingsJapgolly.numeral.mod.Numeral {
