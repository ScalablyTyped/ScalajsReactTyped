...
import typingsJapgolly.numeral.anon.Billion
import typingsJapgolly.numeral.anon.Decimal
import typingsJapgolly.numeral.anon.Format
import typingsJapgolly.numeral.anon.Symbol
import typingsJapgolly.numeral.numeralStrings.`2Dot0Dot6`
...
object mod {
  ...
  */
  ...
  object RegisterType {
    ...
    inline def format: typingsJapgolly.numeral.numeralStrings.format = "format".asInstanceOf[typingsJapgolly.numeral.numeralStrings.format]
    
    inline def locale: typingsJapgolly.numeral.numeralStrings.locale = "locale".asInstanceOf[typingsJapgolly.numeral.numeralStrings.locale]
  }
