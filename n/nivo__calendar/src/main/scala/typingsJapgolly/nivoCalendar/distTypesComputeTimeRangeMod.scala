...
object distTypesComputeTimeRangeMod {
  ...
  trait ComputeCellPositions_
    ...
    var data: js.Array[typingsJapgolly.nivoCalendar.anon.Day]
  ...
  object ComputeCellPositions_ {
    ...
    inline def apply(
      ...
      data: js.Array[typingsJapgolly.nivoCalendar.anon.Day],
      daySpacing: Double,
    ...
    extension [Self <: ComputeCellPositions_](x: Self) {
      ...
      inline def setData(value: js.Array[typingsJapgolly.nivoCalendar.anon.Day]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
      
      inline def setDataVarargs(value: typingsJapgolly.nivoCalendar.anon.Day*): Self = StObject.set(x, "data", js.Array(value*))
  ...
  object ComputeTotalDays_ {
    ...
    inline def apply(data: js.Array[typingsJapgolly.nivoCalendar.anon.Day]): ComputeTotalDays_ = {
