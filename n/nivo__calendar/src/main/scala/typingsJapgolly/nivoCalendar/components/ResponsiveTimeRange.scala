...
object ResponsiveTimeRange {
  
  inline def apply(data: js.Array[CalendarDatum]): Builder = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitTimeRangeSvgPropsheig]))
  }
  
  @JSImport("@nivo/calendar", "ResponsiveTimeRange")
  @js.native
  ...
  def withProps(p: OmitTimeRangeSvgPropsheig): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
