...
object Calendar {
  def apply(
    ...
    CalendarSvgProps with Dimensions, 
    typingsJapgolly.nivoCalendar.mod.Calendar, 
    Unit, 
    CalendarSvgProps with Dimensions
  ] = {
  ...
  typingsJapgolly.nivoCalendar.mod.CalendarSvgProps with typingsJapgolly.nivoCore.mod.Dimensions, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.nivoCalendar.mod.Calendar](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.nivoCalendar.mod.CalendarSvgProps with typingsJapgolly.nivoCore.mod.Dimensions])(children: _*)
  }
