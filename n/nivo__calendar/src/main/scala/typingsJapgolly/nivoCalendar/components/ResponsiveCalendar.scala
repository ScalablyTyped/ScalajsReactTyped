...
object ResponsiveCalendar {
  ...
  inline def apply(data: js.Array[CalendarDatum], from: DateOrString, to: DateOrString): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitCalendarSvgPropsheigh]))
  }
  ...
  def withProps(p: OmitCalendarSvgPropsheigh): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
