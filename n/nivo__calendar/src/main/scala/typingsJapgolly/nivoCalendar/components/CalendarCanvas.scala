...
object CalendarCanvas {
  ...
  inline def apply(data: js.Array[CalendarDatum], from: DateOrString, height: Double, to: DateOrString, width: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[CalendarCanvasProps]))
  }
  ...
  def withProps(p: CalendarCanvasProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
