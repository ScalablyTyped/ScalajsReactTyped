...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.nivoCalendar.anon.OmitCalendarDatumvaluecoo
  - typingsJapgolly.nivoCalendar.anon.CalendarDatumcoordinatesx
*/
trait TimeRangeDayData extends StObject
object TimeRangeDayData {
  
  inline def CalendarDatumcoordinatesx(
    color: String,
    coordinates: Y,
    date: js.Date,
    day: String,
    ...
    __obj.asInstanceOf[typingsJapgolly.nivoCalendar.anon.CalendarDatumcoordinatesx]
  }
  
  inline def OmitCalendarDatumvaluecoo(
    color: String,
    coordinates: Y,
    date: js.Date,
    day: String,
    ...
    __obj.asInstanceOf[typingsJapgolly.nivoCalendar.anon.OmitCalendarDatumvaluecoo]
  }
}
