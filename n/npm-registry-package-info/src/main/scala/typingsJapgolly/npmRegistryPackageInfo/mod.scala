...
import typingsJapgolly.npmRegistryPackageInfo.anon.Failure
import typingsJapgolly.npmRegistryPackageInfo.npmRegistryPackageInfoStrings.http
import typingsJapgolly.npmRegistryPackageInfo.npmRegistryPackageInfoStrings.https
