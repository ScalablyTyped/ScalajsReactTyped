...
import typingsJapgolly.yar.yarBooleans.`false`
import typingsJapgolly.yar.yarStrings.Lax
import typingsJapgolly.yar.yarStrings.Strict
...
object AnonClearInvalid {
  ...
  def apply(
    ...
    customSessionIDGenerator: /* req */ Request => CallbackTo[String] = null,
    ...
    if (customSessionIDGenerator != null) __obj.updateDynamic("customSessionIDGenerator")(js.Any.fromFunction1((t0: /* req */ typingsJapgolly.hapi.mod.Request) => customSessionIDGenerator(t0).runNow()))
