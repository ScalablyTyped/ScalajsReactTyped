...
import typingsJapgolly.yargsParser.anon.PartialConfiguration
...
object mod extends Shortcut {
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      */
    var array: js.UndefOr[js.Array[typingsJapgolly.yargsParser.anon.Boolean | String]] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setArray(value: js.Array[typingsJapgolly.yargsParser.anon.Boolean | String]): Self = StObject.set(x, "array", value.asInstanceOf[js.Any])
      
      inline def setArrayUndefined: Self = StObject.set(x, "array", js.undefined)
      
      inline def setArrayVarargs(value: (typingsJapgolly.yargsParser.anon.Boolean | String)*): Self = StObject.set(x, "array", js.Array(value*))
