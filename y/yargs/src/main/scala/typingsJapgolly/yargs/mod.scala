...
import typingsJapgolly.yargs.anon.DictargName
import typingsJapgolly.yargs.anon.PartialParserConfiguratio
import typingsJapgolly.yargs.yargsBooleans.`false`
import typingsJapgolly.yargs.yargsBooleans.`true`
import typingsJapgolly.yargs.yargsStrings.array
import typingsJapgolly.yargs.yargsStrings.count
import typingsJapgolly.yargs.yargsStrings.error
import typingsJapgolly.yargs.yargsStrings.log
import typingsJapgolly.yargsParser.mod.Configuration
import typingsJapgolly.yargsParser.mod.DetailedArguments
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.yargs.yargsStrings.boolean
    - typingsJapgolly.yargs.yargsStrings.number
    - typingsJapgolly.yargs.yargsStrings.string
  */
  trait PositionalOptionsType extends StObject
  object PositionalOptionsType {
    
    inline def boolean: typingsJapgolly.yargs.yargsStrings.boolean = "boolean".asInstanceOf[typingsJapgolly.yargs.yargsStrings.boolean]
    
    inline def number: typingsJapgolly.yargs.yargsStrings.number = "number".asInstanceOf[typingsJapgolly.yargs.yargsStrings.number]
    
    inline def string: typingsJapgolly.yargs.yargsStrings.string = "string".asInstanceOf[typingsJapgolly.yargs.yargsStrings.string]
  }
