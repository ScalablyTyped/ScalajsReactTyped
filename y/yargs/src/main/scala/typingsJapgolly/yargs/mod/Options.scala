...
object Options {
  ...
  def apply(
    ...
    coerce: /* arg */ js.Any => CallbackTo[js.Any] = null,
    config: js.UndefOr[Boolean] = js.undefined,
    configParser: /* configPath */ String => CallbackTo[js.Object] = null,
    ...
    if (coerce != null) __obj.updateDynamic("coerce")(js.Any.fromFunction1((t0: /* arg */ js.Any) => coerce(t0).runNow()))
    if (!js.isUndefined(config)) __obj.updateDynamic("config")(config.asInstanceOf[js.Any])
    if (configParser != null) __obj.updateDynamic("configParser")(js.Any.fromFunction1((t0: /* configPath */ java.lang.String) => configParser(t0).runNow()))
