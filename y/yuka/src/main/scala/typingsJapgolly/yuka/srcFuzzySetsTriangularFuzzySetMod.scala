...
object srcFuzzySetsTriangularFuzzySetMod {
  
  @JSImport("yuka/src/fuzzy/sets/TriangularFuzzySet", "TriangularFuzzySet")
  @js.native
  /**
    ...
    */
  open class TriangularFuzzySet () extends FuzzySet {
