...
import typingsJapgolly.yuka.yukaStrings.active
import typingsJapgolly.yuka.yukaStrings.completed
import typingsJapgolly.yuka.yukaStrings.failed
import typingsJapgolly.yuka.yukaStrings.inactive
