...
@JSImport("yuka/src/Yuka", "ArriveBehavior")
@js.native
/**
...
open class ArriveBehavior ()
  extends typingsJapgolly.yuka.srcSteeringBehaviorsArriveBehaviorMod.ArriveBehavior {
  def this(target: typingsJapgolly.yuka.srcMathVector3Mod.Vector3) = this()
  def this(target: Unit, deceleration: Double) = this()
  def this(target: typingsJapgolly.yuka.srcMathVector3Mod.Vector3, deceleration: Double) = this()
  ...
  def this(target: typingsJapgolly.yuka.srcMathVector3Mod.Vector3, deceleration: Double, tolerance: Double) = this()
  def this(target: typingsJapgolly.yuka.srcMathVector3Mod.Vector3, deceleration: Unit, tolerance: Double) = this()
}
