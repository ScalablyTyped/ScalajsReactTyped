...
@JSImport("yuka/src/Yuka", "FuzzyOR")
@js.native
open class FuzzyOR protected ()
  extends typingsJapgolly.yuka.srcFuzzyOperatorsFuzzyORMod.FuzzyOR {
  /**
    * Constructs a new fuzzy AND operator with the given values.
    * The constructor accepts and arbitrary amount of fuzzy terms.
    */
  def this(terms: typingsJapgolly.yuka.srcFuzzyFuzzyTermMod.FuzzyTerm*) = this()
}
