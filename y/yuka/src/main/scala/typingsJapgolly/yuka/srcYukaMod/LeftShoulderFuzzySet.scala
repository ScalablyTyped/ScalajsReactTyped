...
@JSImport("yuka/src/Yuka", "LeftShoulderFuzzySet")
@js.native
/**
  ...
  */
open class LeftShoulderFuzzySet ()
  extends typingsJapgolly.yuka.srcFuzzySetsLeftShoulderFuzzySetMod.LeftShoulderFuzzySet {
