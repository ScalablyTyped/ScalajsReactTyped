...
import typingsJapgolly.yaireoTagify.anon.PartialInvalidTagsMessage
...
object TagifyCoreSettings {
  ...
  extension [Self <: TagifyCoreSettings[?], T /* <: BaseTagData */](x: Self & TagifyCoreSettings[T]) {
    ...
    inline def setTransformTag(value: T => Callback): Self = StObject.set(x, "transformTag", js.Any.fromFunction1((t0: T) => value(t0).runNow()))
