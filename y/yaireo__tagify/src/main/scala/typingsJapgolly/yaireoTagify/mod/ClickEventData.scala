...
- typingsJapgolly.yaireoTagify.mod.EventData because Already inherited
- typingsJapgolly.yaireoTagify.mod.TagEventData because var conflicts: tagify. Inlined data, index, tag */ trait ClickEventData[T /* <: BaseTagData */]
  extends StObject
