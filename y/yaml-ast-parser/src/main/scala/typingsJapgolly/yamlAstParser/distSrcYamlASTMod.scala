...
object distSrcYamlASTMod {
  ...
  object YAMLAnchorReference {
    ...
    inline def apply(
      endPosition: Double,
      errors: js.Array[typingsJapgolly.yamlAstParser.distSrcExceptionMod.^],
      kind: Kind,
      parent: YAMLNode,
  ...
  trait YAMLDocument extends StObject {
    ...
    var errors: js.Array[typingsJapgolly.yamlAstParser.distSrcExceptionMod.^]
  ...
  object YAMLDocument {
    ...
    extension [Self <: YAMLDocument](x: Self) {
      ...
      inline def setErrors(value: js.Array[typingsJapgolly.yamlAstParser.distSrcExceptionMod.^]): Self = StObject.set(x, "errors", value.asInstanceOf[js.Any])
      
      inline def setErrorsVarargs(value: typingsJapgolly.yamlAstParser.distSrcExceptionMod.^ *): Self = StObject.set(x, "errors", js.Array(value*))
