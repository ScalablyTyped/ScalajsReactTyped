...
import typingsJapgolly.yaml.yamlStrings.any
import typingsJapgolly.yaml.yamlStrings.block
import typingsJapgolly.yaml.yamlStrings.flow
import typingsJapgolly.yaml.yamlStrings.folded
import typingsJapgolly.yaml.yamlStrings.literal
...
trait ReadonlyToStringOptions extends StObject {
  ...
  val defaultKeyType: js.UndefOr[typingsJapgolly.yaml.distNodesScalarMod.Scalar.Type | Null] = js.undefined
  
  val defaultStringType: js.UndefOr[typingsJapgolly.yaml.distNodesScalarMod.Scalar.Type] = js.undefined
...
object ReadonlyToStringOptions {
  ...
  extension [Self <: ReadonlyToStringOptions](x: Self) {
    ...
    inline def setDefaultKeyType(value: typingsJapgolly.yaml.distNodesScalarMod.Scalar.Type): Self = StObject.set(x, "defaultKeyType", value.asInstanceOf[js.Any])
    ...
    inline def setDefaultStringType(value: typingsJapgolly.yaml.distNodesScalarMod.Scalar.Type): Self = StObject.set(x, "defaultStringType", value.asInstanceOf[js.Any])
