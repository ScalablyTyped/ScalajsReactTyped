...
trait ReadonlyCollection extends StObject {
  ...
  def clone(schema: Schema): typingsJapgolly.yaml.distNodesCollectionMod.Collection = js.native
  ...
  val range: js.UndefOr[typingsJapgolly.yaml.distNodesNodeMod.Range | Null] = js.native
