...
trait ReadonlyRequiredOmitToStr extends StObject {
  ...
  val defaultKeyType: typingsJapgolly.yaml.distNodesScalarMod.Scalar.Type
  
  val defaultStringType: typingsJapgolly.yaml.distNodesScalarMod.Scalar.Type
...
object ReadonlyRequiredOmitToStr {
  ...
  inline def apply(
    ...
    defaultKeyType: typingsJapgolly.yaml.distNodesScalarMod.Scalar.Type,
    defaultStringType: typingsJapgolly.yaml.distNodesScalarMod.Scalar.Type,
    directives: Boolean,
