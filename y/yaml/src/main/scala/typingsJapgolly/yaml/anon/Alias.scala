...
import typingsJapgolly.yaml.distVisitMod.asyncVisitorFn
...
trait Alias extends StObject {
  ...
  var Alias: js.UndefOr[asyncVisitorFn[typingsJapgolly.yaml.distNodesAliasMod.Alias]] = js.undefined
  ...
  var Pair: js.UndefOr[asyncVisitorFn[typingsJapgolly.yaml.distNodesPairMod.Pair[Any, Any]]] = js.undefined
  
  var Scalar: js.UndefOr[asyncVisitorFn[typingsJapgolly.yaml.distNodesScalarMod.Scalar[Any]]] = js.undefined
  ...
  extension [Self <: Alias](x: Self) {
    ...
    inline def setAlias(
      value: (/* key */ Double | key | value | Null, typingsJapgolly.yaml.distNodesAliasMod.Alias, /* path */ js.Array[
        ...
        ]) => Unit | js.Symbol | Double | typingsJapgolly.yaml.distNodesNodeMod.Node[Any] | (Pair[Any, Any]) | (js.Promise[
