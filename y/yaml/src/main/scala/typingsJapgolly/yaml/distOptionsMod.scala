...
import typingsJapgolly.yaml.distSchemaTagsMod.TagId
import typingsJapgolly.yaml.distSchemaTagsMod.Tags
...
object distOptionsMod {
  ...
  object CreateNodeOptions {
    ...
    extension [Self <: CreateNodeOptions](x: Self) {
      ...
      inline def setOnTagObj(value: /* tagObj */ ScalarTag | CollectionTag => Callback): Self = StObject.set(x, "onTagObj", js.Any.fromFunction1((t0: /* tagObj */ ScalarTag | CollectionTag) => value(t0).runNow()))
  ...
  object ToJSOptions {
    ...
    extension [Self <: ToJSOptions](x: Self) {
      ...
      inline def setOnAnchor(value: (/* value */ Any, /* count */ Double) => Callback): Self = StObject.set(x, "onAnchor", js.Any.fromFunction2((t0: /* value */ Any, t1: /* count */ Double) => (value(t0, t1)).runNow()))
