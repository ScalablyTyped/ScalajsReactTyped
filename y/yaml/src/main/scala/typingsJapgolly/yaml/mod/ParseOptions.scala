...
import typingsJapgolly.yaml.yamlStrings.`yaml-1Dot1`
import typingsJapgolly.yaml.yamlStrings.core
import typingsJapgolly.yaml.yamlStrings.failsafe
import typingsJapgolly.yaml.yamlStrings.json
