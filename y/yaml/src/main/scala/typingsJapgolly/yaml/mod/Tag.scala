...
trait Tag extends js.Object {
  ...
  /**
    ...
    */
  def resolve(doc: typingsJapgolly.yaml.mod.ast.Document, cstNode: Node): typingsJapgolly.yaml.mod.ast.Node = js.native
  def resolve(`match`: String*): typingsJapgolly.yaml.mod.ast.Node = js.native
  /**
    ...
    */
  def stringify(item: typingsJapgolly.yaml.mod.ast.Node, ctx: StringifyContext, onComment: js.Function0[Unit]): String = js.native
}
