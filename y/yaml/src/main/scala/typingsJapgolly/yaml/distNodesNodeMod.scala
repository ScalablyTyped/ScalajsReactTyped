...
object distNodesNodeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.yaml.distNodesAliasMod.Alias
    - typingsJapgolly.yaml.distNodesScalarMod.Scalar[T]
    - typingsJapgolly.yaml.distNodesYamlmapMod.YAMLMap[scala.Any, T]
    - typingsJapgolly.yaml.distNodesYamlseqMod.YAMLSeq[T]
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.yaml.distNodesAliasMod.Alias.Parsed
    - typingsJapgolly.yaml.distNodesScalarMod.Scalar.Parsed
    - typingsJapgolly.yaml.distNodesYamlmapMod.YAMLMap.Parsed[scala.Any, scala.Any | scala.Null]
    - typingsJapgolly.yaml.distNodesYamlseqMod.YAMLSeq.Parsed[scala.Any]
  */
  type ParsedNode = _ParsedNode | (Parsed[Any, Any | Null]) | typingsJapgolly.yaml.distNodesYamlseqMod.YAMLSeq.Parsed[Any]
