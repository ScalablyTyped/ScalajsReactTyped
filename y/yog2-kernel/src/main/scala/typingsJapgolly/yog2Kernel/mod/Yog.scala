...
import typingsJapgolly.yog2Kernel.AnonCleanCache
import typingsJapgolly.yog2Kernel.TypeofRAL
import typingsJapgolly.yog2Kernel.TypeofRALPromise
import typingsJapgolly.yog2Kernel.Typeofexpress
...
trait Yog extends js.Object {
  ...
  @JSName("express")
  var express_Original: js.Function0[typingsJapgolly.expressServeStaticCore.mod.Express] with Typeofexpress = js.native
  ...
  def app(
    ...
    res: typingsJapgolly.expressServeStaticCore.mod.Response[_]
  ): js.Any = js.native
  def app(
    req: typingsJapgolly.expressServeStaticCore.mod.Request[ParamsDictionary, _, _],
    res: ServerResponse
  ): js.Any = js.native
  def app(req: IncomingMessage, res: typingsJapgolly.expressServeStaticCore.mod.Response[_]): js.Any = js.native
