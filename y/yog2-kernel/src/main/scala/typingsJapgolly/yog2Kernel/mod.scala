...
import typingsJapgolly.yog2Kernel.anon.CleanCache
import typingsJapgolly.yog2Kernel.anon.TypeofRAL
import typingsJapgolly.yog2Kernel.anon.TypeofRALPromise
import typingsJapgolly.yogBigpipe.mod.BigPipe
import typingsJapgolly.yogLog.mod.Logger
...
object mod extends Shortcut {
  ...
  object ActionObject {
    ...
    extension [Self <: ActionObject](x: Self) {
      ...
      inline def setCopy(
        value: (/* req */ typingsJapgolly.expressServeStaticCore.mod.Request, /* res */ typingsJapgolly.expressServeStaticCore.mod.Response, /* next */ js.UndefOr[NextFunction]) => Any
  ...
  trait Response
    extends StObject
       with typingsJapgolly.expressServeStaticCore.mod.Response {
  ...
  trait Yog extends StObject {
    ...
    @JSName("_")
    def _underscore(): typingsJapgolly.lodash.mod.String = js.native
    @JSName("_")
    def _underscore(value: String): typingsJapgolly.lodash.mod.String = js.native
    @JSName("_")
    ...
    /**
      ...
      **/
    @JSName("_")
    def _underscore_TrapAny_Intersection[TrapAny /* <: typingsJapgolly.lodash.anon.TrapAny */](value: TrapAny): Collection[Any] & Function[Any] & Object[Any] & Primitive[Any] & typingsJapgolly.lodash.mod.String = js.native
    ...
    def express(): typingsJapgolly.expressServeStaticCore.mod.Express = js.native
    @JSName("express")
    var express_Original: js.Function0[typingsJapgolly.expressServeStaticCore.mod.Express] = js.native
