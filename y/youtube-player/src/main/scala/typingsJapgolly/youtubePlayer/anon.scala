...
import typingsJapgolly.youtubePlayer.distConstantsPlayerStatesMod.PlayerStates.ENDED
import typingsJapgolly.youtubePlayer.distConstantsPlayerStatesMod.PlayerStates.PAUSED
import typingsJapgolly.youtubePlayer.distConstantsPlayerStatesMod.PlayerStates.PLAYING
...
import typingsJapgolly.youtubePlayer.youtubePlayerInts.`0`
import typingsJapgolly.youtubePlayer.youtubePlayerInts.`1`
import typingsJapgolly.youtubePlayer.youtubePlayerInts.`3000`
import typingsJapgolly.youtubePlayer.youtubePlayerInts.`3`
import typingsJapgolly.youtubePlayer.youtubePlayerStrings.playlist
import typingsJapgolly.youtubePlayer.youtubePlayerStrings.red
import typingsJapgolly.youtubePlayer.youtubePlayerStrings.search
import typingsJapgolly.youtubePlayer.youtubePlayerStrings.user_uploads
import typingsJapgolly.youtubePlayer.youtubePlayerStrings.white
...
object anon {
  ...
  object eventTypeinEventTypeevent {
    ...
    extension [Self <: eventTypeinEventTypeevent](x: Self) {
      ...
      inline def setApiChange(value: /* event */ CustomEvent => Callback): Self = StObject.set(x, "apiChange", js.Any.fromFunction1((t0: /* event */ CustomEvent) => value(t0).runNow()))
      
      inline def setApiChangeUndefined: Self = StObject.set(x, "apiChange", js.undefined)
      
      inline def setError(value: /* event */ CustomEvent => Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: /* event */ CustomEvent) => value(t0).runNow()))
      
      inline def setErrorUndefined: Self = StObject.set(x, "error", js.undefined)
      
      inline def setPlaybackQualityChange(value: /* event */ CustomEvent => Callback): Self = StObject.set(x, "playbackQualityChange", js.Any.fromFunction1((t0: /* event */ CustomEvent) => value(t0).runNow()))
      
      inline def setPlaybackQualityChangeUndefined: Self = StObject.set(x, "playbackQualityChange", js.undefined)
      
      inline def setPlaybackRateChange(value: /* event */ CustomEvent => Callback): Self = StObject.set(x, "playbackRateChange", js.Any.fromFunction1((t0: /* event */ CustomEvent) => value(t0).runNow()))
      
      inline def setPlaybackRateChangeUndefined: Self = StObject.set(x, "playbackRateChange", js.undefined)
      
      inline def setReady(value: /* event */ CustomEvent => Callback): Self = StObject.set(x, "ready", js.Any.fromFunction1((t0: /* event */ CustomEvent) => value(t0).runNow()))
      
      inline def setReadyUndefined: Self = StObject.set(x, "ready", js.undefined)
      
      inline def setStateChange(value: /* event */ CustomEvent => Callback): Self = StObject.set(x, "stateChange", js.Any.fromFunction1((t0: /* event */ CustomEvent) => value(t0).runNow()))
      
      inline def setStateChangeUndefined: Self = StObject.set(x, "stateChange", js.undefined)
      
      inline def setVolumeChange(value: /* event */ CustomEvent => Callback): Self = StObject.set(x, "volumeChange", js.Any.fromFunction1((t0: /* event */ CustomEvent) => value(t0).runNow()))
