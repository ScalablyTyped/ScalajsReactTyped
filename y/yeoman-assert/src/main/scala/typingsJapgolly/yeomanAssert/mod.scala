package typingsJapgolly.yeomanAssert

import typingsJapgolly.assert.anon.Actual
import typingsJapgolly.assert.anon.DeepEqual
import typingsJapgolly.assert.mod.AssertPredicate
import typingsJapgolly.std.Omit
import typingsJapgolly.yeomanAssert.yeomanAssertStrings.deepEqual
import typingsJapgolly.yeomanAssert.yeomanAssertStrings.deepStrictEqual
import typingsJapgolly.yeomanAssert.yeomanAssertStrings.equal
import typingsJapgolly.yeomanAssert.yeomanAssertStrings.ifError
import typingsJapgolly.yeomanAssert.yeomanAssertStrings.notDeepEqual
import typingsJapgolly.yeomanAssert.yeomanAssertStrings.notEqual
import typingsJapgolly.yeomanAssert.yeomanAssertStrings.ok
import typingsJapgolly.yeomanAssert.yeomanAssertStrings.strictEqual
...
object mod {
  ...
  open class AssertionError ()
    extends typingsJapgolly.assert.mod.AssertionError {
  ...
  val strict: (Omit[
    ...
    equal | notEqual | deepEqual | notDeepEqual | ok | strictEqual | deepStrictEqual | ifError | typingsJapgolly.yeomanAssert.yeomanAssertStrings.strict
  ]) & DeepEqual = js.native
