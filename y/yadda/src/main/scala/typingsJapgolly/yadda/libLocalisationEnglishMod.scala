...
object libLocalisationEnglishMod extends Shortcut {
  ...
  trait Vocabulary
    extends StObject
       with typingsJapgolly.yadda.libLocalisationLanguageMod.Vocabulary {
  ...
  /* This means you don't have to write `^`, but can instead just say `libLocalisationEnglishMod.foo` */
