...
object libParsersFeatureParserMod {
  ...
  trait Options extends StObject {
    ...
    var language: js.UndefOr[typingsJapgolly.yadda.libLocalisationLanguageMod.^[Library]] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setLanguage(value: typingsJapgolly.yadda.libLocalisationLanguageMod.^[Library]): Self = StObject.set(x, "language", value.asInstanceOf[js.Any])
