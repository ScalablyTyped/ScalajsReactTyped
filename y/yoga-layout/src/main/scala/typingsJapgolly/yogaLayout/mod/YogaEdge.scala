...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.yogaLayout.yogaLayoutInts.`8`
*/
...
object YogaEdge {
  ...
  inline def `8`: typingsJapgolly.yogaLayout.yogaLayoutInts.`8` = 8.asInstanceOf[typingsJapgolly.yogaLayout.yogaLayoutInts.`8`]
}
