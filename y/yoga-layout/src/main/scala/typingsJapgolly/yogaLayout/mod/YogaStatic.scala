...
object YogaStatic {
  ...
  extension [Self <: YogaStatic](x: Self) {
    ...
    inline def setGetInstanceCount(value: CallbackTo[Double]): Self = StObject.set(x, "getInstanceCount", value.toJsFn)
