...
import typingsJapgolly.memFsEditor.mod.WriteContents
...
import typingsJapgolly.yeomanGenerator.anon.ExportOption
import typingsJapgolly.yeomanGenerator.anon.Fn0
import typingsJapgolly.yeomanGenerator.anon.FnCall
import typingsJapgolly.yeomanGenerator.anon.FnCallFilepathContentsReplacerSpace
import typingsJapgolly.yeomanGenerator.anon.FnCallFilepathDefaults
import typingsJapgolly.yeomanGenerator.anon.FnCallFilepathOptions
import typingsJapgolly.yeomanGenerator.anon.FnCallFromToOptions
import typingsJapgolly.yeomanGenerator.anon.Git
import typingsJapgolly.yeomanGenerator.anon.Store
import typingsJapgolly.yeomanGenerator.yeomanGeneratorBooleans.`false`
import typingsJapgolly.yeomanGenerator.yeomanGeneratorBooleans.`true`
...
object mod {
  ...
  trait Generator[T /* <: GeneratorOptions */] extends EventEmitter {
    ...
    /**
      ...
      */
    var config: typingsJapgolly.yeomanGenerator.libUtilStorageMod.^ = js.native
    ...
    /**
      ...
      */
    def createStorage(storagePath: String): typingsJapgolly.yeomanGenerator.libUtilStorageMod.^ = js.native
    def createStorage(storagePath: String, key: String): typingsJapgolly.yeomanGenerator.libUtilStorageMod.^ = js.native
    def createStorage(storagePath: String, key: String, lodashPath: Boolean): typingsJapgolly.yeomanGenerator.libUtilStorageMod.^ = js.native
    def createStorage(storagePath: String, key: Unit, lodashPath: Boolean): typingsJapgolly.yeomanGenerator.libUtilStorageMod.^ = js.native
    ...
    /**
      ...
      */
    var packageJson: typingsJapgolly.yeomanGenerator.libUtilStorageMod.^ = js.native
    
    /**
      * Prompt user to answer questions.
      */
    def prompt[T /* <: typingsJapgolly.inquirer.mod.Answers */](questions: Questions[T]): js.Promise[T] = js.native
    ...
    def registerConfigPrompts[TAnswers /* <: typingsJapgolly.inquirer.mod.Answers */](questions: js.Array[QuestionRegistrationOptions[TAnswers]]): Unit = js.native
    /**
      ...
      */
    def registerConfigPrompts[TAnswers /* <: typingsJapgolly.inquirer.mod.Answers */](questions: QuestionRegistrationOptions[TAnswers]): Unit = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.yeomanGenerator.yeomanGeneratorStrings.argument
    - typingsJapgolly.yeomanGenerator.yeomanGeneratorStrings.namespacep
  */
  trait GeneratorFeaturesUniqueBy extends StObject
  object GeneratorFeaturesUniqueBy {
    
    inline def argument: typingsJapgolly.yeomanGenerator.yeomanGeneratorStrings.argument = "argument".asInstanceOf[typingsJapgolly.yeomanGenerator.yeomanGeneratorStrings.argument]
    
    inline def namespacep: typingsJapgolly.yeomanGenerator.yeomanGeneratorStrings.namespacep = "namespacep".asInstanceOf[typingsJapgolly.yeomanGenerator.yeomanGeneratorStrings.namespacep]
  }
  ...
  trait OptionConfig extends StObject {
    ...
    /**
      ...
      */
    var storage: js.UndefOr[typingsJapgolly.yeomanGenerator.libUtilStorageMod.^] = js.undefined
  ...
  object OptionConfig {
    ...
    extension [Self <: OptionConfig](x: Self) {
      ...
      inline def setStorage(value: typingsJapgolly.yeomanGenerator.libUtilStorageMod.^): Self = StObject.set(x, "storage", value.asInstanceOf[js.Any])
  ...
  object TaskOptions {
    ...
    extension [Self <: TaskOptions](x: Self) {
      ...
      inline def setReject(value: /* err */ Any => japgolly.scalajs.react.Callback): Self = StObject.set(x, "reject", js.Any.fromFunction1((t0: /* err */ Any) => value(t0).runNow()))
