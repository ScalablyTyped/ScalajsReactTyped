...
import typingsJapgolly.memFsEditor.mod.Editor
...
object libUtilStorageMod {
  ...
  object Storage {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(createProxy = createProxy.toJsFn, createStorage = js.Any.fromFunction1(createStorage), defaults = js.Any.fromFunction1(defaults), delete = js.Any.fromFunction1((t0: String) => delete(t0).runNow()), get = js.Any.fromFunction1(get), getAll = getAll.toJsFn, getPath = js.Any.fromFunction1(getPath), merge = js.Any.fromFunction1(merge), save = save.toJsFn, set = js.Any.fromFunction2(set), setPath = js.Any.fromFunction2(setPath))
      __obj.asInstanceOf[Storage]
    }
    
    extension [Self <: Storage](x: Self) {
      
      inline def setCreateProxy(value: CallbackTo[js.Object]): Self = StObject.set(x, "createProxy", value.toJsFn)
      ...
      inline def setGetAll(value: CallbackTo[Record[String, Any]]): Self = StObject.set(x, "getAll", value.toJsFn)
