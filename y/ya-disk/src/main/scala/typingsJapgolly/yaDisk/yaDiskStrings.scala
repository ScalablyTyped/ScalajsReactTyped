package typingsJapgolly.yaDisk

import typingsJapgolly.yaDisk.mod.MediaType
import typingsJapgolly.yaDisk.mod.ResourceType
import typingsJapgolly.yaDisk.mod.Sort
import typingsJapgolly.yaDisk.mod._PreviewSize
...
object yaDiskStrings {
  ...
  sealed trait XXXL
    extends StObject
       with _PreviewSize
  inline def XXXL: XXXL = "XXXL".asInstanceOf[XXXL]
  ...
  @js.native
  sealed trait diskimage
    extends StObject
       with MediaType
  inline def diskimage: diskimage = "diskimage".asInstanceOf[diskimage]
