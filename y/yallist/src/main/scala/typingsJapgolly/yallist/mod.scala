package typingsJapgolly.yallist
...
object mod {
  ...
  object ForEachIterable {
    ...
    inline def apply[T](forEach: js.Function1[/* item */ T, Unit] => Callback): ForEachIterable[T] = {
      val __obj = js.Dynamic.literal(forEach = js.Any.fromFunction1((t0: js.Function1[/* item */ T, Unit]) => forEach(t0).runNow()))
      __obj.asInstanceOf[ForEachIterable[T]]
    }
    
    extension [Self <: ForEachIterable[?], T](x: Self & ForEachIterable[T]) {
      
      inline def setForEach(value: js.Function1[/* item */ T, Unit] => Callback): Self = StObject.set(x, "forEach", js.Any.fromFunction1((t0: js.Function1[/* item */ T, Unit]) => value(t0).runNow()))
    }
  }
