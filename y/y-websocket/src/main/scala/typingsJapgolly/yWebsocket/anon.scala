...
object anon {
  ...
  trait Awareness extends StObject {
    ...
    var awareness: js.UndefOr[typingsJapgolly.yProtocols.awarenessMod.Awareness] = js.undefined
  ...
  object Awareness {
    ...
    extension [Self <: Awareness](x: Self) {
      ...
      inline def setAwareness(value: typingsJapgolly.yProtocols.awarenessMod.Awareness): Self = StObject.set(x, "awareness", value.asInstanceOf[js.Any])
