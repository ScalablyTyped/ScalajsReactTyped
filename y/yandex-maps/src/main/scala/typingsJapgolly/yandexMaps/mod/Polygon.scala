...
@js.native
class Polygon protected () extends GeoObject_ {
  ...
  def this(geometry: js.Array[js.Array[js.Array[Double]]], properties: js.Object) = this()
  def this(geometry: js.Array[js.Array[js.Array[Double]]], properties: IDataManager) = this()
