...
import typingsJapgolly.yandexMaps.anon.BalloonAutoPan
import typingsJapgolly.yandexMaps.mod.option.Manager
...
object objectManager {
  ...
  open class ClusterCollection ()
    ...
    var balloon: typingsJapgolly.yandexMaps.anon.Balloon = js.native
    ...
    var hint: typingsJapgolly.yandexMaps.anon.Hint = js.native
  ...
  open class Hint () extends StObject {
    ...
    def close(): js.Promise[typingsJapgolly.yandexMaps.mod.map.Hint] = js.native
    def close(force: Boolean): js.Promise[typingsJapgolly.yandexMaps.mod.map.Hint] = js.native
    ...
    def open(objectId: String): js.Promise[typingsJapgolly.yandexMaps.mod.map.Hint] = js.native
    def open(objectId: String, position: js.Array[Double]): js.Promise[typingsJapgolly.yandexMaps.mod.map.Hint] = js.native
    def open(objectId: js.Object): js.Promise[typingsJapgolly.yandexMaps.mod.map.Hint] = js.native
    def open(objectId: js.Object, position: js.Array[Double]): js.Promise[typingsJapgolly.yandexMaps.mod.map.Hint] = js.native
    
    def setData(data: String): js.Promise[typingsJapgolly.yandexMaps.mod.map.Hint] = js.native
    def setData(data: js.Object): js.Promise[typingsJapgolly.yandexMaps.mod.map.Hint] = js.native
    def setData(data: HTMLElement): js.Promise[typingsJapgolly.yandexMaps.mod.map.Hint] = js.native
    
    def setOptions(options: js.Object): js.Promise[typingsJapgolly.yandexMaps.mod.map.Hint] = js.native
    
    def setPosition(position: js.Array[Double]): js.Promise[typingsJapgolly.yandexMaps.mod.map.Hint] = js.native
  }
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.yandexMaps.mod.IEventEmitter because Already inherited
  - typingsJapgolly.yandexMaps.mod.ICustomizable because var conflicts: events. Inlined options */ @JSImport("yandex-maps", "objectManager.ObjectCollection")
  @js.native
