...
object panorama {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.yandexMaps.yandexMapsStrings.yandexNumbersignpanorama
    - typingsJapgolly.yandexMaps.yandexMapsStrings.yandexNumbersignairPanorama
  */
  trait Layer extends StObject
  object Layer {
    
    inline def yandexNumbersignairPanorama: typingsJapgolly.yandexMaps.yandexMapsStrings.yandexNumbersignairPanorama = "yandex#airPanorama".asInstanceOf[typingsJapgolly.yandexMaps.yandexMapsStrings.yandexNumbersignairPanorama]
    
    inline def yandexNumbersignpanorama: typingsJapgolly.yandexMaps.yandexMapsStrings.yandexNumbersignpanorama = "yandex#panorama".asInstanceOf[typingsJapgolly.yandexMaps.yandexMapsStrings.yandexNumbersignpanorama]
  }
}
