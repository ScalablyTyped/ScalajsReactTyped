...
import typingsJapgolly.yandexMaps.AnonCoordRendering
...
object geometry extends js.Object {
  ...
  - typingsJapgolly.yandexMaps.mod.ILineStringGeometryAccess because var conflicts: events. Inlined get, getChildGeometry, getClosest, getCoordinates, getLength, insert, remove, set, setCoordinates, splice */ @js.native
  ...
  /* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
  - typingsJapgolly.yandexMaps.mod.IFreezable because var conflicts: events. Inlined freeze, isFrozen, unfreeze
  - typingsJapgolly.yandexMaps.mod.IPolygonGeometryAccess because var conflicts: events. Inlined contains, get, getChildGeometry, getClosest, getCoordinates, getFillRule, getLength, insert, remove, set, setCoordinates, setFillRule, splice */ @js.native
  ...
  object Polygon extends js.Object {
    def fromEncodedCoordinates(encodedCoordinates: String): typingsJapgolly.yandexMaps.mod.geometry.Polygon = js.native
     //tslint:disable-line function-name
    def toEncodedCoordinates(geometry: typingsJapgolly.yandexMaps.mod.geometry.Polygon): String = js.native
  }
  ...
  object base extends js.Object {
    ...
    @js.native
    object LineString extends js.Object {
      def fromEncodedCoordinates(encodedCoordinates: String): typingsJapgolly.yandexMaps.mod.geometry.LineString = js.native
       //tslint:disable-line function-name
      def toEncodedCoordinates(geometry: typingsJapgolly.yandexMaps.mod.geometry.LineString): String = js.native
    }
    
    /* static members */
    @js.native
    object Polygon extends js.Object {
      def fromEncodedCoordinates(encodedCoordinates: String): typingsJapgolly.yandexMaps.mod.geometry.base.Polygon = js.native
       //tslint:disable-line function-name
      def toEncodedCoordinates(geometry: typingsJapgolly.yandexMaps.mod.geometry.base.Polygon): String = js.native
    }
