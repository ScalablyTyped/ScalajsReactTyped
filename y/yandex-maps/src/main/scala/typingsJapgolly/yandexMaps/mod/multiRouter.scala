...
object multiRouter {
  ...
  object masstransit {
    ...
    open class PathModel ()
      ...
      var route: typingsJapgolly.yandexMaps.mod.multiRouter.masstransit.RouteModel = js.native
    ...
    open class Route ()
      ...
      var model: typingsJapgolly.yandexMaps.mod.multiRouter.masstransit.RouteModel = js.native
