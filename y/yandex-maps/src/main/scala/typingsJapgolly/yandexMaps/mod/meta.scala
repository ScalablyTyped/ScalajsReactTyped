...
import typingsJapgolly.yandexMaps.anon.TypeofyandexMaps
import typingsJapgolly.yandexMaps.yandexMapsStrings.debug
import typingsJapgolly.yandexMaps.yandexMapsStrings.latlong
import typingsJapgolly.yandexMaps.yandexMapsStrings.longlat
import typingsJapgolly.yandexMaps.yandexMapsStrings.release
