...
object map {
  ...
  open class Balloon protected ()
    extends StObject
       with IBalloonManager[typingsJapgolly.yandexMaps.mod.map.Balloon] {
  ...
  object layer {
    ...
    - typingsJapgolly.yandexMaps.mod.ICollection because var conflicts: events. Inlined add, getIterator, remove
    - typingsJapgolly.yandexMaps.mod.IMapObjectCollection because var conflicts: events, options. Inlined  */ @JSImport("yandex-maps", "map.layer.Manager")
    @js.native
    open class Manager protected ()
      extends StObject
         with ILayer
