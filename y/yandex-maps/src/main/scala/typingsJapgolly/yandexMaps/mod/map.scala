...
import typingsJapgolly.yandexMaps.AnonTrafficImageZIndex
...
object map extends js.Object {
  ...
  class Balloon protected ()
    extends IBalloonManager[typingsJapgolly.yandexMaps.mod.map.Balloon] {
  ...
  object layer extends js.Object {
    ...
    - typingsJapgolly.yandexMaps.mod.ICollection because var conflicts: events. Inlined add, getIterator, remove */ @js.native
    class Manager protected ()
      extends ILayer
         with IParentOnMap {
      def this(map: Map_) = this()
