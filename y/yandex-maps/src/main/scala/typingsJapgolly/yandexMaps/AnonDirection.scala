...
import typingsJapgolly.yandexMaps.yandexMapsStrings.yandexNumbersignairPanorama
import typingsJapgolly.yandexMaps.yandexMapsStrings.yandexNumbersignpanorama
