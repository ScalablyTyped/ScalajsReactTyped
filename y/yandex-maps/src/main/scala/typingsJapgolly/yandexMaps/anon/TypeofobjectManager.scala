...
import typingsJapgolly.yandexMaps.mod.objectManager.ClusterCollection
import typingsJapgolly.yandexMaps.mod.objectManager.ObjectCollection
...
trait TypeofobjectManager extends StObject {
  ...
  var Balloon: Instantiable0[typingsJapgolly.yandexMaps.anon.Balloon]
  
  var ClusterCollection: Instantiable0[typingsJapgolly.yandexMaps.mod.objectManager.ClusterCollection]
  
  var Hint: Instantiable0[typingsJapgolly.yandexMaps.anon.Hint]
  
  var ObjectCollection: Instantiable0[typingsJapgolly.yandexMaps.mod.objectManager.ObjectCollection]
}
