...
import typingsJapgolly.yandexMaps.mod.layout.templateBased.Base
...
trait TypeoftemplateBased extends StObject {
  ...
  var Base: Instantiable1[/* data */ js.Object, typingsJapgolly.yandexMaps.mod.layout.templateBased.Base]
}
