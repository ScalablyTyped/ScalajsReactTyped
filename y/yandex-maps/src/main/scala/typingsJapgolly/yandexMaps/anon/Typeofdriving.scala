...
import typingsJapgolly.yandexMaps.mod.multiRouter.driving.Path
import typingsJapgolly.yandexMaps.mod.multiRouter.driving.PathModel
...
import typingsJapgolly.yandexMaps.mod.multiRouter.driving.Segment
import typingsJapgolly.yandexMaps.mod.multiRouter.driving.SegmentModel
...
trait Typeofdriving extends StObject {
  ...
  var Path: Instantiable0[typingsJapgolly.yandexMaps.mod.multiRouter.driving.Path]
  
  var PathModel: Instantiable0[typingsJapgolly.yandexMaps.mod.multiRouter.driving.PathModel]
  
  var Route: Instantiable0[typingsJapgolly.yandexMaps.mod.multiRouter.driving.Route]
  
  var RouteModel: Instantiable0[typingsJapgolly.yandexMaps.mod.multiRouter.driving.RouteModel]
  
  var Segment: Instantiable0[typingsJapgolly.yandexMaps.mod.multiRouter.driving.Segment]
  
  var SegmentModel: Instantiable0[typingsJapgolly.yandexMaps.mod.multiRouter.driving.SegmentModel]
}
