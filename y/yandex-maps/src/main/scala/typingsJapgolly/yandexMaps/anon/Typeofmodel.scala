...
import typingsJapgolly.yandexMaps.mod.geometryEditor.model.ChildLineString
import typingsJapgolly.yandexMaps.mod.geometryEditor.model.ChildLinearRing
import typingsJapgolly.yandexMaps.mod.geometryEditor.model.ChildVertex
import typingsJapgolly.yandexMaps.mod.geometryEditor.model.Edge
import typingsJapgolly.yandexMaps.mod.geometryEditor.model.EdgeGeometry
...
trait Typeofmodel extends StObject {
  ...
  var ChildLineString: Instantiable0[typingsJapgolly.yandexMaps.mod.geometryEditor.model.ChildLineString]
  
  var ChildLinearRing: Instantiable0[typingsJapgolly.yandexMaps.mod.geometryEditor.model.ChildLinearRing]
  
  var ChildVertex: Instantiable0[typingsJapgolly.yandexMaps.mod.geometryEditor.model.ChildVertex]
  
  var Edge: Instantiable0[typingsJapgolly.yandexMaps.mod.geometryEditor.model.Edge]
  
  var EdgeGeometry: Instantiable0[typingsJapgolly.yandexMaps.mod.geometryEditor.model.EdgeGeometry]
  
  var RootLineString: Instantiable0[typingsJapgolly.yandexMaps.mod.geometryEditor.model.RootLineString]
  
  var RootPolygon: Instantiable0[typingsJapgolly.yandexMaps.mod.geometryEditor.model.RootPolygon]
}
object Typeofmodel {
  ...
  extension [Self <: Typeofmodel](x: Self) {
