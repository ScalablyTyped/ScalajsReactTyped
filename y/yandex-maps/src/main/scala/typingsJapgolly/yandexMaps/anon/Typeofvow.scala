...
import typingsJapgolly.yandexMaps.mod.vow.Deferred
...
trait Typeofvow extends StObject {
  ...
  var Deferred: Instantiable0[typingsJapgolly.yandexMaps.mod.vow.Deferred]
  
  var Promise: Instantiable1[
    /* resolver */ js.UndefOr[js.Function0[Unit]], 
    typingsJapgolly.yandexMaps.mod.vow.Promise
  ]
}
object Typeofvow {
