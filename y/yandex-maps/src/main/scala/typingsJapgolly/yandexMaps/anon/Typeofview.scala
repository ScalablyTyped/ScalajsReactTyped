...
import typingsJapgolly.yandexMaps.mod.geometryEditor.view.Edge
import typingsJapgolly.yandexMaps.mod.geometryEditor.view.MultiPath
import typingsJapgolly.yandexMaps.mod.geometryEditor.view.Path
import typingsJapgolly.yandexMaps.mod.geometryEditor.view.Vertex
...
trait Typeofview extends StObject {
  ...
  var Edge: Instantiable0[typingsJapgolly.yandexMaps.mod.geometryEditor.view.Edge]
  
  var MultiPath: Instantiable0[typingsJapgolly.yandexMaps.mod.geometryEditor.view.MultiPath]
  
  var Path: Instantiable0[typingsJapgolly.yandexMaps.mod.geometryEditor.view.Path]
  
  var Vertex: Instantiable0[typingsJapgolly.yandexMaps.mod.geometryEditor.view.Vertex]
}
object Typeofview {
