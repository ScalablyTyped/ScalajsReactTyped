...
import typingsJapgolly.yandexMaps.mod.geometry.pixel.Circle
import typingsJapgolly.yandexMaps.mod.geometry.pixel.LineString
import typingsJapgolly.yandexMaps.mod.geometry.pixel.MultiLineString
import typingsJapgolly.yandexMaps.mod.geometry.pixel.MultiPolygon
import typingsJapgolly.yandexMaps.mod.geometry.pixel.Point
import typingsJapgolly.yandexMaps.mod.geometry.pixel.Polygon
import typingsJapgolly.yandexMaps.mod.geometry.pixel.Rectangle
...
trait Typeofpixel extends StObject {
  ...
  var Circle: Instantiable3[
    ...
    typingsJapgolly.yandexMaps.mod.geometry.pixel.Circle
  ]
  
  var LineString: Instantiable2[
    /* coordinates */ js.Array[js.Array[Double]], 
    /* metaData */ js.UndefOr[js.Object], 
    typingsJapgolly.yandexMaps.mod.geometry.pixel.LineString
  ]
  
  var MultiLineString: Instantiable2[
    /* coordinates */ js.Array[js.Array[js.Array[Double]]], 
    /* metaData */ js.UndefOr[js.Object], 
    typingsJapgolly.yandexMaps.mod.geometry.pixel.MultiLineString
  ]
  ...
  var MultiPolygon: Instantiable3[
    ...
    /* metaData */ js.UndefOr[js.Object], 
    typingsJapgolly.yandexMaps.mod.geometry.pixel.MultiPolygon
  ]
  
  var Point: Instantiable2[
    /* position */ js.Array[Double] | Null, 
    /* metaData */ js.UndefOr[js.Object], 
    typingsJapgolly.yandexMaps.mod.geometry.pixel.Point
  ]
  ...
  var Polygon: Instantiable3[
    ...
    /* fillRule */ evenOdd | nonZero, 
    /* metaData */ js.UndefOr[js.Object], 
    typingsJapgolly.yandexMaps.mod.geometry.pixel.Polygon
  ]
  
  var Rectangle: Instantiable2[
    /* coordinates */ js.Array[js.Array[Double]] | Null, 
    /* metaData */ js.UndefOr[js.Object], 
    typingsJapgolly.yandexMaps.mod.geometry.pixel.Rectangle
  ]
}
object Typeofpixel {
