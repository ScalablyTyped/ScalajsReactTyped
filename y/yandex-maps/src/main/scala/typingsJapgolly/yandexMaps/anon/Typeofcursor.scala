...
import typingsJapgolly.yandexMaps.mod.util.cursor.Accessor
import typingsJapgolly.yandexMaps.mod.util.cursor.Manager
...
trait Typeofcursor extends StObject {
  ...
  var Accessor: Instantiable1[/* key */ String, typingsJapgolly.yandexMaps.mod.util.cursor.Accessor]
  
  var Manager: Instantiable1[/* element */ HTMLElement, typingsJapgolly.yandexMaps.mod.util.cursor.Manager]
}
object Typeofcursor {
