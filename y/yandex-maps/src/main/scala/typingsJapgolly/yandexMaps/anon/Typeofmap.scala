...
trait Typeofmap extends StObject {
  ...
  var Balloon: Instantiable1[/* map */ Map_, typingsJapgolly.yandexMaps.mod.map.Balloon]
  
  var Container: Instantiable1[
    /* parentElement */ String | HTMLElement, 
    typingsJapgolly.yandexMaps.mod.map.Container
  ]
  
  var Converter: Instantiable1[/* map */ Map_, typingsJapgolly.yandexMaps.mod.map.Converter]
  
  var Copyrights: Instantiable1[/* map */ Map_, typingsJapgolly.yandexMaps.mod.map.Copyrights]
  
  var GeoObjects: Instantiable2[
    /* map */ Map_, 
    /* options */ js.UndefOr[js.Object], 
    typingsJapgolly.yandexMaps.mod.map.GeoObjects
  ]
  
  var Hint: Instantiable1[/* map */ Map_, typingsJapgolly.yandexMaps.mod.map.Hint]
  
  var ZoomRange: Instantiable2[
    /* map */ Map_, 
    /* constraints */ js.Array[Double], 
    typingsJapgolly.yandexMaps.mod.map.ZoomRange
  ]
...
object Typeofmap {
  ...
  inline def apply(
    Balloon: Instantiable1[/* map */ Map_, typingsJapgolly.yandexMaps.mod.map.Balloon],
    ...
    Hint: Instantiable1[/* map */ Map_, typingsJapgolly.yandexMaps.mod.map.Hint],
  ...
  extension [Self <: Typeofmap](x: Self) {
    ...
    inline def setBalloon(value: Instantiable1[/* map */ Map_, typingsJapgolly.yandexMaps.mod.map.Balloon]): Self = StObject.set(x, "Balloon", value.asInstanceOf[js.Any])
    ...
    inline def setHint(value: Instantiable1[/* map */ Map_, typingsJapgolly.yandexMaps.mod.map.Hint]): Self = StObject.set(x, "Hint", value.asInstanceOf[js.Any])
