...
import typingsJapgolly.yandexMaps.mod.pane.EventsPane
import typingsJapgolly.yandexMaps.mod.pane.MovablePane
import typingsJapgolly.yandexMaps.mod.pane.StaticPane
...
trait TypeofpaneEventsPane extends StObject {
  ...
  var EventsPane: Instantiable2[
    ...
    typingsJapgolly.yandexMaps.mod.pane.EventsPane
  ]
  
  var MovablePane: Instantiable2[/* map */ Map_, /* params */ Css, typingsJapgolly.yandexMaps.mod.pane.MovablePane]
  
  var StaticPane: Instantiable2[/* map */ Map_, /* params */ Margin, typingsJapgolly.yandexMaps.mod.pane.StaticPane]
}
