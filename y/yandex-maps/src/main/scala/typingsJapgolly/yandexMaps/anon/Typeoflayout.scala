...
import typingsJapgolly.yandexMaps.mod.layout.ImageWithContent
import typingsJapgolly.yandexMaps.mod.layout.PieChart
...
trait Typeoflayout extends StObject {
  ...
  var Image: Instantiable0[typingsJapgolly.yandexMaps.mod.layout.Image]
  
  var ImageWithContent: Instantiable0[typingsJapgolly.yandexMaps.mod.layout.ImageWithContent]
  
  var PieChart: Instantiable0[typingsJapgolly.yandexMaps.mod.layout.PieChart]
...
object Typeoflayout {
  ...
  inline def apply(
    Image: Instantiable0[typingsJapgolly.yandexMaps.mod.layout.Image],
  ...
  extension [Self <: Typeoflayout](x: Self) {
    ...
    inline def setImage(value: Instantiable0[typingsJapgolly.yandexMaps.mod.layout.Image]): Self = StObject.set(x, "Image", value.asInstanceOf[js.Any])
