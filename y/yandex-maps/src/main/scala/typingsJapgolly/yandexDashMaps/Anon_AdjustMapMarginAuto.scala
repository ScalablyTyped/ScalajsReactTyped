...
import typingsJapgolly.yandexDashMaps.yandexDashMapsMod.IGeocodeProvider
import typingsJapgolly.yandexDashMaps.yandexDashMapsMod.ILayout
import typingsJapgolly.yandexDashMaps.yandexDashMapsMod.ISearchControlLayout
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.`yandex#map`
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.`yandex#search`
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.auto
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.district
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.house
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.large
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.latlong
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.left
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.locality
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.longlat
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.medium
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.metro
...
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.street
