...
import typingsJapgolly.yandexDashMaps.yandexDashMapsMod.event.Manager
import typingsJapgolly.yandexDashMaps.yandexDashMapsMod.geoObject.Hint
...
class GeoObject () extends IGeoObject {
  ...
  var balloon: typingsJapgolly.yandexDashMaps.yandexDashMapsMod.geoObject.Balloon = js.native
  ...
  @JSName("options")
  var options_GeoObject: typingsJapgolly.yandexDashMaps.yandexDashMapsMod.option.Manager = js.native
  @JSName("properties")
  var properties_GeoObject: typingsJapgolly.yandexDashMaps.yandexDashMapsMod.data.Manager = js.native
  @JSName("state")
  var state_GeoObject: typingsJapgolly.yandexDashMaps.yandexDashMapsMod.data.Manager = js.native
  /* CompleteClass */
