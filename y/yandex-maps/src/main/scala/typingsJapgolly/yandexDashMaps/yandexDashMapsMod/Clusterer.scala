...
import typingsJapgolly.yandexDashMaps.yandexDashMapsMod.clusterer.Hint
...
class Clusterer ()
  ...
  var balloon: typingsJapgolly.yandexDashMaps.yandexDashMapsMod.clusterer.Balloon = js.native
  /* CompleteClass */
