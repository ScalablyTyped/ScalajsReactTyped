...
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.`yandex#hybrid`
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.`yandex#map`
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.`yandex#satellite`
