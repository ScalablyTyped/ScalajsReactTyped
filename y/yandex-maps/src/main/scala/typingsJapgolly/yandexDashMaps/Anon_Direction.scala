...
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.`yandex#airPanorama`
import typingsJapgolly.yandexDashMaps.yandexDashMapsStrings.`yandex#panorama`
