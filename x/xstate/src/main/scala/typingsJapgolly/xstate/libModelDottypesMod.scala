...
import typingsJapgolly.xstate.libTypesMod.AnyFunction
...
import typingsJapgolly.xstate.xstateStrings.events
...
object libModelDottypesMod {
  ...
  trait FinalModelCreators[Self] extends StObject {
    ...
    var actions: FinalActionCreators[Prop[Self, typingsJapgolly.xstate.xstateStrings.actions]]
    
    var events: FinalEventCreators[Prop[Self, typingsJapgolly.xstate.xstateStrings.events]]
  }
  ...
  trait Model[TContext, TEvent /* <: EventObject */, TAction /* <: BaseActionObject */, TModelCreators] extends StObject {
    ...
    var actions: Prop[TModelCreators, typingsJapgolly.xstate.xstateStrings.actions] = js.native
    ...
    var events: Prop[TModelCreators, typingsJapgolly.xstate.xstateStrings.events] = js.native
  ...
  trait ModelCreators[Self] extends StObject {
    ...
    var actions: js.UndefOr[ActionCreators[Prop[Self, typingsJapgolly.xstate.xstateStrings.actions]]] = js.undefined
    
    var events: js.UndefOr[EventCreators[Prop[Self, typingsJapgolly.xstate.xstateStrings.events]]] = js.undefined
  }
