...
object PartialInterpreterOptions {
  ...
  def apply(
    ...
    id: String = null,
    logger: /* repeated */ js.Any => Callback = null,
    ...
    if (!js.isUndefined(deferEvents)) __obj.updateDynamic("deferEvents")(deferEvents.asInstanceOf[js.Any])
    ...
    if (logger != null) __obj.updateDynamic("logger")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => logger(t0).runNow()))
