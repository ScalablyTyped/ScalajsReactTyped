...
object SCXML {
  ...
  object Event {
    ...
    inline def apply[TEvent /* <: EventObject */](data: TEvent, name: String, `type`: platform | internal | external): typingsJapgolly.xstate.libTypesMod.SCXML.Event[TEvent] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("$$type")("scxml")
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.xstate.libTypesMod.SCXML.Event[TEvent]]
    }
    
    extension [Self <: typingsJapgolly.xstate.libTypesMod.SCXML.Event[?], TEvent /* <: EventObject */](x: Self & typingsJapgolly.xstate.libTypesMod.SCXML.Event[TEvent]) {
