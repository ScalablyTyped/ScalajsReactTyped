...
trait SendActionObject[TContext, TEvent /* <: EventObject */, TSentEvent /* <: EventObject */]
  ...
  var _event: typingsJapgolly.xstate.libTypesMod.SCXML.Event[TSentEvent]
...
object SendActionObject {
  ...
  inline def apply[TContext, TEvent /* <: EventObject */, TSentEvent /* <: EventObject */](
    _event: typingsJapgolly.xstate.libTypesMod.SCXML.Event[TSentEvent],
    event: TSentEvent,
    id: String | Double,
    `type`: String
  ...
  extension [Self <: SendActionObject[?, ?, ?], TContext, TEvent /* <: EventObject */, TSentEvent /* <: EventObject */](x: Self & (SendActionObject[TContext, TEvent, TSentEvent])) {
    ...
    inline def set_event(value: typingsJapgolly.xstate.libTypesMod.SCXML.Event[TSentEvent]): Self = StObject.set(x, "_event", value.asInstanceOf[js.Any])
  }
}
