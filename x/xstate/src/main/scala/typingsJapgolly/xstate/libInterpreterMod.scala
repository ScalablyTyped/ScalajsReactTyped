...
import typingsJapgolly.xstate.anon.AutoForward
import typingsJapgolly.xstate.anon.ContextAny
import typingsJapgolly.xstate.anon.ContextTChildContext
import typingsJapgolly.xstate.anon.FnCall
import typingsJapgolly.xstate.anon.Id
import typingsJapgolly.xstate.anon.ReadonlyInterpreterOption
...
import typingsJapgolly.xstate.libTypesMod.Subscription
...
object libInterpreterMod {
  ...
  open class Interpreter[TContext, TStateSchema /* <: StateSchema[Any] */, TEvent /* <: EventObject */, TTypestate /* <: Typestate[TContext] */, TResolvedTypesMeta] protected ()
    ...
    def nextState(event: typingsJapgolly.xstate.libTypesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TTypestate, TResolvedTypesMeta] = js.native
    ...
    def send(event: typingsJapgolly.xstate.libTypesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TTypestate, TResolvedTypesMeta] = js.native
    def send(event: typingsJapgolly.xstate.libTypesMod.SCXML.Event[TEvent], payload: EventData): State[TContext, TEvent, TStateSchema, TTypestate, TResolvedTypesMeta] = js.native
  ...
  object Interpreter {
    ...
    @js.native
    def defaultOptions: typingsJapgolly.xstate.anon.Clock = js.native
    inline def defaultOptions_=(x: typingsJapgolly.xstate.anon.Clock): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultOptions")(x.asInstanceOf[js.Any])
  ...
  object Clock {
    ...
    inline def apply(clearTimeout: Any => Callback, setTimeout: (js.Function1[/* repeated */ Any, Unit], Double) => Any): Clock = {
      val __obj = js.Dynamic.literal(clearTimeout = js.Any.fromFunction1((t0: Any) => clearTimeout(t0).runNow()), setTimeout = js.Any.fromFunction2(setTimeout))
