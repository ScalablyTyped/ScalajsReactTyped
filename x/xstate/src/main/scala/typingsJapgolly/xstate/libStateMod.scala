...
import typingsJapgolly.xstate.anon.Tags
...
import typingsJapgolly.xstate.libTypesMod.ActivityMap
...
import typingsJapgolly.xstate.libTypesMod.TransitionDefinition
import typingsJapgolly.xstate.libTypesMod.Typestate
import typingsJapgolly.xstate.xstateStrings.can
import typingsJapgolly.xstate.xstateStrings.configuration
import typingsJapgolly.xstate.xstateStrings.hasTag
import typingsJapgolly.xstate.xstateStrings.machine
import typingsJapgolly.xstate.xstateStrings.matches
import typingsJapgolly.xstate.xstateStrings.tags
import typingsJapgolly.xstate.xstateStrings.toStrings
...
object libStateMod {
  ...
  open class State[TContext, TEvent /* <: EventObject */, TStateSchema /* <: StateSchema[TContext] */, TTypestate /* <: Typestate[TContext] */, TResolvedTypesMeta] protected () extends StObject {
    ...
    def toJSON(): (Omit[
        this.type, 
        machine | configuration | transitions | tags | toStrings | typingsJapgolly.xstate.xstateStrings.toJSON | matches | hasTag | can
      ]) & Tags = js.native
