...
import typingsJapgolly.xstate.anon.`4`
...
import typingsJapgolly.xstate.libTypesMod.ActionTypes.NullEvent
import typingsJapgolly.xstate.libTypesMod.AssignAction
import typingsJapgolly.xstate.libTypesMod.Condition
import typingsJapgolly.xstate.libTypesMod.ConditionPredicate
import typingsJapgolly.xstate.libTypesMod.EventData
import typingsJapgolly.xstate.libTypesMod.EventObject
import typingsJapgolly.xstate.libTypesMod.EventType
import typingsJapgolly.xstate.libTypesMod.Guard
import typingsJapgolly.xstate.libTypesMod.HistoryValue
import typingsJapgolly.xstate.libTypesMod.InvokeSourceDefinition
import typingsJapgolly.xstate.libTypesMod.Mapper
import typingsJapgolly.xstate.libTypesMod.Observer
import typingsJapgolly.xstate.libTypesMod.PropertyMapper
...
import typingsJapgolly.xstate.libTypesMod.StateLike
import typingsJapgolly.xstate.libTypesMod.StateValue
import typingsJapgolly.xstate.libTypesMod.TransitionConfig
import typingsJapgolly.xstate.libTypesMod.TransitionConfigTarget
...
object libUtilsMod {
  ...
  inline def getEventType[TEvent /* <: EventObject */](event: typingsJapgolly.xstate.libTypesMod.Event[TEvent]): /* import warning: importer.ImportType#apply Failed type conversion: TEvent['type'] */ js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getEventType")(event.asInstanceOf[js.Any]).asInstanceOf[/* import warning: importer.ImportType#apply Failed type conversion: TEvent['type'] */ js.Any]
