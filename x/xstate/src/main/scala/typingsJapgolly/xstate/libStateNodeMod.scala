...
import typingsJapgolly.xstate.anon.ContextValue
...
import typingsJapgolly.xstate.libTypesMod.DelayedTransitionDefinition
...
import typingsJapgolly.xstate.libTypesMod.MachineSchema
...
import typingsJapgolly.xstate.libTypesMod.StateNodeDefinition
import typingsJapgolly.xstate.libTypesMod.StateNodesConfig
import typingsJapgolly.xstate.libTypesMod.StateSchema
import typingsJapgolly.xstate.libTypesMod.StateTransition
import typingsJapgolly.xstate.libTypesMod.StateValue
import typingsJapgolly.xstate.libTypesMod.TransitionDefinition
import typingsJapgolly.xstate.libTypesMod.TransitionDefinitionMap
...
object libStateNodeMod {
  ...
  open class StateNode[TContext, TStateSchema /* <: StateSchema[Any] */, TEvent /* <: EventObject */, TTypestate /* <: Typestate[TContext] */, TServiceMap /* <: ServiceMap */, TResolvedTypesMeta] protected () extends StObject {
    ...
    def getTransitionData(
      ...
      event: typingsJapgolly.xstate.libTypesMod.SCXML.Event[TEvent]
    ...
    def transition(state: Unit, event: typingsJapgolly.xstate.libTypesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TTypestate, TResolvedTypesMeta] = js.native
    def transition(state: Unit, event: typingsJapgolly.xstate.libTypesMod.SCXML.Event[TEvent], context: TContext): State[TContext, TEvent, TStateSchema, TTypestate, TResolvedTypesMeta] = js.native
    def transition(
      state: Unit,
      event: typingsJapgolly.xstate.libTypesMod.SCXML.Event[TEvent],
      context: TContext,
    ...
    def transition(state: StateValue, event: typingsJapgolly.xstate.libTypesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TTypestate, TResolvedTypesMeta] = js.native
    def transition(
      state: StateValue,
      event: typingsJapgolly.xstate.libTypesMod.SCXML.Event[TEvent],
      context: TContext
