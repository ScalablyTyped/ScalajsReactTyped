...
import typingsJapgolly.xstate.typesMod.DelayedTransitionDefinition
...
import typingsJapgolly.xstate.typesMod.StateNodeDefinition
import typingsJapgolly.xstate.typesMod.StateNodesConfig
import typingsJapgolly.xstate.typesMod.StateSchema
import typingsJapgolly.xstate.typesMod.StateValue
import typingsJapgolly.xstate.typesMod.StateValueMap
import typingsJapgolly.xstate.typesMod.TransitionDefinition
import typingsJapgolly.xstate.typesMod.TransitionDefinitionMap
...
object stateNodeMod extends js.Object {
  ...
  class StateNode[TContext, TStateSchema /* <: StateSchema[_] */, TEvent /* <: EventObject */, TTypestate /* <: Typestate[TContext] */] protected () extends js.Object {
    ...
    def transition(state: js.UndefOr[scala.Nothing], event: typingsJapgolly.xstate.typesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TTypestate] = js.native
    def transition(
    ...
    def transition(state: String, event: typingsJapgolly.xstate.typesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TTypestate] = js.native
    def transition(state: String, event: typingsJapgolly.xstate.typesMod.SCXML.Event[TEvent], context: TContext): State[TContext, TEvent, TStateSchema, TTypestate] = js.native
    ...
    def transition(state: State[TContext, TEvent, _, _], event: typingsJapgolly.xstate.typesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TTypestate] = js.native
    def transition(
    ...
    def transition(state: StateValueMap, event: typingsJapgolly.xstate.typesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TTypestate] = js.native
    def transition(
      state: StateValueMap,
      event: typingsJapgolly.xstate.typesMod.SCXML.Event[TEvent],
      context: TContext
