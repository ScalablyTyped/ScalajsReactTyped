...
import typingsJapgolly.xstate.AnonAutoForward
import typingsJapgolly.xstate.FnCallMachineOptions
import typingsJapgolly.xstate.PartialInterpreterOptions
import typingsJapgolly.xstate.ReadonlyInterpreterOption
...
import typingsJapgolly.xstate.typesMod.Observer
...
import typingsJapgolly.xstate.typesMod.Unsubscribable
...
class Interpreter[TContext, TStateSchema /* <: StateSchema[_] */, TEvent /* <: EventObject */, TTypestate /* <: Typestate[TContext] */] protected ()
  ...
  def nextState(event: typingsJapgolly.xstate.typesMod.SCXML.Event[TEvent]): State[TContext, TEvent, _, _] = js.native
  /**
    * Removes a listener.
  ...
  def send(event: typingsJapgolly.xstate.typesMod.SCXML.Event[TEvent]): State[TContext, TEvent, _, _] = js.native
  def send(event: typingsJapgolly.xstate.typesMod.SCXML.Event[TEvent], payload: EventData): State[TContext, TEvent, _, _] = js.native
  @JSName("send")
  def send_type(
