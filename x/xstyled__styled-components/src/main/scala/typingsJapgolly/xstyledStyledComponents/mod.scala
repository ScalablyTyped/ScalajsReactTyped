...
import typingsJapgolly.xstyledStyledComponents.anon.ABox
import typingsJapgolly.xstyledStyledComponents.anon.Target
import typingsJapgolly.xstyledSystem.anon.CssProperty
import typingsJapgolly.xstyledSystem.anon.TypeofReact
import typingsJapgolly.xstyledSystem.mod.AliasKey
import typingsJapgolly.xstyledSystem.mod.BreakPointsRules
import typingsJapgolly.xstyledSystem.mod.RPXTransformers_
import typingsJapgolly.xstyledSystem.mod.ResponsiveValue
import typingsJapgolly.xstyledSystem.mod.StyleFunc
import typingsJapgolly.xstyledSystem.mod.StyledSystemLength
import typingsJapgolly.xstyledSystem.mod.ThemeGetterFunc
import typingsJapgolly.xstyledSystem.mod.ThemeGetterValue
import typingsJapgolly.xstyledSystem.mod.VariantArgs
...
object mod {
  ...
  inline def getColorModeInitScriptElement(): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("getColorModeInitScriptElement")().asInstanceOf[Element]
  inline def getColorModeInitScriptElement(options: Target): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("getColorModeInitScriptElement")(options.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.xstyledStyledComponents.xstyledStyledComponentsStrings.xs
    - typingsJapgolly.xstyledStyledComponents.xstyledStyledComponentsStrings.sm
    - typingsJapgolly.xstyledStyledComponents.xstyledStyledComponentsStrings.md
    - typingsJapgolly.xstyledStyledComponents.xstyledStyledComponentsStrings.lg
    - typingsJapgolly.xstyledStyledComponents.xstyledStyledComponentsStrings.xl
  */
