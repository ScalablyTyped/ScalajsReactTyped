...
import typingsJapgolly.xmlbuilder.mod.^
...
/**
  ...
  */
inline def begin(): XMLDocument = ^.asInstanceOf[js.Dynamic].applyDynamic("begin")().asInstanceOf[XMLDocument]
...
inline def begin(options: BeginOptions): XMLDocument = ^.asInstanceOf[js.Dynamic].applyDynamic("begin")(options.asInstanceOf[js.Any]).asInstanceOf[XMLDocument]
...
/**
  ...
  */
inline def begin_XMLDocumentCB(): XMLDocumentCB = ^.asInstanceOf[js.Dynamic].applyDynamic("begin")().asInstanceOf[XMLDocumentCB]
inline def begin_XMLDocumentCB(options: BeginOptions): XMLDocumentCB = ^.asInstanceOf[js.Dynamic].applyDynamic("begin")(options.asInstanceOf[js.Any]).asInstanceOf[XMLDocumentCB]
