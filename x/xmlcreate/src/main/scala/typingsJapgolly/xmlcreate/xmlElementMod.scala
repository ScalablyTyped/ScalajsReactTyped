...
object xmlElementMod extends js.Object {
  ...
  trait XmlElement
    ...
    /**
      ...
      */
    def attribute(name: String, value: String): typingsJapgolly.xmlcreate.xmlAttributeMod.default = js.native
    def attribute(name: String, value: String, index: Double): typingsJapgolly.xmlcreate.xmlAttributeMod.default = js.native
    def attribute(name: String, value: js.Array[String | typingsJapgolly.xmlcreate.xmlNodeMod.default]): typingsJapgolly.xmlcreate.xmlAttributeMod.default = js.native
    def attribute(
      name: String,
      value: js.Array[String | typingsJapgolly.xmlcreate.xmlNodeMod.default],
      index: Double
    ): typingsJapgolly.xmlcreate.xmlAttributeMod.default = js.native
    def attribute(name: String, value: typingsJapgolly.xmlcreate.xmlNodeMod.default): typingsJapgolly.xmlcreate.xmlAttributeMod.default = js.native
    def attribute(name: String, value: typingsJapgolly.xmlcreate.xmlNodeMod.default, index: Double): typingsJapgolly.xmlcreate.xmlAttributeMod.default = js.native
    /**
      ...
      *          instances of {@link XmlAttribute}.
      */
    def attributes(): js.Array[typingsJapgolly.xmlcreate.xmlAttributeMod.default] = js.native
    /**
      ...
      */
    def cdata(content: String): typingsJapgolly.xmlcreate.xmlCdataMod.default = js.native
    def cdata(content: String, index: Double): typingsJapgolly.xmlcreate.xmlCdataMod.default = js.native
    /**
      ...
      */
    def charData(charData: String): typingsJapgolly.xmlcreate.xmlCharDataMod.default = js.native
    def charData(charData: String, index: Double): typingsJapgolly.xmlcreate.xmlCharDataMod.default = js.native
    /**
      ...
      */
    def charRef(char: String): typingsJapgolly.xmlcreate.xmlCharRefMod.default = js.native
    def charRef(char: String, hex: Boolean): typingsJapgolly.xmlcreate.xmlCharRefMod.default = js.native
    def charRef(char: String, hex: Boolean, index: Double): typingsJapgolly.xmlcreate.xmlCharRefMod.default = js.native
    /**
    ...
    /**
      ...
      */
    def entityRef(entity: String): typingsJapgolly.xmlcreate.xmlEntityRefMod.default = js.native
    def entityRef(entity: String, index: Double): typingsJapgolly.xmlcreate.xmlEntityRefMod.default = js.native
    /**
