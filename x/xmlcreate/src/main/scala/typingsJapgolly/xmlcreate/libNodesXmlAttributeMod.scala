...
object libNodesXmlAttributeMod {
  ...
  trait XmlAttribute[Parent] extends StObject {
    ...
    /**
      ...
      * character reference.
      */
    def charRef(options: IXmlCharRefOptions): typingsJapgolly.xmlcreate.libNodesXmlCharRefMod.default[this.type] = js.native
    
    /**
      * Adds an entity reference to this attribute and returns the new entity
      * reference.
      */
    def entityRef(options: IXmlEntityRefOptions): typingsJapgolly.xmlcreate.libNodesXmlEntityRefMod.default[this.type] = js.native
    ...
    /**
      ...
      */
    def text(options: IXmlAttributeTextOptions): typingsJapgolly.xmlcreate.libNodesXmlAttributeTextMod.default[this.type] = js.native
