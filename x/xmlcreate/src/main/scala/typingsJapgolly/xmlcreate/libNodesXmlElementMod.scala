...
object libNodesXmlElementMod {
  ...
  trait XmlElement[Parent] extends StObject {
    ...
    /**
      ...
      */
    def attribute(options: IXmlAttributeOptions): typingsJapgolly.xmlcreate.libNodesXmlAttributeMod.default[this.type] = js.native
    
    /**
      * Adds a CDATA section to this element and returns the new CDATA section.
      */
    def cdata(options: IXmlCdataOptions): typingsJapgolly.xmlcreate.libNodesXmlCdataMod.default[this.type] = js.native
    
    /**
      * Adds character data to this element and returns the new character data.
      */
    def charData(options: IXmlCharDataOptions): typingsJapgolly.xmlcreate.libNodesXmlCharDataMod.default[this.type] = js.native
