...
object xmlAttributeMod extends js.Object {
  ...
  trait XmlAttribute
    ...
    /**
      ...
      * @returns The newly created XML declaration.
      */
    def text(text: String): typingsJapgolly.xmlcreate.xmlAttributeTextMod.default = js.native
    def text(text: String, index: Double): typingsJapgolly.xmlcreate.xmlAttributeTextMod.default = js.native
  }
