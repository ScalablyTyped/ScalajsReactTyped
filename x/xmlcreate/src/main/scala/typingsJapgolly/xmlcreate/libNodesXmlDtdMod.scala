...
object libNodesXmlDtdMod {
  ...
  trait XmlDtd[Parent] extends StObject {
    ...
    /**
      ...
      */
    def attlist(options: IXmlDtdAttlistOptions): typingsJapgolly.xmlcreate.libNodesXmlDtdAttlistMod.default[this.type] = js.native
    ...
    /**
      ...
      */
    def element(options: IXmlDtdElementOptions): typingsJapgolly.xmlcreate.libNodesXmlDtdElementMod.default[this.type] = js.native
    
    /**
      * Adds an entity declaration to this document type declaration
      * and returns the new entity declaration.
      */
    def entity(options: IXmlDtdEntityOptions): typingsJapgolly.xmlcreate.libNodesXmlDtdEntityMod.default[this.type] = js.native
    ...
    /**
      ...
      */
    def notation(options: IXmlDtdNotationOptions): typingsJapgolly.xmlcreate.libNodesXmlDtdNotationMod.default[this.type] = js.native
    
    /**
      * Adds a parameter entity reference to this document type declaration
      * and returns the new parameter entity reference.
      */
    def paramEntityRef(options: IXmlDtdParamEntityRefOptions): typingsJapgolly.xmlcreate.libNodesXmlDtdParamEntityRefMod.default[this.type] = js.native
