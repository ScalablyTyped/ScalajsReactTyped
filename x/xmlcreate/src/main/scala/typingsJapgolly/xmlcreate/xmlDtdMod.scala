...
object xmlDtdMod extends js.Object {
  ...
  trait XmlDtd
    ...
    /**
      ...
      */
    def attlist(text: String): typingsJapgolly.xmlcreate.xmlDtdAttlistMod.default = js.native
    def attlist(text: String, index: Double): typingsJapgolly.xmlcreate.xmlDtdAttlistMod.default = js.native
    /**
    ...
    /**
      ...
      */
    def element(text: String): typingsJapgolly.xmlcreate.xmlDtdElementMod.default = js.native
    def element(text: String, index: Double): typingsJapgolly.xmlcreate.xmlDtdElementMod.default = js.native
    /**
      ...
      */
    def entity(text: String): typingsJapgolly.xmlcreate.xmlDtdEntityMod.default = js.native
    def entity(text: String, index: Double): typingsJapgolly.xmlcreate.xmlDtdEntityMod.default = js.native
    /**
    ...
    /**
      ...
      */
    def notation(text: String): typingsJapgolly.xmlcreate.xmlDtdNotationMod.default = js.native
    def notation(text: String, index: Double): typingsJapgolly.xmlcreate.xmlDtdNotationMod.default = js.native
    /**
      ...
      */
    def paramEntityRef(entity: String): typingsJapgolly.xmlcreate.xmlDtdParamEntityRefMod.default = js.native
    def paramEntityRef(entity: String, index: Double): typingsJapgolly.xmlcreate.xmlDtdParamEntityRefMod.default = js.native
    /**
