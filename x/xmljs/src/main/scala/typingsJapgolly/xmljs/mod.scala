...
object mod {
  ...
  object Node {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getAttribute = js.Any.fromFunction2(getAttribute), path = js.Any.fromFunction2(path), visit = js.Any.fromFunction1((t0: js.Function1[Node, Unit]) => visit(t0).runNow()))
    ...
    extension [Self <: Node](x: Self) {
      ...
      inline def setVisit(value: js.Function1[Node, Unit] => Callback): Self = StObject.set(x, "visit", js.Any.fromFunction1((t0: js.Function1[Node, Unit]) => value(t0).runNow()))
    }
  }
