...
import typingsJapgolly.xmlCore.anon.XmlAttributeTypeanytypest
import typingsJapgolly.xmlCore.anon.XmlChildElementTypeanytyp
...
object distTypesTypesMod {
  ...
  object ICollection {
    ...
    inline def apply[I](
      ...
      val __obj = js.Dynamic.literal(Add = js.Any.fromFunction1((t0: I) => Add(t0).runNow()), Clear = Clear.toJsFn, Count = Count.asInstanceOf[js.Any], Every = js.Any.fromFunction1(Every), Filter = js.Any.fromFunction1(Filter), ForEach = js.Any.fromFunction1((t0: js.Function3[/* item */ I, /* index */ Double, /* array */ js.Array[I], Unit]) => ForEach(t0).runNow()), GetIterator = GetIterator.toJsFn, IsEmpty = IsEmpty.toJsFn, Item = js.Any.fromFunction1(Item), Map = js.Any.fromFunction1(Map), Pop = Pop.toJsFn, RemoveAt = js.Any.fromFunction1((t0: Double) => RemoveAt(t0).runNow()), Some = js.Any.fromFunction1(Some), Sort = js.Any.fromFunction1(Sort))
      __obj.asInstanceOf[ICollection[I]]
    }
    
    extension [Self <: ICollection[?], I](x: Self & ICollection[I]) {
      
      inline def setAdd(value: I => Callback): Self = StObject.set(x, "Add", js.Any.fromFunction1((t0: I) => value(t0).runNow()))
      ...
      inline def setForEach(value: js.Function3[/* item */ I, /* index */ Double, /* array */ js.Array[I], Unit] => Callback): Self = StObject.set(x, "ForEach", js.Any.fromFunction1((t0: js.Function3[/* item */ I, /* index */ Double, /* array */ js.Array[I], Unit]) => value(t0).runNow()))
      
      inline def setGetIterator(value: CallbackTo[js.Array[I]]): Self = StObject.set(x, "GetIterator", value.toJsFn)
      ...
      inline def setPop(value: CallbackTo[js.UndefOr[I]]): Self = StObject.set(x, "Pop", value.toJsFn)
