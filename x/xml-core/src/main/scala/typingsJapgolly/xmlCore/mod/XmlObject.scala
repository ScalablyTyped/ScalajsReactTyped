...
object XmlObject extends js.Object {
  ...
  def GetElementById(element: typingsJapgolly.std.Element, idValue: String): Element | Null = js.native
  ...
  def LoadXml[T /* <: XmlObject */](param: typingsJapgolly.std.Element): T = js.native
}
