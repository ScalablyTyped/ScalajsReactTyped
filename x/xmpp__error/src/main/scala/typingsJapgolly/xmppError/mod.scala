package typingsJapgolly.xmppError

import typingsJapgolly.std.Error
import typingsJapgolly.xmppXml.mod.Element
...
object mod {
  ...
  /* static member */
  inline def fromElement(element: Element): XMPPError[typingsJapgolly.xmppError.xmppErrorStrings.XMPPError] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromElement")(element.asInstanceOf[js.Any]).asInstanceOf[XMPPError[typingsJapgolly.xmppError.xmppErrorStrings.XMPPError]]
