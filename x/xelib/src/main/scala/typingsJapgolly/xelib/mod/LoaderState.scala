...
object LoaderState extends StObject {
  ...
  sealed trait IsActive
    extends StObject
       with LoaderState
  /* 1 */ val IsActive: typingsJapgolly.xelib.mod.LoaderState.IsActive & Double = js.native
  ...
  sealed trait IsDone
    extends StObject
       with LoaderState
  /* 2 */ val IsDone: typingsJapgolly.xelib.mod.LoaderState.IsDone & Double = js.native
  ...
  sealed trait IsError
    extends StObject
       with LoaderState
  /* 3 */ val IsError: typingsJapgolly.xelib.mod.LoaderState.IsError & Double = js.native
  ...
  sealed trait IsInactive
    extends StObject
       with LoaderState
  /* 0 */ val IsInactive: typingsJapgolly.xelib.mod.LoaderState.IsInactive & Double = js.native
}
