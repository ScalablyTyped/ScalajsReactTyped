...
import typingsJapgolly.xelib.anon.Data
import typingsJapgolly.xelib.xelibBooleans.`false`
import typingsJapgolly.xelib.xelibBooleans.`true`
...
trait XELib extends StObject {
  ...
  /**
    ...
    */
  def DefType(id: ElementHandle): typingsJapgolly.xelib.mod.DefType = js.native
  ...
  /**
    ...
    */
  def ElementType(id: ElementHandle): typingsJapgolly.xelib.mod.ElementType = js.native
  ...
  /**
    ...
    */
  def SmashType(id: ElementHandle): typingsJapgolly.xelib.mod.SmashType = js.native
  ...
  /**
    ...
    */
  def ValueType(id: ElementHandle): typingsJapgolly.xelib.mod.ValueType = js.native
