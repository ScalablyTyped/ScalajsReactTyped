...
object SortMode extends StObject {
  ...
  sealed trait EditorID
    extends StObject
       with SortMode
  /* 2 */ val EditorID: typingsJapgolly.xelib.mod.SortMode.EditorID & Double = js.native
  ...
  sealed trait FormID
    extends StObject
       with SortMode
  /* 1 */ val FormID: typingsJapgolly.xelib.mod.SortMode.FormID & Double = js.native
  ...
  sealed trait Name
    extends StObject
       with SortMode
  /* 3 */ val Name: typingsJapgolly.xelib.mod.SortMode.Name & Double = js.native
  ...
  sealed trait None
    extends StObject
       with SortMode
  /* 0 */ val None: typingsJapgolly.xelib.mod.SortMode.None & Double = js.native
}
