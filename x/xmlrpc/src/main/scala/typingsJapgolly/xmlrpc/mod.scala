package typingsJapgolly.xmlrpc
...
import typingsJapgolly.xmlrpc.anon.Expires
import typingsJapgolly.xmlrpc.anon.Pass
import typingsJapgolly.xmlrpc.anon.Processors
...
object mod {
  ...
  object Client {
    ...
    inline def apply(
      ...
      isSecure: Boolean,
      methodCall: (String, js.Array[Any], js.Function2[/* error */ js.Object, /* value */ Any, Unit]) => Callback,
      options: ClientOptions,
      setCookie: (String, String) => Client
    ): Client = {
      val __obj = js.Dynamic.literal(getCookie = js.Any.fromFunction1(getCookie), headersProcessors = headersProcessors.asInstanceOf[js.Any], isSecure = isSecure.asInstanceOf[js.Any], methodCall = js.Any.fromFunction3((t0: String, t1: js.Array[Any], t2: js.Function2[/* error */ js.Object, /* value */ Any, Unit]) => (methodCall(t0, t1, t2)).runNow()), options = options.asInstanceOf[js.Any], setCookie = js.Any.fromFunction2(setCookie))
    ...
    extension [Self <: Client](x: Self) {
      ...
      inline def setMethodCall(
        value: (String, js.Array[Any], js.Function2[/* error */ js.Object, /* value */ Any, Unit]) => Callback
      ): Self = StObject.set(x, "methodCall", js.Any.fromFunction3((t0: String, t1: js.Array[Any], t2: js.Function2[/* error */ js.Object, /* value */ Any, Unit]) => (value(t0, t1, t2)).runNow()))
  ...
  object HeadersProcessor {
    ...
    inline def apply(composeRequest: Headers => Callback, parseResponse: Headers => Callback): HeadersProcessor = {
      val __obj = js.Dynamic.literal(composeRequest = js.Any.fromFunction1((t0: Headers) => composeRequest(t0).runNow()), parseResponse = js.Any.fromFunction1((t0: Headers) => parseResponse(t0).runNow()))
      __obj.asInstanceOf[HeadersProcessor]
    }
    
    extension [Self <: HeadersProcessor](x: Self) {
      
      inline def setComposeRequest(value: Headers => Callback): Self = StObject.set(x, "composeRequest", js.Any.fromFunction1((t0: Headers) => value(t0).runNow()))
      
      inline def setParseResponse(value: Headers => Callback): Self = StObject.set(x, "parseResponse", js.Any.fromFunction1((t0: Headers) => value(t0).runNow()))
    }
  }
  ...
  trait Server extends EventEmitter {
    ...
    var httpServer: (typingsJapgolly.node.httpMod.Server[
