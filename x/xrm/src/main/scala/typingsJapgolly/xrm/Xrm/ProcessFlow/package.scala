...
package object ProcessFlow {
  /**
    ...
    * * StatusCodeName
    */
  type GetProcessInstancesDelegate = js.Function1[/* object */ typingsJapgolly.xrm.Xrm.ProcessFlow.ProcessDictionary, scala.Unit]
  /**
  ...
  /**
    ...
    */
  type ProcessSetStatusDelegate = js.Function1[/* status */ typingsJapgolly.xrm.Xrm.ProcessFlow.ProcessStatus, scala.Unit]
  /**
