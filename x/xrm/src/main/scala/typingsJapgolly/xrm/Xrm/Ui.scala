...
import typingsJapgolly.xrm.Xrm.Controls.FooterSection
import typingsJapgolly.xrm.Xrm.Controls.FormSelector
import typingsJapgolly.xrm.Xrm.Controls.HeaderSection
import typingsJapgolly.xrm.Xrm.Controls.ProcessControl
import typingsJapgolly.xrm.Xrm.Controls.QuickFormControl
import typingsJapgolly.xrm.Xrm.Controls.Tab
import typingsJapgolly.xrm.Xrm.Events.LoadEventHandler
import typingsJapgolly.xrm.Xrm.Events.LoadEventHandlerAsync
import typingsJapgolly.xrm.XrmEnum.FormType
...
trait Ui extends StObject {
  ...
  /**
    ...
    * @remarks This API does not exist with Microsoft Dynamics CRM for tablets.
    */
  var navigation: typingsJapgolly.xrm.Xrm.Controls.Navigation = js.native
