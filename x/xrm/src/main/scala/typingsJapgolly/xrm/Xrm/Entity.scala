...
import typingsJapgolly.xrm.Xrm.Events.PostSaveEventHandler
import typingsJapgolly.xrm.Xrm.Events.SaveEventHandler
import typingsJapgolly.xrm.Xrm.Events.SaveEventHandlerAsync
