...
import typingsJapgolly.xrm.Xrm.Events.KbSearchControl.PostSearchEventHandler
import typingsJapgolly.xrm.Xrm.Events.KbSearchControl.ResultOpenedEventHandler
import typingsJapgolly.xrm.Xrm.Events.KbSearchControl.SelectionEventHandler
