...
object Url {
  ...
  */
  ...
  object CmdBarDisplay {
    ...
    inline def `false`: typingsJapgolly.xrm.xrmStrings.`false` = "false".asInstanceOf[typingsJapgolly.xrm.xrmStrings.`false`]
    
    inline def `true`: typingsJapgolly.xrm.xrmStrings.`true` = "true".asInstanceOf[typingsJapgolly.xrm.xrmStrings.`true`]
  }
  ...
  */
  ...
  object NavBarDisplay {
    ...
    inline def entity: typingsJapgolly.xrm.xrmStrings.entity = "entity".asInstanceOf[typingsJapgolly.xrm.xrmStrings.entity]
    
    inline def off: typingsJapgolly.xrm.xrmStrings.off = "off".asInstanceOf[typingsJapgolly.xrm.xrmStrings.off]
    
    inline def on: typingsJapgolly.xrm.xrmStrings.on = "on".asInstanceOf[typingsJapgolly.xrm.xrmStrings.on]
  }
  ...
  */
  ...
  object ReportAction {
    ...
    inline def filter: typingsJapgolly.xrm.xrmStrings.filter = "filter".asInstanceOf[typingsJapgolly.xrm.xrmStrings.filter]
    
    inline def run: typingsJapgolly.xrm.xrmStrings.run = "run".asInstanceOf[typingsJapgolly.xrm.xrmStrings.run]
  }
