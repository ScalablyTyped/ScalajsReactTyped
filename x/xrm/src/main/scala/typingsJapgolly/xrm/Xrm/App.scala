...
import typingsJapgolly.xrm.Xrm.App.Notifcation
import typingsJapgolly.xrm.Xrm.Async.PromiseLike
import typingsJapgolly.xrm.Xrm.Navigation.CustomPage
import typingsJapgolly.xrm.Xrm.Navigation.Dashboard
import typingsJapgolly.xrm.Xrm.Navigation.NavigationOptions
import typingsJapgolly.xrm.Xrm.Navigation.PageInputEntityList
import typingsJapgolly.xrm.Xrm.Navigation.PageInputEntityRecord
import typingsJapgolly.xrm.Xrm.Navigation.PageInputHtmlWebResource
import typingsJapgolly.xrm.anon.CreatePane
...
object App {
  ...
  object Action {
    ...
    extension [Self <: Action](x: Self) {
      ...
      inline def setEventHandler(value: Callback): Self = StObject.set(x, "eventHandler", value.toJsFn)
