...
trait Utility extends StObject {
  ...
  /**
    ...
    */
  def getEntityMetadata(entityName: String): typingsJapgolly.xrm.Xrm.Async.PromiseLike[EntityMetadata] = js.native
  def getEntityMetadata(entityName: String, attributes: js.Array[String]): typingsJapgolly.xrm.Xrm.Async.PromiseLike[EntityMetadata] = js.native
  ...
  /**
    ...
    */
  def invokeProcessAction(name: String, parameters: Dictionary[Any]): typingsJapgolly.xrm.Xrm.Async.PromiseLike[Any] = js.native
  ...
  /**
    ...
    */
  def lookupObjects(lookupOptions: LookupOptions): typingsJapgolly.xrm.Xrm.Async.PromiseLike[js.Array[LookupValue]] = js.native
  ...
  /**
    ...
    */
  def openQuickCreate(entityLogicalName: String): typingsJapgolly.xrm.Xrm.Async.PromiseLike[OpenQuickCreateSuccessCallbackObject] = js.native
  def openQuickCreate(entityLogicalName: String, createFromEntity: Unit, parameters: OpenParameters): typingsJapgolly.xrm.Xrm.Async.PromiseLike[OpenQuickCreateSuccessCallbackObject] = js.native
  def openQuickCreate(entityLogicalName: String, createFromEntity: LookupValue): typingsJapgolly.xrm.Xrm.Async.PromiseLike[OpenQuickCreateSuccessCallbackObject] = js.native
  def openQuickCreate(entityLogicalName: String, createFromEntity: LookupValue, parameters: OpenParameters): typingsJapgolly.xrm.Xrm.Async.PromiseLike[OpenQuickCreateSuccessCallbackObject] = js.native
