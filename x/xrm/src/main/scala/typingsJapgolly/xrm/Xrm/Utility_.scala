...
import typingsJapgolly.xrm.Xrm.Async.OpenQuickCreateSuccessCallbackObject
import typingsJapgolly.xrm.Xrm.Async.PromiseLike
import typingsJapgolly.xrm.Xrm.Collection.Dictionary
import typingsJapgolly.xrm.Xrm.Metadata.EntityMetadata
import typingsJapgolly.xrm.Xrm.Utility.FormOpenParameters
import typingsJapgolly.xrm.Xrm.Utility.OpenParameters
import typingsJapgolly.xrm.Xrm.Utility.WindowOptions
