...
import typingsJapgolly.xrm.Xrm.Device.CaptureFileResponse
import typingsJapgolly.xrm.Xrm.Device.CaptureImageOptions
import typingsJapgolly.xrm.Xrm.Device.GetCurrentPositionResponse
import typingsJapgolly.xrm.Xrm.Device.PickFileOptions
...
object Device {
  ...
  */
  ...
  object PickFileTypes {
    ...
    inline def audio: typingsJapgolly.xrm.xrmStrings.audio = "audio".asInstanceOf[typingsJapgolly.xrm.xrmStrings.audio]
    
    inline def image: typingsJapgolly.xrm.xrmStrings.image = "image".asInstanceOf[typingsJapgolly.xrm.xrmStrings.image]
    
    inline def video: typingsJapgolly.xrm.xrmStrings.video = "video".asInstanceOf[typingsJapgolly.xrm.xrmStrings.video]
  }
}
