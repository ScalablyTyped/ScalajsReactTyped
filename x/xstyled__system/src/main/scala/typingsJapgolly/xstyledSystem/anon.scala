...
object anon {
  ...
  trait TypeofReact extends StObject {
    ...
    def createElement[P /* <: HTMLAttributes[T] */, T /* <: HTMLElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 116, starting with typingsJapgolly.xstyledSystem.xstyledSystemStrings.a, typingsJapgolly.xstyledSystem.xstyledSystemStrings.abbr, typingsJapgolly.xstyledSystem.xstyledSystemStrings.address */ Any,
    ...
    def createElement_PT_ReactSVGElement[P /* <: SVGAttributes[T] */, T /* <: SVGElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 55, starting with typingsJapgolly.xstyledSystem.xstyledSystemStrings.animate, typingsJapgolly.xstyledSystem.xstyledSystemStrings.circle, typingsJapgolly.xstyledSystem.xstyledSystemStrings.clipPath */ Any,
      props: ClassAttributes[T] & P,
      children: Node*
