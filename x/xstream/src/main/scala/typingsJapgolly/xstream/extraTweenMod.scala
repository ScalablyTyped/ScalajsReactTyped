...
object extraTweenMod extends Shortcut {
  ...
  trait TweenFactory extends StObject {
    ...
    var linear: typingsJapgolly.xstream.anon.Ease = js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `extraTweenMod.foo` */
