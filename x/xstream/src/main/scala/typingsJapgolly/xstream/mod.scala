...
import typingsJapgolly.xstream.anon.Subscribe
...
object mod {
  ...
  object Aggregator {
    ...
    inline def apply[T, U](
      ...
      val __obj = js.Dynamic.literal(_start = js.Any.fromFunction1((t0: Stream[U]) => _start(t0).runNow()), _stop = _stop.toJsFn, insArr = insArr.asInstanceOf[js.Any], out = out.asInstanceOf[js.Any])
    ...
    extension [Self <: Aggregator[?, ?], T, U](x: Self & (Aggregator[T, U])) {
      ...
      inline def set_start(value: Stream[U] => Callback): Self = StObject.set(x, "_start", js.Any.fromFunction1((t0: Stream[U]) => value(t0).runNow()))
    }
  }
  ...
  object InternalListener {
    ...
    inline def apply[T](_c: Callback, _e: Any => Callback, _n: T => Callback): InternalListener[T] = {
      val __obj = js.Dynamic.literal(_c = _c.toJsFn, _e = js.Any.fromFunction1((t0: Any) => _e(t0).runNow()), _n = js.Any.fromFunction1((t0: T) => _n(t0).runNow()))
      __obj.asInstanceOf[InternalListener[T]]
    }
    
    extension [Self <: InternalListener[?], T](x: Self & InternalListener[T]) {
      
      inline def set_c(value: Callback): Self = StObject.set(x, "_c", value.toJsFn)
      
      inline def set_e(value: Any => Callback): Self = StObject.set(x, "_e", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      
      inline def set_n(value: T => Callback): Self = StObject.set(x, "_n", js.Any.fromFunction1((t0: T) => value(t0).runNow()))
    }
  }
  ...
  object InternalProducer {
    ...
    inline def apply[T](_start: InternalListener[T] => Callback, _stop: Callback): InternalProducer[T] = {
      val __obj = js.Dynamic.literal(_start = js.Any.fromFunction1((t0: InternalListener[T]) => _start(t0).runNow()), _stop = _stop.toJsFn)
      __obj.asInstanceOf[InternalProducer[T]]
    }
    
    extension [Self <: InternalProducer[?], T](x: Self & InternalProducer[T]) {
      
      inline def set_start(value: InternalListener[T] => Callback): Self = StObject.set(x, "_start", js.Any.fromFunction1((t0: InternalListener[T]) => value(t0).runNow()))
      
      inline def set_stop(value: Callback): Self = StObject.set(x, "_stop", value.toJsFn)
    }
  }
  ...
  object Listener {
    ...
    inline def apply[T](complete: Callback, error: Any => Callback, next: T => Callback): Listener[T] = {
  ...
  object Operator {
    ...
    inline def apply[T, R](
      ...
      val __obj = js.Dynamic.literal(_c = _c.toJsFn, _e = js.Any.fromFunction1((t0: Any) => _e(t0).runNow()), _n = js.Any.fromFunction1((t0: T) => _n(t0).runNow()), _start = js.Any.fromFunction1((t0: Stream[R]) => _start(t0).runNow()), _stop = _stop.toJsFn, ins = ins.asInstanceOf[js.Any], out = out.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    ...
    extension [Self <: Operator[?, ?], T, R](x: Self & (Operator[T, R])) {
      ...
      inline def set_start(value: Stream[R] => Callback): Self = StObject.set(x, "_start", js.Any.fromFunction1((t0: Stream[R]) => value(t0).runNow()))
    }
  }
  ...
  object Producer {
    ...
    inline def apply[T](start: Listener[T] => Callback, stop: Callback): Producer[T] = {
      val __obj = js.Dynamic.literal(start = js.Any.fromFunction1((t0: Listener[T]) => start(t0).runNow()), stop = stop.toJsFn)
      __obj.asInstanceOf[Producer[T]]
    }
    
    extension [Self <: Producer[?], T](x: Self & Producer[T]) {
      
      inline def setStart(value: Listener[T] => Callback): Self = StObject.set(x, "start", js.Any.fromFunction1((t0: Listener[T]) => value(t0).runNow()))
