...
object mod {
  ...
  open class XmlCDataNode protected ()
    ...
    var `type`: typingsJapgolly.xmldoc.xmldocStrings.cdata = js.native
  }
  ...
  open class XmlCommentNode protected ()
    ...
    var `type`: typingsJapgolly.xmldoc.xmldocStrings.comment = js.native
  }
  ...
  open class XmlTextNode protected ()
    ...
    var `type`: typingsJapgolly.xmldoc.xmldocStrings.text = js.native
  }
  
  type XmlAttributes = StringDictionary[String]
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.xmldoc.mod.XmlElement
    - typingsJapgolly.xmldoc.mod.XmlTextNode
    - typingsJapgolly.xmldoc.mod.XmlCDataNode
    - typingsJapgolly.xmldoc.mod.XmlCommentNode
  */
