package typingsJapgolly.xadesjs.buildTypesSrcMod.xml

import typingsJapgolly.xadesjs.anon.Encoding
...
object XmlXades {
  ...
  @js.native
  def ElementNames: typingsJapgolly.xadesjs.anon.AllDataObjectsTimeStamp = js.native
  inline def ElementNames_=(x: typingsJapgolly.xadesjs.anon.AllDataObjectsTimeStamp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ElementNames")(x.asInstanceOf[js.Any])
