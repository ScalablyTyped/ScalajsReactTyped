...
import typingsJapgolly.xadesjs.buildTypesSrcXmlMod.QualifyingProperties
...
object buildTypesSrcSignedXmlMod {
  ...
  open class SignedXml ()
    ...
    def SignedProperties: typingsJapgolly.xadesjs.buildTypesSrcXmlMod.SignedProperties = js.native
    
    def UnsignedProperties: typingsJapgolly.xadesjs.buildTypesSrcXmlMod.UnsignedProperties = js.native
