...
object buildTypesXmlQualifyingPropertiesMod {
  ...
  open class QualifyingProperties () extends XadesObject {
    ...
    var SignedProperties: typingsJapgolly.xadesjs.buildTypesXmlSignedPropertiesMod.SignedProperties = js.native
    
    var Target: String = js.native
    
    var UnsignedProperties: typingsJapgolly.xadesjs.buildTypesXmlUnsignedPropertiesMod.UnsignedProperties = js.native
  }
}
