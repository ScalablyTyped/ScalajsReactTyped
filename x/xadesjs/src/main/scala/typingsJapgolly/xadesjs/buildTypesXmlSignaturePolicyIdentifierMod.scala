...
import typingsJapgolly.xadesjs.buildTypesXmlAnyMod.AnyCollection
...
object buildTypesXmlSignaturePolicyIdentifierMod {
  ...
  open class SignaturePolicyId () extends XadesObject {
    ...
    var SigPolicyHash: typingsJapgolly.xadesjs.buildTypesXmlSignaturePolicyIdentifierMod.SigPolicyHash = js.native
    
    var SigPolicyId: typingsJapgolly.xadesjs.buildTypesXmlSignaturePolicyIdentifierMod.SigPolicyId = js.native
    
    var SigPolicyQualifiers: typingsJapgolly.xadesjs.buildTypesXmlSignaturePolicyIdentifierMod.SigPolicyQualifiers = js.native
  ...
  open class SignaturePolicyIdentifier () extends XadesObject {
    ...
    var SignaturePolicyId: typingsJapgolly.xadesjs.buildTypesXmlSignaturePolicyIdentifierMod.SignaturePolicyId = js.native
