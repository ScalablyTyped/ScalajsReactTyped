package typingsJapgolly.xml2js
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setEmptyTagCallbackTo(value: CallbackTo[Any]): Self = StObject.set(x, "emptyTag", value.toJsFn)
  ...
  - typingsJapgolly.xml2js.mod.BuilderOptions because var conflicts: attrkey, charkey. Inlined rootName, renderOpts, xmldec, doctype, headless, allowSurrogateChars, cdata */ trait OptionsV2
    extends StObject
       with ParserOptions {
