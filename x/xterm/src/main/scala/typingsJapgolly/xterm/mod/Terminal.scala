...
import typingsJapgolly.xterm.AnonCols
import typingsJapgolly.xterm.AnonDomEvent
import typingsJapgolly.xterm.AnonEnd
import typingsJapgolly.xterm.xtermStrings.`100`
import typingsJapgolly.xterm.xtermStrings.`200`
import typingsJapgolly.xterm.xtermStrings.`300`
import typingsJapgolly.xterm.xtermStrings.`400`
import typingsJapgolly.xterm.xtermStrings.`500`
import typingsJapgolly.xterm.xtermStrings.`600`
import typingsJapgolly.xterm.xtermStrings.`700`
import typingsJapgolly.xterm.xtermStrings.`800`
import typingsJapgolly.xterm.xtermStrings.`900`
import typingsJapgolly.xterm.xtermStrings.allowTransparency
import typingsJapgolly.xterm.xtermStrings.bar
import typingsJapgolly.xterm.xtermStrings.bellSound
import typingsJapgolly.xterm.xtermStrings.bellStyle
import typingsJapgolly.xterm.xtermStrings.block
import typingsJapgolly.xterm.xtermStrings.bold
import typingsJapgolly.xterm.xtermStrings.both
import typingsJapgolly.xterm.xtermStrings.cancelEvents
import typingsJapgolly.xterm.xtermStrings.convertEol
import typingsJapgolly.xterm.xtermStrings.cursorBlink
import typingsJapgolly.xterm.xtermStrings.cursorStyle
import typingsJapgolly.xterm.xtermStrings.disableStdin
import typingsJapgolly.xterm.xtermStrings.fontFamily
import typingsJapgolly.xterm.xtermStrings.fontSize
import typingsJapgolly.xterm.xtermStrings.fontWeight
import typingsJapgolly.xterm.xtermStrings.fontWeightBold
import typingsJapgolly.xterm.xtermStrings.letterSpacing
import typingsJapgolly.xterm.xtermStrings.lineHeight
import typingsJapgolly.xterm.xtermStrings.logLevel
import typingsJapgolly.xterm.xtermStrings.macOptionIsMeta
import typingsJapgolly.xterm.xtermStrings.none
import typingsJapgolly.xterm.xtermStrings.normal
import typingsJapgolly.xterm.xtermStrings.popOnBell
import typingsJapgolly.xterm.xtermStrings.rendererType
import typingsJapgolly.xterm.xtermStrings.rightClickSelectsWord
import typingsJapgolly.xterm.xtermStrings.scrollback
import typingsJapgolly.xterm.xtermStrings.sound
import typingsJapgolly.xterm.xtermStrings.tabStopWidth
import typingsJapgolly.xterm.xtermStrings.termName
import typingsJapgolly.xterm.xtermStrings.theme
import typingsJapgolly.xterm.xtermStrings.underline
import typingsJapgolly.xterm.xtermStrings.visual
import typingsJapgolly.xterm.xtermStrings.visualBell
import typingsJapgolly.xterm.xtermStrings.windowsMode
import typingsJapgolly.xterm.xtermStrings.wordSeparator
...
class Terminal () extends IDisposable {
  ...
  /**
    ...
    */
  @JSName("getOption")
  def getOption_cols(key: typingsJapgolly.xterm.xtermStrings.cols): Double = js.native
  @JSName("getOption")
  ...
  @JSName("getOption")
  def getOption_rows(key: typingsJapgolly.xterm.xtermStrings.rows): Double = js.native
  @JSName("getOption")
  ...
  /**
    ...
    */
  @JSName("setOption")
  def setOption_cols(key: typingsJapgolly.xterm.xtermStrings.cols, value: Double): Unit = js.native
  /**
    * Sets an option on the terminal.
    * @param key The option key.
    * @param value The option value.
  ...
  @JSName("setOption")
  def setOption_rows(key: typingsJapgolly.xterm.xtermStrings.rows, value: Double): Unit = js.native
  @JSName("setOption")
