...
object IBuffer {
  ...
  def apply(
    ...
    cursorX: Double,
    cursorY: Double,
    getLine: Double => CallbackTo[js.UndefOr[IBufferLine]],
    getNullCell: CallbackTo[IBufferCell],
    length: Double,
    viewportY: Double
  ): IBuffer = {
    val __obj = js.Dynamic.literal(baseY = baseY.asInstanceOf[js.Any], cursorX = cursorX.asInstanceOf[js.Any], cursorY = cursorY.asInstanceOf[js.Any], length = length.asInstanceOf[js.Any], viewportY = viewportY.asInstanceOf[js.Any])
    __obj.updateDynamic("getLine")(js.Any.fromFunction1((t0: scala.Double) => getLine(t0).runNow()))
    __obj.updateDynamic("getNullCell")(getNullCell.toJsFn)
