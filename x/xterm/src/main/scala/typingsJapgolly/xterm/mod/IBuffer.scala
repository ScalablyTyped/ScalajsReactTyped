...
import typingsJapgolly.xterm.xtermStrings.alternate
...
object IBuffer {
  ...
  inline def apply(
    ...
    getNullCell: CallbackTo[IBufferCell],
    length: Double,
    `type`: normal | alternate,
    viewportY: Double
  ): IBuffer = {
    val __obj = js.Dynamic.literal(baseY = baseY.asInstanceOf[js.Any], cursorX = cursorX.asInstanceOf[js.Any], cursorY = cursorY.asInstanceOf[js.Any], getLine = js.Any.fromFunction1(getLine), getNullCell = getNullCell.toJsFn, length = length.asInstanceOf[js.Any], viewportY = viewportY.asInstanceOf[js.Any])
  ...
  extension [Self <: IBuffer](x: Self) {
    ...
    inline def setGetNullCell(value: CallbackTo[IBufferCell]): Self = StObject.set(x, "getNullCell", value.toJsFn)
