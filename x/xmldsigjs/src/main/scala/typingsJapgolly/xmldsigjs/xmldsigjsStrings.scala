...
import typingsJapgolly.xmldsigjs.ecdsaKeyMod._NamedCurveType
import typingsJapgolly.xmldsigjs.signedXmlMod.OptionsSignTransform
import typingsJapgolly.xmldsigjs.x509Mod._DigestAlgorithm
