...
import typingsJapgolly.xmldsigjs.buildTypesPkiX509Mod._DigestAlgorithm
import typingsJapgolly.xmldsigjs.buildTypesSignedXmlMod.OptionsSignTransform
import typingsJapgolly.xmldsigjs.buildTypesXmlKeyInfosEcdsaKeyMod._NamedCurveType
