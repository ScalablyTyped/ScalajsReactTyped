...
import typingsJapgolly.xmlCore.mod.AssocArray
import typingsJapgolly.xmlCore.mod.IXmlSerializable
import typingsJapgolly.xmlCore.mod.XmlObject
import typingsJapgolly.xmldsigjs.xmlMod.Reference
import typingsJapgolly.xmldsigjs.xmlMod.Signature
import typingsJapgolly.xmldsigjs.xmlMod.Transform
import typingsJapgolly.xmldsigjs.xmlMod.Transforms
...
class SignedXml () extends IXmlSerializable {
  ...
  def Sign(algorithm: typingsJapgolly.std.Algorithm, key: CryptoKey, data: Document_): js.Promise[Signature] = js.native
  def Sign(algorithm: typingsJapgolly.std.Algorithm, key: CryptoKey, data: Document_, options: OptionsSign): js.Promise[Signature] = js.native
  def Sign(algorithm: typingsJapgolly.std.EcdsaParams, key: CryptoKey, data: Document_): js.Promise[Signature] = js.native
  def Sign(algorithm: typingsJapgolly.std.EcdsaParams, key: CryptoKey, data: Document_, options: OptionsSign): js.Promise[Signature] = js.native
  def Sign(algorithm: typingsJapgolly.std.RsaPssParams, key: CryptoKey, data: Document_): js.Promise[Signature] = js.native
  def Sign(algorithm: typingsJapgolly.std.RsaPssParams, key: CryptoKey, data: Document_, options: OptionsSign): js.Promise[Signature] = js.native
  ...
  /* protected */ def TransformSignedInfo(data: typingsJapgolly.std.Element): String = js.native
