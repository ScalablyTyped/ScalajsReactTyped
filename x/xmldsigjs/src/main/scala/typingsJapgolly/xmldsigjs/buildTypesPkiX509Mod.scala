...
object buildTypesPkiX509Mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typingsJapgolly.xmldsigjs.xmldsigjsStrings.`SHA-1`
    - typingsJapgolly.xmldsigjs.xmldsigjsStrings.`SHA-256`
    - typingsJapgolly.xmldsigjs.xmldsigjsStrings.`SHA-384`
    - typingsJapgolly.xmldsigjs.xmldsigjsStrings.`SHA-512`
  */
