...
import typingsJapgolly.xmldsigjs.buildTypesXmlMod.Reference
import typingsJapgolly.xmldsigjs.buildTypesXmlMod.Signature
import typingsJapgolly.xmldsigjs.buildTypesXmlMod.Transform
import typingsJapgolly.xmldsigjs.buildTypesXmlMod.Transforms
import typingsJapgolly.xmldsigjs.xmldsigjsStrings.xpath
...
object buildTypesSignedXmlMod {
  ...
  open class SignedXml ()
    ...
    var Algorithm: js.UndefOr[org.scalajs.dom.Algorithm | RsaPssParams | EcdsaParams] = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.xmldsigjs.xmldsigjsStrings.enveloped
    - typingsJapgolly.xmldsigjs.xmldsigjsStrings.c14n
    - typingsJapgolly.xmldsigjs.xmldsigjsStrings.`exc-c14n`
    - typingsJapgolly.xmldsigjs.xmldsigjsStrings.`c14n-com`
    - typingsJapgolly.xmldsigjs.xmldsigjsStrings.`exc-c14n-com`
    - typingsJapgolly.xmldsigjs.xmldsigjsStrings.base64
    - typingsJapgolly.xmldsigjs.buildTypesSignedXmlMod.OptionsXPathSignTransform
  */
