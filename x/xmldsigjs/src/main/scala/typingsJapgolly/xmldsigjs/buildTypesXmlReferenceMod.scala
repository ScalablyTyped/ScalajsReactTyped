...
import typingsJapgolly.xmldsigjs.buildTypesXmlXmlObjectMod.XmlSignatureCollection
...
object buildTypesXmlReferenceMod {
  ...
  open class Reference () extends XmlSignatureObject {
    ...
    /**
      ...
      */
    var DigestMethod: typingsJapgolly.xmldsigjs.buildTypesXmlDigestMethodMod.DigestMethod = js.native
    ...
    var Transforms: typingsJapgolly.xmldsigjs.buildTypesXmlTransformCollectionMod.Transforms = js.native
