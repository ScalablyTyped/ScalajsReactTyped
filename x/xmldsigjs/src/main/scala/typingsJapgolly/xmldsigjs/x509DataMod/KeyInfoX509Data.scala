package typingsJapgolly.xmldsigjs.x509DataMod
...
class KeyInfoX509Data () extends KeyInfoClause {
  ...
  def CRL(value: scala.scalajs.js.typedarray.Uint8Array): js.Any = js.native
  /**
    * Gets or sets the Certificate Revocation List (CRL) contained within the KeyInfoX509Data object.
    */
  @JSName("CRL")
  def CRL_Union(): scala.scalajs.js.typedarray.Uint8Array | Null = js.native
  /**
  ...
  /**
    ...
    */
  def SubjectKeyIds(): js.Array[scala.scalajs.js.typedarray.Uint8Array] = js.native
  /**
