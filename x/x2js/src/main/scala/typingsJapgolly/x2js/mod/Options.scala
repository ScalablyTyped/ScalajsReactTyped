...
import typingsJapgolly.x2js.x2jsStrings.`object`
import typingsJapgolly.x2js.x2jsStrings.none
import typingsJapgolly.x2js.x2jsStrings.property
import typingsJapgolly.x2js.x2jsStrings.text
...
object Options {
  ...
  def apply(
    ...
    datetimeAccessFormPaths: js.Array[String | js.RegExp | (js.Function1[/* elementPath */ String, Boolean])] = null,
