...
import typingsJapgolly.fancybox.fancyboxBooleans.`false`
import typingsJapgolly.fancybox.fancyboxStrings.`inline`
import typingsJapgolly.fancybox.fancyboxStrings.`zoom-in-out`
import typingsJapgolly.fancybox.fancyboxStrings.ajax
import typingsJapgolly.fancybox.fancyboxStrings.auto
import typingsJapgolly.fancybox.fancyboxStrings.circular
import typingsJapgolly.fancybox.fancyboxStrings.close
import typingsJapgolly.fancybox.fancyboxStrings.download
import typingsJapgolly.fancybox.fancyboxStrings.fade
import typingsJapgolly.fancybox.fancyboxStrings.fullScreen
...
import typingsJapgolly.fancybox.fancyboxStrings.rotate
import typingsJapgolly.fancybox.fancyboxStrings.share
import typingsJapgolly.fancybox.fancyboxStrings.slide
import typingsJapgolly.fancybox.fancyboxStrings.slideShow
import typingsJapgolly.fancybox.fancyboxStrings.thumbs
import typingsJapgolly.fancybox.fancyboxStrings.tube
import typingsJapgolly.fancybox.fancyboxStrings.zoom
...
object FancyBoxOptions {
  @scala.inline
  def apply(
    afterClose: (/* instance */ FancyBoxInstance, /* current */ FancyBoxSlide) => Callback = null,
    afterLoad: (/* instance */ FancyBoxInstance, /* current */ FancyBoxSlide) => Callback = null,
    afterShow: (/* instance */ FancyBoxInstance, /* current */ FancyBoxSlide) => Callback = null,
    ...
    baseTpl: String = null,
    beforeClose: (/* instance */ FancyBoxInstance, /* current */ FancyBoxSlide) => Callback = null,
    beforeLoad: (/* instance */ FancyBoxInstance, /* current */ FancyBoxSlide) => Callback = null,
    beforeShow: (/* instance */ FancyBoxInstance, /* current */ FancyBoxSlide) => Callback = null,
    ...
    onActivate: /* instance */ FancyBoxInstance => Callback = null,
    onDeactivate: /* instance */ FancyBoxInstance => Callback = null,
    onInit: /* instance */ FancyBoxInstance => Callback = null,
    ...
    if (afterClose != null) __obj.updateDynamic("afterClose")(js.Any.fromFunction2((t0: /* instance */ typingsJapgolly.fancybox.FancyBoxInstance, t1: /* current */ typingsJapgolly.fancybox.FancyBoxSlide) => afterClose(t0, t1).runNow()))
    if (afterLoad != null) __obj.updateDynamic("afterLoad")(js.Any.fromFunction2((t0: /* instance */ typingsJapgolly.fancybox.FancyBoxInstance, t1: /* current */ typingsJapgolly.fancybox.FancyBoxSlide) => afterLoad(t0, t1).runNow()))
    if (afterShow != null) __obj.updateDynamic("afterShow")(js.Any.fromFunction2((t0: /* instance */ typingsJapgolly.fancybox.FancyBoxInstance, t1: /* current */ typingsJapgolly.fancybox.FancyBoxSlide) => afterShow(t0, t1).runNow()))
    ...
    if (beforeClose != null) __obj.updateDynamic("beforeClose")(js.Any.fromFunction2((t0: /* instance */ typingsJapgolly.fancybox.FancyBoxInstance, t1: /* current */ typingsJapgolly.fancybox.FancyBoxSlide) => beforeClose(t0, t1).runNow()))
    if (beforeLoad != null) __obj.updateDynamic("beforeLoad")(js.Any.fromFunction2((t0: /* instance */ typingsJapgolly.fancybox.FancyBoxInstance, t1: /* current */ typingsJapgolly.fancybox.FancyBoxSlide) => beforeLoad(t0, t1).runNow()))
    if (beforeShow != null) __obj.updateDynamic("beforeShow")(js.Any.fromFunction2((t0: /* instance */ typingsJapgolly.fancybox.FancyBoxInstance, t1: /* current */ typingsJapgolly.fancybox.FancyBoxSlide) => beforeShow(t0, t1).runNow()))
    ...
    if (onActivate != null) __obj.updateDynamic("onActivate")(js.Any.fromFunction1((t0: /* instance */ typingsJapgolly.fancybox.FancyBoxInstance) => onActivate(t0).runNow()))
    if (onDeactivate != null) __obj.updateDynamic("onDeactivate")(js.Any.fromFunction1((t0: /* instance */ typingsJapgolly.fancybox.FancyBoxInstance) => onDeactivate(t0).runNow()))
    if (onInit != null) __obj.updateDynamic("onInit")(js.Any.fromFunction1((t0: /* instance */ typingsJapgolly.fancybox.FancyBoxInstance) => onInit(t0).runNow()))
