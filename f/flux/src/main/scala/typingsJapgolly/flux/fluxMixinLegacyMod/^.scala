...
object ^ extends js.Object {
  /**
    ...
    */
  def apply(stores: js.Array[typingsJapgolly.flux.fluxStoreMod.^[_]]): js.Any = js.native
  def apply(stores: js.Array[typingsJapgolly.flux.fluxStoreMod.^[_]], options: Options): js.Any = js.native
}
