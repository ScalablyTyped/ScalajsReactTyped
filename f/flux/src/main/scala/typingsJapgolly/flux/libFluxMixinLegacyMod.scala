...
object libFluxMixinLegacyMod {
  ...
  /**
    ...
    */
  inline def apply(stores: js.Array[typingsJapgolly.flux.libFluxStoreMod.^[Any]]): Any = ^.asInstanceOf[js.Dynamic].apply(stores.asInstanceOf[js.Any]).asInstanceOf[Any]
  inline def apply(stores: js.Array[typingsJapgolly.flux.libFluxStoreMod.^[Any]], options: Options): Any = (^.asInstanceOf[js.Dynamic].apply(stores.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
