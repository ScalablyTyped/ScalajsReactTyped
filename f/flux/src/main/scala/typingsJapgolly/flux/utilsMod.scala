...
import typingsJapgolly.flux.libFluxContainerMod.Component
import typingsJapgolly.flux.libFluxContainerMod.RealOptions
import typingsJapgolly.flux.libFluxMixinLegacyMod.Options
...
object utilsMod {
  ...
  object Container {
    ...
    inline def createFunctional[TProps, TState](
      ...
      getStores: js.Function2[
          ...
          js.Array[typingsJapgolly.flux.libFluxStoreMod.^[Any]]
        ],
    ...
    inline def create_TPropsTStateTContextTStatic_Intersection[TProps, TState, TContext, TStatic](base: (Component[TProps, TState, TContext]) & TStatic): (Component[TProps, TState, TContext]) & TStatic = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(base.asInstanceOf[js.Any]).asInstanceOf[(Component[TProps, TState, TContext]) & TStatic]
    inline def create_TPropsTStateTContextTStatic_Intersection[TProps, TState, TContext, TStatic](base: (Component[TProps, TState, TContext]) & TStatic, options: RealOptions): (Component[TProps, TState, TContext]) & TStatic = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(base.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[(Component[TProps, TState, TContext]) & TStatic]
  }
  ...
  /**
    ...
    */
  inline def Mixin(stores: js.Array[typingsJapgolly.flux.libFluxStoreMod.^[Any]]): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("Mixin")(stores.asInstanceOf[js.Any]).asInstanceOf[Any]
  inline def Mixin(stores: js.Array[typingsJapgolly.flux.libFluxStoreMod.^[Any]], options: Options): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("Mixin")(stores.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  open class ReduceStore[TState, TPayload] ()
    extends typingsJapgolly.flux.libFluxReduceStoreMod.^[TState, TPayload]
  ...
  open class Store[TPayload] protected ()
    extends typingsJapgolly.flux.libFluxStoreMod.^[TPayload] {
    /**
