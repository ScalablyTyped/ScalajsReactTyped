...
object distSrcInterfacesInstallationEntryMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.NotStartedAuthToken
    - typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.InProgressAuthToken
    - typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.CompletedAuthToken
  */
  trait AuthToken extends StObject
  object AuthToken {
    
    inline def CompletedAuthToken(creationTime: Double, expiresIn: Double, token: String): typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.CompletedAuthToken = {
      ...
      __obj.asInstanceOf[typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.CompletedAuthToken]
    }
    
    inline def InProgressAuthToken(requestTime: Double): typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.InProgressAuthToken = {
      val __obj = js.Dynamic.literal(requestStatus = 1, requestTime = requestTime.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.InProgressAuthToken]
    }
    
    inline def NotStartedAuthToken(): typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.NotStartedAuthToken = {
      val __obj = js.Dynamic.literal(requestStatus = 0)
      __obj.asInstanceOf[typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.NotStartedAuthToken]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.UnregisteredInstallationEntry
    - typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.InProgressInstallationEntry
    - typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.RegisteredInstallationEntry
  */
  trait InstallationEntry extends StObject
  object InstallationEntry {
    
    inline def InProgressInstallationEntry(fid: String, registrationTime: Double): typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.InProgressInstallationEntry = {
      val __obj = js.Dynamic.literal(fid = fid.asInstanceOf[js.Any], registrationStatus = 1, registrationTime = registrationTime.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.InProgressInstallationEntry]
    }
    
    inline def RegisteredInstallationEntry(authToken: AuthToken, fid: String, refreshToken: String): typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.RegisteredInstallationEntry = {
      ...
      __obj.asInstanceOf[typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.RegisteredInstallationEntry]
    }
    
    inline def UnregisteredInstallationEntry(fid: String): typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.UnregisteredInstallationEntry = {
      val __obj = js.Dynamic.literal(fid = fid.asInstanceOf[js.Any], registrationStatus = 0)
      __obj.asInstanceOf[typingsJapgolly.firebaseInstallations.distSrcInterfacesInstallationEntryMod.UnregisteredInstallationEntry]
    }
  }
