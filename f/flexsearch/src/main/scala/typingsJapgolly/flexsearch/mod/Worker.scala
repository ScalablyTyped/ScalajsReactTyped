...
open class Worker () extends StObject {
  ...
  def search(query: String, limit: Double): IndexSearchResult = js.native
  ...
  def searchAsync(query: String, limit: Double): IndexSearchResult = js.native
  ...
  @JSName("searchAsync")
  def searchAsync_Promise(query: String, options: Limit): js.Promise[IndexSearchResult] = js.native
  
  @JSName("search")
  def search_Promise(query: String, options: Limit): js.Promise[IndexSearchResult] = js.native
