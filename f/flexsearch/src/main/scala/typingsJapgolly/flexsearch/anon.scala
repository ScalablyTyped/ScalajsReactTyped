package typingsJapgolly.flexsearch

import typingsJapgolly.flexsearch.flexsearchStrings.and
import typingsJapgolly.flexsearch.flexsearchStrings.or
import typingsJapgolly.flexsearch.mod.SearchOptions
...
object anon {
  ...
  object PartialDocumentSearchOpti {
    ...
    extension [Self <: PartialDocumentSearchOpti](x: Self) {
