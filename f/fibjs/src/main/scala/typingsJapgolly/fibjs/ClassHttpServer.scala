...
@js.native
class ClassHttpServer protected () extends ClassTcpServer {
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def this(port: Double, hdlr: ClassHandler) = this()
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def this(addr: String, port: Double, hdlr: ClassHandler) = this()
  /**
  	 * class prop 
  	 *
  	 * 
