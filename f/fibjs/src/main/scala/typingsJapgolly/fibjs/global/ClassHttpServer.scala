...
open class ClassHttpServer protected ()
  extends StObject
     with typingsJapgolly.fibjs.ClassHttpServer {
  /**
    * 
    ...
    * 
    */
  def this(port: Double, hdlr: typingsJapgolly.fibjs.ClassHandler) = this()
  /**
    * 
    ...
    * 
    */
  def this(addr: String, port: Double, hdlr: typingsJapgolly.fibjs.ClassHandler) = this()
}
