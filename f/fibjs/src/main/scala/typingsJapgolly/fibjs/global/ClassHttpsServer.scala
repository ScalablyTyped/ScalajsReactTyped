...
open class ClassHttpsServer protected ()
  extends StObject
     with typingsJapgolly.fibjs.ClassHttpsServer {
  /**
    * 
    ...
    * 
    */
  def this(certs: js.Array[Any], port: Double, hdlr: typingsJapgolly.fibjs.ClassHandler) = this()
  /**
    * 
    ...
    * 
    */
  def this(certs: js.Array[Any], addr: String, port: Double, hdlr: typingsJapgolly.fibjs.ClassHandler) = this()
  /**
    * 
    * @brief HttpsServer 构造函数，在所有本机地址侦听
