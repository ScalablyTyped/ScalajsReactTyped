...
open class ClassPKey ()
  extends StObject
     with typingsJapgolly.fibjs.ClassPKey {
  /**
    * 
    ...
    * 
    */
  def this(DerKey: typingsJapgolly.fibjs.ClassBuffer) = this()
  /**
    * 
  ...
  def this(DerKey: typingsJapgolly.fibjs.ClassBuffer, password: String) = this()
