...
open class ClassTcpServer protected ()
  extends StObject
     with typingsJapgolly.fibjs.ClassTcpServer {
  /**
    * 
    ...
    * 
    */
  def this(port: Double, listener: typingsJapgolly.fibjs.ClassHandler) = this()
  /**
    * 
    ...
    * 
    */
  def this(addr: String, port: Double, listener: typingsJapgolly.fibjs.ClassHandler) = this()
}
