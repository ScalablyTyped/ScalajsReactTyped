...
@js.native
class ClassCipher protected () extends ClassObject {
  /**
  	 * 
  	 ...
  	 * 
  	 */
  def this(provider: Double, key: ClassBuffer) = this()
  /**
  	 * 
  	 * @brief Cipher 构造函数
  	 * @param provider 指定加密算法
  	 ...
  	 * 
  	 */
  def this(provider: Double, mode: Double, key: ClassBuffer) = this()
  /**
  	 * 
  	 * @brief Cipher 构造函数
  	 * @param provider 指定加密算法
  	 ...
  	 * 
  	 */
  def this(provider: Double, mode: Double, key: ClassBuffer, iv: ClassBuffer) = this()
  /**
  	 * class prop 
  	 *
  	 * 
