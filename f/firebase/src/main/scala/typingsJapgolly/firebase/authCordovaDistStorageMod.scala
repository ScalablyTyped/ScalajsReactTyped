...
object authCordovaDistStorageMod {
  ...
  object StringFormat {
    ...
    /**
      ...
      */
    @JSImport("firebase/auth/cordova/dist/storage", "StringFormat.BASE64")
    @js.native
    ...
    /**
      ...
      * ad 69 8e fb e1 3a b7 bf eb 97
      */
    @JSImport("firebase/auth/cordova/dist/storage", "StringFormat.BASE64URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/auth/cordova/dist/storage", "StringFormat.DATA_URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/auth/cordova/dist/storage", "StringFormat.RAW")
    @js.native
