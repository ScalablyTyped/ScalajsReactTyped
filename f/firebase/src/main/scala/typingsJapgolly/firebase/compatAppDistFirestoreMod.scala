...
object compatAppDistFirestoreMod {
  
  @JSImport("firebase/compat/app/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/app/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/compat/app/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/compat/app/dist/firestore", "Bytes")
  @js.native
  ...
  @JSImport("firebase/compat/app/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/compat/app/dist/firestore", "WriteBatch")
  @js.native
