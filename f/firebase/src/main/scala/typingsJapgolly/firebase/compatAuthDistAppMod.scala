...
object compatAuthDistAppMod {
  
  @JSImport("firebase/compat/auth/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/auth/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/auth/dist/app", "SDK_VERSION")
  @js.native
