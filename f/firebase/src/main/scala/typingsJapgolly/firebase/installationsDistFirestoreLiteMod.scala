...
object installationsDistFirestoreLiteMod {
  
  @JSImport("firebase/installations/dist/firestore/lite", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/installations/dist/firestore/lite", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.liteMod.AggregateField[T]
  
  @JSImport("firebase/installations/dist/firestore/lite", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/installations/dist/firestore/lite", "Bytes")
  @js.native
  ...
  @JSImport("firebase/installations/dist/firestore/lite", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.liteMod.Transaction
  
  @JSImport("firebase/installations/dist/firestore/lite", "WriteBatch")
  @js.native
