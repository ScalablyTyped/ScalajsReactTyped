...
object authReactNativeDistAppCheckMod {
  
  @JSImport("firebase/auth/react-native/dist/app-check", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/auth/react-native/dist/app-check", "CustomProvider")
  @js.native
  ...
  @JSImport("firebase/auth/react-native/dist/app-check", "ReCaptchaEnterpriseProvider")
  @js.native
  ...
  @JSImport("firebase/auth/react-native/dist/app-check", "ReCaptchaV3Provider")
  @js.native
