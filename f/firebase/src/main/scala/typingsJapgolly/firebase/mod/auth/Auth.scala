...
import typingsJapgolly.firebase.mod.User
import typingsJapgolly.firebase.mod.app.App
import typingsJapgolly.firebase.mod.auth.Auth.Persistence
...
trait Auth extends js.Object {
  ...
  /**
    ...
    * ```
    */
  def onAuthStateChanged(nextOrObserver: Observer[_, typingsJapgolly.std.Error]): Unsubscribe = js.native
  def onAuthStateChanged(nextOrObserver: Observer[_, typingsJapgolly.std.Error], error: js.Function1[/* a */ Error, _]): Unsubscribe = js.native
  def onAuthStateChanged(
    nextOrObserver: Observer[_, typingsJapgolly.std.Error],
    error: js.Function1[/* a */ Error, _],
    completed: Unsubscribe
  ): Unsubscribe = js.native
  ...
  /**
    ...
    *     observer is removed.
    */
  def onIdTokenChanged(nextOrObserver: Observer[_, typingsJapgolly.std.Error]): Unsubscribe = js.native
  def onIdTokenChanged(nextOrObserver: Observer[_, typingsJapgolly.std.Error], error: js.Function1[/* a */ Error, _]): Unsubscribe = js.native
  def onIdTokenChanged(
    nextOrObserver: Observer[_, typingsJapgolly.std.Error],
    error: js.Function1[/* a */ Error, _],
    completed: Unsubscribe
