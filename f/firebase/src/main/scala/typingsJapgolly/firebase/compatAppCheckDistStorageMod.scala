...
object compatAppCheckDistStorageMod {
  
  @JSImport("firebase/compat/app-check/dist/storage", JSImport.Namespace)
  @js.native
  ...
  object StringFormat {
    ...
    /**
      ...
      */
    @JSImport("firebase/compat/app-check/dist/storage", "StringFormat.BASE64")
    @js.native
    ...
    /**
      ...
      * ad 69 8e fb e1 3a b7 bf eb 97
      */
    @JSImport("firebase/compat/app-check/dist/storage", "StringFormat.BASE64URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/compat/app-check/dist/storage", "StringFormat.DATA_URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("firebase/compat/app-check/dist/storage", "StringFormat.RAW")
    @js.native
