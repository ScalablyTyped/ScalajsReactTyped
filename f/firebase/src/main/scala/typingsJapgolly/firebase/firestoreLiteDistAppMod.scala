...
object firestoreLiteDistAppMod {
  
  @JSImport("firebase/firestore/lite/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/firestore/lite/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/firestore/lite/dist/app", "SDK_VERSION")
  @js.native
