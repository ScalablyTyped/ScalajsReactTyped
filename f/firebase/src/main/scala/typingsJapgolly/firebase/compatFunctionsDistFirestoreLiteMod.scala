...
object compatFunctionsDistFirestoreLiteMod {
  
  @JSImport("firebase/compat/functions/dist/firestore/lite", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/functions/dist/firestore/lite", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.liteMod.AggregateField[T]
  
  @JSImport("firebase/compat/functions/dist/firestore/lite", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/compat/functions/dist/firestore/lite", "Bytes")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/compat/functions/dist/firestore/lite", "FieldValue")
  @js.native
  /* private */ open class FieldValue ()
    extends typingsJapgolly.firebaseFirestore.liteMod.FieldValue
  
  @JSImport("firebase/compat/functions/dist/firestore/lite", "Firestore")
  @js.native
  /* private */ open class Firestore ()
    extends typingsJapgolly.firebaseFirestore.liteMod.Firestore
  
  @JSImport("firebase/compat/functions/dist/firestore/lite", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typingsJapgolly.firebaseFirestore.liteMod.FirestoreError
  
  @JSImport("firebase/compat/functions/dist/firestore/lite", "GeoPoint")
  @js.native
  ...
  @JSImport("firebase/compat/functions/dist/firestore/lite", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.liteMod.Transaction
  
  @JSImport("firebase/compat/functions/dist/firestore/lite", "WriteBatch")
  @js.native
