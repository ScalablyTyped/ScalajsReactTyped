...
object firestoreMod {
  ...
  open class AggregateField[T] ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.AggregateField[T]
  
  @JSImport("firebase/firestore", "AggregateQuerySnapshot")
  @js.native
  /* private */ open class AggregateQuerySnapshot[T /* <: AggregateSpec */] ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.AggregateQuerySnapshot[T]
  
  @JSImport("firebase/firestore", "Bytes")
  @js.native
  /* private */ open class Bytes ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.Bytes
  /* static members */
  object Bytes {
  ...
  /* private */ open class CollectionReference[T] ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.CollectionReference[T]
  
  @JSImport("firebase/firestore", "DocumentReference")
  @js.native
  /* private */ open class DocumentReference[T] ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.DocumentReference[T]
  
  @JSImport("firebase/firestore", "DocumentSnapshot")
  @js.native
  /* protected */ open class DocumentSnapshot[T] ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.DocumentSnapshot[T]
  
  @JSImport("firebase/firestore", "FieldPath")
  @js.native
  open class FieldPath protected ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.FieldPath {
    /**
  ...
  /* private */ open class FieldValue ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.FieldValue
  
  @JSImport("firebase/firestore", "Firestore")
  @js.native
  /* private */ open class Firestore ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.Firestore
  
  @JSImport("firebase/firestore", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.FirestoreError
  
  @JSImport("firebase/firestore", "GeoPoint")
  @js.native
  open class GeoPoint protected ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.GeoPoint {
    /**
  ...
  open class LoadBundleTask ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.LoadBundleTask
  
  /* note: abstract class */ @JSImport("firebase/firestore", "QueryConstraint")
  @js.native
  open class QueryConstraint ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.QueryConstraint
  
  @JSImport("firebase/firestore", "QueryDocumentSnapshot")
  @js.native
  /* protected */ open class QueryDocumentSnapshot[T] ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.QueryDocumentSnapshot[T]
  
  @JSImport("firebase/firestore", "QuerySnapshot")
  @js.native
  /* private */ open class QuerySnapshot[T] ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.QuerySnapshot[T]
  
  @JSImport("firebase/firestore", "Query")
  @js.native
  /* protected */ open class Query_[T] ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.Query_[T]
  
  @JSImport("firebase/firestore", "SnapshotMetadata")
  @js.native
  /* private */ open class SnapshotMetadata ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.SnapshotMetadata
  
  @JSImport("firebase/firestore", "Timestamp")
  @js.native
  open class Timestamp protected ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.Timestamp {
    /**
  ...
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.Transaction
  
  @JSImport("firebase/firestore", "WriteBatch")
  @js.native
  /* private */ open class WriteBatch_ ()
    extends typingsJapgolly.firebase.firestoreDistFirestoreMod.WriteBatch_
