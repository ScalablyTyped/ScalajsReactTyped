...
object appCheckDistFirestoreMod {
  
  @JSImport("firebase/app-check/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/app-check/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/app-check/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/app-check/dist/firestore", "Bytes")
  @js.native
  ...
  @JSImport("firebase/app-check/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/app-check/dist/firestore", "WriteBatch")
  @js.native
