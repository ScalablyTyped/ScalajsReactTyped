...
object databaseDistFirestoreMod {
  ...
  /* note: abstract class */ @JSImport("firebase/database/dist/firestore", "FieldValue")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/database/dist/firestore", "QueryConstraint")
  @js.native
