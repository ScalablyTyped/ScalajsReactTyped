...
object compatPerformanceDistFirestoreMod {
  
  @JSImport("firebase/compat/performance/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/performance/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/compat/performance/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/compat/performance/dist/firestore", "FieldValue")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/compat/performance/dist/firestore", "QueryConstraint")
  @js.native
