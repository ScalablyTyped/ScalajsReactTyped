...
object authMod {
  ...
  open class ActionCodeURL ()
    extends typingsJapgolly.firebase.authDistAuthMod.ActionCodeURL
  /* static members */
  ...
  open class AuthCredential ()
    extends typingsJapgolly.firebase.authDistAuthMod.AuthCredential
  ...
  open class EmailAuthCredential ()
    extends typingsJapgolly.firebase.authDistAuthMod.EmailAuthCredential
  /* static members */
  ...
  open class EmailAuthProvider ()
    extends typingsJapgolly.firebase.authDistAuthMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typingsJapgolly.firebase.authDistAuthMod.FacebookAuthProvider
  /* static members */
  ...
  open class GithubAuthProvider ()
    extends typingsJapgolly.firebase.authDistAuthMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typingsJapgolly.firebase.authDistAuthMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential ()
    extends typingsJapgolly.firebase.authDistAuthMod.OAuthCredential
  /* static members */
  ...
  open class OAuthProvider ()
    extends typingsJapgolly.firebase.authDistAuthMod.OAuthProvider
  /* static members */
  ...
  /* private */ open class PhoneAuthCredential ()
    extends typingsJapgolly.firebase.authDistAuthMod.PhoneAuthCredential
  /* static members */
  ...
  open class PhoneAuthProvider protected ()
    extends typingsJapgolly.firebase.authDistAuthMod.PhoneAuthProvider {
    /**
  ...
  /* private */ open class PhoneMultiFactorGenerator ()
    extends typingsJapgolly.firebase.authDistAuthMod.PhoneMultiFactorGenerator
  /* static members */
  ...
  open class RecaptchaVerifier protected ()
    extends typingsJapgolly.firebase.authDistAuthMod.RecaptchaVerifier {
  ...
  open class SAMLAuthProvider protected ()
    extends typingsJapgolly.firebase.authDistAuthMod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typingsJapgolly.firebase.authDistAuthMod.TwitterAuthProvider
  /* static members */
