...
object compatFirestoreDistAppMod {
  
  @JSImport("firebase/compat/firestore/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/firestore/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/firestore/dist/app", "SDK_VERSION")
  @js.native
