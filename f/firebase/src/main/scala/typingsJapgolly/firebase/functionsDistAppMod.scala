...
object functionsDistAppMod {
  
  @JSImport("firebase/functions/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/functions/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/functions/dist/app", "SDK_VERSION")
  @js.native
