...
import typingsJapgolly.firebase.firebaseStrings.estimate
import typingsJapgolly.firebase.firebaseStrings.none
import typingsJapgolly.firebase.firebaseStrings.previous
