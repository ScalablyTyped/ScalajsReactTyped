...
trait FirebaseError extends StObject {
  ...
  /**
    ...
    */
  var name: typingsJapgolly.firebase.firebaseStrings.FirebaseError
...
object FirebaseError {
  ...
  extension [Self <: FirebaseError](x: Self) {
    ...
    inline def setName(value: typingsJapgolly.firebase.firebaseStrings.FirebaseError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
