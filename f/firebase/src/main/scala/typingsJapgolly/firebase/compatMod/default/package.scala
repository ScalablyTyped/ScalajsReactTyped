...
import typingsJapgolly.firebase.anon.Args
import typingsJapgolly.firebase.anon.Level
import typingsJapgolly.firebase.compatMod.default.^
import typingsJapgolly.firebase.compatMod.firebase.LogLevel
