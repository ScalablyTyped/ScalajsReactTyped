...
import typingsJapgolly.firebase.anon.ForceLongPolling
import typingsJapgolly.firebase.anon.MockUserToken
...
object database {
  ...
  type EmulatorMockTokenOptions = typingsJapgolly.firebase.compatMod.firebase.EmulatorMockTokenOptions
  ...
  */
  ...
  object EventType {
    ...
    inline def child_added: typingsJapgolly.firebase.firebaseStrings.child_added = "child_added".asInstanceOf[typingsJapgolly.firebase.firebaseStrings.child_added]
    
    inline def child_changed: typingsJapgolly.firebase.firebaseStrings.child_changed = "child_changed".asInstanceOf[typingsJapgolly.firebase.firebaseStrings.child_changed]
    
    inline def child_moved: typingsJapgolly.firebase.firebaseStrings.child_moved = "child_moved".asInstanceOf[typingsJapgolly.firebase.firebaseStrings.child_moved]
    
    inline def child_removed: typingsJapgolly.firebase.firebaseStrings.child_removed = "child_removed".asInstanceOf[typingsJapgolly.firebase.firebaseStrings.child_removed]
    
    inline def value: typingsJapgolly.firebase.firebaseStrings.value = "value".asInstanceOf[typingsJapgolly.firebase.firebaseStrings.value]
  }
