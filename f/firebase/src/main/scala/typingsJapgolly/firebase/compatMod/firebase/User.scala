...
import typingsJapgolly.firebase.anon.DisplayName
import typingsJapgolly.firebase.compatMod.firebase.User.MultiFactorUser
import typingsJapgolly.firebase.compatMod.firebase.auth.ActionCodeSettings
import typingsJapgolly.firebase.compatMod.firebase.auth.ApplicationVerifier
import typingsJapgolly.firebase.compatMod.firebase.auth.AuthCredential
import typingsJapgolly.firebase.compatMod.firebase.auth.AuthProvider
import typingsJapgolly.firebase.compatMod.firebase.auth.ConfirmationResult
import typingsJapgolly.firebase.compatMod.firebase.auth.IdTokenResult
import typingsJapgolly.firebase.compatMod.firebase.auth.MultiFactorAssertion
import typingsJapgolly.firebase.compatMod.firebase.auth.MultiFactorInfo
import typingsJapgolly.firebase.compatMod.firebase.auth.MultiFactorSession
import typingsJapgolly.firebase.compatMod.firebase.auth.UserCredential
import typingsJapgolly.firebase.compatMod.firebase.auth.UserMetadata
