...
object analyticsDistAppMod {
  
  @JSImport("firebase/analytics/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/analytics/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/analytics/dist/app", "SDK_VERSION")
  @js.native
