...
object compatDistAppMod {
  
  @JSImport("firebase/compat/dist/app", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/dist/app", "FirebaseError")
  @js.native
  ...
  @JSImport("firebase/compat/dist/app", "SDK_VERSION")
  @js.native
