...
import typingsJapgolly.firebase.mod.firestore.QuerySnapshot
...
object AnonCompleteError {
  ...
  def apply[T](
    ...
    if (next != null) __obj.updateDynamic("next")(js.Any.fromFunction1((t0: /* snapshot */ typingsJapgolly.firebase.mod.firestore.QuerySnapshot[T]) => next(t0).runNow()))
