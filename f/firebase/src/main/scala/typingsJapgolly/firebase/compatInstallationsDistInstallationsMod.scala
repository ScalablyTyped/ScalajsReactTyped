...
import typingsJapgolly.firebaseInstallations.mod.IdChangeCallbackFn
import typingsJapgolly.firebaseInstallations.mod.IdChangeUnsubscribeFn
import typingsJapgolly.firebaseInstallations.mod.Installations
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object compatInstallationsDistInstallationsMod {
  
  @JSImport("firebase/compat/installations/dist/installations", JSImport.Namespace)
  @js.native
