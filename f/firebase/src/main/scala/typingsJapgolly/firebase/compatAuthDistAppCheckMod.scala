...
object compatAuthDistAppCheckMod {
  
  @JSImport("firebase/compat/auth/dist/app-check", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/auth/dist/app-check", "CustomProvider")
  @js.native
  ...
  @JSImport("firebase/compat/auth/dist/app-check", "ReCaptchaEnterpriseProvider")
  @js.native
  ...
  @JSImport("firebase/compat/auth/dist/app-check", "ReCaptchaV3Provider")
  @js.native
