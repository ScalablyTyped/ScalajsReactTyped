...
object compatAuthDistFirestoreMod {
  ...
  @JSImport("firebase/compat/auth/dist/firestore", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typingsJapgolly.firebaseFirestore.mod.FirestoreError
  
  @JSImport("firebase/compat/auth/dist/firestore", "GeoPoint")
  @js.native
  ...
  @JSImport("firebase/compat/auth/dist/firestore", "LoadBundleTask")
  @js.native
  ...
  @JSImport("firebase/compat/auth/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/compat/auth/dist/firestore", "WriteBatch")
  @js.native
