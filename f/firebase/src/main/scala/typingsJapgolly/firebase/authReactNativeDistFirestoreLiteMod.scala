...
object authReactNativeDistFirestoreLiteMod {
  
  @JSImport("firebase/auth/react-native/dist/firestore/lite", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/auth/react-native/dist/firestore/lite", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.liteMod.AggregateField[T]
  
  @JSImport("firebase/auth/react-native/dist/firestore/lite", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/auth/react-native/dist/firestore/lite", "Bytes")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/auth/react-native/dist/firestore/lite", "FieldValue")
  @js.native
  /* private */ open class FieldValue ()
    extends typingsJapgolly.firebaseFirestore.liteMod.FieldValue
  
  @JSImport("firebase/auth/react-native/dist/firestore/lite", "Firestore")
  @js.native
  /* private */ open class Firestore ()
    extends typingsJapgolly.firebaseFirestore.liteMod.Firestore
  
  @JSImport("firebase/auth/react-native/dist/firestore/lite", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typingsJapgolly.firebaseFirestore.liteMod.FirestoreError
  
  @JSImport("firebase/auth/react-native/dist/firestore/lite", "GeoPoint")
  @js.native
  ...
  @JSImport("firebase/auth/react-native/dist/firestore/lite", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.liteMod.Transaction
  
  @JSImport("firebase/auth/react-native/dist/firestore/lite", "WriteBatch")
  @js.native
