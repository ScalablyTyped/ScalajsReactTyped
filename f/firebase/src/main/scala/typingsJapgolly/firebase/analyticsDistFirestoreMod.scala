...
object analyticsDistFirestoreMod {
  
  @JSImport("firebase/analytics/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/analytics/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/analytics/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/analytics/dist/firestore", "Bytes")
  @js.native
  ...
  @JSImport("firebase/analytics/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/analytics/dist/firestore", "WriteBatch")
  @js.native
