...
object compatInstallationsDistFirestoreMod {
  
  @JSImport("firebase/compat/installations/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/installations/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/compat/installations/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/compat/installations/dist/firestore", "Bytes")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/compat/installations/dist/firestore", "FieldValue")
  @js.native
  /* private */ open class FieldValue ()
    extends typingsJapgolly.firebaseFirestore.mod.FieldValue
  
  @JSImport("firebase/compat/installations/dist/firestore", "Firestore")
  @js.native
  /* private */ open class Firestore ()
    extends typingsJapgolly.firebaseFirestore.mod.Firestore
  
  @JSImport("firebase/compat/installations/dist/firestore", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typingsJapgolly.firebaseFirestore.mod.FirestoreError
  
  @JSImport("firebase/compat/installations/dist/firestore", "GeoPoint")
  @js.native
  ...
  @JSImport("firebase/compat/installations/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/compat/installations/dist/firestore", "WriteBatch")
  @js.native
