...
object performanceDistFirestoreLiteMod {
  
  @JSImport("firebase/performance/dist/firestore/lite", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/performance/dist/firestore/lite", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.liteMod.AggregateField[T]
  
  @JSImport("firebase/performance/dist/firestore/lite", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/performance/dist/firestore/lite", "Bytes")
  @js.native
  ...
  @JSImport("firebase/performance/dist/firestore/lite", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.liteMod.Transaction
  
  @JSImport("firebase/performance/dist/firestore/lite", "WriteBatch")
  @js.native
