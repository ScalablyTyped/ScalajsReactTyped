...
object firestoreDistFirestoreMod {
  
  @JSImport("firebase/firestore/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/firestore/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/firestore/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/firestore/dist/firestore", "Bytes")
  @js.native
  ...
  @JSImport("firebase/firestore/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/firestore/dist/firestore", "WriteBatch")
  @js.native
