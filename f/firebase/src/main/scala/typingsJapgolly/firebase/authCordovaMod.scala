...
object authCordovaMod {
  ...
  open class ActionCodeURL protected ()
    extends typingsJapgolly.firebase.authCordovaDistAuthCordovaMod.ActionCodeURL {
    /**
  ...
  open class AuthCredential protected ()
    extends typingsJapgolly.firebase.authCordovaDistAuthCordovaMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  /* private */ open class EmailAuthCredential ()
    extends typingsJapgolly.firebase.authCordovaDistAuthCordovaMod.EmailAuthCredential
  /* static members */
  ...
  open class EmailAuthProvider ()
    extends typingsJapgolly.firebase.authCordovaDistAuthCordovaMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typingsJapgolly.firebase.authCordovaDistAuthCordovaMod.FacebookAuthProvider
  /* static members */
  ...
  open class GithubAuthProvider ()
    extends typingsJapgolly.firebase.authCordovaDistAuthCordovaMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typingsJapgolly.firebase.authCordovaDistAuthCordovaMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential protected ()
    extends typingsJapgolly.firebase.authCordovaDistAuthCordovaMod.OAuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
      * The authentication provider ID for the credential.
  ...
  open class OAuthProvider protected ()
    extends typingsJapgolly.firebase.authCordovaDistAuthCordovaMod.OAuthProvider {
    /**
  ...
  /* private */ open class PhoneAuthCredential ()
    extends typingsJapgolly.firebase.authCordovaDistAuthCordovaMod.PhoneAuthCredential
  /* static members */
  ...
  open class SAMLAuthProvider protected ()
    extends typingsJapgolly.firebase.authCordovaDistAuthCordovaMod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typingsJapgolly.firebase.authCordovaDistAuthCordovaMod.TwitterAuthProvider
  /* static members */
