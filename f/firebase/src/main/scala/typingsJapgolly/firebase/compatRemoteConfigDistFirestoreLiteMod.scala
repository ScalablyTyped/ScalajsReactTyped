...
object compatRemoteConfigDistFirestoreLiteMod {
  
  @JSImport("firebase/compat/remote-config/dist/firestore/lite", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/remote-config/dist/firestore/lite", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.liteMod.AggregateField[T]
  
  @JSImport("firebase/compat/remote-config/dist/firestore/lite", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/compat/remote-config/dist/firestore/lite", "Bytes")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/compat/remote-config/dist/firestore/lite", "FieldValue")
  @js.native
  /* private */ open class FieldValue ()
    extends typingsJapgolly.firebaseFirestore.liteMod.FieldValue
  
  @JSImport("firebase/compat/remote-config/dist/firestore/lite", "Firestore")
  @js.native
  /* private */ open class Firestore ()
    extends typingsJapgolly.firebaseFirestore.liteMod.Firestore
  
  @JSImport("firebase/compat/remote-config/dist/firestore/lite", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typingsJapgolly.firebaseFirestore.liteMod.FirestoreError
  
  @JSImport("firebase/compat/remote-config/dist/firestore/lite", "GeoPoint")
  @js.native
  ...
  @JSImport("firebase/compat/remote-config/dist/firestore/lite", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.liteMod.Transaction
  
  @JSImport("firebase/compat/remote-config/dist/firestore/lite", "WriteBatch")
  @js.native
