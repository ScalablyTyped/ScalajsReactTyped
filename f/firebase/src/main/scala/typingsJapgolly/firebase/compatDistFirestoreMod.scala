...
object compatDistFirestoreMod {
  ...
  @JSImport("firebase/compat/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/compat/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/compat/dist/firestore", "FieldValue")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/compat/dist/firestore", "QueryConstraint")
  @js.native
