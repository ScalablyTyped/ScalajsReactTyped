...
object compatDatabaseDistFirestoreMod {
  
  @JSImport("firebase/compat/database/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/database/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/compat/database/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/compat/database/dist/firestore", "Bytes")
  @js.native
  ...
  @JSImport("firebase/compat/database/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/compat/database/dist/firestore", "WriteBatch")
  @js.native
