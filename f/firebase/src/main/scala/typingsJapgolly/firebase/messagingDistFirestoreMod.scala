...
object messagingDistFirestoreMod {
  
  @JSImport("firebase/messaging/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/messaging/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/messaging/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/messaging/dist/firestore", "FieldValue")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/messaging/dist/firestore", "QueryConstraint")
  @js.native
