...
object appCheckMod {
  ...
  open class CustomProvider protected ()
    extends typingsJapgolly.firebase.appCheckDistAppCheckMod.CustomProvider {
  ...
  open class ReCaptchaEnterpriseProvider protected ()
    extends typingsJapgolly.firebase.appCheckDistAppCheckMod.ReCaptchaEnterpriseProvider {
    /**
  ...
  open class ReCaptchaV3Provider protected ()
    extends typingsJapgolly.firebase.appCheckDistAppCheckMod.ReCaptchaV3Provider {
    /**
