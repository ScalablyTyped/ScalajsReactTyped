...
object compatFunctionsDistFirestoreMod {
  
  @JSImport("firebase/compat/functions/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/compat/functions/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/compat/functions/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/compat/functions/dist/firestore", "Bytes")
  @js.native
  ...
  /* note: abstract class */ @JSImport("firebase/compat/functions/dist/firestore", "FieldValue")
  @js.native
  /* private */ open class FieldValue ()
    extends typingsJapgolly.firebaseFirestore.mod.FieldValue
  
  @JSImport("firebase/compat/functions/dist/firestore", "Firestore")
  @js.native
  /* private */ open class Firestore ()
    extends typingsJapgolly.firebaseFirestore.mod.Firestore
  
  @JSImport("firebase/compat/functions/dist/firestore", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typingsJapgolly.firebaseFirestore.mod.FirestoreError
  
  @JSImport("firebase/compat/functions/dist/firestore", "GeoPoint")
  @js.native
  ...
  @JSImport("firebase/compat/functions/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/compat/functions/dist/firestore", "WriteBatch")
  @js.native
