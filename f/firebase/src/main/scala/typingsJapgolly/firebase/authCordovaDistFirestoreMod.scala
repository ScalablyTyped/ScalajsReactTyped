...
object authCordovaDistFirestoreMod {
  
  @JSImport("firebase/auth/cordova/dist/firestore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("firebase/auth/cordova/dist/firestore", "AggregateField")
  @js.native
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.mod.AggregateField[T]
  
  @JSImport("firebase/auth/cordova/dist/firestore", "AggregateQuerySnapshot")
  @js.native
  ...
  @JSImport("firebase/auth/cordova/dist/firestore", "Bytes")
  @js.native
  ...
  @JSImport("firebase/auth/cordova/dist/firestore", "Transaction")
  @js.native
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.mod.Transaction
  
  @JSImport("firebase/auth/cordova/dist/firestore", "WriteBatch")
  @js.native
