...
object databaseMod {
  ...
  /* private */ open class DataSnapshot ()
    extends typingsJapgolly.firebase.databaseDistDatabaseMod.DataSnapshot
  
  @JSImport("firebase/database", "Database")
  @js.native
  /* private */ open class Database ()
    extends typingsJapgolly.firebase.databaseDistDatabaseMod.Database
  
  @JSImport("firebase/database", "OnDisconnect")
  @js.native
  /* private */ open class OnDisconnect_ ()
    extends typingsJapgolly.firebase.databaseDistDatabaseMod.OnDisconnect_
  
  /* note: abstract class */ @JSImport("firebase/database", "QueryConstraint")
  @js.native
  open class QueryConstraint ()
    extends typingsJapgolly.firebase.databaseDistDatabaseMod.QueryConstraint
  
  @JSImport("firebase/database", "TransactionResult")
  @js.native
  /* private */ open class TransactionResult ()
    extends typingsJapgolly.firebase.databaseDistDatabaseMod.TransactionResult
