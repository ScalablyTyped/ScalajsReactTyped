...
import typingsJapgolly.firebase.mod.analytics.EventNameString
import typingsJapgolly.firebase.mod.database.EventType
import typingsJapgolly.firebase.mod.firestore.DocumentChangeType
import typingsJapgolly.firebase.mod.firestore.FirestoreErrorCode
import typingsJapgolly.firebase.mod.firestore.OrderByDirection
import typingsJapgolly.firebase.mod.firestore.WhereFilterOp
import typingsJapgolly.firebase.mod.functions.FunctionsErrorCode
import typingsJapgolly.firebase.mod.remoteConfig.FetchStatus
import typingsJapgolly.firebase.mod.remoteConfig.LogLevel
import typingsJapgolly.firebase.mod.remoteConfig.ValueSource
...
object firebaseStrings {
  ...
  sealed trait debug
    extends LogLevel
       with typingsJapgolly.firebase.mod.firestore.LogLevel
