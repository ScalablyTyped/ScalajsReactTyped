...
import typingsJapgolly.firebase.compatMod.firebase.analytics.EventNameString
import typingsJapgolly.firebase.compatMod.firebase.database.EventType
import typingsJapgolly.firebase.compatMod.firebase.firestore.DocumentChangeType
import typingsJapgolly.firebase.compatMod.firebase.firestore.FirestoreErrorCode
import typingsJapgolly.firebase.compatMod.firebase.firestore.OrderByDirection
import typingsJapgolly.firebase.compatMod.firebase.firestore.TaskState
import typingsJapgolly.firebase.compatMod.firebase.firestore.WhereFilterOp
import typingsJapgolly.firebase.compatMod.firebase.functions.FunctionsErrorCode
import typingsJapgolly.firebase.compatMod.firebase.remoteConfig.FetchStatus
import typingsJapgolly.firebase.compatMod.firebase.remoteConfig.LogLevel
import typingsJapgolly.firebase.compatMod.firebase.remoteConfig.ValueSource
...
object firebaseStrings {
  ...
  sealed trait debug
    extends StObject
       with LogLevel
       with typingsJapgolly.firebase.compatMod.firebase.LogLevel
       with typingsJapgolly.firebase.compatMod.firebase.firestore.LogLevel
