...
import typingsJapgolly.preact.mod.ErrorInfo
...
open class Component[P, S] () extends StObject {
  ...
  def render(): typingsJapgolly.preact.mod.ComponentChild = js.native
  def render(props: Unit, state: S): typingsJapgolly.preact.mod.ComponentChild = js.native
  def render(props: Unit, state: S, context: Any): typingsJapgolly.preact.mod.ComponentChild = js.native
  def render(props: Unit, state: Unit, context: Any): typingsJapgolly.preact.mod.ComponentChild = js.native
  def render(props: RenderableProps[P, Any]): typingsJapgolly.preact.mod.ComponentChild = js.native
  def render(props: RenderableProps[P, Any], state: S): typingsJapgolly.preact.mod.ComponentChild = js.native
  def render(props: RenderableProps[P, Any], state: S, context: Any): typingsJapgolly.preact.mod.ComponentChild = js.native
  def render(props: RenderableProps[P, Any], state: Unit, context: Any): typingsJapgolly.preact.mod.ComponentChild = js.native
...
object Component {
  ...
  @js.native
  def contextType: js.UndefOr[typingsJapgolly.preact.mod.Context[Any]] = js.native
  inline def contextType_=(x: js.UndefOr[typingsJapgolly.preact.mod.Context[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("contextType")(x.asInstanceOf[js.Any])
