...
object FocusTrapReact {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def containerElements(value: js.Array[HTMLElement]): this.type = set("containerElements", value.asInstanceOf[js.Any])
    
    inline def containerElementsVarargs(value: HTMLElement*): this.type = set("containerElements", js.Array(value*))
    ...
    inline def focusTrapOptions(value: Options): this.type = set("focusTrapOptions", value.asInstanceOf[js.Any])
