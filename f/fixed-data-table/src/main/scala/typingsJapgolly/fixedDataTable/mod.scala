...
object mod {
  ...
  object ColumnGroupProps {
    ...
    inline def apply(header: String | Element | (js.Function1[/* props */ CellProps, String | Element])): ColumnGroupProps = {
    ...
    extension [Self <: ColumnGroupProps](x: Self) {
      ...
      inline def setHeader(value: String | Element | (js.Function1[/* props */ CellProps, String | Element])): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
      
      inline def setHeaderFunction1(value: /* props */ CellProps => String | Element): Self = StObject.set(x, "header", js.Any.fromFunction1(value))
      ...
      inline def setRefFunction1(value: ColumnGroup | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: ColumnGroup | Null) => value(t0).runNow()))
  ...
  object ColumnProps {
    ...
    extension [Self <: ColumnProps](x: Self) {
      ...
      inline def setCell(value: String | Element | (js.Function1[/* props */ CellProps, String | Element])): Self = StObject.set(x, "cell", value.asInstanceOf[js.Any])
      
      inline def setCellFunction1(value: /* props */ CellProps => String | Element): Self = StObject.set(x, "cell", js.Any.fromFunction1(value))
      ...
      inline def setFooter(value: String | Element | (js.Function1[/* props */ CellProps, String | Element])): Self = StObject.set(x, "footer", value.asInstanceOf[js.Any])
      
      inline def setFooterFunction1(value: /* props */ CellProps => String | Element): Self = StObject.set(x, "footer", js.Any.fromFunction1(value))
      ...
      inline def setRefFunction1(value: Column | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: Column | Null) => value(t0).runNow()))
  ...
  object TableProps {
    ...
    extension [Self <: TableProps](x: Self) {
      ...
      inline def setRefFunction1(value: Table | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: Table | Null) => value(t0).runNow()))
