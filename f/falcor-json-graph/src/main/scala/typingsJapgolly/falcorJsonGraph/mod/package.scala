...
package object mod {
  ...
  /**
    ...
    **/
  type KeySet = typingsJapgolly.falcorJsonGraph.mod.Key | typingsJapgolly.falcorJsonGraph.mod.Range | (js.Array[
    typingsJapgolly.falcorJsonGraph.mod.Key | typingsJapgolly.falcorJsonGraph.mod.Range
  ])
  /**
    * An ordered list of {@link Key}s that point to a value in a {@link JSONGraph}.
    **/
  type Path = js.Array[typingsJapgolly.falcorJsonGraph.mod.Key]
  /**
    ...
    **/
  type PathSet = js.Array[typingsJapgolly.falcorJsonGraph.mod.KeySet]
}
