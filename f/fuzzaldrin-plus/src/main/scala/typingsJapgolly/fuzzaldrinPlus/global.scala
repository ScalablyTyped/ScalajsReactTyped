...
import typingsJapgolly.fuzzaldrinPlus.mod.IFilterOptions
import typingsJapgolly.fuzzaldrinPlus.mod.IOptions
...
object global {
  ...
  object fuzzaldrin {
    ...
    @js.native
    open class Query ()
      extends typingsJapgolly.fuzzaldrinPlus.mod.Query
    ...
    inline def prepareQuery(query: String): typingsJapgolly.fuzzaldrinPlus.mod.Query = ^.asInstanceOf[js.Dynamic].applyDynamic("prepareQuery")(query.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.fuzzaldrinPlus.mod.Query]
    inline def prepareQuery(query: String, options: IOptions): typingsJapgolly.fuzzaldrinPlus.mod.Query = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareQuery")(query.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fuzzaldrinPlus.mod.Query]
