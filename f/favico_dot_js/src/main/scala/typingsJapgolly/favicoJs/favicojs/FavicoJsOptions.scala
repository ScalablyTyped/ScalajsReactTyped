package typingsJapgolly.favicoJs.favicojs
...
object FavicoJsOptions {
  ...
  def apply(
    ...
    bgColor: String = null,
    dataUrl: /* url */ String => CallbackTo[js.Any] = null,
    ...
    if (dataUrl != null) __obj.updateDynamic("dataUrl")(js.Any.fromFunction1((t0: /* url */ java.lang.String) => dataUrl(t0).runNow()))
