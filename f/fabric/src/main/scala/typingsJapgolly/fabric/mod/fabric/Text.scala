...
object Text extends js.Object {
  ...
  /**
  	 ...
  	 */
  def fromObject(`object`: js.Any): typingsJapgolly.fabric.fabricImplMod.Text = js.native
  def fromObject(`object`: js.Any, callback: js.Function): typingsJapgolly.fabric.fabricImplMod.Text = js.native
}
