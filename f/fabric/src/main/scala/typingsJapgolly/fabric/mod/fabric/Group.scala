...
import typingsJapgolly.fabric.fabricImplMod.IGroupOptions
...
/**
	 ...
	 */
class Group ()
  extends typingsJapgolly.fabric.fabricImplMod.Group {
  def this(objects: js.Array[typingsJapgolly.fabric.fabricImplMod.Object]) = this()
  def this(objects: js.Array[typingsJapgolly.fabric.fabricImplMod.Object], options: IGroupOptions) = this()
  def this(
    objects: js.Array[typingsJapgolly.fabric.fabricImplMod.Object],
