...
import typingsJapgolly.fabric.mod.fabric.^
...
inline def createCanvasForNode(width: Double, height: Double): typingsJapgolly.fabric.fabricImplMod.Canvas = (^.asInstanceOf[js.Dynamic].applyDynamic("createCanvasForNode")(width.asInstanceOf[js.Any], height.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fabric.fabricImplMod.Canvas]

inline def createSVGFontFacesMarkup(objects: js.Array[typingsJapgolly.fabric.fabricImplMod.Object]): String = ^.asInstanceOf[js.Dynamic].applyDynamic("createSVGFontFacesMarkup")(objects.asInstanceOf[js.Any]).asInstanceOf[String]

inline def createSVGRefElementsMarkup(canvas: typingsJapgolly.fabric.fabricImplMod.StaticCanvas): String = ^.asInstanceOf[js.Dynamic].applyDynamic("createSVGRefElementsMarkup")(canvas.asInstanceOf[js.Any]).asInstanceOf[String]
