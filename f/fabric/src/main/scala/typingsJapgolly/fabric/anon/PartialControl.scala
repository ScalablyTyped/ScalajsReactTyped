...
import typingsJapgolly.fabric.fabricImplMod.Control
import typingsJapgolly.fabric.fabricImplMod.ControlMouseEventHandler
import typingsJapgolly.fabric.fabricImplMod.Object
import typingsJapgolly.fabric.fabricImplMod.Point
import typingsJapgolly.fabric.fabricImplMod.Transform
...
object PartialControl {
  ...
  extension [Self <: PartialControl](x: Self) {
    ...
    inline def setCalcCornerCoords(
      value: (/* objectAngle */ Double, /* objectCornerSize */ Double, /* centerX */ Double, /* centerY */ Double, /* isTouch */ Boolean) => Callback
    ): Self = StObject.set(x, "calcCornerCoords", js.Any.fromFunction5((t0: /* objectAngle */ Double, t1: /* objectCornerSize */ Double, t2: /* centerX */ Double, t3: /* centerY */ Double, t4: /* isTouch */ Boolean) => (value(t0, t1, t2, t3, t4)).runNow()))
    ...
    inline def setRender(
      value: (/* ctx */ CanvasRenderingContext2D, /* left */ Double, /* top */ Double, /* styleOverride */ Any, /* fabricObject */ Object) => Callback
    ): Self = StObject.set(x, "render", js.Any.fromFunction5((t0: /* ctx */ CanvasRenderingContext2D, t1: /* left */ Double, t2: /* top */ Double, t3: /* styleOverride */ Any, t4: /* fabricObject */ Object) => (value(t0, t1, t2, t3, t4)).runNow()))
    
    inline def setRenderUndefined: Self = StObject.set(x, "render", js.undefined)
    
    inline def setSetVisibility(value: /* visibility */ Boolean => Callback): Self = StObject.set(x, "setVisibility", js.Any.fromFunction1((t0: /* visibility */ Boolean) => value(t0).runNow()))
