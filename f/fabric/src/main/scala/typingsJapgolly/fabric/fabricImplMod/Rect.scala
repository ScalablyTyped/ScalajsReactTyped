...
object Rect {
  ...
  /**
    ...
    */
  inline def fromObject(`object`: Any): Rect = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[Rect]
}
