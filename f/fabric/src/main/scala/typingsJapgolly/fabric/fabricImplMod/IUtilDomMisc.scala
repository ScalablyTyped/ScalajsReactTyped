...
import typingsJapgolly.fabric.AnonLeftTop
...
trait IUtilDomMisc extends js.Object {
  ...
  def getById(id: typingsJapgolly.std.HTMLElement): HTMLElement = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def wrapElement(element: HTMLElement, wrapper: typingsJapgolly.std.HTMLElement): HTMLElement = js.native
  def wrapElement(element: HTMLElement, wrapper: typingsJapgolly.std.HTMLElement, attributes: js.Any): HTMLElement = js.native
}
