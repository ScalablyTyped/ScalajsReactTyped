...
import typingsJapgolly.fabric.anon.Baseline
import typingsJapgolly.fabric.anon.CharIndex
import typingsJapgolly.fabric.anon.DeltaY
import typingsJapgolly.fabric.anon.FontFamily
import typingsJapgolly.fabric.anon.GraphemeLines
import typingsJapgolly.fabric.anon.KernedWidth
import typingsJapgolly.fabric.anon.LeftTop
import typingsJapgolly.fabric.anon.NumOfSpaces
import typingsJapgolly.fabric.fabricStrings._empty
import typingsJapgolly.fabric.fabricStrings.italic
import typingsJapgolly.fabric.fabricStrings.ltr
import typingsJapgolly.fabric.fabricStrings.normal
import typingsJapgolly.fabric.fabricStrings.oblique
import typingsJapgolly.fabric.fabricStrings.rtl
...
open class Text protected () extends Object {
  ...
  /**
    ...
    * @private
    */
  def _generateStyleMap(textInfo: GraphemeLines): NumberDictionary[typingsJapgolly.fabric.anon.Line] = js.native
