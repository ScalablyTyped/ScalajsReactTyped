...
import typingsJapgolly.fabric.AnonTl
...
object IStaticCanvasOptions {
  ...
  def apply(
    ...
    clipTo: /* context */ CanvasRenderingContext2D => Callback = null,
    ...
    if (clipTo != null) __obj.updateDynamic("clipTo")(js.Any.fromFunction1((t0: /* context */ org.scalajs.dom.raw.CanvasRenderingContext2D) => clipTo(t0).runNow()))
