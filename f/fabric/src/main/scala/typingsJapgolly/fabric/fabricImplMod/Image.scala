...
import typingsJapgolly.fabric.AnonHeight
...
class Image () extends Object {
  ...
  /**
  	 ...
  	 * @param [options] Options object
  	 */
  def setElement(element: typingsJapgolly.std.HTMLImageElement): Image = js.native
  def setElement(element: typingsJapgolly.std.HTMLImageElement, options: IImageOptions): Image = js.native
  def setElement(element: typingsJapgolly.std.HTMLVideoElement): Image = js.native
  def setElement(element: typingsJapgolly.std.HTMLVideoElement, options: IImageOptions): Image = js.native
  /**
