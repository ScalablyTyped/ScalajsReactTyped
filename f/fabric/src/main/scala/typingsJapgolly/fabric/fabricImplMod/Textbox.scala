...
- typingsJapgolly.fabric.fabricImplMod.TextOptions because Already inherited
- typingsJapgolly.fabric.fabricImplMod.ITextOptions because Already inherited
...
open class Textbox protected () extends IText {
  ...
  /**
    ...
    */
  var _styleMap: js.UndefOr[NumberDictionary[typingsJapgolly.fabric.anon.Line]] = js.native
