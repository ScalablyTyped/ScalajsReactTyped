...
import typingsJapgolly.fuseJs.anon.Keys
import typingsJapgolly.fuseJs.mod.Fuse.FuseGetFunction
import typingsJapgolly.fuseJs.mod.Fuse.FuseIndex
import typingsJapgolly.fuseJs.mod.Fuse.FuseIndexOptions
import typingsJapgolly.fuseJs.mod.Fuse.FuseIndexRecords
import typingsJapgolly.fuseJs.mod.Fuse.FuseOptionKey
import typingsJapgolly.fuseJs.mod.Fuse.FuseSortFunction
import typingsJapgolly.fuseJs.mod.Fuse.FuseSortFunctionArg
import typingsJapgolly.fuseJs.mod.Fuse.IFuseOptions
...
object default {
  ...
  open class FuseIndex[T] ()
    extends StObject
       with typingsJapgolly.fuseJs.mod.Fuse.FuseIndex[T] {
  ...
  /**
    ...
    */
  /* static member */
  inline def createIndex[U](keys: js.Array[FuseOptionKey[U]], list: js.Array[U]): typingsJapgolly.fuseJs.mod.Fuse.FuseIndex[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("createIndex")(keys.asInstanceOf[js.Any], list.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fuseJs.mod.Fuse.FuseIndex[U]]
  inline def createIndex[U](keys: js.Array[FuseOptionKey[U]], list: js.Array[U], options: FuseIndexOptions[U]): typingsJapgolly.fuseJs.mod.Fuse.FuseIndex[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("createIndex")(keys.asInstanceOf[js.Any], list.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fuseJs.mod.Fuse.FuseIndex[U]]
  
  /* static member */
  inline def parseIndex[U](index: Any): typingsJapgolly.fuseJs.mod.Fuse.FuseIndex[U] = ^.asInstanceOf[js.Dynamic].applyDynamic("parseIndex")(index.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.fuseJs.mod.Fuse.FuseIndex[U]]
  inline def parseIndex[U](index: Any, options: FuseIndexOptions[U]): typingsJapgolly.fuseJs.mod.Fuse.FuseIndex[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("parseIndex")(index.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fuseJs.mod.Fuse.FuseIndex[U]]
