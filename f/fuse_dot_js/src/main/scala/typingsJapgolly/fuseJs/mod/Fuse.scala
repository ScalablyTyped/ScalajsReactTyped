...
import typingsJapgolly.fuseJs.anon.Idx
import typingsJapgolly.fuseJs.anon.Keys
import typingsJapgolly.fuseJs.anon.RecordEntryObjectinumber
import typingsJapgolly.fuseJs.anon._empty
import typingsJapgolly.fuseJs.mod.Fuse.Expression
import typingsJapgolly.fuseJs.mod.Fuse.FuseIndex
import typingsJapgolly.fuseJs.mod.Fuse.FuseResult
import typingsJapgolly.fuseJs.mod.Fuse.FuseSearchOptions
...
object Fuse {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.fuseJs.anon.Path
    - typingsJapgolly.fuseJs.anon.And
    - typingsJapgolly.fuseJs.anon.Or
  */
  ...
  object FuseIndex {
    ...
    inline def apply[T](
      add: T => Callback,
      create: Callback,
      setIndexRecords: FuseIndexRecords => Callback,
      setKeys: js.Array[String] => Callback,
      setSources: js.Array[T] => Callback,
      toJSON: CallbackTo[Keys]
    ): FuseIndex[T] = {
      val __obj = js.Dynamic.literal(add = js.Any.fromFunction1((t0: T) => add(t0).runNow()), create = create.toJsFn, setIndexRecords = js.Any.fromFunction1((t0: FuseIndexRecords) => setIndexRecords(t0).runNow()), setKeys = js.Any.fromFunction1((t0: js.Array[String]) => setKeys(t0).runNow()), setSources = js.Any.fromFunction1((t0: js.Array[T]) => setSources(t0).runNow()), toJSON = toJSON.toJsFn)
    ...
    extension [Self <: FuseIndex[?], T](x: Self & FuseIndex[T]) {
      ...
      inline def setSetIndexRecords(value: FuseIndexRecords => Callback): Self = StObject.set(x, "setIndexRecords", js.Any.fromFunction1((t0: FuseIndexRecords) => value(t0).runNow()))
      
      inline def setSetKeys(value: js.Array[String] => Callback): Self = StObject.set(x, "setKeys", js.Any.fromFunction1((t0: js.Array[String]) => value(t0).runNow()))
      
      inline def setSetSources(value: js.Array[T] => Callback): Self = StObject.set(x, "setSources", js.Any.fromFunction1((t0: js.Array[T]) => value(t0).runNow()))
      
      inline def setToJSON(value: CallbackTo[Keys]): Self = StObject.set(x, "toJSON", value.toJsFn)
    }
  }
  ...
  object _Expression {
    ...
    inline def And(): typingsJapgolly.fuseJs.anon.And = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.fuseJs.anon.And]
    }
    
    inline def Or(): typingsJapgolly.fuseJs.anon.Or = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.fuseJs.anon.Or]
    }
    
    inline def Path($path: js.Array[String], $val: String): typingsJapgolly.fuseJs.anon.Path = {
      val __obj = js.Dynamic.literal($path = $path.asInstanceOf[js.Any], $val = $val.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.fuseJs.anon.Path]
    }
  }
}
