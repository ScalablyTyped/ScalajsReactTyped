package typingsJapgolly.flatbuffers
...
object mod {
  ...
  object flatbuffers {
    ...
    @js.native
    open class Builder ()
      extends typingsJapgolly.flatbuffers.mod.global.flatbuffers.Builder {
    ...
    object Builder {
      ...
      /**
        ...
        */
      /* static member */
      inline def growByteBuffer(bb: typingsJapgolly.flatbuffers.mod.global.flatbuffers.ByteBuffer): typingsJapgolly.flatbuffers.mod.global.flatbuffers.ByteBuffer = ^.asInstanceOf[js.Dynamic].applyDynamic("growByteBuffer")(bb.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.flatbuffers.mod.global.flatbuffers.ByteBuffer]
    }
    ...
    open class ByteBuffer protected ()
      extends typingsJapgolly.flatbuffers.mod.global.flatbuffers.ByteBuffer {
    ...
    object ByteBuffer {
      ...
      /* static member */
      inline def allocate(byte_size: Double): typingsJapgolly.flatbuffers.mod.global.flatbuffers.ByteBuffer = ^.asInstanceOf[js.Dynamic].applyDynamic("allocate")(byte_size.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.flatbuffers.mod.global.flatbuffers.ByteBuffer]
    }
    ...
    object Encoding extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.flatbuffers.mod.global.flatbuffers.Encoding & Double] = js.native
      
      /* 1 */ val UTF16_STRING: typingsJapgolly.flatbuffers.mod.global.flatbuffers.Encoding.UTF16_STRING & Double = js.native
      
      /* 0 */ val UTF8_BYTES: typingsJapgolly.flatbuffers.mod.global.flatbuffers.Encoding.UTF8_BYTES & Double = js.native
    }
    ...
    open class Long protected ()
      extends typingsJapgolly.flatbuffers.mod.global.flatbuffers.Long {
    ...
    object Long {
      ...
      @js.native
      def ZERO: typingsJapgolly.flatbuffers.mod.global.flatbuffers.Long = js.native
      inline def ZERO_=(x: typingsJapgolly.flatbuffers.mod.global.flatbuffers.Long): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ZERO")(x.asInstanceOf[js.Any])
      
      /* static member */
      inline def create(low: Double, high: Double): typingsJapgolly.flatbuffers.mod.global.flatbuffers.Long = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(low.asInstanceOf[js.Any], high.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.flatbuffers.mod.global.flatbuffers.Long]
    }
