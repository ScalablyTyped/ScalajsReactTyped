...
import typingsJapgolly.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginBooleans.`false`
import typingsJapgolly.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginStrings.`0Dot8`
import typingsJapgolly.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginStrings.`3Dot8`
import typingsJapgolly.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginStrings.dts
import typingsJapgolly.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginStrings.js_
...
trait Typeofts extends js.Object {
  ...
  def visitEachChild[T /* <: Node */](
    ...
    nodesVisitor: typingsJapgolly.typescript.FnCall
  ): js.UndefOr[T] = js.native
  def visitEachChild[T /* <: Node */](
    node: T,
    visitor: Visitor,
