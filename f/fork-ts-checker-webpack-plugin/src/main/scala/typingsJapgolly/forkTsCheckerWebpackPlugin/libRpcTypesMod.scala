...
import typingsJapgolly.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginStrings.call
import typingsJapgolly.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginStrings.reject
import typingsJapgolly.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginStrings.resolve
...
object libRpcTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.forkTsCheckerWebpackPlugin.libRpcTypesMod.RpcCallMessage
    - typingsJapgolly.forkTsCheckerWebpackPlugin.libRpcTypesMod.RpcResolveMessage
    - typingsJapgolly.forkTsCheckerWebpackPlugin.libRpcTypesMod.RpcRejectMessage
  */
  trait RpcMessage extends StObject
  object RpcMessage {
    
    inline def RpcCallMessage(args: js.Array[Any], id: String): typingsJapgolly.forkTsCheckerWebpackPlugin.libRpcTypesMod.RpcCallMessage = {
      val __obj = js.Dynamic.literal(args = args.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("call")
      __obj.asInstanceOf[typingsJapgolly.forkTsCheckerWebpackPlugin.libRpcTypesMod.RpcCallMessage]
    }
    
    inline def RpcRejectMessage(error: Any, id: String): typingsJapgolly.forkTsCheckerWebpackPlugin.libRpcTypesMod.RpcRejectMessage = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("reject")
      __obj.asInstanceOf[typingsJapgolly.forkTsCheckerWebpackPlugin.libRpcTypesMod.RpcRejectMessage]
    }
    
    inline def RpcResolveMessage(id: String, value: Any): typingsJapgolly.forkTsCheckerWebpackPlugin.libRpcTypesMod.RpcResolveMessage = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("resolve")
      __obj.asInstanceOf[typingsJapgolly.forkTsCheckerWebpackPlugin.libRpcTypesMod.RpcResolveMessage]
    }
  }
