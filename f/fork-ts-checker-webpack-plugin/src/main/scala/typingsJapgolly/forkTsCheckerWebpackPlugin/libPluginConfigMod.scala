...
import typingsJapgolly.forkTsCheckerWebpackPlugin.libIssueIssueConfigMod.IssueConfig
...
import typingsJapgolly.forkTsCheckerWebpackPlugin.libPluginOptionsMod.ForkTsCheckerWebpackPluginOptions
