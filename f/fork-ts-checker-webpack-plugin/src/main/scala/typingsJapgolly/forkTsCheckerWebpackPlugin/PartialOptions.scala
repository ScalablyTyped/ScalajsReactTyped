...
import typingsJapgolly.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginBooleans.`true`
import typingsJapgolly.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginStrings.codeframe
import typingsJapgolly.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginStrings.default
import typingsJapgolly.forkTsCheckerWebpackPlugin.mod.Formatter
import typingsJapgolly.forkTsCheckerWebpackPlugin.mod.Logger
...
object PartialOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(tslintAutoFix)) __obj.updateDynamic("tslintAutoFix")(tslintAutoFix.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(vue)) __obj.updateDynamic("vue")(vue.asInstanceOf[js.Any])
