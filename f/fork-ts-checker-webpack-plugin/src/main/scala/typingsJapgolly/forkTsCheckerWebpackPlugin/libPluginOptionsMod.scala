...
import typingsJapgolly.forkTsCheckerWebpackPlugin.forkTsCheckerWebpackPluginStrings.`webpack-infrastructure`
import typingsJapgolly.forkTsCheckerWebpackPlugin.libFormatterFormatterOptionsMod.FormatterOptions
...
import typingsJapgolly.forkTsCheckerWebpackPlugin.libLoggerMod.Logger
