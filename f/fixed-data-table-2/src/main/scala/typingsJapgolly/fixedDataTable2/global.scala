...
object global {
  ...
  object FixedDataTable {
    ...
    open class Cell protected ()
      extends typingsJapgolly.fixedDataTable2.mod.Cell {
    ...
    open class Column protected ()
      extends typingsJapgolly.fixedDataTable2.mod.Column {
    ...
    open class ColumnGroup protected ()
      extends typingsJapgolly.fixedDataTable2.mod.ColumnGroup {
    ...
    open class Table protected ()
      extends typingsJapgolly.fixedDataTable2.mod.Table {
