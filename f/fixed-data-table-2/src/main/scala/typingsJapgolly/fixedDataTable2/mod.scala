...
object mod {
  ...
  object ColumnGroupProps {
    ...
    extension [Self <: ColumnGroupProps](x: Self) {
      ...
      inline def setHeader(value: String | Element | (js.Function1[/* props */ ColumnGroupHeaderProps, String | Element])): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
      
      inline def setHeaderFunction1(value: /* props */ ColumnGroupHeaderProps => String | Element): Self = StObject.set(x, "header", js.Any.fromFunction1(value))
  ...
  object ColumnProps {
    ...
    extension [Self <: ColumnProps](x: Self) {
      ...
      inline def setCellFunction1(value: ColumnCellProps => String | Element): Self = StObject.set(x, "cell", js.Any.fromFunction1(value))
      ...
      inline def setFooterFunction1(value: ColumnHeaderProps => String | Element): Self = StObject.set(x, "footer", js.Any.fromFunction1(value))
      ...
      inline def setHeaderFunction1(value: ColumnHeaderProps => String | Element): Self = StObject.set(x, "header", js.Any.fromFunction1(value))
  ...
  type ElementOrFunc[P] = String | Element | (js.Function1[/* props */ P, String | Element])
  ...
  object TableProps {
    ...
    extension [Self <: TableProps](x: Self) {
      ...
      inline def setOnColumnReorderEndCallback(value: /* event */ ColumnReorderEndEvent => Callback): Self = StObject.set(x, "onColumnReorderEndCallback", js.Any.fromFunction1((t0: /* event */ ColumnReorderEndEvent) => value(t0).runNow()))
      
      inline def setOnColumnReorderEndCallbackUndefined: Self = StObject.set(x, "onColumnReorderEndCallback", js.undefined)
      
      inline def setOnColumnResizeEndCallback(value: (/* newColumnWidth */ Double, /* columnKey */ String) => Callback): Self = StObject.set(x, "onColumnResizeEndCallback", js.Any.fromFunction2((t0: /* newColumnWidth */ Double, t1: /* columnKey */ String) => (value(t0, t1)).runNow()))
      
      inline def setOnColumnResizeEndCallbackUndefined: Self = StObject.set(x, "onColumnResizeEndCallback", js.undefined)
      
      inline def setOnContentHeightChange(value: /* newHeight */ Double => Callback): Self = StObject.set(x, "onContentHeightChange", js.Any.fromFunction1((t0: /* newHeight */ Double) => value(t0).runNow()))
      ...
      inline def setOnRowClick(
        value: (/* event */ ReactEventFrom[Table & org.scalajs.dom.Element], /* rowIndex */ Double) => Callback
      ): Self = StObject.set(x, "onRowClick", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Table & org.scalajs.dom.Element], t1: /* rowIndex */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnRowClickUndefined: Self = StObject.set(x, "onRowClick", js.undefined)
      
      inline def setOnRowContextMenu(
        value: (/* event */ ReactEventFrom[Table & org.scalajs.dom.Element], /* rowIndex */ Double) => Callback
      ): Self = StObject.set(x, "onRowContextMenu", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Table & org.scalajs.dom.Element], t1: /* rowIndex */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnRowContextMenuUndefined: Self = StObject.set(x, "onRowContextMenu", js.undefined)
      
      inline def setOnRowDoubleClick(
        value: (/* event */ ReactEventFrom[Table & org.scalajs.dom.Element], /* rowIndex */ Double) => Callback
      ): Self = StObject.set(x, "onRowDoubleClick", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Table & org.scalajs.dom.Element], t1: /* rowIndex */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnRowDoubleClickUndefined: Self = StObject.set(x, "onRowDoubleClick", js.undefined)
      
      inline def setOnRowMouseDown(
        value: (/* event */ ReactEventFrom[Table & org.scalajs.dom.Element], /* rowIndex */ Double) => Callback
      ): Self = StObject.set(x, "onRowMouseDown", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Table & org.scalajs.dom.Element], t1: /* rowIndex */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnRowMouseDownUndefined: Self = StObject.set(x, "onRowMouseDown", js.undefined)
      
      inline def setOnRowMouseEnter(
        value: (/* event */ ReactEventFrom[Table & org.scalajs.dom.Element], /* rowIndex */ Double) => Callback
      ): Self = StObject.set(x, "onRowMouseEnter", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Table & org.scalajs.dom.Element], t1: /* rowIndex */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnRowMouseEnterUndefined: Self = StObject.set(x, "onRowMouseEnter", js.undefined)
      
      inline def setOnRowMouseLeave(
        value: (/* event */ ReactEventFrom[Table & org.scalajs.dom.Element], /* rowIndex */ Double) => Callback
      ): Self = StObject.set(x, "onRowMouseLeave", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Table & org.scalajs.dom.Element], t1: /* rowIndex */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnRowMouseLeaveUndefined: Self = StObject.set(x, "onRowMouseLeave", js.undefined)
      
      inline def setOnRowMouseUp(
        value: (/* event */ ReactEventFrom[Table & org.scalajs.dom.Element], /* rowIndex */ Double) => Callback
      ): Self = StObject.set(x, "onRowMouseUp", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Table & org.scalajs.dom.Element], t1: /* rowIndex */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnRowMouseUpUndefined: Self = StObject.set(x, "onRowMouseUp", js.undefined)
      
      inline def setOnRowTouchEnd(
        value: (/* event */ ReactEventFrom[Table & org.scalajs.dom.Element], /* rowIndex */ Double) => Callback
      ): Self = StObject.set(x, "onRowTouchEnd", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Table & org.scalajs.dom.Element], t1: /* rowIndex */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnRowTouchEndUndefined: Self = StObject.set(x, "onRowTouchEnd", js.undefined)
      
      inline def setOnRowTouchMove(
        value: (/* event */ ReactEventFrom[Table & org.scalajs.dom.Element], /* rowIndex */ Double) => Callback
      ): Self = StObject.set(x, "onRowTouchMove", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Table & org.scalajs.dom.Element], t1: /* rowIndex */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnRowTouchMoveUndefined: Self = StObject.set(x, "onRowTouchMove", js.undefined)
      
      inline def setOnRowTouchStart(
        value: (/* event */ ReactEventFrom[Table & org.scalajs.dom.Element], /* rowIndex */ Double) => Callback
      ): Self = StObject.set(x, "onRowTouchStart", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Table & org.scalajs.dom.Element], t1: /* rowIndex */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnRowTouchStartUndefined: Self = StObject.set(x, "onRowTouchStart", js.undefined)
      
      inline def setOnScrollEnd(value: (/* x */ Double, /* y */ Double) => Callback): Self = StObject.set(x, "onScrollEnd", js.Any.fromFunction2((t0: /* x */ Double, t1: /* y */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnScrollEndUndefined: Self = StObject.set(x, "onScrollEnd", js.undefined)
      
      inline def setOnScrollStart(value: (/* x */ Double, /* y */ Double) => Callback): Self = StObject.set(x, "onScrollStart", js.Any.fromFunction2((t0: /* x */ Double, t1: /* y */ Double) => (value(t0, t1)).runNow()))
      ...
      inline def setRowExpandedFunction1(value: RowProps => String | Element): Self = StObject.set(x, "rowExpanded", js.Any.fromFunction1(value))
      
      inline def setRowExpandedUndefined: Self = StObject.set(x, "rowExpanded", js.undefined)
      
      inline def setRowExpandedVdomElement(value: VdomElement): Self = StObject.set(x, "rowExpanded", value.rawElement.asInstanceOf[js.Any])
  ...
  type TableRowEventHandler = js.Function2[
    /* event */ ReactEventFrom[Table & org.scalajs.dom.Element], 
    /* rowIndex */ Double, 
    Unit
  ]
}
