...
object Field {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[js.Any with js.Object, typingsJapgolly.formik.mod.Field, Unit, js.Any with js.Object] = {
  ...
  typingsJapgolly.formik.mod.Field](this.componentImport)
