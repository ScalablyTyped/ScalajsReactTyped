...
import typingsJapgolly.formik.distTypesMod.FormikState
import typingsJapgolly.formik.distTypesMod.FormikTouched
import typingsJapgolly.formik.distTypesMod.FormikValues
import typingsJapgolly.formik.formikStrings.`additions removals`
import typingsJapgolly.formik.formikStrings.`additions text`
import typingsJapgolly.formik.formikStrings.`inline`
import typingsJapgolly.formik.formikStrings.`removals additions`
import typingsJapgolly.formik.formikStrings.`removals text`
import typingsJapgolly.formik.formikStrings.`text additions`
import typingsJapgolly.formik.formikStrings.`text removals`
...
object anon {
  ...
  trait Dirty[Values /* <: FormikValues */] extends StObject {
    ...
    def handleBlur(e: ReactFocusEventFrom[Any & Element]): Unit = js.native
    ...
    def handleChange(e: ReactEventFrom[Any & Element]): Unit = js.native
  ...
  trait FnCall extends StObject {
    ...
    def apply(e: ReactEventFrom[Any & Element]): Unit = js.native
  ...
  trait FnCallE extends StObject {
    ...
    def apply(e: ReactFocusEventFrom[Any & Element]): Unit = js.native
  ...
  object Formik {
    ...
    inline def apply[Values](formik: FormikContextType[Values]): Formik[Values] = {
  ...
  trait PickDetailedHTMLPropsForm extends StObject {
    ...
    var ref: js.UndefOr[Ref[HTMLFormElement]] = js.undefined
  ...
  object PickDetailedHTMLPropsForm {
    ...
    inline def apply(): PickDetailedHTMLPropsForm = {
    ...
    extension [Self <: PickDetailedHTMLPropsForm](x: Self) {
      ...
      inline def setOnChange(value: ReactEventFrom[HTMLFormElement & Element] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: ReactEventFrom[HTMLFormElement & Element]) => value(t0).runNow()))
      ...
      inline def setOnSubmit(value: ReactEventFrom[HTMLFormElement & Element] => Callback): Self = StObject.set(x, "onSubmit", js.Any.fromFunction1((t0: ReactEventFrom[HTMLFormElement & Element]) => value(t0).runNow()))
      ...
      inline def setRef(value: Ref[HTMLFormElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
