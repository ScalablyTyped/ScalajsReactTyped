...
import typingsJapgolly.firefoxWebextBrowser.browser.omnibox.DefaultSuggestResult
import typingsJapgolly.firefoxWebextBrowser.browser.omnibox.OnInputEnteredDisposition
import typingsJapgolly.firefoxWebextBrowser.browser.omnibox.SuggestResult
...
object Typeofomnibox {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(onInputCancelled = onInputCancelled.asInstanceOf[js.Any], onInputChanged = onInputChanged.asInstanceOf[js.Any], onInputEntered = onInputEntered.asInstanceOf[js.Any], onInputStarted = onInputStarted.asInstanceOf[js.Any])
    __obj.updateDynamic("setDefaultSuggestion")(js.Any.fromFunction1((t0: typingsJapgolly.firefoxWebextBrowser.browser.omnibox.DefaultSuggestResult) => setDefaultSuggestion(t0).runNow()))
