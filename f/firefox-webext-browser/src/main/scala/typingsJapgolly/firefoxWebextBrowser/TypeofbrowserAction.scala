...
trait TypeofbrowserAction extends js.Object {
  ...
  /**
    ...
    */
  def setBadgeBackgroundColor(details: AnonColorTabId): js.Promise[Unit] = js.native
  /**
  ...
  /**
    ...
    *     retrieved. If no tab nor window is specified, the global value is set or retrieved.
    */
  def setBadgeTextColor(details: AnonColorTabId): js.Promise[_] = js.native
  /**
    ...
    *     retrieved. If no tab nor window is specified, the global value is set or retrieved.
    */
  def setIcon(details: AnonImageData): js.Promise[Unit] = js.native
  /**
    * Sets the html document to be opened as a popup when the user clicks on the browser action's icon.
    * @param details Specifies to which tab or window the value should be set, or from which one it should be
    *     retrieved. If no tab nor window is specified, the global value is set or retrieved.
    */
  def setPopup(details: AnonPopup): js.Promise[Unit] = js.native
