...
import typingsJapgolly.firefoxWebextBrowser.browser.browserSettings.ImageAnimationBehavior_
...
import typingsJapgolly.firefoxWebextBrowser.browser.manifest._Permission
...
object firefoxWebextBrowserStrings {
  ...
  sealed trait all
    extends ContextType
       with typingsJapgolly.firefoxWebextBrowser.browser.menus.ContextType
  ...
  sealed trait auto_toplevel
    extends typingsJapgolly.firefoxWebextBrowser.browser.history.TransitionType
  ...
  sealed trait bookmark
    extends BookmarkTreeNodeType
       ...
       with typingsJapgolly.firefoxWebextBrowser.browser.menus.OverrideContextContext
  ...
  sealed trait tools_menu
    extends typingsJapgolly.firefoxWebextBrowser.browser.menus.ContextType
