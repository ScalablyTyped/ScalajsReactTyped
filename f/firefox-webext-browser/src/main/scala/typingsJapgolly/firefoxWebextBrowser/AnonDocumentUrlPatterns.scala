...
import typingsJapgolly.firefoxWebextBrowser.browser.menus.ItemType
...
object AnonDocumentUrlPatterns {
  ...
  def apply(
    ...
    if (onclick != null) __obj.updateDynamic("onclick")(js.Any.fromFunction2((t0: /* info */ typingsJapgolly.firefoxWebextBrowser.browser.menus.OnClickData, t1: /* tab */ typingsJapgolly.firefoxWebextBrowser.browser.tabs.Tab) => onclick(t0, t1).runNow()))
