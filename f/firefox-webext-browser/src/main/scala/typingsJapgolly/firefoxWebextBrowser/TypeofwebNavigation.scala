...
object TypeofwebNavigation {
  @scala.inline
  def apply(
    getAllFrames: AnonTabIdNumber => CallbackTo[js.Promise[js.Array[AnonParentFrameId]]],
    getFrame: AnonFrameId => CallbackTo[js.Promise[AnonErrorOccurred]],
    ...
    __obj.updateDynamic("getAllFrames")(js.Any.fromFunction1((t0: typingsJapgolly.firefoxWebextBrowser.AnonTabIdNumber) => getAllFrames(t0).runNow()))
    __obj.updateDynamic("getFrame")(js.Any.fromFunction1((t0: typingsJapgolly.firefoxWebextBrowser.AnonFrameId) => getFrame(t0).runNow()))
