...
import typingsJapgolly.firefoxWebextBrowser.browser.urlbar.contextualTip.ContextualTip
...
object TypeofcontextualTip {
  ...
  def apply(
    ...
    remove: Callback,
    set: ContextualTip => Callback
  ): TypeofcontextualTip = {
    val __obj = js.Dynamic.literal(onButtonClicked = onButtonClicked.asInstanceOf[js.Any], onLinkClicked = onLinkClicked.asInstanceOf[js.Any])
    __obj.updateDynamic("remove")(remove.toJsFn)
    __obj.updateDynamic("set")(js.Any.fromFunction1((t0: typingsJapgolly.firefoxWebextBrowser.browser.urlbar.contextualTip.ContextualTip) => set(t0).runNow()))
