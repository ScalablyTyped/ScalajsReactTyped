...
import typingsJapgolly.firefoxWebextBrowser.browser.management.ExtensionInfo
...
trait Typeofmanagement extends js.Object {
  ...
  def install(options: AnonHash): js.Promise[AnonId] = js.native
  /**
  ...
  def uninstallSelf(options: AnonDialogMessage): js.Promise[Unit] = js.native
}
