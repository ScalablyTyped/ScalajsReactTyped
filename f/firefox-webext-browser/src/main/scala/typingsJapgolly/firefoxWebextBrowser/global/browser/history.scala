...
import typingsJapgolly.firefoxWebextBrowser.browser.history.AddUrlDetails
import typingsJapgolly.firefoxWebextBrowser.browser.history.DeleteRangeRange
import typingsJapgolly.firefoxWebextBrowser.browser.history.DeleteUrlDetails
import typingsJapgolly.firefoxWebextBrowser.browser.history.GetVisitsDetails
import typingsJapgolly.firefoxWebextBrowser.browser.history.HistoryItem
import typingsJapgolly.firefoxWebextBrowser.browser.history.OnTitleChangedChanged
import typingsJapgolly.firefoxWebextBrowser.browser.history.OnVisitRemovedRemoved
import typingsJapgolly.firefoxWebextBrowser.browser.history.SearchQuery
