...
import typingsJapgolly.firefoxWebextBrowser.browser.i18n.DetectLanguageReturnResult
import typingsJapgolly.firefoxWebextBrowser.browser.i18n.LanguageCode
