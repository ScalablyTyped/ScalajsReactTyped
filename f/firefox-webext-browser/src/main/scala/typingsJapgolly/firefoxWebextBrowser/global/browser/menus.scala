...
import typingsJapgolly.firefoxWebextBrowser.browser.menus.CreateCreateProperties
import typingsJapgolly.firefoxWebextBrowser.browser.menus.OnClickData
import typingsJapgolly.firefoxWebextBrowser.browser.menus.OnShownInfo
import typingsJapgolly.firefoxWebextBrowser.browser.menus.OverrideContextContextOptions
import typingsJapgolly.firefoxWebextBrowser.browser.menus.UpdateUpdateProperties
