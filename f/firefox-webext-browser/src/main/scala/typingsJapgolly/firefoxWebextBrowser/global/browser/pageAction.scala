...
import typingsJapgolly.firefoxWebextBrowser.browser.pageAction.GetPopupDetails
import typingsJapgolly.firefoxWebextBrowser.browser.pageAction.GetTitleDetails
import typingsJapgolly.firefoxWebextBrowser.browser.pageAction.IsShownDetails
import typingsJapgolly.firefoxWebextBrowser.browser.pageAction.OnClickData
import typingsJapgolly.firefoxWebextBrowser.browser.pageAction.SetIconDetails
import typingsJapgolly.firefoxWebextBrowser.browser.pageAction.SetPopupDetails
import typingsJapgolly.firefoxWebextBrowser.browser.pageAction.SetTitleDetails
...
object pageAction {
  ...
  /**
    ...
    */
  inline def hide(tabId: Double): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("hide")(tabId.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  
  /** Checks whether the page action is shown. */
  inline def isShown(details: IsShownDetails): js.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("isShown")(details.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Boolean]]
  ...
  inline def setTitle(details: SetTitleDetails): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setTitle")(details.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
    ...
    * @param tabId The id of the tab for which you want to modify the page action.
    */
  inline def show(tabId: Double): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("show")(tabId.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
}
