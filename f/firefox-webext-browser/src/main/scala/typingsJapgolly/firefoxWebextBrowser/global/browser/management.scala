...
import typingsJapgolly.firefoxWebextBrowser.browser.management.InstallOptions
import typingsJapgolly.firefoxWebextBrowser.browser.management.InstallReturnResult
import typingsJapgolly.firefoxWebextBrowser.browser.management.UninstallSelfOptions
