...
import typingsJapgolly.firefoxWebextBrowser.browser.windows.CreateCreateData
import typingsJapgolly.firefoxWebextBrowser.browser.windows.GetAllGetInfo
import typingsJapgolly.firefoxWebextBrowser.browser.windows.GetInfo
import typingsJapgolly.firefoxWebextBrowser.browser.windows.UpdateUpdateInfo
import typingsJapgolly.firefoxWebextBrowser.browser.windows.Window
