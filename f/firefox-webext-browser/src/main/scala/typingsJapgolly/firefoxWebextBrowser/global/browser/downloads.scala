...
import typingsJapgolly.firefoxWebextBrowser.browser.downloads.DownloadItem
import typingsJapgolly.firefoxWebextBrowser.browser.downloads.DownloadOptions
import typingsJapgolly.firefoxWebextBrowser.browser.downloads.DownloadQuery
import typingsJapgolly.firefoxWebextBrowser.browser.downloads.GetFileIconOptions
import typingsJapgolly.firefoxWebextBrowser.browser.downloads.OnChangedDownloadDelta
