...
import typingsJapgolly.firefoxWebextBrowser.browser.action.ColorArray
import typingsJapgolly.firefoxWebextBrowser.browser.action.Details
import typingsJapgolly.firefoxWebextBrowser.browser.action.OnClickData
import typingsJapgolly.firefoxWebextBrowser.browser.action.SetBadgeBackgroundColorDetails
import typingsJapgolly.firefoxWebextBrowser.browser.action.SetBadgeTextColorDetails
import typingsJapgolly.firefoxWebextBrowser.browser.action.SetBadgeTextDetails
import typingsJapgolly.firefoxWebextBrowser.browser.action.SetIconDetails
import typingsJapgolly.firefoxWebextBrowser.browser.action.SetPopupDetails
import typingsJapgolly.firefoxWebextBrowser.browser.action.SetTitleDetails
