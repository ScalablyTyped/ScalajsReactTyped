...
import typingsJapgolly.firefoxWebextBrowser.browser.devtools.inspectedWindow.EvalOptions
import typingsJapgolly.firefoxWebextBrowser.browser.devtools.inspectedWindow.ReloadReloadOptions
...
import typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings._empty
