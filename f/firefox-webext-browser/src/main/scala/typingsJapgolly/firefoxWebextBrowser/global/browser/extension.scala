...
import typingsJapgolly.firefoxWebextBrowser.browser.`extension`.GetViewsFetchProperties
import typingsJapgolly.firefoxWebextBrowser.browser.`extension`.LastError
