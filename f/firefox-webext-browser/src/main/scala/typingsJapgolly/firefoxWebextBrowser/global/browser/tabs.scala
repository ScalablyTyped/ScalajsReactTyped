...
import typingsJapgolly.firefoxWebextBrowser.browser.extensionTypes.InjectDetails
import typingsJapgolly.firefoxWebextBrowser.browser.runtime.Port
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.ConnectConnectInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.CreateCreateProperties
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.DuplicateDuplicateProperties
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.HighlightHighlightInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.MoveInSuccessionOptions
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.MoveMoveProperties
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.OnActivatedActiveInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.OnActiveChangedSelectInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.OnAttachedAttachInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.OnDetachedDetachInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.OnHighlightChangedSelectInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.OnHighlightedHighlightInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.OnMovedMoveInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.OnRemovedRemoveInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.OnSelectionChangedSelectInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.OnUpdatedChangeInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.OnZoomChangeZoomChangeInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.PageSettings
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.QueryQueryInfo
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.ReloadReloadProperties
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.SendMessageOptions
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.Tab
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.TabsOnUpdatedEvent
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.UpdateUpdateProperties
import typingsJapgolly.firefoxWebextBrowser.browser.tabs.ZoomSettings
