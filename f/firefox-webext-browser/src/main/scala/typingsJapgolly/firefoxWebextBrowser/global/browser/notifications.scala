...
import typingsJapgolly.firefoxWebextBrowser.browser.notifications.CreateNotificationOptions
import typingsJapgolly.firefoxWebextBrowser.browser.notifications.PermissionLevel
import typingsJapgolly.firefoxWebextBrowser.browser.notifications.UpdateNotificationOptions
