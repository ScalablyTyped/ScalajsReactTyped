...
object telemetry {
  ...
  */
  ...
  object ScalarType {
    ...
    inline def boolean: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.boolean = "boolean".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.boolean]
    
    inline def count: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.count = "count".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.count]
    
    inline def string: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.string = "string".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.string]
  }
