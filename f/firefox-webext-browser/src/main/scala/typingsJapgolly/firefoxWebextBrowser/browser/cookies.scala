...
object cookies {
  ...
  */
  ...
  object OnChangedCause {
    ...
    inline def evicted: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.evicted = "evicted".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.evicted]
    
    inline def expired: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.expired = "expired".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.expired]
    
    inline def expired_overwrite: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.expired_overwrite = "expired_overwrite".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.expired_overwrite]
    
    inline def explicit: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.explicit = "explicit".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.explicit]
  ...
  */
  ...
  object SameSiteStatus {
    ...
    inline def lax: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.lax = "lax".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.lax]
    
    inline def no_restriction: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.no_restriction = "no_restriction".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.no_restriction]
    
    inline def strict: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.strict = "strict".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.strict]
  }
