...
object omnibox {
  ...
  */
  ...
  object DescriptionStyleType {
    ...
    inline def dim: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.dim = "dim".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.dim]
    
    inline def `match`: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.`match` = "match".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.`match`]
  ...
  */
  ...
  object OnInputEnteredDisposition {
    ...
    inline def currentTab: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.currentTab = "currentTab".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.currentTab]
    
    inline def newBackgroundTab: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.newBackgroundTab = "newBackgroundTab".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.newBackgroundTab]
    
    inline def newForegroundTab: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.newForegroundTab = "newForegroundTab".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.newForegroundTab]
  }
