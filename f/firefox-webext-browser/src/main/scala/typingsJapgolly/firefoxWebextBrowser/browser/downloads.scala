...
object downloads {
  ...
  */
  ...
  object DangerType {
    ...
    inline def accepted: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.accepted = "accepted".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.accepted]
    
    inline def content: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.content = "content".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.content]
    
    inline def file: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.file = "file".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.file]
    
    inline def host: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.host = "host".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.host]
    
    inline def safe: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.safe = "safe".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.safe]
    
    inline def uncommon: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.uncommon = "uncommon".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.uncommon]
    
    inline def unwanted: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.unwanted = "unwanted".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.unwanted]
  ...
  */
  ...
  object DownloadOptionsMethod {
    ...
    inline def GET: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.GET = "GET".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.GET]
    
    inline def POST: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.POST = "POST".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.POST]
  }
  ...
  */
  ...
  object FilenameConflictAction {
    ...
    inline def overwrite: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.overwrite = "overwrite".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.overwrite]
    
    inline def prompt: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.prompt = "prompt".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.prompt]
    
    inline def uniquify: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.uniquify = "uniquify".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.uniquify]
  }
  ...
  */
  ...
  object InterruptReason {
    ...
    inline def CRASH: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.CRASH = "CRASH".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.CRASH]
    
    inline def FILE_ACCESS_DENIED: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_ACCESS_DENIED = "FILE_ACCESS_DENIED".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_ACCESS_DENIED]
    
    inline def FILE_BLOCKED: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_BLOCKED = "FILE_BLOCKED".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_BLOCKED]
    
    inline def FILE_FAILED: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_FAILED = "FILE_FAILED".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_FAILED]
    
    inline def FILE_NAME_TOO_LONG: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_NAME_TOO_LONG = "FILE_NAME_TOO_LONG".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_NAME_TOO_LONG]
    
    inline def FILE_NO_SPACE: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_NO_SPACE = "FILE_NO_SPACE".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_NO_SPACE]
    
    inline def FILE_SECURITY_CHECK_FAILED: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_SECURITY_CHECK_FAILED = "FILE_SECURITY_CHECK_FAILED".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_SECURITY_CHECK_FAILED]
    
    inline def FILE_TOO_LARGE: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_TOO_LARGE = "FILE_TOO_LARGE".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_TOO_LARGE]
    
    inline def FILE_TOO_SHORT: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_TOO_SHORT = "FILE_TOO_SHORT".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_TOO_SHORT]
    
    inline def FILE_TRANSIENT_ERROR: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_TRANSIENT_ERROR = "FILE_TRANSIENT_ERROR".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_TRANSIENT_ERROR]
    
    inline def FILE_VIRUS_INFECTED: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_VIRUS_INFECTED = "FILE_VIRUS_INFECTED".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.FILE_VIRUS_INFECTED]
    
    inline def NETWORK_DISCONNECTED: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.NETWORK_DISCONNECTED = "NETWORK_DISCONNECTED".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.NETWORK_DISCONNECTED]
    
    inline def NETWORK_FAILED: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.NETWORK_FAILED = "NETWORK_FAILED".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.NETWORK_FAILED]
    
    inline def NETWORK_INVALID_REQUEST: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.NETWORK_INVALID_REQUEST = "NETWORK_INVALID_REQUEST".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.NETWORK_INVALID_REQUEST]
    
    inline def NETWORK_SERVER_DOWN: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.NETWORK_SERVER_DOWN = "NETWORK_SERVER_DOWN".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.NETWORK_SERVER_DOWN]
    
    inline def NETWORK_TIMEOUT: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.NETWORK_TIMEOUT = "NETWORK_TIMEOUT".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.NETWORK_TIMEOUT]
    
    inline def SERVER_BAD_CONTENT: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.SERVER_BAD_CONTENT = "SERVER_BAD_CONTENT".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.SERVER_BAD_CONTENT]
    
    inline def SERVER_CERT_PROBLEM: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.SERVER_CERT_PROBLEM = "SERVER_CERT_PROBLEM".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.SERVER_CERT_PROBLEM]
    
    inline def SERVER_FAILED: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.SERVER_FAILED = "SERVER_FAILED".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.SERVER_FAILED]
    
    inline def SERVER_FORBIDDEN: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.SERVER_FORBIDDEN = "SERVER_FORBIDDEN".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.SERVER_FORBIDDEN]
    
    inline def SERVER_NO_RANGE: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.SERVER_NO_RANGE = "SERVER_NO_RANGE".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.SERVER_NO_RANGE]
    
    inline def SERVER_UNAUTHORIZED: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.SERVER_UNAUTHORIZED = "SERVER_UNAUTHORIZED".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.SERVER_UNAUTHORIZED]
    
    inline def USER_CANCELED: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.USER_CANCELED = "USER_CANCELED".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.USER_CANCELED]
    
    inline def USER_SHUTDOWN: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.USER_SHUTDOWN = "USER_SHUTDOWN".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.USER_SHUTDOWN]
  }
  ...
  */
  ...
  object State {
    ...
    inline def in_progress: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.in_progress = "in_progress".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.in_progress]
    
    inline def interrupted: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.interrupted = "interrupted".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.interrupted]
  }
