...
object extensionTypes {
  ...
  */
  ...
  object CSSOrigin {
    ...
    inline def author: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.author = "author".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.author]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firefoxWebextBrowser.anon.File
    - typingsJapgolly.firefoxWebextBrowser.anon.Code
  */
  trait ExtensionFileOrCode extends StObject
  object ExtensionFileOrCode {
    
    inline def Code(code: String): typingsJapgolly.firefoxWebextBrowser.anon.Code = {
      val __obj = js.Dynamic.literal(code = code.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firefoxWebextBrowser.anon.Code]
    }
    
    inline def File(file: ExtensionURL): typingsJapgolly.firefoxWebextBrowser.anon.File = {
      val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firefoxWebextBrowser.anon.File]
    }
  }
  ...
  */
  ...
  object RunAt {
    ...
    inline def document_end: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.document_end = "document_end".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.document_end]
    
    inline def document_idle: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.document_idle = "document_idle".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.document_idle]
    
    inline def document_start: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.document_start = "document_start".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.document_start]
  }
