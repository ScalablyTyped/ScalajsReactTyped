...
object OnAuthRequiredOptions {
  ...
  inline def asyncBlocking: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.asyncBlocking = "asyncBlocking".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.asyncBlocking]
