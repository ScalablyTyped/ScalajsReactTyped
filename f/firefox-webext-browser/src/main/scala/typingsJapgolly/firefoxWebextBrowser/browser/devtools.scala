...
object devtools {
  ...
  object inspectedWindow {
    ...
    object Resource {
      ...
      extension [Self <: Resource](x: Self) {
        ...
        inline def setGetContent(value: CallbackTo[js.Promise[js.Object]]): Self = StObject.set(x, "getContent", value.toJsFn)
  ...
  object network {
    ...
    object Request {
      ...
      inline def apply(getContent: CallbackTo[js.Promise[js.Object]]): Request = {
