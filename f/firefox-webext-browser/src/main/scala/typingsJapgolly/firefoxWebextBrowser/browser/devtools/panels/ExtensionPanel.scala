...
object ExtensionPanel {
  ...
  def apply(
    ...
    createStatusBarButton: (/* iconPath */ String, /* tooltipText */ String, /* disabled */ Boolean) => CallbackTo[Button] = null
  ): ExtensionPanel = {
    ...
    if (createStatusBarButton != null) __obj.updateDynamic("createStatusBarButton")(js.Any.fromFunction3((t0: /* iconPath */ java.lang.String, t1: /* tooltipText */ java.lang.String, t2: /* disabled */ scala.Boolean) => createStatusBarButton(t0, t1, t2).runNow()))
