...
import typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.managed
...
object bookmarks {
  ...
  */
  ...
  object BookmarkTreeNodeType {
    ...
    inline def folder: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.folder = "folder".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.folder]
