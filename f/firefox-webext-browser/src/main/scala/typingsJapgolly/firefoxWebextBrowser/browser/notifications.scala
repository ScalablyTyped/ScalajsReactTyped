...
object notifications {
  ...
  object CreateNotificationOptions {
    ...
    extension [Self <: CreateNotificationOptions](x: Self) {
      ...
      inline def setButtonsVarargs(value: CreateNotificationOptionsButtons*): Self = StObject.set(x, "buttons", js.Array(value*))
  ...
  */
  ...
  object PermissionLevel {
    ...
    inline def denied: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.denied = "denied".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.denied]
    
    inline def granted: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.granted = "granted".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.granted]
  }
  
  /* notifications types */
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.basic
    - typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.image
    - typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.list
    - typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.progress
  */
  trait TemplateType extends StObject
  object TemplateType {
    
    inline def basic: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.basic = "basic".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.basic]
    ...
    inline def list: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.list = "list".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.list]
    
    inline def progress: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.progress = "progress".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.progress]
  }
  ...
  object UpdateNotificationOptions {
    ...
    extension [Self <: UpdateNotificationOptions](x: Self) {
      ...
      inline def setButtonsVarargs(value: UpdateNotificationOptionsButtons*): Self = StObject.set(x, "buttons", js.Array(value*))
