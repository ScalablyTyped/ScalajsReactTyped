...
object events {
  ...
  object Event {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(addListener = js.Any.fromFunction1((t0: js.Function0[Unit]) => addListener(t0).runNow()), hasListener = js.Any.fromFunction1(hasListener), hasListeners = hasListeners.toJsFn, removeListener = js.Any.fromFunction1((t0: js.Function0[Unit]) => removeListener(t0).runNow()))
      __obj.asInstanceOf[Event]
    }
    
    extension [Self <: Event](x: Self) {
      
      inline def setAddListener(value: js.Function0[Unit] => Callback): Self = StObject.set(x, "addListener", js.Any.fromFunction1((t0: js.Function0[Unit]) => value(t0).runNow()))
      ...
      inline def setRemoveListener(value: js.Function0[Unit] => Callback): Self = StObject.set(x, "removeListener", js.Any.fromFunction1((t0: js.Function0[Unit]) => value(t0).runNow()))
