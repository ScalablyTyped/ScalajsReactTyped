...
import typingsJapgolly.firefoxWebextBrowser.browser.webRequest._HttpHeaders
...
object proxy {
  ...
  */
  ...
  object ProxyConfigProxyType {
    ...
    inline def autoConfig: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.autoConfig = "autoConfig".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.autoConfig]
    
    inline def autoDetect: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.autoDetect = "autoDetect".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.autoDetect]
    
    inline def manual: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.manual = "manual".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.manual]
    ...
    inline def system: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.system = "system".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.system]
  }
