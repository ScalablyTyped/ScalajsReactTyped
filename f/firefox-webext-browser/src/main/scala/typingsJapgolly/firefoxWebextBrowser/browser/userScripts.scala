...
import typingsJapgolly.firefoxWebextBrowser.browser.extensionTypes.PlainJSONValue
...
object userScripts {
  ...
  object OnBeforeScriptUserScript {
    ...
    inline def apply(defineGlobals: js.Object => Callback, `export`: Any => Any, global: Any, metadata: Any): OnBeforeScriptUserScript = {
      val __obj = js.Dynamic.literal(defineGlobals = js.Any.fromFunction1((t0: js.Object) => defineGlobals(t0).runNow()), global = global.asInstanceOf[js.Any], metadata = metadata.asInstanceOf[js.Any])
    ...
    extension [Self <: OnBeforeScriptUserScript](x: Self) {
      ...
      inline def setDefineGlobals(value: js.Object => Callback): Self = StObject.set(x, "defineGlobals", js.Any.fromFunction1((t0: js.Object) => value(t0).runNow()))
  ...
  object RegisteredUserScript {
    ...
    inline def apply(unregister: CallbackTo[js.Promise[Any]]): RegisteredUserScript = {
      val __obj = js.Dynamic.literal(unregister = unregister.toJsFn)
      __obj.asInstanceOf[RegisteredUserScript]
    }
    
    extension [Self <: RegisteredUserScript](x: Self) {
      
      inline def setUnregister(value: CallbackTo[js.Promise[Any]]): Self = StObject.set(x, "unregister", value.toJsFn)
    }
  }
