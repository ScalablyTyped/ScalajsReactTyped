...
import typingsJapgolly.firefoxWebextBrowser.browser.manifest.HttpURL
...
object management {
  ...
  */
  ...
  object ExtensionDisabledReason {
    ...
    inline def permissions_increase: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.permissions_increase = "permissions_increase".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.permissions_increase]
  ...
  */
  ...
  object ExtensionInstallType {
    ...
    inline def development: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.development = "development".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.development]
    ...
    inline def other: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.other = "other".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.other]
    
    inline def sideload: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.sideload = "sideload".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.sideload]
  }
  ...
  */
  ...
  object ExtensionType {
    ...
    inline def theme: typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.theme = "theme".asInstanceOf[typingsJapgolly.firefoxWebextBrowser.firefoxWebextBrowserStrings.theme]
  }
