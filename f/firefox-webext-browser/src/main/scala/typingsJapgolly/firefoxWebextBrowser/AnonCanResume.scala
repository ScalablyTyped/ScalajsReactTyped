...
import typingsJapgolly.firefoxWebextBrowser.browser.downloads.BooleanDelta
import typingsJapgolly.firefoxWebextBrowser.browser.downloads.DoubleDelta
import typingsJapgolly.firefoxWebextBrowser.browser.downloads.StringDelta
