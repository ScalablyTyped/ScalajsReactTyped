...
object Options {
  @scala.inline
  def apply(map: /* repeated */ js.Any => CallbackTo[String] = null, sep: String = null): Options = {
    val __obj = js.Dynamic.literal()
    if (map != null) __obj.updateDynamic("map")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => map(t0).runNow()))
