...
object mod {
  ...
  object NodeType extends StObject {
    ...
    sealed trait ELEMENT_NODE
      extends StObject
         with NodeType
    /* 1 */ val ELEMENT_NODE: typingsJapgolly.fastHtmlParser.mod.NodeType.ELEMENT_NODE & Double = js.native
    
    @js.native
    sealed trait TEXT_NODE
      extends StObject
         with NodeType
    /* 3 */ val TEXT_NODE: typingsJapgolly.fastHtmlParser.mod.NodeType.TEXT_NODE & Double = js.native
  }
