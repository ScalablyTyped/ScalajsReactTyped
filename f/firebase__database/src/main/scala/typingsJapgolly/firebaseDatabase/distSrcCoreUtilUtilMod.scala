...
object distSrcCoreUtilUtilMod {
  
  @JSImport("@firebase/database/dist/src/core/util/util", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/database/dist/src/core/util/util", "INTEGER_32_MAX")
  @js.native
  val INTEGER_32_MAX: /* 2147483647 */ Double = js.native
  
  @JSImport("@firebase/database/dist/src/core/util/util", "INTEGER_32_MIN")
  @js.native
