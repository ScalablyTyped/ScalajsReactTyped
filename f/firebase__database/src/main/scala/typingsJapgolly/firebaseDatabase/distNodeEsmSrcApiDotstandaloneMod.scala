...
object distNodeEsmSrcApiDotstandaloneMod {
  ...
  open class DataSnapshot protected ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiReferenceImplMod.DataSnapshot {
    /**
  ...
  open class Database protected ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiDatabaseMod.Database {
    /** @hideconstructor */
    def this(
      _repoInternal: Repo,
  ...
  open class QueryConstraint ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiReferenceImplMod.QueryConstraint
  
  @JSImport("@firebase/database/dist/node-esm/src/api.standalone", "_QueryImpl")
  @js.native
  open class QueryImpl protected ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiReferenceImplMod.QueryImpl {
    /**
      * @hideconstructor
      */
    def this(
  ...
  open class QueryParams ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreViewQueryParamsMod.QueryParams
  
  @JSImport("@firebase/database/dist/node-esm/src/api.standalone", "_ReferenceImpl")
  @js.native
  open class ReferenceImpl protected ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiReferenceImplMod.ReferenceImpl {
    /** @hideconstructor */
  ...
  open class TransactionResult protected ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiTransactionMod.TransactionResult {
    /** @hideconstructor */
    def this(
