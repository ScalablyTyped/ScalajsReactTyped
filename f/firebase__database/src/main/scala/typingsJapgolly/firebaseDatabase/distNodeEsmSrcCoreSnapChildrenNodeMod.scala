...
import typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreSnapIndexMapMod.IndexMap
...
import typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreUtilSortedMapMod.SortedMap
import typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreUtilSortedMapMod.SortedMapIterator
...
object distNodeEsmSrcCoreSnapChildrenNodeMod {
  ...
  object firebaseDatabaseDistNodeEsmSrcCoreSnapNodeAugmentingMod {
    ...
    trait NamedNode extends StObject {
      ...
      var MAX: typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistNodeEsmSrcCoreSnapNodeAugmentingMod.NamedNode
      
      var MIN: typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistNodeEsmSrcCoreSnapNodeAugmentingMod.NamedNode
    }
    object NamedNode {
      
      inline def apply(
        MAX: typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistNodeEsmSrcCoreSnapNodeAugmentingMod.NamedNode,
        MIN: typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistNodeEsmSrcCoreSnapNodeAugmentingMod.NamedNode
      ): typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistNodeEsmSrcCoreSnapNodeAugmentingMod.NamedNode = {
        val __obj = js.Dynamic.literal(MAX = MAX.asInstanceOf[js.Any], MIN = MIN.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistNodeEsmSrcCoreSnapNodeAugmentingMod.NamedNode]
      }
      
      extension [Self <: typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistNodeEsmSrcCoreSnapNodeAugmentingMod.NamedNode](x: Self) {
        
        inline def setMAX(
          value: typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistNodeEsmSrcCoreSnapNodeAugmentingMod.NamedNode
