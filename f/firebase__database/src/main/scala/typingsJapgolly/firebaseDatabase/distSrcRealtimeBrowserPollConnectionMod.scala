...
import typingsJapgolly.firebaseDatabase.anon.D
import typingsJapgolly.firebaseDatabase.distSrcCoreRepoInfoMod.RepoInfo
import typingsJapgolly.firebaseDatabase.distSrcRealtimePollingPacketReceiverMod.PacketReceiver
import typingsJapgolly.firebaseDatabase.distSrcRealtimeTransportMod.Transport
...
object distSrcRealtimeBrowserPollConnectionMod {
  ...
  trait IFrameElement
    extends StObject
       with typingsJapgolly.std.HTMLIFrameElement {
