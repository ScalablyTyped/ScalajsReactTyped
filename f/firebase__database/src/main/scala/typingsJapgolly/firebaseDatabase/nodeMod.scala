...
object nodeMod extends js.Object {
  ...
  class NamedNode protected () extends js.Object {
    ...
    var MAX: typingsJapgolly.firebaseDatabase.childrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode = js.native
    var MIN: typingsJapgolly.firebaseDatabase.childrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode = js.native
