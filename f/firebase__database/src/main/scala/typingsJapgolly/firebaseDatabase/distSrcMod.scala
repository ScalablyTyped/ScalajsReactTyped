...
object distSrcMod {
  ...
  @JSImport("@firebase/database/dist/src", JSImport.Namespace)
  @js.native
  ...
  object firebaseComponentAugmentingMod {
    ...
    trait NameServiceMapping extends StObject {
      ...
      var database: typingsJapgolly.firebaseDatabase.distSrcApiDatabaseMod.Database
    }
    object NameServiceMapping {
      
      inline def apply(database: typingsJapgolly.firebaseDatabase.distSrcApiDatabaseMod.Database): NameServiceMapping = {
      ...
      extension [Self <: NameServiceMapping](x: Self) {
        ...
        inline def setDatabase(value: typingsJapgolly.firebaseDatabase.distSrcApiDatabaseMod.Database): Self = StObject.set(x, "database", value.asInstanceOf[js.Any])
      }
    }
  }
}
