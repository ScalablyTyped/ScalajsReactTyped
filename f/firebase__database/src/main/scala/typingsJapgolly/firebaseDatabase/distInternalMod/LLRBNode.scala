...
object LLRBNode {
  ...
  inline def apply[K, V](
    ...
    val __obj = js.Dynamic.literal(checkMaxDepth_ = checkMaxDepth_.asInstanceOf[js.Any], check_ = check_.toJsFn, color = color.asInstanceOf[js.Any], colorFlip_ = colorFlip_.asInstanceOf[js.Any], copy = js.Any.fromFunction5(copy), count = count.toJsFn, fixUp_ = fixUp_.asInstanceOf[js.Any], inorderTraversal = js.Any.fromFunction1(inorderTraversal), insert = js.Any.fromFunction3(insert), isEmpty = isEmpty.toJsFn, isRed_ = isRed_.toJsFn, key = key.asInstanceOf[js.Any], left = left.asInstanceOf[js.Any], maxKey = maxKey.toJsFn, minKey = minKey.toJsFn, min_ = min_.asInstanceOf[js.Any], moveRedLeft_ = moveRedLeft_.asInstanceOf[js.Any], moveRedRight_ = moveRedRight_.asInstanceOf[js.Any], remove = js.Any.fromFunction2(remove), removeMin_ = removeMin_.asInstanceOf[js.Any], reverseTraversal = js.Any.fromFunction1(reverseTraversal), right = right.asInstanceOf[js.Any], rotateLeft_ = rotateLeft_.asInstanceOf[js.Any], rotateRight_ = rotateRight_.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
  ...
  extension [Self <: LLRBNode[?, ?], K, V](x: Self & (LLRBNode[K, V])) {
    ...
    inline def setMaxKey(value: CallbackTo[K]): Self = StObject.set(x, "maxKey", value.toJsFn)
    
    inline def setMinKey(value: CallbackTo[K]): Self = StObject.set(x, "minKey", value.toJsFn)
