...
- typingsJapgolly.firebaseDatabase.distInternalMod.QueryContext because Already inherited
- typingsJapgolly.firebaseDatabase.distInternalMod.Query_ because Already inherited
- typingsJapgolly.firebaseDatabase.distInternalMod.DatabaseReference because var conflicts: _queryIdentifier, _queryObject, key, ref. Inlined parent, root */ @JSImport("@firebase/database/dist/internal", "_ReferenceImpl")
@js.native
