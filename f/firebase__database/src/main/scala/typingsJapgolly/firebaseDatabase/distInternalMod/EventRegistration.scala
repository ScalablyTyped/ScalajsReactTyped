...
object EventRegistration {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(createCancelEvent = js.Any.fromFunction2(createCancelEvent), createEvent = js.Any.fromFunction2(createEvent), getEventRunner = js.Any.fromFunction1(getEventRunner), hasAnyCallback = hasAnyCallback.toJsFn, matches = js.Any.fromFunction1(matches), respondsTo = js.Any.fromFunction1(respondsTo))
  ...
  extension [Self <: EventRegistration](x: Self) {
    ...
    inline def setHasAnyCallback(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasAnyCallback", value.toJsFn)
