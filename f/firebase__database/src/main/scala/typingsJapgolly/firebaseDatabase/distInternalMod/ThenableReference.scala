...
/* Inlined parent @firebase/database.@firebase/database/dist/internal.DatabaseReference */
/* Inlined parent std.Pick<std.Promise<@firebase/database.@firebase/database/dist/internal.DatabaseReference>, 'then' | 'catch'> */
@js.native
