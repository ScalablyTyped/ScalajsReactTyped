...
object distNodeEsmSrcCoreSnapNodeMod {
  ...
  open class NamedNode protected () extends StObject {
    ...
    var MAX: typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistNodeEsmSrcCoreSnapNodeAugmentingMod.NamedNode = js.native
    
    var MIN: typingsJapgolly.firebaseDatabase.distNodeEsmSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistNodeEsmSrcCoreSnapNodeAugmentingMod.NamedNode = js.native
