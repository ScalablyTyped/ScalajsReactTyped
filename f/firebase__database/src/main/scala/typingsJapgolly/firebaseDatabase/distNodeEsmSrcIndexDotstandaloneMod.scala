...
object distNodeEsmSrcIndexDotstandaloneMod {
  ...
  open class DataSnapshot protected ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiDotstandaloneMod.DataSnapshot {
    /**
  ...
  open class Database protected ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiDotstandaloneMod.Database {
    /** @hideconstructor */
    def this(
      _repoInternal: Repo,
  ...
  open class OnDisconnect_ protected ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiDotstandaloneMod.OnDisconnect_ {
    /** @hideconstructor */
  ...
  open class QueryConstraint ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiDotstandaloneMod.QueryConstraint
  
  @JSImport("@firebase/database/dist/node-esm/src/index.standalone", "_QueryImpl")
  @js.native
  open class QueryImpl protected ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiDotstandaloneMod.QueryImpl {
    /**
      * @hideconstructor
      */
    def this(
  ...
  open class QueryParams ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiDotstandaloneMod.QueryParams
  
  @JSImport("@firebase/database/dist/node-esm/src/index.standalone", "_ReferenceImpl")
  @js.native
  open class ReferenceImpl protected ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiDotstandaloneMod.ReferenceImpl {
    /** @hideconstructor */
  ...
  open class TransactionResult protected ()
    extends typingsJapgolly.firebaseDatabase.distNodeEsmSrcApiDotstandaloneMod.TransactionResult {
    /** @hideconstructor */
    def this(
