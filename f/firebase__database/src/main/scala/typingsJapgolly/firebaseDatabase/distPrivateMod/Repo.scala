...
object Repo {
  ...
  extension [Self <: Repo](x: Self) {
    ...
    inline def setInterceptServerDataCallback_(value: (/* a */ String, /* b */ Any) => Callback): Self = StObject.set(x, "interceptServerDataCallback_", js.Any.fromFunction2((t0: /* a */ String, t1: /* b */ Any) => (value(t0, t1)).runNow()))
