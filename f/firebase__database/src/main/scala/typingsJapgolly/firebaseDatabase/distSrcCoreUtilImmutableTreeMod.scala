...
import typingsJapgolly.firebaseDatabase.anon.PathPath
...
object distSrcCoreUtilImmutableTreeMod {
  ...
  open class ImmutableTree[T] () extends StObject {
    ...
    /**
      ...
      */
    def findRootMostMatchingPathAndValue(relativePath: Path, predicate: js.Function1[/* a */ T, Boolean]): PathPath[T] | Null = js.native
    
    /**
      * Find, if it exists, the shortest subpath of the given path that points a defined
      * value in the tree
      */
    def findRootMostValueAndPath(relativePath: Path): PathPath[T] | Null = js.native
