...
import typingsJapgolly.firebaseDatabase.firebaseDatabaseStrings.cb
import typingsJapgolly.firebaseDatabase.firebaseDatabaseStrings.close
import typingsJapgolly.firebaseDatabase.firebaseDatabaseStrings.d
import typingsJapgolly.firebaseDatabase.firebaseDatabaseStrings.dframe
import typingsJapgolly.firebaseDatabase.firebaseDatabaseStrings.disconn
import typingsJapgolly.firebaseDatabase.firebaseDatabaseStrings.id
import typingsJapgolly.firebaseDatabase.firebaseDatabaseStrings.pLPCommand
import typingsJapgolly.firebaseDatabase.firebaseDatabaseStrings.pRTLPCB
import typingsJapgolly.firebaseDatabase.firebaseDatabaseStrings.pw
import typingsJapgolly.firebaseDatabase.firebaseDatabaseStrings.seg
import typingsJapgolly.firebaseDatabase.firebaseDatabaseStrings.ser
import typingsJapgolly.firebaseDatabase.firebaseDatabaseStrings.start
import typingsJapgolly.firebaseDatabase.firebaseDatabaseStrings.ts
import typingsJapgolly.firebaseDatabase.packetReceiverMod.PacketReceiver
import typingsJapgolly.firebaseDatabase.repoInfoMod.RepoInfo
import typingsJapgolly.firebaseDatabase.transportMod.Transport
...
object browserPollConnectionMod extends js.Object {
  ...
  @js.native
  trait IFrameElement
    extends typingsJapgolly.std.HTMLIFrameElement {
