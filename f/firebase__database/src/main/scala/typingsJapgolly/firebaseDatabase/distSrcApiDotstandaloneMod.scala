...
object distSrcApiDotstandaloneMod {
  ...
  open class DataSnapshot protected ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiReferenceImplMod.DataSnapshot {
    /**
  ...
  open class Database protected ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiDatabaseMod.Database {
    /** @hideconstructor */
    def this(
      _repoInternal: Repo,
  ...
  /* note: abstract class */ @JSImport("@firebase/database/dist/src/api.standalone", "QueryConstraint")
  @js.native
  open class QueryConstraint ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiReferenceImplMod.QueryConstraint
  
  @JSImport("@firebase/database/dist/src/api.standalone", "_QueryImpl")
  @js.native
  open class QueryImpl protected ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiReferenceImplMod.QueryImpl {
    /**
      * @hideconstructor
      */
    def this(
  ...
  open class QueryParams ()
    extends typingsJapgolly.firebaseDatabase.distSrcCoreViewQueryParamsMod.QueryParams
  
  @JSImport("@firebase/database/dist/src/api.standalone", "_ReferenceImpl")
  @js.native
  open class ReferenceImpl protected ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiReferenceImplMod.ReferenceImpl {
    /** @hideconstructor */
  ...
  open class TransactionResult protected ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiTransactionMod.TransactionResult {
    /** @hideconstructor */
    def this(
