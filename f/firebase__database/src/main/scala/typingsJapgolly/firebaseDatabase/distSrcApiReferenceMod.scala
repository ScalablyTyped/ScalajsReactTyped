...
object distSrcApiReferenceMod {
  ...
  /* Inlined parent @firebase/database.@firebase/database/dist/src/api/Reference.DatabaseReference */
  /* Inlined parent std.Pick<std.Promise<@firebase/database.@firebase/database/dist/src/api/Reference.DatabaseReference>, 'then' | 'catch'> */
  @js.native
