...
object distSrcCoreSnapNodeMod {
  ...
  open class NamedNode protected () extends StObject {
    ...
    var MAX: typingsJapgolly.firebaseDatabase.distSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode = js.native
    
    var MIN: typingsJapgolly.firebaseDatabase.distSrcCoreSnapChildrenNodeMod.firebaseDatabaseDistSrcCoreSnapNodeAugmentingMod.NamedNode = js.native
