...
object distSrcIndexDotnodeMod {
  ...
  @JSImport("@firebase/database/dist/src/index.node", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/database/dist/src/index.node", "DataSnapshot")
  @js.native
  open class DataSnapshot protected ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiMod.DataSnapshot {
    /**
  ...
  @JSImport("@firebase/database/dist/src/index.node", "Database")
  @js.native
  open class Database protected ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiMod.Database {
    /** @hideconstructor */
    def this(
      _repoInternal: Repo,
  ...
  @JSImport("@firebase/database/dist/src/index.node", "OnDisconnect")
  @js.native
  open class OnDisconnect_ protected ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiMod.OnDisconnect_ {
    /** @hideconstructor */
    def this(_repo: Repo, _path: Path) = this()
  }
  
  /* note: abstract class */ @JSImport("@firebase/database/dist/src/index.node", "QueryConstraint")
  @js.native
  open class QueryConstraint ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiMod.QueryConstraint
  
  @JSImport("@firebase/database/dist/src/index.node", "_QueryImpl")
  @js.native
  open class QueryImpl protected ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiMod.QueryImpl {
    /**
      * @hideconstructor
      */
    def this(
  ...
  @JSImport("@firebase/database/dist/src/index.node", "_QueryParams")
  @js.native
  open class QueryParams ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiMod.QueryParams
  
  @JSImport("@firebase/database/dist/src/index.node", "_ReferenceImpl")
  @js.native
  open class ReferenceImpl protected ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiMod.ReferenceImpl {
    /** @hideconstructor */
  ...
  @JSImport("@firebase/database/dist/src/index.node", "TransactionResult")
  @js.native
  open class TransactionResult protected ()
    extends typingsJapgolly.firebaseDatabase.distSrcApiMod.TransactionResult {
    /** @hideconstructor */
    def this(
  ...
  inline def getDatabase(): typingsJapgolly.firebaseDatabase.distSrcApiDatabaseMod.Database = ^.asInstanceOf[js.Dynamic].applyDynamic("getDatabase")().asInstanceOf[typingsJapgolly.firebaseDatabase.distSrcApiDatabaseMod.Database]
  inline def getDatabase(app: Unit, url: String): typingsJapgolly.firebaseDatabase.distSrcApiDatabaseMod.Database = (^.asInstanceOf[js.Dynamic].applyDynamic("getDatabase")(app.asInstanceOf[js.Any], url.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseDatabase.distSrcApiDatabaseMod.Database]
  inline def getDatabase(app: FirebaseApp): typingsJapgolly.firebaseDatabase.distSrcApiDatabaseMod.Database = ^.asInstanceOf[js.Dynamic].applyDynamic("getDatabase")(app.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.firebaseDatabase.distSrcApiDatabaseMod.Database]
  inline def getDatabase(app: FirebaseApp, url: String): typingsJapgolly.firebaseDatabase.distSrcApiDatabaseMod.Database = (^.asInstanceOf[js.Dynamic].applyDynamic("getDatabase")(app.asInstanceOf[js.Any], url.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseDatabase.distSrcApiDatabaseMod.Database]
