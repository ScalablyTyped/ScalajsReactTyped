...
import typingsJapgolly.joi.mod.ValidationErrorItem
...
object mod {
  ...
  object nodeFetch {
    ...
    inline def default(url: RequestInfo): js.Promise[typingsJapgolly.nodeFetch.mod.Response] = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(url.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.nodeFetch.mod.Response]]
    inline def default(url: RequestInfo, init: RequestInit): js.Promise[typingsJapgolly.nodeFetch.mod.Response] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(url.asInstanceOf[js.Any], init.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.nodeFetch.mod.Response]]
    
    @JSImport("frisby", "nodeFetch.AbortError")
    @js.native
    open class AbortError ()
      extends typingsJapgolly.nodeFetch.mod.AbortError
    ...
    object Response {
      ...
      inline def error(): typingsJapgolly.nodeFetch.mod.Response = ^.asInstanceOf[js.Dynamic].applyDynamic("error")().asInstanceOf[typingsJapgolly.nodeFetch.mod.Response]
      
      inline def redirect(url: String): typingsJapgolly.nodeFetch.mod.Response = ^.asInstanceOf[js.Dynamic].applyDynamic("redirect")(url.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.nodeFetch.mod.Response]
      inline def redirect(url: String, status: Double): typingsJapgolly.nodeFetch.mod.Response = (^.asInstanceOf[js.Dynamic].applyDynamic("redirect")(url.asInstanceOf[js.Any], status.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.nodeFetch.mod.Response]
    }
