...
import typingsJapgolly.forms.anon.Empty
import typingsJapgolly.forms.anon.ValidatePastFirstError
import typingsJapgolly.forms.anon.WidgetParametersrowsnumbe
...
object mod {
  ...
  trait FieldBound[Data, RawData] extends StObject {
    ...
    var cssClasses: js.UndefOr[typingsJapgolly.forms.anon.Field] = js.native
  ...
  trait FieldParameters extends StObject {
    ...
    /** A list of CSS classes for label and field wrapper. */
    var cssClasses: js.UndefOr[typingsJapgolly.forms.anon.Field] = js.undefined
  ...
  object FieldParameters {
    ...
    extension [Self <: FieldParameters](x: Self) {
      ...
      inline def setCssClasses(value: typingsJapgolly.forms.anon.Field): Self = StObject.set(x, "cssClasses", value.asInstanceOf[js.Any])
      ...
      inline def setRequiredFunction3(
        value: (/* form */ FormBound[Any, FormData[Any]], /* field */ FieldBound[Any, Any], /* callback */ js.Function1[/* err */ js.UndefOr[String], Unit]) => Callback
      ): Self = StObject.set(x, "required", js.Any.fromFunction3((t0: /* form */ FormBound[Any, FormData[Any]], t1: /* field */ FieldBound[Any, Any], t2: /* callback */ js.Function1[/* err */ js.UndefOr[String], Unit]) => (value(t0, t1, t2)).runNow()))
  ...
  object FormBound {
    ...
    inline def apply[Fields /* <: FormFields */, Data /* <: Partial[FormData[Fields]] */](
      ...
      validate: js.Function2[/* err */ String, /* form */ FormBound[Fields, Data], Unit] => Callback
    ): FormBound[Fields, Data] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], isValid = isValid.toJsFn, validate = js.Any.fromFunction1((t0: js.Function2[/* err */ String, /* form */ FormBound[Fields, Data], Unit]) => validate(t0).runNow()))
    ...
    extension [Self <: FormBound[?, ?], Fields /* <: FormFields */, Data /* <: Partial[FormData[Fields]] */](x: Self & (FormBound[Fields, Data])) {
      ...
      inline def setValidate(value: js.Function2[/* err */ String, /* form */ FormBound[Fields, Data], Unit] => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: js.Function2[/* err */ String, /* form */ FormBound[Fields, Data], Unit]) => value(t0).runNow()))
    }
  }
