...
import typingsJapgolly.formidable.anon.FormidableErrortypeofForm
import typingsJapgolly.formidable.anon.PartialOptions
import typingsJapgolly.formidable.anon.TypeofFormidable
import typingsJapgolly.formidable.anon.TypeofMultipartParser
import typingsJapgolly.formidable.anon.Typeofparsers
import typingsJapgolly.formidable.formidableBooleans.`false`
...
import typingsJapgolly.formidable.formidableStrings.json
import typingsJapgolly.formidable.formidableStrings.md5
import typingsJapgolly.formidable.formidableStrings.multipart
import typingsJapgolly.formidable.formidableStrings.octetstream
import typingsJapgolly.formidable.formidableStrings.querystring
import typingsJapgolly.formidable.formidableStrings.sha1
import typingsJapgolly.formidable.formidableStrings.sha256
...
/* Inlined {None (options : formidable.formidable.Options | undefined): formidable.formidable/Formidable.^,   defaultOptions :formidable.formidable.DefaultOptions,   enabledPlugins :formidable.formidable.EnabledPlugins,   plugins :formidable.formidable.EnabledPlugins,   errors :{  FormidableError :typeof FormidableError} & std.Record<'missingPlugin' | 'pluginFunction' | 'aborted' | 'noParser' | 'uninitializedParser' | 'filenameNotString' | 'maxFieldsSizeExceeded' | 'maxFieldsExceeded' | 'smallerThanMinFileSize' | 'biggerThanMaxFileSize' | 'noEmptyFiles' | 'missingContentType' | 'malformedMultipart' | 'missingMultipartBoundary' | 'unknownTransferEncoding', number>,   File :new (properties : formidable.formidable.File): formidable.formidable/PersistentFile.^,   PersistentFile :new (properties : formidable.formidable.File): formidable.formidable/PersistentFile.^,   VolatileFile :new (properties : formidable.formidable.File): formidable.formidable/PersistentFile.^,   Formidable :{ readonly DEFAULT_OPTIONS :formidable.formidable.DefaultOptions} & new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/Formidable.^, formidable (options : formidable.formidable.Options | undefined): formidable.formidable/Formidable.^,   IncomingForm :{ readonly DEFAULT_OPTIONS :formidable.formidable.DefaultOptions} & new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/Formidable.^,   parsers :{  DummyParser :new (incomingForm : typeof IncomingForm, options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.DummyParser,   JSONParser :new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.JSONParser,   MultipartParser :{stateToString (stateNumber : number): string,   STATES :std.Record<'PARSER_UNINITIALIZED' | 'START' | 'START_BOUNDARY' | 'HEADER_FIELD_START' | 'HEADER_FIELD' | 'HEADER_VALUE_START' | 'HEADER_VALUE' | 'HEADER_VALUE_ALMOST_DONE' | 'HEADERS_ALMOST_DONE' | 'PART_DATA_START' | 'PART_DATA' | 'PART_END' | 'END', number>, new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.MultipartParser},   OctetStreamParser :new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.OctetStreamParser,   QuerystringParser :new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.QuerystringParser,   StreamingQuerystring :new (): formidable.formidable/parsers.StreamingQuerystring}} & formidable.formidable.MappedParsers */
object mod {
  
  inline def apply(): typingsJapgolly.formidable.formidableMod.^ = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.formidable.formidableMod.^]
  inline def apply(options: Options): typingsJapgolly.formidable.formidableMod.^ = ^.asInstanceOf[js.Dynamic].apply(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.formidable.formidableMod.^]
  ...
  open class DummyParser protected ()
    extends typingsJapgolly.formidable.parsersMod.DummyParser {
  ...
  def DummyParser: Instantiable2[
    ...
    typingsJapgolly.formidable.parsersMod.DummyParser
  ] = js.native
  ...
  object File {
    ...
    @js.native
    val ^ : Instantiable1[/* properties */ File, typingsJapgolly.formidable.persistentFileMod.^] = js.native
    ...
    extension [Self <: File](x: Self) {
      ...
      inline def setToJSON(value: CallbackTo[FileJSON]): Self = StObject.set(x, "toJSON", value.toJsFn)
    }
  }
  ...
  open class FileCls protected ()
    extends typingsJapgolly.formidable.persistentFileMod.^ {
  ...
  open class Formidable ()
    extends typingsJapgolly.formidable.formidableMod.^ {
    def this(options: PartialOptions) = this()
  }
  @JSImport("formidable", "Formidable")
  @js.native
  def Formidable_ : TypeofFormidable & (Instantiable1[
    /* options */ js.UndefOr[PartialOptions], 
    typingsJapgolly.formidable.formidableMod.^
  ]) = js.native
  
  inline def Formidable__=(
    x: TypeofFormidable & (Instantiable1[
      /* options */ js.UndefOr[PartialOptions], 
      typingsJapgolly.formidable.formidableMod.^
    ])
  ...
  @JSImport("formidable", "IncomingForm")
  @js.native
  def IncomingForm: TypeofFormidable & (Instantiable1[
    /* options */ js.UndefOr[PartialOptions], 
    typingsJapgolly.formidable.formidableMod.^
  ]) = js.native
  ...
  open class JSONParser ()
    extends typingsJapgolly.formidable.parsersMod.JSONParser {
    def this(options: PartialOptions) = this()
  }
  @JSImport("formidable", "JSONParser")
  @js.native
  def JSONParser: Instantiable1[
    /* options */ js.UndefOr[PartialOptions], 
    typingsJapgolly.formidable.parsersMod.JSONParser
  ] = js.native
  ...
  open class MultipartParser ()
    extends typingsJapgolly.formidable.parsersMod.MultipartParser {
    def this(options: PartialOptions) = this()
  }
  @JSImport("formidable", "MultipartParser")
  @js.native
  ...
  open class OctetStreamParser ()
    extends typingsJapgolly.formidable.parsersMod.OctetStreamParser {
    def this(options: PartialOptions) = this()
  }
  @JSImport("formidable", "OctetStreamParser")
  @js.native
  def OctetStreamParser: Instantiable1[
    /* options */ js.UndefOr[PartialOptions], 
    typingsJapgolly.formidable.parsersMod.OctetStreamParser
  ] = js.native
  ...
  @JSImport("formidable", "PersistentFile")
  @js.native
  def PersistentFile: Instantiable1[/* properties */ File, typingsJapgolly.formidable.persistentFileMod.^] = js.native
  inline def PersistentFile_=(x: Instantiable1[/* properties */ File, typingsJapgolly.formidable.persistentFileMod.^]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PersistentFile")(x.asInstanceOf[js.Any])
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("formidable", "QuerystringParser")
  @js.native
  open class QuerystringParser ()
    extends typingsJapgolly.formidable.parsersMod.QuerystringParser {
    def this(options: PartialOptions) = this()
  }
  @JSImport("formidable", "QuerystringParser")
  @js.native
  def QuerystringParser: Instantiable1[
    /* options */ js.UndefOr[PartialOptions], 
    typingsJapgolly.formidable.parsersMod.QuerystringParser
  ] = js.native
  ...
  open class StreamingQuerystring ()
    extends typingsJapgolly.formidable.parsersMod.StreamingQuerystring
  @JSImport("formidable", "StreamingQuerystring")
  @js.native
  def StreamingQuerystring: Instantiable0[typingsJapgolly.formidable.parsersMod.StreamingQuerystring] = js.native
  inline def StreamingQuerystring_=(x: Instantiable0[typingsJapgolly.formidable.parsersMod.StreamingQuerystring]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("StreamingQuerystring")(x.asInstanceOf[js.Any])
  ...
  @JSImport("formidable", "VolatileFile")
  @js.native
  def VolatileFile: Instantiable1[/* properties */ File, typingsJapgolly.formidable.persistentFileMod.^] = js.native
  inline def VolatileFile_=(x: Instantiable1[/* properties */ File, typingsJapgolly.formidable.persistentFileMod.^]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("VolatileFile")(x.asInstanceOf[js.Any])
  ...
  inline def formidable(): typingsJapgolly.formidable.formidableMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("formidable")().asInstanceOf[typingsJapgolly.formidable.formidableMod.^]
  inline def formidable(options: Options): typingsJapgolly.formidable.formidableMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("formidable")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.formidable.formidableMod.^]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.formidable.formidableStrings.ascii
    - typingsJapgolly.formidable.formidableStrings.base64
    - typingsJapgolly.formidable.formidableStrings.binary
    - typingsJapgolly.formidable.formidableStrings.hex
    - typingsJapgolly.formidable.formidableStrings.latin1
    - typingsJapgolly.formidable.formidableStrings.`ucs-2`
    - typingsJapgolly.formidable.formidableStrings.ucs2
    - typingsJapgolly.formidable.formidableStrings.`utf-8`
    - typingsJapgolly.formidable.formidableStrings.utf16le
    - typingsJapgolly.formidable.formidableStrings.utf8
  */
  trait BufferEncoding extends StObject
  object BufferEncoding {
    
    inline def ascii: typingsJapgolly.formidable.formidableStrings.ascii = "ascii".asInstanceOf[typingsJapgolly.formidable.formidableStrings.ascii]
    
    inline def base64: typingsJapgolly.formidable.formidableStrings.base64 = "base64".asInstanceOf[typingsJapgolly.formidable.formidableStrings.base64]
    
    inline def binary: typingsJapgolly.formidable.formidableStrings.binary = "binary".asInstanceOf[typingsJapgolly.formidable.formidableStrings.binary]
    
    inline def hex: typingsJapgolly.formidable.formidableStrings.hex = "hex".asInstanceOf[typingsJapgolly.formidable.formidableStrings.hex]
    
    inline def latin1: typingsJapgolly.formidable.formidableStrings.latin1 = "latin1".asInstanceOf[typingsJapgolly.formidable.formidableStrings.latin1]
    
    inline def `ucs-2`: typingsJapgolly.formidable.formidableStrings.`ucs-2` = "ucs-2".asInstanceOf[typingsJapgolly.formidable.formidableStrings.`ucs-2`]
    
    inline def ucs2: typingsJapgolly.formidable.formidableStrings.ucs2 = "ucs2".asInstanceOf[typingsJapgolly.formidable.formidableStrings.ucs2]
    
    inline def `utf-8`: typingsJapgolly.formidable.formidableStrings.`utf-8` = "utf-8".asInstanceOf[typingsJapgolly.formidable.formidableStrings.`utf-8`]
    
    inline def utf16le: typingsJapgolly.formidable.formidableStrings.utf16le = "utf16le".asInstanceOf[typingsJapgolly.formidable.formidableStrings.utf16le]
    
    inline def utf8: typingsJapgolly.formidable.formidableStrings.utf8 = "utf8".asInstanceOf[typingsJapgolly.formidable.formidableStrings.utf8]
  }
  ...
  trait DefaultOptions extends StObject {
    ...
    def filename(name: String, ext: String, part: Part, form: typingsJapgolly.formidable.formidableMod.^): String
    @JSName("filename")
    var filename_Original: js.Function4[
        /* name */ String, 
        /* ext */ String, 
        /* part */ Part, 
        /* form */ typingsJapgolly.formidable.formidableMod.^, 
        String
      ]
  ...
  object DefaultOptions {
    ...
    inline def apply(
      ...
      fileWriteStreamHandler: CallbackTo[Writable],
      filename: (/* name */ String, /* ext */ String, /* part */ Part, /* form */ typingsJapgolly.formidable.formidableMod.^) => String,
    ...
    extension [Self <: DefaultOptions](x: Self) {
      ...
      inline def setFileWriteStreamHandler(value: CallbackTo[Writable]): Self = StObject.set(x, "fileWriteStreamHandler", value.toJsFn)
      
      inline def setFilename(
        value: (/* name */ String, /* ext */ String, /* part */ Part, /* form */ typingsJapgolly.formidable.formidableMod.^) => String
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.formidable.formidableStrings.aborted
    - typingsJapgolly.formidable.formidableStrings.end_
    - typingsJapgolly.formidable.formidableStrings.error
    - typingsJapgolly.formidable.formidableStrings.field
    - typingsJapgolly.formidable.formidableStrings.file
    - typingsJapgolly.formidable.formidableStrings.fileBegin
    - typingsJapgolly.formidable.formidableStrings.headerEnd
    - typingsJapgolly.formidable.formidableStrings.headerField
    - typingsJapgolly.formidable.formidableStrings.headersEnd
    - typingsJapgolly.formidable.formidableStrings.headerValue
    - typingsJapgolly.formidable.formidableStrings.partBegin
    - typingsJapgolly.formidable.formidableStrings.partData
    - typingsJapgolly.formidable.formidableStrings.progress
  */
  trait EventNames extends StObject
  object EventNames {
    
    inline def aborted: typingsJapgolly.formidable.formidableStrings.aborted = "aborted".asInstanceOf[typingsJapgolly.formidable.formidableStrings.aborted]
    
    inline def end: end_ = "end".asInstanceOf[end_]
    
    inline def error: typingsJapgolly.formidable.formidableStrings.error = "error".asInstanceOf[typingsJapgolly.formidable.formidableStrings.error]
    
    inline def field: typingsJapgolly.formidable.formidableStrings.field = "field".asInstanceOf[typingsJapgolly.formidable.formidableStrings.field]
    
    inline def file: typingsJapgolly.formidable.formidableStrings.file = "file".asInstanceOf[typingsJapgolly.formidable.formidableStrings.file]
    
    inline def fileBegin: typingsJapgolly.formidable.formidableStrings.fileBegin = "fileBegin".asInstanceOf[typingsJapgolly.formidable.formidableStrings.fileBegin]
    
    inline def headerEnd: typingsJapgolly.formidable.formidableStrings.headerEnd = "headerEnd".asInstanceOf[typingsJapgolly.formidable.formidableStrings.headerEnd]
    
    inline def headerField: typingsJapgolly.formidable.formidableStrings.headerField = "headerField".asInstanceOf[typingsJapgolly.formidable.formidableStrings.headerField]
    
    inline def headerValue: typingsJapgolly.formidable.formidableStrings.headerValue = "headerValue".asInstanceOf[typingsJapgolly.formidable.formidableStrings.headerValue]
    
    inline def headersEnd: typingsJapgolly.formidable.formidableStrings.headersEnd = "headersEnd".asInstanceOf[typingsJapgolly.formidable.formidableStrings.headersEnd]
    
    inline def partBegin: typingsJapgolly.formidable.formidableStrings.partBegin = "partBegin".asInstanceOf[typingsJapgolly.formidable.formidableStrings.partBegin]
    
    inline def partData: typingsJapgolly.formidable.formidableStrings.partData = "partData".asInstanceOf[typingsJapgolly.formidable.formidableStrings.partData]
    
    inline def progress: typingsJapgolly.formidable.formidableStrings.progress = "progress".asInstanceOf[typingsJapgolly.formidable.formidableStrings.progress]
  }
  ...
  /* Inlined {[ P in keyof {  DummyParser :new (incomingForm : typeof IncomingForm, options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.DummyParser,   JSONParser :new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.JSONParser,   MultipartParser :{stateToString (stateNumber : number): string,   STATES :std.Record<'PARSER_UNINITIALIZED' | 'START' | 'START_BOUNDARY' | 'HEADER_FIELD_START' | 'HEADER_FIELD' | 'HEADER_VALUE_START' | 'HEADER_VALUE' | 'HEADER_VALUE_ALMOST_DONE' | 'HEADERS_ALMOST_DONE' | 'PART_DATA_START' | 'PART_DATA' | 'PART_END' | 'END', number>, new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.MultipartParser},   OctetStreamParser :new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.OctetStreamParser,   QuerystringParser :new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.QuerystringParser,   StreamingQuerystring :new (): formidable.formidable/parsers.StreamingQuerystring} ]: {  DummyParser :new (incomingForm : typeof IncomingForm, options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.DummyParser,   JSONParser :new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.JSONParser,   MultipartParser :{stateToString (stateNumber : number): string,   STATES :std.Record<'PARSER_UNINITIALIZED' | 'START' | 'START_BOUNDARY' | 'HEADER_FIELD_START' | 'HEADER_FIELD' | 'HEADER_VALUE_START' | 'HEADER_VALUE' | 'HEADER_VALUE_ALMOST_DONE' | 'HEADERS_ALMOST_DONE' | 'PART_DATA_START' | 'PART_DATA' | 'PART_END' | 'END', number>, new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.MultipartParser},   OctetStreamParser :new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.OctetStreamParser,   QuerystringParser :new (options : std.Partial<formidable.formidable.Options> | undefined): formidable.formidable/parsers.QuerystringParser,   StreamingQuerystring :new (): formidable.formidable/parsers.StreamingQuerystring}[P]} */
  trait MappedParsers extends StObject {
    ...
    var StreamingQuerystring: Instantiable0[typingsJapgolly.formidable.parsersMod.StreamingQuerystring]
  }
  object MappedParsers {
    ...
    inline def apply(
      ...
      StreamingQuerystring: Instantiable0[typingsJapgolly.formidable.parsersMod.StreamingQuerystring]
    ): MappedParsers = {
    ...
    extension [Self <: MappedParsers](x: Self) {
      ...
      inline def setStreamingQuerystring(value: Instantiable0[typingsJapgolly.formidable.parsersMod.StreamingQuerystring]): Self = StObject.set(x, "StreamingQuerystring", value.asInstanceOf[js.Any])
    }
  }
  ...
  type PluginFunction = js.Function2[
    /* formidable */ typingsJapgolly.formidable.formidableMod.^, 
    /* options */ PartialOptions, 
    Unit
  ]
