...
object mod {
  ...
  inline def ConditionalContextWrapper(e: Component[Any & js.Object, js.Object]): Component[Any & js.Object, js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("ConditionalContextWrapper")(e.asInstanceOf[js.Any]).asInstanceOf[Component[Any & js.Object, js.Object]]
  ...
  inline def FormolContextWrapper(WrappedComponent: Component[Any & js.Object, js.Object]): Component[Any & js.Object, js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("FormolContextWrapper")(WrappedComponent.asInstanceOf[js.Any]).asInstanceOf[Component[Any & js.Object, js.Object]]
  ...
  inline def choicesAdapter(WrappedComponent: Component[Any & js.Object, js.Object]): Component[Any & js.Object, js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("choicesAdapter")(WrappedComponent.asInstanceOf[js.Any]).asInstanceOf[Component[Any & js.Object, js.Object]]
  ...
  inline def memoizedChoices(WrappedComponent: Component[Any & js.Object, js.Object]): Component[Any & js.Object, js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("memoizedChoices")(WrappedComponent.asInstanceOf[js.Any]).asInstanceOf[Component[Any & js.Object, js.Object]]
  
  inline def multipleAdapter(WrappedComponent: Component[Any & js.Object, js.Object]): Component[Any & js.Object, js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("multipleAdapter")(WrappedComponent.asInstanceOf[js.Any]).asInstanceOf[Component[Any & js.Object, js.Object]]
  ...
  object FieldProps {
    ...
    extension [Self <: FieldProps[?], V](x: Self & FieldProps[V]) {
      ...
      inline def setExtras(value: VdomNode): Self = StObject.set(x, "extras", value.rawNode.asInstanceOf[js.Any])
      
      inline def setExtrasNull: Self = StObject.set(x, "extras", null)
      
      inline def setExtrasUndefined: Self = StObject.set(x, "extras", js.undefined)
      
      inline def setExtrasVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "extras", js.Array(value*))
      
      inline def setExtrasVdomElement(value: VdomElement): Self = StObject.set(x, "extras", value.rawElement.asInstanceOf[js.Any])
      
      inline def setFormatter(value: /* v */ V => V): Self = StObject.set(x, "formatter", js.Any.fromFunction1(value))
      
      inline def setFormatterUndefined: Self = StObject.set(x, "formatter", js.undefined)
      
      inline def setHandleChange(value: (/* name */ String, /* v */ V) => Callback): Self = StObject.set(x, "handleChange", js.Any.fromFunction2((t0: /* name */ String, t1: /* v */ V) => (value(t0, t1)).runNow()))
      
      inline def setHandleChangeUndefined: Self = StObject.set(x, "handleChange", js.undefined)
      
      inline def setHandleEntered(value: (/* name */ String, /* v */ V) => Callback): Self = StObject.set(x, "handleEntered", js.Any.fromFunction2((t0: /* name */ String, t1: /* v */ V) => (value(t0, t1)).runNow()))
      ...
      ): Self = StObject.set(x, "register", js.Any.fromFunction4((t0: /* name */ String, t1: /* element */ Ref[Any], t2: /* validator */ Any, t3: /* validityErrors */ Any) => (value(t0, t1, t2, t3)).runNow()))
      ...
      inline def setUnit(value: VdomNode): Self = StObject.set(x, "unit", value.rawNode.asInstanceOf[js.Any])
      
      inline def setUnitNull: Self = StObject.set(x, "unit", null)
      
      inline def setUnitUndefined: Self = StObject.set(x, "unit", js.undefined)
      
      inline def setUnitVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "unit", js.Array(value*))
      
      inline def setUnitVdomElement(value: VdomElement): Self = StObject.set(x, "unit", value.rawElement.asInstanceOf[js.Any])
  ...
  object FieldSetProps {
    ...
    extension [Self <: FieldSetProps[?], V](x: Self & FieldSetProps[V]) {
      ...
      inline def setElementRefFunction1(value: Any | Null => Callback): Self = StObject.set(x, "elementRef", js.Any.fromFunction1((t0: Any | Null) => value(t0).runNow()))
  ...
  object FormolProps {
    ...
    extension [Self <: FormolProps[?], V](x: Self & FormolProps[V]) {
      ...
      inline def setOnSubmit(value: /* e */ Event => Callback): Self = StObject.set(x, "onSubmit", js.Any.fromFunction1((t0: /* e */ Event) => value(t0).runNow()))
  ...
  object SwitchButtonProps {
    ...
    extension [Self <: SwitchButtonProps](x: Self) {
      ...
      inline def setLeftLabel(value: VdomNode): Self = StObject.set(x, "leftLabel", value.rawNode.asInstanceOf[js.Any])
      
      inline def setLeftLabelNull: Self = StObject.set(x, "leftLabel", null)
      
      inline def setLeftLabelUndefined: Self = StObject.set(x, "leftLabel", js.undefined)
      
      inline def setLeftLabelVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "leftLabel", js.Array(value*))
      
      inline def setLeftLabelVdomElement(value: VdomElement): Self = StObject.set(x, "leftLabel", value.rawElement.asInstanceOf[js.Any])
      
      inline def setRightLabel(value: VdomNode): Self = StObject.set(x, "rightLabel", value.rawNode.asInstanceOf[js.Any])
      
      inline def setRightLabelNull: Self = StObject.set(x, "rightLabel", null)
      
      inline def setRightLabelUndefined: Self = StObject.set(x, "rightLabel", js.undefined)
      
      inline def setRightLabelVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "rightLabel", js.Array(value*))
      
      inline def setRightLabelVdomElement(value: VdomElement): Self = StObject.set(x, "rightLabel", value.rawElement.asInstanceOf[js.Any])
