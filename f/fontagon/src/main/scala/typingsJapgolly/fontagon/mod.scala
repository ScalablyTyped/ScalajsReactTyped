package typingsJapgolly.fontagon

import typingsJapgolly.fontagon.anon.RecordStyleSheetGeneratio
import typingsJapgolly.fontagon.fontagonStrings.all
import typingsJapgolly.std.Record
import typingsJapgolly.svg2ttf.mod.FontOptions
import typingsJapgolly.svgicons2svgfont.mod.SvgIcons2FontOptions
...
object mod {
  ...
  trait FormatOptions extends StObject {
    ...
    var woff: js.UndefOr[typingsJapgolly.ttf2woff.mod.Options] = js.undefined
  ...
  object FormatOptions {
    ...
    extension [Self <: FormatOptions](x: Self) {
      ...
      inline def setWoff(value: typingsJapgolly.ttf2woff.mod.Options): Self = StObject.set(x, "woff", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fontagon.fontagonStrings.css
    - typingsJapgolly.fontagon.fontagonStrings.sass
    - typingsJapgolly.fontagon.fontagonStrings.less
    - typingsJapgolly.fontagon.fontagonStrings.stylus
  */
  trait StyleSheetGenerationType extends StObject
  object StyleSheetGenerationType {
    
    inline def css: typingsJapgolly.fontagon.fontagonStrings.css = "css".asInstanceOf[typingsJapgolly.fontagon.fontagonStrings.css]
    
    inline def less: typingsJapgolly.fontagon.fontagonStrings.less = "less".asInstanceOf[typingsJapgolly.fontagon.fontagonStrings.less]
    
    inline def sass: typingsJapgolly.fontagon.fontagonStrings.sass = "sass".asInstanceOf[typingsJapgolly.fontagon.fontagonStrings.sass]
    
    inline def stylus: typingsJapgolly.fontagon.fontagonStrings.stylus = "stylus".asInstanceOf[typingsJapgolly.fontagon.fontagonStrings.stylus]
  }
}
