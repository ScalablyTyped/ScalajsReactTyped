...
object libStylesheetMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fluentuiMergeStyles.fluentuiMergeStylesInts.`0`
    - typingsJapgolly.fluentuiMergeStyles.fluentuiMergeStylesInts.`1`
    - typingsJapgolly.fluentuiMergeStyles.fluentuiMergeStylesInts.`2`
  */
