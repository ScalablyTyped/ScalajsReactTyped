...
import typingsJapgolly.ftpd.anon.BufferSize
import typingsJapgolly.ftpd.anon.Encoding
import typingsJapgolly.ftpd.anon.EncodingFlag
import typingsJapgolly.ftpd.anon.Flag
import typingsJapgolly.ftpd.anon.Mode
import typingsJapgolly.ftpd.anon.`0`
import typingsJapgolly.ftpd.ftpdInts.`1`
import typingsJapgolly.ftpd.ftpdInts.`2`
import typingsJapgolly.ftpd.ftpdInts.`3`
import typingsJapgolly.ftpd.ftpdInts.`4`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ftpd.ftpdInts.`0`
    - typingsJapgolly.ftpd.ftpdInts.`1`
    - typingsJapgolly.ftpd.ftpdInts.`2`
    - typingsJapgolly.ftpd.ftpdInts.`3`
    - typingsJapgolly.ftpd.ftpdInts.`4`
  */
  ...
  object LogLevel {
    ...
    inline def ERROR: typingsJapgolly.ftpd.ftpdInts.`0` = 0.asInstanceOf[typingsJapgolly.ftpd.ftpdInts.`0`]
