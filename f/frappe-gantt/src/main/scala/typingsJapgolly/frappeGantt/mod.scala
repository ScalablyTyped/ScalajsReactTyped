...
import typingsJapgolly.frappeGantt.frappeGanttStrings.Day_
import typingsJapgolly.frappeGantt.frappeGanttStrings.Month_
import typingsJapgolly.frappeGantt.frappeGanttStrings.Week_
import typingsJapgolly.frappeGantt.frappeGanttStrings.Year_
...
object mod {
  ...
  object Gantt {
    ...
    inline def apply(change_view_mode: viewMode => Callback, refresh: js.Array[Task] => Callback): Gantt = {
      val __obj = js.Dynamic.literal(change_view_mode = js.Any.fromFunction1((t0: viewMode) => change_view_mode(t0).runNow()), refresh = js.Any.fromFunction1((t0: js.Array[Task]) => refresh(t0).runNow()))
      __obj.asInstanceOf[Gantt]
    }
    
    extension [Self <: Gantt](x: Self) {
      
      inline def setChange_view_mode(value: viewMode => Callback): Self = StObject.set(x, "change_view_mode", js.Any.fromFunction1((t0: viewMode) => value(t0).runNow()))
      
      inline def setRefresh(value: js.Array[Task] => Callback): Self = StObject.set(x, "refresh", js.Any.fromFunction1((t0: js.Array[Task]) => value(t0).runNow()))
    }
  }
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOn_click(value: /* task */ EnrichedTask => Callback): Self = StObject.set(x, "on_click", js.Any.fromFunction1((t0: /* task */ EnrichedTask) => value(t0).runNow()))
      
      inline def setOn_clickUndefined: Self = StObject.set(x, "on_click", js.undefined)
      
      inline def setOn_date_change(value: (/* task */ EnrichedTask, /* start */ js.Date, /* end */ js.Date) => Callback): Self = StObject.set(x, "on_date_change", js.Any.fromFunction3((t0: /* task */ EnrichedTask, t1: /* start */ js.Date, t2: /* end */ js.Date) => (value(t0, t1, t2)).runNow()))
      
      inline def setOn_date_changeUndefined: Self = StObject.set(x, "on_date_change", js.undefined)
      
      inline def setOn_progress_change(value: (/* task */ EnrichedTask, /* progress */ Double) => Callback): Self = StObject.set(x, "on_progress_change", js.Any.fromFunction2((t0: /* task */ EnrichedTask, t1: /* progress */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOn_progress_changeUndefined: Self = StObject.set(x, "on_progress_change", js.undefined)
      
      inline def setOn_view_change(value: /* mode */ viewMode => Callback): Self = StObject.set(x, "on_view_change", js.Any.fromFunction1((t0: /* mode */ viewMode) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.frappeGantt.frappeGanttStrings.Day_
    - typingsJapgolly.frappeGantt.frappeGanttStrings.Week_
    - typingsJapgolly.frappeGantt.frappeGanttStrings.Month_
    - typingsJapgolly.frappeGantt.frappeGanttStrings.Year_
  */
  ...
  object viewMode {
    ...
    inline def `Half Day`: typingsJapgolly.frappeGantt.frappeGanttStrings.`Half Day` = ("Half Day").asInstanceOf[typingsJapgolly.frappeGantt.frappeGanttStrings.`Half Day`]
    
    inline def Month: Month_ = "Month".asInstanceOf[Month_]
    
    inline def `Quarter Day`: typingsJapgolly.frappeGantt.frappeGanttStrings.`Quarter Day` = ("Quarter Day").asInstanceOf[typingsJapgolly.frappeGantt.frappeGanttStrings.`Quarter Day`]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.frappeGantt.frappeGanttStrings.QUARTER_DAY
    - typingsJapgolly.frappeGantt.frappeGanttStrings.HALF_DAY
    ...
    - typingsJapgolly.frappeGantt.frappeGanttStrings.YEAR
  */
  trait viewModeKey extends StObject
  object viewModeKey {
    
    inline def DAY: typingsJapgolly.frappeGantt.frappeGanttStrings.DAY = "DAY".asInstanceOf[typingsJapgolly.frappeGantt.frappeGanttStrings.DAY]
    
    inline def HALF_DAY: typingsJapgolly.frappeGantt.frappeGanttStrings.HALF_DAY = "HALF_DAY".asInstanceOf[typingsJapgolly.frappeGantt.frappeGanttStrings.HALF_DAY]
    
    inline def MONTH: typingsJapgolly.frappeGantt.frappeGanttStrings.MONTH = "MONTH".asInstanceOf[typingsJapgolly.frappeGantt.frappeGanttStrings.MONTH]
    
    inline def QUARTER_DAY: typingsJapgolly.frappeGantt.frappeGanttStrings.QUARTER_DAY = "QUARTER_DAY".asInstanceOf[typingsJapgolly.frappeGantt.frappeGanttStrings.QUARTER_DAY]
    
    inline def WEEK: typingsJapgolly.frappeGantt.frappeGanttStrings.WEEK = "WEEK".asInstanceOf[typingsJapgolly.frappeGantt.frappeGanttStrings.WEEK]
    
    inline def YEAR: typingsJapgolly.frappeGantt.frappeGanttStrings.YEAR = "YEAR".asInstanceOf[typingsJapgolly.frappeGantt.frappeGanttStrings.YEAR]
  }
}
