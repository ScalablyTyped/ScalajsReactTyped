...
import typingsJapgolly.fluxStandardAction.fluxStandardActionBooleans.`true`
...
object mod {
  ...
  - typingsJapgolly.fluxStandardAction.mod.FluxStandardAction because Already inherited
  - typingsJapgolly.fluxStandardAction.mod.FluxStandardActionWithMeta because var conflicts: error, meta, payload, `type`. Inlined  */ trait ErrorFluxStandardActionWithMeta[Type /* <: String */, CustomError /* <: js.Error */, Meta]
    extends StObject
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.fluxStandardAction.mod.FluxStandardAction because Already inherited
  - typingsJapgolly.fluxStandardAction.mod.FluxStandardActionWithPayload because var conflicts: error, meta, payload, `type`. Inlined  */ trait ErrorFluxStandardActionWithPayload[Type /* <: String */, CustomError /* <: js.Error */, Meta]
    extends StObject
       with ErrorFluxStandardAction[Type, CustomError, Meta]
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.fluxStandardAction.mod.FluxStandardAction because Already inherited
  - typingsJapgolly.fluxStandardAction.mod.FluxStandardActionWithMeta because var conflicts: error, meta, payload, `type`. Inlined  */ trait FluxStandardActionWithPayloadAndMeta[Type /* <: String */, Payload, Meta]
    extends StObject
