...
object mod extends Shortcut {
  ...
  object Options {
    ...
    extension [Self <: Options[?], T](x: Self & Options[T]) {
      ...
      inline def setAfterBuild(value: (/* model */ Any, /* attrs */ T | js.Array[T], /* options */ Any) => Callback): Self = StObject.set(x, "afterBuild", js.Any.fromFunction3((t0: /* model */ Any, t1: /* attrs */ T | js.Array[T], t2: /* options */ Any) => (value(t0, t1, t2)).runNow()))
      
      inline def setAfterBuildUndefined: Self = StObject.set(x, "afterBuild", js.undefined)
      
      inline def setAfterCreate(value: (/* model */ Any, /* attrs */ T | js.Array[T], /* options */ Any) => Callback): Self = StObject.set(x, "afterCreate", js.Any.fromFunction3((t0: /* model */ Any, t1: /* attrs */ T | js.Array[T], t2: /* options */ Any) => (value(t0, t1, t2)).runNow()))
