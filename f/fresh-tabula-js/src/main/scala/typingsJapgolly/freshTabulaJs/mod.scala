...
import typingsJapgolly.freshTabulaJs.anon.Error
...
object mod {
  ...
  object Tabula {
    ...
    inline def apply(
      getData: CallbackTo[js.Promise[Error]],
      stream: CallbackTo[Stream[Buffer]],
      streamSections: js.Function2[/* err */ js.Error | Null, /* data */ String | Null, Unit] => Callback
    ): Tabula = {
      val __obj = js.Dynamic.literal(getData = getData.toJsFn, stream = stream.toJsFn, streamSections = js.Any.fromFunction1((t0: js.Function2[/* err */ js.Error | Null, /* data */ String | Null, Unit]) => streamSections(t0).runNow()))
      __obj.asInstanceOf[Tabula]
    }
    
    extension [Self <: Tabula](x: Self) {
      
      inline def setGetData(value: CallbackTo[js.Promise[Error]]): Self = StObject.set(x, "getData", value.toJsFn)
      
      inline def setStream(value: CallbackTo[Stream[Buffer]]): Self = StObject.set(x, "stream", value.toJsFn)
      
      inline def setStreamSections(value: js.Function2[/* err */ js.Error | Null, /* data */ String | Null, Unit] => Callback): Self = StObject.set(x, "streamSections", js.Any.fromFunction1((t0: js.Function2[/* err */ js.Error | Null, /* data */ String | Null, Unit]) => value(t0).runNow()))
    }
  }
}
