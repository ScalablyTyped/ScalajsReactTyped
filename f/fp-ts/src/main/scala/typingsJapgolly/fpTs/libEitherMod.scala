...
import typingsJapgolly.fpTs.fpTsStrings.Left
import typingsJapgolly.fpTs.fpTsStrings.Right
...
object libEitherMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fpTs.libEitherMod.Left_[E]
    - typingsJapgolly.fpTs.libEitherMod.Right_[A]
  */
  trait Either_[E, A]
    extends StObject
       with These_[E, A]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
    - scala.Null
    - typingsJapgolly.fpTs.libEitherMod.JsonArray
    - typingsJapgolly.fpTs.libEitherMod.JsonRecord
  */
