...
import typingsJapgolly.fpTs.fpTsStrings.Both
...
object libTheseMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fpTs.libEitherMod.Either_[E, A]
    - typingsJapgolly.fpTs.libTheseMod.Both_[E, A]
  */
  trait These_[E, A] extends StObject
  object These_ {
    
    inline def Both_[E, A](left: E, right: A): typingsJapgolly.fpTs.libTheseMod.Both_[E, A] = {
      val __obj = js.Dynamic.literal(_tag = "Both", left = left.asInstanceOf[js.Any], right = right.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.fpTs.libTheseMod.Both_[E, A]]
    }
    
    inline def Left_[E](left: E): typingsJapgolly.fpTs.libEitherMod.Left_[E] = {
      val __obj = js.Dynamic.literal(_tag = "Left", left = left.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.fpTs.libEitherMod.Left_[E]]
    }
    
    inline def Right_[A](right: A): typingsJapgolly.fpTs.libEitherMod.Right_[A] = {
      val __obj = js.Dynamic.literal(_tag = "Right", right = right.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.fpTs.libEitherMod.Right_[A]]
    }
  }
}
