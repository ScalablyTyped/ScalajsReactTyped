...
object es6TaskOptionMod {
  ...
  @JSImport("fp-ts/es6/TaskOption", "compact")
  @js.native
  ...
  @JSImport("fp-ts/es6/TaskOption", "none")
  @js.native
  ...
  @JSImport("fp-ts/es6/TaskOption", "separate")
  @js.native
