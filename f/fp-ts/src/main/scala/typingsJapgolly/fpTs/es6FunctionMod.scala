...
object es6FunctionMod {
  ...
  @JSImport("fp-ts/es6/function", "constFalse")
  @js.native
  val constFalse: Lazy[Boolean] = js.native
  
  @JSImport("fp-ts/es6/function", "constNull")
  @js.native
  val constNull: Lazy[Null] = js.native
  
  @JSImport("fp-ts/es6/function", "constTrue")
  @js.native
  val constTrue: Lazy[Boolean] = js.native
  
  @JSImport("fp-ts/es6/function", "constUndefined")
  @js.native
  val constUndefined: Lazy[Unit] = js.native
  
  @JSImport("fp-ts/es6/function", "constVoid")
  @js.native
