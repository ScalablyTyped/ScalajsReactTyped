...
object es6ReadonlyTupleMod {
  ...
  @JSImport("fp-ts/es6/ReadonlyTuple", "readonlyTuple")
  @js.native
  ...
  @JSImport("fp-ts/es6/ReadonlyTuple", "sequence")
  @js.native
  ...
  @JSImport("fp-ts/es6/ReadonlyTuple", "traverse")
  @js.native
