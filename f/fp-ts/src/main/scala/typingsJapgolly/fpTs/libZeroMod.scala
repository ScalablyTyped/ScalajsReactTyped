...
object libZeroMod {
  ...
  object Zero {
    ...
    inline def apply[F](URI: F, zero: CallbackTo[Any]): Zero[F] = {
      val __obj = js.Dynamic.literal(URI = URI.asInstanceOf[js.Any], zero = zero.toJsFn)
    ...
    extension [Self <: Zero[?], F](x: Self & Zero[F]) {
      ...
      inline def setZero(value: CallbackTo[Any]): Self = StObject.set(x, "zero", value.toJsFn)
    }
  }
  ...
  object Zero1 {
    ...
    inline def apply[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ Any */](URI: F, zero: CallbackTo[Any]): Zero1[F] = {
      val __obj = js.Dynamic.literal(URI = URI.asInstanceOf[js.Any], zero = zero.toJsFn)
  ...
  object Zero2 {
    ...
    inline def apply[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */](URI: F, zero: CallbackTo[Any]): Zero2[F] = {
      val __obj = js.Dynamic.literal(URI = URI.asInstanceOf[js.Any], zero = zero.toJsFn)
  ...
  object Zero2C {
    ...
    inline def apply[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, E](URI: F, _E: E, zero: CallbackTo[Any]): Zero2C[F, E] = {
      val __obj = js.Dynamic.literal(URI = URI.asInstanceOf[js.Any], _E = _E.asInstanceOf[js.Any], zero = zero.toJsFn)
  ...
  object Zero3 {
    ...
    inline def apply[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */](URI: F, zero: CallbackTo[Any]): Zero3[F] = {
      val __obj = js.Dynamic.literal(URI = URI.asInstanceOf[js.Any], zero = zero.toJsFn)
  ...
  object Zero3C {
    ...
    inline def apply[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */, E](URI: F, _E: E, zero: CallbackTo[Any]): Zero3C[F, E] = {
      val __obj = js.Dynamic.literal(URI = URI.asInstanceOf[js.Any], _E = _E.asInstanceOf[js.Any], zero = zero.toJsFn)
  ...
  object Zero4 {
    ...
    inline def apply[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ Any */](URI: F, zero: CallbackTo[Any]): Zero4[F] = {
      val __obj = js.Dynamic.literal(URI = URI.asInstanceOf[js.Any], zero = zero.toJsFn)
