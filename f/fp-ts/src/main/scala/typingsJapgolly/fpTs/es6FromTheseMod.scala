...
import typingsJapgolly.fpTs.libFromTheseMod.FromThese
import typingsJapgolly.fpTs.libFromTheseMod.FromThese2
import typingsJapgolly.fpTs.libFromTheseMod.FromThese2C
import typingsJapgolly.fpTs.libFromTheseMod.FromThese3
import typingsJapgolly.fpTs.libFromTheseMod.FromThese3C
import typingsJapgolly.fpTs.libFromTheseMod.FromThese4
...
object es6FromTheseMod {
  
  @JSImport("fp-ts/es6/FromThese", JSImport.Namespace)
  @js.native
