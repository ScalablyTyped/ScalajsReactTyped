...
import typingsJapgolly.fpTs.libEitherTMod.EitherM
import typingsJapgolly.fpTs.libEitherTMod.EitherM1
import typingsJapgolly.fpTs.libEitherTMod.EitherM2
...
object eitherTMod {
  ...
  @JSImport("fp-ts/EitherT", JSImport.Namespace)
  @js.native
