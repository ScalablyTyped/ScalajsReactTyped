...
object readonlyRecordMod {
  ...
  @JSImport("fp-ts/ReadonlyRecord", "empty")
  @js.native
  ...
  @JSImport("fp-ts/ReadonlyRecord", "readonlyRecord")
  @js.native
