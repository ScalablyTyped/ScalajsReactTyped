...
object es6SeparatedMod {
  
  @JSImport("fp-ts/es6/Separated", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/es6/Separated", "Bifunctor")
  @js.native
  val Bifunctor: Bifunctor2[typingsJapgolly.fpTs.libSeparatedMod.URI] = js.native
  
  @JSImport("fp-ts/es6/Separated", "Functor")
  @js.native
  val Functor: Functor2[typingsJapgolly.fpTs.libSeparatedMod.URI] = js.native
  
  @JSImport("fp-ts/es6/Separated", "URI")
  @js.native
