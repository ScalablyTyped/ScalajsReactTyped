...
import typingsJapgolly.fpTs.anon.FnCallStartWithAs
...
object es6SemigroupMod {
  
  @JSImport("fp-ts/es6/Semigroup", JSImport.Namespace)
  @js.native
  ...
  @JSImport("fp-ts/es6/Semigroup", "semigroupAll")
  @js.native
  val semigroupAll: Semigroup[Boolean] = js.native
  
  @JSImport("fp-ts/es6/Semigroup", "semigroupAny")
  @js.native
  val semigroupAny: Semigroup[Boolean] = js.native
  
  @JSImport("fp-ts/es6/Semigroup", "semigroupProduct")
  @js.native
  val semigroupProduct: Semigroup[Double] = js.native
  
  @JSImport("fp-ts/es6/Semigroup", "semigroupString")
  @js.native
  val semigroupString: Semigroup[String] = js.native
  
  @JSImport("fp-ts/es6/Semigroup", "semigroupSum")
  @js.native
  val semigroupSum: Semigroup[Double] = js.native
  
  @JSImport("fp-ts/es6/Semigroup", "semigroupVoid")
  @js.native
