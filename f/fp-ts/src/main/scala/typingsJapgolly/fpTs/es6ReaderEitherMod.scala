...
object es6ReaderEitherMod {
  ...
  @JSImport("fp-ts/es6/ReaderEither", "readerEither")
  @js.native
  ...
  @JSImport("fp-ts/es6/ReaderEither", "throwError")
  @js.native
