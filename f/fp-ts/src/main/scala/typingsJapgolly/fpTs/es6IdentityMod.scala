...
object es6IdentityMod {
  ...
  @JSImport("fp-ts/es6/Identity", "sequence")
  @js.native
  val sequence: Sequence1[typingsJapgolly.fpTs.libIdentityMod.URI] = js.native
  
  @JSImport("fp-ts/es6/Identity", "traverse")
  @js.native
