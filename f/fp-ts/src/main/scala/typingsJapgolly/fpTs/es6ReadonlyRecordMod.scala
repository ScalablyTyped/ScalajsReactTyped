...
object es6ReadonlyRecordMod {
  ...
  @JSImport("fp-ts/es6/ReadonlyRecord", "empty")
  @js.native
  ...
  @JSImport("fp-ts/es6/ReadonlyRecord", "readonlyRecord")
  @js.native
  ...
  @JSImport("fp-ts/es6/ReadonlyRecord", "wilt")
  @js.native
  val wilt: PipeableWilt1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyRecord", "wither")
  @js.native
