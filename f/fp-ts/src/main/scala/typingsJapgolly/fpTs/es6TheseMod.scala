...
object es6TheseMod {
  ...
  @JSImport("fp-ts/es6/These", "sequence")
  @js.native
  ...
  @JSImport("fp-ts/es6/These", "these")
  @js.native
  ...
  @JSImport("fp-ts/es6/These", "traverse")
  @js.native
