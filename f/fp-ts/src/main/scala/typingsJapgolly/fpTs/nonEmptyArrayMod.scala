...
object nonEmptyArrayMod {
  ...
  @JSImport("fp-ts/NonEmptyArray", "extract")
  @js.native
  ...
  @JSImport("fp-ts/NonEmptyArray", "nonEmptyArray")
  @js.native
  ...
  @JSImport("fp-ts/NonEmptyArray", "sequence")
  @js.native
