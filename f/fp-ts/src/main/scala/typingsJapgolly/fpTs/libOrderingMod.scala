...
object libOrderingMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fpTs.fpTsInts.`-1`
    - typingsJapgolly.fpTs.fpTsInts.`0`
    - typingsJapgolly.fpTs.fpTsInts.`1`
  */
  trait Ordering extends StObject
  object Ordering {
    
    inline def `-1`: typingsJapgolly.fpTs.fpTsInts.`-1` = -1.asInstanceOf[typingsJapgolly.fpTs.fpTsInts.`-1`]
    
    inline def `0`: typingsJapgolly.fpTs.fpTsInts.`0` = 0.asInstanceOf[typingsJapgolly.fpTs.fpTsInts.`0`]
