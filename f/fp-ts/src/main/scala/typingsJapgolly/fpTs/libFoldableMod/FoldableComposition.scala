...
trait FoldableComposition[F, G] extends StObject {
...
object FoldableComposition {
  ...
  extension [Self <: FoldableComposition[?, ?], F, G](x: Self & (FoldableComposition[F, G])) {
    ...
    inline def setReduce(
      value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify HKT<F, HKT<G, A>> */ Any, Any, js.Function2[Any, Any, Any]) => Any
