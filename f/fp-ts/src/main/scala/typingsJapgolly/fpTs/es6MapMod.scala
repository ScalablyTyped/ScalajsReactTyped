...
import typingsJapgolly.fpTs.anon.Fn6
import typingsJapgolly.fpTs.anon.Fn7
import typingsJapgolly.fpTs.anon.Fn8
import typingsJapgolly.fpTs.anon.FnCallAM
import typingsJapgolly.fpTs.anon.FnCallKM
...
object es6MapMod {
  ...
  @JSImport("fp-ts/es6/Map", "Compactable")
  @js.native
  val Compactable: Compactable2[typingsJapgolly.fpTs.libMapMod.URI] = js.native
  
  @JSImport("fp-ts/es6/Map", "Filterable")
  @js.native
  val Filterable: Filterable2[typingsJapgolly.fpTs.libMapMod.URI] = js.native
  
  @JSImport("fp-ts/es6/Map", "Functor")
  @js.native
  val Functor: Functor2[typingsJapgolly.fpTs.libMapMod.URI] = js.native
  
  @JSImport("fp-ts/es6/Map", "URI")
  @js.native
  ...
  inline def getFilterableWithIndex[K](): FilterableWithIndex2C[typingsJapgolly.fpTs.libMapMod.URI, K, K] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFilterableWithIndex")().asInstanceOf[FilterableWithIndex2C[typingsJapgolly.fpTs.libMapMod.URI, K, K]]
  
  inline def getFoldable[K](O: Ord_[K]): Foldable2C[typingsJapgolly.fpTs.fpTsStrings.Map, K] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFoldable")(O.asInstanceOf[js.Any]).asInstanceOf[Foldable2C[typingsJapgolly.fpTs.fpTsStrings.Map, K]]
  
  inline def getFoldableWithIndex[K](O: Ord_[K]): FoldableWithIndex2C[typingsJapgolly.fpTs.fpTsStrings.Map, K, K] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFoldableWithIndex")(O.asInstanceOf[js.Any]).asInstanceOf[FoldableWithIndex2C[typingsJapgolly.fpTs.fpTsStrings.Map, K, K]]
  ...
  inline def getTraversableWithIndex[K](O: Ord_[K]): TraversableWithIndex2C[typingsJapgolly.fpTs.fpTsStrings.Map, K, K] = ^.asInstanceOf[js.Dynamic].applyDynamic("getTraversableWithIndex")(O.asInstanceOf[js.Any]).asInstanceOf[TraversableWithIndex2C[typingsJapgolly.fpTs.fpTsStrings.Map, K, K]]
  ...
  inline def getWitherable[K](O: Ord_[K]): (Witherable2C[typingsJapgolly.fpTs.libMapMod.URI, K]) & (TraversableWithIndex2C[typingsJapgolly.fpTs.libMapMod.URI, K, K]) = ^.asInstanceOf[js.Dynamic].applyDynamic("getWitherable")(O.asInstanceOf[js.Any]).asInstanceOf[(Witherable2C[typingsJapgolly.fpTs.libMapMod.URI, K]) & (TraversableWithIndex2C[typingsJapgolly.fpTs.libMapMod.URI, K, K])]
  ...
  inline def isSubmap[K, A](SK: Eq[K], SA: Eq[A]): Fn6[K, A] = (^.asInstanceOf[js.Dynamic].applyDynamic("isSubmap")(SK.asInstanceOf[js.Any], SA.asInstanceOf[js.Any])).asInstanceOf[Fn6[K, A]]
  ...
  inline def lookupWithKey[K](E: Eq[K]): Fn7[K] = ^.asInstanceOf[js.Dynamic].applyDynamic("lookupWithKey")(E.asInstanceOf[js.Any]).asInstanceOf[Fn7[K]]
  ...
  @JSImport("fp-ts/es6/Map", "map_")
  @js.native
  val map_ : Filterable2[typingsJapgolly.fpTs.libMapMod.URI] = js.native
  
  inline def member[K](E: Eq[K]): Fn8[K] = ^.asInstanceOf[js.Dynamic].applyDynamic("member")(E.asInstanceOf[js.Any]).asInstanceOf[Fn8[K]]
