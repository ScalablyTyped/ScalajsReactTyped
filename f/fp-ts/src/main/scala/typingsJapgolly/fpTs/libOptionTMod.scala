...
import typingsJapgolly.fpTs.libApplicativeMod.ApplicativeComposition2C1
...
import typingsJapgolly.fpTs.libOptionMod.URI
...
object libOptionTMod {
  ...
  object OptionM {
    ...
    inline def apply[M](
      ...
      none: CallbackTo[OptionT[M, Any]],
      of: Any => Any
    ): OptionM[M] = {
      val __obj = js.Dynamic.literal(alt = js.Any.fromFunction2(alt), ap = js.Any.fromFunction2(ap), chain = js.Any.fromFunction2(chain), fold = js.Any.fromFunction3(fold), fromM = js.Any.fromFunction1(fromM), getOrElse = js.Any.fromFunction2(getOrElse), map = js.Any.fromFunction2(map), none = none.toJsFn, of = js.Any.fromFunction1(of))
    ...
    extension [Self <: OptionM[?], M](x: Self & OptionM[M]) {
      ...
      inline def setNone(value: CallbackTo[OptionT[M, Any]]): Self = StObject.set(x, "none", value.toJsFn)
    }
  }
  ...
  object OptionM1 {
    ...
    inline def apply[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ Any */](
      ...
      none: CallbackTo[OptionT1[M, Any]],
      of: Any => Any
    ): OptionM1[M] = {
      val __obj = js.Dynamic.literal(alt = js.Any.fromFunction2(alt), ap = js.Any.fromFunction2(ap), chain = js.Any.fromFunction2(chain), fold = js.Any.fromFunction3(fold), fromM = js.Any.fromFunction1(fromM), getOrElse = js.Any.fromFunction2(getOrElse), map = js.Any.fromFunction2(map), none = none.toJsFn, of = js.Any.fromFunction1(of))
    ...
    extension [Self <: OptionM1[?], M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ Any */](x: Self & OptionM1[M]) {
      ...
      inline def setNone(value: CallbackTo[OptionT1[M, Any]]): Self = StObject.set(x, "none", value.toJsFn)
    }
  }
  ...
  object OptionM2 {
    ...
    inline def apply[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */](
      ...
      none: CallbackTo[OptionT2[M, Any, Any]],
      of: Any => Any
    ): OptionM2[M] = {
      val __obj = js.Dynamic.literal(alt = js.Any.fromFunction2(alt), ap = js.Any.fromFunction2(ap), chain = js.Any.fromFunction2(chain), fold = js.Any.fromFunction3(fold), fromM = js.Any.fromFunction1(fromM), getOrElse = js.Any.fromFunction2(getOrElse), map = js.Any.fromFunction2(map), none = none.toJsFn, of = js.Any.fromFunction1(of))
    ...
    extension [Self <: OptionM2[?], M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */](x: Self & OptionM2[M]) {
      ...
      inline def setNone(value: CallbackTo[OptionT2[M, Any, Any]]): Self = StObject.set(x, "none", value.toJsFn)
    }
  }
  ...
  object OptionM2C {
    ...
    inline def apply[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, E](
      ...
      map: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Kind2<F, E, Kind<G, A>> */ Any, js.Function1[Any, Any]) => Any,
      none: CallbackTo[OptionT2[M, E, Any]],
      of: Any => Any
    ): OptionM2C[M, E] = {
      val __obj = js.Dynamic.literal(alt = js.Any.fromFunction2(alt), ap = js.Any.fromFunction2(ap), chain = js.Any.fromFunction2(chain), fold = js.Any.fromFunction3(fold), fromM = js.Any.fromFunction1(fromM), getOrElse = js.Any.fromFunction2(getOrElse), map = js.Any.fromFunction2(map), none = none.toJsFn, of = js.Any.fromFunction1(of))
    ...
    extension [Self <: OptionM2C[?, ?], M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, E](x: Self & (OptionM2C[M, E])) {
      ...
      inline def setNone(value: CallbackTo[OptionT2[M, E, Any]]): Self = StObject.set(x, "none", value.toJsFn)
    }
  }
