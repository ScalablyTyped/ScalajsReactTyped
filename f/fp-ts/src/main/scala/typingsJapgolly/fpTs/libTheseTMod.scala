...
import typingsJapgolly.fpTs.anon.Ap
import typingsJapgolly.fpTs.anon.Map
...
object libTheseTMod {
  ...
  trait TheseM1[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ Any */] extends StObject {
    ...
    def getMonad[E](S: Semigroup[E]): typingsJapgolly.fpTs.anon.Chain[E, M]
  ...
  object TheseM1 {
    ...
    inline def apply[M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ Any */](
      ...
      getMonad: Semigroup[Any] => typingsJapgolly.fpTs.anon.Chain[Any, M],
    ...
    extension [Self <: TheseM1[?], M /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ Any */](x: Self & TheseM1[M]) {
      ...
      inline def setGetMonad(value: Semigroup[Any] => typingsJapgolly.fpTs.anon.Chain[Any, M]): Self = StObject.set(x, "getMonad", js.Any.fromFunction1(value))
