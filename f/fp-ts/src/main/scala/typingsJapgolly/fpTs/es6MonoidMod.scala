...
object es6MonoidMod {
  ...
  @JSImport("fp-ts/es6/Monoid", "monoidAll")
  @js.native
  val monoidAll: Monoid[Boolean] = js.native
  
  @JSImport("fp-ts/es6/Monoid", "monoidAny")
  @js.native
  val monoidAny: Monoid[Boolean] = js.native
  
  @JSImport("fp-ts/es6/Monoid", "monoidProduct")
  @js.native
  val monoidProduct: Monoid[Double] = js.native
  
  @JSImport("fp-ts/es6/Monoid", "monoidString")
  @js.native
  val monoidString: Monoid[String] = js.native
  
  @JSImport("fp-ts/es6/Monoid", "monoidSum")
  @js.native
  val monoidSum: Monoid[Double] = js.native
  
  @JSImport("fp-ts/es6/Monoid", "monoidVoid")
  @js.native
