...
object taskOption {
  ...
  @JSImport("fp-ts/index", "taskOption.compact")
  @js.native
  ...
  @JSImport("fp-ts/index", "taskOption.none")
  @js.native
  ...
  @JSImport("fp-ts/index", "taskOption.separate")
  @js.native
