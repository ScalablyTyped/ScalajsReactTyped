...
object function {
  ...
  @JSImport("fp-ts/index", "function.constFalse")
  @js.native
  val constFalse: Lazy[Boolean] = js.native
  
  @JSImport("fp-ts/index", "function.constNull")
  @js.native
  val constNull: Lazy[Null] = js.native
  
  @JSImport("fp-ts/index", "function.constTrue")
  @js.native
  val constTrue: Lazy[Boolean] = js.native
  
  @JSImport("fp-ts/index", "function.constUndefined")
  @js.native
  val constUndefined: Lazy[Unit] = js.native
  
  @JSImport("fp-ts/index", "function.constVoid")
  @js.native
