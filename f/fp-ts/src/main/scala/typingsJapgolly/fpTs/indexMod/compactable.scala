...
import typingsJapgolly.fpTs.libCompactableMod.CompactableComposition
import typingsJapgolly.fpTs.libCompactableMod.CompactableComposition11
import typingsJapgolly.fpTs.libCompactableMod.CompactableComposition12
import typingsJapgolly.fpTs.libCompactableMod.CompactableComposition21
import typingsJapgolly.fpTs.libCompactableMod.CompactableComposition22
import typingsJapgolly.fpTs.libCompactableMod.CompactableComposition22C
import typingsJapgolly.fpTs.libCompactableMod.CompactableComposition23C
import typingsJapgolly.fpTs.libCompactableMod.CompactableComposition2C1
...
object compactable {
  ...
  @JSImport("fp-ts/index", "compactable")
  @js.native
  ...
  ] = (^.asInstanceOf[js.Dynamic].applyDynamic("compact")(F.asInstanceOf[js.Any], G.asInstanceOf[js.Any])).asInstanceOf[js.Function1[
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Kind<F, Kind<G, Option<A>>> */ /* fa */ Any, 
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Kind<F, Kind<G, A>> */ Any
  ]]
