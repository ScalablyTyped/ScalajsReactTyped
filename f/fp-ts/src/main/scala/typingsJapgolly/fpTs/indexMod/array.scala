...
object array {
  ...
  @JSImport("fp-ts/index", "array.array")
  @js.native
  ...
  @JSImport("fp-ts/index", "array.empty")
  @js.native
  ...
  @JSImport("fp-ts/index", "array.filterE")
  @js.native
  ...
  @JSImport("fp-ts/index", "array.sequence")
  @js.native
  ...
  @JSImport("fp-ts/index", "array.traverse")
  @js.native
  val traverse: PipeableTraverse1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/index", "array.traverseWithIndex")
  @js.native
