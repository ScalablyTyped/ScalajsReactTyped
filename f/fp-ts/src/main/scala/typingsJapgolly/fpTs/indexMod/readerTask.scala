...
object readerTask {
  ...
  @JSImport("fp-ts/index", "readerTask.readerTask")
  @js.native
  val readerTask: MonadTask2[typingsJapgolly.fpTs.libReaderTaskMod.URI] = js.native
  
  @JSImport("fp-ts/index", "readerTask.readerTaskSeq")
  @js.native
