...
object ord {
  ...
  @JSImport("fp-ts/index", "ord")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/index", "ord.Contravariant")
  @js.native
  val Contravariant: Contravariant1[typingsJapgolly.fpTs.libOrdMod.URI] = js.native
  
  @JSImport("fp-ts/index", "ord.URI")
  @js.native
  ...
  @JSImport("fp-ts/index", "ord.trivial")
  @js.native
