...
object readonlyRecord {
  ...
  @JSImport("fp-ts/index", "readonlyRecord.empty")
  @js.native
  ...
  @JSImport("fp-ts/index", "readonlyRecord.readonlyRecord")
  @js.native
  ...
  @JSImport("fp-ts/index", "readonlyRecord.wilt")
  @js.native
  val wilt: PipeableWilt1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = js.native
  
  @JSImport("fp-ts/index", "readonlyRecord.wither")
  @js.native
