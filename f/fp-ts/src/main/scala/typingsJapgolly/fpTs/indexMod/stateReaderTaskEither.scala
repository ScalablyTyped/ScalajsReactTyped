...
object stateReaderTaskEither {
  ...
  @JSImport("fp-ts/index", "stateReaderTaskEither.stateReaderTaskEither")
  @js.native
  ...
  @JSImport("fp-ts/index", "stateReaderTaskEither.stateReaderTaskEitherSeq")
  @js.native
  ...
  @JSImport("fp-ts/index", "stateReaderTaskEither.throwError")
  @js.native
