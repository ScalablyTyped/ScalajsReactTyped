...
object readerEither {
  ...
  @JSImport("fp-ts/index", "readerEither.readerEither")
  @js.native
  ...
  @JSImport("fp-ts/index", "readerEither.throwError")
  @js.native
