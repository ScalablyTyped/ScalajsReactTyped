...
object taskThese {
  ...
  @JSImport("fp-ts/index", "taskThese.functorTaskThese")
  @js.native
  ...
  @JSImport("fp-ts/index", "taskThese.taskThese")
  @js.native
