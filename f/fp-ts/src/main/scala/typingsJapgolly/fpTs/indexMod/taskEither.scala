...
object taskEither {
  ...
  @JSImport("fp-ts/index", "taskEither.taskEither")
  @js.native
  ...
  @JSImport("fp-ts/index", "taskEither.taskEitherSeq")
  @js.native
  ...
  @JSImport("fp-ts/index", "taskEither.throwError")
  @js.native
