...
object identity {
  ...
  @JSImport("fp-ts/index", "identity.identity")
  @js.native
  ...
  @JSImport("fp-ts/index", "identity.sequence")
  @js.native
  val sequence: Sequence1[typingsJapgolly.fpTs.libIdentityMod.URI] = js.native
  
  @JSImport("fp-ts/index", "identity.traverse")
  @js.native
