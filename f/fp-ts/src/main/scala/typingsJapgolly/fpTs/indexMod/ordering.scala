...
object ordering {
  ...
  @JSImport("fp-ts/index", "ordering.monoidOrdering")
  @js.native
  ...
  @JSImport("fp-ts/index", "ordering.semigroupOrdering")
  @js.native
