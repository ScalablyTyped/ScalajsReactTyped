...
object readonlyTuple {
  ...
  @JSImport("fp-ts/index", "readonlyTuple.readonlyTuple")
  @js.native
  ...
  @JSImport("fp-ts/index", "readonlyTuple.sequence")
  @js.native
  ...
  @JSImport("fp-ts/index", "readonlyTuple.traverse")
  @js.native
