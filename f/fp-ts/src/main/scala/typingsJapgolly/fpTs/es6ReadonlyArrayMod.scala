...
import typingsJapgolly.fpTs.anon.FnCallAAs
import typingsJapgolly.fpTs.anon.FnCallXsYs
import typingsJapgolly.fpTs.fpTsStrings.ReadonlyArray
...
import typingsJapgolly.fpTs.libReadonlyArrayMod.Spanned
...
object es6ReadonlyArrayMod {
  
  @JSImport("fp-ts/es6/ReadonlyArray", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Alt")
  @js.native
  val Alt_ : Alt1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Alternative")
  @js.native
  val Alternative: Alternative1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Applicative")
  @js.native
  val Applicative: Applicative1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Apply")
  @js.native
  val Apply: Apply1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "ChainRecBreadthFirst")
  @js.native
  val ChainRecBreadthFirst_ : ChainRec1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "ChainRecDepthFirst")
  @js.native
  val ChainRecDepthFirst_ : ChainRec1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Chain")
  @js.native
  val Chain_ : Chain1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Compactable")
  @js.native
  val Compactable: Compactable1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Do")
  @js.native
  val Do: js.Array[js.Object] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Extend")
  @js.native
  val Extend_ : Extend1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Filterable")
  @js.native
  val Filterable: Filterable1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "FilterableWithIndex")
  @js.native
  val FilterableWithIndex: FilterableWithIndex1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI, Double] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Foldable")
  @js.native
  val Foldable: Foldable1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "FoldableWithIndex")
  @js.native
  val FoldableWithIndex: FoldableWithIndex1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI, Double] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "FromEither")
  @js.native
  val FromEither_ : FromEither1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Functor")
  @js.native
  val Functor: Functor1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "FunctorWithIndex")
  @js.native
  val FunctorWithIndex: FunctorWithIndex1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI, Double] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Monad")
  @js.native
  val Monad: Monad1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Pointed")
  @js.native
  val Pointed: Pointed1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Traversable")
  @js.native
  val Traversable: Traversable1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "TraversableWithIndex")
  @js.native
  val TraversableWithIndex: TraversableWithIndex1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI, Double] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "URI")
  @js.native
  val URI: /* "ReadonlyArray" */ String = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Unfoldable")
  @js.native
  val Unfoldable: Unfoldable1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Witherable")
  @js.native
  val Witherable: Witherable1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "Zero")
  @js.native
  val Zero_ : Zero1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  ...
  @JSImport("fp-ts/es6/ReadonlyArray", "empty")
  @js.native
  ...
  @JSImport("fp-ts/es6/ReadonlyArray", "filterE")
  @js.native
  ...
  @JSImport("fp-ts/es6/ReadonlyArray", "readonlyArray")
  @js.native
  val readonlyArray: (FunctorWithIndex1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI, Double]) & Monad1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] & Unfoldable1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] & Alternative1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] & Extend1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] & (FilterableWithIndex1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI, Double]) & (FoldableWithIndex1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI, Double]) & (TraversableWithIndex1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI, Double]) & Witherable1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  ...
  @JSImport("fp-ts/es6/ReadonlyArray", "sequence")
  @js.native
  val sequence: Sequence1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  ...
  @JSImport("fp-ts/es6/ReadonlyArray", "traverse")
  @js.native
  val traverse: PipeableTraverse1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "traverseWithIndex")
  @js.native
  val traverseWithIndex: PipeableTraverseWithIndex1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI, Double] = js.native
  ...
  @JSImport("fp-ts/es6/ReadonlyArray", "wilt")
  @js.native
  val wilt: PipeableWilt1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/ReadonlyArray", "wither")
  @js.native
  val wither: PipeableWither1[typingsJapgolly.fpTs.libReadonlyArrayMod.URI] = js.native
