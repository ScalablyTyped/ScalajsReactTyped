...
object es6ReaderTaskEitherMod {
  ...
  @JSImport("fp-ts/es6/ReaderTaskEither", "readerTaskEitherSeq")
  @js.native
  ...
  @JSImport("fp-ts/es6/ReaderTaskEither", "throwError")
  @js.native
