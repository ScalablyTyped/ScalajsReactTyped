...
@js.native
trait PipeableFilterableWithIndex3[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */, I]
  extends StObject
     with PipeableFilterable3[F] {
