...
object PipeableContravariant2 {
  ...
  extension [Self <: PipeableContravariant2[?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */](x: Self & PipeableContravariant2[F]) {
