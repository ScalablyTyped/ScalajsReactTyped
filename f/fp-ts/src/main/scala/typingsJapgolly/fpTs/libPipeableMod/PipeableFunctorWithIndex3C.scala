...
object PipeableFunctorWithIndex3C {
  ...
  extension [Self <: PipeableFunctorWithIndex3C[?, ?, ?], F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */, I, E](x: Self & (PipeableFunctorWithIndex3C[F, I, E])) {
