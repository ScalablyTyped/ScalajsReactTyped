...
object libReaderEitherMod {
  ...
  @JSImport("fp-ts/lib/ReaderEither", "readerEither")
  @js.native
  ...
  @JSImport("fp-ts/lib/ReaderEither", "throwError")
  @js.native
  ...
  type ReaderEither_[R, E, A] = Reader_[R, Either_[E, A]]
}
