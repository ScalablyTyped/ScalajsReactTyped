...
import typingsJapgolly.fpTs.libTaskTheseMod.TaskThese_
...
object es6TaskTheseMod {
  ...
  @JSImport("fp-ts/es6/TaskThese", "functorTaskThese")
  @js.native
  ...
  @JSImport("fp-ts/es6/TaskThese", "taskThese")
  @js.native
