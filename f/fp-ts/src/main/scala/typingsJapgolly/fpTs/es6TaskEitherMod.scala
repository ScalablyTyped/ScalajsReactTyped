...
import typingsJapgolly.fpTs.fpTsStrings.TaskEither
...
import typingsJapgolly.fpTs.libTaskEitherMod.TaskEither_
import typingsJapgolly.fpTs.libTaskMod.Task_
import typingsJapgolly.fpTs.libTaskOptionMod.TaskOption
...
object es6TaskEitherMod {
  
  @JSImport("fp-ts/es6/TaskEither", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "Alt")
  @js.native
  val Alt_ : Alt2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "ApT")
  @js.native
  val ApT: TaskEither_[scala.Nothing, js.Array[Any]] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "ApplicativePar")
  @js.native
  val ApplicativePar: Applicative2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "ApplicativeSeq")
  @js.native
  val ApplicativeSeq: Applicative2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "ApplyPar")
  @js.native
  val ApplyPar: Apply2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "ApplySeq")
  @js.native
  val ApplySeq: Apply2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "Bifunctor")
  @js.native
  val Bifunctor: Bifunctor2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "Chain")
  @js.native
  val Chain_ : Chain2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "Do")
  @js.native
  val Do: TaskEither_[scala.Nothing, js.Object] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "FromEither")
  @js.native
  val FromEither_ : FromEither2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "FromIO")
  @js.native
  val FromIO_ : FromIO2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "FromTask")
  @js.native
  val FromTask_ : FromTask2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "Functor")
  @js.native
  val Functor: Functor2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "Monad")
  @js.native
  val Monad: Monad2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "MonadIO")
  @js.native
  val MonadIO: MonadIO2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "MonadTask")
  @js.native
  val MonadTask: MonadTask2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "MonadThrow")
  @js.native
  val MonadThrow: MonadThrow2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "Pointed")
  @js.native
  val Pointed: Pointed2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "URI")
  @js.native
  ...
  inline def filterOrElseW_ABE2[A, B /* <: A */, E2](refinement: Refinement[A, B], onFalse: js.Function1[/* a */ A, E2]): js.Function1[/* ma */ TaskEither_[Any, A], TaskEither_[Any | E2, B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("filterOrElseW")(refinement.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ma */ TaskEither_[Any, A], TaskEither_[Any | E2, B]]]
  
  inline def filterOrElse_EAB[E, A, B /* <: A */](refinement: Refinement[A, B], onFalse: js.Function1[/* a */ A, E]): js.Function1[/* ma */ TaskEither_[E, A], TaskEither_[E, B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("filterOrElse")(refinement.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ma */ TaskEither_[E, A], TaskEither_[E, B]]]
  ...
  inline def fromEither[E, A](fa: Either_[E, A]): TaskEither_[E, A] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromEither")(fa.asInstanceOf[js.Any]).asInstanceOf[TaskEither_[E, A]]
  ...
  inline def fromIO[A, E](fa: IO_[A]): TaskEither_[E, A] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIO")(fa.asInstanceOf[js.Any]).asInstanceOf[TaskEither_[E, A]]
  ...
  inline def fromIOK[A /* <: js.Array[Any] */, B](f: js.Function1[/* a */ A, IO_[B]]): js.Function1[/* a */ A, TaskEither_[scala.Nothing, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIOK")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* a */ A, TaskEither_[scala.Nothing, B]]]
  ...
  inline def fromOption[E](onNone: Lazy[E]): js.Function1[/* fa */ Option_[Any], TaskEither_[E, Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromOption")(onNone.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ Option_[Any], TaskEither_[E, Any]]]
  ...
  inline def fromPredicate[E, A](predicate: Predicate[A], onFalse: js.Function1[/* a */ A, E]): js.Function1[/* b */ A, TaskEither_[E, A]] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPredicate")(predicate.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* b */ A, TaskEither_[E, A]]]
  
  inline def fromPredicate_EAB[E, A, B /* <: A */](refinement: Refinement[A, B], onFalse: js.Function1[/* a */ A, E]): js.Function1[/* a */ A, TaskEither_[E, B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPredicate")(refinement.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* a */ A, TaskEither_[E, B]]]
  
  inline def fromTask[A, E](fa: Task_[A]): TaskEither_[E, A] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromTask")(fa.asInstanceOf[js.Any]).asInstanceOf[TaskEither_[E, A]]
  
  inline def fromTaskK[A /* <: js.Array[Any] */, B](f: js.Function1[/* a */ A, Task_[B]]): js.Function1[/* a */ A, TaskEither_[scala.Nothing, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromTaskK")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* a */ A, TaskEither_[scala.Nothing, B]]]
  
  inline def fromTaskOption[E](onNone: Lazy[E]): js.Function1[/* fa */ TaskOption[Any], TaskEither_[E, Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromTaskOption")(onNone.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ TaskOption[Any], TaskEither_[E, Any]]]
  ...
  inline def getAltTaskValidation[E](S: Semigroup[E]): Alt2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E] = ^.asInstanceOf[js.Dynamic].applyDynamic("getAltTaskValidation")(S.asInstanceOf[js.Any]).asInstanceOf[Alt2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E]]
  
  inline def getApplicativeTaskValidation[E](A: Apply1[typingsJapgolly.fpTs.libTaskMod.URI], S: Semigroup[E]): Applicative2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E] = (^.asInstanceOf[js.Dynamic].applyDynamic("getApplicativeTaskValidation")(A.asInstanceOf[js.Any], S.asInstanceOf[js.Any])).asInstanceOf[Applicative2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E]]
  ...
  inline def getFilterable[E](M: Monoid[E]): Filterable2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFilterable")(M.asInstanceOf[js.Any]).asInstanceOf[Filterable2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E]]
  ...
  inline def getTaskValidation[E](SE: Semigroup[E]): (Monad2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E]) & Bifunctor2[typingsJapgolly.fpTs.libTaskEitherMod.URI] & (Alt2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E]) & (MonadTask2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E]) & (MonadThrow2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E]) = ^.asInstanceOf[js.Dynamic].applyDynamic("getTaskValidation")(SE.asInstanceOf[js.Any]).asInstanceOf[(Monad2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E]) & Bifunctor2[typingsJapgolly.fpTs.libTaskEitherMod.URI] & (Alt2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E]) & (MonadTask2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E]) & (MonadThrow2C[typingsJapgolly.fpTs.libTaskEitherMod.URI, E])]
  ...
  @js.native
  val taskEither: Monad2[typingsJapgolly.fpTs.libTaskEitherMod.URI] & Bifunctor2[typingsJapgolly.fpTs.libTaskEitherMod.URI] & Alt2[typingsJapgolly.fpTs.libTaskEitherMod.URI] & MonadTask2[typingsJapgolly.fpTs.libTaskEitherMod.URI] & MonadThrow2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  
  @JSImport("fp-ts/es6/TaskEither", "taskEitherSeq")
  @js.native
  val taskEitherSeq: Monad2[typingsJapgolly.fpTs.libTaskEitherMod.URI] & Bifunctor2[typingsJapgolly.fpTs.libTaskEitherMod.URI] & Alt2[typingsJapgolly.fpTs.libTaskEitherMod.URI] & MonadTask2[typingsJapgolly.fpTs.libTaskEitherMod.URI] & MonadThrow2[typingsJapgolly.fpTs.libTaskEitherMod.URI] = js.native
  ...
  @JSImport("fp-ts/es6/TaskEither", "throwError")
  @js.native
