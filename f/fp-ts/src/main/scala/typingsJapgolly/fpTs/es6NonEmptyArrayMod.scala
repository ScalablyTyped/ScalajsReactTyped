...
object es6NonEmptyArrayMod {
  ...
  @JSImport("fp-ts/es6/NonEmptyArray", "extract")
  @js.native
  ...
  @JSImport("fp-ts/es6/NonEmptyArray", "nonEmptyArray")
  @js.native
  ...
  @JSImport("fp-ts/es6/NonEmptyArray", "sequence")
  @js.native
  ...
  @JSImport("fp-ts/es6/NonEmptyArray", "traverse")
  @js.native
  val traverse: PipeableTraverse1[typingsJapgolly.fpTs.libNonEmptyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/NonEmptyArray", "traverseWithIndex")
  @js.native
