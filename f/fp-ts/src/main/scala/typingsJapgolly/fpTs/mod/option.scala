...
import typingsJapgolly.fpTs.anon.Fn21
...
import typingsJapgolly.fpTs.libMonadThrowMod.MonadThrow1
...
object option {
  ...
  @js.native
  val Alt_ : Alt1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.Alternative")
  @js.native
  val Alternative: Alternative1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  ...
  @js.native
  val Applicative: Applicative1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.Apply")
  @js.native
  val Apply: Apply1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.Chain")
  @js.native
  val Chain_ : Chain1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.Compactable")
  @js.native
  val Compactable: Compactable1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  ...
  @js.native
  val Extend_ : Extend1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.Filterable")
  @js.native
  val Filterable: Filterable1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.Foldable")
  @js.native
  val Foldable: Foldable1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.FromEither")
  @js.native
  val FromEither_ : FromEither1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.Functor")
  @js.native
  val Functor: Functor1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.Monad")
  @js.native
  val Monad: Monad1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.MonadThrow")
  @js.native
  val MonadThrow: MonadThrow1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.Pointed")
  @js.native
  val Pointed: Pointed1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.Traversable")
  @js.native
  val Traversable: Traversable1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  ...
  @js.native
  val Witherable: Witherable1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.Zero")
  @js.native
  val Zero_ : Zero1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  ...
  @js.native
  val option: Monad1[typingsJapgolly.fpTs.libOptionMod.URI] & Foldable1[typingsJapgolly.fpTs.libOptionMod.URI] & Alternative1[typingsJapgolly.fpTs.libOptionMod.URI] & Extend1[typingsJapgolly.fpTs.libOptionMod.URI] & Witherable1[typingsJapgolly.fpTs.libOptionMod.URI] & MonadThrow1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  ...
  @js.native
  val sequence: Sequence1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  ...
  @js.native
  val traverse: PipeableTraverse1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  ...
  @js.native
  val wilt: PipeableWilt1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts", "option.wither")
  @js.native
  val wither: PipeableWither1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
