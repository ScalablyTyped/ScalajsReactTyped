...
object es6ReaderMod {
  ...
  @JSImport("fp-ts/es6/Reader", "first")
  @js.native
  ...
  @JSImport("fp-ts/es6/Reader", "right")
  @js.native
  ...
  @JSImport("fp-ts/es6/Reader", "second")
  @js.native
