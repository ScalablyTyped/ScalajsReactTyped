...
object record {
  ...
  @JSImport("fp-ts/lib/index", "record.empty")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "record.record")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "record.wilt")
  @js.native
  val wilt: PipeableWilt1[typingsJapgolly.fpTs.libRecordMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "record.wither")
  @js.native
