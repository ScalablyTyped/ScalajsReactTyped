...
import typingsJapgolly.fpTs.anon.Fn2
import typingsJapgolly.fpTs.anon.Fn3
import typingsJapgolly.fpTs.fpTsStrings.Array
...
import typingsJapgolly.fpTs.libArrayMod.Spanned
...
object array {
  ...
  @JSImport("fp-ts/lib/index", "array")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/lib/index", "array.Alt")
  @js.native
  val Alt_ : Alt1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Alternative")
  @js.native
  val Alternative: Alternative1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Applicative")
  @js.native
  val Applicative: Applicative1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Apply")
  @js.native
  val Apply: Apply1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.ChainRecBreadthFirst")
  @js.native
  val ChainRecBreadthFirst_ : ChainRec1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.ChainRecDepthFirst")
  @js.native
  val ChainRecDepthFirst_ : ChainRec1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Chain")
  @js.native
  val Chain_ : Chain1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Compactable")
  @js.native
  val Compactable: Compactable1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Do")
  @js.native
  val Do: js.Array[js.Object] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Extend")
  @js.native
  val Extend_ : Extend1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Filterable")
  @js.native
  val Filterable: Filterable1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.FilterableWithIndex")
  @js.native
  val FilterableWithIndex: FilterableWithIndex1[typingsJapgolly.fpTs.libArrayMod.URI, Double] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Foldable")
  @js.native
  val Foldable: Foldable1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.FoldableWithIndex")
  @js.native
  val FoldableWithIndex: FoldableWithIndex1[typingsJapgolly.fpTs.libArrayMod.URI, Double] = js.native
  
  @JSImport("fp-ts/lib/index", "array.FromEither")
  @js.native
  val FromEither_ : FromEither1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Functor")
  @js.native
  val Functor: Functor1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.FunctorWithIndex")
  @js.native
  val FunctorWithIndex: FunctorWithIndex1[typingsJapgolly.fpTs.libArrayMod.URI, Double] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Monad")
  @js.native
  val Monad: Monad1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Pointed")
  @js.native
  val Pointed: Pointed1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Traversable")
  @js.native
  val Traversable: Traversable1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.TraversableWithIndex")
  @js.native
  val TraversableWithIndex: TraversableWithIndex1[typingsJapgolly.fpTs.libArrayMod.URI, Double] = js.native
  
  @JSImport("fp-ts/lib/index", "array.URI")
  @js.native
  val URI: /* "Array" */ String = js.native
  
  @JSImport("fp-ts/lib/index", "array.Unfoldable")
  @js.native
  val Unfoldable: Unfoldable1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Witherable")
  @js.native
  val Witherable: Witherable1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.Zero")
  @js.native
  val Zero_ : Zero1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  ...
  @JSImport("fp-ts/lib/index", "array.array")
  @js.native
  val array: (FunctorWithIndex1[typingsJapgolly.fpTs.libArrayMod.URI, Double]) & Monad1[typingsJapgolly.fpTs.libArrayMod.URI] & Unfoldable1[typingsJapgolly.fpTs.libArrayMod.URI] & Alternative1[typingsJapgolly.fpTs.libArrayMod.URI] & Extend1[typingsJapgolly.fpTs.libArrayMod.URI] & (FilterableWithIndex1[typingsJapgolly.fpTs.libArrayMod.URI, Double]) & (FoldableWithIndex1[typingsJapgolly.fpTs.libArrayMod.URI, Double]) & (TraversableWithIndex1[typingsJapgolly.fpTs.libArrayMod.URI, Double]) & Witherable1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  ...
  inline def elem[A](E: Eq[A]): Fn3[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("elem")(E.asInstanceOf[js.Any]).asInstanceOf[Fn3[A]]
  
  @JSImport("fp-ts/lib/index", "array.empty")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "array.filterE")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "array.sequence")
  @js.native
  val sequence: Sequence1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  ...
  @JSImport("fp-ts/lib/index", "array.traverse")
  @js.native
  val traverse: PipeableTraverse1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.traverseWithIndex")
  @js.native
  val traverseWithIndex: PipeableTraverseWithIndex1[typingsJapgolly.fpTs.libArrayMod.URI, Double] = js.native
  ...
  @JSImport("fp-ts/lib/index", "array.wilt")
  @js.native
  val wilt: PipeableWilt1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "array.wither")
  @js.native
  val wither: PipeableWither1[typingsJapgolly.fpTs.libArrayMod.URI] = js.native
