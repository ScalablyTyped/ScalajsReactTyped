...
object semigroup {
  ...
  @JSImport("fp-ts/lib/index", "semigroup")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "semigroup.semigroupAll")
  @js.native
  val semigroupAll: Semigroup[Boolean] = js.native
  
  @JSImport("fp-ts/lib/index", "semigroup.semigroupAny")
  @js.native
  val semigroupAny: Semigroup[Boolean] = js.native
  
  @JSImport("fp-ts/lib/index", "semigroup.semigroupProduct")
  @js.native
  val semigroupProduct: Semigroup[Double] = js.native
  
  @JSImport("fp-ts/lib/index", "semigroup.semigroupString")
  @js.native
  val semigroupString: Semigroup[String] = js.native
  
  @JSImport("fp-ts/lib/index", "semigroup.semigroupSum")
  @js.native
  val semigroupSum: Semigroup[Double] = js.native
  
  @JSImport("fp-ts/lib/index", "semigroup.semigroupVoid")
  @js.native
