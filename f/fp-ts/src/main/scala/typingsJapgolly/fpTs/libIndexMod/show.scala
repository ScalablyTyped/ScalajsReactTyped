...
object show {
  ...
  @JSImport("fp-ts/lib/index", "show.showBoolean")
  @js.native
  val showBoolean: Show[Boolean] = js.native
  
  @JSImport("fp-ts/lib/index", "show.showNumber")
  @js.native
  val showNumber: Show[Double] = js.native
  
  @JSImport("fp-ts/lib/index", "show.showString")
  @js.native
