...
object booleanAlgebra {
  ...
  @JSImport("fp-ts/lib/index", "booleanAlgebra")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/lib/index", "booleanAlgebra.booleanAlgebraBoolean")
  @js.native
  val booleanAlgebraBoolean: BooleanAlgebra[Boolean] = js.native
  
  @JSImport("fp-ts/lib/index", "booleanAlgebra.booleanAlgebraVoid")
  @js.native
