...
object readerEither {
  ...
  @JSImport("fp-ts/lib/index", "readerEither.readerEither")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "readerEither.throwError")
  @js.native
