...
import typingsJapgolly.fpTs.fpTsStrings.Writer
...
import typingsJapgolly.fpTs.libWriterMod.Writer_
...
object writer {
  ...
  @JSImport("fp-ts/lib/index", "writer")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/lib/index", "writer.Functor")
  @js.native
  val Functor: Functor2[typingsJapgolly.fpTs.libWriterMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "writer.URI")
  @js.native
  ...
  inline def getChain[W](S: Semigroup[W]): Chain2C[typingsJapgolly.fpTs.libWriterMod.URI, W] = ^.asInstanceOf[js.Dynamic].applyDynamic("getChain")(S.asInstanceOf[js.Any]).asInstanceOf[Chain2C[typingsJapgolly.fpTs.libWriterMod.URI, W]]
  
  inline def getMonad[W](M: Monoid[W]): Monad2C[typingsJapgolly.fpTs.libWriterMod.URI, W] = ^.asInstanceOf[js.Dynamic].applyDynamic("getMonad")(M.asInstanceOf[js.Any]).asInstanceOf[Monad2C[typingsJapgolly.fpTs.libWriterMod.URI, W]]
  ...
  @JSImport("fp-ts/lib/index", "writer.writer")
  @js.native
  val writer: Functor2[typingsJapgolly.fpTs.libWriterMod.URI] = js.native
