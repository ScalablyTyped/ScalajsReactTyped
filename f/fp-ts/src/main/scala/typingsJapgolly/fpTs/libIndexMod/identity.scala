...
object identity {
  ...
  @JSImport("fp-ts/lib/index", "identity.identity")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "identity.sequence")
  @js.native
  val sequence: Sequence1[typingsJapgolly.fpTs.libIdentityMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "identity.traverse")
  @js.native
