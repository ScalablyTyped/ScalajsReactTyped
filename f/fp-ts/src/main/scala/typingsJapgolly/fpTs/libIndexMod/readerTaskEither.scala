...
object readerTaskEither {
  ...
  @JSImport("fp-ts/lib/index", "readerTaskEither.readerTaskEither")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "readerTaskEither.readerTaskEitherSeq")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "readerTaskEither.throwError")
  @js.native
