...
import typingsJapgolly.fpTs.anon.Fn5
import typingsJapgolly.fpTs.anon.FnCallAFa
...
object readonlyRecord {
  
  @JSImport("fp-ts/lib/index", "readonlyRecord")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/lib/index", "readonlyRecord.Compactable")
  @js.native
  val Compactable: Compactable1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "readonlyRecord.Filterable")
  @js.native
  val Filterable: Filterable1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "readonlyRecord.FilterableWithIndex")
  @js.native
  val FilterableWithIndex: FilterableWithIndex1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI, String] = js.native
  
  @JSImport("fp-ts/lib/index", "readonlyRecord.Foldable")
  @js.native
  val Foldable: Foldable1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "readonlyRecord.FoldableWithIndex")
  @js.native
  val FoldableWithIndex: FoldableWithIndex1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI, String] = js.native
  
  @JSImport("fp-ts/lib/index", "readonlyRecord.Functor")
  @js.native
  val Functor: Functor1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "readonlyRecord.FunctorWithIndex")
  @js.native
  val FunctorWithIndex: FunctorWithIndex1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI, String] = js.native
  
  @JSImport("fp-ts/lib/index", "readonlyRecord.Traversable")
  @js.native
  val Traversable: Traversable1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "readonlyRecord.TraversableWithIndex")
  @js.native
  val TraversableWithIndex: TraversableWithIndex1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI, String] = js.native
  
  @JSImport("fp-ts/lib/index", "readonlyRecord.URI")
  @js.native
  val URI: /* "ReadonlyRecord" */ String = js.native
  
  @JSImport("fp-ts/lib/index", "readonlyRecord.Witherable")
  @js.native
  val Witherable: Witherable1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = js.native
  ...
  @JSImport("fp-ts/lib/index", "readonlyRecord.empty")
  @js.native
  ...
  inline def getFoldable(O: Ord_[String]): Foldable1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFoldable")(O.asInstanceOf[js.Any]).asInstanceOf[Foldable1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI]]
  
  inline def getFoldableWithIndex(O: Ord_[String]): FoldableWithIndex1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI, String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFoldableWithIndex")(O.asInstanceOf[js.Any]).asInstanceOf[FoldableWithIndex1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI, String]]
  ...
  inline def getTraversable(O: Ord_[String]): Traversable1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = ^.asInstanceOf[js.Dynamic].applyDynamic("getTraversable")(O.asInstanceOf[js.Any]).asInstanceOf[Traversable1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI]]
  
  inline def getTraversableWithIndex(O: Ord_[String]): TraversableWithIndex1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI, String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getTraversableWithIndex")(O.asInstanceOf[js.Any]).asInstanceOf[TraversableWithIndex1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI, String]]
  ...
  inline def getWitherable(O: Ord_[String]): Witherable1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = ^.asInstanceOf[js.Dynamic].applyDynamic("getWitherable")(O.asInstanceOf[js.Any]).asInstanceOf[Witherable1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI]]
  ...
  inline def isSubrecord[A](E: Eq[A]): Fn5[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("isSubrecord")(E.asInstanceOf[js.Any]).asInstanceOf[Fn5[A]]
  ...
  @JSImport("fp-ts/lib/index", "readonlyRecord.readonlyRecord")
  @js.native
  val readonlyRecord: (FunctorWithIndex1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI, String]) & (FoldableWithIndex1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI, String]) & (FilterableWithIndex1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI, String]) & (TraversableWithIndex1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI, String]) & Witherable1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = js.native
  ...
  @JSImport("fp-ts/lib/index", "readonlyRecord.wilt")
  @js.native
  val wilt: PipeableWilt1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "readonlyRecord.wither")
  @js.native
  val wither: PipeableWither1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = js.native
