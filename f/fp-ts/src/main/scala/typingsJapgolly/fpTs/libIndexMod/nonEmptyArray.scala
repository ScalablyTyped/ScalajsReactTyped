...
object nonEmptyArray {
  ...
  @JSImport("fp-ts/lib/index", "nonEmptyArray.extract")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "nonEmptyArray.nonEmptyArray")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "nonEmptyArray.sequence")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "nonEmptyArray.traverse")
  @js.native
  val traverse: PipeableTraverse1[typingsJapgolly.fpTs.libNonEmptyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "nonEmptyArray.traverseWithIndex")
  @js.native
