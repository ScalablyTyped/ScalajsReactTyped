...
object stateReaderTaskEither {
  ...
  @JSImport("fp-ts/lib/index", "stateReaderTaskEither.stateReaderTaskEither")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "stateReaderTaskEither.stateReaderTaskEitherSeq")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "stateReaderTaskEither.throwError")
  @js.native
