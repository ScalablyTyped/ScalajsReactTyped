...
object store {
  ...
  @JSImport("fp-ts/lib/index", "store")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/lib/index", "store.Comonad")
  @js.native
  val Comonad: Comonad2[typingsJapgolly.fpTs.libStoreMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "store.Functor")
  @js.native
  val Functor: Functor2[typingsJapgolly.fpTs.libStoreMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "store.URI")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "store.store")
  @js.native
