...
object taskThese {
  ...
  @JSImport("fp-ts/lib/index", "taskThese.functorTaskThese")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "taskThese.taskThese")
  @js.native
