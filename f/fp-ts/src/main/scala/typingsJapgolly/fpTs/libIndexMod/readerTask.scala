...
object readerTask {
  ...
  @JSImport("fp-ts/lib/index", "readerTask.readerTask")
  @js.native
  val readerTask: MonadTask2[typingsJapgolly.fpTs.libReaderTaskMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "readerTask.readerTaskSeq")
  @js.native
