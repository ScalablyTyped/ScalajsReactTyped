...
object function {
  ...
  @JSImport("fp-ts/lib/index", "function")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "function.constFalse")
  @js.native
  val constFalse: Lazy[Boolean] = js.native
  
  @JSImport("fp-ts/lib/index", "function.constNull")
  @js.native
  val constNull: Lazy[Null] = js.native
  
  @JSImport("fp-ts/lib/index", "function.constTrue")
  @js.native
  val constTrue: Lazy[Boolean] = js.native
  
  @JSImport("fp-ts/lib/index", "function.constUndefined")
  @js.native
  val constUndefined: Lazy[Unit] = js.native
  
  @JSImport("fp-ts/lib/index", "function.constVoid")
  @js.native
