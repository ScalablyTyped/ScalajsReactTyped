...
object monoid {
  ...
  @JSImport("fp-ts/lib/index", "monoid")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "monoid.monoidAll")
  @js.native
  val monoidAll: Monoid[Boolean] = js.native
  
  @JSImport("fp-ts/lib/index", "monoid.monoidAny")
  @js.native
  val monoidAny: Monoid[Boolean] = js.native
  
  @JSImport("fp-ts/lib/index", "monoid.monoidProduct")
  @js.native
  val monoidProduct: Monoid[Double] = js.native
  
  @JSImport("fp-ts/lib/index", "monoid.monoidString")
  @js.native
  val monoidString: Monoid[String] = js.native
  
  @JSImport("fp-ts/lib/index", "monoid.monoidSum")
  @js.native
  val monoidSum: Monoid[Double] = js.native
  
  @JSImport("fp-ts/lib/index", "monoid.monoidVoid")
  @js.native
