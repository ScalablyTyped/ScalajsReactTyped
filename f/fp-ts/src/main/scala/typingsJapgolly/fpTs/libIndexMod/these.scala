...
object these {
  ...
  @JSImport("fp-ts/lib/index", "these.sequence")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "these.these")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "these.traverse")
  @js.native
