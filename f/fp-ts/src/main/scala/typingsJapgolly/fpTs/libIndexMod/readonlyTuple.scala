...
object readonlyTuple {
  ...
  @JSImport("fp-ts/lib/index", "readonlyTuple.readonlyTuple")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "readonlyTuple.sequence")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "readonlyTuple.traverse")
  @js.native
