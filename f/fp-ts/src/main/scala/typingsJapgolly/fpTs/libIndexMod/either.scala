...
import typingsJapgolly.fpTs.anon.FnCallAMa
import typingsJapgolly.fpTs.fpTsStrings.Either
...
import typingsJapgolly.fpTs.libChainRecMod.ChainRec2
...
import typingsJapgolly.fpTs.libEitherMod.Json
...
object either {
  ...
  @JSImport("fp-ts/lib/index", "either")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/lib/index", "either.Alt")
  @js.native
  val Alt_ : Alt2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.ApT")
  @js.native
  val ApT: Either_[scala.Nothing, js.Array[Any]] = js.native
  
  @JSImport("fp-ts/lib/index", "either.Applicative")
  @js.native
  val Applicative: Applicative2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.Apply")
  @js.native
  val Apply: Apply2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.Bifunctor")
  @js.native
  val Bifunctor: Bifunctor2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.ChainRec")
  @js.native
  val ChainRec: ChainRec2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.Chain")
  @js.native
  val Chain_ : Chain2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.Do")
  @js.native
  val Do: Either_[scala.Nothing, js.Object] = js.native
  
  @JSImport("fp-ts/lib/index", "either.Extend")
  @js.native
  val Extend_ : Extend2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.Foldable")
  @js.native
  val Foldable: Foldable2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.FromEither")
  @js.native
  val FromEither: FromEither2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.Functor")
  @js.native
  val Functor: Functor2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.Monad")
  @js.native
  val Monad: Monad2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.MonadThrow")
  @js.native
  val MonadThrow: MonadThrow2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.Pointed")
  @js.native
  val Pointed: Pointed2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.Traversable")
  @js.native
  val Traversable: Traversable2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "either.URI")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "either.either")
  @js.native
  val either: Monad2[typingsJapgolly.fpTs.libEitherMod.URI] & Foldable2[typingsJapgolly.fpTs.libEitherMod.URI] & Traversable2[typingsJapgolly.fpTs.libEitherMod.URI] & Bifunctor2[typingsJapgolly.fpTs.libEitherMod.URI] & Alt2[typingsJapgolly.fpTs.libEitherMod.URI] & Extend2[typingsJapgolly.fpTs.libEitherMod.URI] & ChainRec2[typingsJapgolly.fpTs.libEitherMod.URI] & MonadThrow2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  ...
  inline def filterOrElse[A_1, E_1](predicate: Predicate[A_1], onFalse: js.Function1[/* a */ A_1, E_1]): js.Function1[/* mb */ Either_[E_1, A_1], Either_[E_1, A_1]] = (^.asInstanceOf[js.Dynamic].applyDynamic("filterOrElse")(predicate.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* mb */ Either_[E_1, A_1], Either_[E_1, A_1]]]
  ...
  inline def filterOrElse_ABE[A, B /* <: A */, E](refinement: Refinement[A, B], onFalse: js.Function1[/* a */ A, E]): js.Function1[/* ma */ Either_[E, A], Either_[E, B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("filterOrElse")(refinement.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ma */ Either_[E, A], Either_[E, B]]]
  
  inline def filterOrElse_A_2E_2[A_2, E_2](predicate: Predicate[A_2], onFalse: js.Function1[/* a */ A_2, E_2]): js.Function1[/* ma */ Either_[E_2, A_2], Either_[E_2, A_2]] = (^.asInstanceOf[js.Dynamic].applyDynamic("filterOrElse")(predicate.asInstanceOf[js.Any], onFalse.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* ma */ Either_[E_2, A_2], Either_[E_2, A_2]]]
  ...
  inline def fromOption[E](onNone: Lazy[E]): js.Function1[/* fa */ Option_[Any], Either_[E, Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromOption")(onNone.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ Option_[Any], Either_[E, Any]]]
  ...
  inline def getValidation[E](SE: Semigroup[E]): (Monad2C[typingsJapgolly.fpTs.libEitherMod.URI, E]) & Foldable2[typingsJapgolly.fpTs.libEitherMod.URI] & Traversable2[typingsJapgolly.fpTs.libEitherMod.URI] & Bifunctor2[typingsJapgolly.fpTs.libEitherMod.URI] & (Alt2C[typingsJapgolly.fpTs.libEitherMod.URI, E]) & Extend2[typingsJapgolly.fpTs.libEitherMod.URI] & (ChainRec2C[typingsJapgolly.fpTs.libEitherMod.URI, E]) & (MonadThrow2C[typingsJapgolly.fpTs.libEitherMod.URI, E]) = ^.asInstanceOf[js.Dynamic].applyDynamic("getValidation")(SE.asInstanceOf[js.Any]).asInstanceOf[(Monad2C[typingsJapgolly.fpTs.libEitherMod.URI, E]) & Foldable2[typingsJapgolly.fpTs.libEitherMod.URI] & Traversable2[typingsJapgolly.fpTs.libEitherMod.URI] & Bifunctor2[typingsJapgolly.fpTs.libEitherMod.URI] & (Alt2C[typingsJapgolly.fpTs.libEitherMod.URI, E]) & Extend2[typingsJapgolly.fpTs.libEitherMod.URI] & (ChainRec2C[typingsJapgolly.fpTs.libEitherMod.URI, E]) & (MonadThrow2C[typingsJapgolly.fpTs.libEitherMod.URI, E])]
  ...
  @JSImport("fp-ts/lib/index", "either.sequence")
  @js.native
  val sequence: Sequence2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
  ...
  @JSImport("fp-ts/lib/index", "either.throwError")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "either.traverse")
  @js.native
  val traverse: PipeableTraverse2[typingsJapgolly.fpTs.libEitherMod.URI] = js.native
