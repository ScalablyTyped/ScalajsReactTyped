...
object option {
  ...
  @JSImport("fp-ts/lib/index", "option.none")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "option.option")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "option.sequence")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "option.throwError")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "option.traverse")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "option.wilt")
  @js.native
  val wilt: PipeableWilt1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "option.wither")
  @js.native
