...
object ioEither {
  ...
  @JSImport("fp-ts/lib/index", "ioEither.ioEither")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "ioEither.throwError")
  @js.native
