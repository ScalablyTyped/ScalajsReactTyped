...
import typingsJapgolly.fpTs.anon.Fn55
import typingsJapgolly.fpTs.anon.Fn56
import typingsJapgolly.fpTs.anon.Fn57
...
object set {
  ...
  inline def difference[A](E: Eq[A]): Fn55[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("difference")(E.asInstanceOf[js.Any]).asInstanceOf[Fn55[A]]
  
  inline def elem[A](E: Eq[A]): Fn56[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("elem")(E.asInstanceOf[js.Any]).asInstanceOf[Fn56[A]]
  
  @JSImport("fp-ts/lib/index", "set.empty")
  @js.native
  ...
  inline def intersection[A](E: Eq[A]): Fn55[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("intersection")(E.asInstanceOf[js.Any]).asInstanceOf[Fn55[A]]
  ...
  inline def subset[A](E: Eq[A]): Fn57[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("subset")(E.asInstanceOf[js.Any]).asInstanceOf[Fn57[A]]
  ...
  inline def union[A](E: Eq[A]): Fn55[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("union")(E.asInstanceOf[js.Any]).asInstanceOf[Fn55[A]]
}
