...
object ord {
  ...
  @JSImport("fp-ts/lib/index", "ord")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/lib/index", "ord.Contravariant")
  @js.native
  val Contravariant: Contravariant1[typingsJapgolly.fpTs.libOrdMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "ord.URI")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "ord.ord")
  @js.native
  val ord: Contravariant1[typingsJapgolly.fpTs.libOrdMod.URI] = js.native
  
  @JSImport("fp-ts/lib/index", "ord.ordBoolean")
  @js.native
  val ordBoolean: Ord_[Boolean] = js.native
  
  @JSImport("fp-ts/lib/index", "ord.ordDate")
  @js.native
  val ordDate: Ord_[js.Date] = js.native
  
  @JSImport("fp-ts/lib/index", "ord.ordNumber")
  @js.native
  val ordNumber: Ord_[Double] = js.native
  
  @JSImport("fp-ts/lib/index", "ord.ordString")
  @js.native
  ...
  @JSImport("fp-ts/lib/index", "ord.trivial")
  @js.native
