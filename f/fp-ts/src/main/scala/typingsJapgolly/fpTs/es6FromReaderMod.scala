...
import typingsJapgolly.fpTs.libFromReaderMod.FromReader
import typingsJapgolly.fpTs.libFromReaderMod.FromReader2
import typingsJapgolly.fpTs.libFromReaderMod.FromReader3
import typingsJapgolly.fpTs.libFromReaderMod.FromReader3C
...
object es6FromReaderMod {
  
  @JSImport("fp-ts/es6/FromReader", JSImport.Namespace)
  @js.native
