...
import typingsJapgolly.fpTs.anon.Fn22
import typingsJapgolly.fpTs.anon.Fn23
import typingsJapgolly.fpTs.anon.Fn24
import typingsJapgolly.fpTs.anon.Fn25
import typingsJapgolly.fpTs.anon.Fn26
...
import typingsJapgolly.fpTs.libOptionTMod.OptionM
import typingsJapgolly.fpTs.libOptionTMod.OptionM1
import typingsJapgolly.fpTs.libOptionTMod.OptionM2
import typingsJapgolly.fpTs.libOptionTMod.OptionM2C
...
object es6OptionTMod {
  
  @JSImport("fp-ts/es6/OptionT", JSImport.Namespace)
  @js.native
  ...
  inline def fromPredicate[F](F: Pointed[F]): Fn26 = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPredicate")(F.asInstanceOf[js.Any]).asInstanceOf[Fn26]
  inline def fromPredicate[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS */ Any */](F: Pointed1[F]): Fn26 = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPredicate")(F.asInstanceOf[js.Any]).asInstanceOf[Fn26]
  inline def fromPredicate[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */](F: Pointed2[F]): Fn25 = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPredicate")(F.asInstanceOf[js.Any]).asInstanceOf[Fn25]
  inline def fromPredicate[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */](F: Pointed3[F]): Fn23 = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPredicate")(F.asInstanceOf[js.Any]).asInstanceOf[Fn23]
  inline def fromPredicate[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS4 */ Any */](F: Pointed4[F]): Fn22 = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPredicate")(F.asInstanceOf[js.Any]).asInstanceOf[Fn22]
  inline def fromPredicate[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS2 */ Any */, E](F: Pointed2C[F, E]): Fn26 = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPredicate")(F.asInstanceOf[js.Any]).asInstanceOf[Fn26]
  inline def fromPredicate[F /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify URIS3 */ Any */, E](F: Pointed3C[F, E]): Fn24 = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPredicate")(F.asInstanceOf[js.Any]).asInstanceOf[Fn24]
