...
object es6StateReaderTaskEitherMod {
  ...
  @JSImport("fp-ts/es6/StateReaderTaskEither", "stateReaderTaskEither")
  @js.native
  ...
  @JSImport("fp-ts/es6/StateReaderTaskEither", "stateReaderTaskEitherSeq")
  @js.native
  ...
  @JSImport("fp-ts/es6/StateReaderTaskEither", "throwError")
  @js.native
