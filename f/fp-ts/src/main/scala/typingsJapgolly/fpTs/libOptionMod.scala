...
import typingsJapgolly.fpTs.fpTsStrings.None
import typingsJapgolly.fpTs.fpTsStrings.Some
...
object libOptionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fpTs.libOptionMod.None_
    - typingsJapgolly.fpTs.libOptionMod.Some_[A]
  */
  trait Option_[A] extends StObject
  object Option_ {
    
    inline def None_(): typingsJapgolly.fpTs.libOptionMod.None_ = {
      val __obj = js.Dynamic.literal(_tag = "None")
      __obj.asInstanceOf[typingsJapgolly.fpTs.libOptionMod.None_]
    }
    
    inline def Some_[A](value: A): typingsJapgolly.fpTs.libOptionMod.Some_[A] = {
      val __obj = js.Dynamic.literal(_tag = "Some", value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.fpTs.libOptionMod.Some_[A]]
    }
  }
