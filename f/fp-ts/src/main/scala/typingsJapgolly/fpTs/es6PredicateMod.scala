...
object es6PredicateMod {
  
  @JSImport("fp-ts/es6/Predicate", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/es6/Predicate", "Contravariant")
  @js.native
  val Contravariant: Contravariant1[typingsJapgolly.fpTs.libPredicateMod.URI] = js.native
  
  @JSImport("fp-ts/es6/Predicate", "URI")
  @js.native
