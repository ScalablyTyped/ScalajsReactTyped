...
object es6IooptionMod {
  ...
  @JSImport("fp-ts/es6/IOOption", "compact")
  @js.native
  ...
  @JSImport("fp-ts/es6/IOOption", "none")
  @js.native
  ...
  @JSImport("fp-ts/es6/IOOption", "separate")
  @js.native
