...
object separated {
  ...
  @JSImport("fp-ts/es6/index", "separated")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/es6/index", "separated.Bifunctor")
  @js.native
  val Bifunctor: Bifunctor2[typingsJapgolly.fpTs.libSeparatedMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "separated.Functor")
  @js.native
  val Functor: Functor2[typingsJapgolly.fpTs.libSeparatedMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "separated.URI")
  @js.native
