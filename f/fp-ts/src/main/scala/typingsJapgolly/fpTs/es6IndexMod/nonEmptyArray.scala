...
object nonEmptyArray {
  ...
  @JSImport("fp-ts/es6/index", "nonEmptyArray.extract")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "nonEmptyArray.nonEmptyArray")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "nonEmptyArray.sequence")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "nonEmptyArray.traverse")
  @js.native
  val traverse: PipeableTraverse1[typingsJapgolly.fpTs.libNonEmptyArrayMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "nonEmptyArray.traverseWithIndex")
  @js.native
