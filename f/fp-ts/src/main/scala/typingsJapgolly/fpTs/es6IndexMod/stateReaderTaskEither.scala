...
object stateReaderTaskEither {
  ...
  @JSImport("fp-ts/es6/index", "stateReaderTaskEither.stateReaderTaskEither")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "stateReaderTaskEither.stateReaderTaskEitherSeq")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "stateReaderTaskEither.throwError")
  @js.native
