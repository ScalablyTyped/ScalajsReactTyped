...
object record {
  ...
  @JSImport("fp-ts/es6/index", "record.empty")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "record.record")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "record.wilt")
  @js.native
  val wilt: PipeableWilt1[typingsJapgolly.fpTs.libRecordMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "record.wither")
  @js.native
