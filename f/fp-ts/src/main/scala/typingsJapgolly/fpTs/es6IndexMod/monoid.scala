...
object monoid {
  ...
  @JSImport("fp-ts/es6/index", "monoid")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "monoid.monoidAll")
  @js.native
  val monoidAll: Monoid[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "monoid.monoidAny")
  @js.native
  val monoidAny: Monoid[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "monoid.monoidProduct")
  @js.native
  val monoidProduct: Monoid[Double] = js.native
  
  @JSImport("fp-ts/es6/index", "monoid.monoidString")
  @js.native
  val monoidString: Monoid[String] = js.native
  
  @JSImport("fp-ts/es6/index", "monoid.monoidSum")
  @js.native
  val monoidSum: Monoid[Double] = js.native
  
  @JSImport("fp-ts/es6/index", "monoid.monoidVoid")
  @js.native
