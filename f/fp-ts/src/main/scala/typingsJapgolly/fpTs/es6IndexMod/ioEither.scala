...
object ioEither {
  ...
  @JSImport("fp-ts/es6/index", "ioEither.ioEither")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "ioEither.throwError")
  @js.native
