...
object taskOption {
  ...
  @JSImport("fp-ts/es6/index", "taskOption")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.Alt")
  @js.native
  val Alt_ : Alt1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.Alternative")
  @js.native
  val Alternative: Alternative1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.ApT")
  @js.native
  val ApT: TaskOption[js.Array[Any]] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.ApplicativePar")
  @js.native
  val ApplicativePar: Applicative1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.ApplicativeSeq")
  @js.native
  val ApplicativeSeq: Applicative1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.ApplyPar")
  @js.native
  val ApplyPar: Apply1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.ApplySeq")
  @js.native
  val ApplySeq: Apply1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.Chain")
  @js.native
  val Chain_ : Chain1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.Compactable")
  @js.native
  val Compactable: Compactable1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.Do")
  @js.native
  val Do: TaskOption[js.Object] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.Filterable")
  @js.native
  val Filterable: Filterable1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.FromEither")
  @js.native
  val FromEither_ : FromEither1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.FromIO")
  @js.native
  val FromIO_ : FromIO1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.FromTask")
  @js.native
  val FromTask_ : FromTask1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.Functor")
  @js.native
  val Functor: Functor1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.Monad")
  @js.native
  val Monad: Monad1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.MonadIO")
  @js.native
  val MonadIO: MonadIO1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.MonadTask")
  @js.native
  val MonadTask: MonadTask1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.Pointed")
  @js.native
  val Pointed: Pointed1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.URI")
  @js.native
  val URI: /* "TaskOption" */ String = js.native
  
  @JSImport("fp-ts/es6/index", "taskOption.Zero")
  @js.native
  val Zero_ : Zero1[typingsJapgolly.fpTs.libTaskOptionMod.URI] = js.native
  ...
  @JSImport("fp-ts/es6/index", "taskOption.compact")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "taskOption.none")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "taskOption.separate")
  @js.native
