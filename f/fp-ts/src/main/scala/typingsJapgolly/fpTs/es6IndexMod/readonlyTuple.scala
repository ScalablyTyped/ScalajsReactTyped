...
object readonlyTuple {
  ...
  @JSImport("fp-ts/es6/index", "readonlyTuple")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/es6/index", "readonlyTuple.Bifunctor")
  @js.native
  val Bifunctor: Bifunctor2[typingsJapgolly.fpTs.libReadonlyTupleMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "readonlyTuple.Comonad")
  @js.native
  val Comonad: Comonad2[typingsJapgolly.fpTs.libReadonlyTupleMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "readonlyTuple.Foldable")
  @js.native
  val Foldable: Foldable2[typingsJapgolly.fpTs.libReadonlyTupleMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "readonlyTuple.Functor")
  @js.native
  val Functor: Functor2[typingsJapgolly.fpTs.libReadonlyTupleMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "readonlyTuple.Semigroupoid")
  @js.native
  val Semigroupoid: Semigroupoid2[typingsJapgolly.fpTs.libReadonlyTupleMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "readonlyTuple.Traversable")
  @js.native
  val Traversable: Traversable2[typingsJapgolly.fpTs.libReadonlyTupleMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "readonlyTuple.URI")
  @js.native
  ...
  inline def getApplicative[M](M: Monoid[M]): Applicative2C[typingsJapgolly.fpTs.libReadonlyTupleMod.URI, M] = ^.asInstanceOf[js.Dynamic].applyDynamic("getApplicative")(M.asInstanceOf[js.Any]).asInstanceOf[Applicative2C[typingsJapgolly.fpTs.libReadonlyTupleMod.URI, M]]
  
  inline def getApply[S](S: Semigroup[S]): Apply2C[typingsJapgolly.fpTs.libReadonlyTupleMod.URI, S] = ^.asInstanceOf[js.Dynamic].applyDynamic("getApply")(S.asInstanceOf[js.Any]).asInstanceOf[Apply2C[typingsJapgolly.fpTs.libReadonlyTupleMod.URI, S]]
  
  inline def getChain[S](S: Semigroup[S]): Chain2C[typingsJapgolly.fpTs.libReadonlyTupleMod.URI, S] = ^.asInstanceOf[js.Dynamic].applyDynamic("getChain")(S.asInstanceOf[js.Any]).asInstanceOf[Chain2C[typingsJapgolly.fpTs.libReadonlyTupleMod.URI, S]]
  
  inline def getChainRec[M](M: Monoid[M]): ChainRec2C[typingsJapgolly.fpTs.libReadonlyTupleMod.URI, M] = ^.asInstanceOf[js.Dynamic].applyDynamic("getChainRec")(M.asInstanceOf[js.Any]).asInstanceOf[ChainRec2C[typingsJapgolly.fpTs.libReadonlyTupleMod.URI, M]]
  
  inline def getMonad[M](M: Monoid[M]): Monad2C[typingsJapgolly.fpTs.libReadonlyTupleMod.URI, M] = ^.asInstanceOf[js.Dynamic].applyDynamic("getMonad")(M.asInstanceOf[js.Any]).asInstanceOf[Monad2C[typingsJapgolly.fpTs.libReadonlyTupleMod.URI, M]]
  ...
  @JSImport("fp-ts/es6/index", "readonlyTuple.readonlyTuple")
  @js.native
  val readonlyTuple: Semigroupoid2[typingsJapgolly.fpTs.libReadonlyTupleMod.URI] & Bifunctor2[typingsJapgolly.fpTs.libReadonlyTupleMod.URI] & Comonad2[typingsJapgolly.fpTs.libReadonlyTupleMod.URI] & Foldable2[typingsJapgolly.fpTs.libReadonlyTupleMod.URI] & Traversable2[typingsJapgolly.fpTs.libReadonlyTupleMod.URI] = js.native
  ...
  @JSImport("fp-ts/es6/index", "readonlyTuple.sequence")
  @js.native
  val sequence: Sequence2[typingsJapgolly.fpTs.libReadonlyTupleMod.URI] = js.native
  ...
  @JSImport("fp-ts/es6/index", "readonlyTuple.traverse")
  @js.native
  val traverse: PipeableTraverse2[typingsJapgolly.fpTs.libReadonlyTupleMod.URI] = js.native
