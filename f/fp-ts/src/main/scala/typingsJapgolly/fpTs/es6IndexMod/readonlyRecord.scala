...
object readonlyRecord {
  ...
  @JSImport("fp-ts/es6/index", "readonlyRecord.empty")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "readonlyRecord.readonlyRecord")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "readonlyRecord.wilt")
  @js.native
  val wilt: PipeableWilt1[typingsJapgolly.fpTs.libReadonlyRecordMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "readonlyRecord.wither")
  @js.native
