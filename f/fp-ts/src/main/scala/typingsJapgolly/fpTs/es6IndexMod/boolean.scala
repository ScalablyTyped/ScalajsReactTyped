...
object boolean {
  ...
  @JSImport("fp-ts/es6/index", "boolean")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/es6/index", "boolean.BooleanAlgebra")
  @js.native
  val BooleanAlgebra: typingsJapgolly.fpTs.libBooleanAlgebraMod.BooleanAlgebra[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "boolean.Eq")
  @js.native
  val Eq: typingsJapgolly.fpTs.libEqMod.Eq[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "boolean.MonoidAll")
  @js.native
  val MonoidAll: Monoid[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "boolean.MonoidAny")
  @js.native
  val MonoidAny: Monoid[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "boolean.Ord")
  @js.native
  val Ord: Ord_[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "boolean.SemigroupAll")
  @js.native
  val SemigroupAll: Semigroup[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "boolean.SemigroupAny")
  @js.native
  val SemigroupAny: Semigroup[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "boolean.Show")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "boolean.isBoolean")
  @js.native
