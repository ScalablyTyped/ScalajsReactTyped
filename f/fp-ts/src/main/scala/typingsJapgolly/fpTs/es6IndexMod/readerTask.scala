...
object readerTask {
  ...
  @JSImport("fp-ts/es6/index", "readerTask.readerTask")
  @js.native
  val readerTask: MonadTask2[typingsJapgolly.fpTs.libReaderTaskMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "readerTask.readerTaskSeq")
  @js.native
