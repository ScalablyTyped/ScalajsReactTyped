...
object eq_ {
  ...
  @JSImport("fp-ts/es6/index", "eq")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/es6/index", "eq.Contravariant")
  @js.native
  val Contravariant: Contravariant1[typingsJapgolly.fpTs.libEqMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "eq.URI")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "eq.eqBoolean")
  @js.native
  val eqBoolean: Eq[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "eq.eqDate")
  @js.native
  val eqDate: Eq[js.Date] = js.native
  
  @JSImport("fp-ts/es6/index", "eq.eqNumber")
  @js.native
  val eqNumber: Eq[Double] = js.native
  
  @JSImport("fp-ts/es6/index", "eq.eqStrict")
  @js.native
  val eqStrict: Eq[Any] = js.native
  
  @JSImport("fp-ts/es6/index", "eq.eqString")
  @js.native
  val eqString: Eq[String] = js.native
  
  @JSImport("fp-ts/es6/index", "eq.eq")
  @js.native
