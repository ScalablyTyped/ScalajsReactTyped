...
object option {
  ...
  @JSImport("fp-ts/es6/index", "option.none")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "option.option")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "option.sequence")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "option.throwError")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "option.traverse")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "option.wilt")
  @js.native
  val wilt: PipeableWilt1[typingsJapgolly.fpTs.libOptionMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "option.wither")
  @js.native
