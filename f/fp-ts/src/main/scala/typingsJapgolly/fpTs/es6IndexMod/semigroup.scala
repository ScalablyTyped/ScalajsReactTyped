...
object semigroup {
  ...
  @JSImport("fp-ts/es6/index", "semigroup")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "semigroup.semigroupAll")
  @js.native
  val semigroupAll: Semigroup[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "semigroup.semigroupAny")
  @js.native
  val semigroupAny: Semigroup[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "semigroup.semigroupProduct")
  @js.native
  val semigroupProduct: Semigroup[Double] = js.native
  
  @JSImport("fp-ts/es6/index", "semigroup.semigroupString")
  @js.native
  val semigroupString: Semigroup[String] = js.native
  
  @JSImport("fp-ts/es6/index", "semigroup.semigroupSum")
  @js.native
  val semigroupSum: Semigroup[Double] = js.native
  
  @JSImport("fp-ts/es6/index", "semigroup.semigroupVoid")
  @js.native
