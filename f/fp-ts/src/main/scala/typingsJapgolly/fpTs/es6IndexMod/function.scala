...
import typingsJapgolly.fpTs.libFunctionMod.Endomorphism
...
object function {
  ...
  @JSImport("fp-ts/es6/index", "function")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "function.constFalse")
  @js.native
  val constFalse: Lazy[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "function.constNull")
  @js.native
  val constNull: Lazy[Null] = js.native
  
  @JSImport("fp-ts/es6/index", "function.constTrue")
  @js.native
  val constTrue: Lazy[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "function.constUndefined")
  @js.native
  val constUndefined: Lazy[Unit] = js.native
  
  @JSImport("fp-ts/es6/index", "function.constVoid")
  @js.native
