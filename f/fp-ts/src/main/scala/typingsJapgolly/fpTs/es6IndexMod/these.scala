...
object these {
  ...
  @JSImport("fp-ts/es6/index", "these.sequence")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "these.these")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "these.traverse")
  @js.native
