...
object store {
  ...
  @JSImport("fp-ts/es6/index", "store")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("fp-ts/es6/index", "store.Comonad")
  @js.native
  val Comonad: Comonad2[typingsJapgolly.fpTs.libStoreMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "store.Functor")
  @js.native
  val Functor: Functor2[typingsJapgolly.fpTs.libStoreMod.URI] = js.native
  
  @JSImport("fp-ts/es6/index", "store.URI")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "store.store")
  @js.native
