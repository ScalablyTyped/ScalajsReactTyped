...
object show {
  ...
  @JSImport("fp-ts/es6/index", "show.showBoolean")
  @js.native
  val showBoolean: Show[Boolean] = js.native
  
  @JSImport("fp-ts/es6/index", "show.showNumber")
  @js.native
  val showNumber: Show[Double] = js.native
  
  @JSImport("fp-ts/es6/index", "show.showString")
  @js.native
