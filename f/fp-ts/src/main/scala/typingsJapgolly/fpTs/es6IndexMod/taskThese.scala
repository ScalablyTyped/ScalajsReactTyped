...
object taskThese {
  ...
  @JSImport("fp-ts/es6/index", "taskThese.functorTaskThese")
  @js.native
  ...
  @JSImport("fp-ts/es6/index", "taskThese.taskThese")
  @js.native
