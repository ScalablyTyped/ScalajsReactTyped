...
import typingsJapgolly.ffmpegConcat.ffmpegConcatStrings.jpg
import typingsJapgolly.ffmpegConcat.ffmpegConcatStrings.png
import typingsJapgolly.ffmpegConcat.ffmpegConcatStrings.raw
...
object mod {
  ...
  object ConcatOptions {
    ...
    extension [Self <: ConcatOptions](x: Self) {
      ...
      inline def setLog(value: /* stdout */ String => Callback): Self = StObject.set(x, "log", js.Any.fromFunction1((t0: /* stdout */ String) => value(t0).runNow()))
