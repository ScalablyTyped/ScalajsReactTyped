package typingsJapgolly.findTestNames

import typingsJapgolly.findTestNames.anon.PendingTestCount
import typingsJapgolly.findTestNames.findTestNamesBooleans.`false`
import typingsJapgolly.findTestNames.findTestNamesBooleans.`true`
import typingsJapgolly.findTestNames.findTestNamesStrings.suite
import typingsJapgolly.findTestNames.findTestNamesStrings.test
...
object mod {
  ...
  object ResultsWithStructure {
    ...
    extension [Self <: ResultsWithStructure](x: Self) {
  ...
  object SuiteDescribe {
    ...
    extension [Self <: SuiteDescribe](x: Self) {
  ...
  object TestDescribe {
    ...
    extension [Self <: TestDescribe](x: Self) {
