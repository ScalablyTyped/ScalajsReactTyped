...
import typingsJapgolly.formatjsEcma402Abstract.anon.Full
...
import typingsJapgolly.formatjsEcma402Abstract.anon.Narrow
import typingsJapgolly.formatjsEcma402Abstract.anon.RecordTABLE2defaultRangeP
...
object libTypesDateTimeMod {
  ...
  object DateTimeFormatLocaleInternalData {
    ...
    extension [Self <: DateTimeFormatLocaleInternalData](x: Self) {
      ...
      inline def setEra(value: Narrow): Self = StObject.set(x, "era", value.asInstanceOf[js.Any])
