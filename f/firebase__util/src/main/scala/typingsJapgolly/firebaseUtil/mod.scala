...
import typingsJapgolly.firebaseUtil.anon.`0`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseUtil.anon.useridstringPartialFirebaAuthtime
    - typingsJapgolly.firebaseUtil.anon.substringPartialFirebaseIAuthtime
  */
  trait EmulatorMockTokenOptions extends StObject
  object EmulatorMockTokenOptions {
    
    inline def substringPartialFirebaseIAuthtime(sub: String & js.UndefOr[String]): typingsJapgolly.firebaseUtil.anon.substringPartialFirebaseIAuthtime = {
      val __obj = js.Dynamic.literal(sub = sub.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseUtil.anon.substringPartialFirebaseIAuthtime]
    }
    
    inline def useridstringPartialFirebaAuthtime(user_id: String & js.UndefOr[String]): typingsJapgolly.firebaseUtil.anon.useridstringPartialFirebaAuthtime = {
      val __obj = js.Dynamic.literal(user_id = user_id.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseUtil.anon.useridstringPartialFirebaAuthtime]
    }
  }
