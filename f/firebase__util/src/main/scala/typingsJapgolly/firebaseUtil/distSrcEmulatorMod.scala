...
import typingsJapgolly.firebaseUtil.anon.SigninproviderFirebaseSignInProvider
...
object distSrcEmulatorMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseUtil.anon.useridstringPartialFirebaAud
    - typingsJapgolly.firebaseUtil.anon.substringPartialFirebaseIAud
  */
  trait EmulatorMockTokenOptions extends StObject
  object EmulatorMockTokenOptions {
    
    inline def substringPartialFirebaseIAud(sub: String & js.UndefOr[String]): typingsJapgolly.firebaseUtil.anon.substringPartialFirebaseIAud = {
      val __obj = js.Dynamic.literal(sub = sub.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseUtil.anon.substringPartialFirebaseIAud]
    }
    
    inline def useridstringPartialFirebaAud(user_id: String & js.UndefOr[String]): typingsJapgolly.firebaseUtil.anon.useridstringPartialFirebaAud = {
      val __obj = js.Dynamic.literal(user_id = user_id.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseUtil.anon.useridstringPartialFirebaAud]
    }
  }
