...
import typingsJapgolly.firebaseUtil.distUtilMod.EmulatorMockTokenOptions
import typingsJapgolly.firebaseUtil.firebaseUtilStrings.anonymous
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined {  user_id :string} & std.Partial<@firebase/util.@firebase/util/dist/util.FirebaseIdToken> */
trait useridstringPartialFirebaEmail
  extends StObject
  ...
  var firebase: js.UndefOr[`1`] = js.undefined
...
object useridstringPartialFirebaEmail {
  
  inline def apply(user_id: String & js.UndefOr[String]): useridstringPartialFirebaEmail = {
    val __obj = js.Dynamic.literal(user_id = user_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[useridstringPartialFirebaEmail]
  }
  
  extension [Self <: useridstringPartialFirebaEmail](x: Self) {
    ...
    inline def setFirebase(value: `1`): Self = StObject.set(x, "firebase", value.asInstanceOf[js.Any])
