...
/* Inlined {  user_id :string} & std.Partial<@firebase/util.@firebase/util.FirebaseIdToken> */
trait useridstringPartialFirebaAuthtime
  extends StObject
  ...
  var firebase: js.UndefOr[IdentitiesSigninproviderFirebaseSignInProvider] = js.undefined
...
object useridstringPartialFirebaAuthtime {
  
  inline def apply(user_id: String & js.UndefOr[String]): useridstringPartialFirebaAuthtime = {
    val __obj = js.Dynamic.literal(user_id = user_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[useridstringPartialFirebaAuthtime]
  }
  
  extension [Self <: useridstringPartialFirebaAuthtime](x: Self) {
    ...
    inline def setFirebase(value: IdentitiesSigninproviderFirebaseSignInProvider): Self = StObject.set(x, "firebase", value.asInstanceOf[js.Any])
