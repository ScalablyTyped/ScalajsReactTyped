...
/* Inlined {  sub :string} & std.Partial<@firebase/util.@firebase/util.FirebaseIdToken> */
trait substringPartialFirebaseIAuthtime
  extends StObject
...
object substringPartialFirebaseIAuthtime {
  
  inline def apply(sub: String & js.UndefOr[String]): substringPartialFirebaseIAuthtime = {
