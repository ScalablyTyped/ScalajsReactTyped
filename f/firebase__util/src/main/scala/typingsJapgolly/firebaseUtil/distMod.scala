...
import typingsJapgolly.firebaseUtil.distSrcCompatMod.Compat
import typingsJapgolly.firebaseUtil.distSrcCryptMod.Base64_
import typingsJapgolly.firebaseUtil.distSrcDefaultsMod.ExperimentalKey
import typingsJapgolly.firebaseUtil.distSrcEmulatorMod.EmulatorMockTokenOptions
import typingsJapgolly.firebaseUtil.distSrcErrorsMod.ErrorMap
import typingsJapgolly.firebaseUtil.distSrcJwtMod.DecodedToken
import typingsJapgolly.firebaseUtil.distSrcSubscribeMod.ErrorFn
import typingsJapgolly.firebaseUtil.distSrcSubscribeMod.Executor
import typingsJapgolly.firebaseUtil.distSrcSubscribeMod.Subscribe
...
object distMod {
  ...
  @JSImport("@firebase/util/dist", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object CONSTANTS {
    
    @JSImport("@firebase/util/dist", "CONSTANTS")
    @js.native
    val ^ : js.Any = js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/util/dist", "CONSTANTS.NODE_ADMIN")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/util/dist", "CONSTANTS.NODE_CLIENT")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/util/dist", "CONSTANTS.SDK_VERSION")
    @js.native
  ...
  open class Deferred[R] ()
    extends typingsJapgolly.firebaseUtil.distSrcDeferredMod.Deferred[R]
  ...
  open class ErrorFactory[ErrorCode /* <: String */, ErrorParams /* <: /* import warning: importer.ImportType#apply Failed type conversion: {readonly [ K in ErrorCode ]:? @firebase/util.@firebase/util/dist/src/errors.ErrorData} */ js.Any */] protected ()
    extends typingsJapgolly.firebaseUtil.distSrcErrorsMod.ErrorFactory[ErrorCode, ErrorParams] {
  ...
  open class FirebaseError protected ()
    extends typingsJapgolly.firebaseUtil.distSrcErrorsMod.FirebaseError {
  ...
  @JSImport("@firebase/util/dist", "MAX_VALUE_MILLIS")
  @js.native
  val MAX_VALUE_MILLIS: Double = js.native
  
  @JSImport("@firebase/util/dist", "RANDOM_FACTOR")
  @js.native
  ...
  @js.native
  open class Sha1 ()
    extends typingsJapgolly.firebaseUtil.distSrcSha1Mod.Sha1
  ...
  @JSImport("@firebase/util/dist", "base64")
  @js.native
