...
import typingsJapgolly.firebaseUtil.distNodeEsmSrcCompatMod.Compat
import typingsJapgolly.firebaseUtil.distNodeEsmSrcCryptMod.Base64_
import typingsJapgolly.firebaseUtil.distNodeEsmSrcDefaultsMod.ExperimentalKey
import typingsJapgolly.firebaseUtil.distNodeEsmSrcEmulatorMod.EmulatorMockTokenOptions
import typingsJapgolly.firebaseUtil.distNodeEsmSrcErrorsMod.ErrorMap
import typingsJapgolly.firebaseUtil.distNodeEsmSrcJwtMod.DecodedToken
import typingsJapgolly.firebaseUtil.distNodeEsmSrcSubscribeMod.ErrorFn
import typingsJapgolly.firebaseUtil.distNodeEsmSrcSubscribeMod.Executor
import typingsJapgolly.firebaseUtil.distNodeEsmSrcSubscribeMod.Subscribe
...
object distNodeEsmIndexDotnodeMod {
  ...
  @JSImport("@firebase/util/dist/node-esm/index.node", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object CONSTANTS {
    
    @JSImport("@firebase/util/dist/node-esm/index.node", "CONSTANTS")
    @js.native
    val ^ : js.Any = js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/util/dist/node-esm/index.node", "CONSTANTS.NODE_ADMIN")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/util/dist/node-esm/index.node", "CONSTANTS.NODE_CLIENT")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/util/dist/node-esm/index.node", "CONSTANTS.SDK_VERSION")
    @js.native
  ...
  open class Deferred[R] ()
    extends typingsJapgolly.firebaseUtil.distNodeEsmSrcDeferredMod.Deferred[R]
  
  @JSImport("@firebase/util/dist/node-esm/index.node", "ErrorFactory")
  @js.native
  open class ErrorFactory[ErrorCode /* <: String */, ErrorParams /* <: /* import warning: importer.ImportType#apply Failed type conversion: {readonly [ K in ErrorCode ]:? @firebase/util.@firebase/util/dist/node-esm/src/errors.ErrorData} */ js.Any */] protected ()
    extends typingsJapgolly.firebaseUtil.distNodeEsmSrcErrorsMod.ErrorFactory[ErrorCode, ErrorParams] {
    def this(service: String, serviceName: String, errors: ErrorMap[ErrorCode]) = this()
  }
  
  @JSImport("@firebase/util/dist/node-esm/index.node", "FirebaseError")
  @js.native
  open class FirebaseError protected ()
    extends typingsJapgolly.firebaseUtil.distNodeEsmSrcErrorsMod.FirebaseError {
  ...
  @JSImport("@firebase/util/dist/node-esm/index.node", "MAX_VALUE_MILLIS")
  @js.native
  val MAX_VALUE_MILLIS: Double = js.native
  
  @JSImport("@firebase/util/dist/node-esm/index.node", "RANDOM_FACTOR")
  @js.native
  val RANDOM_FACTOR: /* 0.5 */ Double = js.native
  
  @JSImport("@firebase/util/dist/node-esm/index.node", "Sha1")
  @js.native
  open class Sha1 ()
    extends typingsJapgolly.firebaseUtil.distNodeEsmSrcSha1Mod.Sha1
  ...
  @JSImport("@firebase/util/dist/node-esm/index.node", "base64")
  @js.native
