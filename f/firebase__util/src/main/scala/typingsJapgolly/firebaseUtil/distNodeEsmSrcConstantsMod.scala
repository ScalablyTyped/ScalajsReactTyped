...
object distNodeEsmSrcConstantsMod {
  ...
  object CONSTANTS {
    ...
    @JSImport("@firebase/util/dist/node-esm/src/constants", "CONSTANTS")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/util/dist/node-esm/src/constants", "CONSTANTS.NODE_ADMIN")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/util/dist/node-esm/src/constants", "CONSTANTS.NODE_CLIENT")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/util/dist/node-esm/src/constants", "CONSTANTS.SDK_VERSION")
    @js.native
