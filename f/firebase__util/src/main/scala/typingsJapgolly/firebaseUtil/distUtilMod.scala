...
import typingsJapgolly.firebaseUtil.anon.`2`
...
object distUtilMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseUtil.anon.useridstringPartialFirebaEmail
    - typingsJapgolly.firebaseUtil.anon.substringPartialFirebaseIEmail
  */
  trait EmulatorMockTokenOptions extends StObject
  object EmulatorMockTokenOptions {
    
    inline def substringPartialFirebaseIEmail(sub: String & js.UndefOr[String]): typingsJapgolly.firebaseUtil.anon.substringPartialFirebaseIEmail = {
      val __obj = js.Dynamic.literal(sub = sub.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseUtil.anon.substringPartialFirebaseIEmail]
    }
    
    inline def useridstringPartialFirebaEmail(user_id: String & js.UndefOr[String]): typingsJapgolly.firebaseUtil.anon.useridstringPartialFirebaEmail = {
      val __obj = js.Dynamic.literal(user_id = user_id.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseUtil.anon.useridstringPartialFirebaEmail]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseUtil.firebaseUtilStrings.authTokenSyncURL
    - typingsJapgolly.firebaseUtil.firebaseUtilStrings.authIdTokenMaxAge
  */
  trait ExperimentalKey extends StObject
  object ExperimentalKey {
    
    inline def authIdTokenMaxAge: typingsJapgolly.firebaseUtil.firebaseUtilStrings.authIdTokenMaxAge = "authIdTokenMaxAge".asInstanceOf[typingsJapgolly.firebaseUtil.firebaseUtilStrings.authIdTokenMaxAge]
    
    inline def authTokenSyncURL: typingsJapgolly.firebaseUtil.firebaseUtilStrings.authTokenSyncURL = "authTokenSyncURL".asInstanceOf[typingsJapgolly.firebaseUtil.firebaseUtilStrings.authTokenSyncURL]
  }
  ...
  */
  ...
  object Observer {
    ...
    inline def apply[T](complete: Callback, error: /* error */ js.Error => Callback, next: T => Callback): Observer[T] = {
      val __obj = js.Dynamic.literal(complete = complete.toJsFn, error = js.Any.fromFunction1((t0: /* error */ js.Error) => error(t0).runNow()), next = js.Any.fromFunction1((t0: T) => next(t0).runNow()))
