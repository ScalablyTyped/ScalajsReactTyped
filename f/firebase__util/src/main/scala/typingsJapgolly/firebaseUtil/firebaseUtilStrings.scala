...
import typingsJapgolly.firebaseUtil.mod.ExperimentalKey
...
object firebaseUtilStrings {
  ...
  sealed trait anonymous
    extends StObject
       ...
       with typingsJapgolly.firebaseUtil.distUtilMod.FirebaseSignInProvider
       with typingsJapgolly.firebaseUtil.distNodeEsmSrcEmulatorMod.FirebaseSignInProvider
       with typingsJapgolly.firebaseUtil.distSrcEmulatorMod.FirebaseSignInProvider
  ...
  sealed trait authIdTokenMaxAge
    extends StObject
       ...
       with typingsJapgolly.firebaseUtil.distUtilMod.ExperimentalKey
       with typingsJapgolly.firebaseUtil.distSrcDefaultsMod.ExperimentalKey
       with typingsJapgolly.firebaseUtil.distNodeEsmSrcDefaultsMod.ExperimentalKey
