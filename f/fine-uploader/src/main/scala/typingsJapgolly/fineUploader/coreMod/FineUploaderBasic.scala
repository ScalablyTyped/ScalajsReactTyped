...
class FineUploaderBasic () extends js.Object {
  ...
  def setDeleteFileEndpoint(path: String, identifier: typingsJapgolly.std.HTMLElement): Unit = js.native
  /**
  ...
  def setEndpoint(path: String, identifier: typingsJapgolly.std.HTMLElement): Unit = js.native
