...
object mod {
  ...
  open class CsvFormatterStream[I /* <: Row */, O /* <: Row */] protected ()
    extends typingsJapgolly.fastCsvFormat.buildSrcCsvFormatterStreamMod.CsvFormatterStream[I, O] {
  ...
  open class FormatterOptions[I /* <: Row */, O /* <: Row */] ()
    extends typingsJapgolly.fastCsvFormat.buildSrcFormatterOptionsMod.FormatterOptions[I, O] {
