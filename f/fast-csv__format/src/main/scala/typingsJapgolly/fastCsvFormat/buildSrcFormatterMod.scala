...
object buildSrcFormatterMod {
  
  @JSImport("@fast-csv/format/build/src/formatter", "FieldFormatter")
  @js.native
  open class FieldFormatter[I /* <: Row */, O /* <: Row */] protected ()
    extends typingsJapgolly.fastCsvFormat.buildSrcFormatterFieldFormatterMod.FieldFormatter[I, O] {
  ...
  open class RowFormatter[I /* <: Row */, O /* <: Row */] protected ()
    extends typingsJapgolly.fastCsvFormat.buildSrcFormatterRowFormatterMod.RowFormatter[I, O] {
    def this(formatterOptions: FormatterOptions[I, O]) = this()
  }
  /* static members */
  object RowFormatter {
