...
import typingsJapgolly.fbjs.libUnicodeBidiDirectionMod.BidiDirection
import typingsJapgolly.fbjs.libUnicodeBidiDirectionMod.HTMLDir
...
object fbjsStrings {
  ...
  sealed trait LTR
    extends StObject
       with BidiDirection
       with typingsJapgolly.fbjs.libUnicodeBidiServiceMod.BidiDirection
