package typingsJapgolly.ffprobe

import typingsJapgolly.ffprobe.anon.Attachedpic
import typingsJapgolly.ffprobe.anon.Dicttag
import typingsJapgolly.ffprobe.ffprobeStrings.audio
import typingsJapgolly.ffprobe.ffprobeStrings.images
import typingsJapgolly.ffprobe.ffprobeStrings.video
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ffprobe.ffprobeStrings.`0`
    - typingsJapgolly.ffprobe.ffprobeStrings.`1`
  */
  trait FFProbeBoolean extends StObject
  object FFProbeBoolean {
    
    inline def `0`: typingsJapgolly.ffprobe.ffprobeStrings.`0` = "0".asInstanceOf[typingsJapgolly.ffprobe.ffprobeStrings.`0`]
    
    inline def `1`: typingsJapgolly.ffprobe.ffprobeStrings.`1` = "1".asInstanceOf[typingsJapgolly.ffprobe.ffprobeStrings.`1`]
  }
