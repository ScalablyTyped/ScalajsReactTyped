package typingsJapgolly.fluentuiReactFocus.components
...
import typingsJapgolly.fluentuiReactFocus.libComponentsFocusZoneFocusZoneDottypesMod.FocusZoneDirection
...
object FocusZone {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.fluentuiReactFocus.mod.FocusZone] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def allowFocusRoot(value: Boolean): this.type = set("allowFocusRoot", value.asInstanceOf[js.Any])
    
    inline def allowTabKey(value: Boolean): this.type = set("allowTabKey", value.asInstanceOf[js.Any])
    ...
    inline def checkForNoWrap(value: Boolean): this.type = set("checkForNoWrap", value.asInstanceOf[js.Any])
    
    inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def componentRef(value: IRefObject[IFocusZone]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IFocusZone | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IFocusZone | Null) => value(t0).runNow()))
    ...
    inline def defaultActiveElement(value: String): this.type = set("defaultActiveElement", value.asInstanceOf[js.Any])
    
    inline def defaultChecked(value: Boolean): this.type = set("defaultChecked", value.asInstanceOf[js.Any])
    
    inline def defaultTabbableElement(value: String | (js.Function1[/* root */ HTMLElement, HTMLElement])): this.type = set("defaultTabbableElement", value.asInstanceOf[js.Any])
    
    inline def defaultTabbableElementFunction1(value: /* root */ HTMLElement => HTMLElement): this.type = set("defaultTabbableElement", js.Any.fromFunction1(value))
    ...
    inline def direction(value: FocusZoneDirection): this.type = set("direction", value.asInstanceOf[js.Any])
    
    inline def disabled(value: Boolean): this.type = set("disabled", value.asInstanceOf[js.Any])
    
    inline def doNotAllowFocusEventToPropagate(value: Boolean): this.type = set("doNotAllowFocusEventToPropagate", value.asInstanceOf[js.Any])
    ...
    inline def elementType(value: Any): this.type = set("elementType", value.asInstanceOf[js.Any])
    
    inline def handleTabKey(value: FocusZoneTabbableElements): this.type = set("handleTabKey", value.asInstanceOf[js.Any])
    ...
    inline def isCircularNavigation(value: Boolean): this.type = set("isCircularNavigation", value.asInstanceOf[js.Any])
    
    inline def isInnerZoneKeystroke(value: /* ev */ ReactKeyboardEventFrom[HTMLElement] => Boolean): this.type = set("isInnerZoneKeystroke", js.Any.fromFunction1(value))
    ...
    inline def onActiveElementChanged(
      value: (/* element */ js.UndefOr[HTMLElement], /* ev */ js.UndefOr[ReactFocusEventFrom[HTMLElement]]) => Callback
    ): this.type = set("onActiveElementChanged", js.Any.fromFunction2((t0: /* element */ js.UndefOr[HTMLElement], t1: /* ev */ js.UndefOr[ReactFocusEventFrom[HTMLElement]]) => (value(t0, t1)).runNow()))
    ...
    inline def onBeforeFocus(value: /* childElement */ js.UndefOr[HTMLElement] => Boolean): this.type = set("onBeforeFocus", js.Any.fromFunction1(value))
    ...
    inline def onFocusNotification(value: Callback): this.type = set("onFocusNotification", value.toJsFn)
    ...
    inline def pagingSupportDisabled(value: Boolean): this.type = set("pagingSupportDisabled", value.asInstanceOf[js.Any])
    
    inline def placeholder(value: String): this.type = set("placeholder", value.asInstanceOf[js.Any])
    
    inline def prefix(value: String): this.type = set("prefix", value.asInstanceOf[js.Any])
    
    inline def preventDefaultWhenHandled(value: Boolean): this.type = set("preventDefaultWhenHandled", value.asInstanceOf[js.Any])
    
    inline def preventFocusRestoration(value: Boolean): this.type = set("preventFocusRestoration", value.asInstanceOf[js.Any])
    ...
    inline def rootProps(value: HTMLAttributes[HTMLDivElement]): this.type = set("rootProps", value.asInstanceOf[js.Any])
    
    inline def security(value: String): this.type = set("security", value.asInstanceOf[js.Any])
    
    inline def shouldEnterInnerZone(value: /* ev */ ReactKeyboardEventFrom[HTMLElement] => Boolean): this.type = set("shouldEnterInnerZone", js.Any.fromFunction1(value))
    
    inline def shouldFocusInnerElementWhenReceivedFocus(value: Boolean): this.type = set("shouldFocusInnerElementWhenReceivedFocus", value.asInstanceOf[js.Any])
    
    inline def shouldFocusOnMount(value: Boolean): this.type = set("shouldFocusOnMount", value.asInstanceOf[js.Any])
    
    inline def shouldInputLoseFocusOnArrowKey(value: /* inputElement */ HTMLInputElement | HTMLTextAreaElement => Boolean): this.type = set("shouldInputLoseFocusOnArrowKey", js.Any.fromFunction1(value))
    
    inline def shouldRaiseClicks(value: Boolean): this.type = set("shouldRaiseClicks", value.asInstanceOf[js.Any])
    
    inline def shouldRaiseClicksOnEnter(value: Boolean): this.type = set("shouldRaiseClicksOnEnter", value.asInstanceOf[js.Any])
    
    inline def shouldRaiseClicksOnSpace(value: Boolean): this.type = set("shouldRaiseClicksOnSpace", value.asInstanceOf[js.Any])
    
    inline def shouldReceiveFocus(value: /* childElement */ js.UndefOr[HTMLElement] => Boolean): this.type = set("shouldReceiveFocus", js.Any.fromFunction1(value))
    
    inline def shouldResetActiveElementWhenTabFromZone(value: Boolean): this.type = set("shouldResetActiveElementWhenTabFromZone", value.asInstanceOf[js.Any])
    
    inline def slot(value: String): this.type = set("slot", value.asInstanceOf[js.Any])
    
    inline def spellCheck(value: Booleanish): this.type = set("spellCheck", value.asInstanceOf[js.Any])
    
    inline def stopFocusPropagation(value: Boolean): this.type = set("stopFocusPropagation", value.asInstanceOf[js.Any])
