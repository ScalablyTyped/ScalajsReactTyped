...
object moduleCoreMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fastJsonPatch.moduleCoreMod.AddOperation[scala.Any]
    - typingsJapgolly.fastJsonPatch.moduleCoreMod.RemoveOperation
    - typingsJapgolly.fastJsonPatch.moduleCoreMod.ReplaceOperation[scala.Any]
    - typingsJapgolly.fastJsonPatch.moduleCoreMod.MoveOperation
    - typingsJapgolly.fastJsonPatch.moduleCoreMod.CopyOperation
    - typingsJapgolly.fastJsonPatch.moduleCoreMod.TestOperation[scala.Any]
    - typingsJapgolly.fastJsonPatch.moduleCoreMod.GetOperation[scala.Any]
  */
  ...
  object _Operation {
    ...
    inline def CopyOperation(from: String, path: String): typingsJapgolly.fastJsonPatch.moduleCoreMod.CopyOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = "copy", path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.fastJsonPatch.moduleCoreMod.CopyOperation]
    }
    
    inline def MoveOperation(from: String, path: String): typingsJapgolly.fastJsonPatch.moduleCoreMod.MoveOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = "move", path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.fastJsonPatch.moduleCoreMod.MoveOperation]
    }
    
    inline def RemoveOperation(path: String): typingsJapgolly.fastJsonPatch.moduleCoreMod.RemoveOperation = {
      val __obj = js.Dynamic.literal(op = "remove", path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.fastJsonPatch.moduleCoreMod.RemoveOperation]
    }
  }
}
