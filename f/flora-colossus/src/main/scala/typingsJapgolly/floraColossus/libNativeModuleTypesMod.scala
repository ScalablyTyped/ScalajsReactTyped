...
object libNativeModuleTypesMod {
  ...
  object NativeModuleType extends StObject {
    ...
    /* 1 */ val NODE_GYP: typingsJapgolly.floraColossus.libNativeModuleTypesMod.NativeModuleType.NODE_GYP & Double = js.native
    
    @js.native
    sealed trait NONE
      extends StObject
         with NativeModuleType
    /* 0 */ val NONE: typingsJapgolly.floraColossus.libNativeModuleTypesMod.NativeModuleType.NONE & Double = js.native
    
    @js.native
    sealed trait PREBUILD
      extends StObject
         with NativeModuleType
    /* 2 */ val PREBUILD: typingsJapgolly.floraColossus.libNativeModuleTypesMod.NativeModuleType.PREBUILD & Double = js.native
  }
}
