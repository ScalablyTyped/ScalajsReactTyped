...
import typingsJapgolly.firebaseAppCompat.anon.UseAsService
...
object distSrcTypesMod {
  ...
  trait FirebaseApp
    extends StObject
       with typingsJapgolly.firebaseAppCompat.distSrcFirebaseAppMod.FirebaseApp {
  ...
  trait FirebaseNamespace
    extends StObject
       with typingsJapgolly.firebaseAppCompat.distSrcPublicTypesMod.FirebaseNamespace {
  ...
  trait FirebaseService
    ...
    var app: typingsJapgolly.firebaseAppCompat.distSrcPublicTypesMod.FirebaseApp
  }
  object FirebaseService {
    
    inline def apply(_delegate: Any, app: typingsJapgolly.firebaseAppCompat.distSrcPublicTypesMod.FirebaseApp): FirebaseService = {
    ...
    extension [Self <: FirebaseService](x: Self) {
      ...
      inline def setApp(value: typingsJapgolly.firebaseAppCompat.distSrcPublicTypesMod.FirebaseApp): Self = StObject.set(x, "app", value.asInstanceOf[js.Any])
  ...
  type FirebaseServiceNamespace[T /* <: FirebaseService */] = js.Function1[
    /* app */ js.UndefOr[typingsJapgolly.firebaseAppCompat.distSrcPublicTypesMod.FirebaseApp], 
    T
  ]
}
