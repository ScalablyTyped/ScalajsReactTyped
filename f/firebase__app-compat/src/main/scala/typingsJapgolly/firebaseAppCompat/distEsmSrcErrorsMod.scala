...
import typingsJapgolly.firebaseAppCompat.anon.AppName
import typingsJapgolly.firebaseAppCompat.firebaseAppCompatStrings.`invalid-app-argument`
import typingsJapgolly.firebaseAppCompat.firebaseAppCompatStrings.`no-app`
...
object distEsmSrcErrorsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAppCompat.firebaseAppCompatStrings.`no-app`
    - typingsJapgolly.firebaseAppCompat.firebaseAppCompatStrings.`invalid-app-argument`
  */
