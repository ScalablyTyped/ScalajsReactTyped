...
import typingsJapgolly.firebaseAppCompat.distEsmSrcPublicTypesMod.FirebaseOptions
import typingsJapgolly.firebaseAppCompat.distEsmSrcTypesMod.FirebaseNamespace
import typingsJapgolly.firebaseAppCompat.distEsmSrcTypesMod.FirebaseService
...
object distEsmSrcFirebaseAppMod {
  ...
  object FirebaseApp {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(automaticDataCollectionEnabled = automaticDataCollectionEnabled.asInstanceOf[js.Any], delete = delete.toJsFn, name = name.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any])
