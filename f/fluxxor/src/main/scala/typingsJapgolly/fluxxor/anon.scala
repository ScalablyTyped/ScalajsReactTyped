...
import typingsJapgolly.fluxxor.fluxxorStrings.input
...
object anon {
  ...
  trait TypeofReact extends StObject {
    ...
    def createElement[P /* <: HTMLAttributes[T] */, T /* <: HTMLElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 116, starting with typingsJapgolly.fluxxor.fluxxorStrings.a, typingsJapgolly.fluxxor.fluxxorStrings.abbr, typingsJapgolly.fluxxor.fluxxorStrings.address */ Any,
    ...
    def createElement_PT_ReactSVGElement[P /* <: SVGAttributes[T] */, T /* <: SVGElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 55, starting with typingsJapgolly.fluxxor.fluxxorStrings.animate, typingsJapgolly.fluxxor.fluxxorStrings.circle, typingsJapgolly.fluxxor.fluxxorStrings.clipPath */ Any,
      props: ClassAttributes[T] & P,
      children: Node*
