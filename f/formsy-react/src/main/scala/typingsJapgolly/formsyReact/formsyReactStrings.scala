...
object formsyReactStrings {
  ...
  @js.native
  sealed trait errorMessages extends StObject
  inline def errorMessages: errorMessages = "errorMessages".asInstanceOf[errorMessages]
  ...
  @js.native
  sealed trait isFormDisabled extends StObject
  inline def isFormDisabled: isFormDisabled = "isFormDisabled".asInstanceOf[isFormDisabled]
  
  @js.native
  sealed trait isFormSubmitted extends StObject
  inline def isFormSubmitted: isFormSubmitted = "isFormSubmitted".asInstanceOf[isFormSubmitted]
  
  @js.native
  sealed trait isPristine extends StObject
  inline def isPristine: isPristine = "isPristine".asInstanceOf[isPristine]
  
  @js.native
  sealed trait isRequired extends StObject
  inline def isRequired: isRequired = "isRequired".asInstanceOf[isRequired]
  ...
  @js.native
  sealed trait isValidValue extends StObject
  inline def isValidValue: isValidValue = "isValidValue".asInstanceOf[isValidValue]
  ...
  @js.native
  sealed trait resetValue extends StObject
  inline def resetValue: resetValue = "resetValue".asInstanceOf[resetValue]
  ...
  @js.native
  sealed trait setValidations extends StObject
  inline def setValidations: setValidations = "setValidations".asInstanceOf[setValidations]
  ...
  @js.native
  sealed trait showError extends StObject
  inline def showError: showError = "showError".asInstanceOf[showError]
