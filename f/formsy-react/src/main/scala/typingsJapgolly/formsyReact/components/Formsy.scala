...
object Formsy {
  ...
  inline def apply(
    ...
    onValid: Callback
  ): SharedBuilder_FormsyProps1979329973[typingsJapgolly.formsyReact.distFormsyMod.Formsy] = {
    ...
    new SharedBuilder_FormsyProps1979329973[typingsJapgolly.formsyReact.distFormsyMod.Formsy](js.Array(this.component, __props.asInstanceOf[FormsyProps]))
  }
  ...
  def withProps(p: FormsyProps): SharedBuilder_FormsyProps1979329973[typingsJapgolly.formsyReact.distFormsyMod.Formsy] = new SharedBuilder_FormsyProps1979329973[typingsJapgolly.formsyReact.distFormsyMod.Formsy](js.Array(this.component, p.asInstanceOf[js.Any]))
}
