...
import typingsJapgolly.formsyReact.distFormsyMod.FormElementType
...
@scala.inline
open class SharedBuilder_FormsyProps1979329973[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def formElement(value: FormElementType): this.type = set("formElement", value.asInstanceOf[js.Any])
  ...
  inline def mapping(value: /* model */ IModel => IModel): this.type = set("mapping", js.Any.fromFunction1(value))
  
  inline def mappingNull: this.type = set("mapping", null)
  ...
  ): this.type = set("onSubmit", js.Any.fromFunction4((t0: /* model */ IModel, t1: /* resetModel */ IResetModel, t2: /* updateInputsWithError */ IUpdateInputsWithError, t3: /* event */ ReactEventFrom[FormHTMLAttributes[Any] & Element]) => (value(t0, t1, t2, t3)).runNow()))
  ...
  inline def onValidSubmit(
    value: (/* model */ IModel, /* resetModel */ IResetModel, /* updateInputsWithError */ IUpdateInputsWithError, /* event */ ReactEventFrom[FormHTMLAttributes[Any] & Element]) => Callback
  ): this.type = set("onValidSubmit", js.Any.fromFunction4((t0: /* model */ IModel, t1: /* resetModel */ IResetModel, t2: /* updateInputsWithError */ IUpdateInputsWithError, t3: /* event */ ReactEventFrom[FormHTMLAttributes[Any] & Element]) => (value(t0, t1, t2, t3)).runNow()))
  ...
  inline def preventDefaultSubmit(value: Boolean): this.type = set("preventDefaultSubmit", value.asInstanceOf[js.Any])
  
  inline def preventExternalInvalidation(value: Boolean): this.type = set("preventExternalInvalidation", value.asInstanceOf[js.Any])
  ...
  inline def validationErrors(value: js.Object): this.type = set("validationErrors", value.asInstanceOf[js.Any])
  
  inline def validationErrorsNull: this.type = set("validationErrors", null)
