...
object anon {
  ...
  object RemoveEventListener {
    ...
    inline def apply(removeEventListener: (String, js.Function, Boolean) => Callback): RemoveEventListener = {
      val __obj = js.Dynamic.literal(removeEventListener = js.Any.fromFunction3((t0: String, t1: js.Function, t2: Boolean) => (removeEventListener(t0, t1, t2)).runNow()))
      __obj.asInstanceOf[RemoveEventListener]
    }
    
    extension [Self <: RemoveEventListener](x: Self) {
      
      inline def setRemoveEventListener(value: (String, js.Function, Boolean) => Callback): Self = StObject.set(x, "removeEventListener", js.Any.fromFunction3((t0: String, t1: js.Function, t2: Boolean) => (value(t0, t1, t2)).runNow()))
    }
  }
