...
import typingsJapgolly.freedom.anon.Stream
...
object RTCPeerConnection {
  ...
  trait RTCPeerConnection extends StObject {
    ...
    @JSName("on")
    def on_ondatachannel(t: ondatachannel, f: js.Function1[/* d */ typingsJapgolly.freedom.anon.Channel, Unit]): Unit = js.native
    @JSName("on")
