...
object Console {
  ...
  object Console {
    ...
    inline def apply(
    ...
    ): typingsJapgolly.freedom.freedom.Console.Console = {
      ...
      __obj.asInstanceOf[typingsJapgolly.freedom.freedom.Console.Console]
    }
    
    extension [Self <: typingsJapgolly.freedom.freedom.Console.Console](x: Self) {
