...
import typingsJapgolly.fontCarrier.anon.Partialpathstringwidthnum
...
object classGlyphMod {
  ...
  @js.native
  trait Glyph
    extends typingsJapgolly.fontCarrier.classBaseMod.^[GlyphOptions] {
    
    /**
      * 获取当前字形对应的字体对象
      */
    def getFont(): typingsJapgolly.fontCarrier.classFontMod.^ = js.native
    
    /**
      * 设置当前 glyph 的字体，会按照新的字体做一系列的变换
      * @param font
      */
    def setFont(font: typingsJapgolly.fontCarrier.classFontMod.^): Unit = js.native
