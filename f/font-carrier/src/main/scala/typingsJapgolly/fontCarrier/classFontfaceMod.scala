...
object classFontfaceMod {
  
  /** fontface 对象包含了字体的一些特殊相关信息 */
  @JSImport("font-carrier/class/fontface", JSImport.Namespace)
  @js.native
  open class ^ ()
    extends typingsJapgolly.fontCarrier.classBaseMod.^[FontFaceOptions]
  
  /** fontface 对象包含了字体的一些特殊相关信息 */
  type FontFace = typingsJapgolly.fontCarrier.classBaseMod.^[FontFaceOptions]
