package typingsJapgolly.fsExtraPromise
...
import typingsJapgolly.fsExtra.mod.CopyOptionsSync
...
import typingsJapgolly.fsExtra.mod.WritevResult
...
object mod {
  ...
  @js.native
  open class Dir ()
    extends typingsJapgolly.fsExtra.mod.Dir
  
  @JSImport("fs-extra-promise", "Dirent")
  @js.native
  open class Dirent ()
    extends typingsJapgolly.fsExtra.mod.Dirent
  
  @JSImport("fs-extra-promise", "ReadStream")
  @js.native
  open class ReadStream ()
    extends typingsJapgolly.fsExtra.mod.ReadStream {
  ...
  @js.native
  open class Stats ()
    extends typingsJapgolly.fsExtra.mod.Stats
  
  @JSImport("fs-extra-promise", "WriteStream")
  @js.native
  open class WriteStream ()
    extends typingsJapgolly.fsExtra.mod.WriteStream {
  ...
  inline def appendFileAsync(filename: String, data: Any): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("appendFileAsync")(filename.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def appendFileAsync(filename: String, data: Any, option: String): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("appendFileAsync")(filename.asInstanceOf[js.Any], data.asInstanceOf[js.Any], option.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def appendFileAsync(filename: String, data: Any, option: WriteOptions): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("appendFileAsync")(filename.asInstanceOf[js.Any], data.asInstanceOf[js.Any], option.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def chmod(
    path: PathLike,
    mode: Mode | typingsJapgolly.fsExtra.mod.Mode,
    callback: (js.Function1[/* err */ ErrnoException, Unit]) | NoParamCallback
  ...
  inline def chmod(path: PathLike, mode: typingsJapgolly.fsExtra.mod.Mode): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("chmod")(path.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  
  inline def chmodAsync(path: String, mode: String): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("chmodAsync")(path.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def chmodAsync(path: String, mode: Double): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("chmodAsync")(path.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def chownAsync(path: String, uid: Double, gid: Double): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("chownAsync")(path.asInstanceOf[js.Any], uid.asInstanceOf[js.Any], gid.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def closeAsync(fd: Double): typingsJapgolly.bluebird.mod.^[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("closeAsync")(fd.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def copyAsync(src: String, dest: String): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("copyAsync")(src.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  ): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("copyAsync")(src.asInstanceOf[js.Any], dest.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def copyAsync(src: String, dest: String, options: CopyOptions): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("copyAsync")(src.asInstanceOf[js.Any], dest.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def createFileAsync(file: String): typingsJapgolly.bluebird.mod.^[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("createFileAsync")(file.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def ensureDirAsync(path: String): typingsJapgolly.bluebird.mod.^[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("ensureDirAsync")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def existsAsync(path: String): typingsJapgolly.bluebird.mod.^[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("existsAsync")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Boolean]]
  ...
  inline def fchmod(fd: Double, mode: typingsJapgolly.fsExtra.mod.Mode): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("fchmod")(fd.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  
  inline def fchmodAsync(fd: Double, mode: String): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("fchmodAsync")(fd.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def fchmodAsync(fd: Double, mode: Double): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("fchmodAsync")(fd.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def fchownAsync(fd: Double, uid: Double, gid: Double): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("fchownAsync")(fd.asInstanceOf[js.Any], uid.asInstanceOf[js.Any], gid.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def fstatAsync(fd: Double): typingsJapgolly.bluebird.mod.^[typingsJapgolly.node.fsMod.Stats] = ^.asInstanceOf[js.Dynamic].applyDynamic("fstatAsync")(fd.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[typingsJapgolly.node.fsMod.Stats]]
  ...
  inline def fsyncAsync(fd: Double): typingsJapgolly.bluebird.mod.^[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("fsyncAsync")(fd.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def futimesAsync(fd: Double, atime: Double, mtime: Double): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("futimesAsync")(fd.asInstanceOf[js.Any], atime.asInstanceOf[js.Any], mtime.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def isDirectoryAsync(path: String): typingsJapgolly.bluebird.mod.^[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("isDirectoryAsync")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Boolean]]
  ...
  inline def lchmodAsync(path: String, mode: String): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("lchmodAsync")(path.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def lchmodAsync(path: String, mode: Double): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("lchmodAsync")(path.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def lchownAsync(path: String, uid: Double, gid: Double): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("lchownAsync")(path.asInstanceOf[js.Any], uid.asInstanceOf[js.Any], gid.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def linkAsync(srcpath: String, dstpath: String): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("linkAsync")(srcpath.asInstanceOf[js.Any], dstpath.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def lstatAsync(path: String): typingsJapgolly.bluebird.mod.^[typingsJapgolly.node.fsMod.Stats] = ^.asInstanceOf[js.Dynamic].applyDynamic("lstatAsync")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[typingsJapgolly.node.fsMod.Stats]]
  ...
  inline def mkdir(
    path: PathLike,
    options: Mode | typingsJapgolly.fsExtra.mod.Mode,
    callback: (js.Function1[/* err */ ErrnoException, Unit]) | NoParamCallback
  ...
  inline def mkdir(path: PathLike, options: typingsJapgolly.fsExtra.mod.Mode): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("mkdir")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  ...
  inline def mkdirAsync(path: String): typingsJapgolly.bluebird.mod.^[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("mkdirAsync")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def mkdirAsync(path: String, mode: String): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("mkdirAsync")(path.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def mkdirAsync(path: String, mode: Double): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("mkdirAsync")(path.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def mkdirSync_Unit(path: PathLike, options: Mode | typingsJapgolly.fsExtra.mod.Mode): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("mkdirSync")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def mkdirpAsync(dir: String): typingsJapgolly.bluebird.mod.^[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("mkdirpAsync")(dir.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def mkdirpAsync(dir: String, options: MkdirOptions): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("mkdirpAsync")(dir.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def mkdirsAsync(dir: String): typingsJapgolly.bluebird.mod.^[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("mkdirsAsync")(dir.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def mkdirsAsync(dir: String, options: MkdirOptions): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("mkdirsAsync")(dir.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def mkdtempAsync(prefix: String, options: String): typingsJapgolly.bluebird.mod.^[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("mkdtempAsync")(prefix.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[String]]
  inline def mkdtempAsync(prefix: String, options: typingsJapgolly.fsExtraPromise.anon.Encoding): typingsJapgolly.bluebird.mod.^[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("mkdtempAsync")(prefix.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[String]]
  ...
  inline def moveAsync(src: String, dest: String): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("moveAsync")(src.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def moveAsync(src: String, dest: String, options: MoveOptions): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("moveAsync")(src.asInstanceOf[js.Any], dest.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def open(path: PathLike, flags: String, mode: typingsJapgolly.fsExtra.mod.Mode): js.Promise[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("open")(path.asInstanceOf[js.Any], flags.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Double]]
  inline def open(
    path: PathLike,
    flags: String,
    mode: typingsJapgolly.fsExtra.mod.Mode,
    callback: js.Function2[/* err */ ErrnoException, /* fd */ Double, Unit]
  ...
  inline def open(path: PathLike, flags: Double, mode: typingsJapgolly.fsExtra.mod.Mode): js.Promise[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("open")(path.asInstanceOf[js.Any], flags.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Double]]
  inline def open(
    path: PathLike,
    flags: Double,
    mode: typingsJapgolly.fsExtra.mod.Mode,
  ...
  inline def openAsync(path: String, flags: String): typingsJapgolly.bluebird.mod.^[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("openAsync")(path.asInstanceOf[js.Any], flags.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Double]]
  inline def openAsync(path: String, flags: String, mode: String): typingsJapgolly.bluebird.mod.^[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("openAsync")(path.asInstanceOf[js.Any], flags.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Double]]
  ...
  inline def outputFileAsync(file: String, data: Any): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("outputFileAsync")(file.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def outputJSONAsync_(file: String, data: Any): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("outputJSONAsync")(file.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def outputJsonAsync(file: String, data: Any): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("outputJsonAsync")(file.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def readAsync(fd: Double, buffer: Buffer, offset: Double, length: Double, position: Double): typingsJapgolly.bluebird.mod.^[js.Tuple2[Double, Buffer]] = (^.asInstanceOf[js.Dynamic].applyDynamic("readAsync")(fd.asInstanceOf[js.Any], buffer.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], length.asInstanceOf[js.Any], position.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[js.Tuple2[Double, Buffer]]]
  ...
  inline def readFileAsync(filename: String): typingsJapgolly.bluebird.mod.^[Buffer] = ^.asInstanceOf[js.Dynamic].applyDynamic("readFileAsync")(filename.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Buffer]]
  inline def readFileAsync(filename: String, options: String): typingsJapgolly.bluebird.mod.^[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("readFileAsync")(filename.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[String]]
  inline def readFileAsync(filename: String, options: ReadOptions): typingsJapgolly.bluebird.mod.^[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("readFileAsync")(filename.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[String]]
  ...
  inline def readJSONAsync_(file: String): typingsJapgolly.bluebird.mod.^[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("readJSONAsync")(file.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Any]]
  inline def readJSONAsync_(file: String, options: ReadOptions): typingsJapgolly.bluebird.mod.^[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("readJSONAsync")(file.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Any]]
  ...
  inline def readJsonAsync(file: String): typingsJapgolly.bluebird.mod.^[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("readJsonAsync")(file.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Any]]
  inline def readJsonAsync(file: String, options: ReadOptions): typingsJapgolly.bluebird.mod.^[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("readJsonAsync")(file.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Any]]
  ...
  inline def readdir(path: PathLike, options: typingsJapgolly.fsExtra.anon.WithFileTypes): js.Promise[js.Array[Buffer]] = (^.asInstanceOf[js.Dynamic].applyDynamic("readdir")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Array[Buffer]]]
  ...
  inline def readdirAsync(path: String): typingsJapgolly.bluebird.mod.^[js.Array[String]] = ^.asInstanceOf[js.Dynamic].applyDynamic("readdirAsync")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[js.Array[String]]]
  ...
  inline def readlinkAsync(path: String): typingsJapgolly.bluebird.mod.^[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("readlinkAsync")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[String]]
  ...
  inline def realpathAsync(path: String): typingsJapgolly.bluebird.mod.^[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("realpathAsync")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[String]]
  inline def realpathAsync(path: String, cache: StringDictionary[String]): typingsJapgolly.bluebird.mod.^[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("realpathAsync")(path.asInstanceOf[js.Any], cache.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[String]]
  ...
  inline def removeAsync(dir: String): typingsJapgolly.bluebird.mod.^[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("removeAsync")(dir.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def renameAsync(oldPath: String, newPath: String): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("renameAsync")(oldPath.asInstanceOf[js.Any], newPath.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def rmdirAsync(path: String): typingsJapgolly.bluebird.mod.^[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("rmdirAsync")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def statAsync(path: String): typingsJapgolly.bluebird.mod.^[typingsJapgolly.node.fsMod.Stats] = ^.asInstanceOf[js.Dynamic].applyDynamic("statAsync")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[typingsJapgolly.node.fsMod.Stats]]
  ...
  inline def symlinkAsync(srcpath: String, dstpath: String): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("symlinkAsync")(srcpath.asInstanceOf[js.Any], dstpath.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def symlinkAsync(srcpath: String, dstpath: String, `type`: Type): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("symlinkAsync")(srcpath.asInstanceOf[js.Any], dstpath.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def truncateAsync(fd: Double, len: Double): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("truncateAsync")(fd.asInstanceOf[js.Any], len.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def unlinkAsync(path: String): typingsJapgolly.bluebird.mod.^[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("unlinkAsync")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def utimesAsync(path: String, atime: Double, mtime: Double): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("utimesAsync")(path.asInstanceOf[js.Any], atime.asInstanceOf[js.Any], mtime.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def writeAsync(fd: Double, buffer: Buffer, offset: Double, length: Double, position: Double): typingsJapgolly.bluebird.mod.^[js.Tuple2[Double, Buffer]] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeAsync")(fd.asInstanceOf[js.Any], buffer.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], length.asInstanceOf[js.Any], position.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[js.Tuple2[Double, Buffer]]]
  ...
  inline def writeFileAsync(filename: String, data: Any): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeFileAsync")(filename.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def writeFileAsync(filename: String, data: Any, options: String): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeFileAsync")(filename.asInstanceOf[js.Any], data.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def writeFileAsync(filename: String, data: Any, options: WriteOptions): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeFileAsync")(filename.asInstanceOf[js.Any], data.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def writeJSONAsync_(file: String, `object`: Any): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeJSONAsync")(file.asInstanceOf[js.Any], `object`.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def writeJSONAsync_(file: String, `object`: Any, options: WriteOptions): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeJSONAsync")(file.asInstanceOf[js.Any], `object`.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  inline def writeJsonAsync(file: String, `object`: Any): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeJsonAsync")(file.asInstanceOf[js.Any], `object`.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def writeJsonAsync(file: String, `object`: Any, options: WriteOptions): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeJsonAsync")(file.asInstanceOf[js.Any], `object`.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
