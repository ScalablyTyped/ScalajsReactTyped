...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "fortawesome__fontawesome-common-types" % "6.2.0-6b2e77",
  "org.scalablytyped.japgolly" %%% "fortawesome__fontawesome-svg-core" % "6.2.0-c503a4",
