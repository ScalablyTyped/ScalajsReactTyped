...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "fortawesome__fontawesome-common-types" % "0.2.27-fd0789",
  "org.scalablytyped.japgolly" %%% "fortawesome__fontawesome-svg-core" % "1.2.27-786124",
