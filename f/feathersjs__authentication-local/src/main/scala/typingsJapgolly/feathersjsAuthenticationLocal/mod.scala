...
import typingsJapgolly.feathersjsAuthenticationLocal.anon.Message
import typingsJapgolly.feathersjsAuthenticationLocal.anon.PartialFeathersAuthentica
import typingsJapgolly.feathersjsAuthenticationLocal.anon.Typeofself
