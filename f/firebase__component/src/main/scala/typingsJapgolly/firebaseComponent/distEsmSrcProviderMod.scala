...
import typingsJapgolly.firebaseComponent.anon.Identifier
import typingsJapgolly.firebaseComponent.anon.Optional
...
import typingsJapgolly.firebaseComponent.distEsmSrcTypesMod.InitializeOptions
import typingsJapgolly.firebaseComponent.distEsmSrcTypesMod.Name
import typingsJapgolly.firebaseComponent.distEsmSrcTypesMod.OnInitCallBack
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distEsmSrcProviderMod {
  
  @JSImport("@firebase/component/dist/esm/src/provider", "Provider")
  @js.native
  open class Provider[T /* <: Name */] protected () extends StObject {
    ...
    def getImmediate(): /* import warning: importer.ImportType#apply Failed type conversion: @firebase/component.@firebase/component/dist/esm/src/types.NameServiceMapping[T] */ js.Any = js.native
    /**
      *
      ...
      */
    def getImmediate(options: Identifier): (/* import warning: importer.ImportType#apply Failed type conversion: @firebase/component.@firebase/component/dist/esm/src/types.NameServiceMapping[T] */ js.Any) | Null = js.native
    def getImmediate(options: Optional): /* import warning: importer.ImportType#apply Failed type conversion: @firebase/component.@firebase/component/dist/esm/src/types.NameServiceMapping[T] */ js.Any = js.native
    ...
    def initialize(): /* import warning: importer.ImportType#apply Failed type conversion: @firebase/component.@firebase/component/dist/esm/src/types.NameServiceMapping[T] */ js.Any = js.native
    def initialize(opts: InitializeOptions): /* import warning: importer.ImportType#apply Failed type conversion: @firebase/component.@firebase/component/dist/esm/src/types.NameServiceMapping[T] */ js.Any = js.native
