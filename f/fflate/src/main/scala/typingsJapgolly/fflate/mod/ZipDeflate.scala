...
open class ZipDeflate protected ()
  ...
  @JSName("ondata")
  def ondata_MZipDeflate(err: Null, data: js.typedarray.Uint8Array, `final`: Boolean): Unit = js.native
  @JSName("ondata")
  def ondata_MZipDeflate(err: FlateError, data: js.typedarray.Uint8Array, `final`: Boolean): Unit = js.native
  @JSName("ondata")
