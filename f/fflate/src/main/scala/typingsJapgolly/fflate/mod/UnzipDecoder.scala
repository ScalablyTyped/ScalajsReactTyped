...
object UnzipDecoder {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(ondata = js.Any.fromFunction3((t0: /* err */ FlateError | Null, t1: /* data */ js.typedarray.Uint8Array, t2: /* final */ Boolean) => (ondata(t0, t1, t2)).runNow()), push = js.Any.fromFunction2((t0: js.typedarray.Uint8Array, t1: Boolean) => (push(t0, t1)).runNow()))
