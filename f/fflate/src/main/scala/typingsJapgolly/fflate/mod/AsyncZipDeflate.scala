...
import typingsJapgolly.fflate.fflateInts.`0`
import typingsJapgolly.fflate.fflateInts.`1`
import typingsJapgolly.fflate.fflateInts.`2`
import typingsJapgolly.fflate.fflateInts.`3`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("fflate", "AsyncZipDeflate")
@js.native
open class AsyncZipDeflate protected ()
  ...
  @JSName("ondata")
  def ondata_MAsyncZipDeflate(err: Null, data: js.typedarray.Uint8Array, `final`: Boolean): Unit = js.native
  @JSName("ondata")
  def ondata_MAsyncZipDeflate(err: FlateError, data: js.typedarray.Uint8Array, `final`: Boolean): Unit = js.native
  @JSName("ondata")
