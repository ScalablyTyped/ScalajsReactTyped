...
import typingsJapgolly.fetchMock.fetchMockStrings.always
...
object AnonFallbackToNetwork {
  ...
  def apply(
    ...
    fetch: (/* input */ js.UndefOr[String | Request], /* init */ js.UndefOr[RequestInit]) => CallbackTo[js.Promise[Response]] = null,
    ...
    if (fetch != null) __obj.updateDynamic("fetch")(js.Any.fromFunction2((t0: /* input */ js.UndefOr[java.lang.String | org.scalajs.dom.experimental.Request], t1: /* init */ js.UndefOr[org.scalajs.dom.experimental.RequestInit]) => fetch(t0, t1).runNow()))
