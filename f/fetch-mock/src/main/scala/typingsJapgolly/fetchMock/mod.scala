...
import typingsJapgolly.fetchMock.anon.FallbackToNetwork
import typingsJapgolly.fetchMock.fetchMockBooleans.`false`
import typingsJapgolly.fetchMock.fetchMockBooleans.`true`
import typingsJapgolly.fetchMock.fetchMockStrings.DELETE
import typingsJapgolly.fetchMock.fetchMockStrings.GET
import typingsJapgolly.fetchMock.fetchMockStrings.HEAD
import typingsJapgolly.fetchMock.fetchMockStrings.POST
import typingsJapgolly.fetchMock.fetchMockStrings.PUT
