package typingsJapgolly.fetchMock
...
package object mod {
  /**
    ...
    */
  type InspectionFilter = typingsJapgolly.fetchMock.mod.MockMatcher | scala.Boolean
  /**
    ...
    * calls further.
    */
  type InspectionOptions = typingsJapgolly.fetchMock.mod.MockOptions | java.lang.String
  /**
    ...
    */
  type MockMatcher = java.lang.String | js.RegExp | typingsJapgolly.fetchMock.mod.MockMatcherFunction
  /**
    * Mock matcher function
    */
  type MockMatcherFunction = js.Function2[
    /* url */ java.lang.String, 
    /* opts */ typingsJapgolly.fetchMock.mod.MockRequest, 
    scala.Boolean
  ]
  ...
  type MockResponse = org.scalajs.dom.experimental.Response | (js.Promise[
    scala.Double | typingsJapgolly.fetchMock.mod.MockResponseObject | js.Object | org.scalajs.dom.experimental.Response | java.lang.String
  ]) | scala.Double | java.lang.String | js.Object | typingsJapgolly.fetchMock.mod.MockResponseObject
  /**
  ...
  type MockResponseFunction = js.Function2[
    /* url */ java.lang.String, 
    /* opts */ typingsJapgolly.fetchMock.mod.MockRequest, 
    typingsJapgolly.fetchMock.mod.MockResponse
  ]
}
