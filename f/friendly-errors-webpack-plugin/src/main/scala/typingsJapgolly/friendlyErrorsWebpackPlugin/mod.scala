package typingsJapgolly.friendlyErrorsWebpackPlugin

import japgolly.scalajs.react.Callback
import typingsJapgolly.friendlyErrorsWebpackPlugin.anon.Messages
...
object mod {
  ...
  object Severity extends StObject {
    ...
    sealed trait Error
      extends StObject
         with Severity
    /* "error" */ val Error: typingsJapgolly.friendlyErrorsWebpackPlugin.mod.Severity.Error & String = js.native
    
    @js.native
    sealed trait Warning
      extends StObject
         with Severity
    /* "warning" */ val Warning: typingsJapgolly.friendlyErrorsWebpackPlugin.mod.Severity.Warning & String = js.native
  }
  ...
  object FriendlyErrorsWebpackPlugin {
    ...
    inline def apply(apply: Compiler => Callback): FriendlyErrorsWebpackPlugin = {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnErrors(value: (/* severity */ Severity, /* errors */ String) => Callback): Self = StObject.set(x, "onErrors", js.Any.fromFunction2((t0: /* severity */ Severity, t1: /* errors */ String) => (value(t0, t1)).runNow()))
