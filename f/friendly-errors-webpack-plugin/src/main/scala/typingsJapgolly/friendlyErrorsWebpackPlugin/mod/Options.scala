...
import typingsJapgolly.friendlyErrorsWebpackPlugin.AnonMessages
...
object Options {
  ...
  def apply(
    ...
    onErrors: (/* severity */ Severity, /* errors */ String) => Callback = null
  ): Options = {
    ...
    if (onErrors != null) __obj.updateDynamic("onErrors")(js.Any.fromFunction2((t0: /* severity */ typingsJapgolly.friendlyErrorsWebpackPlugin.mod.Severity, t1: /* errors */ java.lang.String) => onErrors(t0, t1).runNow()))
