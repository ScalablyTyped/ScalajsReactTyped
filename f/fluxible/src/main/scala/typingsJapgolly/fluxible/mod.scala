...
import typingsJapgolly.dispatchr.mod.Dispatcher
...
import typingsJapgolly.fluxible.anon.Create
import typingsJapgolly.fluxible.anon.Instantiable
...
object mod {
  ...
  object FluxibleConfiguration {
    ...
    extension [Self <: FluxibleConfiguration](x: Self) {
      ...
      inline def setComponentActionHandler(value: Callback): Self = StObject.set(x, "componentActionHandler", value.toJsFn)
