...
import typingsJapgolly.figma.mod._Global_.Navigation
import typingsJapgolly.figma.mod._Global_.Transition
import typingsJapgolly.figma.mod._Global_.Vector
