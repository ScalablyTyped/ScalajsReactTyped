package typingsJapgolly.feedsub

import japgolly.scalajs.react.Callback
import typingsJapgolly.feedsub.anon.Headers
...
object distFeedsubMod {
  ...
  object FeedSubEvents {
    ...
    inline def apply(
      ...
      item: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FeedItem */ Any => Callback,
      items: js.Array[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FeedItem */ Any
        ] => Callback
    ): FeedSubEvents = {
      val __obj = js.Dynamic.literal(error = js.Any.fromFunction1((t0: js.Error) => error(t0).runNow()), item = js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FeedItem */ Any) => item(t0).runNow()), items = js.Any.fromFunction1((t0: js.Array[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FeedItem */ Any
        ]) => items(t0).runNow()))
    ...
    extension [Self <: FeedSubEvents](x: Self) {
      ...
      inline def setItem(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FeedItem */ Any => Callback
      ): Self = StObject.set(x, "item", js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FeedItem */ Any) => value(t0).runNow()))
      
      inline def setItems(
        value: js.Array[
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FeedItem */ Any
            ] => Callback
      ): Self = StObject.set(x, "items", js.Any.fromFunction1((t0: js.Array[
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FeedItem */ Any
            ]) => value(t0).runNow()))
    }
  }
