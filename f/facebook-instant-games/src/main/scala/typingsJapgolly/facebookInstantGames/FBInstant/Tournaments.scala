...
object Tournaments {
  ...
  inline def apply(
    ...
    getTournamentsAsync: CallbackTo[js.Promise[js.Array[Tournament]]],
    joinAsync: String => js.Promise[Unit],
    postScoreAsync: Double => js.Promise[Unit],
    shareAsync: ShareTournamentPayload => js.Promise[Unit]
  ): Tournaments = {
    val __obj = js.Dynamic.literal(createAsync = js.Any.fromFunction1(createAsync), getTournamentsAsync = getTournamentsAsync.toJsFn, joinAsync = js.Any.fromFunction1(joinAsync), postScoreAsync = js.Any.fromFunction1(postScoreAsync), shareAsync = js.Any.fromFunction1(shareAsync))
  ...
  extension [Self <: Tournaments](x: Self) {
    ...
    inline def setGetTournamentsAsync(value: CallbackTo[js.Promise[js.Array[Tournament]]]): Self = StObject.set(x, "getTournamentsAsync", value.toJsFn)
