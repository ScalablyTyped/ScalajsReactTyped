...
import typingsJapgolly.fluentuiStyleUtilities.fluentuiStyleUtilitiesBooleans.`false`
import typingsJapgolly.fluentuiStyleUtilities.fluentuiStyleUtilitiesInts.`0`
import typingsJapgolly.fluentuiStyleUtilities.fluentuiStyleUtilitiesInts.`1`
import typingsJapgolly.fluentuiStyleUtilities.fluentuiStyleUtilitiesInts.`2`
...
import typingsJapgolly.fluentuiStyleUtilities.libClassNamesColorClassNamesMod.IColorClassNames
import typingsJapgolly.fluentuiStyleUtilities.libInterfacesIgetfocusstylesMod.IGetFocusStylesOptions
import typingsJapgolly.fluentuiStyleUtilities.libStylesGetGlobalClassNamesMod.GlobalClassNames
...
object mod {
  ...
  open class Stylesheet ()
    extends typingsJapgolly.fluentuiStyleUtilities.libMergeStylesMod.Stylesheet {
  ...
  inline def getEdgeChromiumNoHighContrastAdjustSelector(): typingsJapgolly.fluentuiStyleUtilities.anon.EdgeChromiumHighContrastSelector = ^.asInstanceOf[js.Dynamic].applyDynamic("getEdgeChromiumNoHighContrastAdjustSelector")().asInstanceOf[typingsJapgolly.fluentuiStyleUtilities.anon.EdgeChromiumHighContrastSelector]
