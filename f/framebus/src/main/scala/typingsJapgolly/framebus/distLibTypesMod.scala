...
object distLibTypesMod {
  ...
  object global {
    ...
    trait Window extends StObject {
      ...
      def Window(): typingsJapgolly.framebus.distLibTypesMod.global.Window
    }
    object Window {
      
      inline def apply(Window: CallbackTo[Window]): Window = {
        val __obj = js.Dynamic.literal(Window = Window.toJsFn)
