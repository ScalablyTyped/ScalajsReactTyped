...
trait plotOptions extends StObject {
  ...
  var hooks: js.UndefOr[typingsJapgolly.flot.jquery.flot.hooks] = js.undefined
  
  var interaction: js.UndefOr[typingsJapgolly.flot.jquery.flot.interaction] = js.undefined
