...
import typingsJapgolly.firmata.anon.Address
import typingsJapgolly.firmata.anon.Baud
import typingsJapgolly.firmata.anon.Delay
...
trait Board extends EventEmitter {
  ...
  /* protected */ var transport: typingsJapgolly.serialport.mod.^ = js.native
