...
import typingsJapgolly.firmata.AnonAddress
import typingsJapgolly.firmata.AnonBaud
import typingsJapgolly.firmata.AnonDelay
...
trait Board extends EventEmitter {
  ...
  var transport: typingsJapgolly.serialport.mod.^ = js.native
