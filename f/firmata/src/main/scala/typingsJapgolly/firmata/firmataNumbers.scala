...
import typingsJapgolly.firmata.mod.I2C_MODE
import typingsJapgolly.firmata.mod.PIN_MODE
import typingsJapgolly.firmata.mod.PIN_STATE
import typingsJapgolly.firmata.mod.PULLUP_STATE
import typingsJapgolly.firmata.mod.REPORTING
import typingsJapgolly.firmata.mod.SERIAL_MODE
import typingsJapgolly.firmata.mod.SERIAL_PIN_TYPE
import typingsJapgolly.firmata.mod.SERIAL_PORT_ID
import typingsJapgolly.firmata.mod.STEPPER_DIRECTION
import typingsJapgolly.firmata.mod.STEPPER_RUN_STATE
import typingsJapgolly.firmata.mod.STEPPER_TYPE
