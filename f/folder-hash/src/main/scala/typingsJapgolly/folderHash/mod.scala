...
import typingsJapgolly.folderHash.folderHashStrings.base64
import typingsJapgolly.folderHash.folderHashStrings.base64url
import typingsJapgolly.folderHash.folderHashStrings.binary
import typingsJapgolly.folderHash.folderHashStrings.hex
...
object mod {
  ...
  object FolderAndFileOptions {
    ...
    extension [Self <: FolderAndFileOptions](x: Self) {
      ...
      inline def setExcludeCallbackTo(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "exclude", value.toJsFn)
      ...
      inline def setIncludeCallbackTo(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "include", value.toJsFn)
