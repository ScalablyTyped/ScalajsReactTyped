...
import typingsJapgolly.fluentBundle.anon.Functions
...
object mod {
  ...
  open class FluentBundle protected ()
    extends typingsJapgolly.fluentBundle.esmBundleMod.FluentBundle {
    /**
  ...
  open class FluentDateTime protected ()
    extends typingsJapgolly.fluentBundle.esmTypesMod.FluentDateTime {
    /**
  ...
  open class FluentNone ()
    extends typingsJapgolly.fluentBundle.esmTypesMod.FluentNone {
  ...
  open class FluentNumber protected ()
    extends typingsJapgolly.fluentBundle.esmTypesMod.FluentNumber {
    /**
  ...
  open class FluentResource protected ()
    extends typingsJapgolly.fluentBundle.esmResourceMod.FluentResource {
  ...
  open class FluentType[T] protected ()
    extends typingsJapgolly.fluentBundle.esmTypesMod.FluentType[T] {
    /**
