...
import typingsJapgolly.firebird.firebirdBooleans.`false`
import typingsJapgolly.firebird.firebirdBooleans.`true`
import typingsJapgolly.firebird.firebirdStrings.all
...
object mod {
  ...
  open class Stream protected ()
    extends typingsJapgolly.node.streamMod.Stream {
  ...
  object Transaction {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(commit = js.Any.fromFunction1((t0: js.Function1[/* err */ js.Error | Null, Unit]) => commit(t0).runNow()), commitSync = commitSync.toJsFn, inTransaction = inTransaction.asInstanceOf[js.Any], prepareSync = js.Any.fromFunction1(prepareSync), query = js.Any.fromFunction2((t0: String, t1: js.Function2[/* err */ js.Error | Null, /* res */ FBResult, Unit]) => (query(t0, t1)).runNow()), querySync = js.Any.fromFunction1((t0: String) => querySync(t0).runNow()), rollback = js.Any.fromFunction1((t0: js.Function1[/* err */ js.Error | Null, Unit]) => rollback(t0).runNow()), rollbackSync = rollbackSync.toJsFn, start = js.Any.fromFunction1((t0: js.Function1[/* err */ js.Error | Null, Unit]) => start(t0).runNow()), startSync = startSync.toJsFn)
      __obj.asInstanceOf[Transaction]
    }
    
    extension [Self <: Transaction](x: Self) {
      
      inline def setCommit(value: js.Function1[/* err */ js.Error | Null, Unit] => Callback): Self = StObject.set(x, "commit", js.Any.fromFunction1((t0: js.Function1[/* err */ js.Error | Null, Unit]) => value(t0).runNow()))
      
      inline def setCommitSync(value: Callback): Self = StObject.set(x, "commitSync", value.toJsFn)
      ...
      inline def setQuery(value: (String, js.Function2[/* err */ js.Error | Null, /* res */ FBResult, Unit]) => Callback): Self = StObject.set(x, "query", js.Any.fromFunction2((t0: String, t1: js.Function2[/* err */ js.Error | Null, /* res */ FBResult, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setQuerySync(value: String => Callback): Self = StObject.set(x, "querySync", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setRollback(value: js.Function1[/* err */ js.Error | Null, Unit] => Callback): Self = StObject.set(x, "rollback", js.Any.fromFunction1((t0: js.Function1[/* err */ js.Error | Null, Unit]) => value(t0).runNow()))
      
      inline def setRollbackSync(value: Callback): Self = StObject.set(x, "rollbackSync", value.toJsFn)
      
      inline def setStart(value: js.Function1[/* err */ js.Error | Null, Unit] => Callback): Self = StObject.set(x, "start", js.Any.fromFunction1((t0: js.Function1[/* err */ js.Error | Null, Unit]) => value(t0).runNow()))
      
      inline def setStartSync(value: Callback): Self = StObject.set(x, "startSync", value.toJsFn)
    }
  }
}
