...
import typingsJapgolly.formatjsIntl.formatjsIntlStrings.compact
import typingsJapgolly.formatjsIntl.formatjsIntlStrings.engineering
...
import typingsJapgolly.formatjsIntl.formatjsIntlStrings.scientific
import typingsJapgolly.formatjsIntl.formatjsIntlStrings.short
import typingsJapgolly.formatjsIntl.formatjsIntlStrings.standard
...
trait FormatNumberOptions extends StObject {
  ...
  var format: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: 'number' extends keyof @formatjs/intl.@formatjs/intl/lib/src/types.<global>.FormatjsIntl.Formats ? @formatjs/intl.@formatjs/intl/lib/src/types.<global>.FormatjsIntl.Formats['number'] : string */ js.Any
  ] = js.undefined
...
object FormatNumberOptions {
  ...
  extension [Self <: FormatNumberOptions](x: Self) {
    ...
    inline def setFormat(
      value: /* import warning: importer.ImportType#apply Failed type conversion: 'number' extends keyof @formatjs/intl.@formatjs/intl/lib/src/types.<global>.FormatjsIntl.Formats ? @formatjs/intl.@formatjs/intl/lib/src/types.<global>.FormatjsIntl.Formats['number'] : string */ js.Any
