...
/* Inlined std.Omit<std.Intl.PluralRulesOptions, 'localeMatcher'> & @formatjs/intl.@formatjs/intl/lib/src/types.CustomFormatConfig<string> */
trait FormatPluralOptions extends StObject {
  
  var format: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: string extends keyof @formatjs/intl.@formatjs/intl/lib/src/types.<global>.FormatjsIntl.Formats ? @formatjs/intl.@formatjs/intl/lib/src/types.<global>.FormatjsIntl.Formats[string] : string */ js.Any
  ] = js.undefined
...
object FormatPluralOptions {
  ...
  extension [Self <: FormatPluralOptions](x: Self) {
    ...
    inline def setFormat(
      value: /* import warning: importer.ImportType#apply Failed type conversion: string extends keyof @formatjs/intl.@formatjs/intl/lib/src/types.<global>.FormatjsIntl.Formats ? @formatjs/intl.@formatjs/intl/lib/src/types.<global>.FormatjsIntl.Formats[string] : string */ js.Any
