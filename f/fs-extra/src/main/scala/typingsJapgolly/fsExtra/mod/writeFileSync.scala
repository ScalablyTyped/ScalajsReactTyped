...
object writeFileSync extends js.Object {
  ...
  def apply(path: Double, data: js.Any, options: typingsJapgolly.node.fsMod.WriteFileOptions): Unit = js.native
  /**
  ...
  def apply(path: PathLike, data: js.Any, options: typingsJapgolly.node.fsMod.WriteFileOptions): Unit = js.native
}
