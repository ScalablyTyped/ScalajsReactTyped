...
import typingsJapgolly.forgeApis.mod.WebhooksApi.HooksOptions
import typingsJapgolly.forgeApis.mod.WebhooksApi.RegionEnum
import typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum
import typingsJapgolly.forgeApis.mod.WebhooksApi.WebhooksSystemEnum
...
object WebhooksApi {
  ...
  object RegionEnum extends StObject {
    ...
    sealed trait EMEA
      extends StObject
         with RegionEnum
    /* "EMEA" */ val EMEA: typingsJapgolly.forgeApis.mod.WebhooksApi.RegionEnum.EMEA & String = js.native
    
    @js.native
    sealed trait EU
      extends StObject
         with RegionEnum
    /* "EMEA" */ val EU: typingsJapgolly.forgeApis.mod.WebhooksApi.RegionEnum.EU & String = js.native
    
    @js.native
    sealed trait US
      extends StObject
         with RegionEnum
    /* "US" */ val US: typingsJapgolly.forgeApis.mod.WebhooksApi.RegionEnum.US & String = js.native
  }
  ...
  object StatusEnum extends StObject {
    ...
    sealed trait Active
      extends StObject
         with StatusEnum
    /* "active" */ val Active: typingsJapgolly.forgeApis.mod.WebhooksApi.StatusEnum.Active & String = js.native
    
    @js.native
    sealed trait Inactive
      extends StObject
         with StatusEnum
    /* "inactive" */ val Inactive: typingsJapgolly.forgeApis.mod.WebhooksApi.StatusEnum.Inactive & String = js.native
  }
  ...
  object WebhookEventEnum extends StObject {
    ...
    /* "extraction.finished" */ val ExtractionFinished: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.ExtractionFinished & String = js.native
    
    @js.native
    sealed trait ExtractionUpdated
      extends StObject
         with WebhookEventEnum
    /* "extraction.updated" */ val ExtractionUpdated: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.ExtractionUpdated & String = js.native
    
    @js.native
    sealed trait FolderAdded
      extends StObject
         with WebhookEventEnum
    /* "dm.folder.added" */ val FolderAdded: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.FolderAdded & String = js.native
    
    @js.native
    sealed trait FolderCopied
      extends StObject
         with WebhookEventEnum
    /* "dm.folder.copied" */ val FolderCopied: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.FolderCopied & String = js.native
    
    @js.native
    sealed trait FolderDeleted
      extends StObject
         with WebhookEventEnum
    /* "dm.folder.deleted" */ val FolderDeleted: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.FolderDeleted & String = js.native
    
    @js.native
    sealed trait FolderModified
      extends StObject
         with WebhookEventEnum
    /* "dm.folder.modified" */ val FolderModified: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.FolderModified & String = js.native
    
    @js.native
    sealed trait FolderMoved
      extends StObject
         with WebhookEventEnum
    /* "dm.folder.moved" */ val FolderMoved: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.FolderMoved & String = js.native
    ...
    sealed trait ItemClone
      extends StObject
         with WebhookEventEnum
    /* "item.clone" */ val ItemClone: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.ItemClone & String = js.native
    
    @js.native
    sealed trait ItemCreate
      extends StObject
         with WebhookEventEnum
    /* "item.create" */ val ItemCreate: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.ItemCreate & String = js.native
    
    @js.native
    sealed trait ItemLock
      extends StObject
         with WebhookEventEnum
    /* "item.lock" */ val ItemLock: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.ItemLock & String = js.native
    
    @js.native
    sealed trait ItemRelease
      extends StObject
         with WebhookEventEnum
    /* "item.release" */ val ItemRelease: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.ItemRelease & String = js.native
    
    @js.native
    sealed trait ItemUnlock
      extends StObject
         with WebhookEventEnum
    /* "item.unlock" */ val ItemUnlock: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.ItemUnlock & String = js.native
    
    @js.native
    sealed trait ItemUpdate
      extends StObject
         with WebhookEventEnum
    /* "item.update" */ val ItemUpdate: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.ItemUpdate & String = js.native
    
    @js.native
    sealed trait ModelPublish
      extends StObject
         with WebhookEventEnum
    /* "model.publish" */ val ModelPublish: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.ModelPublish & String = js.native
    ...
    sealed trait ModelSync
      extends StObject
         with WebhookEventEnum
    /* "model.sync" */ val ModelSync: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.ModelSync & String = js.native
    ...
    sealed trait VersionAdded
      extends StObject
         with WebhookEventEnum
    /* "dm.version.added" */ val VersionAdded: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.VersionAdded & String = js.native
    
    @js.native
    sealed trait VersionCopied
      extends StObject
         with WebhookEventEnum
    /* "dm.version.copied" */ val VersionCopied: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.VersionCopied & String = js.native
    
    @js.native
    sealed trait VersionDeleted
      extends StObject
         with WebhookEventEnum
    /* "dm.version.deleted" */ val VersionDeleted: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.VersionDeleted & String = js.native
    
    @js.native
    sealed trait VersionModified
      extends StObject
         with WebhookEventEnum
    /* "dm.version.modified" */ val VersionModified: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.VersionModified & String = js.native
    
    @js.native
    sealed trait VersionMoved
      extends StObject
         with WebhookEventEnum
    /* "dm.version.moved" */ val VersionMoved: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.VersionMoved & String = js.native
    
    @js.native
    sealed trait WorkflowTransition
      extends StObject
         with WebhookEventEnum
    /* "workflow.transition" */ val WorkflowTransition: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhookEventEnum.WorkflowTransition & String = js.native
  }
  ...
  object WebhooksSystemEnum extends StObject {
    ...
    /* "adsk.c4r" */ val c4r: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhooksSystemEnum.c4r & String = js.native
    
    @js.native
    sealed trait data
      extends StObject
         with WebhooksSystemEnum
    /* "data" */ val data: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhooksSystemEnum.data & String = js.native
    
    @js.native
    sealed trait derivative
      extends StObject
         with WebhooksSystemEnum
    /* "derivative" */ val derivative: typingsJapgolly.forgeApis.mod.WebhooksApi.WebhooksSystemEnum.derivative & String = js.native
  }
