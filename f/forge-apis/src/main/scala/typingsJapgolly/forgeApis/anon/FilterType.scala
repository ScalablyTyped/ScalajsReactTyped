...
object FilterType {
  ...
  extension [Self <: FilterType](x: Self) {
    ...
    inline def setFilterVersionNumber(value: js.Array[Double]): Self = StObject.set(x, "filterVersionNumber", value.asInstanceOf[js.Any])
    
    inline def setFilterVersionNumberUndefined: Self = StObject.set(x, "filterVersionNumber", js.undefined)
    
    inline def setFilterVersionNumberVarargs(value: Double*): Self = StObject.set(x, "filterVersionNumber", js.Array(value*))
