package typingsJapgolly.fullcalendar.helperRendererMod
...
class Default_ protected () extends js.Object {
  ...
  def fabricateEventFootprint(componentFootprint: js.Any): typingsJapgolly.fullcalendar.eventFootprintMod.default = js.native
