...
import typingsJapgolly.fullcalendar.AnonActiveUnzonedRange
import typingsJapgolly.fullcalendar.AnonDuration
...
class Default_ protected () extends js.Object {
  ...
  def adjustActiveRange(unzonedRange: js.Any, minTime: js.Any, maxTime: js.Any): typingsJapgolly.fullcalendar.unzonedRangeMod.default = js.native
  ...
  def buildRangeFromDayCount(date: js.Any, direction: js.Any, dayCount: js.Any): typingsJapgolly.fullcalendar.unzonedRangeMod.default = js.native
