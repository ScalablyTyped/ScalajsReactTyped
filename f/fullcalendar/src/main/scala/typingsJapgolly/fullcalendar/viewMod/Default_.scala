package typingsJapgolly.fullcalendar.viewMod
...
abstract class Default_ protected ()
  extends typingsJapgolly.fullcalendar.interactiveDateComponentMod.default {
  def this(calendar: js.Any, viewSpec: js.Any) = this()
  var batchRenderDepth: Double = js.native
  var calendar: typingsJapgolly.fullcalendar.calendarMod.default = js.native
  ...
  var renderQueue: typingsJapgolly.fullcalendar.renderQueueMod.default = js.native
  var selectedEventInstance: typingsJapgolly.fullcalendar.eventInstanceMod.default = js.native
  ...
  def getUnzonedRangeOption(name: js.Any): typingsJapgolly.fullcalendar.unzonedRangeMod.default = js.native
  ...
  def trimHiddenDays(inputUnzonedRange: js.Any): typingsJapgolly.fullcalendar.unzonedRangeMod.default = js.native
