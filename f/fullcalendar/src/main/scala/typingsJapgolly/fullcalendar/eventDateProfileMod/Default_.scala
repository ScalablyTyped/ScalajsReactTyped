package typingsJapgolly.fullcalendar.eventDateProfileMod
...
class Default_ protected () extends js.Object {
  ...
  def buildUnzonedRange(calendar: js.Any): typingsJapgolly.fullcalendar.unzonedRangeMod.default = js.native
