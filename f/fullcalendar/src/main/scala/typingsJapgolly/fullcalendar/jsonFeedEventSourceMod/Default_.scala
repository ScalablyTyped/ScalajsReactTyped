package typingsJapgolly.fullcalendar.jsonFeedEventSourceMod

import typingsJapgolly.fullcalendar.AnonCache
...
@js.native
class Default_ ()
  extends typingsJapgolly.fullcalendar.eventSourceMod.default {
