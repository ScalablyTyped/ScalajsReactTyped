package typingsJapgolly.fullcalendar.interactiveDateComponentMod
...
abstract class Default_ ()
  extends typingsJapgolly.fullcalendar.dateComponentMod.default {
  ...
  def diffDates(a: js.Any, b: js.Any): Duration_ = js.native
