package typingsJapgolly.fullcalendar.dateComponentMod

import typingsJapgolly.fullcalendar.AnonEnd
...
abstract class Default_ ()
  extends typingsJapgolly.fullcalendar.componentMod.Default_ {
