...
import typingsJapgolly.fusioncharts.anon.AddGroup
import typingsJapgolly.fusioncharts.anon.CreditLabel
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fusioncharts.fusionchartsStrings.json
    - typingsJapgolly.fusioncharts.fusionchartsStrings.jsonurl
    - typingsJapgolly.fusioncharts.fusionchartsStrings.csv
    - typingsJapgolly.fusioncharts.fusionchartsStrings.xml
    - typingsJapgolly.fusioncharts.fusionchartsStrings.xmlurl
  */
  trait ChartDataFormats extends StObject
  object ChartDataFormats {
    
    inline def csv: typingsJapgolly.fusioncharts.fusionchartsStrings.csv = "csv".asInstanceOf[typingsJapgolly.fusioncharts.fusionchartsStrings.csv]
    
    inline def json: typingsJapgolly.fusioncharts.fusionchartsStrings.json = "json".asInstanceOf[typingsJapgolly.fusioncharts.fusionchartsStrings.json]
    
    inline def jsonurl: typingsJapgolly.fusioncharts.fusionchartsStrings.jsonurl = "jsonurl".asInstanceOf[typingsJapgolly.fusioncharts.fusionchartsStrings.jsonurl]
    
    inline def xml: typingsJapgolly.fusioncharts.fusionchartsStrings.xml = "xml".asInstanceOf[typingsJapgolly.fusioncharts.fusionchartsStrings.xml]
    
    inline def xmlurl: typingsJapgolly.fusioncharts.fusionchartsStrings.xmlurl = "xmlurl".asInstanceOf[typingsJapgolly.fusioncharts.fusionchartsStrings.xmlurl]
  }
  ...
  trait DataStoreStatic
    ...
    var Operators: typingsJapgolly.fusioncharts.mod.Operators = js.native
  }
  ...
  object EventObject {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(cancelled = cancelled.asInstanceOf[js.Any], detachHandler = detachHandler.toJsFn, detached = detached.asInstanceOf[js.Any], eventId = eventId.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, prevented = prevented.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any], stopPropagation = stopPropagation.toJsFn)
    ...
    extension [Self <: EventObject](x: Self) {
      ...
      inline def setDetachHandler(value: Callback): Self = StObject.set(x, "detachHandler", value.toJsFn)
  ...
  trait FusionChartStatic
    ...
    var Utils: typingsJapgolly.fusioncharts.mod.Utils = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fusioncharts.fusionchartsStrings.left
    - typingsJapgolly.fusioncharts.fusionchartsStrings.right
    - typingsJapgolly.fusioncharts.fusionchartsStrings.middle
  */
  trait ImageHAlign extends StObject
  object ImageHAlign {
    
    inline def left: typingsJapgolly.fusioncharts.fusionchartsStrings.left = "left".asInstanceOf[typingsJapgolly.fusioncharts.fusionchartsStrings.left]
    
    inline def middle: typingsJapgolly.fusioncharts.fusionchartsStrings.middle = "middle".asInstanceOf[typingsJapgolly.fusioncharts.fusionchartsStrings.middle]
    
    inline def right: typingsJapgolly.fusioncharts.fusionchartsStrings.right = "right".asInstanceOf[typingsJapgolly.fusioncharts.fusionchartsStrings.right]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fusioncharts.fusionchartsStrings.top
    - typingsJapgolly.fusioncharts.fusionchartsStrings.bottom
    - typingsJapgolly.fusioncharts.fusionchartsStrings.middle
  */
  trait ImageVAlign extends StObject
  object ImageVAlign {
    
    inline def bottom: typingsJapgolly.fusioncharts.fusionchartsStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.fusioncharts.fusionchartsStrings.bottom]
    
    inline def middle: typingsJapgolly.fusioncharts.fusionchartsStrings.middle = "middle".asInstanceOf[typingsJapgolly.fusioncharts.fusionchartsStrings.middle]
    
    inline def top: typingsJapgolly.fusioncharts.fusionchartsStrings.top = "top".asInstanceOf[typingsJapgolly.fusioncharts.fusionchartsStrings.top]
  }
  ...
  trait Utils extends StObject {
    ...
    var DatetimeUnits: typingsJapgolly.fusioncharts.mod.DatetimeUnits = js.native
    
    var Weekdays: typingsJapgolly.fusioncharts.mod.Weekdays = js.native
