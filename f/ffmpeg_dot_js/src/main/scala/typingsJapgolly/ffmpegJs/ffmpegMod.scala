...
import typingsJapgolly.ffmpegJs.ffmpegMod.ffmpeg.Options
import typingsJapgolly.ffmpegJs.ffmpegMod.ffmpeg.Result
import typingsJapgolly.ffmpegJs.ffmpegMod.ffmpeg.Worker.OnMessageOptions
import typingsJapgolly.ffmpegJs.ffmpegMod.ffmpeg.Worker.PostMessageOptions
...
object ffmpegMod {
  ...
  open class Worker ()
    extends StObject
       with typingsJapgolly.ffmpegJs.ffmpegMod.ffmpeg.Worker {
  ...
  object ffmpeg {
    ...
    object Options {
      ...
      extension [Self <: Options](x: Self) {
        ...
        inline def setOnExit(value: /* code */ Any => Callback): Self = StObject.set(x, "onExit", js.Any.fromFunction1((t0: /* code */ Any) => value(t0).runNow()))
        
        inline def setOnExitUndefined: Self = StObject.set(x, "onExit", js.undefined)
        
        inline def setPrint(value: /* data */ Any => Callback): Self = StObject.set(x, "print", js.Any.fromFunction1((t0: /* data */ Any) => value(t0).runNow()))
        
        inline def setPrintErr(value: /* data */ Any => Callback): Self = StObject.set(x, "printErr", js.Any.fromFunction1((t0: /* data */ Any) => value(t0).runNow()))
        ...
        inline def setStdin(value: /* data */ Any => Callback): Self = StObject.set(x, "stdin", js.Any.fromFunction1((t0: /* data */ Any) => value(t0).runNow()))
    ...
    object Worker {
      ...
      inline def apply(
        ...
        terminate: Callback
      ): typingsJapgolly.ffmpegJs.ffmpegMod.ffmpeg.Worker = {
        ...
        __obj.asInstanceOf[typingsJapgolly.ffmpegJs.ffmpegMod.ffmpeg.Worker]
      }
      ...
      extension [Self <: typingsJapgolly.ffmpegJs.ffmpegMod.ffmpeg.Worker](x: Self) {
