...
object ISpringOptions {
  ...
  def apply(
    ...
    `type`: (/* dist */ js.Any, /* rMax */ js.Any) => CallbackTo[Double] = null
  ): ISpringOptions = {
    ...
    if (`type` != null) __obj.updateDynamic("type")(js.Any.fromFunction2((t0: /* dist */ js.Any, t1: /* rMax */ js.Any) => `type`(t0, t1).runNow()))
