...
trait Accountcountry extends StObject {
  
  @JSName("Account.country")
  var AccountDotcountry: String
  
  @JSName("Account.createdAt")
  var AccountDotcreatedAt: String
  
  @JSName("Account.parent_account_id")
  var AccountDotparent_account_id: Double
  ...
  var settlement_account: Any
  
  var settlement_cycle: Any
...
object Accountcountry {
  ...
  inline def apply(
    AccountDotcountry: String,
    AccountDotcreatedAt: String,
    AccountDotparent_account_id: Double,
    appfees: Double,
    bankcode: Any,
    chargeback: Double,
    chargeback_meta: Any,
    ...
    __obj.updateDynamic("Account.country")(AccountDotcountry.asInstanceOf[js.Any])
    __obj.updateDynamic("Account.createdAt")(AccountDotcreatedAt.asInstanceOf[js.Any])
    __obj.updateDynamic("Account.parent_account_id")(AccountDotparent_account_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[Accountcountry]
  }
  
  extension [Self <: Accountcountry](x: Self) {
    
    inline def setAccountDotcountry(value: String): Self = StObject.set(x, "Account.country", value.asInstanceOf[js.Any])
    
    inline def setAccountDotcreatedAt(value: String): Self = StObject.set(x, "Account.createdAt", value.asInstanceOf[js.Any])
    
    inline def setAccountDotparent_account_id(value: Double): Self = StObject.set(x, "Account.parent_account_id", value.asInstanceOf[js.Any])
    
    inline def setAppfees(value: Double): Self = StObject.set(x, "appfees", value.asInstanceOf[js.Any])
    
    inline def setBankcode(value: Any): Self = StObject.set(x, "bankcode", value.asInstanceOf[js.Any])
    ...
    inline def setFlagmessage(value: String): Self = StObject.set(x, "flagmessage", value.asInstanceOf[js.Any])
    ...
    inline def setIs_batch(value: Double): Self = StObject.set(x, "is_batch", value.asInstanceOf[js.Any])
    
    inline def setIs_local(value: Double): Self = StObject.set(x, "is_local", value.asInstanceOf[js.Any])
    
    inline def setMerchant_email(value: Any): Self = StObject.set(x, "merchant_email", value.asInstanceOf[js.Any])
    ...
    inline def setRefund_meta(value: Any): Self = StObject.set(x, "refund_meta", value.asInstanceOf[js.Any])
    
    inline def setSettlement_account(value: Any): Self = StObject.set(x, "settlement_account", value.asInstanceOf[js.Any])
    
    inline def setSettlement_cycle(value: Any): Self = StObject.set(x, "settlement_cycle", value.asInstanceOf[js.Any])
