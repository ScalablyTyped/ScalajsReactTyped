...
trait MobileMoneyFrancophoneRequest extends StObject {
  ...
  var is_mobile_money_franco: String
...
object MobileMoneyFrancophoneRequest {
  ...
  inline def apply(
    ...
    txRef: String,
    voucher: String
  ): MobileMoneyFrancophoneRequest = {
    val __obj = js.Dynamic.literal(amount = amount.asInstanceOf[js.Any], country = country.asInstanceOf[js.Any], currency = currency.asInstanceOf[js.Any], device_fingerprint = device_fingerprint.asInstanceOf[js.Any], email = email.asInstanceOf[js.Any], is_mobile_money_franco = is_mobile_money_franco.asInstanceOf[js.Any], network = network.asInstanceOf[js.Any], orderRef = orderRef.asInstanceOf[js.Any], payment_type = payment_type.asInstanceOf[js.Any], phonenumber = phonenumber.asInstanceOf[js.Any], txRef = txRef.asInstanceOf[js.Any], voucher = voucher.asInstanceOf[js.Any])
    __obj.asInstanceOf[MobileMoneyFrancophoneRequest]
  }
  
  extension [Self <: MobileMoneyFrancophoneRequest](x: Self) {
    ...
    inline def setIs_mobile_money_franco(value: String): Self = StObject.set(x, "is_mobile_money_franco", value.asInstanceOf[js.Any])
