...
trait MobileMoneyUgandaRequest extends StObject {
...
object MobileMoneyUgandaRequest {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[MobileMoneyUgandaRequest]
  }
  
  extension [Self <: MobileMoneyUgandaRequest](x: Self) {
