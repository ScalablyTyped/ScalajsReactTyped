...
trait MobileMoneyRwandaRequest extends StObject {
...
object MobileMoneyRwandaRequest {
  ...
  inline def apply(
    ...
    txRef: String,
    voucher: String
  ): MobileMoneyRwandaRequest = {
    val __obj = js.Dynamic.literal(amount = amount.asInstanceOf[js.Any], country = country.asInstanceOf[js.Any], currency = currency.asInstanceOf[js.Any], device_fingerprint = device_fingerprint.asInstanceOf[js.Any], email = email.asInstanceOf[js.Any], is_mobile_money_gh = is_mobile_money_gh.asInstanceOf[js.Any], network = network.asInstanceOf[js.Any], orderRef = orderRef.asInstanceOf[js.Any], payment_type = payment_type.asInstanceOf[js.Any], phonenumber = phonenumber.asInstanceOf[js.Any], txRef = txRef.asInstanceOf[js.Any], voucher = voucher.asInstanceOf[js.Any])
    __obj.asInstanceOf[MobileMoneyRwandaRequest]
  }
  
  extension [Self <: MobileMoneyRwandaRequest](x: Self) {
    ...
    inline def setIs_mobile_money_gh(value: String): Self = StObject.set(x, "is_mobile_money_gh", value.asInstanceOf[js.Any])
