package typingsJapgolly.functionalRedBlackTree
...
object mod {
  ...
  object Iterator {
    ...
    inline def apply[K, V](
      ...
      next: Callback,
      prev: Callback,
      remove: CallbackTo[Tree[K, V]],
      tree: Tree[K, V],
      update: V => Tree[K, V],
      valid: Boolean
    ): Iterator[K, V] = {
      val __obj = js.Dynamic.literal(hasNext = hasNext.asInstanceOf[js.Any], hasPrev = hasPrev.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any], next = next.toJsFn, prev = prev.toJsFn, remove = remove.toJsFn, tree = tree.asInstanceOf[js.Any], update = js.Any.fromFunction1(update), valid = valid.asInstanceOf[js.Any], node = null)
    ...
    extension [Self <: Iterator[?, ?], K, V](x: Self & (Iterator[K, V])) {
      ...
      inline def setRemove(value: CallbackTo[Tree[K, V]]): Self = StObject.set(x, "remove", value.toJsFn)
