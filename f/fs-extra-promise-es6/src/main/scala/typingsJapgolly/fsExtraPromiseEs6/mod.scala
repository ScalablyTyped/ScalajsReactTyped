...
import typingsJapgolly.fsExtraPromiseEs6.anon.AutoClose
import typingsJapgolly.fsExtraPromiseEs6.anon.Curr
import typingsJapgolly.fsExtraPromiseEs6.anon.Encoding
import typingsJapgolly.fsExtraPromiseEs6.anon.Interval
import typingsJapgolly.fsExtraPromiseEs6.anon.Persistent
...
object mod {
  ...
  object FSWatcher {
    ...
    inline def apply(close: Callback): FSWatcher = {
