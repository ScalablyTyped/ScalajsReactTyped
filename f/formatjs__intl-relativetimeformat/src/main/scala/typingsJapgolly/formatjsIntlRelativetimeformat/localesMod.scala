...
import typingsJapgolly.formatjsIntlRelativetimeformat.coreMod.IntlRelativeTimeFormatOptions
...
object localesMod extends js.Object {
  @js.native
  class default ()
    extends typingsJapgolly.formatjsIntlRelativetimeformat.coreMod.default {
