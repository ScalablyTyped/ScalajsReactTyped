...
object RelativeTimeFormat {
  ...
  def apply(
    ...
    __obj.updateDynamic("format")(js.Any.fromFunction2((t0: scala.Double, t1: typingsJapgolly.formatjsIntlRelativetimeformat.typesMod.FormattableUnit) => format(t0, t1).runNow()))
    __obj.updateDynamic("formatToParts")(js.Any.fromFunction2((t0: scala.Double, t1: typingsJapgolly.formatjsIntlRelativetimeformat.typesMod.FormattableUnit) => formatToParts(t0, t1).runNow()))
