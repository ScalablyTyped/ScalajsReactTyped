package typingsJapgolly.formatjsIntlRelativetimeformat

import typingsJapgolly.formatjsIntlRelativetimeformat.mod.FormattableUnit
import typingsJapgolly.formatjsIntlRelativetimeformat.mod.Unit
import typingsJapgolly.formatjsIntlRelativetimeformat.mod.Units
...
object formatjsIntlRelativetimeformatStrings {
  ...
  sealed trait day
    extends FormattableUnit
       with typingsJapgolly.formatjsIntlRelativetimeformat.typesMod.FormattableUnit
       with Unit
       with typingsJapgolly.formatjsIntlRelativetimeformat.typesMod.Unit
  ...
  sealed trait days
    extends FormattableUnit
       with typingsJapgolly.formatjsIntlRelativetimeformat.typesMod.FormattableUnit
       with Units
       with typingsJapgolly.formatjsIntlRelativetimeformat.typesMod.Units
