package typingsJapgolly.firebaseFunctions.serviceMod
...
import typingsJapgolly.firebaseFunctions.AnonDelete
...
class Service protected ()
  ...
  /* CompleteClass */
  override var app: typingsJapgolly.firebaseAppTypes.mod.FirebaseApp = js.native
