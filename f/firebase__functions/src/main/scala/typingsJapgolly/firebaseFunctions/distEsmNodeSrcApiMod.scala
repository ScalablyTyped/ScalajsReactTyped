...
import typingsJapgolly.firebaseFunctions.distEsmNodeSrcPublicTypesMod.Functions
...
object distEsmNodeSrcApiMod {
  
  @JSImport("@firebase/functions/dist/esm-node/src/api", JSImport.Namespace)
  @js.native
