...
import typingsJapgolly.firebaseFunctions.distEsmNodeSrcPublicTypesMod.FunctionsErrorCodeCore
import typingsJapgolly.firebaseFunctions.distEsmNodeSrcServiceMod.HttpResponseBody
import typingsJapgolly.firebaseUtil.mod.FirebaseError
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distEsmNodeSrcErrorMod {
  
  @JSImport("@firebase/functions/dist/esm-node/src/error", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/functions/dist/esm-node/src/error", "FunctionsError")
  @js.native
