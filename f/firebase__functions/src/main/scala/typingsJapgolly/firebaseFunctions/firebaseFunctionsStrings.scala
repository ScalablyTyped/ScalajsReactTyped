...
import typingsJapgolly.firebaseFunctions.distSrcPublicTypesMod.FunctionsErrorCodeCore
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object firebaseFunctionsStrings {
  
  @js.native
  sealed trait aborted
    extends StObject
       with FunctionsErrorCodeCore
       with typingsJapgolly.firebaseFunctions.mod.FunctionsErrorCodeCore
       with typingsJapgolly.firebaseFunctions.distEsmNodeSrcPublicTypesMod.FunctionsErrorCodeCore
       with typingsJapgolly.firebaseFunctions.distFunctionsMod.FunctionsErrorCodeCore
  ...
  @js.native
  sealed trait `messaging-internal` extends StObject
  inline def `messaging-internal`: `messaging-internal` = "messaging-internal".asInstanceOf[`messaging-internal`]
