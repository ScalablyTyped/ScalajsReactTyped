...
object mod {
  ...
  object Changes {
    ...
    inline def apply(
      add: (Container[Any], Double) => Callback,
      change: (Container[Any], Double, Double) => Callback,
      remove: (Container[Any], Double) => Callback
    ): Changes = {
      val __obj = js.Dynamic.literal(add = js.Any.fromFunction2((t0: Container[Any], t1: Double) => (add(t0, t1)).runNow()), change = js.Any.fromFunction3((t0: Container[Any], t1: Double, t2: Double) => (change(t0, t1, t2)).runNow()), remove = js.Any.fromFunction2((t0: Container[Any], t1: Double) => (remove(t0, t1)).runNow()))
      __obj.asInstanceOf[Changes]
    }
    
    extension [Self <: Changes](x: Self) {
      
      inline def setAdd(value: (Container[Any], Double) => Callback): Self = StObject.set(x, "add", js.Any.fromFunction2((t0: Container[Any], t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setChange(value: (Container[Any], Double, Double) => Callback): Self = StObject.set(x, "change", js.Any.fromFunction3((t0: Container[Any], t1: Double, t2: Double) => (value(t0, t1, t2)).runNow()))
      
      inline def setRemove(value: (Container[Any], Double) => Callback): Self = StObject.set(x, "remove", js.Any.fromFunction2((t0: Container[Any], t1: Double) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object Container {
    ...
    inline def apply[T](getStyles: CallbackTo[String], id: String): Container[T] = {
      val __obj = js.Dynamic.literal(getStyles = getStyles.toJsFn, id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[Container[T]]
    }
    
    extension [Self <: Container[?], T](x: Self & Container[T]) {
      
      inline def setGetStyles(value: CallbackTo[String]): Self = StObject.set(x, "getStyles", value.toJsFn)
