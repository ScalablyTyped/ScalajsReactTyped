...
object ITooltipOptions {
  ...
  extension [Self <: ITooltipOptions](x: Self) {
    ...
    inline def setTemplateClasses(value: String): Self = StObject.set(x, "templateClasses", value.asInstanceOf[js.Any])
    
    inline def setTemplateClassesUndefined: Self = StObject.set(x, "templateClasses", js.undefined)
    
    inline def setTemplateUndefined: Self = StObject.set(x, "template", js.undefined)
    
    inline def setTipText(value: String): Self = StObject.set(x, "tipText", value.asInstanceOf[js.Any])
    ...
    inline def setTriggerClassUndefined: Self = StObject.set(x, "triggerClass", js.undefined)
