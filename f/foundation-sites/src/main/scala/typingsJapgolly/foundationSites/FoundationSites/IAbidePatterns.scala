...
trait IAbidePatterns extends StObject {
  ...
  var website: js.UndefOr[Any] = js.undefined
}
object IAbidePatterns {
  
  inline def apply(): IAbidePatterns = {
  ...
  extension [Self <: IAbidePatterns](x: Self) {
    ...
    inline def setDay_month_year(value: js.RegExp): Self = StObject.set(x, "day_month_year", value.asInstanceOf[js.Any])
    
    inline def setDay_month_yearUndefined: Self = StObject.set(x, "day_month_year", js.undefined)
    ...
    inline def setWebsite(value: Any): Self = StObject.set(x, "website", value.asInstanceOf[js.Any])
