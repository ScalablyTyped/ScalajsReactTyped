...
object IOrbitOptions {
  ...
  inline def apply(): IOrbitOptions = {
  ...
  extension [Self <: IOrbitOptions](x: Self) {
    ...
    inline def setAnimInFromLeft(value: String): Self = StObject.set(x, "animInFromLeft", value.asInstanceOf[js.Any])
    
    inline def setAnimInFromLeftUndefined: Self = StObject.set(x, "animInFromLeft", js.undefined)
    
    inline def setAnimInFromRight(value: String): Self = StObject.set(x, "animInFromRight", value.asInstanceOf[js.Any])
    
    inline def setAnimInFromRightUndefined: Self = StObject.set(x, "animInFromRight", js.undefined)
    
    inline def setAnimOutToLeft(value: String): Self = StObject.set(x, "animOutToLeft", value.asInstanceOf[js.Any])
    
    inline def setAnimOutToLeftUndefined: Self = StObject.set(x, "animOutToLeft", js.undefined)
    
    inline def setAnimOutToRight(value: String): Self = StObject.set(x, "animOutToRight", value.asInstanceOf[js.Any])
    
    inline def setAnimOutToRightUndefined: Self = StObject.set(x, "animOutToRight", js.undefined)
    
    inline def setAutoPlay(value: Boolean): Self = StObject.set(x, "autoPlay", value.asInstanceOf[js.Any])
    
    inline def setAutoPlayUndefined: Self = StObject.set(x, "autoPlay", js.undefined)
    
    inline def setBoxOfBullets(value: String): Self = StObject.set(x, "boxOfBullets", value.asInstanceOf[js.Any])
    
    inline def setBoxOfBulletsUndefined: Self = StObject.set(x, "boxOfBullets", js.undefined)
    ...
    inline def setInfiniteWrap(value: Boolean): Self = StObject.set(x, "infiniteWrap", value.asInstanceOf[js.Any])
    
    inline def setInfiniteWrapUndefined: Self = StObject.set(x, "infiniteWrap", js.undefined)
    
    inline def setNavButtons(value: Boolean): Self = StObject.set(x, "navButtons", value.asInstanceOf[js.Any])
    
    inline def setNavButtonsUndefined: Self = StObject.set(x, "navButtons", js.undefined)
    ...
    inline def setTimerDelay(value: Double): Self = StObject.set(x, "timerDelay", value.asInstanceOf[js.Any])
    
    inline def setTimerDelayUndefined: Self = StObject.set(x, "timerDelay", js.undefined)
    
    inline def setUseMUI(value: Boolean): Self = StObject.set(x, "useMUI", value.asInstanceOf[js.Any])
    
    inline def setUseMUIUndefined: Self = StObject.set(x, "useMUI", js.undefined)
  }
}
