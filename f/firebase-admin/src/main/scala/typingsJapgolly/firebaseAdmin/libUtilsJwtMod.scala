...
object libUtilsJwtMod {
  ...
  object JwtErrorCode extends StObject {
    ...
    sealed trait INVALID_ARGUMENT
      extends StObject
         with JwtErrorCode
    /* "invalid-argument" */ val INVALID_ARGUMENT: typingsJapgolly.firebaseAdmin.libUtilsJwtMod.JwtErrorCode.INVALID_ARGUMENT & String = js.native
    
    @js.native
    sealed trait INVALID_CREDENTIAL
      extends StObject
         with JwtErrorCode
    /* "invalid-credential" */ val INVALID_CREDENTIAL: typingsJapgolly.firebaseAdmin.libUtilsJwtMod.JwtErrorCode.INVALID_CREDENTIAL & String = js.native
    
    @js.native
    sealed trait INVALID_SIGNATURE
      extends StObject
         with JwtErrorCode
    /* "invalid-token" */ val INVALID_SIGNATURE: typingsJapgolly.firebaseAdmin.libUtilsJwtMod.JwtErrorCode.INVALID_SIGNATURE & String = js.native
    
    @js.native
    sealed trait KEY_FETCH_ERROR
      extends StObject
         with JwtErrorCode
    /* "key-fetch-error" */ val KEY_FETCH_ERROR: typingsJapgolly.firebaseAdmin.libUtilsJwtMod.JwtErrorCode.KEY_FETCH_ERROR & String = js.native
    
    @js.native
    sealed trait NO_KID_IN_HEADER
      extends StObject
         with JwtErrorCode
    /* "no-kid-error" */ val NO_KID_IN_HEADER: typingsJapgolly.firebaseAdmin.libUtilsJwtMod.JwtErrorCode.NO_KID_IN_HEADER & String = js.native
    
    @js.native
    sealed trait NO_MATCHING_KID
      extends StObject
         with JwtErrorCode
    /* "no-matching-kid-error" */ val NO_MATCHING_KID: typingsJapgolly.firebaseAdmin.libUtilsJwtMod.JwtErrorCode.NO_MATCHING_KID & String = js.native
    
    @js.native
    sealed trait TOKEN_EXPIRED
      extends StObject
         with JwtErrorCode
    /* "token-expired" */ val TOKEN_EXPIRED: typingsJapgolly.firebaseAdmin.libUtilsJwtMod.JwtErrorCode.TOKEN_EXPIRED & String = js.native
  }
  ...
  object KeyFetcher {
    ...
    inline def apply(fetchPublicKeys: CallbackTo[js.Promise[StringDictionary[String]]]): KeyFetcher = {
      val __obj = js.Dynamic.literal(fetchPublicKeys = fetchPublicKeys.toJsFn)
      __obj.asInstanceOf[KeyFetcher]
    }
    
    extension [Self <: KeyFetcher](x: Self) {
      
      inline def setFetchPublicKeys(value: CallbackTo[js.Promise[StringDictionary[String]]]): Self = StObject.set(x, "fetchPublicKeys", value.toJsFn)
    }
  }
