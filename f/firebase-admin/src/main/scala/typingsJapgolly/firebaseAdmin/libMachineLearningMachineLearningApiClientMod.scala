...
import typingsJapgolly.firebaseAdmin.anon.AutomlModel
import typingsJapgolly.firebaseAdmin.anon.GcsTfliteUri
import typingsJapgolly.firebaseAdmin.anon.Published
import typingsJapgolly.firebaseAdmin.anon.SizeBytes
import typingsJapgolly.firebaseAdmin.anon.State
...
object libMachineLearningMachineLearningApiClientMod {
  ...
  - typingsJapgolly.firebaseAdmin.libMachineLearningMachineLearningApiClientMod.ModelOptions because Already inherited */ trait AutoMLTfliteModelOptions
    extends StObject
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.firebaseAdmin.libMachineLearningMachineLearningApiClientMod.ModelOptions because Already inherited */ trait GcsTfliteModelOptions
    extends StObject
       with ModelOptionsBase {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAdmin.libMachineLearningMachineLearningApiClientMod.ModelOptionsBase
    - typingsJapgolly.firebaseAdmin.libMachineLearningMachineLearningApiClientMod.GcsTfliteModelOptions
    - typingsJapgolly.firebaseAdmin.libMachineLearningMachineLearningApiClientMod.AutoMLTfliteModelOptions
  */
  trait ModelOptions extends StObject
  object ModelOptions {
    
    inline def AutoMLTfliteModelOptions(tfliteModel: AutomlModel): typingsJapgolly.firebaseAdmin.libMachineLearningMachineLearningApiClientMod.AutoMLTfliteModelOptions = {
      val __obj = js.Dynamic.literal(tfliteModel = tfliteModel.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAdmin.libMachineLearningMachineLearningApiClientMod.AutoMLTfliteModelOptions]
    }
    
    inline def GcsTfliteModelOptions(tfliteModel: GcsTfliteUri): typingsJapgolly.firebaseAdmin.libMachineLearningMachineLearningApiClientMod.GcsTfliteModelOptions = {
      val __obj = js.Dynamic.literal(tfliteModel = tfliteModel.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAdmin.libMachineLearningMachineLearningApiClientMod.GcsTfliteModelOptions]
    }
    
    inline def ModelOptionsBase(): typingsJapgolly.firebaseAdmin.libMachineLearningMachineLearningApiClientMod.ModelOptionsBase = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.firebaseAdmin.libMachineLearningMachineLearningApiClientMod.ModelOptionsBase]
    }
  }
