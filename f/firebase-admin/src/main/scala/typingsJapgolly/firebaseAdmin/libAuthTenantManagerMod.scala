...
import typingsJapgolly.firebaseAdmin.libAuthTenantMod.CreateTenantRequest
import typingsJapgolly.firebaseAdmin.libAuthTenantMod.Tenant
import typingsJapgolly.firebaseAdmin.libAuthTenantMod.UpdateTenantRequest
