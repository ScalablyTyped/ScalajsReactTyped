...
object libDatabaseDatabaseNamespaceMod {
  ...
  object database {
    ...
    /**
      ...
      */
    type ThenableReference = typingsJapgolly.firebaseDatabaseTypes.mod.ThenableReference
  }
}
