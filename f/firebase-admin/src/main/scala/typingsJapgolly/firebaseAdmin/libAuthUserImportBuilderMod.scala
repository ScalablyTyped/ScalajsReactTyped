...
import typingsJapgolly.firebaseAdmin.anon.Algorithm
import typingsJapgolly.firebaseAdmin.anon.DisplayName
import typingsJapgolly.firebaseAdmin.anon.Index
import typingsJapgolly.firebaseAdmin.libAppCoreMod.FirebaseArrayIndexError
import typingsJapgolly.firebaseAdmin.libAuthAuthConfigMod.MultiFactorUpdateSettings
import typingsJapgolly.firebaseAdmin.libAuthAuthConfigMod.UpdateMultiFactorInfoRequest
...
object libAuthUserImportBuilderMod {
  ...
  */
  ...
  object HashAlgorithmType {
    ...
    inline def BCRYPT: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.BCRYPT = "BCRYPT".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.BCRYPT]
    
    inline def HMAC_MD5: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.HMAC_MD5 = "HMAC_MD5".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.HMAC_MD5]
    
    inline def HMAC_SHA1: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.HMAC_SHA1 = "HMAC_SHA1".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.HMAC_SHA1]
    
    inline def HMAC_SHA256: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.HMAC_SHA256 = "HMAC_SHA256".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.HMAC_SHA256]
    
    inline def HMAC_SHA512: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.HMAC_SHA512 = "HMAC_SHA512".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.HMAC_SHA512]
    
    inline def MD5: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.MD5 = "MD5".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.MD5]
    
    inline def PBKDF2_SHA256: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PBKDF2_SHA256 = "PBKDF2_SHA256".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PBKDF2_SHA256]
    
    inline def PBKDF_SHA1: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PBKDF_SHA1 = "PBKDF_SHA1".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PBKDF_SHA1]
    
    inline def SCRYPT: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.SCRYPT = "SCRYPT".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.SCRYPT]
    
    inline def SHA1: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.SHA1 = "SHA1".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.SHA1]
    
    inline def SHA256: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.SHA256 = "SHA256".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.SHA256]
    
    inline def SHA512: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.SHA512 = "SHA512".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.SHA512]
    
    inline def STANDARD_SCRYPT: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.STANDARD_SCRYPT = "STANDARD_SCRYPT".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.STANDARD_SCRYPT]
  }
