...
import typingsJapgolly.firebaseAdmin.firebaseAdminStrings.ADMIN_SDK_NODE
import typingsJapgolly.firebaseAdmin.firebaseAdminStrings.CONSOLE
import typingsJapgolly.firebaseAdmin.firebaseAdminStrings.FORCED_UPDATE
import typingsJapgolly.firebaseAdmin.firebaseAdminStrings.INCREMENTAL_UPDATE
import typingsJapgolly.firebaseAdmin.firebaseAdminStrings.REMOTE_CONFIG_UPDATE_ORIGIN_UNSPECIFIED
import typingsJapgolly.firebaseAdmin.firebaseAdminStrings.REMOTE_CONFIG_UPDATE_TYPE_UNSPECIFIED
import typingsJapgolly.firebaseAdmin.firebaseAdminStrings.REST_API
import typingsJapgolly.firebaseAdmin.firebaseAdminStrings.ROLLBACK
...
object libRemoteConfigRemoteConfigApiMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.STRING
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.BOOLEAN
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.NUMBER
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.JSON
  */
  trait ParameterValueType extends StObject
  object ParameterValueType {
    
    inline def BOOLEAN: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.BOOLEAN = "BOOLEAN".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.BOOLEAN]
    
    inline def JSON: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.JSON = "JSON".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.JSON]
    
    inline def NUMBER: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.NUMBER = "NUMBER".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.NUMBER]
    
    inline def STRING: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.STRING = "STRING".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.STRING]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAdmin.libRemoteConfigRemoteConfigApiMod.ExplicitParameterValue
    - typingsJapgolly.firebaseAdmin.libRemoteConfigRemoteConfigApiMod.InAppDefaultValue
  */
  trait RemoteConfigParameterValue extends StObject
  object RemoteConfigParameterValue {
    
    inline def ExplicitParameterValue(value: String): typingsJapgolly.firebaseAdmin.libRemoteConfigRemoteConfigApiMod.ExplicitParameterValue = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAdmin.libRemoteConfigRemoteConfigApiMod.ExplicitParameterValue]
    }
    
    inline def InAppDefaultValue(useInAppDefault: Boolean): typingsJapgolly.firebaseAdmin.libRemoteConfigRemoteConfigApiMod.InAppDefaultValue = {
      val __obj = js.Dynamic.literal(useInAppDefault = useInAppDefault.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAdmin.libRemoteConfigRemoteConfigApiMod.InAppDefaultValue]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.BLUE
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.BROWN
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.CYAN
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.DEEP_ORANGE
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.GREEN
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.INDIGO
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.LIME
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.ORANGE
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PINK
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PURPLE
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.TEAL
  */
  trait TagColor extends StObject
  object TagColor {
    
    inline def BLUE: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.BLUE = "BLUE".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.BLUE]
    
    inline def BROWN: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.BROWN = "BROWN".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.BROWN]
    
    inline def CYAN: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.CYAN = "CYAN".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.CYAN]
    
    inline def DEEP_ORANGE: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.DEEP_ORANGE = "DEEP_ORANGE".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.DEEP_ORANGE]
    
    inline def GREEN: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.GREEN = "GREEN".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.GREEN]
    
    inline def INDIGO: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.INDIGO = "INDIGO".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.INDIGO]
    
    inline def LIME: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.LIME = "LIME".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.LIME]
    
    inline def ORANGE: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.ORANGE = "ORANGE".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.ORANGE]
    
    inline def PINK: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PINK = "PINK".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PINK]
    
    inline def PURPLE: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PURPLE = "PURPLE".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PURPLE]
    
    inline def TEAL: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.TEAL = "TEAL".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.TEAL]
  }
