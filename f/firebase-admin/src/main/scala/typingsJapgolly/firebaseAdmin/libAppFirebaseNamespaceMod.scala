...
import typingsJapgolly.firebaseAdmin.anon.ApplicationDefault
...
import typingsJapgolly.firebaseAdmin.libAppLifecycleMod.AppStore
...
import typingsJapgolly.firebaseAdmin.libFirebaseNamespaceApiMod.firestore.Firestore
