...
object libUtilsApiRequestMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.GET
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.POST
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PUT
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.DELETE
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PATCH
    - typingsJapgolly.firebaseAdmin.firebaseAdminStrings.HEAD
  */
  trait HttpMethod extends StObject
  object HttpMethod {
    
    inline def DELETE: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.DELETE = "DELETE".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.DELETE]
    
    inline def GET: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.GET = "GET".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.GET]
    
    inline def HEAD: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.HEAD = "HEAD".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.HEAD]
    
    inline def PATCH: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PATCH = "PATCH".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PATCH]
    
    inline def POST: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.POST = "POST".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.POST]
    
    inline def PUT: typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PUT = "PUT".asInstanceOf[typingsJapgolly.firebaseAdmin.firebaseAdminStrings.PUT]
  }
  ...
  object HttpResponse {
    ...
    inline def apply(headers: Any, isJson: CallbackTo[Boolean], status: Double): HttpResponse = {
      val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], isJson = isJson.toJsFn, status = status.asInstanceOf[js.Any])
    ...
    extension [Self <: HttpResponse](x: Self) {
      ...
      inline def setIsJson(value: CallbackTo[Boolean]): Self = StObject.set(x, "isJson", value.toJsFn)
