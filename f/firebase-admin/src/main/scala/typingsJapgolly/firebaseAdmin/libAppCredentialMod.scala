...
object libAppCredentialMod {
  ...
  object Credential {
    ...
    inline def apply(getAccessToken: CallbackTo[js.Promise[GoogleOAuthAccessToken]]): Credential = {
    ...
    extension [Self <: Credential](x: Self) {
      ...
      inline def setGetAccessToken(value: CallbackTo[js.Promise[GoogleOAuthAccessToken]]): Self = StObject.set(x, "getAccessToken", value.toJsFn)
    }
  }
