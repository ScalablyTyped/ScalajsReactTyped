...
import typingsJapgolly.firebaseAdmin.firebaseAdminStrings.sha1_
import typingsJapgolly.firebaseAdmin.firebaseAdminStrings.sha256_
import typingsJapgolly.firebaseAdmin.libProjectManagementAppMetadataMod.AppMetadata
import typingsJapgolly.firebaseAdmin.libProjectManagementAppMetadataMod.AppPlatform.ANDROID
