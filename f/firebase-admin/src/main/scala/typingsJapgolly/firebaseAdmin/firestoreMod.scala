...
object firestoreMod {
  ...
  /* private */ open class FieldValue ()
    extends typingsJapgolly.firebaseAdmin.libFirestoreMod.FieldValue
  /* static members */
  object FieldValue {
  ...
  open class Firestore ()
    extends typingsJapgolly.firebaseAdmin.libFirestoreMod.Firestore {
  ...
  open class GeoPoint protected ()
    extends typingsJapgolly.firebaseAdmin.libFirestoreMod.GeoPoint {
    /**
  ...
  /* protected */ open class Query[T] ()
    extends typingsJapgolly.firebaseAdmin.libFirestoreMod.Query[T]
  
  @JSImport("firebase-admin/firestore", "QueryDocumentSnapshot")
  @js.native
  /* private */ open class QueryDocumentSnapshot[T] ()
    extends typingsJapgolly.firebaseAdmin.libFirestoreMod.QueryDocumentSnapshot[T]
  
  @JSImport("firebase-admin/firestore", "QueryPartition")
  @js.native
  /* private */ open class QueryPartition[T] ()
    extends typingsJapgolly.firebaseAdmin.libFirestoreMod.QueryPartition[T]
  
  @JSImport("firebase-admin/firestore", "QuerySnapshot")
  @js.native
  /* private */ open class QuerySnapshot[T] ()
    extends typingsJapgolly.firebaseAdmin.libFirestoreMod.QuerySnapshot[T]
  
  @JSImport("firebase-admin/firestore", "Timestamp")
  @js.native
  open class Timestamp protected ()
    extends typingsJapgolly.firebaseAdmin.libFirestoreMod.Timestamp {
    /**
  ...
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseAdmin.libFirestoreMod.Transaction
  
  @JSImport("firebase-admin/firestore", "WriteBatch")
  @js.native
  /* private */ open class WriteBatch ()
    extends typingsJapgolly.firebaseAdmin.libFirestoreMod.WriteBatch
  
  @JSImport("firebase-admin/firestore", "WriteResult")
  @js.native
  /* private */ open class WriteResult ()
    extends typingsJapgolly.firebaseAdmin.libFirestoreMod.WriteResult
