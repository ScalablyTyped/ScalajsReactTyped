...
object libAppCoreMod {
  ...
  object FirebaseError {
    ...
    inline def apply(code: String, message: String, toJSON: CallbackTo[js.Object]): FirebaseError = {
      val __obj = js.Dynamic.literal(code = code.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], toJSON = toJSON.toJsFn)
