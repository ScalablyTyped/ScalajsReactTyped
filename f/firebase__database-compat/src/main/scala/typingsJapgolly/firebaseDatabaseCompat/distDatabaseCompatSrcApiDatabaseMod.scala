...
import typingsJapgolly.firebaseDatabaseCompat.anon.Delete
import typingsJapgolly.firebaseDatabaseCompat.anon.Increment
import typingsJapgolly.firebaseDatabaseCompat.anon.MockUserToken
import typingsJapgolly.firebaseDatabaseCompat.distDatabaseCompatSrcApiReferenceMod.Reference
...
object distDatabaseCompatSrcApiDatabaseMod {
  ...
  open class Database protected ()
    extends StObject
       ...
       with Compat[typingsJapgolly.firebaseDatabase.mod.Database] {
    /**
    ...
    /* CompleteClass */
    var _delegate: typingsJapgolly.firebaseDatabase.mod.Database = js.native
