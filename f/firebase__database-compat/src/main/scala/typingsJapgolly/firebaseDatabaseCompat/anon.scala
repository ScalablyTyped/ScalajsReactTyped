...
import typingsJapgolly.firebaseDatabaseCompat.distDatabaseCompatSrcApiReferenceMod.Query
...
object anon {
  ...
  trait Call extends StObject {
    ...
    def apply(app: typingsJapgolly.firebaseDatabaseCompat.mod.firebaseAppCompatAugmentingMod.FirebaseApp): FirebaseDatabase = js.native
  ...
  trait DataSnapshot extends StObject {
    ...
    var DataSnapshot: Instantiable2[
        ...
        typingsJapgolly.firebaseDatabaseCompat.distDatabaseCompatSrcApiReferenceMod.DataSnapshot
      ]
    ...
    var Reference: Instantiable2[
        ...
        typingsJapgolly.firebaseDatabaseCompat.distDatabaseCompatSrcApiReferenceMod.Reference
      ]
  ...
  trait Database extends StObject {
    ...
    def apply(): FirebaseDatabase = js.native
    def apply(app: typingsJapgolly.firebaseDatabaseCompat.appCompatMod.FirebaseApp): FirebaseDatabase = js.native
  ...
  object Delete {
    ...
    inline def apply(delete: CallbackTo[js.Promise[Unit]], forceLongPolling: Callback, forceWebSockets: Callback): Delete = {
      val __obj = js.Dynamic.literal(delete = delete.toJsFn, forceLongPolling = forceLongPolling.toJsFn, forceWebSockets = forceWebSockets.toJsFn)
  ...
  trait Instance[T] extends StObject {
    ...
    var instance: typingsJapgolly.firebaseDatabaseTypes.mod.Database
    
    var namespace: T
  }
  object Instance {
    
    inline def apply[T](instance: typingsJapgolly.firebaseDatabaseTypes.mod.Database, namespace: T): Instance[T] = {
    ...
    extension [Self <: Instance[?], T](x: Self & Instance[T]) {
      ...
      inline def setInstance(value: typingsJapgolly.firebaseDatabaseTypes.mod.Database): Self = StObject.set(x, "instance", value.asInstanceOf[js.Any])
  ...
  object Namespace {
    ...
    inline def apply(instance: typingsJapgolly.firebaseDatabaseTypes.mod.Database, namespace: DataSnapshot): Namespace = {
      val __obj = js.Dynamic.literal(instance = instance.asInstanceOf[js.Any], namespace = namespace.asInstanceOf[js.Any])
  ...
  trait TypeofDatabase
    extends StObject
       with Instantiable2[
          /* _delegate */ typingsJapgolly.firebaseDatabase.mod.Database, 
          /* app */ FirebaseApp, 
          typingsJapgolly.firebaseDatabaseCompat.distDatabaseCompatSrcApiDatabaseMod.Database
        ] {
