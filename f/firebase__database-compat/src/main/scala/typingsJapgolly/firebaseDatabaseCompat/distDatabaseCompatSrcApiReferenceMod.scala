...
import typingsJapgolly.firebaseDatabaseCompat.anon.FnCallOnfulfilledOnrejected
import typingsJapgolly.firebaseDatabaseCompat.anon.FnCallOnrejected
import typingsJapgolly.firebaseDatabaseCompat.distDatabaseCompatSrcApiDatabaseMod.Database
import typingsJapgolly.firebaseDatabaseCompat.distDatabaseCompatSrcApiOnDisconnectMod.OnDisconnect
import typingsJapgolly.firebaseDatabaseCompat.distDatabaseCompatSrcApiTransactionResultMod.TransactionResult
...
object distDatabaseCompatSrcApiReferenceMod {
  ...
  open class DataSnapshot protected ()
    extends StObject
       with Compat[typingsJapgolly.firebaseDatabase.mod.DataSnapshot] {
    def this(_database: Database, _delegate: typingsJapgolly.firebaseDatabase.mod.DataSnapshot) = this()
    
    val _database: Database = js.native
    
    /* CompleteClass */
    var _delegate: typingsJapgolly.firebaseDatabase.mod.DataSnapshot = js.native
