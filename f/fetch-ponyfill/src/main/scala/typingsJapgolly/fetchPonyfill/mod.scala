...
import typingsJapgolly.fetchPonyfill.anon.FnCall
import typingsJapgolly.fetchPonyfill.anon.TypeofDOMException
import typingsJapgolly.fetchPonyfill.anon.TypeofResponse
