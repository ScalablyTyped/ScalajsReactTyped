...
import typingsJapgolly.feathersjsFeathers.anon.PartialHookMap
import typingsJapgolly.feathersjsFeathers.anon.PartialHooksObject
import typingsJapgolly.feathersjsFeathers.anon.PartialServiceMethodsanyS
import typingsJapgolly.feathersjsFeathers.anon.PickPaginationOptionsmax
import typingsJapgolly.feathersjsFeathers.feathersjsFeathersBooleans.`false`
import typingsJapgolly.feathersjsFeathers.feathersjsFeathersStrings.__feathersSkipHooks
import typingsJapgolly.feathersjsFeathers.feathersjsFeathersStrings.after
import typingsJapgolly.feathersjsFeathers.feathersjsFeathersStrings.before
import typingsJapgolly.feathersjsFeathers.feathersjsFeathersStrings.error
...
object mod extends Shortcut {
  ...
  trait Service[T]
    ...
    override def create(data: js.Array[Partial[T]]): js.Promise[js.Array[T]] & (js.Promise[T | js.Array[T]]) = js.native
    /* InferMemberOverrides */
    override def create(data: js.Array[Partial[T]], params: Params): js.Promise[js.Array[T]] & (js.Promise[T | js.Array[T]]) = js.native
    /* InferMemberOverrides */
    override def create(data: Partial[T]): js.Promise[T] & (js.Promise[T | js.Array[T]]) = js.native
    /* InferMemberOverrides */
    override def create(data: Partial[T], params: Params): js.Promise[T] & (js.Promise[T | js.Array[T]]) = js.native
    
    /* InferMemberOverrides */
    override def patch(id: NullableId, data: Pick[T, /* keyof T */ String]): js.Promise[T] = js.native
    /* InferMemberOverrides */
    override def patch(id: NullableId, data: Pick[T, /* keyof T */ String], params: Params): js.Promise[T] = js.native
  }
  ...
  object SetupMethod {
    ...
    inline def apply(setup: (Application[Any], String) => Callback): SetupMethod = {
      val __obj = js.Dynamic.literal(setup = js.Any.fromFunction2((t0: Application[Any], t1: String) => (setup(t0, t1)).runNow()))
      __obj.asInstanceOf[SetupMethod]
    }
    
    extension [Self <: SetupMethod](x: Self) {
      
      inline def setSetup(value: (Application[Any], String) => Callback): Self = StObject.set(x, "setup", js.Any.fromFunction2((t0: Application[Any], t1: String) => (value(t0, t1)).runNow()))
    }
  }
