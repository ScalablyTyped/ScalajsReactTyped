...
import typingsJapgolly.formatjsIcuMessageformatParser.libErrorMod.ParserError
...
object libParserMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.formatjsIcuMessageformatParser.anon.Err[T]
    - typingsJapgolly.formatjsIcuMessageformatParser.anon.Val[E]
  */
  trait Result[T, E] extends StObject
  object Result {
    
    inline def Err[T](err: Null, `val`: T): typingsJapgolly.formatjsIcuMessageformatParser.anon.Err[T] = {
      val __obj = js.Dynamic.literal(err = err.asInstanceOf[js.Any])
      __obj.updateDynamic("val")(`val`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.formatjsIcuMessageformatParser.anon.Err[T]]
    }
    
    inline def Val[E](err: E, `val`: Null): typingsJapgolly.formatjsIcuMessageformatParser.anon.Val[E] = {
      val __obj = js.Dynamic.literal(err = err.asInstanceOf[js.Any])
      __obj.updateDynamic("val")(`val`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.formatjsIcuMessageformatParser.anon.Val[E]]
    }
  }
}
