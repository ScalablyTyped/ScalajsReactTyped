...
import typingsJapgolly.formatjsIcuMessageformatParser.typesMod._ValidPluralRule
...
object formatjsIcuMessageformatParserStrings {
  ...
  sealed trait few
    extends StObject
       ...
       with typingsJapgolly.formatjsIcuMessageformatParser.libTypesMod._ValidPluralRule
