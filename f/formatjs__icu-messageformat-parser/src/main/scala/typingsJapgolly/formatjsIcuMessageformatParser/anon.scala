...
import typingsJapgolly.formatjsIcuMessageformatParser.parserMod.Result
...
object anon {
  ...
  trait Err[T]
    extends StObject
       with Result[T, Any]
       with typingsJapgolly.formatjsIcuMessageformatParser.libParserMod.Result[T, Any] {
  ...
  trait Val[E]
    extends StObject
       with Result[Any, E]
       with typingsJapgolly.formatjsIcuMessageformatParser.libParserMod.Result[Any, E] {
