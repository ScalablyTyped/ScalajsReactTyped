...
import typingsJapgolly.formatjsIcuMessageformatParser.libParserMod.ParserOptions
...
object libMod {
  ...
  open class Parser protected ()
    extends typingsJapgolly.formatjsIcuMessageformatParser.libParserMod.Parser {
  ...
  val Parser: Instantiable2[
    ...
    typingsJapgolly.formatjsIcuMessageformatParser.libParserMod.Parser
  ] = js.native
