package typingsJapgolly.forceGraph

import org.scalablytyped.runtime.StringDictionary
import org.scalajs.dom.CanvasRenderingContext2D
import org.scalajs.dom.HTMLElement
import org.scalajs.dom.MouseEvent
import typingsJapgolly.forceGraph.anon.K
import typingsJapgolly.forceGraph.anon.X
import typingsJapgolly.forceGraph.anon.Y
import typingsJapgolly.forceGraph.forceGraphStrings.center
import typingsJapgolly.forceGraph.forceGraphStrings.charge
import typingsJapgolly.forceGraph.forceGraphStrings.link
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.forceGraph.forceGraphStrings.replace
    - typingsJapgolly.forceGraph.forceGraphStrings.before
    - typingsJapgolly.forceGraph.forceGraphStrings.after
  */
  trait CanvasCustomRenderMode extends StObject
  object CanvasCustomRenderMode {
    
    inline def after: typingsJapgolly.forceGraph.forceGraphStrings.after = "after".asInstanceOf[typingsJapgolly.forceGraph.forceGraphStrings.after]
    
    inline def before: typingsJapgolly.forceGraph.forceGraphStrings.before = "before".asInstanceOf[typingsJapgolly.forceGraph.forceGraphStrings.before]
    
    inline def replace: typingsJapgolly.forceGraph.forceGraphStrings.replace = "replace".asInstanceOf[typingsJapgolly.forceGraph.forceGraphStrings.replace]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.forceGraph.forceGraphStrings.td
    - typingsJapgolly.forceGraph.forceGraphStrings.bu
    - typingsJapgolly.forceGraph.forceGraphStrings.lr
    - typingsJapgolly.forceGraph.forceGraphStrings.rl
    - typingsJapgolly.forceGraph.forceGraphStrings.radialout
    - typingsJapgolly.forceGraph.forceGraphStrings.radialin
  */
  trait DagMode extends StObject
  object DagMode {
    
    inline def bu: typingsJapgolly.forceGraph.forceGraphStrings.bu = "bu".asInstanceOf[typingsJapgolly.forceGraph.forceGraphStrings.bu]
    
    inline def lr: typingsJapgolly.forceGraph.forceGraphStrings.lr = "lr".asInstanceOf[typingsJapgolly.forceGraph.forceGraphStrings.lr]
    
    inline def radialin: typingsJapgolly.forceGraph.forceGraphStrings.radialin = "radialin".asInstanceOf[typingsJapgolly.forceGraph.forceGraphStrings.radialin]
    
    inline def radialout: typingsJapgolly.forceGraph.forceGraphStrings.radialout = "radialout".asInstanceOf[typingsJapgolly.forceGraph.forceGraphStrings.radialout]
    
    inline def rl: typingsJapgolly.forceGraph.forceGraphStrings.rl = "rl".asInstanceOf[typingsJapgolly.forceGraph.forceGraphStrings.rl]
    
    inline def td: typingsJapgolly.forceGraph.forceGraphStrings.td = "td".asInstanceOf[typingsJapgolly.forceGraph.forceGraphStrings.td]
  }
