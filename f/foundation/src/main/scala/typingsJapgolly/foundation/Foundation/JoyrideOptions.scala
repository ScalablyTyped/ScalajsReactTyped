...
import typingsJapgolly.foundation.AnonBottom
import typingsJapgolly.foundation.AnonButton
...
object JoyrideOptions {
  ...
  def apply(
    ...
    post_expose_callback: js.UndefOr[Callback] = js.undefined,
    post_ride_callback: js.UndefOr[Callback] = js.undefined,
    post_step_callback: js.UndefOr[Callback] = js.undefined,
    pre_ride_callback: js.UndefOr[Callback] = js.undefined,
    pre_step_callback: js.UndefOr[Callback] = js.undefined,
    ...
    post_expose_callback.foreach(p => __obj.updateDynamic("post_expose_callback")(p.toJsFn))
    post_ride_callback.foreach(p => __obj.updateDynamic("post_ride_callback")(p.toJsFn))
    post_step_callback.foreach(p => __obj.updateDynamic("post_step_callback")(p.toJsFn))
    pre_ride_callback.foreach(p => __obj.updateDynamic("pre_ride_callback")(p.toJsFn))
    pre_step_callback.foreach(p => __obj.updateDynamic("pre_step_callback")(p.toJsFn))
