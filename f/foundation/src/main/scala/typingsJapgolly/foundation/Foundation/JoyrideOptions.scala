...
import typingsJapgolly.foundation.anon.Bottom
import typingsJapgolly.foundation.anon.Button
...
object JoyrideOptions {
  ...
  extension [Self <: JoyrideOptions](x: Self) {
    ...
    inline def setPost_expose_callback(value: Callback): Self = StObject.set(x, "post_expose_callback", value.toJsFn)
    
    inline def setPost_expose_callbackUndefined: Self = StObject.set(x, "post_expose_callback", js.undefined)
    
    inline def setPost_ride_callback(value: Callback): Self = StObject.set(x, "post_ride_callback", value.toJsFn)
    
    inline def setPost_ride_callbackUndefined: Self = StObject.set(x, "post_ride_callback", js.undefined)
    
    inline def setPost_step_callback(value: Callback): Self = StObject.set(x, "post_step_callback", value.toJsFn)
    
    inline def setPost_step_callbackUndefined: Self = StObject.set(x, "post_step_callback", js.undefined)
    
    inline def setPre_ride_callback(value: Callback): Self = StObject.set(x, "pre_ride_callback", value.toJsFn)
    
    inline def setPre_ride_callbackUndefined: Self = StObject.set(x, "pre_ride_callback", js.undefined)
    
    inline def setPre_step_callback(value: Callback): Self = StObject.set(x, "pre_step_callback", value.toJsFn)
