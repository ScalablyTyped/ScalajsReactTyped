...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcDirectionalIndexByteEncoderMod.DirectionalIndexByteEncoder
...
object distLitePackagesFirestoreSrcFirestoreIndexValueWriterMod {
