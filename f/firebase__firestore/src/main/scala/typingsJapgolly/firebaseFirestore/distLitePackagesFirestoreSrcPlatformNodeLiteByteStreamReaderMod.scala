...
object distLitePackagesFirestoreSrcPlatformNodeLiteByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/node_lite/byte_stream_reader", JSImport.Namespace)
  @js.native
