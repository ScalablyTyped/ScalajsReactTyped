...
object distLitePackagesFirestoreSrcLocalMemoryIndexManagerMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/memory_index_manager", "MemoryCollectionParentIndex")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/memory_index_manager", "MemoryIndexManager")
  @js.native
