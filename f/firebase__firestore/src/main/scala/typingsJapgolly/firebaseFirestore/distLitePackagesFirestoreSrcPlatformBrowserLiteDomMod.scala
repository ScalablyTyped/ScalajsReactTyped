...
object distLitePackagesFirestoreSrcPlatformBrowserLiteDomMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/browser_lite/dom", JSImport.Namespace)
  @js.native
