...
object distPackagesFirestoreSrcRemoteNumberSerializerMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/remote/number_serializer", JSImport.Namespace)
  @js.native
