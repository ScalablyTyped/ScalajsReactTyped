...
object distLiteFirestoreSrcLiteApiTypesMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * You'll have to cast your way around this structure, unfortunately. 
    * TS definition: {{{
    V extends std.Record<string, unknown> ? @firebase/firestore.@firebase/firestore/dist/lite/firestore/src/lite-api/types.AddPrefixToKeys<K, @firebase/firestore.@firebase/firestore/dist/lite/firestore/src/lite-api/reference.UpdateData<V>> : never
    }}}
    */
  @js.native
