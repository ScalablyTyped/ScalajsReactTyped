...
object distPackagesFirestoreSrcApiMod {
  ...
  open class AbstractUserDataWriter ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLiteApiUserDataWriterMod.AbstractUserDataWriter
  ...
  /* private */ open class ByteString ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcUtilByteStringMod.ByteString
  /* static members */
  object ByteString {
  ...
  open class Bytes protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiBytesMod.Bytes {
    /** @hideconstructor */
  ...
  open class CollectionReference[T] protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiReferenceMod.CollectionReference[T] {
    def this(
  ...
  open class DatabaseId protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreDatabaseInfoMod.DatabaseId {
  ...
  open class DocumentKey protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelDocumentKeyMod.DocumentKey {
  ...
  open class DocumentReference[T] protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiReferenceMod.DocumentReference[T] {
    def this(
      firestore: typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLiteApiDatabaseMod.Firestore,
      /**
  ...
  open class DocumentSnapshot[T] protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiSnapshotMod.DocumentSnapshot[T] {
    def this(
  ...
  open class EmptyAppCheckTokenProvider ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiCredentialsMod.EmptyAppCheckTokenProvider
  ...
  open class EmptyAuthCredentialsProvider ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiCredentialsMod.EmptyAuthCredentialsProvider
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api", "FieldPath")
  @js.native
  open class FieldPath protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiFieldPathMod.FieldPath {
    /**
  ...
  open class FieldValue protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiFieldValueMod.FieldValue {
    /**
  ...
  open class Firestore protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiDatabaseMod.Firestore {
    /** @hideconstructor */
    def this(
  ...
  open class GeoPoint protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiGeoPointMod.GeoPoint {
    /**
  ...
  open class LoadBundleTask ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiBundleMod.LoadBundleTask
  ...
  open class QueryConstraint ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiFilterMod.QueryConstraint
  ...
  open class QueryDocumentSnapshot[T] protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiSnapshotMod.QueryDocumentSnapshot[T] {
    def this(
      _firestore: typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiDatabaseMod.Firestore,
      userDataWriter: typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLiteApiUserDataWriterMod.AbstractUserDataWriter,
      key: typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelDocumentKeyMod.DocumentKey,
  ...
  open class QuerySnapshot[T] protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiSnapshotMod.QuerySnapshot[T] {
    /** @hideconstructor */
    def this(
      _firestore: typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiDatabaseMod.Firestore,
  ...
  open class Query_[T] protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiReferenceMod.Query[T] {
    def this(
      firestore: typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLiteApiDatabaseMod.Firestore,
      /**
      * If provided, the `FirestoreDataConverter` associated with this instance.
  ...
  open class ResourcePath ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelPathMod.ResourcePath
  /* static members */
  object ResourcePath {
  ...
  open class SnapshotMetadata protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiSnapshotMod.SnapshotMetadata {
    /** @hideconstructor */
  ...
  open class Timestamp protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiTimestampMod.Timestamp {
    /**
  ...
  open class Transaction protected ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiTransactionMod.Transaction {
    /** @hideconstructor */
    def this(
      _firestore: typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiDatabaseMod.Firestore,
  ...
  open class _FieldPath ()
    extends typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelPathMod.FieldPath
  /* static members */
  object _FieldPath {
