package typingsJapgolly.firebaseFirestore.platformPlatformMod
...
object Platform {
  ...
  def apply(
    ...
    __obj.updateDynamic("loadConnection")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.coreDatabaseInfoMod.DatabaseInfo) => loadConnection(t0).runNow()))
    __obj.updateDynamic("newConnectivityMonitor")(newConnectivityMonitor.toJsFn)
    __obj.updateDynamic("newSerializer")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.coreDatabaseInfoMod.DatabaseId) => newSerializer(t0).runNow()))
