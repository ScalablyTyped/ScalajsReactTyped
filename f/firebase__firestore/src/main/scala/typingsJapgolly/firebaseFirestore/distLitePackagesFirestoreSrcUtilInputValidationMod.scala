...
object distLitePackagesFirestoreSrcUtilInputValidationMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/util/input_validation", JSImport.Namespace)
  @js.native
