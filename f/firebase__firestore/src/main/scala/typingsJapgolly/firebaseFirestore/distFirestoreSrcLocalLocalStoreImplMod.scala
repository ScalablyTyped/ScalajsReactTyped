...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreBundleMod.BundledDocuments
...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcLocalLocalViewChangesMod.LocalViewChanges
...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcLocalQueryEngineMod.QueryEngine
...
object distFirestoreSrcLocalLocalStoreImplMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/local/local_store_impl", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/local/local_store_impl", "LOG_TAG")
  @js.native
