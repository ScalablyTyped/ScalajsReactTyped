...
object distPackagesFirestoreSrcLiteApiReferenceMod {
  ...
  open class Query[T] protected () extends StObject {
    ...
    val _query: typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreQueryMod.Query = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.firebaseFirestore.anon.`44`
  */
  trait SetOptions extends StObject
  object SetOptions {
    
    inline def `44`(): typingsJapgolly.firebaseFirestore.anon.`44` = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.firebaseFirestore.anon.`44`]
    }
