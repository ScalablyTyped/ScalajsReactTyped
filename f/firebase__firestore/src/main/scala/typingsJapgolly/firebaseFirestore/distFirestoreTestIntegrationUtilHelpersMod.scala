...
import typingsJapgolly.firebaseFirestore.distFirestoreTestIntegrationUtilFirebaseExportMod.CollectionReference
import typingsJapgolly.firebaseFirestore.distFirestoreTestIntegrationUtilFirebaseExportMod.DocumentReference
import typingsJapgolly.firebaseFirestore.distFirestoreTestIntegrationUtilFirebaseExportMod.Firestore
import typingsJapgolly.firebaseFirestore.distFirestoreTestIntegrationUtilFirebaseExportMod.QuerySnapshot
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distFirestoreTestIntegrationUtilHelpersMod {
  
  @JSImport("@firebase/firestore/dist/firestore/test/integration/util/helpers", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/test/integration/util/helpers", "apiDescribe")
  @js.native
