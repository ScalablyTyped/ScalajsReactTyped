...
trait FromCache extends StObject {
  ...
  var errorCode: js.UndefOr[typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcUtilErrorMod.Code] = js.undefined
...
object FromCache {
  ...
  extension [Self <: FromCache](x: Self) {
    ...
    inline def setErrorCode(value: typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcUtilErrorMod.Code): Self = StObject.set(x, "errorCode", value.asInstanceOf[js.Any])
