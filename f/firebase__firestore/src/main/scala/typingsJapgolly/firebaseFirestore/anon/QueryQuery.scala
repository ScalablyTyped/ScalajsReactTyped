...
trait QueryQuery extends StObject {
  ...
  var query: typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreQueryMod.Query
...
object QueryQuery {
  ...
  inline def apply(query: typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreQueryMod.Query): QueryQuery = {
  ...
  extension [Self <: QueryQuery](x: Self) {
    ...
    inline def setQuery(value: typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreQueryMod.Query): Self = StObject.set(x, "query", value.asInstanceOf[js.Any])
