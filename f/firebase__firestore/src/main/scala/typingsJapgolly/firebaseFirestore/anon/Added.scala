...
trait Added extends StObject {
  ...
  var errorCode: js.UndefOr[typingsJapgolly.firebaseFirestore.distFirestoreSrcUtilErrorMod.Code] = js.undefined
...
object Added {
  ...
  extension [Self <: Added](x: Self) {
    ...
    inline def setErrorCode(value: typingsJapgolly.firebaseFirestore.distFirestoreSrcUtilErrorMod.Code): Self = StObject.set(x, "errorCode", value.asInstanceOf[js.Any])
