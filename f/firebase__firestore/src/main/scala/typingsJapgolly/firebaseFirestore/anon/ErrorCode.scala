...
trait ErrorCode extends StObject {
  ...
  var errorCode: js.UndefOr[typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcUtilErrorMod.Code] = js.undefined
...
object ErrorCode {
  ...
  extension [Self <: ErrorCode](x: Self) {
    ...
    inline def setErrorCode(value: typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcUtilErrorMod.Code): Self = StObject.set(x, "errorCode", value.asInstanceOf[js.Any])
