...
trait HasPendingWrites extends StObject {
  ...
  var errorCode: js.UndefOr[typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcUtilErrorMod.Code] = js.undefined
...
object HasPendingWrites {
  ...
  extension [Self <: HasPendingWrites](x: Self) {
    ...
    inline def setErrorCode(value: typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcUtilErrorMod.Code): Self = StObject.set(x, "errorCode", value.asInstanceOf[js.Any])
