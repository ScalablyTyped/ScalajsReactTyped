...
import typingsJapgolly.firebaseFirestore.anon.Added
import typingsJapgolly.firebaseFirestore.anon.Affects
import typingsJapgolly.firebaseFirestore.anon.Config
import typingsJapgolly.firebaseFirestore.anon.ExpectUserCallback
import typingsJapgolly.firebaseFirestore.anon.Query
import typingsJapgolly.firebaseFirestore.anon.ReadTime
...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcUtilAsyncQueueMod.TimerId
...
import typingsJapgolly.firebaseFirestore.distFirestoreTestUnitSpecsSpecRpcErrorMod.RpcError
import typingsJapgolly.firebaseFirestore.distFirestoreTestUnitSpecsSpecTestRunnerMod.PersistenceAction
import typingsJapgolly.firebaseFirestore.distFirestoreTestUnitSpecsSpecTestRunnerMod.SpecConfig
import typingsJapgolly.firebaseFirestore.distFirestoreTestUnitSpecsSpecTestRunnerMod.SpecQuery
import typingsJapgolly.firebaseFirestore.distFirestoreTestUnitSpecsSpecTestRunnerMod.SpecStep
...
object distFirestoreTestUnitSpecsSpecBuilderMod {
  ...
  open class SpecBuilder () extends StObject {
    ...
    def expectEvents(query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query, events: Added): this.type = js.native
    ...
    def expectListen(query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query): this.type = js.native
    def expectListen(query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query, resume: ReadTime): this.type = js.native
    ...
    def expectUnlisten(query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query): this.type = js.native
    ...
    /**
      ...
      * stream disconnect.
      */
    def restoreListen(query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query, resumeToken: String): this.type = js.native
    ...
    def userListens(query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query): this.type = js.native
    def userListens(query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query, resume: ReadTime): this.type = js.native
    ...
    def userUnlistens(query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query): this.type = js.native
    
    def waitForPendingWrites(): this.type = js.native
    
    def watchAcks(query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query): this.type = js.native
    ...
    def watchCurrents(query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query, resumeToken: String): this.type = js.native
    
    def watchFilters(
      queries: js.Array[typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query],
      docs: DocumentKey*
    ): this.type = js.native
    
    def watchRemoves(query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query): this.type = js.native
    def watchRemoves(query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query, cause: RpcError): this.type = js.native
    
    def watchRemovesDoc(key: DocumentKey, targets: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query*): this.type = js.native
    ...
    def watchResets(queries: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query*): this.type = js.native
    ...
    def watchSnapshots(
      version: TestSnapshotVersion,
      targets: js.Array[typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query]
    ): this.type = js.native
    def watchSnapshots(
      version: TestSnapshotVersion,
      targets: js.Array[typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query],
