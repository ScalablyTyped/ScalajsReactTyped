...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcCoreViewSnapshotMod.ChangeType
...
object distLitePackagesFirestoreSrcApiSnapshotMod {
  ...
  */
  ...
  trait FirestoreDataConverter[T]
    extends StObject
       with typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiSnapshotMod.FirestoreDataConverter[T] {
