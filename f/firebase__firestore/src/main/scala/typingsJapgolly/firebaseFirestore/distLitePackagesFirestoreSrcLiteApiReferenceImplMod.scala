...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiReferenceMod.CollectionReference
...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiSnapshotMod.QuerySnapshot
...
object distLitePackagesFirestoreSrcLiteApiReferenceImplMod {
  ...
  inline def setDoc[T](
    ...
    options: typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiReferenceMod.SetOptions
