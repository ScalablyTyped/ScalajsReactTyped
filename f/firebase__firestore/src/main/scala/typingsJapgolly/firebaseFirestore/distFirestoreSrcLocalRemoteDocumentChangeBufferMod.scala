...
object distFirestoreSrcLocalRemoteDocumentChangeBufferMod {
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src/local/remote_document_change_buffer", "RemoteDocumentChangeBuffer")
  @js.native
