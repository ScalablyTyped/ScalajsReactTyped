...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcRemoteBackoffMod.ExponentialBackoff
...
object distPackagesFirestoreSrcRemotePersistentStreamMod {
  ...
  open class PersistentWriteStream protected ()
    extends PersistentStream[
          typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcProtosFirestoreProtoApiMod.WriteRequest, 
          WriteResponse, 
          WriteStreamListener
        ] {
    def this(
  ...
  trait WriteRequest
    extends StObject
       with typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcProtosFirestoreProtoApiMod.firestoreV1ApiClientInterfaces.WriteRequest {
