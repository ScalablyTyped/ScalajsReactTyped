...
object distPackagesFirestoreSrcRemoteConnectivityMonitorNoopMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/remote/connectivity_monitor_noop", "NoopConnectivityMonitor")
  @js.native
