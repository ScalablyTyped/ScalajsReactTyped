...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcRemoteBackoffMod.ExponentialBackoff
...
object distLitePackagesFirestoreSrcRemotePersistentStreamMod {
  ...
  open class PersistentWriteStream protected ()
    extends PersistentStream[
          typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.WriteRequest, 
          WriteResponse, 
          WriteStreamListener
        ] {
    def this(
  ...
  trait WriteRequest
    extends StObject
       with typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.firestoreV1ApiClientInterfaces.WriteRequest {
