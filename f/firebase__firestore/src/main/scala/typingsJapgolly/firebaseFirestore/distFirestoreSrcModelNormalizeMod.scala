...
import typingsJapgolly.firebaseFirestore.anon.Nanos
...
object distFirestoreSrcModelNormalizeMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/model/normalize", JSImport.Namespace)
  @js.native
