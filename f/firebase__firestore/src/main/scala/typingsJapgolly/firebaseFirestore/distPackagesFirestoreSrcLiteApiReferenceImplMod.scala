...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLiteApiSnapshotMod.QuerySnapshot
...
object distPackagesFirestoreSrcLiteApiReferenceImplMod {
  ...
  inline def setDoc[T](
    ...
    options: typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLiteApiReferenceMod.SetOptions
