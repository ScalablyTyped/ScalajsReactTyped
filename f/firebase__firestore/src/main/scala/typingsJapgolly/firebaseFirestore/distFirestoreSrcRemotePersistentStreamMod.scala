...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcRemoteBackoffMod.ExponentialBackoff
import typingsJapgolly.firebaseFirestore.distFirestoreSrcRemoteConnectionMod.Connection
import typingsJapgolly.firebaseFirestore.distFirestoreSrcRemoteConnectionMod.Stream
...
object distFirestoreSrcRemotePersistentStreamMod {
  ...
  open class PersistentWriteStream protected ()
    extends PersistentStream[
          typingsJapgolly.firebaseFirestore.distFirestoreSrcProtosFirestoreProtoApiMod.WriteRequest, 
          WriteResponse, 
          WriteStreamListener
        ] {
    def this(
  ...
  trait WriteRequest
    extends StObject
       with typingsJapgolly.firebaseFirestore.distFirestoreSrcProtosFirestoreProtoApiMod.firestoreV1ApiClientInterfaces.WriteRequest {
