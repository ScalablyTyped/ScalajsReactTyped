...
object distLiteFirestoreSrcPlatformByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/byte_stream_reader", JSImport.Namespace)
  @js.native
