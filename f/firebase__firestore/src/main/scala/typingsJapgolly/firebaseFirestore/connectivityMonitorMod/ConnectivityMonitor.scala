package typingsJapgolly.firebaseFirestore.connectivityMonitorMod
...
object ConnectivityMonitor {
  ...
  def apply(addCallback: ConnectivityMonitorCallback => Callback, shutdown: Callback): ConnectivityMonitor = {
    ...
    __obj.updateDynamic("addCallback")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.connectivityMonitorMod.ConnectivityMonitorCallback) => addCallback(t0).runNow()))
