...
object CredentialsProvider {
  ...
  def apply(
    ...
    __obj.updateDynamic("setChangeListener")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.credentialsMod.CredentialChangeListener) => setChangeListener(t0).runNow()))
