...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLocalPersistenceMod.ReferenceDelegate
...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLocalPersistenceTransactionMod.PersistenceTransactionMode
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLocalRemoteDocumentCacheMod.RemoteDocumentCache
...
object distPackagesFirestoreSrcLocalMemoryPersistenceMod {
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/memory_persistence", "MemoryLruDelegate")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/memory_persistence", "MemoryTransaction")
  @js.native
  ...
  object MemoryReferenceDelegate {
    ...
    extension [Self <: MemoryReferenceDelegate](x: Self) {
      ...
      inline def setOnTransactionStarted(value: Callback): Self = StObject.set(x, "onTransactionStarted", value.toJsFn)
    }
  }
}
