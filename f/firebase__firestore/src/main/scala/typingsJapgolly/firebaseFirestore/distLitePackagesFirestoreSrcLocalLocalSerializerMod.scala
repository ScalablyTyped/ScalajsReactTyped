...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSchemaMod.DbBundle
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSchemaMod.DbDocumentOverlay
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSchemaMod.DbIndexConfiguration
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSchemaMod.DbIndexState
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSchemaMod.DbMutationBatch
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSchemaMod.DbNamedQuery
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSchemaMod.DbRemoteDocument
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSchemaMod.DbTarget
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSchemaMod.DbTimestamp
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSentinelsMod.DbDocumentOverlayKey
...
object distLitePackagesFirestoreSrcLocalLocalSerializerMod {
  ...
  inline def fromBundleMetadata(metadata: BundleMetadata): typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcCoreBundleMod.BundleMetadata = ^.asInstanceOf[js.Dynamic].applyDynamic("fromBundleMetadata")(metadata.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcCoreBundleMod.BundleMetadata]
  ...
  inline def fromDbBundle(dbBundle: DbBundle): typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcCoreBundleMod.BundleMetadata = ^.asInstanceOf[js.Dynamic].applyDynamic("fromDbBundle")(dbBundle.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcCoreBundleMod.BundleMetadata]
  ...
  inline def fromProtoNamedQuery(
    namedQuery: typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreBundleProtoMod.NamedQuery
