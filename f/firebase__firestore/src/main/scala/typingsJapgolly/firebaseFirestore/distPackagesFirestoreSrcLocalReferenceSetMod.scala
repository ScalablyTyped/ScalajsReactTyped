...
object distPackagesFirestoreSrcLocalReferenceSetMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/reference_set", "DocReference")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/local/reference_set", "ReferenceSet")
  @js.native
