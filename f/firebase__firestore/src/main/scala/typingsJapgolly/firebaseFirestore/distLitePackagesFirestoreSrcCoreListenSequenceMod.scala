...
object distLitePackagesFirestoreSrcCoreListenSequenceMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/listen_sequence", "ListenSequence")
  @js.native
  ...
  object ListenSequence {
    ...
    @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/listen_sequence", "ListenSequence.INVALID")
    @js.native
