...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcLocalIndexeddbLruDelegateImplMod.IndexedDbLruDelegateImpl
...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcLocalPersistenceMod.PrimaryStateListener
...
object distLiteFirestoreSrcLocalIndexeddbPersistenceMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/local/indexeddb_persistence", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/local/indexeddb_persistence", "IndexedDbPersistence")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/local/indexeddb_persistence", "MAIN_DATABASE")
  @js.native
