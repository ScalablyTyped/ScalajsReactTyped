...
object distLiteFirestoreSrcPlatformRnLiteConnectionMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/rn_lite/connection", JSImport.Namespace)
  @js.native
