...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreViewSnapshotMod.ChangeType
...
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.estimate
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.none
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.previous
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distFirestoreSrcApiSnapshotMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/api/snapshot", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/api/snapshot", "DocumentSnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api/snapshot", "QueryDocumentSnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api/snapshot", "QuerySnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/api/snapshot", "SnapshotMetadata")
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.added
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.removed
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.modified
  */
  trait DocumentChangeType extends StObject
  object DocumentChangeType {
    
    inline def added: typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.added = "added".asInstanceOf[typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.added]
    
    inline def modified: typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.modified = "modified".asInstanceOf[typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.modified]
    
    inline def removed: typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.removed = "removed".asInstanceOf[typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.removed]
  }
  
  @js.native
  trait FirestoreDataConverter[T]
    extends StObject
       with typingsJapgolly.firebaseFirestore.distFirestoreSrcLiteApiSnapshotMod.FirestoreDataConverter[T] {
