...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcLocalLocalDocumentsViewMod.LocalDocumentsView
...
object distFirestoreSrcLocalQueryEngineMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/local/query_engine", "QueryEngine")
  @js.native
