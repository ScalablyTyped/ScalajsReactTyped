package typingsJapgolly.firebaseFirestore.localIndexManagerMod
...
object IndexManager {
  ...
  def apply(
    ...
    __obj.updateDynamic("addToCollectionParentIndex")(js.Any.fromFunction2((t0: typingsJapgolly.firebaseFirestore.localPersistenceMod.PersistenceTransaction, t1: typingsJapgolly.firebaseFirestore.modelPathMod.ResourcePath) => addToCollectionParentIndex(t0, t1).runNow()))
    __obj.updateDynamic("getCollectionParents")(js.Any.fromFunction2((t0: typingsJapgolly.firebaseFirestore.localPersistenceMod.PersistenceTransaction, t1: java.lang.String) => getCollectionParents(t0, t1).runNow()))
