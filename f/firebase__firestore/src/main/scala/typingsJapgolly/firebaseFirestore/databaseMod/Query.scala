...
class Query[T] protected ()
  ...
  def this(_query: typingsJapgolly.firebaseFirestore.queryMod.Query, firestore: Firestore) = this()
  def this(
    _query: typingsJapgolly.firebaseFirestore.queryMod.Query,
    firestore: Firestore,
    _converter: FirestoreDataConverter[T]
  ) = this()
  val _converter: js.UndefOr[FirestoreDataConverter[T]] = js.native
  var _query: typingsJapgolly.firebaseFirestore.queryMod.Query = js.native
