...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.firebaseFirestore.apiCredentialsMod.FirstPartyCredentialsSettings
  - typingsJapgolly.firebaseFirestore.apiCredentialsMod.ProviderCredentialsSettings
*/
