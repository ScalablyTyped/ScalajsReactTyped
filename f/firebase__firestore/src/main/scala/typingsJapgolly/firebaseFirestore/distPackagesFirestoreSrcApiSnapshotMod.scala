...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreViewSnapshotMod.ChangeType
...
object distPackagesFirestoreSrcApiSnapshotMod {
  ...
  */
  ...
  trait FirestoreDataConverter[T]
    extends StObject
       with typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLiteApiSnapshotMod.FirestoreDataConverter[T] {
