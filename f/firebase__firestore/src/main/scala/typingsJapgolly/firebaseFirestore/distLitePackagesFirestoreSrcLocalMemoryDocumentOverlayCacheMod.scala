...
object distLitePackagesFirestoreSrcLocalMemoryDocumentOverlayCacheMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/memory_document_overlay_cache", "MemoryDocumentOverlayCache")
  @js.native
