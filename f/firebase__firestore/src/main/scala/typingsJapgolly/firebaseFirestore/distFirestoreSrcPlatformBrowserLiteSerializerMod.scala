...
object distFirestoreSrcPlatformBrowserLiteSerializerMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/platform/browser_lite/serializer", JSImport.Namespace)
  @js.native
