...
object ITargetChangeTargetChangeTypeEnum {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(ADD = ADD.asInstanceOf[js.Any], CURRENT = CURRENT.asInstanceOf[js.Any], NO_CHANGE = NO_CHANGE.asInstanceOf[js.Any], REMOVE = REMOVE.asInstanceOf[js.Any], RESET = RESET.asInstanceOf[js.Any], values = values.toJsFn)
  ...
  extension [Self <: ITargetChangeTargetChangeTypeEnum](x: Self) {
    ...
    inline def setValues(value: CallbackTo[js.Array[TargetChangeTargetChangeType]]): Self = StObject.set(x, "values", value.toJsFn)
  }
}
