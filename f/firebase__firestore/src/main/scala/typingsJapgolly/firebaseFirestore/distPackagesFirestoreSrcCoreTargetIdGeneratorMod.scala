...
object distPackagesFirestoreSrcCoreTargetIdGeneratorMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/core/target_id_generator", "TargetIdGenerator")
  @js.native
