...
import typingsJapgolly.firebaseFirestore.anon.`54`
import typingsJapgolly.firebaseFirestore.anon.`55`
import typingsJapgolly.firebaseFirestore.anon.`56`
import typingsJapgolly.firebaseFirestore.anon.`57`
import typingsJapgolly.firebaseFirestore.distPrivateMod.^
...
type MapValue = typingsJapgolly.firebaseFirestore.distPrivateMod.firestoreV1ApiClientInterfaces.MapValue
...
type StructuredQuery = typingsJapgolly.firebaseFirestore.distPrivateMod.firestoreV1ApiClientInterfaces.StructuredQuery
...
type Value = typingsJapgolly.firebaseFirestore.distPrivateMod.firestoreV1ApiClientInterfaces.Value
