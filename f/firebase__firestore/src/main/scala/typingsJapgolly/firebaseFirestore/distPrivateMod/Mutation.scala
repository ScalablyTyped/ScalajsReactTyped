...
trait Mutation extends StObject {
  ...
  val key: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any
...
object Mutation {
  ...
  inline def apply(
    ...
    getFieldMask: CallbackTo[FieldMask | Null],
    key: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any,
    precondition: Precondition,
    `type`: MutationType
  ): Mutation = {
    val __obj = js.Dynamic.literal(fieldTransforms = fieldTransforms.asInstanceOf[js.Any], getFieldMask = getFieldMask.toJsFn, key = key.asInstanceOf[js.Any], precondition = precondition.asInstanceOf[js.Any])
  ...
  extension [Self <: Mutation](x: Self) {
    ...
    inline def setGetFieldMask(value: CallbackTo[FieldMask | Null]): Self = StObject.set(x, "getFieldMask", value.toJsFn)
