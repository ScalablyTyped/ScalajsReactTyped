...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.firebaseFirestore.anon.`53`
*/
trait SetOptions extends StObject
object SetOptions {
  
  inline def `53`(): typingsJapgolly.firebaseFirestore.anon.`53` = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[typingsJapgolly.firebaseFirestore.anon.`53`]
  }
