...
trait MutationQueue extends StObject {
  ...
  /**
    ...
    * convenient.
    */
  def getAllMutationBatchesAffectingDocumentKeys(
    transaction: PersistenceTransaction,
  ...
  /**
    ...
    * need to match).
    */
  def getAllMutationBatchesAffectingQuery(transaction: PersistenceTransaction, query: Query2): PersistencePromise[js.Array[MutationBatch]]
...
object MutationQueue {
  ...
  inline def apply(
    ...
    getAllMutationBatchesAffectingDocumentKey: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any) => PersistencePromise[js.Array[MutationBatch]],
    getAllMutationBatchesAffectingDocumentKeys: (PersistenceTransaction, SortedMap[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any, 
      Any
    ]) => PersistencePromise[js.Array[MutationBatch]],
    getAllMutationBatchesAffectingQuery: (PersistenceTransaction, Query2) => PersistencePromise[js.Array[MutationBatch]],
  ...
  extension [Self <: MutationQueue](x: Self) {
    ...
    inline def setGetAllMutationBatchesAffectingDocumentKey(
      value: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any) => PersistencePromise[js.Array[MutationBatch]]
    ): Self = StObject.set(x, "getAllMutationBatchesAffectingDocumentKey", js.Any.fromFunction2(value))
    
    inline def setGetAllMutationBatchesAffectingDocumentKeys(
      value: (PersistenceTransaction, SortedMap[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any, 
          Any
        ]) => PersistencePromise[js.Array[MutationBatch]]
    ): Self = StObject.set(x, "getAllMutationBatchesAffectingDocumentKeys", js.Any.fromFunction2(value))
    
    inline def setGetAllMutationBatchesAffectingQuery(value: (PersistenceTransaction, Query2) => PersistencePromise[js.Array[MutationBatch]]): Self = StObject.set(x, "getAllMutationBatchesAffectingQuery", js.Any.fromFunction2(value))
