...
object DocumentOverlayCache {
  ...
  inline def apply(
    getOverlay: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any) => PersistencePromise[Overlay | Null],
    getOverlays: (PersistenceTransaction, js.Array[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any
    ]) => PersistencePromise[OverlayMap],
    getOverlaysForCollection: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _ResourcePath */ Any, Double) => PersistencePromise[OverlayMap],
  ...
  extension [Self <: DocumentOverlayCache](x: Self) {
    ...
    ): Self = StObject.set(x, "getOverlay", js.Any.fromFunction2(value))
    
    inline def setGetOverlays(
      value: (PersistenceTransaction, js.Array[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _DocumentKey */ Any
        ]) => PersistencePromise[OverlayMap]
    ): Self = StObject.set(x, "getOverlays", js.Any.fromFunction2(value))
    
    inline def setGetOverlaysForCollection(
      value: (PersistenceTransaction, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify _ResourcePath */ Any, Double) => PersistencePromise[OverlayMap]
    ): Self = StObject.set(x, "getOverlaysForCollection", js.Any.fromFunction3(value))
