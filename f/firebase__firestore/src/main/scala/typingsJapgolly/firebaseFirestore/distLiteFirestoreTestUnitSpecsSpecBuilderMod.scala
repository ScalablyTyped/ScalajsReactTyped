...
import typingsJapgolly.firebaseFirestore.anon.AffectsRemoved
import typingsJapgolly.firebaseFirestore.anon.ErrorCode
import typingsJapgolly.firebaseFirestore.anon.ExpectUserCallback
import typingsJapgolly.firebaseFirestore.anon.QueryReadTime
import typingsJapgolly.firebaseFirestore.anon.ResumeToken
import typingsJapgolly.firebaseFirestore.anon.RunBackoffTimer
import typingsJapgolly.firebaseFirestore.anon.Steps
...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcCoreTargetIdGeneratorMod.TargetIdGenerator
...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcModelObjectValueMod.JsonObject
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcUtilAsyncQueueMod.TimerId
...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreTestUnitSpecsSpecRpcErrorMod.RpcError
...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreTestUnitSpecsSpecTestRunnerMod.SpecQuery
...
object distLiteFirestoreTestUnitSpecsSpecBuilderMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/test/unit/specs/spec_builder", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/test/unit/specs/spec_builder", "ClientMemoryState")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/test/unit/specs/spec_builder", "MultiClientSpecBuilder")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/test/unit/specs/spec_builder", "SpecBuilder")
  @js.native
  open class SpecBuilder () extends StObject {
    ...
    def expectActiveTargets(targets: QueryReadTime*): this.type = js.native
    ...
    def expectListen(query: Query, resume: ResumeToken): this.type = js.native
    ...
    def userListens(query: Query, resume: ResumeToken): this.type = js.native
    ...
    def watchSends(targets: AffectsRemoved, docs: Document*): this.type = js.native
  ...
  object SpecBuilder {
    ...
    @JSImport("@firebase/firestore/dist/lite/firestore/test/unit/specs/spec_builder", "SpecBuilder.docToSpec")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/lite/firestore/test/unit/specs/spec_builder", "SpecBuilder.keyToSpec")
    @js.native
    ...
    @JSImport("@firebase/firestore/dist/lite/firestore/test/unit/specs/spec_builder", "SpecBuilder.queryToSpec")
    @js.native
