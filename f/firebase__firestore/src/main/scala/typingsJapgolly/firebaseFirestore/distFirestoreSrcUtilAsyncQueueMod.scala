...
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.all
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.async_queue_retry
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.client_metadata_refresh
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.health_check_timeout
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.index_backfill
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.listen_stream_connection_backoff
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.listen_stream_idle
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.lru_garbage_collection
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.online_state_timeout
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.transaction_retry
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.write_stream_connection_backoff
import typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.write_stream_idle
import typingsJapgolly.std.PromiseLike
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distFirestoreSrcUtilAsyncQueueMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/util/async_queue", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/util/async_queue", "DelayedOperation")
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.all
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.listen_stream_idle
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.listen_stream_connection_backoff
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.write_stream_idle
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.write_stream_connection_backoff
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.health_check_timeout
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.online_state_timeout
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.client_metadata_refresh
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.lru_garbage_collection
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.transaction_retry
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.async_queue_retry
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreStrings.index_backfill
  */
