...
object distLitePackagesFirestoreSrcCoreSnapshotVersionMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/core/snapshot_version", "SnapshotVersion")
  @js.native
