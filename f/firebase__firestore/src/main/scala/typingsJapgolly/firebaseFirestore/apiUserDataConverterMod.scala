...
import typingsJapgolly.firebaseFirestore.modelMutationMod.FieldTransform
...
@JSImport("@firebase/firestore/dist/src/api/user_data_converter", JSImport.Namespace)
@js.native
object apiUserDataConverterMod extends js.Object {
  @js.native
  ...
  class UserDataConverter protected () extends js.Object {
    ...
    def parseUpdateVarargs(
      methodName: String,
      field: typingsJapgolly.firebaseFirestore.apiFieldPathMod.FieldPath,
      value: js.Any,
      moreFieldsAndValues: js.Array[_]
    ): ParsedUpdateData = js.native
  }
  
  def fieldPathFromArgument(methodName: String, path: String): typingsJapgolly.firebaseFirestore.modelPathMod.FieldPath = js.native
  def fieldPathFromArgument(methodName: String, path: typingsJapgolly.firebaseFirestore.apiFieldPathMod.FieldPath): typingsJapgolly.firebaseFirestore.modelPathMod.FieldPath = js.native
