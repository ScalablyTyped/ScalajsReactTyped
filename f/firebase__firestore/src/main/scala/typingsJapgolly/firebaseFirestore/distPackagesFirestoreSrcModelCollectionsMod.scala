...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLocalOverlayedDocumentMod.OverlayedDocument
...
object distPackagesFirestoreSrcModelCollectionsMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/collections", JSImport.Namespace)
  @js.native
