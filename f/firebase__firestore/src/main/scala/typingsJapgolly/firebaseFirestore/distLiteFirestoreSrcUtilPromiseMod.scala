...
object distLiteFirestoreSrcUtilPromiseMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/util/promise", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/util/promise", "Deferred")
  @js.native
