...
object distFirestoreSrcLocalMemoryPersistenceMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/local/memory_persistence", "MemoryEagerDelegate")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/local/memory_persistence", "MemoryLruDelegate")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/local/memory_persistence", "MemoryPersistence")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/local/memory_persistence", "MemoryTransaction")
  @js.native
