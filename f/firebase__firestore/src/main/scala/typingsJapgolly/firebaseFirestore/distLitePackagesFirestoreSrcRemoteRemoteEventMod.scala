...
object distLitePackagesFirestoreSrcRemoteRemoteEventMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/remote/remote_event", "RemoteEvent")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/remote/remote_event", "TargetChange")
  @js.native
