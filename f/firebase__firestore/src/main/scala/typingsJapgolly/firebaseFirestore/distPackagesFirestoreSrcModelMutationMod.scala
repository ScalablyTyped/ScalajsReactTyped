...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelTransformOperationMod.TransformOperation
...
object distPackagesFirestoreSrcModelMutationMod {
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/packages/firestore/src/model/mutation", "Mutation")
  @js.native
