...
import typingsJapgolly.firebaseFirestore.anon.ValueValue
...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelTypeOrderMod.TypeOrder
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcProtosFirestoreProtoApiMod.ArrayValue
...
object distPackagesFirestoreSrcModelValuesMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/values", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/values", "MAX_VALUE")
  @js.native
  val MAX_VALUE: Value = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/values", "MIN_VALUE")
  @js.native
  ...
  inline def isArray(): /* is @firebase/firestore.anon.48 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArray")().asInstanceOf[/* is @firebase/firestore.anon.48 */ Boolean]
  inline def isArray(value: Value): /* is @firebase/firestore.anon.48 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArray")(value.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/firestore.anon.48 */ Boolean]
  ...
  inline def isMapValue(): /* is @firebase/firestore.anon.47 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMapValue")().asInstanceOf[/* is @firebase/firestore.anon.47 */ Boolean]
  inline def isMapValue(value: Value): /* is @firebase/firestore.anon.47 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMapValue")(value.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/firestore.anon.47 */ Boolean]
  ...
  inline def isNanValue(): /* is @firebase/firestore.anon.3 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNanValue")().asInstanceOf[/* is @firebase/firestore.anon.3 */ Boolean]
  inline def isNanValue(value: Value): /* is @firebase/firestore.anon.3 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNanValue")(value.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/firestore.anon.3 */ Boolean]
  ...
  inline def lowerBoundCompare(left: ValueValue, right: ValueValue): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("lowerBoundCompare")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def upperBoundCompare(left: ValueValue, right: ValueValue): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("upperBoundCompare")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Double]
