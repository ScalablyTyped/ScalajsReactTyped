...
object LruDelegate {
  ...
  def apply(
    ...
    __obj.updateDynamic("forEachOrphanedDocumentSequenceNumber")(js.Any.fromFunction2((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: js.Function1[
  /* sequenceNumber */ typingsJapgolly.firebaseFirestore.typesMod.ListenSequenceNumber, 
  scala.Unit]) => forEachOrphanedDocumentSequenceNumber(t0, t1).runNow()))
    __obj.updateDynamic("forEachTarget")(js.Any.fromFunction2((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: js.Function1[
  /* target */ typingsJapgolly.firebaseFirestore.targetDataMod.TargetData, 
  scala.Unit]) => forEachTarget(t0, t1).runNow()))
    __obj.updateDynamic("getCacheSize")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction) => getCacheSize(t0).runNow()))
    __obj.updateDynamic("getSequenceNumberCount")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction) => getSequenceNumberCount(t0).runNow()))
    __obj.updateDynamic("removeOrphanedDocuments")(js.Any.fromFunction2((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: typingsJapgolly.firebaseFirestore.typesMod.ListenSequenceNumber) => removeOrphanedDocuments(t0, t1).runNow()))
    __obj.updateDynamic("removeTargets")(js.Any.fromFunction3((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: typingsJapgolly.firebaseFirestore.typesMod.ListenSequenceNumber, t2: typingsJapgolly.firebaseFirestore.lruGarbageCollectorMod.ActiveTargets) => removeTargets(t0, t1, t2).runNow()))
