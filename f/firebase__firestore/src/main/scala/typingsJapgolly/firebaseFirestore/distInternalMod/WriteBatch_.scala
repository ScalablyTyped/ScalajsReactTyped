...
@JSImport("@firebase/firestore/dist/internal", "WriteBatch")
@js.native
open class WriteBatch_ protected () extends StObject {
  /** @hideconstructor */
  def this(_firestore: Firestore2, _commitHandler: js.Function1[/* m */ js.Array[Mutation], js.Promise[Unit]]) = this()
