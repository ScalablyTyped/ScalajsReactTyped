...
trait StructuredQuery extends StObject {
  ...
  var limit: js.UndefOr[Double | typingsJapgolly.firebaseFirestore.anon.Value] = js.undefined
...
object StructuredQuery {
  ...
  extension [Self <: StructuredQuery](x: Self) {
    ...
    inline def setLimit(value: Double | typingsJapgolly.firebaseFirestore.anon.Value): Self = StObject.set(x, "limit", value.asInstanceOf[js.Any])
