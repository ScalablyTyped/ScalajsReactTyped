...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.firebaseFirestore.anon.`6`
*/
trait SetOptions extends StObject
object SetOptions {
  
  inline def `6`(): typingsJapgolly.firebaseFirestore.anon.`6` = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[typingsJapgolly.firebaseFirestore.anon.`6`]
  }
