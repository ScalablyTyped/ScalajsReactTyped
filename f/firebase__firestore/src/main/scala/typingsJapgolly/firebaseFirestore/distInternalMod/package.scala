...
import typingsJapgolly.firebaseFirestore.anon.`10`
import typingsJapgolly.firebaseFirestore.anon.`7`
import typingsJapgolly.firebaseFirestore.anon.`8`
import typingsJapgolly.firebaseFirestore.anon.`9`
import typingsJapgolly.firebaseFirestore.distInternalMod.^
...
type MapValue = typingsJapgolly.firebaseFirestore.distInternalMod.firestoreV1ApiClientInterfaces.MapValue
...
type StructuredQuery = typingsJapgolly.firebaseFirestore.distInternalMod.firestoreV1ApiClientInterfaces.StructuredQuery
...
type Value = typingsJapgolly.firebaseFirestore.distInternalMod.firestoreV1ApiClientInterfaces.Value
