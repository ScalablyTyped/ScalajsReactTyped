...
object distLitePackagesFirestoreTestUnitRemoteSerializerDothelperMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/test/unit/remote/serializer.helper", JSImport.Namespace)
  @js.native
