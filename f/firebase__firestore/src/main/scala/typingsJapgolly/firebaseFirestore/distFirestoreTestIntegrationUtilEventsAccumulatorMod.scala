...
import typingsJapgolly.firebaseFirestore.distFirestoreTestIntegrationUtilFirebaseExportMod.DocumentSnapshot
...
object distFirestoreTestIntegrationUtilEventsAccumulatorMod {
