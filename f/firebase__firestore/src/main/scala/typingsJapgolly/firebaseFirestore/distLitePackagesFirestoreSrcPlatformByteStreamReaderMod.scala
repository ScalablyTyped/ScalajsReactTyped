...
object distLitePackagesFirestoreSrcPlatformByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/byte_stream_reader", JSImport.Namespace)
  @js.native
