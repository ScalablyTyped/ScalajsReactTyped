...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLiteApiTimestampMod.Timestamp
...
object distPackagesFirestoreSrcModelTransformOperationMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/transform_operation", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/transform_operation", "ArrayRemoveTransformOperation")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/transform_operation", "ArrayUnionTransformOperation")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/transform_operation", "NumericIncrementTransformOperation")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/transform_operation", "ServerTimestampTransform")
  @js.native
  open class ServerTimestampTransform () extends TransformOperation
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/transform_operation", "TransformOperation")
  @js.native
