...
object distFirestoreSrcMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src", "AbstractUserDataWriter")
  @js.native
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src", "FieldValue")
  @js.native
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/firestore/src", "QueryConstraint")
  @js.native
