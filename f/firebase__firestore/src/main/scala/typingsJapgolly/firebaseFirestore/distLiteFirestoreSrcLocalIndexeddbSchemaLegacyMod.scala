...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcLocalIndexeddbSchemaMod.DbNoDocument
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcLocalIndexeddbSchemaMod.DbUnknownDocument
...
object distLiteFirestoreSrcLocalIndexeddbSchemaLegacyMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/local/indexeddb_schema_legacy", "DbRemoteDocumentStore")
  @js.native
