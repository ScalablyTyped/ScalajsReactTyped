...
object distPackagesFirestoreSrcApiSettingsMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/api/settings", "DEFAULT_HOST")
  @js.native
  val DEFAULT_HOST: /* "firestore.googleapis.com" */ String = js.native
  
  trait FirestoreSettings
    extends StObject
       with typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLiteApiSettingsMod.FirestoreSettings {
