...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLiteApiReferenceMod.DocumentReference
...
object distPackagesFirestoreSrcLiteApiSnapshotMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/snapshot", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/snapshot", "DocumentSnapshot")
  @js.native
  open class DocumentSnapshot[T] protected () extends StObject {
    ...
    /**
      ...
      */
    def exists(): /* is @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/lite-api/snapshot.QueryDocumentSnapshot<T> */ Boolean = js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/snapshot", "QueryDocumentSnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/snapshot", "QuerySnapshot")
  @js.native
  ...
  inline def fieldPathFromArgument(methodName: String, arg: String): typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelPathMod.FieldPath]
  inline def fieldPathFromArgument(methodName: String, arg: FieldPath): typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelPathMod.FieldPath]
  inline def fieldPathFromArgument(methodName: String, arg: Compat[FieldPath]): typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelPathMod.FieldPath]
