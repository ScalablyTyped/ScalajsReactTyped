...
import typingsJapgolly.firebaseFirestore.credentialsMod.TokenType
...
import typingsJapgolly.firebaseFirestore.firestoreProtoApiMod.FieldTransformSetToServerValue
import typingsJapgolly.firebaseFirestore.firestoreProtoApiMod.IndexFieldMode
import typingsJapgolly.firebaseFirestore.firestoreProtoApiMod.IndexState
import typingsJapgolly.firebaseFirestore.firestoreProtoApiMod.OrderDirection
import typingsJapgolly.firebaseFirestore.firestoreProtoApiMod.ProjectsDatabasesDocumentsApiClientAlt
import typingsJapgolly.firebaseFirestore.firestoreProtoApiMod.ProjectsDatabasesDocumentsApiClientXgafv
import typingsJapgolly.firebaseFirestore.firestoreProtoApiMod.ProjectsDatabasesIndexesApiClientAlt
import typingsJapgolly.firebaseFirestore.firestoreProtoApiMod.ProjectsDatabasesIndexesApiClientXgafv
import typingsJapgolly.firebaseFirestore.firestoreProtoApiMod.TargetChangeTargetChangeType
import typingsJapgolly.firebaseFirestore.firestoreProtoApiMod.UnaryFilterOp
import typingsJapgolly.firebaseFirestore.inputValidationMod.ValidationType
import typingsJapgolly.firebaseFirestore.localSharedClientStateSyncerMod.QueryTargetState
import typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransactionMode
import typingsJapgolly.firebaseFirestore.simpleDbMod.SimpleDbTransactionMode
import typingsJapgolly.firebaseFirestore.specTestRunnerMod.SpecLimitType
...
object firebaseFirestoreStrings {
  ...
  sealed trait FirstParty
    extends TokenType
       with typingsJapgolly.firebaseFirestore.apiCredentialsMod.TokenType
  ...
  sealed trait LimitToFirst
    extends SpecLimitType
       with typingsJapgolly.firebaseFirestore.specsSpecTestRunnerMod.SpecLimitType
  ...
  sealed trait acknowledged
    extends MutationBatchState
       with typingsJapgolly.firebaseFirestore.coreTypesMod.MutationBatchState
  
  @js.native
  sealed trait boolean
    extends ValidationType
       with typingsJapgolly.firebaseFirestore.utilInputValidationMod.ValidationType
  
  @js.native
  sealed trait current_
    extends QueryTargetState
       with typingsJapgolly.firebaseFirestore.sharedClientStateSyncerMod.QueryTargetState
  ...
  sealed trait readonly
    extends PersistenceTransactionMode
       with typingsJapgolly.firebaseFirestore.localPersistenceMod.PersistenceTransactionMode
       with SimpleDbTransactionMode
       with typingsJapgolly.firebaseFirestore.localSimpleDbMod.SimpleDbTransactionMode
