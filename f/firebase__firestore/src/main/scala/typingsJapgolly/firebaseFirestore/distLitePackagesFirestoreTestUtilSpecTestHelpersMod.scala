...
object distLitePackagesFirestoreTestUtilSpecTestHelpersMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/test/util/spec_test_helpers", JSImport.Namespace)
  @js.native
