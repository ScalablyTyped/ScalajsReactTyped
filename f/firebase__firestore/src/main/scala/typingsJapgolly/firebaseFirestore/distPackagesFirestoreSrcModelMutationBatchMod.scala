...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelCollectionsMod.DocumentVersionMap_
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelCollectionsMod.MutationMap
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelCollectionsMod.OverlayedDocumentMap
...
object distPackagesFirestoreSrcModelMutationBatchMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/mutation_batch", "MutationBatch")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/model/mutation_batch", "MutationBatchResult")
  @js.native
