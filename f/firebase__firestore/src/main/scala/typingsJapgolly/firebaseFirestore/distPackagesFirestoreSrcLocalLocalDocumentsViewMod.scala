...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLocalLocalStoreImplMod.LocalWriteResult
...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelCollectionsMod.DocumentKeyMap
