...
trait ProjectsDatabasesDocumentsBatchGetNamedParameters extends StObject {
...
object ProjectsDatabasesDocumentsBatchGetNamedParameters {
  
  inline def apply(): ProjectsDatabasesDocumentsBatchGetNamedParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProjectsDatabasesDocumentsBatchGetNamedParameters]
  }
  
  extension [Self <: ProjectsDatabasesDocumentsBatchGetNamedParameters](x: Self) {
