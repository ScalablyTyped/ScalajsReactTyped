...
object IUnaryFilterOpEnum {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(IS_NAN = IS_NAN.asInstanceOf[js.Any], IS_NOT_NAN = IS_NOT_NAN.asInstanceOf[js.Any], IS_NOT_NULL = IS_NOT_NULL.asInstanceOf[js.Any], IS_NULL = IS_NULL.asInstanceOf[js.Any], OPERATOR_UNSPECIFIED = OPERATOR_UNSPECIFIED.asInstanceOf[js.Any], values = values.toJsFn)
  ...
  extension [Self <: IUnaryFilterOpEnum](x: Self) {
    ...
    inline def setValues(value: CallbackTo[js.Array[UnaryFilterOp]]): Self = StObject.set(x, "values", value.toJsFn)
  }
}
