...
object distLitePackagesFirestoreSrcPlatformRnLiteSerializerMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/rn_lite/serializer", JSImport.Namespace)
  @js.native
