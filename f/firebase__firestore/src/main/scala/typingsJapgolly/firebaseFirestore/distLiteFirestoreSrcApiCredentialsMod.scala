...
object distLiteFirestoreSrcApiCredentialsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcApiCredentialsMod.FirstPartyCredentialsSettings
    - typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcApiCredentialsMod.ProviderCredentialsSettings
  */
  trait CredentialsSettings extends StObject
  object CredentialsSettings {
    
    inline def FirstPartyCredentialsSettings(client: Any, sessionIndex: String): typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcApiCredentialsMod.FirstPartyCredentialsSettings = {
      ...
      __obj.asInstanceOf[typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcApiCredentialsMod.FirstPartyCredentialsSettings]
    }
    
    inline def ProviderCredentialsSettings(client: CredentialsProvider[User]): typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcApiCredentialsMod.ProviderCredentialsSettings = {
      val __obj = js.Dynamic.literal(client = client.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("provider")
      __obj.asInstanceOf[typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcApiCredentialsMod.ProviderCredentialsSettings]
    }
  }
