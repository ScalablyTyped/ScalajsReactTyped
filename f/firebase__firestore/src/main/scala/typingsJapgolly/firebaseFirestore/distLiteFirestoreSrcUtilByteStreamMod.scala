...
object distLiteFirestoreSrcUtilByteStreamMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/util/byte_stream", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/util/byte_stream", "DEFAULT_BYTES_PER_READ")
  @js.native
