...
import typingsJapgolly.firebaseFirestore.anon.InclusiveBoolean
...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcProtosFirestoreProtoApiMod.ArrayValue
...
object distLitePackagesFirestoreSrcModelValuesMod {
  ...
  inline def isArray(): /* is @firebase/firestore.anon.33 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArray")().asInstanceOf[/* is @firebase/firestore.anon.33 */ Boolean]
  inline def isArray(value: Value): /* is @firebase/firestore.anon.33 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArray")(value.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/firestore.anon.33 */ Boolean]
  ...
  inline def isMapValue(): /* is @firebase/firestore.anon.32 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMapValue")().asInstanceOf[/* is @firebase/firestore.anon.32 */ Boolean]
  inline def isMapValue(value: Value): /* is @firebase/firestore.anon.32 */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMapValue")(value.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/firestore.anon.32 */ Boolean]
