...
object distLiteFirestoreSrcPlatformBrowserLiteByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/browser_lite/byte_stream_reader", JSImport.Namespace)
  @js.native
