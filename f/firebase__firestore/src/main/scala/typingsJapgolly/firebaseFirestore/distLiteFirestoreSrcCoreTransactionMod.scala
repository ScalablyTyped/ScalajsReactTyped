...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcLiteApiUserDataReaderMod.ParsedSetData
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcLiteApiUserDataReaderMod.ParsedUpdateData
...
object distLiteFirestoreSrcCoreTransactionMod {
