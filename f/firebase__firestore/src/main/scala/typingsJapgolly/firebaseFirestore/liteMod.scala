...
object liteMod {
  ...
  open class AggregateField[T] ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.AggregateField[T]
  
  @JSImport("@firebase/firestore/lite", "AggregateQuerySnapshot")
  @js.native
  /* private */ open class AggregateQuerySnapshot[T /* <: AggregateSpec */] ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.AggregateQuerySnapshot[T]
  
  @JSImport("@firebase/firestore/lite", "Bytes")
  @js.native
  /* private */ open class Bytes ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.Bytes
  /* static members */
  object Bytes {
  ...
  /* private */ open class CollectionReference[T] ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.CollectionReference[T]
  
  @JSImport("@firebase/firestore/lite", "DocumentReference")
  @js.native
  /* private */ open class DocumentReference[T] ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.DocumentReference[T]
  
  @JSImport("@firebase/firestore/lite", "DocumentSnapshot")
  @js.native
  /* protected */ open class DocumentSnapshot[T] ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.DocumentSnapshot[T]
  
  @JSImport("@firebase/firestore/lite", "FieldPath")
  @js.native
  open class FieldPath protected ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.FieldPath {
    /**
  ...
  /* private */ open class FieldValue ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.FieldValue
  
  @JSImport("@firebase/firestore/lite", "Firestore")
  @js.native
  /* private */ open class Firestore ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.Firestore
  
  @JSImport("@firebase/firestore/lite", "FirestoreError")
  @js.native
  /* private */ open class FirestoreError ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.FirestoreError
  
  @JSImport("@firebase/firestore/lite", "GeoPoint")
  @js.native
  open class GeoPoint protected ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.GeoPoint {
    /**
  ...
  open class QueryConstraint ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.QueryConstraint
  
  @JSImport("@firebase/firestore/lite", "QueryDocumentSnapshot")
  @js.native
  /* protected */ open class QueryDocumentSnapshot[T] ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.QueryDocumentSnapshot[T]
  
  @JSImport("@firebase/firestore/lite", "QuerySnapshot")
  @js.native
  /* private */ open class QuerySnapshot[T] ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.QuerySnapshot[T]
  
  @JSImport("@firebase/firestore/lite", "Query")
  @js.native
  /* protected */ open class Query_[T] ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.Query_[T]
  
  @JSImport("@firebase/firestore/lite", "Timestamp")
  @js.native
  open class Timestamp protected ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.Timestamp {
    /**
  ...
  /* private */ open class Transaction ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.Transaction
  
  @JSImport("@firebase/firestore/lite", "WriteBatch")
  @js.native
  /* private */ open class WriteBatch_ ()
    extends typingsJapgolly.firebaseFirestore.distLiteMod.WriteBatch_
