...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLocalSharedClientStateSyncerMod.SharedClientStateSyncer
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelCollectionsMod.TargetIdSet_
...
object distPackagesFirestoreSrcLocalSharedClientStateMod {
  ...
  object WebStorageSharedClientState {
    ...
    inline def isAvailable(): /* is @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/util/types.WindowLike */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAvailable")().asInstanceOf[/* is @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/util/types.WindowLike */ Boolean]
    inline def isAvailable(window: WindowLike): /* is @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/util/types.WindowLike */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAvailable")(window.asInstanceOf[js.Any]).asInstanceOf[/* is @firebase/firestore.@firebase/firestore/dist/packages/firestore/src/util/types.WindowLike */ Boolean]
  }
