...
import typingsJapgolly.firebaseFirestore.modelCollectionsMod.DocumentSizeEntries
import typingsJapgolly.firebaseFirestore.modelCollectionsMod.DocumentSizeEntry
