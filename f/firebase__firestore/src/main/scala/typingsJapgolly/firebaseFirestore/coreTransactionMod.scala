...
import typingsJapgolly.firebaseFirestore.apiUserDataConverterMod.ParsedSetData
import typingsJapgolly.firebaseFirestore.apiUserDataConverterMod.ParsedUpdateData
...
@JSImport("@firebase/firestore/dist/src/core/transaction", JSImport.Namespace)
@js.native
object coreTransactionMod extends js.Object {
  @js.native
