...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreTestIntegrationUtilFirebaseExportMod.DocumentSnapshot
...
object distPackagesFirestoreTestIntegrationUtilEventsAccumulatorMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/test/integration/util/events_accumulator", "EventsAccumulator")
  @js.native
