...
object distLitePackagesFirestoreSrcModelDocumentMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/model/document", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/model/document", "MutableDocument")
  @js.native
