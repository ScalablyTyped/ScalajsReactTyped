...
@JSImport("@firebase/firestore/dist/src/api/field_path", JSImport.Namespace)
@js.native
object apiFieldPathMod extends js.Object {
  @js.native
  class FieldPath protected ()
    extends typingsJapgolly.firebaseFirestoreTypes.mod.FieldPath {
    /**
    ...
    var _internalPath: typingsJapgolly.firebaseFirestore.modelPathMod.FieldPath = js.native
  }
