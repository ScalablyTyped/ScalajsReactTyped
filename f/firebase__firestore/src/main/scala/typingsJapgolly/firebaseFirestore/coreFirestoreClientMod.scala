...
import typingsJapgolly.firebaseFirestore.coreEventManagerMod.ListenOptions
import typingsJapgolly.firebaseFirestore.coreEventManagerMod.Observer
import typingsJapgolly.firebaseFirestore.coreEventManagerMod.QueryListener
...
object coreFirestoreClientMod extends js.Object {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseFirestore.coreFirestoreClientMod.IndexedDbPersistenceSettings
    - typingsJapgolly.firebaseFirestore.coreFirestoreClientMod.MemoryPersistenceSettings
  */
