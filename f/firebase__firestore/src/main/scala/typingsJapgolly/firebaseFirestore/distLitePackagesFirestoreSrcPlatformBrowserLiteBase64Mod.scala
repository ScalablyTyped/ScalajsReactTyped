...
object distLitePackagesFirestoreSrcPlatformBrowserLiteBase64Mod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/browser_lite/base64", JSImport.Namespace)
  @js.native
