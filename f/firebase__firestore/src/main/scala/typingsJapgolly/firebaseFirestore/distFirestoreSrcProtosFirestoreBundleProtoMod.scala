...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcProtosFirestoreProtoApiMod.StructuredQuery
...
object distFirestoreSrcProtosFirestoreBundleProtoMod {
