package typingsJapgolly.firebaseFirestore.mutationQueueMod
...
object MutationQueue {
  ...
  def apply(
    ...
    __obj.updateDynamic("acknowledgeBatch")(js.Any.fromFunction3((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: typingsJapgolly.firebaseFirestore.mutationBatchMod.MutationBatch, t2: typingsJapgolly.firebaseFirestore.typesMod.ProtoByteString) => acknowledgeBatch(t0, t1, t2).runNow()))
    __obj.updateDynamic("addMutationBatch")(js.Any.fromFunction4((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: typingsJapgolly.firebaseFirestore.timestampMod.Timestamp, t2: js.Array[typingsJapgolly.firebaseFirestore.mutationMod.Mutation], t3: js.Array[typingsJapgolly.firebaseFirestore.mutationMod.Mutation]) => addMutationBatch(t0, t1, t2, t3).runNow()))
    __obj.updateDynamic("checkEmpty")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction) => checkEmpty(t0).runNow()))
    __obj.updateDynamic("getAllMutationBatches")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction) => getAllMutationBatches(t0).runNow()))
    __obj.updateDynamic("getAllMutationBatchesAffectingDocumentKey")(js.Any.fromFunction2((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: typingsJapgolly.firebaseFirestore.documentKeyMod.DocumentKey) => getAllMutationBatchesAffectingDocumentKey(t0, t1).runNow()))
    __obj.updateDynamic("getAllMutationBatchesAffectingDocumentKeys")(js.Any.fromFunction2((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: typingsJapgolly.firebaseFirestore.sortedMapMod.SortedMap[typingsJapgolly.firebaseFirestore.documentKeyMod.DocumentKey, js.Any]) => getAllMutationBatchesAffectingDocumentKeys(t0, t1).runNow()))
    __obj.updateDynamic("getAllMutationBatchesAffectingQuery")(js.Any.fromFunction2((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: typingsJapgolly.firebaseFirestore.queryMod.Query) => getAllMutationBatchesAffectingQuery(t0, t1).runNow()))
    __obj.updateDynamic("getHighestUnacknowledgedBatchId")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction) => getHighestUnacknowledgedBatchId(t0).runNow()))
    __obj.updateDynamic("getLastStreamToken")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction) => getLastStreamToken(t0).runNow()))
    __obj.updateDynamic("getNextMutationBatchAfterBatchId")(js.Any.fromFunction2((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: typingsJapgolly.firebaseFirestore.typesMod.BatchId) => getNextMutationBatchAfterBatchId(t0, t1).runNow()))
    __obj.updateDynamic("lookupMutationBatch")(js.Any.fromFunction2((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: typingsJapgolly.firebaseFirestore.typesMod.BatchId) => lookupMutationBatch(t0, t1).runNow()))
    __obj.updateDynamic("lookupMutationKeys")(js.Any.fromFunction2((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: typingsJapgolly.firebaseFirestore.typesMod.BatchId) => lookupMutationKeys(t0, t1).runNow()))
    __obj.updateDynamic("performConsistencyCheck")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction) => performConsistencyCheck(t0).runNow()))
    __obj.updateDynamic("removeCachedMutationKeys")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.typesMod.BatchId) => removeCachedMutationKeys(t0).runNow()))
    __obj.updateDynamic("removeMutationBatch")(js.Any.fromFunction2((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: typingsJapgolly.firebaseFirestore.mutationBatchMod.MutationBatch) => removeMutationBatch(t0, t1).runNow()))
    __obj.updateDynamic("setLastStreamToken")(js.Any.fromFunction2((t0: typingsJapgolly.firebaseFirestore.persistenceMod.PersistenceTransaction, t1: typingsJapgolly.firebaseFirestore.typesMod.ProtoByteString) => setLastStreamToken(t0, t1).runNow()))
