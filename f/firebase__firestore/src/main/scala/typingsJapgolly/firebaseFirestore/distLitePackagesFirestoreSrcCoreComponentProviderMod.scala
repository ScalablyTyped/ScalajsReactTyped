...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalSharedClientStateMod.SharedClientState
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcRemoteDatastoreMod.Datastore
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcRemoteRemoteStoreMod.RemoteStore
