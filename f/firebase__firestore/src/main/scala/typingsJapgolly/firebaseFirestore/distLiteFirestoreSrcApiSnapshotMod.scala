...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcCoreViewSnapshotMod.ChangeType
...
object distLiteFirestoreSrcApiSnapshotMod {
  ...
  */
  ...
  trait FirestoreDataConverter[T]
    extends StObject
       with typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcLiteApiSnapshotMod.FirestoreDataConverter[T] {
