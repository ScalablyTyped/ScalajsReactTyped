...
import typingsJapgolly.firebaseFirestore.anon.MapValue
...
object distFirestoreSrcModelObjectValueMod {
  ...
  inline def extractFieldMask(value: typingsJapgolly.firebaseFirestore.distFirestoreSrcProtosFirestoreProtoApiMod.MapValue): FieldMask = ^.asInstanceOf[js.Dynamic].applyDynamic("extractFieldMask")(value.asInstanceOf[js.Any]).asInstanceOf[FieldMask]
