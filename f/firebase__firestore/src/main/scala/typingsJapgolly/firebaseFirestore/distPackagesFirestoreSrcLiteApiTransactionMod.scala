...
object distPackagesFirestoreSrcLiteApiTransactionMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/transaction", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/transaction", "Transaction")
  @js.native
