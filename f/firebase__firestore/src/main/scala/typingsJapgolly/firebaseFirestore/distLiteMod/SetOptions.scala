...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.firebaseFirestore.anon.`20`
*/
trait SetOptions extends StObject
object SetOptions {
  
  inline def `20`(): typingsJapgolly.firebaseFirestore.anon.`20` = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[typingsJapgolly.firebaseFirestore.anon.`20`]
  }
