...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreTargetIdGeneratorMod.TargetIdGenerator
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreTypesMod.BatchId
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreTypesMod.MutationBatchState
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreTypesMod.OnlineState
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreTypesMod.OnlineStateSource
...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLocalReferenceSetMod.ReferenceSet
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLocalSharedClientStateMod.ClientId
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLocalSharedClientStateMod.SharedClientState
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLocalSharedClientStateSyncerMod.QueryTargetState
...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelMutationBatchMod.MutationBatchResult
...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcRemoteRemoteStoreMod.RemoteStore
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcUtilBundleReaderMod.BundleReader
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcUtilErrorMod.FirestoreError
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcUtilObjMapMod.ObjectMap
...
object distPackagesFirestoreSrcCoreSyncEngineImplMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/core/sync_engine_impl", JSImport.Namespace)
  @js.native
  ...
  object SyncEngineListener {
    ...
    extension [Self <: SyncEngineListener](x: Self) {
      ...
      inline def setOnWatchChange(value: /* snapshots */ js.Array[ViewSnapshot] => Callback): Self = StObject.set(x, "onWatchChange", js.Any.fromFunction1((t0: /* snapshots */ js.Array[ViewSnapshot]) => value(t0).runNow()))
      
      inline def setOnWatchChangeUndefined: Self = StObject.set(x, "onWatchChange", js.undefined)
      
      inline def setOnWatchError(value: (/* query */ Query, /* error */ FirestoreError) => Callback): Self = StObject.set(x, "onWatchError", js.Any.fromFunction2((t0: /* query */ Query, t1: /* error */ FirestoreError) => (value(t0, t1)).runNow()))
