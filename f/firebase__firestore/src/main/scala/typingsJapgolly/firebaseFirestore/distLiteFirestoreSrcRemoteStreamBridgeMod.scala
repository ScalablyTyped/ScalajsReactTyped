...
import typingsJapgolly.firebaseFirestore.anon.CloseFn
...
object distLiteFirestoreSrcRemoteStreamBridgeMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/remote/stream_bridge", "StreamBridge")
  @js.native
