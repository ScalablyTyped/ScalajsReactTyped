...
object distFirestoreSrcLiteApiAggregateTypesMod {
  ...
  /** NOTE: Mapped type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    {[ P in keyof T ]: T[P] extends @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/aggregate_types.AggregateField<infer U>? U : never}
    }}}
    */
  @js.native
