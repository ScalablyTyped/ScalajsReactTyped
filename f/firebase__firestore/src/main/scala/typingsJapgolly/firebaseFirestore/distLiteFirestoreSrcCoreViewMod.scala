...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcCoreViewSnapshotMod.DocumentChangeSet
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcCoreViewSnapshotMod.ViewSnapshot
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcLocalLocalStoreImplMod.QueryResult
...
object distLiteFirestoreSrcCoreViewMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcCoreViewMod.AddedLimboDocument
    - typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcCoreViewMod.RemovedLimboDocument
  */
