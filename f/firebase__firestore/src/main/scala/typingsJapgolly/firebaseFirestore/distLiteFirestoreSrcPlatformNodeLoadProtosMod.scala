...
object distLiteFirestoreSrcPlatformNodeLoadProtosMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/node/load_protos", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/node/load_protos", "protoLoaderOptions")
  @js.native
