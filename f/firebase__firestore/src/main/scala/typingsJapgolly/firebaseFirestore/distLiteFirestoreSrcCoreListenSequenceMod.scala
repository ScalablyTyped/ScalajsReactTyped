...
object distLiteFirestoreSrcCoreListenSequenceMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/core/listen_sequence", "ListenSequence")
  @js.native
  ...
  object ListenSequence {
    ...
    @JSImport("@firebase/firestore/dist/lite/firestore/src/core/listen_sequence", "ListenSequence.INVALID")
    @js.native
