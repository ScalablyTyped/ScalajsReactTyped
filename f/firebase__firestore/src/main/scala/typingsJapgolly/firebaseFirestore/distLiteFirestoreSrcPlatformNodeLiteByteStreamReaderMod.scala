...
object distLiteFirestoreSrcPlatformNodeLiteByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/node_lite/byte_stream_reader", JSImport.Namespace)
  @js.native
