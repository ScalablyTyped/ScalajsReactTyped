...
object distPackagesFirestoreSrcPlatformNodeLiteByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/node_lite/byte_stream_reader", JSImport.Namespace)
  @js.native
