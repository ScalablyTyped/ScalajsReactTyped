...
object distPackagesFirestoreSrcIndexEntryMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/index_entry", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/index_entry", "IndexEntry")
  @js.native
