...
object distLitePackagesFirestoreSrcApiCredentialsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.FirstPartyCredentialsSettings
    - typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.ProviderCredentialsSettings
  */
  trait CredentialsSettings extends StObject
  object CredentialsSettings {
    
    inline def FirstPartyCredentialsSettings(client: Any, sessionIndex: String): typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.FirstPartyCredentialsSettings = {
      ...
      __obj.asInstanceOf[typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.FirstPartyCredentialsSettings]
    }
    
    inline def ProviderCredentialsSettings(client: CredentialsProvider[User]): typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.ProviderCredentialsSettings = {
      val __obj = js.Dynamic.literal(client = client.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("provider")
      __obj.asInstanceOf[typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcApiCredentialsMod.ProviderCredentialsSettings]
    }
  }
