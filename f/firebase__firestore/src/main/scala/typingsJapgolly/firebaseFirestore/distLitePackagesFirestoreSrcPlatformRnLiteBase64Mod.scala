...
object distLitePackagesFirestoreSrcPlatformRnLiteBase64Mod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/rn_lite/base64", JSImport.Namespace)
  @js.native
