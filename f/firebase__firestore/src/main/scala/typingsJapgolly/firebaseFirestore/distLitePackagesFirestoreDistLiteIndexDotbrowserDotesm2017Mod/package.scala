...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreDistLiteIndexDotbrowserDotesm2017Mod.^
import typingsJapgolly.firebaseUtil.distSrcErrorsMod.FirebaseError
...
inline def getFirestore(e: Any, n: Any): typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreLiteMod.Firestore = (^.asInstanceOf[js.Dynamic].applyDynamic("getFirestore")(e.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreLiteMod.Firestore]
...
inline def initializeFirestore(t: Any, e: Any, n: Any): typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreLiteMod.Firestore = (^.asInstanceOf[js.Dynamic].applyDynamic("initializeFirestore")(t.asInstanceOf[js.Any], e.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreLiteMod.Firestore]
