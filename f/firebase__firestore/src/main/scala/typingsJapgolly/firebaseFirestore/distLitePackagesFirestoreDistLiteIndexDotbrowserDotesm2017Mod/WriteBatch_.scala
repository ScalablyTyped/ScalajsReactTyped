...
/**
  ...
  * called.
  */ @JSImport("@firebase/firestore/dist/lite/packages/firestore/dist/lite/index.browser.esm2017", "WriteBatch")
@js.native
open class WriteBatch_ protected ()
  ...
  /**
    ...
    */ /* CompleteClass */
  override def delete(t: Any): Qr = js.native
  
  /* CompleteClass */
  override def set(t: Any, e: Any, n: Any): Qr = js.native
  
  /* CompleteClass */
  override def update(t: Any, e: Any, n: Any, r: Any*): Qr = js.native
}
