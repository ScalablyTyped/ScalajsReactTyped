...
object Vn_ {
  ...
  inline def apply(_byteString: Any, isEqual: Any => Any, toBase64: CallbackTo[Any], toUint8Array: CallbackTo[Any]): Vn_ = {
    ...
    __obj.asInstanceOf[Vn_]
  }
  
  extension [Self <: Vn_](x: Self) {
