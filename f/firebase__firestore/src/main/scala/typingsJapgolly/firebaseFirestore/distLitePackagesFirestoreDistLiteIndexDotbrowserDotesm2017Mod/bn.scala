...
/**
  ...
  */ trait bn extends StObject {
  ...
  def withConverter(t: Any): bn
}
object bn {
  
  inline def apply(_query: Any, converter: Any, firestore: Any, `type`: String, withConverter: Any => bn): bn = {
  ...
  extension [Self <: bn](x: Self) {
    ...
    inline def setWithConverter(value: Any => bn): Self = StObject.set(x, "withConverter", js.Any.fromFunction1(value))
