...
object Persistence {
  ...
  def apply(
    ...
    __obj.updateDynamic("getMutationQueue")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.authUserMod.User) => getMutationQueue(t0).runNow()))
    ...
    __obj.updateDynamic("runTransaction")(js.Any.fromFunction3((t0: java.lang.String, t1: typingsJapgolly.firebaseFirestore.localPersistenceMod.PersistenceTransactionMode, t2: js.Function1[
  /* transaction */ typingsJapgolly.firebaseFirestore.localPersistenceMod.PersistenceTransaction, 
  typingsJapgolly.firebaseFirestore.localPersistencePromiseMod.PersistencePromise[js.Any]]) => runTransaction(t0, t1, t2).runNow()))
    ...
    __obj.updateDynamic("setPrimaryStateListener")(js.Any.fromFunction1((t0: typingsJapgolly.firebaseFirestore.localPersistenceMod.PrimaryStateListener) => setPrimaryStateListener(t0).runNow()))
