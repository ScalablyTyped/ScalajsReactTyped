...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcCoreTypesMod.OnlineStateSource
...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalReferenceSetMod.ReferenceSet
