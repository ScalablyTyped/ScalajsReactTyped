...
object distLitePackagesFirestoreSrcPlatformNodeConnectionMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/node/connection", JSImport.Namespace)
  @js.native
