...
object distLiteFirestoreSrcLocalIndexeddbDocumentOverlayCacheMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/local/indexeddb_document_overlay_cache", "IndexedDbDocumentOverlayCache")
  @js.native
