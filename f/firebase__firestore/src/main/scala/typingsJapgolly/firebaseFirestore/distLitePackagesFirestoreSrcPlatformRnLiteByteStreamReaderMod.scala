...
object distLitePackagesFirestoreSrcPlatformRnLiteByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/rn_lite/byte_stream_reader", JSImport.Namespace)
  @js.native
