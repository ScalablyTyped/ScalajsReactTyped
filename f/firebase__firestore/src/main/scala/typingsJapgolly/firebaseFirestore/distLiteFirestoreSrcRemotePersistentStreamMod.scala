...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcApiCredentialsMod.Token
...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcRemoteBackoffMod.ExponentialBackoff
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcRemoteConnectionMod.Connection
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcRemoteConnectionMod.Stream
...
object distLiteFirestoreSrcRemotePersistentStreamMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/remote/persistent_stream", "PersistentListenStream")
  @js.native
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/firestore/src/remote/persistent_stream", "PersistentStream")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/firestore/src/remote/persistent_stream", "PersistentWriteStream")
  @js.native
  open class PersistentWriteStream protected ()
    extends PersistentStream[
          typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcProtosFirestoreProtoApiMod.WriteRequest, 
          WriteResponse, 
          WriteStreamListener
        ] {
    def this(
  ...
  trait WriteRequest
    extends StObject
       with typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcProtosFirestoreProtoApiMod.firestoreV1ApiClientInterfaces.WriteRequest {
