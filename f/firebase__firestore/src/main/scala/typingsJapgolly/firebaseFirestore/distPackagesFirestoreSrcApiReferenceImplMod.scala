...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiSnapshotMod.DocumentSnapshot
...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLiteApiReferenceMod.CollectionReference
