...
object distFirestoreSrcLiteApiReferenceMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/reference", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/reference", "CollectionReference")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/reference", "DocumentReference")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/lite-api/reference", "Query")
  @js.native
  open class Query[T] protected () extends StObject {
    ...
    val _query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query = js.native
  ...
  type PartialWithFieldValue[T] = Partial[T] | (/* import warning: importer.ImportType#apply Failed type conversion: T extends @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/types.Primitive ? T : T extends {} ? {[ K in keyof T ]:? @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/reference.PartialWithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/field_value.FieldValue} : never */ js.Any)
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseFirestore.anon.Merge
    - typingsJapgolly.firebaseFirestore.anon.MergeFields
  */
  ...
  object SetOptions {
    ...
    inline def MergeFields(): typingsJapgolly.firebaseFirestore.anon.MergeFields = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.firebaseFirestore.anon.MergeFields]
    }
  }
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    T extends @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/types.Primitive ? T : T extends {} ? {[ K in keyof T ]:? @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/reference.UpdateData<T[K]> | @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/field_value.FieldValue} & @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/types.NestedUpdateFields<T> : std.Partial<T>
    }}}
    */
  @js.native
  trait UpdateData[T] extends StObject
  
  type WithFieldValue[T] = T | (/* import warning: importer.ImportType#apply Failed type conversion: T extends @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/types.Primitive ? T : T extends {} ? {[ K in keyof T ]: @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/reference.WithFieldValue<T[K]> | @firebase/firestore.@firebase/firestore/dist/firestore/src/lite-api/field_value.FieldValue} : never */ js.Any)
}
