...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreTestIntegrationUtilFirebaseExportMod.DocumentSnapshot
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreTestIntegrationUtilFirebaseExportMod.QuerySnapshot
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distLitePackagesFirestoreTestIntegrationUtilEventsAccumulatorMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/test/integration/util/events_accumulator", "EventsAccumulator")
  @js.native
