...
object distLitePackagesFirestoreSrcPlatformBrowserLiteByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/browser_lite/byte_stream_reader", JSImport.Namespace)
  @js.native
