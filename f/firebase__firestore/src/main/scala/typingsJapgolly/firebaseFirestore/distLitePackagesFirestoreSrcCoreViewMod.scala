...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcCoreTypesMod.OnlineState
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcCoreViewSnapshotMod.DocumentChangeSet
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcCoreViewSnapshotMod.ViewSnapshot
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalLocalStoreImplMod.QueryResult
...
object distLitePackagesFirestoreSrcCoreViewMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcCoreViewMod.AddedLimboDocument
    - typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcCoreViewMod.RemovedLimboDocument
  */
