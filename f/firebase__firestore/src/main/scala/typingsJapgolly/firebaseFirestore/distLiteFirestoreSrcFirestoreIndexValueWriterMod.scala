...
object distLiteFirestoreSrcFirestoreIndexValueWriterMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/firestore_index_value_writer", "FirestoreIndexValueWriter")
  @js.native
  ...
  object FirestoreIndexValueWriter {
    ...
    @JSImport("@firebase/firestore/dist/lite/firestore/src/firestore_index_value_writer", "FirestoreIndexValueWriter.INSTANCE")
    @js.native
