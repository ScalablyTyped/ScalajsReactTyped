...
object distLitePackagesFirestoreSrcApiFieldValueMod {
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/field_value", "FieldValue")
  @js.native
