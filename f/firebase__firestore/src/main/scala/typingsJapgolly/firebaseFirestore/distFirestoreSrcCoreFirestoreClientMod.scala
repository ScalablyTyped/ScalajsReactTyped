...
import typingsJapgolly.firebaseFirestore.anon.PartialObserverViewSnapsh
import typingsJapgolly.firebaseFirestore.anon.PartialObservervoid
import typingsJapgolly.firebaseFirestore.anon.`0`
...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcApiMod.AggregateQuerySnapshot
...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreComponentProviderMod.OfflineComponentProvider
...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreEventManagerMod.ListenOptions
...
object distFirestoreSrcCoreFirestoreClientMod {
  ...
  inline def firestoreClientRunCountQuery(
    client: FirestoreClient,
    query: typingsJapgolly.firebaseFirestore.distFirestoreSrcLiteApiReferenceMod.Query[Any],
