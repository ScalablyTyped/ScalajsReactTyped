...
object distLitePackagesFirestoreSrcPlatformNodeRandomBytesMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/node/random_bytes", JSImport.Namespace)
  @js.native
