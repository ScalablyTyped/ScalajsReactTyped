...
object distLitePackagesFirestoreSrcRemoteOnlineStateTrackerMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/remote/online_state_tracker", "OnlineStateTracker")
  @js.native
