...
object IOrderDirectionEnum {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(ASCENDING = ASCENDING.asInstanceOf[js.Any], DESCENDING = DESCENDING.asInstanceOf[js.Any], DIRECTION_UNSPECIFIED = DIRECTION_UNSPECIFIED.asInstanceOf[js.Any], values = values.toJsFn)
  ...
  extension [Self <: IOrderDirectionEnum](x: Self) {
    ...
    inline def setValues(value: CallbackTo[js.Array[OrderDirection]]): Self = StObject.set(x, "values", value.toJsFn)
  }
}
