...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcLiteApiTimestampMod.Timestamp
import typingsJapgolly.firebaseFirestore.distFirestoreSrcModelCollectionsMod.DocumentKeySet_
import typingsJapgolly.firebaseFirestore.distFirestoreSrcModelCollectionsMod.DocumentVersionMap_
import typingsJapgolly.firebaseFirestore.distFirestoreSrcModelCollectionsMod.MutationMap
import typingsJapgolly.firebaseFirestore.distFirestoreSrcModelCollectionsMod.OverlayedDocumentMap
...
object distFirestoreSrcModelMutationBatchMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/model/mutation_batch", "MutationBatch")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/firestore/src/model/mutation_batch", "MutationBatchResult")
  @js.native
