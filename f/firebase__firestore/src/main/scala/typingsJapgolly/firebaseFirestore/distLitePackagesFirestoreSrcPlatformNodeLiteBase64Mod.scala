...
object distLitePackagesFirestoreSrcPlatformNodeLiteBase64Mod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/node_lite/base64", JSImport.Namespace)
  @js.native
