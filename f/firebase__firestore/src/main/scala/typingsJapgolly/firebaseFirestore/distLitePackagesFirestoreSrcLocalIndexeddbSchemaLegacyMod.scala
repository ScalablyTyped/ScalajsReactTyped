...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSchemaMod.DbNoDocument
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSchemaMod.DbUnknownDocument
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLocalIndexeddbSentinelsMod.DbTimestampKey
...
object distLitePackagesFirestoreSrcLocalIndexeddbSchemaLegacyMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/indexeddb_schema_legacy", "DbRemoteDocumentStore")
  @js.native
