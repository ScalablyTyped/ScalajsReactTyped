...
import typingsJapgolly.firebaseFirestore.anon.PartialContextSettingsHasConverter
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcApiParseContextMod.ParseContext
...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLiteApiFieldValueMod.FieldValue
...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcModelMutationMod.FieldTransform
...
import typingsJapgolly.firebaseFirestore.firebaseFirestoreInts.`3`
import typingsJapgolly.firebaseFirestore.firebaseFirestoreInts.`4`
...
object distPackagesFirestoreSrcLiteApiUserDataReaderMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/user_data_reader", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/user_data_reader", "ArrayRemoveFieldValueImpl")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/user_data_reader", "ArrayUnionFieldValueImpl")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/user_data_reader", "DeleteFieldValueImpl")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/user_data_reader", "NumericIncrementFieldValueImpl")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/user_data_reader", "ParsedSetData")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/user_data_reader", "ParsedUpdateData")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/user_data_reader", "ServerTimestampFieldValueImpl")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/user_data_reader", "UserDataReader")
  @js.native
  ...
  inline def fieldPathFromArgument(methodName: String, path: typingsJapgolly.firebaseFirestoreTypes.mod.FieldPath): FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], path.asInstanceOf[js.Any])).asInstanceOf[FieldPath]
  inline def fieldPathFromArgument(
    methodName: String,
    path: typingsJapgolly.firebaseFirestoreTypes.mod.FieldPath,
  ...
  inline def fieldPathFromArgument(methodName: String, path: Compat[typingsJapgolly.firebaseFirestoreTypes.mod.FieldPath]): FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], path.asInstanceOf[js.Any])).asInstanceOf[FieldPath]
  inline def fieldPathFromArgument(
    methodName: String,
    path: Compat[typingsJapgolly.firebaseFirestoreTypes.mod.FieldPath],
    targetDoc: DocumentKey
  ): FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], path.asInstanceOf[js.Any], targetDoc.asInstanceOf[js.Any])).asInstanceOf[FieldPath]
  ...
  inline def parseUpdateVarargs(
    ...
    methodName: String,
    targetDoc: DocumentKey,
    field: typingsJapgolly.firebaseFirestoreTypes.mod.FieldPath,
    value: Any,
    moreFieldsAndValues: js.Array[Any]
  ): ParsedUpdateData = (^.asInstanceOf[js.Dynamic].applyDynamic("parseUpdateVarargs")(userDataReader.asInstanceOf[js.Any], methodName.asInstanceOf[js.Any], targetDoc.asInstanceOf[js.Any], field.asInstanceOf[js.Any], value.asInstanceOf[js.Any], moreFieldsAndValues.asInstanceOf[js.Any])).asInstanceOf[ParsedUpdateData]
  inline def parseUpdateVarargs(
    ...
    methodName: String,
    targetDoc: DocumentKey,
    field: Compat[typingsJapgolly.firebaseFirestoreTypes.mod.FieldPath],
    value: Any,
    moreFieldsAndValues: js.Array[Any]
  ): ParsedUpdateData = (^.asInstanceOf[js.Dynamic].applyDynamic("parseUpdateVarargs")(userDataReader.asInstanceOf[js.Any], methodName.asInstanceOf[js.Any], targetDoc.asInstanceOf[js.Any], field.asInstanceOf[js.Any], value.asInstanceOf[js.Any], moreFieldsAndValues.asInstanceOf[js.Any])).asInstanceOf[ParsedUpdateData]
  ...
  trait ParseContextImpl
    ...
    def contextWith(configuration: PartialContextSettingsHasConverter): ParseContextImpl = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreInts.`3`
    - typingsJapgolly.firebaseFirestore.firebaseFirestoreInts.`4`
  */
