...
object distFirestoreSrcFirestoreIndexValueWriterMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/firestore_index_value_writer", "FirestoreIndexValueWriter")
  @js.native
  ...
  object FirestoreIndexValueWriter {
    ...
    @JSImport("@firebase/firestore/dist/firestore/src/firestore_index_value_writer", "FirestoreIndexValueWriter.INSTANCE")
    @js.native
