...
object distLitePackagesFirestoreSrcLiteApiUserDataWriterMod {
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/lite-api/user_data_writer", "AbstractUserDataWriter")
  @js.native
