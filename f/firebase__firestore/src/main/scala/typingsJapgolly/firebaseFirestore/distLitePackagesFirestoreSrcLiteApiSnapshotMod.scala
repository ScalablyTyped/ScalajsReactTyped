...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiReferenceMod.DocumentReference
...
object distLitePackagesFirestoreSrcLiteApiSnapshotMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/lite-api/snapshot", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/lite-api/snapshot", "DocumentSnapshot")
  @js.native
  open class DocumentSnapshot[T] protected () extends StObject {
    ...
    /**
      ...
      */
    def exists(): /* is @firebase/firestore.@firebase/firestore/dist/lite/packages/firestore/src/lite-api/snapshot.QueryDocumentSnapshot<T> */ Boolean = js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/lite-api/snapshot", "QueryDocumentSnapshot")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/lite-api/snapshot", "QuerySnapshot")
  @js.native
  ...
  inline def fieldPathFromArgument(methodName: String, arg: String): typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcModelPathMod.FieldPath]
  inline def fieldPathFromArgument(methodName: String, arg: FieldPath): typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcModelPathMod.FieldPath]
  inline def fieldPathFromArgument(methodName: String, arg: Compat[FieldPath]): typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcModelPathMod.FieldPath]
