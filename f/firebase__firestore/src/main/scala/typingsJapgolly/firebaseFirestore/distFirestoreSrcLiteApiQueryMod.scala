...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreTargetMod.Bound
...
import typingsJapgolly.firebaseFirestore.distFirestoreSrcLiteApiUserDataReaderMod.UserDataReader
...
object distFirestoreSrcLiteApiQueryMod {
  ...
  inline def newQueryBoundFromDocument(
    query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query,
  ...
  inline def orderBy(fieldPath: typingsJapgolly.firebaseFirestore.distFirestoreSrcLiteApiFieldPathMod.FieldPath): QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(fieldPath.asInstanceOf[js.Any]).asInstanceOf[QueryConstraint]
  inline def orderBy(
  ...
  inline def validateHasExplicitOrderByForLimitToLast(query: typingsJapgolly.firebaseFirestore.distFirestoreSrcCoreQueryMod.Query): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("validateHasExplicitOrderByForLimitToLast")(query.asInstanceOf[js.Any]).asInstanceOf[Unit]
