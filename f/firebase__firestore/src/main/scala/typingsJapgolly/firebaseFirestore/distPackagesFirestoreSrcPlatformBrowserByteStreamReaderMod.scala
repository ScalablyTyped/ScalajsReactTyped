...
object distPackagesFirestoreSrcPlatformBrowserByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/platform/browser/byte_stream_reader", JSImport.Namespace)
  @js.native
