...
import typingsJapgolly.firebaseFirestore.apiCredentialsMod.Token
import typingsJapgolly.firebaseFirestore.remoteBackoffMod.ExponentialBackoff
import typingsJapgolly.firebaseFirestore.remoteConnectionMod.Connection
import typingsJapgolly.firebaseFirestore.remoteConnectionMod.Stream
...
@JSImport("@firebase/firestore/dist/src/remote/persistent_stream", "PersistentStream")
@js.native
