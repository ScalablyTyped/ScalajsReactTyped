...
object IFieldFilterOpEnum {
  ...
  extension [Self <: IFieldFilterOpEnum](x: Self) {
    ...
    inline def setValues(value: CallbackTo[js.Array[FieldFilterOp]]): Self = StObject.set(x, "values", value.toJsFn)
  }
}
