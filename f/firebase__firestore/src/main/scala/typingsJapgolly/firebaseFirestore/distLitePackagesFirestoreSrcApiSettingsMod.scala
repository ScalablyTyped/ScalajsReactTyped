...
object distLitePackagesFirestoreSrcApiSettingsMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/api/settings", "DEFAULT_HOST")
  @js.native
  val DEFAULT_HOST: /* "firestore.googleapis.com" */ String = js.native
  
  trait FirestoreSettings
    extends StObject
       with typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiSettingsMod.FirestoreSettings {
