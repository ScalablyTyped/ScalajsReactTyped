...
object distLitePackagesFirestoreSrcLocalIndexeddbIndexManagerMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/local/indexeddb_index_manager", "IndexedDbIndexManager")
  @js.native
