...
object distLiteFirestoreSrcPlatformBrowserByteStreamReaderMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/platform/browser/byte_stream_reader", JSImport.Namespace)
  @js.native
