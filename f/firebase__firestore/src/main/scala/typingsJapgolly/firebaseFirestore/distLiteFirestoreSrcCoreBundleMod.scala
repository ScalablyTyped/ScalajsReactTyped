...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcProtosFirestoreBundleProtoMod.BundledDocumentMetadata
...
object distLiteFirestoreSrcCoreBundleMod {
