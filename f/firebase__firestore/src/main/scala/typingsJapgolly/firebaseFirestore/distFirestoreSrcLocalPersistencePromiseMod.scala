...
import typingsJapgolly.firebaseFirestore.anon.ForEach
import typingsJapgolly.firebaseFirestore.anon.`1`
import typingsJapgolly.firebaseFirestore.anon.`2`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distFirestoreSrcLocalPersistencePromiseMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/local/persistence_promise", "PersistencePromise")
  @js.native
  ...
  object PersistencePromise {
    ...
    inline def waitFor(all: ForEach): PersistencePromise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("waitFor")(all.asInstanceOf[js.Any]).asInstanceOf[PersistencePromise[Unit]]
  }
