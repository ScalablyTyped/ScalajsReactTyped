...
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiComponentsMod.FirestoreService
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiSettingsMod.FirestoreSettings
import typingsJapgolly.firebaseFirestore.distLitePackagesFirestoreSrcLiteApiSettingsMod.FirestoreSettingsImpl
...
object distLitePackagesFirestoreSrcLiteApiDatabaseMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/lite-api/database", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/lite-api/database", "Firestore")
  @js.native
