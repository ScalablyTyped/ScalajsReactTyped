...
object distFirestoreSrcLocalIndexeddbLruDelegateImplMod {
  
  @JSImport("@firebase/firestore/dist/firestore/src/local/indexeddb_lru_delegate_impl", "IndexedDbLruDelegateImpl")
  @js.native
