...
object distLitePackagesFirestoreSrcIndexDotrnMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/index.rn", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/index.rn", "AbstractUserDataWriter")
  @js.native
  ...
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/index.rn", "AggregateQuerySnapshot")
  @js.native
  ...
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/index.rn", "QueryConstraint")
  @js.native
