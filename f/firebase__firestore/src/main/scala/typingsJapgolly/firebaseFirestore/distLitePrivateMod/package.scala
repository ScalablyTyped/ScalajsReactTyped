...
import typingsJapgolly.firebaseFirestore.anon.`38`
import typingsJapgolly.firebaseFirestore.distLitePrivateMod.^
...
type MapValue = typingsJapgolly.firebaseFirestore.distLitePrivateMod.firestoreV1ApiClientInterfaces.MapValue
...
type Value = typingsJapgolly.firebaseFirestore.distLitePrivateMod.firestoreV1ApiClientInterfaces.Value
