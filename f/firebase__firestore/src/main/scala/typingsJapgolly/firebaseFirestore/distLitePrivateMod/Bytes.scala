...
@JSImport("@firebase/firestore/dist/lite/private", "Bytes")
@js.native
open class Bytes protected () extends StObject {
  /** @hideconstructor */
  def this(byteString: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ByteString */ Any) = this()
  
  var _byteString: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ByteString */ Any = js.native
