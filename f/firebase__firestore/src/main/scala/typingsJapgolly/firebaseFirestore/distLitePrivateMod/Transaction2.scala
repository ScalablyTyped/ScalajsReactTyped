...
object Transaction2 {
  ...
  inline def apply(
    ...
    committed: Any,
    datastore: Any,
    delete: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any => Callback,
  ...
  extension [Self <: Transaction2](x: Self) {
    ...
    inline def setDelete(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any => Callback
    ): Self = StObject.set(x, "delete", js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any) => value(t0).runNow()))
    ...
    inline def setSet(
      value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any, ParsedSetData) => Callback
    ): Self = StObject.set(x, "set", js.Any.fromFunction2((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any, t1: ParsedSetData) => (value(t0, t1)).runNow()))
    
    inline def setUpdate(
      value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any, ParsedUpdateData) => Callback
    ): Self = StObject.set(x, "update", js.Any.fromFunction2((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DocumentKey */ Any, t1: ParsedUpdateData) => (value(t0, t1)).runNow()))
