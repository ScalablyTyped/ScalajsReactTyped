...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreDistIndexDotesm2017Mod.^
...
inline def getFirestore(e: Any, n: Any): typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcMod.Firestore = (^.asInstanceOf[js.Dynamic].applyDynamic("getFirestore")(e.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcMod.Firestore]
...
/**
  ...
  */ inline def initializeFirestore(t: Any, e: Any, n: Any): typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcMod.Firestore = (^.asInstanceOf[js.Dynamic].applyDynamic("initializeFirestore")(t.asInstanceOf[js.Any], e.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcMod.Firestore]
