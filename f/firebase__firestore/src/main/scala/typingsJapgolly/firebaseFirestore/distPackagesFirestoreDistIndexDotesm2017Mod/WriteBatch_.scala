...
open class WriteBatch_ protected ()
  ...
  /**
    ...
    */ /* CompleteClass */
  override def delete(t: Any): vl = js.native
  
  /* CompleteClass */
  override def set(t: Any, e: Any, n: Any): vl = js.native
  
  /* CompleteClass */
  override def update(t: Any, e: Any, n: Any, s: Any*): vl = js.native
}
