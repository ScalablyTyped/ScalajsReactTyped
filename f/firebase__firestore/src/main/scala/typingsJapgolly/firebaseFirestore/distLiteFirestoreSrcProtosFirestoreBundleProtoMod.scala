...
import typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcProtosFirestoreProtoApiMod.StructuredQuery
...
object distLiteFirestoreSrcProtosFirestoreBundleProtoMod {
