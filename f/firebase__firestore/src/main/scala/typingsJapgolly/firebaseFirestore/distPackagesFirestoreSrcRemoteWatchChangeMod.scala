...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcRemoteExistenceFilterMod.ExistenceFilter
...
object distPackagesFirestoreSrcRemoteWatchChangeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcRemoteWatchChangeMod.DocumentWatchChange
    - typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcRemoteWatchChangeMod.WatchTargetChange
    - typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcRemoteWatchChangeMod.ExistenceFilterChange
  */
