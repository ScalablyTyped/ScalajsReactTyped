...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLiteApiSettingsMod.FirestoreSettingsImpl
...
object distPackagesFirestoreSrcLiteApiComponentsMod {
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/components", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/firestore/dist/packages/firestore/src/lite-api/components", "LOG_TAG")
  @js.native
