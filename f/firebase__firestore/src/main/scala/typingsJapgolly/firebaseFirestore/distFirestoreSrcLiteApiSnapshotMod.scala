...
object distFirestoreSrcLiteApiSnapshotMod {
  ...
  inline def fieldPathFromArgument(methodName: String, arg: String): typingsJapgolly.firebaseFirestore.distFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseFirestore.distFirestoreSrcModelPathMod.FieldPath]
  inline def fieldPathFromArgument(methodName: String, arg: FieldPath): typingsJapgolly.firebaseFirestore.distFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseFirestore.distFirestoreSrcModelPathMod.FieldPath]
  inline def fieldPathFromArgument(methodName: String, arg: Compat[FieldPath]): typingsJapgolly.firebaseFirestore.distFirestoreSrcModelPathMod.FieldPath = (^.asInstanceOf[js.Dynamic].applyDynamic("fieldPathFromArgument")(methodName.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseFirestore.distFirestoreSrcModelPathMod.FieldPath]
