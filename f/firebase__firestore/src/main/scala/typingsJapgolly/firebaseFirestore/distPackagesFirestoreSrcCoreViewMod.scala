...
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreViewSnapshotMod.DocumentChangeSet
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreViewSnapshotMod.ViewSnapshot
import typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcLocalLocalStoreImplMod.QueryResult
...
object distPackagesFirestoreSrcCoreViewMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreViewMod.AddedLimboDocument
    - typingsJapgolly.firebaseFirestore.distPackagesFirestoreSrcCoreViewMod.RemovedLimboDocument
  */
