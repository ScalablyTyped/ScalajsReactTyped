...
object distLitePackagesFirestoreSrcPlatformBrowserConnectionMod {
  
  @JSImport("@firebase/firestore/dist/lite/packages/firestore/src/platform/browser/connection", JSImport.Namespace)
  @js.native
