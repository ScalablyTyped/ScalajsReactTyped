...
object distLiteFirestoreSrcLiteApiQueryMod {
  
  @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/query", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* note: abstract class */ @JSImport("@firebase/firestore/dist/lite/firestore/src/lite-api/query", "QueryConstraint")
  @js.native
  ...
  inline def newQueryBoundFromDocument(
    query: typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcCoreQueryMod.Query,
  ...
  inline def orderBy(fieldPath: typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcLiteApiFieldPathMod.FieldPath): QueryConstraint = ^.asInstanceOf[js.Dynamic].applyDynamic("orderBy")(fieldPath.asInstanceOf[js.Any]).asInstanceOf[QueryConstraint]
  inline def orderBy(
  ...
  inline def validateHasExplicitOrderByForLimitToLast(query: typingsJapgolly.firebaseFirestore.distLiteFirestoreSrcCoreQueryMod.Query): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("validateHasExplicitOrderByForLimitToLast")(query.asInstanceOf[js.Any]).asInstanceOf[Unit]
