...
object BrowsePageLayout extends StObject {
  ...
  /* 1 */ val grid: typingsJapgolly.flashpointLauncher.mod.BrowsePageLayout.grid & Double = js.native
  ...
  sealed trait list
    extends StObject
       with BrowsePageLayout
  /* 0 */ val list: typingsJapgolly.flashpointLauncher.mod.BrowsePageLayout.list & Double = js.native
}
