...
import typingsJapgolly.flashpointLauncher.anon.NewGame
import typingsJapgolly.flashpointLauncher.anon.NewPlaylist
import typingsJapgolly.flashpointLauncher.anon.OldGame
