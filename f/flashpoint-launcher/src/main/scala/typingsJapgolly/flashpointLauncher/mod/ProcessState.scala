...
object ProcessState extends StObject {
  ...
  sealed trait KILLING
    extends StObject
       with ProcessState
  /* 2 */ val KILLING: typingsJapgolly.flashpointLauncher.mod.ProcessState.KILLING & Double = js.native
  ...
  sealed trait RUNNING
    extends StObject
       with ProcessState
  /* 1 */ val RUNNING: typingsJapgolly.flashpointLauncher.mod.ProcessState.RUNNING & Double = js.native
  ...
  sealed trait STOPPED
    extends StObject
       with ProcessState
  /* 0 */ val STOPPED: typingsJapgolly.flashpointLauncher.mod.ProcessState.STOPPED & Double = js.native
}
