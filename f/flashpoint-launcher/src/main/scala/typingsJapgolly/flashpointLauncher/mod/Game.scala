...
object Game {
  ...
  extension [Self <: Game](x: Self) {
    ...
    inline def setUpdateTagsStr(value: Callback): Self = StObject.set(x, "updateTagsStr", value.toJsFn)
