...
import typingsJapgolly.ffiNapi.anon.Alignment
import typingsJapgolly.ffiNapi.anon.Elements
import typingsJapgolly.ffiNapi.ffiNapiStrings.void
import typingsJapgolly.refNapi.mod.CoerceType_
import typingsJapgolly.refNapi.mod.CoerceTypes
import typingsJapgolly.refNapi.mod.NamedType
import typingsJapgolly.refNapi.mod.NamedTypeLike
...
import typingsJapgolly.refNapi.mod.UnderlyingTypes
...
object mod {
  ...
  @js.native
  val Callback: typingsJapgolly.ffiNapi.mod.Callback = js.native
  ...
  open class FunctionCls[TReturnType /* <: NamedTypeLike */, TArgTypes /* <: js.Array[NamedTypeLike] | ArgTypesInferenceMarker */] protected ()
    ...
    /* CompleteClass */
    override def get(buffer: typingsJapgolly.refNapi.mod.global.Buffer, offset: Double): js.Function1[
  ...
  @js.native
  val Library: typingsJapgolly.ffiNapi.mod.Library = js.native
  ...
  object ffiType {
    ...
    inline def apply(`type`: TypeLike): Pointer[typingsJapgolly.ffiNapi.mod.ffiType.FFI_TYPE] = ^.asInstanceOf[js.Dynamic].apply(`type`.asInstanceOf[js.Any]).asInstanceOf[Pointer[typingsJapgolly.ffiNapi.mod.ffiType.FFI_TYPE]]
  ...
  type PFFI_TYPE = Pointer[typingsJapgolly.ffiNapi.mod.ffiType.FFI_TYPE]
  ...
  object refNapiAugmentingMod {
    ...
    object Type {
      ...
      inline def apply(): typingsJapgolly.ffiNapi.mod.refNapiAugmentingMod.Type = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.ffiNapi.mod.refNapiAugmentingMod.Type]
      }
      
      extension [Self <: typingsJapgolly.ffiNapi.mod.refNapiAugmentingMod.Type](x: Self) {
