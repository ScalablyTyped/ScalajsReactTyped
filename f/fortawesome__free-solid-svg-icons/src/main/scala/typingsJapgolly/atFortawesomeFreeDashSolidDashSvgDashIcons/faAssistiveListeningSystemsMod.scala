package typingsJapgolly.atFortawesomeFreeDashSolidDashSvgDashIcons
...
@JSImport("@fortawesome/free-solid-svg-icons/faAssistiveListeningSystems", JSImport.Namespace)
@js.native
object faAssistiveListeningSystemsMod extends js.Object {
