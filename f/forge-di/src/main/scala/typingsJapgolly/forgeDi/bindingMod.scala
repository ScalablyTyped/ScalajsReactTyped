...
import typingsJapgolly.forgeDi.predicateMod.Predicate
...
object bindingMod extends js.Object {
  ...
  trait Binding extends js.Object {
    ...
    var forge: typingsJapgolly.forgeDi.forgeMod.default = js.native
    var lifecycle: Lifecycle = js.native
    var name: String = js.native
    @JSName("predicate")
    var predicate_Original: Predicate = js.native
    var resolver: typingsJapgolly.forgeDi.resolverMod.default = js.native
