...
object firebaseAnalyticsCompatStrings {
  ...
  @js.native
  sealed trait generate_lead extends StObject
  ...
  @js.native
  sealed trait page_view extends StObject
