...
import typingsJapgolly.filepond.mod.^
...
inline def create(): typingsJapgolly.filepond.anon.FilePond = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typingsJapgolly.filepond.anon.FilePond]
inline def create(element: Element): typingsJapgolly.filepond.anon.FilePond = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(element.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.filepond.anon.FilePond]
inline def create(element: Element, options: FilePondOptions): typingsJapgolly.filepond.anon.FilePond = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(element.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.filepond.anon.FilePond]
inline def create(element: Unit, options: FilePondOptions): typingsJapgolly.filepond.anon.FilePond = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(element.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.filepond.anon.FilePond]
...
inline def find(element: Element): typingsJapgolly.filepond.anon.FilePond = ^.asInstanceOf[js.Dynamic].applyDynamic("find")(element.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.filepond.anon.FilePond]
