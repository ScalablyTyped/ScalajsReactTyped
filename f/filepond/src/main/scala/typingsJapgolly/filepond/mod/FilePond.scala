...
import typingsJapgolly.filepond.anon.Index
import typingsJapgolly.filepond.anon.IndexNumber
import typingsJapgolly.filepond.anon.Output
...
open class FilePond () extends StObject {
  ...
  def addFile(source: String, options: Index & Partial[typingsJapgolly.filepond.anon.File]): js.Promise[FilePondFile] = js.native
  def addFile(source: Blob): js.Promise[FilePondFile] = js.native
  def addFile(source: Blob, options: Index & Partial[typingsJapgolly.filepond.anon.File]): js.Promise[FilePondFile] = js.native
  /**
    * Adds a file.
  ...
  def addFile(source: ActualFileObject, options: Index & Partial[typingsJapgolly.filepond.anon.File]): js.Promise[FilePondFile] = js.native
