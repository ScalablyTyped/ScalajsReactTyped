...
import typingsJapgolly.filepond.filepondStrings.input
import typingsJapgolly.filepond.filepondStrings.integrated
import typingsJapgolly.filepond.filepondStrings.limbo
import typingsJapgolly.filepond.filepondStrings.local
import typingsJapgolly.filepond.mod.ActualFileObject
import typingsJapgolly.filepond.mod.CaptureAttribute
import typingsJapgolly.filepond.mod.FetchServerConfigFunction
import typingsJapgolly.filepond.mod.FilePondErrorDescription
import typingsJapgolly.filepond.mod.FilePondEvent
import typingsJapgolly.filepond.mod.FilePondEventPrefixed
...
import typingsJapgolly.filepond.mod.LoadServerConfigFunction
import typingsJapgolly.filepond.mod.ProcessServerChunkTransferOptions
import typingsJapgolly.filepond.mod.ProcessServerConfigFunction
import typingsJapgolly.filepond.mod.ProgressServerConfigFunction
import typingsJapgolly.filepond.mod.RemoveFileOptions
import typingsJapgolly.filepond.mod.RemoveServerConfigFunction
import typingsJapgolly.filepond.mod.RestoreServerConfigFunction
import typingsJapgolly.filepond.mod.RevertServerConfigFunction
import typingsJapgolly.filepond.mod.ServerUrl
import typingsJapgolly.filepond.mod.Status
  ...
  object Fetch {
    ...
    extension [Self <: Fetch](x: Self) {
      ...
      inline def setFetchFunction6(
        value: (/* url */ String, /* load */ js.Function1[/* file */ ActualFileObject | Blob, Unit], /* error */ js.Function1[/* errorText */ String, Unit], /* progress */ ProgressServerConfigFunction, /* abort */ js.Function0[Unit], /* headers */ js.Function1[/* headersString */ String, Unit]) => Callback
      ): Self = StObject.set(x, "fetch", js.Any.fromFunction6((t0: /* url */ String, t1: /* load */ js.Function1[/* file */ ActualFileObject | Blob, Unit], t2: /* error */ js.Function1[/* errorText */ String, Unit], t3: /* progress */ ProgressServerConfigFunction, t4: /* abort */ js.Function0[Unit], t5: /* headers */ js.Function1[/* headersString */ String, Unit]) => (value(t0, t1, t2, t3, t4, t5)).runNow()))
      ...
      inline def setLoadFunction6(
        value: (/* source */ Any, /* load */ js.Function1[/* file */ ActualFileObject | Blob, Unit], /* error */ js.Function1[/* errorText */ String, Unit], /* progress */ ProgressServerConfigFunction, /* abort */ js.Function0[Unit], /* headers */ js.Function1[/* headersString */ String, Unit]) => Callback
      ): Self = StObject.set(x, "load", js.Any.fromFunction6((t0: /* source */ Any, t1: /* load */ js.Function1[/* file */ ActualFileObject | Blob, Unit], t2: /* error */ js.Function1[/* errorText */ String, Unit], t3: /* progress */ ProgressServerConfigFunction, t4: /* abort */ js.Function0[Unit], t5: /* headers */ js.Function1[/* headersString */ String, Unit]) => (value(t0, t1, t2, t3, t4, t5)).runNow()))
      ...
      inline def setProcessFunction9(
        value: (/* fieldName */ String, /* file */ ActualFileObject, /* metadata */ StringDictionary[Any], /* load */ js.Function1[/* p */ String | StringDictionary[Any], Unit], /* error */ js.Function1[/* errorText */ String, Unit], /* progress */ ProgressServerConfigFunction, /* abort */ js.Function0[Unit], /* transfer */ js.Function1[/* transferId */ String, Unit], /* options */ ProcessServerChunkTransferOptions) => Callback
      ): Self = StObject.set(x, "process", js.Any.fromFunction9((t0: /* fieldName */ String, t1: /* file */ ActualFileObject, t2: /* metadata */ StringDictionary[Any], t3: /* load */ js.Function1[/* p */ String | StringDictionary[Any], Unit], t4: /* error */ js.Function1[/* errorText */ String, Unit], t5: /* progress */ ProgressServerConfigFunction, t6: /* abort */ js.Function0[Unit], t7: /* transfer */ js.Function1[/* transferId */ String, Unit], t8: /* options */ ProcessServerChunkTransferOptions) => (value(t0, t1, t2, t3, t4, t5, t6, t7, t8)).runNow()))
      ...
      inline def setRemove(
        value: (/* source */ Any, /* load */ js.Function0[Unit], /* error */ js.Function1[/* errorText */ String, Unit]) => Callback
      ): Self = StObject.set(x, "remove", js.Any.fromFunction3((t0: /* source */ Any, t1: /* load */ js.Function0[Unit], t2: /* error */ js.Function1[/* errorText */ String, Unit]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setRestoreFunction6(
        value: (/* uniqueFileId */ Any, /* load */ js.Function1[/* file */ ActualFileObject, Unit], /* error */ js.Function1[/* errorText */ String, Unit], /* progress */ ProgressServerConfigFunction, /* abort */ js.Function0[Unit], /* headers */ js.Function1[/* headersString */ String, Unit]) => Callback
      ): Self = StObject.set(x, "restore", js.Any.fromFunction6((t0: /* uniqueFileId */ Any, t1: /* load */ js.Function1[/* file */ ActualFileObject, Unit], t2: /* error */ js.Function1[/* errorText */ String, Unit], t3: /* progress */ ProgressServerConfigFunction, t4: /* abort */ js.Function0[Unit], t5: /* headers */ js.Function1[/* headersString */ String, Unit]) => (value(t0, t1, t2, t3, t4, t5)).runNow()))
      ...
      inline def setRevertFunction3(
        value: (/* uniqueFieldId */ Any, /* load */ js.Function0[Unit], /* error */ js.Function1[/* errorText */ String, Unit]) => Callback
      ): Self = StObject.set(x, "revert", js.Any.fromFunction3((t0: /* uniqueFieldId */ Any, t1: /* load */ js.Function0[Unit], t2: /* error */ js.Function1[/* errorText */ String, Unit]) => (value(t0, t1, t2)).runNow()))
