...
object mod {
  ...
  object F1Options {
    ...
    extension [Self <: F1Options](x: Self) {
      ...
      inline def setOnState(value: /* repeated */ Any => Callback): Self = StObject.set(x, "onState", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
      
      inline def setOnStateUndefined: Self = StObject.set(x, "onState", js.undefined)
      
      inline def setOnUpdate(value: /* repeated */ Any => Callback): Self = StObject.set(x, "onUpdate", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
