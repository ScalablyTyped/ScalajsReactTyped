...
object buildSrcTransformsMod {
  ...
  open class HeaderTransformer[O /* <: Row[Any] */] protected ()
    extends typingsJapgolly.fastCsvParse.buildSrcTransformsHeaderTransformerMod.HeaderTransformer[O] {
  ...
  open class RowTransformerValidator[I /* <: Row[Any] */, O /* <: Row[Any] */] ()
    extends typingsJapgolly.fastCsvParse.buildSrcTransformsRowTransformerValidatorMod.RowTransformerValidator[I, O]
  /* static members */
