...
import typingsJapgolly.firebaseAnalytics.distEsmSrcErrorsMod.AnalyticsError
import typingsJapgolly.firebaseAnalytics.distSrcConstantsMod.GtagCommand
import typingsJapgolly.firebaseAnalytics.distSrcPublicTypesMod.ConsentStatusString
import typingsJapgolly.firebaseAnalytics.distSrcPublicTypesMod.EventNameString
...
object firebaseAnalyticsStrings {
  ...
  sealed trait add_payment_info
    extends StObject
       ...
       with typingsJapgolly.firebaseAnalytics.distEsmSrcPublicTypesMod.EventNameString
       with typingsJapgolly.firebaseAnalytics.mod.EventNameString
       with typingsJapgolly.firebaseAnalytics.distAnalyticsMod.EventNameString
  ...
  sealed trait `already-exists`
    extends StObject
       with AnalyticsError
       with typingsJapgolly.firebaseAnalytics.distSrcErrorsMod.AnalyticsError
  ...
  sealed trait config
    extends StObject
       with GtagCommand
       with typingsJapgolly.firebaseAnalytics.distEsmSrcConstantsMod.GtagCommand
  ...
  sealed trait denied
    extends StObject
       ...
       with typingsJapgolly.firebaseAnalytics.distEsmSrcPublicTypesMod.ConsentStatusString
       with typingsJapgolly.firebaseAnalytics.mod.ConsentStatusString
       with typingsJapgolly.firebaseAnalytics.distAnalyticsMod.ConsentStatusString
