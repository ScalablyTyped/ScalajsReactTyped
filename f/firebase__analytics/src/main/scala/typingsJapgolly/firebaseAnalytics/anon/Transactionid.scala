...
trait Transactionid
  ...
  var shipping: js.UndefOr[typingsJapgolly.firebaseAnalytics.distSrcPublicTypesMod.Currency] = js.undefined
  
  var tax: js.UndefOr[typingsJapgolly.firebaseAnalytics.distSrcPublicTypesMod.Currency] = js.undefined
...
object Transactionid {
  ...
  extension [Self <: Transactionid](x: Self) {
    ...
    inline def setShipping(value: typingsJapgolly.firebaseAnalytics.distSrcPublicTypesMod.Currency): Self = StObject.set(x, "shipping", value.asInstanceOf[js.Any])
    
    inline def setShippingUndefined: Self = StObject.set(x, "shipping", js.undefined)
    
    inline def setTax(value: typingsJapgolly.firebaseAnalytics.distSrcPublicTypesMod.Currency): Self = StObject.set(x, "tax", value.asInstanceOf[js.Any])
