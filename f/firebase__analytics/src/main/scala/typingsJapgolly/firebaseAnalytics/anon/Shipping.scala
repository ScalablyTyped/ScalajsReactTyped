...
trait Shipping
  ...
  var shipping: js.UndefOr[typingsJapgolly.firebaseAnalytics.distAnalyticsMod.Currency] = js.undefined
  
  var tax: js.UndefOr[typingsJapgolly.firebaseAnalytics.distAnalyticsMod.Currency] = js.undefined
...
object Shipping {
  ...
  extension [Self <: Shipping](x: Self) {
    ...
    inline def setShipping(value: typingsJapgolly.firebaseAnalytics.distAnalyticsMod.Currency): Self = StObject.set(x, "shipping", value.asInstanceOf[js.Any])
    
    inline def setShippingUndefined: Self = StObject.set(x, "shipping", js.undefined)
    
    inline def setTax(value: typingsJapgolly.firebaseAnalytics.distAnalyticsMod.Currency): Self = StObject.set(x, "tax", value.asInstanceOf[js.Any])
