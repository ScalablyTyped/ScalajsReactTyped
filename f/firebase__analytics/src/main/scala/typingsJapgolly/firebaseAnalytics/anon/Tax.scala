...
trait Tax
  ...
  var shipping: js.UndefOr[typingsJapgolly.firebaseAnalytics.distEsmSrcPublicTypesMod.Currency] = js.undefined
  
  var tax: js.UndefOr[typingsJapgolly.firebaseAnalytics.distEsmSrcPublicTypesMod.Currency] = js.undefined
...
object Tax {
  ...
  extension [Self <: Tax](x: Self) {
    ...
    inline def setShipping(value: typingsJapgolly.firebaseAnalytics.distEsmSrcPublicTypesMod.Currency): Self = StObject.set(x, "shipping", value.asInstanceOf[js.Any])
    
    inline def setShippingUndefined: Self = StObject.set(x, "shipping", js.undefined)
    
    inline def setTax(value: typingsJapgolly.firebaseAnalytics.distEsmSrcPublicTypesMod.Currency): Self = StObject.set(x, "tax", value.asInstanceOf[js.Any])
