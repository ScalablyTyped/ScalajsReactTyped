...
import typingsJapgolly.firebaseAnalytics.distSrcPublicTypesMod.Item
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ItemlistidItemlistname
  extends StObject
...
object ItemlistidItemlistname {
  
  inline def apply(): ItemlistidItemlistname = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ItemlistidItemlistname]
  }
  
  extension [Self <: ItemlistidItemlistname](x: Self) {
