...
import typingsJapgolly.favicons.anon.RecordPlatformNameFileOpt
import typingsJapgolly.favicons.anon.RecordPlatformNameIconOpt
import typingsJapgolly.favicons.mod.Application
import typingsJapgolly.favicons.mod.OutputOptions
import typingsJapgolly.favicons.mod.ShortcutOptions
