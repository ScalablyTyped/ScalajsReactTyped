...
import typingsJapgolly.faviconsWebpackPlugin.srcOptionsMod.FaviconWebpackPlugionInternalOptions
import typingsJapgolly.faviconsWebpackPlugin.srcOptionsMod.FaviconWebpackPlugionOptions
...
object srcMod {
  ...
  object FaviconsWebpackPlugin {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1((t0: Any) => apply(t0).runNow()), generateFaviconsLight = js.Any.fromFunction2(generateFaviconsLight), generateFaviconsWebapp = js.Any.fromFunction2(generateFaviconsWebapp), getCurrentCompilationMode = js.Any.fromFunction1(getCurrentCompilationMode), options = options.asInstanceOf[js.Any])
      __obj.asInstanceOf[FaviconsWebpackPlugin]
    }
    
    extension [Self <: FaviconsWebpackPlugin](x: Self) {
      
      inline def setApply(value: Any => Callback): Self = StObject.set(x, "apply", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
