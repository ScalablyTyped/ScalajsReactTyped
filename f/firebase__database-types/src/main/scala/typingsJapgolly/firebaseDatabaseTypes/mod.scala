...
import typingsJapgolly.firebaseDatabaseTypes.anon.MockUserToken
...
object mod {
  ...
  object DataSnapshot {
    ...
    extension [Self <: DataSnapshot](x: Self) {
      ...
      inline def setExportVal(value: CallbackTo[Any]): Self = StObject.set(x, "exportVal", value.toJsFn)
  ...
  */
  ...
  object EventType {
    ...
    inline def child_added: typingsJapgolly.firebaseDatabaseTypes.firebaseDatabaseTypesStrings.child_added = "child_added".asInstanceOf[typingsJapgolly.firebaseDatabaseTypes.firebaseDatabaseTypesStrings.child_added]
    
    inline def child_changed: typingsJapgolly.firebaseDatabaseTypes.firebaseDatabaseTypesStrings.child_changed = "child_changed".asInstanceOf[typingsJapgolly.firebaseDatabaseTypes.firebaseDatabaseTypesStrings.child_changed]
    
    inline def child_moved: typingsJapgolly.firebaseDatabaseTypes.firebaseDatabaseTypesStrings.child_moved = "child_moved".asInstanceOf[typingsJapgolly.firebaseDatabaseTypes.firebaseDatabaseTypesStrings.child_moved]
    
    inline def child_removed: typingsJapgolly.firebaseDatabaseTypes.firebaseDatabaseTypesStrings.child_removed = "child_removed".asInstanceOf[typingsJapgolly.firebaseDatabaseTypes.firebaseDatabaseTypesStrings.child_removed]
    
    inline def value: typingsJapgolly.firebaseDatabaseTypes.firebaseDatabaseTypesStrings.value = "value".asInstanceOf[typingsJapgolly.firebaseDatabaseTypes.firebaseDatabaseTypesStrings.value]
  }
