...
object DataSnapshot {
  ...
  def apply(
    ...
    __obj.updateDynamic("forEach")(js.Any.fromFunction1((t0: js.Function1[typingsJapgolly.firebaseDatabaseTypes.mod.DataSnapshot, scala.Boolean | scala.Unit]) => forEach(t0).runNow()))
