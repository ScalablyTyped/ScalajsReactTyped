package typingsJapgolly.findupSync.mod
...
trait Options
  extends typingsJapgolly.micromatch.mod.Options
...
object Options {
  ...
  def apply(
    ...
    expandRange: (/* left */ String, /* right */ String, /* options */ typingsJapgolly.micromatch.mod.Options) => CallbackTo[String] = null,
