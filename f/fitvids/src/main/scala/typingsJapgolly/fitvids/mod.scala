...
object mod {
  ...
  inline def apply(parentSelector: NodeList[Element & Node]): Unit = ^.asInstanceOf[js.Dynamic].apply(parentSelector.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def apply(parentSelector: NodeList[Element & Node], options: Options): Unit = (^.asInstanceOf[js.Dynamic].apply(parentSelector.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
