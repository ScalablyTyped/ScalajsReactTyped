package typingsJapgolly.fitvids

import org.scalajs.dom.Element
import org.scalajs.dom.Node
import org.scalajs.dom.NodeList
import typingsJapgolly.fitvids.mod.Options
...
object global {
  ...
  inline def fitvids(parentSelector: NodeList[Element & Node]): Unit = js.Dynamic.global.applyDynamic("fitvids")(parentSelector.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def fitvids(parentSelector: NodeList[Element & Node], options: Options): Unit = (js.Dynamic.global.applyDynamic("fitvids")(parentSelector.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
