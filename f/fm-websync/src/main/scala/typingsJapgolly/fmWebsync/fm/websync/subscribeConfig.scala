...
object subscribeConfig {
  ...
  extension [Self <: subscribeConfig](x: Self) {
    ...
    inline def setOnComplete(value: /* args */ subscribeCompleteArgs => Callback): Self = StObject.set(x, "onComplete", js.Any.fromFunction1((t0: /* args */ subscribeCompleteArgs) => value(t0).runNow()))
    
    inline def setOnCompleteUndefined: Self = StObject.set(x, "onComplete", js.undefined)
    
    inline def setOnFailure(value: /* args */ subscribeFailureArgs => Callback): Self = StObject.set(x, "onFailure", js.Any.fromFunction1((t0: /* args */ subscribeFailureArgs) => value(t0).runNow()))
    
    inline def setOnFailureUndefined: Self = StObject.set(x, "onFailure", js.undefined)
    
    inline def setOnReceive(value: /* args */ receiveArgs => Callback): Self = StObject.set(x, "onReceive", js.Any.fromFunction1((t0: /* args */ receiveArgs) => value(t0).runNow()))
    
    inline def setOnReceiveUndefined: Self = StObject.set(x, "onReceive", js.undefined)
    
    inline def setOnSubscribersChange(value: /* args */ subscribersChangeArgs => Callback): Self = StObject.set(x, "onSubscribersChange", js.Any.fromFunction1((t0: /* args */ subscribersChangeArgs) => value(t0).runNow()))
    
    inline def setOnSubscribersChangeUndefined: Self = StObject.set(x, "onSubscribersChange", js.undefined)
    
    inline def setOnSuccess(value: /* args */ subscribeSuccessArgs => Callback): Self = StObject.set(x, "onSuccess", js.Any.fromFunction1((t0: /* args */ subscribeSuccessArgs) => value(t0).runNow()))
