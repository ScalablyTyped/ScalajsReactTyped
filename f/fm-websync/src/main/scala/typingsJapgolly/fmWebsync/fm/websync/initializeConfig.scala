...
object initializeConfig {
  ...
  extension [Self <: initializeConfig](x: Self) {
    ...
    inline def setOnComplete(value: /* args */ baseArgs => Callback): Self = StObject.set(x, "onComplete", js.Any.fromFunction1((t0: /* args */ baseArgs) => value(t0).runNow()))
    
    inline def setOnCompleteUndefined: Self = StObject.set(x, "onComplete", js.undefined)
    
    inline def setOnFailure(value: /* args */ initializeFailureArgs => Callback): Self = StObject.set(x, "onFailure", js.Any.fromFunction1((t0: /* args */ initializeFailureArgs) => value(t0).runNow()))
    
    inline def setOnFailureUndefined: Self = StObject.set(x, "onFailure", js.undefined)
    
    inline def setOnSuccess(value: /* args */ baseArgs => Callback): Self = StObject.set(x, "onSuccess", js.Any.fromFunction1((t0: /* args */ baseArgs) => value(t0).runNow()))
