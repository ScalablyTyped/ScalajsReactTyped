...
object initializeConfig {
  ...
  def apply(
    ...
    key: String = null,
    onComplete: /* args */ baseArgs => Callback = null,
    onFailure: /* args */ initializeFailureArgs => Callback = null,
    onSuccess: /* args */ baseArgs => Callback = null,
    ...
    if (onComplete != null) __obj.updateDynamic("onComplete")(js.Any.fromFunction1((t0: /* args */ typingsJapgolly.fmWebsync.fm.websync.baseArgs) => onComplete(t0).runNow()))
    if (onFailure != null) __obj.updateDynamic("onFailure")(js.Any.fromFunction1((t0: /* args */ typingsJapgolly.fmWebsync.fm.websync.initializeFailureArgs) => onFailure(t0).runNow()))
    if (onSuccess != null) __obj.updateDynamic("onSuccess")(js.Any.fromFunction1((t0: /* args */ typingsJapgolly.fmWebsync.fm.websync.baseArgs) => onSuccess(t0).runNow()))
