package typingsJapgolly.fbdlCore

import typingsJapgolly.fbdlCore.anon.Angry
import typingsJapgolly.fbdlCore.anon.Avatar
import typingsJapgolly.fbdlCore.anon.Name
