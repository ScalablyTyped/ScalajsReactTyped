...
import typingsJapgolly.ffi.anon.RTLDDEFAUL
import typingsJapgolly.ref.mod.Type
import typingsJapgolly.refStruct.mod.StructType
...
object mod {
  ...
  @js.native
  val Callback: typingsJapgolly.ffi.mod.Callback = js.native
  ...
  object DynamicLibrary {
    ...
    extension [Self <: DynamicLibrary](x: Self) {
      ...
      inline def setClose(value: CallbackTo[Double]): Self = StObject.set(x, "close", value.toJsFn)
      
      inline def setError(value: CallbackTo[String]): Self = StObject.set(x, "error", value.toJsFn)
  ...
  open class FunctionCls protected ()
    ...
    /* CompleteClass */
    override def get(buffer: typingsJapgolly.node.bufferMod.global.Buffer, offset: Double): Any = js.native
    ...
    /* CompleteClass */
    override def set(buffer: typingsJapgolly.node.bufferMod.global.Buffer, offset: Double, value: Any): Unit = js.native
  ...
  @js.native
  val Library: typingsJapgolly.ffi.mod.Library = js.native
  ...
  object ffiType {
    ...
    inline def FFI_TYPE(arg: typingsJapgolly.node.bufferMod.global.Buffer): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("FFI_TYPE")(arg.asInstanceOf[js.Any]).asInstanceOf[Any]
    inline def FFI_TYPE(arg: typingsJapgolly.node.bufferMod.global.Buffer, data: js.Object): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("FFI_TYPE")(arg.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[Any]
