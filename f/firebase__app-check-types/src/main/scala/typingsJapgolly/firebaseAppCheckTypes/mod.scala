package typingsJapgolly.firebaseAppCheckTypes

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.firebaseAppCheckTypes.firebaseAppCheckTypesStrings.appCheck
...
object mod {
  ...
  object AppCheckProvider {
    ...
    inline def apply(getToken: CallbackTo[js.Promise[AppCheckToken]]): AppCheckProvider = {
