...
import typingsJapgolly.fileServicesNode.distNodeFsMod.ICreateNodeFsOptions
import typingsJapgolly.fileServicesNode.distWatchServiceMod.INodeWatchServiceOptions
...
object distMod {
  ...
  open class NodeWatchService ()
    extends typingsJapgolly.fileServicesNode.distWatchServiceMod.NodeWatchService {
