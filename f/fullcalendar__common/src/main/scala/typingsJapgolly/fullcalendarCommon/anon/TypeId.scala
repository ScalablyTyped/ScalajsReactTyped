...
trait TypeId extends StObject {
  ...
  var duration: typingsJapgolly.fullcalendarCommon.mod.Duration
...
object TypeId {
  ...
  inline def apply(duration: typingsJapgolly.fullcalendarCommon.mod.Duration, typeData: Any, typeId: Double): TypeId = {
  ...
  extension [Self <: TypeId](x: Self) {
    ...
    inline def setDuration(value: typingsJapgolly.fullcalendarCommon.mod.Duration): Self = StObject.set(x, "duration", value.asInstanceOf[js.Any])
