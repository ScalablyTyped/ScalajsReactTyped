...
/* Inlined @fullcalendar/common.@fullcalendar/common.MountArg<@fullcalendar/common.@fullcalendar/common.DayHeaderContentArg> */
...
object DayHeaderMountArg {
  ...
  extension [Self <: DayHeaderMountArg](x: Self) {
