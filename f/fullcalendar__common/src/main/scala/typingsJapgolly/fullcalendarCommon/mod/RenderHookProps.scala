...
object RenderHookProps {
  ...
  inline def apply[ContentArg](
    ...
    val __obj = js.Dynamic.literal(children = js.Any.fromFunction4(children), classNames = classNames.asInstanceOf[js.Any], content = content.asInstanceOf[js.Any], didMount = js.Any.fromFunction1((t0: MountArg[ContentArg]) => didMount(t0).runNow()), hookProps = hookProps.asInstanceOf[js.Any], willUnmount = js.Any.fromFunction1((t0: MountArg[ContentArg]) => willUnmount(t0).runNow()))
