...
object EventSource {
  ...
  extension [Self <: EventSource[?], Meta](x: Self & EventSource[Meta]) {
    ...
    inline def setFailure(value: /* error */ EventSourceError => Callback): Self = StObject.set(x, "failure", js.Any.fromFunction1((t0: /* error */ EventSourceError) => value(t0).runNow()))
