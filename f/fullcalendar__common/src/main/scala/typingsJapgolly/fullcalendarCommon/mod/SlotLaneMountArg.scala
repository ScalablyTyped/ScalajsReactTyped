...
/* Inlined @fullcalendar/common.@fullcalendar/common.MountArg<@fullcalendar/common.@fullcalendar/common.SlotLaneContentArg> */
...
object SlotLaneMountArg {
  ...
  extension [Self <: SlotLaneMountArg](x: Self) {
