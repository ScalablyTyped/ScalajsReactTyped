...
import typingsJapgolly.fullcalendarCommon.anon.End
...
open class DateProfileGenerator protected () extends StObject {
  ...
  def buildCurrentRangeInfo(date: js.Date, direction: Any): typingsJapgolly.fullcalendarCommon.anon.Duration = js.native
