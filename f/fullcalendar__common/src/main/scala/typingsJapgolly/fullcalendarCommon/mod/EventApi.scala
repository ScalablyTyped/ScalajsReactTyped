...
import typingsJapgolly.fullcalendarCommon.anon.AllDay
import typingsJapgolly.fullcalendarCommon.anon.CollapseColor
import typingsJapgolly.fullcalendarCommon.anon.Granularity
import typingsJapgolly.fullcalendarCommon.anon.MaintainDuration
import typingsJapgolly.fullcalendarCommon.anon.`9`
