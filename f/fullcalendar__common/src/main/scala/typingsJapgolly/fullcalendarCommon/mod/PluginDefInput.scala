...
object PluginDefInput {
  ...
  extension [Self <: PluginDefInput](x: Self) {
    ...
    inline def setContextInit(value: /* context */ CalendarContext => Callback): Self = StObject.set(x, "contextInit", js.Any.fromFunction1((t0: /* context */ CalendarContext) => value(t0).runNow()))
