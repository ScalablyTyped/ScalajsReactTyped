...
trait BuiltInEventSourceRefiners extends StObject {
  ...
  @JSName("events")
  var events_Original: Identity_[js.Array[EventInput] | EventSourceFunc]
  ...
  @JSName("extraParams")
  var extraParams_Original: Identity_[Dictionary | js.Function0[Dictionary]]
  
  def failure(raw: EventSourceErrorResponseHandler): EventSourceErrorResponseHandler
  @JSName("failure")
  var failure_Original: Identity_[EventSourceErrorResponseHandler]
  ...
  @JSName("success")
  var success_Original: Identity_[EventSourceSuccessResponseHandler]
