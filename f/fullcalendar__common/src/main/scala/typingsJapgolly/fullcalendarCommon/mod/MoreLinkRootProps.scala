...
object MoreLinkRootProps {
  ...
  extension [Self <: MoreLinkRootProps](x: Self) {
    ...
    inline def setPopoverContent(value: CallbackTo[Any]): Self = StObject.set(x, "popoverContent", value.toJsFn)
