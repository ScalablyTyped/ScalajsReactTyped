...
object anon {
  ...
  object OnFirstInputDelay {
    ...
    inline def apply(onFirstInputDelay: js.Function1[/* fid */ Double, Unit] => Callback): OnFirstInputDelay = {
      val __obj = js.Dynamic.literal(onFirstInputDelay = js.Any.fromFunction1((t0: js.Function1[/* fid */ Double, Unit]) => onFirstInputDelay(t0).runNow()))
      __obj.asInstanceOf[OnFirstInputDelay]
    }
    
    extension [Self <: OnFirstInputDelay](x: Self) {
      
      inline def setOnFirstInputDelay(value: js.Function1[/* fid */ Double, Unit] => Callback): Self = StObject.set(x, "onFirstInputDelay", js.Any.fromFunction1((t0: js.Function1[/* fid */ Double, Unit]) => value(t0).runNow()))
    }
  }
