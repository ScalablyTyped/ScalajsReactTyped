...
object distSrcUtilsAttributesUtilsMod {
  ...
  object VisibilityState extends StObject {
    ...
    /* 2 */ val HIDDEN: typingsJapgolly.firebasePerformance.distSrcUtilsAttributesUtilsMod.VisibilityState.HIDDEN & Double = js.native
    
    @js.native
    sealed trait UNKNOWN
      extends StObject
         with VisibilityState
    /* 0 */ val UNKNOWN: typingsJapgolly.firebasePerformance.distSrcUtilsAttributesUtilsMod.VisibilityState.UNKNOWN & Double = js.native
    
    @js.native
    sealed trait VISIBLE
      extends StObject
         with VisibilityState
    /* 1 */ val VISIBLE: typingsJapgolly.firebasePerformance.distSrcUtilsAttributesUtilsMod.VisibilityState.VISIBLE & Double = js.native
  }
