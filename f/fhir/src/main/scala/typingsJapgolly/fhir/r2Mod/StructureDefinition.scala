...
import typingsJapgolly.fhir.fhirStrings.`extension`
import typingsJapgolly.fhir.fhirStrings.active
import typingsJapgolly.fhir.fhirStrings.datatype
import typingsJapgolly.fhir.fhirStrings.draft
import typingsJapgolly.fhir.fhirStrings.logical
import typingsJapgolly.fhir.fhirStrings.mapping
...
trait StructureDefinition
  ...
  @JSName("resourceType")
  val resourceType_StructureDefinition: typingsJapgolly.fhir.fhirStrings.StructureDefinition
...
object StructureDefinition {
  ...
  extension [Self <: StructureDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.StructureDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
