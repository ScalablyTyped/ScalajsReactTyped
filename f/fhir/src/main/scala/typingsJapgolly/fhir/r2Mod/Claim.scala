...
import typingsJapgolly.fhir.fhirStrings.exploratory
import typingsJapgolly.fhir.fhirStrings.institutional
import typingsJapgolly.fhir.fhirStrings.oral
import typingsJapgolly.fhir.fhirStrings.other
import typingsJapgolly.fhir.fhirStrings.pharmacy
import typingsJapgolly.fhir.fhirStrings.professional
import typingsJapgolly.fhir.fhirStrings.proposed
import typingsJapgolly.fhir.fhirStrings.vision
...
trait Claim
  ...
  @JSName("resourceType")
  val resourceType_Claim: typingsJapgolly.fhir.fhirStrings.Claim
...
object Claim {
  ...
  extension [Self <: Claim](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Claim): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
