...
import typingsJapgolly.fhir.fhirStrings.replaced
...
trait OrderResponse
  ...
  @JSName("resourceType")
  val resourceType_OrderResponse: typingsJapgolly.fhir.fhirStrings.OrderResponse
...
object OrderResponse {
  ...
  extension [Self <: OrderResponse](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.OrderResponse): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
