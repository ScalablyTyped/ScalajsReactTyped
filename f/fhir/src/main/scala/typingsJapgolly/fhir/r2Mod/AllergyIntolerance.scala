...
import typingsJapgolly.fhir.fhirStrings.CRITH
import typingsJapgolly.fhir.fhirStrings.CRITL
import typingsJapgolly.fhir.fhirStrings.CRITU
import typingsJapgolly.fhir.fhirStrings.`entered-in-error`
import typingsJapgolly.fhir.fhirStrings.active
import typingsJapgolly.fhir.fhirStrings.allergy
import typingsJapgolly.fhir.fhirStrings.confirmed
import typingsJapgolly.fhir.fhirStrings.environment
import typingsJapgolly.fhir.fhirStrings.food
import typingsJapgolly.fhir.fhirStrings.inactive
import typingsJapgolly.fhir.fhirStrings.intolerance
...
import typingsJapgolly.fhir.fhirStrings.unconfirmed
...
trait AllergyIntolerance
  ...
  @JSName("resourceType")
  val resourceType_AllergyIntolerance: typingsJapgolly.fhir.fhirStrings.AllergyIntolerance
...
object AllergyIntolerance {
  ...
  extension [Self <: AllergyIntolerance](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.AllergyIntolerance): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
