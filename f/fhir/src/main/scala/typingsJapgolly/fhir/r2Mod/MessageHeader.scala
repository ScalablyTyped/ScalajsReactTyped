...
trait MessageHeader
  ...
  @JSName("resourceType")
  val resourceType_MessageHeader: typingsJapgolly.fhir.fhirStrings.MessageHeader
...
object MessageHeader {
  ...
  extension [Self <: MessageHeader](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.MessageHeader): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
