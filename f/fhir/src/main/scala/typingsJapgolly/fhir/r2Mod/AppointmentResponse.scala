...
trait AppointmentResponse
  ...
  @JSName("resourceType")
  val resourceType_AppointmentResponse: typingsJapgolly.fhir.fhirStrings.AppointmentResponse
...
object AppointmentResponse {
  ...
  extension [Self <: AppointmentResponse](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.AppointmentResponse): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
