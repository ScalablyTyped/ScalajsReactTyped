...
import typingsJapgolly.fhir.fhirStrings.`fully-specified`
import typingsJapgolly.fhir.fhirStrings.active
import typingsJapgolly.fhir.fhirStrings.comparable
import typingsJapgolly.fhir.fhirStrings.convertable
import typingsJapgolly.fhir.fhirStrings.draft
import typingsJapgolly.fhir.fhirStrings.equivalent
import typingsJapgolly.fhir.fhirStrings.flexible
import typingsJapgolly.fhir.fhirStrings.retired
import typingsJapgolly.fhir.fhirStrings.scaleable
...
trait DataElement
  ...
  @JSName("resourceType")
  val resourceType_DataElement: typingsJapgolly.fhir.fhirStrings.DataElement
...
object DataElement {
  ...
  extension [Self <: DataElement](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.DataElement): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
