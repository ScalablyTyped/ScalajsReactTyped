...
trait MedicationOrder
  ...
  @JSName("resourceType")
  val resourceType_MedicationOrder: typingsJapgolly.fhir.fhirStrings.MedicationOrder
...
object MedicationOrder {
  ...
  extension [Self <: MedicationOrder](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.MedicationOrder): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
