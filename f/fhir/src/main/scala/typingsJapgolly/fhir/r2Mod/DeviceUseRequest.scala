...
trait DeviceUseRequest
  ...
  @JSName("resourceType")
  val resourceType_DeviceUseRequest: typingsJapgolly.fhir.fhirStrings.DeviceUseRequest
...
object DeviceUseRequest {
  ...
  extension [Self <: DeviceUseRequest](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.DeviceUseRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
