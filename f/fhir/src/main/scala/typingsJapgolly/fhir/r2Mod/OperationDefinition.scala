...
trait OperationDefinition
  ...
  @JSName("resourceType")
  val resourceType_OperationDefinition: typingsJapgolly.fhir.fhirStrings.OperationDefinition
...
object OperationDefinition {
  ...
  extension [Self <: OperationDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.OperationDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
