...
trait OperationDefinitionContact
  extends StObject
...
object OperationDefinitionContact {
  
  inline def apply(): OperationDefinitionContact = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OperationDefinitionContact]
  }
  
  extension [Self <: OperationDefinitionContact](x: Self) {
