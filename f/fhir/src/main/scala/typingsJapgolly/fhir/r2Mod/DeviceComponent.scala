...
import typingsJapgolly.fhir.fhirStrings.acoustical
import typingsJapgolly.fhir.fhirStrings.biological
import typingsJapgolly.fhir.fhirStrings.chemical
import typingsJapgolly.fhir.fhirStrings.electrical
import typingsJapgolly.fhir.fhirStrings.impedance
import typingsJapgolly.fhir.fhirStrings.manual
import typingsJapgolly.fhir.fhirStrings.mechanical
import typingsJapgolly.fhir.fhirStrings.nuclear
import typingsJapgolly.fhir.fhirStrings.optical
import typingsJapgolly.fhir.fhirStrings.other
import typingsJapgolly.fhir.fhirStrings.thermal
...
trait DeviceComponent
  ...
  @JSName("resourceType")
  val resourceType_DeviceComponent: typingsJapgolly.fhir.fhirStrings.DeviceComponent
...
object DeviceComponent {
  ...
  extension [Self <: DeviceComponent](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.DeviceComponent): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
