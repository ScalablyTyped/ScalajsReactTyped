...
trait CarePlan
  ...
  @JSName("resourceType")
  val resourceType_CarePlan: typingsJapgolly.fhir.fhirStrings.CarePlan
...
object CarePlan {
  ...
  extension [Self <: CarePlan](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.CarePlan): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
