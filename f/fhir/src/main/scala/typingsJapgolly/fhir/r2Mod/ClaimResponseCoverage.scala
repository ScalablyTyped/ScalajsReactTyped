...
object ClaimResponseCoverage {
  
  inline def apply(coverage: Reference, focal: Boolean, relationship: Coding, sequence: Double): ClaimResponseCoverage = {
    ...
    __obj.asInstanceOf[ClaimResponseCoverage]
  }
  
  extension [Self <: ClaimResponseCoverage](x: Self) {
