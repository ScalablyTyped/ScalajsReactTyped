...
trait TestScript
  ...
  @JSName("resourceType")
  val resourceType_TestScript: typingsJapgolly.fhir.fhirStrings.TestScript
...
object TestScript {
  ...
  extension [Self <: TestScript](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.TestScript): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
