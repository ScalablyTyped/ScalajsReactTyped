...
trait DocumentManifest
  ...
  @JSName("resourceType")
  val resourceType_DocumentManifest: typingsJapgolly.fhir.fhirStrings.DocumentManifest
...
object DocumentManifest {
  ...
  extension [Self <: DocumentManifest](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.DocumentManifest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
