...
trait Account
  ...
  @JSName("resourceType")
  val resourceType_Account: typingsJapgolly.fhir.fhirStrings.Account
...
object Account {
  ...
  extension [Self <: Account](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Account): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
