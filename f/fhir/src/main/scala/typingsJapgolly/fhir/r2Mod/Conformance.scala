...
trait Conformance
  ...
  @JSName("resourceType")
  val resourceType_Conformance: typingsJapgolly.fhir.fhirStrings.Conformance
...
object Conformance {
  ...
  extension [Self <: Conformance](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Conformance): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
