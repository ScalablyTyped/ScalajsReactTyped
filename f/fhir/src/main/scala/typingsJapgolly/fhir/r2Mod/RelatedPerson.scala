...
trait RelatedPerson
  ...
  @JSName("resourceType")
  val resourceType_RelatedPerson: typingsJapgolly.fhir.fhirStrings.RelatedPerson
...
object RelatedPerson {
  ...
  extension [Self <: RelatedPerson](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.RelatedPerson): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
