...
trait DiagnosticOrder
  ...
  @JSName("resourceType")
  val resourceType_DiagnosticOrder: typingsJapgolly.fhir.fhirStrings.DiagnosticOrder
...
object DiagnosticOrder {
  ...
  extension [Self <: DiagnosticOrder](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.DiagnosticOrder): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
