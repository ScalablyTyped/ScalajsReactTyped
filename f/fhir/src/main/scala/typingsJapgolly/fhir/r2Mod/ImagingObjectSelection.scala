...
trait ImagingObjectSelection
  ...
  @JSName("resourceType")
  val resourceType_ImagingObjectSelection: typingsJapgolly.fhir.fhirStrings.ImagingObjectSelection
...
object ImagingObjectSelection {
  ...
  extension [Self <: ImagingObjectSelection](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ImagingObjectSelection): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
