...
object List {
  ...
  inline def apply(mode: working | snapshot | changes, status: current | retired | `entered-in-error`): typingsJapgolly.fhir.r2Mod.List = {
    val __obj = js.Dynamic.literal(mode = mode.asInstanceOf[js.Any], resourceType = "List", status = status.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsJapgolly.fhir.r2Mod.List]
  }
  
  extension [Self <: typingsJapgolly.fhir.r2Mod.List](x: Self) {
