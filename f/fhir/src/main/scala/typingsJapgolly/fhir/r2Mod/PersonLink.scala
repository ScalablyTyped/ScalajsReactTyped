...
import typingsJapgolly.fhir.fhirStrings.level1
import typingsJapgolly.fhir.fhirStrings.level2
import typingsJapgolly.fhir.fhirStrings.level3
import typingsJapgolly.fhir.fhirStrings.level4
