...
trait ProcedureRequest
  ...
  @JSName("resourceType")
  val resourceType_ProcedureRequest: typingsJapgolly.fhir.fhirStrings.ProcedureRequest
...
object ProcedureRequest {
  ...
  extension [Self <: ProcedureRequest](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ProcedureRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
