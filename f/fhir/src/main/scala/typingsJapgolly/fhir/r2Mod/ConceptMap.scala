...
trait ConceptMap
  ...
  @JSName("resourceType")
  val resourceType_ConceptMap: typingsJapgolly.fhir.fhirStrings.ConceptMap
...
object ConceptMap {
  ...
  extension [Self <: ConceptMap](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ConceptMap): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
