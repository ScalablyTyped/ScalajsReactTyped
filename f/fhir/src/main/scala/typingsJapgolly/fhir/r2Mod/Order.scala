...
trait Order
  ...
  @JSName("resourceType")
  val resourceType_Order: typingsJapgolly.fhir.fhirStrings.Order
...
object Order {
  ...
  extension [Self <: Order](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Order): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
