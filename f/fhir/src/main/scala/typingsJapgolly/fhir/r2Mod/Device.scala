...
import typingsJapgolly.fhir.fhirStrings.`not-available`
...
trait Device
  ...
  @JSName("resourceType")
  val resourceType_Device: typingsJapgolly.fhir.fhirStrings.Device
...
object Device {
  ...
  extension [Self <: Device](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Device): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
