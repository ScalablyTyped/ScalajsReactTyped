...
trait HealthcareService
  ...
  @JSName("resourceType")
  val resourceType_HealthcareService: typingsJapgolly.fhir.fhirStrings.HealthcareService
...
object HealthcareService {
  ...
  extension [Self <: HealthcareService](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.HealthcareService): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
