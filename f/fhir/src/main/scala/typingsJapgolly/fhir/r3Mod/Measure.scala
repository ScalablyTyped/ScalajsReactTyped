...
trait Measure
  ...
  @JSName("resourceType")
  val resourceType_Measure: typingsJapgolly.fhir.fhirStrings.Measure
...
object Measure {
  ...
  extension [Self <: Measure](x: Self) {
    ...
    inline def setImprovementNotation(value: String): Self = StObject.set(x, "improvementNotation", value.asInstanceOf[js.Any])
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Measure): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
    ...
    inline def set_improvementNotation(value: Element): Self = StObject.set(x, "_improvementNotation", value.asInstanceOf[js.Any])
    
    inline def set_improvementNotationUndefined: Self = StObject.set(x, "_improvementNotation", js.undefined)
    ...
    inline def set_set(value: Element): Self = StObject.set(x, "_set", value.asInstanceOf[js.Any])
    
    inline def set_setUndefined: Self = StObject.set(x, "_set", js.undefined)
