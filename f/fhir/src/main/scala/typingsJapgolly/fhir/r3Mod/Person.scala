...
trait Person
  ...
  @JSName("resourceType")
  val resourceType_Person: typingsJapgolly.fhir.fhirStrings.Person
...
object Person {
  ...
  extension [Self <: Person](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Person): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
