...
trait EligibilityRequest
  ...
  @JSName("resourceType")
  val resourceType_EligibilityRequest: typingsJapgolly.fhir.fhirStrings.EligibilityRequest
...
object EligibilityRequest {
  ...
  extension [Self <: EligibilityRequest](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.EligibilityRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
