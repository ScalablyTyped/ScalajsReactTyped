...
trait Patient
  ...
  @JSName("resourceType")
  val resourceType_Patient: typingsJapgolly.fhir.fhirStrings.Patient
...
object Patient {
  ...
  extension [Self <: Patient](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Patient): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
