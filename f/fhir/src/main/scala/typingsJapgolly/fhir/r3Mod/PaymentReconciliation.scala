...
trait PaymentReconciliation
  ...
  @JSName("resourceType")
  val resourceType_PaymentReconciliation: typingsJapgolly.fhir.fhirStrings.PaymentReconciliation
...
object PaymentReconciliation {
  ...
  extension [Self <: PaymentReconciliation](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.PaymentReconciliation): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
