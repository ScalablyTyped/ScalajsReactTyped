...
trait ReferralRequest
  ...
  @JSName("resourceType")
  val resourceType_ReferralRequest: typingsJapgolly.fhir.fhirStrings.ReferralRequest
...
object ReferralRequest {
  ...
  extension [Self <: ReferralRequest](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ReferralRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
