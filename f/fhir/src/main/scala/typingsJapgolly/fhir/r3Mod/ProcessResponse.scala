...
trait ProcessResponse
  ...
  @JSName("resourceType")
  val resourceType_ProcessResponse: typingsJapgolly.fhir.fhirStrings.ProcessResponse
...
object ProcessResponse {
  ...
  extension [Self <: ProcessResponse](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ProcessResponse): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
