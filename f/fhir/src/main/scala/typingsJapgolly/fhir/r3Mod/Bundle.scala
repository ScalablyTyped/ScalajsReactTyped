...
import typingsJapgolly.fhir.fhirStrings.`batch-response`
import typingsJapgolly.fhir.fhirStrings.`transaction-response`
import typingsJapgolly.fhir.fhirStrings.batch
import typingsJapgolly.fhir.fhirStrings.collection
import typingsJapgolly.fhir.fhirStrings.document
import typingsJapgolly.fhir.fhirStrings.history
import typingsJapgolly.fhir.fhirStrings.message
import typingsJapgolly.fhir.fhirStrings.searchset
import typingsJapgolly.fhir.fhirStrings.transaction
...
trait Bundle[BundleContentType]
  ...
  @JSName("resourceType")
  val resourceType_Bundle: typingsJapgolly.fhir.fhirStrings.Bundle
...
object Bundle {
  ...
  extension [Self <: Bundle[?], BundleContentType](x: Self & Bundle[BundleContentType]) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Bundle): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
