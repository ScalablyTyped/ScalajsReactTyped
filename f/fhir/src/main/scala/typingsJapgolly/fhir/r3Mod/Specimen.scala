...
import typingsJapgolly.fhir.fhirStrings.unavailable_
import typingsJapgolly.fhir.fhirStrings.unsatisfactory
...
trait Specimen
  ...
  @JSName("resourceType")
  val resourceType_Specimen: typingsJapgolly.fhir.fhirStrings.Specimen
...
object Specimen {
  ...
  extension [Self <: Specimen](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Specimen): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
