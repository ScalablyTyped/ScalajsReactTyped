...
trait Organization
  ...
  @JSName("resourceType")
  val resourceType_Organization: typingsJapgolly.fhir.fhirStrings.Organization
...
object Organization {
  ...
  extension [Self <: Organization](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Organization): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
