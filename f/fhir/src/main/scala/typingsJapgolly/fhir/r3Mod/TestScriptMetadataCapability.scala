...
object TestScriptMetadataCapability {
  ...
  inline def apply(capabilities: Reference): TestScriptMetadataCapability = {
  ...
  extension [Self <: TestScriptMetadataCapability](x: Self) {
    ...
    inline def setCapabilities(value: Reference): Self = StObject.set(x, "capabilities", value.asInstanceOf[js.Any])
