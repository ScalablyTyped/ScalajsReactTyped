...
trait ClinicalImpression
  ...
  @JSName("resourceType")
  val resourceType_ClinicalImpression: typingsJapgolly.fhir.fhirStrings.ClinicalImpression
  ...
  /**
    ...
    */
  var status: draft | completed | `entered-in-error`
...
object ClinicalImpression {
  ...
  inline def apply(status: draft | completed | `entered-in-error`, subject: Reference): ClinicalImpression = {
  ...
  extension [Self <: ClinicalImpression](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ClinicalImpression): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
    
    inline def setStatus(value: draft | completed | `entered-in-error`): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
