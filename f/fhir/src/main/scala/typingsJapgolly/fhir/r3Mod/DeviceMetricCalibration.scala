...
import typingsJapgolly.fhir.fhirStrings.`calibration-required`
import typingsJapgolly.fhir.fhirStrings.`not-calibrated`
import typingsJapgolly.fhir.fhirStrings.`two-point`
import typingsJapgolly.fhir.fhirStrings.calibrated
import typingsJapgolly.fhir.fhirStrings.gain
import typingsJapgolly.fhir.fhirStrings.offset
