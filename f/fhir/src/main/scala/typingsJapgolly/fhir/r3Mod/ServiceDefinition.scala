...
trait ServiceDefinition
  ...
  @JSName("resourceType")
  val resourceType_ServiceDefinition: typingsJapgolly.fhir.fhirStrings.ServiceDefinition
...
object ServiceDefinition {
  ...
  extension [Self <: ServiceDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ServiceDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
