...
import typingsJapgolly.fhir.fhirStrings.directlink
import typingsJapgolly.fhir.fhirStrings.login
import typingsJapgolly.fhir.fhirStrings.oauth
import typingsJapgolly.fhir.fhirStrings.openapi
...
object SequenceRepository {
  ...
  inline def apply(`type`: directlink | openapi | login | oauth | other): SequenceRepository = {
