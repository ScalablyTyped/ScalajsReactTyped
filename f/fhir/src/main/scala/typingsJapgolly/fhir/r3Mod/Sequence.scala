...
trait Sequence
  ...
  @JSName("resourceType")
  val resourceType_Sequence: typingsJapgolly.fhir.fhirStrings.Sequence
...
object Sequence {
  ...
  extension [Self <: Sequence](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Sequence): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
