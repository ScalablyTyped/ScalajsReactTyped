...
trait ClaimResponse
  ...
  @JSName("resourceType")
  val resourceType_ClaimResponse: typingsJapgolly.fhir.fhirStrings.ClaimResponse
...
object ClaimResponse {
  ...
  extension [Self <: ClaimResponse](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ClaimResponse): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
