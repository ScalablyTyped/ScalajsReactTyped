...
import typingsJapgolly.fhir.fhirStrings.elements
import typingsJapgolly.fhir.fhirStrings.extensions
...
trait CapabilityStatement
  ...
  @JSName("resourceType")
  val resourceType_CapabilityStatement: typingsJapgolly.fhir.fhirStrings.CapabilityStatement
...
object CapabilityStatement {
  ...
  extension [Self <: CapabilityStatement](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.CapabilityStatement): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
