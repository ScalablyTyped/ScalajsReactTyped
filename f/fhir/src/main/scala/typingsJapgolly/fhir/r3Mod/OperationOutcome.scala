...
trait OperationOutcome
  ...
  @JSName("resourceType")
  val resourceType_OperationOutcome: typingsJapgolly.fhir.fhirStrings.OperationOutcome
}
object OperationOutcome {
  ...
  extension [Self <: OperationOutcome](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.OperationOutcome): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
