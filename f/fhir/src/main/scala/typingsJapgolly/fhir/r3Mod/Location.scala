...
import typingsJapgolly.fhir.fhirStrings.kind
...
trait Location
  ...
  @JSName("resourceType")
  val resourceType_Location: typingsJapgolly.fhir.fhirStrings.Location
...
object Location {
  ...
  extension [Self <: Location](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Location): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
