...
trait ExpansionProfile
  ...
  @JSName("resourceType")
  val resourceType_ExpansionProfile: typingsJapgolly.fhir.fhirStrings.ExpansionProfile
...
object ExpansionProfile {
  ...
  extension [Self <: ExpansionProfile](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ExpansionProfile): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
