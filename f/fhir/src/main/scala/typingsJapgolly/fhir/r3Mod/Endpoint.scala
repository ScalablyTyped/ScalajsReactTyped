...
trait Endpoint
  ...
  @JSName("resourceType")
  val resourceType_Endpoint: typingsJapgolly.fhir.fhirStrings.Endpoint
...
object Endpoint {
  ...
  extension [Self <: Endpoint](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Endpoint): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
