...
import typingsJapgolly.fhir.fhirStrings.cancel
import typingsJapgolly.fhir.fhirStrings.cancelled
import typingsJapgolly.fhir.fhirStrings.draft
import typingsJapgolly.fhir.fhirStrings.poll
import typingsJapgolly.fhir.fhirStrings.reprocess
import typingsJapgolly.fhir.fhirStrings.status
...
trait ProcessRequest
  ...
  @JSName("resourceType")
  val resourceType_ProcessRequest: typingsJapgolly.fhir.fhirStrings.ProcessRequest
...
object ProcessRequest {
  ...
  extension [Self <: ProcessRequest](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ProcessRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
