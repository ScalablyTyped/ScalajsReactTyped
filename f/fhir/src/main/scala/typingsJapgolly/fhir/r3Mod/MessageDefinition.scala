...
trait MessageDefinition
  ...
  @JSName("resourceType")
  val resourceType_MessageDefinition: typingsJapgolly.fhir.fhirStrings.MessageDefinition
...
object MessageDefinition {
  ...
  extension [Self <: MessageDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.MessageDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
