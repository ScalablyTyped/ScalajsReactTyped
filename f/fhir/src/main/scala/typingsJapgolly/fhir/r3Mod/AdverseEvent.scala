...
import typingsJapgolly.fhir.fhirStrings.AE
import typingsJapgolly.fhir.fhirStrings.PAE
...
trait AdverseEvent
  ...
  @JSName("resourceType")
  val resourceType_AdverseEvent: typingsJapgolly.fhir.fhirStrings.AdverseEvent
...
object AdverseEvent {
  ...
  extension [Self <: AdverseEvent](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.AdverseEvent): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
