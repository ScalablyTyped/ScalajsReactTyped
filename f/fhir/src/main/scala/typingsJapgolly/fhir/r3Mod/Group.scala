...
trait Group
  ...
  @JSName("resourceType")
  val resourceType_Group: typingsJapgolly.fhir.fhirStrings.Group
...
object Group {
  ...
  extension [Self <: Group](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Group): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
