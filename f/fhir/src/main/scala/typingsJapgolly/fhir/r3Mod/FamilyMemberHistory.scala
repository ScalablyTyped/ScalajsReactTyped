...
import typingsJapgolly.fhir.fhirStrings.female
import typingsJapgolly.fhir.fhirStrings.male
...
trait FamilyMemberHistory
  ...
  @JSName("resourceType")
  val resourceType_FamilyMemberHistory: typingsJapgolly.fhir.fhirStrings.FamilyMemberHistory
...
object FamilyMemberHistory {
  ...
  extension [Self <: FamilyMemberHistory](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.FamilyMemberHistory): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
