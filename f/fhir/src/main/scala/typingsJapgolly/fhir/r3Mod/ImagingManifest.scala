...
trait ImagingManifest
  ...
  @JSName("resourceType")
  val resourceType_ImagingManifest: typingsJapgolly.fhir.fhirStrings.ImagingManifest
...
object ImagingManifest {
  ...
  extension [Self <: ImagingManifest](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ImagingManifest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
