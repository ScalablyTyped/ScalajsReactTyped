...
import typingsJapgolly.fhir.fhirStrings.code
...
trait CodeSystemProperty
  ...
  /**
    ...
    */
  var `type`: code | typingsJapgolly.fhir.fhirStrings.Coding | string | integer | boolean | dateTime
...
object CodeSystemProperty {
  ...
  inline def apply(
    code: String,
    `type`: code | typingsJapgolly.fhir.fhirStrings.Coding | string | integer | boolean | dateTime
  ): CodeSystemProperty = {
  ...
  extension [Self <: CodeSystemProperty](x: Self) {
    ...
    inline def setType(value: code | typingsJapgolly.fhir.fhirStrings.Coding | string | integer | boolean | dateTime): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
