...
trait Binary
  ...
  @JSName("resourceType")
  val resourceType_Binary: typingsJapgolly.fhir.fhirStrings.Binary
...
object Binary {
  ...
  extension [Self <: Binary](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Binary): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
