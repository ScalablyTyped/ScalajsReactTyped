...
import typingsJapgolly.fhir.fhirStrings.`rest-hook`
import typingsJapgolly.fhir.fhirStrings.email
import typingsJapgolly.fhir.fhirStrings.message
import typingsJapgolly.fhir.fhirStrings.sms
import typingsJapgolly.fhir.fhirStrings.websocket
