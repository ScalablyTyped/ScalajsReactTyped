...
trait GuidanceResponse
  ...
  @JSName("resourceType")
  val resourceType_GuidanceResponse: typingsJapgolly.fhir.fhirStrings.GuidanceResponse
...
object GuidanceResponse {
  ...
  extension [Self <: GuidanceResponse](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.GuidanceResponse): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
