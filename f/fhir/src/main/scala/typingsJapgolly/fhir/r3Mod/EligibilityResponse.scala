...
trait EligibilityResponse
  ...
  @JSName("resourceType")
  val resourceType_EligibilityResponse: typingsJapgolly.fhir.fhirStrings.EligibilityResponse
...
object EligibilityResponse {
  ...
  extension [Self <: EligibilityResponse](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.EligibilityResponse): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
