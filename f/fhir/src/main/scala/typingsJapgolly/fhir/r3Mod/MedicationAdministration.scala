...
trait MedicationAdministration
  ...
  @JSName("resourceType")
  val resourceType_MedicationAdministration: typingsJapgolly.fhir.fhirStrings.MedicationAdministration
...
object MedicationAdministration {
  ...
  extension [Self <: MedicationAdministration](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.MedicationAdministration): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
