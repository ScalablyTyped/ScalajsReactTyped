...
trait Questionnaire
  ...
  @JSName("resourceType")
  val resourceType_Questionnaire: typingsJapgolly.fhir.fhirStrings.Questionnaire
...
object Questionnaire {
  ...
  extension [Self <: Questionnaire](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Questionnaire): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
