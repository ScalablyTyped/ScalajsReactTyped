...
trait Observation
  ...
  @JSName("resourceType")
  val resourceType_Observation: typingsJapgolly.fhir.fhirStrings.Observation
...
object Observation {
  ...
  extension [Self <: Observation](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Observation): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
