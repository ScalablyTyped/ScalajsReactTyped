...
- typingsJapgolly.fhir.fhir.Resource because Already inherited */ trait Consent extends DomainResource {
  /**
  ...
  /**
    ...
    */
  var dateTime: js.UndefOr[typingsJapgolly.fhir.fhir.dateTime] = js.undefined
  /**
