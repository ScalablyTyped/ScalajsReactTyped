...
- typingsJapgolly.fhir.fhir.Resource because Already inherited */ trait HealthcareService extends DomainResource {
  /**
...
object HealthcareService {
  ...
  def apply(
    ...
    if (!js.isUndefined(appointmentRequired)) __obj.updateDynamic("appointmentRequired")(appointmentRequired.asInstanceOf[js.Any])
