...
package object fhir {
  /**
    ...
    */
  type Age = typingsJapgolly.fhir.fhir.Quantity
  /**
    * A measured or measurable amount
    */
  type Count = typingsJapgolly.fhir.fhir.Quantity
  /**
    * A length - a value with a unit that is a physical distance
    */
  type Distance = typingsJapgolly.fhir.fhir.Quantity
  /**
    * A length of time
    */
  type Duration = typingsJapgolly.fhir.fhir.Quantity
  /**
    * An amount of economic utility in some recognized currency
    */
  type Money = typingsJapgolly.fhir.fhir.Quantity
  /**
    * A fixed quantity (no comparator)
    */
  type SimpleQuantity = typingsJapgolly.fhir.fhir.Quantity
  /**
    * A stream of bytes
    */
