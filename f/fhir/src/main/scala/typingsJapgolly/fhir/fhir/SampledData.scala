...
object SampledData {
  ...
  def apply(
    ...
    if (_dimensions != null) __obj.updateDynamic("_dimensions")(_dimensions.asInstanceOf[js.Any])
    if (_factor != null) __obj.updateDynamic("_factor")(_factor.asInstanceOf[js.Any])
    if (_fhir_comments != null) __obj.updateDynamic("_fhir_comments")(_fhir_comments.asInstanceOf[js.Any])
    if (_id != null) __obj.updateDynamic("_id")(_id.asInstanceOf[js.Any])
    if (_lowerLimit != null) __obj.updateDynamic("_lowerLimit")(_lowerLimit.asInstanceOf[js.Any])
