...
- typingsJapgolly.fhir.fhir.Resource because Already inherited */ trait NutritionOrder extends DomainResource {
  /**
  ...
  /**
    ...
    */
  var dateTime: typingsJapgolly.fhir.fhir.dateTime
  /**
