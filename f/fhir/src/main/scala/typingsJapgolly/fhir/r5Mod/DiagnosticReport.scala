...
trait DiagnosticReport
  ...
  /**
    ...
    */
  var conclusionCode: js.UndefOr[js.Array[CodeableConcept]] = js.undefined
  ...
  /**
    ...
    */
  var media: js.UndefOr[js.Array[DiagnosticReportMedia]] = js.undefined
  ...
  @JSName("resourceType")
  val resourceType_DiagnosticReport: typingsJapgolly.fhir.fhirStrings.DiagnosticReport
  ...
  /**
    ...
    */
  var resultsInterpreter: js.UndefOr[js.Array[Reference]] = js.undefined
...
object DiagnosticReport {
  ...
  extension [Self <: DiagnosticReport](x: Self) {
    ...
    inline def setComposition(value: Reference): Self = StObject.set(x, "composition", value.asInstanceOf[js.Any])
    ...
    inline def setConclusionCode(value: js.Array[CodeableConcept]): Self = StObject.set(x, "conclusionCode", value.asInstanceOf[js.Any])
    
    inline def setConclusionCodeUndefined: Self = StObject.set(x, "conclusionCode", js.undefined)
    
    inline def setConclusionCodeVarargs(value: CodeableConcept*): Self = StObject.set(x, "conclusionCode", js.Array(value*))
    ...
    inline def setMedia(value: js.Array[DiagnosticReportMedia]): Self = StObject.set(x, "media", value.asInstanceOf[js.Any])
    
    inline def setMediaUndefined: Self = StObject.set(x, "media", js.undefined)
    
    inline def setMediaVarargs(value: DiagnosticReportMedia*): Self = StObject.set(x, "media", js.Array(value*))
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.DiagnosticReport): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
    ...
    inline def setResultsInterpreter(value: js.Array[Reference]): Self = StObject.set(x, "resultsInterpreter", value.asInstanceOf[js.Any])
    
    inline def setResultsInterpreterUndefined: Self = StObject.set(x, "resultsInterpreter", js.undefined)
    
    inline def setResultsInterpreterVarargs(value: Reference*): Self = StObject.set(x, "resultsInterpreter", js.Array(value*))
