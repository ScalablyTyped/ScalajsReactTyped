...
object CanonicalResource {
  
  inline def apply(resourceType: String, status: draft | active | retired | unknown): CanonicalResource = {
    val __obj = js.Dynamic.literal(resourceType = resourceType.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
