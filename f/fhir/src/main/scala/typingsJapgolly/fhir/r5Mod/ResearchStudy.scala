...
trait ResearchStudy
  ...
  @JSName("resourceType")
  val resourceType_ResearchStudy: typingsJapgolly.fhir.fhirStrings.ResearchStudy
...
object ResearchStudy {
  ...
  extension [Self <: ResearchStudy](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ResearchStudy): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
