...
trait SubstancePolymer
  ...
  @JSName("resourceType")
  val resourceType_SubstancePolymer: typingsJapgolly.fhir.fhirStrings.SubstancePolymer
}
object SubstancePolymer {
  ...
  extension [Self <: SubstancePolymer](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.SubstancePolymer): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
