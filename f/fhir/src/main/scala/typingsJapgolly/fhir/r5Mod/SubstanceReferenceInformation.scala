...
trait SubstanceReferenceInformation
  ...
  @JSName("resourceType")
  val resourceType_SubstanceReferenceInformation: typingsJapgolly.fhir.fhirStrings.SubstanceReferenceInformation
...
object SubstanceReferenceInformation {
  ...
  extension [Self <: SubstanceReferenceInformation](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.SubstanceReferenceInformation): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
