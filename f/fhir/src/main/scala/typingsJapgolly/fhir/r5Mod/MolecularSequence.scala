...
import typingsJapgolly.fhir.fhirStrings.aa
import typingsJapgolly.fhir.fhirStrings.dna
import typingsJapgolly.fhir.fhirStrings.rna
...
trait MolecularSequence
  ...
  @JSName("resourceType")
  val resourceType_MolecularSequence: typingsJapgolly.fhir.fhirStrings.MolecularSequence
...
object MolecularSequence {
  ...
  extension [Self <: MolecularSequence](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.MolecularSequence): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
