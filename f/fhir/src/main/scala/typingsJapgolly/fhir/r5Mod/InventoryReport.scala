...
trait InventoryReport
  ...
  @JSName("resourceType")
  val resourceType_InventoryReport: typingsJapgolly.fhir.fhirStrings.InventoryReport
...
object InventoryReport {
  ...
  extension [Self <: InventoryReport](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.InventoryReport): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
