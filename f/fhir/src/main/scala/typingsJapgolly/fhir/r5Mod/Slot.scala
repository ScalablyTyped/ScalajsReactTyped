...
trait Slot
  ...
  /**
    ...
    */
  var appointmentType: js.UndefOr[js.Array[CodeableConcept]] = js.undefined
  ...
  @JSName("resourceType")
  val resourceType_Slot: typingsJapgolly.fhir.fhirStrings.Slot
...
object Slot {
  ...
  extension [Self <: Slot](x: Self) {
    ...
    inline def setAppointmentTypeVarargs(value: CodeableConcept*): Self = StObject.set(x, "appointmentType", js.Array(value*))
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Slot): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
