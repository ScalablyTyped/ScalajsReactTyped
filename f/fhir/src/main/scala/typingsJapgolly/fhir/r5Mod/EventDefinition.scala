...
trait EventDefinition
  ...
  @JSName("resourceType")
  val resourceType_EventDefinition: typingsJapgolly.fhir.fhirStrings.EventDefinition
  ...
  /**
    ...
    */
  var trigger: js.Array[TriggerDefinition]
...
object EventDefinition {
  ...
  inline def apply(status: draft | active | retired | unknown, trigger: js.Array[TriggerDefinition]): EventDefinition = {
  ...
  extension [Self <: EventDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.EventDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
