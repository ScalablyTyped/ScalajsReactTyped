...
import typingsJapgolly.fhir.fhirStrings.anonymous
import typingsJapgolly.fhir.fhirStrings.maiden
import typingsJapgolly.fhir.fhirStrings.nickname
...
object HumanName {
  ...
  extension [Self <: HumanName](x: Self) {
