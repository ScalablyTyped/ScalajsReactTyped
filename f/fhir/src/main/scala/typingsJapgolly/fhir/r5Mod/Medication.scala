...
trait Medication
  ...
  @JSName("resourceType")
  val resourceType_Medication: typingsJapgolly.fhir.fhirStrings.Medication
...
object Medication {
  ...
  extension [Self <: Medication](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Medication): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
