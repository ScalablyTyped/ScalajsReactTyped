...
trait Composition
  ...
  @JSName("resourceType")
  val resourceType_Composition: typingsJapgolly.fhir.fhirStrings.Composition
  ...
  /**
    ...
    */
  var status: preliminary | `final` | amended | `entered-in-error` | deprecated
...
object Composition {
  ...
  extension [Self <: Composition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Composition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
    ...
    inline def setStatus(value: preliminary | `final` | amended | `entered-in-error` | deprecated): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
