...
import typingsJapgolly.fhir.fhirStrings.`not-started`
...
import typingsJapgolly.fhir.fhirStrings.scheduled
...
trait CarePlanActivityPlannedActivityDetail
  extends StObject
  ...
  /**
    ...
    */
  var kind: js.UndefOr[
    typingsJapgolly.fhir.fhirStrings.Appointment | typingsJapgolly.fhir.fhirStrings.CommunicationRequest | typingsJapgolly.fhir.fhirStrings.DeviceRequest | typingsJapgolly.fhir.fhirStrings.MedicationRequest | typingsJapgolly.fhir.fhirStrings.NutritionOrder | typingsJapgolly.fhir.fhirStrings.Task | typingsJapgolly.fhir.fhirStrings.ServiceRequest | typingsJapgolly.fhir.fhirStrings.VisionPrescription
  ] = js.undefined
...
object CarePlanActivityPlannedActivityDetail {
  
  inline def apply(
    status: `not-started` | scheduled | `in-progress` | `on-hold` | completed | cancelled | stopped | unknown | `entered-in-error`
  ): CarePlanActivityPlannedActivityDetail = {
    val __obj = js.Dynamic.literal(status = status.asInstanceOf[js.Any])
    __obj.asInstanceOf[CarePlanActivityPlannedActivityDetail]
  }
  
  extension [Self <: CarePlanActivityPlannedActivityDetail](x: Self) {
    ...
    inline def setKind(
      value: typingsJapgolly.fhir.fhirStrings.Appointment | typingsJapgolly.fhir.fhirStrings.CommunicationRequest | typingsJapgolly.fhir.fhirStrings.DeviceRequest | typingsJapgolly.fhir.fhirStrings.MedicationRequest | typingsJapgolly.fhir.fhirStrings.NutritionOrder | typingsJapgolly.fhir.fhirStrings.Task | typingsJapgolly.fhir.fhirStrings.ServiceRequest | typingsJapgolly.fhir.fhirStrings.VisionPrescription
