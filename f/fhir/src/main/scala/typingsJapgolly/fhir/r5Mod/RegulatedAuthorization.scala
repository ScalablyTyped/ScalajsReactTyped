...
trait RegulatedAuthorization
  ...
  @JSName("resourceType")
  val resourceType_RegulatedAuthorization: typingsJapgolly.fhir.fhirStrings.RegulatedAuthorization
...
object RegulatedAuthorization {
  ...
  extension [Self <: RegulatedAuthorization](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.RegulatedAuthorization): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
