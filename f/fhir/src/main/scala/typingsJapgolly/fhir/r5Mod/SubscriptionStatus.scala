...
trait SubscriptionStatus
  ...
  @JSName("resourceType")
  val resourceType_SubscriptionStatus: typingsJapgolly.fhir.fhirStrings.SubscriptionStatus
...
object SubscriptionStatus {
  ...
  extension [Self <: SubscriptionStatus](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.SubscriptionStatus): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
