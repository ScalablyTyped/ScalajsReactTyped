...
trait SpecimenDefinition
  ...
  @JSName("resourceType")
  val resourceType_SpecimenDefinition: typingsJapgolly.fhir.fhirStrings.SpecimenDefinition
...
object SpecimenDefinition {
  ...
  extension [Self <: SpecimenDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.SpecimenDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
