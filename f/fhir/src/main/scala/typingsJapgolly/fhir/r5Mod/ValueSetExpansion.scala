...
trait ValueSetExpansion
  ...
  /**
    ...
    */
  var property: js.UndefOr[js.Array[ValueSetExpansionProperty]] = js.undefined
...
object ValueSetExpansion {
  ...
  extension [Self <: ValueSetExpansion](x: Self) {
    ...
    inline def setProperty(value: js.Array[ValueSetExpansionProperty]): Self = StObject.set(x, "property", value.asInstanceOf[js.Any])
    
    inline def setPropertyUndefined: Self = StObject.set(x, "property", js.undefined)
    
    inline def setPropertyVarargs(value: ValueSetExpansionProperty*): Self = StObject.set(x, "property", js.Array(value*))
