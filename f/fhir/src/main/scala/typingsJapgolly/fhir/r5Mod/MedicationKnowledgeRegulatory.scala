...
trait MedicationKnowledgeRegulatory
  ...
  /**
    ...
    */
  var schedule: js.UndefOr[js.Array[CodeableConcept]] = js.undefined
...
object MedicationKnowledgeRegulatory {
  ...
  extension [Self <: MedicationKnowledgeRegulatory](x: Self) {
    ...
    inline def setSchedule(value: js.Array[CodeableConcept]): Self = StObject.set(x, "schedule", value.asInstanceOf[js.Any])
    
    inline def setScheduleUndefined: Self = StObject.set(x, "schedule", js.undefined)
    
    inline def setScheduleVarargs(value: CodeableConcept*): Self = StObject.set(x, "schedule", js.Array(value*))
