...
trait List
  ...
  @JSName("resourceType")
  val resourceType_List: typingsJapgolly.fhir.fhirStrings.List
...
object List {
  ...
  inline def apply(mode: working | snapshot | changes, status: current | retired | `entered-in-error`): typingsJapgolly.fhir.r5Mod.List = {
  ...
  extension [Self <: typingsJapgolly.fhir.r5Mod.List](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.List): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
