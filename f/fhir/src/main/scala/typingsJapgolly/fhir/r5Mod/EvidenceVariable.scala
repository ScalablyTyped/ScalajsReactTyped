...
import typingsJapgolly.fhir.fhirStrings.ordinal
import typingsJapgolly.fhir.fhirStrings.polychotomous
...
trait EvidenceVariable
  ...
  @JSName("resourceType")
  val resourceType_EvidenceVariable: typingsJapgolly.fhir.fhirStrings.EvidenceVariable
...
object EvidenceVariable {
  ...
  extension [Self <: EvidenceVariable](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.EvidenceVariable): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
