...
trait SubstanceNucleicAcid
  ...
  @JSName("resourceType")
  val resourceType_SubstanceNucleicAcid: typingsJapgolly.fhir.fhirStrings.SubstanceNucleicAcid
...
object SubstanceNucleicAcid {
  ...
  extension [Self <: SubstanceNucleicAcid](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.SubstanceNucleicAcid): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
