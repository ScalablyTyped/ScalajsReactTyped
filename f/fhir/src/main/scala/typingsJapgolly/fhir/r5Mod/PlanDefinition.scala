...
trait PlanDefinition
  ...
  /**
    ...
    */
  var actor: js.UndefOr[js.Array[PlanDefinitionActor]] = js.undefined
  ...
  @JSName("resourceType")
  val resourceType_PlanDefinition: typingsJapgolly.fhir.fhirStrings.PlanDefinition
...
object PlanDefinition {
  ...
  extension [Self <: PlanDefinition](x: Self) {
    ...
    inline def setActor(value: js.Array[PlanDefinitionActor]): Self = StObject.set(x, "actor", value.asInstanceOf[js.Any])
    
    inline def setActorUndefined: Self = StObject.set(x, "actor", js.undefined)
    
    inline def setActorVarargs(value: PlanDefinitionActor*): Self = StObject.set(x, "actor", js.Array(value*))
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.PlanDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
