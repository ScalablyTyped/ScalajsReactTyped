...
trait EvidenceReport
  ...
  @JSName("resourceType")
  val resourceType_EvidenceReport: typingsJapgolly.fhir.fhirStrings.EvidenceReport
...
object EvidenceReport {
  ...
  extension [Self <: EvidenceReport](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.EvidenceReport): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
