...
import typingsJapgolly.fhir.fhirStrings.`not-persuasive-with-modification`
import typingsJapgolly.fhir.fhirStrings.`not-persuasive`
import typingsJapgolly.fhir.fhirStrings.`persuasive-with-modification`
import typingsJapgolly.fhir.fhirStrings.`resolved-change-required`
import typingsJapgolly.fhir.fhirStrings.`resolved-no-change`
import typingsJapgolly.fhir.fhirStrings.`waiting-for-input`
import typingsJapgolly.fhir.fhirStrings.applied
import typingsJapgolly.fhir.fhirStrings.deferred
import typingsJapgolly.fhir.fhirStrings.duplicate
import typingsJapgolly.fhir.fhirStrings.persuasive
import typingsJapgolly.fhir.fhirStrings.published
import typingsJapgolly.fhir.fhirStrings.submitted
import typingsJapgolly.fhir.fhirStrings.triaged
import typingsJapgolly.fhir.fhirStrings.unresolved
...
trait ArtifactAssessment
  ...
  @JSName("resourceType")
  val resourceType_ArtifactAssessment: typingsJapgolly.fhir.fhirStrings.ArtifactAssessment
...
object ArtifactAssessment {
  ...
  extension [Self <: ArtifactAssessment](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ArtifactAssessment): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
