...
trait SubstanceProtein
  ...
  @JSName("resourceType")
  val resourceType_SubstanceProtein: typingsJapgolly.fhir.fhirStrings.SubstanceProtein
...
object SubstanceProtein {
  ...
  extension [Self <: SubstanceProtein](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.SubstanceProtein): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
