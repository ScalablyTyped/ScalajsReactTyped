...
trait ClinicalUseDefinition
  ...
  @JSName("resourceType")
  val resourceType_ClinicalUseDefinition: typingsJapgolly.fhir.fhirStrings.ClinicalUseDefinition
...
object ClinicalUseDefinition {
  ...
  extension [Self <: ClinicalUseDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ClinicalUseDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
