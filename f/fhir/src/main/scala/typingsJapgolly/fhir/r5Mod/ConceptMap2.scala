...
trait ConceptMap2
  ...
  @JSName("resourceType")
  val resourceType_ConceptMap2: typingsJapgolly.fhir.fhirStrings.ConceptMap2
...
object ConceptMap2 {
  ...
  extension [Self <: ConceptMap2](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ConceptMap2): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
