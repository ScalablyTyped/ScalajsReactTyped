...
trait SubstanceSourceMaterial
  ...
  @JSName("resourceType")
  val resourceType_SubstanceSourceMaterial: typingsJapgolly.fhir.fhirStrings.SubstanceSourceMaterial
...
object SubstanceSourceMaterial {
  ...
  extension [Self <: SubstanceSourceMaterial](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.SubstanceSourceMaterial): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
