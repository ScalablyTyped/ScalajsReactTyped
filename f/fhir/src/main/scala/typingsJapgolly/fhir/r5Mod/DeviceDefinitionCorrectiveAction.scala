...
import typingsJapgolly.fhir.fhirStrings.`lot-numbers`
import typingsJapgolly.fhir.fhirStrings.`serial-numbers`
import typingsJapgolly.fhir.fhirStrings.model
