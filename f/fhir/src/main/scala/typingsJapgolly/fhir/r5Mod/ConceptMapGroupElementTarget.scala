...
import typingsJapgolly.fhir.fhirStrings.`not-related-to`
import typingsJapgolly.fhir.fhirStrings.`related-to`
import typingsJapgolly.fhir.fhirStrings.`source-is-broader-than-target`
import typingsJapgolly.fhir.fhirStrings.`source-is-narrower-than-target`
