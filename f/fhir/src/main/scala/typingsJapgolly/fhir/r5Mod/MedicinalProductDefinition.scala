...
trait MedicinalProductDefinition
  ...
  @JSName("resourceType")
  val resourceType_MedicinalProductDefinition: typingsJapgolly.fhir.fhirStrings.MedicinalProductDefinition
...
object MedicinalProductDefinition {
  ...
  extension [Self <: MedicinalProductDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.MedicinalProductDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
