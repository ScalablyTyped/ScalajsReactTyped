...
trait ServiceRequest
  ...
  @JSName("resourceType")
  val resourceType_ServiceRequest: typingsJapgolly.fhir.fhirStrings.ServiceRequest
...
object ServiceRequest {
  ...
  extension [Self <: ServiceRequest](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ServiceRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
