...
trait VisionPrescription
  ...
  @JSName("resourceType")
  val resourceType_VisionPrescription: typingsJapgolly.fhir.fhirStrings.VisionPrescription
...
object VisionPrescription {
  ...
  extension [Self <: VisionPrescription](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.VisionPrescription): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
