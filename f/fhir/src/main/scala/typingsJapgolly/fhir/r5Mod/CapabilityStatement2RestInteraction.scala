...
import typingsJapgolly.fhir.fhirStrings.`history-system`
import typingsJapgolly.fhir.fhirStrings.`search-system`
...
object CapabilityStatement2RestInteraction {
  ...
  extension [Self <: CapabilityStatement2RestInteraction](x: Self) {
