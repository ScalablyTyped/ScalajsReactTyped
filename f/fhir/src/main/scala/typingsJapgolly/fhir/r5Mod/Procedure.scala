...
trait Procedure
  ...
  @JSName("resourceType")
  val resourceType_Procedure: typingsJapgolly.fhir.fhirStrings.Procedure
...
object Procedure {
  ...
  extension [Self <: Procedure](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Procedure): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
