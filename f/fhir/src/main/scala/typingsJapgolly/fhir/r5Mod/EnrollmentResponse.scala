...
trait EnrollmentResponse
  ...
  @JSName("resourceType")
  val resourceType_EnrollmentResponse: typingsJapgolly.fhir.fhirStrings.EnrollmentResponse
...
object EnrollmentResponse {
  ...
  extension [Self <: EnrollmentResponse](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.EnrollmentResponse): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
