...
object ClaimSupportingInfo {
  
  inline def apply(category: CodeableConcept, sequence: Double): ClaimSupportingInfo = {
    val __obj = js.Dynamic.literal(category = category.asInstanceOf[js.Any], sequence = sequence.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClaimSupportingInfo]
  }
  
  extension [Self <: ClaimSupportingInfo](x: Self) {
