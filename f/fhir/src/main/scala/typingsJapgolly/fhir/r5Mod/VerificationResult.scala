...
trait VerificationResult
  ...
  @JSName("resourceType")
  val resourceType_VerificationResult: typingsJapgolly.fhir.fhirStrings.VerificationResult
...
object VerificationResult {
  ...
  extension [Self <: VerificationResult](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.VerificationResult): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
