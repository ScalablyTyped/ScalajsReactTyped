...
trait DeviceUsage
  ...
  @JSName("resourceType")
  val resourceType_DeviceUsage: typingsJapgolly.fhir.fhirStrings.DeviceUsage
...
object DeviceUsage {
  ...
  extension [Self <: DeviceUsage](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.DeviceUsage): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
