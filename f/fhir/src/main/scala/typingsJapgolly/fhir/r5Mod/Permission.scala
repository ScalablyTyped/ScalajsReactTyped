...
trait Permission
  ...
  @JSName("resourceType")
  val resourceType_Permission: typingsJapgolly.fhir.fhirStrings.Permission
...
object Permission {
  ...
  extension [Self <: Permission](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Permission): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
