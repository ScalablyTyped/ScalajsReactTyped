...
trait NutritionIntake
  ...
  @JSName("resourceType")
  val resourceType_NutritionIntake: typingsJapgolly.fhir.fhirStrings.NutritionIntake
...
object NutritionIntake {
  ...
  extension [Self <: NutritionIntake](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.NutritionIntake): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
