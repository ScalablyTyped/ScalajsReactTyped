...
trait ManufacturedItemDefinition
  ...
  @JSName("resourceType")
  val resourceType_ManufacturedItemDefinition: typingsJapgolly.fhir.fhirStrings.ManufacturedItemDefinition
...
object ManufacturedItemDefinition {
  ...
  extension [Self <: ManufacturedItemDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ManufacturedItemDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
