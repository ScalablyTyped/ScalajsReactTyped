...
trait ExplanationOfBenefit
  ...
  @JSName("resourceType")
  val resourceType_ExplanationOfBenefit: typingsJapgolly.fhir.fhirStrings.ExplanationOfBenefit
...
object ExplanationOfBenefit {
  ...
  extension [Self <: ExplanationOfBenefit](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ExplanationOfBenefit): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
