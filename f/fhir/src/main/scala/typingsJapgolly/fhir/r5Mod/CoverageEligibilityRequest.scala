...
trait CoverageEligibilityRequest
  ...
  @JSName("resourceType")
  val resourceType_CoverageEligibilityRequest: typingsJapgolly.fhir.fhirStrings.CoverageEligibilityRequest
...
object CoverageEligibilityRequest {
  ...
  extension [Self <: CoverageEligibilityRequest](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.CoverageEligibilityRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
