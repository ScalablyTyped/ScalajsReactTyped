...
trait ClinicalUseIssueContraindication
  extends StObject
...
object ClinicalUseIssueContraindication {
  
  inline def apply(): ClinicalUseIssueContraindication = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClinicalUseIssueContraindication]
  }
  
  extension [Self <: ClinicalUseIssueContraindication](x: Self) {
