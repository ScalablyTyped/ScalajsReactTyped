...
trait ClinicalUseIssueInteraction
  extends StObject
  ...
  /**
    ...
    */
  var interactant: js.UndefOr[js.Array[ClinicalUseIssueInteractionInteractant]] = js.undefined
...
object ClinicalUseIssueInteraction {
  
  inline def apply(): ClinicalUseIssueInteraction = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClinicalUseIssueInteraction]
  }
  
  extension [Self <: ClinicalUseIssueInteraction](x: Self) {
    ...
    inline def setInteractant(value: js.Array[ClinicalUseIssueInteractionInteractant]): Self = StObject.set(x, "interactant", value.asInstanceOf[js.Any])
    
    inline def setInteractantUndefined: Self = StObject.set(x, "interactant", js.undefined)
    
    inline def setInteractantVarargs(value: ClinicalUseIssueInteractionInteractant*): Self = StObject.set(x, "interactant", js.Array(value*))
