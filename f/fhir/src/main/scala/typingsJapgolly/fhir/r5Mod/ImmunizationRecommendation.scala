...
trait ImmunizationRecommendation
  ...
  @JSName("resourceType")
  val resourceType_ImmunizationRecommendation: typingsJapgolly.fhir.fhirStrings.ImmunizationRecommendation
}
object ImmunizationRecommendation {
  ...
  extension [Self <: ImmunizationRecommendation](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ImmunizationRecommendation): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
