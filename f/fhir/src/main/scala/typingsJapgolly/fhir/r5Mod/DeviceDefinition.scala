...
import typingsJapgolly.fhir.fhirStrings.`biological-source`
import typingsJapgolly.fhir.fhirStrings.`expiration-date`
import typingsJapgolly.fhir.fhirStrings.`lot-number`
import typingsJapgolly.fhir.fhirStrings.`manufactured-date`
import typingsJapgolly.fhir.fhirStrings.`serial-number`
import typingsJapgolly.fhir.fhirStrings.`software-version`
...
trait DeviceDefinition
  ...
  @JSName("resourceType")
  val resourceType_DeviceDefinition: typingsJapgolly.fhir.fhirStrings.DeviceDefinition
...
object DeviceDefinition {
  ...
  extension [Self <: DeviceDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.DeviceDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
