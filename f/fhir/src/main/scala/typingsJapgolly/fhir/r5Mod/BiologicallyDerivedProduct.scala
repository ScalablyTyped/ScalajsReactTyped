...
import typingsJapgolly.fhir.fhirStrings.biologicalAgent
import typingsJapgolly.fhir.fhirStrings.cells
import typingsJapgolly.fhir.fhirStrings.fluid
import typingsJapgolly.fhir.fhirStrings.organ
import typingsJapgolly.fhir.fhirStrings.tissue
...
trait BiologicallyDerivedProduct
  ...
  @JSName("resourceType")
  val resourceType_BiologicallyDerivedProduct: typingsJapgolly.fhir.fhirStrings.BiologicallyDerivedProduct
...
object BiologicallyDerivedProduct {
  ...
  extension [Self <: BiologicallyDerivedProduct](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.BiologicallyDerivedProduct): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
