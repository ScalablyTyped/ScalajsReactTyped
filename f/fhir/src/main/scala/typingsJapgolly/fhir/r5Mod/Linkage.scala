...
trait Linkage
  ...
  @JSName("resourceType")
  val resourceType_Linkage: typingsJapgolly.fhir.fhirStrings.Linkage
}
object Linkage {
  ...
  extension [Self <: Linkage](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Linkage): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
