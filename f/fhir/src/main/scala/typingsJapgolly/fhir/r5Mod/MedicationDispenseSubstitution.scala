...
trait MedicationDispenseSubstitution
  ...
  /**
    ...
    */
  var responsibleParty: js.UndefOr[Reference] = js.undefined
...
object MedicationDispenseSubstitution {
  ...
  extension [Self <: MedicationDispenseSubstitution](x: Self) {
    ...
    inline def setResponsibleParty(value: Reference): Self = StObject.set(x, "responsibleParty", value.asInstanceOf[js.Any])
