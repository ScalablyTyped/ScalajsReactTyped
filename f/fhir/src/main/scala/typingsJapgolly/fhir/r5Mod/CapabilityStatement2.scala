...
trait CapabilityStatement2
  ...
  @JSName("resourceType")
  val resourceType_CapabilityStatement2: typingsJapgolly.fhir.fhirStrings.CapabilityStatement2
...
object CapabilityStatement2 {
  ...
  extension [Self <: CapabilityStatement2](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.CapabilityStatement2): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
