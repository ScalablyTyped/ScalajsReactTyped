...
trait TestReport
  ...
  @JSName("resourceType")
  val resourceType_TestReport: typingsJapgolly.fhir.fhirStrings.TestReport
...
object TestReport {
  ...
  extension [Self <: TestReport](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.TestReport): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
