...
trait MedicationRequest
  ...
  @JSName("resourceType")
  val resourceType_MedicationRequest: typingsJapgolly.fhir.fhirStrings.MedicationRequest
...
object MedicationRequest {
  ...
  extension [Self <: MedicationRequest](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.MedicationRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
