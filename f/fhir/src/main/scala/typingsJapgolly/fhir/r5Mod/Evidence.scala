...
trait Evidence
  ...
  @JSName("resourceType")
  val resourceType_Evidence: typingsJapgolly.fhir.fhirStrings.Evidence
...
object Evidence {
  ...
  extension [Self <: Evidence](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Evidence): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
