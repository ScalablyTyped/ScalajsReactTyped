...
trait Flag
  ...
  @JSName("resourceType")
  val resourceType_Flag: typingsJapgolly.fhir.fhirStrings.Flag
...
object Flag {
  ...
  extension [Self <: Flag](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Flag): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
