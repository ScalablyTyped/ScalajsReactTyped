...
trait ValueSetExpansionContains
  ...
  /**
    ...
    */
  var property: js.UndefOr[js.Array[ValueSetExpansionContainsProperty]] = js.undefined
...
object ValueSetExpansionContains {
  ...
  extension [Self <: ValueSetExpansionContains](x: Self) {
    ...
    inline def setProperty(value: js.Array[ValueSetExpansionContainsProperty]): Self = StObject.set(x, "property", value.asInstanceOf[js.Any])
    
    inline def setPropertyUndefined: Self = StObject.set(x, "property", js.undefined)
    
    inline def setPropertyVarargs(value: ValueSetExpansionContainsProperty*): Self = StObject.set(x, "property", js.Array(value*))
