...
import typingsJapgolly.fhir.fhirStrings.alert
import typingsJapgolly.fhir.fhirStrings.critical
import typingsJapgolly.fhir.fhirStrings.debug
import typingsJapgolly.fhir.fhirStrings.emergency
import typingsJapgolly.fhir.fhirStrings.error
import typingsJapgolly.fhir.fhirStrings.informational
import typingsJapgolly.fhir.fhirStrings.notice
...
trait AuditEvent
  ...
  @JSName("resourceType")
  val resourceType_AuditEvent: typingsJapgolly.fhir.fhirStrings.AuditEvent
...
object AuditEvent {
  ...
  extension [Self <: AuditEvent](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.AuditEvent): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
