...
trait ConditionDefinition
  ...
  @JSName("resourceType")
  val resourceType_ConditionDefinition: typingsJapgolly.fhir.fhirStrings.ConditionDefinition
...
object ConditionDefinition {
  ...
  extension [Self <: ConditionDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ConditionDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
