...
trait GraphDefinition
  ...
  @JSName("resourceType")
  val resourceType_GraphDefinition: typingsJapgolly.fhir.fhirStrings.GraphDefinition
...
object GraphDefinition {
  ...
  extension [Self <: GraphDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.GraphDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
