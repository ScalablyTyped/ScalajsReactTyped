...
trait MedicationDispense
  ...
  @JSName("resourceType")
  val resourceType_MedicationDispense: typingsJapgolly.fhir.fhirStrings.MedicationDispense
...
object MedicationDispense {
  ...
  extension [Self <: MedicationDispense](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.MedicationDispense): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
