...
trait ChargeItem
  ...
  @JSName("resourceType")
  val resourceType_ChargeItem: typingsJapgolly.fhir.fhirStrings.ChargeItem
...
object ChargeItem {
  ...
  extension [Self <: ChargeItem](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ChargeItem): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
