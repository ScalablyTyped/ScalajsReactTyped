...
trait Invoice
  ...
  @JSName("resourceType")
  val resourceType_Invoice: typingsJapgolly.fhir.fhirStrings.Invoice
...
object Invoice {
  ...
  extension [Self <: Invoice](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Invoice): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
