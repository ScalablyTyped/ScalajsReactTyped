...
trait PlanDefinitionActionParticipant
  ...
  /**
    ...
    */
  var actorId: js.UndefOr[String] = js.undefined
...
object PlanDefinitionActionParticipant {
  ...
  inline def apply(): PlanDefinitionActionParticipant = {
  ...
  extension [Self <: PlanDefinitionActionParticipant](x: Self) {
    ...
    inline def setActorIdUndefined: Self = StObject.set(x, "actorId", js.undefined)
