...
trait Substance
  ...
  @JSName("resourceType")
  val resourceType_Substance: typingsJapgolly.fhir.fhirStrings.Substance
...
object Substance {
  ...
  extension [Self <: Substance](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Substance): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
