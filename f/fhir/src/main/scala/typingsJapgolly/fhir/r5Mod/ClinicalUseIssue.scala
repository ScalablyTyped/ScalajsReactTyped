...
trait ClinicalUseIssue
  ...
  @JSName("resourceType")
  val resourceType_ClinicalUseIssue: typingsJapgolly.fhir.fhirStrings.ClinicalUseIssue
...
object ClinicalUseIssue {
  ...
  extension [Self <: ClinicalUseIssue](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ClinicalUseIssue): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
