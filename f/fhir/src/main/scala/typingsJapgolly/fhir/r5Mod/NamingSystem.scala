...
trait NamingSystem
  ...
  @JSName("resourceType")
  val resourceType_NamingSystem: typingsJapgolly.fhir.fhirStrings.NamingSystem
...
object NamingSystem {
  ...
  extension [Self <: NamingSystem](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.NamingSystem): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
