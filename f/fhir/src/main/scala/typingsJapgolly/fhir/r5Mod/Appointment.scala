...
trait Appointment
  ...
  @JSName("resourceType")
  val resourceType_Appointment: typingsJapgolly.fhir.fhirStrings.Appointment
...
object Appointment {
  ...
  extension [Self <: Appointment](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Appointment): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
