...
trait PackagedProductDefinition
  ...
  @JSName("resourceType")
  val resourceType_PackagedProductDefinition: typingsJapgolly.fhir.fhirStrings.PackagedProductDefinition
...
object PackagedProductDefinition {
  ...
  extension [Self <: PackagedProductDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.PackagedProductDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
