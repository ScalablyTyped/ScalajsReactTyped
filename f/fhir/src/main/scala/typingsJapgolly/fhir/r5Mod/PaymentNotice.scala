...
trait PaymentNotice
  ...
  @JSName("resourceType")
  val resourceType_PaymentNotice: typingsJapgolly.fhir.fhirStrings.PaymentNotice
...
object PaymentNotice {
  ...
  extension [Self <: PaymentNotice](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.PaymentNotice): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
