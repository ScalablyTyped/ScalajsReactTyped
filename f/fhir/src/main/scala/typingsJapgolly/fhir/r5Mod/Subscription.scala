...
import typingsJapgolly.fhir.fhirStrings.`full-resource`
import typingsJapgolly.fhir.fhirStrings.`full-url`
import typingsJapgolly.fhir.fhirStrings.`id-only`
import typingsJapgolly.fhir.fhirStrings.`request-response`
...
import typingsJapgolly.fhir.fhirStrings.none
...
trait Subscription
  ...
  @JSName("resourceType")
  val resourceType_Subscription: typingsJapgolly.fhir.fhirStrings.Subscription
...
object Subscription {
  ...
  extension [Self <: Subscription](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Subscription): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
