...
trait CoverageEligibilityResponse
  ...
  @JSName("resourceType")
  val resourceType_CoverageEligibilityResponse: typingsJapgolly.fhir.fhirStrings.CoverageEligibilityResponse
...
object CoverageEligibilityResponse {
  ...
  extension [Self <: CoverageEligibilityResponse](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.CoverageEligibilityResponse): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
