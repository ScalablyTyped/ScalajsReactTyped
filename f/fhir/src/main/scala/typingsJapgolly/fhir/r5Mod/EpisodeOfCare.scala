...
trait EpisodeOfCare
  ...
  @JSName("resourceType")
  val resourceType_EpisodeOfCare: typingsJapgolly.fhir.fhirStrings.EpisodeOfCare
...
object EpisodeOfCare {
  ...
  extension [Self <: EpisodeOfCare](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.EpisodeOfCare): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
