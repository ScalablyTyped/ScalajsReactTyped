...
trait DeviceDispense
  ...
  @JSName("resourceType")
  val resourceType_DeviceDispense: typingsJapgolly.fhir.fhirStrings.DeviceDispense
...
object DeviceDispense {
  ...
  extension [Self <: DeviceDispense](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.DeviceDispense): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
