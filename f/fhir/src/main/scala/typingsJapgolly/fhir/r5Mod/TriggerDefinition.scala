...
import typingsJapgolly.fhir.fhirStrings.`data-access-ended`
import typingsJapgolly.fhir.fhirStrings.`data-accessed`
import typingsJapgolly.fhir.fhirStrings.`data-added`
import typingsJapgolly.fhir.fhirStrings.`data-changed`
import typingsJapgolly.fhir.fhirStrings.`data-modified`
import typingsJapgolly.fhir.fhirStrings.`data-removed`
import typingsJapgolly.fhir.fhirStrings.`named-event`
import typingsJapgolly.fhir.fhirStrings.periodic
