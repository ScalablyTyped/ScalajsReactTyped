...
trait OrganizationAffiliation
  ...
  @JSName("resourceType")
  val resourceType_OrganizationAffiliation: typingsJapgolly.fhir.fhirStrings.OrganizationAffiliation
...
object OrganizationAffiliation {
  ...
  extension [Self <: OrganizationAffiliation](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.OrganizationAffiliation): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
