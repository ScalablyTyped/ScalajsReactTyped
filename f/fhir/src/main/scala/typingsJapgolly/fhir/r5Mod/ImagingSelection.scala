...
trait ImagingSelection
  ...
  @JSName("resourceType")
  val resourceType_ImagingSelection: typingsJapgolly.fhir.fhirStrings.ImagingSelection
...
object ImagingSelection {
  ...
  extension [Self <: ImagingSelection](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ImagingSelection): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
