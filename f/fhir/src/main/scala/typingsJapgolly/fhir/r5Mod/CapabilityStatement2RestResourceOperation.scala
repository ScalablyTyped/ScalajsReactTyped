...
trait CapabilityStatement2RestResourceOperation
  extends StObject
...
object CapabilityStatement2RestResourceOperation {
  
  inline def apply(definition: String, name: String): CapabilityStatement2RestResourceOperation = {
    val __obj = js.Dynamic.literal(definition = definition.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[CapabilityStatement2RestResourceOperation]
  }
  
  extension [Self <: CapabilityStatement2RestResourceOperation](x: Self) {
