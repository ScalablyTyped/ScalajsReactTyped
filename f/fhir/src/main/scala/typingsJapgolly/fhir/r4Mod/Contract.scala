...
trait Contract
  ...
  @JSName("resourceType")
  val resourceType_Contract: typingsJapgolly.fhir.fhirStrings.Contract
...
object Contract {
  ...
  extension [Self <: Contract](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Contract): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
