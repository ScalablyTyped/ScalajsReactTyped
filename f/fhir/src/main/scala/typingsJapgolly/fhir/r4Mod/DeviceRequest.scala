...
trait DeviceRequest
  ...
  @JSName("resourceType")
  val resourceType_DeviceRequest: typingsJapgolly.fhir.fhirStrings.DeviceRequest
...
object DeviceRequest {
  ...
  extension [Self <: DeviceRequest](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.DeviceRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
