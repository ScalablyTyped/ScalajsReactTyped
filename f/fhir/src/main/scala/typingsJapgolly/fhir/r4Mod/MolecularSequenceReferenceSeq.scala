...
import typingsJapgolly.fhir.fhirStrings.antisense
import typingsJapgolly.fhir.fhirStrings.crick
import typingsJapgolly.fhir.fhirStrings.sense
import typingsJapgolly.fhir.fhirStrings.watson
...
object MolecularSequenceReferenceSeq {
  ...
  extension [Self <: MolecularSequenceReferenceSeq](x: Self) {
