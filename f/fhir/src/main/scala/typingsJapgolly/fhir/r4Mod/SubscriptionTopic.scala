...
trait SubscriptionTopic
  ...
  @JSName("resourceType")
  val resourceType_SubscriptionTopic: typingsJapgolly.fhir.fhirStrings.SubscriptionTopic
...
object SubscriptionTopic {
  ...
  extension [Self <: SubscriptionTopic](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.SubscriptionTopic): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
