...
trait EnrollmentRequest
  ...
  @JSName("resourceType")
  val resourceType_EnrollmentRequest: typingsJapgolly.fhir.fhirStrings.EnrollmentRequest
...
object EnrollmentRequest {
  ...
  extension [Self <: EnrollmentRequest](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.EnrollmentRequest): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
