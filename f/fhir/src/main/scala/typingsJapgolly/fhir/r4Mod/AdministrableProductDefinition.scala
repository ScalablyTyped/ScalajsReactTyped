...
trait AdministrableProductDefinition
  ...
  @JSName("resourceType")
  val resourceType_AdministrableProductDefinition: typingsJapgolly.fhir.fhirStrings.AdministrableProductDefinition
...
object AdministrableProductDefinition {
  ...
  extension [Self <: AdministrableProductDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.AdministrableProductDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
