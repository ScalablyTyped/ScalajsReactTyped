...
trait CodeSystemProperty
  ...
  /**
    ...
    */
  var `type`: code | typingsJapgolly.fhir.fhirStrings.Coding | string | integer | boolean | dateTime | decimal
...
object CodeSystemProperty {
  ...
  inline def apply(
    code: String,
    `type`: code | typingsJapgolly.fhir.fhirStrings.Coding | string | integer | boolean | dateTime | decimal
  ): CodeSystemProperty = {
  ...
  extension [Self <: CodeSystemProperty](x: Self) {
    ...
    inline def setType(
      value: code | typingsJapgolly.fhir.fhirStrings.Coding | string | integer | boolean | dateTime | decimal
