...
trait NutritionProduct
  ...
  @JSName("resourceType")
  val resourceType_NutritionProduct: typingsJapgolly.fhir.fhirStrings.NutritionProduct
...
object NutritionProduct {
  ...
  extension [Self <: NutritionProduct](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.NutritionProduct): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
