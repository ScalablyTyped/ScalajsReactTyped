...
trait Media
  ...
  @JSName("resourceType")
  val resourceType_Media: typingsJapgolly.fhir.fhirStrings.Media
...
object Media {
  ...
  extension [Self <: Media](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Media): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
