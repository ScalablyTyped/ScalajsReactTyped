...
trait StructureMap
  ...
  @JSName("resourceType")
  val resourceType_StructureMap: typingsJapgolly.fhir.fhirStrings.StructureMap
...
object StructureMap {
  ...
  extension [Self <: StructureMap](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.StructureMap): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
