...
trait Immunization
  ...
  @JSName("resourceType")
  val resourceType_Immunization: typingsJapgolly.fhir.fhirStrings.Immunization
...
object Immunization {
  ...
  extension [Self <: Immunization](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Immunization): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
