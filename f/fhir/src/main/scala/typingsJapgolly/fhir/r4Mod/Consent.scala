...
trait Consent
  ...
  @JSName("resourceType")
  val resourceType_Consent: typingsJapgolly.fhir.fhirStrings.Consent
...
object Consent {
  ...
  extension [Self <: Consent](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Consent): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
