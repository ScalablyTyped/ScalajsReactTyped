...
trait InsurancePlan
  ...
  @JSName("resourceType")
  val resourceType_InsurancePlan: typingsJapgolly.fhir.fhirStrings.InsurancePlan
...
object InsurancePlan {
  ...
  extension [Self <: InsurancePlan](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.InsurancePlan): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
