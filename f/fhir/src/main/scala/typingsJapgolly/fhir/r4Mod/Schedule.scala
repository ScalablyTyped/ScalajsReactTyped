...
trait Schedule
  ...
  @JSName("resourceType")
  val resourceType_Schedule: typingsJapgolly.fhir.fhirStrings.Schedule
...
object Schedule {
  ...
  extension [Self <: Schedule](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Schedule): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
