...
trait Communication
  ...
  @JSName("resourceType")
  val resourceType_Communication: typingsJapgolly.fhir.fhirStrings.Communication
...
object Communication {
  ...
  extension [Self <: Communication](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Communication): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
