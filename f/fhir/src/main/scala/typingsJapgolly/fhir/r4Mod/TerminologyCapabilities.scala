...
import typingsJapgolly.fhir.fhirStrings.explicit
...
trait TerminologyCapabilities
  ...
  @JSName("resourceType")
  val resourceType_TerminologyCapabilities: typingsJapgolly.fhir.fhirStrings.TerminologyCapabilities
...
object TerminologyCapabilities {
  ...
  extension [Self <: TerminologyCapabilities](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.TerminologyCapabilities): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
