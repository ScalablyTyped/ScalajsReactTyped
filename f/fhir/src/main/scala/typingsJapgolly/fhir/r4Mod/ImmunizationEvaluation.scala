...
trait ImmunizationEvaluation
  ...
  @JSName("resourceType")
  val resourceType_ImmunizationEvaluation: typingsJapgolly.fhir.fhirStrings.ImmunizationEvaluation
...
object ImmunizationEvaluation {
  ...
  extension [Self <: ImmunizationEvaluation](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ImmunizationEvaluation): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
