...
trait ChargeItemDefinition
  ...
  @JSName("resourceType")
  val resourceType_ChargeItemDefinition: typingsJapgolly.fhir.fhirStrings.ChargeItemDefinition
...
object ChargeItemDefinition {
  ...
  extension [Self <: ChargeItemDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ChargeItemDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
