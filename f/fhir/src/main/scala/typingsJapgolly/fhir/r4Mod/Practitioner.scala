...
trait Practitioner
  ...
  @JSName("resourceType")
  val resourceType_Practitioner: typingsJapgolly.fhir.fhirStrings.Practitioner
...
object Practitioner {
  ...
  extension [Self <: Practitioner](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Practitioner): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
