...
import typingsJapgolly.fhir.fhirStrings.derivation
import typingsJapgolly.fhir.fhirStrings.quotation
import typingsJapgolly.fhir.fhirStrings.removal
import typingsJapgolly.fhir.fhirStrings.revision
import typingsJapgolly.fhir.fhirStrings.source
...
object ProvenanceEntity {
  ...
  inline def apply(role: derivation | revision | quotation | source | removal, what: Reference): ProvenanceEntity = {
