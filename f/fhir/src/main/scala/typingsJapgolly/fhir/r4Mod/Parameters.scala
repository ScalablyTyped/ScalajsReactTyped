...
trait Parameters
  ...
  @JSName("resourceType")
  val resourceType_Parameters: typingsJapgolly.fhir.fhirStrings.Parameters
}
object Parameters {
  ...
  extension [Self <: Parameters](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Parameters): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
  }
}
