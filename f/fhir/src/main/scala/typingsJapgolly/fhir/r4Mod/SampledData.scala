...
object SampledData {
  ...
  inline def apply(dimensions: Double, origin: Quantity, period: Double): SampledData = {
    val __obj = js.Dynamic.literal(dimensions = dimensions.asInstanceOf[js.Any], origin = origin.asInstanceOf[js.Any], period = period.asInstanceOf[js.Any])
