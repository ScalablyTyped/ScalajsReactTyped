...
trait Citation
  ...
  @JSName("resourceType")
  val resourceType_Citation: typingsJapgolly.fhir.fhirStrings.Citation
...
object Citation {
  ...
  extension [Self <: Citation](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Citation): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
