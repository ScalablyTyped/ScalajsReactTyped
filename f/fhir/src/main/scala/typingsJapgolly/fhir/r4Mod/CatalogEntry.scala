...
trait CatalogEntry
  ...
  @JSName("resourceType")
  val resourceType_CatalogEntry: typingsJapgolly.fhir.fhirStrings.CatalogEntry
...
object CatalogEntry {
  ...
  extension [Self <: CatalogEntry](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.CatalogEntry): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
