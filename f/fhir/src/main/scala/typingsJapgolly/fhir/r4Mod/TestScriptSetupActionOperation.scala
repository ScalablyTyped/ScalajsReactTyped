...
trait TestScriptSetupActionOperation
  ...
  /**
    ...
    */
  var method: js.UndefOr[delete_ | get_ | options | patch_ | post_ | put_ | head_] = js.undefined
...
object TestScriptSetupActionOperation {
  ...
  inline def apply(encodeRequestUrl: Boolean): TestScriptSetupActionOperation = {
    val __obj = js.Dynamic.literal(encodeRequestUrl = encodeRequestUrl.asInstanceOf[js.Any])
  ...
  extension [Self <: TestScriptSetupActionOperation](x: Self) {
    ...
    inline def setMethod(value: delete_ | get_ | options | patch_ | post_ | put_ | head_): Self = StObject.set(x, "method", value.asInstanceOf[js.Any])
