...
import typingsJapgolly.fhir.fhirStrings.high
import typingsJapgolly.fhir.fhirStrings.low
import typingsJapgolly.fhir.fhirStrings.moderate
...
trait DetectedIssue
  ...
  @JSName("resourceType")
  val resourceType_DetectedIssue: typingsJapgolly.fhir.fhirStrings.DetectedIssue
...
object DetectedIssue {
  ...
  extension [Self <: DetectedIssue](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.DetectedIssue): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
