...
import typingsJapgolly.fhir.fhirStrings.`not-taken`
...
trait MedicationStatement
  ...
  @JSName("resourceType")
  val resourceType_MedicationStatement: typingsJapgolly.fhir.fhirStrings.MedicationStatement
  ...
  /**
    ...
    */
  var status: active | completed | `entered-in-error` | intended | stopped | `on-hold` | unknown | `not-taken`
...
object MedicationStatement {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(resourceType = "MedicationStatement", status = status.asInstanceOf[js.Any], subject = subject.asInstanceOf[js.Any])
  ...
  extension [Self <: MedicationStatement](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.MedicationStatement): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
