...
trait ResearchDefinition
  ...
  /**
    ...
    */
  var outcome: js.UndefOr[Reference] = js.undefined
  ...
  @JSName("resourceType")
  val resourceType_ResearchDefinition: typingsJapgolly.fhir.fhirStrings.ResearchDefinition
...
object ResearchDefinition {
  
  inline def apply(population: Reference, status: draft | active | retired | unknown): ResearchDefinition = {
    val __obj = js.Dynamic.literal(population = population.asInstanceOf[js.Any], resourceType = "ResearchDefinition", status = status.asInstanceOf[js.Any])
    __obj.asInstanceOf[ResearchDefinition]
  }
  
  extension [Self <: ResearchDefinition](x: Self) {
    ...
    inline def setExposureAlternativeUndefined: Self = StObject.set(x, "exposureAlternative", js.undefined)
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ResearchDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
