...
trait PractitionerRole
  ...
  @JSName("resourceType")
  val resourceType_PractitionerRole: typingsJapgolly.fhir.fhirStrings.PractitionerRole
...
object PractitionerRole {
  ...
  extension [Self <: PractitionerRole](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.PractitionerRole): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
