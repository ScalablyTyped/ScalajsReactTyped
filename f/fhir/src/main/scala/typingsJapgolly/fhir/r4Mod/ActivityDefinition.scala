...
trait ActivityDefinition
  ...
  @JSName("resourceType")
  val resourceType_ActivityDefinition: typingsJapgolly.fhir.fhirStrings.ActivityDefinition
...
object ActivityDefinition {
  ...
  extension [Self <: ActivityDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ActivityDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
