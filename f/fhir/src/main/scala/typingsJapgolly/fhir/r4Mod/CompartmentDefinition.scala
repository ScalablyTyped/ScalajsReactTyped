...
trait CompartmentDefinition
  ...
  @JSName("resourceType")
  val resourceType_CompartmentDefinition: typingsJapgolly.fhir.fhirStrings.CompartmentDefinition
...
object CompartmentDefinition {
  ...
  extension [Self <: CompartmentDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.CompartmentDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
