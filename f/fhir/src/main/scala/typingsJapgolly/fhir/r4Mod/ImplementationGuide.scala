...
trait ImplementationGuide
  ...
  @JSName("resourceType")
  val resourceType_ImplementationGuide: typingsJapgolly.fhir.fhirStrings.ImplementationGuide
...
object ImplementationGuide {
  ...
  extension [Self <: ImplementationGuide](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ImplementationGuide): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
