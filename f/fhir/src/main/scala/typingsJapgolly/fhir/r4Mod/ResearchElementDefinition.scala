...
import typingsJapgolly.fhir.fhirStrings.continuous
import typingsJapgolly.fhir.fhirStrings.descriptive
import typingsJapgolly.fhir.fhirStrings.dichotomous
import typingsJapgolly.fhir.fhirStrings.draft
import typingsJapgolly.fhir.fhirStrings.exposure
import typingsJapgolly.fhir.fhirStrings.outcome
import typingsJapgolly.fhir.fhirStrings.population
...
trait ResearchElementDefinition
  ...
  @JSName("resourceType")
  val resourceType_ResearchElementDefinition: typingsJapgolly.fhir.fhirStrings.ResearchElementDefinition
...
object ResearchElementDefinition {
  ...
  extension [Self <: ResearchElementDefinition](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.ResearchElementDefinition): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
