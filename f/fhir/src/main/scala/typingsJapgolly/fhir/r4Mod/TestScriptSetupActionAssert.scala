...
import typingsJapgolly.fhir.fhirStrings.bad
import typingsJapgolly.fhir.fhirStrings.conflict
import typingsJapgolly.fhir.fhirStrings.contains
import typingsJapgolly.fhir.fhirStrings.created
import typingsJapgolly.fhir.fhirStrings.delete_
import typingsJapgolly.fhir.fhirStrings.empty
import typingsJapgolly.fhir.fhirStrings.equals
import typingsJapgolly.fhir.fhirStrings.eval
import typingsJapgolly.fhir.fhirStrings.forbidden
import typingsJapgolly.fhir.fhirStrings.get_
import typingsJapgolly.fhir.fhirStrings.gone
import typingsJapgolly.fhir.fhirStrings.greaterThan
import typingsJapgolly.fhir.fhirStrings.head_
import typingsJapgolly.fhir.fhirStrings.in
import typingsJapgolly.fhir.fhirStrings.lessThan
import typingsJapgolly.fhir.fhirStrings.methodNotAllowed
import typingsJapgolly.fhir.fhirStrings.noContent
import typingsJapgolly.fhir.fhirStrings.notContains
import typingsJapgolly.fhir.fhirStrings.notEmpty
import typingsJapgolly.fhir.fhirStrings.notEquals
import typingsJapgolly.fhir.fhirStrings.notFound
import typingsJapgolly.fhir.fhirStrings.notIn
import typingsJapgolly.fhir.fhirStrings.notModified
import typingsJapgolly.fhir.fhirStrings.okay
import typingsJapgolly.fhir.fhirStrings.options
import typingsJapgolly.fhir.fhirStrings.patch_
import typingsJapgolly.fhir.fhirStrings.post_
import typingsJapgolly.fhir.fhirStrings.preconditionFailed
import typingsJapgolly.fhir.fhirStrings.put_
import typingsJapgolly.fhir.fhirStrings.request
import typingsJapgolly.fhir.fhirStrings.response
import typingsJapgolly.fhir.fhirStrings.unprocessable
...
object TestScriptSetupActionAssert {
  ...
  inline def apply(warningOnly: Boolean): TestScriptSetupActionAssert = {
    val __obj = js.Dynamic.literal(warningOnly = warningOnly.asInstanceOf[js.Any])
