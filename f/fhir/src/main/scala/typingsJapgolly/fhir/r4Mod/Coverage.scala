...
trait Coverage
  ...
  @JSName("resourceType")
  val resourceType_Coverage: typingsJapgolly.fhir.fhirStrings.Coverage
...
object Coverage {
  ...
  extension [Self <: Coverage](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Coverage): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
