...
trait NutritionOrder
  ...
  @JSName("resourceType")
  val resourceType_NutritionOrder: typingsJapgolly.fhir.fhirStrings.NutritionOrder
...
object NutritionOrder {
  ...
  extension [Self <: NutritionOrder](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.NutritionOrder): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
