...
trait MedicationKnowledge
  ...
  @JSName("resourceType")
  val resourceType_MedicationKnowledge: typingsJapgolly.fhir.fhirStrings.MedicationKnowledge
...
object MedicationKnowledge {
  ...
  extension [Self <: MedicationKnowledge](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.MedicationKnowledge): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
