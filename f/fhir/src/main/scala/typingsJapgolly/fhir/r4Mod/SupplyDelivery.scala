...
import typingsJapgolly.fhir.fhirStrings.abandoned
...
trait SupplyDelivery
  ...
  @JSName("resourceType")
  val resourceType_SupplyDelivery: typingsJapgolly.fhir.fhirStrings.SupplyDelivery
...
object SupplyDelivery {
  ...
  extension [Self <: SupplyDelivery](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.SupplyDelivery): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
