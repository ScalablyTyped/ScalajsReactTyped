...
trait Basic
  ...
  @JSName("resourceType")
  val resourceType_Basic: typingsJapgolly.fhir.fhirStrings.Basic
...
object Basic {
  ...
  extension [Self <: Basic](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.Basic): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
