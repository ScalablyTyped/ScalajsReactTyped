...
trait DocumentReference
  ...
  @JSName("resourceType")
  val resourceType_DocumentReference: typingsJapgolly.fhir.fhirStrings.DocumentReference
...
object DocumentReference {
  ...
  extension [Self <: DocumentReference](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.DocumentReference): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
