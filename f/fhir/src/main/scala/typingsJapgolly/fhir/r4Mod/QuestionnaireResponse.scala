...
trait QuestionnaireResponse
  ...
  @JSName("resourceType")
  val resourceType_QuestionnaireResponse: typingsJapgolly.fhir.fhirStrings.QuestionnaireResponse
...
object QuestionnaireResponse {
  ...
  extension [Self <: QuestionnaireResponse](x: Self) {
    ...
    inline def setResourceType(value: typingsJapgolly.fhir.fhirStrings.QuestionnaireResponse): Self = StObject.set(x, "resourceType", value.asInstanceOf[js.Any])
