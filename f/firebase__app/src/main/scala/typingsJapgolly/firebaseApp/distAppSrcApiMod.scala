...
import typingsJapgolly.firebaseApp.distAppSrcPublicTypesMod.FirebaseAppSettings
import typingsJapgolly.firebaseApp.distAppSrcPublicTypesMod.FirebaseOptions
