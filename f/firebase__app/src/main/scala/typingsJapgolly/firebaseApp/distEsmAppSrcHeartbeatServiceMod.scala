...
import typingsJapgolly.firebaseApp.anon.UnsentEntries
import typingsJapgolly.firebaseApp.distEsmAppSrcPublicTypesMod.FirebaseApp
import typingsJapgolly.firebaseApp.distEsmAppSrcTypesMod.HeartbeatService
import typingsJapgolly.firebaseApp.distEsmAppSrcTypesMod.HeartbeatStorage
import typingsJapgolly.firebaseApp.distEsmAppSrcTypesMod.HeartbeatsByUserAgent
import typingsJapgolly.firebaseApp.distEsmAppSrcTypesMod.HeartbeatsInIndexedDB
import typingsJapgolly.firebaseApp.distEsmAppSrcTypesMod.SingleDateHeartbeat
