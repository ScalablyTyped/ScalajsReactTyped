...
import typingsJapgolly.firebaseApp.distEsmAppSrcPublicTypesMod.FirebaseAppSettings
import typingsJapgolly.firebaseApp.distEsmAppSrcPublicTypesMod.FirebaseOptions
