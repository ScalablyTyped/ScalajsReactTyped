...
import typingsJapgolly.fullpageJs.anon.FadeBackground
import typingsJapgolly.fullpageJs.anon.Percentage
...
object FullPageJsOptions {
  ...
  extension [Self <: FullPageJsOptions](x: Self) {
    ...
    inline def setAfterLoad(value: (/* anchorLink */ String, /* index */ Double) => Callback): Self = StObject.set(x, "afterLoad", js.Any.fromFunction2((t0: /* anchorLink */ String, t1: /* index */ Double) => (value(t0, t1)).runNow()))
    ...
    inline def setAfterResize(value: Callback): Self = StObject.set(x, "afterResize", value.toJsFn)
    
    inline def setAfterResizeUndefined: Self = StObject.set(x, "afterResize", js.undefined)
    
    inline def setAfterResponsive(value: /* isResponsive */ Boolean => Callback): Self = StObject.set(x, "afterResponsive", js.Any.fromFunction1((t0: /* isResponsive */ Boolean) => value(t0).runNow()))
    
    inline def setAfterResponsiveUndefined: Self = StObject.set(x, "afterResponsive", js.undefined)
    
    inline def setAfterSlideLoad(
      value: (/* anchorLink */ String, /* index */ Double, /* slideAnchor */ String, /* slideIndex */ Double) => Callback
    ): Self = StObject.set(x, "afterSlideLoad", js.Any.fromFunction4((t0: /* anchorLink */ String, t1: /* index */ Double, t2: /* slideAnchor */ String, t3: /* slideIndex */ Double) => (value(t0, t1, t2, t3)).runNow()))
    ...
    inline def setOnLeave(value: (/* index */ Double, /* nextIndex */ Double, /* direction */ String) => Callback): Self = StObject.set(x, "onLeave", js.Any.fromFunction3((t0: /* index */ Double, t1: /* nextIndex */ Double, t2: /* direction */ String) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnLeaveUndefined: Self = StObject.set(x, "onLeave", js.undefined)
    
    inline def setOnSlideLeave(
      value: (/* anchorLink */ String, /* index */ Double, /* slideIndex */ Double, /* direction */ String, /* nextSlideIndex */ Double) => Callback
    ): Self = StObject.set(x, "onSlideLeave", js.Any.fromFunction5((t0: /* anchorLink */ String, t1: /* index */ Double, t2: /* slideIndex */ Double, t3: /* direction */ String, t4: /* nextSlideIndex */ Double) => (value(t0, t1, t2, t3, t4)).runNow()))
