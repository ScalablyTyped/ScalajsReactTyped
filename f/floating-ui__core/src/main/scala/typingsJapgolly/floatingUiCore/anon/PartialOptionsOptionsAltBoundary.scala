...
trait PartialOptionsOptionsAltBoundary extends StObject {
  ...
  var fallbackPlacements: js.UndefOr[js.Array[typingsJapgolly.floatingUiCore.srcTypesMod.Placement]] = js.undefined
...
object PartialOptionsOptionsAltBoundary {
  ...
  extension [Self <: PartialOptionsOptionsAltBoundary](x: Self) {
    ...
    inline def setFallbackPlacements(value: js.Array[typingsJapgolly.floatingUiCore.srcTypesMod.Placement]): Self = StObject.set(x, "fallbackPlacements", value.asInstanceOf[js.Any])
    
    inline def setFallbackPlacementsUndefined: Self = StObject.set(x, "fallbackPlacements", js.undefined)
    
    inline def setFallbackPlacementsVarargs(value: typingsJapgolly.floatingUiCore.srcTypesMod.Placement*): Self = StObject.set(x, "fallbackPlacements", js.Array(value*))
