...
import typingsJapgolly.floatingUiCore.srcTypesMod.Elements
...
trait MiddlewareArgumentsavaila extends StObject {
  ...
  var initialPlacement: typingsJapgolly.floatingUiCore.srcTypesMod.Placement
  
  var middlewareData: MiddlewareData
  
  var placement: typingsJapgolly.floatingUiCore.srcTypesMod.Placement
...
object MiddlewareArgumentsavaila {
  ...
  inline def apply(
    ...
    elements: Elements,
    initialPlacement: typingsJapgolly.floatingUiCore.srcTypesMod.Placement,
    middlewareData: MiddlewareData,
    placement: typingsJapgolly.floatingUiCore.srcTypesMod.Placement,
    platform: Platform,
    rects: ElementRects,
    strategy: Strategy,
    x: Double,
  ...
  extension [Self <: MiddlewareArgumentsavaila](x: Self) {
    ...
    inline def setInitialPlacement(value: typingsJapgolly.floatingUiCore.srcTypesMod.Placement): Self = StObject.set(x, "initialPlacement", value.asInstanceOf[js.Any])
