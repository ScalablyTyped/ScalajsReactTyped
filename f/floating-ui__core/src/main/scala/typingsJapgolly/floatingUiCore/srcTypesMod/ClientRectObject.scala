...
/* Inlined @floating-ui/core.@floating-ui/core/src/types.Rect & @floating-ui/core.@floating-ui/core/src/types.SideObject */
trait ClientRectObject extends StObject {
...
object ClientRectObject {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ClientRectObject]
  }
  
  extension [Self <: ClientRectObject](x: Self) {
