...
import typingsJapgolly.floatingUiCore.anon.Floating
import typingsJapgolly.floatingUiCore.anon.OffsetParent
...
trait Platform extends StObject {
  ...
  def getClippingRect(args: typingsJapgolly.floatingUiCore.anon.Boundary): Promisable[Rect]
...
object Platform {
  ...
  inline def apply(
    getClippingRect: typingsJapgolly.floatingUiCore.anon.Boundary => Promisable[Rect],
  ...
  extension [Self <: Platform](x: Self) {
    ...
    inline def setGetClippingRect(value: typingsJapgolly.floatingUiCore.anon.Boundary => Promisable[Rect]): Self = StObject.set(x, "getClippingRect", js.Any.fromFunction1(value))
