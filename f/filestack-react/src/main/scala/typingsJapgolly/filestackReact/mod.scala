package typingsJapgolly.filestackReact
...
object mod {
  ...
  object PickerBaseProps {
    ...
    extension [Self <: PickerBaseProps](x: Self) {
      ...
      ): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify PickerFileMetadata */ /* error */ Any) => value(t0).runNow()))
      ...
      ): Self = StObject.set(x, "onSuccess", js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify PickerFileMetadata */ /* result */ Any) => value(t0).runNow()))
      
      inline def setOnSuccessUndefined: Self = StObject.set(x, "onSuccess", js.undefined)
      
      inline def setOnUploadDone(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify PickerFileMetadata */ /* result */ Any => Callback
      ): Self = StObject.set(x, "onUploadDone", js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify PickerFileMetadata */ /* result */ Any) => value(t0).runNow()))
