...
trait Layer extends FontawesomeObject {
  val `type`: typingsJapgolly.atFortawesomeFontawesomeDashSvgDashCore.atFortawesomeFontawesomeDashSvgDashCoreStrings.layer
}
...
object Layer {
  ...
  def apply(
    ...
    node: HTMLCollection,
    `type`: typingsJapgolly.atFortawesomeFontawesomeDashSvgDashCore.atFortawesomeFontawesomeDashSvgDashCoreStrings.layer
  ): Layer = {
