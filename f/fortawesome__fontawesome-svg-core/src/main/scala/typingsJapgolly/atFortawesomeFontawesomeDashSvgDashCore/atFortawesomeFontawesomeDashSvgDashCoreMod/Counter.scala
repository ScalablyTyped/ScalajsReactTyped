...
trait Counter extends FontawesomeObject {
  val `type`: typingsJapgolly.atFortawesomeFontawesomeDashSvgDashCore.atFortawesomeFontawesomeDashSvgDashCoreStrings.counter
}
...
object Counter {
  ...
  def apply(
    ...
    node: HTMLCollection,
    `type`: typingsJapgolly.atFortawesomeFontawesomeDashSvgDashCore.atFortawesomeFontawesomeDashSvgDashCoreStrings.counter
  ): Counter = {
