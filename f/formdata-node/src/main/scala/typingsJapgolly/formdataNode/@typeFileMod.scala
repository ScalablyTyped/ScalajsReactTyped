package typingsJapgolly.formdataNode

import typingsJapgolly.formdataNode.`@typeBlobMod`.Blob
import typingsJapgolly.formdataNode.`@typeBlobMod`.BlobParts
import typingsJapgolly.formdataNode.`@typeBlobMod`.BlobPropertyBag
...
object `@typeFileMod` {
  ...
  - typingsJapgolly.formdataNode.`@typeFileMod`.FileLike because var conflicts: size, toStringTag, `type`. Inlined name, lastModified */ @JSImport("formdata-node/@type/File", "File")
  @js.native
