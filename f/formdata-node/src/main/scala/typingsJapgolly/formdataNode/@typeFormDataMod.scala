...
import typingsJapgolly.formdataNode.`@typeFileMod`.File
import typingsJapgolly.std.Generator
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object `@typeFormDataMod` {
  
  @JSImport("formdata-node/@type/FormData", "FormData")
  @js.native
  open class FormData () extends StObject {
    ...
    /**
      ...
      */
    def forEach(
      callback: js.Function3[/* value */ FormDataEntryValue, /* key */ String, /* form */ this.type, Unit]
    ): Unit = js.native
    def forEach(
      callback: js.Function3[/* value */ FormDataEntryValue, /* key */ String, /* form */ this.type, Unit],
      thisArg: Any
    ...
    /**
      ...
      */
    def keys(): Generator[String, Any, Any] = js.native
    ...
    /**
      ...
      */
    def values(): Generator[FormDataEntryValue, Any, Any] = js.native
  }
