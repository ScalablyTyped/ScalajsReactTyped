...
import typingsJapgolly.formdataNode.`@typeFileMod`.FilePropertyBag
...
object mod {
  ...
  /**
    ...
    */
  open class Blob ()
    extends typingsJapgolly.formdataNode.`@typeBlobMod`.Blob {
  ...
  open class File protected ()
    extends typingsJapgolly.formdataNode.`@typeFileMod`.File {
    /**
  ...
  @js.native
  open class FormData ()
    extends typingsJapgolly.formdataNode.`@typeFormDataMod`.FormData
}
