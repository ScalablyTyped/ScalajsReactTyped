...
import typingsJapgolly.firebaseAppCheck.distEsmSrcErrorsMod.AppCheckError
...
object firebaseAppCheckStrings {
  ...
  sealed trait EXTERNAL
    extends StObject
       with ListenerType
       with typingsJapgolly.firebaseAppCheck.distSrcTypesMod.ListenerType
  ...
  sealed trait `already-initialized`
    extends StObject
       with AppCheckError
       with typingsJapgolly.firebaseAppCheck.distSrcErrorsMod.AppCheckError
