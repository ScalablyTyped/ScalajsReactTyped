...
object distEsmSrcMod {
  ...
  open class CustomProvider protected ()
    extends typingsJapgolly.firebaseAppCheck.distEsmSrcApiMod.CustomProvider {
  ...
  open class ReCaptchaEnterpriseProvider protected ()
    extends typingsJapgolly.firebaseAppCheck.distEsmSrcApiMod.ReCaptchaEnterpriseProvider {
    /**
  ...
  open class ReCaptchaV3Provider protected ()
    extends typingsJapgolly.firebaseAppCheck.distEsmSrcApiMod.ReCaptchaV3Provider {
    /**
