...
import typingsJapgolly.firebaseAppCheck.distEsmSrcPublicTypesMod.AppCheckOptions
import typingsJapgolly.firebaseAppCheck.distEsmSrcPublicTypesMod.AppCheckTokenResult
import typingsJapgolly.firebaseAppCheck.distEsmSrcPublicTypesMod.CustomProviderOptions
...
object distEsmSrcApiMod {
  ...
  open class CustomProvider protected ()
    extends typingsJapgolly.firebaseAppCheck.distEsmSrcProvidersMod.CustomProvider {
  ...
  open class ReCaptchaEnterpriseProvider protected ()
    extends typingsJapgolly.firebaseAppCheck.distEsmSrcProvidersMod.ReCaptchaEnterpriseProvider {
    /**
  ...
  open class ReCaptchaV3Provider protected ()
    extends typingsJapgolly.firebaseAppCheck.distEsmSrcProvidersMod.ReCaptchaV3Provider {
    /**
