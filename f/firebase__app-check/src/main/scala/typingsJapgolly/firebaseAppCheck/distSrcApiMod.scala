...
import typingsJapgolly.firebaseAppCheck.distSrcFactoryMod.AppCheckService
import typingsJapgolly.firebaseAppCheck.distSrcPublicTypesMod.AppCheck
import typingsJapgolly.firebaseAppCheck.distSrcPublicTypesMod.AppCheckOptions
import typingsJapgolly.firebaseAppCheck.distSrcPublicTypesMod.AppCheckTokenResult
import typingsJapgolly.firebaseAppCheck.distSrcPublicTypesMod.CustomProviderOptions
...
object distSrcApiMod {
  ...
  @JSImport("@firebase/app-check/dist/src/api", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/app-check/dist/src/api", "CustomProvider")
  @js.native
  open class CustomProvider protected ()
    extends typingsJapgolly.firebaseAppCheck.distSrcProvidersMod.CustomProvider {
    def this(_customProviderOptions: CustomProviderOptions) = this()
  }
  
  @JSImport("@firebase/app-check/dist/src/api", "ReCaptchaEnterpriseProvider")
  @js.native
  open class ReCaptchaEnterpriseProvider protected ()
    extends typingsJapgolly.firebaseAppCheck.distSrcProvidersMod.ReCaptchaEnterpriseProvider {
    /**
  ...
  @JSImport("@firebase/app-check/dist/src/api", "ReCaptchaV3Provider")
  @js.native
  open class ReCaptchaV3Provider protected ()
    extends typingsJapgolly.firebaseAppCheck.distSrcProvidersMod.ReCaptchaV3Provider {
    /**
