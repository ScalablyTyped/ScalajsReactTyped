...
import typingsJapgolly.firebaseAppCheck.distEsmSrcPublicTypesMod.AppCheckToken
...
object distEsmSrcTypesMod {
  ...
  trait AppCheckTokenObserver
    ...
    @JSName("next")
    def next_MAppCheckTokenObserver(token: typingsJapgolly.firebaseAppCheck.distEsmSrcPublicTypesMod.AppCheckTokenResult): Unit
    @JSName("next")
  ...
  object AppCheckTokenObserver {
    ...
    inline def apply(
      next: /* token */ typingsJapgolly.firebaseAppCheck.distEsmSrcPublicTypesMod.AppCheckTokenResult => Callback,
      `type`: ListenerType
    ): AppCheckTokenObserver = {
      val __obj = js.Dynamic.literal(next = js.Any.fromFunction1((t0: /* token */ typingsJapgolly.firebaseAppCheck.distEsmSrcPublicTypesMod.AppCheckTokenResult) => next(t0).runNow()))
    ...
    extension [Self <: AppCheckTokenObserver](x: Self) {
      ...
      inline def setNext(
        value: /* token */ typingsJapgolly.firebaseAppCheck.distEsmSrcPublicTypesMod.AppCheckTokenResult => Callback
      ): Self = StObject.set(x, "next", js.Any.fromFunction1((t0: /* token */ typingsJapgolly.firebaseAppCheck.distEsmSrcPublicTypesMod.AppCheckTokenResult) => value(t0).runNow()))
