...
import typingsJapgolly.firebaseAppCheck.distSrcProvidersMod.CustomProvider
import typingsJapgolly.firebaseAppCheck.distSrcProvidersMod.ReCaptchaEnterpriseProvider
import typingsJapgolly.firebaseAppCheck.distSrcProvidersMod.ReCaptchaV3Provider
