...
import typingsJapgolly.firebaseAppCheck.anon.Action
import typingsJapgolly.firebaseAppCheck.firebaseAppCheckStrings.invisible
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distEsmSrcRecaptchaMod {
  
  @JSImport("@firebase/app-check/dist/esm/src/recaptcha", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/app-check/dist/esm/src/recaptcha", "RECAPTCHA_ENTERPRISE_URL")
  @js.native
  val RECAPTCHA_ENTERPRISE_URL: /* "https://www.google.com/recaptcha/enterprise.js" */ String = js.native
  
  @JSImport("@firebase/app-check/dist/esm/src/recaptcha", "RECAPTCHA_URL")
  @js.native
