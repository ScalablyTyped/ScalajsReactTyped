...
object distSrcMod {
  ...
  open class CustomProvider protected ()
    extends typingsJapgolly.firebaseAppCheck.distSrcApiMod.CustomProvider {
  ...
  open class ReCaptchaEnterpriseProvider protected ()
    extends typingsJapgolly.firebaseAppCheck.distSrcApiMod.ReCaptchaEnterpriseProvider {
    /**
  ...
  open class ReCaptchaV3Provider protected ()
    extends typingsJapgolly.firebaseAppCheck.distSrcApiMod.ReCaptchaV3Provider {
    /**
