...
object ComponentConfig {
  ...
  def apply(
    ...
    defaultDotcollator: (/* markup */ String, /* item */ AnonHandle) => CallbackTo[String] = null,
    ...
    if (defaultDotcollator != null) __obj.updateDynamic("defaultDotcollator")(js.Any.fromFunction2((t0: /* markup */ java.lang.String, t1: /* item */ typingsJapgolly.frctlFractal.AnonHandle) => defaultDotcollator(t0, t1).runNow()))
