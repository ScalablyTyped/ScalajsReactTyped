...
import typingsJapgolly.frctlFractal.anon.Register
...
object core {
  ...
  object mixins {
    ...
    - typingsJapgolly.frctlFractal.mod.fractal.core.mixins.Configurable because Inheritance from two classes. Inlined config, config, set, set, get, get */ @JSImport("@frctl/fractal", "fractal.core.mixins.ConfigurableEmitter")
    @js.native
    ...
    open class Entity () extends StObject {
      ...
      val source: EntitySource[typingsJapgolly.frctlFractal.mod.fractal.core.entities.Entity, Any] = js.native
