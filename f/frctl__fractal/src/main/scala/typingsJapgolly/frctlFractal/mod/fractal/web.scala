...
import typingsJapgolly.frctlFractal.anon.ErrorCount
import typingsJapgolly.frctlFractal.anon.Sync
...
object web {
  ...
  open class Server () extends EventEmitter {
    ...
    val ports: typingsJapgolly.frctlFractal.anon.Server = js.native
