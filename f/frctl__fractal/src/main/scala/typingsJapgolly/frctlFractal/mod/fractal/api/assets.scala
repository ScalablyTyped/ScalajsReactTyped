package typingsJapgolly.frctlFractal.mod.fractal.api
...
object assets extends js.Object {
  ...
  - typingsJapgolly.frctlFractal.mod.fractal.core.mixins.Configurable because Inheritance from two classes. Inlined config, config, set, set, get, get */ @js.native
