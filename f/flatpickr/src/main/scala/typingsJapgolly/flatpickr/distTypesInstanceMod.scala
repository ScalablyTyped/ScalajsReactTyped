...
import typingsJapgolly.flatpickr.anon.Capture
import typingsJapgolly.flatpickr.anon.GetDaysInMonth
import typingsJapgolly.flatpickr.anon.PartialParsedOptions
import typingsJapgolly.flatpickr.anon.Remove
import typingsJapgolly.flatpickr.anon.kinkeyCustomLocaledefault
import typingsJapgolly.flatpickr.anon.kinkeyofOptionsOptionsk
...
import typingsJapgolly.flatpickr.distTypesGlobalsMod.global.Window
...
import typingsJapgolly.flatpickr.distUtilsFormattingMod.Formats_
import typingsJapgolly.flatpickr.distUtilsFormattingMod.RevFormat_
import typingsJapgolly.flatpickr.distUtilsFormattingMod.TokenRegex_
...
object distTypesInstanceMod {
  ...
  trait Elements extends StObject {
    ...
    var amPM: js.UndefOr[org.scalajs.dom.HTMLSpanElement] = js.undefined
    
    var calendarContainer: HTMLDivElement
    
    var currentMonthElement: org.scalajs.dom.HTMLSpanElement
    ...
    var monthElements: js.Array[org.scalajs.dom.HTMLSpanElement]
  ...
  object Elements {
    ...
    inline def apply(
      ...
      currentMonthElement: org.scalajs.dom.HTMLSpanElement,
      currentYearElement: HTMLInputElement,
      days: HTMLDivElement,
      element: HTMLElement,
      input: HTMLInputElement,
      monthElements: js.Array[org.scalajs.dom.HTMLSpanElement],
    ...
    extension [Self <: Elements](x: Self) {
      ...
      inline def setAmPM(value: org.scalajs.dom.HTMLSpanElement): Self = StObject.set(x, "amPM", value.asInstanceOf[js.Any])
      ...
      inline def setCurrentMonthElement(value: org.scalajs.dom.HTMLSpanElement): Self = StObject.set(x, "currentMonthElement", value.asInstanceOf[js.Any])
      ...
      inline def setMonthElements(value: js.Array[org.scalajs.dom.HTMLSpanElement]): Self = StObject.set(x, "monthElements", value.asInstanceOf[js.Any])
      
      inline def setMonthElementsVarargs(value: org.scalajs.dom.HTMLSpanElement*): Self = StObject.set(x, "monthElements", js.Array(value*))
  ...
  trait Instance
    ...
    def set(
      option: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 62, starting with typingsJapgolly.flatpickr.flatpickrStrings.plugins, typingsJapgolly.flatpickr.flatpickrStrings.showMonths, typingsJapgolly.flatpickr.flatpickrStrings.disable */ Any
    ): Unit = js.native
    def set(
      option: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 62, starting with typingsJapgolly.flatpickr.flatpickrStrings.plugins, typingsJapgolly.flatpickr.flatpickrStrings.showMonths, typingsJapgolly.flatpickr.flatpickrStrings.disable */ Any,
      value: Any
