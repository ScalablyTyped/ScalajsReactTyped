...
import typingsJapgolly.flatpickr.distTypesOptionsMod.DateLimit
import typingsJapgolly.flatpickr.distTypesOptionsMod.DateOption
import typingsJapgolly.flatpickr.distTypesOptionsMod.Hook
...
object anon {
  ...
  object PartialParsedOptions {
    ...
    extension [Self <: PartialParsedOptions](x: Self) {
      ...
      inline def setErrorHandler(value: /* err */ js.Error => Callback): Self = StObject.set(x, "errorHandler", js.Any.fromFunction1((t0: /* err */ js.Error) => value(t0).runNow()))
  ...
  object kinkeyofOptionsOptionsk {
    ...
    extension [Self <: kinkeyofOptionsOptionsk](x: Self) {
      ...
      inline def setPositionFunction2(value: (kinkeyofOptionsOptionsk, /* customElement */ js.UndefOr[HTMLElement]) => Callback): Self = StObject.set(x, "position", js.Any.fromFunction2((t0: kinkeyofOptionsOptionsk, t1: /* customElement */ js.UndefOr[HTMLElement]) => (value(t0, t1)).runNow()))
