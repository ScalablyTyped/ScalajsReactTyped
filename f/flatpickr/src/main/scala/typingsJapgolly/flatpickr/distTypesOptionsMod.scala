...
object distTypesOptionsMod {
  ...
  object BaseOptions {
    ...
    extension [Self <: BaseOptions](x: Self) {
      ...
      inline def setErrorHandler(value: js.Error => Callback): Self = StObject.set(x, "errorHandler", js.Any.fromFunction1((t0: js.Error) => value(t0).runNow()))
      ...
      inline def setOnDestroyFunction4(
        value: (/* dates */ js.Array[Date], /* currentDateString */ String, /* self */ Instance, /* data */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "onDestroy", js.Any.fromFunction4((t0: /* dates */ js.Array[Date], t1: /* currentDateString */ String, t2: /* self */ Instance, t3: /* data */ js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
      ...
      inline def setOnKeyDownFunction4(
        value: (/* dates */ js.Array[Date], /* currentDateString */ String, /* self */ Instance, /* data */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction4((t0: /* dates */ js.Array[Date], t1: /* currentDateString */ String, t2: /* self */ Instance, t3: /* data */ js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
      ...
      inline def setOnParseConfigFunction4(
        value: (/* dates */ js.Array[Date], /* currentDateString */ String, /* self */ Instance, /* data */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "onParseConfig", js.Any.fromFunction4((t0: /* dates */ js.Array[Date], t1: /* currentDateString */ String, t2: /* self */ Instance, t3: /* data */ js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
      ...
      inline def setOnPreCalendarPositionFunction4(
        value: (/* dates */ js.Array[Date], /* currentDateString */ String, /* self */ Instance, /* data */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "onPreCalendarPosition", js.Any.fromFunction4((t0: /* dates */ js.Array[Date], t1: /* currentDateString */ String, t2: /* self */ Instance, t3: /* data */ js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
      ...
      inline def setPositionFunction2(value: (/* self */ Instance, /* customElement */ js.UndefOr[HTMLElement]) => Callback): Self = StObject.set(x, "position", js.Any.fromFunction2((t0: /* self */ Instance, t1: /* customElement */ js.UndefOr[HTMLElement]) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.flatpickr.flatpickrStrings.onChange
    - typingsJapgolly.flatpickr.flatpickrStrings.onClose
    - typingsJapgolly.flatpickr.flatpickrStrings.onDayCreate
    - typingsJapgolly.flatpickr.flatpickrStrings.onDestroy
    - typingsJapgolly.flatpickr.flatpickrStrings.onKeyDown
    - typingsJapgolly.flatpickr.flatpickrStrings.onMonthChange
    - typingsJapgolly.flatpickr.flatpickrStrings.onOpen
    - typingsJapgolly.flatpickr.flatpickrStrings.onParseConfig
    - typingsJapgolly.flatpickr.flatpickrStrings.onReady
    - typingsJapgolly.flatpickr.flatpickrStrings.onValueUpdate
    - typingsJapgolly.flatpickr.flatpickrStrings.onYearChange
    - typingsJapgolly.flatpickr.flatpickrStrings.onPreCalendarPosition
  */
  trait HookKey extends StObject
  object HookKey {
    
    inline def onChange: typingsJapgolly.flatpickr.flatpickrStrings.onChange = "onChange".asInstanceOf[typingsJapgolly.flatpickr.flatpickrStrings.onChange]
    
    inline def onClose: typingsJapgolly.flatpickr.flatpickrStrings.onClose = "onClose".asInstanceOf[typingsJapgolly.flatpickr.flatpickrStrings.onClose]
    
    inline def onDayCreate: typingsJapgolly.flatpickr.flatpickrStrings.onDayCreate = "onDayCreate".asInstanceOf[typingsJapgolly.flatpickr.flatpickrStrings.onDayCreate]
    
    inline def onDestroy: typingsJapgolly.flatpickr.flatpickrStrings.onDestroy = "onDestroy".asInstanceOf[typingsJapgolly.flatpickr.flatpickrStrings.onDestroy]
    
    inline def onKeyDown: typingsJapgolly.flatpickr.flatpickrStrings.onKeyDown = "onKeyDown".asInstanceOf[typingsJapgolly.flatpickr.flatpickrStrings.onKeyDown]
    
    inline def onMonthChange: typingsJapgolly.flatpickr.flatpickrStrings.onMonthChange = "onMonthChange".asInstanceOf[typingsJapgolly.flatpickr.flatpickrStrings.onMonthChange]
    
    inline def onOpen: typingsJapgolly.flatpickr.flatpickrStrings.onOpen = "onOpen".asInstanceOf[typingsJapgolly.flatpickr.flatpickrStrings.onOpen]
    
    inline def onParseConfig: typingsJapgolly.flatpickr.flatpickrStrings.onParseConfig = "onParseConfig".asInstanceOf[typingsJapgolly.flatpickr.flatpickrStrings.onParseConfig]
    
    inline def onPreCalendarPosition: typingsJapgolly.flatpickr.flatpickrStrings.onPreCalendarPosition = "onPreCalendarPosition".asInstanceOf[typingsJapgolly.flatpickr.flatpickrStrings.onPreCalendarPosition]
    
    inline def onReady: typingsJapgolly.flatpickr.flatpickrStrings.onReady = "onReady".asInstanceOf[typingsJapgolly.flatpickr.flatpickrStrings.onReady]
    
    inline def onValueUpdate: typingsJapgolly.flatpickr.flatpickrStrings.onValueUpdate = "onValueUpdate".asInstanceOf[typingsJapgolly.flatpickr.flatpickrStrings.onValueUpdate]
    
    inline def onYearChange: typingsJapgolly.flatpickr.flatpickrStrings.onYearChange = "onYearChange".asInstanceOf[typingsJapgolly.flatpickr.flatpickrStrings.onYearChange]
  }
