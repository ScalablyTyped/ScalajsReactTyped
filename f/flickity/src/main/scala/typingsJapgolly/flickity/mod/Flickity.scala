...
import typingsJapgolly.flickity.mod._Global_.JQuery
...
trait Flickity extends js.Object {
  ...
  def append(elements: js.Array[typingsJapgolly.std.Element]): Unit = js.native
  /**
  ...
  def append(elements: typingsJapgolly.std.Element): Unit = js.native
  ...
  def insert(elements: js.Array[typingsJapgolly.std.Element], index: Double): Unit = js.native
  /**
  ...
  def insert(elements: typingsJapgolly.std.Element, index: Double): Unit = js.native
  ...
  def off(
    ...
    callback: js.Function2[js.UndefOr[Event_], js.UndefOr[typingsJapgolly.std.Element | Touch], _]
  ): Unit = js.native
  /**
    * Remove event listener
    * @param eventName name of event  (@see Flickity.FlickityEvents class for filckity supported events)
  ...
  def off(
    ...
    callback: js.Function3[
      ...
      /* pointer */ js.UndefOr[typingsJapgolly.std.Element | Touch], 
  ...
  def off(
    ...
    callback: js.Function4[
      /* event */ js.UndefOr[Event_], 
      /* pointer */ js.UndefOr[typingsJapgolly.std.Element | Touch], 
      /* cellElement */ js.UndefOr[typingsJapgolly.std.Element], 
  ...
  def prepend(elements: js.Array[typingsJapgolly.std.Element]): Unit = js.native
  /**
  ...
  def prepend(elements: typingsJapgolly.std.Element): Unit = js.native
  ...
  def remove(elements: js.Array[typingsJapgolly.std.Element]): Unit = js.native
  /**
  ...
  def remove(elements: typingsJapgolly.std.Element): Unit = js.native
