...
import typingsJapgolly.fluentuiDateTimeUtilities.libDateGridDateGridDottypesMod.IAvailableDateOptions
...
object mod {
  ...
  object MonthOfYear extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.MonthOfYear & Double
      ] = js.native
