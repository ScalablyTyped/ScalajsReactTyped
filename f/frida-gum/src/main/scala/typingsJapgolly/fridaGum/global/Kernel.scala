...
import typingsJapgolly.fridaGum.KernelMemoryScanCallbacks
import typingsJapgolly.fridaGum.KernelMemoryScanMatch
import typingsJapgolly.fridaGum.KernelModuleDetails
import typingsJapgolly.fridaGum.KernelModuleRangeDetails
import typingsJapgolly.fridaGum.KernelRangeDetails
...
object Kernel {
  ...
  inline def scan(
    address: UInt64,
    size: Double,
    pattern: typingsJapgolly.fridaGum.MatchPattern,
  ...
  inline def scanSync(address: UInt64, size: Double, pattern: typingsJapgolly.fridaGum.MatchPattern): js.Array[KernelMemoryScanMatch] = (^.asInstanceOf[js.Dynamic].applyDynamic("scanSync")(address.asInstanceOf[js.Any], size.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[js.Array[KernelMemoryScanMatch]]
  ...
  inline def scanSync(address: UInt64, size: UInt64, pattern: typingsJapgolly.fridaGum.MatchPattern): js.Array[KernelMemoryScanMatch] = (^.asInstanceOf[js.Dynamic].applyDynamic("scanSync")(address.asInstanceOf[js.Any], size.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[js.Array[KernelMemoryScanMatch]]
