...
import typingsJapgolly.fridaGum.SqliteOpenOptions
...
open class SqliteDatabase ()
  extends StObject
     with typingsJapgolly.fridaGum.SqliteDatabase {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def prepare(sql: String): typingsJapgolly.fridaGum.SqliteStatement = js.native
}
object SqliteDatabase {
  ...
  /**
    ...
    */
  /* static member */
  inline def open(path: String): typingsJapgolly.fridaGum.SqliteDatabase = ^.asInstanceOf[js.Dynamic].applyDynamic("open")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.fridaGum.SqliteDatabase]
  inline def open(path: String, options: SqliteOpenOptions): typingsJapgolly.fridaGum.SqliteDatabase = (^.asInstanceOf[js.Dynamic].applyDynamic("open")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fridaGum.SqliteDatabase]
  ...
  /**
    ...
    */
  /* static member */
  inline def openInline(encodedContents: String): typingsJapgolly.fridaGum.SqliteDatabase = ^.asInstanceOf[js.Dynamic].applyDynamic("openInline")(encodedContents.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.fridaGum.SqliteDatabase]
}
