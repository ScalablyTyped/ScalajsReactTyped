...
open class ArmRelocator protected ()
  extends StObject
     with typingsJapgolly.fridaGum.ArmRelocator {
  /**
    ...
    *               address.
    */
  def this(inputCode: NativePointerValue, output: typingsJapgolly.fridaGum.ArmWriter) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def reset(inputCode: NativePointerValue, output: typingsJapgolly.fridaGum.ArmWriter): Unit = js.native
