...
@js.native
open class X86Relocator protected ()
  extends StObject
     with typingsJapgolly.fridaGum.X86Relocator {
  /**
    ...
    *               address.
    */
  def this(inputCode: NativePointerValue, output: typingsJapgolly.fridaGum.X86Writer) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def reset(inputCode: NativePointerValue, output: typingsJapgolly.fridaGum.X86Writer): Unit = js.native
