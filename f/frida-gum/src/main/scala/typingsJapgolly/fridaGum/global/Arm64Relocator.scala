...
open class Arm64Relocator protected ()
  extends StObject
     with typingsJapgolly.fridaGum.Arm64Relocator {
  /**
    ...
    *               address.
    */
  def this(inputCode: NativePointerValue, output: typingsJapgolly.fridaGum.Arm64Writer) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def reset(inputCode: NativePointerValue, output: typingsJapgolly.fridaGum.Arm64Writer): Unit = js.native
