...
import typingsJapgolly.fridaGum.HexdumpOptions
import typingsJapgolly.fridaGum.ImmediateId
import typingsJapgolly.fridaGum.Int64
import typingsJapgolly.fridaGum.IntervalId
import typingsJapgolly.fridaGum.MessageCallback
import typingsJapgolly.fridaGum.MessageRecvOperation
import typingsJapgolly.fridaGum.NativePointerValue
import typingsJapgolly.fridaGum.ScheduledCallback
import typingsJapgolly.fridaGum.TimeoutId
...
/**
  ...
  */
inline def NULL: typingsJapgolly.fridaGum.NativePointer = js.Dynamic.global.selectDynamic("NULL").asInstanceOf[typingsJapgolly.fridaGum.NativePointer]
...
/**
  ...
  */
inline def ptr(value: String): typingsJapgolly.fridaGum.NativePointer = js.Dynamic.global.applyDynamic("ptr")(value.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.fridaGum.NativePointer]
inline def ptr(value: Double): typingsJapgolly.fridaGum.NativePointer = js.Dynamic.global.applyDynamic("ptr")(value.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.fridaGum.NativePointer]
