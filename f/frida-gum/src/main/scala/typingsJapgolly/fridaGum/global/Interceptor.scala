...
import typingsJapgolly.fridaGum.InstructionProbeCallback
import typingsJapgolly.fridaGum.InvocationListenerCallbacks
...
object Interceptor {
  ...
  inline def attach(target: NativePointerValue, callbacksOrProbe: InstructionProbeCallback): typingsJapgolly.fridaGum.InvocationListener = (^.asInstanceOf[js.Dynamic].applyDynamic("attach")(target.asInstanceOf[js.Any], callbacksOrProbe.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fridaGum.InvocationListener]
  inline def attach(target: NativePointerValue, callbacksOrProbe: InstructionProbeCallback, data: NativePointerValue): typingsJapgolly.fridaGum.InvocationListener = (^.asInstanceOf[js.Dynamic].applyDynamic("attach")(target.asInstanceOf[js.Any], callbacksOrProbe.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fridaGum.InvocationListener]
  /**
    ...
    */
  inline def attach(target: NativePointerValue, callbacksOrProbe: InvocationListenerCallbacks): typingsJapgolly.fridaGum.InvocationListener = (^.asInstanceOf[js.Dynamic].applyDynamic("attach")(target.asInstanceOf[js.Any], callbacksOrProbe.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fridaGum.InvocationListener]
  inline def attach(
    target: NativePointerValue,
    callbacksOrProbe: InvocationListenerCallbacks,
    data: NativePointerValue
  ): typingsJapgolly.fridaGum.InvocationListener = (^.asInstanceOf[js.Dynamic].applyDynamic("attach")(target.asInstanceOf[js.Any], callbacksOrProbe.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fridaGum.InvocationListener]
