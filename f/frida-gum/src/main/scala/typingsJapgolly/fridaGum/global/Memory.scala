...
import typingsJapgolly.fridaGum.MemoryAllocOptions
import typingsJapgolly.fridaGum.MemoryPatchApplyCallback
import typingsJapgolly.fridaGum.MemoryScanCallbacks
import typingsJapgolly.fridaGum.MemoryScanMatch
...
object Memory {
  ...
  /**
    ...
    */
  inline def alloc(size: Double): typingsJapgolly.fridaGum.NativePointer = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(size.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.fridaGum.NativePointer]
  inline def alloc(size: Double, options: MemoryAllocOptions): typingsJapgolly.fridaGum.NativePointer = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(size.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fridaGum.NativePointer]
  inline def alloc(size: UInt64): typingsJapgolly.fridaGum.NativePointer = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(size.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.fridaGum.NativePointer]
  inline def alloc(size: UInt64, options: MemoryAllocOptions): typingsJapgolly.fridaGum.NativePointer = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(size.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fridaGum.NativePointer]
  ...
  /**
    ...
    */
  inline def allocAnsiString(str: String): typingsJapgolly.fridaGum.NativePointer = ^.asInstanceOf[js.Dynamic].applyDynamic("allocAnsiString")(str.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.fridaGum.NativePointer]
  ...
  /**
    ...
    * @param str String to allocate.
    */
  inline def allocUtf16String(str: String): typingsJapgolly.fridaGum.NativePointer = ^.asInstanceOf[js.Dynamic].applyDynamic("allocUtf16String")(str.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.fridaGum.NativePointer]
  ...
  /**
    ...
    * @param str String to allocate.
    */
  inline def allocUtf8String(str: String): typingsJapgolly.fridaGum.NativePointer = ^.asInstanceOf[js.Dynamic].applyDynamic("allocUtf8String")(str.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.fridaGum.NativePointer]
  ...
  /**
    ...
    */
  inline def dup(address: NativePointerValue, size: Double): typingsJapgolly.fridaGum.NativePointer = (^.asInstanceOf[js.Dynamic].applyDynamic("dup")(address.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fridaGum.NativePointer]
  inline def dup(address: NativePointerValue, size: UInt64): typingsJapgolly.fridaGum.NativePointer = (^.asInstanceOf[js.Dynamic].applyDynamic("dup")(address.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.fridaGum.NativePointer]
  ...
  inline def scanSync(address: NativePointerValue, size: Double, pattern: typingsJapgolly.fridaGum.MatchPattern): js.Array[MemoryScanMatch] = (^.asInstanceOf[js.Dynamic].applyDynamic("scanSync")(address.asInstanceOf[js.Any], size.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[js.Array[MemoryScanMatch]]
  ...
  inline def scanSync(address: NativePointerValue, size: UInt64, pattern: typingsJapgolly.fridaGum.MatchPattern): js.Array[MemoryScanMatch] = (^.asInstanceOf[js.Dynamic].applyDynamic("scanSync")(address.asInstanceOf[js.Any], size.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[js.Array[MemoryScanMatch]]
}
