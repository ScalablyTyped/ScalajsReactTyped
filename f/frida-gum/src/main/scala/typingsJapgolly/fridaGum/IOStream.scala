...
object IOStream {
  ...
  inline def apply(close: CallbackTo[js.Promise[Unit]], input: InputStream, output: OutputStream): IOStream = {
    val __obj = js.Dynamic.literal(close = close.toJsFn, input = input.asInstanceOf[js.Any], output = output.asInstanceOf[js.Any])
