...
import typingsJapgolly.fridaGum.Java.MethodDispatcher
...
object anon {
  ...
  trait Wrapper
    ...
    /**
      ...
      */
    @JSName("$super")
    var $super: typingsJapgolly.fridaGum.Java.Wrapper[js.Object]
    
    /**
      * Retrieves a `java.lang.Class` wrapper for the current class.
      */
    var `class`: typingsJapgolly.fridaGum.Java.Wrapper[js.Object]
  }
  object Wrapper {
    ...
    inline def apply(
      ...
      $super: typingsJapgolly.fridaGum.Java.Wrapper[js.Object],
      `class`: typingsJapgolly.fridaGum.Java.Wrapper[js.Object]
    ): Wrapper = {
      val __obj = js.Dynamic.literal($alloc = $alloc.asInstanceOf[js.Any], $className = $className.asInstanceOf[js.Any], $dispose = $dispose.toJsFn, $init = $init.asInstanceOf[js.Any], $new = $new.asInstanceOf[js.Any], $ownMembers = $ownMembers.asInstanceOf[js.Any], $super = $super.asInstanceOf[js.Any])
    ...
    extension [Self <: Wrapper](x: Self) {
      ...
      inline def set$dispose(value: Callback): Self = StObject.set(x, "$dispose", value.toJsFn)
      ...
      inline def set$super(value: typingsJapgolly.fridaGum.Java.Wrapper[js.Object]): Self = StObject.set(x, "$super", value.asInstanceOf[js.Any])
      
      inline def setClass(value: typingsJapgolly.fridaGum.Java.Wrapper[js.Object]): Self = StObject.set(x, "class", value.asInstanceOf[js.Any])
    }
  }
}
