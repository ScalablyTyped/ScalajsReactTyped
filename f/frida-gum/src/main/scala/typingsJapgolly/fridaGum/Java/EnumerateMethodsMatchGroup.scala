...
trait EnumerateMethodsMatchGroup extends StObject {
  ...
  /**
    ...
    * interest.
    */
  var loader: typingsJapgolly.fridaGum.anon.Wrapper | Null
}
object EnumerateMethodsMatchGroup {
  ...
  extension [Self <: EnumerateMethodsMatchGroup](x: Self) {
    ...
    inline def setLoader(value: typingsJapgolly.fridaGum.anon.Wrapper): Self = StObject.set(x, "loader", value.asInstanceOf[js.Any])
