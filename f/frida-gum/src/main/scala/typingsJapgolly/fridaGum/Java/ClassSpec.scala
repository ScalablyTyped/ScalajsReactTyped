...
trait ClassSpec extends StObject {
  ...
  /**
    ...
    */
  var implements: js.UndefOr[js.Array[typingsJapgolly.fridaGum.anon.Wrapper]] = js.undefined
  ...
  /**
    ...
    */
  var superClass: js.UndefOr[typingsJapgolly.fridaGum.anon.Wrapper] = js.undefined
}
object ClassSpec {
  ...
  extension [Self <: ClassSpec](x: Self) {
    ...
    inline def setImplements(value: js.Array[typingsJapgolly.fridaGum.anon.Wrapper]): Self = StObject.set(x, "implements", value.asInstanceOf[js.Any])
    
    inline def setImplementsUndefined: Self = StObject.set(x, "implements", js.undefined)
    
    inline def setImplementsVarargs(value: typingsJapgolly.fridaGum.anon.Wrapper*): Self = StObject.set(x, "implements", js.Array(value*))
    ...
    inline def setSuperClass(value: typingsJapgolly.fridaGum.anon.Wrapper): Self = StObject.set(x, "superClass", value.asInstanceOf[js.Any])
