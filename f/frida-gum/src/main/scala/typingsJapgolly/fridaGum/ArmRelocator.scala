...
object ArmRelocator {
  ...
  inline def apply(
    ...
    reset: (NativePointerValue, ArmWriter) => Callback,
    skipOne: Callback,
    writeAll: Callback,
  ...
  extension [Self <: ArmRelocator](x: Self) {
    ...
    inline def setReset(value: (NativePointerValue, ArmWriter) => Callback): Self = StObject.set(x, "reset", js.Any.fromFunction2((t0: NativePointerValue, t1: ArmWriter) => (value(t0, t1)).runNow()))
