...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.fridaGum.PortableCpuContext
  - typingsJapgolly.fridaGum.Ia32CpuContext
  - typingsJapgolly.fridaGum.X64CpuContext
  - typingsJapgolly.fridaGum.ArmCpuContext
  - typingsJapgolly.fridaGum.Arm64CpuContext
  - typingsJapgolly.fridaGum.MipsCpuContext
*/
...
object CpuContext {
  ...
  inline def Arm64CpuContext(
    ...
    __obj.asInstanceOf[typingsJapgolly.fridaGum.Arm64CpuContext]
  }
  ...
  inline def ArmCpuContext(
    ...
    __obj.asInstanceOf[typingsJapgolly.fridaGum.ArmCpuContext]
  }
  ...
  inline def Ia32CpuContext(
    ...
    __obj.asInstanceOf[typingsJapgolly.fridaGum.Ia32CpuContext]
  }
  ...
  inline def MipsCpuContext(
    ...
    __obj.asInstanceOf[typingsJapgolly.fridaGum.MipsCpuContext]
  }
  
  inline def PortableCpuContext(pc: NativePointer, sp: NativePointer): typingsJapgolly.fridaGum.PortableCpuContext = {
    val __obj = js.Dynamic.literal(pc = pc.asInstanceOf[js.Any], sp = sp.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsJapgolly.fridaGum.PortableCpuContext]
  }
  ...
  inline def X64CpuContext(
    ...
    __obj.asInstanceOf[typingsJapgolly.fridaGum.X64CpuContext]
  }
}
