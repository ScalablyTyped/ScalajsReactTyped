...
import typingsJapgolly.firebaseRemoteConfigTypes.mod.LogLevel
import typingsJapgolly.firebaseRemoteConfigTypes.mod.Settings
import typingsJapgolly.firebaseRemoteConfigTypes.mod.Value
...
object remoteConfigMod extends js.Object {
  ...
  class RemoteConfig protected ()
    extends typingsJapgolly.firebaseRemoteConfigTypes.mod.RemoteConfig {
    def this(
      app: FirebaseApp,
