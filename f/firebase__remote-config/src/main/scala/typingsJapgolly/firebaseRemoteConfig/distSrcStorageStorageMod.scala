...
import typingsJapgolly.firebaseRemoteConfig.distSrcClientRemoteConfigFetchClientMod.FirebaseRemoteConfigObject
...
object distSrcStorageStorageMod {
  ...
  */
  ...
  object ProjectNamespaceKeyFieldValue {
    ...
    inline def active_config: typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.active_config = "active_config".asInstanceOf[typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.active_config]
    
    inline def active_config_etag: typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.active_config_etag = "active_config_etag".asInstanceOf[typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.active_config_etag]
    
    inline def last_fetch_status: typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.last_fetch_status = "last_fetch_status".asInstanceOf[typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.last_fetch_status]
    
    inline def last_successful_fetch_response: typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.last_successful_fetch_response = "last_successful_fetch_response".asInstanceOf[typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.last_successful_fetch_response]
    
    inline def last_successful_fetch_timestamp_millis: typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.last_successful_fetch_timestamp_millis = "last_successful_fetch_timestamp_millis".asInstanceOf[typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.last_successful_fetch_timestamp_millis]
    
    inline def settings: typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.settings = "settings".asInstanceOf[typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.settings]
    
    inline def throttle_metadata: typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.throttle_metadata = "throttle_metadata".asInstanceOf[typingsJapgolly.firebaseRemoteConfig.firebaseRemoteConfigStrings.throttle_metadata]
  }
