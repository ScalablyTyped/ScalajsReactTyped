...
import typingsJapgolly.firebaseRemoteConfig.distSrcPublicTypesMod.RemoteConfigSettings
...
object distSrcRemoteConfigMod {
  ...
  open class RemoteConfig protected ()
    extends StObject
       with typingsJapgolly.firebaseRemoteConfig.distSrcPublicTypesMod.RemoteConfig {
    def this(
      app: FirebaseApp,
      /**
      * @internal
