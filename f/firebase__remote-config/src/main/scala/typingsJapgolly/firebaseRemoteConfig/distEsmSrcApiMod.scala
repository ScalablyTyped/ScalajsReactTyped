...
import typingsJapgolly.firebaseRemoteConfig.distEsmSrcPublicTypesMod.LogLevel
import typingsJapgolly.firebaseRemoteConfig.distEsmSrcPublicTypesMod.RemoteConfig
import typingsJapgolly.firebaseRemoteConfig.distEsmSrcPublicTypesMod.Value
...
object distEsmSrcApiMod {
  ...
  @JSImport("@firebase/remote-config/dist/esm/src/api", JSImport.Namespace)
  @js.native
