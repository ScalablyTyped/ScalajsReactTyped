package typingsJapgolly.findDuplicatedPropertyKeys
...
object mod {
  ...
  object PropertyInfo {
    ...
    inline def apply(key: String, occurrence: Double, parent: PropertyInfo, propertyPath: CallbackTo[js.Array[String]]): PropertyInfo = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], occurrence = occurrence.asInstanceOf[js.Any], parent = parent.asInstanceOf[js.Any], propertyPath = propertyPath.toJsFn)
    ...
    extension [Self <: PropertyInfo](x: Self) {
      ...
      inline def setPropertyPath(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "propertyPath", value.toJsFn)
    }
  }
}
