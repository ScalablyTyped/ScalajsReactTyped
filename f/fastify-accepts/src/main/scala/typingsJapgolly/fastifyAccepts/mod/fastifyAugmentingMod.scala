package typingsJapgolly.fastifyAccepts.mod

import typingsJapgolly.accepts.mod.Accepts
import typingsJapgolly.fastifyAccepts.FnCall
import typingsJapgolly.fastifyAccepts.FnCallTypes
import typingsJapgolly.fastifyAccepts.fastifyAcceptsBooleans.`false`
