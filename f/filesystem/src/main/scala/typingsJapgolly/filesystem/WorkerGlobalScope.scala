...
- typingsJapgolly.filesystem.LocalFileSystemSync because var conflicts: PERSISTENT, TEMPORARY. Inlined requestFileSystemSync, resolveLocalFileSystemSyncURL, webkitRequestFileSystemSync */ @js.native
