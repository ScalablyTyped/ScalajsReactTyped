...
object distEsm5SrcApiAuthenticationMfaMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAuth.distEsm5SrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse
    - typingsJapgolly.firebaseAuth.distEsm5SrcApiAuthenticationIdpMod.SignInWithIdpResponse
    - typingsJapgolly.firebaseAuth.distEsm5SrcModelIdTokenMod.IdTokenResponse
  */
  trait PhoneOrOauthTokenResponse extends StObject
  object PhoneOrOauthTokenResponse {
    
    inline def IdTokenResponse(localId: String): typingsJapgolly.firebaseAuth.distEsm5SrcModelIdTokenMod.IdTokenResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distEsm5SrcModelIdTokenMod.IdTokenResponse]
    }
    
    inline def SignInWithIdpResponse(localId: String): typingsJapgolly.firebaseAuth.distEsm5SrcApiAuthenticationIdpMod.SignInWithIdpResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distEsm5SrcApiAuthenticationIdpMod.SignInWithIdpResponse]
    }
    
    inline def SignInWithPhoneNumberResponse(localId: String): typingsJapgolly.firebaseAuth.distEsm5SrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distEsm5SrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse]
    }
  }
