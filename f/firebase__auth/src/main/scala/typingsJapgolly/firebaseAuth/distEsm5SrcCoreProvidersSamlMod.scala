...
import typingsJapgolly.firebaseAuth.distEsm5SrcCoreProvidersFederatedMod.FederatedAuthProvider
...
object distEsm5SrcCoreProvidersSamlMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/core/providers/saml", "SAMLAuthProvider")
  @js.native
  ...
  object SAMLAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/esm5/src/core/providers/saml", "SAMLAuthProvider.samlCredentialFromTaggedObject")
    @js.native
