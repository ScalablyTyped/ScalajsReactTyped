...
import typingsJapgolly.firebaseAuth.distEsm5SrcCoreUtilDelayMod.Delay
...
object distEsm5SrcPlatformBrowserStrategiesPopupMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/platform_browser/strategies/popup", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/esm5/src/platform_browser/strategies/popup", "_POLL_WINDOW_CLOSE_TIMEOUT")
  @js.native
