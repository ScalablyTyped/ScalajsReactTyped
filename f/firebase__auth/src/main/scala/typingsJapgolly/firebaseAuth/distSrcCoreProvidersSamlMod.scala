...
import typingsJapgolly.firebaseAuth.distSrcCoreProvidersFederatedMod.FederatedAuthProvider
...
object distSrcCoreProvidersSamlMod {
  
  @JSImport("@firebase/auth/dist/src/core/providers/saml", "SAMLAuthProvider")
  @js.native
  ...
  object SAMLAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/src/core/providers/saml", "SAMLAuthProvider.samlCredentialFromTaggedObject")
    @js.native
