...
trait MultiFactorInfoPreviousEmail extends StObject {
  ...
  var multiFactorInfo: js.UndefOr[
    typingsJapgolly.firebaseAuth.distEsm5SrcModelPublicTypesMod.MultiFactorInfo | Null
  ] = js.undefined
...
object MultiFactorInfoPreviousEmail {
  ...
  extension [Self <: MultiFactorInfoPreviousEmail](x: Self) {
    ...
    inline def setMultiFactorInfo(value: typingsJapgolly.firebaseAuth.distEsm5SrcModelPublicTypesMod.MultiFactorInfo): Self = StObject.set(x, "multiFactorInfo", value.asInstanceOf[js.Any])
