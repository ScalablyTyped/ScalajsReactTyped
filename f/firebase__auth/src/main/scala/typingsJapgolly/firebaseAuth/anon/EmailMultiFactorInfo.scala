...
trait EmailMultiFactorInfo extends StObject {
  ...
  var multiFactorInfo: js.UndefOr[
    typingsJapgolly.firebaseAuth.distEsm2017SrcModelPublicTypesMod.MultiFactorInfo | Null
  ] = js.undefined
...
object EmailMultiFactorInfo {
  ...
  extension [Self <: EmailMultiFactorInfo](x: Self) {
    ...
    inline def setMultiFactorInfo(value: typingsJapgolly.firebaseAuth.distEsm2017SrcModelPublicTypesMod.MultiFactorInfo): Self = StObject.set(x, "multiFactorInfo", value.asInstanceOf[js.Any])
