...
import typingsJapgolly.firebaseAuth.distCordovaSrcModelPopupRedirectMod.AuthEventError
...
object PartialAuthEvent {
  
  inline def apply(): PartialAuthEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAuthEvent]
  }
  
  extension [Self <: PartialAuthEvent](x: Self) {
