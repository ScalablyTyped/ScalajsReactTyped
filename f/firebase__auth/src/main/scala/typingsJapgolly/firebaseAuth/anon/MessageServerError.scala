...
import typingsJapgolly.firebaseAuth.distSrcApiErrorsMod.ServerError
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait MessageServerError extends StObject {
...
object MessageServerError {
  
  inline def apply(domain: String, message: ServerError, reason: String): MessageServerError = {
