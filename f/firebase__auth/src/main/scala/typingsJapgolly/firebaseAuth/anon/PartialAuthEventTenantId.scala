...
import typingsJapgolly.firebaseAuth.distRnSrcModelPopupRedirectMod.AuthEventError
...
trait PartialAuthEventTenantId extends StObject {
...
object PartialAuthEventTenantId {
  
  inline def apply(): PartialAuthEventTenantId = {
