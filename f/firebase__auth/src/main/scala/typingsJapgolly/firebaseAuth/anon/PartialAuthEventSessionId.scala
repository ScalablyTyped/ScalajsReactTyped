...
import typingsJapgolly.firebaseAuth.distNodeSrcModelPopupRedirectMod.AuthEventError
import typingsJapgolly.firebaseAuth.distNodeSrcModelPopupRedirectMod.AuthEventType
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Partial<@firebase/auth.@firebase/auth/dist/node/src/model/popup_redirect.AuthEvent> */
trait PartialAuthEventSessionId extends StObject {
...
object PartialAuthEventSessionId {
  
  inline def apply(): PartialAuthEventSessionId = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAuthEventSessionId]
  }
  
  extension [Self <: PartialAuthEventSessionId](x: Self) {
