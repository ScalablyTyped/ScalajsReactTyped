...
trait `23` extends StObject {
  ...
  var multiFactorInfo: js.UndefOr[
    typingsJapgolly.firebaseAuth.distNodeSrcModelPublicTypesMod.MultiFactorInfo | Null
  ] = js.undefined
...
object `23` {
  ...
  extension [Self <: `23`](x: Self) {
    ...
    inline def setMultiFactorInfo(value: typingsJapgolly.firebaseAuth.distNodeSrcModelPublicTypesMod.MultiFactorInfo): Self = StObject.set(x, "multiFactorInfo", value.asInstanceOf[js.Any])
