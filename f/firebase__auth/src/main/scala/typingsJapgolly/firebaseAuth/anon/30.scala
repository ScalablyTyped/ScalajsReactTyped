...
trait `30` extends StObject {
  ...
  var multiFactorInfo: js.UndefOr[typingsJapgolly.firebaseAuth.distRnSrcModelPublicTypesMod.MultiFactorInfo | Null] = js.undefined
...
object `30` {
  ...
  extension [Self <: `30`](x: Self) {
    ...
    inline def setMultiFactorInfo(value: typingsJapgolly.firebaseAuth.distRnSrcModelPublicTypesMod.MultiFactorInfo): Self = StObject.set(x, "multiFactorInfo", value.asInstanceOf[js.Any])
