...
trait EmailMultiFactorInfoPreviousEmail extends StObject {
  ...
  var multiFactorInfo: js.UndefOr[
    typingsJapgolly.firebaseAuth.distNodeEsmSrcModelPublicTypesMod.MultiFactorInfo | Null
  ] = js.undefined
...
object EmailMultiFactorInfoPreviousEmail {
  ...
  extension [Self <: EmailMultiFactorInfoPreviousEmail](x: Self) {
    ...
    inline def setMultiFactorInfo(value: typingsJapgolly.firebaseAuth.distNodeEsmSrcModelPublicTypesMod.MultiFactorInfo): Self = StObject.set(x, "multiFactorInfo", value.asInstanceOf[js.Any])
