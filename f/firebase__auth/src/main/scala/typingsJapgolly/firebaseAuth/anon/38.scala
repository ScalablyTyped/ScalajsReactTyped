...
trait `38` extends StObject {
  ...
  var multiFactorInfo: js.UndefOr[typingsJapgolly.firebaseAuth.distSrcModelPublicTypesMod.MultiFactorInfo | Null] = js.undefined
...
object `38` {
  ...
  extension [Self <: `38`](x: Self) {
    ...
    inline def setMultiFactorInfo(value: typingsJapgolly.firebaseAuth.distSrcModelPublicTypesMod.MultiFactorInfo): Self = StObject.set(x, "multiFactorInfo", value.asInstanceOf[js.Any])
