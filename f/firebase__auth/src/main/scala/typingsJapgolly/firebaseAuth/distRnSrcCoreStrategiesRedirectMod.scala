...
import typingsJapgolly.firebaseAuth.distRnSrcCoreStrategiesAbstractPopupRedirectOperationMod.AbstractPopupRedirectOperation
...
object distRnSrcCoreStrategiesRedirectMod {
  
  @JSImport("@firebase/auth/dist/rn/src/core/strategies/redirect", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/rn/src/core/strategies/redirect", "RedirectAction")
  @js.native
