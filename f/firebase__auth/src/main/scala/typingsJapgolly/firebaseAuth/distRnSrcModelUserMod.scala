...
import typingsJapgolly.firebaseAuth.distRnSrcApiAccountManagementAccountMod.APIUserInfo
import typingsJapgolly.firebaseAuth.distRnSrcApiAuthenticationMfaMod.FinalizeMfaResponse
import typingsJapgolly.firebaseAuth.distRnSrcCoreUserTokenManagerMod.StsTokenManager
import typingsJapgolly.firebaseAuth.distRnSrcCoreUserUserMetadataMod.UserMetadata
...
import typingsJapgolly.firebaseAuth.distRnSrcModelIdTokenMod.TaggedWithTokenResponse
...
object distRnSrcModelUserMod {
  
  /* Inlined {-readonly [ K in keyof @firebase/auth.@firebase/auth/dist/rn/src/model/public_types.UserInfo ]: @firebase/auth.@firebase/auth/dist/rn/src/model/public_types.UserInfo[K]} */
