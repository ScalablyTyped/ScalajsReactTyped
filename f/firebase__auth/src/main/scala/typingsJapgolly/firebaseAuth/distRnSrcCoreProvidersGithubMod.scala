...
import typingsJapgolly.firebaseAuth.distRnSrcCoreCredentialsOauthMod.OAuthCredential
import typingsJapgolly.firebaseAuth.distRnSrcCoreProvidersOauthMod.BaseOAuthProvider
...
object distRnSrcCoreProvidersGithubMod {
  
  @JSImport("@firebase/auth/dist/rn/src/core/providers/github", "GithubAuthProvider")
  @js.native
  ...
  object GithubAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/rn/src/core/providers/github", "GithubAuthProvider.GITHUB_SIGN_IN_METHOD")
    @js.native
    val GITHUB_SIGN_IN_METHOD: githubDotcom = js.native
    
    /** Always set to {@link ProviderId}.GITHUB. */
    @JSImport("@firebase/auth/dist/rn/src/core/providers/github", "GithubAuthProvider.PROVIDER_ID")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/rn/src/core/providers/github", "GithubAuthProvider.credentialFromTaggedObject")
    @js.native
