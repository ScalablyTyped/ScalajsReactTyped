...
object distCordovaSrcApiAuthenticationSmsMod {
  ...
  - typingsJapgolly.firebaseAuth.distCordovaSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithPhoneNumberResponse
    extends StObject
