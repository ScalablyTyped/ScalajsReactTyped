...
import typingsJapgolly.firebaseAuth.anon.OmitIArgumentscallee
...
import typingsJapgolly.firebaseAuth.firebaseAuthStrings.appName
...
object distRnSrcCoreUtilAssertMod {
