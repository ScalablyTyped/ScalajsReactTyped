...
object distEsm2017TestIntegrationFlowsMiddlewareTestGeneratorMod {
  
  @JSImport("@firebase/auth/dist/esm2017/test/integration/flows/middleware_test_generator", JSImport.Namespace)
  @js.native
