...
import typingsJapgolly.firebaseAuth.distEsm2017SrcModelPublicTypesMod.MultiFactorSession
...
object distEsm2017SrcMfaMfaSessionMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/mfa/mfa_session", "MultiFactorSessionImpl")
  @js.native
