...
object distNodeEsmSrcPlatformBrowserMessagechannelPromiseMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAuth.distNodeEsmSrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T]
    - typingsJapgolly.firebaseAuth.distNodeEsmSrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult
  */
  trait PromiseSettledResult[T] extends StObject
  object PromiseSettledResult {
    
    inline def PromiseFulfilledResult[T](value: T): typingsJapgolly.firebaseAuth.distNodeEsmSrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T] = {
      val __obj = js.Dynamic.literal(fulfilled = true, value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distNodeEsmSrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T]]
    }
    
    inline def PromiseRejectedResult(reason: Any): typingsJapgolly.firebaseAuth.distNodeEsmSrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult = {
      val __obj = js.Dynamic.literal(fulfilled = false, reason = reason.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distNodeEsmSrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult]
    }
  }
}
