...
import typingsJapgolly.firebaseAuth.distRnSrcCorePersistenceMod.StorageEventListener
...
object distRnTestHelpersErroringUnavailablePersistenceMod {
  
  @JSImport("@firebase/auth/dist/rn/test/helpers/erroring_unavailable_persistence", "ErroringUnavailablePersistence")
  @js.native
