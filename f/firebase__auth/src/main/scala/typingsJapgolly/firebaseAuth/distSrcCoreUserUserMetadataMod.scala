...
object distSrcCoreUserUserMetadataMod {
  
  @JSImport("@firebase/auth/dist/src/core/user/user_metadata", "UserMetadata")
  @js.native
  open class UserMetadata ()
    extends StObject
       with typingsJapgolly.firebaseAuth.distSrcModelPublicTypesMod.UserMetadata {
