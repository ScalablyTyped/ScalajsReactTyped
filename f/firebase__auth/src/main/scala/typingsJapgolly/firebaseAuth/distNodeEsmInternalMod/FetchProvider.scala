...
@JSImport("@firebase/auth/dist/node-esm/internal", "FetchProvider")
@js.native
open class FetchProvider ()
  extends typingsJapgolly.firebaseAuth.distNodeEsmSrcCoreUtilFetchProviderMod.FetchProvider
/* static members */
object FetchProvider {
  ...
  @JSImport("@firebase/auth/dist/node-esm/internal", "FetchProvider.fetchImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node-esm/internal", "FetchProvider.headersImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node-esm/internal", "FetchProvider.responseImpl")
  @js.native
