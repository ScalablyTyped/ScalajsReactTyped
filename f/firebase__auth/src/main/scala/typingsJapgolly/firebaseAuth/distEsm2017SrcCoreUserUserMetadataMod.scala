...
object distEsm2017SrcCoreUserUserMetadataMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/core/user/user_metadata", "UserMetadata")
  @js.native
  open class UserMetadata ()
    extends StObject
       with typingsJapgolly.firebaseAuth.distEsm2017SrcModelPublicTypesMod.UserMetadata {
