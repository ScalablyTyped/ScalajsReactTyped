...
import typingsJapgolly.firebaseAuth.distEsm2017SrcModelUserMod.UserParameters
...
open class UserImpl protected ()
  extends typingsJapgolly.firebaseAuth.distEsm2017SrcCoreUserUserImplMod.UserImpl {
