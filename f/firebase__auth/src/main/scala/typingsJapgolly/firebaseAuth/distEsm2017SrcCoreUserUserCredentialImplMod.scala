...
import typingsJapgolly.firebaseAuth.distEsm2017SrcModelEnumsMod.OperationType
import typingsJapgolly.firebaseAuth.distEsm2017SrcModelEnumsMod.ProviderId
...
object distEsm2017SrcCoreUserUserCredentialImplMod {
  ...
  - typingsJapgolly.firebaseAuth.distEsm2017SrcCoreUserUserCredentialImplMod.UserCredentialParams because var conflicts: _tokenResponse, operationType, providerId, user. Inlined  */ @JSImport("@firebase/auth/dist/esm2017/src/core/user/user_credential_impl", "UserCredentialImpl")
  @js.native
