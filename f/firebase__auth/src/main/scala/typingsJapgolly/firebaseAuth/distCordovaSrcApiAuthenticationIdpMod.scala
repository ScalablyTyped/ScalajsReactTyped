...
import typingsJapgolly.firebaseAuth.distCordovaSrcModelIdTokenMod.IdToken
...
object distCordovaSrcApiAuthenticationIdpMod {
  ...
  - typingsJapgolly.firebaseAuth.distCordovaSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
