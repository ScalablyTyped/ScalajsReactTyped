...
import typingsJapgolly.firebaseAuth.distNodeEsmSrcApiAccountManagementMfaMod.MfaEnrollment
import typingsJapgolly.firebaseAuth.distNodeEsmSrcApiAuthenticationSmsMod.SignInWithPhoneNumberRequest
...
object distNodeEsmSrcApiAuthenticationMfaMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/api/authentication/mfa", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAuth.distNodeEsmSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse
    - typingsJapgolly.firebaseAuth.distNodeEsmSrcApiAuthenticationIdpMod.SignInWithIdpResponse
    - typingsJapgolly.firebaseAuth.distNodeEsmSrcModelIdTokenMod.IdTokenResponse
  */
  trait PhoneOrOauthTokenResponse extends StObject
  object PhoneOrOauthTokenResponse {
    
    inline def IdTokenResponse(localId: String): typingsJapgolly.firebaseAuth.distNodeEsmSrcModelIdTokenMod.IdTokenResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distNodeEsmSrcModelIdTokenMod.IdTokenResponse]
    }
    
    inline def SignInWithIdpResponse(localId: String): typingsJapgolly.firebaseAuth.distNodeEsmSrcApiAuthenticationIdpMod.SignInWithIdpResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distNodeEsmSrcApiAuthenticationIdpMod.SignInWithIdpResponse]
    }
    
    inline def SignInWithPhoneNumberResponse(localId: String): typingsJapgolly.firebaseAuth.distNodeEsmSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distNodeEsmSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse]
    }
  }
