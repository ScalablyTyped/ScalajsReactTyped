...
object distCordovaMod {
  ...
  open class ActionCodeURL protected ()
    extends typingsJapgolly.firebaseAuth.distCordovaSrcMod.ActionCodeURL {
    /**
  ...
  open class AuthCredential protected ()
    extends typingsJapgolly.firebaseAuth.distCordovaSrcMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  /* private */ open class EmailAuthCredential ()
    extends typingsJapgolly.firebaseAuth.distCordovaSrcMod.EmailAuthCredential
  /* static members */
  ...
  open class EmailAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distCordovaSrcMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distCordovaSrcMod.FacebookAuthProvider
  /* static members */
  ...
  open class GithubAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distCordovaSrcMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distCordovaSrcMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential protected ()
    extends typingsJapgolly.firebaseAuth.distCordovaSrcMod.OAuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
      * The authentication provider ID for the credential.
  ...
  open class OAuthProvider protected ()
    extends typingsJapgolly.firebaseAuth.distCordovaSrcMod.OAuthProvider {
    /**
  ...
  /* private */ open class PhoneAuthCredential ()
    extends typingsJapgolly.firebaseAuth.distCordovaSrcMod.PhoneAuthCredential
  /* static members */
  ...
  open class RecaptchaVerifier protected ()
    extends typingsJapgolly.firebaseAuth.distCordovaSrcPlatformBrowserRecaptchaRecaptchaVerifierMod.RecaptchaVerifier {
  ...
  open class SAMLAuthProvider protected ()
    extends typingsJapgolly.firebaseAuth.distCordovaSrcMod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distCordovaSrcMod.TwitterAuthProvider
  /* static members */
