...
object distCordovaSrcCorePersistenceInMemoryMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/core/persistence/in_memory", "InMemoryPersistence")
  @js.native
  ...
  object InMemoryPersistence_ {
    ...
    @JSImport("@firebase/auth/dist/cordova/src/core/persistence/in_memory", "InMemoryPersistence.type")
    @js.native
