...
import typingsJapgolly.firebaseAuth.distNodeSrcCoreAuthAuthEventManagerMod.AuthEventManager
...
object distNodeSrcPlatformCordovaPopupRedirectEventsMod {
  
  @JSImport("@firebase/auth/dist/node/src/platform_cordova/popup_redirect/events", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/node/src/platform_cordova/popup_redirect/events", "CordovaAuthEventManager")
  @js.native
