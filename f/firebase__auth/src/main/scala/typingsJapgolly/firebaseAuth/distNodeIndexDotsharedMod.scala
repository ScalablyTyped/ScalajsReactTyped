...
object distNodeIndexDotsharedMod {
  ...
  open class ActionCodeURL protected ()
    extends typingsJapgolly.firebaseAuth.distNodeSrcMod.ActionCodeURL {
    /**
  ...
  open class AuthCredential protected ()
    extends typingsJapgolly.firebaseAuth.distNodeSrcMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  /* private */ open class EmailAuthCredential ()
    extends typingsJapgolly.firebaseAuth.distNodeSrcMod.EmailAuthCredential
  /* static members */
  ...
  open class EmailAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distNodeSrcMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distNodeSrcMod.FacebookAuthProvider
  /* static members */
  ...
  open class GithubAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distNodeSrcMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distNodeSrcMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential protected ()
    extends typingsJapgolly.firebaseAuth.distNodeSrcMod.OAuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
      * The authentication provider ID for the credential.
  ...
  open class OAuthProvider protected ()
    extends typingsJapgolly.firebaseAuth.distNodeSrcMod.OAuthProvider {
    /**
  ...
  /* private */ open class PhoneAuthCredential ()
    extends typingsJapgolly.firebaseAuth.distNodeSrcMod.PhoneAuthCredential
  /* static members */
  ...
  open class SAMLAuthProvider protected ()
    extends typingsJapgolly.firebaseAuth.distNodeSrcMod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distNodeSrcMod.TwitterAuthProvider
  /* static members */
