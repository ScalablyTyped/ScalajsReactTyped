...
object distNodeEsmTestIntegrationFlowsMiddlewareTestGeneratorMod {
  
  @JSImport("@firebase/auth/dist/node-esm/test/integration/flows/middleware_test_generator", JSImport.Namespace)
  @js.native
