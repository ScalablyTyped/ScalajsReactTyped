...
import typingsJapgolly.firebaseAuth.distSrcModelIdTokenMod.IdToken
...
object distSrcApiAuthenticationIdpMod {
  
  @JSImport("@firebase/auth/dist/src/api/authentication/idp", JSImport.Namespace)
  @js.native
  ...
  - typingsJapgolly.firebaseAuth.distSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
