...
object distEsm2017IndexDotdocMod {
  ...
  open class EmailAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distEsm2017Mod.EmailAuthProvider
  /* static members */
  ...
  open class OAuthProvider protected ()
    extends typingsJapgolly.firebaseAuth.distEsm2017Mod.OAuthProvider {
    /**
  ...
  open class RecaptchaVerifier protected ()
    extends typingsJapgolly.firebaseAuth.distEsm2017Mod.RecaptchaVerifier {
