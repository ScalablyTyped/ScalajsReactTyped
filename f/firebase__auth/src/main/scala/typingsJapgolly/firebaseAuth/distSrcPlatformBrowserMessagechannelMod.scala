...
import typingsJapgolly.firebaseAuth.distSrcPlatformBrowserMessagechannelPromiseMod.PromiseSettledResult
...
object distSrcPlatformBrowserMessagechannelMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAuth.distSrcPlatformBrowserMessagechannelMod.KeyChangedRequest
    - typingsJapgolly.firebaseAuth.distSrcPlatformBrowserMessagechannelMod.PingRequest
  */
  trait SenderRequest extends StObject
  object SenderRequest {
    
    inline def KeyChangedRequest(key: String): typingsJapgolly.firebaseAuth.distSrcPlatformBrowserMessagechannelMod.KeyChangedRequest = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distSrcPlatformBrowserMessagechannelMod.KeyChangedRequest]
    }
  }
