...
import typingsJapgolly.firebaseAuth.anon.PartialServerErrorMapServCAPTCHACHECKFAILED
...
import typingsJapgolly.firebaseAuth.distNodeEsmSrcCoreUtilDelayMod.Delay
...
object distNodeEsmSrcApiMod {
  ...
  @JSImport("@firebase/auth/dist/node-esm/src/api", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/node-esm/src/api", "DEFAULT_API_TIMEOUT_MS")
  @js.native
