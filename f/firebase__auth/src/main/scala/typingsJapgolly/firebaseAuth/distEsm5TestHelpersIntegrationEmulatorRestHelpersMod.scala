...
object distEsm5TestHelpersIntegrationEmulatorRestHelpersMod {
  
  @JSImport("@firebase/auth/dist/esm5/test/helpers/integration/emulator_rest_helpers", JSImport.Namespace)
  @js.native
