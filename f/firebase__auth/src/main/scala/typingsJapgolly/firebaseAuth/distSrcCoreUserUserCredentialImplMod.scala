...
import typingsJapgolly.firebaseAuth.distSrcModelEnumsMod.OperationType
import typingsJapgolly.firebaseAuth.distSrcModelEnumsMod.ProviderId
...
object distSrcCoreUserUserCredentialImplMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.firebaseAuth.distSrcCoreUserUserCredentialImplMod.UserCredentialParams because var conflicts: _tokenResponse, operationType, providerId, user. Inlined  */ @JSImport("@firebase/auth/dist/src/core/user/user_credential_impl", "UserCredentialImpl")
  @js.native
  ...
  object UserCredentialImpl {
    ...
    @JSImport("@firebase/auth/dist/src/core/user/user_credential_impl", "UserCredentialImpl")
    @js.native
