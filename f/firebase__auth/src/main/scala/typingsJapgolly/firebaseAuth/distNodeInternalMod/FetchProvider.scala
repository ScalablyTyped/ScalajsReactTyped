...
@JSImport("@firebase/auth/dist/node/internal", "FetchProvider")
@js.native
open class FetchProvider ()
  extends typingsJapgolly.firebaseAuth.distNodeSrcCoreUtilFetchProviderMod.FetchProvider
/* static members */
object FetchProvider {
  ...
  @JSImport("@firebase/auth/dist/node/internal", "FetchProvider.fetchImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node/internal", "FetchProvider.headersImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/node/internal", "FetchProvider.responseImpl")
  @js.native
