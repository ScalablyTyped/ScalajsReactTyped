...
object ProviderId {
  ...
  @JSImport("@firebase/auth/dist/node/internal", "ProviderId.FACEBOOK")
  @js.native
  val FACEBOOK: facebookDotcom = js.native
  
  /** GitHub provider ID */
  @JSImport("@firebase/auth/dist/node/internal", "ProviderId.GITHUB")
  @js.native
  val GITHUB: githubDotcom = js.native
  
  /** Google provider ID */
  @JSImport("@firebase/auth/dist/node/internal", "ProviderId.GOOGLE")
  @js.native
  val GOOGLE: googleDotcom = js.native
  
  /** Password provider */
  @JSImport("@firebase/auth/dist/node/internal", "ProviderId.PASSWORD")
  @js.native
  val PASSWORD: password = js.native
  
  /** Phone provider */
  @JSImport("@firebase/auth/dist/node/internal", "ProviderId.PHONE")
  @js.native
  val PHONE: phone = js.native
  
  /** Twitter provider ID */
  @JSImport("@firebase/auth/dist/node/internal", "ProviderId.TWITTER")
  @js.native
