...
object distRnMod {
  ...
  open class ActionCodeURL protected ()
    extends typingsJapgolly.firebaseAuth.distRnSrcMod.ActionCodeURL {
    /**
  ...
  open class AuthCredential protected ()
    extends typingsJapgolly.firebaseAuth.distRnSrcMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  /* private */ open class EmailAuthCredential ()
    extends typingsJapgolly.firebaseAuth.distRnSrcMod.EmailAuthCredential
  /* static members */
  ...
  open class EmailAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distRnSrcMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distRnSrcMod.FacebookAuthProvider
  /* static members */
  ...
  open class GithubAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distRnSrcMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distRnSrcMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential protected ()
    extends typingsJapgolly.firebaseAuth.distRnSrcMod.OAuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
      * The authentication provider ID for the credential.
  ...
  open class OAuthProvider protected ()
    extends typingsJapgolly.firebaseAuth.distRnSrcMod.OAuthProvider {
    /**
  ...
  /* private */ open class PhoneAuthCredential ()
    extends typingsJapgolly.firebaseAuth.distRnSrcMod.PhoneAuthCredential
  /* static members */
  ...
  open class PhoneAuthProvider protected ()
    extends typingsJapgolly.firebaseAuth.distRnSrcPlatformBrowserProvidersPhoneMod.PhoneAuthProvider {
    /**
  ...
  /* private */ open class PhoneMultiFactorGenerator ()
    extends typingsJapgolly.firebaseAuth.distRnSrcPlatformBrowserMfaAssertionsPhoneMod.PhoneMultiFactorGenerator
  /* static members */
  ...
  open class RecaptchaVerifier protected ()
    extends typingsJapgolly.firebaseAuth.distRnSrcPlatformBrowserRecaptchaRecaptchaVerifierMod.RecaptchaVerifier {
  ...
  open class SAMLAuthProvider protected ()
    extends typingsJapgolly.firebaseAuth.distRnSrcMod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distRnSrcMod.TwitterAuthProvider
  /* static members */
