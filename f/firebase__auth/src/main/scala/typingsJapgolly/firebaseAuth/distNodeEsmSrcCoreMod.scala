...
object distNodeEsmSrcCoreMod {
  ...
  open class ActionCodeURL protected ()
    extends typingsJapgolly.firebaseAuth.distNodeEsmSrcCoreActionCodeUrlMod.ActionCodeURL {
    /**
  ...
  open class AuthCredential protected ()
    extends typingsJapgolly.firebaseAuth.distNodeEsmSrcCoreCredentialsMod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  open class EmailAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distNodeEsmSrcCoreProvidersEmailMod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distNodeEsmSrcCoreProvidersFacebookMod.FacebookAuthProvider
  /* static members */
  ...
  open class GithubAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distNodeEsmSrcCoreProvidersGithubMod.GithubAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distNodeEsmSrcCoreProvidersGoogleMod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthProvider protected ()
    extends typingsJapgolly.firebaseAuth.distNodeEsmSrcCoreProvidersOauthMod.OAuthProvider {
    /**
  ...
  open class SAMLAuthProvider protected ()
    extends typingsJapgolly.firebaseAuth.distNodeEsmSrcCoreProvidersSamlMod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distNodeEsmSrcCoreProvidersTwitterMod.TwitterAuthProvider
  /* static members */
