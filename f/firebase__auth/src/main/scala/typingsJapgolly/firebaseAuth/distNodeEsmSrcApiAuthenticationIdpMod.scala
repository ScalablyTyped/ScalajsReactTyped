...
object distNodeEsmSrcApiAuthenticationIdpMod {
  ...
  - typingsJapgolly.firebaseAuth.distNodeEsmSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
