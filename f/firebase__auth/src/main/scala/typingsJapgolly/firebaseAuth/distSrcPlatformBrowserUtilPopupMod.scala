...
object distSrcPlatformBrowserUtilPopupMod {
  
  @JSImport("@firebase/auth/dist/src/platform_browser/util/popup", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/src/platform_browser/util/popup", "AuthPopup")
  @js.native
