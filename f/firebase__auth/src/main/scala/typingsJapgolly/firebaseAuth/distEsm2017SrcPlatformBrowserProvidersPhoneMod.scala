...
import typingsJapgolly.firebaseAuth.distEsm2017SrcCoreCredentialsPhoneMod.PhoneAuthCredential
import typingsJapgolly.firebaseAuth.distEsm2017SrcCoreMod.AuthCredential
...
import typingsJapgolly.firebaseAuth.distEsm2017SrcModelPublicTypesMod.PhoneInfoOptions
...
object distEsm2017SrcPlatformBrowserProvidersPhoneMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/platform_browser/providers/phone", "PhoneAuthProvider")
  @js.native
  ...
  object PhoneAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/esm2017/src/platform_browser/providers/phone", "PhoneAuthProvider.PHONE_SIGN_IN_METHOD")
    @js.native
    val PHONE_SIGN_IN_METHOD: phone = js.native
    
    /** Always set to {@link ProviderId}.PHONE. */
    @JSImport("@firebase/auth/dist/esm2017/src/platform_browser/providers/phone", "PhoneAuthProvider.PROVIDER_ID")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/esm2017/src/platform_browser/providers/phone", "PhoneAuthProvider.credentialFromTaggedObject")
    @js.native
