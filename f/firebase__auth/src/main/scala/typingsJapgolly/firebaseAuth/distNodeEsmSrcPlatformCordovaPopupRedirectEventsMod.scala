...
import typingsJapgolly.firebaseAuth.distNodeEsmSrcCoreAuthAuthEventManagerMod.AuthEventManager
...
object distNodeEsmSrcPlatformCordovaPopupRedirectEventsMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_cordova/popup_redirect/events", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_cordova/popup_redirect/events", "CordovaAuthEventManager")
  @js.native
