...
object distCordovaTestHelpersIntegrationEmulatorRestHelpersMod {
  
  @JSImport("@firebase/auth/dist/cordova/test/helpers/integration/emulator_rest_helpers", JSImport.Namespace)
  @js.native
