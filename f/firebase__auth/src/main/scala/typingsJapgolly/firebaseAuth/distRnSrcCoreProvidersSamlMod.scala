...
import typingsJapgolly.firebaseAuth.distRnSrcCoreProvidersFederatedMod.FederatedAuthProvider
...
object distRnSrcCoreProvidersSamlMod {
  
  @JSImport("@firebase/auth/dist/rn/src/core/providers/saml", "SAMLAuthProvider")
  @js.native
  ...
  object SAMLAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/rn/src/core/providers/saml", "SAMLAuthProvider.samlCredentialFromTaggedObject")
    @js.native
