...
object distNodeSrcApiAuthenticationSmsMod {
  ...
  - typingsJapgolly.firebaseAuth.distNodeSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithPhoneNumberResponse
    extends StObject
