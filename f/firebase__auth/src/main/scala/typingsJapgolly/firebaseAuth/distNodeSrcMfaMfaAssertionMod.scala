...
import typingsJapgolly.firebaseAuth.distNodeSrcModelPublicTypesMod.FactorId
...
object distNodeSrcMfaMfaAssertionMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/node/src/mfa/mfa_assertion", "MultiFactorAssertionImpl")
  @js.native
