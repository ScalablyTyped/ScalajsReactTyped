...
import typingsJapgolly.firebaseAuth.distEsm2017SrcCorePersistenceMod.PersistenceInternal
...
import typingsJapgolly.firebaseAuth.distEsm2017SrcCorePersistenceMod.StorageEventListener
...
object distEsm2017SrcCorePersistenceInMemoryMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/core/persistence/in_memory", "InMemoryPersistence")
  @js.native
  ...
  object InMemoryPersistence_ {
    ...
    @JSImport("@firebase/auth/dist/esm2017/src/core/persistence/in_memory", "InMemoryPersistence.type")
    @js.native
