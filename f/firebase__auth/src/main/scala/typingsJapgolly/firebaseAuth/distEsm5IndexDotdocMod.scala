...
import typingsJapgolly.firebaseAuth.distEsm5SrcModelPublicTypesMod.ReactNativeAsyncStorage
...
object distEsm5IndexDotdocMod {
  ...
  open class AuthCredential protected ()
    extends typingsJapgolly.firebaseAuth.distEsm5Mod.AuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
  ...
  open class EmailAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distEsm5Mod.EmailAuthProvider
  /* static members */
  ...
  open class FacebookAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distEsm5Mod.FacebookAuthProvider
  /* static members */
  ...
  open class GoogleAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distEsm5Mod.GoogleAuthProvider
  /* static members */
  ...
  open class OAuthCredential protected ()
    extends typingsJapgolly.firebaseAuth.distEsm5Mod.OAuthCredential {
    /** @internal */
    /* protected */ def this(
      /**
      * The authentication provider ID for the credential.
  ...
  open class OAuthProvider protected ()
    extends typingsJapgolly.firebaseAuth.distEsm5Mod.OAuthProvider {
    /**
  ...
  /* private */ open class PhoneAuthCredential ()
    extends typingsJapgolly.firebaseAuth.distEsm5Mod.PhoneAuthCredential
  /* static members */
  ...
  open class PhoneAuthProvider protected ()
    extends typingsJapgolly.firebaseAuth.distEsm5Mod.PhoneAuthProvider {
    /**
  ...
  /* private */ open class PhoneMultiFactorGenerator ()
    extends typingsJapgolly.firebaseAuth.distEsm5Mod.PhoneMultiFactorGenerator
  /* static members */
  ...
  open class SAMLAuthProvider protected ()
    extends typingsJapgolly.firebaseAuth.distEsm5Mod.SAMLAuthProvider {
    /**
  ...
  open class TwitterAuthProvider ()
    extends typingsJapgolly.firebaseAuth.distEsm5Mod.TwitterAuthProvider
  /* static members */
