...
object distNodeSrcPlatformBrowserMessagechannelPromiseMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T]
    - typingsJapgolly.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult
  */
  trait PromiseSettledResult[T] extends StObject
  object PromiseSettledResult {
    
    inline def PromiseFulfilledResult[T](value: T): typingsJapgolly.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T] = {
      val __obj = js.Dynamic.literal(fulfilled = true, value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T]]
    }
    
    inline def PromiseRejectedResult(reason: Any): typingsJapgolly.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult = {
      val __obj = js.Dynamic.literal(fulfilled = false, reason = reason.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult]
    }
  }
}
