...
object distTestIntegrationWebdriverUtilIdpPageMod {
  
  @JSImport("@firebase/auth/dist/test/integration/webdriver/util/idp_page", "IdPPage")
  @js.native
  ...
  object IdPPage {
    ...
    @JSImport("@firebase/auth/dist/test/integration/webdriver/util/idp_page", "IdPPage.PAGE_TITLE")
    @js.native
