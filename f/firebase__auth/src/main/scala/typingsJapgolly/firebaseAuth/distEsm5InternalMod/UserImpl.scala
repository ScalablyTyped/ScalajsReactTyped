...
import typingsJapgolly.firebaseAuth.distEsm5SrcCorePersistenceMod.PersistedBlob
...
import typingsJapgolly.firebaseAuth.distEsm5SrcModelUserMod.UserParameters
...
open class UserImpl protected ()
  extends typingsJapgolly.firebaseAuth.distEsm5SrcCoreUserUserImplMod.UserImpl {
