...
import typingsJapgolly.firebaseAuth.anon.PhoneNumber
...
object distCordovaSrcApiAccountManagementMfaMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/api/account_management/mfa", JSImport.Namespace)
  @js.native
