...
import typingsJapgolly.firebaseAuth.distRnSrcApiAccountManagementMfaMod.MfaEnrollment
import typingsJapgolly.firebaseAuth.distRnSrcApiAuthenticationSmsMod.SignInWithPhoneNumberRequest
...
object distRnSrcApiAuthenticationMfaMod {
  
  @JSImport("@firebase/auth/dist/rn/src/api/authentication/mfa", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAuth.distRnSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse
    - typingsJapgolly.firebaseAuth.distRnSrcApiAuthenticationIdpMod.SignInWithIdpResponse
    - typingsJapgolly.firebaseAuth.distRnSrcModelIdTokenMod.IdTokenResponse
  */
  trait PhoneOrOauthTokenResponse extends StObject
  object PhoneOrOauthTokenResponse {
    
    inline def IdTokenResponse(localId: String): typingsJapgolly.firebaseAuth.distRnSrcModelIdTokenMod.IdTokenResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distRnSrcModelIdTokenMod.IdTokenResponse]
    }
    
    inline def SignInWithIdpResponse(localId: String): typingsJapgolly.firebaseAuth.distRnSrcApiAuthenticationIdpMod.SignInWithIdpResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distRnSrcApiAuthenticationIdpMod.SignInWithIdpResponse]
    }
    
    inline def SignInWithPhoneNumberResponse(localId: String): typingsJapgolly.firebaseAuth.distRnSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distRnSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse]
    }
  }
