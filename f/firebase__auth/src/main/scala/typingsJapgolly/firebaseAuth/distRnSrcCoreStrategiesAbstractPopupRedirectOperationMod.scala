...
import typingsJapgolly.firebaseAuth.distRnSrcModelPopupRedirectMod.AuthEvent
import typingsJapgolly.firebaseAuth.distRnSrcModelPopupRedirectMod.AuthEventConsumer
...
object distRnSrcCoreStrategiesAbstractPopupRedirectOperationMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/rn/src/core/strategies/abstract_popup_redirect_operation", "AbstractPopupRedirectOperation")
  @js.native
