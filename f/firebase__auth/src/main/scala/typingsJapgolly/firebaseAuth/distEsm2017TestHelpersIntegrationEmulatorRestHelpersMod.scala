...
object distEsm2017TestHelpersIntegrationEmulatorRestHelpersMod {
  
  @JSImport("@firebase/auth/dist/esm2017/test/helpers/integration/emulator_rest_helpers", JSImport.Namespace)
  @js.native
