...
import typingsJapgolly.firebaseAuth.distRnSrcModelIdTokenMod.IdToken
...
object distRnSrcApiAuthenticationIdpMod {
  
  @JSImport("@firebase/auth/dist/rn/src/api/authentication/idp", JSImport.Namespace)
  @js.native
  ...
  - typingsJapgolly.firebaseAuth.distRnSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
