...
object ActionCodeOperation {
  ...
  /** The revert second factor addition email action. */
  @JSImport("@firebase/auth/internal", "ActionCodeOperation.VERIFY_AND_CHANGE_EMAIL")
  @js.native
  val VERIFY_AND_CHANGE_EMAIL: typingsJapgolly.firebaseAuth.firebaseAuthStrings.VERIFY_AND_CHANGE_EMAIL = js.native
  
  /** The email verification action. */
  @JSImport("@firebase/auth/internal", "ActionCodeOperation.VERIFY_EMAIL")
  @js.native
