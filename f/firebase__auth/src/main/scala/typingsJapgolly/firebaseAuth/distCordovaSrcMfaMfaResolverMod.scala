...
import typingsJapgolly.firebaseAuth.distCordovaSrcMfaMfaAssertionMod.MultiFactorAssertionImpl
import typingsJapgolly.firebaseAuth.distCordovaSrcMfaMfaErrorMod.MultiFactorError
import typingsJapgolly.firebaseAuth.distCordovaSrcMfaMfaInfoMod.MultiFactorInfoImpl
...
import typingsJapgolly.firebaseAuth.distCordovaSrcModelPublicTypesMod.MultiFactorInfo
import typingsJapgolly.firebaseAuth.distCordovaSrcModelPublicTypesMod.MultiFactorResolver
import typingsJapgolly.firebaseAuth.distCordovaSrcModelPublicTypesMod.MultiFactorSession
...
object distCordovaSrcMfaMfaResolverMod {
  ...
  inline def getMultiFactorResolver(auth: Auth, error: typingsJapgolly.firebaseAuth.distCordovaSrcModelPublicTypesMod.MultiFactorError): MultiFactorResolver = (^.asInstanceOf[js.Dynamic].applyDynamic("getMultiFactorResolver")(auth.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[MultiFactorResolver]
}
