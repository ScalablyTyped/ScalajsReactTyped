...
object distEsm5SrcPlatformBrowserMessagechannelPromiseMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAuth.distEsm5SrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T]
    - typingsJapgolly.firebaseAuth.distEsm5SrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult
  */
  trait PromiseSettledResult[T] extends StObject
  object PromiseSettledResult {
    
    inline def PromiseFulfilledResult[T](value: T): typingsJapgolly.firebaseAuth.distEsm5SrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T] = {
      val __obj = js.Dynamic.literal(fulfilled = true, value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distEsm5SrcPlatformBrowserMessagechannelPromiseMod.PromiseFulfilledResult[T]]
    }
    
    inline def PromiseRejectedResult(reason: Any): typingsJapgolly.firebaseAuth.distEsm5SrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult = {
      val __obj = js.Dynamic.literal(fulfilled = false, reason = reason.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distEsm5SrcPlatformBrowserMessagechannelPromiseMod.PromiseRejectedResult]
    }
  }
}
