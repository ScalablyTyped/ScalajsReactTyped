...
import typingsJapgolly.firebaseAuth.anon.Typeofgapi
import typingsJapgolly.firebaseAuth.distNodeEsmSrcPlatformBrowserRecaptchaRecaptchaMod.Recaptcha
import typingsJapgolly.firebaseAuth.firebaseAuthStrings.DOMContentLoaded
...
object distNodeEsmSrcPlatformBrowserAuthWindowMod {
  ...
  object AuthWindow {
    ...
    inline def apply(
      addEventListener: (DOMContentLoaded, /* listener */ js.ThisFunction1[AuthWindow, /* ev */ Event, Any]) => Callback,
      alert: Callback,
      ...
      cancelIdleCallback: /* handle */ Double => Callback,
      captureEvents: Callback,
      clearInterval: Callback,
      clearTimeout: Callback,
      clientInformation: Navigator,
      close: Callback,
      closed: Boolean,
      confirm: CallbackTo[Boolean],
      ...
      location: CallbackTo[Location],
      locationbar: BarProp,
      matchMedia: /* query */ String => MediaQueryList,
      menubar: BarProp,
      moveBy: (/* x */ Double, /* y */ Double) => Callback,
      moveTo: (/* x */ Double, /* y */ Double) => Callback,
      name: String,
      navigator: Navigator,
      open: CallbackTo[WindowProxy | Null],
      opener: Any,
      orientation: Double,
      origin: String,
      outerHeight: Double,
      ...
      personalbar: BarProp,
      postMessage: (/* message */ Any, /* targetOrigin */ String) => Callback,
      print: Callback,
      prompt: CallbackTo[String | Null],
      queueMicrotask: /* callback */ VoidFunction => Callback,
      releaseEvents: Callback,
      removeEventListener: (DOMContentLoaded, /* listener */ js.ThisFunction1[AuthWindow, /* ev */ Event, Any]) => Callback,
      reportError: /* e */ Any => Callback,
      requestAnimationFrame: /* callback */ FrameRequestCallback => Double,
      requestIdleCallback: /* callback */ IdleRequestCallback => Double,
      resizeBy: (/* x */ Double, /* y */ Double) => Callback,
      resizeTo: (/* width */ Double, /* height */ Double) => Callback,
      screen: Screen,
      screenLeft: Double,
      screenTop: Double,
      screenX: Double,
      ...
      val __obj = js.Dynamic.literal(addEventListener = js.Any.fromFunction2((t0: DOMContentLoaded, t1: /* listener */ js.ThisFunction1[AuthWindow, /* ev */ Event, Any]) => (addEventListener(t0, t1)).runNow()), alert = alert.toJsFn, atob = js.Any.fromFunction1(atob), blur = blur.toJsFn, btoa = js.Any.fromFunction1(btoa), caches = caches.asInstanceOf[js.Any], cancelAnimationFrame = js.Any.fromFunction1((t0: /* handle */ Double) => cancelAnimationFrame(t0).runNow()), cancelIdleCallback = js.Any.fromFunction1((t0: /* handle */ Double) => cancelIdleCallback(t0).runNow()), captureEvents = captureEvents.toJsFn, clearInterval = clearInterval.toJsFn, clearTimeout = clearTimeout.toJsFn, clientInformation = clientInformation.asInstanceOf[js.Any], close = close.toJsFn, closed = closed.asInstanceOf[js.Any], confirm = confirm.toJsFn, createImageBitmap = js.Any.fromFunction1(createImageBitmap), crossOriginIsolated = crossOriginIsolated.asInstanceOf[js.Any], crypto = crypto.asInstanceOf[js.Any], customElements = customElements.asInstanceOf[js.Any], devicePixelRatio = devicePixelRatio.asInstanceOf[js.Any], dispatchEvent = js.Any.fromFunction1(dispatchEvent), document = document.asInstanceOf[js.Any], external = external.asInstanceOf[js.Any], fetch = js.Any.fromFunction1(fetch), focus = focus.toJsFn, frames = frames.asInstanceOf[js.Any], getComputedStyle = js.Any.fromFunction1(getComputedStyle), getSelection = getSelection.toJsFn, history = history.asInstanceOf[js.Any], indexedDB = indexedDB.asInstanceOf[js.Any], innerHeight = innerHeight.asInstanceOf[js.Any], innerWidth = innerWidth.asInstanceOf[js.Any], isSecureContext = isSecureContext.asInstanceOf[js.Any], length = length.asInstanceOf[js.Any], localStorage = localStorage.asInstanceOf[js.Any], location = location.toJsFn, locationbar = locationbar.asInstanceOf[js.Any], matchMedia = js.Any.fromFunction1(matchMedia), menubar = menubar.asInstanceOf[js.Any], moveBy = js.Any.fromFunction2((t0: /* x */ Double, t1: /* y */ Double) => (moveBy(t0, t1)).runNow()), moveTo = js.Any.fromFunction2((t0: /* x */ Double, t1: /* y */ Double) => (moveTo(t0, t1)).runNow()), name = name.asInstanceOf[js.Any], navigator = navigator.asInstanceOf[js.Any], open = open.toJsFn, opener = opener.asInstanceOf[js.Any], orientation = orientation.asInstanceOf[js.Any], origin = origin.asInstanceOf[js.Any], outerHeight = outerHeight.asInstanceOf[js.Any], outerWidth = outerWidth.asInstanceOf[js.Any], pageXOffset = pageXOffset.asInstanceOf[js.Any], pageYOffset = pageYOffset.asInstanceOf[js.Any], parent = parent.asInstanceOf[js.Any], performance = performance.asInstanceOf[js.Any], personalbar = personalbar.asInstanceOf[js.Any], postMessage = js.Any.fromFunction2((t0: /* message */ Any, t1: /* targetOrigin */ String) => (postMessage(t0, t1)).runNow()), print = print.toJsFn, prompt = prompt.toJsFn, queueMicrotask = js.Any.fromFunction1((t0: /* callback */ VoidFunction) => queueMicrotask(t0).runNow()), releaseEvents = releaseEvents.toJsFn, removeEventListener = js.Any.fromFunction2((t0: DOMContentLoaded, t1: /* listener */ js.ThisFunction1[AuthWindow, /* ev */ Event, Any]) => (removeEventListener(t0, t1)).runNow()), reportError = js.Any.fromFunction1((t0: /* e */ Any) => reportError(t0).runNow()), requestAnimationFrame = js.Any.fromFunction1(requestAnimationFrame), requestIdleCallback = js.Any.fromFunction1(requestIdleCallback), resizeBy = js.Any.fromFunction2((t0: /* x */ Double, t1: /* y */ Double) => (resizeBy(t0, t1)).runNow()), resizeTo = js.Any.fromFunction2((t0: /* width */ Double, t1: /* height */ Double) => (resizeTo(t0, t1)).runNow()), screen = screen.asInstanceOf[js.Any], screenLeft = screenLeft.asInstanceOf[js.Any], screenTop = screenTop.asInstanceOf[js.Any], screenX = screenX.asInstanceOf[js.Any], screenY = screenY.asInstanceOf[js.Any], scroll = scroll.toJsFn, scrollBy = scrollBy.toJsFn, scrollTo = scrollTo.toJsFn, scrollX = scrollX.asInstanceOf[js.Any], scrollY = scrollY.asInstanceOf[js.Any], scrollbars = scrollbars.asInstanceOf[js.Any], self = self.asInstanceOf[js.Any], sessionStorage = sessionStorage.asInstanceOf[js.Any], setInterval = js.Any.fromFunction3(setInterval), setTimeout = js.Any.fromFunction3(setTimeout), speechSynthesis = speechSynthesis.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any], statusbar = statusbar.asInstanceOf[js.Any], stop = stop.toJsFn, structuredClone = js.Any.fromFunction1(structuredClone), toolbar = toolbar.asInstanceOf[js.Any], window = window.asInstanceOf[js.Any], onerror = null)
    ...
    extension [Self <: AuthWindow](x: Self) {
      ...
      inline def setAddEventListener(
        value: (DOMContentLoaded, /* listener */ js.ThisFunction1[AuthWindow, /* ev */ Event, Any]) => Callback
      ): Self = StObject.set(x, "addEventListener", js.Any.fromFunction2((t0: DOMContentLoaded, t1: /* listener */ js.ThisFunction1[AuthWindow, /* ev */ Event, Any]) => (value(t0, t1)).runNow()))
      
      inline def setAlert(value: Callback): Self = StObject.set(x, "alert", value.toJsFn)
      ...
      inline def setCancelIdleCallback(value: /* handle */ Double => Callback): Self = StObject.set(x, "cancelIdleCallback", js.Any.fromFunction1((t0: /* handle */ Double) => value(t0).runNow()))
      
      inline def setCaptureEvents(value: Callback): Self = StObject.set(x, "captureEvents", value.toJsFn)
      
      inline def setClearInterval(value: Callback): Self = StObject.set(x, "clearInterval", value.toJsFn)
      ...
      inline def setConfirm(value: CallbackTo[Boolean]): Self = StObject.set(x, "confirm", value.toJsFn)
      ...
      inline def setLocation(value: CallbackTo[Location]): Self = StObject.set(x, "location", value.toJsFn)
      ...
      inline def setMoveBy(value: (/* x */ Double, /* y */ Double) => Callback): Self = StObject.set(x, "moveBy", js.Any.fromFunction2((t0: /* x */ Double, t1: /* y */ Double) => (value(t0, t1)).runNow()))
      
      inline def setMoveTo(value: (/* x */ Double, /* y */ Double) => Callback): Self = StObject.set(x, "moveTo", js.Any.fromFunction2((t0: /* x */ Double, t1: /* y */ Double) => (value(t0, t1)).runNow()))
      ...
      inline def setOnmessage(value: js.ThisFunction1[AuthWindow, /* ev */ MessageEvent, Any]): Self = StObject.set(x, "onmessage", value.asInstanceOf[js.Any])
      ...
      inline def setOnmessageerror(value: js.ThisFunction1[AuthWindow, /* ev */ MessageEvent, Any]): Self = StObject.set(x, "onmessageerror", value.asInstanceOf[js.Any])
      ...
      inline def setOnprogress(value: js.ThisFunction1[AuthWindow, /* ev */ ProgressEvent, Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
      ...
      inline def setOpen(value: CallbackTo[WindowProxy | Null]): Self = StObject.set(x, "open", value.toJsFn)
      ...
      inline def setPostMessage(value: (/* message */ Any, /* targetOrigin */ String) => Callback): Self = StObject.set(x, "postMessage", js.Any.fromFunction2((t0: /* message */ Any, t1: /* targetOrigin */ String) => (value(t0, t1)).runNow()))
      
      inline def setPrint(value: Callback): Self = StObject.set(x, "print", value.toJsFn)
      
      inline def setPrompt(value: CallbackTo[String | Null]): Self = StObject.set(x, "prompt", value.toJsFn)
      
      inline def setQueueMicrotask(value: /* callback */ VoidFunction => Callback): Self = StObject.set(x, "queueMicrotask", js.Any.fromFunction1((t0: /* callback */ VoidFunction) => value(t0).runNow()))
      
      inline def setReleaseEvents(value: Callback): Self = StObject.set(x, "releaseEvents", value.toJsFn)
      
      inline def setRemoveEventListener(
        value: (DOMContentLoaded, /* listener */ js.ThisFunction1[AuthWindow, /* ev */ Event, Any]) => Callback
      ): Self = StObject.set(x, "removeEventListener", js.Any.fromFunction2((t0: DOMContentLoaded, t1: /* listener */ js.ThisFunction1[AuthWindow, /* ev */ Event, Any]) => (value(t0, t1)).runNow()))
      
      inline def setReportError(value: /* e */ Any => Callback): Self = StObject.set(x, "reportError", js.Any.fromFunction1((t0: /* e */ Any) => value(t0).runNow()))
      ...
      inline def setResizeBy(value: (/* x */ Double, /* y */ Double) => Callback): Self = StObject.set(x, "resizeBy", js.Any.fromFunction2((t0: /* x */ Double, t1: /* y */ Double) => (value(t0, t1)).runNow()))
      
      inline def setResizeTo(value: (/* width */ Double, /* height */ Double) => Callback): Self = StObject.set(x, "resizeTo", js.Any.fromFunction2((t0: /* width */ Double, t1: /* height */ Double) => (value(t0, t1)).runNow()))
