...
object distEsm2017SrcApiAuthenticationSmsMod {
  ...
  - typingsJapgolly.firebaseAuth.distEsm2017SrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithPhoneNumberResponse
    extends StObject
