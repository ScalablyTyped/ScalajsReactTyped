...
import typingsJapgolly.firebaseAuth.distNodeSrcApiAccountManagementMfaMod.MfaEnrollment
import typingsJapgolly.firebaseAuth.distNodeSrcApiAuthenticationSmsMod.SignInWithPhoneNumberRequest
...
object distNodeSrcApiAuthenticationMfaMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAuth.distNodeSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse
    - typingsJapgolly.firebaseAuth.distNodeSrcApiAuthenticationIdpMod.SignInWithIdpResponse
    - typingsJapgolly.firebaseAuth.distNodeSrcModelIdTokenMod.IdTokenResponse
  */
  trait PhoneOrOauthTokenResponse extends StObject
  object PhoneOrOauthTokenResponse {
    
    inline def IdTokenResponse(localId: String): typingsJapgolly.firebaseAuth.distNodeSrcModelIdTokenMod.IdTokenResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distNodeSrcModelIdTokenMod.IdTokenResponse]
    }
    
    inline def SignInWithIdpResponse(localId: String): typingsJapgolly.firebaseAuth.distNodeSrcApiAuthenticationIdpMod.SignInWithIdpResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distNodeSrcApiAuthenticationIdpMod.SignInWithIdpResponse]
    }
    
    inline def SignInWithPhoneNumberResponse(localId: String): typingsJapgolly.firebaseAuth.distNodeSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse = {
      val __obj = js.Dynamic.literal(localId = localId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distNodeSrcApiAuthenticationSmsMod.SignInWithPhoneNumberResponse]
    }
  }
