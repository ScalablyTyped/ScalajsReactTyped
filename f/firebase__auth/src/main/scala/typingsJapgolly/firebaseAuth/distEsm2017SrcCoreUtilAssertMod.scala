...
object distEsm2017SrcCoreUtilAssertMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/core/util/assert", JSImport.Namespace)
  @js.native
  ...
  type LessAppName[K /* <: AuthErrorCode */] = Omit[
    /* import warning: importer.ImportType#apply Failed type conversion: @firebase/auth.@firebase/auth/dist/esm2017/src/core/errors.AuthErrorParams[K] */ js.Any, 
    appName
  ]
