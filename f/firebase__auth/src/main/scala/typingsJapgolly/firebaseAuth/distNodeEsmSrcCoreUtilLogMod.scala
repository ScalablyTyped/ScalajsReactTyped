...
object distNodeEsmSrcCoreUtilLogMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/core/util/log", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/node-esm/src/core/util/log", "LogLevel")
  @js.native
