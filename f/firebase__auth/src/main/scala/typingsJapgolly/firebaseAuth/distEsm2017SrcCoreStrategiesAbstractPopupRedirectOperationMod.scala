...
import typingsJapgolly.firebaseAuth.distEsm2017SrcModelPopupRedirectMod.AuthEventConsumer
import typingsJapgolly.firebaseAuth.distEsm2017SrcModelPopupRedirectMod.AuthEventType
import typingsJapgolly.firebaseAuth.distEsm2017SrcModelPopupRedirectMod.PopupRedirectResolverInternal
...
object distEsm2017SrcCoreStrategiesAbstractPopupRedirectOperationMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/esm2017/src/core/strategies/abstract_popup_redirect_operation", "AbstractPopupRedirectOperation")
  @js.native
