...
import typingsJapgolly.firebaseAuth.firebaseAuthInts.`300000`
import typingsJapgolly.firebaseAuth.firebaseAuthInts.`30000`
import typingsJapgolly.firebaseAuth.firebaseAuthInts.`960000`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distNodeEsmSrcCoreUserProactiveRefreshMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/core/user/proactive_refresh", "ProactiveRefresh")
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAuth.firebaseAuthInts.`300000`
    - typingsJapgolly.firebaseAuth.firebaseAuthInts.`30000`
    - typingsJapgolly.firebaseAuth.firebaseAuthInts.`960000`
  */
