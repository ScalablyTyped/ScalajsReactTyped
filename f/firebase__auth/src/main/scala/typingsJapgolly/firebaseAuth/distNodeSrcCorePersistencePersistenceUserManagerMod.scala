...
import typingsJapgolly.firebaseAuth.distNodeSrcModelAuthMod.ApiKey
import typingsJapgolly.firebaseAuth.distNodeSrcModelAuthMod.AppName
...
object distNodeSrcCorePersistencePersistenceUserManagerMod {
  
  @JSImport("@firebase/auth/dist/node/src/core/persistence/persistence_user_manager", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/node/src/core/persistence/persistence_user_manager", "PersistenceUserManager")
  @js.native
