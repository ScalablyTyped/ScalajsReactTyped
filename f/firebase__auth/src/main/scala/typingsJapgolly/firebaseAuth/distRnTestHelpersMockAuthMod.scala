...
import typingsJapgolly.firebaseAuth.distRnSrcCorePersistenceInMemoryMod.InMemoryPersistence_
import typingsJapgolly.firebaseAuth.distRnSrcCorePersistenceMod.PersistedBlob
...
object distRnTestHelpersMockAuthMod {
  
  @JSImport("@firebase/auth/dist/rn/test/helpers/mock_auth", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object FAKE_HEARTBEAT_CONTROLLER {
    
    @JSImport("@firebase/auth/dist/rn/test/helpers/mock_auth", "FAKE_HEARTBEAT_CONTROLLER")
    @js.native
    val ^ : js.Any = js.native
  ...
  @JSImport("@firebase/auth/dist/rn/test/helpers/mock_auth", "FAKE_HEARTBEAT_CONTROLLER_PROVIDER")
  @js.native
  val FAKE_HEARTBEAT_CONTROLLER_PROVIDER: Provider[heartbeat] = js.native
  
  @JSImport("@firebase/auth/dist/rn/test/helpers/mock_auth", "MockPersistenceLayer")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/rn/test/helpers/mock_auth", "TEST_AUTH_DOMAIN")
  @js.native
  val TEST_AUTH_DOMAIN: /* "localhost" */ String = js.native
  
  @JSImport("@firebase/auth/dist/rn/test/helpers/mock_auth", "TEST_HOST")
  @js.native
  val TEST_HOST: /* "localhost" */ String = js.native
  
  @JSImport("@firebase/auth/dist/rn/test/helpers/mock_auth", "TEST_KEY")
  @js.native
  val TEST_KEY: /* "test-api-key" */ String = js.native
  
  @JSImport("@firebase/auth/dist/rn/test/helpers/mock_auth", "TEST_SCHEME")
  @js.native
  val TEST_SCHEME: /* "mock" */ String = js.native
  
  @JSImport("@firebase/auth/dist/rn/test/helpers/mock_auth", "TEST_TOKEN_HOST")
  @js.native
