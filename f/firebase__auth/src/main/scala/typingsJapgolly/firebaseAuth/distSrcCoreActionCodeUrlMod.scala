...
object distSrcCoreActionCodeUrlMod {
  
  @JSImport("@firebase/auth/dist/src/core/action_code_url", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/src/core/action_code_url", "ActionCodeURL")
  @js.native
