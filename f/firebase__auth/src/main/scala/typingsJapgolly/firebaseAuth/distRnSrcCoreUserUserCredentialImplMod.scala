...
object distRnSrcCoreUserUserCredentialImplMod {
  ...
  - typingsJapgolly.firebaseAuth.distRnSrcCoreUserUserCredentialImplMod.UserCredentialParams because var conflicts: _tokenResponse, operationType, providerId, user. Inlined  */ @JSImport("@firebase/auth/dist/rn/src/core/user/user_credential_impl", "UserCredentialImpl")
  @js.native
