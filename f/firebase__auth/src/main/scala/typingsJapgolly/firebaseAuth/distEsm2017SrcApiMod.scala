...
import typingsJapgolly.firebaseAuth.anon.PartialServerErrorMapServADMINONLYOPERATION
...
import typingsJapgolly.firebaseAuth.distEsm2017SrcCoreUtilDelayMod.Delay
...
object distEsm2017SrcApiMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/api", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/esm2017/src/api", "DEFAULT_API_TIMEOUT_MS")
  @js.native
  ...
  inline def performApiRequest[T, V](
    ...
    path: Endpoint,
    request: T,
    customErrorMap: PartialServerErrorMapServADMINONLYOPERATION
