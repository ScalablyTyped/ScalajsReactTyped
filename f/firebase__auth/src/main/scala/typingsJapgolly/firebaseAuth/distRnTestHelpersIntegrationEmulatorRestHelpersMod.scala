...
object distRnTestHelpersIntegrationEmulatorRestHelpersMod {
  
  @JSImport("@firebase/auth/dist/rn/test/helpers/integration/emulator_rest_helpers", JSImport.Namespace)
  @js.native
