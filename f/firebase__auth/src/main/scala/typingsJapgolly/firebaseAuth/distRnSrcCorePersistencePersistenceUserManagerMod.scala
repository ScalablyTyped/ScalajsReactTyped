...
import typingsJapgolly.firebaseAuth.distRnSrcCorePersistenceMod.PersistenceInternal
...
object distRnSrcCorePersistencePersistenceUserManagerMod {
  
  @JSImport("@firebase/auth/dist/rn/src/core/persistence/persistence_user_manager", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/rn/src/core/persistence/persistence_user_manager", "PersistenceUserManager")
  @js.native
