...
trait ActionCodeInfo extends StObject {
  ...
  /**
    ...
    */
  var data: typingsJapgolly.firebaseAuth.anon.MultiFactorInfo
...
object ActionCodeInfo {
  ...
  inline def apply(
    data: typingsJapgolly.firebaseAuth.anon.MultiFactorInfo,
  ...
  extension [Self <: ActionCodeInfo](x: Self) {
    ...
    inline def setData(value: typingsJapgolly.firebaseAuth.anon.MultiFactorInfo): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
