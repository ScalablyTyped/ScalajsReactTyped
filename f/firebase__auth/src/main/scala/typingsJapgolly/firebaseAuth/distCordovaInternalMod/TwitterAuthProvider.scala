...
@JSImport("@firebase/auth/dist/cordova/internal", "TwitterAuthProvider")
@js.native
...
object TwitterAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/cordova/internal", "TwitterAuthProvider.PROVIDER_ID")
  @js.native
  val PROVIDER_ID: twitterDotcom = js.native
  
  /** Always set to {@link SignInMethod}.TWITTER. */
  @JSImport("@firebase/auth/dist/cordova/internal", "TwitterAuthProvider.TWITTER_SIGN_IN_METHOD")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/cordova/internal", "TwitterAuthProvider.credentialFromTaggedObject")
  @js.native
