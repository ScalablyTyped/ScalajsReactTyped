...
import typingsJapgolly.firebaseAuth.distCordovaSrcModelUserMod.UserParameters
...
open class UserImpl protected ()
  extends typingsJapgolly.firebaseAuth.distCordovaSrcCoreUserUserImplMod.UserImpl {
