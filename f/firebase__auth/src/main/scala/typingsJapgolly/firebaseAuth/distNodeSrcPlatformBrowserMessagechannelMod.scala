...
import typingsJapgolly.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelPromiseMod.PromiseSettledResult
...
object distNodeSrcPlatformBrowserMessagechannelMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelMod.KeyChangedRequest
    - typingsJapgolly.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelMod.PingRequest
  */
  trait SenderRequest extends StObject
  object SenderRequest {
    
    inline def KeyChangedRequest(key: String): typingsJapgolly.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelMod.KeyChangedRequest = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distNodeSrcPlatformBrowserMessagechannelMod.KeyChangedRequest]
    }
  }
