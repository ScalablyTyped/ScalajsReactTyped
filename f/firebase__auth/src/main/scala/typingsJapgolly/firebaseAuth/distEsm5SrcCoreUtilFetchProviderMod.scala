...
import typingsJapgolly.firebaseAuth.anon.FnCall
import typingsJapgolly.firebaseAuth.anon.TypeofResponse
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distEsm5SrcCoreUtilFetchProviderMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/core/util/fetch_provider", "FetchProvider")
  @js.native
  ...
  object FetchProvider {
    ...
    @JSImport("@firebase/auth/dist/esm5/src/core/util/fetch_provider", "FetchProvider.fetchImpl")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/esm5/src/core/util/fetch_provider", "FetchProvider.headersImpl")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/esm5/src/core/util/fetch_provider", "FetchProvider.responseImpl")
    @js.native
