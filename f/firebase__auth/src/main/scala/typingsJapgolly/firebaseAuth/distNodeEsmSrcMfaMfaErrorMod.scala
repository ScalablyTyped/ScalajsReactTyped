...
import typingsJapgolly.firebaseAuth.anon.`16`
...
import typingsJapgolly.firebaseAuth.distNodeEsmSrcModelEnumsMod.OperationType
...
object distNodeEsmSrcMfaMfaErrorMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/mfa/mfa_error", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/node-esm/src/mfa/mfa_error", "MultiFactorError")
  @js.native
  /* private */ open class MultiFactorError ()
    extends typingsJapgolly.firebaseAuth.distNodeEsmSrcModelPublicTypesMod.MultiFactorError {
  ...
  type MultiFactorErrorData = (/* import warning: importer.ImportType#apply Failed type conversion: @firebase/auth.@firebase/auth/dist/node-esm/src/model/public_types.AuthError['customData'] */ js.Any) & `2` & `16`
}
