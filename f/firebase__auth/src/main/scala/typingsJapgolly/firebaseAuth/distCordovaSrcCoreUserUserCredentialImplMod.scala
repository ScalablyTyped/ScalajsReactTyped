...
object distCordovaSrcCoreUserUserCredentialImplMod {
  ...
  - typingsJapgolly.firebaseAuth.distCordovaSrcCoreUserUserCredentialImplMod.UserCredentialParams because var conflicts: _tokenResponse, operationType, providerId, user. Inlined  */ @JSImport("@firebase/auth/dist/cordova/src/core/user/user_credential_impl", "UserCredentialImpl")
  @js.native
