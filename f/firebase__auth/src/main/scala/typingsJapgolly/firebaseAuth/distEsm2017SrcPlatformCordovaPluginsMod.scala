...
import typingsJapgolly.firebaseAuth.anon.Plugins
...
object distEsm2017SrcPlatformCordovaPluginsMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/platform_cordova/plugins", JSImport.Namespace)
  @js.native
