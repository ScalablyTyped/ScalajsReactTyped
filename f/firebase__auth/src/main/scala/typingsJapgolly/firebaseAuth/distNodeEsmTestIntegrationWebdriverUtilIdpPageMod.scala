...
object distNodeEsmTestIntegrationWebdriverUtilIdpPageMod {
  
  @JSImport("@firebase/auth/dist/node-esm/test/integration/webdriver/util/idp_page", "IdPPage")
  @js.native
  ...
  object IdPPage {
    ...
    @JSImport("@firebase/auth/dist/node-esm/test/integration/webdriver/util/idp_page", "IdPPage.PAGE_TITLE")
    @js.native
