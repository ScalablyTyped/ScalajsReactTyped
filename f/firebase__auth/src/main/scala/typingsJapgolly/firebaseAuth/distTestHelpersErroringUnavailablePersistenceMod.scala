...
object distTestHelpersErroringUnavailablePersistenceMod {
  
  @JSImport("@firebase/auth/dist/test/helpers/erroring_unavailable_persistence", "ErroringUnavailablePersistence")
  @js.native
