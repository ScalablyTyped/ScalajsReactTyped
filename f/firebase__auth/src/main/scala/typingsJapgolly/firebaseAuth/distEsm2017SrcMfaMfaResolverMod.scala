...
import typingsJapgolly.firebaseAuth.distEsm2017SrcMfaMfaAssertionMod.MultiFactorAssertionImpl
import typingsJapgolly.firebaseAuth.distEsm2017SrcMfaMfaErrorMod.MultiFactorError
import typingsJapgolly.firebaseAuth.distEsm2017SrcMfaMfaInfoMod.MultiFactorInfoImpl
...
import typingsJapgolly.firebaseAuth.distEsm2017SrcModelPublicTypesMod.MultiFactorInfo
...
object distEsm2017SrcMfaMfaResolverMod {
  ...
  inline def getMultiFactorResolver(auth: Auth, error: typingsJapgolly.firebaseAuth.distEsm2017SrcModelPublicTypesMod.MultiFactorError): MultiFactorResolver = (^.asInstanceOf[js.Dynamic].applyDynamic("getMultiFactorResolver")(auth.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[MultiFactorResolver]
}
