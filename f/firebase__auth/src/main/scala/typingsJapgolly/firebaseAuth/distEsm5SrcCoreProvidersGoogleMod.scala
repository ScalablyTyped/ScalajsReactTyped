...
import typingsJapgolly.firebaseAuth.distEsm5SrcCoreCredentialsOauthMod.OAuthCredential
import typingsJapgolly.firebaseAuth.distEsm5SrcCoreProvidersOauthMod.BaseOAuthProvider
