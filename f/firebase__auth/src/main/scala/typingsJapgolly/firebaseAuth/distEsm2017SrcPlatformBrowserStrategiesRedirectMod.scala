...
object distEsm2017SrcPlatformBrowserStrategiesRedirectMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/platform_browser/strategies/redirect", JSImport.Namespace)
  @js.native
