...
import typingsJapgolly.firebaseAuth.distCordovaSrcCoreErrorsMod.AuthErrorParams
...
import typingsJapgolly.firebaseAuth.distCordovaSrcModelPublicTypesMod.Config
