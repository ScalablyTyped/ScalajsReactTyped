...
import typingsJapgolly.firebaseAuth.distCordovaSrcCorePersistenceInMemoryMod.InMemoryPersistence_
import typingsJapgolly.firebaseAuth.distCordovaSrcCorePersistenceMod.PersistedBlob
