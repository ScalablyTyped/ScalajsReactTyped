...
object EmailFunction extends StObject {
  ...
  sealed trait CREATE_USER
    extends StObject
       with EmailFunction
  /* "email.createUser" */ val CREATE_USER: typingsJapgolly.firebaseAuth.distNodeTestIntegrationWebdriverUtilFunctionsMod.EmailFunction.CREATE_USER & String = js.native
}
