...
import typingsJapgolly.firebaseAuth.distEsm5SrcModelIdTokenMod.IdToken
...
object distEsm5SrcApiAuthenticationIdpMod {
  
  @JSImport("@firebase/auth/dist/esm5/src/api/authentication/idp", JSImport.Namespace)
  @js.native
  ...
  - typingsJapgolly.firebaseAuth.distEsm5SrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
