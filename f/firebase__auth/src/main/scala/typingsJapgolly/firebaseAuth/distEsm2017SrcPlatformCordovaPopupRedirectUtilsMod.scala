...
object distEsm2017SrcPlatformCordovaPopupRedirectUtilsMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/platform_cordova/popup_redirect/utils", JSImport.Namespace)
  @js.native
