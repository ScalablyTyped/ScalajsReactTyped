...
import typingsJapgolly.firebaseAuth.distCordovaSrcCoreAuthAuthImplMod.AuthImpl
...
object distCordovaSrcCoreAuthInitializeMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/core/auth/initialize", JSImport.Namespace)
  @js.native
