...
import typingsJapgolly.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.EventType
import typingsJapgolly.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.ReceiverHandler
import typingsJapgolly.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.ReceiverResponse
import typingsJapgolly.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.SenderRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distRnSrcPlatformBrowserMessagechannelReceiverMod {
  
  @JSImport("@firebase/auth/dist/rn/src/platform_browser/messagechannel/receiver", "Receiver")
  @js.native
  ...
  object Receiver {
    ...
    @JSImport("@firebase/auth/dist/rn/src/platform_browser/messagechannel/receiver", "Receiver.receivers")
    @js.native
