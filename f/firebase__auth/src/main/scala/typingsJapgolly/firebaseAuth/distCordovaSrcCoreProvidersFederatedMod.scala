...
object distCordovaSrcCoreProvidersFederatedMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/cordova/src/core/providers/federated", "FederatedAuthProvider")
  @js.native
