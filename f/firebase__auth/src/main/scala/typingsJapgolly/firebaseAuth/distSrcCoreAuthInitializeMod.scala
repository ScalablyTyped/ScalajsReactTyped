...
import typingsJapgolly.firebaseAuth.distSrcCoreAuthAuthImplMod.AuthImpl
...
object distSrcCoreAuthInitializeMod {
  
  @JSImport("@firebase/auth/dist/src/core/auth/initialize", JSImport.Namespace)
  @js.native
