...
import typingsJapgolly.firebaseAuth.distNodeSrcModelIdTokenMod.IdToken
...
object distNodeSrcApiAuthenticationIdpMod {
  ...
  - typingsJapgolly.firebaseAuth.distNodeSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
