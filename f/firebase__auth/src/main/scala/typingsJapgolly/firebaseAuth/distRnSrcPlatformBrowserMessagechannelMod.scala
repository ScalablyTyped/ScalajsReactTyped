...
import typingsJapgolly.firebaseAuth.distRnSrcPlatformBrowserMessagechannelPromiseMod.PromiseSettledResult
...
object distRnSrcPlatformBrowserMessagechannelMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.KeyChangedRequest
    - typingsJapgolly.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.PingRequest
  */
  trait SenderRequest extends StObject
  object SenderRequest {
    
    inline def KeyChangedRequest(key: String): typingsJapgolly.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.KeyChangedRequest = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distRnSrcPlatformBrowserMessagechannelMod.KeyChangedRequest]
    }
  }
