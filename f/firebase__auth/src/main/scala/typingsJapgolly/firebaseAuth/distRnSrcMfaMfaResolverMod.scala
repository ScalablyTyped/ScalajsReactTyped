...
import typingsJapgolly.firebaseAuth.distRnSrcMfaMfaErrorMod.MultiFactorError
import typingsJapgolly.firebaseAuth.distRnSrcMfaMfaInfoMod.MultiFactorInfoImpl
...
import typingsJapgolly.firebaseAuth.distRnSrcModelPublicTypesMod.MultiFactorInfo
import typingsJapgolly.firebaseAuth.distRnSrcModelPublicTypesMod.MultiFactorResolver
import typingsJapgolly.firebaseAuth.distRnSrcModelPublicTypesMod.MultiFactorSession
...
object distRnSrcMfaMfaResolverMod {
  ...
  inline def getMultiFactorResolver(auth: Auth, error: typingsJapgolly.firebaseAuth.distRnSrcModelPublicTypesMod.MultiFactorError): MultiFactorResolver = (^.asInstanceOf[js.Dynamic].applyDynamic("getMultiFactorResolver")(auth.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[MultiFactorResolver]
}
