...
object distEsm2017SrcApiProjectConfigGetProjectConfigMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/api/project_config/get_project_config", JSImport.Namespace)
  @js.native
