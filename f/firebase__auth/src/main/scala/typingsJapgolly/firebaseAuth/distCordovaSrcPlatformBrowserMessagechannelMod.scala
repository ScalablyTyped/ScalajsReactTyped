...
import typingsJapgolly.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelPromiseMod.PromiseSettledResult
...
object distCordovaSrcPlatformBrowserMessagechannelMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.KeyChangedRequest
    - typingsJapgolly.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.PingRequest
  */
  trait SenderRequest extends StObject
  object SenderRequest {
    
    inline def KeyChangedRequest(key: String): typingsJapgolly.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.KeyChangedRequest = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.firebaseAuth.distCordovaSrcPlatformBrowserMessagechannelMod.KeyChangedRequest]
    }
  }
