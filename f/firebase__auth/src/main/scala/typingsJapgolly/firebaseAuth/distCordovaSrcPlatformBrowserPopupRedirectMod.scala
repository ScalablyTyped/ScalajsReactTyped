...
object distCordovaSrcPlatformBrowserPopupRedirectMod {
  
  @JSImport("@firebase/auth/dist/cordova/src/platform_browser/popup_redirect", "browserPopupRedirectResolver")
  @js.native
