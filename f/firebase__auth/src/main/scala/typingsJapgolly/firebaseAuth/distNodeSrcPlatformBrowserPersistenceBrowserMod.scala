...
object distNodeSrcPlatformBrowserPersistenceBrowserMod {
  
  /* note: abstract class */ @JSImport("@firebase/auth/dist/node/src/platform_browser/persistence/browser", "BrowserPersistenceClass")
  @js.native
