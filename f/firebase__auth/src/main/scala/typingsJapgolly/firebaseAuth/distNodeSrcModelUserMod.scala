...
import typingsJapgolly.firebaseAuth.distNodeSrcApiAccountManagementAccountMod.APIUserInfo
import typingsJapgolly.firebaseAuth.distNodeSrcApiAuthenticationMfaMod.FinalizeMfaResponse
import typingsJapgolly.firebaseAuth.distNodeSrcCoreUserTokenManagerMod.StsTokenManager
import typingsJapgolly.firebaseAuth.distNodeSrcCoreUserUserMetadataMod.UserMetadata
...
import typingsJapgolly.firebaseAuth.distNodeSrcModelIdTokenMod.TaggedWithTokenResponse
...
object distNodeSrcModelUserMod {
  
  /* Inlined {-readonly [ K in keyof @firebase/auth.@firebase/auth/dist/node/src/model/public_types.UserInfo ]: @firebase/auth.@firebase/auth/dist/node/src/model/public_types.UserInfo[K]} */
