...
object distEsm2017SrcPlatformBrowserUtilPopupMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/platform_browser/util/popup", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/auth/dist/esm2017/src/platform_browser/util/popup", "AuthPopup")
  @js.native
