...
object distEsm2017SrcCoreProvidersSamlMod {
  
  @JSImport("@firebase/auth/dist/esm2017/src/core/providers/saml", "SAMLAuthProvider")
  @js.native
  ...
  object SAMLAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/esm2017/src/core/providers/saml", "SAMLAuthProvider.samlCredentialFromTaggedObject")
    @js.native
