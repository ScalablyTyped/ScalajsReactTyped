...
import typingsJapgolly.firebaseAuth.distNodeEsmSrcCoreMod.AuthCredential
...
object distNodeEsmSrcPlatformBrowserProvidersPhoneMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/providers/phone", "PhoneAuthProvider")
  @js.native
  ...
  object PhoneAuthProvider {
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/providers/phone", "PhoneAuthProvider.PHONE_SIGN_IN_METHOD")
    @js.native
    val PHONE_SIGN_IN_METHOD: phone = js.native
    
    /** Always set to {@link ProviderId}.PHONE. */
    @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/providers/phone", "PhoneAuthProvider.PROVIDER_ID")
    @js.native
    ...
    @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/providers/phone", "PhoneAuthProvider.credentialFromTaggedObject")
    @js.native
