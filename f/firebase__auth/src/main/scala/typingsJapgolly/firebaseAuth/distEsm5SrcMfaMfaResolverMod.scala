...
import typingsJapgolly.firebaseAuth.distEsm5SrcMfaMfaAssertionMod.MultiFactorAssertionImpl
import typingsJapgolly.firebaseAuth.distEsm5SrcMfaMfaErrorMod.MultiFactorError
import typingsJapgolly.firebaseAuth.distEsm5SrcMfaMfaInfoMod.MultiFactorInfoImpl
import typingsJapgolly.firebaseAuth.distEsm5SrcMfaMfaSessionMod.MultiFactorSessionImpl
import typingsJapgolly.firebaseAuth.distEsm5SrcModelPublicTypesMod.Auth
import typingsJapgolly.firebaseAuth.distEsm5SrcModelPublicTypesMod.MultiFactorAssertion
...
object distEsm5SrcMfaMfaResolverMod {
  ...
  inline def getMultiFactorResolver(auth: Auth, error: typingsJapgolly.firebaseAuth.distEsm5SrcModelPublicTypesMod.MultiFactorError): MultiFactorResolver = (^.asInstanceOf[js.Dynamic].applyDynamic("getMultiFactorResolver")(auth.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[MultiFactorResolver]
}
