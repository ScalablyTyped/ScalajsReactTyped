...
object distNodeEsmSrcApiAuthenticationSmsMod {
  ...
  - typingsJapgolly.firebaseAuth.distNodeEsmSrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithPhoneNumberResponse
    extends StObject
