...
import typingsJapgolly.firebaseAuth.distEsm2017SrcModelIdTokenMod.IdToken
...
object distEsm2017SrcApiAuthenticationIdpMod {
  ...
  - typingsJapgolly.firebaseAuth.distEsm2017SrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithIdpResponse
    extends StObject
