...
object distEsm5SrcApiAuthenticationSmsMod {
  ...
  - typingsJapgolly.firebaseAuth.distEsm5SrcApiAuthenticationMfaMod.PhoneOrOauthTokenResponse because Already inherited */ trait SignInWithPhoneNumberResponse
    extends StObject
