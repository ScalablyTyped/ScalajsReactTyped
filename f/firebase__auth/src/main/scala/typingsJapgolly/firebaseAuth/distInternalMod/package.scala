...
import typingsJapgolly.firebaseAuth.distInternalMod.^
...
import typingsJapgolly.firebaseAuth.distSrcModelAuthMod.ApiKey
import typingsJapgolly.firebaseAuth.distSrcModelAuthMod.AppName
