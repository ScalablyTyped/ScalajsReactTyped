...
@JSImport("@firebase/auth/dist/internal", "FetchProvider")
@js.native
open class FetchProvider ()
  extends typingsJapgolly.firebaseAuth.distSrcCoreUtilFetchProviderMod.FetchProvider
/* static members */
object FetchProvider {
  ...
  @JSImport("@firebase/auth/dist/internal", "FetchProvider.fetchImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/internal", "FetchProvider.headersImpl")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/internal", "FetchProvider.responseImpl")
  @js.native
