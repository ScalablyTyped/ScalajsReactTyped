...
@JSImport("@firebase/auth/dist/internal", "PhoneAuthProvider")
@js.native
...
object PhoneAuthProvider {
  ...
  @JSImport("@firebase/auth/dist/internal", "PhoneAuthProvider.PHONE_SIGN_IN_METHOD")
  @js.native
  val PHONE_SIGN_IN_METHOD: phone = js.native
  
  /** Always set to {@link ProviderId}.PHONE. */
  @JSImport("@firebase/auth/dist/internal", "PhoneAuthProvider.PROVIDER_ID")
  @js.native
  ...
  @JSImport("@firebase/auth/dist/internal", "PhoneAuthProvider.credentialFromTaggedObject")
  @js.native
