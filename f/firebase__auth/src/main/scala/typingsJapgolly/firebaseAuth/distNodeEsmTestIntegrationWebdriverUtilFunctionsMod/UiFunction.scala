...
object UiFunction extends StObject {
  ...
  sealed trait LOAD
    extends StObject
       with UiFunction
  /* "ui.loadUiCode" */ val LOAD: typingsJapgolly.firebaseAuth.distNodeEsmTestIntegrationWebdriverUtilFunctionsMod.UiFunction.LOAD & String = js.native
  
  @js.native
  sealed trait START
    extends StObject
       with UiFunction
  /* "ui.startUi" */ val START: typingsJapgolly.firebaseAuth.distNodeEsmTestIntegrationWebdriverUtilFunctionsMod.UiFunction.START & String = js.native
}
