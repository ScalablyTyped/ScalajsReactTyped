...
import typingsJapgolly.firebaseAuth.anon.`37`
import typingsJapgolly.firebaseAuth.distSrcCoreCredentialsMod.AuthCredential
...
object distSrcMfaMfaErrorMod {
  ...
  /* private */ open class MultiFactorError ()
    extends typingsJapgolly.firebaseAuth.distSrcModelPublicTypesMod.MultiFactorError {
