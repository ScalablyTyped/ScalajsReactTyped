...
object distNodeEsmSrcPlatformCordovaPopupRedirectUtilsMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_cordova/popup_redirect/utils", JSImport.Namespace)
  @js.native
