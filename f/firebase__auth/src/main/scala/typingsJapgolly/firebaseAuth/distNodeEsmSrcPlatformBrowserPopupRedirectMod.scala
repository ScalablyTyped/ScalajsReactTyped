...
object distNodeEsmSrcPlatformBrowserPopupRedirectMod {
  
  @JSImport("@firebase/auth/dist/node-esm/src/platform_browser/popup_redirect", "browserPopupRedirectResolver")
  @js.native
