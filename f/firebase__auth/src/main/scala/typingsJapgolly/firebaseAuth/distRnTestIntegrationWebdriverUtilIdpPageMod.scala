...
object distRnTestIntegrationWebdriverUtilIdpPageMod {
  
  @JSImport("@firebase/auth/dist/rn/test/integration/webdriver/util/idp_page", "IdPPage")
  @js.native
  ...
  object IdPPage {
    ...
    @JSImport("@firebase/auth/dist/rn/test/integration/webdriver/util/idp_page", "IdPPage.PAGE_TITLE")
    @js.native
