...
object anon {
  ...
  trait PartialMetadataBucket extends StObject {
    ...
    var ref: js.UndefOr[typingsJapgolly.firebaseStorage.distSrcPublicTypesMod.StorageReference] = js.undefined
  ...
  object PartialMetadataBucket {
    ...
    extension [Self <: PartialMetadataBucket](x: Self) {
      ...
      inline def setRef(value: typingsJapgolly.firebaseStorage.distSrcPublicTypesMod.StorageReference): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
