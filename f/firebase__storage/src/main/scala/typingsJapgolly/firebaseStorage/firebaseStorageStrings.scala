...
import typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationTaskenumsMod.InternalTaskState
import typingsJapgolly.firebaseStorage.distSrcPublicTypesMod.TaskState
import typingsJapgolly.firebaseStorage.distStorageMod.StorageErrorCode
import typingsJapgolly.firebaseStorage.distStorageMod._TaskState
...
object firebaseStorageStrings {
  ...
  sealed trait `app-deleted`
    extends StObject
       ...
       with typingsJapgolly.firebaseStorage.distSrcImplementationErrorMod.StorageErrorCode
       with typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationErrorMod.StorageErrorCode
  ...
  sealed trait base64
    extends StObject
       with StringFormat
       with typingsJapgolly.firebaseStorage.mod.StringFormat
       with typingsJapgolly.firebaseStorage.distStorageMod.StringFormat
       with typingsJapgolly.firebaseStorage.distSrcImplementationStringMod.StringFormat
  ...
  sealed trait canceled
    extends StObject
       ...
       with typingsJapgolly.firebaseStorage.distSrcImplementationTaskenumsMod.InternalTaskState
       with typingsJapgolly.firebaseStorage.distStorageMod.InternalTaskState
       with StorageErrorCode
       with typingsJapgolly.firebaseStorage.distSrcImplementationErrorMod.StorageErrorCode
       with typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationErrorMod.StorageErrorCode
       with TaskState
       with typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationTaskenumsMod.TaskState
       with typingsJapgolly.firebaseStorage.mod.TaskState
       with typingsJapgolly.firebaseStorage.distSrcImplementationTaskenumsMod.TaskState
       with typingsJapgolly.firebaseStorage.distStorageMod.TaskState
       with typingsJapgolly.firebaseStorage.distNodeEsmSrcPublicTypesMod.TaskState
       with _TaskState
