...
object distSrcApiMod {
  ...
  open class FbsBlob protected ()
    extends typingsJapgolly.firebaseStorage.distSrcImplementationBlobMod.FbsBlob {
  ...
  open class FirebaseStorageImpl protected ()
    extends typingsJapgolly.firebaseStorage.distSrcServiceMod.FirebaseStorageImpl {
    def this(
      /**
  ...
  open class Location protected ()
    extends typingsJapgolly.firebaseStorage.distSrcImplementationLocationMod.Location {
  ...
  open class Reference protected ()
    extends typingsJapgolly.firebaseStorage.distSrcReferenceMod.Reference {
  ...
  open class UploadTask protected ()
    extends typingsJapgolly.firebaseStorage.distSrcTaskMod.UploadTask {
    /**
