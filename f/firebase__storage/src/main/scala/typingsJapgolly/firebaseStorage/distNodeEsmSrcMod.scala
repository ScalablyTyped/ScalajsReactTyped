...
import typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationErrorMod.StorageError
import typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationStringMod.StringData
import typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationStringMod.StringFormat
import typingsJapgolly.firebaseStorage.distNodeEsmSrcMetadataMod.Metadata
import typingsJapgolly.firebaseStorage.distNodeEsmSrcPublicTypesMod.FirebaseStorage
import typingsJapgolly.firebaseStorage.distNodeEsmSrcPublicTypesMod.FullMetadata
import typingsJapgolly.firebaseStorage.distNodeEsmSrcPublicTypesMod.ListOptions
import typingsJapgolly.firebaseStorage.distNodeEsmSrcPublicTypesMod.ListResult
import typingsJapgolly.firebaseStorage.distNodeEsmSrcPublicTypesMod.SettableMetadata
import typingsJapgolly.firebaseStorage.distNodeEsmSrcPublicTypesMod.StorageReference
import typingsJapgolly.firebaseStorage.distNodeEsmSrcPublicTypesMod.UploadMetadata
import typingsJapgolly.firebaseStorage.distNodeEsmSrcPublicTypesMod.UploadResult
...
object distNodeEsmSrcMod {
  ...
  @JSImport("@firebase/storage/dist/node-esm/src", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/storage/dist/node-esm/src", "_FbsBlob")
  @js.native
  open class FbsBlob protected ()
    extends typingsJapgolly.firebaseStorage.distNodeEsmSrcApiMod.FbsBlob {
  ...
  object FbsBlob {
    ...
    inline def getBlob(args: (String | typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationBlobMod.FbsBlob)*): typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationBlobMod.FbsBlob | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("getBlob")(args.asInstanceOf[Seq[js.Any]]*).asInstanceOf[typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationBlobMod.FbsBlob | Null]
  }
  
  @JSImport("@firebase/storage/dist/node-esm/src", "_FirebaseStorageImpl")
  @js.native
  open class FirebaseStorageImpl protected ()
    extends typingsJapgolly.firebaseStorage.distNodeEsmSrcApiMod.FirebaseStorageImpl {
    def this(
      /**
  ...
  @JSImport("@firebase/storage/dist/node-esm/src", "_Location")
  @js.native
  open class Location protected ()
    extends typingsJapgolly.firebaseStorage.distNodeEsmSrcApiMod.Location {
  ...
  @JSImport("@firebase/storage/dist/node-esm/src", "_Reference")
  @js.native
  open class Reference protected ()
    extends typingsJapgolly.firebaseStorage.distNodeEsmSrcApiMod.Reference {
    def this(
      _service: typingsJapgolly.firebaseStorage.distNodeEsmSrcServiceMod.FirebaseStorageImpl,
      location: String
    ) = this()
    def this(
      _service: typingsJapgolly.firebaseStorage.distNodeEsmSrcServiceMod.FirebaseStorageImpl,
      location: typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationLocationMod.Location
    ) = this()
  }
  ...
  object StringFormat {
    ...
    /**
      ...
      */
    @JSImport("@firebase/storage/dist/node-esm/src", "StringFormat.BASE64")
    @js.native
    ...
    /**
      ...
      * ad 69 8e fb e1 3a b7 bf eb 97
      */
    @JSImport("@firebase/storage/dist/node-esm/src", "StringFormat.BASE64URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/storage/dist/node-esm/src", "StringFormat.DATA_URL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@firebase/storage/dist/node-esm/src", "StringFormat.RAW")
    @js.native
  ...
  object TaskEvent {
    ...
    @JSImport("@firebase/storage/dist/node-esm/src", "_TaskEvent")
    @js.native
    val ^ : js.Any = js.native
    ...
    /**
      ...
      * </ul>
      */
    @JSImport("@firebase/storage/dist/node-esm/src", "_TaskEvent.STATE_CHANGED")
    @js.native
  ...
  object TaskState {
    ...
    @JSImport("@firebase/storage/dist/node-esm/src", "_TaskState.CANCELED")
    @js.native
    val CANCELED: canceled = js.native
    
    /** The task failed with an error. */
    @JSImport("@firebase/storage/dist/node-esm/src", "_TaskState.ERROR")
    @js.native
    val ERROR: error = js.native
    
    /** The task was paused by the user. */
    @JSImport("@firebase/storage/dist/node-esm/src", "_TaskState.PAUSED")
    @js.native
    val PAUSED: paused = js.native
    
    /** The task is currently transferring data. */
    @JSImport("@firebase/storage/dist/node-esm/src", "_TaskState.RUNNING")
    @js.native
    val RUNNING: running = js.native
    
    /** The task completed successfully. */
    @JSImport("@firebase/storage/dist/node-esm/src", "_TaskState.SUCCESS")
    @js.native
    val SUCCESS: success = js.native
  }
  
  @JSImport("@firebase/storage/dist/node-esm/src", "_UploadTask")
  @js.native
  open class UploadTask protected ()
    extends typingsJapgolly.firebaseStorage.distNodeEsmSrcApiMod.UploadTask {
    /**
      ...
      */
    def this(
      ref: typingsJapgolly.firebaseStorage.distNodeEsmSrcReferenceMod.Reference,
      blob: typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationBlobMod.FbsBlob
    ) = this()
    def this(
      ref: typingsJapgolly.firebaseStorage.distNodeEsmSrcReferenceMod.Reference,
      blob: typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationBlobMod.FbsBlob,
  ...
  inline def getChild(ref: StorageReference, childPath: String): typingsJapgolly.firebaseStorage.distNodeEsmSrcReferenceMod.Reference = (^.asInstanceOf[js.Dynamic].applyDynamic("_getChild")(ref.asInstanceOf[js.Any], childPath.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.firebaseStorage.distNodeEsmSrcReferenceMod.Reference]
