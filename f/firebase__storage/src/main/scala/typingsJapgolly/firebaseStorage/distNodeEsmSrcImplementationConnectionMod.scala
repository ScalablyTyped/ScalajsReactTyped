...
object distNodeEsmSrcImplementationConnectionMod {
  ...
  object ErrorCode extends StObject {
    ...
    sealed trait ABORT
      extends StObject
         with ErrorCode
    /* 2 */ val ABORT: typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationConnectionMod.ErrorCode.ABORT & Double = js.native
    
    @js.native
    sealed trait NETWORK_ERROR
      extends StObject
         with ErrorCode
    /* 1 */ val NETWORK_ERROR: typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationConnectionMod.ErrorCode.NETWORK_ERROR & Double = js.native
    
    @js.native
    sealed trait NO_ERROR
      extends StObject
         with ErrorCode
    /* 0 */ val NO_ERROR: typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationConnectionMod.ErrorCode.NO_ERROR & Double = js.native
  }
