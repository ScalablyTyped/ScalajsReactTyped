...
object distNodeEsmSrcImplementationRequestMod {
  ...
  inline def makeRequest[I /* <: ConnectionType */, O](
    ...
    firebaseVersion: String,
    retry: Boolean
  ): Request[O] = (^.asInstanceOf[js.Dynamic].applyDynamic("makeRequest")(requestInfo.asInstanceOf[js.Any], appId.asInstanceOf[js.Any], authToken.asInstanceOf[js.Any], appCheckToken.asInstanceOf[js.Any], requestFactory.asInstanceOf[js.Any], firebaseVersion.asInstanceOf[js.Any], retry.asInstanceOf[js.Any])).asInstanceOf[Request[O]]
  inline def makeRequest[I /* <: ConnectionType */, O](
    requestInfo: RequestInfo[I, O],
    appId: String,
    authToken: String,
