...
object RequestInfo2 {
  ...
  extension [Self <: RequestInfo2[?, ?], I /* <: ConnectionType */, O](x: Self & (RequestInfo2[I, O])) {
    ...
    inline def setProgressCallback(value: (/* p1 */ Double, /* p2 */ Double) => Callback): Self = StObject.set(x, "progressCallback", js.Any.fromFunction2((t0: /* p1 */ Double, t1: /* p2 */ Double) => (value(t0, t1)).runNow()))
