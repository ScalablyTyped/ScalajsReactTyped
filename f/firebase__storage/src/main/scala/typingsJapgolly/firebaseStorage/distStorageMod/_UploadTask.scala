...
open class _UploadTask protected () extends StObject {
  ...
  def isExponentialBackoffExpired(): Boolean = js.native
  
  /* private */ var maxSleepTime: Any = js.native
  ...
  def on(`type`: _TaskEvent, nextOrObserver: Unit, error: Unit, completed: CompleteFn): Unsubscribe2 | Subscribe2[UploadTaskSnapshot] = js.native
  ...
  /* private */ var pendingTimeout: Any = js.native
  ...
  /* private */ var sleepTime: Any = js.native
