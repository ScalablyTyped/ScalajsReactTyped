...
object distSrcPlatformBrowserConnectionMod {
  
  @JSImport("@firebase/storage/dist/src/platform/browser/connection", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/storage/dist/src/platform/browser/connection", "XhrBlobConnection")
  @js.native
  open class XhrBlobConnection ()
    extends StObject
       with XhrConnection[Blob]
  
  @JSImport("@firebase/storage/dist/src/platform/browser/connection", "XhrBytesConnection")
  @js.native
  ...
  @JSImport("@firebase/storage/dist/src/platform/browser/connection", "XhrTextConnection")
  @js.native
