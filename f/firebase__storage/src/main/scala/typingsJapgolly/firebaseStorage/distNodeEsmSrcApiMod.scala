...
object distNodeEsmSrcApiMod {
  ...
  open class FbsBlob protected ()
    extends typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationBlobMod.FbsBlob {
  ...
  open class FirebaseStorageImpl protected ()
    extends typingsJapgolly.firebaseStorage.distNodeEsmSrcServiceMod.FirebaseStorageImpl {
    def this(
      /**
  ...
  open class Location protected ()
    extends typingsJapgolly.firebaseStorage.distNodeEsmSrcImplementationLocationMod.Location {
  ...
  open class Reference protected ()
    extends typingsJapgolly.firebaseStorage.distNodeEsmSrcReferenceMod.Reference {
    def this(
  ...
  open class UploadTask protected ()
    extends typingsJapgolly.firebaseStorage.distNodeEsmSrcTaskMod.UploadTask {
    /**
