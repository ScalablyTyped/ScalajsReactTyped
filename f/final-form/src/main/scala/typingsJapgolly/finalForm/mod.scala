...
import typingsJapgolly.finalForm.anon.Notified
import typingsJapgolly.finalForm.finalFormBooleans.`false`
import typingsJapgolly.finalForm.finalFormStrings.`FINAL_FORMSlasharray-error`
import typingsJapgolly.finalForm.finalFormStrings.`FINAL_FORMSlashform-error`
import typingsJapgolly.finalForm.finalFormStrings.debug
import typingsJapgolly.finalForm.finalFormStrings.destroyOnUnregister
import typingsJapgolly.finalForm.finalFormStrings.initialValues
import typingsJapgolly.finalForm.finalFormStrings.keepDirtyOnReinitialize
import typingsJapgolly.finalForm.finalFormStrings.mutators
import typingsJapgolly.finalForm.finalFormStrings.validate
import typingsJapgolly.finalForm.finalFormStrings.validateOnBlur
...
object mod {
  ...
  /* keyof final-form.final-form.Config<object, std.Partial<object>> */ /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.finalForm.finalFormStrings.debug
    - typingsJapgolly.finalForm.finalFormStrings.destroyOnUnregister
    - typingsJapgolly.finalForm.finalFormStrings.initialValues
    - typingsJapgolly.finalForm.finalFormStrings.keepDirtyOnReinitialize
    - typingsJapgolly.finalForm.finalFormStrings.mutators
    - typingsJapgolly.finalForm.finalFormStrings.onSubmit
    - typingsJapgolly.finalForm.finalFormStrings.validate
    - typingsJapgolly.finalForm.finalFormStrings.validateOnBlur
  */
  ...
  object FieldConfig {
    ...
    extension [Self <: FieldConfig[?], FieldValue](x: Self & FieldConfig[FieldValue]) {
      ...
      inline def setAfterSubmit(value: Callback): Self = StObject.set(x, "afterSubmit", value.toJsFn)
      
      inline def setAfterSubmitUndefined: Self = StObject.set(x, "afterSubmit", js.undefined)
      
      inline def setBeforeSubmit(value: CallbackTo[Unit | `false`]): Self = StObject.set(x, "beforeSubmit", value.toJsFn)
      ...
      inline def setGetValidator(value: CallbackTo[js.UndefOr[FieldValidator[FieldValue]]]): Self = StObject.set(x, "getValidator", value.toJsFn)
  ...
  object InternalFieldState {
    ...
    inline def apply[FieldValue](
      ...
      val __obj = js.Dynamic.literal(active = active.asInstanceOf[js.Any], blur = blur.toJsFn, change = js.Any.fromFunction1((t0: Any) => change(t0).runNow()), data = data.asInstanceOf[js.Any], focus = focus.toJsFn, isEqual = js.Any.fromFunction2(isEqual), modified = modified.asInstanceOf[js.Any], modifiedSinceLastSubmit = modifiedSinceLastSubmit.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], touched = touched.asInstanceOf[js.Any], valid = valid.asInstanceOf[js.Any], validating = validating.asInstanceOf[js.Any], validators = validators.asInstanceOf[js.Any], visited = visited.asInstanceOf[js.Any])
    ...
    extension [Self <: InternalFieldState[?], FieldValue](x: Self & InternalFieldState[FieldValue]) {
      ...
      inline def setChange(value: Any => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
  ...
  object Tools {
    ...
    inline def apply[FormValues, InitialFormValues](
      changeValue: (/* state */ MutableState[FormValues, InitialFormValues], /* name */ String, /* mutate */ js.Function1[/* value */ Any, Any]) => Callback,
      getIn: (/* state */ js.Object, /* complexKey */ String) => Any,
      renameField: (/* state */ MutableState[FormValues, InitialFormValues], /* from */ String, /* to */ String) => Callback,
      resetFieldState: String => Callback,
      setIn: (/* state */ js.Object, /* key */ String, /* value */ Any) => js.Object,
      shallowEqual: (/* a */ Any, /* b */ Any) => Boolean
    ): Tools[FormValues, InitialFormValues] = {
      val __obj = js.Dynamic.literal(changeValue = js.Any.fromFunction3((t0: /* state */ MutableState[FormValues, InitialFormValues], t1: /* name */ String, t2: /* mutate */ js.Function1[/* value */ Any, Any]) => (changeValue(t0, t1, t2)).runNow()), getIn = js.Any.fromFunction2(getIn), renameField = js.Any.fromFunction3((t0: /* state */ MutableState[FormValues, InitialFormValues], t1: /* from */ String, t2: /* to */ String) => (renameField(t0, t1, t2)).runNow()), resetFieldState = js.Any.fromFunction1((t0: String) => resetFieldState(t0).runNow()), setIn = js.Any.fromFunction3(setIn), shallowEqual = js.Any.fromFunction2(shallowEqual))
    ...
    extension [Self <: Tools[?, ?], FormValues, InitialFormValues](x: Self & (Tools[FormValues, InitialFormValues])) {
      ...
      inline def setChangeValue(
        value: (/* state */ MutableState[FormValues, InitialFormValues], /* name */ String, /* mutate */ js.Function1[/* value */ Any, Any]) => Callback
      ): Self = StObject.set(x, "changeValue", js.Any.fromFunction3((t0: /* state */ MutableState[FormValues, InitialFormValues], t1: /* name */ String, t2: /* mutate */ js.Function1[/* value */ Any, Any]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setRenameField(
        value: (/* state */ MutableState[FormValues, InitialFormValues], /* from */ String, /* to */ String) => Callback
      ): Self = StObject.set(x, "renameField", js.Any.fromFunction3((t0: /* state */ MutableState[FormValues, InitialFormValues], t1: /* from */ String, t2: /* to */ String) => (value(t0, t1, t2)).runNow()))
      
      inline def setResetFieldState(value: String => Callback): Self = StObject.set(x, "resetFieldState", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
