...
object distSrcInterfacesLoggingTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.firebaseMessaging.firebaseMessagingStrings.RESPONSE_ACTION_UNKNOWN
    - typingsJapgolly.firebaseMessaging.firebaseMessagingStrings.RETRY_REQUEST_LATER
    - typingsJapgolly.firebaseMessaging.firebaseMessagingStrings.DELETE_REQUEST
  */
  trait UserResponse extends StObject
  object UserResponse {
    
    inline def DELETE_REQUEST: typingsJapgolly.firebaseMessaging.firebaseMessagingStrings.DELETE_REQUEST = "DELETE_REQUEST".asInstanceOf[typingsJapgolly.firebaseMessaging.firebaseMessagingStrings.DELETE_REQUEST]
    
    inline def RESPONSE_ACTION_UNKNOWN: typingsJapgolly.firebaseMessaging.firebaseMessagingStrings.RESPONSE_ACTION_UNKNOWN = "RESPONSE_ACTION_UNKNOWN".asInstanceOf[typingsJapgolly.firebaseMessaging.firebaseMessagingStrings.RESPONSE_ACTION_UNKNOWN]
    
    inline def RETRY_REQUEST_LATER: typingsJapgolly.firebaseMessaging.firebaseMessagingStrings.RETRY_REQUEST_LATER = "RETRY_REQUEST_LATER".asInstanceOf[typingsJapgolly.firebaseMessaging.firebaseMessagingStrings.RETRY_REQUEST_LATER]
  }
}
