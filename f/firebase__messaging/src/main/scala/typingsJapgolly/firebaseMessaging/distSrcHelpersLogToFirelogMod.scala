...
import typingsJapgolly.firebaseMessaging.distSrcInterfacesInternalMessagePayloadMod.MessagePayloadInternal
import typingsJapgolly.firebaseMessaging.distSrcInterfacesLoggingTypesMod.LogEvent
import typingsJapgolly.firebaseMessaging.distSrcInterfacesLoggingTypesMod.LogRequest
