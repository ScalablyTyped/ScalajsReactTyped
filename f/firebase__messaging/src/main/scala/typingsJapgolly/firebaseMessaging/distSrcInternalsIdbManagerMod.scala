...
import typingsJapgolly.firebaseMessaging.distSrcInterfacesTokenDetailsMod.TokenDetails
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distSrcInternalsIdbManagerMod {
  
  @JSImport("@firebase/messaging/dist/src/internals/idb-manager", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@firebase/messaging/dist/src/internals/idb-manager", "DATABASE_NAME")
  @js.native
