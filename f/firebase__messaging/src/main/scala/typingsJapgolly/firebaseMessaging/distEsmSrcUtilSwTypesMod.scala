...
import typingsJapgolly.firebaseMessaging.firebaseMessagingStrings.notificationclick
import typingsJapgolly.firebaseMessaging.firebaseMessagingStrings.push
import typingsJapgolly.firebaseMessaging.firebaseMessagingStrings.pushsubscriptionchange
import typingsJapgolly.std.AddEventListenerOptions
import typingsJapgolly.std.ClientTypes
...
object distEsmSrcUtilSwTypesMod {
  ...
  object PushMessageData {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(arrayBuffer = arrayBuffer.toJsFn, blob = blob.toJsFn, json = json.toJsFn, text = text.toJsFn)
