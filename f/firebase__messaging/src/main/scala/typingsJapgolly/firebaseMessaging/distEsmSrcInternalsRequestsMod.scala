...
import typingsJapgolly.firebaseMessaging.anon.ApplicationPubKey
import typingsJapgolly.firebaseMessaging.anon.Message
import typingsJapgolly.firebaseMessaging.distEsmSrcInterfacesInternalDependenciesMod.FirebaseInternalDependencies
import typingsJapgolly.firebaseMessaging.distEsmSrcInterfacesTokenDetailsMod.SubscriptionOptions
import typingsJapgolly.firebaseMessaging.distEsmSrcInterfacesTokenDetailsMod.TokenDetails
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distEsmSrcInternalsRequestsMod {
  
  @JSImport("@firebase/messaging/dist/esm/src/internals/requests", JSImport.Namespace)
  @js.native
