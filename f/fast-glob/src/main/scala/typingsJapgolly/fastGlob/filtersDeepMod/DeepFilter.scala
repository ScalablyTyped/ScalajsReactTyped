package typingsJapgolly.fastGlob.filtersDeepMod
...
object DeepFilter {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(filter = filter.asInstanceOf[js.Any], getMaxPatternDepth = getMaxPatternDepth.asInstanceOf[js.Any], getNegativePatternsRe = getNegativePatternsRe.asInstanceOf[js.Any], isSkippedByDeepOption = isSkippedByDeepOption.asInstanceOf[js.Any], isSkippedByMaxPatternDepth = isSkippedByMaxPatternDepth.asInstanceOf[js.Any], isSkippedByNegativePatterns = isSkippedByNegativePatterns.asInstanceOf[js.Any], isSkippedDotDirectory = isSkippedDotDirectory.asInstanceOf[js.Any], isSkippedSymlinkedDirectory = isSkippedSymlinkedDirectory.asInstanceOf[js.Any], micromatchOptions = micromatchOptions.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any])
    __obj.updateDynamic("getFilter")(js.Any.fromFunction2((t0: js.Array[typingsJapgolly.fastGlob.typesPatternsMod.Pattern], t1: js.Array[typingsJapgolly.fastGlob.typesPatternsMod.Pattern]) => getFilter(t0, t1).runNow()))
