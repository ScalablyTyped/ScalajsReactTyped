package typingsJapgolly.fastGlob.mod
...
/* Inlined fast-glob.fast-glob/out/managers/options.IPartialOptions<T> */
trait Options[T] extends js.Object {
  ...
  var transform: js.UndefOr[typingsJapgolly.fastGlob.optionsMod.TransformFunction[T]] = js.undefined
