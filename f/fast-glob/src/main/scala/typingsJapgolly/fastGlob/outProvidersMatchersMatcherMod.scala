...
import typingsJapgolly.fastGlob.fastGlobBooleans.`false`
import typingsJapgolly.fastGlob.fastGlobBooleans.`true`
...
object outProvidersMatchersMatcherMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fastGlob.outProvidersMatchersMatcherMod.StaticPatternSegment
    - typingsJapgolly.fastGlob.outProvidersMatchersMatcherMod.DynamicPatternSegment
  */
  trait PatternSegment extends StObject
  object PatternSegment {
    
    inline def DynamicPatternSegment(pattern: Pattern, patternRe: js.RegExp): typingsJapgolly.fastGlob.outProvidersMatchersMatcherMod.DynamicPatternSegment = {
      val __obj = js.Dynamic.literal(dynamic = true, pattern = pattern.asInstanceOf[js.Any], patternRe = patternRe.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.fastGlob.outProvidersMatchersMatcherMod.DynamicPatternSegment]
    }
    
    inline def StaticPatternSegment(pattern: Pattern): typingsJapgolly.fastGlob.outProvidersMatchersMatcherMod.StaticPatternSegment = {
      val __obj = js.Dynamic.literal(dynamic = false, pattern = pattern.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.fastGlob.outProvidersMatchersMatcherMod.StaticPatternSegment]
    }
  }
