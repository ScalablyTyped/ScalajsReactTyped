...
import typingsJapgolly.fastGlob.outTypesMod.EntryFilterFunction
...
object outProvidersFiltersEntryMod {
  ...
  open class default protected ()
    extends StObject
       with EntryFilter {
    def this(_settings: typingsJapgolly.fastGlob.outSettingsMod.default, _micromatchOptions: MicromatchOptions) = this()
