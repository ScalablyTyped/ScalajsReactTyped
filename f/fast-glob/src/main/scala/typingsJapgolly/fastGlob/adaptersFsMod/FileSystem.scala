package typingsJapgolly.fastGlob.adaptersFsMod
...
object FileSystem {
  ...
  def apply[T](
    ...
    __obj.updateDynamic("makeEntry")(js.Any.fromFunction2((t0: typingsJapgolly.node.fsMod.Stats, t1: typingsJapgolly.fastGlob.typesPatternsMod.Pattern) => makeEntry(t0, t1).runNow()))
