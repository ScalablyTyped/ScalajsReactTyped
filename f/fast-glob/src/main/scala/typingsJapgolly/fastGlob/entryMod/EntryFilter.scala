package typingsJapgolly.fastGlob.entryMod
...
object EntryFilter {
  ...
  def apply(
    ...
    filter: js.Any,
    getFilter: (js.Array[Pattern], js.Array[Pattern]) => CallbackTo[FilterFunction],
    ...
    val __obj = js.Dynamic.literal(createIndexRecord = createIndexRecord.asInstanceOf[js.Any], filter = filter.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any], isDuplicateEntry = isDuplicateEntry.asInstanceOf[js.Any], isMatchToPatterns = isMatchToPatterns.asInstanceOf[js.Any], isSkippedByAbsoluteNegativePatterns = isSkippedByAbsoluteNegativePatterns.asInstanceOf[js.Any], micromatchOptions = micromatchOptions.asInstanceOf[js.Any], onlyDirectoryFilter = onlyDirectoryFilter.asInstanceOf[js.Any], onlyFileFilter = onlyFileFilter.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any])
    __obj.updateDynamic("getFilter")(js.Any.fromFunction2((t0: js.Array[typingsJapgolly.fastGlob.patternsMod.Pattern], t1: js.Array[typingsJapgolly.fastGlob.patternsMod.Pattern]) => getFilter(t0, t1).runNow()))
