...
import typingsJapgolly.fingerprintjsFingerprintjs.anon.Duration
import typingsJapgolly.fingerprintjsFingerprintjs.anon.Error
import typingsJapgolly.fingerprintjsFingerprintjs.anon.ReadonlyGetOptions
import typingsJapgolly.fingerprintjsFingerprintjs.anon.ReadonlyLoadOptions
import typingsJapgolly.fingerprintjsFingerprintjs.anon.valueundefinederrorErrorm
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fingerprintjsFingerprintjs.fingerprintjsFingerprintjsStrings.srgb
    - typingsJapgolly.fingerprintjsFingerprintjs.fingerprintjsFingerprintjsStrings.p3
    - typingsJapgolly.fingerprintjsFingerprintjs.fingerprintjsFingerprintjsStrings.rec2020
  */
  trait ColorGamut extends StObject
  object ColorGamut {
    
    inline def p3: typingsJapgolly.fingerprintjsFingerprintjs.fingerprintjsFingerprintjsStrings.p3 = "p3".asInstanceOf[typingsJapgolly.fingerprintjsFingerprintjs.fingerprintjsFingerprintjsStrings.p3]
    
    inline def rec2020: typingsJapgolly.fingerprintjsFingerprintjs.fingerprintjsFingerprintjsStrings.rec2020 = "rec2020".asInstanceOf[typingsJapgolly.fingerprintjsFingerprintjs.fingerprintjsFingerprintjsStrings.rec2020]
    
    inline def srgb: typingsJapgolly.fingerprintjsFingerprintjs.fingerprintjsFingerprintjsStrings.srgb = "srgb".asInstanceOf[typingsJapgolly.fingerprintjsFingerprintjs.fingerprintjsFingerprintjsStrings.srgb]
  }
