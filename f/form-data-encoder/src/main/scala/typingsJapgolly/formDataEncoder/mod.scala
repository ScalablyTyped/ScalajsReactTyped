...
import typingsJapgolly.formDataEncoder.`@typeFormDataEncoderMod`.FormDataEncoderOptions
...
object mod {
  ...
  open class FormDataEncoder protected ()
    extends typingsJapgolly.formDataEncoder.`@typeFormDataEncoderMod`.FormDataEncoder {
    /**
