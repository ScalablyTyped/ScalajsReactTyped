...
object anon {
  ...
  trait AsyncPlaceholder extends StObject {
    ...
    var asyncPlaceholder: js.UndefOr[ElementType] = js.undefined
  }
  object AsyncPlaceholder {
    ...
    extension [Self <: AsyncPlaceholder](x: Self) {
      ...
      inline def setAsyncPlaceholder(value: ElementType): Self = StObject.set(x, "asyncPlaceholder", value.asInstanceOf[js.Any])
