...
import typingsJapgolly.fluentuiUtilities.libSelectionSelectionDottypesMod.ISelection
import typingsJapgolly.fluentuiUtilities.libSelectionSelectionDottypesMod.SelectionMode
...
object libSelectionSelectionMod {
  ...
  @JSImport("@fluentui/utilities/lib/selection/Selection", "Selection")
  @js.native
  ...
  object ISelectionOptions {
    ...
    extension [Self <: ISelectionOptions[?], TItem](x: Self & ISelectionOptions[TItem]) {
      ...
      inline def setOnItemsChanged(value: Callback): Self = StObject.set(x, "onItemsChanged", value.toJsFn)
      
      inline def setOnItemsChangedUndefined: Self = StObject.set(x, "onItemsChanged", js.undefined)
      
      inline def setOnSelectionChanged(value: Callback): Self = StObject.set(x, "onSelectionChanged", value.toJsFn)
  ...
  /* Inlined @fluentui/utilities.@fluentui/utilities/lib/selection/Selection.ISelectionOptions<TItem> & std.Required<std.Pick<@fluentui/utilities.@fluentui/utilities/lib/selection/Selection.ISelectionOptions<TItem>, 'getKey'>> */
