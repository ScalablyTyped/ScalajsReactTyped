...
object libSelectionSelectionDottypesMod {
  ...
  @JSImport("@fluentui/utilities/lib/selection/Selection.types", "SELECTION_CHANGE")
  @js.native
  val SELECTION_CHANGE: /* "change" */ String = js.native
  
  @JSImport("@fluentui/utilities/lib/selection/Selection.types", "SELECTION_ITEMS_CHANGE")
  @js.native
  val SELECTION_ITEMS_CHANGE: /* "items-change" */ String = js.native
  
  @js.native
  sealed trait SelectionDirection extends StObject
  @JSImport("@fluentui/utilities/lib/selection/Selection.types", "SelectionDirection")
  @js.native
  ...
  @JSImport("@fluentui/utilities/lib/selection/Selection.types", "SelectionMode")
  @js.native
