...
object libMathMod {
  ...
  @JSImport("@fluentui/utilities/lib/math", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fluentuiUtilities.fluentuiUtilitiesStrings.contain
    - typingsJapgolly.fluentuiUtilities.fluentuiUtilitiesStrings.cover
  */
  trait FitMode extends StObject
  object FitMode {
    
    inline def contain: typingsJapgolly.fluentuiUtilities.fluentuiUtilitiesStrings.contain = "contain".asInstanceOf[typingsJapgolly.fluentuiUtilities.fluentuiUtilitiesStrings.contain]
    
    inline def cover: typingsJapgolly.fluentuiUtilities.fluentuiUtilitiesStrings.cover = "cover".asInstanceOf[typingsJapgolly.fluentuiUtilities.fluentuiUtilitiesStrings.cover]
  }
