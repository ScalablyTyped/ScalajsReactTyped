...
trait Color extends StObject {
  ...
  var color: js.UndefOr[typingsJapgolly.forgeViewer.THREE.Color] = js.undefined
...
object Color {
  ...
  extension [Self <: Color](x: Self) {
    ...
    inline def setColor(value: typingsJapgolly.forgeViewer.THREE.Color): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
