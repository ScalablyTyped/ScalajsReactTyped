...
import typingsJapgolly.forgeViewer.forgeViewerStrings.PlanarHeatmap
import typingsJapgolly.forgeViewer.forgeViewerStrings.max
import typingsJapgolly.forgeViewer.forgeViewerStrings.middle
import typingsJapgolly.forgeViewer.forgeViewerStrings.min
