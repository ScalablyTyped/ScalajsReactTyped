...
trait Model extends StObject {
  ...
  var model: typingsJapgolly.forgeViewer.Autodesk.Viewing.Model
  
  var selection: js.Array[Double]
}
object Model {
  
  inline def apply(model: typingsJapgolly.forgeViewer.Autodesk.Viewing.Model, selection: js.Array[Double]): Model = {
  ...
  extension [Self <: Model](x: Self) {
    ...
    inline def setModel(value: typingsJapgolly.forgeViewer.Autodesk.Viewing.Model): Self = StObject.set(x, "model", value.asInstanceOf[js.Any])
