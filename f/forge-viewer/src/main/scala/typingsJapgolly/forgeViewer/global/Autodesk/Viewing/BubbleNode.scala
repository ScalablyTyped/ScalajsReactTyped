...
import typingsJapgolly.forgeViewer.Autodesk.Viewing.BubbleNodeSearchProps
...
open class BubbleNode protected ()
  extends StObject
     with typingsJapgolly.forgeViewer.Autodesk.Viewing.BubbleNode {
  def this(rawNode: js.Object) = this()
  def this(rawNode: js.Object, parent: typingsJapgolly.forgeViewer.Autodesk.Viewing.BubbleNode) = this()
}
object BubbleNode {
