...
import typingsJapgolly.forgeViewer.THREE.Plane
import typingsJapgolly.forgeViewer.THREE.Vector2
import typingsJapgolly.forgeViewer.THREE.Vector3
import typingsJapgolly.forgeViewer.anon.DiffMode
import typingsJapgolly.forgeViewer.anon.MinOpacity
...
object Extensions {
  ...
  object CompGeom {
    ...
    open class ComplexPolygon protected ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.CompGeom.ComplexPolygon {
    ...
    open class ContourSet ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.CompGeom.ContourSet
    ...
    open class EdgeSet protected ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.CompGeom.EdgeSet {
    ...
    open class EllipseArc protected ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.CompGeom.EllipseArc {
      def this(
        cx: Double,
        cy: Double,
        rx: Double,
    ...
    open class IntervalTree ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.CompGeom.IntervalTree
    
    @JSGlobal("Autodesk.Extensions.CompGeom.LmvCanvasContext")
    @js.native
    open class LmvCanvasContext ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.CompGeom.LmvCanvasContext
    ...
    open class Path2D ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.CompGeom.Path2D
    
    @JSGlobal("Autodesk.Extensions.CompGeom.Point")
    @js.native
    open class Point ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.CompGeom.Point
    
    @JSGlobal("Autodesk.Extensions.CompGeom.PointError")
    @js.native
    open class PointError ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.CompGeom.PointError
    
    @JSGlobal("Autodesk.Extensions.CompGeom.QuadTree")
    @js.native
    open class QuadTree ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.CompGeom.QuadTree
    ...
    open class Triangle ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.CompGeom.Triangle
    
    @JSGlobal("Autodesk.Extensions.CompGeom.UniquePointList")
    @js.native
    open class UniquePointList ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.CompGeom.UniquePointList
  ...
  open class DataVisualization protected ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Extensions.DataVisualization {
  ...
  object DocumentBrowser {
    ...
    open class DocumentBrowser ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.DocumentBrowser.DocumentBrowser
  }
  ...
  open class Edit2D ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Extensions.Edit2D
  ...
  object Measure {
    ...
    open class MeasureExtension ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.Measure.MeasureExtension
  }
  ...
  object PixelCompare {
    ...
    open class PixelCompare protected ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Extensions.PixelCompare.PixelCompare {
  ...
  open class StringExtractor ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Extensions.StringExtractor
  
  @JSGlobal("Autodesk.Extensions.VisualClusters")
  @js.native
  open class VisualClusters ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Extensions.VisualClusters
}
