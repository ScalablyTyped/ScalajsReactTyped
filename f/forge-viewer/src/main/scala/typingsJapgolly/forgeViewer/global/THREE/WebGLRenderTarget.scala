...
import typingsJapgolly.forgeViewer.THREE.WebGLRenderTargetOptions
...
open class WebGLRenderTarget protected ()
  extends StObject
     with typingsJapgolly.forgeViewer.THREE.WebGLRenderTarget {
  ...
  /* CompleteClass */
  override def copy(source: typingsJapgolly.forgeViewer.THREE.WebGLRenderTarget): typingsJapgolly.forgeViewer.THREE.WebGLRenderTarget = js.native
  
  /* CompleteClass */
  var depthBuffer: Boolean = js.native
  
  /* CompleteClass */
  var depthTexture: typingsJapgolly.forgeViewer.THREE.Texture = js.native
  ...
  /* CompleteClass */
  var scissor: typingsJapgolly.forgeViewer.THREE.Vector4 = js.native
  ...
  /* CompleteClass */
  var texture: typingsJapgolly.forgeViewer.THREE.Texture = js.native
  ...
  /* CompleteClass */
  var viewpport: typingsJapgolly.forgeViewer.THREE.Vector4 = js.native
