...
open class Object3D ()
  extends StObject
     with typingsJapgolly.forgeViewer.THREE.Object3D
object Object3D {
  ...
  @js.native
  def DefaultUp: typingsJapgolly.forgeViewer.THREE.Vector3 = js.native
  inline def DefaultUp_=(x: typingsJapgolly.forgeViewer.THREE.Vector3): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DefaultUp")(x.asInstanceOf[js.Any])
}
