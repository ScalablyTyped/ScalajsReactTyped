...
import typingsJapgolly.forgeViewer.Autodesk.Edit2D.BooleanOps.Operator
import typingsJapgolly.forgeViewer.Autodesk.Viewing.EventDispatcher
import typingsJapgolly.forgeViewer.Autodesk.Viewing.Viewer3D
...
import typingsJapgolly.forgeViewer.anon.FlipY
...
object Edit2D {
  ...
  object BooleanOps {
    ...
    object Operator extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.forgeViewer.Autodesk.Edit2D.BooleanOps.Operator & Double] = js.native
      
      /* 3 */ val Difference: typingsJapgolly.forgeViewer.Autodesk.Edit2D.BooleanOps.Operator.Difference & Double = js.native
      
      /* 1 */ val Intersect: typingsJapgolly.forgeViewer.Autodesk.Edit2D.BooleanOps.Operator.Intersect & Double = js.native
      
      /* 2 */ val Union: typingsJapgolly.forgeViewer.Autodesk.Edit2D.BooleanOps.Operator.Union & Double = js.native
      
      /* 4 */ val Xor: typingsJapgolly.forgeViewer.Autodesk.Edit2D.BooleanOps.Operator.Xor & Double = js.native
    }
    
    inline def apply(
      path1: typingsJapgolly.forgeViewer.Autodesk.Edit2D.PolyBase,
      path2: typingsJapgolly.forgeViewer.Autodesk.Edit2D.PolyBase,
      operator: Operator
    ): typingsJapgolly.forgeViewer.Autodesk.Edit2D.PolyBase = (^.asInstanceOf[js.Dynamic].applyDynamic("apply")(path1.asInstanceOf[js.Any], path2.asInstanceOf[js.Any], operator.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.forgeViewer.Autodesk.Edit2D.PolyBase]
    inline def apply(
      path1: typingsJapgolly.forgeViewer.Autodesk.Edit2D.PolyBase,
      path2: typingsJapgolly.forgeViewer.Autodesk.Edit2D.PolyBase,
      operator: Operator,
      extraOperands: js.Array[typingsJapgolly.forgeViewer.Autodesk.Edit2D.PolyBase]
    ): typingsJapgolly.forgeViewer.Autodesk.Edit2D.PolyBase = (^.asInstanceOf[js.Dynamic].applyDynamic("apply")(path1.asInstanceOf[js.Any], path2.asInstanceOf[js.Any], operator.asInstanceOf[js.Any], extraOperands.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.forgeViewer.Autodesk.Edit2D.PolyBase]
  }
  ...
  object EdgeType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.forgeViewer.Autodesk.Edit2D.EdgeType & Double] = js.native
    
    /* 1 */ val Bezier: typingsJapgolly.forgeViewer.Autodesk.Edit2D.EdgeType.Bezier & Double = js.native
    
    /* 2 */ val Ellipse: typingsJapgolly.forgeViewer.Autodesk.Edit2D.EdgeType.Ellipse & Double = js.native
    
    /* 0 */ val Line: typingsJapgolly.forgeViewer.Autodesk.Edit2D.EdgeType.Line & Double = js.native
  }
  ...
  open class Edit2DContext ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Edit2D.Edit2DContext
  
  @JSGlobal("Autodesk.Edit2D.EditLayer")
  @js.native
  open class EditLayer protected ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Edit2D.EditLayer {
  ...
  object LoopType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.forgeViewer.Autodesk.Edit2D.LoopType & Double] = js.native
    
    /* 0 */ val Empty: typingsJapgolly.forgeViewer.Autodesk.Edit2D.LoopType.Empty & Double = js.native
    
    /* 1 */ val Inner: typingsJapgolly.forgeViewer.Autodesk.Edit2D.LoopType.Inner & Double = js.native
    
    /* 2 */ val Outer: typingsJapgolly.forgeViewer.Autodesk.Edit2D.LoopType.Outer & Double = js.native
    
    /* 3 */ val Overlapping: typingsJapgolly.forgeViewer.Autodesk.Edit2D.LoopType.Overlapping & Double = js.native
  }
  ...
  open class MeasureTransform ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Edit2D.MeasureTransform {
  ...
  open class Path ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Edit2D.Path {
    ...
    def this(points: js.Array[X], isClosed: Boolean, style: typingsJapgolly.forgeViewer.Autodesk.Edit2D.Style) = this()
    def this(points: js.Array[X], isClosed: Unit, style: typingsJapgolly.forgeViewer.Autodesk.Edit2D.Style) = this()
    def this(points: Unit, isClosed: Boolean, style: typingsJapgolly.forgeViewer.Autodesk.Edit2D.Style) = this()
    def this(points: Unit, isClosed: Unit, style: typingsJapgolly.forgeViewer.Autodesk.Edit2D.Style) = this()
  }
  ...
  open class PolyBase ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Edit2D.PolyBase {
    def this(points: js.Array[X]) = this()
    def this(points: js.Array[X], style: typingsJapgolly.forgeViewer.Autodesk.Edit2D.Style) = this()
    def this(points: Unit, style: typingsJapgolly.forgeViewer.Autodesk.Edit2D.Style) = this()
  }
  ...
  open class Polygon ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Edit2D.Polygon {
    def this(points: js.Array[X]) = this()
    def this(points: js.Array[X], style: typingsJapgolly.forgeViewer.Autodesk.Edit2D.Style) = this()
    def this(points: Unit, style: typingsJapgolly.forgeViewer.Autodesk.Edit2D.Style) = this()
  }
  ...
  open class Shape ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Edit2D.Shape {
    def this(style: typingsJapgolly.forgeViewer.Autodesk.Edit2D.Style) = this()
  }
  ...
  open class Style ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Edit2D.Style {
    ...
    /* CompleteClass */
    override def copy(from: typingsJapgolly.forgeViewer.Autodesk.Edit2D.Style): typingsJapgolly.forgeViewer.Autodesk.Edit2D.Style = js.native
