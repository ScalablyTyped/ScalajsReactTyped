...
import typingsJapgolly.forgeViewer.Autodesk.Viewing.Private.Viewer3DImpl
import typingsJapgolly.forgeViewer.anon.AddEventListener
import typingsJapgolly.forgeViewer.anon.EnableBrowserNavigation
import typingsJapgolly.forgeViewer.anon.ForceSnapEdges
...
object Extensions {
  ...
  object Multipage {
    ...
    open class MultipageExtension protected ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Viewing.Extensions.Multipage.MultipageExtension {
      def this(viewer: typingsJapgolly.forgeViewer.Autodesk.Viewing.Viewer3D) = this()
      def this(viewer: typingsJapgolly.forgeViewer.Autodesk.Viewing.Viewer3D, options: Any) = this()
    }
  }
  ...
  object PDF {
    ...
    open class PDFExtension protected ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Viewing.Extension {
      def this(viewer: typingsJapgolly.forgeViewer.Autodesk.Viewing.Viewer3D) = this()
      def this(viewer: typingsJapgolly.forgeViewer.Autodesk.Viewing.Viewer3D, options: EnableBrowserNavigation) = this()
    }
    ...
    open class PDFLoader protected ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Viewing.Extensions.PDF.PDFLoader {
      def this(parent: Viewer3DImpl) = this()
      
      /* CompleteClass */
      override def createPDFDocument(pdf: Any): typingsJapgolly.forgeViewer.Autodesk.Viewing.Document = js.native
  ...
  object Snapping {
    ...
    open class Snapper protected ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Viewing.Extensions.Snapping.Snapper {
      def this(viewer: typingsJapgolly.forgeViewer.Autodesk.Viewing.Viewer3D) = this()
      def this(viewer: typingsJapgolly.forgeViewer.Autodesk.Viewing.Viewer3D, options: ForceSnapEdges) = this()
      ...
      /* CompleteClass */
      var indicator: typingsJapgolly.forgeViewer.Autodesk.Viewing.Extensions.Snapping.SnapperIndicator = js.native
    ...
    open class SnapperIndicator protected ()
      extends StObject
         with typingsJapgolly.forgeViewer.Autodesk.Viewing.Extensions.Snapping.SnapperIndicator {
      def this(
        viewer: typingsJapgolly.forgeViewer.Autodesk.Viewing.Viewer3D,
        snapper: typingsJapgolly.forgeViewer.Autodesk.Viewing.Extensions.Snapping.Snapper
      ) = this()
  ...
  open class ViewerModelStructurePanel protected ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.Extensions.ViewerModelStructurePanel {
  ...
  open class ViewerPropertyPanel protected ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.Extensions.ViewerPropertyPanel {
    def this(viewer: typingsJapgolly.forgeViewer.Autodesk.Viewing.GuiViewer3D) = this()
  }
  
  inline def generateDefaultViewerHandlerOptions(viewer: typingsJapgolly.forgeViewer.Autodesk.Viewing.GuiViewer3D): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("generateDefaultViewerHandlerOptions")(viewer.asInstanceOf[js.Any]).asInstanceOf[Any]
}
