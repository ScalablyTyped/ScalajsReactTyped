...
import typingsJapgolly.forgeViewer.anon.AutoDetectAecModelData
...
object AEC {
  ...
  open class FloorSelector protected ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.AEC.FloorSelector {
  ...
  open class LevelsExtension protected ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.AEC.LevelsExtension {
    def this(viewer: GuiViewer3D) = this()
