...
object EventUtils {
  ...
  inline def waitUntilGeometryLoaded(viewer: typingsJapgolly.forgeViewer.Autodesk.Viewing.Viewer3D): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("waitUntilGeometryLoaded")(viewer.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  inline def waitUntilModelAdded(viewer: typingsJapgolly.forgeViewer.Autodesk.Viewing.Viewer3D): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("waitUntilModelAdded")(viewer.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  inline def waitUntilTransitionEnded(viewer: typingsJapgolly.forgeViewer.Autodesk.Viewing.Viewer3D): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("waitUntilTransitionEnded")(viewer.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
}
