...
import typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.ControlOptions
import typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.DockingPanelOptions
import typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.MenuItem
import typingsJapgolly.forgeViewer.forgeViewerStrings.ButtonDotStateChanged
import typingsJapgolly.forgeViewer.forgeViewerStrings.ControlDotCollapsedChanged
import typingsJapgolly.forgeViewer.forgeViewerStrings.ControlDotVisibilityChanged
import typingsJapgolly.forgeViewer.forgeViewerStrings.RadioButtonGroupDotActiveButtonChanged
import typingsJapgolly.forgeViewer.forgeViewerStrings.click
...
object UI {
  ...
  open class Button protected ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.Button {
  ...
  object Button {
    ...
    object State extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.Button.State & Double] = js.native
      
      /* 0 */ val ACTIVE: typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.Button.State.ACTIVE & Double = js.native
      
      /* 2 */ val DISABLED: typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.Button.State.DISABLED & Double = js.native
      
      /* 1 */ val INACTIVE: typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.Button.State.INACTIVE & Double = js.native
    }
  }
  ...
  open class ComboButton protected ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.ComboButton {
    def this(id: String) = this()
    def this(id: String, options: js.Object) = this()
  }
  ...
  open class Control ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.Control {
    def this(id: String) = this()
  ...
  open class ControlEventArgs ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.ControlEventArgs {
  ...
  open class ControlGroup ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.ControlGroup
  
  @JSGlobal("Autodesk.Viewing.UI.DockingPanel")
  @js.native
  open class DockingPanel protected ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.DockingPanel {
  ...
  open class LayersPanel ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.LayersPanel
  
  @JSGlobal("Autodesk.Viewing.UI.ModelStructurePanel")
  @js.native
  open class ModelStructurePanel ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.ModelStructurePanel
  
  @JSGlobal("Autodesk.Viewing.UI.ObjectContextMenu")
  @js.native
  open class ObjectContextMenu protected ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.ObjectContextMenu {
  ...
  open class PropertyPanel ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.PropertyPanel
  
  @JSGlobal("Autodesk.Viewing.UI.RadioButtonGroup")
  @js.native
  open class RadioButtonGroup protected ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.RadioButtonGroup {
    def this(id: String) = this()
    def this(id: String, options: js.Object) = this()
  }
  ...
  open class SettingsPanel ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.SettingsPanel
  ...
  open class Tree protected ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.Tree {
    def this(
      delegate: typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.TreeDelegate,
      root: js.Object,
  ...
  open class TreeDelegate ()
    extends StObject
       with typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.TreeDelegate {
    ...
    /* CompleteClass */
    override def onTreeNodeClick(tree: typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.Tree, node: js.Object, event: Event): Unit = js.native
    
    /* CompleteClass */
    override def onTreeNodeDoubleClick(tree: typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.Tree, node: js.Object, event: Event): Unit = js.native
    
    /* CompleteClass */
    override def onTreeNodeIconClick(tree: typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.Tree, node: js.Object, event: Event): Unit = js.native
    
    /* CompleteClass */
    override def onTreeNodeRightClick(tree: typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.Tree, node: js.Object, event: Event): Unit = js.native
