...
import typingsJapgolly.forgeViewer.Autodesk.Viewing.Properties
...
open class Document protected ()
  extends StObject
     with typingsJapgolly.forgeViewer.Autodesk.Viewing.Document {
...
object Document {
  ...
  /* static member */
  inline def getAecModelData(node: typingsJapgolly.forgeViewer.Autodesk.Viewing.BubbleNode): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getAecModelData")(node.asInstanceOf[js.Any]).asInstanceOf[Any]
  ...
  inline def load(
    documentId: String,
    successCallback: js.Function1[/* doc */ typingsJapgolly.forgeViewer.Autodesk.Viewing.Document, Unit],
    errorCallback: js.Function3[
      /* errorCode */ typingsJapgolly.forgeViewer.Autodesk.Viewing.ErrorCodes, 
      /* errorMsg */ String, 
