...
object WebGLCapabilities {
  ...
  inline def apply(
    ...
    getMaxAnisotropy: CallbackTo[Double],
  ...
  extension [Self <: WebGLCapabilities](x: Self) {
    ...
    inline def setGetMaxAnisotropy(value: CallbackTo[Double]): Self = StObject.set(x, "getMaxAnisotropy", value.toJsFn)
