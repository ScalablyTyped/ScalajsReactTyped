...
object WebGLRenderTarget {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(anisotropy = anisotropy.asInstanceOf[js.Any], copy = js.Any.fromFunction1(copy), depthBuffer = depthBuffer.asInstanceOf[js.Any], depthTexture = depthTexture.asInstanceOf[js.Any], dispose = dispose.toJsFn, format = format.asInstanceOf[js.Any], generateMipmaps = generateMipmaps.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], magFilter = magFilter.asInstanceOf[js.Any], minFilter = minFilter.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any], repeat = repeat.asInstanceOf[js.Any], scissor = scissor.asInstanceOf[js.Any], scissorTest = scissorTest.asInstanceOf[js.Any], setSize = js.Any.fromFunction2((t0: Double, t1: Double) => (setSize(t0, t1)).runNow()), stencilBuffer = stencilBuffer.asInstanceOf[js.Any], texture = texture.asInstanceOf[js.Any], uuid = uuid.asInstanceOf[js.Any], viewpport = viewpport.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any], wrapS = wrapS.asInstanceOf[js.Any], wrapT = wrapT.asInstanceOf[js.Any])
