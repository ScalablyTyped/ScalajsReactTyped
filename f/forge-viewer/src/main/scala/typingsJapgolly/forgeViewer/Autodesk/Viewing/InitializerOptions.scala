...
object InitializerOptions {
  ...
  extension [Self <: InitializerOptions](x: Self) {
    ...
    inline def setGetAccessToken(
      value: /* callback */ js.UndefOr[js.Function2[/* accessToken */ String, /* expires */ Double, Unit]] => Callback
    ): Self = StObject.set(x, "getAccessToken", js.Any.fromFunction1((t0: /* callback */ js.UndefOr[js.Function2[/* accessToken */ String, /* expires */ Double, Unit]]) => value(t0).runNow()))
    ...
    inline def setRefreshToken(
      value: /* callback */ js.UndefOr[js.Function2[/* accessToken */ String, /* expires */ Double, Unit]] => Callback
    ): Self = StObject.set(x, "refreshToken", js.Any.fromFunction1((t0: /* callback */ js.UndefOr[js.Function2[/* accessToken */ String, /* expires */ Double, Unit]]) => value(t0).runNow()))
