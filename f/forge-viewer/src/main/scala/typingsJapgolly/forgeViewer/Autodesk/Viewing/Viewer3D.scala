...
import typingsJapgolly.forgeViewer.Autodesk.Viewing.Private.Dimensions
import typingsJapgolly.forgeViewer.Autodesk.Viewing.Private.HitTestResult
import typingsJapgolly.forgeViewer.Autodesk.Viewing.Private.Viewer3DImpl
import typingsJapgolly.forgeViewer.Autodesk.Viewing.Private.ViewerPreferences
import typingsJapgolly.forgeViewer.Autodesk.Viewing.UI.ToolBar
...
import typingsJapgolly.forgeViewer.THREE.Vector4
import typingsJapgolly.forgeViewer.anon.Geometry
...
trait Viewer3D extends StObject {
  ...
  def getAggregateSelection(): js.Array[typingsJapgolly.forgeViewer.anon.Model] = js.native
  def getAggregateSelection(callback: js.Function2[/* model */ Model, /* dbId */ Double, Unit]): js.Array[typingsJapgolly.forgeViewer.anon.Model] = js.native
