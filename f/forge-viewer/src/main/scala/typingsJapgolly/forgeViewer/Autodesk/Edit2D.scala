...
object Edit2D {
  ...
  object MeasureTransform {
    ...
    inline def apply(apply: Vector2 => Callback): MeasureTransform = {
      val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1((t0: Vector2) => apply(t0).runNow()))
      __obj.asInstanceOf[MeasureTransform]
    }
    
    extension [Self <: MeasureTransform](x: Self) {
      
      inline def setApply(value: Vector2 => Callback): Self = StObject.set(x, "apply", js.Any.fromFunction1((t0: Vector2) => value(t0).runNow()))
    }
  }
  ...
  object Style {
    ...
    inline def apply(
      ...
      lineStyle: Double,
      lineWidth: Double,
      setFillColor: (Double, Double, Double) => Callback,
      setLineColor: (Double, Double, Double) => Callback
    ): Style = {
      val __obj = js.Dynamic.literal(color = color.asInstanceOf[js.Any], copy = js.Any.fromFunction1(copy), fillAlpha = fillAlpha.asInstanceOf[js.Any], fillColor = fillColor.asInstanceOf[js.Any], lineAlpha = lineAlpha.asInstanceOf[js.Any], lineColor = lineColor.asInstanceOf[js.Any], lineStyle = lineStyle.asInstanceOf[js.Any], lineWidth = lineWidth.asInstanceOf[js.Any], setFillColor = js.Any.fromFunction3((t0: Double, t1: Double, t2: Double) => (setFillColor(t0, t1, t2)).runNow()), setLineColor = js.Any.fromFunction3((t0: Double, t1: Double, t2: Double) => (setLineColor(t0, t1, t2)).runNow()))
    ...
    extension [Self <: Style](x: Self) {
      ...
      inline def setSetFillColor(value: (Double, Double, Double) => Callback): Self = StObject.set(x, "setFillColor", js.Any.fromFunction3((t0: Double, t1: Double, t2: Double) => (value(t0, t1, t2)).runNow()))
      
      inline def setSetLineColor(value: (Double, Double, Double) => Callback): Self = StObject.set(x, "setLineColor", js.Any.fromFunction3((t0: Double, t1: Double, t2: Double) => (value(t0, t1, t2)).runNow()))
    }
  }
