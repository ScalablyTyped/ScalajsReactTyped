package typingsJapgolly.fastbitset

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.fastbitset.fastbitsetInts.`0`
import typingsJapgolly.fastbitset.fastbitsetInts.`1`
...
object mod {
  ...
  object FastBitSet {
    ...
    extension [Self <: FastBitSet](x: Self) {
      ...
      inline def setFlip(value: Double => Callback): Self = StObject.set(x, "flip", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      
      inline def setForEach(value: js.Function1[/* index */ Double, Unit] => Callback): Self = StObject.set(x, "forEach", js.Any.fromFunction1((t0: js.Function1[/* index */ Double, Unit]) => value(t0).runNow()))
      ...
      inline def setTrim(value: Callback): Self = StObject.set(x, "trim", value.toJsFn)
