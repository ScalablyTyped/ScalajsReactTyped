...
import typingsJapgolly.fixturifyProject.mod.LinkParams
...
object anon {
  ...
  trait Project
    ...
    var project: typingsJapgolly.fixturifyProject.mod.Project
    
    var requestedRange: js.UndefOr[String] = js.undefined
  }
  object Project {
    
    inline def apply(project: typingsJapgolly.fixturifyProject.mod.Project): Project = {
    ...
    extension [Self <: Project](x: Self) {
      ...
      inline def setProject(value: typingsJapgolly.fixturifyProject.mod.Project): Self = StObject.set(x, "project", value.asInstanceOf[js.Any])
