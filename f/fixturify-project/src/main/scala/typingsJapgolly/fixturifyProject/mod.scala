package typingsJapgolly.fixturifyProject

import typingsJapgolly.fixturify.mod.DirJSON
import typingsJapgolly.fixturifyProject.anon.OmitProjectArgsname
import typingsJapgolly.fixturifyProject.anon.OmitProjectArgsnameversio
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fixturifyProject.anon.BaseDir
    - typingsJapgolly.fixturifyProject.anon.RequestedRange
    - typingsJapgolly.fixturifyProject.anon.Project
  */
  trait LinkParams extends StObject
  object LinkParams {
    
    inline def BaseDir(baseDir: String): typingsJapgolly.fixturifyProject.anon.BaseDir = {
      val __obj = js.Dynamic.literal(baseDir = baseDir.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.fixturifyProject.anon.BaseDir]
    }
    
    inline def Project(project: typingsJapgolly.fixturifyProject.mod.Project): typingsJapgolly.fixturifyProject.anon.Project = {
      val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.fixturifyProject.anon.Project]
    }
    
    inline def RequestedRange(target: String): typingsJapgolly.fixturifyProject.anon.RequestedRange = {
      val __obj = js.Dynamic.literal(target = target.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.fixturifyProject.anon.RequestedRange]
    }
  }
  
  type PackageJson = typingsJapgolly.typeFest.sourcePackageJsonMod.PackageJson & (Record[String, Any])
