...
trait AnonBodyClaimResponse extends js.Object {
  ...
  var resourceType: typingsJapgolly.fhirKitClient.fhirKitClientStrings.ClaimResponse
}
...
object AnonBodyClaimResponse {
  ...
  def apply(
    body: ClaimResponse,
    resourceType: typingsJapgolly.fhirKitClient.fhirKitClientStrings.ClaimResponse,
