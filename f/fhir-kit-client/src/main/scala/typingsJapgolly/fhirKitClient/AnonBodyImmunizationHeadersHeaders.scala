...
trait AnonBodyImmunizationHeadersHeaders extends js.Object {
  ...
  var resourceType: typingsJapgolly.fhirKitClient.fhirKitClientStrings.Immunization
}
...
object AnonBodyImmunizationHeadersHeaders {
  ...
  def apply(
    body: Immunization,
    id: String,
    resourceType: typingsJapgolly.fhirKitClient.fhirKitClientStrings.Immunization,
