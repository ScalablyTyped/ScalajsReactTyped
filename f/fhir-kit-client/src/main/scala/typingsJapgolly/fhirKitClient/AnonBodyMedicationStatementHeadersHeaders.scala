...
trait AnonBodyMedicationStatementHeadersHeaders extends js.Object {
  ...
  var resourceType: typingsJapgolly.fhirKitClient.fhirKitClientStrings.MedicationStatement
}
...
object AnonBodyMedicationStatementHeadersHeaders {
  ...
  def apply(
    ...
    id: String,
    resourceType: typingsJapgolly.fhirKitClient.fhirKitClientStrings.MedicationStatement,
