...
trait AnonBodyMessageDefinition extends js.Object {
  ...
  var resourceType: typingsJapgolly.fhirKitClient.fhirKitClientStrings.MessageDefinition
}
...
object AnonBodyMessageDefinition {
  ...
  def apply(
    ...
    resourceType: typingsJapgolly.fhirKitClient.fhirKitClientStrings.MessageDefinition,
