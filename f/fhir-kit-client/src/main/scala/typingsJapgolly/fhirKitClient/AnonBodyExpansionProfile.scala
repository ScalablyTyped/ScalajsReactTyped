...
trait AnonBodyExpansionProfile extends js.Object {
  ...
  var resourceType: typingsJapgolly.fhirKitClient.fhirKitClientStrings.ExpansionProfile
}
...
object AnonBodyExpansionProfile {
  ...
  def apply(
    ...
    resourceType: typingsJapgolly.fhirKitClient.fhirKitClientStrings.ExpansionProfile,
