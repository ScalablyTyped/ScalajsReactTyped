...
import typingsJapgolly.fhir.fhir.BundleEntry
import typingsJapgolly.fhir.fhir.BundleLink
import typingsJapgolly.fhir.fhir.Element
import typingsJapgolly.fhir.fhir.Identifier
import typingsJapgolly.fhir.fhir.Meta
import typingsJapgolly.fhir.fhir.Signature
import typingsJapgolly.fhir.fhir.code
import typingsJapgolly.fhir.fhir.id
import typingsJapgolly.fhir.fhir.unsignedInt
import typingsJapgolly.fhir.fhir.uri
import typingsJapgolly.fhirKitClient.fhirKitClientStrings.searchset
...
trait Bundletypesearchset extends js.Object {
  ...
  /**
    ...
    */
  var id: js.UndefOr[typingsJapgolly.fhir.fhir.id] = js.undefined
  /**
