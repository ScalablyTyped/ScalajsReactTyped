...
version := "1.1-dt-20200225Z-8b2fe3"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "fhir" % "0.0-unknown-dt-20200226Z-fda2c8",
  "org.scalablytyped.japgolly" %%% "form-data" % "2.5.1-b08b8b",
  "org.scalablytyped.japgolly" %%% "json-patch" % "0.0-unknown-dt-20200226Z-ec0a39",
