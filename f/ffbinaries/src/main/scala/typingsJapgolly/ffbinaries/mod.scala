package typingsJapgolly.ffbinaries

import japgolly.scalajs.react.Callback
import typingsJapgolly.ffbinaries.anon.Arch
import typingsJapgolly.ffbinaries.anon.Filename
import typingsJapgolly.ffbinaries.anon.KinPlatformffmpegstringff
import typingsJapgolly.ffbinaries.ffbinariesBooleans.`false`
import typingsJapgolly.ffbinaries.ffbinariesBooleans.`true`
import typingsJapgolly.ffbinaries.ffbinariesStrings.DONE_CLEAN
import typingsJapgolly.ffbinaries.ffbinariesStrings.DONE_FROM_CACHE
import typingsJapgolly.ffbinaries.ffbinariesStrings.FILE_EXISTS
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ffbinaries.ffbinariesStrings.ffmpeg
    - typingsJapgolly.ffbinaries.ffbinariesStrings.ffprobe
    - typingsJapgolly.ffbinaries.ffbinariesStrings.ffserver
    - typingsJapgolly.ffbinaries.ffbinariesStrings.ffplay
  */
  trait Component extends StObject
  object Component {
    
    inline def ffmpeg: typingsJapgolly.ffbinaries.ffbinariesStrings.ffmpeg = "ffmpeg".asInstanceOf[typingsJapgolly.ffbinaries.ffbinariesStrings.ffmpeg]
    
    inline def ffplay: typingsJapgolly.ffbinaries.ffbinariesStrings.ffplay = "ffplay".asInstanceOf[typingsJapgolly.ffbinaries.ffbinariesStrings.ffplay]
    
    inline def ffprobe: typingsJapgolly.ffbinaries.ffbinariesStrings.ffprobe = "ffprobe".asInstanceOf[typingsJapgolly.ffbinaries.ffbinariesStrings.ffprobe]
    
    inline def ffserver: typingsJapgolly.ffbinaries.ffbinariesStrings.ffserver = "ffserver".asInstanceOf[typingsJapgolly.ffbinaries.ffbinariesStrings.ffserver]
  }
  ...
  object DownloadOptions {
    ...
    extension [Self <: DownloadOptions](x: Self) {
      ...
      inline def setTickerFn(value: /* tickData */ Filename => Callback): Self = StObject.set(x, "tickerFn", js.Any.fromFunction1((t0: /* tickData */ Filename) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ffbinaries.mod.DownloadResultFileExists
    - typingsJapgolly.ffbinaries.mod.DownloadResultFromCache
    - typingsJapgolly.ffbinaries.mod.DownloadResultClean
  */
  trait DownloadResult extends StObject
  object DownloadResult {
    
    inline def DownloadResultClean(filename: String, path: String, size: String, status: String): typingsJapgolly.ffbinaries.mod.DownloadResultClean = {
      ...
      __obj.asInstanceOf[typingsJapgolly.ffbinaries.mod.DownloadResultClean]
    }
    
    inline def DownloadResultFileExists(filename: String, path: String, status: String): typingsJapgolly.ffbinaries.mod.DownloadResultFileExists = {
      ...
      __obj.asInstanceOf[typingsJapgolly.ffbinaries.mod.DownloadResultFileExists]
    }
    
    inline def DownloadResultFromCache(filename: String, path: String, status: String): typingsJapgolly.ffbinaries.mod.DownloadResultFromCache = {
      ...
      __obj.asInstanceOf[typingsJapgolly.ffbinaries.mod.DownloadResultFromCache]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ffbinaries.mod.LocateResultFound
    - typingsJapgolly.ffbinaries.mod.LocateResultNotFound
  */
  trait LocateResult extends StObject
  object LocateResult {
    
    inline def LocateResultFound(isExecutable: Boolean, path: String, version: String): typingsJapgolly.ffbinaries.mod.LocateResultFound = {
      ...
      __obj.asInstanceOf[typingsJapgolly.ffbinaries.mod.LocateResultFound]
    }
    
    inline def LocateResultNotFound(path: Null, version: Null): typingsJapgolly.ffbinaries.mod.LocateResultNotFound = {
      ...
      __obj.asInstanceOf[typingsJapgolly.ffbinaries.mod.LocateResultNotFound]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ffbinaries.ffbinariesStrings.`osx-64`
    - typingsJapgolly.ffbinaries.ffbinariesStrings.`linux-32`
    - typingsJapgolly.ffbinaries.ffbinariesStrings.`linux-64`
    - typingsJapgolly.ffbinaries.ffbinariesStrings.`linux-armel`
    - typingsJapgolly.ffbinaries.ffbinariesStrings.`linux-armhf`
    - typingsJapgolly.ffbinaries.ffbinariesStrings.`windows-32`
    - typingsJapgolly.ffbinaries.ffbinariesStrings.`windows-64`
  */
  trait Platform extends StObject
  object Platform {
    
    inline def `linux-32`: typingsJapgolly.ffbinaries.ffbinariesStrings.`linux-32` = "linux-32".asInstanceOf[typingsJapgolly.ffbinaries.ffbinariesStrings.`linux-32`]
    
    inline def `linux-64`: typingsJapgolly.ffbinaries.ffbinariesStrings.`linux-64` = "linux-64".asInstanceOf[typingsJapgolly.ffbinaries.ffbinariesStrings.`linux-64`]
    
    inline def `linux-armel`: typingsJapgolly.ffbinaries.ffbinariesStrings.`linux-armel` = "linux-armel".asInstanceOf[typingsJapgolly.ffbinaries.ffbinariesStrings.`linux-armel`]
    
    inline def `linux-armhf`: typingsJapgolly.ffbinaries.ffbinariesStrings.`linux-armhf` = "linux-armhf".asInstanceOf[typingsJapgolly.ffbinaries.ffbinariesStrings.`linux-armhf`]
    
    inline def `osx-64`: typingsJapgolly.ffbinaries.ffbinariesStrings.`osx-64` = "osx-64".asInstanceOf[typingsJapgolly.ffbinaries.ffbinariesStrings.`osx-64`]
    
    inline def `windows-32`: typingsJapgolly.ffbinaries.ffbinariesStrings.`windows-32` = "windows-32".asInstanceOf[typingsJapgolly.ffbinaries.ffbinariesStrings.`windows-32`]
    
    inline def `windows-64`: typingsJapgolly.ffbinaries.ffbinariesStrings.`windows-64` = "windows-64".asInstanceOf[typingsJapgolly.ffbinaries.ffbinariesStrings.`windows-64`]
  }
