package typingsJapgolly.fbWatchman
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.fbWatchman.fbWatchmanStrings.unilateralTags
    - typingsJapgolly.fbWatchman.fbWatchmanStrings.log
  */
  trait UnilateralTags extends StObject
  object UnilateralTags {
    
    inline def log: typingsJapgolly.fbWatchman.fbWatchmanStrings.log = "log".asInstanceOf[typingsJapgolly.fbWatchman.fbWatchmanStrings.log]
    
    inline def unilateralTags: typingsJapgolly.fbWatchman.fbWatchmanStrings.unilateralTags = "unilateralTags".asInstanceOf[typingsJapgolly.fbWatchman.fbWatchmanStrings.unilateralTags]
  }
