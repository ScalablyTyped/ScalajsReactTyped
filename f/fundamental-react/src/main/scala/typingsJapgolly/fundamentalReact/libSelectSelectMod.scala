...
import typingsJapgolly.fundamentalReact.fundamentalReactStrings.Select
...
object libSelectSelectMod {
  ...
  object SelectProps {
    ...
    extension [Self <: SelectProps](x: Self) {
      ...
      inline def setOnBlur(value: /* event */ ReactFocusEventFrom[HTMLDivElement] => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: /* event */ ReactFocusEventFrom[HTMLDivElement]) => value(t0).runNow()))
