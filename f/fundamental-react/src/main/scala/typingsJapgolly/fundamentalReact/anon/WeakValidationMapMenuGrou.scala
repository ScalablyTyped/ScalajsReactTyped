...
trait WeakValidationMapMenuGrou extends StObject {
  ...
  var titleProps: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: null extends {[x: string] : any} | undefined ? react.react.Validator<{[x: string] : any} | undefined | null | undefined> : undefined extends {[x: string] : any} | undefined ? react.react.Validator<{[x: string] : any} | undefined | null | undefined> : react.react.Validator<{[x: string] : any} | undefined> */ js.Any
  ] = js.undefined
...
object WeakValidationMapMenuGrou {
  ...
  inline def apply(): WeakValidationMapMenuGrou = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapMenuGrou]
  }
  
  extension [Self <: WeakValidationMapMenuGrou](x: Self) {
    ...
    ): Self = StObject.set(x, "headingLevel", value.asInstanceOf[js.Any])
    ...
    inline def setTitleProps(
      value: /* import warning: importer.ImportType#apply Failed type conversion: null extends {[x: string] : any} | undefined ? react.react.Validator<{[x: string] : any} | undefined | null | undefined> : undefined extends {[x: string] : any} | undefined ? react.react.Validator<{[x: string] : any} | undefined | null | undefined> : react.react.Validator<{[x: string] : any} | undefined> */ js.Any
    ): Self = StObject.set(x, "titleProps", value.asInstanceOf[js.Any])
