...
trait PartialTableProps extends StObject {
  ...
  var headers: js.UndefOr[js.Array[String | Node]] = js.undefined
...
object PartialTableProps {
  ...
  extension [Self <: PartialTableProps](x: Self) {
    ...
    inline def setTableBodyRowPropsFunction2(value: (/* rowData */ js.Array[String], /* index */ Double) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "tableBodyRowProps", js.Any.fromFunction2((t0: /* rowData */ js.Array[String], t1: /* index */ Double) => (value(t0, t1)).runNow()))
