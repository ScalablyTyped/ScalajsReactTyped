...
trait WeakValidationMapSwitchPr extends StObject {
  ...
  var internalLabels: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: null extends {  checked :any | undefined,   unchecked :any | undefined} | undefined ? react.react.Validator<{  checked :any | undefined,   unchecked :any | undefined} | undefined | null | undefined> : undefined extends {  checked :any | undefined,   unchecked :any | undefined} | undefined ? react.react.Validator<{  checked :any | undefined,   unchecked :any | undefined} | undefined | null | undefined> : react.react.Validator<{  checked :any | undefined,   unchecked :any | undefined} | undefined> */ js.Any
  ] = js.undefined
  
  var labelProps: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: null extends any | undefined ? react.react.Validator<any | undefined | null | undefined> : undefined extends any | undefined ? react.react.Validator<any | undefined | null | undefined> : react.react.Validator<any | undefined> */ js.Any
  ] = js.undefined
...
object WeakValidationMapSwitchPr {
  ...
  inline def apply(): WeakValidationMapSwitchPr = {
  ...
  extension [Self <: WeakValidationMapSwitchPr](x: Self) {
    ...
    ): Self = StObject.set(x, "inputProps", value.asInstanceOf[js.Any])
    
    inline def setInputPropsUndefined: Self = StObject.set(x, "inputProps", js.undefined)
    
    inline def setInternalLabels(
      value: /* import warning: importer.ImportType#apply Failed type conversion: null extends {  checked :any | undefined,   unchecked :any | undefined} | undefined ? react.react.Validator<{  checked :any | undefined,   unchecked :any | undefined} | undefined | null | undefined> : undefined extends {  checked :any | undefined,   unchecked :any | undefined} | undefined ? react.react.Validator<{  checked :any | undefined,   unchecked :any | undefined} | undefined | null | undefined> : react.react.Validator<{  checked :any | undefined,   unchecked :any | undefined} | undefined> */ js.Any
    ): Self = StObject.set(x, "internalLabels", value.asInstanceOf[js.Any])
    
    inline def setInternalLabelsUndefined: Self = StObject.set(x, "internalLabels", js.undefined)
    
    inline def setLabelProps(
      value: /* import warning: importer.ImportType#apply Failed type conversion: null extends any | undefined ? react.react.Validator<any | undefined | null | undefined> : undefined extends any | undefined ? react.react.Validator<any | undefined | null | undefined> : react.react.Validator<any | undefined> */ js.Any
    ): Self = StObject.set(x, "labelProps", value.asInstanceOf[js.Any])
