...
object PartialStepInputProps {
  ...
  extension [Self <: PartialStepInputProps](x: Self) {
    ...
    inline def setOnChange(value: /* stepValue */ Double => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* stepValue */ Double) => value(t0).runNow()))
