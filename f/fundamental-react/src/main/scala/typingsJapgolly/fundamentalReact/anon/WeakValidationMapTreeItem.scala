...
/* Inlined react.react.WeakValidationMap<fundamental-react.fundamental-react/lib/TreeView/TreeView.TreeItemProps> */
trait WeakValidationMapTreeItem extends StObject {
...
object WeakValidationMapTreeItem {
  
  inline def apply(): WeakValidationMapTreeItem = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapTreeItem]
  }
  
  extension [Self <: WeakValidationMapTreeItem](x: Self) {
