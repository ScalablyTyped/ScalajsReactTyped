...
/* Inlined react.react.WeakValidationMap<fundamental-react.fundamental-react/lib/Breadcrumb/Breadcrumb.BreadcrumbItemProps> */
trait WeakValidationMapBreadcruAbout extends StObject {
...
object WeakValidationMapBreadcruAbout {
  
  inline def apply(): WeakValidationMapBreadcruAbout = {
