...
/* Inlined react.react.WeakValidationMap<fundamental-react.fundamental-react/lib/Menu/Menu.MenuProps> */
trait WeakValidationMapMenuProp extends StObject {
...
object WeakValidationMapMenuProp {
  
  inline def apply(): WeakValidationMapMenuProp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapMenuProp]
  }
  
  extension [Self <: WeakValidationMapMenuProp](x: Self) {
    ...
    ): Self = StObject.set(x, "addonBefore", value.asInstanceOf[js.Any])
