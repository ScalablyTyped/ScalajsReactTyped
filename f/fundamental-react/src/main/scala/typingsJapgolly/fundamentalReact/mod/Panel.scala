...
import typingsJapgolly.fundamentalReact.panelMod.PanelProps
...
object Panel extends js.Object {
  ...
  var displayName: js.UndefOr[typingsJapgolly.fundamentalReact.fundamentalReactStrings.Panel | String] = js.native
