...
import typingsJapgolly.fundamentalReact.anon.ButtonProps
import typingsJapgolly.fundamentalReact.anon.InputProps
...
object libLocalizationEditorLocalizationEditorMod {
