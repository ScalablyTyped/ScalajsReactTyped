...
/* Inlined react.react.WeakValidationMap<fundamental-react.fundamental-react/lib/ActionBar/ActionBar.ActionBarHeaderProps> */
trait WeakValidationMapActionBaAriaactivedescendant extends js.Object {
  ...
  var descriptionProps: js.UndefOr[Validator[js.UndefOr[Null | StringDictionary[_]]]] = js.undefined
  ...
  var headingLevel: js.UndefOr[Validator[js.UndefOr[`1` | `2` | `3` | `4` | `5` | `6` | Null]]] = js.undefined
...
object WeakValidationMapActionBaAriaactivedescendant {
  @scala.inline
  def apply(
    ...
    descriptionProps: Validator[js.UndefOr[Null | StringDictionary[_]]] = null,
    dir: Validator[js.UndefOr[Null | String]] = null,
    draggable: Validator[js.UndefOr[Booleanish | Null]] = null,
    headingLevel: Validator[js.UndefOr[`1` | `2` | `3` | `4` | `5` | `6` | Null]] = null,
  ...
  ): WeakValidationMapActionBaAriaactivedescendant = {
    ...
    __obj.asInstanceOf[WeakValidationMapActionBaAriaactivedescendant]
  }
}
