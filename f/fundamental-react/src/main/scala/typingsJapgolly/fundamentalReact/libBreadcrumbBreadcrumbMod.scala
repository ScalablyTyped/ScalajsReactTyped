...
object libBreadcrumbBreadcrumbMod {
  ...
  object default {
    ...
    @JSImport("fundamental-react/lib/Breadcrumb/Breadcrumb", "default.Item")
    @js.native
    ...
    @JSImport("fundamental-react/lib/Breadcrumb/Breadcrumb", "default.contextTypes")
    @js.native
    def contextTypes: js.UndefOr[ValidationMap[Any]] = js.native
    inline def contextTypes_=(x: js.UndefOr[ValidationMap[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("contextTypes")(x.asInstanceOf[js.Any])
    
    @JSImport("fundamental-react/lib/Breadcrumb/Breadcrumb", "default.defaultProps")
    @js.native
    ...
    @JSImport("fundamental-react/lib/Breadcrumb/Breadcrumb", "default.displayName")
    @js.native
    def displayName: js.UndefOr[Breadcrumb | String] = js.native
    inline def displayName_=(x: js.UndefOr[Breadcrumb | String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("fundamental-react/lib/Breadcrumb/Breadcrumb", "default.propTypes")
    @js.native
  ...
  /* Inlined {  disableStyles :boolean | undefined,   ref :react.react.Ref<std.HTMLUListElement> | undefined} & std.Pick<react.react.HTMLAttributes<std.HTMLUListElement>, std.Exclude<keyof react.react.HTMLAttributes<std.HTMLUListElement>, 'className'>> */
