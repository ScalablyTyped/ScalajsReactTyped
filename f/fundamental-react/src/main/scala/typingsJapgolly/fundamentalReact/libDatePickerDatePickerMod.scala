...
import typingsJapgolly.fundamentalReact.libCalendarCalendarMod.CalendarBaseProps
...
object libDatePickerDatePickerMod {
  ...
  type DatePicker = japgolly.scalajs.react.facade.React.Component[DatePickerProps & js.Object, js.Object]
  ...
  object DatePickerProps {
    ...
    extension [Self <: DatePickerProps](x: Self) {
      ...
      inline def setOnBlur(value: /* hasDateFormattedDate */ Date => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: /* hasDateFormattedDate */ Date) => value(t0).runNow()))
