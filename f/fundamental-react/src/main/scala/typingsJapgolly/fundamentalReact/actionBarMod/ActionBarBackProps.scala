...
/* Inlined {onClick ? (event : react.react.MouseEvent<std.HTMLButtonElement, std.MouseEvent>): void,   className ? :string,   disableStyles ? :boolean,   buttonProps ? :{[x: string] : any},   ref ? :react.react.Ref<std.HTMLDivElement>} & react.react.HTMLAttributes<std.HTMLDivElement> */
@js.native
trait ActionBarBackProps extends js.Object {
  // RDFa Attributes
  ...
  var onClick: js.UndefOr[
    (js.Function1[/* event */ ReactMouseEventFrom[HTMLButtonElement], Unit]) | MouseEventHandler[HTMLDivElement]
  ] = js.native
  // Composition Events
