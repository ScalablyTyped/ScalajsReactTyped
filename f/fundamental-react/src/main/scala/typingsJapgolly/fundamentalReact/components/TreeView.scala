...
import typingsJapgolly.fundamentalReact.treeViewMod.TreeViewProps
import typingsJapgolly.fundamentalReact.treeViewMod.default
...
object TreeView {
  def apply(
    ...
    onExpandChange: /* expandData */ StringDictionary[Boolean] => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TreeViewProps, default, Unit, TreeViewProps] = {
    ...
    if (onExpandChange != null) __obj.updateDynamic("onExpandChange")(js.Any.fromFunction1((t0: /* expandData */ org.scalablytyped.runtime.StringDictionary[scala.Boolean]) => onExpandChange(t0).runNow()))
  ...
  typingsJapgolly.fundamentalReact.treeViewMod.TreeViewProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.fundamentalReact.treeViewMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.fundamentalReact.treeViewMod.TreeViewProps])(children: _*)
  }
