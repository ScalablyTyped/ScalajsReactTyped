...
object ActionBar {
  ...
  inline def apply(title: String & js.UndefOr[String]): Builder = {
    val __props = js.Dynamic.literal(title = title.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[ActionBarProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def actionClassName(value: String): this.type = set("actionClassName", value.asInstanceOf[js.Any])
    
    inline def actionProps(value: Any): this.type = set("actionProps", value.asInstanceOf[js.Any])
    ...
    inline def `aria-autocomplete`(value: none | `inline` | list_ | both): this.type = set("aria-autocomplete", value.asInstanceOf[js.Any])
    ...
    inline def `aria-current`(value: Boolean | page | step | location | date | time_): this.type = set("aria-current", value.asInstanceOf[js.Any])
    ...
    inline def `aria-dropeffect`(value: none | copy | execute | link_ | move | popup): this.type = set("aria-dropeffect", value.asInstanceOf[js.Any])
    ...
    inline def `aria-haspopup`(value: Boolean | menu_ | listbox | tree | grid | dialog): this.type = set("aria-haspopup", value.asInstanceOf[js.Any])
    ...
    inline def buttonContainerClassName(value: String): this.type = set("buttonContainerClassName", value.asInstanceOf[js.Any])
    ...
    inline def descriptionProps(value: Any): this.type = set("descriptionProps", value.asInstanceOf[js.Any])
    ...
    inline def headingLevel(value: Any): this.type = set("headingLevel", value.asInstanceOf[js.Any])
    ...
    inline def onBackClick(value: /* repeated */ Any => Any): this.type = set("onBackClick", js.Any.fromFunction1(value))
  ...
  def withProps(p: ActionBarProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
