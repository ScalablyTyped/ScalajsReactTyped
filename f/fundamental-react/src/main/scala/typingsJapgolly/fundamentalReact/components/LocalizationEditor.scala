...
object LocalizationEditor {
  ...
  inline def apply(control: ButtonProps, menu: js.Array[InputProps]): Builder = {
    val __props = js.Dynamic.literal(control = control.asInstanceOf[js.Any], menu = menu.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[LocalizationEditorProps]))
  }
  ...
  def withProps(p: LocalizationEditorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
