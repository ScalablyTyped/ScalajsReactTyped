...
import typingsJapgolly.fundamentalReact.libTitleTitleMod.TitleProps
...
object Title {
  ...
  inline def apply(level: `1` | `2` | `3` | `4` | `5` | `6`): Builder = {
    val __props = js.Dynamic.literal(level = level.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[TitleProps]))
  }
  
  @JSImport("fundamental-react", "Title")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def levelStyle(value: `1` | `2` | `3` | `4` | `5` | `6`): this.type = set("levelStyle", value.asInstanceOf[js.Any])
    
    inline def localizedText(value: Loading): this.type = set("localizedText", value.asInstanceOf[js.Any])
