...
object LayoutGrid {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def colSpan(value: Any): this.type = set("colSpan", value.asInstanceOf[js.Any])
    
    inline def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def cols(value: `1` | `2` | `3` | `4` | `5` | `6`): this.type = set("cols", value.asInstanceOf[js.Any])
    ...
    inline def nogap(value: Boolean): this.type = set("nogap", value.asInstanceOf[js.Any])
  ...
  def withProps(p: LayoutGridProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
