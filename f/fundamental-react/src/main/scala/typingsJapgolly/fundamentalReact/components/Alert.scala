...
import typingsJapgolly.fundamentalReact.AnonClose
import typingsJapgolly.fundamentalReact.alertMod.AlertProps
import typingsJapgolly.fundamentalReact.alertMod.AlertType
import typingsJapgolly.fundamentalReact.alertMod.default
...
object Alert {
  def apply(
    ...
    onCloseClicked: /* event */ ReactMouseEventFrom[HTMLButtonElement] => Callback = null,
    ...
    if (onCloseClicked != null) __obj.updateDynamic("onCloseClicked")(js.Any.fromFunction1((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLButtonElement]) => onCloseClicked(t0).runNow()))
  ...
  typingsJapgolly.fundamentalReact.alertMod.AlertProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.fundamentalReact.alertMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.fundamentalReact.alertMod.AlertProps])(children: _*)
  }
