...
import typingsJapgolly.fundamentalReact.libPopoverPopoverMod.PopoverProps
import typingsJapgolly.fundamentalReact.libPopoverPopoverMod.PopoverTypes
import typingsJapgolly.fundamentalReact.libPopoverPopoverMod.PopperPlacement
import typingsJapgolly.fundamentalReact.libPopoverPopoverMod.PopperSizingTypes
...
object Popover {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.fundamentalReact.mod.Popover] {
    ...
    inline def control(value: VdomNode): this.type = set("control", value.rawNode.asInstanceOf[js.Any])
    
    inline def controlNull: this.type = set("control", null)
    
    inline def controlVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("control", js.Array(value*))
    
    inline def controlVdomElement(value: VdomElement): this.type = set("control", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def disableEdgeDetection(value: Boolean): this.type = set("disableEdgeDetection", value.asInstanceOf[js.Any])
    
    inline def disableKeyPressHandler(value: Boolean): this.type = set("disableKeyPressHandler", value.asInstanceOf[js.Any])
    ...
    inline def onClickOutside(value: /* event */ MouseEvent | TouchEvent | FocusEvent => Callback): this.type = set("onClickOutside", js.Any.fromFunction1((t0: /* event */ MouseEvent | TouchEvent | FocusEvent) => value(t0).runNow()))
    ...
    inline def onEscapeKey(value: Callback): this.type = set("onEscapeKey", value.toJsFn)
    ...
    inline def placement(value: PopperPlacement): this.type = set("placement", value.asInstanceOf[js.Any])
    
    inline def popperClassName(value: String): this.type = set("popperClassName", value.asInstanceOf[js.Any])
    
    inline def popperProps(value: Any): this.type = set("popperProps", value.asInstanceOf[js.Any])
    ...
    inline def `type`(value: PopoverTypes): this.type = set("type", value.asInstanceOf[js.Any])
    
    inline def typeof(value: String): this.type = set("typeof", value.asInstanceOf[js.Any])
    
    inline def unselectable(value: on | off): this.type = set("unselectable", value.asInstanceOf[js.Any])
    
    inline def useArrowKeyNavigation(value: Boolean): this.type = set("useArrowKeyNavigation", value.asInstanceOf[js.Any])
    
    inline def vocab(value: String): this.type = set("vocab", value.asInstanceOf[js.Any])
    
    inline def widthSizingType(value: PopperSizingTypes): this.type = set("widthSizingType", value.asInstanceOf[js.Any])
  }
