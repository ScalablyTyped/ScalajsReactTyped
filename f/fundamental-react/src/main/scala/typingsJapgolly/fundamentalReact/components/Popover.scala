...
import typingsJapgolly.fundamentalReact.popoverMod.PopoverProps
import typingsJapgolly.fundamentalReact.popoverMod.PopoverTypes
import typingsJapgolly.fundamentalReact.popoverMod.PopperPlacement
import typingsJapgolly.fundamentalReact.popoverMod.PopperSizingTypes
import typingsJapgolly.fundamentalReact.popoverMod.default
...
object Popover {
  def apply(
    ...
    onClickOutside: /* event */ MouseEvent | TouchEvent | FocusEvent => Callback = null,
    ...
    onEscapeKey: js.UndefOr[Callback] = js.undefined,
    ...
    if (control != null) __obj.updateDynamic("control")(control.rawNode.asInstanceOf[js.Any])
    ...
    if (onClickOutside != null) __obj.updateDynamic("onClickOutside")(js.Any.fromFunction1((t0: /* event */ org.scalajs.dom.raw.MouseEvent | org.scalajs.dom.raw.TouchEvent | org.scalajs.dom.raw.FocusEvent) => onClickOutside(t0).runNow()))
    ...
    onEscapeKey.foreach(p => __obj.updateDynamic("onEscapeKey")(p.toJsFn))
  ...
  typingsJapgolly.fundamentalReact.popoverMod.PopoverProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.fundamentalReact.popoverMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.fundamentalReact.popoverMod.PopoverProps])(children: _*)
  }
