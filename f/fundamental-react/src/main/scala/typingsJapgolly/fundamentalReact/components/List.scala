...
import typingsJapgolly.fundamentalReact.libListListMod.ListBylineProps
import typingsJapgolly.fundamentalReact.libListListMod.ListFooterProps
import typingsJapgolly.fundamentalReact.libListListMod.ListHeaderProps
import typingsJapgolly.fundamentalReact.libListListMod.ListIconProps
...
import typingsJapgolly.fundamentalReact.libListListMod.ListSelectionProps
...
object List {
  ...
  object Byline {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def cssNamespace(value: String): this.type = set("cssNamespace", value.asInstanceOf[js.Any])
      
      inline def twoColumns(value: Boolean): this.type = set("twoColumns", value.asInstanceOf[js.Any])
    }
    
    implicit def make(companion: Byline.type): typingsJapgolly.fundamentalReact.components.List.Byline.Builder = new typingsJapgolly.fundamentalReact.components.List.Byline.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ListBylineProps): typingsJapgolly.fundamentalReact.components.List.Byline.Builder = new typingsJapgolly.fundamentalReact.components.List.Byline.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Footer {
    ...
    implicit def make(companion: Footer.type): typingsJapgolly.fundamentalReact.components.List.Footer.Builder = new typingsJapgolly.fundamentalReact.components.List.Footer.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ListFooterProps): typingsJapgolly.fundamentalReact.components.List.Footer.Builder = new typingsJapgolly.fundamentalReact.components.List.Footer.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Header {
    ...
    implicit def make(companion: Header.type): typingsJapgolly.fundamentalReact.components.List.Header.Builder = new typingsJapgolly.fundamentalReact.components.List.Header.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ListHeaderProps): typingsJapgolly.fundamentalReact.components.List.Header.Builder = new typingsJapgolly.fundamentalReact.components.List.Header.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object Icon {
    
    inline def apply(glyph: IconGlyph): typingsJapgolly.fundamentalReact.components.List.Icon.Builder = {
      val __props = js.Dynamic.literal(glyph = glyph.asInstanceOf[js.Any])
      new typingsJapgolly.fundamentalReact.components.List.Icon.Builder(js.Array(this.component, __props.asInstanceOf[ListIconProps]))
    }
    ...
    def withProps(p: ListIconProps): typingsJapgolly.fundamentalReact.components.List.Icon.Builder = new typingsJapgolly.fundamentalReact.components.List.Icon.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Item {
    ...
    implicit def make(companion: Item.type): typingsJapgolly.fundamentalReact.components.List.Item.Builder = new typingsJapgolly.fundamentalReact.components.List.Item.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ListItemProps): typingsJapgolly.fundamentalReact.components.List.Item.Builder = new typingsJapgolly.fundamentalReact.components.List.Item.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object Selection {
    
    inline def apply(checkBoxAriaLabel: String): typingsJapgolly.fundamentalReact.components.List.Selection.Builder = {
      val __props = js.Dynamic.literal(checkBoxAriaLabel = checkBoxAriaLabel.asInstanceOf[js.Any])
      new typingsJapgolly.fundamentalReact.components.List.Selection.Builder(js.Array(this.component, __props.asInstanceOf[ListSelectionProps]))
    }
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def onChange(value: (/* event */ ReactEventFrom[HTMLInputElement], /* checkedState */ Boolean) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[HTMLInputElement], t1: /* checkedState */ Boolean) => (value(t0, t1)).runNow()))
      
      inline def selected(value: Boolean): this.type = set("selected", value.asInstanceOf[js.Any])
    }
    
    def withProps(p: ListSelectionProps): typingsJapgolly.fundamentalReact.components.List.Selection.Builder = new typingsJapgolly.fundamentalReact.components.List.Selection.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Text {
    ...
    implicit def make(companion: Text.type): typingsJapgolly.fundamentalReact.components.List.Text.Builder = new typingsJapgolly.fundamentalReact.components.List.Text.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ListTextProps): typingsJapgolly.fundamentalReact.components.List.Text.Builder = new typingsJapgolly.fundamentalReact.components.List.Text.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def footer(value: String | Element): this.type = set("footer", value.asInstanceOf[js.Any])
    
    inline def footerVdomElement(value: VdomElement): this.type = set("footer", value.rawElement.asInstanceOf[js.Any])
    
    inline def hasByline(value: Boolean): this.type = set("hasByline", value.asInstanceOf[js.Any])
    
    inline def header(value: String | Element): this.type = set("header", value.asInstanceOf[js.Any])
    ...
    inline def level(value: `2` | `3` | `4` | `5` | `6`): this.type = set("level", value.asInstanceOf[js.Any])
    
    inline def navigation(value: Boolean): this.type = set("navigation", value.asInstanceOf[js.Any])
    ...
    inline def partialNavigation(value: Boolean): this.type = set("partialNavigation", value.asInstanceOf[js.Any])
