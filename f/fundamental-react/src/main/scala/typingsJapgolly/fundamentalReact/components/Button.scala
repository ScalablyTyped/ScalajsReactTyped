...
import typingsJapgolly.fundamentalReact.libButtonButtonMod.ButtonOptions
import typingsJapgolly.fundamentalReact.libButtonButtonMod.ButtonProps
import typingsJapgolly.fundamentalReact.libButtonButtonMod.ButtonTypes
...
object Button {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def option(value: ButtonOptions): this.type = set("option", value.asInstanceOf[js.Any])
    ...
    inline def `type`(value: ButtonTypes): this.type = set("type", value.asInstanceOf[js.Any])
    
    inline def typeAttr(value: submit | reset | button_): this.type = set("typeAttr", value.asInstanceOf[js.Any])
