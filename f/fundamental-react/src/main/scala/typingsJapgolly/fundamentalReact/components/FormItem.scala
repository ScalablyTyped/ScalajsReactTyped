...
import typingsJapgolly.fundamentalReact.libFormsFormItemMod.FormItemProps
...
object FormItem {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def isHorizontal(value: Boolean): this.type = set("isHorizontal", value.asInstanceOf[js.Any])
    
    inline def isInline(value: Boolean): this.type = set("isInline", value.asInstanceOf[js.Any])
  }
