...
object libTableTableMod {
  ...
  trait TableProps
    ...
    var headers: js.Array[String | Node]
  ...
  object TableProps {
    ...
    inline def apply(headers: js.Array[String | Node]): TableProps = {
    ...
    extension [Self <: TableProps](x: Self) {
      ...
      inline def setHeaders(value: js.Array[String | Node]): Self = StObject.set(x, "headers", value.asInstanceOf[js.Any])
      
      inline def setHeadersVarargs(value: (String | Node)*): Self = StObject.set(x, "headers", js.Array(value*))
      ...
      inline def setTableBodyRowPropsFunction2(value: (/* rowData */ js.Array[String], /* index */ Double) => Callback): Self = StObject.set(x, "tableBodyRowProps", js.Any.fromFunction2((t0: /* rowData */ js.Array[String], t1: /* index */ Double) => (value(t0, t1)).runNow()))
