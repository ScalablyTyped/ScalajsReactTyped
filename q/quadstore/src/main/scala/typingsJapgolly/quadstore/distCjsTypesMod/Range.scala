...
trait Range extends StObject {
  ...
  var termType: typingsJapgolly.quadstore.quadstoreStrings.Range
}
object Range {
  ...
  extension [Self <: Range](x: Self) {
    ...
    inline def setTermType(value: typingsJapgolly.quadstore.quadstoreStrings.Range): Self = StObject.set(x, "termType", value.asInstanceOf[js.Any])
  }
}
