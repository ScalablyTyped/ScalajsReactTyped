...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.qlikEngineapi.qlikEngineapiStrings.OTHER_COUNTED
  - typingsJapgolly.qlikEngineapi.qlikEngineapiStrings.OTHER_ABS_LIMITED
  - typingsJapgolly.qlikEngineapi.qlikEngineapiStrings.OTHER_ABS_ACC_TARGET
