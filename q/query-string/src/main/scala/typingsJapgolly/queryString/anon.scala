...
import typingsJapgolly.queryString.queryStringBooleans.`true`
...
object anon {
  ...
  object parseBooleanstrueParseOptArrayFormat {
    ...
    inline def apply(parseBooleans: `true` & js.UndefOr[Boolean]): parseBooleanstrueParseOptArrayFormat = {
      val __obj = js.Dynamic.literal(parseBooleans = parseBooleans.asInstanceOf[js.Any])
  ...
  object parseBooleanstrueparseNumArrayFormat {
    ...
    inline def apply(parseBooleans: `true` & js.UndefOr[Boolean], parseNumbers: `true` & js.UndefOr[Boolean]): parseBooleanstrueparseNumArrayFormat = {
      val __obj = js.Dynamic.literal(parseBooleans = parseBooleans.asInstanceOf[js.Any], parseNumbers = parseNumbers.asInstanceOf[js.Any])
  ...
  object parseNumberstrueParseOptiArrayFormat {
    ...
    inline def apply(parseNumbers: `true` & js.UndefOr[Boolean]): parseNumberstrueParseOptiArrayFormat = {
      val __obj = js.Dynamic.literal(parseNumbers = parseNumbers.asInstanceOf[js.Any])
