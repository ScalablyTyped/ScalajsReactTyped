...
import typingsJapgolly.qlik.qlikStrings.NX_FREQUENCY_NONE
import typingsJapgolly.qlik.qlikStrings.NX_FREQUENCY_PERCENT
import typingsJapgolly.qlik.qlikStrings.NX_FREQUENCY_RELATIVE
import typingsJapgolly.qlik.qlikStrings.NX_FREQUENCY_VALUE
