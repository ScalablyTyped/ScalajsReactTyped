...
object CustomPropertyButtonGroup {
  ...
  extension [Self <: CustomPropertyButtonGroup](x: Self) {
    ...
    inline def setOptionsCallbackTo(value: CallbackTo[js.Array[ButtonGroupOption]]): Self = StObject.set(x, "options", value.toJsFn)
    
    inline def setOptionsUndefined: Self = StObject.set(x, "options", js.undefined)
    
    inline def setOptionsVarargs(value: ButtonGroupOption*): Self = StObject.set(x, "options", js.Array(value*))
