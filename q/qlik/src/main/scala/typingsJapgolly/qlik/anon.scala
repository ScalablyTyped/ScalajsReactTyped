...
import typingsJapgolly.qlik.qlikStrings.data
import typingsJapgolly.qlik.qlikStrings.dimensions
import typingsJapgolly.qlik.qlikStrings.measures
import typingsJapgolly.qlik.qlikStrings.settings
import typingsJapgolly.qlik.qlikStrings.sorting
...
object anon {
  ...
  object GetContent {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getContent = js.Any.fromFunction2(getContent), setContent = js.Any.fromFunction2((t0: String, t1: String) => (setContent(t0, t1)).runNow()))
    ...
    extension [Self <: GetContent](x: Self) {
      ...
      inline def setSetContent(value: (String, String) => Callback): Self = StObject.set(x, "setContent", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
    }
  }
