package typingsJapgolly.qixianCsPathToRegexp
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.qixianCsPathToRegexp.qixianCsPathToRegexpBooleans.`false`
    - typingsJapgolly.qixianCsPathToRegexp.mod.MatchResult[P]
  */
