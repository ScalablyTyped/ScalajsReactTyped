package typingsJapgolly.qRetry

import typingsJapgolly.q.mod.Deferred
...
object mod {
  ...
  ): typingsJapgolly.q.mod.Promise[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Promise")(resolver.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.q.mod.Promise[T]]
  ...
  object qAugmentingMod {
    ...
    inline def retry[U](process: js.Function0[IPromise[U] | U], limit: Double): typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("retry")(process.asInstanceOf[js.Any], limit.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U]]
    inline def retry[U](
      process: js.Function0[IPromise[U] | U],
      onFail: js.Function2[/* reason */ Any, /* retries */ Double, Unit],
      limit: Double
    ): typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("retry")(process.asInstanceOf[js.Any], onFail.asInstanceOf[js.Any], limit.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U]]
    inline def retry[U](
      process: js.Function0[IPromise[U] | U],
      onFail: js.Function2[/* reason */ Any, /* retries */ Double, Unit],
      options: js.UndefOr[IRetryOptions]
    ): typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("retry")(process.asInstanceOf[js.Any], onFail.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U]]
    inline def retry[U](process: js.Function0[IPromise[U] | U], options: js.UndefOr[IRetryOptions]): typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("retry")(process.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U]]
    ...
    trait Promise[T] extends StObject {
      ...
      def retry[U](process: js.Function1[/* value */ T, IPromise[U] | U]): typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U] = js.native
      def retry[U](process: js.Function1[/* value */ T, IPromise[U] | U], limit: Double): typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U] = js.native
      def retry[U](
      ...
      def retry[U](process: js.Function1[/* value */ T, IPromise[U] | U], options: IRetryOptions): typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U] = js.native
    }
  }
  ...
  inline def retry[U](process: js.Function0[IPromise[U] | U]): typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U] = ^.asInstanceOf[js.Dynamic].applyDynamic("retry")(process.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U]]
  inline def retry[U](process: js.Function0[IPromise[U] | U], limit: Double): typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("retry")(process.asInstanceOf[js.Any], limit.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U]]
  inline def retry[U](
    process: js.Function0[IPromise[U] | U],
    onFail: js.Function2[/* reason */ Any, /* retries */ Double, Unit]
  ): typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("retry")(process.asInstanceOf[js.Any], onFail.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U]]
  inline def retry[U](
    process: js.Function0[IPromise[U] | U],
    onFail: js.Function2[/* reason */ Any, /* retries */ Double, Unit],
    limit: Double
  ...
  inline def retry[U](process: js.Function0[IPromise[U] | U], options: IRetryOptions): typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("retry")(process.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.qRetry.mod.qAugmentingMod.Promise[U]]
