...
object distAssertionsMod {
  ...
  trait DOMAssertions extends StObject {
    ...
    def hasAria(name: String, value: typingsJapgolly.qunitDom.anon.Any): DOMAssertions = js.native
    def hasAria(name: String, value: typingsJapgolly.qunitDom.anon.Any, message: String): DOMAssertions = js.native
    ...
    def hasAttribute(name: String, value: typingsJapgolly.qunitDom.anon.Any): DOMAssertions = js.native
    def hasAttribute(name: String, value: typingsJapgolly.qunitDom.anon.Any, message: String): DOMAssertions = js.native
    ...
    def hasText(expected: typingsJapgolly.qunitDom.anon.Any): DOMAssertions = js.native
    def hasText(expected: typingsJapgolly.qunitDom.anon.Any, message: String): DOMAssertions = js.native
    ...
    def hasValue(expected: typingsJapgolly.qunitDom.anon.Any): DOMAssertions = js.native
    def hasValue(expected: typingsJapgolly.qunitDom.anon.Any, message: String): DOMAssertions = js.native
    ...
    def matchesText(expected: typingsJapgolly.qunitDom.anon.Any): DOMAssertions = js.native
    def matchesText(expected: typingsJapgolly.qunitDom.anon.Any, message: String): DOMAssertions = js.native
