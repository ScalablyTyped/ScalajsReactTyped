...
object IExtension {
  ...
  def apply(
    ...
    paint: (/* $element */ HTMLElement, /* layout */ js.UndefOr[js.Any]) => Callback = null,
    ...
    if (paint != null) __obj.updateDynamic("paint")(js.Any.fromFunction2((t0: /* $element */ org.scalajs.dom.raw.HTMLElement, t1: /* layout */ js.UndefOr[js.Any]) => paint(t0, t1).runNow()))
