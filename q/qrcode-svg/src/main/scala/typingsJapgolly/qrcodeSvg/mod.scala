...
import typingsJapgolly.qrcodeSvg.anon.Container
import typingsJapgolly.qrcodeSvg.anon.Data
import typingsJapgolly.qrcodeSvg.qrcodeSvgStrings.H
import typingsJapgolly.qrcodeSvg.qrcodeSvgStrings.L
import typingsJapgolly.qrcodeSvg.qrcodeSvgStrings.M
import typingsJapgolly.qrcodeSvg.qrcodeSvgStrings.Q
import typingsJapgolly.qrcodeSvg.qrcodeSvgStrings.`svg-viewbox`
...
object mod {
  ...
  object Model {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(addData = js.Any.fromFunction1((t0: String) => addData(t0).runNow()), dataList = dataList.asInstanceOf[js.Any], errorCorrectLevel = errorCorrectLevel.asInstanceOf[js.Any], getModuleCount = getModuleCount.toJsFn, isDark = js.Any.fromFunction2(isDark), make = make.toJsFn, moduleCount = moduleCount.asInstanceOf[js.Any], modules = modules.asInstanceOf[js.Any], typeNumber = typeNumber.asInstanceOf[js.Any], dataCache = null)
      __obj.asInstanceOf[Model]
    }
    
    extension [Self <: Model](x: Self) {
      
      inline def setAddData(value: String => Callback): Self = StObject.set(x, "addData", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      ...
      inline def setGetModuleCount(value: CallbackTo[Double]): Self = StObject.set(x, "getModuleCount", value.toJsFn)
