...
import typingsJapgolly.quill.anon.Html
import typingsJapgolly.quill.quillBooleans.`false`
import typingsJapgolly.quill.quillBooleans.`true`
...
import typingsJapgolly.quill.quillStrings.api
import typingsJapgolly.quill.quillStrings.silent
import typingsJapgolly.quill.quillStrings.user
...
object mod {
  ...
  */
  ...
  object Sources {
    ...
    inline def api: typingsJapgolly.quill.quillStrings.api = "api".asInstanceOf[typingsJapgolly.quill.quillStrings.api]
    
    inline def silent: typingsJapgolly.quill.quillStrings.silent = "silent".asInstanceOf[typingsJapgolly.quill.quillStrings.silent]
    
    inline def user: typingsJapgolly.quill.quillStrings.user = "user".asInstanceOf[typingsJapgolly.quill.quillStrings.user]
  }
