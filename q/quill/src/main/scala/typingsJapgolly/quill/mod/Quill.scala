...
class Quill protected () extends EventEmitter {
  ...
  def addContainer(classNameOrDomNode: typingsJapgolly.std.Node): js.Any = js.native
  def addContainer(classNameOrDomNode: typingsJapgolly.std.Node, refNode: Node): js.Any = js.native
