package typingsJapgolly.quickLru

import japgolly.scalajs.react.Callback
import typingsJapgolly.quickLru.anon.MaxAge
...
object mod {
  ...
  - typingsJapgolly.std.Iterable because var conflicts: iterator. Inlined  */ @js.native
