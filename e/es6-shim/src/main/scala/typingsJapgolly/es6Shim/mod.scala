...
object mod {
  ...
  open class Map[K, V] ()
    extends StObject
       with typingsJapgolly.es6Shim.Map[K, V] {
  ...
  @js.native
  def Math: typingsJapgolly.es6Shim.Math = js.native
  ...
  open class Promise[T] protected ()
    extends StObject
       with typingsJapgolly.es6Shim.Promise[T] {
    /**
  ...
  open class Set[T] ()
    extends StObject
       with typingsJapgolly.es6Shim.Set[T] {
  ...
  open class WeakMap[K /* <: js.Object */, V] ()
    extends StObject
       with typingsJapgolly.es6Shim.WeakMap[K, V] {
    def this(iterable: IterableShim[js.Tuple2[K, V]]) = this()
  ...
  open class WeakSet[T] ()
    extends StObject
       with typingsJapgolly.es6Shim.WeakSet[T] {
    def this(iterable: IterableShim[T]) = this()
