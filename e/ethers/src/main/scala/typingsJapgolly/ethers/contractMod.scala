...
import typingsJapgolly.ethers.interfaceMod.Interface
import typingsJapgolly.ethers.typesMod.BigNumber
import typingsJapgolly.ethers.typesMod.ContractFunction
import typingsJapgolly.ethers.typesMod.EventFilter
