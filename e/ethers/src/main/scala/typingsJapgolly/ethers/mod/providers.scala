...
object providers extends js.Object {
  ...
  class EtherscanProvider ()
    extends typingsJapgolly.ethers.ethersMod.providers.EtherscanProvider {
  ...
  class FallbackProvider protected ()
    extends typingsJapgolly.ethers.ethersMod.providers.FallbackProvider {
    def this(providers: js.Array[typingsJapgolly.ethers.providerMod.Provider]) = this()
  }
  
  @js.native
  class InfuraProvider ()
    extends typingsJapgolly.ethers.ethersMod.providers.InfuraProvider {
    def this(network: Networkish) = this()
  ...
  class IpcProvider protected ()
    extends typingsJapgolly.ethers.ethersMod.providers.IpcProvider {
  ...
  class JsonRpcProvider ()
    extends typingsJapgolly.ethers.ethersMod.providers.JsonRpcProvider {
  ...
  class JsonRpcSigner protected ()
    extends typingsJapgolly.ethers.ethersMod.providers.JsonRpcSigner {
  ...
  class Provider protected ()
    extends typingsJapgolly.ethers.ethersMod.providers.Provider {
  ...
  class Web3Provider protected ()
    extends typingsJapgolly.ethers.ethersMod.providers.Web3Provider {
