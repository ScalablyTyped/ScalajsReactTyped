...
object providersMod extends js.Object {
  ...
  class EtherscanProvider ()
    extends typingsJapgolly.ethers.etherscanProviderMod.EtherscanProvider {
  ...
  class FallbackProvider protected ()
    extends typingsJapgolly.ethers.fallbackProviderMod.FallbackProvider {
    def this(providers: js.Array[typingsJapgolly.ethers.providerMod.Provider]) = this()
  }
  
  @js.native
  class InfuraProvider ()
    extends typingsJapgolly.ethers.infuraProviderMod.InfuraProvider {
    def this(network: Networkish) = this()
  ...
  class IpcProvider protected ()
    extends typingsJapgolly.ethers.ipcProviderMod.IpcProvider {
  ...
  class JsonRpcProvider ()
    extends typingsJapgolly.ethers.jsonRpcProviderMod.JsonRpcProvider {
  ...
  class JsonRpcSigner protected ()
    extends typingsJapgolly.ethers.jsonRpcProviderMod.JsonRpcSigner {
  ...
  class Provider protected ()
    extends typingsJapgolly.ethers.providerMod.Provider {
  ...
  class Web3Provider protected ()
    extends typingsJapgolly.ethers.web3ProviderMod.Web3Provider {
