...
import typingsJapgolly.elasticsearch.mod.IndicesUpdateAliasesParamsAction
...
object anon {
  ...
  trait Explanation[T] extends StObject {
    ...
    var _explanation: js.UndefOr[typingsJapgolly.elasticsearch.mod.Explanation] = js.undefined
  ...
  object Explanation {
    ...
    extension [Self <: Explanation[?], T](x: Self & Explanation[T]) {
      ...
      inline def set_explanation(value: typingsJapgolly.elasticsearch.mod.Explanation): Self = StObject.set(x, "_explanation", value.asInstanceOf[js.Any])
