...
object srcLibConnectorsHttpMod {
  ...
  object HttpConnector {
    ...
    inline def apply(
      ...
      request: (Any, js.Function4[/* error */ Any, /* response */ Any, /* status */ Any, /* headers */ Any, Unit]) => Callback
    ): HttpConnector = {
      val __obj = js.Dynamic.literal(createAgent = js.Any.fromFunction1(createAgent), makeAgentConfig = js.Any.fromFunction1(makeAgentConfig), makeReqParams = js.Any.fromFunction1(makeReqParams), request = js.Any.fromFunction2((t0: Any, t1: js.Function4[/* error */ Any, /* response */ Any, /* status */ Any, /* headers */ Any, Unit]) => (request(t0, t1)).runNow()))
    ...
    extension [Self <: HttpConnector](x: Self) {
      ...
      inline def setRequest(
        value: (Any, js.Function4[/* error */ Any, /* response */ Any, /* status */ Any, /* headers */ Any, Unit]) => Callback
      ): Self = StObject.set(x, "request", js.Any.fromFunction2((t0: Any, t1: js.Function4[/* error */ Any, /* response */ Any, /* status */ Any, /* headers */ Any, Unit]) => (value(t0, t1)).runNow()))
    }
  }
}
