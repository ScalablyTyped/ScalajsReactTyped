...
import typingsJapgolly.expoPrebuildConfig.expoPrebuildConfigStrings.custom
import typingsJapgolly.expoPrebuildConfig.expoPrebuildConfigStrings.displayP3
import typingsJapgolly.expoPrebuildConfig.expoPrebuildConfigStrings.sRGB
...
object rednumbergreennumberbluen {
  ...
  extension [Self <: rednumbergreennumberbluen](x: Self) {
