...
object distTypesDomMod {
  
  @JSImport("@esfx/canceltoken/dist/types/dom", "CancelError")
  @js.native
  open class CancelError ()
    extends typingsJapgolly.esfxCanceltoken.mod.CancelError {
  ...
  object CancelSubscription {
    ...
    @JSImport("@esfx/canceltoken/dist/types/dom", "CancelSubscription")
    @js.native
  ...
  @JSImport("@esfx/canceltoken/dist/types/dom", "CancelToken")
  @js.native
  /* private */ open class CancelToken ()
    extends typingsJapgolly.esfxCanceltoken.mod.CancelToken
  /* static members */
  object CancelToken {
    ...
    @JSImport("@esfx/canceltoken/dist/types/dom", "CancelToken.canceled")
    @js.native
    ...
    @JSImport("@esfx/canceltoken/dist/types/dom", "CancelToken.none")
    @js.native
