...
import typingsJapgolly.esfxCancelable.mod.CancelSignal
import typingsJapgolly.esfxCancelable.mod.CancelSubscription
...
object mod {
  ...
  open class CancelError ()
    extends typingsJapgolly.esfxCancelable.mod.CancelError {
