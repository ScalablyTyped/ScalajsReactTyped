...
import typingsJapgolly.esfxCanceltoken.esfxCanceltokenStrings.update
import typingsJapgolly.esfxCanceltoken.esfxCanceltokenStrings.updateend
import typingsJapgolly.esfxCanceltoken.esfxCanceltokenStrings.updatestart
...
@js.native
trait SourceBuffer extends StObject {
