...
import typingsJapgolly.esfxCanceltoken.esfxCanceltokenStrings.encrypted
...
import typingsJapgolly.esfxCanceltoken.esfxCanceltokenStrings.waitingforkey
...
@js.native
trait HTMLAudioElement extends StObject {
