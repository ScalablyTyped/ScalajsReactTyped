...
import typingsJapgolly.expoConfigPlugins.anon.AppBuildGradle
import typingsJapgolly.expoConfigPlugins.anon.AppDelegate
import typingsJapgolly.expoConfigPlugins.anon.IsIntrospective
...
object buildPluginDottypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.expoConfigPlugins.expoConfigPluginsStrings.android
    - typingsJapgolly.expoConfigPlugins.expoConfigPluginsStrings.ios
  */
