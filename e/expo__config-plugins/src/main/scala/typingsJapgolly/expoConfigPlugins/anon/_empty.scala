...
import typingsJapgolly.expoConfigPlugins.buildAndroidManifestMod.ManifestPermission
import typingsJapgolly.expoConfigPlugins.buildAndroidManifestMod.ManifestUsesFeature
