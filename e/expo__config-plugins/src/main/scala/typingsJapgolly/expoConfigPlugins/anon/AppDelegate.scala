...
import typingsJapgolly.expoConfigPlugins.buildPluginDottypesMod.Plist
...
trait AppDelegate extends StObject {
  ...
  var appDelegate: js.UndefOr[
    typingsJapgolly.expoConfigPlugins.buildPluginDottypesMod.Mod[AppDelegateProjectFile]
  ] = js.undefined
  ...
  /**
    ...
    */
  var entitlements: js.UndefOr[typingsJapgolly.expoConfigPlugins.buildPluginDottypesMod.Mod[Plist]] = js.undefined
  ...
  /**
    ...
    */
  var expoPlist: js.UndefOr[typingsJapgolly.expoConfigPlugins.buildPluginDottypesMod.Mod[Plist]] = js.undefined
  
  /**
    * Modify the `ios/<name>/Info.plist` as JSON (parsed with [`@expo/plist`](https://www.npmjs.com/package/@expo/plist)).
    */
  var infoPlist: js.UndefOr[typingsJapgolly.expoConfigPlugins.buildPluginDottypesMod.Mod[InfoPlist]] = js.undefined
  
  /**
    * Modify the `ios/Podfile.properties.json` as key-value pairs
    */
  var podfileProperties: js.UndefOr[
    typingsJapgolly.expoConfigPlugins.buildPluginDottypesMod.Mod[Record[String, String]]
  ] = js.undefined
  ...
  var xcodeproj: js.UndefOr[
    typingsJapgolly.expoConfigPlugins.buildPluginDottypesMod.Mod[
...
object AppDelegate {
  ...
  extension [Self <: AppDelegate](x: Self) {
    ...
    inline def setAppDelegate(value: typingsJapgolly.expoConfigPlugins.buildPluginDottypesMod.Mod[AppDelegateProjectFile]): Self = StObject.set(x, "appDelegate", value.asInstanceOf[js.Any])
    ...
    inline def setEntitlements(value: typingsJapgolly.expoConfigPlugins.buildPluginDottypesMod.Mod[Plist]): Self = StObject.set(x, "entitlements", value.asInstanceOf[js.Any])
    
    inline def setEntitlementsUndefined: Self = StObject.set(x, "entitlements", js.undefined)
    
    inline def setExpoPlist(value: typingsJapgolly.expoConfigPlugins.buildPluginDottypesMod.Mod[Plist]): Self = StObject.set(x, "expoPlist", value.asInstanceOf[js.Any])
    
    inline def setExpoPlistUndefined: Self = StObject.set(x, "expoPlist", js.undefined)
    
    inline def setInfoPlist(value: typingsJapgolly.expoConfigPlugins.buildPluginDottypesMod.Mod[InfoPlist]): Self = StObject.set(x, "infoPlist", value.asInstanceOf[js.Any])
    
    inline def setInfoPlistUndefined: Self = StObject.set(x, "infoPlist", js.undefined)
    
    inline def setPodfileProperties(value: typingsJapgolly.expoConfigPlugins.buildPluginDottypesMod.Mod[Record[String, String]]): Self = StObject.set(x, "podfileProperties", value.asInstanceOf[js.Any])
    
    inline def setPodfilePropertiesUndefined: Self = StObject.set(x, "podfileProperties", js.undefined)
    
    inline def setXcodeproj(
      value: typingsJapgolly.expoConfigPlugins.buildPluginDottypesMod.Mod[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify XcodeProject */ Any
        ]
