...
import typingsJapgolly.expoConfigPlugins.buildAndroidManifestMod.StringBoolean
import typingsJapgolly.expoConfigPlugins.expoConfigPluginsStrings.androidDotintentDotactionDotVIEW
import typingsJapgolly.expoConfigPlugins.expoConfigPluginsStrings.remove
