...
import typingsJapgolly.expoConfigPlugins.expoConfigPluginsStrings.colors
import typingsJapgolly.expoConfigPlugins.expoConfigPluginsStrings.strings
import typingsJapgolly.expoConfigPlugins.expoConfigPluginsStrings.styles
