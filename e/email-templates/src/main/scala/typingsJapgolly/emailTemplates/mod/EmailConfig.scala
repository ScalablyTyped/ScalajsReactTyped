...
import typingsJapgolly.htmlToText.HtmlToTextOptions
...
object EmailConfig {
  ...
  def apply[T](
    ...
    render: (/* view */ String, /* locals */ T) => CallbackTo[js.Promise[js.Any]] = null,
    ...
    if (render != null) __obj.updateDynamic("render")(js.Any.fromFunction2((t0: /* view */ java.lang.String, t1: /* locals */ T) => render(t0, t1).runNow()))
