...
import typingsJapgolly.emailTemplates.anon.Dictkey
import typingsJapgolly.emailTemplates.anon.PartialEmailMessage
import typingsJapgolly.emailTemplates.emailTemplatesBooleans.`false`
import typingsJapgolly.htmlToText.mod.HtmlToTextOptions
...
object mod {
  ...
  type NodeMailerTransportOptions = typingsJapgolly.nodemailer.libMailerMod.^[Any] | typingsJapgolly.nodemailer.libSmtpPoolMod.^ | typingsJapgolly.nodemailer.libSmtpPoolMod.Options | typingsJapgolly.nodemailer.libSendmailTransportMod.^ | typingsJapgolly.nodemailer.libSendmailTransportMod.Options | typingsJapgolly.nodemailer.libStreamTransportMod.^ | typingsJapgolly.nodemailer.libStreamTransportMod.Options | typingsJapgolly.nodemailer.libJsonTransportMod.^ | typingsJapgolly.nodemailer.libJsonTransportMod.Options | typingsJapgolly.nodemailer.libSesTransportMod.^ | typingsJapgolly.nodemailer.libSesTransportMod.Options | typingsJapgolly.nodemailer.libSmtpTransportMod.^ | typingsJapgolly.nodemailer.libSmtpTransportMod.Options | String
