...
object buildPlatformMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.expoModulesCore.expoModulesCoreStrings.native
    - typingsJapgolly.expoModulesCore.expoModulesCoreStrings.electron
    - typingsJapgolly.expoModulesCore.expoModulesCoreStrings.default
  */
