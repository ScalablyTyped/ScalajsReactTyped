...
import typingsJapgolly.elasticlunr.elasticlunrStrings.AND
import typingsJapgolly.elasticlunr.elasticlunrStrings.OR
...
open class Index[T /* <: js.Object */] () extends StObject {
  ...
  var index: /* import warning: importer.ImportType#apply Failed type conversion: {[ K in keyof T ]:? elasticlunr.elasticlunr.InvertedIndex} */ js.Any = js.native
