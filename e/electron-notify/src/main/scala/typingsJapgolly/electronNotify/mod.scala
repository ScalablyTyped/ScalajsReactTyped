...
object mod {
  ...
  object INotification {
    ...
    extension [Self <: INotification](x: Self) {
      ...
      inline def setOnClickFunc(value: /* event */ INotificationEvent => Callback): Self = StObject.set(x, "onClickFunc", js.Any.fromFunction1((t0: /* event */ INotificationEvent) => value(t0).runNow()))
      
      inline def setOnClickFuncUndefined: Self = StObject.set(x, "onClickFunc", js.undefined)
      
      inline def setOnCloseFunc(value: /* event */ ICloseNotificationEvent => Callback): Self = StObject.set(x, "onCloseFunc", js.Any.fromFunction1((t0: /* event */ ICloseNotificationEvent) => value(t0).runNow()))
      
      inline def setOnCloseFuncUndefined: Self = StObject.set(x, "onCloseFunc", js.undefined)
      
      inline def setOnShowFunc(value: /* event */ INotificationEvent => Callback): Self = StObject.set(x, "onShowFunc", js.Any.fromFunction1((t0: /* event */ INotificationEvent) => value(t0).runNow()))
  ...
  object INotificationEvent {
    ...
    inline def apply(closeNotification: Any => Callback, event: close | show | click, id: Double): INotificationEvent = {
      val __obj = js.Dynamic.literal(closeNotification = js.Any.fromFunction1((t0: Any) => closeNotification(t0).runNow()), event = event.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[INotificationEvent]
    }
    
    extension [Self <: INotificationEvent](x: Self) {
      
      inline def setCloseNotification(value: Any => Callback): Self = StObject.set(x, "closeNotification", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
    }
  }
}
