...
object mod {
  ...
  object CustomType {
    ...
    inline def apply(toJSONValue: CallbackTo[Any], typeName: CallbackTo[String]): CustomType = {
    ...
    extension [Self <: CustomType](x: Self) {
      ...
      inline def setClone_(value: CallbackTo[CustomType]): Self = StObject.set(x, "clone", value.toJsFn)
      ...
      inline def setToJSONValue(value: CallbackTo[Any]): Self = StObject.set(x, "toJSONValue", value.toJsFn)
