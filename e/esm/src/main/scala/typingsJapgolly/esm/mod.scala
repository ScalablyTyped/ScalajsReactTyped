...
import typingsJapgolly.esm.anon.PartialEsm
import typingsJapgolly.esm.anon.PartialOptions
  ...
  object Options {
    ...
    object Options {
      ...
      inline def apply(
        ...
        wasm: Boolean
      ): typingsJapgolly.esm.mod.Options.Options = {
        ...
        __obj.asInstanceOf[typingsJapgolly.esm.mod.Options.Options]
      }
      
      extension [Self <: typingsJapgolly.esm.mod.Options.Options](x: Self) {
