package typingsJapgolly.electronUniversal
...
object distEsmFileUtilsMod {
  ...
  object AppFileType extends StObject {
    ...
    sealed trait APP_CODE
      extends StObject
         with AppFileType
    /* 4 */ val APP_CODE: typingsJapgolly.electronUniversal.distEsmFileUtilsMod.AppFileType.APP_CODE & Double = js.native
    
    @js.native
    sealed trait INFO_PLIST
      extends StObject
         with AppFileType
    /* 2 */ val INFO_PLIST: typingsJapgolly.electronUniversal.distEsmFileUtilsMod.AppFileType.INFO_PLIST & Double = js.native
    
    @js.native
    sealed trait MACHO
      extends StObject
         with AppFileType
    /* 0 */ val MACHO: typingsJapgolly.electronUniversal.distEsmFileUtilsMod.AppFileType.MACHO & Double = js.native
    
    @js.native
    sealed trait PLAIN
      extends StObject
         with AppFileType
    /* 1 */ val PLAIN: typingsJapgolly.electronUniversal.distEsmFileUtilsMod.AppFileType.PLAIN & Double = js.native
    
    @js.native
    sealed trait SNAPSHOT
      extends StObject
         with AppFileType
    /* 3 */ val SNAPSHOT: typingsJapgolly.electronUniversal.distEsmFileUtilsMod.AppFileType.SNAPSHOT & Double = js.native
  }
