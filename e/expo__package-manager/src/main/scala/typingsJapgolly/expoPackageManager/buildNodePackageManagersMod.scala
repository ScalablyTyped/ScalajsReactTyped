...
import typingsJapgolly.expoPackageManager.buildPnpmPackageManagerMod.PnpmPackageManager
...
object buildNodePackageManagersMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.expoPackageManager.expoPackageManagerStrings.yarn
    - typingsJapgolly.expoPackageManager.expoPackageManagerStrings.npm
    - typingsJapgolly.expoPackageManager.expoPackageManagerStrings.pnpm
  */
  trait NodePackageManager extends StObject
  object NodePackageManager {
    
    inline def npm: typingsJapgolly.expoPackageManager.expoPackageManagerStrings.npm = "npm".asInstanceOf[typingsJapgolly.expoPackageManager.expoPackageManagerStrings.npm]
    
    inline def pnpm: typingsJapgolly.expoPackageManager.expoPackageManagerStrings.pnpm = "pnpm".asInstanceOf[typingsJapgolly.expoPackageManager.expoPackageManagerStrings.pnpm]
    
    inline def yarn: typingsJapgolly.expoPackageManager.expoPackageManagerStrings.yarn = "yarn".asInstanceOf[typingsJapgolly.expoPackageManager.expoPackageManagerStrings.yarn]
  }
}
