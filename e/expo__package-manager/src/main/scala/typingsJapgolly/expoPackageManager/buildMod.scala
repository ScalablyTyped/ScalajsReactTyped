...
import typingsJapgolly.expoPackageManager.buildCocoaPodsPackageManagerMod.CocoaPodsErrorCode
import typingsJapgolly.expoPackageManager.buildNodePackageManagersMod.CreateForProjectOptions
import typingsJapgolly.expoPackageManager.buildNodePackageManagersMod.NodePackageManager
...
object buildMod {
  ...
  open class CocoaPodsError protected ()
    extends typingsJapgolly.expoPackageManager.buildCocoaPodsPackageManagerMod.CocoaPodsError {
  ...
  open class CocoaPodsPackageManager protected ()
    extends typingsJapgolly.expoPackageManager.buildCocoaPodsPackageManagerMod.CocoaPodsPackageManager {
  ...
  open class NpmPackageManager protected ()
    extends typingsJapgolly.expoPackageManager.buildNodePackageManagersMod.NpmPackageManager {
  ...
  open class PnpmPackageManager protected ()
    extends typingsJapgolly.expoPackageManager.buildPnpmPackageManagerMod.PnpmPackageManager {
    def this(hasCwdLogSilent: Log) = this()
  }
  ...
  open class YarnPackageManager protected ()
    extends typingsJapgolly.expoPackageManager.buildNodePackageManagersMod.YarnPackageManager {
    def this(hasCwdLogSilent: Log) = this()
  }
  
  inline def createForProject(projectRoot: String): typingsJapgolly.expoPackageManager.buildNodePackageManagersMod.NpmPackageManager | typingsJapgolly.expoPackageManager.buildNodePackageManagersMod.YarnPackageManager | typingsJapgolly.expoPackageManager.buildPnpmPackageManagerMod.PnpmPackageManager = ^.asInstanceOf[js.Dynamic].applyDynamic("createForProject")(projectRoot.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.expoPackageManager.buildNodePackageManagersMod.NpmPackageManager | typingsJapgolly.expoPackageManager.buildNodePackageManagersMod.YarnPackageManager | typingsJapgolly.expoPackageManager.buildPnpmPackageManagerMod.PnpmPackageManager]
  inline def createForProject(projectRoot: String, options: CreateForProjectOptions): typingsJapgolly.expoPackageManager.buildNodePackageManagersMod.NpmPackageManager | typingsJapgolly.expoPackageManager.buildNodePackageManagersMod.YarnPackageManager | typingsJapgolly.expoPackageManager.buildPnpmPackageManagerMod.PnpmPackageManager = (^.asInstanceOf[js.Dynamic].applyDynamic("createForProject")(projectRoot.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.expoPackageManager.buildNodePackageManagersMod.NpmPackageManager | typingsJapgolly.expoPackageManager.buildNodePackageManagersMod.YarnPackageManager | typingsJapgolly.expoPackageManager.buildPnpmPackageManagerMod.PnpmPackageManager]
