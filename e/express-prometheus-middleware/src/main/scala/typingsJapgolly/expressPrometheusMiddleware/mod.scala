package typingsJapgolly.expressPrometheusMiddleware
...
object mod {
  ...
  object UserOptions {
    ...
    extension [Self <: UserOptions](x: Self) {
      ...
      ): Self = StObject.set(x, "transformLabels", js.Any.fromFunction3((t0: /* labels */ Labels, t1: /* req */ Request_[
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.ParamsDictionary */ Any, 
              Any, 
              Any, 
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], t2: /* res */ Response_[Any, Record[String, Any]]) => (value(t0, t1, t2)).runNow()))
