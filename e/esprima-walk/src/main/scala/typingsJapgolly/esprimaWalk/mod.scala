...
object mod extends js.Object {
  ...
  /**
    ...
    */
  def apply(ast: Program, fn: js.Function1[/* node */ typingsJapgolly.estree.mod.Node, Unit]): Unit = js.native
  def walk(ast: Program, fn: js.Function1[/* node */ typingsJapgolly.estree.mod.Node, Unit]): Unit = js.native
