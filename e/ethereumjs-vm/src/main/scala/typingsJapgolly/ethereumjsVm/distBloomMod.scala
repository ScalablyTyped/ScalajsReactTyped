...
object distBloomMod {
  ...
  object Bloom {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(add = js.Any.fromFunction1((t0: Buffer) => add(t0).runNow()), bitvector = bitvector.asInstanceOf[js.Any], check = js.Any.fromFunction1(check), multiCheck = js.Any.fromFunction1(multiCheck), or = js.Any.fromFunction1((t0: Bloom) => or(t0).runNow()))
      __obj.asInstanceOf[Bloom]
    }
    
    extension [Self <: Bloom](x: Self) {
      
      inline def setAdd(value: Buffer => Callback): Self = StObject.set(x, "add", js.Any.fromFunction1((t0: Buffer) => value(t0).runNow()))
      ...
      inline def setOr(value: Bloom => Callback): Self = StObject.set(x, "or", js.Any.fromFunction1((t0: Bloom) => value(t0).runNow()))
    }
  }
}
