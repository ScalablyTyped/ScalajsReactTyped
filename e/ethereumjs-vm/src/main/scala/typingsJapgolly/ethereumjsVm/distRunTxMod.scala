...
import typingsJapgolly.ethereumjsTx.mod.Transaction
import typingsJapgolly.ethereumjsVm.distBloomMod.default
...
object distRunTxMod {
  ...
  trait RunTxResult
    ...
    /**
      ...
      */
    var amountSpent: typingsJapgolly.bnJs.mod.^
  ...
  object RunTxResult {
    ...
    inline def apply(
      amountSpent: typingsJapgolly.bnJs.mod.^,
      bloom: default,
      execResult: ExecResult,
      gasUsed: typingsJapgolly.bnJs.mod.^
    ): RunTxResult = {
    ...
    extension [Self <: RunTxResult](x: Self) {
      ...
      inline def setAmountSpent(value: typingsJapgolly.bnJs.mod.^): Self = StObject.set(x, "amountSpent", value.asInstanceOf[js.Any])
