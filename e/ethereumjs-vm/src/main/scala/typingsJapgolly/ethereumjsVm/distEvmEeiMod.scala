...
object distEvmEeiMod {
  ...
  open class default protected ()
    ...
    def this(
      env: Env,
      state: typingsJapgolly.ethereumjsVm.distStatePromisifiedMod.default,
      evm: typingsJapgolly.ethereumjsVm.distEvmEvmMod.default,
      common: typingsJapgolly.ethereumjsCommon.mod.default,
      gasLeft: ^
    ) = this()
  }
  ...
  trait EEI extends StObject {
    ...
    def _baseCall(msg: typingsJapgolly.ethereumjsVm.distEvmMessageMod.default): js.Promise[^] = js.native
    
    var _common: typingsJapgolly.ethereumjsCommon.mod.default = js.native
    
    var _env: Env = js.native
    
    var _evm: typingsJapgolly.ethereumjsVm.distEvmEvmMod.default = js.native
  ...
  trait Env extends StObject {
    ...
    var contract: typingsJapgolly.ethereumjsAccount.mod.default
  ...
  object Env {
    ...
    inline def apply(
      ...
      code: Buffer,
      codeAddress: Buffer,
      contract: typingsJapgolly.ethereumjsAccount.mod.default,
      depth: Double,
      gasPrice: Buffer,
      isStatic: Boolean,
      origin: Buffer
    ...
    extension [Self <: Env](x: Self) {
      ...
      inline def setContract(value: typingsJapgolly.ethereumjsAccount.mod.default): Self = StObject.set(x, "contract", value.asInstanceOf[js.Any])
