...
import typingsJapgolly.ethereumjsVm.distEvmEvmMod.EVMResult
import typingsJapgolly.ethereumjsVm.distEvmEvmMod.ExecResult
import typingsJapgolly.ethereumjsVm.distEvmOpcodesMod.OpcodeList
import typingsJapgolly.ethereumjsVm.distRunBlockMod.RunBlockOpts
import typingsJapgolly.ethereumjsVm.distRunBlockMod.RunBlockResult
import typingsJapgolly.ethereumjsVm.distRunCallMod.RunCallOpts
import typingsJapgolly.ethereumjsVm.distRunCodeMod.RunCodeOpts
import typingsJapgolly.ethereumjsVm.distRunTxMod.RunTxOpts
import typingsJapgolly.ethereumjsVm.distRunTxMod.RunTxResult
...
object mod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    var blockchain: typingsJapgolly.ethereumjsBlockchain.mod.default = js.native
    ...
    /* CompleteClass */
    override val pStateManager: typingsJapgolly.ethereumjsVm.distStatePromisifiedMod.default = js.native
  ...
  - Dropped any */ trait VM extends StObject {
    ...
    var blockchain: typingsJapgolly.ethereumjsBlockchain.mod.default
    ...
    val pStateManager: typingsJapgolly.ethereumjsVm.distStatePromisifiedMod.default
  ...
  object VM {
    ...
    inline def apply(
      ...
      blockchain: typingsJapgolly.ethereumjsBlockchain.mod.default,
      copy: CallbackTo[VM],
      opts: VMOpts,
      pStateManager: typingsJapgolly.ethereumjsVm.distStatePromisifiedMod.default,
    ...
    extension [Self <: VM](x: Self) {
      ...
      inline def setBlockchain(value: typingsJapgolly.ethereumjsBlockchain.mod.default): Self = StObject.set(x, "blockchain", value.asInstanceOf[js.Any])
      
      inline def setCopy(value: CallbackTo[VM]): Self = StObject.set(x, "copy", value.toJsFn)
      
      inline def setOpts(value: VMOpts): Self = StObject.set(x, "opts", value.asInstanceOf[js.Any])
      
      inline def setPStateManager(value: typingsJapgolly.ethereumjsVm.distStatePromisifiedMod.default): Self = StObject.set(x, "pStateManager", value.asInstanceOf[js.Any])
  ...
  trait VMOpts extends StObject {
    ...
    /**
      ...
      */
    var blockchain: js.UndefOr[typingsJapgolly.ethereumjsBlockchain.mod.default] = js.undefined
