...
import typingsJapgolly.ethereumjsVm.distEvmEvmMod.default
...
object distRunCodeMod {
  ...
  trait RunCodeOpts extends StObject {
    ...
    var message: js.UndefOr[typingsJapgolly.ethereumjsVm.distEvmMessageMod.default] = js.undefined
    ...
    var txContext: js.UndefOr[typingsJapgolly.ethereumjsVm.distEvmTxContextMod.default] = js.undefined
  ...
  object RunCodeOpts {
    ...
    extension [Self <: RunCodeOpts](x: Self) {
      ...
      inline def setMessage(value: typingsJapgolly.ethereumjsVm.distEvmMessageMod.default): Self = StObject.set(x, "message", value.asInstanceOf[js.Any])
      ...
      inline def setTxContext(value: typingsJapgolly.ethereumjsVm.distEvmTxContextMod.default): Self = StObject.set(x, "txContext", value.asInstanceOf[js.Any])
