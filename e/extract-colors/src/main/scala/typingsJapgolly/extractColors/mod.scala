package typingsJapgolly.extractColors
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setColorValidator(value: (/* red */ Double, /* green */ Double, /* blue */ Double, /* alpha */ Double) => Callback): Self = StObject.set(x, "colorValidator", js.Any.fromFunction4((t0: /* red */ Double, t1: /* green */ Double, t2: /* blue */ Double, t3: /* alpha */ Double) => (value(t0, t1, t2, t3)).runNow()))
