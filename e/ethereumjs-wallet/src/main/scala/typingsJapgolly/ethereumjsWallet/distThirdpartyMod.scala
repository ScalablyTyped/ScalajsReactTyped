...
import typingsJapgolly.ethereumjsWallet.mod.default
...
object distThirdpartyMod {
  ...
  object default {
    ...
    @js.native
    def fromEtherCamp: js.Function1[/* passphrase */ String, typingsJapgolly.ethereumjsWallet.mod.default] = js.native
    inline def fromEtherCamp(passphrase: String): typingsJapgolly.ethereumjsWallet.mod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("fromEtherCamp")(passphrase.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ethereumjsWallet.mod.default]
    inline def fromEtherCamp_=(x: js.Function1[/* passphrase */ String, typingsJapgolly.ethereumjsWallet.mod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fromEtherCamp")(x.asInstanceOf[js.Any])
    ...
    def fromEtherWallet: js.Function2[
        ...
        /* password */ String, 
        typingsJapgolly.ethereumjsWallet.mod.default
      ] = js.native
    inline def fromEtherWallet(input: String, password: String): typingsJapgolly.ethereumjsWallet.mod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEtherWallet")(input.asInstanceOf[js.Any], password.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.ethereumjsWallet.mod.default]
    inline def fromEtherWallet(input: EtherWalletOptions, password: String): typingsJapgolly.ethereumjsWallet.mod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEtherWallet")(input.asInstanceOf[js.Any], password.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.ethereumjsWallet.mod.default]
    ...
    def fromKryptoKit: js.Function2[
        /* entropy */ String, 
        /* password */ String, 
        js.Promise[typingsJapgolly.ethereumjsWallet.mod.default]
      ] = js.native
    inline def fromKryptoKit(entropy: String, password: String): js.Promise[typingsJapgolly.ethereumjsWallet.mod.default] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromKryptoKit")(entropy.asInstanceOf[js.Any], password.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.ethereumjsWallet.mod.default]]
    ...
    @js.native
    def fromQuorumWallet: js.Function2[
        /* passphrase */ String, 
        /* userid */ String, 
        typingsJapgolly.ethereumjsWallet.mod.default
      ] = js.native
    inline def fromQuorumWallet(passphrase: String, userid: String): typingsJapgolly.ethereumjsWallet.mod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("fromQuorumWallet")(passphrase.asInstanceOf[js.Any], userid.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.ethereumjsWallet.mod.default]
