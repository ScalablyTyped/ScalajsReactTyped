...
import typingsJapgolly.ethereumjsWallet.anon.Cipher
import typingsJapgolly.ethereumjsWallet.anon.CipherText
import typingsJapgolly.ethereumjsWallet.anon.PartialV3Params
import typingsJapgolly.ethereumjsWallet.distHdkeyMod.EthereumHDKey
import typingsJapgolly.ethereumjsWallet.distThirdpartyMod.EtherWalletOptions
...
object mod {
  ...
  @js.native
  open class hdkey ()
    extends typingsJapgolly.ethereumjsWallet.distHdkeyMod.default {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ethereumjsWallet.mod.ScryptKDFParamsOut
    - typingsJapgolly.ethereumjsWallet.mod.PBKDFParamsOut
  */
  trait KDFParamsOut extends StObject
  object KDFParamsOut {
    
    inline def PBKDFParamsOut(c: Double, dklen: Double, prf: String, salt: String): typingsJapgolly.ethereumjsWallet.mod.PBKDFParamsOut = {
      ...
      __obj.asInstanceOf[typingsJapgolly.ethereumjsWallet.mod.PBKDFParamsOut]
    }
    
    inline def ScryptKDFParamsOut(dklen: Double, n: Double, p: Double, r: Double, salt: String): typingsJapgolly.ethereumjsWallet.mod.ScryptKDFParamsOut = {
      ...
      __obj.asInstanceOf[typingsJapgolly.ethereumjsWallet.mod.ScryptKDFParamsOut]
    }
  }
