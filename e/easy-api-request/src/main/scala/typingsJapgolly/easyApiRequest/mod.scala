package typingsJapgolly.easyApiRequest

import typingsJapgolly.easyApiRequest.anon.Cb
import typingsJapgolly.easyApiRequest.anon.Config
...
object mod {
  ...
  trait BaseRequest extends StObject {
    ...
    /* protected */ var log: typingsJapgolly.bunyan.mod.^ = js.native
