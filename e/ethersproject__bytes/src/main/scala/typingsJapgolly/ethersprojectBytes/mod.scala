package typingsJapgolly.ethersprojectBytes

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.ethersprojectBytes.anon.R
import typingsJapgolly.ethersprojectBytes.ethersprojectBytesStrings.left
import typingsJapgolly.ethersprojectBytes.ethersprojectBytesStrings.right
...
object mod {
  ...
  object Hexable {
    ...
    inline def apply(toHexString: CallbackTo[String]): Hexable = {
