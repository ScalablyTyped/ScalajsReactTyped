...
import typingsJapgolly.edtrIoMathquill.AnonEdit
...
object Config {
  ...
  def apply(
    ...
    substituteTextarea: js.UndefOr[CallbackTo[HTMLTextAreaElement]] = js.undefined,
    ...
    substituteTextarea.foreach(p => __obj.updateDynamic("substituteTextarea")(p.toJsFn))
