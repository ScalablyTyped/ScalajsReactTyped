...
object buildAssetMod {
  ...
  object DownloadPromiseCallbacks {
    ...
    inline def apply(reject: js.Error => Callback, resolve: Callback): DownloadPromiseCallbacks = {
      val __obj = js.Dynamic.literal(reject = js.Any.fromFunction1((t0: js.Error) => reject(t0).runNow()), resolve = resolve.toJsFn)
