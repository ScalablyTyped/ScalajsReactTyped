...
import typingsJapgolly.expoGl.anon.MsaaSamples
import typingsJapgolly.expoGl.buildGlviewDottypesMod.BaseGLViewProps
...
import typingsJapgolly.expoGl.buildGlviewDottypesMod.GLSnapshot
import typingsJapgolly.expoGl.buildGlviewDottypesMod.SnapshotOptions
import typingsJapgolly.expoGl.buildGlviewDottypesMod.SurfaceCreateEvent
import typingsJapgolly.react.mod.Component
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object buildGlviewMod {
  ...
  object GLViewProps {
    ...
    inline def apply(msaaSamples: Double, onContextCreate: ExpoWebGLRenderingContext => Callback): GLViewProps = {
      val __obj = js.Dynamic.literal(msaaSamples = msaaSamples.asInstanceOf[js.Any], onContextCreate = js.Any.fromFunction1((t0: ExpoWebGLRenderingContext) => onContextCreate(t0).runNow()))
