package typingsJapgolly.expoGl
...
import typingsJapgolly.expoGl.expoGlStrings.`box-none`
import typingsJapgolly.expoGl.expoGlStrings.`box-only`
import typingsJapgolly.expoGl.expoGlStrings.`no-hide-descendants`
import typingsJapgolly.expoGl.expoGlStrings.assertive
import typingsJapgolly.expoGl.expoGlStrings.auto
import typingsJapgolly.expoGl.expoGlStrings.no
import typingsJapgolly.expoGl.expoGlStrings.none
import typingsJapgolly.expoGl.expoGlStrings.polite
import typingsJapgolly.expoGl.expoGlStrings.yes
...
object anon {
  ...
  trait ExglCtxId extends StObject {
    
    var exglCtxId: Double
  }
  object ExglCtxId {
    
    inline def apply(exglCtxId: Double): ExglCtxId = {
      val __obj = js.Dynamic.literal(exglCtxId = exglCtxId.asInstanceOf[js.Any])
  ...
  trait MsaaSamples extends StObject {
    
    var msaaSamples: Double
  }
  object MsaaSamples {
    
    inline def apply(msaaSamples: Double): MsaaSamples = {
      val __obj = js.Dynamic.literal(msaaSamples = msaaSamples.asInstanceOf[js.Any])
  ...
  /* Inlined react-native.react-native.ViewProps & {  canvasRef :react.react.Ref<std.HTMLCanvasElement>} */
  trait ViewPropscanvasRefRefHTML extends StObject {
    ...
    var canvasRef: Ref[HTMLCanvasElement]
  ...
  object ViewPropscanvasRefRefHTML {
    
    inline def apply(): ViewPropscanvasRefRefHTML = {
      val __obj = js.Dynamic.literal(canvasRef = null)
    ...
    extension [Self <: ViewPropscanvasRefRefHTML](x: Self) {
      ...
      inline def setCanvasRef(value: Ref[HTMLCanvasElement]): Self = StObject.set(x, "canvasRef", value.asInstanceOf[js.Any])
      
      inline def setCanvasRefFunction1(value: HTMLCanvasElement | Null => Callback): Self = StObject.set(x, "canvasRef", js.Any.fromFunction1((t0: HTMLCanvasElement | Null) => value(t0).runNow()))
