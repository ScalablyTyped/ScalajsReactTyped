...
import typingsJapgolly.expoGl.anon.ViewPropscanvasRefRefHTML
...
object Canvas {
  ...
  @JSImport("expo-gl/build/Canvas", JSImport.Default)
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def canvasRef(value: Ref[HTMLCanvasElement]): this.type = set("canvasRef", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ViewPropscanvasRefRefHTML): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
