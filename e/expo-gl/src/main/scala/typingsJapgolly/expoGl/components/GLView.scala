package typingsJapgolly.expoGl.components

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.ReactEventFrom
import org.scalajs.dom.Element
import typingsJapgolly.StBuildingComponent
import typingsJapgolly.expoGl.buildGlviewDottypesMod.ComponentOrHandle
import typingsJapgolly.expoGl.buildGlviewDottypesMod.ExpoWebGLRenderingContext
import typingsJapgolly.expoGl.buildGlviewMod.GLViewProps
...
object GLView {
  ...
  inline def apply(msaaSamples: Double, onContextCreate: ExpoWebGLRenderingContext => Callback): Builder = {
    val __props = js.Dynamic.literal(msaaSamples = msaaSamples.asInstanceOf[js.Any], onContextCreate = js.Any.fromFunction1((t0: ExpoWebGLRenderingContext) => onContextCreate(t0).runNow()))
    new Builder(js.Array(this.component, __props.asInstanceOf[GLViewProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.expoGl.mod.GLView] {
    ...
    inline def nativeRef_EXPERIMENTAL(value: /* callback */ ComponentOrHandle | Null => Any): this.type = set("nativeRef_EXPERIMENTAL", js.Any.fromFunction1(value))
  ...
  def withProps(p: GLViewProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
