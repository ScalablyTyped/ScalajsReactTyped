...
import typingsJapgolly.expoGl.anon.ExglCtxId
import typingsJapgolly.expoGl.anon.Height
import typingsJapgolly.expoGl.expoGlStrings.jpeg
import typingsJapgolly.expoGl.expoGlStrings.png
...
object buildGlviewDottypesMod {
  ...
  object GLLoggingOption extends StObject {
    ...
    /* 15 */ val ALL: typingsJapgolly.expoGl.buildGlviewDottypesMod.GLLoggingOption.ALL & Double = js.native
    ...
    sealed trait DISABLED
      extends StObject
         with GLLoggingOption
    /* 0 */ val DISABLED: typingsJapgolly.expoGl.buildGlviewDottypesMod.GLLoggingOption.DISABLED & Double = js.native
    ...
    sealed trait GET_ERRORS
      extends StObject
         with GLLoggingOption
    /* 2 */ val GET_ERRORS: typingsJapgolly.expoGl.buildGlviewDottypesMod.GLLoggingOption.GET_ERRORS & Double = js.native
    ...
    sealed trait METHOD_CALLS
      extends StObject
         with GLLoggingOption
    /* 1 */ val METHOD_CALLS: typingsJapgolly.expoGl.buildGlviewDottypesMod.GLLoggingOption.METHOD_CALLS & Double = js.native
    ...
    sealed trait RESOLVE_CONSTANTS
      extends StObject
         with GLLoggingOption
    /* 4 */ val RESOLVE_CONSTANTS: typingsJapgolly.expoGl.buildGlviewDottypesMod.GLLoggingOption.RESOLVE_CONSTANTS & Double = js.native
    ...
    sealed trait TRUNCATE_STRINGS
      extends StObject
         with GLLoggingOption
    /* 8 */ val TRUNCATE_STRINGS: typingsJapgolly.expoGl.buildGlviewDottypesMod.GLLoggingOption.TRUNCATE_STRINGS & Double = js.native
  }
  ...
  object BaseGLViewProps {
    ...
    inline def apply(onContextCreate: ExpoWebGLRenderingContext => Callback): BaseGLViewProps = {
      val __obj = js.Dynamic.literal(onContextCreate = js.Any.fromFunction1((t0: ExpoWebGLRenderingContext) => onContextCreate(t0).runNow()))
    ...
    extension [Self <: BaseGLViewProps](x: Self) {
      ...
      inline def setOnContextCreate(value: ExpoWebGLRenderingContext => Callback): Self = StObject.set(x, "onContextCreate", js.Any.fromFunction1((t0: ExpoWebGLRenderingContext) => value(t0).runNow()))
    }
  }
  
  type ComponentOrHandle = Null | Double | (Component[Any & js.Object, js.Object]) | (ComponentClassP[Any & js.Object])
