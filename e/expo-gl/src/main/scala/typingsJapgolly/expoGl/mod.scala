...
object mod {
  ...
  object GLLoggingOption extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.expoGl.buildGlviewDottypesMod.GLLoggingOption & Double] = js.native
  ...
  open class GLView protected ()
    extends typingsJapgolly.expoGl.buildGlviewMod.GLView {
