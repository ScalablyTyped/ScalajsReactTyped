...
import typingsJapgolly.expoGl.buildGlviewMod.WebGLObject
...
object buildGlviewDotwebMod {
  ...
  object GLViewProps {
    ...
    inline def apply(msaaSamples: Double, onContextCreate: WebGLRenderingContext => Callback): GLViewProps = {
      val __obj = js.Dynamic.literal(msaaSamples = msaaSamples.asInstanceOf[js.Any], onContextCreate = js.Any.fromFunction1((t0: WebGLRenderingContext) => onContextCreate(t0).runNow()))
    ...
    extension [Self <: GLViewProps](x: Self) {
      ...
      inline def setOnContextCreate(value: WebGLRenderingContext => Callback): Self = StObject.set(x, "onContextCreate", js.Any.fromFunction1((t0: WebGLRenderingContext) => value(t0).runNow()))
      ...
      inline def setOnContextRestored(value: /* gl */ js.UndefOr[WebGLRenderingContext] => Callback): Self = StObject.set(x, "onContextRestored", js.Any.fromFunction1((t0: /* gl */ js.UndefOr[WebGLRenderingContext]) => value(t0).runNow()))
