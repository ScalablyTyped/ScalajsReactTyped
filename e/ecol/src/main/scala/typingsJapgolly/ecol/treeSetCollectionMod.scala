...
import typingsJapgolly.tstl.treeSetMod.TreeSet
import typingsJapgolly.tstl.treeSetMod.TreeSet.Iterator
import typingsJapgolly.tstl.treeSetMod.TreeSet.ReverseIterator
...
object treeSetCollectionMod extends js.Object {
  ...
  class TreeSetCollection[T] ()
    ...
    /* CompleteClass */
    /* InferMemberOverrides */
    override def begin(): typingsJapgolly.tstl.icontainerMod.IContainer.Iterator[T, TreeSet[T], Iterator[T], ReverseIterator[T], T] = js.native
    /**
      * @inheritDoc
      */
    /* InferMemberOverrides */
    ...
    /* CompleteClass */
    /* InferMemberOverrides */
    override def end(): typingsJapgolly.tstl.icontainerMod.IContainer.Iterator[T, TreeSet[T], Iterator[T], ReverseIterator[T], T] = js.native
    /**
  ...
  object TreeSetCollection extends js.Object {
    ...
    type Event[T] = CollectionEvent[
        T, 
        TreeSet[T], 
        typingsJapgolly.tstl.treeSetMod.TreeSet.Iterator[T], 
        typingsJapgolly.tstl.treeSetMod.TreeSet.ReverseIterator[T]
      ]
    /**
      * Iterator of {@link TreeSet}
      */
    type Iterator[Key] = typingsJapgolly.tstl.setElementListMod.SetElementList.Iterator[Key, typingsJapgolly.ecol.ecolBooleans.`true`, TreeSet[Key]]
    ...
    /**
      ...
      */
    type ReverseIterator[Key] = typingsJapgolly.tstl.setElementListMod.SetElementList.ReverseIterator[Key, typingsJapgolly.ecol.ecolBooleans.`true`, TreeSet[Key]]
  }
