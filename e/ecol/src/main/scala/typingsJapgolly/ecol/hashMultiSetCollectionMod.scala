...
import typingsJapgolly.tstl.hashMultiSetMod.HashMultiSet
...
object hashMultiSetCollectionMod extends js.Object {
  ...
  class HashMultiSetCollection[T] ()
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def begin(): typingsJapgolly.tstl.icontainerMod.IContainer.Iterator[T, HashMultiSet[T], Iterator[T], ReverseIterator[T], T] = js.native
    /**
      * @inheritDoc
      */
    /* InferMemberOverrides */
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def end(): typingsJapgolly.tstl.icontainerMod.IContainer.Iterator[T, HashMultiSet[T], Iterator[T], ReverseIterator[T], T] = js.native
    /**
  ...
  object HashMultiSetCollection extends js.Object {
    ...
    type Event[T] = CollectionEvent[
        T, 
        HashMultiSet[T], 
        typingsJapgolly.tstl.hashMultiSetMod.HashMultiSet.Iterator[T], 
        typingsJapgolly.tstl.hashMultiSetMod.HashMultiSet.ReverseIterator[T]
      ]
    /**
      * Iterator of {@link HashMultiSet}
      */
    type Iterator[Key] = typingsJapgolly.tstl.setElementListMod.SetElementList.Iterator[Key, typingsJapgolly.ecol.ecolBooleans.`false`, HashMultiSet[Key]]
    ...
    /**
      ...
      */
    type ReverseIterator[Key] = typingsJapgolly.tstl.setElementListMod.SetElementList.ReverseIterator[Key, typingsJapgolly.ecol.ecolBooleans.`false`, HashMultiSet[Key]]
  }
