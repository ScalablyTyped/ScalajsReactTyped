...
object hashMapCollectionMod extends js.Object {
  ...
  class HashMapCollection[Key, T] ()
    ...
    /* CompleteClass */
    /* InferMemberOverrides */
    override def begin(): typingsJapgolly.tstl.icontainerMod.IContainer.Iterator[Entry[Key, T], HashMap[Key, T], Iterator[Key, T], ReverseIterator[Key, T], IPair[Key, T]] = js.native
    /**
      * @inheritDoc
      */
    /* InferMemberOverrides */
    ...
    /* CompleteClass */
    /* InferMemberOverrides */
    override def end(): typingsJapgolly.tstl.icontainerMod.IContainer.Iterator[Entry[Key, T], HashMap[Key, T], Iterator[Key, T], ReverseIterator[Key, T], IPair[Key, T]] = js.native
    /**
  ...
  object HashMapCollection extends js.Object {
    ...
    type Event[Key, T] = CollectionEvent[
        Entry[Key, T], 
        HashMap[Key, T], 
        typingsJapgolly.tstl.hashMapMod.HashMap.Iterator[Key, T], 
        typingsJapgolly.tstl.hashMapMod.HashMap.ReverseIterator[Key, T]
      ]
    /**
      * Iterator of {@link HashMap}
      */
    type Iterator[Key, T] = typingsJapgolly.tstl.mapElementListMod.MapElementList.Iterator[Key, T, typingsJapgolly.ecol.ecolBooleans.`true`, HashMap[Key, T]]
    ...
    /**
      ...
      */
    type ReverseIterator[Key, T] = typingsJapgolly.tstl.mapElementListMod.MapElementList.ReverseIterator[Key, T, typingsJapgolly.ecol.ecolBooleans.`true`, HashMap[Key, T]]
  }
