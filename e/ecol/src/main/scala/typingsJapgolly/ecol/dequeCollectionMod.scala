...
object dequeCollectionMod extends js.Object {
  ...
  class DequeCollection[T] ()
    ...
    /* CompleteClass */
    /* InferMemberOverrides */
    override def begin(): typingsJapgolly.tstl.icontainerMod.IContainer.Iterator[T, Deque[T], Iterator[T], ReverseIterator[T], T] = js.native
    /**
      * @inheritDoc
      */
    /* InferMemberOverrides */
    ...
    /* CompleteClass */
    /* InferMemberOverrides */
    override def end(): typingsJapgolly.tstl.icontainerMod.IContainer.Iterator[T, Deque[T], Iterator[T], ReverseIterator[T], T] = js.native
    /**
  ...
  object DequeCollection extends js.Object {
    ...
    type Event[T] = CollectionEvent[
        T, 
        Deque[T], 
        typingsJapgolly.tstl.dequeMod.Deque.Iterator[T], 
        typingsJapgolly.tstl.dequeMod.Deque.ReverseIterator[T]
      ]
    /**
