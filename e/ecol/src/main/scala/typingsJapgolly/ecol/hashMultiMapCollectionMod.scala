...
import typingsJapgolly.tstl.hashMultiMapMod.HashMultiMap
...
object hashMultiMapCollectionMod extends js.Object {
  ...
  object HashMultiMapCollection extends js.Object {
    ...
    type Event[Key, T] = CollectionEvent[
        Entry[Key, T], 
        HashMultiMap[Key, T], 
        typingsJapgolly.tstl.hashMultiMapMod.HashMultiMap.Iterator[Key, T], 
        typingsJapgolly.tstl.hashMultiMapMod.HashMultiMap.ReverseIterator[Key, T]
      ]
    /**
      * Iterator of {@link HashMultiMap}
      */
    type Iterator[Key, T] = typingsJapgolly.tstl.mapElementListMod.MapElementList.Iterator[Key, T, typingsJapgolly.ecol.ecolBooleans.`false`, HashMultiMap[Key, T]]
    ...
    /**
      ...
      */
    type ReverseIterator[Key, T] = typingsJapgolly.tstl.mapElementListMod.MapElementList.ReverseIterator[Key, T, typingsJapgolly.ecol.ecolBooleans.`false`, HashMultiMap[Key, T]]
  }
