...
import typingsJapgolly.tstl.hashSetMod.HashSet
...
object hashSetCollectionMod extends js.Object {
  ...
  class HashSetCollection[T] ()
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def begin(): typingsJapgolly.tstl.icontainerMod.IContainer.Iterator[T, HashSet[T], Iterator[T], ReverseIterator[T], T] = js.native
    /**
      * @inheritDoc
      */
    /* InferMemberOverrides */
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def end(): typingsJapgolly.tstl.icontainerMod.IContainer.Iterator[T, HashSet[T], Iterator[T], ReverseIterator[T], T] = js.native
    /**
  ...
  object HashSetCollection extends js.Object {
    ...
    type Event[T] = CollectionEvent[
        T, 
        HashSet[T], 
        typingsJapgolly.tstl.hashSetMod.HashSet.Iterator[T], 
        typingsJapgolly.tstl.hashSetMod.HashSet.ReverseIterator[T]
      ]
    /**
      * Iterator of {@link HashSet}
      */
    type Iterator[Key] = typingsJapgolly.tstl.setElementListMod.SetElementList.Iterator[Key, typingsJapgolly.ecol.ecolBooleans.`true`, HashSet[Key]]
    ...
    /**
      ...
      */
    type ReverseIterator[Key] = typingsJapgolly.tstl.setElementListMod.SetElementList.ReverseIterator[Key, typingsJapgolly.ecol.ecolBooleans.`true`, HashSet[Key]]
  }
