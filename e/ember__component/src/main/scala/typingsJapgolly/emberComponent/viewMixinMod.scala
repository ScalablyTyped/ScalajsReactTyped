package typingsJapgolly.emberComponent
...
object viewMixinMod extends js.Object {
  ...
  val default: typingsJapgolly.emberObject.mixinMod.default[ViewMixin, typingsJapgolly.emberObject.mod.default] = js.native
}
