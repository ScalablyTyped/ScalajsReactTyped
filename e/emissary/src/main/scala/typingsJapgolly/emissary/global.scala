...
import typingsJapgolly.emissary.mod.IEmitter
import typingsJapgolly.emissary.mod.IEmitterStatic
import typingsJapgolly.emissary.mod.ISubscriber
import typingsJapgolly.emissary.mod.ISubscriberStatic
