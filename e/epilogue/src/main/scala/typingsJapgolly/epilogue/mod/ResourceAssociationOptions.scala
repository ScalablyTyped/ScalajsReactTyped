...
import typingsJapgolly.sequelize.mod.AssociationForeignKeyOptions
import typingsJapgolly.sequelize.mod.AssociationOptions
import typingsJapgolly.sequelize.mod.AssociationScope
