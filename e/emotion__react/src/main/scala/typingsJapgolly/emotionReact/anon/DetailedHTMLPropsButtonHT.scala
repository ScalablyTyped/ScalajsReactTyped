...
import typingsJapgolly.emotionReact.emotionReactStrings.button
...
import typingsJapgolly.emotionReact.emotionReactStrings.reset
...
import typingsJapgolly.emotionReact.emotionReactStrings.submit
...
object DetailedHTMLPropsButtonHT {
  ...
  inline def apply(): DetailedHTMLPropsButtonHT = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsButtonHT]
  }
  
  extension [Self <: DetailedHTMLPropsButtonHT](x: Self) {
