...
import typingsJapgolly.emotionReact.emotionReactStrings.`lazy`
...
import typingsJapgolly.emotionReact.emotionReactStrings.async
...
import typingsJapgolly.emotionReact.emotionReactStrings.eager
...
import typingsJapgolly.emotionReact.emotionReactStrings.sync
...
/* Inlined react.react.DetailedHTMLProps<react.react.ImgHTMLAttributes<std.HTMLImageElement>, std.HTMLImageElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
trait DetailedHTMLPropsImgHTMLA extends StObject {
...
object DetailedHTMLPropsImgHTMLA {
  
  inline def apply(): DetailedHTMLPropsImgHTMLA = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsImgHTMLA]
  }
  
  extension [Self <: DetailedHTMLPropsImgHTMLA](x: Self) {
