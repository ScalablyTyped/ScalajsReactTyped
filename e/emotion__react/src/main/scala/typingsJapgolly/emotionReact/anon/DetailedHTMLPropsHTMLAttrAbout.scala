...
/* Inlined react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLElement>, std.HTMLElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
trait DetailedHTMLPropsHTMLAttrAbout extends StObject {
...
object DetailedHTMLPropsHTMLAttrAbout {
  
  inline def apply(): DetailedHTMLPropsHTMLAttrAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsHTMLAttrAbout]
  }
  
  extension [Self <: DetailedHTMLPropsHTMLAttrAbout](x: Self) {
