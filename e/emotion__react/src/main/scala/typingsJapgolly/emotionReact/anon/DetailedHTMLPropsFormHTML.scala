...
/* Inlined react.react.DetailedHTMLProps<react.react.FormHTMLAttributes<std.HTMLFormElement>, std.HTMLFormElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
...
object DetailedHTMLPropsFormHTML {
  
  inline def apply(): DetailedHTMLPropsFormHTML = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsFormHTML]
  }
  
  extension [Self <: DetailedHTMLPropsFormHTML](x: Self) {
    ...
    inline def setOnSubmit(value: ReactEventFrom[HTMLFormElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onSubmit", js.Any.fromFunction1((t0: ReactEventFrom[HTMLFormElement & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def setRefFunction1(value: HTMLFormElement | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: HTMLFormElement | Null) => value(t0).runNow()))
