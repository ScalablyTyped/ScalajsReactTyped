...
import typingsJapgolly.expressServeStaticCore.expressServeStaticCoreBooleans.`false`
import typingsJapgolly.expressServeStaticCore.expressServeStaticCoreStrings.`set-cookie`
import typingsJapgolly.node.AnonEnd
import typingsJapgolly.node.NodeJS.WritableStream
import typingsJapgolly.node.httpMod.IncomingMessage
import typingsJapgolly.node.httpMod.ServerResponse
import typingsJapgolly.rangeParser.mod.Options
import typingsJapgolly.rangeParser.mod.Ranges
import typingsJapgolly.rangeParser.mod.Result
...
trait Request[P /* <: Params */, ResBody, ReqBody]
  extends IncomingMessage
     with typingsJapgolly.expressServeStaticCore.mod._Global_.Express.Request {
  /**
