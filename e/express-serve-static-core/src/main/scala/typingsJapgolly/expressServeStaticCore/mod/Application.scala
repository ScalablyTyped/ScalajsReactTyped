...
- typingsJapgolly.expressServeStaticCore.mod.RequestHandler because Inheritance from two classes. Inlined `<apply>`
...
trait Application
  extends EventEmitter
     with typingsJapgolly.expressServeStaticCore.mod._Global_.Express.Application {
  /**
