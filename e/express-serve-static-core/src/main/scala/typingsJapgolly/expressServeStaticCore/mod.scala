...
import typingsJapgolly.expressServeStaticCore.expressServeStaticCoreStrings.auto
...
object mod {
  ...
  trait Application
    extends IRouter
       with typingsJapgolly.expressServeStaticCore.Express.Application {
  ...
  trait Request
    extends StObject
       with typingsJapgolly.expressServeStaticCore.Express.Request {
  ...
  trait Response
    extends ServerResponse[IncomingMessage]
       with typingsJapgolly.expressServeStaticCore.Express.Response {
