...
trait JSXEmptyExpression extends BaseNode {
  @JSName("type")
  var type_JSXEmptyExpression: typingsJapgolly.estreeJsx.estreeJsxStrings.JSXEmptyExpression
}

object JSXEmptyExpression {
  @scala.inline
  def apply(
    `type`: typingsJapgolly.estreeJsx.estreeJsxStrings.JSXEmptyExpression,
