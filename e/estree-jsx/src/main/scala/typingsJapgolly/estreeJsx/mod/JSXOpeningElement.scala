...
trait JSXOpeningElement extends JSXBoundaryElement {
  ...
  @JSName("type")
  var type_JSXOpeningElement: typingsJapgolly.estreeJsx.estreeJsxStrings.JSXOpeningElement
}
...
object JSXOpeningElement {
  ...
  def apply(
    ...
    selfClosing: Boolean,
    `type`: typingsJapgolly.estreeJsx.estreeJsxStrings.JSXOpeningElement,
