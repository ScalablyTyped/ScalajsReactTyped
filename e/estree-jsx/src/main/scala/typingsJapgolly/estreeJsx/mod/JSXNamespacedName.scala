...
trait JSXNamespacedName extends BaseNode {
  @JSName("type")
  var type_JSXNamespacedName: typingsJapgolly.estreeJsx.estreeJsxStrings.JSXNamespacedName
}

object JSXNamespacedName {
  @scala.inline
  def apply(
    `type`: typingsJapgolly.estreeJsx.estreeJsxStrings.JSXNamespacedName,
