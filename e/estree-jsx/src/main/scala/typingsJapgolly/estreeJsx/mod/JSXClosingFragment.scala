...
trait JSXClosingFragment extends BaseNode {
  @JSName("type")
  var type_JSXClosingFragment: typingsJapgolly.estreeJsx.estreeJsxStrings.JSXClosingFragment
}

object JSXClosingFragment {
  @scala.inline
  def apply(
    `type`: typingsJapgolly.estreeJsx.estreeJsxStrings.JSXClosingFragment,
