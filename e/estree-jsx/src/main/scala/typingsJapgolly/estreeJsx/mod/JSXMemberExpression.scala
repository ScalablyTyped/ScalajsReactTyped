...
trait JSXMemberExpression extends BaseNode {
  @JSName("type")
  var type_JSXMemberExpression: typingsJapgolly.estreeJsx.estreeJsxStrings.JSXMemberExpression
}

object JSXMemberExpression {
  @scala.inline
  def apply(
    `type`: typingsJapgolly.estreeJsx.estreeJsxStrings.JSXMemberExpression,
