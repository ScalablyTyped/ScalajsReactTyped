...
object observableMod extends js.Object {
  ...
  trait Observable extends js.Object {
    ...
    {[ KK in K ]: any}
      */ typingsJapgolly.emberObject.emberObjectStrings.Observable with js.Any
  ...
  val default: typingsJapgolly.emberObject.mixinMod.default[Observable, typingsJapgolly.emberObject.coreMod.default] = js.native
}
