package typingsJapgolly.emberObject.actionHandlerMod
...
object ActionHandler {
  @scala.inline
  def apply(actions: ActionsHash, send: (String, /* repeated */ js.Any) => Callback): ActionHandler = {
    val __obj = js.Dynamic.literal(actions = actions.asInstanceOf[js.Any])
    __obj.updateDynamic("send")(js.Any.fromFunction2((t0: java.lang.String, t1: /* repeated */ js.Any) => send(t0, t1).runNow()))
