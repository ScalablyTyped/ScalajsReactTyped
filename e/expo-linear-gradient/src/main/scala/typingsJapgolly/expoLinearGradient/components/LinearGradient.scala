...
import typingsJapgolly.expoLinearGradient.mod.LinearGradientPoint
import typingsJapgolly.expoLinearGradient.mod.LinearGradientProps
...
object LinearGradient {
  ...
  inline def apply(colors: js.Array[String]): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.expoLinearGradient.mod.LinearGradient] {
    ...
    inline def end(value: LinearGradientPoint): this.type = set("end", value.asInstanceOf[js.Any])
    ...
    inline def locations(value: js.Array[Double]): this.type = set("locations", value.asInstanceOf[js.Any])
    
    inline def locationsNull: this.type = set("locations", null)
    
    inline def locationsVarargs(value: Double*): this.type = set("locations", js.Array(value*))
    ...
    inline def start(value: LinearGradientPoint): this.type = set("start", value.asInstanceOf[js.Any])
