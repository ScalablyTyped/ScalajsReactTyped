...
import typingsJapgolly.expoLinearGradient.buildNativeLinearGradientDottypesMod.NativeLinearGradientPoint
...
object NativeLinearGradientDotios {
  ...
  inline def apply(colors: js.Array[Double]): Builder = {
    val __props = js.Dynamic.literal(colors = colors.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[NativeLinearGradientProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def endPoint(value: NativeLinearGradientPoint): this.type = set("endPoint", value.asInstanceOf[js.Any])
    
    inline def endPointNull: this.type = set("endPoint", null)
    ...
    inline def startPoint(value: NativeLinearGradientPoint): this.type = set("startPoint", value.asInstanceOf[js.Any])
    
    inline def startPointNull: this.type = set("startPoint", null)
  ...
  def withProps(p: NativeLinearGradientProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
