...
object mod {
  ...
  */
  ...
  object KeyEventType {
    ...
    inline def keydown: typingsJapgolly.emberTestingHelpers.emberTestingHelpersStrings.keydown = "keydown".asInstanceOf[typingsJapgolly.emberTestingHelpers.emberTestingHelpersStrings.keydown]
    
    inline def keypress: typingsJapgolly.emberTestingHelpers.emberTestingHelpersStrings.keypress = "keypress".asInstanceOf[typingsJapgolly.emberTestingHelpers.emberTestingHelpersStrings.keypress]
    
    inline def keyup: typingsJapgolly.emberTestingHelpers.emberTestingHelpersStrings.keyup = "keyup".asInstanceOf[typingsJapgolly.emberTestingHelpers.emberTestingHelpersStrings.keyup]
  }
