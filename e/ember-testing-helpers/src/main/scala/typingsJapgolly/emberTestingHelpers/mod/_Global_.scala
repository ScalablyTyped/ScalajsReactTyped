...
object _Global_ extends js.Object {
  ...
  def find(selector: String): JQuery_[Node] = js.native
  def find(selector: String, context: js.Object): JQuery_[Node] = js.native
  // https://github.com/emberjs/ember.js/blob/master/packages/ember-testing/lib/helpers/find_with_assert.js
  def findWithAssert(selector: String): JQuery_[Node] = js.native
  def findWithAssert(selector: String, context: js.Object): JQuery_[Node] = js.native
