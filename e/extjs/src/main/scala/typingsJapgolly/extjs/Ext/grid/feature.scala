...
object feature {
  ...
  object IAbstractSummary {
    ...
    extension [Self <: IAbstractSummary](x: Self) {
      ...
      inline def setToggleSummaryRow(value: /* visible */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "toggleSummaryRow", js.Any.fromFunction1((t0: /* visible */ js.UndefOr[Boolean]) => value(t0).runNow()))
  ...
  object IFeature {
    ...
    extension [Self <: IFeature](x: Self) {
      ...
      inline def setGetFireEventArgs(
        value: (/* eventName */ js.UndefOr[Any], /* view */ js.UndefOr[Any], /* featureTarget */ js.UndefOr[Any], /* e */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "getFireEventArgs", js.Any.fromFunction4((t0: /* eventName */ js.UndefOr[Any], t1: /* view */ js.UndefOr[Any], t2: /* featureTarget */ js.UndefOr[Any], t3: /* e */ js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
  ...
  object IGrouping {
    ...
    extension [Self <: IGrouping](x: Self) {
      ...
      inline def setCollapse(value: (/* groupName */ js.UndefOr[String], /* focus */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "collapse", js.Any.fromFunction2((t0: /* groupName */ js.UndefOr[String], t1: /* focus */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
      ...
      inline def setExpand(value: (/* groupName */ js.UndefOr[String], /* focus */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "expand", js.Any.fromFunction2((t0: /* groupName */ js.UndefOr[String], t1: /* focus */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
  ...
  object IRowBody {
    ...
    extension [Self <: IRowBody](x: Self) {
      ...
      inline def setGetAdditionalData(
        value: (/* data */ js.UndefOr[Any], /* idx */ js.UndefOr[Double], /* record */ js.UndefOr[IModel], /* orig */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "getAdditionalData", js.Any.fromFunction4((t0: /* data */ js.UndefOr[Any], t1: /* idx */ js.UndefOr[Double], t2: /* record */ js.UndefOr[IModel], t3: /* orig */ js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
