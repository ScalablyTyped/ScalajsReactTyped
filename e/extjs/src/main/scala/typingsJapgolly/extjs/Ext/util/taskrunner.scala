...
object taskrunner {
  ...
  object ITask {
    ...
    extension [Self <: ITask](x: Self) {
      ...
      inline def setRestart(value: /* interval */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "restart", js.Any.fromFunction1((t0: /* interval */ js.UndefOr[Double]) => value(t0).runNow()))
      
      inline def setRestartUndefined: Self = StObject.set(x, "restart", js.undefined)
      
      inline def setStart(value: /* interval */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "start", js.Any.fromFunction1((t0: /* interval */ js.UndefOr[Double]) => value(t0).runNow()))
