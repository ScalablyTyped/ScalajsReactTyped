...
object action {
  ...
  object IAction {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.form.action.IAction = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.form.action.IAction]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.form.action.IAction](x: Self) {
  ...
  trait ILoad
    extends StObject
       with typingsJapgolly.extjs.Ext.form.action.IAction
  object ILoad {
