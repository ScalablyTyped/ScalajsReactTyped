...
import typingsJapgolly.extjs.Ext.picker.IColor
...
object menu {
  ...
  object ICheckItem {
    ...
    extension [Self <: ICheckItem](x: Self) {
      ...
      inline def setDisableCheckChange(value: Callback): Self = StObject.set(x, "disableCheckChange", value.toJsFn)
      
      inline def setDisableCheckChangeUndefined: Self = StObject.set(x, "disableCheckChange", js.undefined)
      
      inline def setEnableCheckChange(value: Callback): Self = StObject.set(x, "enableCheckChange", value.toJsFn)
      ...
      inline def setSetChecked(value: (/* checked */ js.UndefOr[Boolean], /* suppressEvents */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "setChecked", js.Any.fromFunction2((t0: /* checked */ js.UndefOr[Boolean], t1: /* suppressEvents */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
  ...
  trait IDatePicker
    ...
    var picker: js.UndefOr[typingsJapgolly.extjs.Ext.picker.IDate] = js.undefined
  ...
  object IDatePicker {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.menu.IDatePicker = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.menu.IDatePicker]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.menu.IDatePicker](x: Self) {
      
      inline def setHideOnClick(value: Boolean): Self = StObject.set(x, "hideOnClick", value.asInstanceOf[js.Any])
      
      inline def setHideOnClickUndefined: Self = StObject.set(x, "hideOnClick", js.undefined)
      
      inline def setPicker(value: typingsJapgolly.extjs.Ext.picker.IDate): Self = StObject.set(x, "picker", value.asInstanceOf[js.Any])
  ...
  - typingsJapgolly.extjs.Ext.IQueryable because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined child, down, query, queryBy, queryById */ trait IItem
    extends StObject
       with IComponent {
  ...
  object IItem {
    ...
    extension [Self <: IItem](x: Self) {
      ...
      inline def setOnRemoved(value: Callback): Self = StObject.set(x, "onRemoved", value.toJsFn)
      ...
      inline def setSetMenu(value: (/* menu */ js.UndefOr[Any], /* destroyMenu */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "setMenu", js.Any.fromFunction2((t0: /* menu */ js.UndefOr[Any], t1: /* destroyMenu */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
  ...
  type IKeyNav = typingsJapgolly.extjs.Ext.util.IKeyNav
  ...
  object IMenu {
    ...
    extension [Self <: IMenu](x: Self) {
      ...
      inline def setDeactivateActiveItem(value: /* andBlurFocusedItem */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "deactivateActiveItem", js.Any.fromFunction1((t0: /* andBlurFocusedItem */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  - typingsJapgolly.extjs.Ext.IClass because Already inherited
  - typingsJapgolly.extjs.Ext.IBase because Already inherited
  - typingsJapgolly.extjs.Ext.IQueryable because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined child, down, query, queryBy, queryById */ trait ITextItem
    extends StObject
       with IComponent {
