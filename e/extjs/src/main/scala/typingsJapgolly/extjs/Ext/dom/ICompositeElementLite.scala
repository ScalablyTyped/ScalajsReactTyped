...
object ICompositeElementLite {
  @scala.inline
  def apply(
    add: /* els */ js.UndefOr[js.Any] => CallbackTo[ICompositeElement] = null,
    alias: Array = null,
    ...
    each: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[ICompositeElement] = null,
    elements: Array = null,
    extend: String = null,
    fill: /* els */ js.UndefOr[js.Any] => CallbackTo[ICompositeElement] = null,
    filter: /* selector */ js.UndefOr[js.Any] => CallbackTo[ICompositeElement] = null,
    first: js.UndefOr[CallbackTo[IElement]] = js.undefined,
    ...
    last: js.UndefOr[CallbackTo[IElement]] = js.undefined,
    mixins: js.Any = null,
    removeElement: (/* el */ js.UndefOr[js.Any], /* removeDom */ js.UndefOr[Boolean]) => CallbackTo[ICompositeElement] = null,
    replaceElement: (/* el */ js.UndefOr[js.Any], /* replacement */ js.UndefOr[js.Any], /* domReplace */ js.UndefOr[Boolean]) => CallbackTo[ICompositeElement] = null,
    requires: Array = null,
    self: IClass = null,
