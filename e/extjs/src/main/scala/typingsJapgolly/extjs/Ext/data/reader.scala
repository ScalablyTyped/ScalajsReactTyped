...
object reader {
  ...
  trait IJson
    extends StObject
       with typingsJapgolly.extjs.Ext.data.reader.IReader {
  ...
  object IReader {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.data.reader.IReader = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.data.reader.IReader]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.data.reader.IReader](x: Self) {
