...
import typingsJapgolly.extjs.Ext.util.IAnimate
...
object draw {
  ...
  object IColor {
    ...
    extension [Self <: IColor](x: Self) {
      ...
      inline def setGetBlue(value: CallbackTo[Double]): Self = StObject.set(x, "getBlue", value.toJsFn)
      ...
      inline def setGetGreen(value: CallbackTo[Double]): Self = StObject.set(x, "getGreen", value.toJsFn)
      
      inline def setGetGreenUndefined: Self = StObject.set(x, "getGreen", js.undefined)
      
      inline def setGetHSL(value: CallbackTo[Array]): Self = StObject.set(x, "getHSL", value.toJsFn)
      ...
      inline def setGetRGB(value: CallbackTo[Array]): Self = StObject.set(x, "getRGB", value.toJsFn)
      
      inline def setGetRGBUndefined: Self = StObject.set(x, "getRGB", js.undefined)
      
      inline def setGetRed(value: CallbackTo[Double]): Self = StObject.set(x, "getRed", value.toJsFn)
      ...
      inline def setToString_(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "toString", value.toJsFn)
  ...
  trait IComponent
    extends StObject
       with typingsJapgolly.extjs.Ext.IComponent {
  ...
  object IComponent {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.draw.IComponent = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.draw.IComponent]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.draw.IComponent](x: Self) {
  ...
  object ICompositeSprite {
    ...
    extension [Self <: ICompositeSprite](x: Self) {
      ...
      inline def setAddCls(value: /* cls */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "addCls", js.Any.fromFunction1((t0: /* cls */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      ...
      inline def setGetBBox(value: CallbackTo[Any]): Self = StObject.set(x, "getBBox", value.toJsFn)
      ...
      inline def setRemoveCls(value: /* cls */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "removeCls", js.Any.fromFunction1((t0: /* cls */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setRemoveClsUndefined: Self = StObject.set(x, "removeCls", js.undefined)
      
      inline def setRemoveListener(
        value: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "removeListener", js.Any.fromFunction3((t0: /* eventName */ js.UndefOr[java.lang.String], t1: /* fn */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setSetStyle(value: /* style */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setStyle", js.Any.fromFunction1((t0: /* style */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      ...
      inline def setSortByKey(value: (/* direction */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "sortByKey", js.Any.fromFunction2((t0: /* direction */ js.UndefOr[java.lang.String], t1: /* fn */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
      ...
      inline def setUn(
        value: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "un", js.Any.fromFunction3((t0: /* eventName */ js.UndefOr[java.lang.String], t1: /* fn */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
  ...
  object ISprite {
    ...
    extension [Self <: ISprite](x: Self) {
      ...
      inline def setRedraw(value: CallbackTo[ISprite]): Self = StObject.set(x, "redraw", value.toJsFn)
  ...
  object ISpriteDD {
    ...
    extension [Self <: ISpriteDD](x: Self) {
      ...
      inline def setSetDragElPos(value: Callback): Self = StObject.set(x, "setDragElPos", value.toJsFn)
  ...
  object ISurface {
    ...
    extension [Self <: ISurface](x: Self) {
      ...
      inline def setAddCls(value: (/* sprite */ js.UndefOr[Any], /* className */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "addCls", js.Any.fromFunction2((t0: /* sprite */ js.UndefOr[Any], t1: /* className */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
      
      inline def setAddClsUndefined: Self = StObject.set(x, "addCls", js.undefined)
      
      inline def setAddGradient(value: /* gradient */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "addGradient", js.Any.fromFunction1((t0: /* gradient */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setGetId(value: Callback): Self = StObject.set(x, "getId", value.toJsFn)
      ...
      inline def setRemoveAll(value: /* destroySprites */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "removeAll", js.Any.fromFunction1((t0: /* destroySprites */ js.UndefOr[Boolean]) => value(t0).runNow()))
      
      inline def setRemoveAllUndefined: Self = StObject.set(x, "removeAll", js.undefined)
      
      inline def setRemoveCls(value: (/* sprite */ js.UndefOr[Any], /* className */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "removeCls", js.Any.fromFunction2((t0: /* sprite */ js.UndefOr[Any], t1: /* className */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
      
      inline def setRemoveClsUndefined: Self = StObject.set(x, "removeCls", js.undefined)
      
      inline def setRemoveUndefined: Self = StObject.set(x, "remove", js.undefined)
      
      inline def setSetSize(value: (/* w */ js.UndefOr[Double], /* h */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "setSize", js.Any.fromFunction2((t0: /* w */ js.UndefOr[Double], t1: /* h */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
      
      inline def setSetSizeUndefined: Self = StObject.set(x, "setSize", js.undefined)
      
      inline def setSetStyle(value: (/* sprite */ js.UndefOr[Any], /* styles */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "setStyle", js.Any.fromFunction2((t0: /* sprite */ js.UndefOr[Any], t1: /* styles */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
      
      inline def setSetStyleUndefined: Self = StObject.set(x, "setStyle", js.undefined)
      
      inline def setSetText(value: (/* sprite */ js.UndefOr[Any], /* text */ js.UndefOr[java.lang.String]) => Callback): Self = StObject.set(x, "setText", js.Any.fromFunction2((t0: /* sprite */ js.UndefOr[Any], t1: /* text */ js.UndefOr[java.lang.String]) => (value(t0, t1)).runNow()))
  ...
  trait IText
    extends StObject
       with typingsJapgolly.extjs.Ext.draw.IComponent {
  ...
  object IText {
    ...
    extension [Self <: IText](x: Self) {
      ...
      inline def setSetAngle(value: /* degrees */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setAngle", js.Any.fromFunction1((t0: /* degrees */ js.UndefOr[Double]) => value(t0).runNow()))
      
      inline def setSetAngleUndefined: Self = StObject.set(x, "setAngle", js.undefined)
      
      inline def setSetText(value: /* t */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setText", js.Any.fromFunction1((t0: /* t */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
  ...
  object engine {
    ...
    object ISvg {
      ...
      extension [Self <: ISvg](x: Self) {
        ...
        inline def setApplyZIndex(value: /* sprite */ js.UndefOr[ISprite] => Callback): Self = StObject.set(x, "applyZIndex", js.Any.fromFunction1((t0: /* sprite */ js.UndefOr[ISprite]) => value(t0).runNow()))
        
        inline def setApplyZIndexUndefined: Self = StObject.set(x, "applyZIndex", js.undefined)
        
        inline def setGetRegion(value: CallbackTo[IRegion]): Self = StObject.set(x, "getRegion", value.toJsFn)
        ...
        inline def setSetSize(value: (/* width */ js.UndefOr[Any], /* height */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "setSize", js.Any.fromFunction2((t0: /* width */ js.UndefOr[Any], t1: /* height */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
        
        inline def setSetSizeUndefined: Self = StObject.set(x, "setSize", js.undefined)
        
        inline def setSetText(value: (/* sprite */ js.UndefOr[Any], /* textString */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "setText", js.Any.fromFunction2((t0: /* sprite */ js.UndefOr[Any], t1: /* textString */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    ...
    object IVml {
      ...
      extension [Self <: IVml](x: Self) {
        ...
        inline def setSetText(value: (/* sprite */ js.UndefOr[Any], /* text */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "setText", js.Any.fromFunction2((t0: /* sprite */ js.UndefOr[Any], t1: /* text */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
