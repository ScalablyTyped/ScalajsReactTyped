...
object IDataViewModel {
  ...
  def apply(
    ...
    getLastSelected: js.UndefOr[CallbackTo[IDataViewModel]] = js.undefined,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IDataViewModel] = null,
    isFocused: /* record */ js.UndefOr[IDataViewModel] => Callback = null,
    ...
    self: IClass = null,
    setLastFocused: /* record */ js.UndefOr[IDataViewModel] => Callback = null,
    ...
    if (isFocused != null) __obj.updateDynamic("isFocused")(js.Any.fromFunction1((t0: /* record */ js.UndefOr[typingsJapgolly.extjs.Ext.selection.IDataViewModel]) => isFocused(t0).runNow()))
    ...
    if (setLastFocused != null) __obj.updateDynamic("setLastFocused")(js.Any.fromFunction1((t0: /* record */ js.UndefOr[typingsJapgolly.extjs.Ext.selection.IDataViewModel]) => setLastFocused(t0).runNow()))
