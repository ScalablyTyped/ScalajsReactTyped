...
object IAbstractManager {
  ...
  extension [Self <: IAbstractManager](x: Self) {
    ...
    inline def setOnAvailable(
      value: (/* id */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "onAvailable", js.Any.fromFunction3((t0: /* id */ js.UndefOr[java.lang.String], t1: /* fn */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnAvailableUndefined: Self = StObject.set(x, "onAvailable", js.undefined)
    
    inline def setRegister(value: /* item */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "register", js.Any.fromFunction1((t0: /* item */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setRegisterType(value: (/* type */ js.UndefOr[java.lang.String], /* cls */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "registerType", js.Any.fromFunction2((t0: /* type */ js.UndefOr[java.lang.String], t1: /* cls */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setUnregister(value: /* item */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "unregister", js.Any.fromFunction1((t0: /* item */ js.UndefOr[Any]) => value(t0).runNow()))
