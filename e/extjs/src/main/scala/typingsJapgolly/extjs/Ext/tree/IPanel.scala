...
object IPanel {
  ...
  def apply(
    ...
    expandPath: (/* path */ js.UndefOr[String], /* field */ js.UndefOr[String], /* separator */ js.UndefOr[String], /* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => Callback = null,
    ...
    selectPath: (/* path */ js.UndefOr[String], /* field */ js.UndefOr[String], /* separator */ js.UndefOr[String], /* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => Callback = null,
