...
object picker {
  ...
  object IDate {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.picker.IDate = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.picker.IDate]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.picker.IDate](x: Self) {
  ...
  object IMonth {
    ...
    extension [Self <: IMonth](x: Self) {
      ...
      inline def setAdjustYear(value: /* offset */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "adjustYear", js.Any.fromFunction1((t0: /* offset */ js.UndefOr[Double]) => value(t0).runNow()))
      ...
      inline def setGetValue(value: CallbackTo[Array]): Self = StObject.set(x, "getValue", value.toJsFn)
  ...
  trait ITime
    extends StObject
       with typingsJapgolly.extjs.Ext.view.IBoundList {
  ...
  object ITime {
    ...
    extension [Self <: ITime](x: Self) {
      ...
      inline def setFocusNode(value: /* rec */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "focusNode", js.Any.fromFunction1((t0: /* rec */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setUpdateList(value: Callback): Self = StObject.set(x, "updateList", value.toJsFn)
