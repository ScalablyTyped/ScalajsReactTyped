package typingsJapgolly.extjs.Ext.flash
...
trait IComponent
  extends typingsJapgolly.extjs.Ext.IComponent {
  /** [Property] (String) */
...
object IComponent {
  ...
  def apply(
    ...
    IComponent: typingsJapgolly.extjs.Ext.IComponent = null,
    ...
    getSwfId: js.UndefOr[Callback] = js.undefined,
    swf: IElement = null,
    ...
    getSwfId.foreach(p => __obj.updateDynamic("getSwfId")(p.toJsFn))
