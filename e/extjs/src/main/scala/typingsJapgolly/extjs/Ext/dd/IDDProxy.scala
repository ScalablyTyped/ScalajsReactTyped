...
object IDDProxy {
  ...
  def apply(
    ...
    alias: Array = null,
    alignElWithMouse: (/* el */ js.UndefOr[HTMLElement], /* iPageX */ js.UndefOr[Double], /* iPageY */ js.UndefOr[Double]) => Callback = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IDDProxy] = null,
    ...
    if (alignElWithMouse != null) __obj.updateDynamic("alignElWithMouse")(js.Any.fromFunction3((t0: /* el */ js.UndefOr[org.scalajs.dom.raw.HTMLElement], t1: /* iPageX */ js.UndefOr[scala.Double], t2: /* iPageY */ js.UndefOr[scala.Double]) => alignElWithMouse(t0, t1, t2).runNow()))
