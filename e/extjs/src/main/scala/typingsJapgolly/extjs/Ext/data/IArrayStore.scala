...
object IArrayStore {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IArrayStore] = null,
    ...
    loadData: (/* data */ js.UndefOr[js.Any], /* append */ js.UndefOr[js.Any]) => Callback = null,
    ...
    if (loadData != null) __obj.updateDynamic("loadData")(js.Any.fromFunction2((t0: /* data */ js.UndefOr[js.Any], t1: /* append */ js.UndefOr[js.Any]) => loadData(t0, t1).runNow()))
