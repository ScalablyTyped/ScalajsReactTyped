...
object IQueue {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IQueue] = null,
    mixins: js.Any = null,
    remove: /* obj */ js.UndefOr[js.Any] => CallbackTo[js.Any] = null,
    requires: Array = null,
    self: IClass = null,
    ...
    if (remove != null) __obj.updateDynamic("remove")(js.Any.fromFunction1((t0: /* obj */ js.UndefOr[js.Any]) => remove(t0).runNow()))
