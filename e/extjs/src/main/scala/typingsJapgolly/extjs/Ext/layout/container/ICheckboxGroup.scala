...
object ICheckboxGroup {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[ICheckboxGroup] = null,
    ...
    renderItems: /* items */ js.UndefOr[js.Any] => Callback = null,
    requires: Array = null,
    self: IClass = null,
    ...
    if (renderItems != null) __obj.updateDynamic("renderItems")(js.Any.fromFunction1((t0: /* items */ js.UndefOr[js.Any]) => renderItems(t0).runNow()))
