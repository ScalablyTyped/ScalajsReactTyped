...
trait IDropZone
  extends typingsJapgolly.extjs.Ext.dd.IDropZone
...
object IDropZone {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IDropZone] = null,
    ...
    notifyOut: (/* source */ js.UndefOr[IDragSource], /* e */ js.UndefOr[Event_], /* data */ js.UndefOr[js.Any]) => Callback = null,
    ...
    onNodeOut: (/* nodeData */ js.UndefOr[js.Any], /* source */ js.UndefOr[IDragSource], /* e */ js.UndefOr[Event_], /* data */ js.UndefOr[js.Any]) => Callback = null,
    ...
    if (notifyOut != null) __obj.updateDynamic("notifyOut")(js.Any.fromFunction3((t0: /* source */ js.UndefOr[typingsJapgolly.extjs.Ext.dd.IDragSource], t1: /* e */ js.UndefOr[typingsJapgolly.std.Event_], t2: /* data */ js.UndefOr[js.Any]) => notifyOut(t0, t1, t2).runNow()))
    ...
    if (onNodeOut != null) __obj.updateDynamic("onNodeOut")(js.Any.fromFunction4((t0: /* nodeData */ js.UndefOr[js.Any], t1: /* source */ js.UndefOr[typingsJapgolly.extjs.Ext.dd.IDragSource], t2: /* e */ js.UndefOr[typingsJapgolly.std.Event_], t3: /* data */ js.UndefOr[js.Any]) => onNodeOut(t0, t1, t2, t3).runNow()))
