...
object ICheckbox {
  ...
  extension [Self <: ICheckbox](x: Self) {
    ...
    inline def setGetRawValue(value: CallbackTo[Boolean]): Self = StObject.set(x, "getRawValue", value.toJsFn)
    
    inline def setGetRawValueUndefined: Self = StObject.set(x, "getRawValue", js.undefined)
    
    inline def setGetValue(value: CallbackTo[Boolean]): Self = StObject.set(x, "getValue", value.toJsFn)
    ...
    inline def setResetOriginalValue(value: /* fromBoxInGroup */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "resetOriginalValue", js.Any.fromFunction1((t0: /* fromBoxInGroup */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setSetBoxLabel(value: /* boxLabel */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setBoxLabel", js.Any.fromFunction1((t0: /* boxLabel */ js.UndefOr[String]) => value(t0).runNow()))
    ...
    inline def setSetReadOnly(value: /* readOnly */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setReadOnly", js.Any.fromFunction1((t0: /* readOnly */ js.UndefOr[Any]) => value(t0).runNow()))
