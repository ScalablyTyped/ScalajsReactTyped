...
object IRemotingProvider {
  ...
  def apply(
    ...
    createEvents: /* response */ js.UndefOr[js.Any] => CallbackTo[Array] = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IRemotingProvider] = null,
    isConnected: js.UndefOr[Callback] = js.undefined,
    ...
    if (createEvents != null) __obj.updateDynamic("createEvents")(js.Any.fromFunction1((t0: /* response */ js.UndefOr[js.Any]) => createEvents(t0).runNow()))
