...
object ITemplate {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[ITemplate] = null,
    ...
    if (applyOut != null) __obj.updateDynamic("applyOut")(js.Any.fromFunction2((t0: /* values */ js.UndefOr[js.Any], t1: /* out */ js.UndefOr[typingsJapgolly.extjs.Ext.Array]) => applyOut(t0, t1).runNow()))
