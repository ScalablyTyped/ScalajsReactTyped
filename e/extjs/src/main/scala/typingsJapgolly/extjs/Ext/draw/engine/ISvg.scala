...
object ISvg {
  ...
  def apply(
    ...
    applyZIndex: /* sprite */ js.UndefOr[ISprite] => Callback = null,
    ...
    hasCls: (/* sprite */ js.UndefOr[ISprite], /* className */ js.UndefOr[String]) => CallbackTo[Boolean] = null,
    hasListener: /* eventName */ js.UndefOr[String] => CallbackTo[Boolean] = null,
    hasListeners: js.Any = null,
    height: Int | Double = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[ISvg] = null,
    ...
    setText: (/* sprite */ js.UndefOr[js.Any], /* textString */ js.UndefOr[js.Any]) => Callback = null,
    ...
    if (applyZIndex != null) __obj.updateDynamic("applyZIndex")(js.Any.fromFunction1((t0: /* sprite */ js.UndefOr[typingsJapgolly.extjs.Ext.draw.ISprite]) => applyZIndex(t0).runNow()))
    ...
    if (hasCls != null) __obj.updateDynamic("hasCls")(js.Any.fromFunction2((t0: /* sprite */ js.UndefOr[typingsJapgolly.extjs.Ext.draw.ISprite], t1: /* className */ js.UndefOr[java.lang.String]) => hasCls(t0, t1).runNow()))
    ...
    if (setText != null) __obj.updateDynamic("setText")(js.Any.fromFunction2((t0: /* sprite */ js.UndefOr[js.Any], t1: /* textString */ js.UndefOr[js.Any]) => setText(t0, t1).runNow()))
