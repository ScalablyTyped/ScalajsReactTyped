...
object tip {
  ...
  object IQuickTip {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.tip.IQuickTip = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.tip.IQuickTip]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.tip.IQuickTip](x: Self) {
  ...
  object ITip {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.tip.ITip = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.tip.ITip]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.tip.ITip](x: Self) {
  ...
  trait IToolTip
    extends StObject
       with typingsJapgolly.extjs.Ext.tip.ITip {
  ...
  object IToolTip {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.tip.IToolTip = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.tip.IToolTip]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.tip.IToolTip](x: Self) {
      ...
      inline def setSetTarget(value: /* t */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setTarget", js.Any.fromFunction1((t0: /* t */ js.UndefOr[Any]) => value(t0).runNow()))
