...
object IXTemplateParser {
  ...
  extension [Self <: IXTemplateParser](x: Self) {
    ...
    inline def setDoForEach(value: (/* action */ js.UndefOr[java.lang.String], /* actions */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "doForEach", js.Any.fromFunction2((t0: /* action */ js.UndefOr[java.lang.String], t1: /* actions */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setDoTag(value: Callback): Self = StObject.set(x, "doTag", value.toJsFn)
