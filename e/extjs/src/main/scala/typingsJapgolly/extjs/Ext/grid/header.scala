...
object header {
  ...
  object IContainer {
    ...
    extension [Self <: IContainer](x: Self) {
      ...
      inline def setGetColumnCount(value: Callback): Self = StObject.set(x, "getColumnCount", value.toJsFn)
      
      inline def setGetColumnCountUndefined: Self = StObject.set(x, "getColumnCount", js.undefined)
      
      inline def setGetColumnMenu(value: /* headerContainer */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "getColumnMenu", js.Any.fromFunction1((t0: /* headerContainer */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setGetColumnMenuUndefined: Self = StObject.set(x, "getColumnMenu", js.undefined)
      
      inline def setGetFullWidth(value: Callback): Self = StObject.set(x, "getFullWidth", value.toJsFn)
      ...
      inline def setGetHeaderAtIndex(value: /* index */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "getHeaderAtIndex", js.Any.fromFunction1((t0: /* index */ js.UndefOr[Double]) => value(t0).runNow()))
      
      inline def setGetHeaderAtIndexUndefined: Self = StObject.set(x, "getHeaderAtIndex", js.undefined)
      
      inline def setGetHeaderIndex(value: /* header */ js.UndefOr[typingsJapgolly.extjs.Ext.grid.column.IColumn] => Double): Self = StObject.set(x, "getHeaderIndex", js.Any.fromFunction1(value))
      ...
      inline def setGetVisibleGridColumns(value: CallbackTo[Array]): Self = StObject.set(x, "getVisibleGridColumns", value.toJsFn)
      
      inline def setGetVisibleGridColumnsUndefined: Self = StObject.set(x, "getVisibleGridColumns", js.undefined)
      
      inline def setGetVisibleHeaderClosestToIndex(value: /* index */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "getVisibleHeaderClosestToIndex", js.Any.fromFunction1((t0: /* index */ js.UndefOr[Double]) => value(t0).runNow()))
