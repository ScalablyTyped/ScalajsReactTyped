...
object IPositionable {
  ...
  extension [Self <: IPositionable](x: Self) {
    ...
    inline def setGetViewRegion(value: CallbackTo[IRegion]): Self = StObject.set(x, "getViewRegion", value.toJsFn)
    ...
    inline def setMove(
      value: (/* direction */ js.UndefOr[String], /* distance */ js.UndefOr[Double], /* animate */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "move", js.Any.fromFunction3((t0: /* direction */ js.UndefOr[String], t1: /* distance */ js.UndefOr[Double], t2: /* animate */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
