...
object IKeyMap {
  ...
  extension [Self <: IKeyMap](x: Self) {
    ...
    inline def setAddBinding(value: /* binding */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "addBinding", js.Any.fromFunction1((t0: /* binding */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setDestroy(value: /* removeTarget */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "destroy", js.Any.fromFunction1((t0: /* removeTarget */ js.UndefOr[Boolean]) => value(t0).runNow()))
    ...
    inline def setOn(
      value: (/* key */ js.UndefOr[Any], /* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "on", js.Any.fromFunction3((t0: /* key */ js.UndefOr[Any], t1: /* fn */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setRemoveBinding(value: /* binding */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "removeBinding", js.Any.fromFunction1((t0: /* binding */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setUn(
      value: (/* key */ js.UndefOr[Any], /* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "un", js.Any.fromFunction3((t0: /* key */ js.UndefOr[Any], t1: /* fn */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
