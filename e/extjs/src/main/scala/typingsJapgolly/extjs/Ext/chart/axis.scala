...
object axis {
  ...
  object IAxis {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.chart.axis.IAxis = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.chart.axis.IAxis]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.chart.axis.IAxis](x: Self) {
