...
object ITreeModel {
  ...
  def apply(
    ...
    getLastSelected: js.UndefOr[CallbackTo[ITreeModel]] = js.undefined,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[ITreeModel] = null,
    isFocused: /* record */ js.UndefOr[ITreeModel] => Callback = null,
    ...
    self: IClass = null,
    setLastFocused: /* record */ js.UndefOr[ITreeModel] => Callback = null,
    ...
    if (isFocused != null) __obj.updateDynamic("isFocused")(js.Any.fromFunction1((t0: /* record */ js.UndefOr[typingsJapgolly.extjs.Ext.selection.ITreeModel]) => isFocused(t0).runNow()))
    ...
    if (setLastFocused != null) __obj.updateDynamic("setLastFocused")(js.Any.fromFunction1((t0: /* record */ js.UndefOr[typingsJapgolly.extjs.Ext.selection.ITreeModel]) => setLastFocused(t0).runNow()))
