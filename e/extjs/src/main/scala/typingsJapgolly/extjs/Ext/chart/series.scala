...
object series {
  ...
  object IArea {
    ...
    extension [Self <: IArea](x: Self) {
      ...
      inline def setHighlightSeries(value: /* item */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "highlightSeries", js.Any.fromFunction1((t0: /* item */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setUnHighlightSeries(value: /* item */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "unHighlightSeries", js.Any.fromFunction1((t0: /* item */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  - typingsJapgolly.extjs.Ext.chart.ILabel because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined label, onCreateLabel, onPlaceLabel */ trait ISeries
    extends StObject
       with IObservable {
  ...
  object ISeries {
    ...
    extension [Self <: ISeries](x: Self) {
      ...
      inline def setEachRecord(value: (/* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "eachRecord", js.Any.fromFunction2((t0: /* fn */ js.UndefOr[Any], t1: /* scope */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
      ...
      inline def setGetLegendColor(value: /* index */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "getLegendColor", js.Any.fromFunction1((t0: /* index */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setGetLegendColorUndefined: Self = StObject.set(x, "getLegendColor", js.undefined)
      
      inline def setGetRecordCount(value: Callback): Self = StObject.set(x, "getRecordCount", value.toJsFn)
      ...
      inline def setHighlightItem(value: js.UndefOr[Any] => Callback): Self = StObject.set(x, "highlightItem", js.Any.fromFunction1((t0: js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setHighlightItemUndefined: Self = StObject.set(x, "highlightItem", js.undefined)
      
      inline def setHighlightUndefined: Self = StObject.set(x, "highlight", js.undefined)
      
      inline def setIsExcluded(value: /* index */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "isExcluded", js.Any.fromFunction1((t0: /* index */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setOnPlaceLabel(
        value: (js.UndefOr[ISprite], js.UndefOr[IModel], js.UndefOr[Any], js.UndefOr[Double], js.UndefOr[String], js.UndefOr[Boolean], js.UndefOr[Double]) => Callback
      ): Self = StObject.set(x, "onPlaceLabel", js.Any.fromFunction7((t0: js.UndefOr[ISprite], t1: js.UndefOr[IModel], t2: js.UndefOr[Any], t3: js.UndefOr[Double], t4: js.UndefOr[String], t5: js.UndefOr[Boolean], t6: js.UndefOr[Double]) => (value(t0, t1, t2, t3, t4, t5, t6)).runNow()))
      ...
      inline def setSetTitle(value: (/* index */ js.UndefOr[Double], /* title */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "setTitle", js.Any.fromFunction2((t0: /* index */ js.UndefOr[Double], t1: /* title */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
