...
object IBoundList {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IBoundList] = null,
    initLayout: js.UndefOr[Callback] = js.undefined,
    isLayout: js.UndefOr[Boolean] = js.undefined,
    isValidParent: js.UndefOr[Callback] = js.undefined,
    mixins: js.Any = null,
    ...
    isValidParent.foreach(p => __obj.updateDynamic("isValidParent")(p.toJsFn))
