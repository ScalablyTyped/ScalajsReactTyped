...
import typingsJapgolly.extjs.Ext.data.proxy.IAjax
...
object IRestProxy {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IRestProxy] = null,
    ...
    if (getMethod != null) __obj.updateDynamic("getMethod")(js.Any.fromFunction1((t0: /* request */ js.UndefOr[typingsJapgolly.extjs.Ext.data.IRequest]) => getMethod(t0).runNow()))
