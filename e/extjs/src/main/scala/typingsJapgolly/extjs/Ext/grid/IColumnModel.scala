...
object IColumnModel {
  ...
  extension [Self <: IColumnModel](x: Self) {
    ...
    inline def setGetHeaderAtIndex(value: /* index */ js.UndefOr[Double] => typingsJapgolly.extjs.Ext.grid.column.IColumn): Self = StObject.set(x, "getHeaderAtIndex", js.Any.fromFunction1(value))
    
    inline def setGetHeaderAtIndexUndefined: Self = StObject.set(x, "getHeaderAtIndex", js.undefined)
    
    inline def setGetHeaderById(value: /* id */ js.UndefOr[String] => typingsJapgolly.extjs.Ext.grid.column.IColumn): Self = StObject.set(x, "getHeaderById", js.Any.fromFunction1(value))
