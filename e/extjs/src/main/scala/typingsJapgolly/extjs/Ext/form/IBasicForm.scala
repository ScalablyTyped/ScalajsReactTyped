...
object IBasicForm {
  ...
  extension [Self <: IBasicForm](x: Self) {
    ...
    inline def setCheckValidity(value: Callback): Self = StObject.set(x, "checkValidity", value.toJsFn)
    
    inline def setCheckValidityUndefined: Self = StObject.set(x, "checkValidity", js.undefined)
    
    inline def setClearInvalid(value: CallbackTo[IBasic]): Self = StObject.set(x, "clearInvalid", value.toJsFn)
    ...
    inline def setGetFields(value: CallbackTo[IMixedCollection]): Self = StObject.set(x, "getFields", value.toJsFn)
    ...
    inline def setHasUpload(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasUpload", value.toJsFn)
