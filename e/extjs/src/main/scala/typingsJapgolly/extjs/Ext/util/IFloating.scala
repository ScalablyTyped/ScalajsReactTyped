...
object IFloating {
  ...
  extension [Self <: IFloating](x: Self) {
    ...
    inline def setCenter(value: CallbackTo[IComponent]): Self = StObject.set(x, "center", value.toJsFn)
    ...
    inline def setDoConstrain(value: /* constrainTo */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "doConstrain", js.Any.fromFunction1((t0: /* constrainTo */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setSetActive(value: (/* active */ js.UndefOr[Boolean], /* newActive */ js.UndefOr[IComponent]) => Callback): Self = StObject.set(x, "setActive", js.Any.fromFunction2((t0: /* active */ js.UndefOr[Boolean], t1: /* newActive */ js.UndefOr[IComponent]) => (value(t0, t1)).runNow()))
    ...
    inline def setToBack(value: CallbackTo[IComponent]): Self = StObject.set(x, "toBack", value.toJsFn)
