...
trait ILayer extends IElement {
  ...
  var setLeft_ILayer: js.UndefOr[
    js.Function1[/* left */ js.UndefOr[js.Any], typingsJapgolly.extjs.Ext.dom.IElement]
  ] = js.undefined
  /** [Method] overridden Element method
  		* @param w Object
  		* @param h Object
  ...
  /** [Method] Sets the element s top position directly using CSS style instead of setY
  		...
  		*/
  @JSName("setTop")
  var setTop_ILayer: js.UndefOr[
    js.Function1[/* top */ js.UndefOr[js.Any], typingsJapgolly.extjs.Ext.dom.IElement]
  ] = js.undefined
  /** [Method] overridden Element method
...
object ILayer {
  ...
  def apply(
    ...
    addCls: /* className */ js.UndefOr[js.Any] => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    addClsOnClick: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    addClsOnFocus: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    addClsOnOver: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    addKeyListener: (/* key */ js.UndefOr[js.Any], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[typingsJapgolly.extjs.Ext.util.IKeyMap] = null,
    addKeyMap: /* config */ js.UndefOr[js.Any] => CallbackTo[typingsJapgolly.extjs.Ext.util.IKeyMap] = null,
    addListener: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    alias: Array = null,
    alternateClassName: js.Any = null,
    animate: /* config */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    appendChild: (/* el */ js.UndefOr[js.Any], /* returnDom */ js.UndefOr[Boolean]) => CallbackTo[ILayer] = null,
    appendTo: /* el */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    applyStyles: /* styles */ js.UndefOr[js.Any] => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    autoBoxAdjust: js.UndefOr[Boolean] = js.undefined,
    blur: js.UndefOr[CallbackTo[ILayer]] = js.undefined,
    boxWrap: /* clazz */ js.UndefOr[java.lang.String] => CallbackTo[ILayer] = null,
    ...
    clearListeners: js.UndefOr[CallbackTo[ILayer]] = js.undefined,
    clearOpacity: js.UndefOr[CallbackTo[ILayer]] = js.undefined,
    clearPositioning: /* value */ js.UndefOr[java.lang.String] => CallbackTo[ILayer] = null,
    clip: js.UndefOr[CallbackTo[ILayer]] = js.undefined,
    cls: java.lang.String = null,
    config: js.Any = null,
    constrain: js.UndefOr[Boolean] = js.undefined,
    contains: /* el */ js.UndefOr[js.Any] => CallbackTo[Boolean] = null,
    createChild: (/* config */ js.UndefOr[js.Any], /* insertBefore */ js.UndefOr[HTMLElement], /* returnDom */ js.UndefOr[Boolean]) => CallbackTo[ILayer] = null,
    createProxy: (/* config */ js.UndefOr[js.Any], /* renderTo */ js.UndefOr[js.Any], /* matchBox */ js.UndefOr[Boolean]) => CallbackTo[ILayer] = null,
    createShim: js.UndefOr[CallbackTo[ILayer]] = js.undefined,
    ...
    enableDisplayMode: /* display */ js.UndefOr[java.lang.String] => CallbackTo[ILayer] = null,
    extend: java.lang.String = null,
    fadeIn: /* options */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    fadeOut: /* options */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    findParent: (/* selector */ js.UndefOr[java.lang.String], /* limit */ js.UndefOr[js.Any], /* returnEl */ js.UndefOr[Boolean]) => CallbackTo[HTMLElement] = null,
    findParentNode: (/* selector */ js.UndefOr[java.lang.String], /* limit */ js.UndefOr[js.Any], /* returnEl */ js.UndefOr[Boolean]) => CallbackTo[HTMLElement] = null,
    first: (/* selector */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => CallbackTo[js.Any] = null,
    focus: /* defer */ js.UndefOr[Double] => CallbackTo[ILayer] = null,
    focusable: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    frame: (/* color */ js.UndefOr[java.lang.String], /* count */ js.UndefOr[Double], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    ...
    getAttributeNS: (/* namespace */ js.UndefOr[java.lang.String], /* name */ js.UndefOr[java.lang.String]) => CallbackTo[java.lang.String] = null,
    ...
    getById: (/* id */ js.UndefOr[java.lang.String], /* asDom */ js.UndefOr[Boolean]) => Callback = null,
    getCenterXY: js.UndefOr[CallbackTo[Array]] = js.undefined,
    getColor: (/* attr */ js.UndefOr[java.lang.String], /* defaultValue */ js.UndefOr[java.lang.String], /* prefix */ js.UndefOr[java.lang.String]) => Callback = null,
    getComputedHeight: js.UndefOr[CallbackTo[Double]] = js.undefined,
    getComputedWidth: js.UndefOr[CallbackTo[Double]] = js.undefined,
    getFrameWidth: /* sides */ js.UndefOr[java.lang.String] => CallbackTo[Double] = null,
    ...
    getTextWidth: (/* text */ js.UndefOr[java.lang.String], /* min */ js.UndefOr[Double], /* max */ js.UndefOr[Double]) => CallbackTo[Double] = null,
    ...
    ghost: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    hasCls: /* className */ js.UndefOr[java.lang.String] => CallbackTo[Boolean] = null,
    hide: /* animate */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    hideMode: java.lang.String = null,
    highlight: (/* color */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    hover: (/* overFn */ js.UndefOr[js.Any], /* outFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    id: java.lang.String = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    initDD: (/* group */ js.UndefOr[java.lang.String], /* config */ js.UndefOr[js.Any], /* overrides */ js.UndefOr[js.Any]) => CallbackTo[IDD] = null,
    initDDProxy: (/* group */ js.UndefOr[java.lang.String], /* config */ js.UndefOr[js.Any], /* overrides */ js.UndefOr[js.Any]) => CallbackTo[IDDProxy] = null,
    initDDTarget: (/* group */ js.UndefOr[java.lang.String], /* config */ js.UndefOr[js.Any], /* overrides */ js.UndefOr[js.Any]) => CallbackTo[IDDTarget] = null,
    insertAfter: /* el */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    insertBefore: /* el */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    insertFirst: /* el */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    ...
    insertSibling: (/* el */ js.UndefOr[js.Any], /* where */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => CallbackTo[ILayer] = null,
    ...
    load: /* options */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    mask: (/* msg */ js.UndefOr[java.lang.String], /* msgCls */ js.UndefOr[java.lang.String]) => CallbackTo[ILayer] = null,
    mixins: js.Any = null,
    monitorMouseLeave: (/* delay */ js.UndefOr[Double], /* handler */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[js.Any] = null,
    moveTo: (/* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    ...
    on: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    ...
    pause: /* seconds */ js.UndefOr[Double] => CallbackTo[ILayer] = null,
    position: (/* pos */ js.UndefOr[java.lang.String], /* zIndex */ js.UndefOr[Double], /* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double]) => Callback = null,
    prev: (/* selector */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => CallbackTo[js.Any] = null,
    puff: /* options */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    purgeAllListeners: js.UndefOr[CallbackTo[ILayer]] = js.undefined,
    query: /* selector */ js.UndefOr[java.lang.String] => CallbackTo[Array] = null,
    radioCls: /* className */ js.UndefOr[js.Any] => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    relayEvent: (/* eventName */ js.UndefOr[java.lang.String], /* observable */ js.UndefOr[js.Any]) => Callback = null,
    remove: js.UndefOr[Callback] = js.undefined,
    removeAllListeners: js.UndefOr[CallbackTo[ILayer]] = js.undefined,
    removeCls: /* className */ js.UndefOr[js.Any] => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    removeListener: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    repaint: js.UndefOr[CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement]] = js.undefined,
    replace: /* el */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    replaceCls: (/* oldClassName */ js.UndefOr[java.lang.String], /* newClassName */ js.UndefOr[java.lang.String]) => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    replaceWith: /* el */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    requires: Array = null,
    scale: (/* width */ js.UndefOr[Double], /* height */ js.UndefOr[Double], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    scroll: (/* direction */ js.UndefOr[java.lang.String], /* distance */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => CallbackTo[Boolean] = null,
    scrollBy: (/* deltaX */ js.UndefOr[js.Any], /* deltaY */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    scrollIntoView: (/* container */ js.UndefOr[js.Any], /* hscroll */ js.UndefOr[Boolean], /* animate */ js.UndefOr[js.Any], /* highlight */ js.UndefOr[Boolean]) => CallbackTo[ILayer] = null,
    scrollTo: (/* side */ js.UndefOr[java.lang.String], /* value */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    select: (/* selector */ js.UndefOr[java.lang.String], /* unique */ js.UndefOr[Boolean]) => CallbackTo[ICompositeElement] = null,
    selectable: js.UndefOr[CallbackTo[ILayer]] = js.undefined,
    self: IClass = null,
    serializeForm: /* form */ js.UndefOr[js.Any] => CallbackTo[java.lang.String] = null,
    set: (/* o */ js.UndefOr[js.Any], /* useSet */ js.UndefOr[Boolean]) => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    setBottom: /* bottom */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    setBounds: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[js.Any], /* width */ js.UndefOr[js.Any], /* height */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    setDisplayed: /* value */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    setHTML: /* html */ js.UndefOr[java.lang.String] => CallbackTo[IElement] = null,
    setHeight: (/* h */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    setLeft: /* left */ js.UndefOr[js.Any] => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    setLeftTop: (/* left */ js.UndefOr[js.Any], /* top */ js.UndefOr[js.Any]) => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    setLocation: (/* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    setOpacity: (/* opacity */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    setPositioning: /* posCfg */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    setRight: /* right */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    setScrollLeft: /* left */ js.UndefOr[Double] => CallbackTo[ILayer] = null,
    setScrollTop: /* top */ js.UndefOr[Double] => CallbackTo[ILayer] = null,
    setSize: (/* w */ js.UndefOr[js.Any], /* h */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    setStyle: (/* property */ js.UndefOr[js.Any], /* value */ js.UndefOr[java.lang.String]) => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    setTop: /* top */ js.UndefOr[js.Any] => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    setVisibilityMode: /* mode */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    setVisible: (/* visible */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    setWidth: (/* w */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    setZIndex: /* zindex */ js.UndefOr[Double] => CallbackTo[ILayer] = null,
    shadow: js.Any = null,
    shadowOffset: Int | Double = null,
    shift: /* options */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    shim: js.UndefOr[Boolean] = js.undefined,
    show: /* animate */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    singleton: js.UndefOr[Boolean] = js.undefined,
    slideIn: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    slideOut: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    statics: js.Any = null,
    swallowEvent: (/* eventName */ js.UndefOr[js.Any], /* preventDefault */ js.UndefOr[Boolean]) => CallbackTo[ILayer] = null,
    switchOff: /* options */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    toggle: /* animate */ js.UndefOr[js.Any] => CallbackTo[ILayer] = null,
    toggleCls: /* className */ js.UndefOr[java.lang.String] => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    un: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    unclip: js.UndefOr[CallbackTo[ILayer]] = js.undefined,
    unmask: js.UndefOr[Callback] = js.undefined,
    unselectable: js.UndefOr[CallbackTo[ILayer]] = js.undefined,
    up: (/* selector */ js.UndefOr[java.lang.String], /* limit */ js.UndefOr[js.Any], /* returnDom */ js.UndefOr[Boolean]) => CallbackTo[IElement] = null,
    update: (/* html */ js.UndefOr[java.lang.String], /* loadScripts */ js.UndefOr[Boolean], /* callback */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    useDisplay: js.UndefOr[Boolean] = js.undefined,
    uses: Array = null,
    visibilityCls: java.lang.String = null,
    wrap: (/* config */ js.UndefOr[js.Any], /* returnDom */ js.UndefOr[Boolean], /* selector */ js.UndefOr[java.lang.String]) => CallbackTo[js.Any] = null,
    ...
    if (setBounds != null) __obj.updateDynamic("setBounds")(js.Any.fromFunction8((t0: /* x */ js.UndefOr[js.Any], t1: /* y */ js.UndefOr[js.Any], t2: /* width */ js.UndefOr[js.Any], t3: /* height */ js.UndefOr[js.Any], t4: /* animate */ js.UndefOr[js.Any], t5: /* duration */ js.UndefOr[js.Any], t6: /* callback */ js.UndefOr[js.Any], t7: /* easing */ js.UndefOr[js.Any]) => setBounds(t0, t1, t2, t3, t4, t5, t6, t7).runNow()))
    ...
    if (setHeight != null) __obj.updateDynamic("setHeight")(js.Any.fromFunction5((t0: /* h */ js.UndefOr[js.Any], t1: /* animate */ js.UndefOr[js.Any], t2: /* duration */ js.UndefOr[js.Any], t3: /* callback */ js.UndefOr[js.Any], t4: /* easing */ js.UndefOr[js.Any]) => setHeight(t0, t1, t2, t3, t4).runNow()))
    ...
    if (setSize != null) __obj.updateDynamic("setSize")(js.Any.fromFunction6((t0: /* w */ js.UndefOr[js.Any], t1: /* h */ js.UndefOr[js.Any], t2: /* animate */ js.UndefOr[js.Any], t3: /* duration */ js.UndefOr[js.Any], t4: /* callback */ js.UndefOr[js.Any], t5: /* easing */ js.UndefOr[js.Any]) => setSize(t0, t1, t2, t3, t4, t5).runNow()))
    ...
    if (setVisible != null) __obj.updateDynamic("setVisible")(js.Any.fromFunction5((t0: /* visible */ js.UndefOr[js.Any], t1: /* animate */ js.UndefOr[js.Any], t2: /* duration */ js.UndefOr[js.Any], t3: /* callback */ js.UndefOr[js.Any], t4: /* easing */ js.UndefOr[js.Any]) => setVisible(t0, t1, t2, t3, t4).runNow()))
    if (setWidth != null) __obj.updateDynamic("setWidth")(js.Any.fromFunction5((t0: /* w */ js.UndefOr[js.Any], t1: /* animate */ js.UndefOr[js.Any], t2: /* duration */ js.UndefOr[js.Any], t3: /* callback */ js.UndefOr[js.Any], t4: /* easing */ js.UndefOr[js.Any]) => setWidth(t0, t1, t2, t3, t4).runNow()))
