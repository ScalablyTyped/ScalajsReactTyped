...
object plugin {
  ...
  object IBufferedRenderer {
    ...
    extension [Self <: IBufferedRenderer](x: Self) {
      ...
      inline def setInit(value: /* grid */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "init", js.Any.fromFunction1((t0: /* grid */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setScrollTo(
        value: (/* recordIdx */ js.UndefOr[Double], /* doSelect */ js.UndefOr[Boolean], /* callback */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "scrollTo", js.Any.fromFunction4((t0: /* recordIdx */ js.UndefOr[Double], t1: /* doSelect */ js.UndefOr[Boolean], t2: /* callback */ js.UndefOr[Any], t3: /* scope */ js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
  ...
  object ICellEditing {
    ...
    extension [Self <: ICellEditing](x: Self) {
      ...
      inline def setStartEditByPosition(value: /* position */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "startEditByPosition", js.Any.fromFunction1((t0: /* position */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  object IEditing {
    ...
    extension [Self <: IEditing](x: Self) {
      ...
      inline def setCompleteEdit(value: Callback): Self = StObject.set(x, "completeEdit", value.toJsFn)
      ...
      inline def setRemoveListener(value: (js.UndefOr[String], js.UndefOr[Any], js.UndefOr[Any]) => Callback): Self = StObject.set(x, "removeListener", js.Any.fromFunction3((t0: js.UndefOr[String], t1: js.UndefOr[Any], t2: js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setStartEdit(value: (/* record */ js.UndefOr[Any], /* columnHeader */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "startEdit", js.Any.fromFunction2((t0: /* record */ js.UndefOr[Any], t1: /* columnHeader */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
      ...
      inline def setUn(value: (js.UndefOr[String], js.UndefOr[Any], js.UndefOr[Any]) => Callback): Self = StObject.set(x, "un", js.Any.fromFunction3((t0: js.UndefOr[String], t1: js.UndefOr[Any], t2: js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
  ...
  object IHeaderReorderer {
    ...
    extension [Self <: IHeaderReorderer](x: Self) {
      ...
      inline def setInit(value: /* headerCt */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "init", js.Any.fromFunction1((t0: /* headerCt */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  object IHeaderResizer {
    ...
    extension [Self <: IHeaderResizer](x: Self) {
      ...
      inline def setSetDynamic(value: /* dynamic */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setDynamic", js.Any.fromFunction1((t0: /* dynamic */ js.UndefOr[Boolean]) => value(t0).runNow()))
