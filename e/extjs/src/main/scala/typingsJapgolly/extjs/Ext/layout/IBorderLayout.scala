...
trait IBorderLayout
  ...
  /** [Method] Called to perform the calculations for this layout
    ...
    */
  @JSName("calculate")
  var calculate_IBorderLayout: js.UndefOr[js.Function1[/* ownerContext */ js.UndefOr[Any], Unit]] = js.undefined
  ...
  var getItemSizePolicy_IBorderLayout: js.UndefOr[js.Function1[/* item */ js.UndefOr[Any], ISizePolicy]] = js.undefined
...
object IBorderLayout {
  ...
  inline def apply(): IBorderLayout = {
