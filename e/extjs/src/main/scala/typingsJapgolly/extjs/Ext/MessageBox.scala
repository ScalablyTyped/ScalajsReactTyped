...
object MessageBox extends js.Object {
  ...
  var body: typingsJapgolly.extjs.Ext.dom.IElement = js.native
  /** [Property] (Object) */
  ...
  var floatParent: IContainer = js.native
  /** [Property] (Object) */
  ...
  /** [Property] (Ext.Container) */
  var ownerCt: IContainer = js.native
  /** [Property] (Boolean) */
  ...
  /** [Property] (Ext.Container) */
  var zIndexParent: IContainer = js.native
  ...
  /** [Method] Adds a CSS class to the body element
  		...
  		*/
  def addBodyCls(): typingsJapgolly.extjs.Ext.panel.IPanel = js.native
  def addBodyCls(cls: java.lang.String): typingsJapgolly.extjs.Ext.panel.IPanel = js.native
  ...
  /** [Method] Adds docked item s to the container
  		...
  		*/
  def addDocked(): Array = js.native
  def addDocked(component: js.Any): Array = js.native
  def addDocked(component: js.Any, pos: Double): Array = js.native
  ...
  def afterLayout(layout: typingsJapgolly.extjs.Ext.layout.container.IContainer): Unit = js.native
  ...
  /** [Method] Displays a standard read only message box with an OK button comparable to the basic JavaScript alert prompt
  		...
  		*/
  def alert(): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def alert(title: java.lang.String): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def alert(title: java.lang.String, msg: java.lang.String): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def alert(title: java.lang.String, msg: java.lang.String, fn: js.Any): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def alert(title: java.lang.String, msg: java.lang.String, fn: js.Any, scope: js.Any): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  ...
  def alignTo(element: js.Any, position: java.lang.String, offsets: Array): IPositionable = js.native
  def alignTo(element: js.Any, position: java.lang.String, offsets: Array, animate: js.Any): IPositionable = js.native
  ...
  def bubble(fn: js.Any, scope: js.Any, args: Array): IComponent = js.native
  /** [Method] Calculates the new x y position to move this Positionable into a constrain region
  		...
  		*/
  def calculateConstrainedPosition(): Array = js.native
  def calculateConstrainedPosition(constrainTo: js.Any): Array = js.native
  def calculateConstrainedPosition(constrainTo: js.Any, proposedPosition: Array): Array = js.native
  def calculateConstrainedPosition(constrainTo: js.Any, proposedPosition: Array, local: Boolean): Array = js.native
  def calculateConstrainedPosition(constrainTo: js.Any, proposedPosition: Array, local: Boolean, proposedSize: Array): Array = js.native
  ...
  def cascade(fn: js.Any, scope: js.Any, args: Array): IContainer = js.native
  ...
  /** [Method] Collapses the panel body so that the body becomes hidden
  		...
  		* @returns Ext.panel.Panel this
  		*/
  def collapse(): typingsJapgolly.extjs.Ext.panel.IPanel = js.native
  def collapse(direction: java.lang.String): typingsJapgolly.extjs.Ext.panel.IPanel = js.native
  def collapse(direction: java.lang.String, animate: Boolean): typingsJapgolly.extjs.Ext.panel.IPanel = js.native
  /** [Method] Displays a confirmation message box with Yes and No buttons comparable to JavaScript s confirm
  		...
  		* @returns Ext.window.MessageBox this
  		*/
  def confirm(): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def confirm(title: java.lang.String): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def confirm(title: java.lang.String, msg: java.lang.String): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def confirm(title: java.lang.String, msg: java.lang.String, fn: js.Any): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def confirm(title: java.lang.String, msg: java.lang.String, fn: js.Any, scope: js.Any): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  ...
  /** [Method] This method needs to be called whenever you change something on this component that requires the Component s layout t
  		...
  		*/
  def doComponentLayout(): typingsJapgolly.extjs.Ext.container.IContainer = js.native
  ...
  /** [Method] Manually force this container s layout to be recalculated
  		* @returns Ext.container.Container this
  		*/
  def doLayout(): typingsJapgolly.extjs.Ext.container.IContainer = js.native
  ...
  /** [Method] Expands the panel body so that it becomes visible
  		...
  		* @returns Ext.panel.Panel this
  		*/
  def expand(): typingsJapgolly.extjs.Ext.panel.IPanel = js.native
  def expand(animate: Boolean): typingsJapgolly.extjs.Ext.panel.IPanel = js.native
  /** [Method] Find a container above this component at any level by a custom function
  		...
  		*/
  def findParentBy(): typingsJapgolly.extjs.Ext.container.IContainer = js.native
  def findParentBy(fn: js.Any): typingsJapgolly.extjs.Ext.container.IContainer = js.native
  /** [Method] Find a container above this component at any level by xtype or class See also the up method
  		...
  		*/
  def findParentByType(): typingsJapgolly.extjs.Ext.container.IContainer = js.native
  def findParentByType(xtype: js.Any): typingsJapgolly.extjs.Ext.container.IContainer = js.native
  ...
  /** [Method] Gets the x y coordinates to align this element with another element
  		...
  		* @returns Number[] [x, y]
  		*/
  def getAlignToXY(): Array = js.native
  def getAlignToXY(element: js.Any): Array = js.native
  def getAlignToXY(element: js.Any, position: java.lang.String): Array = js.native
  def getAlignToXY(element: js.Any, position: java.lang.String, offsets: Array): Array = js.native
  /** [Method] Gets the x y coordinates specified by the anchor position on the element
  		...
  		*/
  def getAnchorXY(): Array = js.native
  def getAnchorXY(anchor: java.lang.String): Array = js.native
  def getAnchorXY(anchor: java.lang.String, local: Boolean): Array = js.native
  def getAnchorXY(anchor: java.lang.String, local: Boolean, size: js.Any): Array = js.native
  ...
  def getConstrainVector(constrainTo: js.Any, proposedPosition: Array): js.Any = js.native
  def getConstrainVector(constrainTo: js.Any, proposedPosition: Array, proposedSize: Array): js.Any = js.native
  ...
  def getDockedItems(selector: java.lang.String): Array = js.native
  def getDockedItems(selector: java.lang.String, beforeBody: Boolean): Array = js.native
  /** [Method] Retrieves the top level element representing this component
  		* @returns Ext.dom.Element
  		*/
  def getEl(): typingsJapgolly.extjs.Ext.dom.IElement = js.native
  ...
  /** [Method] Returns the layout instance currently associated with this Container
  		...
  		*/
  def getLayout(): typingsJapgolly.extjs.Ext.layout.container.IContainer = js.native
  ...
  /** [Method] Overridden in Ext rtl AbstractComponent
  		...
  		*/
  def getLocalXY(): Array = js.native
  ...
  /** [Method] Returns the offsets of this element from the passed element
  		...
  		*/
  def getOffsetsTo(): Array = js.native
  def getOffsetsTo(offsetsTo: js.Any): Array = js.native
  ...
  /** [Method] Gets the current XY position of the component s underlying element
  		...
  		*/
  def getPosition(): Array = js.native
  def getPosition(local: Boolean): Array = js.native
  ...
  def isDescendantOf(container: IContainer): Boolean = js.native
  ...
  /** [Method] Fits the window within its current container and automatically replaces the maximize tool button with the restore
  		...
  		*/
  def maximize(): typingsJapgolly.extjs.Ext.window.IWindow = js.native
  def maximize(animate: Boolean): typingsJapgolly.extjs.Ext.window.IWindow = js.native
  /** [Method] Placeholder method for minimizing the window
  		* @returns Ext.window.Window this
  		*/
  def minimize(): typingsJapgolly.extjs.Ext.window.IWindow = js.native
  ...
  /** [Method] Displays a message box with a progress bar
  		...
  		* @returns Ext.window.MessageBox this
  		*/
  def progress(): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def progress(title: java.lang.String): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def progress(title: java.lang.String, msg: java.lang.String): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def progress(title: java.lang.String, msg: java.lang.String, progressText: java.lang.String): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  ...
  ): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  ...
  /** [Method] Retrieves all descendant components which match the passed function
  		...
  		*/
  def queryBy(): Array = js.native
  def queryBy(fn: js.Any): Array = js.native
  def queryBy(fn: js.Any, scope: js.Any): Array = js.native
  ...
  /** [Method] Removes all components from this container
  		...
  		*/
  def removeAll(): Array = js.native
  def removeAll(autoDestroy: Boolean): Array = js.native
  ...
  /** [Method] Removes a CSS class from the body element
  		...
  		* @returns Ext.panel.Panel this
  		*/
  def removeBodyCls(): typingsJapgolly.extjs.Ext.panel.IPanel = js.native
  def removeBodyCls(cls: java.lang.String): typingsJapgolly.extjs.Ext.panel.IPanel = js.native
  ...
  /** [Method] Restores a maximized window back to its original size and position prior to being maximized and also replaces the re
  		...
  		* @returns Ext.window.Window this
  		*/
  def restore(): typingsJapgolly.extjs.Ext.window.IWindow = js.native
  def restore(animate: js.Any): typingsJapgolly.extjs.Ext.window.IWindow = js.native
  ...
  /** [Method] Sets the body style according to the passed parameters
  		...
  		* @returns Ext.panel.Panel this
  		*/
  def setBodyStyle(): typingsJapgolly.extjs.Ext.panel.IPanel = js.native
  def setBodyStyle(style: js.Any): typingsJapgolly.extjs.Ext.panel.IPanel = js.native
  def setBodyStyle(style: js.Any, value: java.lang.String): typingsJapgolly.extjs.Ext.panel.IPanel = js.native
  /** [Method]
  		* @param border Object
  ...
  /** [Method] Adds the specified icon to the dialog
  		...
  		* @returns Ext.window.MessageBox this
  		*/
  def setIcon(): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def setIcon(icon: java.lang.String): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def setIcon(icon: java.lang.String, width: Double): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def setIcon(icon: java.lang.String, width: Double, height: Double): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  ...
  /** [Method] Displays a new message box or reinitializes an existing message box based on the config options passed in
  		...
  		* @returns Ext.window.MessageBox this
  		*/
  def show(): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def show(config: js.Any): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  ...
  def showBy(component: js.Any, position: java.lang.String, offsets: Array): IComponent = js.native
  ...
  /** [Method] Stops any running effects and clears this object s internal effects queue if it contains any additional effects that
  		...
  		*/
  def stopAnimation(): IElement = js.native
  /** [Method] Stops any running effects and clears this object s internal effects queue if it contains any additional effects that
  		* @returns Ext.Element The Element
  		*/
  def stopFx(): IElement = js.native
  ...
  /** [Method] Shortcut for performing an expand or collapse based on the current state of the panel
  		* @returns Ext.panel.Panel this
  		*/
  def toggleCollapse(): typingsJapgolly.extjs.Ext.panel.IPanel = js.native
  /** [Method] A shortcut method for toggling between maximize and restore based on the current maximized state of the window
  		* @returns Ext.window.Window this
  		*/
  def toggleMaximize(): typingsJapgolly.extjs.Ext.window.IWindow = js.native
  ...
  /** [Method] Navigates up the ownership hierarchy searching for an ancestor Container which matches any passed simple selector or
  		...
  		*/
  def up(): typingsJapgolly.extjs.Ext.container.IContainer = js.native
  def up(selector: js.Any): typingsJapgolly.extjs.Ext.container.IContainer = js.native
  def up(selector: js.Any, limit: js.Any): typingsJapgolly.extjs.Ext.container.IContainer = js.native
  ...
  /** [Method] Updates a progress style message box s text and progress bar
  		...
  		* @returns Ext.window.MessageBox this
  		*/
  def updateProgress(): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def updateProgress(value: Double): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def updateProgress(value: Double, progressText: java.lang.String): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def updateProgress(value: Double, progressText: java.lang.String, msg: java.lang.String): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def wait(msg: java.lang.String): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def wait(msg: java.lang.String, title: java.lang.String): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
  def wait(msg: java.lang.String, title: java.lang.String, config: js.Any): typingsJapgolly.extjs.Ext.window.IMessageBox = js.native
}
