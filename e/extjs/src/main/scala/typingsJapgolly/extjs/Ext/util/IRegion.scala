...
object IRegion {
  ...
  def apply(
    ...
    copyFrom: /* p */ js.UndefOr[IRegion] => CallbackTo[IRegion] = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IRegion] = null,
    ...
    statics: js.Any = null,
    translateBy: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[Double]) => CallbackTo[IRegion] = null,
    ...
    if (constrainTo != null) __obj.updateDynamic("constrainTo")(js.Any.fromFunction1((t0: /* targetRegion */ js.UndefOr[typingsJapgolly.extjs.Ext.util.IRegion]) => constrainTo(t0).runNow()))
    if (contains != null) __obj.updateDynamic("contains")(js.Any.fromFunction1((t0: /* region */ js.UndefOr[typingsJapgolly.extjs.Ext.util.IRegion]) => contains(t0).runNow()))
    copy.foreach(p => __obj.updateDynamic("copy")(p.toJsFn))
    if (copyFrom != null) __obj.updateDynamic("copyFrom")(js.Any.fromFunction1((t0: /* p */ js.UndefOr[typingsJapgolly.extjs.Ext.util.IRegion]) => copyFrom(t0).runNow()))
    if (equals != null) __obj.updateDynamic("equals")(js.Any.fromFunction1((t0: /* region */ js.UndefOr[typingsJapgolly.extjs.Ext.util.IRegion]) => equals(t0).runNow()))
    ...
    if (intersect != null) __obj.updateDynamic("intersect")(js.Any.fromFunction1((t0: /* region */ js.UndefOr[typingsJapgolly.extjs.Ext.util.IRegion]) => intersect(t0).runNow()))
    ...
    if (union != null) __obj.updateDynamic("union")(js.Any.fromFunction1((t0: /* region */ js.UndefOr[typingsJapgolly.extjs.Ext.util.IRegion]) => union(t0).runNow()))
