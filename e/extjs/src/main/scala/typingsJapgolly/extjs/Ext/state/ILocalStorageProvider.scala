...
object ILocalStorageProvider {
  ...
  def apply(
    ...
    clear: /* name */ js.UndefOr[js.Any] => Callback = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[ILocalStorageProvider] = null,
    ...
    self: IClass = null,
    set: (/* name */ js.UndefOr[js.Any], /* value */ js.UndefOr[js.Any]) => Callback = null,
    ...
    if (clear != null) __obj.updateDynamic("clear")(js.Any.fromFunction1((t0: /* name */ js.UndefOr[js.Any]) => clear(t0).runNow()))
    ...
    if (set != null) __obj.updateDynamic("set")(js.Any.fromFunction2((t0: /* name */ js.UndefOr[js.Any], t1: /* value */ js.UndefOr[js.Any]) => set(t0, t1).runNow()))
