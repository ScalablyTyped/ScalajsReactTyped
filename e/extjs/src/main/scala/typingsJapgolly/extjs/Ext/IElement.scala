...
trait IElement extends IAbstractElement {
  ...
  var addKeyMap: js.UndefOr[
    js.Function1[/* config */ js.UndefOr[js.Any], typingsJapgolly.extjs.Ext.util.IKeyMap]
  ] = js.undefined
...
object IElement {
  ...
  def apply(
    ...
    addClsOnClick: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    addClsOnFocus: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    addClsOnOver: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    ...
    addListener: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    alias: Array = null,
    ...
    boxWrap: /* clazz */ js.UndefOr[java.lang.String] => CallbackTo[IElement] = null,
    ...
    clearPositioning: /* value */ js.UndefOr[java.lang.String] => CallbackTo[IElement] = null,
    ...
    enableDisplayMode: /* display */ js.UndefOr[java.lang.String] => CallbackTo[IElement] = null,
    ...
    frame: (/* color */ js.UndefOr[java.lang.String], /* count */ js.UndefOr[Double], /* options */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    ...
    ghost: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    ...
    highlight: (/* color */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    ...
    insertSibling: (/* el */ js.UndefOr[js.Any], /* where */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => CallbackTo[IElement] = null,
    ...
    mask: (/* msg */ js.UndefOr[java.lang.String], /* msgCls */ js.UndefOr[java.lang.String]) => CallbackTo[IElement] = null,
    mixins: js.Any = null,
    ...
    on: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    ...
    removeListener: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    ...
    scrollTo: (/* side */ js.UndefOr[java.lang.String], /* value */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    ...
    setHeight: /* height */ js.UndefOr[js.Any] => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    ...
    setSize: (/* width */ js.UndefOr[js.Any], /* height */ js.UndefOr[js.Any]) => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    ...
    setWidth: /* width */ js.UndefOr[js.Any] => CallbackTo[typingsJapgolly.extjs.Ext.dom.IElement] = null,
    shift: /* options */ js.UndefOr[js.Any] => CallbackTo[IElement] = null,
    show: /* animate */ js.UndefOr[js.Any] => CallbackTo[IElement] = null,
    singleton: js.UndefOr[Boolean] = js.undefined,
    slideIn: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    slideOut: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    statics: js.Any = null,
    ...
    un: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    ...
    update: (/* html */ js.UndefOr[java.lang.String], /* loadScripts */ js.UndefOr[Boolean], /* callback */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    uses: Array = null,
