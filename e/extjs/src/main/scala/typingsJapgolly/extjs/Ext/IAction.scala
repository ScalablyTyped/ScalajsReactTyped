...
object IAction {
  ...
  extension [Self <: IAction](x: Self) {
    ...
    inline def setExecute(value: /* repeated */ Any => Callback): Self = StObject.set(x, "execute", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
    
    inline def setExecuteUndefined: Self = StObject.set(x, "execute", js.undefined)
    
    inline def setGetIconCls(value: Callback): Self = StObject.set(x, "getIconCls", value.toJsFn)
    ...
    inline def setIsDisabled(value: Callback): Self = StObject.set(x, "isDisabled", value.toJsFn)
    
    inline def setIsDisabledUndefined: Self = StObject.set(x, "isDisabled", js.undefined)
    
    inline def setIsHidden(value: Callback): Self = StObject.set(x, "isHidden", value.toJsFn)
    ...
    inline def setSetHandler(value: (/* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "setHandler", js.Any.fromFunction2((t0: /* fn */ js.UndefOr[Any], t1: /* scope */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
