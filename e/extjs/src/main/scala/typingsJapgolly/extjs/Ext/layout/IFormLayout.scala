...
trait IFormLayout
  ...
  /** [Method] Called to perform the calculations for this layout
    ...
    */
  @JSName("calculate")
  var calculate_IFormLayout: js.UndefOr[js.Function1[/* ownerContext */ js.UndefOr[Any], Unit]] = js.undefined
  ...
  var completeLayout_IFormLayout: js.UndefOr[js.Function1[/* ownerContext */ js.UndefOr[Any], Unit]] = js.undefined
  ...
  var getItemSizePolicy_IFormLayout: js.UndefOr[js.Function1[/* item */ js.UndefOr[Any], ISizePolicy]] = js.undefined
...
object IFormLayout {
  ...
  extension [Self <: IFormLayout](x: Self) {
    ...
    inline def setCalculateOverflow(
      value: (/* ownerContext */ js.UndefOr[IContextItem], /* containerSize */ js.UndefOr[Any], /* dimensions */ js.UndefOr[Double]) => Callback
    ): Self = StObject.set(x, "calculateOverflow", js.Any.fromFunction3((t0: /* ownerContext */ js.UndefOr[IContextItem], t1: /* containerSize */ js.UndefOr[Any], t2: /* dimensions */ js.UndefOr[Double]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setDoRenderPadder(value: (/* out */ js.UndefOr[Any], /* renderData */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "doRenderPadder", js.Any.fromFunction2((t0: /* out */ js.UndefOr[Any], t1: /* renderData */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
