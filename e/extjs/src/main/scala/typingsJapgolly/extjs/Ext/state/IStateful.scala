...
object IStateful {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IStateful] = null,
    ...
    savePropToState: (/* propName */ js.UndefOr[String], /* state */ js.UndefOr[js.Any], /* stateName */ js.UndefOr[String]) => CallbackTo[Boolean] = null,
