...
object IBoxLayout {
  ...
  extension [Self <: IBoxLayout](x: Self) {
    ...
    inline def setCacheFlexes(value: /* ownerContext */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "cacheFlexes", js.Any.fromFunction1((t0: /* ownerContext */ js.UndefOr[Any]) => value(t0).runNow()))
