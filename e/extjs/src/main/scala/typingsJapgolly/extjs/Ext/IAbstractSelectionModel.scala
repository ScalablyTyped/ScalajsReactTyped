...
object IAbstractSelectionModel {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IAbstractSelectionModel] = null,
    ...
    setSelectionMode: /* selMode */ js.UndefOr[java.lang.String] => Callback = null,
    ...
    if (isFocused != null) __obj.updateDynamic("isFocused")(js.Any.fromFunction1((t0: /* record */ js.UndefOr[typingsJapgolly.extjs.Ext.data.IModel]) => isFocused(t0).runNow()))
    ...
    if (setLastFocused != null) __obj.updateDynamic("setLastFocused")(js.Any.fromFunction1((t0: /* record */ js.UndefOr[typingsJapgolly.extjs.Ext.data.IModel]) => setLastFocused(t0).runNow()))
