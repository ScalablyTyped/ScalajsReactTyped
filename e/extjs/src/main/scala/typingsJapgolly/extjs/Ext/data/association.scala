...
object association {
  ...
  object IAssociation {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.data.association.IAssociation = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.data.association.IAssociation]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.data.association.IAssociation](x: Self) {
  ...
  trait IBelongsTo
    extends StObject
       with typingsJapgolly.extjs.Ext.data.association.IAssociation {
