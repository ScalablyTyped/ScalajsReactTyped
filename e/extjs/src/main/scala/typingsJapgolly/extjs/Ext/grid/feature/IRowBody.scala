...
object IRowBody {
  ...
  def apply(
    ...
    getAdditionalData: (/* data */ js.UndefOr[js.Any], /* idx */ js.UndefOr[Double], /* record */ js.UndefOr[IModel], /* orig */ js.UndefOr[js.Any]) => Callback = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IRowBody] = null,
    ...
    if (getAdditionalData != null) __obj.updateDynamic("getAdditionalData")(js.Any.fromFunction4((t0: /* data */ js.UndefOr[js.Any], t1: /* idx */ js.UndefOr[scala.Double], t2: /* record */ js.UndefOr[typingsJapgolly.extjs.Ext.data.IModel], t3: /* orig */ js.UndefOr[js.Any]) => getAdditionalData(t0, t1, t2, t3).runNow()))
