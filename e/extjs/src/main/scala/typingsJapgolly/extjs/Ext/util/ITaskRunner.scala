...
object ITaskRunner {
  ...
  extension [Self <: ITaskRunner](x: Self) {
    ...
    inline def setNewTask(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "newTask", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setStopAll(value: Callback): Self = StObject.set(x, "stopAll", value.toJsFn)
