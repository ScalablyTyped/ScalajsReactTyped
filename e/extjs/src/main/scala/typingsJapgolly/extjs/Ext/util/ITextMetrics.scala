...
object ITextMetrics {
  ...
  extension [Self <: ITextMetrics](x: Self) {
    ...
    inline def setBind(value: /* el */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "bind", js.Any.fromFunction1((t0: /* el */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setSetFixedWidth(value: /* width */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setFixedWidth", js.Any.fromFunction1((t0: /* width */ js.UndefOr[Double]) => value(t0).runNow()))
