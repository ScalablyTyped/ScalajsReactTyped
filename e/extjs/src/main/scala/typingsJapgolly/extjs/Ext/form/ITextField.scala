...
trait ITextField
  ...
  /** [Method] Applies the state to the object
    ...
    */
  @JSName("applyState")
  var applyState_ITextField: js.UndefOr[js.Function1[/* state */ js.UndefOr[Any], Unit]] = js.undefined
  ...
  /** [Method] Validates a value according to the field s validation rules and returns an array of errors for any failing validations
    ...
    */
  @JSName("getErrors")
  var getErrors_ITextField: js.UndefOr[js.Function1[/* value */ js.UndefOr[Any], Array]] = js.undefined
  ...
  /** [Method] The supplied default state gathering method for the AbstractComponent class
    ...
    */
  @JSName("getState")
  var getState_ITextField: js.UndefOr[js.Function0[Any]] = js.undefined
  ...
  /** [Method] Sets a data value into the field and runs the change detection and validation
    ...
    */
  @JSName("setValue")
  var setValue_ITextField: js.UndefOr[js.Function1[/* value */ js.UndefOr[Any], Any]] = js.undefined
...
object ITextField {
  ...
  extension [Self <: ITextField](x: Self) {
    ...
    inline def setBeforeFocus(value: Callback): Self = StObject.set(x, "beforeFocus", value.toJsFn)
    ...
    inline def setPostBlur(value: Callback): Self = StObject.set(x, "postBlur", value.toJsFn)
    ...
    inline def setSelectText(value: (/* start */ js.UndefOr[Double], /* end */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "selectText", js.Any.fromFunction2((t0: /* start */ js.UndefOr[Double], t1: /* end */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
