...
import typingsJapgolly.extjs.Ext.dd.IStatusProxy
...
object ISpriteDD {
  ...
  def apply(
    ...
    extend: String = null,
    getDragData: /* e */ js.UndefOr[js.Any] => CallbackTo[js.Any] = null,
    getDragEl: /* e */ js.UndefOr[js.Any] => CallbackTo[HTMLElement] = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[ISpriteDD] = null,
    ...
    setDragElPos: js.UndefOr[Callback] = js.undefined,
    ...
    if (getDragData != null) __obj.updateDynamic("getDragData")(js.Any.fromFunction1((t0: /* e */ js.UndefOr[js.Any]) => getDragData(t0).runNow()))
    if (getDragEl != null) __obj.updateDynamic("getDragEl")(js.Any.fromFunction1((t0: /* e */ js.UndefOr[js.Any]) => getDragEl(t0).runNow()))
    ...
    setDragElPos.foreach(p => __obj.updateDynamic("setDragElPos")(p.toJsFn))
