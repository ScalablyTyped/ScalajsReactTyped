...
object IJsonP {
  ...
  def apply(
    ...
    encodeRecords: /* records */ js.UndefOr[Array] => CallbackTo[Array] = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IJsonP] = null,
    ...
    if (encodeRecords != null) __obj.updateDynamic("encodeRecords")(js.Any.fromFunction1((t0: /* records */ js.UndefOr[typingsJapgolly.extjs.Ext.Array]) => encodeRecords(t0).runNow()))
