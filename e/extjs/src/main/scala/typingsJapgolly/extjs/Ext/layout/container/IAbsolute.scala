...
object IAbsolute {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IAbsolute] = null,
    ...
    onContentChange: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    self: IClass = null,
    setCtSizeIfNeeded: (/* ownerContext */ js.UndefOr[IContextItem], /* containerSize */ js.UndefOr[js.Any]) => Callback = null,
    ...
    onContentChange.foreach(p => __obj.updateDynamic("onContentChange")(p.toJsFn))
    ...
    if (setCtSizeIfNeeded != null) __obj.updateDynamic("setCtSizeIfNeeded")(js.Any.fromFunction2((t0: /* ownerContext */ js.UndefOr[typingsJapgolly.extjs.Ext.layout.IContextItem], t1: /* containerSize */ js.UndefOr[js.Any]) => setCtSizeIfNeeded(t0, t1).runNow()))
