...
object IDragTracker {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IDragTracker] = null,
    ...
    onBeforeStart: /* e */ js.UndefOr[IEventObject] => Callback = null,
    onDrag: /* e */ js.UndefOr[IEventObject] => Callback = null,
    onEnd: /* e */ js.UndefOr[IEventObject] => Callback = null,
    onStart: /* e */ js.UndefOr[IEventObject] => Callback = null,
    overCls: String = null,
    ...
    if (onBeforeStart != null) __obj.updateDynamic("onBeforeStart")(js.Any.fromFunction1((t0: /* e */ js.UndefOr[typingsJapgolly.extjs.Ext.IEventObject]) => onBeforeStart(t0).runNow()))
    if (onDrag != null) __obj.updateDynamic("onDrag")(js.Any.fromFunction1((t0: /* e */ js.UndefOr[typingsJapgolly.extjs.Ext.IEventObject]) => onDrag(t0).runNow()))
    if (onEnd != null) __obj.updateDynamic("onEnd")(js.Any.fromFunction1((t0: /* e */ js.UndefOr[typingsJapgolly.extjs.Ext.IEventObject]) => onEnd(t0).runNow()))
    if (onStart != null) __obj.updateDynamic("onStart")(js.Any.fromFunction1((t0: /* e */ js.UndefOr[typingsJapgolly.extjs.Ext.IEventObject]) => onStart(t0).runNow()))
