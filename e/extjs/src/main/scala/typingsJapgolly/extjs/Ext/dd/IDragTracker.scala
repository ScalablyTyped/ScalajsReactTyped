...
object IDragTracker {
  ...
  extension [Self <: IDragTracker](x: Self) {
    ...
    inline def setGetDragTarget(value: CallbackTo[IElement]): Self = StObject.set(x, "getDragTarget", value.toJsFn)
    ...
    inline def setInitEl(value: /* el */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "initEl", js.Any.fromFunction1((t0: /* el */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setInitElUndefined: Self = StObject.set(x, "initEl", js.undefined)
    
    inline def setOnBeforeStart(value: /* e */ js.UndefOr[IEventObject] => Callback): Self = StObject.set(x, "onBeforeStart", js.Any.fromFunction1((t0: /* e */ js.UndefOr[IEventObject]) => value(t0).runNow()))
    
    inline def setOnBeforeStartUndefined: Self = StObject.set(x, "onBeforeStart", js.undefined)
    
    inline def setOnDrag(value: /* e */ js.UndefOr[IEventObject] => Callback): Self = StObject.set(x, "onDrag", js.Any.fromFunction1((t0: /* e */ js.UndefOr[IEventObject]) => value(t0).runNow()))
    
    inline def setOnDragUndefined: Self = StObject.set(x, "onDrag", js.undefined)
    
    inline def setOnEnd(value: /* e */ js.UndefOr[IEventObject] => Callback): Self = StObject.set(x, "onEnd", js.Any.fromFunction1((t0: /* e */ js.UndefOr[IEventObject]) => value(t0).runNow()))
    
    inline def setOnEndUndefined: Self = StObject.set(x, "onEnd", js.undefined)
    
    inline def setOnStart(value: /* e */ js.UndefOr[IEventObject] => Callback): Self = StObject.set(x, "onStart", js.Any.fromFunction1((t0: /* e */ js.UndefOr[IEventObject]) => value(t0).runNow()))
