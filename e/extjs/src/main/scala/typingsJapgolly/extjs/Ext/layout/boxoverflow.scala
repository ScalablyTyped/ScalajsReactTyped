...
object boxoverflow {
  ...
  object IScroller {
    ...
    extension [Self <: IScroller](x: Self) {
      ...
      inline def setScrollToItem(value: (/* item */ js.UndefOr[Any], /* animate */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "scrollToItem", js.Any.fromFunction2((t0: /* item */ js.UndefOr[Any], t1: /* animate */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
