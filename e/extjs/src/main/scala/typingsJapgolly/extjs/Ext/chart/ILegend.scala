...
object ILegend {
  ...
  extension [Self <: ILegend](x: Self) {
    ...
    inline def setToggle(value: /* show */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "toggle", js.Any.fromFunction1((t0: /* show */ js.UndefOr[Boolean]) => value(t0).runNow()))
