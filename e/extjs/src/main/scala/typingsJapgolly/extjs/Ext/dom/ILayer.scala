...
trait ILayer
  extends typingsJapgolly.extjs.Ext.IElement {
...
object ILayer {
  ...
  def apply(
    ...
    addClsOnClick: (/* className */ js.UndefOr[String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    addClsOnFocus: (/* className */ js.UndefOr[String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    addClsOnOver: (/* className */ js.UndefOr[String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    ...
    addListener: (/* eventName */ js.UndefOr[String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    alias: Array = null,
    ...
    boxWrap: /* clazz */ js.UndefOr[String] => CallbackTo[ILayer] = null,
    ...
    clearPositioning: /* value */ js.UndefOr[String] => CallbackTo[ILayer] = null,
    ...
    enableDisplayMode: /* display */ js.UndefOr[String] => CallbackTo[ILayer] = null,
    extend: String = null,
    ...
    frame: (/* color */ js.UndefOr[String], /* count */ js.UndefOr[Double], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    ...
    ghost: (/* anchor */ js.UndefOr[String], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    ...
    highlight: (/* color */ js.UndefOr[String], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    ...
    insertSibling: (/* el */ js.UndefOr[js.Any], /* where */ js.UndefOr[String], /* returnDom */ js.UndefOr[Boolean]) => CallbackTo[ILayer] = null,
    ...
    mask: (/* msg */ js.UndefOr[String], /* msgCls */ js.UndefOr[String]) => CallbackTo[ILayer] = null,
    mixins: js.Any = null,
    ...
    on: (/* eventName */ js.UndefOr[String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    ...
    removeListener: (/* eventName */ js.UndefOr[String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    ...
    scrollTo: (/* side */ js.UndefOr[String], /* value */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    ...
    setBounds: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[js.Any], /* width */ js.UndefOr[js.Any], /* height */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    ...
    setHeight: (/* h */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    ...
    setSize: (/* w */ js.UndefOr[js.Any], /* h */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    ...
    setVisible: (/* visible */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    setWidth: (/* w */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => CallbackTo[IElement] = null,
    ...
    slideIn: (/* anchor */ js.UndefOr[String], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    slideOut: (/* anchor */ js.UndefOr[String], /* options */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    statics: js.Any = null,
    ...
    un: (/* eventName */ js.UndefOr[String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
    ...
    update: (/* html */ js.UndefOr[String], /* loadScripts */ js.UndefOr[Boolean], /* callback */ js.UndefOr[js.Any]) => CallbackTo[ILayer] = null,
