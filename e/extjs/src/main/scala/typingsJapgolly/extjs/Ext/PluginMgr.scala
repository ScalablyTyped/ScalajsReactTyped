...
@js.native
class PluginMgr () extends js.Object
...
object PluginMgr extends js.Object {
  ...
  /** [Method] Returns all plugins registered with the given type
  		...
  		*/
  def findByType(): Array = js.native
  def findByType(`type`: java.lang.String): Array = js.native
  def findByType(`type`: java.lang.String, defaultsOnly: Boolean): Array = js.native
