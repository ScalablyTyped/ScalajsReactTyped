...
object Record extends js.Object {
  ...
  /** [Method] Returns the configured Proxy for this Model
  		...
  		*/
  def getProxy(): typingsJapgolly.extjs.Ext.data.proxy.IProxy = js.native
  ...
  /** [Method] Sets the Proxy to use for this model
  		...
  		*/
  def setProxy(): typingsJapgolly.extjs.Ext.data.proxy.IProxy = js.native
  def setProxy(proxy: js.Any): typingsJapgolly.extjs.Ext.data.proxy.IProxy = js.native
}
