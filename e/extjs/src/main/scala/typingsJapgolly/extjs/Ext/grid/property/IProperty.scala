package typingsJapgolly.extjs.Ext.grid.property
...
object IProperty {
  ...
  def apply(
    ...
    config: js.Any = null,
    copy: /* id */ js.UndefOr[String] => CallbackTo[IProperty] = null,
    defaultProxyType: String = null,
    destroy: /* options */ js.UndefOr[js.Any] => CallbackTo[IProperty] = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IProperty] = null,
    ...
    join: /* store */ js.UndefOr[typingsJapgolly.extjs.Ext.data.IStore] => Callback = null,
    ...
    save: /* options */ js.UndefOr[js.Any] => CallbackTo[IProperty] = null,
    self: IClass = null,
    ...
    statics: js.Any = null,
    store: typingsJapgolly.extjs.Ext.data.IStore = null,
    stores: Array = null,
    ...
    unjoin: /* store */ js.UndefOr[typingsJapgolly.extjs.Ext.data.IStore] => Callback = null,
    uses: Array = null,
