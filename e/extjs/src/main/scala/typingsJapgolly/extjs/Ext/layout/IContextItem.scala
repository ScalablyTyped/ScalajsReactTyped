...
object IContextItem {
  ...
  extension [Self <: IContextItem](x: Self) {
    ...
    inline def setAddCls(value: /* newCls */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "addCls", js.Any.fromFunction1((t0: /* newCls */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setAddClsUndefined: Self = StObject.set(x, "addCls", js.undefined)
    
    inline def setBlock(value: (/* layout */ js.UndefOr[ILayout], /* propName */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "block", js.Any.fromFunction2((t0: /* layout */ js.UndefOr[ILayout], t1: /* propName */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
    
    inline def setBlockUndefined: Self = StObject.set(x, "block", js.undefined)
    
    inline def setClearMarginCache(value: Callback): Self = StObject.set(x, "clearMarginCache", value.toJsFn)
    
    inline def setClearMarginCacheUndefined: Self = StObject.set(x, "clearMarginCache", js.undefined)
    
    inline def setDomBlock(value: (/* layout */ js.UndefOr[ILayout], /* propName */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "domBlock", js.Any.fromFunction2((t0: /* layout */ js.UndefOr[ILayout], t1: /* propName */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
    ...
    inline def setGetBorderInfo(value: CallbackTo[Any]): Self = StObject.set(x, "getBorderInfo", value.toJsFn)
    
    inline def setGetBorderInfoUndefined: Self = StObject.set(x, "getBorderInfo", js.undefined)
    
    inline def setGetClassList(value: Callback): Self = StObject.set(x, "getClassList", value.toJsFn)
    ...
    inline def setGetFrameInfo(value: CallbackTo[Any]): Self = StObject.set(x, "getFrameInfo", value.toJsFn)
    
    inline def setGetFrameInfoUndefined: Self = StObject.set(x, "getFrameInfo", js.undefined)
    
    inline def setGetMarginInfo(value: CallbackTo[Any]): Self = StObject.set(x, "getMarginInfo", value.toJsFn)
    
    inline def setGetMarginInfoUndefined: Self = StObject.set(x, "getMarginInfo", js.undefined)
    
    inline def setGetPaddingInfo(value: CallbackTo[Any]): Self = StObject.set(x, "getPaddingInfo", value.toJsFn)
    ...
    inline def setInvalidate(value: /* options */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "invalidate", js.Any.fromFunction1((t0: /* options */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setInvalidateUndefined: Self = StObject.set(x, "invalidate", js.undefined)
    
    inline def setRecoverProp(
      value: (/* propName */ js.UndefOr[String], /* oldProps */ js.UndefOr[Any], /* oldDirty */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "recoverProp", js.Any.fromFunction3((t0: /* propName */ js.UndefOr[String], t1: /* oldProps */ js.UndefOr[Any], t2: /* oldDirty */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
    
    inline def setRecoverPropUndefined: Self = StObject.set(x, "recoverProp", js.undefined)
    
    inline def setRemoveCls(value: /* removeCls */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "removeCls", js.Any.fromFunction1((t0: /* removeCls */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setRemoveClsUndefined: Self = StObject.set(x, "removeCls", js.undefined)
    
    inline def setRemoveEl(value: (/* nameOrEl */ js.UndefOr[Any], /* owner */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "removeEl", js.Any.fromFunction2((t0: /* nameOrEl */ js.UndefOr[Any], t1: /* owner */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    
    inline def setRemoveElUndefined: Self = StObject.set(x, "removeEl", js.undefined)
    
    inline def setSetAttribute(value: (/* name */ js.UndefOr[Any], /* value */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "setAttribute", js.Any.fromFunction2((t0: /* name */ js.UndefOr[Any], t1: /* value */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    
    inline def setSetAttributeUndefined: Self = StObject.set(x, "setAttribute", js.undefined)
    
    inline def setSetContentHeight(value: (/* height */ js.UndefOr[Any], /* measured */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "setContentHeight", js.Any.fromFunction2((t0: /* height */ js.UndefOr[Any], t1: /* measured */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    
    inline def setSetContentHeightUndefined: Self = StObject.set(x, "setContentHeight", js.undefined)
    
    inline def setSetContentSize(
      value: (/* width */ js.UndefOr[Any], /* height */ js.UndefOr[Any], /* measured */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "setContentSize", js.Any.fromFunction3((t0: /* width */ js.UndefOr[Any], t1: /* height */ js.UndefOr[Any], t2: /* measured */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
    
    inline def setSetContentSizeUndefined: Self = StObject.set(x, "setContentSize", js.undefined)
    
    inline def setSetContentWidth(value: (/* width */ js.UndefOr[Any], /* measured */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "setContentWidth", js.Any.fromFunction2((t0: /* width */ js.UndefOr[Any], t1: /* measured */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
