...
object app {
  ...
  object IController {
    ...
    extension [Self <: IController](x: Self) {
      ...
      inline def setAddRef(value: /* refs */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "addRef", js.Any.fromFunction1((t0: /* refs */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setControl(value: (/* selectors */ js.UndefOr[Any], /* listeners */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "control", js.Any.fromFunction2((t0: /* selectors */ js.UndefOr[Any], t1: /* listeners */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
      ...
      inline def setInit(value: /* application */ js.UndefOr[IApplication] => Callback): Self = StObject.set(x, "init", js.Any.fromFunction1((t0: /* application */ js.UndefOr[IApplication]) => value(t0).runNow()))
      
      inline def setInitUndefined: Self = StObject.set(x, "init", js.undefined)
      
      inline def setListen(value: /* to */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "listen", js.Any.fromFunction1((t0: /* to */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setOnLaunch(value: /* application */ js.UndefOr[IApplication] => Callback): Self = StObject.set(x, "onLaunch", js.Any.fromFunction1((t0: /* application */ js.UndefOr[IApplication]) => value(t0).runNow()))
  ...
  object IEventDomain {
    ...
    extension [Self <: IEventDomain](x: Self) {
      ...
      inline def setMonitor(value: /* observable */ js.UndefOr[IClass] => Callback): Self = StObject.set(x, "monitor", js.Any.fromFunction1((t0: /* observable */ js.UndefOr[IClass]) => value(t0).runNow()))
