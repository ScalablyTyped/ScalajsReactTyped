...
import typingsJapgolly.extjs.Ext.panel.IAbstractPanel
...
object IPanel {
  ...
  extension [Self <: IPanel](x: Self) {
    ...
    inline def setToggleCollapse(value: CallbackTo[IPanel]): Self = StObject.set(x, "toggleCollapse", value.toJsFn)
