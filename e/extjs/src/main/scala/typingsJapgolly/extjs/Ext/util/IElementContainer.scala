...
object IElementContainer {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IElementContainer] = null,
    mixins: js.Any = null,
    removeChildEls: /* testFn */ js.UndefOr[js.Any] => Callback = null,
    requires: Array = null,
    self: IClass = null,
    ...
    if (removeChildEls != null) __obj.updateDynamic("removeChildEls")(js.Any.fromFunction1((t0: /* testFn */ js.UndefOr[js.Any]) => removeChildEls(t0).runNow()))
