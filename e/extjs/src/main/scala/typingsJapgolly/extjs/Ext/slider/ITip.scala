...
trait ITip
  extends typingsJapgolly.extjs.Ext.tip.ITip {
...
object ITip {
  @scala.inline
  def apply(
    ITip: typingsJapgolly.extjs.Ext.tip.ITip = null,
    align: String = null,
    getText: /* thumb */ js.UndefOr[IThumb] => CallbackTo[String] = null,
    offsets: Array = null,
    ...
    if (getText != null) __obj.updateDynamic("getText")(js.Any.fromFunction1((t0: /* thumb */ js.UndefOr[typingsJapgolly.extjs.Ext.slider.IThumb]) => getText(t0).runNow()))
