...
object IArea {
  ...
  def apply(
    ...
    highlightSeries: /* item */ js.UndefOr[js.Any] => Callback = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IArea] = null,
    ...
    unHighlightSeries: /* item */ js.UndefOr[js.Any] => Callback = null,
    uses: Array = null,
    xField: String = null,
    yField: js.Any = null
  ): IArea = {
    ...
    if (highlightSeries != null) __obj.updateDynamic("highlightSeries")(js.Any.fromFunction1((t0: /* item */ js.UndefOr[js.Any]) => highlightSeries(t0).runNow()))
    ...
    if (unHighlightSeries != null) __obj.updateDynamic("unHighlightSeries")(js.Any.fromFunction1((t0: /* item */ js.UndefOr[js.Any]) => unHighlightSeries(t0).runNow()))
