...
object ICellEditing {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[ICellEditing] = null,
    ...
    startEdit: (/* record */ js.UndefOr[js.Any], /* columnHeader */ js.UndefOr[js.Any]) => CallbackTo[Boolean] = null,
    startEditByPosition: /* position */ js.UndefOr[js.Any] => Callback = null,
    statics: js.Any = null,
    ...
    if (startEditByPosition != null) __obj.updateDynamic("startEditByPosition")(js.Any.fromFunction1((t0: /* position */ js.UndefOr[js.Any]) => startEditByPosition(t0).runNow()))
