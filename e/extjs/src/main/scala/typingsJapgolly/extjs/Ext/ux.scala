...
import typingsJapgolly.extjs.Ext.form.field.ITrigger
...
object ux {
  ...
  object form {
    ...
    trait IFileUploadField
      ...
      var button: js.UndefOr[typingsJapgolly.extjs.Ext.button.IButton] = js.undefined
    ...
    object IFileUploadField {
      ...
      extension [Self <: IFileUploadField](x: Self) {
        ...
        inline def setButton(value: typingsJapgolly.extjs.Ext.button.IButton): Self = StObject.set(x, "button", value.asInstanceOf[js.Any])
