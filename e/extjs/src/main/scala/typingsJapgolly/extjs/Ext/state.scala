...
object state {
  ...
  object ICookieProvider {
    ...
    extension [Self <: ICookieProvider](x: Self) {
      ...
      inline def setClear(value: /* name */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "clear", js.Any.fromFunction1((t0: /* name */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setSet(value: (/* name */ js.UndefOr[Any], /* value */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "set", js.Any.fromFunction2((t0: /* name */ js.UndefOr[Any], t1: /* value */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
  ...
  object IProvider {
    ...
    extension [Self <: IProvider](x: Self) {
      ...
      inline def setClear(value: /* name */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "clear", js.Any.fromFunction1((t0: /* name */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      ...
      inline def setSet(value: (/* name */ js.UndefOr[java.lang.String], /* value */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "set", js.Any.fromFunction2((t0: /* name */ js.UndefOr[java.lang.String], t1: /* value */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
  ...
  object IStateful {
    ...
    extension [Self <: IStateful](x: Self) {
      ...
      inline def setAddStateEvents(value: /* events */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "addStateEvents", js.Any.fromFunction1((t0: /* events */ js.UndefOr[Any]) => value(t0).runNow()))
