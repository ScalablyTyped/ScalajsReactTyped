...
- typingsJapgolly.extjs.Ext.util.IBindable because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined bindStore, bindStoreListeners, getStore, getStoreListeners, onBindStore, onUnbindStore, unbindStoreListeners */ trait IModel extends IObservable {
...
object IModel {
  ...
  def apply(
    ...
    getLastSelected: js.UndefOr[CallbackTo[IModel]] = js.undefined,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IModel] = null,
    isFocused: /* record */ js.UndefOr[IModel] => Callback = null,
    ...
    self: IClass = null,
    setLastFocused: /* record */ js.UndefOr[IModel] => Callback = null,
    ...
    if (isFocused != null) __obj.updateDynamic("isFocused")(js.Any.fromFunction1((t0: /* record */ js.UndefOr[typingsJapgolly.extjs.Ext.selection.IModel]) => isFocused(t0).runNow()))
    ...
    if (setLastFocused != null) __obj.updateDynamic("setLastFocused")(js.Any.fromFunction1((t0: /* record */ js.UndefOr[typingsJapgolly.extjs.Ext.selection.IModel]) => setLastFocused(t0).runNow()))
