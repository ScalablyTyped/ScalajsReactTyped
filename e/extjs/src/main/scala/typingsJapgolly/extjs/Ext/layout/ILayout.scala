...
object ILayout {
  ...
  extension [Self <: ILayout](x: Self) {
    ...
    inline def setAfterRemove(value: /* item */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "afterRemove", js.Any.fromFunction1((t0: /* item */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setAfterRemoveUndefined: Self = StObject.set(x, "afterRemove", js.undefined)
    
    inline def setBeginLayout(value: /* ownerContext */ js.UndefOr[IContextItem] => Callback): Self = StObject.set(x, "beginLayout", js.Any.fromFunction1((t0: /* ownerContext */ js.UndefOr[IContextItem]) => value(t0).runNow()))
    
    inline def setBeginLayoutCycle(value: /* ownerContext */ js.UndefOr[IContextItem] => Callback): Self = StObject.set(x, "beginLayoutCycle", js.Any.fromFunction1((t0: /* ownerContext */ js.UndefOr[IContextItem]) => value(t0).runNow()))
    ...
    inline def setCalculate(value: /* ownerContext */ js.UndefOr[IContextItem] => Callback): Self = StObject.set(x, "calculate", js.Any.fromFunction1((t0: /* ownerContext */ js.UndefOr[IContextItem]) => value(t0).runNow()))
    
    inline def setCalculateUndefined: Self = StObject.set(x, "calculate", js.undefined)
    
    inline def setCompleteLayout(value: /* ownerContext */ js.UndefOr[IContextItem] => Callback): Self = StObject.set(x, "completeLayout", js.Any.fromFunction1((t0: /* ownerContext */ js.UndefOr[IContextItem]) => value(t0).runNow()))
    
    inline def setCompleteLayoutUndefined: Self = StObject.set(x, "completeLayout", js.undefined)
    
    inline def setConfigureItem(value: /* item */ js.UndefOr[IComponent] => Callback): Self = StObject.set(x, "configureItem", js.Any.fromFunction1((t0: /* item */ js.UndefOr[IComponent]) => value(t0).runNow()))
    ...
    inline def setFinalizeLayout(value: /* ownerContext */ js.UndefOr[IContextItem] => Callback): Self = StObject.set(x, "finalizeLayout", js.Any.fromFunction1((t0: /* ownerContext */ js.UndefOr[IContextItem]) => value(t0).runNow()))
    
    inline def setFinalizeLayoutUndefined: Self = StObject.set(x, "finalizeLayout", js.undefined)
    
    inline def setFinishedLayout(value: /* ownerContext */ js.UndefOr[IContextItem] => Callback): Self = StObject.set(x, "finishedLayout", js.Any.fromFunction1((t0: /* ownerContext */ js.UndefOr[IContextItem]) => value(t0).runNow()))
    ...
    inline def setGetLayoutItems(value: Callback): Self = StObject.set(x, "getLayoutItems", value.toJsFn)
    
    inline def setGetLayoutItemsUndefined: Self = StObject.set(x, "getLayoutItems", js.undefined)
    
    inline def setInitLayout(value: Callback): Self = StObject.set(x, "initLayout", value.toJsFn)
    ...
    inline def setIsValidParent(
      value: (/* item */ js.UndefOr[Any], /* target */ js.UndefOr[Any], /* position */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "isValidParent", js.Any.fromFunction3((t0: /* item */ js.UndefOr[Any], t1: /* target */ js.UndefOr[Any], t2: /* position */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
    
    inline def setIsValidParentUndefined: Self = StObject.set(x, "isValidParent", js.undefined)
    
    inline def setNotifyOwner(value: /* ownerContext */ js.UndefOr[IContextItem] => Callback): Self = StObject.set(x, "notifyOwner", js.Any.fromFunction1((t0: /* ownerContext */ js.UndefOr[IContextItem]) => value(t0).runNow()))
    ...
    inline def setRenderItems(value: (/* items */ js.UndefOr[Any], /* target */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "renderItems", js.Any.fromFunction2((t0: /* items */ js.UndefOr[Any], t1: /* target */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
