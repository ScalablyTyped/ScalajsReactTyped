...
object ISorter {
  ...
  extension [Self <: ISorter](x: Self) {
    ...
    inline def setUpdateSortFunction(value: /* fn */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "updateSortFunction", js.Any.fromFunction1((t0: /* fn */ js.UndefOr[Any]) => value(t0).runNow()))
