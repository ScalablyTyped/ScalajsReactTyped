...
object IStore {
  ...
  extension [Self <: IStore](x: Self) {
    ...
    inline def setAddFilter(value: (/* filters */ js.UndefOr[Any], /* applyFilters */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "addFilter", js.Any.fromFunction2((t0: /* filters */ js.UndefOr[Any], t1: /* applyFilters */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
    
    inline def setAddFilterUndefined: Self = StObject.set(x, "addFilter", js.undefined)
    
    inline def setAddSorted(value: /* record */ js.UndefOr[IRecord] => Callback): Self = StObject.set(x, "addSorted", js.Any.fromFunction1((t0: /* record */ js.UndefOr[IRecord]) => value(t0).runNow()))
    ...
    inline def setClearGrouping(value: Callback): Self = StObject.set(x, "clearGrouping", value.toJsFn)
    ...
    inline def setFilter(value: (/* filters */ js.UndefOr[Any], /* value */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "filter", js.Any.fromFunction2((t0: /* filters */ js.UndefOr[Any], t1: /* value */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
    ...
    inline def setGroup(value: (/* groupers */ js.UndefOr[Any], /* direction */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "group", js.Any.fromFunction2((t0: /* groupers */ js.UndefOr[Any], t1: /* direction */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
    ...
    inline def setGuaranteeRange(
      value: (/* start */ js.UndefOr[Any], /* end */ js.UndefOr[Any], /* callback */ js.UndefOr[Any], /* scope */ js.UndefOr[Any], /* options */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "guaranteeRange", js.Any.fromFunction5((t0: /* start */ js.UndefOr[Any], t1: /* end */ js.UndefOr[Any], t2: /* callback */ js.UndefOr[Any], t3: /* scope */ js.UndefOr[Any], t4: /* options */ js.UndefOr[Any]) => (value(t0, t1, t2, t3, t4)).runNow()))
    ...
    inline def setLoadPage(value: (/* page */ js.UndefOr[Double], /* options */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "loadPage", js.Any.fromFunction2((t0: /* page */ js.UndefOr[Double], t1: /* options */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    
    inline def setLoadPageUndefined: Self = StObject.set(x, "loadPage", js.undefined)
    
    inline def setLoadRawData(value: (/* data */ js.UndefOr[Array], /* append */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "loadRawData", js.Any.fromFunction2((t0: /* data */ js.UndefOr[Array], t1: /* append */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
    
    inline def setLoadRawDataUndefined: Self = StObject.set(x, "loadRawData", js.undefined)
    
    inline def setLoadRecords(value: (/* records */ js.UndefOr[Array], /* options */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "loadRecords", js.Any.fromFunction2((t0: /* records */ js.UndefOr[Array], t1: /* options */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setPrefetchRange(value: (/* start */ js.UndefOr[Any], /* end */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "prefetchRange", js.Any.fromFunction2((t0: /* start */ js.UndefOr[Any], t1: /* end */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setRemoveAt(value: (/* index */ js.UndefOr[Double], /* count */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "removeAt", js.Any.fromFunction2((t0: /* index */ js.UndefOr[Double], t1: /* count */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
    
    inline def setRemoveAtUndefined: Self = StObject.set(x, "removeAt", js.undefined)
    
    inline def setRemoveFilter(value: (/* toRemove */ js.UndefOr[Any], /* applyFilters */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "removeFilter", js.Any.fromFunction2((t0: /* toRemove */ js.UndefOr[Any], t1: /* applyFilters */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
    ...
    inline def setSort(value: CallbackTo[Array]): Self = StObject.set(x, "sort", value.toJsFn)
