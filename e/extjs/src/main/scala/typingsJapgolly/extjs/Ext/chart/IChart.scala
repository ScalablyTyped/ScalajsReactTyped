...
object IChart {
  ...
  extension [Self <: IChart](x: Self) {
    ...
    inline def setRedraw(value: /* resize */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "redraw", js.Any.fromFunction1((t0: /* resize */ js.UndefOr[Boolean]) => value(t0).runNow()))
    ...
    inline def setSetZoom(value: js.UndefOr[Any] => Callback): Self = StObject.set(x, "setZoom", js.Any.fromFunction1((t0: js.UndefOr[Any]) => value(t0).runNow()))
