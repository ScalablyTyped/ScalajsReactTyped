...
object IClickRepeater {
  ...
  def apply(
    ...
    disable: /* force */ js.UndefOr[js.Any] => Callback = null,
    el: js.Any = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IClickRepeater] = null,
    ...
    if (disable != null) __obj.updateDynamic("disable")(js.Any.fromFunction1((t0: /* force */ js.UndefOr[js.Any]) => disable(t0).runNow()))
