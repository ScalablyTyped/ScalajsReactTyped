...
import typingsJapgolly.extjs.Ext.resizer.IResizeTracker
...
object IResizable {
  ...
  def apply(
    ...
    getTarget: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IResizable] = null,
    ...
    requires: Array = null,
    resizeTo: (/* width */ js.UndefOr[Double], /* height */ js.UndefOr[Double]) => Callback = null,
    ...
    if (resizeTo != null) __obj.updateDynamic("resizeTo")(js.Any.fromFunction2((t0: /* width */ js.UndefOr[scala.Double], t1: /* height */ js.UndefOr[scala.Double]) => resizeTo(t0, t1).runNow()))
