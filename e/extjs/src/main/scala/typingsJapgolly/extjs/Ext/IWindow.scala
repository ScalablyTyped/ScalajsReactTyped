...
object IWindow {
  ...
  extension [Self <: IWindow](x: Self) {
    ...
    inline def setGetDefaultFocus(value: Callback): Self = StObject.set(x, "getDefaultFocus", value.toJsFn)
    ...
    inline def setMinimize(value: CallbackTo[IWindow]): Self = StObject.set(x, "minimize", value.toJsFn)
    ...
    inline def setToggleMaximize(value: CallbackTo[IWindow]): Self = StObject.set(x, "toggleMaximize", value.toJsFn)
