...
object panel {
  ...
  - typingsJapgolly.extjs.Ext.container.IDockingContainer because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined defaultDockWeights, addDocked, getDockedComponent, getDockedItems, insertDocked, onDockedAdd, onDockedRemove, removeDocked */ trait IAbstractPanel
    ...
    var addBodyCls: js.UndefOr[
        js.Function1[/* cls */ js.UndefOr[java.lang.String], typingsJapgolly.extjs.Ext.panel.IPanel]
      ] = js.undefined
    ...
    var body: js.UndefOr[typingsJapgolly.extjs.Ext.dom.IElement] = js.undefined
    ...
    var setBodyStyle: js.UndefOr[
        js.Function2[
          ...
          typingsJapgolly.extjs.Ext.panel.IPanel
        ]
      ] = js.undefined
  ...
  object IAbstractPanel {
    ...
    extension [Self <: IAbstractPanel](x: Self) {
      ...
      inline def setAddBodyCls(value: /* cls */ js.UndefOr[java.lang.String] => typingsJapgolly.extjs.Ext.panel.IPanel): Self = StObject.set(x, "addBodyCls", js.Any.fromFunction1(value))
      ...
      inline def setAddUIClsToElement(value: /* cls */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "addUIClsToElement", js.Any.fromFunction1((t0: /* cls */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setAddUIClsToElementUndefined: Self = StObject.set(x, "addUIClsToElement", js.undefined)
      
      inline def setBody(value: typingsJapgolly.extjs.Ext.dom.IElement): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
      ...
      inline def setInsertDocked(value: (js.UndefOr[Double], js.UndefOr[Any]) => Callback): Self = StObject.set(x, "insertDocked", js.Any.fromFunction2((t0: js.UndefOr[Double], t1: js.UndefOr[Any]) => (value(t0, t1)).runNow()))
      ...
      inline def setOnDockedAdd(value: js.UndefOr[IComponent] => Callback): Self = StObject.set(x, "onDockedAdd", js.Any.fromFunction1((t0: js.UndefOr[IComponent]) => value(t0).runNow()))
      
      inline def setOnDockedAddUndefined: Self = StObject.set(x, "onDockedAdd", js.undefined)
      
      inline def setOnDockedRemove(value: js.UndefOr[IComponent] => Callback): Self = StObject.set(x, "onDockedRemove", js.Any.fromFunction1((t0: js.UndefOr[IComponent]) => value(t0).runNow()))
      
      inline def setOnDockedRemoveUndefined: Self = StObject.set(x, "onDockedRemove", js.undefined)
      
      inline def setRemoveBodyCls(value: /* cls */ js.UndefOr[java.lang.String] => typingsJapgolly.extjs.Ext.panel.IPanel): Self = StObject.set(x, "removeBodyCls", js.Any.fromFunction1(value))
      
      inline def setRemoveBodyClsUndefined: Self = StObject.set(x, "removeBodyCls", js.undefined)
      
      inline def setRemoveDocked(value: (js.UndefOr[IComponent], js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "removeDocked", js.Any.fromFunction2((t0: js.UndefOr[IComponent], t1: js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
      
      inline def setRemoveDockedUndefined: Self = StObject.set(x, "removeDocked", js.undefined)
      
      inline def setRemoveUIClsFromElement(value: /* cls */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "removeUIClsFromElement", js.Any.fromFunction1((t0: /* cls */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setSetBodyStyle(
        value: (/* style */ js.UndefOr[Any], /* value */ js.UndefOr[java.lang.String]) => typingsJapgolly.extjs.Ext.panel.IPanel
  ...
  object IHeader {
    ...
    extension [Self <: IHeader](x: Self) {
      ...
      inline def setAddTool(value: /* tool */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "addTool", js.Any.fromFunction1((t0: /* tool */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setAfterLayout(value: Callback): Self = StObject.set(x, "afterLayout", value.toJsFn)
      
      inline def setAfterLayoutUndefined: Self = StObject.set(x, "afterLayout", js.undefined)
      
      inline def setGetTools(value: CallbackTo[Array]): Self = StObject.set(x, "getTools", value.toJsFn)
      ...
      inline def setOnAdd(value: (/* component */ js.UndefOr[Any], /* index */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "onAdd", js.Any.fromFunction2((t0: /* component */ js.UndefOr[Any], t1: /* index */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
      ...
      inline def setSetGlyph(value: /* glyph */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setGlyph", js.Any.fromFunction1((t0: /* glyph */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setSetGlyphUndefined: Self = StObject.set(x, "setGlyph", js.undefined)
      
      inline def setSetIcon(value: /* icon */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setIcon", js.Any.fromFunction1((t0: /* icon */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetIconCls(value: /* cls */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setIconCls", js.Any.fromFunction1((t0: /* cls */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
  ...
  object IPanel {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.panel.IPanel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.panel.IPanel]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.panel.IPanel](x: Self) {
      
      inline def setAddTool(value: /* tools */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "addTool", js.Any.fromFunction1((t0: /* tools */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setAddToolUndefined: Self = StObject.set(x, "addTool", js.undefined)
      
      inline def setAfterCollapse(value: /* animated */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "afterCollapse", js.Any.fromFunction1((t0: /* animated */ js.UndefOr[Boolean]) => value(t0).runNow()))
      
      inline def setAfterCollapseUndefined: Self = StObject.set(x, "afterCollapse", js.undefined)
      
      inline def setAfterExpand(value: /* animated */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "afterExpand", js.Any.fromFunction1((t0: /* animated */ js.UndefOr[Boolean]) => value(t0).runNow()))
      ...
      inline def setCollapse(
        value: (/* direction */ js.UndefOr[java.lang.String], /* animate */ js.UndefOr[Boolean]) => typingsJapgolly.extjs.Ext.panel.IPanel
      ...
      inline def setConvertCollapseDir(value: /* collapseDir */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "convertCollapseDir", js.Any.fromFunction1((t0: /* collapseDir */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setExpand(value: /* animate */ js.UndefOr[Boolean] => typingsJapgolly.extjs.Ext.panel.IPanel): Self = StObject.set(x, "expand", js.Any.fromFunction1(value))
      ...
      inline def setGetCollapsed(value: CallbackTo[Any]): Self = StObject.set(x, "getCollapsed", value.toJsFn)
      
      inline def setGetCollapsedUndefined: Self = StObject.set(x, "getCollapsed", js.undefined)
      
      inline def setGetHeader(value: Callback): Self = StObject.set(x, "getHeader", value.toJsFn)
      ...
      inline def setOnRemoved(value: /* destroying */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "onRemoved", js.Any.fromFunction1((t0: /* destroying */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setSetBorder(value: (/* border */ js.UndefOr[Any], /* targetEl */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "setBorder", js.Any.fromFunction2((t0: /* border */ js.UndefOr[Any], t1: /* targetEl */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
      
      inline def setSetBorderUndefined: Self = StObject.set(x, "setBorder", js.undefined)
      
      inline def setSetGlyph(value: /* newGlyph */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setGlyph", js.Any.fromFunction1((t0: /* newGlyph */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setSetGlyphUndefined: Self = StObject.set(x, "setGlyph", js.undefined)
      
      inline def setSetIcon(value: /* newIcon */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setIcon", js.Any.fromFunction1((t0: /* newIcon */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetIconCls(value: /* newIconCls */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setIconCls", js.Any.fromFunction1((t0: /* newIconCls */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetIconClsUndefined: Self = StObject.set(x, "setIconCls", js.undefined)
      
      inline def setSetIconUndefined: Self = StObject.set(x, "setIcon", js.undefined)
      
      inline def setSetTitle(value: /* newTitle */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setTitle", js.Any.fromFunction1((t0: /* newTitle */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      ...
      inline def setToggleCollapse(value: CallbackTo[typingsJapgolly.extjs.Ext.panel.IPanel]): Self = StObject.set(x, "toggleCollapse", value.toJsFn)
  ...
  trait IProxy
    ...
    /** [Method] Gets the proxy s ghost Panel
      ...
      */
    var getGhost: js.UndefOr[js.Function0[typingsJapgolly.extjs.Ext.panel.IPanel]] = js.undefined
    ...
    var panel: js.UndefOr[typingsJapgolly.extjs.Ext.panel.IPanel] = js.undefined
  ...
  object IProxy {
    ...
    extension [Self <: IProxy](x: Self) {
      ...
      inline def setGetGhost(value: CallbackTo[typingsJapgolly.extjs.Ext.panel.IPanel]): Self = StObject.set(x, "getGhost", value.toJsFn)
      ...
      inline def setPanel(value: typingsJapgolly.extjs.Ext.panel.IPanel): Self = StObject.set(x, "panel", value.asInstanceOf[js.Any])
  ...
  object ITable {
    ...
    extension [Self <: ITable](x: Self) {
      ...
      inline def setAfterCollapse(value: Callback): Self = StObject.set(x, "afterCollapse", value.toJsFn)
      
      inline def setAfterCollapseUndefined: Self = StObject.set(x, "afterCollapse", js.undefined)
      
      inline def setAfterExpand(value: Callback): Self = StObject.set(x, "afterExpand", value.toJsFn)
      ...
      inline def setApplyState(value: /* state */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "applyState", js.Any.fromFunction1((t0: /* state */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setDetermineScrollbars(value: Callback): Self = StObject.set(x, "determineScrollbars", value.toJsFn)
      ...
      inline def setGetSelectionModel(value: CallbackTo[IModel]): Self = StObject.set(x, "getSelectionModel", value.toJsFn)
      
      inline def setGetSelectionModelUndefined: Self = StObject.set(x, "getSelectionModel", js.undefined)
      
      inline def setGetStore(value: CallbackTo[IStore]): Self = StObject.set(x, "getStore", value.toJsFn)
      
      inline def setGetStoreUndefined: Self = StObject.set(x, "getStore", js.undefined)
      
      inline def setGetView(value: CallbackTo[ITable]): Self = StObject.set(x, "getView", value.toJsFn)
      ...
      inline def setInvalidateScroller(value: Callback): Self = StObject.set(x, "invalidateScroller", value.toJsFn)
      ...
      inline def setView(value: typingsJapgolly.extjs.Ext.view.ITable): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
