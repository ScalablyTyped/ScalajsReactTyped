...
object field {
  ...
  object IField {
    ...
    extension [Self <: IField](x: Self) {
      ...
      inline def setGetErrorStrategy(value: Callback): Self = StObject.set(x, "getErrorStrategy", value.toJsFn)
      
      inline def setGetErrorStrategyUndefined: Self = StObject.set(x, "getErrorStrategy", js.undefined)
      
      inline def setGetLabelStrategy(value: Callback): Self = StObject.set(x, "getLabelStrategy", value.toJsFn)
