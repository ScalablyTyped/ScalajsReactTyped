...
object container {
  ...
  - typingsJapgolly.extjs.Ext.IQueryable because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined child, down, query, queryBy, queryById */ trait IAbstractContainer
    extends StObject
       with IComponent {
    ...
    /** [Method] Manually force this container s layout to be recalculated
      ...
      */
    var doLayout: js.UndefOr[js.Function0[typingsJapgolly.extjs.Ext.container.IContainer]] = js.undefined
  ...
  object IAbstractContainer {
    ...
    extension [Self <: IAbstractContainer](x: Self) {
      ...
      inline def setAfterLayout(value: /* layout */ js.UndefOr[typingsJapgolly.extjs.Ext.layout.container.IContainer] => Callback): Self = StObject.set(x, "afterLayout", js.Any.fromFunction1((t0: /* layout */ js.UndefOr[typingsJapgolly.extjs.Ext.layout.container.IContainer]) => value(t0).runNow()))
      ...
      inline def setCascade(
        value: (/* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any], /* args */ js.UndefOr[Array]) => typingsJapgolly.extjs.Ext.IContainer
      ...
      inline def setDisable(value: CallbackTo[IAbstractContainer]): Self = StObject.set(x, "disable", value.toJsFn)
      
      inline def setDisableUndefined: Self = StObject.set(x, "disable", js.undefined)
      
      inline def setDoLayout(value: CallbackTo[typingsJapgolly.extjs.Ext.container.IContainer]): Self = StObject.set(x, "doLayout", value.toJsFn)
      ...
      inline def setGetLayout(value: CallbackTo[typingsJapgolly.extjs.Ext.layout.container.IContainer]): Self = StObject.set(x, "getLayout", value.toJsFn)
      
      inline def setGetLayoutUndefined: Self = StObject.set(x, "getLayout", js.undefined)
      
      inline def setGetRefItems(value: /* deep */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "getRefItems", js.Any.fromFunction1((t0: /* deep */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setIsAncestor(value: /* possibleDescendant */ js.UndefOr[IComponent] => Callback): Self = StObject.set(x, "isAncestor", js.Any.fromFunction1((t0: /* possibleDescendant */ js.UndefOr[IComponent]) => value(t0).runNow()))
      ...
      inline def setOnAdd(value: (/* component */ js.UndefOr[IComponent], /* position */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "onAdd", js.Any.fromFunction2((t0: /* component */ js.UndefOr[IComponent], t1: /* position */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
      
      inline def setOnAddUndefined: Self = StObject.set(x, "onAdd", js.undefined)
      
      inline def setOnBeforeAdd(value: /* item */ js.UndefOr[IComponent] => Callback): Self = StObject.set(x, "onBeforeAdd", js.Any.fromFunction1((t0: /* item */ js.UndefOr[IComponent]) => value(t0).runNow()))
      ...
      inline def setOnRemove(value: (/* component */ js.UndefOr[IComponent], /* autoDestroy */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction2((t0: /* component */ js.UndefOr[IComponent], t1: /* autoDestroy */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
  ...
  object IButtonGroup {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.container.IButtonGroup = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.container.IButtonGroup]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.container.IButtonGroup](x: Self) {
  ...
  object IContainer {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.container.IContainer = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.container.IContainer]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.container.IContainer](x: Self) {
  ...
  object IDockingContainer {
    ...
    extension [Self <: IDockingContainer](x: Self) {
      ...
      inline def setInsertDocked(value: (/* pos */ js.UndefOr[Double], /* component */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "insertDocked", js.Any.fromFunction2((t0: /* pos */ js.UndefOr[Double], t1: /* component */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
      
      inline def setInsertDockedUndefined: Self = StObject.set(x, "insertDocked", js.undefined)
      
      inline def setOnDockedAdd(value: /* component */ js.UndefOr[IComponent] => Callback): Self = StObject.set(x, "onDockedAdd", js.Any.fromFunction1((t0: /* component */ js.UndefOr[IComponent]) => value(t0).runNow()))
      
      inline def setOnDockedAddUndefined: Self = StObject.set(x, "onDockedAdd", js.undefined)
      
      inline def setOnDockedRemove(value: /* component */ js.UndefOr[IComponent] => Callback): Self = StObject.set(x, "onDockedRemove", js.Any.fromFunction1((t0: /* component */ js.UndefOr[IComponent]) => value(t0).runNow()))
      
      inline def setOnDockedRemoveUndefined: Self = StObject.set(x, "onDockedRemove", js.undefined)
      
      inline def setRemoveDocked(value: (/* item */ js.UndefOr[IComponent], /* autoDestroy */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "removeDocked", js.Any.fromFunction2((t0: /* item */ js.UndefOr[IComponent], t1: /* autoDestroy */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
  ...
  object IViewport {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.container.IViewport = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.container.IViewport]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.container.IViewport](x: Self) {
