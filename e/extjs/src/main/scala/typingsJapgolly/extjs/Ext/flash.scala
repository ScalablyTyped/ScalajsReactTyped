...
object flash {
  ...
  object IComponent {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.flash.IComponent = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.flash.IComponent]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.flash.IComponent](x: Self) {
