...
- typingsJapgolly.extjs.Ext.util.IAbstractMixedCollection because var conflicts: add, allowFunctions, clone, insert, remove. Inlined isMixedCollection, addAll, addEvents, addListener, addManagedListener, clear, clearListeners, clearManagedListeners, collect, contains, containsKey, each, eachKey, enableBubble, filter, filterBy, find, findBy, findIndex, findIndexBy, fireEvent, fireEventArgs, first, get, getAt, getByKey, getCount, getKey, getRange, hasListener, indexOf, indexOfKey, last, mon, mun, on, relayEvents, removeAll, removeAt, removeAtKey, removeListener, removeManagedListener, removeRange, replace, resumeEvent, resumeEvents, sum, suspendEvent, suspendEvents, un, updateKey
- typingsJapgolly.extjs.Ext.util.IAnimate because var conflicts: animate, getActiveAnimation, hasActiveFx, sequenceFx, stopAnimation, stopFx, syncFx. Inlined 
- typingsJapgolly.extjs.Ext.util.IMixedCollection because var conflicts: add, clone, insert, remove. Inlined allowFunctions, findInsertionIndex, generateComparator, getFirstSorter, initSortable, reorder, sort, sortBy, sortByKey
- typingsJapgolly.extjs.Ext.draw.ICompositeSprite because var conflicts: clone. Inlined add, addCls, animate, destroy, getActiveAnimation, getBBox, hasActiveFx, hide, insert, redraw, remove, removeCls, sequenceFx, setAttributes, setStyle, show, stopAnimation, stopFx, syncFx */ trait ILegendItem
  extends StObject
     with IBase {
...
object ILegendItem {
  ...
  extension [Self <: ILegendItem](x: Self) {
    ...
    inline def setAddCls(value: /* cls */ js.UndefOr[String] => Callback): Self = StObject.set(x, "addCls", js.Any.fromFunction1((t0: /* cls */ js.UndefOr[String]) => value(t0).runNow()))
    ...
    inline def setCreateLegend(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "createLegend", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setRemoveCls(value: /* cls */ js.UndefOr[String] => Callback): Self = StObject.set(x, "removeCls", js.Any.fromFunction1((t0: /* cls */ js.UndefOr[String]) => value(t0).runNow()))
    ...
    inline def setSetStyle(value: /* style */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setStyle", js.Any.fromFunction1((t0: /* style */ js.UndefOr[String]) => value(t0).runNow()))
    ...
    inline def setUpdatePosition(value: /* relativeTo */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "updatePosition", js.Any.fromFunction1((t0: /* relativeTo */ js.UndefOr[Any]) => value(t0).runNow()))
