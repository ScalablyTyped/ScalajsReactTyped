...
import typingsJapgolly.extjs.Ext.draw.ICompositeSprite
...
object ILegendItem {
  ...
  def apply(
    ...
    createLegend: /* config */ js.UndefOr[js.Any] => Callback = null,
    ...
    hide: /* redraw */ js.UndefOr[Boolean] => CallbackTo[ILegendItem] = null,
    indexOf: /* o */ js.UndefOr[js.Any] => CallbackTo[Double] = null,
    indexOfKey: /* key */ js.UndefOr[String] => CallbackTo[Double] = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[ILegendItem] = null,
    ...
    setAttributes: (/* attrs */ js.UndefOr[js.Any], /* redraw */ js.UndefOr[Boolean]) => CallbackTo[ILegendItem] = null,
    setStyle: /* style */ js.UndefOr[String] => Callback = null,
    show: /* redraw */ js.UndefOr[Boolean] => CallbackTo[ILegendItem] = null,
    ...
    updatePosition: /* relativeTo */ js.UndefOr[js.Any] => Callback = null,
    uses: Array = null
  ): ILegendItem = {
    ...
    if (createLegend != null) __obj.updateDynamic("createLegend")(js.Any.fromFunction1((t0: /* config */ js.UndefOr[js.Any]) => createLegend(t0).runNow()))
    ...
    if (updatePosition != null) __obj.updateDynamic("updatePosition")(js.Any.fromFunction1((t0: /* relativeTo */ js.UndefOr[js.Any]) => updatePosition(t0).runNow()))
