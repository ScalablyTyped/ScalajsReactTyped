...
object ISpinner {
  ...
  extension [Self <: ISpinner](x: Self) {
    ...
    inline def setOnSpinDown(value: Callback): Self = StObject.set(x, "onSpinDown", value.toJsFn)
    
    inline def setOnSpinDownUndefined: Self = StObject.set(x, "onSpinDown", js.undefined)
    
    inline def setOnSpinUp(value: Callback): Self = StObject.set(x, "onSpinUp", value.toJsFn)
    
    inline def setOnSpinUpUndefined: Self = StObject.set(x, "onSpinUp", js.undefined)
    
    inline def setSetSpinDownEnabled(value: /* enabled */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setSpinDownEnabled", js.Any.fromFunction1((t0: /* enabled */ js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetSpinDownEnabledUndefined: Self = StObject.set(x, "setSpinDownEnabled", js.undefined)
    
    inline def setSetSpinUpEnabled(value: /* enabled */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setSpinUpEnabled", js.Any.fromFunction1((t0: /* enabled */ js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetSpinUpEnabledUndefined: Self = StObject.set(x, "setSpinUpEnabled", js.undefined)
    
    inline def setSpinDown(value: Callback): Self = StObject.set(x, "spinDown", value.toJsFn)
    ...
    inline def setSpinUp(value: Callback): Self = StObject.set(x, "spinUp", value.toJsFn)
