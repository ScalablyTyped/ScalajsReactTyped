...
object column {
  ...
  object IAction {
    ...
    extension [Self <: IAction](x: Self) {
      ...
      inline def setDefaultRenderer(
        value: (/* v */ js.UndefOr[Any], /* meta */ js.UndefOr[Any], /* record */ js.UndefOr[Any], /* rowIdx */ js.UndefOr[Any], /* colIdx */ js.UndefOr[Any], /* store */ js.UndefOr[Any], /* view */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "defaultRenderer", js.Any.fromFunction7((t0: /* v */ js.UndefOr[Any], t1: /* meta */ js.UndefOr[Any], t2: /* record */ js.UndefOr[Any], t3: /* rowIdx */ js.UndefOr[Any], t4: /* colIdx */ js.UndefOr[Any], t5: /* store */ js.UndefOr[Any], t6: /* view */ js.UndefOr[Any]) => (value(t0, t1, t2, t3, t4, t5, t6)).runNow()))
      
      inline def setDefaultRendererUndefined: Self = StObject.set(x, "defaultRenderer", js.undefined)
      
      inline def setDisableAction(value: (/* index */ js.UndefOr[Any], /* silent */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "disableAction", js.Any.fromFunction2((t0: /* index */ js.UndefOr[Any], t1: /* silent */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
      
      inline def setDisableActionUndefined: Self = StObject.set(x, "disableAction", js.undefined)
      
      inline def setEnableAction(value: (/* index */ js.UndefOr[Any], /* silent */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "enableAction", js.Any.fromFunction2((t0: /* index */ js.UndefOr[Any], t1: /* silent */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
  ...
  object ICheckColumn {
    ...
    extension [Self <: ICheckColumn](x: Self) {
      ...
      inline def setOnDisable(value: /* silent */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "onDisable", js.Any.fromFunction1((t0: /* silent */ js.UndefOr[Boolean]) => value(t0).runNow()))
      
      inline def setOnDisableUndefined: Self = StObject.set(x, "onDisable", js.undefined)
      
      inline def setOnEnable(value: /* silent */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "onEnable", js.Any.fromFunction1((t0: /* silent */ js.UndefOr[Boolean]) => value(t0).runNow()))
  ...
  trait IColumn
    extends StObject
       with typingsJapgolly.extjs.Ext.grid.header.IContainer {
  ...
  object IColumn {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.grid.column.IColumn = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.grid.column.IColumn]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.grid.column.IColumn](x: Self) {
      ...
      ): Self = StObject.set(x, "afterComponentLayout", js.Any.fromFunction4((t0: /* width */ js.UndefOr[Any], t1: /* height */ js.UndefOr[Any], t2: /* oldWidth */ js.UndefOr[Any], t3: /* oldHeight */ js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
      ...
      inline def setAutoSize(value: /* The */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "autoSize", js.Any.fromFunction1((t0: /* The */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setDefaultRenderer(value: Callback): Self = StObject.set(x, "defaultRenderer", value.toJsFn)
      ...
      inline def setGetVisibleIndex(value: CallbackTo[Double]): Self = StObject.set(x, "getVisibleIndex", value.toJsFn)
      ...
      inline def setIsHideable(value: Callback): Self = StObject.set(x, "isHideable", value.toJsFn)
      
      inline def setIsHideableUndefined: Self = StObject.set(x, "isHideable", js.undefined)
      
      inline def setIsLockable(value: Callback): Self = StObject.set(x, "isLockable", value.toJsFn)
      ...
      inline def setSetEditor(value: /* field */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setEditor", js.Any.fromFunction1((t0: /* field */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setSetEditorUndefined: Self = StObject.set(x, "setEditor", js.undefined)
      
      inline def setSetText(value: /* text */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setText", js.Any.fromFunction1((t0: /* text */ js.UndefOr[String]) => value(t0).runNow()))
  ...
  object IRowNumberer {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.grid.column.IRowNumberer = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.grid.column.IRowNumberer]
    }
  }
