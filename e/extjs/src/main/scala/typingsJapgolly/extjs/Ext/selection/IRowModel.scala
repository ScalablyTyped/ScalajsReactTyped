...
object IRowModel {
  ...
  def apply(
    ...
    getLastSelected: js.UndefOr[CallbackTo[IRowModel]] = js.undefined,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IRowModel] = null,
    isFocused: /* record */ js.UndefOr[IRowModel] => Callback = null,
    ...
    selectNext: (/* keepExisting */ js.UndefOr[Boolean], /* suppressEvent */ js.UndefOr[Boolean]) => CallbackTo[Boolean] = null,
    selectPrevious: (/* keepExisting */ js.UndefOr[Boolean], /* suppressEvent */ js.UndefOr[Boolean]) => CallbackTo[Boolean] = null,
    ...
    self: IClass = null,
    setLastFocused: /* record */ js.UndefOr[IRowModel] => Callback = null,
    ...
    if (isFocused != null) __obj.updateDynamic("isFocused")(js.Any.fromFunction1((t0: /* record */ js.UndefOr[typingsJapgolly.extjs.Ext.selection.IRowModel]) => isFocused(t0).runNow()))
    ...
    if (selectNext != null) __obj.updateDynamic("selectNext")(js.Any.fromFunction2((t0: /* keepExisting */ js.UndefOr[scala.Boolean], t1: /* suppressEvent */ js.UndefOr[scala.Boolean]) => selectNext(t0, t1).runNow()))
    if (selectPrevious != null) __obj.updateDynamic("selectPrevious")(js.Any.fromFunction2((t0: /* keepExisting */ js.UndefOr[scala.Boolean], t1: /* suppressEvent */ js.UndefOr[scala.Boolean]) => selectPrevious(t0, t1).runNow()))
    ...
    if (setLastFocused != null) __obj.updateDynamic("setLastFocused")(js.Any.fromFunction1((t0: /* record */ js.UndefOr[typingsJapgolly.extjs.Ext.selection.IRowModel]) => setLastFocused(t0).runNow()))
