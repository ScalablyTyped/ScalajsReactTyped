...
object IDropTarget {
  ...
  extension [Self <: IDropTarget](x: Self) {
    ...
    inline def setNotifyOut(
      value: (/* source */ js.UndefOr[IDragSource], /* e */ js.UndefOr[Event], /* data */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "notifyOut", js.Any.fromFunction3((t0: /* source */ js.UndefOr[IDragSource], t1: /* e */ js.UndefOr[Event], t2: /* data */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
