...
object ICheckboxModel {
  ...
  def apply(
    ...
    getHeaderConfig: js.UndefOr[Callback] = js.undefined,
    getInitialConfig: /* name */ js.UndefOr[String] => CallbackTo[js.Any] = null,
    getLastSelected: js.UndefOr[CallbackTo[ICheckboxModel]] = js.undefined,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[ICheckboxModel] = null,
    injectCheckbox: js.Any = null,
    isFocused: /* record */ js.UndefOr[ICheckboxModel] => Callback = null,
    ...
    onHeaderClick: (/* headerCt */ js.UndefOr[js.Any], /* header */ js.UndefOr[js.Any], /* e */ js.UndefOr[js.Any]) => Callback = null,
    ...
    renderer: (/* value */ js.UndefOr[js.Any], /* metaData */ js.UndefOr[js.Any], /* record */ js.UndefOr[js.Any], /* rowIndex */ js.UndefOr[js.Any], /* colIndex */ js.UndefOr[js.Any], /* store */ js.UndefOr[js.Any], /* view */ js.UndefOr[js.Any]) => Callback = null,
    requires: Array = null,
    ...
    self: IClass = null,
    setLastFocused: /* record */ js.UndefOr[ICheckboxModel] => Callback = null,
    ...
    getHeaderConfig.foreach(p => __obj.updateDynamic("getHeaderConfig")(p.toJsFn))
    ...
    if (isFocused != null) __obj.updateDynamic("isFocused")(js.Any.fromFunction1((t0: /* record */ js.UndefOr[typingsJapgolly.extjs.Ext.selection.ICheckboxModel]) => isFocused(t0).runNow()))
    ...
    if (onHeaderClick != null) __obj.updateDynamic("onHeaderClick")(js.Any.fromFunction3((t0: /* headerCt */ js.UndefOr[js.Any], t1: /* header */ js.UndefOr[js.Any], t2: /* e */ js.UndefOr[js.Any]) => onHeaderClick(t0, t1, t2).runNow()))
    ...
    if (renderer != null) __obj.updateDynamic("renderer")(js.Any.fromFunction7((t0: /* value */ js.UndefOr[js.Any], t1: /* metaData */ js.UndefOr[js.Any], t2: /* record */ js.UndefOr[js.Any], t3: /* rowIndex */ js.UndefOr[js.Any], t4: /* colIndex */ js.UndefOr[js.Any], t5: /* store */ js.UndefOr[js.Any], t6: /* view */ js.UndefOr[js.Any]) => renderer(t0, t1, t2, t3, t4, t5, t6).runNow()))
    ...
    if (setLastFocused != null) __obj.updateDynamic("setLastFocused")(js.Any.fromFunction1((t0: /* record */ js.UndefOr[typingsJapgolly.extjs.Ext.selection.ICheckboxModel]) => setLastFocused(t0).runNow()))
