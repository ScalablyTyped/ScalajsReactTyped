...
import typingsJapgolly.extjs.Ext.form.ILabelable
...
object IFormPanel {
  ...
  extension [Self <: IFormPanel](x: Self) {
    ...
    inline def setOnFieldErrorChange(value: (js.UndefOr[ILabelable], js.UndefOr[java.lang.String]) => Callback): Self = StObject.set(x, "onFieldErrorChange", js.Any.fromFunction2((t0: js.UndefOr[ILabelable], t1: js.UndefOr[java.lang.String]) => (value(t0, t1)).runNow()))
    
    inline def setOnFieldErrorChangeUndefined: Self = StObject.set(x, "onFieldErrorChange", js.undefined)
    
    inline def setOnFieldValidityChange(value: (js.UndefOr[IField], js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "onFieldValidityChange", js.Any.fromFunction2((t0: js.UndefOr[IField], t1: js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
