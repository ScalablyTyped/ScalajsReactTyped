...
object IFormPanel {
  ...
  def apply(
    ...
    onFieldErrorChange: (js.UndefOr[ILabelable], js.UndefOr[java.lang.String]) => Callback = null,
    onFieldValidityChange: (js.UndefOr[IField], js.UndefOr[Boolean]) => Callback = null,
