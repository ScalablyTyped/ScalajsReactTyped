...
- typingsJapgolly.extjs.Ext.IQueryable because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined child, down, query, queryBy, queryById */ trait IButton extends IComponent {
...
object IButton {
  ...
  def apply(
    ...
    disable: /* silent */ js.UndefOr[js.Any] => Callback = null,
    down: js.UndefOr[js.Any] => CallbackTo[js.Any] = null,
    enable: /* silent */ js.UndefOr[js.Any] => Callback = null,
    enableToggle: js.UndefOr[Boolean] = js.undefined,
    focusCls: java.lang.String = null,
    getTemplateArgs: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getText: js.UndefOr[CallbackTo[java.lang.String]] = js.undefined,
    glyph: js.Any = null,
    handleMouseEvents: js.UndefOr[Boolean] = js.undefined,
    handler: js.Any = null,
    hasVisibleMenu: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    hideMenu: js.UndefOr[CallbackTo[IButton]] = js.undefined,
    ...
    query: js.UndefOr[java.lang.String] => CallbackTo[Array] = null,
    queryBy: (js.UndefOr[js.Any], js.UndefOr[js.Any]) => CallbackTo[Array] = null,
    queryById: js.UndefOr[java.lang.String] => CallbackTo[IComponent] = null,
    repeat: js.Any = null,
    scale: js.Any = null,
    scope: js.Any = null,
    setGlyph: /* glyph */ js.UndefOr[js.Any] => CallbackTo[IButton] = null,
    setHandler: (/* handler */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[IButton] = null,
    setHref: /* href */ js.UndefOr[java.lang.String] => Callback = null,
    setIcon: /* icon */ js.UndefOr[java.lang.String] => CallbackTo[IButton] = null,
    setIconCls: /* cls */ js.UndefOr[java.lang.String] => CallbackTo[IButton] = null,
    setParams: /* params */ js.UndefOr[js.Any] => Callback = null,
    setScale: /* scale */ js.UndefOr[java.lang.String] => Callback = null,
    setText: /* text */ js.UndefOr[java.lang.String] => CallbackTo[IButton] = null,
    setTextAlign: /* align */ js.UndefOr[java.lang.String] => Callback = null,
    setTooltip: /* tooltip */ js.UndefOr[js.Any] => CallbackTo[IButton] = null,
    setUI: /* ui */ js.UndefOr[js.Any] => Callback = null,
    showEmptyMenu: js.UndefOr[Boolean] = js.undefined,
    showMenu: /* fromEvent */ js.UndefOr[js.Any] => Callback = null,
    tabIndex: Int | Double = null,
    template: ITemplate = null,
    text: java.lang.String = null,
    textAlign: java.lang.String = null,
    toggle: (/* state */ js.UndefOr[Boolean], /* suppressEvent */ js.UndefOr[Boolean]) => CallbackTo[IButton] = null,
    ...
    if (disable != null) __obj.updateDynamic("disable")(js.Any.fromFunction1((t0: /* silent */ js.UndefOr[js.Any]) => disable(t0).runNow()))
    if (down != null) __obj.updateDynamic("down")(js.Any.fromFunction1((t0: js.UndefOr[js.Any]) => down(t0).runNow()))
    if (enable != null) __obj.updateDynamic("enable")(js.Any.fromFunction1((t0: /* silent */ js.UndefOr[js.Any]) => enable(t0).runNow()))
    ...
    getTemplateArgs.foreach(p => __obj.updateDynamic("getTemplateArgs")(p.toJsFn))
    ...
    hasVisibleMenu.foreach(p => __obj.updateDynamic("hasVisibleMenu")(p.toJsFn))
    hideMenu.foreach(p => __obj.updateDynamic("hideMenu")(p.toJsFn))
    ...
    if (setHandler != null) __obj.updateDynamic("setHandler")(js.Any.fromFunction2((t0: /* handler */ js.UndefOr[js.Any], t1: /* scope */ js.UndefOr[js.Any]) => setHandler(t0, t1).runNow()))
    if (setHref != null) __obj.updateDynamic("setHref")(js.Any.fromFunction1((t0: /* href */ js.UndefOr[java.lang.String]) => setHref(t0).runNow()))
    ...
    if (setScale != null) __obj.updateDynamic("setScale")(js.Any.fromFunction1((t0: /* scale */ js.UndefOr[java.lang.String]) => setScale(t0).runNow()))
    if (setText != null) __obj.updateDynamic("setText")(js.Any.fromFunction1((t0: /* text */ js.UndefOr[java.lang.String]) => setText(t0).runNow()))
    if (setTextAlign != null) __obj.updateDynamic("setTextAlign")(js.Any.fromFunction1((t0: /* align */ js.UndefOr[java.lang.String]) => setTextAlign(t0).runNow()))
    ...
    if (showMenu != null) __obj.updateDynamic("showMenu")(js.Any.fromFunction1((t0: /* fromEvent */ js.UndefOr[js.Any]) => showMenu(t0).runNow()))
    if (tabIndex != null) __obj.updateDynamic("tabIndex")(tabIndex.asInstanceOf[js.Any])
    if (template != null) __obj.updateDynamic("template")(template.asInstanceOf[js.Any])
    if (text != null) __obj.updateDynamic("text")(text.asInstanceOf[js.Any])
    if (textAlign != null) __obj.updateDynamic("textAlign")(textAlign.asInstanceOf[js.Any])
    if (toggle != null) __obj.updateDynamic("toggle")(js.Any.fromFunction2((t0: /* state */ js.UndefOr[scala.Boolean], t1: /* suppressEvent */ js.UndefOr[scala.Boolean]) => toggle(t0, t1).runNow()))
