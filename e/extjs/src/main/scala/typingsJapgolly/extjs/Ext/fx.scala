...
object fx {
  ...
  object target {
    ...
    object ICompositeElement {
      ...
      inline def apply(): typingsJapgolly.extjs.Ext.fx.target.ICompositeElement = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.extjs.Ext.fx.target.ICompositeElement]
      }
      
      extension [Self <: typingsJapgolly.extjs.Ext.fx.target.ICompositeElement](x: Self) {
    ...
    type ICompositeElementCSS = typingsJapgolly.extjs.Ext.fx.target.ICompositeElement
    
    type ICompositeSprite = ISprite
    
    type IElement = ITarget
    
    type IElementCSS = typingsJapgolly.extjs.Ext.fx.target.IElement
