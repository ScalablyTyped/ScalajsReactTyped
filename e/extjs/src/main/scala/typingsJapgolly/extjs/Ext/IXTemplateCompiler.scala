...
object IXTemplateCompiler {
  ...
  extension [Self <: IXTemplateCompiler](x: Self) {
    ...
    inline def setDoCase(value: /* action */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "doCase", js.Any.fromFunction1((t0: /* action */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setDoCaseUndefined: Self = StObject.set(x, "doCase", js.undefined)
    
    inline def setDoElseIf(value: (/* action */ js.UndefOr[Any], /* actions */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "doElseIf", js.Any.fromFunction2((t0: /* action */ js.UndefOr[Any], t1: /* actions */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    
    inline def setDoElseIfUndefined: Self = StObject.set(x, "doElseIf", js.undefined)
    
    inline def setDoEnd(value: (/* type */ js.UndefOr[Any], /* actions */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "doEnd", js.Any.fromFunction2((t0: /* type */ js.UndefOr[Any], t1: /* actions */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    
    inline def setDoEndUndefined: Self = StObject.set(x, "doEnd", js.undefined)
    
    inline def setDoEval(value: /* text */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "doEval", js.Any.fromFunction1((t0: /* text */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setDoEvalUndefined: Self = StObject.set(x, "doEval", js.undefined)
    
    inline def setDoExec(value: (/* action */ js.UndefOr[Any], /* actions */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "doExec", js.Any.fromFunction2((t0: /* action */ js.UndefOr[Any], t1: /* actions */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    
    inline def setDoExecUndefined: Self = StObject.set(x, "doExec", js.undefined)
    
    inline def setDoExpr(value: /* expr */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "doExpr", js.Any.fromFunction1((t0: /* expr */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setDoExprUndefined: Self = StObject.set(x, "doExpr", js.undefined)
    
    inline def setDoFor(value: (/* action */ js.UndefOr[Any], /* actions */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "doFor", js.Any.fromFunction2((t0: /* action */ js.UndefOr[Any], t1: /* actions */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    
    inline def setDoForEach(value: (/* action */ js.UndefOr[Any], /* actions */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "doForEach", js.Any.fromFunction2((t0: /* action */ js.UndefOr[Any], t1: /* actions */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setDoIf(value: (/* action */ js.UndefOr[Any], /* actions */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "doIf", js.Any.fromFunction2((t0: /* action */ js.UndefOr[Any], t1: /* actions */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    
    inline def setDoIfUndefined: Self = StObject.set(x, "doIf", js.undefined)
    
    inline def setDoSwitch(value: /* action */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "doSwitch", js.Any.fromFunction1((t0: /* action */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setDoSwitchUndefined: Self = StObject.set(x, "doSwitch", js.undefined)
    
    inline def setDoTag(value: /* tag */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "doTag", js.Any.fromFunction1((t0: /* tag */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setDoTagUndefined: Self = StObject.set(x, "doTag", js.undefined)
    
    inline def setDoText(value: /* text */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "doText", js.Any.fromFunction1((t0: /* text */ js.UndefOr[Any]) => value(t0).runNow()))
