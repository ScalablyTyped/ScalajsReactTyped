...
object IXTemplateCompiler {
  ...
  def apply(
    ...
    doForEach: (/* action */ js.UndefOr[js.Any], /* actions */ js.UndefOr[js.Any]) => Callback = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IXTemplateCompiler] = null,
    ...
    if (doForEach != null) __obj.updateDynamic("doForEach")(js.Any.fromFunction2((t0: /* action */ js.UndefOr[js.Any], t1: /* actions */ js.UndefOr[js.Any]) => doForEach(t0, t1).runNow()))
