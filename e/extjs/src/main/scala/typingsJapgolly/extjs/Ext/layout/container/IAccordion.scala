...
object IAccordion {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IAccordion] = null,
    ...
    if (!js.isUndefined(activeOnTop)) __obj.updateDynamic("activeOnTop")(activeOnTop.asInstanceOf[js.Any])
