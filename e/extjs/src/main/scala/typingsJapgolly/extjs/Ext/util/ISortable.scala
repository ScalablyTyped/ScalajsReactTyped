...
object ISortable {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[ISortable] = null,
    ...
    sort: (/* sorters */ js.UndefOr[js.Any], /* direction */ js.UndefOr[String]) => CallbackTo[Array] = null,
    ...
    if (sort != null) __obj.updateDynamic("sort")(js.Any.fromFunction2((t0: /* sorters */ js.UndefOr[js.Any], t1: /* direction */ js.UndefOr[java.lang.String]) => sort(t0, t1).runNow()))
