...
object writer {
  ...
  trait IJson
    extends StObject
       with typingsJapgolly.extjs.Ext.data.writer.IWriter {
  ...
  object IJson {
    ...
    extension [Self <: IJson](x: Self) {
      ...
      inline def setGetExpandedData(value: /* data */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "getExpandedData", js.Any.fromFunction1((t0: /* data */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  object IWriter {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.data.writer.IWriter = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.data.writer.IWriter]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.data.writer.IWriter](x: Self) {
