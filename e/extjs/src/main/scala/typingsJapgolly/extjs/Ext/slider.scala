...
object slider {
  ...
  trait IMulti
    extends StObject
       with typingsJapgolly.extjs.Ext.form.field.IBase {
  ...
  object IMulti {
    ...
    extension [Self <: IMulti](x: Self) {
      ...
      inline def setSetMaxValue(value: /* val */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setMaxValue", js.Any.fromFunction1((t0: /* val */ js.UndefOr[Double]) => value(t0).runNow()))
      
      inline def setSetMaxValueUndefined: Self = StObject.set(x, "setMaxValue", js.undefined)
      
      inline def setSetMinValue(value: /* val */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setMinValue", js.Any.fromFunction1((t0: /* val */ js.UndefOr[Double]) => value(t0).runNow()))
      ...
      inline def setSyncThumbs(value: Callback): Self = StObject.set(x, "syncThumbs", value.toJsFn)
  ...
  object ISlider {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.slider.ISlider = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.slider.ISlider]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.slider.ISlider](x: Self) {
  ...
  object ITip {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.slider.ITip = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.slider.ITip]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.slider.ITip](x: Self) {
