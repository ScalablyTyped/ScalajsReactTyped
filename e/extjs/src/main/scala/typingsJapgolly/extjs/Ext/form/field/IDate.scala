...
object IDate {
  ...
  extension [Self <: IDate](x: Self) {
    ...
    inline def setSetDisabledDates(value: /* disabledDates */ js.UndefOr[Array] => Callback): Self = StObject.set(x, "setDisabledDates", js.Any.fromFunction1((t0: /* disabledDates */ js.UndefOr[Array]) => value(t0).runNow()))
    
    inline def setSetDisabledDatesUndefined: Self = StObject.set(x, "setDisabledDates", js.undefined)
    
    inline def setSetDisabledDays(value: /* disabledDays */ js.UndefOr[Array] => Callback): Self = StObject.set(x, "setDisabledDays", js.Any.fromFunction1((t0: /* disabledDays */ js.UndefOr[Array]) => value(t0).runNow()))
