...
object IBar {
  ...
  def apply(
    ...
    afterComponentLayout: /* width */ js.UndefOr[js.Any] => Callback = null,
    isTabBar: js.UndefOr[Boolean] = js.undefined,
    maxTabWidth: Int | Double = null,
    minTabWidth: Int | Double = null,
    onRemove: /* tab */ js.UndefOr[js.Any] => Callback = null,
    onRender: js.UndefOr[Callback] = js.undefined,
    plain: js.UndefOr[Boolean] = js.undefined
  ): IBar = {
    val __obj = js.Dynamic.literal()
    if (IHeader != null) js.Dynamic.global.Object.assign(__obj, IHeader)
    if (afterComponentLayout != null) __obj.updateDynamic("afterComponentLayout")(js.Any.fromFunction1((t0: /* width */ js.UndefOr[js.Any]) => afterComponentLayout(t0).runNow()))
    ...
    if (onRemove != null) __obj.updateDynamic("onRemove")(js.Any.fromFunction1((t0: /* tab */ js.UndefOr[js.Any]) => onRemove(t0).runNow()))
