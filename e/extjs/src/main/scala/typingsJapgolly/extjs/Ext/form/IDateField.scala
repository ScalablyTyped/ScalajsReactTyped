...
trait IDateField
  extends StObject
     with typingsJapgolly.extjs.Ext.form.field.IPicker {
  ...
  var setValue_IDateField: js.UndefOr[
    js.Function1[/* date */ js.UndefOr[Any], typingsJapgolly.extjs.Ext.form.field.IDate]
  ] = js.undefined
...
object IDateField {
  ...
  extension [Self <: IDateField](x: Self) {
    ...
    inline def setSetValue(value: /* date */ js.UndefOr[Any] => typingsJapgolly.extjs.Ext.form.field.IDate): Self = StObject.set(x, "setValue", js.Any.fromFunction1(value))
