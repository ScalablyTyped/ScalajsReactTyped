...
trait IDateField
  ...
  var setValue_IDateField: js.UndefOr[
    js.Function1[/* date */ js.UndefOr[js.Any], typingsJapgolly.extjs.Ext.form.field.IDate]
  ] = js.undefined
...
object IDateField {
  ...
  def apply(
    ...
    setValue: /* date */ js.UndefOr[js.Any] => CallbackTo[typingsJapgolly.extjs.Ext.form.field.IDate] = null,
