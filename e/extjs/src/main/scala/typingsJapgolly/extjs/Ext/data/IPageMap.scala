...
object IPageMap {
  ...
  def apply(
    ...
    each: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* reverse */ js.UndefOr[Boolean]) => CallbackTo[IPageMap] = null,
    ...
    findIndexBy: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[Double] = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IPageMap] = null,
    ...
    if (findIndexBy != null) __obj.updateDynamic("findIndexBy")(js.Any.fromFunction2((t0: /* fn */ js.UndefOr[js.Any], t1: /* scope */ js.UndefOr[js.Any]) => findIndexBy(t0, t1).runNow()))
