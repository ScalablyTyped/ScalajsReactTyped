...
object proxy {
  ...
  object IJsonP {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.data.proxy.IJsonP = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.data.proxy.IJsonP]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.data.proxy.IJsonP](x: Self) {
  ...
  object IProxy {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.data.proxy.IProxy = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.data.proxy.IProxy]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.data.proxy.IProxy](x: Self) {
