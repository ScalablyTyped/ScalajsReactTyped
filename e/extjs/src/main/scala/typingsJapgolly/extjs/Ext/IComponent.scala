...
- typingsJapgolly.extjs.Ext.util.IFloating because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined constrain, fixed, focusOnToFront, shadow, shadowOffset, center, doConstrain, setActive, toBack, toFront */ trait IComponent
  ...
  var findParentBy: js.UndefOr[
    js.Function1[/* fn */ js.UndefOr[Any], typingsJapgolly.extjs.Ext.container.IContainer]
  ] = js.undefined
  ...
  var findParentByType: js.UndefOr[
    js.Function1[/* xtype */ js.UndefOr[Any], typingsJapgolly.extjs.Ext.container.IContainer]
  ] = js.undefined
...
object IComponent {
  ...
  extension [Self <: IComponent](x: Self) {
    ...
    inline def setAfterComponentLayout(value: Callback): Self = StObject.set(x, "afterComponentLayout", value.toJsFn)
    
    inline def setAfterComponentLayoutUndefined: Self = StObject.set(x, "afterComponentLayout", js.undefined)
    
    inline def setAfterHide(value: (/* callback */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "afterHide", js.Any.fromFunction2((t0: /* callback */ js.UndefOr[Any], t1: /* scope */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setAfterSetPosition(value: (/* ax */ js.UndefOr[Any], /* ay */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "afterSetPosition", js.Any.fromFunction2((t0: /* ax */ js.UndefOr[Any], t1: /* ay */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    
    inline def setAfterSetPositionUndefined: Self = StObject.set(x, "afterSetPosition", js.undefined)
    
    inline def setAfterShow(
      value: (/* animateTarget */ js.UndefOr[Any], /* callback */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "afterShow", js.Any.fromFunction3((t0: /* animateTarget */ js.UndefOr[Any], t1: /* callback */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setCancelFocus(value: Callback): Self = StObject.set(x, "cancelFocus", value.toJsFn)
    
    inline def setCancelFocusUndefined: Self = StObject.set(x, "cancelFocus", js.undefined)
    
    inline def setCenter(value: CallbackTo[IComponent | IComponent]): Self = StObject.set(x, "center", value.toJsFn)
    ...
    inline def setDoConstrain(value: js.UndefOr[Any] => Callback): Self = StObject.set(x, "doConstrain", js.Any.fromFunction1((t0: js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setDoConstrainUndefined: Self = StObject.set(x, "doConstrain", js.undefined)
    
    inline def setFindParentBy(value: /* fn */ js.UndefOr[Any] => typingsJapgolly.extjs.Ext.container.IContainer): Self = StObject.set(x, "findParentBy", js.Any.fromFunction1(value))
    
    inline def setFindParentByType(value: /* xtype */ js.UndefOr[Any] => typingsJapgolly.extjs.Ext.container.IContainer): Self = StObject.set(x, "findParentByType", js.Any.fromFunction1(value))
    ...
    inline def setGetXType(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getXType", value.toJsFn)
    ...
    inline def setInitComponent(value: Callback): Self = StObject.set(x, "initComponent", value.toJsFn)
    
    inline def setInitComponentUndefined: Self = StObject.set(x, "initComponent", js.undefined)
    
    inline def setOnAdded(value: Callback): Self = StObject.set(x, "onAdded", value.toJsFn)
    ...
    inline def setOnHide(
      value: (/* animateTarget */ js.UndefOr[Any], /* callback */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "onHide", js.Any.fromFunction3((t0: /* animateTarget */ js.UndefOr[Any], t1: /* callback */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnHideUndefined: Self = StObject.set(x, "onHide", js.undefined)
    
    inline def setOnShow(
      value: (/* animateTarget */ js.UndefOr[Any], /* callback */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "onShow", js.Any.fromFunction3((t0: /* animateTarget */ js.UndefOr[Any], t1: /* callback */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnShowComplete(value: (/* callback */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "onShowComplete", js.Any.fromFunction2((t0: /* callback */ js.UndefOr[Any], t1: /* scope */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setScrollBy(
      value: (/* deltaX */ js.UndefOr[Any], /* deltaY */ js.UndefOr[Any], /* animate */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "scrollBy", js.Any.fromFunction3((t0: /* deltaX */ js.UndefOr[Any], t1: /* deltaY */ js.UndefOr[Any], t2: /* animate */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setSetActive(value: (js.UndefOr[Boolean], js.UndefOr[IComponent]) => Callback): Self = StObject.set(x, "setActive", js.Any.fromFunction2((t0: js.UndefOr[Boolean], t1: js.UndefOr[IComponent]) => (value(t0, t1)).runNow()))
    ...
    inline def setToBack(value: CallbackTo[IComponent | IComponent]): Self = StObject.set(x, "toBack", value.toJsFn)
