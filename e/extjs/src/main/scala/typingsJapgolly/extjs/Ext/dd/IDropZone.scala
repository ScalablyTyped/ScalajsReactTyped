...
object IDropZone {
  ...
  extension [Self <: IDropZone](x: Self) {
    ...
    inline def setOnNodeEnter(
      value: (/* nodeData */ js.UndefOr[Any], /* source */ js.UndefOr[IDragSource], /* e */ js.UndefOr[Event], /* data */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "onNodeEnter", js.Any.fromFunction4((t0: /* nodeData */ js.UndefOr[Any], t1: /* source */ js.UndefOr[IDragSource], t2: /* e */ js.UndefOr[Event], t3: /* data */ js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
    
    inline def setOnNodeEnterUndefined: Self = StObject.set(x, "onNodeEnter", js.undefined)
    
    inline def setOnNodeOut(
      value: (/* nodeData */ js.UndefOr[Any], /* source */ js.UndefOr[IDragSource], /* e */ js.UndefOr[Event], /* data */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "onNodeOut", js.Any.fromFunction4((t0: /* nodeData */ js.UndefOr[Any], t1: /* source */ js.UndefOr[IDragSource], t2: /* e */ js.UndefOr[Event], t3: /* data */ js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
