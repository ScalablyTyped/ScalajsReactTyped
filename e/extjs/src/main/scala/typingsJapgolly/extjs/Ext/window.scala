...
object window {
  ...
  trait IMessageBox
    extends StObject
       with typingsJapgolly.extjs.Ext.window.IWindow {
  ...
  object IMessageBox {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.window.IMessageBox = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.window.IMessageBox]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.window.IMessageBox](x: Self) {
      
      inline def setAlert(
        value: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => typingsJapgolly.extjs.Ext.window.IMessageBox
      ...
      inline def setProgress(
        value: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* progressText */ js.UndefOr[java.lang.String]) => typingsJapgolly.extjs.Ext.window.IMessageBox
      ): Self = StObject.set(x, "progress", js.Any.fromFunction3(value))
      
      inline def setProgressUndefined: Self = StObject.set(x, "progress", js.undefined)
      
      inline def setPrompt(
        value: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any], /* multiline */ js.UndefOr[Any], /* value */ js.UndefOr[java.lang.String]) => typingsJapgolly.extjs.Ext.window.IMessageBox
      ...
      inline def setSetIcon(
        value: (/* icon */ js.UndefOr[java.lang.String], /* width */ js.UndefOr[Double], /* height */ js.UndefOr[Double]) => typingsJapgolly.extjs.Ext.window.IMessageBox
      ...
      inline def setShow(value: /* config */ js.UndefOr[Any] => typingsJapgolly.extjs.Ext.window.IMessageBox): Self = StObject.set(x, "show", js.Any.fromFunction1(value))
      
      inline def setShowUndefined: Self = StObject.set(x, "show", js.undefined)
      
      inline def setUpdateProgress(
        value: (/* value */ js.UndefOr[Double], /* progressText */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String]) => typingsJapgolly.extjs.Ext.window.IMessageBox
      ...
      inline def setWait_(
        value: (/* msg */ js.UndefOr[java.lang.String], /* title */ js.UndefOr[java.lang.String], /* config */ js.UndefOr[Any]) => typingsJapgolly.extjs.Ext.window.IMessageBox
  ...
  object IWindow {
    ...
    inline def apply(): typingsJapgolly.extjs.Ext.window.IWindow = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.extjs.Ext.window.IWindow]
    }
    
    extension [Self <: typingsJapgolly.extjs.Ext.window.IWindow](x: Self) {
      ...
      inline def setMaximize(value: /* animate */ js.UndefOr[Boolean] => typingsJapgolly.extjs.Ext.window.IWindow): Self = StObject.set(x, "maximize", js.Any.fromFunction1(value))
      ...
      inline def setMinimize(value: CallbackTo[typingsJapgolly.extjs.Ext.window.IWindow]): Self = StObject.set(x, "minimize", value.toJsFn)
      ...
      inline def setRestore(value: /* animate */ js.UndefOr[Any] => typingsJapgolly.extjs.Ext.window.IWindow): Self = StObject.set(x, "restore", js.Any.fromFunction1(value))
      
      inline def setRestoreUndefined: Self = StObject.set(x, "restore", js.undefined)
      
      inline def setToggleMaximize(value: CallbackTo[typingsJapgolly.extjs.Ext.window.IWindow]): Self = StObject.set(x, "toggleMaximize", value.toJsFn)
