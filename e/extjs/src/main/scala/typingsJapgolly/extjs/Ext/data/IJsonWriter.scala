...
object IJsonWriter {
  ...
  def apply(
    ...
    extend: String = null,
    getExpandedData: /* data */ js.UndefOr[js.Any] => Callback = null,
    getInitialConfig: /* name */ js.UndefOr[String] => CallbackTo[js.Any] = null,
    getRecordData: (/* record */ js.UndefOr[IModel], /* operation */ js.UndefOr[IOperation]) => CallbackTo[js.Any] = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => CallbackTo[IJsonWriter] = null,
    mixins: js.Any = null,
    ...
    if (getExpandedData != null) __obj.updateDynamic("getExpandedData")(js.Any.fromFunction1((t0: /* data */ js.UndefOr[js.Any]) => getExpandedData(t0).runNow()))
