...
import typingsJapgolly.extjs.Ext.dd.IDragDrop
...
object dd {
  ...
  open class DDM ()
    extends StObject
       with typingsJapgolly.extjs.Ext.dd.DDM
  /* static members */
  object DDM {
    ...
    inline def getBestMatch(dds: typingsJapgolly.extjs.Ext.Array): IDragDrop = ^.asInstanceOf[js.Dynamic].applyDynamic("getBestMatch")(dds.asInstanceOf[js.Any]).asInstanceOf[IDragDrop]
    ...
    /** [Method] Returns the drag and drop instances that are in all groups the passed in instance belongs to
      ...
      */
    inline def getRelated(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getRelated")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def getRelated(p_oDD: Unit, bTargetsOnly: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getRelated")(p_oDD.asInstanceOf[js.Any], bTargetsOnly.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def getRelated(p_oDD: IDragDrop): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getRelated")(p_oDD.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def getRelated(p_oDD: IDragDrop, bTargetsOnly: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getRelated")(p_oDD.asInstanceOf[js.Any], bTargetsOnly.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  ...
  open class DragDropManager_ ()
    extends StObject
       with typingsJapgolly.extjs.Ext.dd.DragDropManager_
  /* static members */
  ...
  open class DragDropMgr ()
    extends StObject
       with typingsJapgolly.extjs.Ext.dd.DragDropMgr
  /* static members */
  object DragDropMgr {
  ...
  open class Registry ()
    extends StObject
       with typingsJapgolly.extjs.Ext.dd.Registry
  /* static members */
  object Registry {
  ...
  open class ScrollManager ()
    extends StObject
       with typingsJapgolly.extjs.Ext.dd.ScrollManager
  /* static members */
