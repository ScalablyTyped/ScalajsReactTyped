...
open class Date ()
  extends StObject
     with typingsJapgolly.extjs.Ext.Date
/* static members */
object Date {
  ...
  @js.native
  def dayNames: typingsJapgolly.extjs.Ext.Array = js.native
  inline def dayNames_=(x: typingsJapgolly.extjs.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("dayNames")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def monthNames: typingsJapgolly.extjs.Ext.Array = js.native
  inline def monthNames_=(x: typingsJapgolly.extjs.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("monthNames")(x.asInstanceOf[js.Any])
