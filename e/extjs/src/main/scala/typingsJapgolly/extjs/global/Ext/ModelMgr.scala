...
open class ModelMgr ()
  extends StObject
     with typingsJapgolly.extjs.Ext.ModelMgr
/* static members */
object ModelMgr {
  ...
  @js.native
  def associationStack: typingsJapgolly.extjs.Ext.Array = js.native
  inline def associationStack_=(x: typingsJapgolly.extjs.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("associationStack")(x.asInstanceOf[js.Any])
