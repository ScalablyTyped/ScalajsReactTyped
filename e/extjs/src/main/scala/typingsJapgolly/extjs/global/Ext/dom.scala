...
import typingsJapgolly.extjs.Ext.dom.element.IFly
...
object dom {
  ...
  @js.native
  open class AbstractElement_ ()
    extends StObject
       with typingsJapgolly.extjs.Ext.dom.AbstractElement_
  /* static members */
  object AbstractElement_ {
    ...
    inline def fly(dom: Any): IFly = ^.asInstanceOf[js.Dynamic].applyDynamic("fly")(dom.asInstanceOf[js.Any]).asInstanceOf[IFly]
    inline def fly(dom: Any, named: java.lang.String): IFly = (^.asInstanceOf[js.Dynamic].applyDynamic("fly")(dom.asInstanceOf[js.Any], named.asInstanceOf[js.Any])).asInstanceOf[IFly]
    ...
    /** [Method] Returns an array of unique class names based upon the input strings or string arrays
      ...
      */
    inline def mergeClsList(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("mergeClsList")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def mergeClsList(clsList1: Any): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("mergeClsList")(clsList1.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def mergeClsList(clsList1: Any, clsList2: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("mergeClsList")(clsList1.asInstanceOf[js.Any], clsList2.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def mergeClsList(clsList1: Unit, clsList2: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("mergeClsList")(clsList1.asInstanceOf[js.Any], clsList2.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    ...
    /** [Method] Returns an array of unique class names deom the first parameter with all class names from the second parameter removed
      ...
      */
    inline def removeCls(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("removeCls")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def removeCls(existingClsList: Any): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("removeCls")(existingClsList.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def removeCls(existingClsList: Any, removeClsList: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("removeCls")(existingClsList.asInstanceOf[js.Any], removeClsList.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def removeCls(existingClsList: Unit, removeClsList: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("removeCls")(existingClsList.asInstanceOf[js.Any], removeClsList.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  ...
  open class Element_ ()
    extends StObject
       with typingsJapgolly.extjs.Ext.dom.Element_
  /* static members */
  object Element_ {
  ...
  open class Query ()
    extends StObject
       with typingsJapgolly.extjs.Ext.dom.Query
  /* static members */
  object Query {
    ...
    inline def filter(el: Unit, selector: java.lang.String): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(el.asInstanceOf[js.Any], selector.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def filter(el: Unit, selector: java.lang.String, nonMatches: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(el.asInstanceOf[js.Any], selector.asInstanceOf[js.Any], nonMatches.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def filter(el: Unit, selector: Unit, nonMatches: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(el.asInstanceOf[js.Any], selector.asInstanceOf[js.Any], nonMatches.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def filter(el: typingsJapgolly.extjs.Ext.Array): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(el.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def filter(el: typingsJapgolly.extjs.Ext.Array, selector: java.lang.String): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(el.asInstanceOf[js.Any], selector.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def filter(el: typingsJapgolly.extjs.Ext.Array, selector: java.lang.String, nonMatches: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(el.asInstanceOf[js.Any], selector.asInstanceOf[js.Any], nonMatches.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def filter(el: typingsJapgolly.extjs.Ext.Array, selector: Unit, nonMatches: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(el.asInstanceOf[js.Any], selector.asInstanceOf[js.Any], nonMatches.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    ...
    /** [Method] Selects an array of DOM nodes using JavaScript only implementation
      ...
      * @returns HTMLElement[] An Array of DOM elements which match the selector. If there are no matches, and empty Array is returned.
      */
    inline def jsSelect(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("jsSelect")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def jsSelect(selector: java.lang.String): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("jsSelect")(selector.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def jsSelect(selector: java.lang.String, root: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("jsSelect")(selector.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def jsSelect(selector: Unit, root: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("jsSelect")(selector.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    ...
    /** [Method] Selects an array of DOM nodes by CSS XPath selector
      ...
      */
    inline def select(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("select")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: java.lang.String): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: java.lang.String, root: HTMLElement): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: java.lang.String, root: HTMLElement, `type`: java.lang.String): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: java.lang.String, root: HTMLElement, `type`: java.lang.String, single: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], single.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: java.lang.String, root: HTMLElement, `type`: Unit, single: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], single.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: java.lang.String, root: Unit, `type`: java.lang.String): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: java.lang.String, root: Unit, `type`: java.lang.String, single: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], single.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: java.lang.String, root: Unit, `type`: Unit, single: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], single.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: Unit, root: HTMLElement): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: Unit, root: HTMLElement, `type`: java.lang.String): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: Unit, root: HTMLElement, `type`: java.lang.String, single: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], single.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: Unit, root: HTMLElement, `type`: Unit, single: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], single.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: Unit, root: Unit, `type`: java.lang.String): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: Unit, root: Unit, `type`: java.lang.String, single: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], single.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
    inline def select(path: Unit, root: Unit, `type`: Unit, single: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(path.asInstanceOf[js.Any], root.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], single.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
