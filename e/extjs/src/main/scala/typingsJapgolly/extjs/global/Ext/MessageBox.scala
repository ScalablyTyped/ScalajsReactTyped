...
import typingsJapgolly.extjs.Ext.IComponentLoader
import typingsJapgolly.extjs.Ext.IEventObject
import typingsJapgolly.extjs.Ext.ILoadMask
import typingsJapgolly.extjs.Ext.IZIndexManager
...
import typingsJapgolly.extjs.Ext.util.IAbstractMixedCollection
...
import typingsJapgolly.extjs.Ext.window.IMessageBox
import typingsJapgolly.extjs.Ext.window.IWindow
...
open class MessageBox ()
  extends StObject
     with typingsJapgolly.extjs.Ext.MessageBox
/* static members */
object MessageBox {
  ...
  /** [Method] Adds docked item s to the container
    ...
    */
  inline def addDocked(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("addDocked")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def addDocked(component: Any): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("addDocked")(component.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def addDocked(component: Any, pos: Double): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("addDocked")(component.asInstanceOf[js.Any], pos.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def addDocked(component: Unit, pos: Double): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("addDocked")(component.asInstanceOf[js.Any], pos.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  ...
  inline def alignTo(element: Any, position: java.lang.String, offsets: typingsJapgolly.extjs.Ext.Array): IPositionable = (^.asInstanceOf[js.Dynamic].applyDynamic("alignTo")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any])).asInstanceOf[IPositionable]
  inline def alignTo(element: Any, position: java.lang.String, offsets: typingsJapgolly.extjs.Ext.Array, animate: Any): IPositionable = (^.asInstanceOf[js.Dynamic].applyDynamic("alignTo")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any], animate.asInstanceOf[js.Any])).asInstanceOf[IPositionable]
  ...
  inline def alignTo(element: Any, position: Unit, offsets: typingsJapgolly.extjs.Ext.Array): IPositionable = (^.asInstanceOf[js.Dynamic].applyDynamic("alignTo")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any])).asInstanceOf[IPositionable]
  inline def alignTo(element: Any, position: Unit, offsets: typingsJapgolly.extjs.Ext.Array, animate: Any): IPositionable = (^.asInstanceOf[js.Dynamic].applyDynamic("alignTo")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any], animate.asInstanceOf[js.Any])).asInstanceOf[IPositionable]
  ...
  inline def alignTo(element: Unit, position: java.lang.String, offsets: typingsJapgolly.extjs.Ext.Array): IPositionable = (^.asInstanceOf[js.Dynamic].applyDynamic("alignTo")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any])).asInstanceOf[IPositionable]
  inline def alignTo(element: Unit, position: java.lang.String, offsets: typingsJapgolly.extjs.Ext.Array, animate: Any): IPositionable = (^.asInstanceOf[js.Dynamic].applyDynamic("alignTo")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any], animate.asInstanceOf[js.Any])).asInstanceOf[IPositionable]
  ...
  inline def alignTo(element: Unit, position: Unit, offsets: typingsJapgolly.extjs.Ext.Array): IPositionable = (^.asInstanceOf[js.Dynamic].applyDynamic("alignTo")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any])).asInstanceOf[IPositionable]
  inline def alignTo(element: Unit, position: Unit, offsets: typingsJapgolly.extjs.Ext.Array, animate: Any): IPositionable = (^.asInstanceOf[js.Dynamic].applyDynamic("alignTo")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any], animate.asInstanceOf[js.Any])).asInstanceOf[IPositionable]
  ...
  inline def anchorTo(
    ...
    offsets: js.UndefOr[typingsJapgolly.extjs.Ext.Array],
  ...
  inline def bubble(fn: Any, scope: Any, args: typingsJapgolly.extjs.Ext.Array): IComponent = (^.asInstanceOf[js.Dynamic].applyDynamic("bubble")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[IComponent]
  inline def bubble(fn: Any, scope: Unit, args: typingsJapgolly.extjs.Ext.Array): IComponent = (^.asInstanceOf[js.Dynamic].applyDynamic("bubble")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[IComponent]
  ...
  inline def bubble(fn: Unit, scope: Any, args: typingsJapgolly.extjs.Ext.Array): IComponent = (^.asInstanceOf[js.Dynamic].applyDynamic("bubble")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[IComponent]
  inline def bubble(fn: Unit, scope: Unit, args: typingsJapgolly.extjs.Ext.Array): IComponent = (^.asInstanceOf[js.Dynamic].applyDynamic("bubble")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[IComponent]
  ...
  /** [Method] Calculates the new x y position to move this Positionable into a constrain region
    ...
    */
  inline def calculateConstrainedPosition(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("calculateConstrainedPosition")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def calculateConstrainedPosition(constrainTo: Any): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("calculateConstrainedPosition")(constrainTo.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def calculateConstrainedPosition(constrainTo: Any, proposedPosition: Unit, local: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("calculateConstrainedPosition")(constrainTo.asInstanceOf[js.Any], proposedPosition.asInstanceOf[js.Any], local.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def calculateConstrainedPosition(
    constrainTo: Any,
    proposedPosition: Unit,
    local: Boolean,
    proposedSize: typingsJapgolly.extjs.Ext.Array
  ): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("calculateConstrainedPosition")(constrainTo.asInstanceOf[js.Any], proposedPosition.asInstanceOf[js.Any], local.asInstanceOf[js.Any], proposedSize.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def calculateConstrainedPosition(
    constrainTo: Any,
    proposedPosition: Unit,
    local: Unit,
  ...
  inline def calculateConstrainedPosition(constrainTo: Any, proposedPosition: typingsJapgolly.extjs.Ext.Array): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("calculateConstrainedPosition")(constrainTo.asInstanceOf[js.Any], proposedPosition.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def calculateConstrainedPosition(constrainTo: Any, proposedPosition: typingsJapgolly.extjs.Ext.Array, local: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("calculateConstrainedPosition")(constrainTo.asInstanceOf[js.Any], proposedPosition.asInstanceOf[js.Any], local.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def calculateConstrainedPosition(
    constrainTo: Any,
    proposedPosition: typingsJapgolly.extjs.Ext.Array,
    local: Boolean,
    proposedSize: typingsJapgolly.extjs.Ext.Array
  ): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("calculateConstrainedPosition")(constrainTo.asInstanceOf[js.Any], proposedPosition.asInstanceOf[js.Any], local.asInstanceOf[js.Any], proposedSize.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def calculateConstrainedPosition(
  ...
  inline def calculateConstrainedPosition(constrainTo: Unit, proposedPosition: Unit, local: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("calculateConstrainedPosition")(constrainTo.asInstanceOf[js.Any], proposedPosition.asInstanceOf[js.Any], local.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def calculateConstrainedPosition(
    constrainTo: Unit,
    proposedPosition: Unit,
    local: Boolean,
  ...
  inline def calculateConstrainedPosition(constrainTo: Unit, proposedPosition: typingsJapgolly.extjs.Ext.Array): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("calculateConstrainedPosition")(constrainTo.asInstanceOf[js.Any], proposedPosition.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def calculateConstrainedPosition(constrainTo: Unit, proposedPosition: typingsJapgolly.extjs.Ext.Array, local: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("calculateConstrainedPosition")(constrainTo.asInstanceOf[js.Any], proposedPosition.asInstanceOf[js.Any], local.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def calculateConstrainedPosition(
    constrainTo: Unit,
    proposedPosition: typingsJapgolly.extjs.Ext.Array,
    local: Boolean,
  ...
  /** [Method] Cascades down the component container heirarchy from this component passed in the first call  calling the specified
    ...
    */
  inline def cascade(): typingsJapgolly.extjs.Ext.IContainer = ^.asInstanceOf[js.Dynamic].applyDynamic("cascade")().asInstanceOf[typingsJapgolly.extjs.Ext.IContainer]
  inline def cascade(fn: Any): typingsJapgolly.extjs.Ext.IContainer = ^.asInstanceOf[js.Dynamic].applyDynamic("cascade")(fn.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.IContainer]
  inline def cascade(fn: Any, scope: Any): typingsJapgolly.extjs.Ext.IContainer = (^.asInstanceOf[js.Dynamic].applyDynamic("cascade")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.IContainer]
  inline def cascade(fn: Any, scope: Any, args: typingsJapgolly.extjs.Ext.Array): typingsJapgolly.extjs.Ext.IContainer = (^.asInstanceOf[js.Dynamic].applyDynamic("cascade")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.IContainer]
  inline def cascade(fn: Any, scope: Unit, args: typingsJapgolly.extjs.Ext.Array): typingsJapgolly.extjs.Ext.IContainer = (^.asInstanceOf[js.Dynamic].applyDynamic("cascade")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.IContainer]
  inline def cascade(fn: Unit, scope: Any): typingsJapgolly.extjs.Ext.IContainer = (^.asInstanceOf[js.Dynamic].applyDynamic("cascade")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.IContainer]
  inline def cascade(fn: Unit, scope: Any, args: typingsJapgolly.extjs.Ext.Array): typingsJapgolly.extjs.Ext.IContainer = (^.asInstanceOf[js.Dynamic].applyDynamic("cascade")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.IContainer]
  inline def cascade(fn: Unit, scope: Unit, args: typingsJapgolly.extjs.Ext.Array): typingsJapgolly.extjs.Ext.IContainer = (^.asInstanceOf[js.Dynamic].applyDynamic("cascade")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.IContainer]
  ...
  /** [Method] This method needs to be called whenever you change something on this component that requires the Component s layout t
    ...
    */
  inline def doComponentLayout(): typingsJapgolly.extjs.Ext.container.IContainer = ^.asInstanceOf[js.Dynamic].applyDynamic("doComponentLayout")().asInstanceOf[typingsJapgolly.extjs.Ext.container.IContainer]
  ...
  /** [Method] Manually force this container s layout to be recalculated
    * @returns Ext.container.Container this
    */
  inline def doLayout(): typingsJapgolly.extjs.Ext.container.IContainer = ^.asInstanceOf[js.Dynamic].applyDynamic("doLayout")().asInstanceOf[typingsJapgolly.extjs.Ext.container.IContainer]
  ...
  /** [Method] Find a container above this component at any level by a custom function
    ...
    */
  inline def findParentBy(): typingsJapgolly.extjs.Ext.container.IContainer = ^.asInstanceOf[js.Dynamic].applyDynamic("findParentBy")().asInstanceOf[typingsJapgolly.extjs.Ext.container.IContainer]
  inline def findParentBy(fn: Any): typingsJapgolly.extjs.Ext.container.IContainer = ^.asInstanceOf[js.Dynamic].applyDynamic("findParentBy")(fn.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.container.IContainer]
  ...
  /** [Method] Find a container above this component at any level by xtype or class See also the up method
    ...
    */
  inline def findParentByType(): typingsJapgolly.extjs.Ext.container.IContainer = ^.asInstanceOf[js.Dynamic].applyDynamic("findParentByType")().asInstanceOf[typingsJapgolly.extjs.Ext.container.IContainer]
  inline def findParentByType(xtype: Any): typingsJapgolly.extjs.Ext.container.IContainer = ^.asInstanceOf[js.Dynamic].applyDynamic("findParentByType")(xtype.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.container.IContainer]
  ...
  inline def fireEventArgs(eventName: java.lang.String, args: typingsJapgolly.extjs.Ext.Array): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("fireEventArgs")(eventName.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def fireEventArgs(eventName: Unit, args: typingsJapgolly.extjs.Ext.Array): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("fireEventArgs")(eventName.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  /** [Property] (Ext.Container) */
  @JSGlobal("Ext.MessageBox.floatParent")
  @js.native
  def floatParent: typingsJapgolly.extjs.Ext.IContainer = js.native
  inline def floatParent_=(x: typingsJapgolly.extjs.Ext.IContainer): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("floatParent")(x.asInstanceOf[js.Any])
  ...
  /** [Method] Gets the x y coordinates to align this element with another element
    ...
    * @returns Number[] [x, y]
    */
  inline def getAlignToXY(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getAlignToXY")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAlignToXY(element: Any): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getAlignToXY")(element.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAlignToXY(element: Any, position: java.lang.String): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getAlignToXY")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAlignToXY(element: Any, position: java.lang.String, offsets: typingsJapgolly.extjs.Ext.Array): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getAlignToXY")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAlignToXY(element: Any, position: Unit, offsets: typingsJapgolly.extjs.Ext.Array): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getAlignToXY")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAlignToXY(element: Unit, position: java.lang.String): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getAlignToXY")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAlignToXY(element: Unit, position: java.lang.String, offsets: typingsJapgolly.extjs.Ext.Array): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getAlignToXY")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAlignToXY(element: Unit, position: Unit, offsets: typingsJapgolly.extjs.Ext.Array): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getAlignToXY")(element.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  ...
  /** [Method] Gets the x y coordinates specified by the anchor position on the element
    ...
    */
  inline def getAnchorXY(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getAnchorXY")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAnchorXY(anchor: java.lang.String): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getAnchorXY")(anchor.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAnchorXY(anchor: java.lang.String, local: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getAnchorXY")(anchor.asInstanceOf[js.Any], local.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAnchorXY(anchor: java.lang.String, local: Boolean, size: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getAnchorXY")(anchor.asInstanceOf[js.Any], local.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAnchorXY(anchor: java.lang.String, local: Unit, size: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getAnchorXY")(anchor.asInstanceOf[js.Any], local.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAnchorXY(anchor: Unit, local: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getAnchorXY")(anchor.asInstanceOf[js.Any], local.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAnchorXY(anchor: Unit, local: Boolean, size: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getAnchorXY")(anchor.asInstanceOf[js.Any], local.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAnchorXY(anchor: Unit, local: Unit, size: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getAnchorXY")(anchor.asInstanceOf[js.Any], local.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  ...
  inline def getConstrainVector(constrainTo: Any, proposedPosition: Unit, proposedSize: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("getConstrainVector")(constrainTo.asInstanceOf[js.Any], proposedPosition.asInstanceOf[js.Any], proposedSize.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def getConstrainVector(constrainTo: Any, proposedPosition: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("getConstrainVector")(constrainTo.asInstanceOf[js.Any], proposedPosition.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  inline def getConstrainVector(constrainTo: Unit, proposedPosition: Unit, proposedSize: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("getConstrainVector")(constrainTo.asInstanceOf[js.Any], proposedPosition.asInstanceOf[js.Any], proposedSize.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def getConstrainVector(constrainTo: Unit, proposedPosition: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("getConstrainVector")(constrainTo.asInstanceOf[js.Any], proposedPosition.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def getConstrainVector(
    constrainTo: Unit,
    proposedPosition: typingsJapgolly.extjs.Ext.Array,
    proposedSize: typingsJapgolly.extjs.Ext.Array
  ...
  /** [Method] Retrieves an array of all currently docked Components
    ...
    */
  inline def getDockedItems(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getDockedItems")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getDockedItems(selector: java.lang.String): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getDockedItems")(selector.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getDockedItems(selector: java.lang.String, beforeBody: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getDockedItems")(selector.asInstanceOf[js.Any], beforeBody.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getDockedItems(selector: Unit, beforeBody: Boolean): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getDockedItems")(selector.asInstanceOf[js.Any], beforeBody.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  ...
  /** [Method] Overridden in Ext rtl AbstractComponent
    ...
    */
  inline def getLocalXY(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getLocalXY")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  ...
  /** [Method] Returns the offsets of this element from the passed element
    ...
    */
  inline def getOffsetsTo(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getOffsetsTo")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getOffsetsTo(offsetsTo: Any): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getOffsetsTo")(offsetsTo.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  ...
  /** [Method] Gets the current XY position of the component s underlying element
    ...
    */
  inline def getPosition(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getPosition")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getPosition(local: Boolean): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getPosition")(local.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  ...
  /** [Method] Gets the current position of the DOM element based on page coordinates
    ...
    */
  inline def getXY(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getXY")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  ...
  inline def isDescendantOf(container: typingsJapgolly.extjs.Ext.IContainer): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDescendantOf")(container.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  @js.native
  def ownerCt: typingsJapgolly.extjs.Ext.IContainer = js.native
  inline def ownerCt_=(x: typingsJapgolly.extjs.Ext.IContainer): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ownerCt")(x.asInstanceOf[js.Any])
  ...
  /** [Method] Retrieves all descendant components which match the passed function
    ...
    */
  inline def queryBy(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("queryBy")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def queryBy(fn: Any): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("queryBy")(fn.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def queryBy(fn: Any, scope: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("queryBy")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def queryBy(fn: Unit, scope: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("queryBy")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  ...
  inline def relayEvents(origin: Any, events: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("relayEvents")(origin.asInstanceOf[js.Any], events.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def relayEvents(origin: Any, events: typingsJapgolly.extjs.Ext.Array, prefix: java.lang.String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("relayEvents")(origin.asInstanceOf[js.Any], events.asInstanceOf[js.Any], prefix.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  inline def relayEvents(origin: Unit, events: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("relayEvents")(origin.asInstanceOf[js.Any], events.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def relayEvents(origin: Unit, events: typingsJapgolly.extjs.Ext.Array, prefix: java.lang.String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("relayEvents")(origin.asInstanceOf[js.Any], events.asInstanceOf[js.Any], prefix.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  /** [Method] Removes all components from this container
    ...
    */
  inline def removeAll(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("removeAll")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def removeAll(autoDestroy: Boolean): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("removeAll")(autoDestroy.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  ...
  inline def showBy(component: Any, position: java.lang.String, offsets: typingsJapgolly.extjs.Ext.Array): IComponent = (^.asInstanceOf[js.Dynamic].applyDynamic("showBy")(component.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any])).asInstanceOf[IComponent]
  inline def showBy(component: Any, position: Unit, offsets: typingsJapgolly.extjs.Ext.Array): IComponent = (^.asInstanceOf[js.Dynamic].applyDynamic("showBy")(component.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any])).asInstanceOf[IComponent]
  ...
  inline def showBy(component: Unit, position: java.lang.String, offsets: typingsJapgolly.extjs.Ext.Array): IComponent = (^.asInstanceOf[js.Dynamic].applyDynamic("showBy")(component.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any])).asInstanceOf[IComponent]
  inline def showBy(component: Unit, position: Unit, offsets: typingsJapgolly.extjs.Ext.Array): IComponent = (^.asInstanceOf[js.Dynamic].applyDynamic("showBy")(component.asInstanceOf[js.Any], position.asInstanceOf[js.Any], offsets.asInstanceOf[js.Any])).asInstanceOf[IComponent]
  ...
  /** [Method] Stops any running effects and clears this object s internal effects queue if it contains any additional effects that
    ...
    */
  inline def stopAnimation(): typingsJapgolly.extjs.Ext.IElement = ^.asInstanceOf[js.Dynamic].applyDynamic("stopAnimation")().asInstanceOf[typingsJapgolly.extjs.Ext.IElement]
  
  /** [Method] Stops any running effects and clears this object s internal effects queue if it contains any additional effects that
    * @returns Ext.Element The Element
    */
  inline def stopFx(): typingsJapgolly.extjs.Ext.IElement = ^.asInstanceOf[js.Dynamic].applyDynamic("stopFx")().asInstanceOf[typingsJapgolly.extjs.Ext.IElement]
  ...
  /** [Method] Navigates up the ownership hierarchy searching for an ancestor Container which matches any passed simple selector or
    ...
    */
  inline def up(): typingsJapgolly.extjs.Ext.container.IContainer = ^.asInstanceOf[js.Dynamic].applyDynamic("up")().asInstanceOf[typingsJapgolly.extjs.Ext.container.IContainer]
  inline def up(selector: Any): typingsJapgolly.extjs.Ext.container.IContainer = ^.asInstanceOf[js.Dynamic].applyDynamic("up")(selector.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.container.IContainer]
  inline def up(selector: Any, limit: Any): typingsJapgolly.extjs.Ext.container.IContainer = (^.asInstanceOf[js.Dynamic].applyDynamic("up")(selector.asInstanceOf[js.Any], limit.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.container.IContainer]
  inline def up(selector: Unit, limit: Any): typingsJapgolly.extjs.Ext.container.IContainer = (^.asInstanceOf[js.Dynamic].applyDynamic("up")(selector.asInstanceOf[js.Any], limit.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.container.IContainer]
  ...
  @js.native
  def zIndexParent: typingsJapgolly.extjs.Ext.IContainer = js.native
  inline def zIndexParent_=(x: typingsJapgolly.extjs.Ext.IContainer): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("zIndexParent")(x.asInstanceOf[js.Any])
}
