...
@js.native
open class XTemplate ()
  extends StObject
     with typingsJapgolly.extjs.Ext.XTemplate
/* static members */
object XTemplate {
  ...
  inline def getTpl(instance: Any): IXTemplate = ^.asInstanceOf[js.Dynamic].applyDynamic("getTpl")(instance.asInstanceOf[js.Any]).asInstanceOf[IXTemplate]
  inline def getTpl(instance: Any, name: java.lang.String): IXTemplate = (^.asInstanceOf[js.Dynamic].applyDynamic("getTpl")(instance.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[IXTemplate]
