...
object core {
  ...
  open class DomHelper ()
    extends StObject
       with typingsJapgolly.extjs.Ext.core.DomHelper
  /* static members */
  object DomHelper {
    ...
    inline def generateStyles(styles: Any, buffer: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("generateStyles")(styles.asInstanceOf[js.Any], buffer.asInstanceOf[js.Any])).asInstanceOf[Any]
    inline def generateStyles(styles: Unit, buffer: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("generateStyles")(styles.asInstanceOf[js.Any], buffer.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  open class DomQuery ()
    extends StObject
       with typingsJapgolly.extjs.Ext.core.DomQuery
  /* static members */
  object DomQuery {
  ...
  open class Element ()
    extends StObject
       with typingsJapgolly.extjs.Ext.core.Element
  /* static members */
  object Element {
