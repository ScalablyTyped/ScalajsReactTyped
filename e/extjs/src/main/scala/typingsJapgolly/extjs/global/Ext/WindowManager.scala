...
open class WindowManager ()
  extends StObject
     with typingsJapgolly.extjs.Ext.WindowManager
/* static members */
object WindowManager {
  ...
  /** [Method] Returns zero or more Components in this ZIndexManager using the custom search function passed to this method
    ...
    */
  inline def getBy(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getBy")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getBy(fn: Any): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getBy")(fn.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getBy(fn: Any, scope: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getBy")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getBy(fn: Unit, scope: Any): typingsJapgolly.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getBy")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
