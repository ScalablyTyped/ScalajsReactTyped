...
import typingsJapgolly.extjs.Ext.IClassManager
...
open class ClassManager ()
  extends StObject
     with typingsJapgolly.extjs.Ext.ClassManager
/* static members */
object ClassManager {
  ...
  /** [Method] Get the aliases of a class by the class name
    ...
    */
  inline def getAliasesByName(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getAliasesByName")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getAliasesByName(name: java.lang.String): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getAliasesByName")(name.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  ...
  /** [Method] Converts a string expression to an array of matching class names
    ...
    */
  inline def getNamesByExpression(): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getNamesByExpression")().asInstanceOf[typingsJapgolly.extjs.Ext.Array]
  inline def getNamesByExpression(expression: java.lang.String): typingsJapgolly.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getNamesByExpression")(expression.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.extjs.Ext.Array]
