...
import typingsJapgolly.extjs.Ext.app.IController
...
object app {
  ...
  open class EventBus ()
    extends StObject
       with typingsJapgolly.extjs.Ext.app.EventBus
  /* static members */
  object EventBus {
  ...
  object domain {
    ...
    open class Component ()
      extends StObject
         with typingsJapgolly.extjs.Ext.app.domain.Component
    /* static members */
    object Component {
    ...
    open class Controller ()
      extends StObject
         with typingsJapgolly.extjs.Ext.app.domain.Controller
    /* static members */
    object Controller {
    ...
    open class Direct ()
      extends StObject
         with typingsJapgolly.extjs.Ext.app.domain.Direct
    /* static members */
    object Direct {
    ...
    open class Global ()
      extends StObject
         with typingsJapgolly.extjs.Ext.app.domain.Global
    /* static members */
    object Global {
    ...
    open class Store ()
      extends StObject
         with typingsJapgolly.extjs.Ext.app.domain.Store
    /* static members */
    object Store {
