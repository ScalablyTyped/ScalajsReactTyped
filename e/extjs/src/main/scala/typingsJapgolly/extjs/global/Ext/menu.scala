...
object menu {
  ...
  open class Manager ()
    extends StObject
       with typingsJapgolly.extjs.Ext.menu.Manager
  /* static members */
  object Manager {
    ...
    inline def get(menu: Any): IMenu = ^.asInstanceOf[js.Dynamic].applyDynamic("get")(menu.asInstanceOf[js.Any]).asInstanceOf[IMenu]
  ...
  open class MenuMgr ()
    extends StObject
       with typingsJapgolly.extjs.Ext.menu.MenuMgr
  /* static members */
  object MenuMgr {
