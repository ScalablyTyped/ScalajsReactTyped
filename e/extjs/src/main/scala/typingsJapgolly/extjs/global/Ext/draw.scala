...
object draw {
  ...
  open class Color ()
    extends StObject
       with typingsJapgolly.extjs.Ext.draw.Color
  /* static members */
  object Color {
  ...
  open class Draw ()
    extends StObject
       with typingsJapgolly.extjs.Ext.draw.Draw
  /* static members */
  object Draw {
    ...
    inline def snapEndsByDateAndStep(from: Any, to: Any, step: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("snapEndsByDateAndStep")(from.asInstanceOf[js.Any], to.asInstanceOf[js.Any], step.asInstanceOf[js.Any])).asInstanceOf[Any]
    inline def snapEndsByDateAndStep(from: Any, to: Any, step: typingsJapgolly.extjs.Ext.Array, lockEnds: Boolean): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("snapEndsByDateAndStep")(from.asInstanceOf[js.Any], to.asInstanceOf[js.Any], step.asInstanceOf[js.Any], lockEnds.asInstanceOf[js.Any])).asInstanceOf[Any]
    ...
    inline def snapEndsByDateAndStep(from: Any, to: Unit, step: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("snapEndsByDateAndStep")(from.asInstanceOf[js.Any], to.asInstanceOf[js.Any], step.asInstanceOf[js.Any])).asInstanceOf[Any]
    inline def snapEndsByDateAndStep(from: Any, to: Unit, step: typingsJapgolly.extjs.Ext.Array, lockEnds: Boolean): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("snapEndsByDateAndStep")(from.asInstanceOf[js.Any], to.asInstanceOf[js.Any], step.asInstanceOf[js.Any], lockEnds.asInstanceOf[js.Any])).asInstanceOf[Any]
    ...
    inline def snapEndsByDateAndStep(from: Unit, to: Any, step: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("snapEndsByDateAndStep")(from.asInstanceOf[js.Any], to.asInstanceOf[js.Any], step.asInstanceOf[js.Any])).asInstanceOf[Any]
    inline def snapEndsByDateAndStep(from: Unit, to: Any, step: typingsJapgolly.extjs.Ext.Array, lockEnds: Boolean): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("snapEndsByDateAndStep")(from.asInstanceOf[js.Any], to.asInstanceOf[js.Any], step.asInstanceOf[js.Any], lockEnds.asInstanceOf[js.Any])).asInstanceOf[Any]
    ...
    inline def snapEndsByDateAndStep(from: Unit, to: Unit, step: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("snapEndsByDateAndStep")(from.asInstanceOf[js.Any], to.asInstanceOf[js.Any], step.asInstanceOf[js.Any])).asInstanceOf[Any]
    inline def snapEndsByDateAndStep(from: Unit, to: Unit, step: typingsJapgolly.extjs.Ext.Array, lockEnds: Boolean): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("snapEndsByDateAndStep")(from.asInstanceOf[js.Any], to.asInstanceOf[js.Any], step.asInstanceOf[js.Any], lockEnds.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  open class Surface ()
    extends StObject
       with typingsJapgolly.extjs.Ext.draw.Surface
  /* static members */
  object Surface {
    ...
    inline def create(config: Any, enginePriority: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(config.asInstanceOf[js.Any], enginePriority.asInstanceOf[js.Any])).asInstanceOf[Any]
    inline def create(config: Unit, enginePriority: typingsJapgolly.extjs.Ext.Array): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(config.asInstanceOf[js.Any], enginePriority.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  object engine {
    ...
    open class ImageExporter ()
      extends StObject
         with typingsJapgolly.extjs.Ext.draw.engine.ImageExporter
    /* static members */
    object ImageExporter {
      ...
      @js.native
      def supportedTypes: typingsJapgolly.extjs.Ext.Array = js.native
      inline def supportedTypes_=(x: typingsJapgolly.extjs.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("supportedTypes")(x.asInstanceOf[js.Any])
    ...
    open class SvgExporter ()
      extends StObject
         with typingsJapgolly.extjs.Ext.draw.engine.SvgExporter
    /* static members */
    object SvgExporter {
