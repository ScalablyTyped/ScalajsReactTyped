...
import typingsJapgolly.extjs.Ext.direct.IProvider
...
open class Direct_ ()
  extends StObject
     with typingsJapgolly.extjs.Ext.Direct_
/* static members */
object Direct_ {
  ...
  inline def addProvider(provider: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addProvider")(provider.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /** [Property] (Object) */
  @JSGlobal("Ext.Direct.exceptions")
  @js.native
  def exceptions: Any = js.native
  inline def exceptions_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("exceptions")(x.asInstanceOf[js.Any])
  ...
  inline def getProvider(id: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getProvider")(id.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /** [Property] (Object) */
  @JSGlobal("Ext.Direct.hasListeners")
  @js.native
  ...
  /** [Property] (Boolean) */
  @JSGlobal("Ext.Direct.isObservable")
  @js.native
  ...
  /** [Method] Parses a direct function
    ...
    */
  inline def parseMethod(): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("parseMethod")().asInstanceOf[Any]
  inline def parseMethod(fn: Any): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("parseMethod")(fn.asInstanceOf[js.Any]).asInstanceOf[Any]
  ...
  inline def removeProvider(provider: Any): IProvider = ^.asInstanceOf[js.Dynamic].applyDynamic("removeProvider")(provider.asInstanceOf[js.Any]).asInstanceOf[IProvider]
