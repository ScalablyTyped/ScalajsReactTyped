...
open class FocusManager ()
  extends StObject
     with typingsJapgolly.extjs.Ext.FocusManager
/* static members */
object FocusManager {
  ...
  @js.native
  def whitelist: typingsJapgolly.extjs.Ext.Array = js.native
  inline def whitelist_=(x: typingsJapgolly.extjs.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("whitelist")(x.asInstanceOf[js.Any])
}
