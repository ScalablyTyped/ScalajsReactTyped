...
object form {
  ...
  open class CheckboxManager ()
    extends StObject
       with typingsJapgolly.extjs.Ext.form.CheckboxManager
  /* static members */
  ...
  open class RadioManager ()
    extends StObject
       with typingsJapgolly.extjs.Ext.form.RadioManager
  /* static members */
  object RadioManager {
  ...
  open class VTypes ()
    extends StObject
       with typingsJapgolly.extjs.Ext.form.VTypes
  /* static members */
  object VTypes {
  ...
  object field {
    ...
    open class VTypes ()
      extends StObject
         with typingsJapgolly.extjs.Ext.form.field.VTypes
    /* static members */
    object VTypes {
