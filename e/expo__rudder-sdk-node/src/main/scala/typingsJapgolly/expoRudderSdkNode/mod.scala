...
import typingsJapgolly.expoRudderSdkNode.anon.Batch
import typingsJapgolly.expoRudderSdkNode.anon.Dictkey
import typingsJapgolly.expoRudderSdkNode.anon.Enable
import typingsJapgolly.expoRudderSdkNode.anon.Event
import typingsJapgolly.expoRudderSdkNode.anon.GroupId
import typingsJapgolly.expoRudderSdkNode.anon.Name
import typingsJapgolly.expoRudderSdkNode.anon.PreviousId
import typingsJapgolly.expoRudderSdkNode.anon.Traits
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.expoRudderSdkNode.anon.UserId
    - typingsJapgolly.expoRudderSdkNode.anon.AnonymousId
  */
  trait AnalyticsIdentity extends StObject
  object AnalyticsIdentity {
    
    inline def AnonymousId(anonymousId: String): typingsJapgolly.expoRudderSdkNode.anon.AnonymousId = {
      val __obj = js.Dynamic.literal(anonymousId = anonymousId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.expoRudderSdkNode.anon.AnonymousId]
    }
    
    inline def UserId(userId: String): typingsJapgolly.expoRudderSdkNode.anon.UserId = {
      val __obj = js.Dynamic.literal(userId = userId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.expoRudderSdkNode.anon.UserId]
    }
  }
