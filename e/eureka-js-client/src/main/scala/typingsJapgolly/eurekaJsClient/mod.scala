...
import typingsJapgolly.eurekaJsClient.anon.Debug
import typingsJapgolly.eurekaJsClient.mod.EurekaClient.EurekaConfig
import typingsJapgolly.eurekaJsClient.mod.EurekaClient.EurekaInstanceConfig
import typingsJapgolly.eurekaJsClient.mod.EurekaClient.EurekaMiddlewareConfig
import typingsJapgolly.eurekaJsClient.mod.EurekaClient.EurekaYmlConfig
  ...
  object EurekaClient {
    ...
    */
    ...
    object ActionType {
      ...
      inline def ADDED: typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.ADDED = "ADDED".asInstanceOf[typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.ADDED]
      
      inline def DELETED: typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.DELETED = "DELETED".asInstanceOf[typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.DELETED]
      
      inline def MODIFIED: typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.MODIFIED = "MODIFIED".asInstanceOf[typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.MODIFIED]
    }
    ...
    */
    ...
    object DataCenterName {
      ...
      inline def Amazon: typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.Amazon = "Amazon".asInstanceOf[typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.Amazon]
      
      inline def MyOwn: typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.MyOwn = "MyOwn".asInstanceOf[typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.MyOwn]
      
      inline def Netflix: typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.Netflix = "Netflix".asInstanceOf[typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.Netflix]
    }
    ...
    object EurekaConfig {
      ...
      extension [Self <: EurekaConfig](x: Self) {
        ...
        inline def setRequestMiddleware(value: (/* requestOpts */ Any, /* done */ js.Function1[/* opts */ Any, Unit]) => Callback): Self = StObject.set(x, "requestMiddleware", js.Any.fromFunction2((t0: /* requestOpts */ Any, t1: /* done */ js.Function1[/* opts */ Any, Unit]) => (value(t0, t1)).runNow()))
    ...
    object EurekaMiddlewareConfig {
      ...
      inline def apply(requestMiddleware: (Any, js.Function1[/* opts */ Any, Unit]) => Callback): EurekaMiddlewareConfig = {
        val __obj = js.Dynamic.literal(requestMiddleware = js.Any.fromFunction2((t0: Any, t1: js.Function1[/* opts */ Any, Unit]) => (requestMiddleware(t0, t1)).runNow()))
        __obj.asInstanceOf[EurekaMiddlewareConfig]
      }
      
      extension [Self <: EurekaMiddlewareConfig](x: Self) {
        
        inline def setRequestMiddleware(value: (Any, js.Function1[/* opts */ Any, Unit]) => Callback): Self = StObject.set(x, "requestMiddleware", js.Any.fromFunction2((t0: Any, t1: js.Function1[/* opts */ Any, Unit]) => (value(t0, t1)).runNow()))
      }
    }
    ...
    */
    ...
    object InstanceStatus {
      ...
      inline def DOWN: typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.DOWN = "DOWN".asInstanceOf[typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.DOWN]
      
      inline def OUT_OF_SERVICE: typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.OUT_OF_SERVICE = "OUT_OF_SERVICE".asInstanceOf[typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.OUT_OF_SERVICE]
      
      inline def STARTING: typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.STARTING = "STARTING".asInstanceOf[typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.STARTING]
      
      inline def UNKNOWN: typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.UNKNOWN = "UNKNOWN".asInstanceOf[typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.UNKNOWN]
      
      inline def UP: typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.UP = "UP".asInstanceOf[typingsJapgolly.eurekaJsClient.eurekaJsClientStrings.UP]
    }
