...
object identifyFeatures extends js.Object {
  /**
    ...
    */
  def apply(options: IdentifyFeaturesOptions): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.IdentifyFeatures_ = js.native
  def apply(options: typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.ImageService_): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.IdentifyFeatures_ = js.native
}
