...
object FeatureLayerOptions {
  ...
  def apply(
    ...
    onEachFeature: (/* feature */ js.Any, /* layer */ Layer) => Callback = null,
    pointToLayer: (/* feature */ js.Any, /* latLng */ LatLngExpression) => Callback = null,
    precision: Int | Double = null,
    proxy: String = null,
    renderer: SVG_ | Canvas_ = null,
    simplifyFactor: Int | Double = null,
    style: (/* feature */ js.Any, /* layer */ Layer) => Callback = null,
    ...
    if (onEachFeature != null) __obj.updateDynamic("onEachFeature")(js.Any.fromFunction2((t0: /* feature */ js.Any, t1: /* layer */ typingsJapgolly.leaflet.mod.Layer) => onEachFeature(t0, t1).runNow()))
    if (pointToLayer != null) __obj.updateDynamic("pointToLayer")(js.Any.fromFunction2((t0: /* feature */ js.Any, t1: /* latLng */ typingsJapgolly.leaflet.mod.LatLngExpression) => pointToLayer(t0, t1).runNow()))
    ...
    if (style != null) __obj.updateDynamic("style")(js.Any.fromFunction2((t0: /* feature */ js.Any, t1: /* layer */ typingsJapgolly.leaflet.mod.Layer) => style(t0, t1).runNow()))
