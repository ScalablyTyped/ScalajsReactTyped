...
import typingsJapgolly.esriLeaflet.esriLeafletStrings.client
import typingsJapgolly.esriLeaflet.esriLeafletStrings.server
...
import typingsJapgolly.leaflet.mod.Canvas_
...
import typingsJapgolly.leaflet.mod.SVG_
...
object leafletAugmentingMod {
  ...
  object esri {
    ...
    @js.native
    open class BasemapLayer_ protected () extends TileLayer_ {
    ...
    open class FeatureLayerService_ protected ()
      ...
      def addFeature(feature: Any): this.type = js.native
      def addFeature(feature: Any, callback: Unit, context: Any): this.type = js.native
      def addFeature(feature: Any, callback: ResponseCallbackHandler): this.type = js.native
      def addFeature(feature: Any, callback: ResponseCallbackHandler, context: Any): this.type = js.native
      ...
      def deleteFeature(id: String, callback: Unit, context: Any): this.type = js.native
      def deleteFeature(id: String, callback: ResponseCallbackHandler): this.type = js.native
      def deleteFeature(id: String, callback: ResponseCallbackHandler, context: Any): this.type = js.native
      def deleteFeature(id: Double): this.type = js.native
      def deleteFeature(id: Double, callback: Unit, context: Any): this.type = js.native
      def deleteFeature(id: Double, callback: ResponseCallbackHandler): this.type = js.native
      def deleteFeature(id: Double, callback: ResponseCallbackHandler, context: Any): this.type = js.native
      ...
      def deleteFeatures(ids: js.Array[Double | String], callback: Unit, context: Any): this.type = js.native
      def deleteFeatures(ids: js.Array[Double | String], callback: ResponseCallbackHandler): this.type = js.native
      def deleteFeatures(ids: js.Array[Double | String], callback: ResponseCallbackHandler, context: Any): this.type = js.native
      ...
      /**
        ...
        */
      // TODO: GeoJSONFeature<GeoJSON.GeometryObject>
      def updateFeature(feature: Any): this.type = js.native
      def updateFeature(feature: Any, callback: Unit, context: Any): this.type = js.native
      def updateFeature(feature: Any, callback: ResponseCallbackHandler): this.type = js.native
      def updateFeature(feature: Any, callback: ResponseCallbackHandler, context: Any): this.type = js.native
    }
    ...
    @js.native
    open class FeatureLayer_ protected () extends Layer {
      ...
      /**
        ...
        */
      def eachActiveFeature(fn: js.Function1[/* feature */ Any, Unit]): this.type = js.native
      def eachActiveFeature(fn: js.Function1[/* feature */ Any, Unit], context: Any): this.type = js.native
      ...
      /**
        ...
        */
      def eachFeature(fn: js.Function1[/* feature */ Any, Unit]): this.type = js.native
      def eachFeature(fn: js.Function1[/* feature */ Any, Unit], context: Any): this.type = js.native
      ...
      def metadata(callback: CallbackHandler, context: Any): this.type = js.native
      ...
      def setTimeRange(from: js.Date, to: js.Date, callback: Unit, context: Any): this.type = js.native
      def setTimeRange(from: js.Date, to: js.Date, callback: FeatureCallbackHandler): this.type = js.native
      def setTimeRange(from: js.Date, to: js.Date, callback: FeatureCallbackHandler, context: Any): this.type = js.native
      ...
      def setWhere(where: String, callback: Unit, context: Any): this.type = js.native
      def setWhere(where: String, callback: FeatureCallbackHandler): this.type = js.native
      def setWhere(where: String, callback: FeatureCallbackHandler, context: Any): this.type = js.native
    ...
    open class Find_ protected ()
      ...
      /**
        ...
        * service.
        */
      def dynamicLayers(dynamicLayers: Any): this.type = js.native
      ...
      def run(callback: FeatureCallbackHandler, context: Any): this.type = js.native
    ...
    open class Query_ protected ()
      ...
      def bounds(callback: FeatureCallbackHandler, context: Any): this.type = js.native
      ...
      def count(callback: FeatureCallbackHandler, context: Any): this.type = js.native
      ...
      /**
        ...
        */
      def featureIds(ids: js.Array[Any]): this.type = js.native
      ...
      def ids(callback: FeatureCallbackHandler, context: Any): this.type = js.native
    ...
    open class Service () extends Evented {
      ...
      def get(url: String, params: Any): this.type = js.native
      def get(url: String, params: Any, callback: Unit, context: Any): this.type = js.native
      def get(url: String, params: Any, callback: CallbackHandler): this.type = js.native
      def get(url: String, params: Any, callback: CallbackHandler, context: Any): this.type = js.native
      def get(url: String, params: Unit, callback: Unit, context: Any): this.type = js.native
      def get(url: String, params: Unit, callback: CallbackHandler): this.type = js.native
      def get(url: String, params: Unit, callback: CallbackHandler, context: Any): this.type = js.native
      ...
      def post(url: String, params: Any): this.type = js.native
      def post(url: String, params: Any, callback: Unit, context: Any): this.type = js.native
      def post(url: String, params: Any, callback: CallbackHandler): this.type = js.native
      def post(url: String, params: Any, callback: CallbackHandler, context: Any): this.type = js.native
      def post(url: String, params: Unit, callback: Unit, context: Any): this.type = js.native
      def post(url: String, params: Unit, callback: CallbackHandler): this.type = js.native
      def post(url: String, params: Unit, callback: CallbackHandler, context: Any): this.type = js.native
    }
    ...
    @js.native
    open class Task_ protected () extends Class {
      ...
      def request(url: String, params: Any): this.type = js.native
      def request(url: String, params: Any, callback: Any): this.type = js.native
      def request(url: String, params: Any, callback: Any, context: Any): this.type = js.native
      def request(url: String, params: Any, callback: Unit, context: Any): this.type = js.native
      def request(url: String, params: Unit, callback: Any): this.type = js.native
      def request(url: String, params: Unit, callback: Any, context: Any): this.type = js.native
      def request(url: String, params: Unit, callback: Unit, context: Any): this.type = js.native
    ...
    @js.native
    open class TiledMapLayer_ protected () extends TileLayer_ {
    ...
    /**
      ...
      * The Terms of Use for Esri hosted services apply to all Leaflet applications.
      */
    inline def basemapLayer(key: Basemaps): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.BasemapLayer_ = ^.asInstanceOf[js.Dynamic].applyDynamic("basemapLayer")(key.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.BasemapLayer_]
    inline def basemapLayer(key: Basemaps, options: BasemapLayerOptions): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.BasemapLayer_ = (^.asInstanceOf[js.Dynamic].applyDynamic("basemapLayer")(key.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.BasemapLayer_]
    ...
    /**
      ...
      * identifying individual features.
      */
    inline def dynamicMapLayer(options: DynamicMapLayerOptions): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.DynamicMapLayer_ = ^.asInstanceOf[js.Dynamic].applyDynamic("dynamicMapLayer")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.DynamicMapLayer_]
    ...
    /**
      ...
      * JavaScript.
      */
    inline def featureLayer(options: FeatureLayerOptions): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.FeatureLayer_ = ^.asInstanceOf[js.Dynamic].applyDynamic("featureLayer")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.FeatureLayer_]
    ...
    /**
      ...
      * features from the service.
      */
    inline def featureLayerService(options: FeatureLayerServiceOptions): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.FeatureLayerService_ = ^.asInstanceOf[js.Dynamic].applyDynamic("featureLayerService")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.FeatureLayerService_]
    
    /**
      * L.esri.Find is an abstraction for the find API included in Map Services. It provides a chainable API for
      * building request parameters and executing find tasks.
      */
    inline def find(options: FindOptions): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.Find_ = ^.asInstanceOf[js.Dynamic].applyDynamic("find")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.Find_]
    inline def find(options: typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.MapService_): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.Find_ = ^.asInstanceOf[js.Dynamic].applyDynamic("find")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.Find_]
    
    /**
      * `L.esri.IdentifyFeatures` is an abstraction for the Identify API found in Map Services. It provides a
      * chainable API for building request parameters and executing the request.
      */
    inline def identifyFeatures(options: IdentifyFeaturesOptions): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.IdentifyFeatures_ = ^.asInstanceOf[js.Dynamic].applyDynamic("identifyFeatures")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.IdentifyFeatures_]
    inline def identifyFeatures(options: typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.ImageService_): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.IdentifyFeatures_ = ^.asInstanceOf[js.Dynamic].applyDynamic("identifyFeatures")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.IdentifyFeatures_]
    ...
    /**
      ...
      * service.
      */
    inline def imageService(options: ImageServiceOptions): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.ImageService_ = ^.asInstanceOf[js.Dynamic].applyDynamic("imageService")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.ImageService_]
    
    /**
      * `L.esri.MapService` is an abstraction for interacting with Map Services running on ArcGIS Online and ArcGIS
      * Server that allows you to make requests to the API, as well as query and identify published features.
      */
    inline def mapService(options: MapServiceOptions): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.MapService_ = ^.asInstanceOf[js.Dynamic].applyDynamic("mapService")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.MapService_]
    ...
    /**
      ...
      * version of ArcGIS Server that hosts the service some of these options may not be available.
      */
    inline def query(options: QueryOptions): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.Query_ = ^.asInstanceOf[js.Dynamic].applyDynamic("query")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.Query_]
    
    inline def task(options: typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.Service): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.Task_ = ^.asInstanceOf[js.Dynamic].applyDynamic("task")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.Task_]
    /**
      * `L.esri.Task` is a generic class that provides the foundation for calling operations on ArcGIS Online and
      * ArcGIS Server Services like query, find and identify.
      */
    inline def task(options: TaskOptions): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.Task_ = ^.asInstanceOf[js.Dynamic].applyDynamic("task")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.Task_]
    
    /**
      * Access tiles from ArcGIS Online and ArcGIS Server to visualize and identify features. Copyright text from the
      * service is added to map attribution automatically.
      */
    inline def tiledMapLayer(options: TiledMapLayerOptions): typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.TiledMapLayer_ = ^.asInstanceOf[js.Dynamic].applyDynamic("tiledMapLayer")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.esriLeaflet.mod.leafletAugmentingMod.esri.TiledMapLayer_]
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.Streets
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.Topographic
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.NationalGeographic
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.Oceans
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.Gray
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.DarkGray
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.Imagery
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.ShadedRelief
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.Terrain
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.USATopo
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.OceansLabels
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.GrayLabels
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.DarkGrayLabels
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.ImageryLabels
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.ImageryClarity
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.ImageryTransportation
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.ShadedReliefLabels
      - typingsJapgolly.esriLeaflet.esriLeafletStrings.TerrainLabels
    */
    trait Basemaps extends StObject
    object Basemaps {
      
      inline def DarkGray: typingsJapgolly.esriLeaflet.esriLeafletStrings.DarkGray = "DarkGray".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.DarkGray]
      
      inline def DarkGrayLabels: typingsJapgolly.esriLeaflet.esriLeafletStrings.DarkGrayLabels = "DarkGrayLabels".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.DarkGrayLabels]
      
      inline def Gray: typingsJapgolly.esriLeaflet.esriLeafletStrings.Gray = "Gray".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.Gray]
      
      inline def GrayLabels: typingsJapgolly.esriLeaflet.esriLeafletStrings.GrayLabels = "GrayLabels".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.GrayLabels]
      
      inline def Imagery: typingsJapgolly.esriLeaflet.esriLeafletStrings.Imagery = "Imagery".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.Imagery]
      
      inline def ImageryClarity: typingsJapgolly.esriLeaflet.esriLeafletStrings.ImageryClarity = "ImageryClarity".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.ImageryClarity]
      
      inline def ImageryLabels: typingsJapgolly.esriLeaflet.esriLeafletStrings.ImageryLabels = "ImageryLabels".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.ImageryLabels]
      
      inline def ImageryTransportation: typingsJapgolly.esriLeaflet.esriLeafletStrings.ImageryTransportation = "ImageryTransportation".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.ImageryTransportation]
      
      inline def NationalGeographic: typingsJapgolly.esriLeaflet.esriLeafletStrings.NationalGeographic = "NationalGeographic".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.NationalGeographic]
      
      inline def Oceans: typingsJapgolly.esriLeaflet.esriLeafletStrings.Oceans = "Oceans".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.Oceans]
      
      inline def OceansLabels: typingsJapgolly.esriLeaflet.esriLeafletStrings.OceansLabels = "OceansLabels".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.OceansLabels]
      
      inline def ShadedRelief: typingsJapgolly.esriLeaflet.esriLeafletStrings.ShadedRelief = "ShadedRelief".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.ShadedRelief]
      
      inline def ShadedReliefLabels: typingsJapgolly.esriLeaflet.esriLeafletStrings.ShadedReliefLabels = "ShadedReliefLabels".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.ShadedReliefLabels]
      
      inline def Streets: typingsJapgolly.esriLeaflet.esriLeafletStrings.Streets = "Streets".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.Streets]
      
      inline def Terrain: typingsJapgolly.esriLeaflet.esriLeafletStrings.Terrain = "Terrain".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.Terrain]
      
      inline def TerrainLabels: typingsJapgolly.esriLeaflet.esriLeafletStrings.TerrainLabels = "TerrainLabels".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.TerrainLabels]
      
      inline def Topographic: typingsJapgolly.esriLeaflet.esriLeafletStrings.Topographic = "Topographic".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.Topographic]
      
      inline def USATopo: typingsJapgolly.esriLeaflet.esriLeafletStrings.USATopo = "USATopo".asInstanceOf[typingsJapgolly.esriLeaflet.esriLeafletStrings.USATopo]
    }
    
    type CallbackHandler = js.Function2[/* error */ Any, /* metadata */ Any, Unit]
    ...
    trait DynamicMapLayerOptions
      ...
      /**
        ...
        */
      var dynamicLayers: js.UndefOr[Any] = js.undefined
      ...
      /**
        ...
        */
      var layerDefs: js.UndefOr[Any] = js.undefined
      
      /**
        * An array of Layer IDs like [3,4,5] to show from the service.
        */
      var layers: js.UndefOr[js.Array[Any]] = js.undefined
    ...
    object DynamicMapLayerOptions {
      ...
      extension [Self <: DynamicMapLayerOptions](x: Self) {
        ...
        inline def setDynamicLayers(value: Any): Self = StObject.set(x, "dynamicLayers", value.asInstanceOf[js.Any])
        ...
        inline def setLayerDefs(value: Any): Self = StObject.set(x, "layerDefs", value.asInstanceOf[js.Any])
    ...
    type FeatureCallbackHandler = js.Function3[
        ...
        /* featureCollection */ js.UndefOr[Any], 
    ...
    trait FeatureLayerOptions
      ...
      /**
        ...
        */
      var onEachFeature: js.UndefOr[js.Function2[/* feature */ Any, /* layer */ Layer, Unit]] = js.undefined
      ...
      /**
        ...
        */
      var pointToLayer: js.UndefOr[js.Function2[/* feature */ Any, /* latLng */ LatLngExpression, Unit]] = js.undefined
      ...
      /**
        ...
        */
      var style: js.UndefOr[js.Function2[/* feature */ Any, /* layer */ Layer, Unit]] = js.undefined
      ...
      /**
        ...
        */
      var timeField: js.UndefOr[Any] = js.undefined
    ...
    object FeatureLayerOptions {
      ...
      extension [Self <: FeatureLayerOptions](x: Self) {
        ...
        inline def setOnEachFeature(value: (/* feature */ Any, /* layer */ Layer) => Callback): Self = StObject.set(x, "onEachFeature", js.Any.fromFunction2((t0: /* feature */ Any, t1: /* layer */ Layer) => (value(t0, t1)).runNow()))
        
        inline def setOnEachFeatureUndefined: Self = StObject.set(x, "onEachFeature", js.undefined)
        
        inline def setPointToLayer(value: (/* feature */ Any, /* latLng */ LatLngExpression) => Callback): Self = StObject.set(x, "pointToLayer", js.Any.fromFunction2((t0: /* feature */ Any, t1: /* latLng */ LatLngExpression) => (value(t0, t1)).runNow()))
        ...
        inline def setStyle(value: (/* feature */ Any, /* layer */ Layer) => Callback): Self = StObject.set(x, "style", js.Any.fromFunction2((t0: /* feature */ Any, t1: /* layer */ Layer) => (value(t0, t1)).runNow()))
        
        inline def setStyleUndefined: Self = StObject.set(x, "style", js.undefined)
        
        inline def setTimeField(value: Any): Self = StObject.set(x, "timeField", value.asInstanceOf[js.Any])
    ...
    type ResponseCallbackHandler = js.Function2[/* error */ js.UndefOr[Any], /* response */ js.UndefOr[Any], Unit]
    ...
    type StyleCallback = js.Function1[/* feature */ Any, Any]
