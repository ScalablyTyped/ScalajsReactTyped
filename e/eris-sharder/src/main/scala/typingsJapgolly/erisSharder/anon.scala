...
object anon {
  ...
  object Broadcast {
    ...
    inline def apply(
      ...
      register: (String, js.Function0[Any]) => Callback,
      sendTo: (Double, String, Any) => Callback,
      unregister: String => Callback
    ): Broadcast = {
      val __obj = js.Dynamic.literal(broadcast = js.Any.fromFunction2((t0: String, t1: Any) => (broadcast(t0, t1)).runNow()), fetchChannel = js.Any.fromFunction1(fetchChannel), fetchGuild = js.Any.fromFunction1(fetchGuild), fetchUser = js.Any.fromFunction1(fetchUser), register = js.Any.fromFunction2((t0: String, t1: js.Function0[Any]) => (register(t0, t1)).runNow()), sendTo = js.Any.fromFunction3((t0: Double, t1: String, t2: Any) => (sendTo(t0, t1, t2)).runNow()), unregister = js.Any.fromFunction1((t0: String) => unregister(t0).runNow()))
    ...
    extension [Self <: Broadcast](x: Self) {
      ...
      inline def setRegister(value: (String, js.Function0[Any]) => Callback): Self = StObject.set(x, "register", js.Any.fromFunction2((t0: String, t1: js.Function0[Any]) => (value(t0, t1)).runNow()))
      
      inline def setSendTo(value: (Double, String, Any) => Callback): Self = StObject.set(x, "sendTo", js.Any.fromFunction3((t0: Double, t1: String, t2: Any) => (value(t0, t1, t2)).runNow()))
