...
import typingsJapgolly.easyXapiSupertest.anon.Dotfiles
import typingsJapgolly.easyXapiSupertest.httpMod.Server
import typingsJapgolly.easyXapiSupertest.httpMod.ServerRequest
...
object expressMod {
  ...
  inline def apply(): typingsJapgolly.easyXapiSupertest.expressMod.Express = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.easyXapiSupertest.expressMod.Express]
  ...
  trait Application
    extends IRouter[Application]
       with typingsJapgolly.easyXapiSupertest.Express.Application {
  ...
  trait Request
    extends ServerRequest
       with typingsJapgolly.easyXapiSupertest.Express.Request {
