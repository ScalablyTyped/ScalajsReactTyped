...
object TlsOptions {
  ...
  def apply(
    ...
    SNICallback: /* servername */ String => CallbackTo[js.Any] = null,
    ca: js.Any = null,
    cert: js.Any = null,
    ciphers: String = null,
    crl: js.Any = null,
    ...
    if (SNICallback != null) __obj.updateDynamic("SNICallback")(js.Any.fromFunction1((t0: /* servername */ java.lang.String) => SNICallback(t0).runNow()))
