...
trait NodeBuffer extends /* index */ NumberDictionary[Double] {
  ...
  def compare(otherBuffer: typingsJapgolly.node.Buffer): Double = js.native
  def copy(targetBuffer: typingsJapgolly.node.Buffer): Double = js.native
  def copy(targetBuffer: typingsJapgolly.node.Buffer, targetStart: Double): Double = js.native
  def copy(targetBuffer: typingsJapgolly.node.Buffer, targetStart: Double, sourceStart: Double): Double = js.native
  def copy(
    targetBuffer: typingsJapgolly.node.Buffer,
    targetStart: Double,
    sourceStart: Double,
    sourceEnd: Double
  ): Double = js.native
  def equals(otherBuffer: typingsJapgolly.node.Buffer): Boolean = js.native
  ...
  def slice(): typingsJapgolly.node.Buffer = js.native
  def slice(start: Double): typingsJapgolly.node.Buffer = js.native
  def slice(start: Double, end: Double): typingsJapgolly.node.Buffer = js.native
