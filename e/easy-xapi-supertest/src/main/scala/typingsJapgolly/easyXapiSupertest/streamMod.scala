...
import typingsJapgolly.easyXapiSupertest.NodeJS.ReadWriteStream
...
import typingsJapgolly.easyXapiSupertest.anon.End
...
object streamMod {
  ...
  - typingsJapgolly.easyXapiSupertest.NodeJS.EventEmitter because Already inherited
  - typingsJapgolly.easyXapiSupertest.NodeJS.ReadableStream because Already inherited
  - typingsJapgolly.easyXapiSupertest.NodeJS.ReadWriteStream because var conflicts: readable. Inlined  */ @JSImport("stream", "Duplex")
  @js.native
  open class Duplex ()
    extends Readable
       with WritableStream {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.easyXapiSupertest.streamMod.WritableOptions because var conflicts: highWaterMark. Inlined decodeStrings */ trait DuplexOptions
    extends StObject
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.easyXapiSupertest.streamMod.WritableOptions because var conflicts: highWaterMark. Inlined decodeStrings */ trait TransformOptions
    extends StObject
       with ReadableOptions {
