...
import typingsJapgolly.ethereumjsBlockchain.anon.Genesis
import typingsJapgolly.ethereumjsBlockchain.anon.Key
...
object mod {
  ...
  trait Blockchain
    ...
    var dbManager: typingsJapgolly.ethereumjsBlockchain.distDbManagerMod.default = js.native
