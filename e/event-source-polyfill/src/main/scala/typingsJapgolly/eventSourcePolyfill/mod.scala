...
import typingsJapgolly.eventSourcePolyfill.eventSourcePolyfillStrings.error
import typingsJapgolly.eventSourcePolyfill.eventSourcePolyfillStrings.message
import typingsJapgolly.eventSourcePolyfill.eventSourcePolyfillStrings.open
...
object mod {
  ...
  open class EventSourcePolyfill protected () extends StObject {
    ...
    def addEventListener_error(
      `type`: error,
      listener: js.ThisFunction1[/* this */ org.scalajs.dom.EventSource, /* ev */ Event, Any]
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_error(
      `type`: error,
    ...
    def addEventListener_message(
      `type`: message,
      listener: js.ThisFunction1[/* this */ org.scalajs.dom.EventSource, /* ev */ MessageEvent, Any]
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_message(
      `type`: message,
    ...
    var onerror: (js.ThisFunction1[/* this */ org.scalajs.dom.EventSource, /* ev */ Event, Any]) | Null = js.native
    
    var onmessage: (js.ThisFunction1[/* this */ org.scalajs.dom.EventSource, /* ev */ MessageEvent, Any]) | Null = js.native
    
    var onopen: (js.ThisFunction1[/* this */ org.scalajs.dom.EventSource, /* ev */ Event, Any]) | Null = js.native
  ...
  object EventListenerObject {
    ...
    inline def apply(handleEvent: Event => Callback): EventListenerObject = {
      val __obj = js.Dynamic.literal(handleEvent = js.Any.fromFunction1((t0: Event) => handleEvent(t0).runNow()))
  ...
  trait EventSourceConstructor
    extends StObject
       with Instantiable1[/* url */ String, org.scalajs.dom.EventSource]
       with Instantiable2[
          /* url */ String, 
          /* eventSourceInitDict */ EventSourceInit, 
          org.scalajs.dom.EventSource
        ] {
