...
import typingsJapgolly.exif.anon.ApertureValue
import typingsJapgolly.exif.anon.Artist
import typingsJapgolly.exif.anon.AutoBracketing
import typingsJapgolly.exif.anon.Compression
import typingsJapgolly.exif.anon.GPSAltitude
import typingsJapgolly.exif.anon.InteropIndex
