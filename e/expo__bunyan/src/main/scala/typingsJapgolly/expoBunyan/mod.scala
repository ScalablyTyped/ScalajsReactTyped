...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.expoBunyan.expoBunyanStrings.trace
    - typingsJapgolly.expoBunyan.expoBunyanStrings.debug
    - typingsJapgolly.expoBunyan.expoBunyanStrings.info
    - typingsJapgolly.expoBunyan.expoBunyanStrings.warn
    - typingsJapgolly.expoBunyan.expoBunyanStrings.error
    - typingsJapgolly.expoBunyan.expoBunyanStrings.fatal
  */
  trait LogLevelString extends StObject
  object LogLevelString {
    
    inline def debug: typingsJapgolly.expoBunyan.expoBunyanStrings.debug = "debug".asInstanceOf[typingsJapgolly.expoBunyan.expoBunyanStrings.debug]
    
    inline def error: typingsJapgolly.expoBunyan.expoBunyanStrings.error = "error".asInstanceOf[typingsJapgolly.expoBunyan.expoBunyanStrings.error]
    
    inline def fatal: typingsJapgolly.expoBunyan.expoBunyanStrings.fatal = "fatal".asInstanceOf[typingsJapgolly.expoBunyan.expoBunyanStrings.fatal]
    
    inline def info: typingsJapgolly.expoBunyan.expoBunyanStrings.info = "info".asInstanceOf[typingsJapgolly.expoBunyan.expoBunyanStrings.info]
    
    inline def trace: typingsJapgolly.expoBunyan.expoBunyanStrings.trace = "trace".asInstanceOf[typingsJapgolly.expoBunyan.expoBunyanStrings.trace]
    
    inline def warn: typingsJapgolly.expoBunyan.expoBunyanStrings.warn = "warn".asInstanceOf[typingsJapgolly.expoBunyan.expoBunyanStrings.warn]
  }
