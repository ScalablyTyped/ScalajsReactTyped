package typingsJapgolly.expressFlashNotification
  ...
  object efnOptions {
    ...
    extension [Self <: efnOptions](x: Self) {
      ...
      inline def setAfterAllRender(
        value: (/* htmlFragments */ js.Array[String], /* callback */ js.Function2[/* err */ Any, /* html */ String, Unit]) => Callback
      ): Self = StObject.set(x, "afterAllRender", js.Any.fromFunction2((t0: /* htmlFragments */ js.Array[String], t1: /* callback */ js.Function2[/* err */ Any, /* html */ String, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setAfterAllRenderUndefined: Self = StObject.set(x, "afterAllRender", js.undefined)
      
      inline def setBeforeSingleRender(
        value: (/* item */ Any, /* callback */ js.Function2[/* err */ Any, /* item */ Any, Unit]) => Callback
      ): Self = StObject.set(x, "beforeSingleRender", js.Any.fromFunction2((t0: /* item */ Any, t1: /* callback */ js.Function2[/* err */ Any, /* item */ Any, Unit]) => (value(t0, t1)).runNow()))
