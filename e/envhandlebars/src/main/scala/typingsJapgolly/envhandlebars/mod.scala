package typingsJapgolly.envhandlebars

import japgolly.scalajs.react.Callback
import typingsJapgolly.envhandlebars.anon.TypeofH
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setExtendHandlebars(value: /* Handlebars */ TypeofH => Callback): Self = StObject.set(x, "extendHandlebars", js.Any.fromFunction1((t0: /* Handlebars */ TypeofH) => value(t0).runNow()))
