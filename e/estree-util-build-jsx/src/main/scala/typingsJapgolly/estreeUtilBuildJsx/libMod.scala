...
import typingsJapgolly.estreeUtilBuildJsx.estreeUtilBuildJsxStrings.automatic
import typingsJapgolly.estreeUtilBuildJsx.estreeUtilBuildJsxStrings.classic
...
object libMod {
  ...
  inline def buildJsx[T /* <: typingsJapgolly.estree.mod.Node */](tree: T, options: Options): T = (^.asInstanceOf[js.Dynamic].applyDynamic("buildJsx")(tree.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  type JSXAttribute = typingsJapgolly.estreeJsx.mod.JSXAttribute
  
  type JSXElement = typingsJapgolly.estreeJsx.mod.JSXElement
  ...
  type JSXExpressionContainer = typingsJapgolly.estreeJsx.mod.JSXExpressionContainer
  
  type JSXFragment = typingsJapgolly.estreeJsx.mod.JSXFragment
  ...
  type JSXSpreadAttribute = typingsJapgolly.estreeJsx.mod.JSXSpreadAttribute
  ...
  type JSXText = typingsJapgolly.estreeJsx.mod.JSXText
  ...
  type SyncHandler = typingsJapgolly.estreeWalker.mod.SyncHandler
}
