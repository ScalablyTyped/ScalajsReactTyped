...
object SetOptions {
  ...
  def apply(
    ...
    parseInputDate: /* inputDate */ String => CallbackTo[Moment] = null,
    ...
    if (parseInputDate != null) __obj.updateDynamic("parseInputDate")(js.Any.fromFunction1((t0: /* inputDate */ java.lang.String) => parseInputDate(t0).runNow()))
