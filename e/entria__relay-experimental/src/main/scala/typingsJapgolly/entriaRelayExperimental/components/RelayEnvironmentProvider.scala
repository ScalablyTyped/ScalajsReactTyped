package typingsJapgolly.entriaRelayExperimental.components
...
object RelayEnvironmentProvider {
  ...
  typingsJapgolly.entriaRelayExperimental.relayEnvironmentProviderMod.Props, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.entriaRelayExperimental.relayEnvironmentProviderMod.Props])(children: _*)
  }
