...
object Emoji {
  ...
  inline def apply(emoji: String | EmojiData, size: Double): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def fallback(value: (/* emoji */ EmojiData, EmojiProps) => (Component[js.Object, js.Object]) | Element): this.type = set("fallback", js.Any.fromFunction2(value))
