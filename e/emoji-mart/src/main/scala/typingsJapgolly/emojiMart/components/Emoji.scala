...
object Emoji {
  def apply(
    ...
    EmojiProps, 
    MountedWithRawType[EmojiProps, js.Object, RawMounted[EmojiProps, js.Object]]
  ] = {
  ...
  typingsJapgolly.emojiMart.sharedPropsMod.EmojiProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.emojiMart.sharedPropsMod.EmojiProps])(children: _*)
  }
