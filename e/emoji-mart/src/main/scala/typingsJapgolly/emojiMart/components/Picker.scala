...
import typingsJapgolly.emojiMart.pickerMod.default
...
object Picker {
  ...
  typingsJapgolly.emojiMart.sharedPropsMod.PickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.emojiMart.pickerMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.emojiMart.sharedPropsMod.PickerProps])(children: _*)
  }
