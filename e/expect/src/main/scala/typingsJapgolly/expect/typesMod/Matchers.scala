...
trait Matchers[R] extends js.Object {
  ...
  {[ P in keyof R ]: unknown}
    */ typingsJapgolly.expect.expectStrings.Matchers with js.Any */](propertyMatchers: Partial[T]): R = js.native
  def toMatchInlineSnapshot[T /* <: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof R ]: unknown}
    */ typingsJapgolly.expect.expectStrings.Matchers with js.Any */](propertyMatchers: Partial[T], snapshot: String): R = js.native
  ...
  def toMatchSnapshot[T /* <: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof R ]: unknown}
    */ typingsJapgolly.expect.expectStrings.Matchers with js.Any */](propertyMatchers: Partial[T], snapshotName: String): R = js.native
  /**
