...
import typingsJapgolly.expressBrute.anon.Reset
    ...
    extension [Self <: Middleware](x: Self) {
      ...
      inline def setFailCallback(
        value: (/* req */ Request_[
              ...
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], /* res */ Response_[Any, Record[String, Any]], /* next */ NextFunction, /* nextValidRequestDate */ js.Date) => Callback
      ): Self = StObject.set(x, "failCallback", js.Any.fromFunction4((t0: /* req */ Request_[
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.ParamsDictionary */ Any, 
              Any, 
              Any, 
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], t1: /* res */ Response_[Any, Record[String, Any]], t2: /* next */ NextFunction, t3: /* nextValidRequestDate */ js.Date) => (value(t0, t1, t2, t3)).runNow()))
