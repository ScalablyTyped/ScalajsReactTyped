...
object buildMiddlewareClientLogsMiddlewareMod {
  ...
  inline def default(logger: typingsJapgolly.expoBunyan.mod.^): HandleFunction = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(logger.asInstanceOf[js.Any]).asInstanceOf[HandleFunction]
