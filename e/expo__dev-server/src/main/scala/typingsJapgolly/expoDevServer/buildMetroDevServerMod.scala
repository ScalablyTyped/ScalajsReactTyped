...
import typingsJapgolly.expoDevServer.anon.InspectorProxy
import typingsJapgolly.expoDevServer.anon.Logger
import typingsJapgolly.expoDevServer.anon.Middleware
import typingsJapgolly.expoDevServer.buildJsInspectorMod.MetroInspectorProxyApp
import typingsJapgolly.expoDevServer.buildLogReporterMod.default
import typingsJapgolly.expoDevServer.expoDevServerStrings.android
import typingsJapgolly.expoDevServer.expoDevServerStrings.ios
import typingsJapgolly.expoDevServer.expoDevServerStrings.web
...
object buildMetroDevServerMod {
  ...
  open class LogReporter protected () extends default {
    def this(logger: typingsJapgolly.expoBunyan.mod.^) = this()
    def this(logger: typingsJapgolly.expoBunyan.mod.^, reportEvent: js.Function1[/* event */ Any, Unit]) = this()
  }
  ...
  inline def runMetroDevServerAsync(projectRoot: String, options: MetroDevServerOptions): js.Promise[typingsJapgolly.expoDevServer.anon.MessageSocket] = (^.asInstanceOf[js.Dynamic].applyDynamic("runMetroDevServerAsync")(projectRoot.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.expoDevServer.anon.MessageSocket]]
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify LoadOptions * / any */ trait MetroDevServerOptions extends StObject {
    ...
    var logger: typingsJapgolly.expoBunyan.mod.^
  ...
  object MetroDevServerOptions {
    ...
    inline def apply(logger: typingsJapgolly.expoBunyan.mod.^): MetroDevServerOptions = {
    ...
    extension [Self <: MetroDevServerOptions](x: Self) {
      ...
      inline def setLogger(value: typingsJapgolly.expoBunyan.mod.^): Self = StObject.set(x, "logger", value.asInstanceOf[js.Any])
