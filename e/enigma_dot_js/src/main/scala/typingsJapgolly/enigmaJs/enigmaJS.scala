...
import typingsJapgolly.enigmaJs.anon.Api
import typingsJapgolly.enigmaJs.enigmaJsStrings.changed
import typingsJapgolly.enigmaJs.enigmaJsStrings.closed
import typingsJapgolly.enigmaJs.enigmaJsStrings.opened
import typingsJapgolly.enigmaJs.enigmaJsStrings.resumed
import typingsJapgolly.enigmaJs.enigmaJsStrings.suspended
...
object enigmaJS {
  ...
  object IGeneratedAPI {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(emit = js.Any.fromFunction1((t0: changed | closed) => emit(t0).runNow()), genericType = genericType.asInstanceOf[js.Any], handle = handle.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], on = js.Any.fromFunction2((t0: changed | closed, t1: js.Function0[Unit]) => (on(t0, t1)).runNow()), session = session.asInstanceOf[js.Any])
  ...
  object IMixin {
    ...
    inline def apply(init: Api => Callback, types: js.Array[MixinType]): IMixin = {
      val __obj = js.Dynamic.literal(init = js.Any.fromFunction1((t0: Api) => init(t0).runNow()), types = types.asInstanceOf[js.Any])
    ...
    extension [Self <: IMixin](x: Self) {
      ...
      inline def setInit(value: Api => Callback): Self = StObject.set(x, "init", js.Any.fromFunction1((t0: Api) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.enigmaJs.enigmaJsStrings.Doc
    - typingsJapgolly.enigmaJs.enigmaJsStrings.GenericObject
    - typingsJapgolly.enigmaJs.enigmaJsStrings.GenericBookmark
    - java.lang.String
  */
