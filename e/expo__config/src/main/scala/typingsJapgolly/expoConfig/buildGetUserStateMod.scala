...
object buildGetUserStateMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.expoConfig.expoConfigStrings.`Access-Token-Authentication`
    - typingsJapgolly.expoConfig.expoConfigStrings.`Username-Password-Authentication`
    - typingsJapgolly.expoConfig.expoConfigStrings.facebook
    - typingsJapgolly.expoConfig.expoConfigStrings.`google-oauth2`
    - typingsJapgolly.expoConfig.expoConfigStrings.github
  */
  trait ConnectionType extends StObject
  object ConnectionType {
    
    inline def `Access-Token-Authentication`: typingsJapgolly.expoConfig.expoConfigStrings.`Access-Token-Authentication` = "Access-Token-Authentication".asInstanceOf[typingsJapgolly.expoConfig.expoConfigStrings.`Access-Token-Authentication`]
    
    inline def `Username-Password-Authentication`: typingsJapgolly.expoConfig.expoConfigStrings.`Username-Password-Authentication` = "Username-Password-Authentication".asInstanceOf[typingsJapgolly.expoConfig.expoConfigStrings.`Username-Password-Authentication`]
    
    inline def facebook: typingsJapgolly.expoConfig.expoConfigStrings.facebook = "facebook".asInstanceOf[typingsJapgolly.expoConfig.expoConfigStrings.facebook]
    
    inline def github: typingsJapgolly.expoConfig.expoConfigStrings.github = "github".asInstanceOf[typingsJapgolly.expoConfig.expoConfigStrings.github]
    
    inline def `google-oauth2`: typingsJapgolly.expoConfig.expoConfigStrings.`google-oauth2` = "google-oauth2".asInstanceOf[typingsJapgolly.expoConfig.expoConfigStrings.`google-oauth2`]
  }
