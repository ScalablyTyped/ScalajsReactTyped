...
import typingsJapgolly.expoConfig.anon.AndroidManifestPath
import typingsJapgolly.expoConfig.anon.ProjectRoot
import typingsJapgolly.expoConfig.expoConfigStrings.`React Native packager is running`
