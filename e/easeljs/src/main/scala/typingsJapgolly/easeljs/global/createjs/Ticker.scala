...
import typingsJapgolly.easeljs.anon.HandleEvent
import typingsJapgolly.easeljs.anon.`0`
...
open class Ticker ()
  extends StObject
     with typingsJapgolly.easeljs.createjs.Ticker
/* static members */
object Ticker {
  ...
  inline def addEventListener(`type`: String, listener: typingsJapgolly.easeljs.createjs.Stage): typingsJapgolly.easeljs.createjs.Stage = (^.asInstanceOf[js.Dynamic].applyDynamic("addEventListener")(`type`.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.easeljs.createjs.Stage]
  inline def addEventListener(`type`: String, listener: typingsJapgolly.easeljs.createjs.Stage, useCapture: Boolean): typingsJapgolly.easeljs.createjs.Stage = (^.asInstanceOf[js.Dynamic].applyDynamic("addEventListener")(`type`.asInstanceOf[js.Any], listener.asInstanceOf[js.Any], useCapture.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.easeljs.createjs.Stage]
