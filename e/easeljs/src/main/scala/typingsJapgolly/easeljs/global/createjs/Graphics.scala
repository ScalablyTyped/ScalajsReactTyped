...
open class Graphics ()
  extends StObject
     with typingsJapgolly.easeljs.createjs.Graphics
/* static members */
object Graphics {
  ...
  open class Arc protected ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.Arc {
  ...
  open class ArcTo protected ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.ArcTo {
  ...
  open class BeginPath ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.BeginPath
  
  @JSGlobal("createjs.Graphics.BezierCurveTo")
  @js.native
  open class BezierCurveTo protected ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.BezierCurveTo {
  ...
  open class Circle protected ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.Circle {
  ...
  open class ClosePath ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.ClosePath
  
  @JSGlobal("createjs.Graphics.Fill")
  @js.native
  open class Fill protected ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.Fill {
    def this(style: js.Object) = this()
    def this(style: js.Object, matrix: typingsJapgolly.easeljs.createjs.Matrix2D) = this()
  }
  ...
  open class LineTo protected ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.LineTo {
  ...
  open class MoveTo protected ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.MoveTo {
    def this(x: Double, y: Double) = this()
  ...
  open class PolyStar protected ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.PolyStar {
  ...
  open class QuadraticCurveTo protected ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.QuadraticCurveTo {
  ...
  open class Rect protected ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.Rect {
  ...
  open class RoundRect protected ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.RoundRect {
    def this(
      x: Double,
      y: Double,
      w: Double,
  ...
  open class Stroke protected ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.Stroke {
  ...
  open class StrokeStyle protected ()
    extends StObject
       with typingsJapgolly.easeljs.createjs.Graphics.StrokeStyle {
  ...
  @js.native
  def beginCmd: typingsJapgolly.easeljs.createjs.Graphics.BeginPath = js.native
  inline def beginCmd_=(x: typingsJapgolly.easeljs.createjs.Graphics.BeginPath): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("beginCmd")(x.asInstanceOf[js.Any])
