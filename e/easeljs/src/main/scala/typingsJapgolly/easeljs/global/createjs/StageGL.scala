...
import typingsJapgolly.easeljs.createjs.IStageGLOptions
...
open class StageGL protected ()
  extends StObject
     with typingsJapgolly.easeljs.createjs.StageGL {
...
object StageGL {
  ...
  // methods
  inline def buildUVRects(spritesheet: typingsJapgolly.easeljs.createjs.SpriteSheet): js.Object = ^.asInstanceOf[js.Dynamic].applyDynamic("buildUVRects")(spritesheet.asInstanceOf[js.Any]).asInstanceOf[js.Object]
  inline def buildUVRects(spritesheet: typingsJapgolly.easeljs.createjs.SpriteSheet, target: Double): js.Object = (^.asInstanceOf[js.Dynamic].applyDynamic("buildUVRects")(spritesheet.asInstanceOf[js.Any], target.asInstanceOf[js.Any])).asInstanceOf[js.Object]
  inline def buildUVRects(spritesheet: typingsJapgolly.easeljs.createjs.SpriteSheet, target: Double, onlyTarget: Boolean): js.Object = (^.asInstanceOf[js.Dynamic].applyDynamic("buildUVRects")(spritesheet.asInstanceOf[js.Any], target.asInstanceOf[js.Any], onlyTarget.asInstanceOf[js.Any])).asInstanceOf[js.Object]
  inline def buildUVRects(spritesheet: typingsJapgolly.easeljs.createjs.SpriteSheet, target: Unit, onlyTarget: Boolean): js.Object = (^.asInstanceOf[js.Dynamic].applyDynamic("buildUVRects")(spritesheet.asInstanceOf[js.Any], target.asInstanceOf[js.Any], onlyTarget.asInstanceOf[js.Any])).asInstanceOf[js.Object]
