...
object mod {
  ...
  open class CreateFileError protected ()
    extends typingsJapgolly.externalEditor.mainErrorsCreateFileErrorMod.CreateFileError {
  ...
  open class LaunchEditorError protected ()
    extends typingsJapgolly.externalEditor.mainErrorsLaunchEditorErrorMod.LaunchEditorError {
    def this(originalError: js.Error) = this()
  }
  ...
  open class ReadFileError protected ()
    extends typingsJapgolly.externalEditor.mainErrorsReadFileErrorMod.ReadFileError {
    def this(originalError: js.Error) = this()
  }
  ...
  open class RemoveFileError protected ()
    extends typingsJapgolly.externalEditor.mainErrorsRemoveFileErrorMod.RemoveFileError {
    def this(originalError: js.Error) = this()
  }
