...
import typingsJapgolly.nobleSecp256k1.anon.TypeofSchnorrSignature
import typingsJapgolly.nobleSecp256k1.mod.Hex
import typingsJapgolly.nobleSecp256k1.mod.HmacFnSync
import typingsJapgolly.nobleSecp256k1.mod.OptsNoRecov
import typingsJapgolly.nobleSecp256k1.mod.OptsRecov
import typingsJapgolly.nobleSecp256k1.mod.PrivKey
import typingsJapgolly.nobleSecp256k1.mod.PubKey
import typingsJapgolly.nobleSecp256k1.mod.SchnorrSignature
import typingsJapgolly.nobleSecp256k1.mod.Sha256FnSync
import typingsJapgolly.nobleSecp256k1.mod.Sig
import typingsJapgolly.nobleSecp256k1.mod.U8A
import typingsJapgolly.nobleSecp256k1.mod.VOpts
...
object secp256k1Mod {
  ...
  open class Point protected ()
    extends typingsJapgolly.nobleSecp256k1.mod.Point {
  ...
  object Point {
    ...
    @js.native
    def BASE: typingsJapgolly.nobleSecp256k1.mod.Point = js.native
    inline def BASE_=(x: typingsJapgolly.nobleSecp256k1.mod.Point): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BASE")(x.asInstanceOf[js.Any])
    
    @JSImport("ethereum-cryptography/secp256k1", "Point.ZERO")
    @js.native
    def ZERO: typingsJapgolly.nobleSecp256k1.mod.Point = js.native
    inline def ZERO_=(x: typingsJapgolly.nobleSecp256k1.mod.Point): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ZERO")(x.asInstanceOf[js.Any])
    ...
    inline def fromHex(hex: Hex): typingsJapgolly.nobleSecp256k1.mod.Point = ^.asInstanceOf[js.Dynamic].applyDynamic("fromHex")(hex.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.nobleSecp256k1.mod.Point]
    
    inline def fromPrivateKey(privateKey: PrivKey): typingsJapgolly.nobleSecp256k1.mod.Point = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPrivateKey")(privateKey.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.nobleSecp256k1.mod.Point]
    
    inline def fromSignature(msgHash: Hex, signature: Sig, recovery: Double): typingsJapgolly.nobleSecp256k1.mod.Point = (^.asInstanceOf[js.Dynamic].applyDynamic("fromSignature")(msgHash.asInstanceOf[js.Any], signature.asInstanceOf[js.Any], recovery.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.nobleSecp256k1.mod.Point]
  ...
  open class Signature protected ()
    extends typingsJapgolly.nobleSecp256k1.mod.Signature {
  ...
  object Signature {
    ...
    inline def fromCompact(hex: Hex): typingsJapgolly.nobleSecp256k1.mod.Signature = ^.asInstanceOf[js.Dynamic].applyDynamic("fromCompact")(hex.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.nobleSecp256k1.mod.Signature]
    
    inline def fromDER(hex: Hex): typingsJapgolly.nobleSecp256k1.mod.Signature = ^.asInstanceOf[js.Dynamic].applyDynamic("fromDER")(hex.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.nobleSecp256k1.mod.Signature]
    
    inline def fromHex(hex: Hex): typingsJapgolly.nobleSecp256k1.mod.Signature = ^.asInstanceOf[js.Dynamic].applyDynamic("fromHex")(hex.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.nobleSecp256k1.mod.Signature]
  }
  ...
  object utils {
    ...
    inline def precompute(): typingsJapgolly.nobleSecp256k1.mod.Point = ^.asInstanceOf[js.Dynamic].applyDynamic("precompute")().asInstanceOf[typingsJapgolly.nobleSecp256k1.mod.Point]
    inline def precompute(windowSize: Double): typingsJapgolly.nobleSecp256k1.mod.Point = ^.asInstanceOf[js.Dynamic].applyDynamic("precompute")(windowSize.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.nobleSecp256k1.mod.Point]
    inline def precompute(windowSize: Double, point: typingsJapgolly.nobleSecp256k1.mod.Point): typingsJapgolly.nobleSecp256k1.mod.Point = (^.asInstanceOf[js.Dynamic].applyDynamic("precompute")(windowSize.asInstanceOf[js.Any], point.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.nobleSecp256k1.mod.Point]
    inline def precompute(windowSize: Unit, point: typingsJapgolly.nobleSecp256k1.mod.Point): typingsJapgolly.nobleSecp256k1.mod.Point = (^.asInstanceOf[js.Dynamic].applyDynamic("precompute")(windowSize.asInstanceOf[js.Any], point.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.nobleSecp256k1.mod.Point]
