...
object ResolveContext {
  ...
  extension [Self <: ResolveContext](x: Self) {
    ...
    inline def setLog(value: /* arg0 */ String => Callback): Self = StObject.set(x, "log", js.Any.fromFunction1((t0: /* arg0 */ String) => value(t0).runNow()))
    ...
    inline def setYield(value: /* arg0 */ ResolveRequest => Callback): Self = StObject.set(x, "yield", js.Any.fromFunction1((t0: /* arg0 */ ResolveRequest) => value(t0).runNow()))
