package typingsJapgolly.enhancedResolve.cloneBasenamePluginMod
...
object CloneBasenamePlugin {
  @scala.inline
  def apply(apply: typingsJapgolly.enhancedResolve.resolverMod.^ => Callback, source: String, target: String): CloneBasenamePlugin = {
