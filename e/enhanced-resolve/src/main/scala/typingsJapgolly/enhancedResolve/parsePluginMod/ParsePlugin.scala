package typingsJapgolly.enhancedResolve.parsePluginMod
...
object ParsePlugin {
  @scala.inline
  def apply(apply: typingsJapgolly.enhancedResolve.resolverMod.^ => Callback, source: String, target: String): ParsePlugin = {
