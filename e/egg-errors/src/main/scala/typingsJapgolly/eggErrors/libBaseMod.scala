...
import typingsJapgolly.eggErrors.anon.TypeofBaseError
...
object libBaseMod {
  ...
  @js.native
  open class default[T /* <: typingsJapgolly.eggErrors.libErrorOptionsMod.default */] ()
    extends StObject
       with BaseError[T] {
    ...
    inline def from[S /* <: Instantiable1[
        ...
        InstanceType[
          TypeofBaseError & (Instantiable1[
            ...
            BaseError[typingsJapgolly.eggErrors.libErrorOptionsMod.default]
          ])
        ]
  ...
  trait BaseError[T /* <: typingsJapgolly.eggErrors.libErrorOptionsMod.default */]
    extends StObject
       with Error
  ...
  object BaseError {
    ...
    inline def apply[T /* <: typingsJapgolly.eggErrors.libErrorOptionsMod.default */](code: String, message: String, name: String): BaseError[T] = {
      val __obj = js.Dynamic.literal(code = code.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[BaseError[T]]
    }
    
    extension [Self <: BaseError[?], T /* <: typingsJapgolly.eggErrors.libErrorOptionsMod.default */](x: Self & BaseError[T]) {
