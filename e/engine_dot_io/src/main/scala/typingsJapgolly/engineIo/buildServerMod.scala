...
import typingsJapgolly.cors.mod.CorsRequest
import typingsJapgolly.engineIo.anon.BADHANDSHAKEMETHOD
import typingsJapgolly.engineIo.anon.CookieSerializeOptionsnam
import typingsJapgolly.engineIo.anon.`0`
...
object buildServerMod {
  ...
  object ServerOptions {
    ...
    extension [Self <: ServerOptions](x: Self) {
      ...
      inline def setAllowRequest(
        value: (/* req */ IncomingMessage, /* fn */ js.Function2[/* err */ js.UndefOr[String | Null], /* success */ Boolean, Unit]) => Callback
      ): Self = StObject.set(x, "allowRequest", js.Any.fromFunction2((t0: /* req */ IncomingMessage, t1: /* fn */ js.Function2[/* err */ js.UndefOr[String | Null], /* success */ Boolean, Unit]) => (value(t0, t1)).runNow()))
      ...
      inline def setCorsFunction2(
        value: (CorsRequest, /* callback */ js.Function2[/* err */ js.Error | Null, /* options */ js.UndefOr[CorsOptions], Unit]) => Callback
      ): Self = StObject.set(x, "cors", js.Any.fromFunction2((t0: CorsRequest, t1: /* callback */ js.Function2[/* err */ js.Error | Null, /* options */ js.UndefOr[CorsOptions], Unit]) => (value(t0, t1)).runNow()))
  ...
  */
  ...
  object Transport {
    ...
    inline def polling: typingsJapgolly.engineIo.engineIoStrings.polling = "polling".asInstanceOf[typingsJapgolly.engineIo.engineIoStrings.polling]
    
    inline def websocket: typingsJapgolly.engineIo.engineIoStrings.websocket = "websocket".asInstanceOf[typingsJapgolly.engineIo.engineIoStrings.websocket]
  }
}
