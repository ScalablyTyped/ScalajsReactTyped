package typingsJapgolly.esbuildWasm
...
import typingsJapgolly.esbuildWasm.mod.ImportKind
...
object esbuildWasmStrings {
  ...
  sealed trait default
    extends StObject
       with Loader
       with typingsJapgolly.esbuildWasm.libBrowserMod.Loader
  ...
  sealed trait ascii
    extends StObject
       with Charset
       with typingsJapgolly.esbuildWasm.libBrowserMod.Charset
  ...
  sealed trait browser
    extends StObject
       with Platform
       with typingsJapgolly.esbuildWasm.libBrowserMod.Platform
  ...
  sealed trait cjs
    extends StObject
       with Format
       with typingsJapgolly.esbuildWasm.libBrowserMod.Format
  ...
  sealed trait console
    extends StObject
       with Drop
       with typingsJapgolly.esbuildWasm.libBrowserMod.Drop
  ...
  sealed trait debug
    extends StObject
       with LogLevel
       with typingsJapgolly.esbuildWasm.libBrowserMod.LogLevel
  ...
  sealed trait `dynamic-import`
    extends StObject
       with ImportKind
       with typingsJapgolly.esbuildWasm.libBrowserMod.ImportKind
