...
import typingsJapgolly.esbuildWasm.esbuildWasmBooleans.`true`
import typingsJapgolly.esbuildWasm.esbuildWasmStrings.`inline`
import typingsJapgolly.esbuildWasm.esbuildWasmStrings.automatic
import typingsJapgolly.esbuildWasm.esbuildWasmStrings.both
import typingsJapgolly.esbuildWasm.esbuildWasmStrings.eof
import typingsJapgolly.esbuildWasm.esbuildWasmStrings.external
import typingsJapgolly.esbuildWasm.esbuildWasmStrings.linked
import typingsJapgolly.esbuildWasm.esbuildWasmStrings.none
import typingsJapgolly.esbuildWasm.esbuildWasmStrings.preserve
import typingsJapgolly.esbuildWasm.esbuildWasmStrings.transform
import typingsJapgolly.esbuildWasm.mod.Charset
import typingsJapgolly.esbuildWasm.mod.Drop
import typingsJapgolly.esbuildWasm.mod.Format
import typingsJapgolly.esbuildWasm.mod.Loader
import typingsJapgolly.esbuildWasm.mod.LogLevel
import typingsJapgolly.esbuildWasm.mod.Platform
import typingsJapgolly.esbuildWasm.mod.Plugin
import typingsJapgolly.esbuildWasm.mod.StdinOptions
import typingsJapgolly.esbuildWasm.mod.WatchMode
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined esbuild-wasm.esbuild-wasm.BuildOptions & {  incremental :true,   metafile :true} */
trait BuildOptionsincrementaltrAssetNames extends StObject {
...
object BuildOptionsincrementaltrAssetNames {
  
  inline def apply(incremental: js.UndefOr[Boolean] & `true`, metafile: js.UndefOr[Boolean] & `true`): BuildOptionsincrementaltrAssetNames = {
    val __obj = js.Dynamic.literal(incremental = incremental.asInstanceOf[js.Any], metafile = metafile.asInstanceOf[js.Any])
    __obj.asInstanceOf[BuildOptionsincrementaltrAssetNames]
  }
  
  extension [Self <: BuildOptionsincrementaltrAssetNames](x: Self) {
