...
import typingsJapgolly.esbuildWasm.libBrowserMod.Charset
import typingsJapgolly.esbuildWasm.libBrowserMod.Drop
import typingsJapgolly.esbuildWasm.libBrowserMod.Format
import typingsJapgolly.esbuildWasm.libBrowserMod.Loader
import typingsJapgolly.esbuildWasm.libBrowserMod.LogLevel
import typingsJapgolly.esbuildWasm.libBrowserMod.Platform
import typingsJapgolly.esbuildWasm.libBrowserMod.Plugin
import typingsJapgolly.esbuildWasm.libBrowserMod.StdinOptions
import typingsJapgolly.esbuildWasm.libBrowserMod.WatchMode
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined esbuild-wasm.esbuild-wasm/lib/browser.BuildOptions & {  write :false} */
trait BuildOptionswritefalse extends StObject {
...
object BuildOptionswritefalse {
  
  inline def apply(write: js.UndefOr[Boolean] & `false`): BuildOptionswritefalse = {
    val __obj = js.Dynamic.literal(write = write.asInstanceOf[js.Any])
    __obj.asInstanceOf[BuildOptionswritefalse]
  }
  
  extension [Self <: BuildOptionswritefalse](x: Self) {
