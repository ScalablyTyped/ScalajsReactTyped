...
import typingsJapgolly.ethRpcErrors.distErrorConstantsMod.ErrorCodes_
...
object distMod {
  ...
  open class EthereumProviderError[T] protected ()
    extends typingsJapgolly.ethRpcErrors.distClassesMod.EthereumProviderError[T] {
    /**
  ...
  open class EthereumRpcError[T] protected ()
    extends typingsJapgolly.ethRpcErrors.distClassesMod.EthereumRpcError[T] {
    def this(code: Double, message: String) = this()
    def this(code: Double, message: String, data: T) = this()
  }
