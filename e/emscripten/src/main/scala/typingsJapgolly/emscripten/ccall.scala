...
import typingsJapgolly.emscripten.Emscripten.CCallOpts
import typingsJapgolly.emscripten.Emscripten.JSType
import typingsJapgolly.emscripten.Emscripten.TypeCompatibleWithC
