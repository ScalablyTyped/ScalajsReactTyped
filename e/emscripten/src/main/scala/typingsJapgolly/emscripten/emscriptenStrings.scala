...
import typingsJapgolly.emscripten.Emscripten.CFloatType
import typingsJapgolly.emscripten.Emscripten.CIntType
import typingsJapgolly.emscripten.Emscripten.CPointerType
