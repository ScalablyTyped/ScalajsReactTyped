...
import typingsJapgolly.ethersprojectWeb.ethersprojectWebStrings.poll
...
object mod {
  ...
  object OnceBlockable {
    ...
    inline def apply(once: (block, js.Function0[Unit]) => Callback): OnceBlockable = {
      val __obj = js.Dynamic.literal(once = js.Any.fromFunction2((t0: block, t1: js.Function0[Unit]) => (once(t0, t1)).runNow()))
      __obj.asInstanceOf[OnceBlockable]
    }
    
    extension [Self <: OnceBlockable](x: Self) {
      
      inline def setOnce(value: (block, js.Function0[Unit]) => Callback): Self = StObject.set(x, "once", js.Any.fromFunction2((t0: block, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object OncePollable {
    ...
    inline def apply(once: (poll, js.Function0[Unit]) => Callback): OncePollable = {
      val __obj = js.Dynamic.literal(once = js.Any.fromFunction2((t0: poll, t1: js.Function0[Unit]) => (once(t0, t1)).runNow()))
      __obj.asInstanceOf[OncePollable]
    }
    
    extension [Self <: OncePollable](x: Self) {
      
      inline def setOnce(value: (poll, js.Function0[Unit]) => Callback): Self = StObject.set(x, "once", js.Any.fromFunction2((t0: poll, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
    }
  }
