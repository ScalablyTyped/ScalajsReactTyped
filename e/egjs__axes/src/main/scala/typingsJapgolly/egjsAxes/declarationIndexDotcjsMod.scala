...
object declarationIndexDotcjsMod {
  ...
  open class MoveKeyInput protected ()
    extends typingsJapgolly.egjsAxes.mod.MoveKeyInput {
  ...
  open class PanInput protected ()
    extends typingsJapgolly.egjsAxes.mod.PanInput {
    def this(el: ElementType) = this()
  ...
  open class PinchInput protected ()
    extends typingsJapgolly.egjsAxes.mod.PinchInput {
    def this(el: ElementType) = this()
  ...
  open class RotatePanInput protected ()
    extends typingsJapgolly.egjsAxes.mod.RotatePanInput {
    def this(el: ElementType) = this()
    def this(el: ElementType, options: PanInputOption) = this()
  }
  ...
  open class WheelInput protected ()
    extends typingsJapgolly.egjsAxes.mod.WheelInput {
    def this(el: ElementType) = this()
