...
object anon {
  ...
  trait AnimationManager extends StObject {
    ...
    var animationManager: typingsJapgolly.egjsAxes.declarationAnimationAnimationManagerMod.AnimationManager
    
    var axisManager: typingsJapgolly.egjsAxes.declarationAxisManagerMod.AxisManager
  ...
  object AnimationManager {
    ...
    inline def apply(
      animationManager: typingsJapgolly.egjsAxes.declarationAnimationAnimationManagerMod.AnimationManager,
      axisManager: typingsJapgolly.egjsAxes.declarationAxisManagerMod.AxisManager,
    ...
    extension [Self <: AnimationManager](x: Self) {
      ...
      inline def setAnimationManager(value: typingsJapgolly.egjsAxes.declarationAnimationAnimationManagerMod.AnimationManager): Self = StObject.set(x, "animationManager", value.asInstanceOf[js.Any])
      
      inline def setAxisManager(value: typingsJapgolly.egjsAxes.declarationAxisManagerMod.AxisManager): Self = StObject.set(x, "axisManager", value.asInstanceOf[js.Any])
