...
object declarationUtilsMod {
  ...
  inline def toArray(nodes: NodeList[Node]): js.Array[HTMLElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("toArray")(nodes.asInstanceOf[js.Any]).asInstanceOf[js.Array[HTMLElement]]
