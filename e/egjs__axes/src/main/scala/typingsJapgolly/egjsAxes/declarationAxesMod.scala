...
import typingsJapgolly.egjsAxes.declarationAxisManagerMod.AxisManager
...
import typingsJapgolly.egjsAxes.declarationInputObserverMod.InputObserver
import typingsJapgolly.egjsAxes.declarationInputTypeInputTypeMod.InputType
...
object declarationAxesMod {
  ...
  - typingsJapgolly.egjsAxes.declarationTypesMod.AxesReactiveState because Inheritance from two classes. Inlined  */ @js.native
  trait Axes
    extends typingsJapgolly.egjsComponent.mod.default[AxesEvents]
