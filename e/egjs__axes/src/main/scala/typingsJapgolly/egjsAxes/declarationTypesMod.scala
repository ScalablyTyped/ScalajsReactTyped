...
object declarationTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.egjsAxes.declarationEventInputMouseEventInputMod.MouseEventInput
    - typingsJapgolly.egjsAxes.declarationEventInputTouchEventInputMod.TouchEventInput
    - typingsJapgolly.egjsAxes.declarationEventInputTouchMouseEventInputMod.TouchMouseEventInput
    - typingsJapgolly.egjsAxes.declarationEventInputPointerEventInputMod.PointerEventInput
  */
