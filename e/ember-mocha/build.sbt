...
name := "ember-mocha"
version := "0.14-dt-20200227Z-a60c37"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "ember-test-helpers" % "1.0-dt-20200227Z-20a8ee",
  ...
  "org.scalablytyped.japgolly" %%% "mocha" % "7.0-dt-20200225Z-ea96af",
