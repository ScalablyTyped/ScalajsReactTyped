...
import typingsJapgolly.eventemitter2.eventemitter2Booleans.`true`
...
object mod {
  ...
  object ListenToOptions {
    ...
    extension [Self <: ListenToOptions](x: Self) {
      ...
      inline def setOff(value: (/* event */ event | eventNS, /* handler */ ListenerFn) => Callback): Self = StObject.set(x, "off", js.Any.fromFunction2((t0: /* event */ event | eventNS, t1: /* handler */ ListenerFn) => (value(t0, t1)).runNow()))
      
      inline def setOffUndefined: Self = StObject.set(x, "off", js.undefined)
      
      inline def setOn(value: (/* event */ event | eventNS, /* handler */ ListenerFn) => Callback): Self = StObject.set(x, "on", js.Any.fromFunction2((t0: /* event */ event | eventNS, t1: /* handler */ ListenerFn) => (value(t0, t1)).runNow()))
  ...
  trait Listener extends StObject {
    ...
    var event: typingsJapgolly.eventemitter2.mod.event | eventNS
  ...
  object Listener {
    ...
    inline def apply(
      ...
      event: event | eventNS,
      listener: /* repeated */ Any => Callback,
      off: CallbackTo[Listener]
    ): Listener = {
      val __obj = js.Dynamic.literal(emitter = emitter.asInstanceOf[js.Any], event = event.asInstanceOf[js.Any], listener = js.Any.fromFunction1((t0: /* repeated */ Any) => listener(t0).runNow()), off = off.toJsFn)
    ...
    extension [Self <: Listener](x: Self) {
      ...
      inline def setListener(value: /* repeated */ Any => Callback): Self = StObject.set(x, "listener", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
      
      inline def setOff(value: CallbackTo[Listener]): Self = StObject.set(x, "off", value.toJsFn)
    }
  }
