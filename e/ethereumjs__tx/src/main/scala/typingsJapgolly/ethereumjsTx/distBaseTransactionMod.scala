...
import typingsJapgolly.ethereumjsTx.distTypesMod.Capability
...
import typingsJapgolly.ethereumjsTx.distTypesMod.JsonTx
...
import typingsJapgolly.ethereumjsTx.ethereumjsTxBooleans.`false`
import typingsJapgolly.ethereumjsTx.ethereumjsTxBooleans.`true`
import typingsJapgolly.ethereumjsUtil.distTypesMod.BigIntLike
import typingsJapgolly.ethereumjsUtil.mod.Address
...
object distBaseTransactionMod {
  ...
  trait TransactionCache extends StObject {
    ...
    var dataFee: js.UndefOr[typingsJapgolly.ethereumjsTx.anon.Hardfork] = js.undefined
  ...
  object TransactionCache {
    ...
    extension [Self <: TransactionCache](x: Self) {
      ...
      inline def setDataFee(value: typingsJapgolly.ethereumjsTx.anon.Hardfork): Self = StObject.set(x, "dataFee", value.asInstanceOf[js.Any])
