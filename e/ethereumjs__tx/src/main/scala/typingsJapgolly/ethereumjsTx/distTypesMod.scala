...
import typingsJapgolly.ethereumjsUtil.distTypesMod.AddressLike
...
object distTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ethereumjsTx.distLegacyTransactionMod.Transaction
    - typingsJapgolly.ethereumjsTx.distEip2930TransactionMod.AccessListEIP2930Transaction
    - typingsJapgolly.ethereumjsTx.distEip1559TransactionMod.FeeMarketEIP1559Transaction
  */
