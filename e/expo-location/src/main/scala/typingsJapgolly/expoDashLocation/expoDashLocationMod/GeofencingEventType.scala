...
object GeofencingEventType extends js.Object {
  ...
  /* 1 */ val Enter: typingsJapgolly.expoDashLocation.expoDashLocationMod.GeofencingEventType.Enter with Double = js.native
  /* 2 */ val Exit: typingsJapgolly.expoDashLocation.expoDashLocationMod.GeofencingEventType.Exit with Double = js.native
  @JSBracketAccess
