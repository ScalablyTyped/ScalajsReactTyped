...
trait AnimationEasing extends StObject {
  ...
  /**
    ...
    */
  var data: js.UndefOr[`4`] = js.undefined
...
object AnimationEasing {
  ...
  inline def apply(): AnimationEasing = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnimationEasing]
  }
  
  extension [Self <: AnimationEasing](x: Self) {
    ...
    inline def setData(value: `4`): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
