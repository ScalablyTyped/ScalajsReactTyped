...
/* unknownProperty */ StringDictionary[Any] {
  ...
  /**
    ...
    */
  var color: js.UndefOr[typingsJapgolly.echarts.echarts.EChartOption.Color | js.Function] = js.undefined
...
object DictunknownPropertyBorderColor {
  ...
  extension [Self <: DictunknownPropertyBorderColor](x: Self) {
    ...
    inline def setColor(value: typingsJapgolly.echarts.echarts.EChartOption.Color | js.Function): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
