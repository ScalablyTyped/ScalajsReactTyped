...
import typingsJapgolly.echarts.echartsStrings.dashed
import typingsJapgolly.echarts.echartsStrings.dotted
import typingsJapgolly.echarts.echartsStrings.solid
