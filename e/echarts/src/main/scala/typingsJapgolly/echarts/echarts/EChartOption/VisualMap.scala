...
import typingsJapgolly.echarts.echarts.VisualMap.PiecesObject
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.echarts.echarts.VisualMap.Continuous
  - typingsJapgolly.echarts.echarts.VisualMap.Piecewise
*/
