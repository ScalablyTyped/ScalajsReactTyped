...
import typingsJapgolly.echarts.AnonLabelLine
import typingsJapgolly.echarts.AnonLength
import typingsJapgolly.echarts.AnonShadowOffsetY
import typingsJapgolly.echarts.echarts.EChartOption.SeriesFunnel.DataObject
