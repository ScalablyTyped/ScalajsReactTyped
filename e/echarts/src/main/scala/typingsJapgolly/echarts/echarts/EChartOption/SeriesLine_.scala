...
import typingsJapgolly.echarts.AnonAnimationThreshold
import typingsJapgolly.echarts.AnonBorderRadius
import typingsJapgolly.echarts.AnonColorOpacity
...
import typingsJapgolly.echarts.AnonShadowBlur
import typingsJapgolly.echarts.echarts.EChartOption.SeriesLine.DataObject
...
object SeriesLine_ {
  ...
  def apply(
    ...
    if (!js.isUndefined(clipOverflow)) __obj.updateDynamic("clipOverflow")(clipOverflow.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showAllSymbol)) __obj.updateDynamic("showAllSymbol")(showAllSymbol.asInstanceOf[js.Any])
    if (!js.isUndefined(showSymbol)) __obj.updateDynamic("showSymbol")(showSymbol.asInstanceOf[js.Any])
