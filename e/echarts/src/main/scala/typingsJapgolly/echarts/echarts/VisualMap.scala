...
import typingsJapgolly.echarts.anon.InRange
import typingsJapgolly.echarts.echarts.EChartOption.BaseTextStyleWithRich
...
import typingsJapgolly.echarts.echartsStrings.continuous
...
object VisualMap {
  ...
  trait Continuous
    extends StObject
       with typingsJapgolly.echarts.echarts.EChartOption.VisualMap {
