...
import typingsJapgolly.ethersprojectAbstractProvider.anon.DeferrableTransactionRequ
...
import typingsJapgolly.ethersprojectWeb.mod.OnceBlockable
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.ethersprojectAbstractProvider.mod.EventFilter
    - typingsJapgolly.ethersprojectAbstractProvider.mod.ForkEvent
  */
