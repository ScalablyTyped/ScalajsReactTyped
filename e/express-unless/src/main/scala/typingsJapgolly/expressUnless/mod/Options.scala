package typingsJapgolly.expressUnless.mod
...
object Options {
  @scala.inline
  def apply(
    custom: /* req */ Request_[ParamsDictionary] => CallbackTo[Boolean] = null,
    ...
    if (custom != null) __obj.updateDynamic("custom")(js.Any.fromFunction1((t0: /* req */ typingsJapgolly.express.mod.Request_[typingsJapgolly.expressServeStaticCore.mod.ParamsDictionary]) => custom(t0).runNow()))
