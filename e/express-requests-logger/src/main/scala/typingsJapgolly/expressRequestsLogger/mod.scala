package typingsJapgolly.expressRequestsLogger

import japgolly.scalajs.react.Callback
import typingsJapgolly.expressRequestsLogger.expressRequestsLoggerStrings.debug
import typingsJapgolly.expressRequestsLogger.expressRequestsLoggerStrings.error
import typingsJapgolly.expressRequestsLogger.expressRequestsLoggerStrings.info
import typingsJapgolly.expressRequestsLogger.expressRequestsLoggerStrings.trace
import typingsJapgolly.expressRequestsLogger.expressRequestsLoggerStrings.warn
...
object mod {
  ...
  object Logger {
    ...
    inline def apply(info: (js.Object, /* repeated */ Any) => Callback): Logger = {
      val __obj = js.Dynamic.literal(info = js.Any.fromFunction2((t0: js.Object, t1: /* repeated */ Any) => (info(t0, t1)).runNow()))
      __obj.asInstanceOf[Logger]
    }
    
    extension [Self <: Logger](x: Self) {
      
      inline def setInfo(value: (js.Object, /* repeated */ Any) => Callback): Self = StObject.set(x, "info", js.Any.fromFunction2((t0: js.Object, t1: /* repeated */ Any) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object global {
    ...
    object Express {
      ...
      object Request {
        ...
        inline def apply(maxBodyLength: Double): typingsJapgolly.expressRequestsLogger.mod.global.Express.Request = {
          val __obj = js.Dynamic.literal(maxBodyLength = maxBodyLength.asInstanceOf[js.Any])
          __obj.asInstanceOf[typingsJapgolly.expressRequestsLogger.mod.global.Express.Request]
        }
        
        extension [Self <: typingsJapgolly.expressRequestsLogger.mod.global.Express.Request](x: Self) {
