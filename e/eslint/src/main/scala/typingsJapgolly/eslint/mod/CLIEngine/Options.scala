...
import typingsJapgolly.eslint.eslintBooleans.`false`
import typingsJapgolly.eslint.mod.Linter.ParserOptions
import typingsJapgolly.eslint.mod.Linter.RuleLevel
import typingsJapgolly.eslint.mod.Linter.RuleLevelAndOptions
