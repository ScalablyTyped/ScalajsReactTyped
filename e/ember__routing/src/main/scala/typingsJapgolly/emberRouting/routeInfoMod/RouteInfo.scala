package typingsJapgolly.emberRouting.routeInfoMod
...
object RouteInfo {
  @scala.inline
  def apply(
    find: js.Function1[RouteInfo, Boolean] => CallbackTo[js.UndefOr[RouteInfo]],
    localName: String,
    name: String,
    ...
    val __obj = js.Dynamic.literal(localName = localName.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], paramNames = paramNames.asInstanceOf[js.Any], params = params.asInstanceOf[js.Any], queryParams = queryParams.asInstanceOf[js.Any])
    __obj.updateDynamic("find")(js.Any.fromFunction1((t0: js.Function1[typingsJapgolly.emberRouting.routeInfoMod.RouteInfo, scala.Boolean]) => find(t0).runNow()))
