package typingsJapgolly.emittery

import japgolly.scalajs.react.Callback
import typingsJapgolly.emittery.anon.Instantiable
...
object mod {
  ...
  object DebugOptions {
    ...
    extension [Self <: DebugOptions[?], EventData](x: Self & DebugOptions[EventData]) {
      ...
      ): Self = StObject.set(x, "logger", js.Any.fromFunction4((t0: /* type */ String, t1: /* debugName */ String, t2: /* eventName */ js.UndefOr[/* keyof EventData */ String], t3: /* eventData */ js.UndefOr[
              /* import warning: importer.ImportType#apply Failed type conversion: EventData[Name] */ js.Any
