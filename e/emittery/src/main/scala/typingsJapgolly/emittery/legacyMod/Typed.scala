package typingsJapgolly.emittery.legacyMod

import typingsJapgolly.emittery.mod.Events
...
class Typed[EventDataMap /* <: Events */, EmptyEvents /* <: String */] ()
  extends typingsJapgolly.emittery.mod.Typed[EventDataMap, EmptyEvents]
