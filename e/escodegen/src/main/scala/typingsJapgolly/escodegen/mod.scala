package typingsJapgolly.escodegen
...
object mod {
  ...
  object Precedence extends StObject {
    ...
    sealed trait Additive
      extends StObject
         with Precedence
    /* 14 */ val Additive: typingsJapgolly.escodegen.mod.Precedence.Additive & Double = js.native
    
    @js.native
    sealed trait ArrowFunction
      extends StObject
         with Precedence
    /* 5 */ val ArrowFunction: typingsJapgolly.escodegen.mod.Precedence.ArrowFunction & Double = js.native
    
    @js.native
    sealed trait Assignment
      extends StObject
         with Precedence
    /* 3 */ val Assignment: typingsJapgolly.escodegen.mod.Precedence.Assignment & Double = js.native
    
    @js.native
    sealed trait Await
      extends StObject
         with Precedence
    /* 2 */ val Await: typingsJapgolly.escodegen.mod.Precedence.Await & Double = js.native
    
    @js.native
    sealed trait BitwiseAND
      extends StObject
         with Precedence
    /* 10 */ val BitwiseAND: typingsJapgolly.escodegen.mod.Precedence.BitwiseAND & Double = js.native
    
    @js.native
    sealed trait BitwiseOR
      extends StObject
         with Precedence
    /* 8 */ val BitwiseOR: typingsJapgolly.escodegen.mod.Precedence.BitwiseOR & Double = js.native
    
    @js.native
    sealed trait BitwiseSHIFT
      extends StObject
         with Precedence
    /* 13 */ val BitwiseSHIFT: typingsJapgolly.escodegen.mod.Precedence.BitwiseSHIFT & Double = js.native
    
    @js.native
    sealed trait BitwiseXOR
      extends StObject
         with Precedence
    /* 9 */ val BitwiseXOR: typingsJapgolly.escodegen.mod.Precedence.BitwiseXOR & Double = js.native
    
    @js.native
    sealed trait Call
      extends StObject
         with Precedence
    /* 18 */ val Call: typingsJapgolly.escodegen.mod.Precedence.Call & Double = js.native
    
    @js.native
    sealed trait Conditional
      extends StObject
         with Precedence
    /* 4 */ val Conditional: typingsJapgolly.escodegen.mod.Precedence.Conditional & Double = js.native
    
    @js.native
    sealed trait Equality
      extends StObject
         with Precedence
    /* 11 */ val Equality: typingsJapgolly.escodegen.mod.Precedence.Equality & Double = js.native
    
    @js.native
    sealed trait LogicalAND
      extends StObject
         with Precedence
    /* 7 */ val LogicalAND: typingsJapgolly.escodegen.mod.Precedence.LogicalAND & Double = js.native
    
    @js.native
    sealed trait LogicalOR
      extends StObject
         with Precedence
    /* 6 */ val LogicalOR: typingsJapgolly.escodegen.mod.Precedence.LogicalOR & Double = js.native
    
    @js.native
    sealed trait Member
      extends StObject
         with Precedence
    /* 21 */ val Member: typingsJapgolly.escodegen.mod.Precedence.Member & Double = js.native
    
    @js.native
    sealed trait Multiplicative
      extends StObject
         with Precedence
    /* 15 */ val Multiplicative: typingsJapgolly.escodegen.mod.Precedence.Multiplicative & Double = js.native
    
    @js.native
    sealed trait New
      extends StObject
         with Precedence
    /* 19 */ val New: typingsJapgolly.escodegen.mod.Precedence.New & Double = js.native
    
    @js.native
    sealed trait Postfix
      extends StObject
         with Precedence
    /* 17 */ val Postfix: typingsJapgolly.escodegen.mod.Precedence.Postfix & Double = js.native
    
    @js.native
    sealed trait Primary
      extends StObject
         with Precedence
    /* 22 */ val Primary: typingsJapgolly.escodegen.mod.Precedence.Primary & Double = js.native
    
    @js.native
    sealed trait Relational
      extends StObject
         with Precedence
    /* 12 */ val Relational: typingsJapgolly.escodegen.mod.Precedence.Relational & Double = js.native
    
    @js.native
    sealed trait Sequence
      extends StObject
         with Precedence
    /* 0 */ val Sequence: typingsJapgolly.escodegen.mod.Precedence.Sequence & Double = js.native
    
    @js.native
    sealed trait TaggedTemplate
      extends StObject
         with Precedence
    /* 20 */ val TaggedTemplate: typingsJapgolly.escodegen.mod.Precedence.TaggedTemplate & Double = js.native
    
    @js.native
    sealed trait Unary
      extends StObject
         with Precedence
    /* 16 */ val Unary: typingsJapgolly.escodegen.mod.Precedence.Unary & Double = js.native
    
    @js.native
    sealed trait Yield
      extends StObject
         with Precedence
    /* 1 */ val Yield: typingsJapgolly.escodegen.mod.Precedence.Yield & Double = js.native
  }
