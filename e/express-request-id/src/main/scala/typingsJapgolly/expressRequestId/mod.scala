  ...
  object global {
    ...
    object Express {
      ...
      object Request {
        ...
        inline def apply(id: String): typingsJapgolly.expressRequestId.mod.global.Express.Request = {
          val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
          __obj.asInstanceOf[typingsJapgolly.expressRequestId.mod.global.Express.Request]
        }
        
        extension [Self <: typingsJapgolly.expressRequestId.mod.global.Express.Request](x: Self) {
