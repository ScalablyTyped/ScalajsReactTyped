package typingsJapgolly.expoDashSqlite

import typingsJapgolly.expoDashSqlite.buildSQLiteDotTypesMod.WebSQLDatabase
...
object expoDashSqliteMod extends js.Object {
  @js.native
  class SQLError ()
    extends typingsJapgolly.expoDashSqlite.buildSQLiteDotTypesMod.SQLError
