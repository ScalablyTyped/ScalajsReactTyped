...
import typingsJapgolly.ethersprojectAbi.mod.Fragment
import typingsJapgolly.ethersprojectAbi.mod.Interface
import typingsJapgolly.ethersprojectAbstractProvider.mod.Block
import typingsJapgolly.ethersprojectAbstractProvider.mod.BlockTag
import typingsJapgolly.ethersprojectAbstractProvider.mod.Listener
import typingsJapgolly.ethersprojectAbstractProvider.mod.Log
...
object mod {
  ...
  object Event {
    ...
    inline def apply(
      ...
      blockNumber: Double,
      data: String,
      getBlock: CallbackTo[js.Promise[Block]],
      getTransaction: CallbackTo[js.Promise[TransactionResponse]],
      getTransactionReceipt: CallbackTo[js.Promise[TransactionReceipt]],
      logIndex: Double,
      ...
      val __obj = js.Dynamic.literal(address = address.asInstanceOf[js.Any], blockHash = blockHash.asInstanceOf[js.Any], blockNumber = blockNumber.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any], getBlock = getBlock.toJsFn, getTransaction = getTransaction.toJsFn, getTransactionReceipt = getTransactionReceipt.toJsFn, logIndex = logIndex.asInstanceOf[js.Any], removeListener = removeListener.toJsFn, removed = removed.asInstanceOf[js.Any], topics = topics.asInstanceOf[js.Any], transactionHash = transactionHash.asInstanceOf[js.Any], transactionIndex = transactionIndex.asInstanceOf[js.Any])
    ...
    extension [Self <: Event](x: Self) {
      ...
      inline def setGetBlock(value: CallbackTo[js.Promise[Block]]): Self = StObject.set(x, "getBlock", value.toJsFn)
      
      inline def setGetTransaction(value: CallbackTo[js.Promise[TransactionResponse]]): Self = StObject.set(x, "getTransaction", value.toJsFn)
      
      inline def setGetTransactionReceipt(value: CallbackTo[js.Promise[TransactionReceipt]]): Self = StObject.set(x, "getTransactionReceipt", value.toJsFn)
  ...
  object RunningEvent {
    ...
    inline def apply(
      _listeners: Any,
      addListener: (Listener, Boolean) => Callback,
      filter: EventFilter,
      getEmit: Event => js.Array[Any],
      listenerCount: CallbackTo[Double],
      listeners: CallbackTo[js.Array[Listener]],
      prepareEvent: Event => Callback,
      removeAllListeners: Callback,
      removeListener: Listener => Callback,
      run: js.Array[Any] => Double,
      tag: String
    ): RunningEvent = {
      val __obj = js.Dynamic.literal(_listeners = _listeners.asInstanceOf[js.Any], addListener = js.Any.fromFunction2((t0: Listener, t1: Boolean) => (addListener(t0, t1)).runNow()), filter = filter.asInstanceOf[js.Any], getEmit = js.Any.fromFunction1(getEmit), listenerCount = listenerCount.toJsFn, listeners = listeners.toJsFn, prepareEvent = js.Any.fromFunction1((t0: Event) => prepareEvent(t0).runNow()), removeAllListeners = removeAllListeners.toJsFn, removeListener = js.Any.fromFunction1((t0: Listener) => removeListener(t0).runNow()), run = js.Any.fromFunction1(run), tag = tag.asInstanceOf[js.Any])
      __obj.asInstanceOf[RunningEvent]
    }
    
    extension [Self <: RunningEvent](x: Self) {
      
      inline def setAddListener(value: (Listener, Boolean) => Callback): Self = StObject.set(x, "addListener", js.Any.fromFunction2((t0: Listener, t1: Boolean) => (value(t0, t1)).runNow()))
      ...
      inline def setListeners(value: CallbackTo[js.Array[Listener]]): Self = StObject.set(x, "listeners", value.toJsFn)
      
      inline def setPrepareEvent(value: Event => Callback): Self = StObject.set(x, "prepareEvent", js.Any.fromFunction1((t0: Event) => value(t0).runNow()))
      
      inline def setRemoveAllListeners(value: Callback): Self = StObject.set(x, "removeAllListeners", value.toJsFn)
      
      inline def setRemoveListener(value: Listener => Callback): Self = StObject.set(x, "removeListener", js.Any.fromFunction1((t0: Listener) => value(t0).runNow()))
