package typingsJapgolly.ethersprojectJsonWallets
...
import typingsJapgolly.ethersprojectProperties.mod.Description
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libCrowdsaleMod {
  ...
  open class CrowdsaleAccount protected ()
    ...
    def this(info: /* import warning: importer.ImportType#apply Failed type conversion: {[ K in 'address' | 'privateKey' | '_isCrowdsaleAccount' ]: @ethersproject/json-wallets.@ethersproject/json-wallets/lib/crowdsale._CrowdsaleAccount[K]} */ js.Any) = this()
