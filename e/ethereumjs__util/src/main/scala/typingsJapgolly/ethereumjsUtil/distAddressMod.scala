...
object distAddressMod {
  ...
  object Address {
    ...
    /**
      ...
      */
    inline def generate(from: Address, nonce: js.BigInt): Address = (^.asInstanceOf[js.Dynamic].applyDynamic("generate")(from.asInstanceOf[js.Any], nonce.asInstanceOf[js.Any])).asInstanceOf[Address]
