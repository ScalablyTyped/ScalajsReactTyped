...
name := "express-busboy"
version := "6.0-dt-20190819Z-5e30bc"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "busboy" % "v0.2.13-dt-20200226Z-4d7bcb",
  "org.scalablytyped.japgolly" %%% "connect" % "v3.4.0-dt-20200226Z-95dbfc",
  "org.scalablytyped.japgolly" %%% "connect-busboy" % "0.0-dt-20190819Z-56e6fe",
