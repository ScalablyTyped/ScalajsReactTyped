...
import typingsJapgolly.expressSession.AnonDomain
import typingsJapgolly.expressSession.expressSessionStrings.destroy
import typingsJapgolly.expressSession.expressSessionStrings.keep
...
object SessionOptions {
  ...
  def apply(
    ...
    genid: /* req */ Request_[ParamsDictionary] => CallbackTo[String] = null,
    name: String = null,
    ...
    if (genid != null) __obj.updateDynamic("genid")(js.Any.fromFunction1((t0: /* req */ typingsJapgolly.express.mod.Request_[typingsJapgolly.expressServeStaticCore.mod.ParamsDictionary]) => genid(t0).runNow()))
