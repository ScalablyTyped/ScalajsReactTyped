...
import typingsJapgolly.electronNotarize.anon.Tool
import typingsJapgolly.electronNotarize.anon.`0`
...
object libTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.electronNotarize.libTypesMod.LegacyNotarizePasswordCredentials
    - typingsJapgolly.electronNotarize.libTypesMod.LegacyNotarizeApiKeyCredentials
  */
  ...
  object LegacyNotarizeCredentials {
    ...
    inline def LegacyNotarizeApiKeyCredentials(appleApiIssuer: String, appleApiKey: String): typingsJapgolly.electronNotarize.libTypesMod.LegacyNotarizeApiKeyCredentials = {
      val __obj = js.Dynamic.literal(appleApiIssuer = appleApiIssuer.asInstanceOf[js.Any], appleApiKey = appleApiKey.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.electronNotarize.libTypesMod.LegacyNotarizeApiKeyCredentials]
    }
    
    inline def LegacyNotarizePasswordCredentials(appleId: String, appleIdPassword: String): typingsJapgolly.electronNotarize.libTypesMod.LegacyNotarizePasswordCredentials = {
      val __obj = js.Dynamic.literal(appleId = appleId.asInstanceOf[js.Any], appleIdPassword = appleIdPassword.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.electronNotarize.libTypesMod.LegacyNotarizePasswordCredentials]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.electronNotarize.libTypesMod.LegacyNotarizeCredentials
    - typingsJapgolly.electronNotarize.libTypesMod.NotaryToolCredentials
  */
  ...
  object NotarizeCredentials {
    ...
    inline def NotaryToolApiKeyCredentials(appleApiIssuer: String, appleApiKey: String, appleApiKeyId: String): typingsJapgolly.electronNotarize.libTypesMod.NotaryToolApiKeyCredentials = {
      ...
      __obj.asInstanceOf[typingsJapgolly.electronNotarize.libTypesMod.NotaryToolApiKeyCredentials]
    }
    
    inline def NotaryToolKeychainCredentials(keychainProfile: String): typingsJapgolly.electronNotarize.libTypesMod.NotaryToolKeychainCredentials = {
      val __obj = js.Dynamic.literal(keychainProfile = keychainProfile.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.electronNotarize.libTypesMod.NotaryToolKeychainCredentials]
    }
    
    inline def NotaryToolPasswordCredentials(appleId: String, appleIdPassword: String, teamId: String): typingsJapgolly.electronNotarize.libTypesMod.NotaryToolPasswordCredentials = {
      ...
      __obj.asInstanceOf[typingsJapgolly.electronNotarize.libTypesMod.NotaryToolPasswordCredentials]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.electronNotarize.libTypesMod.NotaryToolPasswordCredentials
    - typingsJapgolly.electronNotarize.libTypesMod.NotaryToolApiKeyCredentials
    - typingsJapgolly.electronNotarize.libTypesMod.NotaryToolKeychainCredentials
  */
