...
import typingsJapgolly.fabric.anon.CrossOrigin
import typingsJapgolly.fabric.fabricImplMod.Canvas
import typingsJapgolly.fabric.fabricImplMod.FilterBackend_
import typingsJapgolly.fabric.fabricImplMod.IUtil
import typingsJapgolly.fabric.fabricImplMod.Object
import typingsJapgolly.fabric.fabricImplMod.StaticCanvas
...
trait TypeofFabric extends StObject {
  ...
  var BaseBrush: Instantiable0[typingsJapgolly.fabric.mod.fabric.BaseBrush] = js.native
  
  var Canvas: TypeofCanvas = js.native
  
  var Canvas2dFilterBackend: Instantiable0[typingsJapgolly.fabric.mod.fabric.Canvas2dFilterBackend] = js.native
  
  var Circle: TypeofCircle = js.native
  
  var CircleBrush: Instantiable0[typingsJapgolly.fabric.mod.fabric.CircleBrush] = js.native
  
  var Color: TypeofColor = js.native
  
  var Control: Instantiable0[typingsJapgolly.fabric.mod.fabric.Control] = js.native
  ...
  var Pattern: Instantiable0[typingsJapgolly.fabric.mod.fabric.Pattern] = js.native
  
  var PatternBrush: Instantiable1[/* canvas */ Canvas, typingsJapgolly.fabric.mod.fabric.PatternBrush] = js.native
  
  var PencilBrush: Instantiable1[/* canvas */ Canvas, typingsJapgolly.fabric.mod.fabric.PencilBrush] = js.native
  
  var Point: Instantiable2[/* x */ Double, /* y */ Double, typingsJapgolly.fabric.mod.fabric.Point] = js.native
  ...
  var SprayBrush: Instantiable0[typingsJapgolly.fabric.mod.fabric.SprayBrush] = js.native
  ...
  var WebglFilterBackend: Instantiable0[typingsJapgolly.fabric.mod.fabric.WebglFilterBackend] = js.native
