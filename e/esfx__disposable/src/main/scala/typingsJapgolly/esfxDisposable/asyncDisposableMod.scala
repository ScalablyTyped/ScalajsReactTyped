  ...
  object AsyncDisposable {
    ...
    inline def usingEach(
      iterable: js.Iterable[
          js.UndefOr[
            typingsJapgolly.esfxDisposable.distTypesAsyncDisposableMod.AsyncDisposable | Disposable | Null | (PromiseLike[
              js.UndefOr[
                typingsJapgolly.esfxDisposable.distTypesAsyncDisposableMod.AsyncDisposable | Disposable | Null
              ]
            ])
          ]
        ]
