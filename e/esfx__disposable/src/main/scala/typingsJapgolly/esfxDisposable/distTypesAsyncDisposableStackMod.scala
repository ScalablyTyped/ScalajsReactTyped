...
import typingsJapgolly.esfxDisposable.anon.TypeofAsyncDisposableStac
import typingsJapgolly.esfxDisposable.distTypesAsyncDisposableMod.AsyncDisposable
...
object distTypesAsyncDisposableStackMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.esfxDisposable.distTypesAsyncDisposableMod.AsyncDisposable
    - typingsJapgolly.esfxDisposable.distTypesDisposableMod.Disposable
    - js.Function0[scala.Unit | typingsJapgolly.std.PromiseLike[scala.Unit]]
  */
