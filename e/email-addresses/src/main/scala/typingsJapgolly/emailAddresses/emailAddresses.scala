...
import typingsJapgolly.emailAddresses.anon.Address
import typingsJapgolly.emailAddresses.anon.Name
import typingsJapgolly.emailAddresses.emailAddressesStrings.group
import typingsJapgolly.emailAddresses.emailAddressesStrings.mailbox
...
object emailAddresses {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.emailAddresses.emailAddressesStrings.address
    - typingsJapgolly.emailAddresses.emailAddressesStrings.`address-list`
    - typingsJapgolly.emailAddresses.emailAddressesStrings.`angle-addr`
    - typingsJapgolly.emailAddresses.emailAddressesStrings.from
    - typingsJapgolly.emailAddresses.emailAddressesStrings.group
    - typingsJapgolly.emailAddresses.emailAddressesStrings.mailbox
    - typingsJapgolly.emailAddresses.emailAddressesStrings.`mailbox-list`
    - typingsJapgolly.emailAddresses.emailAddressesStrings.`reply-to`
    - typingsJapgolly.emailAddresses.emailAddressesStrings.sender
  */
  trait StartProductions extends StObject
  object StartProductions {
    
    inline def address: typingsJapgolly.emailAddresses.emailAddressesStrings.address = "address".asInstanceOf[typingsJapgolly.emailAddresses.emailAddressesStrings.address]
    
    inline def `address-list`: typingsJapgolly.emailAddresses.emailAddressesStrings.`address-list` = "address-list".asInstanceOf[typingsJapgolly.emailAddresses.emailAddressesStrings.`address-list`]
    
    inline def `angle-addr`: typingsJapgolly.emailAddresses.emailAddressesStrings.`angle-addr` = "angle-addr".asInstanceOf[typingsJapgolly.emailAddresses.emailAddressesStrings.`angle-addr`]
    
    inline def from: typingsJapgolly.emailAddresses.emailAddressesStrings.from = "from".asInstanceOf[typingsJapgolly.emailAddresses.emailAddressesStrings.from]
    
    inline def group: typingsJapgolly.emailAddresses.emailAddressesStrings.group = "group".asInstanceOf[typingsJapgolly.emailAddresses.emailAddressesStrings.group]
    
    inline def mailbox: typingsJapgolly.emailAddresses.emailAddressesStrings.mailbox = "mailbox".asInstanceOf[typingsJapgolly.emailAddresses.emailAddressesStrings.mailbox]
    
    inline def `mailbox-list`: typingsJapgolly.emailAddresses.emailAddressesStrings.`mailbox-list` = "mailbox-list".asInstanceOf[typingsJapgolly.emailAddresses.emailAddressesStrings.`mailbox-list`]
    
    inline def `reply-to`: typingsJapgolly.emailAddresses.emailAddressesStrings.`reply-to` = "reply-to".asInstanceOf[typingsJapgolly.emailAddresses.emailAddressesStrings.`reply-to`]
    
    inline def sender: typingsJapgolly.emailAddresses.emailAddressesStrings.sender = "sender".asInstanceOf[typingsJapgolly.emailAddresses.emailAddressesStrings.sender]
  }
}
