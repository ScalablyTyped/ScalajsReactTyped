...
import typingsJapgolly.elliptic.ellipticStrings.ed25519
import typingsJapgolly.elliptic.mod.curve.edwards
import typingsJapgolly.elliptic.mod.eddsa.Bytes
import typingsJapgolly.elliptic.mod.eddsa.KeyPair
import typingsJapgolly.elliptic.mod.eddsa.Point
import typingsJapgolly.elliptic.mod.eddsa.Signature
