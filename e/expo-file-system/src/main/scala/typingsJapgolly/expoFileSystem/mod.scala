...
object mod extends js.Object {
  ...
  class DownloadResumable protected ()
    extends typingsJapgolly.expoFileSystem.fileSystemMod.DownloadResumable {
  ...
  def createDownloadResumable(uri: String, fileUri: String): typingsJapgolly.expoFileSystem.fileSystemMod.DownloadResumable = js.native
  def createDownloadResumable(uri: String, fileUri: String, options: DownloadOptions): typingsJapgolly.expoFileSystem.fileSystemMod.DownloadResumable = js.native
  def createDownloadResumable(uri: String, fileUri: String, options: DownloadOptions, callback: DownloadProgressCallback): typingsJapgolly.expoFileSystem.fileSystemMod.DownloadResumable = js.native
  def createDownloadResumable(
    ...
    callback: DownloadProgressCallback,
    resumeData: String
  ): typingsJapgolly.expoFileSystem.fileSystemMod.DownloadResumable = js.native
