...
object ExponentFileSystemModule {
  ...
  inline def apply(addListener: String => Callback, removeListeners: Double => Callback): ExponentFileSystemModule = {
    val __obj = js.Dynamic.literal(addListener = js.Any.fromFunction1((t0: String) => addListener(t0).runNow()), name = "ExponentFileSystem", removeListeners = js.Any.fromFunction1((t0: Double) => removeListeners(t0).runNow()), bundleDirectory = null, bundledAssets = null, cacheDirectory = null, documentDirectory = null)
