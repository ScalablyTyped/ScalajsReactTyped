...
name := "express"
version := "4.17-dt-20191101Z-756383"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.github.japgolly.scalajs-react" %%% "core" % "1.4.2",
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.gulliblytyped.japgolly" %%% "body-parser" % "1.17-dt-20190819Z-bea960",
  "org.gulliblytyped.japgolly" %%% "connect" % "v3.4.0-dt-20190322Z-be743f",
  ...
  "org.gulliblytyped.japgolly" %%% "serve-static" % "1.13-dt-20190819Z-4e0976",
