...
object PlayerList {
  ...
  inline def apply(
    ...
    getEntries: CallbackTo[js.Promise[js.Array[String]]],
  ...
  extension [Self <: PlayerList](x: Self) {
    ...
    inline def setGetEntries(value: CallbackTo[js.Promise[js.Array[String]]]): Self = StObject.set(x, "getEntries", value.toJsFn)
