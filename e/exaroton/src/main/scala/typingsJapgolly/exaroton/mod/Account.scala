...
object Account {
  ...
  inline def apply(
    ...
    credits: Double,
    email: String,
    get: CallbackTo[js.Promise[Account]],
    name: String,
    setFromObject: js.Object => Account,
    verified: Boolean
  ): Account = {
    val __obj = js.Dynamic.literal(client = client.asInstanceOf[js.Any], credits = credits.asInstanceOf[js.Any], email = email.asInstanceOf[js.Any], get = get.toJsFn, name = name.asInstanceOf[js.Any], setFromObject = js.Any.fromFunction1(setFromObject), verified = verified.asInstanceOf[js.Any])
  ...
  extension [Self <: Account](x: Self) {
    ...
    inline def setGet(value: CallbackTo[js.Promise[Account]]): Self = StObject.set(x, "get", value.toJsFn)
