...
import typingsJapgolly.ecmarkup.anon.`1`
import typingsJapgolly.ecmarkup.ecmarkupStrings.clause
import typingsJapgolly.ecmarkup.ecmarkupStrings.example
import typingsJapgolly.ecmarkup.ecmarkupStrings.figure
import typingsJapgolly.ecmarkup.ecmarkupStrings.mixed
import typingsJapgolly.ecmarkup.ecmarkupStrings.normal
import typingsJapgolly.ecmarkup.ecmarkupStrings.note
import typingsJapgolly.ecmarkup.ecmarkupStrings.op
import typingsJapgolly.ecmarkup.ecmarkupStrings.production
import typingsJapgolly.ecmarkup.ecmarkupStrings.step
import typingsJapgolly.ecmarkup.ecmarkupStrings.table
import typingsJapgolly.ecmarkup.ecmarkupStrings.term
...
object libBiblioMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ecmarkup.ecmarkupStrings.`abstract operation`
    - typingsJapgolly.ecmarkup.ecmarkupStrings.`host-defined abstract operation`
    - typingsJapgolly.ecmarkup.ecmarkupStrings.`implementation-defined abstract operation`
    - typingsJapgolly.ecmarkup.ecmarkupStrings.`syntax-directed operation`
    - typingsJapgolly.ecmarkup.ecmarkupStrings.`numeric method`
  */
  trait AlgorithmType extends StObject
  object AlgorithmType {
    
    inline def `abstract operation`: typingsJapgolly.ecmarkup.ecmarkupStrings.`abstract operation` = ("abstract operation").asInstanceOf[typingsJapgolly.ecmarkup.ecmarkupStrings.`abstract operation`]
    
    inline def `host-defined abstract operation`: typingsJapgolly.ecmarkup.ecmarkupStrings.`host-defined abstract operation` = ("host-defined abstract operation").asInstanceOf[typingsJapgolly.ecmarkup.ecmarkupStrings.`host-defined abstract operation`]
    
    inline def `implementation-defined abstract operation`: typingsJapgolly.ecmarkup.ecmarkupStrings.`implementation-defined abstract operation` = ("implementation-defined abstract operation").asInstanceOf[typingsJapgolly.ecmarkup.ecmarkupStrings.`implementation-defined abstract operation`]
    
    inline def `numeric method`: typingsJapgolly.ecmarkup.ecmarkupStrings.`numeric method` = ("numeric method").asInstanceOf[typingsJapgolly.ecmarkup.ecmarkupStrings.`numeric method`]
    
    inline def `syntax-directed operation`: typingsJapgolly.ecmarkup.ecmarkupStrings.`syntax-directed operation` = ("syntax-directed operation").asInstanceOf[typingsJapgolly.ecmarkup.ecmarkupStrings.`syntax-directed operation`]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ecmarkup.libBiblioMod.AlgorithmBiblioEntry
    - typingsJapgolly.ecmarkup.libBiblioMod.ProductionBiblioEntry
    - typingsJapgolly.ecmarkup.libBiblioMod.ClauseBiblioEntry
    - typingsJapgolly.ecmarkup.libBiblioMod.TermBiblioEntry
    - typingsJapgolly.ecmarkup.libBiblioMod.FigureBiblioEntry
    - typingsJapgolly.ecmarkup.libBiblioMod.StepBiblioEntry
  */
  trait BiblioEntry extends StObject
  object BiblioEntry {
    
    inline def AlgorithmBiblioEntry(aoid: String, effects: js.Array[String], location: String, referencingIds: js.Array[String]): typingsJapgolly.ecmarkup.libBiblioMod.AlgorithmBiblioEntry = {
      val __obj = js.Dynamic.literal(aoid = aoid.asInstanceOf[js.Any], effects = effects.asInstanceOf[js.Any], location = location.asInstanceOf[js.Any], referencingIds = referencingIds.asInstanceOf[js.Any], signature = null)
      __obj.updateDynamic("type")("op")
      __obj.asInstanceOf[typingsJapgolly.ecmarkup.libBiblioMod.AlgorithmBiblioEntry]
    }
    ...
    inline def ClauseBiblioEntry(
      ...
      __obj.asInstanceOf[typingsJapgolly.ecmarkup.libBiblioMod.ClauseBiblioEntry]
    }
    ...
    inline def FigureBiblioEntry(
      ...
      __obj.asInstanceOf[typingsJapgolly.ecmarkup.libBiblioMod.FigureBiblioEntry]
    }
    
    inline def ProductionBiblioEntry(location: String, name: String, referencingIds: js.Array[String]): typingsJapgolly.ecmarkup.libBiblioMod.ProductionBiblioEntry = {
      ...
      __obj.asInstanceOf[typingsJapgolly.ecmarkup.libBiblioMod.ProductionBiblioEntry]
    }
    
    inline def StepBiblioEntry(id: String, location: String, referencingIds: js.Array[String], stepNumbers: js.Array[Double]): typingsJapgolly.ecmarkup.libBiblioMod.StepBiblioEntry = {
      ...
      __obj.asInstanceOf[typingsJapgolly.ecmarkup.libBiblioMod.StepBiblioEntry]
    }
    
    inline def TermBiblioEntry(location: String, referencingIds: js.Array[String], term: String): typingsJapgolly.ecmarkup.libBiblioMod.TermBiblioEntry = {
      ...
      __obj.asInstanceOf[typingsJapgolly.ecmarkup.libBiblioMod.TermBiblioEntry]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ecmarkup.ecmarkupStrings.location
    - typingsJapgolly.ecmarkup.ecmarkupStrings.referencingIds
    - typingsJapgolly.ecmarkup.ecmarkupStrings.namespace
  */
  trait NonExportedKeys extends StObject
  object NonExportedKeys {
    
    inline def location: typingsJapgolly.ecmarkup.ecmarkupStrings.location = "location".asInstanceOf[typingsJapgolly.ecmarkup.ecmarkupStrings.location]
    
    inline def namespace: typingsJapgolly.ecmarkup.ecmarkupStrings.namespace = "namespace".asInstanceOf[typingsJapgolly.ecmarkup.ecmarkupStrings.namespace]
    
    inline def referencingIds: typingsJapgolly.ecmarkup.ecmarkupStrings.referencingIds = "referencingIds".asInstanceOf[typingsJapgolly.ecmarkup.ecmarkupStrings.referencingIds]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ecmarkup.anon.Kind
    - typingsJapgolly.ecmarkup.anon.`0`
    - typingsJapgolly.ecmarkup.anon.CompletionType
    - typingsJapgolly.ecmarkup.anon.TypeOfValueIfNormal
    - typingsJapgolly.ecmarkup.anon.Elements
    - typingsJapgolly.ecmarkup.anon.Types
    - typingsJapgolly.ecmarkup.anon.Fields
  */
  trait Type extends StObject
  object Type {
    
    inline def `0`(): typingsJapgolly.ecmarkup.anon.`0` = {
      val __obj = js.Dynamic.literal(kind = "unused")
      __obj.asInstanceOf[typingsJapgolly.ecmarkup.anon.`0`]
    }
    
    inline def CompletionType(): typingsJapgolly.ecmarkup.anon.CompletionType = {
      val __obj = js.Dynamic.literal(completionType = "abrupt", kind = "completion")
      __obj.asInstanceOf[typingsJapgolly.ecmarkup.anon.CompletionType]
    }
    
    inline def Elements(): typingsJapgolly.ecmarkup.anon.Elements = {
      val __obj = js.Dynamic.literal(kind = "list", elements = null)
      __obj.asInstanceOf[typingsJapgolly.ecmarkup.anon.Elements]
    }
    
    inline def Fields(fields: Record[String, Type | Null]): typingsJapgolly.ecmarkup.anon.Fields = {
      val __obj = js.Dynamic.literal(fields = fields.asInstanceOf[js.Any], kind = "record")
      __obj.asInstanceOf[typingsJapgolly.ecmarkup.anon.Fields]
    }
    
    inline def Kind(`type`: String): typingsJapgolly.ecmarkup.anon.Kind = {
      val __obj = js.Dynamic.literal(kind = "opaque")
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ecmarkup.anon.Kind]
    }
    
    inline def TypeOfValueIfNormal(completionType: normal | mixed): typingsJapgolly.ecmarkup.anon.TypeOfValueIfNormal = {
      val __obj = js.Dynamic.literal(completionType = completionType.asInstanceOf[js.Any], kind = "completion", typeOfValueIfNormal = null)
      __obj.asInstanceOf[typingsJapgolly.ecmarkup.anon.TypeOfValueIfNormal]
    }
    
    inline def Types(types: js.Array[Exclude[Type, `1`]]): typingsJapgolly.ecmarkup.anon.Types = {
      val __obj = js.Dynamic.literal(kind = "union", types = types.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ecmarkup.anon.Types]
    }
  }
