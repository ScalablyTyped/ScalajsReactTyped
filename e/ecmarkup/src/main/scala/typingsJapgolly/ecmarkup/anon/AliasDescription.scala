...
import typingsJapgolly.ecmarkup.ecmarkupStrings.`Display version info`
import typingsJapgolly.ecmarkup.ecmarkupStrings.v
import typingsJapgolly.ecmarkup.ecmarkupStrings.version
