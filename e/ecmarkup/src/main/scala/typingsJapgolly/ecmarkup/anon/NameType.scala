...
import typingsJapgolly.ecmarkup.ecmarkupStrings.`Path to a file where the JS assets should be written`
import typingsJapgolly.ecmarkup.ecmarkupStrings.`js-out`
