...
trait Effects extends StObject {
  ...
  var description: org.scalajs.dom.Element | Null
  
  var effects: js.Array[String]
  
  var `for`: org.scalajs.dom.Element | Null
...
object Effects {
  ...
  extension [Self <: Effects](x: Self) {
    ...
    inline def setDescription(value: org.scalajs.dom.Element): Self = StObject.set(x, "description", value.asInstanceOf[js.Any])
    ...
    inline def setFor(value: org.scalajs.dom.Element): Self = StObject.set(x, "for", value.asInstanceOf[js.Any])
