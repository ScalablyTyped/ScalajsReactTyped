...
import typingsJapgolly.ecmarkup.ecmarkupStrings.`inline`
import typingsJapgolly.ecmarkup.ecmarkupStrings.draft
import typingsJapgolly.ecmarkup.ecmarkupStrings.external
import typingsJapgolly.ecmarkup.ecmarkupStrings.none
import typingsJapgolly.ecmarkup.ecmarkupStrings.proposal
import typingsJapgolly.ecmarkup.ecmarkupStrings.standard
import typingsJapgolly.ecmarkup.libBiblioMod.ExportedBiblio
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setLog(value: /* msg */ String => Callback): Self = StObject.set(x, "log", js.Any.fromFunction1((t0: /* msg */ String) => value(t0).runNow()))
      ...
      inline def setWarn(value: /* err */ EcmarkupError => Callback): Self = StObject.set(x, "warn", js.Any.fromFunction1((t0: /* err */ EcmarkupError) => value(t0).runNow()))
