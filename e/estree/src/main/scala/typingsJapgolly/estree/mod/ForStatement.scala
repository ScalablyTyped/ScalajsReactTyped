...
trait ForStatement
  ...
  @JSName("type")
  var type_ForStatement: typingsJapgolly.estree.estreeStrings.ForStatement
...
object ForStatement {
  ...
  extension [Self <: ForStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.estree.estreeStrings.ForStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
