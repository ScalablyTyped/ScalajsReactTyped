...
trait YieldExpression
  ...
  @JSName("type")
  var type_YieldExpression: typingsJapgolly.estree.estreeStrings.YieldExpression
}
object YieldExpression {
  ...
  extension [Self <: YieldExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.estree.estreeStrings.YieldExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
