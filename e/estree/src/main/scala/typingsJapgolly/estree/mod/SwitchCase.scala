...
trait SwitchCase
  ...
  @JSName("type")
  var type_SwitchCase: typingsJapgolly.estree.estreeStrings.SwitchCase
}
object SwitchCase {
  ...
  extension [Self <: SwitchCase](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.estree.estreeStrings.SwitchCase): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
