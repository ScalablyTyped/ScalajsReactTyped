...
trait PropertyDefinition
  ...
  @JSName("type")
  var type_PropertyDefinition: typingsJapgolly.estree.estreeStrings.PropertyDefinition
...
object PropertyDefinition {
  ...
  extension [Self <: PropertyDefinition](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.estree.estreeStrings.PropertyDefinition): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
