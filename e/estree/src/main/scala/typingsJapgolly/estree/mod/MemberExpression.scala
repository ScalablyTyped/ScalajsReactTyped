...
trait MemberExpression
  ...
  @JSName("type")
  var type_MemberExpression: typingsJapgolly.estree.estreeStrings.MemberExpression
}
object MemberExpression {
  ...
  extension [Self <: MemberExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.estree.estreeStrings.MemberExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
