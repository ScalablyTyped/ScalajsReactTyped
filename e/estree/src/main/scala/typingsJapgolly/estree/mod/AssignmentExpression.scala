...
trait AssignmentExpression
  ...
  @JSName("type")
  var type_AssignmentExpression: typingsJapgolly.estree.estreeStrings.AssignmentExpression
}
object AssignmentExpression {
  ...
  extension [Self <: AssignmentExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.estree.estreeStrings.AssignmentExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
