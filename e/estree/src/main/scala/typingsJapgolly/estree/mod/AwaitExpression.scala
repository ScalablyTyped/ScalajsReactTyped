...
trait AwaitExpression
  ...
  @JSName("type")
  var type_AwaitExpression: typingsJapgolly.estree.estreeStrings.AwaitExpression
}
object AwaitExpression {
  ...
  extension [Self <: AwaitExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.estree.estreeStrings.AwaitExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
