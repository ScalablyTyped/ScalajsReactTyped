...
trait FunctionExpression
  ...
  @JSName("type")
  var type_FunctionExpression: typingsJapgolly.estree.estreeStrings.FunctionExpression
}
object FunctionExpression {
  ...
  extension [Self <: FunctionExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.estree.estreeStrings.FunctionExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
