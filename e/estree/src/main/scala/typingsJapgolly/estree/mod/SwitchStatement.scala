...
trait SwitchStatement
  ...
  @JSName("type")
  var type_SwitchStatement: typingsJapgolly.estree.estreeStrings.SwitchStatement
}
object SwitchStatement {
  ...
  extension [Self <: SwitchStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.estree.estreeStrings.SwitchStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
