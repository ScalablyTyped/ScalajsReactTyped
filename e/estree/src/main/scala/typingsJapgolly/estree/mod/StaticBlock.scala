...
trait StaticBlock
  ...
  var `type`: typingsJapgolly.estree.estreeStrings.StaticBlock
}
object StaticBlock {
  ...
  extension [Self <: StaticBlock](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.estree.estreeStrings.StaticBlock): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
