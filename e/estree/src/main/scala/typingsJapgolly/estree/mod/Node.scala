...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.estree.mod.Function
  - typingsJapgolly.estree.mod.SwitchCase
  - typingsJapgolly.estree.mod.CatchClause
  - typingsJapgolly.estree.mod.VariableDeclarator
  - typingsJapgolly.estree.mod.Statement
  - typingsJapgolly.estree.mod.Expression
  - typingsJapgolly.estree.mod.Property
  - typingsJapgolly.estree.mod.AssignmentProperty
  - typingsJapgolly.estree.mod.Super
  - typingsJapgolly.estree.mod.TemplateElement
  - typingsJapgolly.estree.mod.SpreadElement
  - typingsJapgolly.estree.mod.Pattern
  - typingsJapgolly.estree.mod.ClassBody
  - typingsJapgolly.estree.mod.Class
  - typingsJapgolly.estree.mod.MethodDefinition
  - typingsJapgolly.estree.mod.ModuleDeclaration
  - typingsJapgolly.estree.mod.ModuleSpecifier
*/
...
object Node {
  ...
  def ForStatement(
    body: Statement,
    `type`: typingsJapgolly.estree.estreeStrings.ForStatement,
  ...
  def ForOfStatement(
    ...
    right: Expression,
    `type`: typingsJapgolly.estree.estreeStrings.ForOfStatement,
    leadingComments: js.Array[Comment] = null,
    loc: SourceLocation = null,
    range: js.Tuple2[Double, Double] = null,
    trailingComments: js.Array[Comment] = null
  ...
  @scala.inline
  def Super(
    `type`: typingsJapgolly.estree.estreeStrings.Super,
    leadingComments: js.Array[Comment] = null,
    loc: SourceLocation = null,
    range: js.Tuple2[Double, Double] = null,
    trailingComments: js.Array[Comment] = null
  ...
  @scala.inline
  def ReturnStatement(
    `type`: typingsJapgolly.estree.estreeStrings.ReturnStatement,
    argument: Expression = null,
    leadingComments: js.Array[Comment] = null,
    loc: SourceLocation = null,
    range: js.Tuple2[Double, Double] = null,
  ...
  def LabeledStatement(
    body: Statement,
    label: Identifier,
    `type`: typingsJapgolly.estree.estreeStrings.LabeledStatement,
    leadingComments: js.Array[Comment] = null,
    loc: SourceLocation = null,
    range: js.Tuple2[Double, Double] = null,
    trailingComments: js.Array[Comment] = null
  ...
  def SwitchCase(
    ...
    `type`: typingsJapgolly.estree.estreeStrings.SwitchCase,
    leadingComments: js.Array[Comment] = null,
    loc: SourceLocation = null,
    range: js.Tuple2[Double, Double] = null,
    test: Expression = null,
  ...
  def ExportSpecifier(
    exported: Identifier,
    local: Identifier,
    `type`: typingsJapgolly.estree.estreeStrings.ExportSpecifier,
    leadingComments: js.Array[Comment] = null,
    loc: SourceLocation = null,
    range: js.Tuple2[Double, Double] = null,
    trailingComments: js.Array[Comment] = null
  ...
  def ForInStatement(
    ...
    left: VariableDeclaration | Pattern,
    right: Expression,
    `type`: typingsJapgolly.estree.estreeStrings.ForInStatement,
    leadingComments: js.Array[Comment] = null,
    loc: SourceLocation = null,
    range: js.Tuple2[Double, Double] = null,
    trailingComments: js.Array[Comment] = null
