...
trait ExpressionMap extends StObject {
  ...
  var ArrayExpression: typingsJapgolly.estree.mod.ArrayExpression
  
  var ArrowFunctionExpression: typingsJapgolly.estree.mod.ArrowFunctionExpression
  
  var AssignmentExpression: typingsJapgolly.estree.mod.AssignmentExpression
  
  var AwaitExpression: typingsJapgolly.estree.mod.AwaitExpression
  
  var BinaryExpression: typingsJapgolly.estree.mod.BinaryExpression
  
  var CallExpression: typingsJapgolly.estree.mod.CallExpression
  
  var ChainExpression: typingsJapgolly.estree.mod.ChainExpression
  
  var ClassExpression: typingsJapgolly.estree.mod.ClassExpression
  
  var ConditionalExpression: typingsJapgolly.estree.mod.ConditionalExpression
  
  var FunctionExpression: typingsJapgolly.estree.mod.FunctionExpression
  
  var Identifier: typingsJapgolly.estree.mod.Identifier
  
  var ImportExpression: typingsJapgolly.estree.mod.ImportExpression
  
  var Literal: typingsJapgolly.estree.mod.Literal
  
  var LogicalExpression: typingsJapgolly.estree.mod.LogicalExpression
  
  var MemberExpression: typingsJapgolly.estree.mod.MemberExpression
  
  var MetaProperty: typingsJapgolly.estree.mod.MetaProperty
  
  var NewExpression: typingsJapgolly.estree.mod.NewExpression
  
  var ObjectExpression: typingsJapgolly.estree.mod.ObjectExpression
  
  var SequenceExpression: typingsJapgolly.estree.mod.SequenceExpression
  
  var TaggedTemplateExpression: typingsJapgolly.estree.mod.TaggedTemplateExpression
  
  var TemplateLiteral: typingsJapgolly.estree.mod.TemplateLiteral
  
  var ThisExpression: typingsJapgolly.estree.mod.ThisExpression
  
  var UnaryExpression: typingsJapgolly.estree.mod.UnaryExpression
  
  var UpdateExpression: typingsJapgolly.estree.mod.UpdateExpression
  
  var YieldExpression: typingsJapgolly.estree.mod.YieldExpression
}
