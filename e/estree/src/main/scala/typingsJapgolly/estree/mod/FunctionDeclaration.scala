...
trait FunctionDeclaration
  ...
  @JSName("type")
  var type_FunctionDeclaration: typingsJapgolly.estree.estreeStrings.FunctionDeclaration
}
object FunctionDeclaration {
  ...
  extension [Self <: FunctionDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.estree.estreeStrings.FunctionDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
