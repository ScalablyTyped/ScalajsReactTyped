...
trait ImportDeclaration
  ...
  @JSName("type")
  var type_ImportDeclaration: typingsJapgolly.estree.estreeStrings.ImportDeclaration
}
object ImportDeclaration {
  ...
  extension [Self <: ImportDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.estree.estreeStrings.ImportDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
