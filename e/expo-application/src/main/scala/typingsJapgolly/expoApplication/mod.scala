...
object mod {
  ...
  object ApplicationReleaseType extends StObject {
    ...
    /* 4 */ val AD_HOC: typingsJapgolly.expoApplication.mod.ApplicationReleaseType.AD_HOC & Double = js.native
    
    @js.native
    sealed trait APP_STORE
      extends StObject
         with ApplicationReleaseType
    /* 5 */ val APP_STORE: typingsJapgolly.expoApplication.mod.ApplicationReleaseType.APP_STORE & Double = js.native
    
    @js.native
    sealed trait DEVELOPMENT
      extends StObject
         with ApplicationReleaseType
    /* 3 */ val DEVELOPMENT: typingsJapgolly.expoApplication.mod.ApplicationReleaseType.DEVELOPMENT & Double = js.native
    
    @js.native
    sealed trait ENTERPRISE
      extends StObject
         with ApplicationReleaseType
    /* 2 */ val ENTERPRISE: typingsJapgolly.expoApplication.mod.ApplicationReleaseType.ENTERPRISE & Double = js.native
    
    @js.native
    sealed trait SIMULATOR
      extends StObject
         with ApplicationReleaseType
    /* 1 */ val SIMULATOR: typingsJapgolly.expoApplication.mod.ApplicationReleaseType.SIMULATOR & Double = js.native
    
    @js.native
    sealed trait UNKNOWN
      extends StObject
         with ApplicationReleaseType
    /* 0 */ val UNKNOWN: typingsJapgolly.expoApplication.mod.ApplicationReleaseType.UNKNOWN & Double = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.expoApplication.expoApplicationStrings.development
    - typingsJapgolly.expoApplication.expoApplicationStrings.production
    - scala.Null
  */
