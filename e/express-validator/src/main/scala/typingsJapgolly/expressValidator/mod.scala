...
import typingsJapgolly.expressValidator.anon.PartialMatchedDataOptions
import typingsJapgolly.expressValidator.anon.Run
import typingsJapgolly.expressValidator.anon.WithDefaults
...
import typingsJapgolly.expressValidator.srcChainSanitizationChainMod.SanitizationChain
import typingsJapgolly.expressValidator.srcChainValidationChainMod.ValidationChain
import typingsJapgolly.expressValidator.srcMiddlewaresOneOfMod.OneOfCustomMessageBuilder
import typingsJapgolly.expressValidator.srcMiddlewaresSchemaMod.Schema
...
object mod {
  ...
  open class Result[T] protected ()
    extends typingsJapgolly.expressValidator.srcValidationResultMod.Result[T] {
