...
trait Msg
  ...
  var location: typingsJapgolly.expressValidator.srcBaseMod.Location
...
object Msg {
  ...
  inline def apply(
    location: typingsJapgolly.expressValidator.srcBaseMod.Location,
    msg: Any,
    param: String,
    value: Any
  ): Msg = {
  ...
  extension [Self <: Msg](x: Self) {
    ...
    inline def setLocation(value: typingsJapgolly.expressValidator.srcBaseMod.Location): Self = StObject.set(x, "location", value.asInstanceOf[js.Any])
