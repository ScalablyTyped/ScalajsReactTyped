...
trait PartialMatchedDataOptions extends StObject {
  ...
  var locations: js.UndefOr[js.Array[typingsJapgolly.expressValidator.srcBaseMod.Location]] = js.undefined
...
object PartialMatchedDataOptions {
  ...
  extension [Self <: PartialMatchedDataOptions](x: Self) {
    ...
    inline def setLocations(value: js.Array[typingsJapgolly.expressValidator.srcBaseMod.Location]): Self = StObject.set(x, "locations", value.asInstanceOf[js.Any])
    
    inline def setLocationsUndefined: Self = StObject.set(x, "locations", js.undefined)
    
    inline def setLocationsVarargs(value: typingsJapgolly.expressValidator.srcBaseMod.Location*): Self = StObject.set(x, "locations", js.Array(value*))
