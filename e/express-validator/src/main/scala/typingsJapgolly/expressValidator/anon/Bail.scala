...
trait Bail[K /* <: /* keyof express-validator.express-validator/src/chain/validators.Validators<any> */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 88, starting with typingsJapgolly.expressValidator.expressValidatorStrings.not, typingsJapgolly.expressValidator.expressValidatorStrings.withMessage, typingsJapgolly.expressValidator.expressValidatorStrings.custom */ Any */]
  extends StObject
...
object Bail {
  ...
  inline def apply[K /* <: /* keyof express-validator.express-validator/src/chain/validators.Validators<any> */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 88, starting with typingsJapgolly.expressValidator.expressValidatorStrings.not, typingsJapgolly.expressValidator.expressValidatorStrings.withMessage, typingsJapgolly.expressValidator.expressValidatorStrings.custom */ Any */](): Bail[K] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Bail[K]]
  }
  
  extension [Self <: Bail[?], K /* <: /* keyof express-validator.express-validator/src/chain/validators.Validators<any> */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 88, starting with typingsJapgolly.expressValidator.expressValidatorStrings.not, typingsJapgolly.expressValidator.expressValidatorStrings.withMessage, typingsJapgolly.expressValidator.expressValidatorStrings.custom */ Any */](x: Self & Bail[K]) {
