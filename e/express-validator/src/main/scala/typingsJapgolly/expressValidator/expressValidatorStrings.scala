...
import typingsJapgolly.expressValidator.srcOptionsMod._URLProtocol
...
object expressValidatorStrings {
  ...
  sealed trait `ar-QM`
    extends StObject
       with AlphaLocale
       with AlphanumericLocale
  inline def `ar-QM`: `ar-QM` = "ar-QM".asInstanceOf[`ar-QM`]
  ...
  sealed trait `ar-SD`
    extends StObject
       with AlphaLocale
       with AlphanumericLocale
  inline def `ar-SD`: `ar-SD` = "ar-SD".asInstanceOf[`ar-SD`]
  ...
  sealed trait crc32
    extends StObject
       with HashAlgorithm
  inline def crc32: crc32 = "crc32".asInstanceOf[crc32]
  
  @js.native
  sealed trait crc32b
    extends StObject
       with HashAlgorithm
  inline def crc32b: crc32b = "crc32b".asInstanceOf[crc32b]
  ...
  sealed trait `dz-BT`
    extends StObject
       with MobilePhoneLocale
  inline def `dz-BT`: `dz-BT` = "dz-BT".asInstanceOf[`dz-BT`]
  ...
  sealed trait `en-BW`
    extends StObject
       with MobilePhoneLocale
  inline def `en-BW`: `en-BW` = "en-BW".asInstanceOf[`en-BW`]
  ...
  sealed trait `en-GY`
    extends StObject
       with MobilePhoneLocale
  inline def `en-GY`: `en-GY` = "en-GY".asInstanceOf[`en-GY`]
  ...
  sealed trait `en-HN`
    extends StObject
       with MobilePhoneLocale
  inline def `en-HN`: `en-HN` = "en-HN".asInstanceOf[`en-HN`]
  ...
  sealed trait `en-NA`
    extends StObject
       with MobilePhoneLocale
  inline def `en-NA`: `en-NA` = "en-NA".asInstanceOf[`en-NA`]
  ...
  sealed trait `es-CU`
    extends StObject
       with MobilePhoneLocale
  inline def `es-CU`: `es-CU` = "es-CU".asInstanceOf[`es-CU`]
  ...
  sealed trait `fr-CM`
    extends StObject
       with MobilePhoneLocale
  inline def `fr-CM`: `fr-CM` = "fr-CM".asInstanceOf[`fr-CM`]
  ...
  sealed trait `fr-PF`
    extends StObject
       with MobilePhoneLocale
  inline def `fr-PF`: `fr-PF` = "fr-PF".asInstanceOf[`fr-PF`]
  ...
  sealed trait ripemd128
    extends StObject
       with HashAlgorithm
  inline def ripemd128: ripemd128 = "ripemd128".asInstanceOf[ripemd128]
  ...
  sealed trait `tg-TJ`
    extends StObject
       with MobilePhoneLocale
  inline def `tg-TJ`: `tg-TJ` = "tg-TJ".asInstanceOf[`tg-TJ`]
  ...
  sealed trait tiger128
    extends StObject
       with HashAlgorithm
  inline def tiger128: tiger128 = "tiger128".asInstanceOf[tiger128]
  
  @js.native
  sealed trait tiger160
    extends StObject
       with HashAlgorithm
  inline def tiger160: tiger160 = "tiger160".asInstanceOf[tiger160]
  
  @js.native
  sealed trait tiger192
    extends StObject
       with HashAlgorithm
  inline def tiger192: tiger192 = "tiger192".asInstanceOf[tiger192]
