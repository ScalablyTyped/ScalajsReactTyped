...
object srcBaseMod {
  ...
  */
  ...
  object Location {
    ...
    inline def body: typingsJapgolly.expressValidator.expressValidatorStrings.body = "body".asInstanceOf[typingsJapgolly.expressValidator.expressValidatorStrings.body]
    
    inline def cookies: typingsJapgolly.expressValidator.expressValidatorStrings.cookies = "cookies".asInstanceOf[typingsJapgolly.expressValidator.expressValidatorStrings.cookies]
    
    inline def headers: typingsJapgolly.expressValidator.expressValidatorStrings.headers = "headers".asInstanceOf[typingsJapgolly.expressValidator.expressValidatorStrings.headers]
    
    inline def params: typingsJapgolly.expressValidator.expressValidatorStrings.params = "params".asInstanceOf[typingsJapgolly.expressValidator.expressValidatorStrings.params]
    
    inline def query: typingsJapgolly.expressValidator.expressValidatorStrings.query = "query".asInstanceOf[typingsJapgolly.expressValidator.expressValidatorStrings.query]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.expressValidator.anon.Location
    - typingsJapgolly.expressValidator.anon.Msg
  */
  trait ValidationError extends StObject
  object ValidationError {
    
    inline def Location(location: Unit, msg: Any, nestedErrors: js.Array[ValidationError], value: Unit): typingsJapgolly.expressValidator.anon.Location = {
      ...
      __obj.asInstanceOf[typingsJapgolly.expressValidator.anon.Location]
    }
    
    inline def Msg(location: Location, msg: Any, param: String, value: Any): typingsJapgolly.expressValidator.anon.Msg = {
      ...
      __obj.asInstanceOf[typingsJapgolly.expressValidator.anon.Msg]
    }
  }
}
