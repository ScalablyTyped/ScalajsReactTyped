...
import typingsJapgolly.enquirer.enquirerStrings.autocomplete
import typingsJapgolly.enquirer.enquirerStrings.confirm
import typingsJapgolly.enquirer.enquirerStrings.editable
import typingsJapgolly.enquirer.enquirerStrings.form
import typingsJapgolly.enquirer.enquirerStrings.input
import typingsJapgolly.enquirer.enquirerStrings.invisible
import typingsJapgolly.enquirer.enquirerStrings.left
import typingsJapgolly.enquirer.enquirerStrings.list
import typingsJapgolly.enquirer.enquirerStrings.multiselect
import typingsJapgolly.enquirer.enquirerStrings.numeral
import typingsJapgolly.enquirer.enquirerStrings.password
import typingsJapgolly.enquirer.enquirerStrings.right
import typingsJapgolly.enquirer.enquirerStrings.scale
import typingsJapgolly.enquirer.enquirerStrings.select
import typingsJapgolly.enquirer.enquirerStrings.snippet
import typingsJapgolly.enquirer.enquirerStrings.sort
import typingsJapgolly.enquirer.enquirerStrings.survey
import typingsJapgolly.enquirer.enquirerStrings.text
...
object mod {
  ...
  - typingsJapgolly.enquirer.mod.PromptOptions because Already inherited */ trait ArrayPromptOptions
    extends StObject
  ...
  object BasePromptOptions {
    ...
    extension [Self <: BasePromptOptions](x: Self) {
      ...
      inline def setMessageCallbackTo(value: CallbackTo[js.Promise[String] | String]): Self = StObject.set(x, "message", value.toJsFn)
      ...
      inline def setTypeCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "type", value.toJsFn)
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.enquirer.mod.PromptOptions because Already inherited */ trait BooleanPromptOptions
    extends StObject
       with BasePromptOptions {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.enquirer.mod.PromptOptions because Already inherited */ trait NumberPromptOptions
    extends StObject
       with BasePromptOptions {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.enquirer.mod.BasePromptOptions
    - typingsJapgolly.enquirer.mod.ArrayPromptOptions
    - typingsJapgolly.enquirer.mod.BooleanPromptOptions
    - typingsJapgolly.enquirer.mod.StringPromptOptions
    - typingsJapgolly.enquirer.mod.NumberPromptOptions
    - typingsJapgolly.enquirer.mod.SnippetPromptOptions
    - typingsJapgolly.enquirer.mod.SortPromptOptions
  */
  ...
  object PromptOptions {
    ...
    inline def ArrayPromptOptions(
      ...
      val __obj = js.Dynamic.literal(choices = choices.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.enquirer.mod.ArrayPromptOptions]
    }
    ...
    inline def BasePromptOptions(
      ...
      val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.enquirer.mod.BasePromptOptions]
    }
    
    inline def BooleanPromptOptions(message: String | (js.Function0[js.Promise[String] | String]), name: String | js.Function0[String]): typingsJapgolly.enquirer.mod.BooleanPromptOptions = {
      val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("confirm")
      __obj.asInstanceOf[typingsJapgolly.enquirer.mod.BooleanPromptOptions]
    }
    
    inline def NumberPromptOptions(message: String | (js.Function0[js.Promise[String] | String]), name: String | js.Function0[String]): typingsJapgolly.enquirer.mod.NumberPromptOptions = {
      val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("numeral")
      __obj.asInstanceOf[typingsJapgolly.enquirer.mod.NumberPromptOptions]
    }
    
    inline def SnippetPromptOptions(message: String | (js.Function0[js.Promise[String] | String]), name: String | js.Function0[String]): typingsJapgolly.enquirer.mod.SnippetPromptOptions = {
      val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("snippet")
      __obj.asInstanceOf[typingsJapgolly.enquirer.mod.SnippetPromptOptions]
    }
    
    inline def SortPromptOptions(message: String | (js.Function0[js.Promise[String] | String]), name: String | js.Function0[String]): typingsJapgolly.enquirer.mod.SortPromptOptions = {
      val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("sort")
      __obj.asInstanceOf[typingsJapgolly.enquirer.mod.SortPromptOptions]
    }
    ...
    inline def StringPromptOptions(
      ...
      val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.enquirer.mod.StringPromptOptions]
    }
  }
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.enquirer.mod.PromptOptions because Already inherited */ trait SnippetPromptOptions
    extends StObject
       with BasePromptOptions {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.enquirer.mod.PromptOptions because Already inherited */ trait SortPromptOptions
    extends StObject
       with BasePromptOptions {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.enquirer.mod.PromptOptions because Already inherited */ trait StringPromptOptions
    extends StObject
       with BasePromptOptions {
