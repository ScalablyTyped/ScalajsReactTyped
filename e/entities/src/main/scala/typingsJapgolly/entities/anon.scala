...
import typingsJapgolly.entities.libEsmGeneratedEncodeHtmlMod.EncodeTrieNode
...
object anon {
  ...
  trait O extends StObject {
    ...
    var n: Double | (Map[Double, typingsJapgolly.entities.libGeneratedEncodeHtmlMod.EncodeTrieNode])
  ...
  object O {
    ...
    inline def apply(n: Double | (Map[Double, typingsJapgolly.entities.libGeneratedEncodeHtmlMod.EncodeTrieNode])): O = {
      val __obj = js.Dynamic.literal(n = n.asInstanceOf[js.Any])
    ...
    extension [Self <: O](x: Self) {
      ...
      inline def setN(value: Double | (Map[Double, typingsJapgolly.entities.libGeneratedEncodeHtmlMod.EncodeTrieNode])): Self = StObject.set(x, "n", value.asInstanceOf[js.Any])
