...
object mod {
  ...
  object DecodingMode extends StObject {
    ...
    sealed trait Legacy
      extends StObject
         with DecodingMode
    /* 0 */ val Legacy: typingsJapgolly.entities.mod.DecodingMode.Legacy & Double = js.native
    ...
    sealed trait Strict
      extends StObject
         with DecodingMode
    /* 1 */ val Strict: typingsJapgolly.entities.mod.DecodingMode.Strict & Double = js.native
  }
  ...
  object EncodingMode extends StObject {
    ...
    sealed trait ASCII
      extends StObject
         with EncodingMode
    /* 1 */ val ASCII: typingsJapgolly.entities.mod.EncodingMode.ASCII & Double = js.native
    ...
    sealed trait Attribute
      extends StObject
         with EncodingMode
    /* 3 */ val Attribute: typingsJapgolly.entities.mod.EncodingMode.Attribute & Double = js.native
    ...
    sealed trait Extensive
      extends StObject
         with EncodingMode
    /* 2 */ val Extensive: typingsJapgolly.entities.mod.EncodingMode.Extensive & Double = js.native
    ...
    sealed trait Text
      extends StObject
         with EncodingMode
    /* 4 */ val Text: typingsJapgolly.entities.mod.EncodingMode.Text & Double = js.native
    ...
    sealed trait UTF8
      extends StObject
         with EncodingMode
    /* 0 */ val UTF8: typingsJapgolly.entities.mod.EncodingMode.UTF8 & Double = js.native
  }
  ...
  object EntityLevel extends StObject {
    ...
    sealed trait HTML
      extends StObject
         with EntityLevel
    /* 1 */ val HTML: typingsJapgolly.entities.mod.EntityLevel.HTML & Double = js.native
    ...
    sealed trait XML
      extends StObject
         with EntityLevel
    /* 0 */ val XML: typingsJapgolly.entities.mod.EntityLevel.XML & Double = js.native
  }
