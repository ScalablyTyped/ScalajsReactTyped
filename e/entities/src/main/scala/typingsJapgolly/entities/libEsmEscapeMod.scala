...
object libEsmEscapeMod {
  
  @JSImport("entities/lib/esm/escape", JSImport.Namespace)
  @js.native
  ...
  @JSImport("entities/lib/esm/escape", "escape")
  @js.native
  ...
  @JSImport("entities/lib/esm/escape", "xmlReplacer")
  @js.native
