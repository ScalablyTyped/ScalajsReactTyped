...
trait CommonOptions extends StObject {
  ...
  var jsx: js.UndefOr[typingsJapgolly.esbuild.esbuildStrings.transform | preserve | automatic] = js.undefined
...
object CommonOptions {
  ...
  extension [Self <: CommonOptions](x: Self) {
    ...
    inline def setJsx(value: typingsJapgolly.esbuild.esbuildStrings.transform | preserve | automatic): Self = StObject.set(x, "jsx", value.asInstanceOf[js.Any])
