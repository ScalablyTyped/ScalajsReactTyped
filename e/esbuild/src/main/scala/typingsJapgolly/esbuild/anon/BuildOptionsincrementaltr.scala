...
import typingsJapgolly.esbuild.esbuildBooleans.`true`
import typingsJapgolly.esbuild.esbuildStrings.`inline`
import typingsJapgolly.esbuild.esbuildStrings.automatic
import typingsJapgolly.esbuild.esbuildStrings.both
import typingsJapgolly.esbuild.esbuildStrings.eof
import typingsJapgolly.esbuild.esbuildStrings.external
import typingsJapgolly.esbuild.esbuildStrings.linked
import typingsJapgolly.esbuild.esbuildStrings.none
import typingsJapgolly.esbuild.esbuildStrings.preserve
import typingsJapgolly.esbuild.esbuildStrings.transform
import typingsJapgolly.esbuild.mod.Charset
import typingsJapgolly.esbuild.mod.Drop
import typingsJapgolly.esbuild.mod.Format
import typingsJapgolly.esbuild.mod.Loader
import typingsJapgolly.esbuild.mod.LogLevel
import typingsJapgolly.esbuild.mod.Platform
import typingsJapgolly.esbuild.mod.Plugin
import typingsJapgolly.esbuild.mod.StdinOptions
import typingsJapgolly.esbuild.mod.WatchMode
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined esbuild.esbuild.BuildOptions & {  incremental :true} */
