package typingsJapgolly.emberDebug.dataAdapterMod

import typingsJapgolly.emberDebug.dataAdapterMod.DataAdapter.Column
import typingsJapgolly.emberDebug.dataAdapterMod.DataAdapter.WrappedRecord
import typingsJapgolly.emberDebug.dataAdapterMod.DataAdapter.WrappedType
...
trait DataAdapter_
  ...
  /**
    ...
    * to list all models.
    */
  var containerDebugAdapter: typingsJapgolly.emberDebug.containerDebugAdapterMod.default = js.native
  /**
