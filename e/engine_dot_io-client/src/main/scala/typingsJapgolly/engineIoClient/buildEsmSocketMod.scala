...
import typingsJapgolly.engineIoClient.anon.PartialSocketOptions
import typingsJapgolly.engineIoClient.anon.Threshold
import typingsJapgolly.engineIoClient.buildEsmTransportMod.CloseDetails
...
object buildEsmSocketMod {
  ...
  open class Socket protected ()
    ...
    /* private */ val offlineEventListener: Any = js.native
