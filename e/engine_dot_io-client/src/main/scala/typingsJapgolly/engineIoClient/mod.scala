...
import typingsJapgolly.engineIoClient.buildEsmTransportsPollingMod.Polling
import typingsJapgolly.engineIoClient.buildEsmTransportsWebsocketMod.WS
...
object mod {
  ...
  open class Socket protected ()
    extends typingsJapgolly.engineIoClient.buildEsmSocketMod.Socket {
    /**
      * Socket constructor.
      *
  ...
  open class Transport protected ()
    extends typingsJapgolly.engineIoClient.buildEsmTransportMod.Transport {
    /**
