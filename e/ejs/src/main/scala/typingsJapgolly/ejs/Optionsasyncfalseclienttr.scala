...
import typingsJapgolly.ejs.ejsBooleans.`false`
import typingsJapgolly.ejs.ejsBooleans.`true`
import typingsJapgolly.ejs.mod.EscapeCallback
...
object Optionsasyncfalseclienttr {
  ...
  def apply(
    ...
    escape: /* markup */ js.UndefOr[js.Any] => CallbackTo[String] = null,
    ...
    if (escape != null) __obj.updateDynamic("escape")(js.Any.fromFunction1((t0: /* markup */ js.UndefOr[js.Any]) => escape(t0).runNow()))
