...
import typingsJapgolly.ethereumjsUtil.distSignatureMod.ECDSASignatureBuffer
...
object mod {
  ...
  open class Account ()
    ...
    def this(nonce: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN) = this()
    def this(nonce: Unit, balance: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN) = this()
    def this(
      nonce: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN,
      balance: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN
    ) = this()
    def this(nonce: Unit, balance: Unit, stateRoot: Buffer) = this()
    def this(nonce: Unit, balance: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN, stateRoot: Buffer) = this()
    def this(nonce: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN, balance: Unit, stateRoot: Buffer) = this()
    def this(
      nonce: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN,
      balance: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN,
      stateRoot: Buffer
  ...
  object Address {
    ...
    /**
      ...
      */
    inline def generate(
      from: typingsJapgolly.ethereumjsUtil.distAddressMod.Address,
      nonce: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN
    ): typingsJapgolly.ethereumjsUtil.distAddressMod.Address = (^.asInstanceOf[js.Dynamic].applyDynamic("generate")(from.asInstanceOf[js.Any], nonce.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.ethereumjsUtil.distAddressMod.Address]
  ...
  open class BN protected ()
    extends typingsJapgolly.ethereumjsUtil.distExternalsMod.BN {
  ...
  @js.native
  val MAX_INTEGER: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN = js.native
  
  @JSImport("ethereumjs-util", "MAX_UINT64")
  @js.native
  val MAX_UINT64: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN = js.native
  
  @JSImport("ethereumjs-util", "TWO_POW256")
  @js.native
  val TWO_POW256: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN = js.native
  ...
  inline def bnToHex(value: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN): PrefixedHexString = ^.asInstanceOf[js.Dynamic].applyDynamic("bnToHex")(value.asInstanceOf[js.Any]).asInstanceOf[PrefixedHexString]
  
  inline def bnToRlp(value: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN): Buffer = ^.asInstanceOf[js.Dynamic].applyDynamic("bnToRlp")(value.asInstanceOf[js.Any]).asInstanceOf[Buffer]
  
  inline def bnToUnpaddedBuffer(value: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN): Buffer = ^.asInstanceOf[js.Dynamic].applyDynamic("bnToUnpaddedBuffer")(value.asInstanceOf[js.Any]).asInstanceOf[Buffer]
  ...
  inline def fromSigned(num: Buffer): typingsJapgolly.ethereumjsUtil.distExternalsMod.BN = ^.asInstanceOf[js.Dynamic].applyDynamic("fromSigned")(num.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ethereumjsUtil.distExternalsMod.BN]
  ...
  object rlp {
    ...
    object default {
      ...
      inline def decode_Union(input: Input): js.typedarray.Uint8Array | typingsJapgolly.rlp.mod.NestedUint8Array = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(input.asInstanceOf[js.Any]).asInstanceOf[js.typedarray.Uint8Array | typingsJapgolly.rlp.mod.NestedUint8Array]
      
      inline def decode_false(input: Input, stream: `false`): js.typedarray.Uint8Array | typingsJapgolly.rlp.mod.NestedUint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(input.asInstanceOf[js.Any], stream.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint8Array | typingsJapgolly.rlp.mod.NestedUint8Array]
  ...
  inline def toUnsigned(num: typingsJapgolly.ethereumjsUtil.distExternalsMod.BN): Buffer = ^.asInstanceOf[js.Dynamic].applyDynamic("toUnsigned")(num.asInstanceOf[js.Any]).asInstanceOf[Buffer]
