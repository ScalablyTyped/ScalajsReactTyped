...
import typingsJapgolly.ethereumjsUtil.signatureMod.ECDSASignature
import typingsJapgolly.node.Buffer
import typingsJapgolly.rlp.typesMod.Decoded
import typingsJapgolly.rlp.typesMod.Input
...
object mod extends js.Object {
  ...
  object BN extends js.Object {
    ...
    /**
      ...
      */
    def max(left: typingsJapgolly.bnJs.mod.BN, right: typingsJapgolly.bnJs.mod.BN): typingsJapgolly.bnJs.mod.BN = js.native
    /**
      * @description returns the minimum of 2 BN instances.
      */
    def min(left: typingsJapgolly.bnJs.mod.BN, right: typingsJapgolly.bnJs.mod.BN): typingsJapgolly.bnJs.mod.BN = js.native
    /**
      * @description  create a reduction context  with the Montgomery trick.
      */
    def mont(num: typingsJapgolly.bnJs.mod.BN): ReductionContext = js.native
    /**
      * @description  create a reduction context
      */
    def red(reductionContext: typingsJapgolly.bnJs.mod.BN): ReductionContext = js.native
