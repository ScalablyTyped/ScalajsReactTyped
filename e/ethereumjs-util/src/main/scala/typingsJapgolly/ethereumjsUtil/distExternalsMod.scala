...
import typingsJapgolly.bnJs.mod.ReductionContext
import typingsJapgolly.bnJs.mod.^
import typingsJapgolly.ethereumjsUtil.distBytesMod._ToBufferInputTypes
import typingsJapgolly.ethereumjsUtil.distTypesMod._BufferLike
import typingsJapgolly.ethereumjsUtil.ethereumjsUtilBooleans.`false`
import typingsJapgolly.ethereumjsUtil.ethereumjsUtilBooleans.`true`
import typingsJapgolly.ethereumjsUtil.ethereumjsUtilInts.`26`
import typingsJapgolly.ethereumjsUtil.ethereumjsUtilStrings.hex
import typingsJapgolly.node.bufferMod.global.Buffer
import typingsJapgolly.rlp.anon.FnCall
...
object distExternalsMod {
  ...
  open class BN protected ()
    ...
    def this(number: typingsJapgolly.bnJs.mod.BN) = this()
    ...
    def this(number: typingsJapgolly.bnJs.mod.BN, base: Double) = this()
    def this(number: typingsJapgolly.bnJs.mod.BN, base: hex) = this()
    def this(number: typingsJapgolly.bnJs.mod.BN, endian: Endianness) = this()
    ...
    def this(number: typingsJapgolly.bnJs.mod.BN, base: Double, endian: Endianness) = this()
    def this(number: typingsJapgolly.bnJs.mod.BN, base: Unit, endian: Endianness) = this()
    def this(number: typingsJapgolly.bnJs.mod.BN, base: hex, endian: Endianness) = this()
  ...
  object BN extends Shortcut {
    ...
    open class ^ protected ()
      extends StObject
         with typingsJapgolly.bnJs.mod.BN {
      def this(number: String) = this()
      def this(number: js.Array[Double]) = this()
      def this(number: js.typedarray.Uint8Array) = this()
      def this(number: Double) = this()
    ...
    val ^ : js.Object & (Instantiable3[
        /* number */ Double | String | js.Array[Double] | js.typedarray.Uint8Array | Buffer | typingsJapgolly.bnJs.mod.BN, 
        /* base */ js.UndefOr[Double | hex], 
        /* endian */ js.UndefOr[Endianness], 
        typingsJapgolly.bnJs.mod.BN
      ]) = js.native
    /* static member */
    ...
    /**
      ...
      */
    /* static member */
    inline def max(left: typingsJapgolly.bnJs.mod.BN, right: typingsJapgolly.bnJs.mod.BN): typingsJapgolly.bnJs.mod.BN = (^.asInstanceOf[js.Dynamic].applyDynamic("max")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bnJs.mod.BN]
    
    /**
      * @description returns the minimum of 2 BN instances.
      */
    /* static member */
    inline def min(left: typingsJapgolly.bnJs.mod.BN, right: typingsJapgolly.bnJs.mod.BN): typingsJapgolly.bnJs.mod.BN = (^.asInstanceOf[js.Dynamic].applyDynamic("min")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bnJs.mod.BN]
    
    /**
      * @description  create a reduction context  with the Montgomery trick.
      */
    /* static member */
    inline def mont(num: typingsJapgolly.bnJs.mod.BN): ReductionContext = ^.asInstanceOf[js.Dynamic].applyDynamic("mont")(num.asInstanceOf[js.Any]).asInstanceOf[ReductionContext]
    
    /**
      * @description  create a reduction context
      */
    /* static member */
    inline def red(reductionContext: typingsJapgolly.bnJs.mod.BN): ReductionContext = ^.asInstanceOf[js.Dynamic].applyDynamic("red")(reductionContext.asInstanceOf[js.Any]).asInstanceOf[ReductionContext]
