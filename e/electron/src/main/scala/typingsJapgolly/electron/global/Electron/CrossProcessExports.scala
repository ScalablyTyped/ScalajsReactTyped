...
import typingsJapgolly.electron.Electron.CrossProcessExports.Clipboard
...
import typingsJapgolly.electron.Electron.CrossProcessExports.CrashReporter
...
import typingsJapgolly.electron.Electron.CrossProcessExports.Shell
