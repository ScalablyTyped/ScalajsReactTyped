...
import typingsJapgolly.electron.electronStrings.confirm
import typingsJapgolly.electron.electronStrings.confirmPin
import typingsJapgolly.electron.electronStrings.providePin
