...
import typingsJapgolly.electron.electronStrings.deferred
import typingsJapgolly.electron.electronStrings.failed
import typingsJapgolly.electron.electronStrings.purchased
import typingsJapgolly.electron.electronStrings.purchasing
import typingsJapgolly.electron.electronStrings.restored
