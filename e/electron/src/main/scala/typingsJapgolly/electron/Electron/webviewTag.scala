...
import typingsJapgolly.electron.electronStrings.`did-attach`
...
import typingsJapgolly.electron.electronStrings.beforeinput
...
import typingsJapgolly.electron.electronStrings.compositionend
import typingsJapgolly.electron.electronStrings.compositionstart
import typingsJapgolly.electron.electronStrings.compositionupdate
import typingsJapgolly.electron.electronStrings.contextmenu_
...
import typingsJapgolly.electron.electronStrings.formdata
...
import typingsJapgolly.electron.electronStrings.keydown_
import typingsJapgolly.electron.electronStrings.keypress
import typingsJapgolly.electron.electronStrings.keyup_
...
import typingsJapgolly.electron.electronStrings.mousedown_
import typingsJapgolly.electron.electronStrings.mouseenter_
import typingsJapgolly.electron.electronStrings.mouseleave_
import typingsJapgolly.electron.electronStrings.mousemove_
import typingsJapgolly.electron.electronStrings.mouseout
import typingsJapgolly.electron.electronStrings.mouseover
import typingsJapgolly.electron.electronStrings.mouseup_
...
import typingsJapgolly.electron.electronStrings.slotchange
...
import typingsJapgolly.electron.electronStrings.webkitanimationend
import typingsJapgolly.electron.electronStrings.webkitanimationiteration
import typingsJapgolly.electron.electronStrings.webkitanimationstart
import typingsJapgolly.electron.electronStrings.webkittransitionend
...
trait WebviewTag
  ...
  def addEventListener_beforeinput(
    `type`: beforeinput,
    listener: js.ThisFunction1[/* this */ org.scalajs.dom.HTMLElement, /* ev */ typingsJapgolly.std.InputEvent, Any]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_beforeinput(
    `type`: beforeinput,
  ...
  /**
    ...
    */
  @JSName("addEventListener")
  def addEventListener_didattach(event: `did-attach`, listener: js.Function1[/* event */ Event, Unit]): this.type = js.native
  @JSName("addEventListener")
  def addEventListener_didattach(event: `did-attach`, listener: js.Function1[/* event */ Event, Unit], useCapture: Boolean): this.type = js.native
  /**
