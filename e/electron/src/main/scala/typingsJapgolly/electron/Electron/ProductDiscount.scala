...
import typingsJapgolly.electron.electronStrings.freeTrial
import typingsJapgolly.electron.electronStrings.payAsYouGo
import typingsJapgolly.electron.electronStrings.payUpFront
