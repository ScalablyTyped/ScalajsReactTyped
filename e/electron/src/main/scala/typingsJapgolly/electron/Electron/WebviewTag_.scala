...
import typingsJapgolly.electron.electronStrings.`console-message`
import typingsJapgolly.electron.electronStrings.`devtools-closed`
import typingsJapgolly.electron.electronStrings.`devtools-focused`
import typingsJapgolly.electron.electronStrings.`devtools-opened`
import typingsJapgolly.electron.electronStrings.`did-change-theme-color`
import typingsJapgolly.electron.electronStrings.`did-fail-load`
import typingsJapgolly.electron.electronStrings.`did-finish-load`
import typingsJapgolly.electron.electronStrings.`did-frame-finish-load`
import typingsJapgolly.electron.electronStrings.`did-navigate-in-page`
import typingsJapgolly.electron.electronStrings.`did-navigate`
import typingsJapgolly.electron.electronStrings.`did-start-loading`
import typingsJapgolly.electron.electronStrings.`did-stop-loading`
import typingsJapgolly.electron.electronStrings.`dom-ready`
import typingsJapgolly.electron.electronStrings.`enter-html-full-screen`
import typingsJapgolly.electron.electronStrings.`found-in-page`
import typingsJapgolly.electron.electronStrings.`ipc-message`
import typingsJapgolly.electron.electronStrings.`leave-html-full-screen`
import typingsJapgolly.electron.electronStrings.`load-commit`
import typingsJapgolly.electron.electronStrings.`media-paused`
import typingsJapgolly.electron.electronStrings.`media-started-playing`
import typingsJapgolly.electron.electronStrings.`new-window`
import typingsJapgolly.electron.electronStrings.`page-favicon-updated`
import typingsJapgolly.electron.electronStrings.`page-title-updated`
import typingsJapgolly.electron.electronStrings.`plugin-crashed`
import typingsJapgolly.electron.electronStrings.`update-target-url`
import typingsJapgolly.electron.electronStrings.`will-navigate`
import typingsJapgolly.electron.electronStrings.abort
import typingsJapgolly.electron.electronStrings.activateSelection
import typingsJapgolly.electron.electronStrings.animationcancel
import typingsJapgolly.electron.electronStrings.animationend
import typingsJapgolly.electron.electronStrings.animationiteration
import typingsJapgolly.electron.electronStrings.animationstart
import typingsJapgolly.electron.electronStrings.auxclick
import typingsJapgolly.electron.electronStrings.blur
import typingsJapgolly.electron.electronStrings.cancel
import typingsJapgolly.electron.electronStrings.canplay
import typingsJapgolly.electron.electronStrings.canplaythrough
import typingsJapgolly.electron.electronStrings.change
import typingsJapgolly.electron.electronStrings.clearSelection
...
import typingsJapgolly.electron.electronStrings.cuechange
import typingsJapgolly.electron.electronStrings.cut
import typingsJapgolly.electron.electronStrings.dblclick
import typingsJapgolly.electron.electronStrings.destroyed
import typingsJapgolly.electron.electronStrings.drag
import typingsJapgolly.electron.electronStrings.dragend
import typingsJapgolly.electron.electronStrings.dragenter
import typingsJapgolly.electron.electronStrings.dragexit
import typingsJapgolly.electron.electronStrings.dragleave
import typingsJapgolly.electron.electronStrings.dragover
import typingsJapgolly.electron.electronStrings.dragstart
import typingsJapgolly.electron.electronStrings.drop
import typingsJapgolly.electron.electronStrings.durationchange
import typingsJapgolly.electron.electronStrings.emptied
import typingsJapgolly.electron.electronStrings.ended
import typingsJapgolly.electron.electronStrings.error
import typingsJapgolly.electron.electronStrings.focus
import typingsJapgolly.electron.electronStrings.focusin
import typingsJapgolly.electron.electronStrings.focusout
import typingsJapgolly.electron.electronStrings.fullscreenchange
import typingsJapgolly.electron.electronStrings.fullscreenerror
import typingsJapgolly.electron.electronStrings.gotpointercapture
import typingsJapgolly.electron.electronStrings.input
import typingsJapgolly.electron.electronStrings.invalid
import typingsJapgolly.electron.electronStrings.keepSelection
import typingsJapgolly.electron.electronStrings.keydown
import typingsJapgolly.electron.electronStrings.keypress
import typingsJapgolly.electron.electronStrings.keyup
import typingsJapgolly.electron.electronStrings.load
import typingsJapgolly.electron.electronStrings.loadeddata
import typingsJapgolly.electron.electronStrings.loadedmetadata
import typingsJapgolly.electron.electronStrings.loadstart
import typingsJapgolly.electron.electronStrings.lostpointercapture
...
import typingsJapgolly.electron.electronStrings.mouseout
import typingsJapgolly.electron.electronStrings.mouseover
import typingsJapgolly.electron.electronStrings.mouseup
import typingsJapgolly.electron.electronStrings.paste
import typingsJapgolly.electron.electronStrings.pause
import typingsJapgolly.electron.electronStrings.play
import typingsJapgolly.electron.electronStrings.playing
import typingsJapgolly.electron.electronStrings.pointercancel
import typingsJapgolly.electron.electronStrings.pointerdown
import typingsJapgolly.electron.electronStrings.pointerenter
import typingsJapgolly.electron.electronStrings.pointerleave
import typingsJapgolly.electron.electronStrings.pointermove
import typingsJapgolly.electron.electronStrings.pointerout
import typingsJapgolly.electron.electronStrings.pointerover
import typingsJapgolly.electron.electronStrings.pointerup
import typingsJapgolly.electron.electronStrings.progress
import typingsJapgolly.electron.electronStrings.ratechange
import typingsJapgolly.electron.electronStrings.reset
import typingsJapgolly.electron.electronStrings.resize
import typingsJapgolly.electron.electronStrings.scroll
import typingsJapgolly.electron.electronStrings.securitypolicyviolation
import typingsJapgolly.electron.electronStrings.seeked
import typingsJapgolly.electron.electronStrings.seeking
import typingsJapgolly.electron.electronStrings.select
import typingsJapgolly.electron.electronStrings.selectionchange
import typingsJapgolly.electron.electronStrings.selectstart
import typingsJapgolly.electron.electronStrings.stalled
import typingsJapgolly.electron.electronStrings.submit
import typingsJapgolly.electron.electronStrings.suspend
import typingsJapgolly.electron.electronStrings.timeupdate
import typingsJapgolly.electron.electronStrings.toggle
import typingsJapgolly.electron.electronStrings.touchcancel
import typingsJapgolly.electron.electronStrings.touchend
import typingsJapgolly.electron.electronStrings.touchmove
import typingsJapgolly.electron.electronStrings.touchstart
import typingsJapgolly.electron.electronStrings.transitioncancel
import typingsJapgolly.electron.electronStrings.transitionend
import typingsJapgolly.electron.electronStrings.transitionrun
import typingsJapgolly.electron.electronStrings.transitionstart
import typingsJapgolly.electron.electronStrings.volumechange
import typingsJapgolly.electron.electronStrings.waiting
import typingsJapgolly.electron.electronStrings.wheel
