...
import typingsJapgolly.electron.electronStrings.`medium-light`
import typingsJapgolly.electron.electronStrings.`modal-panel`
...
import typingsJapgolly.electron.electronStrings.`scroll-touch-end`
...
import typingsJapgolly.electron.electronStrings.move
import typingsJapgolly.electron.electronStrings.moved
