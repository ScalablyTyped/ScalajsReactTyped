...
import typingsJapgolly.electron.electronStrings.`bottom-left`
import typingsJapgolly.electron.electronStrings.`bottom-right`
import typingsJapgolly.electron.electronStrings.`top-left`
import typingsJapgolly.electron.electronStrings.`top-right`
