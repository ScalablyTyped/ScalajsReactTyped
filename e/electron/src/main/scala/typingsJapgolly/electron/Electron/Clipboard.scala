...
trait Clipboard extends EventEmitter {
  ...
  @JSName("readImage")
  def readImage_clipboard(`type`: typingsJapgolly.electron.electronStrings.clipboard): NativeImage = js.native
  @JSName("readImage")
  ...
  @JSName("writeImage")
  def writeImage_clipboard(image: NativeImage, `type`: typingsJapgolly.electron.electronStrings.clipboard): Unit = js.native
  @JSName("writeImage")
