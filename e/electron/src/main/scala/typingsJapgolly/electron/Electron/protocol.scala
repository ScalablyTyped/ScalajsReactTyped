...
object Protocol {
  ...
  inline def apply(
    ...
    registerSchemesAsPrivileged: js.Array[CustomScheme] => Callback,
  ...
  extension [Self <: Protocol](x: Self) {
    ...
    inline def setRegisterSchemesAsPrivileged(value: js.Array[CustomScheme] => Callback): Self = StObject.set(x, "registerSchemesAsPrivileged", js.Any.fromFunction1((t0: js.Array[CustomScheme]) => value(t0).runNow()))
