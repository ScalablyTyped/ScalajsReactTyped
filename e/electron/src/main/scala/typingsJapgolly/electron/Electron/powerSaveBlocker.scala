...
object PowerSaveBlocker {
  ...
  inline def apply(
    ...
    stop: Double => Callback
  ): PowerSaveBlocker = {
    val __obj = js.Dynamic.literal(isStarted = js.Any.fromFunction1(isStarted), start = js.Any.fromFunction1(start), stop = js.Any.fromFunction1((t0: Double) => stop(t0).runNow()))
  ...
  extension [Self <: PowerSaveBlocker](x: Self) {
    ...
    inline def setStop(value: Double => Callback): Self = StObject.set(x, "stop", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
  }
}
