...
trait Clipboard_ extends EventEmitter {
  ...
  def availableFormats_clipboard(`type`: typingsJapgolly.electron.electronStrings.clipboard): js.Array[String] = js.native
  @JSName("availableFormats")
  ...
  @JSName("clear")
  def clear_clipboard(`type`: typingsJapgolly.electron.electronStrings.clipboard): Unit = js.native
  @JSName("clear")
  def clear_selection(`type`: selection): Unit = js.native
  def has(format: String): Boolean = js.native
  @JSName("has")
  def has_clipboard(format: String, `type`: typingsJapgolly.electron.electronStrings.clipboard): Boolean = js.native
  @JSName("has")
  ...
  @JSName("readHTML")
  def readHTML_clipboard(`type`: typingsJapgolly.electron.electronStrings.clipboard): String = js.native
  @JSName("readHTML")
  def readHTML_selection(`type`: selection): String = js.native
  def readImage(): NativeImage_ = js.native
  @JSName("readImage")
  def readImage_clipboard(`type`: typingsJapgolly.electron.electronStrings.clipboard): NativeImage_ = js.native
  @JSName("readImage")
  def readImage_selection(`type`: selection): NativeImage_ = js.native
  def readRTF(): String = js.native
  @JSName("readRTF")
  def readRTF_clipboard(`type`: typingsJapgolly.electron.electronStrings.clipboard): String = js.native
  @JSName("readRTF")
  def readRTF_selection(`type`: selection): String = js.native
  def readText(): String = js.native
  @JSName("readText")
  def readText_clipboard(`type`: typingsJapgolly.electron.electronStrings.clipboard): String = js.native
  @JSName("readText")
  ...
  def writeBookmark_clipboard(title: String, url: String, `type`: typingsJapgolly.electron.electronStrings.clipboard): Unit = js.native
  @JSName("writeBookmark")
  ...
  @JSName("writeBuffer")
  def writeBuffer_clipboard(format: String, buffer: Buffer, `type`: typingsJapgolly.electron.electronStrings.clipboard): Unit = js.native
  @JSName("writeBuffer")
  ...
  @JSName("writeHTML")
  def writeHTML_clipboard(markup: String, `type`: typingsJapgolly.electron.electronStrings.clipboard): Unit = js.native
  @JSName("writeHTML")
  ...
  @JSName("writeImage")
  def writeImage_clipboard(image: NativeImage_, `type`: typingsJapgolly.electron.electronStrings.clipboard): Unit = js.native
  @JSName("writeImage")
  ...
  @JSName("writeRTF")
  def writeRTF_clipboard(text: String, `type`: typingsJapgolly.electron.electronStrings.clipboard): Unit = js.native
  @JSName("writeRTF")
  ...
  @JSName("writeText")
  def writeText_clipboard(text: String, `type`: typingsJapgolly.electron.electronStrings.clipboard): Unit = js.native
  @JSName("writeText")
  def writeText_selection(text: String, `type`: selection): Unit = js.native
  @JSName("write")
  def write_clipboard(data: Data, `type`: typingsJapgolly.electron.electronStrings.clipboard): Unit = js.native
  @JSName("write")
