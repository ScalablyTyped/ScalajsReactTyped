...
import typingsJapgolly.electron.electronStrings.customButtonsOnHover
import typingsJapgolly.electron.electronStrings.dark
import typingsJapgolly.electron.electronStrings.default
import typingsJapgolly.electron.electronStrings.followWindow
import typingsJapgolly.electron.electronStrings.header
import typingsJapgolly.electron.electronStrings.hidden
import typingsJapgolly.electron.electronStrings.hiddenInset
import typingsJapgolly.electron.electronStrings.hud
import typingsJapgolly.electron.electronStrings.inactive
