...
import typingsJapgolly.electron.anon.TypeofBrowserWindow
import typingsJapgolly.electron.anon.TypeofMenu
import typingsJapgolly.electron.anon.TypeofNativeImage
import typingsJapgolly.electron.anon.TypeofNotification
import typingsJapgolly.electron.anon.TypeofSession
import typingsJapgolly.electron.anon.TypeofTouchBar
import typingsJapgolly.electron.anon.TypeofWebContents
import typingsJapgolly.electron.anon.TypeofWebFrameMain
...
trait RemoteMainInterface extends StObject {
  ...
  var BrowserView: Instantiable1[
    ...
    typingsJapgolly.electron.Electron.BrowserView
  ]
  
  var BrowserWindow: TypeofBrowserWindow & (Instantiable1[
    /* options */ js.UndefOr[BrowserWindowConstructorOptions], 
    typingsJapgolly.electron.Electron.BrowserWindow
  ])
  
  var Menu: TypeofMenu & Instantiable0[typingsJapgolly.electron.Electron.Menu]
  ...
  var MessageChannelMain: Instantiable0[typingsJapgolly.electron.Electron.MessageChannelMain]
  
  var Notification: TypeofNotification & (Instantiable1[
    /* options */ js.UndefOr[NotificationConstructorOptions], 
    typingsJapgolly.electron.Electron.Notification
  ])
  
  var ShareMenu: Instantiable1[/* sharingItem */ SharingItem, typingsJapgolly.electron.Electron.ShareMenu]
  
  var TouchBar: TypeofTouchBar & (Instantiable1[
    /* options */ TouchBarConstructorOptions, 
    typingsJapgolly.electron.Electron.TouchBar
  ])
  
  var Tray: Instantiable2[
    /* image */ NativeImage_ | String, 
    /* guid */ js.UndefOr[String], 
    typingsJapgolly.electron.Electron.Tray
  ]
