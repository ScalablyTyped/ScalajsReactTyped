...
import typingsJapgolly.electron.electronStrings.`clipboard-read`
import typingsJapgolly.electron.electronStrings.`display-capture`
import typingsJapgolly.electron.electronStrings.`extension-loaded`
import typingsJapgolly.electron.electronStrings.`extension-ready`
import typingsJapgolly.electron.electronStrings.`extension-unloaded`
import typingsJapgolly.electron.electronStrings.`hid-device-added`
import typingsJapgolly.electron.electronStrings.`hid-device-removed`
import typingsJapgolly.electron.electronStrings.`hid-device-revoked`
import typingsJapgolly.electron.electronStrings.`select-hid-device`
import typingsJapgolly.electron.electronStrings.`select-serial-port`
import typingsJapgolly.electron.electronStrings.`serial-port-added`
import typingsJapgolly.electron.electronStrings.`serial-port-removed`
import typingsJapgolly.electron.electronStrings.`spellcheck-dictionary-download-begin`
import typingsJapgolly.electron.electronStrings.`spellcheck-dictionary-download-failure`
import typingsJapgolly.electron.electronStrings.`spellcheck-dictionary-download-success`
import typingsJapgolly.electron.electronStrings.`spellcheck-dictionary-initialized`
import typingsJapgolly.electron.electronStrings.`will-download`
import typingsJapgolly.electron.electronStrings.fullscreen
import typingsJapgolly.electron.electronStrings.geolocation
import typingsJapgolly.electron.electronStrings.media
import typingsJapgolly.electron.electronStrings.mediaKeySystem
import typingsJapgolly.electron.electronStrings.midi
import typingsJapgolly.electron.electronStrings.midiSysex
import typingsJapgolly.electron.electronStrings.notifications
import typingsJapgolly.electron.electronStrings.openExternal
import typingsJapgolly.electron.electronStrings.pointerLock
import typingsJapgolly.electron.electronStrings.preconnect
