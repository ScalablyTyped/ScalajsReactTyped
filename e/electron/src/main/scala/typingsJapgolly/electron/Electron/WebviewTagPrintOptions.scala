...
import typingsJapgolly.electron.electronStrings.longEdge
import typingsJapgolly.electron.electronStrings.shortEdge
import typingsJapgolly.electron.electronStrings.simplex
