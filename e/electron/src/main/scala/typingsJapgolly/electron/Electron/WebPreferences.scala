...
import typingsJapgolly.electron.electronStrings.`document-user-activation-required`
import typingsJapgolly.electron.electronStrings.`no-user-gesture-required`
import typingsJapgolly.electron.electronStrings.`user-gesture-required`
import typingsJapgolly.electron.electronStrings.animate
import typingsJapgolly.electron.electronStrings.animateOnce
import typingsJapgolly.electron.electronStrings.bypassHeatCheck
import typingsJapgolly.electron.electronStrings.bypassHeatCheckAndEagerCompile
import typingsJapgolly.electron.electronStrings.code
