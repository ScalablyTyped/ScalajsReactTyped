...
import typingsJapgolly.electron.electronStrings.`record-as-much-as-possible`
import typingsJapgolly.electron.electronStrings.`record-continuously`
import typingsJapgolly.electron.electronStrings.`record-until-full`
import typingsJapgolly.electron.electronStrings.`trace-to-console`
