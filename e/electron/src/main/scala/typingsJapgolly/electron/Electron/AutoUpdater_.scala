...
import typingsJapgolly.electron.electronStrings.`before-quit-for-update`
import typingsJapgolly.electron.electronStrings.`checking-for-update`
import typingsJapgolly.electron.electronStrings.`update-available`
import typingsJapgolly.electron.electronStrings.`update-downloaded`
import typingsJapgolly.electron.electronStrings.`update-not-available`
...
@js.native
trait AutoUpdater_ extends EventEmitter {
  @JSName("addListener")
