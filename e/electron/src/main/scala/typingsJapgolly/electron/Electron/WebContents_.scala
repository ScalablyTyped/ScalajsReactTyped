...
import typingsJapgolly.electron.electronStrings.`desktop-capturer-get-sources`
...
import typingsJapgolly.electron.electronStrings.`remote-get-builtin`
import typingsJapgolly.electron.electronStrings.`remote-get-current-web-contents`
import typingsJapgolly.electron.electronStrings.`remote-get-current-window`
import typingsJapgolly.electron.electronStrings.`remote-get-global`
import typingsJapgolly.electron.electronStrings.`remote-get-guest-web-contents`
import typingsJapgolly.electron.electronStrings.`remote-require`
...
class WebContents_ () extends EventEmitter {
  ...
  def getType(): backgroundPage | window | browserView | typingsJapgolly.electron.electronStrings.remote | webview | offscreen = js.native
