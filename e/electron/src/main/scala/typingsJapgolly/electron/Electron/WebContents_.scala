...
import typingsJapgolly.electron.anon.Action
import typingsJapgolly.electron.anon.OverrideBrowserWindowOptions
import typingsJapgolly.electron.electronStrings.HTMLComplete
import typingsJapgolly.electron.electronStrings.HTMLOnly
import typingsJapgolly.electron.electronStrings.MHTML
import typingsJapgolly.electron.electronStrings.`background-tab`
import typingsJapgolly.electron.electronStrings.`before-input-event`
import typingsJapgolly.electron.electronStrings.`certificate-error`
import typingsJapgolly.electron.electronStrings.`console-message`
import typingsJapgolly.electron.electronStrings.`context-menu`
import typingsJapgolly.electron.electronStrings.`cursor-changed`
...
import typingsJapgolly.electron.electronStrings.`devtools-reload-page`
import typingsJapgolly.electron.electronStrings.`did-attach-webview`
import typingsJapgolly.electron.electronStrings.`did-change-theme-color`
import typingsJapgolly.electron.electronStrings.`did-create-window`
import typingsJapgolly.electron.electronStrings.`did-fail-load`
import typingsJapgolly.electron.electronStrings.`did-fail-provisional-load`
...
import typingsJapgolly.electron.electronStrings.`did-frame-navigate`
...
import typingsJapgolly.electron.electronStrings.`did-redirect-navigation`
import typingsJapgolly.electron.electronStrings.`did-start-loading`
import typingsJapgolly.electron.electronStrings.`did-start-navigation`
...
import typingsJapgolly.electron.electronStrings.`frame-created`
import typingsJapgolly.electron.electronStrings.`ipc-message-sync`
...
import typingsJapgolly.electron.electronStrings.`preferred-size-changed`
import typingsJapgolly.electron.electronStrings.`preload-error`
import typingsJapgolly.electron.electronStrings.`render-process-gone`
import typingsJapgolly.electron.electronStrings.`save-to-disk`
import typingsJapgolly.electron.electronStrings.`select-bluetooth-device`
import typingsJapgolly.electron.electronStrings.`select-client-certificate`
import typingsJapgolly.electron.electronStrings.`update-target-url`
import typingsJapgolly.electron.electronStrings.`will-attach-webview`
import typingsJapgolly.electron.electronStrings.`will-navigate`
import typingsJapgolly.electron.electronStrings.`will-prevent-unload`
import typingsJapgolly.electron.electronStrings.`will-redirect`
import typingsJapgolly.electron.electronStrings.`zoom-changed`
import typingsJapgolly.electron.electronStrings.activateSelection
import typingsJapgolly.electron.electronStrings.animate
import typingsJapgolly.electron.electronStrings.animateOnce
import typingsJapgolly.electron.electronStrings.backgroundPage
import typingsJapgolly.electron.electronStrings.blur
import typingsJapgolly.electron.electronStrings.browserView
...
import typingsJapgolly.electron.electronStrings.default_public_and_private_interfaces
import typingsJapgolly.electron.electronStrings.default_public_interface_only
import typingsJapgolly.electron.electronStrings.destroyed
import typingsJapgolly.electron.electronStrings.disable_non_proxied_udp
import typingsJapgolly.electron.electronStrings.focus
import typingsJapgolly.electron.electronStrings.in
import typingsJapgolly.electron.electronStrings.keepSelection
import typingsJapgolly.electron.electronStrings.login
import typingsJapgolly.electron.electronStrings.noAnimation
import typingsJapgolly.electron.electronStrings.offscreen
import typingsJapgolly.electron.electronStrings.other
import typingsJapgolly.electron.electronStrings.out
import typingsJapgolly.electron.electronStrings.paint
import typingsJapgolly.electron.electronStrings.remote
