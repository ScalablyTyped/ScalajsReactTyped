...
import typingsJapgolly.electron.electronStrings.digest
import typingsJapgolly.electron.electronStrings.negotiate
import typingsJapgolly.electron.electronStrings.ntlm
