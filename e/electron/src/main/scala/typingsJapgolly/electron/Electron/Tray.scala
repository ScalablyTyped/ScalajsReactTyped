...
import typingsJapgolly.electron.electronStrings.`balloon-click`
import typingsJapgolly.electron.electronStrings.`balloon-closed`
import typingsJapgolly.electron.electronStrings.`balloon-show`
import typingsJapgolly.electron.electronStrings.`double-click`
import typingsJapgolly.electron.electronStrings.`drag-end`
import typingsJapgolly.electron.electronStrings.`drag-enter`
import typingsJapgolly.electron.electronStrings.`drag-leave`
import typingsJapgolly.electron.electronStrings.`drop-files`
import typingsJapgolly.electron.electronStrings.`drop-text`
import typingsJapgolly.electron.electronStrings.`mouse-down`
import typingsJapgolly.electron.electronStrings.`mouse-enter`
import typingsJapgolly.electron.electronStrings.`mouse-leave`
import typingsJapgolly.electron.electronStrings.`mouse-move`
import typingsJapgolly.electron.electronStrings.`mouse-up`
import typingsJapgolly.electron.electronStrings.`right-click`
