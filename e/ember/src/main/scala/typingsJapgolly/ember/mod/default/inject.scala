...
object inject extends js.Object {
  /**
    ...
    */
  def controller(): typingsJapgolly.ember.mod.Ember.ComputedProperty[
    typingsJapgolly.ember.mod.Ember.Controller, 
    typingsJapgolly.ember.mod.Ember.Controller
  ] = js.native
  def controller[K /* <: java.lang.String */](name: K): typingsJapgolly.ember.mod.Ember.ComputedProperty[
  ...
  object service extends js.Object {
    def apply(): typingsJapgolly.emberObject.computedMod.ComputedProperty[typingsJapgolly.emberService.mod.Service, typingsJapgolly.emberService.mod.Service] = js.native
    ...
    def apply[K /* <: java.lang.String */](name: K): typingsJapgolly.emberObject.computedMod.ComputedProperty[
