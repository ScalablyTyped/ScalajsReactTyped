...
import typingsJapgolly.ember.TypeofEventTarget
import typingsJapgolly.ember.TypeofPromise
import typingsJapgolly.ember.emberBooleans.`false`
import typingsJapgolly.ember.emberBooleans.`true`
import typingsJapgolly.ember.emberStrings.^
...
object RSVP extends js.Object {
  ...
  def allSettled[T](entries: js.Array[Arg[T]], label: java.lang.String): typingsJapgolly.rsvp.mod.RSVP.Promise[js.Array[PromiseState[T]]] = js.native
  ...
  def allSettled[T1, T2](entries: js.Tuple2[Arg[T1], Arg[T2]], label: java.lang.String): typingsJapgolly.rsvp.mod.RSVP.Promise[js.Tuple2[PromiseState[T1], PromiseState[T2]]] = js.native
  ...
  def allSettled[T1, T2, T3](entries: js.Tuple3[Arg[T1], Arg[T2], Arg[T3]], label: java.lang.String): typingsJapgolly.rsvp.mod.RSVP.Promise[js.Tuple3[PromiseState[T1], PromiseState[T2], PromiseState[T3]]] = js.native
  ...
  def allSettled[T1, T2, T3, T4](entries: js.Tuple4[Arg[T1], Arg[T2], Arg[T3], Arg[T4]], label: java.lang.String): typingsJapgolly.rsvp.mod.RSVP.Promise[
    js.Tuple4[PromiseState[T1], PromiseState[T2], PromiseState[T3], PromiseState[T4]]
  ] = js.native
  ...
  def allSettled[T1, T2, T3, T4, T5](entries: js.Tuple5[Arg[T1], Arg[T2], Arg[T3], Arg[T4], Arg[T5]], label: java.lang.String): typingsJapgolly.rsvp.mod.RSVP.Promise[
    js.Tuple5[PromiseState[T1], PromiseState[T2], PromiseState[T3], PromiseState[T4], PromiseState[T5]]
  ] = js.native
  ...
  def allSettled[T1, T2, T3, T4, T5, T6](entries: js.Tuple6[Arg[T1], Arg[T2], Arg[T3], Arg[T4], Arg[T5], Arg[T6]], label: java.lang.String): typingsJapgolly.rsvp.mod.RSVP.Promise[
    js.Tuple6[
      PromiseState[T1], 
      PromiseState[T2], 
      PromiseState[T3], 
  ...
  ): js.Function1[/* arg1 */ A, typingsJapgolly.rsvp.mod.RSVP.Promise[^  with js.Any]] = js.native
  ...
  def filter[T](entries: js.Array[Arg[T]], filterFn: js.Function1[/* item */ T, Boolean], label: java.lang.String): typingsJapgolly.rsvp.mod.RSVP.Promise[js.Array[T]] = js.native
  ...
  def map[T, U](entries: js.Array[Arg[T]], mapFn: js.Function1[/* item */ T, U], label: java.lang.String): typingsJapgolly.rsvp.mod.RSVP.Promise[js.Array[U] with Anon8] = js.native
  ...
  def map[T1, T2, U](
    ...
    label: java.lang.String
  ): typingsJapgolly.rsvp.mod.RSVP.Promise[js.Array[U] with Anon7] = js.native
  ...
  type Promise[T] = typingsJapgolly.rsvp.mod.default.Promise[T]
}
