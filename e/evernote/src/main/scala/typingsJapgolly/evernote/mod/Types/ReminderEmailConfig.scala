...
object ReminderEmailConfig extends StObject {
  ...
  /* 1 */ val DO_NOT_SEND: typingsJapgolly.evernote.mod.Types.ReminderEmailConfig.DO_NOT_SEND & Double = js.native
  
  @js.native
  sealed trait SEND_DAILY_EMAIL
    extends StObject
       with ReminderEmailConfig
  /* 2 */ val SEND_DAILY_EMAIL: typingsJapgolly.evernote.mod.Types.ReminderEmailConfig.SEND_DAILY_EMAIL & Double = js.native
}
