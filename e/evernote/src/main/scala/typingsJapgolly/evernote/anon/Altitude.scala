...
trait Altitude extends StObject {
  ...
  var conflictSourceNoteGuid: js.UndefOr[typingsJapgolly.evernote.mod.Types.Guid] = js.undefined
...
object Altitude {
  ...
  extension [Self <: Altitude](x: Self) {
    ...
    inline def setConflictSourceNoteGuid(value: typingsJapgolly.evernote.mod.Types.Guid): Self = StObject.set(x, "conflictSourceNoteGuid", value.asInstanceOf[js.Any])
