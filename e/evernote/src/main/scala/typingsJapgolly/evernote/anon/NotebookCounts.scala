...
trait NotebookCounts extends StObject {
  ...
  var notebookCounts: js.UndefOr[Record[typingsJapgolly.evernote.mod.Types.Guid, Double]] = js.undefined
  
  var tagCounts: js.UndefOr[Record[typingsJapgolly.evernote.mod.Types.Guid, Double]] = js.undefined
...
object NotebookCounts {
  ...
  extension [Self <: NotebookCounts](x: Self) {
    ...
    inline def setNotebookCounts(value: Record[typingsJapgolly.evernote.mod.Types.Guid, Double]): Self = StObject.set(x, "notebookCounts", value.asInstanceOf[js.Any])
    
    inline def setNotebookCountsUndefined: Self = StObject.set(x, "notebookCounts", js.undefined)
    
    inline def setTagCounts(value: Record[typingsJapgolly.evernote.mod.Types.Guid, Double]): Self = StObject.set(x, "tagCounts", value.asInstanceOf[js.Any])
