...
trait AccountLimits extends StObject {
  ...
  var accountLimits: js.UndefOr[typingsJapgolly.evernote.mod.Types.AccountLimits] = js.undefined
...
object AccountLimits {
  ...
  extension [Self <: AccountLimits](x: Self) {
    ...
    inline def setAccountLimits(value: typingsJapgolly.evernote.mod.Types.AccountLimits): Self = StObject.set(x, "accountLimits", value.asInstanceOf[js.Any])
