...
trait Note extends StObject {
  ...
  var note: js.UndefOr[typingsJapgolly.evernote.mod.Types.Note] = js.undefined
...
object Note {
  ...
  extension [Self <: Note](x: Self) {
    ...
    inline def setNote(value: typingsJapgolly.evernote.mod.Types.Note): Self = StObject.set(x, "note", value.asInstanceOf[js.Any])
