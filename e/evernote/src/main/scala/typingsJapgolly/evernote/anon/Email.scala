...
import typingsJapgolly.evernote.mod.Types.SharedNotebookRecipientSettings
...
trait Email extends StObject {
  ...
  var notebookGuid: js.UndefOr[typingsJapgolly.evernote.mod.Types.Guid] = js.undefined
  
  var notebookModifiable: js.UndefOr[Boolean] = js.undefined
  
  var privilege: js.UndefOr[SharedNotebookPrivilegeLevel] = js.undefined
  
  var recipientIdentityId: js.UndefOr[typingsJapgolly.evernote.mod.Types.IdentityID] = js.undefined
...
object Email {
  ...
  extension [Self <: Email](x: Self) {
    ...
    inline def setNotebookGuid(value: typingsJapgolly.evernote.mod.Types.Guid): Self = StObject.set(x, "notebookGuid", value.asInstanceOf[js.Any])
    ...
    inline def setRecipientIdentityId(value: typingsJapgolly.evernote.mod.Types.IdentityID): Self = StObject.set(x, "recipientIdentityId", value.asInstanceOf[js.Any])
