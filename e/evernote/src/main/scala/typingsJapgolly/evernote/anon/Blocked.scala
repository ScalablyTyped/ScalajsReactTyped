...
trait Blocked extends StObject {
  ...
  var id: js.UndefOr[typingsJapgolly.evernote.mod.Types.IdentityID] = js.undefined
...
object Blocked {
  ...
  extension [Self <: Blocked](x: Self) {
    ...
    inline def setId(value: typingsJapgolly.evernote.mod.Types.IdentityID): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
