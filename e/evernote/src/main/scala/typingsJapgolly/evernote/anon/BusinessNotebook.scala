...
trait BusinessNotebook extends StObject {
  ...
  var businessNotebook: js.UndefOr[typingsJapgolly.evernote.mod.Types.BusinessNotebook] = js.undefined
...
object BusinessNotebook {
  ...
  extension [Self <: BusinessNotebook](x: Self) {
    ...
    inline def setBusinessNotebook(value: typingsJapgolly.evernote.mod.Types.BusinessNotebook): Self = StObject.set(x, "businessNotebook", value.asInstanceOf[js.Any])
