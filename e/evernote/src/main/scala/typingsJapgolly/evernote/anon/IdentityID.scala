...
trait IdentityID extends StObject {
  ...
  var identityID: js.UndefOr[typingsJapgolly.evernote.mod.Types.IdentityID] = js.undefined
...
object IdentityID {
  ...
  extension [Self <: IdentityID](x: Self) {
    ...
    inline def setIdentityID(value: typingsJapgolly.evernote.mod.Types.IdentityID): Self = StObject.set(x, "identityID", value.asInstanceOf[js.Any])
