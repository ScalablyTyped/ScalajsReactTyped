...
import typingsJapgolly.evernote.mod.Types.Data
...
trait AlternateData extends StObject {
  ...
  var noteguid: js.UndefOr[typingsJapgolly.evernote.mod.Types.Guid] = js.undefined
...
object AlternateData {
  ...
  extension [Self <: AlternateData](x: Self) {
    ...
    inline def setNoteguid(value: typingsJapgolly.evernote.mod.Types.Guid): Self = StObject.set(x, "noteguid", value.asInstanceOf[js.Any])
