...
trait Attributes extends StObject {
  ...
  var tagGuids: js.UndefOr[js.Array[typingsJapgolly.evernote.mod.Types.Guid]] = js.undefined
...
object Attributes {
  ...
  extension [Self <: Attributes](x: Self) {
    ...
    inline def setTagGuids(value: js.Array[typingsJapgolly.evernote.mod.Types.Guid]): Self = StObject.set(x, "tagGuids", value.asInstanceOf[js.Any])
    
    inline def setTagGuidsUndefined: Self = StObject.set(x, "tagGuids", js.undefined)
    
    inline def setTagGuidsVarargs(value: typingsJapgolly.evernote.mod.Types.Guid*): Self = StObject.set(x, "tagGuids", js.Array(value*))
