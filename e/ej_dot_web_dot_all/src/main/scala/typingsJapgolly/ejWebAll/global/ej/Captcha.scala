...
open class Captcha protected ()
  extends StObject
     with typingsJapgolly.ejWebAll.ej.Captcha {
...
object Captcha {
  ...
  @js.native
  def fn: typingsJapgolly.ejWebAll.ej.Captcha = js.native
  inline def fn_=(x: typingsJapgolly.ejWebAll.ej.Captcha): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
