...
import typingsJapgolly.ejWebAll.ej.Changes
...
open class TableModel protected ()
  extends StObject
     with typingsJapgolly.ejWebAll.ej.TableModel {
  def this(
    name: String,
    jsonArray: js.Array[Any],
    dataManager: typingsJapgolly.ejWebAll.ej.DataManager,
    modelComputed: Any
  ) = this()
  ...
  /* CompleteClass */
  override def setDataManager(dataManager: typingsJapgolly.ejWebAll.ej.DataManager): Unit = js.native
