...
open class DropDownList protected ()
  extends StObject
     with typingsJapgolly.ejWebAll.ej.DropDownList {
...
object DropDownList {
  ...
  @js.native
  def fn: typingsJapgolly.ejWebAll.ej.DropDownList = js.native
  inline def fn_=(x: typingsJapgolly.ejWebAll.ej.DropDownList): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
