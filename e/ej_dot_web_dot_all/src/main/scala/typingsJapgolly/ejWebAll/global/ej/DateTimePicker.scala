...
open class DateTimePicker protected ()
  extends StObject
     with typingsJapgolly.ejWebAll.ej.DateTimePicker {
...
object DateTimePicker {
  ...
  @js.native
  def fn: typingsJapgolly.ejWebAll.ej.DateTimePicker = js.native
  inline def fn_=(x: typingsJapgolly.ejWebAll.ej.DateTimePicker): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
