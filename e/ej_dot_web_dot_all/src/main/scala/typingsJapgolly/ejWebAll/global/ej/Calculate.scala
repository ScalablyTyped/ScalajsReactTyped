...
open class Calculate protected ()
  extends StObject
     with typingsJapgolly.ejWebAll.ej.Calculate {
  ...
  /* CompleteClass */
  var defaults: typingsJapgolly.ejWebAll.ej.Model = js.native
  
  /* CompleteClass */
  var model: typingsJapgolly.ejWebAll.ej.Model = js.native
}
object Calculate {
  ...
  @js.native
  def fn: typingsJapgolly.ejWebAll.ej.Calculate = js.native
  inline def fn_=(x: typingsJapgolly.ejWebAll.ej.Calculate): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
