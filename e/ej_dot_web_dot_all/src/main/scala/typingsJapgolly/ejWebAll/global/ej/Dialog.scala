...
open class Dialog protected ()
  extends StObject
     with typingsJapgolly.ejWebAll.ej.Dialog {
...
object Dialog {
  ...
  @js.native
  def fn: typingsJapgolly.ejWebAll.ej.Dialog = js.native
  inline def fn_=(x: typingsJapgolly.ejWebAll.ej.Dialog): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
