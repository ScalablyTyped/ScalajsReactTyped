...
open class WaitingPopup protected ()
  extends StObject
     with typingsJapgolly.ejWebAll.ej.WaitingPopup {
...
object WaitingPopup {
  ...
  @js.native
  def fn: typingsJapgolly.ejWebAll.ej.WaitingPopup = js.native
  inline def fn_=(x: typingsJapgolly.ejWebAll.ej.WaitingPopup): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
