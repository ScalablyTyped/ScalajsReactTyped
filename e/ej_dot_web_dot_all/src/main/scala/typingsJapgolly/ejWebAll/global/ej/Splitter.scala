...
open class Splitter protected ()
  extends StObject
     with typingsJapgolly.ejWebAll.ej.Splitter {
...
object Splitter {
  ...
  @js.native
  def fn: typingsJapgolly.ejWebAll.ej.Splitter = js.native
  inline def fn_=(x: typingsJapgolly.ejWebAll.ej.Splitter): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
