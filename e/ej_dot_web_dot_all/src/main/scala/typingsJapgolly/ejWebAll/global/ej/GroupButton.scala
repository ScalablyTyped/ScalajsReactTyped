...
open class GroupButton protected ()
  extends StObject
     with typingsJapgolly.ejWebAll.ej.GroupButton {
...
object GroupButton {
  ...
  @js.native
  def fn: typingsJapgolly.ejWebAll.ej.GroupButton = js.native
  inline def fn_=(x: typingsJapgolly.ejWebAll.ej.GroupButton): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
