...
open class MaskEdit protected ()
  extends StObject
     with typingsJapgolly.ejWebAll.ej.MaskEdit {
...
object MaskEdit {
  ...
  @js.native
  def fn: typingsJapgolly.ejWebAll.ej.MaskEdit = js.native
  inline def fn_=(x: typingsJapgolly.ejWebAll.ej.MaskEdit): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
