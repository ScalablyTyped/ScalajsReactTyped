...
open class ListView protected ()
  extends StObject
     with typingsJapgolly.ejWebAll.ej.ListView {
...
object ListView {
  ...
  @js.native
  def fn: typingsJapgolly.ejWebAll.ej.ListView = js.native
  inline def fn_=(x: typingsJapgolly.ejWebAll.ej.ListView): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
