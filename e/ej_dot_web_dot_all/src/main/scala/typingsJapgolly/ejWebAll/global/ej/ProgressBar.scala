...
open class ProgressBar protected ()
  extends StObject
     with typingsJapgolly.ejWebAll.ej.ProgressBar {
...
object ProgressBar {
  ...
  @js.native
  def fn: typingsJapgolly.ejWebAll.ej.ProgressBar = js.native
  inline def fn_=(x: typingsJapgolly.ejWebAll.ej.ProgressBar): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
