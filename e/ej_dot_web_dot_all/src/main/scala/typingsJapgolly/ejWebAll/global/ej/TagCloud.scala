...
open class TagCloud protected ()
  extends StObject
     with typingsJapgolly.ejWebAll.ej.TagCloud {
...
object TagCloud {
  ...
  @js.native
  def fn: typingsJapgolly.ejWebAll.ej.TagCloud = js.native
  inline def fn_=(x: typingsJapgolly.ejWebAll.ej.TagCloud): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
