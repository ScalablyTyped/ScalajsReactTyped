...
trait Typeofdatavisualization extends js.Object {
  val Barcode: TypeofBarcode
  val BulletGraph: TypeofBulletGraph
  val Chart: TypeofChart
  val CircularGauge: TypeofCircularGauge
  val Diagram: TypeofDiagram
  val DigitalGauge: TypeofDigitalGauge
  val HeatMap: TypeofHeatMap
  val HeatMapLegend: TypeofHeatMapLegend
  val LinearGauge: TypeofLinearGauge
  val Map: TypeofMap
  val Overview: TypeofOverview
  val RangeNavigator: TypeofRangeNavigator
  val Sparkline: TypeofSparklineInstantiable
  val Sunburst: js.Any
  val SunburstChart: TypeofSunburstChartInstantiable
  val SymbolPalette: TypeofSymbolPalette
  val TreeMap: TypeofTreeMap
}
