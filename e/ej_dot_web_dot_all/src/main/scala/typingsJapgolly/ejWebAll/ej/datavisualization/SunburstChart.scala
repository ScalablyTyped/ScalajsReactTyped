...
import typingsJapgolly.ejWebAll.ej.SunburstChart.Model
...
object SunburstChart {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.datavisualization.SunburstChart.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.datavisualization.SunburstChart.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.datavisualization.SunburstChart.Model](x: Self) {
