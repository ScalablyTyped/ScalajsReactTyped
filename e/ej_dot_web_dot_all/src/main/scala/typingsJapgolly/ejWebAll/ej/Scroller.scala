...
object Scroller {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Scroller.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Scroller.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Scroller.Model](x: Self) {
      ...
      inline def setThumbEnd(value: /* e */ ThumbEndEventArgs => Callback): Self = StObject.set(x, "thumbEnd", js.Any.fromFunction1((t0: /* e */ ThumbEndEventArgs) => value(t0).runNow()))
      
      inline def setThumbEndUndefined: Self = StObject.set(x, "thumbEnd", js.undefined)
      
      inline def setThumbMove(value: /* e */ ThumbMoveEventArgs => Callback): Self = StObject.set(x, "thumbMove", js.Any.fromFunction1((t0: /* e */ ThumbMoveEventArgs) => value(t0).runNow()))
      
      inline def setThumbMoveUndefined: Self = StObject.set(x, "thumbMove", js.undefined)
      
      inline def setThumbStart(value: /* e */ ThumbStartEventArgs => Callback): Self = StObject.set(x, "thumbStart", js.Any.fromFunction1((t0: /* e */ ThumbStartEventArgs) => value(t0).runNow()))
      
      inline def setThumbStartUndefined: Self = StObject.set(x, "thumbStart", js.undefined)
      
      inline def setWheelMove(value: /* e */ WheelMoveEventArgs => Callback): Self = StObject.set(x, "wheelMove", js.Any.fromFunction1((t0: /* e */ WheelMoveEventArgs) => value(t0).runNow()))
      
      inline def setWheelMoveUndefined: Self = StObject.set(x, "wheelMove", js.undefined)
      
      inline def setWheelStart(value: /* e */ WheelStartEventArgs => Callback): Self = StObject.set(x, "wheelStart", js.Any.fromFunction1((t0: /* e */ WheelStartEventArgs) => value(t0).runNow()))
      
      inline def setWheelStartUndefined: Self = StObject.set(x, "wheelStart", js.undefined)
      
      inline def setWheelStop(value: /* e */ WheelStopEventArgs => Callback): Self = StObject.set(x, "wheelStop", js.Any.fromFunction1((t0: /* e */ WheelStopEventArgs) => value(t0).runNow()))
