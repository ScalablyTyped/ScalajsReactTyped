...
object RTE {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.RTE.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.RTE.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.RTE.Model](x: Self) {
      ...
      inline def setExecute(value: /* e */ ExecuteEventArgs => Callback): Self = StObject.set(x, "execute", js.Any.fromFunction1((t0: /* e */ ExecuteEventArgs) => value(t0).runNow()))
