...
object CircularGauge {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.datavisualization.CircularGauge.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.datavisualization.CircularGauge.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.datavisualization.CircularGauge.Model](x: Self) {
      ...
      inline def setDrawPointerCap(value: /* e */ DrawPointerCapEventArgs => Callback): Self = StObject.set(x, "drawPointerCap", js.Any.fromFunction1((t0: /* e */ DrawPointerCapEventArgs) => value(t0).runNow()))
      
      inline def setDrawPointerCapUndefined: Self = StObject.set(x, "drawPointerCap", js.undefined)
      
      inline def setDrawPointers(value: /* e */ DrawPointersEventArgs => Callback): Self = StObject.set(x, "drawPointers", js.Any.fromFunction1((t0: /* e */ DrawPointersEventArgs) => value(t0).runNow()))
      ...
      inline def setLegendItemClick(value: /* e */ LegendItemClickEventArgs => Callback): Self = StObject.set(x, "legendItemClick", js.Any.fromFunction1((t0: /* e */ LegendItemClickEventArgs) => value(t0).runNow()))
      
      inline def setLegendItemClickUndefined: Self = StObject.set(x, "legendItemClick", js.undefined)
      
      inline def setLegendItemRender(value: /* e */ LegendItemRenderEventArgs => Callback): Self = StObject.set(x, "legendItemRender", js.Any.fromFunction1((t0: /* e */ LegendItemRenderEventArgs) => value(t0).runNow()))
      ...
      inline def setRangeMouseMove(value: /* e */ RangeMouseMoveEventArgs => Callback): Self = StObject.set(x, "rangeMouseMove", js.Any.fromFunction1((t0: /* e */ RangeMouseMoveEventArgs) => value(t0).runNow()))
