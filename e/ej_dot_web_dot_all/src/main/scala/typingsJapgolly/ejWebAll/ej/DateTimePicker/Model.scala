...
import typingsJapgolly.ejWebAll.ej.DatePicker.Header
import typingsJapgolly.ejWebAll.ej.DatePicker.Level
import typingsJapgolly.ejWebAll.ej.popupPosition
...
trait Model extends js.Object {
  ...
  /** Specifies the popup position of DateTimePicker.See below to know available popup positions
    ...
    */
  var popupPosition: js.UndefOr[String | typingsJapgolly.ejWebAll.ej.popupPosition] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    locale: String = null,
    maxDateTime: String | js.Date = null,
    minDateTime: String | js.Date = null,
    ...
    if (beforeClose != null) __obj.updateDynamic("beforeClose")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DateTimePicker.BeforeCloseEventArgs) => beforeClose(t0).runNow()))
    if (beforeOpen != null) __obj.updateDynamic("beforeOpen")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DateTimePicker.BeforeOpenEventArgs) => beforeOpen(t0).runNow()))
    if (blackoutDates != null) __obj.updateDynamic("blackoutDates")(blackoutDates.asInstanceOf[js.Any])
    if (buttonText != null) __obj.updateDynamic("buttonText")(buttonText.asInstanceOf[js.Any])
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DateTimePicker.ChangeEventArgs) => change(t0).runNow()))
    if (close != null) __obj.updateDynamic("close")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DateTimePicker.CloseEventArgs) => close(t0).runNow()))
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DateTimePicker.CreateEventArgs) => create(t0).runNow()))
    ...
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DateTimePicker.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (focusIn != null) __obj.updateDynamic("focusIn")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DateTimePicker.FocusInEventArgs) => focusIn(t0).runNow()))
    if (focusOut != null) __obj.updateDynamic("focusOut")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DateTimePicker.FocusOutEventArgs) => focusOut(t0).runNow()))
    ...
    if (open != null) __obj.updateDynamic("open")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DateTimePicker.OpenEventArgs) => open(t0).runNow()))
