...
class TreeGrid_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.TreeGrid.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.TreeGrid.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.TreeGrid.Model = js.native
  @JSName("model")
  var model_TreeGrid_ : typingsJapgolly.ejWebAll.ej.TreeGrid.Model = js.native
