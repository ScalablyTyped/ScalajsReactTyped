...
object ColorPicker {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.ColorPicker.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.ColorPicker.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.ColorPicker.Model](x: Self) {
