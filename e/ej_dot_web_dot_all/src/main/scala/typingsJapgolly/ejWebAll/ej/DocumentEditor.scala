...
object DocumentEditor {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.DocumentEditor.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.DocumentEditor.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.DocumentEditor.Model](x: Self) {
      ...
      inline def setOnDocumentChange(value: /* e */ OnDocumentChangeEventArgs => Callback): Self = StObject.set(x, "onDocumentChange", js.Any.fromFunction1((t0: /* e */ OnDocumentChangeEventArgs) => value(t0).runNow()))
      
      inline def setOnDocumentChangeUndefined: Self = StObject.set(x, "onDocumentChange", js.undefined)
      
      inline def setOnRequestNavigate(value: /* e */ OnRequestNavigateEventArgs => Callback): Self = StObject.set(x, "onRequestNavigate", js.Any.fromFunction1((t0: /* e */ OnRequestNavigateEventArgs) => value(t0).runNow()))
      
      inline def setOnRequestNavigateUndefined: Self = StObject.set(x, "onRequestNavigate", js.undefined)
      
      inline def setOnSelectionChange(value: /* e */ OnSelectionChangeEventArgs => Callback): Self = StObject.set(x, "onSelectionChange", js.Any.fromFunction1((t0: /* e */ OnSelectionChangeEventArgs) => value(t0).runNow()))
      
      inline def setOnSelectionChangeUndefined: Self = StObject.set(x, "onSelectionChange", js.undefined)
      
      inline def setOnZoomFactorChange(value: /* e */ OnZoomFactorChangeEventArgs => Callback): Self = StObject.set(x, "onZoomFactorChange", js.Any.fromFunction1((t0: /* e */ OnZoomFactorChangeEventArgs) => value(t0).runNow()))
