package typingsJapgolly.ejWebAll.ej.Splitter
...
object Model {
  ...
  def apply(
    ...
    beforeExpandCollapse: /* e */ BeforeExpandCollapseEventArgs => Callback = null,
    clickOnExpander: /* e */ ClickOnExpanderEventArgs => Callback = null,
    ...
    expandCollapse: /* e */ ExpandCollapseEventArgs => Callback = null,
    ...
    if (beforeExpandCollapse != null) __obj.updateDynamic("beforeExpandCollapse")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Splitter.BeforeExpandCollapseEventArgs) => beforeExpandCollapse(t0).runNow()))
    if (clickOnExpander != null) __obj.updateDynamic("clickOnExpander")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Splitter.ClickOnExpanderEventArgs) => clickOnExpander(t0).runNow()))
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Splitter.CreateEventArgs) => create(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Splitter.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (expandCollapse != null) __obj.updateDynamic("expandCollapse")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Splitter.ExpandCollapseEventArgs) => expandCollapse(t0).runNow()))
    ...
    if (resize != null) __obj.updateDynamic("resize")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Splitter.ResizeEventArgs) => resize(t0).runNow()))
