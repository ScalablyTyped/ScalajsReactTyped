...
object DateTimePicker {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.DateTimePicker.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.DateTimePicker.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.DateTimePicker.Model](x: Self) {
