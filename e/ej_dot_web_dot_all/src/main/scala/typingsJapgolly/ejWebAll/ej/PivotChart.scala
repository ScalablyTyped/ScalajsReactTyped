...
object PivotChart {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.PivotChart.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.PivotChart.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.PivotChart.Model](x: Self) {
      ...
      inline def setBeforeSeriesRender(value: /* e */ BeforeSeriesRenderEventArgs => Callback): Self = StObject.set(x, "beforeSeriesRender", js.Any.fromFunction1((t0: /* e */ BeforeSeriesRenderEventArgs) => value(t0).runNow()))
