...
import typingsJapgolly.ejWebAll.ej.PivotChart.ChartTypes
import typingsJapgolly.ejWebAll.ej.PivotGrid.Layout
...
object PivotClient {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.PivotClient.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.PivotClient.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.PivotClient.Model](x: Self) {
      
      inline def setAfterServiceInvoke(value: /* e */ AfterServiceInvokeEventArgs => Callback): Self = StObject.set(x, "afterServiceInvoke", js.Any.fromFunction1((t0: /* e */ AfterServiceInvokeEventArgs) => value(t0).runNow()))
      ...
      inline def setAxesLabelRendering(value: /* e */ AxesLabelRenderingEventArgs => Callback): Self = StObject.set(x, "axesLabelRendering", js.Any.fromFunction1((t0: /* e */ AxesLabelRenderingEventArgs) => value(t0).runNow()))
      
      inline def setAxesLabelRenderingUndefined: Self = StObject.set(x, "axesLabelRendering", js.undefined)
      
      inline def setBeforeExport(value: /* e */ BeforeExportEventArgs => Callback): Self = StObject.set(x, "beforeExport", js.Any.fromFunction1((t0: /* e */ BeforeExportEventArgs) => value(t0).runNow()))
      
      inline def setBeforeExportUndefined: Self = StObject.set(x, "beforeExport", js.undefined)
      
      inline def setBeforeServiceInvoke(value: /* e */ BeforeServiceInvokeEventArgs => Callback): Self = StObject.set(x, "beforeServiceInvoke", js.Any.fromFunction1((t0: /* e */ BeforeServiceInvokeEventArgs) => value(t0).runNow()))
      ...
      inline def setChartLoad(value: /* e */ ChartLoadEventArgs => Callback): Self = StObject.set(x, "chartLoad", js.Any.fromFunction1((t0: /* e */ ChartLoadEventArgs) => value(t0).runNow()))
      ...
      inline def setDrillThrough(value: /* e */ DrillThroughEventArgs => Callback): Self = StObject.set(x, "drillThrough", js.Any.fromFunction1((t0: /* e */ DrillThroughEventArgs) => value(t0).runNow()))
      ...
      inline def setFetchReport(value: /* e */ FetchReportEventArgs => Callback): Self = StObject.set(x, "fetchReport", js.Any.fromFunction1((t0: /* e */ FetchReportEventArgs) => value(t0).runNow()))
      ...
      inline def setLoadReport(value: /* e */ LoadReportEventArgs => Callback): Self = StObject.set(x, "loadReport", js.Any.fromFunction1((t0: /* e */ LoadReportEventArgs) => value(t0).runNow()))
      ...
      inline def setRenderComplete(value: /* e */ RenderCompleteEventArgs => Callback): Self = StObject.set(x, "renderComplete", js.Any.fromFunction1((t0: /* e */ RenderCompleteEventArgs) => value(t0).runNow()))
      
      inline def setRenderCompleteUndefined: Self = StObject.set(x, "renderComplete", js.undefined)
      
      inline def setRenderFailure(value: /* e */ RenderFailureEventArgs => Callback): Self = StObject.set(x, "renderFailure", js.Any.fromFunction1((t0: /* e */ RenderFailureEventArgs) => value(t0).runNow()))
      
      inline def setRenderFailureUndefined: Self = StObject.set(x, "renderFailure", js.undefined)
      
      inline def setRenderSuccess(value: /* e */ RenderSuccessEventArgs => Callback): Self = StObject.set(x, "renderSuccess", js.Any.fromFunction1((t0: /* e */ RenderSuccessEventArgs) => value(t0).runNow()))
      
      inline def setRenderSuccessUndefined: Self = StObject.set(x, "renderSuccess", js.undefined)
      
      inline def setSaveReport(value: /* e */ SaveReportEventArgs => Callback): Self = StObject.set(x, "saveReport", js.Any.fromFunction1((t0: /* e */ SaveReportEventArgs) => value(t0).runNow()))
      
      inline def setSaveReportUndefined: Self = StObject.set(x, "saveReport", js.undefined)
      
      inline def setSchemaLoad(value: /* e */ SchemaLoadEventArgs => Callback): Self = StObject.set(x, "schemaLoad", js.Any.fromFunction1((t0: /* e */ SchemaLoadEventArgs) => value(t0).runNow()))
      ...
      inline def setTreeMapLoad(value: /* e */ TreeMapLoadEventArgs => Callback): Self = StObject.set(x, "treeMapLoad", js.Any.fromFunction1((t0: /* e */ TreeMapLoadEventArgs) => value(t0).runNow()))
      ...
      inline def setValueCellHyperlinkClick(value: /* e */ ValueCellHyperlinkClickEventArgs => Callback): Self = StObject.set(x, "valueCellHyperlinkClick", js.Any.fromFunction1((t0: /* e */ ValueCellHyperlinkClickEventArgs) => value(t0).runNow()))
