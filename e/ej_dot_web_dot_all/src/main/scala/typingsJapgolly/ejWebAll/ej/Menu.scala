...
object Menu {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Menu.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Menu.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Menu.Model](x: Self) {
