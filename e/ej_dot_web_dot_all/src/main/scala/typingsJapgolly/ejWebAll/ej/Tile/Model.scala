...
object Model {
  ...
  def apply(
    ...
    if (mouseDown != null) __obj.updateDynamic("mouseDown")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Tile.MouseDownEventArgs) => mouseDown(t0).runNow()))
    if (mouseUp != null) __obj.updateDynamic("mouseUp")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Tile.MouseUpEventArgs) => mouseUp(t0).runNow()))
