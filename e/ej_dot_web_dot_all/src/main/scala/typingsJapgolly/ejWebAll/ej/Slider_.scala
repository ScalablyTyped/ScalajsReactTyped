...
object Slider_ {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Slider_.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Slider_.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Slider_.Model](x: Self) {
      ...
      inline def setRenderingTicks(value: /* e */ RenderingTicksEventArgs => Callback): Self = StObject.set(x, "renderingTicks", js.Any.fromFunction1((t0: /* e */ RenderingTicksEventArgs) => value(t0).runNow()))
      ...
      inline def setSlide(value: /* e */ SlideEventArgs => Callback): Self = StObject.set(x, "slide", js.Any.fromFunction1((t0: /* e */ SlideEventArgs) => value(t0).runNow()))
      ...
      inline def setStop(value: /* e */ StopEventArgs => Callback): Self = StObject.set(x, "stop", js.Any.fromFunction1((t0: /* e */ StopEventArgs) => value(t0).runNow()))
      
      inline def setStopUndefined: Self = StObject.set(x, "stop", js.undefined)
      
      inline def setTooltipChange(value: /* e */ TooltipChangeEventArgs => Callback): Self = StObject.set(x, "tooltipChange", js.Any.fromFunction1((t0: /* e */ TooltipChangeEventArgs) => value(t0).runNow()))
