...
object NavigationDrawer {
  ...
  object AjaxSettings {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.NavigationDrawer.AjaxSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.NavigationDrawer.AjaxSettings]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.NavigationDrawer.AjaxSettings](x: Self) {
  ...
  trait Model extends StObject {
    ...
    /** Specifies the ajaxSettings option to load the content to the NavigationDrawer control.
      * @Default {null}
      */
    var ajaxSettings: js.UndefOr[typingsJapgolly.ejWebAll.ej.NavigationDrawer.AjaxSettings] = js.undefined
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.NavigationDrawer.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.NavigationDrawer.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.NavigationDrawer.Model](x: Self) {
      ...
      inline def setAjaxSettings(value: typingsJapgolly.ejWebAll.ej.NavigationDrawer.AjaxSettings): Self = StObject.set(x, "ajaxSettings", value.asInstanceOf[js.Any])
      ...
      inline def setSwipe(value: /* e */ SwipeEventArgs => Callback): Self = StObject.set(x, "swipe", js.Any.fromFunction1((t0: /* e */ SwipeEventArgs) => value(t0).runNow()))
