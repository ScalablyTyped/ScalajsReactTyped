...
object Resizable {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Resizable.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Resizable.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Resizable.Model](x: Self) {
