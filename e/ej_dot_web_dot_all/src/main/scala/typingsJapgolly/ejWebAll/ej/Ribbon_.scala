...
class Ribbon_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.Ribbon.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.Ribbon.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.Ribbon.Model = js.native
  @JSName("model")
  var model_Ribbon_ : typingsJapgolly.ejWebAll.ej.Ribbon.Model = js.native
