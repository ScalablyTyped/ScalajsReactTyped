...
object Editor {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Editor.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Editor.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Editor.Model](x: Self) {
