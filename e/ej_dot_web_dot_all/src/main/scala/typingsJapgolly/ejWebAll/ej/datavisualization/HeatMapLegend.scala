...
import typingsJapgolly.ejWebAll.ej.datavisualization.HeatMap.LegendMode
import typingsJapgolly.ejWebAll.ej.datavisualization.HeatMap.LegendOrientation
import typingsJapgolly.ejWebAll.ej.datavisualization.HeatMap.TextDecoration
...
object HeatMapLegend {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.datavisualization.HeatMapLegend.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.datavisualization.HeatMapLegend.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.datavisualization.HeatMapLegend.Model](x: Self) {
