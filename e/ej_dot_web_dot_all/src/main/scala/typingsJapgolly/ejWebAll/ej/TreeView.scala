...
object TreeView {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.TreeView.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.TreeView.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.TreeView.Model](x: Self) {
      ...
      inline def setBeforeAdd(value: /* e */ BeforeAddEventArgs => Callback): Self = StObject.set(x, "beforeAdd", js.Any.fromFunction1((t0: /* e */ BeforeAddEventArgs) => value(t0).runNow()))
      
      inline def setBeforeAddUndefined: Self = StObject.set(x, "beforeAdd", js.undefined)
      
      inline def setBeforeCollapse(value: /* e */ BeforeCollapseEventArgs => Callback): Self = StObject.set(x, "beforeCollapse", js.Any.fromFunction1((t0: /* e */ BeforeCollapseEventArgs) => value(t0).runNow()))
      
      inline def setBeforeCollapseUndefined: Self = StObject.set(x, "beforeCollapse", js.undefined)
      
      inline def setBeforeCut(value: /* e */ BeforeCutEventArgs => Callback): Self = StObject.set(x, "beforeCut", js.Any.fromFunction1((t0: /* e */ BeforeCutEventArgs) => value(t0).runNow()))
      
      inline def setBeforeCutUndefined: Self = StObject.set(x, "beforeCut", js.undefined)
      
      inline def setBeforeDelete(value: /* e */ BeforeDeleteEventArgs => Callback): Self = StObject.set(x, "beforeDelete", js.Any.fromFunction1((t0: /* e */ BeforeDeleteEventArgs) => value(t0).runNow()))
      
      inline def setBeforeDeleteUndefined: Self = StObject.set(x, "beforeDelete", js.undefined)
      
      inline def setBeforeEdit(value: /* e */ BeforeEditEventArgs => Callback): Self = StObject.set(x, "beforeEdit", js.Any.fromFunction1((t0: /* e */ BeforeEditEventArgs) => value(t0).runNow()))
      
      inline def setBeforeEditUndefined: Self = StObject.set(x, "beforeEdit", js.undefined)
      
      inline def setBeforeExpand(value: /* e */ BeforeExpandEventArgs => Callback): Self = StObject.set(x, "beforeExpand", js.Any.fromFunction1((t0: /* e */ BeforeExpandEventArgs) => value(t0).runNow()))
      
      inline def setBeforeExpandUndefined: Self = StObject.set(x, "beforeExpand", js.undefined)
      
      inline def setBeforeLoad(value: /* e */ BeforeLoadEventArgs => Callback): Self = StObject.set(x, "beforeLoad", js.Any.fromFunction1((t0: /* e */ BeforeLoadEventArgs) => value(t0).runNow()))
      
      inline def setBeforeLoadUndefined: Self = StObject.set(x, "beforeLoad", js.undefined)
      
      inline def setBeforePaste(value: /* e */ BeforePasteEventArgs => Callback): Self = StObject.set(x, "beforePaste", js.Any.fromFunction1((t0: /* e */ BeforePasteEventArgs) => value(t0).runNow()))
      
      inline def setBeforePasteUndefined: Self = StObject.set(x, "beforePaste", js.undefined)
      
      inline def setBeforeSelect(value: /* e */ BeforeSelectEventArgs => Callback): Self = StObject.set(x, "beforeSelect", js.Any.fromFunction1((t0: /* e */ BeforeSelectEventArgs) => value(t0).runNow()))
      ...
      inline def setInlineEditValidation(value: /* e */ InlineEditValidationEventArgs => Callback): Self = StObject.set(x, "inlineEditValidation", js.Any.fromFunction1((t0: /* e */ InlineEditValidationEventArgs) => value(t0).runNow()))
      ...
      inline def setLoadError(value: /* e */ LoadErrorEventArgs => Callback): Self = StObject.set(x, "loadError", js.Any.fromFunction1((t0: /* e */ LoadErrorEventArgs) => value(t0).runNow()))
      ...
      inline def setLoadSuccess(value: /* e */ LoadSuccessEventArgs => Callback): Self = StObject.set(x, "loadSuccess", js.Any.fromFunction1((t0: /* e */ LoadSuccessEventArgs) => value(t0).runNow()))
      
      inline def setLoadSuccessUndefined: Self = StObject.set(x, "loadSuccess", js.undefined)
      
      inline def setNodeAdd(value: /* e */ NodeAddEventArgs => Callback): Self = StObject.set(x, "nodeAdd", js.Any.fromFunction1((t0: /* e */ NodeAddEventArgs) => value(t0).runNow()))
      
      inline def setNodeAddUndefined: Self = StObject.set(x, "nodeAdd", js.undefined)
      
      inline def setNodeCheck(value: /* e */ NodeCheckEventArgs => Callback): Self = StObject.set(x, "nodeCheck", js.Any.fromFunction1((t0: /* e */ NodeCheckEventArgs) => value(t0).runNow()))
      
      inline def setNodeCheckUndefined: Self = StObject.set(x, "nodeCheck", js.undefined)
      
      inline def setNodeClick(value: /* e */ NodeClickEventArgs => Callback): Self = StObject.set(x, "nodeClick", js.Any.fromFunction1((t0: /* e */ NodeClickEventArgs) => value(t0).runNow()))
      
      inline def setNodeClickUndefined: Self = StObject.set(x, "nodeClick", js.undefined)
      
      inline def setNodeCollapse(value: /* e */ NodeCollapseEventArgs => Callback): Self = StObject.set(x, "nodeCollapse", js.Any.fromFunction1((t0: /* e */ NodeCollapseEventArgs) => value(t0).runNow()))
      
      inline def setNodeCollapseUndefined: Self = StObject.set(x, "nodeCollapse", js.undefined)
      
      inline def setNodeCut(value: /* e */ NodeCutEventArgs => Callback): Self = StObject.set(x, "nodeCut", js.Any.fromFunction1((t0: /* e */ NodeCutEventArgs) => value(t0).runNow()))
      
      inline def setNodeCutUndefined: Self = StObject.set(x, "nodeCut", js.undefined)
      
      inline def setNodeDelete(value: /* e */ NodeDeleteEventArgs => Callback): Self = StObject.set(x, "nodeDelete", js.Any.fromFunction1((t0: /* e */ NodeDeleteEventArgs) => value(t0).runNow()))
      
      inline def setNodeDeleteUndefined: Self = StObject.set(x, "nodeDelete", js.undefined)
      
      inline def setNodeDrag(value: /* e */ NodeDragEventArgs => Callback): Self = StObject.set(x, "nodeDrag", js.Any.fromFunction1((t0: /* e */ NodeDragEventArgs) => value(t0).runNow()))
      
      inline def setNodeDragStart(value: /* e */ NodeDragStartEventArgs => Callback): Self = StObject.set(x, "nodeDragStart", js.Any.fromFunction1((t0: /* e */ NodeDragStartEventArgs) => value(t0).runNow()))
      
      inline def setNodeDragStartUndefined: Self = StObject.set(x, "nodeDragStart", js.undefined)
      
      inline def setNodeDragStop(value: /* e */ NodeDragStopEventArgs => Callback): Self = StObject.set(x, "nodeDragStop", js.Any.fromFunction1((t0: /* e */ NodeDragStopEventArgs) => value(t0).runNow()))
      ...
      inline def setNodeDropped(value: /* e */ NodeDroppedEventArgs => Callback): Self = StObject.set(x, "nodeDropped", js.Any.fromFunction1((t0: /* e */ NodeDroppedEventArgs) => value(t0).runNow()))
      
      inline def setNodeDroppedUndefined: Self = StObject.set(x, "nodeDropped", js.undefined)
      
      inline def setNodeEdit(value: /* e */ NodeEditEventArgs => Callback): Self = StObject.set(x, "nodeEdit", js.Any.fromFunction1((t0: /* e */ NodeEditEventArgs) => value(t0).runNow()))
      
      inline def setNodeEditUndefined: Self = StObject.set(x, "nodeEdit", js.undefined)
      
      inline def setNodeExpand(value: /* e */ NodeExpandEventArgs => Callback): Self = StObject.set(x, "nodeExpand", js.Any.fromFunction1((t0: /* e */ NodeExpandEventArgs) => value(t0).runNow()))
      
      inline def setNodeExpandUndefined: Self = StObject.set(x, "nodeExpand", js.undefined)
      
      inline def setNodePaste(value: /* e */ NodePasteEventArgs => Callback): Self = StObject.set(x, "nodePaste", js.Any.fromFunction1((t0: /* e */ NodePasteEventArgs) => value(t0).runNow()))
      
      inline def setNodePasteUndefined: Self = StObject.set(x, "nodePaste", js.undefined)
      
      inline def setNodeSelect(value: /* e */ NodeSelectEventArgs => Callback): Self = StObject.set(x, "nodeSelect", js.Any.fromFunction1((t0: /* e */ NodeSelectEventArgs) => value(t0).runNow()))
      
      inline def setNodeSelectUndefined: Self = StObject.set(x, "nodeSelect", js.undefined)
      
      inline def setNodeUncheck(value: /* e */ NodeUncheckEventArgs => Callback): Self = StObject.set(x, "nodeUncheck", js.Any.fromFunction1((t0: /* e */ NodeUncheckEventArgs) => value(t0).runNow()))
      
      inline def setNodeUncheckUndefined: Self = StObject.set(x, "nodeUncheck", js.undefined)
      
      inline def setNodeUnselect(value: /* e */ NodeUnselectEventArgs => Callback): Self = StObject.set(x, "nodeUnselect", js.Any.fromFunction1((t0: /* e */ NodeUnselectEventArgs) => value(t0).runNow()))
      
      inline def setNodeUnselectUndefined: Self = StObject.set(x, "nodeUnselect", js.undefined)
      
      inline def setReady(value: /* e */ ReadyEventArgs => Callback): Self = StObject.set(x, "ready", js.Any.fromFunction1((t0: /* e */ ReadyEventArgs) => value(t0).runNow()))
  ...
  trait SortSettings extends StObject {
    ...
    /** Sets the sorting order type. There are two sorting types available, such as &quot;ascending&quot;, &quot;descending&quot;.
      ...
      */
    var sortOrder: js.UndefOr[typingsJapgolly.ejWebAll.ej.sortOrder | String] = js.undefined
  }
  object SortSettings {
