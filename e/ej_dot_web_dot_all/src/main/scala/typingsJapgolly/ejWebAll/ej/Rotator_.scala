...
class Rotator_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.Rotator.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.Rotator.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.Rotator.Model = js.native
  @JSName("model")
  var model_Rotator_ : typingsJapgolly.ejWebAll.ej.Rotator.Model = js.native
