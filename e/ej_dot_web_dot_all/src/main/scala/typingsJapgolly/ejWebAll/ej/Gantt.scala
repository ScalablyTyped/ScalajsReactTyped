...
import typingsJapgolly.ejWebAll.ej.Gantt.EjPredicate
...
object Gantt {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Gantt.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Gantt.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Gantt.Model](x: Self) {
      ...
      inline def setQueryTaskbarInfo(value: /* e */ QueryTaskbarInfoEventArgs => Callback): Self = StObject.set(x, "queryTaskbarInfo", js.Any.fromFunction1((t0: /* e */ QueryTaskbarInfoEventArgs) => value(t0).runNow()))
      ...
      inline def setSplitterResized(value: /* e */ SplitterResizedEventArgs => Callback): Self = StObject.set(x, "splitterResized", js.Any.fromFunction1((t0: /* e */ SplitterResizedEventArgs) => value(t0).runNow()))
      ...
      inline def setTaskbarClick(value: /* e */ TaskbarClickEventArgs => Callback): Self = StObject.set(x, "taskbarClick", js.Any.fromFunction1((t0: /* e */ TaskbarClickEventArgs) => value(t0).runNow()))
      
      inline def setTaskbarClickUndefined: Self = StObject.set(x, "taskbarClick", js.undefined)
      
      inline def setTaskbarEdited(value: /* e */ TaskbarEditedEventArgs => Callback): Self = StObject.set(x, "taskbarEdited", js.Any.fromFunction1((t0: /* e */ TaskbarEditedEventArgs) => value(t0).runNow()))
      
      inline def setTaskbarEditedUndefined: Self = StObject.set(x, "taskbarEdited", js.undefined)
      
      inline def setTaskbarEditing(value: /* e */ TaskbarEditingEventArgs => Callback): Self = StObject.set(x, "taskbarEditing", js.Any.fromFunction1((t0: /* e */ TaskbarEditingEventArgs) => value(t0).runNow()))
  ...
  trait ScheduleHeaderSettings extends StObject {
    ...
    /** Specifies the number of minutes per interval
      ...
      */
    var minutesPerInterval: js.UndefOr[typingsJapgolly.ejWebAll.ej.Gantt.minutesPerInterval | String] = js.undefined
