package typingsJapgolly.ejWebAll.ej.RecurrenceEditor
...
object Model {
  ...
  def apply(
    ...
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RecurrenceEditor.ChangeEventArgs) => change(t0).runNow()))
