...
object ProgressBar {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.ProgressBar.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.ProgressBar.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.ProgressBar.Model](x: Self) {
