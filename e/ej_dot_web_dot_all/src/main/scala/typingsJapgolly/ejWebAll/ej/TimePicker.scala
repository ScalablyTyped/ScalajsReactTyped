...
object TimePicker {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.TimePicker.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.TimePicker.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.TimePicker.Model](x: Self) {
