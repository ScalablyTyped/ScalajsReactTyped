...
object RecurrenceEditor {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.RecurrenceEditor.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.RecurrenceEditor.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.RecurrenceEditor.Model](x: Self) {
