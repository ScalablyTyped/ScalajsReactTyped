...
object ToggleButton {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.ToggleButton.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.ToggleButton.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.ToggleButton.Model](x: Self) {
