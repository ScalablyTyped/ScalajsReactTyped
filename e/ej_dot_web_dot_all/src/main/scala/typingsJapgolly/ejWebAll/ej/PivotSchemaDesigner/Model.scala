package typingsJapgolly.ejWebAll.ej.PivotSchemaDesigner
...
object Model {
  ...
  def apply(
    ...
    dragMove: /* e */ DragMoveEventArgs => Callback = null,
    ...
    if (afterServiceInvoke != null) __obj.updateDynamic("afterServiceInvoke")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotSchemaDesigner.AfterServiceInvokeEventArgs) => afterServiceInvoke(t0).runNow()))
    if (beforeServiceInvoke != null) __obj.updateDynamic("beforeServiceInvoke")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotSchemaDesigner.BeforeServiceInvokeEventArgs) => beforeServiceInvoke(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (customObject != null) __obj.updateDynamic("customObject")(customObject.asInstanceOf[js.Any])
    if (dragMove != null) __obj.updateDynamic("dragMove")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotSchemaDesigner.DragMoveEventArgs) => dragMove(t0).runNow()))
    ...
    if (load != null) __obj.updateDynamic("load")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotSchemaDesigner.LoadEventArgs) => load(t0).runNow()))
