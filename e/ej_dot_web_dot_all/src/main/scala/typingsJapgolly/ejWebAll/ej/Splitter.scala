...
object Splitter {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Splitter.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Splitter.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Splitter.Model](x: Self) {
      ...
      inline def setBeforeExpandCollapse(value: /* e */ BeforeExpandCollapseEventArgs => Callback): Self = StObject.set(x, "beforeExpandCollapse", js.Any.fromFunction1((t0: /* e */ BeforeExpandCollapseEventArgs) => value(t0).runNow()))
      
      inline def setBeforeExpandCollapseUndefined: Self = StObject.set(x, "beforeExpandCollapse", js.undefined)
      
      inline def setClickOnExpander(value: /* e */ ClickOnExpanderEventArgs => Callback): Self = StObject.set(x, "clickOnExpander", js.Any.fromFunction1((t0: /* e */ ClickOnExpanderEventArgs) => value(t0).runNow()))
      ...
      inline def setExpandCollapse(value: /* e */ ExpandCollapseEventArgs => Callback): Self = StObject.set(x, "expandCollapse", js.Any.fromFunction1((t0: /* e */ ExpandCollapseEventArgs) => value(t0).runNow()))
