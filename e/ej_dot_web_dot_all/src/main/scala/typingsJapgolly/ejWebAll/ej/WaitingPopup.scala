...
object WaitingPopup {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.WaitingPopup.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.WaitingPopup.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.WaitingPopup.Model](x: Self) {
