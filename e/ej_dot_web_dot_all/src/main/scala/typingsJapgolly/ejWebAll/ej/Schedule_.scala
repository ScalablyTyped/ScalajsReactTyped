...
class Schedule_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.Schedule.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.Schedule.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.Schedule.Model = js.native
  @JSName("model")
  var model_Schedule_ : typingsJapgolly.ejWebAll.ej.Schedule.Model = js.native
