...
object Droppable {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Droppable.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Droppable.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Droppable.Model](x: Self) {
      ...
      inline def setOut(value: /* e */ OutEventArgs => Callback): Self = StObject.set(x, "out", js.Any.fromFunction1((t0: /* e */ OutEventArgs) => value(t0).runNow()))
      
      inline def setOutUndefined: Self = StObject.set(x, "out", js.undefined)
      
      inline def setOver(value: /* e */ OverEventArgs => Callback): Self = StObject.set(x, "over", js.Any.fromFunction1((t0: /* e */ OverEventArgs) => value(t0).runNow()))
