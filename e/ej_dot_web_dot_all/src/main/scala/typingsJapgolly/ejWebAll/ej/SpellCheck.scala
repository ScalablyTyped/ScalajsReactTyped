...
object SpellCheck {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.SpellCheck.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.SpellCheck.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.SpellCheck.Model](x: Self) {
      ...
      inline def setComplete(value: /* e */ CompleteEventArgs => Callback): Self = StObject.set(x, "complete", js.Any.fromFunction1((t0: /* e */ CompleteEventArgs) => value(t0).runNow()))
      ...
      inline def setDialogBeforeOpen(value: /* e */ DialogBeforeOpenEventArgs => Callback): Self = StObject.set(x, "dialogBeforeOpen", js.Any.fromFunction1((t0: /* e */ DialogBeforeOpenEventArgs) => value(t0).runNow()))
      
      inline def setDialogBeforeOpenUndefined: Self = StObject.set(x, "dialogBeforeOpen", js.undefined)
      
      inline def setDialogClose(value: /* e */ DialogCloseEventArgs => Callback): Self = StObject.set(x, "dialogClose", js.Any.fromFunction1((t0: /* e */ DialogCloseEventArgs) => value(t0).runNow()))
      
      inline def setDialogCloseUndefined: Self = StObject.set(x, "dialogClose", js.undefined)
      
      inline def setDialogOpen(value: /* e */ DialogOpenEventArgs => Callback): Self = StObject.set(x, "dialogOpen", js.Any.fromFunction1((t0: /* e */ DialogOpenEventArgs) => value(t0).runNow()))
      ...
      inline def setStart(value: /* e */ StartEventArgs => Callback): Self = StObject.set(x, "start", js.Any.fromFunction1((t0: /* e */ StartEventArgs) => value(t0).runNow()))
      
      inline def setStartUndefined: Self = StObject.set(x, "start", js.undefined)
      
      inline def setTargetUpdating(value: /* e */ TargetUpdatingEventArgs => Callback): Self = StObject.set(x, "targetUpdating", js.Any.fromFunction1((t0: /* e */ TargetUpdatingEventArgs) => value(t0).runNow()))
      
      inline def setTargetUpdatingUndefined: Self = StObject.set(x, "targetUpdating", js.undefined)
      
      inline def setValidating(value: /* e */ ValidatingEventArgs => Callback): Self = StObject.set(x, "validating", js.Any.fromFunction1((t0: /* e */ ValidatingEventArgs) => value(t0).runNow()))
