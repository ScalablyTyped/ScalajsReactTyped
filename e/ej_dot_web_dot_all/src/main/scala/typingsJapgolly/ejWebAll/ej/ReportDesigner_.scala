...
class ReportDesigner_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.ReportDesigner.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.ReportDesigner.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.ReportDesigner.Model = js.native
  @JSName("model")
  var model_ReportDesigner_ : typingsJapgolly.ejWebAll.ej.ReportDesigner.Model = js.native
