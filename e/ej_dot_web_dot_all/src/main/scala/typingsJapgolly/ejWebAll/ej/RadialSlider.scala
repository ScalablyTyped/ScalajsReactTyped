...
object RadialSlider {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.RadialSlider.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.RadialSlider.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.RadialSlider.Model](x: Self) {
