...
object Model {
  ...
  def apply(
    ...
    execute: /* e */ ExecuteEventArgs => Callback = null,
    ...
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RTE.ChangeEventArgs) => change(t0).runNow()))
    ...
    if (contextMenuClick != null) __obj.updateDynamic("contextMenuClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RTE.ContextMenuClickEventArgs) => contextMenuClick(t0).runNow()))
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RTE.CreateEventArgs) => create(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RTE.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (execute != null) __obj.updateDynamic("execute")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RTE.ExecuteEventArgs) => execute(t0).runNow()))
    ...
    if (keydown != null) __obj.updateDynamic("keydown")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RTE.KeydownEventArgs) => keydown(t0).runNow()))
    if (keyup != null) __obj.updateDynamic("keyup")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RTE.KeyupEventArgs) => keyup(t0).runNow()))
    ...
    if (preRender != null) __obj.updateDynamic("preRender")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RTE.PreRenderEventArgs) => preRender(t0).runNow()))
    if (select != null) __obj.updateDynamic("select")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RTE.SelectEventArgs) => select(t0).runNow()))
