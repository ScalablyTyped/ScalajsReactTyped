...
object DigitalGauge {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.datavisualization.DigitalGauge.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.datavisualization.DigitalGauge.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.datavisualization.DigitalGauge.Model](x: Self) {
