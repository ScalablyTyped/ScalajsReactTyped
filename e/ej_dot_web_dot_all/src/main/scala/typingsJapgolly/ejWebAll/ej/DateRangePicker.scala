...
object DateRangePicker {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.DateRangePicker.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.DateRangePicker.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.DateRangePicker.Model](x: Self) {
