...
import typingsJapgolly.ejWebAll.ej.FilterType_
import typingsJapgolly.ejWebAll.ej.MultiSelectMode
import typingsJapgolly.ejWebAll.ej.SortOrder_
...
object Model {
  ...
  def apply(
    ...
    beforePopupHide: /* e */ BeforePopupHideEventArgs => Callback = null,
    beforePopupShown: /* e */ BeforePopupShownEventArgs => Callback = null,
    cascade: /* e */ CascadeEventArgs => Callback = null,
    ...
    popupHide: /* e */ PopupHideEventArgs => Callback = null,
    popupResize: /* e */ PopupResizeEventArgs => Callback = null,
    popupResizeStart: /* e */ PopupResizeStartEventArgs => Callback = null,
    popupResizeStop: /* e */ PopupResizeStopEventArgs => Callback = null,
    popupShown: /* e */ PopupShownEventArgs => Callback = null,
    popupWidth: String | Double = null,
    query: js.Any = null,
    readOnly: js.UndefOr[Boolean] = js.undefined,
    search: /* e */ SearchEventArgs => Callback = null,
    ...
    if (actionBegin != null) __obj.updateDynamic("actionBegin")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.ActionBeginEventArgs) => actionBegin(t0).runNow()))
    if (actionComplete != null) __obj.updateDynamic("actionComplete")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.ActionCompleteEventArgs) => actionComplete(t0).runNow()))
    if (actionFailure != null) __obj.updateDynamic("actionFailure")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.ActionFailureEventArgs) => actionFailure(t0).runNow()))
    if (actionSuccess != null) __obj.updateDynamic("actionSuccess")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.ActionSuccessEventArgs) => actionSuccess(t0).runNow()))
    ...
    if (beforePopupHide != null) __obj.updateDynamic("beforePopupHide")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.BeforePopupHideEventArgs) => beforePopupHide(t0).runNow()))
    if (beforePopupShown != null) __obj.updateDynamic("beforePopupShown")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.BeforePopupShownEventArgs) => beforePopupShown(t0).runNow()))
    if (cascade != null) __obj.updateDynamic("cascade")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.CascadeEventArgs) => cascade(t0).runNow()))
    ...
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.ChangeEventArgs) => change(t0).runNow()))
    if (checkChange != null) __obj.updateDynamic("checkChange")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.CheckChangeEventArgs) => checkChange(t0).runNow()))
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.CreateEventArgs) => create(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (dataBound != null) __obj.updateDynamic("dataBound")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.DataBoundEventArgs) => dataBound(t0).runNow()))
    if (dataSource != null) __obj.updateDynamic("dataSource")(dataSource.asInstanceOf[js.Any])
    if (delimiterChar != null) __obj.updateDynamic("delimiterChar")(delimiterChar.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (focusIn != null) __obj.updateDynamic("focusIn")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.FocusInEventArgs) => focusIn(t0).runNow()))
    if (focusOut != null) __obj.updateDynamic("focusOut")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.FocusOutEventArgs) => focusOut(t0).runNow()))
    ...
    if (popupHide != null) __obj.updateDynamic("popupHide")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.PopupHideEventArgs) => popupHide(t0).runNow()))
    if (popupResize != null) __obj.updateDynamic("popupResize")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.PopupResizeEventArgs) => popupResize(t0).runNow()))
    if (popupResizeStart != null) __obj.updateDynamic("popupResizeStart")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.PopupResizeStartEventArgs) => popupResizeStart(t0).runNow()))
    if (popupResizeStop != null) __obj.updateDynamic("popupResizeStop")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.PopupResizeStopEventArgs) => popupResizeStop(t0).runNow()))
    if (popupShown != null) __obj.updateDynamic("popupShown")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.PopupShownEventArgs) => popupShown(t0).runNow()))
    if (popupWidth != null) __obj.updateDynamic("popupWidth")(popupWidth.asInstanceOf[js.Any])
    if (query != null) __obj.updateDynamic("query")(query.asInstanceOf[js.Any])
    if (!js.isUndefined(readOnly)) __obj.updateDynamic("readOnly")(readOnly.asInstanceOf[js.Any])
    if (search != null) __obj.updateDynamic("search")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.SearchEventArgs) => search(t0).runNow()))
    if (select != null) __obj.updateDynamic("select")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DropDownList.SelectEventArgs) => select(t0).runNow()))
