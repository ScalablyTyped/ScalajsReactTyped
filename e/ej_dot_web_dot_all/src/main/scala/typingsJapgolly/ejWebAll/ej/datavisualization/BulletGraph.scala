...
object BulletGraph {
  ...
  trait Model extends StObject {
    ...
    /** Bullet graph will render in the specified orientation.
      * @Default {horizontal}
      */
    var orientation: js.UndefOr[typingsJapgolly.ejWebAll.ej.Orientation | String] = js.undefined
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.datavisualization.BulletGraph.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.datavisualization.BulletGraph.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.datavisualization.BulletGraph.Model](x: Self) {
      ...
      inline def setDrawCaption(value: /* e */ DrawCaptionEventArgs => Callback): Self = StObject.set(x, "drawCaption", js.Any.fromFunction1((t0: /* e */ DrawCaptionEventArgs) => value(t0).runNow()))
      
      inline def setDrawCaptionUndefined: Self = StObject.set(x, "drawCaption", js.undefined)
      
      inline def setDrawCategory(value: /* e */ DrawCategoryEventArgs => Callback): Self = StObject.set(x, "drawCategory", js.Any.fromFunction1((t0: /* e */ DrawCategoryEventArgs) => value(t0).runNow()))
      
      inline def setDrawCategoryUndefined: Self = StObject.set(x, "drawCategory", js.undefined)
      
      inline def setDrawComparativeMeasureSymbol(value: /* e */ DrawComparativeMeasureSymbolEventArgs => Callback): Self = StObject.set(x, "drawComparativeMeasureSymbol", js.Any.fromFunction1((t0: /* e */ DrawComparativeMeasureSymbolEventArgs) => value(t0).runNow()))
      
      inline def setDrawComparativeMeasureSymbolUndefined: Self = StObject.set(x, "drawComparativeMeasureSymbol", js.undefined)
      
      inline def setDrawFeatureMeasureBar(value: /* e */ DrawFeatureMeasureBarEventArgs => Callback): Self = StObject.set(x, "drawFeatureMeasureBar", js.Any.fromFunction1((t0: /* e */ DrawFeatureMeasureBarEventArgs) => value(t0).runNow()))
      
      inline def setDrawFeatureMeasureBarUndefined: Self = StObject.set(x, "drawFeatureMeasureBar", js.undefined)
      
      inline def setDrawIndicator(value: /* e */ DrawIndicatorEventArgs => Callback): Self = StObject.set(x, "drawIndicator", js.Any.fromFunction1((t0: /* e */ DrawIndicatorEventArgs) => value(t0).runNow()))
      ...
      inline def setDrawQualitativeRanges(value: /* e */ DrawQualitativeRangesEventArgs => Callback): Self = StObject.set(x, "drawQualitativeRanges", js.Any.fromFunction1((t0: /* e */ DrawQualitativeRangesEventArgs) => value(t0).runNow()))
      ...
      inline def setOrientation(value: typingsJapgolly.ejWebAll.ej.Orientation | String): Self = StObject.set(x, "orientation", value.asInstanceOf[js.Any])
