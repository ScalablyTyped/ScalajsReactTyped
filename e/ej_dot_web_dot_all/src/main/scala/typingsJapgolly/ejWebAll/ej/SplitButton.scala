...
object SplitButton {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.SplitButton.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.SplitButton.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.SplitButton.Model](x: Self) {
      ...
      inline def setItemMouseOut(value: /* e */ ItemMouseOutEventArgs => Callback): Self = StObject.set(x, "itemMouseOut", js.Any.fromFunction1((t0: /* e */ ItemMouseOutEventArgs) => value(t0).runNow()))
      
      inline def setItemMouseOutUndefined: Self = StObject.set(x, "itemMouseOut", js.undefined)
      
      inline def setItemMouseOver(value: /* e */ ItemMouseOverEventArgs => Callback): Self = StObject.set(x, "itemMouseOver", js.Any.fromFunction1((t0: /* e */ ItemMouseOverEventArgs) => value(t0).runNow()))
      
      inline def setItemMouseOverUndefined: Self = StObject.set(x, "itemMouseOver", js.undefined)
      
      inline def setItemSelected(value: /* e */ ItemSelectedEventArgs => Callback): Self = StObject.set(x, "itemSelected", js.Any.fromFunction1((t0: /* e */ ItemSelectedEventArgs) => value(t0).runNow()))
