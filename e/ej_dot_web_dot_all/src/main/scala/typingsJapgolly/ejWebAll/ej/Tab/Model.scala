...
object Model {
  ...
  def apply(
    ...
    beforeActive: /* e */ BeforeActiveEventArgs => Callback = null,
    beforeItemRemove: /* e */ BeforeItemRemoveEventArgs => Callback = null,
    ...
    itemActive: /* e */ ItemActiveEventArgs => Callback = null,
    itemAdd: /* e */ ItemAddEventArgs => Callback = null,
    itemRemove: /* e */ ItemRemoveEventArgs => Callback = null,
    ...
    if (ajaxBeforeLoad != null) __obj.updateDynamic("ajaxBeforeLoad")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Tab.AjaxBeforeLoadEventArgs) => ajaxBeforeLoad(t0).runNow()))
    if (ajaxError != null) __obj.updateDynamic("ajaxError")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Tab.AjaxErrorEventArgs) => ajaxError(t0).runNow()))
    if (ajaxLoad != null) __obj.updateDynamic("ajaxLoad")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Tab.AjaxLoadEventArgs) => ajaxLoad(t0).runNow()))
    if (ajaxSettings != null) __obj.updateDynamic("ajaxSettings")(ajaxSettings.asInstanceOf[js.Any])
    if (ajaxSuccess != null) __obj.updateDynamic("ajaxSuccess")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Tab.AjaxSuccessEventArgs) => ajaxSuccess(t0).runNow()))
    ...
    if (beforeActive != null) __obj.updateDynamic("beforeActive")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Tab.BeforeActiveEventArgs) => beforeActive(t0).runNow()))
    if (beforeItemRemove != null) __obj.updateDynamic("beforeItemRemove")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Tab.BeforeItemRemoveEventArgs) => beforeItemRemove(t0).runNow()))
    if (!js.isUndefined(collapsible)) __obj.updateDynamic("collapsible")(collapsible.asInstanceOf[js.Any])
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Tab.CreateEventArgs) => create(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Tab.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (itemActive != null) __obj.updateDynamic("itemActive")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Tab.ItemActiveEventArgs) => itemActive(t0).runNow()))
    if (itemAdd != null) __obj.updateDynamic("itemAdd")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Tab.ItemAddEventArgs) => itemAdd(t0).runNow()))
    if (itemRemove != null) __obj.updateDynamic("itemRemove")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Tab.ItemRemoveEventArgs) => itemRemove(t0).runNow()))
