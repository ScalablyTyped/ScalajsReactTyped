...
class PdfViewer_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.PdfViewer.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.PdfViewer.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.PdfViewer.Model = js.native
  @JSName("model")
  var model_PdfViewer_ : typingsJapgolly.ejWebAll.ej.PdfViewer.Model = js.native
