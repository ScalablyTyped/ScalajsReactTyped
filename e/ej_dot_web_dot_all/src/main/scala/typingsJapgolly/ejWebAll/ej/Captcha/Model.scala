...
import typingsJapgolly.ejWebAll.ej.HatchStyle
...
object Model {
  ...
  def apply(
    ...
    refreshBegin: /* e */ RefreshBeginEventArgs => Callback = null,
    refreshComplete: /* e */ RefreshCompleteEventArgs => Callback = null,
    refreshFailure: /* e */ RefreshFailureEventArgs => Callback = null,
    refreshSuccess: /* e */ RefreshSuccessEventArgs => Callback = null,
    ...
    if (refreshBegin != null) __obj.updateDynamic("refreshBegin")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Captcha.RefreshBeginEventArgs) => refreshBegin(t0).runNow()))
    if (refreshComplete != null) __obj.updateDynamic("refreshComplete")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Captcha.RefreshCompleteEventArgs) => refreshComplete(t0).runNow()))
    if (refreshFailure != null) __obj.updateDynamic("refreshFailure")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Captcha.RefreshFailureEventArgs) => refreshFailure(t0).runNow()))
    if (refreshSuccess != null) __obj.updateDynamic("refreshSuccess")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Captcha.RefreshSuccessEventArgs) => refreshSuccess(t0).runNow()))
