...
object FileExplorer {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.FileExplorer.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.FileExplorer.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.FileExplorer.Model](x: Self) {
      ...
      inline def setBeforeAjaxRequest(value: /* e */ BeforeAjaxRequestEventArgs => Callback): Self = StObject.set(x, "beforeAjaxRequest", js.Any.fromFunction1((t0: /* e */ BeforeAjaxRequestEventArgs) => value(t0).runNow()))
      
      inline def setBeforeAjaxRequestUndefined: Self = StObject.set(x, "beforeAjaxRequest", js.undefined)
      
      inline def setBeforeDownload(value: /* e */ BeforeDownloadEventArgs => Callback): Self = StObject.set(x, "beforeDownload", js.Any.fromFunction1((t0: /* e */ BeforeDownloadEventArgs) => value(t0).runNow()))
      
      inline def setBeforeDownloadUndefined: Self = StObject.set(x, "beforeDownload", js.undefined)
      
      inline def setBeforeGetImage(value: /* e */ BeforeGetImageEventArgs => Callback): Self = StObject.set(x, "beforeGetImage", js.Any.fromFunction1((t0: /* e */ BeforeGetImageEventArgs) => value(t0).runNow()))
      ...
      inline def setBeforeUpload(value: /* e */ BeforeUploadEventArgs => Callback): Self = StObject.set(x, "beforeUpload", js.Any.fromFunction1((t0: /* e */ BeforeUploadEventArgs) => value(t0).runNow()))
      
      inline def setBeforeUploadDialogOpen(value: /* e */ BeforeUploadDialogOpenEventArgs => Callback): Self = StObject.set(x, "beforeUploadDialogOpen", js.Any.fromFunction1((t0: /* e */ BeforeUploadDialogOpenEventArgs) => value(t0).runNow()))
      
      inline def setBeforeUploadDialogOpenUndefined: Self = StObject.set(x, "beforeUploadDialogOpen", js.undefined)
      
      inline def setBeforeUploadSend(value: /* e */ BeforeUploadSendEventArgs => Callback): Self = StObject.set(x, "beforeUploadSend", js.Any.fromFunction1((t0: /* e */ BeforeUploadSendEventArgs) => value(t0).runNow()))
      ...
      inline def setCopy(value: /* e */ CopyEventArgs => Callback): Self = StObject.set(x, "copy", js.Any.fromFunction1((t0: /* e */ CopyEventArgs) => value(t0).runNow()))
      ...
      inline def setCreateFolder(value: /* e */ CreateFolderEventArgs => Callback): Self = StObject.set(x, "createFolder", js.Any.fromFunction1((t0: /* e */ CreateFolderEventArgs) => value(t0).runNow()))
      ...
      inline def setCut(value: /* e */ CutEventArgs => Callback): Self = StObject.set(x, "cut", js.Any.fromFunction1((t0: /* e */ CutEventArgs) => value(t0).runNow()))
      ...
      inline def setGetImage(value: /* e */ GetImageEventArgs => Callback): Self = StObject.set(x, "getImage", js.Any.fromFunction1((t0: /* e */ GetImageEventArgs) => value(t0).runNow()))
      ...
      inline def setLayoutChange(value: /* e */ LayoutChangeEventArgs => Callback): Self = StObject.set(x, "layoutChange", js.Any.fromFunction1((t0: /* e */ LayoutChangeEventArgs) => value(t0).runNow()))
      ...
      inline def setMenuBeforeOpen(value: /* e */ MenuBeforeOpenEventArgs => Callback): Self = StObject.set(x, "menuBeforeOpen", js.Any.fromFunction1((t0: /* e */ MenuBeforeOpenEventArgs) => value(t0).runNow()))
      ...
      inline def setMenuOpen(value: /* e */ MenuOpenEventArgs => Callback): Self = StObject.set(x, "menuOpen", js.Any.fromFunction1((t0: /* e */ MenuOpenEventArgs) => value(t0).runNow()))
      ...
      inline def setPaste(value: /* e */ PasteEventArgs => Callback): Self = StObject.set(x, "paste", js.Any.fromFunction1((t0: /* e */ PasteEventArgs) => value(t0).runNow()))
      ...
      inline def setRemove(value: /* e */ RemoveEventArgs => Callback): Self = StObject.set(x, "remove", js.Any.fromFunction1((t0: /* e */ RemoveEventArgs) => value(t0).runNow()))
      ...
      inline def setUploadComplete(value: /* e */ UploadCompleteEventArgs => Callback): Self = StObject.set(x, "uploadComplete", js.Any.fromFunction1((t0: /* e */ UploadCompleteEventArgs) => value(t0).runNow()))
      
      inline def setUploadCompleteUndefined: Self = StObject.set(x, "uploadComplete", js.undefined)
      
      inline def setUploadError(value: /* e */ UploadErrorEventArgs => Callback): Self = StObject.set(x, "uploadError", js.Any.fromFunction1((t0: /* e */ UploadErrorEventArgs) => value(t0).runNow()))
      ...
      inline def setUploadSuccess(value: /* e */ UploadSuccessEventArgs => Callback): Self = StObject.set(x, "uploadSuccess", js.Any.fromFunction1((t0: /* e */ UploadSuccessEventArgs) => value(t0).runNow()))
  ...
  trait TemplateRefreshEventArgs extends StObject {
    ...
    /** Returns the cell object.
      */
    var cell: js.UndefOr[typingsJapgolly.ejWebAll.ej.Model] = js.undefined
  ...
  object TemplateRefreshEventArgs {
    ...
    extension [Self <: TemplateRefreshEventArgs](x: Self) {
      ...
      inline def setCell(value: typingsJapgolly.ejWebAll.ej.Model): Self = StObject.set(x, "cell", value.asInstanceOf[js.Any])
