...
object Autocomplete {
  ...
  object Animation extends StObject {
    ...
    sealed trait Fade
      extends StObject
         with typingsJapgolly.ejWebAll.ej.Autocomplete.Animation
  ...
  object MultiSelectMode extends StObject {
    ...
    sealed trait Delimiter
      extends StObject
         with typingsJapgolly.ejWebAll.ej.Autocomplete.MultiSelectMode
  ...
  trait Model extends StObject {
    ...
    /** Enables or disables selecting the animation style for the popup list. Animation types can be selected through either of the following options,
      * @Default {slide}
      */
    var animateType: js.UndefOr[typingsJapgolly.ejWebAll.ej.Animation | String] = js.undefined
    ...
    /** Enables or disables selecting multiple values from the suggestion list. Multiple values can be selected through either of the following options,
      ...
      */
    var multiSelectMode: js.UndefOr[typingsJapgolly.ejWebAll.ej.MultiSelectMode | String] = js.undefined
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Autocomplete.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Autocomplete.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Autocomplete.Model](x: Self) {
      ...
      inline def setAnimateType(value: typingsJapgolly.ejWebAll.ej.Animation | String): Self = StObject.set(x, "animateType", value.asInstanceOf[js.Any])
      ...
      inline def setMultiSelectMode(value: typingsJapgolly.ejWebAll.ej.MultiSelectMode | String): Self = StObject.set(x, "multiSelectMode", value.asInstanceOf[js.Any])
  ...
  trait MultiColumnSettingsColumn extends StObject {
    ...
    /** Specifies the search filter type. There are several types of search filter available such as â€˜startswithâ€™, â€˜containsâ€™, â€˜endswithâ€™, â€˜lessthanâ€™,
      ...
      * @Default {ej.filterType.StartsWith}
      */
    var filterType: js.UndefOr[typingsJapgolly.ejWebAll.ej.filterType | String] = js.undefined
  ...
  trait SelectEventArgs extends StObject {
    ...
    /** Data object of the selected item.
      */
    var Item: js.UndefOr[typingsJapgolly.ejWebAll.ej.Model] = js.undefined
  ...
  object SelectEventArgs {
    ...
    extension [Self <: SelectEventArgs](x: Self) {
      ...
      inline def setItem(value: typingsJapgolly.ejWebAll.ej.Model): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
