...
object Captcha {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Captcha.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Captcha.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Captcha.Model](x: Self) {
      ...
      inline def setRefreshBegin(value: /* e */ RefreshBeginEventArgs => Callback): Self = StObject.set(x, "refreshBegin", js.Any.fromFunction1((t0: /* e */ RefreshBeginEventArgs) => value(t0).runNow()))
      
      inline def setRefreshBeginUndefined: Self = StObject.set(x, "refreshBegin", js.undefined)
      
      inline def setRefreshComplete(value: /* e */ RefreshCompleteEventArgs => Callback): Self = StObject.set(x, "refreshComplete", js.Any.fromFunction1((t0: /* e */ RefreshCompleteEventArgs) => value(t0).runNow()))
      
      inline def setRefreshCompleteUndefined: Self = StObject.set(x, "refreshComplete", js.undefined)
      
      inline def setRefreshFailure(value: /* e */ RefreshFailureEventArgs => Callback): Self = StObject.set(x, "refreshFailure", js.Any.fromFunction1((t0: /* e */ RefreshFailureEventArgs) => value(t0).runNow()))
      
      inline def setRefreshFailureUndefined: Self = StObject.set(x, "refreshFailure", js.undefined)
      
      inline def setRefreshSuccess(value: /* e */ RefreshSuccessEventArgs => Callback): Self = StObject.set(x, "refreshSuccess", js.Any.fromFunction1((t0: /* e */ RefreshSuccessEventArgs) => value(t0).runNow()))
