...
class Spreadsheet_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.Spreadsheet.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.Spreadsheet.Model) = this()
  ...
  var defaults: typingsJapgolly.ejWebAll.ej.Spreadsheet.Model = js.native
  @JSName("model")
  var model_Spreadsheet_ : typingsJapgolly.ejWebAll.ej.Spreadsheet.Model = js.native
