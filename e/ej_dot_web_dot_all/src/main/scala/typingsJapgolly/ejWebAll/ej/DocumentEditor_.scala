...
@js.native
class DocumentEditor_ protected () extends Widget_ {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.DocumentEditor.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.DocumentEditor.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.DocumentEditor.Model = js.native
  @JSName("model")
  var model_DocumentEditor_ : typingsJapgolly.ejWebAll.ej.DocumentEditor.Model = js.native
