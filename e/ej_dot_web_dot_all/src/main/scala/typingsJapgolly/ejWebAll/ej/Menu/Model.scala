...
import typingsJapgolly.ejWebAll.ej.AnimationType
import typingsJapgolly.ejWebAll.ej.Direction
import typingsJapgolly.ejWebAll.ej.MenuType
...
object Model {
  ...
  def apply(
    ...
    overflowClose: /* e */ OverflowCloseEventArgs => Callback = null,
    overflowHeight: String | Double = null,
    overflowOpen: /* e */ OverflowOpenEventArgs => Callback = null,
    ...
    if (beforeOpen != null) __obj.updateDynamic("beforeOpen")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Menu.BeforeOpenEventArgs) => beforeOpen(t0).runNow()))
    if (click != null) __obj.updateDynamic("click")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Menu.ClickEventArgs) => click(t0).runNow()))
    if (close != null) __obj.updateDynamic("close")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Menu.CloseEventArgs) => close(t0).runNow()))
    if (container != null) __obj.updateDynamic("container")(container.asInstanceOf[js.Any])
    if (contextMenuTarget != null) __obj.updateDynamic("contextMenuTarget")(contextMenuTarget.asInstanceOf[js.Any])
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Menu.CreateEventArgs) => create(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Menu.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (keydown != null) __obj.updateDynamic("keydown")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Menu.KeydownEventArgs) => keydown(t0).runNow()))
    if (menuType != null) __obj.updateDynamic("menuType")(menuType.asInstanceOf[js.Any])
    if (mouseout != null) __obj.updateDynamic("mouseout")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Menu.MouseoutEventArgs) => mouseout(t0).runNow()))
    if (mouseover != null) __obj.updateDynamic("mouseover")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Menu.MouseoverEventArgs) => mouseover(t0).runNow()))
    if (open != null) __obj.updateDynamic("open")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Menu.OpenEventArgs) => open(t0).runNow()))
    if (!js.isUndefined(openOnClick)) __obj.updateDynamic("openOnClick")(openOnClick.asInstanceOf[js.Any])
    if (orientation != null) __obj.updateDynamic("orientation")(orientation.asInstanceOf[js.Any])
    if (overflowClose != null) __obj.updateDynamic("overflowClose")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Menu.OverflowCloseEventArgs) => overflowClose(t0).runNow()))
    if (overflowHeight != null) __obj.updateDynamic("overflowHeight")(overflowHeight.asInstanceOf[js.Any])
    if (overflowOpen != null) __obj.updateDynamic("overflowOpen")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Menu.OverflowOpenEventArgs) => overflowOpen(t0).runNow()))
