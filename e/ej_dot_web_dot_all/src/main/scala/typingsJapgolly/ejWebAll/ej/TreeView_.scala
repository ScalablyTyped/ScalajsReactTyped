...
@js.native
class TreeView_ protected () extends Widget_ {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.TreeView.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.TreeView.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.TreeView.Model = js.native
  @JSName("model")
  var model_TreeView_ : typingsJapgolly.ejWebAll.ej.TreeView.Model = js.native
