...
class Autocomplete_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.Autocomplete.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.Autocomplete.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.Autocomplete.Model = js.native
  @JSName("model")
  var model_Autocomplete_ : typingsJapgolly.ejWebAll.ej.Autocomplete.Model = js.native
