...
object Button {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Button.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Button.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Button.Model](x: Self) {
