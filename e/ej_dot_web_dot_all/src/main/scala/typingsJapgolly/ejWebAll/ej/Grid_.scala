...
class Grid_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.Grid.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.Grid.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.Grid.Model = js.native
  @JSName("model")
  var model_Grid_ : typingsJapgolly.ejWebAll.ej.Grid.Model = js.native
