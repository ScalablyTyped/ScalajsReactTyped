...
object Model {
  ...
  def apply(
    ...
    chartLoad: /* e */ ChartLoadEventArgs => Callback = null,
    ...
    fetchReport: /* e */ FetchReportEventArgs => Callback = null,
    ...
    schemaLoad: /* e */ SchemaLoadEventArgs => Callback = null,
    ...
    treeMapLoad: /* e */ TreeMapLoadEventArgs => Callback = null,
    url: String = null,
    valueCellHyperlinkClick: /* e */ ValueCellHyperlinkClickEventArgs => Callback = null,
    valueSortSettings: ValueSortSettings = null
  ): Model = {
    val __obj = js.Dynamic.literal()
    if (afterServiceInvoke != null) __obj.updateDynamic("afterServiceInvoke")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.AfterServiceInvokeEventArgs) => afterServiceInvoke(t0).runNow()))
    if (analysisMode != null) __obj.updateDynamic("analysisMode")(analysisMode.asInstanceOf[js.Any])
    if (axesLabelRendering != null) __obj.updateDynamic("axesLabelRendering")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.AxesLabelRenderingEventArgs) => axesLabelRendering(t0).runNow()))
    if (beforeExport != null) __obj.updateDynamic("beforeExport")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.BeforeExportEventArgs) => beforeExport(t0).runNow()))
    if (beforeServiceInvoke != null) __obj.updateDynamic("beforeServiceInvoke")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.BeforeServiceInvokeEventArgs) => beforeServiceInvoke(t0).runNow()))
    if (cellClick != null) __obj.updateDynamic("cellClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.CellClickEventArgs) => cellClick(t0).runNow()))
    if (chartLoad != null) __obj.updateDynamic("chartLoad")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.ChartLoadEventArgs) => chartLoad(t0).runNow()))
    ...
    if (drillThrough != null) __obj.updateDynamic("drillThrough")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.DrillThroughEventArgs) => drillThrough(t0).runNow()))
    ...
    if (fetchReport != null) __obj.updateDynamic("fetchReport")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.FetchReportEventArgs) => fetchReport(t0).runNow()))
    ...
    if (load != null) __obj.updateDynamic("load")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.LoadEventArgs) => load(t0).runNow()))
    if (loadReport != null) __obj.updateDynamic("loadReport")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.LoadReportEventArgs) => loadReport(t0).runNow()))
    ...
    if (pointRegionClick != null) __obj.updateDynamic("pointRegionClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.PointRegionClickEventArgs) => pointRegionClick(t0).runNow()))
    if (renderComplete != null) __obj.updateDynamic("renderComplete")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.RenderCompleteEventArgs) => renderComplete(t0).runNow()))
    if (renderFailure != null) __obj.updateDynamic("renderFailure")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.RenderFailureEventArgs) => renderFailure(t0).runNow()))
    if (renderSuccess != null) __obj.updateDynamic("renderSuccess")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.RenderSuccessEventArgs) => renderSuccess(t0).runNow()))
    if (saveReport != null) __obj.updateDynamic("saveReport")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.SaveReportEventArgs) => saveReport(t0).runNow()))
    if (schemaLoad != null) __obj.updateDynamic("schemaLoad")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.SchemaLoadEventArgs) => schemaLoad(t0).runNow()))
    ...
    if (treeMapLoad != null) __obj.updateDynamic("treeMapLoad")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.TreeMapLoadEventArgs) => treeMapLoad(t0).runNow()))
    if (url != null) __obj.updateDynamic("url")(url.asInstanceOf[js.Any])
    if (valueCellHyperlinkClick != null) __obj.updateDynamic("valueCellHyperlinkClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.PivotClient.ValueCellHyperlinkClickEventArgs) => valueCellHyperlinkClick(t0).runNow()))
