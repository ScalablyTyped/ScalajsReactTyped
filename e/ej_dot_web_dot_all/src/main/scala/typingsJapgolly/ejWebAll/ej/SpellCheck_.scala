...
class SpellCheck_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.SpellCheck.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.SpellCheck.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.SpellCheck.Model = js.native
  @JSName("model")
  var model_SpellCheck_ : typingsJapgolly.ejWebAll.ej.SpellCheck.Model = js.native
