...
object PivotTreeMap {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.PivotTreeMap.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.PivotTreeMap.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.PivotTreeMap.Model](x: Self) {
