...
object PivotPager {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.PivotPager.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.PivotPager.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.PivotPager.Model](x: Self) {
