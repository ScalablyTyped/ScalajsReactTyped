...
class ListBox_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.ListBox.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.ListBox.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.ListBox.Model = js.native
  @JSName("model")
  var model_ListBox_ : typingsJapgolly.ejWebAll.ej.ListBox.Model = js.native
