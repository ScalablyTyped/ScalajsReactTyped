...
object Model {
  ...
  def apply(
    ...
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RadialSlider.ChangeEventArgs) => change(t0).runNow()))
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RadialSlider.CreateEventArgs) => create(t0).runNow()))
    ...
    if (mouseover != null) __obj.updateDynamic("mouseover")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RadialSlider.MouseoverEventArgs) => mouseover(t0).runNow()))
    if (radius != null) __obj.updateDynamic("radius")(radius.asInstanceOf[js.Any])
    if (!js.isUndefined(showInnerCircle)) __obj.updateDynamic("showInnerCircle")(showInnerCircle.asInstanceOf[js.Any])
    if (slide != null) __obj.updateDynamic("slide")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RadialSlider.SlideEventArgs) => slide(t0).runNow()))
    if (start != null) __obj.updateDynamic("start")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RadialSlider.StartEventArgs) => start(t0).runNow()))
    if (startAngle != null) __obj.updateDynamic("startAngle")(startAngle.asInstanceOf[js.Any])
    if (stop != null) __obj.updateDynamic("stop")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RadialSlider.StopEventArgs) => stop(t0).runNow()))
