...
object Sparkline {
  ...
  trait Model extends StObject {
    ...
    /** Specifies the theme for Sparkline.
      ...
      */
    var theme: js.UndefOr[typingsJapgolly.ejWebAll.ej.Sparkline.Theme | String] = js.undefined
    ...
    /** Specifies the type of the series to render in sparkline.
      ...
      */
    var `type`: js.UndefOr[typingsJapgolly.ejWebAll.ej.Sparkline.Type | String] = js.undefined
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.datavisualization.Sparkline.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.datavisualization.Sparkline.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.datavisualization.Sparkline.Model](x: Self) {
      ...
      inline def setPointRegionMouseClick(value: /* e */ PointRegionMouseClickEventArgs => Callback): Self = StObject.set(x, "pointRegionMouseClick", js.Any.fromFunction1((t0: /* e */ PointRegionMouseClickEventArgs) => value(t0).runNow()))
      ...
      inline def setSeriesRendering(value: /* e */ SeriesRenderingEventArgs => Callback): Self = StObject.set(x, "seriesRendering", js.Any.fromFunction1((t0: /* e */ SeriesRenderingEventArgs) => value(t0).runNow()))
      ...
      inline def setSparklineMouseLeave(value: /* e */ SparklineMouseLeaveEventArgs => Callback): Self = StObject.set(x, "sparklineMouseLeave", js.Any.fromFunction1((t0: /* e */ SparklineMouseLeaveEventArgs) => value(t0).runNow()))
      
      inline def setSparklineMouseLeaveUndefined: Self = StObject.set(x, "sparklineMouseLeave", js.undefined)
      
      inline def setSparklineMouseMove(value: /* e */ SparklineMouseMoveEventArgs => Callback): Self = StObject.set(x, "sparklineMouseMove", js.Any.fromFunction1((t0: /* e */ SparklineMouseMoveEventArgs) => value(t0).runNow()))
      ...
      inline def setTheme(value: typingsJapgolly.ejWebAll.ej.Sparkline.Theme | String): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
      ...
      inline def setType(value: typingsJapgolly.ejWebAll.ej.Sparkline.Type | String): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  trait TooltipFont extends StObject {
    ...
    /** Specifies the font Style for the tooltip.
      * @Default {Normal}
      */
    var fontStyle: js.UndefOr[typingsJapgolly.ejWebAll.ej.Sparkline.FontStyle | String] = js.undefined
    
    /** Specifies the font weight for the tooltip.
      * @Default {Regular}
      */
    var fontWeight: js.UndefOr[typingsJapgolly.ejWebAll.ej.Sparkline.FontWeight | String] = js.undefined
  ...
  object TooltipFont {
    ...
    extension [Self <: TooltipFont](x: Self) {
      ...
      inline def setFontStyle(value: typingsJapgolly.ejWebAll.ej.Sparkline.FontStyle | String): Self = StObject.set(x, "fontStyle", value.asInstanceOf[js.Any])
      
      inline def setFontStyleUndefined: Self = StObject.set(x, "fontStyle", js.undefined)
      
      inline def setFontWeight(value: typingsJapgolly.ejWebAll.ej.Sparkline.FontWeight | String): Self = StObject.set(x, "fontWeight", value.asInstanceOf[js.Any])
