...
object Rating {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Rating.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Rating.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Rating.Model](x: Self) {
