...
class FileExplorer_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.FileExplorer.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.FileExplorer.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.FileExplorer.Model = js.native
  @JSName("model")
  var model_FileExplorer_ : typingsJapgolly.ejWebAll.ej.FileExplorer.Model = js.native
