...
object Model {
  ...
  def apply(
    ...
    locale: String = null,
    mouseDown: /* e */ MouseDownEventArgs => Callback = null,
    mouseUp: /* e */ MouseUpEventArgs => Callback = null,
    ...
    if (ajaxBeforeLoad != null) __obj.updateDynamic("ajaxBeforeLoad")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.ListView.AjaxBeforeLoadEventArgs) => ajaxBeforeLoad(t0).runNow()))
    if (ajaxComplete != null) __obj.updateDynamic("ajaxComplete")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.ListView.AjaxCompleteEventArgs) => ajaxComplete(t0).runNow()))
    if (ajaxError != null) __obj.updateDynamic("ajaxError")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.ListView.AjaxErrorEventArgs) => ajaxError(t0).runNow()))
    if (ajaxSettings != null) __obj.updateDynamic("ajaxSettings")(ajaxSettings.asInstanceOf[js.Any])
    if (ajaxSuccess != null) __obj.updateDynamic("ajaxSuccess")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.ListView.AjaxSuccessEventArgs) => ajaxSuccess(t0).runNow()))
    ...
    if (load != null) __obj.updateDynamic("load")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.ListView.LoadEventArgs) => load(t0).runNow()))
    if (loadComplete != null) __obj.updateDynamic("loadComplete")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.ListView.LoadCompleteEventArgs) => loadComplete(t0).runNow()))
    if (locale != null) __obj.updateDynamic("locale")(locale.asInstanceOf[js.Any])
    if (mouseDown != null) __obj.updateDynamic("mouseDown")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.ListView.MouseDownEventArgs) => mouseDown(t0).runNow()))
    if (mouseUp != null) __obj.updateDynamic("mouseUp")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.ListView.MouseUpEventArgs) => mouseUp(t0).runNow()))
