package typingsJapgolly.ejWebAll.ej.Rating
...
object Model {
  ...
  def apply(
    ...
    mousemove: /* e */ MousemoveEventArgs => Callback = null,
    ...
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Rating.ChangeEventArgs) => change(t0).runNow()))
    if (click != null) __obj.updateDynamic("click")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Rating.ClickEventArgs) => click(t0).runNow()))
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Rating.CreateEventArgs) => create(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Rating.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (mousemove != null) __obj.updateDynamic("mousemove")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Rating.MousemoveEventArgs) => mousemove(t0).runNow()))
    if (mouseout != null) __obj.updateDynamic("mouseout")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Rating.MouseoutEventArgs) => mouseout(t0).runNow()))
    if (mouseover != null) __obj.updateDynamic("mouseover")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Rating.MouseoverEventArgs) => mouseover(t0).runNow()))
