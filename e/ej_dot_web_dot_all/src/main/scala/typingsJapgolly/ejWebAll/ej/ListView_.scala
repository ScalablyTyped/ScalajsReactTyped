...
class ListView_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.ListView.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.ListView.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.ListView.Model = js.native
  @JSName("model")
  var model_ListView_ : typingsJapgolly.ejWebAll.ej.ListView.Model = js.native
