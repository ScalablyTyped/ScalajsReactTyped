package typingsJapgolly.ejWebAll.ej.RadioButton

import japgolly.scalajs.react.Callback
import typingsJapgolly.ejWebAll.ej.RadioButtonSize
...
object Model {
  ...
  def apply(
    ...
    if (beforeChange != null) __obj.updateDynamic("beforeChange")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RadioButton.BeforeChangeEventArgs) => beforeChange(t0).runNow()))
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RadioButton.ChangeEventArgs) => change(t0).runNow()))
    if (!js.isUndefined(checked)) __obj.updateDynamic("checked")(checked.asInstanceOf[js.Any])
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RadioButton.CreateEventArgs) => create(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.RadioButton.DestroyEventArgs) => destroy(t0).runNow()))
