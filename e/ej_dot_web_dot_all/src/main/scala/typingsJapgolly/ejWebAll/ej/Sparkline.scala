...
object Sparkline {
  ...
  object Type extends StObject {
    ...
    sealed trait Area
      extends StObject
         with typingsJapgolly.ejWebAll.ej.Sparkline.Type
  ...
  trait Model extends StObject {
    ...
    /** Options to customize the tooltip.
      */
    var tooltip: js.UndefOr[typingsJapgolly.ejWebAll.ej.Sparkline.Tooltip] = js.undefined
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Sparkline.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Sparkline.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Sparkline.Model](x: Self) {
      ...
      inline def setTooltip(value: typingsJapgolly.ejWebAll.ej.Sparkline.Tooltip): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
  ...
  object Tooltip {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Sparkline.Tooltip = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Sparkline.Tooltip]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Sparkline.Tooltip](x: Self) {
