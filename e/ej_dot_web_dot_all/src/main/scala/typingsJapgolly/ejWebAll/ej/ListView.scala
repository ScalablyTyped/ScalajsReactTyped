...
object ListView {
  ...
  object AjaxSettings {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.ListView.AjaxSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.ListView.AjaxSettings]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.ListView.AjaxSettings](x: Self) {
  ...
  trait Model extends StObject {
    ...
    /** Specifies the ajaxSettings option to load the items to the ListView control.
      * @Default {null}
      */
    var ajaxSettings: js.UndefOr[typingsJapgolly.ejWebAll.ej.ListView.AjaxSettings] = js.undefined
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.ListView.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.ListView.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.ListView.Model](x: Self) {
      ...
      inline def setAjaxComplete(value: /* e */ AjaxCompleteEventArgs => Callback): Self = StObject.set(x, "ajaxComplete", js.Any.fromFunction1((t0: /* e */ AjaxCompleteEventArgs) => value(t0).runNow()))
      ...
      inline def setAjaxSettings(value: typingsJapgolly.ejWebAll.ej.ListView.AjaxSettings): Self = StObject.set(x, "ajaxSettings", value.asInstanceOf[js.Any])
      ...
      inline def setMouseDown(value: /* e */ MouseDownEventArgs => Callback): Self = StObject.set(x, "mouseDown", js.Any.fromFunction1((t0: /* e */ MouseDownEventArgs) => value(t0).runNow()))
      
      inline def setMouseDownUndefined: Self = StObject.set(x, "mouseDown", js.undefined)
      
      inline def setMouseUp(value: /* e */ MouseUpEventArgs => Callback): Self = StObject.set(x, "mouseUp", js.Any.fromFunction1((t0: /* e */ MouseUpEventArgs) => value(t0).runNow()))
