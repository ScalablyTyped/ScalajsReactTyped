...
class PivotGrid_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.PivotGrid.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.PivotGrid.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.PivotGrid.Model = js.native
  @JSName("model")
  var model_PivotGrid_ : typingsJapgolly.ejWebAll.ej.PivotGrid.Model = js.native
