...
object Model {
  ...
  def apply(
    ...
    backstageItemClick: /* e */ BackstageItemClickEventArgs => Callback = null,
    beforeTabRemove: /* e */ BeforeTabRemoveEventArgs => Callback = null,
    ...
    galleryItemClick: /* e */ GalleryItemClickEventArgs => Callback = null,
    groupClick: /* e */ GroupClickEventArgs => Callback = null,
    groupExpand: /* e */ GroupExpandEventArgs => Callback = null,
    isResponsive: js.UndefOr[Boolean] = js.undefined,
    load: /* e */ LoadEventArgs => Callback = null,
    locale: String = null,
    qatMenuItemClick: /* e */ QatMenuItemClickEventArgs => Callback = null,
    selectedItemIndex: Int | Double = null,
    showQAT: js.UndefOr[Boolean] = js.undefined,
    tabAdd: /* e */ TabAddEventArgs => Callback = null,
    tabClick: /* e */ TabClickEventArgs => Callback = null,
    tabCreate: /* e */ TabCreateEventArgs => Callback = null,
    tabRemove: /* e */ TabRemoveEventArgs => Callback = null,
    tabSelect: /* e */ TabSelectEventArgs => Callback = null,
    tabs: js.Array[Tab] = null,
    toggleButtonClick: /* e */ ToggleButtonClickEventArgs => Callback = null,
    ...
    if (backstageItemClick != null) __obj.updateDynamic("backstageItemClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.BackstageItemClickEventArgs) => backstageItemClick(t0).runNow()))
    if (beforeTabRemove != null) __obj.updateDynamic("beforeTabRemove")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.BeforeTabRemoveEventArgs) => beforeTabRemove(t0).runNow()))
    if (buttonDefaults != null) __obj.updateDynamic("buttonDefaults")(buttonDefaults.asInstanceOf[js.Any])
    if (collapse != null) __obj.updateDynamic("collapse")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.CollapseEventArgs) => collapse(t0).runNow()))
    ...
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.CreateEventArgs) => create(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (expand != null) __obj.updateDynamic("expand")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.ExpandEventArgs) => expand(t0).runNow()))
    if (expandPinSettings != null) __obj.updateDynamic("expandPinSettings")(expandPinSettings.asInstanceOf[js.Any])
    if (galleryItemClick != null) __obj.updateDynamic("galleryItemClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.GalleryItemClickEventArgs) => galleryItemClick(t0).runNow()))
    if (groupClick != null) __obj.updateDynamic("groupClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.GroupClickEventArgs) => groupClick(t0).runNow()))
    if (groupExpand != null) __obj.updateDynamic("groupExpand")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.GroupExpandEventArgs) => groupExpand(t0).runNow()))
    if (!js.isUndefined(isResponsive)) __obj.updateDynamic("isResponsive")(isResponsive.asInstanceOf[js.Any])
    if (load != null) __obj.updateDynamic("load")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.LoadEventArgs) => load(t0).runNow()))
    if (locale != null) __obj.updateDynamic("locale")(locale.asInstanceOf[js.Any])
    if (qatMenuItemClick != null) __obj.updateDynamic("qatMenuItemClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.QatMenuItemClickEventArgs) => qatMenuItemClick(t0).runNow()))
    ...
    if (tabAdd != null) __obj.updateDynamic("tabAdd")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.TabAddEventArgs) => tabAdd(t0).runNow()))
    if (tabClick != null) __obj.updateDynamic("tabClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.TabClickEventArgs) => tabClick(t0).runNow()))
    if (tabCreate != null) __obj.updateDynamic("tabCreate")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.TabCreateEventArgs) => tabCreate(t0).runNow()))
    if (tabRemove != null) __obj.updateDynamic("tabRemove")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.TabRemoveEventArgs) => tabRemove(t0).runNow()))
    if (tabSelect != null) __obj.updateDynamic("tabSelect")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.TabSelectEventArgs) => tabSelect(t0).runNow()))
    if (tabs != null) __obj.updateDynamic("tabs")(tabs.asInstanceOf[js.Any])
    if (toggleButtonClick != null) __obj.updateDynamic("toggleButtonClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Ribbon.ToggleButtonClickEventArgs) => toggleButtonClick(t0).runNow()))
