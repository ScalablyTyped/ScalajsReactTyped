...
object DatePicker {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.DatePicker.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.DatePicker.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.DatePicker.Model](x: Self) {
      ...
      inline def setBeforeDateCreate(value: /* e */ BeforeDateCreateEventArgs => Callback): Self = StObject.set(x, "beforeDateCreate", js.Any.fromFunction1((t0: /* e */ BeforeDateCreateEventArgs) => value(t0).runNow()))
      ...
      inline def setNavigate(value: /* e */ NavigateEventArgs => Callback): Self = StObject.set(x, "navigate", js.Any.fromFunction1((t0: /* e */ NavigateEventArgs) => value(t0).runNow()))
