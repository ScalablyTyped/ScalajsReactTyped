...
object Dialog {
  ...
  object AjaxSettings {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Dialog.AjaxSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Dialog.AjaxSettings]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Dialog.AjaxSettings](x: Self) {
  ...
  trait Model extends StObject {
    ...
    /** Specifies the ajaxSettings option to load the content to the Dialog control.
      * @Default {null}
      */
    var ajaxSettings: js.UndefOr[typingsJapgolly.ejWebAll.ej.Dialog.AjaxSettings] = js.undefined
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Dialog.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Dialog.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Dialog.Model](x: Self) {
      
      inline def setActionButtonClick(value: /* e */ ActionButtonClickEventArgs => Callback): Self = StObject.set(x, "actionButtonClick", js.Any.fromFunction1((t0: /* e */ ActionButtonClickEventArgs) => value(t0).runNow()))
      ...
      inline def setAjaxSettings(value: typingsJapgolly.ejWebAll.ej.Dialog.AjaxSettings): Self = StObject.set(x, "ajaxSettings", value.asInstanceOf[js.Any])
      ...
      inline def setContentLoad(value: /* e */ ContentLoadEventArgs => Callback): Self = StObject.set(x, "contentLoad", js.Any.fromFunction1((t0: /* e */ ContentLoadEventArgs) => value(t0).runNow()))
