...
object Model {
  ...
  def apply(
    ...
    padding: String = null,
    rangeChanged: /* e */ RangeChangedEventArgs => Callback = null,
    ...
    selectedRangeEnd: /* e */ SelectedRangeEndEventArgs => Callback = null,
    selectedRangeSettings: SelectedRangeSettings = null,
    selectedRangeStart: /* e */ SelectedRangeStartEventArgs => Callback = null,
    ...
    if (Click != null) __obj.updateDynamic("Click")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.RangeNavigator.ClickEventArgs) => Click(t0).runNow()))
    ...
    if (doubleClick != null) __obj.updateDynamic("doubleClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.RangeNavigator.DoubleClickEventArgs) => doubleClick(t0).runNow()))
    ...
    if (load != null) __obj.updateDynamic("load")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.RangeNavigator.LoadEventArgs) => load(t0).runNow()))
    if (loaded != null) __obj.updateDynamic("loaded")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.RangeNavigator.LoadedEventArgs) => loaded(t0).runNow()))
    ...
    if (rangeChanged != null) __obj.updateDynamic("rangeChanged")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.RangeNavigator.RangeChangedEventArgs) => rangeChanged(t0).runNow()))
    ...
    if (rightClick != null) __obj.updateDynamic("rightClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.RangeNavigator.RightClickEventArgs) => rightClick(t0).runNow()))
    if (scrollChanged != null) __obj.updateDynamic("scrollChanged")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.RangeNavigator.ScrollChangedEventArgs) => scrollChanged(t0).runNow()))
    if (scrollEnd != null) __obj.updateDynamic("scrollEnd")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.RangeNavigator.ScrollEndEventArgs) => scrollEnd(t0).runNow()))
    if (scrollRangeSettings != null) __obj.updateDynamic("scrollRangeSettings")(scrollRangeSettings.asInstanceOf[js.Any])
    if (scrollStart != null) __obj.updateDynamic("scrollStart")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.RangeNavigator.ScrollStartEventArgs) => scrollStart(t0).runNow()))
    if (selectedData != null) __obj.updateDynamic("selectedData")(selectedData.asInstanceOf[js.Any])
    if (selectedRangeEnd != null) __obj.updateDynamic("selectedRangeEnd")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.RangeNavigator.SelectedRangeEndEventArgs) => selectedRangeEnd(t0).runNow()))
    if (selectedRangeSettings != null) __obj.updateDynamic("selectedRangeSettings")(selectedRangeSettings.asInstanceOf[js.Any])
    if (selectedRangeStart != null) __obj.updateDynamic("selectedRangeStart")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.RangeNavigator.SelectedRangeStartEventArgs) => selectedRangeStart(t0).runNow()))
