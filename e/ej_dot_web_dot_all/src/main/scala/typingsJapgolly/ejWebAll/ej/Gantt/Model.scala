...
trait Model extends js.Object {
  ...
  /** Specifies the working time schedule of day
    ...
    */
  var workingTimeScale: js.UndefOr[typingsJapgolly.ejWebAll.ej.Gantt.workingTimeScale | String] = js.undefined
}
...
object Model {
  ...
  def apply(
    ...
    queryTaskbarInfo: /* e */ QueryTaskbarInfoEventArgs => Callback = null,
    ...
    splitterResized: /* e */ SplitterResizedEventArgs => Callback = null,
    ...
    taskbarClick: /* e */ TaskbarClickEventArgs => Callback = null,
    taskbarEdited: /* e */ TaskbarEditedEventArgs => Callback = null,
    taskbarEditing: /* e */ TaskbarEditingEventArgs => Callback = null,
    ...
    if (actionBegin != null) __obj.updateDynamic("actionBegin")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.ActionBeginEventArgs) => actionBegin(t0).runNow()))
    if (actionComplete != null) __obj.updateDynamic("actionComplete")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.ActionCompleteEventArgs) => actionComplete(t0).runNow()))
    ...
    if (beginEdit != null) __obj.updateDynamic("beginEdit")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.BeginEditEventArgs) => beginEdit(t0).runNow()))
    if (cellSelected != null) __obj.updateDynamic("cellSelected")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.CellSelectedEventArgs) => cellSelected(t0).runNow()))
    if (cellSelecting != null) __obj.updateDynamic("cellSelecting")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.CellSelectingEventArgs) => cellSelecting(t0).runNow()))
    ...
    if (collapsed != null) __obj.updateDynamic("collapsed")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.CollapsedEventArgs) => collapsed(t0).runNow()))
    if (collapsing != null) __obj.updateDynamic("collapsing")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.CollapsingEventArgs) => collapsing(t0).runNow()))
    ...
    if (contextMenuOpen != null) __obj.updateDynamic("contextMenuOpen")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.ContextMenuOpenEventArgs) => contextMenuOpen(t0).runNow()))
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.CreateEventArgs) => create(t0).runNow()))
    ...
    if (endEdit != null) __obj.updateDynamic("endEdit")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.EndEditEventArgs) => endEdit(t0).runNow()))
    if (expandStateMapping != null) __obj.updateDynamic("expandStateMapping")(expandStateMapping.asInstanceOf[js.Any])
    if (expanded != null) __obj.updateDynamic("expanded")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.ExpandedEventArgs) => expanded(t0).runNow()))
    if (expanding != null) __obj.updateDynamic("expanding")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.ExpandingEventArgs) => expanding(t0).runNow()))
    ...
    if (load != null) __obj.updateDynamic("load")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.LoadEventArgs) => load(t0).runNow()))
    ...
    if (queryCellInfo != null) __obj.updateDynamic("queryCellInfo")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.QueryCellInfoEventArgs) => queryCellInfo(t0).runNow()))
    if (queryTaskbarInfo != null) __obj.updateDynamic("queryTaskbarInfo")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.QueryTaskbarInfoEventArgs) => queryTaskbarInfo(t0).runNow()))
    ...
    if (rowDataBound != null) __obj.updateDynamic("rowDataBound")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.RowDataBoundEventArgs) => rowDataBound(t0).runNow()))
    if (rowDrag != null) __obj.updateDynamic("rowDrag")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.RowDragEventArgs) => rowDrag(t0).runNow()))
    if (rowDragStart != null) __obj.updateDynamic("rowDragStart")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.RowDragStartEventArgs) => rowDragStart(t0).runNow()))
    if (rowDragStop != null) __obj.updateDynamic("rowDragStop")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.RowDragStopEventArgs) => rowDragStop(t0).runNow()))
    if (rowHeight != null) __obj.updateDynamic("rowHeight")(rowHeight.asInstanceOf[js.Any])
    if (rowSelected != null) __obj.updateDynamic("rowSelected")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.RowSelectedEventArgs) => rowSelected(t0).runNow()))
    if (rowSelecting != null) __obj.updateDynamic("rowSelecting")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.RowSelectingEventArgs) => rowSelecting(t0).runNow()))
    ...
    if (splitterResized != null) __obj.updateDynamic("splitterResized")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.SplitterResizedEventArgs) => splitterResized(t0).runNow()))
    ...
    if (taskbarClick != null) __obj.updateDynamic("taskbarClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.TaskbarClickEventArgs) => taskbarClick(t0).runNow()))
    if (taskbarEdited != null) __obj.updateDynamic("taskbarEdited")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.TaskbarEditedEventArgs) => taskbarEdited(t0).runNow()))
    if (taskbarEditing != null) __obj.updateDynamic("taskbarEditing")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.TaskbarEditingEventArgs) => taskbarEditing(t0).runNow()))
    ...
    if (toolbarClick != null) __obj.updateDynamic("toolbarClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Gantt.ToolbarClickEventArgs) => toolbarClick(t0).runNow()))
