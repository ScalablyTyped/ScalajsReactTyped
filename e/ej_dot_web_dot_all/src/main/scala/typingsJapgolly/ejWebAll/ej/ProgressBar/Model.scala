...
object Model {
  ...
  def apply(
    ...
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.ProgressBar.ChangeEventArgs) => change(t0).runNow()))
    if (complete != null) __obj.updateDynamic("complete")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.ProgressBar.CompleteEventArgs) => complete(t0).runNow()))
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.ProgressBar.CreateEventArgs) => create(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.ProgressBar.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (start != null) __obj.updateDynamic("start")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.ProgressBar.StartEventArgs) => start(t0).runNow()))
