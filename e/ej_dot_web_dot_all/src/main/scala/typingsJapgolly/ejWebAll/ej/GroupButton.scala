...
object GroupButton {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.GroupButton.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.GroupButton.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.GroupButton.Model](x: Self) {
