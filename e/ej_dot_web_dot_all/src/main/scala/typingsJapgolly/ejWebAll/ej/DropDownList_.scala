...
class DropDownList_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.DropDownList.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.DropDownList.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.DropDownList.Model = js.native
  @JSName("model")
  var model_DropDownList_ : typingsJapgolly.ejWebAll.ej.DropDownList.Model = js.native
