...
class ReportViewer_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.ReportViewer.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.ReportViewer.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.ReportViewer.Model = js.native
  @JSName("model")
  var model_ReportViewer_ : typingsJapgolly.ejWebAll.ej.ReportViewer.Model = js.native
