...
object Toolbar {
  ...
  trait Model extends StObject {
    ...
    /** Specifies the items of  Toolbar
      * @Default {null}
      */
    var Items: js.UndefOr[typingsJapgolly.ejWebAll.ej.Toolbar.Items] = js.undefined
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Toolbar.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Toolbar.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Toolbar.Model](x: Self) {
      ...
      inline def setItemHover(value: /* e */ ItemHoverEventArgs => Callback): Self = StObject.set(x, "itemHover", js.Any.fromFunction1((t0: /* e */ ItemHoverEventArgs) => value(t0).runNow()))
      
      inline def setItemHoverUndefined: Self = StObject.set(x, "itemHover", js.undefined)
      
      inline def setItemLeave(value: /* e */ ItemLeaveEventArgs => Callback): Self = StObject.set(x, "itemLeave", js.Any.fromFunction1((t0: /* e */ ItemLeaveEventArgs) => value(t0).runNow()))
      ...
      inline def setOverflowClose(value: /* e */ OverflowCloseEventArgs => Callback): Self = StObject.set(x, "overflowClose", js.Any.fromFunction1((t0: /* e */ OverflowCloseEventArgs) => value(t0).runNow()))
      
      inline def setOverflowCloseUndefined: Self = StObject.set(x, "overflowClose", js.undefined)
      
      inline def setOverflowOpen(value: /* e */ OverflowOpenEventArgs => Callback): Self = StObject.set(x, "overflowOpen", js.Any.fromFunction1((t0: /* e */ OverflowOpenEventArgs) => value(t0).runNow()))
