...
object CheckBox {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.CheckBox.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.CheckBox.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.CheckBox.Model](x: Self) {
