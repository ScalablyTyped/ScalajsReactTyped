...
class Accordion_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.Accordion.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.Accordion.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.Accordion.Model = js.native
  @JSName("model")
  var model_Accordion_ : typingsJapgolly.ejWebAll.ej.Accordion.Model = js.native
