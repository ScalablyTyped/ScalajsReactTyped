...
object DropDownTree {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.DropDownTree.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.DropDownTree.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.DropDownTree.Model](x: Self) {
      ...
      inline def setBlur(value: /* e */ BlurEventArgs => Callback): Self = StObject.set(x, "blur", js.Any.fromFunction1((t0: /* e */ BlurEventArgs) => value(t0).runNow()))
      ...
      inline def setFiltering(value: /* e */ FilteringEventArgs => Callback): Self = StObject.set(x, "filtering", js.Any.fromFunction1((t0: /* e */ FilteringEventArgs) => value(t0).runNow()))
      
      inline def setFilteringUndefined: Self = StObject.set(x, "filtering", js.undefined)
      
      inline def setFocus(value: /* e */ FocusEventArgs => Callback): Self = StObject.set(x, "focus", js.Any.fromFunction1((t0: /* e */ FocusEventArgs) => value(t0).runNow()))
