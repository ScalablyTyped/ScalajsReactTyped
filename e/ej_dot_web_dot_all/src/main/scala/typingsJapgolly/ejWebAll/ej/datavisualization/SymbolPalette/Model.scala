...
object Model {
  ...
  def apply(
    ...
    if (selectionChange != null) __obj.updateDynamic("selectionChange")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.SymbolPalette.SelectionChangeEventArgs) => selectionChange(t0).runNow()))
