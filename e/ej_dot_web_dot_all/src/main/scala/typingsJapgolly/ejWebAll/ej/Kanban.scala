...
object Kanban {
  ...
  object KanbanFilter {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(clearFilter = clearFilter.toJsFn, clearSearch = clearSearch.toJsFn, filterCards = filterCards.toJsFn, searchCards = js.Any.fromFunction1((t0: String) => searchCards(t0).runNow()))
    ...
    extension [Self <: KanbanFilter](x: Self) {
      ...
      inline def setFilterCards(value: Callback): Self = StObject.set(x, "filterCards", value.toJsFn)
      
      inline def setSearchCards(value: String => Callback): Self = StObject.set(x, "searchCards", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    }
  }
  ...
  object KanbanSelection {
    ...
    inline def apply(clear: Callback): KanbanSelection = {
  ...
  object KanbanSwimlane {
    ...
    inline def apply(collapseAll: Callback, expandAll: Callback, toggle: Any => Callback): KanbanSwimlane = {
      val __obj = js.Dynamic.literal(collapseAll = collapseAll.toJsFn, expandAll = expandAll.toJsFn, toggle = js.Any.fromFunction1((t0: Any) => toggle(t0).runNow()))
    ...
    extension [Self <: KanbanSwimlane](x: Self) {
      ...
      inline def setToggle(value: Any => Callback): Self = StObject.set(x, "toggle", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
    }
  }
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Kanban.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Kanban.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Kanban.Model](x: Self) {
      ...
      inline def setBeforeCardSelect(value: /* e */ BeforeCardSelectEventArgs => Callback): Self = StObject.set(x, "beforeCardSelect", js.Any.fromFunction1((t0: /* e */ BeforeCardSelectEventArgs) => value(t0).runNow()))
      ...
      inline def setCardClick(value: /* e */ CardClickEventArgs => Callback): Self = StObject.set(x, "cardClick", js.Any.fromFunction1((t0: /* e */ CardClickEventArgs) => value(t0).runNow()))
      
      inline def setCardClickUndefined: Self = StObject.set(x, "cardClick", js.undefined)
      
      inline def setCardDoubleClick(value: /* e */ CardDoubleClickEventArgs => Callback): Self = StObject.set(x, "cardDoubleClick", js.Any.fromFunction1((t0: /* e */ CardDoubleClickEventArgs) => value(t0).runNow()))
      
      inline def setCardDoubleClickUndefined: Self = StObject.set(x, "cardDoubleClick", js.undefined)
      
      inline def setCardDrag(value: /* e */ CardDragEventArgs => Callback): Self = StObject.set(x, "cardDrag", js.Any.fromFunction1((t0: /* e */ CardDragEventArgs) => value(t0).runNow()))
      
      inline def setCardDragStart(value: /* e */ CardDragStartEventArgs => Callback): Self = StObject.set(x, "cardDragStart", js.Any.fromFunction1((t0: /* e */ CardDragStartEventArgs) => value(t0).runNow()))
      
      inline def setCardDragStartUndefined: Self = StObject.set(x, "cardDragStart", js.undefined)
      
      inline def setCardDragStop(value: /* e */ CardDragStopEventArgs => Callback): Self = StObject.set(x, "cardDragStop", js.Any.fromFunction1((t0: /* e */ CardDragStopEventArgs) => value(t0).runNow()))
      ...
      inline def setCardDrop(value: /* e */ CardDropEventArgs => Callback): Self = StObject.set(x, "cardDrop", js.Any.fromFunction1((t0: /* e */ CardDropEventArgs) => value(t0).runNow()))
      
      inline def setCardDropUndefined: Self = StObject.set(x, "cardDrop", js.undefined)
      
      inline def setCardSelect(value: /* e */ CardSelectEventArgs => Callback): Self = StObject.set(x, "cardSelect", js.Any.fromFunction1((t0: /* e */ CardSelectEventArgs) => value(t0).runNow()))
      
      inline def setCardSelectUndefined: Self = StObject.set(x, "cardSelect", js.undefined)
      
      inline def setCardSelecting(value: /* e */ CardSelectingEventArgs => Callback): Self = StObject.set(x, "cardSelecting", js.Any.fromFunction1((t0: /* e */ CardSelectingEventArgs) => value(t0).runNow()))
      ...
      inline def setHeaderClick(value: /* e */ HeaderClickEventArgs => Callback): Self = StObject.set(x, "headerClick", js.Any.fromFunction1((t0: /* e */ HeaderClickEventArgs) => value(t0).runNow()))
      ...
      inline def setSwimlaneClick(value: /* e */ SwimlaneClickEventArgs => Callback): Self = StObject.set(x, "swimlaneClick", js.Any.fromFunction1((t0: /* e */ SwimlaneClickEventArgs) => value(t0).runNow()))
