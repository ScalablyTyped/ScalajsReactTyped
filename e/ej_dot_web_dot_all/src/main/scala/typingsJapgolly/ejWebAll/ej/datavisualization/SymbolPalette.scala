...
object SymbolPalette {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.datavisualization.SymbolPalette.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.datavisualization.SymbolPalette.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.datavisualization.SymbolPalette.Model](x: Self) {
      ...
      inline def setSelectionChange(value: /* e */ SelectionChangeEventArgs => Callback): Self = StObject.set(x, "selectionChange", js.Any.fromFunction1((t0: /* e */ SelectionChangeEventArgs) => value(t0).runNow()))
