...
object Pager {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Pager.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Pager.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Pager.Model](x: Self) {
      ...
      inline def setPageSizeSelected(value: /* e */ PageSizeSelectedEventArgs => Callback): Self = StObject.set(x, "pageSizeSelected", js.Any.fromFunction1((t0: /* e */ PageSizeSelectedEventArgs) => value(t0).runNow()))
