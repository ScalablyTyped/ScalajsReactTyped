...
object Model {
  ...
  def apply(
    ...
    beforeSend: /* e */ BeforeSendEventArgs => Callback = null,
    begin: /* e */ BeginEventArgs => Callback = null,
    buttonText: ButtonText = null,
    cancel: /* e */ CancelEventArgs => Callback = null,
    ...
    error: /* e */ ErrorEventArgs => Callback = null,
    extensionsAllow: String = null,
    extensionsDeny: String = null,
    fileSelect: /* e */ FileSelectEventArgs => Callback = null,
    fileSize: Int | Double = null,
    height: String = null,
    htmlAttributes: js.Any = null,
    inProgress: /* e */ InProgressEventArgs => Callback = null,
    locale: String = null,
    ...
    success: /* e */ SuccessEventArgs => Callback = null,
    ...
    if (beforeSend != null) __obj.updateDynamic("beforeSend")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Uploadbox.BeforeSendEventArgs) => beforeSend(t0).runNow()))
    if (begin != null) __obj.updateDynamic("begin")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Uploadbox.BeginEventArgs) => begin(t0).runNow()))
    if (buttonText != null) __obj.updateDynamic("buttonText")(buttonText.asInstanceOf[js.Any])
    if (cancel != null) __obj.updateDynamic("cancel")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Uploadbox.CancelEventArgs) => cancel(t0).runNow()))
    if (complete != null) __obj.updateDynamic("complete")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Uploadbox.CompleteEventArgs) => complete(t0).runNow()))
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Uploadbox.CreateEventArgs) => create(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (customFileDetails != null) __obj.updateDynamic("customFileDetails")(customFileDetails.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Uploadbox.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (error != null) __obj.updateDynamic("error")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Uploadbox.ErrorEventArgs) => error(t0).runNow()))
    ...
    if (fileSelect != null) __obj.updateDynamic("fileSelect")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Uploadbox.FileSelectEventArgs) => fileSelect(t0).runNow()))
    if (fileSize != null) __obj.updateDynamic("fileSize")(fileSize.asInstanceOf[js.Any])
    if (height != null) __obj.updateDynamic("height")(height.asInstanceOf[js.Any])
    if (htmlAttributes != null) __obj.updateDynamic("htmlAttributes")(htmlAttributes.asInstanceOf[js.Any])
    if (inProgress != null) __obj.updateDynamic("inProgress")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Uploadbox.InProgressEventArgs) => inProgress(t0).runNow()))
    ...
    if (remove != null) __obj.updateDynamic("remove")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Uploadbox.RemoveEventArgs) => remove(t0).runNow()))
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Uploadbox.SuccessEventArgs) => success(t0).runNow()))
