...
object Model {
  @scala.inline
  def apply(
    cellMouseEnter: /* e */ CellMouseEnterEventArgs => Callback = null,
    cellMouseLeave: /* e */ CellMouseLeaveEventArgs => Callback = null,
    cellMouseOver: /* e */ CellMouseOverEventArgs => Callback = null,
    ...
    if (cellMouseEnter != null) __obj.updateDynamic("cellMouseEnter")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.HeatMap.CellMouseEnterEventArgs) => cellMouseEnter(t0).runNow()))
    if (cellMouseLeave != null) __obj.updateDynamic("cellMouseLeave")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.HeatMap.CellMouseLeaveEventArgs) => cellMouseLeave(t0).runNow()))
    if (cellMouseOver != null) __obj.updateDynamic("cellMouseOver")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.HeatMap.CellMouseOverEventArgs) => cellMouseOver(t0).runNow()))
    if (cellSelected != null) __obj.updateDynamic("cellSelected")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.datavisualization.HeatMap.CellSelectedEventArgs) => cellSelected(t0).runNow()))
