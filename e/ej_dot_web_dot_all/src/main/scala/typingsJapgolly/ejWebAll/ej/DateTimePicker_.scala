...
class DateTimePicker_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.DateTimePicker.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.DateTimePicker.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.DateTimePicker.Model = js.native
  @JSName("model")
  var model_DateTimePicker_ : typingsJapgolly.ejWebAll.ej.DateTimePicker.Model = js.native
