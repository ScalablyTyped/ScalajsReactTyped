...
object HeatMap {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.datavisualization.HeatMap.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.datavisualization.HeatMap.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.datavisualization.HeatMap.Model](x: Self) {
      
      inline def setCellMouseEnter(value: /* e */ CellMouseEnterEventArgs => Callback): Self = StObject.set(x, "cellMouseEnter", js.Any.fromFunction1((t0: /* e */ CellMouseEnterEventArgs) => value(t0).runNow()))
      
      inline def setCellMouseEnterUndefined: Self = StObject.set(x, "cellMouseEnter", js.undefined)
      
      inline def setCellMouseLeave(value: /* e */ CellMouseLeaveEventArgs => Callback): Self = StObject.set(x, "cellMouseLeave", js.Any.fromFunction1((t0: /* e */ CellMouseLeaveEventArgs) => value(t0).runNow()))
      
      inline def setCellMouseLeaveUndefined: Self = StObject.set(x, "cellMouseLeave", js.undefined)
      
      inline def setCellMouseOver(value: /* e */ CellMouseOverEventArgs => Callback): Self = StObject.set(x, "cellMouseOver", js.Any.fromFunction1((t0: /* e */ CellMouseOverEventArgs) => value(t0).runNow()))
