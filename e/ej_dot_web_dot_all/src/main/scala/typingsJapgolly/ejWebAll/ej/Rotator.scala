...
object Rotator {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Rotator.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Rotator.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Rotator.Model](x: Self) {
      ...
      inline def setThumbItemClick(value: /* e */ ThumbItemClickEventArgs => Callback): Self = StObject.set(x, "thumbItemClick", js.Any.fromFunction1((t0: /* e */ ThumbItemClickEventArgs) => value(t0).runNow()))
