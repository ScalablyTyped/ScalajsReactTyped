...
object Model {
  ...
  def apply(
    ...
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Signature.ChangeEventArgs) => change(t0).runNow()))
    ...
    if (mouseDown != null) __obj.updateDynamic("mouseDown")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Signature.MouseDownEventArgs) => mouseDown(t0).runNow()))
    if (mouseMove != null) __obj.updateDynamic("mouseMove")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Signature.MouseMoveEventArgs) => mouseMove(t0).runNow()))
    if (mouseUp != null) __obj.updateDynamic("mouseUp")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Signature.MouseUpEventArgs) => mouseUp(t0).runNow()))
