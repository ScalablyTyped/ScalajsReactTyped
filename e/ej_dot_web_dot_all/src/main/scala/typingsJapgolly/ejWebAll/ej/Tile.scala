...
object Tile {
  ...
  object ImagePosition extends StObject {
    ...
    sealed trait BottomCenter
      extends StObject
         with typingsJapgolly.ejWebAll.ej.Tile.ImagePosition
  ...
  trait Model extends StObject {
    ...
    /** Specifies the position of tile image.
      * @Default {center}
      */
    var imagePosition: js.UndefOr[typingsJapgolly.ejWebAll.ej.ImagePosition | String] = js.undefined
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Tile.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Tile.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Tile.Model](x: Self) {
      ...
      inline def setImagePosition(value: typingsJapgolly.ejWebAll.ej.ImagePosition | String): Self = StObject.set(x, "imagePosition", value.asInstanceOf[js.Any])
