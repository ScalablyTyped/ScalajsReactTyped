...
class Gantt_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.Gantt.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.Gantt.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.Gantt.Model = js.native
  @JSName("model")
  var model_Gantt_ : typingsJapgolly.ejWebAll.ej.Gantt.Model = js.native
