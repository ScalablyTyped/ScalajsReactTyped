...
object LayersSubLayer {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableMouseHover)) __obj.updateDynamic("enableMouseHover")(enableMouseHover.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showMapItems)) __obj.updateDynamic("showMapItems")(showMapItems.asInstanceOf[js.Any])
