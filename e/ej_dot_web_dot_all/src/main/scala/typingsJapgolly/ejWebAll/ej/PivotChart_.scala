...
class PivotChart_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.PivotChart.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.PivotChart.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.PivotChart.Model = js.native
  @JSName("model")
  var model_PivotChart_ : typingsJapgolly.ejWebAll.ej.PivotChart.Model = js.native
