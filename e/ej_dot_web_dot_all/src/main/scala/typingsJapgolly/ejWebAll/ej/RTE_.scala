...
class RTE_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.RTE.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.RTE.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.RTE.Model = js.native
  @JSName("model")
  var model_RTE_ : typingsJapgolly.ejWebAll.ej.RTE.Model = js.native
