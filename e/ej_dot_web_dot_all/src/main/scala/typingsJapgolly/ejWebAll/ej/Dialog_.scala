...
class Dialog_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.Dialog.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.Dialog.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.Dialog.Model = js.native
  @JSName("model")
  var model_Dialog_ : typingsJapgolly.ejWebAll.ej.Dialog.Model = js.native
