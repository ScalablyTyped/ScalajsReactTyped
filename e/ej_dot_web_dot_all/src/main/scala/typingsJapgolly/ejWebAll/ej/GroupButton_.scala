...
class GroupButton_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.GroupButton.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.GroupButton.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.GroupButton.Model = js.native
  @JSName("model")
  var model_GroupButton_ : typingsJapgolly.ejWebAll.ej.GroupButton.Model = js.native
