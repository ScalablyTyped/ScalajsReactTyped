...
object Model {
  ...
  def apply(
    ...
    pageSizeSelected: /* e */ PageSizeSelectedEventArgs => Callback = null,
    ...
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Pager.ChangeEventArgs) => change(t0).runNow()))
    if (click != null) __obj.updateDynamic("click")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Pager.ClickEventArgs) => click(t0).runNow()))
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Pager.CreateEventArgs) => create(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (currentPage != null) __obj.updateDynamic("currentPage")(currentPage.asInstanceOf[js.Any])
    if (customText != null) __obj.updateDynamic("customText")(customText.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Pager.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (pageSizeSelected != null) __obj.updateDynamic("pageSizeSelected")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Pager.PageSizeSelectedEventArgs) => pageSizeSelected(t0).runNow()))
