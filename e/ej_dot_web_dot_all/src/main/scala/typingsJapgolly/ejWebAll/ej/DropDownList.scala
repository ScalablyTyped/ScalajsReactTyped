...
object DropDownList {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.DropDownList.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.DropDownList.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.DropDownList.Model](x: Self) {
      ...
      inline def setBeforePopupHide(value: /* e */ BeforePopupHideEventArgs => Callback): Self = StObject.set(x, "beforePopupHide", js.Any.fromFunction1((t0: /* e */ BeforePopupHideEventArgs) => value(t0).runNow()))
      
      inline def setBeforePopupHideUndefined: Self = StObject.set(x, "beforePopupHide", js.undefined)
      
      inline def setBeforePopupShown(value: /* e */ BeforePopupShownEventArgs => Callback): Self = StObject.set(x, "beforePopupShown", js.Any.fromFunction1((t0: /* e */ BeforePopupShownEventArgs) => value(t0).runNow()))
      
      inline def setBeforePopupShownUndefined: Self = StObject.set(x, "beforePopupShown", js.undefined)
      
      inline def setCascade(value: /* e */ CascadeEventArgs => Callback): Self = StObject.set(x, "cascade", js.Any.fromFunction1((t0: /* e */ CascadeEventArgs) => value(t0).runNow()))
      ...
      inline def setPopupHide(value: /* e */ PopupHideEventArgs => Callback): Self = StObject.set(x, "popupHide", js.Any.fromFunction1((t0: /* e */ PopupHideEventArgs) => value(t0).runNow()))
      
      inline def setPopupHideUndefined: Self = StObject.set(x, "popupHide", js.undefined)
      
      inline def setPopupResize(value: /* e */ PopupResizeEventArgs => Callback): Self = StObject.set(x, "popupResize", js.Any.fromFunction1((t0: /* e */ PopupResizeEventArgs) => value(t0).runNow()))
      
      inline def setPopupResizeStart(value: /* e */ PopupResizeStartEventArgs => Callback): Self = StObject.set(x, "popupResizeStart", js.Any.fromFunction1((t0: /* e */ PopupResizeStartEventArgs) => value(t0).runNow()))
      
      inline def setPopupResizeStartUndefined: Self = StObject.set(x, "popupResizeStart", js.undefined)
      
      inline def setPopupResizeStop(value: /* e */ PopupResizeStopEventArgs => Callback): Self = StObject.set(x, "popupResizeStop", js.Any.fromFunction1((t0: /* e */ PopupResizeStopEventArgs) => value(t0).runNow()))
      ...
      inline def setPopupShown(value: /* e */ PopupShownEventArgs => Callback): Self = StObject.set(x, "popupShown", js.Any.fromFunction1((t0: /* e */ PopupShownEventArgs) => value(t0).runNow()))
      ...
      inline def setSearch(value: /* e */ SearchEventArgs => Callback): Self = StObject.set(x, "search", js.Any.fromFunction1((t0: /* e */ SearchEventArgs) => value(t0).runNow()))
