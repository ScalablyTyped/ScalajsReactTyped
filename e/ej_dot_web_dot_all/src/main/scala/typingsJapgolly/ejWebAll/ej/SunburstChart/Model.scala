...
import typingsJapgolly.ejWebAll.ej.datavisualization.Sunburst.Animation
...
object Model {
  ...
  def apply(
    ...
    border: Border = null,
    dataLabelRendering: /* e */ DataLabelRenderingEventArgs => Callback = null,
    dataLabelSettings: DataLabelSettings = null,
    dataSource: js.Any = null,
    doubleClick: /* e */ DoubleClickEventArgs => Callback = null,
    drillDownBack: /* e */ DrillDownBackEventArgs => Callback = null,
    drillDownClick: /* e */ DrillDownClickEventArgs => Callback = null,
    drillDownReset: /* e */ DrillDownResetEventArgs => Callback = null,
    ...
    segmentRendering: /* e */ SegmentRenderingEventArgs => Callback = null,
    ...
    if (Click != null) __obj.updateDynamic("Click")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.ClickEventArgs) => Click(t0).runNow()))
    if (animationType != null) __obj.updateDynamic("animationType")(animationType.asInstanceOf[js.Any])
    if (background != null) __obj.updateDynamic("background")(background.asInstanceOf[js.Any])
    if (border != null) __obj.updateDynamic("border")(border.asInstanceOf[js.Any])
    if (dataLabelRendering != null) __obj.updateDynamic("dataLabelRendering")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.DataLabelRenderingEventArgs) => dataLabelRendering(t0).runNow()))
    if (dataLabelSettings != null) __obj.updateDynamic("dataLabelSettings")(dataLabelSettings.asInstanceOf[js.Any])
    if (dataSource != null) __obj.updateDynamic("dataSource")(dataSource.asInstanceOf[js.Any])
    if (doubleClick != null) __obj.updateDynamic("doubleClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.DoubleClickEventArgs) => doubleClick(t0).runNow()))
    if (drillDownBack != null) __obj.updateDynamic("drillDownBack")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.DrillDownBackEventArgs) => drillDownBack(t0).runNow()))
    if (drillDownClick != null) __obj.updateDynamic("drillDownClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.DrillDownClickEventArgs) => drillDownClick(t0).runNow()))
    if (drillDownReset != null) __obj.updateDynamic("drillDownReset")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.DrillDownResetEventArgs) => drillDownReset(t0).runNow()))
    ...
    if (load != null) __obj.updateDynamic("load")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.LoadEventArgs) => load(t0).runNow()))
    if (loaded != null) __obj.updateDynamic("loaded")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.LoadedEventArgs) => loaded(t0).runNow()))
    ...
    if (pointRegionClick != null) __obj.updateDynamic("pointRegionClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.PointRegionClickEventArgs) => pointRegionClick(t0).runNow()))
    if (pointRegionMouseMove != null) __obj.updateDynamic("pointRegionMouseMove")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.PointRegionMouseMoveEventArgs) => pointRegionMouseMove(t0).runNow()))
    if (points != null) __obj.updateDynamic("points")(points.asInstanceOf[js.Any])
    if (preRender != null) __obj.updateDynamic("preRender")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.PreRenderEventArgs) => preRender(t0).runNow()))
    if (radius != null) __obj.updateDynamic("radius")(radius.asInstanceOf[js.Any])
    if (rightClick != null) __obj.updateDynamic("rightClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.RightClickEventArgs) => rightClick(t0).runNow()))
    if (segmentBorder != null) __obj.updateDynamic("segmentBorder")(segmentBorder.asInstanceOf[js.Any])
    if (segmentRendering != null) __obj.updateDynamic("segmentRendering")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.SegmentRenderingEventArgs) => segmentRendering(t0).runNow()))
    ...
    if (titleRendering != null) __obj.updateDynamic("titleRendering")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.TitleRenderingEventArgs) => titleRendering(t0).runNow()))
    if (tooltip != null) __obj.updateDynamic("tooltip")(tooltip.asInstanceOf[js.Any])
    if (tooltipInitialize != null) __obj.updateDynamic("tooltipInitialize")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.SunburstChart.TooltipInitializeEventArgs) => tooltipInitialize(t0).runNow()))
