...
import typingsJapgolly.ejWebAll.ej.TreeGrid.EjPredicate
...
object TreeGrid {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.TreeGrid.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.TreeGrid.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.TreeGrid.Model](x: Self) {
      ...
      inline def setCollapsed(value: /* e */ CollapsedEventArgs => Callback): Self = StObject.set(x, "collapsed", js.Any.fromFunction1((t0: /* e */ CollapsedEventArgs) => value(t0).runNow()))
      ...
      inline def setCollapsing(value: /* e */ CollapsingEventArgs => Callback): Self = StObject.set(x, "collapsing", js.Any.fromFunction1((t0: /* e */ CollapsingEventArgs) => value(t0).runNow()))
      ...
      inline def setColumnResizeEnd(value: /* e */ ColumnResizeEndEventArgs => Callback): Self = StObject.set(x, "columnResizeEnd", js.Any.fromFunction1((t0: /* e */ ColumnResizeEndEventArgs) => value(t0).runNow()))
      ...
      inline def setColumnResizeStart(value: /* e */ ColumnResizeStartEventArgs => Callback): Self = StObject.set(x, "columnResizeStart", js.Any.fromFunction1((t0: /* e */ ColumnResizeStartEventArgs) => value(t0).runNow()))
      
      inline def setColumnResizeStartUndefined: Self = StObject.set(x, "columnResizeStart", js.undefined)
      
      inline def setColumnResized(value: /* e */ ColumnResizedEventArgs => Callback): Self = StObject.set(x, "columnResized", js.Any.fromFunction1((t0: /* e */ ColumnResizedEventArgs) => value(t0).runNow()))
      ...
      inline def setContextMenuOpen(value: /* e */ ContextMenuOpenEventArgs => Callback): Self = StObject.set(x, "contextMenuOpen", js.Any.fromFunction1((t0: /* e */ ContextMenuOpenEventArgs) => value(t0).runNow()))
      ...
      inline def setDetailsHidden(value: /* e */ DetailsHiddenEventArgs => Callback): Self = StObject.set(x, "detailsHidden", js.Any.fromFunction1((t0: /* e */ DetailsHiddenEventArgs) => value(t0).runNow()))
      ...
      inline def setDetailsShown(value: /* e */ DetailsShownEventArgs => Callback): Self = StObject.set(x, "detailsShown", js.Any.fromFunction1((t0: /* e */ DetailsShownEventArgs) => value(t0).runNow()))
      ...
      inline def setExpanded(value: /* e */ ExpandedEventArgs => Callback): Self = StObject.set(x, "expanded", js.Any.fromFunction1((t0: /* e */ ExpandedEventArgs) => value(t0).runNow()))
      
      inline def setExpandedUndefined: Self = StObject.set(x, "expanded", js.undefined)
      
      inline def setExpanding(value: /* e */ ExpandingEventArgs => Callback): Self = StObject.set(x, "expanding", js.Any.fromFunction1((t0: /* e */ ExpandingEventArgs) => value(t0).runNow()))
      ...
      inline def setRowDragStop(value: /* e */ RowDragStopEventArgs => Callback): Self = StObject.set(x, "rowDragStop", js.Any.fromFunction1((t0: /* e */ RowDragStopEventArgs) => value(t0).runNow()))
      ...
      inline def setRowDropActionBegin(value: /* e */ RowDropActionBeginEventArgs => Callback): Self = StObject.set(x, "rowDropActionBegin", js.Any.fromFunction1((t0: /* e */ RowDropActionBeginEventArgs) => value(t0).runNow()))
  ...
  trait SelectionSettings extends StObject {
    ...
    /** Specifies the type of selection whether to select row or cell.
      ...
      */
    var selectionMode: js.UndefOr[typingsJapgolly.std.SelectionMode | String] = js.undefined
  ...
  object SelectionSettings {
    ...
    extension [Self <: SelectionSettings](x: Self) {
      ...
      inline def setSelectionMode(value: typingsJapgolly.std.SelectionMode | String): Self = StObject.set(x, "selectionMode", value.asInstanceOf[js.Any])
