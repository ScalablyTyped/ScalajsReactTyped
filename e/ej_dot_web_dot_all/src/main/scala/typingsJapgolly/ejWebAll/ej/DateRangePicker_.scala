...
class DateRangePicker_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.DateRangePicker.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.DateRangePicker.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.DateRangePicker.Model = js.native
  @JSName("model")
  var model_DateRangePicker_ : typingsJapgolly.ejWebAll.ej.DateRangePicker.Model = js.native
