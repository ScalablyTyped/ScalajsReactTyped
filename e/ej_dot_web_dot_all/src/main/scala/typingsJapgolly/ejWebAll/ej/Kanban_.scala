...
import typingsJapgolly.ejWebAll.ej.Kanban.KanbanEdit
import typingsJapgolly.ejWebAll.ej.Kanban.KanbanFilter
import typingsJapgolly.ejWebAll.ej.Kanban.KanbanSelection
import typingsJapgolly.ejWebAll.ej.Kanban.KanbanSwimlane
...
class Kanban_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.Kanban.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.Kanban.Model) = this()
  ...
  var defaults: typingsJapgolly.ejWebAll.ej.Kanban.Model = js.native
  @JSName("model")
  var model_Kanban_ : typingsJapgolly.ejWebAll.ej.Kanban.Model = js.native
