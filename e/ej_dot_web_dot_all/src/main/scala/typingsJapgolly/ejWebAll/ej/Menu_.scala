...
class Menu_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.Menu.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.Menu.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.Menu.Model = js.native
  @JSName("model")
  var model_Menu_ : typingsJapgolly.ejWebAll.ej.Menu.Model = js.native
