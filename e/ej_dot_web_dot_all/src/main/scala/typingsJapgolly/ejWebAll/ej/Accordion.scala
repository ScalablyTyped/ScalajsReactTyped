...
object Accordion {
  ...
  object AjaxSettings {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Accordion.AjaxSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Accordion.AjaxSettings]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Accordion.AjaxSettings](x: Self) {
  ...
  trait Model extends StObject {
    ...
    /** Specifies the ajaxSettings option to load the content to the accordion control.
      * @Default {null}
      */
    var ajaxSettings: js.UndefOr[typingsJapgolly.ejWebAll.ej.Accordion.AjaxSettings] = js.undefined
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Accordion.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Accordion.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Accordion.Model](x: Self) {
      
      inline def setActivate(value: /* e */ ActivateEventArgs => Callback): Self = StObject.set(x, "activate", js.Any.fromFunction1((t0: /* e */ ActivateEventArgs) => value(t0).runNow()))
      ...
      inline def setAjaxSettings(value: typingsJapgolly.ejWebAll.ej.Accordion.AjaxSettings): Self = StObject.set(x, "ajaxSettings", value.asInstanceOf[js.Any])
      ...
      inline def setBeforeActivate(value: /* e */ BeforeActivateEventArgs => Callback): Self = StObject.set(x, "beforeActivate", js.Any.fromFunction1((t0: /* e */ BeforeActivateEventArgs) => value(t0).runNow()))
      
      inline def setBeforeActivateUndefined: Self = StObject.set(x, "beforeActivate", js.undefined)
      
      inline def setBeforeInactivate(value: /* e */ BeforeInactivateEventArgs => Callback): Self = StObject.set(x, "beforeInactivate", js.Any.fromFunction1((t0: /* e */ BeforeInactivateEventArgs) => value(t0).runNow()))
      ...
      inline def setInActivate(value: /* e */ InActivateEventArgs => Callback): Self = StObject.set(x, "inActivate", js.Any.fromFunction1((t0: /* e */ InActivateEventArgs) => value(t0).runNow()))
