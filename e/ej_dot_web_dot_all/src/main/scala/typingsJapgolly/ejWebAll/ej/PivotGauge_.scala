...
class PivotGauge_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.PivotGauge.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.PivotGauge.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.PivotGauge.Model = js.native
  @JSName("model")
  var model_PivotGauge_ : typingsJapgolly.ejWebAll.ej.PivotGauge.Model = js.native
