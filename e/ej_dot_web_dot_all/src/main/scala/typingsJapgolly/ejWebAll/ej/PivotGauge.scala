...
object PivotGauge {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.PivotGauge.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.PivotGauge.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.PivotGauge.Model](x: Self) {
