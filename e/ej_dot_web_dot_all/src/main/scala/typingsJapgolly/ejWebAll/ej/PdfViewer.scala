...
import typingsJapgolly.ejWebAll.ej.PdfViewer.AnnotationType
...
object PdfViewer {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.PdfViewer.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.PdfViewer.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.PdfViewer.Model](x: Self) {
      
      inline def setAfterPrint(value: /* e */ AfterPrintEventArgs => Callback): Self = StObject.set(x, "afterPrint", js.Any.fromFunction1((t0: /* e */ AfterPrintEventArgs) => value(t0).runNow()))
      
      inline def setAfterPrintUndefined: Self = StObject.set(x, "afterPrint", js.undefined)
      
      inline def setAjaxRequestFailure(value: /* e */ AjaxRequestFailureEventArgs => Callback): Self = StObject.set(x, "ajaxRequestFailure", js.Any.fromFunction1((t0: /* e */ AjaxRequestFailureEventArgs) => value(t0).runNow()))
      
      inline def setAjaxRequestFailureUndefined: Self = StObject.set(x, "ajaxRequestFailure", js.undefined)
      
      inline def setAjaxRequestSuccess(value: /* e */ AjaxRequestSuccessEventArgs => Callback): Self = StObject.set(x, "ajaxRequestSuccess", js.Any.fromFunction1((t0: /* e */ AjaxRequestSuccessEventArgs) => value(t0).runNow()))
      ...
      inline def setAnnotationAdd(value: /* e */ AnnotationAddEventArgs => Callback): Self = StObject.set(x, "annotationAdd", js.Any.fromFunction1((t0: /* e */ AnnotationAddEventArgs) => value(t0).runNow()))
      ...
      inline def setAnnotationPropertiesChange(value: /* e */ AnnotationPropertiesChangeEventArgs => Callback): Self = StObject.set(x, "annotationPropertiesChange", js.Any.fromFunction1((t0: /* e */ AnnotationPropertiesChangeEventArgs) => value(t0).runNow()))
      
      inline def setAnnotationPropertiesChangeUndefined: Self = StObject.set(x, "annotationPropertiesChange", js.undefined)
      
      inline def setAnnotationRemove(value: /* e */ AnnotationRemoveEventArgs => Callback): Self = StObject.set(x, "annotationRemove", js.Any.fromFunction1((t0: /* e */ AnnotationRemoveEventArgs) => value(t0).runNow()))
      ...
      inline def setBufferEnd(value: /* e */ BufferEndEventArgs => Callback): Self = StObject.set(x, "bufferEnd", js.Any.fromFunction1((t0: /* e */ BufferEndEventArgs) => value(t0).runNow()))
      
      inline def setBufferEndUndefined: Self = StObject.set(x, "bufferEnd", js.undefined)
      
      inline def setBufferStart(value: /* e */ BufferStartEventArgs => Callback): Self = StObject.set(x, "bufferStart", js.Any.fromFunction1((t0: /* e */ BufferStartEventArgs) => value(t0).runNow()))
      ...
      inline def setDocumentLoad(value: /* e */ DocumentLoadEventArgs => Callback): Self = StObject.set(x, "documentLoad", js.Any.fromFunction1((t0: /* e */ DocumentLoadEventArgs) => value(t0).runNow()))
      ...
      inline def setDocumentUnload(value: /* e */ DocumentUnloadEventArgs => Callback): Self = StObject.set(x, "documentUnload", js.Any.fromFunction1((t0: /* e */ DocumentUnloadEventArgs) => value(t0).runNow()))
      
      inline def setDocumentUnloadUndefined: Self = StObject.set(x, "documentUnload", js.undefined)
      
      inline def setDownloadEnd(value: /* e */ DownloadEndEventArgs => Callback): Self = StObject.set(x, "downloadEnd", js.Any.fromFunction1((t0: /* e */ DownloadEndEventArgs) => value(t0).runNow()))
      
      inline def setDownloadEndUndefined: Self = StObject.set(x, "downloadEnd", js.undefined)
      
      inline def setDownloadStart(value: /* e */ DownloadStartEventArgs => Callback): Self = StObject.set(x, "downloadStart", js.Any.fromFunction1((t0: /* e */ DownloadStartEventArgs) => value(t0).runNow()))
      ...
      inline def setHyperlinkClick(value: /* e */ HyperlinkClickEventArgs => Callback): Self = StObject.set(x, "hyperlinkClick", js.Any.fromFunction1((t0: /* e */ HyperlinkClickEventArgs) => value(t0).runNow()))
      ...
      inline def setPageChange(value: /* e */ PageChangeEventArgs => Callback): Self = StObject.set(x, "pageChange", js.Any.fromFunction1((t0: /* e */ PageChangeEventArgs) => value(t0).runNow()))
      
      inline def setPageChangeUndefined: Self = StObject.set(x, "pageChange", js.undefined)
      
      inline def setPageClick(value: /* e */ PageClickEventArgs => Callback): Self = StObject.set(x, "pageClick", js.Any.fromFunction1((t0: /* e */ PageClickEventArgs) => value(t0).runNow()))
      ...
      inline def setSignatureAdd(value: /* e */ SignatureAddEventArgs => Callback): Self = StObject.set(x, "signatureAdd", js.Any.fromFunction1((t0: /* e */ SignatureAddEventArgs) => value(t0).runNow()))
      
      inline def setSignatureAddUndefined: Self = StObject.set(x, "signatureAdd", js.undefined)
      
      inline def setSignatureDelete(value: /* e */ SignatureDeleteEventArgs => Callback): Self = StObject.set(x, "signatureDelete", js.Any.fromFunction1((t0: /* e */ SignatureDeleteEventArgs) => value(t0).runNow()))
      
      inline def setSignatureDeleteUndefined: Self = StObject.set(x, "signatureDelete", js.undefined)
      
      inline def setSignaturePropertiesChange(value: /* e */ SignaturePropertiesChangeEventArgs => Callback): Self = StObject.set(x, "signaturePropertiesChange", js.Any.fromFunction1((t0: /* e */ SignaturePropertiesChangeEventArgs) => value(t0).runNow()))
      
      inline def setSignaturePropertiesChangeUndefined: Self = StObject.set(x, "signaturePropertiesChange", js.undefined)
      
      inline def setSignatureResize(value: /* e */ SignatureResizeEventArgs => Callback): Self = StObject.set(x, "signatureResize", js.Any.fromFunction1((t0: /* e */ SignatureResizeEventArgs) => value(t0).runNow()))
      ...
      inline def setZoomChange(value: /* e */ ZoomChangeEventArgs => Callback): Self = StObject.set(x, "zoomChange", js.Any.fromFunction1((t0: /* e */ ZoomChangeEventArgs) => value(t0).runNow()))
