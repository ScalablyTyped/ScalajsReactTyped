...
class PivotClient_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.PivotClient.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.PivotClient.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.PivotClient.Model = js.native
  @JSName("model")
  var model_PivotClient_ : typingsJapgolly.ejWebAll.ej.PivotClient.Model = js.native
