...
object Signature {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Signature.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Signature.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Signature.Model](x: Self) {
      ...
      inline def setMouseMove(value: /* e */ MouseMoveEventArgs => Callback): Self = StObject.set(x, "mouseMove", js.Any.fromFunction1((t0: /* e */ MouseMoveEventArgs) => value(t0).runNow()))
