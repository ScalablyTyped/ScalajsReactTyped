package typingsJapgolly.ejWebAll.ej.Scroller
...
object Model {
  ...
  def apply(
    ...
    thumbEnd: /* e */ ThumbEndEventArgs => Callback = null,
    thumbMove: /* e */ ThumbMoveEventArgs => Callback = null,
    thumbStart: /* e */ ThumbStartEventArgs => Callback = null,
    wheelMove: /* e */ WheelMoveEventArgs => Callback = null,
    wheelStart: /* e */ WheelStartEventArgs => Callback = null,
    wheelStop: /* e */ WheelStopEventArgs => Callback = null,
    ...
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Scroller.CreateEventArgs) => create(t0).runNow()))
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Scroller.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (thumbEnd != null) __obj.updateDynamic("thumbEnd")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Scroller.ThumbEndEventArgs) => thumbEnd(t0).runNow()))
    if (thumbMove != null) __obj.updateDynamic("thumbMove")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Scroller.ThumbMoveEventArgs) => thumbMove(t0).runNow()))
    if (thumbStart != null) __obj.updateDynamic("thumbStart")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Scroller.ThumbStartEventArgs) => thumbStart(t0).runNow()))
    if (wheelMove != null) __obj.updateDynamic("wheelMove")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Scroller.WheelMoveEventArgs) => wheelMove(t0).runNow()))
    if (wheelStart != null) __obj.updateDynamic("wheelStart")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Scroller.WheelStartEventArgs) => wheelStart(t0).runNow()))
    if (wheelStop != null) __obj.updateDynamic("wheelStop")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Scroller.WheelStopEventArgs) => wheelStop(t0).runNow()))
