...
class DropDownTree_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.DropDownTree.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.DropDownTree.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.DropDownTree.Model = js.native
  @JSName("model")
  var model_DropDownTree_ : typingsJapgolly.ejWebAll.ej.DropDownTree.Model = js.native
