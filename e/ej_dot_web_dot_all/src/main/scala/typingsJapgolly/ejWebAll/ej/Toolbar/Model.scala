...
object Model {
  ...
  def apply(
    ...
    itemHover: /* e */ ItemHoverEventArgs => Callback = null,
    itemLeave: /* e */ ItemLeaveEventArgs => Callback = null,
    ...
    if (click != null) __obj.updateDynamic("click")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Toolbar.ClickEventArgs) => click(t0).runNow()))
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Toolbar.CreateEventArgs) => create(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (dataSource != null) __obj.updateDynamic("dataSource")(dataSource.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Toolbar.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (focusOut != null) __obj.updateDynamic("focusOut")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Toolbar.FocusOutEventArgs) => focusOut(t0).runNow()))
    ...
    if (itemHover != null) __obj.updateDynamic("itemHover")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Toolbar.ItemHoverEventArgs) => itemHover(t0).runNow()))
    if (itemLeave != null) __obj.updateDynamic("itemLeave")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Toolbar.ItemLeaveEventArgs) => itemLeave(t0).runNow()))
    if (orientation != null) __obj.updateDynamic("orientation")(orientation.asInstanceOf[js.Any])
    if (overflowClose != null) __obj.updateDynamic("overflowClose")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Toolbar.OverflowCloseEventArgs) => overflowClose(t0).runNow()))
    if (overflowOpen != null) __obj.updateDynamic("overflowOpen")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Toolbar.OverflowOpenEventArgs) => overflowOpen(t0).runNow()))
