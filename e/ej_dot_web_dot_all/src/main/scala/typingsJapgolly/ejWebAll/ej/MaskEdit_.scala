...
class MaskEdit_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.MaskEdit.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.MaskEdit.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.MaskEdit.Model = js.native
  @JSName("model")
  var model_MaskEdit_ : typingsJapgolly.ejWebAll.ej.MaskEdit.Model = js.native
