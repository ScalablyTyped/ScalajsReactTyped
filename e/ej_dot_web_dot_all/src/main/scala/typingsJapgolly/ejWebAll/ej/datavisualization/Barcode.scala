...
object Barcode {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.datavisualization.Barcode.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.datavisualization.Barcode.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.datavisualization.Barcode.Model](x: Self) {
