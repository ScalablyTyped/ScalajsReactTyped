...
object Uploadbox {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Uploadbox.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Uploadbox.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Uploadbox.Model](x: Self) {
      ...
      inline def setBeforeSend(value: /* e */ BeforeSendEventArgs => Callback): Self = StObject.set(x, "beforeSend", js.Any.fromFunction1((t0: /* e */ BeforeSendEventArgs) => value(t0).runNow()))
      
      inline def setBeforeSendUndefined: Self = StObject.set(x, "beforeSend", js.undefined)
      
      inline def setBegin(value: /* e */ BeginEventArgs => Callback): Self = StObject.set(x, "begin", js.Any.fromFunction1((t0: /* e */ BeginEventArgs) => value(t0).runNow()))
      ...
      inline def setCancel(value: /* e */ CancelEventArgs => Callback): Self = StObject.set(x, "cancel", js.Any.fromFunction1((t0: /* e */ CancelEventArgs) => value(t0).runNow()))
      ...
      inline def setError(value: /* e */ ErrorEventArgs => Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: /* e */ ErrorEventArgs) => value(t0).runNow()))
      ...
      inline def setFileSelect(value: /* e */ FileSelectEventArgs => Callback): Self = StObject.set(x, "fileSelect", js.Any.fromFunction1((t0: /* e */ FileSelectEventArgs) => value(t0).runNow()))
      ...
      inline def setInProgress(value: /* e */ InProgressEventArgs => Callback): Self = StObject.set(x, "inProgress", js.Any.fromFunction1((t0: /* e */ InProgressEventArgs) => value(t0).runNow()))
      ...
      inline def setSuccess(value: /* e */ SuccessEventArgs => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* e */ SuccessEventArgs) => value(t0).runNow()))
