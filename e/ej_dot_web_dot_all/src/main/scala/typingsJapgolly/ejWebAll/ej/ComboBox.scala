...
object ComboBox {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.ComboBox.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.ComboBox.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.ComboBox.Model](x: Self) {
      ...
      inline def setCustomValueSpecifier(value: /* e */ CustomValueSpecifierEventArgs => Callback): Self = StObject.set(x, "customValueSpecifier", js.Any.fromFunction1((t0: /* e */ CustomValueSpecifierEventArgs) => value(t0).runNow()))
  ...
  trait SelectEventArgs extends StObject {
    ...
    /** Data object of the selected item.
      */
    var itemData: js.UndefOr[typingsJapgolly.ejWebAll.ej.Model] = js.undefined
  ...
  object SelectEventArgs {
    ...
    extension [Self <: SelectEventArgs](x: Self) {
      ...
      inline def setItemData(value: typingsJapgolly.ejWebAll.ej.Model): Self = StObject.set(x, "itemData", value.asInstanceOf[js.Any])
