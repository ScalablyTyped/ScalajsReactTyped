...
object Ribbon {
  ...
  object Type extends StObject {
    ...
    sealed trait Button
      extends StObject
         with typingsJapgolly.ejWebAll.ej.Ribbon.Type
  ...
  trait Model extends StObject {
    ...
    /** Specifies the tabs and its groups. Also specifies the control details that has to be placed in the tab area in the ribbon control.
      * @Default {Array}
      */
    var tabs: js.UndefOr[js.Array[typingsJapgolly.ejWebAll.ej.Ribbon.Tab]] = js.undefined
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Ribbon.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Ribbon.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Ribbon.Model](x: Self) {
      ...
      inline def setBackstageItemClick(value: /* e */ BackstageItemClickEventArgs => Callback): Self = StObject.set(x, "backstageItemClick", js.Any.fromFunction1((t0: /* e */ BackstageItemClickEventArgs) => value(t0).runNow()))
      
      inline def setBackstageItemClickUndefined: Self = StObject.set(x, "backstageItemClick", js.undefined)
      
      inline def setBeforeTabRemove(value: /* e */ BeforeTabRemoveEventArgs => Callback): Self = StObject.set(x, "beforeTabRemove", js.Any.fromFunction1((t0: /* e */ BeforeTabRemoveEventArgs) => value(t0).runNow()))
      ...
      inline def setCollapse(value: /* e */ CollapseEventArgs => Callback): Self = StObject.set(x, "collapse", js.Any.fromFunction1((t0: /* e */ CollapseEventArgs) => value(t0).runNow()))
      ...
      inline def setExpand(value: /* e */ ExpandEventArgs => Callback): Self = StObject.set(x, "expand", js.Any.fromFunction1((t0: /* e */ ExpandEventArgs) => value(t0).runNow()))
      ...
      inline def setGalleryItemClick(value: /* e */ GalleryItemClickEventArgs => Callback): Self = StObject.set(x, "galleryItemClick", js.Any.fromFunction1((t0: /* e */ GalleryItemClickEventArgs) => value(t0).runNow()))
      
      inline def setGalleryItemClickUndefined: Self = StObject.set(x, "galleryItemClick", js.undefined)
      
      inline def setGroupClick(value: /* e */ GroupClickEventArgs => Callback): Self = StObject.set(x, "groupClick", js.Any.fromFunction1((t0: /* e */ GroupClickEventArgs) => value(t0).runNow()))
      
      inline def setGroupClickUndefined: Self = StObject.set(x, "groupClick", js.undefined)
      
      inline def setGroupExpand(value: /* e */ GroupExpandEventArgs => Callback): Self = StObject.set(x, "groupExpand", js.Any.fromFunction1((t0: /* e */ GroupExpandEventArgs) => value(t0).runNow()))
      ...
      inline def setQatMenuItemClick(value: /* e */ QatMenuItemClickEventArgs => Callback): Self = StObject.set(x, "qatMenuItemClick", js.Any.fromFunction1((t0: /* e */ QatMenuItemClickEventArgs) => value(t0).runNow()))
      ...
      inline def setTabAdd(value: /* e */ TabAddEventArgs => Callback): Self = StObject.set(x, "tabAdd", js.Any.fromFunction1((t0: /* e */ TabAddEventArgs) => value(t0).runNow()))
      ...
      inline def setTabCreate(value: /* e */ TabCreateEventArgs => Callback): Self = StObject.set(x, "tabCreate", js.Any.fromFunction1((t0: /* e */ TabCreateEventArgs) => value(t0).runNow()))
      
      inline def setTabCreateUndefined: Self = StObject.set(x, "tabCreate", js.undefined)
      
      inline def setTabRemove(value: /* e */ TabRemoveEventArgs => Callback): Self = StObject.set(x, "tabRemove", js.Any.fromFunction1((t0: /* e */ TabRemoveEventArgs) => value(t0).runNow()))
      ...
      inline def setTabs(value: js.Array[typingsJapgolly.ejWebAll.ej.Ribbon.Tab]): Self = StObject.set(x, "tabs", value.asInstanceOf[js.Any])
      
      inline def setTabsUndefined: Self = StObject.set(x, "tabs", js.undefined)
      
      inline def setTabsVarargs(value: typingsJapgolly.ejWebAll.ej.Ribbon.Tab*): Self = StObject.set(x, "tabs", js.Array(value*))
      
      inline def setToggleButtonClick(value: /* e */ ToggleButtonClickEventArgs => Callback): Self = StObject.set(x, "toggleButtonClick", js.Any.fromFunction1((t0: /* e */ ToggleButtonClickEventArgs) => value(t0).runNow()))
  ...
  object Tab {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.Ribbon.Tab = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.Ribbon.Tab]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.Ribbon.Tab](x: Self) {
