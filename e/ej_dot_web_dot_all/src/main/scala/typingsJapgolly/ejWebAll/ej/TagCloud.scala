...
object TagCloud {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.TagCloud.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.TagCloud.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.TagCloud.Model](x: Self) {
