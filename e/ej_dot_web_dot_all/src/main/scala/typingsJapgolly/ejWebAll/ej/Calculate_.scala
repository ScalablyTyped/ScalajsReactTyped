...
class Calculate_ protected () extends js.Object {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.Calculate.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.Calculate.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.Calculate.Model = js.native
  var model: typingsJapgolly.ejWebAll.ej.Calculate.Model = js.native
