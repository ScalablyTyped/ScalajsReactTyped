...
object PivotSchemaDesigner {
  ...
  object Model {
    ...
    inline def apply(): typingsJapgolly.ejWebAll.ej.PivotSchemaDesigner.Model = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.ejWebAll.ej.PivotSchemaDesigner.Model]
    }
    
    extension [Self <: typingsJapgolly.ejWebAll.ej.PivotSchemaDesigner.Model](x: Self) {
      ...
      inline def setDragMove(value: /* e */ DragMoveEventArgs => Callback): Self = StObject.set(x, "dragMove", js.Any.fromFunction1((t0: /* e */ DragMoveEventArgs) => value(t0).runNow()))
