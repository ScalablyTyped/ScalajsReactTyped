...
class RadialMenu_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.RadialMenu.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.RadialMenu.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.RadialMenu.Model = js.native
  @JSName("model")
  var model_RadialMenu_ : typingsJapgolly.ejWebAll.ej.RadialMenu.Model = js.native
