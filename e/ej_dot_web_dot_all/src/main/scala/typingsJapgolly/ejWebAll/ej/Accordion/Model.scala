...
object Model {
  ...
  def apply(
    ...
    beforeActivate: /* e */ BeforeActivateEventArgs => Callback = null,
    beforeInactivate: /* e */ BeforeInactivateEventArgs => Callback = null,
    ...
    inActivate: /* e */ InActivateEventArgs => Callback = null,
    ...
    if (activate != null) __obj.updateDynamic("activate")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Accordion.ActivateEventArgs) => activate(t0).runNow()))
    if (ajaxBeforeLoad != null) __obj.updateDynamic("ajaxBeforeLoad")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Accordion.AjaxBeforeLoadEventArgs) => ajaxBeforeLoad(t0).runNow()))
    if (ajaxError != null) __obj.updateDynamic("ajaxError")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Accordion.AjaxErrorEventArgs) => ajaxError(t0).runNow()))
    if (ajaxLoad != null) __obj.updateDynamic("ajaxLoad")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Accordion.AjaxLoadEventArgs) => ajaxLoad(t0).runNow()))
    if (ajaxSettings != null) __obj.updateDynamic("ajaxSettings")(ajaxSettings.asInstanceOf[js.Any])
    if (ajaxSuccess != null) __obj.updateDynamic("ajaxSuccess")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Accordion.AjaxSuccessEventArgs) => ajaxSuccess(t0).runNow()))
    ...
    if (beforeActivate != null) __obj.updateDynamic("beforeActivate")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Accordion.BeforeActivateEventArgs) => beforeActivate(t0).runNow()))
    if (beforeInactivate != null) __obj.updateDynamic("beforeInactivate")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Accordion.BeforeInactivateEventArgs) => beforeInactivate(t0).runNow()))
    ...
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Accordion.CreateEventArgs) => create(t0).runNow()))
    if (cssClass != null) __obj.updateDynamic("cssClass")(cssClass.asInstanceOf[js.Any])
    if (customIcon != null) __obj.updateDynamic("customIcon")(customIcon.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Accordion.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (inActivate != null) __obj.updateDynamic("inActivate")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Accordion.InActivateEventArgs) => inActivate(t0).runNow()))
