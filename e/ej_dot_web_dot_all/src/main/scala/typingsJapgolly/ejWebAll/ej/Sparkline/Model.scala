...
trait Model extends js.Object {
  ...
  /** Specifies the theme for Sparkline.
    ...
    */
  var theme: js.UndefOr[typingsJapgolly.ejWebAll.ej.datavisualization.Sparkline.Theme | String] = js.undefined
  ...
  /** Specifies the type of the series to render in sparkline.
    ...
    */
  var `type`: js.UndefOr[typingsJapgolly.ejWebAll.ej.datavisualization.Sparkline.Type | String] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    stroke: String = null,
    theme: typingsJapgolly.ejWebAll.ej.datavisualization.Sparkline.Theme | String = null,
    tooltip: Tooltip = null,
    tooltipInitialize: /* e */ TooltipInitializeEventArgs => Callback = null,
    `type`: typingsJapgolly.ejWebAll.ej.datavisualization.Sparkline.Type | String = null,
    width: Int | Double = null,
    xName: String = null,
    yName: String = null
  ): Model = {
    val __obj = js.Dynamic.literal()
    if (Click != null) __obj.updateDynamic("Click")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Sparkline.ClickEventArgs) => Click(t0).runNow()))
    ...
    if (doubleClick != null) __obj.updateDynamic("doubleClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Sparkline.DoubleClickEventArgs) => doubleClick(t0).runNow()))
    ...
    if (load != null) __obj.updateDynamic("load")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Sparkline.LoadEventArgs) => load(t0).runNow()))
    if (loaded != null) __obj.updateDynamic("loaded")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Sparkline.LoadedEventArgs) => loaded(t0).runNow()))
    ...
    if (pointRegionMouseClick != null) __obj.updateDynamic("pointRegionMouseClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Sparkline.PointRegionMouseClickEventArgs) => pointRegionMouseClick(t0).runNow()))
    if (pointRegionMouseMove != null) __obj.updateDynamic("pointRegionMouseMove")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Sparkline.PointRegionMouseMoveEventArgs) => pointRegionMouseMove(t0).runNow()))
    if (rangeBandSettings != null) __obj.updateDynamic("rangeBandSettings")(rangeBandSettings.asInstanceOf[js.Any])
    if (rightClick != null) __obj.updateDynamic("rightClick")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Sparkline.RightClickEventArgs) => rightClick(t0).runNow()))
    if (seriesRendering != null) __obj.updateDynamic("seriesRendering")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Sparkline.SeriesRenderingEventArgs) => seriesRendering(t0).runNow()))
    if (size != null) __obj.updateDynamic("size")(size.asInstanceOf[js.Any])
    if (sparklineMouseLeave != null) __obj.updateDynamic("sparklineMouseLeave")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Sparkline.SparklineMouseLeaveEventArgs) => sparklineMouseLeave(t0).runNow()))
    if (sparklineMouseMove != null) __obj.updateDynamic("sparklineMouseMove")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Sparkline.SparklineMouseMoveEventArgs) => sparklineMouseMove(t0).runNow()))
    ...
    if (tooltipInitialize != null) __obj.updateDynamic("tooltipInitialize")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.Sparkline.TooltipInitializeEventArgs) => tooltipInitialize(t0).runNow()))
