...
class ComboBox_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.ComboBox.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.ComboBox.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.ComboBox.Model = js.native
  @JSName("model")
  var model_ComboBox_ : typingsJapgolly.ejWebAll.ej.ComboBox.Model = js.native
