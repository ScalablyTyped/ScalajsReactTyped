...
class TimePicker_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typingsJapgolly.ejWebAll.ej.TimePicker.Model) = this()
  def this(element: Element, options: typingsJapgolly.ejWebAll.ej.TimePicker.Model) = this()
  var defaults: typingsJapgolly.ejWebAll.ej.TimePicker.Model = js.native
  @JSName("model")
  var model_TimePicker_ : typingsJapgolly.ejWebAll.ej.TimePicker.Model = js.native
