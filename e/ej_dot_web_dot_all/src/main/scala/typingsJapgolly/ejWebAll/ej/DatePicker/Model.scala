...
object Model {
  ...
  def apply(
    ...
    beforeDateCreate: /* e */ BeforeDateCreateEventArgs => Callback = null,
    ...
    navigate: /* e */ NavigateEventArgs => Callback = null,
    ...
    if (beforeClose != null) __obj.updateDynamic("beforeClose")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DatePicker.BeforeCloseEventArgs) => beforeClose(t0).runNow()))
    if (beforeDateCreate != null) __obj.updateDynamic("beforeDateCreate")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DatePicker.BeforeDateCreateEventArgs) => beforeDateCreate(t0).runNow()))
    if (beforeOpen != null) __obj.updateDynamic("beforeOpen")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DatePicker.BeforeOpenEventArgs) => beforeOpen(t0).runNow()))
    if (blackoutDates != null) __obj.updateDynamic("blackoutDates")(blackoutDates.asInstanceOf[js.Any])
    if (buttonText != null) __obj.updateDynamic("buttonText")(buttonText.asInstanceOf[js.Any])
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DatePicker.ChangeEventArgs) => change(t0).runNow()))
    if (close != null) __obj.updateDynamic("close")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DatePicker.CloseEventArgs) => close(t0).runNow()))
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DatePicker.CreateEventArgs) => create(t0).runNow()))
    ...
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DatePicker.DestroyEventArgs) => destroy(t0).runNow()))
    ...
    if (focusIn != null) __obj.updateDynamic("focusIn")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DatePicker.FocusInEventArgs) => focusIn(t0).runNow()))
    if (focusOut != null) __obj.updateDynamic("focusOut")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DatePicker.FocusOutEventArgs) => focusOut(t0).runNow()))
    ...
    if (navigate != null) __obj.updateDynamic("navigate")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DatePicker.NavigateEventArgs) => navigate(t0).runNow()))
    if (open != null) __obj.updateDynamic("open")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DatePicker.OpenEventArgs) => open(t0).runNow()))
    if (!js.isUndefined(readOnly)) __obj.updateDynamic("readOnly")(readOnly.asInstanceOf[js.Any])
    if (select != null) __obj.updateDynamic("select")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.ejWebAll.ej.DatePicker.SelectEventArgs) => select(t0).runNow()))
