...
import typingsJapgolly.appdmg.mod.SpecificationCodeSign
import typingsJapgolly.appdmg.mod.SpecificationContents
import typingsJapgolly.appdmg.mod.SpecificationWindow
