...
object TypeofYellowBox {
  ...
  inline def apply(ignoreWarnings: js.Array[String] => Callback): TypeofYellowBox = {
    val __obj = js.Dynamic.literal(ignoreWarnings = js.Any.fromFunction1((t0: js.Array[String]) => ignoreWarnings(t0).runNow()))
  ...
  extension [Self <: TypeofYellowBox](x: Self) {
    ...
    inline def setIgnoreWarnings(value: js.Array[String] => Callback): Self = StObject.set(x, "ignoreWarnings", js.Any.fromFunction1((t0: js.Array[String]) => value(t0).runNow()))
