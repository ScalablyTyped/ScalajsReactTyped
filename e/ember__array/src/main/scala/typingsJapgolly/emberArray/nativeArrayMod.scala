...
import typingsJapgolly.std.stdNumbers.`0`
import typingsJapgolly.std.stdNumbers.`1`
import typingsJapgolly.std.stdNumbers.`2`
import typingsJapgolly.std.stdNumbers.`3`
import typingsJapgolly.std.stdNumbers.`4`
import typingsJapgolly.std.stdNumbers.`5`
import typingsJapgolly.std.stdNumbers.`6`
import typingsJapgolly.std.stdNumbers.`7`
...
object nativeArrayMod extends js.Object {
  ...
  val default: typingsJapgolly.emberObject.mixinMod.default[NativeArray[js.Any], typingsJapgolly.emberObject.mod.default] = js.native
