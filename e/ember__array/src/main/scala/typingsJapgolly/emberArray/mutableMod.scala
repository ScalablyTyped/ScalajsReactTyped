...
import typingsJapgolly.emberArray.mod.Array
...
object mutableMod extends js.Object {
  ...
  - typingsJapgolly.emberArray.enumerableMod.Enumerable because Already inherited
  - typingsJapgolly.emberArray.mutableEnumerableMod.MutableEnumerable because var conflicts: `[]`, every_Original, filter_Original, find_Original, firstObject, forEach_Original, lastObject, map_Original, reduce_Original. Inlined addObject, addObjects, removeObject, removeObjects */ @js.native
  ...
  val default: typingsJapgolly.emberObject.mixinMod.default[MutableArray[js.Any], typingsJapgolly.emberObject.mod.default] = js.native
}
