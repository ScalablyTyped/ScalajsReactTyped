...
import typingsJapgolly.emberArray.nativeArrayMod.NativeArray
...
object mod extends js.Object {
  ...
  // tslint:disable-next-line:array-type
  val default: typingsJapgolly.emberObject.mixinMod.default[Array[js.Any], typingsJapgolly.emberObject.mod.default] = js.native
