...
import typingsJapgolly.escpos.AnonAlign
import typingsJapgolly.escpos.AnonCols
import typingsJapgolly.escpos.AnonEncoding
import typingsJapgolly.escpos.AnonFont
import typingsJapgolly.escpos.AnonMode
import typingsJapgolly.escpos.escposNumbers.`0`
