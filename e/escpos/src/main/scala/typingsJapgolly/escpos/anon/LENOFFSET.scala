...
trait LENOFFSET extends StObject {
  ...
  var LEN_OFFSET: typingsJapgolly.escpos.escposInts.`3`
...
object LENOFFSET {
  ...
  extension [Self <: LENOFFSET](x: Self) {
    ...
    inline def setLEN_OFFSET(value: typingsJapgolly.escpos.escposInts.`3`): Self = StObject.set(x, "LEN_OFFSET", value.asInstanceOf[js.Any])
