...
import typingsJapgolly.emberData.emberDataStrings.boolean
import typingsJapgolly.emberData.emberDataStrings.date
import typingsJapgolly.emberData.emberDataStrings.number
import typingsJapgolly.emberData.emberDataStrings.string
