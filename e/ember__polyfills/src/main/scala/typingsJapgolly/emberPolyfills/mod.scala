...
import typingsJapgolly.emberPolyfills.typesMod.Mix
import typingsJapgolly.emberPolyfills.typesMod.Mix3
import typingsJapgolly.emberPolyfills.typesMod.Mix4
...
object mod {
  ...
  inline def assign(target: js.Object, sources: js.Object*): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("assign")(scala.List(target.asInstanceOf[js.Any]).`++`(sources.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Any]
