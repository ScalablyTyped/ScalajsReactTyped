package typingsJapgolly.enquireJs
...
object mod extends Shortcut {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setMatch(value: japgolly.scalajs.react.Callback): Self = StObject.set(x, "match", value.toJsFn)
      
      inline def setMatchUndefined: Self = StObject.set(x, "match", js.undefined)
      
      inline def setSetup(value: japgolly.scalajs.react.Callback): Self = StObject.set(x, "setup", value.toJsFn)
      
      inline def setSetupUndefined: Self = StObject.set(x, "setup", js.undefined)
      
      inline def setUnmatch(value: japgolly.scalajs.react.Callback): Self = StObject.set(x, "unmatch", value.toJsFn)
