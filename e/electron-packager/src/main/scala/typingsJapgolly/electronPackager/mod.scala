...
import typingsJapgolly.asar.mod.CreateOptions
import typingsJapgolly.electronNotarize.libTypesMod.LegacyNotarizeCredentials
import typingsJapgolly.electronNotarize.libTypesMod.NotaryToolCredentials
import typingsJapgolly.electronNotarize.libTypesMod.TransporterOptions
import typingsJapgolly.electronPackager.anon.Tool
import typingsJapgolly.electronPackager.anon.`0`
import typingsJapgolly.electronPackager.electronPackagerBooleans.`false`
import typingsJapgolly.electronPackager.electronPackagerBooleans.`true`
import typingsJapgolly.electronPackager.electronPackagerStrings.all
import typingsJapgolly.electronPackager.electronPackagerStrings.arm64AppPath
import typingsJapgolly.electronPackager.electronPackagerStrings.asInvoker
import typingsJapgolly.electronPackager.electronPackagerStrings.force
import typingsJapgolly.electronPackager.electronPackagerStrings.highestAvailable
import typingsJapgolly.electronPackager.electronPackagerStrings.outAppPath
import typingsJapgolly.electronPackager.electronPackagerStrings.requireAdministrator
import typingsJapgolly.electronPackager.electronPackagerStrings.x64AppPath
...
object mod {
  ...
  */
  ...
  object OfficialArch {
    ...
    inline def arm64: typingsJapgolly.electronPackager.electronPackagerStrings.arm64 = "arm64".asInstanceOf[typingsJapgolly.electronPackager.electronPackagerStrings.arm64]
    
    inline def armv7l: typingsJapgolly.electronPackager.electronPackagerStrings.armv7l = "armv7l".asInstanceOf[typingsJapgolly.electronPackager.electronPackagerStrings.armv7l]
    
    inline def ia32: typingsJapgolly.electronPackager.electronPackagerStrings.ia32 = "ia32".asInstanceOf[typingsJapgolly.electronPackager.electronPackagerStrings.ia32]
    
    inline def mips64el: typingsJapgolly.electronPackager.electronPackagerStrings.mips64el = "mips64el".asInstanceOf[typingsJapgolly.electronPackager.electronPackagerStrings.mips64el]
    
    inline def x64: typingsJapgolly.electronPackager.electronPackagerStrings.x64 = "x64".asInstanceOf[typingsJapgolly.electronPackager.electronPackagerStrings.x64]
  }
  ...
  */
  ...
  object OfficialPlatform {
    ...
    inline def darwin: typingsJapgolly.electronPackager.electronPackagerStrings.darwin = "darwin".asInstanceOf[typingsJapgolly.electronPackager.electronPackagerStrings.darwin]
    
    inline def linux: typingsJapgolly.electronPackager.electronPackagerStrings.linux = "linux".asInstanceOf[typingsJapgolly.electronPackager.electronPackagerStrings.linux]
    
    inline def mas: typingsJapgolly.electronPackager.electronPackagerStrings.mas = "mas".asInstanceOf[typingsJapgolly.electronPackager.electronPackagerStrings.mas]
    
    inline def win32: typingsJapgolly.electronPackager.electronPackagerStrings.win32 = "win32".asInstanceOf[typingsJapgolly.electronPackager.electronPackagerStrings.win32]
  }
