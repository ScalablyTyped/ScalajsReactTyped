...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "depd" % "1.1-dt-20220624Z-f8da2f",
  "org.scalablytyped.japgolly" %%% "egg-cookies" % "2.6.1-2206f4",
  "org.scalablytyped.japgolly" %%% "egg-core" % "4.26.1-6c2fa0",
  "org.scalablytyped.japgolly" %%% "egg-logger" % "2.9.0-edf39a",
  ...
  "org.scalablytyped.japgolly" %%% "koa-router" % "7.4-dt-20211202Z-1b1888",
  ...
  "org.scalablytyped.japgolly" %%% "urllib" % "3.3.1-32921e")
