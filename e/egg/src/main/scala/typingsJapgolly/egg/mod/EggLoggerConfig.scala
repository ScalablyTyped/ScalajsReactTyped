...
import typingsJapgolly.egg.anon.PartialEggLoggerOptions
import typingsJapgolly.egg.eggStrings.duplicate
import typingsJapgolly.egg.eggStrings.ignore
import typingsJapgolly.egg.eggStrings.redirect
...
trait EggLoggerConfig extends StObject {
  ...
  var consoleLevel: js.UndefOr[typingsJapgolly.eggLogger.mod.LoggerLevel] = js.undefined
  ...
  var level: js.UndefOr[typingsJapgolly.eggLogger.mod.LoggerLevel] = js.undefined
...
object EggLoggerConfig {
  ...
  extension [Self <: EggLoggerConfig](x: Self) {
    ...
    inline def setConsoleLevel(value: typingsJapgolly.eggLogger.mod.LoggerLevel): Self = StObject.set(x, "consoleLevel", value.asInstanceOf[js.Any])
    ...
    inline def setLevel(value: typingsJapgolly.eggLogger.mod.LoggerLevel): Self = StObject.set(x, "level", value.asInstanceOf[js.Any])
