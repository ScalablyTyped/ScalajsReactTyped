...
object libTypesMod {
  ...
  trait Generator extends StObject {
    ...
    def ArrayExpression(node: Any, state: State): Unit
    @JSName("ArrayExpression")
    var ArrayExpression_Original: Handler
    
    def ArrayPattern(node: Any, state: State): Unit
    @JSName("ArrayPattern")
    var ArrayPattern_Original: Handler
    
    def ArrowFunctionExpression(node: Any, state: State): Unit
    @JSName("ArrowFunctionExpression")
    var ArrowFunctionExpression_Original: Handler
    
    def AssignmentExpression(node: Any, state: State): Unit
    @JSName("AssignmentExpression")
    var AssignmentExpression_Original: Handler
    
    def AssignmentPattern(node: Any, state: State): Unit
    @JSName("AssignmentPattern")
    var AssignmentPattern_Original: Handler
    
    def AwaitExpression(node: Any, state: State): Unit
    @JSName("AwaitExpression")
    var AwaitExpression_Original: Handler
    
    def BinaryExpression(node: Any, state: State): Unit
    @JSName("BinaryExpression")
    var BinaryExpression_Original: Handler
    
    def BlockStatement(node: Any, state: State): Unit
    @JSName("BlockStatement")
    var BlockStatement_Original: Handler
    
    def BreakStatement(node: Any, state: State): Unit
    @JSName("BreakStatement")
    var BreakStatement_Original: Handler
    
    def CallExpression(node: Any, state: State): Unit
    @JSName("CallExpression")
    var CallExpression_Original: Handler
    
    def CatchClause(node: Any, state: State): Unit
    @JSName("CatchClause")
    var CatchClause_Original: Handler
    
    def ChainExpression(node: Any, state: State): Unit
    @JSName("ChainExpression")
    var ChainExpression_Original: Handler
    
    def ClassBody(node: Any, state: State): Unit
    @JSName("ClassBody")
    var ClassBody_Original: Handler
    
    def ClassDeclaration(node: Any, state: State): Unit
    @JSName("ClassDeclaration")
    var ClassDeclaration_Original: Handler
    
    def ClassExpression(node: Any, state: State): Unit
    @JSName("ClassExpression")
    var ClassExpression_Original: Handler
    
    def ConditionalExpression(node: Any, state: State): Unit
    @JSName("ConditionalExpression")
    var ConditionalExpression_Original: Handler
    
    def ContinueStatement(node: Any, state: State): Unit
    @JSName("ContinueStatement")
    var ContinueStatement_Original: Handler
    
    def DebuggerStatement(node: Any, state: State): Unit
    @JSName("DebuggerStatement")
    var DebuggerStatement_Original: Handler
    
    def DoWhileStatement(node: Any, state: State): Unit
    @JSName("DoWhileStatement")
    var DoWhileStatement_Original: Handler
    
    def EmptyStatement(node: Any, state: State): Unit
    @JSName("EmptyStatement")
    var EmptyStatement_Original: Handler
    
    def ExportAllDeclaration(node: Any, state: State): Unit
    @JSName("ExportAllDeclaration")
    var ExportAllDeclaration_Original: Handler
    
    def ExportDefaultDeclaration(node: Any, state: State): Unit
    @JSName("ExportDefaultDeclaration")
    var ExportDefaultDeclaration_Original: Handler
    
    def ExportNamedDeclaration(node: Any, state: State): Unit
    @JSName("ExportNamedDeclaration")
    var ExportNamedDeclaration_Original: Handler
    
    def ExportSpecifier(node: Any, state: State): Unit
    @JSName("ExportSpecifier")
    var ExportSpecifier_Original: Handler
    
    def ExpressionStatement(node: Any, state: State): Unit
    @JSName("ExpressionStatement")
    var ExpressionStatement_Original: Handler
    
    def ForInStatement(node: Any, state: State): Unit
    @JSName("ForInStatement")
    var ForInStatement_Original: Handler
    
    def ForOfStatement(node: Any, state: State): Unit
    @JSName("ForOfStatement")
    var ForOfStatement_Original: Handler
    
    def ForStatement(node: Any, state: State): Unit
    @JSName("ForStatement")
    var ForStatement_Original: Handler
    
    def FunctionDeclaration(node: Any, state: State): Unit
    @JSName("FunctionDeclaration")
    var FunctionDeclaration_Original: Handler
    
    def FunctionExpression(node: Any, state: State): Unit
    @JSName("FunctionExpression")
    var FunctionExpression_Original: Handler
    
    def Identifier(node: Any, state: State): Unit
    @JSName("Identifier")
    var Identifier_Original: Handler
    
    def IfStatement(node: Any, state: State): Unit
    @JSName("IfStatement")
    var IfStatement_Original: Handler
    
    def ImportDeclaration(node: Any, state: State): Unit
    @JSName("ImportDeclaration")
    var ImportDeclaration_Original: Handler
    
    def ImportDefaultSpecifier(node: Any, state: State): Unit
    @JSName("ImportDefaultSpecifier")
    var ImportDefaultSpecifier_Original: Handler
    
    def ImportExpression(node: Any, state: State): Unit
    @JSName("ImportExpression")
    var ImportExpression_Original: Handler
    
    def ImportNamespaceSpecifier(node: Any, state: State): Unit
    @JSName("ImportNamespaceSpecifier")
    var ImportNamespaceSpecifier_Original: Handler
    
    def ImportSpecifier(node: Any, state: State): Unit
    @JSName("ImportSpecifier")
    var ImportSpecifier_Original: Handler
    
    def JSXAttribute(node: Any, state: State): Unit
    @JSName("JSXAttribute")
    var JSXAttribute_Original: Handler
    
    def JSXClosingElement(node: Any, state: State): Unit
    @JSName("JSXClosingElement")
    var JSXClosingElement_Original: Handler
    
    def JSXClosingFragment(node: Any, state: State): Unit
    @JSName("JSXClosingFragment")
    var JSXClosingFragment_Original: Handler
    
    def JSXElement(node: Any, state: State): Unit
    @JSName("JSXElement")
    var JSXElement_Original: Handler
    
    def JSXEmptyExpression(node: Any, state: State): Unit
    @JSName("JSXEmptyExpression")
    var JSXEmptyExpression_Original: Handler
    
    def JSXExpressionContainer(node: Any, state: State): Unit
    @JSName("JSXExpressionContainer")
    var JSXExpressionContainer_Original: Handler
    
    def JSXFragment(node: Any, state: State): Unit
    @JSName("JSXFragment")
    var JSXFragment_Original: Handler
    
    def JSXIdentifier(node: Any, state: State): Unit
    @JSName("JSXIdentifier")
    var JSXIdentifier_Original: Handler
    
    def JSXMemberExpression(node: Any, state: State): Unit
    @JSName("JSXMemberExpression")
    var JSXMemberExpression_Original: Handler
    
    def JSXNamespacedName(node: Any, state: State): Unit
    @JSName("JSXNamespacedName")
    var JSXNamespacedName_Original: Handler
    
    def JSXOpeningElement(node: Any, state: State): Unit
    @JSName("JSXOpeningElement")
    var JSXOpeningElement_Original: Handler
    
    def JSXOpeningFragment(node: Any, state: State): Unit
    @JSName("JSXOpeningFragment")
    var JSXOpeningFragment_Original: Handler
    
    def JSXSpreadAttribute(node: Any, state: State): Unit
    @JSName("JSXSpreadAttribute")
    var JSXSpreadAttribute_Original: Handler
    
    def JSXText(node: Any, state: State): Unit
    @JSName("JSXText")
    var JSXText_Original: Handler
    
    def LabeledStatement(node: Any, state: State): Unit
    @JSName("LabeledStatement")
    var LabeledStatement_Original: Handler
    
    def Literal(node: Any, state: State): Unit
    @JSName("Literal")
    var Literal_Original: Handler
    
    def LogicalExpression(node: Any, state: State): Unit
    @JSName("LogicalExpression")
    var LogicalExpression_Original: Handler
    
    def MemberExpression(node: Any, state: State): Unit
    @JSName("MemberExpression")
    var MemberExpression_Original: Handler
    
    def MetaProperty(node: Any, state: State): Unit
    @JSName("MetaProperty")
    var MetaProperty_Original: Handler
    
    def MethodDefinition(node: Any, state: State): Unit
    @JSName("MethodDefinition")
    var MethodDefinition_Original: Handler
    
    def NewExpression(node: Any, state: State): Unit
    @JSName("NewExpression")
    var NewExpression_Original: Handler
    
    def ObjectExpression(node: Any, state: State): Unit
    @JSName("ObjectExpression")
    var ObjectExpression_Original: Handler
    
    def ObjectPattern(node: Any, state: State): Unit
    @JSName("ObjectPattern")
    var ObjectPattern_Original: Handler
    
    def PrivateIdentifier(node: Any, state: State): Unit
    @JSName("PrivateIdentifier")
    var PrivateIdentifier_Original: Handler
    
    def Program(node: Any, state: State): Unit
    @JSName("Program")
    var Program_Original: Handler
    
    def Property(node: Any, state: State): Unit
    
    def PropertyDefinition(node: Any, state: State): Unit
    @JSName("PropertyDefinition")
    var PropertyDefinition_Original: Handler
    
    @JSName("Property")
    var Property_Original: Handler
    
    def RestElement(node: Any, state: State): Unit
    @JSName("RestElement")
    var RestElement_Original: Handler
    
    def ReturnStatement(node: Any, state: State): Unit
    @JSName("ReturnStatement")
    var ReturnStatement_Original: Handler
    
    def SequenceExpression(node: Any, state: State): Unit
    @JSName("SequenceExpression")
    var SequenceExpression_Original: Handler
    
    def SpreadElement(node: Any, state: State): Unit
    @JSName("SpreadElement")
    var SpreadElement_Original: Handler
    
    def StaticBlock(node: Any, state: State): Unit
    @JSName("StaticBlock")
    var StaticBlock_Original: Handler
    
    def Super(node: Any, state: State): Unit
    @JSName("Super")
    var Super_Original: Handler
    
    def SwitchCase(node: Any, state: State): Unit
    @JSName("SwitchCase")
    var SwitchCase_Original: Handler
    
    def SwitchStatement(node: Any, state: State): Unit
    @JSName("SwitchStatement")
    var SwitchStatement_Original: Handler
    
    def TaggedTemplateExpression(node: Any, state: State): Unit
    @JSName("TaggedTemplateExpression")
    var TaggedTemplateExpression_Original: Handler
    
    def TemplateElement(node: Any, state: State): Unit
    @JSName("TemplateElement")
    var TemplateElement_Original: Handler
    
    def TemplateLiteral(node: Any, state: State): Unit
    @JSName("TemplateLiteral")
    var TemplateLiteral_Original: Handler
    
    def ThisExpression(node: Any, state: State): Unit
    @JSName("ThisExpression")
    var ThisExpression_Original: Handler
    
    def ThrowStatement(node: Any, state: State): Unit
    @JSName("ThrowStatement")
    var ThrowStatement_Original: Handler
    
    def TryStatement(node: Any, state: State): Unit
    @JSName("TryStatement")
    var TryStatement_Original: Handler
    
    def UnaryExpression(node: Any, state: State): Unit
    @JSName("UnaryExpression")
    var UnaryExpression_Original: Handler
    
    def UpdateExpression(node: Any, state: State): Unit
    @JSName("UpdateExpression")
    var UpdateExpression_Original: Handler
    
    def VariableDeclaration(node: Any, state: State): Unit
    @JSName("VariableDeclaration")
    var VariableDeclaration_Original: Handler
    
    def VariableDeclarator(node: Any, state: State): Unit
    @JSName("VariableDeclarator")
    var VariableDeclarator_Original: Handler
    
    def WhileStatement(node: Any, state: State): Unit
    @JSName("WhileStatement")
    var WhileStatement_Original: Handler
    
    def WithStatement(node: Any, state: State): Unit
    @JSName("WithStatement")
    var WithStatement_Original: Handler
    
    def YieldExpression(node: Any, state: State): Unit
    @JSName("YieldExpression")
    var YieldExpression_Original: Handler
  }
  object Generator {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(ArrayExpression = ArrayExpression.asInstanceOf[js.Any], ArrayPattern = ArrayPattern.asInstanceOf[js.Any], ArrowFunctionExpression = ArrowFunctionExpression.asInstanceOf[js.Any], AssignmentExpression = AssignmentExpression.asInstanceOf[js.Any], AssignmentPattern = AssignmentPattern.asInstanceOf[js.Any], AwaitExpression = AwaitExpression.asInstanceOf[js.Any], BinaryExpression = BinaryExpression.asInstanceOf[js.Any], BlockStatement = BlockStatement.asInstanceOf[js.Any], BreakStatement = BreakStatement.asInstanceOf[js.Any], CallExpression = CallExpression.asInstanceOf[js.Any], CatchClause = CatchClause.asInstanceOf[js.Any], ChainExpression = ChainExpression.asInstanceOf[js.Any], ClassBody = ClassBody.asInstanceOf[js.Any], ClassDeclaration = ClassDeclaration.asInstanceOf[js.Any], ClassExpression = ClassExpression.asInstanceOf[js.Any], ConditionalExpression = ConditionalExpression.asInstanceOf[js.Any], ContinueStatement = ContinueStatement.asInstanceOf[js.Any], DebuggerStatement = DebuggerStatement.asInstanceOf[js.Any], DoWhileStatement = DoWhileStatement.asInstanceOf[js.Any], EmptyStatement = EmptyStatement.asInstanceOf[js.Any], ExportAllDeclaration = ExportAllDeclaration.asInstanceOf[js.Any], ExportDefaultDeclaration = ExportDefaultDeclaration.asInstanceOf[js.Any], ExportNamedDeclaration = ExportNamedDeclaration.asInstanceOf[js.Any], ExportSpecifier = ExportSpecifier.asInstanceOf[js.Any], ExpressionStatement = ExpressionStatement.asInstanceOf[js.Any], ForInStatement = ForInStatement.asInstanceOf[js.Any], ForOfStatement = ForOfStatement.asInstanceOf[js.Any], ForStatement = ForStatement.asInstanceOf[js.Any], FunctionDeclaration = FunctionDeclaration.asInstanceOf[js.Any], FunctionExpression = FunctionExpression.asInstanceOf[js.Any], Identifier = Identifier.asInstanceOf[js.Any], IfStatement = IfStatement.asInstanceOf[js.Any], ImportDeclaration = ImportDeclaration.asInstanceOf[js.Any], ImportDefaultSpecifier = ImportDefaultSpecifier.asInstanceOf[js.Any], ImportExpression = ImportExpression.asInstanceOf[js.Any], ImportNamespaceSpecifier = ImportNamespaceSpecifier.asInstanceOf[js.Any], ImportSpecifier = ImportSpecifier.asInstanceOf[js.Any], JSXAttribute = JSXAttribute.asInstanceOf[js.Any], JSXClosingElement = JSXClosingElement.asInstanceOf[js.Any], JSXClosingFragment = JSXClosingFragment.asInstanceOf[js.Any], JSXElement = JSXElement.asInstanceOf[js.Any], JSXEmptyExpression = JSXEmptyExpression.asInstanceOf[js.Any], JSXExpressionContainer = JSXExpressionContainer.asInstanceOf[js.Any], JSXFragment = JSXFragment.asInstanceOf[js.Any], JSXIdentifier = JSXIdentifier.asInstanceOf[js.Any], JSXMemberExpression = JSXMemberExpression.asInstanceOf[js.Any], JSXNamespacedName = JSXNamespacedName.asInstanceOf[js.Any], JSXOpeningElement = JSXOpeningElement.asInstanceOf[js.Any], JSXOpeningFragment = JSXOpeningFragment.asInstanceOf[js.Any], JSXSpreadAttribute = JSXSpreadAttribute.asInstanceOf[js.Any], JSXText = JSXText.asInstanceOf[js.Any], LabeledStatement = LabeledStatement.asInstanceOf[js.Any], Literal = Literal.asInstanceOf[js.Any], LogicalExpression = LogicalExpression.asInstanceOf[js.Any], MemberExpression = MemberExpression.asInstanceOf[js.Any], MetaProperty = MetaProperty.asInstanceOf[js.Any], MethodDefinition = MethodDefinition.asInstanceOf[js.Any], NewExpression = NewExpression.asInstanceOf[js.Any], ObjectExpression = ObjectExpression.asInstanceOf[js.Any], ObjectPattern = ObjectPattern.asInstanceOf[js.Any], PrivateIdentifier = PrivateIdentifier.asInstanceOf[js.Any], Program = Program.asInstanceOf[js.Any], Property = Property.asInstanceOf[js.Any], PropertyDefinition = PropertyDefinition.asInstanceOf[js.Any], RestElement = RestElement.asInstanceOf[js.Any], ReturnStatement = ReturnStatement.asInstanceOf[js.Any], SequenceExpression = SequenceExpression.asInstanceOf[js.Any], SpreadElement = SpreadElement.asInstanceOf[js.Any], StaticBlock = StaticBlock.asInstanceOf[js.Any], Super = Super.asInstanceOf[js.Any], SwitchCase = SwitchCase.asInstanceOf[js.Any], SwitchStatement = SwitchStatement.asInstanceOf[js.Any], TaggedTemplateExpression = TaggedTemplateExpression.asInstanceOf[js.Any], TemplateElement = TemplateElement.asInstanceOf[js.Any], TemplateLiteral = TemplateLiteral.asInstanceOf[js.Any], ThisExpression = ThisExpression.asInstanceOf[js.Any], ThrowStatement = ThrowStatement.asInstanceOf[js.Any], TryStatement = TryStatement.asInstanceOf[js.Any], UnaryExpression = UnaryExpression.asInstanceOf[js.Any], UpdateExpression = UpdateExpression.asInstanceOf[js.Any], VariableDeclaration = VariableDeclaration.asInstanceOf[js.Any], VariableDeclarator = VariableDeclarator.asInstanceOf[js.Any], WhileStatement = WhileStatement.asInstanceOf[js.Any], WithStatement = WithStatement.asInstanceOf[js.Any], YieldExpression = YieldExpression.asInstanceOf[js.Any])
  ...
  type Handler = js.ThisFunction2[/* this */ Generator, /* node */ Any, /* state */ State, Unit]
  
  /* Inlined std.Partial<estree-util-to-js.estree-util-to-js/lib/types.Generator> */
  ...
  type NodeType = /* import warning: importer.ImportType#apply Failed type conversion: estree-util-to-js.estree-util-to-js/lib/types.Node['type'] */ js.Any
  ...
  /* Inlined std.Omit<astring.astring.State, 'write'> & {write (code : string, node : estree-util-to-js.estree-util-to-js/lib/types.Node | undefined): void} */
  @js.native
  trait State extends StObject {
    ...
    def write(code: String, node: org.scalajs.dom.Node): Unit = js.native
