...
import typingsJapgolly.estreeUtilToJs.anon.PartialGenerator
import typingsJapgolly.estreeUtilToJs.libTypesMod.Handler
...
object libMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.estreeUtilToJs.libMod.OptionsWithoutSourceMapGenerator
    - typingsJapgolly.estreeUtilToJs.libMod.OptionsWithSourceMapGenerator
  */
  trait Options extends StObject
  object Options {
    
    inline def OptionsWithSourceMapGenerator(SourceMapGenerator: SourceMapGenerator): typingsJapgolly.estreeUtilToJs.libMod.OptionsWithSourceMapGenerator = {
      val __obj = js.Dynamic.literal(SourceMapGenerator = SourceMapGenerator.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.estreeUtilToJs.libMod.OptionsWithSourceMapGenerator]
    }
    
    inline def OptionsWithoutSourceMapGenerator(SourceMapGenerator: Unit, filePath: Unit): typingsJapgolly.estreeUtilToJs.libMod.OptionsWithoutSourceMapGenerator = {
      ...
      __obj.asInstanceOf[typingsJapgolly.estreeUtilToJs.libMod.OptionsWithoutSourceMapGenerator]
    }
  }
  ...
  trait SourceMapFieldsWithSourceMapGenerator extends StObject {
    ...
    /**
      ...
      * in.
      */
    var SourceMapGenerator: typingsJapgolly.estreeUtilToJs.libMod.SourceMapGenerator
  ...
  trait SourceMapGenerator
    extends StObject
       with Instantiable0[typingsJapgolly.sourceMap.mod.SourceMapGenerator] {
    ...
    /**
      ...
      */
    def fromSourceMap(sourceMapConsumer: SourceMapConsumer): typingsJapgolly.sourceMap.mod.SourceMapGenerator = js.native
  }
}
