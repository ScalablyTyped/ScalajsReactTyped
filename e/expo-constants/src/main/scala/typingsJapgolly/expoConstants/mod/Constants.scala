package typingsJapgolly.expoConstants.mod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.expoConstants.constantsTypesMod.AppManifest
import typingsJapgolly.expoConstants.constantsTypesMod.NativeConstants
import typingsJapgolly.expoConstants.constantsTypesMod.PlatformManifest
...
object Constants {
  @scala.inline
  def apply(
    appOwnership: typingsJapgolly.expoConstants.constantsTypesMod.AppOwnership,
    debugMode: Boolean,
