...
import typingsJapgolly.expoConstants.expoConstantsStrings.ExponentConstants
...
object NativeConstants {
  ...
  extension [Self <: NativeConstants](x: Self) {
    ...
    inline def setGetWebViewUserAgentAsync(value: CallbackTo[js.Promise[String | Null]]): Self = StObject.set(x, "getWebViewUserAgentAsync", value.toJsFn)
