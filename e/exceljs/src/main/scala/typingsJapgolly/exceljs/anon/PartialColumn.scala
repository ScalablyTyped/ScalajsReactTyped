...
trait PartialColumn extends StObject {
  ...
  var equivalentTo: js.UndefOr[js.Function1[/* other */ typingsJapgolly.exceljs.mod.Column, Boolean]] = js.undefined
...
object PartialColumn {
  ...
  extension [Self <: PartialColumn](x: Self) {
    ...
    inline def setEachCell(value: /* callback */ js.Function2[/* cell */ Cell, /* rowNumber */ Double, Unit] => Callback): Self = StObject.set(x, "eachCell", js.Any.fromFunction1((t0: /* callback */ js.Function2[/* cell */ Cell, /* rowNumber */ Double, Unit]) => value(t0).runNow()))
    
    inline def setEachCellUndefined: Self = StObject.set(x, "eachCell", js.undefined)
    
    inline def setEquivalentTo(value: /* other */ typingsJapgolly.exceljs.mod.Column => Boolean): Self = StObject.set(x, "equivalentTo", js.Any.fromFunction1(value))
