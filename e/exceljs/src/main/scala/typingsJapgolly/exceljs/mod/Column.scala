...
import typingsJapgolly.exceljs.anon.IncludeEmpty
import typingsJapgolly.exceljs.anon.PartialAlignment
import typingsJapgolly.exceljs.anon.PartialBordersBottom
import typingsJapgolly.exceljs.anon.PartialFont
import typingsJapgolly.exceljs.anon.PartialProtection
