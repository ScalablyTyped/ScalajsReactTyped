...
import typingsJapgolly.expoModulesAutolinking.buildTypesMod.RawExpoModuleConfig
import typingsJapgolly.expoModulesAutolinking.buildTypesMod.SupportedPlatform
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object buildExpoModuleConfigMod {
  
  @JSImport("expo-modules-autolinking/build/ExpoModuleConfig", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("expo-modules-autolinking/build/ExpoModuleConfig", "ExpoModuleConfig")
  @js.native
