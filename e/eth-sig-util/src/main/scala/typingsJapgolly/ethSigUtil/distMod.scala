...
import typingsJapgolly.ethSigUtil.anon.ChainId
import typingsJapgolly.ethSigUtil.anon.Domain
import typingsJapgolly.ethSigUtil.anon.PartialEIP712TypedData
...
object distMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ethSigUtil.ethSigUtilStrings.V1
    - typingsJapgolly.ethSigUtil.ethSigUtilStrings.V2
    - typingsJapgolly.ethSigUtil.ethSigUtilStrings.V3
    - typingsJapgolly.ethSigUtil.ethSigUtilStrings.V4
  */
  trait Version extends StObject
  object Version {
    
    inline def V1: typingsJapgolly.ethSigUtil.ethSigUtilStrings.V1 = "V1".asInstanceOf[typingsJapgolly.ethSigUtil.ethSigUtilStrings.V1]
    
    inline def V2: typingsJapgolly.ethSigUtil.ethSigUtilStrings.V2 = "V2".asInstanceOf[typingsJapgolly.ethSigUtil.ethSigUtilStrings.V2]
    
    inline def V3: typingsJapgolly.ethSigUtil.ethSigUtilStrings.V3 = "V3".asInstanceOf[typingsJapgolly.ethSigUtil.ethSigUtilStrings.V3]
    
    inline def V4: typingsJapgolly.ethSigUtil.ethSigUtilStrings.V4 = "V4".asInstanceOf[typingsJapgolly.ethSigUtil.ethSigUtilStrings.V4]
  }
}
