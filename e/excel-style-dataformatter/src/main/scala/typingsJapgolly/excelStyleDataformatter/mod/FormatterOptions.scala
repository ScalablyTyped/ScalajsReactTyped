...
object FormatterOptions {
  ...
  def apply(
    ...
    transformCode: /* code */ js.Any => CallbackTo[js.Any] = null
  ): FormatterOptions = {
    ...
    if (transformCode != null) __obj.updateDynamic("transformCode")(js.Any.fromFunction1((t0: /* code */ js.Any) => transformCode(t0).runNow()))
