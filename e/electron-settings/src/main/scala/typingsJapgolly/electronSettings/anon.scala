...
import typingsJapgolly.electronSettings.mod.KeyPath
import typingsJapgolly.electronSettings.mod.SettingsObject
import typingsJapgolly.electronSettings.mod.SettingsValue
