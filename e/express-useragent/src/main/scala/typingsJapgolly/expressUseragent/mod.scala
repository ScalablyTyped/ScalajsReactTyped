package typingsJapgolly.expressUseragent

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.express.mod.NextFunction
import typingsJapgolly.express.mod.Request_
import typingsJapgolly.express.mod.Response_
import typingsJapgolly.expressUseragent.expressUseragentBooleans.`false`
import typingsJapgolly.expressUseragent.expressUseragentStrings.CaptiveNetwork
import typingsJapgolly.expressUseragent.expressUseragentStrings.Silk
...
object mod {
  ...
  trait Details extends StObject {
    ...
    var geoIp: StringDictionary[Any]
  ...
  object Details {
    ...
    extension [Self <: Details](x: Self) {
      ...
      inline def setGeoIp(value: StringDictionary[Any]): Self = StObject.set(x, "geoIp", value.asInstanceOf[js.Any])
      ...
      inline def setIsMobileNative(value: Boolean): Self = StObject.set(x, "isMobileNative", value.asInstanceOf[js.Any])
