...
object global {
  ...
  open class Buffer protected ()
    extends StObject
       with typingsJapgolly.node.bufferMod.global.Buffer {
    /**
  ...
  object Buffer {
    ...
    /**
      ...
      */
    inline def compare(
      buf1: typingsJapgolly.node.bufferMod.global.Buffer,
      buf2: typingsJapgolly.node.bufferMod.global.Buffer
    ): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("compare")(buf1.asInstanceOf[js.Any], buf2.asInstanceOf[js.Any])).asInstanceOf[Double]
    ...
    /**
      ...
      */
    inline def concat(list: js.Array[typingsJapgolly.node.bufferMod.global.Buffer]): typingsJapgolly.node.bufferMod.global.Buffer = ^.asInstanceOf[js.Dynamic].applyDynamic("concat")(list.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.bufferMod.global.Buffer]
    inline def concat(list: js.Array[typingsJapgolly.node.bufferMod.global.Buffer], totalLength: Double): typingsJapgolly.node.bufferMod.global.Buffer = (^.asInstanceOf[js.Dynamic].applyDynamic("concat")(list.asInstanceOf[js.Any], totalLength.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.bufferMod.global.Buffer]
  ...
  object global extends Shortcut {
    ...
    open class DataView protected ()
      extends StObject
         with typingsJapgolly.std.DataView {
      /* standard es5 */
    ...
    open class Float32Array ()
      extends StObject
         with typingsJapgolly.std.Float32Array {
