...
- typingsJapgolly.easyXHeaders.streamMod.WritableOptions because var conflicts: highWaterMark. Inlined decodeStrings */ trait DuplexOptions extends ReadableOptions {
