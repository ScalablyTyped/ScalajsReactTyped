...
import typingsJapgolly.easyXHeaders.expressMod.Response
...
object AnonDotfiles {
  ...
  def apply(
    ...
    if (setHeaders != null) __obj.updateDynamic("setHeaders")(js.Any.fromFunction3((t0: /* res */ typingsJapgolly.easyXHeaders.expressMod.Response, t1: /* path */ java.lang.String, t2: /* stat */ js.Any) => setHeaders(t0, t1, t2).runNow()))
