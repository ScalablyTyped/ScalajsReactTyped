...
import typingsJapgolly.easyXHeaders.AnonInstantiable
import typingsJapgolly.easyXHeaders.FnCall
import typingsJapgolly.easyXHeaders.FnCallSRadix
import typingsJapgolly.easyXHeaders.TypeofIntl
