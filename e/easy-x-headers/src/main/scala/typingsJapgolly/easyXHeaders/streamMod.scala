...
import typingsJapgolly.easyXHeaders.NodeJS.ReadWriteStream
...
object streamMod {
  ...
  - typingsJapgolly.easyXHeaders.NodeJS.EventEmitter because Already inherited
  - typingsJapgolly.easyXHeaders.NodeJS.ReadableStream because Already inherited
  - typingsJapgolly.easyXHeaders.NodeJS.ReadWriteStream because var conflicts: readable. Inlined  */ @JSImport("stream", "Duplex")
  @js.native
  open class Duplex ()
    extends Readable
       with WritableStream {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.easyXHeaders.streamMod.WritableOptions because var conflicts: highWaterMark. Inlined decodeStrings */ trait DuplexOptions
    extends StObject
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.easyXHeaders.streamMod.WritableOptions because var conflicts: highWaterMark. Inlined decodeStrings */ trait TransformOptions
    extends StObject
       with ReadableOptions {
