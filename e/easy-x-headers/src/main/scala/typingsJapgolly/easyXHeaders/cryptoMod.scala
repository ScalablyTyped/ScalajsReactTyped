...
object cryptoMod {
  ...
  object Signer {
    ...
    inline def apply(sign: (String, String) => String, update: Any => Callback): Signer = {
      val __obj = js.Dynamic.literal(sign = js.Any.fromFunction2(sign), update = js.Any.fromFunction1((t0: Any) => update(t0).runNow()))
