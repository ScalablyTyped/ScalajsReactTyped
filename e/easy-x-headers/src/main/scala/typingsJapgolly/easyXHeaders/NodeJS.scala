...
import typingsJapgolly.easyXHeaders.anon.Ares
import typingsJapgolly.easyXHeaders.anon.End
import typingsJapgolly.easyXHeaders.anon.FnCall
import typingsJapgolly.easyXHeaders.anon.FnCallStringRadix
import typingsJapgolly.easyXHeaders.anon.HeapTotal
import typingsJapgolly.easyXHeaders.anon.Instantiable
import typingsJapgolly.easyXHeaders.anon.Targetdefaults
import typingsJapgolly.easyXHeaders.anon.Typeofconsole
...
import typingsJapgolly.std.Math
...
object NodeJS {
  ...
  trait Global extends StObject {
    ...
    var Math: typingsJapgolly.std.Math
  ...
  object Global {
    ...
    extension [Self <: Global](x: Self) {
      ...
      inline def setClearImmediate(value: Any => Callback): Self = StObject.set(x, "clearImmediate", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      
      inline def setClearInterval(value: Timer => Callback): Self = StObject.set(x, "clearInterval", js.Any.fromFunction1((t0: Timer) => value(t0).runNow()))
      
      inline def setClearTimeout(value: Timer => Callback): Self = StObject.set(x, "clearTimeout", js.Any.fromFunction1((t0: Timer) => value(t0).runNow()))
      ...
      inline def setGc(value: Callback): Self = StObject.set(x, "gc", value.toJsFn)
  ...
  object Timer {
    ...
    inline def apply(ref: Callback, unref: Callback): Timer = {
