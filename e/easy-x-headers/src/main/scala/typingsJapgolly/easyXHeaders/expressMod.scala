...
import typingsJapgolly.easyXHeaders.anon.Dotfiles
import typingsJapgolly.easyXHeaders.httpMod.Server
import typingsJapgolly.easyXHeaders.httpMod.ServerRequest
import typingsJapgolly.easyXHeaders.httpMod.ServerResponse
...
object expressMod {
  ...
  inline def apply(): typingsJapgolly.easyXHeaders.expressMod.Express = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.easyXHeaders.expressMod.Express]
  ...
  trait Application
    extends IRouter[Application]
       with typingsJapgolly.easyXHeaders.Express.Application {
  ...
  trait Request
    extends ServerRequest
       with typingsJapgolly.easyXHeaders.Express.Request {
  ...
  trait Response
    extends ServerResponse
       with typingsJapgolly.easyXHeaders.Express.Response {
