package typingsJapgolly.expressMongoSanitize

import japgolly.scalajs.react.Callback
import typingsJapgolly.express.mod.Handler
import typingsJapgolly.expressMongoSanitize.anon.Key
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnSanitize(value: /* params */ Key => Callback): Self = StObject.set(x, "onSanitize", js.Any.fromFunction1((t0: /* params */ Key) => value(t0).runNow()))
