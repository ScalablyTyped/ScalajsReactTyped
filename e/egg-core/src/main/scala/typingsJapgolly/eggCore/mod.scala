...
import typingsJapgolly.depd.mod.Deprecate
import typingsJapgolly.eggCore.anon.Exports
import typingsJapgolly.eggCore.anon.IsWeakDep
import typingsJapgolly.eggCore.anon.PartialContextLoaderOptio
import typingsJapgolly.eggCore.anon.PartialFileLoaderOption
import typingsJapgolly.eggCore.anon.Path
import typingsJapgolly.eggCore.anon.Type
...
object mod {
  ...
  open class EggLoader[T, Config, Options /* <: EggLoaderOptions */] protected () extends StObject {
    ...
    var ContextLoader: typingsJapgolly.eggCore.mod.ContextLoader = js.native
    
    var FileLoader: typingsJapgolly.eggCore.mod.FileLoader = js.native
  ...
  */
  ...
  object EggType {
    ...
    inline def agent: typingsJapgolly.eggCore.eggCoreStrings.agent = "agent".asInstanceOf[typingsJapgolly.eggCore.eggCoreStrings.agent]
    
    inline def application: typingsJapgolly.eggCore.eggCoreStrings.application = "application".asInstanceOf[typingsJapgolly.eggCore.eggCoreStrings.application]
  }
  ...
  object FileLoaderBase {
    ...
    inline def apply(load: CallbackTo[js.Object], parse: CallbackTo[js.Array[Exports]]): FileLoaderBase = {
      val __obj = js.Dynamic.literal(load = load.toJsFn, parse = parse.toJsFn)
      __obj.asInstanceOf[FileLoaderBase]
    }
    
    extension [Self <: FileLoaderBase](x: Self) {
      
      inline def setLoad(value: CallbackTo[js.Object]): Self = StObject.set(x, "load", value.toJsFn)
      
      inline def setParse(value: CallbackTo[js.Array[Exports]]): Self = StObject.set(x, "parse", value.toJsFn)
    }
  }
