...
object mod extends js.Object {
  @js.native
  trait Application
    extends typingsJapgolly.emberEngine.mod.default {
    /**
      * Application's router.
      */
    var Router: typingsJapgolly.emberRouting.mod.Router = js.native
    /**
    ...
    /**
      ...
      */
    var eventDispatcher: typingsJapgolly.emberApplication.eventDispatcherMod.default = js.native
    var registry: typingsJapgolly.emberApplication.registryMod.default = js.native
    /**
      * Set this to provide an alternate class to Ember.DefaultResolver
      */
    @JSName("resolver")
    var resolver_Application: typingsJapgolly.emberApplication.defaultResolverMod.default = js.native
    /**
