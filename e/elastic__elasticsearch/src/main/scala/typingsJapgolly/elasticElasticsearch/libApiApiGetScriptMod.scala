...
import typingsJapgolly.elasticElasticsearch.libApiTypesMod.GetScriptRequest
import typingsJapgolly.elasticElasticsearch.libApiTypesMod.GetScriptResponse
...
object libApiApiGetScriptMod {
  ...
  inline def default(params: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.GetScriptRequest): js.Promise[GetScriptResponse] = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(params.asInstanceOf[js.Any]).asInstanceOf[js.Promise[GetScriptResponse]]
  inline def default(
    params: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.GetScriptRequest,
