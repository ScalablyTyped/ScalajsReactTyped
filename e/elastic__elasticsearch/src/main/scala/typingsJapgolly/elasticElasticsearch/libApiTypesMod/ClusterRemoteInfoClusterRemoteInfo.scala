...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.elasticElasticsearch.libApiTypesMod.ClusterRemoteInfoClusterRemoteSniffInfo
  - typingsJapgolly.elasticElasticsearch.libApiTypesMod.ClusterRemoteInfoClusterRemoteProxyInfo
*/
...
object ClusterRemoteInfoClusterRemoteInfo {
  ...
  inline def ClusterRemoteInfoClusterRemoteProxyInfo(
    ...
    __obj.asInstanceOf[typingsJapgolly.elasticElasticsearch.libApiTypesMod.ClusterRemoteInfoClusterRemoteProxyInfo]
  }
  ...
  inline def ClusterRemoteInfoClusterRemoteSniffInfo(
    ...
    __obj.asInstanceOf[typingsJapgolly.elasticElasticsearch.libApiTypesMod.ClusterRemoteInfoClusterRemoteSniffInfo]
  }
}
