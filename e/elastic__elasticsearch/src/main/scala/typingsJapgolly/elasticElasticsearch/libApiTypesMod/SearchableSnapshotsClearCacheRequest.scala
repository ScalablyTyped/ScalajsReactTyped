...
trait SearchableSnapshotsClearCacheRequest
  extends StObject
...
object SearchableSnapshotsClearCacheRequest {
  
  inline def apply(): SearchableSnapshotsClearCacheRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SearchableSnapshotsClearCacheRequest]
  }
  
  extension [Self <: SearchableSnapshotsClearCacheRequest](x: Self) {
