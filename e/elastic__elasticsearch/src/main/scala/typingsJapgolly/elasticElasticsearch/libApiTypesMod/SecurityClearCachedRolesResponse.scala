...
trait SecurityClearCachedRolesResponse extends StObject {
...
object SecurityClearCachedRolesResponse {
  
  inline def apply(_nodes: NodeStatistics, cluster_name: Name, nodes: Record[String, SecurityClusterNode]): SecurityClearCachedRolesResponse = {
