...
trait MlPutDatafeedRequest
  ...
  var indexes: js.UndefOr[Indices] = js.undefined
...
object MlPutDatafeedRequest {
  ...
  inline def apply(datafeed_id: Id): MlPutDatafeedRequest = {
  ...
  extension [Self <: MlPutDatafeedRequest](x: Self) {
    ...
    inline def setIndexes(value: Indices): Self = StObject.set(x, "indexes", value.asInstanceOf[js.Any])
