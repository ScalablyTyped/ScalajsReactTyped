...
trait MappingLongNumberProperty
  ...
  var `type`: typingsJapgolly.elasticElasticsearch.elasticElasticsearchStrings.long
}
object MappingLongNumberProperty {
  ...
  extension [Self <: MappingLongNumberProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.elasticElasticsearch.elasticElasticsearchStrings.long): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
