...
trait MappingByteNumberProperty
  ...
  var `type`: typingsJapgolly.elasticElasticsearch.elasticElasticsearchStrings.byte
}
object MappingByteNumberProperty {
  ...
  extension [Self <: MappingByteNumberProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.elasticElasticsearch.elasticElasticsearchStrings.byte): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
