...
trait TextStructureFindStructureRequest[TJsonDocument] extends StObject {
  ...
  var text_files: js.UndefOr[js.Array[TJsonDocument]] = js.undefined
...
object TextStructureFindStructureRequest {
  ...
  extension [Self <: TextStructureFindStructureRequest[?], TJsonDocument](x: Self & TextStructureFindStructureRequest[TJsonDocument]) {
    ...
    inline def setText_files(value: js.Array[TJsonDocument]): Self = StObject.set(x, "text_files", value.asInstanceOf[js.Any])
    
    inline def setText_filesUndefined: Self = StObject.set(x, "text_files", js.undefined)
    
    inline def setText_filesVarargs(value: TJsonDocument*): Self = StObject.set(x, "text_files", js.Array(value*))
