...
trait MlDataframeAnalysisOutlierDetection extends StObject {
...
object MlDataframeAnalysisOutlierDetection {
  
  inline def apply(): MlDataframeAnalysisOutlierDetection = {
