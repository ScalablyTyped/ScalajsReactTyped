...
import typingsJapgolly.elasticElasticsearch.libApiTypesMod.GetScriptContextRequest
import typingsJapgolly.elasticElasticsearch.libApiTypesMod.GetScriptContextResponse
...
object libApiApiGetScriptContextMod {
  ...
  inline def default(params: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.GetScriptContextRequest): js.Promise[GetScriptContextResponse] = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(params.asInstanceOf[js.Any]).asInstanceOf[js.Promise[GetScriptContextResponse]]
  inline def default(
    params: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.GetScriptContextRequest,
