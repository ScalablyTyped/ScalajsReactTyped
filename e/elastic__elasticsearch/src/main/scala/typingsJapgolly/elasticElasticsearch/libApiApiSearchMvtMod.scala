...
import typingsJapgolly.elasticElasticsearch.libApiTypesMod.SearchMvtRequest
...
object libApiApiSearchMvtMod {
  ...
  inline def default(params: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SearchMvtRequest): js.Promise[js.typedarray.ArrayBuffer] = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(params.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.typedarray.ArrayBuffer]]
  inline def default(
    params: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SearchMvtRequest,
