...
trait Datadescription extends StObject {
  ...
  var model_snapshot_id: js.UndefOr[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Id] = js.undefined
...
object Datadescription {
  ...
  extension [Self <: Datadescription](x: Self) {
    ...
    inline def setModel_snapshot_id(value: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Id): Self = StObject.set(x, "model_snapshot_id", value.asInstanceOf[js.Any])
