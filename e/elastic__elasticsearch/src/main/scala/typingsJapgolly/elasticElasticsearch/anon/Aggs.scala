...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Fields
...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.QueryDslFieldAndFormat
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.QueryDslQueryContainer
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.ScriptField
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SearchFieldCollapse
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SearchHighlight
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SearchPointInTimeReference
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SearchRescore
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SearchSourceConfig
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SearchSuggester
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SearchTrackHits
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SlicedScroll
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Sort
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SortCombinations
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SortResults
...
object Aggs {
  ...
  inline def apply(): Aggs = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Aggs]
  }
  
  extension [Self <: Aggs](x: Self) {
