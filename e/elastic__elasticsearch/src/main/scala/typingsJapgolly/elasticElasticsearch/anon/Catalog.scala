...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MappingRuntimeFields
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.QueryDslQueryContainer
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.TimeZone
...
trait Catalog extends StObject {
  ...
  var keep_alive: js.UndefOr[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration] = js.undefined
  
  var keep_on_completion: js.UndefOr[Boolean] = js.undefined
  
  var page_timeout: js.UndefOr[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration] = js.undefined
  
  var params: js.UndefOr[Record[String, Any]] = js.undefined
  
  var query: js.UndefOr[String] = js.undefined
  
  var request_timeout: js.UndefOr[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration] = js.undefined
  
  var runtime_mappings: js.UndefOr[MappingRuntimeFields] = js.undefined
  
  var time_zone: js.UndefOr[TimeZone] = js.undefined
  
  var wait_for_completion_timeout: js.UndefOr[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration] = js.undefined
}
object Catalog {
  
  inline def apply(): Catalog = {
  ...
  extension [Self <: Catalog](x: Self) {
    ...
    inline def setKeep_alive(value: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration): Self = StObject.set(x, "keep_alive", value.asInstanceOf[js.Any])
    ...
    inline def setPage_timeout(value: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration): Self = StObject.set(x, "page_timeout", value.asInstanceOf[js.Any])
    ...
    inline def setRequest_timeout(value: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration): Self = StObject.set(x, "request_timeout", value.asInstanceOf[js.Any])
    ...
    inline def setWait_for_completion_timeout(value: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration): Self = StObject.set(x, "wait_for_completion_timeout", value.asInstanceOf[js.Any])
