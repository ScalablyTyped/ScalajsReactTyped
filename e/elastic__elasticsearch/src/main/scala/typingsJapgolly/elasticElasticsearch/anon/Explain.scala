...
trait Explain extends StObject {
  
  var explain: js.UndefOr[Boolean] = js.undefined
  
  var id: js.UndefOr[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Id] = js.undefined
...
object Explain {
  ...
  inline def apply(): Explain = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Explain]
  }
  
  extension [Self <: Explain](x: Self) {
