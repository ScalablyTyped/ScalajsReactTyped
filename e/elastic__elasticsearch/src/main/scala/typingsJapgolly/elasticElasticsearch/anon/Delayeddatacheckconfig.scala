...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.IndicesOptions
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MappingRuntimeFields
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlChunkingConfig
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlDelayedDataCheckConfig
...
trait Delayeddatacheckconfig extends StObject {
  ...
  var query_delay: js.UndefOr[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration] = js.undefined
...
object Delayeddatacheckconfig {
  ...
  extension [Self <: Delayeddatacheckconfig](x: Self) {
    ...
    inline def setQuery_delay(value: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration): Self = StObject.set(x, "query_delay", value.asInstanceOf[js.Any])
