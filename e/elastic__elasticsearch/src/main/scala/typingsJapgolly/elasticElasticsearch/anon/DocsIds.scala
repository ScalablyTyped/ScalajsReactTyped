...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MtermvectorsOperation
...
trait DocsIds extends StObject {
  ...
  var ids: js.UndefOr[js.Array[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Id]] = js.undefined
}
object DocsIds {
  ...
  extension [Self <: DocsIds](x: Self) {
    ...
    inline def setIds(value: js.Array[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Id]): Self = StObject.set(x, "ids", value.asInstanceOf[js.Any])
