...
trait Bucketspan extends StObject {
  ...
  var bucket_span: js.UndefOr[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration] = js.undefined
...
object Bucketspan {
  ...
  extension [Self <: Bucketspan](x: Self) {
    ...
    inline def setBucket_span(value: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration): Self = StObject.set(x, "bucket_span", value.asInstanceOf[js.Any])
