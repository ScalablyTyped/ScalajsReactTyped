...
trait Ignoreunavailable extends StObject {
  ...
  var indices: js.UndefOr[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Indices] = js.undefined
...
object Ignoreunavailable {
  ...
  extension [Self <: Ignoreunavailable](x: Self) {
    ...
    inline def setIndices(value: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Indices): Self = StObject.set(x, "indices", value.asInstanceOf[js.Any])
