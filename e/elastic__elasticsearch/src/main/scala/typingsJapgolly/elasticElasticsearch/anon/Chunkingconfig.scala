...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.HttpHeaders
...
trait Chunkingconfig extends StObject {
  ...
  var indexes: js.UndefOr[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Indices] = js.undefined
  ...
  var job_id: js.UndefOr[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Id] = js.undefined
...
object Chunkingconfig {
  ...
  extension [Self <: Chunkingconfig](x: Self) {
    ...
    inline def setIndexes(value: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Indices): Self = StObject.set(x, "indexes", value.asInstanceOf[js.Any])
    ...
    inline def setJob_id(value: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Id): Self = StObject.set(x, "job_id", value.asInstanceOf[js.Any])
