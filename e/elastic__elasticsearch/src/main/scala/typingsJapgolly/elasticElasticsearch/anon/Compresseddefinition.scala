...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlInferenceConfigCreateContainer
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlPutTrainedModelDefinition
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlPutTrainedModelInput
