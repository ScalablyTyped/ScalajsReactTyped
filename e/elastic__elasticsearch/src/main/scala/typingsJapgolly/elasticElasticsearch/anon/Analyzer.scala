...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.AnalysisCharFilter
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.AnalysisTokenFilter
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.AnalysisTokenizer
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Field
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.IndicesAnalyzeTextToAnalyze
...
object Analyzer {
  ...
  inline def apply(): Analyzer = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Analyzer]
  }
  
  extension [Self <: Analyzer](x: Self) {
