...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlAnalysisMemoryLimit
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlDetector
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlModelPlotConfig
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlPerPartitionCategorization
...
trait Analysislimits extends StObject {
...
object Analysislimits {
  ...
  inline def apply(): Analysislimits = {
