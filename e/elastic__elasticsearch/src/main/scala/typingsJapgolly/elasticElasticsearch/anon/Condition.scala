...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.TransformContainer
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.WatcherAction
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.WatcherConditionContainer
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.WatcherInputContainer
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.WatcherTriggerContainer
