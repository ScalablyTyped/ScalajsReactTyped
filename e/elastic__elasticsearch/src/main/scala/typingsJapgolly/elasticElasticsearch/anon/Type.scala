...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SnapshotRepository
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SnapshotRepositorySettings
