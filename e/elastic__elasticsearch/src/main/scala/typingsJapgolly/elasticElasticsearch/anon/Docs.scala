...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.IngestPipeline
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.IngestSimulateDocument
