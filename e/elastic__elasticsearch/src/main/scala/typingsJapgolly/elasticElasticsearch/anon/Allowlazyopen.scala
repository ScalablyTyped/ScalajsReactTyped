...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlAnalysisLimits
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlCustomSettings
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlDataDescription
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlDatafeedConfig
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlModelPlotConfig
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.long
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait Allowlazyopen extends StObject {
  ...
  var background_persist_interval: js.UndefOr[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration] = js.undefined
...
object Allowlazyopen {
  
  inline def apply(analysis_config: MlAnalysisConfig, data_description: MlDataDescription): Allowlazyopen = {
    ...
    __obj.asInstanceOf[Allowlazyopen]
  }
  
  extension [Self <: Allowlazyopen](x: Self) {
    ...
    inline def setBackground_persist_interval(value: typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration): Self = StObject.set(x, "background_persist_interval", value.asInstanceOf[js.Any])
