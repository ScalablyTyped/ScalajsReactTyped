...
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SecurityHasPrivilegesApplicationPrivilegesCheck
import typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.SecurityHasPrivilegesIndexPrivilegesCheck
