...
import typingsJapgolly.elasticElasticsearch.anon.IdString
import typingsJapgolly.elasticElasticsearch.anon.Ingest
import typingsJapgolly.elasticElasticsearch.anon.TypeofBaseConnection
import typingsJapgolly.elasticElasticsearch.anon.TypeofTransport
import typingsJapgolly.elasticElasticsearch.elasticElasticsearchBooleans.`false`
import typingsJapgolly.elasticElasticsearch.elasticElasticsearchStrings.constructor
...
import typingsJapgolly.elasticElasticsearch.elasticElasticsearchStrings.proto
import typingsJapgolly.elasticElasticsearch.libApiMod.API
...
import typingsJapgolly.elasticTransport.libTransportMod.TransportRequestParams
import typingsJapgolly.elasticTransport.libTypesMod.ApiKeyAuth
import typingsJapgolly.elasticTransport.libTypesMod.BasicAuth
import typingsJapgolly.elasticTransport.libTypesMod.BearerAuth
import typingsJapgolly.elasticTransport.libTypesMod.Context
import typingsJapgolly.elasticTransport.libTypesMod.HttpAgentOptions
import typingsJapgolly.elasticTransport.libTypesMod.UndiciAgentOptions
import typingsJapgolly.elasticTransport.libTypesMod.agentFn
import typingsJapgolly.elasticTransport.libTypesMod.generateRequestIdFn
import typingsJapgolly.elasticTransport.libTypesMod.nodeFilterFn
import typingsJapgolly.elasticTransport.libTypesMod.nodeSelectorFn
import typingsJapgolly.elasticTransport.mod.BaseConnectionPool
import typingsJapgolly.elasticTransport.mod.Diagnostic
import typingsJapgolly.elasticTransport.mod.Serializer
...
object libClientMod {
  ...
  trait Client
    ...
    var helpers: typingsJapgolly.elasticElasticsearch.libHelpersMod.default = js.native
    
    var name: String | js.Symbol = js.native
    
    var serializer: Serializer = js.native
    
    var transport: typingsJapgolly.elasticElasticsearch.libSniffingTransportMod.default = js.native
  }
  ...
  trait ClientOptions extends StObject {
    ...
    var Serializer: js.UndefOr[Instantiable0[typingsJapgolly.elasticTransport.mod.Serializer]] = js.undefined
  ...
  object ClientOptions {
    ...
    extension [Self <: ClientOptions](x: Self) {
      ...
      inline def setAgentFunction1(
        value: /* opts */ typingsJapgolly.elasticTransport.libConnectionBaseConnectionMod.ConnectionOptions => Any
      ): Self = StObject.set(x, "agent", js.Any.fromFunction1(value))
