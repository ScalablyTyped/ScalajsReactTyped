...
object ClusterAllocationExplain {
  ...
  def apply[T](
    ...
    if (!js.isUndefined(include_disk_info)) __obj.updateDynamic("include_disk_info")(include_disk_info.asInstanceOf[js.Any])
    if (!js.isUndefined(include_yes_decisions)) __obj.updateDynamic("include_yes_decisions")(include_yes_decisions.asInstanceOf[js.Any])
