...
import typingsJapgolly.elasticElasticsearch.anon.Chunkingconfig
...
trait MlPutDatafeedRequest
  ...
  var body: js.UndefOr[Chunkingconfig] = js.undefined
...
object MlPutDatafeedRequest {
  ...
  extension [Self <: MlPutDatafeedRequest](x: Self) {
    ...
    inline def setBody(value: Chunkingconfig): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
