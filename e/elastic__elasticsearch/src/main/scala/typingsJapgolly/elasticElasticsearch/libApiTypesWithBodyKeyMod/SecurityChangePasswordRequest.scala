...
trait SecurityChangePasswordRequest
  ...
  var body: js.UndefOr[typingsJapgolly.elasticElasticsearch.anon.Password] = js.undefined
...
object SecurityChangePasswordRequest {
  ...
  extension [Self <: SecurityChangePasswordRequest](x: Self) {
    ...
    inline def setBody(value: typingsJapgolly.elasticElasticsearch.anon.Password): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
