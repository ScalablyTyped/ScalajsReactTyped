...
trait MappingShortNumberProperty
  ...
  var `type`: typingsJapgolly.elasticElasticsearch.elasticElasticsearchStrings.short
}
object MappingShortNumberProperty {
  ...
  extension [Self <: MappingShortNumberProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.elasticElasticsearch.elasticElasticsearchStrings.short): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
