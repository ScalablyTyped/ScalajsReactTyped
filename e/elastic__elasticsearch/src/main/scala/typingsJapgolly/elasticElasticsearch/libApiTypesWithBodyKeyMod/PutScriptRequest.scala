...
trait PutScriptRequest
  ...
  var body: js.UndefOr[typingsJapgolly.elasticElasticsearch.anon.Script] = js.undefined
...
object PutScriptRequest {
  ...
  extension [Self <: PutScriptRequest](x: Self) {
    ...
    inline def setBody(value: typingsJapgolly.elasticElasticsearch.anon.Script): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
