...
object IndicesCloseRequest {
  ...
  inline def apply(index: Indices): IndicesCloseRequest = {
    val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any])
    __obj.asInstanceOf[IndicesCloseRequest]
  }
  
  extension [Self <: IndicesCloseRequest](x: Self) {
