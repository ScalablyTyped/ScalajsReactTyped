...
trait MgetRequest
  ...
  var body: js.UndefOr[typingsJapgolly.elasticElasticsearch.anon.Ids] = js.undefined
...
object MgetRequest {
  ...
  extension [Self <: MgetRequest](x: Self) {
    ...
    inline def setBody(value: typingsJapgolly.elasticElasticsearch.anon.Ids): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
