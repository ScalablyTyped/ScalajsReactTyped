...
trait SnapshotCloneRequest
  ...
  var body: js.UndefOr[typingsJapgolly.elasticElasticsearch.anon.Indices] = js.undefined
...
object SnapshotCloneRequest {
  ...
  extension [Self <: SnapshotCloneRequest](x: Self) {
    ...
    inline def setBody(value: typingsJapgolly.elasticElasticsearch.anon.Indices): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
