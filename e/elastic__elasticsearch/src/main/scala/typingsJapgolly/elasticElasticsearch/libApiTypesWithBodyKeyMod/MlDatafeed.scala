...
trait MlDatafeed extends StObject {
  ...
  var delayed_data_check_config: MlDelayedDataCheckConfig
...
object MlDatafeed {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(datafeed_id = datafeed_id.asInstanceOf[js.Any], delayed_data_check_config = delayed_data_check_config.asInstanceOf[js.Any], indices = indices.asInstanceOf[js.Any], job_id = job_id.asInstanceOf[js.Any], query = query.asInstanceOf[js.Any])
    __obj.asInstanceOf[MlDatafeed]
  }
  
  extension [Self <: MlDatafeed](x: Self) {
