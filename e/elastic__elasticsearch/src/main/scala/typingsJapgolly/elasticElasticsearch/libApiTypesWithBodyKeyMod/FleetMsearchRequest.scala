...
trait FleetMsearchRequest
  ...
  var body: js.UndefOr[js.Array[MsearchRequestItem]] = js.undefined
...
object FleetMsearchRequest {
  ...
  extension [Self <: FleetMsearchRequest](x: Self) {
    ...
    inline def setBody(value: js.Array[MsearchRequestItem]): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
    
    inline def setBodyUndefined: Self = StObject.set(x, "body", js.undefined)
    
    inline def setBodyVarargs(value: MsearchRequestItem*): Self = StObject.set(x, "body", js.Array(value*))
