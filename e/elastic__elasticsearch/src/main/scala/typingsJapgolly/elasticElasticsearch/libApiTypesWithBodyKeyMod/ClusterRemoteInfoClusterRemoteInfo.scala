...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.ClusterRemoteInfoClusterRemoteSniffInfo
  - typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.ClusterRemoteInfoClusterRemoteProxyInfo
*/
...
object ClusterRemoteInfoClusterRemoteInfo {
  ...
  inline def ClusterRemoteInfoClusterRemoteProxyInfo(
    ...
    __obj.asInstanceOf[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.ClusterRemoteInfoClusterRemoteProxyInfo]
  }
  ...
  inline def ClusterRemoteInfoClusterRemoteSniffInfo(
    ...
    __obj.asInstanceOf[typingsJapgolly.elasticElasticsearch.libApiTypesWithBodyKeyMod.ClusterRemoteInfoClusterRemoteSniffInfo]
  }
}
