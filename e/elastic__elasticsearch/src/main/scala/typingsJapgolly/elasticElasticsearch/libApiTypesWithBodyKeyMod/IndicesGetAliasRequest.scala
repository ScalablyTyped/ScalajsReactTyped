...
object IndicesGetAliasRequest {
  ...
  inline def apply(): IndicesGetAliasRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IndicesGetAliasRequest]
  }
  
  extension [Self <: IndicesGetAliasRequest](x: Self) {
