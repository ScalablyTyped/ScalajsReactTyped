...
import typingsJapgolly.elasticElasticsearch.anon.Aggregations
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait AsyncSearchSubmitRequest
  extends StObject
  ...
  var body: js.UndefOr[Aggregations] = js.undefined
...
object AsyncSearchSubmitRequest {
  ...
  inline def apply(): AsyncSearchSubmitRequest = {
  ...
  extension [Self <: AsyncSearchSubmitRequest](x: Self) {
    ...
    inline def setBody(value: Aggregations): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
