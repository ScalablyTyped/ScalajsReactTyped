...
trait ReindexRequest
  ...
  var body: js.UndefOr[typingsJapgolly.elasticElasticsearch.anon.Conflicts] = js.undefined
...
object ReindexRequest {
  ...
  extension [Self <: ReindexRequest](x: Self) {
    ...
    inline def setBody(value: typingsJapgolly.elasticElasticsearch.anon.Conflicts): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
