...
trait SecurityInvalidateApiKeyRequest
  ...
  var body: js.UndefOr[typingsJapgolly.elasticElasticsearch.anon.Name] = js.undefined
}
object SecurityInvalidateApiKeyRequest {
  ...
  extension [Self <: SecurityInvalidateApiKeyRequest](x: Self) {
    ...
    inline def setBody(value: typingsJapgolly.elasticElasticsearch.anon.Name): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
