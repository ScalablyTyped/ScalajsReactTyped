...
trait MappingIntegerNumberProperty
  ...
  var `type`: typingsJapgolly.elasticElasticsearch.elasticElasticsearchStrings.integer
}
object MappingIntegerNumberProperty {
  ...
  extension [Self <: MappingIntegerNumberProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.elasticElasticsearch.elasticElasticsearchStrings.integer): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
