...
import typingsJapgolly.elasticElasticsearch.requestParamsMod.CcrDeleteAutoFollowPattern
import typingsJapgolly.elasticElasticsearch.requestParamsMod.CcrFollow
import typingsJapgolly.elasticElasticsearch.requestParamsMod.CcrFollowInfo
import typingsJapgolly.elasticElasticsearch.requestParamsMod.CcrFollowStats
import typingsJapgolly.elasticElasticsearch.requestParamsMod.CcrForgetFollower
import typingsJapgolly.elasticElasticsearch.requestParamsMod.CcrGetAutoFollowPattern
import typingsJapgolly.elasticElasticsearch.requestParamsMod.CcrPauseAutoFollowPattern
import typingsJapgolly.elasticElasticsearch.requestParamsMod.CcrPauseFollow
import typingsJapgolly.elasticElasticsearch.requestParamsMod.CcrPutAutoFollowPattern
import typingsJapgolly.elasticElasticsearch.requestParamsMod.CcrResumeAutoFollowPattern
import typingsJapgolly.elasticElasticsearch.requestParamsMod.CcrResumeFollow
import typingsJapgolly.elasticElasticsearch.requestParamsMod.CcrStats
import typingsJapgolly.elasticElasticsearch.requestParamsMod.CcrUnfollow
