...
object BulkHelperOptions {
  ...
  extension [Self <: BulkHelperOptions[?], TDocument](x: Self & BulkHelperOptions[TDocument]) {
    ...
    inline def setOnDrop(value: /* doc */ OnDropDocument[TDocument] => Callback): Self = StObject.set(x, "onDrop", js.Any.fromFunction1((t0: /* doc */ OnDropDocument[TDocument]) => value(t0).runNow()))
