...
import typingsJapgolly.elasticElasticsearch.libApiTypesMod.AggregateName
import typingsJapgolly.elasticElasticsearch.libApiTypesMod.AggregationsAggregate
