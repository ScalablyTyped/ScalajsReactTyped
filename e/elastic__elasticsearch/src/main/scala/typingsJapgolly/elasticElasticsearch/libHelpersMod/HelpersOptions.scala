...
trait HelpersOptions extends StObject {
  ...
  var client: typingsJapgolly.elasticElasticsearch.libClientMod.default
...
object HelpersOptions {
  ...
  inline def apply(client: typingsJapgolly.elasticElasticsearch.libClientMod.default, maxRetries: Double): HelpersOptions = {
  ...
  extension [Self <: HelpersOptions](x: Self) {
    ...
    inline def setClient(value: typingsJapgolly.elasticElasticsearch.libClientMod.default): Self = StObject.set(x, "client", value.asInstanceOf[js.Any])
