package typingsJapgolly.esAggregateError
...
object mod {
  ...
  @js.native
  open class ^ ()
    extends typingsJapgolly.esAggregateError.implementationMod.^
  @JSImport("es-aggregate-error", JSImport.Namespace)
  @js.native
  ...
  def implementation: Instantiable2[
    ...
    typingsJapgolly.esAggregateError.implementationMod.^
  ] = js.native
  ...
  type AggregateError = typingsJapgolly.esAggregateError.implementationMod.^
}
