...
object implementationMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    @JSName("name")
    override val name_AggregateError: typingsJapgolly.esAggregateError.esAggregateErrorStrings.AggregateError = js.native
  }
  ...
  trait AggregateError
    ...
    @JSName("name")
    val name_AggregateError: typingsJapgolly.esAggregateError.esAggregateErrorStrings.AggregateError
  }
  object AggregateError {
    ...
    extension [Self <: AggregateError](x: Self) {
      ...
      inline def setName(value: typingsJapgolly.esAggregateError.esAggregateErrorStrings.AggregateError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
}
