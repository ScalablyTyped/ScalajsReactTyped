...
import typingsJapgolly.ethersprojectProviders.anon.Method
...
object libWeb3ProviderMod {
  ...
  object ExternalProvider {
    ...
    extension [Self <: ExternalProvider](x: Self) {
      ...
      inline def setSend(
        value: (/* request */ Method, /* callback */ js.Function2[/* error */ Any, /* response */ Any, Unit]) => Callback
      ): Self = StObject.set(x, "send", js.Any.fromFunction2((t0: /* request */ Method, t1: /* callback */ js.Function2[/* error */ Any, /* response */ Any, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setSendAsync(
        value: (/* request */ Method, /* callback */ js.Function2[/* error */ Any, /* response */ Any, Unit]) => Callback
      ): Self = StObject.set(x, "sendAsync", js.Any.fromFunction2((t0: /* request */ Method, t1: /* callback */ js.Function2[/* error */ Any, /* response */ Any, Unit]) => (value(t0, t1)).runNow()))
