...
import typingsJapgolly.ethersprojectAbstractProvider.mod.BlockWithTransactions
import typingsJapgolly.ethersprojectAbstractProvider.mod.EventType
import typingsJapgolly.ethersprojectAbstractProvider.mod.Filter
import typingsJapgolly.ethersprojectAbstractProvider.mod.FilterByBlockHash
...
import typingsJapgolly.ethersprojectProviders.anon.BlockNumber
import typingsJapgolly.ethersprojectProviders.anon.Content
import typingsJapgolly.ethersprojectProviders.anon.Data
import typingsJapgolly.ethersprojectProviders.anon.DeferrableTransactionRequ
import typingsJapgolly.ethersprojectProviders.ethersprojectProvidersInts.`60`
import typingsJapgolly.ethersprojectProviders.ethersprojectProvidersStrings.pending
