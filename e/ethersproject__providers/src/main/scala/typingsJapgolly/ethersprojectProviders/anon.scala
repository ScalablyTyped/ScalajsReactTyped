...
import typingsJapgolly.ethersprojectProviders.ethersprojectProvidersStrings.`2Dot0`
...
object anon {
  ...
  object Reject {
    ...
    inline def apply(reject: js.Error => Callback, request: Id, resolve: Any => Callback): Reject = {
      val __obj = js.Dynamic.literal(reject = js.Any.fromFunction1((t0: js.Error) => reject(t0).runNow()), request = request.asInstanceOf[js.Any], resolve = js.Any.fromFunction1((t0: Any) => resolve(t0).runNow()))
