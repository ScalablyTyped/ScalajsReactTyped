package typingsJapgolly.expressSlowDown
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnLimitReached(
        value: (/* req */ RequestWithSlowDown, /* res */ Response_[Any, Record[String, Any]], Options) => Callback
      ): Self = StObject.set(x, "onLimitReached", js.Any.fromFunction3((t0: /* req */ RequestWithSlowDown, t1: /* res */ Response_[Any, Record[String, Any]], t2: Options) => (value(t0, t1, t2)).runNow()))
  ...
  object Store {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(decrement = js.Any.fromFunction1((t0: String) => decrement(t0).runNow()), incr = js.Any.fromFunction2((t0: String, t1: StoreIncrementCallback) => (incr(t0, t1)).runNow()), resetKey = js.Any.fromFunction1((t0: String) => resetKey(t0).runNow()))
    ...
    extension [Self <: Store](x: Self) {
      ...
      inline def setIncr(value: (String, StoreIncrementCallback) => Callback): Self = StObject.set(x, "incr", js.Any.fromFunction2((t0: String, t1: StoreIncrementCallback) => (value(t0, t1)).runNow()))
