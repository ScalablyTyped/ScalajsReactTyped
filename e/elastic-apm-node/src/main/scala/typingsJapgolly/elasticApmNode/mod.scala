...
import typingsJapgolly.elasticApmNode.anon.Connect
import typingsJapgolly.elasticApmNode.anon.Name
import typingsJapgolly.elasticApmNode.anon.Spanid
import typingsJapgolly.elasticApmNode.anon.Traceid
import typingsJapgolly.elasticApmNode.anon.Transactionid
import typingsJapgolly.elasticApmNode.typesAwsLambdaMod.AwsLambda.Handler
...
object mod extends Shortcut {
  ...
  */
  ...
  object CaptureBody {
    ...
    inline def all: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.all = "all".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.all]
    
    inline def errors: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.errors = "errors".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.errors]
    
    inline def off: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.off = "off".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.off]
    
    inline def transactions: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.transactions = "transactions".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.transactions]
  }
  ...
  */
  ...
  object CaptureErrorLogStackTraces {
    ...
    inline def always: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.always = "always".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.always]
    
    inline def messages: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.messages = "messages".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.messages]
    
    inline def never: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.never = "never".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.never]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.elasticApmNode.elasticApmNodeStrings.warning
    - typingsJapgolly.elasticApmNode.elasticApmNodeStrings.error
    - typingsJapgolly.elasticApmNode.elasticApmNodeStrings.fatal
    - typingsJapgolly.elasticApmNode.elasticApmNodeStrings.critical
    - typingsJapgolly.elasticApmNode.elasticApmNodeStrings.off
  */
  trait LogLevel extends StObject
  object LogLevel {
    
    inline def critical: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.critical = "critical".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.critical]
    
    inline def debug: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.debug = "debug".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.debug]
    
    inline def error: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.error = "error".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.error]
    
    inline def fatal: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.fatal = "fatal".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.fatal]
    
    inline def info: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.info = "info".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.info]
    
    inline def off: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.off = "off".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.off]
    
    inline def trace: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.trace = "trace".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.trace]
    
    inline def warn: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.warn = "warn".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.warn]
    
    inline def warning: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.warning = "warning".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.warning]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.elasticApmNode.elasticApmNodeStrings.unknown
    - typingsJapgolly.elasticApmNode.elasticApmNodeStrings.success
    - typingsJapgolly.elasticApmNode.elasticApmNodeStrings.failure
  */
  trait Outcome extends StObject
  object Outcome {
    
    inline def failure: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.failure = "failure".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.failure]
    
    inline def success: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.success = "success".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.success]
    
    inline def unknown: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.unknown = "unknown".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.unknown]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.elasticApmNode.elasticApmNodeStrings.continue
    - typingsJapgolly.elasticApmNode.elasticApmNodeStrings.restart
    - typingsJapgolly.elasticApmNode.elasticApmNodeStrings.restart_external
  */
  trait TraceContinuationStrategy extends StObject
  object TraceContinuationStrategy {
    
    inline def continue: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.continue = "continue".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.continue]
    
    inline def restart: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.restart = "restart".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.restart]
    
    inline def restart_external: typingsJapgolly.elasticApmNode.elasticApmNodeStrings.restart_external = "restart_external".asInstanceOf[typingsJapgolly.elasticApmNode.elasticApmNodeStrings.restart_external]
  }
