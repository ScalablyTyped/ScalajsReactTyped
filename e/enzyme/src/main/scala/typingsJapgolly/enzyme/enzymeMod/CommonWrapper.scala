...
import typingsJapgolly.cheerio.Cheerio
import typingsJapgolly.enzyme.Anon_IgnoreProps
...
trait CommonWrapper[P, S, C] extends js.Object {
  ...
  /**
    ...
    */
  def containsAllMatchingElements(nodes: js.Array[js.Array[Element] | Element]): Boolean = js.native
  /**
    * Returns whether or not one of the given react elements exists in the shallow render tree.
    */
  def containsAnyMatchingElements(nodes: js.Array[js.Array[Element] | Element]): Boolean = js.native
  ...
  /**
    ...
    */
  def equals(node: Element): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getDOMNode[T /* <: org.scalajs.dom.raw.Element */](): T = js.native
  /**
  ...
  /**
    ...
    */
  def matchesElement(node: Element): Boolean = js.native
  /**
