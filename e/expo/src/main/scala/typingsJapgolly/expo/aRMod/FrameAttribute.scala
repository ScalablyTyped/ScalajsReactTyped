...
object FrameAttribute extends js.Object {
  ...
  object CapturedDepthData
    extends TopLevel[typingsJapgolly.expo.aRMod.FrameAttribute.CapturedDepthData with String]
  
  /* "lightEstimation" */ @js.native
  object LightEstimation
    extends TopLevel[typingsJapgolly.expo.aRMod.FrameAttribute.LightEstimation with String]
