package typingsJapgolly.expo.buildLinkingLinkingModuleDotWebMod

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.expo.buildLinkingLinkingDotTypesMod.URLListener
...
object Linking {
  ...
  def apply(
    ...
    __obj.updateDynamic("addEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.expo.expoStrings.url, t1: typingsJapgolly.expo.buildLinkingLinkingDotTypesMod.URLListener) => addEventListener(t0, t1).runNow()))
    ...
    __obj.updateDynamic("removeEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.expo.expoStrings.url, t1: typingsJapgolly.expo.buildLinkingLinkingDotTypesMod.URLListener) => removeEventListener(t0, t1).runNow()))
