...
abstract class SharedApply_IconProps163127233[ComponentRef] () {
  ...
  typingsJapgolly.reactNativeVectorIcons.iconMod.IconProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeVectorIcons.iconMod.IconProps])(children: _*)
  }
}
