...
abstract class SharedApply_IconButtonProps_982420190[ComponentRef] () {
  ...
  typingsJapgolly.reactNativeVectorIcons.iconMod.IconButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeVectorIcons.iconMod.IconButtonProps])(children: _*)
  }
}
