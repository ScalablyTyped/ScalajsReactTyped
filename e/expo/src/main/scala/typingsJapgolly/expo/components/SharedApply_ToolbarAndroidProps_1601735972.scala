...
abstract class SharedApply_ToolbarAndroidProps_1601735972[ComponentRef] () {
  ...
  typingsJapgolly.reactNativeVectorIcons.iconMod.ToolbarAndroidProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNativeVectorIcons.iconMod.ToolbarAndroidProps])(children: _*)
  }
}
