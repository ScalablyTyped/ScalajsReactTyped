package typingsJapgolly.expo.buildGlobalsDotWebMod.Icon
...
@js.native
class MaterialIcons ()
  extends typingsJapgolly.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialIcons

/* static members */
@JSImport("expo/build/globals.web", "Icon.MaterialIcons")
@js.native
object MaterialIcons extends js.Object {
  @js.native
  class Button ()
