...
libraryDependencies ++= Seq(
  ...
  "org.gulliblytyped.japgolly" %%% "expo-asset" % "7.0.0-1db009",
  "org.gulliblytyped.japgolly" %%% "expo-constants" % "7.0.1-d2faf5",
  "org.gulliblytyped.japgolly" %%% "fbemitter" % "2.0.0-dt-20190503Z-c5311a",
