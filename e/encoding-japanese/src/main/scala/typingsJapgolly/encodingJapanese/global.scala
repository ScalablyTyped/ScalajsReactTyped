...
import typingsJapgolly.encodingJapanese.mod.ConvertArrayBufferOptions
import typingsJapgolly.encodingJapanese.mod.ConvertArrayOptions
import typingsJapgolly.encodingJapanese.mod.ConvertStringOptions
import typingsJapgolly.encodingJapanese.mod.ConvertUnknownOptions
import typingsJapgolly.encodingJapanese.mod.EncodingDetection
import typingsJapgolly.encodingJapanese.mod.IntArrayType
...
object global {
  ...
  object Encoding {
    ...
    inline def convert(data: String, to: typingsJapgolly.encodingJapanese.mod.Encoding): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(data.asInstanceOf[js.Any], to.asInstanceOf[js.Any])).asInstanceOf[String]
    inline def convert(
      data: String,
      to: typingsJapgolly.encodingJapanese.mod.Encoding,
      from: typingsJapgolly.encodingJapanese.mod.Encoding
    ...
    inline def convert(data: IntArrayType, to: typingsJapgolly.encodingJapanese.mod.Encoding): js.Array[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(data.asInstanceOf[js.Any], to.asInstanceOf[js.Any])).asInstanceOf[js.Array[Double]]
    inline def convert(
      data: IntArrayType,
      to: typingsJapgolly.encodingJapanese.mod.Encoding,
      from: typingsJapgolly.encodingJapanese.mod.Encoding
    ...
    inline def detect(data: String, encodings: js.Array[typingsJapgolly.encodingJapanese.mod.Encoding]): EncodingDetection = (^.asInstanceOf[js.Dynamic].applyDynamic("detect")(data.asInstanceOf[js.Any], encodings.asInstanceOf[js.Any])).asInstanceOf[EncodingDetection]
    inline def detect(data: String, encodings: typingsJapgolly.encodingJapanese.mod.Encoding): EncodingDetection = (^.asInstanceOf[js.Dynamic].applyDynamic("detect")(data.asInstanceOf[js.Any], encodings.asInstanceOf[js.Any])).asInstanceOf[EncodingDetection]
    ...
    inline def detect(data: IntArrayType, encodings: js.Array[typingsJapgolly.encodingJapanese.mod.Encoding]): EncodingDetection = (^.asInstanceOf[js.Dynamic].applyDynamic("detect")(data.asInstanceOf[js.Any], encodings.asInstanceOf[js.Any])).asInstanceOf[EncodingDetection]
    inline def detect(data: IntArrayType, encodings: typingsJapgolly.encodingJapanese.mod.Encoding): EncodingDetection = (^.asInstanceOf[js.Dynamic].applyDynamic("detect")(data.asInstanceOf[js.Any], encodings.asInstanceOf[js.Any])).asInstanceOf[EncodingDetection]
