package typingsJapgolly.electronStore

import japgolly.scalajs.react.Callback
import typingsJapgolly.conf.distSourceTypesMod.BeforeEachMigrationCallback
import typingsJapgolly.conf.distSourceTypesMod.BeforeEachMigrationContext
import typingsJapgolly.conf.distSourceTypesMod.Deserialize
import typingsJapgolly.conf.distSourceTypesMod.Migrations
import typingsJapgolly.conf.distSourceTypesMod.Serialize
import typingsJapgolly.conf.mod.default
...
object mod {
  ...
  */
  ...
  trait Options[T /* <: Record[String, Any] */] extends StObject {
    ...
    var schema: js.UndefOr[typingsJapgolly.conf.distSourceTypesMod.Schema[T]] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options[?], T /* <: Record[String, Any] */](x: Self & Options[T]) {
      ...
      inline def setBeforeEachMigration(value: (/* store */ default[T], /* context */ BeforeEachMigrationContext) => Callback): Self = StObject.set(x, "beforeEachMigration", js.Any.fromFunction2((t0: /* store */ default[T], t1: /* context */ BeforeEachMigrationContext) => (value(t0, t1)).runNow()))
      ...
      inline def setSchema(value: typingsJapgolly.conf.distSourceTypesMod.Schema[T]): Self = StObject.set(x, "schema", value.asInstanceOf[js.Any])
  ...
  type Schema[T] = typingsJapgolly.conf.distSourceTypesMod.Schema[T]
}
