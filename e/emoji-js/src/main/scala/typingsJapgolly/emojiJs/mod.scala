...
object mod {
  ...
  object Emoji {
    ...
    inline def apply(
      addAliases: StringDictionary[String] => Callback,
      allow_caps: Boolean,
      ...
      removeAliases: js.Array[String] => Callback,
    ...
    extension [Self <: Emoji](x: Self) {
      ...
      inline def setRemoveAliases(value: js.Array[String] => Callback): Self = StObject.set(x, "removeAliases", js.Any.fromFunction1((t0: js.Array[String]) => value(t0).runNow()))
