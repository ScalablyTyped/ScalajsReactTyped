...
object extensoStrings {
  ...
  @js.native
  sealed trait formal extends StObject
  inline def formal: formal = "formal".asInstanceOf[formal]
  
  @js.native
  sealed trait informal extends StObject
  inline def informal: informal = "informal".asInstanceOf[informal]
