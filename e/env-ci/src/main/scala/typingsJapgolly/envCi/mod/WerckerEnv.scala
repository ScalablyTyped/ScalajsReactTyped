...
object WerckerEnv {
  ...
  inline def apply(branch: String, build: String, buildUrl: String, commit: String, root: String, slug: String): WerckerEnv = {
  ...
  extension [Self <: WerckerEnv](x: Self) {
    ...
    inline def setName(value: Wercker): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    
    inline def setRoot(value: String): Self = StObject.set(x, "root", value.asInstanceOf[js.Any])
    
    inline def setService(value: wercker_): Self = StObject.set(x, "service", value.asInstanceOf[js.Any])
