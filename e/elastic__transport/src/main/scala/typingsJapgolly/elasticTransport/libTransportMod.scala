...
import typingsJapgolly.elasticTransport.anon.Accept
...
import typingsJapgolly.elasticTransport.elasticTransportBooleans.`true`
import typingsJapgolly.elasticTransport.libConnectionMod.Connection
import typingsJapgolly.elasticTransport.libPoolMod.BaseConnectionPool
import typingsJapgolly.elasticTransport.libTypesMod.Context
import typingsJapgolly.elasticTransport.libTypesMod.RequestBody
import typingsJapgolly.elasticTransport.libTypesMod.RequestNDBody
...
object libTransportMod {
  ...
  trait Transport extends StObject {
    ...
    def diagnostic: typingsJapgolly.elasticTransport.libDiagnosticMod.default = js.native
  ...
  trait TransportOptions extends StObject {
    ...
    var serializer: js.UndefOr[typingsJapgolly.elasticTransport.libSerializerMod.default] = js.undefined
  ...
  object TransportOptions {
    ...
    extension [Self <: TransportOptions](x: Self) {
      ...
      inline def setSerializer(value: typingsJapgolly.elasticTransport.libSerializerMod.default): Self = StObject.set(x, "serializer", value.asInstanceOf[js.Any])
