...
import typingsJapgolly.elasticTransport.anon.TypeofBaseConnection
import typingsJapgolly.elasticTransport.elasticTransportBooleans.`false`
import typingsJapgolly.elasticTransport.elasticTransportStrings.none
import typingsJapgolly.elasticTransport.elasticTransportStrings.optimistic
import typingsJapgolly.elasticTransport.elasticTransportStrings.ping
...
object libPoolBaseConnectionPoolMod {
  ...
  trait BaseConnectionPool extends StObject {
    ...
    var _tls: js.UndefOr[typingsJapgolly.node.tlsMod.ConnectionOptions] = js.native
    ...
    var diagnostic: typingsJapgolly.elasticTransport.libDiagnosticMod.default = js.native
  ...
  trait ConnectionPoolOptions extends StObject {
    ...
    var diagnostic: js.UndefOr[typingsJapgolly.elasticTransport.libDiagnosticMod.default] = js.undefined
    ...
    var tls: js.UndefOr[typingsJapgolly.node.tlsMod.ConnectionOptions] = js.undefined
  }
  object ConnectionPoolOptions {
    ...
    extension [Self <: ConnectionPoolOptions](x: Self) {
      ...
      inline def setDiagnostic(value: typingsJapgolly.elasticTransport.libDiagnosticMod.default): Self = StObject.set(x, "diagnostic", value.asInstanceOf[js.Any])
      ...
      inline def setTls(value: typingsJapgolly.node.tlsMod.ConnectionOptions): Self = StObject.set(x, "tls", value.asInstanceOf[js.Any])
