package typingsJapgolly.electronWindowState.mod.ElectronWindowState
...
object WindowState {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(height = height.asInstanceOf[js.Any], isFullScreen = isFullScreen.asInstanceOf[js.Any], isMaximized = isMaximized.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any], x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any])
    __obj.updateDynamic("manage")(js.Any.fromFunction1((t0: typingsJapgolly.electron.Electron.BrowserWindow) => manage(t0).runNow()))
    __obj.updateDynamic("saveState")(js.Any.fromFunction1((t0: typingsJapgolly.electron.Electron.BrowserWindow) => saveState(t0).runNow()))
