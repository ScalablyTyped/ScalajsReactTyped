package typingsJapgolly.electronWindowState

import japgolly.scalajs.react.Callback
import typingsJapgolly.electron.mod.BrowserWindow
import typingsJapgolly.electronWindowState.anon.Height
...
object mod {
  ...
  object State {
    ...
    inline def apply(
      ...
      isMaximized: Boolean,
      manage: BrowserWindow => Callback,
      saveState: BrowserWindow => Callback,
      unmanage: Callback,
      width: Double,
      x: Double,
      y: Double
    ): State = {
      val __obj = js.Dynamic.literal(displayBounds = displayBounds.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], isFullScreen = isFullScreen.asInstanceOf[js.Any], isMaximized = isMaximized.asInstanceOf[js.Any], manage = js.Any.fromFunction1((t0: BrowserWindow) => manage(t0).runNow()), saveState = js.Any.fromFunction1((t0: BrowserWindow) => saveState(t0).runNow()), unmanage = unmanage.toJsFn, width = width.asInstanceOf[js.Any], x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any])
    ...
    extension [Self <: State](x: Self) {
      ...
      inline def setManage(value: BrowserWindow => Callback): Self = StObject.set(x, "manage", js.Any.fromFunction1((t0: BrowserWindow) => value(t0).runNow()))
      
      inline def setSaveState(value: BrowserWindow => Callback): Self = StObject.set(x, "saveState", js.Any.fromFunction1((t0: BrowserWindow) => value(t0).runNow()))
      
      inline def setUnmanage(value: Callback): Self = StObject.set(x, "unmanage", value.toJsFn)
