...
import typingsJapgolly.eventTargetShim.anon.Abort
import typingsJapgolly.eventTargetShim.anon.TypeofEvent
import typingsJapgolly.eventTargetShim.es5Mod.Event.EventInit
import typingsJapgolly.eventTargetShim.es5Mod.EventTarget.AddOptions
import typingsJapgolly.eventTargetShim.es5Mod.EventTarget.CallbackFunction
import typingsJapgolly.eventTargetShim.es5Mod.EventTarget.EventData
import typingsJapgolly.eventTargetShim.es5Mod.EventTarget.EventListener
import typingsJapgolly.eventTargetShim.es5Mod.EventTarget.FallbackEvent
import typingsJapgolly.eventTargetShim.es5Mod.EventTarget.FallbackEventListener
import typingsJapgolly.eventTargetShim.es5Mod.EventTarget.Options
import typingsJapgolly.eventTargetShim.es5Mod.defineEventAttribute.EventAttributes
import typingsJapgolly.eventTargetShim.eventTargetShimStrings.standard
import typingsJapgolly.eventTargetShim.eventTargetShimStrings.strict
...
object es5Mod {
  ...
  object EventTarget {
    ...
    object CallbackObject {
      ...
      inline def apply[TEvent /* <: Event[String] */](handleEvent: TEvent => Callback): CallbackObject[TEvent] = {
