package typingsJapgolly.elasticlunrjs

import typingsJapgolly.elasticlunrjs.mod.PipelineFunction
import typingsJapgolly.elasticlunrjs.mod.SerialisedDocumentStore
import typingsJapgolly.elasticlunrjs.mod.SerialisedIndexData
import typingsJapgolly.elasticlunrjs.mod.SerialisedInvertedIndex
import typingsJapgolly.elasticlunrjs.mod.SerialisedPipeline
...
object global {
  ...
  object elasticlunr {
    ...
    inline def apply[T /* <: js.Object */](): typingsJapgolly.elasticlunrjs.mod.Index[T] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.elasticlunrjs.mod.Index[T]]
    inline def apply[T /* <: js.Object */](
      config: js.ThisFunction1[
          /* this */ typingsJapgolly.elasticlunrjs.mod.Index[T], 
          /* idx */ typingsJapgolly.elasticlunrjs.mod.Index[T], 
          Unit
        ]
    ): typingsJapgolly.elasticlunrjs.mod.Index[T] = ^.asInstanceOf[js.Dynamic].apply(config.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.elasticlunrjs.mod.Index[T]]
    ...
    open class Configuration[T /* <: js.Object */] protected ()
      extends typingsJapgolly.elasticlunrjs.mod.Configuration[T] {
    ...
    open class DocumentStore[T] ()
      extends typingsJapgolly.elasticlunrjs.mod.DocumentStore[T] {
    ...
    object DocumentStore {
      ...
      /* static member */
      inline def load[T](serialisedData: SerialisedDocumentStore[T]): typingsJapgolly.elasticlunrjs.mod.DocumentStore[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("load")(serialisedData.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.elasticlunrjs.mod.DocumentStore[T]]
    }
    
    @JSGlobal("elasticlunr.EventEmitter")
    @js.native
    open class EventEmitter ()
      extends typingsJapgolly.elasticlunrjs.mod.EventEmitter
    
    @JSGlobal("elasticlunr.Index")
    @js.native
    open class Index[T /* <: js.Object */] ()
      extends typingsJapgolly.elasticlunrjs.mod.Index[T]
    object Index {
      ...
      /* static member */
      inline def load[T /* <: js.Object */](serialisedData: SerialisedIndexData[T]): typingsJapgolly.elasticlunrjs.mod.Index[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("load")(serialisedData.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.elasticlunrjs.mod.Index[T]]
    }
    
    @JSGlobal("elasticlunr.InvertedIndex")
    @js.native
    open class InvertedIndex ()
      extends typingsJapgolly.elasticlunrjs.mod.InvertedIndex
    object InvertedIndex {
      ...
      /* static member */
      inline def load(serialisedData: SerialisedInvertedIndex): typingsJapgolly.elasticlunrjs.mod.InvertedIndex = ^.asInstanceOf[js.Dynamic].applyDynamic("load")(serialisedData.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.elasticlunrjs.mod.InvertedIndex]
    }
    
    @JSGlobal("elasticlunr.Pipeline")
    @js.native
    open class Pipeline ()
      extends typingsJapgolly.elasticlunrjs.mod.Pipeline
    object Pipeline {
      ...
      /* static member */
      inline def load(serialised: SerialisedPipeline): typingsJapgolly.elasticlunrjs.mod.Pipeline = ^.asInstanceOf[js.Dynamic].applyDynamic("load")(serialised.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.elasticlunrjs.mod.Pipeline]
    ...
    open class SortedSet[T] ()
      extends typingsJapgolly.elasticlunrjs.mod.SortedSet[T]
    object SortedSet {
      ...
      /* static member */
      inline def load[T](serialisedData: js.Array[T]): typingsJapgolly.elasticlunrjs.mod.SortedSet[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("load")(serialisedData.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.elasticlunrjs.mod.SortedSet[T]]
    }
