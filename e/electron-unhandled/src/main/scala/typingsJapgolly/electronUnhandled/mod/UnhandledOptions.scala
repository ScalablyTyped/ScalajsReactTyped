...
object UnhandledOptions {
  @scala.inline
  def apply(
    logger: /* error */ js.Error => Callback = null,
    reportButton: /* error */ js.Error => Callback = null,
    showDialog: js.UndefOr[Boolean] = js.undefined
  ): UnhandledOptions = {
    val __obj = js.Dynamic.literal()
    if (logger != null) __obj.updateDynamic("logger")(js.Any.fromFunction1((t0: /* error */ js.Error) => logger(t0).runNow()))
    if (reportButton != null) __obj.updateDynamic("reportButton")(js.Any.fromFunction1((t0: /* error */ js.Error) => reportButton(t0).runNow()))
