package typingsJapgolly.electronUnhandled
...
object mod {
  ...
  object UnhandledOptions {
    ...
    extension [Self <: UnhandledOptions](x: Self) {
      ...
      inline def setLogger(value: /* error */ js.Error => Callback): Self = StObject.set(x, "logger", js.Any.fromFunction1((t0: /* error */ js.Error) => value(t0).runNow()))
      
      inline def setLoggerUndefined: Self = StObject.set(x, "logger", js.undefined)
      
      inline def setReportButton(value: /* error */ js.Error => Callback): Self = StObject.set(x, "reportButton", js.Any.fromFunction1((t0: /* error */ js.Error) => value(t0).runNow()))
