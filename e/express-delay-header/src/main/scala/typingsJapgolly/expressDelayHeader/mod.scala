...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setTimeoutFunction(value: (/* next */ js.Function0[Unit], /* ms */ Double) => Callback): Self = StObject.set(x, "timeoutFunction", js.Any.fromFunction2((t0: /* next */ js.Function0[Unit], t1: /* ms */ Double) => (value(t0, t1)).runNow()))
