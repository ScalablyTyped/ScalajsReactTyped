package typingsJapgolly.expressProcessimage
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnPipeline(value: /* pipeline */ js.Object => Callback): Self = StObject.set(x, "onPipeline", js.Any.fromFunction1((t0: /* pipeline */ js.Object) => value(t0).runNow()))
