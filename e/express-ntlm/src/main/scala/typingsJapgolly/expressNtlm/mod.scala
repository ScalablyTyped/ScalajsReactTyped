package typingsJapgolly.expressNtlm
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setDebug(value: (/* prefix */ String, /* message */ String) => Callback): Self = StObject.set(x, "debug", js.Any.fromFunction2((t0: /* prefix */ String, t1: /* message */ String) => (value(t0, t1)).runNow()))
