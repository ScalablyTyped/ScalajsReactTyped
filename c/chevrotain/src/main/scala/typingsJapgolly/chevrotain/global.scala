package typingsJapgolly.chevrotain
...
object global {
  ...
  object chevrotain {
    ...
    open class Alternation protected ()
      extends typingsJapgolly.chevrotain.mod.Alternation {
    ...
    open class Alternative protected ()
      extends typingsJapgolly.chevrotain.mod.Alternative {
    ...
    open class CstParser ()
      extends typingsJapgolly.chevrotain.mod.CstParser
    ...
    open class EarlyExitException protected ()
      extends typingsJapgolly.chevrotain.mod.EarlyExitException {
    ...
    open class EmbeddedActionsParser ()
      extends typingsJapgolly.chevrotain.mod.EmbeddedActionsParser
    
    /* note: abstract class */ @JSGlobal("chevrotain.GAstVisitor")
    @js.native
    open class GAstVisitor ()
      extends typingsJapgolly.chevrotain.mod.GAstVisitor
    
    @JSGlobal("chevrotain.Lexer")
    @js.native
    open class Lexer protected ()
      extends typingsJapgolly.chevrotain.mod.Lexer {
      /**
    ...
    open class MismatchedTokenException protected ()
      extends typingsJapgolly.chevrotain.mod.MismatchedTokenException {
      def this(message: String, token: IToken, previousToken: IToken) = this()
    }
    ...
    open class NoViableAltException protected ()
      extends typingsJapgolly.chevrotain.mod.NoViableAltException {
      def this(message: String, token: IToken, previousToken: IToken) = this()
    }
    ...
    open class NonTerminal protected ()
      extends typingsJapgolly.chevrotain.mod.NonTerminal {
    ...
    open class NotAllInputParsedException protected ()
      extends typingsJapgolly.chevrotain.mod.NotAllInputParsedException {
    ...
    open class Option protected ()
      extends typingsJapgolly.chevrotain.mod.Option {
    ...
    open class Repetition protected ()
      extends typingsJapgolly.chevrotain.mod.Repetition {
      def this(options: Name) = this()
    }
    ...
    open class RepetitionMandatory protected ()
      extends typingsJapgolly.chevrotain.mod.RepetitionMandatory {
      def this(options: Name) = this()
    }
    ...
    open class RepetitionMandatoryWithSeparator protected ()
      extends typingsJapgolly.chevrotain.mod.RepetitionMandatoryWithSeparator {
    ...
    open class RepetitionWithSeparator protected ()
      extends typingsJapgolly.chevrotain.mod.RepetitionWithSeparator {
      def this(options: Separator) = this()
    }
    ...
    open class Rule protected ()
      extends typingsJapgolly.chevrotain.mod.Rule {
    ...
    open class Terminal protected ()
      extends typingsJapgolly.chevrotain.mod.Terminal {
