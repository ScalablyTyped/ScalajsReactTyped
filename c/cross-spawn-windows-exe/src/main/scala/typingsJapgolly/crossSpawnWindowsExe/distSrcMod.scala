...
import typingsJapgolly.crossSpawnWindowsExe.distSrcWrapperMod.DetermineWrapperFunction
...
object distSrcMod {
  ...
  open class WrapperError protected ()
    extends typingsJapgolly.crossSpawnWindowsExe.distSrcWrapperMod.WrapperError {
    /**
