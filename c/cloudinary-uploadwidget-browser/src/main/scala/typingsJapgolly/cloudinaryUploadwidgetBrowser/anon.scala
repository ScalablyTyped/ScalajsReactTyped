...
import typingsJapgolly.cloudinaryUploadwidgetBrowser.cloudinaryUploadwidgetBrowserStrings.INVALID_PUBLIC_ID
import typingsJapgolly.cloudinaryUploadwidgetBrowser.cloudinaryUploadwidgetBrowserStrings.MAX_EXCEEDED
import typingsJapgolly.cloudinaryUploadwidgetBrowser.cloudinaryUploadwidgetBrowserStrings.auto
import typingsJapgolly.cloudinaryUploadwidgetBrowser.cloudinaryUploadwidgetBrowserStrings.custom
import typingsJapgolly.cloudinaryUploadwidgetBrowser.cloudinaryUploadwidgetBrowserStrings.default
import typingsJapgolly.cloudinaryUploadwidgetBrowser.cloudinaryUploadwidgetBrowserStrings.face
...
object anon {
  ...
  trait PartialOmitCloudinaryUplo extends StObject {
    ...
    var defaultSource: js.UndefOr[typingsJapgolly.cloudinaryUploadwidgetBrowser.Source] = js.undefined
    ...
    var sources: js.UndefOr[js.Array[typingsJapgolly.cloudinaryUploadwidgetBrowser.Source]] = js.undefined
  ...
  object PartialOmitCloudinaryUplo {
    ...
    extension [Self <: PartialOmitCloudinaryUplo](x: Self) {
      ...
      inline def setDefaultSource(value: typingsJapgolly.cloudinaryUploadwidgetBrowser.Source): Self = StObject.set(x, "defaultSource", value.asInstanceOf[js.Any])
      ...
      inline def setGetUploadPresets(value: /* cb */ js.Function1[/* presets */ js.Array[String], Unit] => Callback): Self = StObject.set(x, "getUploadPresets", js.Any.fromFunction1((t0: /* cb */ js.Function1[/* presets */ js.Array[String], Unit]) => value(t0).runNow()))
      ...
      inline def setPrepareUploadParams(value: (/* cb */ js.Function1[/* results */ Any, Unit], /* params */ Any) => Callback): Self = StObject.set(x, "prepareUploadParams", js.Any.fromFunction2((t0: /* cb */ js.Function1[/* results */ Any, Unit], t1: /* params */ Any) => (value(t0, t1)).runNow()))
      ...
      inline def setSources(value: js.Array[typingsJapgolly.cloudinaryUploadwidgetBrowser.Source]): Self = StObject.set(x, "sources", value.asInstanceOf[js.Any])
      
      inline def setSourcesUndefined: Self = StObject.set(x, "sources", js.undefined)
      
      inline def setSourcesVarargs(value: typingsJapgolly.cloudinaryUploadwidgetBrowser.Source*): Self = StObject.set(x, "sources", js.Array(value*))
  ...
  object Source {
    ...
    inline def apply(source: String): typingsJapgolly.cloudinaryUploadwidgetBrowser.anon.Source = {
      val __obj = js.Dynamic.literal(source = source.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.cloudinaryUploadwidgetBrowser.anon.Source]
    }
    
    extension [Self <: typingsJapgolly.cloudinaryUploadwidgetBrowser.anon.Source](x: Self) {
