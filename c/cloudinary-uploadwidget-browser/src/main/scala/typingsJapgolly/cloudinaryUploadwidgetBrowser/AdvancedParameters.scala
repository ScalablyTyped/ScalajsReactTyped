...
import typingsJapgolly.cloudinaryUploadwidgetBrowser.anon.Cancel
...
object AdvancedParameters {
  ...
  extension [Self <: AdvancedParameters](x: Self) {
    ...
    inline def setGetTags(value: (/* cb */ js.Function1[/* tags */ js.Array[String], Unit], /* prefix */ String) => Callback): Self = StObject.set(x, "getTags", js.Any.fromFunction2((t0: /* cb */ js.Function1[/* tags */ js.Array[String], Unit], t1: /* prefix */ String) => (value(t0, t1)).runNow()))
    ...
    inline def setPreBatch(
      value: (/* cb */ js.Function1[/* options */ js.UndefOr[Cancel], Unit], /* data */ StringDictionary[Any]) => Callback
    ): Self = StObject.set(x, "preBatch", js.Any.fromFunction2((t0: /* cb */ js.Function1[/* options */ js.UndefOr[Cancel], Unit], t1: /* data */ StringDictionary[Any]) => (value(t0, t1)).runNow()))
