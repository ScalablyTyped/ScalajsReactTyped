...
import typingsJapgolly.cloudinaryUploadwidgetBrowser.anon.PartialOmitCloudinaryUplo
import typingsJapgolly.cloudinaryUploadwidgetBrowser.anon.Quiet
import typingsJapgolly.cloudinaryUploadwidgetBrowser.anon.RemoveThumbnails
