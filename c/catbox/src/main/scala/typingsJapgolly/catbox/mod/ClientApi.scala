package typingsJapgolly.catbox.mod
...
object ClientApi {
  ...
  def apply[T](
    ...
    __obj.updateDynamic("drop")(js.Any.fromFunction1((t0: typingsJapgolly.catbox.mod.CacheKey) => drop(t0).runNow()))
    __obj.updateDynamic("get")(js.Any.fromFunction1((t0: typingsJapgolly.catbox.mod.CacheKey) => get(t0).runNow()))
    __obj.updateDynamic("isReady")(isReady.toJsFn)
    __obj.updateDynamic("set")(js.Any.fromFunction3((t0: typingsJapgolly.catbox.mod.CacheKey, t1: T, t2: scala.Double) => set(t0, t1, t2).runNow()))
