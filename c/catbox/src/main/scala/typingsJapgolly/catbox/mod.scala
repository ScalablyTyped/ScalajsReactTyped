...
import typingsJapgolly.catbox.catboxBooleans.`false`
...
object mod {
  ...
  - typingsJapgolly.catbox.mod.PolicyOptionVariants because Already inherited */ trait DecoratedPolicyOptions[T]
    extends StObject
  ...
  type Id = String | typingsJapgolly.catbox.anon.Id
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.catbox.mod.PolicyOptions[T]
    - typingsJapgolly.catbox.mod.DecoratedPolicyOptions[T]
  */
  trait PolicyOptionVariants[T] extends StObject
  object PolicyOptionVariants {
    
    inline def DecoratedPolicyOptions[T](): typingsJapgolly.catbox.mod.DecoratedPolicyOptions[T] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.catbox.mod.DecoratedPolicyOptions[T]]
    }
    
    inline def PolicyOptions[T](): typingsJapgolly.catbox.mod.PolicyOptions[T] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.catbox.mod.PolicyOptions[T]]
    }
  }
