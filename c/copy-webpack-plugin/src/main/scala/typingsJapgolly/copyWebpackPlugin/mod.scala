...
import typingsJapgolly.copyWebpackPlugin.anon.AbsoluteFilename
import typingsJapgolly.copyWebpackPlugin.anon.Data
import typingsJapgolly.copyWebpackPlugin.anon.FnCall
import typingsJapgolly.globby.mod.Options
import typingsJapgolly.node.bufferMod.global.Buffer
import typingsJapgolly.std.Record
import typingsJapgolly.std.ReturnType
import typingsJapgolly.webpack.mod.Source
...
object mod {
  ...
  type CacheFacade = ReturnType[js.Function1[/* name */ String, typingsJapgolly.webpack.mod.CacheFacade]]
  ...
  object CopyPlugin {
    ...
    inline def apply(apply: Compiler => Callback, options: Any, patterns: Any): CopyPlugin = {
      val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1((t0: Compiler) => apply(t0).runNow()), options = options.asInstanceOf[js.Any], patterns = patterns.asInstanceOf[js.Any])
  ...
  type GlobEntry = typingsJapgolly.globby.mod.GlobEntry
  ...
  object ObjectPattern {
    ...
    extension [Self <: ObjectPattern](x: Self) {
      ...
      inline def setToFunction1(
        value: /* pathData */ typingsJapgolly.copyWebpackPlugin.anon.Context => String | js.Promise[String]
      ): Self = StObject.set(x, "to", js.Any.fromFunction1(value))
  ...
  type Snapshot = ReturnType[
    js.Function2[
      /* snapshot1 */ typingsJapgolly.webpack.mod.Snapshot, 
      /* snapshot2 */ typingsJapgolly.webpack.mod.Snapshot, 
      typingsJapgolly.webpack.mod.Snapshot
    ]
  ]
  ...
  type ToFunction = js.Function1[
    /* pathData */ typingsJapgolly.copyWebpackPlugin.anon.Context, 
    String | js.Promise[String]
  ]
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.copyWebpackPlugin.copyWebpackPluginStrings.dir
    - typingsJapgolly.copyWebpackPlugin.copyWebpackPluginStrings.file
    - typingsJapgolly.copyWebpackPlugin.copyWebpackPluginStrings.template
  */
  trait ToType extends StObject
  object ToType {
    
    inline def dir: typingsJapgolly.copyWebpackPlugin.copyWebpackPluginStrings.dir = "dir".asInstanceOf[typingsJapgolly.copyWebpackPlugin.copyWebpackPluginStrings.dir]
    
    inline def file: typingsJapgolly.copyWebpackPlugin.copyWebpackPluginStrings.file = "file".asInstanceOf[typingsJapgolly.copyWebpackPlugin.copyWebpackPluginStrings.file]
    
    inline def template: typingsJapgolly.copyWebpackPlugin.copyWebpackPluginStrings.template = "template".asInstanceOf[typingsJapgolly.copyWebpackPlugin.copyWebpackPluginStrings.template]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.copyWebpackPlugin.anon.Keys
    - typingsJapgolly.copyWebpackPlugin.anon.`0`
  */
  trait TransformerCacheObject extends StObject
  object TransformerCacheObject {
    
    inline def `0`(keys: (StringDictionary[Any], String) => js.Promise[StringDictionary[Any]]): typingsJapgolly.copyWebpackPlugin.anon.`0` = {
      val __obj = js.Dynamic.literal(keys = js.Any.fromFunction2(keys))
      __obj.asInstanceOf[typingsJapgolly.copyWebpackPlugin.anon.`0`]
    }
    
    inline def Keys(keys: StringDictionary[Any]): typingsJapgolly.copyWebpackPlugin.anon.Keys = {
      val __obj = js.Dynamic.literal(keys = keys.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.copyWebpackPlugin.anon.Keys]
    }
  }
