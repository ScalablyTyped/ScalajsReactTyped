...
object mod extends Shortcut {
  ...
  object TimeDataStatic {
    ...
    inline def apply(allowed: CallbackTo[String], preferred: CallbackTo[String]): TimeDataStatic = {
      val __obj = js.Dynamic.literal(allowed = allowed.toJsFn, preferred = preferred.toJsFn)
      __obj.asInstanceOf[TimeDataStatic]
    }
    
    extension [Self <: TimeDataStatic](x: Self) {
      
      inline def setAllowed(value: CallbackTo[String]): Self = StObject.set(x, "allowed", value.toJsFn)
      
      inline def setPreferred(value: CallbackTo[String]): Self = StObject.set(x, "preferred", value.toJsFn)
    }
  }
  ...
  object WeekDataStatic {
    ...
    inline def apply(firstDay: CallbackTo[String], minDays: CallbackTo[Double]): WeekDataStatic = {
      val __obj = js.Dynamic.literal(firstDay = firstDay.toJsFn, minDays = minDays.toJsFn)
      __obj.asInstanceOf[WeekDataStatic]
    }
    
    extension [Self <: WeekDataStatic](x: Self) {
      
      inline def setFirstDay(value: CallbackTo[String]): Self = StObject.set(x, "firstDay", value.toJsFn)
      
      inline def setMinDays(value: CallbackTo[Double]): Self = StObject.set(x, "minDays", value.toJsFn)
    }
  }
