...
/* Inlined csstype.csstype.Fallback<csstype.csstype.AtRule.FontFaceHyphen<TLength, TTime>> */
...
object FontFaceHyphenFallback {
  ...
  extension [Self <: FontFaceHyphenFallback[?, ?], TLength, TTime](x: Self & (FontFaceHyphenFallback[TLength, TTime])) {
