...
/* Inlined csstype.csstype.Fallback<csstype.csstype.ObsoleteProperties<TLength, TTime>> */
trait ObsoletePropertiesFallback[TLength, TTime] extends StObject {
  ...
  var MozBinding: js.UndefOr[
    typingsJapgolly.csstype.mod.Property.MozBinding | js.Array[NonNullable[js.UndefOr[typingsJapgolly.csstype.mod.Property.MozBinding]]]
  ] = js.undefined
  ...
  var MozFloatEdge: js.UndefOr[
    typingsJapgolly.csstype.mod.Property.MozFloatEdge | js.Array[NonNullable[js.UndefOr[typingsJapgolly.csstype.mod.Property.MozFloatEdge]]]
  ] = js.undefined
  
  var MozForceBrokenImageIcon: js.UndefOr[
    typingsJapgolly.csstype.mod.Property.MozForceBrokenImageIcon | (js.Array[
      NonNullable[js.UndefOr[typingsJapgolly.csstype.mod.Property.MozForceBrokenImageIcon]]
    ])
  ] = js.undefined
  ...
  var MozOutlineRadius: js.UndefOr[
    typingsJapgolly.csstype.mod.Property.MozOutlineRadius[TLength] | (js.Array[
      NonNullable[js.UndefOr[typingsJapgolly.csstype.mod.Property.MozOutlineRadius[TLength]]]
    ])
  ] = js.undefined
  
  var MozOutlineRadiusBottomleft: js.UndefOr[
    typingsJapgolly.csstype.mod.Property.MozOutlineRadiusBottomleft[TLength] | (js.Array[
      NonNullable[
        js.UndefOr[typingsJapgolly.csstype.mod.Property.MozOutlineRadiusBottomleft[TLength]]
      ]
    ])
  ] = js.undefined
  
  var MozOutlineRadiusBottomright: js.UndefOr[
    typingsJapgolly.csstype.mod.Property.MozOutlineRadiusBottomright[TLength] | (js.Array[
      NonNullable[
        js.UndefOr[typingsJapgolly.csstype.mod.Property.MozOutlineRadiusBottomright[TLength]]
      ]
    ])
  ] = js.undefined
  
  var MozOutlineRadiusTopleft: js.UndefOr[
    typingsJapgolly.csstype.mod.Property.MozOutlineRadiusTopleft[TLength] | (js.Array[
      NonNullable[
        js.UndefOr[typingsJapgolly.csstype.mod.Property.MozOutlineRadiusTopleft[TLength]]
      ]
    ])
  ] = js.undefined
  
  var MozOutlineRadiusTopright: js.UndefOr[
    typingsJapgolly.csstype.mod.Property.MozOutlineRadiusTopright[TLength] | (js.Array[
      NonNullable[
        js.UndefOr[typingsJapgolly.csstype.mod.Property.MozOutlineRadiusTopright[TLength]]
      ]
    ])
  ] = js.undefined
  ...
  var MozUserInput: js.UndefOr[
    typingsJapgolly.csstype.mod.Property.MozUserInput | js.Array[NonNullable[js.UndefOr[typingsJapgolly.csstype.mod.Property.MozUserInput]]]
  ] = js.undefined
  
  var OAnimation: js.UndefOr[Animation[TTime] | js.Array[NonNullable[js.UndefOr[Animation[TTime]]]]] = js.undefined
  
  var OAnimationDelay: js.UndefOr[AnimationDelay[TTime] | js.Array[NonNullable[js.UndefOr[AnimationDelay[TTime]]]]] = js.undefined
  ...
  var OTransition: js.UndefOr[Transition[TTime] | js.Array[NonNullable[js.UndefOr[Transition[TTime]]]]] = js.undefined
...
object ObsoletePropertiesFallback {
  ...
  inline def apply[TLength, TTime](): ObsoletePropertiesFallback[TLength, TTime] = {
  ...
  extension [Self <: ObsoletePropertiesFallback[?, ?], TLength, TTime](x: Self & (ObsoletePropertiesFallback[TLength, TTime])) {
    ...
    inline def setOAnimation(value: Animation[TTime] | js.Array[NonNullable[js.UndefOr[Animation[TTime]]]]): Self = StObject.set(x, "OAnimation", value.asInstanceOf[js.Any])
    
    inline def setOAnimationDelay(value: AnimationDelay[TTime] | js.Array[NonNullable[js.UndefOr[AnimationDelay[TTime]]]]): Self = StObject.set(x, "OAnimationDelay", value.asInstanceOf[js.Any])
    
    inline def setOAnimationDelayUndefined: Self = StObject.set(x, "OAnimationDelay", js.undefined)
    
    inline def setOAnimationDelayVarargs(value: NonNullable[js.UndefOr[AnimationDelay[TTime]]]*): Self = StObject.set(x, "OAnimationDelay", js.Array(value*))
    ...
    inline def setOAnimationDuration(value: AnimationDuration[TTime] | js.Array[NonNullable[js.UndefOr[AnimationDuration[TTime]]]]): Self = StObject.set(x, "OAnimationDuration", value.asInstanceOf[js.Any])
    
    inline def setOAnimationDurationUndefined: Self = StObject.set(x, "OAnimationDuration", js.undefined)
    
    inline def setOAnimationDurationVarargs(value: NonNullable[js.UndefOr[AnimationDuration[TTime]]]*): Self = StObject.set(x, "OAnimationDuration", js.Array(value*))
    ...
    inline def setOAnimationVarargs(value: NonNullable[js.UndefOr[Animation[TTime]]]*): Self = StObject.set(x, "OAnimation", js.Array(value*))
    ...
    inline def setOTransition(value: Transition[TTime] | js.Array[NonNullable[js.UndefOr[Transition[TTime]]]]): Self = StObject.set(x, "OTransition", value.asInstanceOf[js.Any])
    
    inline def setOTransitionDelay(value: TransitionDelay[TTime] | js.Array[NonNullable[js.UndefOr[TransitionDelay[TTime]]]]): Self = StObject.set(x, "OTransitionDelay", value.asInstanceOf[js.Any])
    
    inline def setOTransitionDelayUndefined: Self = StObject.set(x, "OTransitionDelay", js.undefined)
    
    inline def setOTransitionDelayVarargs(value: NonNullable[js.UndefOr[TransitionDelay[TTime]]]*): Self = StObject.set(x, "OTransitionDelay", js.Array(value*))
    
    inline def setOTransitionDuration(value: TransitionDuration[TTime] | js.Array[NonNullable[js.UndefOr[TransitionDuration[TTime]]]]): Self = StObject.set(x, "OTransitionDuration", value.asInstanceOf[js.Any])
    
    inline def setOTransitionDurationUndefined: Self = StObject.set(x, "OTransitionDuration", js.undefined)
    
    inline def setOTransitionDurationVarargs(value: NonNullable[js.UndefOr[TransitionDuration[TTime]]]*): Self = StObject.set(x, "OTransitionDuration", js.Array(value*))
    ...
    inline def setOTransitionVarargs(value: NonNullable[js.UndefOr[Transition[TTime]]]*): Self = StObject.set(x, "OTransition", js.Array(value*))
