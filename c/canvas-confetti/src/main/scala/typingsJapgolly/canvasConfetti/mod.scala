...
object mod {
  ...
  */
  ...
  object shape {
    ...
    inline def circle: typingsJapgolly.canvasConfetti.canvasConfettiStrings.circle = "circle".asInstanceOf[typingsJapgolly.canvasConfetti.canvasConfettiStrings.circle]
    
    inline def square: typingsJapgolly.canvasConfetti.canvasConfettiStrings.square = "square".asInstanceOf[typingsJapgolly.canvasConfetti.canvasConfettiStrings.square]
  }
}
