...
object SinonMapMatcher {
  ...
  def apply(
    ...
    __obj.updateDynamic("contains")(js.Any.fromFunction1((t0: typingsJapgolly.cypress.sinonMod.SimplifiedMap) => contains(t0).runNow()))
    __obj.updateDynamic("deepEquals")(js.Any.fromFunction1((t0: typingsJapgolly.cypress.sinonMod.SimplifiedMap) => deepEquals(t0).runNow()))
