...
trait LodashFill1x4[T] extends StObject {
  ...
  def apply[U](start: Double, end: Double, array: typingsJapgolly.cypress.typesLodashMod.List[U]): typingsJapgolly.cypress.typesLodashMod.List[T | U] = js.native
  ...
  def apply[U](start: Double, end: __, array: typingsJapgolly.cypress.typesLodashMod.List[U]): LodashFill2x13[T, U] = js.native
  def apply[U](start: __, end: Double, array: js.Array[U]): LodashFill1x14[T, U] = js.native
  def apply[U](start: __, end: Double, array: typingsJapgolly.cypress.typesLodashMod.List[U]): LodashFill2x14[T, U] = js.native
  ...
  def apply[U](start: __, end: __, array: typingsJapgolly.cypress.typesLodashMod.List[U]): LodashFill2x12[T, U] = js.native
}
