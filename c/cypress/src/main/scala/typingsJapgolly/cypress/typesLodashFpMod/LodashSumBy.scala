...
trait LodashSumBy extends StObject {
  ...
  def apply[T](iteratee: String, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): Double = js.native
  ...
  def apply[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSumBy1x2[T] = js.native
}
