...
@js.native
trait LodashZipWith1x4[T2] extends StObject {
  
  def apply[T1](iteratee: __, arrays1: typingsJapgolly.cypress.typesLodashMod.List[T1]): LodashZipWith1x6[T1, T2] = js.native
