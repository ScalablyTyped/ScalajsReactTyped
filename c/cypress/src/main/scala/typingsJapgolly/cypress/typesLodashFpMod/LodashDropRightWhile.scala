...
@js.native
trait LodashDropRightWhile extends StObject {
  
  def apply[T](predicate: ValueIteratee[T]): js.Array[T] = js.native
  def apply[T](predicate: ValueIteratee[T], array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T] = js.native
  def apply[T](predicate: __): LodashDropRightWhile1x2[T] = js.native
  def apply[T](predicate: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashDropRightWhile1x2[T] = js.native
}
