...
trait LodashPullAllBy1x2[T] extends StObject {
  ...
  def apply(iteratee: ValueIteratee[T], array: typingsJapgolly.cypress.typesLodashMod.List[T]): typingsJapgolly.cypress.typesLodashMod.List[T] = js.native
  def apply(iteratee: __, array: js.Array[T]): LodashPullAllBy1x6[T] = js.native
  def apply(iteratee: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPullAllBy2x6[T] = js.native
}
