...
trait LodashBindKey extends StObject {
  ...
  def placeholder(): typingsJapgolly.cypress.typesLodashMod.String = js.native
  def placeholder(value: String): typingsJapgolly.cypress.typesLodashMod.String = js.native
  ...
  /**
    ...
    **/
  @JSName("placeholder")
  def placeholder_TrapAny_Intersection[TrapAny /* <: typingsJapgolly.cypress.anon.TrapAny */](value: TrapAny): Collection[Any] & Function[Any] & Object[Any] & Primitive[Any] & typingsJapgolly.cypress.typesLodashMod.String = js.native
}
