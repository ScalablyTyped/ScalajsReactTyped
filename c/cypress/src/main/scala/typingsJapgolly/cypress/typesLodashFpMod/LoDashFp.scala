...
import typingsJapgolly.cypress.anon.LodashAnyHack
import typingsJapgolly.cypress.anon.TypeofcypressTypesLodas
import typingsJapgolly.cypress.cypressBooleans.`false`
import typingsJapgolly.cypress.cypressBooleans.`true`
import typingsJapgolly.cypress.cypressInts.`0`
import typingsJapgolly.cypress.cypressStrings._empty
...
import typingsJapgolly.cypress.typesLodashMod.CloneDeepWithCustomizer
import typingsJapgolly.cypress.typesLodashMod.CloneWithCustomizer
import typingsJapgolly.cypress.typesLodashMod.Collection
import typingsJapgolly.cypress.typesLodashMod.Comparator
import typingsJapgolly.cypress.typesLodashMod.Comparator2
import typingsJapgolly.cypress.typesLodashMod.CondPair
import typingsJapgolly.cypress.typesLodashMod.ConformsPredicateObject
import typingsJapgolly.cypress.typesLodashMod.CurriedFunction1
import typingsJapgolly.cypress.typesLodashMod.CurriedFunction2
import typingsJapgolly.cypress.typesLodashMod.CurriedFunction3
import typingsJapgolly.cypress.typesLodashMod.CurriedFunction4
import typingsJapgolly.cypress.typesLodashMod.CurriedFunction5
import typingsJapgolly.cypress.typesLodashMod.DebouncedFunc
import typingsJapgolly.cypress.typesLodashMod.Dictionary
import typingsJapgolly.cypress.typesLodashMod.Function
import typingsJapgolly.cypress.typesLodashMod.Function0
...
import typingsJapgolly.cypress.typesLodashMod.FunctionBase
import typingsJapgolly.cypress.typesLodashMod.IsEqualCustomizer
import typingsJapgolly.cypress.typesLodashMod.ListOfRecursiveArraysOrValues
import typingsJapgolly.cypress.typesLodashMod.LoDashStatic
...
import typingsJapgolly.cypress.typesLodashMod.MergeWithCustomizer
import typingsJapgolly.cypress.typesLodashMod.NotVoid
import typingsJapgolly.cypress.typesLodashMod.NumericDictionary
import typingsJapgolly.cypress.typesLodashMod.Object
import typingsJapgolly.cypress.typesLodashMod.Omit
import typingsJapgolly.cypress.typesLodashMod.PartialObject
import typingsJapgolly.cypress.typesLodashMod.Primitive
import typingsJapgolly.cypress.typesLodashMod.PropertyName
import typingsJapgolly.cypress.typesLodashMod.PropertyPath
import typingsJapgolly.cypress.typesLodashMod.ReplaceFunction
import typingsJapgolly.cypress.typesLodashMod.RightCurriedFunction1
import typingsJapgolly.cypress.typesLodashMod.RightCurriedFunction2
import typingsJapgolly.cypress.typesLodashMod.RightCurriedFunction3
import typingsJapgolly.cypress.typesLodashMod.RightCurriedFunction4
import typingsJapgolly.cypress.typesLodashMod.RightCurriedFunction5
import typingsJapgolly.cypress.typesLodashMod.SetWithCustomizer
import typingsJapgolly.cypress.typesLodashMod.String
import typingsJapgolly.cypress.typesLodashMod.TemplateExecutor
import typingsJapgolly.cypress.typesLodashMod.TruncateOptions
...
import typingsJapgolly.cypress.typesLodashMod.isMatchWithCustomizer
...
trait LoDashFp extends StObject {
  ...
  def __[T](value: typingsJapgolly.cypress.typesLodashMod.List[T]): Collection[T]
  @JSName("__")
  var ___Original: __
  @JSName("__")
  ...
  /**
    ...
    **/
  @JSName("__")
  def ___TrapAny_Intersection[TrapAny /* <: typingsJapgolly.cypress.anon.TrapAny */](value: TrapAny): Collection[Any] & Function[Any] & Object[Any] & Primitive[Any] & String
  ...
  def all[T](predicate: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashEvery1x2[T]
  ...
  def any[T](predicate: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSome1x2[T]
  ...
  def chunk[T](size: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[js.Array[T]]
  def chunk[T](size: __): LodashChunk1x2[T]
  def chunk[T](size: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashChunk1x2[T]
  @JSName("chunk")
  ...
  def compact[T](array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[Exclude[T, js.UndefOr[Null | `false` | _empty | `0`]]]
  @JSName("compact")
  ...
  def countBy[T](iteratee: ValueIteratee[T], collection: typingsJapgolly.cypress.typesLodashMod.List[T]): Dictionary[Double]
  def countBy[T](iteratee: __): LodashCountBy1x2[T]
  def countBy[T /* <: js.Object */](iteratee: __, collection: T): LodashCountBy2x2[T]
  def countBy[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashCountBy1x2[T]
  @JSName("countBy")
  var countBy_Original: LodashCountBy
  @JSName("countBy")
  def countBy_T_LodashCountBy1x1[T](iteratee: ValueIteratee[T]): LodashCountBy1x1[T]
  @JSName("countBy")
  def countBy_T_LodashCountBy2x2[T /* <: js.Object */](iteratee: __): LodashCountBy2x2[T]
  ...
  def defaultTo[TDefault](defaultValue: TDefault): LodashDefaultTo2x1[TDefault]
  ...
  @JSName("defaultTo")
  def defaultTo_T_LodashDefaultTo1x1[T](defaultValue: T): LodashDefaultTo1x1[T]
  @JSName("defaultTo")
  ...
  def difference[T](array: Null, values: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def difference[T](array: Unit, values: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def difference[T](array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashDifference1x1[T]
  def difference[T](
    array: typingsJapgolly.cypress.typesLodashMod.List[T],
    values: typingsJapgolly.cypress.typesLodashMod.List[T]
  ): js.Array[T]
  def difference[T](array: __, values: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashDifference1x2[T]
  
  def differenceBy[T1](iteratee: __): LodashDifferenceBy1x2[T1]
  def differenceBy[T1](iteratee: __, array: typingsJapgolly.cypress.typesLodashMod.List[T1]): LodashDifferenceBy1x2[T1]
  def differenceBy[T2](iteratee: __, array: __, values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashDifferenceBy1x4[T2]
  def differenceBy[T1, T2](iteratee: ValueIteratee[T1 | T2]): LodashDifferenceBy1x1[T1, T2]
  ...
  def differenceBy[T1, T2](iteratee: ValueIteratee[T1 | T2], array: typingsJapgolly.cypress.typesLodashMod.List[T1]): LodashDifferenceBy1x3[T1, T2]
  def differenceBy[T1, T2](
    iteratee: ValueIteratee[T1 | T2],
  ...
  def differenceBy[T1, T2](iteratee: __, array: Null, values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashDifferenceBy1x6[T1, T2]
  def differenceBy[T1, T2](iteratee: __, array: Unit, values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashDifferenceBy1x6[T1, T2]
  def differenceBy[T1, T2](
    iteratee: __,
    array: typingsJapgolly.cypress.typesLodashMod.List[T1],
    values: typingsJapgolly.cypress.typesLodashMod.List[T2]
  ...
  @JSName("differenceBy")
  def differenceBy_T1T2_LodashDifferenceBy1x3[T1, T2](iteratee: ValueIteratee[T1 | T2]): LodashDifferenceBy1x3[T1, T2]
  
  def differenceWith[T1](comparator: __): LodashDifferenceWith1x2[T1]
  def differenceWith[T1](comparator: __, array: typingsJapgolly.cypress.typesLodashMod.List[T1]): LodashDifferenceWith1x2[T1]
  def differenceWith[T2](comparator: __, array: __, values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashDifferenceWith1x4[T2]
  def differenceWith[T1, T2](comparator: Comparator2[T1, T2]): LodashDifferenceWith1x3[T1, T2]
  ...
  def differenceWith[T1, T2](comparator: Comparator2[T1, T2], array: typingsJapgolly.cypress.typesLodashMod.List[T1]): LodashDifferenceWith1x3[T1, T2]
  def differenceWith[T1, T2](
    comparator: Comparator2[T1, T2],
    array: typingsJapgolly.cypress.typesLodashMod.List[T1],
    values: typingsJapgolly.cypress.typesLodashMod.List[T2]
  ...
  def differenceWith[T1, T2](comparator: __, array: Null, values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashDifferenceWith1x6[T1, T2]
  def differenceWith[T1, T2](comparator: __, array: Unit, values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashDifferenceWith1x6[T1, T2]
  def differenceWith[T1, T2](
    comparator: __,
    array: typingsJapgolly.cypress.typesLodashMod.List[T1],
    values: typingsJapgolly.cypress.typesLodashMod.List[T2]
  ...
  @JSName("differenceWith")
  def differenceWith_T1T2_LodashDifferenceWith1x1[T1, T2](comparator: Comparator2[T1, T2]): LodashDifferenceWith1x1[T1, T2]
  ...
  def drop[T](n: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def drop[T](n: __): LodashDrop1x2[T]
  def drop[T](n: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashDrop1x2[T]
  
  def dropLast(n: Double): LodashDropRight1x1
  def dropLast[T](n: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def dropLast[T](n: __): LodashDropRight1x2[T]
  def dropLast[T](n: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashDropRight1x2[T]
  
  def dropLastWhile[T](predicate: ValueIteratee[T]): js.Array[T]
  def dropLastWhile[T](predicate: ValueIteratee[T], array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def dropLastWhile[T](predicate: __): LodashDropRightWhile1x2[T]
  def dropLastWhile[T](predicate: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashDropRightWhile1x2[T]
  ...
  def dropRight[T](n: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def dropRight[T](n: __): LodashDropRight1x2[T]
  def dropRight[T](n: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashDropRight1x2[T]
  
  def dropRightWhile[T](predicate: ValueIteratee[T]): js.Array[T]
  def dropRightWhile[T](predicate: ValueIteratee[T], array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def dropRightWhile[T](predicate: __): LodashDropRightWhile1x2[T]
  def dropRightWhile[T](predicate: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashDropRightWhile1x2[T]
  ...
  def dropWhile[T](predicate: ValueIteratee[T], array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def dropWhile[T](predicate: __): LodashDropWhile1x2[T]
  def dropWhile[T](predicate: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashDropWhile1x2[T]
  @JSName("dropWhile")
  ...
  def each[T](
    ...
    collection: typingsJapgolly.cypress.typesLodashMod.List[T]
  ): typingsJapgolly.cypress.typesLodashMod.List[T]
  ...
  def each[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashForEach2x2[T]
  ...
  def eachRight[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashForEachRight2x2[T]
  ...
  def eachRight[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: __, collection: Unit & TList): LodashForEachRight5x2[T, TList]
  def eachRight[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: __, collection: Null & TList): LodashForEachRight5x2[T, TList]
  @JSName("eachRight")
  ...
  @JSName("eachRight")
  def eachRight_TTList_LodashForEachRight5x2[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T] & TList): LodashForEachRight5x2[T, TList]
  @JSName("eachRight")
  def eachRight_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Unit & TList): TList
  @JSName("eachRight")
  def eachRight_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](
    iteratee: js.Function1[/* value */ T, Any],
    collection: typingsJapgolly.cypress.typesLodashMod.List[T] & TList
  ): TList
  @JSName("eachRight")
  def eachRight_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Null & TList): TList
  @JSName("eachRight")
  ...
  @JSName("eachRight")
  def eachRight_T_Union[T /* <: js.Object */](
    iteratee: js.Function1[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ /* value */ js.Any, 
      Any
    ]
  ...
  @JSName("each")
  def each_TTList_LodashForEach5x2[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: __, collection: Null & TList): LodashForEach5x2[T, TList]
  @JSName("each")
  def each_TTList_LodashForEach5x2[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: __, collection: Unit & TList): LodashForEach5x2[T, TList]
  @JSName("each")
  def each_TTList_LodashForEach5x2[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T] & TList): LodashForEach5x2[T, TList]
  @JSName("each")
  def each_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Unit & TList): TList
  @JSName("each")
  def each_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](
    iteratee: js.Function1[/* value */ T, Any],
    collection: typingsJapgolly.cypress.typesLodashMod.List[T] & TList
  ): TList
  @JSName("each")
  def each_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Null & TList): TList
  @JSName("each")
  def each_T_LodashForEach6x2[T /* <: js.Object */](iteratee: __, collection: T): LodashForEach6x2[T]
  @JSName("each")
  ...
  def every[T](predicate: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashEvery1x2[T]
  @JSName("every")
  ...
  def fill[U](start: Double, end: Double, value: __): LodashFill1x11[U]
  def fill[U](start: Double, end: Double, value: __, array: js.Array[U]): LodashFill1x11[U]
  def fill[U](start: Double, end: Double, value: __, array: typingsJapgolly.cypress.typesLodashMod.List[U]): LodashFill2x11[U]
  ...
  def fill[U](start: Double, end: __, value: __, array: typingsJapgolly.cypress.typesLodashMod.List[U]): LodashFill2x9[U]
  ...
  def fill[U](start: __, end: Double, value: __, array: typingsJapgolly.cypress.typesLodashMod.List[U]): LodashFill2x10[U]
  def fill[T](start: __, end: __, value: T): LodashFill1x4[T]
  def fill[U](start: __, end: __, value: __): LodashFill2x8[U]
  def fill[U](start: __, end: __, value: __, array: js.Array[U]): LodashFill1x8[U]
  def fill[U](start: __, end: __, value: __, array: typingsJapgolly.cypress.typesLodashMod.List[U]): LodashFill2x8[U]
  def fill[T, U](start: Double, end: Double, value: T, array: js.Array[U]): js.Array[T | U]
  def fill[T, U](start: Double, end: Double, value: T, array: typingsJapgolly.cypress.typesLodashMod.List[U]): typingsJapgolly.cypress.typesLodashMod.List[T | U]
  def fill[T, U](start: Double, end: __, value: T, array: js.Array[U]): LodashFill1x13[T, U]
  def fill[T, U](start: Double, end: __, value: T, array: typingsJapgolly.cypress.typesLodashMod.List[U]): LodashFill2x13[T, U]
  def fill[T, U](start: __, end: Double, value: T, array: js.Array[U]): LodashFill1x14[T, U]
  def fill[T, U](start: __, end: Double, value: T, array: typingsJapgolly.cypress.typesLodashMod.List[U]): LodashFill2x14[T, U]
  def fill[T, U](start: __, end: __, value: T, array: js.Array[U]): LodashFill1x12[T, U]
  def fill[T, U](start: __, end: __, value: T, array: typingsJapgolly.cypress.typesLodashMod.List[U]): LodashFill2x12[T, U]
  @JSName("fill")
  var fill_Original: LodashFill
  @JSName("fill")
  def fill_TU_Array[T, U](start: Double, end: Double, value: T): js.Array[T | U]
  @JSName("fill")
  def fill_TU_List[T, U](start: Double, end: Double, value: T): typingsJapgolly.cypress.typesLodashMod.List[T | U]
  @JSName("fill")
  ...
  @JSName("fill")
  def fill_U_LodashFill1x8[U](start: __, end: __, value: __): LodashFill1x8[U]
  @JSName("fill")
  def fill_U_LodashFill2x10[U](start: __, end: Double, value: __): LodashFill2x10[U]
  @JSName("fill")
  def fill_U_LodashFill2x11[U](start: Double, end: Double, value: __): LodashFill2x11[U]
  @JSName("fill")
  def fill_U_LodashFill2x9[U](start: Double, end: __, value: __): LodashFill2x9[U]
  
  def filter[T](predicate: ValueIterateeCustom[T, Boolean]): LodashFilter2x1[T]
  ...
  def filter[T](predicate: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFilter1x2[T]
  def filter[T, S /* <: T */](
  ...
  def find[T](predicate: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFind1x2[T]
  ...
  def findFrom[T](predicate: __, fromIndex: Double, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFindFrom1x6[T]
  def findFrom[T](predicate: __, fromIndex: __): LodashFindFrom1x4[T]
  def findFrom[T /* <: js.Object */](predicate: __, fromIndex: __, collection: T): LodashFindFrom3x4[T]
  def findFrom[T](predicate: __, fromIndex: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFindFrom1x4[T]
  ...
  @JSName("findFrom")
  def findFrom_TS_LodashFindFrom1x3[T, S /* <: T */](predicate: ValueIteratorTypeGuard[T, S], fromIndex: Double): LodashFindFrom1x3[T, S]
  @JSName("findFrom")
  ...
  @JSName("findFrom")
  def findFrom_T_LodashFindFrom3x4[T /* <: js.Object */](predicate: __, fromIndex: __): LodashFindFrom3x4[T]
  @JSName("findFrom")
  ...
  def findIndex[T](predicate: ValueIterateeCustom[T, Boolean]): LodashFindIndex1x1[T]
  def findIndex[T](predicate: ValueIterateeCustom[T, Boolean], array: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  def findIndex[T](predicate: __): LodashFindIndex1x2[T]
  def findIndex[T](predicate: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFindIndex1x2[T]
  ...
  def findIndexFrom[T](predicate: ValueIterateeCustom[T, Boolean], fromIndex: Double): LodashFindIndexFrom1x3[T]
  def findIndexFrom[T](
    predicate: ValueIterateeCustom[T, Boolean],
    fromIndex: Double,
    array: typingsJapgolly.cypress.typesLodashMod.List[T]
  ...
  def findIndexFrom[T](predicate: __, fromIndex: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFindIndexFrom1x6[T]
  def findIndexFrom[T](predicate: __, fromIndex: __): LodashFindIndexFrom1x4[T]
  def findIndexFrom[T](predicate: __, fromIndex: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFindIndexFrom1x4[T]
  @JSName("findIndexFrom")
  var findIndexFrom_Original: LodashFindIndexFrom
  @JSName("findIndexFrom")
  def findIndexFrom_T_Double[T](predicate: ValueIterateeCustom[T, Boolean], fromIndex: Double): Double
  @JSName("findIndexFrom")
  ...
  @JSName("findIndex")
  def findIndex_T_Double[T](predicate: ValueIterateeCustom[T, Boolean]): Double
  ...
  def findLast[T /* <: js.Object */](predicate: __): LodashFindLast3x2[T]
  def findLast[T /* <: js.Object */](predicate: __, collection: T): LodashFindLast3x2[T]
  def findLast[T](predicate: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFindLast1x2[T]
  ...
  def findLastFrom[T](predicate: __, fromIndex: Double, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFindLastFrom1x6[T]
  ...
  def findLastFrom[T](predicate: __, fromIndex: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFindLastFrom1x4[T]
  ...
  def findLastFrom[T, S /* <: T */](predicate: ValueIteratorTypeGuard[T, S], fromIndex: __): LodashFindLastFrom1x5[S]
  def findLastFrom[T /* <: js.Object */, S /* <: /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any */](
    predicate: ValueIteratorTypeGuard[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      S
  ...
  @JSName("findLastFrom")
  def findLastFrom_TS_LodashFindLastFrom3x5[T /* <: js.Object */, S /* <: /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any */](
    predicate: ValueIteratorTypeGuard[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      S
    ],
  ...
  def findLastIndex[T](predicate: ValueIterateeCustom[T, Boolean]): Double
  def findLastIndex[T](predicate: ValueIterateeCustom[T, Boolean], array: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  def findLastIndex[T](predicate: __): LodashFindLastIndex1x2[T]
  def findLastIndex[T](predicate: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFindLastIndex1x2[T]
  ...
  def findLastIndexFrom[T](predicate: ValueIterateeCustom[T, Boolean], fromIndex: Double): Double
  ...
  def findLastIndexFrom[T](predicate: __, fromIndex: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFindLastIndexFrom1x6[T]
  def findLastIndexFrom[T](predicate: __, fromIndex: __): LodashFindLastIndexFrom1x4[T]
  def findLastIndexFrom[T](predicate: __, fromIndex: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFindLastIndexFrom1x4[T]
  @JSName("findLastIndexFrom")
  var findLastIndexFrom_Original: LodashFindLastIndexFrom
  @JSName("findLastIndexFrom")
  def findLastIndexFrom_T_LodashFindLastIndexFrom1x3[T](predicate: ValueIterateeCustom[T, Boolean], fromIndex: Double): LodashFindLastIndexFrom1x3[T]
  @JSName("findLastIndexFrom")
  ...
  @JSName("findLastIndex")
  def findLastIndex_T_LodashFindLastIndex1x1[T](predicate: ValueIterateeCustom[T, Boolean]): LodashFindLastIndex1x1[T]
  ...
  @JSName("findLast")
  def findLast_T_LodashFindLast1x2[T](predicate: __): LodashFindLast1x2[T]
  @JSName("findLast")
  ...
  @JSName("find")
  def find_TS_LodashFind1x1[T, S /* <: T */](predicate: ValueIteratorTypeGuard[T, S]): LodashFind1x1[T, S]
  @JSName("find")
  ...
  def first[T](array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.UndefOr[T]
  @JSName("first")
  ...
  def flatMap[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFlatMap1x2[T]
  ...
  def flatMapDeep[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFlatMapDeep1x2[T]
  ...
  def flatMapDepth(iteratee: __, depth: Double): LodashFlatMapDepth1x2
  ...
  def flatMapDepth[T](iteratee: __, depth: Double, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFlatMapDepth1x6[T]
  def flatMapDepth[T /* <: js.Object */](iteratee: __, depth: __, collection: T): LodashFlatMapDepth2x4[T]
  def flatMapDepth[T](iteratee: __, depth: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashFlatMapDepth1x4[T]
  ...
  @JSName("flatMapDepth")
  def flatMapDepth_LodashFlatMapDepth3x6(iteratee: __, depth: Double): LodashFlatMapDepth3x6
  @JSName("flatMapDepth")
  ...
  @JSName("flatMapDepth")
  def flatMapDepth_TTResult_LodashFlatMapDepth1x5[T, TResult](iteratee: js.Function1[/* value */ T, ListOfRecursiveArraysOrValues[TResult] | TResult], depth: __): LodashFlatMapDepth1x5[TResult]
  @JSName("flatMapDepth")
  ...
  def flatten[T](array: typingsJapgolly.cypress.typesLodashMod.List[Many[T]]): js.Array[T]
  ...
  def forEach[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashForEach2x2[T]
  ...
  def forEachRight[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashForEachRight2x2[T]
  ...
  def forEachRight[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: __, collection: Null & TList): LodashForEachRight5x2[T, TList]
  def forEachRight[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: __, collection: Unit & TList): LodashForEachRight5x2[T, TList]
  @JSName("forEachRight")
  ...
  @JSName("forEachRight")
  def forEachRight_TTList_LodashForEachRight5x2[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T] & TList): LodashForEachRight5x2[T, TList]
  @JSName("forEachRight")
  def forEachRight_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](
    iteratee: js.Function1[/* value */ T, Any],
    collection: typingsJapgolly.cypress.typesLodashMod.List[T] & TList
  ): TList
  @JSName("forEachRight")
  def forEachRight_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Null & TList): TList
  @JSName("forEachRight")
  def forEachRight_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Unit & TList): TList
  @JSName("forEachRight")
  ...
  @JSName("forEachRight")
  def forEachRight_T_Union[T /* <: js.Object */](
    iteratee: js.Function1[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ /* value */ js.Any, 
      Any
    ]
  ...
  @JSName("forEach")
  def forEach_TTList_LodashForEach5x2[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: __, collection: Unit & TList): LodashForEach5x2[T, TList]
  @JSName("forEach")
  def forEach_TTList_LodashForEach5x2[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: __, collection: Null & TList): LodashForEach5x2[T, TList]
  @JSName("forEach")
  def forEach_TTList_LodashForEach5x2[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T] & TList): LodashForEach5x2[T, TList]
  @JSName("forEach")
  def forEach_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Null & TList): TList
  @JSName("forEach")
  def forEach_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Unit & TList): TList
  @JSName("forEach")
  def forEach_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null] */](
    iteratee: js.Function1[/* value */ T, Any],
    collection: typingsJapgolly.cypress.typesLodashMod.List[T] & TList
  ): TList
  @JSName("forEach")
  def forEach_T_LodashForEach6x2[T /* <: js.Object */](iteratee: __, collection: T): LodashForEach6x2[T]
  @JSName("forEach")
  ...
  def forIn[T](iteratee: js.Function1[/* value */ T, Any]): LodashForIn1x1[T]
  def forIn[T](
    iteratee: js.Function1[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ /* value */ js.Any, 
      Any
  ...
  def forIn[T](iteratee: __, `object`: T): LodashForIn1x2[T]
  
  def forInRight[T](iteratee: js.Function1[/* value */ T, Any]): LodashForInRight1x1[T]
  def forInRight[T](
    iteratee: js.Function1[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ /* value */ js.Any, 
      Any
  ...
  def forOwn[T](iteratee: js.Function1[/* value */ T, Any]): LodashForOwn1x1[T]
  def forOwn[T](
    iteratee: js.Function1[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ /* value */ js.Any, 
      Any
  ...
  def fromPairs(pairs: typingsJapgolly.cypress.typesLodashMod.List[js.Array[Any]]): Dictionary[Any]
  @JSName("fromPairs")
  var fromPairs_Original: LodashFromPairs
  @JSName("fromPairs")
  def fromPairs_T[T](): Dictionary[T]
  @JSName("fromPairs")
  def fromPairs_T[T](pairs: typingsJapgolly.cypress.typesLodashMod.List[js.Tuple2[PropertyName, T]]): Dictionary[T]
  ...
  def groupBy[T](iteratee: ValueIteratee[T], collection: typingsJapgolly.cypress.typesLodashMod.List[T]): Dictionary[js.Array[T]]
  def groupBy[T](iteratee: __): LodashGroupBy1x2[T]
  def groupBy[T /* <: js.Object */](iteratee: __, collection: T): LodashGroupBy2x2[T]
  def groupBy[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashGroupBy1x2[T]
  @JSName("groupBy")
  var groupBy_Original: LodashGroupBy
  @JSName("groupBy")
  def groupBy_T_LodashGroupBy1x1[T](iteratee: ValueIteratee[T]): LodashGroupBy1x1[T]
  @JSName("groupBy")
  ...
  def head[T](array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.UndefOr[T]
  @JSName("head")
  ...
  def includes[T](target: T): Boolean
  ...
  @JSName("includes")
  def includes_T_LodashIncludes1x1[T](target: T): LodashIncludes1x1[T]
  ...
  def indexBy[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashKeyBy1x2[T]
  @JSName("indexBy")
  ...
  def indexOf[T](value: T): LodashIndexOf1x1[T]
  def indexOf[T](value: T, array: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  def indexOf[T](value: __): LodashIndexOf1x2[T]
  def indexOf[T](value: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashIndexOf1x2[T]
  ...
  def indexOfFrom[T](value: T, fromIndex: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  def indexOfFrom[T](value: T, fromIndex: __): LodashIndexOfFrom1x5
  def indexOfFrom[T](value: T, fromIndex: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashIndexOfFrom1x5
  def indexOfFrom[T](value: __, fromIndex: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashIndexOfFrom1x6[T]
  def indexOfFrom[T](value: __, fromIndex: __): LodashIndexOfFrom1x4[T]
  def indexOfFrom[T](value: __, fromIndex: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashIndexOfFrom1x4[T]
  @JSName("indexOfFrom")
  ...
  @JSName("indexOf")
  def indexOf_T_Double[T](value: T): Double
  
  def init[T](): js.Array[T]
  def init[T](array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  @JSName("init")
  var init_Original: LodashInitial
  
  def initial[T](): js.Array[T]
  def initial[T](array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  @JSName("initial")
  var initial_Original: LodashInitial
  
  def intersection[T](): js.Array[T]
  def intersection[T](arrays2: Null, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def intersection[T](arrays2: Unit, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def intersection[T](arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def intersection[T](
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays: typingsJapgolly.cypress.typesLodashMod.List[T]
  ): js.Array[T]
  def intersection[T](arrays2: __): LodashIntersection1x2[T]
  def intersection[T](arrays2: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashIntersection1x2[T]
  
  def intersectionBy[T1](iteratee: __): LodashIntersectionBy1x2[T1]
  def intersectionBy[T1](iteratee: __, array: typingsJapgolly.cypress.typesLodashMod.List[T1]): LodashIntersectionBy1x2[T1]
  def intersectionBy[T2](iteratee: __, array: __, values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashIntersectionBy1x4[T2]
  def intersectionBy[T1, T2](iteratee: ValueIteratee[T1 | T2]): LodashIntersectionBy1x3[T1, T2]
  def intersectionBy[T1, T2](
    iteratee: ValueIteratee[T1 | T2],
    array: Null,
    values: typingsJapgolly.cypress.typesLodashMod.List[T2]
  ): js.Array[T1]
  def intersectionBy[T1, T2](iteratee: ValueIteratee[T1 | T2], array: typingsJapgolly.cypress.typesLodashMod.List[T1]): LodashIntersectionBy1x3[T1, T2]
  def intersectionBy[T1, T2](
    iteratee: ValueIteratee[T1 | T2],
    array: typingsJapgolly.cypress.typesLodashMod.List[T1],
    values: typingsJapgolly.cypress.typesLodashMod.List[T2]
  ...
  def intersectionBy[T1, T2](iteratee: __, array: Null, values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashIntersectionBy1x6[T1, T2]
  def intersectionBy[T1, T2](
    iteratee: __,
    array: typingsJapgolly.cypress.typesLodashMod.List[T1],
    values: typingsJapgolly.cypress.typesLodashMod.List[T2]
  ...
  @JSName("intersectionBy")
  def intersectionBy_T1T2_LodashIntersectionBy1x1[T1, T2](iteratee: ValueIteratee[T1 | T2]): LodashIntersectionBy1x1[T1, T2]
  
  def intersectionWith[T1](comparator: __): LodashIntersectionWith1x2[T1]
  def intersectionWith[T1](comparator: __, array: typingsJapgolly.cypress.typesLodashMod.List[T1]): LodashIntersectionWith1x2[T1]
  def intersectionWith[T2](comparator: __, array: __, values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashIntersectionWith1x4[T2]
  def intersectionWith[T1, T2](comparator: Comparator2[T1, T2]): LodashIntersectionWith1x1[T1, T2]
  ...
  def intersectionWith[T1, T2](comparator: Comparator2[T1, T2], array: typingsJapgolly.cypress.typesLodashMod.List[T1]): LodashIntersectionWith1x3[T1, T2]
  def intersectionWith[T1, T2](
    comparator: Comparator2[T1, T2],
    array: typingsJapgolly.cypress.typesLodashMod.List[T1],
    values: typingsJapgolly.cypress.typesLodashMod.List[T2]
  ...
  def intersectionWith[T1, T2](comparator: __, array: Null, values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashIntersectionWith1x6[T1, T2]
  def intersectionWith[T1, T2](comparator: __, array: Unit, values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashIntersectionWith1x6[T1, T2]
  def intersectionWith[T1, T2](
    comparator: __,
    array: typingsJapgolly.cypress.typesLodashMod.List[T1],
    values: typingsJapgolly.cypress.typesLodashMod.List[T2]
  ...
  @JSName("intersectionWith")
  def intersectionWith_T1T2_LodashIntersectionWith1x3[T1, T2](comparator: Comparator2[T1, T2]): LodashIntersectionWith1x3[T1, T2]
  ...
  @JSName("intersection")
  def intersection_T_LodashIntersection1x1[T](arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashIntersection1x1[T]
  ...
  def invokeMap(methodName: java.lang.String): LodashInvokeMap1x1
  ...
  @JSName("invokeMap")
  def invokeMap_Array(methodName: java.lang.String): js.Array[Any]
  @JSName("invokeMap")
  ...
  def isArrayLike(value: Any): /* is cypress.anon.Length */ Boolean
  ...
  def join(separator: java.lang.String, array: typingsJapgolly.cypress.typesLodashMod.List[Any]): java.lang.String
  def join(separator: __): LodashJoin1x2
  def join(separator: __, array: typingsJapgolly.cypress.typesLodashMod.List[Any]): LodashJoin1x2
  @JSName("join")
  ...
  def keyBy[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashKeyBy1x2[T]
  @JSName("keyBy")
  ...
  def last[T](array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.UndefOr[T]
  
  def lastIndexOf[T](value: T): Double
  def lastIndexOf[T](value: T, array: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  def lastIndexOf[T](value: __): LodashLastIndexOf1x2[T]
  def lastIndexOf[T](value: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashLastIndexOf1x2[T]
  ...
  def lastIndexOfFrom[T](value: T, fromIndex: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  def lastIndexOfFrom[T](value: T, fromIndex: __): LodashLastIndexOfFrom1x5
  def lastIndexOfFrom[T](value: T, fromIndex: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashLastIndexOfFrom1x5
  def lastIndexOfFrom[T](value: __, fromIndex: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashLastIndexOfFrom1x6[T]
  def lastIndexOfFrom[T](value: __, fromIndex: __): LodashLastIndexOfFrom1x4[T]
  def lastIndexOfFrom[T](value: __, fromIndex: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashLastIndexOfFrom1x4[T]
  ...
  @JSName("lastIndexOfFrom")
  def lastIndexOfFrom_true[T](value: T, fromIndex: `true`, array: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  @JSName("lastIndexOfFrom")
  def lastIndexOfFrom_true[T](value: __, fromIndex: `true`, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashLastIndexOfFrom1x6[T]
  @JSName("lastIndexOfFrom")
  ...
  def map[T](iteratee: __): LodashMap1x2[T]
  ...
  def map[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashMap2x2[T]
  ...
  def mapKeys[T](iteratee: ValueIteratee[Double], `object`: typingsJapgolly.cypress.typesLodashMod.List[T]): Dictionary[T]
  def mapKeys[T /* <: js.Object */](iteratee: __): LodashMapKeys2x2[T]
  def mapKeys[T /* <: js.Object */](iteratee: __, `object`: T): LodashMapKeys2x2[T]
  def mapKeys[T](iteratee: __, `object`: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashMapKeys1x2[T]
  @JSName("mapKeys")
  ...
  @JSName("mapKeys")
  def mapKeys_T_LodashMapKeys1x2[T](iteratee: __): LodashMapKeys1x2[T]
  
  def mapValues(iteratee: java.lang.String): LodashMapValues6x1
  def mapValues(iteratee: js.Object): LodashMapValues3x1
  def mapValues[T](callbackOrIterateeOrIterateeOrIteratee: __): LodashMapValues1x2[T]
  ...
  def mapValues[T, TResult](callback: js.Function1[/* value */ T, TResult]): Dictionary[TResult]
  ...
  @JSName("mapValues")
  def mapValues_TTKey_LodashMapValues5x1[T, TKey /* <: /* keyof T */ java.lang.String */](iteratee: TKey): LodashMapValues5x1[T, TKey]
  @JSName("mapValues")
  def mapValues_TTResult_Any[T /* <: js.Object */, TResult](
    callback: js.Function1[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ /* value */ js.Any, 
      TResult
    ]
  ...
  @JSName("mapValues")
  def mapValues_T_LodashMapValues2x2[T /* <: js.Object */](callbackOrIterateeOrIteratee: __): LodashMapValues2x2[T]
  ...
  def max[T](collection: typingsJapgolly.cypress.typesLodashMod.List[T]): js.UndefOr[T]
  
  def maxBy[T](iteratee: ValueIteratee[T]): js.UndefOr[T]
  def maxBy[T](iteratee: ValueIteratee[T], collection: typingsJapgolly.cypress.typesLodashMod.List[T]): js.UndefOr[T]
  def maxBy[T](iteratee: __): LodashMaxBy1x2[T]
  def maxBy[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashMaxBy1x2[T]
  @JSName("maxBy")
  ...
  def mean(): Double
  def mean(collection: typingsJapgolly.cypress.typesLodashMod.List[Any]): Double
  
  def meanBy[T](iteratee: ValueIteratee[T]): LodashMeanBy1x1[T]
  def meanBy[T](iteratee: ValueIteratee[T], collection: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  def meanBy[T](iteratee: __): LodashMeanBy1x2[T]
  def meanBy[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashMeanBy1x2[T]
  @JSName("meanBy")
  ...
  def min[T](collection: typingsJapgolly.cypress.typesLodashMod.List[T]): js.UndefOr[T]
  
  def minBy[T](iteratee: ValueIteratee[T]): js.UndefOr[T]
  def minBy[T](iteratee: ValueIteratee[T], collection: typingsJapgolly.cypress.typesLodashMod.List[T]): js.UndefOr[T]
  def minBy[T](iteratee: __): LodashMinBy1x2[T]
  def minBy[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashMinBy1x2[T]
  @JSName("minBy")
  ...
  def noConflict(): TypeofcypressTypesLodas
  @JSName("noConflict")
  ...
  def nth[T](n: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.UndefOr[T]
  def nth[T](n: __): LodashNth1x2[T]
  def nth[T](n: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashNth1x2[T]
  ...
  def omitBy[T](predicate: ValueKeyIteratee[T]): Dictionary[T]
  ...
  def omitBy[T](predicate: __): LodashOmitBy1x2[T]
  ...
  @JSName("omitBy")
  def omitBy_T_LodashOmitBy2x2[T](predicate: __): LodashOmitBy2x2[T]
  @JSName("omitBy")
  ...
  def orderBy[T](iteratees: Many[ValueIteratee[T]], orders: Many[Boolean | asc | desc]): LodashOrderBy2x3[T]
  ...
  def orderBy[T](iteratees: Many[js.Function1[/* value */ T, NotVoid]], orders: __): LodashOrderBy1x5[T]
  def orderBy[T /* <: js.Object */](
    iteratees: Many[
      ValueIteratee[
        /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
  ...
  def orderBy[T](iteratees: __, orders: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashOrderBy1x4[T]
  @JSName("orderBy")
  ...
  @JSName("orderBy")
  def orderBy_T_LodashOrderBy3x5[T /* <: js.Object */](
    iteratees: Many[
      js.Function1[
        /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ /* value */ js.Any, 
        NotVoid
  ...
  def partialRight[T1](func: __, arg1: js.Tuple3[T1, __, __]): LodashPartialRight5x2[T1]
  def partialRight[T1](func: __, arg1: js.Tuple4[T1, __, __, __]): LodashPartialRight12x2[T1]
  def partialRight[T3](func: __, arg3: js.Tuple2[T3, __]): LodashPartialRight15x2[T3]
  def partialRight[T1, T2, R](func: Function2[T1, T2, R]): LodashPartialRight2x1[T1, T2, R]
  def partialRight[T1, T2, R](func: Function2[T1, T2, R], arg1: js.Tuple2[T1, T2]): Function0[R]
  ...
  def partialRight[T1, T2, T3, T4, R](func: Function4[T1, T2, T3, T4, R], arg1: js.Tuple4[T1, T2, T3, T4]): Function0[R]
  ...
  @JSName("partialRight")
  def partialRight_T1T2R_Function1[T1, T2, R](func: Function2[T1, T2, R], arg1: js.Tuple2[T1, __]): Function1[T2, R]
  @JSName("partialRight")
  ...
  @JSName("partialRight")
  def partialRight_T1T2T3T4R_Function2[T1, T2, T3, T4, R](func: Function4[T1, T2, T3, T4, R], arg1: js.Tuple4[T1, T2 | __, T3 | __, T4 | __]): Function2[T3, T4, R]
  @JSName("partialRight")
  ...
  @JSName("partialRight")
  def partialRight_T1_LodashPartialRight2x2[T1](func: __, arg1: js.Tuple2[T1, __]): LodashPartialRight2x2[T1]
  @JSName("partialRight")
  ...
  @JSName("partialRight")
  def partialRight_T2_LodashPartialRight13x2[T2](func: __, arg2: js.Tuple3[T2, __, __]): LodashPartialRight13x2[T2]
  @JSName("partialRight")
  ...
  def partition[T](callback: ValueIteratee[T], collection: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Tuple2[js.Array[T], js.Array[T]]
  def partition[T](callback: __): LodashPartition1x2[T]
  def partition[T /* <: js.Object */](callback: __, collection: T): LodashPartition3x2[T]
  def partition[T](callback: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPartition1x2[T]
  def partition[T, U /* <: T */](callback: ValueIteratorTypeGuard[T, U]): js.Tuple2[js.Array[U], js.Array[Exclude[T, U]]]
  def partition[T, U /* <: T */](callback: ValueIteratorTypeGuard[T, U], collection: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Tuple2[js.Array[U], js.Array[Exclude[T, U]]]
  @JSName("partition")
  ...
  @JSName("partition")
  def partition_T_LodashPartition3x2[T /* <: js.Object */](callback: __): LodashPartition3x2[T]
  @JSName("partition")
  ...
  def path(path: PropertyPath): LodashPath11x1
  ...
  def pathOr(defaultValue: __, path: PropertyPath): LodashPathOr6x2
  ...
  def pathOr[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](defaultValue: __, path: js.Tuple2[TKey1, TKey2]): LodashPathOr2x6[TObject, TKey1, TKey2]
  ...
  @JSName("pathOr")
  def pathOr_LodashPathOr6x6(defaultValue: __, path: PropertyPath): LodashPathOr6x6
  @JSName("pathOr")
  ...
  @JSName("pathOr")
  def pathOr_TObjectTKey1TKey2_LodashPathOr2x2[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](defaultValue: __, path: js.Tuple2[TKey1, TKey2]): LodashPathOr2x2[TObject, TKey1, TKey2]
  @JSName("pathOr")
  ...
  @JSName("pathOr")
  def pathOr_TObjectTKeyTDefault_Union[TObject /* <: js.Object */, TKey /* <: /* keyof TObject */ java.lang.String */, TDefault](defaultValue: TDefault, path: js.Array[TKey]): (Exclude[
    /* import warning: importer.ImportType#apply Failed type conversion: TObject[TKey] */ js.Any, 
    Unit
  ]) | TDefault
  @JSName("pathOr")
  ...
  @JSName("path")
  def path_TObjectTKey_LodashPath1x1[TObject /* <: js.Object */, TKey /* <: /* keyof TObject */ java.lang.String */](path: js.Array[TKey]): LodashPath1x1[TObject, TKey]
  @JSName("path")
  ...
  @JSName("path")
  def path_Unit(path: PropertyPath): Unit
  ...
  def pick[T /* <: js.Object */](props: __, `object`: T): LodashPick1x2[T]
  ...
  def pickAll[T /* <: js.Object */](props: __, `object`: T): LodashPick1x2[T]
  @JSName("pickAll")
  ...
  @JSName("pickAll")
  def pickAll_T_LodashPick2x2[T](props: __, `object`: T): LodashPick2x2[T]
  @JSName("pickAll")
  def pickAll_T_PartialObject[T](props: PropertyPath): PartialObject[T]
  
  def pickBy[T](predicate: ValueKeyIteratee[T]): Dictionary[T]
  ...
  def pickBy[T](predicate: __): LodashPickBy2x2[T]
  ...
  def pickBy[T, S /* <: T */](predicate: ValueKeyIterateeTypeGuard[T, S]): NumericDictionary[S]
  ...
  @JSName("pick")
  def pick_T_LodashPick2x2[T](props: __, `object`: T): LodashPick2x2[T]
  @JSName("pick")
  ...
  def placeholder[T](value: typingsJapgolly.cypress.typesLodashMod.List[T]): Collection[T]
  @JSName("placeholder")
  ...
  /**
    ...
    **/
  @JSName("placeholder")
  def placeholder_TrapAny_Intersection[TrapAny /* <: typingsJapgolly.cypress.anon.TrapAny */](value: TrapAny): Collection[Any] & Function[Any] & Object[Any] & Primitive[Any] & String
  ...
  def pluck[T](iteratee: __): LodashMap1x2[T]
  ...
  def pluck[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashMap2x2[T]
  ...
  def propOr(defaultValue: __, path: PropertyPath): LodashPropOr6x6
  ...
  def propOr[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](defaultValue: __, path: js.Tuple2[TKey1, TKey2]): LodashPropOr2x6[TObject, TKey1, TKey2]
  ...
  @JSName("propOr")
  def propOr_LodashPropOr6x2(defaultValue: __, path: PropertyPath): LodashPropOr6x2
  @JSName("propOr")
  ...
  @JSName("propOr")
  def propOr_TObjectTKey1TKey2_LodashPropOr2x2[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](defaultValue: __, path: js.Tuple2[TKey1, TKey2]): LodashPropOr2x2[TObject, TKey1, TKey2]
  @JSName("propOr")
  ...
  def propertyOf(path: PropertyPath): Unit
  ...
  def propertyOf[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */, TKey3 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1][TKey2] */ js.Any */, TKey4 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1][TKey2][TKey3] */ js.Any */](path: js.Tuple4[TKey1, TKey2, TKey3, TKey4], `object`: TObject): /* import warning: importer.ImportType#apply Failed type conversion: TObject[TKey1][TKey2][TKey3][TKey4] */ js.Any
  @JSName("propertyOf")
  def propertyOf_LodashPropertyOf11x1(path: PropertyPath): LodashPropertyOf11x1
  @JSName("propertyOf")
  ...
  def pull[T](values: T, array: typingsJapgolly.cypress.typesLodashMod.List[T]): typingsJapgolly.cypress.typesLodashMod.List[T]
  def pull[T](values: __, array: js.Array[T]): LodashPull1x2[T]
  def pull[T](values: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPull2x2[T]
  
  def pullAll[T](values: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPullAll1x1[T]
  def pullAll[T](values: typingsJapgolly.cypress.typesLodashMod.List[T], array: js.Array[T]): js.Array[T]
  def pullAll[T](
    values: typingsJapgolly.cypress.typesLodashMod.List[T],
    array: typingsJapgolly.cypress.typesLodashMod.List[T]
  ): typingsJapgolly.cypress.typesLodashMod.List[T]
  def pullAll[T](values: __, array: js.Array[T]): LodashPullAll1x2[T]
  def pullAll[T](values: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPullAll2x2[T]
  
  def pullAllBy[T](iteratee: ValueIteratee[T]): LodashPullAllBy1x1[T]
  def pullAllBy[T](iteratee: ValueIteratee[T], values: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPullAllBy1x3[T]
  def pullAllBy[T](
  ...
  def pullAllBy[T](iteratee: ValueIteratee[T], values: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPullAllBy2x5[T]
  def pullAllBy[T](iteratee: __, values: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPullAllBy1x2[T]
  def pullAllBy[T](iteratee: __, values: typingsJapgolly.cypress.typesLodashMod.List[T], array: js.Array[T]): LodashPullAllBy1x6[T]
  def pullAllBy[T](
    iteratee: __,
    values: typingsJapgolly.cypress.typesLodashMod.List[T],
    array: typingsJapgolly.cypress.typesLodashMod.List[T]
  ...
  def pullAllBy[T1](iteratee: __, values: __, array: typingsJapgolly.cypress.typesLodashMod.List[T1]): LodashPullAllBy4x4[T1]
  @JSName("pullAllBy")
  ...
  def pullAllBy_T1T2[T1, T2](
    ...
    values: typingsJapgolly.cypress.typesLodashMod.List[T2],
    array: typingsJapgolly.cypress.typesLodashMod.List[T1]
  ): typingsJapgolly.cypress.typesLodashMod.List[T1]
  @JSName("pullAllBy")
  def pullAllBy_T1T2_LodashPullAllBy3x1[T1, T2](iteratee: ValueIteratee[T1 | T2]): LodashPullAllBy3x1[T1, T2]
  @JSName("pullAllBy")
  def pullAllBy_T1T2_LodashPullAllBy3x3[T1, T2](iteratee: ValueIteratee[T1 | T2], values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashPullAllBy3x3[T1]
  @JSName("pullAllBy")
  ...
  @JSName("pullAllBy")
  def pullAllBy_T1T2_LodashPullAllBy3x6[T1, T2](iteratee: __, values: typingsJapgolly.cypress.typesLodashMod.List[T2], array: js.Array[T1]): LodashPullAllBy3x6[T1, T2]
  @JSName("pullAllBy")
  def pullAllBy_T1T2_LodashPullAllBy4x5[T1, T2](
    iteratee: ValueIteratee[T1 | T2],
    values: __,
    array: typingsJapgolly.cypress.typesLodashMod.List[T1]
  ...
  @JSName("pullAllBy")
  def pullAllBy_T2_LodashPullAllBy3x2[T2](iteratee: __, values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashPullAllBy3x2[T2]
  @JSName("pullAllBy")
  def pullAllBy_T_LodashPullAllBy2x4[T](iteratee: __, values: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPullAllBy2x4[T]
  
  def pullAllWith[T](comparator: Comparator[T]): LodashPullAllWith1x1[T]
  def pullAllWith[T](comparator: Comparator[T], values: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPullAllWith1x3[T]
  def pullAllWith[T](
  ...
  def pullAllWith[T](comparator: Comparator[T], values: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPullAllWith2x5[T]
  def pullAllWith[T2](comparator: __, values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashPullAllWith3x2[T2]
  def pullAllWith[T](comparator: __, values: typingsJapgolly.cypress.typesLodashMod.List[T], array: js.Array[T]): LodashPullAllWith1x6[T]
  def pullAllWith[T](
    comparator: __,
    values: typingsJapgolly.cypress.typesLodashMod.List[T],
    array: typingsJapgolly.cypress.typesLodashMod.List[T]
  ...
  def pullAllWith[T](comparator: __, values: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPullAllWith2x4[T]
  @JSName("pullAllWith")
  ...
  @JSName("pullAllWith")
  def pullAllWith_T1T2_LodashPullAllWith3x3[T1, T2](comparator: Comparator2[T1, T2], values: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashPullAllWith3x3[T1]
  @JSName("pullAllWith")
  ...
  @JSName("pullAllWith")
  def pullAllWith_T1T2_LodashPullAllWith3x6[T1, T2](comparator: __, values: typingsJapgolly.cypress.typesLodashMod.List[T2], array: js.Array[T1]): LodashPullAllWith3x6[T1, T2]
  @JSName("pullAllWith")
  def pullAllWith_T1T2_LodashPullAllWith4x5[T1, T2](
    comparator: Comparator2[T1, T2],
    values: __,
    array: typingsJapgolly.cypress.typesLodashMod.List[T1]
  ...
  @JSName("pullAllWith")
  def pullAllWith_T1_LodashPullAllWith4x4[T1](comparator: __, values: __, array: typingsJapgolly.cypress.typesLodashMod.List[T1]): LodashPullAllWith4x4[T1]
  @JSName("pullAllWith")
  def pullAllWith_T_LodashPullAllWith1x2[T](comparator: __, values: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPullAllWith1x2[T]
  @JSName("pullAllWith")
  ...
  def pullAt[T](indexes: Many[Double], array: typingsJapgolly.cypress.typesLodashMod.List[T]): typingsJapgolly.cypress.typesLodashMod.List[T]
  def pullAt[T](indexes: __, array: js.Array[T]): LodashPullAt1x2[T]
  def pullAt[T](indexes: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashPullAt2x2[T]
  @JSName("pullAt")
  ...
  def reduce[T /* <: js.Object */](callback: __, accumulator: __): LodashReduce3x4[T]
  ...
  def reduce[T](callback: __, accumulator: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashReduce2x4[T]
  def reduce[T, TResult](callback: MemoIteratorCapped[T, TResult]): LodashReduce1x1[T, TResult]
  ...
  def reduce[T, TResult](callback: __, accumulator: TResult, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashReduce2x6[T, TResult]
  ...
  def reduceRight[T](callback: __, accumulator: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashReduceRight2x4[T]
  ...
  def reduceRight[T, TResult](callback: __, accumulator: TResult, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashReduceRight2x6[T, TResult]
  @JSName("reduceRight")
  ...
  @JSName("reduceRight")
  def reduceRight_TTResult_LodashReduceRight3x3[T /* <: js.Object */, TResult](
    callback: MemoIteratorCappedRight[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      TResult
    ],
  ...
  @JSName("reduce")
  def reduce_TTResult_LodashReduce3x1[T /* <: js.Object */, TResult](
    callback: MemoIteratorCapped[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      TResult
    ]
  ...
  def reject[T](predicate: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashReject1x2[T]
  @JSName("reject")
  ...
  def remove[T](predicate: ValueIteratee[T], array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def remove[T](predicate: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashRemove1x2[T]
  @JSName("remove")
  ...
  def reverse[TList /* <: typingsJapgolly.cypress.typesLodashMod.List[Any] */](array: TList): TList
  @JSName("reverse")
  ...
  def sampleSize[T /* <: js.Object */](n: __): LodashSampleSize2x2[T]
  ...
  @JSName("sampleSize")
  def sampleSize_T_LodashSampleSize1x2[T](n: __): LodashSampleSize1x2[T]
  ...
  def shuffle[T](collection: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  @JSName("shuffle")
  ...
  def slice[T](start: Double, end: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def slice[T](start: Double, end: __): LodashSlice1x5[T]
  def slice[T](start: Double, end: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSlice1x5[T]
  def slice[T](start: __, end: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSlice1x6[T]
  def slice[T](start: __, end: __): LodashSlice1x4[T]
  def slice[T](start: __, end: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSlice1x4[T]
  @JSName("slice")
  ...
  def some[T](predicate: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSome1x2[T]
  @JSName("some")
  ...
  def sortBy[T](iteratees: Many[ValueIteratee[T]], collection: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def sortBy[T /* <: js.Object */](iteratees: __): LodashSortBy2x2[T]
  def sortBy[T /* <: js.Object */](iteratees: __, collection: T): LodashSortBy2x2[T]
  def sortBy[T](iteratees: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSortBy1x2[T]
  @JSName("sortBy")
  ...
  def sortedIndex[T](value: T, array: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  def sortedIndex[T](value: __): LodashSortedIndex1x2[T]
  def sortedIndex[T](value: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSortedIndex1x2[T]
  ...
  def sortedIndexBy[T](iteratee: ValueIteratee[T], value: T, array: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  def sortedIndexBy[T](iteratee: ValueIteratee[T], value: __): LodashSortedIndexBy1x5[T]
  def sortedIndexBy[T](iteratee: ValueIteratee[T], value: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSortedIndexBy1x5[T]
  def sortedIndexBy[T](iteratee: __, value: T): LodashSortedIndexBy1x2[T]
  def sortedIndexBy[T](iteratee: __, value: T, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSortedIndexBy1x6[T]
  def sortedIndexBy[T](iteratee: __, value: __): LodashSortedIndexBy1x4[T]
  def sortedIndexBy[T](iteratee: __, value: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSortedIndexBy1x4[T]
  ...
  def sortedIndexOf[T](value: T, array: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  def sortedIndexOf[T](value: __): LodashSortedIndexOf1x2[T]
  def sortedIndexOf[T](value: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSortedIndexOf1x2[T]
  ...
  def sortedLastIndex[T](value: T, array: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  def sortedLastIndex[T](value: __): LodashSortedLastIndex1x2[T]
  def sortedLastIndex[T](value: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSortedLastIndex1x2[T]
  ...
  def sortedLastIndexBy[T](iteratee: ValueIteratee[T], value: T, array: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  def sortedLastIndexBy[T](iteratee: ValueIteratee[T], value: __): LodashSortedLastIndexBy1x5[T]
  def sortedLastIndexBy[T](iteratee: ValueIteratee[T], value: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSortedLastIndexBy1x5[T]
  def sortedLastIndexBy[T](iteratee: __, value: T): LodashSortedLastIndexBy1x2[T]
  def sortedLastIndexBy[T](iteratee: __, value: T, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSortedLastIndexBy1x6[T]
  def sortedLastIndexBy[T](iteratee: __, value: __): LodashSortedLastIndexBy1x4[T]
  def sortedLastIndexBy[T](iteratee: __, value: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSortedLastIndexBy1x4[T]
  ...
  def sortedLastIndexOf[T](value: T, array: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  def sortedLastIndexOf[T](value: __): LodashSortedLastIndexOf1x2[T]
  def sortedLastIndexOf[T](value: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSortedLastIndexOf1x2[T]
  ...
  def sortedUniq[T](array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  
  def sortedUniqBy[T](iteratee: ValueIteratee[T]): LodashSortedUniqBy1x1[T]
  def sortedUniqBy[T](iteratee: ValueIteratee[T], array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def sortedUniqBy[T](iteratee: __): LodashSortedUniqBy1x2[T]
  def sortedUniqBy[T](iteratee: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSortedUniqBy1x2[T]
  @JSName("sortedUniqBy")
  ...
  def sum(): Double
  def sum(collection: typingsJapgolly.cypress.typesLodashMod.List[Any]): Double
  
  def sumBy[T](iteratee: java.lang.String): LodashSumBy1x1[T]
  def sumBy[T](iteratee: java.lang.String, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): Double
  ...
  def sumBy[T](iteratee: __, collection: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashSumBy1x2[T]
  @JSName("sumBy")
  ...
  def symmetricDifference[T](arrays2: Null, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def symmetricDifference[T](arrays2: Unit, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def symmetricDifference[T](arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXor1x1[T]
  def symmetricDifference[T](
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays: typingsJapgolly.cypress.typesLodashMod.List[T]
  ): js.Array[T]
  def symmetricDifference[T](arrays2: __): LodashXor1x2[T]
  def symmetricDifference[T](arrays2: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXor1x2[T]
  
  def symmetricDifferenceBy[T](iteratee: ValueIteratee[T]): LodashXorBy1x3[T]
  def symmetricDifferenceBy[T](iteratee: ValueIteratee[T], arrays: Null, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def symmetricDifferenceBy[T](iteratee: ValueIteratee[T], arrays: Unit, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def symmetricDifferenceBy[T](iteratee: ValueIteratee[T], arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x3[T]
  ...
  def symmetricDifferenceBy[T](iteratee: ValueIteratee[T], arrays: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x5[T]
  def symmetricDifferenceBy[T](iteratee: __): LodashXorBy1x6[T]
  def symmetricDifferenceBy[T](iteratee: __, arrays: Null, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x6[T]
  def symmetricDifferenceBy[T](iteratee: __, arrays: Unit, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x6[T]
  def symmetricDifferenceBy[T](iteratee: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x6[T]
  def symmetricDifferenceBy[T](
    iteratee: __,
    arrays: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]
  ...
  def symmetricDifferenceBy[T](iteratee: __, arrays: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x4[T]
  ...
  @JSName("symmetricDifferenceBy")
  def symmetricDifferenceBy_T_Array[T](iteratee: ValueIteratee[T], arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  @JSName("symmetricDifferenceBy")
  ...
  @JSName("symmetricDifferenceBy")
  def symmetricDifferenceBy_T_LodashXorBy1x2[T](iteratee: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x2[T]
  
  def symmetricDifferenceWith[T](comparator: Comparator[T]): LodashXorWith1x3[T]
  def symmetricDifferenceWith[T](comparator: Comparator[T], arrays: Null, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def symmetricDifferenceWith[T](comparator: Comparator[T], arrays: Unit, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def symmetricDifferenceWith[T](comparator: Comparator[T], arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x3[T]
  ...
  def symmetricDifferenceWith[T](comparator: Comparator[T], arrays: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x5[T]
  def symmetricDifferenceWith[T](comparator: __): LodashXorWith1x6[T]
  def symmetricDifferenceWith[T](comparator: __, arrays: Null, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x6[T]
  def symmetricDifferenceWith[T](comparator: __, arrays: Unit, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x6[T]
  def symmetricDifferenceWith[T](comparator: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x6[T]
  def symmetricDifferenceWith[T](
    comparator: __,
    arrays: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]
  ...
  def symmetricDifferenceWith[T](comparator: __, arrays: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x4[T]
  ...
  @JSName("symmetricDifferenceWith")
  def symmetricDifferenceWith_T_Array[T](comparator: Comparator[T], arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  @JSName("symmetricDifferenceWith")
  ...
  @JSName("symmetricDifferenceWith")
  def symmetricDifferenceWith_T_LodashXorWith1x2[T](comparator: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x2[T]
  ...
  @JSName("symmetricDifference")
  def symmetricDifference_T_Array[T](arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  
  def tail[T](): js.Array[T]
  def tail[T](array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  @JSName("tail")
  var tail_Original: LodashTail
  
  def take(n: Double): LodashTake1x1
  def take[T](n: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def take[T](n: __): LodashTake1x2[T]
  def take[T](n: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashTake1x2[T]
  
  def takeLast(n: Double): LodashTakeRight1x1
  def takeLast[T](n: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def takeLast[T](n: __): LodashTakeRight1x2[T]
  def takeLast[T](n: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashTakeRight1x2[T]
  
  def takeLastWhile[T](predicate: ValueIteratee[T]): js.Array[T]
  def takeLastWhile[T](predicate: ValueIteratee[T], array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def takeLastWhile[T](predicate: __): LodashTakeRightWhile1x2[T]
  def takeLastWhile[T](predicate: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashTakeRightWhile1x2[T]
  ...
  def takeRight[T](n: Double, array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def takeRight[T](n: __): LodashTakeRight1x2[T]
  def takeRight[T](n: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashTakeRight1x2[T]
  
  def takeRightWhile[T](predicate: ValueIteratee[T]): js.Array[T]
  def takeRightWhile[T](predicate: ValueIteratee[T], array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def takeRightWhile[T](predicate: __): LodashTakeRightWhile1x2[T]
  def takeRightWhile[T](predicate: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashTakeRightWhile1x2[T]
  ...
  def takeWhile[T](predicate: ValueIteratee[T], array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def takeWhile[T](predicate: __): LodashTakeWhile1x2[T]
  def takeWhile[T](predicate: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashTakeWhile1x2[T]
  @JSName("takeWhile")
  ...
  def union[T](): js.Array[T]
  def union[T](arrays2: Null, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def union[T](arrays2: Unit, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def union[T](arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def union[T](
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays: typingsJapgolly.cypress.typesLodashMod.List[T]
  ): js.Array[T]
  def union[T](arrays2: __): LodashUnion1x2[T]
  def union[T](arrays2: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnion1x2[T]
  
  def unionBy[T](iteratee: ValueIteratee[T]): js.Array[T]
  def unionBy[T](iteratee: ValueIteratee[T], arrays1: Null, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def unionBy[T](iteratee: ValueIteratee[T], arrays1: Unit, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def unionBy[T](iteratee: ValueIteratee[T], arrays1: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def unionBy[T](
    iteratee: ValueIteratee[T],
    arrays1: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]
  ): js.Array[T]
  def unionBy[T](iteratee: ValueIteratee[T], arrays1: __): LodashUnionBy1x5[T]
  def unionBy[T](iteratee: ValueIteratee[T], arrays1: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionBy1x5[T]
  def unionBy[T](iteratee: __): LodashUnionBy1x2[T]
  def unionBy[T](iteratee: __, arrays1: Null, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionBy1x6[T]
  def unionBy[T](iteratee: __, arrays1: Unit, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionBy1x6[T]
  def unionBy[T](iteratee: __, arrays1: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionBy1x2[T]
  def unionBy[T](
    iteratee: __,
    arrays1: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]
  ...
  def unionBy[T](iteratee: __, arrays1: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionBy1x4[T]
  @JSName("unionBy")
  ...
  @JSName("unionBy")
  def unionBy_T_LodashUnionBy1x3[T](iteratee: ValueIteratee[T], arrays1: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionBy1x3[T]
  @JSName("unionBy")
  def unionBy_T_LodashUnionBy1x6[T](iteratee: __): LodashUnionBy1x6[T]
  @JSName("unionBy")
  def unionBy_T_LodashUnionBy1x6[T](iteratee: __, arrays1: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionBy1x6[T]
  
  def unionWith[T](comparator: Comparator[T]): js.Array[T]
  def unionWith[T](comparator: Comparator[T], arrays: Null, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def unionWith[T](comparator: Comparator[T], arrays: Unit, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def unionWith[T](comparator: Comparator[T], arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def unionWith[T](
    comparator: Comparator[T],
    arrays: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]
  ...
  def unionWith[T](comparator: Comparator[T], arrays: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionWith1x5[T]
  def unionWith[T](comparator: __): LodashUnionWith1x2[T]
  def unionWith[T](comparator: __, arrays: Null, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionWith1x6[T]
  def unionWith[T](comparator: __, arrays: Unit, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionWith1x6[T]
  def unionWith[T](comparator: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionWith1x2[T]
  def unionWith[T](
    comparator: __,
    arrays: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]
  ...
  def unionWith[T](comparator: __, arrays: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionWith1x4[T]
  @JSName("unionWith")
  ...
  @JSName("unionWith")
  def unionWith_T_LodashUnionWith1x3[T](comparator: Comparator[T], arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionWith1x3[T]
  @JSName("unionWith")
  def unionWith_T_LodashUnionWith1x6[T](comparator: __): LodashUnionWith1x6[T]
  @JSName("unionWith")
  def unionWith_T_LodashUnionWith1x6[T](comparator: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnionWith1x6[T]
  
  @JSName("union")
  var union_Original: LodashUnion
  @JSName("union")
  def union_T_LodashUnion1x1[T](): LodashUnion1x1[T]
  @JSName("union")
  def union_T_LodashUnion1x1[T](arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUnion1x1[T]
  
  def uniq[T](): js.Array[T]
  def uniq[T](array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  
  def uniqBy[T](iteratee: ValueIteratee[T]): LodashUniqBy1x1[T]
  def uniqBy[T](iteratee: ValueIteratee[T], array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def uniqBy[T](iteratee: __): LodashUniqBy1x2[T]
  def uniqBy[T](iteratee: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUniqBy1x2[T]
  @JSName("uniqBy")
  var uniqBy_Original: LodashUniqBy
  @JSName("uniqBy")
  def uniqBy_T_Array[T](iteratee: ValueIteratee[T]): js.Array[T]
  
  def uniqWith[T](comparator: Comparator[T]): js.Array[T]
  def uniqWith[T](comparator: Comparator[T], array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def uniqWith[T](comparator: __): LodashUniqWith1x2[T]
  def uniqWith[T](comparator: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashUniqWith1x2[T]
  @JSName("uniqWith")
  ...
  def unnest[T](array: typingsJapgolly.cypress.typesLodashMod.List[Many[T]]): js.Array[T]
  @JSName("unnest")
  ...
  def unzip[T](array: typingsJapgolly.cypress.typesLodashMod.List[typingsJapgolly.cypress.typesLodashMod.List[T]]): js.Array[js.Array[T]]
  ...
  def values[T](`object`: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  ...
  def valuesIn[T](`object`: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  ...
  def without[T](values: js.Array[T], array: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def without[T](values: __): LodashWithout1x2[T]
  def without[T](values: __, array: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashWithout1x2[T]
  @JSName("without")
  ...
  def xor[T](arrays2: Null, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def xor[T](arrays2: Unit, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def xor[T](arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXor1x1[T]
  def xor[T](
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays: typingsJapgolly.cypress.typesLodashMod.List[T]
  ): js.Array[T]
  def xor[T](arrays2: __): LodashXor1x2[T]
  def xor[T](arrays2: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXor1x2[T]
  
  def xorBy[T](iteratee: ValueIteratee[T]): LodashXorBy1x3[T]
  def xorBy[T](iteratee: ValueIteratee[T], arrays: Null, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def xorBy[T](iteratee: ValueIteratee[T], arrays: Unit, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def xorBy[T](iteratee: ValueIteratee[T], arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x3[T]
  def xorBy[T](
    iteratee: ValueIteratee[T],
    arrays: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]
  ...
  def xorBy[T](iteratee: ValueIteratee[T], arrays: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x5[T]
  def xorBy[T](iteratee: __): LodashXorBy1x6[T]
  def xorBy[T](iteratee: __, arrays: Null, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x6[T]
  def xorBy[T](iteratee: __, arrays: Unit, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x6[T]
  def xorBy[T](iteratee: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x6[T]
  def xorBy[T](
    iteratee: __,
    arrays: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]
  ...
  def xorBy[T](iteratee: __, arrays: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x4[T]
  @JSName("xorBy")
  var xorBy_Original: LodashXorBy
  @JSName("xorBy")
  def xorBy_T_Array[T](iteratee: ValueIteratee[T]): js.Array[T]
  @JSName("xorBy")
  def xorBy_T_Array[T](iteratee: ValueIteratee[T], arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  @JSName("xorBy")
  ...
  @JSName("xorBy")
  def xorBy_T_LodashXorBy1x2[T](iteratee: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorBy1x2[T]
  
  def xorWith[T](comparator: Comparator[T]): LodashXorWith1x3[T]
  def xorWith[T](comparator: Comparator[T], arrays: Null, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def xorWith[T](comparator: Comparator[T], arrays: Unit, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  def xorWith[T](comparator: Comparator[T], arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x3[T]
  def xorWith[T](
    comparator: Comparator[T],
    arrays: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]
  ...
  def xorWith[T](comparator: Comparator[T], arrays: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x5[T]
  def xorWith[T](comparator: __): LodashXorWith1x6[T]
  def xorWith[T](comparator: __, arrays: Null, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x6[T]
  def xorWith[T](comparator: __, arrays: Unit, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x6[T]
  def xorWith[T](comparator: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x6[T]
  def xorWith[T](
    comparator: __,
    arrays: typingsJapgolly.cypress.typesLodashMod.List[T],
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]
  ...
  def xorWith[T](comparator: __, arrays: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x4[T]
  @JSName("xorWith")
  var xorWith_Original: LodashXorWith
  @JSName("xorWith")
  def xorWith_T_Array[T](comparator: Comparator[T]): js.Array[T]
  @JSName("xorWith")
  def xorWith_T_Array[T](comparator: Comparator[T], arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  @JSName("xorWith")
  ...
  @JSName("xorWith")
  def xorWith_T_LodashXorWith1x2[T](comparator: __, arrays: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashXorWith1x2[T]
  ...
  @JSName("xor")
  def xor_T_Array[T](arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): js.Array[T]
  
  def zip[T1](arrays1: typingsJapgolly.cypress.typesLodashMod.List[T1]): LodashZip1x1[T1]
  def zip[T2](arrays1: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashZip1x2[T2]
  def zip[T1, T2](
    arrays1: typingsJapgolly.cypress.typesLodashMod.List[T1],
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T2]
  ): js.Array[js.Tuple2[js.UndefOr[T1], js.UndefOr[T2]]]
  
  def zipAll[T](arrays: js.Array[js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null]]): js.Array[js.Array[js.UndefOr[T]]]
  def zipAll[T1, T2](
    arrays1: js.Tuple2[
      typingsJapgolly.cypress.typesLodashMod.List[T1], 
      typingsJapgolly.cypress.typesLodashMod.List[T2]
    ]
  ): js.Array[js.Tuple2[js.UndefOr[T1], js.UndefOr[T2]]]
  def zipAll[T1, T2, T3](
    arrays1: js.Tuple3[
      typingsJapgolly.cypress.typesLodashMod.List[T1], 
      typingsJapgolly.cypress.typesLodashMod.List[T2], 
      typingsJapgolly.cypress.typesLodashMod.List[T3]
    ]
  ...
  def zipAll[T1, T2, T3, T4](
    arrays1: js.Tuple4[
      ...
      typingsJapgolly.cypress.typesLodashMod.List[T2], 
      typingsJapgolly.cypress.typesLodashMod.List[T3], 
      typingsJapgolly.cypress.typesLodashMod.List[T4]
    ]
  ...
  def zipAll[T1, T2, T3, T4, T5](
    arrays1: js.Tuple5[
      ...
      typingsJapgolly.cypress.typesLodashMod.List[T3], 
      typingsJapgolly.cypress.typesLodashMod.List[T4], 
      typingsJapgolly.cypress.typesLodashMod.List[T5]
    ]
  ): js.Array[
  ...
  def zipObj(props: typingsJapgolly.cypress.typesLodashMod.List[PropertyName]): LodashZipObject1x1
  def zipObj[T](
    props: typingsJapgolly.cypress.typesLodashMod.List[PropertyName],
    values: typingsJapgolly.cypress.typesLodashMod.List[T]
  ): Dictionary[T]
  def zipObj[T](props: __, values: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashZipObject1x2[T]
  @JSName("zipObj")
  var zipObj_Original: LodashZipObject
  
  def zipObject(props: typingsJapgolly.cypress.typesLodashMod.List[PropertyName]): LodashZipObject1x1
  def zipObject[T](
    props: typingsJapgolly.cypress.typesLodashMod.List[PropertyName],
    values: typingsJapgolly.cypress.typesLodashMod.List[T]
  ): Dictionary[T]
  def zipObject[T](props: __, values: typingsJapgolly.cypress.typesLodashMod.List[T]): LodashZipObject1x2[T]
  
  def zipObjectDeep(paths: typingsJapgolly.cypress.typesLodashMod.List[PropertyPath]): LodashZipObjectDeep1x1
  def zipObjectDeep(
    paths: typingsJapgolly.cypress.typesLodashMod.List[PropertyPath],
    values: typingsJapgolly.cypress.typesLodashMod.List[Any]
  ): js.Object
  def zipObjectDeep(paths: __, values: typingsJapgolly.cypress.typesLodashMod.List[Any]): LodashZipObjectDeep1x2
  ...
  def zipWith[T1](iteratee: __, arrays1: typingsJapgolly.cypress.typesLodashMod.List[T1]): LodashZipWith1x2[T1]
  def zipWith[T2](iteratee: __, arrays1: __, arrays2: typingsJapgolly.cypress.typesLodashMod.List[T2]): LodashZipWith1x4[T2]
  def zipWith[T1, T2](
    iteratee: __,
    arrays1: typingsJapgolly.cypress.typesLodashMod.List[T1],
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T2]
...
object LoDashFp {
  ...
  inline def apply(
    ...
    compact: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.Array[Exclude[Any, js.UndefOr[Null | `false` | _empty | `0`]]],
    complement: /* predicate */ js.Function1[/* args */ js.Array[Any], Any] => js.Function1[/* args */ js.Array[Any], Boolean],
    compose: LodashFlowRight,
    concat: LodashConcat,
    cond: /* pairs */ js.Array[CondPair[Any, Any]] => js.Function1[/* Target */ Any, Any],
    ...
    first: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.UndefOr[Any],
    flatMap: LodashFlatMap,
    flatMapDeep: LodashFlatMapDeep,
    flatMapDepth: LodashFlatMapDepth,
    flatten: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Many[Any]] | Null] => js.Array[Any],
    ...
    has: LodashHas,
    hasIn: LodashHasIn,
    head: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.UndefOr[Any],
    identical: LodashEq,
    ...
    init: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.Array[Any],
    initial: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.Array[Any],
    ...
    last: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.UndefOr[Any],
    ...
    max: /* collection */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.UndefOr[Any],
    maxBy: LodashMaxBy,
    mean: /* collection */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => Double,
    meanBy: LodashMeanBy,
    ...
    min: /* collection */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.UndefOr[Any],
    minBy: LodashMinBy,
    multiply: LodashMultiply,
    nAry: LodashAry,
    negate: /* predicate */ js.Function1[/* args */ js.Array[Any], Any] => js.Function1[/* args */ js.Array[Any], Boolean],
    noConflict: CallbackTo[TypeofcypressTypesLodas],
    noop: LodashNoop,
  ...
  extension [Self <: LoDashFp](x: Self) {
    ...
    inline def setCompact(
      value: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.Array[Exclude[Any, js.UndefOr[Null | `false` | _empty | `0`]]]
    ...
    inline def setCond(value: /* pairs */ js.Array[CondPair[Any, Any]] => js.Function1[/* Target */ Any, Any]): Self = StObject.set(x, "cond", js.Any.fromFunction1(value))
    ...
    inline def setFirst(
      value: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.UndefOr[Any]
    ...
    inline def setFlatten(
      value: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Many[Any]] | Null] => js.Array[Any]
    ...
    inline def setHead(
      value: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.UndefOr[Any]
    ): Self = StObject.set(x, "head", js.Any.fromFunction1(value))
    ...
    inline def setInit(
      value: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.Array[Any]
    ): Self = StObject.set(x, "init", js.Any.fromFunction1(value))
    
    inline def setInitial(
      value: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.Array[Any]
    ): Self = StObject.set(x, "initial", js.Any.fromFunction1(value))
    ...
    inline def setIsEmpty(value: /* value */ Any => Boolean): Self = StObject.set(x, "isEmpty", js.Any.fromFunction1(value))
    ...
    inline def setLast(
      value: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.UndefOr[Any]
    ): Self = StObject.set(x, "last", js.Any.fromFunction1(value))
    ...
    inline def setMax(
      value: /* collection */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.UndefOr[Any]
    ...
    inline def setMean(
      value: /* collection */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => Double
    ): Self = StObject.set(x, "mean", js.Any.fromFunction1(value))
    ...
    inline def setNoConflict(value: CallbackTo[TypeofcypressTypesLodas]): Self = StObject.set(x, "noConflict", value.toJsFn)
    ...
    inline def setReverse(
      value: /* array */ typingsJapgolly.cypress.typesLodashMod.List[Any] => typingsJapgolly.cypress.typesLodashMod.List[Any]
    ): Self = StObject.set(x, "reverse", js.Any.fromFunction1(value))
    ...
    inline def setSortedUniq(
      value: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.Array[Any]
    ): Self = StObject.set(x, "sortedUniq", js.Any.fromFunction1(value))
    ...
    inline def setTail(
      value: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.Array[Any]
    ): Self = StObject.set(x, "tail", js.Any.fromFunction1(value))
    ...
    inline def setUniq(
      value: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Any] | Null] => js.Array[Any]
    ): Self = StObject.set(x, "uniq", js.Any.fromFunction1(value))
    ...
    inline def setUnnest(
      value: /* array */ js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[Many[Any]] | Null] => js.Array[Any]
    ): Self = StObject.set(x, "unnest", js.Any.fromFunction1(value))
    
    inline def setUnset(value: LodashUnset): Self = StObject.set(x, "unset", value.asInstanceOf[js.Any])
    
    inline def setUnzip(
      value: /* array */ js.UndefOr[
          js.Array[js.Array[Any]] | typingsJapgolly.cypress.typesLodashMod.List[typingsJapgolly.cypress.typesLodashMod.List[Any]] | Null
