...
import typingsJapgolly.cypress.cypressStrings.afterColonresponse
import typingsJapgolly.cypress.cypressStrings.beforeColonresponse
import typingsJapgolly.cypress.cypressStrings.response
