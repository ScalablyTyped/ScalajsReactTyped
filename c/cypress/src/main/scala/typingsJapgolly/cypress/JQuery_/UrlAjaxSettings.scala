...
import typingsJapgolly.cypress.JQuery_.Ajax.AjaxSettingsBase
import typingsJapgolly.cypress.JQuery_.Ajax.CompleteCallback
import typingsJapgolly.cypress.JQuery_.Ajax.ErrorCallback
import typingsJapgolly.cypress.JQuery_.Ajax.StatusCodeCallbacks
import typingsJapgolly.cypress.JQuery_.Ajax.SuccessCallback
import typingsJapgolly.cypress.JQuery_.Ajax.XHRFields
