...
object HandleObject {
  ...
  def apply[TTarget, TData](
    ...
    __obj.updateDynamic("handler")(js.Any.fromFunction2((t0: typingsJapgolly.cypress.JQuery_.TriggeredEvent[TTarget, TData, js.Any, js.Any], t1: /* repeated */ js.Any) => handler(t0, t1).runNow()))
