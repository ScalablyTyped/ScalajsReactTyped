...
object Effects {
  ...
  def apply(
    ...
    stop: Callback,
    tick: Callback,
    timer: TickFunction[js.Any] => Callback
  ): Effects = {
    val __obj = js.Dynamic.literal(interval = interval.asInstanceOf[js.Any], off = off.asInstanceOf[js.Any], step = step.asInstanceOf[js.Any])
    __obj.updateDynamic("stop")(stop.toJsFn)
    __obj.updateDynamic("tick")(tick.toJsFn)
    __obj.updateDynamic("timer")(js.Any.fromFunction1((t0: typingsJapgolly.cypress.JQuery_.TickFunction[js.Any]) => timer(t0).runNow()))
