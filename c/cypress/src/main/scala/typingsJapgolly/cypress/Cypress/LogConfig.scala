...
object LogConfig {
  ...
  inline def apply(
    ...
    autoEnd: Boolean,
    consoleProps: CallbackTo[ObjectLike],
    displayName: String,
    end: Boolean,
    id: String,
    message: Any,
  ...
  extension [Self <: LogConfig](x: Self) {
    ...
    inline def setConsoleProps(value: CallbackTo[ObjectLike]): Self = StObject.set(x, "consoleProps", value.toJsFn)
