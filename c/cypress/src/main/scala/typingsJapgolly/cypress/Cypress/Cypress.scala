...
import typingsJapgolly.cypress.BufferType
...
import typingsJapgolly.cypress.anon.AddAll
import typingsJapgolly.cypress.anon.Debug
import typingsJapgolly.cypress.anon.Defaults
import typingsJapgolly.cypress.anon.GetContainsSelector
import typingsJapgolly.cypress.anon.GetSelector
...
import typingsJapgolly.cypress.anon.Title
import typingsJapgolly.cypress.anon.`10`
import typingsJapgolly.cypress.anon.`11`
...
import typingsJapgolly.cypress.cypressStrings.arch
import typingsJapgolly.cypress.cypressStrings.autoOpen
import typingsJapgolly.cypress.cypressStrings.baseUrl
import typingsJapgolly.cypress.cypressStrings.blockHosts
import typingsJapgolly.cypress.cypressStrings.browser
import typingsJapgolly.cypress.cypressStrings.browserUrl
import typingsJapgolly.cypress.cypressStrings.browsers
import typingsJapgolly.cypress.cypressStrings.bundled
import typingsJapgolly.cypress.cypressStrings.chromeWebSecurity
import typingsJapgolly.cypress.cypressStrings.clientCertificates
import typingsJapgolly.cypress.cypressStrings.clientRoute
...
import typingsJapgolly.cypress.cypressStrings.component
import typingsJapgolly.cypress.cypressStrings.configFile
import typingsJapgolly.cypress.cypressStrings.cypressBinaryRoot
import typingsJapgolly.cypress.cypressStrings.cypressEnv
import typingsJapgolly.cypress.cypressStrings.darwin
import typingsJapgolly.cypress.cypressStrings.defaultCommandTimeout
import typingsJapgolly.cypress.cypressStrings.devServerPublicPathRoute
import typingsJapgolly.cypress.cypressStrings.downloadsFolder
import typingsJapgolly.cypress.cypressStrings.e2e
import typingsJapgolly.cypress.cypressStrings.env
import typingsJapgolly.cypress.cypressStrings.excludeSpecPattern
import typingsJapgolly.cypress.cypressStrings.execTimeout
import typingsJapgolly.cypress.cypressStrings.experimentalFetchPolyfill
import typingsJapgolly.cypress.cypressStrings.experimentalInteractiveRunEvents
import typingsJapgolly.cypress.cypressStrings.experimentalModifyObstructiveThirdPartyCode
import typingsJapgolly.cypress.cypressStrings.experimentalSessionAndOrigin
import typingsJapgolly.cypress.cypressStrings.experimentalSourceRewriting
import typingsJapgolly.cypress.cypressStrings.experimentalStudio
import typingsJapgolly.cypress.cypressStrings.experimentalWebKitSupport
...
import typingsJapgolly.cypress.cypressStrings.hosts
import typingsJapgolly.cypress.cypressStrings.includeShadowDom
import typingsJapgolly.cypress.cypressStrings.indexHtmlFile
import typingsJapgolly.cypress.cypressStrings.isInteractive
import typingsJapgolly.cypress.cypressStrings.isNewProject
import typingsJapgolly.cypress.cypressStrings.isTextTerminal
import typingsJapgolly.cypress.cypressStrings.keystrokeDelay
...
import typingsJapgolly.cypress.cypressStrings.modifyObstructiveCode
import typingsJapgolly.cypress.cypressStrings.morgan
import typingsJapgolly.cypress.cypressStrings.namespace
...
import typingsJapgolly.cypress.cypressStrings.parentTestsFolder
import typingsJapgolly.cypress.cypressStrings.parentTestsFolderDisplay
import typingsJapgolly.cypress.cypressStrings.platform
import typingsJapgolly.cypress.cypressStrings.port
import typingsJapgolly.cypress.cypressStrings.projectId
import typingsJapgolly.cypress.cypressStrings.projectName
import typingsJapgolly.cypress.cypressStrings.projectRoot
import typingsJapgolly.cypress.cypressStrings.proxyUrl
import typingsJapgolly.cypress.cypressStrings.redirectionLimit
import typingsJapgolly.cypress.cypressStrings.remote
import typingsJapgolly.cypress.cypressStrings.repoRoot
import typingsJapgolly.cypress.cypressStrings.report_
import typingsJapgolly.cypress.cypressStrings.reporter
import typingsJapgolly.cypress.cypressStrings.reporterOptions
import typingsJapgolly.cypress.cypressStrings.reporterRoute
import typingsJapgolly.cypress.cypressStrings.reporterUrl
...
import typingsJapgolly.cypress.cypressStrings.retries
import typingsJapgolly.cypress.cypressStrings.screenshotOnRunFailure
import typingsJapgolly.cypress.cypressStrings.screenshotsFolder
import typingsJapgolly.cypress.cypressStrings.scrollBehavior
...
import typingsJapgolly.cypress.cypressStrings.slowTestThreshold
import typingsJapgolly.cypress.cypressStrings.socketId
import typingsJapgolly.cypress.cypressStrings.socketIoCookie
import typingsJapgolly.cypress.cypressStrings.socketIoRoute
import typingsJapgolly.cypress.cypressStrings.specPattern
import typingsJapgolly.cypress.cypressStrings.spec_
import typingsJapgolly.cypress.cypressStrings.specs
import typingsJapgolly.cypress.cypressStrings.strict
import typingsJapgolly.cypress.cypressStrings.supportFile
import typingsJapgolly.cypress.cypressStrings.supportFolder
import typingsJapgolly.cypress.cypressStrings.system
import typingsJapgolly.cypress.cypressStrings.taskTimeout
...
import typingsJapgolly.cypress.cypressStrings.testIsolation
...
import typingsJapgolly.cypress.cypressStrings.userAgent
import typingsJapgolly.cypress.cypressStrings.version
...
import typingsJapgolly.cypress.cypressStrings.xhrRoute
import typingsJapgolly.cypress.cypressStrings.xhrUrl
import typingsJapgolly.cypress.typesCyBlobUtilMod.BlobUtilStatic
import typingsJapgolly.cypress.typesCyBluebirdMod.BluebirdStatic
import typingsJapgolly.cypress.typesCyBluebirdMod.Promise
import typingsJapgolly.cypress.typesCyMinimatchMod.MinimatchOptions
...
import typingsJapgolly.cypress.typesSinonMod.SinonStatic
...
trait Cypress extends StObject {
  ...
  /**
    ...
    */
  var LocalStorage: typingsJapgolly.cypress.Cypress.LocalStorage = js.native
  ...
  @JSName("_")
  def _underscore[T](value: typingsJapgolly.cypress.typesLodashMod.List[T]): Collection[T] = js.native
  /**
    * Lodash library
    *
    * @see https://on.cypress.io/_
  ...
  /**
    ...
    */
  @JSName("_")
  def _underscore_TrapAny_Intersection[TrapAny /* <: typingsJapgolly.cypress.anon.TrapAny */](value: TrapAny): Collection[Any] & Function[Any] & Object[Any] & Primitive[Any] & String = js.native
  ...
  /**
    ...
    * @see https://on.cypress.io/catalog-of-events#App-Events
    */
  def off(action: windowColonconfirm, fn: js.Function1[/* text */ java.lang.String, `false` | Unit]): typingsJapgolly.cypress.Cypress.Cypress = js.native
  /**
    * These events come from Cypress as it issues commands and reacts to their state. These are all useful to listen to for debugging purposes.
    * @see https://on.cypress.io/catalog-of-events#App-Events
    */
  ...
  /**
    ...
    */
  @JSName("off")
  def off_urlchanged(action: urlColonchanged, fn: js.Function1[/* url */ java.lang.String, Unit]): typingsJapgolly.cypress.Cypress.Cypress = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("off")
  def off_windowalert(action: windowColonalert, fn: js.Function1[/* text */ java.lang.String, Unit]): typingsJapgolly.cypress.Cypress.Cypress = js.native
  @JSName("off")
  def off_windowalert(
  ...
  /**
    ...
    * @see https://on.cypress.io/catalog-of-events#App-Events
    */
  def on(action: windowColonconfirm, fn: js.Function1[/* text */ java.lang.String, `false` | Unit]): typingsJapgolly.cypress.Cypress.Cypress = js.native
  ...
  /**
    ...
    */
  @JSName("on")
  def on_urlchanged(action: urlColonchanged, fn: js.Function1[/* url */ java.lang.String, Unit]): typingsJapgolly.cypress.Cypress.Cypress = js.native
  /**
    * Fires whenever the viewport changes via a `cy.viewport()` or naturally when
    * Cypress resets the viewport to the default between tests. Useful for debugging purposes.
    * @see https://on.cypress.io/catalog-of-events#App-Events
  ...
  /**
    ...
    */
  @JSName("on")
  def on_windowalert(action: windowColonalert, fn: js.Function1[/* text */ java.lang.String, Unit]): typingsJapgolly.cypress.Cypress.Cypress = js.native
  @JSName("on")
  def on_windowalert(
    action: windowColonalert,
    fn: SinonSpyAgent[(SinonSpy[js.Array[Any], Any]) | (SinonStub[js.Array[Any], Any])]
  ...
  /**
    ...
    * @see https://on.cypress.io/catalog-of-events#App-Events
    */
  def once(action: windowColonconfirm, fn: js.Function1[/* text */ java.lang.String, `false` | Unit]): typingsJapgolly.cypress.Cypress.Cypress = js.native
  /**
    * These events come from Cypress as it issues commands and reacts to their state. These are all useful to listen to for debugging purposes.
    * @see https://on.cypress.io/catalog-of-events#App-Events
    */
  ...
  /**
    ...
    */
  @JSName("once")
  def once_urlchanged(action: urlColonchanged, fn: js.Function1[/* url */ java.lang.String, Unit]): typingsJapgolly.cypress.Cypress.Cypress = js.native
  /**
    * Fires whenever the viewport changes via a `cy.viewport()` or naturally when
    * Cypress resets the viewport to the default between tests. Useful for debugging purposes.
    * @see https://on.cypress.io/catalog-of-events#App-Events
  ...
  /**
    ...
    */
  @JSName("once")
  def once_windowalert(action: windowColonalert, fn: js.Function1[/* text */ java.lang.String, Unit]): typingsJapgolly.cypress.Cypress.Cypress = js.native
  @JSName("once")
