...
/**
  ...
  */
/* Inlined std.Partial<cypress.Cypress.Omit<cypress.Cypress.ResolvedConfigOptions<any>, cypress.Cypress.TestingType>> */
trait CoreConfigOptions extends StObject {
...
object CoreConfigOptions {
  
  inline def apply(): CoreConfigOptions = {
