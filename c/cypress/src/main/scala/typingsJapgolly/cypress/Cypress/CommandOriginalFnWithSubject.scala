...
@js.native
trait CommandOriginalFnWithSubject[T /* <: /* keyof cypress.Cypress.ChainableMethods<any> */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 88, starting with typingsJapgolly.cypress.cypressStrings.as, typingsJapgolly.cypress.cypressStrings.title, typingsJapgolly.cypress.cypressStrings.clearLocalStorage */ Any */, S] extends CallableFunction {
