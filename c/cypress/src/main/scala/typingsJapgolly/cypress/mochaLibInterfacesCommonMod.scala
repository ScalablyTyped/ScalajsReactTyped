...
import typingsJapgolly.cypress.Mocha.AsyncFunc
import typingsJapgolly.cypress.Mocha.Func
import typingsJapgolly.cypress.Mocha.MochaGlobals
...
object mochaLibInterfacesCommonMod {
  ...
  object TestFunctions {
    ...
    inline def apply(only: (Mocha, Test) => Test, retries: Double => Callback, skip: String => Callback): TestFunctions = {
      val __obj = js.Dynamic.literal(only = js.Any.fromFunction2(only), retries = js.Any.fromFunction1((t0: Double) => retries(t0).runNow()), skip = js.Any.fromFunction1((t0: String) => skip(t0).runNow()))
    ...
    extension [Self <: TestFunctions](x: Self) {
      ...
      inline def setRetries(value: Double => Callback): Self = StObject.set(x, "retries", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      
      inline def setSkip(value: String => Callback): Self = StObject.set(x, "skip", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    }
  }
}
