...
import typingsJapgolly.cypress.Cypress.ClientCertificate
import typingsJapgolly.cypress.Cypress.Nullable
import typingsJapgolly.cypress.Cypress.PluginConfigOptions
import typingsJapgolly.cypress.Cypress.PluginEvents
import typingsJapgolly.cypress.Cypress.scrollBehaviorOptions
...
/* Inlined cypress.Cypress.Omit<cypress.Cypress.CoreConfigOptions, 'indexHtmlFile'> */
trait OmitCoreConfigOptionsinde extends StObject {
...
object OmitCoreConfigOptionsinde {
  
  inline def apply(): OmitCoreConfigOptionsinde = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitCoreConfigOptionsinde]
  }
  
  extension [Self <: OmitCoreConfigOptionsinde](x: Self) {
