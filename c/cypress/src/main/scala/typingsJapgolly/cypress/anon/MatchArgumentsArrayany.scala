...
import typingsJapgolly.cypress.typesSinonMod.SinonMatcher
...
trait MatchArgumentsArrayany extends StObject {
  ...
  var flat: SinonMatcher | (/* import warning: importer.ImportType#apply Failed type conversion: <A, D extends number = 1>(this : A): std.Array<std.FlatArray<A, D>> extends object ? cypress.cypress/types/sinon.MatchArguments<<A, D extends number = 1>(this : A): std.Array<std.FlatArray<A, D>>> : never */ js.Any) | (js.ThisFunction0[/* this */ Any, js.Array[FlatArray[Any, typingsJapgolly.cypress.cypressInts.`1`]]])
...
object MatchArgumentsArrayany {
  ...
  extension [Self <: MatchArgumentsArrayany](x: Self) {
    ...
    inline def setEntriesCallbackTo(value: CallbackTo[IterableIterator[js.Tuple2[Double, Any]]]): Self = StObject.set(x, "entries", value.toJsFn)
    ...
    inline def setForEachFunction1(
      value: /* callbackfn */ js.Function3[/* value */ Any, /* index */ Double, /* array */ js.Array[Any], Unit] => Callback
    ): Self = StObject.set(x, "forEach", js.Any.fromFunction1((t0: /* callbackfn */ js.Function3[/* value */ Any, /* index */ Double, /* array */ js.Array[Any], Unit]) => value(t0).runNow()))
    ...
    inline def setJoinCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "join", value.toJsFn)
    ...
    inline def setKeysCallbackTo(value: CallbackTo[IterableIterator[Double]]): Self = StObject.set(x, "keys", value.toJsFn)
    ...
    inline def setPopCallbackTo(value: CallbackTo[js.UndefOr[Any]]): Self = StObject.set(x, "pop", value.toJsFn)
    ...
    inline def setReverseCallbackTo(value: CallbackTo[js.Array[Any]]): Self = StObject.set(x, "reverse", value.toJsFn)
    
    inline def setShift(
      value: SinonMatcher | (/* import warning: importer.ImportType#apply Failed type conversion: (): any | undefined extends object ? cypress.cypress/types/sinon.MatchArguments<(): any | undefined> : never */ js.Any) | js.Function0[js.UndefOr[Any]]
    ): Self = StObject.set(x, "shift", value.asInstanceOf[js.Any])
    
    inline def setShiftCallbackTo(value: CallbackTo[js.UndefOr[Any]]): Self = StObject.set(x, "shift", value.toJsFn)
    
    inline def setSlice(
      value: SinonMatcher | (/* import warning: importer.ImportType#apply Failed type conversion: (): std.Array<any> extends object ? cypress.cypress/types/sinon.MatchArguments<(): std.Array<any>> : never */ js.Any) | js.Function0[js.Array[Any]]
    ): Self = StObject.set(x, "slice", value.asInstanceOf[js.Any])
    
    inline def setSliceCallbackTo(value: CallbackTo[js.Array[Any]]): Self = StObject.set(x, "slice", value.toJsFn)
    ...
    inline def setSortCallbackTo(value: CallbackTo[MatchArgumentsArrayany]): Self = StObject.set(x, "sort", value.toJsFn)
    ...
    inline def setToLocaleStringCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "toLocaleString", value.toJsFn)
    
    inline def setToString_(
      value: SinonMatcher | (/* import warning: importer.ImportType#apply Failed type conversion: (): string extends object ? cypress.cypress/types/sinon.MatchArguments<(): string> : never */ js.Any) | js.Function0[String]
    ): Self = StObject.set(x, "toString", value.asInstanceOf[js.Any])
    
    inline def setToString_CallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "toString", value.toJsFn)
    ...
    inline def setValuesCallbackTo(value: CallbackTo[IterableIterator[Any]]): Self = StObject.set(x, "values", value.toJsFn)
  }
}
