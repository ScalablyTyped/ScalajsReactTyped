...
import typingsJapgolly.cypress.Cypress.HttpMethod
import typingsJapgolly.cypress.Cypress.RouteOptions
...
object PartialServerOptions {
  ...
  extension [Self <: PartialServerOptions](x: Self) {
    ...
    inline def setIgnore(value: /* xhr */ Request => Callback): Self = StObject.set(x, "ignore", js.Any.fromFunction1((t0: /* xhr */ Request) => value(t0).runNow()))
    ...
    inline def setOnAnyAbort(value: (/* route */ RouteOptions, /* proxy */ Any) => Callback): Self = StObject.set(x, "onAnyAbort", js.Any.fromFunction2((t0: /* route */ RouteOptions, t1: /* proxy */ Any) => (value(t0, t1)).runNow()))
    
    inline def setOnAnyAbortUndefined: Self = StObject.set(x, "onAnyAbort", js.undefined)
    
    inline def setOnAnyRequest(value: (/* route */ RouteOptions, /* proxy */ Any) => Callback): Self = StObject.set(x, "onAnyRequest", js.Any.fromFunction2((t0: /* route */ RouteOptions, t1: /* proxy */ Any) => (value(t0, t1)).runNow()))
    
    inline def setOnAnyRequestUndefined: Self = StObject.set(x, "onAnyRequest", js.undefined)
    
    inline def setOnAnyResponse(value: (/* route */ RouteOptions, /* proxy */ Any) => Callback): Self = StObject.set(x, "onAnyResponse", js.Any.fromFunction2((t0: /* route */ RouteOptions, t1: /* proxy */ Any) => (value(t0, t1)).runNow()))
