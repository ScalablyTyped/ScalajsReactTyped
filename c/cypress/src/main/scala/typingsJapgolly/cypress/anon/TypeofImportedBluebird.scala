...
import typingsJapgolly.cypress.typesBluebirdMod.Bluebird
import typingsJapgolly.cypress.typesBluebirdMod.ConcurrencyOption
import typingsJapgolly.cypress.typesBluebirdMod.CoroutineOptions
import typingsJapgolly.cypress.typesBluebirdMod.Disposer
import typingsJapgolly.cypress.typesBluebirdMod.FromNodeOptions
import typingsJapgolly.cypress.typesBluebirdMod.Inspection
import typingsJapgolly.cypress.typesBluebirdMod.IterateFunction
import typingsJapgolly.cypress.typesBluebirdMod.PromisifyAllOptions
import typingsJapgolly.cypress.typesBluebirdMod.PromisifyOptions
import typingsJapgolly.cypress.typesBluebirdMod.Resolvable
import typingsJapgolly.cypress.typesBluebirdMod.ResolvableProps
import typingsJapgolly.cypress.typesBluebirdMod.Resolver
...
trait TypeofImportedBluebird extends StObject {
  ...
  /**
    ...
    */
  var AggregateError: Instantiable0[typingsJapgolly.cypress.typesBluebirdMod.AggregateError] = js.native
  
  /**
    * Signals that an operation has been aborted or cancelled. The default reason used by `.cancel`.
    */
  var CancellationError: Instantiable0[typingsJapgolly.cypress.typesBluebirdMod.CancellationError] = js.native
  
  /**
    * returned by `Bluebird.disposer()`.
    */
  var Disposer: Instantiable0[typingsJapgolly.cypress.typesBluebirdMod.Disposer[js.Object]] = js.native
  ...
  /**
    ...
    */
  var OperationalError: Instantiable0[typingsJapgolly.cypress.typesBluebirdMod.OperationalError] = js.native
  
  /**
    * Signals that an operation has timed out. Used as a custom cancellation reason in `.timeout`.
    */
  var TimeoutError: Instantiable0[typingsJapgolly.cypress.typesBluebirdMod.TimeoutError] = js.native
