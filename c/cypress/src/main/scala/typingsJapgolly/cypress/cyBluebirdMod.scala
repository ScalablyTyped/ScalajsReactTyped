...
import typingsJapgolly.cypress.bluebirdMod.Bluebird
import typingsJapgolly.cypress.bluebirdMod.ConcurrencyOption
import typingsJapgolly.cypress.bluebirdMod.CoroutineOptions
import typingsJapgolly.cypress.bluebirdMod.Disposer
import typingsJapgolly.cypress.bluebirdMod.FromNodeOptions
import typingsJapgolly.cypress.bluebirdMod.IterateFunction
import typingsJapgolly.cypress.bluebirdMod.PromisifyAllOptions
import typingsJapgolly.cypress.bluebirdMod.PromisifyOptions
import typingsJapgolly.cypress.bluebirdMod.Resolvable
import typingsJapgolly.cypress.bluebirdMod.ResolvableProps
import typingsJapgolly.cypress.bluebirdMod.Resolver
...
object cyBluebirdMod extends js.Object {
  ...
  trait BluebirdStatic
    extends Instantiable1[
          ...
          typingsJapgolly.cypress.bluebirdMod.^[js.Object]
        ] {
    /**
      ...
      */
    var AggregateError: Instantiable0[typingsJapgolly.cypress.bluebirdMod.AggregateError] = js.native
    /**
      * Signals that an operation has been aborted or cancelled. The default reason used by `.cancel`.
      */
    var CancellationError: Instantiable0[typingsJapgolly.cypress.bluebirdMod.CancellationError] = js.native
    /**
      * returned by `Bluebird.disposer()`.
      */
    var Disposer: Instantiable0[typingsJapgolly.cypress.bluebirdMod.Disposer[js.Object]] = js.native
    /**
      ...
      */
    var OperationalError: Instantiable0[typingsJapgolly.cypress.bluebirdMod.OperationalError] = js.native
    /**
      * Signals that an operation has timed out. Used as a custom cancellation reason in `.timeout`.
      */
    var TimeoutError: Instantiable0[typingsJapgolly.cypress.bluebirdMod.TimeoutError] = js.native
    /**
