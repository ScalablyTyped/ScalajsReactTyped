...
package object Cypress {
  type Agent[T /* <: typingsJapgolly.cypress.sinonMod.SinonSpy */] = typingsJapgolly.cypress.cypressMod.Cypress.SinonSpyAgent[T] with T
  ...
  /**
    ...
    *
    ...
    ```
    */
  type cy = typingsJapgolly.cypress.cypressMod.Cypress.Chainable[js.UndefOr[scala.Nothing]]
}
