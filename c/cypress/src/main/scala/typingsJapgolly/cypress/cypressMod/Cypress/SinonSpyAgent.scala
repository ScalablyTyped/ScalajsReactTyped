...
import typingsJapgolly.cypress.cypressStrings.withArgs
...
trait SinonSpyAgent[A /* <: SinonSpy */] extends js.Object {
  ...
  /**
    ...
    */
  def withArgs(args: js.Any*): (Omit[A, typingsJapgolly.cypress.cypressStrings.withArgs]) with Agent[A] = js.native
}
