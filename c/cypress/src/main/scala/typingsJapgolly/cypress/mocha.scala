...
import typingsJapgolly.cypress.Cypress.TestConfigOverrides
import typingsJapgolly.cypress.Mocha.Interface
import typingsJapgolly.cypress.Mocha.MochaInstanceOptions
import typingsJapgolly.cypress.Mocha.Reporter
import typingsJapgolly.cypress.Mocha.ReporterConstructor
import typingsJapgolly.cypress.Mocha.RootHookObject
import typingsJapgolly.cypress.Mocha.Runner
import typingsJapgolly.cypress.Mocha.Suite
import typingsJapgolly.cypress.Mocha.reporters.Base_
import typingsJapgolly.cypress.NodeJS.EventEmitter
import typingsJapgolly.cypress.cypressStrings.`hook end`
import typingsJapgolly.cypress.cypressStrings.`post-require`
import typingsJapgolly.cypress.cypressStrings.`pre-require`
import typingsJapgolly.cypress.cypressStrings.`suite end`
import typingsJapgolly.cypress.cypressStrings.`test end`
import typingsJapgolly.cypress.cypressStrings.afterAll
import typingsJapgolly.cypress.cypressStrings.afterEach
import typingsJapgolly.cypress.cypressStrings.beforeAll
...
import typingsJapgolly.cypress.cypressStrings.pass
import typingsJapgolly.cypress.cypressStrings.passed
import typingsJapgolly.cypress.cypressStrings.pending
import typingsJapgolly.cypress.cypressStrings.ready
import typingsJapgolly.cypress.cypressStrings.require
import typingsJapgolly.cypress.cypressStrings.retry
import typingsJapgolly.cypress.cypressStrings.run
import typingsJapgolly.cypress.cypressStrings.slow
import typingsJapgolly.cypress.cypressStrings.start
import typingsJapgolly.cypress.cypressStrings.suite
import typingsJapgolly.cypress.cypressStrings.test
...
object Mocha {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cypress.cypressStrings.bdd
    - typingsJapgolly.cypress.cypressStrings.tdd
    - typingsJapgolly.cypress.cypressStrings.qunit
    - typingsJapgolly.cypress.cypressStrings.exports
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cypress.cypressStrings.Base
    - typingsJapgolly.cypress.cypressStrings.base_
    - typingsJapgolly.cypress.cypressStrings.Dot
    - typingsJapgolly.cypress.cypressStrings.dot_
    - typingsJapgolly.cypress.cypressStrings.TAP
    - typingsJapgolly.cypress.cypressStrings.tap_
    - typingsJapgolly.cypress.cypressStrings.JSON
    - typingsJapgolly.cypress.cypressStrings.json_
    - typingsJapgolly.cypress.cypressStrings.HTML
    - typingsJapgolly.cypress.cypressStrings.html_
    - typingsJapgolly.cypress.cypressStrings.List
    - typingsJapgolly.cypress.cypressStrings.list_
    - typingsJapgolly.cypress.cypressStrings.Min
    - typingsJapgolly.cypress.cypressStrings.min_
    - typingsJapgolly.cypress.cypressStrings.Spec
    - typingsJapgolly.cypress.cypressStrings.spec_
    - typingsJapgolly.cypress.cypressStrings.Nyan
    - typingsJapgolly.cypress.cypressStrings.nyan_
    - typingsJapgolly.cypress.cypressStrings.XUnit
    - typingsJapgolly.cypress.cypressStrings.xunit_
    - typingsJapgolly.cypress.cypressStrings.Markdown
    - typingsJapgolly.cypress.cypressStrings.markdown_
    - typingsJapgolly.cypress.cypressStrings.Progress
    - typingsJapgolly.cypress.cypressStrings.progress_
    - typingsJapgolly.cypress.cypressStrings.Landing
    - typingsJapgolly.cypress.cypressStrings.landing_
    - typingsJapgolly.cypress.cypressStrings.JSONStream
    - typingsJapgolly.cypress.cypressStrings.`json-stream`
  */
  ...
  object reporters {
    ...
    object Base_ {
      ...
      inline def apply(epilogue: Callback, failures: js.Array[Test], runner: Runner, stats: Stats): Base_ = {
        val __obj = js.Dynamic.literal(epilogue = epilogue.toJsFn, failures = failures.asInstanceOf[js.Any], runner = runner.asInstanceOf[js.Any], stats = stats.asInstanceOf[js.Any])
      ...
      extension [Self <: Base_](x: Self) {
        ...
        inline def setDone(
          value: (/* failures */ Double, /* fn */ js.UndefOr[js.Function1[/* failures */ Double, Unit]]) => Callback
        ): Self = StObject.set(x, "done", js.Any.fromFunction2((t0: /* failures */ Double, t1: /* fn */ js.UndefOr[js.Function1[/* failures */ Double, Unit]]) => (value(t0, t1)).runNow()))
        
        inline def setDoneUndefined: Self = StObject.set(x, "done", js.undefined)
        
        inline def setEpilogue(value: Callback): Self = StObject.set(x, "epilogue", value.toJsFn)
    ...
    object HTML_ {
      ...
      inline def apply(
        addCodeToggle: (HTMLLIElement, String) => Callback,
        epilogue: Callback,
        ...
        val __obj = js.Dynamic.literal(addCodeToggle = js.Any.fromFunction2((t0: HTMLLIElement, t1: String) => (addCodeToggle(t0, t1)).runNow()), epilogue = epilogue.toJsFn, failures = failures.asInstanceOf[js.Any], runner = runner.asInstanceOf[js.Any], stats = stats.asInstanceOf[js.Any], suiteURL = js.Any.fromFunction1(suiteURL), testURL = js.Any.fromFunction1(testURL))
        __obj.asInstanceOf[HTML_]
      }
      
      extension [Self <: HTML_](x: Self) {
        
        inline def setAddCodeToggle(value: (HTMLLIElement, String) => Callback): Self = StObject.set(x, "addCodeToggle", js.Any.fromFunction2((t0: HTMLLIElement, t1: String) => (value(t0, t1)).runNow()))
    ...
    object Progress_ {
      ...
      trait MochaOptions
        extends StObject
           with typingsJapgolly.cypress.Mocha.MochaOptions
      object MochaOptions {
        
        inline def apply(): typingsJapgolly.cypress.Mocha.reporters.Progress_.MochaOptions = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsJapgolly.cypress.Mocha.reporters.Progress_.MochaOptions]
        }
      }
    ...
    object XUnit_ {
      ...
      inline def apply(
        done: (Double, js.Function1[/* failures */ Double, Unit]) => Callback,
        epilogue: Callback,
        failures: js.Array[Test],
        runner: Runner,
        stats: Stats,
        ...
        val __obj = js.Dynamic.literal(done = js.Any.fromFunction2((t0: Double, t1: js.Function1[/* failures */ Double, Unit]) => (done(t0, t1)).runNow()), epilogue = epilogue.toJsFn, failures = failures.asInstanceOf[js.Any], runner = runner.asInstanceOf[js.Any], stats = stats.asInstanceOf[js.Any], test = js.Any.fromFunction1((t0: Test) => test(t0).runNow()), write = js.Any.fromFunction1((t0: String) => write(t0).runNow()))
      ...
      object MochaOptions {
        ...
        inline def apply(): typingsJapgolly.cypress.Mocha.reporters.XUnit_.MochaOptions = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsJapgolly.cypress.Mocha.reporters.XUnit_.MochaOptions]
        }
      }
      ...
      extension [Self <: XUnit_](x: Self) {
        ...
        inline def setDone(value: (Double, js.Function1[/* failures */ Double, Unit]) => Callback): Self = StObject.set(x, "done", js.Any.fromFunction2((t0: Double, t1: js.Function1[/* failures */ Double, Unit]) => (value(t0, t1)).runNow()))
        
        inline def setTest(value: Test => Callback): Self = StObject.set(x, "test", js.Any.fromFunction1((t0: Test) => value(t0).runNow()))
