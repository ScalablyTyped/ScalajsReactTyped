...
import typingsJapgolly.cypress.Cypress.ResolvedConfigOptions
import typingsJapgolly.cypress.Cypress.TestingType
import typingsJapgolly.cypress.anon.Absolute
import typingsJapgolly.cypress.anon.EndedAt
import typingsJapgolly.cypress.anon.PartialCypressRunOptions
import typingsJapgolly.cypress.cypressStrings.failed
import typingsJapgolly.cypress.cypressStrings.finished
...
object CypressCommandLine {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cypress.cypressStrings.before
    - typingsJapgolly.cypress.cypressStrings.beforeEach
    - typingsJapgolly.cypress.cypressStrings.afterEach
    - typingsJapgolly.cypress.cypressStrings.after
  */
  trait HookName extends StObject
  object HookName {
    
    inline def after: typingsJapgolly.cypress.cypressStrings.after = "after".asInstanceOf[typingsJapgolly.cypress.cypressStrings.after]
    
    inline def afterEach: typingsJapgolly.cypress.cypressStrings.afterEach = "afterEach".asInstanceOf[typingsJapgolly.cypress.cypressStrings.afterEach]
    
    inline def before: typingsJapgolly.cypress.cypressStrings.before = "before".asInstanceOf[typingsJapgolly.cypress.cypressStrings.before]
    
    inline def beforeEach: typingsJapgolly.cypress.cypressStrings.beforeEach = "beforeEach".asInstanceOf[typingsJapgolly.cypress.cypressStrings.beforeEach]
  }
