...
/* Inlined parent std.Pick<cypress.cypress/types/sinon.SinonSpyCallApi<TArgs, TReturnValue>, std.Exclude<keyof cypress.cypress/types/sinon.SinonSpyCallApi<TArgs, TReturnValue>, 'args'>> */
@js.native
