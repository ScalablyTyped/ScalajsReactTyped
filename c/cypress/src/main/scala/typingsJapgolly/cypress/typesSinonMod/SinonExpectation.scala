...
import typingsJapgolly.cypress.anon.MatchArgumentsArrayany
import typingsJapgolly.cypress.anon.PartialMatchArgumentsArra
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined parent cypress.cypress/types/sinon.SinonStub<std.Array<any>, any> */
@js.native
trait SinonExpectation extends StObject {
  ...
  def callArgOn(pos: Double, obj: Any, args: Any*): Unit = js.native
  
  def callArgOnWith(pos: Double, obj: Any, args: Any*): Unit = js.native
  @JSName("callArgOnWith")
  var callArgOnWith_Original: js.Function3[/* pos */ Double, /* obj */ Any, /* repeated */ Any, Unit] = js.native
  
  @JSName("callArgOn")
  var callArgOn_Original: js.Function3[/* pos */ Double, /* obj */ Any, /* repeated */ Any, Unit] = js.native
  
  def callArgWith(pos: Double, args: Any*): Unit = js.native
  @JSName("callArgWith")
  var callArgWith_Original: js.Function2[/* pos */ Double, /* repeated */ Any, Unit] = js.native
  ...
  var calledWithMatch_Original: js.Function1[/* args */ js.Array[Any], Boolean] = js.native
  ...
  /**
    ...
    * @param name
    */
  def named(name: String): SinonStub[js.Array[Any], Any] = js.native
  /**
    * Set the displayName of the spy or stub.
    * @param name
    */
  @JSName("named")
  def named_SinonSpy(name: String): SinonSpy[js.Array[Any], Any] = js.native
  ...
  var notCalledWithMatch_Original: js.Function1[/* args */ js.Array[Any], Boolean] = js.native
  ...
  def `yield`(args: Any*): Unit = js.native
  
  def yieldOn(obj: Any, args: Any*): Unit = js.native
  @JSName("yieldOn")
  var yieldOn_Original: js.Function2[/* obj */ Any, /* repeated */ Any, Unit] = js.native
  
  def yieldTo(property: String, args: Any*): Unit = js.native
  
  def yieldToOn(property: String, obj: Any, args: Any*): Unit = js.native
  @JSName("yieldToOn")
  var yieldToOn_Original: js.Function3[/* property */ String, /* obj */ Any, /* repeated */ Any, Unit] = js.native
  
  @JSName("yieldTo")
  var yieldTo_Original: js.Function2[/* property */ String, /* repeated */ Any, Unit] = js.native
  
  @JSName("yield")
  var yield_Original: js.Function1[/* repeated */ Any, Unit] = js.native
