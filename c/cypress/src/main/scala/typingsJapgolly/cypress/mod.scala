...
import typingsJapgolly.cypress.Cypress.ConfigOptions
import typingsJapgolly.cypress.CypressCommandLine.CypressCliParser
...
import typingsJapgolly.cypress.anon.PartialCypressOpenOptions
import typingsJapgolly.cypress.anon.PartialCypressRunOptions
