...
import typingsJapgolly.cypress.JQuery_.Coordinates
import typingsJapgolly.cypress.JQuery_.CoordinatesPartial
import typingsJapgolly.cypress.JQuery_.Duration
import typingsJapgolly.cypress.JQuery_.EffectsOptions
import typingsJapgolly.cypress.JQuery_.NameValuePair
import typingsJapgolly.cypress.JQuery_.Node
...
import typingsJapgolly.cypress.JQuery_.TypeEventHandler
import typingsJapgolly.cypress.JQuery_.TypeEventHandlers
...
trait JQuery__[TElement]
  ...
  ```
    */
  def insertAfter(target: Selector | TypeOrArray[typingsJapgolly.std.Node] | htmlString): this.type = js.native
  def insertAfter(target: JQuery_[typingsJapgolly.std.Node]): this.type = js.native
  /**
  ...
  ```
    */
  def insertBefore(target: Selector | TypeOrArray[typingsJapgolly.std.Node] | htmlString): this.type = js.native
  def insertBefore(target: JQuery_[typingsJapgolly.std.Node]): this.type = js.native
  def is(
  ...
  def trigger(eventType_event: typingsJapgolly.cypress.JQuery_.Event): this.type = js.native
  def trigger(eventType_event: typingsJapgolly.cypress.JQuery_.Event, extraParameters: String): this.type = js.native
  def trigger(eventType_event: typingsJapgolly.cypress.JQuery_.Event, extraParameters: js.Array[_]): this.type = js.native
  def trigger(eventType_event: typingsJapgolly.cypress.JQuery_.Event, extraParameters: Boolean): this.type = js.native
  def trigger(eventType_event: typingsJapgolly.cypress.JQuery_.Event, extraParameters: Double): this.type = js.native
  def trigger(eventType_event: typingsJapgolly.cypress.JQuery_.Event, extraParameters: PlainObject[_]): this.type = js.native
  /**
  ...
  def triggerHandler(eventType_event: typingsJapgolly.cypress.JQuery_.Event): js.Any = js.native
  def triggerHandler(eventType_event: typingsJapgolly.cypress.JQuery_.Event, extraParameters: String): js.Any = js.native
  def triggerHandler(eventType_event: typingsJapgolly.cypress.JQuery_.Event, extraParameters: js.Array[_]): js.Any = js.native
  def triggerHandler(eventType_event: typingsJapgolly.cypress.JQuery_.Event, extraParameters: Boolean): js.Any = js.native
  def triggerHandler(eventType_event: typingsJapgolly.cypress.JQuery_.Event, extraParameters: Double): js.Any = js.native
  def triggerHandler(eventType_event: typingsJapgolly.cypress.JQuery_.Event, extraParameters: PlainObject[_]): js.Any = js.native
  /**
