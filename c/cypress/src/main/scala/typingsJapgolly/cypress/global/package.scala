...
import typingsJapgolly.cypress.BrowserMocha
import typingsJapgolly.cypress.Chai.AssertStatic
import typingsJapgolly.cypress.Chai.ExpectStatic
...
import typingsJapgolly.cypress.Mocha.PendingSuiteFunction
...
import typingsJapgolly.cypress.SymbolConstructor
...
inline def _empty: JQueryStatic = js.Dynamic.global.selectDynamic("$").asInstanceOf[JQueryStatic]
...
inline def assert: AssertStatic = js.Dynamic.global.selectDynamic("assert").asInstanceOf[AssertStatic]
...
inline def cy: typingsJapgolly.cypress.Cypress.cy & CyEventEmitter = js.Dynamic.global.selectDynamic("cy").asInstanceOf[typingsJapgolly.cypress.Cypress.cy & CyEventEmitter]
...
inline def expect: ExpectStatic = js.Dynamic.global.selectDynamic("expect").asInstanceOf[ExpectStatic]
...
inline def jQuery: JQueryStatic = js.Dynamic.global.selectDynamic("jQuery").asInstanceOf[JQueryStatic]
