...
import typingsJapgolly.cypress.Mocha
import typingsJapgolly.cypress.Mocha.AsyncFunc
import typingsJapgolly.cypress.Mocha.Func
import typingsJapgolly.cypress.Mocha.HookFunction
import typingsJapgolly.cypress.Mocha.MochaOptions
import typingsJapgolly.cypress.Mocha.PendingTestFunction
...
import typingsJapgolly.cypress.Mocha.SuiteConstants
import typingsJapgolly.cypress.Mocha.SuiteFunction
import typingsJapgolly.cypress.Mocha.Test
import typingsJapgolly.cypress.Mocha.TestFunction
...
object Mocha_ {
  ...
  open class Context ()
    extends StObject
       with typingsJapgolly.cypress.Mocha.Context
  ...
  open class Runnable protected ()
    extends StObject
       with typingsJapgolly.cypress.Mocha.Runnable {
  ...
  open class Suite_ protected ()
    extends StObject
       with Suite {
    def this(title: String) = this()
    def this(title: String, parentContext: typingsJapgolly.cypress.Mocha.Context) = this()
  }
  object Suite_ {
