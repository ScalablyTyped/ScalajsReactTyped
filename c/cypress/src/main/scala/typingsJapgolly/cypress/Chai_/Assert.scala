...
import typingsJapgolly.cypress.AnonLength
import typingsJapgolly.cypress.Object
...
trait Assert extends js.Object {
  ...
  /**
    ...
    * @param message   Message to display on error.
    */
  def lengthOf[T /* <: AnonLength */](`object`: T, length: Double): Unit = js.native
  def lengthOf[T /* <: AnonLength */](`object`: T, length: Double, message: String): Unit = js.native
  /**
