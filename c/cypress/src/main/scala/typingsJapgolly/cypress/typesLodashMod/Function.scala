...
trait Function[T]
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T1](arg1: T1, plc2: __, plc3: __): Function[
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T3](arg3: T3, plc4: __): Function[
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T4](arg4: T4): Function[
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T2, T3](arg2: T2, arg3: T3): Function[
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T2, T3](arg2: T2, arg3: T3, plc4: __): Function[
  ...
  /**
    ...
    */
  @JSName("partialRight")
  def partialRight_T1T2[T1, T2](arg1: T1, arg2: T2, plc3: __): Function[
  ...
  /**
    ...
    */
  @JSName("partialRight")
  def partialRight_T2[T2](arg2: T2, plc3: __): Function[
  ...
  /**
    ...
    */
  @JSName("partialRight")
  def partialRight_T2[T2](arg2: T2, plc3: __, plc4: __): Function[
  ...
  /**
    ...
    */
  @JSName("partialRight")
  def partialRight_T3T4[T3, T4](arg3: T3, arg4: T4): Function[
    /* import warning: importer.ImportType#apply Failed type conversion: T extends cypress.cypress/types/lodash.Function4<infer T1, infer T2, T3, T4, infer R> ? cypress.cypress/types/lodash.Function2<T1, T2, R> : any */ js.Any
  ] = js.native
  /**
    * @see _.partialRight
