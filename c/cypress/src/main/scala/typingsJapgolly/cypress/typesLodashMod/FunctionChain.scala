...
trait FunctionChain[T]
  ...
  /**
    * @see _.debounce
    */
  def debounce(): /* import warning: importer.ImportType#apply Failed type conversion: T extends (args : ...any): any ? cypress.cypress/types/lodash.FunctionChain<cypress.cypress/types/lodash.DebouncedFunc<T>> : never */ js.Any = js.native
  def debounce(wait: Double): /* import warning: importer.ImportType#apply Failed type conversion: T extends (args : ...any): any ? cypress.cypress/types/lodash.FunctionChain<cypress.cypress/types/lodash.DebouncedFunc<T>> : never */ js.Any = js.native
  def debounce(wait: Double, options: DebounceSettings): /* import warning: importer.ImportType#apply Failed type conversion: T extends (args : ...any): any ? cypress.cypress/types/lodash.FunctionChain<cypress.cypress/types/lodash.DebouncedFunc<T>> : never */ js.Any = js.native
  def debounce(wait: Unit, options: DebounceSettings): /* import warning: importer.ImportType#apply Failed type conversion: T extends (args : ...any): any ? cypress.cypress/types/lodash.FunctionChain<cypress.cypress/types/lodash.DebouncedFunc<T>> : never */ js.Any = js.native
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T3](arg3: T3, plc4: __): FunctionChain[
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T3, T4](arg3: T3, arg4: T4): FunctionChain[
    /* import warning: importer.ImportType#apply Failed type conversion: T extends cypress.cypress/types/lodash.Function4<infer T1, infer T2, T3, T4, infer R> ? cypress.cypress/types/lodash.Function2<T1, T2, R> : any */ js.Any
  ] = js.native
  /**
    * @see _.partialRight
  ...
  /**
    ...
    */
  @JSName("partialRight")
  def partialRight_T1[T1](arg1: T1, plc2: __): FunctionChain[
  ...
  /**
    ...
    */
  @JSName("partialRight")
  def partialRight_T2T3[T2, T3](arg2: T2, arg3: T3): FunctionChain[
  ...
  /**
    * @see _.throttle
    */
  def throttle(): /* import warning: importer.ImportType#apply Failed type conversion: T extends (args : ...any): any ? cypress.cypress/types/lodash.FunctionChain<cypress.cypress/types/lodash.DebouncedFunc<T>> : never */ js.Any = js.native
  def throttle(wait: Double): /* import warning: importer.ImportType#apply Failed type conversion: T extends (args : ...any): any ? cypress.cypress/types/lodash.FunctionChain<cypress.cypress/types/lodash.DebouncedFunc<T>> : never */ js.Any = js.native
  def throttle(wait: Double, options: ThrottleSettings): /* import warning: importer.ImportType#apply Failed type conversion: T extends (args : ...any): any ? cypress.cypress/types/lodash.FunctionChain<cypress.cypress/types/lodash.DebouncedFunc<T>> : never */ js.Any = js.native
  def throttle(wait: Unit, options: ThrottleSettings): /* import warning: importer.ImportType#apply Failed type conversion: T extends (args : ...any): any ? cypress.cypress/types/lodash.FunctionChain<cypress.cypress/types/lodash.DebouncedFunc<T>> : never */ js.Any = js.native
