...
import typingsJapgolly.cypress.GlobalFunction
import typingsJapgolly.cypress.GlobalPartial
...
type ListOfRecursiveArraysOrValues[T] = typingsJapgolly.cypress.typesLodashMod.List[T | RecursiveArray[T]]
