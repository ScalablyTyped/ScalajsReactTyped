...
trait ObjectChain[T]
  ...
  /**
    * @see _.get
    */
  def get[TKey /* <: /* keyof T */ java.lang.String */](path: TKey, defaultValue: js.Array[scala.Nothing]): /* import warning: importer.ImportType#apply Failed type conversion: T[TKey] extends std.Array<any> ? cypress.cypress/types/lodash.ExpChain<std.Exclude<T[TKey], undefined>> : cypress.cypress/types/lodash.ExpChain<std.Exclude<T[TKey], undefined> | std.Array<never>> */ js.Any = js.native
  ...
  def get[TKey /* <: /* keyof T */ java.lang.String */](path: js.Array[TKey], defaultValue: js.Array[scala.Nothing]): /* import warning: importer.ImportType#apply Failed type conversion: T[TKey] extends std.Array<any> ? cypress.cypress/types/lodash.ExpChain<std.Exclude<T[TKey], undefined>> : cypress.cypress/types/lodash.ExpChain<std.Exclude<T[TKey], undefined> | std.Array<never>> */ js.Any = js.native
  ...
  /**
    * @see _.get
    */
  def get[TKey1 /* <: /* keyof T */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof T[TKey1] */ js.Any */](path: js.Tuple2[TKey1, TKey2], defaultValue: js.Array[scala.Nothing]): /* import warning: importer.ImportType#apply Failed type conversion: T[TKey1][TKey2] extends std.Array<any> ? cypress.cypress/types/lodash.ExpChain<std.Exclude<T[TKey1][TKey2], undefined>> : cypress.cypress/types/lodash.ExpChain<std.Exclude<T[TKey1][TKey2], undefined> | std.Array<never>> */ js.Any = js.native
  /**
    * @see _.get
    */
  ...
  /**
    * @see _.get
    */
  def get[TKey1 /* <: /* keyof T */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof T[TKey1] */ js.Any */, TKey3 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof T[TKey1][TKey2] */ js.Any */](path: js.Tuple3[TKey1, TKey2, TKey3], defaultValue: js.Array[scala.Nothing]): /* import warning: importer.ImportType#apply Failed type conversion: T[TKey1][TKey2][TKey3] extends std.Array<any> ? cypress.cypress/types/lodash.ExpChain<std.Exclude<T[TKey1][TKey2][TKey3], undefined>> : cypress.cypress/types/lodash.ExpChain<std.Exclude<T[TKey1][TKey2][TKey3], undefined> | std.Array<never>> */ js.Any = js.native
  /**
    * @see _.get
    */
  ...
  /**
    * @see _.get
    */
  def get[TKey1 /* <: /* keyof T */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof T[TKey1] */ js.Any */, TKey3 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof T[TKey1][TKey2] */ js.Any */, TKey4 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof T[TKey1][TKey2][TKey3] */ js.Any */](path: js.Tuple4[TKey1, TKey2, TKey3, TKey4], defaultValue: js.Array[scala.Nothing]): /* import warning: importer.ImportType#apply Failed type conversion: T[TKey1][TKey2][TKey3][TKey4] extends std.Array<any> ? cypress.cypress/types/lodash.ExpChain<std.Exclude<T[TKey1][TKey2][TKey3][TKey4], undefined>> : cypress.cypress/types/lodash.ExpChain<std.Exclude<T[TKey1][TKey2][TKey3][TKey4], undefined> | std.Array<never>> */ js.Any = js.native
  /**
    * @see _.get
    */
  ...
  def pickBy[S /* <: /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any */](
    ...
    /* import warning: importer.ImportType#apply Failed type conversion: cypress.cypress/types/lodash.NumericDictionary<unknown> extends T ? cypress.cypress/types/lodash.NumericDictionary<S> : cypress.cypress/types/lodash.Dictionary<S> */ js.Any
  ] = js.native
  ...
  def transform(): ExpChain[
    /* import warning: importer.ImportType#apply Failed type conversion: T extends cypress.cypress/types/lodash.Dictionary<unknown> ? cypress.cypress/types/lodash.Dictionary<any> : T */ js.Any
  ] = js.native
  /**
    * @see _.transform
    */
