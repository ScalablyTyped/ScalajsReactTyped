...
trait Collection[T]
  ...
  /**
    * @see _.difference
    */
  def difference(values: typingsJapgolly.cypress.typesLodashMod.List[T]*): Collection[T] = js.native
  
  /**
    * @see _.differenceBy
    */
  def differenceBy(values: (typingsJapgolly.cypress.typesLodashMod.List[Any] | ValueIteratee[T])*): Collection[T] = js.native
  /**
    * @see _.differenceBy
    */
  def differenceBy[T2](values1: typingsJapgolly.cypress.typesLodashMod.List[T2]): Collection[T] = js.native
  def differenceBy[T2](values1: typingsJapgolly.cypress.typesLodashMod.List[T2], iteratee: ValueIteratee[T | T2]): Collection[T] = js.native
  
  /**
    * @see _.differenceWith
    */
  def differenceWith[T2](values: typingsJapgolly.cypress.typesLodashMod.List[T2], comparator: Comparator2[T, T2]): Collection[T] = js.native
  /**
    * @see _.differenceWith
    */
  def differenceWith[T2, T3, T4](values: (typingsJapgolly.cypress.typesLodashMod.List[Any] | (Comparator2[T, scala.Nothing]))*): Collection[T] = js.native
  ...
  def each(iteratee: ListIterator[T, Any]): Collection[T] = js.native
  
  /**
    * @see _.eachRight
    */
  def eachRight(): Collection[T] = js.native
  def eachRight(iteratee: ListIterator[T, Any]): Collection[T] = js.native
  /**
    * @see _.eachRight
    */
  @JSName("eachRight")
  var eachRight_Original: js.Function1[/* iteratee */ js.UndefOr[ListIterator[T, Any]], Collection[T]] = js.native
  
  /**
    * @see _.each
    */
  @JSName("each")
  var each_Original: js.Function1[/* iteratee */ js.UndefOr[ListIterator[T, Any]], Collection[T]] = js.native
  ...
  /**
    * @see _.flatMap
    */
  def flatMap(): /* import warning: importer.ImportType#apply Failed type conversion: T extends cypress.cypress/types/lodash.Many<infer U> ? cypress.cypress/types/lodash.Collection<U> : cypress.cypress/types/lodash.Collection<T> */ js.Any = js.native
  ...
  /**
    * @see _.flatten
    */
  def flatten(): /* import warning: importer.ImportType#apply Failed type conversion: T extends cypress.cypress/types/lodash.Many<infer U> ? cypress.cypress/types/lodash.Collection<U> : cypress.cypress/types/lodash.Collection<T> */ js.Any = js.native
  
  /**
    * @see _.flattenDeep
    */
  def flattenDeep(): /* import warning: importer.ImportType#apply Failed type conversion: T extends cypress.cypress/types/lodash.ListOfRecursiveArraysOrValues<infer U> ? cypress.cypress/types/lodash.Collection<cypress.cypress/types/lodash.Flat<U>> : cypress.cypress/types/lodash.Collection<T> */ js.Any = js.native
  ...
  def forEach(iteratee: ListIterator[T, Any]): Collection[T] = js.native
  
  /**
    * @see _.forEachRight
    */
  def forEachRight(): Collection[T] = js.native
  def forEachRight(iteratee: ListIterator[T, Any]): Collection[T] = js.native
  
  /**
    * @see _.fromPairs
    */
  def fromPairs(): Object[
    Dictionary[
      /* import warning: importer.ImportType#apply Failed type conversion: T extends [cypress.cypress/types/lodash.PropertyName, infer U] ? U : any */ js.Any
    ]
  ] = js.native
  ...
  /**
    * @see _.intersection
    */
  def intersection(arrays: (js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null])*): Collection[T] = js.native
  
  /**
    * @see _.intersectionBy
    */
  def intersectionBy(values: (typingsJapgolly.cypress.typesLodashMod.List[Any] | ValueIteratee[T])*): Collection[T] = js.native
  /**
    * @see _.intersectionBy
    */
  def intersectionBy[T2](values: typingsJapgolly.cypress.typesLodashMod.List[T2], iteratee: ValueIteratee[T | T2]): Collection[T] = js.native
  
  /**
    * @see _.intersectionWith
    */
  def intersectionWith(values: (typingsJapgolly.cypress.typesLodashMod.List[Any] | (Comparator2[T, scala.Nothing]))*): Collection[T] = js.native
  /**
    * @see _.intersectionWith
    */
  def intersectionWith[T2](values: typingsJapgolly.cypress.typesLodashMod.List[T2], comparator: Comparator2[T, T2]): Collection[T] = js.native
  ...
  /**
    * @see _.mapValues
    */
  def mapValues(iteratee: java.lang.String): Object[Dictionary[Any]] = js.native
  /**
    * @see _.mapValues
    */
  ...
  /**
    ...
    */
  @JSName("map")
  def map_K[K /* <: /* keyof T */ java.lang.String */](key: K): Collection[
  ...
  /**
    * @see _.over
    */
  def over[TResult](iteratees: (Many[js.Function1[/* repeated */ Any, TResult]])*): Function[js.Function1[/* repeated */ Any, js.Array[TResult]]] = js.native
  ...
  def pullAll(values: typingsJapgolly.cypress.typesLodashMod.List[T]): Collection[T] = js.native
  ...
  def pullAllBy[T2](values: typingsJapgolly.cypress.typesLodashMod.List[T2]): Collection[T] = js.native
  def pullAllBy[T2](values: typingsJapgolly.cypress.typesLodashMod.List[T2], iteratee: ValueIteratee[T | T2]): Collection[T] = js.native
  ...
  def pullAllWith[T2](values: typingsJapgolly.cypress.typesLodashMod.List[T2]): Collection[T] = js.native
  def pullAllWith[T2](values: typingsJapgolly.cypress.typesLodashMod.List[T2], comparator: Comparator2[T, T2]): Collection[T] = js.native
  ...
  /**
    * @see _.reduce
    */
  def reduce(callback: MemoListIterator[T, T, typingsJapgolly.cypress.typesLodashMod.List[T]]): js.UndefOr[T] = js.native
  /**
    * @see _.reduce
    */
  def reduce[TResult](
    callback: MemoListIterator[T, TResult, typingsJapgolly.cypress.typesLodashMod.List[T]],
    accumulator: TResult
  ): TResult = js.native
  ...
  /**
    * @see _.reduceRight
    */
  def reduceRight(callback: MemoListIterator[T, T, typingsJapgolly.cypress.typesLodashMod.List[T]]): js.UndefOr[T] = js.native
  /**
    * @see _.reduceRight
    */
  ...
  /**
    * @see _.transform
    */
  def transform(): Collection[Any] = js.native
  /**
    * @see _.transform
    */
  ...
  /**
    * @see _.union
    */
  def union(arrays: (js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null])*): Collection[T] = js.native
  ...
  def unionBy(arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): Collection[T] = js.native
  def unionBy(arrays2: typingsJapgolly.cypress.typesLodashMod.List[T], iteratee: ValueIteratee[T]): Collection[T] = js.native
  /**
    * @see _.unionBy
    */
  def unionBy(iteratee: (js.UndefOr[ValueIteratee[T] | typingsJapgolly.cypress.typesLodashMod.List[T] | Null])*): Collection[T] = js.native
  ...
  def unionWith(arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): Collection[T] = js.native
  def unionWith(arrays2: typingsJapgolly.cypress.typesLodashMod.List[T], comparator: Comparator[T]): Collection[T] = js.native
  /**
    * @see _.unionWith
    */
  def unionWith(comparator: (js.UndefOr[Comparator[T] | typingsJapgolly.cypress.typesLodashMod.List[T] | Null])*): Collection[T] = js.native
  ...
  /**
    * @see _.unzip
    */
  def unzip(): /* import warning: importer.ImportType#apply Failed type conversion: T extends cypress.cypress/types/lodash.List<infer U> ? cypress.cypress/types/lodash.Collection<std.Array<U>> : unknown */ js.Any = js.native
  
  /**
    * @see _.unzipWith
    */
  def unzipWith(): /* import warning: importer.ImportType#apply Failed type conversion: T extends cypress.cypress/types/lodash.List<infer U> ? cypress.cypress/types/lodash.Collection<std.Array<U>> : unknown */ js.Any = js.native
  /**
    * @see _.unzipWith
    */
  def unzipWith[TResult](
    iteratee: js.Function1[
      /* import warning: importer.ImportType#apply Failed type conversion: T extends cypress.cypress/types/lodash.List<infer U> ? U : unknown */ /* repeated */ js.Any, 
      TResult
    ]
  ...
  /**
    * @see _.xor
    */
  def xor(arrays: (js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null])*): Collection[T] = js.native
  ...
  def xorBy(arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): Collection[T] = js.native
  def xorBy(arrays2: typingsJapgolly.cypress.typesLodashMod.List[T], iteratee: ValueIteratee[T]): Collection[T] = js.native
  /**
    * @see _.xorBy
    */
  def xorBy(iteratee: (js.UndefOr[ValueIteratee[T] | typingsJapgolly.cypress.typesLodashMod.List[T] | Null])*): Collection[T] = js.native
  ...
  def xorWith(arrays2: typingsJapgolly.cypress.typesLodashMod.List[T]): Collection[T] = js.native
  def xorWith(arrays2: typingsJapgolly.cypress.typesLodashMod.List[T], comparator: Comparator[T]): Collection[T] = js.native
  /**
    * @see _.xorWith
    */
  def xorWith(comparator: (js.UndefOr[Comparator[T] | typingsJapgolly.cypress.typesLodashMod.List[T] | Null])*): Collection[T] = js.native
  
  /**
    * @see _.zip
    */
  def zip(arrays: (js.UndefOr[typingsJapgolly.cypress.typesLodashMod.List[T] | Null])*): Collection[js.Array[js.UndefOr[T]]] = js.native
  /**
    * @see _.zip
    */
  def zip[T2](arrays2: typingsJapgolly.cypress.typesLodashMod.List[T2]): Collection[js.Tuple2[js.UndefOr[T], js.UndefOr[T2]]] = js.native
  ...
  /**
    * @see _.zipObject
    */
  def zipObject[U](values: typingsJapgolly.cypress.typesLodashMod.List[U]): Object[Dictionary[U]] = js.native
  
  /**
    * @see _.zipObjectDeep
    */
  def zipObjectDeep(): Object[js.Object] = js.native
  def zipObjectDeep(values: typingsJapgolly.cypress.typesLodashMod.List[Any]): Object[js.Object] = js.native
  ...
  def zipWith[TResult](
    iteratee: (js.UndefOr[
      (js.Function1[/* repeated */ T, TResult]) | typingsJapgolly.cypress.typesLodashMod.List[T] | Null
    ])*
  ): Collection[TResult] = js.native
  /**
    * @see _.zipWith
  ...
  def zipWith[T2, T3, TResult](
    arrays2: typingsJapgolly.cypress.typesLodashMod.List[T2],
    arrays3: typingsJapgolly.cypress.typesLodashMod.List[T3],
