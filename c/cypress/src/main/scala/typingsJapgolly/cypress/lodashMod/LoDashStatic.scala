...
import typingsJapgolly.cypress.AnonCall
import typingsJapgolly.cypress.FnCallArray
import typingsJapgolly.cypress.FnCallCollectionIteratee
import typingsJapgolly.cypress.FnCallValue
...
trait LoDashStatic extends js.Object {
  ...
  {[ P in keyof T ]: any}
    */ typingsJapgolly.cypress.cypressStrings.LoDashStatic with js.Any = js.native
  /**
    * @see _.mapValues
    */
