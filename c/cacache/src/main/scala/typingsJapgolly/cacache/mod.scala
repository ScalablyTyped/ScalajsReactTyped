...
import typingsJapgolly.cacache.cacacheBooleans.`false`
import typingsJapgolly.cacache.enMod.CacheObject
import typingsJapgolly.cacache.enMod.GetCacheObject
import typingsJapgolly.cacache.enMod.get.HasContentObject
import typingsJapgolly.cacache.enMod.get.Options
import typingsJapgolly.cacache.enMod.ls.Cache
import typingsJapgolly.cacache.enMod.tmp.Callback
...
object mod extends js.Object {
  ...
  object put extends js.Object {
    ...
    def apply(cachePath: String, key: String, data: js.Any, opts: typingsJapgolly.cacache.enMod.put.Options): js.Promise[String] = js.native
    /**
    ...
    def stream(cachePath: String, key: String, opts: typingsJapgolly.cacache.enMod.put.Options): WritableStream = js.native
  }
  ...
  object tmp extends js.Object {
    ...
    def mkdir(cachePath: String, opts: typingsJapgolly.cacache.enMod.tmp.Options): js.Promise[String] = js.native
    ...
    /**
      ...
      */
    def withTmp(cachePath: String, opts: typingsJapgolly.cacache.enMod.tmp.Options, cb: Callback): Unit = js.native
  }
  
  @js.native
  object verify extends js.Object {
    def apply(cachePath: String): js.Promise[_] = js.native
    def apply(cachePath: String, opts: typingsJapgolly.cacache.enMod.verify.Options): js.Promise[_] = js.native
    /**
