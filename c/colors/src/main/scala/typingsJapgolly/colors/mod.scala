package typingsJapgolly.colors
...
object mod {
  ...
  object global {
    ...
    object String {
      ...
      inline def apply(
      ...
      ): typingsJapgolly.colors.mod.global.String = {
        ...
        __obj.asInstanceOf[typingsJapgolly.colors.mod.global.String]
      }
      
      extension [Self <: typingsJapgolly.colors.mod.global.String](x: Self) {
