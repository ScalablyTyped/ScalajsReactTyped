...
object autoCompleteMod {
  ...
  type AutoComplete = japgolly.scalajs.react.facade.React.Component[AutoCompleteProps & js.Object, js.Object]
  ...
  object AutoCompleteProps {
    ...
    extension [Self <: AutoCompleteProps](x: Self) {
      ...
      inline def setOnSelectedItem(value: /* item */ String => Callback): Self = StObject.set(x, "onSelectedItem", js.Any.fromFunction1((t0: /* item */ String) => value(t0).runNow()))
