...
object paginationMod {
  ...
  object PaginationProps {
    ...
    extension [Self <: PaginationProps](x: Self) {
      ...
      inline def setInfoFormatter(value: (/* activePage */ js.UndefOr[Double], /* lastPage */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "infoFormatter", js.Any.fromFunction2((t0: /* activePage */ js.UndefOr[Double], t1: /* lastPage */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
      ...
      inline def setOnPageClick(value: /* page */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "onPageClick", js.Any.fromFunction1((t0: /* page */ js.UndefOr[Double]) => value(t0).runNow()))
      ...
      inline def setPageHref(value: /* page */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "pageHref", js.Any.fromFunction1((t0: /* page */ js.UndefOr[Double]) => value(t0).runNow()))
