...
object gridMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cathoQuantum.cathoQuantumStrings.xsmall
    - typingsJapgolly.cathoQuantum.cathoQuantumStrings.small
    - typingsJapgolly.cathoQuantum.cathoQuantumStrings.medium
    - typingsJapgolly.cathoQuantum.cathoQuantumStrings.large
  */
