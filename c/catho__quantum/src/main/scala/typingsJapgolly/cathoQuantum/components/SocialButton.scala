...
import typingsJapgolly.cathoQuantum.socialButtonMod.SocialButtonProps
import typingsJapgolly.cathoQuantum.socialButtonMod.default
...
object SocialButton {
  ...
  inline def apply(provider: String): Builder = {
