...
import typingsJapgolly.cathoQuantum.inputMod.CustomValidate
import typingsJapgolly.cathoQuantum.inputMod.InputProps
import typingsJapgolly.cathoQuantum.inputMod.Mask
import typingsJapgolly.cathoQuantum.inputMod.Validate
import typingsJapgolly.cathoQuantum.inputMod.default
...
object Input {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def descriptionLabel(value: String): this.type = set("descriptionLabel", value.asInstanceOf[js.Any])
    ...
    inline def mask(value: Mask | js.Array[Mask]): this.type = set("mask", value.asInstanceOf[js.Any])
    
    inline def maskFunction1(value: /* rawValue */ String => js.Array[String]): this.type = set("mask", js.Any.fromFunction1(value))
    
    inline def maskVarargs(value: Mask*): this.type = set("mask", js.Array(value*))
    ...
    inline def onClean(value: ReactMouseEventFrom[HTMLInputElement & Element] => Callback): this.type = set("onClean", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLInputElement & Element]) => value(t0).runNow()))
    ...
    inline def `type`(
      value: typingsJapgolly.cathoQuantum.cathoQuantumStrings.email | typingsJapgolly.cathoQuantum.cathoQuantumStrings.text | typingsJapgolly.cathoQuantum.cathoQuantumStrings.tel | number | password | typingsJapgolly.cathoQuantum.cathoQuantumStrings.search
    ...
    inline def validate(value: Validate | CustomValidate | (js.Array[Validate | CustomValidate])): this.type = set("validate", value.asInstanceOf[js.Any])
    
    inline def validateFunction1(
      value: js.UndefOr[
          (/* params */ `13`) | (/* params */ MaxLength) | (/* params */ MinLength) | ValueString
        ] => String
    ): this.type = set("validate", js.Any.fromFunction1(value))
    
    inline def validateFunction2(value: (/* params */ `13`, /* cpf */ js.UndefOr[String]) => String): this.type = set("validate", js.Any.fromFunction2(value))
    
    inline def validateVarargs(value: (Validate | CustomValidate)*): this.type = set("validate", js.Array(value*))
