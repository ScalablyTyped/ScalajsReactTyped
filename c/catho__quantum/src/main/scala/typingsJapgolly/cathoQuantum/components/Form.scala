...
import typingsJapgolly.cathoQuantum.formMod.FormProps
...
object Form {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.cathoQuantum.formMod.Form] {
    ...
    inline def onSubmit(value: /* hasValid */ js.UndefOr[Valid] => Callback): this.type = set("onSubmit", js.Any.fromFunction1((t0: /* hasValid */ js.UndefOr[Valid]) => value(t0).runNow()))
    ...
    inline def onValidSubmit(value: /* values */ js.UndefOr[StringDictionary[js.UndefOr[String]]] => Callback): this.type = set("onValidSubmit", js.Any.fromFunction1((t0: /* values */ js.UndefOr[StringDictionary[js.UndefOr[String]]]) => value(t0).runNow()))
