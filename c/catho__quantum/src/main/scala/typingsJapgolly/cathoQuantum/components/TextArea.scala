...
import typingsJapgolly.cathoQuantum.textAreaMod.TextAreaProps
import typingsJapgolly.cathoQuantum.textAreaMod.default
...
object TextArea {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def autoResizeConfig(value: InitialRows): this.type = set("autoResizeConfig", value.asInstanceOf[js.Any])
    ...
    inline def isAutoResize(value: Boolean): this.type = set("isAutoResize", value.asInstanceOf[js.Any])
