...
import typingsJapgolly.cathoQuantum.buttonIconButtonMod.IconButtonProps
import typingsJapgolly.cathoQuantum.buttonMod.ButtonProps
import typingsJapgolly.cathoQuantum.buttonMod.default
...
object Button {
  ...
  object Icon {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def skin(value: neutral | primary | secondary | success | warning | error): this.type = set("skin", value.asInstanceOf[js.Any])
      
      inline def theme(value: ColorsComponents): this.type = set("theme", value.asInstanceOf[js.Any])
    }
    
    implicit def make(companion: Icon.type): typingsJapgolly.cathoQuantum.components.Button.Icon.Builder = new typingsJapgolly.cathoQuantum.components.Button.Icon.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: IconButtonProps): typingsJapgolly.cathoQuantum.components.Button.Icon.Builder = new typingsJapgolly.cathoQuantum.components.Button.Icon.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def $as(value: Element | String): this.type = set("$as", value.asInstanceOf[js.Any])
    
    inline def $asVdomElement(value: VdomElement): this.type = set("$as", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def childrenVarargs(value: (japgolly.scalajs.react.facade.React.Element | Empty | JsNumber | Node | String)*): this.type = set("children", js.Array(value*))
    ...
    inline def theme(value: Breakpoints): this.type = set("theme", value.asInstanceOf[js.Any])
