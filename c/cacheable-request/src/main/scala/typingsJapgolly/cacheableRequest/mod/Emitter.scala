...
import typingsJapgolly.cacheableRequest.cacheableRequestStrings.error
import typingsJapgolly.cacheableRequest.cacheableRequestStrings.request
import typingsJapgolly.cacheableRequest.cacheableRequestStrings.response
...
trait Emitter extends EventEmitter {
  ...
  def addListener_response(
    event: response,
    listener: js.Function1[/* response */ ServerResponse | typingsJapgolly.responselike.mod.^ , Unit]
  ): this.type = js.native
  @JSName("emit")
  ...
  @JSName("emit")
  def emit_response(event: response, response: typingsJapgolly.responselike.mod.^): Boolean = js.native
  ...
  def listeners_response(event: response): js.Array[
    js.Function1[/* response */ ServerResponse | typingsJapgolly.responselike.mod.^ , Unit]
  ] = js.native
  @JSName("off")
