...
import typingsJapgolly.cheerio.libOptionsMod.CheerioOptions
import typingsJapgolly.cheerio.libOptionsMod.InternalOptions
import typingsJapgolly.cheerio.libStaticMod.WritableArrayLike
...
object mod {
  ...
  inline def load(content: String, options: typingsJapgolly.cheerio.libEsmOptionsMod.CheerioOptions): CheerioAPI = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[CheerioAPI]
  inline def load(
    content: String,
    options: typingsJapgolly.cheerio.libEsmOptionsMod.CheerioOptions,
    isDocument: Boolean
  ...
  inline def load(content: js.Array[AnyNode], options: typingsJapgolly.cheerio.libEsmOptionsMod.CheerioOptions): CheerioAPI = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[CheerioAPI]
  inline def load(
  ...
  inline def load(content: AnyNode, options: typingsJapgolly.cheerio.libEsmOptionsMod.CheerioOptions): CheerioAPI = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[CheerioAPI]
  inline def load(
    content: AnyNode,
    options: typingsJapgolly.cheerio.libEsmOptionsMod.CheerioOptions,
    isDocument: Boolean
  ...
  inline def load(content: Buffer, options: typingsJapgolly.cheerio.libEsmOptionsMod.CheerioOptions): CheerioAPI = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[CheerioAPI]
  inline def load(
    content: Buffer,
    options: typingsJapgolly.cheerio.libEsmOptionsMod.CheerioOptions,
    isDocument: Boolean
  ...
  val root: js.ThisFunction0[
    /* this */ typingsJapgolly.cheerio.libLoadMod.CheerioAPI, 
    typingsJapgolly.cheerio.libCheerioMod.Cheerio[typingsJapgolly.domhandler.mod.Document]
  ] = js.native
