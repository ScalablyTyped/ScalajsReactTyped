...
object libEsmOptionsMod {
  ...
  - typingsJapgolly.htmlparser2.libParserMod.ParserOptions because var conflicts: xmlMode. Inlined lowerCaseTags, decodeEntities, lowerCaseAttributeNames, Tokenizer, recognizeCDATA, recognizeSelfClosing */ trait HTMLParser2Options
    extends StObject
    ...
    var Tokenizer: js.UndefOr[
        Instantiable2[
          ...
          /* cbs */ Callbacks, 
          typingsJapgolly.htmlparser2.libTokenizerMod.default
        ]
      ] = js.undefined
