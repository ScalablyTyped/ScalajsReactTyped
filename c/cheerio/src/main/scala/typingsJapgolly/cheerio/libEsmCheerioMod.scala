...
import typingsJapgolly.cheerio.libEsmApiAttributesMod.StyleProp
import typingsJapgolly.cheerio.libEsmApiFormsMod.SerializedField
import typingsJapgolly.cheerio.libEsmOptionsMod.InternalOptions
import typingsJapgolly.cheerio.libEsmTypesMod.AcceptedElems
import typingsJapgolly.cheerio.libEsmTypesMod.AcceptedFilters
...
object libEsmCheerioMod {
  
  /* note: abstract class */ @JSImport("cheerio/lib/esm/cheerio", "Cheerio")
  @js.native
  ...
  trait TraversingType extends StObject {
    ...
    def filter[T](`match`: Cheerio[T]): Cheerio[
        /* import warning: importer.ImportType#apply Failed type conversion: cheerio.cheerio/lib/esm/cheerio.Cheerio<T> extends string ? domhandler.domhandler.Element : T */ js.Any
      ] = js.native
