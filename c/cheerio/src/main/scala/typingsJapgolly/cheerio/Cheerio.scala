...
/* index */ NumberDictionary[CheerioElement] {
  ...
  def after(content: js.Array[typingsJapgolly.std.Document], contents: js.Any*): Cheerio = js.native
  def after(content: Cheerio, contents: js.Any*): Cheerio = js.native
  def after(content: typingsJapgolly.std.Document, contents: js.Any*): Cheerio = js.native
  def append(content: String, contents: js.Any*): Cheerio = js.native
  def append(content: js.Array[typingsJapgolly.std.Document], contents: js.Any*): Cheerio = js.native
  def append(content: Cheerio, contents: js.Any*): Cheerio = js.native
  def append(content: typingsJapgolly.std.Document, contents: js.Any*): Cheerio = js.native
  // Manipulation
  ...
  def before(content: js.Array[typingsJapgolly.std.Document], contents: js.Any*): Cheerio = js.native
  def before(content: Cheerio, contents: js.Any*): Cheerio = js.native
  def before(content: typingsJapgolly.std.Document, contents: js.Any*): Cheerio = js.native
  ...
  def insertAfter(content: typingsJapgolly.std.Document): Cheerio = js.native
  def insertBefore(content: String): Cheerio = js.native
  def insertBefore(content: Cheerio): Cheerio = js.native
  def insertBefore(content: typingsJapgolly.std.Document): Cheerio = js.native
  ...
  def prepend(content: js.Array[typingsJapgolly.std.Document], contents: js.Any*): Cheerio = js.native
  def prepend(content: Cheerio, contents: js.Any*): Cheerio = js.native
  def prepend(content: typingsJapgolly.std.Document, contents: js.Any*): Cheerio = js.native
  ...
  def wrap(content: typingsJapgolly.std.Document): Cheerio = js.native
}
