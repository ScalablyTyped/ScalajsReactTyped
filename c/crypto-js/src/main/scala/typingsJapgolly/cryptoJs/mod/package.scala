...
import typingsJapgolly.cryptoJs.mod.^
import typingsJapgolly.cryptoJs.mod.global.CryptoJS.x64.Word
...
inline def EvpKDF(password: String, salt: String, cfg: typingsJapgolly.cryptoJs.anon.Hasher): WordArray = (^.asInstanceOf[js.Dynamic].applyDynamic("EvpKDF")(password.asInstanceOf[js.Any], salt.asInstanceOf[js.Any], cfg.asInstanceOf[js.Any])).asInstanceOf[WordArray]
...
inline def EvpKDF(password: String, salt: WordArray, cfg: typingsJapgolly.cryptoJs.anon.Hasher): WordArray = (^.asInstanceOf[js.Dynamic].applyDynamic("EvpKDF")(password.asInstanceOf[js.Any], salt.asInstanceOf[js.Any], cfg.asInstanceOf[js.Any])).asInstanceOf[WordArray]
...
inline def EvpKDF(password: WordArray, salt: String, cfg: typingsJapgolly.cryptoJs.anon.Hasher): WordArray = (^.asInstanceOf[js.Dynamic].applyDynamic("EvpKDF")(password.asInstanceOf[js.Any], salt.asInstanceOf[js.Any], cfg.asInstanceOf[js.Any])).asInstanceOf[WordArray]
...
inline def EvpKDF(password: WordArray, salt: WordArray, cfg: typingsJapgolly.cryptoJs.anon.Hasher): WordArray = (^.asInstanceOf[js.Dynamic].applyDynamic("EvpKDF")(password.asInstanceOf[js.Any], salt.asInstanceOf[js.Any], cfg.asInstanceOf[js.Any])).asInstanceOf[WordArray]
...
type CipherParams = typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams
...
type WordArray = typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray
