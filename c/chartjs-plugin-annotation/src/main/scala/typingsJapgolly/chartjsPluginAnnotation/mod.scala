...
import typingsJapgolly.chartjsPluginAnnotation.anon.Box
import typingsJapgolly.chartjsPluginAnnotation.chartjsPluginAnnotationStrings.bottom
import typingsJapgolly.chartjsPluginAnnotation.chartjsPluginAnnotationStrings.box
import typingsJapgolly.chartjsPluginAnnotation.chartjsPluginAnnotationStrings.center
import typingsJapgolly.chartjsPluginAnnotation.chartjsPluginAnnotationStrings.horizontal
import typingsJapgolly.chartjsPluginAnnotation.chartjsPluginAnnotationStrings.left
import typingsJapgolly.chartjsPluginAnnotation.chartjsPluginAnnotationStrings.line
import typingsJapgolly.chartjsPluginAnnotation.chartjsPluginAnnotationStrings.right
import typingsJapgolly.chartjsPluginAnnotation.chartjsPluginAnnotationStrings.top
import typingsJapgolly.chartjsPluginAnnotation.chartjsPluginAnnotationStrings.vertical
...
object mod extends Shortcut {
  ...
  object AnnotationElement {
    ...
    inline def apply(
      ...
      inRange: Callback,
      initialize: Callback,
      setDataLimits: Callback
    ): AnnotationElement = {
      val __obj = js.Dynamic.literal(_model = _model.asInstanceOf[js.Any], configure = configure.toJsFn, destroy = destroy.toJsFn, draw = draw.toJsFn, getArea = getArea.toJsFn, getCenterPoint = getCenterPoint.toJsFn, getHeight = getHeight.toJsFn, getWidth = getWidth.toJsFn, hidden = hidden.asInstanceOf[js.Any], hovering = hovering.asInstanceOf[js.Any], inRange = inRange.toJsFn, initialize = initialize.toJsFn, setDataLimits = setDataLimits.toJsFn)
      __obj.asInstanceOf[AnnotationElement]
    }
    
    extension [Self <: AnnotationElement](x: Self) {
      
      inline def setConfigure(value: Callback): Self = StObject.set(x, "configure", value.toJsFn)
      
      inline def setDestroy(value: Callback): Self = StObject.set(x, "destroy", value.toJsFn)
      
      inline def setDraw(value: Callback): Self = StObject.set(x, "draw", value.toJsFn)
      
      inline def setGetArea(value: Callback): Self = StObject.set(x, "getArea", value.toJsFn)
      
      inline def setGetCenterPoint(value: Callback): Self = StObject.set(x, "getCenterPoint", value.toJsFn)
      
      inline def setGetHeight(value: Callback): Self = StObject.set(x, "getHeight", value.toJsFn)
      
      inline def setGetWidth(value: Callback): Self = StObject.set(x, "getWidth", value.toJsFn)
      
      inline def setHidden(value: Boolean): Self = StObject.set(x, "hidden", value.asInstanceOf[js.Any])
      
      inline def setHovering(value: Boolean): Self = StObject.set(x, "hovering", value.asInstanceOf[js.Any])
      
      inline def setInRange(value: Callback): Self = StObject.set(x, "inRange", value.toJsFn)
      
      inline def setInitialize(value: Callback): Self = StObject.set(x, "initialize", value.toJsFn)
      
      inline def setSetDataLimits(value: Callback): Self = StObject.set(x, "setDataLimits", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chartjsPluginAnnotation.mod.LineAnnotationOptions
    - typingsJapgolly.chartjsPluginAnnotation.mod.BoxAnnotationOptions
  */
  trait AnnotationOptions extends StObject
  object AnnotationOptions {
    
    inline def BoxAnnotationOptions(xMax: ChartPointValue, xMin: ChartPointValue, yMax: ChartPointValue, yMin: ChartPointValue): typingsJapgolly.chartjsPluginAnnotation.mod.BoxAnnotationOptions = {
      ...
      __obj.asInstanceOf[typingsJapgolly.chartjsPluginAnnotation.mod.BoxAnnotationOptions]
    }
    
    inline def LineAnnotationOptions(mode: horizontal | vertical, scaleID: String, value: ChartPointValue): typingsJapgolly.chartjsPluginAnnotation.mod.LineAnnotationOptions = {
      ...
      __obj.asInstanceOf[typingsJapgolly.chartjsPluginAnnotation.mod.LineAnnotationOptions]
    }
  }
  ...
  object CommonAnnotationOptions {
    ...
    extension [Self <: CommonAnnotationOptions](x: Self) {
      ...
      inline def setOnWheel(value: /* event */ MouseEvent => Callback): Self = StObject.set(x, "onWheel", js.Any.fromFunction1((t0: /* event */ MouseEvent) => value(t0).runNow()))
