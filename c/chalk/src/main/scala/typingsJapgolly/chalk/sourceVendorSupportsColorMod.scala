...
object sourceVendorSupportsColorMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chalk.sourceVendorSupportsColorMod.ColorSupport
    - typingsJapgolly.chalk.chalkBooleans.`false`
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chalk.chalkInts.`0`
    - typingsJapgolly.chalk.chalkInts.`1`
    - typingsJapgolly.chalk.chalkInts.`2`
    - typingsJapgolly.chalk.chalkInts.`3`
  */
  trait ColorSupportLevel extends StObject
  object ColorSupportLevel {
    
    inline def `0`: typingsJapgolly.chalk.chalkInts.`0` = 0.asInstanceOf[typingsJapgolly.chalk.chalkInts.`0`]
    
    inline def `1`: typingsJapgolly.chalk.chalkInts.`1` = 1.asInstanceOf[typingsJapgolly.chalk.chalkInts.`1`]
    
    inline def `2`: typingsJapgolly.chalk.chalkInts.`2` = 2.asInstanceOf[typingsJapgolly.chalk.chalkInts.`2`]
    
    inline def `3`: typingsJapgolly.chalk.chalkInts.`3` = 3.asInstanceOf[typingsJapgolly.chalk.chalkInts.`3`]
  }
