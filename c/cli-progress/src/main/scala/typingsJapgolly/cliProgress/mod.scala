package typingsJapgolly.cliProgress
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cliProgress.cliProgressStrings.percentage
    - typingsJapgolly.cliProgress.cliProgressStrings.total
    - typingsJapgolly.cliProgress.cliProgressStrings.value
    - typingsJapgolly.cliProgress.cliProgressStrings.eta
    - typingsJapgolly.cliProgress.cliProgressStrings.duration
  */
  trait ValueType extends StObject
  object ValueType {
    
    inline def duration: typingsJapgolly.cliProgress.cliProgressStrings.duration = "duration".asInstanceOf[typingsJapgolly.cliProgress.cliProgressStrings.duration]
    
    inline def eta: typingsJapgolly.cliProgress.cliProgressStrings.eta = "eta".asInstanceOf[typingsJapgolly.cliProgress.cliProgressStrings.eta]
    
    inline def percentage: typingsJapgolly.cliProgress.cliProgressStrings.percentage = "percentage".asInstanceOf[typingsJapgolly.cliProgress.cliProgressStrings.percentage]
    
    inline def total: typingsJapgolly.cliProgress.cliProgressStrings.total = "total".asInstanceOf[typingsJapgolly.cliProgress.cliProgressStrings.total]
    
    inline def value: typingsJapgolly.cliProgress.cliProgressStrings.value = "value".asInstanceOf[typingsJapgolly.cliProgress.cliProgressStrings.value]
  }
}
