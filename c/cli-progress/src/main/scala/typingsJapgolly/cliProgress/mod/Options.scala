...
import typingsJapgolly.cliProgress.cliProgressStrings.center
import typingsJapgolly.cliProgress.cliProgressStrings.left
import typingsJapgolly.cliProgress.cliProgressStrings.right
