...
import typingsJapgolly.ckeditorCkeditor5Utils.mod.BindChain
import typingsJapgolly.ckeditorCkeditor5Utils.mod.Emitter
import typingsJapgolly.ckeditorCkeditor5Utils.mod.EmitterMixinDelegateChain
import typingsJapgolly.ckeditorCkeditor5Utils.mod.EventInfo
...
trait Observablemessagestring extends js.Object {
  ...
  def listenTo(
    ...
    options: typingsJapgolly.ckeditorCkeditor5Utils.AnonPriority
  ): Unit = js.native
  def off(event: String): Unit = js.native
  def off(event: String, callback: js.Function): Unit = js.native
  def on(event: String, callback: js.Function): Unit = js.native
  def on(event: String, callback: js.Function, options: typingsJapgolly.ckeditorCkeditor5Utils.Anon0): Unit = js.native
  def once(event: String, callback: js.Function): Unit = js.native
  def once(event: String, callback: js.Function, options: typingsJapgolly.ckeditorCkeditor5Utils.Anon0): Unit = js.native
