...
import typingsJapgolly.ckeditorCkeditor5Core.Observablemessagestring
...
object PendingActions extends js.Object {
  val pluginName: typingsJapgolly.ckeditorCkeditor5Core.ckeditorCkeditor5CoreStrings.PendingActions = js.native
}
