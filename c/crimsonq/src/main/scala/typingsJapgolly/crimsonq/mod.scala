package typingsJapgolly.crimsonq

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.crimsonq.anon.Error
import typingsJapgolly.crimsonq.anon.Key
import typingsJapgolly.crimsonq.anon.TypeofIORedis
import typingsJapgolly.crimsonq.crimsonqStrings.completed
import typingsJapgolly.crimsonq.crimsonqStrings.failed
...
object mod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    override def Consumer(consumerId: String): typingsJapgolly.crimsonq.mod.Consumer = js.native
    
    /* CompleteClass */
    override def Producer(): typingsJapgolly.crimsonq.mod.Producer = js.native
  ...
  trait CrimsonQClient extends StObject {
    ...
    def Consumer(consumerId: String): typingsJapgolly.crimsonq.mod.Consumer
    
    def Producer(): typingsJapgolly.crimsonq.mod.Producer
  ...
  object CrimsonQClient {
    ...
    inline def apply(
      ...
      Producer: CallbackTo[Producer],
      command: Command,
      connect: CallbackTo[js.Promise[Error]],
      redisCommander: TypeofIORedis,
      redisSubscriber: TypeofIORedis
    ): CrimsonQClient = {
      val __obj = js.Dynamic.literal(Consumer = js.Any.fromFunction1(Consumer), Producer = Producer.toJsFn, command = command.asInstanceOf[js.Any], connect = connect.toJsFn, redisCommander = redisCommander.asInstanceOf[js.Any], redisSubscriber = redisSubscriber.asInstanceOf[js.Any])
    ...
    extension [Self <: CrimsonQClient](x: Self) {
      ...
      inline def setConnect(value: CallbackTo[js.Promise[Error]]): Self = StObject.set(x, "connect", value.toJsFn)
      
      inline def setConsumer(value: String => Consumer): Self = StObject.set(x, "Consumer", js.Any.fromFunction1(value))
      
      inline def setProducer(value: CallbackTo[Producer]): Self = StObject.set(x, "Producer", value.toJsFn)
  ...
  object RecievedMessage {
    ...
    inline def apply(
      consumer: Consumer,
      done: CallbackTo[js.Promise[js.UndefOr[CommandResult | ErrorConstructor]]],
      fail: String => js.Promise[js.UndefOr[CommandResult | ErrorConstructor]],
      key: String,
      message: Key
    ): RecievedMessage = {
      val __obj = js.Dynamic.literal(consumer = consumer.asInstanceOf[js.Any], done = done.toJsFn, fail = js.Any.fromFunction1(fail), key = key.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any])
    ...
    extension [Self <: RecievedMessage](x: Self) {
      ...
      inline def setDone(value: CallbackTo[js.Promise[js.UndefOr[CommandResult | ErrorConstructor]]]): Self = StObject.set(x, "done", value.toJsFn)
