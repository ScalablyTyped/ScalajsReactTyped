...
import typingsJapgolly.crimsonq.crimsonqStrings.ENTER_SUBSCRIBER_MODE
import typingsJapgolly.crimsonq.crimsonqStrings.EXIT_SUBSCRIBER_MODE
import typingsJapgolly.crimsonq.crimsonqStrings.VALID_IN_MONITOR_MODE
import typingsJapgolly.crimsonq.crimsonqStrings.VALID_IN_SUBSCRIBER_MODE
import typingsJapgolly.crimsonq.crimsonqStrings.WILL_DISCONNECT
...
import typingsJapgolly.ioredis.builtClusterMod.default
...
import typingsJapgolly.ioredis.builtRedisMod.Redis
...
object anon {
  ...
  trait TypeofIORedis extends StObject {
    ...
    val default: Typeofdefault & (Instantiable3[
        ...
        typingsJapgolly.ioredis.mod.default
      ]) = js.native
    
    var AbstractConnector: Instantiable1[/* disconnectTimeout */ Double, typingsJapgolly.ioredis.mod.AbstractConnector] = js.native
    
    /**
      * Client for the official Redis Cluster
      */
    var Cluster: Instantiable1[/* startupNodes */ js.Array[ClusterNode], typingsJapgolly.ioredis.mod.Cluster] = js.native
    
    var Command: TypeofCommandInstantiable = js.native
    
    var Pipeline: Instantiable1[
        /* redis */ typingsJapgolly.ioredis.builtRedisMod.default, 
        typingsJapgolly.ioredis.mod.Pipeline
      ] = js.native
    ...
    val Redis: TypeofRedis & (Instantiable3[
        ...
        /* host */ String, 
        /* options */ RedisOptions, 
        typingsJapgolly.ioredis.mod.Redis
      ]) = js.native
    
    val ReplyError: Any = js.native
    
    var ScanStream: Instantiable1[/* opt */ Options, typingsJapgolly.ioredis.mod.ScanStream] = js.native
    
    var SentinelConnector: Instantiable1[
        /* options */ SentinelConnectionOptions, 
        typingsJapgolly.ioredis.mod.SentinelConnector
      ] = js.native
    
    var SentinelIterator: Instantiable1[
        /* sentinels */ js.Array[PartialSentinelAddress], 
        typingsJapgolly.ioredis.mod.SentinelIterator
      ] = js.native
  ...
  trait TypeofRedis extends StObject {
    ...
    def createClient(
      /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type ConstructorParameters<typeof Redis> is not an array type */ args: ConstructorParameters[
          typingsJapgolly.ioredis.anon.TypeofRedis & (Instantiable3[/* port */ Double, /* host */ String, /* options */ RedisOptions, Redis])
        ]
    ): Redis
