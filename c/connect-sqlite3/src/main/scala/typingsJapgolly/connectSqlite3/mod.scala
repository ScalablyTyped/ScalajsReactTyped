...
import typingsJapgolly.connectSqlite3.connectSqlite3Strings.auto
import typingsJapgolly.connectSqlite3.connectSqlite3Strings.lax
import typingsJapgolly.connectSqlite3.connectSqlite3Strings.none
import typingsJapgolly.connectSqlite3.connectSqlite3Strings.strict
import typingsJapgolly.connectSqlite3.mod.connect.ConnectParams
import typingsJapgolly.connectSqlite3.mod.connect.SQLiteStoreInitator
...
object mod {
  ...
  object connect {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.connectSqlite3.anon.Store
      - typingsJapgolly.connectSqlite3.anon.Session
    */
    trait ConnectParams extends StObject
    object ConnectParams {
      
      inline def Session(session: typingsJapgolly.connectSqlite3.anon.Store): typingsJapgolly.connectSqlite3.anon.Session = {
        val __obj = js.Dynamic.literal(session = session.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.connectSqlite3.anon.Session]
      }
      
      inline def Store(Store: Instantiable0[typingsJapgolly.connectSqlite3.mod.connect.Store]): typingsJapgolly.connectSqlite3.anon.Store = {
        val __obj = js.Dynamic.literal(Store = Store.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.connectSqlite3.anon.Store]
      }
    }
