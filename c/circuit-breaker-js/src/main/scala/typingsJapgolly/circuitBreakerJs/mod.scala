...
import typingsJapgolly.circuitBreakerJs.circuitBreakerJsInts.`0`
import typingsJapgolly.circuitBreakerJs.circuitBreakerJsInts.`1`
import typingsJapgolly.circuitBreakerJs.circuitBreakerJsInts.`2`
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnCircuitClose(value: /* m */ Metrics => Callback): Self = StObject.set(x, "onCircuitClose", js.Any.fromFunction1((t0: /* m */ Metrics) => value(t0).runNow()))
      
      inline def setOnCircuitCloseUndefined: Self = StObject.set(x, "onCircuitClose", js.undefined)
      
      inline def setOnCircuitOpen(value: /* m */ Metrics => Callback): Self = StObject.set(x, "onCircuitOpen", js.Any.fromFunction1((t0: /* m */ Metrics) => value(t0).runNow()))
