...
object Options {
  ...
  def apply(
    ...
    onCircuitClose: /* m */ Metrics => Callback = null,
    onCircuitOpen: /* m */ Metrics => Callback = null,
    ...
    if (onCircuitClose != null) __obj.updateDynamic("onCircuitClose")(js.Any.fromFunction1((t0: /* m */ typingsJapgolly.circuitBreakerJs.mod.Metrics) => onCircuitClose(t0).runNow()))
    if (onCircuitOpen != null) __obj.updateDynamic("onCircuitOpen")(js.Any.fromFunction1((t0: /* m */ typingsJapgolly.circuitBreakerJs.mod.Metrics) => onCircuitOpen(t0).runNow()))
