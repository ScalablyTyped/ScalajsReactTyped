package typingsJapgolly.cytoscapeCxtmenu

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.Shortcut
import org.scalajs.dom.HTMLElement
import typingsJapgolly.cytoscape.mod.Ext
import typingsJapgolly.cytoscape.mod.Selector
import typingsJapgolly.cytoscape.mod.SingularData
import typingsJapgolly.cytoscapeCxtmenu.anon.PartialCSSStyleDeclaratio
import typingsJapgolly.cytoscapeCxtmenu.cytoscapeCxtmenuBooleans.`false`
...
object mod extends Shortcut {
  ...
  object Command {
    ...
    extension [Self <: Command](x: Self) {
      ...
      inline def setSelect(value: /* element */ SingularData => Callback): Self = StObject.set(x, "select", js.Any.fromFunction1((t0: /* element */ SingularData) => value(t0).runNow()))
  ...
  object MenuInstance {
    ...
    inline def apply(destroy: Callback): MenuInstance = {
