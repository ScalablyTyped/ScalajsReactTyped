...
trait Edge
  extends typingsJapgolly.cassandraDriver.graphMod.graph.Element {
  var inV: js.UndefOr[typingsJapgolly.cassandraDriver.graphMod.graph.Vertex] = js.undefined
  var inVLabel: js.UndefOr[String] = js.undefined
  var outV: js.UndefOr[typingsJapgolly.cassandraDriver.graphMod.graph.Vertex] = js.undefined
...
object Edge {
  ...
  def apply(
    id: js.Any,
    label: String,
    inV: typingsJapgolly.cassandraDriver.graphMod.graph.Vertex = null,
    inVLabel: String = null,
    outV: typingsJapgolly.cassandraDriver.graphMod.graph.Vertex = null,
