package typingsJapgolly.cassandraDriver.datastaxMod.datastax
...
object search extends js.Object {
  ...
  class DateRange protected () extends js.Object {
    ...
    var lowerBound: typingsJapgolly.cassandraDriver.searchMod.search.DateRangeBound = js.native
    var upperBound: typingsJapgolly.cassandraDriver.searchMod.search.DateRangeBound = js.native
    def equals(other: typingsJapgolly.cassandraDriver.searchMod.search.DateRangeBound): Boolean = js.native
  }
