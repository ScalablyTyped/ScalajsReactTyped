...
object reconnection extends js.Object {
  ...
  class ConstantReconnectionPolicy protected ()
    extends typingsJapgolly.cassandraDriver.policiesMod.policies.reconnection.ConstantReconnectionPolicy {
    def this(delay: Double) = this()
  }
  
  @js.native
  class ExponentialReconnectionPolicy protected ()
    extends typingsJapgolly.cassandraDriver.policiesMod.policies.reconnection.ExponentialReconnectionPolicy {
