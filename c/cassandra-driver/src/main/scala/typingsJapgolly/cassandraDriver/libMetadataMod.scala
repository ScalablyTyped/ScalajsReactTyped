...
import typingsJapgolly.cassandraDriver.anon.Activity
import typingsJapgolly.cassandraDriver.anon.Code
import typingsJapgolly.cassandraDriver.anon.Dictoption
import typingsJapgolly.cassandraDriver.anon.Frozen
import typingsJapgolly.cassandraDriver.anon.Info
import typingsJapgolly.cassandraDriver.anon.Name
import typingsJapgolly.cassandraDriver.libTypesMod.types.InetAddress
...
import typingsJapgolly.cassandraDriver.libTypesMod.types.dataTypes
...
import typingsJapgolly.cassandraDriver.mod.token.Token
import typingsJapgolly.cassandraDriver.mod.token.TokenRange
  ...
  object metadata {
    ...
    object ClientState {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(getConnectedHosts = getConnectedHosts.toJsFn, getInFlightQueries = js.Any.fromFunction1(getInFlightQueries), getOpenConnections = js.Any.fromFunction1(getOpenConnections))
        __obj.asInstanceOf[ClientState]
      }
      
      extension [Self <: ClientState](x: Self) {
        
        inline def setGetConnectedHosts(value: CallbackTo[js.Array[Host]]): Self = StObject.set(x, "getConnectedHosts", value.toJsFn)
    ...
    object Index {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(isCompositesKind = isCompositesKind.toJsFn, isCustomKind = isCustomKind.toJsFn, isKeysKind = isKeysKind.toJsFn, kind = kind.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any])
        __obj.asInstanceOf[Index]
      }
      
      extension [Self <: Index](x: Self) {
        
        inline def setIsCompositesKind(value: CallbackTo[Boolean]): Self = StObject.set(x, "isCompositesKind", value.toJsFn)
        
        inline def setIsCustomKind(value: CallbackTo[Boolean]): Self = StObject.set(x, "isCustomKind", value.toJsFn)
        
        inline def setIsKeysKind(value: CallbackTo[Boolean]): Self = StObject.set(x, "isKeysKind", value.toJsFn)
