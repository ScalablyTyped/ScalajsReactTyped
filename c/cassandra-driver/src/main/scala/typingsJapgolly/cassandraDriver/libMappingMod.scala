...
import typingsJapgolly.cassandraDriver.anon.Fields
  ...
  object mapping {
    ...
    object TableMappings {
      ...
      inline def apply(
        ...
        newObjectInstance: CallbackTo[Any]
      ): TableMappings = {
        val __obj = js.Dynamic.literal(getColumnName = js.Any.fromFunction1(getColumnName), getPropertyName = js.Any.fromFunction1(getPropertyName), newObjectInstance = newObjectInstance.toJsFn)
      ...
      extension [Self <: TableMappings](x: Self) {
        ...
        inline def setNewObjectInstance(value: CallbackTo[Any]): Self = StObject.set(x, "newObjectInstance", value.toJsFn)
      }
    }
