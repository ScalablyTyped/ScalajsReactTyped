...
trait Cash_ extends js.Object {
  ...
  def add(selector: typingsJapgolly.std.Element): Cash_ = js.native
  def add(selector: typingsJapgolly.std.Element, context: Element): Cash_ = js.native
  /**
    * addClass
  ...
  /**
    ...
    */
  def after(selector: typingsJapgolly.std.Element): Cash_ = js.native
  /**
    * append
  ...
  def append(content: typingsJapgolly.std.Element): Cash_ = js.native
  /**
    * appendTo
  ...
  def appendTo(parent: typingsJapgolly.std.Element): Cash_ = js.native
  /**
    * attr
  ...
  def before(selector: typingsJapgolly.std.Element): Cash_ = js.native
  /**
    * children
  ...
  def insertAfter(selector: typingsJapgolly.std.Element): Cash_ = js.native
  /**
    * insertBefore
  ...
  def insertBefore(selector: typingsJapgolly.std.Element): Cash_ = js.native
  /**
    * is
  ...
  def is(selector: typingsJapgolly.std.Element): Boolean = js.native
  /**
    * last
  ...
  def not(selector: typingsJapgolly.std.Element): Cash_ = js.native
  /**
    * off
  ...
  def prependTo(parent: typingsJapgolly.std.Element): Cash_ = js.native
  /**
    * prev
