...
package object mod {
  ...
  type businessRuleHandler = js.Function4[
    /* changed */ typingsJapgolly.cqrsDomain.mod.AggregateModel, 
    /* previous */ typingsJapgolly.cqrsDomain.mod.AggregateModel, 
    /* command */ js.Any, 
  ...
  type commandHandler = js.Function2[
    /* data */ js.Any, 
    /* aggregate */ typingsJapgolly.cqrsDomain.mod.AggregateModel, 
    scala.Unit
  ]
  /**
  ...
  type defineEventStreamsToLoadHandler = js.Function1[/* cmd */ js.Any, js.Array[typingsJapgolly.cqrsDomain.AnonAggregate]]
  /**
