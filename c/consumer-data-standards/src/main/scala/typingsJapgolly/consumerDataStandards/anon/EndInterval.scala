...
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.FINAL_SUBSTITUTE
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.SUBSTITUTE
...
object EndInterval {
  ...
  extension [Self <: EndInterval](x: Self) {
