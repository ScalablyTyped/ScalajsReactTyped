...
object AnzsicDivision {
  
  inline def apply(legalEntityId: String, legalEntityName: String, logoUri: String, status: ACTIVE | REMOVED): AnzsicDivision = {
