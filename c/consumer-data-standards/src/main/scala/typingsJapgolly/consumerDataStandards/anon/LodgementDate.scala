...
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.HOLD_ON_MATURITY
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.PAID_OUT_AT_MATURITY
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.ROLLED_OVER
...
object LodgementDate {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[LodgementDate]
  }
  
  extension [Self <: LodgementDate](x: Self) {
