...
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.BUSINESS_LOANS
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.CLOSED
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.CRED_AND_CHRG_CARDS
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.LEASES
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.MARGIN_LOANS
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.OPEN
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.OVERDRAFTS
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.PERS_LOANS
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.REGULATED_TRUST_ACCOUNTS
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.RESIDENTIAL_MORTGAGES
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.TERM_DEPOSITS
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.TRADE_FINANCE
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.TRANS_AND_SAVINGS_ACCOUNTS
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.TRAVEL_CARDS
