...
object FinalPaymentDate {
  ...
  inline def apply(intervals: js.Array[DayInInterval]): FinalPaymentDate = {
    val __obj = js.Dynamic.literal(intervals = intervals.asInstanceOf[js.Any])
    __obj.asInstanceOf[FinalPaymentDate]
  }
  
  extension [Self <: FinalPaymentDate](x: Self) {
