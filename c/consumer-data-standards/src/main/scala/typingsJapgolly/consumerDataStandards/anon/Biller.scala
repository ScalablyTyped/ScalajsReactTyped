...
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.accountId
...
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.payeeId
...
object Biller {
  ...
  inline def apply(toUType: accountId | biller_ | domestic_ | international_ | payeeId): Biller = {
    val __obj = js.Dynamic.literal(toUType = toUType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Biller]
  }
  
  extension [Self <: Biller](x: Self) {
