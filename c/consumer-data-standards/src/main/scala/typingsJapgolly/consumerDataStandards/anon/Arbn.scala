...
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.banking
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.energy
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.telco
...
object Arbn {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Arbn]
  }
  
  extension [Self <: Arbn](x: Self) {
