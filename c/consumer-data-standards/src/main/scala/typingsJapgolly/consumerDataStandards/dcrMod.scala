package typingsJapgolly.consumerDataStandards

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.ES256
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.PS256
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.`code id_token`
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.authorization_code
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.client_credentials
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.invalid_client_metadata
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.invalid_redirect_uri
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.invalid_software_statement
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.private_key_jwt
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.refresh_token
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.unapproved_software_statement
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.web
