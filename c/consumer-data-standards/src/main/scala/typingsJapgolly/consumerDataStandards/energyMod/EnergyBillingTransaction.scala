...
import typingsJapgolly.consumerDataStandards.anon.Adjustments
import typingsJapgolly.consumerDataStandards.anon.CalculationFactors
import typingsJapgolly.consumerDataStandards.anon.InvoiceNumber
import typingsJapgolly.consumerDataStandards.anon.IsEstimate
import typingsJapgolly.consumerDataStandards.anon.Method
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.demand_
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.onceOff
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.otherCharges
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.payment_
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.usage_
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait EnergyBillingTransaction
  extends StObject
...
object EnergyBillingTransaction {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[EnergyBillingTransaction]
  }
  
  extension [Self <: EnergyBillingTransaction](x: Self) {
