...
import typingsJapgolly.consumerDataStandards.anon.Date
import typingsJapgolly.consumerDataStandards.anon.OtherCharges
import typingsJapgolly.consumerDataStandards.anon.StartDate
import typingsJapgolly.consumerDataStandards.anon.TotalCharges
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.NOT_PAID
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.PAID
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.PARTIALLY_PAID
...
object EnergyInvoice {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[EnergyInvoice]
  }
  
  extension [Self <: EnergyInvoice](x: Self) {
