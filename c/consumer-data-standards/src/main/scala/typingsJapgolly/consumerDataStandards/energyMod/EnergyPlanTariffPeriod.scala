...
import typingsJapgolly.consumerDataStandards.anon.ChargePeriod
import typingsJapgolly.consumerDataStandards.anon.GeneralUnitPrice
import typingsJapgolly.consumerDataStandards.anon.TimeOfUse
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.AEST
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.ENVIRONMENTAL
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.LOCAL
...
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.demandCharges
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.singleRate
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.timeOfUseRates
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait EnergyPlanTariffPeriod
  extends StObject
...
object EnergyPlanTariffPeriod {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[EnergyPlanTariffPeriod]
  }
  
  extension [Self <: EnergyPlanTariffPeriod](x: Self) {
