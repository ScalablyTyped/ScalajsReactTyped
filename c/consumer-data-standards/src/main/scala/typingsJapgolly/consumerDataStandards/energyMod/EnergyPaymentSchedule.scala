...
import typingsJapgolly.consumerDataStandards.anon.BillFrequency
import typingsJapgolly.consumerDataStandards.anon.Bsb
import typingsJapgolly.consumerDataStandards.anon.CalculationType
import typingsJapgolly.consumerDataStandards.anon.PaymentFrequency
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.cardDebit
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.digitalWallet
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.directDebit
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.manualPayment
