...
import typingsJapgolly.consumerDataStandards.anon.AmountDescription
import typingsJapgolly.consumerDataStandards.anon.Type
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.AGGREGATE
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.CONTROLLED_LOAD
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.OFF_PEAK
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.OFF_PEAK_DEMAND_CHARGE
...
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.SOLAR
...
object EnergyBillingDemandTransaction {
  ...
  extension [Self <: EnergyBillingDemandTransaction](x: Self) {
