...
import typingsJapgolly.consumerDataStandards.anon.AdditionalInfo
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.DAY
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.DOLLAR
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.MONTH
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.PERCENT
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.PER_TIER
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.WHOLE_BALANCE
