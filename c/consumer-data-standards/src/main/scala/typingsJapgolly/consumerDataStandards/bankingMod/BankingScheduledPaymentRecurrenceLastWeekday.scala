...
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.AFTER
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.BEFORE
...
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.ON
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.ONLY
...
trait BankingScheduledPaymentRecurrenceLastWeekday
  extends StObject
...
object BankingScheduledPaymentRecurrenceLastWeekday {
  
  inline def apply(interval: String, lastWeekDay: FRI | MON | SAT | SUN | THU | TUE | WED): BankingScheduledPaymentRecurrenceLastWeekday = {
    val __obj = js.Dynamic.literal(interval = interval.asInstanceOf[js.Any], lastWeekDay = lastWeekDay.asInstanceOf[js.Any])
    __obj.asInstanceOf[BankingScheduledPaymentRecurrenceLastWeekday]
  }
  
  extension [Self <: BankingScheduledPaymentRecurrenceLastWeekday](x: Self) {
