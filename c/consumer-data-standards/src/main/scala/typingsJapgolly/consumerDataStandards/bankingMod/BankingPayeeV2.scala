...
object BankingPayeeV2 {
  
  inline def apply(nickname: String, payeeId: String, `type`: BILLER | DIGITAL_WALLET | DOMESTIC | INTERNATIONAL): BankingPayeeV2 = {
    val __obj = js.Dynamic.literal(nickname = nickname.asInstanceOf[js.Any], payeeId = payeeId.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[BankingPayeeV2]
  }
  
  extension [Self <: BankingPayeeV2](x: Self) {
