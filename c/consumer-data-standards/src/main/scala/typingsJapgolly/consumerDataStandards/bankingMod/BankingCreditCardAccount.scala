...
trait BankingCreditCardAccount
  extends StObject
...
object BankingCreditCardAccount {
  
  inline def apply(minPaymentAmount: String, paymentDueAmount: String, paymentDueDate: String): BankingCreditCardAccount = {
    ...
    __obj.asInstanceOf[BankingCreditCardAccount]
  }
  
  extension [Self <: BankingCreditCardAccount](x: Self) {
