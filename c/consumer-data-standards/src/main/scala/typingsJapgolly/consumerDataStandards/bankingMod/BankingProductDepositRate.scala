...
import typingsJapgolly.consumerDataStandards.anon.AdditionalInfoUri
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.BONUS
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.BUNDLE_BONUS
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.FIXED
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.FLOATING
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.INTRODUCTORY
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.MARKET_LINKED
import typingsJapgolly.consumerDataStandards.consumerDataStandardsStrings.VARIABLE
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait BankingProductDepositRate
  extends StObject
...
object BankingProductDepositRate {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[BankingProductDepositRate]
  }
  
  extension [Self <: BankingProductDepositRate](x: Self) {
