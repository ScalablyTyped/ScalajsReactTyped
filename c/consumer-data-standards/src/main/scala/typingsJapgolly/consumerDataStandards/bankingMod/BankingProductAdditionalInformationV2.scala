...
import typingsJapgolly.consumerDataStandards.anon.Description
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait BankingProductAdditionalInformationV2
  extends StObject
...
object BankingProductAdditionalInformationV2 {
  
  inline def apply(): BankingProductAdditionalInformationV2 = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BankingProductAdditionalInformationV2]
  }
  
  extension [Self <: BankingProductAdditionalInformationV2](x: Self) {
