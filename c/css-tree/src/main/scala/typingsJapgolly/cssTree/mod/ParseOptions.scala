...
object ParseOptions {
  ...
  extension [Self <: ParseOptions](x: Self) {
    ...
    inline def setOnComment(value: (/* value */ String, /* loc */ CssLocation) => Callback): Self = StObject.set(x, "onComment", js.Any.fromFunction2((t0: /* value */ String, t1: /* loc */ CssLocation) => (value(t0, t1)).runNow()))
    
    inline def setOnCommentUndefined: Self = StObject.set(x, "onComment", js.undefined)
    
    inline def setOnParseError(value: (/* error */ SyntaxParseError, /* fallbackNode */ CssNode) => Callback): Self = StObject.set(x, "onParseError", js.Any.fromFunction2((t0: /* error */ SyntaxParseError, t1: /* fallbackNode */ CssNode) => (value(t0, t1)).runNow()))
