...
object ParseOptions {
  ...
  def apply(
    ...
    onParseError: (/* error */ SyntaxParseError, /* fallbackNode */ CssNode) => Callback = null,
    ...
    if (onParseError != null) __obj.updateDynamic("onParseError")(js.Any.fromFunction2((t0: /* error */ typingsJapgolly.cssTree.mod.SyntaxParseError, t1: /* fallbackNode */ typingsJapgolly.cssTree.mod.CssNode) => onParseError(t0, t1).runNow()))
