...
import typingsJapgolly.coinbaseCommerceNode.coinbaseCommerceNodeStrings.email
import typingsJapgolly.coinbaseCommerceNode.coinbaseCommerceNodeStrings.name
