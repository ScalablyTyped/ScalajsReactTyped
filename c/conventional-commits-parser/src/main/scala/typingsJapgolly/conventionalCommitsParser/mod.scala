...
import typingsJapgolly.conventionalCommitsParser.mod.Commit.Field
import typingsJapgolly.conventionalCommitsParser.mod.Commit.Note
import typingsJapgolly.conventionalCommitsParser.mod.Commit.Reference
import typingsJapgolly.conventionalCommitsParser.mod.Commit.Revert
import typingsJapgolly.conventionalCommitsParser.mod.Options.Actions
import typingsJapgolly.conventionalCommitsParser.mod.Options.Correspondence
import typingsJapgolly.conventionalCommitsParser.mod.Options.Keywords
import typingsJapgolly.conventionalCommitsParser.mod.Options.Pattern
import typingsJapgolly.conventionalCommitsParser.mod.Options.Prefixes
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setWarnFunction1(value: /* message */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "warn", js.Any.fromFunction1((t0: /* message */ js.UndefOr[Any]) => value(t0).runNow()))
