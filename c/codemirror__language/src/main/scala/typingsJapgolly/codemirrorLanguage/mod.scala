...
import typingsJapgolly.codemirrorLanguage.anon.Align
import typingsJapgolly.codemirrorLanguage.anon.Except
import typingsJapgolly.codemirrorLanguage.anon.Fallback
import typingsJapgolly.codemirrorLanguage.anon.From
import typingsJapgolly.codemirrorLanguage.anon.OverrideIndentation
import typingsJapgolly.codemirrorLanguage.anon.To
import typingsJapgolly.codemirrorLanguage.codemirrorLanguageInts.`-1`
import typingsJapgolly.codemirrorLanguage.codemirrorLanguageInts.`0`
import typingsJapgolly.codemirrorLanguage.codemirrorLanguageInts.`1`
...
import typingsJapgolly.lezerHighlight.mod.Highlighter
import typingsJapgolly.lezerHighlight.mod.Tag
import typingsJapgolly.lezerLr.distParseMod.ParserConfig
import typingsJapgolly.lezerLr.mod.LRParser
import typingsJapgolly.std.RegExpMatchArray
import typingsJapgolly.styleMod.mod.StyleModule
  ...
  */
  ...
  object LanguageDescription {
    ...
    inline def apply(
      ...
      load: CallbackTo[js.Promise[LanguageSupport]],
      loadFunc: Any,
      loading: Any,
      name: String
    ): LanguageDescription = {
      val __obj = js.Dynamic.literal(alias = alias.asInstanceOf[js.Any], extensions = extensions.asInstanceOf[js.Any], load = load.toJsFn, loadFunc = loadFunc.asInstanceOf[js.Any], loading = loading.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
    ...
    extension [Self <: LanguageDescription](x: Self) {
      ...
      inline def setLoad(value: CallbackTo[js.Promise[LanguageSupport]]): Self = StObject.set(x, "load", value.toJsFn)
  ...
  */
  ...
  object ParseContext {
    ...
    inline def apply(
      ...
      parse: Any,
      parser: Any,
      skipUntilInView: (Double, Double) => Callback,
      startParse: Any,
      state: EditorState,
      viewport: To,
      withContext: Any,
      ...
      val __obj = js.Dynamic.literal(fragments = fragments.asInstanceOf[js.Any], parse = parse.asInstanceOf[js.Any], parser = parser.asInstanceOf[js.Any], skipUntilInView = js.Any.fromFunction2((t0: Double, t1: Double) => (skipUntilInView(t0, t1)).runNow()), startParse = startParse.asInstanceOf[js.Any], state = state.asInstanceOf[js.Any], viewport = viewport.asInstanceOf[js.Any], withContext = withContext.asInstanceOf[js.Any], withoutTempSkipped = withoutTempSkipped.asInstanceOf[js.Any])
    ...
    extension [Self <: ParseContext](x: Self) {
      ...
      inline def setSkipUntilInView(value: (Double, Double) => Callback): Self = StObject.set(x, "skipUntilInView", js.Any.fromFunction2((t0: Double, t1: Double) => (value(t0, t1)).runNow()))
  ...
  */
  ...
  object StreamParser {
    ...
    extension [Self <: StreamParser[?], State](x: Self & StreamParser[State]) {
      ...
      inline def setBlankLine(value: (/* state */ State, /* indentUnit */ Double) => Callback): Self = StObject.set(x, "blankLine", js.Any.fromFunction2((t0: /* state */ State, t1: /* indentUnit */ Double) => (value(t0, t1)).runNow()))
