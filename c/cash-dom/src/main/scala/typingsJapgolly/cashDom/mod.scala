package typingsJapgolly.cashDom
...
import typingsJapgolly.cashDom.anon.Left
import typingsJapgolly.cashDom.cashDomBooleans.`true`
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cashDom.mod.falsy
    - java.lang.String
    - js.Function
    - org.scalajs.dom.HTMLCollection[scala.Any]
    - org.scalajs.dom.NodeList[org.scalajs.dom.Node]
    - typingsJapgolly.cashDom.mod.Ele
    - js.Array[typingsJapgolly.cashDom.mod.Ele]
    - typingsJapgolly.std.ArrayLike[typingsJapgolly.cashDom.mod.Ele]
    - typingsJapgolly.cashDom.mod.Cash
  */
  type Selector = js.UndefOr[
    _Selector | HTMLCollection[Any] | NodeList[Node] | js.Array[Ele] | ArrayLike[Ele] | String | js.Function | Ele | Null
  ]
  ...
  /* Rewritten from type alias, can be one of: 
    - scala.Unit
    - scala.Null
    - typingsJapgolly.cashDom.cashDomBooleans.`false`
    - typingsJapgolly.cashDom.cashDomInts.`0`
    - typingsJapgolly.cashDom.cashDomStrings._empty
  */
