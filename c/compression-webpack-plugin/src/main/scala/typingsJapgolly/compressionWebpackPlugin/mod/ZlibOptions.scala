...
trait ZlibOptions
  ...
  var compressionOptions: js.UndefOr[typingsJapgolly.node.zlibMod.ZlibOptions] = js.undefined
}
...
object ZlibOptions {
  ...
  def apply(
    ...
    compressionOptions: typingsJapgolly.node.zlibMod.ZlibOptions = null,
