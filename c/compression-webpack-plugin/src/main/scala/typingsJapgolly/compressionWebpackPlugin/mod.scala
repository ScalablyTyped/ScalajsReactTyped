...
import typingsJapgolly.compressionWebpackPlugin.anon.ToPrimitive
import typingsJapgolly.compressionWebpackPlugin.anon.ValueOf
import typingsJapgolly.compressionWebpackPlugin.anon.`0`
import typingsJapgolly.compressionWebpackPlugin.anon.`1`
import typingsJapgolly.compressionWebpackPlugin.anon.`2`
import typingsJapgolly.compressionWebpackPlugin.compressionWebpackPluginStrings.`keep-source-map`
...
object mod {
  ...
  open class ^[T] ()
    ...
    /* CompleteClass */
    @JSName("apply")
    override def apply(compiler: typingsJapgolly.webpack.mod.Compiler): Unit = js.native
  ...
  trait CompressionPlugin[T]
    extends StObject
       with typingsJapgolly.webpack.mod.WebpackPluginInstance {
  ...
  object CompressionPlugin {
    ...
    inline def apply[T](
      algorithm: Any,
      apply: typingsJapgolly.webpack.mod.Compiler => Callback,
      compress: Any,
      options: Any,
      runCompressionAlgorithm: Any
    ): CompressionPlugin[T] = {
      val __obj = js.Dynamic.literal(algorithm = algorithm.asInstanceOf[js.Any], apply = js.Any.fromFunction1((t0: typingsJapgolly.webpack.mod.Compiler) => apply(t0).runNow()), compress = compress.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], runCompressionAlgorithm = runCompressionAlgorithm.asInstanceOf[js.Any])
  ...
  type WebpackPluginInstance = typingsJapgolly.webpack.mod.WebpackPluginInstance
  
  type WithImplicitCoercion[T] = T | `2`[T]
  
  type ZlibOptions = typingsJapgolly.node.zlibMod.ZlibOptions
}
