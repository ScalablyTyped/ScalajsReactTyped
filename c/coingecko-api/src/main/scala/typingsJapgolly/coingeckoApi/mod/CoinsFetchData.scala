...
import typingsJapgolly.coingeckoApi.anon.Alexarank
import typingsJapgolly.coingeckoApi.anon.Circulatingsupply
import typingsJapgolly.coingeckoApi.anon.Closedissues
import typingsJapgolly.coingeckoApi.anon.Facebooklikes
import typingsJapgolly.coingeckoApi.anon.Small
