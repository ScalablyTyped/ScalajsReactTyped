...
object distSrcGherkinDocumentWalkerMod {
  ...
  object IHandlers {
    ...
    extension [Self <: IHandlers](x: Self) {
      ...
      inline def setHandleBackground(value: /* background */ Background => Callback): Self = StObject.set(x, "handleBackground", js.Any.fromFunction1((t0: /* background */ Background) => value(t0).runNow()))
      
      inline def setHandleBackgroundUndefined: Self = StObject.set(x, "handleBackground", js.undefined)
      
      inline def setHandleFeature(value: /* feature */ Feature => Callback): Self = StObject.set(x, "handleFeature", js.Any.fromFunction1((t0: /* feature */ Feature) => value(t0).runNow()))
      
      inline def setHandleFeatureUndefined: Self = StObject.set(x, "handleFeature", js.undefined)
      
      inline def setHandleRule(value: /* rule */ Rule => Callback): Self = StObject.set(x, "handleRule", js.Any.fromFunction1((t0: /* rule */ Rule) => value(t0).runNow()))
      
      inline def setHandleRuleUndefined: Self = StObject.set(x, "handleRule", js.undefined)
      
      inline def setHandleScenario(value: /* scenario */ Scenario => Callback): Self = StObject.set(x, "handleScenario", js.Any.fromFunction1((t0: /* scenario */ Scenario) => value(t0).runNow()))
      
      inline def setHandleScenarioUndefined: Self = StObject.set(x, "handleScenario", js.undefined)
      
      inline def setHandleStep(value: /* step */ Step => Callback): Self = StObject.set(x, "handleStep", js.Any.fromFunction1((t0: /* step */ Step) => value(t0).runNow()))
