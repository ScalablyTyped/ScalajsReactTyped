...
import typingsJapgolly.crawler.anon.Log
import typingsJapgolly.crawler.anon.OmitCrawlerRequestOptions
import typingsJapgolly.crawler.crawlerBooleans.`false`
import typingsJapgolly.crawler.crawlerStrings.drain
import typingsJapgolly.crawler.crawlerStrings.limiterChange
import typingsJapgolly.crawler.crawlerStrings.request
import typingsJapgolly.crawler.crawlerStrings.schedule
  ...
  object CrawlerRequestOptions {
    ...
    extension [Self <: CrawlerRequestOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* err */ js.Error, /* res */ CrawlerRequestResponse, /* done */ js.Function0[Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction3((t0: /* err */ js.Error, t1: /* res */ CrawlerRequestResponse, t2: /* done */ js.Function0[Unit]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setPreRequest(
        value: (CrawlerRequestOptions, /* doRequest */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "preRequest", js.Any.fromFunction2((t0: CrawlerRequestOptions, t1: /* doRequest */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
