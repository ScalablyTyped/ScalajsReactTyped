package typingsJapgolly.connectRedis
...
object mod {
  ...
  object RedisStoreOptions {
    ...
    extension [Self <: RedisStoreOptions](x: Self) {
      ...
      inline def setLogErrorsFunction1(value: /* error */ String => Callback): Self = StObject.set(x, "logErrors", js.Any.fromFunction1((t0: /* error */ String) => value(t0).runNow()))
