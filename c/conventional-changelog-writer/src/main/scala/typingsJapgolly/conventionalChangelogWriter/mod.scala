...
import typingsJapgolly.conventionalChangelogWriter.anon.Raw
import typingsJapgolly.conventionalChangelogWriter.conventionalChangelogWriterBooleans.`false`
import typingsJapgolly.conventionalChangelogWriter.conventionalChangelogWriterStrings.raw
import typingsJapgolly.conventionalChangelogWriter.mod.GeneratedContext.ExtraContext
import typingsJapgolly.conventionalChangelogWriter.mod.Options.FinalizeContext
import typingsJapgolly.conventionalChangelogWriter.mod.Options.GenerateOn
import typingsJapgolly.conventionalChangelogWriter.mod.Options.Sort
import typingsJapgolly.conventionalCommitsParser.mod.Commit
import typingsJapgolly.conventionalCommitsParser.mod.Commit.Note
...
object mod {
  ...
  trait Options[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: Context */] extends StObject {
    ...
    var transform: js.UndefOr[
        typingsJapgolly.conventionalChangelogWriter.mod.Options.Transform[TCommit, TContext]
      ] = js.undefined
  }
  object Options {
    ...
    extension [Self <: Options[?, ?], TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: Context */](x: Self & (Options[TCommit, TContext])) {
      ...
      inline def setDebug(value: /* message */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "debug", js.Any.fromFunction1((t0: /* message */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setTransform(value: typingsJapgolly.conventionalChangelogWriter.mod.Options.Transform[TCommit, TContext]): Self = StObject.set(x, "transform", value.asInstanceOf[js.Any])
