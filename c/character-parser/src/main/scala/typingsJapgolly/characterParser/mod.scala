...
import typingsJapgolly.characterParser.anon.End
import typingsJapgolly.characterParser.anon.IgnoreLineComment
import typingsJapgolly.characterParser.anon.IgnoreNesting
import typingsJapgolly.characterParser.anon.Src
...
object mod {
  ...
  object TOKEN_TYPES extends StObject {
    ...
    sealed trait BLOCK_COMMENT
      extends StObject
         with TOKEN_TYPES
    /* "BLOCK_COMMENT" */ val BLOCK_COMMENT: typingsJapgolly.characterParser.mod.TOKEN_TYPES.BLOCK_COMMENT & String = js.native
    
    @js.native
    sealed trait CURLY_BRACKET
      extends StObject
         with TOKEN_TYPES
    /* "CURLY_BRACKET" */ val CURLY_BRACKET: typingsJapgolly.characterParser.mod.TOKEN_TYPES.CURLY_BRACKET & String = js.native
    
    @js.native
    sealed trait DOUBLE_QUOTE
      extends StObject
         with TOKEN_TYPES
    /* "DOUBLE_QUOTE" */ val DOUBLE_QUOTE: typingsJapgolly.characterParser.mod.TOKEN_TYPES.DOUBLE_QUOTE & String = js.native
    
    @js.native
    sealed trait LINE_COMMENT
      extends StObject
         with TOKEN_TYPES
    /* "LINE_COMMENT" */ val LINE_COMMENT: typingsJapgolly.characterParser.mod.TOKEN_TYPES.LINE_COMMENT & String = js.native
    
    @js.native
    sealed trait REGEXP
      extends StObject
         with TOKEN_TYPES
    /* "REGEXP" */ val REGEXP: typingsJapgolly.characterParser.mod.TOKEN_TYPES.REGEXP & String = js.native
    
    @js.native
    sealed trait ROUND_BRACKET
      extends StObject
         with TOKEN_TYPES
    /* "ROUND_BRACKET" */ val ROUND_BRACKET: typingsJapgolly.characterParser.mod.TOKEN_TYPES.ROUND_BRACKET & String = js.native
    
    @js.native
    sealed trait SINGLE_QUOTE
      extends StObject
         with TOKEN_TYPES
    /* "SINGLE_QUOTE" */ val SINGLE_QUOTE: typingsJapgolly.characterParser.mod.TOKEN_TYPES.SINGLE_QUOTE & String = js.native
    
    @js.native
    sealed trait SQUARE_BRACKET
      extends StObject
         with TOKEN_TYPES
    /* "SQUARE_BRACKET" */ val SQUARE_BRACKET: typingsJapgolly.characterParser.mod.TOKEN_TYPES.SQUARE_BRACKET & String = js.native
    
    @js.native
    sealed trait TEMPLATE_QUOTE
      extends StObject
         with TOKEN_TYPES
    /* "TEMPLATE_QUOTE" */ val TEMPLATE_QUOTE: typingsJapgolly.characterParser.mod.TOKEN_TYPES.TEMPLATE_QUOTE & String = js.native
  }
