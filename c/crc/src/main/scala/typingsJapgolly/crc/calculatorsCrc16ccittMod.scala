...
object calculatorsCrc16ccittMod extends Shortcut {
  
  @JSImport("crc/calculators/crc16ccitt", JSImport.Default)
  @js.native
  val default: CRCCalculator[js.typedarray.Uint8Array] = js.native
  
  type _To = CRCCalculator[js.typedarray.Uint8Array]
  
  /* This means you don't have to write `default`, but can instead just say `calculatorsCrc16ccittMod.foo` */
