...
import typingsJapgolly.cookieclicker.Game.UpgradePool
import typingsJapgolly.cookieclicker.Game._TooltipOrigins
...
object cookieclickerStrings {
  ...
  @js.native
  sealed trait Farm extends StObject
  inline def Farm: Farm = "Farm".asInstanceOf[Farm]
  
  @js.native
  sealed trait Garden extends StObject
  inline def Garden: Garden = "Garden".asInstanceOf[Garden]
  
  @js.native
  sealed trait Grimoire extends StObject
  inline def Grimoire: Grimoire = "Grimoire".asInstanceOf[Grimoire]
  
  @js.native
  sealed trait Pantheon extends StObject
  inline def Pantheon: Pantheon = "Pantheon".asInstanceOf[Pantheon]
  
  @js.native
  sealed trait Temple extends StObject
  ...
  @js.native
  sealed trait altDraw extends StObject
  inline def altDraw: altDraw = "altDraw".asInstanceOf[altDraw]
  ...
  @js.native
  sealed trait ascend extends StObject
  ...
  @js.native
  sealed trait askLumps extends StObject
  inline def askLumps: askLumps = "askLumps".asInstanceOf[askLumps]
  ...
  @js.native
  sealed trait autoupdate extends StObject
  inline def autoupdate: autoupdate = "autoupdate".asInstanceOf[autoupdate]
  ...
  @js.native
  sealed trait cursors extends StObject
  inline def cursors: cursors = "cursors".asInstanceOf[cursors]
  
  @js.native
  sealed trait customGrandmas extends StObject
  inline def customGrandmas: customGrandmas = "customGrandmas".asInstanceOf[customGrandmas]
  ...
  @js.native
  sealed trait milk extends StObject
  inline def milk: milk = "milk".asInstanceOf[milk]
  ...
  inline def notifs: notifs = "notifs".asInstanceOf[notifs]
  ...
  inline def particles: particles = "particles".asInstanceOf[particles]
  ...
  sealed trait prestige
    extends StObject
       with UpgradePool
  inline def prestige: prestige = "prestige".asInstanceOf[prestige]
  
  @js.native
  sealed trait prestigeDecor
    extends StObject
       with UpgradePool
  inline def prestigeDecor: prestigeDecor = "prestigeDecor".asInstanceOf[prestigeDecor]
  ...
  sealed trait tech
    extends StObject
       with UpgradePool
  inline def tech: tech = "tech".asInstanceOf[tech]
  ...
  @js.native
  sealed trait wobbly extends StObject
  inline def wobbly: wobbly = "wobbly".asInstanceOf[wobbly]
}
