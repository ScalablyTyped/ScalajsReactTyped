...
import typingsJapgolly.cookieclicker.cookieclickerBooleans.`true`
import typingsJapgolly.cookieclicker.cookieclickerInts.`40`
import typingsJapgolly.cookieclicker.cookieclickerStrings.Garden
