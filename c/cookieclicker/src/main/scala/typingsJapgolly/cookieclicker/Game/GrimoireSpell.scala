...
object GrimoireSpell {
  ...
  inline def apply(costMin: Double, desc: String, icon: Icon, id: Double, name: String, win: CallbackTo[`-1` | Unit]): GrimoireSpell = {
    val __obj = js.Dynamic.literal(costMin = costMin.asInstanceOf[js.Any], desc = desc.asInstanceOf[js.Any], icon = icon.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], win = win.toJsFn)
  ...
  extension [Self <: GrimoireSpell](x: Self) {
    ...
    inline def setFail(value: CallbackTo[`-1` | Unit]): Self = StObject.set(x, "fail", value.toJsFn)
    ...
    inline def setWin(value: CallbackTo[`-1` | Unit]): Self = StObject.set(x, "win", value.toJsFn)
  }
}
