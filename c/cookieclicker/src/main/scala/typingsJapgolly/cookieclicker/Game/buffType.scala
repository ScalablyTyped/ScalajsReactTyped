...
@js.native
trait buffType extends StObject {
  ...
  def func(time: Double, arg1: Double, arg2: Unit, arg3: Double): Buff = js.native
  def func(time: Double, arg1: Unit, arg2: Double): Buff = js.native
  def func(time: Double, arg1: Unit, arg2: Double, arg3: Double): Buff = js.native
  def func(time: Double, arg1: Unit, arg2: Unit, arg3: Double): Buff = js.native
