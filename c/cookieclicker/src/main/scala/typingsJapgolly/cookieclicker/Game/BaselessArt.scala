...
object BaselessArt {
  ...
  extension [Self <: BaselessArt](x: Self) {
    ...
    inline def setBgFunction2(value: (/* building */ GameObject, /* ctx */ CanvasRenderingContext2D) => Callback): Self = StObject.set(x, "bg", js.Any.fromFunction2((t0: /* building */ GameObject, t1: /* ctx */ CanvasRenderingContext2D) => (value(t0, t1)).runNow()))
