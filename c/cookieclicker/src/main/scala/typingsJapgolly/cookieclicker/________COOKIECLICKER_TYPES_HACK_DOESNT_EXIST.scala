...
import org.scalajs.dom.MediaElementAudioSourceNode
  ...
  object Music {
    ...
    object Track {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(audio = audio.asInstanceOf[js.Any], canPlay = canPlay.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], out = out.asInstanceOf[js.Any], play = play.toJsFn, stop = stop.toJsFn)
