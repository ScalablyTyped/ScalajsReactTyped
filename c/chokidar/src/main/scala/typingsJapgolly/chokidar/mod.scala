package typingsJapgolly.chokidar

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.anymatch.mod.AnymatchMatcher
import typingsJapgolly.anymatch.mod.AnymatchPattern
...
object mod {
  ...
  open class FSWatcher ()
    extends EventEmitter
       with typingsJapgolly.node.fsMod.FSWatcher {
