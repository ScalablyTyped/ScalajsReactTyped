...
object Form {
  ...
  inline def apply[T /* <: js.Object */](): Builder[T] = {
  ...
  open class Builder[T /* <: js.Object */] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.calidation.mod.Form[T]] {
  ...
  implicit def make[T /* <: js.Object */](companion: Form.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps[T /* <: js.Object */](p: FormProps[T]): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
