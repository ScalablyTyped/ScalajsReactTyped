...
trait FormValidationProps[T /* <: js.Object */] extends StObject {
  ...
  var onChange: js.UndefOr[js.Function1[/* event */ ReactEventFrom[HTMLFormElement], Unit]] = js.undefined
...
object FormValidationProps {
  ...
  inline def apply[T /* <: js.Object */](children: ValidationContext[T] => Node, config: FieldsConfig[T]): FormValidationProps[T] = {
  ...
  extension [Self <: FormValidationProps[?], T /* <: js.Object */](x: Self & FormValidationProps[T]) {
    ...
    inline def setOnChange(value: /* event */ ReactEventFrom[HTMLFormElement] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[HTMLFormElement]) => value(t0).runNow()))
    ...
    inline def setOnSubmit(value: /* context */ FormContext[T] => Callback): Self = StObject.set(x, "onSubmit", js.Any.fromFunction1((t0: /* context */ FormContext[T]) => value(t0).runNow()))
    ...
    inline def setOnUpdate(value: /* context */ FormContext[T] => Callback): Self = StObject.set(x, "onUpdate", js.Any.fromFunction1((t0: /* context */ FormContext[T]) => value(t0).runNow()))
