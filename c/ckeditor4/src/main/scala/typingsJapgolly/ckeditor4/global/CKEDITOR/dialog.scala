...
import typingsJapgolly.ckeditor4.CKEDITOR.dialog.DialogDefinition
...
open class dialog protected ()
  extends StObject
     with typingsJapgolly.ckeditor4.CKEDITOR.dialog {
  def this(editor: typingsJapgolly.ckeditor4.CKEDITOR.editor, dialogName: String) = this()
}
object dialog {
  ...
  inline def add(
    name: String,
    dialogDefinition: js.Function1[/* editor */ typingsJapgolly.ckeditor4.CKEDITOR.editor, DialogDefinition]
  ...
  /* static member */
  inline def getCurrent(): typingsJapgolly.ckeditor4.CKEDITOR.dialog = ^.asInstanceOf[js.Dynamic].applyDynamic("getCurrent")().asInstanceOf[typingsJapgolly.ckeditor4.CKEDITOR.dialog]
  
  /* static member */
  inline def isTabEnabled(editor: typingsJapgolly.ckeditor4.CKEDITOR.editor, dialogName: String, tabName: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isTabEnabled")(editor.asInstanceOf[js.Any], dialogName.asInstanceOf[js.Any], tabName.asInstanceOf[js.Any])).asInstanceOf[Boolean]
