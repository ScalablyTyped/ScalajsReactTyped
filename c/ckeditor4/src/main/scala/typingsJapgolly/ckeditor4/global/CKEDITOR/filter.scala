...
open class filter protected ()
  extends StObject
     with typingsJapgolly.ckeditor4.CKEDITOR.filter {
  def this(editorOrRules: typingsJapgolly.ckeditor4.CKEDITOR.editor) = this()
...
object filter {
  ...
  @js.native
  val transformationTools: typingsJapgolly.ckeditor4.CKEDITOR.filter.transformationTools = js.native
}
