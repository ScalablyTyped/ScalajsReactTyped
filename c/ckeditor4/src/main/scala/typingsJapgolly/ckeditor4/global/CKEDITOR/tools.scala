...
import typingsJapgolly.ckeditor4.Window
import typingsJapgolly.ckeditor4.anon.Aria
import typingsJapgolly.ckeditor4.anon.Bottom
import typingsJapgolly.ckeditor4.anon.Color
import typingsJapgolly.ckeditor4.anon.Display
import typingsJapgolly.ckeditor4.anon.Input
import typingsJapgolly.ckeditor4.anon.Style
...
object tools {
  ...
  inline def getMouseButton(evt: typingsJapgolly.ckeditor4.CKEDITOR.dom.event): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("getMouseButton")(evt.asInstanceOf[js.Any]).asInstanceOf[Boolean]
