...
object ajax {
  ...
  inline def loadXml(url: String): typingsJapgolly.ckeditor4.CKEDITOR.xml = ^.asInstanceOf[js.Dynamic].applyDynamic("loadXml")(url.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ckeditor4.CKEDITOR.xml]
  inline def loadXml(url: String, callback: js.Function1[/* data */ Any, Unit]): typingsJapgolly.ckeditor4.CKEDITOR.xml = (^.asInstanceOf[js.Dynamic].applyDynamic("loadXml")(url.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.ckeditor4.CKEDITOR.xml]
