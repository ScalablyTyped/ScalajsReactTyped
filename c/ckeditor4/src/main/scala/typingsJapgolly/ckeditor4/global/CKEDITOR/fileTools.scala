...
import typingsJapgolly.ckeditor4.CKEDITOR.fileTools.uploadWidgetDefinition
...
object fileTools {
  ...
  inline def addUploadWidget(editor: typingsJapgolly.ckeditor4.CKEDITOR.editor, name: String, `def`: uploadWidgetDefinition): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("addUploadWidget")(editor.asInstanceOf[js.Any], name.asInstanceOf[js.Any], `def`.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def bindNotification(
    editor: typingsJapgolly.ckeditor4.CKEDITOR.editor,
    fileLoader: typingsJapgolly.ckeditor4.CKEDITOR.fileTools.fileLoader
  ...
  open class fileLoader protected ()
    extends StObject
       with typingsJapgolly.ckeditor4.CKEDITOR.fileTools.fileLoader {
  ...
  open class uploadRepository protected ()
    extends StObject
       with typingsJapgolly.ckeditor4.CKEDITOR.fileTools.uploadRepository {
