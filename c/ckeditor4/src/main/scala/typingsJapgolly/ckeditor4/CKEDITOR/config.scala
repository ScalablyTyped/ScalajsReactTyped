...
import typingsJapgolly.ckeditor4.CKEDITOR.config.styleObject
import typingsJapgolly.ckeditor4.CKEDITOR.dom.element
import typingsJapgolly.ckeditor4.CKEDITOR.editor.eventObject
...
import typingsJapgolly.ckeditor4.anon.Groups
import typingsJapgolly.ckeditor4.ckeditor4Strings.html
import typingsJapgolly.ckeditor4.ckeditor4Strings.text
...
trait config extends StObject {
  ...
  var codeSnippet_languages: js.UndefOr[StringDictionary[Any]] = js.undefined
  ...
  var easyimage_styles: js.UndefOr[StringDictionary[Any]] = js.undefined
  ...
  var fileTools_requestHeaders: js.UndefOr[StringDictionary[Any]] = js.undefined
  ...
  var fillEmptyBlocks: js.UndefOr[
    Boolean | (js.Function1[/* element */ typingsJapgolly.ckeditor4.CKEDITOR.htmlParser.element, Boolean])
  ] = js.undefined
  ...
  var scayt_multiLanguageStyles: js.UndefOr[StringDictionary[Any]] = js.undefined
  ...
  var templates_files: js.UndefOr[StringDictionary[Any]] = js.undefined
  ...
  var toolbarGroups: js.UndefOr[js.Array[typingsJapgolly.ckeditor4.CKEDITOR.toolbarGroups | String]] = js.undefined
...
object config {
  ...
  extension [Self <: config](x: Self) {
    ...
    inline def setBlockedKeystrokesVarargs(value: Double*): Self = StObject.set(x, "blockedKeystrokes", js.Array(value*))
    ...
    inline def setCodeSnippet_languages(value: StringDictionary[Any]): Self = StObject.set(x, "codeSnippet_languages", value.asInstanceOf[js.Any])
    ...
    inline def setContentsCssVarargs(value: String*): Self = StObject.set(x, "contentsCss", js.Array(value*))
    ...
    inline def setCopyFormatting_allowedContextsVarargs(value: String*): Self = StObject.set(x, "copyFormatting_allowedContexts", js.Array(value*))
    ...
    inline def setEasyimage_styles(value: StringDictionary[Any]): Self = StObject.set(x, "easyimage_styles", value.asInstanceOf[js.Any])
    ...
    inline def setEasyimage_toolbarVarargs(value: String*): Self = StObject.set(x, "easyimage_toolbar", js.Array(value*))
    ...
    inline def setExtraAllowedContentVarargs(value: allowedContentRule*): Self = StObject.set(x, "extraAllowedContent", js.Array(value*))
    ...
    inline def setFileTools_requestHeaders(value: StringDictionary[Any]): Self = StObject.set(x, "fileTools_requestHeaders", value.asInstanceOf[js.Any])
    ...
    inline def setFillEmptyBlocks(
      value: Boolean | (js.Function1[/* element */ typingsJapgolly.ckeditor4.CKEDITOR.htmlParser.element, Boolean])
    ): Self = StObject.set(x, "fillEmptyBlocks", value.asInstanceOf[js.Any])
    
    inline def setFillEmptyBlocksFunction1(value: /* element */ typingsJapgolly.ckeditor4.CKEDITOR.htmlParser.element => Boolean): Self = StObject.set(x, "fillEmptyBlocks", js.Any.fromFunction1(value))
    ...
    inline def setImage2_alignClassesVarargs(value: String*): Self = StObject.set(x, "image2_alignClasses", js.Array(value*))
    ...
    inline def setIndentClassesVarargs(value: String*): Self = StObject.set(x, "indentClasses", js.Array(value*))
    ...
    inline def setJustifyClassesVarargs(value: String*): Self = StObject.set(x, "justifyClasses", js.Array(value*))
    ...
    inline def setKeystrokesVarargs(value: (js.Tuple2[Double, String])*): Self = StObject.set(x, "keystrokes", js.Array(value*))
    ...
    inline def setLanguage_listVarargs(value: String*): Self = StObject.set(x, "language_list", js.Array(value*))
    ...
    inline def setMagicline_tabuListVarargs(value: String*): Self = StObject.set(x, "magicline_tabuList", js.Array(value*))
    ...
    inline def setProtectedSource(value: js.Array[js.RegExp]): Self = StObject.set(x, "protectedSource", value.asInstanceOf[js.Any])
    
    inline def setProtectedSourceUndefined: Self = StObject.set(x, "protectedSource", js.undefined)
    
    inline def setProtectedSourceVarargs(value: js.RegExp*): Self = StObject.set(x, "protectedSource", js.Array(value*))
    ...
    inline def setScayt_disableOptionsStorageVarargs(value: String*): Self = StObject.set(x, "scayt_disableOptionsStorage", js.Array(value*))
    ...
    inline def setScayt_multiLanguageStyles(value: StringDictionary[Any]): Self = StObject.set(x, "scayt_multiLanguageStyles", value.asInstanceOf[js.Any])
    ...
    inline def setSmiley_descriptionsVarargs(value: String*): Self = StObject.set(x, "smiley_descriptions", js.Array(value*))
    ...
    inline def setSmiley_imagesVarargs(value: String*): Self = StObject.set(x, "smiley_images", js.Array(value*))
    ...
    inline def setSpecialCharsVarargs(value: (String | (js.Tuple2[String, String]))*): Self = StObject.set(x, "specialChars", js.Array(value*))
    ...
    inline def setStylesSetVarargs(value: styleObject*): Self = StObject.set(x, "stylesSet", js.Array(value*))
    
    inline def setStylesheetParser_skipSelectors(value: js.RegExp): Self = StObject.set(x, "stylesheetParser_skipSelectors", value.asInstanceOf[js.Any])
    
    inline def setStylesheetParser_skipSelectorsUndefined: Self = StObject.set(x, "stylesheetParser_skipSelectors", js.undefined)
    
    inline def setStylesheetParser_validSelectors(value: js.RegExp): Self = StObject.set(x, "stylesheetParser_validSelectors", value.asInstanceOf[js.Any])
    ...
    inline def setTemplates_files(value: StringDictionary[Any]): Self = StObject.set(x, "templates_files", value.asInstanceOf[js.Any])
    ...
    inline def setToolbarGroupsVarargs(value: (toolbarGroups | String)*): Self = StObject.set(x, "toolbarGroups", js.Array(value*))
    ...
    inline def setToolbarVarargs(value: (String | js.Array[String] | Groups)*): Self = StObject.set(x, "toolbar", js.Array(value*))
