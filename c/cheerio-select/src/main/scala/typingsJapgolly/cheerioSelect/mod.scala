...
object mod {
  ...
  @JSImport("cheerio-select", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("cheerio-select", "aliases")
  @js.native
  ...
  @JSImport("cheerio-select", "filters")
  @js.native
  ...
  @JSImport("cheerio-select", "pseudos")
  @js.native
  ...
  trait Options
    extends StObject
       with typingsJapgolly.cssSelect.libTypesMod.Options[AnyNode, Element] {
