...
import typingsJapgolly.createjsLib.anon.HandleEvent
import typingsJapgolly.createjsLib.anon.`0`
...
object global {
  ...
  object createjs {
    ...
    open class Event protected ()
      extends StObject
         with typingsJapgolly.createjsLib.createjs.Event {
      ...
      /* CompleteClass */
      override def set(props: js.Object): typingsJapgolly.createjsLib.createjs.Event = js.native
    ...
    open class EventDispatcher ()
      extends StObject
         with typingsJapgolly.createjsLib.createjs.EventDispatcher
    /* static members */
