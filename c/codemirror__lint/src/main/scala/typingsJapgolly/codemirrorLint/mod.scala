...
import typingsJapgolly.codemirrorLint.codemirrorLintStrings.error
import typingsJapgolly.codemirrorLint.codemirrorLintStrings.info
import typingsJapgolly.codemirrorLint.codemirrorLintStrings.warning
...
object mod {
  ...
  */
  ...
  object Action {
    ...
    inline def apply(apply: (EditorView, Double, Double) => Callback, name: String): Action = {
      val __obj = js.Dynamic.literal(apply = js.Any.fromFunction3((t0: EditorView, t1: Double, t2: Double) => (apply(t0, t1, t2)).runNow()), name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[Action]
    }
    
    extension [Self <: Action](x: Self) {
      
      inline def setApply(value: (EditorView, Double, Double) => Callback): Self = StObject.set(x, "apply", js.Any.fromFunction3((t0: EditorView, t1: Double, t2: Double) => (value(t0, t1, t2)).runNow()))
  ...
  */
  ...
  object Diagnostic {
    ...
    extension [Self <: Diagnostic](x: Self) {
      ...
      inline def setRenderMessage(value: CallbackTo[Node]): Self = StObject.set(x, "renderMessage", value.toJsFn)
