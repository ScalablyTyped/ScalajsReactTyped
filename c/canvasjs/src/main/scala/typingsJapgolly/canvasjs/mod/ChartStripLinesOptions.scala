...
import typingsJapgolly.canvasjs.AnonAxis
...
object ChartStripLinesOptions {
  ...
  def apply(
    ...
    labelFormatter: /* e */ js.UndefOr[AnonAxis] => CallbackTo[String] = null,
    ...
    if (labelFormatter != null) __obj.updateDynamic("labelFormatter")(js.Any.fromFunction1((t0: /* e */ js.UndefOr[typingsJapgolly.canvasjs.AnonAxis]) => labelFormatter(t0).runNow()))
