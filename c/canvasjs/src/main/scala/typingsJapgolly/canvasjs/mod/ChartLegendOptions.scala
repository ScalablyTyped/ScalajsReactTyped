...
import typingsJapgolly.canvasjs.anon.DataPoint
...
object ChartLegendOptions {
  ...
  extension [Self <: ChartLegendOptions](x: Self) {
    ...
    inline def setItemclick(value: /* event */ ChartEvent => Callback): Self = StObject.set(x, "itemclick", js.Any.fromFunction1((t0: /* event */ ChartEvent) => value(t0).runNow()))
    
    inline def setItemclickUndefined: Self = StObject.set(x, "itemclick", js.undefined)
    
    inline def setItemmousemove(value: /* event */ ChartEvent => Callback): Self = StObject.set(x, "itemmousemove", js.Any.fromFunction1((t0: /* event */ ChartEvent) => value(t0).runNow()))
    
    inline def setItemmousemoveUndefined: Self = StObject.set(x, "itemmousemove", js.undefined)
    
    inline def setItemmouseout(value: /* event */ ChartEvent => Callback): Self = StObject.set(x, "itemmouseout", js.Any.fromFunction1((t0: /* event */ ChartEvent) => value(t0).runNow()))
    
    inline def setItemmouseoutUndefined: Self = StObject.set(x, "itemmouseout", js.undefined)
    
    inline def setItemmouseover(value: /* event */ ChartEvent => Callback): Self = StObject.set(x, "itemmouseover", js.Any.fromFunction1((t0: /* event */ ChartEvent) => value(t0).runNow()))
