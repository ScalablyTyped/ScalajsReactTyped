...
import typingsJapgolly.canvasjs.AnonEntries
...
object ChartToolTipOptions {
  ...
  def apply(
    ...
    content: String = null,
    contentFormatter: /* e */ AnonEntries => CallbackTo[String] = null,
    ...
    if (contentFormatter != null) __obj.updateDynamic("contentFormatter")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.canvasjs.AnonEntries) => contentFormatter(t0).runNow()))
