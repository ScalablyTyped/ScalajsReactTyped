...
import typingsJapgolly.canvasjs.AnonDataSeries
...
object ChartDataPoint {
  @scala.inline
  def apply(
    click: /* event */ ChartEvent => Callback = null,
    color: String = null,
    ...
    indexLabelFormatter: /* e */ AnonDataSeries => CallbackTo[String] = null,
    ...
    mousemove: /* event */ ChartEvent => Callback = null,
    mouseout: /* event */ ChartEvent => Callback = null,
    mouseover: /* event */ ChartEvent => Callback = null,
    name: String = null,
    ...
    if (click != null) __obj.updateDynamic("click")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.canvasjs.mod.ChartEvent) => click(t0).runNow()))
    ...
    if (indexLabelFormatter != null) __obj.updateDynamic("indexLabelFormatter")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.canvasjs.AnonDataSeries) => indexLabelFormatter(t0).runNow()))
    ...
    if (mousemove != null) __obj.updateDynamic("mousemove")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.canvasjs.mod.ChartEvent) => mousemove(t0).runNow()))
    if (mouseout != null) __obj.updateDynamic("mouseout")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.canvasjs.mod.ChartEvent) => mouseout(t0).runNow()))
    if (mouseover != null) __obj.updateDynamic("mouseover")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.canvasjs.mod.ChartEvent) => mouseover(t0).runNow()))
