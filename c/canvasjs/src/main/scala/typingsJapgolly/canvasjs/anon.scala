...
import typingsJapgolly.canvasjs.mod.ChartAxisYOptions
...
object anon {
  ...
  trait Axis extends StObject {
    ...
    var chart: typingsJapgolly.canvasjs.mod.Chart
  ...
  object Axis {
    ...
    inline def apply(axis: ChartAxisYOptions, chart: typingsJapgolly.canvasjs.mod.Chart, label: String, value: Double): Axis = {
    ...
    extension [Self <: Axis](x: Self) {
      ...
      inline def setChart(value: typingsJapgolly.canvasjs.mod.Chart): Self = StObject.set(x, "chart", value.asInstanceOf[js.Any])
  ...
  object Chart {
    ...
    inline def apply(
      chart: typingsJapgolly.canvasjs.mod.Chart,
  ...
  object Entries {
    ...
    inline def apply(chart: typingsJapgolly.canvasjs.mod.Chart, entries: js.Array[DataSeries], toolTip: Entries): Entries = {
  ...
  object Stripline {
    ...
    inline def apply(axis: ChartAxisYOptions, chart: typingsJapgolly.canvasjs.mod.Chart, stripline: Stripline): Stripline = {
