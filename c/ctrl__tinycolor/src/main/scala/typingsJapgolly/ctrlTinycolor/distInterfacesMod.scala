...
import typingsJapgolly.ctrlTinycolor.distMod._ColorInput
...
object distInterfacesMod {
  ...
  - typingsJapgolly.ctrlTinycolor.distMod._ColorInput because Already inherited */ trait HSLA
    extends StObject
       with HSL {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.ctrlTinycolor.distMod._ColorInput because Already inherited */ trait HSVA
    extends StObject
       with HSV {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.ctrlTinycolor.distMod._ColorInput because Already inherited */ trait RGBA
    extends StObject
       with RGB {
