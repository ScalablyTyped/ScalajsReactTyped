...
import typingsJapgolly.ctrlTinycolor.distMod.ColorFormats
...
object ctrlTinycolorStrings {
  ...
  @js.native
  sealed trait AAA extends StObject
  ...
  sealed trait hex4
    extends StObject
       with ColorFormats
  inline def hex4: hex4 = "hex4".asInstanceOf[hex4]
  
  @js.native
  sealed trait hex6
    extends StObject
       with ColorFormats
  inline def hex6: hex6 = "hex6".asInstanceOf[hex6]
  
  @js.native
  sealed trait hex8
    extends StObject
       with ColorFormats
  inline def hex8: hex8 = "hex8".asInstanceOf[hex8]
  ...
  sealed trait prgb
    extends StObject
       with ColorFormats
  inline def prgb: prgb = "prgb".asInstanceOf[prgb]
