...
import typingsJapgolly.chromecastApi.chromecastApiStrings.device
...
object libClientMod {
  ...
  trait Client extends EventEmitter {
    ...
    /**
      ...
      */
    var devices: js.Array[typingsJapgolly.chromecastApi.libDeviceMod.^] = js.native
    
    /**
      * The device event is emitted each time a new device has been found.
      */
    @JSName("on")
    def on_device(event: device, listener: js.Function1[/* d */ typingsJapgolly.chromecastApi.libDeviceMod.^, Unit]): this.type = js.native
