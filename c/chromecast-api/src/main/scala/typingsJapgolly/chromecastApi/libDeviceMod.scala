...
import typingsJapgolly.chromecastApi.anon.BackgroundColor
import typingsJapgolly.chromecastApi.anon.ContentId
import typingsJapgolly.chromecastApi.anon.Language
import typingsJapgolly.chromecastApi.anon.Title
import typingsJapgolly.chromecastApi.chromecastApiInts.`0`
import typingsJapgolly.chromecastApi.chromecastApiInts.`1`
import typingsJapgolly.chromecastApi.chromecastApiInts.`2`
import typingsJapgolly.chromecastApi.chromecastApiInts.`3`
import typingsJapgolly.chromecastApi.chromecastApiInts.`4`
import typingsJapgolly.chromecastApi.chromecastApiStrings.BUFFERING
import typingsJapgolly.chromecastApi.chromecastApiStrings.CANCELLED
import typingsJapgolly.chromecastApi.chromecastApiStrings.ERROR
import typingsJapgolly.chromecastApi.chromecastApiStrings.FINISHED
import typingsJapgolly.chromecastApi.chromecastApiStrings.IDLE
import typingsJapgolly.chromecastApi.chromecastApiStrings.INTERRUPTED
import typingsJapgolly.chromecastApi.chromecastApiStrings.PAUSED
import typingsJapgolly.chromecastApi.chromecastApiStrings.PLAYING
import typingsJapgolly.chromecastApi.chromecastApiStrings.connected
import typingsJapgolly.chromecastApi.chromecastApiStrings.finished_
import typingsJapgolly.chromecastApi.chromecastApiStrings.status
