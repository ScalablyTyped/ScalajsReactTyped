package typingsJapgolly.canvaskitWasm

import typingsJapgolly.canvaskitWasm.mod.SkBlurStyle
...
trait SkEnumSkBlurStyleInnerSkB extends js.Object {
  val Inner: SkBlurStyle
  val Normal: SkBlurStyle
  val Outer: SkBlurStyle
  val Solid: SkBlurStyle
  val values: js.Array[SkBlurStyle]
}
