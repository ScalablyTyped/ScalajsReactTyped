...
import typingsJapgolly.canvaskitWasm.mod.SkAlphaType
...
trait SkEnumSkAlphaTypeOpaqueSk extends js.Object {
  val Opaque: SkAlphaType
  val Premul: SkAlphaType
  val Unpremul: SkAlphaType
  val values: js.Array[SkAlphaType]
}
