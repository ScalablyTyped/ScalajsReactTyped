...
import typingsJapgolly.webgpuTypes.GPUDevice
import typingsJapgolly.webgpuTypes.GPUTexture
...
trait CanvasKit extends StObject {
  ...
  /**
    ...
    *                is used.
    */
  def MakeGPUCanvasSurface(canvasContext: WebGPUCanvasContext, colorSpace: typingsJapgolly.canvaskitWasm.mod.ColorSpace): Surface | Null = js.native
  def MakeGPUCanvasSurface(
    canvasContext: WebGPUCanvasContext,
    colorSpace: typingsJapgolly.canvaskitWasm.mod.ColorSpace,
    width: Double
  ...
  /**
    ...
    */
  def MakeVertices(
    mode: typingsJapgolly.canvaskitWasm.mod.VertexMode,
  ...
  def MakeWebGLCanvasSurface(canvas: String, colorSpace: typingsJapgolly.canvaskitWasm.mod.ColorSpace): Surface | Null = js.native
  def MakeWebGLCanvasSurface(canvas: String, colorSpace: typingsJapgolly.canvaskitWasm.mod.ColorSpace, opts: WebGLOptions): Surface | Null = js.native
  /**
  ...
  def MakeWebGLCanvasSurface(canvas: HTMLCanvasElement, colorSpace: typingsJapgolly.canvaskitWasm.mod.ColorSpace): Surface | Null = js.native
  def MakeWebGLCanvasSurface(
  ...
  val Paint: DefaultConstructor[typingsJapgolly.canvaskitWasm.mod.Paint] = js.native
  ...
  val PictureRecorder: DefaultConstructor[typingsJapgolly.canvaskitWasm.mod.PictureRecorder] = js.native
  ...
  def getShadowLocalBounds(
    ctm: InputMatrix,
    path: typingsJapgolly.canvaskitWasm.mod.Path,
