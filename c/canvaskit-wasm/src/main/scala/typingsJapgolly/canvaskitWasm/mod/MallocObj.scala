...
object MallocObj {
  ...
  inline def apply(
    ...
    toTypedArray: CallbackTo[TypedArray]
  ): MallocObj = {
    val __obj = js.Dynamic.literal(byteOffset = byteOffset.asInstanceOf[js.Any], length = length.asInstanceOf[js.Any], subarray = js.Any.fromFunction2(subarray), toTypedArray = toTypedArray.toJsFn)
  ...
  extension [Self <: MallocObj](x: Self) {
    ...
    inline def setToTypedArray(value: CallbackTo[TypedArray]): Self = StObject.set(x, "toTypedArray", value.toJsFn)
  }
}
