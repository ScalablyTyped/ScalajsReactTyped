...
object ColorMatrixHelpers {
  ...
  inline def apply(
    ...
    identity: CallbackTo[js.typedarray.Float32Array],
    ...
    val __obj = js.Dynamic.literal(concat = js.Any.fromFunction2(concat), identity = identity.toJsFn, postTranslate = js.Any.fromFunction5(postTranslate), rotated = js.Any.fromFunction3(rotated), scaled = js.Any.fromFunction4(scaled))
  ...
  extension [Self <: ColorMatrixHelpers](x: Self) {
    ...
    inline def setIdentity(value: CallbackTo[js.typedarray.Float32Array]): Self = StObject.set(x, "identity", value.toJsFn)
