...
trait Tester extends js.Object {
  ...
  def assertMatch(subject: js.Any, pattern: js.RegExp): js.Any = js.native
  def assertMatch(subject: js.Any, pattern: js.RegExp, message: String): js.Any = js.native
  ...
  def assertTitleMatch(pattern: js.RegExp): js.Any = js.native
  def assertTitleMatch(pattern: js.RegExp, message: String): js.Any = js.native
