package typingsJapgolly.canvas

import typingsJapgolly.canvas.anon.Family
import typingsJapgolly.canvas.canvasInts.`0`
import typingsJapgolly.canvas.canvasInts.`1`
import typingsJapgolly.canvas.canvasInts.`2`
import typingsJapgolly.canvas.canvasInts.`3`
import typingsJapgolly.canvas.canvasInts.`4`
import typingsJapgolly.canvas.canvasInts.`5`
import typingsJapgolly.canvas.canvasInts.`6`
import typingsJapgolly.canvas.canvasInts.`7`
import typingsJapgolly.canvas.canvasInts.`8`
import typingsJapgolly.canvas.canvasInts.`9`
import typingsJapgolly.canvas.canvasStrings.A1
import typingsJapgolly.canvas.canvasStrings.A8
import typingsJapgolly.canvas.canvasStrings.RGB16_565
import typingsJapgolly.canvas.canvasStrings.RGB24
import typingsJapgolly.canvas.canvasStrings.RGB30
import typingsJapgolly.canvas.canvasStrings.RGBA32
import typingsJapgolly.canvas.canvasStrings._empty
import typingsJapgolly.canvas.canvasStrings.`2d`
import typingsJapgolly.canvas.canvasStrings.`no-repeat`
import typingsJapgolly.canvas.canvasStrings.`repeat-x`
import typingsJapgolly.canvas.canvasStrings.`repeat-y`
import typingsJapgolly.canvas.canvasStrings.applicationSlashpdf
import typingsJapgolly.canvas.canvasStrings.best
import typingsJapgolly.canvas.canvasStrings.bilinear
import typingsJapgolly.canvas.canvasStrings.default
import typingsJapgolly.canvas.canvasStrings.fast
import typingsJapgolly.canvas.canvasStrings.glyph
import typingsJapgolly.canvas.canvasStrings.good
import typingsJapgolly.canvas.canvasStrings.gray
import typingsJapgolly.canvas.canvasStrings.image
import typingsJapgolly.canvas.canvasStrings.imageSlashjpeg
import typingsJapgolly.canvas.canvasStrings.imageSlashpng
import typingsJapgolly.canvas.canvasStrings.nearest
import typingsJapgolly.canvas.canvasStrings.none
import typingsJapgolly.canvas.canvasStrings.path
import typingsJapgolly.canvas.canvasStrings.pdf
import typingsJapgolly.canvas.canvasStrings.raw
import typingsJapgolly.canvas.canvasStrings.repeat
import typingsJapgolly.canvas.canvasStrings.subpixel
import typingsJapgolly.canvas.canvasStrings.svg
...
import typingsJapgolly.std.PredefinedColorSpace
...
object mod {
  ...
  open class CanvasGradient ()
    extends StObject
       with typingsJapgolly.std.CanvasGradient {
  ...
  open class CanvasPattern ()
    extends StObject
       with typingsJapgolly.std.CanvasPattern
  ...
  open class ImageData ()
    extends StObject
       with typingsJapgolly.std.ImageData {
  ...
  inline def createImageData(data: js.typedarray.Uint16Array, width: Double): org.scalajs.dom.ImageData = (^.asInstanceOf[js.Dynamic].applyDynamic("createImageData")(data.asInstanceOf[js.Any], width.asInstanceOf[js.Any])).asInstanceOf[org.scalajs.dom.ImageData]
  inline def createImageData(data: js.typedarray.Uint16Array, width: Double, height: Double): org.scalajs.dom.ImageData = (^.asInstanceOf[js.Dynamic].applyDynamic("createImageData")(data.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any])).asInstanceOf[org.scalajs.dom.ImageData]
  inline def createImageData(data: js.typedarray.Uint8ClampedArray, width: Double): org.scalajs.dom.ImageData = (^.asInstanceOf[js.Dynamic].applyDynamic("createImageData")(data.asInstanceOf[js.Any], width.asInstanceOf[js.Any])).asInstanceOf[org.scalajs.dom.ImageData]
  inline def createImageData(data: js.typedarray.Uint8ClampedArray, width: Double, height: Double): org.scalajs.dom.ImageData = (^.asInstanceOf[js.Dynamic].applyDynamic("createImageData")(data.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any])).asInstanceOf[org.scalajs.dom.ImageData]
  inline def createImageData(width: Double, height: Double): org.scalajs.dom.ImageData = (^.asInstanceOf[js.Dynamic].applyDynamic("createImageData")(width.asInstanceOf[js.Any], height.asInstanceOf[js.Any])).asInstanceOf[org.scalajs.dom.ImageData]
  ...
  type NodeCanvasCanvasGradient = org.scalajs.dom.CanvasGradient
  
  type NodeCanvasCanvasPattern = org.scalajs.dom.CanvasPattern
  
  type NodeCanvasDOMMatrix = typingsJapgolly.std.DOMMatrix
  
  type NodeCanvasDOMPoint = typingsJapgolly.std.DOMPoint
  
  type NodeCanvasImageData = org.scalajs.dom.ImageData
  
  @js.native
  trait NodeCanvasRenderingContext2D
    extends StObject
       with typingsJapgolly.std.CanvasRenderingContext2D {
    ...
    /**
    	 ...
    	 */
    def createPattern(args: Any*): org.scalajs.dom.CanvasPattern = js.native
    def createPattern(image: Canvas): org.scalajs.dom.CanvasPattern = js.native
    def createPattern(image: Canvas, repetition: repeat | `repeat-x` | `repeat-y` | `no-repeat` | _empty): org.scalajs.dom.CanvasPattern = js.native
    def createPattern(image: Image): org.scalajs.dom.CanvasPattern = js.native
    def createPattern(image: Image, repetition: repeat | `repeat-x` | `repeat-y` | `no-repeat` | _empty): org.scalajs.dom.CanvasPattern = js.native
