package typingsJapgolly.commandLineArgs.mod
...
object OptionDefinition {
  ...
  def apply(
    ...
    `type`: /* input */ String => CallbackTo[js.Any] = null
  ): OptionDefinition = {
    ...
    if (`type` != null) __obj.updateDynamic("type")(js.Any.fromFunction1((t0: /* input */ java.lang.String) => `type`(t0).runNow()))
