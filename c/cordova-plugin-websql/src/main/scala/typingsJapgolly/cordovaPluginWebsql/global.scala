...
object global {
  ...
  open class Database protected ()
    extends StObject
       with typingsJapgolly.cordovaPluginWebsql.Database {
    ...
    def this(
      ...
      displayname: String,
      size: Double,
      creationCallback: js.Function1[/* database */ typingsJapgolly.cordovaPluginWebsql.Database, Unit]
    ) = this()
  }
  ...
  open class SqlTransaction ()
    extends StObject
       with typingsJapgolly.cordovaPluginWebsql.SqlTransaction
}
