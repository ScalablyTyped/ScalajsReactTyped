...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typingsJapgolly.colorRgba.mod.RGBTuple
    - typingsJapgolly.colorRgba.mod.RGBColor
    - typingsJapgolly.colorRgba.mod.RGBKeyedColor
    - typingsJapgolly.colorRgba.mod.HSL
  */
  ...
  object _ColorValue {
    ...
    inline def HSL(h: Double, l: Double, s: Double): typingsJapgolly.colorRgba.mod.HSL = {
      val __obj = js.Dynamic.literal(h = h.asInstanceOf[js.Any], l = l.asInstanceOf[js.Any], s = s.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.colorRgba.mod.HSL]
    }
    
    inline def RGBColor(b: Double, g: Double, r: Double): typingsJapgolly.colorRgba.mod.RGBColor = {
      val __obj = js.Dynamic.literal(b = b.asInstanceOf[js.Any], g = g.asInstanceOf[js.Any], r = r.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.colorRgba.mod.RGBColor]
    }
    
    inline def RGBKeyedColor(blue: Double, green: Double, red: Double): typingsJapgolly.colorRgba.mod.RGBKeyedColor = {
      val __obj = js.Dynamic.literal(blue = blue.asInstanceOf[js.Any], green = green.asInstanceOf[js.Any], red = red.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.colorRgba.mod.RGBKeyedColor]
    }
  }
}
