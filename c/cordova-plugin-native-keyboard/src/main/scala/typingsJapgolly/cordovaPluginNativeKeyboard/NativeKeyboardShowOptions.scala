...
object NativeKeyboardShowOptions {
  ...
  def apply(
    ...
    onKeyboardDidHide: js.UndefOr[Callback] = js.undefined,
    onKeyboardDidShow: js.UndefOr[Callback] = js.undefined,
    onKeyboardWillHide: js.UndefOr[Callback] = js.undefined,
    onKeyboardWillShow: js.UndefOr[Callback] = js.undefined,
    onTextChanged: /* text */ String => Callback = null,
    ...
    __obj.updateDynamic("onSubmit")(js.Any.fromFunction1((t0: java.lang.String) => onSubmit(t0).runNow()))
    ...
    onKeyboardDidHide.foreach(p => __obj.updateDynamic("onKeyboardDidHide")(p.toJsFn))
    onKeyboardDidShow.foreach(p => __obj.updateDynamic("onKeyboardDidShow")(p.toJsFn))
    onKeyboardWillHide.foreach(p => __obj.updateDynamic("onKeyboardWillHide")(p.toJsFn))
    onKeyboardWillShow.foreach(p => __obj.updateDynamic("onKeyboardWillShow")(p.toJsFn))
    if (onTextChanged != null) __obj.updateDynamic("onTextChanged")(js.Any.fromFunction1((t0: /* text */ java.lang.String) => onTextChanged(t0).runNow()))
