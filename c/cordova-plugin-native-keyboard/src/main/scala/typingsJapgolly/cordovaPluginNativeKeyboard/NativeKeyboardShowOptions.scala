...
object NativeKeyboardShowOptions {
  ...
  inline def apply(onSubmit: String => Callback): NativeKeyboardShowOptions = {
    val __obj = js.Dynamic.literal(onSubmit = js.Any.fromFunction1((t0: String) => onSubmit(t0).runNow()))
    __obj.asInstanceOf[NativeKeyboardShowOptions]
  }
  
  extension [Self <: NativeKeyboardShowOptions](x: Self) {
    ...
    inline def setOnKeyboardDidHide(value: Callback): Self = StObject.set(x, "onKeyboardDidHide", value.toJsFn)
    
    inline def setOnKeyboardDidHideUndefined: Self = StObject.set(x, "onKeyboardDidHide", js.undefined)
    
    inline def setOnKeyboardDidShow(value: Callback): Self = StObject.set(x, "onKeyboardDidShow", value.toJsFn)
    
    inline def setOnKeyboardDidShowUndefined: Self = StObject.set(x, "onKeyboardDidShow", js.undefined)
    
    inline def setOnKeyboardWillHide(value: Callback): Self = StObject.set(x, "onKeyboardWillHide", value.toJsFn)
    
    inline def setOnKeyboardWillHideUndefined: Self = StObject.set(x, "onKeyboardWillHide", js.undefined)
    
    inline def setOnKeyboardWillShow(value: Callback): Self = StObject.set(x, "onKeyboardWillShow", value.toJsFn)
    
    inline def setOnKeyboardWillShowUndefined: Self = StObject.set(x, "onKeyboardWillShow", js.undefined)
    
    inline def setOnSubmit(value: String => Callback): Self = StObject.set(x, "onSubmit", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    
    inline def setOnTextChanged(value: /* text */ String => Callback): Self = StObject.set(x, "onTextChanged", js.Any.fromFunction1((t0: /* text */ String) => value(t0).runNow()))
