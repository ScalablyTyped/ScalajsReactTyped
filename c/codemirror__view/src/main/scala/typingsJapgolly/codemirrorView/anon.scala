package typingsJapgolly.codemirrorView

import japgolly.scalajs.react.Callback
import org.scalajs.dom.HTMLElement
import org.scalajs.dom.MouseEvent
import typingsJapgolly.codemirrorState.mod.Transaction
import typingsJapgolly.codemirrorView.codemirrorViewStrings.Alt
import typingsJapgolly.codemirrorView.codemirrorViewStrings.Control
import typingsJapgolly.codemirrorView.codemirrorViewStrings.Meta
import typingsJapgolly.codemirrorView.codemirrorViewStrings.Shift
import typingsJapgolly.codemirrorView.codemirrorViewStrings.absolute
import typingsJapgolly.codemirrorView.codemirrorViewStrings.fixed
import typingsJapgolly.codemirrorView.codemirrorViewStrings.touch
import typingsJapgolly.codemirrorView.mod.Decoration
import typingsJapgolly.codemirrorView.mod.EditorView
import typingsJapgolly.codemirrorView.mod.Tooltip
...
object anon {
  ...
  object Boundary {
    ...
    extension [Self <: Boundary](x: Self) {
      ...
      inline def setDecorate(
        value: (/* add */ js.Function3[/* from */ Double, /* to */ Double, /* decoration */ Decoration, Unit], /* from */ Double, /* to */ Double, /* match */ RegExpExecArray, /* view */ EditorView) => Callback
      ): Self = StObject.set(x, "decorate", js.Any.fromFunction5((t0: /* add */ js.Function3[/* from */ Double, /* to */ Double, /* decoration */ Decoration, Unit], t1: /* from */ Double, t2: /* to */ Double, t3: /* match */ RegExpExecArray, t4: /* view */ EditorView) => (value(t0, t1, t2, t3, t4)).runNow()))
  ...
  object Node {
    ...
    inline def apply(node: org.scalajs.dom.Node, offset: Double): Node = {
