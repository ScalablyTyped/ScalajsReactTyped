...
checking.
*/
/* Inlined {[ event in keyof @codemirror/view.@codemirror/view.DOMEventMap ]:? (this : This, event : @codemirror/view.@codemirror/view.DOMEventMap[event], view : @codemirror/view.@codemirror/view.EditorView): boolean | void} */
trait DOMEventHandlers[This] extends StObject {
  
  var abort: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ UIEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  
  var animationcancel: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ AnimationEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  ...
  var auxclick: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ MouseEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  
  var beforeinput: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ InputEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  ...
  var compositionend: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ CompositionEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  ...
  var copy: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ ClipboardEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  ...
  var drag: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ DragEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  ...
  var error: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ ErrorEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  ...
  var formdata: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ FormDataEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  ...
  var gotpointercapture: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ PointerEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  ...
  var keydown: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ KeyboardEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  ...
  var progress: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ ProgressEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  ...
  var submit: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ SubmitEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  ...
  var touchcancel: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ TouchEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  ...
  var transitioncancel: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ TransitionEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
  ...
  var wheel: js.UndefOr[
    js.ThisFunction2[/* this */ This, /* event */ WheelEvent, /* view */ EditorView, Boolean | Unit]
  ] = js.undefined
}
object DOMEventHandlers {
  
  inline def apply[This](): DOMEventHandlers[This] = {
  ...
  extension [Self <: DOMEventHandlers[?], This](x: Self & DOMEventHandlers[This]) {
    ...
    inline def setAnimationcancel(
      value: js.ThisFunction2[/* this */ This, /* event */ AnimationEvent, /* view */ EditorView, Boolean | Unit]
    ...
    inline def setAuxclick(
      value: js.ThisFunction2[/* this */ This, /* event */ MouseEvent, /* view */ EditorView, Boolean | Unit]
    ...
    inline def setBeforeinput(
      value: js.ThisFunction2[/* this */ This, /* event */ InputEvent, /* view */ EditorView, Boolean | Unit]
    ...
    inline def setBlur(
      value: js.ThisFunction2[/* this */ This, /* event */ FocusEvent, /* view */ EditorView, Boolean | Unit]
    ...
    inline def setCanplaythrough(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "canplaythrough", value.asInstanceOf[js.Any])
    
    inline def setCanplaythroughUndefined: Self = StObject.set(x, "canplaythrough", js.undefined)
    
    inline def setChange(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "change", value.asInstanceOf[js.Any])
    ...
    inline def setClose(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "close", value.asInstanceOf[js.Any])
    
    inline def setCloseUndefined: Self = StObject.set(x, "close", js.undefined)
    
    inline def setCompositionend(
      value: js.ThisFunction2[/* this */ This, /* event */ CompositionEvent, /* view */ EditorView, Boolean | Unit]
    ...
    inline def setCopy(
      value: js.ThisFunction2[/* this */ This, /* event */ ClipboardEvent, /* view */ EditorView, Boolean | Unit]
    ): Self = StObject.set(x, "copy", value.asInstanceOf[js.Any])
    
    inline def setCopyUndefined: Self = StObject.set(x, "copy", js.undefined)
    
    inline def setCuechange(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "cuechange", value.asInstanceOf[js.Any])
    ...
    inline def setDrag(
      value: js.ThisFunction2[/* this */ This, /* event */ DragEvent, /* view */ EditorView, Boolean | Unit]
    ...
    inline def setDurationchange(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "durationchange", value.asInstanceOf[js.Any])
    
    inline def setDurationchangeUndefined: Self = StObject.set(x, "durationchange", js.undefined)
    
    inline def setEmptied(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "emptied", value.asInstanceOf[js.Any])
    
    inline def setEmptiedUndefined: Self = StObject.set(x, "emptied", js.undefined)
    
    inline def setEnded(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "ended", value.asInstanceOf[js.Any])
    
    inline def setEndedUndefined: Self = StObject.set(x, "ended", js.undefined)
    
    inline def setError(
      value: js.ThisFunction2[/* this */ This, /* event */ ErrorEvent, /* view */ EditorView, Boolean | Unit]
    ...
    inline def setFormdata(
      value: js.ThisFunction2[/* this */ This, /* event */ FormDataEvent, /* view */ EditorView, Boolean | Unit]
    ): Self = StObject.set(x, "formdata", value.asInstanceOf[js.Any])
    
    inline def setFormdataUndefined: Self = StObject.set(x, "formdata", js.undefined)
    
    inline def setFullscreenchange(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "fullscreenchange", value.asInstanceOf[js.Any])
    
    inline def setFullscreenchangeUndefined: Self = StObject.set(x, "fullscreenchange", js.undefined)
    
    inline def setFullscreenerror(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "fullscreenerror", value.asInstanceOf[js.Any])
    
    inline def setFullscreenerrorUndefined: Self = StObject.set(x, "fullscreenerror", js.undefined)
    
    inline def setGotpointercapture(
      value: js.ThisFunction2[/* this */ This, /* event */ PointerEvent, /* view */ EditorView, Boolean | Unit]
    ...
    inline def setInput(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "input", value.asInstanceOf[js.Any])
    
    inline def setInputUndefined: Self = StObject.set(x, "input", js.undefined)
    
    inline def setInvalid(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "invalid", value.asInstanceOf[js.Any])
    
    inline def setInvalidUndefined: Self = StObject.set(x, "invalid", js.undefined)
    
    inline def setKeydown(
      value: js.ThisFunction2[/* this */ This, /* event */ KeyboardEvent, /* view */ EditorView, Boolean | Unit]
    ...
    inline def setLoad(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "load", value.asInstanceOf[js.Any])
    
    inline def setLoadUndefined: Self = StObject.set(x, "load", js.undefined)
    
    inline def setLoadeddata(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "loadeddata", value.asInstanceOf[js.Any])
    
    inline def setLoadeddataUndefined: Self = StObject.set(x, "loadeddata", js.undefined)
    
    inline def setLoadedmetadata(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "loadedmetadata", value.asInstanceOf[js.Any])
    
    inline def setLoadedmetadataUndefined: Self = StObject.set(x, "loadedmetadata", js.undefined)
    
    inline def setLoadstart(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "loadstart", value.asInstanceOf[js.Any])
    ...
    inline def setPause(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "pause", value.asInstanceOf[js.Any])
    
    inline def setPauseUndefined: Self = StObject.set(x, "pause", js.undefined)
    
    inline def setPlay(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "play", value.asInstanceOf[js.Any])
    
    inline def setPlayUndefined: Self = StObject.set(x, "play", js.undefined)
    
    inline def setPlaying(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "playing", value.asInstanceOf[js.Any])
    ...
    inline def setProgress(
      value: js.ThisFunction2[/* this */ This, /* event */ ProgressEvent, /* view */ EditorView, Boolean | Unit]
    ): Self = StObject.set(x, "progress", value.asInstanceOf[js.Any])
    
    inline def setProgressUndefined: Self = StObject.set(x, "progress", js.undefined)
    
    inline def setRatechange(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "ratechange", value.asInstanceOf[js.Any])
    
    inline def setRatechangeUndefined: Self = StObject.set(x, "ratechange", js.undefined)
    
    inline def setReset(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "reset", value.asInstanceOf[js.Any])
    ...
    inline def setScroll(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "scroll", value.asInstanceOf[js.Any])
    ...
    inline def setSeeked(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "seeked", value.asInstanceOf[js.Any])
    
    inline def setSeekedUndefined: Self = StObject.set(x, "seeked", js.undefined)
    
    inline def setSeeking(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "seeking", value.asInstanceOf[js.Any])
    
    inline def setSeekingUndefined: Self = StObject.set(x, "seeking", js.undefined)
    
    inline def setSelect(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "select", value.asInstanceOf[js.Any])
    
    inline def setSelectUndefined: Self = StObject.set(x, "select", js.undefined)
    
    inline def setSelectionchange(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "selectionchange", value.asInstanceOf[js.Any])
    
    inline def setSelectionchangeUndefined: Self = StObject.set(x, "selectionchange", js.undefined)
    
    inline def setSelectstart(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "selectstart", value.asInstanceOf[js.Any])
    
    inline def setSelectstartUndefined: Self = StObject.set(x, "selectstart", js.undefined)
    
    inline def setSlotchange(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "slotchange", value.asInstanceOf[js.Any])
    
    inline def setSlotchangeUndefined: Self = StObject.set(x, "slotchange", js.undefined)
    
    inline def setStalled(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "stalled", value.asInstanceOf[js.Any])
    
    inline def setStalledUndefined: Self = StObject.set(x, "stalled", js.undefined)
    
    inline def setSubmit(
      value: js.ThisFunction2[/* this */ This, /* event */ SubmitEvent, /* view */ EditorView, Boolean | Unit]
    ...
    inline def setSuspend(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "suspend", value.asInstanceOf[js.Any])
    
    inline def setSuspendUndefined: Self = StObject.set(x, "suspend", js.undefined)
    
    inline def setTimeupdate(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "timeupdate", value.asInstanceOf[js.Any])
    
    inline def setTimeupdateUndefined: Self = StObject.set(x, "timeupdate", js.undefined)
    
    inline def setToggle(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "toggle", value.asInstanceOf[js.Any])
    
    inline def setToggleUndefined: Self = StObject.set(x, "toggle", js.undefined)
    
    inline def setTouchcancel(
      value: js.ThisFunction2[/* this */ This, /* event */ TouchEvent, /* view */ EditorView, Boolean | Unit]
    ...
    inline def setTransitioncancel(
      value: js.ThisFunction2[/* this */ This, /* event */ TransitionEvent, /* view */ EditorView, Boolean | Unit]
    ...
    inline def setVolumechange(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "volumechange", value.asInstanceOf[js.Any])
    
    inline def setVolumechangeUndefined: Self = StObject.set(x, "volumechange", js.undefined)
    
    inline def setWaiting(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "waiting", value.asInstanceOf[js.Any])
    
    inline def setWaitingUndefined: Self = StObject.set(x, "waiting", js.undefined)
    
    inline def setWebkitanimationend(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "webkitanimationend", value.asInstanceOf[js.Any])
    
    inline def setWebkitanimationendUndefined: Self = StObject.set(x, "webkitanimationend", js.undefined)
    
    inline def setWebkitanimationiteration(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "webkitanimationiteration", value.asInstanceOf[js.Any])
    
    inline def setWebkitanimationiterationUndefined: Self = StObject.set(x, "webkitanimationiteration", js.undefined)
    
    inline def setWebkitanimationstart(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "webkitanimationstart", value.asInstanceOf[js.Any])
    
    inline def setWebkitanimationstartUndefined: Self = StObject.set(x, "webkitanimationstart", js.undefined)
    
    inline def setWebkittransitionend(value: js.ThisFunction2[/* this */ This, /* event */ Event, /* view */ EditorView, Boolean | Unit]): Self = StObject.set(x, "webkittransitionend", value.asInstanceOf[js.Any])
    
    inline def setWebkittransitionendUndefined: Self = StObject.set(x, "webkittransitionend", js.undefined)
    
    inline def setWheel(
      value: js.ThisFunction2[/* this */ This, /* event */ WheelEvent, /* view */ EditorView, Boolean | Unit]
