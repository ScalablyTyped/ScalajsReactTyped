...
import typingsJapgolly.codemirrorState.mod.Line
...
import typingsJapgolly.codemirrorView.anon.Bottom
import typingsJapgolly.codemirrorView.anon.From
import typingsJapgolly.codemirrorView.anon.Node
import typingsJapgolly.codemirrorView.anon.X
import typingsJapgolly.codemirrorView.codemirrorViewBooleans.`false`
...
trait EditorView extends StObject {
  ...
  /**
    ...
    */
  def posAtDOM(node: org.scalajs.dom.Node): Double = js.native
  def posAtDOM(node: org.scalajs.dom.Node, offset: Double): Double = js.native
