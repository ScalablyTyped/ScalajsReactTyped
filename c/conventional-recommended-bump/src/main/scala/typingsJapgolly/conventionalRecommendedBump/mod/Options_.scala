...
object Options_ {
  ...
  def apply(
    ...
    whatBump: /* commits */ js.Array[Commit[String | Double | js.Symbol]] => CallbackTo[Result] = null
  ): Options_ = {
    ...
    if (whatBump != null) __obj.updateDynamic("whatBump")(js.Any.fromFunction1((t0: /* commits */ js.Array[
  typingsJapgolly.conventionalCommitsParser.mod.Commit[java.lang.String | scala.Double | js.Symbol]]) => whatBump(t0).runNow()))
