...
trait Collectsfullname extends StObject {
  ...
  var is_tax_exempt: Boolean
}
object Collectsfullname {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(collects_billing_address = collects_billing_address.asInstanceOf[js.Any], collects_extra_fields = collects_extra_fields.asInstanceOf[js.Any], collects_fullname = collects_fullname.asInstanceOf[js.Any], collects_shipping_address = collects_shipping_address.asInstanceOf[js.Any], has_digital_delivery = has_digital_delivery.asInstanceOf[js.Any], has_images = has_images.asInstanceOf[js.Any], has_physical_delivery = has_physical_delivery.asInstanceOf[js.Any], is_active = is_active.asInstanceOf[js.Any], is_inventory_managed = is_inventory_managed.asInstanceOf[js.Any], is_pay_what_you_want = is_pay_what_you_want.asInstanceOf[js.Any], is_sold_out = is_sold_out.asInstanceOf[js.Any], is_tax_exempt = is_tax_exempt.asInstanceOf[js.Any])
    __obj.asInstanceOf[Collectsfullname]
  }
  
  extension [Self <: Collectsfullname](x: Self) {
    ...
    inline def setIs_tax_exempt(value: Boolean): Self = StObject.set(x, "is_tax_exempt", value.asInstanceOf[js.Any])
  }
}
