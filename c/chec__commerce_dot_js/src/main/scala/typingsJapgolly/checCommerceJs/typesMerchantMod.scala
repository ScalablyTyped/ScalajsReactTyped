...
import typingsJapgolly.checCommerceJs.anon.Analytics
import typingsJapgolly.checCommerceJs.anon.Google
...
object typesMerchantMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.checCommerceJs.checCommerceJsStrings.active
    - typingsJapgolly.checCommerceJs.checCommerceJsStrings.inactive
  */
  trait MerchantStatus extends StObject
  object MerchantStatus {
    
    inline def active: typingsJapgolly.checCommerceJs.checCommerceJsStrings.active = "active".asInstanceOf[typingsJapgolly.checCommerceJs.checCommerceJsStrings.active]
    
    inline def inactive: typingsJapgolly.checCommerceJs.checCommerceJsStrings.inactive = "inactive".asInstanceOf[typingsJapgolly.checCommerceJs.checCommerceJsStrings.inactive]
  }
}
