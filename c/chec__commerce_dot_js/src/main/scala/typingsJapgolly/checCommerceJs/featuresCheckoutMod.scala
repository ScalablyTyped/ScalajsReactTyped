...
import typingsJapgolly.checCommerceJs.anon.Code
import typingsJapgolly.checCommerceJs.anon.Country
import typingsJapgolly.checCommerceJs.anon.Customersetprice
import typingsJapgolly.checCommerceJs.anon.Digits
import typingsJapgolly.checCommerceJs.anon.Ipaddress
import typingsJapgolly.checCommerceJs.anon.Postalzipcode
import typingsJapgolly.checCommerceJs.anon.Region
import typingsJapgolly.checCommerceJs.checCommerceJsBooleans.`true`
import typingsJapgolly.checCommerceJs.mod.^
import typingsJapgolly.checCommerceJs.typesCheckoutCaptureMod.CheckoutCapture
import typingsJapgolly.checCommerceJs.typesCheckoutCaptureResponseMod.CheckoutCaptureResponse
import typingsJapgolly.checCommerceJs.typesCheckoutTokenMod.CheckoutToken
...
object featuresCheckoutMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.checCommerceJs.checCommerceJsStrings.product_id
    - typingsJapgolly.checCommerceJs.checCommerceJsStrings.cart
    - typingsJapgolly.checCommerceJs.checCommerceJsStrings.permalink
  */
  trait IdentifierType extends StObject
  object IdentifierType {
    
    inline def cart: typingsJapgolly.checCommerceJs.checCommerceJsStrings.cart = "cart".asInstanceOf[typingsJapgolly.checCommerceJs.checCommerceJsStrings.cart]
    
    inline def permalink: typingsJapgolly.checCommerceJs.checCommerceJsStrings.permalink = "permalink".asInstanceOf[typingsJapgolly.checCommerceJs.checCommerceJsStrings.permalink]
    
    inline def product_id: typingsJapgolly.checCommerceJs.checCommerceJsStrings.product_id = "product_id".asInstanceOf[typingsJapgolly.checCommerceJs.checCommerceJsStrings.product_id]
  }
