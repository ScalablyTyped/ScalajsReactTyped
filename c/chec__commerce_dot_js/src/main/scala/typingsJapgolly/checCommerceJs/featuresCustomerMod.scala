...
import typingsJapgolly.checCommerceJs.anon.Customerid
import typingsJapgolly.checCommerceJs.anon.Success
import typingsJapgolly.checCommerceJs.featuresCartMod.RequestMethod
import typingsJapgolly.checCommerceJs.mod.^
import typingsJapgolly.checCommerceJs.typesOrderMod.Order
import typingsJapgolly.checCommerceJs.typesPaginationMod.PaginationMeta
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object featuresCustomerMod {
  ...
  open class Customer protected () extends StObject {
    ...
    def about(): js.Promise[typingsJapgolly.checCommerceJs.typesCustomerMod.Customer] = js.native
    ...
    def update(data: CustomerUpdate): js.Promise[typingsJapgolly.checCommerceJs.typesCustomerMod.Customer] = js.native
    def update(data: CustomerUpdate, customerId: String): js.Promise[typingsJapgolly.checCommerceJs.typesCustomerMod.Customer] = js.native
    def update(data: CustomerUpdate, customerId: String, token: String): js.Promise[typingsJapgolly.checCommerceJs.typesCustomerMod.Customer] = js.native
    def update(data: CustomerUpdate, customerId: Unit, token: String): js.Promise[typingsJapgolly.checCommerceJs.typesCustomerMod.Customer] = js.native
  }
