package typingsJapgolly.cleaveJs.components
...
import typingsJapgolly.cleaveJs.reactMod.^
import typingsJapgolly.cleaveJs.reactPropsMod.ChangeEvent
import typingsJapgolly.cleaveJs.reactPropsMod.Props
import typingsJapgolly.cleaveJs.reactPropsMod.ReactInstanceWithCleave
...
object React {
  ...
  inline def apply(options: CleaveOptions): Builder = {
  ...
  object React {
    ...
    inline def apply(options: CleaveOptions): typingsJapgolly.cleaveJs.components.React.React.Builder = {
      val __props = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
      new typingsJapgolly.cleaveJs.components.React.React.Builder(js.Array(this.component, __props.asInstanceOf[Props]))
    }
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def htmlRef(value: /* i */ Any => Callback): this.type = set("htmlRef", js.Any.fromFunction1((t0: /* i */ Any) => value(t0).runNow()))
      ...
      inline def onChange(value: ChangeEvent[HTMLInputElement] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ChangeEvent[HTMLInputElement]) => value(t0).runNow()))
      ...
      inline def onInit(value: /* owner */ ReactInstanceWithCleave => Callback): this.type = set("onInit", js.Any.fromFunction1((t0: /* owner */ ReactInstanceWithCleave) => value(t0).runNow()))
    ...
    def withProps(p: Props): typingsJapgolly.cleaveJs.components.React.React.Builder = new typingsJapgolly.cleaveJs.components.React.React.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
