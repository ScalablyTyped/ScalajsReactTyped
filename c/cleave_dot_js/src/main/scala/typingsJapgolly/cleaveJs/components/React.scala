...
import typingsJapgolly.cleaveJs.propsMod.ChangeEvent
import typingsJapgolly.cleaveJs.propsMod.Props
...
object React {
  def apply(
    ...
    htmlRef: /* i */ js.Any => Callback = null,
    id: String = null,
    inlist: js.Any = null,
    ...
    onChange: ChangeEvent[HTMLInputElement] => Callback = null,
    ...
    onInit: /* owner */ ReactInstance => Callback = null,
    ...
    if (htmlRef != null) __obj.updateDynamic("htmlRef")(js.Any.fromFunction1((t0: /* i */ js.Any) => htmlRef(t0).runNow()))
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: typingsJapgolly.cleaveJs.propsMod.ChangeEvent[org.scalajs.dom.raw.HTMLInputElement]) => onChange(t0).runNow()))
    ...
    if (onInit != null) __obj.updateDynamic("onInit")(js.Any.fromFunction1((t0: /* owner */ typingsJapgolly.react.mod.ReactInstance) => onInit(t0).runNow()))
  ...
  typingsJapgolly.cleaveJs.propsMod.Props, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.cleaveJs.reactMod.^](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.cleaveJs.propsMod.Props])(children: _*)
  }
