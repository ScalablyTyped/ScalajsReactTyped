package typingsJapgolly.cleaveJs.optionsMod

import japgolly.scalajs.react.Callback
import typingsJapgolly.cleaveJs.creditCardMod.CreditCardTypeChangeHandler
...
object CleaveOptions {
  ...
  def apply(
    ...
    onValueChanged: /* event */ js.Any => Callback = null,
    ...
    if (onValueChanged != null) __obj.updateDynamic("onValueChanged")(js.Any.fromFunction1((t0: /* event */ js.Any) => onValueChanged(t0).runNow()))
