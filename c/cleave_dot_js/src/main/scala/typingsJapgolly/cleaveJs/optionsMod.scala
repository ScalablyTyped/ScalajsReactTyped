...
import typingsJapgolly.cleaveJs.optionsCreditCardMod.CreditCardTypeChangeHandler
...
object optionsMod {
  ...
  object CleaveOptions {
    ...
    extension [Self <: CleaveOptions](x: Self) {
      ...
      inline def setOnValueChanged(value: /* event */ Any => Callback): Self = StObject.set(x, "onValueChanged", js.Any.fromFunction1((t0: /* event */ Any) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cleaveJs.cleaveJsStrings.lakh
    - typingsJapgolly.cleaveJs.cleaveJsStrings.thousand
    - typingsJapgolly.cleaveJs.cleaveJsStrings.wan
    - typingsJapgolly.cleaveJs.cleaveJsStrings.none
  */
  trait NumeralThousandsGroupStyleType extends StObject
  object NumeralThousandsGroupStyleType {
    
    inline def lakh: typingsJapgolly.cleaveJs.cleaveJsStrings.lakh = "lakh".asInstanceOf[typingsJapgolly.cleaveJs.cleaveJsStrings.lakh]
    
    inline def none: typingsJapgolly.cleaveJs.cleaveJsStrings.none = "none".asInstanceOf[typingsJapgolly.cleaveJs.cleaveJsStrings.none]
    
    inline def thousand: typingsJapgolly.cleaveJs.cleaveJsStrings.thousand = "thousand".asInstanceOf[typingsJapgolly.cleaveJs.cleaveJsStrings.thousand]
    
    inline def wan: typingsJapgolly.cleaveJs.cleaveJsStrings.wan = "wan".asInstanceOf[typingsJapgolly.cleaveJs.cleaveJsStrings.wan]
  }
}
