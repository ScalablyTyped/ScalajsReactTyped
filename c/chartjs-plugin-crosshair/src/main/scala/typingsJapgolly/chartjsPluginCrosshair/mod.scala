...
import typingsJapgolly.chartjsPluginCrosshair.chartjsPluginCrosshairStrings.interpolate
...
object mod {
  ...
  object CallbackOptions {
    ...
    extension [Self <: CallbackOptions](x: Self) {
      ...
      inline def setAfterZoom(value: (/* start */ Double, /* end */ Double) => Callback): Self = StObject.set(x, "afterZoom", js.Any.fromFunction2((t0: /* start */ Double, t1: /* end */ Double) => (value(t0, t1)).runNow()))
  ...
  object chartJsAugmentingMod {
    ...
    trait InteractionModeRegistry extends StObject {
      ...
      var interpolate: typingsJapgolly.chartjsPluginCrosshair.chartjsPluginCrosshairStrings.interpolate
    }
  ...
  object global {
    ...
    object Chart {
      ...
      inline def apply(panZoom: Double => Callback): Chart = {
        val __obj = js.Dynamic.literal(panZoom = js.Any.fromFunction1((t0: Double) => panZoom(t0).runNow()))
        __obj.asInstanceOf[Chart]
      }
      
      extension [Self <: Chart](x: Self) {
        
        inline def setPanZoom(value: Double => Callback): Self = StObject.set(x, "panZoom", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      }
    }
  }
}
