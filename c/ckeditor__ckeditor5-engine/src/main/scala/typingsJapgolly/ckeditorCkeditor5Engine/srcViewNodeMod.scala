...
import typingsJapgolly.ckeditorCkeditor5Engine.anon.TextData
...
object srcViewNodeMod {
  ...
  trait Node extends StObject {
    ...
    def getCommonAncestor(node: Node): typingsJapgolly.ckeditorCkeditor5Engine.srcViewElementMod.default | typingsJapgolly.ckeditorCkeditor5Engine.srcViewDocumentfragmentMod.default | Null = js.native
    def getCommonAncestor(node: Node, options: IncludeSelf): typingsJapgolly.ckeditorCkeditor5Engine.srcViewElementMod.default | typingsJapgolly.ckeditorCkeditor5Engine.srcViewDocumentfragmentMod.default | Null = js.native
    ...
    val parent: typingsJapgolly.ckeditorCkeditor5Engine.srcViewElementMod.default | typingsJapgolly.ckeditorCkeditor5Engine.srcViewDocumentfragmentMod.default | Null = js.native
    
    val previousSibling: Node | Null = js.native
    
    val root: Node | typingsJapgolly.ckeditorCkeditor5Engine.srcViewDocumentfragmentMod.default = js.native
