...
object srcConversionConversionhelpersMod {
  ...
  @js.native
  open class default[T /* <: typingsJapgolly.ckeditorCkeditor5Engine.srcConversionDowncasthelpersMod.default | typingsJapgolly.ckeditorCkeditor5Engine.srcConversionUpcasthelpersMod.default */] protected ()
    extends StObject
  ...
  trait ConversionHelpers[T /* <: typingsJapgolly.ckeditorCkeditor5Engine.srcConversionDowncasthelpersMod.default | typingsJapgolly.ckeditorCkeditor5Engine.srcConversionUpcasthelpersMod.default */] extends StObject {
  ...
  object ConversionHelpers {
    ...
    inline def apply[T /* <: typingsJapgolly.ckeditorCkeditor5Engine.srcConversionDowncasthelpersMod.default | typingsJapgolly.ckeditorCkeditor5Engine.srcConversionUpcasthelpersMod.default */](
      add: js.Function1[
          /* import warning: importer.ImportType#apply Failed type conversion: T extends @ckeditor/ckeditor5-engine.@ckeditor/ckeditor5-engine/src/conversion/downcasthelpers.default ? @ckeditor/ckeditor5-engine.@ckeditor/ckeditor5-engine/src/conversion/downcastdispatcher.default<{}> : @ckeditor/ckeditor5-engine.@ckeditor/ckeditor5-engine/src/conversion/upcastdispatcher.default */ /* dispatcher */ js.Any, 
          Unit
        ] => ConversionHelpers[T]
    ...
    extension [Self <: ConversionHelpers[?], T /* <: typingsJapgolly.ckeditorCkeditor5Engine.srcConversionDowncasthelpersMod.default | typingsJapgolly.ckeditorCkeditor5Engine.srcConversionUpcasthelpersMod.default */](x: Self & ConversionHelpers[T]) {
