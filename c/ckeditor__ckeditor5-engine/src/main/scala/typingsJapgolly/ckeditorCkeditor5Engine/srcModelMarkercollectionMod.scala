...
object srcModelMarkercollectionMod {
  ...
  open class Marker protected () extends StObject {
    def this(
      name: String,
      liveRange: typingsJapgolly.ckeditorCkeditor5Engine.srcModelLiverangeMod.default,
  ...
  trait MarkerCollection
    ...
    def getMarkersAtPosition(position: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default): Generator[Marker, Any, Any] = js.native
    
    def getMarkersGroup(prefix: String): Generator[Marker, Any, Any] = js.native
    
    def getMarkersIntersectingRange(range: typingsJapgolly.ckeditorCkeditor5Engine.srcModelRangeMod.default): Generator[Marker, Any, Any] = js.native
