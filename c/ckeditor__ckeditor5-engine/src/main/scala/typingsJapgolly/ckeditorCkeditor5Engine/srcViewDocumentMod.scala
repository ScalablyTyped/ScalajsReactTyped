...
import typingsJapgolly.ckeditorCkeditor5Engine.anon.Context
import typingsJapgolly.ckeditorCkeditor5Engine.anon.Priority
import typingsJapgolly.ckeditorCkeditor5Engine.srcViewObserverBubblingemittermixinMod.BubblingEmitter
...
object srcViewDocumentMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ckeditorCkeditor5Engine.ckeditorCkeditor5EngineStrings.children
    - typingsJapgolly.ckeditorCkeditor5Engine.ckeditorCkeditor5EngineStrings.attributes
    - typingsJapgolly.ckeditorCkeditor5Engine.ckeditorCkeditor5EngineStrings.text
  */
  trait ChangeType extends StObject
  object ChangeType {
    
    inline def attributes: typingsJapgolly.ckeditorCkeditor5Engine.ckeditorCkeditor5EngineStrings.attributes = "attributes".asInstanceOf[typingsJapgolly.ckeditorCkeditor5Engine.ckeditorCkeditor5EngineStrings.attributes]
    
    inline def children: typingsJapgolly.ckeditorCkeditor5Engine.ckeditorCkeditor5EngineStrings.children = "children".asInstanceOf[typingsJapgolly.ckeditorCkeditor5Engine.ckeditorCkeditor5EngineStrings.children]
  ...
  trait Document
    ...
    /**
      ...
      */
    def getRoot(): typingsJapgolly.ckeditorCkeditor5Engine.srcViewRooteditableelementMod.default | Null = js.native
    def getRoot(name: String): typingsJapgolly.ckeditorCkeditor5Engine.srcViewRooteditableelementMod.default | Null = js.native
    ...
    def registerPostFixer(
      postFixer: js.Function1[
          /* writer */ typingsJapgolly.ckeditorCkeditor5Engine.srcViewDowncastwriterMod.default[default], 
          Boolean | Unit
        ]
    ): Unit = js.native
