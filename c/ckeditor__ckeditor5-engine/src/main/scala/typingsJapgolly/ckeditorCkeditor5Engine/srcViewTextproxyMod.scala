...
object srcViewTextproxyMod {
  ...
  open class default protected ()
    extends StObject
       ...
       with Item {
    def this(
      textNode: typingsJapgolly.ckeditorCkeditor5Engine.srcViewTextMod.default,
      offsetInText: Double,
      length: Double
    ) = this()
  }
  ...
  trait TextProxy extends StObject {
    ...
    val document: typingsJapgolly.ckeditorCkeditor5Engine.srcViewDocumentMod.default | Null = js.native
    ...
    val textNode: typingsJapgolly.ckeditorCkeditor5Engine.srcViewTextMod.default = js.native
  }
}
