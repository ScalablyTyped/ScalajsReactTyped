...
import typingsJapgolly.ckeditorCkeditor5Engine.anon.ModelViewMatcherPattern
import typingsJapgolly.ckeditorCkeditor5Engine.anon.ViewMatcherPattern
import typingsJapgolly.ckeditorCkeditor5Engine.anon.ViewString
import typingsJapgolly.ckeditorCkeditor5Engine.anon.`12`
import typingsJapgolly.ckeditorCkeditor5Engine.anon.`9`
...
import typingsJapgolly.ckeditorCkeditor5Engine.ckeditorCkeditor5EngineStrings.selectionChange
import typingsJapgolly.ckeditorCkeditor5Engine.ckeditorCkeditor5EngineStrings.text
import typingsJapgolly.ckeditorCkeditor5Engine.srcConversionUpcastdispatcherMod.UpcastDispatcherCallback
import typingsJapgolly.ckeditorCkeditor5Engine.srcModelModelMod.Model
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object srcConversionUpcasthelpersMod {
  ...
  inline def convertSelectionChange(model: Model, mapper: typingsJapgolly.ckeditorCkeditor5Engine.srcConversionMapperMod.default): UpcastDispatcherCallback[
    selectionChange, 
    typingsJapgolly.ckeditorCkeditor5Engine.srcViewDocumentMod.default
  ] = (^.asInstanceOf[js.Dynamic].applyDynamic("convertSelectionChange")(model.asInstanceOf[js.Any], mapper.asInstanceOf[js.Any])).asInstanceOf[UpcastDispatcherCallback[
    selectionChange, 
    typingsJapgolly.ckeditorCkeditor5Engine.srcViewDocumentMod.default
  ]]
  ...
  @js.native
  trait UpcastHelpers
    extends typingsJapgolly.ckeditorCkeditor5Engine.srcConversionConversionhelpersMod.default[UpcastHelpers] {
