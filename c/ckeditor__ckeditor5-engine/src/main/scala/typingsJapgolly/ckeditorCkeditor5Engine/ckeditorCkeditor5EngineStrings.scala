...
import typingsJapgolly.ckeditorCkeditor5Engine.mod.model.PositionRelation
import typingsJapgolly.ckeditorCkeditor5Engine.mod.model.PositionStickiness
import typingsJapgolly.ckeditorCkeditor5Engine.mod.model.TreeWalkerValueType
import typingsJapgolly.ckeditorCkeditor5Engine.mod.view.ChangeType
import typingsJapgolly.ckeditorCkeditor5Engine.mod.view.TreeWalkerDirection
...
object ckeditorCkeditor5EngineStrings {
  ...
  sealed trait after
    extends PositionRelation
       with typingsJapgolly.ckeditorCkeditor5Engine.mod.view.PositionRelation
  ...
  sealed trait different
    extends typingsJapgolly.ckeditorCkeditor5Engine.mod.view.PositionRelation
  ...
  sealed trait elementEnd
    extends TreeWalkerValueType
       with typingsJapgolly.ckeditorCkeditor5Engine.mod.view.TreeWalkerValueType
