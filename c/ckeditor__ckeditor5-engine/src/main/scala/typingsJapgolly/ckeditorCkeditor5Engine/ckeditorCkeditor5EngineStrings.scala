...
import typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.PositionRelation
import typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.PositionStickiness
import typingsJapgolly.ckeditorCkeditor5Engine.srcModelTreewalkerMod.TreeWalkerValueType
import typingsJapgolly.ckeditorCkeditor5Engine.srcViewDocumentMod.ChangeType
import typingsJapgolly.ckeditorCkeditor5Engine.srcViewDomconverterMod.BlockFillerMode
...
object ckeditorCkeditor5EngineStrings {
  ...
  sealed trait after
    extends StObject
       ...
       with typingsJapgolly.ckeditorCkeditor5Engine.srcViewPositionMod.PositionRelation
  ...
  sealed trait backward
    extends StObject
       ...
       with typingsJapgolly.ckeditorCkeditor5Engine.srcModelTreewalkerMod.TreeWalkerDirection
  ...
  sealed trait elementEnd
    extends StObject
       with typingsJapgolly.ckeditorCkeditor5Engine.srcViewTreewalkerMod.TreeWalkerValueType
       with TreeWalkerValueType
