...
object srcModelLiverangeMod {
  ...
  - typingsJapgolly.ckeditorCkeditor5Engine.srcModelSelectionMod._Selectable because Already inherited */ @JSImport("@ckeditor/ckeditor5-engine/src/model/liverange", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    inline def fromRange(range: typingsJapgolly.ckeditorCkeditor5Engine.srcModelRangeMod.default): LiveRange = ^.asInstanceOf[js.Dynamic].applyDynamic("fromRange")(range.asInstanceOf[js.Any]).asInstanceOf[LiveRange]
  }
  ...
  trait LiveRange
    ...
    def toRange(): typingsJapgolly.ckeditorCkeditor5Engine.srcModelRangeMod.default = js.native
  }
}
