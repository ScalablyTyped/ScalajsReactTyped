...
object srcViewEditableelementMod {
  ...
  - typingsJapgolly.ckeditorCkeditor5Engine.srcViewItemMod.Item because Already inherited */ @JSImport("@ckeditor/ckeditor5-engine/src/view/editableelement", JSImport.Default)
  @js.native
  open class default () extends EditableElement
  
  @js.native
  trait EditableElement
    extends typingsJapgolly.ckeditorCkeditor5Engine.srcViewContainerelementMod.default {
