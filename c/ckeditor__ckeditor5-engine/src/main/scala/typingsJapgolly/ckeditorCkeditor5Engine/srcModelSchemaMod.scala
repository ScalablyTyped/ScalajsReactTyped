...
import typingsJapgolly.ckeditorCkeditor5Engine.ckeditorCkeditor5EngineStrings.both
...
object srcModelSchemaMod {
  ...
  open class SchemaContext protected ()
    ...
    def push(item: js.Array[String | typingsJapgolly.ckeditorCkeditor5Engine.srcModelNodeMod.default]): SchemaContext = js.native
    def push(item: typingsJapgolly.ckeditorCkeditor5Engine.srcModelNodeMod.default): SchemaContext = js.native
  ...
  trait Schema extends StObject {
    ...
    def checkAttributeInSelection(
      selection: typingsJapgolly.ckeditorCkeditor5Engine.srcModelDocumentselectionMod.default,
      attribute: String
    ): Boolean = js.native
    def checkAttributeInSelection(selection: typingsJapgolly.ckeditorCkeditor5Engine.srcModelSelectionMod.default, attribute: String): Boolean = js.native
    
    def checkChild(context: SchemaContextDefinition, `def`: String): Boolean = js.native
    def checkChild(
      context: SchemaContextDefinition,
      `def`: typingsJapgolly.ckeditorCkeditor5Engine.srcModelNodeMod.default
    ): Boolean = js.native
    
    def checkMerge(
      positionOrBaseElement: typingsJapgolly.ckeditorCkeditor5Engine.srcModelElementMod.default,
      elementToMerge: typingsJapgolly.ckeditorCkeditor5Engine.srcModelElementMod.default
    ): Boolean = js.native
    def checkMerge(
      positionOrBaseElement: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default,
      elementToMerge: typingsJapgolly.ckeditorCkeditor5Engine.srcModelElementMod.default
    ): Boolean = js.native
    ...
    def findAllowedParent(position: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default, node: String): typingsJapgolly.ckeditorCkeditor5Engine.srcModelElementMod.default | Null = js.native
    ...
    ): typingsJapgolly.ckeditorCkeditor5Engine.srcModelElementMod.default | Null = js.native
    ...
    def getLimitElement(
      selectionOrRangeOrPosition: typingsJapgolly.ckeditorCkeditor5Engine.srcModelDocumentselectionMod.default
    ): typingsJapgolly.ckeditorCkeditor5Engine.srcModelElementMod.default = js.native
    def getLimitElement(selectionOrRangeOrPosition: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default): typingsJapgolly.ckeditorCkeditor5Engine.srcModelElementMod.default = js.native
    def getLimitElement(selectionOrRangeOrPosition: typingsJapgolly.ckeditorCkeditor5Engine.srcModelRangeMod.default): typingsJapgolly.ckeditorCkeditor5Engine.srcModelElementMod.default = js.native
    def getLimitElement(selectionOrRangeOrPosition: typingsJapgolly.ckeditorCkeditor5Engine.srcModelSelectionMod.default): typingsJapgolly.ckeditorCkeditor5Engine.srcModelElementMod.default = js.native
    
    def getNearestSelectionRange(position: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default): typingsJapgolly.ckeditorCkeditor5Engine.srcModelRangeMod.default | Null = js.native
    def getNearestSelectionRange(
      position: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default,
      direction: both | forward | backward
    ): typingsJapgolly.ckeditorCkeditor5Engine.srcModelRangeMod.default | Null = js.native
    
    def getValidRanges(
      ranges: js.Array[typingsJapgolly.ckeditorCkeditor5Engine.srcModelRangeMod.default],
      attribute: String
    ): Generator[typingsJapgolly.ckeditorCkeditor5Engine.srcModelRangeMod.default, Any, Any] = js.native
    ...
    def removeDisallowedAttributes(
      nodes: js.Iterable[typingsJapgolly.ckeditorCkeditor5Engine.srcModelNodeMod.default],
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ckeditorCkeditor5Engine.srcModelItemMod.Item
    - typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default
    - typingsJapgolly.ckeditorCkeditor5Engine.srcModelSchemaMod.SchemaContext
    - java.lang.String
    - js.Array[java.lang.String | typingsJapgolly.ckeditorCkeditor5Engine.srcModelItemMod.Item]
  */
  ...
  object SchemaContextItem {
    ...
    inline def apply(
      ...
      getAttributeKeys: CallbackTo[Generator[String, Any, Any]],
      name: String
    ): SchemaContextItem = {
      val __obj = js.Dynamic.literal(getAttribute = js.Any.fromFunction1(getAttribute), getAttributeKeys = getAttributeKeys.toJsFn, name = name.asInstanceOf[js.Any])
    ...
    extension [Self <: SchemaContextItem](x: Self) {
      ...
      inline def setGetAttributeKeys(value: CallbackTo[Generator[String, Any, Any]]): Self = StObject.set(x, "getAttributeKeys", value.toJsFn)
