...
object srcModelOperationDetachoperationMod {
  ...
  open class default protected ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val sourcePosition: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default = js.native
  ...
  object default {
    ...
    @js.native
    val className: typingsJapgolly.ckeditorCkeditor5Engine.ckeditorCkeditor5EngineStrings.DetachOperation = js.native
  }
  ...
  trait DetachOperation
    ...
    /**
      * Position before the first {@link module:engine/model/item~Item model item} to detach.
      */
    val sourcePosition: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default
  ...
  object DetachOperation {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(howMany = howMany.asInstanceOf[js.Any], isDocumentOperation = isDocumentOperation.asInstanceOf[js.Any], sourcePosition = sourcePosition.asInstanceOf[js.Any], toJSON = toJSON.toJsFn, baseVersion = null, batch = null)
