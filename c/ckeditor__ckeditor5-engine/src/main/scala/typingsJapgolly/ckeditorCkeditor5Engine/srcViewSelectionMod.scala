...
import typingsJapgolly.ckeditorCkeditor5Engine.anon.Label
...
object srcViewSelectionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ckeditorCkeditor5Engine.srcViewSelectionMod.Selection
    - typingsJapgolly.ckeditorCkeditor5Engine.srcViewDocumentselectionMod.default
    - typingsJapgolly.ckeditorCkeditor5Engine.srcViewPositionMod.default
    - js.Iterable[typingsJapgolly.ckeditorCkeditor5Engine.srcViewRangeMod.default]
    - typingsJapgolly.ckeditorCkeditor5Engine.srcViewRangeMod.default
    - typingsJapgolly.ckeditorCkeditor5Engine.srcViewItemMod.Item
  */
  type Selectable = _Selectable | js.Iterable[typingsJapgolly.ckeditorCkeditor5Engine.srcViewRangeMod.default]
  ...
  trait Selection
    ...
    def setFocus(itemOrPosition: typingsJapgolly.ckeditorCkeditor5Engine.srcViewPositionMod.default): Unit = js.native
