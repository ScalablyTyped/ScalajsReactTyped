...
import typingsJapgolly.ckeditorCkeditor5Engine.srcModelTreewalkerMod.TreeWalkerDirection
...
trait Boundaries extends StObject {
  ...
  var startPosition: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.Position
}
object Boundaries {
  
  inline def apply(startPosition: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.Position): Boundaries = {
  ...
  extension [Self <: Boundaries](x: Self) {
    ...
    inline def setStartPosition(value: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.Position): Self = StObject.set(x, "startPosition", value.asInstanceOf[js.Any])
  }
}
