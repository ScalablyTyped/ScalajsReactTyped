...
trait Element extends StObject {
  ...
  var view: typingsJapgolly.ckeditorCkeditor5Engine.srcViewViewMod.View
}
object Element {
  
  inline def apply(element: default, text: String, view: typingsJapgolly.ckeditorCkeditor5Engine.srcViewViewMod.View): Element = {
  ...
  extension [Self <: Element](x: Self) {
    ...
    inline def setView(value: typingsJapgolly.ckeditorCkeditor5Engine.srcViewViewMod.View): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
  }
}
