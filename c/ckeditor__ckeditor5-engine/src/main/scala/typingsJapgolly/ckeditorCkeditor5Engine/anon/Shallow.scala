...
trait Shallow
  ...
  var startPosition: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default
}
object Shallow {
  
  inline def apply(startPosition: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default): Shallow = {
  ...
  extension [Self <: Shallow](x: Self) {
    ...
    inline def setStartPosition(value: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default): Self = StObject.set(x, "startPosition", value.asInstanceOf[js.Any])
  }
}
