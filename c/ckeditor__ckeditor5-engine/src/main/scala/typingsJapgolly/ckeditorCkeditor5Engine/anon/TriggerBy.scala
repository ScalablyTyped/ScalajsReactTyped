...
trait TriggerBy extends StObject {
  ...
  var view: ElementDefinition | (js.Function2[
    ...
    typingsJapgolly.ckeditorCkeditor5Engine.srcViewContainerelementMod.default
  ])
}
object TriggerBy {
  ...
  extension [Self <: TriggerBy](x: Self) {
    ...
    inline def setViewFunction2(
      value: (/* element */ default, /* api */ DowncastConversionApi[Any]) => typingsJapgolly.ckeditorCkeditor5Engine.srcViewContainerelementMod.default
