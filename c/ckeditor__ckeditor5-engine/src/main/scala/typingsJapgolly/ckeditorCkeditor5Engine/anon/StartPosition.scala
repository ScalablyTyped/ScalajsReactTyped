...
import typingsJapgolly.ckeditorCkeditor5Engine.srcViewPositionMod.default
...
trait StartPosition extends StObject {
  ...
  var boundaries: js.UndefOr[typingsJapgolly.ckeditorCkeditor5Engine.srcViewRangeMod.Range] = js.undefined
...
object StartPosition {
  ...
  extension [Self <: StartPosition](x: Self) {
    ...
    inline def setBoundaries(value: typingsJapgolly.ckeditorCkeditor5Engine.srcViewRangeMod.Range): Self = StObject.set(x, "boundaries", value.asInstanceOf[js.Any])
