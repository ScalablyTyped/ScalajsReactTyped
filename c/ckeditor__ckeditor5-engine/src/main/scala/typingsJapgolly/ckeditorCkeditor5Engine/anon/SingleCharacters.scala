...
import typingsJapgolly.ckeditorCkeditor5Engine.srcViewRangeMod.default
import typingsJapgolly.ckeditorCkeditor5Engine.srcViewTreewalkerMod.TreeWalkerDirection
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait SingleCharacters extends StObject {
  ...
  var startPosition: typingsJapgolly.ckeditorCkeditor5Engine.srcViewPositionMod.Position
}
object SingleCharacters {
  
  inline def apply(startPosition: typingsJapgolly.ckeditorCkeditor5Engine.srcViewPositionMod.Position): SingleCharacters = {
  ...
  extension [Self <: SingleCharacters](x: Self) {
    ...
    inline def setStartPosition(value: typingsJapgolly.ckeditorCkeditor5Engine.srcViewPositionMod.Position): Self = StObject.set(x, "startPosition", value.asInstanceOf[js.Any])
  }
}
