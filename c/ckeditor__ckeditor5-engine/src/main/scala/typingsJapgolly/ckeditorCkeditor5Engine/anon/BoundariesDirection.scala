...
trait BoundariesDirection extends StObject {
  ...
  var startPosition: typingsJapgolly.ckeditorCkeditor5Engine.srcViewPositionMod.default
}
object BoundariesDirection {
  
  inline def apply(startPosition: typingsJapgolly.ckeditorCkeditor5Engine.srcViewPositionMod.default): BoundariesDirection = {
  ...
  extension [Self <: BoundariesDirection](x: Self) {
    ...
    inline def setStartPosition(value: typingsJapgolly.ckeditorCkeditor5Engine.srcViewPositionMod.default): Self = StObject.set(x, "startPosition", value.asInstanceOf[js.Any])
  }
}
