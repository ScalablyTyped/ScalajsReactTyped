...
object srcModelLivepositionMod {
  ...
  - typingsJapgolly.ckeditorCkeditor5Engine.srcModelSelectionMod._Selectable because Already inherited */ @JSImport("@ckeditor/ckeditor5-engine/src/model/liveposition", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    inline def fromPosition(position: typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default): LivePosition = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPosition")(position.asInstanceOf[js.Any]).asInstanceOf[LivePosition]
  ...
  trait LivePosition
    extends typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default {
    ...
    def toPosition(): typingsJapgolly.ckeditorCkeditor5Engine.srcModelPositionMod.default = js.native
  }
}
