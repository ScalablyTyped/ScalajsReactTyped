package typingsJapgolly.colresizable.colResizable

import japgolly.scalajs.react.Callback
import typingsJapgolly.colresizable.colresizableStrings.fit
import typingsJapgolly.colresizable.colresizableStrings.flex
import typingsJapgolly.colresizable.colresizableStrings.overflow
...
object Settings {
  ...
  def apply(
    ...
    onDrag: /* e */ JQueryMouseEventObject => Callback = null,
    onResize: /* e */ JQueryMouseEventObject => Callback = null,
    ...
    if (onDrag != null) __obj.updateDynamic("onDrag")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.jquery.JQueryMouseEventObject) => onDrag(t0).runNow()))
    if (onResize != null) __obj.updateDynamic("onResize")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.jquery.JQueryMouseEventObject) => onResize(t0).runNow()))
