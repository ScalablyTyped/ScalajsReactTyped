...
object colResizable {
  ...
  object Settings {
    ...
    extension [Self <: Settings](x: Self) {
      ...
      inline def setOnDrag(value: /* e */ JQueryMouseEventObject => Callback): Self = StObject.set(x, "onDrag", js.Any.fromFunction1((t0: /* e */ JQueryMouseEventObject) => value(t0).runNow()))
      
      inline def setOnDragUndefined: Self = StObject.set(x, "onDrag", js.undefined)
      
      inline def setOnResize(value: /* e */ JQueryMouseEventObject => Callback): Self = StObject.set(x, "onResize", js.Any.fromFunction1((t0: /* e */ JQueryMouseEventObject) => value(t0).runNow()))
