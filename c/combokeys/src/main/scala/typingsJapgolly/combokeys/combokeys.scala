...
object Combokeys {
  ...
  trait CombokeysStatic
    extends StObject
       with Instantiable1[/* element */ Element, typingsJapgolly.combokeys.Combokeys.Combokeys] {
    
    /**
      * all instances of Combokeys
      */
    var instances: js.Array[typingsJapgolly.combokeys.Combokeys.Combokeys] = js.native
