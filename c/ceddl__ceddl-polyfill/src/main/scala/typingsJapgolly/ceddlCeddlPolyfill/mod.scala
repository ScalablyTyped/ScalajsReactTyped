...
import typingsJapgolly.ceddlCeddlPolyfill.anon.FieldType
...
object mod {
  ...
  object ArrayField {
    ...
    inline def apply(validate: Callback): ArrayField = {
      val __obj = js.Dynamic.literal(validate = validate.toJsFn)
  ...
  object BooleanField {
    ...
    inline def apply(validate: Callback): BooleanField = {
      val __obj = js.Dynamic.literal(validate = validate.toJsFn)
  ...
  object ListField {
    ...
    inline def apply(validate: Callback): ListField = {
      val __obj = js.Dynamic.literal(validate = validate.toJsFn)
  ...
  trait ModelFactory extends StObject {
    ...
    var fields: typingsJapgolly.ceddlCeddlPolyfill.anon.ArrayField
  }
  object ModelFactory {
    
    inline def apply(create: ModelConfig => Model, fields: typingsJapgolly.ceddlCeddlPolyfill.anon.ArrayField): ModelFactory = {
    ...
    extension [Self <: ModelFactory](x: Self) {
      ...
      inline def setFields(value: typingsJapgolly.ceddlCeddlPolyfill.anon.ArrayField): Self = StObject.set(x, "fields", value.asInstanceOf[js.Any])
    }
  }
  ...
  object ModelField {
    ...
    inline def apply(validate: Callback): ModelField = {
      val __obj = js.Dynamic.literal(validate = validate.toJsFn)
  ...
  object NumberField {
    ...
    inline def apply(validate: Callback): NumberField = {
      val __obj = js.Dynamic.literal(validate = validate.toJsFn)
  ...
  object StringField {
    ...
    inline def apply(validate: Callback): StringField = {
      val __obj = js.Dynamic.literal(validate = validate.toJsFn)
