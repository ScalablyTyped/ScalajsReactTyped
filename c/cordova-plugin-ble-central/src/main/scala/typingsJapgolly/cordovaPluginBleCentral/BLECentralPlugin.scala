...
import typingsJapgolly.cordovaPluginBleCentral.anon.EmitOnRegistered
import typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.balanced
import typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.high
import typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.low
import typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.registered
...
object BLECentralPlugin {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.disconnected
    - typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.disconnecting
    - typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.connecting
    - typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.connected
  */
  trait PeripheralState extends StObject
  object PeripheralState {
    
    inline def connected: typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.connected = "connected".asInstanceOf[typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.connected]
    
    inline def connecting: typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.connecting = "connecting".asInstanceOf[typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.connecting]
    
    inline def disconnected: typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.disconnected = "disconnected".asInstanceOf[typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.disconnected]
    
    inline def disconnecting: typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.disconnecting = "disconnecting".asInstanceOf[typingsJapgolly.cordovaPluginBleCentral.cordovaPluginBleCentralStrings.disconnecting]
  }
