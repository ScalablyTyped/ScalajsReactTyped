...
import typingsJapgolly.cytoscape.anon.Degree
import typingsJapgolly.cytoscape.anon.MaxDegree
...
- typingsJapgolly.cytoscape.mod.LayoutOptions because Already inherited */ trait ConcentricLayoutOptions
  extends StObject
