...
object BaseLayoutOptions {
  ...
  extension [Self <: BaseLayoutOptions](x: Self) {
    ...
    inline def setReady(value: /* e */ LayoutEventObject => Callback): Self = StObject.set(x, "ready", js.Any.fromFunction1((t0: /* e */ LayoutEventObject) => value(t0).runNow()))
    
    inline def setReadyUndefined: Self = StObject.set(x, "ready", js.undefined)
    
    inline def setStop(value: /* e */ LayoutEventObject => Callback): Self = StObject.set(x, "stop", js.Any.fromFunction1((t0: /* e */ LayoutEventObject) => value(t0).runNow()))
