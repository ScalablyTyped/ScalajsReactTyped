...
import typingsJapgolly.cytoscape.cytoscapeStrings.`inside-to-node`
import typingsJapgolly.cytoscape.cytoscapeStrings.`outside-to-line-or-label`
import typingsJapgolly.cytoscape.cytoscapeStrings.`outside-to-line`
import typingsJapgolly.cytoscape.cytoscapeStrings.`outside-to-node-or-label`
import typingsJapgolly.cytoscape.cytoscapeStrings.`outside-to-node`
