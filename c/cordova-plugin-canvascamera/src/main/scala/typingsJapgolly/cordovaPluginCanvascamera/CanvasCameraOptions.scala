...
import typingsJapgolly.cordovaPluginCanvascamera.anon.Height
...
object CanvasCameraOptions {
  ...
  extension [Self <: CanvasCameraOptions](x: Self) {
    ...
    inline def setOnAfterDraw(value: /* frame */ js.UndefOr[Frame] => Callback): Self = StObject.set(x, "onAfterDraw", js.Any.fromFunction1((t0: /* frame */ js.UndefOr[Frame]) => value(t0).runNow()))
    
    inline def setOnAfterDrawUndefined: Self = StObject.set(x, "onAfterDraw", js.undefined)
    
    inline def setOnBeforeDraw(value: /* frame */ js.UndefOr[Frame] => Callback): Self = StObject.set(x, "onBeforeDraw", js.Any.fromFunction1((t0: /* frame */ js.UndefOr[Frame]) => value(t0).runNow()))
