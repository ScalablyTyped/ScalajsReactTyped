...
import typingsJapgolly.cspotcodeSourceMapSupport.cspotcodeSourceMapSupportInts.`3`
import typingsJapgolly.cspotcodeSourceMapSupport.cspotcodeSourceMapSupportStrings.auto
import typingsJapgolly.cspotcodeSourceMapSupport.cspotcodeSourceMapSupportStrings.browser
import typingsJapgolly.cspotcodeSourceMapSupport.cspotcodeSourceMapSupportStrings.node
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnConflictingLibraryRedirect(
        value: (/* request */ String, /* parent */ Any, /* isMain */ Boolean, /* options */ Any, /* redirectedRequest */ String) => Callback
      ): Self = StObject.set(x, "onConflictingLibraryRedirect", js.Any.fromFunction5((t0: /* request */ String, t1: /* parent */ Any, t2: /* isMain */ Boolean, t3: /* options */ Any, t4: /* redirectedRequest */ String) => (value(t0, t1, t2, t3, t4)).runNow()))
