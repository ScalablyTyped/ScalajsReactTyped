...
object distCachingMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cacheManager.cacheManagerStrings.memory
    - typingsJapgolly.cacheManager.distCachingMod.Store
    - typingsJapgolly.cacheManager.distCachingMod.FactoryStore[S, T]
  */
