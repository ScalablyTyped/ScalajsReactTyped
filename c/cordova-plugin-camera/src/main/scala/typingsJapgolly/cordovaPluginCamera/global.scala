...
import typingsJapgolly.cordovaPluginCamera.anon.ALLMEDIA
import typingsJapgolly.cordovaPluginCamera.anon.ARROWANY
import typingsJapgolly.cordovaPluginCamera.anon.BACK
import typingsJapgolly.cordovaPluginCamera.anon.CAMERA
import typingsJapgolly.cordovaPluginCamera.anon.DATAURL
import typingsJapgolly.cordovaPluginCamera.anon.JPEG
...
object global {
  ...
  open class CameraPopoverOptions ()
    extends StObject
       with typingsJapgolly.cordovaPluginCamera.CameraPopoverOptions {
