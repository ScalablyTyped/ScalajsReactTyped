...
import typingsJapgolly.chartist.distChartsLineChartLineChartDottypesMod.LineInterpolation
...
/* Inlined std.Omit<chartist.chartist/dist/charts/LineChart/LineChart.types.LineChartOptions<chartist.chartist/dist/utils.RequiredKeys<chartist.chartist/dist/core.AxisOptions, 'offset' | 'position' | 'labelOffset' | 'showLabel' | 'showGrid' | 'labelInterpolationFnc', never>, chartist.chartist/dist/utils.RequiredKeys<chartist.chartist/dist/core.AxisOptions, 'offset' | 'position' | 'labelOffset' | 'showLabel' | 'showGrid' | 'labelInterpolationFnc' | 'scaleMinSpace', never>>, 'series'> */
trait OmitLineChartOptionsRequi extends StObject {
...
object OmitLineChartOptionsRequi {
  
  inline def apply(): OmitLineChartOptionsRequi = {
