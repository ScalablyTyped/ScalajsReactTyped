...
import typingsJapgolly.chartist.anon.Command
import typingsJapgolly.chartist.chartistStrings.always
import typingsJapgolly.chartist.chartistStrings.discrete
import typingsJapgolly.chartist.chartistStrings.easeInBack
import typingsJapgolly.chartist.chartistStrings.easeInCirc
import typingsJapgolly.chartist.chartistStrings.easeInCubic
import typingsJapgolly.chartist.chartistStrings.easeInExpo
import typingsJapgolly.chartist.chartistStrings.easeInOutBack
import typingsJapgolly.chartist.chartistStrings.easeInOutCirc
import typingsJapgolly.chartist.chartistStrings.easeInOutCubic
import typingsJapgolly.chartist.chartistStrings.easeInOutExpo
import typingsJapgolly.chartist.chartistStrings.easeInOutQuad
import typingsJapgolly.chartist.chartistStrings.easeInOutQuart
import typingsJapgolly.chartist.chartistStrings.easeInOutQuint
import typingsJapgolly.chartist.chartistStrings.easeInOutSine
import typingsJapgolly.chartist.chartistStrings.easeInQuad
import typingsJapgolly.chartist.chartistStrings.easeInQuart
import typingsJapgolly.chartist.chartistStrings.easeInQuint
import typingsJapgolly.chartist.chartistStrings.easeInSine
import typingsJapgolly.chartist.chartistStrings.easeOutBack
import typingsJapgolly.chartist.chartistStrings.easeOutCirc
import typingsJapgolly.chartist.chartistStrings.easeOutCubic
import typingsJapgolly.chartist.chartistStrings.easeOutExpo
import typingsJapgolly.chartist.chartistStrings.easeOutQuad
import typingsJapgolly.chartist.chartistStrings.easeOutQuart
import typingsJapgolly.chartist.chartistStrings.easeOutQuint
import typingsJapgolly.chartist.chartistStrings.easeOutSine
import typingsJapgolly.chartist.chartistStrings.indefinite
import typingsJapgolly.chartist.chartistStrings.linear
import typingsJapgolly.chartist.chartistStrings.never
import typingsJapgolly.chartist.chartistStrings.paced
import typingsJapgolly.chartist.chartistStrings.spline
import typingsJapgolly.chartist.chartistStrings.whenNotActive
...
object distSvgTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chartist.distSvgTypesMod.MoveParams
    - typingsJapgolly.chartist.distSvgTypesMod.LineParams
    - typingsJapgolly.chartist.distSvgTypesMod.CurveParams
    - typingsJapgolly.chartist.distSvgTypesMod.ArcParams
  */
  ...
  object _PathParams {
    ...
    inline def ArcParams(lAf: Double, rx: Double, ry: Double, sf: Double, x: Double, xAr: Double, y: Double): typingsJapgolly.chartist.distSvgTypesMod.ArcParams = {
      val __obj = js.Dynamic.literal(lAf = lAf.asInstanceOf[js.Any], rx = rx.asInstanceOf[js.Any], ry = ry.asInstanceOf[js.Any], sf = sf.asInstanceOf[js.Any], x = x.asInstanceOf[js.Any], xAr = xAr.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.chartist.distSvgTypesMod.ArcParams]
    }
    
    inline def CurveParams(x: Double, x1: Double, x2: Double, y: Double, y1: Double, y2: Double): typingsJapgolly.chartist.distSvgTypesMod.CurveParams = {
      val __obj = js.Dynamic.literal(x = x.asInstanceOf[js.Any], x1 = x1.asInstanceOf[js.Any], x2 = x2.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any], y1 = y1.asInstanceOf[js.Any], y2 = y2.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.chartist.distSvgTypesMod.CurveParams]
    }
  }
}
