...
import typingsJapgolly.chartist.chartistStrings.Asterisk
...
import typingsJapgolly.chartist.distEventEventEmitterMod.AllEventsListener
import typingsJapgolly.chartist.distEventEventEmitterMod.EventListener
