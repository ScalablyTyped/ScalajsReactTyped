...
object distSvgMod {
  ...
  open class Svg protected ()
    extends typingsJapgolly.chartist.distSvgSvgMod.Svg {
    /**
  ...
  open class SvgList protected ()
    extends typingsJapgolly.chartist.distSvgSvgListMod.SvgList {
    /**
  ...
  /**
    ...
    */
  open class SvgPath ()
    extends typingsJapgolly.chartist.distSvgSvgPathMod.SvgPath {
