...
object Integration02 {
  
  @JSImport("@carbon/pictograms-react", "Integration02")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Integration02.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
