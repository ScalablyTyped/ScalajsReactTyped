...
object EmergencyExit {
  
  @JSImport("@carbon/pictograms-react", "EmergencyExit")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: EmergencyExit.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
