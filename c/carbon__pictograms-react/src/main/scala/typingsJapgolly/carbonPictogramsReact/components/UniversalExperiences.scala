...
object UniversalExperiences {
  
  @JSImport("@carbon/pictograms-react", "UniversalExperiences")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: UniversalExperiences.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
