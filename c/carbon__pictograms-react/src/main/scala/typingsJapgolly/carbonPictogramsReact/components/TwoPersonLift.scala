...
object TwoPersonLift {
  
  @JSImport("@carbon/pictograms-react", "TwoPersonLift")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: TwoPersonLift.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
