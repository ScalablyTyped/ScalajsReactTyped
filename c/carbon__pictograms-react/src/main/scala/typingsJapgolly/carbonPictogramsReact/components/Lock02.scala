...
object Lock02 {
  ...
  @JSImport("@carbon/pictograms-react", "Lock02")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Lock02.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
