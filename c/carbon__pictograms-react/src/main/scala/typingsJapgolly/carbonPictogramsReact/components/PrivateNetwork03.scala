...
object PrivateNetwork03 {
  
  @JSImport("@carbon/pictograms-react", "PrivateNetwork03")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: PrivateNetwork03.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
