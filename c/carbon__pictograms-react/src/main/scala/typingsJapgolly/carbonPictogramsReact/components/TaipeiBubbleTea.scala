...
object TaipeiBubbleTea {
  
  @JSImport("@carbon/pictograms-react", "TaipeiBubbleTea")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: TaipeiBubbleTea.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
