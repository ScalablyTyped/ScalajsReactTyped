...
object MachineLearning07 {
  
  @JSImport("@carbon/pictograms-react", "MachineLearning07")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: MachineLearning07.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
