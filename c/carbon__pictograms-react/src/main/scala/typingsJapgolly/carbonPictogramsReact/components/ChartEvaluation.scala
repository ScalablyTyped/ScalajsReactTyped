...
object ChartEvaluation {
  
  @JSImport("@carbon/pictograms-react", "ChartEvaluation")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ChartEvaluation.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
