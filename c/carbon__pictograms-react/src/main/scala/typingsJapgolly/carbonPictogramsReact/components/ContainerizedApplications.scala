...
object ContainerizedApplications {
  
  @JSImport("@carbon/pictograms-react", "ContainerizedApplications")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ContainerizedApplications.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
