...
object IbmZ16PlusCloud {
  
  @JSImport("@carbon/pictograms-react", "IbmZ16PlusCloud")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: IbmZ16PlusCloud.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
