...
object BusinessContinuity02 {
  
  @JSImport("@carbon/pictograms-react", "BusinessContinuity02")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: BusinessContinuity02.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
