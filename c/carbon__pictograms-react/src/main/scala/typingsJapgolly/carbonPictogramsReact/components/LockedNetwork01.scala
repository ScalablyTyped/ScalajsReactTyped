...
object LockedNetwork01 {
  
  @JSImport("@carbon/pictograms-react", "LockedNetwork01")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LockedNetwork01.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
