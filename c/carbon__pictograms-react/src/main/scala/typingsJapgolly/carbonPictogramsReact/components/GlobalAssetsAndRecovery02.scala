...
object GlobalAssetsAndRecovery02 {
  ...
  implicit def make(companion: GlobalAssetsAndRecovery02.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
