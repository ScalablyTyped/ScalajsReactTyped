...
object NycManhattan01 {
  
  @JSImport("@carbon/pictograms-react", "NycManhattan01")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NycManhattan01.type): SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement] = new SharedBuilder_CarbonPictogramPropsRefAttributes1100045141[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
