package typingsJapgolly.conf.mod
...
trait Options[T] extends js.Object {
  ...
  {[ P in keyof T ]: conf.conf.Schema}
    */ typingsJapgolly.conf.confStrings.Options with js.Any
  ] = js.undefined
  /**
...
object Options {
  ...
  def apply[T](
    ...
    cwd: String = null,
    defaults: T = null,
    deserialize: /* text */ String => CallbackTo[T] = null,
  ...
  {[ P in keyof T ]: conf.conf.Schema}
    */ typingsJapgolly.conf.confStrings.Options with js.Any = null,
    serialize: /* value */ T => CallbackTo[String] = null,
    ...
    if (deserialize != null) __obj.updateDynamic("deserialize")(js.Any.fromFunction1((t0: /* text */ java.lang.String) => deserialize(t0).runNow()))
    ...
    if (serialize != null) __obj.updateDynamic("serialize")(js.Any.fromFunction1((t0: /* value */ T) => serialize(t0).runNow()))
