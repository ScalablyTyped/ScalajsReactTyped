...
package object es5Mod {
  ...
  type Cast[T] = js.Function2[
    /* value */ T, 
    /* context */ typingsJapgolly.csvStringify.es5Mod.CastingContext, 
    java.lang.String
  ]
  ...
  */
  type RecordDelimiter = typingsJapgolly.csvStringify.es5Mod._RecordDelimiter | java.lang.String | typingsJapgolly.node.Buffer
}
