...
object mod {
  ...
  trait Options
    ...
    /**
      ...
      */
    var cast: js.UndefOr[typingsJapgolly.csvStringify.anon.Boolean] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setCast(value: typingsJapgolly.csvStringify.anon.Boolean): Self = StObject.set(x, "cast", value.asInstanceOf[js.Any])
