...
import typingsJapgolly.cucumberMessageStreams.distCjsSrcMessageToNdjsonStreamMod.default
...
object mod {
  ...
  open class NdjsonToMessageStream ()
    extends typingsJapgolly.cucumberMessageStreams.distCjsSrcNdjsonToMessageStreamMod.default {
