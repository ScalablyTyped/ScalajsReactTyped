package typingsJapgolly.cryptoHash

import typingsJapgolly.cryptoHash.mod.OptionBufferOutput
import typingsJapgolly.cryptoHash.mod.OptionsHexOutput
...
object browserMod {
  ...
  @JSImport("crypto-hash/browser", JSImport.Namespace)
  @js.native
