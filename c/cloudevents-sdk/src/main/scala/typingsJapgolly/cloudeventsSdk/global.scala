...
object global {
  ...
  open class Base64Parser protected ()
    extends StObject
       with typingsJapgolly.cloudeventsSdk.Base64Parser {
  ...
  open class JSONParser protected ()
    extends StObject
       with typingsJapgolly.cloudeventsSdk.JSONParser {
    def this(decorator: typingsJapgolly.cloudeventsSdk.Base64Parser) = this()
  }
