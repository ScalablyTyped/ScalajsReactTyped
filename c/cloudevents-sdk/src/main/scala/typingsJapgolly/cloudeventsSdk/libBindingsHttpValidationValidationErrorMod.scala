...
object libBindingsHttpValidationValidationErrorMod {
  ...
  open class ^ protected ()
    ...
    def this(
      message: String,
      errors: js.Array[
            (typingsJapgolly.ajv.distTypesMod.ErrorObject[String, Record[String, Any], Any]) | String
          ]
    ) = this()
  ...
  object ValidationError {
    ...
    extension [Self <: ValidationError](x: Self) {
      ...
      inline def setErrorsVarargs(
        value: ((typingsJapgolly.ajv.distTypesMod.ErrorObject[String, Record[String, Any], Any]) | String)*
