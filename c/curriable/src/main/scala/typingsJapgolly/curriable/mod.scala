...
object mod extends js.Object {
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.curriable.curriableBooleans.`true`
    - typingsJapgolly.curriable.curriableBooleans.`false`
  */
  ...
  {[ K in keyof T ]: std.NonNullable<T[K]>}
    */ typingsJapgolly.curriable.curriableStrings.CleanedGaps with T
  ...
  {[ K in keyof T ]:? T[K] | curriable.curriable.Placeholder}
    */ typingsJapgolly.curriable.curriableStrings.PartialGaps with T
