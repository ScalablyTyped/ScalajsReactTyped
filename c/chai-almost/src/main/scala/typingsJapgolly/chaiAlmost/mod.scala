...
import typingsJapgolly.chaiAlmost.mod.global.Chai.ChaiAlmost.Almost
import typingsJapgolly.chaiAlmost.mod.global.Chai.ChaiAlmost.DeepAlmost
    ...
    object Chai {
      ...
      object ChaiAlmost {
        ...
        trait Almost
          ...
          def eql(value: Any): typingsJapgolly.chai.Chai.Assertion = js.native
          def eql(value: Any, message: String): typingsJapgolly.chai.Chai.Assertion = js.native
          @JSName("eql")
          var eql_Original: Equal = js.native
          
          def eqls(value: Any): typingsJapgolly.chai.Chai.Assertion = js.native
          def eqls(value: Any, message: String): typingsJapgolly.chai.Chai.Assertion = js.native
          @JSName("eqls")
        ...
        trait DeepAlmost extends StObject {
          ...
          def eq(value: Any, message: String): typingsJapgolly.chai.Chai.Assertion = js.native
          @JSName("eq")
          var eq_Original: Equal = js.native
          
          def equal(value: Any): typingsJapgolly.chai.Chai.Assertion = js.native
          def equal(value: Any, message: String): typingsJapgolly.chai.Chai.Assertion = js.native
          @JSName("equal")
          var equal_Original: Equal = js.native
          
          def equals(value: Any, message: String): typingsJapgolly.chai.Chai.Assertion = js.native
          @JSName("equals")
