package typingsJapgolly.compressionNext
...
object mod {
  ...
  @JSImport("compression-next", JSImport.Namespace)
  @js.native
  ...
  /**
    ...
    * In addition to those listed below, `zlib` or `brotli` options may be passed in to the options object.
    */
  ...
  object global {
    ...
    object Express {
      ...
      object Response {
        ...
        inline def apply(flush: Callback): Response = {
