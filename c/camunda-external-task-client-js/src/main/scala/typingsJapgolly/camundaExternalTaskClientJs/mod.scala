...
import typingsJapgolly.camundaExternalTaskClientJs.anon.Authorization
import typingsJapgolly.camundaExternalTaskClientJs.anon.Password
import typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.pollColonsuccess
...
object mod {
  ...
  object ClientConfig {
    ...
    extension [Self <: ClientConfig](x: Self) {
      ...
      inline def setUseFunction1(value: /* client */ Client => Callback): Self = StObject.set(x, "use", js.Any.fromFunction1((t0: /* client */ Client) => value(t0).runNow()))
  ...
  */
  ...
  object ErrorEvent {
    ...
    inline def completeColonerror: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.completeColonerror = "complete:error".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.completeColonerror]
    
    inline def pollColonerror: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.pollColonerror = "poll:error".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.pollColonerror]
  }
  ...
  */
  ...
  object ErrorWithTaskEvent {
    ...
    inline def extendLockColonerror: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.extendLockColonerror = "extendLock:error".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.extendLockColonerror]
    
    inline def handleBpmnErrorColonerror: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.handleBpmnErrorColonerror = "handleBpmnError:error".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.handleBpmnErrorColonerror]
    
    inline def handleFailureColonerror: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.handleFailureColonerror = "handleFailure:error".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.handleFailureColonerror]
    
    inline def unlockColonerror: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.unlockColonerror = "unlock:error".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.unlockColonerror]
  }
  ...
  */
  ...
  object PollEvent {
    ...
    inline def pollColonstart: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.pollColonstart = "poll:start".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.pollColonstart]
    
    inline def pollColonstop: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.pollColonstop = "poll:stop".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.pollColonstop]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.completeColonsuccess
    - typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.handleFailureColonsuccess
    - typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.handleBpmnErrorColonsuccess
    - typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.extendLockColonsuccess
    - typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.unlockColonsuccess
  */
  trait SuccessWithTaskEvent extends StObject
  object SuccessWithTaskEvent {
    
    inline def completeColonsuccess: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.completeColonsuccess = "complete:success".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.completeColonsuccess]
    
    inline def extendLockColonsuccess: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.extendLockColonsuccess = "extendLock:success".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.extendLockColonsuccess]
    
    inline def handleBpmnErrorColonsuccess: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.handleBpmnErrorColonsuccess = "handleBpmnError:success".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.handleBpmnErrorColonsuccess]
    
    inline def handleFailureColonsuccess: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.handleFailureColonsuccess = "handleFailure:success".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.handleFailureColonsuccess]
    
    inline def unlockColonsuccess: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.unlockColonsuccess = "unlock:success".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.unlockColonsuccess]
  }
  ...
  */
  ...
  object TopicEvent {
    ...
    inline def subscribe: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.subscribe = "subscribe".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.subscribe]
    
    inline def unsubscribe: typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.unsubscribe = "unsubscribe".asInstanceOf[typingsJapgolly.camundaExternalTaskClientJs.camundaExternalTaskClientJsStrings.unsubscribe]
  }
  ...
  object TopicSubscription {
    ...
    inline def apply(unsubscribe: Callback): TopicSubscription = {
