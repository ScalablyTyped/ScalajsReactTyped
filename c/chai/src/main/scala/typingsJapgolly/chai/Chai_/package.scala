...
package object Chai_ {
  type AssertStatic = typingsJapgolly.chai.Chai_.Assert
  ...
  js.Any, 
    typingsJapgolly.chai.Chai_.Message, 
    typingsJapgolly.chai.Chai_.Message, 
    js.Any, 
    js.UndefOr[js.Any], 
  ...
  type ChaiPlugin = js.Function2[
    /* chai */ typingsJapgolly.chai.Chai_.ChaiStatic, 
    /* utils */ typingsJapgolly.chai.Chai_.ChaiUtils, 
    scala.Unit
  ]
  type CloseTo = js.Function3[
    ...
    typingsJapgolly.chai.Chai_.Assertion
  ]
  ...
  type PropertyChange = js.Function3[
    /* object */ typingsJapgolly.chai.Object, 
