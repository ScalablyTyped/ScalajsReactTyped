...
trait Assert extends StObject {
  ...
  /**
    ...
    * @param message   Message to display on error.
    */
  def lengthOf[T /* <: typingsJapgolly.chai.anon.Length */](`object`: T, length: Double): Unit = js.native
  def lengthOf[T /* <: typingsJapgolly.chai.anon.Length */](`object`: T, length: Double, message: String): Unit = js.native
