...
object logicNotMod {
  ...
  inline def default[A](p: typingsJapgolly.crocks.predMod.default): js.Function1[/* x */ A, Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(p.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* x */ A, Boolean]]
}
