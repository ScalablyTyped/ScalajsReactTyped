...
object logicWhenMod {
  ...
  inline def default[A, B](p: typingsJapgolly.crocks.predMod.default): js.Function1[/* f */ js.Function1[/* x */ A, B], js.Function1[/* x */ A, A | B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(p.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* f */ js.Function1[/* x */ A, B], js.Function1[/* x */ A, A | B]]]
  inline def default[A, B](p: typingsJapgolly.crocks.predMod.default, f: js.Function1[/* x */ A, B]): js.Function1[/* x */ A, A | B] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(p.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* x */ A, A | B]]
}
