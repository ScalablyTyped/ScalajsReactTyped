...
object stateStateMod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    override def runWith(`val`: Any): typingsJapgolly.crocks.pairMod.default = js.native
  }
  object default {
    
    inline def apply(`val`: js.Function1[/* state */ Any, typingsJapgolly.crocks.pairMod.default]): State = ^.asInstanceOf[js.Dynamic].apply(`val`.asInstanceOf[js.Any]).asInstanceOf[State]
  ...
  trait State extends StObject {
    ...
    def runWith(`val`: Any): typingsJapgolly.crocks.pairMod.default
  }
  object State {
    ...
    inline def apply(
      ...
      runWith: Any => typingsJapgolly.crocks.pairMod.default
    ): State = {
    ...
    extension [Self <: State](x: Self) {
      ...
      inline def setRunWith(value: Any => typingsJapgolly.crocks.pairMod.default): Self = StObject.set(x, "runWith", js.Any.fromFunction1(value))
    }
  }
}
