...
object logicIfElseMod {
  ...
  inline def default[A, C](p: typingsJapgolly.crocks.predMod.default): js.Function1[
    /* f */ js.Function1[/* x */ A, Any], 
    js.Function1[/* g */ js.Function1[/* x */ A, C], js.Function1[/* x */ A, A | C]]
  ] = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(p.asInstanceOf[js.Any]).asInstanceOf[js.Function1[
    /* f */ js.Function1[/* x */ A, Any], 
  ...
  inline def default[A, C](p: typingsJapgolly.crocks.predMod.default, f: js.Function1[/* x */ A, Any]): js.Function1[/* g */ js.Function1[/* x */ A, C], js.Function1[/* x */ A, A | C]] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(p.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* g */ js.Function1[/* x */ A, C], js.Function1[/* x */ A, A | C]]]
  inline def default[A, C](
    p: typingsJapgolly.crocks.predMod.default,
    f: js.Function1[/* x */ A, Any],
    g: js.Function1[/* x */ A, C]
  ): js.Function1[/* x */ A, A | C] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(p.asInstanceOf[js.Any], f.asInstanceOf[js.Any], g.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* x */ A, A | C]]
}
