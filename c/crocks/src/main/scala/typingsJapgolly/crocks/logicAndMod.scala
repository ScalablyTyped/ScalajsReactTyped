...
object logicAndMod {
  ...
  inline def default[A](p: PredicateFunction[A], q: typingsJapgolly.crocks.predMod.default, x: A): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(p.asInstanceOf[js.Any], q.asInstanceOf[js.Any], x.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def default[A](p: typingsJapgolly.crocks.predMod.default, q: PredicateFunction[A], x: A): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(p.asInstanceOf[js.Any], q.asInstanceOf[js.Any], x.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def default[A](p: typingsJapgolly.crocks.predMod.default, q: typingsJapgolly.crocks.predMod.default, x: A): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(p.asInstanceOf[js.Any], q.asInstanceOf[js.Any], x.asInstanceOf[js.Any])).asInstanceOf[Boolean]
}
