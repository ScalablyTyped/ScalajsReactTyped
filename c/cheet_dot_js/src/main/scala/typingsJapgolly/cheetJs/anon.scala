package typingsJapgolly.cheetJs
...
object anon {
  ...
  object Done {
    ...
    extension [Self <: Done](x: Self) {
      ...
      inline def setDone(value: (/* str */ String, /* seq */ js.Array[String]) => Callback): Self = StObject.set(x, "done", js.Any.fromFunction2((t0: /* str */ String, t1: /* seq */ js.Array[String]) => (value(t0, t1)).runNow()))
      
      inline def setDoneUndefined: Self = StObject.set(x, "done", js.undefined)
      
      inline def setFail(value: (/* str */ String, /* seq */ js.Array[String]) => Callback): Self = StObject.set(x, "fail", js.Any.fromFunction2((t0: /* str */ String, t1: /* seq */ js.Array[String]) => (value(t0, t1)).runNow()))
      
      inline def setFailUndefined: Self = StObject.set(x, "fail", js.undefined)
      
      inline def setNext(
        value: (/* str */ String, /* key */ String, /* num */ Double, /* seq */ js.Array[String]) => Callback
      ): Self = StObject.set(x, "next", js.Any.fromFunction4((t0: /* str */ String, t1: /* key */ String, t2: /* num */ Double, t3: /* seq */ js.Array[String]) => (value(t0, t1, t2, t3)).runNow()))
