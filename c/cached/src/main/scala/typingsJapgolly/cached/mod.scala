package typingsJapgolly.cached

import typingsJapgolly.cached.anon.Expire
import typingsJapgolly.cached.cachedStrings.memcached
import typingsJapgolly.cached.cachedStrings.memory
import typingsJapgolly.cached.cachedStrings.noop
...
object mod {
  ...
  trait BackendOptions extends StObject {
    ...
    var client: js.UndefOr[typingsJapgolly.memcached.mod.^] = js.undefined
  ...
  object BackendOptions {
    ...
    extension [Self <: BackendOptions](x: Self) {
      ...
      inline def setClient(value: typingsJapgolly.memcached.mod.^): Self = StObject.set(x, "client", value.asInstanceOf[js.Any])
