...
import typingsJapgolly.canvg.distDocumentMod.AnimateElement
import typingsJapgolly.canvg.distDocumentMod.Document
import typingsJapgolly.canvg.distDocumentMod.Element
import typingsJapgolly.canvg.distMouseMod.Mouse
import typingsJapgolly.canvg.distTypesMod.Fetch
import typingsJapgolly.canvg.distTypesMod.RenderingContext2D
import typingsJapgolly.canvg.distViewPortMod.ViewPort
...
object distScreenMod {
  ...
  object IScreenStartOptions {
    ...
    extension [Self <: IScreenStartOptions](x: Self) {
      ...
      inline def setForceRedraw(value: CallbackTo[Boolean]): Self = StObject.set(x, "forceRedraw", value.toJsFn)
