...
open class Document protected ()
  extends typingsJapgolly.canvg.distDocumentMod.Document {
  def this(canvg: typingsJapgolly.canvg.distCanvgMod.Canvg) = this()
  def this(
    canvg: typingsJapgolly.canvg.distCanvgMod.Canvg,
