...
import typingsJapgolly.canvg.distTypesMod.VectorValue
import typingsJapgolly.canvg.mod.^
...
inline def PSEUDO_ZERO: /* 1e-8 */ Double = ^.asInstanceOf[js.Dynamic].selectDynamic("PSEUDO_ZERO").asInstanceOf[/* 1e-8 */ Double]
