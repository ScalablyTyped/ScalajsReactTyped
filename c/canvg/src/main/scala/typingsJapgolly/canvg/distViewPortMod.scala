...
object distViewPortMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.canvg.canvgStrings.x
    - typingsJapgolly.canvg.canvgStrings.y
  */
  trait Axis extends StObject
  object Axis {
    
    inline def x: typingsJapgolly.canvg.canvgStrings.x = "x".asInstanceOf[typingsJapgolly.canvg.canvgStrings.x]
    
    inline def y: typingsJapgolly.canvg.canvgStrings.y = "y".asInstanceOf[typingsJapgolly.canvg.canvgStrings.y]
  }
