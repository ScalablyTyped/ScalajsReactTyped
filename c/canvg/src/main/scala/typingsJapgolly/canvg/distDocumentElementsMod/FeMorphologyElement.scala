...
@JSImport("canvg/dist/Document/elements", "FeMorphologyElement")
@js.native
open class FeMorphologyElement protected ()
  extends typingsJapgolly.canvg.distDocumentFeMorphologyElementMod.FeMorphologyElement {
