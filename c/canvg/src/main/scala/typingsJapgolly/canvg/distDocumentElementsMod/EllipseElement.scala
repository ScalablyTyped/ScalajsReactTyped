...
@JSImport("canvg/dist/Document/elements", "EllipseElement")
@js.native
open class EllipseElement protected ()
  extends typingsJapgolly.canvg.distDocumentEllipseElementMod.EllipseElement {
