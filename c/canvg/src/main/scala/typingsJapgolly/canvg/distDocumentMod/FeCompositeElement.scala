...
@JSImport("canvg/dist/Document", "FeCompositeElement")
@js.native
open class FeCompositeElement protected ()
  extends typingsJapgolly.canvg.distDocumentElementsMod.FeCompositeElement {
