...
object distDocumentFeMorphologyElementMod {
  
  @JSImport("canvg/dist/Document/FeMorphologyElement", "FeMorphologyElement")
  @js.native
  open class FeMorphologyElement protected () extends Element {
