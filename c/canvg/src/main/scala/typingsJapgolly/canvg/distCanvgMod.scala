...
import typingsJapgolly.canvg.distParserMod.IParserOptions
import typingsJapgolly.canvg.distParserMod.Parser
import typingsJapgolly.canvg.distScreenMod.IScreenStartOptions
...
object distCanvgMod {
  ...
  - typingsJapgolly.canvg.distScreenMod.IScreenOptions because var conflicts: fetch. Inlined window */ trait IOptions
    extends StObject
       with IParserOptions
