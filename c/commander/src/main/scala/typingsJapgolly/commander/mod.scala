package typingsJapgolly.commander

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.commander.commanderBooleans.`true`
import typingsJapgolly.commander.commanderStrings.electron
import typingsJapgolly.commander.commanderStrings.node
import typingsJapgolly.commander.commanderStrings.user
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.commander.commanderStrings.beforeAll
    - typingsJapgolly.commander.commanderStrings.before
    - typingsJapgolly.commander.commanderStrings.after
    - typingsJapgolly.commander.commanderStrings.afterAll
  */
  trait AddHelpTextPosition extends StObject
  object AddHelpTextPosition {
    
    inline def after: typingsJapgolly.commander.commanderStrings.after = "after".asInstanceOf[typingsJapgolly.commander.commanderStrings.after]
    
    inline def afterAll: typingsJapgolly.commander.commanderStrings.afterAll = "afterAll".asInstanceOf[typingsJapgolly.commander.commanderStrings.afterAll]
    
    inline def before: typingsJapgolly.commander.commanderStrings.before = "before".asInstanceOf[typingsJapgolly.commander.commanderStrings.before]
    
    inline def beforeAll: typingsJapgolly.commander.commanderStrings.beforeAll = "beforeAll".asInstanceOf[typingsJapgolly.commander.commanderStrings.beforeAll]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.commander.commanderStrings.preSubcommand
    - typingsJapgolly.commander.commanderStrings.preAction
    - typingsJapgolly.commander.commanderStrings.postAction
  */
  trait HookEvent extends StObject
  object HookEvent {
    
    inline def postAction: typingsJapgolly.commander.commanderStrings.postAction = "postAction".asInstanceOf[typingsJapgolly.commander.commanderStrings.postAction]
    
    inline def preAction: typingsJapgolly.commander.commanderStrings.preAction = "preAction".asInstanceOf[typingsJapgolly.commander.commanderStrings.preAction]
    
    inline def preSubcommand: typingsJapgolly.commander.commanderStrings.preSubcommand = "preSubcommand".asInstanceOf[typingsJapgolly.commander.commanderStrings.preSubcommand]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.commander.commanderStrings.default
    - typingsJapgolly.commander.commanderStrings.config
    - typingsJapgolly.commander.commanderStrings.env
    - typingsJapgolly.commander.commanderStrings.cli
    - typingsJapgolly.commander.commanderStrings.implied
  */
  trait OptionValueSource extends StObject
  object OptionValueSource {
    
    inline def default: typingsJapgolly.commander.commanderStrings.default = "default".asInstanceOf[typingsJapgolly.commander.commanderStrings.default]
    
    inline def cli: typingsJapgolly.commander.commanderStrings.cli = "cli".asInstanceOf[typingsJapgolly.commander.commanderStrings.cli]
    
    inline def config: typingsJapgolly.commander.commanderStrings.config = "config".asInstanceOf[typingsJapgolly.commander.commanderStrings.config]
    
    inline def env: typingsJapgolly.commander.commanderStrings.env = "env".asInstanceOf[typingsJapgolly.commander.commanderStrings.env]
    
    inline def implied: typingsJapgolly.commander.commanderStrings.implied = "implied".asInstanceOf[typingsJapgolly.commander.commanderStrings.implied]
  }
  ...
  object OutputConfiguration {
    ...
    extension [Self <: OutputConfiguration](x: Self) {
      ...
      inline def setGetErrHelpWidth(value: CallbackTo[Double]): Self = StObject.set(x, "getErrHelpWidth", value.toJsFn)
      
      inline def setGetErrHelpWidthUndefined: Self = StObject.set(x, "getErrHelpWidth", js.undefined)
      
      inline def setGetOutHelpWidth(value: CallbackTo[Double]): Self = StObject.set(x, "getOutHelpWidth", value.toJsFn)
      
      inline def setGetOutHelpWidthUndefined: Self = StObject.set(x, "getOutHelpWidth", js.undefined)
      
      inline def setOutputError(value: (/* str */ String, /* write */ js.Function1[/* str */ String, Unit]) => Callback): Self = StObject.set(x, "outputError", js.Any.fromFunction2((t0: /* str */ String, t1: /* write */ js.Function1[/* str */ String, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setOutputErrorUndefined: Self = StObject.set(x, "outputError", js.undefined)
      
      inline def setWriteErr(value: /* str */ String => Callback): Self = StObject.set(x, "writeErr", js.Any.fromFunction1((t0: /* str */ String) => value(t0).runNow()))
      
      inline def setWriteErrUndefined: Self = StObject.set(x, "writeErr", js.undefined)
      
      inline def setWriteOut(value: /* str */ String => Callback): Self = StObject.set(x, "writeOut", js.Any.fromFunction1((t0: /* str */ String) => value(t0).runNow()))
