package typingsJapgolly.cssElementQueries

import org.scalajs.dom.Element
import typingsJapgolly.cssElementQueries.srcResizeSensorMod.ResizeSensorCallback
...
object mod {
  ...
  open class ElementQueries ()
    extends typingsJapgolly.cssElementQueries.srcElementQueriesMod.ElementQueries
  /* static members */
  ...
  open class ResizeSensor protected ()
    extends typingsJapgolly.cssElementQueries.srcResizeSensorMod.ResizeSensor {
