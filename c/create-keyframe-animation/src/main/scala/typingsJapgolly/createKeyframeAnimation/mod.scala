package typingsJapgolly.createKeyframeAnimation

import org.scalablytyped.runtime.StringDictionary
import org.scalajs.dom.Element
import typingsJapgolly.createKeyframeAnimation.anon.FnCall
import typingsJapgolly.createKeyframeAnimation.anon.Name
import typingsJapgolly.createKeyframeAnimation.anon.PartialPresetsConfig
import typingsJapgolly.std.FillMode
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.createKeyframeAnimation.createKeyframeAnimationStrings.normal
    - typingsJapgolly.createKeyframeAnimation.createKeyframeAnimationStrings.alternate
    - typingsJapgolly.createKeyframeAnimation.createKeyframeAnimationStrings.reverse
    - typingsJapgolly.createKeyframeAnimation.createKeyframeAnimationStrings.`alternate-reverse`
  */
  trait Direction extends StObject
  object Direction {
    
    inline def alternate: typingsJapgolly.createKeyframeAnimation.createKeyframeAnimationStrings.alternate = "alternate".asInstanceOf[typingsJapgolly.createKeyframeAnimation.createKeyframeAnimationStrings.alternate]
    
    inline def `alternate-reverse`: typingsJapgolly.createKeyframeAnimation.createKeyframeAnimationStrings.`alternate-reverse` = "alternate-reverse".asInstanceOf[typingsJapgolly.createKeyframeAnimation.createKeyframeAnimationStrings.`alternate-reverse`]
    
    inline def normal: typingsJapgolly.createKeyframeAnimation.createKeyframeAnimationStrings.normal = "normal".asInstanceOf[typingsJapgolly.createKeyframeAnimation.createKeyframeAnimationStrings.normal]
    
    inline def reverse: typingsJapgolly.createKeyframeAnimation.createKeyframeAnimationStrings.reverse = "reverse".asInstanceOf[typingsJapgolly.createKeyframeAnimation.createKeyframeAnimationStrings.reverse]
  }
