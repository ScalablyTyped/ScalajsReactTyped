package typingsJapgolly.cloudflareTurnstile
...
object Turnstile {
  ...
  object RenderParameters {
    ...
    extension [Self <: RenderParameters](x: Self) {
      ...
      inline def setCallback(value: /* token */ String => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* token */ String) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cloudflareTurnstile.cloudflareTurnstileStrings.auto
    - typingsJapgolly.cloudflareTurnstile.cloudflareTurnstileStrings.light
    - typingsJapgolly.cloudflareTurnstile.cloudflareTurnstileStrings.dark
  */
  trait Theme extends StObject
  object Theme {
    
    inline def auto: typingsJapgolly.cloudflareTurnstile.cloudflareTurnstileStrings.auto = "auto".asInstanceOf[typingsJapgolly.cloudflareTurnstile.cloudflareTurnstileStrings.auto]
    
    inline def dark: typingsJapgolly.cloudflareTurnstile.cloudflareTurnstileStrings.dark = "dark".asInstanceOf[typingsJapgolly.cloudflareTurnstile.cloudflareTurnstileStrings.dark]
    
    inline def light: typingsJapgolly.cloudflareTurnstile.cloudflareTurnstileStrings.light = "light".asInstanceOf[typingsJapgolly.cloudflareTurnstile.cloudflareTurnstileStrings.light]
  }
