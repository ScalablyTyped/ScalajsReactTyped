...
import typingsJapgolly.cosmiconfig.mod.LoaderSync
import typingsJapgolly.cosmiconfig.mod.Transform
import typingsJapgolly.cosmiconfig.mod.TransformSync
...
object distTypesMod {
  ...
  type CosmiconfigResult = typingsJapgolly.cosmiconfig.anon.Config | Null
