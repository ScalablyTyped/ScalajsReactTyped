...
object Location {
  ...
  @JSImport("@carbon/icons-react", "Location")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Location.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
