...
object ChartViolinPlot {
  
  @JSImport("@carbon/icons-react", "ChartViolinPlot")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ChartViolinPlot.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
