...
object SysProvision {
  ...
  @JSImport("@carbon/icons-react", "SysProvision")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SysProvision.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
