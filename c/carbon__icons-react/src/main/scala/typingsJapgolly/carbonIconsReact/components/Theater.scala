...
object Theater {
  ...
  @JSImport("@carbon/icons-react", "Theater")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Theater.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
