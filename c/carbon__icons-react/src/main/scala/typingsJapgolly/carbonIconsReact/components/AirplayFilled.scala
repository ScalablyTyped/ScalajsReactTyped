...
object AirplayFilled {
  
  @JSImport("@carbon/icons-react", "AirplayFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: AirplayFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
