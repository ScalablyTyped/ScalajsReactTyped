...
object Touch1Down {
  ...
  @JSImport("@carbon/icons-react", "Touch1Down")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Touch1Down.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
