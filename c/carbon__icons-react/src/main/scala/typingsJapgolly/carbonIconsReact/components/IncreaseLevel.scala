...
object IncreaseLevel {
  
  @JSImport("@carbon/icons-react", "IncreaseLevel")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: IncreaseLevel.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
