...
object GroupObjects {
  ...
  @JSImport("@carbon/icons-react", "GroupObjects")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: GroupObjects.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
