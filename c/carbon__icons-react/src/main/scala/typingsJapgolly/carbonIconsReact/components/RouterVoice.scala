...
object RouterVoice {
  ...
  @JSImport("@carbon/icons-react", "RouterVoice")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RouterVoice.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
