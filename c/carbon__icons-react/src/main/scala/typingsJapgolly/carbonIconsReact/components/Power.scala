...
object Power {
  ...
  @JSImport("@carbon/icons-react", "Power")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Power.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
