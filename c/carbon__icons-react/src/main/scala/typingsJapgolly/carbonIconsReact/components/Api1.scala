...
object Api1 {
  ...
  @JSImport("@carbon/icons-react", "Api1")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Api1.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
