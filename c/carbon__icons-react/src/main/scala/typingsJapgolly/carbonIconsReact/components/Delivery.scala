...
object Delivery {
  ...
  @JSImport("@carbon/icons-react", "Delivery")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Delivery.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
