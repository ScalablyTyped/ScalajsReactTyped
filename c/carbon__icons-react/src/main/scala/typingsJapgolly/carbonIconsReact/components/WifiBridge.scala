...
object WifiBridge {
  ...
  @JSImport("@carbon/icons-react", "WifiBridge")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WifiBridge.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
