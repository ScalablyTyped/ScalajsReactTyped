...
object AlarmSubtract {
  
  @JSImport("@carbon/icons-react", "AlarmSubtract")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: AlarmSubtract.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
