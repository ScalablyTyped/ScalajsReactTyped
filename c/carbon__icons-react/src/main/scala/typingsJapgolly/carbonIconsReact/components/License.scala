...
object License {
  ...
  @JSImport("@carbon/icons-react", "License")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: License.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
