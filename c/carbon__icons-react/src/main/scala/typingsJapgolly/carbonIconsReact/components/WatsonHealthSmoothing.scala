...
object WatsonHealthSmoothing {
  
  @JSImport("@carbon/icons-react", "WatsonHealthSmoothing")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WatsonHealthSmoothing.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
