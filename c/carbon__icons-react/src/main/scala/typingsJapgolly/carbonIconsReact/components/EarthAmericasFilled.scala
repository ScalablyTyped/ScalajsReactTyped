...
object EarthAmericasFilled {
  
  @JSImport("@carbon/icons-react", "EarthAmericasFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: EarthAmericasFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
