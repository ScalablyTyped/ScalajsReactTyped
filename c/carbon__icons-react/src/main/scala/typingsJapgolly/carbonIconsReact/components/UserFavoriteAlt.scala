...
object UserFavoriteAlt {
  
  @JSImport("@carbon/icons-react", "UserFavoriteAlt")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: UserFavoriteAlt.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
