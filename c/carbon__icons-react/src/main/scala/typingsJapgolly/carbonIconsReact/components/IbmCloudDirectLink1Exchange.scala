...
object IbmCloudDirectLink1Exchange {
  
  @JSImport("@carbon/icons-react", "IbmCloudDirectLink1Exchange")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: IbmCloudDirectLink1Exchange.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
