...
object ForecastHail {
  ...
  @JSImport("@carbon/icons-react", "ForecastHail")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ForecastHail.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
