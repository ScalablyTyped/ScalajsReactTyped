...
object FavoriteHalf {
  ...
  @JSImport("@carbon/icons-react", "FavoriteHalf")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: FavoriteHalf.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
