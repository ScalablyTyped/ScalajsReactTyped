...
object FaceNeutralFilled {
  
  @JSImport("@carbon/icons-react", "FaceNeutralFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: FaceNeutralFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
