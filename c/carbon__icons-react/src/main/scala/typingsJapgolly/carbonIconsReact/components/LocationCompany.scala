...
object LocationCompany {
  
  @JSImport("@carbon/icons-react", "LocationCompany")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LocationCompany.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
