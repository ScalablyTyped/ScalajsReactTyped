...
object Touch1DownFilled {
  
  @JSImport("@carbon/icons-react", "Touch1DownFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Touch1DownFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
