...
object DataBase {
  ...
  @JSImport("@carbon/icons-react", "DataBase")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: DataBase.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
