...
object AccumulationSnow {
  
  @JSImport("@carbon/icons-react", "AccumulationSnow")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: AccumulationSnow.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
