...
object SankeyDiagramAlt {
  
  @JSImport("@carbon/icons-react", "SankeyDiagramAlt")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SankeyDiagramAlt.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
