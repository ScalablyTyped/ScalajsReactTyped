...
object Select02 {
  ...
  @JSImport("@carbon/icons-react", "Select02")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Select02.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
