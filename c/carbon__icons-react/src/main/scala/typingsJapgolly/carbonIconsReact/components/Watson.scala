...
object Watson {
  ...
  @JSImport("@carbon/icons-react", "Watson")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Watson.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
