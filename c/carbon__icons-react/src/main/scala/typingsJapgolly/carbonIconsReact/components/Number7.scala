...
object Number7 {
  ...
  @JSImport("@carbon/icons-react", "Number7")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Number7.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
