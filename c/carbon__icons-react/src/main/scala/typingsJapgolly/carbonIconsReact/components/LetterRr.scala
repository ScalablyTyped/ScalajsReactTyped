...
object LetterRr {
  ...
  @JSImport("@carbon/icons-react", "LetterRr")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LetterRr.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
