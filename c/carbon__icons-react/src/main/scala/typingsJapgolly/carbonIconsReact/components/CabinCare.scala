...
object CabinCare {
  ...
  @JSImport("@carbon/icons-react", "CabinCare")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: CabinCare.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
