...
object IbmWatsonOrders {
  
  @JSImport("@carbon/icons-react", "IbmWatsonOrders")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: IbmWatsonOrders.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
