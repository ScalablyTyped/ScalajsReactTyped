...
object Network3 {
  ...
  @JSImport("@carbon/icons-react", "Network3")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Network3.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
