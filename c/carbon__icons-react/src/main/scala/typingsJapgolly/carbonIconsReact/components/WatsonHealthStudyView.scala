...
object WatsonHealthStudyView {
  
  @JSImport("@carbon/icons-react", "WatsonHealthStudyView")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WatsonHealthStudyView.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
