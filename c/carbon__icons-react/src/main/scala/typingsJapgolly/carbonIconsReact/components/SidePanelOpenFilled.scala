...
object SidePanelOpenFilled {
  
  @JSImport("@carbon/icons-react", "SidePanelOpenFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SidePanelOpenFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
