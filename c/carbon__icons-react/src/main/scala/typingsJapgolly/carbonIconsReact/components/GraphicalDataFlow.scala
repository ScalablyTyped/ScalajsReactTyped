...
object GraphicalDataFlow {
  
  @JSImport("@carbon/icons-react", "GraphicalDataFlow")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: GraphicalDataFlow.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
