...
object WatsonHealthErase3D {
  
  @JSImport("@carbon/icons-react", "WatsonHealthErase3D")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WatsonHealthErase3D.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
