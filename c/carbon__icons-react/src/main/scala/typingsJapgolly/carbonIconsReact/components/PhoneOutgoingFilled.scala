...
object PhoneOutgoingFilled {
  
  @JSImport("@carbon/icons-react", "PhoneOutgoingFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: PhoneOutgoingFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
