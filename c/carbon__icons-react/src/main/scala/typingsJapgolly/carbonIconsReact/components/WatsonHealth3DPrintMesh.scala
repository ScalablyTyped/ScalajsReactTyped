...
object WatsonHealth3DPrintMesh {
  
  @JSImport("@carbon/icons-react", "WatsonHealth3DPrintMesh")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WatsonHealth3DPrintMesh.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
