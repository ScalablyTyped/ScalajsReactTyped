...
object Headphones {
  ...
  @JSImport("@carbon/icons-react", "Headphones")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Headphones.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
