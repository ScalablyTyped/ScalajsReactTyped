...
object WatsonHealth3DSoftware {
  
  @JSImport("@carbon/icons-react", "WatsonHealth3DSoftware")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WatsonHealth3DSoftware.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
