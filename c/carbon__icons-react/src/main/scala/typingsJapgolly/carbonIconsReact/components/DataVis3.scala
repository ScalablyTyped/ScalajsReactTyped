...
object DataVis3 {
  ...
  @JSImport("@carbon/icons-react", "DataVis3")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: DataVis3.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
