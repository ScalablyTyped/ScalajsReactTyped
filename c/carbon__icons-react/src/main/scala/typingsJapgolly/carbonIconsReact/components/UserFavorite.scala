...
object UserFavorite {
  ...
  @JSImport("@carbon/icons-react", "UserFavorite")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: UserFavorite.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
