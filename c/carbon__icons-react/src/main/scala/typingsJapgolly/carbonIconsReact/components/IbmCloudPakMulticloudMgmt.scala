...
object IbmCloudPakMulticloudMgmt {
  
  @JSImport("@carbon/icons-react", "IbmCloudPakMulticloudMgmt")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: IbmCloudPakMulticloudMgmt.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
