...
object SkipBackOutlineSolid {
  
  @JSImport("@carbon/icons-react", "SkipBackOutlineSolid")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SkipBackOutlineSolid.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
