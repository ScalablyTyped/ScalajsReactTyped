...
object ConvertToCloud {
  
  @JSImport("@carbon/icons-react", "ConvertToCloud")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ConvertToCloud.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
