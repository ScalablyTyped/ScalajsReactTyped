...
object WaveDirection {
  
  @JSImport("@carbon/icons-react", "WaveDirection")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WaveDirection.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
