...
object NumberSmall5 {
  ...
  @JSImport("@carbon/icons-react", "NumberSmall5")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NumberSmall5.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
