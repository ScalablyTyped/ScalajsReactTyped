...
object RotateCounterclockwise {
  
  @JSImport("@carbon/icons-react", "RotateCounterclockwise")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RotateCounterclockwise.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
