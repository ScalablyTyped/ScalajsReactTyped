...
object Wmv {
  ...
  @JSImport("@carbon/icons-react", "Wmv")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Wmv.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
