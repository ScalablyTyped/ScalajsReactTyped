...
object TwoFactorAuthentication {
  ...
  @JSImport("@carbon/icons-react", "TwoFactorAuthentication")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: TwoFactorAuthentication.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
