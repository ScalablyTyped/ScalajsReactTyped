...
object VirtualPrivateCloudAlt {
  
  @JSImport("@carbon/icons-react", "VirtualPrivateCloudAlt")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: VirtualPrivateCloudAlt.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
