...
object LocationPersonFilled {
  
  @JSImport("@carbon/icons-react", "LocationPersonFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LocationPersonFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
