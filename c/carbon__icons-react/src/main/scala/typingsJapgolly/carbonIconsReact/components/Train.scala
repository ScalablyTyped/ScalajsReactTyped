...
object Train {
  ...
  @JSImport("@carbon/icons-react", "Train")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Train.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
