...
object RecordingFilledAlt {
  
  @JSImport("@carbon/icons-react", "RecordingFilledAlt")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RecordingFilledAlt.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
