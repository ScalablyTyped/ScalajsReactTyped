...
object CharacterLowerCase {
  
  @JSImport("@carbon/icons-react", "CharacterLowerCase")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: CharacterLowerCase.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
