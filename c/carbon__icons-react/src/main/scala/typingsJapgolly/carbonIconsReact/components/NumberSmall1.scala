...
object NumberSmall1 {
  ...
  @JSImport("@carbon/icons-react", "NumberSmall1")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NumberSmall1.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
