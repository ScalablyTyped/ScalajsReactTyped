...
object UndefinedGlyph {
  
  @JSImport("@carbon/icons-react", "UndefinedGlyph")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: UndefinedGlyph.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
