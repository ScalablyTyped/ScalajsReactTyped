...
object Asterisk {
  ...
  @JSImport("@carbon/icons-react", "Asterisk")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Asterisk.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
