...
object WatsonHealthAiStatusFailed {
  
  @JSImport("@carbon/icons-react", "WatsonHealthAiStatusFailed")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WatsonHealthAiStatusFailed.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
