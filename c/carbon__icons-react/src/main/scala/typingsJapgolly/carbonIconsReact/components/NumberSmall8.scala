...
object NumberSmall8 {
  ...
  @JSImport("@carbon/icons-react", "NumberSmall8")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NumberSmall8.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
