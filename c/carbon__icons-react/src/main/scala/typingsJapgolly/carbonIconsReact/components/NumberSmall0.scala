...
object NumberSmall0 {
  ...
  @JSImport("@carbon/icons-react", "NumberSmall0")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NumberSmall0.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
