...
object NumberSmall2 {
  ...
  @JSImport("@carbon/icons-react", "NumberSmall2")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NumberSmall2.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
