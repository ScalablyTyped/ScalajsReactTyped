...
object Unlocked {
  ...
  @JSImport("@carbon/icons-react", "Unlocked")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Unlocked.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
