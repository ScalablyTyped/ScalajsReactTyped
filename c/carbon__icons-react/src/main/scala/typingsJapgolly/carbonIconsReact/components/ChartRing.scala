...
object ChartRing {
  ...
  @JSImport("@carbon/icons-react", "ChartRing")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ChartRing.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
