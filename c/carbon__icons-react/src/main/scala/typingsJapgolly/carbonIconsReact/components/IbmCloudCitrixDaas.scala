...
object IbmCloudCitrixDaas {
  
  @JSImport("@carbon/icons-react", "IbmCloudCitrixDaas")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: IbmCloudCitrixDaas.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
