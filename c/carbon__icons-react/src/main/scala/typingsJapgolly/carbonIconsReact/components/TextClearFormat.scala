...
object TextClearFormat {
  
  @JSImport("@carbon/icons-react", "TextClearFormat")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: TextClearFormat.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
