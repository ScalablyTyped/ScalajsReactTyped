...
object MicrophoneOffFilled {
  
  @JSImport("@carbon/icons-react", "MicrophoneOffFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: MicrophoneOffFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
