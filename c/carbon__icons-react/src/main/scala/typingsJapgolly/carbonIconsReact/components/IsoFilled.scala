...
object IsoFilled {
  ...
  @JSImport("@carbon/icons-react", "IsoFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: IsoFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
