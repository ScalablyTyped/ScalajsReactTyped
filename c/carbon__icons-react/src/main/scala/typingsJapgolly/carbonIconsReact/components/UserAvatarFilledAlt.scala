...
object UserAvatarFilledAlt {
  
  @JSImport("@carbon/icons-react", "UserAvatarFilledAlt")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: UserAvatarFilledAlt.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
