...
object WatsonHealthStatusPartialFail {
  
  @JSImport("@carbon/icons-react", "WatsonHealthStatusPartialFail")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WatsonHealthStatusPartialFail.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
