...
object App {
  ...
  @JSImport("@carbon/icons-react", "App")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: App.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
