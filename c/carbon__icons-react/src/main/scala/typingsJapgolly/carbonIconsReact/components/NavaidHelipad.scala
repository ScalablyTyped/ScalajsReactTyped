...
object NavaidHelipad {
  
  @JSImport("@carbon/icons-react", "NavaidHelipad")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NavaidHelipad.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
