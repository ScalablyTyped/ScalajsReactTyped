...
object Erase {
  ...
  @JSImport("@carbon/icons-react", "Erase")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Erase.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
