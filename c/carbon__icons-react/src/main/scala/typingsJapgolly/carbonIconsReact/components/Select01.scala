...
object Select01 {
  ...
  @JSImport("@carbon/icons-react", "Select01")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Select01.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
