...
object PreviousFilled {
  
  @JSImport("@carbon/icons-react", "PreviousFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: PreviousFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
