...
object Microservices1 {
  
  @JSImport("@carbon/icons-react", "Microservices1")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Microservices1.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
