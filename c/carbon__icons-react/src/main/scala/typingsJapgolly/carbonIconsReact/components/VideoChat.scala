...
object VideoChat {
  ...
  @JSImport("@carbon/icons-react", "VideoChat")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: VideoChat.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
