...
object Touch1Filled {
  ...
  @JSImport("@carbon/icons-react", "Touch1Filled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Touch1Filled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
