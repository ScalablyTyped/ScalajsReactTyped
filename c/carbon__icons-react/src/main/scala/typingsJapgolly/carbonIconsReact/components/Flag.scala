...
object Flag {
  ...
  @JSImport("@carbon/icons-react", "Flag")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Flag.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
