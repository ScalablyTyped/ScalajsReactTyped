...
object CheckmarkFilledWarning {
  
  @JSImport("@carbon/icons-react", "CheckmarkFilledWarning")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: CheckmarkFilledWarning.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
