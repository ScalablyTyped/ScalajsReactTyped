...
object BoxMedium {
  ...
  @JSImport("@carbon/icons-react", "BoxMedium")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: BoxMedium.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
