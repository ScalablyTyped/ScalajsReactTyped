...
object ServerDns {
  ...
  @JSImport("@carbon/icons-react", "ServerDns")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ServerDns.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
