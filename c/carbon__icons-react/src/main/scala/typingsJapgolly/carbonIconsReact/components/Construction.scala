...
object Construction {
  ...
  @JSImport("@carbon/icons-react", "Construction")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Construction.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
