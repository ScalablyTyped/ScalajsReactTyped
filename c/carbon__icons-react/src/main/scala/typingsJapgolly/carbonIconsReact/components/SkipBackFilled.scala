...
object SkipBackFilled {
  
  @JSImport("@carbon/icons-react", "SkipBackFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SkipBackFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
