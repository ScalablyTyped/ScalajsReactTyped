...
object WatsonHealthStudyTransfer {
  
  @JSImport("@carbon/icons-react", "WatsonHealthStudyTransfer")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WatsonHealthStudyTransfer.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
