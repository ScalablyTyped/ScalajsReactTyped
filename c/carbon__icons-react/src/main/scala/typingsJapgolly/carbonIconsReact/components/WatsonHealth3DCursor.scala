...
object WatsonHealth3DCursor {
  
  @JSImport("@carbon/icons-react", "WatsonHealth3DCursor")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WatsonHealth3DCursor.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
