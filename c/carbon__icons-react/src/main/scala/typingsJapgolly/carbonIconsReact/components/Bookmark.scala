...
object Bookmark {
  ...
  @JSImport("@carbon/icons-react", "Bookmark")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Bookmark.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
