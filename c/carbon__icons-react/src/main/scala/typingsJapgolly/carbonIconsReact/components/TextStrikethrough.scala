...
object TextStrikethrough {
  
  @JSImport("@carbon/icons-react", "TextStrikethrough")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: TextStrikethrough.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
