...
object Number9 {
  ...
  @JSImport("@carbon/icons-react", "Number9")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Number9.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
