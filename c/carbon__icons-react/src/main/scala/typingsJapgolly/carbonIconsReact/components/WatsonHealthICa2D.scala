...
object WatsonHealthICa2D {
  
  @JSImport("@carbon/icons-react", "WatsonHealthICa2D")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WatsonHealthICa2D.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
