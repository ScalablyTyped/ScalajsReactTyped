...
object NextOutline {
  ...
  @JSImport("@carbon/icons-react", "NextOutline")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: NextOutline.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
