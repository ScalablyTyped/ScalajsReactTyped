...
object EditOff {
  ...
  @JSImport("@carbon/icons-react", "EditOff")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: EditOff.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
