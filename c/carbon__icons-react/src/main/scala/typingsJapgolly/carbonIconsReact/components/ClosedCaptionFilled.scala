...
object ClosedCaptionFilled {
  
  @JSImport("@carbon/icons-react", "ClosedCaptionFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ClosedCaptionFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
