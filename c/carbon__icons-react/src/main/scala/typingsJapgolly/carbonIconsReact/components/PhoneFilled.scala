...
object PhoneFilled {
  ...
  @JSImport("@carbon/icons-react", "PhoneFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: PhoneFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
