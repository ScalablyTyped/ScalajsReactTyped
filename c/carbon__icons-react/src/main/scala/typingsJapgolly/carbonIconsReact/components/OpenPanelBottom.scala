...
object OpenPanelBottom {
  
  @JSImport("@carbon/icons-react", "OpenPanelBottom")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: OpenPanelBottom.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
