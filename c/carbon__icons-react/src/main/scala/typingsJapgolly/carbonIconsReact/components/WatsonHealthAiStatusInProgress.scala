...
object WatsonHealthAiStatusInProgress {
  
  @JSImport("@carbon/icons-react", "WatsonHealthAiStatusInProgress")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: WatsonHealthAiStatusInProgress.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
