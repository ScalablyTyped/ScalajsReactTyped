...
object Apple {
  ...
  @JSImport("@carbon/icons-react", "Apple")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Apple.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
