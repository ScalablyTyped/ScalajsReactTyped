...
object BareMetalServer02 {
  
  @JSImport("@carbon/icons-react", "BareMetalServer02")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: BareMetalServer02.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
