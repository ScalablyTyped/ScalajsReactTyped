...
object Network4Reference {
  
  @JSImport("@carbon/icons-react", "Network4Reference")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Network4Reference.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
