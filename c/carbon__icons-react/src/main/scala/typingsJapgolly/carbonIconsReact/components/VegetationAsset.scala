...
object VegetationAsset {
  
  @JSImport("@carbon/icons-react", "VegetationAsset")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: VegetationAsset.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
