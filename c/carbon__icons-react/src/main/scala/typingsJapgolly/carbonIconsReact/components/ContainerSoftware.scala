...
object ContainerSoftware {
  
  @JSImport("@carbon/icons-react", "ContainerSoftware")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ContainerSoftware.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
