...
object LogoGithub {
  ...
  @JSImport("@carbon/icons-react", "LogoGithub")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LogoGithub.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
