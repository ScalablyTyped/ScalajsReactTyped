...
object SoilTemperatureField {
  
  @JSImport("@carbon/icons-react", "SoilTemperatureField")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: SoilTemperatureField.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
