...
object OperationsRecord {
  
  @JSImport("@carbon/icons-react", "OperationsRecord")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: OperationsRecord.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
