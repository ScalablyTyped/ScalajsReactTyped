...
object IbmZCloudModStack {
  
  @JSImport("@carbon/icons-react", "IbmZCloudModStack")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: IbmZCloudModStack.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
