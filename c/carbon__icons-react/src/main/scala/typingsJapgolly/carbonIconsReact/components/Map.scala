...
object Map {
  ...
  @JSImport("@carbon/icons-react", "Map")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Map.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
