...
object Carbon {
  ...
  @JSImport("@carbon/icons-react", "Carbon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Carbon.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
