...
object Bat {
  ...
  @JSImport("@carbon/icons-react", "Bat")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Bat.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
