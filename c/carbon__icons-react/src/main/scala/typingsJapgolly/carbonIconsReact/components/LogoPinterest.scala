...
object LogoPinterest {
  
  @JSImport("@carbon/icons-react", "LogoPinterest")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LogoPinterest.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
