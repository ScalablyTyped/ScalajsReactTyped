...
object TextLinkAnalysis {
  
  @JSImport("@carbon/icons-react", "TextLinkAnalysis")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: TextLinkAnalysis.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
