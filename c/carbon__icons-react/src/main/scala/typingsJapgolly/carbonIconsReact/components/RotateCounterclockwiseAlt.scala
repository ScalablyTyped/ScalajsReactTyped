...
object RotateCounterclockwiseAlt {
  
  @JSImport("@carbon/icons-react", "RotateCounterclockwiseAlt")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: RotateCounterclockwiseAlt.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
