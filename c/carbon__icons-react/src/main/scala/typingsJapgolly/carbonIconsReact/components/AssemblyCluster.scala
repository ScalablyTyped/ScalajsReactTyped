...
object AssemblyCluster {
  
  @JSImport("@carbon/icons-react", "AssemblyCluster")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: AssemblyCluster.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
