...
object Home {
  ...
  @JSImport("@carbon/icons-react", "Home")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Home.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
