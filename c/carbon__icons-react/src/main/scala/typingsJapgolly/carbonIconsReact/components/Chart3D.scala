...
object Chart3D {
  ...
  @JSImport("@carbon/icons-react", "Chart3D")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Chart3D.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
