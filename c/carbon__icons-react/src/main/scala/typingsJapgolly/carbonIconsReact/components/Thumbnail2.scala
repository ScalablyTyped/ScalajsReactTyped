...
object Thumbnail2 {
  ...
  @JSImport("@carbon/icons-react", "Thumbnail2")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Thumbnail2.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
