...
object CheckmarkFilledError {
  
  @JSImport("@carbon/icons-react", "CheckmarkFilledError")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: CheckmarkFilledError.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
