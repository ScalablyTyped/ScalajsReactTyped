...
object Microservices2 {
  
  @JSImport("@carbon/icons-react", "Microservices2")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Microservices2.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
