...
object IbmSecurityServices {
  
  @JSImport("@carbon/icons-react", "IbmSecurityServices")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: IbmSecurityServices.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
