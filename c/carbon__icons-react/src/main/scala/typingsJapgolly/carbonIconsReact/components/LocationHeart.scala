...
object LocationHeart {
  
  @JSImport("@carbon/icons-react", "LocationHeart")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: LocationHeart.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
