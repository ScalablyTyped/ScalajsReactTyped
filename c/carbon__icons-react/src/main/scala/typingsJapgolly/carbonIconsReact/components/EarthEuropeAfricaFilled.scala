...
object EarthEuropeAfricaFilled {
  
  @JSImport("@carbon/icons-react", "EarthEuropeAfricaFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: EarthEuropeAfricaFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
