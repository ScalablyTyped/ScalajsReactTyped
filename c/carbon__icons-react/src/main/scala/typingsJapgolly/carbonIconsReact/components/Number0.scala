...
object Number0 {
  ...
  @JSImport("@carbon/icons-react", "Number0")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Number0.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
