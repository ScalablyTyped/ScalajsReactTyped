...
object DirectionRotaryRightFilled {
  
  @JSImport("@carbon/icons-react", "DirectionRotaryRightFilled")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: DirectionRotaryRightFilled.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
