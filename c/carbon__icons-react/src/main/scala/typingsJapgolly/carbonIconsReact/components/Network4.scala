...
object Network4 {
  ...
  @JSImport("@carbon/icons-react", "Network4")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Network4.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
