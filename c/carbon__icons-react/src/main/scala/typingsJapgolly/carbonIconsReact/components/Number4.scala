...
object Number4 {
  ...
  @JSImport("@carbon/icons-react", "Number4")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Number4.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
