...
object Bullhorn {
  ...
  @JSImport("@carbon/icons-react", "Bullhorn")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Bullhorn.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
