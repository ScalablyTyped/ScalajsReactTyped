...
object CalendarHeatMap {
  
  @JSImport("@carbon/icons-react", "CalendarHeatMap")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: CalendarHeatMap.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
