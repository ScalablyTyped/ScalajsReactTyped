...
object Forward10 {
  ...
  @JSImport("@carbon/icons-react", "Forward10")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Forward10.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
