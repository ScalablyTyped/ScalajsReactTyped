...
object ForecastLightning30 {
  
  @JSImport("@carbon/icons-react", "ForecastLightning30")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ForecastLightning30.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
