...
object Add {
  ...
  @JSImport("@carbon/icons-react", "Add")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Add.type): SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement] = new SharedBuilder_CarbonIconPropsRefAttributes_759481778[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
