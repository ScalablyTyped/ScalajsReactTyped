...
import typingsJapgolly.cloudflare.anon.Actions
...
object PageRules {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(add = js.Any.fromFunction1(add), browse = browse.toJsFn, del = js.Any.fromFunction1(del), edit = js.Any.fromFunction2(edit), read = js.Any.fromFunction1(read))
