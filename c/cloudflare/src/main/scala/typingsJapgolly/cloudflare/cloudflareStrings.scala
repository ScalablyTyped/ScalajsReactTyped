package typingsJapgolly.cloudflare

import typingsJapgolly.cloudflare.mod.RecordTypes
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object cloudflareStrings {
  ...
  sealed trait SMIMEA
    extends StObject
       with RecordTypes
  inline def SMIMEA: SMIMEA = "SMIMEA".asInstanceOf[SMIMEA]
  ...
  sealed trait SVCB
    extends StObject
       with RecordTypes
  inline def SVCB: SVCB = "SVCB".asInstanceOf[SVCB]
  ...
  @js.native
  sealed trait `URI read only`
    extends StObject
       with RecordTypes
  inline def `URI read only`: `URI read only` = ("URI read only").asInstanceOf[`URI read only`]
