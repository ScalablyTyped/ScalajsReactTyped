...
import typingsJapgolly.countryjs.anon.Alpha2
import typingsJapgolly.countryjs.anon.De
import typingsJapgolly.countryjs.countryjsStrings.ISO2
import typingsJapgolly.countryjs.countryjsStrings.ISO3
import typingsJapgolly.countryjs.countryjsStrings.name
...
object mod {
  ...
  inline def name(name: String, mode: ISO2 | ISO3 | typingsJapgolly.countryjs.countryjsStrings.name): js.UndefOr[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("name")(name.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[String]]
