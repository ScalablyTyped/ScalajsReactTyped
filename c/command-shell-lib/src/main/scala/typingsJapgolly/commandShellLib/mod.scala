package typingsJapgolly.commandShellLib
...
object mod {
  ...
  object Command {
    ...
    inline def apply(description: String, handler: js.Array[String] => Callback, parameters: js.Array[String]): Command = {
      val __obj = js.Dynamic.literal(description = description.asInstanceOf[js.Any], handler = js.Any.fromFunction1((t0: js.Array[String]) => handler(t0).runNow()), parameters = parameters.asInstanceOf[js.Any])
    ...
    extension [Self <: Command](x: Self) {
      ...
      inline def setHandler(value: js.Array[String] => Callback): Self = StObject.set(x, "handler", js.Any.fromFunction1((t0: js.Array[String]) => value(t0).runNow()))
