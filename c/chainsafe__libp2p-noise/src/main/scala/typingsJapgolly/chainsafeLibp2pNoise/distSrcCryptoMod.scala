...
import typingsJapgolly.chainsafeLibp2pNoise.distSrcHandshakeMod.Hkdf
...
object distSrcCryptoMod {
  ...
  object ICryptoInterface {
    ...
    inline def apply(
      ...
      generateX25519KeyPair: CallbackTo[KeyPair],
    ...
    extension [Self <: ICryptoInterface](x: Self) {
      ...
      inline def setGenerateX25519KeyPair(value: CallbackTo[KeyPair]): Self = StObject.set(x, "generateX25519KeyPair", value.toJsFn)
