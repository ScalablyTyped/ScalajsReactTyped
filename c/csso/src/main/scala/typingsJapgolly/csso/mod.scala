...
import typingsJapgolly.csso.anon.Classes
...
object mod {
  ...
  object MinifyOptions {
    ...
    extension [Self <: MinifyOptions](x: Self) {
      ...
      inline def setAfterCompressFunction2(value: (/* compressResult */ String, /* options */ CompressOptions) => Callback): Self = StObject.set(x, "afterCompress", js.Any.fromFunction2((t0: /* compressResult */ String, t1: /* options */ CompressOptions) => (value(t0, t1)).runNow()))
      ...
      inline def setBeforeCompressFunction2(value: (/* ast */ js.Object, /* options */ CompressOptions) => Callback): Self = StObject.set(x, "beforeCompress", js.Any.fromFunction2((t0: /* ast */ js.Object, t1: /* options */ CompressOptions) => (value(t0, t1)).runNow()))
