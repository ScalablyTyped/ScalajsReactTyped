...
object typesLibTaggedMod {
  ...
  object Tagged {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(convert = js.Any.fromFunction1(convert), encodeCBOR = js.Any.fromFunction1(encodeCBOR), err = err.asInstanceOf[js.Any], tag = tag.asInstanceOf[js.Any], toJSON = toJSON.toJsFn, value = value.asInstanceOf[js.Any])
