...
import typingsJapgolly.cbor.anon.Indefinite
import typingsJapgolly.cbor.cborStrings.float
import typingsJapgolly.cbor.cborStrings.int
import typingsJapgolly.cbor.cborStrings.number
import typingsJapgolly.cbor.cborStrings.string
...
object typesLibEncoderMod {
  ...
  /**
    ...
    */
  /* static member */
  inline def pushNoFilter(gen: Encoder, obj: typingsJapgolly.nofilter.mod.^): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("_pushNoFilter")(gen.asInstanceOf[js.Any], obj.asInstanceOf[js.Any])).asInstanceOf[Boolean]
