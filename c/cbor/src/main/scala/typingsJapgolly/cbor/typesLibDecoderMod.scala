...
import typingsJapgolly.cbor.typesLibTaggedMod.TagFunction
import typingsJapgolly.cbor.typesLibTaggedMod.TagMap
...
object typesLibDecoderMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    var valueBytes: typingsJapgolly.nofilter.mod.^ = js.native
  }
  @JSImport("cbor/types/lib/decoder", JSImport.Namespace)
  @js.native
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify BinaryParseStream * / any */ trait Decoder extends StObject {
    ...
    var valueBytes: typingsJapgolly.nofilter.mod.^
  }
  object Decoder {
    
    inline def apply(
      _onRead: Any => Callback,
      close: Callback,
    ...
    extension [Self <: Decoder](x: Self) {
      ...
      inline def setValueBytes(value: typingsJapgolly.nofilter.mod.^): Self = StObject.set(x, "valueBytes", value.asInstanceOf[js.Any])
      
      inline def set_onRead(value: Any => Callback): Self = StObject.set(x, "_onRead", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
    }
  }
