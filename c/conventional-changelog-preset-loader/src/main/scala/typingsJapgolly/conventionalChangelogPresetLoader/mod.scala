package typingsJapgolly.conventionalChangelogPresetLoader

import typingsJapgolly.conventionalChangelogWriter.mod.Context
...
object mod {
  ...
  /**
    ...
    * @param path
    */
  inline def apply(path: String): typingsJapgolly.conventionalChangelogCore.mod.Options.Config[Commit[String | Double | js.Symbol], Context] = ^.asInstanceOf[js.Dynamic].apply(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.conventionalChangelogCore.mod.Options.Config[Commit[String | Double | js.Symbol], Context]]
  inline def apply(path: Config): typingsJapgolly.conventionalChangelogCore.mod.Options.Config[Commit[String | Double | js.Symbol], Context] = ^.asInstanceOf[js.Dynamic].apply(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.conventionalChangelogCore.mod.Options.Config[Commit[String | Double | js.Symbol], Context]]
  ...
  type Builder = js.Function1[
    ...
    typingsJapgolly.conventionalChangelogCore.mod.Options.Config[Commit[String | Double | js.Symbol], Context]
  ]
