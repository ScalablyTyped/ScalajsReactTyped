package typingsJapgolly.cordovaPluginMsAdal
  ...
  object ADAL {
    ...
    object AuthenticationResult {
      ...
      inline def apply(
        ...
        createAuthorizationHeader: CallbackTo[String],
        expiresOn: js.Date,
        idToken: String,
        ...
        val __obj = js.Dynamic.literal(accessToken = accessToken.asInstanceOf[js.Any], accessTokenType = accessTokenType.asInstanceOf[js.Any], createAuthorizationHeader = createAuthorizationHeader.toJsFn, expiresOn = expiresOn.asInstanceOf[js.Any], idToken = idToken.asInstanceOf[js.Any], isMultipleResourceRefreshToken = isMultipleResourceRefreshToken.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any], statusCode = statusCode.asInstanceOf[js.Any], tenantId = tenantId.asInstanceOf[js.Any], userInfo = userInfo.asInstanceOf[js.Any])
      ...
      extension [Self <: AuthenticationResult](x: Self) {
        ...
        inline def setCreateAuthorizationHeader(value: CallbackTo[String]): Self = StObject.set(x, "createAuthorizationHeader", value.toJsFn)
    ...
    object TokenCache {
      ...
      inline def apply(
        clear: CallbackTo[Promise],
        contextAuthority: String,
        deleteItem: TokenCacheItem => Promise,
        readItems: CallbackTo[PromiseTokenCacheItems]
      ): TokenCache = {
        val __obj = js.Dynamic.literal(clear = clear.toJsFn, contextAuthority = contextAuthority.asInstanceOf[js.Any], deleteItem = js.Any.fromFunction1(deleteItem), readItems = readItems.toJsFn)
        __obj.asInstanceOf[TokenCache]
      }
      
      extension [Self <: TokenCache](x: Self) {
        
        inline def setClear(value: CallbackTo[Promise]): Self = StObject.set(x, "clear", value.toJsFn)
        ...
        inline def setReadItems(value: CallbackTo[PromiseTokenCacheItems]): Self = StObject.set(x, "readItems", value.toJsFn)
      }
    }
