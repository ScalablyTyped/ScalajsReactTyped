...
import typingsJapgolly.ckeditorCkeditor5Highlight.anon.Bluemarker
...
object srcHighlightuiMod {
  ...
  object ckeditorCkeditor5CoreSrcPlugincollectionAugmentingMod {
    ...
    trait Plugins extends StObject {
      ...
      var HighlightUI: typingsJapgolly.ckeditorCkeditor5Highlight.srcHighlightuiMod.HighlightUI
    }
    object Plugins {
