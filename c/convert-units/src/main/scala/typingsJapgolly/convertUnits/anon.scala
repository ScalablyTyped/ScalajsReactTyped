...
object anon {
  ...
  object Abbr {
    ...
    inline def apply[T /* <: Unit */](
      abbr: T,
      measure: typingsJapgolly.convertUnits.mod.Measure,
      system: typingsJapgolly.convertUnits.mod.System,
      unit: Name
    ): Abbr[T] = {
    ...
    extension [Self <: Abbr[?], T /* <: Unit */](x: Self & Abbr[T]) {
      ...
      inline def setMeasure(value: typingsJapgolly.convertUnits.mod.Measure): Self = StObject.set(x, "measure", value.asInstanceOf[js.Any])
      
      inline def setSystem(value: typingsJapgolly.convertUnits.mod.System): Self = StObject.set(x, "system", value.asInstanceOf[js.Any])
