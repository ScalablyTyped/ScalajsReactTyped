...
import typingsJapgolly.cypressImageSnapshot.anon.Counter
import typingsJapgolly.cypressImageSnapshot.anon.Height
import typingsJapgolly.cypressImageSnapshot.anon.IncludeAA
import typingsJapgolly.cypressImageSnapshot.cypressImageSnapshotStrings.fullPage
import typingsJapgolly.cypressImageSnapshot.cypressImageSnapshotStrings.horizontal
import typingsJapgolly.cypressImageSnapshot.cypressImageSnapshotStrings.percent
import typingsJapgolly.cypressImageSnapshot.cypressImageSnapshotStrings.pixel
import typingsJapgolly.cypressImageSnapshot.cypressImageSnapshotStrings.pixelmatch
import typingsJapgolly.cypressImageSnapshot.cypressImageSnapshotStrings.runner
import typingsJapgolly.cypressImageSnapshot.cypressImageSnapshotStrings.ssim
import typingsJapgolly.cypressImageSnapshot.cypressImageSnapshotStrings.vertical
import typingsJapgolly.cypressImageSnapshot.cypressImageSnapshotStrings.viewport
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setAfterScreenshot(value: /* doc */ Document => Callback): Self = StObject.set(x, "afterScreenshot", js.Any.fromFunction1((t0: /* doc */ Document) => value(t0).runNow()))
      ...
      inline def setBeforeScreenshot(value: /* doc */ Document => Callback): Self = StObject.set(x, "beforeScreenshot", js.Any.fromFunction1((t0: /* doc */ Document) => value(t0).runNow()))
