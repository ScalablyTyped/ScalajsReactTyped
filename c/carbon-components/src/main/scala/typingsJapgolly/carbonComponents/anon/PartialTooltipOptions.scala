...
trait PartialTooltipOptions extends StObject {
  ...
  var objMenuOffset: js.UndefOr[
    js.Function2[
      /* menuBody */ org.scalajs.dom.Element, 
...
object PartialTooltipOptions {
  ...
  extension [Self <: PartialTooltipOptions](x: Self) {
    ...
    inline def setObjMenuOffset(value: (/* menuBody */ org.scalajs.dom.Element, /* menuDirection */ String) => js.UndefOr[Dictx]): Self = StObject.set(x, "objMenuOffset", js.Any.fromFunction2(value))
