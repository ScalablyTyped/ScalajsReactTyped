...
import typingsJapgolly.carbonComponents.anon.MatchesNavSubmenu
import typingsJapgolly.carbonComponents.anon.PartialNavigationMenuOpti
import typingsJapgolly.carbonComponents.componentsUiShellNavigationMenuPanelMod.NavigationMenuPanelOptions
...
object componentsUiShellNavigationMenuMod {
  ...
  trait NavigationMenu
    extends typingsJapgolly.carbonComponents.componentsUiShellNavigationMenuPanelMod.default {
