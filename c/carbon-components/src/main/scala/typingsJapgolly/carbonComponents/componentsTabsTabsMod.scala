...
import typingsJapgolly.carbonComponents.anon.Item
import typingsJapgolly.carbonComponents.anon.PartialTabOptions
import typingsJapgolly.carbonComponents.componentsContentSwitcherContentSwitcherMod.ContentSwitcherOptions
...
object componentsTabsTabsMod {
  ...
  @js.native
  trait Tab
    extends typingsJapgolly.carbonComponents.componentsContentSwitcherContentSwitcherMod.default {
