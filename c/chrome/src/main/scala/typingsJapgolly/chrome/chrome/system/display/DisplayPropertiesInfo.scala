...
import typingsJapgolly.chrome.chromeNumbers.`0`
import typingsJapgolly.chrome.chromeNumbers.`180`
import typingsJapgolly.chrome.chromeNumbers.`270`
import typingsJapgolly.chrome.chromeNumbers.`90`
