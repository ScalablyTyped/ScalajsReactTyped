...
object cookies {
  ...
  object CookieChangeInfo {
    ...
    inline def apply(cause: String, cookie: Cookie, removed: Boolean): CookieChangeInfo = {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chrome.chromeStrings.unspecified
    - typingsJapgolly.chrome.chromeStrings.no_restriction
    - typingsJapgolly.chrome.chromeStrings.lax
    - typingsJapgolly.chrome.chromeStrings.strict
  */
  trait SameSiteStatus extends StObject
  object SameSiteStatus {
    
    inline def lax: typingsJapgolly.chrome.chromeStrings.lax = "lax".asInstanceOf[typingsJapgolly.chrome.chromeStrings.lax]
    
    inline def no_restriction: typingsJapgolly.chrome.chromeStrings.no_restriction = "no_restriction".asInstanceOf[typingsJapgolly.chrome.chromeStrings.no_restriction]
    
    inline def strict: typingsJapgolly.chrome.chromeStrings.strict = "strict".asInstanceOf[typingsJapgolly.chrome.chromeStrings.strict]
    
    inline def unspecified: typingsJapgolly.chrome.chromeStrings.unspecified = "unspecified".asInstanceOf[typingsJapgolly.chrome.chromeStrings.unspecified]
  }
