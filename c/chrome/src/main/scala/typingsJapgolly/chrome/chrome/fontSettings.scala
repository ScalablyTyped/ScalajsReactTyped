...
import typingsJapgolly.chrome.chromeStrings.cursive
import typingsJapgolly.chrome.chromeStrings.fantasy
import typingsJapgolly.chrome.chromeStrings.fixed
import typingsJapgolly.chrome.chromeStrings.sansserif
import typingsJapgolly.chrome.chromeStrings.serif
import typingsJapgolly.chrome.chromeStrings.standard
