...
import typingsJapgolly.chrome.chromeStrings.app
import typingsJapgolly.chrome.chromeStrings.complete
import typingsJapgolly.chrome.chromeStrings.devtools
import typingsJapgolly.chrome.chromeStrings.loading
import typingsJapgolly.chrome.chromeStrings.normal
import typingsJapgolly.chrome.chromeStrings.panel
import typingsJapgolly.chrome.chromeStrings.popup
