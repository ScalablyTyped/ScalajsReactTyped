...
import typingsJapgolly.chrome.chromeStrings.CENTER
import typingsJapgolly.chrome.chromeStrings.CENTER_CROPPED
import typingsJapgolly.chrome.chromeStrings.STRETCH
