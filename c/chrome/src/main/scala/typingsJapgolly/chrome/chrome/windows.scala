...
object windows {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.chrome.chromeStrings.popup
    - typingsJapgolly.chrome.chromeStrings.panel
  */
  ...
  object createTypeEnum {
    ...
    inline def panel: typingsJapgolly.chrome.chromeStrings.panel = "panel".asInstanceOf[typingsJapgolly.chrome.chromeStrings.panel]
    
    inline def popup: typingsJapgolly.chrome.chromeStrings.popup = "popup".asInstanceOf[typingsJapgolly.chrome.chromeStrings.popup]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chrome.chromeStrings.normal
    - typingsJapgolly.chrome.chromeStrings.minimized
    - typingsJapgolly.chrome.chromeStrings.maximized
    - typingsJapgolly.chrome.chromeStrings.fullscreen
    - typingsJapgolly.chrome.chromeStrings.`locked-fullscreen`
  */
  trait windowStateEnum extends StObject
  object windowStateEnum {
    
    inline def fullscreen: typingsJapgolly.chrome.chromeStrings.fullscreen = "fullscreen".asInstanceOf[typingsJapgolly.chrome.chromeStrings.fullscreen]
    
    inline def `locked-fullscreen`: typingsJapgolly.chrome.chromeStrings.`locked-fullscreen` = "locked-fullscreen".asInstanceOf[typingsJapgolly.chrome.chromeStrings.`locked-fullscreen`]
    
    inline def maximized: typingsJapgolly.chrome.chromeStrings.maximized = "maximized".asInstanceOf[typingsJapgolly.chrome.chromeStrings.maximized]
    
    inline def minimized: typingsJapgolly.chrome.chromeStrings.minimized = "minimized".asInstanceOf[typingsJapgolly.chrome.chromeStrings.minimized]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.chrome.chromeStrings.popup
    - typingsJapgolly.chrome.chromeStrings.panel
    - typingsJapgolly.chrome.chromeStrings.app
    - typingsJapgolly.chrome.chromeStrings.devtools
  */
  trait windowTypeEnum extends StObject
  object windowTypeEnum {
    
    inline def app: typingsJapgolly.chrome.chromeStrings.app = "app".asInstanceOf[typingsJapgolly.chrome.chromeStrings.app]
    
    inline def devtools: typingsJapgolly.chrome.chromeStrings.devtools = "devtools".asInstanceOf[typingsJapgolly.chrome.chromeStrings.devtools]
