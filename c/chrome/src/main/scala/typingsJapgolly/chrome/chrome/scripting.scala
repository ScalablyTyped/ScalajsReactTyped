...
import typingsJapgolly.chrome.anon.ArgsFunc
import typingsJapgolly.chrome.anon.Func
import typingsJapgolly.chrome.anon.Target
import typingsJapgolly.chrome.anon.filesArraystringtargetInj
...
object scripting {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chrome.chromeStrings.ISOLATED
    - typingsJapgolly.chrome.chromeStrings.MAIN
  */
  trait ExecutionWorld extends StObject
  object ExecutionWorld {
    
    inline def ISOLATED: typingsJapgolly.chrome.chromeStrings.ISOLATED = "ISOLATED".asInstanceOf[typingsJapgolly.chrome.chromeStrings.ISOLATED]
    
    inline def MAIN: typingsJapgolly.chrome.chromeStrings.MAIN = "MAIN".asInstanceOf[typingsJapgolly.chrome.chromeStrings.MAIN]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chrome.chromeStrings.AUTHOR
    - typingsJapgolly.chrome.chromeStrings.USER
  */
  trait StyleOrigin extends StObject
  object StyleOrigin {
    
    inline def AUTHOR: typingsJapgolly.chrome.chromeStrings.AUTHOR = "AUTHOR".asInstanceOf[typingsJapgolly.chrome.chromeStrings.AUTHOR]
    
    inline def USER: typingsJapgolly.chrome.chromeStrings.USER = "USER".asInstanceOf[typingsJapgolly.chrome.chromeStrings.USER]
  }
}
