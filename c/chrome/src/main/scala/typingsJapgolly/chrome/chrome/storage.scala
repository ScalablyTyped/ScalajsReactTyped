...
object storage {
  ...
  /* keyof chrome.anon.TRUSTEDANDUNTRUSTEDCONTEXTS */ /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chrome.chromeStrings.TRUSTED_AND_UNTRUSTED_CONTEXTS
    - typingsJapgolly.chrome.chromeStrings.TRUSTED_CONTEXTS
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chrome.chromeStrings.sync
    - typingsJapgolly.chrome.chromeStrings.local
    - typingsJapgolly.chrome.chromeStrings.managed
    - typingsJapgolly.chrome.chromeStrings.session
  */
  trait AreaName extends StObject
  object AreaName {
    
    inline def local: typingsJapgolly.chrome.chromeStrings.local = "local".asInstanceOf[typingsJapgolly.chrome.chromeStrings.local]
    
    inline def managed: typingsJapgolly.chrome.chromeStrings.managed = "managed".asInstanceOf[typingsJapgolly.chrome.chromeStrings.managed]
    
    inline def session: typingsJapgolly.chrome.chromeStrings.session = "session".asInstanceOf[typingsJapgolly.chrome.chromeStrings.session]
    
    inline def sync: typingsJapgolly.chrome.chromeStrings.sync = "sync".asInstanceOf[typingsJapgolly.chrome.chromeStrings.sync]
  }
