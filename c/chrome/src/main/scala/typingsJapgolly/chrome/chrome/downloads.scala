...
import typingsJapgolly.chrome.chromeInts.`16`
import typingsJapgolly.chrome.chromeInts.`32`
import typingsJapgolly.chrome.chromeStrings.GET
import typingsJapgolly.chrome.chromeStrings.POST
...
object downloads {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chrome.chromeStrings.file
    - typingsJapgolly.chrome.chromeStrings.url
    - typingsJapgolly.chrome.chromeStrings.content
    - typingsJapgolly.chrome.chromeStrings.uncommon
    - typingsJapgolly.chrome.chromeStrings.host
    - typingsJapgolly.chrome.chromeStrings.unwanted
    - typingsJapgolly.chrome.chromeStrings.safe
    - typingsJapgolly.chrome.chromeStrings.accepted
  */
  trait DangerType extends StObject
  object DangerType {
    
    inline def accepted: typingsJapgolly.chrome.chromeStrings.accepted = "accepted".asInstanceOf[typingsJapgolly.chrome.chromeStrings.accepted]
    
    inline def content: typingsJapgolly.chrome.chromeStrings.content = "content".asInstanceOf[typingsJapgolly.chrome.chromeStrings.content]
    
    inline def file: typingsJapgolly.chrome.chromeStrings.file = "file".asInstanceOf[typingsJapgolly.chrome.chromeStrings.file]
    
    inline def host: typingsJapgolly.chrome.chromeStrings.host = "host".asInstanceOf[typingsJapgolly.chrome.chromeStrings.host]
    
    inline def safe: typingsJapgolly.chrome.chromeStrings.safe = "safe".asInstanceOf[typingsJapgolly.chrome.chromeStrings.safe]
    
    inline def uncommon: typingsJapgolly.chrome.chromeStrings.uncommon = "uncommon".asInstanceOf[typingsJapgolly.chrome.chromeStrings.uncommon]
    
    inline def unwanted: typingsJapgolly.chrome.chromeStrings.unwanted = "unwanted".asInstanceOf[typingsJapgolly.chrome.chromeStrings.unwanted]
    
    inline def url: typingsJapgolly.chrome.chromeStrings.url = "url".asInstanceOf[typingsJapgolly.chrome.chromeStrings.url]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chrome.chromeStrings.FILE_FAILED
    - typingsJapgolly.chrome.chromeStrings.FILE_ACCESS_DENIED
    - typingsJapgolly.chrome.chromeStrings.FILE_NO_SPACE
    - typingsJapgolly.chrome.chromeStrings.FILE_NAME_TOO_LONG
    - typingsJapgolly.chrome.chromeStrings.FILE_TOO_LARGE
    - typingsJapgolly.chrome.chromeStrings.FILE_VIRUS_INFECTED
    - typingsJapgolly.chrome.chromeStrings.FILE_TRANSIENT_ERROR
    - typingsJapgolly.chrome.chromeStrings.FILE_BLOCKED
    - typingsJapgolly.chrome.chromeStrings.FILE_SECURITY_CHECK_FAILED
    - typingsJapgolly.chrome.chromeStrings.FILE_TOO_SHORT
    - typingsJapgolly.chrome.chromeStrings.FILE_HASH_MISMATCH
    - typingsJapgolly.chrome.chromeStrings.FILE_SAME_AS_SOURCE
    - typingsJapgolly.chrome.chromeStrings.NETWORK_FAILED
    - typingsJapgolly.chrome.chromeStrings.NETWORK_TIMEOUT
    - typingsJapgolly.chrome.chromeStrings.NETWORK_DISCONNECTED
    - typingsJapgolly.chrome.chromeStrings.NETWORK_SERVER_DOWN
    - typingsJapgolly.chrome.chromeStrings.NETWORK_INVALID_REQUEST
    - typingsJapgolly.chrome.chromeStrings.SERVER_FAILED
    - typingsJapgolly.chrome.chromeStrings.SERVER_NO_RANGE
    - typingsJapgolly.chrome.chromeStrings.SERVER_BAD_CONTENT
    - typingsJapgolly.chrome.chromeStrings.SERVER_UNAUTHORIZED
    - typingsJapgolly.chrome.chromeStrings.SERVER_CERT_PROBLEM
    - typingsJapgolly.chrome.chromeStrings.SERVER_FORBIDDEN
    - typingsJapgolly.chrome.chromeStrings.SERVER_UNREACHABLE
    - typingsJapgolly.chrome.chromeStrings.SERVER_CONTENT_LENGTH_MISMATCH
    - typingsJapgolly.chrome.chromeStrings.SERVER_CROSS_ORIGIN_REDIRECT
    - typingsJapgolly.chrome.chromeStrings.USER_CANCELED
    - typingsJapgolly.chrome.chromeStrings.USER_SHUTDOWN
    - typingsJapgolly.chrome.chromeStrings.CRASH
  */
  trait DownloadInterruptReason extends StObject
  object DownloadInterruptReason {
    
    inline def CRASH: typingsJapgolly.chrome.chromeStrings.CRASH = "CRASH".asInstanceOf[typingsJapgolly.chrome.chromeStrings.CRASH]
    
    inline def FILE_ACCESS_DENIED: typingsJapgolly.chrome.chromeStrings.FILE_ACCESS_DENIED = "FILE_ACCESS_DENIED".asInstanceOf[typingsJapgolly.chrome.chromeStrings.FILE_ACCESS_DENIED]
    
    inline def FILE_BLOCKED: typingsJapgolly.chrome.chromeStrings.FILE_BLOCKED = "FILE_BLOCKED".asInstanceOf[typingsJapgolly.chrome.chromeStrings.FILE_BLOCKED]
    
    inline def FILE_FAILED: typingsJapgolly.chrome.chromeStrings.FILE_FAILED = "FILE_FAILED".asInstanceOf[typingsJapgolly.chrome.chromeStrings.FILE_FAILED]
    
    inline def FILE_HASH_MISMATCH: typingsJapgolly.chrome.chromeStrings.FILE_HASH_MISMATCH = "FILE_HASH_MISMATCH".asInstanceOf[typingsJapgolly.chrome.chromeStrings.FILE_HASH_MISMATCH]
    
    inline def FILE_NAME_TOO_LONG: typingsJapgolly.chrome.chromeStrings.FILE_NAME_TOO_LONG = "FILE_NAME_TOO_LONG".asInstanceOf[typingsJapgolly.chrome.chromeStrings.FILE_NAME_TOO_LONG]
    
    inline def FILE_NO_SPACE: typingsJapgolly.chrome.chromeStrings.FILE_NO_SPACE = "FILE_NO_SPACE".asInstanceOf[typingsJapgolly.chrome.chromeStrings.FILE_NO_SPACE]
    
    inline def FILE_SAME_AS_SOURCE: typingsJapgolly.chrome.chromeStrings.FILE_SAME_AS_SOURCE = "FILE_SAME_AS_SOURCE".asInstanceOf[typingsJapgolly.chrome.chromeStrings.FILE_SAME_AS_SOURCE]
    
    inline def FILE_SECURITY_CHECK_FAILED: typingsJapgolly.chrome.chromeStrings.FILE_SECURITY_CHECK_FAILED = "FILE_SECURITY_CHECK_FAILED".asInstanceOf[typingsJapgolly.chrome.chromeStrings.FILE_SECURITY_CHECK_FAILED]
    
    inline def FILE_TOO_LARGE: typingsJapgolly.chrome.chromeStrings.FILE_TOO_LARGE = "FILE_TOO_LARGE".asInstanceOf[typingsJapgolly.chrome.chromeStrings.FILE_TOO_LARGE]
    
    inline def FILE_TOO_SHORT: typingsJapgolly.chrome.chromeStrings.FILE_TOO_SHORT = "FILE_TOO_SHORT".asInstanceOf[typingsJapgolly.chrome.chromeStrings.FILE_TOO_SHORT]
    
    inline def FILE_TRANSIENT_ERROR: typingsJapgolly.chrome.chromeStrings.FILE_TRANSIENT_ERROR = "FILE_TRANSIENT_ERROR".asInstanceOf[typingsJapgolly.chrome.chromeStrings.FILE_TRANSIENT_ERROR]
    
    inline def FILE_VIRUS_INFECTED: typingsJapgolly.chrome.chromeStrings.FILE_VIRUS_INFECTED = "FILE_VIRUS_INFECTED".asInstanceOf[typingsJapgolly.chrome.chromeStrings.FILE_VIRUS_INFECTED]
    
    inline def NETWORK_DISCONNECTED: typingsJapgolly.chrome.chromeStrings.NETWORK_DISCONNECTED = "NETWORK_DISCONNECTED".asInstanceOf[typingsJapgolly.chrome.chromeStrings.NETWORK_DISCONNECTED]
    
    inline def NETWORK_FAILED: typingsJapgolly.chrome.chromeStrings.NETWORK_FAILED = "NETWORK_FAILED".asInstanceOf[typingsJapgolly.chrome.chromeStrings.NETWORK_FAILED]
    
    inline def NETWORK_INVALID_REQUEST: typingsJapgolly.chrome.chromeStrings.NETWORK_INVALID_REQUEST = "NETWORK_INVALID_REQUEST".asInstanceOf[typingsJapgolly.chrome.chromeStrings.NETWORK_INVALID_REQUEST]
    
    inline def NETWORK_SERVER_DOWN: typingsJapgolly.chrome.chromeStrings.NETWORK_SERVER_DOWN = "NETWORK_SERVER_DOWN".asInstanceOf[typingsJapgolly.chrome.chromeStrings.NETWORK_SERVER_DOWN]
    
    inline def NETWORK_TIMEOUT: typingsJapgolly.chrome.chromeStrings.NETWORK_TIMEOUT = "NETWORK_TIMEOUT".asInstanceOf[typingsJapgolly.chrome.chromeStrings.NETWORK_TIMEOUT]
    
    inline def SERVER_BAD_CONTENT: typingsJapgolly.chrome.chromeStrings.SERVER_BAD_CONTENT = "SERVER_BAD_CONTENT".asInstanceOf[typingsJapgolly.chrome.chromeStrings.SERVER_BAD_CONTENT]
    
    inline def SERVER_CERT_PROBLEM: typingsJapgolly.chrome.chromeStrings.SERVER_CERT_PROBLEM = "SERVER_CERT_PROBLEM".asInstanceOf[typingsJapgolly.chrome.chromeStrings.SERVER_CERT_PROBLEM]
    
    inline def SERVER_CONTENT_LENGTH_MISMATCH: typingsJapgolly.chrome.chromeStrings.SERVER_CONTENT_LENGTH_MISMATCH = "SERVER_CONTENT_LENGTH_MISMATCH".asInstanceOf[typingsJapgolly.chrome.chromeStrings.SERVER_CONTENT_LENGTH_MISMATCH]
    
    inline def SERVER_CROSS_ORIGIN_REDIRECT: typingsJapgolly.chrome.chromeStrings.SERVER_CROSS_ORIGIN_REDIRECT = "SERVER_CROSS_ORIGIN_REDIRECT".asInstanceOf[typingsJapgolly.chrome.chromeStrings.SERVER_CROSS_ORIGIN_REDIRECT]
    
    inline def SERVER_FAILED: typingsJapgolly.chrome.chromeStrings.SERVER_FAILED = "SERVER_FAILED".asInstanceOf[typingsJapgolly.chrome.chromeStrings.SERVER_FAILED]
    
    inline def SERVER_FORBIDDEN: typingsJapgolly.chrome.chromeStrings.SERVER_FORBIDDEN = "SERVER_FORBIDDEN".asInstanceOf[typingsJapgolly.chrome.chromeStrings.SERVER_FORBIDDEN]
    
    inline def SERVER_NO_RANGE: typingsJapgolly.chrome.chromeStrings.SERVER_NO_RANGE = "SERVER_NO_RANGE".asInstanceOf[typingsJapgolly.chrome.chromeStrings.SERVER_NO_RANGE]
    
    inline def SERVER_UNAUTHORIZED: typingsJapgolly.chrome.chromeStrings.SERVER_UNAUTHORIZED = "SERVER_UNAUTHORIZED".asInstanceOf[typingsJapgolly.chrome.chromeStrings.SERVER_UNAUTHORIZED]
    
    inline def SERVER_UNREACHABLE: typingsJapgolly.chrome.chromeStrings.SERVER_UNREACHABLE = "SERVER_UNREACHABLE".asInstanceOf[typingsJapgolly.chrome.chromeStrings.SERVER_UNREACHABLE]
    
    inline def USER_CANCELED: typingsJapgolly.chrome.chromeStrings.USER_CANCELED = "USER_CANCELED".asInstanceOf[typingsJapgolly.chrome.chromeStrings.USER_CANCELED]
    
    inline def USER_SHUTDOWN: typingsJapgolly.chrome.chromeStrings.USER_SHUTDOWN = "USER_SHUTDOWN".asInstanceOf[typingsJapgolly.chrome.chromeStrings.USER_SHUTDOWN]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chrome.chromeStrings.in_progress
    - typingsJapgolly.chrome.chromeStrings.interrupted
    - typingsJapgolly.chrome.chromeStrings.complete
  */
  trait DownloadState extends StObject
  object DownloadState {
    
    inline def complete: typingsJapgolly.chrome.chromeStrings.complete = "complete".asInstanceOf[typingsJapgolly.chrome.chromeStrings.complete]
    
    inline def in_progress: typingsJapgolly.chrome.chromeStrings.in_progress = "in_progress".asInstanceOf[typingsJapgolly.chrome.chromeStrings.in_progress]
    
    inline def interrupted: typingsJapgolly.chrome.chromeStrings.interrupted = "interrupted".asInstanceOf[typingsJapgolly.chrome.chromeStrings.interrupted]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chrome.chromeStrings.uniquify
    - typingsJapgolly.chrome.chromeStrings.overwrite
    - typingsJapgolly.chrome.chromeStrings.prompt
  */
  trait FilenameConflictAction extends StObject
  object FilenameConflictAction {
    
    inline def overwrite: typingsJapgolly.chrome.chromeStrings.overwrite = "overwrite".asInstanceOf[typingsJapgolly.chrome.chromeStrings.overwrite]
    
    inline def prompt: typingsJapgolly.chrome.chromeStrings.prompt = "prompt".asInstanceOf[typingsJapgolly.chrome.chromeStrings.prompt]
    
    inline def uniquify: typingsJapgolly.chrome.chromeStrings.uniquify = "uniquify".asInstanceOf[typingsJapgolly.chrome.chromeStrings.uniquify]
  }
