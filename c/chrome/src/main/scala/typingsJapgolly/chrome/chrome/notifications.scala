...
object notifications {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chrome.chromeStrings.basic
    - typingsJapgolly.chrome.chromeStrings.image
    - typingsJapgolly.chrome.chromeStrings.list
    - typingsJapgolly.chrome.chromeStrings.progress
  */
  trait TemplateType extends StObject
  object TemplateType {
    
    inline def basic: typingsJapgolly.chrome.chromeStrings.basic = "basic".asInstanceOf[typingsJapgolly.chrome.chromeStrings.basic]
    ...
    inline def list: typingsJapgolly.chrome.chromeStrings.list = "list".asInstanceOf[typingsJapgolly.chrome.chromeStrings.list]
    
    inline def progress: typingsJapgolly.chrome.chromeStrings.progress = "progress".asInstanceOf[typingsJapgolly.chrome.chromeStrings.progress]
  }
}
