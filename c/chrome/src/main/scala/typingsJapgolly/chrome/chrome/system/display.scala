...
import typingsJapgolly.chrome.anon.ManufacturerId
import typingsJapgolly.chrome.chromeInts.`0`
import typingsJapgolly.chrome.chromeInts.`180`
import typingsJapgolly.chrome.chromeInts.`270`
import typingsJapgolly.chrome.chromeInts.`90`
