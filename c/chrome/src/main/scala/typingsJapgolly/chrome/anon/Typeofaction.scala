...
import typingsJapgolly.chrome.chrome.action.BadgeBackgroundColorDetails
import typingsJapgolly.chrome.chrome.action.BadgeTextDetails
import typingsJapgolly.chrome.chrome.action.BrowserClickedEvent
import typingsJapgolly.chrome.chrome.action.ColorArray
import typingsJapgolly.chrome.chrome.action.PopupDetails
import typingsJapgolly.chrome.chrome.action.TabDetails
import typingsJapgolly.chrome.chrome.action.TabIconDetails
import typingsJapgolly.chrome.chrome.action.TitleDetails
