...
import typingsJapgolly.chrome.chrome.declarativeNetRequest.ExtensionActionOptions
import typingsJapgolly.chrome.chrome.declarativeNetRequest.IsRegexSupportedResult
import typingsJapgolly.chrome.chrome.declarativeNetRequest.MatchedRulesFilter
import typingsJapgolly.chrome.chrome.declarativeNetRequest.RegexOptions
import typingsJapgolly.chrome.chrome.declarativeNetRequest.Rule
import typingsJapgolly.chrome.chrome.declarativeNetRequest.RuleMatchedDebugEvent
import typingsJapgolly.chrome.chrome.declarativeNetRequest.RulesMatchedDetails
import typingsJapgolly.chrome.chrome.declarativeNetRequest.UpdateRuleOptions
import typingsJapgolly.chrome.chrome.declarativeNetRequest.UpdateRulesetOptions
