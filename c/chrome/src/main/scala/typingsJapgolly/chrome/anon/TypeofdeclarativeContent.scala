...
import typingsJapgolly.chrome.chrome.declarativeContent.SetIcon
import typingsJapgolly.chrome.chrome.declarativeContent.ShowAction
...
trait TypeofdeclarativeContent extends StObject {
  ...
  var SetIcon: Instantiable1[
    ...
    typingsJapgolly.chrome.chrome.declarativeContent.SetIcon
  ]
  
  var ShowAction: Instantiable0[typingsJapgolly.chrome.chrome.declarativeContent.ShowAction]
