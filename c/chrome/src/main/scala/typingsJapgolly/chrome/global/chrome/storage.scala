...
object storage {
  ...
  object AccessLevel {
    ...
    @js.native
    def TRUSTED_AND_UNTRUSTED_CONTEXTS: typingsJapgolly.chrome.chromeStrings.TRUSTED_AND_UNTRUSTED_CONTEXTS = js.native
    ...
    @js.native
    def TRUSTED_CONTEXTS: typingsJapgolly.chrome.chromeStrings.TRUSTED_CONTEXTS = js.native
