...
object serial {
  ...
  object onReceiveError {
    ...
    object OnReceiveErrorEnum {
      ...
      @js.native
      def break: typingsJapgolly.chrome.chromeStrings.break = js.native
      ...
      @js.native
      def disconnected: typingsJapgolly.chrome.chromeStrings.disconnected = js.native
      ...
      @js.native
      def overrun: typingsJapgolly.chrome.chromeStrings.overrun = js.native
      ...
      @js.native
      def timeout: typingsJapgolly.chrome.chromeStrings.timeout = js.native
