...
import typingsJapgolly.chrome.chrome.cast.media.IdleReason
import typingsJapgolly.chrome.chrome.cast.media.MediaCommand
import typingsJapgolly.chrome.chrome.cast.media.MetadataType
import typingsJapgolly.chrome.chrome.cast.media.PlayerState
import typingsJapgolly.chrome.chrome.cast.media.RepeatMode
import typingsJapgolly.chrome.chrome.cast.media.ResumeState
import typingsJapgolly.chrome.chrome.cast.media.StreamType
import typingsJapgolly.chrome.chrome.cast.media.TextTrackEdgeType
import typingsJapgolly.chrome.chrome.cast.media.TextTrackFontGenericFamily
import typingsJapgolly.chrome.chrome.cast.media.TextTrackFontStyle
import typingsJapgolly.chrome.chrome.cast.media.TextTrackType
import typingsJapgolly.chrome.chrome.cast.media.TextTrackWindowType
...
object media {
  ...
  open class EditTracksInfoRequest ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.EditTracksInfoRequest {
    def this(activeTrackIds: js.Array[Double]) = this()
    def this(
      activeTrackIds: js.Array[Double],
      textTrackStyle: typingsJapgolly.chrome.chrome.cast.media.TextTrackStyle
    ) = this()
    def this(activeTrackIds: Unit, textTrackStyle: typingsJapgolly.chrome.chrome.cast.media.TextTrackStyle) = this()
    
    /* CompleteClass */
    var activeTrackIds: js.Array[Double] = js.native
    
    /* CompleteClass */
    var textTrackStyle: typingsJapgolly.chrome.chrome.cast.media.TextTrackStyle = js.native
  }
  ...
  open class GenericMediaMetadata ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.GenericMediaMetadata {
    
    /* CompleteClass */
    var images: js.Array[typingsJapgolly.chrome.chrome.cast.Image] = js.native
  ...
  open class GetStatusRequest ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.GetStatusRequest {
  ...
  object IdleReason extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.cast.media.IdleReason & String] = js.native
    
    /* "CANCELLED" */ val CANCELLED: typingsJapgolly.chrome.chrome.cast.media.IdleReason.CANCELLED & String = js.native
    
    /* "ERROR" */ val ERROR: typingsJapgolly.chrome.chrome.cast.media.IdleReason.ERROR & String = js.native
    
    /* "FINISHED" */ val FINISHED: typingsJapgolly.chrome.chrome.cast.media.IdleReason.FINISHED & String = js.native
    
    /* "INTERRUPTED" */ val INTERRUPTED: typingsJapgolly.chrome.chrome.cast.media.IdleReason.INTERRUPTED & String = js.native
  }
  ...
  open class LiveSeekableRange ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.LiveSeekableRange {
  ...
  open class LoadRequest protected ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.LoadRequest {
    /**
      * @param mediaInfo
      * @see https://developers.google.com/cast/docs/reference/chrome/chrome.cast.media.LoadRequest
      */
    def this(mediaInfo: typingsJapgolly.chrome.chrome.cast.media.MediaInfo) = this()
    ...
    /* CompleteClass */
    var media: typingsJapgolly.chrome.chrome.cast.media.MediaInfo = js.native
  }
  ...
  open class Media protected ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.Media {
    /**
      * @param sessionId
    ...
    override def editTracksInfo(
      editTracksInfoRequest: typingsJapgolly.chrome.chrome.cast.media.EditTracksInfoRequest,
    ...
    override def getStatus(
      getStatusRequest: typingsJapgolly.chrome.chrome.cast.media.GetStatusRequest,
      successCallback: js.Function,
      errorCallback: js.Function1[/* error */ typingsJapgolly.chrome.chrome.cast.Error, Unit]
    ): Unit = js.native
    ...
    /* CompleteClass */
    var items: js.Array[typingsJapgolly.chrome.chrome.cast.media.QueueItem] = js.native
    ...
    /* CompleteClass */
    override def pause(
      pauseRequest: typingsJapgolly.chrome.chrome.cast.media.PauseRequest,
      successCallback: js.Function,
      errorCallback: js.Function1[/* error */ typingsJapgolly.chrome.chrome.cast.Error, Unit]
    ): Unit = js.native
    ...
    /* CompleteClass */
    override def play(
      playRequest: typingsJapgolly.chrome.chrome.cast.media.PlayRequest,
      successCallback: js.Function,
      errorCallback: js.Function1[/* error */ typingsJapgolly.chrome.chrome.cast.Error, Unit]
    ): Unit = js.native
    ...
    override def queueAppendItem(
      item: typingsJapgolly.chrome.chrome.cast.media.QueueItem,
      successCallback: js.Function,
      errorCallback: js.Function1[/* error */ typingsJapgolly.chrome.chrome.cast.Error, Unit]
    ): Unit = js.native
    ...
    override def queueInsertItems(
      queueInsertItemsRequest: typingsJapgolly.chrome.chrome.cast.media.QueueInsertItemsRequest,
      successCallback: js.Function,
      errorCallback: js.Function1[/* error */ typingsJapgolly.chrome.chrome.cast.Error, Unit]
    ): Unit = js.native
    ...
    override def queueReorderItems(
      queueReorderItemsRequest: typingsJapgolly.chrome.chrome.cast.media.QueueReorderItemsRequest,
      successCallback: js.Function,
      errorCallback: js.Function1[/* error */ typingsJapgolly.chrome.chrome.cast.Error, Unit]
    ): Unit = js.native
    ...
    override def queueUpdateItems(
      queueUpdateItemsRequest: typingsJapgolly.chrome.chrome.cast.media.QueueUpdateItemsRequest,
      successCallback: js.Function,
      errorCallback: js.Function1[/* error */ typingsJapgolly.chrome.chrome.cast.Error, Unit]
    ): Unit = js.native
    ...
    /* CompleteClass */
    override def seek(
      seekRequest: typingsJapgolly.chrome.chrome.cast.media.SeekRequest,
      successCallback: js.Function,
      errorCallback: js.Function1[/* error */ typingsJapgolly.chrome.chrome.cast.Error, Unit]
    ): Unit = js.native
    ...
    override def setVolume(
      volumeRequest: typingsJapgolly.chrome.chrome.cast.media.VolumeRequest,
      successCallback: js.Function,
      errorCallback: js.Function1[/* error */ typingsJapgolly.chrome.chrome.cast.Error, Unit]
    ): Unit = js.native
    ...
    /* CompleteClass */
    override def stop(
      stopRequest: typingsJapgolly.chrome.chrome.cast.media.StopRequest,
      successCallback: js.Function,
      errorCallback: js.Function1[/* error */ typingsJapgolly.chrome.chrome.cast.Error, Unit]
    ): Unit = js.native
  ...
  object MediaCommand extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.cast.media.MediaCommand & String] = js.native
    
    /* "pause" */ val PAUSE: typingsJapgolly.chrome.chrome.cast.media.MediaCommand.PAUSE & String = js.native
    
    /* "seek" */ val SEEK: typingsJapgolly.chrome.chrome.cast.media.MediaCommand.SEEK & String = js.native
    
    /* "stream_mute" */ val STREAM_MUTE: typingsJapgolly.chrome.chrome.cast.media.MediaCommand.STREAM_MUTE & String = js.native
    
    /* "stream_volume" */ val STREAM_VOLUME: typingsJapgolly.chrome.chrome.cast.media.MediaCommand.STREAM_VOLUME & String = js.native
  }
  ...
  open class MediaInfo protected ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.MediaInfo {
    /**
      * @param contentId
      * @param contentType
    ...
    /* CompleteClass */
    var tracks: js.Array[typingsJapgolly.chrome.chrome.cast.media.Track] = js.native
  }
  ...
  object MetadataType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.chrome.chrome.cast.media.MetadataType & Double] = js.native
    
    /* 0 */ val GENERIC: typingsJapgolly.chrome.chrome.cast.media.MetadataType.GENERIC & Double = js.native
    
    /* 2 */ val MOVIE: typingsJapgolly.chrome.chrome.cast.media.MetadataType.MOVIE & Double = js.native
    
    /* 3 */ val MUSIC_TRACK: typingsJapgolly.chrome.chrome.cast.media.MetadataType.MUSIC_TRACK & Double = js.native
    
    /* 4 */ val PHOTO: typingsJapgolly.chrome.chrome.cast.media.MetadataType.PHOTO & Double = js.native
    
    /* 1 */ val TV_SHOW: typingsJapgolly.chrome.chrome.cast.media.MetadataType.TV_SHOW & Double = js.native
  }
  ...
  open class MovieMediaMetadata ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.MovieMediaMetadata {
  ...
  open class MusicTrackMediaMetadata ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.MusicTrackMediaMetadata {
  ...
  open class PauseRequest ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.PauseRequest {
  ...
  open class PhotoMediaMetadata ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.PhotoMediaMetadata {
  ...
  open class PlayRequest ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.PlayRequest {
  ...
  object PlayerState extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.cast.media.PlayerState & String] = js.native
    
    /* "BUFFERING" */ val BUFFERING: typingsJapgolly.chrome.chrome.cast.media.PlayerState.BUFFERING & String = js.native
    
    /* "IDLE" */ val IDLE: typingsJapgolly.chrome.chrome.cast.media.PlayerState.IDLE & String = js.native
    
    /* "PAUSED" */ val PAUSED: typingsJapgolly.chrome.chrome.cast.media.PlayerState.PAUSED & String = js.native
    
    /* "PLAYING" */ val PLAYING: typingsJapgolly.chrome.chrome.cast.media.PlayerState.PLAYING & String = js.native
  }
  ...
  open class QueueInsertItemsRequest protected ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.QueueInsertItemsRequest {
    /**
      * @param itemsToInsert
      * @see https://developers.google.com/cast/docs/reference/chrome/chrome.cast.media.QueueInsertItemsRequest
      */
    def this(itemsToInsert: js.Array[typingsJapgolly.chrome.chrome.cast.media.QueueItem]) = this()
  ...
  open class QueueItem protected ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.QueueItem {
    /**
      * @param mediaInfo
  ...
  open class QueueLoadRequest protected ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.QueueLoadRequest {
    /**
      * @param items
      * @see https://developers.google.com/cast/docs/reference/chrome/chrome.cast.media.QueueLoadRequest
      */
    def this(items: js.Array[typingsJapgolly.chrome.chrome.cast.media.QueueItem]) = this()
  ...
  open class QueueRemoveItemsRequest protected ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.QueueRemoveItemsRequest {
    /**
  ...
  open class QueueReorderItemsRequest protected ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.QueueReorderItemsRequest {
    /**
  ...
  open class QueueUpdateItemsRequest protected ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.QueueUpdateItemsRequest {
    /**
      * @param itemsToUpdate
      * @see https://developers.google.com/cast/docs/reference/chrome/chrome.cast.media.QueueUpdateItemsRequest
      */
    def this(itemsToUpdate: js.Array[typingsJapgolly.chrome.chrome.cast.media.QueueItem]) = this()
    
    /* CompleteClass */
    var customData: js.Object = js.native
    
    /* CompleteClass */
    var item: js.Array[typingsJapgolly.chrome.chrome.cast.media.QueueItem] = js.native
  }
  ...
  object RepeatMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.cast.media.RepeatMode & String] = js.native
    
    /* "REPEAT_ALL" */ val ALL: typingsJapgolly.chrome.chrome.cast.media.RepeatMode.ALL & String = js.native
    
    /* "REPEAT_ALL_AND_SHUFFLE" */ val ALL_AND_SHUFFLE: typingsJapgolly.chrome.chrome.cast.media.RepeatMode.ALL_AND_SHUFFLE & String = js.native
    
    /* "REPEAT_OFF" */ val OFF: typingsJapgolly.chrome.chrome.cast.media.RepeatMode.OFF & String = js.native
    
    /* "REPEAT_SINGLE" */ val SINGLE: typingsJapgolly.chrome.chrome.cast.media.RepeatMode.SINGLE & String = js.native
  }
  ...
  object ResumeState extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.cast.media.ResumeState & String] = js.native
    
    /* "PLAYBACK_PAUSE" */ val PLAYBACK_PAUSE: typingsJapgolly.chrome.chrome.cast.media.ResumeState.PLAYBACK_PAUSE & String = js.native
    
    /* "PLAYBACK_START" */ val PLAYBACK_START: typingsJapgolly.chrome.chrome.cast.media.ResumeState.PLAYBACK_START & String = js.native
  }
  ...
  open class SeekRequest ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.SeekRequest {
  ...
  open class StopRequest ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.StopRequest {
  ...
  object StreamType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.cast.media.StreamType & String] = js.native
    
    /* "BUFFERED" */ val BUFFERED: typingsJapgolly.chrome.chrome.cast.media.StreamType.BUFFERED & String = js.native
    
    /* "LIVE" */ val LIVE: typingsJapgolly.chrome.chrome.cast.media.StreamType.LIVE & String = js.native
    
    /* "OTHER" */ val OTHER: typingsJapgolly.chrome.chrome.cast.media.StreamType.OTHER & String = js.native
  }
  ...
  object TextTrackEdgeType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.cast.media.TextTrackEdgeType & String] = js.native
    
    /* "DEPRESSED" */ val DEPRESSED: typingsJapgolly.chrome.chrome.cast.media.TextTrackEdgeType.DEPRESSED & String = js.native
    
    /* "DROP_SHADOW" */ val DROP_SHADOW: typingsJapgolly.chrome.chrome.cast.media.TextTrackEdgeType.DROP_SHADOW & String = js.native
    
    /* "NONE" */ val NONE: typingsJapgolly.chrome.chrome.cast.media.TextTrackEdgeType.NONE & String = js.native
    
    /* "OUTLINE" */ val OUTLINE: typingsJapgolly.chrome.chrome.cast.media.TextTrackEdgeType.OUTLINE & String = js.native
    
    /* "RAISED" */ val RAISED: typingsJapgolly.chrome.chrome.cast.media.TextTrackEdgeType.RAISED & String = js.native
  }
  ...
  object TextTrackFontGenericFamily extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.cast.media.TextTrackFontGenericFamily & String] = js.native
    
    /* "CASUAL" */ val CASUAL: typingsJapgolly.chrome.chrome.cast.media.TextTrackFontGenericFamily.CASUAL & String = js.native
    
    /* "CURSIVE" */ val CURSIVE: typingsJapgolly.chrome.chrome.cast.media.TextTrackFontGenericFamily.CURSIVE & String = js.native
    
    /* "MONOSPACED_SANS_SERIF" */ val MONOSPACED_SANS_SERIF: typingsJapgolly.chrome.chrome.cast.media.TextTrackFontGenericFamily.MONOSPACED_SANS_SERIF & String = js.native
    
    /* "MONOSPACED_SERIF" */ val MONOSPACED_SERIF: typingsJapgolly.chrome.chrome.cast.media.TextTrackFontGenericFamily.MONOSPACED_SERIF & String = js.native
    
    /* "SANS_SERIF" */ val SANS_SERIF: typingsJapgolly.chrome.chrome.cast.media.TextTrackFontGenericFamily.SANS_SERIF & String = js.native
    
    /* "SERIF" */ val SERIF: typingsJapgolly.chrome.chrome.cast.media.TextTrackFontGenericFamily.SERIF & String = js.native
    
    /* "SMALL_CAPITALS" */ val SMALL_CAPITALS: typingsJapgolly.chrome.chrome.cast.media.TextTrackFontGenericFamily.SMALL_CAPITALS & String = js.native
  }
  ...
  object TextTrackFontStyle extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.cast.media.TextTrackFontStyle & String] = js.native
    
    /* "BOLD" */ val BOLD: typingsJapgolly.chrome.chrome.cast.media.TextTrackFontStyle.BOLD & String = js.native
    
    /* "BOLD_ITALIC" */ val BOLD_ITALIC: typingsJapgolly.chrome.chrome.cast.media.TextTrackFontStyle.BOLD_ITALIC & String = js.native
    
    /* "ITALIC" */ val ITALIC: typingsJapgolly.chrome.chrome.cast.media.TextTrackFontStyle.ITALIC & String = js.native
    
    /* "NORMAL" */ val NORMAL: typingsJapgolly.chrome.chrome.cast.media.TextTrackFontStyle.NORMAL & String = js.native
  }
  ...
  open class TextTrackStyle ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.TextTrackStyle {
  ...
  object TextTrackType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.cast.media.TextTrackType & String] = js.native
    
    /* "CAPTIONS" */ val CAPTIONS: typingsJapgolly.chrome.chrome.cast.media.TextTrackType.CAPTIONS & String = js.native
    
    /* "CHAPTERS" */ val CHAPTERS: typingsJapgolly.chrome.chrome.cast.media.TextTrackType.CHAPTERS & String = js.native
    
    /* "DESCRIPTIONS" */ val DESCRIPTIONS: typingsJapgolly.chrome.chrome.cast.media.TextTrackType.DESCRIPTIONS & String = js.native
    
    /* "METADATA" */ val METADATA: typingsJapgolly.chrome.chrome.cast.media.TextTrackType.METADATA & String = js.native
    
    /* "SUBTITLES" */ val SUBTITLES: typingsJapgolly.chrome.chrome.cast.media.TextTrackType.SUBTITLES & String = js.native
  }
  ...
  object TextTrackWindowType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.cast.media.TextTrackWindowType & String] = js.native
    
    /* "NONE" */ val NONE: typingsJapgolly.chrome.chrome.cast.media.TextTrackWindowType.NONE & String = js.native
    
    /* "NORMAL" */ val NORMAL: typingsJapgolly.chrome.chrome.cast.media.TextTrackWindowType.NORMAL & String = js.native
    
    /* "ROUNDED_CORNERS" */ val ROUNDED_CORNERS: typingsJapgolly.chrome.chrome.cast.media.TextTrackWindowType.ROUNDED_CORNERS & String = js.native
  }
  ...
  open class Track protected ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.Track {
    /**
      * @param trackId
      * @param trackType
  ...
  object TrackType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.cast.media.TrackType & String] = js.native
    
    /* "AUDIO" */ val AUDIO: typingsJapgolly.chrome.chrome.cast.media.TrackType.AUDIO & String = js.native
    
    /* "TEXT" */ val TEXT: typingsJapgolly.chrome.chrome.cast.media.TrackType.TEXT & String = js.native
    
    /* "VIDEO" */ val VIDEO: typingsJapgolly.chrome.chrome.cast.media.TrackType.VIDEO & String = js.native
  }
  ...
  open class TvShowMediaMetadata ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.TvShowMediaMetadata {
  ...
  open class VolumeRequest protected ()
    extends StObject
       with typingsJapgolly.chrome.chrome.cast.media.VolumeRequest {
    /**
      * @param volume
      * @see https://developers.google.com/cast/docs/reference/chrome/chrome.cast.media.VolumeRequest
      */
    def this(volume: typingsJapgolly.chrome.chrome.cast.Volume) = this()
