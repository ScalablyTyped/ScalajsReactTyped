...
object declarativeNetRequest {
  ...
  object DomainType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.declarativeNetRequest.DomainType & String] = js.native
    
    /* "firstParty" */ val FIRST_PARTY: typingsJapgolly.chrome.chrome.declarativeNetRequest.DomainType.FIRST_PARTY & String = js.native
    
    /* "thirdParty" */ val THIRD_PARTY: typingsJapgolly.chrome.chrome.declarativeNetRequest.DomainType.THIRD_PARTY & String = js.native
  }
  ...
  object HeaderOperation extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.declarativeNetRequest.HeaderOperation & String] = js.native
    
    /* "append" */ val APPEND: typingsJapgolly.chrome.chrome.declarativeNetRequest.HeaderOperation.APPEND & String = js.native
    
    /* "remove" */ val REMOVE: typingsJapgolly.chrome.chrome.declarativeNetRequest.HeaderOperation.REMOVE & String = js.native
    
    /* "set" */ val SET: typingsJapgolly.chrome.chrome.declarativeNetRequest.HeaderOperation.SET & String = js.native
  }
  ...
  object RequestMethod extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.declarativeNetRequest.RequestMethod & String] = js.native
    
    /* "connect" */ val CONNECT: typingsJapgolly.chrome.chrome.declarativeNetRequest.RequestMethod.CONNECT & String = js.native
    
    /* "delete" */ val DELETE: typingsJapgolly.chrome.chrome.declarativeNetRequest.RequestMethod.DELETE & String = js.native
    
    /* "get" */ val GET: typingsJapgolly.chrome.chrome.declarativeNetRequest.RequestMethod.GET & String = js.native
    
    /* "head" */ val HEAD: typingsJapgolly.chrome.chrome.declarativeNetRequest.RequestMethod.HEAD & String = js.native
    
    /* "options" */ val OPTIONS: typingsJapgolly.chrome.chrome.declarativeNetRequest.RequestMethod.OPTIONS & String = js.native
    
    /* "patch" */ val PATCH: typingsJapgolly.chrome.chrome.declarativeNetRequest.RequestMethod.PATCH & String = js.native
    
    /* "post" */ val POST: typingsJapgolly.chrome.chrome.declarativeNetRequest.RequestMethod.POST & String = js.native
    
    /* "put" */ val PUT: typingsJapgolly.chrome.chrome.declarativeNetRequest.RequestMethod.PUT & String = js.native
  }
  ...
  object ResourceType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType & String] = js.native
    
    /* "csp_report" */ val CSP_REPORT: typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType.CSP_REPORT & String = js.native
    
    /* "font" */ val FONT: typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType.FONT & String = js.native
    
    /* "image" */ val IMAGE: typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType.IMAGE & String = js.native
    
    /* "main_frame" */ val MAIN_FRAME: typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType.MAIN_FRAME & String = js.native
    
    /* "media" */ val MEDIA: typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType.MEDIA & String = js.native
    
    /* "object" */ val OBJECT: typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType.OBJECT & String = js.native
    
    /* "other" */ val OTHER: typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType.OTHER & String = js.native
    
    /* "ping" */ val PING: typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType.PING & String = js.native
    
    /* "script" */ val SCRIPT: typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType.SCRIPT & String = js.native
    
    /* "stylesheet" */ val STYLESHEET: typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType.STYLESHEET & String = js.native
    
    /* "sub_frame" */ val SUB_FRAME: typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType.SUB_FRAME & String = js.native
    
    /* "websocket" */ val WEBSOCKET: typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType.WEBSOCKET & String = js.native
    
    /* "xmlhttprequest" */ val XMLHTTPREQUEST: typingsJapgolly.chrome.chrome.declarativeNetRequest.ResourceType.XMLHTTPREQUEST & String = js.native
  }
  ...
  object RuleActionType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.chrome.chrome.declarativeNetRequest.RuleActionType & String] = js.native
    
    /* "allow" */ val ALLOW: typingsJapgolly.chrome.chrome.declarativeNetRequest.RuleActionType.ALLOW & String = js.native
    
    /* "allowAllRequests" */ val ALLOW_ALL_REQUESTS: typingsJapgolly.chrome.chrome.declarativeNetRequest.RuleActionType.ALLOW_ALL_REQUESTS & String = js.native
    
    /* "block" */ val BLOCK: typingsJapgolly.chrome.chrome.declarativeNetRequest.RuleActionType.BLOCK & String = js.native
    
    /* "modifyHeaders" */ val MODIFY_HEADERS: typingsJapgolly.chrome.chrome.declarativeNetRequest.RuleActionType.MODIFY_HEADERS & String = js.native
    
    /* "redirect" */ val REDIRECT: typingsJapgolly.chrome.chrome.declarativeNetRequest.RuleActionType.REDIRECT & String = js.native
    
    /* "upgradeScheme" */ val UPGRADE_SCHEME: typingsJapgolly.chrome.chrome.declarativeNetRequest.RuleActionType.UPGRADE_SCHEME & String = js.native
  }
  ...
  object UnsupportedRegexReason extends StObject {
    ...
    def apply(value: String): js.UndefOr[
        typingsJapgolly.chrome.chrome.declarativeNetRequest.UnsupportedRegexReason & String
      ] = js.native
    
    /* "memoryLimitExceeded" */ val MEMORY_LIMIT_EXCEEDED: typingsJapgolly.chrome.chrome.declarativeNetRequest.UnsupportedRegexReason.MEMORY_LIMIT_EXCEEDED & String = js.native
    
    /* "syntaxError" */ val SYNTAX_ERROR: typingsJapgolly.chrome.chrome.declarativeNetRequest.UnsupportedRegexReason.SYNTAX_ERROR & String = js.native
  }
