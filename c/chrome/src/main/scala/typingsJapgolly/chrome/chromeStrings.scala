...
import typingsJapgolly.chrome.chrome.contentSettings.DefaultContentSettingDetails
import typingsJapgolly.chrome.chrome.contentSettings.ScopeEnum
import typingsJapgolly.chrome.chrome.contextMenus.ContextItemType
import typingsJapgolly.chrome.chrome.contextMenus.ContextType
import typingsJapgolly.chrome.chrome.cookies.SameSiteStatus
import typingsJapgolly.chrome.chrome.downloads.DangerType
import typingsJapgolly.chrome.chrome.downloads.DownloadInterruptReason
import typingsJapgolly.chrome.chrome.downloads.DownloadState
import typingsJapgolly.chrome.chrome.downloads.FilenameConflictAction
import typingsJapgolly.chrome.chrome.idle.IdleState
import typingsJapgolly.chrome.chrome.input.ime.AssistiveWindowButton
import typingsJapgolly.chrome.chrome.loginState.ProfileType
import typingsJapgolly.chrome.chrome.loginState.SessionState
import typingsJapgolly.chrome.chrome.notifications.TemplateType
import typingsJapgolly.chrome.chrome.omnibox.OnInputEnteredDisposition
import typingsJapgolly.chrome.chrome.runtime.ManifestPermissions
import typingsJapgolly.chrome.chrome.runtime.PlatformArch
import typingsJapgolly.chrome.chrome.runtime.PlatformNaclArch
import typingsJapgolly.chrome.chrome.runtime.PlatformOs
import typingsJapgolly.chrome.chrome.runtime.RequestUpdateCheckStatus
import typingsJapgolly.chrome.chrome.scripting.ExecutionWorld
import typingsJapgolly.chrome.chrome.scripting.StyleOrigin
import typingsJapgolly.chrome.chrome.search.Disposition
import typingsJapgolly.chrome.chrome.storage.AccessLevel
import typingsJapgolly.chrome.chrome.storage.AreaName
import typingsJapgolly.chrome.chrome.tabGroups.ColorEnum
import typingsJapgolly.chrome.chrome.types._settingsScope
import typingsJapgolly.chrome.chrome.webRequest.ResourceType
import typingsJapgolly.chrome.chrome.windows.createTypeEnum
import typingsJapgolly.chrome.chrome.windows.windowStateEnum
import typingsJapgolly.chrome.chrome.windows.windowTypeEnum
