...
import typingsJapgolly.chrome.chrome.debugger.Debuggee
import typingsJapgolly.chrome.chrome.debugger.DebuggerDetachedEvent
import typingsJapgolly.chrome.chrome.debugger.DebuggerEventEvent
import typingsJapgolly.chrome.chrome.debugger.TargetInfo
