package typingsJapgolly.clamscan

import typingsJapgolly.clamscan.anon.Active
import typingsJapgolly.clamscan.anon.BypassTest
import typingsJapgolly.clamscan.anon.Isinfected
import typingsJapgolly.clamscan.anon.ReadonlyOptions
import typingsJapgolly.clamscan.anon.ResponsefilestringisInfec
import typingsJapgolly.clamscan.anon.ResponsefilestringisInfecFile
import typingsJapgolly.clamscan.anon.ResponsegoodFilesArraystr
import typingsJapgolly.clamscan.anon.ResponsepathstringisInfec
import typingsJapgolly.clamscan.anon.Viruses
import typingsJapgolly.clamscan.clamscanStrings.`node-clam`
import typingsJapgolly.clamscan.clamscanStrings.clamdscan
