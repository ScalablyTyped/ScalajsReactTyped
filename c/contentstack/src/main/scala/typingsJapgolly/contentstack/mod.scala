...
import typingsJapgolly.contentstack.anon.Paths
...
object mod {
  ...
  open class Assets () extends StObject {
    ...
    def Query(): typingsJapgolly.contentstack.mod.Query = js.native
  ...
  object CachePolicy extends StObject {
    ...
    sealed trait CACHE_ELSE_NETWORK
      extends StObject
         with CachePolicy
    /* 1 */ val CACHE_ELSE_NETWORK: typingsJapgolly.contentstack.mod.CachePolicy.CACHE_ELSE_NETWORK & Double = js.native
    
    @js.native
    sealed trait CACHE_THEN_NETWORK
      extends StObject
         with CachePolicy
    /* 3 */ val CACHE_THEN_NETWORK: typingsJapgolly.contentstack.mod.CachePolicy.CACHE_THEN_NETWORK & Double = js.native
    
    @js.native
    sealed trait IGNORE_CACHE
      extends StObject
         with CachePolicy
    /* -1 */ val IGNORE_CACHE: typingsJapgolly.contentstack.mod.CachePolicy.IGNORE_CACHE & Double = js.native
    
    @js.native
    sealed trait NETWORK_ELSE_CACHE
      extends StObject
         with CachePolicy
    /* 2 */ val NETWORK_ELSE_CACHE: typingsJapgolly.contentstack.mod.CachePolicy.NETWORK_ELSE_CACHE & Double = js.native
    
    @js.native
    sealed trait ONLY_NETWORK
      extends StObject
         with CachePolicy
    /* 0 */ val ONLY_NETWORK: typingsJapgolly.contentstack.mod.CachePolicy.ONLY_NETWORK & Double = js.native
  }
  ...
  open class ContentType () extends StObject {
    ...
    def Entry(uid: String): typingsJapgolly.contentstack.mod.Entry = js.native
  ...
  object Region extends StObject {
    ...
    sealed trait AZURE_NA
      extends StObject
         with Region
    /* "azure-na" */ val AZURE_NA: typingsJapgolly.contentstack.mod.Region.AZURE_NA & String = js.native
    
    @js.native
    sealed trait EU
      extends StObject
         with Region
    /* "eu" */ val EU: typingsJapgolly.contentstack.mod.Region.EU & String = js.native
    
    @js.native
    sealed trait US
      extends StObject
         with Region
    /* "us" */ val US: typingsJapgolly.contentstack.mod.Region.US & String = js.native
  }
  ...
  open class Stack protected () extends StObject {
    ...
    def Assets(): typingsJapgolly.contentstack.mod.Assets = js.native
    def Assets(uid: String): Asset = js.native
    
    def ContentType(uid: String): typingsJapgolly.contentstack.mod.ContentType = js.native
  ...
  object Utils {
    ...
    inline def render(option: typingsJapgolly.contentstack.anon.Entry): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("render")(option.asInstanceOf[js.Any]).asInstanceOf[Unit]
