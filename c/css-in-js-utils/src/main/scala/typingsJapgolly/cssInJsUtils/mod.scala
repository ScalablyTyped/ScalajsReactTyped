...
import typingsJapgolly.cssInJsUtils.esAssignStyleMod.StyleObject
...
object mod {
  ...
  inline def cssifyObject(style: typingsJapgolly.cssInJsUtils.esCssifyObjectMod.StyleObject): String = ^.asInstanceOf[js.Dynamic].applyDynamic("cssifyObject")(style.asInstanceOf[js.Any]).asInstanceOf[String]
