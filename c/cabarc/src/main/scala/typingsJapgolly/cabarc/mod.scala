package typingsJapgolly.cabarc

import typingsJapgolly.cabarc.cabarcInts.`8`
import typingsJapgolly.cabarc.mod.Cabinet.COMPRESSION
  ...
  object Cabinet {
    ...
    object COMPRESSION extends StObject {
      ...
      sealed trait LZX
        extends StObject
           with COMPRESSION
      /* 0x0300 */ val LZX: typingsJapgolly.cabarc.mod.Cabinet.COMPRESSION.LZX & Double = js.native
      
      @js.native
      sealed trait MSZIP
        extends StObject
           with COMPRESSION
      /* 0x0100 */ val MSZIP: typingsJapgolly.cabarc.mod.Cabinet.COMPRESSION.MSZIP & Double = js.native
      
      @js.native
      sealed trait NONE
        extends StObject
           with COMPRESSION
      /* 0x0000 */ val NONE: typingsJapgolly.cabarc.mod.Cabinet.COMPRESSION.NONE & Double = js.native
      
      @js.native
      sealed trait QUANTUM
        extends StObject
           with COMPRESSION
      /* 0x0200 */ val QUANTUM: typingsJapgolly.cabarc.mod.Cabinet.COMPRESSION.QUANTUM & Double = js.native
    }
