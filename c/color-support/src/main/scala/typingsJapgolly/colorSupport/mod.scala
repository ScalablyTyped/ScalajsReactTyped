package typingsJapgolly.colorSupport

import org.scalablytyped.runtime.Shortcut
import typingsJapgolly.colorSupport.colorSupportBooleans.`false`
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.colorSupport.colorSupportInts.`0`
    - typingsJapgolly.colorSupport.colorSupportInts.`1`
    - typingsJapgolly.colorSupport.colorSupportInts.`2`
    - typingsJapgolly.colorSupport.colorSupportInts.`3`
  */
  trait ColorSupportLevel extends StObject
  object ColorSupportLevel {
    
    inline def `0`: typingsJapgolly.colorSupport.colorSupportInts.`0` = 0.asInstanceOf[typingsJapgolly.colorSupport.colorSupportInts.`0`]
    
    inline def `1`: typingsJapgolly.colorSupport.colorSupportInts.`1` = 1.asInstanceOf[typingsJapgolly.colorSupport.colorSupportInts.`1`]
    
    inline def `2`: typingsJapgolly.colorSupport.colorSupportInts.`2` = 2.asInstanceOf[typingsJapgolly.colorSupport.colorSupportInts.`2`]
    
    inline def `3`: typingsJapgolly.colorSupport.colorSupportInts.`3` = 3.asInstanceOf[typingsJapgolly.colorSupport.colorSupportInts.`3`]
  }
