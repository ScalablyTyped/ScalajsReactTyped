...
import typingsJapgolly.cloudflareApps.CloudflareApps.InstallOptions
...
object global {
  ...
  @js.native
  val CloudflareApps: typingsJapgolly.cloudflareApps.CloudflareApps.CloudflareApps = js.native
  ...
  @JSGlobal("INSTALL")
  @js.native
  val INSTALL: typingsJapgolly.cloudflareApps.CloudflareApps.CloudflareApps = js.native
