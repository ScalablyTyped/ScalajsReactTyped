...
object mod {
  ...
  object Severity extends StObject {
    ...
    sealed trait Error
      extends StObject
         with Severity
    /* "Error" */ val Error: typingsJapgolly.cyberblastLogger.mod.Severity.Error & String = js.native
    
    @js.native
    sealed trait Info
      extends StObject
         with Severity
    /* "Info" */ val Info: typingsJapgolly.cyberblastLogger.mod.Severity.Info & String = js.native
    
    @js.native
    sealed trait Verbose
      extends StObject
         with Severity
    /* "Verbose" */ val Verbose: typingsJapgolly.cyberblastLogger.mod.Severity.Verbose & String = js.native
    
    @js.native
    sealed trait Warning
      extends StObject
         with Severity
    /* "Warning" */ val Warning: typingsJapgolly.cyberblastLogger.mod.Severity.Warning & String = js.native
  }
  ...
  object SeverityLevel extends StObject {
    ...
    sealed trait Error
      extends StObject
         with SeverityLevel
    /* 4 */ val Error: typingsJapgolly.cyberblastLogger.mod.SeverityLevel.Error & Double = js.native
    
    @js.native
    sealed trait Info
      extends StObject
         with SeverityLevel
    /* 2 */ val Info: typingsJapgolly.cyberblastLogger.mod.SeverityLevel.Info & Double = js.native
    
    @js.native
    sealed trait Verbose
      extends StObject
         with SeverityLevel
    /* 1 */ val Verbose: typingsJapgolly.cyberblastLogger.mod.SeverityLevel.Verbose & Double = js.native
    
    @js.native
    sealed trait Warning
      extends StObject
         with SeverityLevel
    /* 3 */ val Warning: typingsJapgolly.cyberblastLogger.mod.SeverityLevel.Warning & Double = js.native
  }
