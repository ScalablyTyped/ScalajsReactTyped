...
import typingsJapgolly.cldr.cldrStrings.date
import typingsJapgolly.cldr.cldrStrings.time
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cldr.cldrStrings.cardinal
    - typingsJapgolly.cldr.cldrStrings.ordinal
  */
  trait CardinalOrOrdinal extends StObject
  object CardinalOrOrdinal {
    
    inline def cardinal: typingsJapgolly.cldr.cldrStrings.cardinal = "cardinal".asInstanceOf[typingsJapgolly.cldr.cldrStrings.cardinal]
    
    inline def ordinal: typingsJapgolly.cldr.cldrStrings.ordinal = "ordinal".asInstanceOf[typingsJapgolly.cldr.cldrStrings.ordinal]
  }
