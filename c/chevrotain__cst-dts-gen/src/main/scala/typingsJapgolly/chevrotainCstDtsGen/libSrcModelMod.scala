...
import typingsJapgolly.chevrotainCstDtsGen.chevrotainCstDtsGenStrings.rule
import typingsJapgolly.chevrotainCstDtsGen.chevrotainCstDtsGenStrings.token
...
object libSrcModelMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chevrotainCstDtsGen.libSrcModelMod.TokenArrayType
    - typingsJapgolly.chevrotainCstDtsGen.libSrcModelMod.RuleArrayType
    - js.Array[
  typingsJapgolly.chevrotainCstDtsGen.libSrcModelMod.TokenArrayType | typingsJapgolly.chevrotainCstDtsGen.libSrcModelMod.RuleArrayType]
  */
  ...
  object _PropertyArrayType {
    ...
    inline def RuleArrayType(name: String): typingsJapgolly.chevrotainCstDtsGen.libSrcModelMod.RuleArrayType = {
      val __obj = js.Dynamic.literal(kind = "rule", name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.chevrotainCstDtsGen.libSrcModelMod.RuleArrayType]
    }
    
    inline def TokenArrayType(): typingsJapgolly.chevrotainCstDtsGen.libSrcModelMod.TokenArrayType = {
      val __obj = js.Dynamic.literal(kind = "token")
      __obj.asInstanceOf[typingsJapgolly.chevrotainCstDtsGen.libSrcModelMod.TokenArrayType]
    }
  }
}
