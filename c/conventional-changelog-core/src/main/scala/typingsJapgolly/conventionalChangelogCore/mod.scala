...
import typingsJapgolly.conventionalChangelogCore.anon.ReadonlyPartialPackage
import typingsJapgolly.conventionalChangelogCore.mod.MergedContext.ExtraContext
import typingsJapgolly.conventionalChangelogCore.mod.Options.Config
import typingsJapgolly.conventionalChangelogCore.mod.Options.Config.FunctionType.Callback
import typingsJapgolly.conventionalChangelogCore.mod.Options.Logger
import typingsJapgolly.conventionalChangelogCore.mod.Options.Pkg
import typingsJapgolly.conventionalChangelogCore.mod.Options.Transform
import typingsJapgolly.conventionalCommitsParser.mod.Commit
import typingsJapgolly.gitRawCommits.mod.ExecOptions
import typingsJapgolly.gitRawCommits.mod.GitOptions
...
object mod {
  ...
  inline def apply[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */](
  ...
  trait Context
    extends StObject
       with typingsJapgolly.conventionalChangelogWriter.mod.Context {
  ...
  type MergedContext[T /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */] = T & ExtraContext
  
  trait Options[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */] extends StObject {
  ...
  object Options {
    ...
    inline def apply[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */](): Options[TCommit, TContext] = {
      val __obj = js.Dynamic.literal()
    ...
    object Config {
      ...
      object FunctionType {
        ...
        type Callback[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */] = js.Function2[/* error */ Any, /* config */ ObjectType[TCommit, TContext], Unit]
      }
      type FunctionType[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */] = js.Function1[/* callback */ Callback[TCommit, TContext], Unit]
      
      trait ObjectType[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */] extends StObject {
        ...
        var recommendedBumpOpts: js.UndefOr[typingsJapgolly.conventionalRecommendedBump.mod.Options] = js.undefined
        
        var writerOpts: js.UndefOr[WriterOptions[TCommit, TContext]] = js.undefined
      }
      object ObjectType {
        
        inline def apply[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */](): ObjectType[TCommit, TContext] = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[ObjectType[TCommit, TContext]]
        }
        
        extension [Self <: ObjectType[?, ?], TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */](x: Self & (ObjectType[TCommit, TContext])) {
          ...
          inline def setRecommendedBumpOpts(value: typingsJapgolly.conventionalRecommendedBump.mod.Options): Self = StObject.set(x, "recommendedBumpOpts", value.asInstanceOf[js.Any])
    ...
    // tslint:disable-next-line max-line-length
    type Config[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */] = js.Promise[js.Object] | js.Function | js.Object
    
    type Logger = js.Function1[/* message */ js.UndefOr[Any], Unit]
    
    extension [Self <: Options[?, ?], TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */](x: Self & (Options[TCommit, TContext])) {
      ...
      inline def setDebug(value: /* message */ js.UndefOr[Any] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "debug", js.Any.fromFunction1((t0: /* message */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setWarn(value: /* message */ js.UndefOr[Any] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "warn", js.Any.fromFunction1((t0: /* message */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    type Transform[T /* <: Commit[String | Double | js.Symbol] */] = js.ThisFunction2[
        /* this */ typingsJapgolly.node.streamMod.Transform, 
        /* commit */ Commit[String | Double | js.Symbol], 
        /* cb */ typingsJapgolly.conventionalChangelogCore.mod.Options.Transform.Callback[T], 
        Unit
      ]
  }
  ...
  trait ParserOptions
    extends StObject
       with typingsJapgolly.conventionalCommitsParser.mod.Options
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Options<TCommit, TContext> * / any */ trait WriterOptions[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */] extends StObject {
  ...
  object WriterOptions {
    ...
    inline def apply[TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */](): WriterOptions[TCommit, TContext] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[WriterOptions[TCommit, TContext]]
    }
    
    extension [Self <: WriterOptions[?, ?], TCommit /* <: Commit[String | Double | js.Symbol] */, TContext /* <: typingsJapgolly.conventionalChangelogWriter.mod.Context */](x: Self & (WriterOptions[TCommit, TContext])) {
