...
import typingsJapgolly.countriesAndTimezones.countriesAndTimezonesStrings.AF
...
trait `181` extends StObject {
  ...
  var u: typingsJapgolly.countriesAndTimezones.countriesAndTimezonesInts.`270`
}
object `181` {
  ...
  extension [Self <: `181`](x: Self) {
    ...
    inline def setU(value: typingsJapgolly.countriesAndTimezones.countriesAndTimezonesInts.`270`): Self = StObject.set(x, "u", value.asInstanceOf[js.Any])
  }
}
