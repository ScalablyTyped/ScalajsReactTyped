...
import typingsJapgolly.countriesAndTimezones.countriesAndTimezonesStrings.UG
...
object `15` {
  ...
  inline def apply(c: js.Array[UG]): `15` = {
  ...
  extension [Self <: `15`](x: Self) {
    ...
    inline def setC(value: js.Array[UG]): Self = StObject.set(x, "c", value.asInstanceOf[js.Any])
    
    inline def setCVarargs(value: UG*): Self = StObject.set(x, "c", js.Array(value*))
