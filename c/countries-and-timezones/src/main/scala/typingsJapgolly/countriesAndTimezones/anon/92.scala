...
import typingsJapgolly.countriesAndTimezones.countriesAndTimezonesStrings.BO
...
object `92` {
  ...
  inline def apply(c: js.Array[BO]): `92` = {
  ...
  extension [Self <: `92`](x: Self) {
    ...
    inline def setC(value: js.Array[BO]): Self = StObject.set(x, "c", value.asInstanceOf[js.Any])
    
    inline def setCVarargs(value: BO*): Self = StObject.set(x, "c", js.Array(value*))
