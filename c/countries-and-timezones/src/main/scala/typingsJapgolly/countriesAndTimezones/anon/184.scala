...
import typingsJapgolly.countriesAndTimezones.countriesAndTimezonesStrings.NP
...
trait `184` extends StObject {
  ...
  var u: typingsJapgolly.countriesAndTimezones.countriesAndTimezonesInts.`345`
}
object `184` {
  ...
  extension [Self <: `184`](x: Self) {
    ...
    inline def setU(value: typingsJapgolly.countriesAndTimezones.countriesAndTimezonesInts.`345`): Self = StObject.set(x, "u", value.asInstanceOf[js.Any])
  }
}
