...
import typingsJapgolly.cloudmersiveVirusApiClient.anon.Apikey
import typingsJapgolly.cloudmersiveVirusApiClient.cloudmersiveVirusApiClientStrings.apiKey_
import typingsJapgolly.cloudmersiveVirusApiClient.cloudmersiveVirusApiClientStrings.header
...
object mod {
  ...
  trait ApiClient extends StObject {
    ...
    var CollectionFormatEnum: typingsJapgolly.cloudmersiveVirusApiClient.mod.CollectionFormatEnum = js.native
  ...
  @js.native
  val ApiClient: typingsJapgolly.cloudmersiveVirusApiClient.mod.ApiClient = js.native
  ...
  object CollectionFormatEnum extends StObject {
    ...
    /* "," */ val CSV: typingsJapgolly.cloudmersiveVirusApiClient.mod.CollectionFormatEnum.CSV & String = js.native
    ...
    sealed trait MULTI
      extends StObject
         with CollectionFormatEnum
    /* "multi" */ val MULTI: typingsJapgolly.cloudmersiveVirusApiClient.mod.CollectionFormatEnum.MULTI & String = js.native
    ...
    sealed trait PIPES
      extends StObject
         with CollectionFormatEnum
    /* "|" */ val PIPES: typingsJapgolly.cloudmersiveVirusApiClient.mod.CollectionFormatEnum.PIPES & String = js.native
    ...
    sealed trait SSV
      extends StObject
         with CollectionFormatEnum
    /* " " */ val SSV: typingsJapgolly.cloudmersiveVirusApiClient.mod.CollectionFormatEnum.SSV & String = js.native
    ...
    sealed trait TSV
      extends StObject
         with CollectionFormatEnum
    /* "\t" */ val TSV: typingsJapgolly.cloudmersiveVirusApiClient.mod.CollectionFormatEnum.TSV & String = js.native
  }
  
  @JSImport("cloudmersive-virus-api-client", "ScanApi")
  @js.native
  open class ScanApi () extends StObject {
    def this(apiClient: typingsJapgolly.cloudmersiveVirusApiClient.mod.ApiClient) = this()
  ...
  trait WebsiteScanResult
    ...
    /**
      ...
      */
    var WebsiteThreatType: typingsJapgolly.cloudmersiveVirusApiClient.mod.WebsiteThreatType
  }
  ...
  object WebsiteThreatType extends StObject {
    ...
    /* "ForcedDownload" */ val ForcedDownload: typingsJapgolly.cloudmersiveVirusApiClient.mod.WebsiteThreatType.ForcedDownload & String = js.native
    
    @js.native
    sealed trait Malware
      extends StObject
         with WebsiteThreatType
    /* "Malware" */ val Malware: typingsJapgolly.cloudmersiveVirusApiClient.mod.WebsiteThreatType.Malware & String = js.native
    
    @js.native
    sealed trait None
      extends StObject
         with WebsiteThreatType
    /* "None" */ val None: typingsJapgolly.cloudmersiveVirusApiClient.mod.WebsiteThreatType.None & String = js.native
    
    @js.native
    sealed trait Phising
      extends StObject
         with WebsiteThreatType
    /* "Phishing" */ val Phising: typingsJapgolly.cloudmersiveVirusApiClient.mod.WebsiteThreatType.Phising & String = js.native
    
    @js.native
    sealed trait UnableToConnect
      extends StObject
         with WebsiteThreatType
    /* "UnableToConnect" */ val UnableToConnect: typingsJapgolly.cloudmersiveVirusApiClient.mod.WebsiteThreatType.UnableToConnect & String = js.native
  }
  ...
  trait ApiInstanceAuthentications extends StObject {
    ...
    var name: typingsJapgolly.cloudmersiveVirusApiClient.cloudmersiveVirusApiClientStrings.Apikey
  ...
  object ApiInstanceAuthentications {
    ...
    extension [Self <: ApiInstanceAuthentications](x: Self) {
      ...
      inline def setName(value: typingsJapgolly.cloudmersiveVirusApiClient.cloudmersiveVirusApiClientStrings.Apikey): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
