...
object SourceMediaType extends StObject {
  ...
  /* "text/x.cucumber.gherkin+markdown" */ val TEXT_X_CUCUMBER_GHERKIN_MARKDOWN: typingsJapgolly.cucumberMessages.distCjsSrcMessagesMod.SourceMediaType.TEXT_X_CUCUMBER_GHERKIN_MARKDOWN & String = js.native
  
  @js.native
  sealed trait TEXT_X_CUCUMBER_GHERKIN_PLAIN
    extends StObject
       with SourceMediaType
  /* "text/x.cucumber.gherkin+plain" */ val TEXT_X_CUCUMBER_GHERKIN_PLAIN: typingsJapgolly.cucumberMessages.distCjsSrcMessagesMod.SourceMediaType.TEXT_X_CUCUMBER_GHERKIN_PLAIN & String = js.native
}
