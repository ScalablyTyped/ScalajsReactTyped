...
object InitOptions {
  ...
  def apply(
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction2((t0: /* error */ scala.Boolean, t1: /* response */ typingsJapgolly.clearbladejsNode.mod.Resp) => callback(t0, t1).runNow()))
