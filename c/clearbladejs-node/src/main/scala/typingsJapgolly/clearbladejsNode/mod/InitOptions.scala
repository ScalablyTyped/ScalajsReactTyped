...
object InitOptions {
  ...
  extension [Self <: InitOptions](x: Self) {
    ...
    inline def setCallback(value: (/* error */ Boolean, /* response */ Resp) => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* error */ Boolean, t1: /* response */ Resp) => (value(t0, t1)).runNow()))
