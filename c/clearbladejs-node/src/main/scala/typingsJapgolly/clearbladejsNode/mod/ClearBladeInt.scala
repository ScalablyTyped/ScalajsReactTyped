...
trait ClearBladeInt extends StObject {
  ...
  def Code(): typingsJapgolly.clearbladejsNode.mod.Code = js.native
  
  def Collection(options: String): typingsJapgolly.clearbladejsNode.mod.Collection = js.native
  def Collection(options: CollectionOptionsWithID): typingsJapgolly.clearbladejsNode.mod.Collection = js.native
  def Collection(options: CollectionOptionsWithName): typingsJapgolly.clearbladejsNode.mod.Collection = js.native
  
  def Item(data: js.Object, options: String): typingsJapgolly.clearbladejsNode.mod.Item = js.native
  def Item(data: js.Object, options: ItemOptions): typingsJapgolly.clearbladejsNode.mod.Item = js.native
  
  def Messaging(options: MessagingOptions, callback: CbCallback): typingsJapgolly.clearbladejsNode.mod.Messaging = js.native
