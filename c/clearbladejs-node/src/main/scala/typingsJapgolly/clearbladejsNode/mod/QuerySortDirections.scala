...
object QuerySortDirections extends StObject {
  ...
  /* "ASC" */ val QUERY_SORT_ASCENDING: typingsJapgolly.clearbladejsNode.mod.QuerySortDirections.QUERY_SORT_ASCENDING & String = js.native
  
  @js.native
  sealed trait QUERY_SORT_DESCENDING
    extends StObject
       with QuerySortDirections
  /* "DESC" */ val QUERY_SORT_DESCENDING: typingsJapgolly.clearbladejsNode.mod.QuerySortDirections.QUERY_SORT_DESCENDING & String = js.native
}
