package typingsJapgolly.cookies
...
import typingsJapgolly.cookies.anon.Instantiable
import typingsJapgolly.cookies.cookiesStrings.lax
import typingsJapgolly.cookies.cookiesStrings.none
import typingsJapgolly.cookies.cookiesStrings.strict
...
object mod extends Shortcut {
  ...
  object Cookie {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(domain = domain.asInstanceOf[js.Any], expires = expires.asInstanceOf[js.Any], httpOnly = httpOnly.asInstanceOf[js.Any], maxAge = maxAge.asInstanceOf[js.Any], maxage = maxage.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], overwrite = overwrite.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any], sameSite = sameSite.asInstanceOf[js.Any], secure = secure.asInstanceOf[js.Any], toHeader = toHeader.toJsFn, value = value.asInstanceOf[js.Any])
    ...
    extension [Self <: Cookie](x: Self) {
      ...
      inline def setToHeader(value: CallbackTo[String]): Self = StObject.set(x, "toHeader", value.toJsFn)
