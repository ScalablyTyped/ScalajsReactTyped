...
object CanvasGauges {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.normal
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.italic
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.oblique
  */
  trait FontStyle extends StObject
  object FontStyle {
    
    inline def italic: typingsJapgolly.canvasGauges.canvasGaugesStrings.italic = "italic".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.italic]
    
    inline def normal: typingsJapgolly.canvasGauges.canvasGaugesStrings.normal = "normal".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.normal]
    
    inline def oblique: typingsJapgolly.canvasGauges.canvasGaugesStrings.oblique = "oblique".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.oblique]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.normal
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.bold
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.bolder
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.lighter
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.`100`
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.`200`
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.`300`
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.`400`
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.`500`
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.`600`
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.`700`
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.`800`
    - typingsJapgolly.canvasGauges.canvasGaugesStrings.`900`
  */
  trait FontWeight extends StObject
  object FontWeight {
    
    inline def `100`: typingsJapgolly.canvasGauges.canvasGaugesStrings.`100` = "100".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.`100`]
    
    inline def `200`: typingsJapgolly.canvasGauges.canvasGaugesStrings.`200` = "200".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.`200`]
    
    inline def `300`: typingsJapgolly.canvasGauges.canvasGaugesStrings.`300` = "300".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.`300`]
    
    inline def `400`: typingsJapgolly.canvasGauges.canvasGaugesStrings.`400` = "400".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.`400`]
    
    inline def `500`: typingsJapgolly.canvasGauges.canvasGaugesStrings.`500` = "500".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.`500`]
    
    inline def `600`: typingsJapgolly.canvasGauges.canvasGaugesStrings.`600` = "600".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.`600`]
    
    inline def `700`: typingsJapgolly.canvasGauges.canvasGaugesStrings.`700` = "700".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.`700`]
    
    inline def `800`: typingsJapgolly.canvasGauges.canvasGaugesStrings.`800` = "800".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.`800`]
    
    inline def `900`: typingsJapgolly.canvasGauges.canvasGaugesStrings.`900` = "900".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.`900`]
    
    inline def bold: typingsJapgolly.canvasGauges.canvasGaugesStrings.bold = "bold".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.bold]
    
    inline def bolder: typingsJapgolly.canvasGauges.canvasGaugesStrings.bolder = "bolder".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.bolder]
    
    inline def lighter: typingsJapgolly.canvasGauges.canvasGaugesStrings.lighter = "lighter".asInstanceOf[typingsJapgolly.canvasGauges.canvasGaugesStrings.lighter]
  ...
  object SmartCanvas {
    ...
    inline def apply(
      ...
      init: CallbackTo[Any],
      minSide: Double,
      onRedraw: CallbackTo[Any],
      pixelRatio: Double,
      redraw: CallbackTo[SmartCanvas],
      width: Double
    ): SmartCanvas = {
      val __obj = js.Dynamic.literal(commit = commit.toJsFn, context = context.asInstanceOf[js.Any], contextClone = contextClone.asInstanceOf[js.Any], destroy = destroy.toJsFn, drawHeight = drawHeight.asInstanceOf[js.Any], drawWidth = drawWidth.asInstanceOf[js.Any], drawX = drawX.asInstanceOf[js.Any], drawY = drawY.asInstanceOf[js.Any], element = element.asInstanceOf[js.Any], elementClone = elementClone.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], init = init.toJsFn, minSide = minSide.asInstanceOf[js.Any], onRedraw = onRedraw.toJsFn, pixelRatio = pixelRatio.asInstanceOf[js.Any], redraw = redraw.toJsFn, width = width.asInstanceOf[js.Any])
      __obj.asInstanceOf[SmartCanvas]
    }
    
    extension [Self <: SmartCanvas](x: Self) {
      
      inline def setCommit(value: CallbackTo[SmartCanvas]): Self = StObject.set(x, "commit", value.toJsFn)
      ...
      inline def setOnRedraw(value: CallbackTo[Any]): Self = StObject.set(x, "onRedraw", value.toJsFn)
      
      inline def setPixelRatio(value: Double): Self = StObject.set(x, "pixelRatio", value.asInstanceOf[js.Any])
      
      inline def setRedraw(value: CallbackTo[SmartCanvas]): Self = StObject.set(x, "redraw", value.toJsFn)
