...
object SignaturePolicy extends StObject {
  ...
  /* "StrictNoSign" */ val StrictNoSign: typingsJapgolly.chainsafeLibp2pGossipsub.distSrcTypesMod.SignaturePolicy.StrictNoSign & String = js.native
  ...
  sealed trait StrictSign
    extends StObject
       with SignaturePolicy
  /* "StrictSign" */ val StrictSign: typingsJapgolly.chainsafeLibp2pGossipsub.distSrcTypesMod.SignaturePolicy.StrictSign & String = js.native
}
