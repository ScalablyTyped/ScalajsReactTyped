...
object PublishConfigType extends StObject {
  ...
  /* 1 */ val Anonymous: typingsJapgolly.chainsafeLibp2pGossipsub.distSrcTypesMod.PublishConfigType.Anonymous & Double = js.native
  
  @js.native
  sealed trait Signing
    extends StObject
       with PublishConfigType
  /* 0 */ val Signing: typingsJapgolly.chainsafeLibp2pGossipsub.distSrcTypesMod.PublishConfigType.Signing & Double = js.native
}
