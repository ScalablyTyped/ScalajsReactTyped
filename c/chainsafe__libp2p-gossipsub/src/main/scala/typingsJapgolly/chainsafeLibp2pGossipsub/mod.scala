...
import typingsJapgolly.chainsafeLibp2pGossipsub.anon.PartialGossipsubOpts
...
import typingsJapgolly.chainsafeLibp2pGossipsub.anon.RequiredGossipOptions
import typingsJapgolly.chainsafeLibp2pGossipsub.distSrcConfigMod.GossipsubOptsSpec
...
import typingsJapgolly.chainsafeLibp2pGossipsub.distSrcScoreMod.PeerScore
import typingsJapgolly.chainsafeLibp2pGossipsub.distSrcScorePeerScoreMod.PeerScoreStatsDump
...
import typingsJapgolly.chainsafeLibp2pGossipsub.distSrcStreamMod.InboundStream
import typingsJapgolly.chainsafeLibp2pGossipsub.distSrcStreamMod.OutboundStream
import typingsJapgolly.chainsafeLibp2pGossipsub.distSrcTracerMod.IWantTracer
...
import typingsJapgolly.chainsafeLibp2pGossipsub.distSrcTypesMod.MsgIdStr
...
import typingsJapgolly.chainsafeLibp2pGossipsub.distSrcTypesMod.TopicValidatorFn
...
object mod {
  ...
  trait GossipsubEvents
    ...
    var gossipsubColonheartbeat: CustomEvent
    
    @JSName("gossipsub:message")
    var gossipsubColonmessage: CustomEvent
  }
  object GossipsubEvents {
    
    inline def apply(
      gossipsubColonheartbeat: CustomEvent,
      gossipsubColonmessage: CustomEvent,
      message: CustomEvent,
    ...
    extension [Self <: GossipsubEvents](x: Self) {
      ...
      inline def setGossipsubColonheartbeat(value: CustomEvent): Self = StObject.set(x, "gossipsub:heartbeat", value.asInstanceOf[js.Any])
      
      inline def setGossipsubColonmessage(value: CustomEvent): Self = StObject.set(x, "gossipsub:message", value.asInstanceOf[js.Any])
    }
  }
