...
object IHaveIgnoreReason extends StObject {
  ...
  /* "low_score" */ val LowScore: typingsJapgolly.chainsafeLibp2pGossipsub.distSrcMetricsMod.IHaveIgnoreReason.LowScore & String = js.native
  
  @js.native
  sealed trait MaxIasked
    extends StObject
       with IHaveIgnoreReason
  /* "max_iasked" */ val MaxIasked: typingsJapgolly.chainsafeLibp2pGossipsub.distSrcMetricsMod.IHaveIgnoreReason.MaxIasked & String = js.native
  
  @js.native
  sealed trait MaxIhave
    extends StObject
       with IHaveIgnoreReason
  /* "max_ihave" */ val MaxIhave: typingsJapgolly.chainsafeLibp2pGossipsub.distSrcMetricsMod.IHaveIgnoreReason.MaxIhave & String = js.native
}
