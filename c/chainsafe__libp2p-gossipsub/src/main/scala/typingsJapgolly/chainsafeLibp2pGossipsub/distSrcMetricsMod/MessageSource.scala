...
object MessageSource extends StObject {
  ...
  sealed trait forward
    extends StObject
       with MessageSource
  /* "forward" */ val forward: typingsJapgolly.chainsafeLibp2pGossipsub.distSrcMetricsMod.MessageSource.forward & String = js.native
  
  @js.native
  sealed trait publish
    extends StObject
       with MessageSource
  /* "publish" */ val publish: typingsJapgolly.chainsafeLibp2pGossipsub.distSrcMetricsMod.MessageSource.publish & String = js.native
}
