...
object distSrcUtilsBuildRawMessageMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chainsafeLibp2pGossipsub.anon.Valid
    - typingsJapgolly.chainsafeLibp2pGossipsub.anon.ErrorValid
  */
  trait ValidationResult extends StObject
  object ValidationResult {
    
    inline def ErrorValid(error: ValidateError): typingsJapgolly.chainsafeLibp2pGossipsub.anon.ErrorValid = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any], valid = false)
      __obj.asInstanceOf[typingsJapgolly.chainsafeLibp2pGossipsub.anon.ErrorValid]
    }
    
    inline def Valid(message: Message): typingsJapgolly.chainsafeLibp2pGossipsub.anon.Valid = {
      val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any], valid = true)
      __obj.asInstanceOf[typingsJapgolly.chainsafeLibp2pGossipsub.anon.Valid]
    }
  }
}
