...
import typingsJapgolly.denque.mod.^
...
object distSrcScoreMessageDeliveriesMod {
  ...
  object DeliveryRecordStatus extends StObject {
    ...
    /* 3 */ val ignored: typingsJapgolly.chainsafeLibp2pGossipsub.distSrcScoreMessageDeliveriesMod.DeliveryRecordStatus.ignored & Double = js.native
    ...
    sealed trait invalid
      extends StObject
         with DeliveryRecordStatus
    /* 2 */ val invalid: typingsJapgolly.chainsafeLibp2pGossipsub.distSrcScoreMessageDeliveriesMod.DeliveryRecordStatus.invalid & Double = js.native
    ...
    sealed trait unknown
      extends StObject
         with DeliveryRecordStatus
    /* 0 */ val unknown: typingsJapgolly.chainsafeLibp2pGossipsub.distSrcScoreMessageDeliveriesMod.DeliveryRecordStatus.unknown & Double = js.native
    ...
    sealed trait valid
      extends StObject
         with DeliveryRecordStatus
    /* 1 */ val valid: typingsJapgolly.chainsafeLibp2pGossipsub.distSrcScoreMessageDeliveriesMod.DeliveryRecordStatus.valid & Double = js.native
  }
