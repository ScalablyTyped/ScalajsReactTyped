package typingsJapgolly.canvasTxt

import org.scalajs.dom.CanvasRenderingContext2D
import typingsJapgolly.canvasTxt.canvasTxtStrings.bottom
import typingsJapgolly.canvasTxt.canvasTxtStrings.center
import typingsJapgolly.canvasTxt.canvasTxtStrings.left
import typingsJapgolly.canvasTxt.canvasTxtStrings.middle
import typingsJapgolly.canvasTxt.canvasTxtStrings.right
import typingsJapgolly.canvasTxt.canvasTxtStrings.top
...
object mod {
  ...
  inline def drawText(ctx: CanvasRenderingContext2D, text: String, x: Double, y: Double, width: Double, height: Double): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("drawText")(ctx.asInstanceOf[js.Any], text.asInstanceOf[js.Any], x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any])).asInstanceOf[Any]
