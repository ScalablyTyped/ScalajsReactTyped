...
object mod {
  ...
  object Captcha {
    ...
    inline def apply(get: CallbackTo[js.Tuple2[String, Buffer]]): Captcha = {
    ...
    extension [Self <: Captcha](x: Self) {
      ...
      inline def setGet(value: CallbackTo[js.Tuple2[String, Buffer]]): Self = StObject.set(x, "get", value.toJsFn)
    }
  }
