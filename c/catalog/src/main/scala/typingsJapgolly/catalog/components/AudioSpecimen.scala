...
object AudioSpecimen {
  ...
  inline def apply(src: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[SpecimenProps & AudioSpecimenProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.catalog.mod.AudioSpecimen] {
  ...
  def withProps(p: SpecimenProps & AudioSpecimenProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
