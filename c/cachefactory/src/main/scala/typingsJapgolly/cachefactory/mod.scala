...
object mod {
  ...
  object CacheOptions {
    ...
    extension [Self <: CacheOptions](x: Self) {
      ...
      inline def setOnExpire(value: (/* key */ String, /* value */ Any, /* done */ js.UndefOr[js.Function]) => Callback): Self = StObject.set(x, "onExpire", js.Any.fromFunction3((t0: /* key */ String, t1: /* value */ Any, t2: /* done */ js.UndefOr[js.Function]) => (value(t0, t1, t2)).runNow()))
  ...
  */
  ...
  object DeleteOnExpire {
    ...
    inline def aggressive: typingsJapgolly.cachefactory.cachefactoryStrings.aggressive = "aggressive".asInstanceOf[typingsJapgolly.cachefactory.cachefactoryStrings.aggressive]
    
    inline def none: typingsJapgolly.cachefactory.cachefactoryStrings.none = "none".asInstanceOf[typingsJapgolly.cachefactory.cachefactoryStrings.none]
    
    inline def passive: typingsJapgolly.cachefactory.cachefactoryStrings.passive = "passive".asInstanceOf[typingsJapgolly.cachefactory.cachefactoryStrings.passive]
  }
  ...
  */
  ...
  object StorageMode {
    ...
    inline def localStorage: typingsJapgolly.cachefactory.cachefactoryStrings.localStorage = "localStorage".asInstanceOf[typingsJapgolly.cachefactory.cachefactoryStrings.localStorage]
    
    inline def memory: typingsJapgolly.cachefactory.cachefactoryStrings.memory = "memory".asInstanceOf[typingsJapgolly.cachefactory.cachefactoryStrings.memory]
    
    inline def sessionStorage: typingsJapgolly.cachefactory.cachefactoryStrings.sessionStorage = "sessionStorage".asInstanceOf[typingsJapgolly.cachefactory.cachefactoryStrings.sessionStorage]
  }
