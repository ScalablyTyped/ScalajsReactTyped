package typingsJapgolly.contextjs
...
object mod {
  ...
  object InitSettings {
    ...
    extension [Self <: InitSettings](x: Self) {
      ...
      inline def setFilter(value: /* e */ Element => Callback): Self = StObject.set(x, "filter", js.Any.fromFunction1((t0: /* e */ Element) => value(t0).runNow()))
  ...
  object MenuObject {
    ...
    extension [Self <: MenuObject](x: Self) {
      ...
      inline def setAction(value: /* e */ Event => Callback): Self = StObject.set(x, "action", js.Any.fromFunction1((t0: /* e */ Event) => value(t0).runNow()))
