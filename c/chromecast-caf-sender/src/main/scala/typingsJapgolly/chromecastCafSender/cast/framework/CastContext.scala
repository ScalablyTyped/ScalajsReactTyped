...
import typingsJapgolly.chromecastCafSender.cast.framework.CastContextEventType.CAST_STATE_CHANGED
import typingsJapgolly.chromecastCafSender.cast.framework.CastContextEventType.SESSION_STATE_CHANGED
