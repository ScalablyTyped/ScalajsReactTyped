...
import typingsJapgolly.conventionalChangelogConfigSpec.versions2Dot1Dot0SchemaDotjsonMod.Config.Type
...
object versions2Dot1Dot0SchemaDotjsonMod extends Shortcut {
  ...
  object Config {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.conventionalChangelogConfigSpec.versions2Dot1Dot0SchemaDotjsonMod.Config.Type.WithSection
      - typingsJapgolly.conventionalChangelogConfigSpec.versions2Dot1Dot0SchemaDotjsonMod.Config.Type.WithHidden
    */
