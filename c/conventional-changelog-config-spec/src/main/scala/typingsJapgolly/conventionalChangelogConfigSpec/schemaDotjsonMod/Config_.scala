package typingsJapgolly.conventionalChangelogConfigSpec.schemaDotjsonMod

import typingsJapgolly.conventionalChangelogConfigSpec.schemaDotjsonMod.Config.Type
