...
import typingsJapgolly.colord.colordStrings.AA
import typingsJapgolly.colord.colordStrings.AAA
import typingsJapgolly.colord.colordStrings.large
import typingsJapgolly.colord.colordStrings.normal
...
object pluginsA11yMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `pluginsA11yMod.foo` */
