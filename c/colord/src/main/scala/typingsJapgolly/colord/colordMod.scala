...
import typingsJapgolly.colord.pluginsA11yMod.ReadabilityOptions
import typingsJapgolly.colord.pluginsA11yMod.colordColordAugmentingMod.Colord
import typingsJapgolly.colord.pluginsHarmoniesMod.HarmonyType
import typingsJapgolly.colord.pluginsMinifyMod.MinificationOptions
import typingsJapgolly.colord.pluginsNamesMod.ConvertOptions
import typingsJapgolly.colord.typesMod.AnyColor
import typingsJapgolly.colord.typesMod.CmykaColor
import typingsJapgolly.colord.typesMod.HslaColor
import typingsJapgolly.colord.typesMod.HsvaColor
import typingsJapgolly.colord.typesMod.HwbaColor
import typingsJapgolly.colord.typesMod.LabaColor
import typingsJapgolly.colord.typesMod.LchaColor
import typingsJapgolly.colord.typesMod.RgbaColor
...
object colordMod {
  ...
  open class Colord_ protected () extends StObject {
    ...
    def delta(color: typingsJapgolly.colord.pluginsLabMod.colordColordAugmentingMod.Colord): Double = js.native
    ...
    /**
      ...
      */
    def harmonies(): js.Array[typingsJapgolly.colord.pluginsHarmoniesMod.colordColordAugmentingMod.Colord] = js.native
    def harmonies(`type`: HarmonyType): js.Array[typingsJapgolly.colord.pluginsHarmoniesMod.colordColordAugmentingMod.Colord] = js.native
    ...
    def mix(color2: typingsJapgolly.colord.pluginsMixMod.colordColordAugmentingMod.Colord): typingsJapgolly.colord.pluginsMixMod.colordColordAugmentingMod.Colord = js.native
    def mix(color2: typingsJapgolly.colord.pluginsMixMod.colordColordAugmentingMod.Colord, ratio: Double): typingsJapgolly.colord.pluginsMixMod.colordColordAugmentingMod.Colord = js.native
    /**
      * Produces a mixture of two colors through CIE LAB color space and returns a new Colord instance.
      */
    def mix(color2: AnyColor): typingsJapgolly.colord.pluginsMixMod.colordColordAugmentingMod.Colord = js.native
    def mix(color2: AnyColor, ratio: Double): typingsJapgolly.colord.pluginsMixMod.colordColordAugmentingMod.Colord = js.native
    ...
    /**
      ...
      */
    def shades(): js.Array[typingsJapgolly.colord.pluginsMixMod.colordColordAugmentingMod.Colord] = js.native
    def shades(count: Double): js.Array[typingsJapgolly.colord.pluginsMixMod.colordColordAugmentingMod.Colord] = js.native
    
    /**
      * Generates a tints palette based on original color.
      */
    def tints(): js.Array[typingsJapgolly.colord.pluginsMixMod.colordColordAugmentingMod.Colord] = js.native
    def tints(count: Double): js.Array[typingsJapgolly.colord.pluginsMixMod.colordColordAugmentingMod.Colord] = js.native
    ...
    /**
      ...
      */
    def tones(): js.Array[typingsJapgolly.colord.pluginsMixMod.colordColordAugmentingMod.Colord] = js.native
    def tones(count: Double): js.Array[typingsJapgolly.colord.pluginsMixMod.colordColordAugmentingMod.Colord] = js.native
  }
