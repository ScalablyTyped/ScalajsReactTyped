...
import typingsJapgolly.codemirror.mod.AutoCloseBrackets
import typingsJapgolly.codemirror.mod.AutoCloseTags
import typingsJapgolly.codemirror.mod.Editor
import typingsJapgolly.codemirror.mod.EditorConfiguration
import typingsJapgolly.codemirror.mod.HighlightSelectionMatches
import typingsJapgolly.codemirror.mod.InputStyle
import typingsJapgolly.codemirror.mod.KeyMap
import typingsJapgolly.codemirror.mod.LintOptions
import typingsJapgolly.codemirror.mod.MatchBrackets
import typingsJapgolly.codemirror.mod.MatchTags
import typingsJapgolly.codemirror.mod.ShowHintOptions
...
object MergeViewEditorConfiguration {
  ...
  def apply(
    ...
    keyMap: String = null,
    lineNumberFormatter: /* line */ Double => CallbackTo[String] = null,
    ...
    mode: js.Any = null,
    onCollapse: (/* mergeView */ MergeViewEditor, /* line */ Double, /* size */ Double, /* mark */ TextMarker) => Callback = null,
    onDragEvent: (/* instance */ Editor, /* event */ DragEvent) => CallbackTo[Boolean] = null,
    onKeyEvent: (/* instance */ Editor, /* event */ KeyboardEvent) => CallbackTo[Boolean] = null,
    ...
    if (lineNumberFormatter != null) __obj.updateDynamic("lineNumberFormatter")(js.Any.fromFunction1((t0: /* line */ scala.Double) => lineNumberFormatter(t0).runNow()))
    ...
    if (onCollapse != null) __obj.updateDynamic("onCollapse")(js.Any.fromFunction4((t0: /* mergeView */ typingsJapgolly.codemirror.mod.MergeView.MergeViewEditor, t1: /* line */ scala.Double, t2: /* size */ scala.Double, t3: /* mark */ typingsJapgolly.codemirror.mod.TextMarker) => onCollapse(t0, t1, t2, t3).runNow()))
    if (onDragEvent != null) __obj.updateDynamic("onDragEvent")(js.Any.fromFunction2((t0: /* instance */ typingsJapgolly.codemirror.mod.Editor, t1: /* event */ org.scalajs.dom.raw.DragEvent) => onDragEvent(t0, t1).runNow()))
    if (onKeyEvent != null) __obj.updateDynamic("onKeyEvent")(js.Any.fromFunction2((t0: /* instance */ typingsJapgolly.codemirror.mod.Editor, t1: /* event */ org.scalajs.dom.raw.KeyboardEvent) => onKeyEvent(t0, t1).runNow()))
