...
import typingsJapgolly.codemirror.codemirrorStrings.`after-top`
import typingsJapgolly.codemirror.codemirrorStrings.`before-bottom`
import typingsJapgolly.codemirror.codemirrorStrings.bottom
import typingsJapgolly.codemirror.codemirrorStrings.top
