...
object TextMarkerOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(addToHistory)) __obj.updateDynamic("addToHistory")(addToHistory.asInstanceOf[js.Any])
    if (!js.isUndefined(atomic)) __obj.updateDynamic("atomic")(atomic.asInstanceOf[js.Any])
    if (className != null) __obj.updateDynamic("className")(className.asInstanceOf[js.Any])
    if (!js.isUndefined(clearOnEnter)) __obj.updateDynamic("clearOnEnter")(clearOnEnter.asInstanceOf[js.Any])
    if (!js.isUndefined(clearWhenEmpty)) __obj.updateDynamic("clearWhenEmpty")(clearWhenEmpty.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(inclusiveLeft)) __obj.updateDynamic("inclusiveLeft")(inclusiveLeft.asInstanceOf[js.Any])
    if (!js.isUndefined(inclusiveRight)) __obj.updateDynamic("inclusiveRight")(inclusiveRight.asInstanceOf[js.Any])
