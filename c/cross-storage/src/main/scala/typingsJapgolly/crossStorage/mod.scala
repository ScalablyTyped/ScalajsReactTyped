package typingsJapgolly.crossStorage
...
object mod {
  ...
  */
  ...
  object CrossStorageMethod {
    ...
    inline def clear: typingsJapgolly.crossStorage.crossStorageStrings.clear = "clear".asInstanceOf[typingsJapgolly.crossStorage.crossStorageStrings.clear]
    
    inline def del: typingsJapgolly.crossStorage.crossStorageStrings.del = "del".asInstanceOf[typingsJapgolly.crossStorage.crossStorageStrings.del]
    
    inline def get: typingsJapgolly.crossStorage.crossStorageStrings.get = "get".asInstanceOf[typingsJapgolly.crossStorage.crossStorageStrings.get]
    
    inline def getKeys: typingsJapgolly.crossStorage.crossStorageStrings.getKeys = "getKeys".asInstanceOf[typingsJapgolly.crossStorage.crossStorageStrings.getKeys]
    
    inline def set: typingsJapgolly.crossStorage.crossStorageStrings.set = "set".asInstanceOf[typingsJapgolly.crossStorage.crossStorageStrings.set]
  }
