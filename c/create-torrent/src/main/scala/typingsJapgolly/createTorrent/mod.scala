...
object mod {
  ...
  object CreateTorrentOptions {
    ...
    extension [Self <: CreateTorrentOptions](x: Self) {
      ...
      inline def setOnProgress(value: (/* hashedLength */ Double, /* estimatedTorrentLength */ Double) => Callback): Self = StObject.set(x, "onProgress", js.Any.fromFunction2((t0: /* hashedLength */ Double, t1: /* estimatedTorrentLength */ Double) => (value(t0, t1)).runNow()))
