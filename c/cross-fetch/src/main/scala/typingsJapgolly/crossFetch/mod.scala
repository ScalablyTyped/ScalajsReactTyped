...
object mod extends js.Object {
  @js.native
  class Headers ()
    extends typingsJapgolly.std.Headers {
  ...
  @js.native
  class Response ()
    extends typingsJapgolly.std.Response {
  ...
  @js.native
  object Headers
    extends Instantiable0[typingsJapgolly.std.Headers]
       with Instantiable1[/* init */ HeadersInit, typingsJapgolly.std.Headers]
  ...
  @js.native
  object Response
    extends Instantiable0[typingsJapgolly.std.Response]
       with Instantiable1[/* body */ BodyInit, typingsJapgolly.std.Response]
       with Instantiable2[
          (/* body */ BodyInit) | (/* body */ Null), 
          /* init */ typingsJapgolly.std.ResponseInit, 
          typingsJapgolly.std.Response
        ] {
