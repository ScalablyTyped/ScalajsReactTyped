package typingsJapgolly.commandLineUsage

import typingsJapgolly.commandLineUsage.anon.Data
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.commandLineUsage.mod.Content
    - typingsJapgolly.commandLineUsage.mod.OptionList
  */
  trait Section extends StObject
  object Section {
    
    inline def Content(): typingsJapgolly.commandLineUsage.mod.Content = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.commandLineUsage.mod.Content]
    }
    
    inline def OptionList(): typingsJapgolly.commandLineUsage.mod.OptionList = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.commandLineUsage.mod.OptionList]
    }
  }
}
