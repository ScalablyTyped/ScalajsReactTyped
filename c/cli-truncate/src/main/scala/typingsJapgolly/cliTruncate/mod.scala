package typingsJapgolly.cliTruncate

import typingsJapgolly.cliTruncate.cliTruncateStrings.end
import typingsJapgolly.cliTruncate.cliTruncateStrings.middle
import typingsJapgolly.cliTruncate.cliTruncateStrings.start
