...
object distSrcItokenMod {
  ...
  object IGherkinLine {
    ...
    inline def apply(
      ...
      getTableCells: CallbackTo[js.Array[Item]],
      isEmpty: Boolean,
      lineNumber: Double,
    ...
    extension [Self <: IGherkinLine](x: Self) {
      ...
      inline def setGetTableCells(value: CallbackTo[js.Array[Item]]): Self = StObject.set(x, "getTableCells", value.toJsFn)
