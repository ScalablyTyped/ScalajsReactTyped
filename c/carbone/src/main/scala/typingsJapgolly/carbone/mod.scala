...
import typingsJapgolly.carbone.anon.Rates
...
object mod {
  ...
  */
  ...
  object DocumentType {
    ...
    inline def document: typingsJapgolly.carbone.carboneStrings.document = "document".asInstanceOf[typingsJapgolly.carbone.carboneStrings.document]
    
    inline def graphics: typingsJapgolly.carbone.carboneStrings.graphics = "graphics".asInstanceOf[typingsJapgolly.carbone.carboneStrings.graphics]
    
    inline def presentation: typingsJapgolly.carbone.carboneStrings.presentation = "presentation".asInstanceOf[typingsJapgolly.carbone.carboneStrings.presentation]
    
    inline def spreadsheet: typingsJapgolly.carbone.carboneStrings.spreadsheet = "spreadsheet".asInstanceOf[typingsJapgolly.carbone.carboneStrings.spreadsheet]
    
    inline def web: typingsJapgolly.carbone.carboneStrings.web = "web".asInstanceOf[typingsJapgolly.carbone.carboneStrings.web]
  }
