...
import typingsJapgolly.commitlintTypes.libParseMod.CommitNote
import typingsJapgolly.commitlintTypes.libParseMod.CommitReference
...
import typingsJapgolly.commitlintTypes.libRulesMod.RuleConfigQuality.User
