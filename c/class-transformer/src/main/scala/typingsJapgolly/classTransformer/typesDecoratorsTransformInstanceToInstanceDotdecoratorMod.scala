...
object typesDecoratorsTransformInstanceToInstanceDotdecoratorMod {
  
  @JSImport("class-transformer/types/decorators/transform-instance-to-instance.decorator", JSImport.Namespace)
  @js.native
