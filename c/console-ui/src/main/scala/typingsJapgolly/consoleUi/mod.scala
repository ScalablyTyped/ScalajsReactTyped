...
import typingsJapgolly.consoleUi.anon.Ci
...
object mod {
  ...
  */
  ...
  object WriteLevel {
    ...
    inline def DEBUG: typingsJapgolly.consoleUi.consoleUiStrings.DEBUG = "DEBUG".asInstanceOf[typingsJapgolly.consoleUi.consoleUiStrings.DEBUG]
    
    inline def ERROR: typingsJapgolly.consoleUi.consoleUiStrings.ERROR = "ERROR".asInstanceOf[typingsJapgolly.consoleUi.consoleUiStrings.ERROR]
    
    inline def INFO: typingsJapgolly.consoleUi.consoleUiStrings.INFO = "INFO".asInstanceOf[typingsJapgolly.consoleUi.consoleUiStrings.INFO]
    
    inline def WARNING: typingsJapgolly.consoleUi.consoleUiStrings.WARNING = "WARNING".asInstanceOf[typingsJapgolly.consoleUi.consoleUiStrings.WARNING]
  }
}
