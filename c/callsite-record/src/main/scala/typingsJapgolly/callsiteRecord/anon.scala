package typingsJapgolly.callsiteRecord

import typingsJapgolly.callsiteRecord.mod.StackFrame
import typingsJapgolly.callsiteRecord.mod.isCallSiteFrame
...
object anon {
  ...
  trait PickCreateCallsiteRecordO extends StObject {
    ...
    var processFrameFn: js.UndefOr[typingsJapgolly.callsiteRecord.mod.processFrameFn] = js.undefined
  }
