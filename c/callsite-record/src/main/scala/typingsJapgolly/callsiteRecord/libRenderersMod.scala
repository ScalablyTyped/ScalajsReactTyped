...
import typingsJapgolly.callsiteRecord.anon.Comment
...
object libRenderersMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.callsiteRecord.libRenderersMod.RendererWithoutSyntax
    - typingsJapgolly.callsiteRecord.libRenderersMod.RendererWithSyntax
  */
  ...
  object Renderer {
    ...
    inline def RendererWithSyntax(
      ...
      __obj.asInstanceOf[typingsJapgolly.callsiteRecord.libRenderersMod.RendererWithSyntax]
    }
    ...
    inline def RendererWithoutSyntax(
      ...
      __obj.asInstanceOf[typingsJapgolly.callsiteRecord.libRenderersMod.RendererWithoutSyntax]
    }
  }
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.callsiteRecord.libRenderersMod.Renderer because Already inherited */ trait RendererWithSyntax
    extends StObject
