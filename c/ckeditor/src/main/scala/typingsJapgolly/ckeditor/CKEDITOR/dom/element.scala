...
import typingsJapgolly.ckeditor.CKEDITOR.dtdDefinition
import typingsJapgolly.ckeditor.CKEDITOR.editor
import typingsJapgolly.ckeditor.ckeditorBooleans.`false`
import typingsJapgolly.ckeditor.ckeditorNumbers.`1`
...
object element extends js.Object {
  ...
  def get(element: typingsJapgolly.std.HTMLElement): element = js.native
