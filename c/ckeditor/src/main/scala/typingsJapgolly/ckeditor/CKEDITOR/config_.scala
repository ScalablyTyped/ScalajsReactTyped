...
import typingsJapgolly.ckeditor.AnonGroups
import typingsJapgolly.ckeditor.CKEDITOR.config.styleObject
import typingsJapgolly.ckeditor.CKEDITOR.dom.element
import typingsJapgolly.ckeditor.CKEDITOR.editor.eventObject
import typingsJapgolly.ckeditor.CKEDITOR.filter.allowedContentRules
import typingsJapgolly.ckeditor.CKEDITOR.filter.disallowedContentRules
import typingsJapgolly.ckeditor.ckeditorStrings.html
import typingsJapgolly.ckeditor.ckeditorStrings.text
...
trait config_ extends js.Object {
  ...
  var fillEmptyBlocks: js.UndefOr[
    Boolean | (js.Function1[/* element */ typingsJapgolly.ckeditor.CKEDITOR.htmlParser.element, Boolean])
  ] = js.undefined
  ...
  var toolbarGroups: js.UndefOr[js.Array[typingsJapgolly.ckeditor.CKEDITOR.toolbarGroups | String]] = js.undefined
...
object config_ {
  ...
  def apply(
    ...
    devtools_textCallback: (/* editor */ editor, /* dialog */ dialog, /* element */ element, /* tabName */ String) => CallbackTo[String] = null,
    ...
    fillEmptyBlocks: Boolean | (js.Function1[/* element */ typingsJapgolly.ckeditor.CKEDITOR.htmlParser.element, Boolean]) = null,
    ...
    if (devtools_textCallback != null) __obj.updateDynamic("devtools_textCallback")(js.Any.fromFunction4((t0: /* editor */ typingsJapgolly.ckeditor.CKEDITOR.editor, t1: /* dialog */ typingsJapgolly.ckeditor.CKEDITOR.dialog, t2: /* element */ typingsJapgolly.ckeditor.CKEDITOR.dom.element, t3: /* tabName */ java.lang.String) => devtools_textCallback(t0, t1, t2, t3).runNow()))
