...
import typingsJapgolly.ckeditor.AnonAria
import typingsJapgolly.ckeditor.AnonBottom
import typingsJapgolly.ckeditor.AnonColor
import typingsJapgolly.ckeditor.AnonDisplay
import typingsJapgolly.ckeditor.AnonInput
import typingsJapgolly.ckeditor.AnonStyle
import typingsJapgolly.ckeditor.Window
...
object tools extends js.Object {
  ...
  def getMouseButton(evt: typingsJapgolly.ckeditor.CKEDITOR.dom.event): Boolean = js.native
