...
import typingsJapgolly.ckeditor.CKEDITOR.filter.contentRule
import typingsJapgolly.ckeditor.CKEDITOR.filter.disallowedContentRules
import typingsJapgolly.ckeditor.CKEDITOR.filter.transformation
import typingsJapgolly.ckeditor.CKEDITOR.htmlParser.element
import typingsJapgolly.ckeditor.CKEDITOR.htmlParser.fragment
...
class filter protected () extends js.Object {
  def this(editorOrRules: typingsJapgolly.ckeditor.CKEDITOR.editor) = this()
