...
object Chosen {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chosenJs.chosenJsStrings.chosenColonready
    - typingsJapgolly.chosenJs.chosenJsStrings.chosenColonmaxselected
    - typingsJapgolly.chosenJs.chosenJsStrings.chosenColonshowing_dropdown
    - typingsJapgolly.chosenJs.chosenJsStrings.chosenColonhiding_dropdown
    - typingsJapgolly.chosenJs.chosenJsStrings.chosenColonno_results
  */
  trait OnEvent extends StObject
  object OnEvent {
    
    inline def chosenColonhiding_dropdown: typingsJapgolly.chosenJs.chosenJsStrings.chosenColonhiding_dropdown = "chosen:hiding_dropdown".asInstanceOf[typingsJapgolly.chosenJs.chosenJsStrings.chosenColonhiding_dropdown]
    
    inline def chosenColonmaxselected: typingsJapgolly.chosenJs.chosenJsStrings.chosenColonmaxselected = "chosen:maxselected".asInstanceOf[typingsJapgolly.chosenJs.chosenJsStrings.chosenColonmaxselected]
    
    inline def chosenColonno_results: typingsJapgolly.chosenJs.chosenJsStrings.chosenColonno_results = "chosen:no_results".asInstanceOf[typingsJapgolly.chosenJs.chosenJsStrings.chosenColonno_results]
    
    inline def chosenColonready: typingsJapgolly.chosenJs.chosenJsStrings.chosenColonready = "chosen:ready".asInstanceOf[typingsJapgolly.chosenJs.chosenJsStrings.chosenColonready]
    
    inline def chosenColonshowing_dropdown: typingsJapgolly.chosenJs.chosenJsStrings.chosenColonshowing_dropdown = "chosen:showing_dropdown".asInstanceOf[typingsJapgolly.chosenJs.chosenJsStrings.chosenColonshowing_dropdown]
  }
  ...
  /**
    ...
    */
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chosenJs.anon.Selected
    - typingsJapgolly.chosenJs.anon.Deselected
  */
  trait SelectedData extends StObject
  object SelectedData {
    
    inline def Deselected(deselected: String): typingsJapgolly.chosenJs.anon.Deselected = {
      val __obj = js.Dynamic.literal(deselected = deselected.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.chosenJs.anon.Deselected]
    }
    
    inline def Selected(selected: String): typingsJapgolly.chosenJs.anon.Selected = {
      val __obj = js.Dynamic.literal(selected = selected.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.chosenJs.anon.Selected]
    }
  }
  ...
  */
  ...
  object TriggerEvent {
    ...
    inline def chosenColonactivate: typingsJapgolly.chosenJs.chosenJsStrings.chosenColonactivate = "chosen:activate".asInstanceOf[typingsJapgolly.chosenJs.chosenJsStrings.chosenColonactivate]
    
    inline def chosenColonclose: typingsJapgolly.chosenJs.chosenJsStrings.chosenColonclose = "chosen:close".asInstanceOf[typingsJapgolly.chosenJs.chosenJsStrings.chosenColonclose]
    
    inline def chosenColonopen: typingsJapgolly.chosenJs.chosenJsStrings.chosenColonopen = "chosen:open".asInstanceOf[typingsJapgolly.chosenJs.chosenJsStrings.chosenColonopen]
    
    inline def chosenColonupdated: typingsJapgolly.chosenJs.chosenJsStrings.chosenColonupdated = "chosen:updated".asInstanceOf[typingsJapgolly.chosenJs.chosenJsStrings.chosenColonupdated]
  }
}
