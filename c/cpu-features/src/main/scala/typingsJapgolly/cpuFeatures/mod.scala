...
import typingsJapgolly.cpuFeatures.cpuFeaturesBooleans.`true`
import typingsJapgolly.cpuFeatures.cpuFeaturesStrings.aarch64
import typingsJapgolly.cpuFeatures.cpuFeaturesStrings.arm
import typingsJapgolly.cpuFeatures.cpuFeaturesStrings.mips
import typingsJapgolly.cpuFeatures.cpuFeaturesStrings.ppc
import typingsJapgolly.cpuFeatures.cpuFeaturesStrings.unknown
import typingsJapgolly.cpuFeatures.cpuFeaturesStrings.x86
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cpuFeatures.mod.X86CpuFeatures
    - typingsJapgolly.cpuFeatures.mod.ArmCpuFeatures
    - typingsJapgolly.cpuFeatures.mod.Aarch64CpuFeatures
    - typingsJapgolly.cpuFeatures.mod.MipsCpuFeatures
    - typingsJapgolly.cpuFeatures.mod.PPCCpuFeatures
    - typingsJapgolly.cpuFeatures.mod.UnknownCpuFeatures
  */
  trait CpuFeatures extends StObject
  object CpuFeatures {
    
    inline def Aarch64CpuFeatures(flags: Aarch64CpuFlags, implementer: Double, part: Double, revision: Double, variant: Double): typingsJapgolly.cpuFeatures.mod.Aarch64CpuFeatures = {
      val __obj = js.Dynamic.literal(arch = "aarch64", flags = flags.asInstanceOf[js.Any], implementer = implementer.asInstanceOf[js.Any], part = part.asInstanceOf[js.Any], revision = revision.asInstanceOf[js.Any], variant = variant.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.cpuFeatures.mod.Aarch64CpuFeatures]
    }
    ...
    inline def ArmCpuFeatures(
      ...
      val __obj = js.Dynamic.literal(arch = "arm", architecture = architecture.asInstanceOf[js.Any], flags = flags.asInstanceOf[js.Any], implementer = implementer.asInstanceOf[js.Any], part = part.asInstanceOf[js.Any], revision = revision.asInstanceOf[js.Any], variant = variant.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.cpuFeatures.mod.ArmCpuFeatures]
    }
    
    inline def MipsCpuFeatures(flags: MipsCpuFlags): typingsJapgolly.cpuFeatures.mod.MipsCpuFeatures = {
      val __obj = js.Dynamic.literal(arch = "mips", flags = flags.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.cpuFeatures.mod.MipsCpuFeatures]
    }
    ...
    inline def PPCCpuFeatures(
      ...
      __obj.asInstanceOf[typingsJapgolly.cpuFeatures.mod.PPCCpuFeatures]
    }
    
    inline def UnknownCpuFeatures(): typingsJapgolly.cpuFeatures.mod.UnknownCpuFeatures = {
      val __obj = js.Dynamic.literal(arch = "unknown")
      __obj.asInstanceOf[typingsJapgolly.cpuFeatures.mod.UnknownCpuFeatures]
    }
    ...
    inline def X86CpuFeatures(
      ...
      __obj.asInstanceOf[typingsJapgolly.cpuFeatures.mod.X86CpuFeatures]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.X86_UNKNOWN
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_CORE
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_PNR
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_NHM
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_ATOM_BNL
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_WSM
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_SNB
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_IVB
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_ATOM_SMT
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_HSW
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_BDW
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_SKL
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_ATOM_GMT
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_KBL
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_CFL
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_WHL
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_CNL
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_ICL
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_TGL
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_SPR
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_HAMMER
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_K10
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_K11
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_K12
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_BOBCAT
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_PILEDRIVER
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_STREAMROLLER
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_EXCAVATOR
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_BULLDOZER
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_PUMA
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_JAGUAR
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_ZEN
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_ZEN_PLUS
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_ZEN2
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_ZEN3
    - typingsJapgolly.cpuFeatures.cpuFeaturesStrings.`unknown microarchitecture`
  */
  trait X86UArch extends StObject
  object X86UArch {
    
    inline def AMD_BOBCAT: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_BOBCAT = "AMD_BOBCAT".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_BOBCAT]
    
    inline def AMD_BULLDOZER: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_BULLDOZER = "AMD_BULLDOZER".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_BULLDOZER]
    
    inline def AMD_EXCAVATOR: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_EXCAVATOR = "AMD_EXCAVATOR".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_EXCAVATOR]
    
    inline def AMD_HAMMER: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_HAMMER = "AMD_HAMMER".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_HAMMER]
    
    inline def AMD_JAGUAR: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_JAGUAR = "AMD_JAGUAR".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_JAGUAR]
    
    inline def AMD_K10: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_K10 = "AMD_K10".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_K10]
    
    inline def AMD_K11: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_K11 = "AMD_K11".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_K11]
    
    inline def AMD_K12: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_K12 = "AMD_K12".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_K12]
    
    inline def AMD_PILEDRIVER: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_PILEDRIVER = "AMD_PILEDRIVER".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_PILEDRIVER]
    
    inline def AMD_PUMA: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_PUMA = "AMD_PUMA".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_PUMA]
    
    inline def AMD_STREAMROLLER: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_STREAMROLLER = "AMD_STREAMROLLER".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_STREAMROLLER]
    
    inline def AMD_ZEN: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_ZEN = "AMD_ZEN".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_ZEN]
    
    inline def AMD_ZEN2: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_ZEN2 = "AMD_ZEN2".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_ZEN2]
    
    inline def AMD_ZEN3: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_ZEN3 = "AMD_ZEN3".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_ZEN3]
    
    inline def AMD_ZEN_PLUS: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_ZEN_PLUS = "AMD_ZEN_PLUS".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.AMD_ZEN_PLUS]
    
    inline def INTEL_ATOM_BNL: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_ATOM_BNL = "INTEL_ATOM_BNL".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_ATOM_BNL]
    
    inline def INTEL_ATOM_GMT: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_ATOM_GMT = "INTEL_ATOM_GMT".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_ATOM_GMT]
    
    inline def INTEL_ATOM_SMT: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_ATOM_SMT = "INTEL_ATOM_SMT".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_ATOM_SMT]
    
    inline def INTEL_BDW: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_BDW = "INTEL_BDW".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_BDW]
    
    inline def INTEL_CFL: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_CFL = "INTEL_CFL".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_CFL]
    
    inline def INTEL_CNL: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_CNL = "INTEL_CNL".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_CNL]
    
    inline def INTEL_CORE: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_CORE = "INTEL_CORE".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_CORE]
    
    inline def INTEL_HSW: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_HSW = "INTEL_HSW".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_HSW]
    
    inline def INTEL_ICL: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_ICL = "INTEL_ICL".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_ICL]
    
    inline def INTEL_IVB: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_IVB = "INTEL_IVB".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_IVB]
    
    inline def INTEL_KBL: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_KBL = "INTEL_KBL".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_KBL]
    
    inline def INTEL_NHM: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_NHM = "INTEL_NHM".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_NHM]
    
    inline def INTEL_PNR: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_PNR = "INTEL_PNR".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_PNR]
    
    inline def INTEL_SKL: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_SKL = "INTEL_SKL".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_SKL]
    
    inline def INTEL_SNB: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_SNB = "INTEL_SNB".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_SNB]
    
    inline def INTEL_SPR: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_SPR = "INTEL_SPR".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_SPR]
    
    inline def INTEL_TGL: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_TGL = "INTEL_TGL".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_TGL]
    
    inline def INTEL_WHL: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_WHL = "INTEL_WHL".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_WHL]
    
    inline def INTEL_WSM: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_WSM = "INTEL_WSM".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.INTEL_WSM]
    
    inline def X86_UNKNOWN: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.X86_UNKNOWN = "X86_UNKNOWN".asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.X86_UNKNOWN]
    
    inline def `unknown microarchitecture`: typingsJapgolly.cpuFeatures.cpuFeaturesStrings.`unknown microarchitecture` = ("unknown microarchitecture").asInstanceOf[typingsJapgolly.cpuFeatures.cpuFeaturesStrings.`unknown microarchitecture`]
  }
}
