...
import typingsJapgolly.cron.anon.Args
...
object mod {
  ...
  open class CronJob protected () extends StObject {
    ...
    def nextDates(): DateTime = js.native
    ...
    /**
      ...
      */
    @JSName("nextDates")
    def nextDates_Union(): DateTime | js.Array[DateTime] = js.native
  ...
  open class CronTime protected () extends StObject {
    ...
    /**
      ...
      */
    @JSName("sendAt")
    def sendAt_Union(): DateTime | js.Array[DateTime] = js.native
  }
  ...
  object CronJobParameters {
    ...
    extension [Self <: CronJobParameters](x: Self) {
      ...
      inline def setOnCompleteCallback(value: Callback): Self = StObject.set(x, "onComplete", value.toJsFn)
      ...
      inline def setOnTickCallback(value: Callback): Self = StObject.set(x, "onTick", value.toJsFn)
