...
import typingsJapgolly.ckeditorCkeditor5Engine.mod.DocumentSelection
...
object anon {
  ...
  trait Selection extends StObject {
    ...
    var selection: js.UndefOr[
        typingsJapgolly.ckeditorCkeditor5Engine.srcModelSelectionMod.default | DocumentSelection
      ] = js.undefined
  }
  object Selection {
    ...
    extension [Self <: Selection](x: Self) {
      ...
      inline def setSelection(value: typingsJapgolly.ckeditorCkeditor5Engine.srcModelSelectionMod.default | DocumentSelection): Self = StObject.set(x, "selection", value.asInstanceOf[js.Any])
