...
object typesLibEncodeMod {
  ...
  open class Ref protected ()
    extends StObject
       with typingsJapgolly.cborg.typesInterfaceMod.Reference {
  ...
  inline def objectToTokens(obj: Any, options: Unit, refStack: typingsJapgolly.cborg.typesInterfaceMod.Reference): TokenOrNestedTokens = (^.asInstanceOf[js.Dynamic].applyDynamic("objectToTokens")(obj.asInstanceOf[js.Any], options.asInstanceOf[js.Any], refStack.asInstanceOf[js.Any])).asInstanceOf[TokenOrNestedTokens]
  inline def objectToTokens(obj: Any, options: typingsJapgolly.cborg.typesInterfaceMod.EncodeOptions): TokenOrNestedTokens = (^.asInstanceOf[js.Dynamic].applyDynamic("objectToTokens")(obj.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[TokenOrNestedTokens]
  inline def objectToTokens(
    obj: Any,
    options: typingsJapgolly.cborg.typesInterfaceMod.EncodeOptions,
    refStack: typingsJapgolly.cborg.typesInterfaceMod.Reference
  ...
  type OptionalTypeEncoder = typingsJapgolly.cborg.typesInterfaceMod.OptionalTypeEncoder
  
  type Reference = typingsJapgolly.cborg.typesInterfaceMod.Reference
  
  @js.native
  trait StrictTypeEncoder
    extends StObject
       with typingsJapgolly.cborg.typesInterfaceMod.StrictTypeEncoder
