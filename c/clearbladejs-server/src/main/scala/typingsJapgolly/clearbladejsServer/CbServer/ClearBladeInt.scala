...
import typingsJapgolly.clearbladejsServer.anon.Request
...
trait ClearBladeInt extends StObject {
  ...
  def Code(): typingsJapgolly.clearbladejsServer.CbServer.Code = js.native
  
  def Collection(options: String): typingsJapgolly.clearbladejsServer.CbServer.Collection = js.native
  def Collection(options: CollectionOptionsWithCollection): typingsJapgolly.clearbladejsServer.CbServer.Collection = js.native
  def Collection(options: CollectionOptionsWithID): typingsJapgolly.clearbladejsServer.CbServer.Collection = js.native
  def Collection(options: CollectionOptionsWithName): typingsJapgolly.clearbladejsServer.CbServer.Collection = js.native
  
  def Deployment(): typingsJapgolly.clearbladejsServer.CbServer.Deployment = js.native
  
  def Device(): typingsJapgolly.clearbladejsServer.CbServer.Device = js.native
  
  def Item(data: js.Object, options: String): typingsJapgolly.clearbladejsServer.CbServer.Item = js.native
  def Item(data: js.Object, options: ItemOptions): typingsJapgolly.clearbladejsServer.CbServer.Item = js.native
  
  def Messaging(options: MessagingOptions, callback: CbCallback): typingsJapgolly.clearbladejsServer.CbServer.Messaging = js.native
