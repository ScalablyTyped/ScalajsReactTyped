...
object InitOptions {
  ...
  def apply(
    ...
    callback: (/* error */ Boolean, /* response */ Resp_) => Callback = null,
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction2((t0: /* error */ scala.Boolean, t1: /* response */ typingsJapgolly.clearbladejsServer.CbServer.Resp_) => callback(t0, t1).runNow()))
