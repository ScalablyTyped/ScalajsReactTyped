...
object mod {
  ...
  object ClickEvents {
    ...
    extension [Self <: ClickEvents](x: Self) {
      ...
      inline def setClick(value: /* target */ Target => Callback): Self = StObject.set(x, "click", js.Any.fromFunction1((t0: /* target */ Target) => value(t0).runNow()))
      
      inline def setClickUndefined: Self = StObject.set(x, "click", js.undefined)
      
      inline def setNextInterval(value: (/* start */ Moment, /* end */ Moment) => Callback): Self = StObject.set(x, "nextInterval", js.Any.fromFunction2((t0: /* start */ Moment, t1: /* end */ Moment) => (value(t0, t1)).runNow()))
      
      inline def setNextIntervalUndefined: Self = StObject.set(x, "nextInterval", js.undefined)
      
      inline def setNextMonth(value: /* month */ Moment => Callback): Self = StObject.set(x, "nextMonth", js.Any.fromFunction1((t0: /* month */ Moment) => value(t0).runNow()))
      
      inline def setNextMonthUndefined: Self = StObject.set(x, "nextMonth", js.undefined)
      
      inline def setNextYear(value: /* month */ Moment => Callback): Self = StObject.set(x, "nextYear", js.Any.fromFunction1((t0: /* month */ Moment) => value(t0).runNow()))
      
      inline def setNextYearUndefined: Self = StObject.set(x, "nextYear", js.undefined)
      
      inline def setOnIntervalChange(value: (/* start */ Moment, /* end */ Moment) => Callback): Self = StObject.set(x, "onIntervalChange", js.Any.fromFunction2((t0: /* start */ Moment, t1: /* end */ Moment) => (value(t0, t1)).runNow()))
      
      inline def setOnIntervalChangeUndefined: Self = StObject.set(x, "onIntervalChange", js.undefined)
      
      inline def setOnMonthChange(value: /* month */ Moment => Callback): Self = StObject.set(x, "onMonthChange", js.Any.fromFunction1((t0: /* month */ Moment) => value(t0).runNow()))
      
      inline def setOnMonthChangeUndefined: Self = StObject.set(x, "onMonthChange", js.undefined)
      
      inline def setOnYearChange(value: /* month */ Moment => Callback): Self = StObject.set(x, "onYearChange", js.Any.fromFunction1((t0: /* month */ Moment) => value(t0).runNow()))
      
      inline def setOnYearChangeUndefined: Self = StObject.set(x, "onYearChange", js.undefined)
      
      inline def setPreviousInterval(value: (/* start */ Moment, /* end */ Moment) => Callback): Self = StObject.set(x, "previousInterval", js.Any.fromFunction2((t0: /* start */ Moment, t1: /* end */ Moment) => (value(t0, t1)).runNow()))
      
      inline def setPreviousIntervalUndefined: Self = StObject.set(x, "previousInterval", js.undefined)
      
      inline def setPreviousMonth(value: /* month */ Moment => Callback): Self = StObject.set(x, "previousMonth", js.Any.fromFunction1((t0: /* month */ Moment) => value(t0).runNow()))
      
      inline def setPreviousMonthUndefined: Self = StObject.set(x, "previousMonth", js.undefined)
      
      inline def setPreviousYear(value: /* month */ Moment => Callback): Self = StObject.set(x, "previousYear", js.Any.fromFunction1((t0: /* month */ Moment) => value(t0).runNow()))
      
      inline def setPreviousYearUndefined: Self = StObject.set(x, "previousYear", js.undefined)
      
      inline def setToday(value: /* month */ Moment => Callback): Self = StObject.set(x, "today", js.Any.fromFunction1((t0: /* month */ Moment) => value(t0).runNow()))
  ...
  object ClndrOptions {
    ...
    extension [Self <: ClndrOptions](x: Self) {
      ...
      inline def setDoneRendering(value: Callback): Self = StObject.set(x, "doneRendering", value.toJsFn)
      ...
      inline def setRender(value: /* data */ RenderData => Callback): Self = StObject.set(x, "render", js.Any.fromFunction1((t0: /* data */ RenderData) => value(t0).runNow()))
