...
object ClndrOptions {
  ...
  def apply(
    ...
    doneRendering: js.UndefOr[Callback] = js.undefined,
    ...
    render: /* data */ RenderData => Callback = null,
    ...
    doneRendering.foreach(p => __obj.updateDynamic("doneRendering")(p.toJsFn))
    ...
    if (render != null) __obj.updateDynamic("render")(js.Any.fromFunction1((t0: /* data */ typingsJapgolly.clndr.mod.RenderData) => render(t0).runNow()))
