...
import typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.ITestResult
...
open class TestResult ()
  extends typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult {
...
object TestResult {
  ...
  object Status extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status & Double
      ] = js.native
    
    /* 5 */ val AMBIGUOUS: typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.AMBIGUOUS & Double = js.native
    
    /* 6 */ val FAILED: typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.FAILED & Double = js.native
    
    /* 1 */ val PASSED: typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.PASSED & Double = js.native
    
    /* 3 */ val PENDING: typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.PENDING & Double = js.native
    
    /* 2 */ val SKIPPED: typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.SKIPPED & Double = js.native
    
    /* 4 */ val UNDEFINED: typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.UNDEFINED & Double = js.native
    
    /* 0 */ val UNKNOWN: typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.UNKNOWN & Double = js.native
  }
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult]
  inline def create(properties: ITestResult): typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult]
  ...
  /**
    ...
    */
  /* static member */
  inline def decode(reader: Reader): typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult]
  ...
  /* static member */
  inline def toObject(
    message: typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult
