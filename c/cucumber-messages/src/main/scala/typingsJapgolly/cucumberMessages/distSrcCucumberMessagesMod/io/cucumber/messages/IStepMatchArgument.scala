...
import typingsJapgolly.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.StepMatchArgument.IGroup
...
object IStepMatchArgument {
  ...
  extension [Self <: IStepMatchArgument](x: Self) {
