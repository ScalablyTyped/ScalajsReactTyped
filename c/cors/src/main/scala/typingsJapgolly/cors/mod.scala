...
import typingsJapgolly.cors.anon.End
  ...
  object CorsOptions {
    ...
    extension [Self <: CorsOptions](x: Self) {
      ...
      inline def setOriginFunction2(
        value: (/* requestOrigin */ js.UndefOr[String], /* callback */ js.Function2[/* err */ js.Error | Null, /* origin */ js.UndefOr[StaticOrigin], Unit]) => Callback
      ): Self = StObject.set(x, "origin", js.Any.fromFunction2((t0: /* requestOrigin */ js.UndefOr[String], t1: /* callback */ js.Function2[/* err */ js.Error | Null, /* origin */ js.UndefOr[StaticOrigin], Unit]) => (value(t0, t1)).runNow()))
