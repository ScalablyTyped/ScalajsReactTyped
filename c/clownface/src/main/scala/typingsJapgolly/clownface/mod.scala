...
import typingsJapgolly.clownface.anon.ToString
import typingsJapgolly.clownface.libContextMod.Context
...
object mod {
  ...
  trait NodeOptions extends StObject {
    ...
    var `type`: js.UndefOr[
        typingsJapgolly.clownface.clownfaceStrings.BlankNode | typingsJapgolly.clownface.clownfaceStrings.Literal | typingsJapgolly.clownface.clownfaceStrings.NamedNode
      ] = js.undefined
  }
  object NodeOptions {
    ...
    extension [Self <: NodeOptions](x: Self) {
      ...
      inline def setType(
        value: typingsJapgolly.clownface.clownfaceStrings.BlankNode | typingsJapgolly.clownface.clownfaceStrings.Literal | typingsJapgolly.clownface.clownfaceStrings.NamedNode
