...
object coreMod extends js.Object {
  ...
  @JSName("$for")
  def `for`[T](iterable: js.Iterable[T]): typingsJapgolly.coreJs.`for`[T] = js.native
  ...
  object Array extends js.Object {
    def concat[T](array: ArrayLike[T], items: (typingsJapgolly.coreJs.Array[T] | T)*): typingsJapgolly.coreJs.Array[T] = js.native
    def copyWithin[T](array: ArrayLike[T], target: Double, start: Double): typingsJapgolly.coreJs.Array[T] = js.native
    def copyWithin[T](array: ArrayLike[T], target: Double, start: Double, end: Double): typingsJapgolly.coreJs.Array[T] = js.native
    ...
    def fill[T](array: ArrayLike[T], value: T): typingsJapgolly.coreJs.Array[T] = js.native
    def fill[T](array: ArrayLike[T], value: T, start: Double): typingsJapgolly.coreJs.Array[T] = js.native
    def fill[T](array: ArrayLike[T], value: T, start: Double, end: Double): typingsJapgolly.coreJs.Array[T] = js.native
    def filter[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[
          /* value */ T, 
    ...
    ): typingsJapgolly.coreJs.Array[T] = js.native
    def filter[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[
          /* value */ T, 
    ...
    def from[T](arrayLike: ArrayLike[T]): typingsJapgolly.coreJs.Array[T] = js.native
    def from[T](arrayLike: Iterable[T]): typingsJapgolly.coreJs.Array[T] = js.native
    def from[T, U](arrayLike: ArrayLike[T], mapfn: js.Function2[/* v */ T, /* k */ Double, U]): typingsJapgolly.coreJs.Array[U] = js.native
    def from[T, U](arrayLike: ArrayLike[T], mapfn: js.Function2[/* v */ T, /* k */ Double, U], thisArg: js.Any): typingsJapgolly.coreJs.Array[U] = js.native
    def from[T, U](arrayLike: Iterable[T], mapfn: js.Function2[/* v */ T, /* k */ Double, U]): typingsJapgolly.coreJs.Array[U] = js.native
    def from[T, U](arrayLike: Iterable[T], mapfn: js.Function2[/* v */ T, /* k */ Double, U], thisArg: js.Any): typingsJapgolly.coreJs.Array[U] = js.native
    ...
    ): typingsJapgolly.coreJs.Array[U] = js.native
    def map[T, U](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typingsJapgolly.coreJs.Array[T], U],
      thisArg: js.Any
    ): typingsJapgolly.coreJs.Array[U] = js.native
    def of[T](items: T*): typingsJapgolly.coreJs.Array[T] = js.native
    ...
    def reverse[T](array: ArrayLike[T]): typingsJapgolly.coreJs.Array[T] = js.native
    def shift[T](array: ArrayLike[T]): T = js.native
    def slice[T](array: ArrayLike[T]): typingsJapgolly.coreJs.Array[T] = js.native
    def slice[T](array: ArrayLike[T], start: Double): typingsJapgolly.coreJs.Array[T] = js.native
    def slice[T](array: ArrayLike[T], start: Double, end: Double): typingsJapgolly.coreJs.Array[T] = js.native
    def some[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[
          /* value */ T, 
    ...
    def sort[T](array: ArrayLike[T]): typingsJapgolly.coreJs.Array[T] = js.native
    def sort[T](array: ArrayLike[T], compareFn: js.Function2[/* a */ T, /* b */ T, Double]): typingsJapgolly.coreJs.Array[T] = js.native
    def splice[T](array: ArrayLike[T], start: Double): typingsJapgolly.coreJs.Array[T] = js.native
    def splice[T](array: ArrayLike[T], start: Double, deleteCount: Double, items: T*): typingsJapgolly.coreJs.Array[T] = js.native
    def turn[T](
      array: ArrayLike[T],
      callbackfn: js.Function4[
  ...
  object Date extends js.Object {
    def format(date: typingsJapgolly.coreJs.Date, template: java.lang.String): java.lang.String = js.native
    def format(date: typingsJapgolly.coreJs.Date, template: java.lang.String, locale: java.lang.String): java.lang.String = js.native
    def formatUTC(date: typingsJapgolly.coreJs.Date, template: java.lang.String): java.lang.String = js.native
    def formatUTC(date: typingsJapgolly.coreJs.Date, template: java.lang.String, locale: java.lang.String): java.lang.String = js.native
    def now(): Double = js.native
    def toISOString(date: typingsJapgolly.coreJs.Date): java.lang.String = js.native
  }
  
  @js.native
  object Function extends js.Object {
    def bind(target: typingsJapgolly.coreJs.Function, thisArg: js.Any, argArray: js.Any*): js.Any = js.native
    def part(target: typingsJapgolly.coreJs.Function, args: js.Any*): js.Any = js.native
  }
