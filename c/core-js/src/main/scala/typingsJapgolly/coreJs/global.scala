...
object global {
  ...
  inline def `for`[T](iterable: js.Iterable[T]): typingsJapgolly.coreJs.`for`[T] = js.Dynamic.global.applyDynamic("$for")(iterable.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.coreJs.`for`[T]]
}
