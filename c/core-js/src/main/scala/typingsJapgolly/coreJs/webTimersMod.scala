...
import typingsJapgolly.coreJs.anon.Typeofcore
import typingsJapgolly.coreJs.core.Locale
...
object webTimersMod {
  ...
  object Array {
    ...
    @JSImport("core-js/web/timers", "Array")
    @js.native
    val ^ : js.Any = js.native
    
    inline def concat[T](array: ArrayLike[T], items: (typingsJapgolly.coreJs.Array[T] | T)*): typingsJapgolly.coreJs.Array[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("concat")(scala.List(array.asInstanceOf[js.Any]).`++`(items.asInstanceOf[Seq[js.Any]])*).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    
    inline def copyWithin[T](array: ArrayLike[T], target: Double, start: Double): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("copyWithin")(array.asInstanceOf[js.Any], target.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def copyWithin[T](array: ArrayLike[T], target: Double, start: Double, end: Double): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("copyWithin")(array.asInstanceOf[js.Any], target.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    ...
    inline def every[T](
      ...
      callbackfn: js.Function3[
          /* value */ T, 
          /* index */ Double, 
          /* array */ typingsJapgolly.coreJs.Array[T], 
          Boolean
        ]
    ...
    inline def fill[T](array: ArrayLike[T], value: T): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("fill")(array.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def fill[T](array: ArrayLike[T], value: T, start: Double): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("fill")(array.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def fill[T](array: ArrayLike[T], value: T, start: Double, end: Double): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("fill")(array.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def fill[T](array: ArrayLike[T], value: T, start: Unit, end: Double): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("fill")(array.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    ...
    ): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(array.asInstanceOf[js.Any], callbackfn.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def filter[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[
          /* value */ T, 
      ...
      thisArg: Any
    ): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(array.asInstanceOf[js.Any], callbackfn.asInstanceOf[js.Any], thisArg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    
    inline def find[T](
      array: ArrayLike[T],
      predicate: js.Function3[/* value */ T, /* index */ Double, /* obj */ typingsJapgolly.coreJs.Array[T], Boolean]
    ...
    inline def forEach[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typingsJapgolly.coreJs.Array[T], Unit]
    ...
    inline def from[T](arrayLike: js.Iterable[T]): typingsJapgolly.coreJs.Array[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(arrayLike.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def from[T](arrayLike: ArrayLike[T]): typingsJapgolly.coreJs.Array[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(arrayLike.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def from[T, U](arrayLike: js.Iterable[T], mapfn: js.Function2[/* v */ T, /* k */ Double, U]): typingsJapgolly.coreJs.Array[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(arrayLike.asInstanceOf[js.Any], mapfn.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[U]]
    inline def from[T, U](arrayLike: js.Iterable[T], mapfn: js.Function2[/* v */ T, /* k */ Double, U], thisArg: Any): typingsJapgolly.coreJs.Array[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(arrayLike.asInstanceOf[js.Any], mapfn.asInstanceOf[js.Any], thisArg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[U]]
    inline def from[T, U](arrayLike: ArrayLike[T], mapfn: js.Function2[/* v */ T, /* k */ Double, U]): typingsJapgolly.coreJs.Array[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(arrayLike.asInstanceOf[js.Any], mapfn.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[U]]
    inline def from[T, U](arrayLike: ArrayLike[T], mapfn: js.Function2[/* v */ T, /* k */ Double, U], thisArg: Any): typingsJapgolly.coreJs.Array[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(arrayLike.asInstanceOf[js.Any], mapfn.asInstanceOf[js.Any], thisArg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[U]]
    ...
    inline def map[T, U](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typingsJapgolly.coreJs.Array[T], U]
    ): typingsJapgolly.coreJs.Array[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("map")(array.asInstanceOf[js.Any], callbackfn.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[U]]
    inline def map[T, U](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typingsJapgolly.coreJs.Array[T], U],
      thisArg: Any
    ): typingsJapgolly.coreJs.Array[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("map")(array.asInstanceOf[js.Any], callbackfn.asInstanceOf[js.Any], thisArg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[U]]
    
    inline def of[T](items: T*): typingsJapgolly.coreJs.Array[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("of")(items.asInstanceOf[Seq[js.Any]]*).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    ...
    inline def reverse[T](array: ArrayLike[T]): typingsJapgolly.coreJs.Array[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("reverse")(array.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    ...
    inline def slice[T](array: ArrayLike[T]): typingsJapgolly.coreJs.Array[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("slice")(array.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def slice[T](array: ArrayLike[T], start: Double): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("slice")(array.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def slice[T](array: ArrayLike[T], start: Double, end: Double): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("slice")(array.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def slice[T](array: ArrayLike[T], start: Unit, end: Double): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("slice")(array.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    ...
    inline def sort[T](array: ArrayLike[T]): typingsJapgolly.coreJs.Array[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("sort")(array.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def sort[T](array: ArrayLike[T], compareFn: js.Function2[/* a */ T, /* b */ T, Double]): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("sort")(array.asInstanceOf[js.Any], compareFn.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    
    inline def splice[T](array: ArrayLike[T], start: Double, deleteCount: Double, items: T*): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("splice")((scala.List(array.asInstanceOf[js.Any], start.asInstanceOf[js.Any], deleteCount.asInstanceOf[js.Any])).`++`(items.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def splice[T](array: ArrayLike[T], start: Double, deleteCount: Unit, items: T*): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("splice")((scala.List(array.asInstanceOf[js.Any], start.asInstanceOf[js.Any], deleteCount.asInstanceOf[js.Any])).`++`(items.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    
    inline def turn[T](
      array: ArrayLike[T],
      callbackfn: js.Function4[
          /* memo */ typingsJapgolly.coreJs.Array[T], 
          /* value */ T, 
          /* index */ Double, 
          /* array */ typingsJapgolly.coreJs.Array[T], 
          Unit
        ]
    ): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("turn")(array.asInstanceOf[js.Any], callbackfn.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def turn[T](
      array: ArrayLike[T],
      callbackfn: js.Function4[
          /* memo */ typingsJapgolly.coreJs.Array[T], 
      ...
      memo: typingsJapgolly.coreJs.Array[T]
    ): typingsJapgolly.coreJs.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("turn")(array.asInstanceOf[js.Any], callbackfn.asInstanceOf[js.Any], memo.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.coreJs.Array[T]]
    inline def turn[T, U](
      array: ArrayLike[T],
      callbackfn: js.Function4[
          /* memo */ U, 
  ...
  object Date {
    ...
    @JSImport("core-js/web/timers", "Date")
    @js.native
    val ^ : js.Any = js.native
    
    inline def format(date: typingsJapgolly.coreJs.Date, template: java.lang.String): java.lang.String = (^.asInstanceOf[js.Dynamic].applyDynamic("format")(date.asInstanceOf[js.Any], template.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
    inline def format(date: typingsJapgolly.coreJs.Date, template: java.lang.String, locale: java.lang.String): java.lang.String = (^.asInstanceOf[js.Dynamic].applyDynamic("format")(date.asInstanceOf[js.Any], template.asInstanceOf[js.Any], locale.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
    
    inline def formatUTC(date: typingsJapgolly.coreJs.Date, template: java.lang.String): java.lang.String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatUTC")(date.asInstanceOf[js.Any], template.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
    inline def formatUTC(date: typingsJapgolly.coreJs.Date, template: java.lang.String, locale: java.lang.String): java.lang.String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatUTC")(date.asInstanceOf[js.Any], template.asInstanceOf[js.Any], locale.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
    
    inline def now(): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("now")().asInstanceOf[Double]
    
    inline def toISOString(date: typingsJapgolly.coreJs.Date): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("toISOString")(date.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
  }
  
  @JSImport("core-js/web/timers", "Dict")
  @js.native
  val Dict: DictConstructor = js.native
  
  object Function {
    
    @JSImport("core-js/web/timers", "Function")
    @js.native
    val ^ : js.Any = js.native
    
    inline def bind(target: typingsJapgolly.coreJs.Function, thisArg: Any, argArray: Any*): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("bind")((scala.List(target.asInstanceOf[js.Any], thisArg.asInstanceOf[js.Any])).`++`(argArray.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[Any]
    
    inline def part(target: typingsJapgolly.coreJs.Function, args: Any*): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("part")(scala.List(target.asInstanceOf[js.Any]).`++`(args.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Any]
  }
  ...
  object Math {
    ...
    @JSImport("core-js/web/timers", "Math")
    @js.native
    val ^ : js.Any = js.native
  ...
  object Number {
    ...
    @JSImport("core-js/web/timers", "Number.MIN_SAFE_INTEGER")
    @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("core-js/web/timers", "Promise")
  @js.native
  ...
  object RegExp {
    ...
    @JSImport("core-js/web/timers", "RegExp")
    @js.native
    val ^ : js.Any = js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("core-js/web/timers", "Set")
  @js.native
  /* standard es2015.collection */
  open class Set[T] ()
    extends StObject
  ...
  open class WeakMap[K /* <: js.Object */, V] ()
    extends StObject
       with typingsJapgolly.std.WeakMap[K, V] {
    def this(entries: js.Array[js.Tuple2[K, V]]) = this()
  }
  @JSImport("core-js/web/timers", "WeakMap")
  @js.native
  ...
  open class WeakSet[T /* <: js.Object */] ()
    extends StObject
       with typingsJapgolly.std.WeakSet[T] {
  ...
  inline def `for`[T](iterable: js.Iterable[T]): typingsJapgolly.coreJs.`for`[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("$for")(iterable.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.coreJs.`for`[T]]
  ...
  @JSImport("core-js/web/timers", "global")
  @js.native
  ...
  @JSImport("core-js/web/timers", "version")
  @js.native
