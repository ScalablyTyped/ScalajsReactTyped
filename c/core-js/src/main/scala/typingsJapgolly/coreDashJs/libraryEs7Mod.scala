...
@JSImport("core-js/library/es7", JSImport.Namespace)
@js.native
object libraryEs7Mod extends js.Object {
  @js.native
  class Map[K, V] ()
  ...
  object Date extends js.Object {
    def format(date: typingsJapgolly.coreDashJs.Date, template: java.lang.String): java.lang.String = js.native
    def format(date: typingsJapgolly.coreDashJs.Date, template: java.lang.String, locale: java.lang.String): java.lang.String = js.native
    def formatUTC(date: typingsJapgolly.coreDashJs.Date, template: java.lang.String): java.lang.String = js.native
    def formatUTC(date: typingsJapgolly.coreDashJs.Date, template: java.lang.String, locale: java.lang.String): java.lang.String = js.native
    def now(): Double = js.native
    def toISOString(date: typingsJapgolly.coreDashJs.Date): java.lang.String = js.native
  }
  
  @js.native
  object Function extends js.Object {
    def bind(target: typingsJapgolly.coreDashJs.Function, thisArg: js.Any, argArray: js.Any*): js.Any = js.native
    def part(target: typingsJapgolly.coreDashJs.Function, args: js.Any*): js.Any = js.native
  }
