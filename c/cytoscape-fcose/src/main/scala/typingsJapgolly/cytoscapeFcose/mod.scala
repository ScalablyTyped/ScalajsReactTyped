package typingsJapgolly.cytoscapeFcose

import org.scalablytyped.runtime.Shortcut
import typingsJapgolly.cytoscape.mod.BaseLayoutOptions
import typingsJapgolly.cytoscape.mod.Ext
import typingsJapgolly.cytoscape.mod.Position
import typingsJapgolly.cytoscapeFcose.cytoscapeFcoseStrings.`ease-out`
import typingsJapgolly.cytoscapeFcose.cytoscapeFcoseStrings.all
import typingsJapgolly.cytoscapeFcose.cytoscapeFcoseStrings.cose
import typingsJapgolly.cytoscapeFcose.cytoscapeFcoseStrings.default
import typingsJapgolly.cytoscapeFcose.cytoscapeFcoseStrings.draft
import typingsJapgolly.cytoscapeFcose.cytoscapeFcoseStrings.enforced
import typingsJapgolly.cytoscapeFcose.cytoscapeFcoseStrings.fcose
import typingsJapgolly.cytoscapeFcose.cytoscapeFcoseStrings.proof
import typingsJapgolly.cytoscapeFcose.cytoscapeFcoseStrings.transformed
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cytoscapeFcose.mod.FcoseRelativeVerticalPlacementConstraint
    - typingsJapgolly.cytoscapeFcose.mod.FcoseRelativeHorizontalPlacementConstraint
  */
  trait FcoseRelativePlacementConstraint extends StObject
  object FcoseRelativePlacementConstraint {
    
    inline def FcoseRelativeHorizontalPlacementConstraint(gap: Double, left: String, right: String): typingsJapgolly.cytoscapeFcose.mod.FcoseRelativeHorizontalPlacementConstraint = {
      val __obj = js.Dynamic.literal(gap = gap.asInstanceOf[js.Any], left = left.asInstanceOf[js.Any], right = right.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.cytoscapeFcose.mod.FcoseRelativeHorizontalPlacementConstraint]
    }
    
    inline def FcoseRelativeVerticalPlacementConstraint(bottom: String, gap: Double, top: String): typingsJapgolly.cytoscapeFcose.mod.FcoseRelativeVerticalPlacementConstraint = {
      val __obj = js.Dynamic.literal(bottom = bottom.asInstanceOf[js.Any], gap = gap.asInstanceOf[js.Any], top = top.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.cytoscapeFcose.mod.FcoseRelativeVerticalPlacementConstraint]
    }
  }
