...
object anon {
  ...
  trait Entry extends StObject {
    ...
    var renderOption: js.UndefOr[typingsJapgolly.contentstackUtils.distTypesOptionsMod.RenderOption] = js.undefined
  }
  object Entry {
    ...
    extension [Self <: Entry](x: Self) {
      ...
      inline def setRenderOption(value: typingsJapgolly.contentstackUtils.distTypesOptionsMod.RenderOption): Self = StObject.set(x, "renderOption", value.asInstanceOf[js.Any])
