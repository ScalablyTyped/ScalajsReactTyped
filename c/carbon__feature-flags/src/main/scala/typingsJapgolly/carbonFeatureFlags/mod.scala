...
import typingsJapgolly.carbonFeatureFlags.anon.PartialRecordFeatureFlagN
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.carbonFeatureFlags.carbonFeatureFlagsStrings.`enable-css-custom-properties`
    - typingsJapgolly.carbonFeatureFlags.carbonFeatureFlagsStrings.`enable-use-controlled-state-with-value`
    - typingsJapgolly.carbonFeatureFlags.carbonFeatureFlagsStrings.`enable-css-grid`
    - typingsJapgolly.carbonFeatureFlags.carbonFeatureFlagsStrings.`enable-v11-release`
  */
  trait FeatureFlagName extends StObject
  object FeatureFlagName {
    
    inline def `enable-css-custom-properties`: typingsJapgolly.carbonFeatureFlags.carbonFeatureFlagsStrings.`enable-css-custom-properties` = "enable-css-custom-properties".asInstanceOf[typingsJapgolly.carbonFeatureFlags.carbonFeatureFlagsStrings.`enable-css-custom-properties`]
    
    inline def `enable-css-grid`: typingsJapgolly.carbonFeatureFlags.carbonFeatureFlagsStrings.`enable-css-grid` = "enable-css-grid".asInstanceOf[typingsJapgolly.carbonFeatureFlags.carbonFeatureFlagsStrings.`enable-css-grid`]
    
    inline def `enable-use-controlled-state-with-value`: typingsJapgolly.carbonFeatureFlags.carbonFeatureFlagsStrings.`enable-use-controlled-state-with-value` = "enable-use-controlled-state-with-value".asInstanceOf[typingsJapgolly.carbonFeatureFlags.carbonFeatureFlagsStrings.`enable-use-controlled-state-with-value`]
    
    inline def `enable-v11-release`: typingsJapgolly.carbonFeatureFlags.carbonFeatureFlagsStrings.`enable-v11-release` = "enable-v11-release".asInstanceOf[typingsJapgolly.carbonFeatureFlags.carbonFeatureFlagsStrings.`enable-v11-release`]
  }
