...
import typingsJapgolly.channelIo.anon.PartialUpdateUserOption
...
object ChannelIO {
  ...
  /* keyof channel-io.ChannelIO.CommandSignature */ /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.channelIo.channelIoStrings.boot
    - typingsJapgolly.channelIo.channelIoStrings.shutdown
    - typingsJapgolly.channelIo.channelIoStrings.showMessenger
    - typingsJapgolly.channelIo.channelIoStrings.show
    - typingsJapgolly.channelIo.channelIoStrings.hideMessenger
    - typingsJapgolly.channelIo.channelIoStrings.hide
    - typingsJapgolly.channelIo.channelIoStrings.lounge
    - typingsJapgolly.channelIo.channelIoStrings.openChat
    - typingsJapgolly.channelIo.channelIoStrings.track
    - typingsJapgolly.channelIo.channelIoStrings.onBoot
    - typingsJapgolly.channelIo.channelIoStrings.onShowMessenger
    - typingsJapgolly.channelIo.channelIoStrings.onShow
    - typingsJapgolly.channelIo.channelIoStrings.onHideMessenger
    - typingsJapgolly.channelIo.channelIoStrings.onHide
    - typingsJapgolly.channelIo.channelIoStrings.onBadgeChanged
    - typingsJapgolly.channelIo.channelIoStrings.onChangeBadge
    - typingsJapgolly.channelIo.channelIoStrings.onChatCreated
    - typingsJapgolly.channelIo.channelIoStrings.onFollowUpChanged
    - typingsJapgolly.channelIo.channelIoStrings.onCreateChat
    - typingsJapgolly.channelIo.channelIoStrings.onProfileChanged
    - typingsJapgolly.channelIo.channelIoStrings.onChangeProfile
    - typingsJapgolly.channelIo.channelIoStrings.onUrlClicked
    - typingsJapgolly.channelIo.channelIoStrings.onClickRedirect
    - typingsJapgolly.channelIo.channelIoStrings.clearCallbacks
    - typingsJapgolly.channelIo.channelIoStrings.updateUser
    - typingsJapgolly.channelIo.channelIoStrings.addTags
    - typingsJapgolly.channelIo.channelIoStrings.removeTags
    - typingsJapgolly.channelIo.channelIoStrings.setPage
    - typingsJapgolly.channelIo.channelIoStrings.resetPage
    - typingsJapgolly.channelIo.channelIoStrings.showChannelButton
    - typingsJapgolly.channelIo.channelIoStrings.hideChannelButton
  */
