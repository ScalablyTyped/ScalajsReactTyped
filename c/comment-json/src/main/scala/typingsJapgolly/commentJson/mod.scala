package typingsJapgolly.commentJson

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.commentJson.commentJsonStrings.BlockComment
import typingsJapgolly.commentJson.commentJsonStrings.LineComment
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.commentJson.commentJsonStrings.before
    - typingsJapgolly.commentJson.commentJsonStrings.`before-all`
    - typingsJapgolly.commentJson.commentJsonStrings.`after-all`
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.commentJson.commentJsonStrings.before
    - typingsJapgolly.commentJson.commentJsonStrings.`after-prop`
    - typingsJapgolly.commentJson.commentJsonStrings.`after-colon`
    - typingsJapgolly.commentJson.commentJsonStrings.`after-value`
    - typingsJapgolly.commentJson.commentJsonStrings.after
  */
  trait CommentPrefix extends StObject
  object CommentPrefix {
    
    inline def after: typingsJapgolly.commentJson.commentJsonStrings.after = "after".asInstanceOf[typingsJapgolly.commentJson.commentJsonStrings.after]
    
    inline def `after-colon`: typingsJapgolly.commentJson.commentJsonStrings.`after-colon` = "after-colon".asInstanceOf[typingsJapgolly.commentJson.commentJsonStrings.`after-colon`]
    
    inline def `after-prop`: typingsJapgolly.commentJson.commentJsonStrings.`after-prop` = "after-prop".asInstanceOf[typingsJapgolly.commentJson.commentJsonStrings.`after-prop`]
    
    inline def `after-value`: typingsJapgolly.commentJson.commentJsonStrings.`after-value` = "after-value".asInstanceOf[typingsJapgolly.commentJson.commentJsonStrings.`after-value`]
    
    inline def before: typingsJapgolly.commentJson.commentJsonStrings.before = "before".asInstanceOf[typingsJapgolly.commentJson.commentJsonStrings.before]
  }
