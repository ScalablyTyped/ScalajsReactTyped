...
object InitOptions {
  ...
  def apply(
    ...
    callback: (/* error */ Boolean, /* response */ Resp) => Callback = null,
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction2((t0: /* error */ scala.Boolean, t1: /* response */ typingsJapgolly.clearbladejsClient.CbClient.Resp) => callback(t0, t1).runNow()))
