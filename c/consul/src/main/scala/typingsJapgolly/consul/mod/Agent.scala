...
import typingsJapgolly.consul.mod.Agent.Check
import typingsJapgolly.consul.mod.Agent.Check.DeregisterOptions
import typingsJapgolly.consul.mod.Agent.Check.FailOptions
import typingsJapgolly.consul.mod.Agent.Check.ListOptions
import typingsJapgolly.consul.mod.Agent.Check.PassOptions
import typingsJapgolly.consul.mod.Agent.Check.RegisterOptions
import typingsJapgolly.consul.mod.Agent.Check.WarnOptions
import typingsJapgolly.consul.mod.Agent.ChecksOptions
import typingsJapgolly.consul.mod.Agent.ForceLeaveOptions
import typingsJapgolly.consul.mod.Agent.JoinOptions
import typingsJapgolly.consul.mod.Agent.MaintenanceOptions
import typingsJapgolly.consul.mod.Agent.MembersOptions
import typingsJapgolly.consul.mod.Agent.SelfOptions
import typingsJapgolly.consul.mod.Agent.Service
import typingsJapgolly.consul.mod.Agent.ServicesOptions
...
object Agent {
  ...
  trait Service extends StObject {
    ...
    /**
      * Deregister a local service
      */
    def deregister[TData](opts: typingsJapgolly.consul.mod.Agent.Service.DeregisterOptions): js.Promise[TData] = js.native
    /**
      * Deregister a local service
      */
    def deregister[TData](opts: typingsJapgolly.consul.mod.Agent.Service.DeregisterOptions, callback: Callback[TData]): Unit = js.native
    ...
    /**
      ...
      */
    def list[TData](callback: Callback[TData]): Unit = js.native
    def list[TData](opts: typingsJapgolly.consul.mod.Agent.Service.ListOptions): js.Promise[TData] = js.native
    /**
      * Returns the services local agent is managing
      */
    def list[TData](opts: typingsJapgolly.consul.mod.Agent.Service.ListOptions, callback: Callback[TData]): Unit = js.native
    
    /**
      * Manages node maintenance mode
      */
    def maintenance[TData](opts: typingsJapgolly.consul.mod.Agent.Service.MaintenanceOptions): js.Promise[TData] = js.native
    /**
      * Manages node maintenance mode
      */
    ...
    /**
      * Registers a new local service
      */
    def register[TData](opts: typingsJapgolly.consul.mod.Agent.Service.RegisterOptions): js.Promise[TData] = js.native
    /**
      * Registers a new local service
      */
    def register[TData](opts: typingsJapgolly.consul.mod.Agent.Service.RegisterOptions, callback: Callback[TData]): Unit = js.native
  }
  object Service {
    ...
    object DeregisterOptions {
      ...
      inline def apply(id: String): typingsJapgolly.consul.mod.Agent.Service.DeregisterOptions = {
        val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.consul.mod.Agent.Service.DeregisterOptions]
      }
      
      extension [Self <: typingsJapgolly.consul.mod.Agent.Service.DeregisterOptions](x: Self) {
    ...
    object MaintenanceOptions {
      ...
      inline def apply(enable: Boolean, id: String): typingsJapgolly.consul.mod.Agent.Service.MaintenanceOptions = {
        val __obj = js.Dynamic.literal(enable = enable.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.consul.mod.Agent.Service.MaintenanceOptions]
      }
      
      extension [Self <: typingsJapgolly.consul.mod.Agent.Service.MaintenanceOptions](x: Self) {
    ...
    object RegisterOptions {
      ...
      inline def apply(name: String): typingsJapgolly.consul.mod.Agent.Service.RegisterOptions = {
        val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.consul.mod.Agent.Service.RegisterOptions]
      }
      
      extension [Self <: typingsJapgolly.consul.mod.Agent.Service.RegisterOptions](x: Self) {
  ...
  type ServicesOptions = typingsJapgolly.consul.mod.Agent.Service.ListOptions
}
