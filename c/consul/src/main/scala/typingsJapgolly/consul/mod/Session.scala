...
import typingsJapgolly.consul.mod.Session.CreateOptions
import typingsJapgolly.consul.mod.Session.DestroyOptions
import typingsJapgolly.consul.mod.Session.GetOptions
import typingsJapgolly.consul.mod.Session.InfoOptions
import typingsJapgolly.consul.mod.Session.ListOptions
import typingsJapgolly.consul.mod.Session.NodeOptions
import typingsJapgolly.consul.mod.Session.RenewOptions
