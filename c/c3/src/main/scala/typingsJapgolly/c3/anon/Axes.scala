...
trait Axes extends StObject {
  ...
  /** Data to load. */
  var data: js.UndefOr[typingsJapgolly.c3.mod.Data] = js.undefined
...
object Axes {
  ...
  extension [Self <: Axes](x: Self) {
    ...
    inline def setData(value: typingsJapgolly.c3.mod.Data): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
