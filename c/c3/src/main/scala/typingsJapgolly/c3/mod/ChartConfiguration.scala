...
import typingsJapgolly.c3.anon.Arcs
import typingsJapgolly.c3.anon.Auto
import typingsJapgolly.c3.anon.Brighten
import typingsJapgolly.c3.anon.Classname
import typingsJapgolly.c3.anon.Duration
import typingsJapgolly.c3.anon.Expand
import typingsJapgolly.c3.anon.Height
import typingsJapgolly.c3.anon.Interpolation
import typingsJapgolly.c3.anon.Label
import typingsJapgolly.c3.anon.Lines
import typingsJapgolly.c3.anon.Pattern
import typingsJapgolly.c3.anon.Space
import typingsJapgolly.c3.anon.Zerobased
...
trait ChartConfiguration extends StObject {
  ...
  var title: js.UndefOr[typingsJapgolly.c3.anon.Padding] = js.undefined
...
object ChartConfiguration {
  ...
  extension [Self <: ChartConfiguration](x: Self) {
    ...
    inline def setTitle(value: typingsJapgolly.c3.anon.Padding): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
