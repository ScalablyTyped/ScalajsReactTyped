...
object AnonColors {
  @scala.inline
  def apply(
    colors: /* value */ Double => CallbackTo[String] = null,
    ...
    scaleValues: (/* minValue */ Double, /* maxValue */ Double) => CallbackTo[js.Array[Double]] = null,
    scaleWidth: js.UndefOr[scala.Nothing] = js.undefined,
    texts: js.Array[AnonContent] = null
  ): AnonColors = {
    val __obj = js.Dynamic.literal()
    if (colors != null) __obj.updateDynamic("colors")(js.Any.fromFunction1((t0: /* value */ scala.Double) => colors(t0).runNow()))
    ...
    if (scaleValues != null) __obj.updateDynamic("scaleValues")(js.Any.fromFunction2((t0: /* minValue */ scala.Double, t1: /* maxValue */ scala.Double) => scaleValues(t0, t1).runNow()))
