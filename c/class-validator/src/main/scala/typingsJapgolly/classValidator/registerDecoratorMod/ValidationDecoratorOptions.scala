package typingsJapgolly.classValidator.registerDecoratorMod

import typingsJapgolly.classValidator.validatorConstraintInterfaceMod.ValidatorConstraintInterface
