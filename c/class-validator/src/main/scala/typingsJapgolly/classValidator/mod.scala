...
import typingsJapgolly.classValidator.classValidatorStrings.`3`
import typingsJapgolly.classValidator.classValidatorStrings.`4`
import typingsJapgolly.classValidator.classValidatorStrings.`5`
import typingsJapgolly.classValidator.containerMod.UseContainerOptions
import typingsJapgolly.classValidator.registerDecoratorMod.ValidationDecoratorOptions
...
import typingsJapgolly.classValidator.validationTypeOptionsMod.IsNumberOptions
...
object mod extends js.Object {
  ...
  class MetadataStorage ()
    extends typingsJapgolly.classValidator.metadataStorageMod.MetadataStorage
  
  @js.native
  class ValidationError ()
    extends typingsJapgolly.classValidator.validationErrorMod.ValidationError
  
  @js.native
  class ValidationTypes ()
    extends typingsJapgolly.classValidator.validationTypesMod.ValidationTypes
  
  @js.native
  class Validator ()
    extends typingsJapgolly.classValidator.validatorMod.Validator
  ...
  def validate(`object`: js.Object): js.Promise[js.Array[typingsJapgolly.classValidator.validationErrorMod.ValidationError]] = js.native
  def validate(`object`: js.Object, validatorOptions: ValidatorOptions): js.Promise[js.Array[typingsJapgolly.classValidator.validationErrorMod.ValidationError]] = js.native
  def validate(schemaName: String, `object`: js.Object): js.Promise[js.Array[typingsJapgolly.classValidator.validationErrorMod.ValidationError]] = js.native
  def validate(schemaName: String, `object`: js.Object, validatorOptions: ValidatorOptions): js.Promise[js.Array[typingsJapgolly.classValidator.validationErrorMod.ValidationError]] = js.native
  ...
  def validateSync(`object`: js.Object): js.Array[typingsJapgolly.classValidator.validationErrorMod.ValidationError] = js.native
  def validateSync(`object`: js.Object, validatorOptions: ValidatorOptions): js.Array[typingsJapgolly.classValidator.validationErrorMod.ValidationError] = js.native
  def validateSync(schemaName: String, `object`: js.Object): js.Array[typingsJapgolly.classValidator.validationErrorMod.ValidationError] = js.native
  def validateSync(schemaName: String, `object`: js.Object, validatorOptions: ValidatorOptions): js.Array[typingsJapgolly.classValidator.validationErrorMod.ValidationError] = js.native
  /* static members */
  @js.native
