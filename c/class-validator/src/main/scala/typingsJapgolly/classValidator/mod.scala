...
import typingsJapgolly.classValidator.anon.Async
import typingsJapgolly.classValidator.anon.Get
import typingsJapgolly.classValidator.anon.Instantiable
import typingsJapgolly.classValidator.anon.Nullable
import typingsJapgolly.classValidator.classValidatorStrings.any
import typingsJapgolly.classValidator.typesContainerMod.UseContainerOptions
import typingsJapgolly.classValidator.typesDecoratorArrayArrayUniqueMod.ArrayUniqueIdentifier
import typingsJapgolly.classValidator.typesDecoratorCommonValidateByMod.ValidateByOptions
...
import typingsJapgolly.classValidator.typesDecoratorTypecheckerIsNumberMod.IsNumberOptions
import typingsJapgolly.classValidator.typesDecoratorValidationOptionsMod.ValidationOptions
import typingsJapgolly.classValidator.typesRegisterDecoratorMod.ValidationDecoratorOptions
import typingsJapgolly.classValidator.typesValidationSchemaValidationSchemaMod.ValidationSchema
...
object mod {
  ...
  open class MetadataStorage ()
    extends typingsJapgolly.classValidator.typesMetadataMetadataStorageMod.MetadataStorage
  ...
  open class ValidationError ()
    extends typingsJapgolly.classValidator.typesValidationValidationErrorMod.ValidationError
  
  @JSImport("class-validator", "ValidationTypes")
  @js.native
  open class ValidationTypes ()
    extends typingsJapgolly.classValidator.typesValidationValidationTypesMod.ValidationTypes
  /* static members */
  ...
  open class Validator ()
    extends typingsJapgolly.classValidator.typesValidationValidatorMod.Validator
  ...
  inline def getMetadataStorage(): typingsJapgolly.classValidator.typesMetadataMetadataStorageMod.MetadataStorage = ^.asInstanceOf[js.Dynamic].applyDynamic("getMetadataStorage")().asInstanceOf[typingsJapgolly.classValidator.typesMetadataMetadataStorageMod.MetadataStorage]
  ...
  inline def validate(`object`: js.Object): js.Promise[
    js.Array[typingsJapgolly.classValidator.typesValidationValidationErrorMod.ValidationError]
  ...
  inline def validateSync(`object`: js.Object): js.Array[typingsJapgolly.classValidator.typesValidationValidationErrorMod.ValidationError] = ^.asInstanceOf[js.Dynamic].applyDynamic("validateSync")(`object`.asInstanceOf[js.Any]).asInstanceOf[js.Array[typingsJapgolly.classValidator.typesValidationValidationErrorMod.ValidationError]]
  inline def validateSync(`object`: js.Object, validatorOptions: ValidatorOptions): js.Array[typingsJapgolly.classValidator.typesValidationValidationErrorMod.ValidationError] = (^.asInstanceOf[js.Dynamic].applyDynamic("validateSync")(`object`.asInstanceOf[js.Any], validatorOptions.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.classValidator.typesValidationValidationErrorMod.ValidationError]]
  inline def validateSync(schemaName: String, `object`: js.Object): js.Array[typingsJapgolly.classValidator.typesValidationValidationErrorMod.ValidationError] = (^.asInstanceOf[js.Dynamic].applyDynamic("validateSync")(schemaName.asInstanceOf[js.Any], `object`.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.classValidator.typesValidationValidationErrorMod.ValidationError]]
  inline def validateSync(schemaName: String, `object`: js.Object, validatorOptions: ValidatorOptions): js.Array[typingsJapgolly.classValidator.typesValidationValidationErrorMod.ValidationError] = (^.asInstanceOf[js.Dynamic].applyDynamic("validateSync")(schemaName.asInstanceOf[js.Any], `object`.asInstanceOf[js.Any], validatorOptions.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.classValidator.typesValidationValidationErrorMod.ValidationError]]
}
