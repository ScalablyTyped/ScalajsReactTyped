...
import typingsJapgolly.chartDotJs.chartDotJsNumbers.`false`
import typingsJapgolly.chartDotJs.chartDotJsStrings.auto
import typingsJapgolly.chartDotJs.chartDotJsStrings.data
import typingsJapgolly.chartDotJs.chartDotJsStrings.labels
