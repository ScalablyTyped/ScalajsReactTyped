...
object RadialChartOptions {
  ...
  def apply(
    ...
    if (legendCallback != null) __obj.updateDynamic("legendCallback")(js.Any.fromFunction1((t0: /* chart */ typingsJapgolly.chartDotJs.chartDotJsMod.Chart) => legendCallback(t0).runNow()))
