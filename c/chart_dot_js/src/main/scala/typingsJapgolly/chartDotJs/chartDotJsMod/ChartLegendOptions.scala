...
object ChartLegendOptions {
  ...
  def apply(
    ...
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction2((t0: /* event */ org.scalajs.dom.raw.MouseEvent, t1: /* legendItem */ typingsJapgolly.chartDotJs.chartDotJsMod.ChartLegendLabelItem) => onClick(t0, t1).runNow()))
    if (onHover != null) __obj.updateDynamic("onHover")(js.Any.fromFunction2((t0: /* event */ org.scalajs.dom.raw.MouseEvent, t1: /* legendItem */ typingsJapgolly.chartDotJs.chartDotJsMod.ChartLegendLabelItem) => onHover(t0, t1).runNow()))
