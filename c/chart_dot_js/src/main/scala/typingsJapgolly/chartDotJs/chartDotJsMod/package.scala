...
package object chartDotJsMod {
  ...
  import typingsJapgolly.chartDotJs.Anon_Chart
  import typingsJapgolly.std.CanvasGradient
  import typingsJapgolly.std.CanvasPattern
  ...
  {[ key in chart.js.chart.js.PositionType ]:? number}
    */ typingsJapgolly.chartDotJs.chartDotJsStrings.BorderWidth with js.Any)
