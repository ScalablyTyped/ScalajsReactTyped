...
import typingsJapgolly.chartJs.mod.PolarAreaAnimationOptions
...
trait CoreChartOptionspolarArea extends StObject {
  ...
  /**
    ...
    */
  var backgroundColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[polarArea]]
  ...
  /**
    ...
    */
  var borderColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[polarArea]]
  ...
  /**
    ...
    * @see Defaults.color
    */
  var color: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[polarArea]]
...
object CoreChartOptionspolarArea {
  ...
  inline def apply(
    ...
    aspectRatio: Double,
    backgroundColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[polarArea]],
    bar: Datasets,
    borderColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[polarArea]],
    bubble: DatasetsBubbleControllerDatasetOptions,
    clip: Double | ChartArea | `false`,
    color: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[polarArea]],
  ...
  extension [Self <: CoreChartOptionspolarArea](x: Self) {
    ...
    inline def setBackgroundColor(value: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[polarArea]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext[polarArea], /* options */ AnyObject) => js.UndefOr[typingsJapgolly.chartJs.typesColorMod.Color]
    ...
    inline def setBorderColor(value: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[polarArea]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    ...
    inline def setColor(value: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[polarArea]]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
