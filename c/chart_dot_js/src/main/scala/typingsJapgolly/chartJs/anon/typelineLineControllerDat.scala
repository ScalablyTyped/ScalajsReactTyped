...
import typingsJapgolly.chartJs.mod.ComplexFillTarget
import typingsJapgolly.chartJs.mod.FillTarget
...
trait typelineLineControllerDat extends StObject {
  ...
  var backgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]
  
  var borderCapStyle: Scriptable[CanvasLineCap, ScriptableContext[line]]
  
  var borderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]
  ...
  var hoverBackgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]
  
  var hoverBorderCapStyle: Scriptable[CanvasLineCap, ScriptableContext[line]]
  
  var hoverBorderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]
  ...
  var pointBackgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]
  
  var pointBorderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]
  ...
  var pointHoverBackgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]
  
  var pointHoverBorderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]
  ...
  var pointStyle: ScriptableAndArray[typingsJapgolly.chartJs.mod.PointStyle, ScriptableContext[line]]
...
object typelineLineControllerDat {
  ...
  inline def apply(
    ...
    backgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]],
    borderCapStyle: Scriptable[CanvasLineCap, ScriptableContext[line]],
    borderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]],
    ...
    hidden: Boolean,
    hoverBackgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]],
    hoverBorderCapStyle: Scriptable[CanvasLineCap, ScriptableContext[line]],
    hoverBorderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]],
    ...
    pointBackgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]],
    pointBorderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]],
    ...
    pointHoverBackgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]],
    pointHoverBorderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]],
    ...
    pointStyle: ScriptableAndArray[typingsJapgolly.chartJs.mod.PointStyle, ScriptableContext[line]],
  ...
  extension [Self <: typelineLineControllerDat](x: Self) {
    ...
    inline def setBackgroundColor(value: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[typingsJapgolly.chartJs.typesColorMod.Color]
    ...
    inline def setBorderColor(value: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    ...
    inline def setHoverBackgroundColor(value: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]): Self = StObject.set(x, "hoverBackgroundColor", value.asInstanceOf[js.Any])
    ...
    inline def setHoverBorderColor(value: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]): Self = StObject.set(x, "hoverBorderColor", value.asInstanceOf[js.Any])
    ...
    inline def setPointBackgroundColor(value: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]): Self = StObject.set(x, "pointBackgroundColor", value.asInstanceOf[js.Any])
    
    inline def setPointBackgroundColorFunction2(
      value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[typingsJapgolly.chartJs.typesColorMod.Color]
    ): Self = StObject.set(x, "pointBackgroundColor", js.Any.fromFunction2(value))
    
    inline def setPointBackgroundColorVarargs(value: typingsJapgolly.chartJs.typesColorMod.Color*): Self = StObject.set(x, "pointBackgroundColor", js.Array(value*))
    
    inline def setPointBorderColor(value: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]): Self = StObject.set(x, "pointBorderColor", value.asInstanceOf[js.Any])
    
    inline def setPointBorderColorFunction2(
      value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[typingsJapgolly.chartJs.typesColorMod.Color]
    ): Self = StObject.set(x, "pointBorderColor", js.Any.fromFunction2(value))
    
    inline def setPointBorderColorVarargs(value: typingsJapgolly.chartJs.typesColorMod.Color*): Self = StObject.set(x, "pointBorderColor", js.Array(value*))
    ...
    inline def setPointHoverBackgroundColor(value: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]): Self = StObject.set(x, "pointHoverBackgroundColor", value.asInstanceOf[js.Any])
    
    inline def setPointHoverBackgroundColorFunction2(
      value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[typingsJapgolly.chartJs.typesColorMod.Color]
    ): Self = StObject.set(x, "pointHoverBackgroundColor", js.Any.fromFunction2(value))
    
    inline def setPointHoverBackgroundColorVarargs(value: typingsJapgolly.chartJs.typesColorMod.Color*): Self = StObject.set(x, "pointHoverBackgroundColor", js.Array(value*))
    
    inline def setPointHoverBorderColor(value: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[line]]): Self = StObject.set(x, "pointHoverBorderColor", value.asInstanceOf[js.Any])
    
    inline def setPointHoverBorderColorFunction2(
      value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[typingsJapgolly.chartJs.typesColorMod.Color]
    ): Self = StObject.set(x, "pointHoverBorderColor", js.Any.fromFunction2(value))
    
    inline def setPointHoverBorderColorVarargs(value: typingsJapgolly.chartJs.typesColorMod.Color*): Self = StObject.set(x, "pointHoverBorderColor", js.Array(value*))
    ...
    inline def setPointStyle(value: ScriptableAndArray[typingsJapgolly.chartJs.mod.PointStyle, ScriptableContext[line]]): Self = StObject.set(x, "pointStyle", value.asInstanceOf[js.Any])
    
    inline def setPointStyleFunction2(
      value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[typingsJapgolly.chartJs.mod.PointStyle]
    ): Self = StObject.set(x, "pointStyle", js.Any.fromFunction2(value))
    
    inline def setPointStyleVarargs(value: typingsJapgolly.chartJs.mod.PointStyle*): Self = StObject.set(x, "pointStyle", js.Array(value*))
