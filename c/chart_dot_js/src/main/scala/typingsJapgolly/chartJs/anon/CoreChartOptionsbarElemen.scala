...
import typingsJapgolly.chartJs.chartJsStrings.bar
...
/* Inlined chart.js.chart.js.CoreChartOptions<'bar'> & chart.js.chart.js.ElementChartOptions<'bar'> & chart.js.chart.js.PluginChartOptions<'bar'> & chart.js.chart.js.DatasetChartOptions<chart.js.chart.js.ChartType> & chart.js.chart.js.ScaleChartOptions<'bar'> & chart.js.chart.js.BarControllerChartOptions */
trait CoreChartOptionsbarElemen extends StObject {
  ...
  /**
    ...
    */
  var backgroundColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]
  ...
  /**
    ...
    */
  var borderColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]
  ...
  /**
    ...
    * @see Defaults.color
    */
  var color: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]
  ...
  var elements: ElementOptionsByType[bar]
  ...
  var layout: PartialautoPaddingboolean
  ...
  var plugins: PluginOptionsByType[bar]
...
object CoreChartOptionsbarElemen {
  
  inline def apply(
    animation: `false` | AnimationSpecbaronProgres,
    animations: AnimationsSpec[bar],
    aspectRatio: Double,
    backgroundColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]],
    bar: Datasets,
    borderColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]],
    bubble: DatasetsBubbleControllerDatasetOptions,
    clip: Double | ChartArea | `false`,
    color: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]],
    datasets: keyinChartTypeChartTypeReBar,
    devicePixelRatio: Double,
    doughnut: DatasetsDoughnutControllerDatasetOptions,
    elements: ElementOptionsByType[bar],
    events: js.Array[
      /* keyof std.HTMLElementEventMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 100, starting with typingsJapgolly.chartJs.chartJsStrings.fullscreenchange, typingsJapgolly.chartJs.chartJsStrings.fullscreenerror, typingsJapgolly.chartJs.chartJsStrings.copy */ Any
    ],
    ...
    layout: PartialautoPaddingboolean,
    line: `1`,
    locale: String,
  ...
  extension [Self <: CoreChartOptionsbarElemen](x: Self) {
    ...
    inline def setBackgroundColor(value: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext[bar], /* options */ AnyObject) => js.UndefOr[typingsJapgolly.chartJs.typesColorMod.Color]
    ...
    inline def setBorderColor(value: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    ...
    inline def setColor(value: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    ...
    inline def setElements(value: ElementOptionsByType[bar]): Self = StObject.set(x, "elements", value.asInstanceOf[js.Any])
    ...
    inline def setLayout(value: PartialautoPaddingboolean): Self = StObject.set(x, "layout", value.asInstanceOf[js.Any])
    ...
    inline def setPlugins(value: PluginOptionsByType[bar]): Self = StObject.set(x, "plugins", value.asInstanceOf[js.Any])
