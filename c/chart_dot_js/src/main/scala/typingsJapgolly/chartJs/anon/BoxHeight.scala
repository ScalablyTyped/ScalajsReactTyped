...
import typingsJapgolly.chartJs.mod.LegendItem
...
import typingsJapgolly.chartJs.mod.TextAlign
...
trait BoxHeight extends StObject {
  ...
  def filter(
    item: LegendItem,
    data: ChartData[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any]
  ): Boolean
...
object BoxHeight {
  ...
  inline def apply(
    ...
    filter: (LegendItem, ChartData[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any]) => Boolean,
    font: ScriptableAndScriptableOptions[PartialFontSpec, ScriptableChartContext],
    generateLabels: typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any] => js.Array[LegendItem],
    padding: Double,
    pointStyle: typingsJapgolly.chartJs.mod.PointStyle,
    sort: (LegendItem, LegendItem, ChartData[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any]) => Double,
  ...
  extension [Self <: BoxHeight](x: Self) {
    ...
    inline def setFilter(
      value: (LegendItem, ChartData[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any]) => Boolean
    ...
    inline def setGenerateLabels(
      value: typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any] => js.Array[LegendItem]
    ...
    inline def setSort(
      value: (LegendItem, LegendItem, ChartData[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any]) => Double
