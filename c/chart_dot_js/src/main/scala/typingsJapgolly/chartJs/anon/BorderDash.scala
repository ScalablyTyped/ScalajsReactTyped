...
import typingsJapgolly.chartJs.mod.ScriptableScaleContext
...
trait BorderDash extends StObject {
  ...
  /**
    ...
    */
  var color: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableScaleContext]
...
object BorderDash {
  ...
  inline def apply(
    ...
    color: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableScaleContext],
    display: Boolean,
  ...
  extension [Self <: BorderDash](x: Self) {
    ...
    inline def setColor(value: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableScaleContext]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    
    inline def setColorFunction2(
      value: (ScriptableScaleContext, /* options */ AnyObject) => js.UndefOr[typingsJapgolly.chartJs.typesColorMod.Color]
