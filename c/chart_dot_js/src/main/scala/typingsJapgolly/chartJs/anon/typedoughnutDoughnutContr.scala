...
import typingsJapgolly.chartJs.mod.ArcBorderRadius
import typingsJapgolly.chartJs.mod.ScriptableAndArray
...
/* Inlined {  type :'doughnut'} & chart.js.chart.js.DoughnutControllerDatasetOptions */
trait typedoughnutDoughnutContr extends StObject {
  ...
  var backgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[doughnut]]
  
  var borderAlign: ScriptableAndArray[center | inner, ScriptableContext[doughnut]]
  
  var borderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[doughnut]]
  ...
  var hoverBackgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[doughnut]]
  
  var hoverBorderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[doughnut]]
...
object typedoughnutDoughnutContr {
  ...
  inline def apply(
    ...
    backgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[doughnut]],
    borderAlign: ScriptableAndArray[center | inner, ScriptableContext[doughnut]],
    borderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[doughnut]],
    ...
    hidden: Boolean,
    hoverBackgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[doughnut]],
    hoverBorderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[doughnut]],
  ...
  extension [Self <: typedoughnutDoughnutContr](x: Self) {
    ...
    inline def setBackgroundColor(
      value: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[doughnut]]
    ): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext[doughnut], /* options */ AnyObject) => js.UndefOr[typingsJapgolly.chartJs.typesColorMod.Color]
    ): Self = StObject.set(x, "backgroundColor", js.Any.fromFunction2(value))
    
    inline def setBackgroundColorVarargs(value: typingsJapgolly.chartJs.typesColorMod.Color*): Self = StObject.set(x, "backgroundColor", js.Array(value*))
    ...
    inline def setBorderColorVarargs(value: typingsJapgolly.chartJs.typesColorMod.Color*): Self = StObject.set(x, "borderColor", js.Array(value*))
    ...
    inline def setHoverBackgroundColorVarargs(value: typingsJapgolly.chartJs.typesColorMod.Color*): Self = StObject.set(x, "hoverBackgroundColor", js.Array(value*))
    ...
    inline def setHoverBorderColorVarargs(value: typingsJapgolly.chartJs.typesColorMod.Color*): Self = StObject.set(x, "hoverBorderColor", js.Array(value*))
