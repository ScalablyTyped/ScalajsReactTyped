...
trait typebarBarControllerDatas extends StObject {
  ...
  var backgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]
  ...
  var borderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]
  ...
  var hoverBackgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]
  
  var hoverBorderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]
...
object typebarBarControllerDatas {
  ...
  inline def apply(
    ...
    backgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]],
    barPercentage: Double,
    barThickness: Double | flex,
    base: ScriptableAndArray[Double, ScriptableContext[bar]],
    borderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]],
    ...
    hidden: Boolean,
    hoverBackgroundColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]],
    hoverBorderColor: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]],
  ...
  extension [Self <: typebarBarControllerDatas](x: Self) {
    ...
    inline def setBackgroundColor(value: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    ...
    inline def setBorderColor(value: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    ...
    inline def setHoverBackgroundColor(value: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]): Self = StObject.set(x, "hoverBackgroundColor", value.asInstanceOf[js.Any])
    ...
    inline def setHoverBorderColor(value: ScriptableAndArray[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[bar]]): Self = StObject.set(x, "hoverBorderColor", value.asInstanceOf[js.Any])
