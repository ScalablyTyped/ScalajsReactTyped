...
import typingsJapgolly.chartJs.mod.ScriptableLineSegmentContext
...
trait BackgroundColor extends StObject {
  ...
  var backgroundColor: Scriptable[
    js.UndefOr[typingsJapgolly.chartJs.typesColorMod.Color], 
...
object BackgroundColor {
  ...
  extension [Self <: BackgroundColor](x: Self) {
    ...
    inline def setBackgroundColorFunction2(
      value: (ScriptableLineSegmentContext, /* options */ AnyObject) => js.UndefOr[js.UndefOr[typingsJapgolly.chartJs.typesColorMod.Color]]
