...
import typingsJapgolly.chartJs.mod.ActiveElement
import typingsJapgolly.chartJs.mod.AnimationsSpec
import typingsJapgolly.chartJs.mod.ChartEvent
import typingsJapgolly.chartJs.mod.ChartType
import typingsJapgolly.chartJs.mod.CoreInteractionOptions
import typingsJapgolly.chartJs.mod.ElementOptionsByType
import typingsJapgolly.chartJs.mod.PluginOptionsByType
...
import typingsJapgolly.chartJs.mod.TransitionsSpec
...
/* Inlined chart.js.chart.js.CoreChartOptions<'radar'> & chart.js.chart.js.ElementChartOptions<'radar'> & chart.js.chart.js.PluginChartOptions<'radar'> & chart.js.chart.js.DatasetChartOptions<chart.js.chart.js.ChartType> & chart.js.chart.js.ScaleChartOptions<'radar'> & chart.js.chart.js.RadarControllerChartOptions */
trait CoreChartOptionsradarElem extends StObject {
  ...
  /**
    ...
    */
  var backgroundColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[radar]]
  ...
  /**
    ...
    */
  var borderColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[radar]]
  ...
  /**
    ...
    * @see Defaults.color
    */
  var color: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[radar]]
  ...
  var elements: ElementOptionsByType[radar]
  ...
  /**
    ...
    */
  var events: js.Array[
    /* keyof std.HTMLElementEventMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 100, starting with typingsJapgolly.chartJs.chartJsStrings.fullscreenchange, typingsJapgolly.chartJs.chartJsStrings.fullscreenerror, typingsJapgolly.chartJs.chartJsStrings.copy */ Any
  ]
  ...
  var layout: PartialautoPaddingbooleanPadding
  ...
  var plugins: PluginOptionsByType[radar]
  ...
  var scales: StringDictionary[ScaleOptionsByType[radialLinear]]
...
object CoreChartOptionsradarElem {
  
  inline def apply(
    animation: `false` | AnimationSpecradaronProgr,
    animations: AnimationsSpec[radar],
    aspectRatio: Double,
    backgroundColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[radar]],
    bar: Datasets,
    borderColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[radar]],
    bubble: DatasetsBubbleControllerDatasetOptions,
    clip: Double | ChartArea | `false`,
    color: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[radar]],
    datasets: keyinChartTypeChartTypeReBar,
    devicePixelRatio: Double,
    doughnut: DatasetsDoughnutControllerDatasetOptions,
    elements: ElementOptionsByType[radar],
    events: js.Array[
      /* keyof std.HTMLElementEventMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 100, starting with typingsJapgolly.chartJs.chartJsStrings.fullscreenchange, typingsJapgolly.chartJs.chartJsStrings.fullscreenerror, typingsJapgolly.chartJs.chartJsStrings.copy */ Any
    ],
    ...
    layout: PartialautoPaddingbooleanPadding,
    line: `1`,
    locale: String,
    maintainAspectRatio: Boolean,
    normalized: Boolean,
    onClick: (ChartEvent, js.Array[ActiveElement], typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any]) => Callback,
    onHover: (ChartEvent, js.Array[ActiveElement], typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any]) => Callback,
    onResize: (typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any], Height) => Callback,
    parsing: StringDictionary[String] | `false`,
    pie: DatasetsPieControllerDatasetOptions,
    plugins: PluginOptionsByType[radar],
    polarArea: DatasetsPolarAreaControllerDatasetOptions,
    radar: `0`,
    resizeDelay: Double,
    responsive: Boolean,
    scales: StringDictionary[ScaleOptionsByType[radialLinear]],
    scatter: DatasetsScatterControllerDatasetOptions,
    showLine: Boolean,
    spanGaps: Boolean | Double,
    transitions: TransitionsSpec[radar]
  ): CoreChartOptionsradarElem = {
    val __obj = js.Dynamic.literal(animation = animation.asInstanceOf[js.Any], animations = animations.asInstanceOf[js.Any], aspectRatio = aspectRatio.asInstanceOf[js.Any], backgroundColor = backgroundColor.asInstanceOf[js.Any], bar = bar.asInstanceOf[js.Any], borderColor = borderColor.asInstanceOf[js.Any], bubble = bubble.asInstanceOf[js.Any], clip = clip.asInstanceOf[js.Any], color = color.asInstanceOf[js.Any], datasets = datasets.asInstanceOf[js.Any], devicePixelRatio = devicePixelRatio.asInstanceOf[js.Any], doughnut = doughnut.asInstanceOf[js.Any], elements = elements.asInstanceOf[js.Any], events = events.asInstanceOf[js.Any], font = font.asInstanceOf[js.Any], hover = hover.asInstanceOf[js.Any], indexAxis = indexAxis.asInstanceOf[js.Any], interaction = interaction.asInstanceOf[js.Any], layout = layout.asInstanceOf[js.Any], line = line.asInstanceOf[js.Any], locale = locale.asInstanceOf[js.Any], maintainAspectRatio = maintainAspectRatio.asInstanceOf[js.Any], normalized = normalized.asInstanceOf[js.Any], onClick = js.Any.fromFunction3((t0: ChartEvent, t1: js.Array[ActiveElement], t2: typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any]) => (onClick(t0, t1, t2)).runNow()), onHover = js.Any.fromFunction3((t0: ChartEvent, t1: js.Array[ActiveElement], t2: typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any]) => (onHover(t0, t1, t2)).runNow()), onResize = js.Any.fromFunction2((t0: typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any], t1: Height) => (onResize(t0, t1)).runNow()), parsing = parsing.asInstanceOf[js.Any], pie = pie.asInstanceOf[js.Any], plugins = plugins.asInstanceOf[js.Any], polarArea = polarArea.asInstanceOf[js.Any], radar = radar.asInstanceOf[js.Any], resizeDelay = resizeDelay.asInstanceOf[js.Any], responsive = responsive.asInstanceOf[js.Any], scales = scales.asInstanceOf[js.Any], scatter = scatter.asInstanceOf[js.Any], showLine = showLine.asInstanceOf[js.Any], spanGaps = spanGaps.asInstanceOf[js.Any], transitions = transitions.asInstanceOf[js.Any])
  ...
  extension [Self <: CoreChartOptionsradarElem](x: Self) {
    ...
    inline def setBackgroundColor(value: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[radar]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext[radar], /* options */ AnyObject) => js.UndefOr[typingsJapgolly.chartJs.typesColorMod.Color]
    ...
    inline def setBorderColor(value: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[radar]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    ...
    inline def setColor(value: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[radar]]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    ...
    inline def setElements(value: ElementOptionsByType[radar]): Self = StObject.set(x, "elements", value.asInstanceOf[js.Any])
    ...
    inline def setEventsVarargs(
      value: (/* keyof std.HTMLElementEventMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 100, starting with typingsJapgolly.chartJs.chartJsStrings.fullscreenchange, typingsJapgolly.chartJs.chartJsStrings.fullscreenerror, typingsJapgolly.chartJs.chartJsStrings.copy */ Any)*
    ...
    inline def setIndexAxis(value: typingsJapgolly.chartJs.chartJsStrings.x | y): Self = StObject.set(x, "indexAxis", value.asInstanceOf[js.Any])
    
    inline def setInteraction(value: CoreInteractionOptions): Self = StObject.set(x, "interaction", value.asInstanceOf[js.Any])
    
    inline def setLayout(value: PartialautoPaddingbooleanPadding): Self = StObject.set(x, "layout", value.asInstanceOf[js.Any])
    ...
    inline def setOnClick(
      value: (ChartEvent, js.Array[ActiveElement], typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any]) => Callback
    ): Self = StObject.set(x, "onClick", js.Any.fromFunction3((t0: ChartEvent, t1: js.Array[ActiveElement], t2: typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnHover(
      value: (ChartEvent, js.Array[ActiveElement], typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any]) => Callback
    ): Self = StObject.set(x, "onHover", js.Any.fromFunction3((t0: ChartEvent, t1: js.Array[ActiveElement], t2: typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnResize(
      value: (typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any], Height) => Callback
    ): Self = StObject.set(x, "onResize", js.Any.fromFunction2((t0: typingsJapgolly.chartJs.mod.Chart[ChartType, typingsJapgolly.chartJs.mod.DefaultDataPoint[ChartType], Any], t1: Height) => (value(t0, t1)).runNow()))
    ...
    inline def setPlugins(value: PluginOptionsByType[radar]): Self = StObject.set(x, "plugins", value.asInstanceOf[js.Any])
    ...
    inline def setScales(value: StringDictionary[ScaleOptionsByType[radialLinear]]): Self = StObject.set(x, "scales", value.asInstanceOf[js.Any])
