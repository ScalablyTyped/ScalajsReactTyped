...
import typingsJapgolly.chartJs.typesAdaptersMod.TimeUnit
...
trait PartialDateAdapter extends StObject {
  ...
  var init: js.UndefOr[
    js.Function1[/* chartOptions */ typingsJapgolly.chartJs.mod.ChartOptions[ChartType], Unit]
  ] = js.undefined
...
object PartialDateAdapter {
  ...
  extension [Self <: PartialDateAdapter](x: Self) {
    ...
    inline def setFormats(value: CallbackTo[StringDictionary[String]]): Self = StObject.set(x, "formats", value.toJsFn)
    
    inline def setFormatsUndefined: Self = StObject.set(x, "formats", js.undefined)
    
    inline def setInit(value: /* chartOptions */ typingsJapgolly.chartJs.mod.ChartOptions[ChartType] => Callback): Self = StObject.set(x, "init", js.Any.fromFunction1((t0: /* chartOptions */ typingsJapgolly.chartJs.mod.ChartOptions[ChartType]) => value(t0).runNow()))
    ...
    inline def setOverride(value: /* members */ Partial[PartialDateAdapter] => Callback): Self = StObject.set(x, "override", js.Any.fromFunction1((t0: /* members */ Partial[PartialDateAdapter]) => value(t0).runNow()))
