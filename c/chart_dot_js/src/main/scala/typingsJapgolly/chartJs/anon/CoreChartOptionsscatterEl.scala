...
trait CoreChartOptionsscatterEl extends StObject {
  ...
  /**
    ...
    */
  var backgroundColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[scatter]]
  ...
  /**
    ...
    */
  var borderColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[scatter]]
  ...
  /**
    ...
    * @see Defaults.color
    */
  var color: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[scatter]]
...
object CoreChartOptionsscatterEl {
  ...
  inline def apply(
    ...
    aspectRatio: Double,
    backgroundColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[scatter]],
    bar: Datasets,
    borderColor: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[scatter]],
    bubble: DatasetsBubbleControllerDatasetOptions,
    clip: Double | ChartArea | `false`,
    color: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[scatter]],
  ...
  extension [Self <: CoreChartOptionsscatterEl](x: Self) {
    ...
    inline def setBackgroundColor(value: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[scatter]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext[scatter], /* options */ AnyObject) => js.UndefOr[typingsJapgolly.chartJs.typesColorMod.Color]
    ...
    inline def setBorderColor(value: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[scatter]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    ...
    inline def setColor(value: Scriptable[typingsJapgolly.chartJs.typesColorMod.Color, ScriptableContext[scatter]]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
