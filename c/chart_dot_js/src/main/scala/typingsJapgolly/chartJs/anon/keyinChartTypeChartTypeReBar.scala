...
import typingsJapgolly.chartJs.mod.DoughnutControllerDatasetOptions
...
import typingsJapgolly.chartJs.mod.PolarAreaControllerDatasetOptions
import typingsJapgolly.chartJs.mod.RadarControllerDatasetOptions
