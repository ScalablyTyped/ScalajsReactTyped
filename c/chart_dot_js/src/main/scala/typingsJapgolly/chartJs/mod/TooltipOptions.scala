...
import typingsJapgolly.chartJs.anon.ChartTooltip
...
object TooltipOptions {
  ...
  inline def apply[TType /* <: ChartType */](
    ...
    external: ChartTooltip[TType] => Callback,
    ...
    val __obj = js.Dynamic.literal(animation = animation.asInstanceOf[js.Any], animations = animations.asInstanceOf[js.Any], axis = axis.asInstanceOf[js.Any], backgroundColor = backgroundColor.asInstanceOf[js.Any], bodyAlign = bodyAlign.asInstanceOf[js.Any], bodyColor = bodyColor.asInstanceOf[js.Any], bodyFont = bodyFont.asInstanceOf[js.Any], bodySpacing = bodySpacing.asInstanceOf[js.Any], borderColor = borderColor.asInstanceOf[js.Any], borderWidth = borderWidth.asInstanceOf[js.Any], boxHeight = boxHeight.asInstanceOf[js.Any], boxPadding = boxPadding.asInstanceOf[js.Any], boxWidth = boxWidth.asInstanceOf[js.Any], callbacks = callbacks.asInstanceOf[js.Any], caretPadding = caretPadding.asInstanceOf[js.Any], caretSize = caretSize.asInstanceOf[js.Any], cornerRadius = cornerRadius.asInstanceOf[js.Any], displayColors = displayColors.asInstanceOf[js.Any], enabled = enabled.asInstanceOf[js.Any], external = js.Any.fromFunction1((t0: ChartTooltip[TType]) => external(t0).runNow()), filter = js.Any.fromFunction4(filter), footerAlign = footerAlign.asInstanceOf[js.Any], footerColor = footerColor.asInstanceOf[js.Any], footerFont = footerFont.asInstanceOf[js.Any], footerMarginTop = footerMarginTop.asInstanceOf[js.Any], footerSpacing = footerSpacing.asInstanceOf[js.Any], includeInvisible = includeInvisible.asInstanceOf[js.Any], intersect = intersect.asInstanceOf[js.Any], itemSort = js.Any.fromFunction3(itemSort), mode = mode.asInstanceOf[js.Any], multiKeyBackground = multiKeyBackground.asInstanceOf[js.Any], padding = padding.asInstanceOf[js.Any], position = position.asInstanceOf[js.Any], rtl = rtl.asInstanceOf[js.Any], textDirection = textDirection.asInstanceOf[js.Any], titleAlign = titleAlign.asInstanceOf[js.Any], titleColor = titleColor.asInstanceOf[js.Any], titleFont = titleFont.asInstanceOf[js.Any], titleMarginBottom = titleMarginBottom.asInstanceOf[js.Any], titleSpacing = titleSpacing.asInstanceOf[js.Any], usePointStyle = usePointStyle.asInstanceOf[js.Any], xAlign = xAlign.asInstanceOf[js.Any], yAlign = yAlign.asInstanceOf[js.Any])
  ...
  extension [Self <: TooltipOptions[?], TType /* <: ChartType */](x: Self & TooltipOptions[TType]) {
    ...
    inline def setExternal(value: ChartTooltip[TType] => Callback): Self = StObject.set(x, "external", js.Any.fromFunction1((t0: ChartTooltip[TType]) => value(t0).runNow()))
