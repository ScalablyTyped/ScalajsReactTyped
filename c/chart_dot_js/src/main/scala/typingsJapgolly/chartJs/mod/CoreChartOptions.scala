...
import typingsJapgolly.chartJs.anon.AutoPadding
...
import typingsJapgolly.chartJs.anon.keyinChartTypeChartTypeReBar
...
object CoreChartOptions {
  ...
  extension [Self <: CoreChartOptions[?], TType /* <: ChartType */](x: Self & CoreChartOptions[TType]) {
    ...
    inline def setOnClick(
      value: (ChartEvent, js.Array[ActiveElement], Chart[ChartType, DefaultDataPoint[ChartType], Any]) => Callback
    ): Self = StObject.set(x, "onClick", js.Any.fromFunction3((t0: ChartEvent, t1: js.Array[ActiveElement], t2: Chart[ChartType, DefaultDataPoint[ChartType], Any]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnHover(
      value: (ChartEvent, js.Array[ActiveElement], Chart[ChartType, DefaultDataPoint[ChartType], Any]) => Callback
    ): Self = StObject.set(x, "onHover", js.Any.fromFunction3((t0: ChartEvent, t1: js.Array[ActiveElement], t2: Chart[ChartType, DefaultDataPoint[ChartType], Any]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnResize(value: (Chart[ChartType, DefaultDataPoint[ChartType], Any], Height) => Callback): Self = StObject.set(x, "onResize", js.Any.fromFunction2((t0: Chart[ChartType, DefaultDataPoint[ChartType], Any], t1: Height) => (value(t0, t1)).runNow()))
