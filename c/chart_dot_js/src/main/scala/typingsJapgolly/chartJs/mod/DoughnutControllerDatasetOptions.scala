...
/* Inlined parent chart.js.chart.js.ScriptableAndArrayOptions<chart.js.chart.js.ArcOptions, chart.js.chart.js.ScriptableContext<'doughnut'>> */
/* Inlined parent chart.js.chart.js.ScriptableAndArrayOptions<chart.js.chart.js.ArcHoverOptions, chart.js.chart.js.ScriptableContext<'doughnut'>> */
/* Inlined parent chart.js.chart.js.AnimationOptions<'doughnut'> */
trait DoughnutControllerDatasetOptions extends StObject {
  
  var animation: `false` | AnimationSpecdoughnutonPr
  
  var animations: AnimationsSpec[doughnut]
  
  var backgroundColor: ScriptableAndArray[Color, ScriptableContext[doughnut]]
  
  var borderAlign: ScriptableAndArray[center | inner, ScriptableContext[doughnut]]
  
  var borderColor: ScriptableAndArray[Color, ScriptableContext[doughnut]]
  ...
  var hoverBackgroundColor: ScriptableAndArray[Color, ScriptableContext[doughnut]]
  
  var hoverBorderColor: ScriptableAndArray[Color, ScriptableContext[doughnut]]
...
object DoughnutControllerDatasetOptions {
  ...
  extension [Self <: DoughnutControllerDatasetOptions](x: Self) {
    ...
    inline def setBackgroundColor(value: ScriptableAndArray[Color, ScriptableContext[doughnut]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(value: (ScriptableContext[doughnut], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "backgroundColor", js.Any.fromFunction2(value))
    ...
    inline def setBorderColor(value: ScriptableAndArray[Color, ScriptableContext[doughnut]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    
    inline def setBorderColorFunction2(value: (ScriptableContext[doughnut], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "borderColor", js.Any.fromFunction2(value))
    ...
    inline def setHoverBackgroundColor(value: ScriptableAndArray[Color, ScriptableContext[doughnut]]): Self = StObject.set(x, "hoverBackgroundColor", value.asInstanceOf[js.Any])
    
    inline def setHoverBackgroundColorFunction2(value: (ScriptableContext[doughnut], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "hoverBackgroundColor", js.Any.fromFunction2(value))
    
    inline def setHoverBackgroundColorVarargs(value: Color*): Self = StObject.set(x, "hoverBackgroundColor", js.Array(value*))
    
    inline def setHoverBorderColor(value: ScriptableAndArray[Color, ScriptableContext[doughnut]]): Self = StObject.set(x, "hoverBorderColor", value.asInstanceOf[js.Any])
    
    inline def setHoverBorderColorFunction2(value: (ScriptableContext[doughnut], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "hoverBorderColor", js.Any.fromFunction2(value))
