...
object ChartLegendLabelOptions {
  ...
  def apply(
    ...
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction2((t0: /* legendItem */ typingsJapgolly.chartJs.mod.ChartLegendLabelItem, t1: /* data */ typingsJapgolly.chartJs.mod.ChartData) => filter(t0, t1).runNow()))
    if (fontColor != null) __obj.updateDynamic("fontColor")(fontColor.asInstanceOf[js.Any])
    if (fontFamily != null) __obj.updateDynamic("fontFamily")(fontFamily.asInstanceOf[js.Any])
    if (fontSize != null) __obj.updateDynamic("fontSize")(fontSize.asInstanceOf[js.Any])
    if (fontStyle != null) __obj.updateDynamic("fontStyle")(fontStyle.asInstanceOf[js.Any])
    if (generateLabels != null) __obj.updateDynamic("generateLabels")(js.Any.fromFunction1((t0: /* chart */ typingsJapgolly.chartJs.mod.Chart) => generateLabels(t0).runNow()))
