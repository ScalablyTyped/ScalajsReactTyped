...
object ChartTooltipOptions {
  ...
  def apply(
    ...
    if (custom != null) __obj.updateDynamic("custom")(js.Any.fromFunction1((t0: /* tooltipModel */ typingsJapgolly.chartJs.mod.ChartTooltipModel) => custom(t0).runNow()))
    if (!js.isUndefined(displayColors)) __obj.updateDynamic("displayColors")(displayColors.asInstanceOf[js.Any])
    if (!js.isUndefined(enabled)) __obj.updateDynamic("enabled")(enabled.asInstanceOf[js.Any])
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction2((t0: /* item */ typingsJapgolly.chartJs.mod.ChartTooltipItem, t1: /* data */ typingsJapgolly.chartJs.mod.ChartData) => filter(t0, t1).runNow()))
    ...
    if (itemSort != null) __obj.updateDynamic("itemSort")(js.Any.fromFunction3((t0: /* itemA */ typingsJapgolly.chartJs.mod.ChartTooltipItem, t1: /* itemB */ typingsJapgolly.chartJs.mod.ChartTooltipItem, t2: /* data */ js.UndefOr[typingsJapgolly.chartJs.mod.ChartData]) => itemSort(t0, t1, t2).runNow()))
