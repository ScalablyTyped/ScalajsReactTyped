...
trait LineElement[T /* <: LineProps */, O /* <: LineOptions */]
  ...
  def interpolate(
    point: Point,
    property: typingsJapgolly.chartJs.chartJsStrings.x | typingsJapgolly.chartJs.chartJsStrings.y
  ): js.UndefOr[Point | js.Array[Point]] = js.native
  ...
  def updateControlPoints(
    chartArea: ChartArea,
    indexAxis: typingsJapgolly.chartJs.chartJsStrings.x | typingsJapgolly.chartJs.chartJsStrings.y
  ): Unit = js.native
}
