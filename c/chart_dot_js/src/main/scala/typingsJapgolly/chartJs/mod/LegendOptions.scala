...
import typingsJapgolly.chartJs.anon.BoxHeight
import typingsJapgolly.chartJs.anon.Color
import typingsJapgolly.chartJs.typesLayoutMod.LayoutPosition
...
object LegendOptions {
  ...
  inline def apply[TType /* <: ChartType */](
    ...
    maxHeight: Double,
    maxWidth: Double,
    onClick: (ChartEvent, LegendItem, LegendElement[TType]) => Callback,
    onHover: (ChartEvent, LegendItem, LegendElement[TType]) => Callback,
    onLeave: (ChartEvent, LegendItem, LegendElement[TType]) => Callback,
    ...
    val __obj = js.Dynamic.literal(align = align.asInstanceOf[js.Any], display = display.asInstanceOf[js.Any], fullSize = fullSize.asInstanceOf[js.Any], labels = labels.asInstanceOf[js.Any], maxHeight = maxHeight.asInstanceOf[js.Any], maxWidth = maxWidth.asInstanceOf[js.Any], onClick = js.Any.fromFunction3((t0: ChartEvent, t1: LegendItem, t2: LegendElement[TType]) => (onClick(t0, t1, t2)).runNow()), onHover = js.Any.fromFunction3((t0: ChartEvent, t1: LegendItem, t2: LegendElement[TType]) => (onHover(t0, t1, t2)).runNow()), onLeave = js.Any.fromFunction3((t0: ChartEvent, t1: LegendItem, t2: LegendElement[TType]) => (onLeave(t0, t1, t2)).runNow()), position = position.asInstanceOf[js.Any], reverse = reverse.asInstanceOf[js.Any], rtl = rtl.asInstanceOf[js.Any], textDirection = textDirection.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any])
  ...
  extension [Self <: LegendOptions[?], TType /* <: ChartType */](x: Self & LegendOptions[TType]) {
    ...
    inline def setOnClick(value: (ChartEvent, LegendItem, LegendElement[TType]) => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction3((t0: ChartEvent, t1: LegendItem, t2: LegendElement[TType]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnHover(value: (ChartEvent, LegendItem, LegendElement[TType]) => Callback): Self = StObject.set(x, "onHover", js.Any.fromFunction3((t0: ChartEvent, t1: LegendItem, t2: LegendElement[TType]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnLeave(value: (ChartEvent, LegendItem, LegendElement[TType]) => Callback): Self = StObject.set(x, "onLeave", js.Any.fromFunction3((t0: ChartEvent, t1: LegendItem, t2: LegendElement[TType]) => (value(t0, t1, t2)).runNow()))
