...
import typingsJapgolly.cesium.mod.PlaneOutlineGeometry
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sourceCorePlaneOutlineGeometryMod {
  
  @JSImport("cesium/Source/Core/PlaneOutlineGeometry", JSImport.Default)
  @js.native
  open class default () extends PlaneOutlineGeometry
  /* static members */
  object default {
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/PlaneOutlineGeometry", "default.packedLength")
    @js.native
