...
import typingsJapgolly.cesium.anon.MinimumHeight
import typingsJapgolly.cesium.anon.MinimumHeights
import typingsJapgolly.cesium.mod.Geometry
import typingsJapgolly.cesium.mod.WallOutlineGeometry
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sourceCoreWallOutlineGeometryMod {
  
  @JSImport("cesium/Source/Core/WallOutlineGeometry", JSImport.Default)
  @js.native
  open class default protected () extends WallOutlineGeometry {
