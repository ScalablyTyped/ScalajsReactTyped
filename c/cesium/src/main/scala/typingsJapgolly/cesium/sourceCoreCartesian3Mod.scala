...
object sourceCoreCartesian3Mod {
  
  @JSImport("cesium/Source/Core/Cartesian3", JSImport.Default)
  @js.native
  open class default () extends Cartesian3 {
  ...
  object default {
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartesian3", "default.ONE")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartesian3", "default.UNIT_X")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartesian3", "default.UNIT_Y")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartesian3", "default.UNIT_Z")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartesian3", "default.ZERO")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartesian3", "default.packedLength")
    @js.native
