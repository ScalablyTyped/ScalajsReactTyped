...
import typingsJapgolly.cesium.mod.Intersect
import typingsJapgolly.cesium.mod.Rectangle
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sourceCoreBoundingRectangleMod {
  
  @JSImport("cesium/Source/Core/BoundingRectangle", JSImport.Default)
  @js.native
  open class default () extends BoundingRectangle {
  ...
  object default {
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/BoundingRectangle", "default.packedLength")
    @js.native
