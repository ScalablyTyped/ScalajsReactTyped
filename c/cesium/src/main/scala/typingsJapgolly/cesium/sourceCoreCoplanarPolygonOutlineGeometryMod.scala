...
import typingsJapgolly.cesium.anon.PolygonHierarchyPolygonHierarchy
import typingsJapgolly.cesium.anon.PositionsArray
import typingsJapgolly.cesium.mod.CoplanarPolygonOutlineGeometry
import typingsJapgolly.cesium.mod.Geometry
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sourceCoreCoplanarPolygonOutlineGeometryMod {
  
  @JSImport("cesium/Source/Core/CoplanarPolygonOutlineGeometry", JSImport.Default)
  @js.native
  open class default protected () extends CoplanarPolygonOutlineGeometry {
