...
import typingsJapgolly.cesium.anon.EllipsoidGranularity
...
@js.native
open class RectangleGeometry protected () extends StObject {
  def this(options: typingsJapgolly.cesium.anon.Rectangle) = this()
}
/* static members */
object RectangleGeometry {
  ...
  /**
    ...
    */
  inline def computeRectangle(options: EllipsoidGranularity): Rectangle = ^.asInstanceOf[js.Dynamic].applyDynamic("computeRectangle")(options.asInstanceOf[js.Any]).asInstanceOf[Rectangle]
  inline def computeRectangle(options: EllipsoidGranularity, result: Rectangle): Rectangle = (^.asInstanceOf[js.Dynamic].applyDynamic("computeRectangle")(options.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Rectangle]
  ...
  /**
    ...
    */
  @JSImport("cesium", "RectangleGeometry.packedLength")
  @js.native
