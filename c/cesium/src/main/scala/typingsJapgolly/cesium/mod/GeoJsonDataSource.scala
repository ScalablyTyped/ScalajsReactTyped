...
object GeoJsonDataSource {
  ...
  trait LoadOptions extends StObject {
    ...
    var describe: js.UndefOr[typingsJapgolly.cesium.mod.GeoJsonDataSource.describe] = js.undefined
  ...
  object LoadOptions {
    ...
    extension [Self <: LoadOptions](x: Self) {
      ...
      inline def setDescribe(value: (/* properties */ Any, /* nameProperty */ String) => Callback): Self = StObject.set(x, "describe", js.Any.fromFunction2((t0: /* properties */ Any, t1: /* nameProperty */ String) => (value(t0, t1)).runNow()))
