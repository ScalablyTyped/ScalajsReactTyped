...
import typingsJapgolly.cesium.anon.EllipsoidExtrudedHeight
import typingsJapgolly.cesium.anon.PerPositionHeight
...
@js.native
open class PolygonOutlineGeometry protected () extends StObject {
