...
@JSImport("cesium", "CustomShaderMode")
@js.native
object CustomShaderMode extends StObject {
  ...
  /* "MODIFY_MATERIAL" */ val MODIFY_MATERIAL: typingsJapgolly.cesium.mod.CustomShaderMode.MODIFY_MATERIAL & String = js.native
  ...
  sealed trait REPLACE_MATERIAL
    extends StObject
       with CustomShaderMode
  /* "REPLACE_MATERIAL" */ val REPLACE_MATERIAL: typingsJapgolly.cesium.mod.CustomShaderMode.REPLACE_MATERIAL & String = js.native
}
