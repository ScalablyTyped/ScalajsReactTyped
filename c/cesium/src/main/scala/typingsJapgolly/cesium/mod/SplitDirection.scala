...
object SplitDirection extends StObject {
  ...
  sealed trait LEFT
    extends StObject
       with SplitDirection
  /* -1 */ val LEFT: typingsJapgolly.cesium.mod.SplitDirection.LEFT & Double = js.native
  ...
  sealed trait NONE
    extends StObject
       with SplitDirection
  /* 0 */ val NONE: typingsJapgolly.cesium.mod.SplitDirection.NONE & Double = js.native
  ...
  sealed trait RIGHT
    extends StObject
       with SplitDirection
  /* 1 */ val RIGHT: typingsJapgolly.cesium.mod.SplitDirection.RIGHT & Double = js.native
}
