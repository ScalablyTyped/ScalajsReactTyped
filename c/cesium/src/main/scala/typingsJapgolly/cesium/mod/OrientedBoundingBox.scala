...
@JSImport("cesium", "OrientedBoundingBox")
@js.native
open class OrientedBoundingBox () extends StObject {
  ...
  /**
    ...
    */
  def computeCorners(): js.Array[Cartesian3] = js.native
  def computeCorners(result: js.Array[Cartesian3]): js.Array[Cartesian3] = js.native
  ...
  /**
    ...
    */
  def computeTransformation(result: Matrix4): Matrix4 = js.native
...
object OrientedBoundingBox {
  ...
  /**
    ...
    */
  @JSImport("cesium", "OrientedBoundingBox.packedLength")
  @js.native
