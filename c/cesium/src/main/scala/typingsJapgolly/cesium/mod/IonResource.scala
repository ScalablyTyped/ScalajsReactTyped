...
import typingsJapgolly.cesium.AnonAccessToken
import typingsJapgolly.cesium.AnonEndpoint
import typingsJapgolly.cesium.AnonHeaders
import typingsJapgolly.cesium.AnonPreserveQueryParameters
