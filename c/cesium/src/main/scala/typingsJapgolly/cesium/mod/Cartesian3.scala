...
- typingsJapgolly.cesium.mod.Property because Inheritance from two classes. Inlined isConstant, definitionChanged, getValue, getValue, equals, equals
- typingsJapgolly.cesium.mod.PositionProperty because Inheritance from two classes. Inlined referenceFrame, getValueInReferenceFrame, getValueInReferenceFrame */ @JSImport("cesium", "Cartesian3")
@js.native
