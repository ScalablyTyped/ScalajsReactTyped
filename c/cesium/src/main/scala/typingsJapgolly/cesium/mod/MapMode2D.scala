...
object MapMode2D extends StObject {
  ...
  sealed trait INFINITE_SCROLL
    extends StObject
       with MapMode2D
  /* 1 */ val INFINITE_SCROLL: typingsJapgolly.cesium.mod.MapMode2D.INFINITE_SCROLL & Double = js.native
  ...
  sealed trait ROTATE
    extends StObject
       with MapMode2D
  /* 0 */ val ROTATE: typingsJapgolly.cesium.mod.MapMode2D.ROTATE & Double = js.native
}
