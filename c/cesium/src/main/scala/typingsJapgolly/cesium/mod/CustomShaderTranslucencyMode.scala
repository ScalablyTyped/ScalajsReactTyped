...
object CustomShaderTranslucencyMode extends StObject {
  ...
  /* 0 */ val INHERIT: typingsJapgolly.cesium.mod.CustomShaderTranslucencyMode.INHERIT & Double = js.native
  ...
  sealed trait OPAQUE
    extends StObject
       with CustomShaderTranslucencyMode
  /* 1 */ val OPAQUE: typingsJapgolly.cesium.mod.CustomShaderTranslucencyMode.OPAQUE & Double = js.native
  ...
  sealed trait TRANSLUCENT
    extends StObject
       with CustomShaderTranslucencyMode
  /* 2 */ val TRANSLUCENT: typingsJapgolly.cesium.mod.CustomShaderTranslucencyMode.TRANSLUCENT & Double = js.native
}
