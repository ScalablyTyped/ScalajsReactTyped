...
import typingsJapgolly.cesium.anon.InTangents
import typingsJapgolly.cesium.anon.LastTangent
import typingsJapgolly.cesium.anon.Points
import typingsJapgolly.cesium.anon.Times
...
@js.native
open class HermiteSpline protected () extends StObject {
  ...
  /**
    ...
    */
  val inTangents: js.Array[Cartesian3] = js.native
  
  /**
    * An array of outgoing tangents at each control point.
    */
  val outTangents: js.Array[Cartesian3] = js.native
