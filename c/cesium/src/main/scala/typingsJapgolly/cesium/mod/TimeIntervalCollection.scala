...
import typingsJapgolly.cesium.anon.DataCallback
import typingsJapgolly.cesium.anon.Epoch
import typingsJapgolly.cesium.anon.Iso8601Dates
import typingsJapgolly.cesium.anon.Start
import typingsJapgolly.cesium.mod.TimeInterval.DataComparer
import typingsJapgolly.cesium.mod.TimeInterval.MergeCallback
...
object TimeIntervalCollection {
  ...
  /**
    ...
    */
  inline def fromIso8601(options: typingsJapgolly.cesium.anon.Iso8601): TimeIntervalCollection = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIso8601")(options.asInstanceOf[js.Any]).asInstanceOf[TimeIntervalCollection]
  inline def fromIso8601(options: typingsJapgolly.cesium.anon.Iso8601, result: TimeIntervalCollection): TimeIntervalCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("fromIso8601")(options.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[TimeIntervalCollection]
