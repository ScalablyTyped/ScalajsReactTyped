...
import typingsJapgolly.cesium.mod.EllipsoidGeometry
import typingsJapgolly.cesium.mod.Geometry
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sourceCoreEllipsoidGeometryMod {
  
  @JSImport("cesium/Source/Core/EllipsoidGeometry", JSImport.Default)
  @js.native
  open class default () extends EllipsoidGeometry {
  ...
  object default {
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/EllipsoidGeometry", "default.packedLength")
    @js.native
