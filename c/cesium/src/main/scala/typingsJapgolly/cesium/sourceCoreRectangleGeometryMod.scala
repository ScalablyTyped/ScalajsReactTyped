...
import typingsJapgolly.cesium.anon.Rectangle
import typingsJapgolly.cesium.mod.Geometry
import typingsJapgolly.cesium.mod.RectangleGeometry
...
object sourceCoreRectangleGeometryMod {
  ...
  object default {
    ...
    /**
      ...
      */
    inline def computeRectangle(options: EllipsoidGranularity): typingsJapgolly.cesium.mod.Rectangle = ^.asInstanceOf[js.Dynamic].applyDynamic("computeRectangle")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.cesium.mod.Rectangle]
    inline def computeRectangle(options: EllipsoidGranularity, result: typingsJapgolly.cesium.mod.Rectangle): typingsJapgolly.cesium.mod.Rectangle = (^.asInstanceOf[js.Dynamic].applyDynamic("computeRectangle")(options.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cesium.mod.Rectangle]
