...
import typingsJapgolly.cesium.anon.NumberOfVerticalLines
import typingsJapgolly.cesium.mod.EllipseOutlineGeometry
import typingsJapgolly.cesium.mod.Geometry
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sourceCoreEllipseOutlineGeometryMod {
  
  @JSImport("cesium/Source/Core/EllipseOutlineGeometry", JSImport.Default)
  @js.native
  open class default protected () extends EllipseOutlineGeometry {
  ...
  object default {
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/EllipseOutlineGeometry", "default.packedLength")
    @js.native
