...
import typingsJapgolly.cesium.mod.CustomShader
...
trait Asynchronous extends StObject {
  ...
  var silhouetteColor: js.UndefOr[typingsJapgolly.cesium.mod.Color] = js.undefined
...
object Asynchronous {
  ...
  extension [Self <: Asynchronous](x: Self) {
    ...
    inline def setSilhouetteColor(value: typingsJapgolly.cesium.mod.Color): Self = StObject.set(x, "silhouetteColor", value.asInstanceOf[js.Any])
