...
trait OutlineColor extends StObject {
  ...
  var outlineColor: js.UndefOr[Property | typingsJapgolly.cesium.mod.Color] = js.undefined
...
object OutlineColor {
  ...
  extension [Self <: OutlineColor](x: Self) {
    ...
    inline def setOutlineColor(value: Property | typingsJapgolly.cesium.mod.Color): Self = StObject.set(x, "outlineColor", value.asInstanceOf[js.Any])
