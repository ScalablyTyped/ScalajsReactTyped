...
import typingsJapgolly.cesium.mod.Axis
import typingsJapgolly.cesium.mod.Cartesian3
import typingsJapgolly.cesium.mod.ClassificationType
import typingsJapgolly.cesium.mod.ClippingPlaneCollection
import typingsJapgolly.cesium.mod.ImageBasedLighting
...
trait BackFaceCulling extends StObject {
  ...
  var foveatedInterpolationCallback: js.UndefOr[typingsJapgolly.cesium.mod.Cesium3DTileset.foveatedInterpolationCallback] = js.undefined
  ...
  var outlineColor: js.UndefOr[typingsJapgolly.cesium.mod.Color] = js.undefined
...
object BackFaceCulling {
  ...
  extension [Self <: BackFaceCulling](x: Self) {
    ...
    inline def setOutlineColor(value: typingsJapgolly.cesium.mod.Color): Self = StObject.set(x, "outlineColor", value.asInstanceOf[js.Any])
