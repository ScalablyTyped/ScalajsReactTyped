...
import typingsJapgolly.cesium.mod.PostProcessStageSampleMode
...
trait ClearColor extends StObject {
  ...
  var clearColor: js.UndefOr[typingsJapgolly.cesium.mod.Color] = js.undefined
...
object ClearColor {
  ...
  extension [Self <: ClearColor](x: Self) {
    ...
    inline def setClearColor(value: typingsJapgolly.cesium.mod.Color): Self = StObject.set(x, "clearColor", value.asInstanceOf[js.Any])
