...
import typingsJapgolly.cesium.mod.OrientedBoundingBox
...
trait BoundingSphere extends StObject {
  ...
  var boundingSphere: typingsJapgolly.cesium.mod.BoundingSphere
...
object BoundingSphere {
  ...
  inline def apply(
    boundingSphere: typingsJapgolly.cesium.mod.BoundingSphere,
  ...
  extension [Self <: BoundingSphere](x: Self) {
    ...
    inline def setBoundingSphere(value: typingsJapgolly.cesium.mod.BoundingSphere): Self = StObject.set(x, "boundingSphere", value.asInstanceOf[js.Any])
