...
trait Globe extends StObject {
  ...
  var globe: typingsJapgolly.cesium.mod.Globe
...
object Globe {
  ...
  inline def apply(globe: typingsJapgolly.cesium.mod.Globe): Globe = {
  ...
  extension [Self <: Globe](x: Self) {
    ...
    inline def setGlobe(value: typingsJapgolly.cesium.mod.Globe): Self = StObject.set(x, "globe", value.asInstanceOf[js.Any])
