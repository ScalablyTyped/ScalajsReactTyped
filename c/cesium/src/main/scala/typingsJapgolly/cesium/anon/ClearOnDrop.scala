...
trait ClearOnDrop extends StObject {
  ...
  var dropTarget: js.UndefOr[org.scalajs.dom.Element | String] = js.undefined
...
object ClearOnDrop {
  ...
  extension [Self <: ClearOnDrop](x: Self) {
    ...
    inline def setDropTarget(value: org.scalajs.dom.Element | String): Self = StObject.set(x, "dropTarget", value.asInstanceOf[js.Any])
