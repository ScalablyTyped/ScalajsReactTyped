...
trait DashLength extends StObject {
  ...
  var gapColor: js.UndefOr[Property | typingsJapgolly.cesium.mod.Color] = js.undefined
}
object DashLength {
  ...
  extension [Self <: DashLength](x: Self) {
    ...
    inline def setGapColor(value: Property | typingsJapgolly.cesium.mod.Color): Self = StObject.set(x, "gapColor", value.asInstanceOf[js.Any])
