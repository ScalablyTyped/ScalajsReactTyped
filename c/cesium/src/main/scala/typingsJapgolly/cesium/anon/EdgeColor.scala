...
import typingsJapgolly.cesium.mod.ClippingPlane
...
trait EdgeColor extends StObject {
  ...
  var edgeColor: js.UndefOr[typingsJapgolly.cesium.mod.Color] = js.undefined
...
object EdgeColor {
  ...
  extension [Self <: EdgeColor](x: Self) {
    ...
    inline def setEdgeColor(value: typingsJapgolly.cesium.mod.Color): Self = StObject.set(x, "edgeColor", value.asInstanceOf[js.Any])
