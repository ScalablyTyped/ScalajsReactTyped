...
trait BlendOption extends StObject {
  ...
  var blendOption: js.UndefOr[typingsJapgolly.cesium.mod.BlendOption] = js.undefined
  
  var debugShowBoundingVolume: js.UndefOr[Boolean] = js.undefined
  
  var modelMatrix: js.UndefOr[Matrix4] = js.undefined
  
  var scene: js.UndefOr[typingsJapgolly.cesium.mod.Scene] = js.undefined
...
object BlendOption {
  ...
  extension [Self <: BlendOption](x: Self) {
    ...
    inline def setBlendOption(value: typingsJapgolly.cesium.mod.BlendOption): Self = StObject.set(x, "blendOption", value.asInstanceOf[js.Any])
