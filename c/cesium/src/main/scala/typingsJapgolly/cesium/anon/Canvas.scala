...
trait Canvas extends StObject {
  ...
  var creditContainer: js.UndefOr[org.scalajs.dom.Element] = js.undefined
  
  var creditViewport: js.UndefOr[org.scalajs.dom.Element] = js.undefined
...
object Canvas {
  ...
  extension [Self <: Canvas](x: Self) {
    ...
    inline def setCreditContainer(value: org.scalajs.dom.Element): Self = StObject.set(x, "creditContainer", value.asInstanceOf[js.Any])
    
    inline def setCreditContainerUndefined: Self = StObject.set(x, "creditContainer", js.undefined)
    
    inline def setCreditViewport(value: org.scalajs.dom.Element): Self = StObject.set(x, "creditViewport", value.asInstanceOf[js.Any])
