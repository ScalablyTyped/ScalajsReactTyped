...
trait CompressVertices extends StObject {
  ...
  var depthFailAppearance: js.UndefOr[typingsJapgolly.cesium.mod.Appearance] = js.undefined
...
object CompressVertices {
  ...
  extension [Self <: CompressVertices](x: Self) {
    ...
    inline def setDepthFailAppearance(value: typingsJapgolly.cesium.mod.Appearance): Self = StObject.set(x, "depthFailAppearance", value.asInstanceOf[js.Any])
