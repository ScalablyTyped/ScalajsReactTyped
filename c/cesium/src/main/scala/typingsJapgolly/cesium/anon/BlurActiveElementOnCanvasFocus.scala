...
import typingsJapgolly.cesium.cesiumBooleans.`false`
import typingsJapgolly.cesium.mod.ImageryProvider
import typingsJapgolly.cesium.mod.MapMode2D
import typingsJapgolly.cesium.mod.MapProjection
import typingsJapgolly.cesium.mod.SceneMode
import typingsJapgolly.cesium.mod.ShadowMode
import typingsJapgolly.cesium.mod.SkyAtmosphere
import typingsJapgolly.cesium.mod.SkyBox
import typingsJapgolly.cesium.mod.TerrainProvider
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait BlurActiveElementOnCanvasFocus extends StObject {
  ...
  var creditContainer: js.UndefOr[org.scalajs.dom.Element | String] = js.undefined
  
  var creditViewport: js.UndefOr[org.scalajs.dom.Element | String] = js.undefined
  
  var globe: js.UndefOr[typingsJapgolly.cesium.mod.Globe | `false`] = js.undefined
...
object BlurActiveElementOnCanvasFocus {
  
  inline def apply(): BlurActiveElementOnCanvasFocus = {
  ...
  extension [Self <: BlurActiveElementOnCanvasFocus](x: Self) {
    ...
    inline def setCreditContainer(value: org.scalajs.dom.Element | String): Self = StObject.set(x, "creditContainer", value.asInstanceOf[js.Any])
    
    inline def setCreditContainerUndefined: Self = StObject.set(x, "creditContainer", js.undefined)
    
    inline def setCreditViewport(value: org.scalajs.dom.Element | String): Self = StObject.set(x, "creditViewport", value.asInstanceOf[js.Any])
    
    inline def setCreditViewportUndefined: Self = StObject.set(x, "creditViewport", js.undefined)
    
    inline def setGlobe(value: typingsJapgolly.cesium.mod.Globe | `false`): Self = StObject.set(x, "globe", value.asInstanceOf[js.Any])
