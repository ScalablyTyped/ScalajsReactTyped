...
import typingsJapgolly.cesium.mod.CustomShaderMode
import typingsJapgolly.cesium.mod.CustomShaderTranslucencyMode
import typingsJapgolly.cesium.mod.LightingModel
import typingsJapgolly.cesium.mod.UniformSpecifier
import typingsJapgolly.cesium.mod.VaryingType
...
object FragmentShaderText {
  ...
  extension [Self <: FragmentShaderText](x: Self) {
