...
import typingsJapgolly.cesium.mod.Particle
...
trait Bursts extends StObject {
  ...
  var endColor: js.UndefOr[typingsJapgolly.cesium.mod.Color] = js.undefined
  ...
  var startColor: js.UndefOr[typingsJapgolly.cesium.mod.Color] = js.undefined
  
  var startScale: js.UndefOr[Double] = js.undefined
  
  var updateCallback: js.UndefOr[typingsJapgolly.cesium.mod.ParticleSystem.updateCallback] = js.undefined
}
object Bursts {
  ...
  extension [Self <: Bursts](x: Self) {
    ...
    inline def setEndColor(value: typingsJapgolly.cesium.mod.Color): Self = StObject.set(x, "endColor", value.asInstanceOf[js.Any])
    ...
    inline def setStartColor(value: typingsJapgolly.cesium.mod.Color): Self = StObject.set(x, "startColor", value.asInstanceOf[js.Any])
    ...
    inline def setUpdateCallback(value: (/* particle */ Particle, /* dt */ Double) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "updateCallback", js.Any.fromFunction2((t0: /* particle */ Particle, t1: /* dt */ Double) => (value(t0, t1)).runNow()))
