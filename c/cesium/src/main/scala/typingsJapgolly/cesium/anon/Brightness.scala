...
import typingsJapgolly.cesium.mod.SplitDirection
import typingsJapgolly.cesium.mod.TextureMagnificationFilter
import typingsJapgolly.cesium.mod.TextureMinificationFilter
...
trait Brightness extends StObject {
  ...
  var colorToAlpha: js.UndefOr[typingsJapgolly.cesium.mod.Color] = js.undefined
  ...
  var cutoutRectangle: js.UndefOr[typingsJapgolly.cesium.mod.Rectangle] = js.undefined
...
object Brightness {
  ...
  extension [Self <: Brightness](x: Self) {
    ...
    inline def setColorToAlpha(value: typingsJapgolly.cesium.mod.Color): Self = StObject.set(x, "colorToAlpha", value.asInstanceOf[js.Any])
    ...
    inline def setCutoutRectangle(value: typingsJapgolly.cesium.mod.Rectangle): Self = StObject.set(x, "cutoutRectangle", value.asInstanceOf[js.Any])
