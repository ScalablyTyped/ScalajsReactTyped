...
import typingsJapgolly.cesium.anon.MaximumHeight
import typingsJapgolly.cesium.anon.MaximumHeights
import typingsJapgolly.cesium.mod.Geometry
import typingsJapgolly.cesium.mod.WallGeometry
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sourceCoreWallGeometryMod {
  
  @JSImport("cesium/Source/Core/WallGeometry", JSImport.Default)
  @js.native
  open class default protected () extends WallGeometry {
