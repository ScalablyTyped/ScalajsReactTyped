...
object sourceCoreRectangleMod {
  
  @JSImport("cesium/Source/Core/Rectangle", JSImport.Default)
  @js.native
  open class default () extends Rectangle {
  ...
  object default {
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Rectangle", "default.MAX_VALUE")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Rectangle", "default.packedLength")
    @js.native
