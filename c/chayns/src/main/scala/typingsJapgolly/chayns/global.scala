...
import typingsJapgolly.chayns.chayns.storage.accessMode
  ...
  object chayns {
    ...
    object dialog {
      ...
      object buttonText extends StObject {
        ...
        @JSBracketAccess
        def apply(value: String): js.UndefOr[typingsJapgolly.chayns.chayns.dialog.buttonText & String] = js.native
        
        /* "Abbrechen" */ val CANCEL: typingsJapgolly.chayns.chayns.dialog.buttonText.CANCEL & String = js.native
        
        /* "Nein" */ val NO: typingsJapgolly.chayns.chayns.dialog.buttonText.NO & String = js.native
        
        /* "OK" */ val OK: typingsJapgolly.chayns.chayns.dialog.buttonText.OK & String = js.native
        
        /* "Ja" */ val YES: typingsJapgolly.chayns.chayns.dialog.buttonText.YES & String = js.native
      }
      ...
      object buttonType extends StObject {
        ...
        @JSBracketAccess
        def apply(value: Double): js.UndefOr[typingsJapgolly.chayns.chayns.dialog.buttonType & Double] = js.native
        
        /* -1 */ val CANCEL: typingsJapgolly.chayns.chayns.dialog.buttonType.CANCEL & Double = js.native
        
        /* 0 */ val NEGATIVE: typingsJapgolly.chayns.chayns.dialog.buttonType.NEGATIVE & Double = js.native
        
        /* 1 */ val POSITIVE: typingsJapgolly.chayns.chayns.dialog.buttonType.POSITIVE & Double = js.native
      }
      ...
      object dateType extends StObject {
        ...
        @JSBracketAccess
        def apply(value: Double): js.UndefOr[typingsJapgolly.chayns.chayns.dialog.dateType & Double] = js.native
        
        /* 0 */ val DATE: typingsJapgolly.chayns.chayns.dialog.dateType.DATE & Double = js.native
        
        /* 2 */ val DATE_TIME: typingsJapgolly.chayns.chayns.dialog.dateType.DATE_TIME & Double = js.native
        
        /* 1 */ val TIME: typingsJapgolly.chayns.chayns.dialog.dateType.TIME & Double = js.native
      }
      ...
      object inputType extends StObject {
        ...
        @JSBracketAccess
        def apply(value: Double): js.UndefOr[typingsJapgolly.chayns.chayns.dialog.inputType & Double] = js.native
        
        /* 0 */ val DEFAULT: typingsJapgolly.chayns.chayns.dialog.inputType.DEFAULT & Double = js.native
        
        /* 1 */ val PASSWORD: typingsJapgolly.chayns.chayns.dialog.inputType.PASSWORD & Double = js.native
      }
    ...
    object storage {
      ...
      object accessMode extends StObject {
        ...
        @JSBracketAccess
        def apply(value: Double): js.UndefOr[typingsJapgolly.chayns.chayns.storage.accessMode & Double] = js.native
        
        /* 2 */ val PRIVATE: typingsJapgolly.chayns.chayns.storage.accessMode.PRIVATE & Double = js.native
        
        /* 1 */ val PROTECTED: typingsJapgolly.chayns.chayns.storage.accessMode.PROTECTED & Double = js.native
        
        /* 0 */ val PUBLIC: typingsJapgolly.chayns.chayns.storage.accessMode.PUBLIC & Double = js.native
      }
