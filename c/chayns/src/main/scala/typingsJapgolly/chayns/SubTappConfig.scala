...
object SubTappConfig {
  ...
  def apply(
    ...
    callbackURL: /* result */ js.Any => CallbackTo[js.Any] = null,
    ...
    if (callbackURL != null) __obj.updateDynamic("callbackURL")(js.Any.fromFunction1((t0: /* result */ js.Any) => callbackURL(t0).runNow()))
