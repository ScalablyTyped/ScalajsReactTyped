...
import typingsJapgolly.cleanCss.anon.AdjacentSpace
import typingsJapgolly.cleanCss.anon.AfterAtRule
import typingsJapgolly.cleanCss.anon.All
import typingsJapgolly.cleanCss.anon.AroundSelectorRelation
import typingsJapgolly.cleanCss.anon.BackgroundClipMerging
import typingsJapgolly.cleanCss.anon.Ch
import typingsJapgolly.cleanCss.anon.Efficiency
import typingsJapgolly.cleanCss.anon.MergeAdjacentRules
import typingsJapgolly.cleanCss.anon.Opacity
import typingsJapgolly.cleanCss.anon.SourceMap
import typingsJapgolly.cleanCss.cleanCssBooleans.`false`
import typingsJapgolly.cleanCss.cleanCssBooleans.`true`
import typingsJapgolly.cleanCss.cleanCssInts.`0`
import typingsJapgolly.cleanCss.cleanCssInts.`1`
import typingsJapgolly.cleanCss.cleanCssInts.`2`
...
import typingsJapgolly.cleanCss.cleanCssStrings.space
import typingsJapgolly.cleanCss.cleanCssStrings.tab
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.cleanCss.mod.MinifierOutput
    - typingsJapgolly.cleanCss.mod.MinifierPromise
  */
  ...
  */
  ...
  object Options {
    ...
    inline def OptionsOutput(): typingsJapgolly.cleanCss.mod.OptionsOutput = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.cleanCss.mod.OptionsOutput]
    }
    
    inline def OptionsPromise(): typingsJapgolly.cleanCss.mod.OptionsPromise = {
      val __obj = js.Dynamic.literal(returnPromise = true)
      __obj.asInstanceOf[typingsJapgolly.cleanCss.mod.OptionsPromise]
    }
  }
  ...
  object OptionsBase {
    ...
    extension [Self <: OptionsBase](x: Self) {
      ...
      inline def setFetch(
        value: (/* uri */ String, /* inlineRequest */ RequestOptions | typingsJapgolly.node.httpsMod.RequestOptions, /* inlineTimeout */ Double, /* done */ js.Function2[/* message */ String | Double, /* body */ String, Unit]) => Callback
      ): Self = StObject.set(x, "fetch", js.Any.fromFunction4((t0: /* uri */ String, t1: /* inlineRequest */ RequestOptions | typingsJapgolly.node.httpsMod.RequestOptions, t2: /* inlineTimeout */ Double, t3: /* done */ js.Function2[/* message */ String | Double, /* body */ String, Unit]) => (value(t0, t1, t2, t3)).runNow()))
      ...
      inline def setInlineRequest(value: RequestOptions | typingsJapgolly.node.httpsMod.RequestOptions): Self = StObject.set(x, "inlineRequest", value.asInstanceOf[js.Any])
