...
object AnonAll {
  ...
  def apply(
    ...
    transform: (/* propertyName */ String, /* propertyValue */ String, /* selector */ js.UndefOr[String]) => CallbackTo[String] = null
  ): AnonAll = {
    ...
    if (transform != null) __obj.updateDynamic("transform")(js.Any.fromFunction3((t0: /* propertyName */ java.lang.String, t1: /* propertyValue */ java.lang.String, t2: /* selector */ js.UndefOr[java.lang.String]) => transform(t0, t1, t2).runNow()))
