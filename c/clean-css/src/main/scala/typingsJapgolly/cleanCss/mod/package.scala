...
package object mod {
  ...
  type Source = /**
    * Path to file
    */
  org.scalablytyped.runtime.StringDictionary[typingsJapgolly.cleanCss.AnonSourceMap]
  /**
    * Union of all types acceptable as input for the minify function
    */
  type Sources = java.lang.String | (js.Array[typingsJapgolly.cleanCss.mod.Source | java.lang.String]) | typingsJapgolly.cleanCss.mod.Source | typingsJapgolly.node.Buffer
}
