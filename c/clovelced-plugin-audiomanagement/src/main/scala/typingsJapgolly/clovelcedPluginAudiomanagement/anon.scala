...
object anon {
  ...
  trait AudioMode extends StObject {
    ...
    var audioMode: typingsJapgolly.clovelcedPluginAudiomanagement.mod.AudioMode
    
    var label: String
  }
  object AudioMode {
    
    inline def apply(audioMode: typingsJapgolly.clovelcedPluginAudiomanagement.mod.AudioMode, label: String): AudioMode = {
    ...
    extension [Self <: AudioMode](x: Self) {
      ...
      inline def setAudioMode(value: typingsJapgolly.clovelcedPluginAudiomanagement.mod.AudioMode): Self = StObject.set(x, "audioMode", value.asInstanceOf[js.Any])
