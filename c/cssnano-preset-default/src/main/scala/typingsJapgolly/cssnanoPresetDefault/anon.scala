package typingsJapgolly.cssnanoPresetDefault

import typingsJapgolly.browserslist.mod.Stats
import typingsJapgolly.cssnanoPresetDefault.cssnanoPresetDefaultBooleans.`false`
import typingsJapgolly.cssnanoPresetDefault.cssnanoPresetDefaultBooleans.`true`
import typingsJapgolly.cssnanoPresetDefault.cssnanoPresetDefaultStrings.double
import typingsJapgolly.cssnanoPresetDefault.cssnanoPresetDefaultStrings.single
