...
trait AnonMediaminwidth82rem extends js.Object {
  ...
  var `@media Leftparenthesismin-widthColon 66remRightparenthesis`: AnonLetterSpacing
  @JSName("@media (min-width: 82rem)")
  var `@media Leftparenthesismin-widthColon 82remRightparenthesis`: AnonLetterSpacing
  @JSName("@media (min-width: 99rem)")
  var `@media Leftparenthesismin-widthColon 99remRightparenthesis`: AnonLetterSpacing
...
object AnonMediaminwidth82rem {
  @scala.inline
  def apply(
    `@media Leftparenthesismin-widthColon 42remRightparenthesis`: AnonLineHeight,
    `@media Leftparenthesismin-widthColon 66remRightparenthesis`: AnonLetterSpacing,
    `@media Leftparenthesismin-widthColon 82remRightparenthesis`: AnonLetterSpacing,
    `@media Leftparenthesismin-widthColon 99remRightparenthesis`: AnonLetterSpacing,
    fontFamily: String,
    fontSize: String,
    fontWeight: Double,
    letterSpacing: Double,
    lineHeight: String
  ): AnonMediaminwidth82rem = {
    ...
    __obj.asInstanceOf[AnonMediaminwidth82rem]
  }
}
