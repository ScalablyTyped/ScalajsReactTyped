...
trait AnonFontSizeFontWeight extends js.Object {
  @JSName("@media (min-width: 42rem)")
  var `@media Leftparenthesismin-widthColon 42remRightparenthesis`: AnonFontFamily
...
object AnonFontSizeFontWeight {
  @scala.inline
  def apply(
    `@media Leftparenthesismin-widthColon 42remRightparenthesis`: AnonFontFamily,
    ...
    __obj.asInstanceOf[AnonFontSizeFontWeight]
  }
}
