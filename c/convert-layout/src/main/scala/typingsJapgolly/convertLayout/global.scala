...
object global {
  ...
  @js.native
  def langLayout: layout = js.native
  
  inline def langLayout_=(x: layout): Unit = js.Dynamic.global.updateDynamic("lang_layout")(x.asInstanceOf[js.Any])
}
