...
import typingsJapgolly.chartmogulNode.anon.Addresszip
...
import typingsJapgolly.chartmogulNode.commonMod.Strings
...
object Customer {
  ...
  inline def all(config: Config): js.Promise[Entries[typingsJapgolly.chartmogulNode.mod.Customer.Customer]] = ^.asInstanceOf[js.Dynamic].applyDynamic("all")(config.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Entries[typingsJapgolly.chartmogulNode.mod.Customer.Customer]]]
  inline def all(config: Config, params: ListCustomersParams): js.Promise[Entries[typingsJapgolly.chartmogulNode.mod.Customer.Customer]] = (^.asInstanceOf[js.Dynamic].applyDynamic("all")(config.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Entries[typingsJapgolly.chartmogulNode.mod.Customer.Customer]]]
  ...
  inline def create(config: Config, data: NewCustomer): js.Promise[typingsJapgolly.chartmogulNode.mod.Customer.Customer] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(config.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.chartmogulNode.mod.Customer.Customer]]
  ...
  inline def modify(config: Config, uuid: String, data: UpdateCustomer): js.Promise[typingsJapgolly.chartmogulNode.mod.Customer.Customer] = (^.asInstanceOf[js.Dynamic].applyDynamic("modify")(config.asInstanceOf[js.Any], uuid.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.chartmogulNode.mod.Customer.Customer]]
  
  inline def retrieve(config: Config, uuid: String): js.Promise[typingsJapgolly.chartmogulNode.mod.Customer.Customer] = (^.asInstanceOf[js.Dynamic].applyDynamic("retrieve")(config.asInstanceOf[js.Any], uuid.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.chartmogulNode.mod.Customer.Customer]]
  
  inline def search(config: Config): js.Promise[Entries[typingsJapgolly.chartmogulNode.mod.Customer.Customer]] = ^.asInstanceOf[js.Dynamic].applyDynamic("search")(config.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Entries[typingsJapgolly.chartmogulNode.mod.Customer.Customer]]]
  inline def search(config: Config, params: SearchCustomersParams): js.Promise[Entries[typingsJapgolly.chartmogulNode.mod.Customer.Customer]] = (^.asInstanceOf[js.Dynamic].applyDynamic("search")(config.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Entries[typingsJapgolly.chartmogulNode.mod.Customer.Customer]]]
  ...
  object Customer {
    ...
    inline def apply(): typingsJapgolly.chartmogulNode.mod.Customer.Customer = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.chartmogulNode.mod.Customer.Customer]
    }
    
    extension [Self <: typingsJapgolly.chartmogulNode.mod.Customer.Customer](x: Self) {
