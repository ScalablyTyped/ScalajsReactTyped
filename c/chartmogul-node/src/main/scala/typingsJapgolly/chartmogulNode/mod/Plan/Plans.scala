package typingsJapgolly.chartmogulNode.mod.Plan
...
trait Plans extends Cursor {
  var plans: js.Array[typingsJapgolly.chartmogulNode.mod.Plan.Plan]
}

object Plans {
  @scala.inline
  def apply(
    plans: js.Array[typingsJapgolly.chartmogulNode.mod.Plan.Plan],
