...
import typingsJapgolly.chartmogulNode.commonMod.Cursor
...
object Subscription {
  ...
  inline def cancel(config: Config, uuid: String, data: CancelSubscriptionParams): js.Promise[typingsJapgolly.chartmogulNode.mod.Subscription.Subscription] = (^.asInstanceOf[js.Dynamic].applyDynamic("cancel")(config.asInstanceOf[js.Any], uuid.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.chartmogulNode.mod.Subscription.Subscription]]
  ...
  object Subscription {
    ...
    inline def apply(
      ...
      plan_uuid: String,
      uuid: String
    ): typingsJapgolly.chartmogulNode.mod.Subscription.Subscription = {
      ...
      __obj.asInstanceOf[typingsJapgolly.chartmogulNode.mod.Subscription.Subscription]
    }
    
    extension [Self <: typingsJapgolly.chartmogulNode.mod.Subscription.Subscription](x: Self) {
  ...
  trait Subscriptions
    ...
    var subscriptions: js.Array[typingsJapgolly.chartmogulNode.mod.Subscription.Subscription]
  }
  object Subscriptions {
    
    inline def apply(subscriptions: js.Array[typingsJapgolly.chartmogulNode.mod.Subscription.Subscription]): Subscriptions = {
    ...
    extension [Self <: Subscriptions](x: Self) {
      ...
      inline def setSubscriptions(value: js.Array[typingsJapgolly.chartmogulNode.mod.Subscription.Subscription]): Self = StObject.set(x, "subscriptions", value.asInstanceOf[js.Any])
      
      inline def setSubscriptionsVarargs(value: typingsJapgolly.chartmogulNode.mod.Subscription.Subscription*): Self = StObject.set(x, "subscriptions", js.Array(value*))
    }
  }
}
