...
object Invoice {
  ...
  inline def create(config: Config, uuid: String, data: typingsJapgolly.chartmogulNode.anon.Invoices): js.Promise[typingsJapgolly.chartmogulNode.mod.Invoice.Invoice] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(config.asInstanceOf[js.Any], uuid.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.chartmogulNode.mod.Invoice.Invoice]]
  ...
  inline def retrieve(config: Config, uuid: String): js.Promise[typingsJapgolly.chartmogulNode.mod.Invoice.Invoice] = (^.asInstanceOf[js.Dynamic].applyDynamic("retrieve")(config.asInstanceOf[js.Any], uuid.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.chartmogulNode.mod.Invoice.Invoice]]
  ...
  trait Invoice extends StObject {
    ...
    var transactions: js.UndefOr[js.Array[typingsJapgolly.chartmogulNode.mod.Invoice.Transaction]] = js.undefined
    
    var uuid: js.UndefOr[String] = js.undefined
  }
  object Invoice {
    
    inline def apply(): typingsJapgolly.chartmogulNode.mod.Invoice.Invoice = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.chartmogulNode.mod.Invoice.Invoice]
    }
    
    extension [Self <: typingsJapgolly.chartmogulNode.mod.Invoice.Invoice](x: Self) {
      ...
      inline def setTransactions(value: js.Array[typingsJapgolly.chartmogulNode.mod.Invoice.Transaction]): Self = StObject.set(x, "transactions", value.asInstanceOf[js.Any])
      
      inline def setTransactionsUndefined: Self = StObject.set(x, "transactions", js.undefined)
      
      inline def setTransactionsVarargs(value: typingsJapgolly.chartmogulNode.mod.Invoice.Transaction*): Self = StObject.set(x, "transactions", js.Array(value*))
  ...
  object Invoices {
    ...
    inline def apply(invoices: js.Array[typingsJapgolly.chartmogulNode.mod.Invoice.Invoice]): Invoices = {
    ...
    extension [Self <: Invoices](x: Self) {
      ...
      inline def setInvoices(value: js.Array[typingsJapgolly.chartmogulNode.mod.Invoice.Invoice]): Self = StObject.set(x, "invoices", value.asInstanceOf[js.Any])
      
      inline def setInvoicesVarargs(value: typingsJapgolly.chartmogulNode.mod.Invoice.Invoice*): Self = StObject.set(x, "invoices", js.Array(value*))
    }
  }
  ...
  object Transaction {
    ...
    inline def apply(): typingsJapgolly.chartmogulNode.mod.Invoice.Transaction = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.chartmogulNode.mod.Invoice.Transaction]
    }
    
    extension [Self <: typingsJapgolly.chartmogulNode.mod.Invoice.Transaction](x: Self) {
