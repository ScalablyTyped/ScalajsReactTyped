...
object Plan {
  ...
  inline def create(config: Config, data: typingsJapgolly.chartmogulNode.mod.Plan.Plan): js.Promise[typingsJapgolly.chartmogulNode.mod.Plan.Plan] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(config.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.chartmogulNode.mod.Plan.Plan]]
  ...
  inline def modify(config: Config, uuid: String, data: typingsJapgolly.chartmogulNode.mod.Plan.Plan): js.Promise[typingsJapgolly.chartmogulNode.mod.Plan.Plan] = (^.asInstanceOf[js.Dynamic].applyDynamic("modify")(config.asInstanceOf[js.Any], uuid.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.chartmogulNode.mod.Plan.Plan]]
  
  inline def retrieve(config: Config, uuid: String): js.Promise[typingsJapgolly.chartmogulNode.mod.Plan.Plan] = (^.asInstanceOf[js.Dynamic].applyDynamic("retrieve")(config.asInstanceOf[js.Any], uuid.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.chartmogulNode.mod.Plan.Plan]]
  ...
  object Plan {
    ...
    inline def apply(): typingsJapgolly.chartmogulNode.mod.Plan.Plan = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.chartmogulNode.mod.Plan.Plan]
    }
    
    extension [Self <: typingsJapgolly.chartmogulNode.mod.Plan.Plan](x: Self) {
  ...
  object Plans {
    ...
    inline def apply(plans: js.Array[typingsJapgolly.chartmogulNode.mod.Plan.Plan]): Plans = {
    ...
    extension [Self <: Plans](x: Self) {
      ...
      inline def setPlans(value: js.Array[typingsJapgolly.chartmogulNode.mod.Plan.Plan]): Self = StObject.set(x, "plans", value.asInstanceOf[js.Any])
      
      inline def setPlansVarargs(value: typingsJapgolly.chartmogulNode.mod.Plan.Plan*): Self = StObject.set(x, "plans", js.Array(value*))
    }
  }
}
