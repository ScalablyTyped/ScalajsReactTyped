...
import typingsJapgolly.chaiJquery.anon.Interval
...
import typingsJapgolly.jquery.JQueryEventConstructor
import typingsJapgolly.jquery.JQueryParam
import typingsJapgolly.jquery.JQueryPromise
import typingsJapgolly.jquery.JQuerySupport
