...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnRender(value: /* state */ Record[String, Any] => Callback): Self = StObject.set(x, "onRender", js.Any.fromFunction1((t0: /* state */ Record[String, Any]) => value(t0).runNow()))
