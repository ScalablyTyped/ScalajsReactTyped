package typingsJapgolly.cssBoxModel
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.std.ClientRect
    - org.scalajs.dom.DOMRect
    - typingsJapgolly.cssBoxModel.mod.Rect
    - typingsJapgolly.cssBoxModel.mod.Spacing
  */
  ...
  object _AnyRectType {
    ...
    inline def Rect(
      ...
      val __obj = js.Dynamic.literal(bottom = bottom.asInstanceOf[js.Any], center = center.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], left = left.asInstanceOf[js.Any], right = right.asInstanceOf[js.Any], top = top.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any], x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.cssBoxModel.mod.Rect]
    }
    
    inline def Spacing(bottom: Double, left: Double, right: Double, top: Double): typingsJapgolly.cssBoxModel.mod.Spacing = {
      val __obj = js.Dynamic.literal(bottom = bottom.asInstanceOf[js.Any], left = left.asInstanceOf[js.Any], right = right.asInstanceOf[js.Any], top = top.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.cssBoxModel.mod.Spacing]
    }
  }
}
