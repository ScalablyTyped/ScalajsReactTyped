package typingsJapgolly.connectPgSimple

import japgolly.scalajs.react.Callback
import typingsJapgolly.connectPgSimple.connectPgSimpleBooleans.`false`
...
object mod {
  ...
  object PGStoreOptions {
    ...
    extension [Self <: PGStoreOptions](x: Self) {
      ...
      inline def setErrorLog(value: /* repeated */ Any => Callback): Self = StObject.set(x, "errorLog", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
