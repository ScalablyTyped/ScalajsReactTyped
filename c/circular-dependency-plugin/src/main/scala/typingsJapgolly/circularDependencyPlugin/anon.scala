...
object anon {
  ...
  trait Compilation extends StObject {
    ...
    var compilation: typingsJapgolly.webpack.mod.Compilation
  ...
  object Compilation {
    ...
    inline def apply(compilation: typingsJapgolly.webpack.mod.Compilation, module: Module, paths: js.Array[String]): Compilation = {
    ...
    extension [Self <: Compilation](x: Self) {
      ...
      inline def setCompilation(value: typingsJapgolly.webpack.mod.Compilation): Self = StObject.set(x, "compilation", value.asInstanceOf[js.Any])
  ...
  object CompilationCompilation {
    ...
    inline def apply(compilation: typingsJapgolly.webpack.mod.Compilation): CompilationCompilation = {
