...
import typingsJapgolly.ckeditorCkeditor5Indent.srcIndentMod.default
...
object mod {
  ...
  open class IndentBlock ()
    extends typingsJapgolly.ckeditorCkeditor5Indent.srcIndentblockMod.default
  /* static members */
  object IndentBlock {
    
    @JSImport("@ckeditor/ckeditor5-indent", "IndentBlock.pluginName")
    @js.native
    val pluginName: typingsJapgolly.ckeditorCkeditor5Indent.ckeditorCkeditor5IndentStrings.IndentBlock = js.native
  }
  
  @JSImport("@ckeditor/ckeditor5-indent", "IndentEditing")
  @js.native
  open class IndentEditing ()
    extends typingsJapgolly.ckeditorCkeditor5Indent.srcIndenteditingMod.default
  /* static members */
  ...
  @js.native
  open class IndentUI ()
    extends typingsJapgolly.ckeditorCkeditor5Indent.srcIndentuiMod.default
  /* static members */
  object IndentUI {
