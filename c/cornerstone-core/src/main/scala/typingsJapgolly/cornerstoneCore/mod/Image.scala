...
object Image {
  ...
  inline def apply(
    ...
    getImageData: CallbackTo[ImageData],
    getPixelData: CallbackTo[js.Array[Double]],
    height: Double,
    imageId: String,
    intercept: Double,
    invert: Boolean,
  ...
  extension [Self <: Image](x: Self) {
    ...
    inline def setGetImageData(value: CallbackTo[ImageData]): Self = StObject.set(x, "getImageData", value.toJsFn)
    
    inline def setGetPixelData(value: CallbackTo[js.Array[Double]]): Self = StObject.set(x, "getPixelData", value.toJsFn)
