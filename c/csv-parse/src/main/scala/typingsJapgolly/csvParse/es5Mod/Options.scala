...
object Options {
  ...
  def apply(
    ...
    objname: String = null,
    on_record: (/* record */ js.Any, /* context */ CastingContext) => CallbackTo[js.Any] = null,
    ...
    if (on_record != null) __obj.updateDynamic("on_record")(js.Any.fromFunction2((t0: /* record */ js.Any, t1: /* context */ typingsJapgolly.csvParse.es5Mod.CastingContext) => on_record(t0, t1).runNow()))
