...
object Options {
  ...
  def apply(
    ...
    if (on_record != null) __obj.updateDynamic("on_record")(js.Any.fromFunction2((t0: /* record */ js.Any, t1: /* context */ typingsJapgolly.csvParse.mod.CastingContext) => on_record(t0, t1).runNow()))
