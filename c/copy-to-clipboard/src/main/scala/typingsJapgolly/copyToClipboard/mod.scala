package typingsJapgolly.copyToClipboard
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnCopy(value: /* clipboardData */ js.Object => Callback): Self = StObject.set(x, "onCopy", js.Any.fromFunction1((t0: /* clipboardData */ js.Object) => value(t0).runNow()))
