...
import typingsJapgolly.cucumberCucumberExpressions.distCjsSrcParameterTypeMod.default
...
object distCjsSrcTypesMod {
  ...
  object DefinesParameterType {
    ...
    inline def apply(defineParameterType: default[Any] => Callback): DefinesParameterType = {
      val __obj = js.Dynamic.literal(defineParameterType = js.Any.fromFunction1((t0: default[Any]) => defineParameterType(t0).runNow()))
      __obj.asInstanceOf[DefinesParameterType]
    }
    
    extension [Self <: DefinesParameterType](x: Self) {
      
      inline def setDefineParameterType(value: default[Any] => Callback): Self = StObject.set(x, "defineParameterType", js.Any.fromFunction1((t0: default[Any]) => value(t0).runNow()))
    }
  }
  
  trait Expression extends StObject {
    
    def `match`(text: String): js.Array[typingsJapgolly.cucumberCucumberExpressions.distCjsSrcArgumentMod.default] | Null
  ...
  object Expression {
    ...
    inline def apply(
      `match`: String => js.Array[typingsJapgolly.cucumberCucumberExpressions.distCjsSrcArgumentMod.default] | Null,
      source: String
    ): Expression = {
    ...
    extension [Self <: Expression](x: Self) {
      ...
      inline def setMatch(
        value: String => js.Array[typingsJapgolly.cucumberCucumberExpressions.distCjsSrcArgumentMod.default] | Null
