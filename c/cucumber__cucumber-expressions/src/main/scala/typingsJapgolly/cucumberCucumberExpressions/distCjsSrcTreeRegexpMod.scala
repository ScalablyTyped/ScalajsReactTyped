...
object distCjsSrcTreeRegexpMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    override val groupBuilder: typingsJapgolly.cucumberCucumberExpressions.distCjsSrcGroupBuilderMod.default = js.native
    
    /* CompleteClass */
    override def `match`(s: String): typingsJapgolly.cucumberCucumberExpressions.distCjsSrcGroupMod.default | Null = js.native
  ...
  trait TreeRegexp extends StObject {
    ...
    val groupBuilder: typingsJapgolly.cucumberCucumberExpressions.distCjsSrcGroupBuilderMod.default
    
    def `match`(s: String): typingsJapgolly.cucumberCucumberExpressions.distCjsSrcGroupMod.default | Null
  ...
  object TreeRegexp {
    ...
    inline def apply(
      groupBuilder: typingsJapgolly.cucumberCucumberExpressions.distCjsSrcGroupBuilderMod.default,
      `match`: String => typingsJapgolly.cucumberCucumberExpressions.distCjsSrcGroupMod.default | Null,
      regexp: js.RegExp
    ): TreeRegexp = {
    ...
    extension [Self <: TreeRegexp](x: Self) {
      ...
      inline def setGroupBuilder(value: typingsJapgolly.cucumberCucumberExpressions.distCjsSrcGroupBuilderMod.default): Self = StObject.set(x, "groupBuilder", value.asInstanceOf[js.Any])
      
      inline def setMatch(value: String => typingsJapgolly.cucumberCucumberExpressions.distCjsSrcGroupMod.default | Null): Self = StObject.set(x, "match", js.Any.fromFunction1(value))
