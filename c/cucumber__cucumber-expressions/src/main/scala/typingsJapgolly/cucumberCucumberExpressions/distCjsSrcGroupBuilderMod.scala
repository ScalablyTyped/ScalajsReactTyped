...
import typingsJapgolly.regexpMatchIndices.typesMod.RegExpExecArray
...
object distCjsSrcGroupBuilderMod {
  ...
  trait GroupBuilder extends StObject {
    ...
    def build(`match`: RegExpExecArray, nextGroupIndex: js.Function0[Double]): typingsJapgolly.cucumberCucumberExpressions.distCjsSrcGroupMod.default = js.native
