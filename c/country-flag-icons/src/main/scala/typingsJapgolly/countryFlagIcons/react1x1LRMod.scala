...
object react1x1LRMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/LR", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react1x1LRMod.foo` */
