...
object react3x2HMMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/HM", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2HMMod.foo` */
