...
object react3x2IRMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/IR", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2IRMod.foo` */
