...
object react3x2GHMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/GH", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2GHMod.foo` */
