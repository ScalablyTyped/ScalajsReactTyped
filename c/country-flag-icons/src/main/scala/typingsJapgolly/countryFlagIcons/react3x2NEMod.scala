...
object react3x2NEMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/NE", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2NEMod.foo` */
