...
object react3x2UZMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/UZ", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2UZMod.foo` */
