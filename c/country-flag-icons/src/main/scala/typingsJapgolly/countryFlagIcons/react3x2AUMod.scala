...
object react3x2AUMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/AU", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2AUMod.foo` */
