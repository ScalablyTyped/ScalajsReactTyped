...
object react1x1XKMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/XK", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react1x1XKMod.foo` */
