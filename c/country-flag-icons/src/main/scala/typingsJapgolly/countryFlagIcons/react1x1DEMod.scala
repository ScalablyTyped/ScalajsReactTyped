...
object react1x1DEMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/DE", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react1x1DEMod.foo` */
