...
object react1x1TDMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/TD", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react1x1TDMod.foo` */
