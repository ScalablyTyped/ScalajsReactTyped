...
object react3x2GLMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/GL", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2GLMod.foo` */
