...
object react3x2TCMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/TC", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2TCMod.foo` */
