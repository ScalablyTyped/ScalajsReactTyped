...
object react1x1SRMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/SR", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react1x1SRMod.foo` */
