...
object react1x1AWMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/AW", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react1x1AWMod.foo` */
