...
object react3x2DKMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/DK", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2DKMod.foo` */
