...
object anon {
  ...
  trait Fullscreen extends StObject {
    ...
    var marks: typingsJapgolly.cliBox.mod.Marks
  ...
  object Fullscreen {
    ...
    inline def apply(
      fullscreen: Boolean,
      height: Double,
      marks: typingsJapgolly.cliBox.mod.Marks,
      stringify: Boolean,
      width: Double
    ): Fullscreen = {
    ...
    extension [Self <: Fullscreen](x: Self) {
      ...
      inline def setMarks(value: typingsJapgolly.cliBox.mod.Marks): Self = StObject.set(x, "marks", value.asInstanceOf[js.Any])
  ...
  object Height {
    ...
    inline def apply(height: Double, lines: js.Array[Offset], marks: typingsJapgolly.cliBox.mod.Marks, width: Double): Height = {
  ...
  object Marks {
    ...
    inline def apply(marks: typingsJapgolly.cliBox.mod.Marks): Marks = {
