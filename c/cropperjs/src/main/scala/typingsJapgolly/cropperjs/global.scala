...
object global {
  ...
  open class Cropper protected ()
    extends StObject
       with typingsJapgolly.cropperjs.Cropper {
  ...
  object Cropper {
    ...
    /* static member */
    inline def noConflict(): typingsJapgolly.cropperjs.Cropper = ^.asInstanceOf[js.Dynamic].applyDynamic("noConflict")().asInstanceOf[typingsJapgolly.cropperjs.Cropper]
