...
object global {
  ...
  open class FileError protected ()
    extends StObject
       with typingsJapgolly.cordovaPluginFile.FileError {
  ...
  object LocalFileSystem extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.cordovaPluginFile.LocalFileSystem & Double] = js.native
    
    /* 1 */ val PERSISTENT: typingsJapgolly.cordovaPluginFile.LocalFileSystem.PERSISTENT & Double = js.native
    
    /* 0 */ val TEMPORARY: typingsJapgolly.cordovaPluginFile.LocalFileSystem.TEMPORARY & Double = js.native
  }
}
