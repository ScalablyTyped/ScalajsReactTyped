...
import typingsJapgolly.couchbase.couchbaseStrings.connect
...
import typingsJapgolly.couchbase.mod.Bucket.DecoderFunction
import typingsJapgolly.couchbase.mod.Bucket.EncoderFunction
import typingsJapgolly.couchbase.mod.Bucket.FtsQueryCallback
import typingsJapgolly.couchbase.mod.Bucket.FtsQueryResponse
import typingsJapgolly.couchbase.mod.Bucket.FtsQueryResponse.Meta
import typingsJapgolly.couchbase.mod.Bucket.MultiGetCallback
import typingsJapgolly.couchbase.mod.Bucket.N1qlQueryCallback
import typingsJapgolly.couchbase.mod.Bucket.N1qlQueryResponse
import typingsJapgolly.couchbase.mod.Bucket.OpCallback
import typingsJapgolly.couchbase.mod.Bucket.QueryCallback
import typingsJapgolly.couchbase.mod.Bucket.ViewQueryResponse
...
object Bucket {
  ...
  type N1qlQueryCallback = js.Function3[
    /* error */ CouchbaseError | Null, 
    /* rows */ js.Array[Any] | Null, 
    /* meta */ typingsJapgolly.couchbase.mod.Bucket.N1qlQueryResponse.Meta, 
    Unit
  ]
  ...
  trait N1qlQueryResponse extends EventEmitter {
    ...
    def addListener_end(
      event: end,
      listener: js.Function1[/* meta */ typingsJapgolly.couchbase.mod.Bucket.N1qlQueryResponse.Meta, Unit]
    ): this.type = js.native
    @JSName("addListener")
    def addListener_error(event: error, listener: js.Function1[/* error */ CouchbaseError, Unit]): this.type = js.native
    @JSName("addListener")
  ...
  object N1qlQueryResponse {
    ...
    object Meta {
      ...
      inline def apply(requestID: Double): typingsJapgolly.couchbase.mod.Bucket.N1qlQueryResponse.Meta = {
        val __obj = js.Dynamic.literal(requestID = requestID.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.couchbase.mod.Bucket.N1qlQueryResponse.Meta]
      }
      
      extension [Self <: typingsJapgolly.couchbase.mod.Bucket.N1qlQueryResponse.Meta](x: Self) {
  ...
  type QueryCallback = js.Function3[
    /* error */ CouchbaseError | Null, 
    /* rows */ js.Array[Any] | Null, 
    /* meta */ typingsJapgolly.couchbase.mod.Bucket.ViewQueryResponse.Meta, 
    Unit
  ]
  ...
  trait ViewQueryResponse extends EventEmitter {
    ...
    def addListener_end(
      event: end,
      listener: js.Function1[/* meta */ typingsJapgolly.couchbase.mod.Bucket.ViewQueryResponse.Meta, Unit]
    ): this.type = js.native
    @JSName("addListener")
    def addListener_error(event: error, listener: js.Function1[/* error */ CouchbaseError, Unit]): this.type = js.native
    @JSName("addListener")
  ...
  object ViewQueryResponse {
    ...
    object Meta {
      ...
      inline def apply(total_rows: Double): typingsJapgolly.couchbase.mod.Bucket.ViewQueryResponse.Meta = {
        val __obj = js.Dynamic.literal(total_rows = total_rows.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.couchbase.mod.Bucket.ViewQueryResponse.Meta]
      }
      
      extension [Self <: typingsJapgolly.couchbase.mod.Bucket.ViewQueryResponse.Meta](x: Self) {
