...
package object Bucket {
  /**
    ...
    */
  type DecoderFunction = js.Function1[/* doc */ typingsJapgolly.couchbase.mod.Bucket.TranscoderDoc, js.Any]
  /**
    ...
    */
  type EncoderFunction = js.Function1[/* value */ js.Any, typingsJapgolly.couchbase.mod.Bucket.TranscoderDoc]
  /**
  ...
  type FtsQueryCallback = js.Function3[
    /* error */ typingsJapgolly.couchbase.mod.CouchbaseError | scala.Null, 
    /* rows */ js.Array[js.Any] | scala.Null, 
    /* meta */ typingsJapgolly.couchbase.mod.Bucket.FtsQueryResponse.Meta, 
    scala.Unit
  ]
  type FtsQueryResponse = typingsJapgolly.couchbase.mod.Bucket.FtsQueryResponse_
  /**
    * Multi-Get Callback.
  ...
  type N1qlQueryResponse = typingsJapgolly.couchbase.mod.Bucket.N1qlQueryResponse_
  /**
  ...
  type ViewQueryResponse = typingsJapgolly.couchbase.mod.Bucket.ViewQueryResponse_
}
