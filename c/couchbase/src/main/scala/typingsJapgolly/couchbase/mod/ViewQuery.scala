...
import typingsJapgolly.couchbase.mod.ViewQuery.ErrorMode
import typingsJapgolly.couchbase.mod.ViewQuery.Order
import typingsJapgolly.couchbase.mod.ViewQuery.Update
...
object ViewQuery {
  ...
  object ErrorMode extends StObject {
    ...
    sealed trait CONTINUE
      extends StObject
         with ErrorMode
    /* 0 */ val CONTINUE: typingsJapgolly.couchbase.mod.ViewQuery.ErrorMode.CONTINUE & Double = js.native
    ...
    sealed trait STOP
      extends StObject
         with ErrorMode
    /* 1 */ val STOP: typingsJapgolly.couchbase.mod.ViewQuery.ErrorMode.STOP & Double = js.native
  }
  ...
  object Order extends StObject {
    ...
    sealed trait ASCENDING
      extends StObject
         with Order
    /* 0 */ val ASCENDING: typingsJapgolly.couchbase.mod.ViewQuery.Order.ASCENDING & Double = js.native
    ...
    sealed trait DESCENDING
      extends StObject
         with Order
    /* 1 */ val DESCENDING: typingsJapgolly.couchbase.mod.ViewQuery.Order.DESCENDING & Double = js.native
  }
  ...
  object Update extends StObject {
    ...
    sealed trait AFTER
      extends StObject
         with Update
    /* 2 */ val AFTER: typingsJapgolly.couchbase.mod.ViewQuery.Update.AFTER & Double = js.native
    ...
    sealed trait BEFORE
      extends StObject
         with Update
    /* 0 */ val BEFORE: typingsJapgolly.couchbase.mod.ViewQuery.Update.BEFORE & Double = js.native
    ...
    sealed trait NONE
      extends StObject
         with Update
    /* 1 */ val NONE: typingsJapgolly.couchbase.mod.ViewQuery.Update.NONE & Double = js.native
  }
