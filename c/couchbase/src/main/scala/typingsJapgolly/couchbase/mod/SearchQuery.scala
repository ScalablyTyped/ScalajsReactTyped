...
import typingsJapgolly.couchbase.mod.SearchQuery.Consistency
import typingsJapgolly.couchbase.mod.SearchQuery.HighlightStyle
...
object SearchQuery {
  ...
  object Consistency extends StObject {
    ...
    sealed trait NOT_BOUNDED
      extends StObject
         with Consistency
    /* 0 */ val NOT_BOUNDED: typingsJapgolly.couchbase.mod.SearchQuery.Consistency.NOT_BOUNDED & Double = js.native
  }
  ...
  object HighlightStyle extends StObject {
    ...
    sealed trait ANSI
      extends StObject
         with HighlightStyle
    /* 2 */ val ANSI: typingsJapgolly.couchbase.mod.SearchQuery.HighlightStyle.ANSI & Double = js.native
    ...
    sealed trait DEFAULT
      extends StObject
         with HighlightStyle
    /* 0 */ val DEFAULT: typingsJapgolly.couchbase.mod.SearchQuery.HighlightStyle.DEFAULT & Double = js.native
    ...
    sealed trait HTML
      extends StObject
         with HighlightStyle
    /* 1 */ val HTML: typingsJapgolly.couchbase.mod.SearchQuery.HighlightStyle.HTML & Double = js.native
  }
