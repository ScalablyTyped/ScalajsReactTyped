...
object N1qlQuery {
  ...
  object Consistency extends StObject {
    ...
    sealed trait NOT_BOUNDED
      extends StObject
         with Consistency
    /* 0 */ val NOT_BOUNDED: typingsJapgolly.couchbase.mod.N1qlQuery.Consistency.NOT_BOUNDED & Double = js.native
    ...
    sealed trait REQUEST_PLUS
      extends StObject
         with Consistency
    /* 1 */ val REQUEST_PLUS: typingsJapgolly.couchbase.mod.N1qlQuery.Consistency.REQUEST_PLUS & Double = js.native
    ...
    sealed trait STATEMENT_PLUS
      extends StObject
         with Consistency
    /* 2 */ val STATEMENT_PLUS: typingsJapgolly.couchbase.mod.N1qlQuery.Consistency.STATEMENT_PLUS & Double = js.native
  }
