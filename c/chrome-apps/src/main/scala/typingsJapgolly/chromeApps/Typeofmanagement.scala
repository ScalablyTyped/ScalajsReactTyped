...
trait Typeofmanagement extends js.Object {
  val ExtensionDisabledReason: AnonPERMISSIONSINCREASE = js.native
  val ExtensionInstallType: AnonADMIN = js.native
  val ExtensionType: AnonEXTENSION = js.native
  val LaunchType: AnonOPENASPINNEDTAB = js.native
  /**
