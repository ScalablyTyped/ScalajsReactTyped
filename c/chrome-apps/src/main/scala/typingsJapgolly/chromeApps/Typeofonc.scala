...
import typingsJapgolly.chromeApps.chrome.networking.onc.DeviceStates
import typingsJapgolly.chromeApps.chrome.networking.onc.Filter
import typingsJapgolly.chromeApps.chrome.networking.onc.GlobalPolicy
import typingsJapgolly.chromeApps.chrome.networking.onc.ManagedProperties
import typingsJapgolly.chromeApps.chrome.networking.onc.NetworkConfigProperties
import typingsJapgolly.chromeApps.chrome.networking.onc.NetworkProperties
import typingsJapgolly.chromeApps.chrome.networking.onc.NetworkStateProperties
...
import typingsJapgolly.chromeApps.chromeAppsStrings.setter
