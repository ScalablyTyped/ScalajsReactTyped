...
trait Typeofusb extends js.Object {
  ...
  val Direction: AnonIN = js.native
  /** Direction, Recipient, RequestType, and TransferType all map to their namesakes within the USB specification. */
  val Recipient: AnonDEVICE = js.native
  /** Direction, Recipient, RequestType, and TransferType all map to their namesakes within the USB specification. */
  val RequestType: AnonCLASS = js.native
  ...
  /**
    ...
    * @param callback
    */
  def findDevices(options: AnonInterfaceId, callback: js.Function1[/* handles */ js.Array[ConnectionHandle], Unit]): Unit = js.native
  /**
    * Finds USB devices specified by the vendor, product and (optionally) interface IDs and if permissions allow opens them for use.
    * If the access request is rejected or the device fails to be opened a connection handle will not be created or returned.
    * Calling this method is equivalent to calling *getDevices* followed by *openDevice* for each device.
    ...
    * @param callback
    */
  def findDevices(options: AnonProductId, callback: js.Function1[/* handles */ js.Array[ConnectionHandle], Unit]): Unit = js.native
  /**
  ...
  /**
    ...
    * @param callback
    */
  def getDevices(options: AnonFiltersArray, callback: js.Function1[/* devices */ js.Array[Device], Unit]): Unit = js.native
  /**
