...
object TypeofplatformKeysClientCertificateType {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(ClientCertificateType = ClientCertificateType.asInstanceOf[js.Any])
  ...
  scala.Unit]) => getKeyPair(t0, t1, t2).runNow()))
    __obj.updateDynamic("selectClientCertificates")(js.Any.fromFunction2((t0: typingsJapgolly.chromeApps.chrome.platformKeys.SelectDetails, t1: js.Function1[
  /* matches */ js.Array[typingsJapgolly.chromeApps.chrome.platformKeys.Match], 
  scala.Unit]) => selectClientCertificates(t0, t1).runNow()))
    __obj.updateDynamic("subtleCrypto")(subtleCrypto.toJsFn)
    __obj.updateDynamic("verifyTLSServerCertificate")(js.Any.fromFunction2((t0: typingsJapgolly.chromeApps.chrome.platformKeys.VerificationDetails, t1: js.Function1[
  /* result */ typingsJapgolly.chromeApps.chrome.platformKeys.VerificationResult, 
