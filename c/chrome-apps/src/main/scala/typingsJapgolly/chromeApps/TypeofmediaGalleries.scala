...
import typingsJapgolly.chromeApps.chrome.mediaGalleries.GalleryChangedEventArgs
import typingsJapgolly.chromeApps.chrome.mediaGalleries.GalleryWatchResult
import typingsJapgolly.chromeApps.chrome.mediaGalleries.MediaFileSystemMetadata
import typingsJapgolly.chromeApps.chrome.mediaGalleries.MediaFileSystemsOptions
import typingsJapgolly.chromeApps.chrome.mediaGalleries.Metadata
import typingsJapgolly.chromeApps.chrome.mediaGalleries.MetadataOptions
import typingsJapgolly.chromeApps.chrome.mediaGalleries.ScanProgressEventArgs
