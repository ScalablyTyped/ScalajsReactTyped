...
trait RedirectToTransparentImage
  ...
  /* protected */ val typeGuard: typingsJapgolly.chromeApps.chromeAppsStrings.RedirectToTransparentImage
}
object RedirectToTransparentImage {
  ...
  extension [Self <: RedirectToTransparentImage](x: Self) {
    ...
    inline def setTypeGuard(value: typingsJapgolly.chromeApps.chromeAppsStrings.RedirectToTransparentImage): Self = StObject.set(x, "typeGuard", value.asInstanceOf[js.Any])
  }
}
