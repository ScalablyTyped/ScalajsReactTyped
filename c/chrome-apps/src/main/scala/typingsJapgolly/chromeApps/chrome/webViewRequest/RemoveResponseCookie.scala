...
trait RemoveResponseCookie
  ...
  /* protected */ val typeGuard: typingsJapgolly.chromeApps.chromeAppsStrings.RemoveResponseCookie
}
object RemoveResponseCookie {
  ...
  extension [Self <: RemoveResponseCookie](x: Self) {
    ...
    inline def setTypeGuard(value: typingsJapgolly.chromeApps.chromeAppsStrings.RemoveResponseCookie): Self = StObject.set(x, "typeGuard", value.asInstanceOf[js.Any])
  }
}
