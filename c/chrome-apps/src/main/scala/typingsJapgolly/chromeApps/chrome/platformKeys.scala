...
import typingsJapgolly.chromeApps.anon.ECDSASIGN
import typingsJapgolly.chromeApps.chromeAppsStrings.ECDSA_SIGN
import typingsJapgolly.chromeApps.chromeAppsStrings.RSA_SIGN
