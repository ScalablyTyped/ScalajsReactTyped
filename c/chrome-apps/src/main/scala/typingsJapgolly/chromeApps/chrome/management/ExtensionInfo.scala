...
import typingsJapgolly.chromeApps.AnonADMIN
import typingsJapgolly.chromeApps.AnonOPENASPINNEDTAB
import typingsJapgolly.chromeApps.AnonPERMISSIONSINCREASE
