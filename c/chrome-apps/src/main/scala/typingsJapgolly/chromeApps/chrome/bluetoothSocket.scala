...
object bluetoothSocket {
  ...
  */
  ...
  object OnAcceptErrorCode {
    ...
    inline def not_listening: typingsJapgolly.chromeApps.chromeAppsStrings.not_listening = "not_listening".asInstanceOf[typingsJapgolly.chromeApps.chromeAppsStrings.not_listening]
    
    inline def system_error: typingsJapgolly.chromeApps.chromeAppsStrings.system_error = "system_error".asInstanceOf[typingsJapgolly.chromeApps.chromeAppsStrings.system_error]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chromeApps.chromeAppsStrings.disconnected__
    - typingsJapgolly.chromeApps.chromeAppsStrings.system_error
  ...
  */
  ...
  object OnReceiveErrorCode {
    ...
    inline def not_connected: typingsJapgolly.chromeApps.chromeAppsStrings.not_connected = "not_connected".asInstanceOf[typingsJapgolly.chromeApps.chromeAppsStrings.not_connected]
