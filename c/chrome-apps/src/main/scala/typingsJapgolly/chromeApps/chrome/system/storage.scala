...
import typingsJapgolly.chromeApps.anon.FIXED
import typingsJapgolly.chromeApps.chrome.ToStringLiteral
import typingsJapgolly.chromeApps.chrome.integer
import typingsJapgolly.chromeApps.chromeAppsStrings.REMOVABLE
import typingsJapgolly.chromeApps.chromeAppsStrings.UNKNOWN
...
object storage {
  ...
  trait StorageUnitInfo extends StObject {
    ...
    var `type`: ToStringLiteral[
        FIXED, 
        /* keyof chrome-apps.anon.FIXED */ typingsJapgolly.chromeApps.chromeAppsStrings.FIXED | REMOVABLE | UNKNOWN, 
