...
object fileSystem {
  ...
  - typingsJapgolly.chromeApps.chrome.fileSystem.ChooseEntryOptions because Already inherited */ trait ChooseDirectoryEntryOptions
    extends StObject
  ...
  */
  ...
  object ChooseEntryOptions {
    ...
    inline def ChooseDirectoryEntryOptions(): typingsJapgolly.chromeApps.chrome.fileSystem.ChooseDirectoryEntryOptions = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("openDirectory")
      __obj.asInstanceOf[typingsJapgolly.chromeApps.chrome.fileSystem.ChooseDirectoryEntryOptions]
    }
    
    inline def ChooseEntryOptionsBase(): typingsJapgolly.chromeApps.chrome.fileSystem.ChooseEntryOptionsBase = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.chromeApps.chrome.fileSystem.ChooseEntryOptionsBase]
    }
    
    inline def ChooseFileEntryOptions(`type`: openFile | openWritableFile): typingsJapgolly.chromeApps.chrome.fileSystem.ChooseFileEntryOptions = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.chromeApps.chrome.fileSystem.ChooseFileEntryOptions]
    }
    
    inline def ChooseMultipleFilesEntryOptions(`type`: openFile | openWritableFile): typingsJapgolly.chromeApps.chrome.fileSystem.ChooseMultipleFilesEntryOptions = {
      val __obj = js.Dynamic.literal(acceptsMultiple = true)
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.chromeApps.chrome.fileSystem.ChooseMultipleFilesEntryOptions]
    }
    
    inline def ChooseSaveFileEntryOptions(): typingsJapgolly.chromeApps.chrome.fileSystem.ChooseSaveFileEntryOptions = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("saveFile")
      __obj.asInstanceOf[typingsJapgolly.chromeApps.chrome.fileSystem.ChooseSaveFileEntryOptions]
    }
  }
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.chromeApps.chrome.fileSystem.ChooseEntryOptions because Already inherited */ trait ChooseFileEntryOptions
    extends StObject
       with ChooseEntryOptionsBase {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.chromeApps.chrome.fileSystem.ChooseEntryOptions because Already inherited */ trait ChooseMultipleFilesEntryOptions
    extends StObject
       with ChooseEntryOptionsBase {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.chromeApps.chrome.fileSystem.ChooseEntryOptions because Already inherited */ trait ChooseSaveFileEntryOptions
    extends StObject
       with ChooseEntryOptionsBase {
