...
trait RemoveRequestCookie
  ...
  /* protected */ val typeGuard: typingsJapgolly.chromeApps.chromeAppsStrings.RemoveRequestCookie
}
object RemoveRequestCookie {
  ...
  extension [Self <: RemoveRequestCookie](x: Self) {
    ...
    inline def setTypeGuard(value: typingsJapgolly.chromeApps.chromeAppsStrings.RemoveRequestCookie): Self = StObject.set(x, "typeGuard", value.asInstanceOf[js.Any])
  }
}
