...
trait RedirectToEmptyDocument
  ...
  /* protected */ val typeGuard: typingsJapgolly.chromeApps.chromeAppsStrings.RedirectToEmptyDocument
}
object RedirectToEmptyDocument {
  ...
  extension [Self <: RedirectToEmptyDocument](x: Self) {
    ...
    inline def setTypeGuard(value: typingsJapgolly.chromeApps.chromeAppsStrings.RedirectToEmptyDocument): Self = StObject.set(x, "typeGuard", value.asInstanceOf[js.Any])
  }
}
