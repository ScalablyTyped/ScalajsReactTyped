...
import typingsJapgolly.chromeApps.anon.ADDED
import typingsJapgolly.chromeApps.anon.CONFLICTING
import typingsJapgolly.chromeApps.anon.LOCALTOREMOTE
...
object syncFileSystem {
  ...
  trait FileStatusChangedDetail extends StObject {
    ...
    var action: js.UndefOr[
        ToStringLiteral[
          ADDED, 
          /* keyof chrome-apps.anon.ADDED */ typingsJapgolly.chromeApps.chromeAppsStrings.ADDED | UPDATED | DELETED, 
