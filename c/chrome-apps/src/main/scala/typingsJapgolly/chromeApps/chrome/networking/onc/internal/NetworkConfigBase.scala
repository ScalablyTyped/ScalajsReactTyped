package typingsJapgolly.chromeApps.chrome.networking.onc.internal
...
import typingsJapgolly.chromeApps.chrome.networking.onc.CellularBase
import typingsJapgolly.chromeApps.chrome.networking.onc.CellularProperties
import typingsJapgolly.chromeApps.chrome.networking.onc.EthernetProperties
...
import typingsJapgolly.chromeApps.chrome.networking.onc.ManagedBoolean
import typingsJapgolly.chromeApps.chrome.networking.onc.ManagedDOMString
import typingsJapgolly.chromeApps.chrome.networking.onc.ManagedIPConfigType
import typingsJapgolly.chromeApps.chrome.networking.onc.ManagedLong
...
import typingsJapgolly.chromeApps.chrome.networking.onc.VPNProperties
import typingsJapgolly.chromeApps.chrome.networking.onc.WiFiProperties
import typingsJapgolly.chromeApps.chrome.networking.onc.WiFiPropertiesBase
import typingsJapgolly.chromeApps.chrome.networking.onc.WiMAXProperties
