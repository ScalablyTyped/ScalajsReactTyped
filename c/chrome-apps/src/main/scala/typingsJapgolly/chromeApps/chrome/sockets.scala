...
import typingsJapgolly.chromeApps.anon.Max
...
object sockets {
  ...
  object tcpServer {
    ...
    object SocketInfo {
      ...
      inline def apply(paused: Boolean, persistent: Boolean, socketId: integer): typingsJapgolly.chromeApps.chrome.sockets.tcpServer.SocketInfo = {
        ...
        __obj.asInstanceOf[typingsJapgolly.chromeApps.chrome.sockets.tcpServer.SocketInfo]
      }
      
      extension [Self <: typingsJapgolly.chromeApps.chrome.sockets.tcpServer.SocketInfo](x: Self) {
    ...
    object SocketProperties {
      ...
      inline def apply(): typingsJapgolly.chromeApps.chrome.sockets.tcpServer.SocketProperties = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.chromeApps.chrome.sockets.tcpServer.SocketProperties]
      }
      
      extension [Self <: typingsJapgolly.chromeApps.chrome.sockets.tcpServer.SocketProperties](x: Self) {
