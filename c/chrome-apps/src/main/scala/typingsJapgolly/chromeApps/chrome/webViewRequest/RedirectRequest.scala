...
trait RedirectRequest
  ...
  /* protected */ val typeGuard: typingsJapgolly.chromeApps.chromeAppsStrings.RedirectRequest
}
object RedirectRequest {
  ...
  extension [Self <: RedirectRequest](x: Self) {
    ...
    inline def setTypeGuard(value: typingsJapgolly.chromeApps.chromeAppsStrings.RedirectRequest): Self = StObject.set(x, "typeGuard", value.asInstanceOf[js.Any])
  }
}
