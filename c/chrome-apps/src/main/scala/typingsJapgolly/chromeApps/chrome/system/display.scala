...
import typingsJapgolly.chromeApps.anon.BOTTOM
import typingsJapgolly.chromeApps.anon.ManufacturerId
import typingsJapgolly.chromeApps.chrome.ToStringLiteral
import typingsJapgolly.chromeApps.chrome.double
import typingsJapgolly.chromeApps.chrome.integer
import typingsJapgolly.chromeApps.chromeAppsInts.`0`
import typingsJapgolly.chromeApps.chromeAppsInts.`180`
import typingsJapgolly.chromeApps.chromeAppsInts.`270`
import typingsJapgolly.chromeApps.chromeAppsInts.`90`
...
object display {
  ...
  trait DisplayLayout extends StObject {
    ...
    var position: ToStringLiteral[
        BOTTOM, 
        /* keyof chrome-apps.anon.BOTTOM */ TOP | RIGHT | typingsJapgolly.chromeApps.chromeAppsStrings.BOTTOM | LEFT, 
