...
import typingsJapgolly.chromeApps.chromeAppsStrings.CDMA
import typingsJapgolly.chromeApps.chromeAppsStrings.GSM
...
trait CellularProperties[M /* <: ManagedObject */]
  ...
  var PaymentPortal: js.UndefOr[
    typingsJapgolly.chromeApps.chrome.networking.onc.PaymentPortal | PaymentPortalPost
  ] = js.undefined
...
object CellularProperties {
  ...
  extension [Self <: CellularProperties[?], M /* <: ManagedObject */](x: Self & CellularProperties[M]) {
