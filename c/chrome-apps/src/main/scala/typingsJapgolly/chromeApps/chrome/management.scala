...
import typingsJapgolly.chromeApps.anon.ADMIN
import typingsJapgolly.chromeApps.anon.OPENASPINNEDTAB
import typingsJapgolly.chromeApps.anon.PERMISSIONSINCREASE
...
object management {
  ...
  trait ExtensionInfo extends StObject {
    ...
    var installType: ToStringLiteral[
        ADMIN, 
        /* keyof chrome-apps.anon.ADMIN */ typingsJapgolly.chromeApps.chromeAppsStrings.ADMIN | DEVELOPMENT | NORMAL | SIDELOAD | OTHER, 
