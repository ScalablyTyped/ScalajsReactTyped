...
object internal {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.chromeApps.chromeAppsStrings.getter
    - typingsJapgolly.chromeApps.chromeAppsStrings.setter
  */
  trait ObjectFunction extends StObject
  object ObjectFunction {
    
    inline def getter: typingsJapgolly.chromeApps.chromeAppsStrings.getter = "getter".asInstanceOf[typingsJapgolly.chromeApps.chromeAppsStrings.getter]
    
    inline def setter: typingsJapgolly.chromeApps.chromeAppsStrings.setter = "setter".asInstanceOf[typingsJapgolly.chromeApps.chromeAppsStrings.setter]
