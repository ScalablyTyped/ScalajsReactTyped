...
import typingsJapgolly.chromeApps.anon.CAPABILITIESNEGOTIATIONERROR
import typingsJapgolly.chromeApps.anon.CONNECTED
import typingsJapgolly.chromeApps.anon.PBC
...
object displaySource {
  ...
  trait AuthenticationInfo extends StObject {
    ...
    var method: js.UndefOr[
        ToStringLiteral[
          PBC, 
          /* keyof chrome-apps.anon.PBC */ typingsJapgolly.chromeApps.chromeAppsStrings.PBC | PIN, 
  ...
  trait SinkInfo extends StObject {
    ...
    var state: ToStringLiteral[
        CONNECTED, 
        /* keyof chrome-apps.anon.CONNECTED */ typingsJapgolly.chromeApps.chromeAppsStrings.CONNECTED | CONNECTING | DISCONNECTED, 
