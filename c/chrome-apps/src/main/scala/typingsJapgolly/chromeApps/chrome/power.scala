...
import typingsJapgolly.chromeApps.AnonDISPLAY
import typingsJapgolly.chromeApps.chromeAppsStrings.display
...
object power extends js.Object {
  ...
  def requestKeepAwake(
    level: ToStringLiteral[
      AnonDISPLAY, 
      String, 
      Exclude[String, typingsJapgolly.chromeApps.chromeAppsStrings.system | display]
    ]
  ): Unit = js.native
  /**
    * @enum
  ...
  object Level extends js.Object {
    ...
    var SYSTEM: typingsJapgolly.chromeApps.chromeAppsStrings.system = js.native
  }
