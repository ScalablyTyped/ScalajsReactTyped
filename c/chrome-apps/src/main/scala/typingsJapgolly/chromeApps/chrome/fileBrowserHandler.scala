...
object fileBrowserHandler {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.chromeApps.chromeAppsStrings.ReadOnly
    - typingsJapgolly.chromeApps.chromeAppsStrings.ReadWrite
  */
  trait FileBrowserHandleExecuteId extends StObject
  object FileBrowserHandleExecuteId {
    
    inline def ReadOnly: typingsJapgolly.chromeApps.chromeAppsStrings.ReadOnly = "ReadOnly".asInstanceOf[typingsJapgolly.chromeApps.chromeAppsStrings.ReadOnly]
    
    inline def ReadWrite: typingsJapgolly.chromeApps.chromeAppsStrings.ReadWrite = "ReadWrite".asInstanceOf[typingsJapgolly.chromeApps.chromeAppsStrings.ReadWrite]
  }
