...
import typingsJapgolly.chromeApps.chrome.runtime.SocketTcpPermission
import typingsJapgolly.chromeApps.chrome.runtime.SocketTcpServerPermission
import typingsJapgolly.chromeApps.chrome.runtime.SocketUdpPermission
