...
import typingsJapgolly.chromeApps.chromeAppsStrings.about_page_
import typingsJapgolly.chromeApps.chromeAppsStrings.app_launcher_
import typingsJapgolly.chromeApps.chromeAppsStrings.background_
import typingsJapgolly.chromeApps.chromeAppsStrings.chrome_internal_
import typingsJapgolly.chromeApps.chromeAppsStrings.command_line_
import typingsJapgolly.chromeApps.chromeAppsStrings.context_menu_
import typingsJapgolly.chromeApps.chromeAppsStrings.ephemeral_app_
import typingsJapgolly.chromeApps.chromeAppsStrings.extensions_page_
import typingsJapgolly.chromeApps.chromeAppsStrings.file_handler_
import typingsJapgolly.chromeApps.chromeAppsStrings.installed_notification_
import typingsJapgolly.chromeApps.chromeAppsStrings.keyboard_
import typingsJapgolly.chromeApps.chromeAppsStrings.kiosk_
import typingsJapgolly.chromeApps.chromeAppsStrings.load_and_launch_
import typingsJapgolly.chromeApps.chromeAppsStrings.management_api_
import typingsJapgolly.chromeApps.chromeAppsStrings.new_tab_page_
import typingsJapgolly.chromeApps.chromeAppsStrings.reload_
import typingsJapgolly.chromeApps.chromeAppsStrings.restart_
import typingsJapgolly.chromeApps.chromeAppsStrings.system_tray_
import typingsJapgolly.chromeApps.chromeAppsStrings.test_
import typingsJapgolly.chromeApps.chromeAppsStrings.untracked_
import typingsJapgolly.chromeApps.chromeAppsStrings.url_handler_
...
trait ABOUTPAGE extends StObject {
  ...
  var ABOUT_PAGE: about_page_
  
  var APP_LAUNCHER: app_launcher_
  
  var BACKGROUND: background_
  
  var CHROME_INTERNAL: chrome_internal_
  
  var COMMAND_LINE: command_line_
  
  var CONTEXT_MENU: context_menu_
  
  var EPHEMERAL_APP: ephemeral_app_
  
  var EXTENSIONS_PAGE: extensions_page_
  
  var FILE_HANDLER: file_handler_
  
  var INSTALLED_NOTIFICATION: installed_notification_
  
  var KEYBOARD: keyboard_
  
  var KIOSK: kiosk_
  
  var LOAD_AND_LAUNCH: load_and_launch_
  
  var MANAGEMENT_API: management_api_
  
  var NEW_TAB_PAGE: new_tab_page_
  
  var RELOAD: reload_
  
  var RESTART: restart_
  
  var SYSTEM_TRAY: system_tray_
  
  var TEST: test_
  
  var UNTRACKED: untracked_
  
  var URL_HANDLER: url_handler_
}
object ABOUTPAGE {
