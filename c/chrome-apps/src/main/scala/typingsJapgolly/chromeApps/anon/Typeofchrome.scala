...
object Typeofchrome {
  ...
  extension [Self <: Typeofchrome](x: Self) {
    ...
    inline def setCsi(value: CallbackTo[OnloadT]): Self = StObject.set(x, "csi", value.toJsFn)
    ...
    inline def setLoadTimes(value: CallbackTo[deprecatedButUsable]): Self = StObject.set(x, "loadTimes", value.toJsFn)
