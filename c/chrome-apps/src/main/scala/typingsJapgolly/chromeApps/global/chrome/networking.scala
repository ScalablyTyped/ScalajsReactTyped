...
import typingsJapgolly.chromeApps.anon.FAILED
...
object networking {
  ...
  object config {
    ...
    inline def finishAuthentication(
      ...
      result: ToStringLiteral[
          FAILED, 
          /* keyof chrome-apps.anon.FAILED */ UNHANDLED | SUCCEEDED | REJECTED | typingsJapgolly.chromeApps.chromeAppsStrings.FAILED, 
    ...
    @js.native
    val onCaptivePortalDetected: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* networkInfo */ NetworkInfo, Unit]] = js.native
  ...
  object onc {
    ...
    @js.native
    val onDeviceStateListChanged: typingsJapgolly.chromeApps.chrome.events.Event[js.Function0[Unit]] = js.native
    ...
    @js.native
    val onNetworkListChanged: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* changes */ js.Array[String], Unit]] = js.native
    ...
    @js.native
    val onNetworksChanged: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* changes */ js.Array[String], Unit]] = js.native
    ...
    @js.native
    val onPortalDetectionCompleted: typingsJapgolly.chromeApps.chrome.events.Event[js.Function2[/* networkGuid */ String, /* status */ CaptivePortalStatus, Unit]] = js.native
