...
object printerProvider {
  ...
  @js.native
  val onGetCapabilityRequested: typingsJapgolly.chromeApps.chrome.events.Event[
    js.Function2[
      /* printerId */ String, 
  ...
  @js.native
  val onGetPrintersRequested: typingsJapgolly.chromeApps.chrome.events.Event[
    js.Function1[
  ...
  @js.native
  val onGetUsbPrinterInfoRequested: typingsJapgolly.chromeApps.chrome.events.Event[
    js.Function2[
      /* device */ Any, 
  ...
  @js.native
  val onPrintRequested: typingsJapgolly.chromeApps.chrome.events.Event[
    js.Function2[
      /* printJob */ PrintJob, 
