...
import typingsJapgolly.chromeApps.chrome.sockets.AcceptErrorEventArgs
import typingsJapgolly.chromeApps.chrome.sockets.AcceptEventArgs
import typingsJapgolly.chromeApps.chrome.sockets.CreateInfo
import typingsJapgolly.chromeApps.chrome.sockets.ReceiveErrorEventArgs
import typingsJapgolly.chromeApps.chrome.sockets.ReceiveEventArgs
import typingsJapgolly.chromeApps.chrome.sockets.SendInfo
...
import typingsJapgolly.chromeApps.chrome.sockets.tcp.SecureOptions
...
object sockets {
  ...
  object tcp {
    ...
    @js.native
    val onReceive: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* args */ ReceiveEventArgs, Unit]] = js.native
    ...
    @js.native
    val onReceiveError: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* args */ ReceiveErrorEventArgs, Unit]] = js.native
  ...
  object tcpServer {
    ...
    /**
      ...
      */
    inline def create(
      properties: typingsJapgolly.chromeApps.chrome.sockets.tcpServer.SocketProperties,
    ...
    inline def getInfo(
      ...
      callback: js.Function1[
          /* socketInfo */ typingsJapgolly.chromeApps.chrome.sockets.tcpServer.SocketInfo, 
          Unit
        ]
    ...
    inline def getSockets(
      callback: js.Function1[
          /* socketInfos */ js.Array[typingsJapgolly.chromeApps.chrome.sockets.tcpServer.SocketInfo], 
          Unit
        ]
    ...
    @js.native
    val onAccept: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* args */ AcceptEventArgs, Unit]] = js.native
    ...
    @js.native
    val onAcceptError: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* args */ AcceptErrorEventArgs, Unit]] = js.native
    ...
    inline def update(
      socketId: integer,
      properties: typingsJapgolly.chromeApps.chrome.sockets.tcpServer.SocketProperties
    ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("update")(socketId.asInstanceOf[js.Any], properties.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def update(
      socketId: integer,
      properties: typingsJapgolly.chromeApps.chrome.sockets.tcpServer.SocketProperties,
