...
import typingsJapgolly.chromeApps.chrome.fileSystem.ChooseDirectoryEntryOptions
import typingsJapgolly.chromeApps.chrome.fileSystem.ChooseEntryOptionsBase
import typingsJapgolly.chromeApps.chrome.fileSystem.ChooseFileEntryOptions
import typingsJapgolly.chromeApps.chrome.fileSystem.ChooseMultipleFilesEntryOptions
import typingsJapgolly.chromeApps.chrome.fileSystem.ChooseSaveFileEntryOptions
import typingsJapgolly.chromeApps.chrome.fileSystem.FileEntryCallback
import typingsJapgolly.chromeApps.chrome.fileSystem.Volume
...
import typingsJapgolly.filesystem.FileSystemDirectoryEntry
...
object fileSystem {
  ...
  @js.native
  val onVolumeListChanged: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* object */ js.Array[Volume], Unit]] = js.native
