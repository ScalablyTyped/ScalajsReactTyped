...
object gcm {
  ...
  @js.native
  val onMessage: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* message */ IncomingMessage, Unit]] = js.native
  ...
  @js.native
  val onMessagesDeleted: typingsJapgolly.chromeApps.chrome.events.Event[js.Function0[Unit]] = js.native
  
  /** Fired when it was not possible to send a message to the GCM server. */
  @JSGlobal("chrome.gcm.onSendError")
  @js.native
  val onSendError: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* error */ GcmError, Unit]] = js.native
