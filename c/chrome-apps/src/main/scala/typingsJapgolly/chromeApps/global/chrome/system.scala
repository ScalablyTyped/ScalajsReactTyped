...
import typingsJapgolly.chromeApps.anon.FAILURE
import typingsJapgolly.chromeApps.chrome.ToStringLiteral
import typingsJapgolly.chromeApps.chrome.system.cpu.CpuInfo
import typingsJapgolly.chromeApps.chrome.system.display.Bounds
import typingsJapgolly.chromeApps.chrome.system.display.DisplayInfo
import typingsJapgolly.chromeApps.chrome.system.display.DisplayInfoFlags
import typingsJapgolly.chromeApps.chrome.system.display.DisplayLayout
import typingsJapgolly.chromeApps.chrome.system.display.DisplayPropertiesInfo
import typingsJapgolly.chromeApps.chrome.system.display.Insets
import typingsJapgolly.chromeApps.chrome.system.display.MirrorModeInfo
import typingsJapgolly.chromeApps.chrome.system.display.MirrorModeInfoMixed
import typingsJapgolly.chromeApps.chrome.system.display.TouchCalibrationPairs
...
object system {
  ...
  object display {
    ...
    @js.native
    val onDisplayChanged: typingsJapgolly.chromeApps.chrome.events.Event[js.Function0[Unit]] = js.native
  ...
  object powerSource {
    ...
    object PowerSourceType extends StObject {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[typingsJapgolly.chromeApps.chrome.system.powerSource.PowerSourceType & String] = js.native
      
      /* "mains" */ val mains: typingsJapgolly.chromeApps.chrome.system.powerSource.PowerSourceType.mains & String = js.native
      
      /* "unknown" */ val unknown: typingsJapgolly.chromeApps.chrome.system.powerSource.PowerSourceType.unknown & String = js.native
      
      /* "usb" */ val usb: typingsJapgolly.chromeApps.chrome.system.powerSource.PowerSourceType.usb & String = js.native
    }
    ...
    @js.native
    val onPowerChanged: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* powerSourceInfo */ js.Array[PowerSourceInfo], Unit]] = js.native
  ...
  object storage {
    ...
    inline def ejectDevice(
      ...
      callback: js.Function1[
          /* result */ ToStringLiteral[
            FAILURE, 
            /* keyof chrome-apps.anon.FAILURE */ SUCCESS | IN_USE | NO_SUCH_DEVICE | typingsJapgolly.chromeApps.chromeAppsStrings.FAILURE, 
    ...
    @js.native
    val onAttached: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* info */ StorageUnitInfo, Unit]] = js.native
    
    /** Fired when a removable storage is detached from the system. */
    @JSGlobal("chrome.system.storage.onDetached")
    @js.native
    val onDetached: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* id */ String, Unit]] = js.native
  }
}
