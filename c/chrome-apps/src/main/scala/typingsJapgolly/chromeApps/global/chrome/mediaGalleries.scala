...
object mediaGalleries {
  ...
  @js.native
  val onGalleryChanged: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* args */ GalleryChangedEventArgs, Unit]] = js.native
  ...
  @js.native
  val onScanProgress: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* args */ ScanProgressEventArgs, Unit]] = js.native
