...
import typingsJapgolly.chromeApps.anon.AUTHENTICATIONREQUIRED
import typingsJapgolly.chromeApps.anon.CONFLICTING
import typingsJapgolly.chromeApps.anon.LASTWRITEWIN
import typingsJapgolly.chromeApps.anon.QuotaBytes
import typingsJapgolly.chromeApps.anon.State
...
import typingsJapgolly.chromeApps.chromeAppsStrings.MANUAL
...
import typingsJapgolly.chromeApps.chromeAppsStrings.authentication_required_
...
import typingsJapgolly.chromeApps.chromeAppsStrings.initializing_
...
import typingsJapgolly.chromeApps.chromeAppsStrings.running_
import typingsJapgolly.chromeApps.chromeAppsStrings.synced_
import typingsJapgolly.chromeApps.chromeAppsStrings.temporary_unavailable_
...
object syncFileSystem {
  ...
  inline def getFileStatus(
    ...
    callback: js.Function1[
      /* status */ ToStringLiteral[
        CONFLICTING, 
        /* keyof chrome-apps.anon.CONFLICTING */ SYNCED | PENDING | typingsJapgolly.chromeApps.chromeAppsStrings.CONFLICTING, 
  ...
  @js.native
  val onFileStatusChanged: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* detail */ FileStatusChangedDetail, Unit]] = js.native
  ...
  @js.native
  val onServiceStatusChanged: typingsJapgolly.chromeApps.chrome.events.Event[js.Function1[/* detail */ State, Unit]] = js.native
