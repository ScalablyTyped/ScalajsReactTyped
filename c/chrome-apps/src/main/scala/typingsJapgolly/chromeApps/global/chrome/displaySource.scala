...
import typingsJapgolly.chromeApps.chromeAppsStrings.Connecting_
...
object displaySource {
  ...
  object AuthenticationMethod {
    ...
    @js.native
    def PBC: typingsJapgolly.chromeApps.chromeAppsStrings.PBC = js.native
  ...
  @js.native
  val onSessionErrorOccured: typingsJapgolly.chromeApps.chrome.events.Event[Any] = js.native
  
  @JSGlobal("chrome.displaySource.onSessionTerminated")
  @js.native
  val onSessionTerminated: typingsJapgolly.chromeApps.chrome.events.Event[Any] = js.native
  
  @JSGlobal("chrome.displaySource.onSinksUpdated")
  @js.native
  val onSinksUpdated: typingsJapgolly.chromeApps.chrome.events.Event[Any] = js.native
