...
import typingsJapgolly.chromeLauncher.anon.FnCall
import typingsJapgolly.chromeLauncher.anon.FnCallPathOptionsCallback
import typingsJapgolly.chromeLauncher.anon.Typeoffs
import typingsJapgolly.chromeLauncher.chromeLauncherStrings.error
import typingsJapgolly.chromeLauncher.chromeLauncherStrings.info
import typingsJapgolly.chromeLauncher.chromeLauncherStrings.silent
import typingsJapgolly.chromeLauncher.chromeLauncherStrings.verbose
...
object distSrcChromeLauncherMod {
  ...
  object LaunchedChrome {
    ...
    inline def apply(kill: CallbackTo[js.Promise[js.Object]], pid: Double, port: Double, process: ChildProcess): LaunchedChrome = {
      val __obj = js.Dynamic.literal(kill = kill.toJsFn, pid = pid.asInstanceOf[js.Any], port = port.asInstanceOf[js.Any], process = process.asInstanceOf[js.Any])
      __obj.asInstanceOf[LaunchedChrome]
    }
    
    extension [Self <: LaunchedChrome](x: Self) {
      
      inline def setKill(value: CallbackTo[js.Promise[js.Object]]): Self = StObject.set(x, "kill", value.toJsFn)
