...
import typingsJapgolly.chromeLauncher.distUtilsMod.LaunchErrorCodes
...
object chromeLauncherStrings {
  ...
  sealed trait ERR_LAUNCHER_INVALID_USER_DATA_DIRECTORY
    extends StObject
       ...
       with typingsJapgolly.chromeLauncher.distSrcUtilsMod.LaunchErrorCodes
  ...
  @js.native
  sealed trait netbsd extends StObject
  ...
  @js.native
  sealed trait wsl extends StObject
  inline def wsl: wsl = "wsl".asInstanceOf[wsl]
}
