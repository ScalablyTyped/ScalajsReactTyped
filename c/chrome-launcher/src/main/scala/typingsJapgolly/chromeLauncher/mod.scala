...
import typingsJapgolly.chromeLauncher.distChromeLauncherMod.LaunchedChrome
import typingsJapgolly.chromeLauncher.distChromeLauncherMod.ModuleOverrides
import typingsJapgolly.chromeLauncher.distChromeLauncherMod.Options
...
object mod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.chromeLauncher.distChromeLauncherMod.default {
