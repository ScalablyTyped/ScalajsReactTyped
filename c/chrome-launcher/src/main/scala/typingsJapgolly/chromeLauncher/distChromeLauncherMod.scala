...
object distChromeLauncherMod {
  ...
  object LaunchedChrome {
    ...
    inline def apply(kill: CallbackTo[js.Promise[Unit]], pid: Double, port: Double, process: ChildProcess): LaunchedChrome = {
    ...
    extension [Self <: LaunchedChrome](x: Self) {
      ...
      inline def setKill(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "kill", value.toJsFn)
