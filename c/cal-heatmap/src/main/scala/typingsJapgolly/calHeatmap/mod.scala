package typingsJapgolly.calHeatmap
...
object mod {
  ...
  object global {
    ...
    object CalHeatMap extends Shortcut {
      ...
      open class ^ ()
        extends StObject
           with typingsJapgolly.calHeatmap.mod.global.CalHeatMap.CalHeatMap
      ...
      trait CalHeatMap extends StObject {
        ...
        /**
          ...
          */
        def destroy(): typingsJapgolly.calHeatmap.mod.global.CalHeatMap.CalHeatMap = js.native
        def destroy(callback: js.Function): typingsJapgolly.calHeatmap.mod.global.CalHeatMap.CalHeatMap = js.native
      ...
      trait CalHeatMapStatic
        extends StObject
           with Instantiable0[typingsJapgolly.calHeatmap.mod.global.CalHeatMap.CalHeatMap]
      ...
      object InitOptions {
        ...
        extension [Self <: InitOptions](x: Self) {
          ...
          inline def setAfterLoadNextDomain(value: /* date */ js.Date => Callback): Self = StObject.set(x, "afterLoadNextDomain", js.Any.fromFunction1((t0: /* date */ js.Date) => value(t0).runNow()))
          
          inline def setAfterLoadNextDomainUndefined: Self = StObject.set(x, "afterLoadNextDomain", js.undefined)
          
          inline def setAfterLoadPreviousDomain(value: /* date */ js.Date => Callback): Self = StObject.set(x, "afterLoadPreviousDomain", js.Any.fromFunction1((t0: /* date */ js.Date) => value(t0).runNow()))
          ...
          inline def setOnClick(value: (/* date */ js.Date, /* value */ Double) => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* date */ js.Date, t1: /* value */ Double) => (value(t0, t1)).runNow()))
          ...
          inline def setOnMaxDomainReached(value: /* reached */ Boolean => Callback): Self = StObject.set(x, "onMaxDomainReached", js.Any.fromFunction1((t0: /* reached */ Boolean) => value(t0).runNow()))
          
          inline def setOnMaxDomainReachedUndefined: Self = StObject.set(x, "onMaxDomainReached", js.undefined)
          
          inline def setOnMinDomainReached(value: /* reached */ Boolean => Callback): Self = StObject.set(x, "onMinDomainReached", js.Any.fromFunction1((t0: /* reached */ Boolean) => value(t0).runNow()))
