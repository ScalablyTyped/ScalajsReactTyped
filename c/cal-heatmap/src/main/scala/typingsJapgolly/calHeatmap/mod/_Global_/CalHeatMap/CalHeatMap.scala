...
trait CalHeatMap extends js.Object {
  ...
  /**
  			 ...
  			 */
  def destroy(): typingsJapgolly.calHeatmap.mod._Global_.CalHeatMap.CalHeatMap = js.native
  def destroy(callback: js.Function): typingsJapgolly.calHeatmap.mod._Global_.CalHeatMap.CalHeatMap = js.native
  /**
