...
import typingsJapgolly.cryptojs.CryptoJS.enc.IEncoder
import typingsJapgolly.cryptojs.CryptoJS.format.IFormatter
import typingsJapgolly.cryptojs.CryptoJS.kdf.IKdfImpl
...
import typingsJapgolly.cryptojs.CryptoJS.mode.IBlockCipherModeImpl
import typingsJapgolly.cryptojs.CryptoJS.pad.IPaddingImpl
...
object lib {
  ...
  object Base {
    ...
    inline def apply(
      ...
      init: /* repeated */ Any => Callback,
      mixIn: js.Object => Callback
    ): Base = {
      val __obj = js.Dynamic.literal(create = js.Any.fromFunction1(create), extend = js.Any.fromFunction1(extend), init = js.Any.fromFunction1((t0: /* repeated */ Any) => init(t0).runNow()), mixIn = js.Any.fromFunction1((t0: js.Object) => mixIn(t0).runNow()))
    ...
    extension [Self <: Base](x: Self) {
      ...
      inline def setMixIn(value: js.Object => Callback): Self = StObject.set(x, "mixIn", js.Any.fromFunction1((t0: js.Object) => value(t0).runNow()))
    }
  }
  ...
  object BufferedBlockAlgorithm {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(create = js.Any.fromFunction1(create), extend = js.Any.fromFunction1(extend), init = js.Any.fromFunction1((t0: /* repeated */ Any) => init(t0).runNow()), mixIn = js.Any.fromFunction1((t0: js.Object) => mixIn(t0).runNow()), reset = reset.toJsFn)
