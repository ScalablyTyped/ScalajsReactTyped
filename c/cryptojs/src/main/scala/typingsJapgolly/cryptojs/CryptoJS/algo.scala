...
import typingsJapgolly.cryptojs.CryptoJS.lib.IHasher
import typingsJapgolly.cryptojs.CryptoJS.lib.IStreamCipher
import typingsJapgolly.cryptojs.CryptoJS.lib.StreamCipher
...
object algo {
  ...
  trait AlgoStatic extends StObject {
    ...
    var AES: typingsJapgolly.cryptojs.CryptoJS.algo.AES
    
    var DES: typingsJapgolly.cryptojs.CryptoJS.algo.DES
    
    var EvpKDF: typingsJapgolly.cryptojs.CryptoJS.algo.EvpKDF
    
    var HMAC: typingsJapgolly.cryptojs.CryptoJS.algo.HMAC
    
    var MD5: typingsJapgolly.cryptojs.CryptoJS.algo.MD5
    
    var PBKDF2: typingsJapgolly.cryptojs.CryptoJS.algo.PBKDF2
    
    var RC4: typingsJapgolly.cryptojs.CryptoJS.algo.RC4
    
    var RC4Drop: typingsJapgolly.cryptojs.CryptoJS.algo.RC4Drop
    
    var RIPEMD160: typingsJapgolly.cryptojs.CryptoJS.algo.RIPEMD160
    
    var Rabbit: typingsJapgolly.cryptojs.CryptoJS.algo.Rabbit
    
    var RabbitLegacy: typingsJapgolly.cryptojs.CryptoJS.algo.RabbitLegacy
    
    var SHA1: typingsJapgolly.cryptojs.CryptoJS.algo.SHA1
    
    var SHA224: typingsJapgolly.cryptojs.CryptoJS.algo.SHA224
    
    var SHA256: typingsJapgolly.cryptojs.CryptoJS.algo.SHA256
    
    var SHA3: typingsJapgolly.cryptojs.CryptoJS.algo.SHA3
    
    var SHA384: typingsJapgolly.cryptojs.CryptoJS.algo.SHA384
    
    var SHA512: typingsJapgolly.cryptojs.CryptoJS.algo.SHA512
    
    var TripleDES: typingsJapgolly.cryptojs.CryptoJS.algo.TripleDES
  }
  object AlgoStatic {
