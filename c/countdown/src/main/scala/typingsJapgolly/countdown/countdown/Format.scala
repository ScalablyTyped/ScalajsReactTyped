package typingsJapgolly.countdown.countdown
...
object Format {
  ...
  def apply(
    delim: String = null,
    empty: String = null,
    formatNumber: /* value */ Double => CallbackTo[String] = null,
    formatter: (/* value */ Double, /* unit */ Double) => CallbackTo[String] = null,
    last: String = null,
    ...
    if (formatNumber != null) __obj.updateDynamic("formatNumber")(js.Any.fromFunction1((t0: /* value */ scala.Double) => formatNumber(t0).runNow()))
    if (formatter != null) __obj.updateDynamic("formatter")(js.Any.fromFunction2((t0: /* value */ scala.Double, t1: /* unit */ scala.Double) => formatter(t0, t1).runNow()))
