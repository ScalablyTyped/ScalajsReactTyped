...
import typingsJapgolly.leaflet.anon.TypeofDomEvent
import typingsJapgolly.leaflet.mod.DomEvent.EventHandlerFn
import typingsJapgolly.leaflet.mod.DomEvent.PropagableEvent
...
object DomEvent {
  ...
  inline def getMousePosition(ev: MouseEvent): typingsJapgolly.leaflet.mod.Point_ = ^.asInstanceOf[js.Dynamic].applyDynamic("getMousePosition")(ev.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.leaflet.mod.Point_]
  inline def getMousePosition(ev: MouseEvent, container: HTMLElement): typingsJapgolly.leaflet.mod.Point_ = (^.asInstanceOf[js.Dynamic].applyDynamic("getMousePosition")(ev.asInstanceOf[js.Any], container.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.leaflet.mod.Point_]
