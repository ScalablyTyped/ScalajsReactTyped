...
class Marker[P] protected () extends Layer {
  ...
  var feature: js.UndefOr[Feature[typingsJapgolly.geojson.geojsonMod.Point, P]] = js.native
  // Properties
  ...
  def toGeoJSON(): Feature[typingsJapgolly.geojson.geojsonMod.Point, P] = js.native
}
