...
import typingsJapgolly.leaflet.leafletNumbers.`false`
...
object DomUtil extends js.Object {
  ...
  def create(tagName: String, className: String, container: typingsJapgolly.std.HTMLElement): HTMLElement = js.native
  ...
  def setTransform(el: typingsJapgolly.std.HTMLElement, offset: Point): Unit = js.native
  def setTransform(el: typingsJapgolly.std.HTMLElement, offset: Point, scale: Double): Unit = js.native
