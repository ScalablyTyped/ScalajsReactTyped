...
import typingsJapgolly.geojson.geojsonMod.FeatureCollection
import typingsJapgolly.geojson.geojsonMod.GeometryCollection
import typingsJapgolly.geojson.geojsonMod.GeometryObject
import typingsJapgolly.geojson.geojsonMod.MultiPoint
