...
trait GeoJSONOptions[P] extends LayerOptions {
  ...
  var pointToLayer: js.UndefOr[
    js.Function2[
      /* geoJsonPoint */ Feature[typingsJapgolly.geojson.geojsonMod.Point, P], 
      /* latlng */ LatLng, 
      Layer
    ]
  ] = js.undefined
...
object GeoJSONOptions {
  ...
  def apply[P](
    ...
    coordsToLatLng: /* coords */ (js.Tuple2[Double, Double]) | (js.Tuple3[Double, Double, Double]) => CallbackTo[LatLng] = null,
    ...
    pane: String = null,
    pointToLayer: (/* geoJsonPoint */ Feature[typingsJapgolly.geojson.geojsonMod.Point, P], /* latlng */ LatLng) => CallbackTo[Layer] = null,
    ...
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction1((t0: /* geoJsonFeature */ typingsJapgolly.geojson.geojsonMod.Feature[typingsJapgolly.geojson.geojsonMod.GeometryObject, P]) => filter(t0).runNow()))
    if (onEachFeature != null) __obj.updateDynamic("onEachFeature")(js.Any.fromFunction2((t0: /* feature */ typingsJapgolly.geojson.geojsonMod.Feature[typingsJapgolly.geojson.geojsonMod.GeometryObject, P], t1: /* layer */ typingsJapgolly.leaflet.leafletMod.Layer) => onEachFeature(t0, t1).runNow()))
    if (pane != null) __obj.updateDynamic("pane")(pane.asInstanceOf[js.Any])
    if (pointToLayer != null) __obj.updateDynamic("pointToLayer")(js.Any.fromFunction2((t0: /* geoJsonPoint */ typingsJapgolly.geojson.geojsonMod.Feature[typingsJapgolly.geojson.geojsonMod.Point, P], t1: /* latlng */ typingsJapgolly.leaflet.leafletMod.LatLng) => pointToLayer(t0, t1).runNow()))
