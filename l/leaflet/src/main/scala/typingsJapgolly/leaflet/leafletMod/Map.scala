...
class Map protected () extends Evented {
  ...
  var zoomControl: typingsJapgolly.leaflet.leafletMod.Control.Zoom = js.native
  ...
  def createPane(name: String, container: typingsJapgolly.std.HTMLElement): HTMLElement = js.native
  ...
  def getPane(pane: typingsJapgolly.std.HTMLElement): js.UndefOr[HTMLElement] = js.native
...
object map extends js.Object {
  ...
  def apply(element: typingsJapgolly.std.HTMLElement): Map = js.native
  def apply(element: typingsJapgolly.std.HTMLElement, options: MapOptions): Map = js.native
}
