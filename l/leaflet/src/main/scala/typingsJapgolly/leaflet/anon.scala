...
object anon {
  ...
  trait Attribution
    ...
    var Scale: Instantiable1[/* options */ js.UndefOr[ScaleOptions], typingsJapgolly.leaflet.mod.Control_.Scale] = js.native
    
    var Zoom: Instantiable1[/* options */ js.UndefOr[ZoomOptions], typingsJapgolly.leaflet.mod.Control_.Zoom] = js.native
