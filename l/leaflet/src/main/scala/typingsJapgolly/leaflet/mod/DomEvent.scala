...
object DomEvent {
  ...
  */
  ...
  object _PropagableEvent {
    ...
    inline def LeafletEvent(layer: Any, popup: Any, propagatedFrom: Any, sourceTarget: Any, target: Any, `type`: String): typingsJapgolly.leaflet.mod.LeafletEvent = {
      ...
      __obj.asInstanceOf[typingsJapgolly.leaflet.mod.LeafletEvent]
    }
    ...
    inline def LeafletKeyboardEvent(
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.leaflet.mod.LeafletKeyboardEvent]
    }
    ...
    inline def LeafletMouseEvent(
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.leaflet.mod.LeafletMouseEvent]
    }
  }
}
