...
object Control_ {
  ...
  open class Zoom () extends Control_ {
    def this(options: typingsJapgolly.leaflet.mod.Control_.ZoomOptions) = this()
    
    @JSName("options")
    var options_Zoom: typingsJapgolly.leaflet.mod.Control_.ZoomOptions = js.native
  }
  ...
  object ZoomOptions {
    ...
    inline def apply(): typingsJapgolly.leaflet.mod.Control_.ZoomOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.leaflet.mod.Control_.ZoomOptions]
    }
    
    extension [Self <: typingsJapgolly.leaflet.mod.Control_.ZoomOptions](x: Self) {
