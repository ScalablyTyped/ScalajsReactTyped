...
import org.scalajs.dom.SVGScriptElement
import org.scalajs.dom.SVGStopElement
import org.scalajs.dom.SVGStyleElement
...
import org.scalajs.dom.SVGTitleElement
import org.scalajs.dom.SVGUseElement
import org.scalajs.dom.SVGViewElement
import typingsJapgolly.leaflet.leafletStrings.a
import typingsJapgolly.leaflet.leafletStrings.animate
import typingsJapgolly.leaflet.leafletStrings.animateMotion
import typingsJapgolly.leaflet.leafletStrings.animateTransform
import typingsJapgolly.leaflet.leafletStrings.clipPath
import typingsJapgolly.leaflet.leafletStrings.defs
import typingsJapgolly.leaflet.leafletStrings.desc
import typingsJapgolly.leaflet.leafletStrings.ellipse
import typingsJapgolly.leaflet.leafletStrings.feBlend
import typingsJapgolly.leaflet.leafletStrings.feColorMatrix
import typingsJapgolly.leaflet.leafletStrings.feComponentTransfer
import typingsJapgolly.leaflet.leafletStrings.feComposite
import typingsJapgolly.leaflet.leafletStrings.feConvolveMatrix
import typingsJapgolly.leaflet.leafletStrings.feDiffuseLighting
import typingsJapgolly.leaflet.leafletStrings.feDisplacementMap
import typingsJapgolly.leaflet.leafletStrings.feDistantLight
import typingsJapgolly.leaflet.leafletStrings.feDropShadow
import typingsJapgolly.leaflet.leafletStrings.feFlood
import typingsJapgolly.leaflet.leafletStrings.feFuncA
import typingsJapgolly.leaflet.leafletStrings.feFuncB
import typingsJapgolly.leaflet.leafletStrings.feFuncG
import typingsJapgolly.leaflet.leafletStrings.feFuncR
import typingsJapgolly.leaflet.leafletStrings.feGaussianBlur
import typingsJapgolly.leaflet.leafletStrings.feImage
import typingsJapgolly.leaflet.leafletStrings.feMerge
import typingsJapgolly.leaflet.leafletStrings.feMergeNode
import typingsJapgolly.leaflet.leafletStrings.feMorphology
import typingsJapgolly.leaflet.leafletStrings.feOffset
import typingsJapgolly.leaflet.leafletStrings.fePointLight
import typingsJapgolly.leaflet.leafletStrings.feSpecularLighting
import typingsJapgolly.leaflet.leafletStrings.feSpotLight
import typingsJapgolly.leaflet.leafletStrings.feTile
import typingsJapgolly.leaflet.leafletStrings.feTurbulence
import typingsJapgolly.leaflet.leafletStrings.filter
import typingsJapgolly.leaflet.leafletStrings.foreignObject
import typingsJapgolly.leaflet.leafletStrings.g
import typingsJapgolly.leaflet.leafletStrings.image
import typingsJapgolly.leaflet.leafletStrings.line
import typingsJapgolly.leaflet.leafletStrings.linearGradient
import typingsJapgolly.leaflet.leafletStrings.mask
import typingsJapgolly.leaflet.leafletStrings.metadata
import typingsJapgolly.leaflet.leafletStrings.mpath
import typingsJapgolly.leaflet.leafletStrings.path
import typingsJapgolly.leaflet.leafletStrings.pattern
import typingsJapgolly.leaflet.leafletStrings.radialGradient
import typingsJapgolly.leaflet.leafletStrings.rect
import typingsJapgolly.leaflet.leafletStrings.script
import typingsJapgolly.leaflet.leafletStrings.set
import typingsJapgolly.leaflet.leafletStrings.stop
import typingsJapgolly.leaflet.leafletStrings.style
import typingsJapgolly.leaflet.leafletStrings.switch
import typingsJapgolly.leaflet.leafletStrings.symbol
import typingsJapgolly.leaflet.leafletStrings.text
import typingsJapgolly.leaflet.leafletStrings.textPath
import typingsJapgolly.leaflet.leafletStrings.title
import typingsJapgolly.leaflet.leafletStrings.tspan
import typingsJapgolly.leaflet.leafletStrings.use
import typingsJapgolly.leaflet.leafletStrings.view
...
object SVG_ {
  ...
  inline def create_circle(name: typingsJapgolly.leaflet.leafletStrings.circle): SVGCircleElement = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[SVGCircleElement]
  ...
  inline def create_marker(name: typingsJapgolly.leaflet.leafletStrings.marker): SVGMarkerElement = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[SVGMarkerElement]
  ...
  inline def create_polygon(name: typingsJapgolly.leaflet.leafletStrings.polygon): SVGPolygonElement = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[SVGPolygonElement]
  
  inline def create_polyline(name: typingsJapgolly.leaflet.leafletStrings.polyline): SVGPolylineElement = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[SVGPolylineElement]
  ...
  inline def create_svg(name: typingsJapgolly.leaflet.leafletStrings.svg): SVGSVGElement = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[SVGSVGElement]
