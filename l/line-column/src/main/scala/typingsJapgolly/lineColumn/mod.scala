package typingsJapgolly.lineColumn
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.lineColumn.anon.Column
  */
  trait LineColumnObject extends StObject
  object LineColumnObject {
    
    inline def Column(column: Double, line: Double): typingsJapgolly.lineColumn.anon.Column = {
      val __obj = js.Dynamic.literal(column = column.asInstanceOf[js.Any], line = line.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.lineColumn.anon.Column]
    }
    
    inline def LineColumnInfo(col: Double, line: Double): typingsJapgolly.lineColumn.mod.LineColumnInfo = {
      val __obj = js.Dynamic.literal(col = col.asInstanceOf[js.Any], line = line.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.lineColumn.mod.LineColumnInfo]
    }
  }
