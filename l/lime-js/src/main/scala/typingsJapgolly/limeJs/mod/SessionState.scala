...
@js.native
open class SessionState () extends StObject
object SessionState {
  ...
  /* static member */
  @JSImport("lime-js", "SessionState.authenticating")
  @js.native
  ...
  /* static member */
  @JSImport("lime-js", "SessionState.established")
  @js.native
  ...
  /* static member */
  @JSImport("lime-js", "SessionState.failed")
  @js.native
  ...
  /* static member */
  @JSImport("lime-js", "SessionState.finished")
  @js.native
  ...
  /* static member */
  @JSImport("lime-js", "SessionState.finishing")
  @js.native
  ...
  /* static member */
  @JSImport("lime-js", "SessionState.negotiating")
  @js.native
  ...
  /* static member */
  @JSImport("lime-js", "SessionState.new")
  @js.native
