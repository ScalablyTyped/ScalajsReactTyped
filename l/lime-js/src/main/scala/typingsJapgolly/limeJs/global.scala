...
import typingsJapgolly.limeJs.mod.Session
import typingsJapgolly.limeJs.mod.Transport
...
object global {
  ...
  object Lime {
    ...
    open class Authentication ()
      extends typingsJapgolly.limeJs.mod.Authentication
    ...
    open class Channel protected ()
      extends typingsJapgolly.limeJs.mod.Channel {
    ...
    open class ClientChannel protected ()
      extends typingsJapgolly.limeJs.mod.ClientChannel {
    ...
    open class ClientChannelExtensions ()
      extends typingsJapgolly.limeJs.mod.ClientChannelExtensions
    object ClientChannelExtensions {
      ...
      inline def establishSession(
        clientChannel: typingsJapgolly.limeJs.mod.ClientChannel,
        compression: String,
        encryption: String,
        identity: String,
        authentication: typingsJapgolly.limeJs.mod.Authentication,
        instance: String,
    ...
    open class CommandMethod ()
      extends typingsJapgolly.limeJs.mod.CommandMethod
    ...
    open class CommandStatus ()
      extends typingsJapgolly.limeJs.mod.CommandStatus
    ...
    open class GuestAuthentication ()
      extends typingsJapgolly.limeJs.mod.GuestAuthentication
    
    @JSGlobal("Lime.KeyAuthentication")
    @js.native
    open class KeyAuthentication ()
      extends typingsJapgolly.limeJs.mod.KeyAuthentication
    
    @JSGlobal("Lime.NotificationEvent")
    @js.native
    open class NotificationEvent ()
      extends typingsJapgolly.limeJs.mod.NotificationEvent
    ...
    open class PlainAuthentication ()
      extends typingsJapgolly.limeJs.mod.PlainAuthentication
    
    @JSGlobal("Lime.SessionCompression")
    @js.native
    open class SessionCompression ()
      extends typingsJapgolly.limeJs.mod.SessionCompression
    ...
    open class SessionEncryption ()
      extends typingsJapgolly.limeJs.mod.SessionEncryption
    ...
    open class SessionState ()
      extends typingsJapgolly.limeJs.mod.SessionState
    object SessionState {
    ...
    open class TransportAuthentication ()
      extends typingsJapgolly.limeJs.mod.TransportAuthentication
    
    @JSGlobal("Lime.WebSocketTransport")
    @js.native
    open class WebSocketTransport ()
      extends typingsJapgolly.limeJs.mod.WebSocketTransport {
