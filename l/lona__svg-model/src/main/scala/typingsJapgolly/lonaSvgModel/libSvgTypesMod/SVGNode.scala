...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.lonaSvgModel.libSvgTypesMod.SVGRoot
  - typingsJapgolly.lonaSvgModel.libSvgTypesMod.SVGChildNode
*/
...
object SVGNode {
  ...
  inline def SVGRoot(attributes: SVGRootAttributes, children: js.Array[SVGChildNode | SVGDefs]): typingsJapgolly.lonaSvgModel.libSvgTypesMod.SVGRoot = {
    val __obj = js.Dynamic.literal(attributes = attributes.asInstanceOf[js.Any], children = children.asInstanceOf[js.Any], name = "svg")
    __obj.updateDynamic("type")("element")
    __obj.asInstanceOf[typingsJapgolly.lonaSvgModel.libSvgTypesMod.SVGRoot]
  }
