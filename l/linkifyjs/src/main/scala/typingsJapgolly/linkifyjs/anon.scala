  ...
  object PartialGlobalEventHandler {
    ...
    extension [Self <: PartialGlobalEventHandler](x: Self) {
      ...
      inline def setAddEventListener(
        value: (abort, /* listener */ js.ThisFunction1[PartialGlobalEventHandler, /* ev */ UIEvent, Any]) => Callback
      ): Self = StObject.set(x, "addEventListener", js.Any.fromFunction2((t0: abort, t1: /* listener */ js.ThisFunction1[PartialGlobalEventHandler, /* ev */ UIEvent, Any]) => (value(t0, t1)).runNow()))
      ...
      inline def setOnprogress(value: js.ThisFunction1[PartialGlobalEventHandler, /* ev */ ProgressEvent, Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
      ...
      inline def setRemoveEventListener(
        value: (abort, /* listener */ js.ThisFunction1[PartialGlobalEventHandler, /* ev */ UIEvent, Any]) => Callback
      ): Self = StObject.set(x, "removeEventListener", js.Any.fromFunction2((t0: abort, t1: /* listener */ js.ThisFunction1[PartialGlobalEventHandler, /* ev */ UIEvent, Any]) => (value(t0, t1)).runNow()))
