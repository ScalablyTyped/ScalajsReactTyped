...
import typingsJapgolly.linkifyjs.linkifyjsStrings.abort
...
object PartialGlobalEventHandler {
  @scala.inline
  def apply(
    addEventListener: (abort, /* listener */ js.ThisFunction1[PartialGlobalEventHandler, /* ev */ UIEvent, js.Any]) => Callback = null,
    ...
    removeEventListener: (abort, /* listener */ js.ThisFunction1[PartialGlobalEventHandler, /* ev */ UIEvent, js.Any]) => Callback = null
  ): PartialGlobalEventHandler = {
    val __obj = js.Dynamic.literal()
    if (addEventListener != null) __obj.updateDynamic("addEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.linkifyjs.linkifyjsStrings.abort, t1: /* listener */ js.ThisFunction1[
  typingsJapgolly.linkifyjs.PartialGlobalEventHandler, 
  /* ev */ org.scalajs.dom.raw.UIEvent, 
  js.Any]) => addEventListener(t0, t1).runNow()))
    ...
    if (removeEventListener != null) __obj.updateDynamic("removeEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.linkifyjs.linkifyjsStrings.abort, t1: /* listener */ js.ThisFunction1[
  typingsJapgolly.linkifyjs.PartialGlobalEventHandler, 
  /* ev */ org.scalajs.dom.raw.UIEvent, 
