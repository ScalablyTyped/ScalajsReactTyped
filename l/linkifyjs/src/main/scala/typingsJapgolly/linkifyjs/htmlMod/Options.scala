package typingsJapgolly.linkifyjs.htmlMod

import typingsJapgolly.linkifyjs.PartialGlobalEventHandler
...
import typingsJapgolly.linkifyjs.mod.LinkEntityType
...
trait Options
  extends typingsJapgolly.linkifyjs.mod.Options {
  /**
