...
object distEsmTokenBucketMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - scala.Double
    - typingsJapgolly.limiter.limiterStrings.second
    - typingsJapgolly.limiter.limiterStrings.sec
    - typingsJapgolly.limiter.limiterStrings.minute
    - typingsJapgolly.limiter.limiterStrings.min
    - typingsJapgolly.limiter.limiterStrings.hour
    - typingsJapgolly.limiter.limiterStrings.hr
    - typingsJapgolly.limiter.limiterStrings.day
  */
