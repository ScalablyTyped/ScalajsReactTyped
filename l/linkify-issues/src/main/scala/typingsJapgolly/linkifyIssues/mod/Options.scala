package typingsJapgolly.linkifyIssues.mod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.linkifyIssues.linkifyIssuesStrings.dom
import typingsJapgolly.linkifyIssues.linkifyIssuesStrings.string
