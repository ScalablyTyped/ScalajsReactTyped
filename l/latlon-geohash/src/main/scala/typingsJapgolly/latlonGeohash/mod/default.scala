package typingsJapgolly.latlonGeohash.mod
...
object default extends js.Object {
  ...
  object Direction extends js.Object {
    /* "E" */ val East: typingsJapgolly.latlonGeohash.mod.Geohash.Direction.East with String = js.native
    /* "N" */ val North: typingsJapgolly.latlonGeohash.mod.Geohash.Direction.North with String = js.native
    /* "S" */ val South: typingsJapgolly.latlonGeohash.mod.Geohash.Direction.South with String = js.native
    /* "W" */ val West: typingsJapgolly.latlonGeohash.mod.Geohash.Direction.West with String = js.native
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.latlonGeohash.mod.Geohash.Direction with String] = js.native
  }
