package typingsJapgolly.ltijs

import typingsJapgolly.ltijs.anon.Context
import typingsJapgolly.ltijs.libProviderProviderMod.ProviderOptions
import typingsJapgolly.ltijs.libUtilsDatabaseMod.DatabaseOptions
...
object mod {
  ...
  open class Provider protected ()
    extends typingsJapgolly.ltijs.libProviderProviderMod.Provider {
