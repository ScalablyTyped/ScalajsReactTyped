...
import typingsJapgolly.ltijs.anon.Cert
import typingsJapgolly.ltijs.anon.Method
import typingsJapgolly.ltijs.anon.SameSite
import typingsJapgolly.ltijs.libIdTokenMod.IdToken
import typingsJapgolly.ltijs.libProviderServicesDeepLinkingMod.DeepLinkingService
import typingsJapgolly.ltijs.libProviderServicesGradeServiceMod.GradeService
import typingsJapgolly.ltijs.libProviderServicesNamesAndRolesMod.NamesAndRolesService
import typingsJapgolly.ltijs.libUtilsDatabaseMod.DatabaseOptions
import typingsJapgolly.ltijs.libUtilsPlatformMod.Platform
import typingsJapgolly.ltijs.libUtilsPlatformMod.PlatformConfig
import typingsJapgolly.ltijs.ltijsBooleans.`false`
import typingsJapgolly.ltijs.ltijsBooleans.`true`
...
object libProviderProviderMod {
  ...
  open class Provider protected () extends StObject {
    ...
    var Database: typingsJapgolly.ltijs.libUtilsDatabaseMod.Database = js.native
  ...
  object ProviderOptions {
    ...
    extension [Self <: ProviderOptions](x: Self) {
      ...
      inline def setServerAddon(value: /* app */ Express => Callback): Self = StObject.set(x, "serverAddon", js.Any.fromFunction1((t0: /* app */ Express) => value(t0).runNow()))
