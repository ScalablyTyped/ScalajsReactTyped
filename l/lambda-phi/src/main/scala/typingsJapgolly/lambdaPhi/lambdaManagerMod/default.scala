...
class default () extends LambdaManager {
  ...
  /* CompleteClass */
  override def getLambdaByName(name: String): typingsJapgolly.lambdaPhi.lambdaModelMod.default = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def upsertLambdaModel(target: js.Any): typingsJapgolly.lambdaPhi.lambdaModelMod.default = js.native
}
