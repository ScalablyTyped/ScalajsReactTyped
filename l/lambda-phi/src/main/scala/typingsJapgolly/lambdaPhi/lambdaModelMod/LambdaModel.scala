package typingsJapgolly.lambdaPhi.lambdaModelMod
...
trait LambdaModel extends js.Object {
  ...
  var httpVerbs: js.Array[typingsJapgolly.lambdaPhi.httpVerbModelMod.default]
  var instance: js.Any
  var methodProperty: js.Any
  var name: js.Any
  var pathParams: js.Array[typingsJapgolly.lambdaPhi.pathParamModelMod.default]
  var pathParamsProperty: js.Any
  var paths: js.Array[typingsJapgolly.lambdaPhi.pathModelMod.default]
...
object LambdaModel {
  ...
  def apply(
    ...
    httpVerbs: js.Array[typingsJapgolly.lambdaPhi.httpVerbModelMod.default],
    instance: js.Any,
    methodProperty: js.Any,
    name: js.Any,
    pathParams: js.Array[typingsJapgolly.lambdaPhi.pathParamModelMod.default],
    pathParamsProperty: js.Any,
    paths: js.Array[typingsJapgolly.lambdaPhi.pathModelMod.default],
