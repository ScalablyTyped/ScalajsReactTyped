package typingsJapgolly.lezerHighlight
...
import typingsJapgolly.lezerCommon.mod.Tree
import typingsJapgolly.lezerHighlight.anon.All
import typingsJapgolly.lezerHighlight.anon.Class
import typingsJapgolly.lezerHighlight.anon.Inherit
