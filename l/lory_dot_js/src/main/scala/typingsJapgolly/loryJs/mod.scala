package typingsJapgolly.loryJs
...
object mod {
  ...
  object LoryOptions {
    ...
    extension [Self <: LoryOptions](x: Self) {
      ...
      inline def setAfterInit(value: CallbackTo[Any]): Self = StObject.set(x, "afterInit", value.toJsFn)
      
      inline def setAfterInitUndefined: Self = StObject.set(x, "afterInit", js.undefined)
      
      inline def setBeforeInit(value: CallbackTo[Any]): Self = StObject.set(x, "beforeInit", value.toJsFn)
      
      inline def setBeforeInitUndefined: Self = StObject.set(x, "beforeInit", js.undefined)
      
      inline def setBeforeNext(value: CallbackTo[Any]): Self = StObject.set(x, "beforeNext", value.toJsFn)
      
      inline def setBeforeNextUndefined: Self = StObject.set(x, "beforeNext", js.undefined)
      
      inline def setBeforePrev(value: CallbackTo[Any]): Self = StObject.set(x, "beforePrev", value.toJsFn)
      
      inline def setBeforePrevUndefined: Self = StObject.set(x, "beforePrev", js.undefined)
      
      inline def setBeforeResize(value: CallbackTo[Any]): Self = StObject.set(x, "beforeResize", value.toJsFn)
      
      inline def setBeforeResizeUndefined: Self = StObject.set(x, "beforeResize", js.undefined)
      
      inline def setBeforeTouch(value: CallbackTo[Any]): Self = StObject.set(x, "beforeTouch", value.toJsFn)
