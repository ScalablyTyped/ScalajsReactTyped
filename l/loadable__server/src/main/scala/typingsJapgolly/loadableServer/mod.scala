...
import typingsJapgolly.loadableServer.anon.Default
...
object mod {
  ...
  open class ChunkExtractor protected () extends StObject {
    ...
    /**
      ...
      */
    def getInlineStyleElements(): js.Promise[js.Array[japgolly.scalajs.react.facade.React.Element]] = js.native
    def getInlineStyleElements(attr: js.Object): js.Promise[js.Array[japgolly.scalajs.react.facade.React.Element]] = js.native
    def getInlineStyleElements(attr: AttrFn): js.Promise[js.Array[japgolly.scalajs.react.facade.React.Element]] = js.native
    ...
    /**
      ...
      */
    def getLinkElements(): js.Array[japgolly.scalajs.react.facade.React.Element] = js.native
    def getLinkElements(attr: js.Object): js.Array[japgolly.scalajs.react.facade.React.Element] = js.native
    def getLinkElements(attr: AttrFn): js.Array[japgolly.scalajs.react.facade.React.Element] = js.native
    ...
    /**
      ...
      */
    def getScriptElements(): js.Array[japgolly.scalajs.react.facade.React.Element] = js.native
    def getScriptElements(attr: js.Object): js.Array[japgolly.scalajs.react.facade.React.Element] = js.native
    def getScriptElements(attr: AttrFn): js.Array[japgolly.scalajs.react.facade.React.Element] = js.native
    ...
    /**
      ...
      */
    def getStyleElements(): js.Array[japgolly.scalajs.react.facade.React.Element] = js.native
    def getStyleElements(attr: js.Object): js.Array[japgolly.scalajs.react.facade.React.Element] = js.native
    def getStyleElements(attr: AttrFn): js.Array[japgolly.scalajs.react.facade.React.Element] = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.loadableServer.anon.statsFilestringentrypoint
    - typingsJapgolly.loadableServer.anon.statsobjectentrypointsstr
  */
  trait ChunkExtractorOptions extends StObject
  object ChunkExtractorOptions {
    
    inline def statsFilestringentrypoint(statsFile: String): typingsJapgolly.loadableServer.anon.statsFilestringentrypoint = {
      val __obj = js.Dynamic.literal(statsFile = statsFile.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.loadableServer.anon.statsFilestringentrypoint]
    }
    
    inline def statsobjectentrypointsstr(stats: js.Object): typingsJapgolly.loadableServer.anon.statsobjectentrypointsstr = {
      val __obj = js.Dynamic.literal(stats = stats.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.loadableServer.anon.statsobjectentrypointsstr]
    }
  }
}
