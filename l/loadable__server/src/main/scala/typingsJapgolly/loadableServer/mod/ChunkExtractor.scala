...
import typingsJapgolly.loadableServer.AnonDefault
...
class ChunkExtractor protected () extends js.Object {
  ...
  /**
  	 ...
  	 */
  def getInlineStyleElements(): js.Promise[js.Array[Element]] = js.native
  def getInlineStyleElements(attr: js.Object): js.Promise[js.Array[Element]] = js.native
  def getInlineStyleElements(attr: AttrFn): js.Promise[js.Array[Element]] = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def getLinkElements(): js.Array[Element] = js.native
  def getLinkElements(attr: js.Object): js.Array[Element] = js.native
  def getLinkElements(attr: AttrFn): js.Array[Element] = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def getScriptElements(): js.Array[Element] = js.native
  def getScriptElements(attr: js.Object): js.Array[Element] = js.native
  def getScriptElements(attr: AttrFn): js.Array[Element] = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def getStyleElements(): js.Array[Element] = js.native
  def getStyleElements(attr: js.Object): js.Array[Element] = js.native
  def getStyleElements(attr: AttrFn): js.Array[Element] = js.native
  /**
