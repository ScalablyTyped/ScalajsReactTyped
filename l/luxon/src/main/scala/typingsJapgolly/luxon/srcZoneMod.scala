...
object srcZoneMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.luxon.luxonStrings.techie
  */
  ...
  object ZoneOffsetFormat {
    ...
    inline def techie: typingsJapgolly.luxon.luxonStrings.techie = "techie".asInstanceOf[typingsJapgolly.luxon.luxonStrings.techie]
  }
