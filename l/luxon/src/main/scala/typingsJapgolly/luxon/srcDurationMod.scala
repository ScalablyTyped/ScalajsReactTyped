...
import typingsJapgolly.luxon.anon.Floor
import typingsJapgolly.luxon.luxonStrings.long
import typingsJapgolly.luxon.luxonStrings.narrow
import typingsJapgolly.luxon.luxonStrings.short
...
object srcDurationMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.luxon.srcDurationMod.Duration
    - scala.Double
    - typingsJapgolly.luxon.srcDurationMod.DurationLikeObject
  */
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.luxon.luxonStrings.year
    - typingsJapgolly.luxon.luxonStrings.quarter
    - typingsJapgolly.luxon.luxonStrings.month
    - typingsJapgolly.luxon.luxonStrings.week
    - typingsJapgolly.luxon.luxonStrings.day
    - typingsJapgolly.luxon.luxonStrings.hour
    - typingsJapgolly.luxon.luxonStrings.minute
    - typingsJapgolly.luxon.luxonStrings.second
    - typingsJapgolly.luxon.luxonStrings.millisecond
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.luxon.luxonStrings.basic
    - typingsJapgolly.luxon.luxonStrings.extended
  */
  trait ToISOFormat extends StObject
  object ToISOFormat {
    
    inline def basic: typingsJapgolly.luxon.luxonStrings.basic = "basic".asInstanceOf[typingsJapgolly.luxon.luxonStrings.basic]
    
    inline def extended: typingsJapgolly.luxon.luxonStrings.extended = "extended".asInstanceOf[typingsJapgolly.luxon.luxonStrings.extended]
  }
