...
import typingsJapgolly.luxon.anon.Separator
import typingsJapgolly.luxon.srcDatetimeMod.DateTime
import typingsJapgolly.luxon.srcDatetimeMod.DateTimeOptions
import typingsJapgolly.luxon.srcDatetimeMod.DiffOptions
import typingsJapgolly.luxon.srcDatetimeMod.ToISOTimeOptions
...
object srcIntervalMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.luxon.srcDatetimeMod.DateTime
    - typingsJapgolly.luxon.srcDatetimeMod.DateObjectUnits
    - js.Date
  */
