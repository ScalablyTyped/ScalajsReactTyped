...
object global {
  ...
  object luxon {
    ...
    open class DateTime protected ()
      extends typingsJapgolly.luxon.mod.DateTime {
    ...
    open class Duration protected ()
      extends typingsJapgolly.luxon.mod.Duration {
      /* private */ def this(config: Any) = this()
    }
    /* static members */
    object Duration {
    ...
    open class FixedOffsetZone ()
      extends typingsJapgolly.luxon.mod.FixedOffsetZone
    /* static members */
    ...
    open class IANAZone protected ()
      extends typingsJapgolly.luxon.mod.IANAZone {
    ...
    open class Interval protected ()
      extends typingsJapgolly.luxon.mod.Interval {
      /* private */ def this(config: Any) = this()
    }
    /* static members */
    object Interval {
    ...
    open class InvalidZone ()
      extends typingsJapgolly.luxon.mod.InvalidZone
    
    @JSGlobal("luxon.Settings")
    @js.native
    open class Settings ()
      extends typingsJapgolly.luxon.mod.Settings
    /* static members */
    object Settings {
    ...
    open class SystemZone ()
      extends typingsJapgolly.luxon.mod.SystemZone
    ...
    @js.native
    open class Zone ()
      extends typingsJapgolly.luxon.mod.Zone
  }
}
