...
object anon {
  ...
  trait Zone extends StObject {
    ...
    var zone: js.UndefOr[String | typingsJapgolly.luxon.srcZoneMod.Zone] = js.undefined
  }
  object Zone {
    ...
    extension [Self <: Zone](x: Self) {
      ...
      inline def setZone(value: String | typingsJapgolly.luxon.srcZoneMod.Zone): Self = StObject.set(x, "zone", value.asInstanceOf[js.Any])
