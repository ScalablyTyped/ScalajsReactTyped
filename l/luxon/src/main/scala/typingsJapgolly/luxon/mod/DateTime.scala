...
import typingsJapgolly.luxon.AnonIncludeConfig
import typingsJapgolly.std.Intl.ResolvedDateTimeFormatOptions
...
object DateTime extends js.Object {
  ...
  def fromJSDate(date: js.Date): DateTime = js.native
  def fromJSDate(date: js.Date, options: DateTimeJSOptions): DateTime = js.native
