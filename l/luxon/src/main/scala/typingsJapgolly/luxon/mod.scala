...
object mod {
  ...
  open class DateTime protected ()
    extends typingsJapgolly.luxon.srcLuxonMod.DateTime {
  ...
  open class Duration protected ()
    extends typingsJapgolly.luxon.srcLuxonMod.Duration {
    /* private */ def this(config: Any) = this()
  }
  /* static members */
  object Duration {
  ...
  open class FixedOffsetZone ()
    extends typingsJapgolly.luxon.srcLuxonMod.FixedOffsetZone
  /* static members */
  ...
  open class IANAZone protected ()
    extends typingsJapgolly.luxon.srcLuxonMod.IANAZone {
  ...
  open class Interval protected ()
    extends typingsJapgolly.luxon.srcLuxonMod.Interval {
    /* private */ def this(config: Any) = this()
  }
  /* static members */
  object Interval {
  ...
  open class InvalidZone ()
    extends typingsJapgolly.luxon.srcLuxonMod.InvalidZone
  
  @JSImport("luxon", "Settings")
  @js.native
  open class Settings ()
    extends typingsJapgolly.luxon.srcLuxonMod.Settings
  /* static members */
  object Settings {
  ...
  @JSImport("luxon", "SystemZone")
  @js.native
  open class SystemZone ()
    extends typingsJapgolly.luxon.srcLuxonMod.SystemZone
  
  @JSImport("luxon", "VERSION")
  @js.native
  val VERSION: String = js.native
  
  /* note: abstract class */ @JSImport("luxon", "Zone")
  @js.native
  open class Zone ()
    extends typingsJapgolly.luxon.srcLuxonMod.Zone
}
