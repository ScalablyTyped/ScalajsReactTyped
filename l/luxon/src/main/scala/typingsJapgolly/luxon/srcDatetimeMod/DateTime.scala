...
import typingsJapgolly.luxon.anon.IncludeConfig
import typingsJapgolly.luxon.srcDurationMod.Duration
import typingsJapgolly.luxon.srcDurationMod.DurationLike
import typingsJapgolly.luxon.srcDurationMod.DurationUnits
import typingsJapgolly.luxon.srcIntervalMod.Interval
import typingsJapgolly.luxon.srcIntervalMod._DateInput
import typingsJapgolly.luxon.srcMiscMod.DateTimeFormatOptions
import typingsJapgolly.luxon.srcMiscMod.ZoneOptions
import typingsJapgolly.luxon.srcZoneMod.Zone
...
open class DateTime protected ()
  ...
  /**
    ...
    */
  def get(
    unit: /* keyof luxon.luxon/src/datetime.DateTime */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 117, starting with typingsJapgolly.luxon.luxonStrings.now, typingsJapgolly.luxon.luxonStrings.local, typingsJapgolly.luxon.luxonStrings.utc */ Any
  ): Double = js.native
...
object DateTime {
  ...
  inline def fromJSDate(date: js.Date, options: typingsJapgolly.luxon.anon.Zone): DateTime = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJSDate")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[DateTime]
