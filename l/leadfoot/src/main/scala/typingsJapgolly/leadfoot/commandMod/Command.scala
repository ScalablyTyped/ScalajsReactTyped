...
import typingsJapgolly.dojo.dojo.promise.Thenable
import typingsJapgolly.dojo.promiseMod.Promise
import typingsJapgolly.leadfoot.AnonHeight
import typingsJapgolly.leadfoot.AnonX
import typingsJapgolly.leadfoot.leadfoot.Geolocation
import typingsJapgolly.leadfoot.leadfoot.LogEntry
import typingsJapgolly.leadfoot.leadfoot.WebDriverCookie
...
trait Command[T] extends Thenable[T] {
  ...
  /**
  		 ...
  		 * @readonly
  		 */
  var session: typingsJapgolly.leadfoot.sessionMod.^ = js.native
  /**
  ...
  def `catch`[U](
    errback: js.Function2[
      ...
      typingsJapgolly.dojo.thenableMod.Thenable[U] | U
    ]
  ): Command[U] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def doubleTap(element: typingsJapgolly.leadfoot.elementMod.^): Command[Unit] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def equals(other: typingsJapgolly.leadfoot.elementMod.^): Command[Boolean] = js.native
  ...
  /**
  		 ...
  		 */
  def find(using: String, value: String): Command[typingsJapgolly.leadfoot.elementMod.^] = js.native
  /**
  		 ...
  		 * The strategy-specific value to search for. See {@link module:leadfoot/Session#find} for details.
  		 */
  def findAll(using: String, value: String): Command[js.Array[typingsJapgolly.leadfoot.elementMod.^]] = js.native
  /**
  		 ...
  		 */
  def findAllByClassName(className: String): Command[js.Array[typingsJapgolly.leadfoot.elementMod.^]] = js.native
  /**
  		 * Gets all elements within the elements in the Command's context matching the given CSS selector.
  		 *
  		 * @param selector The CSS selector to search for.
  		 */
  def findAllByCssSelector(selector: String): Command[js.Array[typingsJapgolly.leadfoot.elementMod.^]] = js.native
  /**
  		 ...
  		 */
  def findAllByLinkText(text: String): Command[js.Array[typingsJapgolly.leadfoot.elementMod.^]] = js.native
  /**
  		 * Gets all elements within the elements in the Command's context matching the given name attribute.
  		 *
  		 * @param name The name of the element.
  		 */
  def findAllByName(name: String): Command[js.Array[typingsJapgolly.leadfoot.elementMod.^]] = js.native
  /**
  		 ...
  		 */
  def findAllByPartialLinkText(text: String): Command[js.Array[typingsJapgolly.leadfoot.elementMod.^]] = js.native
  /**
  		 * Gets all elements within the elements in the Command's context matching the given HTML tag name.
  		 *
  		 * @param tagName The tag name of the element.
  		 */
  def findAllByTagName(tagName: String): Command[js.Array[typingsJapgolly.leadfoot.elementMod.^]] = js.native
  /**
  		 ...
  		 */
  def findAllByXpath(path: String): Command[js.Array[typingsJapgolly.leadfoot.elementMod.^]] = js.native
  /**
  		 * Gets the first element within the elements in the Command's context matching the given CSS class name.
  		 *
  		 * @param className The CSS class name to search for.
  		 */
  def findByClassName(className: String): Command[typingsJapgolly.leadfoot.elementMod.^] = js.native
  /**
  		 * Gets the first element within the elements in the Command's context matching the given CSS selector.
  		 *
  		 * @param selector The CSS selector to search for.
  		 */
  def findByCssSelector(selector: String): Command[typingsJapgolly.leadfoot.elementMod.^] = js.native
  /**
  		 * Gets the first element within the elements in the Command's context matching the given ID.
  		 *
  		 * @param id The ID of the element.
  		 */
  def findById(id: String): Command[typingsJapgolly.leadfoot.elementMod.^] = js.native
  /**
  		 * Gets the first element within the elements in the Command's context matching the given case-insensitive link text.
  		 *
  		 * @param text The link text of the element.
  		 */
  def findByLinkText(text: String): Command[typingsJapgolly.leadfoot.elementMod.^] = js.native
  /**
  		 * Gets the first element within the elements in the Command's context matching the given name attribute.
  		 *
  		 * @param name The name of the element.
  		 */
  def findByName(name: String): Command[typingsJapgolly.leadfoot.elementMod.^] = js.native
  /**
  		 ...
  		 * @param text The partial link text of the element.
  		 */
  def findByPartialLinkText(text: String): Command[typingsJapgolly.leadfoot.elementMod.^] = js.native
  /**
  		 * Gets the first element within the elements in the Command's context matching the given HTML tag name.
  		 *
  		 * @param tagName The tag name of the element.
  		 */
  def findByTagName(tagName: String): Command[typingsJapgolly.leadfoot.elementMod.^] = js.native
  /**
  		 * Gets the first element within the elements in the Command's context matching the given XPath selector.
  		 *
  		 * @param path The XPath selector to search for.
  		 */
  def findByXpath(path: String): Command[typingsJapgolly.leadfoot.elementMod.^] = js.native
  /**
  		 ...
  		 */
  def flickFinger(element: typingsJapgolly.leadfoot.elementMod.^, xOffset: Double, yOffset: Double, speed: Double): Command[Unit] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def getActiveElement(): Command[typingsJapgolly.leadfoot.elementMod.^] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def longTap(element: typingsJapgolly.leadfoot.elementMod.^): Command[Unit] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def moveMouseTo(element: typingsJapgolly.leadfoot.elementMod.^): Command[Unit] = js.native
  def moveMouseTo(element: typingsJapgolly.leadfoot.elementMod.^, xOffset: Double): Command[Unit] = js.native
  def moveMouseTo(element: typingsJapgolly.leadfoot.elementMod.^, xOffset: Double, yOffset: Double): Command[Unit] = js.native
  ...
  def switchToFrame(id: typingsJapgolly.leadfoot.elementMod.^): Command[Unit] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def tap(element: typingsJapgolly.leadfoot.elementMod.^): Command[Unit] = js.native
  /**
  ...
  /**
  		 ...
  		 * the offset is relative to the previous scroll position of the window.
  		 */
  def touchScroll(element: typingsJapgolly.leadfoot.elementMod.^, xOffset: Double, yOffset: Double): Command[Unit] = js.native
