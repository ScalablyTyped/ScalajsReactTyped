package typingsJapgolly.leadfoot.serverMod
...
trait Server extends js.Object {
  ...
  var sessionConstructor: Instantiable3[
    ...
    typingsJapgolly.leadfoot.sessionMod.^
  ] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  /* protected */ def _fillCapabilities(session: typingsJapgolly.leadfoot.sessionMod.^): typingsJapgolly.leadfoot.sessionMod.^ = js.native
  /**
  		 * A function that performs an HTTP request to a JsonWireProtocol endpoint and normalises response status and
  		 * data.
  		 *
  ...
  /**
  		 ...
  		 */
  def createSession(desiredCapabilities: Capabilities): Promise[typingsJapgolly.leadfoot.sessionMod.^] = js.native
  def createSession(desiredCapabilities: Capabilities, requiredCapabilities: Capabilities): Promise[typingsJapgolly.leadfoot.sessionMod.^] = js.native
  /**
