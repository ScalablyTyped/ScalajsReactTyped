...
import typingsJapgolly.lunr.anon.Boost
import typingsJapgolly.lunr.anon.Typeoftokenizer
import typingsJapgolly.lunr.anon.`0`
import typingsJapgolly.lunr.mod.Builder.Plugin
...
import typingsJapgolly.lunr.mod.Token.UpdateFunction
