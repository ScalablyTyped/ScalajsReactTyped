...
import typingsJapgolly.linq4js.Linq4JS.OrderDirection
...
object global {
  ...
  object Linq4JS {
    ...
    open class EvaluateCommand protected ()
      extends StObject
         with typingsJapgolly.linq4js.Linq4JS.EvaluateCommand {
    ...
    open class EvaluateCommandResult protected ()
      extends StObject
         with typingsJapgolly.linq4js.Linq4JS.EvaluateCommandResult {
    ...
    open class GeneratedEntity ()
      extends StObject
         with typingsJapgolly.linq4js.Linq4JS.GeneratedEntity {
    ...
    open class Helper ()
      extends StObject
         with typingsJapgolly.linq4js.Linq4JS.Helper
    object Helper {
      ...
      @js.native
      def Commands: Array[typingsJapgolly.linq4js.Linq4JS.EvaluateCommand] = js.native
      inline def Commands_=(x: Array[typingsJapgolly.linq4js.Linq4JS.EvaluateCommand]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Commands")(x.asInstanceOf[js.Any])
      ...
      /* static member */
      inline def MatchCommand(cmd: String): typingsJapgolly.linq4js.Linq4JS.EvaluateCommandResult = ^.asInstanceOf[js.Dynamic].applyDynamic("MatchCommand")(cmd.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.linq4js.Linq4JS.EvaluateCommandResult]
    ...
    object OrderDirection extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.linq4js.Linq4JS.OrderDirection & Double] = js.native
      
      /* 0 */ val Ascending: typingsJapgolly.linq4js.Linq4JS.OrderDirection.Ascending & Double = js.native
      
      /* 1 */ val Descending: typingsJapgolly.linq4js.Linq4JS.OrderDirection.Descending & Double = js.native
    }
    ...
    open class OrderEntry protected ()
      extends StObject
         with typingsJapgolly.linq4js.Linq4JS.OrderEntry {
    ...
    open class SelectEntry protected ()
      extends StObject
         with typingsJapgolly.linq4js.Linq4JS.SelectEntry {
