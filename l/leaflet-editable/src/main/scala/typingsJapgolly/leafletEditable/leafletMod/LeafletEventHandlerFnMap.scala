...
object LeafletEventHandlerFnMap {
  ...
  extension [Self <: LeafletEventHandlerFnMap](x: Self) {
    ...
    inline def setEditableColoncreated(value: /* event */ LayerEvent => Callback): Self = StObject.set(x, "editable:created", js.Any.fromFunction1((t0: /* event */ LayerEvent) => value(t0).runNow()))
    
    inline def setEditableColoncreatedUndefined: Self = StObject.set(x, "editable:created", js.undefined)
    
    inline def setEditableColondisable(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:disable", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColondisableUndefined: Self = StObject.set(x, "editable:disable", js.undefined)
    
    inline def setEditableColondrag(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:drag", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColondragUndefined: Self = StObject.set(x, "editable:drag", js.undefined)
    
    inline def setEditableColondragend(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:dragend", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColondragendUndefined: Self = StObject.set(x, "editable:dragend", js.undefined)
    
    inline def setEditableColondragstart(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:dragstart", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColondragstartUndefined: Self = StObject.set(x, "editable:dragstart", js.undefined)
    
    inline def setEditableColondrawingColoncancel(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:drawing:cancel", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColondrawingColoncancelUndefined: Self = StObject.set(x, "editable:drawing:cancel", js.undefined)
    
    inline def setEditableColondrawingColonclick(value: /* event */ CancelableEvent => Callback): Self = StObject.set(x, "editable:drawing:click", js.Any.fromFunction1((t0: /* event */ CancelableEvent) => value(t0).runNow()))
    
    inline def setEditableColondrawingColonclickUndefined: Self = StObject.set(x, "editable:drawing:click", js.undefined)
    
    inline def setEditableColondrawingColonclicked(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:drawing:clicked", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColondrawingColonclickedUndefined: Self = StObject.set(x, "editable:drawing:clicked", js.undefined)
    
    inline def setEditableColondrawingColoncommit(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:drawing:commit", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColondrawingColoncommitUndefined: Self = StObject.set(x, "editable:drawing:commit", js.undefined)
    
    inline def setEditableColondrawingColonend(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:drawing:end", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColondrawingColonendUndefined: Self = StObject.set(x, "editable:drawing:end", js.undefined)
    
    inline def setEditableColondrawingColonmousedown(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:drawing:mousedown", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColondrawingColonmousedownUndefined: Self = StObject.set(x, "editable:drawing:mousedown", js.undefined)
    
    inline def setEditableColondrawingColonmouseup(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:drawing:mouseup", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColondrawingColonmouseupUndefined: Self = StObject.set(x, "editable:drawing:mouseup", js.undefined)
    
    inline def setEditableColondrawingColonmove(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:drawing:move", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColondrawingColonmoveUndefined: Self = StObject.set(x, "editable:drawing:move", js.undefined)
    
    inline def setEditableColondrawingColonstart(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:drawing:start", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColondrawingColonstartUndefined: Self = StObject.set(x, "editable:drawing:start", js.undefined)
    
    inline def setEditableColonediting(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:editing", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColoneditingUndefined: Self = StObject.set(x, "editable:editing", js.undefined)
    
    inline def setEditableColonenable(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "editable:enable", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
    
    inline def setEditableColonenableUndefined: Self = StObject.set(x, "editable:enable", js.undefined)
    
    inline def setEditableColonmiddlemarkerColonmousedown(value: /* event */ VertexEvent => Callback): Self = StObject.set(x, "editable:middlemarker:mousedown", js.Any.fromFunction1((t0: /* event */ VertexEvent) => value(t0).runNow()))
    ...
    inline def setEditableColonshapeColondelete(value: /* event */ CancelableShapeEvent => Callback): Self = StObject.set(x, "editable:shape:delete", js.Any.fromFunction1((t0: /* event */ CancelableShapeEvent) => value(t0).runNow()))
    
    inline def setEditableColonshapeColondeleteUndefined: Self = StObject.set(x, "editable:shape:delete", js.undefined)
    
    inline def setEditableColonshapeColondeleted(value: /* event */ ShapeEvent => Callback): Self = StObject.set(x, "editable:shape:deleted", js.Any.fromFunction1((t0: /* event */ ShapeEvent) => value(t0).runNow()))
    
    inline def setEditableColonshapeColondeletedUndefined: Self = StObject.set(x, "editable:shape:deleted", js.undefined)
    
    inline def setEditableColonshapeColonnew(value: /* event */ ShapeEvent => Callback): Self = StObject.set(x, "editable:shape:new", js.Any.fromFunction1((t0: /* event */ ShapeEvent) => value(t0).runNow()))
    
    inline def setEditableColonshapeColonnewUndefined: Self = StObject.set(x, "editable:shape:new", js.undefined)
    
    inline def setEditableColonvertexColonaltclick(value: /* event */ VertexEvent => Callback): Self = StObject.set(x, "editable:vertex:altclick", js.Any.fromFunction1((t0: /* event */ VertexEvent) => value(t0).runNow()))
    
    inline def setEditableColonvertexColonaltclickUndefined: Self = StObject.set(x, "editable:vertex:altclick", js.undefined)
    
    inline def setEditableColonvertexColonclick(value: /* event */ CancelableVertexEvent => Callback): Self = StObject.set(x, "editable:vertex:click", js.Any.fromFunction1((t0: /* event */ CancelableVertexEvent) => value(t0).runNow()))
    
    inline def setEditableColonvertexColonclickUndefined: Self = StObject.set(x, "editable:vertex:click", js.undefined)
    
    inline def setEditableColonvertexColonclicked(value: /* event */ VertexEvent => Callback): Self = StObject.set(x, "editable:vertex:clicked", js.Any.fromFunction1((t0: /* event */ VertexEvent) => value(t0).runNow()))
    
    inline def setEditableColonvertexColonclickedUndefined: Self = StObject.set(x, "editable:vertex:clicked", js.undefined)
    
    inline def setEditableColonvertexColoncontextmenu(value: /* event */ VertexEvent => Callback): Self = StObject.set(x, "editable:vertex:contextmenu", js.Any.fromFunction1((t0: /* event */ VertexEvent) => value(t0).runNow()))
    
    inline def setEditableColonvertexColoncontextmenuUndefined: Self = StObject.set(x, "editable:vertex:contextmenu", js.undefined)
    
    inline def setEditableColonvertexColonctrlclick(value: /* event */ VertexEvent => Callback): Self = StObject.set(x, "editable:vertex:ctrlclick", js.Any.fromFunction1((t0: /* event */ VertexEvent) => value(t0).runNow()))
    
    inline def setEditableColonvertexColonctrlclickUndefined: Self = StObject.set(x, "editable:vertex:ctrlclick", js.undefined)
    
    inline def setEditableColonvertexColondeleted(value: /* event */ VertexEvent => Callback): Self = StObject.set(x, "editable:vertex:deleted", js.Any.fromFunction1((t0: /* event */ VertexEvent) => value(t0).runNow()))
    
    inline def setEditableColonvertexColondeletedUndefined: Self = StObject.set(x, "editable:vertex:deleted", js.undefined)
    
    inline def setEditableColonvertexColondrag(value: /* event */ VertexEvent => Callback): Self = StObject.set(x, "editable:vertex:drag", js.Any.fromFunction1((t0: /* event */ VertexEvent) => value(t0).runNow()))
    
    inline def setEditableColonvertexColondragUndefined: Self = StObject.set(x, "editable:vertex:drag", js.undefined)
    
    inline def setEditableColonvertexColondragend(value: /* event */ VertexEvent => Callback): Self = StObject.set(x, "editable:vertex:dragend", js.Any.fromFunction1((t0: /* event */ VertexEvent) => value(t0).runNow()))
    
    inline def setEditableColonvertexColondragendUndefined: Self = StObject.set(x, "editable:vertex:dragend", js.undefined)
    
    inline def setEditableColonvertexColondragstart(value: /* event */ VertexEvent => Callback): Self = StObject.set(x, "editable:vertex:dragstart", js.Any.fromFunction1((t0: /* event */ VertexEvent) => value(t0).runNow()))
    
    inline def setEditableColonvertexColondragstartUndefined: Self = StObject.set(x, "editable:vertex:dragstart", js.undefined)
    
    inline def setEditableColonvertexColonmetakeyclick(value: /* event */ VertexEvent => Callback): Self = StObject.set(x, "editable:vertex:metakeyclick", js.Any.fromFunction1((t0: /* event */ VertexEvent) => value(t0).runNow()))
    ...
    inline def setEditableColonvertexColonmousedown(value: /* event */ VertexEvent => Callback): Self = StObject.set(x, "editable:vertex:mousedown", js.Any.fromFunction1((t0: /* event */ VertexEvent) => value(t0).runNow()))
    
    inline def setEditableColonvertexColonmousedownUndefined: Self = StObject.set(x, "editable:vertex:mousedown", js.undefined)
    
    inline def setEditableColonvertexColonnew(value: /* event */ VertexEvent => Callback): Self = StObject.set(x, "editable:vertex:new", js.Any.fromFunction1((t0: /* event */ VertexEvent) => value(t0).runNow()))
    
    inline def setEditableColonvertexColonnewUndefined: Self = StObject.set(x, "editable:vertex:new", js.undefined)
    
    inline def setEditableColonvertexColonrawclick(value: /* event */ CancelableVertexEvent => Callback): Self = StObject.set(x, "editable:vertex:rawclick", js.Any.fromFunction1((t0: /* event */ CancelableVertexEvent) => value(t0).runNow()))
    
    inline def setEditableColonvertexColonrawclickUndefined: Self = StObject.set(x, "editable:vertex:rawclick", js.undefined)
    
    inline def setEditableColonvertexColonshiftclick(value: /* event */ VertexEvent => Callback): Self = StObject.set(x, "editable:vertex:shiftclick", js.Any.fromFunction1((t0: /* event */ VertexEvent) => value(t0).runNow()))
