...
import typingsJapgolly.libp2pInterfaceDht.libp2pInterfaceDhtStrings.PEER_RESPONSE
...
trait PeerResponseEvent
  ...
  var `type`: typingsJapgolly.libp2pInterfaceDht.mod.EventTypes.PEER_RESPONSE
}
object PeerResponseEvent {
  ...
  inline def apply(
    ...
    `type`: typingsJapgolly.libp2pInterfaceDht.mod.EventTypes.PEER_RESPONSE
  ): PeerResponseEvent = {
  ...
  extension [Self <: PeerResponseEvent](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.libp2pInterfaceDht.mod.EventTypes.PEER_RESPONSE): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
