package typingsJapgolly.libp2pInterfaceKeys

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.libp2pInterfaceKeys.libp2pInterfaceKeysStrings.`pkcs-8`
...
object mod {
  ...
  object PublicKey {
    ...
    inline def apply(
      ...
      hash: CallbackTo[js.Promise[js.typedarray.Uint8Array]],
      marshal: CallbackTo[js.typedarray.Uint8Array],
      verify: (js.typedarray.Uint8Array, js.typedarray.Uint8Array) => js.Promise[Boolean]
    ): PublicKey = {
      val __obj = js.Dynamic.literal(bytes = bytes.asInstanceOf[js.Any], hash = hash.toJsFn, marshal = marshal.toJsFn, verify = js.Any.fromFunction2(verify))
    ...
    extension [Self <: PublicKey](x: Self) {
      ...
      inline def setHash(value: CallbackTo[js.Promise[js.typedarray.Uint8Array]]): Self = StObject.set(x, "hash", value.toJsFn)
