...
import typingsJapgolly.leafletGeocoderMapzen.leafletMod.Control_.Geocoder
import typingsJapgolly.leafletGeocoderMapzen.leafletMod.Control_.GeocoderOptions
...
object leafletMod {
  ...
  object Control_ {
    ...
    type Geocoder = typingsJapgolly.leaflet.mod.Control_
