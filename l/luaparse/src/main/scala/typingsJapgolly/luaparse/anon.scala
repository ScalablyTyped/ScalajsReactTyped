...
object anon {
  ...
  object PartialOptions {
    ...
    extension [Self <: PartialOptions](x: Self) {
      ...
      inline def setOnLocalDeclaration(value: /* identifier */ Identifier => Callback): Self = StObject.set(x, "onLocalDeclaration", js.Any.fromFunction1((t0: /* identifier */ Identifier) => value(t0).runNow()))
