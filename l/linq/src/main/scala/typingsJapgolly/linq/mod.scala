...
import typingsJapgolly.linq.anon.Dictx
import typingsJapgolly.linq.anon.DictxLength
import typingsJapgolly.linq.anon.DictxNumberT
import typingsJapgolly.linq.anon.DictxNumberTInner
import typingsJapgolly.linq.anon.DictxNumberTResult
import typingsJapgolly.linq.anon.Key
import typingsJapgolly.linq.anon.Length
import typingsJapgolly.linq.anon.Value
import typingsJapgolly.linq.mod.Enumerable.IEnumerable
import typingsJapgolly.linq.mod.Enumerable.IEnumerator
  ...
  object Enumerable {
    ...
    object IDictionary {
      ...
      inline def apply[TKey, TValue](
        ...
        toEnumerable: CallbackTo[IEnumerable[Key[TKey, TValue]]]
      ): IDictionary[TKey, TValue] = {
        val __obj = js.Dynamic.literal(add = js.Any.fromFunction2((t0: TKey, t1: TValue) => (add(t0, t1)).runNow()), clear = clear.toJsFn, contains = js.Any.fromFunction1(contains), count = count.toJsFn, get = js.Any.fromFunction1(get), remove = js.Any.fromFunction1((t0: TKey) => remove(t0).runNow()), set = js.Any.fromFunction2(set), toEnumerable = toEnumerable.toJsFn)
      ...
      extension [Self <: IDictionary[?, ?], TKey, TValue](x: Self & (IDictionary[TKey, TValue])) {
        ...
        inline def setRemove(value: TKey => Callback): Self = StObject.set(x, "remove", js.Any.fromFunction1((t0: TKey) => value(t0).runNow()))
        
        inline def setSet(value: (TKey, TValue) => Boolean): Self = StObject.set(x, "set", js.Any.fromFunction2(value))
        
        inline def setToEnumerable(value: CallbackTo[IEnumerable[Key[TKey, TValue]]]): Self = StObject.set(x, "toEnumerable", value.toJsFn)
      }
    }
    ...
    object IEnumerator {
      ...
      inline def apply[T](current: CallbackTo[T], dispose: Callback, moveNext: CallbackTo[Boolean]): IEnumerator[T] = {
        val __obj = js.Dynamic.literal(current = current.toJsFn, dispose = dispose.toJsFn, moveNext = moveNext.toJsFn)
    ...
    object ILookup {
      ...
      inline def apply[TKey, TElement](
        ...
        val __obj = js.Dynamic.literal(contains = js.Any.fromFunction1(contains), count = count.toJsFn, get = js.Any.fromFunction1(get), toEnumerable = toEnumerable.toJsFn)
      ...
      extension [Self <: ILookup[?, ?], TKey, TElement](x: Self & (ILookup[TKey, TElement])) {
        ...
        inline def setToEnumerable(value: CallbackTo[IEnumerable[IGrouping[TKey, TElement]]]): Self = StObject.set(x, "toEnumerable", value.toJsFn)
      }
    }
