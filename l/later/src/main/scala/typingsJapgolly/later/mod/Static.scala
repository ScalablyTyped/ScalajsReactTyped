...
object Static {
  ...
  def apply(
    ...
    month: TimePeriod,
    parse: ParseStatic,
    schedule: js.Any => CallbackTo[Schedule],
    second: TimePeriod,
    setInterval: (js.Function0[Unit], ScheduleData) => CallbackTo[Timer],
    setTimeout: (js.Function0[Unit], ScheduleData) => CallbackTo[Timer],
    time: TimePeriod,
    weekOfMonth: TimePeriod,
    weekOfYear: TimePeriod,
    year: TimePeriod
  ): Static = {
    val __obj = js.Dynamic.literal(date = date.asInstanceOf[js.Any], day = day.asInstanceOf[js.Any], dayOfWeek = dayOfWeek.asInstanceOf[js.Any], dayOfWeekCount = dayOfWeekCount.asInstanceOf[js.Any], dayOfYear = dayOfYear.asInstanceOf[js.Any], hour = hour.asInstanceOf[js.Any], minute = minute.asInstanceOf[js.Any], modifier = modifier.asInstanceOf[js.Any], month = month.asInstanceOf[js.Any], parse = parse.asInstanceOf[js.Any], second = second.asInstanceOf[js.Any], time = time.asInstanceOf[js.Any], weekOfMonth = weekOfMonth.asInstanceOf[js.Any], weekOfYear = weekOfYear.asInstanceOf[js.Any], year = year.asInstanceOf[js.Any])
    __obj.updateDynamic("schedule")(js.Any.fromFunction1((t0: js.Any) => schedule(t0).runNow()))
    __obj.updateDynamic("setInterval")(js.Any.fromFunction2((t0: js.Function0[scala.Unit], t1: typingsJapgolly.later.mod.ScheduleData) => setInterval(t0, t1).runNow()))
    __obj.updateDynamic("setTimeout")(js.Any.fromFunction2((t0: js.Function0[scala.Unit], t1: typingsJapgolly.later.mod.ScheduleData) => setTimeout(t0, t1).runNow()))
