...
object mod extends Shortcut {
  ...
  object DateProvider {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(UTC = UTC.toJsFn, localTime = localTime.toJsFn, next = js.Any.fromFunction6(next), nextRollover = js.Any.fromFunction4(nextRollover), prev = js.Any.fromFunction6(prev), prevRollover = js.Any.fromFunction4(prevRollover))
      __obj.asInstanceOf[DateProvider]
    }
    
    extension [Self <: DateProvider](x: Self) {
      
      inline def setLocalTime(value: Callback): Self = StObject.set(x, "localTime", value.toJsFn)
      ...
      inline def setUTC(value: Callback): Self = StObject.set(x, "UTC", value.toJsFn)
    }
  }
  ...
  object Timer {
    ...
    inline def apply(clear: Callback): Timer = {
