...
import typingsJapgolly.logfmt.anon.ContentType
import typingsJapgolly.logfmt.anon.Contentlength
import typingsJapgolly.logfmt.anon.Delimiter
import typingsJapgolly.logfmt.anon.End
...
object mod extends Shortcut {
  ...
  object WritableStream {
    ...
    inline def apply(write: String => Callback): WritableStream = {
