...
import typingsJapgolly.log4javascript.anon.AppendResult
import typingsJapgolly.log4javascript.anon.Name
...
object mod {
  ...
  object Level extends StObject {
    ...
    sealed trait ALL
      extends StObject
         with Level
    /* 0 */ val ALL: typingsJapgolly.log4javascript.mod.Level.ALL & Double = js.native
    
    @js.native
    sealed trait DEBUG
      extends StObject
         with Level
    /* 2 */ val DEBUG: typingsJapgolly.log4javascript.mod.Level.DEBUG & Double = js.native
    
    @js.native
    sealed trait ERROR
      extends StObject
         with Level
    /* 5 */ val ERROR: typingsJapgolly.log4javascript.mod.Level.ERROR & Double = js.native
    
    @js.native
    sealed trait FATAL
      extends StObject
         with Level
    /* 6 */ val FATAL: typingsJapgolly.log4javascript.mod.Level.FATAL & Double = js.native
    
    @js.native
    sealed trait INFO
      extends StObject
         with Level
    /* 3 */ val INFO: typingsJapgolly.log4javascript.mod.Level.INFO & Double = js.native
    
    @js.native
    sealed trait OFF
      extends StObject
         with Level
    /* 7 */ val OFF: typingsJapgolly.log4javascript.mod.Level.OFF & Double = js.native
    
    @js.native
    sealed trait TRACE
      extends StObject
         with Level
    /* 1 */ val TRACE: typingsJapgolly.log4javascript.mod.Level.TRACE & Double = js.native
    
    @js.native
    sealed trait WARN
      extends StObject
         with Level
    /* 4 */ val WARN: typingsJapgolly.log4javascript.mod.Level.WARN & Double = js.native
  }
