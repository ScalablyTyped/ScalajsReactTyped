package typingsJapgolly.leafletMarkerclusterLayersupport

import typingsJapgolly.leaflet.mod.Layer
import typingsJapgolly.leafletMarkercluster.leafletMod.MarkerClusterGroupOptions
import typingsJapgolly.leafletMarkerclusterLayersupport.leafletMod.MarkerClusterGroup_.LayerSupport
...
object leafletMod {
  ...
  object MarkerClusterGroup_ {
    ...
    @js.native
    trait LayerSupport
      extends typingsJapgolly.leafletMarkercluster.leafletMod.MarkerClusterGroup_ {
