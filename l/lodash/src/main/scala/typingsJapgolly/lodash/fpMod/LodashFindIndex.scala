...
trait LodashFindIndex extends StObject {
  ...
  def apply[T](predicate: ValueIterateeCustom[T, Boolean], array: typingsJapgolly.lodash.mod.List[T]): Double = js.native
  def apply[T](predicate: __): LodashFindIndex1x2[T] = js.native
  def apply[T](predicate: __, array: typingsJapgolly.lodash.mod.List[T]): LodashFindIndex1x2[T] = js.native
}
