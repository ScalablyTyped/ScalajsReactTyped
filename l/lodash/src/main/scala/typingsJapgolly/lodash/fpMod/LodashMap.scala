...
trait LodashMap extends StObject {
  ...
  def apply[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashMap2x2[T] = js.native
  ...
  def apply[T, TResult](iteratee: js.Function1[/* value */ T, TResult], collection: typingsJapgolly.lodash.mod.List[T]): js.Array[TResult] = js.native
}
