...
trait LodashPropOr1x1[TDefault] extends js.Object {
  ...
  def apply[TObject /* <: js.Object */, TKey /* <: String */](path: TKey): LodashPropOr1x3[TObject, TKey, TDefault] = js.native
  ...
  def apply[TObject /* <: js.Object */, TKey /* <: String */](path: js.Array[TKey]): LodashPropOr1x3[TObject, TKey, TDefault] = js.native
  def apply[TObject /* <: js.Object */, TKey /* <: String */](path: js.Array[TKey], `object`: TObject): (Exclude[
    /* import warning: importer.ImportType#apply Failed type conversion: TObject[TKey] */ js.Any, 
    js.UndefOr[scala.Nothing]
  ]) | TDefault = js.native
  def apply[TObject /* <: js.Object */, TKey1 /* <: String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](path: js.Tuple2[TKey1, TKey2]): LodashPropOr2x3[TObject, TKey1, TKey2, TDefault] = js.native
