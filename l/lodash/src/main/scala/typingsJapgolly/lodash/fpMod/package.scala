...
package object fpMod {
  ...
  type LodashAssignAllWith1x2 = js.Function1[/* customizer */ typingsJapgolly.lodash.mod.AssignCustomizer, js.Any]
  ...
  type LodashAssignInAllWith1x2 = js.Function1[/* customizer */ typingsJapgolly.lodash.mod.AssignCustomizer, js.Any]
  ...
  type LodashAssignInWith1x6[TObject, TSource] = js.Function1[/* customizer */ typingsJapgolly.lodash.mod.AssignCustomizer, TObject with TSource]
  ...
  type LodashAssignWith1x6[TObject, TSource] = js.Function1[/* customizer */ typingsJapgolly.lodash.mod.AssignCustomizer, TObject with TSource]
  type LodashAt1x1 = js.Function1[
    /* object */ js.UndefOr[
      typingsJapgolly.lodash.mod.List[js.Any] | typingsJapgolly.lodash.mod.Dictionary[js.Any] | typingsJapgolly.lodash.mod.NumericDictionary[js.Any] | scala.Null
    ], 
    js.Array[js.Any]
  ]
  type LodashAt1x2[T] = js.Function1[/* props */ typingsJapgolly.lodash.mod.PropertyPath, js.Array[T]]
  ...
  type LodashAt2x2[T] = js.Function1[
    /* props */ typingsJapgolly.lodash.mod.Many[java.lang.String], 
    js.Array[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ]
  ]
  ...
  type LodashBindAll1x2[T] = js.Function1[/* methodNames */ typingsJapgolly.lodash.mod.Many[java.lang.String], T]
  ...
  type LodashCastArray = js.Function1[/* value */ typingsJapgolly.lodash.mod.Many[js.Any], js.Array[js.Any]]
  type LodashCeil = js.Function1[/* n */ scala.Double, scala.Double]
  type LodashChunk1x1 = js.Function1[
    /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[js.Any] | scala.Null], 
  ...
  type LodashCloneDeepWith1x2[T] = js.Function1[/* customizer */ typingsJapgolly.lodash.mod.CloneDeepWithCustomizer[T], js.Any]
  ...
  type LodashCompact = js.Function1[
    /* array */ js.UndefOr[
      (typingsJapgolly.lodash.mod.List[
        js.UndefOr[
          js.Any | scala.Null | typingsJapgolly.lodash.lodashBooleans.`false` | typingsJapgolly.lodash.lodashStrings._empty | typingsJapgolly.lodash.lodashNumbers.`0`
        ]
      ]) | scala.Null
    ], 
    js.Array[js.Any]
  ]
  type LodashConcat1x1[T] = js.Function1[/* values */ typingsJapgolly.lodash.mod.Many[T], js.Array[T]]
  type LodashConcat1x2[T] = js.Function1[/* array */ typingsJapgolly.lodash.mod.Many[T], js.Array[T]]
  type LodashCond = js.Function1[
    /* pairs */ js.Array[typingsJapgolly.lodash.mod.CondPair[js.Any, js.Any]], 
    js.Function1[/* Target */ js.Any, js.Any]
  ]
  type LodashConformsTo1x1[T] = js.Function1[/* object */ T, scala.Boolean]
  type LodashConformsTo1x2[T] = js.Function1[/* source */ typingsJapgolly.lodash.mod.ConformsPredicateObject[T], scala.Boolean]
  ...
  type LodashContains1x1[T] = js.Function1[
    /* collection */ js.UndefOr[
      typingsJapgolly.lodash.mod.List[T] | typingsJapgolly.lodash.mod.Dictionary[T] | typingsJapgolly.lodash.mod.NumericDictionary[T] | scala.Null
    ], 
    scala.Boolean
  ]
  type LodashContains1x2[T] = js.Function1[/* target */ T, scala.Boolean]
  type LodashCountBy1x1[T] = js.Function1[
    /* collection */ js.UndefOr[typingsJapgolly.lodash.mod.List[T] | js.Object | scala.Null], 
    typingsJapgolly.lodash.mod.Dictionary[scala.Double]
  ]
  type LodashCountBy1x2[T] = js.Function1[
    /* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T], 
    typingsJapgolly.lodash.mod.Dictionary[scala.Double]
  ]
  type LodashCountBy2x2[T] = js.Function1[
    /* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ], 
    typingsJapgolly.lodash.mod.Dictionary[scala.Double]
  ]
  type LodashCreate = js.Function1[/* prototype */ js.Object, js.Object]
  type LodashCurryN1x2[T1, R] = js.Function1[/* arity */ scala.Double, typingsJapgolly.lodash.mod.CurriedFunction1[T1, R]]
  type LodashCurryN2x2[T1, T2, R] = js.Function1[/* arity */ scala.Double, typingsJapgolly.lodash.mod.CurriedFunction2[T1, T2, R]]
  type LodashCurryN3x2[T1, T2, T3, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsJapgolly.lodash.mod.CurriedFunction3[T1, T2, T3, R]
  ]
  type LodashCurryN4x2[T1, T2, T3, T4, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsJapgolly.lodash.mod.CurriedFunction4[T1, T2, T3, T4, R]
  ]
  type LodashCurryN5x2[T1, T2, T3, T4, T5, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsJapgolly.lodash.mod.CurriedFunction5[T1, T2, T3, T4, T5, R]
  ]
  type LodashCurryN6x2 = js.Function1[/* arity */ scala.Double, js.Function1[/* repeated */ js.Any, js.Any]]
  type LodashCurryRightN1x2[T1, R] = js.Function1[/* arity */ scala.Double, typingsJapgolly.lodash.mod.RightCurriedFunction1[T1, R]]
  type LodashCurryRightN2x2[T1, T2, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsJapgolly.lodash.mod.RightCurriedFunction2[T1, T2, R]
  ]
  type LodashCurryRightN3x2[T1, T2, T3, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsJapgolly.lodash.mod.RightCurriedFunction3[T1, T2, T3, R]
  ]
  type LodashCurryRightN4x2[T1, T2, T3, T4, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsJapgolly.lodash.mod.RightCurriedFunction4[T1, T2, T3, T4, R]
  ]
  type LodashCurryRightN5x2[T1, T2, T3, T4, T5, R] = js.Function1[
    /* arity */ scala.Double, 
    typingsJapgolly.lodash.mod.RightCurriedFunction5[T1, T2, T3, T4, T5, R]
  ]
  ...
  type LodashDebounce1x1 = js.Function1[
    /* func */ js.Function1[/* repeated */ js.Any, js.Any], 
    (js.Function1[/* repeated */ js.Any, _]) with typingsJapgolly.lodash.mod.Cancelable
  ]
  type LodashDebounce1x2[T] = js.Function1[/* wait */ scala.Double, T with typingsJapgolly.lodash.mod.Cancelable]
  ...
  type LodashDifference1x1[T] = js.Function1[/* values */ typingsJapgolly.lodash.mod.List[T], js.Array[T]]
  type LodashDifference1x2[T] = js.Function1[
    /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashDifferenceBy1x3[T1, T2] = js.Function1[/* values */ typingsJapgolly.lodash.mod.List[T2], js.Array[T1]]
  type LodashDifferenceBy1x5[T1] = js.Function1[
    /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[T1] | scala.Null], 
    js.Array[T1]
  ]
  type LodashDifferenceBy1x6[T1, T2] = js.Function1[/* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T1 | T2], js.Array[T1]]
  type LodashDifferenceWith1x3[T1, T2] = js.Function1[/* values */ typingsJapgolly.lodash.mod.List[T2], js.Array[T1]]
  type LodashDifferenceWith1x5[T1] = js.Function1[
    /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[T1] | scala.Null], 
    js.Array[T1]
  ]
  type LodashDifferenceWith1x6[T1, T2] = js.Function1[/* comparator */ typingsJapgolly.lodash.mod.Comparator2[T1, T2], js.Array[T1]]
  ...
  type LodashDropRightWhile1x2[T] = js.Function1[/* predicate */ typingsJapgolly.lodash.mod.ValueIteratee[T], js.Array[T]]
  type LodashDropWhile1x1[T] = js.Function1[
    /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashDropWhile1x2[T] = js.Function1[/* predicate */ typingsJapgolly.lodash.mod.ValueIteratee[T], js.Array[T]]
  ...
  type LodashEvery1x2[T] = js.Function1[
    /* predicate */ typingsJapgolly.lodash.mod.ValueIterateeCustom[T, scala.Boolean], 
    scala.Boolean
  ]
  type LodashEvery2x2[T] = js.Function1[
    /* predicate */ typingsJapgolly.lodash.mod.ValueIterateeCustom[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      scala.Boolean
    ], 
    scala.Boolean
  ...
  type LodashExtendAllWith1x2 = js.Function1[/* customizer */ typingsJapgolly.lodash.mod.AssignCustomizer, js.Any]
  ...
  type LodashExtendWith1x6[TObject, TSource] = js.Function1[/* customizer */ typingsJapgolly.lodash.mod.AssignCustomizer, TObject with TSource]
  ...
  type LodashFill2x11[U] = js.Function1[/* value */ js.Any, typingsJapgolly.lodash.mod.List[js.Any | U]]
  type LodashFill2x13[T, U] = js.Function1[/* end */ scala.Double, typingsJapgolly.lodash.mod.List[T | U]]
  type LodashFill2x14[T, U] = js.Function1[/* start */ scala.Double, typingsJapgolly.lodash.mod.List[T | U]]
  type LodashFilter1x1[T, S] = js.Function1[
    /* collection */ js.UndefOr[typingsJapgolly.lodash.mod.List[T] | scala.Null], 
    js.Array[S]
  ]
  ...
  type LodashFindKey1x2[T] = js.Function1[
    /* predicate */ typingsJapgolly.lodash.mod.ValueIteratee[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ], 
  ...
  type LodashFlatMap1x2[T] = js.Function1[
    /* iteratee */ js.Function1[/* value */ T, typingsJapgolly.lodash.mod.Many[js.Any]], 
    js.Array[js.Any]
  ]
  ...
  type LodashFlatMap2x2[T] = js.Function1[
    /* iteratee */ js.Function1[
      ...
      typingsJapgolly.lodash.mod.Many[js.Any]
    ], 
    js.Array[js.Any]
  ]
  ...
  type LodashFlatMapDeep1x2[T] = js.Function1[
    /* iteratee */ js.Function1[
      /* value */ T, 
      typingsJapgolly.lodash.mod.ListOfRecursiveArraysOrValues[js.Any] | js.Any
    ], 
    js.Array[js.Any]
  ]
  ...
  type LodashFlatten = js.Function1[
    /* array */ js.UndefOr[
      typingsJapgolly.lodash.mod.List[typingsJapgolly.lodash.mod.Many[js.Any]] | scala.Null
    ], 
    js.Array[js.Any]
  ]
  type LodashFlattenDeep = js.Function1[
    /* array */ js.UndefOr[typingsJapgolly.lodash.mod.ListOfRecursiveArraysOrValues[js.Any] | scala.Null], 
    js.Array[js.Any]
  ]
  ...
  type LodashGet8x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.UndefOr[scala.Nothing]]
  type LodashGet9x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  ...
  type LodashGetOr5x3[TDefault] = js.Function1[
    /* object */ js.UndefOr[typingsJapgolly.lodash.mod.NumericDictionary[js.Any] | scala.Null], 
    js.Any | TDefault
  ]
  ...
  type LodashGetOr6x5[TDefault] = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, TDefault]
  type LodashGetOr6x6 = js.Function1[/* defaultValue */ js.Any, js.Any]
  type LodashGetOr7x3 = js.Function1[/* object */ js.Any, js.Any]
  type LodashGetOr7x5 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  type LodashGetOr7x6 = js.Function1[/* defaultValue */ js.Any, js.Any]
  type LodashGroupBy1x1[T] = js.Function1[
    /* collection */ js.UndefOr[typingsJapgolly.lodash.mod.List[T] | js.Object | scala.Null], 
    typingsJapgolly.lodash.mod.Dictionary[js.Array[T]]
  ]
  ...
  type LodashGroupBy2x2[T] = js.Function1[
    ...
    typingsJapgolly.lodash.mod.Dictionary[
      js.Array[
        /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
      ]
    ]
  ...
  type LodashHas1x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, scala.Boolean]
  type LodashHasIn1x1 = js.Function1[/* object */ js.Any, scala.Boolean]
  type LodashHasIn1x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, scala.Boolean]
  ...
  type LodashIntersection1x1[T] = js.Function1[/* arrays */ typingsJapgolly.lodash.mod.List[T], js.Array[T]]
  type LodashIntersection1x2[T] = js.Function1[/* arrays2 */ typingsJapgolly.lodash.mod.List[T], js.Array[T]]
  type LodashIntersectionBy1x3[T1, T2] = js.Function1[/* values */ typingsJapgolly.lodash.mod.List[T2], js.Array[T1]]
  type LodashIntersectionBy1x5[T1] = js.Function1[/* array */ typingsJapgolly.lodash.mod.List[T1] | scala.Null, js.Array[T1]]
  type LodashIntersectionBy1x6[T1, T2] = js.Function1[/* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T1 | T2], js.Array[T1]]
  type LodashIntersectionWith1x3[T1, T2] = js.Function1[/* values */ typingsJapgolly.lodash.mod.List[T2], js.Array[T1]]
  type LodashIntersectionWith1x5[T1] = js.Function1[
    /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[T1] | scala.Null], 
    js.Array[T1]
  ]
  type LodashIntersectionWith1x6[T1, T2] = js.Function1[/* comparator */ typingsJapgolly.lodash.mod.Comparator2[T1, T2], js.Array[T1]]
  type LodashInvert = js.Function1[/* object */ js.Object, typingsJapgolly.lodash.mod.Dictionary[java.lang.String]]
  type LodashInvertBy1x1[T] = js.Function1[
    /* object */ js.UndefOr[
      typingsJapgolly.lodash.mod.List[T] | typingsJapgolly.lodash.mod.Dictionary[T] | typingsJapgolly.lodash.mod.NumericDictionary[T] | js.Object | scala.Null
    ], 
    typingsJapgolly.lodash.mod.Dictionary[js.Array[java.lang.String]]
  ]
  type LodashInvertBy1x2[T] = js.Function1[
    /* interatee */ typingsJapgolly.lodash.mod.ValueIteratee[T], 
    typingsJapgolly.lodash.mod.Dictionary[js.Array[java.lang.String]]
  ]
  type LodashInvertBy2x2[T] = js.Function1[
    /* interatee */ typingsJapgolly.lodash.mod.ValueIteratee[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ], 
    typingsJapgolly.lodash.mod.Dictionary[js.Array[java.lang.String]]
  ]
  type LodashInvoke1x1 = js.Function1[/* object */ js.Any, js.Any]
  type LodashInvoke1x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  ...
  type LodashInvokeArgs1x6 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  ...
  type LodashIsEqualWith1x6 = js.Function1[/* customizer */ typingsJapgolly.lodash.mod.IsEqualCustomizer, scala.Boolean]
  ...
  type LodashIsMatchWith1x6 = js.Function1[/* customizer */ typingsJapgolly.lodash.mod.isMatchWithCustomizer, scala.Boolean]
  ...
  type LodashKeyBy1x1[T] = js.Function1[
    /* collection */ js.UndefOr[typingsJapgolly.lodash.mod.List[T] | js.Object | scala.Null], 
    typingsJapgolly.lodash.mod.Dictionary[T]
  ]
  type LodashKeyBy1x2[T] = js.Function1[
    /* iteratee */ typingsJapgolly.lodash.mod.ValueIterateeCustom[T, typingsJapgolly.lodash.mod.PropertyName], 
    typingsJapgolly.lodash.mod.Dictionary[T]
  ]
  type LodashKeyBy2x2[T] = js.Function1[
    /* iteratee */ typingsJapgolly.lodash.mod.ValueIterateeCustom[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      typingsJapgolly.lodash.mod.PropertyName
    ], 
    typingsJapgolly.lodash.mod.Dictionary[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ]
  ...
  type LodashLastIndexOfFrom1x5 = js.Function1[
    /* fromIndex */ typingsJapgolly.lodash.lodashBooleans.`true` | scala.Double, 
    scala.Double
  ]
  ...
  type LodashMap1x1[T, TResult] = js.Function1[
    /* collection */ js.UndefOr[js.Array[T] | typingsJapgolly.lodash.mod.List[T] | scala.Null], 
    js.Array[TResult]
  ]
  ...
  type LodashMapKeys1x1 = js.Function1[
    /* object */ js.UndefOr[typingsJapgolly.lodash.mod.List[js.Any] | scala.Null], 
    typingsJapgolly.lodash.mod.Dictionary[js.Any]
  ]
  type LodashMapKeys1x2[T] = js.Function1[
    /* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[scala.Double], 
    typingsJapgolly.lodash.mod.Dictionary[T]
  ]
  ...
  type LodashMapKeys2x2[T] = js.Function1[
    /* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[java.lang.String], 
    typingsJapgolly.lodash.mod.Dictionary[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ]
  ]
  type LodashMapValues1x1[T, TResult] = js.Function1[
    /* obj */ js.UndefOr[
      typingsJapgolly.lodash.mod.Dictionary[T] | typingsJapgolly.lodash.mod.NumericDictionary[T] | scala.Null
    ], 
    typingsJapgolly.lodash.mod.Dictionary[TResult]
  ]
  ...
  type LodashMatchesProperty1x2 = js.Function1[
    /* path */ typingsJapgolly.lodash.mod.PropertyPath, 
    js.Function1[/* value */ js.Any, scala.Boolean]
  ]
  type LodashMax = js.Function1[
    /* collection */ js.UndefOr[typingsJapgolly.lodash.mod.List[js.Any] | scala.Null], 
    js.UndefOr[js.Any]
  ]
  ...
  type LodashMaxBy1x2[T] = js.Function1[/* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T], js.UndefOr[T]]
  ...
  type LodashMeanBy1x2[T] = js.Function1[/* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T], scala.Double]
  type LodashMemoize = js.Function1[
    /* func */ js.Function1[/* repeated */ js.Any, js.Any], 
    (js.Function1[/* repeated */ js.Any, _]) with typingsJapgolly.lodash.mod.MemoizedFunction
  ]
  ...
  type LodashMergeAllWith1x2 = js.Function1[/* customizer */ typingsJapgolly.lodash.mod.MergeWithCustomizer, js.Any]
  ...
  type LodashMergeWith1x6[TObject, TSource] = js.Function1[
    /* customizer */ typingsJapgolly.lodash.mod.MergeWithCustomizer, 
  ...
  type LodashMethodOf = js.Function1[
    /* object */ js.Object, 
    js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  ]
  ...
  type LodashMinBy1x2[T] = js.Function1[/* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T], js.UndefOr[T]]
  ...
  type LodashNoConflict = js.Function0[typingsJapgolly.lodash.Typeoflodash]
  ...
  type LodashOmit1x2[T] = js.Function1[
    /* paths */ typingsJapgolly.lodash.mod.Many[typingsJapgolly.lodash.mod.PropertyName], 
    T
  ]
  type LodashOmit2x1[T, K /* <: java.lang.String */] = js.Function1[/* object */ js.UndefOr[T | scala.Null], typingsJapgolly.lodash.mod.Omit[T, K]]
  type LodashOmitBy1x2[T] = js.Function1[
    /* predicate */ typingsJapgolly.lodash.mod.ValueKeyIteratee[T], 
    typingsJapgolly.lodash.mod.Dictionary[T]
  ]
  type LodashOmitBy2x2[T] = js.Function1[
    /* predicate */ typingsJapgolly.lodash.mod.ValueKeyIteratee[T], 
    typingsJapgolly.lodash.mod.NumericDictionary[T]
  ]
  type LodashOmitBy3x2[T] = js.Function1[
    /* predicate */ typingsJapgolly.lodash.mod.ValueKeyIteratee[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ], 
    typingsJapgolly.lodash.mod.PartialObject[T]
  ]
  ...
  type LodashOrderBy1x5[T] = js.Function1[
    /* orders */ typingsJapgolly.lodash.mod.Many[
      scala.Boolean | typingsJapgolly.lodash.lodashStrings.asc | typingsJapgolly.lodash.lodashStrings.desc
    ], 
    js.Array[T]
  ]
  type LodashOrderBy1x6[T] = js.Function1[
    /* iteratees */ typingsJapgolly.lodash.mod.Many[
      (js.Function1[/* value */ T, typingsJapgolly.lodash.mod.NotVoid]) | typingsJapgolly.lodash.mod.ValueIteratee[T]
    ], 
    js.Array[T]
  ]
  ...
  type LodashOrderBy3x6[T] = js.Function1[
    /* iteratees */ typingsJapgolly.lodash.mod.Many[
      (js.Function1[
        /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ /* value */ js.Any, 
        typingsJapgolly.lodash.mod.NotVoid
      ]) | (typingsJapgolly.lodash.mod.ValueIteratee[
        /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
      ])
    ], 
    js.Array[
  ...
  type LodashOver = js.Function1[
    /* iteratees */ typingsJapgolly.lodash.mod.Many[js.Function1[/* repeated */ js.Any, js.Any]], 
    js.Function1[/* repeated */ js.Any, js.Array[js.Any]]
  ]
  type LodashOverArgs1x1 = js.Function1[
    /* transforms */ typingsJapgolly.lodash.mod.Many[js.Function1[/* repeated */ js.Any, js.Any]], 
    js.Function1[/* repeated */ js.Any, js.Any]
  ]
  ...
  type LodashOverEvery = js.Function1[
    /* predicates */ typingsJapgolly.lodash.mod.Many[js.Function1[/* repeated */ js.Any, scala.Boolean]], 
  ...
  type LodashPartial19x2[T4] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[js.Any, js.Any, js.Any, T4, js.Any], 
    typingsJapgolly.lodash.mod.Function3[js.Any, js.Any, js.Any, js.Any]
  ]
  type LodashPartial1x1[T1, R] = js.Function1[/* arg1 */ js.Array[T1], typingsJapgolly.lodash.mod.Function0[R]]
  type LodashPartial20x2[T1, T4] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[T1, js.Any, js.Any, T4, js.Any], 
    typingsJapgolly.lodash.mod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartial21x2[T2, T4] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[js.Any, T2, js.Any, T4, js.Any], 
    typingsJapgolly.lodash.mod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartial22x2[T1, T2, T4] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[T1, T2, js.Any, T4, js.Any], 
    typingsJapgolly.lodash.mod.Function1[js.Any, js.Any]
  ]
  type LodashPartial23x2[T3, T4] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[js.Any, js.Any, T3, T4, js.Any], 
    typingsJapgolly.lodash.mod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartial24x2[T1, T3, T4] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[T1, js.Any, T3, T4, js.Any], 
    typingsJapgolly.lodash.mod.Function1[js.Any, js.Any]
  ]
  type LodashPartial25x2[T2, T3, T4] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[js.Any, T2, T3, T4, js.Any], 
    typingsJapgolly.lodash.mod.Function1[js.Any, js.Any]
  ]
  type LodashPartial26x2[T1, T2, T3, T4] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[T1, T2, T3, T4, js.Any], 
    typingsJapgolly.lodash.mod.Function0[js.Any]
  ]
  ...
  type LodashPartialRight10x2[T2, T3] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function3[js.Any, T2, T3, js.Any], 
    typingsJapgolly.lodash.mod.Function1[js.Any, js.Any]
  ]
  type LodashPartialRight11x2[T1, T2, T3] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function3[T1, T2, T3, js.Any], 
    typingsJapgolly.lodash.mod.Function0[js.Any]
  ]
  type LodashPartialRight12x2[T1] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[T1, js.Any, js.Any, js.Any, js.Any], 
    typingsJapgolly.lodash.mod.Function3[js.Any, js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight13x2[T2] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[js.Any, T2, js.Any, js.Any, js.Any], 
    typingsJapgolly.lodash.mod.Function3[js.Any, js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight14x2[T1, T2] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[T1, T2, js.Any, js.Any, js.Any], 
    typingsJapgolly.lodash.mod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight15x2[T3] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[js.Any, js.Any, T3, js.Any, js.Any], 
    typingsJapgolly.lodash.mod.Function3[js.Any, js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight16x2[T1, T3] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[T1, js.Any, T3, js.Any, js.Any], 
    typingsJapgolly.lodash.mod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight17x2[T2, T3] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[js.Any, T2, T3, js.Any, js.Any], 
    typingsJapgolly.lodash.mod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight18x2[T1, T2, T3] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function4[T1, T2, T3, js.Any, js.Any], 
    typingsJapgolly.lodash.mod.Function1[js.Any, js.Any]
  ]
  ...
  type LodashPartialRight1x1[T1, R] = js.Function1[/* arg1 */ js.Array[T1], typingsJapgolly.lodash.mod.Function0[R]]
  type LodashPartialRight1x2[T1] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function1[T1, js.Any], 
    typingsJapgolly.lodash.mod.Function0[js.Any]
  ]
  ...
  type LodashPartialRight2x2[T1] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function2[T1, js.Any, js.Any], 
    typingsJapgolly.lodash.mod.Function1[js.Any, js.Any]
  ]
  type LodashPartialRight3x2[T2] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function2[js.Any, T2, js.Any], 
    typingsJapgolly.lodash.mod.Function1[js.Any, js.Any]
  ]
  type LodashPartialRight4x2[T1, T2] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function2[T1, T2, js.Any], 
    typingsJapgolly.lodash.mod.Function0[js.Any]
  ]
  type LodashPartialRight5x2[T1] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function3[T1, js.Any, js.Any, js.Any], 
    typingsJapgolly.lodash.mod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight6x2[T2] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function3[js.Any, T2, js.Any, js.Any], 
    typingsJapgolly.lodash.mod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight7x2[T1, T2] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function3[T1, T2, js.Any, js.Any], 
    typingsJapgolly.lodash.mod.Function1[js.Any, js.Any]
  ]
  type LodashPartialRight8x2[T3] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function3[js.Any, js.Any, T3, js.Any], 
    typingsJapgolly.lodash.mod.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight9x2[T1, T3] = js.Function1[
    /* func */ typingsJapgolly.lodash.mod.Function3[T1, js.Any, T3, js.Any], 
    typingsJapgolly.lodash.mod.Function1[js.Any, js.Any]
  ]
  ...
  type LodashPartition3x2[T] = js.Function1[
    /* callback */ typingsJapgolly.lodash.mod.ValueIteratee[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ], 
    js.Tuple2[
      js.Array[
  ...
  type LodashPath8x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.UndefOr[scala.Nothing]]
  type LodashPath9x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  ...
  type LodashPathOr6x5[TDefault] = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, TDefault]
  type LodashPathOr6x6 = js.Function1[/* defaultValue */ js.Any, js.Any]
  type LodashPathOr7x3 = js.Function1[/* object */ js.Any, js.Any]
  type LodashPathOr7x5 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  ...
  type LodashPick2x1 = js.Function1[
    ...
    typingsJapgolly.lodash.mod.PartialDeep[js.Any]
  ]
  type LodashPick2x2[T] = js.Function1[
    /* props */ typingsJapgolly.lodash.mod.PropertyPath, 
    typingsJapgolly.lodash.mod.PartialDeep[T]
  ]
  ...
  type LodashProp8x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.UndefOr[scala.Nothing]]
  type LodashProp9x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  ...
  type LodashPropOr6x5[TDefault] = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, TDefault]
  type LodashPropOr6x6 = js.Function1[/* defaultValue */ js.Any, js.Any]
  type LodashPropOr7x3 = js.Function1[/* object */ js.Any, js.Any]
  type LodashPropOr7x5 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  ...
  type LodashProperty8x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.UndefOr[scala.Nothing]]
  type LodashProperty9x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  ...
  type LodashPropertyOf8x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.UndefOr[scala.Nothing]]
  type LodashPropertyOf9x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  type LodashPull1x2[T] = js.Function1[/* values */ T, js.Array[T]]
  type LodashPull2x2[T] = js.Function1[/* values */ T, typingsJapgolly.lodash.mod.List[T]]
  type LodashPullAll1x2[T] = js.Function1[/* values */ typingsJapgolly.lodash.mod.List[T], js.Array[T]]
  type LodashPullAll2x2[T] = js.Function1[
    /* values */ typingsJapgolly.lodash.mod.List[T], 
    typingsJapgolly.lodash.mod.List[T]
  ]
  type LodashPullAllBy1x5[T] = js.Function1[/* values */ typingsJapgolly.lodash.mod.List[T], js.Array[T]]
  type LodashPullAllBy1x6[T] = js.Function1[/* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T], js.Array[T]]
  ...
  type LodashPullAllBy3x5[T1, T2] = js.Function1[/* values */ typingsJapgolly.lodash.mod.List[T2], js.Array[T1]]
  type LodashPullAllBy3x6[T1, T2] = js.Function1[/* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T1 | T2], js.Array[T1]]
  ...
  type LodashPullAllBy4x6[T1, T2] = js.Function1[
    /* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T1 | T2], 
    typingsJapgolly.lodash.mod.List[T1]
  ]
  type LodashPullAllWith1x5[T] = js.Function1[/* values */ typingsJapgolly.lodash.mod.List[T], js.Array[T]]
  type LodashPullAllWith1x6[T] = js.Function1[/* comparator */ typingsJapgolly.lodash.mod.Comparator[T], js.Array[T]]
  type LodashPullAllWith2x5[T] = js.Function1[
    /* values */ typingsJapgolly.lodash.mod.List[T], 
    typingsJapgolly.lodash.mod.List[T]
  ]
  type LodashPullAllWith2x6[T] = js.Function1[
    /* comparator */ typingsJapgolly.lodash.mod.Comparator[T], 
    typingsJapgolly.lodash.mod.List[T]
  ]
  type LodashPullAllWith3x5[T1, T2] = js.Function1[/* values */ typingsJapgolly.lodash.mod.List[T2], js.Array[T1]]
  type LodashPullAllWith3x6[T1, T2] = js.Function1[/* comparator */ typingsJapgolly.lodash.mod.Comparator2[T1, T2], js.Array[T1]]
  type LodashPullAllWith4x5[T1, T2] = js.Function1[
    /* values */ typingsJapgolly.lodash.mod.List[T2], 
    typingsJapgolly.lodash.mod.List[T1]
  ]
  type LodashPullAllWith4x6[T1, T2] = js.Function1[
    /* comparator */ typingsJapgolly.lodash.mod.Comparator2[T1, T2], 
    typingsJapgolly.lodash.mod.List[T1]
  ]
  type LodashPullAt1x2[T] = js.Function1[/* indexes */ typingsJapgolly.lodash.mod.Many[scala.Double], js.Array[T]]
  type LodashPullAt2x2[T] = js.Function1[
    /* indexes */ typingsJapgolly.lodash.mod.Many[scala.Double], 
    typingsJapgolly.lodash.mod.List[T]
  ]
  ...
  type LodashReduce1x6[T, TResult] = js.Function1[/* callback */ typingsJapgolly.lodash.mod.MemoIteratorCapped[T, TResult], TResult]
  type LodashReduce2x5[TResult] = js.Function1[/* accumulator */ TResult, TResult]
  type LodashReduce2x6[T, TResult] = js.Function1[/* callback */ typingsJapgolly.lodash.mod.MemoIteratorCapped[T, TResult], TResult]
  ...
  type LodashReduce3x6[T, TResult] = js.Function1[
    /* callback */ typingsJapgolly.lodash.mod.MemoIteratorCapped[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      TResult
    ], 
    TResult
  ...
  type LodashReduceRight1x6[T, TResult] = js.Function1[
    /* callback */ typingsJapgolly.lodash.mod.MemoIteratorCappedRight[T, TResult], 
    TResult
  ]
  ...
  type LodashReduceRight3x6[T, TResult] = js.Function1[
    /* callback */ typingsJapgolly.lodash.mod.MemoIteratorCappedRight[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      TResult
    ], 
    TResult
  ...
  type LodashRemove1x1[T] = js.Function1[/* array */ typingsJapgolly.lodash.mod.List[T], js.Array[T]]
  type LodashRemove1x2[T] = js.Function1[/* predicate */ typingsJapgolly.lodash.mod.ValueIteratee[T], js.Array[T]]
  ...
  type LodashReplace1x5 = js.Function1[
    /* replacement */ typingsJapgolly.lodash.mod.ReplaceFunction | java.lang.String, 
    java.lang.String
  ]
  ...
  type LodashResult1x2 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  type LodashReverse = js.Function1[
    /* array */ typingsJapgolly.lodash.mod.List[js.Any], 
    typingsJapgolly.lodash.mod.List[js.Any]
  ]
  type LodashRound = js.Function1[/* n */ scala.Double, scala.Double]
  type LodashRunInContext = js.Function1[/* context */ js.Object, typingsJapgolly.lodash.mod.LoDashStatic]
  ...
  type LodashSet1x6[T] = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, T]
  type LodashSet2x5 = js.Function1[/* value */ js.Any, js.Any]
  type LodashSet2x6 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  type LodashSetWith1x11[T] = js.Function1[/* value */ js.Any, T]
  type LodashSetWith1x13[T] = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, T]
  type LodashSetWith1x14[T] = js.Function1[/* customizer */ typingsJapgolly.lodash.mod.SetWithCustomizer[T], T]
  ...
  type LodashSortBy1x2[T] = js.Function1[
    /* iteratees */ typingsJapgolly.lodash.mod.Many[typingsJapgolly.lodash.mod.ValueIteratee[T]], 
    js.Array[T]
  ]
  ...
  type LodashSortedIndexBy1x6[T] = js.Function1[/* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T], scala.Double]
  ...
  type LodashSortedLastIndexBy1x6[T] = js.Function1[/* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T], scala.Double]
  ...
  type LodashSortedUniqBy1x2[T] = js.Function1[/* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T], js.Array[T]]
  ...
  type LodashStubFalse = js.Function0[typingsJapgolly.lodash.lodashBooleans.`false`]
  type LodashStubObject = js.Function0[js.Any]
  type LodashStubString = js.Function0[java.lang.String]
  type LodashStubTrue = js.Function0[typingsJapgolly.lodash.lodashBooleans.`true`]
  ...
  type LodashTakeRightWhile1x2[T] = js.Function1[/* predicate */ typingsJapgolly.lodash.mod.ValueIteratee[T], js.Array[T]]
  type LodashTakeWhile1x1[T] = js.Function1[
    /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashTakeWhile1x2[T] = js.Function1[/* predicate */ typingsJapgolly.lodash.mod.ValueIteratee[T], js.Array[T]]
  type LodashTap1x1[T] = js.Function1[/* value */ T, T]
  type LodashTap1x2[T] = js.Function1[/* interceptor */ js.Function1[/* value */ T, scala.Unit], T]
  type LodashTemplate = js.Function1[/* string */ java.lang.String, typingsJapgolly.lodash.mod.TemplateExecutor]
  type LodashThrottle1x1 = js.Function1[
    /* func */ js.Function1[/* repeated */ js.Any, js.Any], 
    (js.Function1[/* repeated */ js.Any, _]) with typingsJapgolly.lodash.mod.Cancelable
  ]
  type LodashThrottle1x2[T] = js.Function1[/* wait */ scala.Double, T with typingsJapgolly.lodash.mod.Cancelable]
  ...
  type LodashTransform1x3[T, TResult] = js.Function1[
    /* object */ js.Array[T] | typingsJapgolly.lodash.mod.Dictionary[T], 
    js.Array[TResult]
  ]
  ...
  type LodashTransform1x6[T, TResult] = js.Function1[
    /* iteratee */ typingsJapgolly.lodash.mod.MemoVoidIteratorCapped[T, js.Array[TResult]], 
    js.Array[TResult]
  ]
  ...
  type LodashTransform2x5[TResult] = js.Function1[
    /* accumulator */ typingsJapgolly.lodash.mod.Dictionary[TResult], 
    typingsJapgolly.lodash.mod.Dictionary[TResult]
  ]
  type LodashTransform2x6[T, TResult] = js.Function1[
    /* iteratee */ typingsJapgolly.lodash.mod.MemoVoidIteratorCapped[T, typingsJapgolly.lodash.mod.Dictionary[TResult]], 
    typingsJapgolly.lodash.mod.Dictionary[TResult]
  ]
  ...
  type LodashTruncate1x2 = js.Function1[/* options */ typingsJapgolly.lodash.mod.TruncateOptions, java.lang.String]
  ...
  type LodashUnion1x1[T] = js.Function1[
    /* arrays */ js.UndefOr[typingsJapgolly.lodash.mod.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashUnion1x2[T] = js.Function1[
    /* arrays2 */ js.UndefOr[typingsJapgolly.lodash.mod.List[T] | scala.Null], 
    js.Array[T]
  ]
  ...
  type LodashUnionBy1x5[T] = js.Function1[
    /* arrays1 */ js.UndefOr[typingsJapgolly.lodash.mod.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashUnionBy1x6[T] = js.Function1[/* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T], js.Array[T]]
  ...
  type LodashUnionWith1x6[T] = js.Function1[/* comparator */ typingsJapgolly.lodash.mod.Comparator[T], js.Array[T]]
  ...
  type LodashUniqBy1x2[T] = js.Function1[/* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T], js.Array[T]]
  type LodashUniqWith1x1[T] = js.Function1[
    /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashUniqWith1x2[T] = js.Function1[/* comparator */ typingsJapgolly.lodash.mod.Comparator[T], js.Array[T]]
  ...
  type LodashUnset1x2[T] = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, T]
  type LodashUnzip = js.Function1[
    /* array */ js.UndefOr[
      js.Array[js.Array[js.Any]] | typingsJapgolly.lodash.mod.List[typingsJapgolly.lodash.mod.List[js.Any]] | scala.Null
    ], 
    js.Array[js.Array[js.Any]]
  ]
  type LodashUnzipWith1x1[T, TResult] = js.Function1[
    /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[typingsJapgolly.lodash.mod.List[T]] | scala.Null], 
    js.Array[TResult]
  ]
  ...
  type LodashUpdate1x6 = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, js.Any]
  type LodashUpdateWith1x11[T] = js.Function1[/* updater */ js.Function1[/* oldValue */ js.Any, js.Any], T]
  type LodashUpdateWith1x13[T] = js.Function1[/* path */ typingsJapgolly.lodash.mod.PropertyPath, T]
  type LodashUpdateWith1x14[T] = js.Function1[/* customizer */ typingsJapgolly.lodash.mod.SetWithCustomizer[T], T]
  ...
  type LodashXorBy1x6[T] = js.Function1[/* iteratee */ typingsJapgolly.lodash.mod.ValueIteratee[T], js.Array[T]]
  ...
  type LodashXorWith1x6[T] = js.Function1[/* comparator */ typingsJapgolly.lodash.mod.Comparator[T], js.Array[T]]
  type LodashZip1x1[T1] = js.Function1[
    /* arrays2 */ typingsJapgolly.lodash.mod.List[js.Any], 
    js.Array[js.Tuple2[js.UndefOr[T1], js.UndefOr[js.Any]]]
  ]
  type LodashZip1x2[T2] = js.Function1[
    /* arrays1 */ typingsJapgolly.lodash.mod.List[js.Any], 
    js.Array[js.Tuple2[js.UndefOr[js.Any], js.UndefOr[T2]]]
  ]
  type LodashZipObject1x1 = js.Function1[
    /* values */ typingsJapgolly.lodash.mod.List[js.Any], 
    typingsJapgolly.lodash.mod.Dictionary[js.Any]
  ]
  type LodashZipObject1x2[T] = js.Function1[
    /* props */ typingsJapgolly.lodash.mod.List[typingsJapgolly.lodash.mod.PropertyName], 
    typingsJapgolly.lodash.mod.Dictionary[T]
  ]
  type LodashZipObjectDeep1x1 = js.Function1[/* values */ typingsJapgolly.lodash.mod.List[js.Any], js.Object]
  type LodashZipObjectDeep1x2 = js.Function1[
    /* paths */ typingsJapgolly.lodash.mod.List[typingsJapgolly.lodash.mod.PropertyPath], 
    js.Object
  ]
  type LodashZipWith1x3[T2, TResult] = js.Function1[/* arrays2 */ typingsJapgolly.lodash.mod.List[T2], js.Array[TResult]]
  type LodashZipWith1x5[T1, TResult] = js.Function1[/* arrays1 */ typingsJapgolly.lodash.mod.List[T1], js.Array[TResult]]
