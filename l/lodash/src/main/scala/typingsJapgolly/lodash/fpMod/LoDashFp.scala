...
import typingsJapgolly.lodash.anon.LodashAnyHack
import typingsJapgolly.lodash.anon.TrapAny
import typingsJapgolly.lodash.anon.Typeoflodash
import typingsJapgolly.lodash.lodashBooleans.`false`
import typingsJapgolly.lodash.lodashBooleans.`true`
import typingsJapgolly.lodash.lodashInts.`0`
import typingsJapgolly.lodash.lodashStrings._empty
import typingsJapgolly.lodash.lodashStrings.asc
import typingsJapgolly.lodash.lodashStrings.desc
import typingsJapgolly.lodash.mod.AssignCustomizer
import typingsJapgolly.lodash.mod.CloneDeepWithCustomizer
...
import typingsJapgolly.lodash.mod.CondPairNullary
import typingsJapgolly.lodash.mod.CondPairUnary
import typingsJapgolly.lodash.mod.ConformsPredicateObject
import typingsJapgolly.lodash.mod.CurriedFunction1
...
import typingsJapgolly.lodash.mod.FunctionBase
import typingsJapgolly.lodash.mod.IsEqualCustomizer
...
import typingsJapgolly.lodash.mod.MergeWithCustomizer
...
import typingsJapgolly.lodash.mod.Omit
...
import typingsJapgolly.lodash.mod.RightCurriedFunction1
...
import typingsJapgolly.lodash.mod.TruncateOptions
...
trait LoDashFp extends StObject {
  ...
  def __[T /* <: js.UndefOr[Null] */](value: T): Primitive[T]
  def __[T](value: typingsJapgolly.lodash.mod.List[T]): Collection[T]
  @JSName("__")
  var ___Original: __
  @JSName("__")
  def ___T_Collection[T](): Collection[T]
  @JSName("__")
  def ___T_Function[T /* <: js.Function1[/* args */ Any, Any] */](value: T): Function[T]
  @JSName("__")
  ...
  /**
    ...
    **/
  @JSName("__")
  def ___TrapAny_Intersection[TrapAny /* <: typingsJapgolly.lodash.anon.TrapAny */](value: TrapAny): Collection[Any] & Function[Any] & Object[Any] & Primitive[Any] & String
  ...
  def all[T](predicate: ValueIterateeCustom[T, Boolean]): LodashEvery1x1[T]
  def all[T /* <: js.Object */](
  ...
  def all[T](predicate: ValueIterateeCustom[T, Boolean], collection: typingsJapgolly.lodash.mod.List[T]): Boolean
  def all[T /* <: js.Object */](predicate: __): LodashEvery2x2[T]
  def all[T /* <: js.Object */](predicate: __, collection: T): LodashEvery2x2[T]
  def all[T](predicate: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashEvery1x2[T]
  ...
  def any[T](predicate: ValueIterateeCustom[T, Boolean]): LodashSome1x1[T]
  def any[T /* <: js.Object */](
    predicate: ValueIterateeCustom[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      Boolean
  ...
  def any[T](predicate: ValueIterateeCustom[T, Boolean], collection: typingsJapgolly.lodash.mod.List[T]): Boolean
  def any[T /* <: js.Object */](predicate: __): LodashSome2x2[T]
  def any[T /* <: js.Object */](predicate: __, collection: T): LodashSome2x2[T]
  def any[T](predicate: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashSome1x2[T]
  ...
  @JSName("any")
  def any_T_LodashSome1x2[T](predicate: __): LodashSome1x2[T]
  ...
  def at[T /* <: js.Object */](props: __): LodashAt2x2[T]
  ...
  @JSName("at")
  def at_T_LodashAt1x2[T](props: __): LodashAt1x2[T]
  @JSName("at")
  ...
  def chunk[T](size: Double, array: typingsJapgolly.lodash.mod.List[T]): js.Array[js.Array[T]]
  def chunk[T](size: __): LodashChunk1x2[T]
  def chunk[T](size: __, array: typingsJapgolly.lodash.mod.List[T]): LodashChunk1x2[T]
  @JSName("chunk")
  ...
  def cloneWith[T, TResult](customizer: CloneWithCustomizer[T, js.UndefOr[TResult]]): LodashCloneWith2x1[T, TResult]
  ...
  @JSName("cloneWith")
  def cloneWith_TTResult_LodashCloneWith1x1[T, TResult /* <: js.Object | java.lang.String | Double | Boolean | Null */](customizer: CloneWithCustomizer[T, TResult]): LodashCloneWith1x1[T, TResult]
  @JSName("cloneWith")
  ...
  def compact[T](array: typingsJapgolly.lodash.mod.List[T]): js.Array[Exclude[T, js.UndefOr[Null | `false` | _empty | `0`]]]
  @JSName("compact")
  ...
  def countBy[T](iteratee: ValueIteratee[T], collection: typingsJapgolly.lodash.mod.List[T]): Dictionary[Double]
  ...
  def countBy[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashCountBy1x2[T]
  @JSName("countBy")
  var countBy_Original: LodashCountBy
  @JSName("countBy")
  def countBy_T_LodashCountBy1x1[T](iteratee: ValueIteratee[T]): LodashCountBy1x1[T]
  @JSName("countBy")
  ...
  def difference[T](array: Null, values: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def difference[T](array: Unit, values: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def difference[T](array: typingsJapgolly.lodash.mod.List[T]): LodashDifference1x1[T]
  def difference[T](array: typingsJapgolly.lodash.mod.List[T], values: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def difference[T](array: __, values: typingsJapgolly.lodash.mod.List[T]): LodashDifference1x2[T]
  
  def differenceBy[T1](iteratee: __): LodashDifferenceBy1x2[T1]
  def differenceBy[T1](iteratee: __, array: typingsJapgolly.lodash.mod.List[T1]): LodashDifferenceBy1x2[T1]
  def differenceBy[T2](iteratee: __, array: __, values: typingsJapgolly.lodash.mod.List[T2]): LodashDifferenceBy1x4[T2]
  def differenceBy[T1, T2](iteratee: ValueIteratee[T1 | T2]): LodashDifferenceBy1x3[T1, T2]
  def differenceBy[T1, T2](iteratee: ValueIteratee[T1 | T2], array: Null, values: typingsJapgolly.lodash.mod.List[T2]): js.Array[T1]
  def differenceBy[T1, T2](iteratee: ValueIteratee[T1 | T2], array: Unit, values: typingsJapgolly.lodash.mod.List[T2]): js.Array[T1]
  def differenceBy[T1, T2](iteratee: ValueIteratee[T1 | T2], array: typingsJapgolly.lodash.mod.List[T1]): LodashDifferenceBy1x3[T1, T2]
  ...
  def differenceBy[T1, T2](iteratee: ValueIteratee[T1 | T2], array: __, values: typingsJapgolly.lodash.mod.List[T2]): LodashDifferenceBy1x5[T1]
  def differenceBy[T1, T2](iteratee: __, array: Null, values: typingsJapgolly.lodash.mod.List[T2]): LodashDifferenceBy1x6[T1, T2]
  def differenceBy[T1, T2](iteratee: __, array: Unit, values: typingsJapgolly.lodash.mod.List[T2]): LodashDifferenceBy1x6[T1, T2]
  def differenceBy[T1, T2](
    iteratee: __,
    array: typingsJapgolly.lodash.mod.List[T1],
    values: typingsJapgolly.lodash.mod.List[T2]
  ...
  def differenceWith[T1](comparator: __, array: typingsJapgolly.lodash.mod.List[T1]): LodashDifferenceWith1x2[T1]
  def differenceWith[T2](comparator: __, array: __, values: typingsJapgolly.lodash.mod.List[T2]): LodashDifferenceWith1x4[T2]
  def differenceWith[T1, T2](comparator: Comparator2[T1, T2]): LodashDifferenceWith1x1[T1, T2]
  def differenceWith[T1, T2](comparator: Comparator2[T1, T2], array: Null, values: typingsJapgolly.lodash.mod.List[T2]): js.Array[T1]
  def differenceWith[T1, T2](comparator: Comparator2[T1, T2], array: Unit, values: typingsJapgolly.lodash.mod.List[T2]): js.Array[T1]
  def differenceWith[T1, T2](comparator: Comparator2[T1, T2], array: typingsJapgolly.lodash.mod.List[T1]): LodashDifferenceWith1x3[T1, T2]
  def differenceWith[T1, T2](
    comparator: Comparator2[T1, T2],
    array: typingsJapgolly.lodash.mod.List[T1],
    values: typingsJapgolly.lodash.mod.List[T2]
  ): js.Array[T1]
  def differenceWith[T1, T2](comparator: Comparator2[T1, T2], array: __, values: typingsJapgolly.lodash.mod.List[T2]): LodashDifferenceWith1x5[T1]
  def differenceWith[T1, T2](comparator: __, array: Null, values: typingsJapgolly.lodash.mod.List[T2]): LodashDifferenceWith1x6[T1, T2]
  def differenceWith[T1, T2](comparator: __, array: Unit, values: typingsJapgolly.lodash.mod.List[T2]): LodashDifferenceWith1x6[T1, T2]
  def differenceWith[T1, T2](
    comparator: __,
    array: typingsJapgolly.lodash.mod.List[T1],
    values: typingsJapgolly.lodash.mod.List[T2]
  ...
  def drop[T](n: Double, array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def drop[T](n: __): LodashDrop1x2[T]
  def drop[T](n: __, array: typingsJapgolly.lodash.mod.List[T]): LodashDrop1x2[T]
  
  def dropLast(n: Double): LodashDropRight1x1
  def dropLast[T](n: Double, array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def dropLast[T](n: __): LodashDropRight1x2[T]
  def dropLast[T](n: __, array: typingsJapgolly.lodash.mod.List[T]): LodashDropRight1x2[T]
  
  def dropLastWhile[T](predicate: ValueIteratee[T]): js.Array[T]
  def dropLastWhile[T](predicate: ValueIteratee[T], array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def dropLastWhile[T](predicate: __): LodashDropRightWhile1x2[T]
  def dropLastWhile[T](predicate: __, array: typingsJapgolly.lodash.mod.List[T]): LodashDropRightWhile1x2[T]
  @JSName("dropLastWhile")
  var dropLastWhile_Original: LodashDropRightWhile
  @JSName("dropLastWhile")
  def dropLastWhile_T_LodashDropRightWhile1x1[T](predicate: ValueIteratee[T]): LodashDropRightWhile1x1[T]
  ...
  def dropRight[T](n: Double, array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def dropRight[T](n: __): LodashDropRight1x2[T]
  def dropRight[T](n: __, array: typingsJapgolly.lodash.mod.List[T]): LodashDropRight1x2[T]
  
  def dropRightWhile[T](predicate: ValueIteratee[T]): js.Array[T]
  def dropRightWhile[T](predicate: ValueIteratee[T], array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def dropRightWhile[T](predicate: __): LodashDropRightWhile1x2[T]
  def dropRightWhile[T](predicate: __, array: typingsJapgolly.lodash.mod.List[T]): LodashDropRightWhile1x2[T]
  @JSName("dropRightWhile")
  var dropRightWhile_Original: LodashDropRightWhile
  @JSName("dropRightWhile")
  def dropRightWhile_T_LodashDropRightWhile1x1[T](predicate: ValueIteratee[T]): LodashDropRightWhile1x1[T]
  ...
  def dropWhile[T](predicate: ValueIteratee[T], array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def dropWhile[T](predicate: __): LodashDropWhile1x2[T]
  def dropWhile[T](predicate: __, array: typingsJapgolly.lodash.mod.List[T]): LodashDropWhile1x2[T]
  @JSName("dropWhile")
  ...
  def each[T](iteratee: js.Function1[/* value */ T, Any], collection: typingsJapgolly.lodash.mod.List[T]): typingsJapgolly.lodash.mod.List[T]
  ...
  def each[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashForEach2x2[T]
  ...
  def each[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: Null & TList): LodashForEach5x2[T, TList]
  def each[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: Unit & TList): LodashForEach5x2[T, TList]
  ...
  def eachRight[T](iteratee: js.Function1[/* value */ T, Any], collection: typingsJapgolly.lodash.mod.List[T]): typingsJapgolly.lodash.mod.List[T]
  def eachRight[T /* <: js.Object */](iteratee: __): LodashForEachRight6x2[T]
  def eachRight[T /* <: js.Object */](iteratee: __, collection: T): LodashForEachRight3x2[T]
  def eachRight[T](iteratee: __, collection: js.Array[T]): LodashForEachRight1x2[T]
  def eachRight[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashForEachRight2x2[T]
  ...
  @JSName("eachRight")
  def eachRight_TTList_LodashForEachRight5x2[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T] & TList): LodashForEachRight5x2[T, TList]
  @JSName("eachRight")
  def eachRight_TTList_LodashForEachRight5x2[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: Null & TList): LodashForEachRight5x2[T, TList]
  @JSName("eachRight")
  def eachRight_TTList_LodashForEachRight5x2[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: Unit & TList): LodashForEachRight5x2[T, TList]
  @JSName("eachRight")
  def eachRight_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Unit & TList): TList
  @JSName("eachRight")
  def eachRight_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: typingsJapgolly.lodash.mod.List[T] & TList): TList
  @JSName("eachRight")
  def eachRight_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Null & TList): TList
  @JSName("eachRight")
  def eachRight_T_LodashForEachRight1x1[T](iteratee: js.Function1[/* value */ T, Any]): LodashForEachRight1x1[T]
  @JSName("eachRight")
  def eachRight_T_LodashForEachRight6x2[T /* <: js.Object */](iteratee: __, collection: T): LodashForEachRight6x2[T]
  @JSName("eachRight")
  ...
  @JSName("each")
  def each_TTArray_LodashForEach4x2[T, TArray /* <: js.UndefOr[js.Array[T] | Null] */](iteratee: __, collection: Unit & TArray): LodashForEach4x2[T, TArray]
  @JSName("each")
  def each_TTArray_LodashForEach4x2[T, TArray /* <: js.UndefOr[js.Array[T] | Null] */](iteratee: __, collection: Null & TArray): LodashForEach4x2[T, TArray]
  @JSName("each")
  ...
  @JSName("each")
  def each_TTList_LodashForEach5x2[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T] & TList): LodashForEach5x2[T, TList]
  @JSName("each")
  def each_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Unit & TList): TList
  @JSName("each")
  def each_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: typingsJapgolly.lodash.mod.List[T] & TList): TList
  @JSName("each")
  def each_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Null & TList): TList
  @JSName("each")
  ...
  def every[T](predicate: ValueIterateeCustom[T, Boolean]): LodashEvery1x1[T]
  ...
  def every[T](predicate: ValueIterateeCustom[T, Boolean], collection: typingsJapgolly.lodash.mod.List[T]): Boolean
  def every[T /* <: js.Object */](predicate: __): LodashEvery2x2[T]
  def every[T /* <: js.Object */](predicate: __, collection: T): LodashEvery2x2[T]
  def every[T](predicate: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashEvery1x2[T]
  @JSName("every")
  var every_Original: LodashEvery
  @JSName("every")
  def every_T_Boolean[T](
    predicate: ValueIterateeCustom[
      (/* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any) | T, 
      Boolean
    ]
  ...
  def fill[U](start: Double, end: Double, value: __, array: typingsJapgolly.lodash.mod.List[U]): LodashFill2x11[U]
  def fill[T](start: Double, end: __, value: T): LodashFill1x5[T]
  def fill[U](start: Double, end: __, value: __): LodashFill1x9[U]
  def fill[U](start: Double, end: __, value: __, array: js.Array[U]): LodashFill1x9[U]
  def fill[U](start: Double, end: __, value: __, array: typingsJapgolly.lodash.mod.List[U]): LodashFill2x9[U]
  def fill[T](start: __, end: Double, value: T): LodashFill1x6[T]
  def fill[U](start: __, end: Double, value: __): LodashFill1x10[U]
  def fill[U](start: __, end: Double, value: __, array: js.Array[U]): LodashFill1x10[U]
  def fill[U](start: __, end: Double, value: __, array: typingsJapgolly.lodash.mod.List[U]): LodashFill2x10[U]
  ...
  def fill[U](start: __, end: __, value: __, array: typingsJapgolly.lodash.mod.List[U]): LodashFill2x8[U]
  def fill[T, U](start: Double, end: Double, value: T, array: js.Array[U]): js.Array[T | U]
  def fill[T, U](start: Double, end: Double, value: T, array: typingsJapgolly.lodash.mod.List[U]): typingsJapgolly.lodash.mod.List[T | U]
  def fill[T, U](start: Double, end: __, value: T, array: js.Array[U]): LodashFill1x13[T, U]
  def fill[T, U](start: Double, end: __, value: T, array: typingsJapgolly.lodash.mod.List[U]): LodashFill2x13[T, U]
  def fill[T, U](start: __, end: Double, value: T, array: js.Array[U]): LodashFill1x14[T, U]
  def fill[T, U](start: __, end: Double, value: T, array: typingsJapgolly.lodash.mod.List[U]): LodashFill2x14[T, U]
  def fill[T, U](start: __, end: __, value: T, array: js.Array[U]): LodashFill1x12[T, U]
  def fill[T, U](start: __, end: __, value: T, array: typingsJapgolly.lodash.mod.List[U]): LodashFill2x12[T, U]
  @JSName("fill")
  var fill_Original: LodashFill
  @JSName("fill")
  def fill_TU_Array[T, U](start: Double, end: Double, value: T): js.Array[T | U]
  @JSName("fill")
  def fill_TU_List[T, U](start: Double, end: Double, value: T): typingsJapgolly.lodash.mod.List[T | U]
  @JSName("fill")
  ...
  @JSName("fill")
  def fill_U_LodashFill2x10[U](start: __, end: Double, value: __): LodashFill2x10[U]
  @JSName("fill")
  def fill_U_LodashFill2x8[U](start: __, end: __, value: __): LodashFill2x8[U]
  @JSName("fill")
  def fill_U_LodashFill2x9[U](start: Double, end: __, value: __): LodashFill2x9[U]
  ...
  def filter[T](predicate: ValueIterateeCustom[T, Boolean], collection: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def filter[T](predicate: __): LodashFilter1x2[T]
  def filter[T /* <: js.Object */](predicate: __, collection: T): LodashFilter3x2[T]
  def filter[T](predicate: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashFilter1x2[T]
  def filter[T, S /* <: T */](
  ...
  def filter[T, S /* <: T */](predicate: ValueIteratorTypeGuard[T, S], collection: typingsJapgolly.lodash.mod.List[T]): js.Array[S]
  @JSName("filter")
  ...
  def find[T](predicate: ValueIterateeCustom[T, Boolean]): LodashFind2x1[T]
  ...
  def find[T](predicate: ValueIterateeCustom[T, Boolean], collection: typingsJapgolly.lodash.mod.List[T]): js.UndefOr[T]
  def find[T](predicate: __): LodashFind1x2[T]
  def find[T /* <: js.Object */](predicate: __, collection: T): LodashFind3x2[T]
  def find[T](predicate: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashFind1x2[T]
  ...
  def find[T, S /* <: T */](predicate: ValueIteratorTypeGuard[T, S], collection: typingsJapgolly.lodash.mod.List[T]): js.UndefOr[S]
  ...
  def findFrom[T](predicate: __, fromIndex: Double, collection: typingsJapgolly.lodash.mod.List[T]): LodashFindFrom1x6[T]
  ...
  def findFrom[T](predicate: __, fromIndex: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashFindFrom1x4[T]
  ...
  def findFrom[T, S /* <: T */](predicate: ValueIteratorTypeGuard[T, S], fromIndex: __): LodashFindFrom1x5[S]
  def findFrom[T /* <: js.Object */, S /* <: /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any */](
    predicate: ValueIteratorTypeGuard[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      S
  ...
  @JSName("findFrom")
  def findFrom_TS_LodashFindFrom3x5[T /* <: js.Object */, S /* <: /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any */](
    predicate: ValueIteratorTypeGuard[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      S
    ],
  ...
  @JSName("findFrom")
  def findFrom_T_LodashFindFrom2x3[T](predicate: ValueIterateeCustom[T, Boolean], fromIndex: Double): LodashFindFrom2x3[T]
  @JSName("findFrom")
  def findFrom_T_LodashFindFrom2x5[T](predicate: ValueIterateeCustom[T, Boolean], fromIndex: __): LodashFindFrom2x5[T]
  @JSName("findFrom")
  ...
  def findIndex[T](predicate: ValueIterateeCustom[T, Boolean], array: typingsJapgolly.lodash.mod.List[T]): Double
  def findIndex[T](predicate: __): LodashFindIndex1x2[T]
  def findIndex[T](predicate: __, array: typingsJapgolly.lodash.mod.List[T]): LodashFindIndex1x2[T]
  ...
  def findIndexFrom[T](predicate: __, fromIndex: Double, array: typingsJapgolly.lodash.mod.List[T]): LodashFindIndexFrom1x6[T]
  def findIndexFrom[T](predicate: __, fromIndex: __): LodashFindIndexFrom1x4[T]
  def findIndexFrom[T](predicate: __, fromIndex: __, array: typingsJapgolly.lodash.mod.List[T]): LodashFindIndexFrom1x4[T]
  ...
  @JSName("findKey")
  def findKey_T_LodashFindKey1x1[T](predicate: ValueIteratee[T]): LodashFindKey1x1[T]
  ...
  def findLast[T](predicate: ValueIterateeCustom[T, Boolean], collection: typingsJapgolly.lodash.mod.List[T]): js.UndefOr[T]
  def findLast[T](predicate: __): LodashFindLast1x2[T]
  def findLast[T /* <: js.Object */](predicate: __, collection: T): LodashFindLast3x2[T]
  def findLast[T](predicate: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashFindLast1x2[T]
  def findLast[T, S /* <: T */](predicate: ValueIteratorTypeGuard[T, S]): LodashFindLast1x1[T, S]
  ...
  def findLast[T, S /* <: T */](predicate: ValueIteratorTypeGuard[T, S], collection: typingsJapgolly.lodash.mod.List[T]): js.UndefOr[S]
  ...
  def findLastFrom[T](predicate: ValueIterateeCustom[T, Boolean], fromIndex: __): LodashFindLastFrom2x5[T]
  def findLastFrom[T /* <: js.Object */](
    predicate: ValueIterateeCustom[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      Boolean
  ...
  def findLastFrom[T](predicate: __, fromIndex: Double, collection: typingsJapgolly.lodash.mod.List[T]): LodashFindLastFrom1x6[T]
  def findLastFrom[T](predicate: __, fromIndex: __): LodashFindLastFrom1x4[T]
  def findLastFrom[T /* <: js.Object */](predicate: __, fromIndex: __, collection: T): LodashFindLastFrom3x4[T]
  def findLastFrom[T](predicate: __, fromIndex: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashFindLastFrom1x4[T]
  ...
  def findLastFrom[T, S /* <: T */](predicate: ValueIteratorTypeGuard[T, S], fromIndex: Double): LodashFindLastFrom1x3[T, S]
  def findLastFrom[T /* <: js.Object */, S /* <: /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any */](
    predicate: ValueIteratorTypeGuard[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      S
  ...
  @JSName("findLastFrom")
  def findLastFrom_TS_LodashFindLastFrom3x3[T /* <: js.Object */, S /* <: /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any */](
    predicate: ValueIteratorTypeGuard[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      S
    ],
  ...
  @JSName("findLastFrom")
  def findLastFrom_T_LodashFindLastFrom2x3[T](predicate: ValueIterateeCustom[T, Boolean], fromIndex: Double): LodashFindLastFrom2x3[T]
  @JSName("findLastFrom")
  def findLastFrom_T_LodashFindLastFrom3x4[T /* <: js.Object */](predicate: __, fromIndex: __): LodashFindLastFrom3x4[T]
  @JSName("findLastFrom")
  def findLastFrom_T_LodashFindLastFrom3x6[T /* <: js.Object */](predicate: __, fromIndex: Double): LodashFindLastFrom3x6[T]
  @JSName("findLastFrom")
  def findLastFrom_T_LodashFindLastFrom4x5[T /* <: js.Object */](
    predicate: ValueIterateeCustom[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      Boolean
    ],
  ...
  def findLastIndex[T](predicate: ValueIterateeCustom[T, Boolean], array: typingsJapgolly.lodash.mod.List[T]): Double
  def findLastIndex[T](predicate: __): LodashFindLastIndex1x2[T]
  def findLastIndex[T](predicate: __, array: typingsJapgolly.lodash.mod.List[T]): LodashFindLastIndex1x2[T]
  ...
  def findLastIndexFrom[T](predicate: __, fromIndex: Double, array: typingsJapgolly.lodash.mod.List[T]): LodashFindLastIndexFrom1x6[T]
  def findLastIndexFrom[T](predicate: __, fromIndex: __): LodashFindLastIndexFrom1x4[T]
  def findLastIndexFrom[T](predicate: __, fromIndex: __, array: typingsJapgolly.lodash.mod.List[T]): LodashFindLastIndexFrom1x4[T]
  ...
  def findLastKey[T](predicate: ValueIteratee[T]): LodashFindLastKey1x1[T]
  def findLastKey[T](
    predicate: ValueIteratee[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any
    ],
  ...
  @JSName("findLast")
  def findLast_TS_LodashFindLast3x1[T /* <: js.Object */, S /* <: /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any */](
    predicate: ValueIteratorTypeGuard[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      S
    ]
  ...
  @JSName("find")
  def find_T_LodashFind3x2[T /* <: js.Object */](predicate: __): LodashFind3x2[T]
  @JSName("find")
  def find_T_Union[T](
    predicate: ValueIterateeCustom[
      (/* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any) | T, 
  ...
  def first[T](array: typingsJapgolly.lodash.mod.List[T]): js.UndefOr[T]
  @JSName("first")
  var first_Original: LodashHead
  
  def flatMap(iteratee: java.lang.String): LodashFlatMap3x1
  def flatMap(iteratee: java.lang.String, collection: js.Object): js.Array[Any]
  def flatMap(iteratee: js.Object): LodashFlatMap4x1
  ...
  def flatMap[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashFlatMap1x2[T]
  ...
  def flatMapDeep(iteratee: js.Object): js.Array[Boolean]
  ...
  def flatMapDeep[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashFlatMapDeep1x2[T]
  def flatMapDeep[T, TResult](iteratee: js.Function1[/* value */ T, ListOfRecursiveArraysOrValues[TResult] | TResult]): LodashFlatMapDeep1x1[T, TResult]
  ...
  @JSName("flatMapDeep")
  def flatMapDeep_LodashFlatMapDeep4x1(iteratee: js.Object): LodashFlatMapDeep4x1
  @JSName("flatMapDeep")
  ...
  @JSName("flatMapDeep")
  def flatMapDeep_TTResult_LodashFlatMapDeep2x1[T /* <: js.Object */, TResult](
    iteratee: js.Function1[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ /* value */ js.Any, 
      ListOfRecursiveArraysOrValues[TResult] | TResult
    ]
  ...
  def flatMapDepth(iteratee: js.Object, depth: Double): js.Array[Boolean]
  ...
  def flatMapDepth[T](iteratee: __, depth: Double, collection: typingsJapgolly.lodash.mod.List[T]): LodashFlatMapDepth1x6[T]
  def flatMapDepth[T /* <: js.Object */](iteratee: __, depth: __, collection: T): LodashFlatMapDepth2x4[T]
  def flatMapDepth[T](iteratee: __, depth: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashFlatMapDepth1x4[T]
  def flatMapDepth[T, TResult](iteratee: js.Function1[/* value */ T, ListOfRecursiveArraysOrValues[TResult] | TResult]): LodashFlatMapDepth1x1[T, TResult]
  ...
  @JSName("flatMapDepth")
  def flatMapDepth_LodashFlatMapDepth4x3(iteratee: js.Object, depth: Double): LodashFlatMapDepth4x3
  @JSName("flatMapDepth")
  ...
  @JSName("flatMapDepth")
  def flatMapDepth_TTResult_LodashFlatMapDepth2x1[T /* <: js.Object */, TResult](
    iteratee: js.Function1[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ /* value */ js.Any, 
      ListOfRecursiveArraysOrValues[TResult] | TResult
    ]
  ...
  @JSName("flatMap")
  def flatMap_Array(iteratee: java.lang.String): js.Array[Any]
  @JSName("flatMap")
  def flatMap_Array(iteratee: js.Object): js.Array[Boolean]
  @JSName("flatMap")
  ...
  def flatten[T](array: typingsJapgolly.lodash.mod.List[Many[T]]): js.Array[T]
  ...
  def forEach[T](iteratee: js.Function1[/* value */ T, Any], collection: typingsJapgolly.lodash.mod.List[T]): typingsJapgolly.lodash.mod.List[T]
  ...
  def forEach[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashForEach2x2[T]
  ...
  def forEach[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: Null & TList): LodashForEach5x2[T, TList]
  def forEach[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: Unit & TList): LodashForEach5x2[T, TList]
  ...
  def forEachRight[T](iteratee: js.Function1[/* value */ T, Any], collection: typingsJapgolly.lodash.mod.List[T]): typingsJapgolly.lodash.mod.List[T]
  def forEachRight[T /* <: js.Object */](iteratee: __): LodashForEachRight6x2[T]
  def forEachRight[T /* <: js.Object */](iteratee: __, collection: T): LodashForEachRight3x2[T]
  def forEachRight[T](iteratee: __, collection: js.Array[T]): LodashForEachRight1x2[T]
  def forEachRight[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashForEachRight2x2[T]
  ...
  @JSName("forEachRight")
  def forEachRight_TTList_LodashForEachRight5x2[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: Null & TList): LodashForEachRight5x2[T, TList]
  @JSName("forEachRight")
  def forEachRight_TTList_LodashForEachRight5x2[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T] & TList): LodashForEachRight5x2[T, TList]
  @JSName("forEachRight")
  def forEachRight_TTList_LodashForEachRight5x2[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: Unit & TList): LodashForEachRight5x2[T, TList]
  @JSName("forEachRight")
  def forEachRight_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: typingsJapgolly.lodash.mod.List[T] & TList): TList
  @JSName("forEachRight")
  def forEachRight_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Null & TList): TList
  @JSName("forEachRight")
  def forEachRight_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Unit & TList): TList
  @JSName("forEachRight")
  def forEachRight_T_LodashForEachRight1x1[T](iteratee: js.Function1[/* value */ T, Any]): LodashForEachRight1x1[T]
  @JSName("forEachRight")
  def forEachRight_T_LodashForEachRight6x2[T /* <: js.Object */](iteratee: __, collection: T): LodashForEachRight6x2[T]
  @JSName("forEachRight")
  ...
  @JSName("forEach")
  def forEach_TTArray_LodashForEach4x2[T, TArray /* <: js.UndefOr[js.Array[T] | Null] */](iteratee: __, collection: Unit & TArray): LodashForEach4x2[T, TArray]
  @JSName("forEach")
  def forEach_TTArray_LodashForEach4x2[T, TArray /* <: js.UndefOr[js.Array[T] | Null] */](iteratee: __, collection: Null & TArray): LodashForEach4x2[T, TArray]
  @JSName("forEach")
  ...
  @JSName("forEach")
  def forEach_TTList_LodashForEach5x2[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T] & TList): LodashForEach5x2[T, TList]
  @JSName("forEach")
  def forEach_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Null & TList): TList
  @JSName("forEach")
  def forEach_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: Unit & TList): TList
  @JSName("forEach")
  def forEach_TTList_TList[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: js.Function1[/* value */ T, Any], collection: typingsJapgolly.lodash.mod.List[T] & TList): TList
  @JSName("forEach")
  ...
  def forInRight[T](iteratee: __, `object`: T): LodashForInRight2x2[T]
  @JSName("forInRight")
  ...
  def forOwn[T](iteratee: __, `object`: T): LodashForOwn2x2[T]
  ...
  def fromPairs(pairs: typingsJapgolly.lodash.mod.List[js.Array[Any]]): Dictionary[Any]
  @JSName("fromPairs")
  var fromPairs_Original: LodashFromPairs
  @JSName("fromPairs")
  def fromPairs_T[T](): Dictionary[T]
  @JSName("fromPairs")
  def fromPairs_T[T](pairs: typingsJapgolly.lodash.mod.List[js.Tuple2[PropertyName, T]]): Dictionary[T]
  ...
  def get(path: PropertyPath): Unit
  ...
  def get[T](path: __, `object`: NumericDictionary[T]): LodashGet9x2[T]
  ...
  def get[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](path: js.Tuple2[TKey1, TKey2]): js.UndefOr[
  ...
  def getOr[TObject /* <: js.Object */, TKey /* <: /* keyof TObject */ java.lang.String */, TDefault](defaultValue: TDefault, path: js.Array[TKey]): LodashGetOr1x3[TObject, TKey, TDefault]
  ...
  @JSName("getOr")
  def getOr_TObjectTKey1TKey2TKey3TDefault_Union[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */, TKey3 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1][TKey2] */ js.Any */, TDefault](defaultValue: TDefault, path: js.Tuple3[TKey1, TKey2, TKey3]): (Exclude[
    /* import warning: importer.ImportType#apply Failed type conversion: TObject[TKey1][TKey2][TKey3] */ js.Any, 
    Unit
  ]) | TDefault
  @JSName("getOr")
  ...
  @JSName("getOr")
  def getOr_TObjectTKeyTDefault_Union[TObject /* <: js.Object */, TKey /* <: /* keyof TObject */ java.lang.String */, TDefault](defaultValue: TDefault, path: js.Array[TKey]): (Exclude[
    /* import warning: importer.ImportType#apply Failed type conversion: TObject[TKey] */ js.Any, 
    Unit
  ]) | TDefault
  @JSName("getOr")
  ...
  @JSName("getOr")
  def getOr_TObjectTKey_LodashGetOr1x2[TObject /* <: js.Object */, TKey /* <: /* keyof TObject */ java.lang.String */](defaultValue: __, path: js.Array[TKey]): LodashGetOr1x2[TObject, TKey]
  @JSName("getOr")
  ...
  @JSName("get")
  def get_LodashGet11x1(path: PropertyPath): LodashGet11x1
  @JSName("get")
  ...
  @JSName("get")
  def get_TObjectTKey1TKey2_LodashGet3x1[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](path: js.Tuple2[TKey1, TKey2]): LodashGet3x1[TObject, TKey1, TKey2]
  @JSName("get")
  ...
  @JSName("get")
  def get_T_LodashGet10x2[T](path: __, `object`: NumericDictionary[T]): LodashGet10x2[T]
  @JSName("get")
  ...
  def groupBy[T](iteratee: ValueIteratee[T], collection: typingsJapgolly.lodash.mod.List[T]): Dictionary[js.Array[T]]
  def groupBy[T](iteratee: __): LodashGroupBy1x2[T]
  def groupBy[T /* <: js.Object */](iteratee: __, collection: T): LodashGroupBy2x2[T]
  def groupBy[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashGroupBy1x2[T]
  @JSName("groupBy")
  ...
  @JSName("groupBy")
  def groupBy_T_LodashGroupBy2x2[T /* <: js.Object */](iteratee: __): LodashGroupBy2x2[T]
  ...
  def head[T](array: typingsJapgolly.lodash.mod.List[T]): js.UndefOr[T]
  @JSName("head")
  ...
  def includesFrom[T](target: T, fromIndex: Double): LodashIncludesFrom1x3[T]
  ...
  @JSName("includesFrom")
  def includesFrom_T_Boolean[T](target: T, fromIndex: Double): Boolean
  @JSName("includesFrom")
  ...
  def indexBy[T](iteratee: ValueIterateeCustom[T, PropertyName], collection: typingsJapgolly.lodash.mod.List[T]): Dictionary[T]
  def indexBy[T](iteratee: __): LodashKeyBy1x2[T]
  def indexBy[T /* <: js.Object */](iteratee: __, collection: T): LodashKeyBy2x2[T]
  def indexBy[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashKeyBy1x2[T]
  @JSName("indexBy")
  var indexBy_Original: LodashKeyBy
  @JSName("indexBy")
  def indexBy_T_LodashKeyBy1x1[T](iteratee: ValueIterateeCustom[T, PropertyName]): LodashKeyBy1x1[T]
  @JSName("indexBy")
  def indexBy_T_LodashKeyBy2x2[T /* <: js.Object */](iteratee: __): LodashKeyBy2x2[T]
  
  def indexOf[T](value: T): Double
  def indexOf[T](value: T, array: typingsJapgolly.lodash.mod.List[T]): Double
  def indexOf[T](value: __): LodashIndexOf1x2[T]
  def indexOf[T](value: __, array: typingsJapgolly.lodash.mod.List[T]): LodashIndexOf1x2[T]
  ...
  def indexOfFrom[T](value: T, fromIndex: Double, array: typingsJapgolly.lodash.mod.List[T]): Double
  def indexOfFrom[T](value: T, fromIndex: __): LodashIndexOfFrom1x5
  def indexOfFrom[T](value: T, fromIndex: __, array: typingsJapgolly.lodash.mod.List[T]): LodashIndexOfFrom1x5
  def indexOfFrom[T](value: __, fromIndex: Double, array: typingsJapgolly.lodash.mod.List[T]): LodashIndexOfFrom1x6[T]
  def indexOfFrom[T](value: __, fromIndex: __): LodashIndexOfFrom1x4[T]
  def indexOfFrom[T](value: __, fromIndex: __, array: typingsJapgolly.lodash.mod.List[T]): LodashIndexOfFrom1x4[T]
  @JSName("indexOfFrom")
  ...
  def init[T](array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  @JSName("init")
  var init_Original: LodashInitial
  
  def initial[T](): js.Array[T]
  def initial[T](array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  @JSName("initial")
  var initial_Original: LodashInitial
  
  def intersection[T](): js.Array[T]
  def intersection[T](arrays2: Null, arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def intersection[T](arrays2: Unit, arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def intersection[T](arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def intersection[T](arrays2: typingsJapgolly.lodash.mod.List[T], arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def intersection[T](arrays2: __): LodashIntersection1x2[T]
  def intersection[T](arrays2: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashIntersection1x2[T]
  
  def intersectionBy[T1](iteratee: __): LodashIntersectionBy1x2[T1]
  def intersectionBy[T1](iteratee: __, array: typingsJapgolly.lodash.mod.List[T1]): LodashIntersectionBy1x2[T1]
  def intersectionBy[T2](iteratee: __, array: __, values: typingsJapgolly.lodash.mod.List[T2]): LodashIntersectionBy1x4[T2]
  def intersectionBy[T1, T2](iteratee: ValueIteratee[T1 | T2]): LodashIntersectionBy1x1[T1, T2]
  def intersectionBy[T1, T2](iteratee: ValueIteratee[T1 | T2], array: Null, values: typingsJapgolly.lodash.mod.List[T2]): js.Array[T1]
  def intersectionBy[T1, T2](iteratee: ValueIteratee[T1 | T2], array: typingsJapgolly.lodash.mod.List[T1]): LodashIntersectionBy1x3[T1, T2]
  def intersectionBy[T1, T2](
    iteratee: ValueIteratee[T1 | T2],
    array: typingsJapgolly.lodash.mod.List[T1],
    values: typingsJapgolly.lodash.mod.List[T2]
  ): js.Array[T1]
  def intersectionBy[T1, T2](iteratee: ValueIteratee[T1 | T2], array: __, values: typingsJapgolly.lodash.mod.List[T2]): LodashIntersectionBy1x5[T1]
  def intersectionBy[T1, T2](iteratee: __, array: Null, values: typingsJapgolly.lodash.mod.List[T2]): LodashIntersectionBy1x6[T1, T2]
  def intersectionBy[T1, T2](
    iteratee: __,
    array: typingsJapgolly.lodash.mod.List[T1],
    values: typingsJapgolly.lodash.mod.List[T2]
  ...
  def intersectionWith[T1](comparator: __, array: typingsJapgolly.lodash.mod.List[T1]): LodashIntersectionWith1x2[T1]
  def intersectionWith[T2](comparator: __, array: __, values: typingsJapgolly.lodash.mod.List[T2]): LodashIntersectionWith1x4[T2]
  def intersectionWith[T1, T2](comparator: Comparator2[T1, T2]): LodashIntersectionWith1x3[T1, T2]
  def intersectionWith[T1, T2](comparator: Comparator2[T1, T2], array: Null, values: typingsJapgolly.lodash.mod.List[T2]): js.Array[T1]
  def intersectionWith[T1, T2](comparator: Comparator2[T1, T2], array: Unit, values: typingsJapgolly.lodash.mod.List[T2]): js.Array[T1]
  def intersectionWith[T1, T2](comparator: Comparator2[T1, T2], array: typingsJapgolly.lodash.mod.List[T1]): LodashIntersectionWith1x3[T1, T2]
  def intersectionWith[T1, T2](
    comparator: Comparator2[T1, T2],
    array: typingsJapgolly.lodash.mod.List[T1],
    values: typingsJapgolly.lodash.mod.List[T2]
  ): js.Array[T1]
  def intersectionWith[T1, T2](comparator: Comparator2[T1, T2], array: __, values: typingsJapgolly.lodash.mod.List[T2]): LodashIntersectionWith1x5[T1]
  def intersectionWith[T1, T2](comparator: __, array: Null, values: typingsJapgolly.lodash.mod.List[T2]): LodashIntersectionWith1x6[T1, T2]
  def intersectionWith[T1, T2](comparator: __, array: Unit, values: typingsJapgolly.lodash.mod.List[T2]): LodashIntersectionWith1x6[T1, T2]
  def intersectionWith[T1, T2](
    comparator: __,
    array: typingsJapgolly.lodash.mod.List[T1],
    values: typingsJapgolly.lodash.mod.List[T2]
  ...
  @JSName("intersection")
  def intersection_T_LodashIntersection1x1[T](arrays2: typingsJapgolly.lodash.mod.List[T]): LodashIntersection1x1[T]
  ...
  def invertBy[T](interatee: __): LodashInvertBy1x2[T]
  ...
  @JSName("invertBy")
  def invertBy_T_LodashInvertBy1x1[T](interatee: ValueIteratee[T]): LodashInvertBy1x1[T]
  @JSName("invertBy")
  def invertBy_T_LodashInvertBy2x2[T /* <: js.Object */](interatee: __): LodashInvertBy2x2[T]
  ...
  def invokeArgsMap(methodName: java.lang.String, args: js.Array[Any]): js.Array[Any]
  ...
  @JSName("invokeArgsMap")
  def invokeArgsMap_LodashInvokeArgsMap1x3(methodName: java.lang.String, args: js.Array[Any]): LodashInvokeArgsMap1x3
  @JSName("invokeArgsMap")
  ...
  def isEmpty(value: typingsJapgolly.lodash.mod.List[Any]): Boolean
  ...
  def join(separator: java.lang.String, array: typingsJapgolly.lodash.mod.List[Any]): java.lang.String
  def join(separator: __): LodashJoin1x2
  def join(separator: __, array: typingsJapgolly.lodash.mod.List[Any]): LodashJoin1x2
  @JSName("join")
  def join_LodashJoin1x1(separator: java.lang.String): LodashJoin1x1
  @JSName("join")
  ...
  def keyBy[T](iteratee: ValueIterateeCustom[T, PropertyName], collection: typingsJapgolly.lodash.mod.List[T]): Dictionary[T]
  def keyBy[T](iteratee: __): LodashKeyBy1x2[T]
  def keyBy[T /* <: js.Object */](iteratee: __, collection: T): LodashKeyBy2x2[T]
  def keyBy[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashKeyBy1x2[T]
  @JSName("keyBy")
  var keyBy_Original: LodashKeyBy
  @JSName("keyBy")
  def keyBy_T_LodashKeyBy1x1[T](iteratee: ValueIterateeCustom[T, PropertyName]): LodashKeyBy1x1[T]
  @JSName("keyBy")
  def keyBy_T_LodashKeyBy2x2[T /* <: js.Object */](iteratee: __): LodashKeyBy2x2[T]
  ...
  def last[T](array: typingsJapgolly.lodash.mod.List[T]): js.UndefOr[T]
  
  def lastIndexOf[T](value: T): Double
  def lastIndexOf[T](value: T, array: typingsJapgolly.lodash.mod.List[T]): Double
  def lastIndexOf[T](value: __): LodashLastIndexOf1x2[T]
  def lastIndexOf[T](value: __, array: typingsJapgolly.lodash.mod.List[T]): LodashLastIndexOf1x2[T]
  ...
  def lastIndexOfFrom[T](value: T, fromIndex: Double): LodashLastIndexOfFrom1x3[T]
  def lastIndexOfFrom[T](value: T, fromIndex: Double, array: typingsJapgolly.lodash.mod.List[T]): Double
  def lastIndexOfFrom[T](value: T, fromIndex: __): LodashLastIndexOfFrom1x5
  def lastIndexOfFrom[T](value: T, fromIndex: __, array: typingsJapgolly.lodash.mod.List[T]): LodashLastIndexOfFrom1x5
  def lastIndexOfFrom[T](value: __, fromIndex: Double, array: typingsJapgolly.lodash.mod.List[T]): LodashLastIndexOfFrom1x6[T]
  def lastIndexOfFrom[T](value: __, fromIndex: __): LodashLastIndexOfFrom1x4[T]
  def lastIndexOfFrom[T](value: __, fromIndex: __, array: typingsJapgolly.lodash.mod.List[T]): LodashLastIndexOfFrom1x4[T]
  @JSName("lastIndexOfFrom")
  var lastIndexOfFrom_Original: LodashLastIndexOfFrom
  @JSName("lastIndexOfFrom")
  def lastIndexOfFrom_T_Double[T](value: T, fromIndex: Double): Double
  @JSName("lastIndexOfFrom")
  ...
  @JSName("lastIndexOfFrom")
  def lastIndexOfFrom_true[T](value: T, fromIndex: `true`): LodashLastIndexOfFrom1x3[T]
  @JSName("lastIndexOfFrom")
  def lastIndexOfFrom_true[T](value: T, fromIndex: `true`, array: typingsJapgolly.lodash.mod.List[T]): Double
  @JSName("lastIndexOfFrom")
  def lastIndexOfFrom_true[T](value: __, fromIndex: `true`, array: typingsJapgolly.lodash.mod.List[T]): LodashLastIndexOfFrom1x6[T]
  @JSName("lastIndexOfFrom")
  def lastIndexOfFrom_true_T_Double[T](value: T, fromIndex: `true`): Double
  @JSName("lastIndexOfFrom")
  ...
  def map[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashMap2x2[T]
  ...
  def map[T, TResult](iteratee: js.Function1[/* value */ T, TResult], collection: typingsJapgolly.lodash.mod.List[T]): js.Array[TResult]
  ...
  def mapKeys[T](iteratee: ValueIteratee[Double], `object`: typingsJapgolly.lodash.mod.List[T]): Dictionary[T]
  def mapKeys[T](iteratee: __): LodashMapKeys1x2[T]
  def mapKeys[T /* <: js.Object */](iteratee: __, `object`: T): LodashMapKeys2x2[T]
  def mapKeys[T](iteratee: __, `object`: typingsJapgolly.lodash.mod.List[T]): LodashMapKeys1x2[T]
  @JSName("mapKeys")
  ...
  @JSName("map")
  def map_TK_LodashMap4x1[T, K /* <: /* keyof T */ java.lang.String */](iteratee: K): LodashMap4x1[T, K]
  @JSName("map")
  ...
  @JSName("map")
  def map_T_LodashMap2x2[T](iteratee: __): LodashMap2x2[T]
  @JSName("map")
  ...
  def max[T](collection: typingsJapgolly.lodash.mod.List[T]): js.UndefOr[T]
  
  def maxBy[T](iteratee: ValueIteratee[T]): js.UndefOr[T]
  def maxBy[T](iteratee: ValueIteratee[T], collection: typingsJapgolly.lodash.mod.List[T]): js.UndefOr[T]
  def maxBy[T](iteratee: __): LodashMaxBy1x2[T]
  def maxBy[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashMaxBy1x2[T]
  @JSName("maxBy")
  var maxBy_Original: LodashMaxBy
  @JSName("maxBy")
  def maxBy_T_LodashMaxBy1x1[T](iteratee: ValueIteratee[T]): LodashMaxBy1x1[T]
  
  @JSName("max")
  var max_Original: LodashMax
  
  def mean(): Double
  def mean(collection: typingsJapgolly.lodash.mod.List[Any]): Double
  
  def meanBy[T](iteratee: ValueIteratee[T]): LodashMeanBy1x1[T]
  def meanBy[T](iteratee: ValueIteratee[T], collection: typingsJapgolly.lodash.mod.List[T]): Double
  def meanBy[T](iteratee: __): LodashMeanBy1x2[T]
  def meanBy[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashMeanBy1x2[T]
  @JSName("meanBy")
  var meanBy_Original: LodashMeanBy
  @JSName("meanBy")
  def meanBy_T_Double[T](iteratee: ValueIteratee[T]): Double
  ...
  def min[T](collection: typingsJapgolly.lodash.mod.List[T]): js.UndefOr[T]
  
  def minBy[T](iteratee: ValueIteratee[T]): js.UndefOr[T]
  def minBy[T](iteratee: ValueIteratee[T], collection: typingsJapgolly.lodash.mod.List[T]): js.UndefOr[T]
  def minBy[T](iteratee: __): LodashMinBy1x2[T]
  def minBy[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashMinBy1x2[T]
  @JSName("minBy")
  ...
  def nth[T](n: Double, array: typingsJapgolly.lodash.mod.List[T]): js.UndefOr[T]
  def nth[T](n: __): LodashNth1x2[T]
  def nth[T](n: __, array: typingsJapgolly.lodash.mod.List[T]): LodashNth1x2[T]
  ...
  def omitBy[T](predicate: ValueKeyIteratee[T]): LodashOmitBy1x1[T]
  ...
  @JSName("omitBy")
  def omitBy_T_NumericDictionary[T](predicate: ValueKeyIteratee[T]): NumericDictionary[T]
  @JSName("omitBy")
  ...
  def orderBy[T](iteratees: Many[js.Function1[/* value */ T, NotVoid]], orders: Many[Boolean | asc | desc]): LodashOrderBy1x3[T]
  def orderBy[T](
    iteratees: Many[
      ValueIteratee[
        (/* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any) | T
  ...
  def orderBy[T](iteratees: Many[ValueIteratee[T]], orders: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashOrderBy2x5[T]
  def orderBy[T /* <: js.Object */](iteratees: __, orders: Many[Boolean | asc | desc], collection: T): LodashOrderBy3x6[T]
  def orderBy[T](iteratees: __, orders: Many[Boolean | asc | desc], collection: typingsJapgolly.lodash.mod.List[T]): LodashOrderBy1x6[T]
  ...
  def orderBy[T](iteratees: __, orders: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashOrderBy1x4[T]
  @JSName("orderBy")
  var orderBy_Original: LodashOrderBy
  @JSName("orderBy")
  def orderBy_T_Array[T](
    iteratees: Many[
      js.Function1[
        (/* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ /* value */ js.Any) | (/* value */ T), 
        NotVoid
  ...
  @JSName("orderBy")
  def orderBy_T_LodashOrderBy2x5[T](iteratees: Many[ValueIteratee[T]], orders: __): LodashOrderBy2x5[T]
  @JSName("orderBy")
  ...
  def partial[T1, T2, T3, R](func: Function3[T1, T2, T3, R]): LodashPartial2x1[T1, T2, T3, R]
  ...
  @JSName("partial")
  def partial_TST1R_LodashPartial18x1[TS /* <: js.Array[Any] */, T1, R](func: js.Function2[/* t1 */ T1, /* ts */ TS, R]): LodashPartial18x1[TS, T1, R]
  @JSName("partial")
  def partial_TST1T2R_LodashPartial19x1[TS /* <: js.Array[Any] */, T1, T2, R](func: js.Function3[/* t1 */ T1, /* t2 */ T2, /* ts */ TS, R]): LodashPartial19x1[TS, T1, T2, R]
  @JSName("partial")
  ...
  def partition[T](callback: ValueIteratee[T], collection: typingsJapgolly.lodash.mod.List[T]): js.Tuple2[js.Array[T], js.Array[T]]
  ...
  def partition[T](callback: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashPartition1x2[T]
  def partition[T, U /* <: T */](callback: ValueIteratorTypeGuard[T, U]): js.Tuple2[js.Array[U], js.Array[Exclude[T, U]]]
  def partition[T, U /* <: T */](callback: ValueIteratorTypeGuard[T, U], collection: typingsJapgolly.lodash.mod.List[T]): js.Tuple2[js.Array[U], js.Array[Exclude[T, U]]]
  @JSName("partition")
  ...
  def pathOr[TObject /* <: js.Object */, TKey /* <: /* keyof TObject */ java.lang.String */](defaultValue: __, path: js.Array[TKey]): LodashPathOr1x6[TObject, TKey]
  ...
  def pathOr[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */, TDefault](defaultValue: TDefault, path: js.Tuple2[TKey1, TKey2]): LodashPathOr2x3[TObject, TKey1, TKey2, TDefault]
  ...
  @JSName("pathOr")
  def pathOr_TObjectTKey1TKey2TDefault_Union[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */, TDefault](defaultValue: TDefault, path: js.Tuple2[TKey1, TKey2]): (Exclude[
    /* import warning: importer.ImportType#apply Failed type conversion: TObject[TKey1][TKey2] */ js.Any, 
    Unit
  ]) | TDefault
  @JSName("pathOr")
  ...
  @JSName("pathOr")
  def pathOr_TObjectTKey1TKey2TKey3_LodashPathOr3x6[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */, TKey3 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1][TKey2] */ js.Any */](defaultValue: __, path: js.Tuple3[TKey1, TKey2, TKey3]): LodashPathOr3x6[TObject, TKey1, TKey2, TKey3]
  @JSName("pathOr")
  ...
  @JSName("pathOr")
  def pathOr_TObjectTKey_LodashPathOr1x2[TObject /* <: js.Object */, TKey /* <: /* keyof TObject */ java.lang.String */](defaultValue: __, path: js.Array[TKey]): LodashPathOr1x2[TObject, TKey]
  @JSName("pathOr")
  ...
  @JSName("path")
  def path_TObjectTKey1TKey2_LodashPath3x1[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](path: js.Tuple2[TKey1, TKey2]): LodashPath3x1[TObject, TKey1, TKey2]
  @JSName("path")
  ...
  def paths[T /* <: js.Object */](props: __): LodashAt2x2[T]
  ...
  @JSName("paths")
  def paths_T_LodashAt1x2[T](props: __): LodashAt1x2[T]
  @JSName("paths")
  ...
  def pickBy[T](predicate: ValueKeyIteratee[T]): LodashPickBy3x1[T]
  ...
  def pickBy[T](predicate: __): LodashPickBy1x2[T]
  ...
  def pickBy[T, S /* <: T */](predicate: ValueKeyIterateeTypeGuard[T, S]): Dictionary[S]
  ...
  @JSName("pickBy")
  def pickBy_TS_LodashPickBy1x1[T, S /* <: T */](predicate: ValueKeyIterateeTypeGuard[T, S]): LodashPickBy1x1[T, S]
  @JSName("pickBy")
  ...
  @JSName("pickBy")
  def pickBy_T_LodashPickBy5x2[T /* <: js.Object */](predicate: __): LodashPickBy5x2[T]
  @JSName("pickBy")
  def pickBy_T_NumericDictionary[T](predicate: ValueKeyIteratee[T]): NumericDictionary[T]
  @JSName("pickBy")
  ...
  def placeholder[T /* <: js.UndefOr[Null] */](value: T): Primitive[T]
  def placeholder[T](value: typingsJapgolly.lodash.mod.List[T]): Collection[T]
  @JSName("placeholder")
  var placeholder_Original: __
  @JSName("placeholder")
  def placeholder_T_Collection[T](): Collection[T]
  @JSName("placeholder")
  def placeholder_T_Function[T /* <: js.Function1[/* args */ Any, Any] */](value: T): Function[T]
  @JSName("placeholder")
  ...
  /**
    ...
    **/
  @JSName("placeholder")
  def placeholder_TrapAny_Intersection[TrapAny /* <: typingsJapgolly.lodash.anon.TrapAny */](value: TrapAny): Collection[Any] & Function[Any] & Object[Any] & Primitive[Any] & String
  ...
  def pluck[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashMap2x2[T]
  ...
  def pluck[T, TResult](iteratee: js.Function1[/* value */ T, TResult], collection: typingsJapgolly.lodash.mod.List[T]): js.Array[TResult]
  @JSName("pluck")
  var pluck_Original: LodashMap
  @JSName("pluck")
  def pluck_TK_LodashMap4x1[T, K /* <: /* keyof T */ java.lang.String */](iteratee: K): LodashMap4x1[T, K]
  @JSName("pluck")
  ...
  @JSName("pluck")
  def pluck_T_LodashMap2x2[T](iteratee: __): LodashMap2x2[T]
  @JSName("pluck")
  ...
  def prop[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](path: js.Tuple2[TKey1, TKey2]): LodashProp3x1[TObject, TKey1, TKey2]
  ...
  @JSName("propOr")
  def propOr_TObjectTKeyTDefault_LodashPropOr1x3[TObject /* <: js.Object */, TKey /* <: /* keyof TObject */ java.lang.String */, TDefault](defaultValue: TDefault, path: js.Array[TKey]): LodashPropOr1x3[TObject, TKey, TDefault]
  @JSName("propOr")
  ...
  @JSName("prop")
  def prop_TObjectTKey1TKey2_Union[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ java.lang.String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](path: js.Tuple2[TKey1, TKey2]): js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: TObject[TKey1][TKey2] */ js.Any
  ]
  @JSName("prop")
  ...
  def property(path: PropertyPath): LodashProperty11x1
  ...
  def propertyOf[T](path: __, `object`: NumericDictionary[T]): LodashPropertyOf10x2[T]
  ...
  @JSName("propertyOf")
  def propertyOf_T_LodashPropertyOf9x2[T](path: __, `object`: NumericDictionary[T]): LodashPropertyOf9x2[T]
  @JSName("propertyOf")
  ...
  @JSName("property")
  def property_TObjectTKey_LodashProperty1x1[TObject /* <: js.Object */, TKey /* <: /* keyof TObject */ java.lang.String */](path: js.Array[TKey]): LodashProperty1x1[TObject, TKey]
  @JSName("property")
  ...
  @JSName("property")
  def property_T_LodashProperty9x2[T](path: __, `object`: NumericDictionary[T]): LodashProperty9x2[T]
  @JSName("property")
  def property_T_T[T](path: Double, `object`: NumericDictionary[T]): T
  @JSName("property")
  def property_T_Union[T](path: Double): js.UndefOr[T]
  @JSName("property")
  def property_Unit(path: PropertyPath): Unit
  ...
  def props[T /* <: js.Object */](props: __): LodashAt2x2[T]
  ...
  @JSName("props")
  def props_T_LodashAt1x2[T](props: __): LodashAt1x2[T]
  @JSName("props")
  ...
  def pull[T](values: T, array: typingsJapgolly.lodash.mod.List[T]): typingsJapgolly.lodash.mod.List[T]
  def pull[T](values: __, array: js.Array[T]): LodashPull1x2[T]
  def pull[T](values: __, array: typingsJapgolly.lodash.mod.List[T]): LodashPull2x2[T]
  
  def pullAll[T](values: typingsJapgolly.lodash.mod.List[T]): LodashPullAll1x1[T]
  def pullAll[T](values: typingsJapgolly.lodash.mod.List[T], array: js.Array[T]): js.Array[T]
  def pullAll[T](values: typingsJapgolly.lodash.mod.List[T], array: typingsJapgolly.lodash.mod.List[T]): typingsJapgolly.lodash.mod.List[T]
  def pullAll[T](values: __, array: js.Array[T]): LodashPullAll1x2[T]
  def pullAll[T](values: __, array: typingsJapgolly.lodash.mod.List[T]): LodashPullAll2x2[T]
  
  def pullAllBy[T](iteratee: ValueIteratee[T]): LodashPullAllBy1x1[T]
  def pullAllBy[T](iteratee: ValueIteratee[T], values: typingsJapgolly.lodash.mod.List[T]): LodashPullAllBy1x3[T]
  def pullAllBy[T](iteratee: ValueIteratee[T], values: typingsJapgolly.lodash.mod.List[T], array: js.Array[T]): js.Array[T]
  def pullAllBy[T](
    iteratee: ValueIteratee[T],
    values: typingsJapgolly.lodash.mod.List[T],
    array: typingsJapgolly.lodash.mod.List[T]
  ): typingsJapgolly.lodash.mod.List[T]
  def pullAllBy[T](iteratee: ValueIteratee[T], values: __, array: js.Array[T]): LodashPullAllBy1x5[T]
  def pullAllBy[T](iteratee: ValueIteratee[T], values: __, array: typingsJapgolly.lodash.mod.List[T]): LodashPullAllBy2x5[T]
  def pullAllBy[T2](iteratee: __, values: typingsJapgolly.lodash.mod.List[T2]): LodashPullAllBy3x2[T2]
  def pullAllBy[T](iteratee: __, values: typingsJapgolly.lodash.mod.List[T], array: js.Array[T]): LodashPullAllBy1x6[T]
  def pullAllBy[T](
    iteratee: __,
    values: typingsJapgolly.lodash.mod.List[T],
    array: typingsJapgolly.lodash.mod.List[T]
  ): LodashPullAllBy2x6[T]
  def pullAllBy[T1](iteratee: __, values: __, array: js.Array[T1]): LodashPullAllBy3x4[T1]
  def pullAllBy[T1](iteratee: __, values: __, array: typingsJapgolly.lodash.mod.List[T1]): LodashPullAllBy4x4[T1]
  @JSName("pullAllBy")
  var pullAllBy_Original: LodashPullAllBy
  @JSName("pullAllBy")
  def pullAllBy_T1T2[T1, T2](iteratee: ValueIteratee[T1 | T2], values: typingsJapgolly.lodash.mod.List[T2], array: js.Array[T1]): js.Array[T1]
  @JSName("pullAllBy")
  def pullAllBy_T1T2[T1, T2](
    iteratee: ValueIteratee[T1 | T2],
    values: typingsJapgolly.lodash.mod.List[T2],
    array: typingsJapgolly.lodash.mod.List[T1]
  ): typingsJapgolly.lodash.mod.List[T1]
  @JSName("pullAllBy")
  def pullAllBy_T1T2_LodashPullAllBy3x1[T1, T2](iteratee: ValueIteratee[T1 | T2]): LodashPullAllBy3x1[T1, T2]
  @JSName("pullAllBy")
  def pullAllBy_T1T2_LodashPullAllBy3x3[T1, T2](iteratee: ValueIteratee[T1 | T2], values: typingsJapgolly.lodash.mod.List[T2]): LodashPullAllBy3x3[T1]
  @JSName("pullAllBy")
  ...
  @JSName("pullAllBy")
  def pullAllBy_T1T2_LodashPullAllBy3x6[T1, T2](iteratee: __, values: typingsJapgolly.lodash.mod.List[T2], array: js.Array[T1]): LodashPullAllBy3x6[T1, T2]
  @JSName("pullAllBy")
  def pullAllBy_T1T2_LodashPullAllBy4x5[T1, T2](iteratee: ValueIteratee[T1 | T2], values: __, array: typingsJapgolly.lodash.mod.List[T1]): LodashPullAllBy4x5[T1, T2]
  @JSName("pullAllBy")
  def pullAllBy_T1T2_LodashPullAllBy4x6[T1, T2](
    iteratee: __,
    values: typingsJapgolly.lodash.mod.List[T2],
    array: typingsJapgolly.lodash.mod.List[T1]
  ): LodashPullAllBy4x6[T1, T2]
  @JSName("pullAllBy")
  def pullAllBy_T_LodashPullAllBy1x2[T](iteratee: __, values: typingsJapgolly.lodash.mod.List[T]): LodashPullAllBy1x2[T]
  @JSName("pullAllBy")
  def pullAllBy_T_LodashPullAllBy1x4[T](iteratee: __, values: __, array: js.Array[T]): LodashPullAllBy1x4[T]
  @JSName("pullAllBy")
  def pullAllBy_T_LodashPullAllBy2x4[T](iteratee: __, values: __, array: typingsJapgolly.lodash.mod.List[T]): LodashPullAllBy2x4[T]
  
  def pullAllWith[T](comparator: Comparator[T]): LodashPullAllWith1x1[T]
  def pullAllWith[T](comparator: Comparator[T], values: typingsJapgolly.lodash.mod.List[T]): LodashPullAllWith1x3[T]
  def pullAllWith[T](comparator: Comparator[T], values: typingsJapgolly.lodash.mod.List[T], array: js.Array[T]): js.Array[T]
  def pullAllWith[T](
  ...
  def pullAllWith[T](comparator: Comparator[T], values: __, array: typingsJapgolly.lodash.mod.List[T]): LodashPullAllWith2x5[T]
  def pullAllWith[T](comparator: __, values: typingsJapgolly.lodash.mod.List[T]): LodashPullAllWith1x2[T]
  def pullAllWith[T](comparator: __, values: typingsJapgolly.lodash.mod.List[T], array: js.Array[T]): LodashPullAllWith1x6[T]
  def pullAllWith[T](
    comparator: __,
    values: typingsJapgolly.lodash.mod.List[T],
    array: typingsJapgolly.lodash.mod.List[T]
  ): LodashPullAllWith2x6[T]
  def pullAllWith[T1](comparator: __, values: __, array: js.Array[T1]): LodashPullAllWith3x4[T1]
  def pullAllWith[T](comparator: __, values: __, array: typingsJapgolly.lodash.mod.List[T]): LodashPullAllWith2x4[T]
  @JSName("pullAllWith")
  var pullAllWith_Original: LodashPullAllWith
  @JSName("pullAllWith")
  def pullAllWith_T1T2[T1, T2](comparator: Comparator2[T1, T2], values: typingsJapgolly.lodash.mod.List[T2], array: js.Array[T1]): js.Array[T1]
  @JSName("pullAllWith")
  ...
  @JSName("pullAllWith")
  def pullAllWith_T1T2_LodashPullAllWith3x3[T1, T2](comparator: Comparator2[T1, T2], values: typingsJapgolly.lodash.mod.List[T2]): LodashPullAllWith3x3[T1]
  @JSName("pullAllWith")
  ...
  @JSName("pullAllWith")
  def pullAllWith_T1T2_LodashPullAllWith3x6[T1, T2](comparator: __, values: typingsJapgolly.lodash.mod.List[T2], array: js.Array[T1]): LodashPullAllWith3x6[T1, T2]
  @JSName("pullAllWith")
  def pullAllWith_T1T2_LodashPullAllWith4x5[T1, T2](comparator: Comparator2[T1, T2], values: __, array: typingsJapgolly.lodash.mod.List[T1]): LodashPullAllWith4x5[T1, T2]
  @JSName("pullAllWith")
  def pullAllWith_T1T2_LodashPullAllWith4x6[T1, T2](
    comparator: __,
    values: typingsJapgolly.lodash.mod.List[T2],
    array: typingsJapgolly.lodash.mod.List[T1]
  ): LodashPullAllWith4x6[T1, T2]
  @JSName("pullAllWith")
  def pullAllWith_T1_LodashPullAllWith4x4[T1](comparator: __, values: __, array: typingsJapgolly.lodash.mod.List[T1]): LodashPullAllWith4x4[T1]
  @JSName("pullAllWith")
  def pullAllWith_T2_LodashPullAllWith3x2[T2](comparator: __, values: typingsJapgolly.lodash.mod.List[T2]): LodashPullAllWith3x2[T2]
  @JSName("pullAllWith")
  def pullAllWith_T_LodashPullAllWith1x4[T](comparator: __, values: __, array: js.Array[T]): LodashPullAllWith1x4[T]
  ...
  def pullAt[T](indexes: Many[Double], array: typingsJapgolly.lodash.mod.List[T]): typingsJapgolly.lodash.mod.List[T]
  def pullAt[T](indexes: __, array: js.Array[T]): LodashPullAt1x2[T]
  def pullAt[T](indexes: __, array: typingsJapgolly.lodash.mod.List[T]): LodashPullAt2x2[T]
  @JSName("pullAt")
  ...
  def reduce[T](callback: __, accumulator: __): LodashReduce1x4[T]
  ...
  def reduce[T](callback: __, accumulator: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashReduce2x4[T]
  ...
  def reduce[T, TResult](callback: __, accumulator: TResult, collection: typingsJapgolly.lodash.mod.List[T]): LodashReduce2x6[T, TResult]
  
  def reduceRight[TResult](callback: __, accumulator: TResult): LodashReduceRight1x2[TResult]
  def reduceRight[T](callback: __, accumulator: __): LodashReduceRight1x4[T]
  ...
  def reduceRight[T](callback: __, accumulator: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashReduceRight2x4[T]
  ...
  def reduceRight[T, TResult](callback: MemoIteratorCappedRight[T, TResult], accumulator: __): LodashReduceRight1x5[TResult]
  def reduceRight[T /* <: js.Object */, TResult](
    callback: MemoIteratorCappedRight[
      /* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any, 
      TResult
  ...
  def reduceRight[T, TResult](callback: __, accumulator: TResult, collection: typingsJapgolly.lodash.mod.List[T]): LodashReduceRight2x6[T, TResult]
  @JSName("reduceRight")
  ...
  @JSName("reduceRight")
  def reduceRight_TTResult_LodashReduceRight2x5[T, TResult](callback: MemoIteratorCappedRight[T, TResult], accumulator: __): LodashReduceRight2x5[TResult]
  @JSName("reduceRight")
  ...
  @JSName("reduceRight")
  def reduceRight_T_LodashReduceRight3x4[T /* <: js.Object */](callback: __, accumulator: __): LodashReduceRight3x4[T]
  ...
  @JSName("reduce")
  def reduce_TTResult_LodashReduce1x5[T, TResult](callback: MemoIteratorCapped[T, TResult], accumulator: __): LodashReduce1x5[TResult]
  @JSName("reduce")
  ...
  @JSName("reduce")
  def reduce_T_LodashReduce2x4[T](callback: __, accumulator: __): LodashReduce2x4[T]
  @JSName("reduce")
  def reduce_T_LodashReduce3x4[T /* <: js.Object */](callback: __, accumulator: __): LodashReduce3x4[T]
  
  def reject[T](predicate: ValueIterateeCustom[T, Boolean]): LodashReject1x1[T]
  ...
  def reject[T](predicate: ValueIterateeCustom[T, Boolean], collection: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def reject[T /* <: js.Object */](predicate: __): LodashReject2x2[T]
  def reject[T /* <: js.Object */](predicate: __, collection: T): LodashReject2x2[T]
  def reject[T](predicate: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashReject1x2[T]
  @JSName("reject")
  var reject_Original: LodashReject
  @JSName("reject")
  def reject_T_Array[T](
    predicate: ValueIterateeCustom[
      (/* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any) | T, 
      Boolean
    ]
  ...
  def remove[T](predicate: ValueIteratee[T], array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def remove[T](predicate: __, array: typingsJapgolly.lodash.mod.List[T]): LodashRemove1x2[T]
  @JSName("remove")
  ...
  def reverse[TList /* <: typingsJapgolly.lodash.mod.List[Any] */](array: TList): TList
  @JSName("reverse")
  ...
  def shuffle[T](collection: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  @JSName("shuffle")
  ...
  def slice[T](start: Double, end: Double, array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def slice[T](start: Double, end: __): LodashSlice1x5[T]
  def slice[T](start: Double, end: __, array: typingsJapgolly.lodash.mod.List[T]): LodashSlice1x5[T]
  def slice[T](start: __, end: Double, array: typingsJapgolly.lodash.mod.List[T]): LodashSlice1x6[T]
  def slice[T](start: __, end: __): LodashSlice1x4[T]
  def slice[T](start: __, end: __, array: typingsJapgolly.lodash.mod.List[T]): LodashSlice1x4[T]
  @JSName("slice")
  ...
  def some[T](predicate: ValueIterateeCustom[T, Boolean]): LodashSome1x1[T]
  ...
  def some[T](predicate: ValueIterateeCustom[T, Boolean], collection: typingsJapgolly.lodash.mod.List[T]): Boolean
  def some[T /* <: js.Object */](predicate: __): LodashSome2x2[T]
  def some[T /* <: js.Object */](predicate: __, collection: T): LodashSome2x2[T]
  def some[T](predicate: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashSome1x2[T]
  @JSName("some")
  var some_Original: LodashSome
  @JSName("some")
  def some_T_Boolean[T](
    predicate: ValueIterateeCustom[
      (/* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any) | T, 
      Boolean
    ]
  ...
  @JSName("some")
  def some_T_LodashSome1x2[T](predicate: __): LodashSome1x2[T]
  
  def sortBy[T](iteratees: Many[ValueIteratee[T]]): LodashSortBy1x1[T]
  ...
  def sortBy[T](iteratees: Many[ValueIteratee[T]], collection: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def sortBy[T /* <: js.Object */](iteratees: __): LodashSortBy2x2[T]
  def sortBy[T /* <: js.Object */](iteratees: __, collection: T): LodashSortBy2x2[T]
  def sortBy[T](iteratees: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashSortBy1x2[T]
  @JSName("sortBy")
  var sortBy_Original: LodashSortBy
  @JSName("sortBy")
  def sortBy_T_Array[T](
    iteratees: Many[
      ValueIteratee[
        (/* import warning: importer.ImportType#apply Failed type conversion: T[keyof T] */ js.Any) | T
      ]
  ...
  def sortedIndex[T](value: T, array: typingsJapgolly.lodash.mod.List[T]): Double
  def sortedIndex[T](value: __): LodashSortedIndex1x2[T]
  def sortedIndex[T](value: __, array: typingsJapgolly.lodash.mod.List[T]): LodashSortedIndex1x2[T]
  ...
  def sortedIndexBy[T](iteratee: ValueIteratee[T], value: T, array: typingsJapgolly.lodash.mod.List[T]): Double
  def sortedIndexBy[T](iteratee: ValueIteratee[T], value: __): LodashSortedIndexBy1x5[T]
  def sortedIndexBy[T](iteratee: ValueIteratee[T], value: __, array: typingsJapgolly.lodash.mod.List[T]): LodashSortedIndexBy1x5[T]
  def sortedIndexBy[T](iteratee: __, value: T): LodashSortedIndexBy1x6[T]
  def sortedIndexBy[T](iteratee: __, value: T, array: typingsJapgolly.lodash.mod.List[T]): LodashSortedIndexBy1x6[T]
  def sortedIndexBy[T](iteratee: __, value: __): LodashSortedIndexBy1x4[T]
  def sortedIndexBy[T](iteratee: __, value: __, array: typingsJapgolly.lodash.mod.List[T]): LodashSortedIndexBy1x4[T]
  @JSName("sortedIndexBy")
  var sortedIndexBy_Original: LodashSortedIndexBy
  @JSName("sortedIndexBy")
  def sortedIndexBy_T_LodashSortedIndexBy1x2[T](iteratee: __, value: T): LodashSortedIndexBy1x2[T]
  @JSName("sortedIndexBy")
  def sortedIndexBy_T_LodashSortedIndexBy1x3[T](iteratee: ValueIteratee[T], value: T): LodashSortedIndexBy1x3[T]
  
  def sortedIndexOf[T](value: T): Double
  def sortedIndexOf[T](value: T, array: typingsJapgolly.lodash.mod.List[T]): Double
  def sortedIndexOf[T](value: __): LodashSortedIndexOf1x2[T]
  def sortedIndexOf[T](value: __, array: typingsJapgolly.lodash.mod.List[T]): LodashSortedIndexOf1x2[T]
  @JSName("sortedIndexOf")
  var sortedIndexOf_Original: LodashSortedIndexOf
  @JSName("sortedIndexOf")
  def sortedIndexOf_T_LodashSortedIndexOf1x1[T](value: T): LodashSortedIndexOf1x1[T]
  ...
  def sortedLastIndex[T](value: T): Double
  def sortedLastIndex[T](value: T, array: typingsJapgolly.lodash.mod.List[T]): Double
  def sortedLastIndex[T](value: __): LodashSortedLastIndex1x2[T]
  def sortedLastIndex[T](value: __, array: typingsJapgolly.lodash.mod.List[T]): LodashSortedLastIndex1x2[T]
  
  def sortedLastIndexBy[T](iteratee: ValueIteratee[T]): LodashSortedLastIndexBy1x1[T]
  def sortedLastIndexBy[T](iteratee: ValueIteratee[T], value: T): Double
  def sortedLastIndexBy[T](iteratee: ValueIteratee[T], value: T, array: typingsJapgolly.lodash.mod.List[T]): Double
  def sortedLastIndexBy[T](iteratee: ValueIteratee[T], value: __): LodashSortedLastIndexBy1x5[T]
  def sortedLastIndexBy[T](iteratee: ValueIteratee[T], value: __, array: typingsJapgolly.lodash.mod.List[T]): LodashSortedLastIndexBy1x5[T]
  def sortedLastIndexBy[T](iteratee: __, value: T): LodashSortedLastIndexBy1x2[T]
  def sortedLastIndexBy[T](iteratee: __, value: T, array: typingsJapgolly.lodash.mod.List[T]): LodashSortedLastIndexBy1x6[T]
  def sortedLastIndexBy[T](iteratee: __, value: __): LodashSortedLastIndexBy1x4[T]
  def sortedLastIndexBy[T](iteratee: __, value: __, array: typingsJapgolly.lodash.mod.List[T]): LodashSortedLastIndexBy1x4[T]
  @JSName("sortedLastIndexBy")
  var sortedLastIndexBy_Original: LodashSortedLastIndexBy
  @JSName("sortedLastIndexBy")
  def sortedLastIndexBy_T_LodashSortedLastIndexBy1x3[T](iteratee: ValueIteratee[T], value: T): LodashSortedLastIndexBy1x3[T]
  @JSName("sortedLastIndexBy")
  def sortedLastIndexBy_T_LodashSortedLastIndexBy1x6[T](iteratee: __, value: T): LodashSortedLastIndexBy1x6[T]
  
  def sortedLastIndexOf[T](value: T): LodashSortedLastIndexOf1x1[T]
  def sortedLastIndexOf[T](value: T, array: typingsJapgolly.lodash.mod.List[T]): Double
  def sortedLastIndexOf[T](value: __): LodashSortedLastIndexOf1x2[T]
  def sortedLastIndexOf[T](value: __, array: typingsJapgolly.lodash.mod.List[T]): LodashSortedLastIndexOf1x2[T]
  @JSName("sortedLastIndexOf")
  var sortedLastIndexOf_Original: LodashSortedLastIndexOf
  @JSName("sortedLastIndexOf")
  def sortedLastIndexOf_T_Double[T](value: T): Double
  
  @JSName("sortedLastIndex")
  var sortedLastIndex_Original: LodashSortedLastIndex
  @JSName("sortedLastIndex")
  def sortedLastIndex_T_LodashSortedLastIndex1x1[T](value: T): LodashSortedLastIndex1x1[T]
  
  def sortedUniq[T](): js.Array[T]
  def sortedUniq[T](array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  
  def sortedUniqBy[T](iteratee: ValueIteratee[T]): LodashSortedUniqBy1x1[T]
  def sortedUniqBy[T](iteratee: ValueIteratee[T], array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def sortedUniqBy[T](iteratee: __): LodashSortedUniqBy1x2[T]
  def sortedUniqBy[T](iteratee: __, array: typingsJapgolly.lodash.mod.List[T]): LodashSortedUniqBy1x2[T]
  @JSName("sortedUniqBy")
  var sortedUniqBy_Original: LodashSortedUniqBy
  @JSName("sortedUniqBy")
  def sortedUniqBy_T_Array[T](iteratee: ValueIteratee[T]): js.Array[T]
  
  @JSName("sortedUniq")
  var sortedUniq_Original: LodashSortedUniq
  
  def split(separator: java.lang.String): js.Array[java.lang.String]
  def split(separator: java.lang.String, string: java.lang.String): js.Array[java.lang.String]
  def split(separator: js.RegExp): js.Array[java.lang.String]
  ...
  @JSName("split")
  def split_LodashSplit1x1(separator: java.lang.String): LodashSplit1x1
  @JSName("split")
  def split_LodashSplit1x1(separator: js.RegExp): LodashSplit1x1
  @JSName("split")
  ...
  def sum(): Double
  def sum(collection: typingsJapgolly.lodash.mod.List[Any]): Double
  
  def sumBy[T](iteratee: java.lang.String): Double
  def sumBy[T](iteratee: java.lang.String, collection: typingsJapgolly.lodash.mod.List[T]): Double
  def sumBy[T](iteratee: js.Function1[/* value */ T, Double]): Double
  def sumBy[T](iteratee: js.Function1[/* value */ T, Double], collection: typingsJapgolly.lodash.mod.List[T]): Double
  def sumBy[T](iteratee: __): LodashSumBy1x2[T]
  def sumBy[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashSumBy1x2[T]
  @JSName("sumBy")
  var sumBy_Original: LodashSumBy
  @JSName("sumBy")
  def sumBy_T_LodashSumBy1x1[T](iteratee: java.lang.String): LodashSumBy1x1[T]
  @JSName("sumBy")
  def sumBy_T_LodashSumBy1x1[T](iteratee: js.Function1[/* value */ T, Double]): LodashSumBy1x1[T]
  
  @JSName("sum")
  var sum_Original: LodashSum
  
  def symmetricDifference[T](): LodashXor1x1[T]
  def symmetricDifference[T](arrays2: Null, arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def symmetricDifference[T](arrays2: Unit, arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def symmetricDifference[T](arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXor1x1[T]
  def symmetricDifference[T](arrays2: typingsJapgolly.lodash.mod.List[T], arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def symmetricDifference[T](arrays2: __): LodashXor1x2[T]
  def symmetricDifference[T](arrays2: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashXor1x2[T]
  
  def symmetricDifferenceBy[T](iteratee: ValueIteratee[T]): LodashXorBy1x3[T]
  def symmetricDifferenceBy[T](iteratee: ValueIteratee[T], arrays: Null, arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def symmetricDifferenceBy[T](iteratee: ValueIteratee[T], arrays: Unit, arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def symmetricDifferenceBy[T](iteratee: ValueIteratee[T], arrays: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x3[T]
  def symmetricDifferenceBy[T](
    iteratee: ValueIteratee[T],
    arrays: typingsJapgolly.lodash.mod.List[T],
    arrays2: typingsJapgolly.lodash.mod.List[T]
  ): js.Array[T]
  def symmetricDifferenceBy[T](iteratee: ValueIteratee[T], arrays: __): LodashXorBy1x5[T]
  def symmetricDifferenceBy[T](iteratee: ValueIteratee[T], arrays: __, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x5[T]
  def symmetricDifferenceBy[T](iteratee: __): LodashXorBy1x6[T]
  def symmetricDifferenceBy[T](iteratee: __, arrays: Null, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x6[T]
  def symmetricDifferenceBy[T](iteratee: __, arrays: Unit, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x6[T]
  def symmetricDifferenceBy[T](iteratee: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x6[T]
  def symmetricDifferenceBy[T](
    iteratee: __,
    arrays: typingsJapgolly.lodash.mod.List[T],
    arrays2: typingsJapgolly.lodash.mod.List[T]
  ...
  def symmetricDifferenceBy[T](iteratee: __, arrays: __, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x4[T]
  ...
  @JSName("symmetricDifferenceBy")
  def symmetricDifferenceBy_T_Array[T](iteratee: ValueIteratee[T], arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  @JSName("symmetricDifferenceBy")
  def symmetricDifferenceBy_T_LodashXorBy1x1[T](iteratee: ValueIteratee[T]): LodashXorBy1x1[T]
  @JSName("symmetricDifferenceBy")
  def symmetricDifferenceBy_T_LodashXorBy1x2[T](iteratee: __): LodashXorBy1x2[T]
  @JSName("symmetricDifferenceBy")
  def symmetricDifferenceBy_T_LodashXorBy1x2[T](iteratee: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x2[T]
  
  def symmetricDifferenceWith[T](comparator: Comparator[T]): LodashXorWith1x1[T]
  def symmetricDifferenceWith[T](comparator: Comparator[T], arrays: Null, arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def symmetricDifferenceWith[T](comparator: Comparator[T], arrays: Unit, arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def symmetricDifferenceWith[T](comparator: Comparator[T], arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  ...
  def symmetricDifferenceWith[T](comparator: Comparator[T], arrays: __, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x5[T]
  def symmetricDifferenceWith[T](comparator: __): LodashXorWith1x6[T]
  def symmetricDifferenceWith[T](comparator: __, arrays: Null, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x6[T]
  def symmetricDifferenceWith[T](comparator: __, arrays: Unit, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x6[T]
  def symmetricDifferenceWith[T](comparator: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x6[T]
  def symmetricDifferenceWith[T](
    comparator: __,
    arrays: typingsJapgolly.lodash.mod.List[T],
    arrays2: typingsJapgolly.lodash.mod.List[T]
  ...
  def symmetricDifferenceWith[T](comparator: __, arrays: __, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x4[T]
  ...
  @JSName("symmetricDifferenceWith")
  def symmetricDifferenceWith_T_LodashXorWith1x2[T](comparator: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x2[T]
  @JSName("symmetricDifferenceWith")
  def symmetricDifferenceWith_T_LodashXorWith1x3[T](comparator: Comparator[T]): LodashXorWith1x3[T]
  @JSName("symmetricDifferenceWith")
  def symmetricDifferenceWith_T_LodashXorWith1x3[T](comparator: Comparator[T], arrays: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x3[T]
  
  @JSName("symmetricDifference")
  var symmetricDifference_Original: LodashXor
  @JSName("symmetricDifference")
  def symmetricDifference_T_Array[T](): js.Array[T]
  @JSName("symmetricDifference")
  def symmetricDifference_T_Array[T](arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  
  def tail[T](): js.Array[T]
  def tail[T](array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  @JSName("tail")
  var tail_Original: LodashTail
  
  def take(n: Double): LodashTake1x1
  def take[T](n: Double, array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def take[T](n: __): LodashTake1x2[T]
  def take[T](n: __, array: typingsJapgolly.lodash.mod.List[T]): LodashTake1x2[T]
  
  def takeLast(n: Double): LodashTakeRight1x1
  def takeLast[T](n: Double, array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def takeLast[T](n: __): LodashTakeRight1x2[T]
  def takeLast[T](n: __, array: typingsJapgolly.lodash.mod.List[T]): LodashTakeRight1x2[T]
  
  def takeLastWhile[T](predicate: ValueIteratee[T]): LodashTakeRightWhile1x1[T]
  def takeLastWhile[T](predicate: ValueIteratee[T], array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def takeLastWhile[T](predicate: __): LodashTakeRightWhile1x2[T]
  def takeLastWhile[T](predicate: __, array: typingsJapgolly.lodash.mod.List[T]): LodashTakeRightWhile1x2[T]
  @JSName("takeLastWhile")
  var takeLastWhile_Original: LodashTakeRightWhile
  @JSName("takeLastWhile")
  def takeLastWhile_T_Array[T](predicate: ValueIteratee[T]): js.Array[T]
  ...
  def takeRight[T](n: Double, array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def takeRight[T](n: __): LodashTakeRight1x2[T]
  def takeRight[T](n: __, array: typingsJapgolly.lodash.mod.List[T]): LodashTakeRight1x2[T]
  
  def takeRightWhile[T](predicate: ValueIteratee[T]): LodashTakeRightWhile1x1[T]
  def takeRightWhile[T](predicate: ValueIteratee[T], array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def takeRightWhile[T](predicate: __): LodashTakeRightWhile1x2[T]
  def takeRightWhile[T](predicate: __, array: typingsJapgolly.lodash.mod.List[T]): LodashTakeRightWhile1x2[T]
  @JSName("takeRightWhile")
  var takeRightWhile_Original: LodashTakeRightWhile
  @JSName("takeRightWhile")
  def takeRightWhile_T_Array[T](predicate: ValueIteratee[T]): js.Array[T]
  ...
  def takeWhile[T](predicate: ValueIteratee[T]): LodashTakeWhile1x1[T]
  def takeWhile[T](predicate: ValueIteratee[T], array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def takeWhile[T](predicate: __): LodashTakeWhile1x2[T]
  def takeWhile[T](predicate: __, array: typingsJapgolly.lodash.mod.List[T]): LodashTakeWhile1x2[T]
  @JSName("takeWhile")
  var takeWhile_Original: LodashTakeWhile
  @JSName("takeWhile")
  def takeWhile_T_Array[T](predicate: ValueIteratee[T]): js.Array[T]
  ...
  def union[T](arrays2: Null, arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def union[T](arrays2: Unit, arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def union[T](arrays2: typingsJapgolly.lodash.mod.List[T]): LodashUnion1x1[T]
  def union[T](arrays2: typingsJapgolly.lodash.mod.List[T], arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def union[T](arrays2: __): LodashUnion1x2[T]
  def union[T](arrays2: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashUnion1x2[T]
  
  def unionBy[T](iteratee: ValueIteratee[T]): js.Array[T]
  def unionBy[T](iteratee: ValueIteratee[T], arrays1: Null, arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def unionBy[T](iteratee: ValueIteratee[T], arrays1: Unit, arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def unionBy[T](iteratee: ValueIteratee[T], arrays1: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def unionBy[T](
    iteratee: ValueIteratee[T],
    arrays1: typingsJapgolly.lodash.mod.List[T],
    arrays2: typingsJapgolly.lodash.mod.List[T]
  ): js.Array[T]
  def unionBy[T](iteratee: ValueIteratee[T], arrays1: __): LodashUnionBy1x5[T]
  def unionBy[T](iteratee: ValueIteratee[T], arrays1: __, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashUnionBy1x5[T]
  def unionBy[T](iteratee: __): LodashUnionBy1x2[T]
  def unionBy[T](iteratee: __, arrays1: Null, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashUnionBy1x6[T]
  def unionBy[T](iteratee: __, arrays1: Unit, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashUnionBy1x6[T]
  def unionBy[T](iteratee: __, arrays1: typingsJapgolly.lodash.mod.List[T]): LodashUnionBy1x2[T]
  def unionBy[T](
    iteratee: __,
    arrays1: typingsJapgolly.lodash.mod.List[T],
    arrays2: typingsJapgolly.lodash.mod.List[T]
  ...
  def unionBy[T](iteratee: __, arrays1: __, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashUnionBy1x4[T]
  @JSName("unionBy")
  ...
  @JSName("unionBy")
  def unionBy_T_LodashUnionBy1x3[T](iteratee: ValueIteratee[T], arrays1: typingsJapgolly.lodash.mod.List[T]): LodashUnionBy1x3[T]
  @JSName("unionBy")
  def unionBy_T_LodashUnionBy1x6[T](iteratee: __): LodashUnionBy1x6[T]
  @JSName("unionBy")
  def unionBy_T_LodashUnionBy1x6[T](iteratee: __, arrays1: typingsJapgolly.lodash.mod.List[T]): LodashUnionBy1x6[T]
  
  def unionWith[T](comparator: Comparator[T]): LodashUnionWith1x3[T]
  def unionWith[T](comparator: Comparator[T], arrays: Null, arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def unionWith[T](comparator: Comparator[T], arrays: Unit, arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def unionWith[T](comparator: Comparator[T], arrays: typingsJapgolly.lodash.mod.List[T]): LodashUnionWith1x3[T]
  def unionWith[T](
    comparator: Comparator[T],
    arrays: typingsJapgolly.lodash.mod.List[T],
    arrays2: typingsJapgolly.lodash.mod.List[T]
  ...
  def unionWith[T](comparator: Comparator[T], arrays: __, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashUnionWith1x5[T]
  def unionWith[T](comparator: __): LodashUnionWith1x6[T]
  def unionWith[T](comparator: __, arrays: Null, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashUnionWith1x6[T]
  def unionWith[T](comparator: __, arrays: Unit, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashUnionWith1x6[T]
  def unionWith[T](comparator: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashUnionWith1x6[T]
  def unionWith[T](
    comparator: __,
    arrays: typingsJapgolly.lodash.mod.List[T],
    arrays2: typingsJapgolly.lodash.mod.List[T]
  ...
  def unionWith[T](comparator: __, arrays: __, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashUnionWith1x4[T]
  @JSName("unionWith")
  var unionWith_Original: LodashUnionWith
  @JSName("unionWith")
  def unionWith_T_Array[T](comparator: Comparator[T]): js.Array[T]
  @JSName("unionWith")
  def unionWith_T_Array[T](comparator: Comparator[T], arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  @JSName("unionWith")
  ...
  @JSName("unionWith")
  def unionWith_T_LodashUnionWith1x2[T](comparator: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashUnionWith1x2[T]
  ...
  @JSName("union")
  def union_T_Array[T](arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  
  def uniq[T](): js.Array[T]
  def uniq[T](array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  
  def uniqBy[T](iteratee: ValueIteratee[T]): js.Array[T]
  def uniqBy[T](iteratee: ValueIteratee[T], array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def uniqBy[T](iteratee: __): LodashUniqBy1x2[T]
  def uniqBy[T](iteratee: __, array: typingsJapgolly.lodash.mod.List[T]): LodashUniqBy1x2[T]
  @JSName("uniqBy")
  var uniqBy_Original: LodashUniqBy
  @JSName("uniqBy")
  def uniqBy_T_LodashUniqBy1x1[T](iteratee: ValueIteratee[T]): LodashUniqBy1x1[T]
  
  def uniqWith[T](comparator: Comparator[T]): LodashUniqWith1x1[T]
  def uniqWith[T](comparator: Comparator[T], array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def uniqWith[T](comparator: __): LodashUniqWith1x2[T]
  def uniqWith[T](comparator: __, array: typingsJapgolly.lodash.mod.List[T]): LodashUniqWith1x2[T]
  @JSName("uniqWith")
  var uniqWith_Original: LodashUniqWith
  @JSName("uniqWith")
  def uniqWith_T_Array[T](comparator: Comparator[T]): js.Array[T]
  ...
  def unnest[T](array: typingsJapgolly.lodash.mod.List[Many[T]]): js.Array[T]
  @JSName("unnest")
  ...
  def unzip[T](array: typingsJapgolly.lodash.mod.List[typingsJapgolly.lodash.mod.List[T]]): js.Array[js.Array[T]]
  
  def unzipWith[T](iteratee: __): LodashUnzipWith1x2[T]
  def unzipWith[T](iteratee: __, array: typingsJapgolly.lodash.mod.List[typingsJapgolly.lodash.mod.List[T]]): LodashUnzipWith1x2[T]
  def unzipWith[T, TResult](iteratee: js.Function1[/* repeated */ T, TResult]): js.Array[TResult]
  def unzipWith[T, TResult](
    iteratee: js.Function1[/* repeated */ T, TResult],
    array: typingsJapgolly.lodash.mod.List[typingsJapgolly.lodash.mod.List[T]]
  ): js.Array[TResult]
  @JSName("unzipWith")
  var unzipWith_Original: LodashUnzipWith
  @JSName("unzipWith")
  def unzipWith_TTResult_LodashUnzipWith1x1[T, TResult](iteratee: js.Function1[/* repeated */ T, TResult]): LodashUnzipWith1x1[T, TResult]
  ...
  def values[T](`object`: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  ...
  def valuesIn[T](`object`: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  ...
  def without[T](values: js.Array[T]): LodashWithout1x1[T]
  def without[T](values: js.Array[T], array: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def without[T](values: __): LodashWithout1x2[T]
  def without[T](values: __, array: typingsJapgolly.lodash.mod.List[T]): LodashWithout1x2[T]
  @JSName("without")
  var without_Original: LodashWithout
  @JSName("without")
  def without_T_Array[T](values: js.Array[T]): js.Array[T]
  ...
  def xor[T](): LodashXor1x1[T]
  def xor[T](arrays2: Null, arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def xor[T](arrays2: Unit, arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def xor[T](arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXor1x1[T]
  def xor[T](arrays2: typingsJapgolly.lodash.mod.List[T], arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def xor[T](arrays2: __): LodashXor1x2[T]
  def xor[T](arrays2: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashXor1x2[T]
  
  def xorBy[T](iteratee: ValueIteratee[T]): LodashXorBy1x3[T]
  def xorBy[T](iteratee: ValueIteratee[T], arrays: Null, arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def xorBy[T](iteratee: ValueIteratee[T], arrays: Unit, arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def xorBy[T](iteratee: ValueIteratee[T], arrays: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x3[T]
  def xorBy[T](
    iteratee: ValueIteratee[T],
    arrays: typingsJapgolly.lodash.mod.List[T],
    arrays2: typingsJapgolly.lodash.mod.List[T]
  ...
  def xorBy[T](iteratee: ValueIteratee[T], arrays: __, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x5[T]
  def xorBy[T](iteratee: __): LodashXorBy1x6[T]
  def xorBy[T](iteratee: __, arrays: Null, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x6[T]
  def xorBy[T](iteratee: __, arrays: Unit, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x6[T]
  def xorBy[T](iteratee: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x6[T]
  def xorBy[T](
    iteratee: __,
    arrays: typingsJapgolly.lodash.mod.List[T],
    arrays2: typingsJapgolly.lodash.mod.List[T]
  ...
  def xorBy[T](iteratee: __, arrays: __, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x4[T]
  @JSName("xorBy")
  var xorBy_Original: LodashXorBy
  @JSName("xorBy")
  def xorBy_T_Array[T](iteratee: ValueIteratee[T]): js.Array[T]
  @JSName("xorBy")
  def xorBy_T_Array[T](iteratee: ValueIteratee[T], arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  @JSName("xorBy")
  def xorBy_T_LodashXorBy1x1[T](iteratee: ValueIteratee[T]): LodashXorBy1x1[T]
  @JSName("xorBy")
  def xorBy_T_LodashXorBy1x2[T](iteratee: __): LodashXorBy1x2[T]
  @JSName("xorBy")
  def xorBy_T_LodashXorBy1x2[T](iteratee: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashXorBy1x2[T]
  
  def xorWith[T](comparator: Comparator[T]): LodashXorWith1x1[T]
  def xorWith[T](comparator: Comparator[T], arrays: Null, arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def xorWith[T](comparator: Comparator[T], arrays: Unit, arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def xorWith[T](comparator: Comparator[T], arrays: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  def xorWith[T](
    comparator: Comparator[T],
    arrays: typingsJapgolly.lodash.mod.List[T],
    arrays2: typingsJapgolly.lodash.mod.List[T]
  ...
  def xorWith[T](comparator: Comparator[T], arrays: __, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x5[T]
  def xorWith[T](comparator: __): LodashXorWith1x6[T]
  def xorWith[T](comparator: __, arrays: Null, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x6[T]
  def xorWith[T](comparator: __, arrays: Unit, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x6[T]
  def xorWith[T](comparator: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x6[T]
  def xorWith[T](
    comparator: __,
    arrays: typingsJapgolly.lodash.mod.List[T],
    arrays2: typingsJapgolly.lodash.mod.List[T]
  ...
  def xorWith[T](comparator: __, arrays: __, arrays2: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x4[T]
  @JSName("xorWith")
  ...
  @JSName("xorWith")
  def xorWith_T_LodashXorWith1x2[T](comparator: __, arrays: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x2[T]
  @JSName("xorWith")
  def xorWith_T_LodashXorWith1x3[T](comparator: Comparator[T]): LodashXorWith1x3[T]
  @JSName("xorWith")
  def xorWith_T_LodashXorWith1x3[T](comparator: Comparator[T], arrays: typingsJapgolly.lodash.mod.List[T]): LodashXorWith1x3[T]
  
  @JSName("xor")
  var xor_Original: LodashXor
  @JSName("xor")
  def xor_T_Array[T](): js.Array[T]
  @JSName("xor")
  def xor_T_Array[T](arrays2: typingsJapgolly.lodash.mod.List[T]): js.Array[T]
  
  def zip[T1](arrays1: typingsJapgolly.lodash.mod.List[T1]): LodashZip1x1[T1]
  def zip[T2](arrays1: __, arrays2: typingsJapgolly.lodash.mod.List[T2]): LodashZip1x2[T2]
  def zip[T1, T2](arrays1: typingsJapgolly.lodash.mod.List[T1], arrays2: typingsJapgolly.lodash.mod.List[T2]): js.Array[js.Tuple2[js.UndefOr[T1], js.UndefOr[T2]]]
  
  def zipAll[T](arrays: js.Array[js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null]]): js.Array[js.Array[js.UndefOr[T]]]
  def zipAll[T1, T2](arrays1: js.Tuple2[typingsJapgolly.lodash.mod.List[T1], typingsJapgolly.lodash.mod.List[T2]]): js.Array[js.Tuple2[js.UndefOr[T1], js.UndefOr[T2]]]
  def zipAll[T1, T2, T3](
    arrays1: js.Tuple3[
      typingsJapgolly.lodash.mod.List[T1], 
      typingsJapgolly.lodash.mod.List[T2], 
      typingsJapgolly.lodash.mod.List[T3]
    ]
  ...
  def zipAll[T1, T2, T3, T4](
    arrays1: js.Tuple4[
      ...
      typingsJapgolly.lodash.mod.List[T2], 
      typingsJapgolly.lodash.mod.List[T3], 
      typingsJapgolly.lodash.mod.List[T4]
    ]
  ...
  def zipAll[T1, T2, T3, T4, T5](
    arrays1: js.Tuple5[
      ...
      typingsJapgolly.lodash.mod.List[T3], 
      typingsJapgolly.lodash.mod.List[T4], 
      typingsJapgolly.lodash.mod.List[T5]
    ]
  ): js.Array[
  ...
  def zipObj(props: typingsJapgolly.lodash.mod.List[PropertyName]): LodashZipObject1x1
  def zipObj[T](props: typingsJapgolly.lodash.mod.List[PropertyName], values: typingsJapgolly.lodash.mod.List[T]): Dictionary[T]
  def zipObj[T](props: __, values: typingsJapgolly.lodash.mod.List[T]): LodashZipObject1x2[T]
  @JSName("zipObj")
  var zipObj_Original: LodashZipObject
  
  def zipObject(props: typingsJapgolly.lodash.mod.List[PropertyName]): LodashZipObject1x1
  def zipObject[T](props: typingsJapgolly.lodash.mod.List[PropertyName], values: typingsJapgolly.lodash.mod.List[T]): Dictionary[T]
  def zipObject[T](props: __, values: typingsJapgolly.lodash.mod.List[T]): LodashZipObject1x2[T]
  
  def zipObjectDeep(paths: typingsJapgolly.lodash.mod.List[PropertyPath]): LodashZipObjectDeep1x1
  def zipObjectDeep(paths: typingsJapgolly.lodash.mod.List[PropertyPath], values: typingsJapgolly.lodash.mod.List[Any]): js.Object
  def zipObjectDeep(paths: __, values: typingsJapgolly.lodash.mod.List[Any]): LodashZipObjectDeep1x2
  ...
  def zipWith[T1](iteratee: __, arrays1: typingsJapgolly.lodash.mod.List[T1]): LodashZipWith1x2[T1]
  def zipWith[T2](iteratee: __, arrays1: __, arrays2: typingsJapgolly.lodash.mod.List[T2]): LodashZipWith1x4[T2]
  def zipWith[T1, T2](
    iteratee: __,
...
object LoDashFp {
  ...
  inline def apply(
    ...
    compact: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.Array[Exclude[Any, js.UndefOr[Null | `false` | _empty | `0`]]],
    ...
    first: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.UndefOr[Any],
    flatMap: LodashFlatMap,
    flatMapDeep: LodashFlatMapDeep,
    flatMapDepth: LodashFlatMapDepth,
    flatten: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Many[Any]] | Null] => js.Array[Any],
    ...
    has: LodashHas,
    hasIn: LodashHasIn,
    head: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.UndefOr[Any],
    identical: LodashEq,
    ...
    init: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.Array[Any],
    initial: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.Array[Any],
    ...
    last: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.UndefOr[Any],
    ...
    max: /* collection */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.UndefOr[Any],
    maxBy: LodashMaxBy,
    mean: /* collection */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => Double,
    meanBy: LodashMeanBy,
    ...
    min: /* collection */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.UndefOr[Any],
    minBy: LodashMinBy,
    multiply: LodashMultiply,
    nAry: LodashAry,
    negate: /* predicate */ js.Function1[/* args */ js.Array[Any], Any] => js.Function1[/* args */ js.Array[Any], Boolean],
    noConflict: CallbackTo[Typeoflodash],
    noop: LodashNoop,
  ...
  extension [Self <: LoDashFp](x: Self) {
    ...
    inline def setCompact(
      value: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.Array[Exclude[Any, js.UndefOr[Null | `false` | _empty | `0`]]]
    ...
    inline def setF(value: CallbackTo[`false`]): Self = StObject.set(x, "F", value.toJsFn)
    ...
    inline def setFirst(value: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.UndefOr[Any]): Self = StObject.set(x, "first", js.Any.fromFunction1(value))
    ...
    inline def setFlatten(value: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Many[Any]] | Null] => js.Array[Any]): Self = StObject.set(x, "flatten", js.Any.fromFunction1(value))
    ...
    inline def setHead(value: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.UndefOr[Any]): Self = StObject.set(x, "head", js.Any.fromFunction1(value))
    ...
    inline def setInit(value: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.Array[Any]): Self = StObject.set(x, "init", js.Any.fromFunction1(value))
    
    inline def setInitial(value: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.Array[Any]): Self = StObject.set(x, "initial", js.Any.fromFunction1(value))
    ...
    inline def setLast(value: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.UndefOr[Any]): Self = StObject.set(x, "last", js.Any.fromFunction1(value))
    ...
    inline def setMax(value: /* collection */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.UndefOr[Any]): Self = StObject.set(x, "max", js.Any.fromFunction1(value))
    
    inline def setMaxBy(value: LodashMaxBy): Self = StObject.set(x, "maxBy", value.asInstanceOf[js.Any])
    
    inline def setMean(value: /* collection */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => Double): Self = StObject.set(x, "mean", js.Any.fromFunction1(value))
    ...
    inline def setMin(value: /* collection */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.UndefOr[Any]): Self = StObject.set(x, "min", js.Any.fromFunction1(value))
    ...
    inline def setNoConflict(value: CallbackTo[Typeoflodash]): Self = StObject.set(x, "noConflict", value.toJsFn)
    ...
    inline def setReverse(value: /* array */ typingsJapgolly.lodash.mod.List[Any] => typingsJapgolly.lodash.mod.List[Any]): Self = StObject.set(x, "reverse", js.Any.fromFunction1(value))
    ...
    inline def setSortedUniq(value: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.Array[Any]): Self = StObject.set(x, "sortedUniq", js.Any.fromFunction1(value))
    ...
    inline def setStubArray(value: CallbackTo[js.Array[Any]]): Self = StObject.set(x, "stubArray", value.toJsFn)
    
    inline def setStubFalse(value: CallbackTo[`false`]): Self = StObject.set(x, "stubFalse", value.toJsFn)
    
    inline def setStubObject(value: CallbackTo[Any]): Self = StObject.set(x, "stubObject", value.toJsFn)
    
    inline def setStubString(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "stubString", value.toJsFn)
    
    inline def setStubTrue(value: CallbackTo[`true`]): Self = StObject.set(x, "stubTrue", value.toJsFn)
    
    inline def setSubtract(value: LodashSubtract): Self = StObject.set(x, "subtract", value.asInstanceOf[js.Any])
    
    inline def setSum(value: /* collection */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => Double): Self = StObject.set(x, "sum", js.Any.fromFunction1(value))
    ...
    inline def setT(value: CallbackTo[`true`]): Self = StObject.set(x, "T", value.toJsFn)
    
    inline def setTail(value: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.Array[Any]): Self = StObject.set(x, "tail", js.Any.fromFunction1(value))
    ...
    inline def setUniq(value: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Any] | Null] => js.Array[Any]): Self = StObject.set(x, "uniq", js.Any.fromFunction1(value))
    ...
    inline def setUnnest(value: /* array */ js.UndefOr[typingsJapgolly.lodash.mod.List[Many[Any]] | Null] => js.Array[Any]): Self = StObject.set(x, "unnest", js.Any.fromFunction1(value))
    
    inline def setUnset(value: LodashUnset): Self = StObject.set(x, "unset", value.asInstanceOf[js.Any])
    
    inline def setUnzip(
      value: /* array */ js.UndefOr[
          js.Array[js.Array[Any]] | typingsJapgolly.lodash.mod.List[typingsJapgolly.lodash.mod.List[Any]] | Null
