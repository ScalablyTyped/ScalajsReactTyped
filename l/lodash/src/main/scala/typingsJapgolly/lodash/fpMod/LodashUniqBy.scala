...
trait LodashUniqBy extends StObject {
  ...
  def apply[T](iteratee: ValueIteratee[T], array: typingsJapgolly.lodash.mod.List[T]): js.Array[T] = js.native
  def apply[T](iteratee: __): LodashUniqBy1x2[T] = js.native
  def apply[T](iteratee: __, array: typingsJapgolly.lodash.mod.List[T]): LodashUniqBy1x2[T] = js.native
}
