...
trait LodashForEach extends StObject {
  ...
  def apply[T](iteratee: __, collection: typingsJapgolly.lodash.mod.List[T]): LodashForEach2x2[T] = js.native
  ...
  def apply[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: Unit & TList): LodashForEach5x2[T, TList] = js.native
  def apply[T, TList /* <: js.UndefOr[typingsJapgolly.lodash.mod.List[T] | Null] */](iteratee: __, collection: Null & TList): LodashForEach5x2[T, TList] = js.native
}
