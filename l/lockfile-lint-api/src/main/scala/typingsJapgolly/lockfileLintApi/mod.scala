...
import typingsJapgolly.lockfileLintApi.lockfileLintApiStrings.error
import typingsJapgolly.lockfileLintApi.lockfileLintApiStrings.success
...
object mod {
  ...
  open class ValidateHost protected () extends StObject {
    def this(packages: typingsJapgolly.lockfileLintApi.anon.Packages) = this()
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.lockfileLintApi.mod.ValidationError
    - typingsJapgolly.lockfileLintApi.mod.ValidationSuccess
  */
  trait ValidationResult extends StObject
  object ValidationResult {
    
    inline def ValidationError(errors: js.Array[Error]): typingsJapgolly.lockfileLintApi.mod.ValidationError = {
      val __obj = js.Dynamic.literal(errors = errors.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("error")
      __obj.asInstanceOf[typingsJapgolly.lockfileLintApi.mod.ValidationError]
    }
    
    inline def ValidationSuccess(`object`: Packages): typingsJapgolly.lockfileLintApi.mod.ValidationSuccess = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("success")
      __obj.asInstanceOf[typingsJapgolly.lockfileLintApi.mod.ValidationSuccess]
    }
  }
