...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.libp2pInterfaceKeychain.libp2pInterfaceKeychainStrings.Ed25519
    - typingsJapgolly.libp2pInterfaceKeychain.libp2pInterfaceKeychainStrings.RSA
  */
  trait KeyType extends StObject
  object KeyType {
    
    inline def Ed25519: typingsJapgolly.libp2pInterfaceKeychain.libp2pInterfaceKeychainStrings.Ed25519 = "Ed25519".asInstanceOf[typingsJapgolly.libp2pInterfaceKeychain.libp2pInterfaceKeychainStrings.Ed25519]
    
    inline def RSA: typingsJapgolly.libp2pInterfaceKeychain.libp2pInterfaceKeychainStrings.RSA = "RSA".asInstanceOf[typingsJapgolly.libp2pInterfaceKeychain.libp2pInterfaceKeychainStrings.RSA]
  }
}
