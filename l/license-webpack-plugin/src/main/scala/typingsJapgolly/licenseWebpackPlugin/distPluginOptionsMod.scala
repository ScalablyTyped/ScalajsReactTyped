...
import typingsJapgolly.licenseWebpackPlugin.distIncludeExcludeTestMod.IncludeExcludeTest
...
import typingsJapgolly.licenseWebpackPlugin.distPluginStatsMod.PluginStats
...
object distPluginOptionsMod {
  ...
  object PluginOptions {
    ...
    extension [Self <: PluginOptions](x: Self) {
      ...
      inline def setHandleUnacceptableLicense(value: (/* packageName */ String, /* licenseType */ String) => Callback): Self = StObject.set(x, "handleUnacceptableLicense", js.Any.fromFunction2((t0: /* packageName */ String, t1: /* licenseType */ String) => (value(t0, t1)).runNow()))
