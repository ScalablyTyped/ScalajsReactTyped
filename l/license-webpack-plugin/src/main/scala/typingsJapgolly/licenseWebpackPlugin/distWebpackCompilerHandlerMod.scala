...
object distWebpackCompilerHandlerMod {
  ...
  object WebpackCompilerHandler {
    ...
    inline def apply(
      ...
      handleCompiler: WebpackCompiler => Callback,
      iterateChunks: Any,
    ...
    extension [Self <: WebpackCompilerHandler](x: Self) {
      ...
      inline def setHandleCompiler(value: WebpackCompiler => Callback): Self = StObject.set(x, "handleCompiler", js.Any.fromFunction1((t0: WebpackCompiler) => value(t0).runNow()))
