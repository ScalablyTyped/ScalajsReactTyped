...
object distWebpackChunkMod {
  ...
  object WebpackChunk {
    ...
    extension [Self <: WebpackChunk](x: Self) {
      ...
      inline def setForEachModule(value: /* callback */ js.Function1[/* module */ WebpackChunkModule, Unit] => Callback): Self = StObject.set(x, "forEachModule", js.Any.fromFunction1((t0: /* callback */ js.Function1[/* module */ WebpackChunkModule, Unit]) => value(t0).runNow()))
