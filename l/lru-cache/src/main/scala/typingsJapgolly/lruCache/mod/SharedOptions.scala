...
object SharedOptions {
  ...
  extension [Self <: SharedOptions[?, ?], K, V](x: Self & (SharedOptions[K, V])) {
    ...
    inline def setDispose(value: (V, K, /* reason */ DisposeReason) => Callback): Self = StObject.set(x, "dispose", js.Any.fromFunction3((t0: V, t1: K, t2: /* reason */ DisposeReason) => (value(t0, t1, t2)).runNow()))
    
    inline def setDisposeAfter(value: (V, K, /* reason */ DisposeReason) => Callback): Self = StObject.set(x, "disposeAfter", js.Any.fromFunction3((t0: V, t1: K, t2: /* reason */ DisposeReason) => (value(t0, t1, t2)).runNow()))
