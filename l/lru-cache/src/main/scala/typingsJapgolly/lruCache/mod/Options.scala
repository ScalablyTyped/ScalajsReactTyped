...
object Options {
  @scala.inline
  def apply[K, V](
    dispose: (/* key */ K, /* value */ V) => Callback = null,
    length: (/* value */ V, /* key */ js.UndefOr[K]) => CallbackTo[Double] = null,
    max: Int | Double = null,
    ...
    if (dispose != null) __obj.updateDynamic("dispose")(js.Any.fromFunction2((t0: /* key */ K, t1: /* value */ V) => dispose(t0, t1).runNow()))
    if (length != null) __obj.updateDynamic("length")(js.Any.fromFunction2((t0: /* value */ V, t1: /* key */ js.UndefOr[K]) => length(t0, t1).runNow()))
