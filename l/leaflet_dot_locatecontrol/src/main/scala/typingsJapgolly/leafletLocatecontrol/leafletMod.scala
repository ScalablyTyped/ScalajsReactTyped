package typingsJapgolly.leafletLocatecontrol
...
import typingsJapgolly.leafletLocatecontrol.leafletMod.Control_.Locate
import typingsJapgolly.leafletLocatecontrol.leafletMod.Control_.LocateOptions
...
object leafletMod {
  ...
  object Control_ {
    ...
    trait LocateOptions extends StObject {
      ...
      var locateOptions: js.UndefOr[typingsJapgolly.leaflet.mod.LocateOptions] = js.undefined
    ...
    object LocateOptions {
      ...
      extension [Self <: LocateOptions](x: Self) {
        ...
        inline def setLocateOptions(value: typingsJapgolly.leaflet.mod.LocateOptions): Self = StObject.set(x, "locateOptions", value.asInstanceOf[js.Any])
