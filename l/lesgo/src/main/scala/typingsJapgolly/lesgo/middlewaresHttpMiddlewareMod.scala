...
import typingsJapgolly.lesgo.lesgoStrings.APIGATEWAY
import typingsJapgolly.lesgo.lesgoStrings.ELB
import typingsJapgolly.lesgo.middlewaresErrorHttpResponseMiddlewareMod.ErrorHttpMiddleware
import typingsJapgolly.lesgo.middlewaresNormalizeHttpRequestMiddlewareMod.NormalizeHttpMiddleware
import typingsJapgolly.lesgo.middlewaresSuccessHttpResponseMiddlewareMod.SuccessHttpMiddleware
...
object middlewaresHttpMiddlewareMod {
  ...
  trait HttpMiddlewareOptions extends StObject {
    ...
    var db: js.UndefOr[default | typingsJapgolly.lesgo.servicesAuroraDbRDSProxyServiceMod.default] = js.undefined
  ...
  object HttpMiddlewareOptions {
    ...
    extension [Self <: HttpMiddlewareOptions](x: Self) {
      ...
      inline def setDb(value: default | typingsJapgolly.lesgo.servicesAuroraDbRDSProxyServiceMod.default): Self = StObject.set(x, "db", value.asInstanceOf[js.Any])
