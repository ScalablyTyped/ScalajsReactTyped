...
import typingsJapgolly.awsLambda.triggerApiGatewayProxyMod.APIGatewayProxyEventBase
...
import typingsJapgolly.lesgo.anon.`0`
import typingsJapgolly.lesgo.middlewaresHttpMiddlewareMod.HttpMiddlewareOptions
...
object middlewaresNormalizeHttpRequestMiddlewareMod {
  ...
  object NormalizeHttpMiddlewareOptions {
    ...
    extension [Self <: NormalizeHttpMiddlewareOptions](x: Self) {
      ...
      inline def setLogger(value: /* message */ Any => Callback): Self = StObject.set(x, "logger", js.Any.fromFunction1((t0: /* message */ Any) => value(t0).runNow()))
