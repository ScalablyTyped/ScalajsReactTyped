package typingsJapgolly.libmime

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.libmime.anon.Key
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.libmime.libmimeStrings.Q
    - typingsJapgolly.libmime.libmimeStrings.B
  */
  trait MimeWordEncoding extends StObject
  object MimeWordEncoding {
    
    inline def B: typingsJapgolly.libmime.libmimeStrings.B = "B".asInstanceOf[typingsJapgolly.libmime.libmimeStrings.B]
    
    inline def Q: typingsJapgolly.libmime.libmimeStrings.Q = "Q".asInstanceOf[typingsJapgolly.libmime.libmimeStrings.Q]
  }
