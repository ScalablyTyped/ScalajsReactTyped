...
object anon {
  ...
  object PartialContext {
    ...
    extension [Self <: PartialContext](x: Self) {
      ...
      inline def setFail(value: /* error */ js.Error => Callback): Self = StObject.set(x, "fail", js.Any.fromFunction1((t0: /* error */ js.Error) => value(t0).runNow()))
      ...
      inline def setGetRemainingTimeInMillis(value: CallbackTo[Double]): Self = StObject.set(x, "getRemainingTimeInMillis", value.toJsFn)
      ...
      inline def setSucceed(value: /* messageOrObject */ Any => Callback): Self = StObject.set(x, "succeed", js.Any.fromFunction1((t0: /* messageOrObject */ Any) => value(t0).runNow()))
