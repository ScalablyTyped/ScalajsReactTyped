...
import typingsJapgolly.liftoff.liftoffStrings.loaderColonfailure
import typingsJapgolly.liftoff.liftoffStrings.loaderColonsuccess
import typingsJapgolly.liftoff.liftoffStrings.preloadColonbefore
import typingsJapgolly.liftoff.liftoffStrings.preloadColonfailure
import typingsJapgolly.liftoff.liftoffStrings.preloadColonsuccess
...
object mod {
  ...
  object Events {
    ...
    inline def apply(
      loaderColonfailure: (String, js.Error) => Callback,
      loaderColonsuccess: (String, Any) => Callback,
      preloadColonbefore: String => Callback,
      preloadColonfailure: (String, js.Error) => Callback,
      preloadColonsuccess: (String, Any) => Callback,
      respawn: (js.Array[String], Process) => Callback
    ): Events = {
      val __obj = js.Dynamic.literal(respawn = js.Any.fromFunction2((t0: js.Array[String], t1: Process) => (respawn(t0, t1)).runNow()))
      __obj.updateDynamic("loader:failure")(js.Any.fromFunction2((t0: String, t1: js.Error) => (loaderColonfailure(t0, t1)).runNow()))
      __obj.updateDynamic("loader:success")(js.Any.fromFunction2((t0: String, t1: Any) => (loaderColonsuccess(t0, t1)).runNow()))
      __obj.updateDynamic("preload:before")(js.Any.fromFunction1((t0: String) => preloadColonbefore(t0).runNow()))
      __obj.updateDynamic("preload:failure")(js.Any.fromFunction2((t0: String, t1: js.Error) => (preloadColonfailure(t0, t1)).runNow()))
      __obj.updateDynamic("preload:success")(js.Any.fromFunction2((t0: String, t1: Any) => (preloadColonsuccess(t0, t1)).runNow()))
      __obj.asInstanceOf[Events]
    }
    
    extension [Self <: Events](x: Self) {
      
      inline def setLoaderColonfailure(value: (String, js.Error) => Callback): Self = StObject.set(x, "loader:failure", js.Any.fromFunction2((t0: String, t1: js.Error) => (value(t0, t1)).runNow()))
      
      inline def setLoaderColonsuccess(value: (String, Any) => Callback): Self = StObject.set(x, "loader:success", js.Any.fromFunction2((t0: String, t1: Any) => (value(t0, t1)).runNow()))
      
      inline def setPreloadColonbefore(value: String => Callback): Self = StObject.set(x, "preload:before", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setPreloadColonfailure(value: (String, js.Error) => Callback): Self = StObject.set(x, "preload:failure", js.Any.fromFunction2((t0: String, t1: js.Error) => (value(t0, t1)).runNow()))
      
      inline def setPreloadColonsuccess(value: (String, Any) => Callback): Self = StObject.set(x, "preload:success", js.Any.fromFunction2((t0: String, t1: Any) => (value(t0, t1)).runNow()))
      
      inline def setRespawn(value: (js.Array[String], Process) => Callback): Self = StObject.set(x, "respawn", js.Any.fromFunction2((t0: js.Array[String], t1: Process) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setV8flagsFunction1(value: /* cb */ js.Function2[/* err */ Any, /* flags */ js.Array[String], Unit] => Callback): Self = StObject.set(x, "v8flags", js.Any.fromFunction1((t0: /* cb */ js.Function2[/* err */ Any, /* flags */ js.Array[String], Unit]) => value(t0).runNow()))
