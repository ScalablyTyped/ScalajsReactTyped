...
import typingsJapgolly.loglevel.loglevelInts.`0`
import typingsJapgolly.loglevel.loglevelInts.`1`
import typingsJapgolly.loglevel.loglevelInts.`2`
import typingsJapgolly.loglevel.loglevelInts.`3`
import typingsJapgolly.loglevel.loglevelInts.`4`
import typingsJapgolly.loglevel.loglevelInts.`5`
import typingsJapgolly.loglevel.loglevelStrings.debug_
import typingsJapgolly.loglevel.loglevelStrings.error_
import typingsJapgolly.loglevel.loglevelStrings.info_
import typingsJapgolly.loglevel.loglevelStrings.silent_
import typingsJapgolly.loglevel.loglevelStrings.trace_
import typingsJapgolly.loglevel.loglevelStrings.warn_
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.loglevel.loglevelInts.`3`
    - typingsJapgolly.loglevel.loglevelInts.`2`
    - typingsJapgolly.loglevel.loglevelInts.`4`
    - typingsJapgolly.loglevel.loglevelInts.`0`
    - typingsJapgolly.loglevel.loglevelInts.`5`
    - typingsJapgolly.loglevel.loglevelInts.`1`
    - typingsJapgolly.loglevel.loglevelStrings.DEBUG
    - typingsJapgolly.loglevel.loglevelStrings.info_
    - typingsJapgolly.loglevel.loglevelStrings.INFO
    - typingsJapgolly.loglevel.loglevelStrings.warn_
    - typingsJapgolly.loglevel.loglevelStrings.TRACE
    - typingsJapgolly.loglevel.loglevelStrings.SILENT
    - typingsJapgolly.loglevel.loglevelStrings.silent_
    - typingsJapgolly.loglevel.loglevelStrings.WARN
    - typingsJapgolly.loglevel.loglevelStrings.debug_
    - typingsJapgolly.loglevel.loglevelStrings.ERROR
    - typingsJapgolly.loglevel.loglevelStrings.error_
    - typingsJapgolly.loglevel.loglevelStrings.trace_
  */
  trait LogLevelDesc extends StObject
  object LogLevelDesc {
    
    inline def `0`: typingsJapgolly.loglevel.loglevelInts.`0` = 0.asInstanceOf[typingsJapgolly.loglevel.loglevelInts.`0`]
    
    inline def `1`: typingsJapgolly.loglevel.loglevelInts.`1` = 1.asInstanceOf[typingsJapgolly.loglevel.loglevelInts.`1`]
    
    inline def `2`: typingsJapgolly.loglevel.loglevelInts.`2` = 2.asInstanceOf[typingsJapgolly.loglevel.loglevelInts.`2`]
    
    inline def `3`: typingsJapgolly.loglevel.loglevelInts.`3` = 3.asInstanceOf[typingsJapgolly.loglevel.loglevelInts.`3`]
    
    inline def `4`: typingsJapgolly.loglevel.loglevelInts.`4` = 4.asInstanceOf[typingsJapgolly.loglevel.loglevelInts.`4`]
    
    inline def `5`: typingsJapgolly.loglevel.loglevelInts.`5` = 5.asInstanceOf[typingsJapgolly.loglevel.loglevelInts.`5`]
    
    inline def DEBUG: typingsJapgolly.loglevel.loglevelStrings.DEBUG = "DEBUG".asInstanceOf[typingsJapgolly.loglevel.loglevelStrings.DEBUG]
    
    inline def ERROR: typingsJapgolly.loglevel.loglevelStrings.ERROR = "ERROR".asInstanceOf[typingsJapgolly.loglevel.loglevelStrings.ERROR]
    
    inline def INFO: typingsJapgolly.loglevel.loglevelStrings.INFO = "INFO".asInstanceOf[typingsJapgolly.loglevel.loglevelStrings.INFO]
    
    inline def SILENT: typingsJapgolly.loglevel.loglevelStrings.SILENT = "SILENT".asInstanceOf[typingsJapgolly.loglevel.loglevelStrings.SILENT]
    
    inline def TRACE: typingsJapgolly.loglevel.loglevelStrings.TRACE = "TRACE".asInstanceOf[typingsJapgolly.loglevel.loglevelStrings.TRACE]
    
    inline def WARN: typingsJapgolly.loglevel.loglevelStrings.WARN = "WARN".asInstanceOf[typingsJapgolly.loglevel.loglevelStrings.WARN]
