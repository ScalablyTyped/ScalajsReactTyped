package typingsJapgolly.licenseCheckerWebpackPlugin

import japgolly.scalajs.react.Callback
import typingsJapgolly.licenseCheckerWebpackPlugin.anon.PartialDependency
import typingsJapgolly.licenseCheckerWebpackPlugin.anon.PartialOptions
...
object mod {
  ...
  object LicenseCheckerWebpackPlugin {
    ...
    inline def apply(apply: Compiler => Callback): LicenseCheckerWebpackPlugin = {
