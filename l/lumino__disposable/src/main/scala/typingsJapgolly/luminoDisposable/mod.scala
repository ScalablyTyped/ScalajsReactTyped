...
object mod {
  ...
  object IDisposable {
    ...
    inline def apply(dispose: Callback, isDisposed: Boolean): IDisposable = {
  ...
  object IObservableDisposable {
    ...
    inline def apply(dispose: Callback, disposed: ISignal[IObservableDisposable, Unit], isDisposed: Boolean): IObservableDisposable = {
      val __obj = js.Dynamic.literal(dispose = dispose.toJsFn, disposed = disposed.asInstanceOf[js.Any], isDisposed = isDisposed.asInstanceOf[js.Any])
