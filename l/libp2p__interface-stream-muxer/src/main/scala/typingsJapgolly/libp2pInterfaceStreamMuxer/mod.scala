...
import typingsJapgolly.libp2pInterfaceConnection.mod.Direction
...
object mod {
  ...
  object StreamMuxerInit {
    ...
    extension [Self <: StreamMuxerInit](x: Self) {
      ...
      inline def setOnIncomingStream(value: /* stream */ Stream => Callback): Self = StObject.set(x, "onIncomingStream", js.Any.fromFunction1((t0: /* stream */ Stream) => value(t0).runNow()))
      
      inline def setOnIncomingStreamUndefined: Self = StObject.set(x, "onIncomingStream", js.undefined)
      
      inline def setOnStreamEnd(value: /* stream */ Stream => Callback): Self = StObject.set(x, "onStreamEnd", js.Any.fromFunction1((t0: /* stream */ Stream) => value(t0).runNow()))
