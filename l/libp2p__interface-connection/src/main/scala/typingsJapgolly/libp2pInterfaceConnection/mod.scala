package typingsJapgolly.libp2pInterfaceConnection

import japgolly.scalajs.react.Callback
import typingsJapgolly.itStreamTypes.mod.Duplex
import typingsJapgolly.itStreamTypes.mod.Source
import typingsJapgolly.libp2pInterfaceConnection.libp2pInterfaceConnectionStrings.CLOSED
import typingsJapgolly.libp2pInterfaceConnection.libp2pInterfaceConnectionStrings.CLOSING
import typingsJapgolly.libp2pInterfaceConnection.libp2pInterfaceConnectionStrings.OPEN
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.libp2pInterfaceConnection.libp2pInterfaceConnectionStrings.inbound
    - typingsJapgolly.libp2pInterfaceConnection.libp2pInterfaceConnectionStrings.outbound
  */
  trait Direction extends StObject
  object Direction {
    
    inline def inbound: typingsJapgolly.libp2pInterfaceConnection.libp2pInterfaceConnectionStrings.inbound = "inbound".asInstanceOf[typingsJapgolly.libp2pInterfaceConnection.libp2pInterfaceConnectionStrings.inbound]
    
    inline def outbound: typingsJapgolly.libp2pInterfaceConnection.libp2pInterfaceConnectionStrings.outbound = "outbound".asInstanceOf[typingsJapgolly.libp2pInterfaceConnection.libp2pInterfaceConnectionStrings.outbound]
  }
  ...
  object Stream {
    ...
    extension [Self <: Stream](x: Self) {
      ...
      inline def setAbort(value: js.Error => Callback): Self = StObject.set(x, "abort", js.Any.fromFunction1((t0: js.Error) => value(t0).runNow()))
      
      inline def setClose(value: Callback): Self = StObject.set(x, "close", value.toJsFn)
      
      inline def setCloseRead(value: Callback): Self = StObject.set(x, "closeRead", value.toJsFn)
      
      inline def setCloseWrite(value: Callback): Self = StObject.set(x, "closeWrite", value.toJsFn)
