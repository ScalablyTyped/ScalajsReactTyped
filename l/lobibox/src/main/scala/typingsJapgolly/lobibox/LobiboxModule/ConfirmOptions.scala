...
object ConfirmOptions {
  ...
  def apply(
    ...
    height: String = null,
    hide: js.UndefOr[CallbackTo[ConfirmOptions]] = js.undefined,
    ...
    setHeight: /* height */ js.UndefOr[Double] => CallbackTo[ConfirmOptions] = null,
    setPosition: (/* left */ js.UndefOr[Double | String], /* top */ js.UndefOr[Double]) => CallbackTo[ConfirmOptions] = null,
    setSize: (/* width */ js.UndefOr[Double], /* height */ js.UndefOr[Double]) => CallbackTo[ConfirmOptions] = null,
    setTitle: /* title */ js.UndefOr[String] => CallbackTo[ConfirmOptions] = null,
    setWidth: /* width */ js.UndefOr[Double] => CallbackTo[ConfirmOptions] = null,
    show: js.UndefOr[CallbackTo[ConfirmOptions]] = js.undefined,
