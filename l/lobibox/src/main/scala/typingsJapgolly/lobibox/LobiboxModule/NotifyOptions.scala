...
import typingsJapgolly.lobibox.AnonClassString
import typingsJapgolly.lobibox.AnonIcon
import typingsJapgolly.lobibox.AnonWidth
...
object NotifyOptions {
  ...
  def apply(
    ...
    remove: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
