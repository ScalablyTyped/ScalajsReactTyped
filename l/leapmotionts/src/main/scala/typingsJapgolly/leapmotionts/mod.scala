package typingsJapgolly.leapmotionts
...
object mod {
  ...
  object Listener {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(onConnect = js.Any.fromFunction1((t0: Controller) => onConnect(t0).runNow()), onDisconnect = js.Any.fromFunction1((t0: Controller) => onDisconnect(t0).runNow()), onExit = js.Any.fromFunction1((t0: Controller) => onExit(t0).runNow()), onFrame = js.Any.fromFunction2((t0: Controller, t1: Frame) => (onFrame(t0, t1)).runNow()), onInit = js.Any.fromFunction1((t0: Controller) => onInit(t0).runNow()))
      __obj.asInstanceOf[Listener]
    }
    
    extension [Self <: Listener](x: Self) {
      
      inline def setOnConnect(value: Controller => Callback): Self = StObject.set(x, "onConnect", js.Any.fromFunction1((t0: Controller) => value(t0).runNow()))
      
      inline def setOnDisconnect(value: Controller => Callback): Self = StObject.set(x, "onDisconnect", js.Any.fromFunction1((t0: Controller) => value(t0).runNow()))
      
      inline def setOnExit(value: Controller => Callback): Self = StObject.set(x, "onExit", js.Any.fromFunction1((t0: Controller) => value(t0).runNow()))
      
      inline def setOnFrame(value: (Controller, Frame) => Callback): Self = StObject.set(x, "onFrame", js.Any.fromFunction2((t0: Controller, t1: Frame) => (value(t0, t1)).runNow()))
      
      inline def setOnInit(value: Controller => Callback): Self = StObject.set(x, "onInit", js.Any.fromFunction1((t0: Controller) => value(t0).runNow()))
    }
  }
}
