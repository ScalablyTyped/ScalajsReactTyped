...
import typingsJapgolly.libphonenumberJs.libphonenumberJsBooleans.`true`
import typingsJapgolly.libphonenumberJs.sourceAsYouTypeFormatterDotPatternParserMod.character
...
object sourceAsYouTypeFormatterDotPatternMatcherMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultOverflow
    - typingsJapgolly.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultFullMatch
    - typingsJapgolly.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultPartialMatch
    - typingsJapgolly.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultNoMatch
  */
  ...
  object _MatchResult {
    ...
    inline def MatchResultFullMatch(matchedChars: js.Array[character]): typingsJapgolly.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultFullMatch = {
      val __obj = js.Dynamic.literal(matchedChars = matchedChars.asInstanceOf[js.Any])
      __obj.updateDynamic("match")(true)
      __obj.asInstanceOf[typingsJapgolly.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultFullMatch]
    }
    
    inline def MatchResultOverflow(): typingsJapgolly.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultOverflow = {
      val __obj = js.Dynamic.literal(overflow = true)
      __obj.asInstanceOf[typingsJapgolly.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultOverflow]
    }
    
    inline def MatchResultPartialMatch(): typingsJapgolly.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultPartialMatch = {
      val __obj = js.Dynamic.literal(partialMatch = true)
      __obj.asInstanceOf[typingsJapgolly.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultPartialMatch]
    }
  }
}
