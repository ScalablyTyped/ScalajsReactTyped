...
import typingsJapgolly.libphonenumberJs.typesMod._NumberType
...
object libphonenumberJsStrings {
  ...
  @js.native
  sealed trait EDot164
    extends StObject
       with NumberFormat
  inline def EDot164: EDot164 = "E.164".asInstanceOf[EDot164]
  ...
  sealed trait IDD
    extends StObject
       with NumberFormat
  inline def IDD: IDD = "IDD".asInstanceOf[IDD]
