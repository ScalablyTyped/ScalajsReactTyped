...
import typingsJapgolly.lgtv2.lgtv2Strings.close
import typingsJapgolly.lgtv2.lgtv2Strings.connect
import typingsJapgolly.lgtv2.lgtv2Strings.connecting
import typingsJapgolly.lgtv2.lgtv2Strings.error
import typingsJapgolly.lgtv2.lgtv2Strings.prompt
  ...
  object Config {
    ...
    extension [Self <: Config](x: Self) {
      ...
      inline def setSaveKey(
        value: (/* key */ String, /* callback */ js.Function1[/* error */ js.UndefOr[ErrnoException | Null], Unit]) => Callback
      ): Self = StObject.set(x, "saveKey", js.Any.fromFunction2((t0: /* key */ String, t1: /* callback */ js.Function1[/* error */ js.UndefOr[ErrnoException | Null], Unit]) => (value(t0, t1)).runNow()))
