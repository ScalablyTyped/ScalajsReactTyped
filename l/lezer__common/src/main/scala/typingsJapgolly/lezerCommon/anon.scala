...
import typingsJapgolly.lezerCommon.distTreeMod.IterMode
import typingsJapgolly.lezerCommon.distTreeMod.NodeProp
...
import typingsJapgolly.lezerCommon.distTreeMod.TreeBuffer
...
object anon {
  ...
  object Enter {
    ...
    extension [Self <: Enter](x: Self) {
      ...
      inline def setLeave(value: /* node */ SyntaxNodeRef => Callback): Self = StObject.set(x, "leave", js.Any.fromFunction1((t0: /* node */ SyntaxNodeRef) => value(t0).runNow()))
