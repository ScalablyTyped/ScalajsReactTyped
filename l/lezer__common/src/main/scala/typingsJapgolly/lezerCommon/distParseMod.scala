...
object distParseMod {
  ...
  object PartialParse {
    ...
    inline def apply(advance: CallbackTo[Tree | Null], parsedPos: Double, stopAt: Double => Callback): PartialParse = {
      val __obj = js.Dynamic.literal(advance = advance.toJsFn, parsedPos = parsedPos.asInstanceOf[js.Any], stopAt = js.Any.fromFunction1((t0: Double) => stopAt(t0).runNow()), stoppedAt = null)
      __obj.asInstanceOf[PartialParse]
    }
    
    extension [Self <: PartialParse](x: Self) {
      
      inline def setAdvance(value: CallbackTo[Tree | Null]): Self = StObject.set(x, "advance", value.toJsFn)
      
      inline def setParsedPos(value: Double): Self = StObject.set(x, "parsedPos", value.asInstanceOf[js.Any])
      
      inline def setStopAt(value: Double => Callback): Self = StObject.set(x, "stopAt", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
