...
import typingsJapgolly.lezerCommon.anon.Enter
import typingsJapgolly.lezerCommon.anon.Error
import typingsJapgolly.lezerCommon.anon.From
import typingsJapgolly.lezerCommon.anon.MakeTree
import typingsJapgolly.lezerCommon.distParseMod.Parser
import typingsJapgolly.lezerCommon.lezerCommonInts.`-1`
import typingsJapgolly.lezerCommon.lezerCommonInts.`-2`
import typingsJapgolly.lezerCommon.lezerCommonInts.`0`
import typingsJapgolly.lezerCommon.lezerCommonInts.`1`
import typingsJapgolly.lezerCommon.lezerCommonInts.`2`
import typingsJapgolly.lezerCommon.lezerCommonInts.`4`
...
object distTreeMod {
  ...
  object BufferCursor {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], fork = fork.toJsFn, id = id.asInstanceOf[js.Any], next = next.toJsFn, pos = pos.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any], start = start.asInstanceOf[js.Any])
    ...
    extension [Self <: BufferCursor](x: Self) {
      ...
      inline def setFork(value: CallbackTo[BufferCursor]): Self = StObject.set(x, "fork", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.lezerCommon.lezerCommonInts.`-2`
    - typingsJapgolly.lezerCommon.lezerCommonInts.`-1`
    - typingsJapgolly.lezerCommon.lezerCommonInts.`0`
    - typingsJapgolly.lezerCommon.lezerCommonInts.`1`
    - typingsJapgolly.lezerCommon.lezerCommonInts.`2`
    - typingsJapgolly.lezerCommon.lezerCommonInts.`4`
  */
