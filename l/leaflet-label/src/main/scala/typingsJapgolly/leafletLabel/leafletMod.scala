package typingsJapgolly.leafletLabel
...
object leafletMod {
  ...
  object Label {
    ...
    extension [Self <: Label](x: Self) {
      ...
      inline def setOnAdd(value: Map_ => Callback): Self = StObject.set(x, "onAdd", js.Any.fromFunction1((t0: Map_) => value(t0).runNow()))
      
      inline def setOnRemove(value: Map_ => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction1((t0: Map_) => value(t0).runNow()))
      ...
      inline def setUpdateZIndex(value: Double => Callback): Self = StObject.set(x, "updateZIndex", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    }
  }
