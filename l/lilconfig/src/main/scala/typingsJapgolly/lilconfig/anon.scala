package typingsJapgolly.lilconfig

import typingsJapgolly.lilconfig.mod.LilconfigResult
import typingsJapgolly.lilconfig.mod.Loaders
import typingsJapgolly.lilconfig.mod.Transform
