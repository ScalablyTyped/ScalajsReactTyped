...
import typingsJapgolly.lodashDecorators.anon.Instantiable
import typingsJapgolly.lodashDecorators.factoryCommonMod.ResolvableFunction
import typingsJapgolly.lodashDecorators.factoryMod.DecoratorConfig
...
object sharedMod {
  ...
  object MemoizeMap {
    ...
    inline def apply[T, U](delete: T => Callback, get: T => U, has: T => Boolean, set: (T, U) => Callback): MemoizeMap[T, U] = {
      val __obj = js.Dynamic.literal(delete = js.Any.fromFunction1((t0: T) => delete(t0).runNow()), get = js.Any.fromFunction1(get), has = js.Any.fromFunction1(has), set = js.Any.fromFunction2((t0: T, t1: U) => (set(t0, t1)).runNow()))
    ...
    extension [Self <: MemoizeMap[?, ?], T, U](x: Self & (MemoizeMap[T, U])) {
      ...
      inline def setSet(value: (T, U) => Callback): Self = StObject.set(x, "set", js.Any.fromFunction2((t0: T, t1: U) => (value(t0, t1)).runNow()))
    }
  }
