...
import typingsJapgolly.loggly.anon.Password
...
object mod {
  ...
  */
  ...
  object SearchOptions {
    ...
    inline def SearchOptionsWithQ(q: String): typingsJapgolly.loggly.mod.SearchOptionsWithQ = {
      val __obj = js.Dynamic.literal(q = q.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.loggly.mod.SearchOptionsWithQ]
    }
    
    inline def SearchOptionsWithQuery(query: String): typingsJapgolly.loggly.mod.SearchOptionsWithQuery = {
      val __obj = js.Dynamic.literal(query = query.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.loggly.mod.SearchOptionsWithQuery]
    }
  }
