...
import typingsJapgolly.libp2pKadDht.libp2pKadDhtStrings.ping
import typingsJapgolly.pQueue.distOptionsMod.QueueAddOptions
import typingsJapgolly.pQueue.distPriorityQueueMod.default
...
object distSrcRoutingTableMod {
  ...
  open class RoutingTable protected ()
    ...
    var pingQueue: typingsJapgolly.pQueue.mod.default[default, QueueAddOptions] = js.native
  ...
  object KBucketTree {
    ...
    inline def apply(
      ...
      on: (ping, js.Function2[/* oldContacts */ js.Array[KBucketPeer], /* newContact */ KBucketPeer, Unit]) => Callback,
      remove: js.typedarray.Uint8Array => Callback,
      root: KBucket,
      toIterable: CallbackTo[js.Iterable[KBucket]]
    ): KBucketTree = {
      val __obj = js.Dynamic.literal(add = js.Any.fromFunction1((t0: KBucketPeer) => add(t0).runNow()), closest = js.Any.fromFunction2(closest), closestPeer = js.Any.fromFunction1(closestPeer), count = count.toJsFn, get = js.Any.fromFunction1(get), localNodeId = localNodeId.asInstanceOf[js.Any], on = js.Any.fromFunction2((t0: ping, t1: js.Function2[/* oldContacts */ js.Array[KBucketPeer], /* newContact */ KBucketPeer, Unit]) => (on(t0, t1)).runNow()), remove = js.Any.fromFunction1((t0: js.typedarray.Uint8Array) => remove(t0).runNow()), root = root.asInstanceOf[js.Any], toIterable = toIterable.toJsFn)
      __obj.asInstanceOf[KBucketTree]
    }
    
    extension [Self <: KBucketTree](x: Self) {
      
      inline def setAdd(value: KBucketPeer => Callback): Self = StObject.set(x, "add", js.Any.fromFunction1((t0: KBucketPeer) => value(t0).runNow()))
      ...
      inline def setOn(
        value: (ping, js.Function2[/* oldContacts */ js.Array[KBucketPeer], /* newContact */ KBucketPeer, Unit]) => Callback
      ): Self = StObject.set(x, "on", js.Any.fromFunction2((t0: ping, t1: js.Function2[/* oldContacts */ js.Array[KBucketPeer], /* newContact */ KBucketPeer, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setRemove(value: js.typedarray.Uint8Array => Callback): Self = StObject.set(x, "remove", js.Any.fromFunction1((t0: js.typedarray.Uint8Array) => value(t0).runNow()))
      
      inline def setRoot(value: KBucket): Self = StObject.set(x, "root", value.asInstanceOf[js.Any])
      
      inline def setToIterable(value: CallbackTo[js.Iterable[KBucket]]): Self = StObject.set(x, "toIterable", value.toJsFn)
    }
  }
