...
import typingsJapgolly.libp2pKadDht.distSrcMessageDhtMod.Message.Peer
  ...
  object Message {
    ...
    object ConnectionType extends StObject {
      ...
      sealed trait CANNOT_CONNECT
        extends StObject
           with ConnectionType
      /* "CANNOT_CONNECT" */ val CANNOT_CONNECT: typingsJapgolly.libp2pKadDht.distSrcMessageDhtMod.Message.ConnectionType.CANNOT_CONNECT & String = js.native
      
      @js.native
      sealed trait CAN_CONNECT
        extends StObject
           with ConnectionType
      /* "CAN_CONNECT" */ val CAN_CONNECT: typingsJapgolly.libp2pKadDht.distSrcMessageDhtMod.Message.ConnectionType.CAN_CONNECT & String = js.native
      
      @js.native
      sealed trait CONNECTED
        extends StObject
           with ConnectionType
      /* "CONNECTED" */ val CONNECTED: typingsJapgolly.libp2pKadDht.distSrcMessageDhtMod.Message.ConnectionType.CONNECTED & String = js.native
      
      @js.native
      sealed trait NOT_CONNECTED
        extends StObject
           with ConnectionType
      /* "NOT_CONNECTED" */ val NOT_CONNECTED: typingsJapgolly.libp2pKadDht.distSrcMessageDhtMod.Message.ConnectionType.NOT_CONNECTED & String = js.native
    ...
    object MessageType extends StObject {
      ...
      sealed trait ADD_PROVIDER
        extends StObject
           with MessageType
      /* "ADD_PROVIDER" */ val ADD_PROVIDER: typingsJapgolly.libp2pKadDht.distSrcMessageDhtMod.Message.MessageType.ADD_PROVIDER & String = js.native
      
      @js.native
      sealed trait FIND_NODE
        extends StObject
           with MessageType
      /* "FIND_NODE" */ val FIND_NODE: typingsJapgolly.libp2pKadDht.distSrcMessageDhtMod.Message.MessageType.FIND_NODE & String = js.native
      
      @js.native
      sealed trait GET_PROVIDERS
        extends StObject
           with MessageType
      /* "GET_PROVIDERS" */ val GET_PROVIDERS: typingsJapgolly.libp2pKadDht.distSrcMessageDhtMod.Message.MessageType.GET_PROVIDERS & String = js.native
      
      @js.native
      sealed trait GET_VALUE
        extends StObject
           with MessageType
      /* "GET_VALUE" */ val GET_VALUE: typingsJapgolly.libp2pKadDht.distSrcMessageDhtMod.Message.MessageType.GET_VALUE & String = js.native
      
      @js.native
      sealed trait PING
        extends StObject
           with MessageType
      /* "PING" */ val PING: typingsJapgolly.libp2pKadDht.distSrcMessageDhtMod.Message.MessageType.PING & String = js.native
      
      @js.native
      sealed trait PUT_VALUE
        extends StObject
           with MessageType
      /* "PUT_VALUE" */ val PUT_VALUE: typingsJapgolly.libp2pKadDht.distSrcMessageDhtMod.Message.MessageType.PUT_VALUE & String = js.native
