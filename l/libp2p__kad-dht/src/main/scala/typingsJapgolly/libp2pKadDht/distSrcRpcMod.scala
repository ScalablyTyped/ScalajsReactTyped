...
object distSrcRpcMod {
  ...
  object DHTMessageHandler {
    ...
    inline def apply(handle: (PeerId, Message) => js.Promise[js.UndefOr[Message]], init: Components => Callback): DHTMessageHandler = {
      val __obj = js.Dynamic.literal(handle = js.Any.fromFunction2(handle), init = js.Any.fromFunction1((t0: Components) => init(t0).runNow()))
