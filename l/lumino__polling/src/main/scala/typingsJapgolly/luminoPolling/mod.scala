...
object mod {
  ...
  open class Debouncer[T, U, V /* <: js.Array[Any] */] protected ()
    extends typingsJapgolly.luminoPolling.typesRatelimiterMod.Debouncer[T, U, V] {
    /**
  ...
  open class Poll[T, U, V /* <: String */] protected ()
    extends typingsJapgolly.luminoPolling.typesPollMod.Poll[T, U, V] {
    /**
  ...
  open class RateLimiter[T, U, V /* <: js.Array[Any] */] protected ()
    extends typingsJapgolly.luminoPolling.typesRatelimiterMod.RateLimiter[T, U, V] {
    /**
      * Instantiate a rate limiter.
      *
      * @param fn - The function to rate limit.
  ...
  open class Throttler[T, U, V /* <: js.Array[Any] */] protected ()
    extends typingsJapgolly.luminoPolling.typesRatelimiterMod.Throttler[T, U, V] {
    /**
    ...
    def this(
      ...
      options: typingsJapgolly.luminoPolling.typesRatelimiterMod.Throttler.IOptions
    ) = this()
  }
  ...
  object IPoll {
    ...
    /* Rewritten from type alias, can be one of: 
      - T
      - typingsJapgolly.luminoPolling.luminoPollingStrings.constructed
      - typingsJapgolly.luminoPolling.luminoPollingStrings.disposed
      - typingsJapgolly.luminoPolling.luminoPollingStrings.reconnected
      - typingsJapgolly.luminoPolling.luminoPollingStrings.refreshed
      - typingsJapgolly.luminoPolling.luminoPollingStrings.rejected
      - typingsJapgolly.luminoPolling.luminoPollingStrings.resolved
      - typingsJapgolly.luminoPolling.luminoPollingStrings.standby
      - typingsJapgolly.luminoPolling.luminoPollingStrings.started
      - typingsJapgolly.luminoPolling.luminoPollingStrings.stopped
    */
  ...
  object IRateLimiter {
    ...
    inline def apply[T, U, V /* <: js.Array[Any] */](
      ...
      val __obj = js.Dynamic.literal(dispose = dispose.toJsFn, invoke = js.Any.fromFunction1(invoke), isDisposed = isDisposed.asInstanceOf[js.Any], limit = limit.asInstanceOf[js.Any], stop = stop.toJsFn)
