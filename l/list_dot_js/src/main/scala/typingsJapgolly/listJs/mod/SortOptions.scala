package typingsJapgolly.listJs.mod
...
object SortOptions {
  ...
  def apply(
    ...
    order: String = null,
    sortFunction: (/* a */ js.Object, /* b */ js.Object) => CallbackTo[js.UndefOr[Double]] = null
  ): SortOptions = {
    ...
    if (sortFunction != null) __obj.updateDynamic("sortFunction")(js.Any.fromFunction2((t0: /* a */ js.Object, t1: /* b */ js.Object) => sortFunction(t0, t1).runNow()))
