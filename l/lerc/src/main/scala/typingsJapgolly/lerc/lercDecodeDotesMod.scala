...
import typingsJapgolly.lerc.anon.InputOffset
import typingsJapgolly.lerc.anon.LocateFile
import typingsJapgolly.lerc.anon.MaxValues
...
object lercDecodeDotesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.lerc.lercStrings.S8
    - typingsJapgolly.lerc.lercStrings.U8
    - typingsJapgolly.lerc.lercStrings.S16
    - typingsJapgolly.lerc.lercStrings.U16
    - typingsJapgolly.lerc.lercStrings.S32
    - typingsJapgolly.lerc.lercStrings.U32
    - typingsJapgolly.lerc.lercStrings.F32
    - typingsJapgolly.lerc.lercStrings.F64
  */
  trait LercPixelType extends StObject
  object LercPixelType {
    
    inline def F32: typingsJapgolly.lerc.lercStrings.F32 = "F32".asInstanceOf[typingsJapgolly.lerc.lercStrings.F32]
    
    inline def F64: typingsJapgolly.lerc.lercStrings.F64 = "F64".asInstanceOf[typingsJapgolly.lerc.lercStrings.F64]
    
    inline def S16: typingsJapgolly.lerc.lercStrings.S16 = "S16".asInstanceOf[typingsJapgolly.lerc.lercStrings.S16]
    
    inline def S32: typingsJapgolly.lerc.lercStrings.S32 = "S32".asInstanceOf[typingsJapgolly.lerc.lercStrings.S32]
    
    inline def S8: typingsJapgolly.lerc.lercStrings.S8 = "S8".asInstanceOf[typingsJapgolly.lerc.lercStrings.S8]
    
    inline def U16: typingsJapgolly.lerc.lercStrings.U16 = "U16".asInstanceOf[typingsJapgolly.lerc.lercStrings.U16]
    
    inline def U32: typingsJapgolly.lerc.lercStrings.U32 = "U32".asInstanceOf[typingsJapgolly.lerc.lercStrings.U32]
    
    inline def U8: typingsJapgolly.lerc.lercStrings.U8 = "U8".asInstanceOf[typingsJapgolly.lerc.lercStrings.U8]
  }
