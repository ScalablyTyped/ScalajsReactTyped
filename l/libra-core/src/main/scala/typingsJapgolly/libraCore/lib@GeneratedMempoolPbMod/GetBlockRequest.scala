...
object GetBlockRequest {
  ...
  trait AsObject extends StObject {
    ...
    var transactionsList: js.Array[
        typingsJapgolly.libraCore.`lib@GeneratedMempoolPbMod`.TransactionExclusion.AsObject
      ]
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setTransactionsListVarargs(value: typingsJapgolly.libraCore.`lib@GeneratedMempoolPbMod`.TransactionExclusion.AsObject*): Self = StObject.set(x, "transactionsList", js.Array(value*))
    }
  }
}
