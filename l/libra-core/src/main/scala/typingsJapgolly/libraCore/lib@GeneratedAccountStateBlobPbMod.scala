...
import typingsJapgolly.libraCore.`lib@GeneratedProofPbMod`.AccountStateProof
...
object `lib@GeneratedAccountStateBlobPbMod` {
  ...
  object AccountStateWithProof {
    ...
    trait AsObject extends StObject {
      ...
      var blob: js.UndefOr[
            typingsJapgolly.libraCore.`lib@GeneratedAccountStateBlobPbMod`.AccountStateBlob.AsObject
          ] = js.undefined
      
      var proof: js.UndefOr[typingsJapgolly.libraCore.`lib@GeneratedProofPbMod`.AccountStateProof.AsObject] = js.undefined
    ...
    object AsObject {
      ...
      extension [Self <: AsObject](x: Self) {
        ...
        inline def setBlob(value: typingsJapgolly.libraCore.`lib@GeneratedAccountStateBlobPbMod`.AccountStateBlob.AsObject): Self = StObject.set(x, "blob", value.asInstanceOf[js.Any])
        
        inline def setBlobUndefined: Self = StObject.set(x, "blob", js.undefined)
        
        inline def setProof(value: typingsJapgolly.libraCore.`lib@GeneratedProofPbMod`.AccountStateProof.AsObject): Self = StObject.set(x, "proof", value.asInstanceOf[js.Any])
