...
import typingsJapgolly.libraCore.`lib@GeneratedAdmissionControlPbMod`.SubmitTransactionResponse.StatusCase
import typingsJapgolly.libraCore.`lib@GeneratedMempoolStatusPbMod`.MempoolAddTransactionStatus
import typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.SignedTransaction
import typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.VMStatus
...
object `lib@GeneratedAdmissionControlPbMod` {
  ...
  object AdmissionControlStatusCode extends StObject {
    ...
    /* 0 */ val ACCEPTED: typingsJapgolly.libraCore.`lib@GeneratedAdmissionControlPbMod`.AdmissionControlStatusCode.ACCEPTED & Double = js.native
    
    @js.native
    sealed trait BLACKLISTED
      extends StObject
         with AdmissionControlStatusCode
    /* 1 */ val BLACKLISTED: typingsJapgolly.libraCore.`lib@GeneratedAdmissionControlPbMod`.AdmissionControlStatusCode.BLACKLISTED & Double = js.native
    
    @js.native
    sealed trait REJECTED
      extends StObject
         with AdmissionControlStatusCode
    /* 2 */ val REJECTED: typingsJapgolly.libraCore.`lib@GeneratedAdmissionControlPbMod`.AdmissionControlStatusCode.REJECTED & Double = js.native
  }
  ...
  object SubmitTransactionResponse {
    ...
    object StatusCase extends StObject {
      ...
      sealed trait AC_STATUS
        extends StObject
           with StatusCase
      /* 2 */ val AC_STATUS: typingsJapgolly.libraCore.`lib@GeneratedAdmissionControlPbMod`.SubmitTransactionResponse.StatusCase.AC_STATUS & Double = js.native
      
      @js.native
      sealed trait MEMPOOL_STATUS
        extends StObject
           with StatusCase
      /* 3 */ val MEMPOOL_STATUS: typingsJapgolly.libraCore.`lib@GeneratedAdmissionControlPbMod`.SubmitTransactionResponse.StatusCase.MEMPOOL_STATUS & Double = js.native
      
      @js.native
      sealed trait STATUS_NOT_SET
        extends StObject
           with StatusCase
      /* 0 */ val STATUS_NOT_SET: typingsJapgolly.libraCore.`lib@GeneratedAdmissionControlPbMod`.SubmitTransactionResponse.StatusCase.STATUS_NOT_SET & Double = js.native
      
      @js.native
      sealed trait VM_STATUS
        extends StObject
           with StatusCase
      /* 1 */ val VM_STATUS: typingsJapgolly.libraCore.`lib@GeneratedAdmissionControlPbMod`.SubmitTransactionResponse.StatusCase.VM_STATUS & Double = js.native
    }
    ...
    trait AsObject extends StObject {
      ...
      var acStatus: js.UndefOr[
            typingsJapgolly.libraCore.`lib@GeneratedAdmissionControlPbMod`.AdmissionControlStatus.AsObject
          ] = js.undefined
      ...
      var vmStatus: js.UndefOr[typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.VMStatus.AsObject] = js.undefined
    }
    object AsObject {
      ...
      extension [Self <: AsObject](x: Self) {
        ...
        inline def setAcStatus(
          value: typingsJapgolly.libraCore.`lib@GeneratedAdmissionControlPbMod`.AdmissionControlStatus.AsObject
        ): Self = StObject.set(x, "acStatus", value.asInstanceOf[js.Any])
        
        inline def setAcStatusUndefined: Self = StObject.set(x, "acStatus", js.undefined)
        
        inline def setMempoolStatus(
          value: typingsJapgolly.libraCore.`lib@GeneratedMempoolStatusPbMod`.MempoolAddTransactionStatus.AsObject
        ): Self = StObject.set(x, "mempoolStatus", value.asInstanceOf[js.Any])
        ...
        inline def setVmStatus(value: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.VMStatus.AsObject): Self = StObject.set(x, "vmStatus", value.asInstanceOf[js.Any])
