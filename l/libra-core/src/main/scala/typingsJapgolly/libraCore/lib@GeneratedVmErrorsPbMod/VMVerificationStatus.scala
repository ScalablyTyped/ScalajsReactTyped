...
import typingsJapgolly.libraCore.`lib@GeneratedLanguageStoragePbMod`.ModuleId
import typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.VMVerificationStatus.StatusKind
...
object VMVerificationStatus {
  ...
  object StatusKind extends StObject {
    ...
    sealed trait DEPENDENCY
      extends StObject
         with StatusKind
    /* 2 */ val DEPENDENCY: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.VMVerificationStatus.StatusKind.DEPENDENCY & Double = js.native
    
    @js.native
    sealed trait MODULE
      extends StObject
         with StatusKind
    /* 1 */ val MODULE: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.VMVerificationStatus.StatusKind.MODULE & Double = js.native
    
    @js.native
    sealed trait SCRIPT
      extends StObject
         with StatusKind
    /* 0 */ val SCRIPT: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.VMVerificationStatus.StatusKind.SCRIPT & Double = js.native
  }
  ...
  trait AsObject extends StObject {
    ...
    var dependencyId: js.UndefOr[typingsJapgolly.libraCore.`lib@GeneratedLanguageStoragePbMod`.ModuleId.AsObject] = js.undefined
  ...
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setDependencyId(value: typingsJapgolly.libraCore.`lib@GeneratedLanguageStoragePbMod`.ModuleId.AsObject): Self = StObject.set(x, "dependencyId", value.asInstanceOf[js.Any])
