...
import typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.ArithmeticError.ArithmeticErrorType
...
object ArithmeticError {
  ...
  object ArithmeticErrorType extends StObject {
    ...
    /* 3 */ val DIVISIONBYZERO: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.ArithmeticError.ArithmeticErrorType.DIVISIONBYZERO & Double = js.native
    
    @js.native
    sealed trait OVERFLOW
      extends StObject
         with ArithmeticErrorType
    /* 2 */ val OVERFLOW: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.ArithmeticError.ArithmeticErrorType.OVERFLOW & Double = js.native
    
    @js.native
    sealed trait UNDERFLOW
      extends StObject
         with ArithmeticErrorType
    /* 1 */ val UNDERFLOW: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.ArithmeticError.ArithmeticErrorType.UNDERFLOW & Double = js.native
    
    @js.native
    sealed trait UNKNOWNARITHMETICERROR
      extends StObject
         with ArithmeticErrorType
    /* 0 */ val UNKNOWNARITHMETICERROR: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.ArithmeticError.ArithmeticErrorType.UNKNOWNARITHMETICERROR & Double = js.native
  }
