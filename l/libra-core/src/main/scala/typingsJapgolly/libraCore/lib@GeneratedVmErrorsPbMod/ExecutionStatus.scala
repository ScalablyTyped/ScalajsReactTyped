...
import typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.ExecutionStatus.ExecutionStatusCase
...
object ExecutionStatus {
  ...
  object ExecutionStatusCase extends StObject {
    ...
    /* 3 */ val ARITHMETIC_ERROR: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.ExecutionStatus.ExecutionStatusCase.ARITHMETIC_ERROR & Double = js.native
    
    @js.native
    sealed trait ASSERTION_FAILURE
      extends StObject
         with ExecutionStatusCase
    /* 2 */ val ASSERTION_FAILURE: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.ExecutionStatus.ExecutionStatusCase.ASSERTION_FAILURE & Double = js.native
    
    @js.native
    sealed trait EXECUTIONSTATUS_NOT_SET
      extends StObject
         with ExecutionStatusCase
    /* 0 */ val EXECUTIONSTATUS_NOT_SET: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.ExecutionStatus.ExecutionStatusCase.EXECUTIONSTATUS_NOT_SET & Double = js.native
    
    @js.native
    sealed trait REFERENCE_ERROR
      extends StObject
         with ExecutionStatusCase
    /* 4 */ val REFERENCE_ERROR: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.ExecutionStatus.ExecutionStatusCase.REFERENCE_ERROR & Double = js.native
    
    @js.native
    sealed trait RUNTIME_STATUS
      extends StObject
         with ExecutionStatusCase
    /* 1 */ val RUNTIME_STATUS: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.ExecutionStatus.ExecutionStatusCase.RUNTIME_STATUS & Double = js.native
  }
  ...
  trait AsObject extends StObject {
    ...
    var arithmeticError: js.UndefOr[typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.ArithmeticError.AsObject] = js.undefined
    
    var assertionFailure: js.UndefOr[typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.AssertionFailure.AsObject] = js.undefined
    
    var referenceError: js.UndefOr[
        typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.DynamicReferenceError.AsObject
      ] = js.undefined
  ...
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setArithmeticError(value: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.ArithmeticError.AsObject): Self = StObject.set(x, "arithmeticError", value.asInstanceOf[js.Any])
      
      inline def setArithmeticErrorUndefined: Self = StObject.set(x, "arithmeticError", js.undefined)
      
      inline def setAssertionFailure(value: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.AssertionFailure.AsObject): Self = StObject.set(x, "assertionFailure", value.asInstanceOf[js.Any])
      
      inline def setAssertionFailureUndefined: Self = StObject.set(x, "assertionFailure", js.undefined)
      
      inline def setReferenceError(value: typingsJapgolly.libraCore.`lib@GeneratedVmErrorsPbMod`.DynamicReferenceError.AsObject): Self = StObject.set(x, "referenceError", value.asInstanceOf[js.Any])
