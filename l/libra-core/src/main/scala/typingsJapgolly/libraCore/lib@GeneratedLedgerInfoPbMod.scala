...
object `lib@GeneratedLedgerInfoPbMod` {
  ...
  object LedgerInfoWithSignatures {
    ...
    trait AsObject extends StObject {
      ...
      var ledgerInfo: js.UndefOr[typingsJapgolly.libraCore.`lib@GeneratedLedgerInfoPbMod`.LedgerInfo.AsObject] = js.undefined
      
      var signaturesList: js.Array[
            typingsJapgolly.libraCore.`lib@GeneratedLedgerInfoPbMod`.ValidatorSignature.AsObject
          ]
    }
    object AsObject {
      ...
      extension [Self <: AsObject](x: Self) {
        ...
        inline def setLedgerInfo(value: typingsJapgolly.libraCore.`lib@GeneratedLedgerInfoPbMod`.LedgerInfo.AsObject): Self = StObject.set(x, "ledgerInfo", value.asInstanceOf[js.Any])
        
        inline def setLedgerInfoUndefined: Self = StObject.set(x, "ledgerInfo", js.undefined)
        
        inline def setSignaturesList(
          value: js.Array[
                  typingsJapgolly.libraCore.`lib@GeneratedLedgerInfoPbMod`.ValidatorSignature.AsObject
                ]
        ): Self = StObject.set(x, "signaturesList", value.asInstanceOf[js.Any])
        
        inline def setSignaturesListVarargs(value: typingsJapgolly.libraCore.`lib@GeneratedLedgerInfoPbMod`.ValidatorSignature.AsObject*): Self = StObject.set(x, "signaturesList", js.Array(value*))
      }
    }
  }
