...
object WriteOpType extends StObject {
  ...
  sealed trait DELETE
    extends StObject
       with WriteOpType
  /* 1 */ val DELETE: typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.WriteOpType.DELETE & Double = js.native
  
  @js.native
  sealed trait WRITE
    extends StObject
       with WriteOpType
  /* 0 */ val WRITE: typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.WriteOpType.WRITE & Double = js.native
}
