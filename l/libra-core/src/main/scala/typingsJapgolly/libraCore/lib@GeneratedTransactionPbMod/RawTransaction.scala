...
import typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.RawTransaction.PayloadCase
...
object RawTransaction {
  ...
  object PayloadCase extends StObject {
    ...
    sealed trait PAYLOAD_NOT_SET
      extends StObject
         with PayloadCase
    /* 0 */ val PAYLOAD_NOT_SET: typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.RawTransaction.PayloadCase.PAYLOAD_NOT_SET & Double = js.native
    
    @js.native
    sealed trait PROGRAM
      extends StObject
         with PayloadCase
    /* 3 */ val PROGRAM: typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.RawTransaction.PayloadCase.PROGRAM & Double = js.native
    
    @js.native
    sealed trait WRITE_SET
      extends StObject
         with PayloadCase
    /* 4 */ val WRITE_SET: typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.RawTransaction.PayloadCase.WRITE_SET & Double = js.native
  }
  ...
  trait AsObject extends StObject {
    ...
    var program: js.UndefOr[typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.Program.AsObject] = js.undefined
    
    var senderAccount: js.typedarray.Uint8Array | String
    
    var sequenceNumber: String
    
    var writeSet: js.UndefOr[typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.WriteSet.AsObject] = js.undefined
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setProgram(value: typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.Program.AsObject): Self = StObject.set(x, "program", value.asInstanceOf[js.Any])
      ...
      inline def setWriteSet(value: typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.WriteSet.AsObject): Self = StObject.set(x, "writeSet", value.asInstanceOf[js.Any])
