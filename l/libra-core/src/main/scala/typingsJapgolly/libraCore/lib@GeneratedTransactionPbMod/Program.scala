...
object Program {
  ...
  trait AsObject extends StObject {
    ...
    var argumentsList: js.Array[
        typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.TransactionArgument.AsObject
      ]
  ...
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setArgumentsList(
        value: js.Array[
              typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.TransactionArgument.AsObject
            ]
      ): Self = StObject.set(x, "argumentsList", value.asInstanceOf[js.Any])
      
      inline def setArgumentsListVarargs(value: typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.TransactionArgument.AsObject*): Self = StObject.set(x, "argumentsList", js.Array(value*))
