...
object WriteSet {
  ...
  trait AsObject extends StObject {
    ...
    var writeSetList: js.Array[typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.WriteOp.AsObject]
  }
  object AsObject {
    
    inline def apply(writeSetList: js.Array[typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.WriteOp.AsObject]): AsObject = {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setWriteSetList(value: js.Array[typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.WriteOp.AsObject]): Self = StObject.set(x, "writeSetList", value.asInstanceOf[js.Any])
      
      inline def setWriteSetListVarargs(value: typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.WriteOp.AsObject*): Self = StObject.set(x, "writeSetList", js.Array(value*))
    }
  }
}
