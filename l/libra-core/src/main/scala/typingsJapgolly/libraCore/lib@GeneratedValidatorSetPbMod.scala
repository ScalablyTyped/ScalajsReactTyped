...
import typingsJapgolly.libraCore.`lib@GeneratedValidatorPublicKeysPbMod`.ValidatorPublicKeys
  ...
  object ValidatorSet {
    ...
    trait AsObject extends StObject {
      ...
      var validatorPublicKeysList: js.Array[
            typingsJapgolly.libraCore.`lib@GeneratedValidatorPublicKeysPbMod`.ValidatorPublicKeys.AsObject
          ]
    }
    object AsObject {
      ...
      extension [Self <: AsObject](x: Self) {
        ...
        inline def setValidatorPublicKeysListVarargs(
          value: typingsJapgolly.libraCore.`lib@GeneratedValidatorPublicKeysPbMod`.ValidatorPublicKeys.AsObject*
        ): Self = StObject.set(x, "validatorPublicKeysList", js.Array(value*))
      }
    }
  }
}
