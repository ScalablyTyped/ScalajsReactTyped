...
import typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.RequestItem.RequestedItemsCase
...
object RequestItem {
  ...
  object RequestedItemsCase extends StObject {
    ...
    /* 1 */ val GET_ACCOUNT_STATE_REQUEST: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.RequestItem.RequestedItemsCase.GET_ACCOUNT_STATE_REQUEST & Double = js.native
    
    @js.native
    sealed trait GET_ACCOUNT_TRANSACTION_BY_SEQUENCE_NUMBER_REQUEST
      extends StObject
         with RequestedItemsCase
    /* 2 */ val GET_ACCOUNT_TRANSACTION_BY_SEQUENCE_NUMBER_REQUEST: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.RequestItem.RequestedItemsCase.GET_ACCOUNT_TRANSACTION_BY_SEQUENCE_NUMBER_REQUEST & Double = js.native
    
    @js.native
    sealed trait GET_EVENTS_BY_EVENT_ACCESS_PATH_REQUEST
      extends StObject
         with RequestedItemsCase
    /* 3 */ val GET_EVENTS_BY_EVENT_ACCESS_PATH_REQUEST: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.RequestItem.RequestedItemsCase.GET_EVENTS_BY_EVENT_ACCESS_PATH_REQUEST & Double = js.native
    
    @js.native
    sealed trait GET_TRANSACTIONS_REQUEST
      extends StObject
         with RequestedItemsCase
    /* 4 */ val GET_TRANSACTIONS_REQUEST: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.RequestItem.RequestedItemsCase.GET_TRANSACTIONS_REQUEST & Double = js.native
    
    @js.native
    sealed trait REQUESTEDITEMS_NOT_SET
      extends StObject
         with RequestedItemsCase
    /* 0 */ val REQUESTEDITEMS_NOT_SET: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.RequestItem.RequestedItemsCase.REQUESTEDITEMS_NOT_SET & Double = js.native
  }
  ...
  trait AsObject extends StObject {
    ...
    var getAccountStateRequest: js.UndefOr[
        typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetAccountStateRequest.AsObject
      ] = js.undefined
    
    var getAccountTransactionBySequenceNumberRequest: js.UndefOr[
        typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetAccountTransactionBySequenceNumberRequest.AsObject
      ] = js.undefined
    
    var getEventsByEventAccessPathRequest: js.UndefOr[
        typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetEventsByEventAccessPathRequest.AsObject
      ] = js.undefined
    
    var getTransactionsRequest: js.UndefOr[
        typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetTransactionsRequest.AsObject
      ] = js.undefined
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setGetAccountStateRequest(value: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetAccountStateRequest.AsObject): Self = StObject.set(x, "getAccountStateRequest", value.asInstanceOf[js.Any])
      ...
      inline def setGetAccountTransactionBySequenceNumberRequest(
        value: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetAccountTransactionBySequenceNumberRequest.AsObject
      ...
      inline def setGetEventsByEventAccessPathRequest(
        value: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetEventsByEventAccessPathRequest.AsObject
      ...
      inline def setGetTransactionsRequest(value: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetTransactionsRequest.AsObject): Self = StObject.set(x, "getTransactionsRequest", value.asInstanceOf[js.Any])
