...
import typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.TransactionListWithProof
...
object GetTransactionsResponse {
  ...
  trait AsObject extends StObject {
    ...
    var txnListWithProof: js.UndefOr[
        typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.TransactionListWithProof.AsObject
      ] = js.undefined
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setTxnListWithProof(value: typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.TransactionListWithProof.AsObject): Self = StObject.set(x, "txnListWithProof", value.asInstanceOf[js.Any])
