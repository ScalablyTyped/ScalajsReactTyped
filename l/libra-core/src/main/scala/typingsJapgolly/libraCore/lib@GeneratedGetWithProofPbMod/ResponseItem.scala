...
import typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.ResponseItem.ResponseItemsCase
...
object ResponseItem {
  ...
  object ResponseItemsCase extends StObject {
    ...
    /* 3 */ val GET_ACCOUNT_STATE_RESPONSE: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.ResponseItem.ResponseItemsCase.GET_ACCOUNT_STATE_RESPONSE & Double = js.native
    
    @js.native
    sealed trait GET_ACCOUNT_TRANSACTION_BY_SEQUENCE_NUMBER_RESPONSE
      extends StObject
         with ResponseItemsCase
    /* 4 */ val GET_ACCOUNT_TRANSACTION_BY_SEQUENCE_NUMBER_RESPONSE: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.ResponseItem.ResponseItemsCase.GET_ACCOUNT_TRANSACTION_BY_SEQUENCE_NUMBER_RESPONSE & Double = js.native
    
    @js.native
    sealed trait GET_EVENTS_BY_EVENT_ACCESS_PATH_RESPONSE
      extends StObject
         with ResponseItemsCase
    /* 5 */ val GET_EVENTS_BY_EVENT_ACCESS_PATH_RESPONSE: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.ResponseItem.ResponseItemsCase.GET_EVENTS_BY_EVENT_ACCESS_PATH_RESPONSE & Double = js.native
    
    @js.native
    sealed trait GET_TRANSACTIONS_RESPONSE
      extends StObject
         with ResponseItemsCase
    /* 6 */ val GET_TRANSACTIONS_RESPONSE: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.ResponseItem.ResponseItemsCase.GET_TRANSACTIONS_RESPONSE & Double = js.native
    
    @js.native
    sealed trait RESPONSEITEMS_NOT_SET
      extends StObject
         with ResponseItemsCase
    /* 0 */ val RESPONSEITEMS_NOT_SET: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.ResponseItem.ResponseItemsCase.RESPONSEITEMS_NOT_SET & Double = js.native
  }
  ...
  trait AsObject extends StObject {
    ...
    var getAccountStateResponse: js.UndefOr[
        typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetAccountStateResponse.AsObject
      ] = js.undefined
    
    var getAccountTransactionBySequenceNumberResponse: js.UndefOr[
        typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetAccountTransactionBySequenceNumberResponse.AsObject
      ] = js.undefined
    
    var getEventsByEventAccessPathResponse: js.UndefOr[
        typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetEventsByEventAccessPathResponse.AsObject
      ] = js.undefined
    
    var getTransactionsResponse: js.UndefOr[
        typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetTransactionsResponse.AsObject
      ] = js.undefined
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setGetAccountStateResponse(value: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetAccountStateResponse.AsObject): Self = StObject.set(x, "getAccountStateResponse", value.asInstanceOf[js.Any])
      ...
      inline def setGetAccountTransactionBySequenceNumberResponse(
        value: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetAccountTransactionBySequenceNumberResponse.AsObject
      ...
      inline def setGetEventsByEventAccessPathResponse(
        value: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetEventsByEventAccessPathResponse.AsObject
      ...
      inline def setGetTransactionsResponse(value: typingsJapgolly.libraCore.`lib@GeneratedGetWithProofPbMod`.GetTransactionsResponse.AsObject): Self = StObject.set(x, "getTransactionsResponse", value.asInstanceOf[js.Any])
