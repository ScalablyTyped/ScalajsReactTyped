...
import typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.SignedTransactionWithProof
...
object GetAccountTransactionBySequenceNumberResponse {
  ...
  trait AsObject extends StObject {
    ...
    var signedTransactionWithProof: js.UndefOr[
        typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.SignedTransactionWithProof.AsObject
      ] = js.undefined
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setProofOfCurrentSequenceNumber(
        value: typingsJapgolly.libraCore.`lib@GeneratedAccountStateBlobPbMod`.AccountStateWithProof.AsObject
      ): Self = StObject.set(x, "proofOfCurrentSequenceNumber", value.asInstanceOf[js.Any])
      
      inline def setProofOfCurrentSequenceNumberUndefined: Self = StObject.set(x, "proofOfCurrentSequenceNumber", js.undefined)
      
      inline def setSignedTransactionWithProof(
        value: typingsJapgolly.libraCore.`lib@GeneratedTransactionPbMod`.SignedTransactionWithProof.AsObject
      ): Self = StObject.set(x, "signedTransactionWithProof", value.asInstanceOf[js.Any])
