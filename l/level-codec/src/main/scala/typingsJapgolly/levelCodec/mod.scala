package typingsJapgolly.levelCodec
...
object mod {
  ...
  open class CodecCls ()
    extends StObject
       with typingsJapgolly.levelCodec.mod.Codec {
  ...
  trait CodecConstructor
    extends StObject
       with Instantiable0[typingsJapgolly.levelCodec.mod.Codec]
       with Instantiable1[/* options */ CodecOptions, typingsJapgolly.levelCodec.mod.Codec] {
    
    def apply(): typingsJapgolly.levelCodec.mod.Codec = js.native
    def apply(options: CodecOptions): typingsJapgolly.levelCodec.mod.Codec = js.native
  }
