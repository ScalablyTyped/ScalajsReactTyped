...
import typingsJapgolly.loadableComponent.anon.Children
...
object mod {
  ...
  trait ExtraClassComponentProps[Component /* <: ComponentClassP[js.Object] */]
    extends StObject
  ...
  object ExtraClassComponentProps {
    ...
    inline def apply[Component /* <: ComponentClassP[js.Object] */](): ExtraClassComponentProps[Component] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ExtraClassComponentProps[Component]]
    }
    
    extension [Self <: ExtraClassComponentProps[?], Component /* <: ComponentClassP[js.Object] */](x: Self & ExtraClassComponentProps[Component]) {
      
      inline def setRef(value: LegacyRef[InstanceType[Component]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      inline def setRefFunction1(value: InstanceType[Component] | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: InstanceType[Component] | Null) => value(t0).runNow()))
  ...
  type LoadableClassComponent[Component /* <: ComponentClassP[js.Object] */] = (ComponentType[ComponentProps[Component] & ExtraClassComponentProps[Component]]) & LoadableComponentMethods[ComponentProps[Component]]
