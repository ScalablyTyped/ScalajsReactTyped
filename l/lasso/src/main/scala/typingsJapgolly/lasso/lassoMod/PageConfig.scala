...
import typingsJapgolly.lasso.dependenciesMod.DependencyConfig
...
trait PageConfig extends js.Object {
  ...
  var lassoContext: js.UndefOr[typingsJapgolly.lasso.lassoContextMod.default] = js.undefined
...
object PageConfig {
  ...
  def apply(
    ...
    from: String = null,
    lassoContext: typingsJapgolly.lasso.lassoContextMod.default = null,
    name: String = null,
