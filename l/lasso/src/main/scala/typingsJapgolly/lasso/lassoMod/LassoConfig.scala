...
object LassoConfig {
  ...
  def apply(
    ...
    cspNonceProvider: /* out */ js.Any => CallbackTo[String] = null,
    fingerprintInlineCode: /* code */ js.Any => CallbackTo[String] = null,
    ...
    if (cspNonceProvider != null) __obj.updateDynamic("cspNonceProvider")(js.Any.fromFunction1((t0: /* out */ js.Any) => cspNonceProvider(t0).runNow()))
    if (fingerprintInlineCode != null) __obj.updateDynamic("fingerprintInlineCode")(js.Any.fromFunction1((t0: /* code */ js.Any) => fingerprintInlineCode(t0).runNow()))
