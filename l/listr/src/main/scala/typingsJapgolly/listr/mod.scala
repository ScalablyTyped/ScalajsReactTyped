...
object mod {
  ...
  object ListrRenderer {
    ...
    inline def apply(end: js.Error => Callback, render: Callback): ListrRenderer = {
      val __obj = js.Dynamic.literal(end = js.Any.fromFunction1((t0: js.Error) => end(t0).runNow()), render = render.toJsFn)
      __obj.asInstanceOf[ListrRenderer]
    }
    
    extension [Self <: ListrRenderer](x: Self) {
      
      inline def setEnd(value: js.Error => Callback): Self = StObject.set(x, "end", js.Any.fromFunction1((t0: js.Error) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.listr.listrStrings.silent
    - typingsJapgolly.listr.listrStrings.default
    - typingsJapgolly.listr.listrStrings.verbose
    - typingsJapgolly.listr.mod.ListrRendererClass[Ctx]
  */
