package typingsJapgolly.leafletMarkercluster
...
import typingsJapgolly.leafletMarkercluster.leafletMarkerclusterStrings.animationend
import typingsJapgolly.leafletMarkercluster.leafletMarkerclusterStrings.spiderfied
import typingsJapgolly.leafletMarkercluster.leafletMarkerclusterStrings.unspiderfied
...
object leafletMod {
  ...
  object LeafletEventHandlerFnMap {
    ...
    extension [Self <: LeafletEventHandlerFnMap](x: Self) {
      ...
      inline def setAnimationend(value: /* event */ LeafletEvent => Callback): Self = StObject.set(x, "animationend", js.Any.fromFunction1((t0: /* event */ LeafletEvent) => value(t0).runNow()))
      
      inline def setAnimationendUndefined: Self = StObject.set(x, "animationend", js.undefined)
      
      inline def setSpiderfied(value: /* event */ MarkerClusterSpiderfyEvent => Callback): Self = StObject.set(x, "spiderfied", js.Any.fromFunction1((t0: /* event */ MarkerClusterSpiderfyEvent) => value(t0).runNow()))
      
      inline def setSpiderfiedUndefined: Self = StObject.set(x, "spiderfied", js.undefined)
      
      inline def setUnspiderfied(value: /* event */ MarkerClusterSpiderfyEvent => Callback): Self = StObject.set(x, "unspiderfied", js.Any.fromFunction1((t0: /* event */ MarkerClusterSpiderfyEvent) => value(t0).runNow()))
  ...
  object MarkerClusterGroupOptions {
    ...
    extension [Self <: MarkerClusterGroupOptions](x: Self) {
      ...
      inline def setChunkProgress(
        value: (/* processedMarkers */ Double, /* totalMarkers */ Double, /* elapsedTime */ Double) => Callback
      ): Self = StObject.set(x, "chunkProgress", js.Any.fromFunction3((t0: /* processedMarkers */ Double, t1: /* totalMarkers */ Double, t2: /* elapsedTime */ Double) => (value(t0, t1, t2)).runNow()))
