...
import typingsJapgolly.lifeomicAxiosFetch.anon.Href
...
object srcTypeUtilsMod {
  ...
  type HeadersLike = js.Array[js.Array[String]] | (Record[String, js.UndefOr[String]]) | Headers | typingsJapgolly.nodeFetch.mod.Headers
