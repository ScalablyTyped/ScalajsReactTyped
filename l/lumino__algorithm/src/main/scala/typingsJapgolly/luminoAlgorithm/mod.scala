...
import typingsJapgolly.luminoAlgorithm.typesArrayMod.ArrayExt.MutableArrayLike
import typingsJapgolly.luminoAlgorithm.typesArrayMod.ArrayExt.slice.IOptions
...
import typingsJapgolly.luminoAlgorithm.typesRetroMod.RetroableOrArrayLike
import typingsJapgolly.luminoAlgorithm.typesStringMod.StringExt.IMatchResult
...
object mod {
  ...
  open class ArrayIterator[T] protected ()
    extends typingsJapgolly.luminoAlgorithm.typesIterMod.ArrayIterator[T] {
    /**
  ...
  open class ChainIterator[T] protected ()
    extends typingsJapgolly.luminoAlgorithm.typesChainMod.ChainIterator[T] {
    /**
  ...
  open class EmptyIterator[T] ()
    extends typingsJapgolly.luminoAlgorithm.typesEmptyMod.EmptyIterator[T]
  
  @JSImport("@lumino/algorithm", "EnumerateIterator")
  @js.native
  open class EnumerateIterator[T] protected ()
    extends typingsJapgolly.luminoAlgorithm.typesEnumerateMod.EnumerateIterator[T] {
    /**
  ...
  open class FilterIterator[T] protected ()
    extends typingsJapgolly.luminoAlgorithm.typesFilterMod.FilterIterator[T] {
    /**
  ...
  open class FnIterator[T] protected ()
    extends typingsJapgolly.luminoAlgorithm.typesIterMod.FnIterator[T] {
    /**
  ...
  open class ItemIterator[T] protected ()
    extends typingsJapgolly.luminoAlgorithm.typesIterMod.ItemIterator[T] {
    /**
  ...
  open class KeyIterator protected ()
    extends typingsJapgolly.luminoAlgorithm.typesIterMod.KeyIterator {
    /**
  ...
  open class MapIterator[T, U] protected ()
    extends typingsJapgolly.luminoAlgorithm.typesMapMod.MapIterator[T, U] {
    /**
  ...
  open class RangeIterator protected ()
    extends typingsJapgolly.luminoAlgorithm.typesRangeMod.RangeIterator {
    /**
  ...
  open class RepeatIterator[T] protected ()
    extends typingsJapgolly.luminoAlgorithm.typesRepeatMod.RepeatIterator[T] {
    /**
  ...
  open class RetroArrayIterator[T] protected ()
    extends typingsJapgolly.luminoAlgorithm.typesRetroMod.RetroArrayIterator[T] {
    /**
  ...
  open class StrideIterator[T] protected ()
    extends typingsJapgolly.luminoAlgorithm.typesStrideMod.StrideIterator[T] {
    /**
  ...
  open class TakeIterator[T] protected ()
    extends typingsJapgolly.luminoAlgorithm.typesTakeMod.TakeIterator[T] {
    /**
  ...
  open class ValueIterator[T] protected ()
    extends typingsJapgolly.luminoAlgorithm.typesIterMod.ValueIterator[T] {
    /**
  ...
  open class ZipIterator[T] protected ()
    extends typingsJapgolly.luminoAlgorithm.typesZipMod.ZipIterator[T] {
    /**
