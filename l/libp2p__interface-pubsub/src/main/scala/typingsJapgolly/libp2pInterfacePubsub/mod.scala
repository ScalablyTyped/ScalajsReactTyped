package typingsJapgolly.libp2pInterfacePubsub
...
import typingsJapgolly.libp2pInterfacePubsub.libp2pInterfacePubsubStrings.signed
import typingsJapgolly.libp2pInterfacePubsub.libp2pInterfacePubsubStrings.unsigned
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.libp2pInterfacePubsub.mod.SignedMessage
    - typingsJapgolly.libp2pInterfacePubsub.mod.UnsignedMessage
  */
  ...
  object Message {
    ...
    inline def SignedMessage(
      ...
      __obj.asInstanceOf[typingsJapgolly.libp2pInterfacePubsub.mod.SignedMessage]
    }
    
    inline def UnsignedMessage(data: js.typedarray.Uint8Array, topic: String): typingsJapgolly.libp2pInterfacePubsub.mod.UnsignedMessage = {
      ...
      __obj.asInstanceOf[typingsJapgolly.libp2pInterfacePubsub.mod.UnsignedMessage]
    }
  }
  ...
  trait PeerStreamEvents extends StObject {
    ...
    var streamColoninbound: CustomEvent
    
    @JSName("stream:outbound")
    var streamColonoutbound: CustomEvent
  }
  object PeerStreamEvents {
    
    inline def apply(close: CustomEvent, streamColoninbound: CustomEvent, streamColonoutbound: CustomEvent): PeerStreamEvents = {
    ...
    extension [Self <: PeerStreamEvents](x: Self) {
      ...
      inline def setStreamColoninbound(value: CustomEvent): Self = StObject.set(x, "stream:inbound", value.asInstanceOf[js.Any])
      
      inline def setStreamColonoutbound(value: CustomEvent): Self = StObject.set(x, "stream:outbound", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait PubSubEvents extends StObject {
    ...
    var message: CustomEvent
    
    var `subscription-change`: CustomEvent
  }
  object PubSubEvents {
    
    inline def apply(message: CustomEvent, `subscription-change`: CustomEvent): PubSubEvents = {
    ...
    extension [Self <: PubSubEvents](x: Self) {
      ...
      inline def setMessage(value: CustomEvent): Self = StObject.set(x, "message", value.asInstanceOf[js.Any])
      
      inline def `setSubscription-change`(value: CustomEvent): Self = StObject.set(x, "subscription-change", value.asInstanceOf[js.Any])
    }
  }
