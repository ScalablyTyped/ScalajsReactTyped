...
object mod {
  ...
  type BatchOperation[TDatabase, K, V] = (typingsJapgolly.classicLevel.mod.BatchOperation[TDatabase, K, V]) & (typingsJapgolly.browserLevel.mod.BatchOperation[TDatabase, K, V])
  
  trait BatchOptions[K, V]
    extends StObject
       with typingsJapgolly.classicLevel.mod.BatchOptions[K, V]
  object BatchOptions {
  ...
  trait ChainedBatch[TDatabase, K, V]
    extends typingsJapgolly.classicLevel.mod.ChainedBatch[TDatabase, K, V]
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.abstractLevel.typesAbstractLevelMod.AbstractDatabaseOptions because var conflicts: createIfMissing, errorIfExists, keyEncoding, valueEncoding. Inlined 
  - typingsJapgolly.browserLevel.mod.DatabaseOptions because var conflicts: createIfMissing, errorIfExists, keyEncoding, valueEncoding. Inlined prefix, version */ trait DatabaseOptions[K, V]
    extends StObject
       with typingsJapgolly.classicLevel.mod.DatabaseOptions[K, V] {
  ...
  trait DelOptions[K]
    extends StObject
       with typingsJapgolly.classicLevel.mod.DelOptions[K]
  object DelOptions {
  ...
  trait GetManyOptions[K, V]
    extends StObject
       with typingsJapgolly.classicLevel.mod.GetManyOptions[K, V]
  ...
  trait GetOptions[K, V]
    extends StObject
       with typingsJapgolly.classicLevel.mod.GetOptions[K, V]
  object GetOptions {
  ...
  trait IteratorOptions[K, V]
    extends StObject
       with typingsJapgolly.classicLevel.mod.IteratorOptions[K, V]
  ...
  trait KeyIteratorOptions[K]
    extends StObject
       with typingsJapgolly.classicLevel.mod.KeyIteratorOptions[K]
  ...
  trait OpenOptions
    extends StObject
       with typingsJapgolly.classicLevel.mod.OpenOptions
  object OpenOptions {
  ...
  trait PutOptions[K, V]
    extends StObject
       with typingsJapgolly.classicLevel.mod.PutOptions[K, V]
  object PutOptions {
  ...
  trait ValueIteratorOptions[K, V]
    extends StObject
       with typingsJapgolly.classicLevel.mod.ValueIteratorOptions[K, V]
