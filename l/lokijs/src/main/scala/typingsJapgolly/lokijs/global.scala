...
object global {
  ...
  open class DynamicView[E /* <: js.Object */] protected ()
    ...
    /**
      ...
      */
    def this(collection: typingsJapgolly.lokijs.Collection[E], name: String) = this()
    def this(collection: typingsJapgolly.lokijs.Collection[E], name: String, options: PartialDynamicViewOptions) = this()
  }
  ...
  open class ExactIndex[E /* <: js.Object */] protected ()
    extends StObject
       with typingsJapgolly.lokijs.ExactIndex[E] {
  ...
  open class Loki protected ()
    extends StObject
       with typingsJapgolly.lokijs.Loki {
    /**
  ...
  object LokiConstructor {
    ...
    open class LokiPartitioningAdapter ()
      ...
      /* CompleteClass */
      var dbref: typingsJapgolly.lokijs.Loki | Null = js.native
      ...
      override def exportDatabase_MLokiPartitioningAdapter(
        dbname: String,
        dbref: typingsJapgolly.lokijs.Loki,
    ...
    object persistenceAdapters {
      ...
      @js.native
      def fs: typingsJapgolly.lokijs._LokiFsAdapter = js.native
      inline def fs_=(x: typingsJapgolly.lokijs._LokiFsAdapter): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fs")(x.asInstanceOf[js.Any])
      
      @JSGlobal("LokiConstructor.persistenceAdapters.localStorage")
      @js.native
      def localStorage: typingsJapgolly.lokijs._LokiLocalStorageAdapter = js.native
      inline def localStorage_=(x: typingsJapgolly.lokijs._LokiLocalStorageAdapter): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("localStorage")(x.asInstanceOf[js.Any])
    }
  }
  ...
  open class LokiEventEmitter ()
    extends StObject
       with typingsJapgolly.lokijs.LokiEventEmitter
  ...
  open class Resultset[E /* <: js.Object */] protected ()
    extends StObject
       with typingsJapgolly.lokijs.Resultset[E] {
    /**
      * @param collection - The collection which this Resultset will query against.
      * @param options
      */
    def this(collection: typingsJapgolly.lokijs.Collection[E]) = this()
    def this(collection: typingsJapgolly.lokijs.Collection[E], options: Any) = this()
  }
  ...
  open class SortedIndex protected ()
    extends StObject
       with typingsJapgolly.lokijs.SortedIndex {
  ...
  open class UniqueIndex[E /* <: js.Object */] protected ()
    extends StObject
       with typingsJapgolly.lokijs.UniqueIndex[E] {
