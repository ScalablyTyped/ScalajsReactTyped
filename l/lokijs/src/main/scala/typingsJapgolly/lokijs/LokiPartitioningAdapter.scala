...
object LokiPartitioningAdapter {
  ...
  inline def apply(
    dbname: String,
    exportDatabase: (String, Loki, js.Function1[/* err */ js.Error | Null, Unit]) => Callback,
    loadDatabase: (String, js.Function1[/* value */ Any, Unit]) => Callback,
    loadNextPage: js.Function0[Unit] => Callback,
    loadNextPartition: (Double, js.Function0[Unit]) => Callback,
    mode: String,
    options: PageSize,
    pageIterator: PageIterator | js.Object,
    saveNextPage: js.Function1[/* err */ js.Error | Null, Unit] => Callback,
    saveNextPartition: js.Function1[/* err */ js.Error | Null, Unit] => Callback
  ): LokiPartitioningAdapter = {
    val __obj = js.Dynamic.literal(dbname = dbname.asInstanceOf[js.Any], exportDatabase = js.Any.fromFunction3((t0: String, t1: Loki, t2: js.Function1[/* err */ js.Error | Null, Unit]) => (exportDatabase(t0, t1, t2)).runNow()), loadDatabase = js.Any.fromFunction2((t0: String, t1: js.Function1[/* value */ Any, Unit]) => (loadDatabase(t0, t1)).runNow()), loadNextPage = js.Any.fromFunction1((t0: js.Function0[Unit]) => loadNextPage(t0).runNow()), loadNextPartition = js.Any.fromFunction2((t0: Double, t1: js.Function0[Unit]) => (loadNextPartition(t0, t1)).runNow()), mode = mode.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], pageIterator = pageIterator.asInstanceOf[js.Any], saveNextPage = js.Any.fromFunction1((t0: js.Function1[/* err */ js.Error | Null, Unit]) => saveNextPage(t0).runNow()), saveNextPartition = js.Any.fromFunction1((t0: js.Function1[/* err */ js.Error | Null, Unit]) => saveNextPartition(t0).runNow()), adapter = null, dbref = null)
  ...
  extension [Self <: LokiPartitioningAdapter](x: Self) {
    ...
    inline def setExportDatabase(value: (String, Loki, js.Function1[/* err */ js.Error | Null, Unit]) => Callback): Self = StObject.set(x, "exportDatabase", js.Any.fromFunction3((t0: String, t1: Loki, t2: js.Function1[/* err */ js.Error | Null, Unit]) => (value(t0, t1, t2)).runNow()))
    
    inline def setLoadNextPage(value: js.Function0[Unit] => Callback): Self = StObject.set(x, "loadNextPage", js.Any.fromFunction1((t0: js.Function0[Unit]) => value(t0).runNow()))
    
    inline def setLoadNextPartition(value: (Double, js.Function0[Unit]) => Callback): Self = StObject.set(x, "loadNextPartition", js.Any.fromFunction2((t0: Double, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
    ...
    inline def setSaveNextPage(value: js.Function1[/* err */ js.Error | Null, Unit] => Callback): Self = StObject.set(x, "saveNextPage", js.Any.fromFunction1((t0: js.Function1[/* err */ js.Error | Null, Unit]) => value(t0).runNow()))
    
    inline def setSaveNextPartition(value: js.Function1[/* err */ js.Error | Null, Unit] => Callback): Self = StObject.set(x, "saveNextPartition", js.Any.fromFunction1((t0: js.Function1[/* err */ js.Error | Null, Unit]) => value(t0).runNow()))
  }
}
