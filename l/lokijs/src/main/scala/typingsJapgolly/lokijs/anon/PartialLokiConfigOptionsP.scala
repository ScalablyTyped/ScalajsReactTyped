...
object PartialLokiConfigOptionsP {
  ...
  extension [Self <: PartialLokiConfigOptionsP](x: Self) {
    ...
    inline def setAutoloadCallback(value: /* err */ Any => Callback): Self = StObject.set(x, "autoloadCallback", js.Any.fromFunction1((t0: /* err */ Any) => value(t0).runNow()))
    ...
    inline def setAutosaveCallback(value: /* err */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "autosaveCallback", js.Any.fromFunction1((t0: /* err */ js.UndefOr[Any]) => value(t0).runNow()))
