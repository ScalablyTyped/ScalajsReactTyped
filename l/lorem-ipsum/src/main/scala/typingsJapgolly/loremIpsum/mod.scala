...
import typingsJapgolly.loremIpsum.typesSrcLibGeneratorMod.IGeneratorOptions
import typingsJapgolly.loremIpsum.typesSrcLibGeneratorMod.IPrng
import typingsJapgolly.loremIpsum.typesSrcLibLoremIpsumMod.default
