package typingsJapgolly.leafletTextpath
...
object leafletMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.leafletTextpath.leafletTextpathStrings.flip
    - typingsJapgolly.leafletTextpath.leafletTextpathStrings.perpendicular
    - scala.Double
  */
