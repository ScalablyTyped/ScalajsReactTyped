...
import typingsJapgolly.lib0.distPairMod.Pair
...
object dom {
  ...
  inline def fragment(children: HTMLCollection[Any]): DocumentFragment = ^.asInstanceOf[js.Dynamic].applyDynamic("fragment")(children.asInstanceOf[js.Any]).asInstanceOf[DocumentFragment]
  ...
  inline def querySelectorAll(el: HTMLElement, query: String): NodeList[HTMLElement & Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("querySelectorAll")(el.asInstanceOf[js.Any], query.asInstanceOf[js.Any])).asInstanceOf[NodeList[HTMLElement & Node]]
  inline def querySelectorAll(el: ShadowRoot, query: String): NodeList[HTMLElement & Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("querySelectorAll")(el.asInstanceOf[js.Any], query.asInstanceOf[js.Any])).asInstanceOf[NodeList[HTMLElement & Node]]
