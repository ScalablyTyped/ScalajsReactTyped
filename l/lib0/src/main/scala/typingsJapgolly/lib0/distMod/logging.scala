...
object logging {
  ...
  open class VConsole protected ()
    extends typingsJapgolly.lib0.distLoggingMod.VConsole {
    /**
      * @param {Element} dom
      */
  ...
  inline def createVConsole(dom: Element): typingsJapgolly.lib0.distLoggingMod.VConsole = ^.asInstanceOf[js.Dynamic].applyDynamic("createVConsole")(dom.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.lib0.distLoggingMod.VConsole]
