...
import typingsJapgolly.lib0.distPrngMod.PRNG
...
object distTestingMod {
  ...
  @JSImport("lib0/dist/testing", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("lib0/dist/testing", "TestCase")
  @js.native
  ...
  @JSImport("lib0/dist/testing", "envSeed")
  @js.native
  val envSeed: Double | Null = js.native
  
  @JSImport("lib0/dist/testing", "extensive")
  @js.native
  ...
  @JSImport("lib0/dist/testing", "production")
  @js.native
  val production: Boolean = js.native
  
  @JSImport("lib0/dist/testing", "repetitionTime")
  @js.native
