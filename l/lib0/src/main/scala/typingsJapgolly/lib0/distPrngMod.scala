...
import typingsJapgolly.lib0.distPrngXoroshiro128plusMod.Xoroshiro128plus
...
object distPrngMod {
  ...
  @JSImport("lib0/dist/prng", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("lib0/dist/prng", "DefaultPRNG")
  @js.native
  ...
  object PRNG {
    ...
    inline def apply(next: CallbackTo[Double]): PRNG = {
