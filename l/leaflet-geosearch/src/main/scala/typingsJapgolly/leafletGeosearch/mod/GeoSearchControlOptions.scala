...
import typingsJapgolly.leafletGeosearch.AnonButton
import typingsJapgolly.leafletGeosearch.AnonQuery
import typingsJapgolly.leafletGeosearch.leafletGeosearchStrings.bar
import typingsJapgolly.leafletGeosearch.leafletGeosearchStrings.button
...
object GeoSearchControlOptions {
  ...
  def apply(
    ...
    popupFormat: /* hasQueryResult */ AnonQuery => CallbackTo[String] = null,
    ...
    if (popupFormat != null) __obj.updateDynamic("popupFormat")(js.Any.fromFunction1((t0: /* hasQueryResult */ typingsJapgolly.leafletGeosearch.AnonQuery) => popupFormat(t0).runNow()))
