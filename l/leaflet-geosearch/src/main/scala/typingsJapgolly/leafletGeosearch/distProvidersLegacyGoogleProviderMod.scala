...
import typingsJapgolly.leafletGeosearch.anon.Compoundcode
import typingsJapgolly.leafletGeosearch.anon.Location
import typingsJapgolly.leafletGeosearch.anon.Longname
