...
object distProvidersProviderMod {
  ...
  object RequestType extends StObject {
    ...
    sealed trait REVERSE
      extends StObject
         with RequestType
    /* 1 */ val REVERSE: typingsJapgolly.leafletGeosearch.distProvidersProviderMod.RequestType.REVERSE & Double = js.native
    
    @js.native
    sealed trait SEARCH
      extends StObject
         with RequestType
    /* 0 */ val SEARCH: typingsJapgolly.leafletGeosearch.distProvidersProviderMod.RequestType.SEARCH & Double = js.native
  }
