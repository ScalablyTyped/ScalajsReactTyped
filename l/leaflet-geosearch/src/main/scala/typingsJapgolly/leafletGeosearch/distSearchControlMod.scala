...
import typingsJapgolly.leafletGeosearch.anon.Button
import typingsJapgolly.leafletGeosearch.anon.OmitSearchControlPropspro
import typingsJapgolly.leafletGeosearch.anon.Query
import typingsJapgolly.leafletGeosearch.anon.Result
import typingsJapgolly.leafletGeosearch.distProvidersMod.Provider
import typingsJapgolly.leafletGeosearch.distProvidersProviderMod.SearchResult
import typingsJapgolly.leafletGeosearch.distResultListMod.default
...
object distSearchControlMod {
  ...
  trait SearchControl extends StObject {
    ...
    var searchElement: typingsJapgolly.leafletGeosearch.distSearchElementMod.default = js.native
