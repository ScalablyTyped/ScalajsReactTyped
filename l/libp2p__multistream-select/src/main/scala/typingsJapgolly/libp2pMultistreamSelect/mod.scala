...
import typingsJapgolly.libp2pMultistreamSelect.libp2pMultistreamSelectBooleans.`false`
import typingsJapgolly.libp2pMultistreamSelect.libp2pMultistreamSelectBooleans.`true`
