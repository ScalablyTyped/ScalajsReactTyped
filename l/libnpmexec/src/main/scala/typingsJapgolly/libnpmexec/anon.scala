package typingsJapgolly.libnpmexec
...
object anon {
  ...
  object DisableProgress {
    ...
    inline def apply(warn: (String, String) => Callback): DisableProgress = {
      val __obj = js.Dynamic.literal(warn = js.Any.fromFunction2((t0: String, t1: String) => (warn(t0, t1)).runNow()))
      __obj.asInstanceOf[DisableProgress]
    }
    
    extension [Self <: DisableProgress](x: Self) {
      
      inline def setDisableProgress(value: Callback): Self = StObject.set(x, "disableProgress", value.toJsFn)
      
      inline def setDisableProgressUndefined: Self = StObject.set(x, "disableProgress", js.undefined)
      
      inline def setEnableProgress(value: Callback): Self = StObject.set(x, "enableProgress", value.toJsFn)
      
      inline def setEnableProgressUndefined: Self = StObject.set(x, "enableProgress", js.undefined)
      
      inline def setWarn(value: (String, String) => Callback): Self = StObject.set(x, "warn", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
    }
  }
}
