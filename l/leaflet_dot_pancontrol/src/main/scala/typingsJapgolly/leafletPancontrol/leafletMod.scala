package typingsJapgolly.leafletPancontrol

import typingsJapgolly.leaflet.mod.ControlOptions
import typingsJapgolly.leafletPancontrol.leafletMod.Control_.Pan
import typingsJapgolly.leafletPancontrol.leafletMod.Control_.PanControlOptions
