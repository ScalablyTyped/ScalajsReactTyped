...
object libEncodingMod {
  ...
  object IEncoding {
    ...
    extension [Self <: IEncoding[?, ?, ?], TIn, TFormat, TOut](x: Self & (IEncoding[TIn, TFormat, TOut])) {
      ...
      inline def setCreateBufferTranscoder(value: CallbackTo[BufferFormat[TIn, TOut]]): Self = StObject.set(x, "createBufferTranscoder", value.toJsFn)
      
      inline def setCreateBufferTranscoderUndefined: Self = StObject.set(x, "createBufferTranscoder", js.undefined)
      
      inline def setCreateUTF8Transcoder(value: CallbackTo[UTF8Format[TIn, TOut]]): Self = StObject.set(x, "createUTF8Transcoder", value.toJsFn)
      
      inline def setCreateUTF8TranscoderUndefined: Self = StObject.set(x, "createUTF8Transcoder", js.undefined)
      
      inline def setCreateViewTranscoder(value: CallbackTo[ViewFormat[TIn, TOut]]): Self = StObject.set(x, "createViewTranscoder", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.levelTranscoder.levelTranscoderStrings.utf8
    - typingsJapgolly.levelTranscoder.levelTranscoderStrings.buffer
    - typingsJapgolly.levelTranscoder.levelTranscoderStrings.view
    - typingsJapgolly.levelTranscoder.levelTranscoderStrings.json
    - typingsJapgolly.levelTranscoder.levelTranscoderStrings.hex
    - typingsJapgolly.levelTranscoder.levelTranscoderStrings.base64
  */
  trait KnownEncodingName extends StObject
  object KnownEncodingName {
    
    inline def base64: typingsJapgolly.levelTranscoder.levelTranscoderStrings.base64 = "base64".asInstanceOf[typingsJapgolly.levelTranscoder.levelTranscoderStrings.base64]
    
    inline def buffer: typingsJapgolly.levelTranscoder.levelTranscoderStrings.buffer = "buffer".asInstanceOf[typingsJapgolly.levelTranscoder.levelTranscoderStrings.buffer]
    
    inline def hex: typingsJapgolly.levelTranscoder.levelTranscoderStrings.hex = "hex".asInstanceOf[typingsJapgolly.levelTranscoder.levelTranscoderStrings.hex]
    
    inline def json: typingsJapgolly.levelTranscoder.levelTranscoderStrings.json = "json".asInstanceOf[typingsJapgolly.levelTranscoder.levelTranscoderStrings.json]
    
    inline def utf8: typingsJapgolly.levelTranscoder.levelTranscoderStrings.utf8 = "utf8".asInstanceOf[typingsJapgolly.levelTranscoder.levelTranscoderStrings.utf8]
    
    inline def view: typingsJapgolly.levelTranscoder.levelTranscoderStrings.view = "view".asInstanceOf[typingsJapgolly.levelTranscoder.levelTranscoderStrings.view]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.levelTranscoder.libEncodingMod.IEncoding[TIn, TFormat, TOut]
    - typingsJapgolly.levelTranscoder.libEncodingMod.IExternalEncoding[TIn, TFormat, TOut]
  */
  trait MixedEncoding[TIn, TFormat, TOut] extends StObject
  object MixedEncoding {
    
    inline def IEncoding[TIn, TFormat, TOut](decode: TFormat => TOut, encode: TIn => TFormat, format: buffer | view | utf8, name: String): typingsJapgolly.levelTranscoder.libEncodingMod.IEncoding[TIn, TFormat, TOut] = {
      val __obj = js.Dynamic.literal(decode = js.Any.fromFunction1(decode), encode = js.Any.fromFunction1(encode), format = format.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.levelTranscoder.libEncodingMod.IEncoding[TIn, TFormat, TOut]]
    }
    
    inline def IExternalEncoding[TIn, TFormat, TOut](decode: TFormat => TOut, encode: TIn => TFormat): typingsJapgolly.levelTranscoder.libEncodingMod.IExternalEncoding[TIn, TFormat, TOut] = {
      val __obj = js.Dynamic.literal(decode = js.Any.fromFunction1(decode), encode = js.Any.fromFunction1(encode))
      __obj.asInstanceOf[typingsJapgolly.levelTranscoder.libEncodingMod.IExternalEncoding[TIn, TFormat, TOut]]
    }
  }
