package typingsJapgolly.luminoProperties

import japgolly.scalajs.react.Callback
import typingsJapgolly.luminoProperties.mod.AttachedProperty.IOptions
  ...
  object AttachedProperty {
    ...
    object IOptions {
      ...
      extension [Self <: IOptions[?, ?], T, U](x: Self & (IOptions[T, U])) {
        ...
        inline def setChanged(value: (/* owner */ T, /* oldValue */ U, /* newValue */ U) => Callback): Self = StObject.set(x, "changed", js.Any.fromFunction3((t0: /* owner */ T, t1: /* oldValue */ U, t2: /* newValue */ U) => (value(t0, t1, t2)).runNow()))
