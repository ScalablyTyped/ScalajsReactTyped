...
object mod {
  ...
  object ASN1Tag {
    ...
    inline def apply(
      isEOC: CallbackTo[Boolean],
      isUniversal: CallbackTo[Boolean],
      tagClass: Double,
      tagConstructed: Boolean,
      tagNumber: Double
    ): ASN1Tag = {
      val __obj = js.Dynamic.literal(isEOC = isEOC.toJsFn, isUniversal = isUniversal.toJsFn, tagClass = tagClass.asInstanceOf[js.Any], tagConstructed = tagConstructed.asInstanceOf[js.Any], tagNumber = tagNumber.asInstanceOf[js.Any])
      __obj.asInstanceOf[ASN1Tag]
    }
    
    extension [Self <: ASN1Tag](x: Self) {
      
      inline def setIsEOC(value: CallbackTo[Boolean]): Self = StObject.set(x, "isEOC", value.toJsFn)
      
      inline def setIsUniversal(value: CallbackTo[Boolean]): Self = StObject.set(x, "isUniversal", value.toJsFn)
