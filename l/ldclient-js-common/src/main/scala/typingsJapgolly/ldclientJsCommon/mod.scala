...
import typingsJapgolly.ldclientJsCommon.anon.Current
...
object mod {
  ...
  object LDLogger {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(debug = js.Any.fromFunction1((t0: String) => debug(t0).runNow()), error = js.Any.fromFunction1((t0: String) => error(t0).runNow()), info = js.Any.fromFunction1((t0: String) => info(t0).runNow()), warn = js.Any.fromFunction1((t0: String) => warn(t0).runNow()))
