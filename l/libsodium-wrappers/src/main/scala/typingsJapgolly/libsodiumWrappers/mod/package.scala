...
import typingsJapgolly.libsodiumWrappers.libsodiumWrappersBooleans.`true`
import typingsJapgolly.libsodiumWrappers.libsodiumWrappersStrings.uint8array
import typingsJapgolly.libsodiumWrappers.mod.^
