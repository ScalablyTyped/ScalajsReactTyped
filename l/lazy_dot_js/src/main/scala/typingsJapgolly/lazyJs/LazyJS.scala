...
import typingsJapgolly.lazyJs.anon.Property
import typingsJapgolly.lazyJs.lazyJsBooleans.`false`
import typingsJapgolly.lazyJs.lazyJsBooleans.`true`
...
object LazyJS {
  ...
  object AsyncHandle {
    ...
    inline def apply[T](
      ...
      val __obj = js.Dynamic.literal(cancel = cancel.toJsFn, onComplete = js.Any.fromFunction1((t0: Callback) => onComplete(t0).runNow()), onError = js.Any.fromFunction1((t0: ErrorCallback) => onError(t0).runNow()))
    ...
    extension [Self <: AsyncHandle[?], T](x: Self & AsyncHandle[T]) {
      ...
      inline def setOnComplete(value: Callback => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onComplete", js.Any.fromFunction1((t0: Callback) => value(t0).runNow()))
      
      inline def setOnError(value: ErrorCallback => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: ErrorCallback) => value(t0).runNow()))
    }
  }
