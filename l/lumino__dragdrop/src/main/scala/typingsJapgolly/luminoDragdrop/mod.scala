package typingsJapgolly.luminoDragdrop

import org.scalajs.dom.Document
import org.scalajs.dom.Event
import org.scalajs.dom.HTMLElement
import typingsJapgolly.luminoCoreutils.mod.MimeData
import typingsJapgolly.luminoDisposable.mod.IDisposable
import typingsJapgolly.luminoDragdrop.mod.Drag.IOptions
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.luminoDragdrop.luminoDragdropStrings.none
    - typingsJapgolly.luminoDragdrop.luminoDragdropStrings.copy
    - typingsJapgolly.luminoDragdrop.luminoDragdropStrings.link
    - typingsJapgolly.luminoDragdrop.luminoDragdropStrings.move
  */
  trait DropAction extends StObject
  object DropAction {
    
    inline def copy: typingsJapgolly.luminoDragdrop.luminoDragdropStrings.copy = "copy".asInstanceOf[typingsJapgolly.luminoDragdrop.luminoDragdropStrings.copy]
    
    inline def link: typingsJapgolly.luminoDragdrop.luminoDragdropStrings.link = "link".asInstanceOf[typingsJapgolly.luminoDragdrop.luminoDragdropStrings.link]
    
    inline def move: typingsJapgolly.luminoDragdrop.luminoDragdropStrings.move = "move".asInstanceOf[typingsJapgolly.luminoDragdrop.luminoDragdropStrings.move]
    
    inline def none: typingsJapgolly.luminoDragdrop.luminoDragdropStrings.none = "none".asInstanceOf[typingsJapgolly.luminoDragdrop.luminoDragdropStrings.none]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.luminoDragdrop.luminoDragdropStrings.`copy-link`
    - typingsJapgolly.luminoDragdrop.luminoDragdropStrings.`copy-move`
    - typingsJapgolly.luminoDragdrop.luminoDragdropStrings.`link-move`
    - typingsJapgolly.luminoDragdrop.luminoDragdropStrings.all
    - typingsJapgolly.luminoDragdrop.luminoDragdropStrings.none
    - typingsJapgolly.luminoDragdrop.luminoDragdropStrings.copy
    - typingsJapgolly.luminoDragdrop.luminoDragdropStrings.link
    - typingsJapgolly.luminoDragdrop.luminoDragdropStrings.move
  */
  ...
  object SupportedActions {
    ...
    inline def all: typingsJapgolly.luminoDragdrop.luminoDragdropStrings.all = "all".asInstanceOf[typingsJapgolly.luminoDragdrop.luminoDragdropStrings.all]
    
    inline def copy: typingsJapgolly.luminoDragdrop.luminoDragdropStrings.copy = "copy".asInstanceOf[typingsJapgolly.luminoDragdrop.luminoDragdropStrings.copy]
    
    inline def `copy-link`: typingsJapgolly.luminoDragdrop.luminoDragdropStrings.`copy-link` = "copy-link".asInstanceOf[typingsJapgolly.luminoDragdrop.luminoDragdropStrings.`copy-link`]
    
    inline def `copy-move`: typingsJapgolly.luminoDragdrop.luminoDragdropStrings.`copy-move` = "copy-move".asInstanceOf[typingsJapgolly.luminoDragdrop.luminoDragdropStrings.`copy-move`]
    
    inline def link: typingsJapgolly.luminoDragdrop.luminoDragdropStrings.link = "link".asInstanceOf[typingsJapgolly.luminoDragdrop.luminoDragdropStrings.link]
    
    inline def `link-move`: typingsJapgolly.luminoDragdrop.luminoDragdropStrings.`link-move` = "link-move".asInstanceOf[typingsJapgolly.luminoDragdrop.luminoDragdropStrings.`link-move`]
