...
object AnonCacheFile {
  ...
  def apply(
    ...
    storeCss: (/* pathname */ String, /* css */ String, /* req */ Request_[ParamsDictionary], /* next */ js.Function) => Callback = null
  ): AnonCacheFile = {
    ...
    if (storeCss != null) __obj.updateDynamic("storeCss")(js.Any.fromFunction4((t0: /* pathname */ java.lang.String, t1: /* css */ java.lang.String, t2: /* req */ typingsJapgolly.express.mod.Request_[typingsJapgolly.expressServeStaticCore.mod.ParamsDictionary], t3: /* next */ js.Function) => storeCss(t0, t1, t2, t3).runNow()))
