...
object dn {
  ...
  trait DN extends StObject {
    ...
    def pop(): typingsJapgolly.ldapjs.mod.dn.RDN = js.native
    
    /** Pushes and RDN to this DN */
    def push(rdn: typingsJapgolly.ldapjs.mod.dn.RDN): Unit = js.native
    ...
    def shift(): typingsJapgolly.ldapjs.mod.dn.RDN = js.native
    
    def unshift(rdn: typingsJapgolly.ldapjs.mod.dn.RDN): Unit = js.native
  }
  ...
  trait RDN extends StObject {
    ...
    def equals(rdn: typingsJapgolly.ldapjs.mod.dn.RDN): Boolean = js.native
