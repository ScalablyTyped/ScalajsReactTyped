...
object Localize extends js.Object {
  ...
  def translate(input: typingsJapgolly.std.HTMLElement): Unit = js.native
  def translate(input: typingsJapgolly.std.HTMLElement, variables: js.Any): Unit = js.native
  def translate(
    input: typingsJapgolly.std.HTMLElement,
    variables: js.Any,
    callback: js.Function1[/* translation */ String | HTMLElement, Unit]
  ): Unit = js.native
  /**
