...
object srcLtxMod {
  ...
  inline def clone_(el: typingsJapgolly.ltx.srcElementMod.Element): typingsJapgolly.ltx.srcElementMod.Element = ^.asInstanceOf[js.Dynamic].applyDynamic("clone")(el.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ltx.srcElementMod.Element]
