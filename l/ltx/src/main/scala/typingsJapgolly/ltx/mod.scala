...
object mod {
  ...
  open class Element protected ()
    extends typingsJapgolly.ltx.libLtxMod.Element {
  ...
  @js.native
  open class Parser ()
    extends typingsJapgolly.ltx.libLtxMod.Parser {
  ...
  object Parser {
    ...
    @JSImport("ltx", "Parser.DefaultElement")
    @js.native
    ...
    @JSImport("ltx", "Parser.DefaultParser")
    @js.native
