...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "engine_dot_io-client" % "6.2.3-998b10",
  ...
  "org.scalablytyped.japgolly" %%% "libp2p__webrtc-peer" % "2.0.0-9de7ea",
  "org.scalablytyped.japgolly" %%% "libp2p__webrtc-star-protocol" % "2.0.1-febbde",
  ...
  "org.scalablytyped.japgolly" %%% "socket_dot_io-client" % "4.5.3-9ada2b",
