...
import typingsJapgolly.logrocket.anon.BaseHref
import typingsJapgolly.logrocket.anon.IsEnabled
import typingsJapgolly.logrocket.anon.RequestSanitizer
import typingsJapgolly.logrocket.anon.UrlSanitizer
  ...
  object LR {
    ...
    object IOptions {
      ...
      extension [Self <: IOptions](x: Self) {
        ...
        inline def setShouldSendData(value: CallbackTo[Boolean]): Self = StObject.set(x, "shouldSendData", value.toJsFn)
