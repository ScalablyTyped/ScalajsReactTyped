...
import typingsJapgolly.libp2pCrypto.distSrcKeysEd25519ClassMod.Ed25519PrivateKey
import typingsJapgolly.libp2pCrypto.distSrcKeysEd25519ClassMod.Ed25519PublicKey
import typingsJapgolly.libp2pCrypto.distSrcKeysRsaClassMod.RsaPrivateKey
import typingsJapgolly.libp2pCrypto.distSrcKeysRsaClassMod.RsaPublicKey
import typingsJapgolly.libp2pCrypto.distSrcKeysSecp256k1ClassMod.Secp256k1PrivateKey
import typingsJapgolly.libp2pCrypto.distSrcKeysSecp256k1ClassMod.Secp256k1PublicKey
...
object anon {
  ...
  object Abs {
    ...
    inline def apply(abs: CallbackTo[Any]): Abs = {
    ...
    extension [Self <: Abs](x: Self) {
      ...
      inline def setAbs(value: CallbackTo[Any]): Self = StObject.set(x, "abs", value.toJsFn)
    }
  }
  ...
  trait TypeofEd25519 extends StObject {
    ...
    var Ed25519PrivateKey: Instantiable2[
        ...
        typingsJapgolly.libp2pCrypto.distSrcKeysEd25519ClassMod.Ed25519PrivateKey
      ]
    
    var Ed25519PublicKey: Instantiable1[
        /* key */ js.typedarray.Uint8Array, 
        typingsJapgolly.libp2pCrypto.distSrcKeysEd25519ClassMod.Ed25519PublicKey
      ]
  ...
  object TypeofEd25519 {
    ...
    inline def apply(
      ...
      generateKeyPair: CallbackTo[js.Promise[Ed25519PrivateKey]],
    ...
    extension [Self <: TypeofEd25519](x: Self) {
      ...
      inline def setGenerateKeyPair(value: CallbackTo[js.Promise[Ed25519PrivateKey]]): Self = StObject.set(x, "generateKeyPair", value.toJsFn)
  ...
  trait TypeofRSA extends StObject {
    ...
    var RsaPrivateKey: Instantiable2[
        ...
        typingsJapgolly.libp2pCrypto.distSrcKeysRsaClassMod.RsaPrivateKey
      ]
    
    var RsaPublicKey: Instantiable1[
        /* key */ JsonWebKey, 
        typingsJapgolly.libp2pCrypto.distSrcKeysRsaClassMod.RsaPublicKey
      ]
  ...
  trait TypeofSecp256k1 extends StObject {
    ...
    var Secp256k1PrivateKey: Instantiable2[
        ...
        typingsJapgolly.libp2pCrypto.distSrcKeysSecp256k1ClassMod.Secp256k1PrivateKey
      ]
    
    var Secp256k1PublicKey: Instantiable1[
        /* key */ js.typedarray.Uint8Array, 
        typingsJapgolly.libp2pCrypto.distSrcKeysSecp256k1ClassMod.Secp256k1PublicKey
      ]
  ...
  object TypeofSecp256k1 {
    ...
    inline def apply(
      ...
      generateKeyPair: CallbackTo[js.Promise[Secp256k1PrivateKey]],
      ...
      val __obj = js.Dynamic.literal(Secp256k1PrivateKey = Secp256k1PrivateKey.asInstanceOf[js.Any], Secp256k1PublicKey = Secp256k1PublicKey.asInstanceOf[js.Any], generateKeyPair = generateKeyPair.toJsFn, unmarshalSecp256k1PrivateKey = js.Any.fromFunction1(unmarshalSecp256k1PrivateKey), unmarshalSecp256k1PublicKey = js.Any.fromFunction1(unmarshalSecp256k1PublicKey))
      __obj.asInstanceOf[TypeofSecp256k1]
    }
    
    extension [Self <: TypeofSecp256k1](x: Self) {
      
      inline def setGenerateKeyPair(value: CallbackTo[js.Promise[Secp256k1PrivateKey]]): Self = StObject.set(x, "generateKeyPair", value.toJsFn)
