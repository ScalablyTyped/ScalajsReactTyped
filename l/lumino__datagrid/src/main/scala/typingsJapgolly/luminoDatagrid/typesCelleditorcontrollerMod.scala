...
import typingsJapgolly.luminoDatagrid.typesCelleditorMod.CellEditor.CellConfig
import typingsJapgolly.luminoDatagrid.typesCelleditorMod.ICellEditOptions
import typingsJapgolly.luminoDatagrid.typesCelleditorMod.ICellEditor
...
object typesCelleditorcontrollerMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.luminoDatagrid.typesCelleditorMod.CellDataType
    - typingsJapgolly.luminoDatagrid.typesDatamodelMod.DataModel.Metadata
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.default
  */
