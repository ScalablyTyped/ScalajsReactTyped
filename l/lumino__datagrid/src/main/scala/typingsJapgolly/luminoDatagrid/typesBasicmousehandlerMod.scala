...
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`column-resize`
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`row-resize`
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.select
import typingsJapgolly.luminoDatagrid.typesBasicmousehandlerMod.PressData.PressData
...
object typesBasicmousehandlerMod {
  ...
  object PressData {
    ...
    trait ColumnResizeData
      extends StObject
         with typingsJapgolly.luminoDatagrid.typesBasicmousehandlerMod.PressData.PressData {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.luminoDatagrid.typesBasicmousehandlerMod.PressData.RowResizeData
      - typingsJapgolly.luminoDatagrid.typesBasicmousehandlerMod.PressData.ColumnResizeData
      - typingsJapgolly.luminoDatagrid.typesBasicmousehandlerMod.PressData.SelectData
    */
    trait PressData extends StObject
    object PressData {
      
      inline def ColumnResizeData(clientX: Double, index: Double, `override`: IDisposable, region: ColumnRegion, size: Double): typingsJapgolly.luminoDatagrid.typesBasicmousehandlerMod.PressData.ColumnResizeData = {
        val __obj = js.Dynamic.literal(clientX = clientX.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any])
        __obj.updateDynamic("override")(`override`.asInstanceOf[js.Any])
        __obj.updateDynamic("type")("column-resize")
        __obj.asInstanceOf[typingsJapgolly.luminoDatagrid.typesBasicmousehandlerMod.PressData.ColumnResizeData]
      }
      
      inline def RowResizeData(clientY: Double, index: Double, `override`: IDisposable, region: RowRegion, size: Double): typingsJapgolly.luminoDatagrid.typesBasicmousehandlerMod.PressData.RowResizeData = {
        ...
        __obj.asInstanceOf[typingsJapgolly.luminoDatagrid.typesBasicmousehandlerMod.PressData.RowResizeData]
      }
      ...
      inline def SelectData(
        ...
        __obj.asInstanceOf[typingsJapgolly.luminoDatagrid.typesBasicmousehandlerMod.PressData.SelectData]
      }
    }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.hyperlink
  */
  ...
  object ResizeHandle {
    ...
    inline def hyperlink: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.hyperlink = "hyperlink".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.hyperlink]
