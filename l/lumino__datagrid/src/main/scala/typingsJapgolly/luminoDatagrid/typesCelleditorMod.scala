...
import typingsJapgolly.luminoDatagrid.typesCelleditorMod.Private.ICellInfo
...
import typingsJapgolly.luminoDatagrid.typesNotificationMod.Notification
...
import typingsJapgolly.luminoSignaling.mod.Signal
...
object typesCelleditorMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.string
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.number
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.integer
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.boolean
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.date
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.stringColonoption
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.numberColonoption
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.integerColonoption
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.dateColonoption
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`stringColondynamic-option`
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`numberColondynamic-option`
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`integerColondynamic-option`
    - typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`dateColondynamic-option`
  */
  trait CellDataType
    extends StObject
  ...
  object CellDataType {
    ...
    inline def boolean: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.boolean = "boolean".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.boolean]
    
    inline def date: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.date = "date".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.date]
    
    inline def `dateColondynamic-option`: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`dateColondynamic-option` = "date:dynamic-option".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`dateColondynamic-option`]
    
    inline def dateColonoption: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.dateColonoption = "date:option".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.dateColonoption]
    
    inline def integer: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.integer = "integer".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.integer]
    
    inline def `integerColondynamic-option`: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`integerColondynamic-option` = "integer:dynamic-option".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`integerColondynamic-option`]
    
    inline def integerColonoption: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.integerColonoption = "integer:option".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.integerColonoption]
    
    inline def number: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.number = "number".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.number]
    
    inline def `numberColondynamic-option`: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`numberColondynamic-option` = "number:dynamic-option".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`numberColondynamic-option`]
    
    inline def numberColonoption: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.numberColonoption = "number:option".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.numberColonoption]
    
    inline def string: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.string = "string".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.string]
    
    inline def `stringColondynamic-option`: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`stringColondynamic-option` = "string:dynamic-option".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.`stringColondynamic-option`]
    
    inline def stringColonoption: typingsJapgolly.luminoDatagrid.luminoDatagridStrings.stringColonoption = "string:option".asInstanceOf[typingsJapgolly.luminoDatagrid.luminoDatagridStrings.stringColonoption]
  }
  ...
  object ICellEditOptions {
    ...
    extension [Self <: ICellEditOptions](x: Self) {
      ...
      inline def setOnCommit(value: /* response */ ICellEditResponse => Callback): Self = StObject.set(x, "onCommit", js.Any.fromFunction1((t0: /* response */ ICellEditResponse) => value(t0).runNow()))
