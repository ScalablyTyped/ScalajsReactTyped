...
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.column
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.row
import typingsJapgolly.luminoDatagrid.typesBasicmousehandlerMod.PressData.SelectData
...
import typingsJapgolly.luminoDatagrid.typesDatagridMod.DataGrid.CopyConfig
import typingsJapgolly.luminoDatagrid.typesDatagridMod.DataGrid.CopyFormatArgs
import typingsJapgolly.luminoDatagrid.typesDatagridMod.DataGrid.DefaultSizes_
import typingsJapgolly.luminoDatagrid.typesDatagridMod.DataGrid.HitTestResult
import typingsJapgolly.luminoDatagrid.typesDatagridMod.DataGrid.MinimumSizes_
import typingsJapgolly.luminoDatagrid.typesDatagridMod.DataGrid.Style
...
import typingsJapgolly.luminoDatagrid.typesRenderermapMod.RendererMap.Values
import typingsJapgolly.luminoDatagrid.typesSelectionmodelMod.SelectionModel.IOptions
import typingsJapgolly.luminoDatagrid.typesTextrendererMod.TextRenderer.FormatFunc
...
object mod {
  ...
  open class BasicKeyHandler ()
    extends typingsJapgolly.luminoDatagrid.typesBasickeyhandlerMod.BasicKeyHandler
  
  @JSImport("@lumino/datagrid", "BasicMouseHandler")
  @js.native
  open class BasicMouseHandler ()
    extends typingsJapgolly.luminoDatagrid.typesBasicmousehandlerMod.BasicMouseHandler
  
  @JSImport("@lumino/datagrid", "BasicSelectionModel")
  @js.native
  open class BasicSelectionModel protected ()
    extends typingsJapgolly.luminoDatagrid.typesBasicselectionmodelMod.BasicSelectionModel {
    /**
  ...
  open class BooleanCellEditor ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorMod.BooleanCellEditor
  ...
  open class CellEditor ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorMod.CellEditor
  
  @JSImport("@lumino/datagrid", "CellEditorController")
  @js.native
  open class CellEditorController ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorcontrollerMod.CellEditorController
  ...
  object CellGroup {
    ...
    inline def areCellGroupsIntersecting(
      group1: typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup,
      group2: typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup
    ...
    inline def areCellsMerged(
      dataModel: typingsJapgolly.luminoDatagrid.typesDatamodelMod.DataModel,
      rgn: CellRegion,
    ...
    inline def calculateMergeOffsets(
      ...
      axis: row | column,
      sectionList: typingsJapgolly.luminoDatagrid.typesSectionlistMod.SectionList,
      index: Double
    ): js.Tuple3[Double, Double, typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup] = (^.asInstanceOf[js.Dynamic].applyDynamic("calculateMergeOffsets")(dataModel.asInstanceOf[js.Any], regions.asInstanceOf[js.Any], axis.asInstanceOf[js.Any], sectionList.asInstanceOf[js.Any], index.asInstanceOf[js.Any])).asInstanceOf[js.Tuple3[Double, Double, typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup]]
    ...
    /**
      ...
      */
    inline def getCellGroupsAtColumn(
      dataModel: typingsJapgolly.luminoDatagrid.typesDatamodelMod.DataModel,
      rgn: CellRegion,
      column: Double
    ): js.Array[typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup] = (^.asInstanceOf[js.Dynamic].applyDynamic("getCellGroupsAtColumn")(dataModel.asInstanceOf[js.Any], rgn.asInstanceOf[js.Any], column.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup]]
    ...
    /**
      ...
      * @param rgn
      */
    inline def getCellGroupsAtRegion(dataModel: typingsJapgolly.luminoDatagrid.typesDatamodelMod.DataModel, rgn: CellRegion): js.Array[typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup] = (^.asInstanceOf[js.Dynamic].applyDynamic("getCellGroupsAtRegion")(dataModel.asInstanceOf[js.Any], rgn.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup]]
    ...
    /**
      ...
      */
    inline def getCellGroupsAtRow(
      dataModel: typingsJapgolly.luminoDatagrid.typesDatamodelMod.DataModel,
      rgn: CellRegion,
      row: Double
    ): js.Array[typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup] = (^.asInstanceOf[js.Dynamic].applyDynamic("getCellGroupsAtRow")(dataModel.asInstanceOf[js.Any], rgn.asInstanceOf[js.Any], row.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup]]
    ...
    inline def getGroup(
      ...
      row: Double,
      column: Double
    ): typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getGroup")(dataModel.asInstanceOf[js.Any], rgn.asInstanceOf[js.Any], row.asInstanceOf[js.Any], column.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup | Null]
    ...
    inline def joinCellGroupWithMergedCellGroups(
      dataModel: typingsJapgolly.luminoDatagrid.typesDatamodelMod.DataModel,
      group: typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup,
      region: CellRegion
    ): typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("joinCellGroupWithMergedCellGroups")(dataModel.asInstanceOf[js.Any], group.asInstanceOf[js.Any], region.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup]
    ...
    /**
      ...
      * @param groups
      */
    inline def joinCellGroups(groups: js.Array[typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup]): typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup = ^.asInstanceOf[js.Dynamic].applyDynamic("joinCellGroups")(groups.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup]
    ...
    inline def joinCellGroupsIntersectingAtAxis(
      ...
      axis: row | column,
      group: typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup
    ): typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("joinCellGroupsIntersectingAtAxis")(dataModel.asInstanceOf[js.Any], regions.asInstanceOf[js.Any], axis.asInstanceOf[js.Any], group.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.luminoDatagrid.typesCellgroupMod.CellGroup]
  }
  
  /* note: abstract class */ @JSImport("@lumino/datagrid", "CellRenderer")
  @js.native
  open class CellRenderer ()
    extends typingsJapgolly.luminoDatagrid.typesCellrendererMod.CellRenderer
  object CellRenderer {
  ...
  /**
    ...
    */
  open class DataGrid ()
    extends typingsJapgolly.luminoDatagrid.typesDatagridMod.DataGrid {
    def this(options: typingsJapgolly.luminoDatagrid.typesDatagridMod.DataGrid.IOptions) = this()
  }
  object DataGrid {
  ...
  open class DataModel ()
    extends typingsJapgolly.luminoDatagrid.typesDatamodelMod.DataModel
  object DataModel {
  ...
  open class DateCellEditor ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorMod.DateCellEditor
  ...
  open class DynamicOptionCellEditor ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorMod.DynamicOptionCellEditor
  
  @JSImport("@lumino/datagrid", "GraphicsContext")
  @js.native
  open class GraphicsContext protected ()
    extends typingsJapgolly.luminoDatagrid.typesGraphicscontextMod.GraphicsContext {
    /**
  ...
  open class HyperlinkRenderer ()
    extends typingsJapgolly.luminoDatagrid.typesHyperlinkrendererMod.HyperlinkRenderer {
    def this(options: typingsJapgolly.luminoDatagrid.typesHyperlinkrendererMod.HyperlinkRenderer.IOptions) = this()
  }
  ...
  open class InputCellEditor ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorMod.InputCellEditor
  ...
  open class IntegerCellEditor ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorMod.IntegerCellEditor
  
  @JSImport("@lumino/datagrid", "IntegerInputValidator")
  @js.native
  open class IntegerInputValidator ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorMod.IntegerInputValidator
  
  @JSImport("@lumino/datagrid", "JSONModel")
  @js.native
  open class JSONModel protected ()
    extends typingsJapgolly.luminoDatagrid.typesJsonmodelMod.JSONModel {
    /**
      * Create a data model with static JSON data.
      *
      * @param options - The options for initializing the data model.
      */
    def this(options: typingsJapgolly.luminoDatagrid.typesJsonmodelMod.JSONModel.IOptions) = this()
  }
  
  /* note: abstract class */ @JSImport("@lumino/datagrid", "MutableDataModel")
  @js.native
  open class MutableDataModel ()
    extends typingsJapgolly.luminoDatagrid.typesDatamodelMod.MutableDataModel
  ...
  open class NumberCellEditor ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorMod.NumberCellEditor
  
  @JSImport("@lumino/datagrid", "NumberInputValidator")
  @js.native
  open class NumberInputValidator ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorMod.NumberInputValidator
  ...
  open class OptionCellEditor ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorMod.OptionCellEditor
  
  @JSImport("@lumino/datagrid", "PassInputValidator")
  @js.native
  open class PassInputValidator ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorMod.PassInputValidator
  ...
  object Private {
    ...
    /**
      ...
      */
    inline def autoselect(grid: typingsJapgolly.luminoDatagrid.typesDatagridMod.DataGrid, data: SelectData): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("autoselect")(grid.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    /**
      ...
      */
    inline def createCellConfigObject(grid: typingsJapgolly.luminoDatagrid.typesDatagridMod.DataGrid, hit: HitTestResult): js.UndefOr[CellConfig] = (^.asInstanceOf[js.Dynamic].applyDynamic("createCellConfigObject")(grid.asInstanceOf[js.Any], hit.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[CellConfig]]
  ...
  open class RendererMap ()
    extends typingsJapgolly.luminoDatagrid.typesRenderermapMod.RendererMap {
    def this(values: Values) = this()
    def this(values: Unit, fallback: typingsJapgolly.luminoDatagrid.typesCellrendererMod.CellRenderer) = this()
    def this(values: Values, fallback: typingsJapgolly.luminoDatagrid.typesCellrendererMod.CellRenderer) = this()
  }
  
  @JSImport("@lumino/datagrid", "SectionList")
  @js.native
  open class SectionList protected ()
    extends typingsJapgolly.luminoDatagrid.typesSectionlistMod.SectionList {
    /**
      * Construct a new section list.
      *
      * @param options - The options for initializing the list.
      */
    def this(options: typingsJapgolly.luminoDatagrid.typesSectionlistMod.SectionList.IOptions) = this()
  }
  
  /* note: abstract class */ @JSImport("@lumino/datagrid", "SelectionModel")
  @js.native
  open class SelectionModel protected ()
    extends typingsJapgolly.luminoDatagrid.typesSelectionmodelMod.SelectionModel {
    /**
      * Construct a new selection model.
      *
      * @param options - The options for initializing the model.
  ...
  open class TextCellEditor ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorMod.TextCellEditor
  
  @JSImport("@lumino/datagrid", "TextInputValidator")
  @js.native
  open class TextInputValidator ()
    extends typingsJapgolly.luminoDatagrid.typesCelleditorMod.TextInputValidator
  ...
  open class TextRenderer ()
    extends typingsJapgolly.luminoDatagrid.typesTextrendererMod.TextRenderer {
    def this(options: typingsJapgolly.luminoDatagrid.typesTextrendererMod.TextRenderer.IOptions) = this()
  }
  object TextRenderer {
    ...
    /**
      * The namespace for the `formatDate` function statics.
      */
    inline def formatDate(options: typingsJapgolly.luminoDatagrid.typesTextrendererMod.TextRenderer.formatDate.IOptions): FormatFunc = ^.asInstanceOf[js.Dynamic].applyDynamic("formatDate")(options.asInstanceOf[js.Any]).asInstanceOf[FormatFunc]
    ...
    /**
      * The namespace for the `formatExponential` function statics.
      */
    inline def formatExponential(
      options: typingsJapgolly.luminoDatagrid.typesTextrendererMod.TextRenderer.formatExponential.IOptions
    ): FormatFunc = ^.asInstanceOf[js.Dynamic].applyDynamic("formatExponential")(options.asInstanceOf[js.Any]).asInstanceOf[FormatFunc]
    ...
    /**
      * The namespace for the `formatFixed` function statics.
      */
    inline def formatFixed(options: typingsJapgolly.luminoDatagrid.typesTextrendererMod.TextRenderer.formatFixed.IOptions): FormatFunc = ^.asInstanceOf[js.Dynamic].applyDynamic("formatFixed")(options.asInstanceOf[js.Any]).asInstanceOf[FormatFunc]
    ...
    /**
      * The namespace for the `formatGeneric` function statics.
      */
    inline def formatGeneric(options: typingsJapgolly.luminoDatagrid.typesTextrendererMod.TextRenderer.formatGeneric.IOptions): FormatFunc = ^.asInstanceOf[js.Dynamic].applyDynamic("formatGeneric")(options.asInstanceOf[js.Any]).asInstanceOf[FormatFunc]
    ...
    /**
      * The namespace for the `formatISODateTime` function statics.
      */
    inline def formatISODateTime(
      options: typingsJapgolly.luminoDatagrid.typesTextrendererMod.TextRenderer.formatISODateTime.IOptions
    ): FormatFunc = ^.asInstanceOf[js.Dynamic].applyDynamic("formatISODateTime")(options.asInstanceOf[js.Any]).asInstanceOf[FormatFunc]
    ...
    /**
      * The namespace for the `formatIntlDateTime` function statics.
      */
    inline def formatIntlDateTime(
      options: typingsJapgolly.luminoDatagrid.typesTextrendererMod.TextRenderer.formatIntlDateTime.IOptions
    ): FormatFunc = ^.asInstanceOf[js.Dynamic].applyDynamic("formatIntlDateTime")(options.asInstanceOf[js.Any]).asInstanceOf[FormatFunc]
    ...
    /**
      * The namespace for the `formatIntlNumber` function statics.
      */
    inline def formatIntlNumber(
      options: typingsJapgolly.luminoDatagrid.typesTextrendererMod.TextRenderer.formatIntlNumber.IOptions
    ): FormatFunc = ^.asInstanceOf[js.Dynamic].applyDynamic("formatIntlNumber")(options.asInstanceOf[js.Any]).asInstanceOf[FormatFunc]
    ...
    /**
      * The namespace for the `formatPrecision` function statics.
      */
    inline def formatPrecision(options: typingsJapgolly.luminoDatagrid.typesTextrendererMod.TextRenderer.formatPrecision.IOptions): FormatFunc = ^.asInstanceOf[js.Dynamic].applyDynamic("formatPrecision")(options.asInstanceOf[js.Any]).asInstanceOf[FormatFunc]
    ...
    /**
      * The namespace for the `formatTime` function statics.
      */
    inline def formatTime(options: typingsJapgolly.luminoDatagrid.typesTextrendererMod.TextRenderer.formatTime.IOptions): FormatFunc = ^.asInstanceOf[js.Dynamic].applyDynamic("formatTime")(options.asInstanceOf[js.Any]).asInstanceOf[FormatFunc]
    ...
    /**
      * The namespace for the `formatUTCDateTime` function statics.
      */
    inline def formatUTCDateTime(
      options: typingsJapgolly.luminoDatagrid.typesTextrendererMod.TextRenderer.formatUTCDateTime.IOptions
    ): FormatFunc = ^.asInstanceOf[js.Dynamic].applyDynamic("formatUTCDateTime")(options.asInstanceOf[js.Any]).asInstanceOf[FormatFunc]
  ...
  inline def resolveOption[T](
    option: typingsJapgolly.luminoDatagrid.typesCelleditorcontrollerMod.ConfigOption[T],
    config: typingsJapgolly.luminoDatagrid.typesCelleditorMod.CellEditor.CellConfig
