...
import typingsJapgolly.luminoDatagrid.anon.Color1
import typingsJapgolly.luminoDatagrid.anon.Lx
import typingsJapgolly.luminoDatagrid.anon.Vx
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.all
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.column
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.down
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.left
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.none
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.right
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.row
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.up
import typingsJapgolly.luminoDatagrid.luminoDatagridStrings.void
import typingsJapgolly.luminoDatagrid.typesCelleditorcontrollerMod.ICellEditorController
import typingsJapgolly.luminoDatagrid.typesCellrendererMod.CellRenderer
...
import typingsJapgolly.luminoDatagrid.typesDatagridMod.DataGrid.IMouseHandler
import typingsJapgolly.luminoDatagrid.typesDatagridMod.DataGrid.IOptions
...
import typingsJapgolly.luminoDatagrid.typesRenderermapMod.RendererMap
import typingsJapgolly.luminoDatagrid.typesSectionlistMod.SectionList
import typingsJapgolly.luminoDatagrid.typesSelectionmodelMod.SelectionModel
...
import typingsJapgolly.luminoMessaging.mod.IMessageHandler
import typingsJapgolly.luminoMessaging.mod.Message
import typingsJapgolly.luminoWidgets.mod.Widget
import typingsJapgolly.luminoWidgets.mod.Widget.ResizeMessage
  ...
  object DataGrid {
    ...
    */
    ...
    object IKeyHandler {
      ...
      inline def apply(dispose: Callback, isDisposed: Boolean, onKeyDown: (DataGrid, KeyboardEvent) => Callback): IKeyHandler = {
        val __obj = js.Dynamic.literal(dispose = dispose.toJsFn, isDisposed = isDisposed.asInstanceOf[js.Any], onKeyDown = js.Any.fromFunction2((t0: DataGrid, t1: KeyboardEvent) => (onKeyDown(t0, t1)).runNow()))
        __obj.asInstanceOf[IKeyHandler]
      }
      
      extension [Self <: IKeyHandler](x: Self) {
        
        inline def setOnKeyDown(value: (DataGrid, KeyboardEvent) => Callback): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction2((t0: DataGrid, t1: KeyboardEvent) => (value(t0, t1)).runNow()))
      }
    }
    ...
    object IMouseHandler {
      ...
      inline def apply(
        dispose: Callback,
        isDisposed: Boolean,
        onContextMenu: (DataGrid, MouseEvent) => Callback,
        onMouseDoubleClick: (DataGrid, MouseEvent) => Callback,
        onMouseDown: (DataGrid, MouseEvent) => Callback,
        onMouseHover: (DataGrid, MouseEvent) => Callback,
        onMouseLeave: (DataGrid, MouseEvent) => Callback,
        onMouseMove: (DataGrid, MouseEvent) => Callback,
        onMouseUp: (DataGrid, MouseEvent) => Callback,
        onWheel: (DataGrid, WheelEvent) => Callback,
        release: Callback
      ): IMouseHandler = {
        val __obj = js.Dynamic.literal(dispose = dispose.toJsFn, isDisposed = isDisposed.asInstanceOf[js.Any], onContextMenu = js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (onContextMenu(t0, t1)).runNow()), onMouseDoubleClick = js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (onMouseDoubleClick(t0, t1)).runNow()), onMouseDown = js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (onMouseDown(t0, t1)).runNow()), onMouseHover = js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (onMouseHover(t0, t1)).runNow()), onMouseLeave = js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (onMouseLeave(t0, t1)).runNow()), onMouseMove = js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (onMouseMove(t0, t1)).runNow()), onMouseUp = js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (onMouseUp(t0, t1)).runNow()), onWheel = js.Any.fromFunction2((t0: DataGrid, t1: WheelEvent) => (onWheel(t0, t1)).runNow()), release = release.toJsFn)
        __obj.asInstanceOf[IMouseHandler]
      }
      
      extension [Self <: IMouseHandler](x: Self) {
        
        inline def setOnContextMenu(value: (DataGrid, MouseEvent) => Callback): Self = StObject.set(x, "onContextMenu", js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (value(t0, t1)).runNow()))
        
        inline def setOnMouseDoubleClick(value: (DataGrid, MouseEvent) => Callback): Self = StObject.set(x, "onMouseDoubleClick", js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (value(t0, t1)).runNow()))
        
        inline def setOnMouseDown(value: (DataGrid, MouseEvent) => Callback): Self = StObject.set(x, "onMouseDown", js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (value(t0, t1)).runNow()))
        
        inline def setOnMouseHover(value: (DataGrid, MouseEvent) => Callback): Self = StObject.set(x, "onMouseHover", js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (value(t0, t1)).runNow()))
        
        inline def setOnMouseLeave(value: (DataGrid, MouseEvent) => Callback): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (value(t0, t1)).runNow()))
        
        inline def setOnMouseMove(value: (DataGrid, MouseEvent) => Callback): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (value(t0, t1)).runNow()))
        
        inline def setOnMouseUp(value: (DataGrid, MouseEvent) => Callback): Self = StObject.set(x, "onMouseUp", js.Any.fromFunction2((t0: DataGrid, t1: MouseEvent) => (value(t0, t1)).runNow()))
        
        inline def setOnWheel(value: (DataGrid, WheelEvent) => Callback): Self = StObject.set(x, "onWheel", js.Any.fromFunction2((t0: DataGrid, t1: WheelEvent) => (value(t0, t1)).runNow()))
