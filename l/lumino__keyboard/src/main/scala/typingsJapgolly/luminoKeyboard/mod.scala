package typingsJapgolly.luminoKeyboard

import japgolly.scalajs.react.CallbackTo
import org.scalablytyped.runtime.NumberDictionary
import org.scalablytyped.runtime.StringDictionary
import org.scalajs.dom.KeyboardEvent
import typingsJapgolly.luminoKeyboard.mod.KeycodeLayout.CodeMap
...
object mod {
  ...
  object IKeyboardLayout {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(isModifierKey = js.Any.fromFunction1(isModifierKey), isValidKey = js.Any.fromFunction1(isValidKey), keyForKeydownEvent = js.Any.fromFunction1(keyForKeydownEvent), keys = keys.toJsFn, name = name.asInstanceOf[js.Any])
