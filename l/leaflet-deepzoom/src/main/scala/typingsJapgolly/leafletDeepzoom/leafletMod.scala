package typingsJapgolly.leafletDeepzoom

import typingsJapgolly.leafletDeepzoom.leafletMod.TileLayer_.DeepZoom
import typingsJapgolly.leafletDeepzoom.leafletMod.TileLayer_.DeepZoomOptions
