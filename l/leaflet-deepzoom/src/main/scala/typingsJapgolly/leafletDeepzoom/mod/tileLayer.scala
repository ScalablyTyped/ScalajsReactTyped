package typingsJapgolly.leafletDeepzoom.mod

import typingsJapgolly.leafletDeepzoom.mod.TileLayer_.DeepZoom
import typingsJapgolly.leafletDeepzoom.mod.TileLayer_.DeepZoomOptions
