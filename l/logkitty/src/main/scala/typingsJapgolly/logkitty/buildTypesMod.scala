...
object buildTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.logkitty.logkittyStrings.ios
    - typingsJapgolly.logkitty.logkittyStrings.android
  */
  trait Platform extends StObject
  object Platform {
    
    inline def android: typingsJapgolly.logkitty.logkittyStrings.android = "android".asInstanceOf[typingsJapgolly.logkitty.logkittyStrings.android]
    
    inline def ios: typingsJapgolly.logkitty.logkittyStrings.ios = "ios".asInstanceOf[typingsJapgolly.logkitty.logkittyStrings.ios]
  }
}
