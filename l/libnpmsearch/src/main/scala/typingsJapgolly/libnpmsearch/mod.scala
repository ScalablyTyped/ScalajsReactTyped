...
import typingsJapgolly.libnpmsearch.anon.Maintenance
import typingsJapgolly.libnpmsearch.anon.Optionsdetailedtrue
...
object mod {
  ...
  trait Options
    extends StObject
       with SearchOptions
       with typingsJapgolly.npmRegistryFetch.mod.Options
  object Options {
