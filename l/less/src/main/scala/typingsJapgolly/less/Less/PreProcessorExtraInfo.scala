...
trait PreProcessorExtraInfo extends StObject {
  ...
  var context: typingsJapgolly.less.anon.PluginManager
...
object PreProcessorExtraInfo {
  ...
  inline def apply(
    context: typingsJapgolly.less.anon.PluginManager,
    fileInfo: RootFileInfo,
    imports: StringDictionary[Any]
  ...
  extension [Self <: PreProcessorExtraInfo](x: Self) {
    ...
    inline def setContext(value: typingsJapgolly.less.anon.PluginManager): Self = StObject.set(x, "context", value.asInstanceOf[js.Any])
