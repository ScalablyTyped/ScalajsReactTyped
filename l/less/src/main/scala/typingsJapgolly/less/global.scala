...
import typingsJapgolly.less.Less.Environment
import typingsJapgolly.less.Less.FileLoadError
import typingsJapgolly.less.Less.FileLoadResult
import typingsJapgolly.less.Less.LoadFileOptions
...
object global {
  ...
  object Less_ {
    ...
    open class AbstractFileManager ()
      extends StObject
         with typingsJapgolly.less.Less.AbstractFileManager {
    ...
    open class FileManager ()
      extends StObject
         with typingsJapgolly.less.Less.FileManager {
    ...
    open class PluginManager protected ()
      extends StObject
         with typingsJapgolly.less.Less.PluginManager {
