...
import typingsJapgolly.locomotiveScroll.anon.DeviceOptionsbreakpointnu
import typingsJapgolly.locomotiveScroll.anon.El
import typingsJapgolly.locomotiveScroll.locomotiveScrollBooleans.`false`
import typingsJapgolly.locomotiveScroll.locomotiveScrollStrings.call
import typingsJapgolly.locomotiveScroll.locomotiveScrollStrings.scroll
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.locomotiveScroll.locomotiveScrollStrings.vertical
    - typingsJapgolly.locomotiveScroll.locomotiveScrollStrings.horizontal
  */
  trait Direction extends StObject
  object Direction {
    
    inline def horizontal: typingsJapgolly.locomotiveScroll.locomotiveScrollStrings.horizontal = "horizontal".asInstanceOf[typingsJapgolly.locomotiveScroll.locomotiveScrollStrings.horizontal]
    
    inline def vertical: typingsJapgolly.locomotiveScroll.locomotiveScrollStrings.vertical = "vertical".asInstanceOf[typingsJapgolly.locomotiveScroll.locomotiveScrollStrings.vertical]
  }
