package typingsJapgolly.layuiLayer

import japgolly.scalajs.react.Callback
import org.scalajs.dom.HTMLElement
import typingsJapgolly.jquery.JQuery
import typingsJapgolly.layuiLayer.anon.PartialCSSStyleDeclaratio
import typingsJapgolly.layuiLayer.layer.callback.Cancel
import typingsJapgolly.layuiLayer.layer.callback.End
import typingsJapgolly.layuiLayer.layer.callback.Prompt
import typingsJapgolly.layuiLayer.layer.callback.Yes
import typingsJapgolly.layuiLayer.layuiLayerBooleans.`false`
import typingsJapgolly.layuiLayer.layuiLayerInts.`-1`
import typingsJapgolly.layuiLayer.layuiLayerInts.`0`
import typingsJapgolly.layuiLayer.layuiLayerInts.`1`
import typingsJapgolly.layuiLayer.layuiLayerInts.`2`
import typingsJapgolly.layuiLayer.layuiLayerInts.`3`
import typingsJapgolly.layuiLayer.layuiLayerInts.`4`
import typingsJapgolly.layuiLayer.layuiLayerInts.`5`
import typingsJapgolly.layuiLayer.layuiLayerInts.`6`
import typingsJapgolly.layuiLayer.layuiLayerStrings.c
import typingsJapgolly.layuiLayer.layuiLayerStrings.dialog
import typingsJapgolly.layuiLayer.layuiLayerStrings.iframe
import typingsJapgolly.layuiLayer.layuiLayerStrings.l
import typingsJapgolly.layuiLayer.layuiLayerStrings.loading
import typingsJapgolly.layuiLayer.layuiLayerStrings.page
import typingsJapgolly.layuiLayer.layuiLayerStrings.r
import typingsJapgolly.layuiLayer.layuiLayerStrings.tips
...
object layer {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setFull(value: /* layero */ JQuery[HTMLElement] => Callback): Self = StObject.set(x, "full", js.Any.fromFunction1((t0: /* layero */ JQuery[HTMLElement]) => value(t0).runNow()))
      ...
      inline def setResizing(value: /* layero */ JQuery[HTMLElement] => Callback): Self = StObject.set(x, "resizing", js.Any.fromFunction1((t0: /* layero */ JQuery[HTMLElement]) => value(t0).runNow()))
      
      inline def setResizingUndefined: Self = StObject.set(x, "resizing", js.undefined)
      
      inline def setRestore(value: /* layero */ JQuery[HTMLElement] => Callback): Self = StObject.set(x, "restore", js.Any.fromFunction1((t0: /* layero */ JQuery[HTMLElement]) => value(t0).runNow()))
      ...
      inline def setSuccess(value: (/* layero */ JQuery[HTMLElement], /* index */ Index) => Callback): Self = StObject.set(x, "success", js.Any.fromFunction2((t0: /* layero */ JQuery[HTMLElement], t1: /* index */ Index) => (value(t0, t1)).runNow()))
      ...
      inline def setYes(value: (/* index */ Index, /* layero */ JQuery[HTMLElement]) => Callback): Self = StObject.set(x, "yes", js.Any.fromFunction2((t0: /* index */ Index, t1: /* layero */ JQuery[HTMLElement]) => (value(t0, t1)).runNow()))
  ...
  object PhotosOptions {
    ...
    extension [Self <: PhotosOptions](x: Self) {
      ...
      inline def setTab(value: (/* pic */ PhotosDataItem, /* layero */ JQuery[HTMLElement]) => Callback): Self = StObject.set(x, "tab", js.Any.fromFunction2((t0: /* pic */ PhotosDataItem, t1: /* layero */ JQuery[HTMLElement]) => (value(t0, t1)).runNow()))
