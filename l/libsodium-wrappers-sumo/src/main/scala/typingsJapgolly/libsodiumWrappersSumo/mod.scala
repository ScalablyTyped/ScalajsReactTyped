package typingsJapgolly.libsodiumWrappersSumo

import typingsJapgolly.libsodiumWrappers.anon.Header
import typingsJapgolly.libsodiumWrappers.anon.State
...
import typingsJapgolly.libsodiumWrappers.mod.SecretBox
...
import typingsJapgolly.libsodiumWrappers.mod.StringSecretBox
import typingsJapgolly.libsodiumWrappers.mod.Uint8ArrayOutputFormat
import typingsJapgolly.libsodiumWrappers.mod.base64Variants
import typingsJapgolly.libsodiumWrappersSumo.libsodiumWrappersSumoBooleans.`true`
...
object mod {
  ...
  object base64Variants extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.libsodiumWrappers.mod.base64Variants & Double] = js.native
