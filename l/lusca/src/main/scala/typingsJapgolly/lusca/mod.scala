...
import typingsJapgolly.lusca.anon.Name
import typingsJapgolly.lusca.anon.Options
...
object mod {
  ...
  */
  ...
  object csrfOptionsAngularOrNonAngular {
    ...
    inline def csrfOptionsAngular(): typingsJapgolly.lusca.mod.csrfOptionsAngular = {
      val __obj = js.Dynamic.literal(angular = true)
      __obj.asInstanceOf[typingsJapgolly.lusca.mod.csrfOptionsAngular]
    }
    
    inline def csrfOptionsNonAngular(): typingsJapgolly.lusca.mod.csrfOptionsNonAngular = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.lusca.mod.csrfOptionsNonAngular]
    }
  }
  ...
  object csrfOptionsBase {
    ...
    extension [Self <: csrfOptionsBase](x: Self) {
      ...
      inline def setImpl(value: CallbackTo[Any]): Self = StObject.set(x, "impl", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.lusca.mod.csrfOptionsBlocklist
    - typingsJapgolly.lusca.mod.csrfOptionsAllowlist
  */
  trait csrfOptionsBlocklistOrAllowlist extends StObject
  object csrfOptionsBlocklistOrAllowlist {
    
    inline def csrfOptionsAllowlist(): typingsJapgolly.lusca.mod.csrfOptionsAllowlist = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.lusca.mod.csrfOptionsAllowlist]
    }
    
    inline def csrfOptionsBlocklist(): typingsJapgolly.lusca.mod.csrfOptionsBlocklist = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.lusca.mod.csrfOptionsBlocklist]
    }
  }
