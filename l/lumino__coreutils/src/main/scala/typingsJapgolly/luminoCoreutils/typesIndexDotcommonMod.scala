...
object typesIndexDotcommonMod {
  ...
  @js.native
  open class MimeData ()
    extends typingsJapgolly.luminoCoreutils.typesMimeMod.MimeData
  ...
  open class PromiseDelegate[T] ()
    extends typingsJapgolly.luminoCoreutils.typesPromiseMod.PromiseDelegate[T]
  
  @JSImport("@lumino/coreutils/types/index.common", "Token")
  @js.native
  open class Token[T] protected ()
    extends typingsJapgolly.luminoCoreutils.typesTokenMod.Token[T] {
    /**
