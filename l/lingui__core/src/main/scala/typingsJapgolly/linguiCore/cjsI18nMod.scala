...
import typingsJapgolly.linguiCore.cjsEventEmitterMod.EventEmitter
...
object cjsI18nMod {
  ...
  object Events {
    ...
    inline def apply(change: Callback, missing: MissingMessageEvent => Callback): Events = {
      val __obj = js.Dynamic.literal(change = change.toJsFn, missing = js.Any.fromFunction1((t0: MissingMessageEvent) => missing(t0).runNow()))
    ...
    extension [Self <: Events](x: Self) {
      ...
      inline def setMissing(value: MissingMessageEvent => Callback): Self = StObject.set(x, "missing", js.Any.fromFunction1((t0: MissingMessageEvent) => value(t0).runNow()))
    }
  }
