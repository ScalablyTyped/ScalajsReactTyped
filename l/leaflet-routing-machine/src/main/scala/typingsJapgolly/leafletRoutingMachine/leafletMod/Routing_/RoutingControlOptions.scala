...
import typingsJapgolly.leafletRoutingMachine.leafletRoutingMachineStrings.connect
import typingsJapgolly.leafletRoutingMachine.leafletRoutingMachineStrings.smart
import typingsJapgolly.leafletRoutingMachine.leafletRoutingMachineStrings.snap
...
object RoutingControlOptions {
  ...
  extension [Self <: RoutingControlOptions](x: Self) {
    ...
    inline def setDefaultErrorHandler(value: /* error */ Any => Callback): Self = StObject.set(x, "defaultErrorHandler", js.Any.fromFunction1((t0: /* error */ Any) => value(t0).runNow()))
