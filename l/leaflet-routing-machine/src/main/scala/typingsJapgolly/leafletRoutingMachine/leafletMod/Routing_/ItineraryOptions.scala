...
object ItineraryOptions {
  ...
  extension [Self <: ItineraryOptions](x: Self) {
    ...
    inline def setCollapseBtn(value: /* itinerary */ Itinerary_ => Callback): Self = StObject.set(x, "collapseBtn", js.Any.fromFunction1((t0: /* itinerary */ Itinerary_) => value(t0).runNow()))
