...
object PlanOptions {
  ...
  extension [Self <: PlanOptions](x: Self) {
    ...
    inline def setGeocoderClass(value: (/* waypointIndex */ Double, /* numberOfWaypoints */ Double) => Callback): Self = StObject.set(x, "geocoderClass", js.Any.fromFunction2((t0: /* waypointIndex */ Double, t1: /* numberOfWaypoints */ Double) => (value(t0, t1)).runNow()))
