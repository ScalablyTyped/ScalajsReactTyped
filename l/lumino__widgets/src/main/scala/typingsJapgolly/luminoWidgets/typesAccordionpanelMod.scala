...
import typingsJapgolly.luminoWidgets.typesAccordionlayoutMod.AccordionLayout
import typingsJapgolly.luminoWidgets.typesAccordionpanelMod.AccordionPanel.IOptions
import typingsJapgolly.luminoWidgets.typesAccordionpanelMod.AccordionPanel.IRenderer
import typingsJapgolly.luminoWidgets.typesSplitpanelMod.SplitPanel
  ...
  object AccordionPanel {
    ...
    open class Renderer ()
      extends typingsJapgolly.luminoWidgets.typesSplitpanelMod.SplitPanel.Renderer
         with typingsJapgolly.luminoWidgets.typesAccordionlayoutMod.AccordionLayout.IRenderer {
    ...
    trait IOptions extends StObject {
      ...
      var alignment: js.UndefOr[typingsJapgolly.luminoWidgets.typesSplitlayoutMod.SplitLayout.Alignment] = js.undefined
      ...
      var orientation: js.UndefOr[typingsJapgolly.luminoWidgets.typesSplitlayoutMod.SplitLayout.Orientation] = js.undefined
      
      var renderer: js.UndefOr[typingsJapgolly.luminoWidgets.typesAccordionlayoutMod.AccordionLayout.IRenderer] = js.undefined
    ...
    object IOptions {
      ...
      extension [Self <: IOptions](x: Self) {
        ...
        inline def setAlignment(value: typingsJapgolly.luminoWidgets.typesSplitlayoutMod.SplitLayout.Alignment): Self = StObject.set(x, "alignment", value.asInstanceOf[js.Any])
        ...
        inline def setOrientation(value: typingsJapgolly.luminoWidgets.typesSplitlayoutMod.SplitLayout.Orientation): Self = StObject.set(x, "orientation", value.asInstanceOf[js.Any])
        
        inline def setOrientationUndefined: Self = StObject.set(x, "orientation", js.undefined)
        
        inline def setRenderer(value: typingsJapgolly.luminoWidgets.typesAccordionlayoutMod.AccordionLayout.IRenderer): Self = StObject.set(x, "renderer", value.asInstanceOf[js.Any])
    ...
    /**
      ...
      */
    type IRenderer = typingsJapgolly.luminoWidgets.typesAccordionlayoutMod.AccordionLayout.IRenderer
