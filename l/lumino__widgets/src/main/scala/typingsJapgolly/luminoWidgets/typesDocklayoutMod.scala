...
import typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`split-area`
import typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`tab-area`
import typingsJapgolly.luminoWidgets.luminoWidgetsStrings.horizontal
import typingsJapgolly.luminoWidgets.luminoWidgetsStrings.vertical
import typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.IAddOptions
import typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.ILayoutConfig
import typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.IOptions
import typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.IRenderer
import typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.ITabAreaGeometry
...
import typingsJapgolly.luminoWidgets.typesWidgetMod.Widget.HiddenMode
import typingsJapgolly.std.ShadowRoot
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object typesDocklayoutMod {
  ...
  object DockLayout {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.ITabAreaConfig
      - typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.ISplitAreaConfig
    */
    trait AreaConfig extends StObject
    object AreaConfig {
      
      inline def ISplitAreaConfig(children: js.Array[AreaConfig], orientation: horizontal | vertical, sizes: js.Array[Double]): typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.ISplitAreaConfig = {
        ...
        __obj.asInstanceOf[typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.ISplitAreaConfig]
      }
      
      inline def ITabAreaConfig(currentIndex: Double, widgets: js.Array[Widget]): typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.ITabAreaConfig = {
        ...
        __obj.asInstanceOf[typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.ITabAreaConfig]
      }
    }
    ...
    /**
      ...
      */
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`split-top`
      - typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`split-left`
      - typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`split-right`
      - typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`split-bottom`
      - typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`tab-before`
      - typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`tab-after`
    */
    trait InsertMode extends StObject
    object InsertMode {
      
      inline def `split-bottom`: typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`split-bottom` = "split-bottom".asInstanceOf[typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`split-bottom`]
      
      inline def `split-left`: typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`split-left` = "split-left".asInstanceOf[typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`split-left`]
      
      inline def `split-right`: typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`split-right` = "split-right".asInstanceOf[typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`split-right`]
      
      inline def `split-top`: typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`split-top` = "split-top".asInstanceOf[typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`split-top`]
      
      inline def `tab-after`: typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`tab-after` = "tab-after".asInstanceOf[typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`tab-after`]
      
      inline def `tab-before`: typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`tab-before` = "tab-before".asInstanceOf[typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`tab-before`]
    }
  }
}
