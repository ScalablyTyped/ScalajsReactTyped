...
import typingsJapgolly.luminoWidgets.typesDockpanelMod.DockPanel.IAddOptions
import typingsJapgolly.luminoWidgets.typesDockpanelMod.DockPanel.ILayoutConfig
import typingsJapgolly.luminoWidgets.typesDockpanelMod.DockPanel.IOptions
import typingsJapgolly.luminoWidgets.typesDockpanelMod.DockPanel.IOverlay
import typingsJapgolly.luminoWidgets.typesDockpanelMod.DockPanel.IRenderer
import typingsJapgolly.luminoWidgets.typesDockpanelMod.DockPanel.Mode
...
object typesDockpanelMod {
  ...
  object DockPanel {
    ...
    open class Renderer ()
      extends StObject
         with typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.IRenderer
    ...
    /**
      ...
      */
    type IAddOptions = typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.IAddOptions
    ...
    /**
      ...
      */
    type ILayoutConfig = typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.ILayoutConfig
    ...
    object IOverlay {
      ...
      inline def apply(hide: Double => Callback, node: HTMLDivElement, show: IOverlayGeometry => Callback): IOverlay = {
        val __obj = js.Dynamic.literal(hide = js.Any.fromFunction1((t0: Double) => hide(t0).runNow()), node = node.asInstanceOf[js.Any], show = js.Any.fromFunction1((t0: IOverlayGeometry) => show(t0).runNow()))
        __obj.asInstanceOf[IOverlay]
      }
      
      extension [Self <: IOverlay](x: Self) {
        
        inline def setHide(value: Double => Callback): Self = StObject.set(x, "hide", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
        
        inline def setNode(value: HTMLDivElement): Self = StObject.set(x, "node", value.asInstanceOf[js.Any])
        
        inline def setShow(value: IOverlayGeometry => Callback): Self = StObject.set(x, "show", js.Any.fromFunction1((t0: IOverlayGeometry) => value(t0).runNow()))
      }
    }
    ...
    /**
      ...
      */
    type IRenderer = typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.IRenderer
    
    /**
      * A type alias for the supported insertion modes.
      */
    type InsertMode = typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.InsertMode
    
    /**
      * A type alias for the supported dock panel modes.
      */
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`single-document`
      - typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`multiple-document`
    */
    trait Mode extends StObject
    object Mode {
      
      inline def `multiple-document`: typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`multiple-document` = "multiple-document".asInstanceOf[typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`multiple-document`]
      
      inline def `single-document`: typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`single-document` = "single-document".asInstanceOf[typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`single-document`]
    }
  }
}
