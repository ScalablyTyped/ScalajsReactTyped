...
import typingsJapgolly.luminoWidgets.luminoWidgetsStrings.next
import typingsJapgolly.luminoWidgets.luminoWidgetsStrings.previous
...
object typesMenuMod {
  ...
  object Menu {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.luminoWidgets.luminoWidgetsStrings.command
      - typingsJapgolly.luminoWidgets.luminoWidgetsStrings.submenu
      - typingsJapgolly.luminoWidgets.luminoWidgetsStrings.separator
    */
    trait ItemType extends StObject
    object ItemType {
      
      inline def command: typingsJapgolly.luminoWidgets.luminoWidgetsStrings.command = "command".asInstanceOf[typingsJapgolly.luminoWidgets.luminoWidgetsStrings.command]
      
      inline def separator: typingsJapgolly.luminoWidgets.luminoWidgetsStrings.separator = "separator".asInstanceOf[typingsJapgolly.luminoWidgets.luminoWidgetsStrings.separator]
      
      inline def submenu: typingsJapgolly.luminoWidgets.luminoWidgetsStrings.submenu = "submenu".asInstanceOf[typingsJapgolly.luminoWidgets.luminoWidgetsStrings.submenu]
    }
  }
}
