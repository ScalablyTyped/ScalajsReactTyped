...
import typingsJapgolly.luminoWidgets.typesLayoutMod.Layout.FitPolicy
...
object typesLayoutMod {
  ...
  object Layout {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`set-no-constraint`
      - typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`set-min-size`
    */
    trait FitPolicy extends StObject
    object FitPolicy {
      
      inline def `set-min-size`: typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`set-min-size` = "set-min-size".asInstanceOf[typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`set-min-size`]
      
      inline def `set-no-constraint`: typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`set-no-constraint` = "set-no-constraint".asInstanceOf[typingsJapgolly.luminoWidgets.luminoWidgetsStrings.`set-no-constraint`]
    }
