...
import typingsJapgolly.luminoWidgets.typesCommandpaletteMod.CommandPalette.IItem
import typingsJapgolly.luminoWidgets.typesCommandpaletteMod.CommandPalette.IItemOptions
import typingsJapgolly.luminoWidgets.typesCommandpaletteMod.CommandPalette.IOptions
import typingsJapgolly.luminoWidgets.typesCommandpaletteMod.CommandPalette.IRenderer
  ...
  object CommandPalette {
    ...
    trait IItem extends StObject {
      ...
      /**
        ...
        */
      val icon: js.UndefOr[typingsJapgolly.luminoVirtualdom.mod.VirtualElement.IRenderer | String] = js.undefined
    ...
    object IItem {
      ...
      extension [Self <: IItem](x: Self) {
        ...
        inline def setIcon(value: typingsJapgolly.luminoVirtualdom.mod.VirtualElement.IRenderer | String): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
