...
import typingsJapgolly.luminoWidgets.typesBoxlayoutMod.BoxLayout
import typingsJapgolly.luminoWidgets.typesBoxpanelMod.BoxPanel.Alignment
import typingsJapgolly.luminoWidgets.typesBoxpanelMod.BoxPanel.Direction
import typingsJapgolly.luminoWidgets.typesBoxpanelMod.BoxPanel.IOptions
...
object typesBoxpanelMod {
  ...
  object BoxPanel {
    ...
    /**
      ...
      */
    type Alignment = typingsJapgolly.luminoWidgets.typesBoxlayoutMod.BoxLayout.Alignment
    
    /**
      * A type alias for a box panel direction.
      */
    type Direction = typingsJapgolly.luminoWidgets.typesBoxlayoutMod.BoxLayout.Direction
