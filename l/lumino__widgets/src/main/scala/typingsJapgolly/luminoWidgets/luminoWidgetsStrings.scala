...
import typingsJapgolly.luminoWidgets.typesDocklayoutMod.DockLayout.InsertMode
...
object luminoWidgetsStrings {
  ...
  sealed trait center
    extends StObject
       with Alignment
       with typingsJapgolly.luminoWidgets.typesSplitlayoutMod.SplitLayout.Alignment
  ...
  sealed trait horizontal
    extends StObject
       with Orientation
       with typingsJapgolly.luminoWidgets.typesSplitlayoutMod.SplitLayout.Orientation
       with typingsJapgolly.luminoWidgets.typesScrollbarMod.ScrollBar.Orientation
