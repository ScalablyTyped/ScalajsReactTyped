...
open class AccordionPanel ()
  extends typingsJapgolly.luminoWidgets.typesAccordionpanelMod.AccordionPanel {
...
object AccordionPanel {
  ...
  @js.native
  open class Renderer ()
    extends typingsJapgolly.luminoWidgets.typesAccordionpanelMod.AccordionPanel.Renderer
  object Renderer {
  ...
  @js.native
  val defaultRenderer: typingsJapgolly.luminoWidgets.typesAccordionpanelMod.AccordionPanel.Renderer = js.native
}
