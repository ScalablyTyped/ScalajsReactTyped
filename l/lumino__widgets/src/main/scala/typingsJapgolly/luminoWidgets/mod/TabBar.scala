...
/**
  ...
  */
open class TabBar[T] ()
  extends typingsJapgolly.luminoWidgets.typesTabbarMod.TabBar[T] {
...
object TabBar {
  ...
  @js.native
  open class Renderer ()
    extends typingsJapgolly.luminoWidgets.typesTabbarMod.TabBar.Renderer
  object Renderer {
  ...
  @js.native
  val defaultRenderer: typingsJapgolly.luminoWidgets.typesTabbarMod.TabBar.Renderer = js.native
}
