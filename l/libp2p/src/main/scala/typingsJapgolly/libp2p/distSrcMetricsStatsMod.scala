...
import typingsJapgolly.libp2p.libp2pStrings.dataReceived
import typingsJapgolly.libp2p.libp2pStrings.dataSent
import typingsJapgolly.libp2pInterfaceMetrics.mod.MovingAverages
import typingsJapgolly.libp2pInterfaceMetrics.mod.Stats
import typingsJapgolly.libp2pInterfaceMetrics.mod.TransferStats
...
object distSrcMetricsStatsMod {
  ...
  object StatsEvents {
    ...
    inline def apply(update: CustomEvent): StatsEvents = {
