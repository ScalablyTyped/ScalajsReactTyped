...
import typingsJapgolly.libp2p.libp2pStrings.addressSorter
import typingsJapgolly.libp2p.libp2pStrings.autoDial
import typingsJapgolly.libp2p.libp2pStrings.autoDialInterval
import typingsJapgolly.libp2p.libp2pStrings.inboundUpgradeTimeout
import typingsJapgolly.libp2p.libp2pStrings.maxAddrsToDial
import typingsJapgolly.libp2p.libp2pStrings.maxConnections
import typingsJapgolly.libp2p.libp2pStrings.maxData
import typingsJapgolly.libp2p.libp2pStrings.maxDialsPerPeer
import typingsJapgolly.libp2p.libp2pStrings.maxEventLoopDelay
import typingsJapgolly.libp2p.libp2pStrings.maxParallelDials
import typingsJapgolly.libp2p.libp2pStrings.maxReceivedData
import typingsJapgolly.libp2p.libp2pStrings.maxSentData
import typingsJapgolly.libp2p.libp2pStrings.minConnections
import typingsJapgolly.libp2p.libp2pStrings.movingAverageInterval
import typingsJapgolly.libp2p.libp2pStrings.pollInterval
import typingsJapgolly.libp2p.libp2pStrings.resolvers
...
object distSrcConnectionManagerMod {
  ...
  open class DefaultConnectionManager protected ()
    ...
    /**
      ...
      */
    def _onConnect(evt: CustomEvent): js.Promise[Unit] = js.native
    
    /**
      * If the event loop is slow, maybe close a connection
      */
    def _onLatencyMeasure(evt: CustomEvent): Unit = js.native
    ...
    def onConnect(evt: CustomEvent): Unit = js.native
    
    /**
      * Removes the connection from tracking
      */
    def onDisconnect(evt: CustomEvent): Unit = js.native
