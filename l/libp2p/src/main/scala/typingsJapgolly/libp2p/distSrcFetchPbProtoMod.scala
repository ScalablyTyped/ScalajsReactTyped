...
import typingsJapgolly.libp2p.distSrcFetchPbProtoMod.FetchResponse.StatusCode
  ...
  object FetchResponse {
    ...
    object StatusCode extends StObject {
      ...
      sealed trait ERROR
        extends StObject
           with StatusCode
      /* "ERROR" */ val ERROR: typingsJapgolly.libp2p.distSrcFetchPbProtoMod.FetchResponse.StatusCode.ERROR & String = js.native
      
      @js.native
      sealed trait NOT_FOUND
        extends StObject
           with StatusCode
      /* "NOT_FOUND" */ val NOT_FOUND: typingsJapgolly.libp2p.distSrcFetchPbProtoMod.FetchResponse.StatusCode.NOT_FOUND & String = js.native
      
      @js.native
      sealed trait OK
        extends StObject
           with StatusCode
      /* "OK" */ val OK: typingsJapgolly.libp2p.distSrcFetchPbProtoMod.FetchResponse.StatusCode.OK & String = js.native
