...
object distSrcInsecurePbProtoMod {
  ...
  object KeyType extends StObject {
    ...
    sealed trait ECDSA
      extends StObject
         with KeyType
    /* "ECDSA" */ val ECDSA: typingsJapgolly.libp2p.distSrcInsecurePbProtoMod.KeyType.ECDSA & String = js.native
    
    @js.native
    sealed trait Ed25519
      extends StObject
         with KeyType
    /* "Ed25519" */ val Ed25519: typingsJapgolly.libp2p.distSrcInsecurePbProtoMod.KeyType.Ed25519 & String = js.native
    
    @js.native
    sealed trait RSA
      extends StObject
         with KeyType
    /* "RSA" */ val RSA: typingsJapgolly.libp2p.distSrcInsecurePbProtoMod.KeyType.RSA & String = js.native
    
    @js.native
    sealed trait Secp256k1
      extends StObject
         with KeyType
    /* "Secp256k1" */ val Secp256k1: typingsJapgolly.libp2p.distSrcInsecurePbProtoMod.KeyType.Secp256k1 & String = js.native
