...
object distSrcConnectionManagerLatencyMonitorMod {
  ...
  trait LatencyMonitorEvents extends StObject {
    ...
    var data: CustomEvent
  }
  object LatencyMonitorEvents {
    
    inline def apply(data: CustomEvent): LatencyMonitorEvents = {
    ...
    extension [Self <: LatencyMonitorEvents](x: Self) {
      ...
      inline def setData(value: CustomEvent): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    }
  }
  ...
  object LatencyMonitorInit {
    ...
    extension [Self <: LatencyMonitorInit](x: Self) {
      ...
      inline def setAsyncTestFn(value: /* cb */ js.Function0[Unit] => Callback): Self = StObject.set(x, "asyncTestFn", js.Any.fromFunction1((t0: /* cb */ js.Function0[Unit]) => value(t0).runNow()))
