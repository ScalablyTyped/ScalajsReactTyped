...
trait PromptSettings extends StObject {
  ...
  var enquirer: js.UndefOr[typingsJapgolly.enquirer.mod.^[js.Object]] = js.undefined
...
object PromptSettings {
  ...
  extension [Self <: PromptSettings](x: Self) {
    ...
    inline def setEnquirer(value: typingsJapgolly.enquirer.mod.^[js.Object]): Self = StObject.set(x, "enquirer", value.asInstanceOf[js.Any])
