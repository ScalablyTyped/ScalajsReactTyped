...
import typingsJapgolly.listr2.anon.Enquirer
import typingsJapgolly.listr2.listr2Booleans.`false`
import typingsJapgolly.listr2.listr2Strings.full
import typingsJapgolly.listr2.listr2Strings.minimal
...
object ListrOptions {
  ...
  extension [Self <: ListrOptions[?], Ctx](x: Self & ListrOptions[Ctx]) {
    ...
    inline def setRendererFallbackCallbackTo(value: CallbackTo[Boolean]): Self = StObject.set(x, "rendererFallback", value.toJsFn)
    ...
    inline def setRendererSilentCallbackTo(value: CallbackTo[Boolean]): Self = StObject.set(x, "rendererSilent", value.toJsFn)
