package typingsJapgolly.listr2

import typingsJapgolly.listr2.mod.PromptTypes
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object listr2Strings {
  ...
  sealed trait BasicAuth
    extends StObject
       with PromptTypes
  inline def BasicAuth: BasicAuth = "BasicAuth".asInstanceOf[BasicAuth]
  ...
  sealed trait Numeral
    extends StObject
       with PromptTypes
  inline def Numeral: Numeral = "Numeral".asInstanceOf[Numeral]
  ...
  sealed trait Survey
    extends StObject
       with PromptTypes
  inline def Survey: Survey = "Survey".asInstanceOf[Survey]
