...
import typingsJapgolly.lmdb.mod.CompressionOptions
...
object anon {
  ...
  trait DatabaseOptionsnamestring extends StObject {
    ...
    var sharedStructuresKey: js.UndefOr[typingsJapgolly.lmdb.mod.Key] = js.undefined
  ...
  object DatabaseOptionsnamestring {
    ...
    extension [Self <: DatabaseOptionsnamestring](x: Self) {
      ...
      inline def setSharedStructuresKey(value: typingsJapgolly.lmdb.mod.Key): Self = StObject.set(x, "sharedStructuresKey", value.asInstanceOf[js.Any])
  ...
  trait Key[K /* <: typingsJapgolly.lmdb.mod.Key */, V] extends StObject {
  ...
  object Key {
    ...
    inline def apply[K /* <: typingsJapgolly.lmdb.mod.Key */, V](key: K, value: V): Key[K, V] = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[Key[K, V]]
    }
    
    extension [Self <: Key[?, ?], K /* <: typingsJapgolly.lmdb.mod.Key */, V](x: Self & (Key[K, V])) {
