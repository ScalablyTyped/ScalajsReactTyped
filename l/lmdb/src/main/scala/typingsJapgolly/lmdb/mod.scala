...
import typingsJapgolly.lmdb.anon.DatabaseOptionsnamestring
import typingsJapgolly.lmdb.anon.Value
import typingsJapgolly.lmdb.lmdbStrings.`ordered-binary`
import typingsJapgolly.lmdb.lmdbStrings.aftercommit
import typingsJapgolly.lmdb.lmdbStrings.beforecommit
import typingsJapgolly.lmdb.lmdbStrings.binary
import typingsJapgolly.lmdb.lmdbStrings.json
import typingsJapgolly.lmdb.lmdbStrings.msgpack
import typingsJapgolly.lmdb.lmdbStrings.string
import typingsJapgolly.lmdb.lmdbStrings.uint32
...
object mod {
  ...
  open class Database[V, K /* <: Key */] () extends StObject {
    ...
    /**
    		...
    		* @param options The options for the range/iterator
    		**/
    def getRange(): RangeIterable[typingsJapgolly.lmdb.anon.Key[K, V]] = js.native
    def getRange(options: RangeOptions): RangeIterable[typingsJapgolly.lmdb.anon.Key[K, V]] = js.native
  ...
  object TransactionFlags extends StObject {
    ...
    /* 1 */ val ABORTABLE: typingsJapgolly.lmdb.mod.TransactionFlags.ABORTABLE & Double = js.native
    ...
    sealed trait NO_SYNC_FLUSH
      extends StObject
         with TransactionFlags
    /* 0x10000 */ val NO_SYNC_FLUSH: typingsJapgolly.lmdb.mod.TransactionFlags.NO_SYNC_FLUSH & Double = js.native
    ...
    sealed trait SYNCHRONOUS_COMMIT
      extends StObject
         with TransactionFlags
    /* 2 */ val SYNCHRONOUS_COMMIT: typingsJapgolly.lmdb.mod.TransactionFlags.SYNCHRONOUS_COMMIT & Double = js.native
  }
