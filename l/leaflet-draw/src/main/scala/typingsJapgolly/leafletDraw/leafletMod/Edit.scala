...
import typingsJapgolly.leafletDraw.leafletMod.EditOptions.EditPolyVerticesEditOptions
import typingsJapgolly.leafletDraw.leafletMod.EditOptions.EditSimpleShapeOptions
...
object Edit {
  ...
  open class Polyline protected () extends Handler {
    def this(polyline: typingsJapgolly.leafletDraw.leafletMod.Draw.Polyline) = this()
