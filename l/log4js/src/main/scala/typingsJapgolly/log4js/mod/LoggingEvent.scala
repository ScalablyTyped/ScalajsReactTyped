...
import typingsJapgolly.log4js.anon.Worker
...
object LoggingEvent {
  ...
  inline def apply(
    ...
    level: Level,
    pid: Double,
    serialise: CallbackTo[String],
    startTime: js.Date
  ): LoggingEvent = {
    val __obj = js.Dynamic.literal(categoryName = categoryName.asInstanceOf[js.Any], context = context.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any], level = level.asInstanceOf[js.Any], pid = pid.asInstanceOf[js.Any], serialise = serialise.toJsFn, startTime = startTime.asInstanceOf[js.Any])
  ...
  extension [Self <: LoggingEvent](x: Self) {
    ...
    inline def setSerialise(value: CallbackTo[String]): Self = StObject.set(x, "serialise", value.toJsFn)
