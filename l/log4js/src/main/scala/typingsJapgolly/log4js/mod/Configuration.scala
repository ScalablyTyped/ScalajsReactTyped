...
trait Configuration extends StObject {
  ...
  var categories: StringDictionary[typingsJapgolly.log4js.anon.Appenders]
...
object Configuration {
  ...
  inline def apply(
    ...
    categories: StringDictionary[typingsJapgolly.log4js.anon.Appenders]
  ): Configuration = {
  ...
  extension [Self <: Configuration](x: Self) {
    ...
    inline def setCategories(value: StringDictionary[typingsJapgolly.log4js.anon.Appenders]): Self = StObject.set(x, "categories", value.asInstanceOf[js.Any])
