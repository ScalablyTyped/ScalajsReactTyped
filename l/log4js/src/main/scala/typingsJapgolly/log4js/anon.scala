...
object anon {
  ...
  trait Context extends StObject {
    ...
    var format: js.UndefOr[typingsJapgolly.log4js.mod.Format] = js.undefined
  ...
  object Context {
    ...
    extension [Self <: Context](x: Self) {
      ...
      inline def setFormat(value: typingsJapgolly.log4js.mod.Format): Self = StObject.set(x, "format", value.asInstanceOf[js.Any])
