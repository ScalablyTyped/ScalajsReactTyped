...
object DateFormat {
  def apply(
    ...
    typingsJapgolly.linguiReact.mod.DateFormat, 
    Unit, 
    FormatPropsWithoutI18n[js.Date, DateTimeFormatOptions]
  ] = {
  ...
  typingsJapgolly.linguiReact.createFormatMod.FormatPropsWithoutI18n[js.Date, typingsJapgolly.std.Intl.DateTimeFormatOptions], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.linguiReact.mod.DateFormat](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.linguiReact.createFormatMod.FormatPropsWithoutI18n[js.Date, typingsJapgolly.std.Intl.DateTimeFormatOptions]])(children: _*)
  }
