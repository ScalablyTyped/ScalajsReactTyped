...
import typingsJapgolly.linguiReact.transMod.default
...
object Trans {
  ...
  typingsJapgolly.linguiReact.transMod.TransPropsWithoutI18n, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.linguiReact.transMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.linguiReact.transMod.TransPropsWithoutI18n])(children: _*)
  }
