...
abstract class SharedApply_PluralPropsWithoutI18n1025816832[ComponentRef] () {
  ...
  typingsJapgolly.linguiReact.selectMod.PluralPropsWithoutI18n, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.linguiReact.selectMod.PluralPropsWithoutI18n])(children: _*)
  }
}
