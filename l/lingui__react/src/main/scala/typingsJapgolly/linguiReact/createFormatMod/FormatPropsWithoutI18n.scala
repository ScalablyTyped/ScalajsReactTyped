package typingsJapgolly.linguiReact.createFormatMod
...
object FormatPropsWithoutI18n {
  @scala.inline
  def apply[V, FormatOptions](value: V, className: String = null, format: FormatOptions = null, render: VdomNode = null): FormatPropsWithoutI18n[V, FormatOptions] = {
