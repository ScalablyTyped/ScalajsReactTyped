...
import typingsJapgolly.webdriverio.WebdriverIO.AddValueOptions
import typingsJapgolly.webdriverio.WebdriverIO.CSSProperty
import typingsJapgolly.webdriverio.WebdriverIO.ClickOptions
import typingsJapgolly.webdriverio.WebdriverIO.Element
import typingsJapgolly.webdriverio.WebdriverIO.ElementArray
import typingsJapgolly.webdriverio.WebdriverIO.LocationParam
import typingsJapgolly.webdriverio.WebdriverIO.SizeParam
import typingsJapgolly.webdriverio.WebdriverIO.WaitForOptions
...
trait ElementAsync extends js.Object {
  ...
  @JSName("$")
  def $(selector: String): js.Promise[typingsJapgolly.webdriverio.WebdriverIOAsync.Element] = js.native
  @JSName("$")
  def $(selector: js.Function): js.Promise[typingsJapgolly.webdriverio.WebdriverIOAsync.Element] = js.native
  @JSName("$$")
  def DollarDollar(selector: String): js.Promise[typingsJapgolly.webdriverio.WebdriverIOAsync.ElementArray] = js.native
  @JSName("$$")
  def DollarDollar(selector: js.Function): js.Promise[typingsJapgolly.webdriverio.WebdriverIOAsync.ElementArray] = js.native
  def addValue(
