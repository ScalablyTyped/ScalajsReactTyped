...
import typingsJapgolly.webdriverio.anon.CommandList
...
object buildMultiremoteMod {
  ...
  open class default ()
    ...
    override def commandWrapper(
      commandName: /* keyof @wdio/protocols.@wdio/protocols.ProtocolCommands & webdriverio.webdriverio/build/types.BrowserCommandsType */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 269, starting with typingsJapgolly.webdriverio.webdriverioStrings.getSessionStorage, typingsJapgolly.webdriverio.webdriverioStrings.getGeoLocation, typingsJapgolly.webdriverio.webdriverioStrings.getElementLocationInView */ Any
  ...
  object MultiRemote {
    ...
    inline def apply(
      ...
      commandWrapper: /* keyof @wdio/protocols.@wdio/protocols.ProtocolCommands & webdriverio.webdriverio/build/types.BrowserCommandsType */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 269, starting with typingsJapgolly.webdriverio.webdriverioStrings.getSessionStorage, typingsJapgolly.webdriverio.webdriverioStrings.getGeoLocation, typingsJapgolly.webdriverio.webdriverioStrings.getElementLocationInView */ Any => js.Function1[/* args */ Any, js.Promise[Any]],
      instances: Record[
          String, 
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebdriverIO.Browser */ Any
        ],
