...
import typingsJapgolly.webdriverio.anon.MatchesmockedResponsestri
...
object buildUtilsInterceptionDevtoolsMod {
  ...
  object default {
    ...
    inline def handleRequestInterception(client: CDPSession, mocks: Set[typingsJapgolly.webdriverio.buildUtilsInterceptionMod.default]): js.Function1[/* event */ Event, js.Promise[Unit | ClientResponse]] = (^.asInstanceOf[js.Dynamic].applyDynamic("handleRequestInterception")(client.asInstanceOf[js.Any], mocks.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* event */ Event, js.Promise[Unit | ClientResponse]]]
  }
  ...
  trait DevtoolsInterception
    extends typingsJapgolly.webdriverio.buildUtilsInterceptionMod.default {
