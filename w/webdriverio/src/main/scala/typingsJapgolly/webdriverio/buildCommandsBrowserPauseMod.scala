...
object buildCommandsBrowserPauseMod {
  ...
  inline def default(milliseconds: Double): js.Promise[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(milliseconds.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Any]]
}
