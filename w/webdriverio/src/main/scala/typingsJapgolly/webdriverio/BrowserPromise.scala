...
import typingsJapgolly.webdriver.WebDriver.RectReturn
import typingsJapgolly.webdriverio.WebdriverIO.Cookie
import typingsJapgolly.webdriverio.WebdriverIO.Element
import typingsJapgolly.webdriverio.WebdriverIO.ElementArray
import typingsJapgolly.webdriverio.WebdriverIO.Timeouts
...
trait BrowserPromise extends js.Object {
  ...
  @JSName("switchWindow")
  var switchWindow_Original: js.Function1[/* urlOrTitleToMatch */ String | js.RegExp, Unit] = js.native
  @JSName("uploadFile")
