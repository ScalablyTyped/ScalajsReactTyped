...
trait `18` extends StObject {
  ...
  var default: js.UndefOr[js.Array[ReporterEntry]] = js.undefined
  ...
  var validate: js.UndefOr[js.Function1[/* option */ js.UndefOr[js.Array[ReporterEntry]], Unit]] = js.undefined
}
object `18` {
  
  inline def apply(`type`: string | number | `object` | boolean | function): `18` = {
  ...
  extension [Self <: `18`](x: Self) {
    ...
    inline def setDefault(value: js.Array[ReporterEntry]): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
    
    inline def setDefaultUndefined: Self = StObject.set(x, "default", js.undefined)
    
    inline def setDefaultVarargs(value: ReporterEntry*): Self = StObject.set(x, "default", js.Array(value*))
    ...
    inline def setValidate(value: /* option */ js.UndefOr[js.Array[ReporterEntry]] => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* option */ js.UndefOr[js.Array[ReporterEntry]]) => value(t0).runNow()))
