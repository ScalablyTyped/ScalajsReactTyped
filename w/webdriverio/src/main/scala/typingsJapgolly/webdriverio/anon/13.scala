...
object `13` {
  ...
  extension [Self <: `13`](x: Self) {
    ...
    inline def setDefaultFunction2(value: (/* commandName */ String, /* args */ js.Array[Any]) => Callback): Self = StObject.set(x, "default", js.Any.fromFunction2((t0: /* commandName */ String, t1: /* args */ js.Array[Any]) => (value(t0, t1)).runNow()))
