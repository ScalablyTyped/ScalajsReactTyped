...
object `25` {
  ...
  extension [Self <: `25`](x: Self) {
    ...
    inline def setValidate(value: /* option */ js.UndefOr[AutoCompileConfig] => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* option */ js.UndefOr[AutoCompileConfig]) => value(t0).runNow()))
