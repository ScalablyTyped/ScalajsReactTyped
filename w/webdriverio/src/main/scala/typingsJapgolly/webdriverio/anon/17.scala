...
trait `17` extends StObject {
  ...
  var default: js.UndefOr[Record[String, js.Array[String]]] = js.undefined
  ...
  var validate: js.UndefOr[js.Function1[/* option */ js.UndefOr[Record[String, js.Array[String]]], Unit]] = js.undefined
}
object `17` {
  
  inline def apply(`type`: string | number | `object` | boolean | function): `17` = {
  ...
  extension [Self <: `17`](x: Self) {
    ...
    inline def setDefault(value: Record[String, js.Array[String]]): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
    ...
    inline def setValidate(value: /* option */ js.UndefOr[Record[String, js.Array[String]]] => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* option */ js.UndefOr[Record[String, js.Array[String]]]) => value(t0).runNow()))
