...
object DefaultMatchRequiredType {
  ...
  extension [Self <: DefaultMatchRequiredType](x: Self) {
    ...
    inline def setValidate(value: /* option */ js.UndefOr[js.Array[String]] => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* option */ js.UndefOr[js.Array[String]]) => value(t0).runNow()))
