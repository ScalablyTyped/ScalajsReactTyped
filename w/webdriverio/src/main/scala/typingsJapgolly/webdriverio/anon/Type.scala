...
object Type {
  ...
  inline def apply(`type`: string | number | `object` | boolean | function): Type = {
  ...
  extension [Self <: Type](x: Self) {
    ...
    inline def setValidate(value: /* option */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* option */ js.UndefOr[Boolean]) => value(t0).runNow()))
