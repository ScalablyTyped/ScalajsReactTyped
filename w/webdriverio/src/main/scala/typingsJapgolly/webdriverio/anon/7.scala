...
trait `7` extends StObject {
  ...
  var default: js.UndefOr[CucumberOpts] = js.undefined
  ...
  var validate: js.UndefOr[js.Function1[/* option */ js.UndefOr[CucumberOpts], Unit]] = js.undefined
}
object `7` {
  
  inline def apply(`type`: string | number | `object` | boolean | function): `7` = {
  ...
  extension [Self <: `7`](x: Self) {
    ...
    inline def setDefault(value: CucumberOpts): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
    ...
    inline def setValidate(value: /* option */ js.UndefOr[CucumberOpts] => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* option */ js.UndefOr[CucumberOpts]) => value(t0).runNow()))
