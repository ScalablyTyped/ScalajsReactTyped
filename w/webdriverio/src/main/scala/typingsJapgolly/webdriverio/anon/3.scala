...
object `3` {
  ...
  inline def apply(`type`: string | number | `object` | boolean | function): `3` = {
  ...
  extension [Self <: `3`](x: Self) {
    ...
    inline def setDefaultFunction2(value: (/* test */ Test, /* context */ Any) => Callback): Self = StObject.set(x, "default", js.Any.fromFunction2((t0: /* test */ Test, t1: /* context */ Any) => (value(t0, t1)).runNow()))
    
    inline def setDefaultUndefined: Self = StObject.set(x, "default", js.undefined)
    
    inline def setDefaultVarargs(value: (NonNullable[js.UndefOr[js.Function2[/* test */ Test, /* context */ Any, Unit]]])*): Self = StObject.set(x, "default", js.Array(value*))
