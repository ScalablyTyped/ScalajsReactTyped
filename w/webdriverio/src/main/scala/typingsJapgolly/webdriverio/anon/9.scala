...
object `9` {
  ...
  inline def apply(`type`: string | number | `object` | boolean | function): `9` = {
  ...
  extension [Self <: `9`](x: Self) {
    ...
    ): Self = StObject.set(x, "default", js.Any.fromFunction3((t0: /* result */ Double, t1: /* capabilities */ RemoteCapability, t2: /* specs */ js.Array[String]) => (value(t0, t1, t2)).runNow()))
