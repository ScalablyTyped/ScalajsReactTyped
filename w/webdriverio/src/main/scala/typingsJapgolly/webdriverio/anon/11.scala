...
object `11` {
  ...
  extension [Self <: `11`](x: Self) {
    ...
    inline def setValidate(value: /* option */ js.UndefOr[JasmineOpts] => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* option */ js.UndefOr[JasmineOpts]) => value(t0).runNow()))
