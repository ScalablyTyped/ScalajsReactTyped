...
object `20` {
  ...
  extension [Self <: `20`](x: Self) {
    ...
    inline def setValidate(value: /* option */ js.UndefOr[SupportedProtocols] => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* option */ js.UndefOr[SupportedProtocols]) => value(t0).runNow()))
