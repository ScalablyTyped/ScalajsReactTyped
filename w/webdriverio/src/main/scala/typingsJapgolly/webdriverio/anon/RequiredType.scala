...
object RequiredType {
  ...
  extension [Self <: RequiredType](x: Self) {
    ...
    inline def setValidate(value: /* option */ RemoteCapability => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* option */ RemoteCapability) => value(t0).runNow()))
