...
trait `8` extends StObject {
  ...
  var default: js.UndefOr[MochaOpts] = js.undefined
  ...
  var validate: js.UndefOr[js.Function1[/* option */ js.UndefOr[MochaOpts], Unit]] = js.undefined
}
object `8` {
  
  inline def apply(`type`: string | number | `object` | boolean | function): `8` = {
  ...
  extension [Self <: `8`](x: Self) {
    ...
    inline def setDefault(value: MochaOpts): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
    ...
    inline def setValidate(value: /* option */ js.UndefOr[MochaOpts] => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* option */ js.UndefOr[MochaOpts]) => value(t0).runNow()))
