...
object DefaultMatchRequiredTypeValidate {
  ...
  extension [Self <: DefaultMatchRequiredTypeValidate](x: Self) {
    ...
    inline def setDefaultFunction2(value: (/* oldSessionId */ String, /* newSessionId */ String) => Callback): Self = StObject.set(x, "default", js.Any.fromFunction2((t0: /* oldSessionId */ String, t1: /* newSessionId */ String) => (value(t0, t1)).runNow()))
