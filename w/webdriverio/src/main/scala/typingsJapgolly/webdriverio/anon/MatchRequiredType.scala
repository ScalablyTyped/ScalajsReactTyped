...
trait MatchRequiredType extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[/* option */ js.UndefOr[Double], Unit]] = js.undefined
}
object MatchRequiredType {
  
  inline def apply(`type`: string | number | `object` | boolean | function): MatchRequiredType = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[MatchRequiredType]
  }
  
  extension [Self <: MatchRequiredType](x: Self) {
    ...
    inline def setValidate(value: /* option */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* option */ js.UndefOr[Double]) => value(t0).runNow()))
