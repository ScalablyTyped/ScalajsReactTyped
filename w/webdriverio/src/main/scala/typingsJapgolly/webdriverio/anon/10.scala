...
object `10` {
  ...
  extension [Self <: `10`](x: Self) {
    ...
    inline def setValidate(value: /* option */ js.UndefOr[local] => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* option */ js.UndefOr[local]) => value(t0).runNow()))
