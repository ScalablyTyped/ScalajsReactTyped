...
/* Inlined std.Omit<webdriverio.webdriverio/build/types.$ElementCommands, keyof webdriverio.webdriverio/build/types.ChainablePrototype> & webdriverio.webdriverio/build/types.ChainablePrototype */
trait ElementCommandsType extends StObject {
