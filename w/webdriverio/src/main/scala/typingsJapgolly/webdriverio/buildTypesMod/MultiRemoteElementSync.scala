...
/* Inlined parent webdriverio.webdriverio/build/types.MultiRemoteProtocolCommandsTypeSync */
/* Inlined parent std.Omit<webdriverio.webdriverio/build/types.MultiRemoteBrowserCommandsTypeSync, keyof webdriverio.webdriverio/build/types.MultiRemoteElementCommandsTypeSync> */
/* Inlined parent webdriverio.webdriverio/build/types.MultiRemoteElementCommandsTypeSync */
trait MultiRemoteElementSync extends StObject {
  ...
  def call(
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type Parameters<BrowserCommandsTypeSync[K]> is not an array type */ args: Parameters[js.Function1[/* fn */ js.Function0[Any], ThenArg[Any]]]
  ): js.Array[ThenArg[ReturnType[js.Function1[/* fn */ js.Function0[Any], ThenArg[Any]]]]]
  @JSName("call")
  var call_Original: js.Function1[
    /* args */ Parameters[js.Function1[/* fn */ js.Function0[Any], ThenArg[Any]]], 
    js.Array[ThenArg[ReturnType[js.Function1[/* fn */ js.Function0[Any], ThenArg[Any]]]]]
  ]
  ...
  def execute(
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type Parameters<BrowserCommandsTypeSync[K]> is not an array type */ args: Parameters[
      js.Function2[
        /* script */ String | (js.Function1[/* innerArgs */ Any, Any]), 
        /* args */ js.Array[Any], 
        Any
      ]
    ]
  ...
  def getLocation(
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type Parameters<ElementCommandsTypeSync[K]> is not an array type */ args: Parameters[
      (js.ThisFunction0[/* this */ org.scalajs.dom.Element, Location]) & (js.ThisFunction1[/* this */ org.scalajs.dom.Element, /* prop */ x | y, Double]) & (js.ThisFunction1[/* this */ org.scalajs.dom.Element, /* prop */ js.UndefOr[x | y], Location | Double])
    ]
  ): js.Array[
    ThenArg[
      ReturnType[
  ...
  def getSize(
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type Parameters<ElementCommandsTypeSync[K]> is not an array type */ args: Parameters[
      (js.ThisFunction0[/* this */ org.scalajs.dom.Element, Size]) & (js.ThisFunction1[
...
object MultiRemoteElementSync {
  ...
  extension [Self <: MultiRemoteElementSync](x: Self) {
    ...
    inline def setCall(
      value: /* args */ Parameters[js.Function1[/* fn */ js.Function0[Any], ThenArg[Any]]] => js.Array[ThenArg[ReturnType[js.Function1[/* fn */ js.Function0[Any], ThenArg[Any]]]]]
    ...
    inline def setGetLocation(
      value: /* args */ Parameters[
          (js.ThisFunction0[/* this */ org.scalajs.dom.Element, Location]) & (js.ThisFunction1[
            /* this */ org.scalajs.dom.Element, 
