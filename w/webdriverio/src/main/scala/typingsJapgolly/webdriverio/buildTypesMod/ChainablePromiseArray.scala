...
trait ChainablePromiseArray[T]
  ...
  */
/* n */ NumberDictionary[ChainablePromiseElement[js.UndefOr[org.scalajs.dom.Element]]] {
  
  def every[T](
    callback: js.Function3[
      /* currentValue */ org.scalajs.dom.Element, 
      /* index */ Double, 
      /* array */ js.Array[T], 
  ...
  ): js.Promise[js.Array[org.scalajs.dom.Element]] = js.native
  def filter[T](
    callback: js.Function3[
      /* currentValue */ org.scalajs.dom.Element, 
      /* index */ Double, 
  ...
  var parent: js.Promise[
    org.scalajs.dom.Element | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebdriverIO.Browser */ Any)
  ] = js.native
