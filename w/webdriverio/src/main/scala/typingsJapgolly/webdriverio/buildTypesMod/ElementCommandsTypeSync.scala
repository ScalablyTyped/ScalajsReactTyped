...
/* Inlined {[ K in keyof std.Omit<webdriverio.webdriverio/build/types.$ElementCommands, 'getLocation' | 'getSize'> ]: (args : std.Parameters<webdriverio.webdriverio/build/types.$ElementCommands[K]>): @wdio/types.@wdio/types.ThenArg<std.ReturnType<webdriverio.webdriverio/build/types.$ElementCommands[K]>>} & {  getLocation :(this : std.Element): webdriverio.webdriverio/build/commands/element/getLocation.Location & (this : std.Element, prop : keyof webdriverio.webdriverio/build/commands/element/getLocation.Location): number & (this : std.Element, prop : keyof webdriverio.webdriverio/build/commands/element/getLocation.Location | undefined): webdriverio.webdriverio/build/commands/element/getLocation.Location | number,   getSize :(this : std.Element): webdriverio.webdriverio/build/commands/element/getSize.Size & (this : std.Element, prop : keyof @wdio/protocols.@wdio/protocols.RectReturn): number & (this : std.Element, prop : keyof @wdio/protocols.@wdio/protocols.RectReturn | undefined): webdriverio.webdriverio/build/commands/element/getSize.Size | number} */
trait ElementCommandsTypeSync extends StObject {
  ...
  def getLocation(): Location | Double
  def getLocation(prop: x | y): Location | Double
  @JSName("getLocation")
  def getLocation_Double(prop: x | y): Double
  @JSName("getLocation")
  def getLocation_Location(): Location
  @JSName("getLocation")
  var getLocation_Original: (js.ThisFunction0[/* this */ org.scalajs.dom.Element, Location]) & (js.ThisFunction1[/* this */ org.scalajs.dom.Element, /* prop */ x | y, Double]) & (js.ThisFunction1[/* this */ org.scalajs.dom.Element, /* prop */ js.UndefOr[x | y], Location | Double])
  ...
  def getSize(): Size
  def getSize(prop: /* keyof @wdio/protocols.@wdio/protocols/build/types.RectReturn */ x | y | width | height): Size | Double
  @JSName("getSize")
  def getSize_Double(prop: /* keyof @wdio/protocols.@wdio/protocols/build/types.RectReturn */ x | y | width | height): Double
  @JSName("getSize")
  var getSize_Original: (js.ThisFunction0[/* this */ org.scalajs.dom.Element, Size]) & (js.ThisFunction1[
    /* this */ org.scalajs.dom.Element, 
...
object ElementCommandsTypeSync {
  ...
  inline def apply(
    ...
    getLocation: (js.ThisFunction0[/* this */ org.scalajs.dom.Element, Location]) & (js.ThisFunction1[/* this */ org.scalajs.dom.Element, /* prop */ x | y, Double]) & (js.ThisFunction1[/* this */ org.scalajs.dom.Element, /* prop */ js.UndefOr[x | y], Location | Double]),
    ...
    getSize: (js.ThisFunction0[/* this */ org.scalajs.dom.Element, Size]) & (js.ThisFunction1[
      /* this */ org.scalajs.dom.Element, 
      /* keyof @wdio/protocols.@wdio/protocols/build/types.RectReturn */ /* prop */ x | y | width | height, 
      Double
    ]) & (js.ThisFunction1[
  ...
  extension [Self <: ElementCommandsTypeSync](x: Self) {
    ...
    inline def setGetLocation(
      value: (js.ThisFunction0[/* this */ org.scalajs.dom.Element, Location]) & (js.ThisFunction1[
          /* this */ org.scalajs.dom.Element, 
          /* prop */ typingsJapgolly.webdriverio.webdriverioStrings.x | y, 
          Double
        ]) & (js.ThisFunction1[
          /* this */ org.scalajs.dom.Element, 
          /* prop */ js.UndefOr[typingsJapgolly.webdriverio.webdriverioStrings.x | y], 
          Location | Double
        ])
    ...
    inline def setGetSize(
      value: (js.ThisFunction0[/* this */ org.scalajs.dom.Element, Size]) & (js.ThisFunction1[
          /* this */ org.scalajs.dom.Element, 
          /* keyof @wdio/protocols.@wdio/protocols/build/types.RectReturn */ /* prop */ typingsJapgolly.webdriverio.webdriverioStrings.x | y | width | height, 
          Double
        ]) & (js.ThisFunction1[
          /* this */ org.scalajs.dom.Element, 
          /* prop */ js.UndefOr[typingsJapgolly.webdriverio.webdriverioStrings.x | y | width | height], 
          Size | Double
        ])
