package typingsJapgolly.webResourceInliner.mod
...
object Options {
  ...
  def apply(
    ...
    linkTransform: (/* content */ String, /* done */ Callback) => CallbackTo[js.Any] = null,
    links: Boolean | Double = null,
    rebaseRelativeTo: String = null,
    relativeTo: String = null,
    requestTransform: /* requestOptions */ RequiredUriUrl with CoreOptions => CallbackTo[RequiredUriUrl with CoreOptions] = null,
    scriptTransform: (/* content */ String, /* done */ Callback) => CallbackTo[js.Any] = null,
    ...
    if (linkTransform != null) __obj.updateDynamic("linkTransform")(js.Any.fromFunction2((t0: /* content */ java.lang.String, t1: /* done */ typingsJapgolly.webResourceInliner.mod.Callback) => linkTransform(t0, t1).runNow()))
    ...
    if (requestTransform != null) __obj.updateDynamic("requestTransform")(js.Any.fromFunction1((t0: /* requestOptions */ typingsJapgolly.request.mod.RequiredUriUrl with typingsJapgolly.request.mod.CoreOptions) => requestTransform(t0).runNow()))
    if (scriptTransform != null) __obj.updateDynamic("scriptTransform")(js.Any.fromFunction2((t0: /* content */ java.lang.String, t1: /* done */ typingsJapgolly.webResourceInliner.mod.Callback) => scriptTransform(t0, t1).runNow()))
