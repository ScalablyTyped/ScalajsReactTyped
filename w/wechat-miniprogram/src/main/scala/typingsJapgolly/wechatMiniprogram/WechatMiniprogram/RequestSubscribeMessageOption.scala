...
object RequestSubscribeMessageOption {
  ...
  extension [Self <: RequestSubscribeMessageOption](x: Self) {
    ...
    inline def setFail(value: /* result */ RequestSubscribeMessageFailCallbackResult => Callback): Self = StObject.set(x, "fail", js.Any.fromFunction1((t0: /* result */ RequestSubscribeMessageFailCallbackResult) => value(t0).runNow()))
    
    inline def setFailUndefined: Self = StObject.set(x, "fail", js.undefined)
    
    inline def setSuccess(value: /* result */ RequestSubscribeMessageSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ RequestSubscribeMessageSuccessCallbackResult) => value(t0).runNow()))
