...
object GetChannelsLiveInfoOption {
  ...
  extension [Self <: GetChannelsLiveInfoOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetChannelsLiveInfoSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetChannelsLiveInfoSuccessCallbackResult) => value(t0).runNow()))
