...
object AccessOption {
  ...
  extension [Self <: AccessOption](x: Self) {
    ...
    inline def setFail(value: /* result */ AccessFailCallbackResult => Callback): Self = StObject.set(x, "fail", js.Any.fromFunction1((t0: /* result */ AccessFailCallbackResult) => value(t0).runNow()))
