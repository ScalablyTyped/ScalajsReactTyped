...
object GetScaleOption {
  ...
  extension [Self <: GetScaleOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetScaleSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetScaleSuccessCallbackResult) => value(t0).runNow()))
