...
object TruncateOption {
  ...
  extension [Self <: TruncateOption](x: Self) {
    ...
    inline def setFail(value: /* result */ TruncateFailCallbackResult => Callback): Self = StObject.set(x, "fail", js.Any.fromFunction1((t0: /* result */ TruncateFailCallbackResult) => value(t0).runNow()))
