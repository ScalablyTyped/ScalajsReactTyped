...
import typingsJapgolly.wechatMiniprogram.WxCloud
import typingsJapgolly.wechatMiniprogram.anon.USERDATAPATH
...
trait Wx extends StObject {
  ...
  * 最低基础库： `1.9.0` */
  ...
  component: TrivialInstance | typingsJapgolly.wechatMiniprogram.WechatMiniprogram.Component.TrivialInstance
