...
object ChooseMessageFileOption {
  ...
  extension [Self <: ChooseMessageFileOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ ChooseMessageFileSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ ChooseMessageFileSuccessCallbackResult) => value(t0).runNow()))
