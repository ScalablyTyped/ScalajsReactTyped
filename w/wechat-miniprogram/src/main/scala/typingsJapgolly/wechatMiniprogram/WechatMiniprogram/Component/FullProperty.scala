...
object FullProperty {
  ...
  extension [Self <: FullProperty[?], T /* <: PropertyType */](x: Self & FullProperty[T]) {
    ...
    inline def setObserverFunction3(
      value: (/* newVal */ ValueType[T], /* oldVal */ ValueType[T], /* changedPath */ js.Array[String | Double]) => Callback
    ): Self = StObject.set(x, "observer", js.Any.fromFunction3((t0: /* newVal */ ValueType[T], t1: /* oldVal */ ValueType[T], t2: /* changedPath */ js.Array[String | Double]) => (value(t0, t1, t2)).runNow()))
