...
import typingsJapgolly.wechatMiniprogram.wechatMiniprogramStrings.easeIn
import typingsJapgolly.wechatMiniprogram.wechatMiniprogramStrings.easeInOut
import typingsJapgolly.wechatMiniprogram.wechatMiniprogramStrings.easeOut
