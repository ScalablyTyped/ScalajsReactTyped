...
object GetClipboardDataOption {
  ...
  inline def apply(): GetClipboardDataOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetClipboardDataOption]
  }
  
  extension [Self <: GetClipboardDataOption](x: Self) {
    ...
    inline def setSuccess(value: /* option */ GetClipboardDataSuccessCallbackOption => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* option */ GetClipboardDataSuccessCallbackOption) => value(t0).runNow()))
