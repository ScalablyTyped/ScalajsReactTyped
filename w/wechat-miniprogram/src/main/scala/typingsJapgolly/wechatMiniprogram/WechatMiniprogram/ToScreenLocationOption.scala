...
object ToScreenLocationOption {
  ...
  extension [Self <: ToScreenLocationOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ ToScreenLocationSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ ToScreenLocationSuccessCallbackResult) => value(t0).runNow()))
