...
object GetSkewOption {
  ...
  extension [Self <: GetSkewOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetSkewSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetSkewSuccessCallbackResult) => value(t0).runNow()))
