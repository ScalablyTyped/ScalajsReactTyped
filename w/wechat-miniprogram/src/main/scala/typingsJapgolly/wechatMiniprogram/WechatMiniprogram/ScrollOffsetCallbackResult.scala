...
object ScrollOffsetCallbackResult {
  ...
  inline def apply(dataset: IAnyObject, id: String, scrollLeft: Double, scrollTop: Double): ScrollOffsetCallbackResult = {
  ...
  extension [Self <: ScrollOffsetCallbackResult](x: Self) {
    ...
    inline def setDataset(value: IAnyObject): Self = StObject.set(x, "dataset", value.asInstanceOf[js.Any])
