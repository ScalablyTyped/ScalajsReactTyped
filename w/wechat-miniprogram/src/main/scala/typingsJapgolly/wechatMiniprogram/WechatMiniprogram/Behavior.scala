...
import typingsJapgolly.wechatMiniprogram.WechatMiniprogram.Component.RelationOption
...
object Behavior {
  ...
  type Data[D /* <: DataOption */] = typingsJapgolly.wechatMiniprogram.WechatMiniprogram.Component.Data[D]
  
  type DataOption = typingsJapgolly.wechatMiniprogram.WechatMiniprogram.Component.DataOption
  
  type DefinitionFilter = typingsJapgolly.wechatMiniprogram.WechatMiniprogram.Component.DefinitionFilter
  
  type Instance[TData /* <: DataOption */, TProperty /* <: PropertyOption */, TMethod /* <: MethodOption */, TCustomInstanceProperty /* <: IAnyObject */] = typingsJapgolly.wechatMiniprogram.WechatMiniprogram.Component.Instance[TData, TProperty, TMethod, TCustomInstanceProperty, `false`]
  
  type Lifetimes = typingsJapgolly.wechatMiniprogram.WechatMiniprogram.Component.Lifetimes
  
  type Method[M /* <: MethodOption */] = typingsJapgolly.wechatMiniprogram.WechatMiniprogram.Component.Method[M, `false`]
  
  type MethodOption = typingsJapgolly.wechatMiniprogram.WechatMiniprogram.Component.MethodOption
  ...
  trait Options[TData /* <: DataOption */, TProperty /* <: PropertyOption */, TMethod /* <: MethodOption */, TCustomInstanceProperty /* <: IAnyObject */] extends StObject {
    ...
    var definitionFilter: js.UndefOr[typingsJapgolly.wechatMiniprogram.WechatMiniprogram.Component.DefinitionFilter] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options[?, ?, ?, ?], TData /* <: DataOption */, TProperty /* <: PropertyOption */, TMethod /* <: MethodOption */, TCustomInstanceProperty /* <: IAnyObject */](x: Self & (Options[TData, TProperty, TMethod, TCustomInstanceProperty])) {
      ...
      inline def setDefinitionFilter(value: typingsJapgolly.wechatMiniprogram.WechatMiniprogram.Component.DefinitionFilter): Self = StObject.set(x, "definitionFilter", value.asInstanceOf[js.Any])
  ...
  type Property[P /* <: PropertyOption */] = typingsJapgolly.wechatMiniprogram.WechatMiniprogram.Component.Property[P]
  
  type PropertyOption = typingsJapgolly.wechatMiniprogram.WechatMiniprogram.Component.PropertyOption
