...
object Canvas {
  ...
  inline def apply(
    ...
    createImage: CallbackTo[Image],
    createImageData: CallbackTo[ImageData],
  ...
  extension [Self <: Canvas](x: Self) {
    ...
    inline def setCreateImageData(value: CallbackTo[ImageData]): Self = StObject.set(x, "createImageData", value.toJsFn)
