...
object LoadFontFaceOption {
  ...
  extension [Self <: LoadFontFaceOption](x: Self) {
    
    inline def setComplete(value: /* result */ LoadFontFaceCompleteCallbackResult => Callback): Self = StObject.set(x, "complete", js.Any.fromFunction1((t0: /* result */ LoadFontFaceCompleteCallbackResult) => value(t0).runNow()))
    ...
    inline def setFail(value: /* result */ LoadFontFaceCompleteCallbackResult => Callback): Self = StObject.set(x, "fail", js.Any.fromFunction1((t0: /* result */ LoadFontFaceCompleteCallbackResult) => value(t0).runNow()))
    ...
    inline def setSuccess(value: /* result */ LoadFontFaceCompleteCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ LoadFontFaceCompleteCallbackResult) => value(t0).runNow()))
