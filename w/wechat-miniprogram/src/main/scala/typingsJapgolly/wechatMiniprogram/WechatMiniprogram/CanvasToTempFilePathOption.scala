...
import typingsJapgolly.wechatMiniprogram.wechatMiniprogramStrings.jpg
import typingsJapgolly.wechatMiniprogram.wechatMiniprogramStrings.png
...
object CanvasToTempFilePathOption {
  ...
  extension [Self <: CanvasToTempFilePathOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ CanvasToTempFilePathSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ CanvasToTempFilePathSuccessCallbackResult) => value(t0).runNow()))
