...
object NavigateToOption {
  ...
  extension [Self <: NavigateToOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ NavigateToSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ NavigateToSuccessCallbackResult) => value(t0).runNow()))
