...
object GetMaxTransceiveLengthOption {
  ...
  extension [Self <: GetMaxTransceiveLengthOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetMaxTransceiveLengthSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetMaxTransceiveLengthSuccessCallbackResult) => value(t0).runNow()))
