...
object ReadOption {
  ...
  extension [Self <: ReadOption](x: Self) {
    ...
    inline def setFail(value: /* result */ ReadFailCallbackResult => Callback): Self = StObject.set(x, "fail", js.Any.fromFunction1((t0: /* result */ ReadFailCallbackResult) => value(t0).runNow()))
    ...
    inline def setSuccess(value: /* result */ ReadSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ ReadSuccessCallbackResult) => value(t0).runNow()))
