...
import typingsJapgolly.wechatMiniprogram.wechatMiniprogramStrings.`2d`
import typingsJapgolly.wechatMiniprogram.wechatMiniprogramStrings.webgl
...
object OffscreenCanvas {
  ...
  inline def apply(createImage: CallbackTo[Image], getContext: webgl | `2d` => Any, height: Double, width: Double): OffscreenCanvas = {
    val __obj = js.Dynamic.literal(createImage = createImage.toJsFn, getContext = js.Any.fromFunction1(getContext), height = height.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
    __obj.asInstanceOf[OffscreenCanvas]
  }
  
  extension [Self <: OffscreenCanvas](x: Self) {
    
    inline def setCreateImage(value: CallbackTo[Image]): Self = StObject.set(x, "createImage", value.toJsFn)
