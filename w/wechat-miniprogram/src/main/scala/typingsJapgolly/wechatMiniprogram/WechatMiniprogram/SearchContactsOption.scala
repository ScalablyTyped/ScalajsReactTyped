...
object SearchContactsOption {
  ...
  extension [Self <: SearchContactsOption](x: Self) {
    ...
    inline def setSuccess(value: /* option */ SearchContactsSuccessCallbackOption => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* option */ SearchContactsSuccessCallbackOption) => value(t0).runNow()))
