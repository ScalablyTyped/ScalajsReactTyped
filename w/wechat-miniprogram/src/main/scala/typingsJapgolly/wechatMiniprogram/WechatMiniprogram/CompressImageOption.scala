...
object CompressImageOption {
  ...
  extension [Self <: CompressImageOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ CompressImageSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ CompressImageSuccessCallbackResult) => value(t0).runNow()))
