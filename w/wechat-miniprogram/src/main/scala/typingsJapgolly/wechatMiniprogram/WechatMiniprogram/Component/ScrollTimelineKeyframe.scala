...
import typingsJapgolly.wechatMiniprogram.wechatMiniprogramStrings.accumulate
import typingsJapgolly.wechatMiniprogram.wechatMiniprogramStrings.add
import typingsJapgolly.wechatMiniprogram.wechatMiniprogramStrings.auto
import typingsJapgolly.wechatMiniprogram.wechatMiniprogramStrings.replace
