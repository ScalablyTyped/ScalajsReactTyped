...
object CanvasGetImageDataOption {
  ...
  extension [Self <: CanvasGetImageDataOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ CanvasGetImageDataSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ CanvasGetImageDataSuccessCallbackResult) => value(t0).runNow()))
