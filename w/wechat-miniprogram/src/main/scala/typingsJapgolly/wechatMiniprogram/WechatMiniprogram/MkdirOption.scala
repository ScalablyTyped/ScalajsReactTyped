...
object MkdirOption {
  ...
  extension [Self <: MkdirOption](x: Self) {
    ...
    inline def setFail(value: /* result */ MkdirFailCallbackResult => Callback): Self = StObject.set(x, "fail", js.Any.fromFunction1((t0: /* result */ MkdirFailCallbackResult) => value(t0).runNow()))
