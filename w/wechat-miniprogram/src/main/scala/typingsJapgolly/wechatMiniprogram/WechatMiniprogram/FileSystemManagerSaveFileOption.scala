...
object FileSystemManagerSaveFileOption {
  ...
  extension [Self <: FileSystemManagerSaveFileOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ SaveFileSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ SaveFileSuccessCallbackResult) => value(t0).runNow()))
