...
object ScrollViewContext {
  ...
  extension [Self <: ScrollViewContext](x: Self) {
    ...
    inline def setScrollIntoView(value: String => Callback): Self = StObject.set(x, "scrollIntoView", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    
    inline def setScrollTo(value: ScrollToOption => Callback): Self = StObject.set(x, "scrollTo", js.Any.fromFunction1((t0: ScrollToOption) => value(t0).runNow()))
