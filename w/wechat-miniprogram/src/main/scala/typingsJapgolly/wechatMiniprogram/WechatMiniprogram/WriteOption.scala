...
object WriteOption {
  ...
  extension [Self <: WriteOption](x: Self) {
    ...
    inline def setFail(value: /* result */ WriteFailCallbackResult => Callback): Self = StObject.set(x, "fail", js.Any.fromFunction1((t0: /* result */ WriteFailCallbackResult) => value(t0).runNow()))
    ...
    inline def setSuccess(value: /* result */ WriteSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ WriteSuccessCallbackResult) => value(t0).runNow()))
