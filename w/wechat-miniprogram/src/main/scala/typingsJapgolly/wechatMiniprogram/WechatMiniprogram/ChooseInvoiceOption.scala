...
object ChooseInvoiceOption {
  ...
  inline def apply(): ChooseInvoiceOption = {
  ...
  extension [Self <: ChooseInvoiceOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ ChooseInvoiceSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ ChooseInvoiceSuccessCallbackResult) => value(t0).runNow()))
