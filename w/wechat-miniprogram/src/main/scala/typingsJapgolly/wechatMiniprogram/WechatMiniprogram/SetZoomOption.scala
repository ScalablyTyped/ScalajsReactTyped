...
object SetZoomOption {
  ...
  extension [Self <: SetZoomOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ SetZoomSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ SetZoomSuccessCallbackResult) => value(t0).runNow()))
