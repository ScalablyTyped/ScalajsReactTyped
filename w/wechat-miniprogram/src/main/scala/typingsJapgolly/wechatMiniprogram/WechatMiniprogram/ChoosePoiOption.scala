...
object ChoosePoiOption {
  ...
  extension [Self <: ChoosePoiOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ ChoosePoiSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ ChoosePoiSuccessCallbackResult) => value(t0).runNow()))
