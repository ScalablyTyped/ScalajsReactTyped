...
object GetGroupEnterInfoOption {
  ...
  extension [Self <: GetGroupEnterInfoOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetGroupEnterInfoSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetGroupEnterInfoSuccessCallbackResult) => value(t0).runNow()))
