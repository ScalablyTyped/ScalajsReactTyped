...
object GetRandomValuesOption {
  ...
  extension [Self <: GetRandomValuesOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetRandomValuesSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetRandomValuesSuccessCallbackResult) => value(t0).runNow()))
