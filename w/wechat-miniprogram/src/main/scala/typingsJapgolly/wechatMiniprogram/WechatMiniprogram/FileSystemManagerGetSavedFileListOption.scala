...
object FileSystemManagerGetSavedFileListOption {
  ...
  extension [Self <: FileSystemManagerGetSavedFileListOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ FileSystemManagerGetSavedFileListSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ FileSystemManagerGetSavedFileListSuccessCallbackResult) => value(t0).runNow()))
