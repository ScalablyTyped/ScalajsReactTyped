...
import typingsJapgolly.wechatMiniprogram.wechatMiniprogramStrings.horizontal
import typingsJapgolly.wechatMiniprogram.wechatMiniprogramStrings.vertical
