...
import typingsJapgolly.wordpressCustomizeBrowser.outerSectionMod.OuterSection
import typingsJapgolly.wordpressCustomizeBrowser.themesSectionMod.ThemesSection
