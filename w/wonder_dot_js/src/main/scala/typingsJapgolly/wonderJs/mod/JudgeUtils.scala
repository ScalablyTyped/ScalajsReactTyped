...
@js.native
class JudgeUtils ()
  extends typingsJapgolly.wonderJs.judgeUtilsMod.JudgeUtils
...
object JudgeUtils extends js.Object {
  ...
  def isComponenet(component: typingsJapgolly.wonderJs.componentMod.Component): Boolean = js.native
  ...
  def isSelf(
    self: typingsJapgolly.wonderJs.entityMod.Entity,
    entityObject: typingsJapgolly.wonderJs.entityMod.Entity
  ): Boolean = js.native
