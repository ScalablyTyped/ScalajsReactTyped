...
@js.native
class EventUtils ()
  extends typingsJapgolly.wonderJs.eventUtilsMod.EventUtils

/* static members */
@JSImport("wonder.js/dist/es2015", "EventUtils")
@js.native
object EventUtils extends js.Object {
  def isEntityObject(arg: typingsJapgolly.wonderJs.entityObjectMod.EntityObject): Boolean = js.native
