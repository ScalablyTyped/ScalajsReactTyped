...
import typingsJapgolly.wonderJs.distEs2015EventHandlerDomEventHandlerMod.DomEventHandler
import typingsJapgolly.wonderJs.distEs2015EventInterfaceIeventdataMod.IEventData
