...
import typingsJapgolly.wonderJs.anon.Y
import typingsJapgolly.wonderJs.distEs2015CoreDataMainDataMod.ContextConfigData
...
object distEs2015StructureViewMod {
  ...
  object IView {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(dom = dom.asInstanceOf[js.Any], getContext = js.Any.fromFunction1(getContext), height = height.asInstanceOf[js.Any], initCanvas = initCanvas.toJsFn, offset = offset.asInstanceOf[js.Any], styleHeight = styleHeight.asInstanceOf[js.Any], styleWidth = styleWidth.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any], x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any])
    ...
    extension [Self <: IView](x: Self) {
      ...
      inline def setInitCanvas(value: Callback): Self = StObject.set(x, "initCanvas", value.toJsFn)
