...
object IPointEventData {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(clientX = clientX.asInstanceOf[js.Any], clientY = clientY.asInstanceOf[js.Any], pageX = pageX.asInstanceOf[js.Any], pageY = pageY.asInstanceOf[js.Any], returnValue = returnValue.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any])
