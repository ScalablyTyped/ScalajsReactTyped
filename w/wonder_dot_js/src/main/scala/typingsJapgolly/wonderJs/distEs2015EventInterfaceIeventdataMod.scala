...
object distEs2015EventInterfaceIeventdataMod {
  ...
  object IEventData {
    ...
    inline def apply(preventDefault: Callback, returnValue: Boolean): IEventData = {
      val __obj = js.Dynamic.literal(preventDefault = preventDefault.toJsFn, returnValue = returnValue.asInstanceOf[js.Any])
  ...
  object IKeyboardEventData {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(altKey = altKey.asInstanceOf[js.Any], ctrlKey = ctrlKey.asInstanceOf[js.Any], keyCode = keyCode.asInstanceOf[js.Any], metaKey = metaKey.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, returnValue = returnValue.asInstanceOf[js.Any], shiftKey = shiftKey.asInstanceOf[js.Any])
  ...
  object IMouseEventData {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(button = button.asInstanceOf[js.Any], clientX = clientX.asInstanceOf[js.Any], clientY = clientY.asInstanceOf[js.Any], currentTarget = currentTarget.asInstanceOf[js.Any], pageX = pageX.asInstanceOf[js.Any], pageY = pageY.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, returnValue = returnValue.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any])
  ...
  object IPointEventData {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(clientX = clientX.asInstanceOf[js.Any], clientY = clientY.asInstanceOf[js.Any], pageX = pageX.asInstanceOf[js.Any], pageY = pageY.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, returnValue = returnValue.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any], currentTarget = null)
  ...
  object ITouchEventData {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(changedTouches = changedTouches.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, returnValue = returnValue.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any], targetTouches = targetTouches.asInstanceOf[js.Any], touches = touches.asInstanceOf[js.Any], currentTarget = null)
