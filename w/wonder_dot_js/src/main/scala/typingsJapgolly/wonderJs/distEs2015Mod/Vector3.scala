...
@js.native
open class Vector3 ()
  extends typingsJapgolly.wonderJs.distEs2015MathVector3Mod.Vector3 {
...
object Vector3 {
  ...
  inline def create(): typingsJapgolly.wonderJs.distEs2015MathVector3Mod.Vector3 = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typingsJapgolly.wonderJs.distEs2015MathVector3Mod.Vector3]
  inline def create(x: Double, y: Double, z: Double): typingsJapgolly.wonderJs.distEs2015MathVector3Mod.Vector3 = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], z.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.wonderJs.distEs2015MathVector3Mod.Vector3]
