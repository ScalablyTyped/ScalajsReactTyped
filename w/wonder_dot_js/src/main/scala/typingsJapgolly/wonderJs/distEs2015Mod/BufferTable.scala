...
open class BufferTable ()
  extends typingsJapgolly.wonderJs.distEs2015CoreEntityObjectSceneCacheBufferTableMod.BufferTable
/* static members */
object BufferTable {
  ...
  inline def addBuffer(key: String, buffer: typingsJapgolly.wonderJs.distEs2015RendererBufferBufferMod.Buffer): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("addBuffer")(key.asInstanceOf[js.Any], buffer.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def bindIndexBuffer(indexBuffer: typingsJapgolly.wonderJs.distEs2015RendererBufferElementBufferMod.ElementBuffer): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("bindIndexBuffer")(indexBuffer.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  @js.native
  def lastBindedElementBuffer: typingsJapgolly.wonderJs.distEs2015RendererBufferElementBufferMod.ElementBuffer = js.native
  inline def lastBindedElementBuffer_=(x: typingsJapgolly.wonderJs.distEs2015RendererBufferElementBufferMod.ElementBuffer): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("lastBindedElementBuffer")(x.asInstanceOf[js.Any])
