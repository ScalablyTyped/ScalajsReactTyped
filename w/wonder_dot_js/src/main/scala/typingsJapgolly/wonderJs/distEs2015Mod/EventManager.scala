...
open class EventManager ()
  extends typingsJapgolly.wonderJs.distEs2015EventEventManagerMod.EventManager
/* static members */
object EventManager {
  ...
  inline def broadcast(
    target: typingsJapgolly.wonderJs.distEs2015CoreEntityObjectEntityObjectMod.EntityObject,
    event: typingsJapgolly.wonderJs.distEs2015EventObjectEventMod.Event
  ...
  inline def fromEvent(dom: HTMLElement, eventName: typingsJapgolly.wonderJs.distEs2015EventEengineeventMod.EEngineEvent): FromEventPatternStream = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEvent")(dom.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any])).asInstanceOf[FromEventPatternStream]
  inline def fromEvent(
    dom: HTMLElement,
    eventName: typingsJapgolly.wonderJs.distEs2015EventEengineeventMod.EEngineEvent,
    priority: Double
  ...
  ): FromEventPatternStream = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEvent")(dom.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any])).asInstanceOf[FromEventPatternStream]
  inline def fromEvent(
    dom: HTMLElement,
    eventName: typingsJapgolly.wonderJs.distEs2015EventObjectEventNameHandlerMod.EEventName,
    priority: Double
  ...
  inline def fromEvent(eventName: typingsJapgolly.wonderJs.distEs2015EventEengineeventMod.EEngineEvent): FromEventPatternStream = ^.asInstanceOf[js.Dynamic].applyDynamic("fromEvent")(eventName.asInstanceOf[js.Any]).asInstanceOf[FromEventPatternStream]
  inline def fromEvent(eventName: typingsJapgolly.wonderJs.distEs2015EventEengineeventMod.EEngineEvent, priority: Double): FromEventPatternStream = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEvent")(eventName.asInstanceOf[js.Any], priority.asInstanceOf[js.Any])).asInstanceOf[FromEventPatternStream]
  inline def fromEvent(eventName: typingsJapgolly.wonderJs.distEs2015EventObjectEventNameHandlerMod.EEventName): FromEventPatternStream = ^.asInstanceOf[js.Dynamic].applyDynamic("fromEvent")(eventName.asInstanceOf[js.Any]).asInstanceOf[FromEventPatternStream]
  inline def fromEvent(
    eventName: typingsJapgolly.wonderJs.distEs2015EventObjectEventNameHandlerMod.EEventName,
    priority: Double
  ): FromEventPatternStream = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEvent")(eventName.asInstanceOf[js.Any], priority.asInstanceOf[js.Any])).asInstanceOf[FromEventPatternStream]
  inline def fromEvent(
    target: typingsJapgolly.wonderJs.distEs2015CoreEntityObjectEntityObjectMod.EntityObject,
    eventName: String
  ...
  inline def off(
    dom: HTMLElement,
    eventName: typingsJapgolly.wonderJs.distEs2015EventObjectEventNameHandlerMod.EEventName
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("off")(dom.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def off(
    dom: HTMLElement,
    eventName: typingsJapgolly.wonderJs.distEs2015EventObjectEventNameHandlerMod.EEventName,
    handler: js.Function
  ...
  inline def off(eventName: typingsJapgolly.wonderJs.distEs2015EventEengineeventMod.EEngineEvent): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("off")(eventName.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def off(
    eventName: typingsJapgolly.wonderJs.distEs2015EventEengineeventMod.EEngineEvent,
    handler: js.Function
  ...
  inline def off(eventName: typingsJapgolly.wonderJs.distEs2015EventObjectEventNameHandlerMod.EEventName): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("off")(eventName.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def off(
    eventName: typingsJapgolly.wonderJs.distEs2015EventObjectEventNameHandlerMod.EEventName,
    handler: js.Function
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("off")(eventName.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def off(target: typingsJapgolly.wonderJs.distEs2015CoreEntityObjectEntityObjectMod.EntityObject): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("off")(target.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def off(
    target: typingsJapgolly.wonderJs.distEs2015CoreEntityObjectEntityObjectMod.EntityObject,
    eventName: String
  ...
  inline def setBubbleParent(
    target: typingsJapgolly.wonderJs.distEs2015CoreEntityObjectEntityObjectMod.EntityObject,
    parent: Any
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setBubbleParent")(target.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def trigger(dom: HTMLElement, event: typingsJapgolly.wonderJs.distEs2015EventObjectEventMod.Event): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("trigger")(dom.asInstanceOf[js.Any], event.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def trigger(event: typingsJapgolly.wonderJs.distEs2015EventObjectEventMod.Event): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("trigger")(event.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def trigger(event: typingsJapgolly.wonderJs.distEs2015EventObjectEventMod.Event, userData: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("trigger")(event.asInstanceOf[js.Any], userData.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def trigger(
    target: typingsJapgolly.wonderJs.distEs2015CoreEntityObjectEntityObjectMod.EntityObject,
    event: typingsJapgolly.wonderJs.distEs2015EventObjectEventMod.Event
