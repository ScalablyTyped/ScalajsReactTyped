...
open class CloneUtils ()
  extends typingsJapgolly.wonderJs.distEs2015DefinitionTypescriptDecoratorCloneMod.CloneUtils
/* static members */
object CloneUtils {
  ...
  inline def isNotClone(entityObject: typingsJapgolly.wonderJs.distEs2015CoreEntityObjectEntityObjectMod.EntityObject): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNotClone")(entityObject.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  inline def markNotClone(entityObject: typingsJapgolly.wonderJs.distEs2015CoreEntityObjectEntityObjectMod.EntityObject): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("markNotClone")(entityObject.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
