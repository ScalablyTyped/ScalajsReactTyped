...
open class ShaderLibUtils ()
  extends typingsJapgolly.wonderJs.distEs2015UtilsShaderLibUtilsMod.ShaderLibUtils
/* static members */
object ShaderLibUtils {
  ...
  inline def addVerticeShaderLib(
    geometry: typingsJapgolly.wonderJs.distEs2015ComponentGeometryGeometryMod.Geometry,
    shader: typingsJapgolly.wonderJs.distEs2015RendererShaderShaderShaderMod.Shader
