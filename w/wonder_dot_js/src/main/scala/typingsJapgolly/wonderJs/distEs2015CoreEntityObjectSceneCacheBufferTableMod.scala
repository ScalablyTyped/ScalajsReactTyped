...
import typingsJapgolly.wonderJs.distEs2015RendererBufferBufferMod.Buffer
import typingsJapgolly.wonderJs.distEs2015RendererBufferElementBufferMod.ElementBuffer
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distEs2015CoreEntityObjectSceneCacheBufferTableMod {
  ...
  object BufferTableKey extends StObject {
    ...
    sealed trait PROCEDURAL_INDEX
      extends StObject
         with BufferTableKey
    /* 1 */ val PROCEDURAL_INDEX: typingsJapgolly.wonderJs.distEs2015CoreEntityObjectSceneCacheBufferTableMod.BufferTableKey.PROCEDURAL_INDEX & Double = js.native
    
    @js.native
    sealed trait PROCEDURAL_VERTEX
      extends StObject
         with BufferTableKey
    /* 0 */ val PROCEDURAL_VERTEX: typingsJapgolly.wonderJs.distEs2015CoreEntityObjectSceneCacheBufferTableMod.BufferTableKey.PROCEDURAL_VERTEX & Double = js.native
  }
}
