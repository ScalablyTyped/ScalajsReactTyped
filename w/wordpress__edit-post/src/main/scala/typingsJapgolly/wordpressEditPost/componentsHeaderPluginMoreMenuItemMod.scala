...
object componentsHeaderPluginMoreMenuItemMod {
  ...
  object PluginMoreMenuItem {
    ...
    object Props {
      ...
      extension [Self <: Props](x: Self) {
        ...
        inline def setInfoVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "info", js.Array(value*))
