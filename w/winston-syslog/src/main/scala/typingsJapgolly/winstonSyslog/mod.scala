...
import typingsJapgolly.glossy.mod.Produce
import typingsJapgolly.glossy.mod.ProduceOptions
import typingsJapgolly.node.dgramMod.Socket
import typingsJapgolly.winstonSyslog.winstonSyslogBooleans.`true`
import typingsJapgolly.winstonTransport.mod.TransportStreamOptions
import typingsJapgolly.winstonTransport.mod.^
...
object mod {
  ...
  trait SyslogTransportInstance extends ^ {
    ...
    var socket: Socket | typingsJapgolly.node.netMod.Socket = js.native
  }
