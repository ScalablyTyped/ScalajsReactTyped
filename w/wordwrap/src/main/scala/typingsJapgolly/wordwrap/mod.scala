...
object mod {
  ...
  inline def apply(start: Double, stop: Double, params: typingsJapgolly.wordwrap.anon.Mode): Wrap = (^.asInstanceOf[js.Dynamic].apply(start.asInstanceOf[js.Any], stop.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[Wrap]
  /**
  ...
  inline def apply(stop: Double, params: typingsJapgolly.wordwrap.anon.Mode): Wrap = (^.asInstanceOf[js.Dynamic].apply(stop.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[Wrap]
  ...
  */
  ...
  object Mode {
    ...
    inline def hard: typingsJapgolly.wordwrap.wordwrapStrings.hard = "hard".asInstanceOf[typingsJapgolly.wordwrap.wordwrapStrings.hard]
    
    inline def soft: typingsJapgolly.wordwrap.wordwrapStrings.soft = "soft".asInstanceOf[typingsJapgolly.wordwrap.wordwrapStrings.soft]
  }
