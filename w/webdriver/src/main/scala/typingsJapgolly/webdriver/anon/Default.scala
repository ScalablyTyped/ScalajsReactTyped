...
object Default {
  ...
  extension [Self <: Default](x: Self) {
    ...
    inline def setValidate(value: /* option */ Record[String, WebDriverLogTypes] => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* option */ Record[String, WebDriverLogTypes]) => value(t0).runNow()))
