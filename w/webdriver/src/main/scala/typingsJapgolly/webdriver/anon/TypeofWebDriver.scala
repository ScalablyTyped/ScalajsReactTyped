...
import typingsJapgolly.webdriver.buildTypesMod.AttachOptions
import typingsJapgolly.webdriver.buildTypesMod.Client
import typingsJapgolly.webdriver.mod.WebDriver
...
trait TypeofWebDriver
  ...
  def newSession(options: typingsJapgolly.wdioTypes.buildOptionsMod.WebDriver): js.Promise[Client] = js.native
  def newSession(
    options: typingsJapgolly.wdioTypes.buildOptionsMod.WebDriver,
    modifier: js.Function1[/* repeated */ Any, Any]
