...
object buildRequestMod {
  ...
  type Agents = typingsJapgolly.wdioTypes.buildOptionsMod.Agents
  
  type RequestLibOptions = typingsJapgolly.wdioTypes.buildOptionsMod.RequestLibOptions
  
  type RequestLibResponse = typingsJapgolly.wdioTypes.buildOptionsMod.RequestLibResponse
  ...
  trait RequestOptions extends StObject {
    ...
    var transformResponse: js.UndefOr[
        js.Function2[
          /* response */ typingsJapgolly.wdioTypes.buildOptionsMod.RequestLibResponse, 
          /* requestOptions */ typingsJapgolly.wdioTypes.buildOptionsMod.RequestLibOptions, 
          typingsJapgolly.wdioTypes.buildOptionsMod.RequestLibResponse
        ]
      ] = js.undefined
  ...
  object RequestOptions {
    ...
    extension [Self <: RequestOptions](x: Self) {
      ...
      inline def setTransformResponse(
        value: (/* response */ typingsJapgolly.wdioTypes.buildOptionsMod.RequestLibResponse, /* requestOptions */ typingsJapgolly.wdioTypes.buildOptionsMod.RequestLibOptions) => typingsJapgolly.wdioTypes.buildOptionsMod.RequestLibResponse
