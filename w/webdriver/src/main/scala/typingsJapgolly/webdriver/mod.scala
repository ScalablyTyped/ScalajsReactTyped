...
import typingsJapgolly.webdriver.anon.Default
import typingsJapgolly.webdriver.anon.DefaultMatch
import typingsJapgolly.webdriver.anon.DefaultMatchRequired
import typingsJapgolly.webdriver.anon.Match
import typingsJapgolly.webdriver.anon.MatchRequired
import typingsJapgolly.webdriver.anon.PartialSessionFlags
import typingsJapgolly.webdriver.anon.Required
import typingsJapgolly.webdriver.anon.RequiredType
import typingsJapgolly.webdriver.anon.Type
import typingsJapgolly.webdriver.anon.TypeValidate
import typingsJapgolly.webdriver.anon.Validate
...
import typingsJapgolly.webdriver.buildTypesMod.BaseClient
...
object mod {
  ...
  object default {
    ...
    inline def newSession(options: typingsJapgolly.wdioTypes.buildOptionsMod.WebDriver): js.Promise[Client] = ^.asInstanceOf[js.Dynamic].applyDynamic("newSession")(options.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Client]]
