package typingsJapgolly.webpackManifestPlugin
...
import typingsJapgolly.webpackManifestPlugin.anon.ModuleAssets
import typingsJapgolly.webpackManifestPlugin.distMod.EmitCountMap
import typingsJapgolly.webpackManifestPlugin.distMod.InternalOptions
