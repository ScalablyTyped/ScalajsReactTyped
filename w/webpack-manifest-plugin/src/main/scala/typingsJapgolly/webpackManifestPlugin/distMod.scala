...
import typingsJapgolly.webpackManifestPlugin.distHelpersMod.FileDescriptor
import typingsJapgolly.webpackManifestPlugin.webpackManifestPluginBooleans.`false`
