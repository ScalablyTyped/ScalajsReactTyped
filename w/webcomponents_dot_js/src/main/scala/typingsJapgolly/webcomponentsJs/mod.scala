...
import typingsJapgolly.webcomponentsJs.mod.global.Document
...
object mod {
  ...
  object HTMLImportsPolyfill {
    ...
    extension [Self <: HTMLImportsPolyfill](x: Self) {
      ...
      inline def setWhenReady(value: js.Function0[Unit] => Callback): Self = StObject.set(x, "whenReady", js.Any.fromFunction1((t0: js.Function0[Unit]) => value(t0).runNow()))
    }
  }
  ...
  object global {
    ...
    object Element {
      ...
      inline def apply(createShadowRoot: CallbackTo[ShadowRoot]): Element = {
        val __obj = js.Dynamic.literal(createShadowRoot = createShadowRoot.toJsFn, shadowRoot = null)
        __obj.asInstanceOf[Element]
      }
      
      extension [Self <: Element](x: Self) {
        
        inline def setCreateShadowRoot(value: CallbackTo[ShadowRoot]): Self = StObject.set(x, "createShadowRoot", value.toJsFn)
