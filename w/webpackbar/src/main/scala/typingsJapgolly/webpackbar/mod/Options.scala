...
object Options {
  ...
  def apply(
    ...
    done: (/* sharedState */ SharedState, /* ctx */ WebpackBar) => Callback = null,
    ...
    if (done != null) __obj.updateDynamic("done")(js.Any.fromFunction2((t0: /* sharedState */ typingsJapgolly.webpackbar.mod.SharedState, t1: /* ctx */ typingsJapgolly.webpackbar.mod.WebpackBar) => done(t0, t1).runNow()))
