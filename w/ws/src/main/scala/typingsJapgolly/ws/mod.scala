...
import typingsJapgolly.ws.anon.Binary
import typingsJapgolly.ws.anon.ChunkSize
import typingsJapgolly.ws.anon.Origin
import typingsJapgolly.ws.anon.TypeofWebSocket
import typingsJapgolly.ws.wsBooleans.`false`
import typingsJapgolly.ws.wsInts.`0`
import typingsJapgolly.ws.wsInts.`1`
import typingsJapgolly.ws.wsInts.`2`
import typingsJapgolly.ws.wsInts.`3`
...
object mod extends Shortcut {
  ...
  @JSImport("ws", "Server")
  @js.native
  open class Server[T /* <: typingsJapgolly.ws.mod.WebSocket */] () extends EventEmitter {
  ...
  val WebSocketServer: Instantiable2[
    ...
    Server[typingsJapgolly.ws.mod.WebSocket]
  ] = js.native
  type WebSocketServer = Server[typingsJapgolly.ws.mod.WebSocket]
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("ws", "WebSocketServer")
  @js.native
  open class WebSocketServerCls[T /* <: typingsJapgolly.ws.mod.WebSocket */] () extends Server[T] {
    def this(options: ServerOptions) = this()
    def this(options: Unit, callback: js.Function0[Unit]) = this()
    def this(options: ServerOptions, callback: js.Function0[Unit]) = this()
  }
  ...
  object ClientOptions {
    ...
    extension [Self <: ClientOptions](x: Self) {
      ...
      inline def setGenerateMask(value: /* mask */ Buffer => Callback): Self = StObject.set(x, "generateMask", js.Any.fromFunction1((t0: /* mask */ Buffer) => value(t0).runNow()))
  ...
  trait CloseEvent extends StObject {
    ...
    var target: typingsJapgolly.ws.mod.WebSocket
  ...
  object CloseEvent {
    ...
    inline def apply(
      code: Double,
      reason: String,
      target: typingsJapgolly.ws.mod.WebSocket,
      `type`: String,
      wasClean: Boolean
    ): CloseEvent = {
    ...
    extension [Self <: CloseEvent](x: Self) {
      ...
      inline def setTarget(value: typingsJapgolly.ws.mod.WebSocket): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
  ...
  object ErrorEvent {
    ...
    inline def apply(error: Any, message: String, target: typingsJapgolly.ws.mod.WebSocket, `type`: String): ErrorEvent = {
  ...
  object Event {
    ...
    inline def apply(target: typingsJapgolly.ws.mod.WebSocket, `type`: String): Event = {
  ...
  object MessageEvent {
    ...
    inline def apply(data: Data, target: typingsJapgolly.ws.mod.WebSocket, `type`: String): MessageEvent = {
  ...
  type WebSocketAlias = org.scalajs.dom.WebSocket
