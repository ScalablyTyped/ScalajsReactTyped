...
object ClientOptions {
  ...
  def apply(
    ...
    ca: CertMeta = null,
    cert: CertMeta = null,
    checkServerIdentity: (/* servername */ String, /* cert */ CertMeta) => CallbackTo[Boolean] = null,
    ciphers: String = null,
    ...
    if (checkServerIdentity != null) __obj.updateDynamic("checkServerIdentity")(js.Any.fromFunction2((t0: /* servername */ java.lang.String, t1: /* cert */ typingsJapgolly.ws.mod.CertMeta) => checkServerIdentity(t0, t1).runNow()))
