...
object AppOptions {
  ...
  extension [Self <: AppOptions](x: Self) {
    ...
    inline def setOnLaunch(value: /* options */ onLaunchOptions => Callback): Self = StObject.set(x, "onLaunch", js.Any.fromFunction1((t0: /* options */ onLaunchOptions) => value(t0).runNow()))
    
    inline def setOnLaunchUndefined: Self = StObject.set(x, "onLaunch", js.undefined)
    
    inline def setOnPageNotFound(value: Callback): Self = StObject.set(x, "onPageNotFound", value.toJsFn)
    
    inline def setOnPageNotFoundUndefined: Self = StObject.set(x, "onPageNotFound", js.undefined)
    
    inline def setOnShow(value: /* options */ onShowOptions => Callback): Self = StObject.set(x, "onShow", js.Any.fromFunction1((t0: /* options */ onShowOptions) => value(t0).runNow()))
