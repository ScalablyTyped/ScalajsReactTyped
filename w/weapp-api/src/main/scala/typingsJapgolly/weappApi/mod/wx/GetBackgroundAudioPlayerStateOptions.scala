...
object GetBackgroundAudioPlayerStateOptions {
  ...
  def apply(
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* state */ typingsJapgolly.weappApi.mod.wx.BackgroundAudioPlayerState) => success(t0).runNow()))
