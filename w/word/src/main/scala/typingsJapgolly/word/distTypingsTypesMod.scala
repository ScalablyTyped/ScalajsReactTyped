...
import typingsJapgolly.word.wordStrings.c
import typingsJapgolly.word.wordStrings.r
import typingsJapgolly.word.wordStrings.s
import typingsJapgolly.word.wordStrings.t
...
object distTypingsTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.word.distTypingsTypesMod.WJSTextRun
    - typingsJapgolly.word.distTypingsTypesMod.WJSTable
  */
  trait WJSParaElement extends StObject
  object WJSParaElement {
    
    inline def WJSTable(r: js.Array[WJSTableRow]): typingsJapgolly.word.distTypingsTypesMod.WJSTable = {
      val __obj = js.Dynamic.literal(r = r.asInstanceOf[js.Any], t = "t")
      __obj.asInstanceOf[typingsJapgolly.word.distTypingsTypesMod.WJSTable]
    }
    
    inline def WJSTextRun(v: String): typingsJapgolly.word.distTypingsTypesMod.WJSTextRun = {
      val __obj = js.Dynamic.literal(t = "s", v = v.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.word.distTypingsTypesMod.WJSTextRun]
    }
  }
  ...
  trait WJSTable
    ...
    var t: typingsJapgolly.word.wordStrings.t
  }
  object WJSTable {
