...
object distTypesStoriesOnStageSystemIndexDotstoryMod {
  
  object default {
    
    @JSImport("@wix/wix-ui-icons-common/dist/types/stories/on-stage/system/index.story", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@wix/wix-ui-icons-common/dist/types/stories/on-stage/system/index.story", "default.category")
    @js.native
