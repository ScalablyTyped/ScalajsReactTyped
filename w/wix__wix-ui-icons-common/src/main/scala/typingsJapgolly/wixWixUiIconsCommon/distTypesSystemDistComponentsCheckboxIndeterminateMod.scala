...
object distTypesSystemDistComponentsCheckboxIndeterminateMod extends Shortcut {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system/dist/components/CheckboxIndeterminate", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesSystemDistComponentsCheckboxIndeterminateMod.foo` */
