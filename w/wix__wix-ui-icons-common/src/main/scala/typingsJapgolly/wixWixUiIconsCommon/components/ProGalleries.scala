...
object ProGalleries {
  ...
  implicit def make(companion: ProGalleries.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ProGalleriesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
