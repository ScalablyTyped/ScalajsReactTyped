...
object WarningSignBold {
  ...
  implicit def make(companion: WarningSignBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WarningSignBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
