...
object HtmlBold {
  ...
  implicit def make(companion: HtmlBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HtmlBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
