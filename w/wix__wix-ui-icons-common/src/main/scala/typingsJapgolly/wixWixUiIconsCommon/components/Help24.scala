...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsHelp24Mod.Help24Props
...
object Help24 {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "Help24")
  @js.native
  ...
  implicit def make(companion: Help24.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: Help24Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
