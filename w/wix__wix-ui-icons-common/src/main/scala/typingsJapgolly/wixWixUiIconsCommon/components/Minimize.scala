...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsMinimizeMod.MinimizeProps
...
object Minimize {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Minimize")
  @js.native
  ...
  implicit def make(companion: Minimize.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MinimizeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
