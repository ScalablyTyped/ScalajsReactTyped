...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsMaskMod.MaskProps
...
object Mask {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "Mask")
  @js.native
