...
object AlertCircleBoldSmall {
  ...
  implicit def make(companion: AlertCircleBoldSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlertCircleBoldSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
