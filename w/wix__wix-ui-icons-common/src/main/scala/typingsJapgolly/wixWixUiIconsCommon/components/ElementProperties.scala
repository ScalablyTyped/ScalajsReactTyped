...
object ElementProperties {
  ...
  implicit def make(companion: ElementProperties.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ElementPropertiesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
