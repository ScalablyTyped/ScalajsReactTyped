...
object AddBold {
  ...
  implicit def make(companion: AddBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
