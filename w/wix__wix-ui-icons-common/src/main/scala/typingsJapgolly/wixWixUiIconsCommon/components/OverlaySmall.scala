...
object OverlaySmall {
  ...
  implicit def make(companion: OverlaySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OverlaySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
