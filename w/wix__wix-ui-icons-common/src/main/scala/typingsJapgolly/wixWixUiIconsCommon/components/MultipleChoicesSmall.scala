...
object MultipleChoicesSmall {
  ...
  implicit def make(companion: MultipleChoicesSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MultipleChoicesSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
