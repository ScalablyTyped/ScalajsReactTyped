...
object Microsoft {
  ...
  implicit def make(companion: Microsoft.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MicrosoftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
