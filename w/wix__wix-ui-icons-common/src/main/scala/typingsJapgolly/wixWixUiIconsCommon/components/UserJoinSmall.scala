...
object UserJoinSmall {
  ...
  implicit def make(companion: UserJoinSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserJoinSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
