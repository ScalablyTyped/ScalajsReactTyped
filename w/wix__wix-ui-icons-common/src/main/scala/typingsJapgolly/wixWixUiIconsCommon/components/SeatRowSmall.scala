...
object SeatRowSmall {
  ...
  implicit def make(companion: SeatRowSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SeatRowSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
