...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsLayoutAlignLeftMod.LayoutAlignLeftProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object LayoutAlignLeft {
  ...
  implicit def make(companion: LayoutAlignLeft.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutAlignLeftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
