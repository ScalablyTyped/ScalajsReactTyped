...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsNumberedListSmallMod.NumberedListSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object NumberedListSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "NumberedListSmall")
  @js.native
  ...
  implicit def make(companion: NumberedListSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NumberedListSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
