...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsCloseLargeMod.CloseLargeProps
...
object CloseLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "CloseLarge")
  @js.native
