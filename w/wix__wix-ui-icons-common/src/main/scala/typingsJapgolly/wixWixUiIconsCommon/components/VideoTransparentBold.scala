...
object VideoTransparentBold {
  ...
  implicit def make(companion: VideoTransparentBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VideoTransparentBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
