...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsAlignTopBoldMod.AlignTopBoldProps
...
object AlignTopBold {
  ...
  implicit def make(companion: AlignTopBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignTopBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
