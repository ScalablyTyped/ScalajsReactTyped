...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsMediaMod.MediaProps
...
object Media {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "Media")
  @js.native
