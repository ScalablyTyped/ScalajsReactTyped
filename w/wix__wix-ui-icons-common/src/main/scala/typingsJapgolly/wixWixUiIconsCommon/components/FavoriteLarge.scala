...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsFavoriteLargeMod.FavoriteLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FavoriteLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "FavoriteLarge")
  @js.native
  ...
  implicit def make(companion: FavoriteLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FavoriteLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
