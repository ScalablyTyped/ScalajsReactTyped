...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsChevronDownXSmallMod.ChevronDownXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ChevronDownXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ChevronDownXSmall")
  @js.native
  ...
  implicit def make(companion: ChevronDownXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronDownXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
