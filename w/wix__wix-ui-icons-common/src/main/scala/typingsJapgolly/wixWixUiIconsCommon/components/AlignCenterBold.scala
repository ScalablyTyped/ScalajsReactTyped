...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsAlignCenterBoldMod.AlignCenterBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object AlignCenterBold {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/responsive-editor/system", "AlignCenterBold")
  @js.native
  ...
  implicit def make(companion: AlignCenterBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignCenterBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
