...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsDeleteUserMod.DeleteUserProps
...
object DeleteUser {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "DeleteUser")
  @js.native
  ...
  implicit def make(companion: DeleteUser.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DeleteUserProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
