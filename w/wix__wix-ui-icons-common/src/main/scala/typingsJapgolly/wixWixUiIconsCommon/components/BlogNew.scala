...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsBlogNewMod.BlogNewProps
...
object BlogNew {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "BlogNew")
  @js.native
  ...
  implicit def make(companion: BlogNew.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BlogNewProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
