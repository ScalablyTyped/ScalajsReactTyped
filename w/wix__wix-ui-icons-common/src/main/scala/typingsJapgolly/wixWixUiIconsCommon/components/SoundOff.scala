...
object SoundOff {
  ...
  implicit def make(companion: SoundOff.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SoundOffProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
