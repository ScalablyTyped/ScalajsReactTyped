...
object ChevronDownLargeSmall {
  ...
  implicit def make(companion: ChevronDownLargeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronDownLargeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
