...
object ItalicSmall {
  ...
  implicit def make(companion: ItalicSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ItalicSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
