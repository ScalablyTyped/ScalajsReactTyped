...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsClappingMod.ClappingProps
...
object Clapping {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "Clapping")
  @js.native
  ...
  implicit def make(companion: Clapping.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ClappingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
