...
object TextRtlDecrease {
  ...
  implicit def make(companion: TextRtlDecrease.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextRtlDecreaseProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
