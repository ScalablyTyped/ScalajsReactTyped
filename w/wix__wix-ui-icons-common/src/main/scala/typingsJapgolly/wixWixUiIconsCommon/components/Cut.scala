...
object Cut {
  ...
  implicit def make(companion: Cut.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CutProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
