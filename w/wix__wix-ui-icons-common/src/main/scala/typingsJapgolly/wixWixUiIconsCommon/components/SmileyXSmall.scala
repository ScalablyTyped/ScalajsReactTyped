...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSmileyXSmallMod.SmileyXSmallProps
...
object SmileyXSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "SmileyXSmall")
  @js.native
  ...
  implicit def make(companion: SmileyXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SmileyXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
