...
object Vegan {
  ...
  implicit def make(companion: Vegan.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VeganProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
