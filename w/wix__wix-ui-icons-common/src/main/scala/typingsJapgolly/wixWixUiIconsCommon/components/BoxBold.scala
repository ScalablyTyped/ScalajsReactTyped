...
object BoxBold {
  ...
  implicit def make(companion: BoxBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BoxBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
