...
object ShapeCropBold {
  ...
  implicit def make(companion: ShapeCropBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShapeCropBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
