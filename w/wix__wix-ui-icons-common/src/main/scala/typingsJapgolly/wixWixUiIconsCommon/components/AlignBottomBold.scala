...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsAlignBottomBoldMod.AlignBottomBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object AlignBottomBold {
  ...
  implicit def make(companion: AlignBottomBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignBottomBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
