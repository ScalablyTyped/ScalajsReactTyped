...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutThreeOnOneMod.GridLayoutThreeOnOneProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutThreeOnOne {
  ...
  implicit def make(companion: GridLayoutThreeOnOne.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutThreeOnOneProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
