...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsSelectLargeMod.SelectLargeProps
...
object SelectLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "SelectLarge")
  @js.native
  ...
  implicit def make(companion: SelectLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SelectLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
