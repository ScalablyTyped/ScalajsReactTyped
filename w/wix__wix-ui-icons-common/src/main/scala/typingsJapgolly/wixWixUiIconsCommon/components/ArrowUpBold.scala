...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsArrowUpBoldMod.ArrowUpBoldProps
...
object ArrowUpBold {
  ...
  implicit def make(companion: ArrowUpBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArrowUpBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
