...
object VideoCameraDisabledSmall {
  ...
  implicit def make(companion: VideoCameraDisabledSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VideoCameraDisabledSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
