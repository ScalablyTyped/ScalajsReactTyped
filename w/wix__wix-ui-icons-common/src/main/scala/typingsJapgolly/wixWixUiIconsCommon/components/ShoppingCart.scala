...
object ShoppingCart {
  ...
  implicit def make(companion: ShoppingCart.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShoppingCartProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
