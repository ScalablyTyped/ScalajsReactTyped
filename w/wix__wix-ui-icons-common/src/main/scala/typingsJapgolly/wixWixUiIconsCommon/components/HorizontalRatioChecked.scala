...
object HorizontalRatioChecked {
  ...
  implicit def make(companion: HorizontalRatioChecked.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HorizontalRatioCheckedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
