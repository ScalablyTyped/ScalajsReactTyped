...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsSortByArrowUpMod.SortByArrowUpProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SortByArrowUp {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "SortByArrowUp")
  @js.native
  ...
  implicit def make(companion: SortByArrowUp.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SortByArrowUpProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
