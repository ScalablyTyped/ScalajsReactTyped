...
object Microsoft365 {
  ...
  implicit def make(companion: Microsoft365.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: Microsoft365Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
