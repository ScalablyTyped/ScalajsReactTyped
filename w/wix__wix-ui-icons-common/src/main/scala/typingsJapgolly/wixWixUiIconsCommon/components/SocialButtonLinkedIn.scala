...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsSocialButtonLinkedInMod.SocialButtonLinkedInProps
...
object SocialButtonLinkedIn {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "SocialButtonLinkedIn")
  @js.native
