...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsThemeManagerMod.ThemeManagerProps
...
object ThemeManager {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "ThemeManager")
  @js.native
  ...
  implicit def make(companion: ThemeManager.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ThemeManagerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
