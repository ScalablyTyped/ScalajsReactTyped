...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsErrorMod.ErrorProps
...
object Error {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Error")
  @js.native
  ...
  implicit def make(companion: Error.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ErrorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
