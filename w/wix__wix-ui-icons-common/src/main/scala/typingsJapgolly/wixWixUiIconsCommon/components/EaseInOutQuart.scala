...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEaseInOutQuartMod.EaseInOutQuartProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object EaseInOutQuart {
  ...
  implicit def make(companion: EaseInOutQuart.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EaseInOutQuartProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
