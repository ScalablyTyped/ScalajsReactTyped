...
object FileHtml {
  ...
  implicit def make(companion: FileHtml.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FileHtmlProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
