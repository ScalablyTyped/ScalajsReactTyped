...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsFocalPointMod.FocalPointProps
...
object FocalPoint {
  ...
  implicit def make(companion: FocalPoint.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FocalPointProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
