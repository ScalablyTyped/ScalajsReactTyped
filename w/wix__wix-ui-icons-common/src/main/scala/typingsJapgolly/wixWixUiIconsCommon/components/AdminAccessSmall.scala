...
object AdminAccessSmall {
  ...
  implicit def make(companion: AdminAccessSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AdminAccessSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
