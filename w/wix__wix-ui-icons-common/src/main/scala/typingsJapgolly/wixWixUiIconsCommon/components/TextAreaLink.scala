...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsTextAreaLinkMod.TextAreaLinkProps
...
object TextAreaLink {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "TextAreaLink")
  @js.native
