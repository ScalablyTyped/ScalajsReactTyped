...
object UploadExportSmall {
  ...
  implicit def make(companion: UploadExportSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UploadExportSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
