...
object FunnelChartSmall {
  ...
  implicit def make(companion: FunnelChartSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FunnelChartSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
