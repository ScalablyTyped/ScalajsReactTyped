...
object SortZASmall {
  ...
  implicit def make(companion: SortZASmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SortZASmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
