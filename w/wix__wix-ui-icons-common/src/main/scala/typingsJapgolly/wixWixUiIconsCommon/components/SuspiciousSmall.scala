...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSuspiciousSmallMod.SuspiciousSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SuspiciousSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "SuspiciousSmall")
  @js.native
  ...
  implicit def make(companion: SuspiciousSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SuspiciousSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
