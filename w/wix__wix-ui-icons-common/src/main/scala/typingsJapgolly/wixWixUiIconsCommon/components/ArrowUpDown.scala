...
object ArrowUpDown {
  ...
  implicit def make(companion: ArrowUpDown.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArrowUpDownProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
