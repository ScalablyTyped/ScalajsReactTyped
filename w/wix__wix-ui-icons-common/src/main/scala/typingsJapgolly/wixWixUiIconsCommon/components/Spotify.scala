...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsSpotifyMod.SpotifyProps
...
object Spotify {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Spotify")
  @js.native
  ...
  implicit def make(companion: Spotify.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SpotifyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
