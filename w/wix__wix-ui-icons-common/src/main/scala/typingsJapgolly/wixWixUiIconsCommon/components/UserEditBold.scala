...
object UserEditBold {
  ...
  implicit def make(companion: UserEditBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserEditBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
