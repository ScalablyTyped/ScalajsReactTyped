...
object AlignLeft {
  ...
  implicit def make(companion: AlignLeft.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignLeftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
