...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsLayoutSliderMod.LayoutSliderProps
...
object LayoutSlider {
  ...
  implicit def make(companion: LayoutSlider.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutSliderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
