...
object Replace {
  ...
  implicit def make(companion: Replace.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ReplaceProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
