...
object RouterSmall {
  ...
  implicit def make(companion: RouterSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RouterSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
