...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsPercentLargeMod.PercentLargeProps
...
object PercentLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "PercentLarge")
  @js.native
  ...
  implicit def make(companion: PercentLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PercentLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
