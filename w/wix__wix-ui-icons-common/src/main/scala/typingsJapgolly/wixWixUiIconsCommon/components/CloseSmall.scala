...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsCloseSmallMod.CloseSmallProps
...
object CloseSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "CloseSmall")
  @js.native
  ...
  implicit def make(companion: CloseSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CloseSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
