...
object ChatBold {
  ...
  implicit def make(companion: ChatBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChatBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
