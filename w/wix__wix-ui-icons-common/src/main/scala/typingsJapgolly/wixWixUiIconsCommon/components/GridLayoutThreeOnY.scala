...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutThreeOnYMod.GridLayoutThreeOnYProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutThreeOnY {
  ...
  implicit def make(companion: GridLayoutThreeOnY.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutThreeOnYProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
