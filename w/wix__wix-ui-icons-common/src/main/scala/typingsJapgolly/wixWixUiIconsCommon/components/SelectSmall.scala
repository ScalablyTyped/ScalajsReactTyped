...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsSelectSmallMod.SelectSmallProps
...
object SelectSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "SelectSmall")
  @js.native
  ...
  implicit def make(companion: SelectSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SelectSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
