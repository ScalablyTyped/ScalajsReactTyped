...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsNotificationsSmallMod.NotificationsSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object NotificationsSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "NotificationsSmall")
  @js.native
  ...
  implicit def make(companion: NotificationsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NotificationsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
