...
object VideoBoxBold {
  ...
  implicit def make(companion: VideoBoxBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VideoBoxBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
