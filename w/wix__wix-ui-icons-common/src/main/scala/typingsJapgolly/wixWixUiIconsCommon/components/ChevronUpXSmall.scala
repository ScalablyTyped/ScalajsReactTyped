...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsChevronUpXSmallMod.ChevronUpXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ChevronUpXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ChevronUpXSmall")
  @js.native
  ...
  implicit def make(companion: ChevronUpXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronUpXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
