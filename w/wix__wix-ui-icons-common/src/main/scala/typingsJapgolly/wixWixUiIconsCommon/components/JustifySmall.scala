...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsJustifySmallMod.JustifySmallProps
...
object JustifySmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "JustifySmall")
  @js.native
  ...
  implicit def make(companion: JustifySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: JustifySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
