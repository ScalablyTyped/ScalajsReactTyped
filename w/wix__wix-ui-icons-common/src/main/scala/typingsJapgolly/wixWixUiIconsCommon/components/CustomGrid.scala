...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsCustomGridMod.CustomGridProps
...
object CustomGrid {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/responsive-editor/system", "CustomGrid")
  @js.native
  ...
  implicit def make(companion: CustomGrid.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CustomGridProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
