...
object FocusSmall {
  ...
  implicit def make(companion: FocusSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FocusSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
