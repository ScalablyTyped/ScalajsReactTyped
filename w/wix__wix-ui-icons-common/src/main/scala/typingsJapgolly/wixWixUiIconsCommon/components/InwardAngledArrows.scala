...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsInwardAngledArrowsMod.InwardAngledArrowsProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object InwardAngledArrows {
  ...
  implicit def make(companion: InwardAngledArrows.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InwardAngledArrowsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
