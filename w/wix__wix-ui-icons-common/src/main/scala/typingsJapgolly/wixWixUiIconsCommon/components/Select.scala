...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsSelectMod.SelectProps
...
object Select {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Select")
  @js.native
