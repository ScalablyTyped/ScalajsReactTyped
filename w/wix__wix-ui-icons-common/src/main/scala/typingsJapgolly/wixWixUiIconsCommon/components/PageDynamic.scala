...
object PageDynamic {
  ...
  implicit def make(companion: PageDynamic.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PageDynamicProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
