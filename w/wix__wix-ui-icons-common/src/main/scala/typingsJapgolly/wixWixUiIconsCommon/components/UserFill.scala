...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsUserFillMod.UserFillProps
...
object UserFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "UserFill")
  @js.native
  ...
  implicit def make(companion: UserFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
