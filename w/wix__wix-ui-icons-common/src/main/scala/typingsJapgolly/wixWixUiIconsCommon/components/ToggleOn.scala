...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsToggleOnMod.ToggleOnProps
...
object ToggleOn {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "ToggleOn")
  @js.native
  ...
  implicit def make(companion: ToggleOn.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ToggleOnProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
