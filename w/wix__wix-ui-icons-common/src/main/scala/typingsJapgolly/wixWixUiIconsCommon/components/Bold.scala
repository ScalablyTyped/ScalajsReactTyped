...
object Bold {
  ...
  implicit def make(companion: Bold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
