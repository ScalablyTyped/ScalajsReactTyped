...
object ImageGalleryBold {
  ...
  implicit def make(companion: ImageGalleryBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ImageGalleryBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
