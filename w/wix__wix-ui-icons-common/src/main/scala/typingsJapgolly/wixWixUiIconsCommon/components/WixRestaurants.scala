...
object WixRestaurants {
  ...
  implicit def make(companion: WixRestaurants.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixRestaurantsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
