...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsFilledDocumentMod.FilledDocumentProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FilledDocument {
  ...
  implicit def make(companion: FilledDocument.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FilledDocumentProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
