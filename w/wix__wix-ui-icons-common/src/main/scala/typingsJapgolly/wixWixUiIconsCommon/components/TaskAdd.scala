...
object TaskAdd {
  ...
  implicit def make(companion: TaskAdd.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TaskAddProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
