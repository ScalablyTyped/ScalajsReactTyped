...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsConnectToDataMod.ConnectToDataProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ConnectToData {
  ...
  implicit def make(companion: ConnectToData.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ConnectToDataProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
