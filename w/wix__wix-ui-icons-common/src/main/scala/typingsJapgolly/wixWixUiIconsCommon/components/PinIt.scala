...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsPinItMod.PinItProps
...
object PinIt {
  ...
  implicit def make(companion: PinIt.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PinItProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
