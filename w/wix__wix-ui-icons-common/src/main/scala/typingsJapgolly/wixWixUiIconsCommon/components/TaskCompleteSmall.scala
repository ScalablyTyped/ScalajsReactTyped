...
object TaskCompleteSmall {
  ...
  implicit def make(companion: TaskCompleteSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TaskCompleteSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
