...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsPasteStyleMod.PasteStyleProps
...
object PasteStyle {
  ...
  implicit def make(companion: PasteStyle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PasteStyleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
