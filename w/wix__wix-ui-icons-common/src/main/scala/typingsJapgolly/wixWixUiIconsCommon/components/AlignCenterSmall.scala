...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsAlignCenterSmallMod.AlignCenterSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object AlignCenterSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "AlignCenterSmall")
  @js.native
  ...
  implicit def make(companion: AlignCenterSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignCenterSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
