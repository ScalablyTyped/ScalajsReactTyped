...
object UserChecked {
  ...
  implicit def make(companion: UserChecked.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserCheckedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
