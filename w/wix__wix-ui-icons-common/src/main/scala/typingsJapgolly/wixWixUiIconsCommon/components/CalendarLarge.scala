...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsCalendarLargeMod.CalendarLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object CalendarLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "CalendarLarge")
  @js.native
  ...
  implicit def make(companion: CalendarLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CalendarLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
