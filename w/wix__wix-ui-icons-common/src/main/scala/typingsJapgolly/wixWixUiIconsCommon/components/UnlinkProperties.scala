...
object UnlinkProperties {
  ...
  implicit def make(companion: UnlinkProperties.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UnlinkPropertiesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
