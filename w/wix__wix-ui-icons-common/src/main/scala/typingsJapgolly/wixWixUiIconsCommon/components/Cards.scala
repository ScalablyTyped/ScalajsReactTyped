...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsCardsMod.CardsProps
...
object Cards {
  ...
  implicit def make(companion: Cards.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CardsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
