...
object StripBold {
  ...
  implicit def make(companion: StripBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StripBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
