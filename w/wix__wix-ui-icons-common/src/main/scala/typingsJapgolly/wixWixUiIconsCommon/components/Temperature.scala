...
object Temperature {
  ...
  implicit def make(companion: Temperature.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TemperatureProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
