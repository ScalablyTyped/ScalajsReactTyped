...
object EmailBold {
  ...
  implicit def make(companion: EmailBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EmailBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
