...
object SquareRatioChecked {
  ...
  implicit def make(companion: SquareRatioChecked.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SquareRatioCheckedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
