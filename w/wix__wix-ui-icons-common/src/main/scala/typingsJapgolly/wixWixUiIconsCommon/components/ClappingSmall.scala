...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsClappingSmallMod.ClappingSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ClappingSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "ClappingSmall")
  @js.native
  ...
  implicit def make(companion: ClappingSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ClappingSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
