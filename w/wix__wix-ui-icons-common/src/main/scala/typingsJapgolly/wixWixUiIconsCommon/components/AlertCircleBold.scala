...
object AlertCircleBold {
  ...
  implicit def make(companion: AlertCircleBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlertCircleBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
