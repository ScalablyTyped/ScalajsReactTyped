...
object TableChartColSmall {
  ...
  implicit def make(companion: TableChartColSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TableChartColSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
