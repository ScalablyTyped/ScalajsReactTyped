...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEaseOutSineMod.EaseOutSineProps
...
object EaseOutSine {
  ...
  implicit def make(companion: EaseOutSine.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EaseOutSineProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
