...
object CustomTypeBold {
  ...
  implicit def make(companion: CustomTypeBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CustomTypeBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
