...
object CustomBold {
  ...
  implicit def make(companion: CustomBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CustomBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
