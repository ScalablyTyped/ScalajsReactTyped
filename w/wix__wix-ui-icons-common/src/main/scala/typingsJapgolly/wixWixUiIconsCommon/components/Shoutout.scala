...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsShoutoutMod.ShoutoutProps
...
object Shoutout {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "Shoutout")
  @js.native
  ...
  implicit def make(companion: Shoutout.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShoutoutProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
