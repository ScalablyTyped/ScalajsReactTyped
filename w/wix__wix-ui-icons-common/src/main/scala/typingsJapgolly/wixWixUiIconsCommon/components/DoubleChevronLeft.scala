...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsDoubleChevronLeftMod.DoubleChevronLeftProps
...
object DoubleChevronLeft {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "DoubleChevronLeft")
  @js.native
  ...
  implicit def make(companion: DoubleChevronLeft.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DoubleChevronLeftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
