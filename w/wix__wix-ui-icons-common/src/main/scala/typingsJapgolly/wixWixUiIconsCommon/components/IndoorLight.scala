...
object IndoorLight {
  ...
  implicit def make(companion: IndoorLight.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: IndoorLightProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
