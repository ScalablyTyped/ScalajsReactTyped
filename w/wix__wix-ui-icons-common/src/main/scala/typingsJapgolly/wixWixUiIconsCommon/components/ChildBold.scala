...
object ChildBold {
  ...
  implicit def make(companion: ChildBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChildBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
