...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsBookMod.BookProps
...
object Book {
  ...
  implicit def make(companion: Book.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BookProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
