...
object CaptchaBold {
  ...
  implicit def make(companion: CaptchaBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CaptchaBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
