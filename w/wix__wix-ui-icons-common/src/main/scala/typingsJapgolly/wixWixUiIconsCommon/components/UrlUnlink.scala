...
object UrlUnlink {
  ...
  implicit def make(companion: UrlUnlink.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UrlUnlinkProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
