...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsSelectFillMod.SelectFillProps
...
object SelectFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "SelectFill")
  @js.native
  ...
  implicit def make(companion: SelectFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SelectFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
