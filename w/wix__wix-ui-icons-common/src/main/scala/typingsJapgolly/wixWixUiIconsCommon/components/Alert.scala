...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsAlertMod.AlertProps
...
object Alert {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Alert")
  @js.native
