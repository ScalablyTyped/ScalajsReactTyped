...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsUpgradeAscendMod.UpgradeAscendProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object UpgradeAscend {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "UpgradeAscend")
  @js.native
  ...
  implicit def make(companion: UpgradeAscend.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UpgradeAscendProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
