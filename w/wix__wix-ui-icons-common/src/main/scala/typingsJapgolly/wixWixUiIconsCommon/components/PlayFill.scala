...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsPlayFillMod.PlayFillProps
...
object PlayFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "PlayFill")
  @js.native
  ...
  implicit def make(companion: PlayFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlayFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
