...
object SplitColumns {
  ...
  implicit def make(companion: SplitColumns.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SplitColumnsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
