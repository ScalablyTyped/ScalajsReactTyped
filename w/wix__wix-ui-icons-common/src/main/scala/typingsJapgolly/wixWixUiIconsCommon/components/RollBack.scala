...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsRollBackMod.RollBackProps
...
object RollBack {
  ...
  implicit def make(companion: RollBack.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RollBackProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
