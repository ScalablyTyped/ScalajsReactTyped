...
object LayoutFourColumnsSmall {
  ...
  implicit def make(companion: LayoutFourColumnsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutFourColumnsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
