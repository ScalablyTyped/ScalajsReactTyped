...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsEmailLargeMod.EmailLargeProps
...
object EmailLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "EmailLarge")
  @js.native
  ...
  implicit def make(companion: EmailLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EmailLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
