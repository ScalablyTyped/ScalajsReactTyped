...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsCheckboxIndeterminateMod.CheckboxIndeterminateProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object CheckboxIndeterminate {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "CheckboxIndeterminate")
  @js.native
  ...
  implicit def make(companion: CheckboxIndeterminate.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CheckboxIndeterminateProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
