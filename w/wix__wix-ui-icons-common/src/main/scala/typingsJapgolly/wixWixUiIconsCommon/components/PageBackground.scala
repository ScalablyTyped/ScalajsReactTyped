...
object PageBackground {
  ...
  implicit def make(companion: PageBackground.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PageBackgroundProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
