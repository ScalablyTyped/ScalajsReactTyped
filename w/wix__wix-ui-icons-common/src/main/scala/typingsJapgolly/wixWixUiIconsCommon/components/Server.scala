...
object Server {
  ...
  implicit def make(companion: Server.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ServerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
