...
object AppSmall {
  ...
  implicit def make(companion: AppSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AppSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
