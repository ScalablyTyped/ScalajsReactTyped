...
object ModalSmall {
  ...
  implicit def make(companion: ModalSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ModalSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
