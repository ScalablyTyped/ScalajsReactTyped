...
object ChecklistSmall {
  ...
  implicit def make(companion: ChecklistSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChecklistSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
