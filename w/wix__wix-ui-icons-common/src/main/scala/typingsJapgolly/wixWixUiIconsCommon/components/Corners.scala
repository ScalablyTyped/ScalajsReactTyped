...
object Corners {
  ...
  implicit def make(companion: Corners.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CornersProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
