...
object AlignCenterHorizontally {
  ...
  implicit def make(companion: AlignCenterHorizontally.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignCenterHorizontallyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
