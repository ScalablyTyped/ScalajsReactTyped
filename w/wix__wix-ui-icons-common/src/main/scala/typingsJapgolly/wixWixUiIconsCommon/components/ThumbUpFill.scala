...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsThumbUpFillMod.ThumbUpFillProps
...
object ThumbUpFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "ThumbUpFill")
  @js.native
  ...
  implicit def make(companion: ThumbUpFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ThumbUpFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
