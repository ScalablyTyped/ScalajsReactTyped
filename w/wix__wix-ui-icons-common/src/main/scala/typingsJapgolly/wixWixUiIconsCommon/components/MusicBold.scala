...
object MusicBold {
  ...
  implicit def make(companion: MusicBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MusicBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
