...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsHotelsMod.HotelsProps
...
object Hotels {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Hotels")
  @js.native
  ...
  implicit def make(companion: Hotels.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HotelsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
