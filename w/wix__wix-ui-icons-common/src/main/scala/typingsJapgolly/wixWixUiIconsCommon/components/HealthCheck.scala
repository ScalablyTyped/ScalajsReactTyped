...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsHealthCheckMod.HealthCheckProps
...
object HealthCheck {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/responsive-editor/system", "HealthCheck")
  @js.native
  ...
  implicit def make(companion: HealthCheck.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HealthCheckProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
