...
object ExternalLinkBold {
  ...
  implicit def make(companion: ExternalLinkBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExternalLinkBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
