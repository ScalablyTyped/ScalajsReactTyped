...
object FolderOpen {
  ...
  implicit def make(companion: FolderOpen.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FolderOpenProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
