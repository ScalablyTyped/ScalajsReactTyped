...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsStoresSmallMod.StoresSmallProps
...
object StoresSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "StoresSmall")
  @js.native
  ...
  implicit def make(companion: StoresSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StoresSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
