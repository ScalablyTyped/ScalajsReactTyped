...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsHorizontalArrowsSquareMod.HorizontalArrowsSquareProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object HorizontalArrowsSquare {
  ...
  implicit def make(companion: HorizontalArrowsSquare.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HorizontalArrowsSquareProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
