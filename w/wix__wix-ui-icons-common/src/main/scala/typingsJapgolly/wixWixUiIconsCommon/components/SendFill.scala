...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsSendFillMod.SendFillProps
...
object SendFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "SendFill")
  @js.native
  ...
  implicit def make(companion: SendFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SendFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
