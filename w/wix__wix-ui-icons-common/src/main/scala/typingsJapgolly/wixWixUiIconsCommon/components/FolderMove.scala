...
object FolderMove {
  ...
  implicit def make(companion: FolderMove.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FolderMoveProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
