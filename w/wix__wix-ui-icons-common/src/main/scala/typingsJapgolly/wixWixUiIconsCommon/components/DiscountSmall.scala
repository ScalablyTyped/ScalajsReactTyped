...
object DiscountSmall {
  ...
  implicit def make(companion: DiscountSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DiscountSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
