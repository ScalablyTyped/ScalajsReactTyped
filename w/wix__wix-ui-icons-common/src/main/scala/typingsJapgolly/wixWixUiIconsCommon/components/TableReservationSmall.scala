...
object TableReservationSmall {
  ...
  implicit def make(companion: TableReservationSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TableReservationSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
