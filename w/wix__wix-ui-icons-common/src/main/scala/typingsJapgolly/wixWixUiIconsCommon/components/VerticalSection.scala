...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsVerticalSectionMod.VerticalSectionProps
...
object VerticalSection {
  ...
  implicit def make(companion: VerticalSection.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VerticalSectionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
