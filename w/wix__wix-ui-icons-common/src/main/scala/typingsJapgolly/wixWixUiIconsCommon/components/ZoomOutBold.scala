...
object ZoomOutBold {
  ...
  implicit def make(companion: ZoomOutBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ZoomOutBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
