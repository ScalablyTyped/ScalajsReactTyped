...
object WixForum {
  ...
  implicit def make(companion: WixForum.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixForumProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
