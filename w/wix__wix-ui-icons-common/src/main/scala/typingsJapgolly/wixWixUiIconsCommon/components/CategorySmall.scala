...
object CategorySmall {
  ...
  implicit def make(companion: CategorySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CategorySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
