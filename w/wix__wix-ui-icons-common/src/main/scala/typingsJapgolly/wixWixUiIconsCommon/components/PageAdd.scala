...
object PageAdd {
  ...
  implicit def make(companion: PageAdd.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PageAddProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
