...
object TextRtlIncrease {
  ...
  implicit def make(companion: TextRtlIncrease.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextRtlIncreaseProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
