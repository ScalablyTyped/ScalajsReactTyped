...
object CopyBold {
  ...
  implicit def make(companion: CopyBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CopyBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
