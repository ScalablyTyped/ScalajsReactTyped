...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsMobileToolsMod.MobileToolsProps
...
object MobileTools {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "MobileTools")
  @js.native
  ...
  implicit def make(companion: MobileTools.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MobileToolsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
