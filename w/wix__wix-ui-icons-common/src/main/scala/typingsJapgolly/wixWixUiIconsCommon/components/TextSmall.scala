...
object TextSmall {
  ...
  implicit def make(companion: TextSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
