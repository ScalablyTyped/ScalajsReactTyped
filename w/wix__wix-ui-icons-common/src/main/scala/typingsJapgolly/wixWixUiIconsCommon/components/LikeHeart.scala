...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsLikeHeartMod.LikeHeartProps
...
object LikeHeart {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "LikeHeart")
  @js.native
  ...
  implicit def make(companion: LikeHeart.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LikeHeartProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
