...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsEmailFillMod.EmailFillProps
...
object EmailFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "EmailFill")
  @js.native
  ...
  implicit def make(companion: EmailFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EmailFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
