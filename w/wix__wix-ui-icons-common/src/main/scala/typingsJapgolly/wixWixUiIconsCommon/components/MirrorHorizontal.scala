...
object MirrorHorizontal {
  ...
  implicit def make(companion: MirrorHorizontal.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MirrorHorizontalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
