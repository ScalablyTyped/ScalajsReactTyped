...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsBoxWideMod.BoxWideProps
...
object BoxWide {
  ...
  implicit def make(companion: BoxWide.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BoxWideProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
