...
object ChangeOrderSmall {
  ...
  implicit def make(companion: ChangeOrderSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChangeOrderSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
