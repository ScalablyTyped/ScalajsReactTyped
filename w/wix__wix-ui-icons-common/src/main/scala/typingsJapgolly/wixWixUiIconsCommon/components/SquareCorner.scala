...
object SquareCorner {
  ...
  implicit def make(companion: SquareCorner.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SquareCornerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
