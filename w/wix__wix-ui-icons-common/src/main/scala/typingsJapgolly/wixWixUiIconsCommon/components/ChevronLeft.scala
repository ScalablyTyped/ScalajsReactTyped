...
object ChevronLeft {
  ...
  implicit def make(companion: ChevronLeft.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronLeftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
