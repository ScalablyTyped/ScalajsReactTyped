...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsPluginsMod.PluginsProps
...
object Plugins {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "Plugins")
  @js.native
  ...
  implicit def make(companion: Plugins.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PluginsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
