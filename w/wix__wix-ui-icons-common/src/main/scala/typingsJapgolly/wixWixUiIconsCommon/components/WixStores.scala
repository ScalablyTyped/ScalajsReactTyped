...
object WixStores {
  ...
  implicit def make(companion: WixStores.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixStoresProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
