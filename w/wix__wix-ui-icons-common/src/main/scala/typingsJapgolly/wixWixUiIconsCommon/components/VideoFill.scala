...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsVideoFillMod.VideoFillProps
...
object VideoFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "VideoFill")
  @js.native
  ...
  implicit def make(companion: VideoFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VideoFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
