...
object PageCode {
  ...
  implicit def make(companion: PageCode.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PageCodeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
