...
object ShadowBold {
  ...
  implicit def make(companion: ShadowBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShadowBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
