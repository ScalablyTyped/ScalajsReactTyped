...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsWhiteTextColorSmallMod.WhiteTextColorSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object WhiteTextColorSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "WhiteTextColorSmall")
  @js.native
  ...
  implicit def make(companion: WhiteTextColorSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WhiteTextColorSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
