...
object ExternalLink {
  ...
  implicit def make(companion: ExternalLink.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExternalLinkProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
