...
object SquareCornerSmall {
  ...
  implicit def make(companion: SquareCornerSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SquareCornerSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
