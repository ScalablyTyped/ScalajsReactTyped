...
object Copy {
  ...
  implicit def make(companion: Copy.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CopyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
