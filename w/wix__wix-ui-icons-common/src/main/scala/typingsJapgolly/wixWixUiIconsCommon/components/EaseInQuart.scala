...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEaseInQuartMod.EaseInQuartProps
...
object EaseInQuart {
  ...
  implicit def make(companion: EaseInQuart.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EaseInQuartProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
