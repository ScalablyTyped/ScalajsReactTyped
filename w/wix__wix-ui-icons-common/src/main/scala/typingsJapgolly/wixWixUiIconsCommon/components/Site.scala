...
object Site {
  ...
  implicit def make(companion: Site.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SiteProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
