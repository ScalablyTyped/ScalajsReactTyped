...
object MapPinBold {
  ...
  implicit def make(companion: MapPinBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MapPinBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
