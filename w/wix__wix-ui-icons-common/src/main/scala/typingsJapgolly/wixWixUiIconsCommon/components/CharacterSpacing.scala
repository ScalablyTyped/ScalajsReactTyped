...
object CharacterSpacing {
  ...
  implicit def make(companion: CharacterSpacing.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CharacterSpacingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
