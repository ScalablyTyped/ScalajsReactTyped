...
object PaginationBold {
  ...
  implicit def make(companion: PaginationBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaginationBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
