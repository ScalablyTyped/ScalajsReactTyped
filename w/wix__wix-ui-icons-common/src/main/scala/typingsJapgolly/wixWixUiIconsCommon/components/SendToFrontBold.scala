...
object SendToFrontBold {
  ...
  implicit def make(companion: SendToFrontBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SendToFrontBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
