...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsCalendarSmallMod.CalendarSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object CalendarSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "CalendarSmall")
  @js.native
  ...
  implicit def make(companion: CalendarSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CalendarSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
