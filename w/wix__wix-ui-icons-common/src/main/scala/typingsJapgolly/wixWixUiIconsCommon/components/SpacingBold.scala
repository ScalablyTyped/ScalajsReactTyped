...
object SpacingBold {
  ...
  implicit def make(companion: SpacingBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SpacingBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
