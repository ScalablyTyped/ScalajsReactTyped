...
object MapPin {
  ...
  implicit def make(companion: MapPin.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MapPinProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
