...
object UrlUnlinkBold {
  ...
  implicit def make(companion: UrlUnlinkBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UrlUnlinkBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
