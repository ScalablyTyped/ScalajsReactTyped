...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsPercentMod.PercentProps
...
object Percent {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Percent")
  @js.native
  ...
  implicit def make(companion: Percent.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PercentProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
