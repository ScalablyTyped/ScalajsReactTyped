...
object MenuSmall {
  ...
  implicit def make(companion: MenuSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MenuSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
