...
object ListBold {
  ...
  implicit def make(companion: ListBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ListBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
