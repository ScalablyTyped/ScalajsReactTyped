...
object QuickActionBar {
  ...
  implicit def make(companion: QuickActionBar.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: QuickActionBarProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
