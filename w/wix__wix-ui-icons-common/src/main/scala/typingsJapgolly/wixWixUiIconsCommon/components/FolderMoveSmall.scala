...
object FolderMoveSmall {
  ...
  implicit def make(companion: FolderMoveSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FolderMoveSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
