...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsPlusSmallMod.PlusSmallProps
...
object PlusSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "PlusSmall")
  @js.native
  ...
  implicit def make(companion: PlusSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlusSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
