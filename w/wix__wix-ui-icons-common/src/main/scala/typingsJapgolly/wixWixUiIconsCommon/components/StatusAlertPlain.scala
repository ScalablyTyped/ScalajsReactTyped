...
object StatusAlertPlain {
  ...
  implicit def make(companion: StatusAlertPlain.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatusAlertPlainProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
