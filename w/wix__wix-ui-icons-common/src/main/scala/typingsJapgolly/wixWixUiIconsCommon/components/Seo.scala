...
object Seo {
  ...
  implicit def make(companion: Seo.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SeoProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
