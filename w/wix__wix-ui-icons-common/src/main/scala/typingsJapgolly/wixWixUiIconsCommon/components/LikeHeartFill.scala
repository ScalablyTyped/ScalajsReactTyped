...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsLikeHeartFillMod.LikeHeartFillProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object LikeHeartFill {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "LikeHeartFill")
  @js.native
  ...
  implicit def make(companion: LikeHeartFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LikeHeartFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
