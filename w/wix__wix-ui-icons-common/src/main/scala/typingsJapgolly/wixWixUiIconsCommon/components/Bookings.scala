...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsBookingsMod.BookingsProps
...
object Bookings {
  ...
  implicit def make(companion: Bookings.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BookingsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
