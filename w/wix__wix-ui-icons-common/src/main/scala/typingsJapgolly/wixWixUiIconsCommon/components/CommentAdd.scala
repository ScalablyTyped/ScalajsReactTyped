...
object CommentAdd {
  ...
  implicit def make(companion: CommentAdd.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CommentAddProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
