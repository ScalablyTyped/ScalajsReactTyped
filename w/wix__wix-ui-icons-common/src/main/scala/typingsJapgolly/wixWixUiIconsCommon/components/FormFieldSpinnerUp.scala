...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsFormFieldSpinnerUpMod.FormFieldSpinnerUpProps
...
object FormFieldSpinnerUp {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "FormFieldSpinnerUp")
  @js.native
