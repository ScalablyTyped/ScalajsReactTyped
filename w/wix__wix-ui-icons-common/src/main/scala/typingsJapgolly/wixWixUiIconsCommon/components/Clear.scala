...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsClearMod.ClearProps
...
object Clear {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Clear")
  @js.native
  ...
  implicit def make(companion: Clear.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ClearProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
