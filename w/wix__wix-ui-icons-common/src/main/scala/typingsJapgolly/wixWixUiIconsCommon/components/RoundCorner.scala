...
object RoundCorner {
  ...
  implicit def make(companion: RoundCorner.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RoundCornerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
