...
object ContextMenuVertical {
  ...
  implicit def make(companion: ContextMenuVertical.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ContextMenuVerticalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
