...
object HorizontalImageBold {
  ...
  implicit def make(companion: HorizontalImageBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HorizontalImageBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
