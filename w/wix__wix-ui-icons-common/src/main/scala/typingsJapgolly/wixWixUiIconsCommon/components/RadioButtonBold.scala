...
object RadioButtonBold {
  ...
  implicit def make(companion: RadioButtonBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RadioButtonBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
