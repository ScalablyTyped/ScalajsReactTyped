...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsThumbDownSmallMod.ThumbDownSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ThumbDownSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "ThumbDownSmall")
  @js.native
  ...
  implicit def make(companion: ThumbDownSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ThumbDownSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
