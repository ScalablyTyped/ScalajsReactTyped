...
object VerticalMenu {
  ...
  implicit def make(companion: VerticalMenu.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VerticalMenuProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
