...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsAdminSmallMod.AdminSmallProps
...
object AdminSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "AdminSmall")
  @js.native
  ...
  implicit def make(companion: AdminSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AdminSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
