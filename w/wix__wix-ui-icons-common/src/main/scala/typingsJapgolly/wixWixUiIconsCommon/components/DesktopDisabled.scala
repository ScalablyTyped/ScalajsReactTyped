...
object DesktopDisabled {
  ...
  implicit def make(companion: DesktopDisabled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DesktopDisabledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
