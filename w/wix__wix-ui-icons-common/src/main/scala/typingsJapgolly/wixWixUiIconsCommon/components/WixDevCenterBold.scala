...
object WixDevCenterBold {
  ...
  implicit def make(companion: WixDevCenterBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixDevCenterBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
