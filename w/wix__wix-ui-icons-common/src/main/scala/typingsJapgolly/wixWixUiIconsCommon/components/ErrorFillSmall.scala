...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsErrorFillSmallMod.ErrorFillSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ErrorFillSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "ErrorFillSmall")
  @js.native
  ...
  implicit def make(companion: ErrorFillSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ErrorFillSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
