...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutFourOnThreeMod.GridLayoutFourOnThreeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutFourOnThree {
  ...
  implicit def make(companion: GridLayoutFourOnThree.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutFourOnThreeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
