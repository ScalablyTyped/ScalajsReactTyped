...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsStarFilledTinyMod.StarFilledTinyProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object StarFilledTiny {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "StarFilledTiny")
  @js.native
  ...
  implicit def make(companion: StarFilledTiny.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StarFilledTinyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
