...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSmileyMod.SmileyProps
...
object Smiley {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "Smiley")
  @js.native
  ...
  implicit def make(companion: Smiley.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SmileyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
