...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsUnlockMod.UnlockProps
...
object Unlock {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Unlock")
  @js.native
  ...
  implicit def make(companion: Unlock.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UnlockProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
