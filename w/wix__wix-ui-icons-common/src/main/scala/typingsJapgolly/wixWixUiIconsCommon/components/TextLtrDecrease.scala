...
object TextLtrDecrease {
  ...
  implicit def make(companion: TextLtrDecrease.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextLtrDecreaseProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
