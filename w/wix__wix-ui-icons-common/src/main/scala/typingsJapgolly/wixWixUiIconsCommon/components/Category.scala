...
object Category {
  ...
  implicit def make(companion: Category.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CategoryProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
