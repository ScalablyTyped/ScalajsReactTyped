...
object Cart {
  ...
  implicit def make(companion: Cart.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CartProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
