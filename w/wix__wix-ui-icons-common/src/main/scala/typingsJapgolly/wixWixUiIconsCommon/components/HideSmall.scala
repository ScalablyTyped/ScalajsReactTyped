...
object HideSmall {
  ...
  implicit def make(companion: HideSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HideSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
