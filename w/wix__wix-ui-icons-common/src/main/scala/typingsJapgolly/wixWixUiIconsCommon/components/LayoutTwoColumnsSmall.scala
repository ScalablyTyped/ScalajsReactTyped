...
object LayoutTwoColumnsSmall {
  ...
  implicit def make(companion: LayoutTwoColumnsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutTwoColumnsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
