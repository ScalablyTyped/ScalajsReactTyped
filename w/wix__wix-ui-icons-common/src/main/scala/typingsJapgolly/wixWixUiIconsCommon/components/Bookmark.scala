...
object Bookmark {
  ...
  implicit def make(companion: Bookmark.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BookmarkProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
