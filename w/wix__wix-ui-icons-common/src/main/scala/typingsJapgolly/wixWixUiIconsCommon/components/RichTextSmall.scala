...
object RichTextSmall {
  ...
  implicit def make(companion: RichTextSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RichTextSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
