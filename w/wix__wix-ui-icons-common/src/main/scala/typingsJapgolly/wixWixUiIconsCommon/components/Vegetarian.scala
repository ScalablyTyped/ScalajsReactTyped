...
object Vegetarian {
  ...
  implicit def make(companion: Vegetarian.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VegetarianProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
