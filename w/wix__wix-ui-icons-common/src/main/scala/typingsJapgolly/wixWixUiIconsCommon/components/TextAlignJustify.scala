...
object TextAlignJustify {
  ...
  implicit def make(companion: TextAlignJustify.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAlignJustifyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
