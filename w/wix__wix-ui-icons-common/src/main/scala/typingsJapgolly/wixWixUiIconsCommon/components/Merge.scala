...
object Merge {
  ...
  implicit def make(companion: Merge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
