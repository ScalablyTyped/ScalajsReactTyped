...
object MoveForward {
  ...
  implicit def make(companion: MoveForward.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MoveForwardProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
