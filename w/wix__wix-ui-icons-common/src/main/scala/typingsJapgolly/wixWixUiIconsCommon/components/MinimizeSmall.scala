...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsMinimizeSmallMod.MinimizeSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object MinimizeSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "MinimizeSmall")
  @js.native
  ...
  implicit def make(companion: MinimizeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MinimizeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
