...
object YoutubeFilled {
  ...
  implicit def make(companion: YoutubeFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: YoutubeFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
