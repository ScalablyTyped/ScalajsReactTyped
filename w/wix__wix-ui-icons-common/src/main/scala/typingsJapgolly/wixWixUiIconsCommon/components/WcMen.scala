...
object WcMen {
  ...
  implicit def make(companion: WcMen.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WcMenProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
