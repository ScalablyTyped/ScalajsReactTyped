...
object UserPrivate {
  ...
  implicit def make(companion: UserPrivate.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserPrivateProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
