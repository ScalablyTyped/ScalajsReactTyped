...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsThumbUpSmallMod.ThumbUpSmallProps
...
object ThumbUpSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "ThumbUpSmall")
  @js.native
  ...
  implicit def make(companion: ThumbUpSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ThumbUpSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
