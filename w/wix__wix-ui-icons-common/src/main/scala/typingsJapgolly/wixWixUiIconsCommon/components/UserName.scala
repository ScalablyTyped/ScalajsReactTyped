...
object UserName {
  ...
  implicit def make(companion: UserName.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserNameProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
