...
object Strip {
  ...
  implicit def make(companion: Strip.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StripProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
