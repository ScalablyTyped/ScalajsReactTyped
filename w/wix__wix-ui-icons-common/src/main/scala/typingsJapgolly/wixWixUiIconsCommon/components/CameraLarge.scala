...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsCameraLargeMod.CameraLargeProps
...
object CameraLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "CameraLarge")
  @js.native
  ...
  implicit def make(companion: CameraLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CameraLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
