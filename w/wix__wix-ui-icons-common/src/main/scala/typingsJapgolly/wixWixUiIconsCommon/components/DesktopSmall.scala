...
object DesktopSmall {
  ...
  implicit def make(companion: DesktopSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DesktopSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
