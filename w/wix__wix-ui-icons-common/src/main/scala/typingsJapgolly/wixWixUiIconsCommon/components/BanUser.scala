...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsBanUserMod.BanUserProps
...
object BanUser {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "BanUser")
  @js.native
  ...
  implicit def make(companion: BanUser.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BanUserProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
