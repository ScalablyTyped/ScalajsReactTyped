...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsTextStyle2SmallMod.TextStyle2SmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextStyle2Small {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "TextStyle2Small")
  @js.native
  ...
  implicit def make(companion: TextStyle2Small.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextStyle2SmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
