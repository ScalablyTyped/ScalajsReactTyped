...
object Visible {
  ...
  implicit def make(companion: Visible.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VisibleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
