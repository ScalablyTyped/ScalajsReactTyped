...
object UserNameSmall {
  ...
  implicit def make(companion: UserNameSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserNameSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
