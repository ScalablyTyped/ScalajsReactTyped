...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsDecreaseIndentSmallMod.DecreaseIndentSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DecreaseIndentSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "DecreaseIndentSmall")
  @js.native
  ...
  implicit def make(companion: DecreaseIndentSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DecreaseIndentSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
