...
object HorizontalMenuBold {
  ...
  implicit def make(companion: HorizontalMenuBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HorizontalMenuBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
