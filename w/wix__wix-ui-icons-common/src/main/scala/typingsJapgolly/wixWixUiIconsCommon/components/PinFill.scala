...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsPinFillMod.PinFillProps
...
object PinFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "PinFill")
  @js.native
  ...
  implicit def make(companion: PinFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PinFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
