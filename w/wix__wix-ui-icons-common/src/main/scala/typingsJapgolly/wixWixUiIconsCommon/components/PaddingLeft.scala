...
object PaddingLeft {
  ...
  implicit def make(companion: PaddingLeft.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaddingLeftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
