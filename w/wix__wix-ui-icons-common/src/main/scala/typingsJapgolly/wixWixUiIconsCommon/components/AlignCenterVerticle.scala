...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsAlignCenterVerticleMod.AlignCenterVerticleProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object AlignCenterVerticle {
  ...
  implicit def make(companion: AlignCenterVerticle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignCenterVerticleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
