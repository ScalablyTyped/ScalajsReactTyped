...
object MultiSelectSmall {
  ...
  implicit def make(companion: MultiSelectSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MultiSelectSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
