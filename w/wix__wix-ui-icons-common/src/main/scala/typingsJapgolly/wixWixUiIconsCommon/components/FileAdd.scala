...
object FileAdd {
  ...
  implicit def make(companion: FileAdd.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FileAddProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
