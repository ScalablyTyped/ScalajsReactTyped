...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsMinusLargeMod.MinusLargeProps
...
object MinusLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "MinusLarge")
  @js.native
  ...
  implicit def make(companion: MinusLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MinusLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
