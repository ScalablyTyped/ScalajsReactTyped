...
object Invoice {
  ...
  implicit def make(companion: Invoice.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InvoiceProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
