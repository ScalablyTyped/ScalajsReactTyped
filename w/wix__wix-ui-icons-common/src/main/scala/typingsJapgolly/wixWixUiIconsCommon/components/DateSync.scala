...
object DateSync {
  ...
  implicit def make(companion: DateSync.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DateSyncProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
