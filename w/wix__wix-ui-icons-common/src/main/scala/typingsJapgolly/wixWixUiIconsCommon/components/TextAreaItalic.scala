...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsTextAreaItalicMod.TextAreaItalicProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextAreaItalic {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "TextAreaItalic")
  @js.native
  ...
  implicit def make(companion: TextAreaItalic.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaItalicProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
