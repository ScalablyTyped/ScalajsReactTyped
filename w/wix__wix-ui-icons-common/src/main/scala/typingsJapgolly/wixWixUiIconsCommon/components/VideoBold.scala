...
object VideoBold {
  ...
  implicit def make(companion: VideoBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VideoBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
