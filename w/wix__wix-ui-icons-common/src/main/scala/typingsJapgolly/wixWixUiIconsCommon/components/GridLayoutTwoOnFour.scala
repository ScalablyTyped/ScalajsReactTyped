...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutTwoOnFourMod.GridLayoutTwoOnFourProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutTwoOnFour {
  ...
  implicit def make(companion: GridLayoutTwoOnFour.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutTwoOnFourProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
