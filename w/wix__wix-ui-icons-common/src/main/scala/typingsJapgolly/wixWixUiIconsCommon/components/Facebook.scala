...
object Facebook {
  ...
  implicit def make(companion: Facebook.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FacebookProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
