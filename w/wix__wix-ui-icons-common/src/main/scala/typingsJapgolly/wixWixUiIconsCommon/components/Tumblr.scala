...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsTumblrMod.TumblrProps
...
object Tumblr {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Tumblr")
  @js.native
  ...
  implicit def make(companion: Tumblr.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TumblrProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
