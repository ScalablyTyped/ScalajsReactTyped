...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsFlipVerticalBoldMod.FlipVerticalBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FlipVerticalBold {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/responsive-editor/system", "FlipVerticalBold")
  @js.native
  ...
  implicit def make(companion: FlipVerticalBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlipVerticalBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
