...
object ListMenuBold {
  ...
  implicit def make(companion: ListMenuBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ListMenuBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
