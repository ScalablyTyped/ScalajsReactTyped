...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsGroupFillMod.GroupFillProps
...
object GroupFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "GroupFill")
  @js.native
  ...
  implicit def make(companion: GroupFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GroupFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
