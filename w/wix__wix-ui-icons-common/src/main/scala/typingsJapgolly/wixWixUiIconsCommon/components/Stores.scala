...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsStoresMod.StoresProps
...
object Stores {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Stores")
  @js.native
  ...
  implicit def make(companion: Stores.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StoresProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
