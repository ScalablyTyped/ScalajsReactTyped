...
object UserMenu {
  ...
  implicit def make(companion: UserMenu.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserMenuProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
