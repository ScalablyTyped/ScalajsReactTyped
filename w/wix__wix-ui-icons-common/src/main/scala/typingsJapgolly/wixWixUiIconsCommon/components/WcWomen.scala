...
object WcWomen {
  ...
  implicit def make(companion: WcWomen.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WcWomenProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
