...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsConnectedToDataMod.ConnectedToDataProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ConnectedToData {
  ...
  implicit def make(companion: ConnectedToData.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ConnectedToDataProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
