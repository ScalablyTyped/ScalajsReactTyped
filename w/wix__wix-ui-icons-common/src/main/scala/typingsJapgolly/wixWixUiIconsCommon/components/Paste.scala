...
object Paste {
  ...
  implicit def make(companion: Paste.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PasteProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
