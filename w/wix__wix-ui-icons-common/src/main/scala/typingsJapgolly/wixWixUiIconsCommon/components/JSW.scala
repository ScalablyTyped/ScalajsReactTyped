...
object JSW {
  ...
  implicit def make(companion: JSW.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: JSWProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
