...
object MicrophoneSmall {
  ...
  implicit def make(companion: MicrophoneSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MicrophoneSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
