...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsLockSquareMod.LockSquareProps
...
object LockSquare {
  ...
  implicit def make(companion: LockSquare.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LockSquareProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
