...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsWidgetCanvasMod.WidgetCanvasProps
...
object WidgetCanvas {
  ...
  implicit def make(companion: WidgetCanvas.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WidgetCanvasProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
