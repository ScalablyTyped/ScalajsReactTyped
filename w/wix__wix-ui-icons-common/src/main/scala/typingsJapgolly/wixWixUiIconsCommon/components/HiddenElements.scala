...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsHiddenElementsMod.HiddenElementsProps
...
object HiddenElements {
  ...
  implicit def make(companion: HiddenElements.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HiddenElementsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
