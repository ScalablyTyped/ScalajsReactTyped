...
object SwitchBold {
  ...
  implicit def make(companion: SwitchBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SwitchBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
