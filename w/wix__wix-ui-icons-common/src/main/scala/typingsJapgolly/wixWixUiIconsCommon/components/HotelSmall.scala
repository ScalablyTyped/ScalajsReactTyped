...
object HotelSmall {
  ...
  implicit def make(companion: HotelSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HotelSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
