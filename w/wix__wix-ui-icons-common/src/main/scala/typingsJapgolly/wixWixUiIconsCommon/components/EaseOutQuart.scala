...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEaseOutQuartMod.EaseOutQuartProps
...
object EaseOutQuart {
  ...
  implicit def make(companion: EaseOutQuart.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EaseOutQuartProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
