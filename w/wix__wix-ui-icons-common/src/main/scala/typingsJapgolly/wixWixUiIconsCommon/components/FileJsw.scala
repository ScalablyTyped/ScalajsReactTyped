...
object FileJsw {
  ...
  implicit def make(companion: FileJsw.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FileJswProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
