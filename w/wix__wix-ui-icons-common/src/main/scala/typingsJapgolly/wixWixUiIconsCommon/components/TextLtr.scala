...
object TextLtr {
  ...
  implicit def make(companion: TextLtr.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextLtrProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
