...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsNotificationsFillSmallMod.NotificationsFillSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object NotificationsFillSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "NotificationsFillSmall")
  @js.native
  ...
  implicit def make(companion: NotificationsFillSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NotificationsFillSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
