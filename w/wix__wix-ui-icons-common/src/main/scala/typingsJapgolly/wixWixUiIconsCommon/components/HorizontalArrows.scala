...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsHorizontalArrowsMod.HorizontalArrowsProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object HorizontalArrows {
  ...
  implicit def make(companion: HorizontalArrows.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HorizontalArrowsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
