...
object FormEditBold {
  ...
  implicit def make(companion: FormEditBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FormEditBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
