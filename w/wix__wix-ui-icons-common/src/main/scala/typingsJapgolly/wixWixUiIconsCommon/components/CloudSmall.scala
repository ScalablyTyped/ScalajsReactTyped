...
object CloudSmall {
  ...
  implicit def make(companion: CloudSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CloudSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
