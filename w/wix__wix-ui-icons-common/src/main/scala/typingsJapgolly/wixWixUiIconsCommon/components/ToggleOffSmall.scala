...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsToggleOffSmallMod.ToggleOffSmallProps
...
object ToggleOffSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "ToggleOffSmall")
  @js.native
