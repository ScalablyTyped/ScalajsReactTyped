...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsForumsMod.ForumsProps
...
object Forums {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Forums")
  @js.native
  ...
  implicit def make(companion: Forums.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ForumsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
