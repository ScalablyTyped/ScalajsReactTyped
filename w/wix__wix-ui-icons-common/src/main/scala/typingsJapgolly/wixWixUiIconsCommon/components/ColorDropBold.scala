...
object ColorDropBold {
  ...
  implicit def make(companion: ColorDropBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ColorDropBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
