...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsDistributeVerticalBoldMod.DistributeVerticalBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DistributeVerticalBold {
  ...
  implicit def make(companion: DistributeVerticalBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DistributeVerticalBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
