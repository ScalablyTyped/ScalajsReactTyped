...
object SendToBackBold {
  ...
  implicit def make(companion: SendToBackBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SendToBackBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
