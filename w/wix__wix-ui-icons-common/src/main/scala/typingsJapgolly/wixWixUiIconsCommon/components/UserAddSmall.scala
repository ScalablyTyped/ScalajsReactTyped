...
object UserAddSmall {
  ...
  implicit def make(companion: UserAddSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserAddSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
