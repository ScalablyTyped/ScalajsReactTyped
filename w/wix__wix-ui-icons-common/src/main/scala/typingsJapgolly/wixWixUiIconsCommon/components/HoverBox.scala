...
object HoverBox {
  ...
  implicit def make(companion: HoverBox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HoverBoxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
