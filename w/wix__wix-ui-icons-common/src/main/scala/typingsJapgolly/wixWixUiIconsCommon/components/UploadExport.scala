...
object UploadExport {
  ...
  implicit def make(companion: UploadExport.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UploadExportProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
