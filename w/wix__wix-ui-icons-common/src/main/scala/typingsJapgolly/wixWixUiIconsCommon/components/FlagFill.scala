...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsFlagFillMod.FlagFillProps
...
object FlagFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "FlagFill")
  @js.native
  ...
  implicit def make(companion: FlagFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlagFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
