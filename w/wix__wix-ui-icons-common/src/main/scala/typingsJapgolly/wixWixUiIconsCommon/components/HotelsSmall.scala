...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsHotelsSmallMod.HotelsSmallProps
...
object HotelsSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "HotelsSmall")
  @js.native
  ...
  implicit def make(companion: HotelsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HotelsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
