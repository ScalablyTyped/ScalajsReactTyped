...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsUnderlineSmallMod.UnderlineSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object UnderlineSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "UnderlineSmall")
  @js.native
  ...
  implicit def make(companion: UnderlineSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UnderlineSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
