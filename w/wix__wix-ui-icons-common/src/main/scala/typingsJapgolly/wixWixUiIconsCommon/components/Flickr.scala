...
object Flickr {
  ...
  implicit def make(companion: Flickr.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlickrProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
