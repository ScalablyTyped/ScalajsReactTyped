...
object ProGalleriesSmall {
  ...
  implicit def make(companion: ProGalleriesSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ProGalleriesSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
