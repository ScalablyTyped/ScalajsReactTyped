...
object AdminAccess {
  ...
  implicit def make(companion: AdminAccess.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AdminAccessProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
