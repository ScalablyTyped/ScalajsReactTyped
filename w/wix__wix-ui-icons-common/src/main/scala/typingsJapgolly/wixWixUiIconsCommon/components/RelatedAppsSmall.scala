...
object RelatedAppsSmall {
  ...
  implicit def make(companion: RelatedAppsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RelatedAppsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
