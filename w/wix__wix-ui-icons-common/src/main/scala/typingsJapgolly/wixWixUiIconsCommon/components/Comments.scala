...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsCommentsMod.CommentsProps
...
object Comments {
  ...
  implicit def make(companion: Comments.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CommentsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
