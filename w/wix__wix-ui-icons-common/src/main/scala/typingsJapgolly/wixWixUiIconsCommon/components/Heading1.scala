...
object Heading1 {
  ...
  implicit def make(companion: Heading1.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: Heading1Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
