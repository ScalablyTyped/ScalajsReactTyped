...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutOneOnTwoMod.GridLayoutOneOnTwoProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutOneOnTwo {
  ...
  implicit def make(companion: GridLayoutOneOnTwo.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutOneOnTwoProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
