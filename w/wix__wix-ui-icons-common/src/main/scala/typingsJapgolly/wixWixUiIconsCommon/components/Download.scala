...
object Download {
  ...
  implicit def make(companion: Download.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DownloadProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
