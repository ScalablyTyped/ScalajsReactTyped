...
object HighlightColor {
  ...
  implicit def make(companion: HighlightColor.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HighlightColorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
