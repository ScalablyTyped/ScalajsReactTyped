...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsAngryXSmallMod.AngryXSmallProps
...
object AngryXSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "AngryXSmall")
  @js.native
  ...
  implicit def make(companion: AngryXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AngryXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
