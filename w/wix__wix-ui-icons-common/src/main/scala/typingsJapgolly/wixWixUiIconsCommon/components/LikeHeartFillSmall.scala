...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsLikeHeartFillSmallMod.LikeHeartFillSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object LikeHeartFillSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "LikeHeartFillSmall")
  @js.native
  ...
  implicit def make(companion: LikeHeartFillSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LikeHeartFillSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
