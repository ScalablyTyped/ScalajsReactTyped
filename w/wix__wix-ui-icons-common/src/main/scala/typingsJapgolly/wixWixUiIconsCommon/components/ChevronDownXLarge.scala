...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsChevronDownXLargeMod.ChevronDownXLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ChevronDownXLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ChevronDownXLarge")
  @js.native
  ...
  implicit def make(companion: ChevronDownXLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronDownXLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
