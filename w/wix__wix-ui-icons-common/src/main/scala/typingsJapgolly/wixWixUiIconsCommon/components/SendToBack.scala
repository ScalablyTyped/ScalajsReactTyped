...
object SendToBack {
  ...
  implicit def make(companion: SendToBack.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SendToBackProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
