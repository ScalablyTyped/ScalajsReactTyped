...
object Smoking {
  ...
  implicit def make(companion: Smoking.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SmokingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
