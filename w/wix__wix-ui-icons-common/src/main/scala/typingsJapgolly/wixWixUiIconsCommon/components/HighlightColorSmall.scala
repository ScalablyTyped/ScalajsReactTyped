...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsHighlightColorSmallMod.HighlightColorSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object HighlightColorSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "HighlightColorSmall")
  @js.native
  ...
  implicit def make(companion: HighlightColorSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HighlightColorSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
