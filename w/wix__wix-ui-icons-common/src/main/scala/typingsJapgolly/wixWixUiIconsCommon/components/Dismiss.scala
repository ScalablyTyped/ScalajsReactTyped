...
object Dismiss {
  ...
  implicit def make(companion: Dismiss.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DismissProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
