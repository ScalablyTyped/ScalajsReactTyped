...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsExternalLinkLargeMod.ExternalLinkLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ExternalLinkLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ExternalLinkLarge")
  @js.native
  ...
  implicit def make(companion: ExternalLinkLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExternalLinkLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
