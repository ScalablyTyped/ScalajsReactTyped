...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsUnlockFillMod.UnlockFillProps
...
object UnlockFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "UnlockFill")
  @js.native
  ...
  implicit def make(companion: UnlockFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UnlockFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
