...
object ColorBucketBold {
  ...
  implicit def make(companion: ColorBucketBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ColorBucketBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
