...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsFavoriteFillSmallMod.FavoriteFillSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FavoriteFillSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "FavoriteFillSmall")
  @js.native
  ...
  implicit def make(companion: FavoriteFillSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FavoriteFillSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
