...
object ShoppingCartBold {
  ...
  implicit def make(companion: ShoppingCartBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShoppingCartBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
