...
object FormBold {
  ...
  implicit def make(companion: FormBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FormBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
