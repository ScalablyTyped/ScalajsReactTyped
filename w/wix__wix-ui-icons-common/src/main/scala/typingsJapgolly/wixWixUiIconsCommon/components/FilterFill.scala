...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsFilterFillMod.FilterFillProps
...
object FilterFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "FilterFill")
  @js.native
  ...
  implicit def make(companion: FilterFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FilterFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
