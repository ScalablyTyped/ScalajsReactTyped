...
object DocumentSend {
  ...
  implicit def make(companion: DocumentSend.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DocumentSendProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
