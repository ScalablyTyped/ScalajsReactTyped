...
object ColorBucket {
  ...
  implicit def make(companion: ColorBucket.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ColorBucketProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
