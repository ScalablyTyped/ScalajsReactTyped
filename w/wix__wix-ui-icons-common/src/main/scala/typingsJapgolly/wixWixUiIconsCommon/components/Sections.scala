...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsSectionsMod.SectionsProps
...
object Sections {
  ...
  implicit def make(companion: Sections.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SectionsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
