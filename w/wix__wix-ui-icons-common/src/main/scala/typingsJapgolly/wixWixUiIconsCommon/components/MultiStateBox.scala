...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsMultiStateBoxMod.MultiStateBoxProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object MultiStateBox {
  ...
  implicit def make(companion: MultiStateBox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MultiStateBoxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
