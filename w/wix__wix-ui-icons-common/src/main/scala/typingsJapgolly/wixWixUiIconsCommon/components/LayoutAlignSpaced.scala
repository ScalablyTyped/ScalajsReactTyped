...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsLayoutAlignSpacedMod.LayoutAlignSpacedProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object LayoutAlignSpaced {
  ...
  implicit def make(companion: LayoutAlignSpaced.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutAlignSpacedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
