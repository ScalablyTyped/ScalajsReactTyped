...
object Loyalty {
  ...
  implicit def make(companion: Loyalty.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LoyaltyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
