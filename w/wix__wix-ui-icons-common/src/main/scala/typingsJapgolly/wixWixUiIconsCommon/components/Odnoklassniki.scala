...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsOdnoklassnikiMod.OdnoklassnikiProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object Odnoklassniki {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Odnoklassniki")
  @js.native
  ...
  implicit def make(companion: Odnoklassniki.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OdnoklassnikiProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
