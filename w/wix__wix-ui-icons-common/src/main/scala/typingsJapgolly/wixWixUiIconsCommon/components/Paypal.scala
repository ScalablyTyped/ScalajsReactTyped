...
object Paypal {
  ...
  implicit def make(companion: Paypal.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaypalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
