...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsFilterMod.FilterProps
...
object Filter {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Filter")
  @js.native
