...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsTextStyleSmallMod.TextStyleSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextStyleSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "TextStyleSmall")
  @js.native
  ...
  implicit def make(companion: TextStyleSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextStyleSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
