...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsToggleOnSmallMod.ToggleOnSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ToggleOnSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "ToggleOnSmall")
  @js.native
  ...
  implicit def make(companion: ToggleOnSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ToggleOnSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
