...
object HomeBold {
  ...
  implicit def make(companion: HomeBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HomeBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
