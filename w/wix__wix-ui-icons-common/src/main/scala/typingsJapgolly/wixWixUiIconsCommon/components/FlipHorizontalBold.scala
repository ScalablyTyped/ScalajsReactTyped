...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsFlipHorizontalBoldMod.FlipHorizontalBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FlipHorizontalBold {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/responsive-editor/system", "FlipHorizontalBold")
  @js.native
  ...
  implicit def make(companion: FlipHorizontalBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlipHorizontalBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
