...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsCameraSmallMod.CameraSmallProps
...
object CameraSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "CameraSmall")
  @js.native
  ...
  implicit def make(companion: CameraSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CameraSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
