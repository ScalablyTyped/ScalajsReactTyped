...
object RichTextBoxBold {
  ...
  implicit def make(companion: RichTextBoxBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RichTextBoxBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
