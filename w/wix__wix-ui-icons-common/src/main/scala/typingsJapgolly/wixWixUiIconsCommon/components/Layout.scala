...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsLayoutMod.LayoutProps
...
object Layout {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "Layout")
  @js.native
