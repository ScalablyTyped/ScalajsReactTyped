...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsDistributeMod.DistributeProps
...
object Distribute {
  ...
  implicit def make(companion: Distribute.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DistributeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
