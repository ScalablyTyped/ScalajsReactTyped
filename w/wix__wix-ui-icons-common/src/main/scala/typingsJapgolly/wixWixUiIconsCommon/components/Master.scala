...
object Master {
  ...
  implicit def make(companion: Master.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MasterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
