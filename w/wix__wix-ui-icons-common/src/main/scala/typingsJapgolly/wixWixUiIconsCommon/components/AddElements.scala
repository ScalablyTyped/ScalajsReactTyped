...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsAddElementsMod.AddElementsProps
...
object AddElements {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "AddElements")
  @js.native
  ...
  implicit def make(companion: AddElements.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddElementsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
