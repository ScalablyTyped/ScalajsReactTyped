...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsChevronRightXSmallMod.ChevronRightXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ChevronRightXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ChevronRightXSmall")
  @js.native
  ...
  implicit def make(companion: ChevronRightXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronRightXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
