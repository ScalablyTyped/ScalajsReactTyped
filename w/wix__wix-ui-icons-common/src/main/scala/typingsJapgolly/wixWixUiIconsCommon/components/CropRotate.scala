...
object CropRotate {
  ...
  implicit def make(companion: CropRotate.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CropRotateProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
