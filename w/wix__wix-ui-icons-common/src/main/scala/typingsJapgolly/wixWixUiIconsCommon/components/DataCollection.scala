...
object DataCollection {
  ...
  implicit def make(companion: DataCollection.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DataCollectionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
