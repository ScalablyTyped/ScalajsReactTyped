...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEaseLinearMod.EaseLinearProps
...
object EaseLinear {
  ...
  implicit def make(companion: EaseLinear.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EaseLinearProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
