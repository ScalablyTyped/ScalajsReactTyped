...
object PageSpecial {
  ...
  implicit def make(companion: PageSpecial.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PageSpecialProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
