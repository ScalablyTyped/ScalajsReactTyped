...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsStoresLargeMod.StoresLargeProps
...
object StoresLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "StoresLarge")
  @js.native
  ...
  implicit def make(companion: StoresLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StoresLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
