...
object DataTableCloud {
  ...
  implicit def make(companion: DataTableCloud.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DataTableCloudProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
