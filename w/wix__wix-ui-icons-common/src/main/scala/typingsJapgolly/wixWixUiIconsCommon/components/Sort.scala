...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsSortMod.SortProps
...
object Sort {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Sort")
  @js.native
  ...
  implicit def make(companion: Sort.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SortProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
