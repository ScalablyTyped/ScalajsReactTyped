...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsLikeHeartLargeMod.LikeHeartLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object LikeHeartLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "LikeHeartLarge")
  @js.native
  ...
  implicit def make(companion: LikeHeartLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LikeHeartLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
