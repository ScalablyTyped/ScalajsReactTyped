...
object ESignature {
  ...
  implicit def make(companion: ESignature.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ESignatureProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
