...
object SizeAndRatio {
  ...
  implicit def make(companion: SizeAndRatio.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SizeAndRatioProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
