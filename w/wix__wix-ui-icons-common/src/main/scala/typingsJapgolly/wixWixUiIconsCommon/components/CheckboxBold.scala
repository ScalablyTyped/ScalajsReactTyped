...
object CheckboxBold {
  ...
  implicit def make(companion: CheckboxBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CheckboxBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
