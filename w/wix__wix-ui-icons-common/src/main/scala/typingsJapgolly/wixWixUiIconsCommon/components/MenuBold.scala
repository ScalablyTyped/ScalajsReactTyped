...
object MenuBold {
  ...
  implicit def make(companion: MenuBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MenuBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
