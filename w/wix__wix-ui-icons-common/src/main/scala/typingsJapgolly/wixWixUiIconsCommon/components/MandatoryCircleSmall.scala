...
object MandatoryCircleSmall {
  ...
  implicit def make(companion: MandatoryCircleSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MandatoryCircleSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
