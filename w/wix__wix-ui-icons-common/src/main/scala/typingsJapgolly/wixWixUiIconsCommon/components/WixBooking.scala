...
object WixBooking {
  ...
  implicit def make(companion: WixBooking.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixBookingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
