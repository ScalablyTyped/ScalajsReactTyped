...
object SpicySmall {
  ...
  implicit def make(companion: SpicySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SpicySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
