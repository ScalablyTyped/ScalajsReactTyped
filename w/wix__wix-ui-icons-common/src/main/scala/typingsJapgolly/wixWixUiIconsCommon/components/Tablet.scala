...
object Tablet {
  ...
  implicit def make(companion: Tablet.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TabletProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
