...
object TextColor {
  ...
  implicit def make(companion: TextColor.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextColorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
