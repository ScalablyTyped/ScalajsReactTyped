...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsPagesMod.PagesProps
...
object Pages {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "Pages")
  @js.native
  ...
  implicit def make(companion: Pages.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PagesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
