...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsTagLargeMod.TagLargeProps
...
object TagLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "TagLarge")
  @js.native
  ...
  implicit def make(companion: TagLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TagLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
