...
object CSS {
  ...
  implicit def make(companion: CSS.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CSSProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
