...
object WixFormsFilled {
  ...
  implicit def make(companion: WixFormsFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixFormsFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
