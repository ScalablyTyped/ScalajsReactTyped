...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsInteractionMod.InteractionProps
...
object Interaction {
  ...
  implicit def make(companion: Interaction.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InteractionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
