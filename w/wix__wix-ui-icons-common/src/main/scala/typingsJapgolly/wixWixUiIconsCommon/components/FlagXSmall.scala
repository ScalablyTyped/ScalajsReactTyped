...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsFlagXSmallMod.FlagXSmallProps
...
object FlagXSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "FlagXSmall")
  @js.native
  ...
  implicit def make(companion: FlagXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlagXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
