...
object Cutlery {
  ...
  implicit def make(companion: Cutlery.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CutleryProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
