...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsErrorLargeMod.ErrorLargeProps
...
object ErrorLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ErrorLarge")
  @js.native
  ...
  implicit def make(companion: ErrorLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ErrorLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
