...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsThumbDownXSmallMod.ThumbDownXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ThumbDownXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "ThumbDownXSmall")
  @js.native
  ...
  implicit def make(companion: ThumbDownXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ThumbDownXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
