...
object LayoutGalleryWithPanelSmall {
  ...
  implicit def make(companion: LayoutGalleryWithPanelSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutGalleryWithPanelSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
