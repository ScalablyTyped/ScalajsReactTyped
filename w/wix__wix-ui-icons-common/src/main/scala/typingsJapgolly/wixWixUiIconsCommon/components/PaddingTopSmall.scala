...
object PaddingTopSmall {
  ...
  implicit def make(companion: PaddingTopSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaddingTopSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
