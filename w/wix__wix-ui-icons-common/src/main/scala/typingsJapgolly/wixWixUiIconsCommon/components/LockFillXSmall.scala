...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsLockFillXSmallMod.LockFillXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object LockFillXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "LockFillXSmall")
  @js.native
  ...
  implicit def make(companion: LockFillXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LockFillXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
