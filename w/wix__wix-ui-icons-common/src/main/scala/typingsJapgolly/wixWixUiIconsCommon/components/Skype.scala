...
object Skype {
  ...
  implicit def make(companion: Skype.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SkypeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
