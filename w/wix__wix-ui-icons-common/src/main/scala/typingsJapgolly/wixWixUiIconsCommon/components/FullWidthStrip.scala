...
object FullWidthStrip {
  ...
  implicit def make(companion: FullWidthStrip.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FullWidthStripProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
