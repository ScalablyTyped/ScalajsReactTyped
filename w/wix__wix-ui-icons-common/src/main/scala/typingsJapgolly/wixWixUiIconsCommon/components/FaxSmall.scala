...
object FaxSmall {
  ...
  implicit def make(companion: FaxSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FaxSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
