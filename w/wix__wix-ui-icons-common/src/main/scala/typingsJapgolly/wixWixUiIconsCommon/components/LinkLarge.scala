...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsLinkLargeMod.LinkLargeProps
...
object LinkLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "LinkLarge")
  @js.native
  ...
  implicit def make(companion: LinkLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LinkLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
