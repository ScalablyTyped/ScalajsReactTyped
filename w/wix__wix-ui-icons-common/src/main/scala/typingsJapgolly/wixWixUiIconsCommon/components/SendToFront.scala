...
object SendToFront {
  ...
  implicit def make(companion: SendToFront.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SendToFrontProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
