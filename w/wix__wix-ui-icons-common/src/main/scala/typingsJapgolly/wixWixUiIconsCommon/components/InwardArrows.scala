...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsInwardArrowsMod.InwardArrowsProps
...
object InwardArrows {
  ...
  implicit def make(companion: InwardArrows.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InwardArrowsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
