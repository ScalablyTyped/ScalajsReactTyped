...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsGroupMod.GroupProps
...
object Group {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Group")
  @js.native
