...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsVkontakteMod.VKontakteProps
...
object VKontakte {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "VKontakte")
  @js.native
  ...
  implicit def make(companion: VKontakte.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VKontakteProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
