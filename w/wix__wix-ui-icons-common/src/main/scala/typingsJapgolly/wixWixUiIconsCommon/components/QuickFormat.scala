...
object QuickFormat {
  ...
  implicit def make(companion: QuickFormat.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: QuickFormatProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
