...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsReplySmallMod.ReplySmallProps
...
object ReplySmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "ReplySmall")
  @js.native
  ...
  implicit def make(companion: ReplySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ReplySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
