...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsLayoutAlignCenterMod.LayoutAlignCenterProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object LayoutAlignCenter {
  ...
  implicit def make(companion: LayoutAlignCenter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutAlignCenterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
