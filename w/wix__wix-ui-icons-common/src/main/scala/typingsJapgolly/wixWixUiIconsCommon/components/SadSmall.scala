...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSadSmallMod.SadSmallProps
...
object SadSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "SadSmall")
  @js.native
  ...
  implicit def make(companion: SadSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SadSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
