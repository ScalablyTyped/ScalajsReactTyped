...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsTagFillMod.TagFillProps
...
object TagFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "TagFill")
  @js.native
  ...
  implicit def make(companion: TagFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TagFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
