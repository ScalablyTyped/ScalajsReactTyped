...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsStripFullWidthMod.StripFullWidthProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object StripFullWidth {
  ...
  implicit def make(companion: StripFullWidth.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StripFullWidthProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
