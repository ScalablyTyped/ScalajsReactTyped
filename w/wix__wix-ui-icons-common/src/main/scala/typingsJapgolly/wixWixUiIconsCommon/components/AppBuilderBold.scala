...
object AppBuilderBold {
  ...
  implicit def make(companion: AppBuilderBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AppBuilderBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
