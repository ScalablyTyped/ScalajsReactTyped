...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsSortDownMod.SortDownProps
...
object SortDown {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "SortDown")
  @js.native
  ...
  implicit def make(companion: SortDown.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SortDownProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
