...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEaseInQuadMod.EaseInQuadProps
...
object EaseInQuad {
  ...
  implicit def make(companion: EaseInQuad.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EaseInQuadProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
