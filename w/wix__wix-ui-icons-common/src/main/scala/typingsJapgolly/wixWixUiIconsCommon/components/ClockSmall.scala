...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsClockSmallMod.ClockSmallProps
...
object ClockSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "ClockSmall")
  @js.native
  ...
  implicit def make(companion: ClockSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ClockSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
