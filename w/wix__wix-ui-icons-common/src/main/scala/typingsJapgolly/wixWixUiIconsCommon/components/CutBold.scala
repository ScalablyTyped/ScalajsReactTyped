...
object CutBold {
  ...
  implicit def make(companion: CutBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CutBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
