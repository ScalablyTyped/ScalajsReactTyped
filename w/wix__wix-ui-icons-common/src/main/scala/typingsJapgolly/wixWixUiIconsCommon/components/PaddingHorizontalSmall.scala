...
object PaddingHorizontalSmall {
  ...
  implicit def make(companion: PaddingHorizontalSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaddingHorizontalSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
