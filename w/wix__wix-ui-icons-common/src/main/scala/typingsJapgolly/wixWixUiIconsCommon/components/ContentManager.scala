...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsContentManagerMod.ContentManagerProps
...
object ContentManager {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "ContentManager")
  @js.native
  ...
  implicit def make(companion: ContentManager.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ContentManagerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
