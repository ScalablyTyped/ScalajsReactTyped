...
object ComposeSmall {
  ...
  implicit def make(companion: ComposeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ComposeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
