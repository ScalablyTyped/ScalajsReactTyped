...
object UserPreviewBold {
  ...
  implicit def make(companion: UserPreviewBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserPreviewBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
