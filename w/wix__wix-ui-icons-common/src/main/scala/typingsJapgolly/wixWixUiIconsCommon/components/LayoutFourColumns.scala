...
object LayoutFourColumns {
  ...
  implicit def make(companion: LayoutFourColumns.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutFourColumnsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
