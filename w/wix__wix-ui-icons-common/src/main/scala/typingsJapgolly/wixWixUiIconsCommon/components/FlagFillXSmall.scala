...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsFlagFillXSmallMod.FlagFillXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FlagFillXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "FlagFillXSmall")
  @js.native
  ...
  implicit def make(companion: FlagFillXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlagFillXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
