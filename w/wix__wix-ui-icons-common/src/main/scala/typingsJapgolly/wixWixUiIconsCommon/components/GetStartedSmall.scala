...
object GetStartedSmall {
  ...
  implicit def make(companion: GetStartedSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GetStartedSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
