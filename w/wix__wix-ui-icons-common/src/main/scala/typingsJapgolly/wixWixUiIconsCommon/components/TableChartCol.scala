...
object TableChartCol {
  ...
  implicit def make(companion: TableChartCol.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TableChartColProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
