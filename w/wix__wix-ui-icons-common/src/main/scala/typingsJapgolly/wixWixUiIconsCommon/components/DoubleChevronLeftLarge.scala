...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsDoubleChevronLeftLargeMod.DoubleChevronLeftLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DoubleChevronLeftLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "DoubleChevronLeftLarge")
  @js.native
  ...
  implicit def make(companion: DoubleChevronLeftLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DoubleChevronLeftLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
