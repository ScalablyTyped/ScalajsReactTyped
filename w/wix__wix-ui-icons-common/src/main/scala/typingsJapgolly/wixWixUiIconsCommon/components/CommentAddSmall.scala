...
object CommentAddSmall {
  ...
  implicit def make(companion: CommentAddSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CommentAddSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
