...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsLoyaltyPointsLargeMod.LoyaltyPointsLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object LoyaltyPointsLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "LoyaltyPointsLarge")
  @js.native
  ...
  implicit def make(companion: LoyaltyPointsLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LoyaltyPointsLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
