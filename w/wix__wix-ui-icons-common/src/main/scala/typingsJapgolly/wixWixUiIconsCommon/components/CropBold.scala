...
object CropBold {
  ...
  implicit def make(companion: CropBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CropBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
