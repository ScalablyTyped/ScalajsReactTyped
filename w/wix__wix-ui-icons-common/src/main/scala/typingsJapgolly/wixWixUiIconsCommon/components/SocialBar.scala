...
object SocialBar {
  ...
  implicit def make(companion: SocialBar.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SocialBarProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
