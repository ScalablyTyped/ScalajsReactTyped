...
object RedoBold {
  ...
  implicit def make(companion: RedoBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RedoBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
