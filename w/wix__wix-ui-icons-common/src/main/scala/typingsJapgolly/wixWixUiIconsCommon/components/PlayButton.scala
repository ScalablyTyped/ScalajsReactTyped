...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsPlayButtonMod.PlayButtonProps
...
object PlayButton {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "PlayButton")
  @js.native
  ...
  implicit def make(companion: PlayButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlayButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
