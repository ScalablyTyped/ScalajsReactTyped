...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSmileySmallMod.SmileySmallProps
...
object SmileySmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "SmileySmall")
  @js.native
  ...
  implicit def make(companion: SmileySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SmileySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
