...
object AdminAccessBold {
  ...
  implicit def make(companion: AdminAccessBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AdminAccessBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
