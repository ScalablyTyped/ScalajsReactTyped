...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsSoundOnMod.SoundOnProps
...
object SoundOn {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "SoundOn")
  @js.native
  ...
  implicit def make(companion: SoundOn.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SoundOnProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
