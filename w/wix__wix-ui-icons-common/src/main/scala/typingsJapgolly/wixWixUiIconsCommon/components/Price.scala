...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsPriceMod.PriceProps
...
object Price {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Price")
  @js.native
  ...
  implicit def make(companion: Price.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PriceProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
