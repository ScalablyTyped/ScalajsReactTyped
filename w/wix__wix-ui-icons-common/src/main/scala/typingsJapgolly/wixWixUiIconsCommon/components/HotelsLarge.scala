...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsHotelsLargeMod.HotelsLargeProps
...
object HotelsLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "HotelsLarge")
  @js.native
  ...
  implicit def make(companion: HotelsLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HotelsLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
