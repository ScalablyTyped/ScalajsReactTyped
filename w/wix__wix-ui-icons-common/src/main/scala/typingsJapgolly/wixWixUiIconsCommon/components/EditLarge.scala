...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsEditLargeMod.EditLargeProps
...
object EditLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "EditLarge")
  @js.native
  ...
  implicit def make(companion: EditLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EditLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
