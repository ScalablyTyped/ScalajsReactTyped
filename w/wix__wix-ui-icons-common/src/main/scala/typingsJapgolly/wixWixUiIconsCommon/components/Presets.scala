...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsPresetsMod.PresetsProps
...
object Presets {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "Presets")
  @js.native
  ...
  implicit def make(companion: Presets.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PresetsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
