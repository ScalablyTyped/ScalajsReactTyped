...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsBadgeFillMod.BadgeFillProps
...
object BadgeFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "BadgeFill")
  @js.native
  ...
  implicit def make(companion: BadgeFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BadgeFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
