...
object ESignatureBold {
  ...
  implicit def make(companion: ESignatureBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ESignatureBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
