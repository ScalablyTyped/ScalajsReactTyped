...
object TagSmall {
  ...
  implicit def make(companion: TagSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TagSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
