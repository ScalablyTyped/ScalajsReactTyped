...
object DownloadBold {
  ...
  implicit def make(companion: DownloadBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DownloadBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
