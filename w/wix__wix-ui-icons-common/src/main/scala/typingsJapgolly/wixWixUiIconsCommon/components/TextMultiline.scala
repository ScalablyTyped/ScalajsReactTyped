...
object TextMultiline {
  ...
  implicit def make(companion: TextMultiline.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextMultilineProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
