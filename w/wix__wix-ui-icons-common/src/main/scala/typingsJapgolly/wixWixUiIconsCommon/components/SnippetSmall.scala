...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsSnippetSmallMod.SnippetSmallProps
...
object SnippetSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "SnippetSmall")
  @js.native
  ...
  implicit def make(companion: SnippetSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SnippetSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
