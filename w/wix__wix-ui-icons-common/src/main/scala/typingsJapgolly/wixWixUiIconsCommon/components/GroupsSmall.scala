...
object GroupsSmall {
  ...
  implicit def make(companion: GroupsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GroupsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
