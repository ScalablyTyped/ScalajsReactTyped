...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsFaceSmiling30Mod.FaceSmiling30Props
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FaceSmiling30 {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "FaceSmiling30")
  @js.native
  ...
  implicit def make(companion: FaceSmiling30.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FaceSmiling30Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
