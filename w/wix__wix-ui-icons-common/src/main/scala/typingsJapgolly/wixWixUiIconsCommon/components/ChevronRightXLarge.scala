...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsChevronRightXLargeMod.ChevronRightXLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ChevronRightXLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ChevronRightXLarge")
  @js.native
  ...
  implicit def make(companion: ChevronRightXLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronRightXLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
