...
object Heading4 {
  ...
  implicit def make(companion: Heading4.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: Heading4Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
