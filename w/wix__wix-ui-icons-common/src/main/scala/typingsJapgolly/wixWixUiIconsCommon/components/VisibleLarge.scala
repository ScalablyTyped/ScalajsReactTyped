...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsVisibleLargeMod.VisibleLargeProps
...
object VisibleLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "VisibleLarge")
  @js.native
  ...
  implicit def make(companion: VisibleLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VisibleLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
