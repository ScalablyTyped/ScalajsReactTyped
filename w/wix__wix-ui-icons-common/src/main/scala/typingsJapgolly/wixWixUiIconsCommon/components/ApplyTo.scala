...
object ApplyTo {
  ...
  implicit def make(companion: ApplyTo.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ApplyToProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
