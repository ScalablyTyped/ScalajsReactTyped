...
object PhoneFilled {
  ...
  implicit def make(companion: PhoneFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PhoneFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
