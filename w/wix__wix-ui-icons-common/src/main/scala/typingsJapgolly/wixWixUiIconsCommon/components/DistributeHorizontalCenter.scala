...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsDistributeHorizontalCenterMod.DistributeHorizontalCenterProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DistributeHorizontalCenter {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "DistributeHorizontalCenter")
  @js.native
  ...
  implicit def make(companion: DistributeHorizontalCenter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DistributeHorizontalCenterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
