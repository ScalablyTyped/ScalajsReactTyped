...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsFaceFrowning30Mod.FaceFrowning30Props
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FaceFrowning30 {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "FaceFrowning30")
  @js.native
  ...
  implicit def make(companion: FaceFrowning30.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FaceFrowning30Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
