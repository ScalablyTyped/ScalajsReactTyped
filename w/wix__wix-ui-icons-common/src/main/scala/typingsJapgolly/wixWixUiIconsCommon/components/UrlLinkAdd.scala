...
object UrlLinkAdd {
  ...
  implicit def make(companion: UrlLinkAdd.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UrlLinkAddProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
