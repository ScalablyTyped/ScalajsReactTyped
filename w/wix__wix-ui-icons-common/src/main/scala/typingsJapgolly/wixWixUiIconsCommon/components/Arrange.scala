...
object Arrange {
  ...
  implicit def make(companion: Arrange.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArrangeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
