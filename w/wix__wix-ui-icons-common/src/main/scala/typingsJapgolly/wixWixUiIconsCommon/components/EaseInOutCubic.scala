...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEaseInOutCubicMod.EaseInOutCubicProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object EaseInOutCubic {
  ...
  implicit def make(companion: EaseInOutCubic.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EaseInOutCubicProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
