...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsBackToTopMod.BackToTopProps
...
object BackToTop {
  ...
  implicit def make(companion: BackToTop.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BackToTopProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
