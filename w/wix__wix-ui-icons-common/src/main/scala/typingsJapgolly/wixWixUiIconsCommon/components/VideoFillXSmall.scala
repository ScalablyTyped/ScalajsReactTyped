...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsVideoFillXSmallMod.VideoFillXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object VideoFillXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "VideoFillXSmall")
  @js.native
  ...
  implicit def make(companion: VideoFillXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VideoFillXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
