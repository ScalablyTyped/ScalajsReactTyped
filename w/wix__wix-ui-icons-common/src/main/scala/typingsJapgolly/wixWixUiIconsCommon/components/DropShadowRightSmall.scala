...
object DropShadowRightSmall {
  ...
  implicit def make(companion: DropShadowRightSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DropShadowRightSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
