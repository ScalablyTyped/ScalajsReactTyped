...
object UrlLinkBold {
  ...
  implicit def make(companion: UrlLinkBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UrlLinkBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
