...
object VectorBold {
  ...
  implicit def make(companion: VectorBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VectorBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
