...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsColorDropDisabledMod.ColorDropDisabledProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ColorDropDisabled {
  ...
  implicit def make(companion: ColorDropDisabled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ColorDropDisabledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
