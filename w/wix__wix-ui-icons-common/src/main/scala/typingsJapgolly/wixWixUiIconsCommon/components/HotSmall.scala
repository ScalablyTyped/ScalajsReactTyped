...
object HotSmall {
  ...
  implicit def make(companion: HotSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HotSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
