...
object BrowserBold {
  ...
  implicit def make(companion: BrowserBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BrowserBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
