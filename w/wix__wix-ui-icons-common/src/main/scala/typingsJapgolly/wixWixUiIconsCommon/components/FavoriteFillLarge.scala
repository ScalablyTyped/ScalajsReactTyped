...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsFavoriteFillLargeMod.FavoriteFillLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FavoriteFillLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "FavoriteFillLarge")
  @js.native
  ...
  implicit def make(companion: FavoriteFillLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FavoriteFillLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
