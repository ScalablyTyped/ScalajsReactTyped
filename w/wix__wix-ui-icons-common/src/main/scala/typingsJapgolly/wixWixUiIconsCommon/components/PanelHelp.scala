...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsPanelHelpMod.PanelHelpProps
...
object PanelHelp {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "PanelHelp")
  @js.native
  ...
  implicit def make(companion: PanelHelp.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PanelHelpProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
