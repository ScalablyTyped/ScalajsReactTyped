...
object FoodSmall {
  ...
  implicit def make(companion: FoodSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FoodSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
