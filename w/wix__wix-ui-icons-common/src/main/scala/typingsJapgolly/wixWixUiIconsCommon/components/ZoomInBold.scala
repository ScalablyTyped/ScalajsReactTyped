...
object ZoomInBold {
  ...
  implicit def make(companion: ZoomInBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ZoomInBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
