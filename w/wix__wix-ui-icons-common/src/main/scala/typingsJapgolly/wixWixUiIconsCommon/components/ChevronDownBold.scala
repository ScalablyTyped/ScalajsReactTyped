...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsChevronDownBoldMod.ChevronDownBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ChevronDownBold {
  ...
  implicit def make(companion: ChevronDownBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronDownBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
