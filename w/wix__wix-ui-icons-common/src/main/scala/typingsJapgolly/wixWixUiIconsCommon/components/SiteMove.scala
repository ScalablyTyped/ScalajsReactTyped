...
object SiteMove {
  ...
  implicit def make(companion: SiteMove.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SiteMoveProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
