...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEaseInOutQuadMod.EaseInOutQuadProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object EaseInOutQuad {
  ...
  implicit def make(companion: EaseInOutQuad.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EaseInOutQuadProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
