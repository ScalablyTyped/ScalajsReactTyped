...
object DateAndTimeSmall {
  ...
  implicit def make(companion: DateAndTimeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DateAndTimeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
