...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsOverlayBoldMod.OverlayBoldProps
...
object OverlayBold {
  ...
  implicit def make(companion: OverlayBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OverlayBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
