...
object DistributeGlobe {
  ...
  implicit def make(companion: DistributeGlobe.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DistributeGlobeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
