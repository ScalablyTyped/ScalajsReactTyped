...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsHistoryMod.HistoryProps
...
object History {
  ...
  implicit def make(companion: History.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HistoryProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
