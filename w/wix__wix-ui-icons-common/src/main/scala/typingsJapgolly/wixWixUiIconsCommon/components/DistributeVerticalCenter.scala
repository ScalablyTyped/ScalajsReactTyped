...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsDistributeVerticalCenterMod.DistributeVerticalCenterProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DistributeVerticalCenter {
  ...
  implicit def make(companion: DistributeVerticalCenter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DistributeVerticalCenterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
