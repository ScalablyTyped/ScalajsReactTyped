...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsFavoriteFillMod.FavoriteFillProps
...
object FavoriteFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "FavoriteFill")
  @js.native
  ...
  implicit def make(companion: FavoriteFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FavoriteFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
