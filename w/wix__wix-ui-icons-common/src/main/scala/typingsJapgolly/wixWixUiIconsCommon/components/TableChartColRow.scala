...
object TableChartColRow {
  ...
  implicit def make(companion: TableChartColRow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TableChartColRowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
