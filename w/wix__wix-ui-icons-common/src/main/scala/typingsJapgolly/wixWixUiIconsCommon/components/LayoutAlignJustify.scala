...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsLayoutAlignJustifyMod.LayoutAlignJustifyProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object LayoutAlignJustify {
  ...
  implicit def make(companion: LayoutAlignJustify.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutAlignJustifyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
