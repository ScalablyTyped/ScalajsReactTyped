...
object TextBoxBold {
  ...
  implicit def make(companion: TextBoxBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextBoxBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
