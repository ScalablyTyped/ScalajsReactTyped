...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsMobileLayoutMod.MobileLayoutProps
...
object MobileLayout {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "MobileLayout")
  @js.native
  ...
  implicit def make(companion: MobileLayout.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MobileLayoutProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
