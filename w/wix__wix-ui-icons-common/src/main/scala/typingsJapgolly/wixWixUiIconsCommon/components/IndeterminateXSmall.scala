...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsIndeterminateXSmallMod.IndeterminateXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object IndeterminateXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "IndeterminateXSmall")
  @js.native
  ...
  implicit def make(companion: IndeterminateXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: IndeterminateXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
