...
object UserFormBold {
  ...
  implicit def make(companion: UserFormBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserFormBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
