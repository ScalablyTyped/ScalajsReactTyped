...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsHorizontalSectionMod.HorizontalSectionProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object HorizontalSection {
  ...
  implicit def make(companion: HorizontalSection.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HorizontalSectionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
