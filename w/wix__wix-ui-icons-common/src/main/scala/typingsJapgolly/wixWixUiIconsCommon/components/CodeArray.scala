...
object CodeArray {
  ...
  implicit def make(companion: CodeArray.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CodeArrayProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
