...
object Minimise {
  ...
  implicit def make(companion: Minimise.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MinimiseProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
