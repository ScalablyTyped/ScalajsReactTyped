...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsMessengerMod.MessengerProps
...
object Messenger {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Messenger")
  @js.native
  ...
  implicit def make(companion: Messenger.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MessengerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
