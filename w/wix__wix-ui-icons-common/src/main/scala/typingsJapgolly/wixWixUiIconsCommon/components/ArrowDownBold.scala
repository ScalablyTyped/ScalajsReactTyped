...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsArrowDownBoldMod.ArrowDownBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ArrowDownBold {
  ...
  implicit def make(companion: ArrowDownBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArrowDownBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
