...
object SoundBold {
  ...
  implicit def make(companion: SoundBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SoundBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
