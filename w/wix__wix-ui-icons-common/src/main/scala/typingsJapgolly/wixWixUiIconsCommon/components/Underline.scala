...
object Underline {
  ...
  implicit def make(companion: Underline.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UnderlineProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
