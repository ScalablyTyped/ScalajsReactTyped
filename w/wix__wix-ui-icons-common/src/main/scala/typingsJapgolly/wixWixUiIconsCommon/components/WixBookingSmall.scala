...
object WixBookingSmall {
  ...
  implicit def make(companion: WixBookingSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixBookingSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
