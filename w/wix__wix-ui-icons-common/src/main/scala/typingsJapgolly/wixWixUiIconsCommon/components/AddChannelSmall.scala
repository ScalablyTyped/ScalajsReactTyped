...
object AddChannelSmall {
  ...
  implicit def make(companion: AddChannelSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddChannelSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
