...
object SquareRatioSmall {
  ...
  implicit def make(companion: SquareRatioSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SquareRatioSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
