...
object FileCss {
  ...
  implicit def make(companion: FileCss.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FileCssProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
