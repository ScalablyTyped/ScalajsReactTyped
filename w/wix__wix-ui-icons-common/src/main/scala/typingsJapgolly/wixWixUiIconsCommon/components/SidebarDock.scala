...
object SidebarDock {
  ...
  implicit def make(companion: SidebarDock.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SidebarDockProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
