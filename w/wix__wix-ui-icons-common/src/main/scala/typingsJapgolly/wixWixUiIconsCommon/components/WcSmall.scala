...
object WcSmall {
  ...
  implicit def make(companion: WcSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WcSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
