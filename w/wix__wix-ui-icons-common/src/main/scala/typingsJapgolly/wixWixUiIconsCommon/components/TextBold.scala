...
object TextBold {
  ...
  implicit def make(companion: TextBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
