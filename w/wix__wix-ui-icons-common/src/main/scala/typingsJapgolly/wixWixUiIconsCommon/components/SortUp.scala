...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsSortUpMod.SortUpProps
...
object SortUp {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "SortUp")
  @js.native
  ...
  implicit def make(companion: SortUp.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SortUpProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
