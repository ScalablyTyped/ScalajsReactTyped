...
object ZoomIn {
  ...
  implicit def make(companion: ZoomIn.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ZoomInProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
