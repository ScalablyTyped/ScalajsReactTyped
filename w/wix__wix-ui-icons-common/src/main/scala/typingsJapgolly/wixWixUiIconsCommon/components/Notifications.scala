...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsNotificationsMod.NotificationsProps
...
object Notifications {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Notifications")
  @js.native
