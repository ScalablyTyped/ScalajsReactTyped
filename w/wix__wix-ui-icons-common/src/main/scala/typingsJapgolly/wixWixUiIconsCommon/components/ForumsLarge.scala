...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsForumsLargeMod.ForumsLargeProps
...
object ForumsLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ForumsLarge")
  @js.native
  ...
  implicit def make(companion: ForumsLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ForumsLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
