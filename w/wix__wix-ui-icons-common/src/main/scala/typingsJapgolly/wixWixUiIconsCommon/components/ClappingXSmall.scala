...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsClappingXSmallMod.ClappingXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ClappingXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "ClappingXSmall")
  @js.native
  ...
  implicit def make(companion: ClappingXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ClappingXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
