...
object FileJson {
  ...
  implicit def make(companion: FileJson.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FileJsonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
