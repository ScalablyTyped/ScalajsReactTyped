...
object CheckboxListBold {
  ...
  implicit def make(companion: CheckboxListBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CheckboxListBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
