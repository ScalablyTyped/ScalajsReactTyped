...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsBoldSmallMod.BoldSmallProps
...
object BoldSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "BoldSmall")
  @js.native
  ...
  implicit def make(companion: BoldSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BoldSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
