...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsBugMod.BugProps
...
object Bug {
  ...
  implicit def make(companion: Bug.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BugProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
