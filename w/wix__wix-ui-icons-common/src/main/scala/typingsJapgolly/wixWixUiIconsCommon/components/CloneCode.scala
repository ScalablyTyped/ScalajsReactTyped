...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsCloneCodeMod.CloneCodeProps
...
object CloneCode {
  ...
  implicit def make(companion: CloneCode.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CloneCodeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
