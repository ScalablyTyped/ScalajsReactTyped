...
object VerticalRatio {
  ...
  implicit def make(companion: VerticalRatio.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VerticalRatioProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
