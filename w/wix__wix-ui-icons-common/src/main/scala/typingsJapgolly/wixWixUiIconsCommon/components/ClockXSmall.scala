...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsClockXSmallMod.ClockXSmallProps
...
object ClockXSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ClockXSmall")
  @js.native
  ...
  implicit def make(companion: ClockXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ClockXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
