...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsEventsSmallMod.EventsSmallProps
...
object EventsSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "EventsSmall")
  @js.native
  ...
  implicit def make(companion: EventsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EventsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
