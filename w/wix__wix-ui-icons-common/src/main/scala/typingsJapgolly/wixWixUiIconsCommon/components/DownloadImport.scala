...
object DownloadImport {
  ...
  implicit def make(companion: DownloadImport.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DownloadImportProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
