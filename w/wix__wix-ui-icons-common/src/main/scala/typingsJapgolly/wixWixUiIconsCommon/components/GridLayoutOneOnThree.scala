...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutOneOnThreeMod.GridLayoutOneOnThreeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutOneOnThree {
  ...
  implicit def make(companion: GridLayoutOneOnThree.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutOneOnThreeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
