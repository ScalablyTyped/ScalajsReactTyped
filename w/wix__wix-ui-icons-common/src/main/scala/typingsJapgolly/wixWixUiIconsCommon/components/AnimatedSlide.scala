...
object AnimatedSlide {
  ...
  implicit def make(companion: AnimatedSlide.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AnimatedSlideProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
