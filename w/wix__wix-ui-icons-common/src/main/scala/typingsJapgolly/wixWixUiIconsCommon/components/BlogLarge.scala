...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsBlogLargeMod.BlogLargeProps
...
object BlogLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "BlogLarge")
  @js.native
  ...
  implicit def make(companion: BlogLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BlogLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
