...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsMosaicMod.MosaicProps
...
object Mosaic {
  ...
  implicit def make(companion: Mosaic.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MosaicProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
