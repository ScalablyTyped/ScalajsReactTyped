...
object WarningSign {
  ...
  implicit def make(companion: WarningSign.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WarningSignProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
