...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsUserFillSmallMod.UserFillSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object UserFillSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "UserFillSmall")
  @js.native
  ...
  implicit def make(companion: UserFillSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserFillSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
