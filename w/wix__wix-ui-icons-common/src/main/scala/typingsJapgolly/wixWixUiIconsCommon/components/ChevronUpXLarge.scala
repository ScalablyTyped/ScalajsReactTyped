...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsChevronUpXLargeMod.ChevronUpXLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ChevronUpXLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ChevronUpXLarge")
  @js.native
  ...
  implicit def make(companion: ChevronUpXLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronUpXLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
