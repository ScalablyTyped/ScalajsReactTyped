...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsCopyStyleMod.CopyStyleProps
...
object CopyStyle {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "CopyStyle")
  @js.native
  ...
  implicit def make(companion: CopyStyle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CopyStyleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
