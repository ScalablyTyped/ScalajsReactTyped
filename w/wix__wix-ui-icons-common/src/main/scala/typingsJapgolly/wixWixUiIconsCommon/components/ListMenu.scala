...
object ListMenu {
  ...
  implicit def make(companion: ListMenu.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ListMenuProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
