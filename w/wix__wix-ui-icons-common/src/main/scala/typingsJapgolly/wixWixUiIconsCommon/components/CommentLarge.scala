...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsCommentLargeMod.CommentLargeProps
...
object CommentLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "CommentLarge")
  @js.native
  ...
  implicit def make(companion: CommentLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CommentLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
