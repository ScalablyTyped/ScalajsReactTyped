...
object GroupBold {
  ...
  implicit def make(companion: GroupBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GroupBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
