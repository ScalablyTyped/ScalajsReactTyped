...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsPlayButtonSmallMod.PlayButtonSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object PlayButtonSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "PlayButtonSmall")
  @js.native
  ...
  implicit def make(companion: PlayButtonSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlayButtonSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
