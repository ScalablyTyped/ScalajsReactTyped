...
object Child {
  ...
  implicit def make(companion: Child.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChildProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
