...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsPlusXSmallMod.PlusXSmallProps
...
object PlusXSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "PlusXSmall")
  @js.native
  ...
  implicit def make(companion: PlusXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlusXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
