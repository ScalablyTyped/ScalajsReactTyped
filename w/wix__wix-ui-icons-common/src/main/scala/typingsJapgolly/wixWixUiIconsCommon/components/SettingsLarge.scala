...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsSettingsLargeMod.SettingsLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SettingsLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "SettingsLarge")
  @js.native
  ...
  implicit def make(companion: SettingsLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SettingsLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
