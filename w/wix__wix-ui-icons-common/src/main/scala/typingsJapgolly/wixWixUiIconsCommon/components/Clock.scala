...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsClockMod.ClockProps
...
object Clock {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Clock")
  @js.native
  ...
  implicit def make(companion: Clock.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ClockProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
