...
object Highlights {
  ...
  implicit def make(companion: Highlights.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HighlightsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
