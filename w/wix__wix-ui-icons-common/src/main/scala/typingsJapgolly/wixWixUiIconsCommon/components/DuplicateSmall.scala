...
object DuplicateSmall {
  ...
  implicit def make(companion: DuplicateSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DuplicateSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
