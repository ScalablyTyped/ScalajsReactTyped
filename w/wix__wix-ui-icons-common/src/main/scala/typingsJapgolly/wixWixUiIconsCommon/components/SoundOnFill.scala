...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsSoundOnFillMod.SoundOnFillProps
...
object SoundOnFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "SoundOnFill")
  @js.native
  ...
  implicit def make(companion: SoundOnFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SoundOnFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
