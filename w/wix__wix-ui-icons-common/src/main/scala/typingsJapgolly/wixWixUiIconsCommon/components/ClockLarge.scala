...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsClockLargeMod.ClockLargeProps
...
object ClockLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ClockLarge")
  @js.native
  ...
  implicit def make(companion: ClockLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ClockLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
