...
object TextRtl {
  ...
  implicit def make(companion: TextRtl.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextRtlProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
