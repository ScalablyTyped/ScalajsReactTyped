...
object ExtraHotSmall {
  ...
  implicit def make(companion: ExtraHotSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExtraHotSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
