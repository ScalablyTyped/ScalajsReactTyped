...
object CodeBold {
  ...
  implicit def make(companion: CodeBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CodeBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
