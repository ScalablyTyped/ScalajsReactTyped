...
object BrightnessBold {
  ...
  implicit def make(companion: BrightnessBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BrightnessBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
