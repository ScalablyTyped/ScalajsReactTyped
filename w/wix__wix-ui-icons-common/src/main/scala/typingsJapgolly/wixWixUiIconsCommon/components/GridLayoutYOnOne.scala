...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutYOnOneMod.GridLayoutYOnOneProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutYOnOne {
  ...
  implicit def make(companion: GridLayoutYOnOne.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutYOnOneProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
