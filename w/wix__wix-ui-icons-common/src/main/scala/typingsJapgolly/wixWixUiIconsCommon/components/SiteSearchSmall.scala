...
object SiteSearchSmall {
  ...
  implicit def make(companion: SiteSearchSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SiteSearchSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
