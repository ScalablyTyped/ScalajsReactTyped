...
object ChatFilled {
  ...
  implicit def make(companion: ChatFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChatFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
