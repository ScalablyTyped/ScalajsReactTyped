...
object Custom {
  ...
  implicit def make(companion: Custom.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CustomProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
