...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsReelsMod.ReelsProps
...
object Reels {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Reels")
  @js.native
  ...
  implicit def make(companion: Reels.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ReelsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
