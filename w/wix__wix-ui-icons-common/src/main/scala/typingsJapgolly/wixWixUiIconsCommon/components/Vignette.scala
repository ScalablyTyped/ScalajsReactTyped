...
object Vignette {
  ...
  implicit def make(companion: Vignette.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VignetteProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
