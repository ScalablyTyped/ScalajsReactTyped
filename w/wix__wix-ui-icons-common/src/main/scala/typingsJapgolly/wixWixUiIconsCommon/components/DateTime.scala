...
object DateTime {
  ...
  implicit def make(companion: DateTime.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DateTimeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
