...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsInteractiveMod.InteractiveProps
...
object Interactive {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/responsive-editor/system", "Interactive")
  @js.native
  ...
  implicit def make(companion: Interactive.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InteractiveProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
