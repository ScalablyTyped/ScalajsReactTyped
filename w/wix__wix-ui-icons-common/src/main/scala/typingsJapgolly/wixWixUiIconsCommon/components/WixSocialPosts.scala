...
object WixSocialPosts {
  ...
  implicit def make(companion: WixSocialPosts.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixSocialPostsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
