...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsIncreaseIndentSmallMod.IncreaseIndentSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object IncreaseIndentSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "IncreaseIndentSmall")
  @js.native
  ...
  implicit def make(companion: IncreaseIndentSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: IncreaseIndentSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
