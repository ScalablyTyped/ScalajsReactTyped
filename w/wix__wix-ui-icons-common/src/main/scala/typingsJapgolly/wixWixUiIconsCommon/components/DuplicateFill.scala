...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsDuplicateFillMod.DuplicateFillProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DuplicateFill {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "DuplicateFill")
  @js.native
  ...
  implicit def make(companion: DuplicateFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DuplicateFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
