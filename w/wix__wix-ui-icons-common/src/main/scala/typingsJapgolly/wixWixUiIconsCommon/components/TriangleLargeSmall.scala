...
object TriangleLargeSmall {
  ...
  implicit def make(companion: TriangleLargeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TriangleLargeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
