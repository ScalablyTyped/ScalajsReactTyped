...
object LowerCase {
  ...
  implicit def make(companion: LowerCase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LowerCaseProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
