...
object AlignLeftSmall {
  ...
  implicit def make(companion: AlignLeftSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignLeftSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
