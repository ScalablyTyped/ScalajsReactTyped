...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsLockMod.LockProps
...
object Lock {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Lock")
  @js.native
  ...
  implicit def make(companion: Lock.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LockProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
