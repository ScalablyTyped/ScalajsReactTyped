...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsAngledArrowsSquareMod.AngledArrowsSquareProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object AngledArrowsSquare {
  ...
  implicit def make(companion: AngledArrowsSquare.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AngledArrowsSquareProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
