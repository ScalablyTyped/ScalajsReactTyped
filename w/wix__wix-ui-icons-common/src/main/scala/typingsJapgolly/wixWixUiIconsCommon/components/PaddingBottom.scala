...
object PaddingBottom {
  ...
  implicit def make(companion: PaddingBottom.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaddingBottomProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
