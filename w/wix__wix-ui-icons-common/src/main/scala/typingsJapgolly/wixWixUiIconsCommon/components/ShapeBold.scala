...
object ShapeBold {
  ...
  implicit def make(companion: ShapeBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShapeBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
