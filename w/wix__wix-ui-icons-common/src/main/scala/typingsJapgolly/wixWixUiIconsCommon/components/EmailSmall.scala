...
object EmailSmall {
  ...
  implicit def make(companion: EmailSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EmailSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
