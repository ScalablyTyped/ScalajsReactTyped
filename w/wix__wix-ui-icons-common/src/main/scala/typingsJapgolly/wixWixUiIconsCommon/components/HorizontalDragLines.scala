...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsHorizontalDragLinesMod.HorizontalDragLinesProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object HorizontalDragLines {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/responsive-editor/system", "HorizontalDragLines")
  @js.native
  ...
  implicit def make(companion: HorizontalDragLines.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HorizontalDragLinesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
