...
object TableChartRowSmall {
  ...
  implicit def make(companion: TableChartRowSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TableChartRowSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
