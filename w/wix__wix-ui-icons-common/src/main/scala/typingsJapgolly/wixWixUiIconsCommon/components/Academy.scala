...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsAcademyMod.AcademyProps
...
object Academy {
  ...
  implicit def make(companion: Academy.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AcademyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
