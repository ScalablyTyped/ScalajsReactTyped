...
object NumericListLeft {
  ...
  implicit def make(companion: NumericListLeft.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NumericListLeftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
