...
object Heading6 {
  ...
  implicit def make(companion: Heading6.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: Heading6Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
