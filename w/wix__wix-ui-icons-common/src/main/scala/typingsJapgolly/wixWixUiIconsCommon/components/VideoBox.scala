...
object VideoBox {
  ...
  implicit def make(companion: VideoBox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VideoBoxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
