...
object SlideShowBold {
  ...
  implicit def make(companion: SlideShowBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SlideShowBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
