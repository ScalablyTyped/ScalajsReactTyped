...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsCalendarMod.CalendarProps
...
object Calendar {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Calendar")
  @js.native
