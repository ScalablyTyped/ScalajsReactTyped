...
object SidebarDockSmall {
  ...
  implicit def make(companion: SidebarDockSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SidebarDockSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
