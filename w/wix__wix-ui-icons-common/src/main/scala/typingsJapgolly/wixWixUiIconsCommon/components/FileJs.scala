...
object FileJs {
  ...
  implicit def make(companion: FileJs.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FileJsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
