...
object AccessibilitySmall {
  ...
  implicit def make(companion: AccessibilitySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AccessibilitySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
