...
object RoundedCorner {
  ...
  implicit def make(companion: RoundedCorner.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RoundedCornerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
