...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSuspiciousMod.SuspiciousProps
...
object Suspicious {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "Suspicious")
  @js.native
  ...
  implicit def make(companion: Suspicious.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SuspiciousProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
