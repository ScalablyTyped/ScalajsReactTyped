...
object WhatsappSmall {
  ...
  implicit def make(companion: WhatsappSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WhatsappSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
