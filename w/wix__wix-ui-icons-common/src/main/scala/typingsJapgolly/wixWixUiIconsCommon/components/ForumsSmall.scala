...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsForumsSmallMod.ForumsSmallProps
...
object ForumsSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "ForumsSmall")
  @js.native
  ...
  implicit def make(companion: ForumsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ForumsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
