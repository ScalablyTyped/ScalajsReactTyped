...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsMovetoBackMod.MovetoBackProps
...
object MovetoBack {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "MovetoBack")
  @js.native
  ...
  implicit def make(companion: MovetoBack.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MovetoBackProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
