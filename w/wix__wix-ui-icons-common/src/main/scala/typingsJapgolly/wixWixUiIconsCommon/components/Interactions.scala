...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsInteractionsMod.InteractionsProps
...
object Interactions {
  ...
  implicit def make(companion: Interactions.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InteractionsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
