...
object MultiRowSmall {
  ...
  implicit def make(companion: MultiRowSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MultiRowSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
