...
object LoyaltySmall {
  ...
  implicit def make(companion: LoyaltySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LoyaltySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
