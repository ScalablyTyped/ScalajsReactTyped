...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsDoubleChevronRightLargeMod.DoubleChevronRightLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DoubleChevronRightLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "DoubleChevronRightLarge")
  @js.native
  ...
  implicit def make(companion: DoubleChevronRightLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DoubleChevronRightLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
