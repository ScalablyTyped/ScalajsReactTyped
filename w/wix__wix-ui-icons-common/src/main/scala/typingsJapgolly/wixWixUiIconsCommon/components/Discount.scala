...
object Discount {
  ...
  implicit def make(companion: Discount.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DiscountProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
