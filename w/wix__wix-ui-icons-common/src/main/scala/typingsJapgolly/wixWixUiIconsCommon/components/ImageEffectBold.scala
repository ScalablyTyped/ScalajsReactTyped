...
object ImageEffectBold {
  ...
  implicit def make(companion: ImageEffectBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ImageEffectBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
