...
object PinBold {
  ...
  implicit def make(companion: PinBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PinBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
