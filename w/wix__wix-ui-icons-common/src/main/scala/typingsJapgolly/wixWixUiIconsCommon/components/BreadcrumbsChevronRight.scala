...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsBreadcrumbsChevronRightMod.BreadcrumbsChevronRightProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object BreadcrumbsChevronRight {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "BreadcrumbsChevronRight")
  @js.native
  ...
  implicit def make(companion: BreadcrumbsChevronRight.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BreadcrumbsChevronRightProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
