...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutFourOnOneMod.GridLayoutFourOnOneProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutFourOnOne {
  ...
  implicit def make(companion: GridLayoutFourOnOne.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutFourOnOneProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
