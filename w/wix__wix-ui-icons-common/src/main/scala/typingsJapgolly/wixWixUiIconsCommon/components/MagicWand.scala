...
object MagicWand {
  ...
  implicit def make(companion: MagicWand.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MagicWandProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
