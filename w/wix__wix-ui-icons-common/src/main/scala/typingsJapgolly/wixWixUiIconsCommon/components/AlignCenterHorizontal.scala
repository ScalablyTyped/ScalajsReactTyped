...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsAlignCenterHorizontalMod.AlignCenterHorizontalProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object AlignCenterHorizontal {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "AlignCenterHorizontal")
  @js.native
  ...
  implicit def make(companion: AlignCenterHorizontal.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignCenterHorizontalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
