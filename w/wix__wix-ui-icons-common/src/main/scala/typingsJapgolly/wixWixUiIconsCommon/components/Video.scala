...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsVideoMod.VideoProps
...
object Video {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Video")
  @js.native
