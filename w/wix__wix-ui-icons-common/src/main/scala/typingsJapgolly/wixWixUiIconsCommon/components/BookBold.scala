...
object BookBold {
  ...
  implicit def make(companion: BookBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BookBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
