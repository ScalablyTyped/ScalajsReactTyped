...
object ImageEffect {
  ...
  implicit def make(companion: ImageEffect.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ImageEffectProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
