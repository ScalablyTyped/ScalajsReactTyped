...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSmileyTearsSmallMod.SmileyTearsSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SmileyTearsSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "SmileyTearsSmall")
  @js.native
  ...
  implicit def make(companion: SmileyTearsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SmileyTearsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
