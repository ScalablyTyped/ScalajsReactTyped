...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsMinusXSmallMod.MinusXSmallProps
...
object MinusXSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "MinusXSmall")
  @js.native
  ...
  implicit def make(companion: MinusXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MinusXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
