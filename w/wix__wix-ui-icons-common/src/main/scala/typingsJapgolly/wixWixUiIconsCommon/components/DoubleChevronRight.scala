...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsDoubleChevronRightMod.DoubleChevronRightProps
...
object DoubleChevronRight {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "DoubleChevronRight")
  @js.native
  ...
  implicit def make(companion: DoubleChevronRight.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DoubleChevronRightProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
