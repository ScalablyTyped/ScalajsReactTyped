...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsThumbDownMod.ThumbDownProps
...
object ThumbDown {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "ThumbDown")
  @js.native
  ...
  implicit def make(companion: ThumbDown.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ThumbDownProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
