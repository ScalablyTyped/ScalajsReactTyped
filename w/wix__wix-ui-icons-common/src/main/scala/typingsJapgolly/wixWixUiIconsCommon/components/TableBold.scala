...
object TableBold {
  ...
  implicit def make(companion: TableBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TableBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
