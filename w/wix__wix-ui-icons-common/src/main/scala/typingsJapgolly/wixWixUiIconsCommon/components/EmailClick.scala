...
object EmailClick {
  ...
  implicit def make(companion: EmailClick.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EmailClickProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
