...
object StatusIndeterminate {
  ...
  implicit def make(companion: StatusIndeterminate.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatusIndeterminateProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
