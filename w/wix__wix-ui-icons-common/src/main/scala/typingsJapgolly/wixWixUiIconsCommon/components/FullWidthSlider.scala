...
object FullWidthSlider {
  ...
  implicit def make(companion: FullWidthSlider.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FullWidthSliderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
