...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsTagFillSmallMod.TagFillSmallProps
...
object TagFillSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "TagFillSmall")
  @js.native
  ...
  implicit def make(companion: TagFillSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TagFillSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
