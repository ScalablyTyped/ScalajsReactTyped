...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsStartArrowMod.StartArrowProps
...
object StartArrow {
  ...
  implicit def make(companion: StartArrow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StartArrowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
