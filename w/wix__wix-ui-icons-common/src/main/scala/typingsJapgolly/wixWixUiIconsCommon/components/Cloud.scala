...
object Cloud {
  ...
  implicit def make(companion: Cloud.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CloudProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
