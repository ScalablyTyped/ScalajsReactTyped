...
object PaddingTop {
  ...
  implicit def make(companion: PaddingTop.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaddingTopProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
