...
object CheckroomSmall {
  ...
  implicit def make(companion: CheckroomSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CheckroomSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
