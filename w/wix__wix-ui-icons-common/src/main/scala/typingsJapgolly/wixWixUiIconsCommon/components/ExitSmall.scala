...
object ExitSmall {
  ...
  implicit def make(companion: ExitSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExitSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
