...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsChevronUpBoldMod.ChevronUpBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ChevronUpBold {
  ...
  implicit def make(companion: ChevronUpBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronUpBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
