...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsSlideShowVerticalMod.SlideShowVerticalProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SlideShowVertical {
  ...
  implicit def make(companion: SlideShowVertical.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SlideShowVerticalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
