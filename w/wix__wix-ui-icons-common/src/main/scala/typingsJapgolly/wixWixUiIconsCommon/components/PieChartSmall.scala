...
object PieChartSmall {
  ...
  implicit def make(companion: PieChartSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PieChartSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
