...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsBehaviorMod.BehaviorProps
...
object Behavior {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/responsive-editor/system", "Behavior")
  @js.native
  ...
  implicit def make(companion: Behavior.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BehaviorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
