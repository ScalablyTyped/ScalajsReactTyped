...
object Repeater {
  ...
  implicit def make(companion: Repeater.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RepeaterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
