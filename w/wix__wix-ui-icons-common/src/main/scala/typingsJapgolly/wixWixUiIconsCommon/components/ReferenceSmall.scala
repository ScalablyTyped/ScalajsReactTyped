...
object ReferenceSmall {
  ...
  implicit def make(companion: ReferenceSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ReferenceSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
