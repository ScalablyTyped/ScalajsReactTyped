...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsBuyNowMod.BuyNowProps
...
object BuyNow {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "BuyNow")
  @js.native
  ...
  implicit def make(companion: BuyNow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BuyNowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
