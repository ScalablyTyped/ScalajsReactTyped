...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEndArrowMod.EndArrowProps
...
object EndArrow {
  ...
  implicit def make(companion: EndArrow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EndArrowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
