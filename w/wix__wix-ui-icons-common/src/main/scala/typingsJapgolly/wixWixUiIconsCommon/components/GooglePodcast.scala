...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsGooglePodcastMod.GooglePodcastProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GooglePodcast {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "GooglePodcast")
  @js.native
  ...
  implicit def make(companion: GooglePodcast.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GooglePodcastProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
