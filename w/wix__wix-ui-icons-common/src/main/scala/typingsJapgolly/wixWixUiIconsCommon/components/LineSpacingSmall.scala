...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsLineSpacingSmallMod.LineSpacingSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object LineSpacingSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "LineSpacingSmall")
  @js.native
  ...
  implicit def make(companion: LineSpacingSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LineSpacingSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
