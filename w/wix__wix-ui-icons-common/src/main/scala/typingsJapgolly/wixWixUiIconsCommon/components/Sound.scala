...
object Sound {
  ...
  implicit def make(companion: Sound.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SoundProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
