...
object MirrorVerticalSmall {
  ...
  implicit def make(companion: MirrorVerticalSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MirrorVerticalSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
