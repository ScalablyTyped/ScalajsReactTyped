...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsPlusLargeMod.PlusLargeProps
...
object PlusLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "PlusLarge")
  @js.native
  ...
  implicit def make(companion: PlusLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlusLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
