...
object Vimeo {
  ...
  implicit def make(companion: Vimeo.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VimeoProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
