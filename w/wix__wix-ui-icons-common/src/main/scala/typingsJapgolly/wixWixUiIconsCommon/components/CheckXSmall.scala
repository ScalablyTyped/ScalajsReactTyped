...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsCheckXSmallMod.CheckXSmallProps
...
object CheckXSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "CheckXSmall")
  @js.native
  ...
  implicit def make(companion: CheckXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CheckXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
