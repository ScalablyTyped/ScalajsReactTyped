...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsElementsMod.ElementsProps
...
object Elements {
  ...
  def withProps(p: ElementsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
