...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEaseInCubicMod.EaseInCubicProps
...
object EaseInCubic {
  ...
  implicit def make(companion: EaseInCubic.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EaseInCubicProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
