...
object Backward {
  ...
  implicit def make(companion: Backward.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BackwardProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
