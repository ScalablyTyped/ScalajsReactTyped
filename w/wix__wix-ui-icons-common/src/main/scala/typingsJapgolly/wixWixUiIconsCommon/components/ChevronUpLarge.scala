...
object ChevronUpLarge {
  ...
  implicit def make(companion: ChevronUpLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronUpLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
