...
object TextBox {
  ...
  implicit def make(companion: TextBox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextBoxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
