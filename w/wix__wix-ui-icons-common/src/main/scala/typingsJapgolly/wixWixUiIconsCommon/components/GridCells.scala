...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridCellsMod.GridCellsProps
...
object GridCells {
  ...
  implicit def make(companion: GridCells.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridCellsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
