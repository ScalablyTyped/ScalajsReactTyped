...
object SelectionTool {
  ...
  implicit def make(companion: SelectionTool.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SelectionToolProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
