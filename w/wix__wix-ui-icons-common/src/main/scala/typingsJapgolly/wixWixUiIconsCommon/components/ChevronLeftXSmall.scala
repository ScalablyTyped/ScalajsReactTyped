...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsChevronLeftXSmallMod.ChevronLeftXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ChevronLeftXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ChevronLeftXSmall")
  @js.native
  ...
  implicit def make(companion: ChevronLeftXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronLeftXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
