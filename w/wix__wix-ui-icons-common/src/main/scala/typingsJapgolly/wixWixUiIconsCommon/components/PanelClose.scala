...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsPanelCloseMod.PanelCloseProps
...
object PanelClose {
  ...
  implicit def make(companion: PanelClose.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PanelCloseProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
