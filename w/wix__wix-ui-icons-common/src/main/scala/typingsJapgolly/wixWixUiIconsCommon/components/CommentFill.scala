...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsCommentFillMod.CommentFillProps
...
object CommentFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "CommentFill")
  @js.native
  ...
  implicit def make(companion: CommentFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CommentFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
