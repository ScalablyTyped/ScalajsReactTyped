...
object SuccessSmall {
  ...
  implicit def make(companion: SuccessSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SuccessSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
