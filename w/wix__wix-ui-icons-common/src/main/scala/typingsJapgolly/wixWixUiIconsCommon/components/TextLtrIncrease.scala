...
object TextLtrIncrease {
  ...
  implicit def make(companion: TextLtrIncrease.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextLtrIncreaseProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
