...
object ArchiveSmall {
  ...
  implicit def make(companion: ArchiveSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArchiveSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
