...
object MultipleChoices {
  ...
  implicit def make(companion: MultipleChoices.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MultipleChoicesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
