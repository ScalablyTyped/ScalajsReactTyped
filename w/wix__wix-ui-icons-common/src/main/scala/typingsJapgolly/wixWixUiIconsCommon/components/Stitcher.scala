...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsStitcherMod.StitcherProps
...
object Stitcher {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Stitcher")
  @js.native
  ...
  implicit def make(companion: Stitcher.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StitcherProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
