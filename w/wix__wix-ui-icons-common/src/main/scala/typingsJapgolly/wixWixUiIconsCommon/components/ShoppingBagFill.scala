...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsShoppingBagFillMod.ShoppingBagFillProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ShoppingBagFill {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "ShoppingBagFill")
  @js.native
  ...
  implicit def make(companion: ShoppingBagFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShoppingBagFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
