...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsBreakpointsMod.BreakpointsProps
...
object Breakpoints {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/responsive-editor/system", "Breakpoints")
  @js.native
  ...
  implicit def make(companion: Breakpoints.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BreakpointsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
