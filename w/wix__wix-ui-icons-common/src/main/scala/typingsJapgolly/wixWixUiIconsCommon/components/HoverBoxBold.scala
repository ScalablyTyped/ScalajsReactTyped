...
object HoverBoxBold {
  ...
  implicit def make(companion: HoverBoxBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HoverBoxBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
