...
object RenameSmall {
  ...
  implicit def make(companion: RenameSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RenameSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
