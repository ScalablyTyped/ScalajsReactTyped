...
object HelpBold {
  ...
  implicit def make(companion: HelpBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HelpBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
