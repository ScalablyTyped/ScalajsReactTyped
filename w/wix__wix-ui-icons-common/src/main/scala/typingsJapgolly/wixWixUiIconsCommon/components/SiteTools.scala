...
object SiteTools {
  ...
  implicit def make(companion: SiteTools.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SiteToolsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
