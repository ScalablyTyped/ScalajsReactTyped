...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutFourOnTwoMod.GridLayoutFourOnTwoProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutFourOnTwo {
  ...
  implicit def make(companion: GridLayoutFourOnTwo.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutFourOnTwoProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
