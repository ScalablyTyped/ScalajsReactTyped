...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsAngrySmallMod.AngrySmallProps
...
object AngrySmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "AngrySmall")
  @js.native
  ...
  implicit def make(companion: AngrySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AngrySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
