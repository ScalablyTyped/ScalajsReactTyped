...
object ColumnBold {
  ...
  implicit def make(companion: ColumnBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ColumnBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
