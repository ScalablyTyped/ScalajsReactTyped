...
object WixHotels {
  ...
  implicit def make(companion: WixHotels.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixHotelsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
