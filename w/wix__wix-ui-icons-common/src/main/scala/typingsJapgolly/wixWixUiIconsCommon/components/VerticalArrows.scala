...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsVerticalArrowsMod.VerticalArrowsProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object VerticalArrows {
  ...
  implicit def make(companion: VerticalArrows.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VerticalArrowsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
