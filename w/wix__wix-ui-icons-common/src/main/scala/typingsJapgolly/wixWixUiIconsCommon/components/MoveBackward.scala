...
object MoveBackward {
  ...
  implicit def make(companion: MoveBackward.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MoveBackwardProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
