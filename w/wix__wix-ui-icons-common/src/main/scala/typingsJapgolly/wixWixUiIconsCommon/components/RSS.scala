...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsRssMod.RSSProps
...
object RSS {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "RSS")
  @js.native
  ...
  implicit def make(companion: RSS.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RSSProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
