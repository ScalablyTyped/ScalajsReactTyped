...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsAnimationsScrollMod.AnimationsScrollProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object AnimationsScroll {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "AnimationsScroll")
  @js.native
  ...
  implicit def make(companion: AnimationsScroll.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AnimationsScrollProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
