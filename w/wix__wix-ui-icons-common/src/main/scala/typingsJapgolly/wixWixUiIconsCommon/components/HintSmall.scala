...
object HintSmall {
  ...
  implicit def make(companion: HintSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HintSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
