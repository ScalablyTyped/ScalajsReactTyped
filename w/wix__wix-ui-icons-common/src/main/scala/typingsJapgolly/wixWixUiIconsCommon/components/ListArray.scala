...
object ListArray {
  ...
  implicit def make(companion: ListArray.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ListArrayProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
