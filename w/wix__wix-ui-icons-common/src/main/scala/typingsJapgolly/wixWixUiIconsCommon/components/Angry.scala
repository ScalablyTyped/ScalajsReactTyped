...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsAngryMod.AngryProps
...
object Angry {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "Angry")
  @js.native
  ...
  implicit def make(companion: Angry.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AngryProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
