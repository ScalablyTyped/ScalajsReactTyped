...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutTwoOnThreeMod.GridLayoutTwoOnThreeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutTwoOnThree {
  ...
  implicit def make(companion: GridLayoutTwoOnThree.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutTwoOnThreeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
