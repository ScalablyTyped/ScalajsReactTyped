...
object TikTok {
  ...
  implicit def make(companion: TikTok.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TikTokProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
