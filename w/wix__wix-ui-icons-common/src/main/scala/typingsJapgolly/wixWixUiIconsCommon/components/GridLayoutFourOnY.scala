...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutFourOnYMod.GridLayoutFourOnYProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutFourOnY {
  ...
  implicit def make(companion: GridLayoutFourOnY.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutFourOnYProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
