...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsDocumentLargeMod.DocumentLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DocumentLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "DocumentLarge")
  @js.native
  ...
  implicit def make(companion: DocumentLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DocumentLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
