...
object VerticalMenuBold {
  ...
  implicit def make(companion: VerticalMenuBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VerticalMenuBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
