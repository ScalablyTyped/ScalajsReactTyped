...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsColorMod.ColorProps
...
object Color {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "Color")
  @js.native
