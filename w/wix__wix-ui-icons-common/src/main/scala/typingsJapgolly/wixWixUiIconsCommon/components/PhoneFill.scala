...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsPhoneFillMod.PhoneFillProps
...
object PhoneFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "PhoneFill")
  @js.native
  ...
  implicit def make(companion: PhoneFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PhoneFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
