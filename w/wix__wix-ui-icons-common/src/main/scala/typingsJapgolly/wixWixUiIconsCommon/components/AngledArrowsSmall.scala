...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsAngledArrowsSmallMod.AngledArrowsSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object AngledArrowsSmall {
  ...
  implicit def make(companion: AngledArrowsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AngledArrowsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
