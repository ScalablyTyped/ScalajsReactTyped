...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsIncreaseFontMod.IncreaseFontProps
...
object IncreaseFont {
  ...
  implicit def make(companion: IncreaseFont.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: IncreaseFontProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
