...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsAppMarketNewMod.AppMarketNewProps
...
object AppMarketNew {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "AppMarketNew")
  @js.native
  ...
  implicit def make(companion: AppMarketNew.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AppMarketNewProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
