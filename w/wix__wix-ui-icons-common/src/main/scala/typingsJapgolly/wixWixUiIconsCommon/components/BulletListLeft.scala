...
object BulletListLeft {
  ...
  implicit def make(companion: BulletListLeft.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BulletListLeftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
