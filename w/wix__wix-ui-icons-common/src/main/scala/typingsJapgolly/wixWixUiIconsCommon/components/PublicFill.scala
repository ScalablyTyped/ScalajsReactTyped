...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsPublicFillMod.PublicFillProps
...
object PublicFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "PublicFill")
  @js.native
  ...
  implicit def make(companion: PublicFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PublicFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
