...
object LockUnlockedBold {
  ...
  implicit def make(companion: LockUnlockedBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LockUnlockedBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
