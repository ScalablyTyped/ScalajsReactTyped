...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsPodcastMod.PodcastProps
...
object Podcast {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Podcast")
  @js.native
  ...
  implicit def make(companion: Podcast.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PodcastProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
