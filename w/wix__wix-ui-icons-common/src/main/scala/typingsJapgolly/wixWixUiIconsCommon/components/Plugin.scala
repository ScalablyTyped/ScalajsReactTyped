...
object Plugin {
  ...
  implicit def make(companion: Plugin.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PluginProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
