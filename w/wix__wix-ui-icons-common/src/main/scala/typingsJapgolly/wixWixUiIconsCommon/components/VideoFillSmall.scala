...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsVideoFillSmallMod.VideoFillSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object VideoFillSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "VideoFillSmall")
  @js.native
  ...
  implicit def make(companion: VideoFillSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VideoFillSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
