...
object Google {
  ...
  implicit def make(companion: Google.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GoogleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
