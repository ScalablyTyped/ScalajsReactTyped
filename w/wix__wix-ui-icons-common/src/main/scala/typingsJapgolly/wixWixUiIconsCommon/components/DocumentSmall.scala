...
object DocumentSmall {
  ...
  implicit def make(companion: DocumentSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DocumentSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
