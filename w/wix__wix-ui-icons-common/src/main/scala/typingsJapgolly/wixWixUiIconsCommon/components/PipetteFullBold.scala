...
object PipetteFullBold {
  ...
  implicit def make(companion: PipetteFullBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PipetteFullBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
