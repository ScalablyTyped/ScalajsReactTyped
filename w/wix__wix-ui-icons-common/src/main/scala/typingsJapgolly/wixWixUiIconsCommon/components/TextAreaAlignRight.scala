...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsTextAreaAlignRightMod.TextAreaAlignRightProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextAreaAlignRight {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "TextAreaAlignRight")
  @js.native
  ...
  implicit def make(companion: TextAreaAlignRight.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaAlignRightProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
