...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsPlayButtonFillSmallMod.PlayButtonFillSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object PlayButtonFillSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "PlayButtonFillSmall")
  @js.native
  ...
  implicit def make(companion: PlayButtonFillSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlayButtonFillSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
