...
object DocSend {
  ...
  implicit def make(companion: DocSend.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DocSendProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
