...
object Blogger {
  ...
  implicit def make(companion: Blogger.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BloggerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
