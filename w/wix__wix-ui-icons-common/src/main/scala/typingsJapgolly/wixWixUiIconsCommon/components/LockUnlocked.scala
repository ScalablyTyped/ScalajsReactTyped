...
object LockUnlocked {
  ...
  implicit def make(companion: LockUnlocked.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LockUnlockedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
