...
object GlobeSmall {
  ...
  implicit def make(companion: GlobeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GlobeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
