...
object DateTimeBold {
  ...
  implicit def make(companion: DateTimeBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DateTimeBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
