...
object PhotoCamera {
  ...
  implicit def make(companion: PhotoCamera.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PhotoCameraProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
