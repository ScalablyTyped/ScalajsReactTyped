...
object Heading5 {
  ...
  implicit def make(companion: Heading5.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: Heading5Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
