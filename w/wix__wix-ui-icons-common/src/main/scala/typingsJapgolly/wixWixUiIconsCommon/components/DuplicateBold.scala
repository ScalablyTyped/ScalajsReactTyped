...
object DuplicateBold {
  ...
  implicit def make(companion: DuplicateBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DuplicateBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
