...
object Bow {
  ...
  implicit def make(companion: Bow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
