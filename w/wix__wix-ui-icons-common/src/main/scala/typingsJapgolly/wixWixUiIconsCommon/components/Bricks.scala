...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsBricksMod.BricksProps
...
object Bricks {
  ...
  implicit def make(companion: Bricks.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BricksProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
