...
object MoveForwardBold {
  ...
  implicit def make(companion: MoveForwardBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MoveForwardBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
