...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsChevronLeftXLargeMod.ChevronLeftXLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ChevronLeftXLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ChevronLeftXLarge")
  @js.native
  ...
  implicit def make(companion: ChevronLeftXLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronLeftXLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
