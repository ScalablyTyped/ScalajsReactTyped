...
object FlagFindSmall {
  ...
  implicit def make(companion: FlagFindSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlagFindSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
