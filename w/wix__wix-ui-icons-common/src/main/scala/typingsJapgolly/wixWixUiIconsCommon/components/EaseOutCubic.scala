...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEaseOutCubicMod.EaseOutCubicProps
...
object EaseOutCubic {
  ...
  implicit def make(companion: EaseOutCubic.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EaseOutCubicProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
