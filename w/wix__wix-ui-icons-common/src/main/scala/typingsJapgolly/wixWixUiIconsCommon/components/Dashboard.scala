...
object Dashboard {
  ...
  implicit def make(companion: Dashboard.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DashboardProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
