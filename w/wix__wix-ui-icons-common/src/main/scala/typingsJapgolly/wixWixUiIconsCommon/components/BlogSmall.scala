...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsBlogSmallMod.BlogSmallProps
...
object BlogSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "BlogSmall")
  @js.native
  ...
  implicit def make(companion: BlogSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BlogSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
