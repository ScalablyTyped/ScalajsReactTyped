...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsTypographyDisabledMod.TypographyDisabledProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TypographyDisabled {
  ...
  implicit def make(companion: TypographyDisabled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TypographyDisabledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
