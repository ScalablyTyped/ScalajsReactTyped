...
object PaddingHorizontal {
  ...
  implicit def make(companion: PaddingHorizontal.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaddingHorizontalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
