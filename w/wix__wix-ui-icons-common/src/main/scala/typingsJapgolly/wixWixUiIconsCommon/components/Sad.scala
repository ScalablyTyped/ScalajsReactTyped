...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSadMod.SadProps
...
object Sad {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "Sad")
  @js.native
  ...
  implicit def make(companion: Sad.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SadProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
