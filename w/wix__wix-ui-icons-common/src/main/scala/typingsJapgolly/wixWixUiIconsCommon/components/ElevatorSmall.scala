...
object ElevatorSmall {
  ...
  implicit def make(companion: ElevatorSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ElevatorSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
