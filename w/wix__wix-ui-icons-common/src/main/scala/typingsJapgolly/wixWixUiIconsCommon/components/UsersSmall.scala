...
object UsersSmall {
  ...
  implicit def make(companion: UsersSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UsersSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
