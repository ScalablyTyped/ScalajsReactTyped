...
object SortAZ {
  ...
  implicit def make(companion: SortAZ.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SortAZProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
