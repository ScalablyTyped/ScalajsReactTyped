...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsCheckSmallMod.CheckSmallProps
...
object CheckSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "CheckSmall")
  @js.native
  ...
  implicit def make(companion: CheckSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CheckSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
