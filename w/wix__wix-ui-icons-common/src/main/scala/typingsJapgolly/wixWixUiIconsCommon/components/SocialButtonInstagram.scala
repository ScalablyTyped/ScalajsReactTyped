...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsSocialButtonInstagramMod.SocialButtonInstagramProps
...
object SocialButtonInstagram {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "SocialButtonInstagram")
  @js.native
