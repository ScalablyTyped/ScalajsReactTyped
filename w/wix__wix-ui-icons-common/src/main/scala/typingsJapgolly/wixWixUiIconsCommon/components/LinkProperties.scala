...
object LinkProperties {
  ...
  implicit def make(companion: LinkProperties.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LinkPropertiesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
