...
object UserAdd {
  ...
  implicit def make(companion: UserAdd.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserAddProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
