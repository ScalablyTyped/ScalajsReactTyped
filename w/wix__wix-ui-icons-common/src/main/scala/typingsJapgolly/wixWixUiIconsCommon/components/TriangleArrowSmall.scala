...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsTriangleArrowSmallMod.TriangleArrowSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TriangleArrowSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "TriangleArrowSmall")
  @js.native
  ...
  implicit def make(companion: TriangleArrowSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TriangleArrowSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
