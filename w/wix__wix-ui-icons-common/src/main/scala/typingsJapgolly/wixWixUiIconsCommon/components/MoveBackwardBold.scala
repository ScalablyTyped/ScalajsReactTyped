...
object MoveBackwardBold {
  ...
  implicit def make(companion: MoveBackwardBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MoveBackwardBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
