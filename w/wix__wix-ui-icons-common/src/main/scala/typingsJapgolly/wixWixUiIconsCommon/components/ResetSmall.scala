...
object ResetSmall {
  ...
  implicit def make(companion: ResetSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ResetSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
