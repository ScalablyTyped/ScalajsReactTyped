...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsLikeMod.LikeProps
...
object Like {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Like")
  @js.native
  ...
  implicit def make(companion: Like.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LikeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
