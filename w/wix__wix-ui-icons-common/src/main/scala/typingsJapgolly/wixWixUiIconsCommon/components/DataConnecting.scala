...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsDataConnectingMod.DataConnectingProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DataConnecting {
  ...
  implicit def make(companion: DataConnecting.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DataConnectingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
