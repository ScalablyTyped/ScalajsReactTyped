...
object SettingsLocked {
  ...
  implicit def make(companion: SettingsLocked.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SettingsLockedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
