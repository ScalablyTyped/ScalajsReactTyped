...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsExploreMod.ExploreProps
...
object Explore {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Explore")
  @js.native
  ...
  implicit def make(companion: Explore.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExploreProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
