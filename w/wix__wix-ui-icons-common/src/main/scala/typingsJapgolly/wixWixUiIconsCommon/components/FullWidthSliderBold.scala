...
object FullWidthSliderBold {
  ...
  implicit def make(companion: FullWidthSliderBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FullWidthSliderBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
