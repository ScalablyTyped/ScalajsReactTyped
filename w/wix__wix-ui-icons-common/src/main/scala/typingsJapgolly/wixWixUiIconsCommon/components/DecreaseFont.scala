...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsDecreaseFontMod.DecreaseFontProps
...
object DecreaseFont {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "DecreaseFont")
  @js.native
  ...
  implicit def make(companion: DecreaseFont.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DecreaseFontProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
