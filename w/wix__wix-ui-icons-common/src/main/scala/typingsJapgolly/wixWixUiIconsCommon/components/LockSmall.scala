...
object LockSmall {
  ...
  implicit def make(companion: LockSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LockSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
