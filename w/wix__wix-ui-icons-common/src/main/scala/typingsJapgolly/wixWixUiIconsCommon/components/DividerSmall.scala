...
object DividerSmall {
  ...
  implicit def make(companion: DividerSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DividerSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
