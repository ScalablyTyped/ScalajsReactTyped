...
object ConfirmBold {
  ...
  implicit def make(companion: ConfirmBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ConfirmBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
