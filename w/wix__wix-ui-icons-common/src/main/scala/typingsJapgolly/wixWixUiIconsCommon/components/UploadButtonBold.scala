...
object UploadButtonBold {
  ...
  implicit def make(companion: UploadButtonBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UploadButtonBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
