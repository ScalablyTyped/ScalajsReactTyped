...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsNotificationsFillMod.NotificationsFillProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object NotificationsFill {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "NotificationsFill")
  @js.native
  ...
  implicit def make(companion: NotificationsFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NotificationsFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
