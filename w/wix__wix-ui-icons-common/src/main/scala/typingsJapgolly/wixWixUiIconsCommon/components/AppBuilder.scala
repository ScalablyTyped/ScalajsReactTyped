...
object AppBuilder {
  ...
  implicit def make(companion: AppBuilder.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AppBuilderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
