...
object JS {
  ...
  implicit def make(companion: JS.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: JSProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
