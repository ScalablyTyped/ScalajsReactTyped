...
object HeartBold {
  ...
  implicit def make(companion: HeartBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HeartBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
