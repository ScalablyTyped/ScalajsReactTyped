...
object Objects {
  ...
  implicit def make(companion: Objects.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ObjectsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
