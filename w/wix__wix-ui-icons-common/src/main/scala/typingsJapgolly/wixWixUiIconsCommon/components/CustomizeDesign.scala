...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsCustomizeDesignMod.CustomizeDesignProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object CustomizeDesign {
  ...
  implicit def make(companion: CustomizeDesign.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CustomizeDesignProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
