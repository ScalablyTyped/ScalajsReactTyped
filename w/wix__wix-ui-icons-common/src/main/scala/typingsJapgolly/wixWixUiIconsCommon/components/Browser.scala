...
object Browser {
  ...
  implicit def make(companion: Browser.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BrowserProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
