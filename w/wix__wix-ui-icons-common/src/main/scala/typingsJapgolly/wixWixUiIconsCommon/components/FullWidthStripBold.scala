...
object FullWidthStripBold {
  ...
  implicit def make(companion: FullWidthStripBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FullWidthStripBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
