...
object UrlLink {
  ...
  implicit def make(companion: UrlLink.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UrlLinkProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
