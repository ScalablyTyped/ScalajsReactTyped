...
object AlertSmall {
  ...
  implicit def make(companion: AlertSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlertSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
