...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsImageFilterMod.ImageFilterProps
...
object ImageFilter {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "ImageFilter")
  @js.native
  ...
  implicit def make(companion: ImageFilter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ImageFilterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
