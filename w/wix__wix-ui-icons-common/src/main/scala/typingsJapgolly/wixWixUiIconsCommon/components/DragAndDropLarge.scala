...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsDragAndDropLargeMod.DragAndDropLargeProps
...
object DragAndDropLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "DragAndDropLarge")
  @js.native
