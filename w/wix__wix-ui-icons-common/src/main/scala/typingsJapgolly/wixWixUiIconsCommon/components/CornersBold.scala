...
object CornersBold {
  ...
  implicit def make(companion: CornersBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CornersBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
