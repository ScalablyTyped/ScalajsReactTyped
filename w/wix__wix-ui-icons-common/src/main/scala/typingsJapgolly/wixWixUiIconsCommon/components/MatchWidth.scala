...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsMatchWidthMod.MatchWidthProps
...
object MatchWidth {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "MatchWidth")
  @js.native
  ...
  implicit def make(companion: MatchWidth.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MatchWidthProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
