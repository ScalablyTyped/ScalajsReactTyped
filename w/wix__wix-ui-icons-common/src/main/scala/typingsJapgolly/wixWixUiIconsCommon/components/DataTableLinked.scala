...
object DataTableLinked {
  ...
  implicit def make(companion: DataTableLinked.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DataTableLinkedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
