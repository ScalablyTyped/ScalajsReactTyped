...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsCameraFillMod.CameraFillProps
...
object CameraFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "CameraFill")
  @js.native
  ...
  implicit def make(companion: CameraFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CameraFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
