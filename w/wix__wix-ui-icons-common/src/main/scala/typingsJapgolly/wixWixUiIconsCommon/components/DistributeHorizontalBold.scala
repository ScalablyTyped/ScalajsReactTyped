...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsDistributeHorizontalBoldMod.DistributeHorizontalBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DistributeHorizontalBold {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/responsive-editor/system", "DistributeHorizontalBold")
  @js.native
  ...
  implicit def make(companion: DistributeHorizontalBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DistributeHorizontalBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
