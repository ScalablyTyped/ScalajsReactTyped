...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsLockFillMod.LockFillProps
...
object LockFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "LockFill")
  @js.native
  ...
  implicit def make(companion: LockFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LockFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
