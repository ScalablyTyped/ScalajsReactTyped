...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsAdminFillMod.AdminFillProps
...
object AdminFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "AdminFill")
  @js.native
  ...
  implicit def make(companion: AdminFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AdminFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
