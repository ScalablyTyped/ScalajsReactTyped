...
object Enter {
  ...
  implicit def make(companion: Enter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EnterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
