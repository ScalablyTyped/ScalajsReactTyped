...
object Contrast {
  ...
  implicit def make(companion: Contrast.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ContrastProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
