...
object DismissBold {
  ...
  implicit def make(companion: DismissBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DismissBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
