...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsBookingsLargeMod.BookingsLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object BookingsLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "BookingsLarge")
  @js.native
  ...
  implicit def make(companion: BookingsLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BookingsLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
