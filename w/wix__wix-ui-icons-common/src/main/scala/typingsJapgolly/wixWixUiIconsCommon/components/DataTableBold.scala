...
object DataTableBold {
  ...
  implicit def make(companion: DataTableBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DataTableBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
