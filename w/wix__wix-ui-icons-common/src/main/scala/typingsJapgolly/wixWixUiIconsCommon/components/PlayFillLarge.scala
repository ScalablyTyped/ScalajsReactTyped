...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsPlayFillLargeMod.PlayFillLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object PlayFillLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "PlayFillLarge")
  @js.native
  ...
  implicit def make(companion: PlayFillLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlayFillLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
