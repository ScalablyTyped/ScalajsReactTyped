...
object GlutenFree {
  ...
  implicit def make(companion: GlutenFree.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GlutenFreeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
