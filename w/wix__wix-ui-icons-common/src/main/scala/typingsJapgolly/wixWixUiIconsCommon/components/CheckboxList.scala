...
object CheckboxList {
  ...
  implicit def make(companion: CheckboxList.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CheckboxListProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
