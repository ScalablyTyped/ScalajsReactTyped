...
object MediaProofingSmall {
  ...
  implicit def make(companion: MediaProofingSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MediaProofingSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
