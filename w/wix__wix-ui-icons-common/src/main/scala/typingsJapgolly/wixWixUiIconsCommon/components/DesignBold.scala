...
object DesignBold {
  ...
  implicit def make(companion: DesignBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DesignBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
