...
object AddressInputBold {
  ...
  implicit def make(companion: AddressInputBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddressInputBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
