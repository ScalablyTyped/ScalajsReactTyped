...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsHorizontalDragHandleMod.HorizontalDragHandleProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object HorizontalDragHandle {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "HorizontalDragHandle")
  @js.native
  ...
  implicit def make(companion: HorizontalDragHandle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HorizontalDragHandleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
