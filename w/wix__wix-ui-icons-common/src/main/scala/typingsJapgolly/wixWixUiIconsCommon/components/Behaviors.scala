...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsBehaviorsMod.BehaviorsProps
...
object Behaviors {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "Behaviors")
  @js.native
  ...
  implicit def make(companion: Behaviors.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BehaviorsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
