...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsCircleLoaderCheckMod.CircleLoaderCheckProps
...
object CircleLoaderCheck {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "CircleLoaderCheck")
  @js.native
