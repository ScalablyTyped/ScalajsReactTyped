...
object ITunes {
  ...
  implicit def make(companion: ITunes.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ITunesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
