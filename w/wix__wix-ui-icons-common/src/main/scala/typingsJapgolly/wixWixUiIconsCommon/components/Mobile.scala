...
object Mobile {
  ...
  implicit def make(companion: Mobile.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MobileProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
