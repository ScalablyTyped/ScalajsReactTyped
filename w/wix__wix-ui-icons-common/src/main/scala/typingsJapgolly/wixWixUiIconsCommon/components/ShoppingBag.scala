...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsShoppingBagMod.ShoppingBagProps
...
object ShoppingBag {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "ShoppingBag")
  @js.native
  ...
  implicit def make(companion: ShoppingBag.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShoppingBagProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
