...
object LinkPropertiesSmall {
  ...
  implicit def make(companion: LinkPropertiesSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LinkPropertiesSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
