...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsDeleteLargeMod.DeleteLargeProps
...
object DeleteLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "DeleteLarge")
  @js.native
  ...
  implicit def make(companion: DeleteLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DeleteLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
