...
object DateAdd {
  ...
  implicit def make(companion: DateAdd.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DateAddProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
