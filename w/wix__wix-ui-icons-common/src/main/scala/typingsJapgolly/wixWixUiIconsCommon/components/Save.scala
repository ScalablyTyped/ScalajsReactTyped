...
object Save {
  ...
  implicit def make(companion: Save.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SaveProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
