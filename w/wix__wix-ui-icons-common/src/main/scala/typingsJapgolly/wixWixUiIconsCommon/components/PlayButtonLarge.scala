...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsPlayButtonLargeMod.PlayButtonLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object PlayButtonLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "PlayButtonLarge")
  @js.native
  ...
  implicit def make(companion: PlayButtonLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlayButtonLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
