...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridSectionMod.GridSectionProps
...
object GridSection {
  ...
  implicit def make(companion: GridSection.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridSectionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
