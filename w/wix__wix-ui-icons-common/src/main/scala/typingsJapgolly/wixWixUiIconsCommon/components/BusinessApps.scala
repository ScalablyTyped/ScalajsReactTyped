...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsBusinessAppsMod.BusinessAppsProps
...
object BusinessApps {
  ...
  implicit def make(companion: BusinessApps.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BusinessAppsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
