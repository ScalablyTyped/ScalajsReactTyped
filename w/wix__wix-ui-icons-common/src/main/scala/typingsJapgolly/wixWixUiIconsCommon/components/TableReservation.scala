...
object TableReservation {
  ...
  implicit def make(companion: TableReservation.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TableReservationProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
