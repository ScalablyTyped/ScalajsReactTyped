...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutThreeOnTwoMod.GridLayoutThreeOnTwoProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutThreeOnTwo {
  ...
  implicit def make(companion: GridLayoutThreeOnTwo.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutThreeOnTwoProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
