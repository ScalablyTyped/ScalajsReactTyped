...
object Strikethrough {
  ...
  implicit def make(companion: Strikethrough.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StrikethroughProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
