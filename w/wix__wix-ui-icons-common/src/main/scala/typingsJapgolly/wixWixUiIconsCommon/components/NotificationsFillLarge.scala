...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsNotificationsFillLargeMod.NotificationsFillLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object NotificationsFillLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "NotificationsFillLarge")
  @js.native
  ...
  implicit def make(companion: NotificationsFillLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NotificationsFillLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
