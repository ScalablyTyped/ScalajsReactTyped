...
object OrganicSmall {
  ...
  implicit def make(companion: OrganicSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OrganicSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
