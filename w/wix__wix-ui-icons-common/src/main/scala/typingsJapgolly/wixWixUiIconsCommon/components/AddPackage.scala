...
object AddPackage {
  ...
  implicit def make(companion: AddPackage.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddPackageProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
