...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutThreeOnFourMod.GridLayoutThreeOnFourProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutThreeOnFour {
  ...
  implicit def make(companion: GridLayoutThreeOnFour.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutThreeOnFourProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
