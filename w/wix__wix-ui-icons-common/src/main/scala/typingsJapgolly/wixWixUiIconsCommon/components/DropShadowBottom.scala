...
object DropShadowBottom {
  ...
  implicit def make(companion: DropShadowBottom.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DropShadowBottomProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
