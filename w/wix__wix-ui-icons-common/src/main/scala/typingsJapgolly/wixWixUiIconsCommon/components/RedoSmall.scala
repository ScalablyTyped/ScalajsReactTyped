...
object RedoSmall {
  ...
  implicit def make(companion: RedoSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RedoSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
