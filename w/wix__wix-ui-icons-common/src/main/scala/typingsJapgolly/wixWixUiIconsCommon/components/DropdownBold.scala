...
object DropdownBold {
  ...
  implicit def make(companion: DropdownBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DropdownBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
