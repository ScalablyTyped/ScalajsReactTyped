...
object Duplicate {
  ...
  implicit def make(companion: Duplicate.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DuplicateProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
