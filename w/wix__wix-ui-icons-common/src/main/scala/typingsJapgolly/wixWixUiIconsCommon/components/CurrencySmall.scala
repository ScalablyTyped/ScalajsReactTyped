...
object CurrencySmall {
  ...
  implicit def make(companion: CurrencySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CurrencySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
