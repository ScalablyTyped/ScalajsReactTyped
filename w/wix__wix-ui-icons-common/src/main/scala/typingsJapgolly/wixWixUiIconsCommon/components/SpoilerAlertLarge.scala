...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsSpoilerAlertLargeMod.SpoilerAlertLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SpoilerAlertLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "SpoilerAlertLarge")
  @js.native
  ...
  implicit def make(companion: SpoilerAlertLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SpoilerAlertLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
