...
object TableChartColRowSmall {
  ...
  implicit def make(companion: TableChartColRowSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TableChartColRowSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
