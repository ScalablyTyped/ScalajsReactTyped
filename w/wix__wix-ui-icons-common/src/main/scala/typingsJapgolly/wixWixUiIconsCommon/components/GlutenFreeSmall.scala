...
object GlutenFreeSmall {
  ...
  implicit def make(companion: GlutenFreeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GlutenFreeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
