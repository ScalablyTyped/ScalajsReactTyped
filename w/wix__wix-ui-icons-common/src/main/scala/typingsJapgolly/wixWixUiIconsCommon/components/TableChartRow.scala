...
object TableChartRow {
  ...
  implicit def make(companion: TableChartRow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TableChartRowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
