...
object SortAscending {
  ...
  implicit def make(companion: SortAscending.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SortAscendingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
