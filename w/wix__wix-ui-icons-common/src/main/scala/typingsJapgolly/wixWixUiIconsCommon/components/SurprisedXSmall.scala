...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSurprisedXSmallMod.SurprisedXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SurprisedXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "SurprisedXSmall")
  @js.native
  ...
  implicit def make(companion: SurprisedXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SurprisedXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
