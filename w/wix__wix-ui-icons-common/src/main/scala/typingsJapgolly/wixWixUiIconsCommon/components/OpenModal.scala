...
object OpenModal {
  ...
  implicit def make(companion: OpenModal.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OpenModalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
