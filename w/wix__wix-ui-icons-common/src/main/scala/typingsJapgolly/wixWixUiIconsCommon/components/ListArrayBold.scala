...
object ListArrayBold {
  ...
  implicit def make(companion: ListArrayBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ListArrayBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
