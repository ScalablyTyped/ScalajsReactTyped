...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsTransitionsMod.TransitionsProps
...
object Transitions {
  ...
  implicit def make(companion: Transitions.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TransitionsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
