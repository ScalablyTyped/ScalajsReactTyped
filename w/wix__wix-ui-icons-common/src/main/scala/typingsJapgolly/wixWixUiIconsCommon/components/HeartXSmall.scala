...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsHeartXSmallMod.HeartXSmallProps
...
object HeartXSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "HeartXSmall")
  @js.native
  ...
  implicit def make(companion: HeartXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HeartXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
