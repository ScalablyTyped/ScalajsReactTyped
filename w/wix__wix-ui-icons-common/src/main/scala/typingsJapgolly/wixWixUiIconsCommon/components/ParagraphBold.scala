...
object ParagraphBold {
  ...
  implicit def make(companion: ParagraphBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ParagraphBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
