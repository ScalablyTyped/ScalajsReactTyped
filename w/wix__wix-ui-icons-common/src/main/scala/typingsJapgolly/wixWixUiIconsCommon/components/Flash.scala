...
object Flash {
  ...
  implicit def make(companion: Flash.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlashProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
