...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsVideoLargeMod.VideoLargeProps
...
object VideoLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "VideoLarge")
  @js.native
  ...
  implicit def make(companion: VideoLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VideoLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
