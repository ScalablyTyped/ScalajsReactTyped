...
object UserChatBold {
  ...
  implicit def make(companion: UserChatBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserChatBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
