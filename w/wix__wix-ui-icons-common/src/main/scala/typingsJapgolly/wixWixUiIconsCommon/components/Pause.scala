...
object Pause {
  ...
  implicit def make(companion: Pause.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PauseProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
