...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsCloseXSmallMod.CloseXSmallProps
...
object CloseXSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "CloseXSmall")
  @js.native
  ...
  implicit def make(companion: CloseXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CloseXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
