...
object PaidPlansSellSmall {
  ...
  implicit def make(companion: PaidPlansSellSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaidPlansSellSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
