...
object SharpnessSmall {
  ...
  implicit def make(companion: SharpnessSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SharpnessSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
