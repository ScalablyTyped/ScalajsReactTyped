...
object SortAscendingSmall {
  ...
  implicit def make(companion: SortAscendingSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SortAscendingSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
