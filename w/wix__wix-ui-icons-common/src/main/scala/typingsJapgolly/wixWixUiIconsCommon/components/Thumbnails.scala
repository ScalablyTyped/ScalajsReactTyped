...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsThumbnailsMod.ThumbnailsProps
...
object Thumbnails {
  ...
  implicit def make(companion: Thumbnails.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ThumbnailsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
