...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsReactionFillMod.ReactionFillProps
...
object ReactionFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "ReactionFill")
  @js.native
  ...
  implicit def make(companion: ReactionFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ReactionFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
