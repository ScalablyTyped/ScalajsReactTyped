...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutYOnThreeMod.GridLayoutYOnThreeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutYOnThree {
  ...
  implicit def make(companion: GridLayoutYOnThree.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutYOnThreeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
