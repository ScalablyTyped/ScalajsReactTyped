...
object LayoutListSmall {
  ...
  implicit def make(companion: LayoutListSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutListSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
