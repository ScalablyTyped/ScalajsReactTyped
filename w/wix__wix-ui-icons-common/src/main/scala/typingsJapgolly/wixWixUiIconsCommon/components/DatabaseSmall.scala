...
object DatabaseSmall {
  ...
  implicit def make(companion: DatabaseSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DatabaseSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
