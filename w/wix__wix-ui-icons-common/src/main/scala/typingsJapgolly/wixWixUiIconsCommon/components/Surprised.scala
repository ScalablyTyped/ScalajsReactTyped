...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSurprisedMod.SurprisedProps
...
object Surprised {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "Surprised")
  @js.native
  ...
  implicit def make(companion: Surprised.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SurprisedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
