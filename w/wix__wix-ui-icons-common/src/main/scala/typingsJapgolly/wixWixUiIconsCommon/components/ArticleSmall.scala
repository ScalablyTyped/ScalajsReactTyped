...
object ArticleSmall {
  ...
  implicit def make(companion: ArticleSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArticleSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
