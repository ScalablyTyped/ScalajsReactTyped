...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsUpgradeMod.UpgradeProps
...
object Upgrade {
  ...
  implicit def make(companion: Upgrade.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UpgradeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
