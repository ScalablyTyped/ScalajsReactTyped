...
object Organic {
  ...
  implicit def make(companion: Organic.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OrganicProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
