...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsQuoteSmallMod.QuoteSmallProps
...
object QuoteSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "QuoteSmall")
  @js.native
  ...
  implicit def make(companion: QuoteSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: QuoteSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
