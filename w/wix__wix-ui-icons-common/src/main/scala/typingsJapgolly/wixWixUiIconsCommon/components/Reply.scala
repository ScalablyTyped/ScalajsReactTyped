...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsReplyMod.ReplyProps
...
object Reply {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Reply")
  @js.native
  ...
  implicit def make(companion: Reply.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ReplyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
