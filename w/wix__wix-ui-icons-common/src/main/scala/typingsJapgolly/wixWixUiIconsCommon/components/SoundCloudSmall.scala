...
object SoundCloudSmall {
  ...
  implicit def make(companion: SoundCloudSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SoundCloudSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
