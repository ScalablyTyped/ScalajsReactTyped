...
object ArrowUpSmall {
  ...
  implicit def make(companion: ArrowUpSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArrowUpSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
