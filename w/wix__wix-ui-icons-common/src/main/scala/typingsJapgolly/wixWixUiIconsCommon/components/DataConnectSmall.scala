...
object DataConnectSmall {
  ...
  implicit def make(companion: DataConnectSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DataConnectSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
