...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsChevronRightBoldMod.ChevronRightBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ChevronRightBold {
  ...
  implicit def make(companion: ChevronRightBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronRightBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
