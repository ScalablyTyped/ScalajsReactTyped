...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsTextColorSmallMod.TextColorSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextColorSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "TextColorSmall")
  @js.native
  ...
  implicit def make(companion: TextColorSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextColorSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
