...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutTwoOnOneMod.GridLayoutTwoOnOneProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutTwoOnOne {
  ...
  implicit def make(companion: GridLayoutTwoOnOne.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutTwoOnOneProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
