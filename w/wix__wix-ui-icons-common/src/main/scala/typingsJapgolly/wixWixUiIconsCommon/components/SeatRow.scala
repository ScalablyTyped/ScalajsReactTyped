...
object SeatRow {
  ...
  implicit def make(companion: SeatRow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SeatRowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
