...
object Newspaper {
  ...
  implicit def make(companion: Newspaper.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NewspaperProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
