...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutOneOnFourMod.GridLayoutOneOnFourProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutOneOnFour {
  ...
  implicit def make(companion: GridLayoutOneOnFour.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutOneOnFourProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
