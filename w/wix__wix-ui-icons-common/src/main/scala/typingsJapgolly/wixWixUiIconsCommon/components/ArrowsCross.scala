...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsArrowsCrossMod.ArrowsCrossProps
...
object ArrowsCross {
  ...
  implicit def make(companion: ArrowsCross.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArrowsCrossProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
