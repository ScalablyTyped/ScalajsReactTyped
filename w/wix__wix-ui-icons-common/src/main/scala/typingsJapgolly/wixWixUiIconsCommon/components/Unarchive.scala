...
object Unarchive {
  ...
  implicit def make(companion: Unarchive.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UnarchiveProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
