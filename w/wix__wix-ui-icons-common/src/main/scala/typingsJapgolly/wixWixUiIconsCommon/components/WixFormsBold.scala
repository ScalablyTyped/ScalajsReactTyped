...
object WixFormsBold {
  ...
  implicit def make(companion: WixFormsBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixFormsBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
