...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSmileyTearsXSmallMod.SmileyTearsXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SmileyTearsXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "SmileyTearsXSmall")
  @js.native
  ...
  implicit def make(companion: SmileyTearsXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SmileyTearsXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
