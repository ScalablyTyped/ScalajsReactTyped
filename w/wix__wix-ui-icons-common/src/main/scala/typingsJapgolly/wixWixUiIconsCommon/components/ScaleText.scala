...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsScaleTextMod.ScaleTextProps
...
object ScaleText {
  ...
  implicit def make(companion: ScaleText.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ScaleTextProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
