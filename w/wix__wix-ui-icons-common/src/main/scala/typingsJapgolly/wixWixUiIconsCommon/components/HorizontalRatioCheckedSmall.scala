...
object HorizontalRatioCheckedSmall {
  ...
  implicit def make(companion: HorizontalRatioCheckedSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HorizontalRatioCheckedSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
