...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsLocationFillMod.LocationFillProps
...
object LocationFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "LocationFill")
  @js.native
  ...
  implicit def make(companion: LocationFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LocationFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
