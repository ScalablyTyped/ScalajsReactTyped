...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEaseInOutSineMod.EaseInOutSineProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object EaseInOutSine {
  ...
  implicit def make(companion: EaseInOutSine.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EaseInOutSineProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
