...
object ButtonBold {
  ...
  implicit def make(companion: ButtonBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ButtonBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
