...
object Design {
  ...
  implicit def make(companion: Design.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DesignProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
