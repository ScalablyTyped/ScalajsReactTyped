...
object TextMultilineBold {
  ...
  implicit def make(companion: TextMultilineBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextMultilineBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
