...
object PaddingRightSmall {
  ...
  implicit def make(companion: PaddingRightSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaddingRightSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
