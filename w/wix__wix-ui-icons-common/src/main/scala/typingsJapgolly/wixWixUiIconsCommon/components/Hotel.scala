...
object Hotel {
  ...
  implicit def make(companion: Hotel.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HotelProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
