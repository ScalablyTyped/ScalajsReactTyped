...
object BookOpenBold {
  ...
  implicit def make(companion: BookOpenBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BookOpenBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
