...
object CloudBold {
  ...
  implicit def make(companion: CloudBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CloudBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
