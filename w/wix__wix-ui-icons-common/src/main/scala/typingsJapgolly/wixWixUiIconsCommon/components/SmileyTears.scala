...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSmileyTearsMod.SmileyTearsProps
...
object SmileyTears {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "SmileyTears")
  @js.native
  ...
  implicit def make(companion: SmileyTears.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SmileyTearsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
