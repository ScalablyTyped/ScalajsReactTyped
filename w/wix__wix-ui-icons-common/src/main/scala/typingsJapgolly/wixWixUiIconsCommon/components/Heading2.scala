...
object Heading2 {
  ...
  implicit def make(companion: Heading2.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: Heading2Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
