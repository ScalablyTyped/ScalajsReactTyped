...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsReactionMod.ReactionProps
...
object Reaction {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Reaction")
  @js.native
  ...
  implicit def make(companion: Reaction.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ReactionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
