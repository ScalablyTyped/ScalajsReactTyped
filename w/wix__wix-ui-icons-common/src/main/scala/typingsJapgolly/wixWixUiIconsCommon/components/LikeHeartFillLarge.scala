...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsLikeHeartFillLargeMod.LikeHeartFillLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object LikeHeartFillLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "LikeHeartFillLarge")
  @js.native
  ...
  implicit def make(companion: LikeHeartFillLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LikeHeartFillLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
