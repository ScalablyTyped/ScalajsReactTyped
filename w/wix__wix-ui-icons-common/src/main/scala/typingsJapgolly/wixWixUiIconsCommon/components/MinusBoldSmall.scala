...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsMinusBoldSmallMod.MinusBoldSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object MinusBoldSmall {
  ...
  implicit def make(companion: MinusBoldSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MinusBoldSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
