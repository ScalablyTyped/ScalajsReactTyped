...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsReactionLargeMod.ReactionLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ReactionLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ReactionLarge")
  @js.native
  ...
  implicit def make(companion: ReactionLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ReactionLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
