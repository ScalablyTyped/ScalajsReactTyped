...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsPlusMod.PlusProps
...
object Plus {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Plus")
  @js.native
  ...
  implicit def make(companion: Plus.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PlusProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
