...
object Spicy {
  ...
  implicit def make(companion: Spicy.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SpicyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
