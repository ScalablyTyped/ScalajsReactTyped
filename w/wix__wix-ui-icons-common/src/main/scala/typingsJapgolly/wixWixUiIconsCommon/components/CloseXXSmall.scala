...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsCloseXXSmallMod.CloseXXSmallProps
...
object CloseXXSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "CloseXXSmall")
  @js.native
  ...
  implicit def make(companion: CloseXXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CloseXXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
