...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsBlogMod.BlogProps
...
object Blog {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Blog")
  @js.native
  ...
  implicit def make(companion: Blog.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BlogProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
