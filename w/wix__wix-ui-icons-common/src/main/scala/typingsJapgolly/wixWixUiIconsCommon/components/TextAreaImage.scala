...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsTextAreaImageMod.TextAreaImageProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextAreaImage {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "TextAreaImage")
  @js.native
  ...
  implicit def make(companion: TextAreaImage.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaImageProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
