...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsRearrangeableMod.RearrangeableProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object Rearrangeable {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Rearrangeable")
  @js.native
  ...
  implicit def make(companion: Rearrangeable.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RearrangeableProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
