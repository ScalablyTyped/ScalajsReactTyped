...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsAscendMod.AscendProps
...
object Ascend {
  ...
  implicit def make(companion: Ascend.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AscendProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
