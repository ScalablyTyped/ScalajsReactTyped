...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsAlignLeftBoldMod.AlignLeftBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object AlignLeftBold {
  ...
  implicit def make(companion: AlignLeftBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignLeftBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
