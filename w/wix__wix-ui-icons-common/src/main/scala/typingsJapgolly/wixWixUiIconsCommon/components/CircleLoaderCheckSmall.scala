...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsCircleLoaderCheckSmallMod.CircleLoaderCheckSmallProps
...
object CircleLoaderCheckSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "CircleLoaderCheckSmall")
  @js.native
