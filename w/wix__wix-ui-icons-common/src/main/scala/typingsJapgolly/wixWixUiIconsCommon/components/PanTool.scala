...
object PanTool {
  ...
  implicit def make(companion: PanTool.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PanToolProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
