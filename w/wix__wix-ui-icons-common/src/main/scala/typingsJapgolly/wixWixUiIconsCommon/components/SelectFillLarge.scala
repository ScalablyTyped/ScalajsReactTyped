...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsSelectFillLargeMod.SelectFillLargeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SelectFillLarge {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "SelectFillLarge")
  @js.native
  ...
  implicit def make(companion: SelectFillLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SelectFillLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
