...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsVideoSmallMod.VideoSmallProps
...
object VideoSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "VideoSmall")
  @js.native
  ...
  implicit def make(companion: VideoSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VideoSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
