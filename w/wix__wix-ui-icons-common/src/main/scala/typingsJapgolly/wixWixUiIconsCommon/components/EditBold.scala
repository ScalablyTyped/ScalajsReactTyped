...
object EditBold {
  ...
  implicit def make(companion: EditBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EditBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
