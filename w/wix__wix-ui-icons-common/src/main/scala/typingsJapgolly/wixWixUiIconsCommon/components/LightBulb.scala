...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsLightBulbMod.LightBulbProps
...
object LightBulb {
  ...
  implicit def make(companion: LightBulb.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LightBulbProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
