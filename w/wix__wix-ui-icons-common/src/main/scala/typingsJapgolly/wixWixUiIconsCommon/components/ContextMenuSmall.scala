...
object ContextMenuSmall {
  ...
  implicit def make(companion: ContextMenuSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ContextMenuSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
