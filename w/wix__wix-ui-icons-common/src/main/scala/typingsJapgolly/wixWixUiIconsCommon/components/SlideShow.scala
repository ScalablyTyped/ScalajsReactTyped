...
object SlideShow {
  ...
  implicit def make(companion: SlideShow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SlideShowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
