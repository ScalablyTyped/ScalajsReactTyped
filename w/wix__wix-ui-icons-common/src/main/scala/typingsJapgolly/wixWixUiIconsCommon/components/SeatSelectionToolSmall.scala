...
object SeatSelectionToolSmall {
  ...
  implicit def make(companion: SeatSelectionToolSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SeatSelectionToolSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
