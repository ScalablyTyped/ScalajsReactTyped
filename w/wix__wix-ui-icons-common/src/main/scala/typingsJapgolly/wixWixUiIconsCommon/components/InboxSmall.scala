...
object InboxSmall {
  ...
  implicit def make(companion: InboxSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InboxSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
