...
object Package {
  ...
  implicit def make(companion: Package.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PackageProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
