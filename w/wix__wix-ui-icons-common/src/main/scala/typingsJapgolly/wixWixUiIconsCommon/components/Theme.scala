...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsThemeMod.ThemeProps
...
object Theme {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/responsive-editor/system", "Theme")
  @js.native
  ...
  implicit def make(companion: Theme.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ThemeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
