...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsClearXSmallMod.ClearXSmallProps
...
object ClearXSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ClearXSmall")
  @js.native
  ...
  implicit def make(companion: ClearXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ClearXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
