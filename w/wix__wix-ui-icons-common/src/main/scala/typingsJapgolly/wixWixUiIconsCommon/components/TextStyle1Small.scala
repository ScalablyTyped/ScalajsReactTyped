...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsTextStyle1SmallMod.TextStyle1SmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextStyle1Small {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "TextStyle1Small")
  @js.native
  ...
  implicit def make(companion: TextStyle1Small.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextStyle1SmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
