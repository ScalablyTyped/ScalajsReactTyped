...
object ExtraHot {
  ...
  implicit def make(companion: ExtraHot.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExtraHotProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
