...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsMatchHeightWidthMod.MatchHeightWidthProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object MatchHeightWidth {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "MatchHeightWidth")
  @js.native
  ...
  implicit def make(companion: MatchHeightWidth.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MatchHeightWidthProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
