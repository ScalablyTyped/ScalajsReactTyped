...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSadXSmallMod.SadXSmallProps
...
object SadXSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "SadXSmall")
  @js.native
  ...
  implicit def make(companion: SadXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SadXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
