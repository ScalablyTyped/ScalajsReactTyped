...
object Automations {
  ...
  implicit def make(companion: Automations.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AutomationsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
