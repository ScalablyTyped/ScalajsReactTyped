...
object TextAlignRightSmall {
  ...
  implicit def make(companion: TextAlignRightSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAlignRightSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
