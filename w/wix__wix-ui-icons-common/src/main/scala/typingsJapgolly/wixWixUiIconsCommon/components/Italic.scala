...
object Italic {
  ...
  implicit def make(companion: Italic.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ItalicProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
