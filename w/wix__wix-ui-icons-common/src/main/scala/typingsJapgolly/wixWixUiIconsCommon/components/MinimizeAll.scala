...
object MinimizeAll {
  ...
  implicit def make(companion: MinimizeAll.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MinimizeAllProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
