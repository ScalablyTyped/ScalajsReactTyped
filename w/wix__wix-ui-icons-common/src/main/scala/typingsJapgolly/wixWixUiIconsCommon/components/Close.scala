...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsCloseMod.CloseProps
...
object Close {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "Close")
  @js.native
  ...
  implicit def make(companion: Close.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
