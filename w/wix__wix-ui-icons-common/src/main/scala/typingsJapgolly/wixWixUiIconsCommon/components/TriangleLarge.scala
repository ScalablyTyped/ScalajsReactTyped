...
object TriangleLarge {
  ...
  implicit def make(companion: TriangleLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TriangleLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
