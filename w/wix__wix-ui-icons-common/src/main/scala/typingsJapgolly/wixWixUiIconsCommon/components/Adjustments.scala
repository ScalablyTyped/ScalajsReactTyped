...
object Adjustments {
  ...
  implicit def make(companion: Adjustments.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AdjustmentsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
