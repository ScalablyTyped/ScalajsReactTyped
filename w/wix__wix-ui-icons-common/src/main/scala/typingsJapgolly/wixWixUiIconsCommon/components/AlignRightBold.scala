...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsAlignRightBoldMod.AlignRightBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object AlignRightBold {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/responsive-editor/system", "AlignRightBold")
  @js.native
  ...
  implicit def make(companion: AlignRightBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignRightBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
