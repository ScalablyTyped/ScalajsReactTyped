...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsAddButtonMod.AddButtonProps
...
object AddButton {
  ...
  implicit def make(companion: AddButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
