...
object MoveToTrash {
  ...
  implicit def make(companion: MoveToTrash.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MoveToTrashProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
