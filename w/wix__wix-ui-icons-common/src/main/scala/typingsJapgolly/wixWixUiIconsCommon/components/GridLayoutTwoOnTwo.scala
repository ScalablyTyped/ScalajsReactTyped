...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutTwoOnTwoMod.GridLayoutTwoOnTwoProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutTwoOnTwo {
  ...
  implicit def make(companion: GridLayoutTwoOnTwo.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutTwoOnTwoProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
