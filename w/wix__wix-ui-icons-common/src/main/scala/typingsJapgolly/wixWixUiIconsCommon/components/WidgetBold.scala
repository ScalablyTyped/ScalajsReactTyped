...
object WidgetBold {
  ...
  implicit def make(companion: WidgetBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WidgetBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
