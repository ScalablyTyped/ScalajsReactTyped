...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEaseInSineMod.EaseInSineProps
...
object EaseInSine {
  ...
  implicit def make(companion: EaseInSine.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EaseInSineProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
