...
object PagesBold {
  ...
  implicit def make(companion: PagesBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PagesBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
