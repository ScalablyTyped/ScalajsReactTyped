...
object SettingsBold {
  ...
  implicit def make(companion: SettingsBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SettingsBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
