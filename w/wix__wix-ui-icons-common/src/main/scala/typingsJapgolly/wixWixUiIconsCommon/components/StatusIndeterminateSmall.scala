...
object StatusIndeterminateSmall {
  ...
  implicit def make(companion: StatusIndeterminateSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatusIndeterminateSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
