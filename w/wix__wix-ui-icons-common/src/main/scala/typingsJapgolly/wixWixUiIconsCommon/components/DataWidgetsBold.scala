...
object DataWidgetsBold {
  ...
  implicit def make(companion: DataWidgetsBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DataWidgetsBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
