...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsFormFieldErrorSmallMod.FormFieldErrorSmallProps
...
object FormFieldErrorSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "FormFieldErrorSmall")
  @js.native
