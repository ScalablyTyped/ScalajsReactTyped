...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsAdminMod.AdminProps
...
object Admin {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Admin")
  @js.native
  ...
  implicit def make(companion: Admin.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AdminProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
