...
object SingleItemCollection {
  ...
  implicit def make(companion: SingleItemCollection.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SingleItemCollectionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
