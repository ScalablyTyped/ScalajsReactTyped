...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEditFormMod.EditFormProps
...
object EditForm {
  ...
  implicit def make(companion: EditForm.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EditFormProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
