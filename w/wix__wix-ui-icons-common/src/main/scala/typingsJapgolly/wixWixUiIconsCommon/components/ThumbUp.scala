...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsThumbUpMod.ThumbUpProps
...
object ThumbUp {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "ThumbUp")
  @js.native
  ...
  implicit def make(companion: ThumbUp.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ThumbUpProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
