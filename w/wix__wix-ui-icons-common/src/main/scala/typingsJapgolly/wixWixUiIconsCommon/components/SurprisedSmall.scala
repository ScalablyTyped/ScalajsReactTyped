...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSurprisedSmallMod.SurprisedSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SurprisedSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "SurprisedSmall")
  @js.native
  ...
  implicit def make(companion: SurprisedSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SurprisedSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
