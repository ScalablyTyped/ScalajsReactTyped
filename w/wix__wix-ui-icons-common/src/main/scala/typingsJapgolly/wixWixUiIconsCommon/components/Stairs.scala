...
object Stairs {
  ...
  implicit def make(companion: Stairs.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StairsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
