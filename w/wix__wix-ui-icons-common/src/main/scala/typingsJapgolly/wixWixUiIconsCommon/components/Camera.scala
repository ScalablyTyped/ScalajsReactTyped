...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsCameraMod.CameraProps
...
object Camera {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "Camera")
  @js.native
  ...
  implicit def make(companion: Camera.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CameraProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
