...
object Currency {
  ...
  implicit def make(companion: Currency.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CurrencyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
