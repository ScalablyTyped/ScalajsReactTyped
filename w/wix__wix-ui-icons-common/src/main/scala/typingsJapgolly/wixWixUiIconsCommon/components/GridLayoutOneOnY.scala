...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutOneOnYMod.GridLayoutOneOnYProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutOneOnY {
  ...
  implicit def make(companion: GridLayoutOneOnY.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutOneOnYProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
