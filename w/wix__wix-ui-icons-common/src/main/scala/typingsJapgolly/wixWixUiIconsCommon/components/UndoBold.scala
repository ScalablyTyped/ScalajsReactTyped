...
object UndoBold {
  ...
  implicit def make(companion: UndoBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UndoBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
