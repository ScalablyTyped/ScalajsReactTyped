...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsTextAreaUnderlineMod.TextAreaUnderlineProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object TextAreaUnderline {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "TextAreaUnderline")
  @js.native
  ...
  implicit def make(companion: TextAreaUnderline.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextAreaUnderlineProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
