...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEditDisabledMod.EditDisabledProps
...
object EditDisabled {
  ...
  implicit def make(companion: EditDisabled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EditDisabledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
