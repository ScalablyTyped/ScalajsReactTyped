...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsDevianArtMod.DevianArtProps
...
object DevianArt {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "DevianArt")
  @js.native
  ...
  implicit def make(companion: DevianArt.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DevianArtProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
