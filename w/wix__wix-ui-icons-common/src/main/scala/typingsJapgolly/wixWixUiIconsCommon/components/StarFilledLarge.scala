...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsStarFilledLargeMod.StarFilledLargeProps
...
object StarFilledLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "StarFilledLarge")
  @js.native
