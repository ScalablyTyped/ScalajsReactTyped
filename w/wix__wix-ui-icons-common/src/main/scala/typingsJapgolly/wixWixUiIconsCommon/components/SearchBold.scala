...
object SearchBold {
  ...
  implicit def make(companion: SearchBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SearchBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
