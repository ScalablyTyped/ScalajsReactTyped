...
object VideoTransparent {
  ...
  implicit def make(companion: VideoTransparent.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VideoTransparentProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
