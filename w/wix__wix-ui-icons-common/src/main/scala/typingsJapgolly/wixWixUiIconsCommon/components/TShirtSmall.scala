...
object TShirtSmall {
  ...
  implicit def make(companion: TShirtSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TShirtSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
