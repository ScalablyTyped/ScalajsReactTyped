...
object FolderOpenAdd {
  ...
  implicit def make(companion: FolderOpenAdd.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FolderOpenAddProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
