...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsChevronUpBoldSmallMod.ChevronUpBoldSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ChevronUpBoldSmall {
  ...
  implicit def make(companion: ChevronUpBoldSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronUpBoldSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
