...
object Delete {
  ...
  implicit def make(companion: Delete.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DeleteProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
