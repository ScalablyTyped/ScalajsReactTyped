...
object JSLocked {
  ...
  implicit def make(companion: JSLocked.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: JSLockedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
