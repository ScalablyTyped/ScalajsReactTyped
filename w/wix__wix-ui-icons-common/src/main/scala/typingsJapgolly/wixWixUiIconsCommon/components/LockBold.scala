...
object LockBold {
  ...
  implicit def make(companion: LockBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LockBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
