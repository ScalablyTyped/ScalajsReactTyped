...
object FolderAdd {
  ...
  implicit def make(companion: FolderAdd.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FolderAddProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
