...
object BooleanBold {
  ...
  implicit def make(companion: BooleanBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BooleanBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
