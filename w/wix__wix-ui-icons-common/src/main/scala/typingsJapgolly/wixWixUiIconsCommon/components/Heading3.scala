...
object Heading3 {
  ...
  implicit def make(companion: Heading3.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: Heading3Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
