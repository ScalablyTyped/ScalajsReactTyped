...
object BarChartSplitSmall {
  ...
  implicit def make(companion: BarChartSplitSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BarChartSplitSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
