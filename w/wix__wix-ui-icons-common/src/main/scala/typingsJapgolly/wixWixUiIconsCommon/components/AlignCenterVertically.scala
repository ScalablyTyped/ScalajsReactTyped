...
object AlignCenterVertically {
  ...
  implicit def make(companion: AlignCenterVertically.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignCenterVerticallyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
