...
object Microsoft365Small {
  ...
  implicit def make(companion: Microsoft365Small.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: Microsoft365SmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
