...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsFormFieldSpinnerDownMod.FormFieldSpinnerDownProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FormFieldSpinnerDown {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "FormFieldSpinnerDown")
  @js.native
  ...
  implicit def make(companion: FormFieldSpinnerDown.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FormFieldSpinnerDownProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
