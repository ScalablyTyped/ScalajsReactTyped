...
object HorizontalLine {
  ...
  implicit def make(companion: HorizontalLine.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HorizontalLineProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
