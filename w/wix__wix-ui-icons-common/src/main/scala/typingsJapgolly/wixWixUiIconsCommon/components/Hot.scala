...
object Hot {
  ...
  implicit def make(companion: Hot.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HotProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
