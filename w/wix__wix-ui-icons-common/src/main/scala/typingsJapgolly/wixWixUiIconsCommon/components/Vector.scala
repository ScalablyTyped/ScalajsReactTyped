...
object Vector {
  ...
  implicit def make(companion: Vector.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VectorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
