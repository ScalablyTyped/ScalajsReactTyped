...
object UnlinkPropertiesSmall {
  ...
  implicit def make(companion: UnlinkPropertiesSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UnlinkPropertiesSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
