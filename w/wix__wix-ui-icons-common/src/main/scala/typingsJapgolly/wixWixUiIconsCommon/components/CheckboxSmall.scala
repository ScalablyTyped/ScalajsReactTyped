...
object CheckboxSmall {
  ...
  implicit def make(companion: CheckboxSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CheckboxSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
