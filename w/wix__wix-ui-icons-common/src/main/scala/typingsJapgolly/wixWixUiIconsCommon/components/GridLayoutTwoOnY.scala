...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutTwoOnYMod.GridLayoutTwoOnYProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutTwoOnY {
  ...
  implicit def make(companion: GridLayoutTwoOnY.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutTwoOnYProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
