...
object MaximizeSmall {
  ...
  implicit def make(companion: MaximizeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MaximizeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
