...
object UserPrivateSmall {
  ...
  implicit def make(companion: UserPrivateSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserPrivateSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
