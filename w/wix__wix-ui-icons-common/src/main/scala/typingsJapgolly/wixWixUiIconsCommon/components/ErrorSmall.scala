...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsErrorSmallMod.ErrorSmallProps
...
object ErrorSmall {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "ErrorSmall")
  @js.native
  ...
  implicit def make(companion: ErrorSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ErrorSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
