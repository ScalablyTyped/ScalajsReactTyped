...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsDuplicateFillSmallMod.DuplicateFillSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object DuplicateFillSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "DuplicateFillSmall")
  @js.native
  ...
  implicit def make(companion: DuplicateFillSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DuplicateFillSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
