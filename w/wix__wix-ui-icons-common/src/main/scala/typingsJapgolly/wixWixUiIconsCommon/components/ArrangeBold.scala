...
object ArrangeBold {
  ...
  implicit def make(companion: ArrangeBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArrangeBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
