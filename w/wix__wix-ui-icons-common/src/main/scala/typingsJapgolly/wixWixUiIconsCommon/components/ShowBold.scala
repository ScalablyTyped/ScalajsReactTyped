...
object ShowBold {
  ...
  implicit def make(companion: ShowBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShowBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
