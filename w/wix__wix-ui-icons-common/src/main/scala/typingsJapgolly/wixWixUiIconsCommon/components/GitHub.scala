...
object GitHub {
  ...
  implicit def make(companion: GitHub.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GitHubProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
