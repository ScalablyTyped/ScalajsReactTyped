...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsStretchMod.StretchProps
...
object Stretch {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "Stretch")
  @js.native
  ...
  implicit def make(companion: Stretch.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StretchProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
