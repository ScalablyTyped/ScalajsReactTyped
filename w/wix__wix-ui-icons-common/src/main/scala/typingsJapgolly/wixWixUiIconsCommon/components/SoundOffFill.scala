...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsSoundOffFillMod.SoundOffFillProps
...
object SoundOffFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "SoundOffFill")
  @js.native
  ...
  implicit def make(companion: SoundOffFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SoundOffFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
