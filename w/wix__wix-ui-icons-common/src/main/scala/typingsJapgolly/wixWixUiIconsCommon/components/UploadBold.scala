...
object UploadBold {
  ...
  implicit def make(companion: UploadBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UploadBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
