...
import typingsJapgolly.wixWixUiIconsCommon.distTypesSystemDistComponentsFormFieldWarningFilledMod.FormFieldWarningFilledProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object FormFieldWarningFilled {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system", "FormFieldWarningFilled")
  @js.native
  ...
  implicit def make(companion: FormFieldWarningFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FormFieldWarningFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
