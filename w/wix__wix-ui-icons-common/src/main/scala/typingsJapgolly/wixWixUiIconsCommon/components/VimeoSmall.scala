...
object VimeoSmall {
  ...
  implicit def make(companion: VimeoSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VimeoSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
