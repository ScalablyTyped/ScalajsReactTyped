...
object MicrophoneDisabledSmall {
  ...
  implicit def make(companion: MicrophoneDisabledSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MicrophoneDisabledSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
