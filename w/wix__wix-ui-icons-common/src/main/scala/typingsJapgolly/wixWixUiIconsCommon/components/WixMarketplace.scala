...
object WixMarketplace {
  ...
  implicit def make(companion: WixMarketplace.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixMarketplaceProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
