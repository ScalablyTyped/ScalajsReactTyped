...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsFlagReviewMod.FlagReviewProps
...
object FlagReview {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "FlagReview")
  @js.native
  ...
  implicit def make(companion: FlagReview.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlagReviewProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
