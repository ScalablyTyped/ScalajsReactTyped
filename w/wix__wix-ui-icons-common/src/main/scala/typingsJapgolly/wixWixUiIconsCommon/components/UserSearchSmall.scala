...
object UserSearchSmall {
  ...
  implicit def make(companion: UserSearchSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserSearchSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
