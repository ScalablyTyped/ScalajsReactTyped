...
object Layers {
  ...
  implicit def make(companion: Layers.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayersProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
