...
object PanToolSmall {
  ...
  implicit def make(companion: PanToolSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PanToolSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
