...
object StatusCompleteFilled {
  ...
  implicit def make(companion: StatusCompleteFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatusCompleteFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
