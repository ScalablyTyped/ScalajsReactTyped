...
object LayoutThreeColumns {
  ...
  implicit def make(companion: LayoutThreeColumns.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutThreeColumnsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
