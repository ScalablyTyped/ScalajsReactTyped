...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsEaseOutQuadMod.EaseOutQuadProps
...
object EaseOutQuad {
  ...
  implicit def make(companion: EaseOutQuad.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EaseOutQuadProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
