...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsMovetoFrontMod.MovetoFrontProps
...
object MovetoFront {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "MovetoFront")
  @js.native
  ...
  implicit def make(companion: MovetoFront.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MovetoFrontProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
