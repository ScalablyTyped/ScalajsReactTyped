...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorSystemDistComponentsAppsMod.AppsProps
...
object Apps {
  ...
  implicit def make(companion: Apps.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AppsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
