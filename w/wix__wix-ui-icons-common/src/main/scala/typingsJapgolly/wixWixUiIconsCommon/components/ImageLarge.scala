...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsImageLargeMod.ImageLargeProps
...
object ImageLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "ImageLarge")
  @js.native
  ...
  implicit def make(companion: ImageLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ImageLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
