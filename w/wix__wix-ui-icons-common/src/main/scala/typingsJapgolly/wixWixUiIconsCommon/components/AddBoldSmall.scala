...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsAddBoldSmallMod.AddBoldSmallProps
...
object AddBoldSmall {
  ...
  implicit def make(companion: AddBoldSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddBoldSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
