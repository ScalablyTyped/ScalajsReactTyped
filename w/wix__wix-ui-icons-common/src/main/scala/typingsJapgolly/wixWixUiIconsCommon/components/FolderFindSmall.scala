...
object FolderFindSmall {
  ...
  implicit def make(companion: FolderFindSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FolderFindSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
