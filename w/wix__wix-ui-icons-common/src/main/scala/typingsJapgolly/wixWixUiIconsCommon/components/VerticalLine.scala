...
object VerticalLine {
  ...
  implicit def make(companion: VerticalLine.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VerticalLineProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
