...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsLikeHeartSmallMod.LikeHeartSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object LikeHeartSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "LikeHeartSmall")
  @js.native
  ...
  implicit def make(companion: LikeHeartSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LikeHeartSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
