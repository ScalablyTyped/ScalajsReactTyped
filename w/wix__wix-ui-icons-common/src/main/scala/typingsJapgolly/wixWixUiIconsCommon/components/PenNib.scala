...
object PenNib {
  ...
  implicit def make(companion: PenNib.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PenNibProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
