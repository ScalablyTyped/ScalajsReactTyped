...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsThumbUpXSmallMod.ThumbUpXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ThumbUpXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "ThumbUpXSmall")
  @js.native
  ...
  implicit def make(companion: ThumbUpXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ThumbUpXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
