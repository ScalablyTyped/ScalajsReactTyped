...
object WixFormsSmall {
  ...
  implicit def make(companion: WixFormsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixFormsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
