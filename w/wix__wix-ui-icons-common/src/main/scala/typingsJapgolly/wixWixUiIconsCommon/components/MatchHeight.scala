...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsMatchHeightMod.MatchHeightProps
...
object MatchHeight {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/classic-editor/system", "MatchHeight")
  @js.native
  ...
  implicit def make(companion: MatchHeight.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MatchHeightProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
