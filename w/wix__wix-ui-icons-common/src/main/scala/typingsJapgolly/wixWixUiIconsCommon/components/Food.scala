...
object Food {
  ...
  implicit def make(companion: Food.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FoodProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
