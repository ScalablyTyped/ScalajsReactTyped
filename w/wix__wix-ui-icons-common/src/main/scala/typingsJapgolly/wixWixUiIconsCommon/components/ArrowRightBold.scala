...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsArrowRightBoldMod.ArrowRightBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ArrowRightBold {
  ...
  implicit def make(companion: ArrowRightBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArrowRightBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
