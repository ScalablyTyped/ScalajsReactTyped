...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsReelsFillMod.ReelsFillProps
...
object ReelsFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "ReelsFill")
  @js.native
  ...
  implicit def make(companion: ReelsFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ReelsFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
