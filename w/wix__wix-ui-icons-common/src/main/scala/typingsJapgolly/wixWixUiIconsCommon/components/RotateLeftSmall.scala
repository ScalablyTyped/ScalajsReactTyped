...
object RotateLeftSmall {
  ...
  implicit def make(companion: RotateLeftSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RotateLeftSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
