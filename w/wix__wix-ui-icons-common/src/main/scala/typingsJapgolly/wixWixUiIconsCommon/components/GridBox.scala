...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridBoxMod.GridBoxProps
...
object GridBox {
  ...
  implicit def make(companion: GridBox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridBoxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
