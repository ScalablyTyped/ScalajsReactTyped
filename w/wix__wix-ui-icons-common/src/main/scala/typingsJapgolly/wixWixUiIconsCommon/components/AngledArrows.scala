...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsAngledArrowsMod.AngledArrowsProps
...
object AngledArrows {
  ...
  implicit def make(companion: AngledArrows.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AngledArrowsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
