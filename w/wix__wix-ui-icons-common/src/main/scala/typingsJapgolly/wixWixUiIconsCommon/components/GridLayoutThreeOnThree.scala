...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsGridLayoutThreeOnThreeMod.GridLayoutThreeOnThreeProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object GridLayoutThreeOnThree {
  ...
  implicit def make(companion: GridLayoutThreeOnThree.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GridLayoutThreeOnThreeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
