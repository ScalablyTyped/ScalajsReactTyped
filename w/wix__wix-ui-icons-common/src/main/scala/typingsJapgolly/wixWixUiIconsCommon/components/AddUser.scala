...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsAddUserMod.AddUserProps
...
object AddUser {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "AddUser")
  @js.native
  ...
  implicit def make(companion: AddUser.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AddUserProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
