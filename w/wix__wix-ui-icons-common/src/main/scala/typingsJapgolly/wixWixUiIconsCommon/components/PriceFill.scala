...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsPriceFillMod.PriceFillProps
...
object PriceFill {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "PriceFill")
  @js.native
  ...
  implicit def make(companion: PriceFill.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PriceFillProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
