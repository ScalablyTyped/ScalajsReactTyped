...
import typingsJapgolly.wixWixUiIconsCommon.distTypesClassicEditorSystemDistComponentsPropertiesMod.PropertiesProps
...
object Properties {
  ...
  implicit def make(companion: Properties.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PropertiesProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
