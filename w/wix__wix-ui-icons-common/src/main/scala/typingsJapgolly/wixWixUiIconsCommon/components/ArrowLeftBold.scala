...
import typingsJapgolly.wixWixUiIconsCommon.distTypesResponsiveEditorGeneralDistComponentsArrowLeftBoldMod.ArrowLeftBoldProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ArrowLeftBold {
  ...
  implicit def make(companion: ArrowLeftBold.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArrowLeftBoldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
