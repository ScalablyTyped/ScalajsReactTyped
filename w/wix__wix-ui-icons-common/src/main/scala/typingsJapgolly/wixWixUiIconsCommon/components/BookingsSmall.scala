...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageGeneralDistComponentsBookingsSmallMod.BookingsSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object BookingsSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage", "BookingsSmall")
  @js.native
  ...
  implicit def make(companion: BookingsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BookingsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
