...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageSystemDistComponentsEventsLargeMod.EventsLargeProps
...
object EventsLarge {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/system", "EventsLarge")
  @js.native
  ...
  implicit def make(companion: EventsLarge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EventsLargeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
