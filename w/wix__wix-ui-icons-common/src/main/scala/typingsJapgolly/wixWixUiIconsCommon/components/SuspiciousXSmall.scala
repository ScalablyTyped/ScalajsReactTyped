...
import typingsJapgolly.wixWixUiIconsCommon.distTypesOnStageReactionsDistComponentsSuspiciousXSmallMod.SuspiciousXSmallProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SuspiciousXSmall {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/on-stage/reactions", "SuspiciousXSmall")
  @js.native
  ...
  implicit def make(companion: SuspiciousXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SuspiciousXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
