...
import typingsJapgolly.wdioTypes.wdioTypesStrings.local
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined parent @wdio/types.@wdio/types/build/Services.Hooks */
/* Inlined parent std.Omit<@wdio/types.@wdio/types/build/Options.WebdriverIO, 'capabilities'> */
/* Inlined parent @wdio/types.@wdio/types.<global>.WebdriverIO.HookFunctionExtension */
...
object Testrunner {
  ...
  inline def apply(capabilities: RemoteCapabilities): Testrunner = {
  ...
  extension [Self <: Testrunner](x: Self) {
    ...
    inline def setAfterSession(
      value: (js.Function3[Testrunner, /* capabilities */ RemoteCapability, /* specs */ js.Array[String], Unit]) | (js.Array[
          NonNullable[
            js.UndefOr[
              js.Function3[Testrunner, /* capabilities */ RemoteCapability, /* specs */ js.Array[String], Unit]
            ]
          ]
        ])
    ): Self = StObject.set(x, "afterSession", value.asInstanceOf[js.Any])
    
    inline def setAfterSessionFunction3(value: (Testrunner, /* capabilities */ RemoteCapability, /* specs */ js.Array[String]) => Callback): Self = StObject.set(x, "afterSession", js.Any.fromFunction3((t0: Testrunner, t1: /* capabilities */ RemoteCapability, t2: /* specs */ js.Array[String]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setOnPrepare(
      value: (js.Function2[Testrunner, /* capabilities */ RemoteCapabilities, Unit]) | (js.Array[
          NonNullable[
            js.UndefOr[js.Function2[Testrunner, /* capabilities */ RemoteCapabilities, Unit]]
          ]
        ])
    ): Self = StObject.set(x, "onPrepare", value.asInstanceOf[js.Any])
    
    inline def setOnPrepareFunction2(value: (Testrunner, /* capabilities */ RemoteCapabilities) => Callback): Self = StObject.set(x, "onPrepare", js.Any.fromFunction2((t0: Testrunner, t1: /* capabilities */ RemoteCapabilities) => (value(t0, t1)).runNow()))
    ...
    inline def setOnWorkerStartFunction5(
      value: (/* cid */ String, /* caps */ DesiredCapabilities, /* specs */ js.Array[String], Testrunner, /* execArgv */ js.Array[String]) => Callback
    ): Self = StObject.set(x, "onWorkerStart", js.Any.fromFunction5((t0: /* cid */ String, t1: /* caps */ DesiredCapabilities, t2: /* specs */ js.Array[String], t3: Testrunner, t4: /* execArgv */ js.Array[String]) => (value(t0, t1, t2, t3, t4)).runNow()))
