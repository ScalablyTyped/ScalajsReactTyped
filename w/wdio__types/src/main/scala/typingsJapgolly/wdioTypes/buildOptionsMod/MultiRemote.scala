...
/* Inlined parent std.Omit<@wdio/types.@wdio/types/build/Options.Testrunner, 'capabilities'> */
...
object MultiRemote {
  ...
  inline def apply(capabilities: MultiRemoteCapabilities): MultiRemote = {
  ...
  extension [Self <: MultiRemote](x: Self) {
    ...
    inline def setCapabilities(value: MultiRemoteCapabilities): Self = StObject.set(x, "capabilities", value.asInstanceOf[js.Any])
