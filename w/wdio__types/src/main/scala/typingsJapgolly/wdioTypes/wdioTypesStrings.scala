...
import typingsJapgolly.wdioTypes.buildCapabilitiesMod.FirefoxLogLevels
import typingsJapgolly.wdioTypes.buildCapabilitiesMod.LoggingPreferenceType
import typingsJapgolly.wdioTypes.buildCapabilitiesMod.MoonMobileDeviceOrientation
import typingsJapgolly.wdioTypes.buildCapabilitiesMod.PageLoadingStrategy
import typingsJapgolly.wdioTypes.buildCapabilitiesMod.ProxyTypes
...
object wdioTypesStrings {
  ...
  @js.native
  sealed trait AMBIGUOUS extends StObject
  ...
  sealed trait FINER
    extends StObject
       with LoggingPreferenceType
  inline def FINER: FINER = "FINER".asInstanceOf[FINER]
  ...
  inline def config_ : config_ = "config".asInstanceOf[config_]
  ...
  sealed trait noproxy
    extends StObject
       with ProxyTypes
  inline def noproxy: noproxy = "noproxy".asInstanceOf[noproxy]
  ...
  @js.native
  sealed trait warnings extends StObject
  inline def warnings: warnings = "warnings".asInstanceOf[warnings]
