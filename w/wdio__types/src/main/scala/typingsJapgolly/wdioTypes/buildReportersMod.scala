...
import typingsJapgolly.wdioTypes.anon.PartialOptions
import typingsJapgolly.wdioTypes.anon.Write
import typingsJapgolly.wdioTypes.mod.global.WebdriverIO.ReporterOption
