...
object OmitTestrunnercapabilitieAfter {
  ...
  extension [Self <: OmitTestrunnercapabilitieAfter](x: Self) {
    ...
    inline def setAfterSession(
      value: (js.Function3[
          OmitTestrunnercapabilitieAfter, 
          /* capabilities */ RemoteCapability, 
          /* specs */ js.Array[String], 
          Unit
        ]) | (js.Array[
    ...
    inline def setAfterSessionFunction3(
      value: (OmitTestrunnercapabilitieAfter, /* capabilities */ RemoteCapability, /* specs */ js.Array[String]) => Callback
    ): Self = StObject.set(x, "afterSession", js.Any.fromFunction3((t0: OmitTestrunnercapabilitieAfter, t1: /* capabilities */ RemoteCapability, t2: /* specs */ js.Array[String]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setBeforeSession(
      value: (js.Function4[
          /* config */ Omit[OmitTestrunnercapabilitieAfter, capabilities], 
          /* capabilities */ RemoteCapability, 
          /* specs */ js.Array[String], 
          /* cid */ String, 
          Unit
    ...
    inline def setBeforeSessionFunction4(
      value: (/* config */ Omit[OmitTestrunnercapabilitieAfter, capabilities], /* capabilities */ RemoteCapability, /* specs */ js.Array[String], /* cid */ String) => Callback
    ): Self = StObject.set(x, "beforeSession", js.Any.fromFunction4((t0: /* config */ Omit[OmitTestrunnercapabilitieAfter, capabilities], t1: /* capabilities */ RemoteCapability, t2: /* specs */ js.Array[String], t3: /* cid */ String) => (value(t0, t1, t2, t3)).runNow()))
    ...
    inline def setOnCompleteFunction4(
      value: (/* exitCode */ Double, /* config */ Omit[OmitTestrunnercapabilitieAfter, capabilities], /* capabilities */ RemoteCapabilities, /* results */ Any) => Callback
    ): Self = StObject.set(x, "onComplete", js.Any.fromFunction4((t0: /* exitCode */ Double, t1: /* config */ Omit[OmitTestrunnercapabilitieAfter, capabilities], t2: /* capabilities */ RemoteCapabilities, t3: /* results */ Any) => (value(t0, t1, t2, t3)).runNow()))
    ...
    inline def setOnPrepare(
      value: (js.Function2[OmitTestrunnercapabilitieAfter, /* capabilities */ RemoteCapabilities, Unit]) | (js.Array[
          NonNullable[
            js.UndefOr[
              js.Function2[OmitTestrunnercapabilitieAfter, /* capabilities */ RemoteCapabilities, Unit]
            ]
          ]
        ])
    ): Self = StObject.set(x, "onPrepare", value.asInstanceOf[js.Any])
    
    inline def setOnPrepareFunction2(value: (OmitTestrunnercapabilitieAfter, /* capabilities */ RemoteCapabilities) => Callback): Self = StObject.set(x, "onPrepare", js.Any.fromFunction2((t0: OmitTestrunnercapabilitieAfter, t1: /* capabilities */ RemoteCapabilities) => (value(t0, t1)).runNow()))
    ...
    inline def setOnWorkerStartFunction5(
      value: (/* cid */ String, /* caps */ DesiredCapabilities, /* specs */ js.Array[String], OmitTestrunnercapabilitieAfter, /* execArgv */ js.Array[String]) => Callback
    ): Self = StObject.set(x, "onWorkerStart", js.Any.fromFunction5((t0: /* cid */ String, t1: /* caps */ DesiredCapabilities, t2: /* specs */ js.Array[String], t3: OmitTestrunnercapabilitieAfter, t4: /* execArgv */ js.Array[String]) => (value(t0, t1, t2, t3, t4)).runNow()))
