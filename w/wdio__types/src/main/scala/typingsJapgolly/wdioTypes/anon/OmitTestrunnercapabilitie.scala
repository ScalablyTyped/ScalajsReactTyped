...
import typingsJapgolly.wdioTypes.wdioTypesStrings.capabilities
...
object OmitTestrunnercapabilitie {
  ...
  extension [Self <: OmitTestrunnercapabilitie](x: Self) {
    ...
    inline def setBeforeSessionFunction4(
      value: (/* config */ Omit[Testrunner, capabilities], /* capabilities */ RemoteCapability, /* specs */ js.Array[String], /* cid */ String) => Callback
    ): Self = StObject.set(x, "beforeSession", js.Any.fromFunction4((t0: /* config */ Omit[Testrunner, capabilities], t1: /* capabilities */ RemoteCapability, t2: /* specs */ js.Array[String], t3: /* cid */ String) => (value(t0, t1, t2, t3)).runNow()))
    ...
    inline def setOnCompleteFunction4(
      value: (/* exitCode */ Double, /* config */ Omit[Testrunner, capabilities], /* capabilities */ RemoteCapabilities, /* results */ Any) => Callback
    ): Self = StObject.set(x, "onComplete", js.Any.fromFunction4((t0: /* exitCode */ Double, t1: /* config */ Omit[Testrunner, capabilities], t2: /* capabilities */ RemoteCapabilities, t3: /* results */ Any) => (value(t0, t1, t2, t3)).runNow()))
