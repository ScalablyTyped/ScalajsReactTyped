...
import typingsJapgolly.wdioTypes.mod.global.WebdriverIO.WDIODevtoolsOptions
import typingsJapgolly.wdioTypes.mod.global.WebdriverIO.WDIOVSCodeServiceOptions
