package typingsJapgolly.webpackEntryManifestPlugin
...
object mod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    var name: typingsJapgolly.webpackEntryManifestPlugin.webpackEntryManifestPluginStrings.WebpackEntryManifestPlugin = js.native
  }
  ...
  - Dropped webpack.anon.Apply | (this : webpack.webpack.Resolver, arg1 : webpack.webpack.Resolver): void */ trait WebpackEntryManifestPlugin extends StObject {
    ...
    var name: typingsJapgolly.webpackEntryManifestPlugin.webpackEntryManifestPluginStrings.WebpackEntryManifestPlugin
  }
  object WebpackEntryManifestPlugin {
    ...
    extension [Self <: WebpackEntryManifestPlugin](x: Self) {
      ...
      inline def setName(
        value: typingsJapgolly.webpackEntryManifestPlugin.webpackEntryManifestPluginStrings.WebpackEntryManifestPlugin
