...
import typingsJapgolly.wpapi.anon.Self
import typingsJapgolly.wpapi.anon.Type
import typingsJapgolly.wpapi.wpapiStrings.asc
import typingsJapgolly.wpapi.wpapiStrings.desc
...
object mod {
  ...
  */
  ...
  object HTTPArgumentType {
    ...
    inline def array: typingsJapgolly.wpapi.wpapiStrings.array = "array".asInstanceOf[typingsJapgolly.wpapi.wpapiStrings.array]
    
    inline def boolean: typingsJapgolly.wpapi.wpapiStrings.boolean = "boolean".asInstanceOf[typingsJapgolly.wpapi.wpapiStrings.boolean]
    
    inline def integer: typingsJapgolly.wpapi.wpapiStrings.integer = "integer".asInstanceOf[typingsJapgolly.wpapi.wpapiStrings.integer]
    
    inline def number: typingsJapgolly.wpapi.wpapiStrings.number = "number".asInstanceOf[typingsJapgolly.wpapi.wpapiStrings.number]
    
    inline def `object`: typingsJapgolly.wpapi.wpapiStrings.`object` = "object".asInstanceOf[typingsJapgolly.wpapi.wpapiStrings.`object`]
    
    inline def string: typingsJapgolly.wpapi.wpapiStrings.string = "string".asInstanceOf[typingsJapgolly.wpapi.wpapiStrings.string]
  }
  ...
  */
  ...
  object HTTPMethod {
    ...
    inline def DELETE: typingsJapgolly.wpapi.wpapiStrings.DELETE = "DELETE".asInstanceOf[typingsJapgolly.wpapi.wpapiStrings.DELETE]
    
    inline def GET: typingsJapgolly.wpapi.wpapiStrings.GET = "GET".asInstanceOf[typingsJapgolly.wpapi.wpapiStrings.GET]
    
    inline def PATCH: typingsJapgolly.wpapi.wpapiStrings.PATCH = "PATCH".asInstanceOf[typingsJapgolly.wpapi.wpapiStrings.PATCH]
    
    inline def POST: typingsJapgolly.wpapi.wpapiStrings.POST = "POST".asInstanceOf[typingsJapgolly.wpapi.wpapiStrings.POST]
    
    inline def PUT: typingsJapgolly.wpapi.wpapiStrings.PUT = "PUT".asInstanceOf[typingsJapgolly.wpapi.wpapiStrings.PUT]
  }
  ...
  object Route {
    ...
    extension [Self <: Route](x: Self) {
      ...
      inline def set_links(value: typingsJapgolly.wpapi.anon.Self): Self = StObject.set(x, "_links", value.asInstanceOf[js.Any])
