package typingsJapgolly.webAppManifest

import typingsJapgolly.std.OrientationLockType
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.webAppManifest.webAppManifestStrings.fullscreen
    - typingsJapgolly.webAppManifest.webAppManifestStrings.standalone
    - typingsJapgolly.webAppManifest.webAppManifestStrings.`minimal-ui`
    - typingsJapgolly.webAppManifest.webAppManifestStrings.browser
  */
  trait DisplayModeType extends StObject
  object DisplayModeType {
    
    inline def browser: typingsJapgolly.webAppManifest.webAppManifestStrings.browser = "browser".asInstanceOf[typingsJapgolly.webAppManifest.webAppManifestStrings.browser]
    
    inline def fullscreen: typingsJapgolly.webAppManifest.webAppManifestStrings.fullscreen = "fullscreen".asInstanceOf[typingsJapgolly.webAppManifest.webAppManifestStrings.fullscreen]
    
    inline def `minimal-ui`: typingsJapgolly.webAppManifest.webAppManifestStrings.`minimal-ui` = "minimal-ui".asInstanceOf[typingsJapgolly.webAppManifest.webAppManifestStrings.`minimal-ui`]
    
    inline def standalone: typingsJapgolly.webAppManifest.webAppManifestStrings.standalone = "standalone".asInstanceOf[typingsJapgolly.webAppManifest.webAppManifestStrings.standalone]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.webAppManifest.webAppManifestStrings.ltr
    - typingsJapgolly.webAppManifest.webAppManifestStrings.rtl
    - typingsJapgolly.webAppManifest.webAppManifestStrings.auto
  */
  trait TextDirectionType extends StObject
  object TextDirectionType {
    
    inline def auto: typingsJapgolly.webAppManifest.webAppManifestStrings.auto = "auto".asInstanceOf[typingsJapgolly.webAppManifest.webAppManifestStrings.auto]
    
    inline def ltr: typingsJapgolly.webAppManifest.webAppManifestStrings.ltr = "ltr".asInstanceOf[typingsJapgolly.webAppManifest.webAppManifestStrings.ltr]
    
    inline def rtl: typingsJapgolly.webAppManifest.webAppManifestStrings.rtl = "rtl".asInstanceOf[typingsJapgolly.webAppManifest.webAppManifestStrings.rtl]
  }
