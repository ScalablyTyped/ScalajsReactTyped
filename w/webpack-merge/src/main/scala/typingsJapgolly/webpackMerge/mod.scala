...
import typingsJapgolly.webpackMerge.distTypesMod.CustomizeRule
import typingsJapgolly.webpackMerge.distTypesMod.CustomizeRuleString
import typingsJapgolly.webpackMerge.distTypesMod.ICustomizeOptions
import typingsJapgolly.webpackMerge.distTypesMod.Key
import typingsJapgolly.webpackMerge.webpackMergeBooleans.`false`
...
object mod {
  ...
  object CustomizeRule extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.webpackMerge.distTypesMod.CustomizeRule & String] = js.native
