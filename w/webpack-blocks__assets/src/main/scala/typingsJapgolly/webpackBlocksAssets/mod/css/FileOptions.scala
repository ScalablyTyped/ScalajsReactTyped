...
object FileOptions {
  ...
  def apply(
    ...
    postTransformPublicPath: /* p */ String => CallbackTo[String] = null,
    ...
    if (postTransformPublicPath != null) __obj.updateDynamic("postTransformPublicPath")(js.Any.fromFunction1((t0: /* p */ java.lang.String) => postTransformPublicPath(t0).runNow()))
