...
object global {
  ...
  open class NDEFMessage protected ()
    extends StObject
       with typingsJapgolly.w3cWebNfc.NDEFMessage {
    def this(messageInit: NDEFMessageInit) = this()
    
    /* CompleteClass */
    var records: js.Array[typingsJapgolly.w3cWebNfc.NDEFRecord] = js.native
  }
  ...
  open class NDEFReader ()
    extends StObject
       with typingsJapgolly.w3cWebNfc.NDEFReader
  
  @JSGlobal("NDEFReadingEvent")
  @js.native
  open class NDEFReadingEvent protected ()
    extends StObject
       with typingsJapgolly.w3cWebNfc.NDEFReadingEvent {
  ...
  open class NDEFRecord protected ()
    extends StObject
       with typingsJapgolly.w3cWebNfc.NDEFRecord {
