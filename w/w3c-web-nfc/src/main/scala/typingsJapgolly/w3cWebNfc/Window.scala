...
trait Window extends StObject {
  ...
  var NDEFMessage: typingsJapgolly.w3cWebNfc.NDEFMessage
  
  var NDEFReader: typingsJapgolly.w3cWebNfc.NDEFReader
  
  var NDEFReadingEvent: typingsJapgolly.w3cWebNfc.NDEFReadingEvent
  
  var NDEFRecord: typingsJapgolly.w3cWebNfc.NDEFRecord
}
object Window {
