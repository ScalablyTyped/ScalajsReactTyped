...
object Promise extends js.Object {
  ...
  class CancellationError () extends Error {
    ...
    @JSName("name")
    var name_CancellationError: typingsJapgolly.workerpool.workerpoolStrings.CancellationError = js.native
  }
  ...
  class TimeoutError () extends Error {
    ...
    override var name: String = js.native
    @JSName("name")
    var name_TimeoutError: typingsJapgolly.workerpool.workerpoolStrings.TimeoutError = js.native
  }
