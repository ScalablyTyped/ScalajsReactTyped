package typingsJapgolly.workerpool.mod

import typingsJapgolly.node.childProcessMod.ForkOptions
import typingsJapgolly.workerpool.workerpoolStrings.auto
import typingsJapgolly.workerpool.workerpoolStrings.max
import typingsJapgolly.workerpool.workerpoolStrings.process
import typingsJapgolly.workerpool.workerpoolStrings.thread
import typingsJapgolly.workerpool.workerpoolStrings.web
