...
import typingsJapgolly.workerpool.anon.On
import typingsJapgolly.workerpool.workerpoolStrings.auto
import typingsJapgolly.workerpool.workerpoolStrings.browser
import typingsJapgolly.workerpool.workerpoolStrings.max
import typingsJapgolly.workerpool.workerpoolStrings.node
