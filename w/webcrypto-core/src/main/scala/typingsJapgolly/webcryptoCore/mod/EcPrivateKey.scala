...
object EcPrivateKey {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(fromJSON = js.Any.fromFunction1(fromJSON), privateKey = privateKey.asInstanceOf[js.Any], toJSON = toJSON.toJsFn, version = version.asInstanceOf[js.Any])
