...
object CryptoStorage {
  ...
  inline def apply[T](
    ...
    val __obj = js.Dynamic.literal(clear = clear.toJsFn, getItem = js.Any.fromFunction1(getItem), hasItem = js.Any.fromFunction1(hasItem), indexOf = js.Any.fromFunction1(indexOf), keys = keys.toJsFn, removeItem = js.Any.fromFunction1(removeItem), setItem = js.Any.fromFunction1(setItem))
