...
object CryptoKey {
  ...
  /* static member */
  inline def create[T /* <: CryptoKey1 */](algorithm: Algorithm, `type`: KeyType, extractable: Boolean, usages: KeyUsages): T = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(algorithm.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], extractable.asInstanceOf[js.Any], usages.asInstanceOf[js.Any])).asInstanceOf[T]
