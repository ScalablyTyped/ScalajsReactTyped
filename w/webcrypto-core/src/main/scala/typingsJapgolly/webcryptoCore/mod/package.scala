...
import typingsJapgolly.webcryptoCore.mod.^
...
type NativeCrypto = org.scalajs.dom.Crypto

type NativeCryptoKey = org.scalajs.dom.CryptoKey

type NativeSubtleCrypto = org.scalajs.dom.SubtleCrypto
