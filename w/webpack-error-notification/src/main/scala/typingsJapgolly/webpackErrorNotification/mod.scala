...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.webpackErrorNotification.webpackErrorNotificationStrings.darwin
    - typingsJapgolly.webpackErrorNotification.webpackErrorNotificationStrings.linux
  ...
  */
  ...
  object WebpackErrorNotificationPlugin {
    ...
    inline def apply(compilationDone: Stats => Callback, compileMessage: Stats => String): WebpackErrorNotificationPlugin = {
      val __obj = js.Dynamic.literal(compilationDone = js.Any.fromFunction1((t0: Stats) => compilationDone(t0).runNow()), compileMessage = js.Any.fromFunction1(compileMessage))
      __obj.asInstanceOf[WebpackErrorNotificationPlugin]
    }
    
    extension [Self <: WebpackErrorNotificationPlugin](x: Self) {
      
      inline def setCompilationDone(value: Stats => Callback): Self = StObject.set(x, "compilationDone", js.Any.fromFunction1((t0: Stats) => value(t0).runNow()))
