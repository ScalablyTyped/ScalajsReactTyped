...
object global {
  ...
  open class AbsoluteOrientationSensor ()
    extends StObject
       with typingsJapgolly.w3cGenericSensor.OrientationSensor {
  ...
  open class Accelerometer ()
    extends StObject
       with typingsJapgolly.w3cGenericSensor.Accelerometer {
    def this(options: MotionSensorOptions) = this()
  }
  ...
  open class AmbientLightSensor ()
    extends StObject
       with typingsJapgolly.w3cGenericSensor.AmbientLightSensor {
  ...
  open class Gyroscope ()
    extends StObject
       with typingsJapgolly.w3cGenericSensor.Gyroscope {
    def this(options: MotionSensorOptions) = this()
  }
  ...
  open class Magnetometer ()
    extends StObject
       with typingsJapgolly.w3cGenericSensor.Magnetometer {
    def this(options: MotionSensorOptions) = this()
  }
  ...
  open class Sensor ()
    extends StObject
       with typingsJapgolly.w3cGenericSensor.Sensor
  
  @JSGlobal("SensorErrorEvent")
  @js.native
  open class SensorErrorEvent protected ()
    extends StObject
       with typingsJapgolly.w3cGenericSensor.SensorErrorEvent {
  ...
  open class UncalibratedMagnetometer ()
    extends StObject
       with typingsJapgolly.w3cGenericSensor.UncalibratedMagnetometer {
    def this(options: MotionSensorOptions) = this()
  }
}
