...
import typingsJapgolly.w3cGenericSensor.w3cGenericSensorStrings.activate
import typingsJapgolly.w3cGenericSensor.w3cGenericSensorStrings.error
import typingsJapgolly.w3cGenericSensor.w3cGenericSensorStrings.reading
