...
object mod extends js.Object {
  ...
  def dropWhile[T](fn: Filter_[T], iter: js.Iterable[T]): WuIterable[T] = js.native
  ...
  def every[T](fn: Filter_[T], iter: js.Iterable[T]): Boolean = js.native
  def filter[T](fn: Filter_[T], iter: js.Iterable[T]): WuIterable[T] = js.native
  @JSName("filter")
  def filter_TS_T[T, S /* <: T */](fn: TypeGuardFilter[T, S], iter: js.Iterable[T]): WuIterable[S] = js.native
