...
import typingsJapgolly.winstonMail.AnonCa
import typingsJapgolly.winstonMail.AnonCiphers
...
object MailTransportOptions {
  ...
  def apply(
    ...
    filter: /* obj */ AnonLevel => CallbackTo[Boolean] = null,
    formatter: /* obj */ AnonLevel => CallbackTo[String] = null,
    from: String = null,
    ...
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction1((t0: /* obj */ typingsJapgolly.winstonMail.AnonLevel) => filter(t0).runNow()))
    if (formatter != null) __obj.updateDynamic("formatter")(js.Any.fromFunction1((t0: /* obj */ typingsJapgolly.winstonMail.AnonLevel) => formatter(t0).runNow()))
