...
import typingsJapgolly.webmidi.webmidiStrings.output
import typingsJapgolly.webmidi.webmidiStrings.statechange
...
object WebMidi {
  ...
  */
  ...
  object MIDIPortConnectionState {
    ...
    inline def closed: typingsJapgolly.webmidi.webmidiStrings.closed = "closed".asInstanceOf[typingsJapgolly.webmidi.webmidiStrings.closed]
    
    inline def open: typingsJapgolly.webmidi.webmidiStrings.open = "open".asInstanceOf[typingsJapgolly.webmidi.webmidiStrings.open]
    
    inline def pending: typingsJapgolly.webmidi.webmidiStrings.pending = "pending".asInstanceOf[typingsJapgolly.webmidi.webmidiStrings.pending]
  }
  ...
  */
  ...
  object MIDIPortDeviceState {
    ...
    inline def connected: typingsJapgolly.webmidi.webmidiStrings.connected = "connected".asInstanceOf[typingsJapgolly.webmidi.webmidiStrings.connected]
    
    inline def disconnected: typingsJapgolly.webmidi.webmidiStrings.disconnected = "disconnected".asInstanceOf[typingsJapgolly.webmidi.webmidiStrings.disconnected]
  }
  ...
  */
  ...
  object MIDIPortType {
    ...
    inline def input: typingsJapgolly.webmidi.webmidiStrings.input = "input".asInstanceOf[typingsJapgolly.webmidi.webmidiStrings.input]
    
    inline def output: typingsJapgolly.webmidi.webmidiStrings.output = "output".asInstanceOf[typingsJapgolly.webmidi.webmidiStrings.output]
  }
}
