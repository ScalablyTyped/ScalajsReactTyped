package typingsJapgolly.webpackMergeAndIncludeGlobally

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.webpack.mod.Compiler
import typingsJapgolly.webpackMergeAndIncludeGlobally.anon.Dest
...
object mod {
  ...
  object MergeIntoFile {
    ...
    inline def apply(apply: Compiler => Callback): MergeIntoFile = {
