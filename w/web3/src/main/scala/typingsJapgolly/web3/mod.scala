...
object mod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    override val currentProvider: typingsJapgolly.web3Core.mod.provider = js.native
    ...
    /* CompleteClass */
    override def setProvider(provider: typingsJapgolly.web3Core.mod.provider): Boolean = js.native
