...
object PostPublishPanel {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def PostPublishExtension(value: ComponentType[js.Object]): this.type = set("PostPublishExtension", value.asInstanceOf[js.Any])
    
    inline def PrePublishExtension(value: ComponentType[js.Object]): this.type = set("PrePublishExtension", value.asInstanceOf[js.Any])
