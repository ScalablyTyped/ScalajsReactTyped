...
import typingsJapgolly.wordpressEditor.componentsEditorNoticesMod.EditorNotices.Props
...
object EditorNotices {
  ...
  implicit def make(companion: EditorNotices.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
