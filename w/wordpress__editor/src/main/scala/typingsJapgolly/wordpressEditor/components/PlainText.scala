...
import typingsJapgolly.wordpressBlockEditor.anon.TypeofTextareaAutosize
import typingsJapgolly.wordpressBlockEditor.componentsPlainTextMod.PlainText.Props
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.`additions removals`
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.`additions text`
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.`inline`
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.`removals additions`
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.`removals text`
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.`text additions`
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.`text removals`
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.additions
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.all
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.ascending
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.assertive
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.both
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.copy
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.date
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.decimal
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.descending
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.dialog
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.email
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.environment
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.execute
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.grammar
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.grid
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.horizontal
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.inherit
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.link
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.list
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.listbox
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.location
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.menu
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.mixed
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.move
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.no
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.none
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.numeric
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.off
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.on
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.other
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.page
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.polite
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.popup
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.removals
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.search
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.spelling
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.step
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.tel
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.text
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.time
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.tree
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.url
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.user
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.vertical
import typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.yes
...
object PlainText {
  ...
  inline def apply(onChange: String => Callback, value: String): Builder = {
    val __props = js.Dynamic.literal(onChange = js.Any.fromFunction1((t0: String) => onChange(t0).runNow()), value = value.asInstanceOf[js.Any])
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[TypeofTextareaAutosize] {
    ...
    inline def onResize(value: /* e */ Event => Callback): this.type = set("onResize", js.Any.fromFunction1((t0: /* e */ Event) => value(t0).runNow()))
