...
import typingsJapgolly.watsonDeveloperCloud.compareComplyV1Mod.CompareDocumentsConstants.File1ContentType
import typingsJapgolly.watsonDeveloperCloud.compareComplyV1Mod.CompareDocumentsConstants.File2ContentType
import typingsJapgolly.watsonDeveloperCloud.compareComplyV1Mod.CompareDocumentsConstants.Model
