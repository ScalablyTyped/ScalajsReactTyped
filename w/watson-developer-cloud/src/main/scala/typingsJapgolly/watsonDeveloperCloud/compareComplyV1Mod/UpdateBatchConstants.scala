...
object UpdateBatchConstants {
  ...
  object Action extends StObject {
    ...
    sealed trait CANCEL
      extends StObject
         with Action
    /* "cancel" */ val CANCEL: typingsJapgolly.watsonDeveloperCloud.compareComplyV1Mod.UpdateBatchConstants.Action.CANCEL & String = js.native
    
    @js.native
    sealed trait RESCAN
      extends StObject
         with Action
    /* "rescan" */ val RESCAN: typingsJapgolly.watsonDeveloperCloud.compareComplyV1Mod.UpdateBatchConstants.Action.RESCAN & String = js.native
  }
  ...
  object Model extends StObject {
    ...
    sealed trait CONTRACTS
      extends StObject
         with Model
    /* "contracts" */ val CONTRACTS: typingsJapgolly.watsonDeveloperCloud.compareComplyV1Mod.UpdateBatchConstants.Model.CONTRACTS & String = js.native
    
    @js.native
    sealed trait TABLES
      extends StObject
         with Model
    /* "tables" */ val TABLES: typingsJapgolly.watsonDeveloperCloud.compareComplyV1Mod.UpdateBatchConstants.Model.TABLES & String = js.native
  }
}
