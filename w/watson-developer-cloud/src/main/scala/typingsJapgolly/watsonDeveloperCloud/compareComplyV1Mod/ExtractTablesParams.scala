...
import typingsJapgolly.watsonDeveloperCloud.compareComplyV1Mod.ExtractTablesConstants.FileContentType
import typingsJapgolly.watsonDeveloperCloud.compareComplyV1Mod.ExtractTablesConstants.Model
