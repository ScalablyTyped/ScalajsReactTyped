...
import typingsJapgolly.watsonDeveloperCloud.textToSpeechV1GeneratedMod.SynthesizeConstants.Accept
...
object SynthesizeParams {
  ...
  def apply(
    ...
    voice: typingsJapgolly.watsonDeveloperCloud.textToSpeechV1GeneratedMod.SynthesizeConstants.Voice | String = null
  ): SynthesizeParams = {
