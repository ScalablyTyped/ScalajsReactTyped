...
object GetWorkspaceConstants extends js.Object {
  ...
  object Sort extends js.Object {
    /* "stable" */ val STABLE: typingsJapgolly.watsonDeveloperCloud.mod.GetWorkspaceConstants.Sort.STABLE with String = js.native
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.watsonDeveloperCloud.mod.GetWorkspaceConstants.Sort with String] = js.native
  }
