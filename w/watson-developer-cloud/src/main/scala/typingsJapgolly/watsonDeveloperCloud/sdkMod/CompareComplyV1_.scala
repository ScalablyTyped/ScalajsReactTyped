...
import typingsJapgolly.watsonDeveloperCloud.compareComplyV1Mod.Options
import typingsJapgolly.watsonDeveloperCloud.compareComplyV1Mod.^
...
@js.native
class CompareComplyV1_ protected () extends ^ {
  /**
