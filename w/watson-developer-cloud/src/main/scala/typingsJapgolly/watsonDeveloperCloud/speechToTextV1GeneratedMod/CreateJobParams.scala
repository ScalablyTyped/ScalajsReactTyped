...
import typingsJapgolly.watsonDeveloperCloud.speechToTextV1GeneratedMod.CreateJobConstants.ContentType
import typingsJapgolly.watsonDeveloperCloud.speechToTextV1GeneratedMod.CreateJobConstants.Events
import typingsJapgolly.watsonDeveloperCloud.speechToTextV1GeneratedMod.CreateJobConstants.Model
