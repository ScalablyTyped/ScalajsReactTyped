...
import typingsJapgolly.watsonDeveloperCloud.speechToTextV1GeneratedMod.AddAudioConstants.ContainedContentType
import typingsJapgolly.watsonDeveloperCloud.speechToTextV1GeneratedMod.AddAudioConstants.ContentType
