...
import typingsJapgolly.watsonDeveloperCloud.speechToTextV1GeneratedMod.GetModelConstants.ModelId
...
object GetModelParams {
  ...
  inline def apply(model_id: ModelId | String): GetModelParams = {
  ...
  extension [Self <: GetModelParams](x: Self) {
    ...
    inline def setModel_id(value: ModelId | String): Self = StObject.set(x, "model_id", value.asInstanceOf[js.Any])
