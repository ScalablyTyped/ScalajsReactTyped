...
import typingsJapgolly.watsonDeveloperCloud.assistantV1Mod.ListIntentsConstants.Sort
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/** Parameters for the `listIntents` operation. */
trait ListIntentsParams extends StObject {
...
object ListIntentsParams {
  ...
  inline def apply(workspace_id: String): ListIntentsParams = {
