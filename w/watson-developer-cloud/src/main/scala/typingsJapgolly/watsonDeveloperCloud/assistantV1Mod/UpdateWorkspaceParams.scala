...
object UpdateWorkspaceParams {
  ...
  inline def apply(workspace_id: String): UpdateWorkspaceParams = {
  ...
  extension [Self <: UpdateWorkspaceParams](x: Self) {
    ...
    inline def setCounterexamplesVarargs(value: Counterexample*): Self = StObject.set(x, "counterexamples", js.Array(value*))
    ...
    inline def setEntities(value: js.Array[CreateEntity]): Self = StObject.set(x, "entities", value.asInstanceOf[js.Any])
    
    inline def setEntitiesUndefined: Self = StObject.set(x, "entities", js.undefined)
    
    inline def setEntitiesVarargs(value: CreateEntity*): Self = StObject.set(x, "entities", js.Array(value*))
    
    inline def setHeaders(value: js.Object): Self = StObject.set(x, "headers", value.asInstanceOf[js.Any])
    
    inline def setHeadersUndefined: Self = StObject.set(x, "headers", js.undefined)
    
    inline def setIntents(value: js.Array[CreateIntent]): Self = StObject.set(x, "intents", value.asInstanceOf[js.Any])
    
    inline def setIntentsUndefined: Self = StObject.set(x, "intents", js.undefined)
    
    inline def setIntentsVarargs(value: CreateIntent*): Self = StObject.set(x, "intents", js.Array(value*))
    ...
    inline def setLearning_opt_outUndefined: Self = StObject.set(x, "learning_opt_out", js.undefined)
