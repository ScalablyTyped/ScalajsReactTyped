...
object ListEntitiesConstants {
  ...
  object Sort extends StObject {
    ...
    sealed trait ENTITY
      extends StObject
         with Sort
    /* "entity" */ val ENTITY: typingsJapgolly.watsonDeveloperCloud.assistantV1Mod.ListEntitiesConstants.Sort.ENTITY & String = js.native
    
    @js.native
    sealed trait UPDATED
      extends StObject
         with Sort
    /* "updated" */ val UPDATED: typingsJapgolly.watsonDeveloperCloud.assistantV1Mod.ListEntitiesConstants.Sort.UPDATED & String = js.native
  }
}
