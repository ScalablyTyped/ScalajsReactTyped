...
object ListValuesConstants {
  ...
  object Sort extends StObject {
    ...
    sealed trait UPDATED
      extends StObject
         with Sort
    /* "updated" */ val UPDATED: typingsJapgolly.watsonDeveloperCloud.assistantV1Mod.ListValuesConstants.Sort.UPDATED & String = js.native
    
    @js.native
    sealed trait VALUE
      extends StObject
         with Sort
    /* "value" */ val VALUE: typingsJapgolly.watsonDeveloperCloud.assistantV1Mod.ListValuesConstants.Sort.VALUE & String = js.native
  }
}
