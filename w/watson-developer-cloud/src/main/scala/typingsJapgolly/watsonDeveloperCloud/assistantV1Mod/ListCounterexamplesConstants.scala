...
object ListCounterexamplesConstants {
  ...
  object Sort extends StObject {
    ...
    sealed trait TEXT
      extends StObject
         with Sort
    /* "text" */ val TEXT: typingsJapgolly.watsonDeveloperCloud.assistantV1Mod.ListCounterexamplesConstants.Sort.TEXT & String = js.native
    
    @js.native
    sealed trait UPDATED
      extends StObject
         with Sort
    /* "updated" */ val UPDATED: typingsJapgolly.watsonDeveloperCloud.assistantV1Mod.ListCounterexamplesConstants.Sort.UPDATED & String = js.native
  }
}
