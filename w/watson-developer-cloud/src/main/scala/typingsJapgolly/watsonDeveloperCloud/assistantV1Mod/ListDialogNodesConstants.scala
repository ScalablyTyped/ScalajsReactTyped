...
object ListDialogNodesConstants {
  ...
  object Sort extends StObject {
    ...
    sealed trait DIALOG_NODE
      extends StObject
         with Sort
    /* "dialog_node" */ val DIALOG_NODE: typingsJapgolly.watsonDeveloperCloud.assistantV1Mod.ListDialogNodesConstants.Sort.DIALOG_NODE & String = js.native
    
    @js.native
    sealed trait UPDATED
      extends StObject
         with Sort
    /* "updated" */ val UPDATED: typingsJapgolly.watsonDeveloperCloud.assistantV1Mod.ListDialogNodesConstants.Sort.UPDATED & String = js.native
  }
}
