...
object ListSynonymsConstants {
  ...
  object Sort extends StObject {
    ...
    sealed trait SYNONYM
      extends StObject
         with Sort
    /* "synonym" */ val SYNONYM: typingsJapgolly.watsonDeveloperCloud.assistantV1Mod.ListSynonymsConstants.Sort.SYNONYM & String = js.native
    
    @js.native
    sealed trait UPDATED
      extends StObject
         with Sort
    /* "updated" */ val UPDATED: typingsJapgolly.watsonDeveloperCloud.assistantV1Mod.ListSynonymsConstants.Sort.UPDATED & String = js.native
  }
}
