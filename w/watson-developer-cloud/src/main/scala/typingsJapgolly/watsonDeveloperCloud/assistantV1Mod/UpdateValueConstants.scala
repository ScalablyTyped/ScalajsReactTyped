...
object UpdateValueConstants {
  ...
  object ValueType extends StObject {
    ...
    sealed trait PATTERNS
      extends StObject
         with ValueType
    /* "patterns" */ val PATTERNS: typingsJapgolly.watsonDeveloperCloud.assistantV1Mod.UpdateValueConstants.ValueType.PATTERNS & String = js.native
    
    @js.native
    sealed trait SYNONYMS
      extends StObject
         with ValueType
    /* "synonyms" */ val SYNONYMS: typingsJapgolly.watsonDeveloperCloud.assistantV1Mod.UpdateValueConstants.ValueType.SYNONYMS & String = js.native
  }
}
