...
trait GetValueParams extends StObject {
...
object GetValueParams {
  ...
  inline def apply(entity: String, value: String, workspace_id: String): GetValueParams = {
  ...
  extension [Self <: GetValueParams](x: Self) {
