package typingsJapgolly.watsonDeveloperCloud.speechToTextV1Mod
...
trait SpeechToTextV1
  ...
  /**
    ...
    */
  def recognizeUsingWebSocket(params: js.Any): typingsJapgolly.watsonDeveloperCloud.recognizeStreamMod.^ = js.native
  /**
