...
trait AssistantV2 extends BaseService {
  ...
  /**
    ...
    */
  def createSession(params: CreateSessionParams): js.Promise[Any] | Unit = js.native
  def createSession(params: CreateSessionParams, callback: Callback[SessionResponse]): js.Promise[Any] | Unit = js.native
  ...
  /**
    ...
    * @returns {Promise<any>|void}
    */
  def deleteSession(params: DeleteSessionParams): js.Promise[Any] | Unit = js.native
  def deleteSession(params: DeleteSessionParams, callback: Callback[Empty]): js.Promise[Any] | Unit = js.native
