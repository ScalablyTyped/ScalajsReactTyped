...
object MessageOutputDebug {
  ...
  extension [Self <: MessageOutputDebug](x: Self) {
    ...
    inline def setLog_messagesVarargs(value: DialogLogMessage*): Self = StObject.set(x, "log_messages", js.Array(value*))
    ...
    inline def setNodes_visitedVarargs(value: DialogNodesVisited*): Self = StObject.set(x, "nodes_visited", js.Array(value*))
  }
}
