...
trait LanguageTranslatorV3 extends BaseService {
  ...
  /**
    ...
    */
  def createModel(params: CreateModelParams): js.Promise[Any] | Unit = js.native
  def createModel(params: CreateModelParams, callback: Callback[TranslationModel]): js.Promise[Any] | Unit = js.native
  ...
  def deleteModel(params: DeleteModelParams, callback: Callback[DeleteModelResult]): js.Promise[Any] | Unit = js.native
  ...
  def getModel(params: GetModelParams, callback: Callback[TranslationModel]): js.Promise[Any] | Unit = js.native
  ...
  /**
    ...
    * @returns {Promise<any>|void}
    */
  def identify(params: IdentifyParams): js.Promise[Any] | Unit = js.native
  def identify(params: IdentifyParams, callback: Callback[IdentifiedLanguages]): js.Promise[Any] | Unit = js.native
  ...
  /**
    ...
    * @returns {Promise<any>|void}
    */
  def listIdentifiableLanguages(): js.Promise[Any] | Unit = js.native
  def listIdentifiableLanguages(params: Unit, callback: Callback[IdentifiableLanguages]): js.Promise[Any] | Unit = js.native
  def listIdentifiableLanguages(params: ListIdentifiableLanguagesParams): js.Promise[Any] | Unit = js.native
  def listIdentifiableLanguages(params: ListIdentifiableLanguagesParams, callback: Callback[IdentifiableLanguages]): js.Promise[Any] | Unit = js.native
  ...
  def listModels(params: Unit, callback: Callback[TranslationModels]): js.Promise[Any] | Unit = js.native
  def listModels(params: ListModelsParams): js.Promise[Any] | Unit = js.native
  def listModels(params: ListModelsParams, callback: Callback[TranslationModels]): js.Promise[Any] | Unit = js.native
  ...
  /**
    ...
    * @returns {Promise<any>|void}
    */
  def translate(params: TranslateParams): js.Promise[Any] | Unit = js.native
  def translate(params: TranslateParams, callback: Callback[TranslationResult]): js.Promise[Any] | Unit = js.native
}
