package typingsJapgolly.watsonDeveloperCloud.personalityInsightsV3GeneratedMod
...
trait PersonalityInsightsV3 extends BaseService {
  ...
  /**
    ...
    */
  def profile(params: ProfileParams): js.Promise[Any] | Unit = js.native
  def profile(params: ProfileParams, callback: Callback[Profile]): js.Promise[Any] | Unit = js.native
  ...
  /**
    ...
    * @returns {Promise<any>|void}
    */
  def profileAsCsv(params: ProfileAsCsvParams): js.Promise[Any] | Unit = js.native
  def profileAsCsv(params: ProfileAsCsvParams, callback: Callback[ReadableStream | FileObject | Buffer]): js.Promise[Any] | Unit = js.native
