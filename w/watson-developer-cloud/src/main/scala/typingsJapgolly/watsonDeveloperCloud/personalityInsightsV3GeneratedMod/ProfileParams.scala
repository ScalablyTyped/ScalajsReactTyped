...
import typingsJapgolly.watsonDeveloperCloud.personalityInsightsV3GeneratedMod.ProfileConstants.AcceptLanguage
import typingsJapgolly.watsonDeveloperCloud.personalityInsightsV3GeneratedMod.ProfileConstants.ContentLanguage
import typingsJapgolly.watsonDeveloperCloud.personalityInsightsV3GeneratedMod.ProfileConstants.ContentType
