package typingsJapgolly.watsonDeveloperCloud.textToSpeechV1Mod
...
trait TextToSpeechV1
  extends typingsJapgolly.watsonDeveloperCloud.textToSpeechV1GeneratedMod.^ {
  /**
  ...
  /**
    ...
    */
  def synthesizeUsingWebSocket(params: js.Any): typingsJapgolly.watsonDeveloperCloud.synthesizeStreamMod.^ = js.native
}
