...
trait DeleteConfigurationParams extends StObject {
...
object DeleteConfigurationParams {
  ...
  inline def apply(configuration_id: String, environment_id: String): DeleteConfigurationParams = {
  ...
  extension [Self <: DeleteConfigurationParams](x: Self) {
