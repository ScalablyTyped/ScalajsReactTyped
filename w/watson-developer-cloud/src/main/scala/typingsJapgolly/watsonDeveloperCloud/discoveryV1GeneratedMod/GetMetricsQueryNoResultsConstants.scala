...
object GetMetricsQueryNoResultsConstants {
  ...
  object ResultType extends StObject {
    ...
    sealed trait DOCUMENT
      extends StObject
         with ResultType
    /* "document" */ val DOCUMENT: typingsJapgolly.watsonDeveloperCloud.discoveryV1GeneratedMod.GetMetricsQueryNoResultsConstants.ResultType.DOCUMENT & String = js.native
  }
}
