...
import typingsJapgolly.watsonDeveloperCloud.discoveryV1GeneratedMod.UpdateCredentialsConstants.SourceType
...
object UpdateCredentialsParams {
  ...
  extension [Self <: UpdateCredentialsParams](x: Self) {
