...
import typingsJapgolly.watsonDeveloperCloud.v3GeneratedMod.ProfileConstants.AcceptLanguage
import typingsJapgolly.watsonDeveloperCloud.v3GeneratedMod.ProfileConstants.ContentLanguage
import typingsJapgolly.watsonDeveloperCloud.v3GeneratedMod.ProfileConstants.ContentType
