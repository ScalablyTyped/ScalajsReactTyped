...
object xmlyMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.wechatMiniprogramXmly.wechatMiniprogramXmlyStrings.GET
    - typingsJapgolly.wechatMiniprogramXmly.wechatMiniprogramXmlyStrings.POST
  */
  trait RequestType extends StObject
  object RequestType {
    
    inline def GET: typingsJapgolly.wechatMiniprogramXmly.wechatMiniprogramXmlyStrings.GET = "GET".asInstanceOf[typingsJapgolly.wechatMiniprogramXmly.wechatMiniprogramXmlyStrings.GET]
    
    inline def POST: typingsJapgolly.wechatMiniprogramXmly.wechatMiniprogramXmlyStrings.POST = "POST".asInstanceOf[typingsJapgolly.wechatMiniprogramXmly.wechatMiniprogramXmlyStrings.POST]
  }
