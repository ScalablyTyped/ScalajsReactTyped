...
object mod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    var options: typingsJapgolly.wechatMiniprogramXmly.mod.options = js.native
    
    /* CompleteClass */
    var player: typingsJapgolly.wechatMiniprogramXmly.playerMod.default = js.native
    
    /* CompleteClass */
    var xmly: typingsJapgolly.wechatMiniprogramXmly.xmlyMod.default = js.native
  }
  /* static members */
  object default {
  ...
  trait XMPlugin extends StObject {
    ...
    var options: typingsJapgolly.wechatMiniprogramXmly.mod.options
    
    var player: typingsJapgolly.wechatMiniprogramXmly.playerMod.default
    
    var xmly: typingsJapgolly.wechatMiniprogramXmly.xmlyMod.default
  }
  object XMPlugin {
    
    inline def apply(
      options: options,
      player: typingsJapgolly.wechatMiniprogramXmly.playerMod.default,
      xmly: typingsJapgolly.wechatMiniprogramXmly.xmlyMod.default
    ): XMPlugin = {
    ...
    extension [Self <: XMPlugin](x: Self) {
      ...
      inline def setPlayer(value: typingsJapgolly.wechatMiniprogramXmly.playerMod.default): Self = StObject.set(x, "player", value.asInstanceOf[js.Any])
      
      inline def setXmly(value: typingsJapgolly.wechatMiniprogramXmly.xmlyMod.default): Self = StObject.set(x, "xmly", value.asInstanceOf[js.Any])
    }
  }
