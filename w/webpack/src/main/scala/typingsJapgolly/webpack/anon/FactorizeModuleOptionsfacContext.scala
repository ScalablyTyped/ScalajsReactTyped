...
/* Inlined webpack.webpack.FactorizeModuleOptions & {  factoryResult :true} */
trait FactorizeModuleOptionsfacContext extends StObject {
  ...
  /**
  	 ...
  	 */
  var factoryResult: js.UndefOr[Boolean] & `true`
  
  var originModule: Null | typingsJapgolly.webpack.mod.Module
}
object FactorizeModuleOptionsfacContext {
  
  inline def apply(
    currentProfile: ModuleProfile,
    dependencies: js.Array[typingsJapgolly.webpack.mod.Dependency],
    factory: ModuleFactory,
    factoryResult: js.UndefOr[Boolean] & `true`
  ): FactorizeModuleOptionsfacContext = {
    ...
    __obj.asInstanceOf[FactorizeModuleOptionsfacContext]
  }
  
  extension [Self <: FactorizeModuleOptionsfacContext](x: Self) {
    ...
    inline def setFactoryResult(value: js.UndefOr[Boolean] & `true`): Self = StObject.set(x, "factoryResult", value.asInstanceOf[js.Any])
