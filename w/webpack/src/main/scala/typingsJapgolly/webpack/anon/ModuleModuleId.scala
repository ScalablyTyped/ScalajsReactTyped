...
trait ModuleModuleId extends StObject {
  ...
  var module: typingsJapgolly.webpack.NodeJS.Module
  
  var moduleId: String | Double
}
object ModuleModuleId {
  
  inline def apply(module: typingsJapgolly.webpack.NodeJS.Module, moduleId: String | Double): ModuleModuleId = {
  ...
  extension [Self <: ModuleModuleId](x: Self) {
    ...
    inline def setModule(value: typingsJapgolly.webpack.NodeJS.Module): Self = StObject.set(x, "module", value.asInstanceOf[js.Any])
