...
trait AutomaticNameDelimiter extends StObject {
  ...
  var chunks: js.UndefOr[
    all | initial | async | (js.Function1[/* chunk */ typingsJapgolly.webpack.mod.Chunk, Boolean])
  ] = js.undefined
...
object AutomaticNameDelimiter {
  ...
  extension [Self <: AutomaticNameDelimiter](x: Self) {
    ...
    inline def setChunks(
      value: all | initial | async | (js.Function1[/* chunk */ typingsJapgolly.webpack.mod.Chunk, Boolean])
    ): Self = StObject.set(x, "chunks", value.asInstanceOf[js.Any])
    
    inline def setChunksFunction1(value: /* chunk */ typingsJapgolly.webpack.mod.Chunk => Boolean): Self = StObject.set(x, "chunks", js.Any.fromFunction1(value))
