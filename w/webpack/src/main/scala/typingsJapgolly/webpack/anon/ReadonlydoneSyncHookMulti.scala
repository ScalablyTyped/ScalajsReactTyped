...
import typingsJapgolly.tapable.mod.MultiHook
...
trait ReadonlydoneSyncHookMulti extends StObject {
  ...
  val run: MultiHook[
    AsyncSeriesHook[js.Array[typingsJapgolly.webpack.mod.Compiler], UnsetAdditionalOptions]
  ]
  
  val watchClose: SyncHook[js.Array[Any], Unit, UnsetAdditionalOptions]
  
  val watchRun: MultiHook[
    AsyncSeriesHook[js.Array[typingsJapgolly.webpack.mod.Compiler], UnsetAdditionalOptions]
  ]
}
object ReadonlydoneSyncHookMulti {
  ...
  extension [Self <: ReadonlydoneSyncHookMulti](x: Self) {
    ...
    inline def setWatchRun(
      value: MultiHook[
          AsyncSeriesHook[js.Array[typingsJapgolly.webpack.mod.Compiler], UnsetAdditionalOptions]
        ]
    ): Self = StObject.set(x, "watchRun", value.asInstanceOf[js.Any])
  }
}
