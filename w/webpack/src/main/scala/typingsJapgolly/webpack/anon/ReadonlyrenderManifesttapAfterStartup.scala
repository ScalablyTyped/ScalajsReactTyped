...
import typingsJapgolly.webpack.mod.DependencyTemplates
...
trait ReadonlyrenderManifesttapAfterStartup extends StObject {
  ...
  val bootstrap: SyncWaterfallHook[
    js.Tuple5[String, typingsJapgolly.webpack.mod.Chunk, String, ModuleTemplate, DependencyTemplates], 
  ...
  val jsonpScript: SyncWaterfallHook[js.Tuple2[String, typingsJapgolly.webpack.mod.Chunk], UnsetAdditionalOptions]
  
  val linkPrefetch: SyncWaterfallHook[js.Tuple2[String, typingsJapgolly.webpack.mod.Chunk], UnsetAdditionalOptions]
  
  val linkPreload: SyncWaterfallHook[js.Tuple2[String, typingsJapgolly.webpack.mod.Chunk], UnsetAdditionalOptions]
  
  val localVars: SyncWaterfallHook[
    js.Tuple3[String, typingsJapgolly.webpack.mod.Chunk, String], 
    UnsetAdditionalOptions
  ]
  ...
  val requireEnsure: SyncWaterfallHook[
    js.Tuple4[String, typingsJapgolly.webpack.mod.Chunk, String, String], 
    UnsetAdditionalOptions
  ]
  
  val requireExtensions: SyncWaterfallHook[
    js.Tuple3[String, typingsJapgolly.webpack.mod.Chunk, String], 
    UnsetAdditionalOptions
  ]
...
object ReadonlyrenderManifesttapAfterStartup {
  ...
  inline def apply(
    ...
    hashForChunk: Tap,
    hotBootstrap: `0`,
    jsonpScript: SyncWaterfallHook[js.Tuple2[String, typingsJapgolly.webpack.mod.Chunk], UnsetAdditionalOptions],
    linkPrefetch: SyncWaterfallHook[js.Tuple2[String, typingsJapgolly.webpack.mod.Chunk], UnsetAdditionalOptions],
    linkPreload: SyncWaterfallHook[js.Tuple2[String, typingsJapgolly.webpack.mod.Chunk], UnsetAdditionalOptions],
  ...
  extension [Self <: ReadonlyrenderManifesttapAfterStartup](x: Self) {
    ...
    inline def setJsonpScript(
      value: SyncWaterfallHook[js.Tuple2[String, typingsJapgolly.webpack.mod.Chunk], UnsetAdditionalOptions]
    ): Self = StObject.set(x, "jsonpScript", value.asInstanceOf[js.Any])
    
    inline def setLinkPrefetch(
      value: SyncWaterfallHook[js.Tuple2[String, typingsJapgolly.webpack.mod.Chunk], UnsetAdditionalOptions]
    ): Self = StObject.set(x, "linkPrefetch", value.asInstanceOf[js.Any])
    
    inline def setLinkPreload(
      value: SyncWaterfallHook[js.Tuple2[String, typingsJapgolly.webpack.mod.Chunk], UnsetAdditionalOptions]
    ): Self = StObject.set(x, "linkPreload", value.asInstanceOf[js.Any])
