...
trait FailOnConflict extends StObject {
  ...
  /**
  		 ...
  		 */
  var test: js.UndefOr[js.Function1[/* arg0 */ typingsJapgolly.webpack.mod.Module, Boolean]] = js.undefined
}
object FailOnConflict {
  ...
  extension [Self <: FailOnConflict](x: Self) {
    ...
    inline def setTest(value: /* arg0 */ typingsJapgolly.webpack.mod.Module => Boolean): Self = StObject.set(x, "test", js.Any.fromFunction1(value))
