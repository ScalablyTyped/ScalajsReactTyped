...
import typingsJapgolly.webpack.mod.AssetEmittedInfo
import typingsJapgolly.webpack.mod.Compilation
import typingsJapgolly.webpack.mod.CompilationParams
import typingsJapgolly.webpack.mod.EntryNormalized
...
trait ReadonlyinitializeSyncHoo extends StObject {
  ...
  val afterPlugins: SyncHook[js.Array[typingsJapgolly.webpack.mod.Compiler], Unit, UnsetAdditionalOptions]
  
  val afterResolvers: SyncHook[js.Array[typingsJapgolly.webpack.mod.Compiler], Unit, UnsetAdditionalOptions]
  ...
  val beforeRun: AsyncSeriesHook[js.Array[typingsJapgolly.webpack.mod.Compiler], UnsetAdditionalOptions]
  ...
  val contextModuleFactory: SyncHook[
    js.Array[typingsJapgolly.webpack.mod.ContextModuleFactory], 
    Unit, 
  ...
  val run: AsyncSeriesHook[js.Array[typingsJapgolly.webpack.mod.Compiler], UnsetAdditionalOptions]
  ...
  val watchRun: AsyncSeriesHook[js.Array[typingsJapgolly.webpack.mod.Compiler], UnsetAdditionalOptions]
}
object ReadonlyinitializeSyncHoo {
  ...
  inline def apply(
    ...
    afterPlugins: SyncHook[js.Array[typingsJapgolly.webpack.mod.Compiler], Unit, UnsetAdditionalOptions],
    afterResolvers: SyncHook[js.Array[typingsJapgolly.webpack.mod.Compiler], Unit, UnsetAdditionalOptions],
    ...
    beforeRun: AsyncSeriesHook[js.Array[typingsJapgolly.webpack.mod.Compiler], UnsetAdditionalOptions],
    ...
    run: AsyncSeriesHook[js.Array[typingsJapgolly.webpack.mod.Compiler], UnsetAdditionalOptions],
    ...
    watchRun: AsyncSeriesHook[js.Array[typingsJapgolly.webpack.mod.Compiler], UnsetAdditionalOptions]
  ...
  extension [Self <: ReadonlyinitializeSyncHoo](x: Self) {
    ...
    inline def setAfterPlugins(value: SyncHook[js.Array[typingsJapgolly.webpack.mod.Compiler], Unit, UnsetAdditionalOptions]): Self = StObject.set(x, "afterPlugins", value.asInstanceOf[js.Any])
    
    inline def setAfterResolvers(value: SyncHook[js.Array[typingsJapgolly.webpack.mod.Compiler], Unit, UnsetAdditionalOptions]): Self = StObject.set(x, "afterResolvers", value.asInstanceOf[js.Any])
    ...
    inline def setBeforeRun(value: AsyncSeriesHook[js.Array[typingsJapgolly.webpack.mod.Compiler], UnsetAdditionalOptions]): Self = StObject.set(x, "beforeRun", value.asInstanceOf[js.Any])
    ...
    inline def setContextModuleFactory(
      value: SyncHook[
          js.Array[typingsJapgolly.webpack.mod.ContextModuleFactory], 
          Unit, 
          UnsetAdditionalOptions
        ]
    ): Self = StObject.set(x, "contextModuleFactory", value.asInstanceOf[js.Any])
    ...
    inline def setRun(value: AsyncSeriesHook[js.Array[typingsJapgolly.webpack.mod.Compiler], UnsetAdditionalOptions]): Self = StObject.set(x, "run", value.asInstanceOf[js.Any])
    ...
    inline def setWatchRun(value: AsyncSeriesHook[js.Array[typingsJapgolly.webpack.mod.Compiler], UnsetAdditionalOptions]): Self = StObject.set(x, "watchRun", value.asInstanceOf[js.Any])
  }
}
