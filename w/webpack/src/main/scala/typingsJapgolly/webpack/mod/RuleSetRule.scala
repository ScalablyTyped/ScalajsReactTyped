...
import typingsJapgolly.webpack.anon.Ident
...
trait RuleSetRule extends StObject {
  ...
  var use: js.UndefOr[
    String | js.Array[RuleSetUseItem] | (js.Function1[
      (/* data */ typingsJapgolly.webpack.anon.Compiler) | (/* data */ js.Object), 
...
object RuleSetRule {
  ...
  extension [Self <: RuleSetRule](x: Self) {
    ...
    inline def setUseFunction1(
      value: (/* data */ typingsJapgolly.webpack.anon.Compiler) | (/* data */ js.Object) => js.Array[RuleSetUseItem] | Ident | String | TypeWebpackOptions
