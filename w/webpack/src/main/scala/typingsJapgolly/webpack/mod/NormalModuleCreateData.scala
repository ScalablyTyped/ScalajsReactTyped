...
trait NormalModuleCreateData extends StObject {
  ...
  /**
  	 * the generator used
  	 */
  var generator: typingsJapgolly.std.Generator[Any, Any, Any]
...
object NormalModuleCreateData {
  ...
  inline def apply(
    context: String,
    generator: typingsJapgolly.std.Generator[Any, Any, Any],
  ...
  extension [Self <: NormalModuleCreateData](x: Self) {
    ...
    inline def setGenerator(value: typingsJapgolly.std.Generator[Any, Any, Any]): Self = StObject.set(x, "generator", value.asInstanceOf[js.Any])
