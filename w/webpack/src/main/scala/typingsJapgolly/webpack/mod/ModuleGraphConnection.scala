...
object ModuleGraphConnection {
  ...
  inline def apply(
    active: Unit,
    addCondition: js.Function2[ModuleGraphConnection, /* arg1 */ RuntimeSpec, ConnectionState] => Callback,
    addExplanation: String => Callback,
  ...
  extension [Self <: ModuleGraphConnection](x: Self) {
    ...
    inline def setAddCondition(value: js.Function2[ModuleGraphConnection, /* arg1 */ RuntimeSpec, ConnectionState] => Callback): Self = StObject.set(x, "addCondition", js.Any.fromFunction1((t0: js.Function2[ModuleGraphConnection, /* arg1 */ RuntimeSpec, ConnectionState]) => value(t0).runNow()))
    
    inline def setAddExplanation(value: String => Callback): Self = StObject.set(x, "addExplanation", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
