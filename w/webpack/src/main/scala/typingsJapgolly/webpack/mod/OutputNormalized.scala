...
import typingsJapgolly.webpack.webpackStrings.`use-credentials`
import typingsJapgolly.webpack.webpackStrings.anonymous
import typingsJapgolly.webpack.webpackStrings.module
import typingsJapgolly.webpack.webpackStrings.textSlashjavascript
...
/**
  ...
  */
trait OutputNormalized extends StObject {
  ...
  /**
  	 ...
  	 */
  var trustedTypes: js.UndefOr[TrustedTypes] = js.undefined
...
object OutputNormalized {
  
  inline def apply(): OutputNormalized = {
  ...
  extension [Self <: OutputNormalized](x: Self) {
    ...
    inline def setTrustedTypes(value: TrustedTypes): Self = StObject.set(x, "trustedTypes", value.asInstanceOf[js.Any])
