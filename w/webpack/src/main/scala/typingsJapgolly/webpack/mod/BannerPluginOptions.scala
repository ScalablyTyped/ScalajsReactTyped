...
trait BannerPluginOptions extends StObject {
  ...
  /**
  	 ...
  	 */
  var banner: String | (js.Function1[/* data */ typingsJapgolly.webpack.anon.Chunk, String])
...
object BannerPluginOptions {
  ...
  inline def apply(banner: String | (js.Function1[/* data */ typingsJapgolly.webpack.anon.Chunk, String])): BannerPluginOptions = {
  ...
  extension [Self <: BannerPluginOptions](x: Self) {
    ...
    inline def setBanner(value: String | (js.Function1[/* data */ typingsJapgolly.webpack.anon.Chunk, String])): Self = StObject.set(x, "banner", value.asInstanceOf[js.Any])
    
    inline def setBannerFunction1(value: /* data */ typingsJapgolly.webpack.anon.Chunk => String): Self = StObject.set(x, "banner", js.Any.fromFunction1(value))
