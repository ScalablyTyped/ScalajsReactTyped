...
trait RuntimeChunkPlugin extends StObject {
...
object RuntimeChunkPlugin {
  
  inline def apply(apply: Compiler => Callback, options: Any): RuntimeChunkPlugin = {
    val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1((t0: Compiler) => apply(t0).runNow()), options = options.asInstanceOf[js.Any])
    __obj.asInstanceOf[RuntimeChunkPlugin]
  }
  
  extension [Self <: RuntimeChunkPlugin](x: Self) {
