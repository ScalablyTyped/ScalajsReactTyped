...
import typingsJapgolly.webpack.anon.ForceRelativeName
...
trait UserResolveOptions extends StObject {
  ...
  /**
  	 ...
  	 */
  var fileSystem: typingsJapgolly.std.FileSystem
  ...
  /**
  	 ...
  	 */
  var plugins: js.UndefOr[js.Array[typingsJapgolly.std.Plugin]] = js.undefined
...
object UserResolveOptions {
  ...
  inline def apply(fileSystem: typingsJapgolly.std.FileSystem): UserResolveOptions = {
    val __obj = js.Dynamic.literal(fileSystem = fileSystem.asInstanceOf[js.Any])
    __obj.asInstanceOf[UserResolveOptions]
  }
  
  extension [Self <: UserResolveOptions](x: Self) {
    ...
    inline def setFileSystem(value: typingsJapgolly.std.FileSystem): Self = StObject.set(x, "fileSystem", value.asInstanceOf[js.Any])
    ...
    inline def setPlugins(value: js.Array[typingsJapgolly.std.Plugin]): Self = StObject.set(x, "plugins", value.asInstanceOf[js.Any])
    
    inline def setPluginsUndefined: Self = StObject.set(x, "plugins", js.undefined)
    
    inline def setPluginsVarargs(value: typingsJapgolly.std.Plugin*): Self = StObject.set(x, "plugins", js.Array(value*))
