...
import typingsJapgolly.webpack.webpackStrings.`eval-only`
import typingsJapgolly.webpack.webpackStrings.`warn-mock`
import typingsJapgolly.webpack.webpackStrings.mock
import typingsJapgolly.webpack.webpackStrings.warn
