...
import typingsJapgolly.webpack.anon.BuildInfo
import typingsJapgolly.webpack.anon.ReadonlyinitializeSyncHoo
...
open class Compiler protected () extends StObject {
  ...
  def newCompilationParams(): typingsJapgolly.webpack.anon.ContextModuleFactory = js.native
