...
import typingsJapgolly.webpack.anon.ReadonlyresolveAsyncSerie
...
trait NormalModuleFactory
  ...
  var generatorCache: Map[String, WeakMap[js.Object, typingsJapgolly.std.Generator[Any, Any, Any]]] = js.native
  
  def getGenerator(): js.UndefOr[typingsJapgolly.std.Generator[Any, Any, Any]] = js.native
  def getGenerator(`type`: Any): js.UndefOr[typingsJapgolly.std.Generator[Any, Any, Any]] = js.native
  def getGenerator(`type`: Any, generatorOptions: js.Object): js.UndefOr[typingsJapgolly.std.Generator[Any, Any, Any]] = js.native
  def getGenerator(`type`: Unit, generatorOptions: js.Object): js.UndefOr[typingsJapgolly.std.Generator[Any, Any, Any]] = js.native
