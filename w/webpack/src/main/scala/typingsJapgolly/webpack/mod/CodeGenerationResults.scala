...
object CodeGenerationResults {
  ...
  inline def apply(
    add: (Module, RuntimeSpec, CodeGenerationResult) => Callback,
    ...
    val __obj = js.Dynamic.literal(add = js.Any.fromFunction3((t0: Module, t1: RuntimeSpec, t2: CodeGenerationResult) => (add(t0, t1, t2)).runNow()), get = js.Any.fromFunction2(get), getData = js.Any.fromFunction3(getData), getHash = js.Any.fromFunction2(getHash), getRuntimeRequirements = js.Any.fromFunction2(getRuntimeRequirements), getSource = js.Any.fromFunction3(getSource), has = js.Any.fromFunction2(has), map = map.asInstanceOf[js.Any])
    __obj.asInstanceOf[CodeGenerationResults]
  }
  
  extension [Self <: CodeGenerationResults](x: Self) {
    
    inline def setAdd(value: (Module, RuntimeSpec, CodeGenerationResult) => Callback): Self = StObject.set(x, "add", js.Any.fromFunction3((t0: Module, t1: RuntimeSpec, t2: CodeGenerationResult) => (value(t0, t1, t2)).runNow()))
