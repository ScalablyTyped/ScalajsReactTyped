...
trait FetchCompileWasmPlugin extends StObject {
...
object FetchCompileWasmPlugin {
  
  inline def apply(apply: Compiler => Callback, options: Any): FetchCompileWasmPlugin = {
    val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1((t0: Compiler) => apply(t0).runNow()), options = options.asInstanceOf[js.Any])
    __obj.asInstanceOf[FetchCompileWasmPlugin]
  }
  
  extension [Self <: FetchCompileWasmPlugin](x: Self) {
