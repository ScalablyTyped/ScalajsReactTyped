...
import typingsJapgolly.webpack.anon.AsiSafe
import typingsJapgolly.webpack.anon.Block
import typingsJapgolly.webpack.anon.BlockChunkGraph
import typingsJapgolly.webpack.anon.ChunkName
import typingsJapgolly.webpack.anon.ExportsArgument
import typingsJapgolly.webpack.anon.Expr
import typingsJapgolly.webpack.anon.IdExpr
import typingsJapgolly.webpack.anon.ImportVar
import typingsJapgolly.webpack.anon.Message
import typingsJapgolly.webpack.anon.Request
import typingsJapgolly.webpack.anon.Runtime
import typingsJapgolly.webpack.anon.RuntimeRequirements
import typingsJapgolly.webpack.anon.Strict
import typingsJapgolly.webpack.webpackStrings.`x EqualssignGreaterthansign LeftcurlybracketRightcurlybracket`
...
trait RuntimeTemplate extends StObject {
  ...
  def assetUrl(__0: typingsJapgolly.webpack.anon.CodeGenerationResults): String = js.native
  ...
  def moduleId(__0: typingsJapgolly.webpack.anon.Module): String = js.native
  ...
  def syncModuleFactory(__0: typingsJapgolly.webpack.anon.Dependency): String = js.native
