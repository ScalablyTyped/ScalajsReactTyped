...
object LazyCompilationOptions {
  ...
  extension [Self <: LazyCompilationOptions](x: Self) {
    ...
    inline def setBackendFunction2(
      value: (/* compiler */ Compiler, /* callback */ js.Function2[/* err */ js.UndefOr[js.Error], /* api */ js.UndefOr[BackendApi], Unit]) => Callback
    ): Self = StObject.set(x, "backend", js.Any.fromFunction2((t0: /* compiler */ Compiler, t1: /* callback */ js.Function2[/* err */ js.UndefOr[js.Error], /* api */ js.UndefOr[BackendApi], Unit]) => (value(t0, t1)).runNow()))
