...
trait NamedModuleIdsPlugin extends StObject {
...
object NamedModuleIdsPlugin {
  
  inline def apply(apply: Compiler => Callback, options: Any): NamedModuleIdsPlugin = {
    val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1((t0: Compiler) => apply(t0).runNow()), options = options.asInstanceOf[js.Any])
    __obj.asInstanceOf[NamedModuleIdsPlugin]
  }
  
  extension [Self <: NamedModuleIdsPlugin](x: Self) {
