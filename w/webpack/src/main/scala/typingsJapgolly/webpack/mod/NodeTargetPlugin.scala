...
trait NodeTargetPlugin extends StObject {
...
object NodeTargetPlugin {
  
  inline def apply(apply: Compiler => Callback): NodeTargetPlugin = {
    val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1((t0: Compiler) => apply(t0).runNow()))
    __obj.asInstanceOf[NodeTargetPlugin]
  }
  
  extension [Self <: NodeTargetPlugin](x: Self) {
