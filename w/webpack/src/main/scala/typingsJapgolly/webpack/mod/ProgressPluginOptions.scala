...
object ProgressPluginOptions {
  ...
  extension [Self <: ProgressPluginOptions](x: Self) {
    ...
    inline def setHandler(value: (/* percentage */ Double, /* msg */ String, /* repeated */ String) => Callback): Self = StObject.set(x, "handler", js.Any.fromFunction3((t0: /* percentage */ Double, t1: /* msg */ String, t2: /* repeated */ String) => (value(t0, t1, t2)).runNow()))
