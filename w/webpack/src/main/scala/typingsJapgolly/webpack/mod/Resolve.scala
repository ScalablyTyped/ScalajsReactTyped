...
import typingsJapgolly.webpack.AnonPath
...
trait Resolve extends js.Object {
  ...
  /**
    ...
    * Defaults to `() => true`.
    */
  var cachePredicate: js.UndefOr[js.Function1[/* data */ AnonPath, Boolean]] = js.undefined
  /**
...
object Resolve {
  ...
  def apply(
    ...
    cachePredicate: /* data */ AnonPath => CallbackTo[Boolean] = null,
    ...
    if (cachePredicate != null) __obj.updateDynamic("cachePredicate")(js.Any.fromFunction1((t0: /* data */ typingsJapgolly.webpack.AnonPath) => cachePredicate(t0).runNow()))
