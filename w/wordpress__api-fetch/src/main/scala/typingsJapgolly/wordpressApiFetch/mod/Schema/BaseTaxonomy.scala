...
import typingsJapgolly.wordpressApiFetch.AnonAddnewitem
import typingsJapgolly.wordpressApiFetch.AnonAssignterms
import typingsJapgolly.wordpressApiFetch.AnonDictk
import typingsJapgolly.wordpressApiFetch.AnonPublic
