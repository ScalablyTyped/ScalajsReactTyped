...
import typingsJapgolly.wordpressApiFetch.AnonAddnew
import typingsJapgolly.wordpressApiFetch.AnonAuthor
import typingsJapgolly.wordpressApiFetch.AnonCreateposts
