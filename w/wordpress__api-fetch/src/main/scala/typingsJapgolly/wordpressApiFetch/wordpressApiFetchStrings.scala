...
import typingsJapgolly.wordpressApiFetch.mod.Schema.Context
import typingsJapgolly.wordpressApiFetch.mod.Schema.EmbedKeys.Block
import typingsJapgolly.wordpressApiFetch.mod.Schema.EmbedKeys.Category
import typingsJapgolly.wordpressApiFetch.mod.Schema.EmbedKeys.Comment
import typingsJapgolly.wordpressApiFetch.mod.Schema.EmbedKeys.Media
import typingsJapgolly.wordpressApiFetch.mod.Schema.EmbedKeys.Page
import typingsJapgolly.wordpressApiFetch.mod.Schema.EmbedKeys.Post
import typingsJapgolly.wordpressApiFetch.mod.Schema.EmbedKeys.PostRevision
import typingsJapgolly.wordpressApiFetch.mod.Schema.EmbedKeys.Status
import typingsJapgolly.wordpressApiFetch.mod.Schema.EmbedKeys.Tag
import typingsJapgolly.wordpressApiFetch.mod.Schema.EmbedKeys.Taxonomy
import typingsJapgolly.wordpressApiFetch.mod.Schema.EmbedKeys.Type
import typingsJapgolly.wordpressApiFetch.mod.Schema.EmbedKeys.User
import typingsJapgolly.wordpressApiFetch.mod.Schema.OpenOrClosed
import typingsJapgolly.wordpressApiFetch.mod.Schema.PostFormat
import typingsJapgolly.wordpressApiFetch.mod.Schema.PostStatus
import typingsJapgolly.wordpressApiFetch.mod.Schema.TaxonomyKind
...
object wordpressApiFetchStrings {
  ...
  sealed trait categories
    extends typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Post
  ...
  sealed trait comment_status
    extends typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Media
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Page
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Post
  
  @js.native
  sealed trait content
    extends Comment
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Block
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Page
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Post
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.PostRevision
  
  @js.native
  sealed trait count
    extends typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Category
  ...
  sealed trait date_gmt
    extends typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Block
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Comment
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Media
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Page
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Post
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.PostRevision
  ...
  sealed trait description
    extends User
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Category
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Media
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Taxonomy
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Type
  ...
  sealed trait hierarchical
    extends typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Taxonomy
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Type
  ...
  sealed trait menu_order
    extends typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Page
  ...
  sealed trait meta
    extends typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Category
       ...
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Page
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Post
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.User
  ...
  @js.native
  sealed trait post
    extends typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Comment
       with typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Media
  ...
  @js.native
  sealed trait public
    extends typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Status
  ...
  sealed trait taxonomies
    extends typingsJapgolly.wordpressApiFetch.mod.Schema.ViewKeys.Type
