package typingsJapgolly.whyDidYouUpdate

import japgolly.scalajs.react.Callback
import typingsJapgolly.whyDidYouUpdate.anon.Typeofreact
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setNotifier(
        value: (/* groupByComponent */ Boolean, /* collapseComponentGroups */ Boolean, /* displayName */ String, /* diffs */ js.Array[Diffs]) => Callback
      ): Self = StObject.set(x, "notifier", js.Any.fromFunction4((t0: /* groupByComponent */ Boolean, t1: /* collapseComponentGroups */ Boolean, t2: /* displayName */ String, t3: /* diffs */ js.Array[Diffs]) => (value(t0, t1, t2, t3)).runNow()))
