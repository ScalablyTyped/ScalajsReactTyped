...
import typingsJapgolly.whyDidYouUpdate.whyDidYouUpdateStrings.input
...
object anon {
  ...
  trait Typeofreact extends StObject {
    ...
    def createElement[P /* <: HTMLAttributes[T] */, T /* <: HTMLElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 116, starting with typingsJapgolly.whyDidYouUpdate.whyDidYouUpdateStrings.a, typingsJapgolly.whyDidYouUpdate.whyDidYouUpdateStrings.abbr, typingsJapgolly.whyDidYouUpdate.whyDidYouUpdateStrings.address */ Any,
    ...
    def createElement_PT_ReactSVGElement[P /* <: SVGAttributes[T] */, T /* <: SVGElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 55, starting with typingsJapgolly.whyDidYouUpdate.whyDidYouUpdateStrings.animate, typingsJapgolly.whyDidYouUpdate.whyDidYouUpdateStrings.circle, typingsJapgolly.whyDidYouUpdate.whyDidYouUpdateStrings.clipPath */ Any,
      props: ClassAttributes[T] & P,
      children: Node*
