...
object distTypesWixDesignSystemsMaskingProviderContextMod {
  
  @JSImport("wix-design-systems-providers/dist/types/WixDesignSystemsMaskingProvider/context", "WixDesignSystemsMaskingContext")
  @js.native
