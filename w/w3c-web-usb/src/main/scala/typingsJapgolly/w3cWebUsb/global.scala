...
object global {
  ...
  open class USB ()
    extends StObject
       with typingsJapgolly.w3cWebUsb.USB
  
  @JSGlobal("USBAlternateInterface")
  @js.native
  open class USBAlternateInterface protected ()
    extends StObject
       with typingsJapgolly.w3cWebUsb.USBAlternateInterface {
    def this(deviceInterface: typingsJapgolly.w3cWebUsb.USBInterface, alternateSetting: Double) = this()
  ...
  open class USBConfiguration ()
    extends StObject
       with typingsJapgolly.w3cWebUsb.USBConfiguration {
    
    /* CompleteClass */
    override val configurationValue: Double = js.native
    
    /* CompleteClass */
    override val interfaces: js.Array[typingsJapgolly.w3cWebUsb.USBInterface] = js.native
  }
  ...
  open class USBConnectionEvent protected ()
    extends StObject
       with typingsJapgolly.w3cWebUsb.USBConnectionEvent {
  ...
  open class USBDevice ()
    extends StObject
       with typingsJapgolly.w3cWebUsb.USBDevice
  
  @JSGlobal("USBInTransferResult")
  @js.native
  open class USBInTransferResult protected ()
    extends StObject
       with typingsJapgolly.w3cWebUsb.USBInTransferResult {
  ...
  open class USBInterface protected ()
    extends StObject
       with typingsJapgolly.w3cWebUsb.USBInterface {
    def this(configuration: typingsJapgolly.w3cWebUsb.USBConfiguration, interfaceNumber: Double) = this()
    
    /* CompleteClass */
    override val alternate: typingsJapgolly.w3cWebUsb.USBAlternateInterface = js.native
    
    /* CompleteClass */
    override val alternates: js.Array[typingsJapgolly.w3cWebUsb.USBAlternateInterface] = js.native
  ...
  open class USBIsochronousInTransferPacket protected ()
    extends StObject
       with typingsJapgolly.w3cWebUsb.USBIsochronousInTransferPacket {
    def this(status: USBTransferStatus) = this()
    def this(status: USBTransferStatus, data: js.typedarray.DataView) = this()
  }
  ...
  open class USBIsochronousInTransferResult protected ()
    extends StObject
       with typingsJapgolly.w3cWebUsb.USBIsochronousInTransferResult {
    def this(packets: js.Array[typingsJapgolly.w3cWebUsb.USBIsochronousInTransferPacket]) = this()
    def this(
      packets: js.Array[typingsJapgolly.w3cWebUsb.USBIsochronousInTransferPacket],
      data: js.typedarray.DataView
    ) = this()
    
    /* CompleteClass */
    override val packets: js.Array[typingsJapgolly.w3cWebUsb.USBIsochronousInTransferPacket] = js.native
  }
  ...
  open class USBIsochronousOutTransferPacket protected ()
    extends StObject
       with typingsJapgolly.w3cWebUsb.USBIsochronousOutTransferPacket {
    def this(status: USBTransferStatus) = this()
  ...
  open class USBIsochronousOutTransferResult protected ()
    extends StObject
       with typingsJapgolly.w3cWebUsb.USBIsochronousOutTransferResult {
    def this(packets: js.Array[typingsJapgolly.w3cWebUsb.USBIsochronousOutTransferPacket]) = this()
    
    /* CompleteClass */
    override val packets: js.Array[typingsJapgolly.w3cWebUsb.USBIsochronousOutTransferPacket] = js.native
  }
  ...
  open class USBOutTransferResult protected ()
    extends StObject
       with typingsJapgolly.w3cWebUsb.USBOutTransferResult {
    def this(status: USBTransferStatus) = this()
