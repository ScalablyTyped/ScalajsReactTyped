...
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.Context
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.EmbedKeys.Block
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.EmbedKeys.Category
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.EmbedKeys.Comment
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.EmbedKeys.Media
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.EmbedKeys.Page
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.EmbedKeys.Post
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.EmbedKeys.PostRevision
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.EmbedKeys.Status
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.EmbedKeys.Tag
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.EmbedKeys.Taxonomy
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.EmbedKeys.Type
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.EmbedKeys.User
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.OpenOrClosed
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.PostFormat
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.PostStatus
import typingsJapgolly.wordpressCoreData.schemaMod.Schema.TaxonomyKind
...
object wordpressCoreDataStrings {
  ...
  sealed trait categories
    extends StObject
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Post
  ...
  sealed trait comment_status
    extends StObject
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Media
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Page
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Post
  ...
  sealed trait content
    extends StObject
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Block
       with Comment
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Page
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Post
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.PostRevision
  ...
  sealed trait count
    extends StObject
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Category
  ...
  sealed trait date_gmt
    extends StObject
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Block
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Comment
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Media
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Page
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Post
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.PostRevision
  ...
  sealed trait description
    extends StObject
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Category
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Media
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Taxonomy
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Type
       with User
  ...
  sealed trait meta
    extends StObject
       ...
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Page
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Post
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.User
  ...
  sealed trait public
    extends StObject
       with typingsJapgolly.wordpressCoreData.schemaMod.Schema.ViewKeys.Status
