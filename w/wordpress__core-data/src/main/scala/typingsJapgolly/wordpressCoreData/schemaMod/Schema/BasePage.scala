...
import typingsJapgolly.wordpressCoreData.anon.Blockversion
import typingsJapgolly.wordpressCoreData.anon.Dictk
import typingsJapgolly.wordpressCoreData.anon.Protected
...
object BasePage {
  ...
  extension [Self <: BasePage[?], T /* <: Context */](x: Self & BasePage[T]) {
