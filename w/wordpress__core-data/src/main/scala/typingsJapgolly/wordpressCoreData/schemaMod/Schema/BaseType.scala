...
import typingsJapgolly.wordpressCoreData.anon.Addnew
import typingsJapgolly.wordpressCoreData.anon.Author
import typingsJapgolly.wordpressCoreData.anon.Createposts
