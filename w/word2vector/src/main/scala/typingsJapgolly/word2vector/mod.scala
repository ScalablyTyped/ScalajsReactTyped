package typingsJapgolly.word2vector
...
object mod {
  ...
  inline def add(p1: String, p2: String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(p1.asInstanceOf[js.Any], p2.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def add(p1: String, p2: String, opt: js.Object): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(p1.asInstanceOf[js.Any], p2.asInstanceOf[js.Any], opt.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def add(p1: js.Array[Double], p2: js.Array[Double]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(p1.asInstanceOf[js.Any], p2.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def add(p1: js.Array[Double], p2: js.Array[Double], opt: js.Object): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(p1.asInstanceOf[js.Any], p2.asInstanceOf[js.Any], opt.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  inline def similarity(w1: String, w2: String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("similarity")(w1.asInstanceOf[js.Any], w2.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def similarity(w1: String, w2: String, options: js.Object): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("similarity")(w1.asInstanceOf[js.Any], w2.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  
  inline def substract(p1: String, p2: String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("substract")(p1.asInstanceOf[js.Any], p2.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def substract(p1: String, p2: String, opt: js.Object): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("substract")(p1.asInstanceOf[js.Any], p2.asInstanceOf[js.Any], opt.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def substract(p1: js.Array[Double], p2: js.Array[Double]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("substract")(p1.asInstanceOf[js.Any], p2.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def substract(p1: js.Array[Double], p2: js.Array[Double], opt: js.Object): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("substract")(p1.asInstanceOf[js.Any], p2.asInstanceOf[js.Any], opt.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  inline def w2v(): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("w2v")().asInstanceOf[Any]
}
