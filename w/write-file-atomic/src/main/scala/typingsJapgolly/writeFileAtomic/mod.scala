package typingsJapgolly.writeFileAtomic

import japgolly.scalajs.react.Callback
import typingsJapgolly.node.bufferMod.global.Buffer
import typingsJapgolly.node.bufferMod.global.BufferEncoding
import typingsJapgolly.writeFileAtomic.anon.Gid
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setTmpfileCreated(value: /* tmpfile */ String => Callback): Self = StObject.set(x, "tmpfileCreated", js.Any.fromFunction1((t0: /* tmpfile */ String) => value(t0).runNow()))
