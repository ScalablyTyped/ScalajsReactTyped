...
import typingsJapgolly.webicon.iconOptionsIconSetOptionsMod.IconSetOptions
...
object iconOptionsSvgIconSetOptionsMod {
  ...
  - typingsJapgolly.webicon.iconOptionsDownloadableMod.Downloadable because Already inherited
  - typingsJapgolly.webicon.iconOptionsStoreableMod.Storeable because var conflicts: iconIdParser, uri, url. Inlined preloadable, iconIdResolver */ trait SvgIconSetOptions
    extends StObject
       with IconSetOptions {
