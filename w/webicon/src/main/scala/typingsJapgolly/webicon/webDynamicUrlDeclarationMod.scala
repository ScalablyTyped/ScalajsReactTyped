...
import typingsJapgolly.webicon.webStaticUrlDeclarationMod.StaticUrlDeclaration
import typingsJapgolly.webicon.webUrlDeclarationBaseMod.UrlDeclarationBase
