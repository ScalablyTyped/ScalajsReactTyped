package typingsJapgolly.webicon.dynamicUrlDeclarationMod

import typingsJapgolly.webicon.staticUrlDeclarationMod.StaticUrlDeclaration
import typingsJapgolly.webicon.urlDeclarationBaseMod.UrlDeclarationBase
