...
trait GPUOutOfMemoryError
  ...
  /**
    ...
    * @internal
    */
  val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUOutOfMemoryError
}
object GPUOutOfMemoryError {
  ...
  extension [Self <: GPUOutOfMemoryError](x: Self) {
    ...
    inline def set__brand(value: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUOutOfMemoryError): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
