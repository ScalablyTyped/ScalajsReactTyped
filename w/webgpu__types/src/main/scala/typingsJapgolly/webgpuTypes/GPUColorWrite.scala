...
trait GPUColorWrite extends StObject {
  ...
  /**
    ...
    * @internal
    */
  val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUColorWrite
}
object GPUColorWrite {
  ...
  extension [Self <: GPUColorWrite](x: Self) {
    ...
    inline def set__brand(value: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUColorWrite): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
