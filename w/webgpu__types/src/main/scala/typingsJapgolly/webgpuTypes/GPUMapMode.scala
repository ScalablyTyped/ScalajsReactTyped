...
trait GPUMapMode extends StObject {
  ...
  /**
    ...
    * @internal
    */
  val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUMapMode
}
object GPUMapMode {
  ...
  extension [Self <: GPUMapMode](x: Self) {
    ...
    inline def set__brand(value: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUMapMode): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
