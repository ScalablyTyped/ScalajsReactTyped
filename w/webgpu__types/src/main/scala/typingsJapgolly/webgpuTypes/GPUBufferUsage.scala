...
trait GPUBufferUsage extends StObject {
  ...
  /**
    ...
    * @internal
    */
  val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUBufferUsage
}
object GPUBufferUsage {
  ...
  extension [Self <: GPUBufferUsage](x: Self) {
    ...
    inline def set__brand(value: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUBufferUsage): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
