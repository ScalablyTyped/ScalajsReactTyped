...
trait GPUDeviceLostInfo extends StObject {
  ...
  /**
    ...
    * @internal
    */
  val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUDeviceLostInfo
...
object GPUDeviceLostInfo {
  ...
  extension [Self <: GPUDeviceLostInfo](x: Self) {
    ...
    inline def set__brand(value: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUDeviceLostInfo): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
