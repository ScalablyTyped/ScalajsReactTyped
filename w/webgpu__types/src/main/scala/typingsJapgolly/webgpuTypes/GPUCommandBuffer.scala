...
trait GPUCommandBuffer
  ...
  /**
    ...
    * @internal
    */
  val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUCommandBuffer
}
object GPUCommandBuffer {
  ...
  extension [Self <: GPUCommandBuffer](x: Self) {
    ...
    inline def set__brand(value: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUCommandBuffer): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
