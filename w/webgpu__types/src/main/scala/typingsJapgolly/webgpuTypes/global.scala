...
object global {
  ...
  open class GPUOutOfMemoryError protected ()
    extends StObject
       with typingsJapgolly.webgpuTypes.GPUOutOfMemoryError {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUOutOfMemoryError = js.native
  ...
  open class GPUUncapturedErrorEvent protected ()
    extends StObject
       with typingsJapgolly.webgpuTypes.GPUUncapturedErrorEvent {
  ...
  open class GPUValidationError protected ()
    extends StObject
       with typingsJapgolly.webgpuTypes.GPUValidationError {
    def this(message: String) = this()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUValidationError = js.native
