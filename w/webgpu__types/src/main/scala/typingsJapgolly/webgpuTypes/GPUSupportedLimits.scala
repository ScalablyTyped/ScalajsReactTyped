...
trait GPUSupportedLimits extends StObject {
  ...
  /**
    ...
    * @internal
    */
  val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUSupportedLimits
...
object GPUSupportedLimits {
  ...
  extension [Self <: GPUSupportedLimits](x: Self) {
    ...
    inline def set__brand(value: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUSupportedLimits): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
