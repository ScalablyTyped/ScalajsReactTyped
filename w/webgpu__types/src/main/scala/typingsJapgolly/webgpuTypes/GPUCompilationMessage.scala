...
trait GPUCompilationMessage extends StObject {
  ...
  /**
    ...
    * @internal
    */
  val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUCompilationMessage
...
object GPUCompilationMessage {
  ...
  extension [Self <: GPUCompilationMessage](x: Self) {
    ...
    inline def set__brand(value: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUCompilationMessage): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
