...
trait GPUShaderStage extends StObject {
  ...
  /**
    ...
    * @internal
    */
  val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUShaderStage
}
object GPUShaderStage {
  ...
  extension [Self <: GPUShaderStage](x: Self) {
    ...
    inline def set__brand(value: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUShaderStage): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
