...
trait GPUAdapterInfo extends StObject {
  ...
  /**
    ...
    * @internal
    */
  val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUAdapterInfo
...
object GPUAdapterInfo {
  ...
  extension [Self <: GPUAdapterInfo](x: Self) {
    ...
    inline def set__brand(value: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUAdapterInfo): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
