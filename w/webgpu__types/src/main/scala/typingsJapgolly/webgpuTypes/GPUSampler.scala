...
trait GPUSampler
  ...
  /**
    ...
    * @internal
    */
  val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUSampler
}
object GPUSampler {
  ...
  extension [Self <: GPUSampler](x: Self) {
    ...
    inline def set__brand(value: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUSampler): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
