...
trait GPUInternalError
  ...
  /**
    ...
    * @internal
    */
  val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUInternalError
}
object GPUInternalError {
  ...
  extension [Self <: GPUInternalError](x: Self) {
    ...
    inline def set__brand(value: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUInternalError): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
