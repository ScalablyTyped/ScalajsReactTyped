...
trait GPUCompilationInfo extends StObject {
  ...
  /**
    ...
    * @internal
    */
  val __brand: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUCompilationInfo
...
object GPUCompilationInfo {
  ...
  extension [Self <: GPUCompilationInfo](x: Self) {
    ...
    inline def set__brand(value: typingsJapgolly.webgpuTypes.webgpuTypesStrings.GPUCompilationInfo): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
