package typingsJapgolly.waaclock

import japgolly.scalajs.react.Callback
import org.scalajs.dom.AudioContext
import typingsJapgolly.waaclock.anon.Early
import typingsJapgolly.waaclock.anon.ToleranceEarly
...
object mod {
  ...
  object WAAClock {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(callbackAtTime = js.Any.fromFunction2(callbackAtTime), setTimeout = js.Any.fromFunction2(setTimeout), start = start.toJsFn, stop = stop.toJsFn, timeStretch = js.Any.fromFunction3(timeStretch))
