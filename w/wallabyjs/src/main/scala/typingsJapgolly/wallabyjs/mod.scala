package typingsJapgolly.wallabyjs
...
object mod {
  ...
  object IWallabyFile {
    ...
    inline def apply(changeExt: String => Callback, rename: String => Callback): IWallabyFile = {
      val __obj = js.Dynamic.literal(changeExt = js.Any.fromFunction1((t0: String) => changeExt(t0).runNow()), rename = js.Any.fromFunction1((t0: String) => rename(t0).runNow()))
      __obj.asInstanceOf[IWallabyFile]
    }
    
    extension [Self <: IWallabyFile](x: Self) {
      
      inline def setChangeExt(value: String => Callback): Self = StObject.set(x, "changeExt", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
