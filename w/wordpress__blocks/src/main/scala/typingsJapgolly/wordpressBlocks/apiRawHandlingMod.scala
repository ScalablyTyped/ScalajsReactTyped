...
import typingsJapgolly.wordpressBlocks.anon.HTML
...
import typingsJapgolly.wordpressBlocks.wordpressBlocksStrings.AUTO
import typingsJapgolly.wordpressBlocks.wordpressBlocksStrings.BLOCKS
...
object apiRawHandlingMod {
  ...
  object pasteHandler {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.wordpressBlocks.apiRawHandlingMod.pasteHandler.HTMLOptions
      - typingsJapgolly.wordpressBlocks.apiRawHandlingMod.pasteHandler.PlainTextOptions
    */
    trait Options extends StObject
    object Options {
      
      inline def HTMLOptions(HTML: String): typingsJapgolly.wordpressBlocks.apiRawHandlingMod.pasteHandler.HTMLOptions = {
        val __obj = js.Dynamic.literal(HTML = HTML.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.wordpressBlocks.apiRawHandlingMod.pasteHandler.HTMLOptions]
      }
      
      inline def PlainTextOptions(plainText: String): typingsJapgolly.wordpressBlocks.apiRawHandlingMod.pasteHandler.PlainTextOptions = {
        val __obj = js.Dynamic.literal(plainText = plainText.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.wordpressBlocks.apiRawHandlingMod.pasteHandler.PlainTextOptions]
      }
    }
