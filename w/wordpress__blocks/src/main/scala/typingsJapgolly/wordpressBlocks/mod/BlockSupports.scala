...
import typingsJapgolly.wordpressBlocks.anon.PartialColorProps
import typingsJapgolly.wordpressBlocks.anon.PartialSpacingProps
import typingsJapgolly.wordpressBlocks.anon.PartialTypographyProps
