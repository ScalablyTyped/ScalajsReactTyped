...
import typingsJapgolly.wordpressBlocks.mod.TransformRawSchema
...
trait Attributes extends StObject {
  ...
  var require: js.UndefOr[
    js.Array[
      /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressBlocks.wordpressBlocksStrings.a, typingsJapgolly.wordpressBlocks.wordpressBlocksStrings.abbr, typingsJapgolly.wordpressBlocks.wordpressBlocksStrings.address */ Any
    ]
  ] = js.undefined
}
object Attributes {
  ...
  extension [Self <: Attributes](x: Self) {
    ...
    inline def setRequireVarargs(
      value: (/* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressBlocks.wordpressBlocksStrings.a, typingsJapgolly.wordpressBlocks.wordpressBlocksStrings.abbr, typingsJapgolly.wordpressBlocks.wordpressBlocksStrings.address */ Any)*
