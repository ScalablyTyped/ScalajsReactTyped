...
import typingsJapgolly.wordpressBlocks.mod.BlockAttributes
...
import typingsJapgolly.wordpressBlocks.mod.BlockVariation
import typingsJapgolly.wordpressBlocks.mod.BlockVariationScope
...
object apiMod {
  ...
  inline def parseWithAttributeSchema(innerHTML: String, schema: typingsJapgolly.wordpressBlocks.apiParserMod.Schema.Node): Element | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("parseWithAttributeSchema")(innerHTML.asInstanceOf[js.Any], schema.asInstanceOf[js.Any])).asInstanceOf[Element | Null]
