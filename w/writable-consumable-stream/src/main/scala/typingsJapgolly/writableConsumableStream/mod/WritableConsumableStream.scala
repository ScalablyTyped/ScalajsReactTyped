package typingsJapgolly.writableConsumableStream.mod
...
trait WritableConsumableStream[T] extends ConsumableStream[T] {
  ...
  def setConsumer(consumerId: Double, consumer: typingsJapgolly.writableConsumableStream.consumerMod.^[T]): Unit = js.native
