package typingsJapgolly.writableConsumableStream

import typingsJapgolly.std.IteratorResult
import typingsJapgolly.writableConsumableStream.anon.Done
...
object consumerMod {
  ...
  trait Consumer[T]
    extends StObject
       with typingsJapgolly.consumableStream.mod.Consumer[T] {
    ...
    var stream: typingsJapgolly.writableConsumableStream.mod.^[T] = js.native
