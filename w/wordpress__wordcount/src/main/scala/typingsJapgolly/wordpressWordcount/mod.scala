package typingsJapgolly.wordpressWordcount

import typingsJapgolly.wordpressWordcount.anon.PartialSettings
import typingsJapgolly.wordpressWordcount.anon.Shortcodes
...
object mod {
  ...
  */
  ...
  object CountType {
    ...
    inline def characters_excluding_spaces: typingsJapgolly.wordpressWordcount.wordpressWordcountStrings.characters_excluding_spaces = "characters_excluding_spaces".asInstanceOf[typingsJapgolly.wordpressWordcount.wordpressWordcountStrings.characters_excluding_spaces]
    
    inline def characters_including_spaces: typingsJapgolly.wordpressWordcount.wordpressWordcountStrings.characters_including_spaces = "characters_including_spaces".asInstanceOf[typingsJapgolly.wordpressWordcount.wordpressWordcountStrings.characters_including_spaces]
    
    inline def words: typingsJapgolly.wordpressWordcount.wordpressWordcountStrings.words = "words".asInstanceOf[typingsJapgolly.wordpressWordcount.wordpressWordcountStrings.words]
  }
