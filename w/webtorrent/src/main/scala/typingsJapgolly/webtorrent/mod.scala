...
import typingsJapgolly.webtorrent.anon.Autoplay
import typingsJapgolly.webtorrent.anon.End
import typingsJapgolly.webtorrent.anon.Files
...
import typingsJapgolly.webtorrent.webtorrentStrings.torrent
...
object mod extends Shortcut {
  ...
  trait Instance
    ...
    def add(torrent: typingsJapgolly.parseTorrent.mod.Instance): Torrent = js.native
    def add(torrent: typingsJapgolly.parseTorrent.mod.Instance, cb: js.Function1[/* torrent */ Torrent, Any]): Torrent = js.native
    def add(
      torrent: typingsJapgolly.parseTorrent.mod.Instance,
      opts: Unit,
      cb: js.Function1[/* torrent */ Torrent, Any]
    ): Torrent = js.native
    def add(torrent: typingsJapgolly.parseTorrent.mod.Instance, opts: TorrentOptions): Torrent = js.native
    def add(
      torrent: typingsJapgolly.parseTorrent.mod.Instance,
      opts: TorrentOptions,
      cb: js.Function1[/* torrent */ Torrent, Any]
  ...
  trait Torrent
    ...
    def on(
      event: typingsJapgolly.webtorrent.webtorrentStrings.infoHash | metadata | typingsJapgolly.webtorrent.webtorrentStrings.ready | typingsJapgolly.webtorrent.webtorrentStrings.done,
  ...
  object TorrentOptions {
    ...
    extension [Self <: TorrentOptions](x: Self) {
      ...
      inline def setGetAnnounceOpts(value: Callback): Self = StObject.set(x, "getAnnounceOpts", value.toJsFn)
      ...
      inline def setPreloadedStore(value: Callback): Self = StObject.set(x, "preloadedStore", value.toJsFn)
