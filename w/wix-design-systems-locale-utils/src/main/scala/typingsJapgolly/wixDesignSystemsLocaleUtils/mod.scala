package typingsJapgolly.wixDesignSystemsLocaleUtils
...
object mod {
  ...
  object dateTimeFormat {
    ...
    @JSImport("wix-design-systems-locale-utils", "dateTimeFormat")
    @js.native
    val ^ : js.Any = js.native
    
    inline def getLongTime(
      locale: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 54, starting with typingsJapgolly.wixDesignSystemsLocaleUtils.wixDesignSystemsLocaleUtilsStrings.en, typingsJapgolly.wixDesignSystemsLocaleUtils.wixDesignSystemsLocaleUtilsStrings.`en-US`, typingsJapgolly.wixDesignSystemsLocaleUtils.wixDesignSystemsLocaleUtilsStrings.`en-GB` */ Any,
      date: js.Date
