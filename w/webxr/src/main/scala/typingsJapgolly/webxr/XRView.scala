...
object XRView {
  ...
  inline def apply(
    ...
    requestViewportScale: Double => Callback,
    transform: XRRigidTransform
  ): XRView = {
    val __obj = js.Dynamic.literal(eye = eye.asInstanceOf[js.Any], projectionMatrix = projectionMatrix.asInstanceOf[js.Any], requestViewportScale = js.Any.fromFunction1((t0: Double) => requestViewportScale(t0).runNow()), transform = transform.asInstanceOf[js.Any])
  ...
  extension [Self <: XRView](x: Self) {
    ...
    inline def setRequestViewportScale(value: Double => Callback): Self = StObject.set(x, "requestViewportScale", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
