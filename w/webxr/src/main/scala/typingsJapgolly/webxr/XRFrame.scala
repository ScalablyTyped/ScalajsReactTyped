...
import typingsJapgolly.webxr.anon.DetectedPlanes
...
trait XRFrame extends StObject {
  ...
  var getJointPose: js.UndefOr[js.Function2[/* joint */ XRJointSpace, EventTarget, js.UndefOr[XRJointPose]]] = js.undefined
...
object XRFrame {
  ...
  extension [Self <: XRFrame](x: Self) {
    ...
    inline def setCreateAnchor(value: (/* pose */ XRRigidTransform, EventTarget) => js.UndefOr[js.Promise[XRAnchor]]): Self = StObject.set(x, "createAnchor", js.Any.fromFunction2(value))
    ...
    inline def setGetJointPose(value: (/* joint */ XRJointSpace, EventTarget) => js.UndefOr[XRJointPose]): Self = StObject.set(x, "getJointPose", js.Any.fromFunction2(value))
