...
import typingsJapgolly.webxr.anon.PlaneDetectionState
import typingsJapgolly.webxr.webxrStrings.end
import typingsJapgolly.webxr.webxrStrings.frameratechange
import typingsJapgolly.webxr.webxrStrings.inputsourceschange
import typingsJapgolly.webxr.webxrStrings.select
import typingsJapgolly.webxr.webxrStrings.selectend
import typingsJapgolly.webxr.webxrStrings.selectstart
import typingsJapgolly.webxr.webxrStrings.squeeze
import typingsJapgolly.webxr.webxrStrings.squeezeend
import typingsJapgolly.webxr.webxrStrings.squeezestart
import typingsJapgolly.webxr.webxrStrings.visibilitychange
