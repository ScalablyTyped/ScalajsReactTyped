...
open class XRViewerPose ()
  extends StObject
     with typingsJapgolly.webxr.XRViewerPose {
  
  /* CompleteClass */
  override val emulatedPosition: Boolean = js.native
  
  /* CompleteClass */
  override val transform: typingsJapgolly.webxr.XRRigidTransform = js.native
  
  /* CompleteClass */
  override val views: js.Array[typingsJapgolly.webxr.XRView] = js.native
}
