...
import typingsJapgolly.webpackAssetsManifest.webpackAssetsManifestBooleans.`false`
import typingsJapgolly.webpackAssetsManifest.webpackAssetsManifestStrings.customize
...
object Options {
  @scala.inline
  def apply(
    apply: /* manifest */ WebpackAssetsManifest => Callback = null,
    assets: js.Object = null,
    customize: (/* entry */ Entry, /* original */ AnyObject, /* manifest */ WebpackAssetsManifest, /* asset */ AnyObject) => CallbackTo[Entry | `false`] = null,
    done: (/* manifest */ WebpackAssetsManifest, /* stats */ AnyObject) => Callback = null,
    ...
    transform: (/* assets */ AnyObject, /* manifest */ WebpackAssetsManifest) => CallbackTo[js.Any] = null,
    writeToDisk: js.UndefOr[Boolean] = js.undefined
  ): Options = {
    val __obj = js.Dynamic.literal()
    if (apply != null) __obj.updateDynamic("apply")(js.Any.fromFunction1((t0: /* manifest */ typingsJapgolly.webpackAssetsManifest.mod.WebpackAssetsManifest) => apply(t0).runNow()))
    if (assets != null) __obj.updateDynamic("assets")(assets.asInstanceOf[js.Any])
    if (customize != null) __obj.updateDynamic("customize")(js.Any.fromFunction4((t0: /* entry */ typingsJapgolly.webpackAssetsManifest.mod.Entry, t1: /* original */ typingsJapgolly.webpackAssetsManifest.mod.AnyObject, t2: /* manifest */ typingsJapgolly.webpackAssetsManifest.mod.WebpackAssetsManifest, t3: /* asset */ typingsJapgolly.webpackAssetsManifest.mod.AnyObject) => customize(t0, t1, t2, t3).runNow()))
    if (done != null) __obj.updateDynamic("done")(js.Any.fromFunction2((t0: /* manifest */ typingsJapgolly.webpackAssetsManifest.mod.WebpackAssetsManifest, t1: /* stats */ typingsJapgolly.webpackAssetsManifest.mod.AnyObject) => done(t0, t1).runNow()))
    ...
    if (transform != null) __obj.updateDynamic("transform")(js.Any.fromFunction2((t0: /* assets */ typingsJapgolly.webpackAssetsManifest.mod.AnyObject, t1: /* manifest */ typingsJapgolly.webpackAssetsManifest.mod.WebpackAssetsManifest) => transform(t0, t1).runNow()))
