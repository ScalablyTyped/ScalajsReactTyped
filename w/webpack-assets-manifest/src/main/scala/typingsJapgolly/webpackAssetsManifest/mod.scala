...
import typingsJapgolly.webpackAssetsManifest.anon.AfterOptions
import typingsJapgolly.webpackAssetsManifest.webpackAssetsManifestBooleans.`false`
import typingsJapgolly.webpackAssetsManifest.webpackAssetsManifestStrings.auto
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setApply(value: /* manifest */ WebpackAssetsManifest => Callback): Self = StObject.set(x, "apply", js.Any.fromFunction1((t0: /* manifest */ WebpackAssetsManifest) => value(t0).runNow()))
      ...
      inline def setDone(value: (/* manifest */ WebpackAssetsManifest, /* stats */ Stats) => Callback): Self = StObject.set(x, "done", js.Any.fromFunction2((t0: /* manifest */ WebpackAssetsManifest, t1: /* stats */ Stats) => (value(t0, t1)).runNow()))
  ...
  trait WebpackAssetsManifest
    ...
    def getCompilationAssets(compilation: Compilation): typingsJapgolly.webpackAssetsManifest.anon.Assets = js.native
