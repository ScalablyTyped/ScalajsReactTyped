...
import typingsJapgolly.wordpressData.anon.FnCall
import typingsJapgolly.wordpressData.anon.PartialDataRegistry
import typingsJapgolly.wordpressData.anon.Registry
import typingsJapgolly.wordpressData.anon.Select
import typingsJapgolly.wordpressData.anon.Storage
...
object mod {
  ...
  object DataRegistry {
    ...
    inline def apply(
      ...
      registerGenericStore: (/* name */ String, /* config */ GenericStoreConfig) => Callback,
      ...
      val __obj = js.Dynamic.literal(dispatch = js.Any.fromFunction1(dispatch), registerGenericStore = js.Any.fromFunction2((t0: /* name */ String, t1: /* config */ GenericStoreConfig) => (registerGenericStore(t0, t1)).runNow()), registerStore = registerStore.asInstanceOf[js.Any], select = js.Any.fromFunction1(select), subscribe = js.Any.fromFunction1(subscribe))
  ...
  object GenericStoreConfig {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getActions = getActions.toJsFn, getSelectors = getSelectors.toJsFn, subscribe = js.Any.fromFunction1(subscribe))
      __obj.asInstanceOf[GenericStoreConfig]
    }
    
    extension [Self <: GenericStoreConfig](x: Self) {
      
      inline def setGetActions(value: CallbackTo[DispatcherMap]): Self = StObject.set(x, "getActions", value.toJsFn)
      
      inline def setGetSelectors(value: CallbackTo[SelectorMap]): Self = StObject.set(x, "getSelectors", value.toJsFn)
  ...
  object Store {
    ...
    inline def apply[S, A /* <: AnyAction */](
      ...
      val __obj = js.Dynamic.literal(dispatch = js.Any.fromFunction1(dispatch), getState = getState.toJsFn, subscribe = js.Any.fromFunction1(subscribe))
