...
object GmeConfig {
  ...
  trait GmeConfig extends StObject {
    ...
    var socketIO: typingsJapgolly.webgme.anon.ClientOptions
  ...
  object GmeConfig {
    ...
    extension [Self <: typingsJapgolly.webgme.GmeConfig.GmeConfig](x: Self) {
      ...
      inline def setSocketIO(value: typingsJapgolly.webgme.anon.ClientOptions): Self = StObject.set(x, "socketIO", value.asInstanceOf[js.Any])
