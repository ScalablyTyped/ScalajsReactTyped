...
import typingsJapgolly.webgme.Blobs.BlobMetadata
...
import typingsJapgolly.webgme.Core.GmePersisted
import typingsJapgolly.webgme.Core.MixinViolation
import typingsJapgolly.webgme.Core.Node
import typingsJapgolly.webgme.Core.ObjectHash
import typingsJapgolly.webgme.Core.RelationRule
import typingsJapgolly.webgme.Global_.GmeLogger
import typingsJapgolly.webgme.GmeCommon.ArtifactHash
import typingsJapgolly.webgme.GmeCommon.DefObject
import typingsJapgolly.webgme.GmeCommon.Dictionary
import typingsJapgolly.webgme.GmeCommon.ErrorOnlyCallback
import typingsJapgolly.webgme.GmeCommon.ErrorStr
import typingsJapgolly.webgme.GmeCommon.ISO8601
import typingsJapgolly.webgme.GmeCommon.InAttr
import typingsJapgolly.webgme.GmeCommon.LoadObject
import typingsJapgolly.webgme.GmeCommon.Message
import typingsJapgolly.webgme.GmeCommon.MetaInfo
import typingsJapgolly.webgme.GmeCommon.MetaRules
...
import typingsJapgolly.webgme.GmeCommon.OutPath
import typingsJapgolly.webgme.GmeCommon.Path
import typingsJapgolly.webgme.GmeCommon.ProjectStart
import typingsJapgolly.webgme.GmeCommon.RelId
import typingsJapgolly.webgme.GmeCommon.ResultCallback
import typingsJapgolly.webgme.GmeCommon.VoidFn
import typingsJapgolly.webgme.GmeStorage.CommitHash
import typingsJapgolly.webgme.GmeStorage.CommitHashCallback
import typingsJapgolly.webgme.GmeStorage.CommitObject
import typingsJapgolly.webgme.GmeStorage.CommitResult
import typingsJapgolly.webgme.anon.Children
import typingsJapgolly.webgme.anon.FinishTime
import typingsJapgolly.webgme.anon.Members
...
object GmeClasses {
  ...
  trait Core extends StObject {
    ...
    /**
      ...
      */
    def loadByPath(startNode: Node, relativePath: Path): js.Promise[typingsJapgolly.webgme.GmeCommon.DataObject] = js.native
    /**
      * From the given starting node, it loads the path 
      * given as a series of relative ids (separated by '/') and returns the node it finds at the ends of the path. 
      * If there is no node, the function will return null.
    ...
    def loadByPath(
      startNode: Node,
      relativePath: Path,
      callback: ResultCallback[typingsJapgolly.webgme.GmeCommon.DataObject]
    ): Unit = js.native
    ...
    /**
      ...
      * @param relativeId the relative id of the child in question.
      */
    def loadChild(parent: Node, relativeId: String): js.Promise[js.Array[typingsJapgolly.webgme.GmeCommon.DataObject]] = js.native
    /**
      * Loads the child of the given parent pointed by the relative id. 
      * Behind the scenes, it means that it actually loads the 
      * data pointed by a hash stored inside the parent under 
    ...
    def loadChild(
      parent: Node,
      relativeId: String,
      callback: ResultCallback[js.Array[typingsJapgolly.webgme.GmeCommon.DataObject]]
    ): Unit = js.native
    ...
    /**
      ...
      */
    def loadChildren(parent: Node): js.Promise[js.Array[typingsJapgolly.webgme.GmeCommon.DataObject]] = js.native
    /**
      * Loads all the children of the given parent. 
      * As it first checks the already reserved relative ids of the parent, 
      * it only loads the already existing children (so no on-demand empty node creation).
      ...
      * @see https://github.com/webgme/webgme/wiki/GME-Core-API#containment-methods
      */
    def loadChildren(parent: Node, callback: ResultCallback[js.Array[typingsJapgolly.webgme.GmeCommon.DataObject]]): Unit = js.native
    ...
    /**
      ...
      */
    def loadCollection(target: Node, pointerName: Name): js.Promise[js.Array[typingsJapgolly.webgme.GmeCommon.DataObject]] = js.native
    /**
      * Loads all the source nodes that has such a pointer and its target is the given node.
      * @param target the container node in question.
      * @param pointerName 
  ...
  trait Project extends StObject {
    ...
    /**
      ...
      */
    def createTag(tagName: String, commitHash: CommitHash): js.Promise[typingsJapgolly.webgme.GmeStorage.ErrorOnlyCallback] = js.native
    /**
      * Creates a new tag pointing to the provided commit hash.
      */
    def createTag(
      ...
      callback: typingsJapgolly.webgme.GmeStorage.ErrorOnlyCallback
    ): Unit = js.native
    ...
    /**
      ...
      */
    def deleteTag(tagName: String, callback: typingsJapgolly.webgme.GmeStorage.ErrorOnlyCallback): Unit = js.native
    /**
      * Deletes the given tag.
      */
    ...
    /** 
      ...
      */
    def loadPaths(rootKey: String, paths: js.Array[String]): js.Promise[typingsJapgolly.webgme.GmeStorage.ErrorOnlyCallback] = js.native
    /** 
      * Collects the objects from the server and pre-loads 
      * them into the cache making the load of multiple objects faster.
      * 
