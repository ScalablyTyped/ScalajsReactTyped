...
package object Gme {
  ...
  type ProjectResult = js.Array[typingsJapgolly.webgme.Gme.Project] | org.scalablytyped.runtime.StringDictionary[typingsJapgolly.webgme.Gme.Project]
  /**
    ...
    */
  type TerritoryEventHandler = js.Function1[/* event */ js.Array[typingsJapgolly.webgme.Gme.Event], scala.Unit]
  type TerritoryId = typingsJapgolly.webgme.Core.GUID
}
