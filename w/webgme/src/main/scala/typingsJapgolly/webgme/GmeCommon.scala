...
import typingsJapgolly.webgme.anon.Filter
import typingsJapgolly.webgme.anon.Level
import typingsJapgolly.webgme.anon.Ptr
...
object GmeCommon {
  ...
  */
  ...
  object DefObject {
    ...
    inline def DefAssetObject(): typingsJapgolly.webgme.GmeCommon.DefAssetObject = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("asset")
      __obj.asInstanceOf[typingsJapgolly.webgme.GmeCommon.DefAssetObject]
    }
    
    inline def DefBoolObject(): typingsJapgolly.webgme.GmeCommon.DefBoolObject = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("boolean")
      __obj.asInstanceOf[typingsJapgolly.webgme.GmeCommon.DefBoolObject]
    }
    
    inline def DefFloatObject(): typingsJapgolly.webgme.GmeCommon.DefFloatObject = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("float")
      __obj.asInstanceOf[typingsJapgolly.webgme.GmeCommon.DefFloatObject]
    }
    
    inline def DefIntegerObject(): typingsJapgolly.webgme.GmeCommon.DefIntegerObject = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("integer")
      __obj.asInstanceOf[typingsJapgolly.webgme.GmeCommon.DefIntegerObject]
    }
    
    inline def DefStringObject(): typingsJapgolly.webgme.GmeCommon.DefStringObject = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("string")
      __obj.asInstanceOf[typingsJapgolly.webgme.GmeCommon.DefStringObject]
    }
  }
  ...
  /**
    ...
    */
  type LoadObject = CommitObject | typingsJapgolly.webgme.Core.DataObject
  ...
  object MetaRules {
    ...
    extension [Self <: MetaRules](x: Self) {
      ...
      inline def setConstraints(value: Dictionary[typingsJapgolly.webgme.Core.Constraint]): Self = StObject.set(x, "constraints", value.asInstanceOf[js.Any])
