...
trait Members extends StObject {
  ...
  /** the name of the set. */
  var name: typingsJapgolly.webgme.GmeCommon.Name
...
object Members {
  ...
  inline def apply(name: typingsJapgolly.webgme.GmeCommon.Name, node: Node): Members = {
  ...
  extension [Self <: Members](x: Self) {
    ...
    inline def setName(value: typingsJapgolly.webgme.GmeCommon.Name): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
