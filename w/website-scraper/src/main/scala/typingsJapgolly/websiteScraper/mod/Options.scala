...
object Options {
  ...
  def apply(
    ...
    urlFilter: /* url */ String => CallbackTo[Boolean] = null
  ): Options = {
    ...
    if (urlFilter != null) __obj.updateDynamic("urlFilter")(js.Any.fromFunction1((t0: /* url */ java.lang.String) => urlFilter(t0).runNow()))
