package typingsJapgolly.webfontloader
...
object mod {
  ...
  object Config {
    ...
    extension [Self <: Config](x: Self) {
      ...
      inline def setActive(value: Callback): Self = StObject.set(x, "active", value.toJsFn)
      ...
      inline def setFontactive(value: (/* familyName */ String, /* fvd */ String) => Callback): Self = StObject.set(x, "fontactive", js.Any.fromFunction2((t0: /* familyName */ String, t1: /* fvd */ String) => (value(t0, t1)).runNow()))
      ...
      inline def setFontinactive(value: (/* familyName */ String, /* fvd */ String) => Callback): Self = StObject.set(x, "fontinactive", js.Any.fromFunction2((t0: /* familyName */ String, t1: /* fvd */ String) => (value(t0, t1)).runNow()))
      
      inline def setFontinactiveUndefined: Self = StObject.set(x, "fontinactive", js.undefined)
      
      inline def setFontloading(value: (/* familyName */ String, /* fvd */ String) => Callback): Self = StObject.set(x, "fontloading", js.Any.fromFunction2((t0: /* familyName */ String, t1: /* fvd */ String) => (value(t0, t1)).runNow()))
      ...
      inline def setInactive(value: Callback): Self = StObject.set(x, "inactive", value.toJsFn)
      
      inline def setInactiveUndefined: Self = StObject.set(x, "inactive", js.undefined)
      
      inline def setLoading(value: Callback): Self = StObject.set(x, "loading", value.toJsFn)
