...
trait OnHistoryStateUpdatedDetailsType extends StObject {
...
object OnHistoryStateUpdatedDetailsType {
  
  inline def apply(frameId: Double, tabId: Double, timeStamp: Double, url: String): OnHistoryStateUpdatedDetailsType = {
