...
trait OnCommittedDetailsType extends StObject {
...
object OnCommittedDetailsType {
  
  inline def apply(frameId: Double, tabId: Double, timeStamp: Double, url: String): OnCommittedDetailsType = {
