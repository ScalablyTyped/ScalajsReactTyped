...
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.ExtensionURL
import typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.author_
...
object namespacesExtensionTypesMod {
  ...
  object ExtensionTypes {
    ...
    /* Rewritten from type alias, can be one of: 
      ...
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.author_
    */
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.ExtensionFileOrCodeC1Type
      - typingsJapgolly.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.ExtensionFileOrCodeC2Type
    */
    trait ExtensionFileOrCode extends StObject
    object ExtensionFileOrCode {
      
      inline def ExtensionFileOrCodeC1Type(file: ExtensionURL): typingsJapgolly.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.ExtensionFileOrCodeC1Type = {
        val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.ExtensionFileOrCodeC1Type]
      }
      
      inline def ExtensionFileOrCodeC2Type(code: String): typingsJapgolly.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.ExtensionFileOrCodeC2Type = {
        val __obj = js.Dynamic.literal(code = code.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.ExtensionFileOrCodeC2Type]
      }
    }
    ...
    */
    ...
    /**
      ...
      */
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.document_start
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.document_end
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.document_idle
    */
    trait RunAt extends StObject
    object RunAt {
      
      inline def document_end: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.document_end = "document_end".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.document_end]
      
      inline def document_idle: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.document_idle = "document_idle".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.document_idle]
      
      inline def document_start: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.document_start = "document_start".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.document_start]
    }
