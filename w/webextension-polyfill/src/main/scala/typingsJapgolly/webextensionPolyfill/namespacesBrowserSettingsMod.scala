...
object namespacesBrowserSettingsMod {
  ...
  object BrowserSettings {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.off
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.full
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.tagged_only
    */
    trait ColorManagementMode extends StObject
    object ColorManagementMode {
      
      inline def full: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.full = "full".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.full]
      
      inline def off: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.off = "off".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.off]
      
      inline def tagged_only: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.tagged_only = "tagged_only".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.tagged_only]
    }
    ...
    /**
      ...
      */
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.mouseup
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.mousedown
    */
    trait ContextMenuMouseEvent extends StObject
    object ContextMenuMouseEvent {
      
      inline def mousedown: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.mousedown = "mousedown".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.mousedown]
      
      inline def mouseup: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.mouseup = "mouseup".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.mouseup]
    }
    ...
    /* Rewritten from type alias, can be one of: 
      ...
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.none
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.once
    */
    trait ImageAnimationBehavior extends StObject
    object ImageAnimationBehavior {
      
      inline def none: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.none = "none".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.none]
      ...
      inline def once: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.once = "once".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.once]
    }
    ...
    trait Static extends StObject {
      ...
      var colorManagement: typingsJapgolly.webextensionPolyfill.namespacesBrowserSettingsColorManagementMod.BrowserSettingsColorManagement.Static
    ...
    object Static {
      ...
      inline def apply(
        ...
        colorManagement: typingsJapgolly.webextensionPolyfill.namespacesBrowserSettingsColorManagementMod.BrowserSettingsColorManagement.Static,
      ...
      extension [Self <: Static](x: Self) {
        ...
        inline def setColorManagement(
          value: typingsJapgolly.webextensionPolyfill.namespacesBrowserSettingsColorManagementMod.BrowserSettingsColorManagement.Static
