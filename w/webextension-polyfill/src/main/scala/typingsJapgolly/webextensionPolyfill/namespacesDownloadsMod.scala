...
object namespacesDownloadsMod {
  ...
  object Downloads {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.file
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.url
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.content
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.uncommon
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.host
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.unwanted
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.safe
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.accepted
    */
    trait DangerType extends StObject
    object DangerType {
      
      inline def accepted: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.accepted = "accepted".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.accepted]
      
      inline def content: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.content = "content".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.content]
      
      inline def file: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.file = "file".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.file]
      
      inline def host: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.host = "host".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.host]
      
      inline def safe: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.safe = "safe".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.safe]
      
      inline def uncommon: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.uncommon = "uncommon".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.uncommon]
      
      inline def unwanted: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.unwanted = "unwanted".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.unwanted]
    ...
    /**
      ...
      */
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.GET
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.POST
    */
    trait DownloadOptionsTypeMethodEnum extends StObject
    object DownloadOptionsTypeMethodEnum {
      
      inline def GET: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.GET = "GET".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.GET]
      
      inline def POST: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.POST = "POST".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.POST]
    }
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.uniquify
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.overwrite
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.prompt
    */
    ...
    object FilenameConflictAction {
      ...
      inline def prompt: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.prompt = "prompt".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.prompt]
      
      inline def uniquify: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.uniquify = "uniquify".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.uniquify]
    }
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_FAILED
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_ACCESS_DENIED
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_NO_SPACE
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_NAME_TOO_LONG
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_TOO_LARGE
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_VIRUS_INFECTED
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_TRANSIENT_ERROR
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_BLOCKED
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_SECURITY_CHECK_FAILED
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_TOO_SHORT
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_FAILED
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_TIMEOUT
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_DISCONNECTED
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_SERVER_DOWN
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_INVALID_REQUEST
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_FAILED
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_NO_RANGE
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_BAD_CONTENT
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_UNAUTHORIZED
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_CERT_PROBLEM
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_FORBIDDEN
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.USER_CANCELED
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.USER_SHUTDOWN
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.CRASH
    */
    trait InterruptReason extends StObject
    object InterruptReason {
      
      inline def CRASH: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.CRASH = "CRASH".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.CRASH]
      
      inline def FILE_ACCESS_DENIED: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_ACCESS_DENIED = "FILE_ACCESS_DENIED".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_ACCESS_DENIED]
      
      inline def FILE_BLOCKED: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_BLOCKED = "FILE_BLOCKED".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_BLOCKED]
      
      inline def FILE_FAILED: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_FAILED = "FILE_FAILED".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_FAILED]
      
      inline def FILE_NAME_TOO_LONG: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_NAME_TOO_LONG = "FILE_NAME_TOO_LONG".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_NAME_TOO_LONG]
      
      inline def FILE_NO_SPACE: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_NO_SPACE = "FILE_NO_SPACE".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_NO_SPACE]
      
      inline def FILE_SECURITY_CHECK_FAILED: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_SECURITY_CHECK_FAILED = "FILE_SECURITY_CHECK_FAILED".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_SECURITY_CHECK_FAILED]
      
      inline def FILE_TOO_LARGE: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_TOO_LARGE = "FILE_TOO_LARGE".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_TOO_LARGE]
      
      inline def FILE_TOO_SHORT: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_TOO_SHORT = "FILE_TOO_SHORT".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_TOO_SHORT]
      
      inline def FILE_TRANSIENT_ERROR: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_TRANSIENT_ERROR = "FILE_TRANSIENT_ERROR".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_TRANSIENT_ERROR]
      
      inline def FILE_VIRUS_INFECTED: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_VIRUS_INFECTED = "FILE_VIRUS_INFECTED".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.FILE_VIRUS_INFECTED]
      
      inline def NETWORK_DISCONNECTED: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_DISCONNECTED = "NETWORK_DISCONNECTED".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_DISCONNECTED]
      
      inline def NETWORK_FAILED: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_FAILED = "NETWORK_FAILED".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_FAILED]
      
      inline def NETWORK_INVALID_REQUEST: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_INVALID_REQUEST = "NETWORK_INVALID_REQUEST".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_INVALID_REQUEST]
      
      inline def NETWORK_SERVER_DOWN: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_SERVER_DOWN = "NETWORK_SERVER_DOWN".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_SERVER_DOWN]
      
      inline def NETWORK_TIMEOUT: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_TIMEOUT = "NETWORK_TIMEOUT".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.NETWORK_TIMEOUT]
      
      inline def SERVER_BAD_CONTENT: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_BAD_CONTENT = "SERVER_BAD_CONTENT".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_BAD_CONTENT]
      
      inline def SERVER_CERT_PROBLEM: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_CERT_PROBLEM = "SERVER_CERT_PROBLEM".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_CERT_PROBLEM]
      
      inline def SERVER_FAILED: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_FAILED = "SERVER_FAILED".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_FAILED]
      
      inline def SERVER_FORBIDDEN: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_FORBIDDEN = "SERVER_FORBIDDEN".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_FORBIDDEN]
      
      inline def SERVER_NO_RANGE: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_NO_RANGE = "SERVER_NO_RANGE".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_NO_RANGE]
      
      inline def SERVER_UNAUTHORIZED: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_UNAUTHORIZED = "SERVER_UNAUTHORIZED".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.SERVER_UNAUTHORIZED]
      
      inline def USER_CANCELED: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.USER_CANCELED = "USER_CANCELED".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.USER_CANCELED]
      
      inline def USER_SHUTDOWN: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.USER_SHUTDOWN = "USER_SHUTDOWN".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.USER_SHUTDOWN]
    }
    ...
    /**
      ...
      */
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.in_progress
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.interrupted
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.complete
    */
    trait State extends StObject
    object State {
      
      inline def complete: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.complete = "complete".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.complete]
      
      inline def in_progress: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.in_progress = "in_progress".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.in_progress]
      
      inline def interrupted: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.interrupted = "interrupted".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.interrupted]
    }
