...
import typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.managed
...
object namespacesBookmarksMod {
  ...
  object Bookmarks {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.bookmark
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.folder
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.separator
    */
    trait BookmarkTreeNodeType extends StObject
    object BookmarkTreeNodeType {
      
      inline def bookmark: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.bookmark = "bookmark".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.bookmark]
      
      inline def folder: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.folder = "folder".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.folder]
      
      inline def separator: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.separator = "separator".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.separator]
    }
