...
import typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.startup
...
object namespacesExperimentsMod {
  ...
  object Experiments {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.addon_child
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.content_child
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.devtools_child
    */
    trait APIChildScope extends StObject
    object APIChildScope {
      
      inline def addon_child: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.addon_child = "addon_child".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.addon_child]
      
      inline def content_child: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.content_child = "content_child".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.content_child]
      
      inline def devtools_child: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.devtools_child = "devtools_child".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.devtools_child]
    }
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.addon_parent
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.content_parent
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.devtools_parent
    */
    trait APIParentScope extends StObject
    object APIParentScope {
      
      inline def addon_parent: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.addon_parent = "addon_parent".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.addon_parent]
      
      inline def content_parent: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.content_parent = "content_parent".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.content_parent]
      
      inline def devtools_parent: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.devtools_parent = "devtools_parent".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.devtools_parent]
    }
