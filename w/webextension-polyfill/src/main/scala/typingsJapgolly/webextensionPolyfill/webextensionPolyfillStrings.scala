...
import typingsJapgolly.webextensionPolyfill.namespacesActivityLogMod.ActivityLog.OnExtensionActivityDetailsTypeTypeEnum
import typingsJapgolly.webextensionPolyfill.namespacesActivityLogMod.ActivityLog.OnExtensionActivityDetailsTypeViewTypeEnum
import typingsJapgolly.webextensionPolyfill.namespacesBookmarksMod.Bookmarks.BookmarkTreeNodeType
import typingsJapgolly.webextensionPolyfill.namespacesBrowserSettingsMod.BrowserSettings.ColorManagementMode
import typingsJapgolly.webextensionPolyfill.namespacesBrowserSettingsMod.BrowserSettings.ContextMenuMouseEvent
import typingsJapgolly.webextensionPolyfill.namespacesBrowserSettingsMod.BrowserSettings.ImageAnimationBehavior
import typingsJapgolly.webextensionPolyfill.namespacesCaptivePortalMod.CaptivePortal.OnConnectivityAvailableStatusEnum
import typingsJapgolly.webextensionPolyfill.namespacesCaptivePortalMod.CaptivePortal.OnStateChangedDetailsTypeStateEnum
import typingsJapgolly.webextensionPolyfill.namespacesClipboardMod.Clipboard.SetImageDataImageTypeEnum
import typingsJapgolly.webextensionPolyfill.namespacesCookiesMod.Cookies.OnChangedCause
import typingsJapgolly.webextensionPolyfill.namespacesCookiesMod.Cookies.SameSiteStatus
import typingsJapgolly.webextensionPolyfill.namespacesDnsMod.Dns.ResolveFlagsItemEnum
import typingsJapgolly.webextensionPolyfill.namespacesDownloadsMod.Downloads.DangerType
import typingsJapgolly.webextensionPolyfill.namespacesDownloadsMod.Downloads.DownloadOptionsTypeMethodEnum
import typingsJapgolly.webextensionPolyfill.namespacesDownloadsMod.Downloads.FilenameConflictAction
import typingsJapgolly.webextensionPolyfill.namespacesDownloadsMod.Downloads.InterruptReason
import typingsJapgolly.webextensionPolyfill.namespacesDownloadsMod.Downloads.State
import typingsJapgolly.webextensionPolyfill.namespacesExperimentsMod.Experiments.APIChildScope
import typingsJapgolly.webextensionPolyfill.namespacesExperimentsMod.Experiments.APIParentScope
import typingsJapgolly.webextensionPolyfill.namespacesExtensionMod.Extension.ViewType
import typingsJapgolly.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.CSSOrigin
import typingsJapgolly.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.ImageFormat
import typingsJapgolly.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.RunAt
import typingsJapgolly.webextensionPolyfill.namespacesGeckoProfilerMod.GeckoProfiler.ProfilerFeature
import typingsJapgolly.webextensionPolyfill.namespacesIdleMod.Idle.IdleState
import typingsJapgolly.webextensionPolyfill.namespacesManagementMod.Management.ExtensionDisabledReason
import typingsJapgolly.webextensionPolyfill.namespacesManagementMod.Management.ExtensionInstallType
import typingsJapgolly.webextensionPolyfill.namespacesManagementMod.Management.ExtensionType
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.ActionManifestDefaultAreaEnum
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.OptionalPermission
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.OptionalPermissionNoPrompt
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.PermissionNoPrompt
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.PermissionPrivileged
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.SitePermission
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.ThemeTypePropertiesAdditionalBackgroundsAlignmentItemEnum
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.ThemeTypePropertiesAdditionalBackgroundsTilingItemEnum
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.ThemeTypePropertiesColorSchemeEnum
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.ThemeTypePropertiesContentColorSchemeEnum
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.WebExtensionManifestIncognitoEnum
import typingsJapgolly.webextensionPolyfill.namespacesMenusMod.Menus.ContextType
import typingsJapgolly.webextensionPolyfill.namespacesMenusMod.Menus.ItemType
import typingsJapgolly.webextensionPolyfill.namespacesMenusMod.Menus.OnClickDataModifiersItemEnum
import typingsJapgolly.webextensionPolyfill.namespacesMenusMod.Menus.OverrideContextContextOptionsTypeContextEnum
import typingsJapgolly.webextensionPolyfill.namespacesNetworkStatusMod.NetworkStatus.NetworkLinkInfoStatusEnum
import typingsJapgolly.webextensionPolyfill.namespacesNetworkStatusMod.NetworkStatus.NetworkLinkInfoTypeEnum
import typingsJapgolly.webextensionPolyfill.namespacesNotificationsMod.Notifications.PermissionLevel
import typingsJapgolly.webextensionPolyfill.namespacesNotificationsMod.Notifications.TemplateType
import typingsJapgolly.webextensionPolyfill.namespacesOmniboxMod.Omnibox.DescriptionStyleType
import typingsJapgolly.webextensionPolyfill.namespacesOmniboxMod.Omnibox.OnInputEnteredDisposition
import typingsJapgolly.webextensionPolyfill.namespacesPrivacyNetworkMod.PrivacyNetwork.HTTPSOnlyModeOption
import typingsJapgolly.webextensionPolyfill.namespacesPrivacyNetworkMod.PrivacyNetwork.IPHandlingPolicy
import typingsJapgolly.webextensionPolyfill.namespacesPrivacyNetworkMod.PrivacyNetwork.TlsVersionRestrictionConfigMaximumEnum
import typingsJapgolly.webextensionPolyfill.namespacesPrivacyNetworkMod.PrivacyNetwork.TlsVersionRestrictionConfigMinimumEnum
import typingsJapgolly.webextensionPolyfill.namespacesPrivacyWebsitesMod.PrivacyWebsites.CookieConfigBehaviorEnum
import typingsJapgolly.webextensionPolyfill.namespacesPrivacyWebsitesMod.PrivacyWebsites.TrackingProtectionModeOption
import typingsJapgolly.webextensionPolyfill.namespacesProxyMod.Proxy.ProxyConfigProxyTypeEnum
import typingsJapgolly.webextensionPolyfill.namespacesRuntimeMod.Runtime.OnInstalledReason
import typingsJapgolly.webextensionPolyfill.namespacesRuntimeMod.Runtime.OnRestartRequiredReason
import typingsJapgolly.webextensionPolyfill.namespacesRuntimeMod.Runtime.PlatformArch
import typingsJapgolly.webextensionPolyfill.namespacesRuntimeMod.Runtime.PlatformOs
import typingsJapgolly.webextensionPolyfill.namespacesRuntimeMod.Runtime.RequestUpdateCheckStatus
import typingsJapgolly.webextensionPolyfill.namespacesScriptingMod.Scripting.CSSInjectionOriginEnum
import typingsJapgolly.webextensionPolyfill.namespacesScriptingMod.Scripting.StyleOrigin
import typingsJapgolly.webextensionPolyfill.namespacesTabsMod.Tabs.MutedInfoReason
import typingsJapgolly.webextensionPolyfill.namespacesTabsMod.Tabs.TabStatus
import typingsJapgolly.webextensionPolyfill.namespacesTabsMod.Tabs.UpdatePropertyName
import typingsJapgolly.webextensionPolyfill.namespacesTabsMod.Tabs.WindowType
import typingsJapgolly.webextensionPolyfill.namespacesTabsMod.Tabs.ZoomSettingsMode
import typingsJapgolly.webextensionPolyfill.namespacesTabsMod.Tabs.ZoomSettingsScope
import typingsJapgolly.webextensionPolyfill.namespacesTopSitesMod.TopSites.MostVisitedURLTypeEnum
import typingsJapgolly.webextensionPolyfill.namespacesTypesMod.Types.LevelOfControl
import typingsJapgolly.webextensionPolyfill.namespacesTypesMod.Types.SettingScope
import typingsJapgolly.webextensionPolyfill.namespacesUrlbarMod.Urlbar.EngagementState
import typingsJapgolly.webextensionPolyfill.namespacesUrlbarMod.Urlbar.OnBehaviorRequestedReturnEnum
import typingsJapgolly.webextensionPolyfill.namespacesUrlbarMod.Urlbar.ResultType
import typingsJapgolly.webextensionPolyfill.namespacesUrlbarMod.Urlbar.SourceType
import typingsJapgolly.webextensionPolyfill.namespacesWebNavigationMod.WebNavigation.TransitionQualifier
import typingsJapgolly.webextensionPolyfill.namespacesWebNavigationMod.WebNavigation.TransitionType
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.CertificateTransparencyStatus
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.OnAuthRequiredOptions
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.OnBeforeRedirectOptions
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.OnBeforeRequestOptions
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.OnBeforeSendHeadersOptions
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.OnCompletedOptions
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.OnHeadersReceivedOptions
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.OnResponseStartedOptions
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.OnSendHeadersOptions
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.ResourceType
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.SecurityInfoProtocolVersionEnum
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.SecurityInfoStateEnum
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.StreamFilterStatus
import typingsJapgolly.webextensionPolyfill.namespacesWebRequestMod.WebRequest.UrlClassificationFlags
import typingsJapgolly.webextensionPolyfill.namespacesWindowsMod.Windows.CreateType
import typingsJapgolly.webextensionPolyfill.namespacesWindowsMod.Windows.WindowState
...
object webextensionPolyfillStrings {
  ...
  sealed trait Alt
    extends StObject
       ...
       with typingsJapgolly.webextensionPolyfill.namespacesPageActionMod.PageAction.OnClickDataModifiersItemEnum
       with typingsJapgolly.webextensionPolyfill.namespacesActionMod.Action.OnClickDataModifiersItemEnum
  ...
  sealed trait app
    extends StObject
       with WindowType
       with typingsJapgolly.webextensionPolyfill.namespacesWindowsMod.Windows.WindowType
  ...
  sealed trait auto_bookmark
    extends StObject
       with TransitionType
       with typingsJapgolly.webextensionPolyfill.namespacesHistoryMod.History.TransitionType
