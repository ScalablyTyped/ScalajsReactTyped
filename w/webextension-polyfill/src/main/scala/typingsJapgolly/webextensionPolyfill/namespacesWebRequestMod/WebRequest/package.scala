...
import typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.cipher
import typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.extraHeaders
