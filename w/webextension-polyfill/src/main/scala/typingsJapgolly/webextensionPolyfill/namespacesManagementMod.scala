...
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.ExtensionID
...
object namespacesManagementMod {
  ...
  object Management {
    ...
    /* Rewritten from type alias, can be one of: 
      ...
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.permissions_increase
    */
    trait ExtensionDisabledReason extends StObject
    object ExtensionDisabledReason {
      
      inline def permissions_increase: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.permissions_increase = "permissions_increase".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.permissions_increase]
    ...
    /**
      ...
      */
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.development
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.normal
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.sideload
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.other
    */
    trait ExtensionInstallType extends StObject
    object ExtensionInstallType {
      
      inline def development: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.development = "development".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.development]
      ...
      inline def other: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.other = "other".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.other]
      
      inline def sideload: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.sideload = "sideload".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.sideload]
    }
    ...
    /* Rewritten from type alias, can be one of: 
      ...
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.theme
    */
    ...
    object ExtensionType {
      ...
      inline def theme: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.theme = "theme".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.theme]
    }
