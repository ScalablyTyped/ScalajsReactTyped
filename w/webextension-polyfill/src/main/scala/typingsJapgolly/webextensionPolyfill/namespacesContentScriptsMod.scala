...
object namespacesContentScriptsMod {
  ...
  object ContentScripts {
    ...
    object RegisteredContentScript {
      ...
      inline def apply(unregister: CallbackTo[js.Promise[Unit]]): RegisteredContentScript = {
      ...
      extension [Self <: RegisteredContentScript](x: Self) {
        ...
        inline def setUnregister(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "unregister", value.toJsFn)
      }
    }
