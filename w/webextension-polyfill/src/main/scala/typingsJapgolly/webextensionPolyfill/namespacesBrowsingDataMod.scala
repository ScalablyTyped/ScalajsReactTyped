  ...
  object BrowsingData {
    ...
    object Static {
      ...
      extension [Self <: Static](x: Self) {
        ...
        inline def setSettings(value: CallbackTo[js.Promise[SettingsCallbackResultType]]): Self = StObject.set(x, "settings", value.toJsFn)
      }
    }
  }
}
