...
object namespacesActionMod {
  ...
  object Action {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.Shift
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.Alt
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.Command
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.Ctrl
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.MacCtrl
    */
    trait OnClickDataModifiersItemEnum extends StObject
    object OnClickDataModifiersItemEnum {
      
      inline def Alt: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.Alt = "Alt".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.Alt]
      
      inline def Command: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.Command = "Command".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.Command]
      
      inline def Ctrl: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.Ctrl = "Ctrl".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.Ctrl]
      
      inline def MacCtrl: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.MacCtrl = "MacCtrl".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.MacCtrl]
      
      inline def Shift: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.Shift = "Shift".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.Shift]
    }
