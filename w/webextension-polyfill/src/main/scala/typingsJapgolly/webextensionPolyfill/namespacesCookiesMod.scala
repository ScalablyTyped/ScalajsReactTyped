...
object namespacesCookiesMod {
  ...
  object Cookies {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.evicted
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.expired
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.explicit
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.expired_overwrite
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.overwrite
    */
    trait OnChangedCause extends StObject
    object OnChangedCause {
      
      inline def evicted: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.evicted = "evicted".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.evicted]
      
      inline def expired: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.expired = "expired".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.expired]
      
      inline def expired_overwrite: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.expired_overwrite = "expired_overwrite".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.expired_overwrite]
      
      inline def explicit: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.explicit = "explicit".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.explicit]
      
      inline def overwrite: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.overwrite = "overwrite".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.overwrite]
    }
    ...
    /**
      ...
      */
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.no_restriction
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.lax
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.strict
    */
    trait SameSiteStatus extends StObject
    object SameSiteStatus {
      
      inline def lax: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.lax = "lax".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.lax]
      
      inline def no_restriction: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.no_restriction = "no_restriction".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.no_restriction]
      
      inline def strict: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.strict = "strict".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.strict]
    }
    ...
    object Static {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(get = js.Any.fromFunction1(get), getAll = js.Any.fromFunction1(getAll), getAllCookieStores = getAllCookieStores.toJsFn, onChanged = onChanged.asInstanceOf[js.Any], remove = js.Any.fromFunction1(remove), set = js.Any.fromFunction1(set))
      ...
      extension [Self <: Static](x: Self) {
        ...
        inline def setGetAllCookieStores(value: CallbackTo[js.Promise[js.Array[CookieStore]]]): Self = StObject.set(x, "getAllCookieStores", value.toJsFn)
