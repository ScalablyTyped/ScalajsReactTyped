  ...
  object Commands {
    ...
    object Static {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(getAll = getAll.toJsFn, onCommand = onCommand.asInstanceOf[js.Any], reset = js.Any.fromFunction1(reset), update = js.Any.fromFunction1(update))
        __obj.asInstanceOf[Static]
      }
      
      extension [Self <: Static](x: Self) {
        
        inline def setGetAll(value: CallbackTo[js.Promise[js.Array[Command]]]): Self = StObject.set(x, "getAll", value.toJsFn)
