...
object namespacesNormandyAddonStudyMod {
  ...
  object NormandyAddonStudy {
    ...
    object Static {
      ...
      inline def apply(
        endStudy: String => Callback,
        getClientMetadata: Callback,
        getStudy: Callback,
        onUnenroll: Event[js.Function1[/* reason */ String, Unit]]
      ): Static = {
        val __obj = js.Dynamic.literal(endStudy = js.Any.fromFunction1((t0: String) => endStudy(t0).runNow()), getClientMetadata = getClientMetadata.toJsFn, getStudy = getStudy.toJsFn, onUnenroll = onUnenroll.asInstanceOf[js.Any])
        __obj.asInstanceOf[Static]
      }
      
      extension [Self <: Static](x: Self) {
        
        inline def setEndStudy(value: String => Callback): Self = StObject.set(x, "endStudy", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
        
        inline def setGetClientMetadata(value: Callback): Self = StObject.set(x, "getClientMetadata", value.toJsFn)
        
        inline def setGetStudy(value: Callback): Self = StObject.set(x, "getStudy", value.toJsFn)
