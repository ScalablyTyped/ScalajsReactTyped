...
import typingsJapgolly.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.RunAt
import typingsJapgolly.webextensionPolyfill.namespacesManifestMod.Manifest.ExtensionURL
import typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.ISOLATED
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object namespacesScriptingMod {
  ...
  object Scripting {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.USER
      - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.AUTHOR
    */
    trait CSSInjectionOriginEnum extends StObject
    object CSSInjectionOriginEnum {
      
      inline def AUTHOR: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.AUTHOR = "AUTHOR".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.AUTHOR]
      
      inline def USER: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.USER = "USER".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.USER]
    }
