...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.`per-origin`
  - typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.`per-tab`
*/
trait ZoomSettingsScope extends StObject
object ZoomSettingsScope {
  
  inline def `per-origin`: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.`per-origin` = "per-origin".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.`per-origin`]
  
  inline def `per-tab`: typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.`per-tab` = "per-tab".asInstanceOf[typingsJapgolly.webextensionPolyfill.webextensionPolyfillStrings.`per-tab`]
}
