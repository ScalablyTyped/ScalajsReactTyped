    ...
    */
    ...
    object Static {
      ...
      extension [Self <: Static](x: Self) {
        ...
        inline def setOpenPopup(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "openPopup", value.toJsFn)
        ...
        inline def setSetTitle(value: SetTitleDetailsType => Callback): Self = StObject.set(x, "setTitle", js.Any.fromFunction1((t0: SetTitleDetailsType) => value(t0).runNow()))
