  ...
  object Events {
    ...
    object Event {
      ...
      inline def apply[T /* <: js.Function1[/* repeated */ Any, Any] */](
        addListener: (T, /* repeated */ Any) => Callback,
        hasListener: T => Boolean,
        hasListeners: CallbackTo[Boolean],
        removeListener: T => Callback
      ): Event[T] = {
        val __obj = js.Dynamic.literal(addListener = js.Any.fromFunction2((t0: T, t1: /* repeated */ Any) => (addListener(t0, t1)).runNow()), hasListener = js.Any.fromFunction1(hasListener), hasListeners = hasListeners.toJsFn, removeListener = js.Any.fromFunction1((t0: T) => removeListener(t0).runNow()))
        __obj.asInstanceOf[Event[T]]
      }
      
      extension [Self <: Event[?], T /* <: js.Function1[/* repeated */ Any, Any] */](x: Self & Event[T]) {
        
        inline def setAddListener(value: (T, /* repeated */ Any) => Callback): Self = StObject.set(x, "addListener", js.Any.fromFunction2((t0: T, t1: /* repeated */ Any) => (value(t0, t1)).runNow()))
        ...
        inline def setRemoveListener(value: T => Callback): Self = StObject.set(x, "removeListener", js.Any.fromFunction1((t0: T) => value(t0).runNow()))
      }
    }
