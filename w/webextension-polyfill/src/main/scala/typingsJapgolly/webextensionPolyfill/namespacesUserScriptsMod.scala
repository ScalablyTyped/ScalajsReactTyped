...
import typingsJapgolly.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.ExtensionFileOrCode
import typingsJapgolly.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.PlainJSONValue
...
object namespacesUserScriptsMod {
  ...
  object UserScripts {
    ...
    object RegisteredUserScript {
      ...
      inline def apply(unregister: Callback): RegisteredUserScript = {
    ...
    object Static {
      ...
      inline def apply(register: UserScriptOptions => Callback): Static = {
        val __obj = js.Dynamic.literal(register = js.Any.fromFunction1((t0: UserScriptOptions) => register(t0).runNow()))
        __obj.asInstanceOf[Static]
      }
      
      extension [Self <: Static](x: Self) {
        
        inline def setRegister(value: UserScriptOptions => Callback): Self = StObject.set(x, "register", js.Any.fromFunction1((t0: UserScriptOptions) => value(t0).runNow()))
      }
    }
