...
object anon {
  ...
  trait BoundariesElement[TItem, CustomTextAreaProps /* <: TextareaHTMLAttributes[HTMLTextAreaElement] */] extends StObject {
    ...
    /**
      ...
      */
    var loadingComponent: typingsJapgolly.webscopeioReactTextareaAutocomplete.mod.Component[Data[TItem]]
    ...
    var textAreaComponent: js.UndefOr[
        typingsJapgolly.webscopeioReactTextareaAutocomplete.mod.Component[CustomTextAreaProps] | Component[CustomTextAreaProps]
      ] = js.undefined
  ...
  object BoundariesElement {
    ...
    inline def apply[TItem, CustomTextAreaProps /* <: TextareaHTMLAttributes[HTMLTextAreaElement] */](
      loadingComponent: typingsJapgolly.webscopeioReactTextareaAutocomplete.mod.Component[Data[TItem]],
    ...
    extension [Self <: BoundariesElement[?, ?], TItem, CustomTextAreaProps /* <: TextareaHTMLAttributes[HTMLTextAreaElement] */](x: Self & (BoundariesElement[TItem, CustomTextAreaProps])) {
      ...
      inline def setInnerRef(value: /* ref */ HTMLTextAreaElement => Callback): Self = StObject.set(x, "innerRef", js.Any.fromFunction1((t0: /* ref */ HTMLTextAreaElement) => value(t0).runNow()))
      ...
      inline def setLoadingComponent(value: typingsJapgolly.webscopeioReactTextareaAutocomplete.mod.Component[Data[TItem]]): Self = StObject.set(x, "loadingComponent", value.asInstanceOf[js.Any])
      ...
      inline def setOnCaretPositionChange(value: /* pos */ Double => Callback): Self = StObject.set(x, "onCaretPositionChange", js.Any.fromFunction1((t0: /* pos */ Double) => value(t0).runNow()))
      
      inline def setOnCaretPositionChangeUndefined: Self = StObject.set(x, "onCaretPositionChange", js.undefined)
      
      inline def setOnItemHighlighted(value: /* event */ CurrentTrigger[TItem] => Callback): Self = StObject.set(x, "onItemHighlighted", js.Any.fromFunction1((t0: /* event */ CurrentTrigger[TItem]) => value(t0).runNow()))
      
      inline def setOnItemHighlightedUndefined: Self = StObject.set(x, "onItemHighlighted", js.undefined)
      
      inline def setOnItemSelected(value: /* event */ Item[TItem] => Callback): Self = StObject.set(x, "onItemSelected", js.Any.fromFunction1((t0: /* event */ Item[TItem]) => value(t0).runNow()))
      ...
      inline def setScrollToItemFunction2(value: (/* container */ HTMLDivElement, /* item */ HTMLDivElement) => Callback): Self = StObject.set(x, "scrollToItem", js.Any.fromFunction2((t0: /* container */ HTMLDivElement, t1: /* item */ HTMLDivElement) => (value(t0, t1)).runNow()))
      ...
      inline def setTextAreaComponent(
        value: typingsJapgolly.webscopeioReactTextareaAutocomplete.mod.Component[CustomTextAreaProps] | Component[CustomTextAreaProps]
  ...
  trait Component[CustomTextAreaProps /* <: TextareaHTMLAttributes[HTMLTextAreaElement] */] extends StObject {
    ...
    var component: typingsJapgolly.webscopeioReactTextareaAutocomplete.mod.Component[CustomTextAreaProps]
  ...
  object Component {
    ...
    inline def apply[CustomTextAreaProps /* <: TextareaHTMLAttributes[HTMLTextAreaElement] */](
      component: typingsJapgolly.webscopeioReactTextareaAutocomplete.mod.Component[CustomTextAreaProps],
      ref: String
    ...
    extension [Self <: Component[?], CustomTextAreaProps /* <: TextareaHTMLAttributes[HTMLTextAreaElement] */](x: Self & Component[CustomTextAreaProps]) {
      ...
      inline def setComponent(value: typingsJapgolly.webscopeioReactTextareaAutocomplete.mod.Component[CustomTextAreaProps]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
