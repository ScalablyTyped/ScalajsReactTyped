...
import typingsJapgolly.webscopeioReactTextareaAutocomplete.anon.BoundariesElement
import typingsJapgolly.webscopeioReactTextareaAutocomplete.anon.SelectionEnd
...
object mod {
  ...
  */
  ...
  type Component[P /* <: js.Object */] = FunctionComponent[P] | (ComponentClassP[P & js.Object])
  ...
  trait ReactTextareaAutocomplete[TItem /* <: String | js.Object */, CustomTextAreaProps /* <: TextareaHTMLAttributes[HTMLTextAreaElement] */]
    extends typingsJapgolly.react.mod.Component[TextareaProps[TItem, CustomTextAreaProps], TextareaState[TItem], Any] {
