...
import typingsJapgolly.wavEncoder.anon.Call
...
object mod {
  ...
  inline def encode(audioData: AudioData): js.Promise[js.typedarray.ArrayBuffer] = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(audioData.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.typedarray.ArrayBuffer]]
  inline def encode(audioData: AudioData, opts: Options): js.Promise[js.typedarray.ArrayBuffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(audioData.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.typedarray.ArrayBuffer]]
  ...
  object AudioData {
    ...
    inline def apply(channelData: js.Array[js.typedarray.Float32Array], sampleRate: Double): AudioData = {
