...
import typingsJapgolly.websocketStream.websocketStreamStrings.close
import typingsJapgolly.websocketStream.websocketStreamStrings.connection
import typingsJapgolly.websocketStream.websocketStreamStrings.data
import typingsJapgolly.websocketStream.websocketStreamStrings.drain
import typingsJapgolly.websocketStream.websocketStreamStrings.end
import typingsJapgolly.websocketStream.websocketStreamStrings.error
import typingsJapgolly.websocketStream.websocketStreamStrings.finish
import typingsJapgolly.websocketStream.websocketStreamStrings.headers
import typingsJapgolly.websocketStream.websocketStreamStrings.listening
import typingsJapgolly.websocketStream.websocketStreamStrings.pipe
import typingsJapgolly.websocketStream.websocketStreamStrings.readable
import typingsJapgolly.websocketStream.websocketStreamStrings.stream
import typingsJapgolly.websocketStream.websocketStreamStrings.unpipe
...
object mod extends js.Object {
  @js.native
  class Server ()
    extends typingsJapgolly.ws.mod.Server {
    @JSName("on")
    def on_connection(
      event: connection,
