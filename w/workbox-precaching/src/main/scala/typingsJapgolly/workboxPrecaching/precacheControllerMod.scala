...
import typingsJapgolly.workboxPrecaching.typesCleanupResultMod.CleanupResult
import typingsJapgolly.workboxPrecaching.typesInstallResultMod.InstallResult
