...
import typingsJapgolly.walkdir.walkdirBooleans.`false`
import typingsJapgolly.walkdir.walkdirBooleans.`true`
...
object synctruereturnobjectfalse {
  @scala.inline
  def apply(
    filter: (/* directory */ String, /* files */ js.Array[String]) => CallbackTo[js.Array[String] | js.Promise[js.Array[String]]] = null,
    ...
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction2((t0: /* directory */ java.lang.String, t1: /* files */ js.Array[java.lang.String]) => filter(t0, t1).runNow()))
