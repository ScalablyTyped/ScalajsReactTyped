package typingsJapgolly.wordpressUrl

import typingsJapgolly.std.Record
import typingsJapgolly.wordpressUrl.buildTypesGetQueryArgMod.QueryArgParsed
import typingsJapgolly.wordpressUrl.buildTypesGetQueryArgsMod.QueryArgs
