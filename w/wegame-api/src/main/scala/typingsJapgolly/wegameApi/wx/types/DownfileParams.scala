...
import typingsJapgolly.wegameApi.anon.StatusCode
...
object DownfileParams {
  ...
  extension [Self <: DownfileParams](x: Self) {
    ...
    inline def setSuccess(value: /* res */ StatusCode => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ StatusCode) => value(t0).runNow()))
