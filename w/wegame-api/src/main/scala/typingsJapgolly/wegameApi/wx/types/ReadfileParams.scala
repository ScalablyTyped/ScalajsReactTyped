...
object ReadfileParams {
  ...
  extension [Self <: ReadfileParams](x: Self) {
    ...
    inline def setSuccess(value: /* res */ `0` => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ `0`) => value(t0).runNow()))
