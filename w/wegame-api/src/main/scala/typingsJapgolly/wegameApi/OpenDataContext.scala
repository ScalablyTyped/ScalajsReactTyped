...
object OpenDataContext {
  ...
  inline def apply(canvas: Canvas, postMessage: Any => Callback): OpenDataContext = {
    val __obj = js.Dynamic.literal(canvas = canvas.asInstanceOf[js.Any], postMessage = js.Any.fromFunction1((t0: Any) => postMessage(t0).runNow()))
