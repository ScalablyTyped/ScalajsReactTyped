...
object List {
  ...
  inline def apply(list: js.Array[AvatarUrl]): typingsJapgolly.wegameApi.anon.List = {
    val __obj = js.Dynamic.literal(list = list.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsJapgolly.wegameApi.anon.List]
  }
  
  extension [Self <: typingsJapgolly.wegameApi.anon.List](x: Self) {
