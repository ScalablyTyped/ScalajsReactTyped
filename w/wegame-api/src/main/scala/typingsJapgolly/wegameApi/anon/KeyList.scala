...
object KeyList {
  ...
  inline def apply(keyList: js.Array[String]): KeyList = {
  ...
  extension [Self <: KeyList](x: Self) {
    ...
    inline def setSuccess(value: /* res */ KVDataList => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ KVDataList) => value(t0).runNow()))
