...
import typingsJapgolly.wegameApi.wegameApiStrings.CNY
import typingsJapgolly.wegameApi.wegameApiStrings.android
...
object BuyQuantity {
  ...
  extension [Self <: BuyQuantity](x: Self) {
    ...
    inline def setEnv(value: typingsJapgolly.wegameApi.wegameApiInts.`0` | typingsJapgolly.wegameApi.wegameApiInts.`1`): Self = StObject.set(x, "env", value.asInstanceOf[js.Any])
