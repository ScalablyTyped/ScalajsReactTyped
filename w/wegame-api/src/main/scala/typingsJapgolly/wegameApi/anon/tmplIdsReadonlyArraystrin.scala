...
object tmplIdsReadonlyArraystrin {
  ...
  extension [Self <: tmplIdsReadonlyArraystrin](x: Self) {
    ...
    inline def setSuccess(value: /* res */ DictTEMPLATEID => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ DictTEMPLATEID) => value(t0).runNow()))
