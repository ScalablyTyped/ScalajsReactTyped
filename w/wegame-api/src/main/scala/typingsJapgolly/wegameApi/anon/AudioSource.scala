...
import typingsJapgolly.wegameApi.wegameApiInts.`11025`
import typingsJapgolly.wegameApi.wegameApiInts.`12000`
import typingsJapgolly.wegameApi.wegameApiInts.`16000`
import typingsJapgolly.wegameApi.wegameApiInts.`22050`
import typingsJapgolly.wegameApi.wegameApiInts.`24000`
import typingsJapgolly.wegameApi.wegameApiInts.`32000`
import typingsJapgolly.wegameApi.wegameApiInts.`44100`
import typingsJapgolly.wegameApi.wegameApiInts.`48000`
import typingsJapgolly.wegameApi.wegameApiInts.`8000`
...
trait AudioSource extends StObject {
  ...
  /**
    * 录音通道数
    */
  var numberOfChannels: typingsJapgolly.wegameApi.wegameApiInts.`1` | typingsJapgolly.wegameApi.wegameApiInts.`2`
...
object AudioSource {
  ...
  inline def apply(
    ...
    format: mp3 | aac,
    frameSize: Double,
    numberOfChannels: typingsJapgolly.wegameApi.wegameApiInts.`1` | typingsJapgolly.wegameApi.wegameApiInts.`2`,
  ...
  extension [Self <: AudioSource](x: Self) {
    ...
    inline def setNumberOfChannels(value: typingsJapgolly.wegameApi.wegameApiInts.`1` | typingsJapgolly.wegameApi.wegameApiInts.`2`): Self = StObject.set(x, "numberOfChannels", value.asInstanceOf[js.Any])
