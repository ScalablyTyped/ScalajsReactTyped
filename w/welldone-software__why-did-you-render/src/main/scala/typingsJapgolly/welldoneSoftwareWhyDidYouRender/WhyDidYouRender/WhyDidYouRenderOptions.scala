package typingsJapgolly.welldoneSoftwareWhyDidYouRender.WhyDidYouRender
...
object WhyDidYouRenderOptions {
  ...
  def apply(
    ...
    exclude: js.Array[js.RegExp] = null,
    hotReloadBufferMs: Int | Double = null,
    include: js.Array[js.RegExp] = null,
    logOnDifferentValues: js.UndefOr[Boolean] = js.undefined,
    notifier: /* options */ UpdateInfo => Callback = null,
    ...
    if (notifier != null) __obj.updateDynamic("notifier")(js.Any.fromFunction1((t0: /* options */ typingsJapgolly.welldoneSoftwareWhyDidYouRender.WhyDidYouRender.UpdateInfo) => notifier(t0).runNow()))
