...
import typingsJapgolly.welldoneSoftwareWhyDidYouRender.anon.TypeofReact
...
object mod {
  ...
  trait UpdateInfo extends StObject {
    ...
    var Component: japgolly.scalajs.react.facade.React.Component[js.Object, js.Object]
  ...
  object UpdateInfo {
    ...
    extension [Self <: UpdateInfo](x: Self) {
      ...
      inline def setComponent(value: Component[js.Object, js.Object]): Self = StObject.set(x, "Component", value.asInstanceOf[js.Any])
  ...
  object WhyDidYouRenderOptions {
    ...
    extension [Self <: WhyDidYouRenderOptions](x: Self) {
      ...
      inline def setNotifier(value: /* options */ UpdateInfo => Callback): Self = StObject.set(x, "notifier", js.Any.fromFunction1((t0: /* options */ UpdateInfo) => value(t0).runNow()))
