package typingsJapgolly.welldoneSoftwareWhyDidYouRender
...
import typingsJapgolly.welldoneSoftwareWhyDidYouRender.mod.WhyDidYouRenderComponentMember
import typingsJapgolly.welldoneSoftwareWhyDidYouRender.welldoneSoftwareWhyDidYouRenderStrings.input
...
object anon {
  ...
  trait TypeofReact extends StObject {
    ...
    def createElement[P /* <: HTMLAttributes[T] */, T /* <: HTMLElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 116, starting with typingsJapgolly.welldoneSoftwareWhyDidYouRender.welldoneSoftwareWhyDidYouRenderStrings.a, typingsJapgolly.welldoneSoftwareWhyDidYouRender.welldoneSoftwareWhyDidYouRenderStrings.abbr, typingsJapgolly.welldoneSoftwareWhyDidYouRender.welldoneSoftwareWhyDidYouRenderStrings.address */ Any,
    ...
    def createElement_PT_ReactSVGElement[P /* <: SVGAttributes[T] */, T /* <: SVGElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 55, starting with typingsJapgolly.welldoneSoftwareWhyDidYouRender.welldoneSoftwareWhyDidYouRenderStrings.animate, typingsJapgolly.welldoneSoftwareWhyDidYouRender.welldoneSoftwareWhyDidYouRenderStrings.circle, typingsJapgolly.welldoneSoftwareWhyDidYouRender.welldoneSoftwareWhyDidYouRenderStrings.clipPath */ Any,
      props: ClassAttributes[T] & P,
      children: Node*
