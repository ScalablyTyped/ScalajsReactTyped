...
object srcDrawerDotmulticanvasMod {
  ...
  @js.native
  trait MultiCanvas
    extends typingsJapgolly.wavesurferJs.srcDrawerMod.default {
    
    /** Class used to generate entries. */
    val EntryClass: Instantiable0[typingsJapgolly.wavesurferJs.srcDrawerDotcanvasentryMod.default] = js.native
    
    /** Add a canvas to the canvas list. */
    def addCanvas(): Unit = js.native
    
    /** Set the canvas transforms for a certain entry (wave and progress). */
    def applyCanvasTransforms(entry: typingsJapgolly.wavesurferJs.srcDrawerDotcanvasentryMod.default, vertical: Boolean): Unit = js.native
    ...
    val canvases: js.Array[typingsJapgolly.wavesurferJs.srcDrawerDotcanvasentryMod.default] = js.native
    ...
    def setFillStyles(
      entry: typingsJapgolly.wavesurferJs.srcDrawerDotcanvasentryMod.default,
      waveColor: String,
