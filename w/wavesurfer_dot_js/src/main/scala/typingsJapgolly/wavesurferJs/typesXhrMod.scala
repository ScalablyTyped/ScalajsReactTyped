...
import typingsJapgolly.wavesurferJs.wavesurferJsStrings.arraybuffer
import typingsJapgolly.wavesurferJs.wavesurferJsStrings.blob
import typingsJapgolly.wavesurferJs.wavesurferJsStrings.json
import typingsJapgolly.wavesurferJs.wavesurferJsStrings.text
