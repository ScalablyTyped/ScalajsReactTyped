...
import org.scalajs.dom.OfflineAudioContext
import typingsJapgolly.wavesurferJs.srcUtilObserverMod.default
...
object typesBackendMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.wavesurferJs.srcWebaudioMod.default
    - typingsJapgolly.wavesurferJs.srcMediaelementMod.default
    - typingsJapgolly.wavesurferJs.srcMediaelementWebaudioMod.default
  */
