...
import typingsJapgolly.wavesurferJs.typesUtilMod.Styles
import typingsJapgolly.wavesurferJs.wavesurferJsStrings.drag
import typingsJapgolly.wavesurferJs.wavesurferJsStrings.left
import typingsJapgolly.wavesurferJs.wavesurferJsStrings.resize
import typingsJapgolly.wavesurferJs.wavesurferJsStrings.right
...
object srcPluginRegionsMod {
  ...
  open class default protected () extends RegionsPlugin {
    def this(params: RegionsPluginParams, ws: typingsJapgolly.wavesurferJs.srcWavesurferMod.default) = this()
  }
  /* static members */
  object default {
  ...
  open class Region protected ()
    ...
    def this(
      ...
      ws: typingsJapgolly.wavesurferJs.srcWavesurferMod.default
    ) = this()
    ...
    def onResize(
      delta: Double,
      direction: typingsJapgolly.wavesurferJs.wavesurferJsStrings.start | typingsJapgolly.wavesurferJs.wavesurferJsStrings.end
    ): Unit = js.native
  ...
  object RegionsPluginParams {
    ...
    extension [Self <: RegionsPluginParams](x: Self) {
      ...
      inline def setFormatTimeCallback(value: CallbackTo[String]): Self = StObject.set(x, "formatTimeCallback", value.toJsFn)
  ...
  object WavesurferAugmentingMod {
    ...
    object WaveSurfer {
      ...
      inline def apply(
        addRegion: RegionParams => Callback,
        clearRegions: Callback,
        enableDragSelection: RegionParams => Callback
      ): WaveSurfer = {
        val __obj = js.Dynamic.literal(addRegion = js.Any.fromFunction1((t0: RegionParams) => addRegion(t0).runNow()), clearRegions = clearRegions.toJsFn, enableDragSelection = js.Any.fromFunction1((t0: RegionParams) => enableDragSelection(t0).runNow()))
        __obj.asInstanceOf[WaveSurfer]
      }
      
      extension [Self <: WaveSurfer](x: Self) {
        
        inline def setAddRegion(value: RegionParams => Callback): Self = StObject.set(x, "addRegion", js.Any.fromFunction1((t0: RegionParams) => value(t0).runNow()))
        
        inline def setClearRegions(value: Callback): Self = StObject.set(x, "clearRegions", value.toJsFn)
        
        inline def setEnableDragSelection(value: RegionParams => Callback): Self = StObject.set(x, "enableDragSelection", js.Any.fromFunction1((t0: RegionParams) => value(t0).runNow()))
      }
    }
  }
}
