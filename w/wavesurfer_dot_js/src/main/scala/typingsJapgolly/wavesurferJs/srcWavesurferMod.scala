...
import typingsJapgolly.wavesurferJs.typesBackendMod.Peaks
...
import typingsJapgolly.wavesurferJs.typesUtilMod.WaveSurferUtil
import typingsJapgolly.wavesurferJs.wavesurferJsStrings.blob
import typingsJapgolly.wavesurferJs.wavesurferJsStrings.dataURL
...
object srcWavesurferMod {
  ...
  trait WaveSurfer
    ...
    var cursor: typingsJapgolly.wavesurferJs.srcPluginCursorMod.default = js.native
    ...
    var elan: typingsJapgolly.wavesurferJs.srcPluginElanMod.default = js.native
    ...
    var markers: typingsJapgolly.wavesurferJs.srcPluginMarkersMod.default = js.native
    
    /** Only available in WaveSurfer instances with MediaSessionPlugin. */
    var mediasession: typingsJapgolly.wavesurferJs.srcPluginMediasessionMod.default = js.native
    
    /** Only available in WaveSurfer instances with MicrophonePlugin. */
    var microphone: typingsJapgolly.wavesurferJs.srcPluginMicrophoneMod.default = js.native
    
    /** Only available in WaveSurfer instances with MinimapPlugin. */
    var minimap: typingsJapgolly.wavesurferJs.srcPluginMinimapMod.default = js.native
    ...
    var playhead: typingsJapgolly.wavesurferJs.srcPluginPlayheadMod.default = js.native
    
    /** Only available in WaveSurfer instances with RegionsPlugin. */
    var regions: typingsJapgolly.wavesurferJs.srcPluginRegionsMod.default = js.native
    ...
    var spectrogram: typingsJapgolly.wavesurferJs.srcPluginSpectrogramMod.default = js.native
    
    def stop(): Unit = js.native
    
    /** Only available in WaveSurfer instances with TimelinePlugin. */
    var timeline: typingsJapgolly.wavesurferJs.srcPluginTimelineMod.default = js.native
