...
import typingsJapgolly.winrt.Windows.Graphics.Printing.IPrintTaskOptionsCore
import typingsJapgolly.winrt.Windows.Graphics.Printing.IPrintTaskOptionsCoreUIConfiguration
