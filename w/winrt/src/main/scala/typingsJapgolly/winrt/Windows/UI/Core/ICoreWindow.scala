...
object ICoreWindow {
  ...
  extension [Self <: ICoreWindow](x: Self) {
    ...
    inline def setReleasePointerCapture(value: Callback): Self = StObject.set(x, "releasePointerCapture", value.toJsFn)
    
    inline def setSetPointerCapture(value: Callback): Self = StObject.set(x, "setPointerCapture", value.toJsFn)
