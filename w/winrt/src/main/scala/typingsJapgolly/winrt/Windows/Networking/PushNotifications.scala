...
object PushNotifications {
  ...
  object IPushNotificationChannel {
    ...
    inline def apply(close: Callback, expirationTime: js.Date, onpushnotificationreceived: Any, uri: String): IPushNotificationChannel = {
      val __obj = js.Dynamic.literal(close = close.toJsFn, expirationTime = expirationTime.asInstanceOf[js.Any], onpushnotificationreceived = onpushnotificationreceived.asInstanceOf[js.Any], uri = uri.asInstanceOf[js.Any])
  ...
  object PushNotificationChannel {
    ...
    inline def apply(close: Callback, expirationTime: js.Date, onpushnotificationreceived: Any, uri: String): PushNotificationChannel = {
      val __obj = js.Dynamic.literal(close = close.toJsFn, expirationTime = expirationTime.asInstanceOf[js.Any], onpushnotificationreceived = onpushnotificationreceived.asInstanceOf[js.Any], uri = uri.asInstanceOf[js.Any])
