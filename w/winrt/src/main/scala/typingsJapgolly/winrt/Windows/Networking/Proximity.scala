...
object Proximity {
  ...
  object IProximityDeviceStatics {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(fromId = js.Any.fromFunction1(fromId), getDefault = getDefault.toJsFn, getDeviceSelector = getDeviceSelector.toJsFn)
    ...
    extension [Self <: IProximityDeviceStatics](x: Self) {
      ...
      inline def setGetDefault(value: CallbackTo[ProximityDevice]): Self = StObject.set(x, "getDefault", value.toJsFn)
