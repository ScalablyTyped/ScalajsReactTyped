...
import typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DayFormat
import typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DayOfWeekFormat
import typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.HourFormat
import typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.MinuteFormat
import typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.MonthFormat
import typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.SecondFormat
import typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.YearFormat
...
object Globalization {
  ...
  open class ApplicationLanguages ()
    extends StObject
       with typingsJapgolly.winrt.Windows.Globalization.ApplicationLanguages
  /* static members */
  ...
  open class Calendar ()
    extends StObject
       with typingsJapgolly.winrt.Windows.Globalization.Calendar {
  ...
  open class CalendarIdentifiers ()
    extends StObject
       with typingsJapgolly.winrt.Windows.Globalization.CalendarIdentifiers
  /* static members */
  ...
  open class ClockIdentifiers ()
    extends StObject
       with typingsJapgolly.winrt.Windows.Globalization.ClockIdentifiers
  /* static members */
  ...
  object Collation {
    ...
    open class CharacterGrouping ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Globalization.Collation.CharacterGrouping {
    ...
    open class CharacterGroupings ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Globalization.Collation.CharacterGroupings {
      
      /* CompleteClass */
      override def first(): IIterator[typingsJapgolly.winrt.Windows.Globalization.Collation.CharacterGrouping] = js.native
    }
  }
  ...
  object DateTimeFormatting {
    ...
    open class DateTimeFormatter protected ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DateTimeFormatter {
    ...
    object DateTimeFormatter {
      ...
      @js.native
      def longDate: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DateTimeFormatter = js.native
      inline def longDate_=(x: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DateTimeFormatter): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("longDate")(x.asInstanceOf[js.Any])
      
      @JSGlobal("Windows.Globalization.DateTimeFormatting.DateTimeFormatter.longTime")
      @js.native
      def longTime: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DateTimeFormatter = js.native
      inline def longTime_=(x: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DateTimeFormatter): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("longTime")(x.asInstanceOf[js.Any])
      
      @JSGlobal("Windows.Globalization.DateTimeFormatting.DateTimeFormatter.shortDate")
      @js.native
      def shortDate: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DateTimeFormatter = js.native
      inline def shortDate_=(x: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DateTimeFormatter): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("shortDate")(x.asInstanceOf[js.Any])
      
      @JSGlobal("Windows.Globalization.DateTimeFormatting.DateTimeFormatter.shortTime")
      @js.native
      def shortTime: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DateTimeFormatter = js.native
      inline def shortTime_=(x: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DateTimeFormatter): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("shortTime")(x.asInstanceOf[js.Any])
    }
    ...
    object DayFormat extends StObject {
      ...
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DayFormat & Double
          ] = js.native
      
      /* 1 */ val default: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DayFormat.default & Double = js.native
      
      /* 0 */ val none: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DayFormat.none & Double = js.native
    }
    ...
    object DayOfWeekFormat extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DayOfWeekFormat & Double
          ] = js.native
      
      /* 1 */ val default: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DayOfWeekFormat.default & Double = js.native
      
      /* 2 */ val abbreviated: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DayOfWeekFormat.abbreviated & Double = js.native
      
      /* 3 */ val full: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DayOfWeekFormat.full & Double = js.native
      
      /* 0 */ val none: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.DayOfWeekFormat.none & Double = js.native
    }
    ...
    object HourFormat extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.HourFormat & Double
          ] = js.native
      
      /* 1 */ val default: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.HourFormat.default & Double = js.native
      
      /* 0 */ val none: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.HourFormat.none & Double = js.native
    }
    ...
    object MinuteFormat extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.MinuteFormat & Double
          ] = js.native
      
      /* 1 */ val default: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.MinuteFormat.default & Double = js.native
      
      /* 0 */ val none: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.MinuteFormat.none & Double = js.native
    }
    ...
    object MonthFormat extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.MonthFormat & Double
          ] = js.native
      
      /* 1 */ val default: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.MonthFormat.default & Double = js.native
      
      /* 2 */ val abbreviated: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.MonthFormat.abbreviated & Double = js.native
      
      /* 3 */ val full: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.MonthFormat.full & Double = js.native
      
      /* 0 */ val none: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.MonthFormat.none & Double = js.native
      
      /* 4 */ val numeric: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.MonthFormat.numeric & Double = js.native
    }
    ...
    object SecondFormat extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.SecondFormat & Double
          ] = js.native
      
      /* 1 */ val default: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.SecondFormat.default & Double = js.native
      
      /* 0 */ val none: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.SecondFormat.none & Double = js.native
    }
    ...
    object YearFormat extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.YearFormat & Double
          ] = js.native
      
      /* 1 */ val default: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.YearFormat.default & Double = js.native
      
      /* 2 */ val abbreviated: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.YearFormat.abbreviated & Double = js.native
      
      /* 3 */ val full: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.YearFormat.full & Double = js.native
      
      /* 0 */ val none: typingsJapgolly.winrt.Windows.Globalization.DateTimeFormatting.YearFormat.none & Double = js.native
    }
  }
  ...
  object DayOfWeek extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrt.Windows.Globalization.DayOfWeek & Double] = js.native
    
    /* 5 */ val friday: typingsJapgolly.winrt.Windows.Globalization.DayOfWeek.friday & Double = js.native
    
    /* 1 */ val monday: typingsJapgolly.winrt.Windows.Globalization.DayOfWeek.monday & Double = js.native
    
    /* 6 */ val saturday: typingsJapgolly.winrt.Windows.Globalization.DayOfWeek.saturday & Double = js.native
    
    /* 0 */ val sunday: typingsJapgolly.winrt.Windows.Globalization.DayOfWeek.sunday & Double = js.native
    
    /* 4 */ val thursday: typingsJapgolly.winrt.Windows.Globalization.DayOfWeek.thursday & Double = js.native
    
    /* 2 */ val tuesday: typingsJapgolly.winrt.Windows.Globalization.DayOfWeek.tuesday & Double = js.native
    
    /* 3 */ val wednesday: typingsJapgolly.winrt.Windows.Globalization.DayOfWeek.wednesday & Double = js.native
  }
  ...
  object Fonts {
    ...
    open class LanguageFont ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Globalization.Fonts.LanguageFont {
    ...
    open class LanguageFontGroup protected ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Globalization.Fonts.LanguageFontGroup {
      def this(languageTag: String) = this()
      
      /* CompleteClass */
      var documentAlternate1Font: typingsJapgolly.winrt.Windows.Globalization.Fonts.LanguageFont = js.native
      
      /* CompleteClass */
      var documentAlternate2Font: typingsJapgolly.winrt.Windows.Globalization.Fonts.LanguageFont = js.native
      
      /* CompleteClass */
      var documentHeadingFont: typingsJapgolly.winrt.Windows.Globalization.Fonts.LanguageFont = js.native
      
      /* CompleteClass */
      var fixedWidthTextFont: typingsJapgolly.winrt.Windows.Globalization.Fonts.LanguageFont = js.native
      
      /* CompleteClass */
      var modernDocumentFont: typingsJapgolly.winrt.Windows.Globalization.Fonts.LanguageFont = js.native
      
      /* CompleteClass */
      var traditionalDocumentFont: typingsJapgolly.winrt.Windows.Globalization.Fonts.LanguageFont = js.native
      
      /* CompleteClass */
      var uICaptionFont: typingsJapgolly.winrt.Windows.Globalization.Fonts.LanguageFont = js.native
      
      /* CompleteClass */
      var uIHeadingFont: typingsJapgolly.winrt.Windows.Globalization.Fonts.LanguageFont = js.native
      
      /* CompleteClass */
      var uINotificationHeadingFont: typingsJapgolly.winrt.Windows.Globalization.Fonts.LanguageFont = js.native
      
      /* CompleteClass */
      var uITextFont: typingsJapgolly.winrt.Windows.Globalization.Fonts.LanguageFont = js.native
      
      /* CompleteClass */
      var uITitleFont: typingsJapgolly.winrt.Windows.Globalization.Fonts.LanguageFont = js.native
    }
  }
  ...
  open class GeographicRegion ()
    extends StObject
       with typingsJapgolly.winrt.Windows.Globalization.GeographicRegion {
  ...
  open class Language protected ()
    extends StObject
       with typingsJapgolly.winrt.Windows.Globalization.Language {
    def this(languageTag: String) = this()
  ...
  object NumberFormatting {
    ...
    open class CurrencyFormatter protected ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Globalization.NumberFormatting.CurrencyFormatter {
    ...
    open class DecimalFormatter ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Globalization.NumberFormatting.DecimalFormatter {
    ...
    open class PercentFormatter ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Globalization.NumberFormatting.PercentFormatter {
      def this(languages: IIterable[String], geographicRegion: String) = this()
    ...
    open class PermilleFormatter ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Globalization.NumberFormatting.PermilleFormatter {
      def this(languages: IIterable[String], geographicRegion: String) = this()
