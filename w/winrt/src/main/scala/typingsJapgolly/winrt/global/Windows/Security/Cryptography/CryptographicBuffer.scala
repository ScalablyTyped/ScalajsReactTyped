...
open class CryptographicBuffer ()
  extends StObject
     with typingsJapgolly.winrt.Windows.Security.Cryptography.CryptographicBuffer
/* static members */
object CryptographicBuffer {
  ...
  inline def convertBinaryToString(
    encoding: typingsJapgolly.winrt.Windows.Security.Cryptography.BinaryStringEncoding,
    buffer: IBuffer
  ): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convertBinaryToString")(encoding.asInstanceOf[js.Any], buffer.asInstanceOf[js.Any])).asInstanceOf[String]
  
  inline def convertStringToBinary(value: String, encoding: typingsJapgolly.winrt.Windows.Security.Cryptography.BinaryStringEncoding): IBuffer = (^.asInstanceOf[js.Dynamic].applyDynamic("convertStringToBinary")(value.asInstanceOf[js.Any], encoding.asInstanceOf[js.Any])).asInstanceOf[IBuffer]
