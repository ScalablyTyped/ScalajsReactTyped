...
object Store {
  ...
  open class CurrentApp ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.Store.CurrentApp
  /* static members */
  object CurrentApp {
    ...
    @js.native
    def licenseInformation: typingsJapgolly.winrt.Windows.ApplicationModel.Store.LicenseInformation = js.native
    inline def licenseInformation_=(x: typingsJapgolly.winrt.Windows.ApplicationModel.Store.LicenseInformation): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("licenseInformation")(x.asInstanceOf[js.Any])
    ...
    inline def loadListingInformationAsync(): IAsyncOperation[typingsJapgolly.winrt.Windows.ApplicationModel.Store.ListingInformation] = ^.asInstanceOf[js.Dynamic].applyDynamic("loadListingInformationAsync")().asInstanceOf[IAsyncOperation[typingsJapgolly.winrt.Windows.ApplicationModel.Store.ListingInformation]]
  ...
  open class CurrentAppSimulator ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.Store.CurrentAppSimulator
  /* static members */
  ...
  open class LicenseInformation ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.Store.LicenseInformation {
    ...
    /* CompleteClass */
    var productLicenses: IMapView[String, typingsJapgolly.winrt.Windows.ApplicationModel.Store.ProductLicense] = js.native
  }
  ...
  open class ListingInformation ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.Store.ListingInformation {
    ...
    /* CompleteClass */
    var productListings: IMapView[String, typingsJapgolly.winrt.Windows.ApplicationModel.Store.ProductListing] = js.native
  }
  ...
  open class ProductLicense ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.Store.ProductLicense {
  ...
  open class ProductListing ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.Store.ProductListing {
