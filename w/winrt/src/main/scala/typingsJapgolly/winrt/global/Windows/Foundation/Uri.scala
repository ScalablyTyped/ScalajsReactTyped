...
open class Uri protected ()
  extends StObject
     with typingsJapgolly.winrt.Windows.Foundation.Uri {
  ...
  /* CompleteClass */
  override def combineUri(relativeUri: String): typingsJapgolly.winrt.Windows.Foundation.Uri = js.native
  ...
  /* CompleteClass */
  override def equals(pUri: typingsJapgolly.winrt.Windows.Foundation.Uri): Boolean = js.native
  ...
  /* CompleteClass */
  var queryParsed: typingsJapgolly.winrt.Windows.Foundation.WwwFormUrlDecoder = js.native
