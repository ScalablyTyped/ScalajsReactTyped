...
object Printers {
  ...
  object Extensions {
    ...
    open class PrintExtensionContext ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Devices.Printers.Extensions.PrintExtensionContext
    /* static members */
    ...
    open class PrintNotificationEventDetails ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Devices.Printers.Extensions.PrintNotificationEventDetails {
    ...
    open class PrintTaskConfiguration ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Devices.Printers.Extensions.PrintTaskConfiguration {
    ...
    open class PrintTaskConfigurationSaveRequest ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequest {
      ...
      /* CompleteClass */
      override def getDeferral(): typingsJapgolly.winrt.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequestedDeferral = js.native
    ...
    open class PrintTaskConfigurationSaveRequestedDeferral ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequestedDeferral {
    ...
    open class PrintTaskConfigurationSaveRequestedEventArgs ()
      extends StObject
         with typingsJapgolly.winrt.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequestedEventArgs {
      
      /* CompleteClass */
      var request: typingsJapgolly.winrt.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequest = js.native
    }
  }
}
