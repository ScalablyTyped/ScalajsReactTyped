...
import typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackageOperation
...
object DataTransfer {
  ...
  open class Clipboard ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.Clipboard
  /* static members */
  object Clipboard {
    ...
    inline def getContent(): typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackageView = ^.asInstanceOf[js.Dynamic].applyDynamic("getContent")().asInstanceOf[typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackageView]
    ...
    inline def setContent(content: typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackage): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setContent")(content.asInstanceOf[js.Any]).asInstanceOf[Unit]
  }
  ...
  open class DataPackage ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackage
  ...
  object DataPackageOperation extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackageOperation & Double
      ] = js.native
    
    /* 1 */ val copy: typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackageOperation.copy & Double = js.native
    
    /* 3 */ val link: typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackageOperation.link & Double = js.native
    
    /* 2 */ val move: typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackageOperation.move & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackageOperation.none & Double = js.native
  }
  ...
  open class DataPackagePropertySet ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackagePropertySet {
  ...
  open class DataPackagePropertySetView ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackagePropertySetView {
  ...
  open class DataPackageView ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackageView
  
  @JSGlobal("Windows.ApplicationModel.DataTransfer.DataProviderDeferral")
  @js.native
  open class DataProviderDeferral ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataProviderDeferral {
  ...
  open class DataProviderRequest ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataProviderRequest {
    ...
    /* CompleteClass */
    override def getDeferral(): typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataProviderDeferral = js.native
  ...
  open class DataRequest ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataRequest {
    
    /* CompleteClass */
    var data: typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataPackage = js.native
    ...
    /* CompleteClass */
    override def getDeferral(): typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataRequestDeferral = js.native
  }
  ...
  open class DataRequestDeferral ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataRequestDeferral {
  ...
  open class DataRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataRequestedEventArgs {
    
    /* CompleteClass */
    var request: typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataRequest = js.native
  }
  ...
  open class DataTransferManager ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataTransferManager {
  ...
  object DataTransferManager {
    ...
    inline def getForCurrentView(): typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataTransferManager = ^.asInstanceOf[js.Dynamic].applyDynamic("getForCurrentView")().asInstanceOf[typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.DataTransferManager]
  ...
  open class HtmlFormatHelper ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.HtmlFormatHelper
  /* static members */
  ...
  open class OperationCompletedEventArgs ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.OperationCompletedEventArgs {
  ...
  object ShareTarget {
    ...
    open class QuickLink ()
      extends StObject
         with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.ShareTarget.QuickLink {
    ...
    open class ShareOperation ()
      extends StObject
         with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.ShareTarget.ShareOperation
  }
  ...
  open class StandardDataFormats ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.StandardDataFormats
  /* static members */
  ...
  open class TargetApplicationChosenEventArgs ()
    extends StObject
       with typingsJapgolly.winrt.Windows.ApplicationModel.DataTransfer.TargetApplicationChosenEventArgs {
