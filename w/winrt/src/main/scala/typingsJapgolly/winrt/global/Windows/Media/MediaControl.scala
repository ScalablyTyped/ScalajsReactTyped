...
open class MediaControl ()
  extends StObject
     with typingsJapgolly.winrt.Windows.Media.MediaControl
/* static members */
object MediaControl {
  ...
  @js.native
  def soundLevel: typingsJapgolly.winrt.Windows.Media.SoundLevel = js.native
  inline def soundLevel_=(x: typingsJapgolly.winrt.Windows.Media.SoundLevel): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("soundLevel")(x.asInstanceOf[js.Any])
