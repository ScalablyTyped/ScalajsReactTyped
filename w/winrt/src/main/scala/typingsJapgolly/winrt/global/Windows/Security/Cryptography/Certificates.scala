...
import typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.EnrollKeyUsages
import typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.ExportOption
import typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.InstallOptions
import typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.KeyProtectionLevel
...
object Certificates {
  ...
  open class CertificateEnrollmentManager ()
    extends StObject
       with typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.CertificateEnrollmentManager
  /* static members */
  object CertificateEnrollmentManager {
    ...
    inline def createRequestAsync(
      request: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.CertificateRequestProperties
    ): IAsyncOperation[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("createRequestAsync")(request.asInstanceOf[js.Any]).asInstanceOf[IAsyncOperation[String]]
  ...
  open class CertificateRequestProperties ()
    extends StObject
       with typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.CertificateRequestProperties {
  ...
  object EnrollKeyUsages extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.EnrollKeyUsages & Double
      ] = js.native
    
    /* 4 */ val all: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.EnrollKeyUsages.all & Double = js.native
    
    /* 1 */ val decryption: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.EnrollKeyUsages.decryption & Double = js.native
    
    /* 3 */ val keyAgreement: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.EnrollKeyUsages.keyAgreement & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.EnrollKeyUsages.none & Double = js.native
    
    /* 2 */ val signing: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.EnrollKeyUsages.signing & Double = js.native
  }
  ...
  object ExportOption extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.ExportOption & Double
      ] = js.native
    
    /* 1 */ val exportable: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.ExportOption.exportable & Double = js.native
    
    /* 0 */ val notExportable: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.ExportOption.notExportable & Double = js.native
  }
  ...
  object InstallOptions extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.InstallOptions & Double
      ] = js.native
    
    /* 1 */ val deleteExpired: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.InstallOptions.deleteExpired & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.InstallOptions.none & Double = js.native
  }
  ...
  open class KeyAlgorithmNames ()
    extends StObject
       with typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.KeyAlgorithmNames
  /* static members */
  ...
  object KeyProtectionLevel extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.KeyProtectionLevel & Double
      ] = js.native
    
    /* 1 */ val consentOnly: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.KeyProtectionLevel.consentOnly & Double = js.native
    
    /* 2 */ val consentWithPassword: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.KeyProtectionLevel.consentWithPassword & Double = js.native
    
    /* 0 */ val noConsent: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.KeyProtectionLevel.noConsent & Double = js.native
  }
  ...
  object KeySize extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.KeySize & Double
      ] = js.native
    
    /* 0 */ val invalid: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.KeySize.invalid & Double = js.native
    
    /* 1 */ val rsa2048: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.KeySize.rsa2048 & Double = js.native
    
    /* 2 */ val rsa4096: typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.KeySize.rsa4096 & Double = js.native
  }
  ...
  open class KeyStorageProviderNames ()
    extends StObject
       with typingsJapgolly.winrt.Windows.Security.Cryptography.Certificates.KeyStorageProviderNames
  /* static members */
