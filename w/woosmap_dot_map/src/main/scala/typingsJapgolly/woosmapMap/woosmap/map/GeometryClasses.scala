...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.woosmapMap.woosmap.map.GeometryCollectionElement
  - typingsJapgolly.woosmapMap.woosmap.map.Data_.GeometryCollection
*/
trait GeometryClasses extends StObject
object GeometryClasses {
  
  inline def GeometryCollection(
    ...
    __obj.asInstanceOf[typingsJapgolly.woosmapMap.woosmap.map.Data_.GeometryCollection]
  }
