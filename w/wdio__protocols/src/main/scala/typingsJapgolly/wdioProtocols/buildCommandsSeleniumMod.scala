...
object buildCommandsSeleniumMod {
  ...
  object SeleniumCommands {
    ...
    extension [Self <: SeleniumCommands](x: Self) {
      ...
      inline def setGetHubConfig(value: CallbackTo[ProtocolCommandResponse]): Self = StObject.set(x, "getHubConfig", value.toJsFn)
      ...
      inline def setManageSeleniumHubLifecycle(value: String => Callback): Self = StObject.set(x, "manageSeleniumHubLifecycle", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
