...
import typingsJapgolly.wdioProtocols.buildTypesMod.Protocol
...
import typingsJapgolly.wdioProtocols.wdioProtocolsStrings.tab
import typingsJapgolly.wdioProtocols.wdioProtocolsStrings.window
