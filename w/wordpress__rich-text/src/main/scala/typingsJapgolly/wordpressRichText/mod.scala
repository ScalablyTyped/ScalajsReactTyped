...
import typingsJapgolly.wordpressRichText.anon.Element
import typingsJapgolly.wordpressRichText.anon.Html
import typingsJapgolly.wordpressRichText.anon.MultilineTag
import typingsJapgolly.wordpressRichText.anon.Text
import typingsJapgolly.wordpressRichText.anon.TypeofimportedActions
import typingsJapgolly.wordpressRichText.anon.TypeofimportedSelectors
...
object mod {
  ...
  trait FormatConfiguration extends StObject {
    ...
    var tagName: (/* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressRichText.wordpressRichTextStrings.a, typingsJapgolly.wordpressRichText.wordpressRichTextStrings.abbr, typingsJapgolly.wordpressRichText.wordpressRichTextStrings.address */ Any) & String
  ...
  object FormatConfiguration {
    ...
    inline def apply(
      ...
      tagName: (/* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressRichText.wordpressRichTextStrings.a, typingsJapgolly.wordpressRichText.wordpressRichTextStrings.abbr, typingsJapgolly.wordpressRichText.wordpressRichTextStrings.address */ Any) & String,
      title: String
    ): FormatConfiguration = {
    ...
    extension [Self <: FormatConfiguration](x: Self) {
      ...
      inline def setTagName(
        value: (/* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressRichText.wordpressRichTextStrings.a, typingsJapgolly.wordpressRichText.wordpressRichTextStrings.abbr, typingsJapgolly.wordpressRichText.wordpressRichTextStrings.address */ Any) & String
  ...
  object FormatProps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(activeAttributes = activeAttributes.asInstanceOf[js.Any], isActive = isActive.asInstanceOf[js.Any], onChange = js.Any.fromFunction1((t0: Value) => onChange(t0).runNow()), value = value.asInstanceOf[js.Any])
