...
object wordpressRichTextStrings {
  ...
  @js.native
  sealed trait `coreSlashrich-text` extends StObject
  inline def `coreSlashrich-text`: `coreSlashrich-text` = "core/rich-text".asInstanceOf[`coreSlashrich-text`]
