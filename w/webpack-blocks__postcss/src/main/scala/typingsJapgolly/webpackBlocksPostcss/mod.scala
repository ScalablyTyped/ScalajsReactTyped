...
object mod {
  ...
  object Plugin {
    ...
    extension [Self <: Plugin](x: Self) {
      ...
      inline def setParserCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "parser", value.toJsFn)
      
      inline def setParserUndefined: Self = StObject.set(x, "parser", js.undefined)
      
      inline def setStringifier(value: String | FunctionType): Self = StObject.set(x, "stringifier", value.asInstanceOf[js.Any])
      
      inline def setStringifierCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "stringifier", value.toJsFn)
      
      inline def setStringifierUndefined: Self = StObject.set(x, "stringifier", js.undefined)
      
      inline def setSyntax(value: String | FunctionType): Self = StObject.set(x, "syntax", value.asInstanceOf[js.Any])
      
      inline def setSyntaxCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "syntax", value.toJsFn)
