...
object srcUnidriverLegacyStylableTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.wixUiTestUtils.srcUnidriverLegacyStylableTypesMod.LegacyStylesheet
    - typingsJapgolly.wixUiTestUtils.srcUnidriverLegacyStylableTypesMod.CompatStylesheet
    - typingsJapgolly.wixUiTestUtils.srcUnidriverLegacyStylableTypesMod.StylesheetV2
  */
