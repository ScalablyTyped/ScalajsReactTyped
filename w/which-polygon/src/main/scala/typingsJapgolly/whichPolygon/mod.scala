package typingsJapgolly.whichPolygon
...
import typingsJapgolly.whichPolygon.whichPolygonBooleans.`false`
import typingsJapgolly.whichPolygon.whichPolygonBooleans.`true`
