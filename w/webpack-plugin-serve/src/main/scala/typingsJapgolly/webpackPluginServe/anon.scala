...
import typingsJapgolly.webpackPluginServe.webpackPluginServeStrings.ws
import typingsJapgolly.webpackPluginServe.webpackPluginServeStrings.wss
...
object anon {
  ...
  object Apply {
    ...
    inline def apply[Compiler](apply: Compiler => Callback): Apply[Compiler] = {
