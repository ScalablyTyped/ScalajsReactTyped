...
import typingsJapgolly.webpackPluginServe.anon.Address
import typingsJapgolly.webpackPluginServe.anon.App
import typingsJapgolly.webpackPluginServe.anon.Apply
import typingsJapgolly.webpackPluginServe.anon.Level
import typingsJapgolly.webpackPluginServe.webpackPluginServeStrings.`refresh-on-failure`
...
object mod {
  ...
  trait Builtins extends StObject {
    ...
    def proxy(args: typingsJapgolly.httpProxyMiddleware.distTypesMod.Options): RequestHandler = js.native
  ...
  object WebpackPluginServeOptions {
    ...
    extension [Self <: WebpackPluginServeOptions](x: Self) {
      ...
      inline def setMiddleware(value: (/* app */ ^[DefaultState, DefaultContext], /* builtins */ Builtins) => Callback): Self = StObject.set(x, "middleware", js.Any.fromFunction2((t0: /* app */ ^[DefaultState, DefaultContext], t1: /* builtins */ Builtins) => (value(t0, t1)).runNow()))
