...
version := "1.4-dt-20211223Z-4519d6"
scalaVersion := "3.1.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "koa-compress" % "v4.x-dt-20220818Z-b0ab51",
  "org.scalablytyped.japgolly" %%% "koa-send" % "4.1-dt-20211202Z-e43a34",
  "org.scalablytyped.japgolly" %%% "koa-static" % "4.0-dt-20211202Z-1b0cbb",
