...
import typingsJapgolly.wixUiCore.anon.Config
import typingsJapgolly.wixUiCore.distEsSrcComponentsVideoTypesMod.ICommonProps
...
object distEsSrcComponentsVideoVideoMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/video/Video", "Video")
  @js.native
  open class Video protected () extends Component[IVideoProps, IVideoState, Any] {
  ...
  object Video {
    ...
    @JSImport("wix-ui-core/dist/es/src/components/video/Video", "Video.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/components/video/Video", "Video.displayName")
    @js.native
