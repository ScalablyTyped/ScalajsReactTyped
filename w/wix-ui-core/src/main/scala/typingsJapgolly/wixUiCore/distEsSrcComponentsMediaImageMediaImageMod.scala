...
object distEsSrcComponentsMediaImageMediaImageMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/media-image/media-image", "MediaImage")
  @js.native
  open class MediaImage protected ()
    ...
    /* private */ var getImageSource: Any = js.native
  }
  /* static members */
  object MediaImage {
    ...
    @JSImport("wix-ui-core/dist/es/src/components/media-image/media-image", "MediaImage.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/components/media-image/media-image", "MediaImage.displayName")
    @js.native
  ...
  @JSImport("wix-ui-core/dist/es/src/components/media-image/media-image", "MediaImageScaling")
  @js.native
  ...
  @JSImport("wix-ui-core/dist/es/src/components/media-image/media-image", "MediaImageUpscaleMethod")
  @js.native
  object MediaImageUpscaleMethod extends StObject {
    ...
    /* "auto" */ val AUTO: typingsJapgolly.wixUiCore.distEsSrcComponentsMediaImageMediaImageMod.MediaImageUpscaleMethod.AUTO & String = js.native
    
    @js.native
    sealed trait CLASSIC
      extends StObject
         with MediaImageUpscaleMethod
    /* "classic" */ val CLASSIC: typingsJapgolly.wixUiCore.distEsSrcComponentsMediaImageMediaImageMod.MediaImageUpscaleMethod.CLASSIC & String = js.native
    
    @js.native
    sealed trait SUPER
      extends StObject
         with MediaImageUpscaleMethod
    /* "super" */ val SUPER: typingsJapgolly.wixUiCore.distEsSrcComponentsMediaImageMediaImageMod.MediaImageUpscaleMethod.SUPER & String = js.native
  }
