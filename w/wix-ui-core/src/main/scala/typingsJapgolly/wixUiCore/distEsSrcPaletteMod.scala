...
object distEsSrcPaletteMod {
  
  object palette {
    
    @JSImport("wix-ui-core/dist/es/src/palette", "palette")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("wix-ui-core/dist/es/src/palette", "palette.black")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/palette", "palette.white")
    @js.native
