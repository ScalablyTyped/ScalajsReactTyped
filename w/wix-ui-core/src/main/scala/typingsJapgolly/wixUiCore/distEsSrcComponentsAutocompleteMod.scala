...
object distEsSrcComponentsAutocompleteMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/autocomplete", "Autocomplete")
  @js.native
  open class Autocomplete protected ()
    extends typingsJapgolly.wixUiCore.distEsSrcComponentsAutocompleteAutocompleteMod.Autocomplete {
  ...
  object Autocomplete {
    ...
    @JSImport("wix-ui-core/dist/es/src/components/autocomplete", "Autocomplete.displayName")
    @js.native
