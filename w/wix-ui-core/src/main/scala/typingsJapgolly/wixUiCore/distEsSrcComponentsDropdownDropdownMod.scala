...
import typingsJapgolly.wixUiCore.anon.IsOpen
...
object distEsSrcComponentsDropdownDropdownMod {
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("wix-ui-core/dist/es/src/components/dropdown/Dropdown", "Dropdown")
  @js.native
  ...
  object Dropdown {
    ...
    @JSImport("wix-ui-core/dist/es/src/components/dropdown/Dropdown", "Dropdown.displayName")
    @js.native
  ...
  @js.native
  open class DropdownComponent protected () extends PureComponent[DropdownProps, DropdownState, Any] {
    def this(props: DropdownProps) = this()
    ...
    /* private */ var dropdownContentRef: Any = js.native
    ...
    def isClosingKey(key: Any): Boolean = js.native
    
    def onKeyDown(evt: ReactKeyboardEventFrom[HTMLElement]): Unit = js.native
    ...
    def onPopoverClick(e: Any): Unit = js.native
  ...
  object DropdownComponent {
    ...
    @JSImport("wix-ui-core/dist/es/src/components/dropdown/Dropdown", "DropdownComponent.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  }
  
  /* Inlined std.Pick<wix-ui-core.wix-ui-core/dist/es/src/components/popover.PopoverProps, 'fixed' | 'flip' | 'moveBy' | 'contentClassName'> & {  data-hook :string | undefined,   placement :wix-ui-core.wix-ui-core/dist/es/src/components/popover.Placement,   showArrow :boolean | undefined,   children :react.react.ReactNode,   options :std.Array<wix-ui-core.wix-ui-core/dist/es/src/components/dropdown-option.Option>,   openTrigger :wix-ui-core.wix-ui-core/dist/es/src/components/dropdown/constants.OPEN_TRIGGER_TYPE,   onOptionHover :(option : wix-ui-core.wix-ui-core/dist/es/src/components/dropdown-option.Option & wix-ui-core.wix-ui-core/dist/es/src/components/dropdown-content.IDOMid | null): void | undefined, onSelect (option : wix-ui-core.wix-ui-core/dist/es/src/components/dropdown-option.Option | null): void,   onContentMouseDown :(e : react.react.MouseEvent<std.Element, react.react.NativeMouseEvent>): void | undefined,   onDeselect :(option : wix-ui-core.wix-ui-core/dist/es/src/components/dropdown-option.Option | null): void | undefined,   onExpandedChange :(isExpanded : boolean): void | undefined,   initialSelectedIds :std.Array<string | number>,   onInitialSelectedOptionsSet :(options : std.Array<wix-ui-core.wix-ui-core/dist/es/src/components/dropdown-option.Option>): void | undefined,   multi :boolean | undefined,   fixedHeader :react.react.ReactNode | undefined,   fixedFooter :react.react.ReactNode | undefined,   disabled :boolean | undefined,   timeout :number | undefined,   forceContentElementVisibility :boolean | undefined,   style :object | undefined,   role :string | undefined,   id :string | undefined,   contentId :string | undefined,   allowReselect :boolean | undefined,   optionsContainerZIndex :number | undefined,   dynamicWidth :boolean | undefined,   appendTo :wix-ui-core.wix-ui-core/dist/es/src/components/popover.AppendTo | undefined,   className :string | undefined,   dropdownA11yFixes :boolean | undefined} */
  @js.native
  trait DropdownProps extends StObject {
    ...
    var dropdownA11yFixes: js.UndefOr[Boolean] = js.native
    ...
    var onContentMouseDown: js.UndefOr[js.Function1[/* e */ ReactMouseEventFrom[Element], Unit]] = js.native
