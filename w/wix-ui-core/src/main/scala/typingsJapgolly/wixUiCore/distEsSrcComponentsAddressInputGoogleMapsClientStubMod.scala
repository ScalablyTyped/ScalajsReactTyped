...
import typingsJapgolly.wixUiCore.anon.Reject
...
import typingsJapgolly.wixUiCore.distEsSrcClientsGoogleMapsTypesMod.PlaceDetails
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distEsSrcComponentsAddressInputGoogleMapsClientStubMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/address-input/GoogleMapsClientStub", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("wix-ui-core/dist/es/src/components/address-input/GoogleMapsClientStub", "GoogleMapsClientStub")
  @js.native
  open class GoogleMapsClientStub ()
    extends StObject
  ...
  object GoogleMapsClientStub {
    ...
    @JSImport("wix-ui-core/dist/es/src/components/address-input/GoogleMapsClientStub", "GoogleMapsClientStub.addresses")
    @js.native
    def addresses: js.Array[Address] = js.native
    
    @JSImport("wix-ui-core/dist/es/src/components/address-input/GoogleMapsClientStub", "GoogleMapsClientStub.addressesDelay")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/components/address-input/GoogleMapsClientStub", "GoogleMapsClientStub.addressesPromise")
    @js.native
    def addressesPromise: js.Promise[Any] = js.native
    inline def addressesPromise_=(x: js.Promise[Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("addressesPromise")(x.asInstanceOf[js.Any])
    
    inline def addresses_=(x: js.Array[Address]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("addresses")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/dist/es/src/components/address-input/GoogleMapsClientStub", "GoogleMapsClientStub.geocode")
    @js.native
    def geocode: js.Array[Geocode] = js.native
    
    @JSImport("wix-ui-core/dist/es/src/components/address-input/GoogleMapsClientStub", "GoogleMapsClientStub.geocodeDelay")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/components/address-input/GoogleMapsClientStub", "GoogleMapsClientStub.geocodePromise")
    @js.native
    def geocodePromise: js.Promise[Any] = js.native
    inline def geocodePromise_=(x: js.Promise[Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("geocodePromise")(x.asInstanceOf[js.Any])
    
    inline def geocode_=(x: js.Array[Geocode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("geocode")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/dist/es/src/components/address-input/GoogleMapsClientStub", "GoogleMapsClientStub.placeDetails")
    @js.native
    def placeDetails: PlaceDetails = js.native
    
    @JSImport("wix-ui-core/dist/es/src/components/address-input/GoogleMapsClientStub", "GoogleMapsClientStub.placeDetailsDelay")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/components/address-input/GoogleMapsClientStub", "GoogleMapsClientStub.placeDetailsPromise")
    @js.native
    def placeDetailsPromise: js.Promise[Any] = js.native
    inline def placeDetailsPromise_=(x: js.Promise[Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("placeDetailsPromise")(x.asInstanceOf[js.Any])
