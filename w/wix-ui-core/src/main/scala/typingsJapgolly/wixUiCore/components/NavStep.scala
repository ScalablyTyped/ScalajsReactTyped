...
import typingsJapgolly.wixUiCore.distEsSrcComponentsNavStepperNavStepMod.NavStepProps
...
object NavStep {
  ...
  inline def apply(
    ...
    val __props = js.Dynamic.literal(active = active.asInstanceOf[js.Any], children = children.asInstanceOf[js.Any], visited = visited.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[NavStepProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.wixUiCore.distEsSrcComponentsNavStepperNavStepMod.NavStep] {
  ...
  def withProps(p: NavStepProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
