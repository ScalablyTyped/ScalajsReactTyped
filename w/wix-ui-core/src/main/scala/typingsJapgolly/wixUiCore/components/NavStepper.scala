...
object NavStepper {
  ...
  inline def apply(activeStep: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[NavStepperProps]))
  }
  
  object Step {
    
    inline def apply(children: js.UndefOr[Node] & Node): typingsJapgolly.wixUiCore.components.NavStepper.Step.Builder = {
      val __props = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
      new typingsJapgolly.wixUiCore.components.NavStepper.Step.Builder(js.Array(this.component, __props.asInstanceOf[ExternalNavStepProps & js.Object]))
    }
    ...
    def withProps(p: ExternalNavStepProps & js.Object): typingsJapgolly.wixUiCore.components.NavStepper.Step.Builder = new typingsJapgolly.wixUiCore.components.NavStepper.Step.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.wixUiCore.distEsSrcMod.NavStepper] {
    
    inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def `data-hook`(value: String): this.type = set("data-hook", value.asInstanceOf[js.Any])
    
    inline def onStepClick(value: (/* stepIndex */ Double, /* e */ Any) => Callback): this.type = set("onStepClick", js.Any.fromFunction2((t0: /* stepIndex */ Double, t1: /* e */ Any) => (value(t0, t1)).runNow()))
  }
  
  def withProps(p: NavStepperProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
