...
object ButtonNext {
  ...
  @JSImport("wix-ui-core/dist/es/src/components/button-next/button-next", "ButtonNext")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.wixUiCore.distEsSrcComponentsButtonNextButtonNextMod.ButtonNext] {
    ...
    inline def contentRef(value: RefHandle[HTMLSpanElement]): this.type = set("contentRef", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ButtonNext.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
