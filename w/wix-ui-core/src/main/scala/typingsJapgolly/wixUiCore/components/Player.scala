...
object Player {
  ...
  @JSImport("wix-ui-core/dist/es/src/components/video/players/Vimeo", "Player")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Player.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
