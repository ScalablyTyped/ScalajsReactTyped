...
object Facebook {
  ...
  @JSImport("wix-ui-core/dist/es/src", "playerComponents.facebook")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Facebook.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
