...
object Dropdown {
  ...
  inline def apply(
    ...
    placement: Placement
  ): SharedBuilder_DropdownProps_577454351[typingsJapgolly.wixUiCore.distEsSrcMod.Dropdown] = {
    ...
    new SharedBuilder_DropdownProps_577454351[typingsJapgolly.wixUiCore.distEsSrcMod.Dropdown](js.Array(this.component, __props.asInstanceOf[DropdownProps]))
  }
  ...
  def withProps(p: DropdownProps): SharedBuilder_DropdownProps_577454351[typingsJapgolly.wixUiCore.distEsSrcMod.Dropdown] = new SharedBuilder_DropdownProps_577454351[typingsJapgolly.wixUiCore.distEsSrcMod.Dropdown](js.Array(this.component, p.asInstanceOf[js.Any]))
}
