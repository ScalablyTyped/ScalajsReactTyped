...
object Vimeo {
  ...
  @JSImport("wix-ui-core/dist/es/src", "playerComponents.vimeo")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Vimeo.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
