...
object Playable {
  ...
  @JSImport("wix-ui-core/dist/es/src", "playerComponents.playable")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Playable.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
