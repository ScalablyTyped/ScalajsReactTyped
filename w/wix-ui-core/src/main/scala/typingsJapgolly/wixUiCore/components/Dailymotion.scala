...
object Dailymotion {
  ...
  @JSImport("wix-ui-core/dist/es/src", "playerComponents.dailymotion")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Dailymotion.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
