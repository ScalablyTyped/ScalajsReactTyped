...
object Youtube {
  ...
  @JSImport("wix-ui-core/dist/es/src", "playerComponents.youtube")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Youtube.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
