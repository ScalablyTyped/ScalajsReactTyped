...
import typingsJapgolly.wixUiCore.wixUiCoreStrings.done
import typingsJapgolly.wixUiCore.wixUiCoreStrings.email
import typingsJapgolly.wixUiCore.wixUiCoreStrings.enter
import typingsJapgolly.wixUiCore.wixUiCoreStrings.environment
import typingsJapgolly.wixUiCore.wixUiCoreStrings.execute
import typingsJapgolly.wixUiCore.wixUiCoreStrings.go
...
import typingsJapgolly.wixUiCore.wixUiCoreStrings.next
...
import typingsJapgolly.wixUiCore.wixUiCoreStrings.user
...
object Input {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.wixUiCore.distEsSrcMod.Input] {
    ...
    inline def `aria-autocomplete`(value: AriaAutoCompleteType): this.type = set("aria-autocomplete", value.asInstanceOf[js.Any])
    ...
    inline def onClick(value: ReactMouseEventFrom[HTMLInputElement] => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLInputElement]) => value(t0).runNow()))
    ...
    inline def onDragStart(value: ReactDragEventFrom[HTMLInputElement] => Callback): this.type = set("onDragStart", js.Any.fromFunction1((t0: ReactDragEventFrom[HTMLInputElement]) => value(t0).runNow()))
    ...
    inline def onMouseDown(value: ReactMouseEventFrom[HTMLInputElement] => Callback): this.type = set("onMouseDown", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLInputElement]) => value(t0).runNow()))
    ...
    inline def onMouseMove(value: ReactMouseEventFrom[HTMLInputElement] => Callback): this.type = set("onMouseMove", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLInputElement]) => value(t0).runNow()))
    ...
    inline def onMouseUp(value: ReactMouseEventFrom[HTMLInputElement] => Callback): this.type = set("onMouseUp", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLInputElement]) => value(t0).runNow()))
