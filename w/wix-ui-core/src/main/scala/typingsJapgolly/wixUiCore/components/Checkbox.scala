...
object Checkbox {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.wixUiCore.distEsSrcMod.Checkbox] {
    ...
    inline def checkedIcon(value: VdomElement): this.type = set("checkedIcon", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def indeterminateIcon(value: VdomElement): this.type = set("indeterminateIcon", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def onChange(value: OnChangeEvent => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: OnChangeEvent) => value(t0).runNow()))
    ...
    inline def uncheckedIcon(value: VdomElement): this.type = set("uncheckedIcon", value.rawElement.asInstanceOf[js.Any])
