...
object Twitch {
  ...
  @JSImport("wix-ui-core/dist/es/src", "playerComponents.twitch")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Twitch.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
