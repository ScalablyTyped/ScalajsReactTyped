...
import typingsJapgolly.wixUiCore.distEsSrcComponentsTooltipNextTooltipNextMod.Point
import typingsJapgolly.wixUiCore.distEsSrcComponentsTooltipNextTooltipNextMod.TooltipProps
...
object TooltipNext {
  ...
  @JSImport("wix-ui-core/dist/es/src", "TooltipNext")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.wixUiCore.distEsSrcMod.TooltipNext] {
  ...
  implicit def make(companion: TooltipNext.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
