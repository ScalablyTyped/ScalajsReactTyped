...
trait ISDKConfig extends StObject {
  ...
  var isLoaded: js.UndefOr[js.Function1[/* sdk */ Any, Boolean]] = js.undefined
  ...
  var resolveRequire: js.UndefOr[js.Function1[/* sdk */ Any, Any]] = js.undefined
...
object ISDKConfig {
  ...
  extension [Self <: ISDKConfig](x: Self) {
    ...
    inline def setIsLoaded(value: /* sdk */ Any => Boolean): Self = StObject.set(x, "isLoaded", js.Any.fromFunction1(value))
    ...
    inline def setResolveRequire(value: /* sdk */ Any => Any): Self = StObject.set(x, "resolveRequire", js.Any.fromFunction1(value))
