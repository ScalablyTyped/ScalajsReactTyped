...
trait ICommonProps extends StObject {
  ...
  var onInit: js.UndefOr[js.Function2[/* player */ Any, /* playerName */ PlayerNameType, Unit]] = js.undefined
...
object ICommonProps {
  ...
  extension [Self <: ICommonProps](x: Self) {
    ...
    inline def setOnInit(value: (/* player */ Any, /* playerName */ PlayerNameType) => Callback): Self = StObject.set(x, "onInit", js.Any.fromFunction2((t0: /* player */ Any, t1: /* playerName */ PlayerNameType) => (value(t0, t1)).runNow()))
