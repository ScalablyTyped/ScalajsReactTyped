...
object distEsSrcComponentsCircularProgressBarCircularProgressBarMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/circular-progress-bar/CircularProgressBar", "CircularProgressBar")
  @js.native
