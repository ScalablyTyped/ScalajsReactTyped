...
object distEsSrcComponentsInputInputMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/input/Input", "Input")
  @js.native
  open class Input protected () extends Component[InputProps, InputState, Any] {
  ...
  object Input {
    ...
    @JSImport("wix-ui-core/dist/es/src/components/input/Input", "Input.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/components/input/Input", "Input.displayName")
    @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.wixUiCore.wixUiCoreStrings.list
    - typingsJapgolly.wixUiCore.wixUiCoreStrings.none
    - typingsJapgolly.wixUiCore.wixUiCoreStrings.both
  */
  trait AriaAutoCompleteType extends StObject
  object AriaAutoCompleteType {
    
    inline def both: typingsJapgolly.wixUiCore.wixUiCoreStrings.both = "both".asInstanceOf[typingsJapgolly.wixUiCore.wixUiCoreStrings.both]
    
    inline def list: typingsJapgolly.wixUiCore.wixUiCoreStrings.list = "list".asInstanceOf[typingsJapgolly.wixUiCore.wixUiCoreStrings.list]
    
    inline def none: typingsJapgolly.wixUiCore.wixUiCoreStrings.none = "none".asInstanceOf[typingsJapgolly.wixUiCore.wixUiCoreStrings.none]
  }
  
  /* Inlined parent type-zoo.type-zoo.Omit<react.react.InputHTMLAttributes<std.HTMLInputElement>, wix-ui-core.wix-ui-core/dist/es/src/components/input/Input.OmittedInputProps> */
  trait InputProps extends StObject {
    ...
    var onClick: js.UndefOr[EventHandler[ReactMouseEventFrom[HTMLInputElement]]] = js.undefined
    ...
    var onDragStart: js.UndefOr[EventHandler[ReactDragEventFrom[HTMLInputElement]]] = js.undefined
    ...
    var onMouseDown: js.UndefOr[EventHandler[ReactMouseEventFrom[HTMLInputElement]]] = js.undefined
    ...
    var onMouseMove: js.UndefOr[EventHandler[ReactMouseEventFrom[HTMLInputElement]]] = js.undefined
    ...
    var onMouseUp: js.UndefOr[EventHandler[ReactMouseEventFrom[HTMLInputElement]]] = js.undefined
  ...
  object InputProps {
    ...
    extension [Self <: InputProps](x: Self) {
      ...
      inline def setOnDragStart(value: ReactDragEventFrom[HTMLInputElement] => Callback): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1((t0: ReactDragEventFrom[HTMLInputElement]) => value(t0).runNow()))
      ...
      inline def setOnMouseDown(value: ReactMouseEventFrom[HTMLInputElement] => Callback): Self = StObject.set(x, "onMouseDown", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLInputElement]) => value(t0).runNow()))
      ...
      inline def setOnMouseMove(value: ReactMouseEventFrom[HTMLInputElement] => Callback): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLInputElement]) => value(t0).runNow()))
      ...
      inline def setOnMouseUp(value: ReactMouseEventFrom[HTMLInputElement] => Callback): Self = StObject.set(x, "onMouseUp", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLInputElement]) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.wixUiCore.wixUiCoreStrings.value
    - typingsJapgolly.wixUiCore.wixUiCoreStrings.prefix
  */
  trait OmittedInputProps extends StObject
  object OmittedInputProps {
    
    inline def prefix: typingsJapgolly.wixUiCore.wixUiCoreStrings.prefix = "prefix".asInstanceOf[typingsJapgolly.wixUiCore.wixUiCoreStrings.prefix]
    
    inline def value: typingsJapgolly.wixUiCore.wixUiCoreStrings.value = "value".asInstanceOf[typingsJapgolly.wixUiCore.wixUiCoreStrings.value]
  }
}
