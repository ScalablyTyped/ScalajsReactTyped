...
object distEsSrcComponentsPopoverNextComponentsPopperMod extends Shortcut {
  ...
  /* Inlined wix-ui-core.wix-ui-core/dist/es/src/components/popover/utils/getModifiers.ModifiersParams & std.Pick<wix-ui-core.wix-ui-core/dist/es/src/components/popover-next/popover-next.PopoverNextProps, 'maxWidth' | 'showArrow' | 'zIndex' | 'moveArrowTo' | 'customArrow' | 'id' | 'role'> & {  contentHook :string | undefined, grabScheduleUpdater (scheduler : react-popper.react-popper.PopperChildrenProps['scheduleUpdate']): void,   contentClassName :string | undefined} */
  ...
  object PopperProps {
    ...
    extension [Self <: PopperProps](x: Self) {
      ...
      inline def setGrabScheduleUpdater(
        value: /* import warning: importer.ImportType#apply Failed type conversion: react-popper.react-popper.PopperChildrenProps['scheduleUpdate'] */ js.Any => Callback
      ): Self = StObject.set(x, "grabScheduleUpdater", js.Any.fromFunction1((t0: /* import warning: importer.ImportType#apply Failed type conversion: react-popper.react-popper.PopperChildrenProps['scheduleUpdate'] */ js.Any) => value(t0).runNow()))
  ...
  /* This means you don't have to write `default`, but can instead just say `distEsSrcComponentsPopoverNextComponentsPopperMod.foo` */
