...
object distEsSrcComponentsSignatureInputMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/signature-input", "SignatureInput")
  @js.native
  open class SignatureInput protected ()
    extends typingsJapgolly.wixUiCore.distEsSrcComponentsSignatureInputSignatureInputMod.SignatureInput {
  ...
  object SignatureInput {
    ...
    @JSImport("wix-ui-core/dist/es/src/components/signature-input", "SignatureInput.ClearButton")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/components/signature-input", "SignatureInput.SigningPad")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/components/signature-input", "SignatureInput.Title")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/components/signature-input", "SignatureInput.displayName")
    @js.native
