...
object distEsSrcComponentsPopoverPopoverContextMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/popover/PopoverContext", "PopoverContext")
  @js.native
  ...
  object PopoverContextValue {
    ...
    extension [Self <: PopoverContextValue](x: Self) {
      ...
      inline def setExcludeClickOutsideClassesVarargs(value: String*): Self = StObject.set(x, "excludeClickOutsideClasses", js.Array(value*))
    }
  }
}
