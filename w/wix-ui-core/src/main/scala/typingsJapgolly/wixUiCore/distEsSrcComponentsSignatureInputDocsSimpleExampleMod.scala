...
object distEsSrcComponentsSignatureInputDocsSimpleExampleMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/signature-input/docs/SimpleExample", "SimpleExample")
  @js.native
