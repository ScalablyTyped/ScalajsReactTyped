...
open class Slider protected ()
  extends typingsJapgolly.wixUiCore.distEsSrcComponentsSliderMod.Slider {
...
object Slider {
  ...
  @JSImport("wix-ui-core/dist/es/src", "Slider.defaultProps")
  @js.native
  ...
  @JSImport("wix-ui-core/dist/es/src", "Slider.displayName")
  @js.native
