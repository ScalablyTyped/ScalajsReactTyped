...
open class ToggleSwitch protected ()
  extends typingsJapgolly.wixUiCore.distEsSrcComponentsToggleSwitchMod.ToggleSwitch {
...
object ToggleSwitch {
  ...
  @JSImport("wix-ui-core/dist/es/src", "ToggleSwitch.defaultProps")
  @js.native
  ...
  @JSImport("wix-ui-core/dist/es/src", "ToggleSwitch.displayName")
  @js.native
