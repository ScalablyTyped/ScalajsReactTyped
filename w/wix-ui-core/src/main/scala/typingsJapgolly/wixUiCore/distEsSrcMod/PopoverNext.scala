...
open class PopoverNext protected ()
  extends typingsJapgolly.wixUiCore.distEsSrcComponentsPopoverNextMod.PopoverNext {
...
object PopoverNext {
  ...
  @JSImport("wix-ui-core/dist/es/src", "PopoverNext.defaultProps")
  @js.native
  ...
  @JSImport("wix-ui-core/dist/es/src", "PopoverNext.displayName")
  @js.native
