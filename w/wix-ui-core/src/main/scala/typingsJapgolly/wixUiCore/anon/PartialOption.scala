...
/* Inlined std.Partial<wix-ui-core.wix-ui-core/dist/es/src/components/dropdown-option/OptionFactory.Option> */
trait PartialOption extends StObject {
  ...
  var render: js.UndefOr[js.Function1[/* value */ Node, Node]] = js.undefined
...
object PartialOption {
  ...
  extension [Self <: PartialOption](x: Self) {
    ...
    inline def setRender(value: /* value */ Node => Node): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
