...
object GetElementId {
  ...
  extension [Self <: GetElementId](x: Self) {
    ...
    inline def setGetTooltipText(value: CallbackTo[Any]): Self = StObject.set(x, "getTooltipText", value.toJsFn)
