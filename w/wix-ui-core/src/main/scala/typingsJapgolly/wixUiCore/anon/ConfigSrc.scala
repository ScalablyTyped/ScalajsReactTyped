...
object ConfigSrc {
  ...
  extension [Self <: ConfigSrc](x: Self) {
    ...
    inline def setConfigVarargs(value: (ValueDailymotion | ValuePlayable | ValueYoutube)*): Self = StObject.set(x, "config", js.Array(value*))
    
    inline def setSrc(value: js.Array[Label]): Self = StObject.set(x, "src", value.asInstanceOf[js.Any])
    
    inline def setSrcVarargs(value: Label*): Self = StObject.set(x, "src", js.Array(value*))
  }
}
