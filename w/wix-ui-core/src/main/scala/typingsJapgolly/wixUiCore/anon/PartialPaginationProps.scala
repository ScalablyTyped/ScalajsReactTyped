...
/* Inlined std.Partial<wix-ui-core.wix-ui-core/dist/es/src/components/pagination/Pagination.PaginationProps> */
trait PartialPaginationProps extends StObject {
  ...
  var onClick: js.UndefOr[js.Function1[/* event */ ReactEventFrom[org.scalajs.dom.Element], Unit]] = js.undefined
  
  var onDoubleClick: js.UndefOr[js.Function1[/* event */ ReactEventFrom[org.scalajs.dom.Element], Unit]] = js.undefined
  
  var onMouseEnter: js.UndefOr[js.Function1[/* event */ ReactEventFrom[org.scalajs.dom.Element], Unit]] = js.undefined
  
  var onMouseLeave: js.UndefOr[js.Function1[/* event */ ReactEventFrom[org.scalajs.dom.Element], Unit]] = js.undefined
...
object PartialPaginationProps {
  ...
  extension [Self <: PartialPaginationProps](x: Self) {
    ...
    inline def setOnClick(value: /* event */ ReactEventFrom[org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
    
    inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
    
    inline def setOnDoubleClick(value: /* event */ ReactEventFrom[org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onDoubleClick", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
    
    inline def setOnDoubleClickUndefined: Self = StObject.set(x, "onDoubleClick", js.undefined)
    
    inline def setOnMouseEnter(value: /* event */ ReactEventFrom[org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
    
    inline def setOnMouseEnterUndefined: Self = StObject.set(x, "onMouseEnter", js.undefined)
    
    inline def setOnMouseLeave(value: /* event */ ReactEventFrom[org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
