...
trait AriaActivedescendant extends StObject {
  ...
  var ariaActivedescendant: Any
  
  var ariaExpanded: Boolean
}
object AriaActivedescendant {
  
  inline def apply(ariaActivedescendant: Any, ariaExpanded: Boolean): AriaActivedescendant = {
  ...
  extension [Self <: AriaActivedescendant](x: Self) {
    ...
    inline def setAriaActivedescendant(value: Any): Self = StObject.set(x, "ariaActivedescendant", value.asInstanceOf[js.Any])
