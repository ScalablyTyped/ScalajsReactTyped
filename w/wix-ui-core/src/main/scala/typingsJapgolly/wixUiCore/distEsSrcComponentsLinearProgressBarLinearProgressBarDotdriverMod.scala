...
object distEsSrcComponentsLinearProgressBarLinearProgressBarDotdriverMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/linear-progress-bar/LinearProgressBar.driver", "linearProgressBarDriverFactory")
  @js.native
