...
object distEsSrcComponentsPopoverNextPopoverNextMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/popover-next/popover-next", "PopoverNext")
  @js.native
  open class PopoverNext protected () extends Component[PopoverNextProps, PopoverNextState, Any] {
    ...
    def componentDidUpdate_MPopoverNext(prevProps: Any): Unit = js.native
    ...
    def recoverFromError(event: Any): Unit = js.native
    
    def renderPopperContent(childrenObject: Any): Element = js.native
  ...
  object PopoverNext {
    ...
    @JSImport("wix-ui-core/dist/es/src/components/popover-next/popover-next", "PopoverNext.Content")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/components/popover-next/popover-next", "PopoverNext.Element")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/components/popover-next/popover-next", "PopoverNext.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/components/popover-next/popover-next", "PopoverNext.displayName")
    @js.native
  ...
  trait PopoverNextProps extends StObject {
    ...
    var appendTo: js.UndefOr[Boundary | parent | org.scalajs.dom.Element | Predicate] = js.undefined
  ...
  object PopoverNextProps {
    ...
    extension [Self <: PopoverNextProps](x: Self) {
      ...
      inline def setAppendTo(value: Boundary | parent | org.scalajs.dom.Element | Predicate): Self = StObject.set(x, "appendTo", value.asInstanceOf[js.Any])
