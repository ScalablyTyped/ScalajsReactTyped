...
import typingsJapgolly.wixUiCore.anon.TypeofButtonNextComponent
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distEsSrcComponentsButtonNextButtonNextMod {
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("wix-ui-core/dist/es/src/components/button-next/button-next", "ButtonNext")
  @js.native
  open class ButtonNext () extends ButtonNextComponent
  @JSImport("wix-ui-core/dist/es/src/components/button-next/button-next", "ButtonNext")
  @js.native
  ...
  trait ButtonNextComponent
    ...
    var innerComponentRef: RefHandle[HTMLElement | ComponentType[js.Object]] = js.native
  }
