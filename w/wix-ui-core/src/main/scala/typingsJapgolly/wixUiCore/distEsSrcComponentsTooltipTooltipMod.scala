...
object distEsSrcComponentsTooltipTooltipMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/tooltip/Tooltip", "Tooltip")
  @js.native
  open class Tooltip protected () extends PureComponent[TooltipProps, TooltipState, Any] {
  ...
  object Tooltip {
    ...
    @JSImport("wix-ui-core/dist/es/src/components/tooltip/Tooltip", "Tooltip.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/es/src/components/tooltip/Tooltip", "Tooltip.displayName")
    @js.native
