...
import typingsJapgolly.wixUiCore.distEsSrcComponentsDropdownOptionDropdownOptionMod.DropdownOptionType
import typingsJapgolly.wixUiCore.distEsSrcComponentsDropdownOptionOptionFactoryMod.Option
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distEsSrcComponentsDropdownOptionMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/dropdown-option", "DropdownOption")
  @js.native
  val DropdownOption: DropdownOptionType = js.native
  
  object OptionFactory {
    
    @JSImport("wix-ui-core/dist/es/src/components/dropdown-option", "OptionFactory")
    @js.native
