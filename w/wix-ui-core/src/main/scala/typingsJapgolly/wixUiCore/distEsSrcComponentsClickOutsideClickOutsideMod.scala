...
object distEsSrcComponentsClickOutsideClickOutsideMod {
  
  @JSImport("wix-ui-core/dist/es/src/components/click-outside/ClickOutside", "ClickOutside")
  @js.native
  open class ClickOutside protected ()
    ...
    /**
      ...
      */
    def _isInsideClick(event: Any): Boolean = js.native
    ...
    def componentDidUpdate_MClickOutside(prevProps: Any): Unit = js.native
  ...
  trait ClickOutsideProps extends StObject {
    ...
    var rootRef: RefHandle[HTMLElement]
  }
  object ClickOutsideProps {
    
    inline def apply(rootRef: RefHandle[HTMLElement]): ClickOutsideProps = {
