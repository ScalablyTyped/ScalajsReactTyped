...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setClick(value: (/* item */ ListEntry, /* dimension */ Dimension, /* event */ MouseEvent) => Callback): Self = StObject.set(x, "click", js.Any.fromFunction3((t0: /* item */ ListEntry, t1: /* dimension */ Dimension, t2: /* event */ MouseEvent) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setHover(value: (/* item */ ListEntry, /* dimension */ Dimension, /* event */ MouseEvent) => Callback): Self = StObject.set(x, "hover", js.Any.fromFunction3((t0: /* item */ ListEntry, t1: /* dimension */ Dimension, t2: /* event */ MouseEvent) => (value(t0, t1, t2)).runNow()))
