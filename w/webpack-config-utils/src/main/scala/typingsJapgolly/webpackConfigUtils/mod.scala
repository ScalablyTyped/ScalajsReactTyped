...
object mod {
  ...
  */
  ...
  object EnvVars {
    ...
    inline def dev: typingsJapgolly.webpackConfigUtils.webpackConfigUtilsStrings.dev = "dev".asInstanceOf[typingsJapgolly.webpackConfigUtils.webpackConfigUtilsStrings.dev]
    
    inline def development: typingsJapgolly.webpackConfigUtils.webpackConfigUtilsStrings.development = "development".asInstanceOf[typingsJapgolly.webpackConfigUtils.webpackConfigUtilsStrings.development]
    
    inline def prod: typingsJapgolly.webpackConfigUtils.webpackConfigUtilsStrings.prod = "prod".asInstanceOf[typingsJapgolly.webpackConfigUtils.webpackConfigUtilsStrings.prod]
    
    inline def production: typingsJapgolly.webpackConfigUtils.webpackConfigUtilsStrings.production = "production".asInstanceOf[typingsJapgolly.webpackConfigUtils.webpackConfigUtilsStrings.production]
    
    inline def test: typingsJapgolly.webpackConfigUtils.webpackConfigUtilsStrings.test = "test".asInstanceOf[typingsJapgolly.webpackConfigUtils.webpackConfigUtilsStrings.test]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - scala.Unit
    - scala.Null
    - typingsJapgolly.webpackConfigUtils.webpackConfigUtilsInts.`0`
  */
