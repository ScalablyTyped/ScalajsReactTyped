...
package object mod {
  ...
  type HookMap[T /* <: js.Function1[/* repeated */ js.Any, _] */] = typingsJapgolly.wordpressHooks.AnonCurrent[T] with (typingsJapgolly.std.Record[java.lang.String, js.UndefOr[js.Array[typingsJapgolly.wordpressHooks.mod.Hook[T]]]])
