...
import typingsJapgolly.wordpressHooks.buildTypesCreateAddHookMod.AddHook
import typingsJapgolly.wordpressHooks.buildTypesCreateDidHookMod.DidHook
import typingsJapgolly.wordpressHooks.buildTypesCreateDoingHookMod.DoingHook
import typingsJapgolly.wordpressHooks.buildTypesCreateHasHookMod.HasHook
import typingsJapgolly.wordpressHooks.buildTypesCreateHooksMod._Hooks
import typingsJapgolly.wordpressHooks.buildTypesCreateRemoveHookMod.RemoveHook
...
object mod {
  ...
  /**
    ...
    */
  inline def createHooks(): typingsJapgolly.wordpressHooks.buildTypesCreateHooksMod.Hooks = ^.asInstanceOf[js.Dynamic].applyDynamic("createHooks")().asInstanceOf[typingsJapgolly.wordpressHooks.buildTypesCreateHooksMod.Hooks]
  ...
  type Hooks = typingsJapgolly.wordpressHooks.buildTypesCreateHooksMod.Hooks
  
  type Store = (Record[String, Hook]) & typingsJapgolly.wordpressHooks.anon.Current
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.wordpressHooks.wordpressHooksStrings.actions
    - typingsJapgolly.wordpressHooks.wordpressHooksStrings.filters
  */
  trait StoreKey extends StObject
  object StoreKey {
    
    inline def actions: typingsJapgolly.wordpressHooks.wordpressHooksStrings.actions = "actions".asInstanceOf[typingsJapgolly.wordpressHooks.wordpressHooksStrings.actions]
    
    inline def filters: typingsJapgolly.wordpressHooks.wordpressHooksStrings.filters = "filters".asInstanceOf[typingsJapgolly.wordpressHooks.wordpressHooksStrings.filters]
  }
}
