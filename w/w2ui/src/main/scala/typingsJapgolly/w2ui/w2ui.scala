...
import typingsJapgolly.w2ui.W2UI.W2Grid.Columns
import typingsJapgolly.w2ui.W2UI.W2Grid.Ranges
import typingsJapgolly.w2ui.W2UI.W2Grid.Records
...
object W2UI {
  ...
  object W2Event {
    ...
    inline def apply(onComplete: Callback, target: String): W2Event = {
      val __obj = js.Dynamic.literal(onComplete = onComplete.toJsFn, target = target.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.w2ui.W2UI.W2Layout
    - typingsJapgolly.w2ui.W2UI.W2Grid
    - typingsJapgolly.w2ui.W2UI.W2Toolbar
    - typingsJapgolly.w2ui.W2UI.W2Sidebar
    - typingsJapgolly.w2ui.W2UI.W2Tabs
    - typingsJapgolly.w2ui.W2UI.W2Form
    - typingsJapgolly.w2ui.W2UI.W2Popup
  */
