...
trait W2Layout
  ...
  def content(`type`: String, content: typingsJapgolly.std.HTMLElement): Unit = js.native
  def content(`type`: String, content: typingsJapgolly.std.HTMLElement, transition: String): Unit = js.native
