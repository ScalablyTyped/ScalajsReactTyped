...
object RouterProps {
  ...
  def apply(
    ...
    __obj.updateDynamic("hook")(js.Any.fromFunction1((t0: /* options */ js.UndefOr[typingsJapgolly.wouter.mod.LocationHookOptions]) => hook(t0).runNow()))
    __obj.updateDynamic("matcher")(js.Any.fromFunction2((t0: /* pattern */ typingsJapgolly.wouter.mod.Path, t1: /* path */ typingsJapgolly.wouter.mod.Path) => matcher(t0, t1).runNow()))
