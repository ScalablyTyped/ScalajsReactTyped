package typingsJapgolly.wistiaPlayerBrowser

import typingsJapgolly.wistiaPlayerBrowser.anon.After
import typingsJapgolly.wistiaPlayerBrowser.anon.ClickToPlayButton
import typingsJapgolly.wistiaPlayerBrowser.anon.Fov
import typingsJapgolly.wistiaPlayerBrowser.anon.Language
import typingsJapgolly.wistiaPlayerBrowser.anon.MaxHeight
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserBooleans.`false`
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.`mid-roll-email`
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.`post-roll-email`
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.`pre-roll-email`
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.allow
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.auto
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.beforeremove
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.beforereplace
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.betweentimes
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.captionschange
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.conversion
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.crosstime
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.default
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.end
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.flash
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.hd_mp4
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.heightchange
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.lookchange
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.loop
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.metadata
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.mutechange
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.muted
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.none
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.original
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.pause
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.percentwatchedchanged
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.play
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.playbackratechange
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.reset
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.sd_mp4
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.secondchange
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.seek
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.silentplaybackmodechange
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.timechange
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.transparent
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.volumechange
import typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.widthchange
...
object WistiaPlayer {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.beforeplay
    - typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.playing
    - typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.paused
    - typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.ended
  */
  trait PlayState extends StObject
  object PlayState {
    
    inline def beforeplay: typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.beforeplay = "beforeplay".asInstanceOf[typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.beforeplay]
    
    inline def ended: typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.ended = "ended".asInstanceOf[typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.ended]
    
    inline def paused: typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.paused = "paused".asInstanceOf[typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.paused]
    
    inline def playing: typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.playing = "playing".asInstanceOf[typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserStrings.playing]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`224`
    - typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`360`
    - typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`540`
    - typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`720`
    - typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`1080`
    - typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`3840`
  */
  trait PlaybackQuality extends StObject
  object PlaybackQuality {
    
    inline def `1080`: typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`1080` = 1080.asInstanceOf[typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`1080`]
    
    inline def `224`: typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`224` = 224.asInstanceOf[typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`224`]
    
    inline def `360`: typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`360` = 360.asInstanceOf[typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`360`]
    
    inline def `3840`: typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`3840` = 3840.asInstanceOf[typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`3840`]
    
    inline def `540`: typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`540` = 540.asInstanceOf[typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`540`]
    
    inline def `720`: typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`720` = 720.asInstanceOf[typingsJapgolly.wistiaPlayerBrowser.wistiaPlayerBrowserInts.`720`]
  }
