...
object sliderConfig {
  ...
  inline def apply(): sliderConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[sliderConfig]
  }
  
  extension [Self <: sliderConfig](x: Self) {
    ...
    inline def setMoveTitle(value: Boolean): Self = StObject.set(x, "moveTitle", value.asInstanceOf[js.Any])
    
    inline def setMoveTitleUndefined: Self = StObject.set(x, "moveTitle", js.undefined)
