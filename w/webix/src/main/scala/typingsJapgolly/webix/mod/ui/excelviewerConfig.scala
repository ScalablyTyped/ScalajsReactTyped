...
trait excelviewerConfig extends js.Object {
  ...
  var subview: js.UndefOr[typingsJapgolly.webix.webix.ui.baseview | WebixCallback] = js.undefined
...
object excelviewerConfig {
  ...
  def apply(
    ...
    externalData: /* repeated */ js.Any => CallbackTo[js.Any] = null,
    ...
    subrow: String = null,
    subview: typingsJapgolly.webix.webix.ui.baseview | WebixCallback = null,
    templateCopy: /* repeated */ js.Any => CallbackTo[js.Any] = null,
    toolbar: String = null,
    tooltip: js.Any = null,
    ...
    if (externalData != null) __obj.updateDynamic("externalData")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => externalData(t0).runNow()))
    ...
    if (templateCopy != null) __obj.updateDynamic("templateCopy")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => templateCopy(t0).runNow()))
