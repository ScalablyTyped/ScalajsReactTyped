...
object pdfviewerEventName {
  ...
  @scala.inline
  def onDocumentReady: typingsJapgolly.webix.webixStrings.onDocumentReady = this.cast("onDocumentReady")
  @scala.inline
  ...
  @scala.inline
  def onPageRender: typingsJapgolly.webix.webixStrings.onPageRender = this.cast("onPageRender")
  @scala.inline
  def onScaleChange: typingsJapgolly.webix.webixStrings.onScaleChange = this.cast("onScaleChange")
  @scala.inline
