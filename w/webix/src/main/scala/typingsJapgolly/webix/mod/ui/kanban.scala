...
open class kanban ()
  ...
  def getComments(): typingsJapgolly.webix.webix.ui.baseview = js.native
  
  def getEditor(): typingsJapgolly.webix.webix.ui.baseview = js.native
  ...
  def getMenu(): typingsJapgolly.webix.webix.ui.baseview = js.native
  ...
  def getUserList(): typingsJapgolly.webix.webix.ui.baseview = js.native
