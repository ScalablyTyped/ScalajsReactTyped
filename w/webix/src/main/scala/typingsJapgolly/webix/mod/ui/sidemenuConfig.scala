...
object sidemenuConfig {
  ...
  inline def apply(): sidemenuConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[sidemenuConfig]
  }
  
  extension [Self <: sidemenuConfig](x: Self) {
    ...
    inline def setState(value: WebixCallback): Self = StObject.set(x, "state", value.asInstanceOf[js.Any])
