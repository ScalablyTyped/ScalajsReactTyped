...
object switchButtonConfig {
  ...
  inline def apply(): switchButtonConfig = {
  ...
  extension [Self <: switchButtonConfig](x: Self) {
    ...
    inline def setCheckValueUndefined: Self = StObject.set(x, "checkValue", js.undefined)
    ...
    inline def setCustomCheckbox(value: Boolean): Self = StObject.set(x, "customCheckbox", value.asInstanceOf[js.Any])
    
    inline def setCustomCheckboxUndefined: Self = StObject.set(x, "customCheckbox", js.undefined)
    ...
    inline def setUncheckValue(value: String): Self = StObject.set(x, "uncheckValue", value.asInstanceOf[js.Any])
    
    inline def setUncheckValueUndefined: Self = StObject.set(x, "uncheckValue", js.undefined)
