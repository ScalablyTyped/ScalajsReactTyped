...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onAfterTabClick
  - typingsJapgolly.webix.webixStrings.onBeforeRender
  - typingsJapgolly.webix.webixStrings.onBeforeTabClick
  - typingsJapgolly.webix.webixStrings.onBeforeTabClose
  ...
  - typingsJapgolly.webix.webixStrings.onOptionAdd
  - typingsJapgolly.webix.webixStrings.onOptionRemove
...
object tabbarEventName {
  ...
  inline def onAfterTabClick: typingsJapgolly.webix.webixStrings.onAfterTabClick = "onAfterTabClick".asInstanceOf[typingsJapgolly.webix.webixStrings.onAfterTabClick]
  ...
  inline def onBeforeTabClick: typingsJapgolly.webix.webixStrings.onBeforeTabClick = "onBeforeTabClick".asInstanceOf[typingsJapgolly.webix.webixStrings.onBeforeTabClick]
  
  inline def onBeforeTabClose: typingsJapgolly.webix.webixStrings.onBeforeTabClose = "onBeforeTabClose".asInstanceOf[typingsJapgolly.webix.webixStrings.onBeforeTabClose]
  ...
  inline def onOptionAdd: typingsJapgolly.webix.webixStrings.onOptionAdd = "onOptionAdd".asInstanceOf[typingsJapgolly.webix.webixStrings.onOptionAdd]
  
  inline def onOptionRemove: typingsJapgolly.webix.webixStrings.onOptionRemove = "onOptionRemove".asInstanceOf[typingsJapgolly.webix.webixStrings.onOptionRemove]
