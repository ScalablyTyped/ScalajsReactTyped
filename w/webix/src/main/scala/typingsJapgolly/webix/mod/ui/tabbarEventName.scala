...
object tabbarEventName {
  ...
  @scala.inline
  def onAfterTabClick: typingsJapgolly.webix.webixStrings.onAfterTabClick = this.cast("onAfterTabClick")
  @scala.inline
  def onBeforeRender: typingsJapgolly.webix.webixStrings.onBeforeRender = this.cast("onBeforeRender")
  @scala.inline
  def onBeforeTabClick: typingsJapgolly.webix.webixStrings.onBeforeTabClick = this.cast("onBeforeTabClick")
  @scala.inline
  def onBeforeTabClose: typingsJapgolly.webix.webixStrings.onBeforeTabClose = this.cast("onBeforeTabClose")
  @scala.inline
  ...
  @scala.inline
  def onOptionAdd: typingsJapgolly.webix.webixStrings.onOptionAdd = this.cast("onOptionAdd")
  @scala.inline
  def onOptionRemove: typingsJapgolly.webix.webixStrings.onOptionRemove = this.cast("onOptionRemove")
  @scala.inline
