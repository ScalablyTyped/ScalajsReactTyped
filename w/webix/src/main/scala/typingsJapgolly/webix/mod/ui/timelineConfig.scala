...
trait timelineConfig extends StObject {
  ...
  var templateDate: js.UndefOr[String | WebixCallback] = js.undefined
  
  var templateDetails: js.UndefOr[String | WebixCallback] = js.undefined
  
  var templateValue: js.UndefOr[String | WebixCallback] = js.undefined
...
object timelineConfig {
  ...
  inline def apply(): timelineConfig = {
  ...
  extension [Self <: timelineConfig](x: Self) {
    ...
    inline def setTemplateDate(value: String | WebixCallback): Self = StObject.set(x, "templateDate", value.asInstanceOf[js.Any])
    
    inline def setTemplateDateUndefined: Self = StObject.set(x, "templateDate", js.undefined)
    
    inline def setTemplateDetails(value: String | WebixCallback): Self = StObject.set(x, "templateDetails", value.asInstanceOf[js.Any])
    
    inline def setTemplateDetailsUndefined: Self = StObject.set(x, "templateDetails", js.undefined)
    
    inline def setTemplateUndefined: Self = StObject.set(x, "template", js.undefined)
    
    inline def setTemplateValue(value: String | WebixCallback): Self = StObject.set(x, "templateValue", value.asInstanceOf[js.Any])
