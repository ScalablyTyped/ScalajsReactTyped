...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onSubmit
...
object formEventName {
  ...
  inline def onSubmit: typingsJapgolly.webix.webixStrings.onSubmit = "onSubmit".asInstanceOf[typingsJapgolly.webix.webixStrings.onSubmit]
