...
open class submenu ()
  ...
  @JSName("$skin")
  var $skin_Original_submenu: WebixCallback = js.native
  ...
  def attachEvent(`type`: submenuEventName, functor: WebixCallback): String | Double = js.native
  def attachEvent(`type`: submenuEventName, functor: WebixCallback, id: String): String | Double = js.native
