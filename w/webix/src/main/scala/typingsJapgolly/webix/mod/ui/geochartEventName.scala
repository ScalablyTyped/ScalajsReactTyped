...
object geochartEventName {
  ...
  @scala.inline
  def onMapError: typingsJapgolly.webix.webixStrings.onMapError = this.cast("onMapError")
  @scala.inline
  def onMapReady: typingsJapgolly.webix.webixStrings.onMapReady = this.cast("onMapReady")
  @scala.inline
  def onRegionClick: typingsJapgolly.webix.webixStrings.onRegionClick = this.cast("onRegionClick")
  @scala.inline
