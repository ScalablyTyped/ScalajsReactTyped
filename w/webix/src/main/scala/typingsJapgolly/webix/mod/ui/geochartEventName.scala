...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onMapError
  - typingsJapgolly.webix.webixStrings.onMapReady
  - typingsJapgolly.webix.webixStrings.onRegionClick
...
object geochartEventName {
  ...
  inline def onMapError: typingsJapgolly.webix.webixStrings.onMapError = "onMapError".asInstanceOf[typingsJapgolly.webix.webixStrings.onMapError]
  
  inline def onMapReady: typingsJapgolly.webix.webixStrings.onMapReady = "onMapReady".asInstanceOf[typingsJapgolly.webix.webixStrings.onMapReady]
  
  inline def onRegionClick: typingsJapgolly.webix.webixStrings.onRegionClick = "onRegionClick".asInstanceOf[typingsJapgolly.webix.webixStrings.onRegionClick]
