...
trait timeboardConfig extends StObject {
  ...
  var hours: js.UndefOr[Boolean] = js.undefined
  ...
  var twelve: js.UndefOr[Boolean] = js.undefined
...
object timeboardConfig {
  
  inline def apply(): timeboardConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[timeboardConfig]
  }
  
  extension [Self <: timeboardConfig](x: Self) {
    ...
    inline def setHours(value: Boolean): Self = StObject.set(x, "hours", value.asInstanceOf[js.Any])
    ...
    inline def setTwelve(value: Boolean): Self = StObject.set(x, "twelve", value.asInstanceOf[js.Any])
    
    inline def setTwelveUndefined: Self = StObject.set(x, "twelve", js.undefined)
