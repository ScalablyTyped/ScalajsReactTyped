...
trait daterangesuggestConfig extends StObject {
  ...
  var body: js.UndefOr[String | typingsJapgolly.webix.webix.ui.baseview] = js.undefined
  ...
  var master: js.UndefOr[typingsJapgolly.webix.webix.ui.baseview] = js.undefined
...
object daterangesuggestConfig {
  ...
  inline def apply(): daterangesuggestConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[daterangesuggestConfig]
  }
  
  extension [Self <: daterangesuggestConfig](x: Self) {
    ...
    inline def setBody(value: String | typingsJapgolly.webix.webix.ui.baseview): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
    ...
    inline def setMaster(value: typingsJapgolly.webix.webix.ui.baseview): Self = StObject.set(x, "master", value.asInstanceOf[js.Any])
