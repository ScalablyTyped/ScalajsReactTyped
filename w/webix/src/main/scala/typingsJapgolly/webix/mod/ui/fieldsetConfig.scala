...
trait fieldsetConfig extends StObject {
  ...
  var body: js.UndefOr[typingsJapgolly.webix.webix.ui.baseview] = js.undefined
...
object fieldsetConfig {
  
  inline def apply(): fieldsetConfig = {
  ...
  extension [Self <: fieldsetConfig](x: Self) {
    ...
    inline def setBody(value: typingsJapgolly.webix.webix.ui.baseview): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
