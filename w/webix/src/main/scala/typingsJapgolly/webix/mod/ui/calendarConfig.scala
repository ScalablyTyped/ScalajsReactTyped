...
object calendarConfig {
  ...
  def apply(
    animate: js.Any = null,
    blockDates: /* repeated */ js.Any => CallbackTo[js.Any] = null,
    blockTime: /* repeated */ js.Any => CallbackTo[js.Any] = null,
    ...
    dayTemplate: /* repeated */ js.Any => CallbackTo[js.Any] = null,
    disabled: js.UndefOr[Boolean] = js.undefined,
    events: /* repeated */ js.Any => CallbackTo[js.Any] = null,
    ...
    if (blockDates != null) __obj.updateDynamic("blockDates")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => blockDates(t0).runNow()))
    if (blockTime != null) __obj.updateDynamic("blockTime")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => blockTime(t0).runNow()))
    ...
    if (dayTemplate != null) __obj.updateDynamic("dayTemplate")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => dayTemplate(t0).runNow()))
    if (!js.isUndefined(disabled)) __obj.updateDynamic("disabled")(disabled.asInstanceOf[js.Any])
    if (events != null) __obj.updateDynamic("events")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => events(t0).runNow()))
