...
trait selectConfig extends StObject {
  ...
  var options: js.UndefOr[js.Array[Any] | String] = js.undefined
...
object selectConfig {
  ...
  extension [Self <: selectConfig](x: Self) {
    ...
    inline def setOptions(value: js.Array[Any] | String): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
