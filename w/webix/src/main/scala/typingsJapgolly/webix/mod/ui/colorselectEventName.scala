...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onColorSelect
...
object colorselectEventName {
  ...
  inline def onColorSelect: typingsJapgolly.webix.webixStrings.onColorSelect = "onColorSelect".asInstanceOf[typingsJapgolly.webix.webixStrings.onColorSelect]
