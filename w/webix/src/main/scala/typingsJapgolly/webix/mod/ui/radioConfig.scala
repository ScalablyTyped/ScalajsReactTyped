...
object radioConfig {
  ...
  extension [Self <: radioConfig](x: Self) {
    ...
    inline def setCustomRadio(value: Boolean): Self = StObject.set(x, "customRadio", value.asInstanceOf[js.Any])
    
    inline def setCustomRadioUndefined: Self = StObject.set(x, "customRadio", js.undefined)
