...
trait TooltipControl extends js.Object {
  ...
  def addTooltip(target: typingsJapgolly.std.HTMLElement, config: js.Any): Unit = js.native
  ...
  def removeTooltip(target: typingsJapgolly.std.HTMLElement): Unit = js.native
}
