...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onHeatMapRender
...
object googleMapEventName {
  ...
  inline def onHeatMapRender: typingsJapgolly.webix.webixStrings.onHeatMapRender = "onHeatMapRender".asInstanceOf[typingsJapgolly.webix.webixStrings.onHeatMapRender]
