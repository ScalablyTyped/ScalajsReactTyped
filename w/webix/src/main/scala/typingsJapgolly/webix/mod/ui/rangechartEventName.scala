...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onAfterRangeChange
  ...
  - typingsJapgolly.webix.webixStrings.onLegendClick
...
*/
trait rangechartEventName extends StObject
object rangechartEventName {
  ...
  inline def onAfterRangeChange: typingsJapgolly.webix.webixStrings.onAfterRangeChange = "onAfterRangeChange".asInstanceOf[typingsJapgolly.webix.webixStrings.onAfterRangeChange]
  ...
  inline def onLegendClick: typingsJapgolly.webix.webixStrings.onLegendClick = "onLegendClick".asInstanceOf[typingsJapgolly.webix.webixStrings.onLegendClick]
