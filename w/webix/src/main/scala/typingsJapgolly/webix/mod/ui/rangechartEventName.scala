...
object rangechartEventName {
  ...
  @scala.inline
  def onAfterRangeChange: typingsJapgolly.webix.webixStrings.onAfterRangeChange = this.cast("onAfterRangeChange")
  @scala.inline
  ...
  @scala.inline
  def onLegendClick: typingsJapgolly.webix.webixStrings.onLegendClick = this.cast("onLegendClick")
  @scala.inline
