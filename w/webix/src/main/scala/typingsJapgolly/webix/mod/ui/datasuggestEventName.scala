...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onValueSuggest
...
*/
trait datasuggestEventName extends StObject
object datasuggestEventName {
  ...
  inline def onValueSuggest: typingsJapgolly.webix.webixStrings.onValueSuggest = "onValueSuggest".asInstanceOf[typingsJapgolly.webix.webixStrings.onValueSuggest]
