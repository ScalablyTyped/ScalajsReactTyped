...
object multitextEventName {
  ...
  @scala.inline
  def onSectionAdd: typingsJapgolly.webix.webixStrings.onSectionAdd = this.cast("onSectionAdd")
  @scala.inline
  def onSectionRemove: typingsJapgolly.webix.webixStrings.onSectionRemove = this.cast("onSectionRemove")
  @scala.inline
