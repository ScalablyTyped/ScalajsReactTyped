...
class treetable ()
  ...
  def move(sid: String, tindex: Double, tobj: typingsJapgolly.webix.webix.ui.baseview, details: js.Any): String | Double = js.native
  ...
  def move(sid: Double, tindex: Double, tobj: typingsJapgolly.webix.webix.ui.baseview, details: js.Any): String | Double = js.native
