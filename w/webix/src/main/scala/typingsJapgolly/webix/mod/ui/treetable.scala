...
open class treetable ()
  ...
  def copy(sid: String, tindex: Double, tobj: typingsJapgolly.webix.webix.ui.baseview, details: Any): Double = js.native
  ...
  def copy(sid: Double, tindex: Double, tobj: typingsJapgolly.webix.webix.ui.baseview, details: Any): Double = js.native
  ...
  def move(sid: String, tindex: Double, tobj: typingsJapgolly.webix.webix.ui.baseview): String | Double = js.native
  def move(sid: String, tindex: Double, tobj: typingsJapgolly.webix.webix.ui.baseview, details: Any): String | Double = js.native
  ...
  def move(sid: Double, tindex: Double, tobj: typingsJapgolly.webix.webix.ui.baseview): String | Double = js.native
  def move(sid: Double, tindex: Double, tobj: typingsJapgolly.webix.webix.ui.baseview, details: Any): String | Double = js.native
