...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onSliderDrag
...
*/
trait sliderEventName extends StObject
object sliderEventName {
  ...
  inline def onSliderDrag: typingsJapgolly.webix.webixStrings.onSliderDrag = "onSliderDrag".asInstanceOf[typingsJapgolly.webix.webixStrings.onSliderDrag]
