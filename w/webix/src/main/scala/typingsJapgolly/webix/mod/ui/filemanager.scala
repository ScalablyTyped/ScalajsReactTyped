...
import typingsJapgolly.webix.mod.DataStore
import typingsJapgolly.webix.mod.WebixCallback
import typingsJapgolly.webix.mod.WebixTemplate
...
class filemanager ()
  ...
  def copy(sid: String, tindex: Double, tobj: typingsJapgolly.webix.webix.ui.baseview): Double = js.native
  def copy(sid: String, tindex: Double, tobj: typingsJapgolly.webix.webix.ui.baseview, details: js.Any): Double = js.native
  def copy(sid: Double, tindex: Double): Double = js.native
  def copy(sid: Double, tindex: Double, tobj: typingsJapgolly.webix.webix.ui.baseview): Double = js.native
  def copy(sid: Double, tindex: Double, tobj: typingsJapgolly.webix.webix.ui.baseview, details: js.Any): Double = js.native
  ...
  def ui(view: js.Any): typingsJapgolly.webix.webix.ui.baseview = js.native
