...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onInit
...
*/
trait reportsEventName extends StObject
object reportsEventName {
  ...
  inline def onInit: typingsJapgolly.webix.webixStrings.onInit = "onInit".asInstanceOf[typingsJapgolly.webix.webixStrings.onInit]
