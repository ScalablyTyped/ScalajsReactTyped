...
trait WebixFilter extends js.Object {
  ...
  def refresh(master: typingsJapgolly.webix.webix.ui.baseview, node: HTMLElement, value: js.Any): Unit
  def render(master: typingsJapgolly.webix.webix.ui.baseview, config: StringDictionary[js.Any]): String
...
object WebixFilter {
  ...
  def apply(
    ...
    refresh: (typingsJapgolly.webix.webix.ui.baseview, HTMLElement, js.Any) => Callback,
    render: (typingsJapgolly.webix.webix.ui.baseview, StringDictionary[js.Any]) => CallbackTo[String],
