...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onAfterClose
  ...
  - typingsJapgolly.webix.webixStrings.onAfterOpen
  ...
  - typingsJapgolly.webix.webixStrings.onBeforeClose
  ...
  - typingsJapgolly.webix.webixStrings.onBeforeOpen
  ...
  - typingsJapgolly.webix.webixStrings.onItemCheck
  ...
  - typingsJapgolly.webix.webixStrings.onPartialRender
...
*/
trait treeEventName extends StObject
object treeEventName {
  ...
  inline def onPartialRender: typingsJapgolly.webix.webixStrings.onPartialRender = "onPartialRender".asInstanceOf[typingsJapgolly.webix.webixStrings.onPartialRender]
