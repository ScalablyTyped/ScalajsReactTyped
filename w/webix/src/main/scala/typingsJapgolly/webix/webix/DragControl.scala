...
trait DragControl extends js.Object {
  ...
  def addDrag(node: typingsJapgolly.std.HTMLElement, ctrl: js.Any): Unit = js.native
  ...
  def addDrop(node: typingsJapgolly.std.HTMLElement, ctrl: js.Any): Unit = js.native
  def addDrop(node: typingsJapgolly.std.HTMLElement, ctrl: js.Any, master_mode: Boolean): Unit = js.native
