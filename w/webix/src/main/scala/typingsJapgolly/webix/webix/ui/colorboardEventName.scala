...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onSelect
...
object colorboardEventName {
  ...
  inline def onSelect: typingsJapgolly.webix.webixStrings.onSelect = "onSelect".asInstanceOf[typingsJapgolly.webix.webixStrings.onSelect]
