...
object multicomboConfig {
  ...
  def apply(
    ...
    tagTemplate: /* repeated */ js.Any => CallbackTo[js.Any] = null,
    tooltip: js.Any = null,
    ...
    if (tagTemplate != null) __obj.updateDynamic("tagTemplate")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => tagTemplate(t0).runNow()))
