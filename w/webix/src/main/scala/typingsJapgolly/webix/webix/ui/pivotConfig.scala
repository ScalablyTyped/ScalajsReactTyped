...
object pivotConfig {
  ...
  def apply(
    ...
    format: /* repeated */ js.Any => CallbackTo[js.Any] = null,
    gravity: Int | Double = null,
    headerTemplate: /* repeated */ js.Any => CallbackTo[js.Any] = null,
    ...
    ping: /* repeated */ js.Any => CallbackTo[js.Any] = null,
    popup: js.Any = null,
    ...
    if (format != null) __obj.updateDynamic("format")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => format(t0).runNow()))
    if (gravity != null) __obj.updateDynamic("gravity")(gravity.asInstanceOf[js.Any])
    if (headerTemplate != null) __obj.updateDynamic("headerTemplate")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => headerTemplate(t0).runNow()))
    ...
    if (ping != null) __obj.updateDynamic("ping")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => ping(t0).runNow()))
