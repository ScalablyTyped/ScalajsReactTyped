...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onUnits
...
*/
trait unitlistEventName extends StObject
object unitlistEventName {
  ...
  inline def onUnits: typingsJapgolly.webix.webixStrings.onUnits = "onUnits".asInstanceOf[typingsJapgolly.webix.webixStrings.onUnits]
