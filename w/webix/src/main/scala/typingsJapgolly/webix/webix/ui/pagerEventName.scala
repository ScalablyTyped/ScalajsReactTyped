...
object pagerEventName {
  ...
  @scala.inline
  def onAfterPageChange: typingsJapgolly.webix.webixStrings.onAfterPageChange = this.cast("onAfterPageChange")
  @scala.inline
  ...
  @scala.inline
  def onBeforePageChange: typingsJapgolly.webix.webixStrings.onBeforePageChange = this.cast("onBeforePageChange")
  @scala.inline
