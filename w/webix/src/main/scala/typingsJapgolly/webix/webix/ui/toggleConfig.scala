...
trait toggleConfig extends StObject {
...
object toggleConfig {
  ...
  inline def apply(): toggleConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[toggleConfig]
  }
  
  extension [Self <: toggleConfig](x: Self) {
    ...
    inline def setOffIcon(value: String): Self = StObject.set(x, "offIcon", value.asInstanceOf[js.Any])
    ...
    inline def setOnIcon(value: String): Self = StObject.set(x, "onIcon", value.asInstanceOf[js.Any])
