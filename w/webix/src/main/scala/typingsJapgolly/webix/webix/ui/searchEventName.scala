...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onSearchIconClick
...
object searchEventName {
  ...
  inline def onSearchIconClick: typingsJapgolly.webix.webixStrings.onSearchIconClick = "onSearchIconClick".asInstanceOf[typingsJapgolly.webix.webixStrings.onSearchIconClick]
