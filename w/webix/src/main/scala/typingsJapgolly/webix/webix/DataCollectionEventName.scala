...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onAfterCursorChange
  ...
  - typingsJapgolly.webix.webixStrings.onBeforeCursorChange
  ...
  - typingsJapgolly.webix.webixStrings.onBindUpdate
