...
object hintEventName {
  ...
  @scala.inline
  def onAfterStart: typingsJapgolly.webix.webixStrings.onAfterStart = this.cast("onAfterStart")
  @scala.inline
  def onBeforeStart: typingsJapgolly.webix.webixStrings.onBeforeStart = this.cast("onBeforeStart")
  @scala.inline
  ...
  @scala.inline
  def onEnd: typingsJapgolly.webix.webixStrings.onEnd = this.cast("onEnd")
  @scala.inline
  ...
  @scala.inline
  def onNext: typingsJapgolly.webix.webixStrings.onNext = this.cast("onNext")
  @scala.inline
  def onPrevious: typingsJapgolly.webix.webixStrings.onPrevious = this.cast("onPrevious")
  @scala.inline
  def onSkip: typingsJapgolly.webix.webixStrings.onSkip = this.cast("onSkip")
  @scala.inline
