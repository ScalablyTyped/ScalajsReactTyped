...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.webix.webixStrings.onTimeSelect
  - typingsJapgolly.webix.webixStrings.onViewShow
*/
trait timeboardEventName extends StObject
object timeboardEventName {
  ...
  inline def onTimeSelect: typingsJapgolly.webix.webixStrings.onTimeSelect = "onTimeSelect".asInstanceOf[typingsJapgolly.webix.webixStrings.onTimeSelect]
