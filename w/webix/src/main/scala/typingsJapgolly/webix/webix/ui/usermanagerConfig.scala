...
trait usermanagerConfig extends StObject {
  ...
  var roles: js.UndefOr[Boolean] = js.undefined
...
object usermanagerConfig {
  
  inline def apply(): usermanagerConfig = {
  ...
  extension [Self <: usermanagerConfig](x: Self) {
    ...
    inline def setRoles(value: Boolean): Self = StObject.set(x, "roles", value.asInstanceOf[js.Any])
