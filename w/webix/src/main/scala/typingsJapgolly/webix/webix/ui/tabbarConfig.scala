...
object tabbarConfig {
  ...
  def apply(
    ...
    moreTemplate: /* repeated */ js.Any => CallbackTo[js.Any] = null,
    ...
    popup: String = null,
    popupTemplate: /* repeated */ js.Any => CallbackTo[js.Any] = null,
    ...
    if (moreTemplate != null) __obj.updateDynamic("moreTemplate")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => moreTemplate(t0).runNow()))
    ...
    if (popupTemplate != null) __obj.updateDynamic("popupTemplate")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => popupTemplate(t0).runNow()))
