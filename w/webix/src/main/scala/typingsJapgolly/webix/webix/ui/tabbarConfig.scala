...
object tabbarConfig {
  ...
  extension [Self <: tabbarConfig](x: Self) {
    ...
    inline def setMoreTemplate(value: WebixCallback): Self = StObject.set(x, "moreTemplate", value.asInstanceOf[js.Any])
    
    inline def setMoreTemplateUndefined: Self = StObject.set(x, "moreTemplate", js.undefined)
    ...
    inline def setTabMargin(value: Double): Self = StObject.set(x, "tabMargin", value.asInstanceOf[js.Any])
    
    inline def setTabMarginUndefined: Self = StObject.set(x, "tabMargin", js.undefined)
    
    inline def setTabMinWidth(value: Double): Self = StObject.set(x, "tabMinWidth", value.asInstanceOf[js.Any])
    
    inline def setTabMinWidthUndefined: Self = StObject.set(x, "tabMinWidth", js.undefined)
    
    inline def setTabMoreWidth(value: Double): Self = StObject.set(x, "tabMoreWidth", value.asInstanceOf[js.Any])
    
    inline def setTabMoreWidthUndefined: Self = StObject.set(x, "tabMoreWidth", js.undefined)
    
    inline def setTabOffset(value: Double): Self = StObject.set(x, "tabOffset", value.asInstanceOf[js.Any])
    
    inline def setTabOffsetUndefined: Self = StObject.set(x, "tabOffset", js.undefined)
    
    inline def setTabbarPopup(value: baseview): Self = StObject.set(x, "tabbarPopup", value.asInstanceOf[js.Any])
