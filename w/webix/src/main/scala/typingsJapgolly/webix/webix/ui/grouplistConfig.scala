...
trait grouplistConfig extends StObject {
  ...
  var templateBack: js.UndefOr[String | WebixCallback] = js.undefined
...
object grouplistConfig {
  ...
  inline def apply(): grouplistConfig = {
  ...
  extension [Self <: grouplistConfig](x: Self) {
    ...
    inline def setTemplateBack(value: String | WebixCallback): Self = StObject.set(x, "templateBack", value.asInstanceOf[js.Any])
    
    inline def setTemplateBackUndefined: Self = StObject.set(x, "templateBack", js.undefined)
    ...
    inline def setTemplateGroup(value: String | WebixCallback): Self = StObject.set(x, "templateGroup", value.asInstanceOf[js.Any])
    
    inline def setTemplateGroupUndefined: Self = StObject.set(x, "templateGroup", js.undefined)
    
    inline def setTemplateItem(value: String | WebixCallback): Self = StObject.set(x, "templateItem", value.asInstanceOf[js.Any])
    
    inline def setTemplateItemUndefined: Self = StObject.set(x, "templateItem", js.undefined)
