...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.whatwgEncoding.whatwgEncodingStrings.`UTF-16BE`
    - typingsJapgolly.whatwgEncoding.whatwgEncodingStrings.`UTF-16LE`
    - typingsJapgolly.whatwgEncoding.whatwgEncodingStrings.`UTF-8`
  */
  trait BOMEncoding extends StObject
  object BOMEncoding {
    
    inline def `UTF-16BE`: typingsJapgolly.whatwgEncoding.whatwgEncodingStrings.`UTF-16BE` = "UTF-16BE".asInstanceOf[typingsJapgolly.whatwgEncoding.whatwgEncodingStrings.`UTF-16BE`]
    
    inline def `UTF-16LE`: typingsJapgolly.whatwgEncoding.whatwgEncodingStrings.`UTF-16LE` = "UTF-16LE".asInstanceOf[typingsJapgolly.whatwgEncoding.whatwgEncodingStrings.`UTF-16LE`]
    
    inline def `UTF-8`: typingsJapgolly.whatwgEncoding.whatwgEncodingStrings.`UTF-8` = "UTF-8".asInstanceOf[typingsJapgolly.whatwgEncoding.whatwgEncodingStrings.`UTF-8`]
  }
}
