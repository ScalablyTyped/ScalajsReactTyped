...
import typingsJapgolly.wdioConfig.buildLibConfigParserMod.Spec
import typingsJapgolly.wdioConfig.buildLibConfigParserMod.default
...
import typingsJapgolly.wdioTypes.buildOptionsMod.Definition
