...
object anon {
  ...
  object OmitTestrunnercapabilitie {
    ...
    extension [Self <: OmitTestrunnercapabilitie](x: Self) {
      ...
      inline def setAfterSessionFunction3(
        value: (OmitTestrunnercapabilitie, /* capabilities */ RemoteCapability, /* specs */ js.Array[String]) => Callback
      ): Self = StObject.set(x, "afterSession", js.Any.fromFunction3((t0: OmitTestrunnercapabilitie, t1: /* capabilities */ RemoteCapability, t2: /* specs */ js.Array[String]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnPrepareFunction2(value: (OmitTestrunnercapabilitie, /* capabilities */ RemoteCapabilities) => Callback): Self = StObject.set(x, "onPrepare", js.Any.fromFunction2((t0: OmitTestrunnercapabilitie, t1: /* capabilities */ RemoteCapabilities) => (value(t0, t1)).runNow()))
      ...
      inline def setOnWorkerStartFunction5(
        value: (/* cid */ String, /* caps */ DesiredCapabilities, /* specs */ js.Array[String], OmitTestrunnercapabilitie, /* execArgv */ js.Array[String]) => Callback
      ): Self = StObject.set(x, "onWorkerStart", js.Any.fromFunction5((t0: /* cid */ String, t1: /* caps */ DesiredCapabilities, t2: /* specs */ js.Array[String], t3: OmitTestrunnercapabilitie, t4: /* execArgv */ js.Array[String]) => (value(t0, t1, t2, t3, t4)).runNow()))
  ...
  object RequiredTestrunner {
    ...
    extension [Self <: RequiredTestrunner](x: Self) {
      ...
      inline def setAfterSessionFunction3(
        value: (RequiredTestrunner, /* capabilities */ RemoteCapability, /* specs */ js.Array[String]) => Callback
      ): Self = StObject.set(x, "afterSession", js.Any.fromFunction3((t0: RequiredTestrunner, t1: /* capabilities */ RemoteCapability, t2: /* specs */ js.Array[String]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnPrepareFunction2(value: (RequiredTestrunner, /* capabilities */ RemoteCapabilities) => Callback): Self = StObject.set(x, "onPrepare", js.Any.fromFunction2((t0: RequiredTestrunner, t1: /* capabilities */ RemoteCapabilities) => (value(t0, t1)).runNow()))
      ...
      inline def setOnWorkerStartFunction5(
        value: (/* cid */ String, /* caps */ DesiredCapabilities, /* specs */ js.Array[String], RequiredTestrunner, /* execArgv */ js.Array[String]) => Callback
      ): Self = StObject.set(x, "onWorkerStart", js.Any.fromFunction5((t0: /* cid */ String, t1: /* caps */ DesiredCapabilities, t2: /* specs */ js.Array[String], t3: RequiredTestrunner, t4: /* execArgv */ js.Array[String]) => (value(t0, t1, t2, t3, t4)).runNow()))
