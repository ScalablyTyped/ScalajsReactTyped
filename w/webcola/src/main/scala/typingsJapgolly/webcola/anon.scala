...
import typingsJapgolly.webcola.distSrcGeomMod.Point
import typingsJapgolly.webcola.distSrcGeomMod.VisibilityEdge
import typingsJapgolly.webcola.distSrcGeomMod.VisibilityVertex
...
import typingsJapgolly.webcola.distSrcPowergraphMod.PowerEdge
import typingsJapgolly.webcola.distSrcVpscMod.Block
...
object anon {
  ...
  trait Constraint extends StObject {
    ...
    var constraint: typingsJapgolly.webcola.distSrcVpscMod.Constraint
  ...
  object Constraint {
    ...
    inline def apply(constraint: typingsJapgolly.webcola.distSrcVpscMod.Constraint, lb: Block, rb: Block): Constraint = {
    ...
    extension [Self <: Constraint](x: Self) {
      ...
      inline def setConstraint(value: typingsJapgolly.webcola.distSrcVpscMod.Constraint): Self = StObject.set(x, "constraint", value.asInstanceOf[js.Any])
