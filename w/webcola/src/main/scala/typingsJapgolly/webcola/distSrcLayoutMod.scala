...
object distSrcLayoutMod {
  ...
  object Event {
    ...
    extension [Self <: Event](x: Self) {
      ...
      inline def setListener(value: Callback): Self = StObject.set(x, "listener", value.toJsFn)
  ...
  object LinkLengthTypeAccessor {
    ...
    inline def apply(
      ...
      setLength: (Link[Node | Double], Double) => Callback
    ): LinkLengthTypeAccessor = {
      val __obj = js.Dynamic.literal(getSourceIndex = js.Any.fromFunction1(getSourceIndex), getTargetIndex = js.Any.fromFunction1(getTargetIndex), getType = js.Any.fromFunction1(getType), setLength = js.Any.fromFunction2((t0: Link[Node | Double], t1: Double) => (setLength(t0, t1)).runNow()))
