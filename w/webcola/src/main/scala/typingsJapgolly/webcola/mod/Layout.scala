...
import typingsJapgolly.webcola.distSrcLayoutMod.Group
import typingsJapgolly.webcola.distSrcLayoutMod.Link
import typingsJapgolly.webcola.distSrcLayoutMod.Node
...
@js.native
open class Layout ()
  extends typingsJapgolly.webcola.distSrcLayoutMod.Layout
/* static members */
object Layout {
