...
open class Solver protected ()
  extends typingsJapgolly.webcola.distSrcVpscMod.Solver {
  def this(
    vs: js.Array[typingsJapgolly.webcola.distSrcVpscMod.Variable],
    cs: js.Array[typingsJapgolly.webcola.distSrcVpscMod.Constraint]
  ) = this()
}
/* static members */
object Solver {
