...
class Layout3D protected ()
  extends typingsJapgolly.webcola.layout3dMod.Layout3D {
  def this(
    nodes: js.Array[typingsJapgolly.webcola.layout3dMod.Node3D],
    links: js.Array[typingsJapgolly.webcola.layout3dMod.Link3D]
  ) = this()
  def this(
    nodes: js.Array[typingsJapgolly.webcola.layout3dMod.Node3D],
    links: js.Array[typingsJapgolly.webcola.layout3dMod.Link3D],
