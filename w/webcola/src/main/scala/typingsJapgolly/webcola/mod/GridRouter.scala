...
import typingsJapgolly.webcola.gridrouterMod.NodeAccessor
...
class GridRouter[Node] protected ()
  extends typingsJapgolly.webcola.gridrouterMod.GridRouter[Node] {
...
object GridRouter extends js.Object {
  ...
  def angleBetween2Lines(
    line1: js.Array[typingsJapgolly.webcola.geomMod.Point],
    line2: js.Array[typingsJapgolly.webcola.geomMod.Point]
  ): Double = js.native
  def getRoutePath(
    route: js.Array[js.Array[typingsJapgolly.webcola.geomMod.Point]],
    cornerradius: Double,
    arrowwidth: Double,
    arrowheight: Double
  ): AnonArrowpath = js.native
  def getSegmentSets(routes: js.Any, x: js.Any, y: js.Any): js.Array[_] = js.native
  def makeSegments(path: js.Array[typingsJapgolly.webcola.geomMod.Point]): js.Array[js.Array[typingsJapgolly.webcola.geomMod.Point]] = js.native
  def nudgeSegments(
    routes: js.Any,
    x: String,
    y: String,
