...
import typingsJapgolly.webcola.anon.Arrowpath
import typingsJapgolly.webcola.distSrcGridrouterMod.NodeAccessor
...
open class GridRouter[Node] protected ()
  extends typingsJapgolly.webcola.distSrcGridrouterMod.GridRouter[Node] {
...
object GridRouter {
  ...
  inline def angleBetween2Lines(
    line1: js.Array[typingsJapgolly.webcola.distSrcGeomMod.Point],
    line2: js.Array[typingsJapgolly.webcola.distSrcGeomMod.Point]
  ...
  inline def getRoutePath(
    route: js.Array[js.Array[typingsJapgolly.webcola.distSrcGeomMod.Point]],
    cornerradius: Double,
    arrowwidth: Double,
    arrowheight: Double
  ...
  inline def makeSegments(path: js.Array[typingsJapgolly.webcola.distSrcGeomMod.Point]): js.Array[js.Array[typingsJapgolly.webcola.distSrcGeomMod.Point]] = ^.asInstanceOf[js.Dynamic].applyDynamic("makeSegments")(path.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Array[typingsJapgolly.webcola.distSrcGeomMod.Point]]]
