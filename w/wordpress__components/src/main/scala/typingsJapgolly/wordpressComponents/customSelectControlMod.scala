  ...
  object CustomSelectControl {
    ...
    object Props {
      ...
      extension [Self <: Props](x: Self) {
        ...
        inline def setOnChange(value: /* changes */ UseSelectStateChange[Option] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* changes */ UseSelectStateChange[Option]) => value(t0).runNow()))
