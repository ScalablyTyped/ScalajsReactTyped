...
object menuItemsChoiceMod {
  ...
  object MenuItemsChoice {
    ...
    object Props {
      ...
      inline def apply(choices: js.Array[Choice], onSelect: String => Callback, value: String): Props = {
        val __obj = js.Dynamic.literal(choices = choices.asInstanceOf[js.Any], onSelect = js.Any.fromFunction1((t0: String) => onSelect(t0).runNow()), value = value.asInstanceOf[js.Any])
