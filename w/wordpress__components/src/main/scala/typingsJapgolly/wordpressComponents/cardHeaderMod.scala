...
import typingsJapgolly.wordpressComponents.anon.IsBorderless
import typingsJapgolly.wordpressComponents.cardHeaderMod.CardHeader.Props
...
object cardHeaderMod {
  ...
  object CardHeader {
    ...
    type Props[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 175, starting with typingsJapgolly.wordpressComponents.wordpressComponentsStrings.a, typingsJapgolly.wordpressComponents.wordpressComponentsStrings.abbr, typingsJapgolly.wordpressComponents.wordpressComponentsStrings.address */ Any */] = IsBorderless[T] & (/* import warning: importer.ImportType#apply Failed type conversion: react.react.<global>.JSX.IntrinsicElements[T] */ js.Any)
  }
}
