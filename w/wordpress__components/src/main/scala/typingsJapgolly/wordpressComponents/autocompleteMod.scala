...
object autocompleteMod {
  ...
  object Autocomplete {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.wordpressComponents.wordpressComponentsStrings.`insert-at-caret`
      - typingsJapgolly.wordpressComponents.wordpressComponentsStrings.replace
    */
    trait Action extends StObject
    object Action {
      
      inline def `insert-at-caret`: typingsJapgolly.wordpressComponents.wordpressComponentsStrings.`insert-at-caret` = "insert-at-caret".asInstanceOf[typingsJapgolly.wordpressComponents.wordpressComponentsStrings.`insert-at-caret`]
      
      inline def replace: typingsJapgolly.wordpressComponents.wordpressComponentsStrings.replace = "replace".asInstanceOf[typingsJapgolly.wordpressComponents.wordpressComponentsStrings.replace]
    }
    ...
    trait Completer[T] extends StObject {
      ...
      /**
        ...
        * @param option - a completer option.
        */
      def getOptionLabel(option: T): Node
    ...
    object Completer {
      ...
      extension [Self <: Completer[?], T](x: Self & Completer[T]) {
        ...
        inline def setGetOptionLabel(value: T => Node): Self = StObject.set(x, "getOptionLabel", js.Any.fromFunction1(value))
    ...
    /* Rewritten from type alias, can be one of: 
      ...
      - typingsJapgolly.wordpressComponents.anon.Action
      - typingsJapgolly.wordpressComponents.anon.Value
    */
    type OptionCompletion = _OptionCompletion | Node
    ...
    object Props {
      ...
      extension [Self <: Props[?], T](x: Self & Props[T]) {
        ...
        inline def setOnChange(value: /* value */ Value => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* value */ Value) => value(t0).runNow()))
        
        inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
        
        inline def setOnReplace(value: /* value */ Value => Callback): Self = StObject.set(x, "onReplace", js.Any.fromFunction1((t0: /* value */ Value) => value(t0).runNow()))
    ...
    trait RenderProps extends StObject {
      ...
      def onKeyDown(event: ReactKeyboardEventFrom[HTMLElement]): Unit
    }
    object RenderProps {
      ...
      inline def apply(
        ...
        isExpanded: Boolean,
        listBoxId: String,
        onKeyDown: ReactKeyboardEventFrom[HTMLElement] => Callback
      ): RenderProps = {
        val __obj = js.Dynamic.literal(activeId = activeId.asInstanceOf[js.Any], isExpanded = isExpanded.asInstanceOf[js.Any], listBoxId = listBoxId.asInstanceOf[js.Any], onKeyDown = js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLElement]) => onKeyDown(t0).runNow()))
      ...
      extension [Self <: RenderProps](x: Self) {
        ...
        inline def setOnKeyDown(value: ReactKeyboardEventFrom[HTMLElement] => Callback): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLElement]) => value(t0).runNow()))
      }
    }
    ...
    object _OptionCompletion {
      ...
      inline def Action(): typingsJapgolly.wordpressComponents.anon.Action = {
        val __obj = js.Dynamic.literal(action = "insert-at-caret", value = null)
        __obj.asInstanceOf[typingsJapgolly.wordpressComponents.anon.Action]
      }
      
      inline def Value(value: typingsJapgolly.wordpressRichText.mod.Value): typingsJapgolly.wordpressComponents.anon.Value = {
        val __obj = js.Dynamic.literal(action = "replace", value = value.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.wordpressComponents.anon.Value]
      }
    }
  }
}
