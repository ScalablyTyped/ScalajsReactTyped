...
import typingsJapgolly.wordpressComponents.anon.OnMouseEnter
  ...
  object FormTokenField {
    ...
    object Props {
      ...
      extension [Self <: Props](x: Self) {
        ...
        inline def setOnChange(value: /* value */ js.Array[Value] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* value */ js.Array[Value]) => value(t0).runNow()))
        ...
        inline def setOnInputChange(value: /* token */ String => Callback): Self = StObject.set(x, "onInputChange", js.Any.fromFunction1((t0: /* token */ String) => value(t0).runNow()))
