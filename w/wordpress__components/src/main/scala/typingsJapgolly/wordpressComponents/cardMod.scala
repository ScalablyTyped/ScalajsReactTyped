...
import typingsJapgolly.wordpressComponents.anon.Elevation
import typingsJapgolly.wordpressComponents.cardMod.Card.Props
...
object cardMod {
  ...
  object Card {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.wordpressComponents.wordpressComponentsStrings.large
      - typingsJapgolly.wordpressComponents.wordpressComponentsStrings.medium
      - typingsJapgolly.wordpressComponents.wordpressComponentsStrings.small
      - typingsJapgolly.wordpressComponents.wordpressComponentsStrings.extraSmall
    */
    trait CardSize extends StObject
    object CardSize {
      
      inline def extraSmall: typingsJapgolly.wordpressComponents.wordpressComponentsStrings.extraSmall = "extraSmall".asInstanceOf[typingsJapgolly.wordpressComponents.wordpressComponentsStrings.extraSmall]
      
      inline def large: typingsJapgolly.wordpressComponents.wordpressComponentsStrings.large = "large".asInstanceOf[typingsJapgolly.wordpressComponents.wordpressComponentsStrings.large]
      
      inline def medium: typingsJapgolly.wordpressComponents.wordpressComponentsStrings.medium = "medium".asInstanceOf[typingsJapgolly.wordpressComponents.wordpressComponentsStrings.medium]
      
      inline def small: typingsJapgolly.wordpressComponents.wordpressComponentsStrings.small = "small".asInstanceOf[typingsJapgolly.wordpressComponents.wordpressComponentsStrings.small]
    }
    
    type Props[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 175, starting with typingsJapgolly.wordpressComponents.wordpressComponentsStrings.a, typingsJapgolly.wordpressComponents.wordpressComponentsStrings.abbr, typingsJapgolly.wordpressComponents.wordpressComponentsStrings.address */ Any */] = Elevation[T] & (/* import warning: importer.ImportType#apply Failed type conversion: react.react.<global>.JSX.IntrinsicElements[T] */ js.Any)
  }
}
