...
trait Elevation[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 175, starting with typingsJapgolly.wordpressComponents.wordpressComponentsStrings.a, typingsJapgolly.wordpressComponents.wordpressComponentsStrings.abbr, typingsJapgolly.wordpressComponents.wordpressComponentsStrings.address */ Any */] extends StObject {
...
object Elevation {
  ...
  inline def apply[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 175, starting with typingsJapgolly.wordpressComponents.wordpressComponentsStrings.a, typingsJapgolly.wordpressComponents.wordpressComponentsStrings.abbr, typingsJapgolly.wordpressComponents.wordpressComponentsStrings.address */ Any */](): Elevation[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Elevation[T]]
  }
  
  extension [Self <: Elevation[?], T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 175, starting with typingsJapgolly.wordpressComponents.wordpressComponentsStrings.a, typingsJapgolly.wordpressComponents.wordpressComponentsStrings.abbr, typingsJapgolly.wordpressComponents.wordpressComponentsStrings.address */ Any */](x: Self & Elevation[T]) {
