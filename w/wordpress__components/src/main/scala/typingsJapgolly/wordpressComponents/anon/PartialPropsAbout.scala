...
/* Inlined std.Partial<@wordpress/components.@wordpress/components/popover.default.Props> */
trait PartialPropsAbout extends StObject {
...
object PartialPropsAbout {
  
  inline def apply(): PartialPropsAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPropsAbout]
  }
  
  extension [Self <: PartialPropsAbout](x: Self) {
