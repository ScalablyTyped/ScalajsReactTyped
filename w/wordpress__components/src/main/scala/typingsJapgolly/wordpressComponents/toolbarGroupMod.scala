...
object toolbarGroupMod extends Shortcut {
  
  @JSImport("@wordpress/components/toolbar-group", JSImport.Default)
  @js.native
  val default: ComponentType[ToolbarGroupProps] = js.native
  ...
  type _To = ComponentType[ToolbarGroupProps]
  
  /* This means you don't have to write `default`, but can instead just say `toolbarGroupMod.foo` */
  override def _to: ComponentType[ToolbarGroupProps] = default
}
