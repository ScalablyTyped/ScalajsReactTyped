...
import typingsJapgolly.wordpressComponents.anon.OpenFileDialog
...
object FormFileUpload {
  ...
  object IconButtonProps {
    ...
    inline def apply(onChange: ReactEventFrom[HTMLInputElement & Element] => Callback): Builder = {
      val __props = js.Dynamic.literal(onChange = js.Any.fromFunction1((t0: ReactEventFrom[HTMLInputElement & Element]) => onChange(t0).runNow()))
      new Builder(js.Array(this.component, __props.asInstanceOf[typingsJapgolly.wordpressComponents.formFileUploadMod.FormFileUpload.IconButtonProps]))
    }
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def icon(
        value: typingsJapgolly.wordpressComponents.dashiconMod.Dashicon.Icon | typingsJapgolly.react.mod.global.JSX.Element
    ...
    def withProps(p: typingsJapgolly.wordpressComponents.formFileUploadMod.FormFileUpload.IconButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object RenderProps {
    ...
    inline def apply(
      ...
      render: OpenFileDialog => typingsJapgolly.react.mod.global.JSX.Element
    ): Builder = {
      val __props = js.Dynamic.literal(onChange = js.Any.fromFunction1((t0: ReactEventFrom[HTMLInputElement & Element]) => onChange(t0).runNow()), render = js.Any.fromFunction1(render))
      new Builder(js.Array(this.component, __props.asInstanceOf[typingsJapgolly.wordpressComponents.formFileUploadMod.FormFileUpload.RenderProps]))
    }
    ...
    def withProps(p: typingsJapgolly.wordpressComponents.formFileUploadMod.FormFileUpload.RenderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
