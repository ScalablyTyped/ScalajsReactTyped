...
object CardDivider {
  ...
  implicit def make(companion: CardDivider.type): SharedBuilder_Props510035900 = new SharedBuilder_Props510035900(js.Array(this.component, js.Dictionary.empty))()
