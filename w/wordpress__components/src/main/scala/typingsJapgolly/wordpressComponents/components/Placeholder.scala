...
object Placeholder {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def instructions(value: String): this.type = set("instructions", value.asInstanceOf[js.Any])
    
    inline def integrity(value: String): this.type = set("integrity", value.asInstanceOf[js.Any])
    
    inline def is(value: String): this.type = set("is", value.asInstanceOf[js.Any])
    
    inline def isColumnLayout(value: Boolean): this.type = set("isColumnLayout", value.asInstanceOf[js.Any])
    ...
    inline def preview(value: VdomElement): this.type = set("preview", value.rawElement.asInstanceOf[js.Any])
