...
object RangeControl {
  ...
  inline def apply(onChange: js.UndefOr[Double] => Callback, value: Double): Builder = {
    val __props = js.Dynamic.literal(onChange = js.Any.fromFunction1((t0: js.UndefOr[Double]) => onChange(t0).runNow()), value = value.asInstanceOf[js.Any])
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def afterIcon(value: typingsJapgolly.wordpressComponents.dashiconMod.Dashicon.Icon): this.type = set("afterIcon", value.asInstanceOf[js.Any])
    ...
    inline def beforeIcon(value: typingsJapgolly.wordpressComponents.dashiconMod.Dashicon.Icon): this.type = set("beforeIcon", value.asInstanceOf[js.Any])
    ...
    inline def initialPosition(value: Double): this.type = set("initialPosition", value.asInstanceOf[js.Any])
