...
import typingsJapgolly.wordpressComponents.cardDividerMod.CardDivider.Props
...
object Divider {
  ...
  implicit def make(companion: Divider.type): SharedBuilder_Props510035900 = new SharedBuilder_Props510035900(js.Array(this.component, js.Dictionary.empty))()
  ...
  ): SharedBuilder_Props510035900 = new SharedBuilder_Props510035900(js.Array(this.component, p.asInstanceOf[js.Any]))
}
