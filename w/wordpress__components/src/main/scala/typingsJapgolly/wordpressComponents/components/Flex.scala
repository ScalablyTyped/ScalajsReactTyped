...
import typingsJapgolly.wordpressComponents.flexMod.Flex.Props
...
object Flex {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def align(value: AlignItems | top | bottom): this.type = set("align", value.asInstanceOf[js.Any])
    ...
    inline def direction(value: FlexDirection): this.type = set("direction", value.asInstanceOf[js.Any])
    ...
    inline def gap(value: Double | String): this.type = set("gap", value.asInstanceOf[js.Any])
    ...
    inline def isReversed(value: Boolean): this.type = set("isReversed", value.asInstanceOf[js.Any])
    ...
    inline def justify(value: JustifyContent): this.type = set("justify", value.asInstanceOf[js.Any])
