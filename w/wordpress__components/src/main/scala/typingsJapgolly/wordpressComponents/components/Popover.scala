...
object Popover {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onFocusOutside(value: /* event */ ReactFocusEventFrom[Element] => Callback): this.type = set("onFocusOutside", js.Any.fromFunction1((t0: /* event */ ReactFocusEventFrom[Element]) => value(t0).runNow()))
