...
object Modal {
  ...
  inline def apply(
    ...
    val __props = js.Dynamic.literal(onRequestClose = js.Any.fromFunction1((t0: (ReactFocusEventFrom[Element & Element]) | (ReactKeyboardEventFrom[Element & Element]) | (ReactMouseEventFrom[Element & Element])) => onRequestClose(t0).runNow()), title = title.asInstanceOf[js.Any])
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def aria(value: Describedby): this.type = set("aria", value.asInstanceOf[js.Any])
    ...
    inline def closeButtonLabel(value: String): this.type = set("closeButtonLabel", value.asInstanceOf[js.Any])
    ...
    inline def isDismissable(value: Boolean): this.type = set("isDismissable", value.asInstanceOf[js.Any])
