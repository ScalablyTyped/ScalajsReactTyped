...
object CardFooter {
  ...
  implicit def make(companion: CardFooter.type): SharedBuilder_Props1270557638 = new SharedBuilder_Props1270557638(js.Array(this.component, js.Dictionary.empty))()
  ...
  ): SharedBuilder_Props1270557638 = new SharedBuilder_Props1270557638(js.Array(this.component, p.asInstanceOf[js.Any]))
}
