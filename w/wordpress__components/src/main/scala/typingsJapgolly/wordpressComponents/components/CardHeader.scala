...
object CardHeader {
  ...
  implicit def make(companion: CardHeader.type): SharedBuilder_Props1302477108 = new SharedBuilder_Props1302477108(js.Array(this.component, js.Dictionary.empty))()
  ...
  ): SharedBuilder_Props1302477108 = new SharedBuilder_Props1302477108(js.Array(this.component, p.asInstanceOf[js.Any]))
}
