...
object CardBody {
  ...
  implicit def make(companion: CardBody.type): SharedBuilder_Props_295933985 = new SharedBuilder_Props_295933985(js.Array(this.component, js.Dictionary.empty))()
  ...
  ): SharedBuilder_Props_295933985 = new SharedBuilder_Props_295933985(js.Array(this.component, p.asInstanceOf[js.Any]))
}
