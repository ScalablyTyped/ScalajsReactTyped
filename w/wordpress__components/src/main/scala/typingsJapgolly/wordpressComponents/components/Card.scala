...
object Card {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def isElevated(value: Boolean): this.type = set("isElevated", value.asInstanceOf[js.Any])
    
    inline def isRounded(value: Boolean): this.type = set("isRounded", value.asInstanceOf[js.Any])
