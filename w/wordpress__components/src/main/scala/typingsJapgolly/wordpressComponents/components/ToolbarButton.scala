...
object ToolbarButton {
  ...
  object AnchorProps {
    ...
    implicit def make(companion: AnchorProps.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: typingsJapgolly.wordpressComponents.buttonMod.Button.AnchorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object ButtonProps {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def href(value: scala.Nothing | String): this.type = set("href", value.asInstanceOf[js.Any])
    ...
    implicit def make(companion: ButtonProps.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: typingsJapgolly.wordpressComponents.buttonMod.Button.ButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object Props {
    
    inline def apply(
      icon: typingsJapgolly.wordpressComponents.dashiconMod.Dashicon.Icon | typingsJapgolly.react.mod.global.JSX.Element,
      title: String
    ): Builder = {
      val __props = js.Dynamic.literal(icon = icon.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[typingsJapgolly.wordpressComponents.toolbarButtonMod.ToolbarButton.Props]))
    }
    ...
    def withProps(p: typingsJapgolly.wordpressComponents.toolbarButtonMod.ToolbarButton.Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
