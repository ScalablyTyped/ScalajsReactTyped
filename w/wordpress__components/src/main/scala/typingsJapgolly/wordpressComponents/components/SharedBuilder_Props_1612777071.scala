...
@scala.inline
open class SharedBuilder_Props_1612777071[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def cycle(value: Boolean): this.type = set("cycle", value.asInstanceOf[js.Any])
  ...
  inline def onNavigate(value: (/* nextIndex */ Double, /* focusedElement */ HTMLElement) => Callback): this.type = set("onNavigate", js.Any.fromFunction2((t0: /* nextIndex */ Double, t1: /* focusedElement */ HTMLElement) => (value(t0, t1)).runNow()))
  ...
  inline def orientation(
    value: typingsJapgolly.wordpressComponents.wordpressComponentsStrings.vertical | typingsJapgolly.wordpressComponents.wordpressComponentsStrings.horizontal | typingsJapgolly.wordpressComponents.wordpressComponentsStrings.both
