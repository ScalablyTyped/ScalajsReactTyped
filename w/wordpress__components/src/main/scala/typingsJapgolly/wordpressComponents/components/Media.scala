...
import typingsJapgolly.wordpressComponents.cardMediaMod.CardMedia.Props
...
object Media {
  ...
  implicit def make(companion: Media.type): SharedBuilder_Props_83222855 = new SharedBuilder_Props_83222855(js.Array(this.component, js.Dictionary.empty))()
  ...
  ): SharedBuilder_Props_83222855 = new SharedBuilder_Props_83222855(js.Array(this.component, p.asInstanceOf[js.Any]))
}
