...
import typingsJapgolly.wordpressComponents.anon.AsClassName
...
object cardMediaMod {
  ...
  object CardMedia {
    ...
    type Props[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 175, starting with typingsJapgolly.wordpressComponents.wordpressComponentsStrings.a, typingsJapgolly.wordpressComponents.wordpressComponentsStrings.abbr, typingsJapgolly.wordpressComponents.wordpressComponentsStrings.address */ Any */] = AsClassName[T] & (/* import warning: importer.ImportType#apply Failed type conversion: react.react.<global>.JSX.IntrinsicElements[T] */ js.Any)
  }
}
