...
import typingsJapgolly.wordpressComponents.buttonMod.Button.Props
...
object buttonMod {
  ...
  object Button {
    ...
    - typingsJapgolly.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results
    - typingsJapgolly.react.mod.AllHTMLAttributes because var conflicts: className, disabled, label. Inlined formAction, srcDoc, alt, coords, src, max, marginWidth, keyParams, required, selected, kind, charSet, srcLang, sizes, dateTime, multiple, height, rowSpan, as, method, content, nonce, start, httpEquiv, default, optimum, target, scope, sandbox, seamless, classID, noValidate, autoPlay, min, cols, capture, encType, wmode, wrap, keyType, frameBorder, media, preload, useMap, size, scoped, rel, maxLength, manifest, colSpan, data, formEncType, pattern, form, open, accept, step, defer, shape, value, cite, minLength, cellSpacing, readOnly, challenge, poster, name, formMethod, playsInline, marginHeight, htmlFor, allowTransparency, headers, width, summary, formTarget, rows, href, action, scrolling, low, acceptCharset, reversed, autoFocus, controls, loop, mediaGroup, download, crossOrigin, muted, async, integrity, high, `type`, checked, srcSet, formNoValidate, allowFullScreen, list, cellPadding, autoComplete, hrefLang, span
    - typingsJapgolly.react.mod.HTMLProps because var conflicts: className, disabled, label. Inlined  */ trait ButtonProps
      extends StObject
         with BaseProps
         with Props
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.wordpressComponents.wordpressComponentsStrings.primary
      - typingsJapgolly.wordpressComponents.wordpressComponentsStrings.secondary
      - typingsJapgolly.wordpressComponents.wordpressComponentsStrings.tertiary
      - typingsJapgolly.wordpressComponents.wordpressComponentsStrings.link
    */
    trait ButtonVariant extends StObject
    object ButtonVariant {
      
      inline def link: typingsJapgolly.wordpressComponents.wordpressComponentsStrings.link = "link".asInstanceOf[typingsJapgolly.wordpressComponents.wordpressComponentsStrings.link]
      
      inline def primary: typingsJapgolly.wordpressComponents.wordpressComponentsStrings.primary = "primary".asInstanceOf[typingsJapgolly.wordpressComponents.wordpressComponentsStrings.primary]
      
      inline def secondary: typingsJapgolly.wordpressComponents.wordpressComponentsStrings.secondary = "secondary".asInstanceOf[typingsJapgolly.wordpressComponents.wordpressComponentsStrings.secondary]
      
      inline def tertiary: typingsJapgolly.wordpressComponents.wordpressComponentsStrings.tertiary = "tertiary".asInstanceOf[typingsJapgolly.wordpressComponents.wordpressComponentsStrings.tertiary]
    }
    
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.wordpressComponents.buttonMod.Button.AnchorProps
      - typingsJapgolly.wordpressComponents.buttonMod.Button.ButtonProps
    */
    trait Props extends StObject
    object Props {
      
      inline def AnchorProps(): typingsJapgolly.wordpressComponents.buttonMod.Button.AnchorProps = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.wordpressComponents.buttonMod.Button.AnchorProps]
      }
      
      inline def ButtonProps(): typingsJapgolly.wordpressComponents.buttonMod.Button.ButtonProps = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.wordpressComponents.buttonMod.Button.ButtonProps]
      }
    }
  }
}
