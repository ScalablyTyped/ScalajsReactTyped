...
import typingsJapgolly.winston.anon.Colors
import typingsJapgolly.winston.anon.ColorsLevels
import typingsJapgolly.winston.anon.Levels
...
object libWinstonConfigMod extends Shortcut {
  ...
  object Config {
    ...
    inline def apply(
      addColors: AbstractConfigSetColors => Callback,
      allColors: AbstractConfigSetColors,
      cli: Colors,
      npm: Levels,
      syslog: ColorsLevels
    ): Config = {
      val __obj = js.Dynamic.literal(addColors = js.Any.fromFunction1((t0: AbstractConfigSetColors) => addColors(t0).runNow()), allColors = allColors.asInstanceOf[js.Any], cli = cli.asInstanceOf[js.Any], npm = npm.asInstanceOf[js.Any], syslog = syslog.asInstanceOf[js.Any])
      __obj.asInstanceOf[Config]
    }
    
    extension [Self <: Config](x: Self) {
      
      inline def setAddColors(value: AbstractConfigSetColors => Callback): Self = StObject.set(x, "addColors", js.Any.fromFunction1((t0: AbstractConfigSetColors) => value(t0).runNow()))
