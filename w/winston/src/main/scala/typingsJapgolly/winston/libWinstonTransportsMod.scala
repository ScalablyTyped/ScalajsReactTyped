...
import typingsJapgolly.winston.anon.Bearer
...
object libWinstonTransportsMod extends Shortcut {
  ...
  trait Transports extends StObject {
    ...
    var ConsoleTransportOptions: typingsJapgolly.winston.libWinstonTransportsMod.ConsoleTransportOptions
    
    var File: FileTransportInstance
    
    var FileTransportOptions: typingsJapgolly.winston.libWinstonTransportsMod.FileTransportOptions
    
    var Http: HttpTransportInstance
    
    var HttpTransportOptions: typingsJapgolly.winston.libWinstonTransportsMod.HttpTransportOptions
    
    var Stream: StreamTransportInstance
    
    var StreamTransportOptions: typingsJapgolly.winston.libWinstonTransportsMod.StreamTransportOptions
  }
  object Transports {
