...
import typingsJapgolly.logform.mod.CliOptions
import typingsJapgolly.logform.mod.ColorizeOptions
import typingsJapgolly.logform.mod.Colorizer
import typingsJapgolly.logform.mod.FormatWrap
import typingsJapgolly.logform.mod.Format_
import typingsJapgolly.logform.mod.JsonOptions
import typingsJapgolly.logform.mod.LabelOptions
import typingsJapgolly.logform.mod.MetadataOptions
import typingsJapgolly.logform.mod.PadLevelsOptions
import typingsJapgolly.logform.mod.PrettyPrintOptions
import typingsJapgolly.logform.mod.TimestampOptions
import typingsJapgolly.logform.mod.TransformFunction
import typingsJapgolly.logform.mod.TransformableInfo
import typingsJapgolly.logform.mod.UncolorizeOptions
import typingsJapgolly.node.NodeJS.ReadableStream
import typingsJapgolly.node.streamMod.Transform
import typingsJapgolly.std.Map
import typingsJapgolly.std.Number
import typingsJapgolly.winston.libWinstonConfigMod.AbstractConfigSetColors
import typingsJapgolly.winston.libWinstonConfigMod.AbstractConfigSetLevels
import typingsJapgolly.winston.libWinstonConfigMod.Config
import typingsJapgolly.winston.libWinstonTransportsMod.ConsoleTransportInstance
import typingsJapgolly.winston.libWinstonTransportsMod.ConsoleTransportOptions
import typingsJapgolly.winston.libWinstonTransportsMod.FileTransportInstance
import typingsJapgolly.winston.libWinstonTransportsMod.FileTransportOptions
import typingsJapgolly.winston.libWinstonTransportsMod.HttpTransportInstance
import typingsJapgolly.winston.libWinstonTransportsMod.HttpTransportOptions
import typingsJapgolly.winston.libWinstonTransportsMod.StreamTransportInstance
import typingsJapgolly.winston.libWinstonTransportsMod.StreamTransportOptions
import typingsJapgolly.winston.libWinstonTransportsMod.Transports
import typingsJapgolly.winston.winstonStrings.asc
import typingsJapgolly.winston.winstonStrings.desc
...
object mod {
  ...
  open class ExceptionHandler protected () extends StObject {
    ...
    def handle(transports: typingsJapgolly.winstonTransport.mod.^ *): Unit = js.native
    
    var handlers: Map[Any, Any] = js.native
    
    var logger: Logger = js.native
    
    def unhandle(transports: typingsJapgolly.winstonTransport.mod.^ *): Unit = js.native
  }
  ...
  object Logform {
    ...
    open class Colorizer ()
      extends typingsJapgolly.logform.mod.Colorizer {
    ...
    @js.native
    open class Format_ ()
      extends typingsJapgolly.logform.mod.Format_ {
      def this(opts: js.Object) = this()
    }
    ...
    object format {
      ...
      inline def align(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("align")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def cli(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("cli")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      inline def cli(opts: CliOptions): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("cli")(opts.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def colorize(): typingsJapgolly.logform.mod.Colorizer = ^.asInstanceOf[js.Dynamic].applyDynamic("colorize")().asInstanceOf[typingsJapgolly.logform.mod.Colorizer]
      inline def colorize(opts: ColorizeOptions): typingsJapgolly.logform.mod.Colorizer = ^.asInstanceOf[js.Dynamic].applyDynamic("colorize")(opts.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.logform.mod.Colorizer]
      
      inline def combine(formats: typingsJapgolly.logform.mod.Format_ *): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("combine")(formats.asInstanceOf[Seq[js.Any]]*).asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def errors(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("errors")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      inline def errors(opts: js.Object): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("errors")(opts.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def json(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("json")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      inline def json(opts: JsonOptions): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("json")(opts.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def label(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("label")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      inline def label(opts: LabelOptions): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("label")(opts.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def logstash(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("logstash")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def metadata(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("metadata")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      inline def metadata(opts: MetadataOptions): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("metadata")(opts.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def ms(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("ms")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def padLevels(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("padLevels")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      inline def padLevels(opts: PadLevelsOptions): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("padLevels")(opts.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def prettyPrint(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("prettyPrint")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      inline def prettyPrint(opts: PrettyPrintOptions): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("prettyPrint")(opts.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def printf(templateFunction: js.Function1[/* info */ TransformableInfo, String]): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("printf")(templateFunction.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def simple(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("simple")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def splat(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("splat")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def timestamp(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("timestamp")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      inline def timestamp(opts: TimestampOptions): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("timestamp")(opts.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.logform.mod.Format_]
      
      inline def uncolorize(): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("uncolorize")().asInstanceOf[typingsJapgolly.logform.mod.Format_]
      inline def uncolorize(opts: UncolorizeOptions): typingsJapgolly.logform.mod.Format_ = ^.asInstanceOf[js.Dynamic].applyDynamic("uncolorize")(opts.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.logform.mod.Format_]
    }
  ...
  open class Logger () extends Transform {
    ...
    def add(transport: typingsJapgolly.winstonTransport.mod.^): Logger = js.native
    ...
    def remove(transport: typingsJapgolly.winstonTransport.mod.^): Logger = js.native
    ...
    var transports: js.Array[typingsJapgolly.winstonTransport.mod.^] = js.native
  ...
  @js.native
  def add: js.Function1[/* transport */ typingsJapgolly.winstonTransport.mod.^, Logger] = js.native
  ...
  inline def add_=(x: js.Function1[/* transport */ typingsJapgolly.winstonTransport.mod.^, Logger]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("add")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def remove: js.Function1[/* transport */ typingsJapgolly.winstonTransport.mod.^, Logger] = js.native
  inline def remove_=(x: js.Function1[/* transport */ typingsJapgolly.winstonTransport.mod.^, Logger]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("remove")(x.asInstanceOf[js.Any])
  ...
  trait LoggerOptions extends StObject {
    ...
    var transports: js.UndefOr[
        js.Array[typingsJapgolly.winstonTransport.mod.^] | typingsJapgolly.winstonTransport.mod.^
      ] = js.undefined
  }
  object LoggerOptions {
    ...
    extension [Self <: LoggerOptions](x: Self) {
      ...
      inline def setTransports(value: js.Array[typingsJapgolly.winstonTransport.mod.^] | typingsJapgolly.winstonTransport.mod.^): Self = StObject.set(x, "transports", value.asInstanceOf[js.Any])
      
      inline def setTransportsUndefined: Self = StObject.set(x, "transports", js.undefined)
      
      inline def setTransportsVarargs(value: typingsJapgolly.winstonTransport.mod.^ *): Self = StObject.set(x, "transports", js.Array(value*))
    }
  }
