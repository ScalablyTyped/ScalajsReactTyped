...
object distEsSrcGeneralDistComponentsVerticalRatioCheckedSmallMod extends Shortcut {
  
  @JSImport("wix-ui-icons-common/dist/es/src/general/dist/components/VerticalRatioCheckedSmall", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distEsSrcGeneralDistComponentsVerticalRatioCheckedSmallMod.foo` */
