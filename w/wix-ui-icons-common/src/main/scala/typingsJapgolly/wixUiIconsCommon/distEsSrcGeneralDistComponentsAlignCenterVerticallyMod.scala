...
object distEsSrcGeneralDistComponentsAlignCenterVerticallyMod extends Shortcut {
  
  @JSImport("wix-ui-icons-common/dist/es/src/general/dist/components/AlignCenterVertically", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distEsSrcGeneralDistComponentsAlignCenterVerticallyMod.foo` */
