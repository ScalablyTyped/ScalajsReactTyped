...
object distEsSrcGeneralDistComponentsLayoutListWithPanelSmallMod extends Shortcut {
  
  @JSImport("wix-ui-icons-common/dist/es/src/general/dist/components/LayoutListWithPanelSmall", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distEsSrcGeneralDistComponentsLayoutListWithPanelSmallMod.foo` */
