...
object Naver {
  ...
  implicit def make(companion: Naver.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NaverProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
