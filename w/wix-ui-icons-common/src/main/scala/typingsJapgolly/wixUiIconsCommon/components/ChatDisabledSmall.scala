...
object ChatDisabledSmall {
  ...
  implicit def make(companion: ChatDisabledSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChatDisabledSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
