...
object AdmissionArea {
  ...
  implicit def make(companion: AdmissionArea.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AdmissionAreaProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
