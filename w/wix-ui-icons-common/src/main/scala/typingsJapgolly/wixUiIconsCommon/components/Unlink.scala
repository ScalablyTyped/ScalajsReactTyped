...
object Unlink {
  ...
  implicit def make(companion: Unlink.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UnlinkProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
