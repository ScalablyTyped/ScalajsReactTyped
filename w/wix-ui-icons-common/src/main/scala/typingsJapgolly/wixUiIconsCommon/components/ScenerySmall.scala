...
object ScenerySmall {
  ...
  implicit def make(companion: ScenerySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ScenerySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
