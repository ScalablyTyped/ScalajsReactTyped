...
object ShowSidebarSmall {
  ...
  implicit def make(companion: ShowSidebarSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShowSidebarSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
