...
object TransferSmall {
  ...
  implicit def make(companion: TransferSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TransferSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
