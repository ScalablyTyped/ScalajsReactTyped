...
object EmptyTrashSmall {
  ...
  implicit def make(companion: EmptyTrashSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EmptyTrashSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
