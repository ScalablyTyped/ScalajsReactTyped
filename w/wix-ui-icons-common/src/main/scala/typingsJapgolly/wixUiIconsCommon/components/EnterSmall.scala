...
object EnterSmall {
  ...
  implicit def make(companion: EnterSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EnterSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
