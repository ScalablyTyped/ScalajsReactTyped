...
object EditorXSmall {
  ...
  implicit def make(companion: EditorXSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EditorXSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
