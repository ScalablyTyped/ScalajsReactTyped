...
object SiteAddSmall {
  ...
  implicit def make(companion: SiteAddSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SiteAddSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
