...
object HeatmapChartSmall {
  ...
  implicit def make(companion: HeatmapChartSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HeatmapChartSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
