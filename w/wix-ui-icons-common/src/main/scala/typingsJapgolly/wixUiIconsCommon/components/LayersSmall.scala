...
object LayersSmall {
  ...
  implicit def make(companion: LayersSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayersSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
