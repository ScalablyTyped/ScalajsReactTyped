...
object Inbox {
  ...
  implicit def make(companion: Inbox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InboxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
