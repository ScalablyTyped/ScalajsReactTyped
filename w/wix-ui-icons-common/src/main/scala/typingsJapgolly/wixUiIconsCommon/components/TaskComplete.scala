...
object TaskComplete {
  ...
  implicit def make(companion: TaskComplete.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TaskCompleteProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
