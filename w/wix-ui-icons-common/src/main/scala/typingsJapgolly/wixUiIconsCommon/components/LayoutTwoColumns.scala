...
object LayoutTwoColumns {
  ...
  implicit def make(companion: LayoutTwoColumns.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutTwoColumnsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
