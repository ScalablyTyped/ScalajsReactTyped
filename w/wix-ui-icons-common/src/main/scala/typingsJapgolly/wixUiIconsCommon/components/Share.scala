...
object Share {
  ...
  implicit def make(companion: Share.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShareProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
