...
object PaddingLeftSmall {
  ...
  implicit def make(companion: PaddingLeftSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaddingLeftSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
