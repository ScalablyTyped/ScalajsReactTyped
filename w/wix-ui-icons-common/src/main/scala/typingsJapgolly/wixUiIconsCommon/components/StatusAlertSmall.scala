...
object StatusAlertSmall {
  ...
  implicit def make(companion: StatusAlertSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatusAlertSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
