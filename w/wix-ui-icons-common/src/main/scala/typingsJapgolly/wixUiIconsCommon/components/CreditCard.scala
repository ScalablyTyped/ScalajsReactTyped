...
object CreditCard {
  ...
  implicit def make(companion: CreditCard.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CreditCardProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
