...
object Print {
  ...
  implicit def make(companion: Print.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PrintProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
