...
object HorizontalRatio {
  ...
  implicit def make(companion: HorizontalRatio.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HorizontalRatioProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
