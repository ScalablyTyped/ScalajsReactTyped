...
object Note {
  ...
  implicit def make(companion: Note.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NoteProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
