...
object GetStarted {
  ...
  implicit def make(companion: GetStarted.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GetStartedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
