...
object TikTokSmall {
  ...
  implicit def make(companion: TikTokSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TikTokSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
