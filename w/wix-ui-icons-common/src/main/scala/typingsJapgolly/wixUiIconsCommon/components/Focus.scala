...
object Focus {
  ...
  implicit def make(companion: Focus.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FocusProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
