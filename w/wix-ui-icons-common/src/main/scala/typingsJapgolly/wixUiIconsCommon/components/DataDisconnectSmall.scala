...
object DataDisconnectSmall {
  ...
  implicit def make(companion: DataDisconnectSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DataDisconnectSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
