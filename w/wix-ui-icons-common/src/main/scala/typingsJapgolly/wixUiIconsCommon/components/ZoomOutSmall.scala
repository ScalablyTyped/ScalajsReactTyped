...
object ZoomOutSmall {
  ...
  implicit def make(companion: ZoomOutSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ZoomOutSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
