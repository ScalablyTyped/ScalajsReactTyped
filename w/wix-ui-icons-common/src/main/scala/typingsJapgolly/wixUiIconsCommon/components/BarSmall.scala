...
object BarSmall {
  ...
  implicit def make(companion: BarSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BarSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
