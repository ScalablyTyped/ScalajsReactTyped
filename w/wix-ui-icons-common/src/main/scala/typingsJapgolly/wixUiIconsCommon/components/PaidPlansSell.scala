...
object PaidPlansSell {
  ...
  implicit def make(companion: PaidPlansSell.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaidPlansSellProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
