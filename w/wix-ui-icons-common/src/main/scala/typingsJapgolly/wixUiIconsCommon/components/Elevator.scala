...
object Elevator {
  ...
  implicit def make(companion: Elevator.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ElevatorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
