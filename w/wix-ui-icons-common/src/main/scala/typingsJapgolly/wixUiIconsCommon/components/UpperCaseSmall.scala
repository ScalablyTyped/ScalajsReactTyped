...
object UpperCaseSmall {
  ...
  implicit def make(companion: UpperCaseSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UpperCaseSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
