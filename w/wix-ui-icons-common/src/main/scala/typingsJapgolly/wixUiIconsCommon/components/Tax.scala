...
object Tax {
  ...
  implicit def make(companion: Tax.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TaxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
