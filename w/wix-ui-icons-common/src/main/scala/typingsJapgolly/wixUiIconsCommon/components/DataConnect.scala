...
object DataConnect {
  ...
  implicit def make(companion: DataConnect.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DataConnectProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
