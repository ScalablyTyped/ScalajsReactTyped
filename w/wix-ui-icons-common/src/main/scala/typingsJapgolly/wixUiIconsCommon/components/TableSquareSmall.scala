...
object TableSquareSmall {
  ...
  implicit def make(companion: TableSquareSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TableSquareSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
