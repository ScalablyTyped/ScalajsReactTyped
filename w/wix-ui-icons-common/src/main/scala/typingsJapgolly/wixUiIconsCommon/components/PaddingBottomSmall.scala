...
object PaddingBottomSmall {
  ...
  implicit def make(companion: PaddingBottomSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaddingBottomSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
