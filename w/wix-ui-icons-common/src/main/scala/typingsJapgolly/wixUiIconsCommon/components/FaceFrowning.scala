...
object FaceFrowning {
  ...
  implicit def make(companion: FaceFrowning.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FaceFrowningProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
