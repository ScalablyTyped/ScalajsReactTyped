...
object RichText {
  ...
  implicit def make(companion: RichText.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RichTextProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
