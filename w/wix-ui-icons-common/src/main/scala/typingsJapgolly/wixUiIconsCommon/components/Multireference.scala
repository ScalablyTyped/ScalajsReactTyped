...
object Multireference {
  ...
  implicit def make(companion: Multireference.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MultireferenceProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
