...
object SortDescendingSmall {
  ...
  implicit def make(companion: SortDescendingSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SortDescendingSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
