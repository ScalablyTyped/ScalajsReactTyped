...
object ExitFullScreenSmall {
  ...
  implicit def make(companion: ExitFullScreenSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExitFullScreenSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
