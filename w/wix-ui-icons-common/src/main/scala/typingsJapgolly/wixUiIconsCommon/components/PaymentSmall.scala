...
object PaymentSmall {
  ...
  implicit def make(companion: PaymentSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaymentSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
