...
object DateChecked {
  ...
  implicit def make(companion: DateChecked.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DateCheckedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
