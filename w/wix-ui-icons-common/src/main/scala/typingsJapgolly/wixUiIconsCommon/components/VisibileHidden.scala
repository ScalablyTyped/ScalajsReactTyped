...
object VisibileHidden {
  ...
  implicit def make(companion: VisibileHidden.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VisibileHiddenProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
