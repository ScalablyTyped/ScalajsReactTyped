...
object StopSmall {
  ...
  implicit def make(companion: StopSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StopSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
