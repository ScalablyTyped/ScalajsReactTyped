...
object RectangleLargeSmall {
  ...
  implicit def make(companion: RectangleLargeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RectangleLargeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
