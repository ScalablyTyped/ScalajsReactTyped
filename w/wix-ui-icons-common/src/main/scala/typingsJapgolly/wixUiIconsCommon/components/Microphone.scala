...
object Microphone {
  ...
  implicit def make(companion: Microphone.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MicrophoneProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
