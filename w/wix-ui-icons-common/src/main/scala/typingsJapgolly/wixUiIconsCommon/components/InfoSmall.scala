...
object InfoSmall {
  ...
  implicit def make(companion: InfoSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InfoSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
