...
object Apple {
  ...
  implicit def make(companion: Apple.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AppleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
