...
object DateSyncSmall {
  ...
  implicit def make(companion: DateSyncSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DateSyncSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
