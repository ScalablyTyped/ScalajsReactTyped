...
object UserCheckedSmall {
  ...
  implicit def make(companion: UserCheckedSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserCheckedSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
