...
object AdmissionAreaSmall {
  ...
  implicit def make(companion: AdmissionAreaSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AdmissionAreaSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
