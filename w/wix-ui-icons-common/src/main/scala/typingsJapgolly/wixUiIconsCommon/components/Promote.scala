...
object Promote {
  ...
  implicit def make(companion: Promote.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PromoteProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
