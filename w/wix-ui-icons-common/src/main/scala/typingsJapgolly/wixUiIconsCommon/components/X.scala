...
object X {
  ...
  implicit def make(companion: X.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: XProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
