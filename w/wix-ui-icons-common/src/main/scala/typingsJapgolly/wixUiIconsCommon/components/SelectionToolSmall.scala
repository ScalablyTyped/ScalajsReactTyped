...
object SelectionToolSmall {
  ...
  implicit def make(companion: SelectionToolSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SelectionToolSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
