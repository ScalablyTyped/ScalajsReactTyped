...
object StatusIndeterminateFilledSmall {
  ...
  implicit def make(companion: StatusIndeterminateFilledSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatusIndeterminateFilledSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
