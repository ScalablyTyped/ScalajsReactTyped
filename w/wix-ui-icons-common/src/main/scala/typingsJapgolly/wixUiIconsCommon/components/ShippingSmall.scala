...
object ShippingSmall {
  ...
  implicit def make(companion: ShippingSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShippingSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
