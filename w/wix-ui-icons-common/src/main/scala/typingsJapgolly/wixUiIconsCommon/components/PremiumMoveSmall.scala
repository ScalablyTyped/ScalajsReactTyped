...
object PremiumMoveSmall {
  ...
  implicit def make(companion: PremiumMoveSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PremiumMoveSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
