...
object MicrophoneDisabled {
  ...
  implicit def make(companion: MicrophoneDisabled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MicrophoneDisabledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
