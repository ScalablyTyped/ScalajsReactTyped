...
object Chat {
  ...
  implicit def make(companion: Chat.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChatProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
