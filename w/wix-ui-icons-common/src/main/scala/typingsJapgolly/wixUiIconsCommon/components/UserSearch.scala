...
object UserSearch {
  ...
  implicit def make(companion: UserSearch.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UserSearchProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
