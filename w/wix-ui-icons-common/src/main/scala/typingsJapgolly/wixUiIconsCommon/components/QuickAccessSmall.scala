...
object QuickAccessSmall {
  ...
  implicit def make(companion: QuickAccessSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: QuickAccessSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
