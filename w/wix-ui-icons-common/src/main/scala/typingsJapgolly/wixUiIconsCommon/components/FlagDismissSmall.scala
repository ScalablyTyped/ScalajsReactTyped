...
object FlagDismissSmall {
  ...
  implicit def make(companion: FlagDismissSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlagDismissSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
