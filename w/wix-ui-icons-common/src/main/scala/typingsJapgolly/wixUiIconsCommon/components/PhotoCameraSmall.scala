...
object PhotoCameraSmall {
  ...
  implicit def make(companion: PhotoCameraSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PhotoCameraSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
