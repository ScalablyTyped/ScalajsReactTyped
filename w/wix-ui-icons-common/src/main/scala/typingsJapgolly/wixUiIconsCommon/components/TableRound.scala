...
object TableRound {
  ...
  implicit def make(companion: TableRound.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TableRoundProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
