...
object MediaProofing {
  ...
  implicit def make(companion: MediaProofing.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MediaProofingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
