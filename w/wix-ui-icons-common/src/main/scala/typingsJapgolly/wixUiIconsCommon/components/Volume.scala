...
object Volume {
  ...
  implicit def make(companion: Volume.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VolumeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
