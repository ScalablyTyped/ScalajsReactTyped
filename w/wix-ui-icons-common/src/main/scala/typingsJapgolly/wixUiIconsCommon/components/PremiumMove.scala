...
object PremiumMove {
  ...
  implicit def make(companion: PremiumMove.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PremiumMoveProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
