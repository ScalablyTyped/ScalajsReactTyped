...
object PenNibAdd {
  ...
  implicit def make(companion: PenNibAdd.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PenNibAddProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
