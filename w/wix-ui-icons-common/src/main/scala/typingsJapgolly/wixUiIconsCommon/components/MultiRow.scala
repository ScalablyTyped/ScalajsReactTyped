...
object MultiRow {
  ...
  implicit def make(companion: MultiRow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MultiRowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
