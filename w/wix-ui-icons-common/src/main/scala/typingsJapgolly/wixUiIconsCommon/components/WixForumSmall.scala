...
object WixForumSmall {
  ...
  implicit def make(companion: WixForumSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixForumSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
