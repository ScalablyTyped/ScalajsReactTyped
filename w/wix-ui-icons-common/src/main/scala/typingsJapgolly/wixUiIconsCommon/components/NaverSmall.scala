...
object NaverSmall {
  ...
  implicit def make(companion: NaverSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NaverSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
