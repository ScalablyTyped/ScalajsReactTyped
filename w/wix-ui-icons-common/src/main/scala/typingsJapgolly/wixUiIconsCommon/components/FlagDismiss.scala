...
object FlagDismiss {
  ...
  implicit def make(companion: FlagDismiss.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlagDismissProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
