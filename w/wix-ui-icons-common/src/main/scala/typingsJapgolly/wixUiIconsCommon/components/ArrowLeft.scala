...
object ArrowLeft {
  ...
  implicit def make(companion: ArrowLeft.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArrowLeftProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
