...
object PenNibSmall {
  ...
  implicit def make(companion: PenNibSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PenNibSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
