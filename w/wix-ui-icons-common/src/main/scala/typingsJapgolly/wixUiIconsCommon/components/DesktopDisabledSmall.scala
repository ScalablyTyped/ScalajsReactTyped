...
object DesktopDisabledSmall {
  ...
  implicit def make(companion: DesktopDisabledSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DesktopDisabledSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
