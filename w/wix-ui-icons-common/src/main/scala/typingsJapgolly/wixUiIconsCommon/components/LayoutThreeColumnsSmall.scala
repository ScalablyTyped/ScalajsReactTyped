...
object LayoutThreeColumnsSmall {
  ...
  implicit def make(companion: LayoutThreeColumnsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutThreeColumnsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
