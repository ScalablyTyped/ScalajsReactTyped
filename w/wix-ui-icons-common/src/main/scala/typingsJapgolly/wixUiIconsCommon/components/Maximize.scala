...
object Maximize {
  ...
  implicit def make(companion: Maximize.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MaximizeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
