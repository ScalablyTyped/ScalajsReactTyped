...
object SidebarUndock {
  ...
  implicit def make(companion: SidebarUndock.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SidebarUndockProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
