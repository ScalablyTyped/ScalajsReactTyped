...
object LayoutSplit {
  ...
  implicit def make(companion: LayoutSplit.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutSplitProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
