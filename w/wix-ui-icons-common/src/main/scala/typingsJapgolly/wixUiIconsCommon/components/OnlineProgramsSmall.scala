...
object OnlineProgramsSmall {
  ...
  implicit def make(companion: OnlineProgramsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OnlineProgramsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
