...
object Database {
  ...
  implicit def make(companion: Database.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DatabaseProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
