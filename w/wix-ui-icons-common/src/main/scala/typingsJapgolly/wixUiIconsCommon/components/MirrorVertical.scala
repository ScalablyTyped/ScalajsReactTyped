...
object MirrorVertical {
  ...
  implicit def make(companion: MirrorVertical.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MirrorVerticalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
