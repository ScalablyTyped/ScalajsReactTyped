...
object UndoSmall {
  ...
  implicit def make(companion: UndoSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UndoSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
