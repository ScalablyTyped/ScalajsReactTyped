...
object Undo {
  ...
  implicit def make(companion: Undo.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: UndoProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
