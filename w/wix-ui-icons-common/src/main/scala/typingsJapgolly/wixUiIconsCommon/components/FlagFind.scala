...
object FlagFind {
  ...
  implicit def make(companion: FlagFind.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FlagFindProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
