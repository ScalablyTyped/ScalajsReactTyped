...
object MicrosoftSmall {
  ...
  implicit def make(companion: MicrosoftSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MicrosoftSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
