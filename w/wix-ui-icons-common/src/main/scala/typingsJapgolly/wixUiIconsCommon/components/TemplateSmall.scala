...
object TemplateSmall {
  ...
  implicit def make(companion: TemplateSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TemplateSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
