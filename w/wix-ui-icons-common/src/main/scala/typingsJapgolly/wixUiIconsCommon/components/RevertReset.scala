...
object RevertReset {
  ...
  implicit def make(companion: RevertReset.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RevertResetProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
