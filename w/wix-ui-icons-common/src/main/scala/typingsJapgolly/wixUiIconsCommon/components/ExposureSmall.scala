...
object ExposureSmall {
  ...
  implicit def make(companion: ExposureSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExposureSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
