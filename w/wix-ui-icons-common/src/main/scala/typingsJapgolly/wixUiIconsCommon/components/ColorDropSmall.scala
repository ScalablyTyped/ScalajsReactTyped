...
object ColorDropSmall {
  ...
  implicit def make(companion: ColorDropSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ColorDropSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
