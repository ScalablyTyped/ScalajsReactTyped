...
object ShowSidebar {
  ...
  implicit def make(companion: ShowSidebar.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShowSidebarProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
