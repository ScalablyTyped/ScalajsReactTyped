...
object CommentSmall {
  ...
  implicit def make(companion: CommentSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CommentSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
