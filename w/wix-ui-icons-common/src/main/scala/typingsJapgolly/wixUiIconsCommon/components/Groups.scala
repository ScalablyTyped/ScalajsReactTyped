...
object Groups {
  ...
  implicit def make(companion: Groups.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: GroupsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
