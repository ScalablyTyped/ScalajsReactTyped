...
object Shipping {
  ...
  implicit def make(companion: Shipping.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ShippingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
