...
object SendSmall {
  ...
  implicit def make(companion: SendSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SendSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
