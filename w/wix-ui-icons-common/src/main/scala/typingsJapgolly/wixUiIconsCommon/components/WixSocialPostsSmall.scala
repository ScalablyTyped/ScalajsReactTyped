...
object WixSocialPostsSmall {
  ...
  implicit def make(companion: WixSocialPostsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixSocialPostsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
