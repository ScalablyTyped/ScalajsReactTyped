...
object SidebarUndockSmall {
  ...
  implicit def make(companion: SidebarUndockSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SidebarUndockSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
