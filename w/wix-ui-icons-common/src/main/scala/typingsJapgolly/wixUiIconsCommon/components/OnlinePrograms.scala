...
object OnlinePrograms {
  ...
  implicit def make(companion: OnlinePrograms.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OnlineProgramsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
