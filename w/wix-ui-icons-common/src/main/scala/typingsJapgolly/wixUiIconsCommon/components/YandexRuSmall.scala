...
object YandexRuSmall {
  ...
  implicit def make(companion: YandexRuSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: YandexRuSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
