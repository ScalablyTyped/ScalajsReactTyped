...
object CodeObject {
  ...
  implicit def make(companion: CodeObject.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CodeObjectProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
