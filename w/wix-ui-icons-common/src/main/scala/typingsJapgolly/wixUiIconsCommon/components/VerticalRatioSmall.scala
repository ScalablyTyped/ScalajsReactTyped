...
object VerticalRatioSmall {
  ...
  implicit def make(companion: VerticalRatioSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VerticalRatioSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
