...
object QuickAccess {
  ...
  implicit def make(companion: QuickAccess.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: QuickAccessProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
