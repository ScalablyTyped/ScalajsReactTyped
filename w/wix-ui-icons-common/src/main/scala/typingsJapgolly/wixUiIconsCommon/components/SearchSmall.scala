...
object SearchSmall {
  ...
  implicit def make(companion: SearchSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SearchSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
