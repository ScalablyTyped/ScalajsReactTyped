...
object RoundedCornerSmall {
  ...
  implicit def make(companion: RoundedCornerSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RoundedCornerSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
