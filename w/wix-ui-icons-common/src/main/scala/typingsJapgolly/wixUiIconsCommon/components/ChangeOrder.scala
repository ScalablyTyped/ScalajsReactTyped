...
object ChangeOrder {
  ...
  implicit def make(companion: ChangeOrder.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChangeOrderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
