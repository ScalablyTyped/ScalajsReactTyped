...
object StatusIndeterminateFilled {
  ...
  implicit def make(companion: StatusIndeterminateFilled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StatusIndeterminateFilledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
