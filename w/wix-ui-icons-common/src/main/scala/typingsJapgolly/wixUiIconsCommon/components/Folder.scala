...
object Folder {
  ...
  implicit def make(companion: Folder.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FolderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
