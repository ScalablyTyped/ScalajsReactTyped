...
object ChevronRightLargeSmall {
  ...
  implicit def make(companion: ChevronRightLargeSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ChevronRightLargeSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
