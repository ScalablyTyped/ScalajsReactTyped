...
object Adjust {
  ...
  implicit def make(companion: Adjust.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AdjustProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
