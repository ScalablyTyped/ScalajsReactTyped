...
object ContentFilterSmall {
  ...
  implicit def make(companion: ContentFilterSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ContentFilterSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
