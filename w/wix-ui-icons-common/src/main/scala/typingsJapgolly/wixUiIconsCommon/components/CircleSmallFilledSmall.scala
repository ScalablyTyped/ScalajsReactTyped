...
object CircleSmallFilledSmall {
  ...
  implicit def make(companion: CircleSmallFilledSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CircleSmallFilledSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
