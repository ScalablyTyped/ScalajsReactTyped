...
object CreditCardSmall {
  ...
  implicit def make(companion: CreditCardSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CreditCardSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
