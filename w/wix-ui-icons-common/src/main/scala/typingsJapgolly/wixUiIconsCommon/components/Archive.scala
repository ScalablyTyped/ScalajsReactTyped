...
object Archive {
  ...
  implicit def make(companion: Archive.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ArchiveProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
