...
object ESignatureSmall {
  ...
  implicit def make(companion: ESignatureSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ESignatureSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
