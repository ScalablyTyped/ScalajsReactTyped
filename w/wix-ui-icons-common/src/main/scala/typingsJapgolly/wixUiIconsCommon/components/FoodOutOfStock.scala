...
object FoodOutOfStock {
  ...
  implicit def make(companion: FoodOutOfStock.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FoodOutOfStockProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
