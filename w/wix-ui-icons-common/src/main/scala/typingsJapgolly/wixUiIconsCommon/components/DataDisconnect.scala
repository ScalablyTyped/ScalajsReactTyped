...
object DataDisconnect {
  ...
  implicit def make(companion: DataDisconnect.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DataDisconnectProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
