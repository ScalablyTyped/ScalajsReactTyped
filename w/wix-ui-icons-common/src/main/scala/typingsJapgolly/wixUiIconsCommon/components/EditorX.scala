...
object EditorX {
  ...
  implicit def make(companion: EditorX.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EditorXProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
