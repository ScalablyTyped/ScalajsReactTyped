...
object VerticalRatioChecked {
  ...
  implicit def make(companion: VerticalRatioChecked.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VerticalRatioCheckedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
