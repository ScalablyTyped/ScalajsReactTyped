...
object MinimiseSmall {
  ...
  implicit def make(companion: MinimiseSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MinimiseSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
