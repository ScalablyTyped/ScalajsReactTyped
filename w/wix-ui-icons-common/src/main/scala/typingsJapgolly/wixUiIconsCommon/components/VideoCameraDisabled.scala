...
object VideoCameraDisabled {
  ...
  implicit def make(companion: VideoCameraDisabled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VideoCameraDisabledProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
