...
object DateAndTime {
  ...
  implicit def make(companion: DateAndTime.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DateAndTimeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
