...
object Filters {
  ...
  implicit def make(companion: Filters.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FiltersProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
