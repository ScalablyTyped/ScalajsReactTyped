...
object PaidPlans {
  ...
  implicit def make(companion: PaidPlans.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaidPlansProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
