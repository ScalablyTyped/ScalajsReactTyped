...
object Order {
  ...
  implicit def make(companion: Order.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: OrderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
