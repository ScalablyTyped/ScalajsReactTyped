...
object LayoutSplitSmall {
  ...
  implicit def make(companion: LayoutSplitSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LayoutSplitSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
