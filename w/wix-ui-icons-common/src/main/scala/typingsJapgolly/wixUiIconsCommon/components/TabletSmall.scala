...
object TabletSmall {
  ...
  implicit def make(companion: TabletSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TabletSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
