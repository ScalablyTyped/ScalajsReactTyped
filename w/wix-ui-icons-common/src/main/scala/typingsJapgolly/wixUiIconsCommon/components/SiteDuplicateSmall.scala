...
object SiteDuplicateSmall {
  ...
  implicit def make(companion: SiteDuplicateSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SiteDuplicateSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
