...
object DocExpireSmall {
  ...
  implicit def make(companion: DocExpireSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DocExpireSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
