...
object PaidPlansSmall {
  ...
  implicit def make(companion: PaidPlansSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaidPlansSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
