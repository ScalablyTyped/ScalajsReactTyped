...
object LowerCaseSmall {
  ...
  implicit def make(companion: LowerCaseSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LowerCaseSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
