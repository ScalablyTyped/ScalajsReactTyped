...
object ExternalLinkSmall {
  ...
  implicit def make(companion: ExternalLinkSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExternalLinkSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
