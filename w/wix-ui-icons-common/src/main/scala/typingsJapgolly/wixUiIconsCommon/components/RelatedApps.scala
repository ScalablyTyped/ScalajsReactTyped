...
object RelatedApps {
  ...
  implicit def make(companion: RelatedApps.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RelatedAppsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
