...
object CodeObjectSmall {
  ...
  implicit def make(companion: CodeObjectSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CodeObjectSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
