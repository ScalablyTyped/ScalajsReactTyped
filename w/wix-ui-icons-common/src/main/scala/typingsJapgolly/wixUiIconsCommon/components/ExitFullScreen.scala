...
object ExitFullScreen {
  ...
  implicit def make(companion: ExitFullScreen.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExitFullScreenProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
