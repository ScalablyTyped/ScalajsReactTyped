...
object BackgroundSmall {
  ...
  implicit def make(companion: BackgroundSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BackgroundSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
