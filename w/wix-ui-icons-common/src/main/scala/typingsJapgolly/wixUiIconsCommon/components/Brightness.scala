...
object Brightness {
  ...
  implicit def make(companion: Brightness.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BrightnessProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
