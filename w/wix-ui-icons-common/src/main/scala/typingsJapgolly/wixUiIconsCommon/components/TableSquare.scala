...
object TableSquare {
  ...
  implicit def make(companion: TableSquare.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TableSquareProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
