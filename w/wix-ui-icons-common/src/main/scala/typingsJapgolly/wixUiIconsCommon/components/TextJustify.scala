...
object TextJustify {
  ...
  implicit def make(companion: TextJustify.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TextJustifyProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
