...
object ZoomOut {
  ...
  implicit def make(companion: ZoomOut.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ZoomOutProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
