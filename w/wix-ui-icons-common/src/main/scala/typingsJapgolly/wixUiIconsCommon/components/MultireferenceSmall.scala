...
object MultireferenceSmall {
  ...
  implicit def make(companion: MultireferenceSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MultireferenceSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
