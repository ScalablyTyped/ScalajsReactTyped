...
object SmokingSmall {
  ...
  implicit def make(companion: SmokingSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SmokingSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
