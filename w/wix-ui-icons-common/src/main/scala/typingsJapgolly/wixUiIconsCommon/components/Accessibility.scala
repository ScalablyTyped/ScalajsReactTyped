...
object Accessibility {
  ...
  implicit def make(companion: Accessibility.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AccessibilityProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
