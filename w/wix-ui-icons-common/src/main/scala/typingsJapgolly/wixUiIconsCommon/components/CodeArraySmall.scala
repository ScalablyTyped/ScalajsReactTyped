...
object CodeArraySmall {
  ...
  implicit def make(companion: CodeArraySmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CodeArraySmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
