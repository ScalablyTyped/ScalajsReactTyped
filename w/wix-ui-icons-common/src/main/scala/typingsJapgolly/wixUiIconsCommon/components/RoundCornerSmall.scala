...
object RoundCornerSmall {
  ...
  implicit def make(companion: RoundCornerSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RoundCornerSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
