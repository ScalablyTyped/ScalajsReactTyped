...
object EmailOpen {
  ...
  implicit def make(companion: EmailOpen.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EmailOpenProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
