...
object SquareRatio {
  ...
  implicit def make(companion: SquareRatio.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SquareRatioProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
