...
object RadioButtonGroupSmall {
  ...
  implicit def make(companion: RadioButtonGroupSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: RadioButtonGroupSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
