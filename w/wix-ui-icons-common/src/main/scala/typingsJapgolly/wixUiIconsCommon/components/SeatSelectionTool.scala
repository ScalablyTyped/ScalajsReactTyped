...
object SeatSelectionTool {
  ...
  implicit def make(companion: SeatSelectionTool.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SeatSelectionToolProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
