...
object TaxSmall {
  ...
  implicit def make(companion: TaxSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TaxSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
