...
object PaddingVerticalSmall {
  ...
  implicit def make(companion: PaddingVerticalSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: PaddingVerticalSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
