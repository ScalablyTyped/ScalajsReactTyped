...
object MagicWandSmall {
  ...
  implicit def make(companion: MagicWandSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MagicWandSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
