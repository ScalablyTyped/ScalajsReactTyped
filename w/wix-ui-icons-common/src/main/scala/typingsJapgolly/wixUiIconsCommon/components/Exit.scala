...
object Exit {
  ...
  implicit def make(companion: Exit.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExitProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
