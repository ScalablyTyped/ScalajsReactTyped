...
object BrightnessSmall {
  ...
  implicit def make(companion: BrightnessSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BrightnessSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
