...
object StairsSmall {
  ...
  implicit def make(companion: StairsSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: StairsSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
