...
object Checkroom {
  ...
  implicit def make(companion: Checkroom.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CheckroomProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
