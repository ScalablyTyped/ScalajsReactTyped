...
object AlignBottomSmall {
  ...
  implicit def make(companion: AlignBottomSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AlignBottomSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
