...
object SoundCloud {
  ...
  implicit def make(companion: SoundCloud.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SoundCloudProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
