...
object VideoCameraSmall {
  ...
  implicit def make(companion: VideoCameraSmall.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: VideoCameraSmallProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
