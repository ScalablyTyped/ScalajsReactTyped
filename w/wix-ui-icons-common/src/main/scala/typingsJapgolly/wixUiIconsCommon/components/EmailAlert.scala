...
object EmailAlert {
  ...
  implicit def make(companion: EmailAlert.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EmailAlertProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
