...
object distEsSrcGeneralDistComponentsOnlineProgramsMod extends Shortcut {
  
  @JSImport("wix-ui-icons-common/dist/es/src/general/dist/components/OnlinePrograms", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distEsSrcGeneralDistComponentsOnlineProgramsMod.foo` */
