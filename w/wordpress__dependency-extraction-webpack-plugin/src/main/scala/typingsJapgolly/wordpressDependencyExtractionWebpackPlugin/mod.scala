package typingsJapgolly.wordpressDependencyExtractionWebpackPlugin

import japgolly.scalajs.react.Callback
import typingsJapgolly.webpack.mod.Compiler
import typingsJapgolly.wordpressDependencyExtractionWebpackPlugin.wordpressDependencyExtractionWebpackPluginStrings.json
import typingsJapgolly.wordpressDependencyExtractionWebpackPlugin.wordpressDependencyExtractionWebpackPluginStrings.php
...
object mod {
  ...
  object DependencyExtractionWebpackPlugin {
    ...
    inline def apply(apply: Compiler => Callback): DependencyExtractionWebpackPlugin = {
