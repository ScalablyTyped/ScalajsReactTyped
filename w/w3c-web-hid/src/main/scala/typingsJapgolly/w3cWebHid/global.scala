...
object global {
  ...
  open class HID ()
    extends StObject
       with typingsJapgolly.w3cWebHid.HID
  ...
  open class HIDConnectionEvent protected ()
    extends StObject
       with typingsJapgolly.w3cWebHid.HIDConnectionEvent {
  ...
  open class HIDDevice ()
    extends StObject
       with typingsJapgolly.w3cWebHid.HIDDevice
  ...
  open class HIDInputReportEvent protected ()
    extends StObject
       with typingsJapgolly.w3cWebHid.HIDInputReportEvent {
