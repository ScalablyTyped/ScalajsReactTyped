...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.webidl2.mod.ExtendedAttributeRightHandSideBase
  - typingsJapgolly.webidl2.mod.ExtendedAttributeRightHandSideList
*/
trait ExtendedAttributeRightHandSide extends StObject
