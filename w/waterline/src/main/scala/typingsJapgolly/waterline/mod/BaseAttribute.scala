...
/* Inlined waterline.waterline.AttributeValidations & {  type ? :string,   primaryKey ? :boolean,   unique ? :boolean,   required ? :boolean,   enum ? :std.Array<T>,   size ? :number,   columnName ? :string,   index ? :boolean,   defaultsTo ? :T | waterline.waterline.DefaultsToFn<T>} */
trait BaseAttribute[T] extends js.Object {
  ...
  @JSName("equals")
  var equals_FBaseAttribute: js.UndefOr[AttributeValidation[_]] = js.undefined
