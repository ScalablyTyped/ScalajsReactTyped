...
/* Inlined waterline.waterline.BaseAttribute<std.Date> & {  type  :'date'} */
trait DateAttribute extends _Attribute {
  ...
  var defaultsTo: js.UndefOr[js.Date | DefaultsToFn[js.Date]] = js.undefined
  ...
  var enum: js.UndefOr[js.Array[js.Date]] = js.undefined
  @JSName("equals")
  var equals_FDateAttribute: js.UndefOr[AttributeValidation[_]] = js.undefined
  ...
  var `type`: js.UndefOr[String with date] = js.undefined
