...
import typingsJapgolly.webStreamsPolyfill.anon.HighWaterMark
import typingsJapgolly.webStreamsPolyfill.anon.Mode
import typingsJapgolly.webStreamsPolyfill.anon.Readable
