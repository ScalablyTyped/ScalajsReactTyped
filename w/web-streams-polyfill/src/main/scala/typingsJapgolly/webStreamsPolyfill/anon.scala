...
import typingsJapgolly.webStreamsPolyfill.mod.ReadableStreamBYOBReadResult
import typingsJapgolly.webStreamsPolyfill.mod.ReadableStreamDefaultReadResult
import typingsJapgolly.webStreamsPolyfill.mod.WritableStream
import typingsJapgolly.webStreamsPolyfill.webStreamsPolyfillBooleans.`false`
import typingsJapgolly.webStreamsPolyfill.webStreamsPolyfillBooleans.`true`
import typingsJapgolly.webStreamsPolyfill.webStreamsPolyfillStrings.byob
