...
object errors extends js.Object {
  ...
  def RevertInstructionError(reason: String, signature: String): typingsJapgolly.web3CoreHelpers.mod.RevertInstructionError = js.native
  def TransactionError(message: String, receipt: js.Object): typingsJapgolly.web3CoreHelpers.mod.TransactionError = js.native
  def TransactionOutOfGasError(receipt: js.Object): TransactionError = js.native
  def TransactionRevertInstructionError(reason: String, signature: String, receipt: js.Object): typingsJapgolly.web3CoreHelpers.mod.TransactionRevertInstructionError = js.native
