...
object errors {
  ...
  inline def ConnectionError(msg: String): typingsJapgolly.web3CoreHelpers.mod.ConnectionError = ^.asInstanceOf[js.Dynamic].applyDynamic("ConnectionError")(msg.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.web3CoreHelpers.mod.ConnectionError]
  inline def ConnectionError(msg: String, event: WebSocketEvent): typingsJapgolly.web3CoreHelpers.mod.ConnectionError = (^.asInstanceOf[js.Dynamic].applyDynamic("ConnectionError")(msg.asInstanceOf[js.Any], event.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.web3CoreHelpers.mod.ConnectionError]
  ...
  inline def RevertInstructionError(reason: String, signature: String): typingsJapgolly.web3CoreHelpers.mod.RevertInstructionError = (^.asInstanceOf[js.Dynamic].applyDynamic("RevertInstructionError")(reason.asInstanceOf[js.Any], signature.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.web3CoreHelpers.mod.RevertInstructionError]
  
  inline def TransactionError(message: String, receipt: js.Object): typingsJapgolly.web3CoreHelpers.mod.TransactionError = (^.asInstanceOf[js.Dynamic].applyDynamic("TransactionError")(message.asInstanceOf[js.Any], receipt.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.web3CoreHelpers.mod.TransactionError]
  ...
  inline def TransactionRevertInstructionError(reason: String, signature: String, receipt: js.Object): typingsJapgolly.web3CoreHelpers.mod.TransactionRevertInstructionError = (^.asInstanceOf[js.Dynamic].applyDynamic("TransactionRevertInstructionError")(reason.asInstanceOf[js.Any], signature.asInstanceOf[js.Any], receipt.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.web3CoreHelpers.mod.TransactionRevertInstructionError]
