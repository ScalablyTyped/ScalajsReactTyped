...
object global {
  ...
  open class FederatedCredential protected ()
    extends StObject
       with typingsJapgolly.webappsecCredentialManagement.FederatedCredential {
  ...
  open class PasswordCredential protected ()
    extends StObject
       with typingsJapgolly.webappsecCredentialManagement.PasswordCredential {
    ...
    /* CompleteClass */
    @JSName("type")
    override val type_PasswordCredential: typingsJapgolly.webappsecCredentialManagement.webappsecCredentialManagementStrings.password = js.native
  }
  ...
  open class SiteBoundCredential ()
    extends StObject
       with typingsJapgolly.webappsecCredentialManagement.SiteBoundCredential {
