...
import typingsJapgolly.winstonDailyRotateFile.winstonDailyRotateFileStrings.filename
import typingsJapgolly.winstonDailyRotateFile.winstonDailyRotateFileStrings.stream
  ...
  object winstonLibWinstonTransportsAugmentingMod {
    ...
    trait Transports extends StObject {
      ...
      var DailyRotateFile: Instantiable1[
            ...
            typingsJapgolly.winstonDailyRotateFile.mod.DailyRotateFile
          ]
      
      var DailyRotateFileTransportOptions: typingsJapgolly.winstonDailyRotateFile.mod.DailyRotateFileTransportOptions
    }
    object Transports {
