package typingsJapgolly.webpackLivereloadPlugin
...
object mod {
  ...
  object LiveReloadPlugin {
    ...
    inline def apply(
      ...
      applyCompilation: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify webpack.compilation.Compilation */ Any => Callback,
      autoloadJs: CallbackTo[String],
      done: Stats => Callback,
      failed: Callback,
      isRunning: Boolean,
      scriptTag: String => String,
      start: (Any, js.Function0[Unit]) => Callback
    ): LiveReloadPlugin = {
      val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1((t0: Compiler) => apply(t0).runNow()), applyCompilation = js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify webpack.compilation.Compilation */ Any) => applyCompilation(t0).runNow()), autoloadJs = autoloadJs.toJsFn, done = js.Any.fromFunction1((t0: Stats) => done(t0).runNow()), failed = failed.toJsFn, isRunning = isRunning.asInstanceOf[js.Any], scriptTag = js.Any.fromFunction1(scriptTag), start = js.Any.fromFunction2((t0: Any, t1: js.Function0[Unit]) => (start(t0, t1)).runNow()))
    ...
    extension [Self <: LiveReloadPlugin](x: Self) {
      ...
      inline def setApplyCompilation(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify webpack.compilation.Compilation */ Any => Callback
      ): Self = StObject.set(x, "applyCompilation", js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify webpack.compilation.Compilation */ Any) => value(t0).runNow()))
      
      inline def setAutoloadJs(value: CallbackTo[String]): Self = StObject.set(x, "autoloadJs", value.toJsFn)
      
      inline def setDone(value: Stats => Callback): Self = StObject.set(x, "done", js.Any.fromFunction1((t0: Stats) => value(t0).runNow()))
      ...
      inline def setStart(value: (Any, js.Function0[Unit]) => Callback): Self = StObject.set(x, "start", js.Any.fromFunction2((t0: Any, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
    }
  }
