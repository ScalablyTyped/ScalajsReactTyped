...
object buildTypesCreateI18nMod {
  ...
  type Hooks = typingsJapgolly.wordpressHooks.mod.Hooks
  ...
  object I18n {
    ...
    inline def apply(
      ...
      addLocaleData: (/* data */ js.UndefOr[LocaleData], /* domain */ js.UndefOr[String]) => Callback,
      ...
      resetLocaleData: (/* data */ js.UndefOr[LocaleData], /* domain */ js.UndefOr[String]) => Callback,
      setLocaleData: (/* data */ js.UndefOr[LocaleData], /* domain */ js.UndefOr[String]) => Callback,
      subscribe: /* callback */ SubscribeCallback => UnsubscribeCallback
    ): I18n = {
      val __obj = js.Dynamic.literal(__ = js.Any.fromFunction2(__), _n = js.Any.fromFunction4(_n), _nx = js.Any.fromFunction5(_nx), _x = js.Any.fromFunction3(_x), addLocaleData = js.Any.fromFunction2((t0: /* data */ js.UndefOr[LocaleData], t1: /* domain */ js.UndefOr[String]) => (addLocaleData(t0, t1)).runNow()), getLocaleData = js.Any.fromFunction1(getLocaleData), hasTranslation = js.Any.fromFunction3(hasTranslation), isRTL = isRTL.toJsFn, resetLocaleData = js.Any.fromFunction2((t0: /* data */ js.UndefOr[LocaleData], t1: /* domain */ js.UndefOr[String]) => (resetLocaleData(t0, t1)).runNow()), setLocaleData = js.Any.fromFunction2((t0: /* data */ js.UndefOr[LocaleData], t1: /* domain */ js.UndefOr[String]) => (setLocaleData(t0, t1)).runNow()), subscribe = js.Any.fromFunction1(subscribe))
      __obj.asInstanceOf[I18n]
    }
    
    extension [Self <: I18n](x: Self) {
      
      inline def setAddLocaleData(value: (/* data */ js.UndefOr[LocaleData], /* domain */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "addLocaleData", js.Any.fromFunction2((t0: /* data */ js.UndefOr[LocaleData], t1: /* domain */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
      ...
      inline def setResetLocaleData(value: (/* data */ js.UndefOr[LocaleData], /* domain */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "resetLocaleData", js.Any.fromFunction2((t0: /* data */ js.UndefOr[LocaleData], t1: /* domain */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
      
      inline def setSetLocaleData(value: (/* data */ js.UndefOr[LocaleData], /* domain */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "setLocaleData", js.Any.fromFunction2((t0: /* data */ js.UndefOr[LocaleData], t1: /* domain */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
