...
object mod {
  ...
  inline def babel(options: typingsJapgolly.webpackBlocksBabel.mod.babel): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("babel")(options.asInstanceOf[js.Any]).asInstanceOf[Any]
  ...
  inline def postcss(options: typingsJapgolly.webpackBlocksPostcss.mod.Options): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("postcss")(options.asInstanceOf[js.Any]).asInstanceOf[Any]
  ...
  inline def sass(options: typingsJapgolly.webpackBlocksSass.mod.Options): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("sass")(options.asInstanceOf[js.Any]).asInstanceOf[Any]
  ...
  inline def typescript(options: typingsJapgolly.webpackBlocksTypescript.mod.Options): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("typescript")(options.asInstanceOf[js.Any]).asInstanceOf[Any]
  
  inline def uglify(): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("uglify")().asInstanceOf[Any]
  inline def uglify(options: typingsJapgolly.webpackBlocksUglify.mod.Options): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("uglify")(options.asInstanceOf[js.Any]).asInstanceOf[Any]
