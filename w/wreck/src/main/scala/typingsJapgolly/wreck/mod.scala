...
import typingsJapgolly.wreck.anon.Http
import typingsJapgolly.wreck.anon.PromiseIncomingMessagereq
import typingsJapgolly.wreck.anon.Req
import typingsJapgolly.wreck.anon.RequestOptionspayloadanyu
import typingsJapgolly.wreck.wreckBooleans.`false`
import typingsJapgolly.wreck.wreckBooleans.`true`
import typingsJapgolly.wreck.wreckStrings.force
import typingsJapgolly.wreck.wreckStrings.request
import typingsJapgolly.wreck.wreckStrings.response
import typingsJapgolly.wreck.wreckStrings.strict
...
object mod extends Shortcut {
  ...
  type ResponseCallback = js.Function2[/* err */ js.UndefOr[typingsJapgolly.boom.mod.^[Any]], /* details */ Req, Unit]
