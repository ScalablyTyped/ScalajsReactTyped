package typingsJapgolly.wicgEntriesApi

import japgolly.scalajs.react.CallbackTo
import org.scalajs.dom.DOMException
import typingsJapgolly.wicgEntriesApi.mod.global.File
import typingsJapgolly.wicgEntriesApi.mod.global.FileSystemEntry
...
object mod {
  ...
  object global {
    ...
    object DataTransferItem {
      ...
      inline def apply(webkitGetAsEntry: CallbackTo[FileSystemEntry | Null]): DataTransferItem = {
        val __obj = js.Dynamic.literal(webkitGetAsEntry = webkitGetAsEntry.toJsFn)
        __obj.asInstanceOf[DataTransferItem]
      }
      
      extension [Self <: DataTransferItem](x: Self) {
        
        inline def setWebkitGetAsEntry(value: CallbackTo[FileSystemEntry | Null]): Self = StObject.set(x, "webkitGetAsEntry", value.toJsFn)
      }
    }
