...
import typingsJapgolly.webpackBlocksDevServer.anon.Errors
import typingsJapgolly.webpackBlocksDevServer.webpackBlocksDevServerBooleans.`false`
...
object mod {
  ...
  trait Options extends StObject {
    ...
    var mimeTypes: js.UndefOr[typingsJapgolly.webpackBlocksDevServer.anon.String] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setAfter(value: (/* app */ Any, /* server */ Any) => Callback): Self = StObject.set(x, "after", js.Any.fromFunction2((t0: /* app */ Any, t1: /* server */ Any) => (value(t0, t1)).runNow()))
      ...
      inline def setBefore(value: (/* app */ Any, /* server */ Any) => Callback): Self = StObject.set(x, "before", js.Any.fromFunction2((t0: /* app */ Any, t1: /* server */ Any) => (value(t0, t1)).runNow()))
      ...
      inline def setMimeTypes(value: typingsJapgolly.webpackBlocksDevServer.anon.String): Self = StObject.set(x, "mimeTypes", value.asInstanceOf[js.Any])
      ...
      inline def setStaticOptions(value: (/* res */ js.Object, /* path */ String, /* stat */ js.Object) => Callback): Self = StObject.set(x, "staticOptions", js.Any.fromFunction3((t0: /* res */ js.Object, t1: /* path */ String, t2: /* stat */ js.Object) => (value(t0, t1, t2)).runNow()))
  ...
  object TransportMode {
    ...
    extension [Self <: TransportMode](x: Self) {
      ...
      inline def setClientCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "client", value.toJsFn)
      
      inline def setClientUndefined: Self = StObject.set(x, "client", js.undefined)
      
      inline def setServer(value: String | PathFunction): Self = StObject.set(x, "server", value.asInstanceOf[js.Any])
      
      inline def setServerCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "server", value.toJsFn)
