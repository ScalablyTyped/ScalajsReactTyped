...
package object mod {
  ...
  type ProxyFunction = js.Function3[
    ...
    /* proxy */ js.Any, 
    js.UndefOr[
      scala.Null | typingsJapgolly.webpackBlocksDevServer.webpackBlocksDevServerBooleans.`false` | java.lang.String
    ]
  ]
  type ProxyType = js.Object | typingsJapgolly.webpackBlocksDevServer.mod.ProxyFunction
  type RewritesToFunction = js.Function1[
    /* context */ typingsJapgolly.webpackBlocksDevServer.mod.ContextObject, 
    java.lang.String
  ]
