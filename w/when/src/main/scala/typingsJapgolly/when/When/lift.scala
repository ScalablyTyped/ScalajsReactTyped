...
import typingsJapgolly.when.When._underscore.LiftedFn0
import typingsJapgolly.when.When._underscore.LiftedFn1
import typingsJapgolly.when.When._underscore.LiftedFn2
import typingsJapgolly.when.When._underscore.LiftedFn3
import typingsJapgolly.when.When._underscore.LiftedFn4
import typingsJapgolly.when.When._underscore.LiftedFn5
