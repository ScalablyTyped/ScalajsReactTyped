...
open class DoObserver protected ()
  extends typingsJapgolly.wonderFrp.distEs2015ObserverDoObserverMod.DoObserver {
...
object DoObserver {
  ...
  inline def create(currentObserver: IObserver, prevObserver: IObserver): typingsJapgolly.wonderFrp.distEs2015ObserverDoObserverMod.DoObserver = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(currentObserver.asInstanceOf[js.Any], prevObserver.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.wonderFrp.distEs2015ObserverDoObserverMod.DoObserver]
}
