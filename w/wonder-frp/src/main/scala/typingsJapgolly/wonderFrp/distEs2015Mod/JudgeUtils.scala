...
open class JudgeUtils ()
  extends typingsJapgolly.wonderFrp.distEs2015JudgeUtilsMod.JudgeUtils
/* static members */
object JudgeUtils {
  ...
  inline def isEqual(
    ob1: typingsJapgolly.wonderFrp.distEs2015CoreEntityMod.Entity,
    ob2: typingsJapgolly.wonderFrp.distEs2015CoreEntityMod.Entity
