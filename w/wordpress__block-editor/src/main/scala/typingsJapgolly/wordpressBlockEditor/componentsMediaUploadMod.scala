  ...
  object MediaUpload {
    ...
    object Props {
      ...
      inline def apply[T /* <: Boolean */](
        ...
        val __obj = js.Dynamic.literal(onSelect = js.Any.fromFunction1((t0: /* import warning: importer.ImportType#apply Failed type conversion: T extends true ? std.Array<{  id :number, [k: string] : any}> : {  id :number, [k: string] : any} */ /* value */ js.Any) => onSelect(t0).runNow()), render = js.Any.fromFunction1(render))
      ...
      extension [Self <: Props[?], T /* <: Boolean */](x: Self & Props[T]) {
        ...
        inline def setOnSelect(
          value: /* import warning: importer.ImportType#apply Failed type conversion: T extends true ? std.Array<{  id :number, [k: string] : any}> : {  id :number, [k: string] : any} */ /* value */ js.Any => Callback
        ): Self = StObject.set(x, "onSelect", js.Any.fromFunction1((t0: /* import warning: importer.ImportType#apply Failed type conversion: T extends true ? std.Array<{  id :number, [k: string] : any}> : {  id :number, [k: string] : any} */ /* value */ js.Any) => value(t0).runNow()))
