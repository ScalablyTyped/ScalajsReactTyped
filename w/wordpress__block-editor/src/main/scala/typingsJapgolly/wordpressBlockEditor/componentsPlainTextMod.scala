...
object componentsPlainTextMod {
  ...
  object PlainText {
    ...
    object Props {
      ...
      inline def apply(onChange: String => Callback, value: String): Props = {
      ...
      extension [Self <: Props](x: Self) {
        ...
        inline def setRefFunction1(value: TypeofTextareaAutosize | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: TypeofTextareaAutosize | Null) => value(t0).runNow()))
