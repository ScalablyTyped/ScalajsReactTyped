  ...
  object MediaPlaceholder {
    ...
    object Props {
      ...
      inline def apply[T /* <: Boolean */](
        ...
        val __obj = js.Dynamic.literal(onSelect = js.Any.fromFunction1((t0: /* import warning: importer.ImportType#apply Failed type conversion: T extends true ? std.Array<{  id :number, [k: string] : any}> : {  id :number, [k: string] : any} */ js.Any) => onSelect(t0).runNow()))
      ...
      extension [Self <: Props[?], T /* <: Boolean */](x: Self & Props[T]) {
        ...
        inline def setMediaPreview(value: VdomElement): Self = StObject.set(x, "mediaPreview", value.rawElement.asInstanceOf[js.Any])
        ...
        inline def setOnSelect(
          value: /* import warning: importer.ImportType#apply Failed type conversion: T extends true ? std.Array<{  id :number, [k: string] : any}> : {  id :number, [k: string] : any} */ js.Any => Callback
        ): Self = StObject.set(x, "onSelect", js.Any.fromFunction1((t0: /* import warning: importer.ImportType#apply Failed type conversion: T extends true ? std.Array<{  id :number, [k: string] : any}> : {  id :number, [k: string] : any} */ js.Any) => value(t0).runNow()))
        
        inline def setOnSelectURL(value: /* src */ String => Callback): Self = StObject.set(x, "onSelectURL", js.Any.fromFunction1((t0: /* src */ String) => value(t0).runNow()))
