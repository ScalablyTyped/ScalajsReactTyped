...
import typingsJapgolly.wordpressBlockEditor.componentsRichTextMod.RichText.Props
...
object componentsRichTextMod {
  ...
  object RichTextShortcut extends Shortcut {
    ...
    object Props {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(character = character.asInstanceOf[js.Any], onUse = onUse.toJsFn)
        __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.wordpressBlockEditor.componentsRichTextMod.RichTextShortcut.Props]
      }
      
      extension [Self <: typingsJapgolly.wordpressBlockEditor.componentsRichTextMod.RichTextShortcut.Props](x: Self) {
        
        inline def setCharacter(value: String): Self = StObject.set(x, "character", value.asInstanceOf[js.Any])
        
        inline def setOnUse(value: Callback): Self = StObject.set(x, "onUse", value.toJsFn)
  ...
  object RichTextToolbarButton extends Shortcut {
    ...
    trait Props
      extends StObject
         with typingsJapgolly.wordpressComponents.toolbarButtonMod.ToolbarButton.Props {
    ...
    object Props {
      ...
      inline def apply(icon: Icon | Element, title: String): typingsJapgolly.wordpressBlockEditor.componentsRichTextMod.RichTextToolbarButton.Props = {
        val __obj = js.Dynamic.literal(icon = icon.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.wordpressBlockEditor.componentsRichTextMod.RichTextToolbarButton.Props]
      }
      
      extension [Self <: typingsJapgolly.wordpressBlockEditor.componentsRichTextMod.RichTextToolbarButton.Props](x: Self) {
  ...
  object RichText {
    ...
    trait ContentProps[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.a, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.abbr, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.address */ Any */]
      extends StObject
         with HTMLProps[T] {
    ...
    object ContentProps {
      ...
      inline def apply[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.a, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.abbr, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.address */ Any */](value: String): ContentProps[T] = {
        val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
        __obj.asInstanceOf[ContentProps[T]]
      }
      
      extension [Self <: ContentProps[?], T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.a, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.abbr, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.address */ Any */](x: Self & ContentProps[T]) {
    ...
    trait Props[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.a, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.abbr, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.address */ Any */] extends StObject {
      ...
      var multiline: js.UndefOr[
            /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 113, starting with scala.Boolean, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.a, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.abbr */ Any
          ] = js.undefined
      ...
      var onTagNameChange: js.UndefOr[
            js.Function1[
              /* tagName */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.a, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.abbr, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.address */ Any, 
              Unit
            ]
          ] = js.undefined
    ...
    object Props {
      ...
      inline def apply[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.a, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.abbr, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.address */ Any */](onChange: String => Callback, value: String): Props[T] = {
        val __obj = js.Dynamic.literal(onChange = js.Any.fromFunction1((t0: String) => onChange(t0).runNow()), value = value.asInstanceOf[js.Any])
        __obj.asInstanceOf[Props[T]]
      }
      
      extension [Self <: Props[?], T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.a, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.abbr, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.address */ Any */](x: Self & Props[T]) {
        ...
        inline def setMultiline(
          value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 113, starting with scala.Boolean, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.a, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.abbr */ Any
        ...
        inline def setOnMerge(value: /* forward */ Boolean => Callback): Self = StObject.set(x, "onMerge", js.Any.fromFunction1((t0: /* forward */ Boolean) => value(t0).runNow()))
        ...
        inline def setOnRemove(value: /* forward */ Boolean => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction1((t0: /* forward */ Boolean) => value(t0).runNow()))
        
        inline def setOnRemoveUndefined: Self = StObject.set(x, "onRemove", js.undefined)
        
        inline def setOnReplace(value: /* blocks */ js.Array[BlockInstance[StringDictionary[Any]]] => Callback): Self = StObject.set(x, "onReplace", js.Any.fromFunction1((t0: /* blocks */ js.Array[BlockInstance[StringDictionary[Any]]]) => value(t0).runNow()))
        ...
        inline def setOnSplit(value: /* value */ String => Callback): Self = StObject.set(x, "onSplit", js.Any.fromFunction1((t0: /* value */ String) => value(t0).runNow()))
        ...
        inline def setOnTagNameChange(
          value: /* tagName */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.a, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.abbr, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.address */ Any => Callback
        ): Self = StObject.set(x, "onTagNameChange", js.Any.fromFunction1((t0: /* tagName */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.a, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.abbr, typingsJapgolly.wordpressBlockEditor.wordpressBlockEditorStrings.address */ Any) => value(t0).runNow()))
