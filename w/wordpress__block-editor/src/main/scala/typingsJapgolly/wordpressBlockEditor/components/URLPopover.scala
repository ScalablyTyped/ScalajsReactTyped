...
object URLPopover {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def anchorRect(value: DOMRect | ClientRect): this.type = set("anchorRect", value.asInstanceOf[js.Any])
    ...
    inline def getAnchorRect(value: /* currentAnchorElement */ HTMLSpanElement | Null => js.UndefOr[DOMRect | ClientRect]): this.type = set("getAnchorRect", js.Any.fromFunction1(value))
    
    inline def headerTitle(value: String): this.type = set("headerTitle", value.asInstanceOf[js.Any])
    ...
    inline def noArrow(value: Boolean): this.type = set("noArrow", value.asInstanceOf[js.Any])
    ...
    inline def onFocusOutside(value: /* event */ ReactFocusEventFrom[org.scalajs.dom.Element] => Callback): this.type = set("onFocusOutside", js.Any.fromFunction1((t0: /* event */ ReactFocusEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def renderSettings(value: CallbackTo[typingsJapgolly.react.mod.global.JSX.Element]): this.type = set("renderSettings", value.toJsFn)
  ...
  implicit def make(companion: URLPopover.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
