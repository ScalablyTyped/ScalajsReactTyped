...
import typingsJapgolly.webpackEnv.webpackEnvStrings.`accept-errored`
import typingsJapgolly.webpackEnv.webpackEnvStrings.`lazy-once`
import typingsJapgolly.webpackEnv.webpackEnvStrings.`lazy`
import typingsJapgolly.webpackEnv.webpackEnvStrings.`self-accept-error-handler-errored`
import typingsJapgolly.webpackEnv.webpackEnvStrings.`self-accept-errored`
import typingsJapgolly.webpackEnv.webpackEnvStrings.`self-declined`
import typingsJapgolly.webpackEnv.webpackEnvStrings.accepted
import typingsJapgolly.webpackEnv.webpackEnvStrings.declined
import typingsJapgolly.webpackEnv.webpackEnvStrings.disposed
import typingsJapgolly.webpackEnv.webpackEnvStrings.eager
import typingsJapgolly.webpackEnv.webpackEnvStrings.sync
import typingsJapgolly.webpackEnv.webpackEnvStrings.unaccepted
...
object WebpackModuleApi {
  ...
  object AcceptOptions {
    ...
    extension [Self <: AcceptOptions](x: Self) {
      ...
      inline def setOnAccepted(value: /* info */ HotNotifierInfo => Callback): Self = StObject.set(x, "onAccepted", js.Any.fromFunction1((t0: /* info */ HotNotifierInfo) => value(t0).runNow()))
      
      inline def setOnAcceptedUndefined: Self = StObject.set(x, "onAccepted", js.undefined)
      
      inline def setOnDeclined(value: /* info */ HotNotifierInfo => Callback): Self = StObject.set(x, "onDeclined", js.Any.fromFunction1((t0: /* info */ HotNotifierInfo) => value(t0).runNow()))
      
      inline def setOnDeclinedUndefined: Self = StObject.set(x, "onDeclined", js.undefined)
      
      inline def setOnDisposed(value: /* info */ HotNotifierInfo => Callback): Self = StObject.set(x, "onDisposed", js.Any.fromFunction1((t0: /* info */ HotNotifierInfo) => value(t0).runNow()))
      
      inline def setOnDisposedUndefined: Self = StObject.set(x, "onDisposed", js.undefined)
      
      inline def setOnErrored(value: /* info */ HotNotifierInfo => Callback): Self = StObject.set(x, "onErrored", js.Any.fromFunction1((t0: /* info */ HotNotifierInfo) => value(t0).runNow()))
      
      inline def setOnErroredUndefined: Self = StObject.set(x, "onErrored", js.undefined)
      
      inline def setOnUnaccepted(value: /* info */ HotNotifierInfo => Callback): Self = StObject.set(x, "onUnaccepted", js.Any.fromFunction1((t0: /* info */ HotNotifierInfo) => value(t0).runNow()))
  ...
  trait RequireFunction extends StObject {
    ...
    /**
      ...
      */
    @JSName("resolve")
    var resolve_Original: typingsJapgolly.webpackEnv.NodeJS.RequireResolve = js.native
  }
  ...
  - typingsJapgolly.webpackEnv.WebpackModuleApi.Require2 because Already inherited */ @js.native
