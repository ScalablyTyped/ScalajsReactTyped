...
object AcceptOptions {
  ...
  def apply(
    ...
    if (onAccepted != null) __obj.updateDynamic("onAccepted")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.webpackDashEnv.__WebpackModuleApi.HotNotifierInfo) => onAccepted(t0).runNow()))
    if (onDeclined != null) __obj.updateDynamic("onDeclined")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.webpackDashEnv.__WebpackModuleApi.HotNotifierInfo) => onDeclined(t0).runNow()))
    if (onDisposed != null) __obj.updateDynamic("onDisposed")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.webpackDashEnv.__WebpackModuleApi.HotNotifierInfo) => onDisposed(t0).runNow()))
    if (onErrored != null) __obj.updateDynamic("onErrored")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.webpackDashEnv.__WebpackModuleApi.HotNotifierInfo) => onErrored(t0).runNow()))
    if (onUnaccepted != null) __obj.updateDynamic("onUnaccepted")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.webpackDashEnv.__WebpackModuleApi.HotNotifierInfo) => onUnaccepted(t0).runNow()))
