...
import typingsJapgolly.wixStyleReact.anon.LastOptionsShow
...
object distTypesInputWithOptionsInputWithOptionsMod {
  ...
  trait InputWithOptions extends Component[Any, Any, Any] {
    ...
    var dropdownLayout: js.UndefOr[
        typingsJapgolly.wixStyleReact.distTypesDropdownLayoutDropdownLayoutMod.default | Null
      ] = js.native
    ...
    var input: RefHandle[Any] = js.native
