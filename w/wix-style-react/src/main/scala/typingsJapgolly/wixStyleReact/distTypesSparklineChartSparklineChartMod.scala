...
import typingsJapgolly.wixStyleReact.anon.AreaGenerator
import typingsJapgolly.wixStyleReact.anon.HoveredLabel
import typingsJapgolly.wixStyleReact.anon.LabelRequireable
...
object distTypesSparklineChartSparklineChartMod {
  ...
  trait SparklineChart extends PureComponent[Any, Any, Any] {
    ...
    var svgRef: RefHandle[Any] = js.native
  }
}
