...
import typingsJapgolly.wixStyleReact.distTypesProvidersUsePlacesAutocompleteAutocompleteClientMod.AutocompleteClient
...
object distTypesProvidersUsePlacesAutocompleteMod {
  ...
  object UsePlacesAutocompleteReturn {
    ...
    inline def apply[Prediction, RequestOptions](
      clearPredictions: Callback,
      loading: Boolean,
      predictions: js.Array[Prediction],
      updatePredictions: (/* value */ String, /* requestOptions */ js.UndefOr[RequestOptions]) => Callback
    ): UsePlacesAutocompleteReturn[Prediction, RequestOptions] = {
      val __obj = js.Dynamic.literal(clearPredictions = clearPredictions.toJsFn, loading = loading.asInstanceOf[js.Any], predictions = predictions.asInstanceOf[js.Any], updatePredictions = js.Any.fromFunction2((t0: /* value */ String, t1: /* requestOptions */ js.UndefOr[RequestOptions]) => (updatePredictions(t0, t1)).runNow()))
    ...
    extension [Self <: UsePlacesAutocompleteReturn[?, ?], Prediction, RequestOptions](x: Self & (UsePlacesAutocompleteReturn[Prediction, RequestOptions])) {
      ...
      inline def setClearPredictions(value: Callback): Self = StObject.set(x, "clearPredictions", value.toJsFn)
      ...
      inline def setUpdatePredictions(value: (/* value */ String, /* requestOptions */ js.UndefOr[RequestOptions]) => Callback): Self = StObject.set(x, "updatePredictions", js.Any.fromFunction2((t0: /* value */ String, t1: /* requestOptions */ js.UndefOr[RequestOptions]) => (value(t0, t1)).runNow()))
    }
  }
}
