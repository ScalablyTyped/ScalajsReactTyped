...
import typingsJapgolly.wixStyleReact.anon.BulkSelectionContext
import typingsJapgolly.wixStyleReact.anon.CallDefaultProps
import typingsJapgolly.wixStyleReact.anon.CallDisplayName
import typingsJapgolly.wixStyleReact.anon.DataHookAny
import typingsJapgolly.wixStyleReact.anon.DefaultProps
import typingsJapgolly.wixStyleReact.anon.DisplayName
import typingsJapgolly.wixStyleReact.anon.InfoTooltipProps
import typingsJapgolly.wixStyleReact.anon.LeftShadowVisible
import typingsJapgolly.wixStyleReact.anon.PropTypes
import typingsJapgolly.wixStyleReact.distTypesTableBulkSelectionBulkSelectionMod.BulkSelection
...
object distTypesTableTableMod {
  ...
  open class Table protected () extends Component[Any, Any, Any] {
    ...
    def renderChildren(): Node = js.native
  ...
  object Table {
    ...
    inline def BulkSelectionCheckbox(hasDataHookChildren: DataHookAny): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("BulkSelectionCheckbox")(hasDataHookChildren.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  inline def createColumns(hasTablePropsBulkSelectionContext: BulkSelectionContext): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("createColumns")(hasTablePropsBulkSelectionContext.asInstanceOf[js.Any]).asInstanceOf[Any]
