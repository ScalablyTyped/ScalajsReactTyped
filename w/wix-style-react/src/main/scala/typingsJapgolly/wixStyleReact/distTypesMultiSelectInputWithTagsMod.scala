...
import typingsJapgolly.wixStyleReact.anon.InputHasFocus
import typingsJapgolly.wixStyleReact.anon.IsPlaceholder
...
object distTypesMultiSelectInputWithTagsMod {
  ...
  trait InputWithTags extends Component[Any, Any, Any] {
    ...
    def renderReorderableTag(hasHasIdLabelItemPropsPreviewStylesIsPlaceholderIsPreviewRest: IsPlaceholder): Element = js.native
