...
object distTypesUtilsAdaptiveHeadingMod {
  
  /** AdaptiveHeading */
  @JSImport("wix-style-react/dist/types/utils/AdaptiveHeading", JSImport.Default)
  @js.native
  open class default protected ()
    extends typingsJapgolly.wixStyleReact.distTypesUtilsAdaptiveHeadingAdaptiveHeadingMod.default {
  ...
  object default {
    ...
    /* static member */
    @JSImport("wix-style-react/dist/types/utils/AdaptiveHeading", "default.displayName")
    @js.native
    ...
    object propTypes {
      ...
      @JSImport("wix-style-react/dist/types/utils/AdaptiveHeading", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      /** H1-H6 to create a Heading component, or "tiny" for a bold Text component  */
      @JSImport("wix-style-react/dist/types/utils/AdaptiveHeading", "default.propTypes.appearance")
      @js.native
      ...
      @JSImport("wix-style-react/dist/types/utils/AdaptiveHeading", "default.propTypes.dataHook")
      @js.native
      def dataHook: Requireable[String] = js.native
      inline def dataHook_=(x: Requireable[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("dataHook")(x.asInstanceOf[js.Any])
      
      /** Render empty content when there is not enough space for short text */
      @JSImport("wix-style-react/dist/types/utils/AdaptiveHeading", "default.propTypes.emptyLast")
      @js.native
      ...
      /** Use light theme */
      @JSImport("wix-style-react/dist/types/utils/AdaptiveHeading", "default.propTypes.light")
      @js.native
      ...
      @JSImport("wix-style-react/dist/types/utils/AdaptiveHeading", "default.propTypes.text")
      @js.native
      def text: Validator[String] = js.native
      
      /** Short version text */
      @JSImport("wix-style-react/dist/types/utils/AdaptiveHeading", "default.propTypes.textInShort")
      @js.native
