...
import typingsJapgolly.wixStyleReact.anon.DeselectAll
...
object distTypesSelectorListToggleAllCheckboxToggleAllCheckboxMod {
  ...
  object default {
    ...
    inline def apply(
      hasSelectAllTextDeselectAllTextEnabledItemsAmountSelectedEnabledItemsAmountSelectAllDeselectAllDataHook: DeselectAll
    ): Element = ^.asInstanceOf[js.Dynamic].apply(hasSelectAllTextDeselectAllTextEnabledItemsAmountSelectedEnabledItemsAmountSelectAllDeselectAllDataHook.asInstanceOf[js.Any]).asInstanceOf[Element]
