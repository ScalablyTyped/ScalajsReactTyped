...
object distTypesClientsGoogleMapsClientMod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    override def autocomplete(hasRequest: Request): js.Promise[Any] = js.native
    
    /* CompleteClass */
    override def geocode(hasRequest: Request): js.Promise[Any] = js.native
    
    /* CompleteClass */
    override def placeDetails(hasRequest: Request): js.Promise[Any] = js.native
  }
  ...
  trait GoogleMapsClient extends StObject {
    ...
    def autocomplete(hasRequest: Request): js.Promise[Any]
    
    def geocode(hasRequest: Request): js.Promise[Any]
    
    def placeDetails(hasRequest: Request): js.Promise[Any]
  }
