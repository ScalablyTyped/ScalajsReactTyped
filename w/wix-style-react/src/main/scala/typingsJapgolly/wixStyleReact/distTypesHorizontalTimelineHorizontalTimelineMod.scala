...
import typingsJapgolly.wixStyleReact.anon.IconLabel
import typingsJapgolly.wixStyleReact.anon.LabelEllipsis
import typingsJapgolly.wixStyleReact.anon.Line
import typingsJapgolly.wixStyleReact.anon.`8`
...
object distTypesHorizontalTimelineHorizontalTimelineMod {
  ...
  object default {
    ...
    @js.native
    def ActiveIcon: js.Function1[/* hasSkin */ `8`, Element] = js.native
    inline def ActiveIcon_=(x: js.Function1[/* hasSkin */ `8`, Element]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ActiveIcon")(x.asInstanceOf[js.Any])
    
    /* static member */
    @JSImport("wix-style-react/dist/types/HorizontalTimeline/HorizontalTimeline", "default.BoundaryIcon")
    @js.native
    def BoundaryIcon: js.Function1[/* hasSkin */ `8`, Element] = js.native
    inline def BoundaryIcon_=(x: js.Function1[/* hasSkin */ `8`, Element]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BoundaryIcon")(x.asInstanceOf[js.Any])
    
    /* static member */
    @JSImport("wix-style-react/dist/types/HorizontalTimeline/HorizontalTimeline", "default.CompleteIcon")
    @js.native
    def CompleteIcon: js.Function1[/* hasSkin */ `8`, Element] = js.native
    inline def CompleteIcon_=(x: js.Function1[/* hasSkin */ `8`, Element]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CompleteIcon")(x.asInstanceOf[js.Any])
    
    /* static member */
    @JSImport("wix-style-react/dist/types/HorizontalTimeline/HorizontalTimeline", "default.DefaultIcon")
    @js.native
    def DefaultIcon: js.Function1[/* hasSkin */ `8`, Element] = js.native
    inline def DefaultIcon_=(x: js.Function1[/* hasSkin */ `8`, Element]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DefaultIcon")(x.asInstanceOf[js.Any])
  ...
  trait HorizontalTimeline extends PureComponent[Any, Any, Any] {
    ...
    def _renderLabel(hasLabelIndexLabelEllipsis: LabelEllipsis): Element = js.native
    
    def _renderLine(hasSkinLine: Line): Element = js.native
  }
}
