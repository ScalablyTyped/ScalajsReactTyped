...
object distTypesTimeTableTimeTableDotuniDotdriverMod {
  ...
  object TimeTableUniDriver {
    ...
    inline def apply(
      ...
      getColumnCount: CallbackTo[js.Promise[Double]],
    ...
    extension [Self <: TimeTableUniDriver](x: Self) {
      ...
      inline def setGetColumnCount(value: CallbackTo[js.Promise[Double]]): Self = StObject.set(x, "getColumnCount", value.toJsFn)
