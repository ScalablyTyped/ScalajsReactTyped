...
import typingsJapgolly.wixStyleReact.anon.FromRequireable
  ...
  object default {
    ...
    object propTypes {
      ...
      def locale: Requireable[
            /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 55, starting with typingsJapgolly.wixStyleReact.wixStyleReactStrings.th, typingsJapgolly.wixStyleReact.wixStyleReactStrings.tr, typingsJapgolly.wixStyleReact.wixStyleReactStrings.id */ Any
          ] = js.native
      inline def locale_=(
        x: Requireable[
              /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 55, starting with typingsJapgolly.wixStyleReact.wixStyleReactStrings.th, typingsJapgolly.wixStyleReact.wixStyleReactStrings.tr, typingsJapgolly.wixStyleReact.wixStyleReactStrings.id */ Any
