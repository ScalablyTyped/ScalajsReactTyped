...
import typingsJapgolly.wixStyleReact.anon.InitiallyOpen
import typingsJapgolly.wixStyleReact.anon.ItemsAny
import typingsJapgolly.wixStyleReact.anon.OpenIndices
...
object distTypesSelectableAccordionSelectableAccordionMod {
  ...
  object default {
    ...
    /* static member */
    inline def getDerivedStateFromProps(hasItems: ItemsAny, state: Any): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("getDerivedStateFromProps")(hasItems.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Any]
