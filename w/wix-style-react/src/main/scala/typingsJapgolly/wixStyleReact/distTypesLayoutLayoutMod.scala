...
object distTypesLayoutLayoutMod {
  ...
  object default {
    ...
    inline def apply(hasChildrenGapColsJustifyItemsAlignItemsRowHeightDataHookClassName: AlignItems): Element = ^.asInstanceOf[js.Dynamic].apply(hasChildrenGapColsJustifyItemsAlignItemsRowHeightDataHookClassName.asInstanceOf[js.Any]).asInstanceOf[Element]
