...
object distTypesMultiSelectCheckboxMod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.wixStyleReact.distTypesInputWithOptionsMod.default[ManualInputFnSignature, MultiSelectOnSelectFnSignature, MultiSelectCheckboxProps]
  
  type MultiSelectCheckbox = typingsJapgolly.wixStyleReact.distTypesInputWithOptionsMod.default[ManualInputFnSignature, MultiSelectOnSelectFnSignature, MultiSelectCheckboxProps]
  ...
  object MultiSelectCheckboxProps {
    ...
    extension [Self <: MultiSelectCheckboxProps](x: Self) {
      ...
      inline def setOnDeselect(value: (/* id */ String | Double, /* option */ DropdownLayoutValueOption) => Callback): Self = StObject.set(x, "onDeselect", js.Any.fromFunction2((t0: /* id */ String | Double, t1: /* option */ DropdownLayoutValueOption) => (value(t0, t1)).runNow()))
      ...
      inline def setOnSelect(value: (/* id */ String | Double, /* option */ DropdownLayoutValueOption) => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction2((t0: /* id */ String | Double, t1: /* option */ DropdownLayoutValueOption) => (value(t0, t1)).runNow()))
