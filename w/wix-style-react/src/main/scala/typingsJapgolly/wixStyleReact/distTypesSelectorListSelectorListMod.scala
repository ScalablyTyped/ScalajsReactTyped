...
import typingsJapgolly.wixStyleReact.anon.DataSource
import typingsJapgolly.wixStyleReact.anon.ImageShape
import typingsJapgolly.wixStyleReact.anon.IsEmpty
import typingsJapgolly.wixStyleReact.anon.SearchValue
...
object distTypesSelectorListSelectorListMod {
  ...
  trait SelectorList extends PureComponent[Any, Any, Any] {
    ...
    def _updateItems(hasNextPageItemsTotalCountSearchValue: SearchValue): Unit = js.native
