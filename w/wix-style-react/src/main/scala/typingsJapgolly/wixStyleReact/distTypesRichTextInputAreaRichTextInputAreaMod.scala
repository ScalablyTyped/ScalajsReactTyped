...
import typingsJapgolly.wixStyleReact.anon.EditorState
import typingsJapgolly.wixStyleReact.anon.ToolbarButtons
...
object distTypesRichTextInputAreaRichTextInputAreaMod {
  ...
  trait RichTextInputArea extends PureComponent[Any, Any, Any] {
    ...
    var editorRef: js.UndefOr[RefHandle[Any]] = js.native
