...
import typingsJapgolly.wixStyleReact.anon.AddItemLabel
import typingsJapgolly.wixStyleReact.anon.Backup
import typingsJapgolly.wixStyleReact.anon.IsLastChild
...
object distTypesNestableListNestableListMod {
  ...
  trait NestableList extends PureComponent[Any, Any, Any] {
    ...
    def _renderArrow(hasIsLastChildIsPreviewIsPlaceholder: IsLastChild): Element = js.native
