...
object distTypesSparklineChartMod {
  ...
  trait SparklineChartProps extends StObject {
    ...
    var getTooltipContent: js.UndefOr[js.Function1[/* index */ Double, Node]] = js.undefined
  ...
  object SparklineChartProps {
    ...
    extension [Self <: SparklineChartProps](x: Self) {
      ...
      inline def setGetTooltipContent(value: /* index */ Double => Node): Self = StObject.set(x, "getTooltipContent", js.Any.fromFunction1(value))
      ...
      inline def setOnHover(value: /* index */ Double => Callback): Self = StObject.set(x, "onHover", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
