...
object distTypesNestableListMod {
  ...
  trait Action extends StObject {
    ...
    var prefixIcon: js.UndefOr[Node] = js.native
  }
  ...
  object NestableListProps {
    ...
    extension [Self <: NestableListProps](x: Self) {
      ...
      inline def setOnAddItem(value: /* item */ NestableListItem => Callback): Self = StObject.set(x, "onAddItem", js.Any.fromFunction1((t0: /* item */ NestableListItem) => value(t0).runNow()))
      
      inline def setOnAddItemUndefined: Self = StObject.set(x, "onAddItem", js.undefined)
      
      inline def setOnChange(value: /* data */ ItemItems => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* data */ ItemItems) => value(t0).runNow()))
