...
object distTypesDatePickerDateInputMod {
  ...
  trait DateInputProps extends StObject {
    ...
    var onValidate: js.UndefOr[js.Function1[/* hasFormatValidationTypeValue */ Format, Unit]] = js.undefined
  ...
  object DateInputProps {
    ...
    extension [Self <: DateInputProps](x: Self) {
      ...
      inline def setOnValidate(value: /* hasFormatValidationTypeValue */ Format => Callback): Self = StObject.set(x, "onValidate", js.Any.fromFunction1((t0: /* hasFormatValidationTypeValue */ Format) => value(t0).runNow()))
