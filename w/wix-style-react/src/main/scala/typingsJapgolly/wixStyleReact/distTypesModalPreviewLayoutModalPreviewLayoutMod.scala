...
import typingsJapgolly.wixStyleReact.anon.ChildIndexDisplayed
import typingsJapgolly.wixStyleReact.anon.TargetIdAny
import typingsJapgolly.wixStyleReact.anon.TooltipText
...
object distTypesModalPreviewLayoutModalPreviewLayoutMod {
  ...
  trait ModalPreviewLayout extends PureComponent[Any, Any, Any] {
    ...
    def _onOverlayClick(onClose: Any): js.Function1[/* hasHasId */ TargetIdAny, Unit] = js.native
