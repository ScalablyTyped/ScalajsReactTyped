...
import typingsJapgolly.wixStyleReact.anon.DescriptionMaxLines
...
object distTypesGooglePreviewGooglePreviewMod {
  ...
  object default {
    ...
    /**
      ...
      */
    inline def apply(hasDataHookPreviewUrlTitleDescriptionTitleMaxLinesDescriptionMaxLinesSkin: DescriptionMaxLines): Element = ^.asInstanceOf[js.Dynamic].apply(hasDataHookPreviewUrlTitleDescriptionTitleMaxLinesDescriptionMaxLinesSkin.asInstanceOf[js.Any]).asInstanceOf[Element]
