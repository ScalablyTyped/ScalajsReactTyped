...
object distTypesCircularProgressBarCircularProgressBarCoreArcMod {
  
  @JSImport("wix-style-react/dist/types/CircularProgressBar/CircularProgressBarCore/Arc", "Arc")
  @js.native
