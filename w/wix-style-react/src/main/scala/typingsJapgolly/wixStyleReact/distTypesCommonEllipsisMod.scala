...
object distTypesCommonEllipsisMod {
  ...
  inline def extractEllipsisProps[T](props: T & EllipsisCommonProps): typingsJapgolly.wixStyleReact.anon.EllipsisProps[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("extractEllipsisProps")(props.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.wixStyleReact.anon.EllipsisProps[T]]
  ...
  trait IEllipsisProps
    ...
    def render[T](renderProps: RenderProps[T]): japgolly.scalajs.react.facade.React.Element
  }
  object IEllipsisProps {
    
    inline def apply(render: RenderProps[Any] => japgolly.scalajs.react.facade.React.Element): IEllipsisProps = {
    ...
    extension [Self <: IEllipsisProps](x: Self) {
      ...
      inline def setRender(value: RenderProps[Any] => japgolly.scalajs.react.facade.React.Element): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
    }
  }
