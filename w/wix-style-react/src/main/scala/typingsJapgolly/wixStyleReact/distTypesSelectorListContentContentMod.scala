...
import typingsJapgolly.wixStyleReact.anon.BelowNode
import typingsJapgolly.wixStyleReact.anon.CheckIndeterminate
...
object distTypesSelectorListContentContentMod {
  ...
  object default {
    ...
    inline def apply(
      hasDataHookItemsTopScrollableContentOnToggleEmptyStateRenderNoResultsIsLoadingCheckIsSelectedCheckIndeterminateIsEmptyNoResultsFoundImageSizeImageShapeMultipleSearchValueLoadMoreHasMoreInfiniteScrollRef: CheckIndeterminate
    ): Element = ^.asInstanceOf[js.Dynamic].apply(hasDataHookItemsTopScrollableContentOnToggleEmptyStateRenderNoResultsIsLoadingCheckIsSelectedCheckIndeterminateIsEmptyNoResultsFoundImageSizeImageShapeMultipleSearchValueLoadMoreHasMoreInfiniteScrollRef.asInstanceOf[js.Any]).asInstanceOf[Element]
