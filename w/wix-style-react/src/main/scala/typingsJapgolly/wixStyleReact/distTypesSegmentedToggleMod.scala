...
object distTypesSegmentedToggleMod {
  ...
  object default {
    ...
    @js.native
    def Button: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify React.SFC<SegmentedToggleButtonProps> */ Any = js.native
    inline def Button_=(
      x: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify React.SFC<SegmentedToggleButtonProps> */ Any
    ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Button")(x.asInstanceOf[js.Any])
  ...
  @js.native
  val SegmentedToggleButton: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify React.SFC<SegmentedToggleButtonProps> */ Any = js.native
  ...
  type SegmentedToggle = japgolly.scalajs.react.facade.React.Component[SegmentedToggleProps & js.Object, js.Object]
  ...
  object SegmentedToggleButtonProps {
    ...
    extension [Self <: SegmentedToggleButtonProps](x: Self) {
      ...
      inline def setFocusableOnBlur(value: ReactFocusEventFrom[HTMLButtonElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "focusableOnBlur", js.Any.fromFunction1((t0: ReactFocusEventFrom[HTMLButtonElement & org.scalajs.dom.Element]) => value(t0).runNow()))
      
      inline def setFocusableOnBlurUndefined: Self = StObject.set(x, "focusableOnBlur", js.undefined)
      
      inline def setFocusableOnFocus(value: ReactFocusEventFrom[HTMLButtonElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "focusableOnFocus", js.Any.fromFunction1((t0: ReactFocusEventFrom[HTMLButtonElement & org.scalajs.dom.Element]) => value(t0).runNow()))
  ...
  trait SegmentedToggleProps extends StObject {
    ...
    var defaultSelected: js.UndefOr[Node] = js.undefined
  ...
  object SegmentedToggleProps {
    ...
    extension [Self <: SegmentedToggleProps](x: Self) {
      ...
      inline def setDefaultSelected(value: VdomNode): Self = StObject.set(x, "defaultSelected", value.rawNode.asInstanceOf[js.Any])
      
      inline def setDefaultSelectedNull: Self = StObject.set(x, "defaultSelected", null)
      
      inline def setDefaultSelectedUndefined: Self = StObject.set(x, "defaultSelected", js.undefined)
      
      inline def setDefaultSelectedVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "defaultSelected", js.Array(value*))
      
      inline def setDefaultSelectedVdomElement(value: VdomElement): Self = StObject.set(x, "defaultSelected", value.rawElement.asInstanceOf[js.Any])
      
      inline def setDisabled(value: Boolean): Self = StObject.set(x, "disabled", value.asInstanceOf[js.Any])
      
      inline def setDisabledUndefined: Self = StObject.set(x, "disabled", js.undefined)
      
      inline def setOnClick(value: (/* event */ ReactEventFrom[org.scalajs.dom.Element], /* value */ String) => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element], t1: /* value */ String) => (value(t0, t1)).runNow()))
