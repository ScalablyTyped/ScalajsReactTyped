...
trait Label extends StObject {
  ...
  def value(hasSelectedHoveredRest: Dictx): typingsJapgolly.react.mod.global.JSX.Element
}
object Label {
  ...
  inline def apply(
    ...
    value: Dictx => typingsJapgolly.react.mod.global.JSX.Element
  ): Label = {
  ...
  extension [Self <: Label](x: Self) {
    ...
    inline def setValue(value: Dictx => typingsJapgolly.react.mod.global.JSX.Element): Self = StObject.set(x, "value", js.Any.fromFunction1(value))
  }
}
