...
object DataHookDisabled {
  ...
  extension [Self <: DataHookDisabled](x: Self) {
    ...
    inline def setOnCollapse(value: /* trigger */ ExpandCollapseTrigger => Callback): Self = StObject.set(x, "onCollapse", js.Any.fromFunction1((t0: /* trigger */ ExpandCollapseTrigger) => value(t0).runNow()))
    
    inline def setOnCollapseUndefined: Self = StObject.set(x, "onCollapse", js.undefined)
    
    inline def setOnExpand(value: /* trigger */ ExpandCollapseTrigger => Callback): Self = StObject.set(x, "onExpand", js.Any.fromFunction1((t0: /* trigger */ ExpandCollapseTrigger) => value(t0).runNow()))
