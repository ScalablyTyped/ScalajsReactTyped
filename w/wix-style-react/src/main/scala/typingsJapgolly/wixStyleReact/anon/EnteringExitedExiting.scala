...
trait EnteringExitedExiting extends StObject {
...
object EnteringExitedExiting {
  
  inline def apply(entered: HeightLeft, entering: LeftWidth, exited: HeightLeft, exiting: BottomHeight): EnteringExitedExiting = {
    ...
    __obj.asInstanceOf[EnteringExitedExiting]
  }
  
  extension [Self <: EnteringExitedExiting](x: Self) {
