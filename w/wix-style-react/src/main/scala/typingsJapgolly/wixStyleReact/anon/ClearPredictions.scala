...
object ClearPredictions {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(clearPredictions = clearPredictions.toJsFn, loading = loading.asInstanceOf[js.Any], predictions = predictions.asInstanceOf[js.Any], updatePredictions = updatePredictions.asInstanceOf[js.Any])
