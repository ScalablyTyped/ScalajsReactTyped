...
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.formatError
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.outOfBoundsError
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.valid
