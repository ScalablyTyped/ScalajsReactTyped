...
trait IdOverrideOptionStyleValue extends StObject {
  ...
  def value(hasHovered: HoveredAny): typingsJapgolly.react.mod.global.JSX.Element
}
object IdOverrideOptionStyleValue {
  ...
  inline def apply(
    ...
    value: HoveredAny => typingsJapgolly.react.mod.global.JSX.Element
  ...
  extension [Self <: IdOverrideOptionStyleValue](x: Self) {
    ...
    inline def setValue(value: HoveredAny => typingsJapgolly.react.mod.global.JSX.Element): Self = StObject.set(x, "value", js.Any.fromFunction1(value))
  }
}
