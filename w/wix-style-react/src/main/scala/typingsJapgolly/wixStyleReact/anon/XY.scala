...
import typingsJapgolly.wixStyleReact.distTypesCommonScrollableContainerMod.AreaX
import typingsJapgolly.wixStyleReact.distTypesCommonScrollableContainerMod.AreaY
