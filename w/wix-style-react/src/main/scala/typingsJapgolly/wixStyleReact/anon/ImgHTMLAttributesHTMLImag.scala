...
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.`use-credentials`
...
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.anonymous
...
trait ImgHTMLAttributesHTMLImag extends StObject {
  ...
  var crossOrigin: js.UndefOr[
    anonymous | `use-credentials` | typingsJapgolly.wixStyleReact.wixStyleReactStrings._empty
  ] = js.undefined
...
object ImgHTMLAttributesHTMLImag {
  ...
  extension [Self <: ImgHTMLAttributesHTMLImag](x: Self) {
    ...
    inline def setCrossOrigin(value: anonymous | `use-credentials` | typingsJapgolly.wixStyleReact.wixStyleReactStrings._empty): Self = StObject.set(x, "crossOrigin", value.asInstanceOf[js.Any])
