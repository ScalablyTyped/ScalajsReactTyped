...
trait Theme extends StObject {
  ...
  var children: js.UndefOr[Validator[Node]] = js.undefined
  ...
  var image: js.UndefOr[
    Validator[js.UndefOr[String | typingsJapgolly.react.mod.global.JSX.Element | Null]]
  ] = js.undefined
  
  var subtitle: js.UndefOr[Validator[Node]] = js.undefined
  
  var theme: js.UndefOr[Validator[js.UndefOr[EmptyStateTheme | Null]]] = js.undefined
  
  var title: js.UndefOr[Validator[Node]] = js.undefined
}
object Theme {
  ...
  extension [Self <: Theme](x: Self) {
    ...
    inline def setChildren(value: Validator[Node]): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
    ...
    inline def setImage(value: Validator[js.UndefOr[String | typingsJapgolly.react.mod.global.JSX.Element | Null]]): Self = StObject.set(x, "image", value.asInstanceOf[js.Any])
    
    inline def setImageUndefined: Self = StObject.set(x, "image", js.undefined)
    
    inline def setSubtitle(value: Validator[Node]): Self = StObject.set(x, "subtitle", value.asInstanceOf[js.Any])
    ...
    inline def setTitle(value: Validator[Node]): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
