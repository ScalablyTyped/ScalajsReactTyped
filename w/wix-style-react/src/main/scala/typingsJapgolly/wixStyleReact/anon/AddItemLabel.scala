...
trait AddItemLabel extends StObject {
  ...
  var id: typingsJapgolly.propTypes.mod.Validator[String | Double]
  ...
  var onBlur: js.UndefOr[
    Validator[
      js.UndefOr[
        (js.Function1[/* e */ ReactFocusEventFrom[org.scalajs.dom.Element], Unit]) | Null
      ]
    ]
  ] = js.undefined
...
object AddItemLabel {
  ...
  inline def apply(
    ...
    id: typingsJapgolly.propTypes.mod.Validator[String | Double],
  ...
  extension [Self <: AddItemLabel](x: Self) {
    ...
    inline def setId(value: typingsJapgolly.propTypes.mod.Validator[String | Double]): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
