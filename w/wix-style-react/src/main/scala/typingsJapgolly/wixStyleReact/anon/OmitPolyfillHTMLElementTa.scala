...
/* Inlined wix-style-react.wix-style-react/dist/types/common.OmitPolyfill<std.HTMLElementTagNameMap, 'a' | 'button'> */
trait OmitPolyfillHTMLElementTa extends StObject {
...
object OmitPolyfillHTMLElementTa {
