...
trait EllipsisProps[T] extends StObject {
  ...
  var ellipsisProps: typingsJapgolly.wixStyleReact.distTypesCommonEllipsisMod.EllipsisProps
}
object EllipsisProps {
  
  inline def apply[T](
    componentProps: T,
    ellipsisProps: typingsJapgolly.wixStyleReact.distTypesCommonEllipsisMod.EllipsisProps
  ): EllipsisProps[T] = {
  ...
  extension [Self <: EllipsisProps[?], T](x: Self & EllipsisProps[T]) {
    ...
    inline def setEllipsisProps(value: typingsJapgolly.wixStyleReact.distTypesCommonEllipsisMod.EllipsisProps): Self = StObject.set(x, "ellipsisProps", value.asInstanceOf[js.Any])
  }
}
