...
trait ReadonlyInputWithOptionsP extends StObject {
  ...
  val customInput: js.UndefOr[Node | js.Function] = js.undefined
  
  val dataHook: js.UndefOr[String] = js.undefined
  
  val defaultValue: js.UndefOr[typingsJapgolly.wixStyleReact.distTypesInputMod.InputValue] = js.undefined
  ...
  val fixedFooter: js.UndefOr[Node] = js.undefined
  
  val fixedHeader: js.UndefOr[Node] = js.undefined
  ...
  val inputElement: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.undefined
  ...
  val max: js.UndefOr[typingsJapgolly.wixStyleReact.distTypesInputMod.MaxValue] = js.undefined
  ...
  val min: js.UndefOr[typingsJapgolly.wixStyleReact.distTypesInputMod.MinValue] = js.undefined
  ...
  val onFocus: js.UndefOr[js.Function1[/* e */ js.UndefOr[ReactFocusEventFrom[HTMLInputElement]], Unit]] = js.undefined
  ...
  val prefix: js.UndefOr[Node] = js.undefined
  ...
  val statusMessage: js.UndefOr[Node] = js.undefined
  
  val step: js.UndefOr[Double] = js.undefined
  
  val suffix: js.UndefOr[Node] = js.undefined
  
  val tabIndex: js.UndefOr[Double] = js.undefined
  
  val textOverflow: js.UndefOr[clip | ellipsis] = js.undefined
  
  val tooltipPlacement: js.UndefOr[typingsJapgolly.wixStyleReact.distTypesPopoverPopoverDottypesMod.Placement] = js.undefined
...
object ReadonlyInputWithOptionsP {
  ...
  extension [Self <: ReadonlyInputWithOptionsP](x: Self) {
    ...
    inline def setCustomInputVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "customInput", js.Array(value*))
    ...
    inline def setDefaultValue(value: typingsJapgolly.wixStyleReact.distTypesInputMod.InputValue): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
    ...
    inline def setMax(value: typingsJapgolly.wixStyleReact.distTypesInputMod.MaxValue): Self = StObject.set(x, "max", value.asInstanceOf[js.Any])
    ...
    inline def setMin(value: typingsJapgolly.wixStyleReact.distTypesInputMod.MinValue): Self = StObject.set(x, "min", value.asInstanceOf[js.Any])
    ...
    inline def setTooltipPlacement(value: typingsJapgolly.wixStyleReact.distTypesPopoverPopoverDottypesMod.Placement): Self = StObject.set(x, "tooltipPlacement", value.asInstanceOf[js.Any])
