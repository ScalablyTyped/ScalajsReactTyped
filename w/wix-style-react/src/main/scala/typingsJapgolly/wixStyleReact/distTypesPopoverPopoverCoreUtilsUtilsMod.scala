...
import typingsJapgolly.wixStyleReact.anon.Left
import typingsJapgolly.wixStyleReact.anon.LeftTop
import typingsJapgolly.wixStyleReact.anon.Timeout
import typingsJapgolly.wixStyleReact.anon.Top
...
object distTypesPopoverPopoverCoreUtilsUtilsMod {
  ...
  inline def shouldAnimatePopover(hasTimeout: Timeout): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("shouldAnimatePopover")(hasTimeout.asInstanceOf[js.Any]).asInstanceOf[Boolean]
