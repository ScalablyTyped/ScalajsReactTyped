...
import typingsJapgolly.wixStyleReact.anon.OnCopy
...
object distTypesProvidersUseCopyClipboardUseCopyClipboardMod {
  ...
  /**
    ...
    * @return {Clipboard}
    */
  inline def default(hasValueOnCopyResetTimeout: OnCopy): Clipboard = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(hasValueOnCopyResetTimeout.asInstanceOf[js.Any]).asInstanceOf[Clipboard]
