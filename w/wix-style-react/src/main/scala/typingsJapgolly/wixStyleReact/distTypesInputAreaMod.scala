...
object distTypesInputAreaMod {
  ...
  type InputAreaChildrenFnArgs = js.Function1[/* data */ OnBlur, Node]
  ...
  trait InputAreaProps extends StObject {
    ...
    var onFocus: js.UndefOr[js.Function1[/* e */ js.UndefOr[ReactFocusEventFrom[HTMLTextAreaElement]], Unit]] = js.undefined
  ...
  object InputAreaProps {
    ...
    extension [Self <: InputAreaProps](x: Self) {
      ...
      inline def setChildren(value: /* data */ OnBlur => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      inline def setOnEnterPressed(value: ReactKeyboardEventFrom[HTMLTextAreaElement & Element] => Callback): Self = StObject.set(x, "onEnterPressed", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLTextAreaElement & Element]) => value(t0).runNow()))
      
      inline def setOnEnterPressedUndefined: Self = StObject.set(x, "onEnterPressed", js.undefined)
      
      inline def setOnEscapePressed(value: Callback): Self = StObject.set(x, "onEscapePressed", value.toJsFn)
      
      inline def setOnEscapePressedUndefined: Self = StObject.set(x, "onEscapePressed", js.undefined)
      
      inline def setOnFocus(value: /* e */ js.UndefOr[ReactFocusEventFrom[HTMLTextAreaElement]] => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: /* e */ js.UndefOr[ReactFocusEventFrom[HTMLTextAreaElement]]) => value(t0).runNow()))
