...
import typingsJapgolly.wixStyleReact.anon.AddItemButton
...
object distTypesThemeProviderMod {
  ...
  trait ThemeInterface extends StObject {
    ...
    var componentWrapper: js.UndefOr[js.Function1[/* hasChildren */ ChildrenReactNode, Node]] = js.undefined
  ...
  object ThemeInterface {
    ...
    extension [Self <: ThemeInterface](x: Self) {
      ...
      inline def setComponentWrapper(value: /* hasChildren */ ChildrenReactNode => Node): Self = StObject.set(x, "componentWrapper", js.Any.fromFunction1(value))
