...
import typingsJapgolly.wixStyleReact.anon.Description
import typingsJapgolly.wixStyleReact.anon.DescriptionInfo
import typingsJapgolly.wixStyleReact.anon.LabelShort
import typingsJapgolly.wixStyleReact.anon.Width
...
object distTypesBarChartBarChartMod {
  ...
  trait BarChart extends PureComponent[Any, Any, Any] {
    ...
    def _renderItem(hasValueLabelLabelShortDescriptionDescriptionInfo: Description, key: Any): Element = js.native
    
    def _renderValue(hasDescriptionInfoValueLabelLabelShortShowText: DescriptionInfo): Element = js.native
