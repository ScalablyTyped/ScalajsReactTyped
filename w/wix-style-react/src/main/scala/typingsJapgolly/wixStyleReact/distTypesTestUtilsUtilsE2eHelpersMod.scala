...
import typingsJapgolly.wixStyleReact.anon.Category
...
object distTypesTestUtilsUtilsE2eHelpersMod {
  ...
  inline def navigateToTestUrl(hasTestNameCategoryStoryNameRtl: Category): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("navigateToTestUrl")(hasTestNameCategoryStoryNameRtl.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
