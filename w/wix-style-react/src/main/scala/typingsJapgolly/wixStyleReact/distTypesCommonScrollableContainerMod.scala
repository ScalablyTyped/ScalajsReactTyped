...
import typingsJapgolly.wixStyleReact.anon.XY
...
object distTypesCommonScrollableContainerMod extends Shortcut {
  ...
  object AreaX extends StObject {
    ...
    sealed trait END
      extends StObject
         with AreaX
    /* "end" */ val END: typingsJapgolly.wixStyleReact.distTypesCommonScrollableContainerMod.AreaX.END & String = js.native
    
    @js.native
    sealed trait MIDDLE
      extends StObject
         with AreaX
    /* "middle" */ val MIDDLE: typingsJapgolly.wixStyleReact.distTypesCommonScrollableContainerMod.AreaX.MIDDLE & String = js.native
    
    @js.native
    sealed trait NONE
      extends StObject
         with AreaX
    /* "none" */ val NONE: typingsJapgolly.wixStyleReact.distTypesCommonScrollableContainerMod.AreaX.NONE & String = js.native
    
    @js.native
    sealed trait START
      extends StObject
         with AreaX
    /* "start" */ val START: typingsJapgolly.wixStyleReact.distTypesCommonScrollableContainerMod.AreaX.START & String = js.native
  }
  ...
  object AreaY extends StObject {
    ...
    sealed trait BOTTOM
      extends StObject
         with AreaY
    /* "bottom" */ val BOTTOM: typingsJapgolly.wixStyleReact.distTypesCommonScrollableContainerMod.AreaY.BOTTOM & String = js.native
    
    @js.native
    sealed trait MIDDLE
      extends StObject
         with AreaY
    /* "middle" */ val MIDDLE: typingsJapgolly.wixStyleReact.distTypesCommonScrollableContainerMod.AreaY.MIDDLE & String = js.native
    
    @js.native
    sealed trait NONE
      extends StObject
         with AreaY
    /* "none" */ val NONE: typingsJapgolly.wixStyleReact.distTypesCommonScrollableContainerMod.AreaY.NONE & String = js.native
    
    @js.native
    sealed trait TOP
      extends StObject
         with AreaY
    /* "top" */ val TOP: typingsJapgolly.wixStyleReact.distTypesCommonScrollableContainerMod.AreaY.TOP & String = js.native
  }
