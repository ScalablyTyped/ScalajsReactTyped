...
import typingsJapgolly.wixStyleReact.anon.BottomLeft
import typingsJapgolly.wixStyleReact.anon.DataWidth
import typingsJapgolly.wixStyleReact.anon.Values
...
object distTypesStackedBarChartStackedBarChartMod {
  ...
  trait StackedBarChart extends PureComponent[Any, Any, Any] {
    ...
    var chart: RefHandle[Any] = js.native
