...
import typingsJapgolly.wixStyleReact.anon.DisabledIcon
import typingsJapgolly.wixStyleReact.anon.ItemsSectionTitle
import typingsJapgolly.wixStyleReact.anon.Section
...
object distTypesComposerSidebarComposerSidebarMod {
  ...
  trait ComposerSidebar extends PureComponent[Any, Any, Any] {
    ...
    def _renderSection(hasHasItemsSectionTitleShowSectionTitles: Section): Element = js.native
