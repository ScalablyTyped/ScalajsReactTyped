...
import typingsJapgolly.wixStyleReact.distTypesWixStyleReactProviderMod.Features
import typingsJapgolly.wixStyleReact.distTypesWixStyleReactProviderMod.WixStyleReactProviderProps
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.div
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.span
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object WixStyleReactProvider {
  
  @JSImport("wix-style-react", "WixStyleReactProvider")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.wixStyleReact.mod.WixStyleReactProvider] {
    ...
    inline def as(value: span | div): this.type = set("as", value.asInstanceOf[js.Any])
    ...
    inline def features(value: Features): this.type = set("features", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: WixStyleReactProvider.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WixStyleReactProviderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
