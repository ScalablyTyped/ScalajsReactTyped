...
import typingsJapgolly.wixStyleReact.distTypesDragAndDropDraggableComponentsDraggableManagerMod.default
...
object DraggableManager {
  ...
  implicit def make(companion: DraggableManager.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
