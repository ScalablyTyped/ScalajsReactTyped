...
import typingsJapgolly.wixStyleReact.distTypesButtonButtonDottypesMod.default
...
object ButtonDottypes {
  
  object AnchorHTMLAttributesFullWidthAs {
    
    inline def apply(): Builder = {
      val __props = js.Dynamic.literal(as = "a")
      new Builder(js.Array(this.component, __props.asInstanceOf[AnchorHTMLAttributes[HTMLAnchorElement] & FullWidth & As]))
    }
    ...
    def withProps(p: AnchorHTMLAttributes[HTMLAnchorElement] & FullWidth & As): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object ButtonHTMLAttributesFullWidthOnClick {
    ...
    implicit def make(companion: ButtonHTMLAttributesFullWidthOnClick.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ButtonHTMLAttributes[HTMLButtonElement] & FullWidth & OnClick): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object FullWidthDictadditionalProps {
    
    inline def apply(as: ComponentType[Any]): Builder = {
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[FullWidth & DictadditionalProps]))
    }
    ...
    def withProps(p: FullWidth & DictadditionalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object FullWidthDictadditionalPropsAs {
    ...
    inline def apply(
      ...
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[FullWidth & DictadditionalPropsAs]))
    }
    ...
    def withProps(p: FullWidth & DictadditionalPropsAs): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
