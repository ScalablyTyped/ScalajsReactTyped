...
import typingsJapgolly.wixStyleReact.distTypesAnalyticsLayoutCellIndexMod.default
...
object Index {
  ...
  implicit def make(companion: Index.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
