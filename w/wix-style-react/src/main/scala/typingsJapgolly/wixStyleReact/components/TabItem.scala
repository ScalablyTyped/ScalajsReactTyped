...
import typingsJapgolly.wixStyleReact.distTypesTabsCoreTabItemMod.default
...
object TabItem {
  ...
  implicit def make(companion: TabItem.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
