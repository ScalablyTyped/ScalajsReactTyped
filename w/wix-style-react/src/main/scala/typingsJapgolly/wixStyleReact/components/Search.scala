...
import typingsJapgolly.wixStyleReact.distTypesSearchMod.SearchProps
...
object Search {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.wixStyleReact.mod.Search] {
    ...
    inline def expandWidth(value: String | Double): this.type = set("expandWidth", value.asInstanceOf[js.Any])
