...
import typingsJapgolly.wixStyleReact.distTypesUtilsInfiniteScrollMod.default
...
object InfiniteScroll {
  ...
  implicit def make(companion: InfiniteScroll.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
