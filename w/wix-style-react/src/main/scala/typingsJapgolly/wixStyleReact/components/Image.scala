...
import typingsJapgolly.wixStyleReact.distTypesImageMod.ImageFit
import typingsJapgolly.wixStyleReact.distTypesImageMod.ImageProps
...
object Image {
  ...
  @JSImport("wix-style-react", "Image")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def fit(value: ImageFit): this.type = set("fit", value.asInstanceOf[js.Any])
