...
object Heading {
  ...
  @JSImport("wix-style-react/dist/types/Heading/Heading", JSImport.Default)
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Heading.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
