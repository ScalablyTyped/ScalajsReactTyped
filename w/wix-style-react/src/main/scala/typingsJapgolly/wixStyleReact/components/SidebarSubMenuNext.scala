...
import typingsJapgolly.wixStyleReact.distTypesSidebarSubMenuNextMod.ExpandCollapseTrigger
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.button
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object SidebarSubMenuNext {
  
  object AnchorHTMLAttributesDataHookDisabledAs {
    
    inline def apply(): Builder = {
      val __props = js.Dynamic.literal(as = "a")
      new Builder(js.Array(this.component, __props.asInstanceOf[AnchorHTMLAttributes[HTMLAnchorElement] & DataHookDisabled & As]))
    }
    
    @JSImport("wix-style-react", "SidebarSubMenuNext")
    @js.native
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def onCollapse(value: /* trigger */ ExpandCollapseTrigger => Callback): this.type = set("onCollapse", js.Any.fromFunction1((t0: /* trigger */ ExpandCollapseTrigger) => value(t0).runNow()))
      ...
      inline def onExpand(value: /* trigger */ ExpandCollapseTrigger => Callback): this.type = set("onExpand", js.Any.fromFunction1((t0: /* trigger */ ExpandCollapseTrigger) => value(t0).runNow()))
    ...
    def withProps(p: AnchorHTMLAttributes[HTMLAnchorElement] & DataHookDisabled & As): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object ButtonHTMLAttributesDataHookDisabledOnClick {
    ...
    implicit def make(companion: ButtonHTMLAttributesDataHookDisabledOnClick.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ButtonHTMLAttributes[HTMLButtonElement] & DataHookDisabled & OnClick): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object DataHookDisabledDictadditionalProps {
    
    inline def apply(as: ComponentType[Any]): Builder = {
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[DataHookDisabled & DictadditionalProps]))
    }
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def title(value: ComponentType[js.Object] | String): this.type = set("title", value.asInstanceOf[js.Any])
    }
    
    def withProps(p: DataHookDisabled & DictadditionalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object DataHookDisabledDictadditionalPropsAs {
    ...
    inline def apply(
      ...
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[DataHookDisabled & DictadditionalPropsAs]))
    }
    ...
    def withProps(p: DataHookDisabled & DictadditionalPropsAs): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
