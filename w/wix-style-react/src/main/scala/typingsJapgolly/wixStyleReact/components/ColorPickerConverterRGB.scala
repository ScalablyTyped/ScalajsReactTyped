...
import typingsJapgolly.wixStyleReact.distTypesColorPickerColorPickerConverterRGBMod.default
...
object ColorPickerConverterRGB {
  ...
  implicit def make(companion: ColorPickerConverterRGB.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
