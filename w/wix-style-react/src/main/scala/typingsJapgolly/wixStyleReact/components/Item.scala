...
import typingsJapgolly.wixStyleReact.distTypesNestableListBaseItemMod.default
...
object Item {
  ...
  implicit def make(companion: Item.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
