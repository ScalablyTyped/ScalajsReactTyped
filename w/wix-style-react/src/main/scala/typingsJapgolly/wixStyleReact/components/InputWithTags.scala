...
import typingsJapgolly.wixStyleReact.distTypesMultiSelectInputWithTagsMod.default
...
object InputWithTags {
  ...
  implicit def make(companion: InputWithTags.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
