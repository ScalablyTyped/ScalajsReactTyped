...
object NumberInput {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def hideStepper(value: Boolean): this.type = set("hideStepper", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* value */ Double | Null, /* stringValue */ String) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* value */ Double | Null, t1: /* stringValue */ String) => (value(t0, t1)).runNow()))
    ...
    inline def onInvalid(value: /* value */ String => Callback): this.type = set("onInvalid", js.Any.fromFunction1((t0: /* value */ String) => value(t0).runNow()))
