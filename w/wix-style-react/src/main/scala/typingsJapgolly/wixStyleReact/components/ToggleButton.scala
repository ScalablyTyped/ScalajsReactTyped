...
object ToggleButton {
  ...
  object AnchorHTMLAttributesBorderAs {
    
    inline def apply(): Builder = {
      val __props = js.Dynamic.literal(as = "a")
      new Builder(js.Array(this.component, __props.asInstanceOf[AnchorHTMLAttributes[HTMLAnchorElement] & Border & As]))
    }
    
    @JSImport("wix-style-react", "ToggleButton")
    @js.native
    ...
    open class Builder (val args: js.Array[Any])
      extends AnyVal
         with StBuildingComponent[typingsJapgolly.wixStyleReact.mod.ToggleButton] {
      ...
      inline def labelEllipsis(value: Boolean): this.type = set("labelEllipsis", value.asInstanceOf[js.Any])
      
      inline def labelPlacement(value: tooltip | bottom | end): this.type = set("labelPlacement", value.asInstanceOf[js.Any])
      
      inline def labelValue(value: VdomNode): this.type = set("labelValue", value.rawNode.asInstanceOf[js.Any])
      
      inline def labelValueNull: this.type = set("labelValue", null)
      
      inline def labelValueVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("labelValue", js.Array(value*))
      
      inline def labelValueVdomElement(value: VdomElement): this.type = set("labelValue", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def shape(value: square | round): this.type = set("shape", value.asInstanceOf[js.Any])
      
      inline def size(value: tiny | small | medium | large): this.type = set("size", value.asInstanceOf[js.Any])
      
      inline def skin(value: ToggleButtonSkin): this.type = set("skin", value.asInstanceOf[js.Any])
    ...
    def withProps(p: AnchorHTMLAttributes[HTMLAnchorElement] & Border & As): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object BorderDictadditionalProps {
    
    inline def apply(as: ComponentType[Any]): Builder = {
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[Border & DictadditionalProps]))
    }
    ...
    def withProps(p: Border & DictadditionalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object BorderDictadditionalPropsAs {
    ...
    inline def apply(
      ...
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[Border & DictadditionalPropsAs]))
    }
    ...
    def withProps(p: Border & DictadditionalPropsAs): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object ButtonHTMLAttributesBorderOnClick {
    ...
    implicit def make(companion: ButtonHTMLAttributesBorderOnClick.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ButtonHTMLAttributes[HTMLButtonElement] & Border & OnClick): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
