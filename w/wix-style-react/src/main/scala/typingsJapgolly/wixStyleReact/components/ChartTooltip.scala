...
object ChartTooltip {
  ...
  @JSImport("wix-style-react/dist/types/SparklineChart/ChartTooltip", "ChartTooltip")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ChartTooltip.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
