...
import typingsJapgolly.wixStyleReact.distTypesNestableListBaseContainerMod.default
...
object Container {
  ...
  @JSImport("wix-style-react/dist/types/NestableListBase/Container", JSImport.Default)
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Container.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
