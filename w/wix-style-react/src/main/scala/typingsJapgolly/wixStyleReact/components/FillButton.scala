...
import typingsJapgolly.wixStyleReact.distTypesFillButtonMod.FillButtonIconSize
import typingsJapgolly.wixStyleReact.distTypesFillButtonMod.FillButtonProps
...
object FillButton {
  ...
  @JSImport("wix-style-react", "FillButton")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.wixStyleReact.mod.FillButton] {
    ...
    inline def iconSize(value: FillButtonIconSize): this.type = set("iconSize", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: FillButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FillButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
