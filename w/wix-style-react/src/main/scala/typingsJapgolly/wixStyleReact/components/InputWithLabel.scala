...
import typingsJapgolly.wixStyleReact.distTypesInputWithLabelMod.InputWithLabelProps
...
object InputWithLabel {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.wixStyleReact.mod.InputWithLabel] {
    ...
    inline def border(value: standard | bottomLine): this.type = set("border", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: InputWithLabel.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InputWithLabelProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
