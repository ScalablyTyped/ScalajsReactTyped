...
object DEFAULT_VALUE_PARSER {
  
  def apply(p: Any): Default[js.Object] = new Default[js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @JSImport("wix-style-react/dist/types/InputWithOptions/InputWithOptions", "DEFAULT_VALUE_PARSER")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: DEFAULT_VALUE_PARSER.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
