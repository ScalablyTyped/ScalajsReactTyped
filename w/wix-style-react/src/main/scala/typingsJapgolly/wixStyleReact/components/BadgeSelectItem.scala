...
object BadgeSelectItem {
  ...
  implicit def make(companion: BadgeSelectItem.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
