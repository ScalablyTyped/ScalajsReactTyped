...
import typingsJapgolly.wixStyleReact.distTypesColorPickerColorPickerHsbMod.default
...
object ColorPickerHsb {
  ...
  implicit def make(companion: ColorPickerHsb.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
