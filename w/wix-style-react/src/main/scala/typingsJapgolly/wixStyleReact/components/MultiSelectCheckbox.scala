...
import typingsJapgolly.wixStyleReact.distTypesMultiSelectCheckboxMod.MultiSelectCheckboxProps
...
object MultiSelectCheckbox {
  
  @JSImport("wix-style-react", "MultiSelectCheckbox")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.wixStyleReact.mod.MultiSelectCheckbox] {
    ...
    inline def onDeselect(value: (/* id */ String | Double, /* option */ DropdownLayoutValueOption) => Callback): this.type = set("onDeselect", js.Any.fromFunction2((t0: /* id */ String | Double, t1: /* option */ DropdownLayoutValueOption) => (value(t0, t1)).runNow()))
    ...
    inline def onSelect(value: (/* id */ String | Double, /* option */ DropdownLayoutValueOption) => Callback): this.type = set("onSelect", js.Any.fromFunction2((t0: /* id */ String | Double, t1: /* option */ DropdownLayoutValueOption) => (value(t0, t1)).runNow()))
    ...
    inline def selectedOptions(value: js.Array[js.UndefOr[String | Double]]): this.type = set("selectedOptions", value.asInstanceOf[js.Any])
    
    inline def selectedOptionsVarargs(value: (js.UndefOr[String | Double])*): this.type = set("selectedOptions", js.Array(value*))
  ...
  implicit def make(companion: MultiSelectCheckbox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MultiSelectCheckboxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
