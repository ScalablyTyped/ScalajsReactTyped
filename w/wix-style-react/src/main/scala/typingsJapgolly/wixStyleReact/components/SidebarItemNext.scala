...
object SidebarItemNext {
  
  object AnchorHTMLAttributesItemKeyAs {
    
    inline def apply(): Builder = {
      val __props = js.Dynamic.literal(as = "a")
      new Builder(js.Array(this.component, __props.asInstanceOf[AnchorHTMLAttributes[HTMLAnchorElement] & ItemKey & As]))
    }
    
    @JSImport("wix-style-react", "SidebarItemNext")
    @js.native
    ...
    def withProps(p: AnchorHTMLAttributes[HTMLAnchorElement] & ItemKey & As): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object ButtonHTMLAttributesItemKeyOnClick {
    ...
    implicit def make(companion: ButtonHTMLAttributesItemKeyOnClick.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ButtonHTMLAttributes[HTMLButtonElement] & ItemKey & OnClick): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object ItemKeyDictadditionalProps {
    
    inline def apply(as: ComponentType[Any]): Builder = {
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[ItemKey & DictadditionalProps]))
    }
    ...
    def withProps(p: ItemKey & DictadditionalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object ItemKeyDictadditionalPropsAs {
    ...
    inline def apply(
      ...
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[ItemKey & DictadditionalPropsAs]))
    }
    ...
    def withProps(p: ItemKey & DictadditionalPropsAs): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
