...
import typingsJapgolly.wixStyleReact.distTypesSelectorExtraTextMod.default
...
object ExtraText {
  ...
  implicit def make(companion: ExtraText.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
