...
import typingsJapgolly.wixStyleReact.anon.AspectRatio
...
object FillPreview {
  ...
  object AnchorHTMLAttributesAspectRatioAs {
    
    inline def apply(): Builder = {
      val __props = js.Dynamic.literal(as = "a")
      new Builder(js.Array(this.component, __props.asInstanceOf[AnchorHTMLAttributes[HTMLAnchorElement] & AspectRatio & As]))
    }
    ...
    open class Builder (val args: js.Array[Any])
      extends AnyVal
         with StBuildingComponent[typingsJapgolly.wixStyleReact.mod.FillPreview] {
      ...
      inline def aspectRatio(value: String | Double): this.type = set("aspectRatio", value.asInstanceOf[js.Any])
      ...
      inline def fill(value: VdomNode): this.type = set("fill", value.rawNode.asInstanceOf[js.Any])
      
      inline def fillNull: this.type = set("fill", null)
      
      inline def fillVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("fill", js.Array(value*))
      
      inline def fillVdomElement(value: VdomElement): this.type = set("fill", value.rawElement.asInstanceOf[js.Any])
    ...
    def withProps(p: AnchorHTMLAttributes[HTMLAnchorElement] & AspectRatio & As): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object AspectRatioDictadditionalProps {
    
    inline def apply(as: ComponentType[Any]): Builder = {
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[AspectRatio & DictadditionalProps]))
    }
    ...
    def withProps(p: AspectRatio & DictadditionalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object AspectRatioDictadditionalPropsAs {
    ...
    inline def apply(
      ...
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[AspectRatio & DictadditionalPropsAs]))
    }
    ...
    def withProps(p: AspectRatio & DictadditionalPropsAs): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object ButtonHTMLAttributesAspectRatioOnClick {
    ...
    implicit def make(companion: ButtonHTMLAttributesAspectRatioOnClick.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ButtonHTMLAttributes[HTMLButtonElement] & AspectRatio & OnClick): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
