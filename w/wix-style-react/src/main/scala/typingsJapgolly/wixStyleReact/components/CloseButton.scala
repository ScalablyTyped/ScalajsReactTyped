...
import typingsJapgolly.wixStyleReact.distTypesCloseButtonMod.CloseButtonSize
import typingsJapgolly.wixStyleReact.distTypesCloseButtonMod.CloseButtonSkin
...
object CloseButton {
  ...
  object AnchorHTMLAttributesClassNameDataHookAs {
    
    inline def apply(): Builder = {
      val __props = js.Dynamic.literal(as = "a")
      new Builder(js.Array(this.component, __props.asInstanceOf[AnchorHTMLAttributes[HTMLAnchorElement] & ClassNameDataHook & As]))
    }
    
    @JSImport("wix-style-react", "CloseButton")
    @js.native
    ...
    open class Builder (val args: js.Array[Any])
      extends AnyVal
         with StBuildingComponent[typingsJapgolly.wixStyleReact.mod.CloseButton] {
      ...
      inline def size(value: CloseButtonSize): this.type = set("size", value.asInstanceOf[js.Any])
      
      inline def skin(value: CloseButtonSkin): this.type = set("skin", value.asInstanceOf[js.Any])
    ...
    def withProps(p: AnchorHTMLAttributes[HTMLAnchorElement] & ClassNameDataHook & As): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object ButtonHTMLAttributesClassNameDataHookOnClick {
    ...
    implicit def make(companion: ButtonHTMLAttributesClassNameDataHookOnClick.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ButtonHTMLAttributes[HTMLButtonElement] & ClassNameDataHook & OnClick): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object ClassNameDataHookDictadditionalProps {
    
    inline def apply(as: ComponentType[Any]): Builder = {
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[ClassNameDataHook & DictadditionalProps]))
    }
    ...
    def withProps(p: ClassNameDataHook & DictadditionalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object ClassNameDataHookDictadditionalPropsAs {
    ...
    inline def apply(
      ...
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[ClassNameDataHook & DictadditionalPropsAs]))
    }
    ...
    def withProps(p: ClassNameDataHook & DictadditionalPropsAs): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
