...
object TableActionCell {
  ...
  implicit def make(companion: TableActionCell.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
