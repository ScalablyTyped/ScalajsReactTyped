...
import typingsJapgolly.wixStyleReact.distTypesSelectorProgressBarMod.default
...
object ProgressBar {
  ...
  implicit def make(companion: ProgressBar.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
