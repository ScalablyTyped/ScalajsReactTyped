...
import typingsJapgolly.wixStyleReact.distTypesColorPickerColorPickerConverterMod.default
...
object ColorPickerConverter {
  ...
  implicit def make(companion: ColorPickerConverter.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
