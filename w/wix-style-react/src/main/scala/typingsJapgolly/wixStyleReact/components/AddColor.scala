...
import typingsJapgolly.wixStyleReact.distTypesSwatchesAddColorMod.default
...
object AddColor {
  ...
  implicit def make(companion: AddColor.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
