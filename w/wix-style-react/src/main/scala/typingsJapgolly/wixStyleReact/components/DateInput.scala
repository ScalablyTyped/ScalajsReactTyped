...
import typingsJapgolly.wixStyleReact.distTypesDatePickerDateInputMod.DateInputProps
import typingsJapgolly.wixStyleReact.distTypesDatePickerDateInputMod.default
...
object DateInput {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onValidate(value: /* hasFormatValidationTypeValue */ Format => Callback): this.type = set("onValidate", js.Any.fromFunction1((t0: /* hasFormatValidationTypeValue */ Format) => value(t0).runNow()))
