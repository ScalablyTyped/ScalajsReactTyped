...
import typingsJapgolly.wixStyleReact.distTypesEditableSelectorEditableRowEditableRowMod.default
...
object EditableRow {
  ...
  implicit def make(companion: EditableRow.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
