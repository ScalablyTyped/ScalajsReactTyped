...
import typingsJapgolly.wixStyleReact.distTypesRichTextInputAreaFormRichTextInputAreaLinkFormMod.default
...
object RichTextInputAreaLinkForm {
  ...
  implicit def make(companion: RichTextInputAreaLinkForm.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
