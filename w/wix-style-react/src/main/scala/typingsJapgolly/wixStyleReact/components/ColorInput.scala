...
import typingsJapgolly.wixStyleReact.anon.OmitPolyfillPopoverPropss
import typingsJapgolly.wixStyleReact.distTypesColorInputMod.ColorInputProps
import typingsJapgolly.wixStyleReact.distTypesColorInputMod.ColorInputSize
...
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.parent
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.round
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.scrollParent
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.standard
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.viewport
import typingsJapgolly.wixStyleReact.wixStyleReactStrings.window
...
object ColorInput {
  ...
  inline def apply(value: (js.UndefOr[String | Double]) & String): Builder = {
    val __props = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[ColorInputProps]))
  }
  
  @JSImport("wix-style-react", "ColorInput")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.wixStyleReact.mod.ColorInput] {
    ...
    inline def colorPickerChildren(value: VdomNode): this.type = set("colorPickerChildren", value.rawNode.asInstanceOf[js.Any])
    
    inline def colorPickerChildrenNull: this.type = set("colorPickerChildren", null)
    
    inline def colorPickerChildrenVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("colorPickerChildren", js.Array(value*))
    
    inline def colorPickerChildrenVdomElement(value: VdomElement): this.type = set("colorPickerChildren", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def onAddColor(value: /* color */ String | js.Object => Callback): this.type = set("onAddColor", js.Any.fromFunction1((t0: /* color */ String | js.Object) => value(t0).runNow()))
    ...
    inline def onCancel(value: /* color */ String | js.Object => Callback): this.type = set("onCancel", js.Any.fromFunction1((t0: /* color */ String | js.Object) => value(t0).runNow()))
    
    inline def onChange(value: /* color */ String | js.Object => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* color */ String | js.Object) => value(t0).runNow()))
    ...
    inline def onConfirm(value: /* color */ String | js.Object => Callback): this.type = set("onConfirm", js.Any.fromFunction1((t0: /* color */ String | js.Object) => value(t0).runNow()))
    ...
    inline def popoverAppendTo(value: window | scrollParent | viewport | parent): this.type = set("popoverAppendTo", value.asInstanceOf[js.Any])
    
    inline def popoverPlacement(value: Placement): this.type = set("popoverPlacement", value.asInstanceOf[js.Any])
    
    inline def popoverProps(value: OmitPolyfillPopoverPropss): this.type = set("popoverProps", value.asInstanceOf[js.Any])
    ...
    inline def size(value: js.UndefOr[InputSize] & js.UndefOr[ColorInputSize]): this.type = set("size", value.asInstanceOf[js.Any])
