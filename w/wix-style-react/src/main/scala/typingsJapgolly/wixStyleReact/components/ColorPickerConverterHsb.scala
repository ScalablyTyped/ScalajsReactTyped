...
import typingsJapgolly.wixStyleReact.distTypesColorPickerColorPickerConverterHsbMod.default
...
object ColorPickerConverterHsb {
  ...
  implicit def make(companion: ColorPickerConverterHsb.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
