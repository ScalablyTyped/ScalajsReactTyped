...
object ZIndex {
  ...
  @JSImport("wix-style-react/dist/types/ZIndex", "ZIndex")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ZIndex.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
