...
object IconButton {
  ...
  object AnchorHTMLAttributesPriorityAs {
    
    inline def apply(): Builder = {
      val __props = js.Dynamic.literal(as = "a")
      new Builder(js.Array(this.component, __props.asInstanceOf[AnchorHTMLAttributes[HTMLAnchorElement] & Priority & As]))
    }
    
    @JSImport("wix-style-react", "IconButton")
    @js.native
    ...
    open class Builder (val args: js.Array[Any])
      extends AnyVal
         with StBuildingComponent[typingsJapgolly.wixStyleReact.mod.IconButton] {
      ...
      inline def priority(value: IconButtonPriority): this.type = set("priority", value.asInstanceOf[js.Any])
      ...
      inline def size(value: IconButtonSize): this.type = set("size", value.asInstanceOf[js.Any])
      
      inline def skin(value: IconButtonSkin): this.type = set("skin", value.asInstanceOf[js.Any])
    ...
    def withProps(p: AnchorHTMLAttributes[HTMLAnchorElement] & Priority & As): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object ButtonHTMLAttributesPriorityOnClick {
    ...
    implicit def make(companion: ButtonHTMLAttributesPriorityOnClick.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ButtonHTMLAttributes[HTMLButtonElement] & Priority & OnClick): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object PriorityDictadditionalProps {
    
    inline def apply(as: ComponentType[Any]): Builder = {
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[Priority & DictadditionalProps]))
    }
    ...
    def withProps(p: Priority & DictadditionalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object PriorityDictadditionalPropsAs {
    ...
    inline def apply(
      ...
      val __props = js.Dynamic.literal(as = as.asInstanceOf[js.Any])
      new Builder(js.Array(this.component, __props.asInstanceOf[Priority & DictadditionalPropsAs]))
    }
    ...
    def withProps(p: Priority & DictadditionalPropsAs): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
