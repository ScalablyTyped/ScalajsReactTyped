...
object SidebarContentWrapper {
  ...
  def apply(p: Any): Default[
    typingsJapgolly.wixStyleReact.distTypesSidebarSidebarContentWrapperMod.SidebarContentWrapper
  ] = new Default[
    typingsJapgolly.wixStyleReact.distTypesSidebarSidebarContentWrapperMod.SidebarContentWrapper
  ...
  implicit def make(companion: SidebarContentWrapper.type): Default[
    typingsJapgolly.wixStyleReact.distTypesSidebarSidebarContentWrapperMod.SidebarContentWrapper
  ] = new Default[
    typingsJapgolly.wixStyleReact.distTypesSidebarSidebarContentWrapperMod.SidebarContentWrapper
