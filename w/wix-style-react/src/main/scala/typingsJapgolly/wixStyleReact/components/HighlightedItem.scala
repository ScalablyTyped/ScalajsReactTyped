...
import typingsJapgolly.wixStyleReact.distTypesHighlighterHighlightedItemMod.default
...
object HighlightedItem {
  ...
  implicit def make(companion: HighlightedItem.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
