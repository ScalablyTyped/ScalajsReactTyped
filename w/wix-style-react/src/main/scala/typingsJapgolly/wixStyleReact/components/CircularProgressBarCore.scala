...
import typingsJapgolly.wixStyleReact.distTypesCircularProgressBarCircularProgressBarCoreCircularProgressBarCoreMod.CircularProgressBarCoreProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object CircularProgressBarCore {
  
  @JSImport("wix-style-react/dist/types/CircularProgressBar/CircularProgressBarCore", "CircularProgressBarCore")
  @js.native
  ...
  implicit def make(companion: CircularProgressBarCore.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CircularProgressBarCoreProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
