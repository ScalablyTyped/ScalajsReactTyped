...
import typingsJapgolly.wixStyleReact.distTypesColorPickerColorPickerHueMod.default
...
object ColorPickerHue {
  ...
  implicit def make(companion: ColorPickerHue.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
