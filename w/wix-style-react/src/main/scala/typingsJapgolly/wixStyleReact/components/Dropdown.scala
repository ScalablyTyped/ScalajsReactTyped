...
object Dropdown {
  ...
  object DropdownPropsControlled {
    ...
    @JSImport("wix-style-react", "Dropdown")
    @js.native
    ...
    open class Builder (val args: js.Array[Any])
      extends AnyVal
         with StBuildingComponent[typingsJapgolly.wixStyleReact.mod.Dropdown] {
    ...
    implicit def make(companion: DropdownPropsControlled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: typingsJapgolly.wixStyleReact.distTypesDropdownMod.DropdownPropsControlled): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object DropdownPropsUncontrolled {
    ...
    implicit def make(companion: DropdownPropsUncontrolled.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: typingsJapgolly.wixStyleReact.distTypesDropdownMod.DropdownPropsUncontrolled): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
