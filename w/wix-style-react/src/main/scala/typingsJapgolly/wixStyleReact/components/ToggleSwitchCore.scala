...
import typingsJapgolly.wixStyleReact.distTypesToggleSwitchToggleSwitchCoreMod.default
import typingsJapgolly.wixStyleReact.distTypesToggleSwitchToggleSwitchCoreToggleSwitchCoreMod.ToggleSwitchCoreProps
import typingsJapgolly.wixStyleReact.distTypesToggleSwitchToggleSwitchCoreToggleSwitchCoreMod.ToggleSwitchCoreStyles
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ToggleSwitchCore {
  
  @JSImport("wix-style-react/dist/types/ToggleSwitch/ToggleSwitchCore", JSImport.Default)
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def styles(value: ToggleSwitchCoreStyles): this.type = set("styles", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ToggleSwitchCore.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ToggleSwitchCoreProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
