...
import typingsJapgolly.wixStyleReact.distTypesMultiSelectMod.MultiSelectMode
import typingsJapgolly.wixStyleReact.distTypesMultiSelectMod.MultiSelectProps
import typingsJapgolly.wixStyleReact.distTypesMultiSelectMod.MultiSelectStatus
import typingsJapgolly.wixStyleReact.distTypesMultiSelectMod.MultiSelectTag
...
object MultiSelect {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.wixStyleReact.mod.MultiSelect] {
    
    inline def acceptOnBlur(value: Boolean): this.type = set("acceptOnBlur", value.asInstanceOf[js.Any])
    ...
    inline def customSuffix(value: VdomNode): this.type = set("customSuffix", value.rawNode.asInstanceOf[js.Any])
    
    inline def customSuffixNull: this.type = set("customSuffix", null)
    
    inline def customSuffixVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("customSuffix", js.Array(value*))
    
    inline def customSuffixVdomElement(value: VdomElement): this.type = set("customSuffix", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def maxNumRows(value: Double): this.type = set("maxNumRows", value.asInstanceOf[js.Any])
    ...
    inline def mode(value: MultiSelectMode): this.type = set("mode", value.asInstanceOf[js.Any])
    ...
    inline def onManuallyInput(value: /* values */ js.Array[String] => Callback): this.type = set("onManuallyInput", js.Any.fromFunction1((t0: /* values */ js.Array[String]) => value(t0).runNow()))
    ...
    inline def onRemoveTag(value: /* tagId */ String => Callback): this.type = set("onRemoveTag", js.Any.fromFunction1((t0: /* tagId */ String) => value(t0).runNow()))
    
    inline def onReorder(value: /* data */ RemovedIndex => Callback): this.type = set("onReorder", js.Any.fromFunction1((t0: /* data */ RemovedIndex) => value(t0).runNow()))
    ...
    inline def status(value: MultiSelectStatus): this.type = set("status", value.asInstanceOf[js.Any])
    ...
    inline def tags(value: js.Array[MultiSelectTag]): this.type = set("tags", value.asInstanceOf[js.Any])
    
    inline def tagsVarargs(value: MultiSelectTag*): this.type = set("tags", js.Array(value*))
