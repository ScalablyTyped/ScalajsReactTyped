...
import typingsJapgolly.wixStyleReact.distTypesTimelineTimelineItemMod.default
...
object TimelineItem {
  ...
  implicit def make(companion: TimelineItem.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
