...
import typingsJapgolly.wixStyleReact.anon.DateVal
import typingsJapgolly.wixStyleReact.anon.DynamicWidth
import typingsJapgolly.wixStyleReact.anon.IsDateInputFocusable
import typingsJapgolly.wixStyleReact.anon.ZIndex
...
object distTypesDatePickerDatePickerMod {
  ...
  trait DatePicker extends PureComponent[Any, Any, Any] {
    ...
    def _handleInputChange(hasDateVal: DateVal): Unit = js.native
