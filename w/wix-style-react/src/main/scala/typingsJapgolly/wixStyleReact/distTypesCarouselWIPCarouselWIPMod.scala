...
import typingsJapgolly.wixStyleReact.anon.AlignTo
import typingsJapgolly.wixStyleReact.anon.IsAnimating
...
object distTypesCarouselWIPCarouselWIPMod {
  ...
  trait CarouselWIP extends PureComponent[Any, Any, Any] {
    ...
    def _slideTo(hasIndexAlignToImmediate: AlignTo): js.Promise[Any] = js.native
