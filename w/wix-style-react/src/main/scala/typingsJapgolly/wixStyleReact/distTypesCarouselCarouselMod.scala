...
import typingsJapgolly.wixStyleReact.anon.AfterChange
import typingsJapgolly.wixStyleReact.anon.Autoplay
import typingsJapgolly.wixStyleReact.anon.LoadedImages
...
object distTypesCarouselCarouselMod {
  ...
  trait Carousel extends Component[Any, Any, Any] {
    ...
    def _resolveSliderSettings(
      hasInfiniteAutoplayDotsVariableWidthButtonSkinInitialSlideIndexAfterChangeBeforeChangeControlsPositionControlsSizeControlsStartEnd: Autoplay
    ): AfterChange = js.native
