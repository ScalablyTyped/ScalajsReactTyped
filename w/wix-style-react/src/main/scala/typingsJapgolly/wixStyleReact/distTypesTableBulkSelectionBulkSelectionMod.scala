...
import typingsJapgolly.wixStyleReact.anon.AllIds
import typingsJapgolly.wixStyleReact.anon.BulkSelectionState
import typingsJapgolly.wixStyleReact.anon.Helpers
...
object distTypesTableBulkSelectionBulkSelectionMod {
  ...
  open class BulkSelection protected () extends Component[Any, Any, Any] {
    ...
    def createHelpers(hasSelectedIdsNotSelectedIdsAllIdsSelectionDisabledDeselectRowsByDefaultTotalCount: AllIds): BulkSelectionState = js.native
  ...
  object BulkSelectionState {
    ...
    @js.native
    val ALL: typingsJapgolly.wixStyleReact.wixStyleReactStrings.ALL = js.native
    
    @JSImport("wix-style-react/dist/types/Table/BulkSelection/BulkSelection", "BulkSelectionState.NONE")
    @js.native
    val NONE: typingsJapgolly.wixStyleReact.wixStyleReactStrings.NONE = js.native
    
    @JSImport("wix-style-react/dist/types/Table/BulkSelection/BulkSelection", "BulkSelectionState.SOME")
    @js.native
    val SOME: typingsJapgolly.wixStyleReact.wixStyleReactStrings.SOME = js.native
  }
  ...
  object ChangeType {
    ...
    @js.native
    val SINGLE_TOGGLE: typingsJapgolly.wixStyleReact.wixStyleReactStrings.SINGLE_TOGGLE = js.native
  }
}
