...
object distTypesNestableListBaseMod {
  ...
  trait NestableItemProps
    ...
    var children: js.UndefOr[
        js.Array[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ItemProps */ Any
        ]
      ] = js.undefined
  ...
  object NestableItemProps {
    ...
    extension [Self <: NestableItemProps](x: Self) {
      ...
      inline def setChildrenVarargs(
        value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ItemProps */ Any)*
  ...
  trait NestableListBaseProps extends StObject {
    ...
    var renderAction: js.UndefOr[js.Function1[/* data */ IRenderData, Node]] = js.undefined
    
    var renderItem: js.UndefOr[js.Function1[/* data */ IRenderData, Node]] = js.undefined
    
    var renderPrefix: js.UndefOr[js.Function1[/* data */ IRenderData, Node]] = js.undefined
  ...
  object NestableListBaseProps {
    ...
    extension [Self <: NestableListBaseProps](x: Self) {
      ...
      inline def setOnDragEnd(value: /* itemProps */ Any => Callback): Self = StObject.set(x, "onDragEnd", js.Any.fromFunction1((t0: /* itemProps */ Any) => value(t0).runNow()))
      
      inline def setOnDragEndUndefined: Self = StObject.set(x, "onDragEnd", js.undefined)
      
      inline def setOnDragStart(value: /* itemProps */ Any => Callback): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1((t0: /* itemProps */ Any) => value(t0).runNow()))
      
      inline def setOnDragStartUndefined: Self = StObject.set(x, "onDragStart", js.undefined)
      
      inline def setOnUpdate(value: /* data */ ItemObject => Callback): Self = StObject.set(x, "onUpdate", js.Any.fromFunction1((t0: /* data */ ItemObject) => value(t0).runNow()))
      ...
      inline def setRenderAction(value: /* data */ IRenderData => Node): Self = StObject.set(x, "renderAction", js.Any.fromFunction1(value))
      
      inline def setRenderActionUndefined: Self = StObject.set(x, "renderAction", js.undefined)
      
      inline def setRenderItem(value: /* data */ IRenderData => Node): Self = StObject.set(x, "renderItem", js.Any.fromFunction1(value))
      
      inline def setRenderItemUndefined: Self = StObject.set(x, "renderItem", js.undefined)
      
      inline def setRenderPrefix(value: /* data */ IRenderData => Node): Self = StObject.set(x, "renderPrefix", js.Any.fromFunction1(value))
