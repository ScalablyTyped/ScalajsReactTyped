...
import typingsJapgolly.wixStyleReact.distTypesSelectableAccordionItemMod.SelectableAccordionItemCommonProps
...
object distTypesSelectableAccordionMod {
  ...
  object SelectableAccordionProps {
    ...
    extension [Self <: SelectableAccordionProps](x: Self) {
      ...
      inline def setOnSelectionChanged(value: /* selectedIds */ js.Array[Double] => Callback): Self = StObject.set(x, "onSelectionChanged", js.Any.fromFunction1((t0: /* selectedIds */ js.Array[Double]) => value(t0).runNow()))
