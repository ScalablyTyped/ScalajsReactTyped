...
import typingsJapgolly.wixStyleReact.anon.OverrideOptionStyleBoolean
import typingsJapgolly.wixStyleReact.anon.Suffix
...
object distTypesListItemSectionListItemSectionMod {
  ...
  inline def listItemSectionBuilder(hasIdClassNameDataHookTypeTitleSuffixEllipsis: Suffix): OverrideOptionStyleBoolean = ^.asInstanceOf[js.Dynamic].applyDynamic("listItemSectionBuilder")(hasIdClassNameDataHookTypeTitleSuffixEllipsis.asInstanceOf[js.Any]).asInstanceOf[OverrideOptionStyleBoolean]
