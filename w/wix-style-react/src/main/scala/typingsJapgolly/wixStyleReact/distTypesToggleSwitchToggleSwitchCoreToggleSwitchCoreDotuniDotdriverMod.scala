...
object distTypesToggleSwitchToggleSwitchCoreToggleSwitchCoreDotuniDotdriverMod {
  
  @JSImport("wix-style-react/dist/types/ToggleSwitch/ToggleSwitchCore/ToggleSwitchCore.uni.driver", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def toggleSwitchUniDriverFactory(base: UniDriver[Any]): ToggleSwitchCoreUniDriver = ^.asInstanceOf[js.Dynamic].applyDynamic("toggleSwitchUniDriverFactory")(base.asInstanceOf[js.Any]).asInstanceOf[ToggleSwitchCoreUniDriver]
  
  trait ToggleSwitchCoreUniDriver
    extends StObject
       with BaseUniDriver {
  ...
  object ToggleSwitchCoreUniDriver {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[ToggleSwitchCoreUniDriver]
    }
    
    extension [Self <: ToggleSwitchCoreUniDriver](x: Self) {
