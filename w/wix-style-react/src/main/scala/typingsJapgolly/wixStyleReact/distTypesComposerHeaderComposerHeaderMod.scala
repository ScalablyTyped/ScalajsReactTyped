...
import typingsJapgolly.wixStyleReact.anon.BackButtonValue
...
object distTypesComposerHeaderComposerHeaderMod {
  ...
  object default {
    ...
    /** ComposerHeader */
    inline def apply(hasChildrenDataHookSizeDropShadowBackButtonValueOnBackClick: BackButtonValue): Element = ^.asInstanceOf[js.Dynamic].apply(hasChildrenDataHookSizeDropShadowBackButtonValueOnBackClick.asInstanceOf[js.Any]).asInstanceOf[Element]
