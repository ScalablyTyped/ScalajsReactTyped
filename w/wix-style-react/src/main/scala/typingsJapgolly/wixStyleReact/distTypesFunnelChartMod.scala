...
object distTypesFunnelChartMod {
  ...
  object FunnelChartProps {
    ...
    extension [Self <: FunnelChartProps](x: Self) {
      ...
      inline def setOnDifferenceBadgeTooltipShow(value: /* hasCurrentIndexDifference */ percentageDifferenceCbData => Callback): Self = StObject.set(x, "onDifferenceBadgeTooltipShow", js.Any.fromFunction1((t0: /* hasCurrentIndexDifference */ percentageDifferenceCbData) => value(t0).runNow()))
