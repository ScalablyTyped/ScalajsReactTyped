...
import typingsJapgolly.wixStyleReact.anon.DisabledIdOverrideOptionStyle
import typingsJapgolly.wixStyleReact.anon.FocusedItemId
import typingsJapgolly.wixStyleReact.anon.HasLink
import typingsJapgolly.wixStyleReact.anon.IdLabel
import typingsJapgolly.wixStyleReact.anon.Idx
import typingsJapgolly.wixStyleReact.anon.Option
import typingsJapgolly.wixStyleReact.anon.OverrideOptionStyleOverrideStyle
import typingsJapgolly.wixStyleReact.anon.OverrideOptionStyleValue
import typingsJapgolly.wixStyleReact.anon.OverrideStyleValue
import typingsJapgolly.wixStyleReact.anon.Selected
...
object distTypesDropdownLayoutDropdownLayoutMod {
  ...
  trait DropdownLayout extends PureComponent[Any, Any, Any] {
    ...
    def _convertCustomOptionToBuilder(hasOption: Option): js.UndefOr[OverrideOptionStyleOverrideStyle | OverrideStyleValue] = js.native
    
    def _convertOptionToBuilder(option: Any, idx: Any): Any = js.native
    
    def _convertOptionToListItemActionBuilder(hasOptionIdx: Idx): DisabledIdOverrideOptionStyle = js.native
    
    def _convertOptionToListItemSectionBuilder(hasOptionIdx: Idx): js.UndefOr[OverrideOptionStyleValue] = js.native
    
    def _convertOptionToListItemSelectBuilder(hasOption: Option): IdLabel = js.native
    ...
    def _getItemDataAttr(hasHoveredSelectedDisabled: Selected): js.Object = js.native
    
    def _getMarkedIndex(): Any = js.native
    
    def _handleActionListNavigation(event: Any, id: Any): Unit = js.native
    
    def _isActionOption(hasOption: Option): Boolean = js.native
    
    def _isBuilderOption(hasOption: Option): Boolean = js.native
    
    def _isControlled(): Boolean = js.native
    
    def _isCustomOption(hasOption: Option): Any = js.native
    
    def _isItemSection(hasOption: Option): Any = js.native
    ...
    def _renderOption(hasOptionIdx: Idx): Element = js.native
    
    def _renderOptionContent(hasOptionIdxHasLink: HasLink): Element = js.native
