...
object distTypesAutoCompleteMod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.wixStyleReact.distTypesInputWithOptionsMod.default[ManualInputFnSignature, OnSelectFnSignature, AutoCompleteProps]
  
  type AutoComplete = typingsJapgolly.wixStyleReact.distTypesInputWithOptionsMod.default[ManualInputFnSignature, OnSelectFnSignature, AutoCompleteProps]
