...
import typingsJapgolly.wixStyleReact.anon.ApproveButtonTooltipContent
import typingsJapgolly.wixStyleReact.anon.DisabledBoolean
import typingsJapgolly.wixStyleReact.anon.ValueString
...
object distTypesListItemEditableListItemEditableMod {
  ...
  inline def listItemEditableBuilder(
    hasIdDataHookClassNameSizePlaceholderOnApproveOnCancelCancelButtonTooltipContentCancelButtonTooltipPropsApproveButtonTooltipContentApproveButtonTooltipPropsStatusStatusMessageMargins: ApproveButtonTooltipContent
  ): DisabledBoolean = ^.asInstanceOf[js.Dynamic].applyDynamic("listItemEditableBuilder")(hasIdDataHookClassNameSizePlaceholderOnApproveOnCancelCancelButtonTooltipContentCancelButtonTooltipPropsApproveButtonTooltipContentApproveButtonTooltipPropsStatusStatusMessageMargins.asInstanceOf[js.Any]).asInstanceOf[DisabledBoolean]
