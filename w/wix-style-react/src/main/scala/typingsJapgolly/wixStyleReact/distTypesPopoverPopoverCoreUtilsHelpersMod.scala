...
object distTypesPopoverPopoverCoreUtilsHelpersMod {
  
  object popoverTestUtils {
    
    @JSImport("wix-style-react/dist/types/Popover/PopoverCore/utils/helpers", "popoverTestUtils")
    @js.native
