...
object distTypesEditableSelectorMod {
  ...
  type EditableSelector = japgolly.scalajs.react.facade.React.Component[EditableSelectorProps & js.Object, js.Object]
  ...
  object EditableSelectorProps {
    ...
    extension [Self <: EditableSelectorProps](x: Self) {
      ...
      inline def setOnOptionAdded(value: /* title */ String => Callback): Self = StObject.set(x, "onOptionAdded", js.Any.fromFunction1((t0: /* title */ String) => value(t0).runNow()))
      
      inline def setOnOptionAddedUndefined: Self = StObject.set(x, "onOptionAdded", js.undefined)
      
      inline def setOnOptionDelete(value: /* id */ Double => Callback): Self = StObject.set(x, "onOptionDelete", js.Any.fromFunction1((t0: /* id */ Double) => value(t0).runNow()))
      
      inline def setOnOptionDeleteUndefined: Self = StObject.set(x, "onOptionDelete", js.undefined)
      
      inline def setOnOptionEdit(value: (/* title */ String, /* id */ Double) => Callback): Self = StObject.set(x, "onOptionEdit", js.Any.fromFunction2((t0: /* title */ String, t1: /* id */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnOptionEditUndefined: Self = StObject.set(x, "onOptionEdit", js.undefined)
      
      inline def setOnOptionToggle(value: /* id */ Double => Callback): Self = StObject.set(x, "onOptionToggle", js.Any.fromFunction1((t0: /* id */ Double) => value(t0).runNow()))
