...
object distTypesColorInputMod {
  ...
  type ColorInput = japgolly.scalajs.react.facade.React.Component[ColorInputProps & js.Object, js.Object]
  ...
  trait ColorInputProps extends StObject {
    ...
    var colorPickerChildren: js.UndefOr[Node] = js.undefined
  ...
  object ColorInputProps {
    ...
    extension [Self <: ColorInputProps](x: Self) {
      ...
      inline def setColorPickerChildren(value: VdomNode): Self = StObject.set(x, "colorPickerChildren", value.rawNode.asInstanceOf[js.Any])
      
      inline def setColorPickerChildrenNull: Self = StObject.set(x, "colorPickerChildren", null)
      
      inline def setColorPickerChildrenUndefined: Self = StObject.set(x, "colorPickerChildren", js.undefined)
      
      inline def setColorPickerChildrenVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "colorPickerChildren", js.Array(value*))
      
      inline def setColorPickerChildrenVdomElement(value: VdomElement): Self = StObject.set(x, "colorPickerChildren", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnAddColor(value: /* color */ String | js.Object => Callback): Self = StObject.set(x, "onAddColor", js.Any.fromFunction1((t0: /* color */ String | js.Object) => value(t0).runNow()))
      ...
      inline def setOnCancel(value: /* color */ String | js.Object => Callback): Self = StObject.set(x, "onCancel", js.Any.fromFunction1((t0: /* color */ String | js.Object) => value(t0).runNow()))
      
      inline def setOnCancelUndefined: Self = StObject.set(x, "onCancel", js.undefined)
      
      inline def setOnChange(value: /* color */ String | js.Object => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* color */ String | js.Object) => value(t0).runNow()))
      ...
      inline def setOnConfirm(value: /* color */ String | js.Object => Callback): Self = StObject.set(x, "onConfirm", js.Any.fromFunction1((t0: /* color */ String | js.Object) => value(t0).runNow()))
