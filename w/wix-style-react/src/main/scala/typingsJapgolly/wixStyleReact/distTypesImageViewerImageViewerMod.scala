...
import typingsJapgolly.wixStyleReact.anon.CurrentImageUrl
import typingsJapgolly.wixStyleReact.anon.ImageLoading
import typingsJapgolly.wixStyleReact.anon.ImageUrl
...
object distTypesImageViewerImageViewerMod {
  ...
  trait ImageViewer extends Component[Any, Any, Any] {
    ...
    def _renderImageElement(hasImageUrlShouldDisplayOnLoadOnErrorKeyDataHook: ImageUrl): Element = js.native
    ...
    var focusNode: RefHandle[Any] = js.native
