...
import typingsJapgolly.wixStyleReact.anon.AddedToContainerId
import typingsJapgolly.wixStyleReact.anon.Columns
import typingsJapgolly.wixStyleReact.anon.Droppable
import typingsJapgolly.wixStyleReact.anon.IsPlaceholderItem
import typingsJapgolly.wixStyleReact.anon.ItemAny
...
object distTypesTimeTableTimeTableMod {
  ...
  trait TimeTable extends PureComponent[Any, Any, Any] {
    ...
    def _handleCanDrag(hasItem: ItemAny): Boolean = js.native
    
    def _handleDragEnd(): Unit = js.native
    
    def _handleDragStart(): Unit = js.native
    
    def _handleDrop(hasAddedItemIndexRemovedItemIndexAddedToContainerIdRemovedFromContainerId: AddedToContainerId): Unit = js.native
    ...
    def _renderItem(hasIsPlaceholderPreviewStylesHasContentDisabledDraggable: IsPlaceholderItem): Element = js.native
