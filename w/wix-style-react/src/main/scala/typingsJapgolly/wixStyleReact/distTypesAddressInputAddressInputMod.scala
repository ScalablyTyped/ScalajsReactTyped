...
import typingsJapgolly.wixStyleReact.anon.Disabled
import typingsJapgolly.wixStyleReact.anon.Id
import typingsJapgolly.wixStyleReact.anon.InputValue
...
object distTypesAddressInputAddressInputMod {
  ...
  trait AddressInput extends PureComponent[Any, Any, Any] {
    ...
    var innerRef: RefHandle[Any] = js.native
