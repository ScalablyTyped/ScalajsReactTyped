...
object distTypesSidebarHeaderMod {
  
  @JSImport("wix-style-react/dist/types/SidebarHeader", JSImport.Default)
  @js.native
  open class default ()
    extends PureComponent[SidebarHeaderProps, js.Object, Any]
  
  type SidebarHeader = PureComponent[SidebarHeaderProps, js.Object, Any]
