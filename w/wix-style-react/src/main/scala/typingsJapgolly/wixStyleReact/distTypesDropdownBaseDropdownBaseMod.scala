...
import typingsJapgolly.wixStyleReact.anon.ListAutoFocus
import typingsJapgolly.wixStyleReact.anon.OverrideStyle
import typingsJapgolly.wixStyleReact.anon.ReadonlychildrenReactNode
import typingsJapgolly.wixStyleReact.anon.ValueRequireable
import typingsJapgolly.wixStyleReact.anon.X
...
object distTypesDropdownBaseDropdownBaseMod {
  ...
  trait DropdownBase extends PureComponent[Any, Any, Any] {
    ...
    var triggerElementRef: RefHandle[Any] = js.native
  }
}
