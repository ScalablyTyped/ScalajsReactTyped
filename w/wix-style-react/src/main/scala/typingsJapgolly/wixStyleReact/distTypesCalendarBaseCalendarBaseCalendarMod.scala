...
object distTypesCalendarBaseCalendarBaseCalendarMod {
  ...
  trait BaseCalendarProps extends StObject {
    ...
    var captionElement: Element | (ComponentClassP[
        (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify CaptionElementProps */ Any) & js.Object
      ]) | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify React.SFC<CaptionElementProps> */ Any) = js.native
