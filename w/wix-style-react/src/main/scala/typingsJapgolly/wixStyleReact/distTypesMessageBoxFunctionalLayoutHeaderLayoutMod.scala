...
import typingsJapgolly.wixStyleReact.anon.CloseButton
...
object distTypesMessageBoxFunctionalLayoutHeaderLayoutMod {
  ...
  object default {
    ...
    inline def apply(hasTitleOnCancelThemeCloseButtonAppearanceNewColorsBranding: CloseButton): Element = ^.asInstanceOf[js.Dynamic].apply(hasTitleOnCancelThemeCloseButtonAppearanceNewColorsBranding.asInstanceOf[js.Any]).asInstanceOf[Element]
