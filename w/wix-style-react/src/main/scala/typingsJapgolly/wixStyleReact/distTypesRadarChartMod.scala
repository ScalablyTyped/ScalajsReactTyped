...
object distTypesRadarChartMod {
  ...
  object DataPoint {
    ...
    inline def apply(color: String, label: String, tooltipContent: VdomElement, value: Double): DataPoint = {
      val __obj = js.Dynamic.literal(color = color.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any], tooltipContent = tooltipContent.rawElement.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    ...
    extension [Self <: DataPoint](x: Self) {
      ...
      inline def setTooltipContent(value: VdomElement): Self = StObject.set(x, "tooltipContent", value.rawElement.asInstanceOf[js.Any])
  ...
  object RadarChartProps {
    ...
    extension [Self <: RadarChartProps](x: Self) {
      ...
      inline def setOnDataPointHover(value: Callback): Self = StObject.set(x, "onDataPointHover", value.toJsFn)
