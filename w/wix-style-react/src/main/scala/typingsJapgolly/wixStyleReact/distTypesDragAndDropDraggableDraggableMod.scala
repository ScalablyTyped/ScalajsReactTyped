...
import typingsJapgolly.wixStyleReact.anon.ContainerId
import typingsJapgolly.wixStyleReact.anon.Delayed
import typingsJapgolly.wixStyleReact.anon.ListOfPropsThatAffectItems
...
object distTypesDragAndDropDraggableDraggableMod {
  ...
  open class Draggable protected () extends Component[Any, Any, Any] {
    ...
    def canDrag(hasIdIndexContainerIdGroupNameItem: ContainerId): Any = js.native
    ...
    def onDragEnd(hasIdIndexContainerIdGroupNameItem: ContainerId): Unit = js.native
    
    def onDragStart(hasIdIndexContainerIdGroupNameItem: ContainerId): Unit = js.native
    ...
    def shouldComponentUpdate_MDraggable(hasListOfPropsThatAffectItemsNextProps: ListOfPropsThatAffectItems, nextState: Any): Boolean = js.native
