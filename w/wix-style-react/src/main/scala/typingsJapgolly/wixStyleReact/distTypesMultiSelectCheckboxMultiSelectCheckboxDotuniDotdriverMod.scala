...
import typingsJapgolly.wixStyleReact.anon.getNumOfLabelsPromisenumb
...
object distTypesMultiSelectCheckboxMultiSelectCheckboxDotuniDotdriverMod {
  ...
  trait MultiSelectCheckboxUniDriver extends StObject {
    ...
    var driver: getNumOfLabelsPromisenumb = js.native
    ...
    @JSName("exists")
    var exists_FMultiSelectCheckboxUniDriver: js.Function0[js.Promise[Boolean]] = js.native
