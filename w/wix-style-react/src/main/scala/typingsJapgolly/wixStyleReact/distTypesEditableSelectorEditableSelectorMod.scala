...
import typingsJapgolly.wixStyleReact.anon.AddingNewRow
import typingsJapgolly.wixStyleReact.anon.Index
import typingsJapgolly.wixStyleReact.anon.IsSelected
...
object distTypesEditableSelectorEditableSelectorMod {
  ...
  trait EditableSelector extends PureComponent[Any, Any, Any] {
    ...
    def _onNewOptionApprove(hasNewTitleIndex: Index): Unit = js.native
