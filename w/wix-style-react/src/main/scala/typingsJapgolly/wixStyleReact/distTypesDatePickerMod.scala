...
object distTypesDatePickerMod {
  ...
  trait DatePickerProps extends StObject {
    ...
    var customInput: js.UndefOr[Node] = js.undefined
    ...
    var onValidate: js.UndefOr[js.Function1[/* hasValidationTypeFormatValue */ Format, Unit]] = js.undefined
  ...
  object DatePickerProps {
    ...
    extension [Self <: DatePickerProps](x: Self) {
      ...
      inline def setCustomInput(value: VdomNode): Self = StObject.set(x, "customInput", value.rawNode.asInstanceOf[js.Any])
      ...
      inline def setOnValidate(value: /* hasValidationTypeFormatValue */ Format => Callback): Self = StObject.set(x, "onValidate", js.Any.fromFunction1((t0: /* hasValidationTypeFormatValue */ Format) => value(t0).runNow()))
