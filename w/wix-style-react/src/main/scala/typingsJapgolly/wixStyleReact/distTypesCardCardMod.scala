...
import typingsJapgolly.wixStyleReact.anon.Controls
...
object distTypesCardCardMod {
  ...
  object default {
    ...
    inline def apply(hasStretchVerticallyShowShadowHideOverflowClassNameChildrenControlsDataHook: Controls): Element = ^.asInstanceOf[js.Dynamic].apply(hasStretchVerticallyShowShadowHideOverflowClassNameChildrenControlsDataHook.asInstanceOf[js.Any]).asInstanceOf[Element]
