...
object distTypesProvidersUsePlacesAutocompleteAutocompleteClientMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.wixStyleReact.distTypesProvidersUsePlacesAutocompleteAutocompleteClientMod.ReadyAutocompleteClient[Prediction, Address, RequestOptions]
    - typingsJapgolly.wixStyleReact.distTypesProvidersUsePlacesAutocompleteAutocompleteClientMod.NotReadyAutocompleteClient
  */
  trait AutocompleteClient[Prediction, Address, RequestOptions] extends StObject
  object AutocompleteClient {
    
    inline def NotReadyAutocompleteClient(): typingsJapgolly.wixStyleReact.distTypesProvidersUsePlacesAutocompleteAutocompleteClientMod.NotReadyAutocompleteClient = {
      val __obj = js.Dynamic.literal(ready = false)
      __obj.asInstanceOf[typingsJapgolly.wixStyleReact.distTypesProvidersUsePlacesAutocompleteAutocompleteClientMod.NotReadyAutocompleteClient]
    }
    ...
    inline def ReadyAutocompleteClient[Prediction, Address, RequestOptions](
      ...
      __obj.asInstanceOf[typingsJapgolly.wixStyleReact.distTypesProvidersUsePlacesAutocompleteAutocompleteClientMod.ReadyAutocompleteClient[Prediction, Address, RequestOptions]]
    }
  }
