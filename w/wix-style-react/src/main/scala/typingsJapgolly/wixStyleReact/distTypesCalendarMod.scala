...
object distTypesCalendarMod {
  ...
  object CalendarProps {
    ...
    extension [Self <: CalendarProps](x: Self) {
      ...
      inline def setOnMonthChange(value: /* monthStart */ js.Date => Callback): Self = StObject.set(x, "onMonthChange", js.Any.fromFunction1((t0: /* monthStart */ js.Date) => value(t0).runNow()))
