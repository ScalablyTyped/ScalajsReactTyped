...
object distTypesTagMod {
  
  @JSImport("wix-style-react/dist/types/Tag", JSImport.Default)
  @js.native
  open class default ()
    extends PureComponent[TagProps, js.Object, Any]
  
  type Tag = PureComponent[TagProps, js.Object, Any]
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.wixStyleReact.wixStyleReactStrings.lightOutlined
  */
  ...
  object TagTheme {
    ...
    inline def lightOutlined: typingsJapgolly.wixStyleReact.wixStyleReactStrings.lightOutlined = "lightOutlined".asInstanceOf[typingsJapgolly.wixStyleReact.wixStyleReactStrings.lightOutlined]
