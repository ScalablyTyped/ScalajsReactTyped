...
import typingsJapgolly.wixStyleReact.anon.Checkbox
...
object distTypesListItemSelectListItemSelectMod {
  ...
  inline def listItemSelectBuilder(
    hasIdClassNameCheckboxPrefixTitleLabelSubtitleSuffixDisabledSizeEllipsisDataHookTooltipProps: Checkbox
  ): Label = ^.asInstanceOf[js.Dynamic].applyDynamic("listItemSelectBuilder")(hasIdClassNameCheckboxPrefixTitleLabelSubtitleSuffixDisabledSizeEllipsisDataHookTooltipProps.asInstanceOf[js.Any]).asInstanceOf[Label]
