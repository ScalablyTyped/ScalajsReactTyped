...
object distTypesCopyClipboardMod {
  ...
  trait CopyClipboardProps extends StObject {
    ...
    def children(params: CopyClipboardChildrenProps): Node
  ...
  object CopyClipboardProps {
    ...
    inline def apply(children: CopyClipboardChildrenProps => Node, value: String): CopyClipboardProps = {
    ...
    extension [Self <: CopyClipboardProps](x: Self) {
      ...
      inline def setChildren(value: CopyClipboardChildrenProps => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
