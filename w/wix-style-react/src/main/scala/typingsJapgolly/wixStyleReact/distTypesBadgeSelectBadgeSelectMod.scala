...
import typingsJapgolly.wixStyleReact.anon.Ellipsis
import typingsJapgolly.wixStyleReact.anon.IdAny
import typingsJapgolly.wixStyleReact.anon.OverrideOptionStyle
import typingsJapgolly.wixStyleReact.anon.SelectedBadge
...
object distTypesBadgeSelectBadgeSelectMod {
  ...
  trait BadgeSelect extends Component[Any, Any, Any] {
    ...
    def _handleSelect(hasSelectedId: IdAny): Unit = js.native
    ...
    var badge: js.UndefOr[typingsJapgolly.wixStyleReact.distTypesBadgeMod.default | Null] = js.native
    
    var dropdownLayout: js.UndefOr[typingsJapgolly.wixStyleReact.distTypesDropdownLayoutMod.default | Null] = js.native
