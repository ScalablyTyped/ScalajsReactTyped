...
import typingsJapgolly.wixStyleReact.anon.LabelSize
import typingsJapgolly.wixStyleReact.anon.LengthLeft
import typingsJapgolly.wixStyleReact.anon.SetCharactersLeft
import typingsJapgolly.wixStyleReact.anon.TrimLongText
...
object distTypesFormFieldFormFieldMod {
  ...
  trait FormField extends Component[Any, Any, Any] {
    ...
    def _renderLabel(hasTrimLongTextLabelSize: TrimLongText): Element = js.native
    
    def _renderLabelWithIndicators(hasLabelSize: LabelSize): Element = js.native
