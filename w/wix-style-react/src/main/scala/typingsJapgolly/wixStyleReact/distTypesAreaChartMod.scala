...
object distTypesAreaChartMod {
  ...
  object AreaChartProps {
    ...
    extension [Self <: AreaChartProps](x: Self) {
      ...
      inline def setOnTooltipShow(value: /* item */ IDatasetItem => Callback): Self = StObject.set(x, "onTooltipShow", js.Any.fromFunction1((t0: /* item */ IDatasetItem) => value(t0).runNow()))
