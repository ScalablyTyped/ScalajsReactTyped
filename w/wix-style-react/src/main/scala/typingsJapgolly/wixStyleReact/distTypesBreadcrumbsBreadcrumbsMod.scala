...
import typingsJapgolly.wixStyleReact.anon.CustomElement
import typingsJapgolly.wixStyleReact.anon.Datahook
import typingsJapgolly.wixStyleReact.anon.IsActive
import typingsJapgolly.wixStyleReact.anon.Item
...
object distTypesBreadcrumbsBreadcrumbsMod {
  ...
  trait Breadcrumbs extends PureComponent[Any, Any, Any] {
    ...
    def _createItem(hasItemIsActiveOnClickMaxWidthId: IsActive): Element = js.native
    
    def _getIsActive(item: Any): Boolean = js.native
    
    def _getItemWrapperDataAttributes(hasPositionItem: Item): Datahook = js.native
