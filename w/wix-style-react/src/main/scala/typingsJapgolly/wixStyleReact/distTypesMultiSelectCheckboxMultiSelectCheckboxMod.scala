...
import typingsJapgolly.wixStyleReact.anon.InputElement
import typingsJapgolly.wixStyleReact.anon.ReadonlyInputWithOptionsP
import typingsJapgolly.wixStyleReact.anon.SelectedHighlight
import typingsJapgolly.wixStyleReact.anon.ValueAny
...
object distTypesMultiSelectCheckboxMultiSelectCheckboxMod {
  ...
  trait MultiSelectCheckbox
    ...
    def _isDivider(hasValue: ValueAny): Boolean = js.native
    
    def _isUsingCustomRenderFunction(hasValue: ValueAny): Boolean = js.native
