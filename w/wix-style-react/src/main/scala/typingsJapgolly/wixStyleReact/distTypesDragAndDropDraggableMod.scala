...
object distTypesDragAndDropDraggableMod {
  ...
  type Draggable = japgolly.scalajs.react.facade.React.Component[DraggableProps & js.Object, js.Object]
  ...
  trait DraggableProps extends StObject {
    ...
    var renderItem: js.UndefOr[js.Function1[/* data */ js.Object, Node]] = js.undefined
  ...
  object DraggableProps {
    ...
    extension [Self <: DraggableProps](x: Self) {
      ...
      inline def setCanDrag(value: /* params */ DragEventParams => Callback): Self = StObject.set(x, "canDrag", js.Any.fromFunction1((t0: /* params */ DragEventParams) => value(t0).runNow()))
      ...
      inline def setOnDragEnd(value: /* params */ DragEventParams => Callback): Self = StObject.set(x, "onDragEnd", js.Any.fromFunction1((t0: /* params */ DragEventParams) => value(t0).runNow()))
      
      inline def setOnDragEndUndefined: Self = StObject.set(x, "onDragEnd", js.undefined)
      
      inline def setOnDragStart(value: /* params */ DragEventParams => Callback): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1((t0: /* params */ DragEventParams) => value(t0).runNow()))
      ...
      inline def setOnHover(value: /* params */ AddedIndex => Callback): Self = StObject.set(x, "onHover", js.Any.fromFunction1((t0: /* params */ AddedIndex) => value(t0).runNow()))
      
      inline def setOnHoverUndefined: Self = StObject.set(x, "onHover", js.undefined)
      
      inline def setOnMoveOut(value: /* id */ Any => Callback): Self = StObject.set(x, "onMoveOut", js.Any.fromFunction1((t0: /* id */ Any) => value(t0).runNow()))
      
      inline def setOnMoveOutUndefined: Self = StObject.set(x, "onMoveOut", js.undefined)
      
      inline def setRenderItem(value: /* data */ js.Object => Node): Self = StObject.set(x, "renderItem", js.Any.fromFunction1(value))
      
      inline def setRenderItemUndefined: Self = StObject.set(x, "renderItem", js.undefined)
      
      inline def setSetWrapperNode(value: (/* node */ HTMLElement, /* index */ Double, /* item */ js.Object) => Callback): Self = StObject.set(x, "setWrapperNode", js.Any.fromFunction3((t0: /* node */ HTMLElement, t1: /* index */ Double, t2: /* item */ js.Object) => (value(t0, t1, t2)).runNow()))
