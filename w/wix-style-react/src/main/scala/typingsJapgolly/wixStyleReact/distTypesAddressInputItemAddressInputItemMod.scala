...
import typingsJapgolly.wixStyleReact.anon.ClassName
import typingsJapgolly.wixStyleReact.anon.Label
...
object distTypesAddressInputItemAddressInputItemMod {
  ...
  inline def addressInputItemBuilder(
    hasIdClassNamePrefixMainLabelSecondaryLabelSuffixDisabledDataHookOptionLayoutOnClickDisplayLabel: ClassName
  ): Label = ^.asInstanceOf[js.Dynamic].applyDynamic("addressInputItemBuilder")(hasIdClassNamePrefixMainLabelSecondaryLabelSuffixDisabledDataHookOptionLayoutOnClickDisplayLabel.asInstanceOf[js.Any]).asInstanceOf[Label]
