...
object distTypesDropdownMod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.wixStyleReact.distTypesInputWithOptionsMod.default[ManualInputFnSignature, OnSelectFnSignature, DropdownProps]
  
  type Dropdown = typingsJapgolly.wixStyleReact.distTypesInputWithOptionsMod.default[ManualInputFnSignature, OnSelectFnSignature, DropdownProps]
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.wixStyleReact.distTypesDropdownMod.DropdownPropsControlled
    - typingsJapgolly.wixStyleReact.distTypesDropdownMod.DropdownPropsUncontrolled
  */
  trait DropdownProps extends StObject
  object DropdownProps {
    
    inline def DropdownPropsControlled(): typingsJapgolly.wixStyleReact.distTypesDropdownMod.DropdownPropsControlled = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.wixStyleReact.distTypesDropdownMod.DropdownPropsControlled]
    }
    
    inline def DropdownPropsUncontrolled(): typingsJapgolly.wixStyleReact.distTypesDropdownMod.DropdownPropsUncontrolled = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.wixStyleReact.distTypesDropdownMod.DropdownPropsUncontrolled]
    }
  }
