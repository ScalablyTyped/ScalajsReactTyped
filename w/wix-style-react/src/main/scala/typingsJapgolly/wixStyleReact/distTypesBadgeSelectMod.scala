...
import typingsJapgolly.wixStyleReact.distTypesBadgeSelectItemMod.BadgeSelectItem
...
object distTypesBadgeSelectMod {
  ...
  object BadgeSelectProps {
    ...
    extension [Self <: BadgeSelectProps](x: Self) {
      ...
      inline def setOnSelect(value: /* option */ BadgeSelectItem => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction1((t0: /* option */ BadgeSelectItem) => value(t0).runNow()))
