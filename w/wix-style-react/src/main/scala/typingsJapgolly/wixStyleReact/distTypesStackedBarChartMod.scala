...
object distTypesStackedBarChartMod {
  ...
  trait StackedBarChartProps extends StObject {
    ...
    var tooltipTemplate: js.UndefOr[js.Function1[/* item */ item, Node]] = js.undefined
  ...
  object StackedBarChartProps {
    ...
    extension [Self <: StackedBarChartProps](x: Self) {
      ...
      inline def setTooltipTemplate(value: /* item */ item => Node): Self = StObject.set(x, "tooltipTemplate", js.Any.fromFunction1(value))
