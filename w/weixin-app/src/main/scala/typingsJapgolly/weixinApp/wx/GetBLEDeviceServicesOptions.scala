...
import typingsJapgolly.weixinApp.servicesArrayuuidstringis
...
object GetBLEDeviceServicesOptions {
  ...
  def apply(
    ...
    __obj.updateDynamic("success")(js.Any.fromFunction1((t0: typingsJapgolly.weixinApp.servicesArrayuuidstringis) => success(t0).runNow()))
