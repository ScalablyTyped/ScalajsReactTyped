...
object compressImageOptions {
  ...
  inline def apply(src: String, success: String => Callback): compressImageOptions = {
    val __obj = js.Dynamic.literal(src = src.asInstanceOf[js.Any], success = js.Any.fromFunction1((t0: String) => success(t0).runNow()))
