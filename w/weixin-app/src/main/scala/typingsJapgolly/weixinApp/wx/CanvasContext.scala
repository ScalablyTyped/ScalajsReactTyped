...
import typingsJapgolly.weixinApp.weixinAppStrings.center
import typingsJapgolly.weixinApp.weixinAppStrings.left
import typingsJapgolly.weixinApp.weixinAppStrings.right
