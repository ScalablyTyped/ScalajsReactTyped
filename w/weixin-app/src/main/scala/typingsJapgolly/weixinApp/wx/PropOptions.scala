...
object PropOptions {
  @scala.inline
  def apply[T](
    observer: (/* value */ T, /* old */ T, /* changedPath */ String) => Callback = null,
    `type`: Prop[T] | js.Array[Prop[T]] = null,
    value: T | js.Function0[js.Object] = null
  ): PropOptions[T] = {
    val __obj = js.Dynamic.literal()
    if (observer != null) __obj.updateDynamic("observer")(js.Any.fromFunction3((t0: /* value */ T, t1: /* old */ T, t2: /* changedPath */ java.lang.String) => observer(t0, t1, t2).runNow()))
