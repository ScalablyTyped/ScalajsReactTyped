...
import typingsJapgolly.weixinApp.AnonTempImagePath
...
object TakePhotoOptions {
  ...
  def apply(
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.weixinApp.AnonTempImagePath) => success(t0).runNow()))
