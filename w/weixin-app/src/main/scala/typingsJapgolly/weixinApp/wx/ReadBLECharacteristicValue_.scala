...
import typingsJapgolly.weixinApp.characteristiccharacteris
...
object ReadBLECharacteristicValue_ {
  ...
  def apply(
    ...
    __obj.updateDynamic("success")(js.Any.fromFunction1((t0: typingsJapgolly.weixinApp.characteristiccharacteris) => success(t0).runNow()))
