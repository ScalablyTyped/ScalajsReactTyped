...
object ComponentRelation {
  ...
  extension [Self <: ComponentRelation[?, ?], D, P](x: Self & (ComponentRelation[D, P])) {
    ...
    inline def setLinkChanged(value: /* target */ Component[D, P, js.Array[Any]] => Callback): Self = StObject.set(x, "linkChanged", js.Any.fromFunction1((t0: /* target */ Component[D, P, js.Array[Any]]) => value(t0).runNow()))
    
    inline def setLinkChangedUndefined: Self = StObject.set(x, "linkChanged", js.undefined)
    
    inline def setLinked(value: /* target */ Component[D, P, js.Array[Any]] => Callback): Self = StObject.set(x, "linked", js.Any.fromFunction1((t0: /* target */ Component[D, P, js.Array[Any]]) => value(t0).runNow()))
    ...
    inline def setUnlinked(value: /* target */ Component[D, P, js.Array[Any]] => Callback): Self = StObject.set(x, "unlinked", js.Any.fromFunction1((t0: /* target */ Component[D, P, js.Array[Any]]) => value(t0).runNow()))
