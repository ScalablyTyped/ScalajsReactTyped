...
import typingsJapgolly.weixinApp.AnonBankAccount
...
object ChooseInvoiceTitleOptions {
  ...
  def apply(
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.weixinApp.AnonBankAccount) => success(t0).runNow()))
