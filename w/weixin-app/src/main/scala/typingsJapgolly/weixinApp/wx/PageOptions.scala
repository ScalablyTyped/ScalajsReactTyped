...
import typingsJapgolly.weixinApp.AnonScrollTop
...
object PageOptions {
  ...
  def apply(
    ...
    if (onPageScroll != null) __obj.updateDynamic("onPageScroll")(js.Any.fromFunction1((t0: /* option */ typingsJapgolly.weixinApp.AnonScrollTop) => onPageScroll(t0).runNow()))
    ...
    if (onShareAppMessage != null) __obj.updateDynamic("onShareAppMessage")(js.Any.fromFunction1((t0: /* options */ js.UndefOr[typingsJapgolly.weixinApp.wx.PageShareAppMessageOptions]) => onShareAppMessage(t0).runNow()))
