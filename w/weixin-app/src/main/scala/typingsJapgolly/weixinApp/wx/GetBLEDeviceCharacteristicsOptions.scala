...
import typingsJapgolly.weixinApp.characteristicsArrayuuids
...
object GetBLEDeviceCharacteristicsOptions {
  ...
  def apply(
    deviceId: String,
    serviceId: String,
    success: characteristicsArrayuuids => Callback,
    ...
    __obj.updateDynamic("success")(js.Any.fromFunction1((t0: typingsJapgolly.weixinApp.characteristicsArrayuuids) => success(t0).runNow()))
