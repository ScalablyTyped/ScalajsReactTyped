...
import typingsJapgolly.weixinApp.AnonEnv
...
object Cloud {
  ...
  def apply(
    ...
    __obj.updateDynamic("database")(js.Any.fromFunction1((t0: typingsJapgolly.weixinApp.AnonEnv) => database(t0).runNow()))
    __obj.updateDynamic("init")(js.Any.fromFunction1((t0: typingsJapgolly.weixinApp.wx.InitCloudOptions) => init(t0).runNow()))
