...
object AppOptions {
  ...
  def apply(
    ...
    if (onLaunch != null) __obj.updateDynamic("onLaunch")(js.Any.fromFunction1((t0: /* option */ typingsJapgolly.weixinApp.wx.LaunchOptions) => onLaunch(t0).runNow()))
    if (onShow != null) __obj.updateDynamic("onShow")(js.Any.fromFunction1((t0: /* option */ typingsJapgolly.weixinApp.wx.LaunchOptions) => onShow(t0).runNow()))
