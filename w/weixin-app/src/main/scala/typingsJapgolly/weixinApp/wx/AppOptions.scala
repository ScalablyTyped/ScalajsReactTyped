...
object AppOptions {
  ...
  extension [Self <: AppOptions](x: Self) {
    ...
    inline def setOnError(value: /* msg */ String => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* msg */ String) => value(t0).runNow()))
    ...
    inline def setOnLaunch(value: /* option */ LaunchOptions => Callback): Self = StObject.set(x, "onLaunch", js.Any.fromFunction1((t0: /* option */ LaunchOptions) => value(t0).runNow()))
    
    inline def setOnLaunchUndefined: Self = StObject.set(x, "onLaunch", js.undefined)
    
    inline def setOnShow(value: /* option */ LaunchOptions => Callback): Self = StObject.set(x, "onShow", js.Any.fromFunction1((t0: /* option */ LaunchOptions) => value(t0).runNow()))
    
    inline def setOnShowUndefined: Self = StObject.set(x, "onShow", js.undefined)
    
    inline def setOnUnlaunch(value: Callback): Self = StObject.set(x, "onUnlaunch", value.toJsFn)
