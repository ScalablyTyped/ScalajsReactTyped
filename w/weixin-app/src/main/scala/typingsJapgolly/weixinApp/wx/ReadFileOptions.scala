...
import typingsJapgolly.weixinApp.anon.Data
...
object ReadFileOptions {
  ...
  extension [Self <: ReadFileOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ Data => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ Data) => value(t0).runNow()))
