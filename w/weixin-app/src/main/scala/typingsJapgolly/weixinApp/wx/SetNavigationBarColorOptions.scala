...
import typingsJapgolly.weixinApp.anon.Duration
import typingsJapgolly.weixinApp.weixinAppStrings.Numbersign000000
import typingsJapgolly.weixinApp.weixinAppStrings.Numbersignffffff
