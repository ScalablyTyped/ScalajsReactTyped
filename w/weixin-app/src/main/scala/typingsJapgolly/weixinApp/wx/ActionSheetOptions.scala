...
import typingsJapgolly.weixinApp.AnonTapIndex
...
object ActionSheetOptions {
  ...
  def apply(
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.weixinApp.AnonTapIndex) => success(t0).runNow()))
