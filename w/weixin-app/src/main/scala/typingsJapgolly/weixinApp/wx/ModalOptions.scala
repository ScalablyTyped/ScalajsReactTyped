...
import typingsJapgolly.weixinApp.anon.Cancel
...
object ModalOptions {
  ...
  extension [Self <: ModalOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ Cancel => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ Cancel) => value(t0).runNow()))
