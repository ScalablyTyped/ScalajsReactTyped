...
import typingsJapgolly.weixinApp.PartialLifetimes
import typingsJapgolly.weixinApp.PartialPageLifetimes
import typingsJapgolly.weixinApp.PartialaddGlobalClassbool
