...
import typingsJapgolly.weixinApp.anon.PartialLifetimes
import typingsJapgolly.weixinApp.anon.PartialPageLifetimes
import typingsJapgolly.weixinApp.anon.PartialaddGlobalClassbool
