package typingsJapgolly.whoisJson

import typingsJapgolly.whoisJson.mod.Whois.Options
import typingsJapgolly.whoisJson.mod.Whois.Result
...
object mod {
  ...
  object Whois {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.whoisJson.whoisJsonInts.`4`
      - typingsJapgolly.whoisJson.whoisJsonInts.`5`
    */
    trait SocksProtocolVersion extends StObject
    object SocksProtocolVersion {
      
      inline def `4`: typingsJapgolly.whoisJson.whoisJsonInts.`4` = 4.asInstanceOf[typingsJapgolly.whoisJson.whoisJsonInts.`4`]
      
      inline def `5`: typingsJapgolly.whoisJson.whoisJsonInts.`5` = 5.asInstanceOf[typingsJapgolly.whoisJson.whoisJsonInts.`5`]
    }
