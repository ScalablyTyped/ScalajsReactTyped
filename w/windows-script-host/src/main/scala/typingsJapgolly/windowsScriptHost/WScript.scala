package typingsJapgolly.windowsScriptHost

import typingsJapgolly.activexIwshruntimelibrary.IWshRuntimeLibrary.TextStreamReader
import typingsJapgolly.activexIwshruntimelibrary.IWshRuntimeLibrary.TextStreamWriter
