package typingsJapgolly.winjs.WinJS.Binding
...
@js.native
object setAttributeOneTime extends js.Object {
  /**
    ...
    **/
  def apply(source: js.Any, sourceProperties: js.Array[_], dest: Element, destProperties: js.Array[_]): Unit = js.native
}
