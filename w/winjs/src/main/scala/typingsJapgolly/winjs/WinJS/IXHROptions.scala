...
object IXHROptions {
  ...
  extension [Self <: IXHROptions](x: Self) {
    ...
    inline def setCustomRequestInitializer(value: /* request */ XMLHttpRequest => Callback): Self = StObject.set(x, "customRequestInitializer", js.Any.fromFunction1((t0: /* request */ XMLHttpRequest) => value(t0).runNow()))
