...
trait ListView[T] extends StObject {
  ...
  /**
    ...
    **/
  def onaccessibilityannotationcomplete(eventInfo: CustomEvent): Unit = js.native
  ...
  /**
    ...
    **/
  def onfootervisibilitychanged(eventInfo: CustomEvent): Unit = js.native
  ...
  /**
    ...
    **/
  def ongroupheaderinvoked(eventInfo: CustomEvent): Unit = js.native
  
  /**
    * Raised when the header's visibility property changes.
    * @param eventInfo An object that contains information about the event. The detail property of this object contains the following sub-properties: detail.visible.
    **/
  def onheadervisibilitychanged(eventInfo: CustomEvent): Unit = js.native
  ...
  /**
    ...
    **/
  def onitemdragbetween(eventInfo: CustomEvent): Unit = js.native
  
  /**
    * Raised when the user is dragging an item from the ListView and the datasource changes while the user is dragging.
    * @param eventInfo An object that contains information about the event. The detail property of this object contains additional information about the event.
    **/
  def onitemdragchanged(eventInfo: CustomEvent): Unit = js.native
  ...
  /**
    ...
    **/
  def onitemdragdrop(eventInfo: CustomEvent): Unit = js.native
  
  /**
    * Raised when the user drops an item dragged from a ListView.
    * @param eventInfo An object that contains information about the event.
    **/
  def onitemdragend(eventInfo: CustomEvent): Unit = js.native
  ...
  /**
    ...
    **/
  def onitemdragenter(eventInfo: CustomEvent): Unit = js.native
  
  /**
    * Raised when a draggable item leaves the bounds of a ListView control.
    * @param eventInfo An object that contains information about the event.
    **/
  def onitemdragleave(eventInfo: CustomEvent): Unit = js.native
  ...
  /**
    ...
    **/
  def onitemdragstart(eventInfo: CustomEvent): Unit = js.native
  ...
  /**
    ...
    **/
  def oniteminvoked(eventInfo: CustomEvent): Unit = js.native
  ...
  /**
    ...
    **/
  def onkeyboardnavigating(eventInfo: CustomEvent): Unit = js.native
  ...
  /**
    ...
    **/
  def onselectionchanged(eventInfo: CustomEvent): Unit = js.native
  ...
  /**
    ...
    **/
  def onselectionchanging(eventInfo: CustomEvent): Unit = js.native
