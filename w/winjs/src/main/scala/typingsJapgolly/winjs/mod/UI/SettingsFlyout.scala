...
open class SettingsFlyout ()
  extends StObject
     with typingsJapgolly.winjs.WinJS.UI.SettingsFlyout {
...
object SettingsFlyout {
  ...
  /**
    ...
    **/
  /* static member */
  inline def populateSettings(e: CustomEvent): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("populateSettings")(e.asInstanceOf[js.Any]).asInstanceOf[Unit]
