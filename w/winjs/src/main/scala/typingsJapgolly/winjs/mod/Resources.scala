...
import typingsJapgolly.winjs.AnonEmpty
...
object Resources extends js.Object {
  ...
  /**
    ...
    **/
  def processAll(): typingsJapgolly.winjs.WinJS.Promise[Unit] = js.native
  def processAll(rootElement: HTMLElement): typingsJapgolly.winjs.WinJS.Promise[Unit] = js.native
  /**
