...
object Navigation extends js.Object {
  ...
  /**
    ...
    **/
  def back(): typingsJapgolly.winjs.WinJS.Promise[Boolean] = js.native
  def back(distance: Double): typingsJapgolly.winjs.WinJS.Promise[Boolean] = js.native
  /**
    * Navigates forwards.
    * @param distance The number of entries to go forward.
    * @returns A promise that is completed with a value that indicates whether or not the navigation was successful.
    **/
  def forward(): typingsJapgolly.winjs.WinJS.Promise[Boolean] = js.native
  def forward(distance: Double): typingsJapgolly.winjs.WinJS.Promise[Boolean] = js.native
  /**
    ...
    **/
  def navigate(location: js.Any): typingsJapgolly.winjs.WinJS.Promise[Boolean] = js.native
  def navigate(location: js.Any, initialState: js.Any): typingsJapgolly.winjs.WinJS.Promise[Boolean] = js.native
  //#endregion Functions
  //#region Events
  /**
