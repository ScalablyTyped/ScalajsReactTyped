...
import typingsJapgolly.winjs.anon.KeyCode
import typingsJapgolly.winjs.winjsStrings.down
import typingsJapgolly.winjs.winjsStrings.left
import typingsJapgolly.winjs.winjsStrings.right
import typingsJapgolly.winjs.winjsStrings.up
...
object XYFocus {
  ...
  inline def findNextFocusElement(direction: String, options: typingsJapgolly.winjs.WinJS.UI.XYFocus.XYFocusOptions): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("findNextFocusElement")(direction.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
  ...
  inline def findNextFocusElement_down(direction: down, options: typingsJapgolly.winjs.WinJS.UI.XYFocus.XYFocusOptions): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("findNextFocusElement")(direction.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
  ...
  inline def findNextFocusElement_left(direction: left, options: typingsJapgolly.winjs.WinJS.UI.XYFocus.XYFocusOptions): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("findNextFocusElement")(direction.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
  ...
  inline def findNextFocusElement_right(direction: right, options: typingsJapgolly.winjs.WinJS.UI.XYFocus.XYFocusOptions): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("findNextFocusElement")(direction.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
  ...
  inline def findNextFocusElement_up(direction: up, options: typingsJapgolly.winjs.WinJS.UI.XYFocus.XYFocusOptions): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("findNextFocusElement")(direction.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
  ...
  inline def moveFocus(direction: String, options: typingsJapgolly.winjs.WinJS.UI.XYFocus.XYFocusOptions): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("moveFocus")(direction.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
  ...
  inline def moveFocus_down(direction: down, options: typingsJapgolly.winjs.WinJS.UI.XYFocus.XYFocusOptions): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("moveFocus")(direction.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
  ...
  inline def moveFocus_left(direction: left, options: typingsJapgolly.winjs.WinJS.UI.XYFocus.XYFocusOptions): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("moveFocus")(direction.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
  ...
  inline def moveFocus_right(direction: right, options: typingsJapgolly.winjs.WinJS.UI.XYFocus.XYFocusOptions): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("moveFocus")(direction.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
  ...
  inline def moveFocus_up(direction: up, options: typingsJapgolly.winjs.WinJS.UI.XYFocus.XYFocusOptions): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("moveFocus")(direction.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
  
  inline def onfocuschanged(eventInfo: CustomEvent): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onfocuschanged")(eventInfo.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def onfocuschanging(eventInfo: CustomEvent): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onfocuschanging")(eventInfo.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  trait XYFocusEvent
    extends StObject
       with typingsJapgolly.std.CustomEvent[Any] {
  ...
  trait XYFocusOptions extends StObject {
    ...
    /**
      ...
      **/
    var historyRect: js.UndefOr[typingsJapgolly.winjs.WinJS.UI.XYFocus.IRect] = js.undefined
    ...
    /**
      ...
      **/
    var referenceRect: js.UndefOr[typingsJapgolly.winjs.WinJS.UI.XYFocus.IRect] = js.undefined
  }
  object XYFocusOptions {
    ...
    extension [Self <: XYFocusOptions](x: Self) {
      ...
      inline def setHistoryRect(value: typingsJapgolly.winjs.WinJS.UI.XYFocus.IRect): Self = StObject.set(x, "historyRect", value.asInstanceOf[js.Any])
      ...
      inline def setReferenceRect(value: typingsJapgolly.winjs.WinJS.UI.XYFocus.IRect): Self = StObject.set(x, "referenceRect", value.asInstanceOf[js.Any])
