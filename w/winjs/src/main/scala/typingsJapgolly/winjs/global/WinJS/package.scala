...
import typingsJapgolly.winjs.global.WinJS.^
...
/**
  ...
  **/
inline def xhr(options: IXHROptions): typingsJapgolly.winjs.WinJS.Promise[XMLHttpRequest] = ^.asInstanceOf[js.Dynamic].applyDynamic("xhr")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winjs.WinJS.Promise[XMLHttpRequest]]
