...
import typingsJapgolly.winjs.WinJS.IPromise
...
open class Promise[T] ()
  extends StObject
     with typingsJapgolly.winjs.WinJS.Promise[T] {
...
object Promise {
  ...
  /**
    ...
    **/
  /* static member */
  inline def onerror(eventInfo: CustomEvent): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onerror")(eventInfo.asInstanceOf[js.Any]).asInstanceOf[Unit]
