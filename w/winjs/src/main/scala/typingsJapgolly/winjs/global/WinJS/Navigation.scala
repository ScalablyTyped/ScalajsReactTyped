...
object Navigation {
  ...
  /**
    ...
    **/
  inline def back(): typingsJapgolly.winjs.WinJS.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("back")().asInstanceOf[typingsJapgolly.winjs.WinJS.Promise[Boolean]]
  inline def back(distance: Double): typingsJapgolly.winjs.WinJS.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("back")(distance.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winjs.WinJS.Promise[Boolean]]
  ...
  /**
    ...
    * @returns A promise that is completed with a value that indicates whether or not the navigation was successful.
    **/
  inline def forward(): typingsJapgolly.winjs.WinJS.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("forward")().asInstanceOf[typingsJapgolly.winjs.WinJS.Promise[Boolean]]
  inline def forward(distance: Double): typingsJapgolly.winjs.WinJS.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("forward")(distance.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winjs.WinJS.Promise[Boolean]]
  ...
  /**
    ...
    **/
  inline def navigate(location: Any): typingsJapgolly.winjs.WinJS.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("navigate")(location.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winjs.WinJS.Promise[Boolean]]
  inline def navigate(location: Any, initialState: Any): typingsJapgolly.winjs.WinJS.Promise[Boolean] = (^.asInstanceOf[js.Dynamic].applyDynamic("navigate")(location.asInstanceOf[js.Any], initialState.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winjs.WinJS.Promise[Boolean]]
  ...
  /**
    ...
    **/
  inline def onbeforenavigate(eventInfo: CustomEvent): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onbeforenavigate")(eventInfo.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  /**
    * Occurs after navigation has taken place.
    * @param eventInfo An object that contains information about the event. The detail property of this object contains the following sub-properties: location, state.
    **/
  inline def onnavigated(eventInfo: CustomEvent): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onnavigated")(eventInfo.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  /**
    * Occurs when navigation is taking place.
    * @param eventInfo An object that contains information about the event. The detail property of this object contains the following sub-properties: location, state.
    **/
  inline def onnavigating(eventInfo: CustomEvent): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onnavigating")(eventInfo.asInstanceOf[js.Any]).asInstanceOf[Unit]
