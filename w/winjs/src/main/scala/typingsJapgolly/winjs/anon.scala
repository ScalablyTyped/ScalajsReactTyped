...
object anon {
  ...
  object Element {
    ...
    inline def apply(element: Promise[HTMLElement], renderComplete: Promise[Any]): typingsJapgolly.winjs.anon.Element = {
      val __obj = js.Dynamic.literal(element = element.asInstanceOf[js.Any], renderComplete = renderComplete.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.winjs.anon.Element]
    }
    
    extension [Self <: typingsJapgolly.winjs.anon.Element](x: Self) {
