package typingsJapgolly.web3CoreSubscriptions

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.web3CoreSubscriptions.web3CoreSubscriptionsStrings.changed
import typingsJapgolly.web3CoreSubscriptions.web3CoreSubscriptionsStrings.connected
import typingsJapgolly.web3CoreSubscriptions.web3CoreSubscriptionsStrings.data
import typingsJapgolly.web3CoreSubscriptions.web3CoreSubscriptionsStrings.error
...
object mod {
  ...
  object SubscriptionModel {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(inputFormatter = inputFormatter.asInstanceOf[js.Any], outputFormatter = outputFormatter.toJsFn, params = params.asInstanceOf[js.Any], subscriptionHandler = subscriptionHandler.toJsFn, subscriptionName = subscriptionName.asInstanceOf[js.Any])
    ...
    extension [Self <: SubscriptionModel](x: Self) {
      ...
      inline def setOutputFormatter(value: Callback): Self = StObject.set(x, "outputFormatter", value.toJsFn)
      
      inline def setParams(value: Double): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
      
      inline def setSubscriptionHandler(value: Callback): Self = StObject.set(x, "subscriptionHandler", value.toJsFn)
