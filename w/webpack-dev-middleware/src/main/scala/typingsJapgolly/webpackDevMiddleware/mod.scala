...
import typingsJapgolly.webpack.mod.CallbackFunction
import typingsJapgolly.webpack.mod.StatsOptions
import typingsJapgolly.webpackDevMiddleware.anon.CreateReadStream
import typingsJapgolly.webpackDevMiddleware.anon.FnCall
import typingsJapgolly.webpackDevMiddleware.anon.Key
import typingsJapgolly.webpackDevMiddleware.anon.Webpack
...
object mod {
  ...
  /**
    ...
    */
  inline def apply[Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */](compiler: Compiler): API[Request_1, Response_1] = ^.asInstanceOf[js.Dynamic].apply(compiler.asInstanceOf[js.Any]).asInstanceOf[API[Request_1, Response_1]]
  inline def apply[Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */](compiler: Compiler, options: Options[Request_1, Response_1]): API[Request_1, Response_1] = (^.asInstanceOf[js.Dynamic].apply(compiler.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[API[Request_1, Response_1]]
  inline def apply[Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */](compiler: MultiCompiler): API[Request_1, Response_1] = ^.asInstanceOf[js.Dynamic].apply(compiler.asInstanceOf[js.Any]).asInstanceOf[API[Request_1, Response_1]]
  inline def apply[Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */](compiler: MultiCompiler, options: Options[Request_1, Response_1]): API[Request_1, Response_1] = (^.asInstanceOf[js.Dynamic].apply(compiler.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[API[Request_1, Response_1]]
  ...
  @js.native
  trait API[Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */]
  ...
  trait AdditionalMethods[Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */] extends StObject {
  ...
  object AdditionalMethods {
    ...
    inline def apply[Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */](
    ...
    extension [Self <: AdditionalMethods[?, ?], Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */](x: Self & (AdditionalMethods[Request_1, Response_1])) {
  ...
  type Callback = js.Function1[
    /* stats */ js.UndefOr[typingsJapgolly.webpack.mod.Stats | typingsJapgolly.webpack.mod.MultiStats], 
    Any
  ]
  ...
  trait Context[Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */] extends StObject {
  ...
  object Context {
    ...
    extension [Self <: Context[?, ?], Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */](x: Self & (Context[Request_1, Response_1])) {
  ...
  type Headers[Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */] = js.UndefOr[
  ...
  type Middleware[Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */] = js.Function3[/* req */ Request_1, /* res */ Response_1, /* next */ NextFunction, js.Promise[Unit]]
  ...
  type MultiWatching = ReturnType[
    js.Function2[
      /* watchOptions */ typingsJapgolly.webpack.mod.WatchOptions, 
      /* handler */ CallbackFunction[typingsJapgolly.webpack.mod.Stats], 
      typingsJapgolly.webpack.mod.Watching
    ]
  ]
  
  type NextFunction = js.Function1[/* err */ js.UndefOr[Any], Unit]
  
  trait Options[Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */] extends StObject {
    
    var headers: js.UndefOr[org.scalajs.dom.Headers] = js.undefined
  ...
  object Options {
    ...
    inline def apply[Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */](): Options[Request_1, Response_1] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[Options[Request_1, Response_1]]
    }
    
    extension [Self <: Options[?, ?], Request_1 /* <: typingsJapgolly.node.httpMod.IncomingMessage */, Response_1 /* <: ServerResponse */](x: Self & (Options[Request_1, Response_1])) {
  ...
  type OutputFileSystem = typingsJapgolly.webpack.mod.OutputFileSystem & CreateReadStream
  ...
  type WatchOptions = NonNullable[js.UndefOr[typingsJapgolly.webpack.mod.WatchOptions]]
  
  type Watching = typingsJapgolly.webpack.mod.Watching
}
