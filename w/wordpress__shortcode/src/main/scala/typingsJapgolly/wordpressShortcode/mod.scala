...
import typingsJapgolly.wordpressShortcode.anon.Call
import typingsJapgolly.wordpressShortcode.anon.PartialShortcodeAttrs
import typingsJapgolly.wordpressShortcode.anon.PartialShortcodeOptions
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.wordpressShortcode.anon.typeclosedcontentstringat
    - typingsJapgolly.wordpressShortcode.anon.typeselfclosingsingleattr
  */
  trait Shortcode_ extends StObject
  object Shortcode_ {
    
    inline def typeclosedcontentstringat(attrs: ShortcodeAttrs, content: String, tag: String): typingsJapgolly.wordpressShortcode.anon.typeclosedcontentstringat = {
      ...
      __obj.asInstanceOf[typingsJapgolly.wordpressShortcode.anon.typeclosedcontentstringat]
    }
    
    inline def typeselfclosingsingleattr(attrs: ShortcodeAttrs, tag: String, `type`: `self-closing` | single): typingsJapgolly.wordpressShortcode.anon.typeselfclosingsingleattr = {
      val __obj = js.Dynamic.literal(attrs = attrs.asInstanceOf[js.Any], tag = tag.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.wordpressShortcode.anon.typeselfclosingsingleattr]
    }
  }
