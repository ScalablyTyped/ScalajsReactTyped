...
import typingsJapgolly.winrtUwp.Windows.System.UserProfile.AccountPictureKind
import typingsJapgolly.winrtUwp.Windows.System.UserProfile.SetAccountPictureResult
import typingsJapgolly.winrtUwp.Windows.System.UserProfile.SetImageFeedResult
import typingsJapgolly.winrtUwp.anon.Second
import typingsJapgolly.winrtUwp.winrtUwpStrings.accountpicturechanged
...
object UserProfile {
  ...
  object AccountPictureKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.System.UserProfile.AccountPictureKind & Double] = js.native
    
    /* 1 */ val largeImage: typingsJapgolly.winrtUwp.Windows.System.UserProfile.AccountPictureKind.largeImage & Double = js.native
    
    /* 0 */ val smallImage: typingsJapgolly.winrtUwp.Windows.System.UserProfile.AccountPictureKind.smallImage & Double = js.native
    
    /* 2 */ val video: typingsJapgolly.winrtUwp.Windows.System.UserProfile.AccountPictureKind.video & Double = js.native
  }
  ...
  open class AdvertisingManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.UserProfile.AdvertisingManager
  ...
  open class FirstSignInSettings ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.UserProfile.FirstSignInSettings {
  ...
  object FirstSignInSettings {
    ...
    /**
      ...
      */
    /* static member */
    inline def getDefault(): typingsJapgolly.winrtUwp.Windows.System.UserProfile.FirstSignInSettings = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefault")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.System.UserProfile.FirstSignInSettings]
  }
  ...
  open class GlobalizationPreferences ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.UserProfile.GlobalizationPreferences
  ...
  open class LockScreen ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.UserProfile.LockScreen
  object LockScreen {
  ...
  object SetAccountPictureResult extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.System.UserProfile.SetAccountPictureResult & Double
      ] = js.native
    
    /* 1 */ val changeDisabled: typingsJapgolly.winrtUwp.Windows.System.UserProfile.SetAccountPictureResult.changeDisabled & Double = js.native
    
    /* 5 */ val failure: typingsJapgolly.winrtUwp.Windows.System.UserProfile.SetAccountPictureResult.failure & Double = js.native
    
    /* 4 */ val fileSizeError: typingsJapgolly.winrtUwp.Windows.System.UserProfile.SetAccountPictureResult.fileSizeError & Double = js.native
    
    /* 2 */ val largeOrDynamicError: typingsJapgolly.winrtUwp.Windows.System.UserProfile.SetAccountPictureResult.largeOrDynamicError & Double = js.native
    
    /* 0 */ val success: typingsJapgolly.winrtUwp.Windows.System.UserProfile.SetAccountPictureResult.success & Double = js.native
    
    /* 3 */ val videoFrameSizeError: typingsJapgolly.winrtUwp.Windows.System.UserProfile.SetAccountPictureResult.videoFrameSizeError & Double = js.native
  }
  ...
  object SetImageFeedResult extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.System.UserProfile.SetImageFeedResult & Double] = js.native
    
    /* 1 */ val changeDisabled: typingsJapgolly.winrtUwp.Windows.System.UserProfile.SetImageFeedResult.changeDisabled & Double = js.native
    
    /* 0 */ val success: typingsJapgolly.winrtUwp.Windows.System.UserProfile.SetImageFeedResult.success & Double = js.native
    
    /* 2 */ val userCanceled: typingsJapgolly.winrtUwp.Windows.System.UserProfile.SetImageFeedResult.userCanceled & Double = js.native
  }
  ...
  open class UserInformation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.UserProfile.UserInformation
  ...
  open class UserProfilePersonalizationSettings ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.UserProfile.UserProfilePersonalizationSettings {
  ...
  object UserProfilePersonalizationSettings {
    ...
    @js.native
    def current: typingsJapgolly.winrtUwp.Windows.System.UserProfile.UserProfilePersonalizationSettings = js.native
    inline def current_=(x: typingsJapgolly.winrtUwp.Windows.System.UserProfile.UserProfilePersonalizationSettings): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("current")(x.asInstanceOf[js.Any])
