...
import typingsJapgolly.winrtUwp.Windows.Services.Store.StoreConsumableStatus
import typingsJapgolly.winrtUwp.Windows.Services.Store.StoreDurationUnit
import typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdateState
import typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdateStatus
import typingsJapgolly.winrtUwp.Windows.Services.Store.StorePurchaseStatus
...
object Services {
    ...
    object Guidance {
      ...
      object GuidanceLaneMarkers extends StObject {
        ...
        def apply(value: Double): js.UndefOr[
                typingsJapgolly.winrtUwp.Windows.Services.Maps.Guidance.GuidanceLaneMarkers & Double
              ] = js.native
        
        /* 6 */ val hardLeft: typingsJapgolly.winrtUwp.Windows.Services.Maps.Guidance.GuidanceLaneMarkers.hardLeft & Double = js.native
        
        /* 3 */ val hardRight: typingsJapgolly.winrtUwp.Windows.Services.Maps.Guidance.GuidanceLaneMarkers.hardRight & Double = js.native
        
        /* 7 */ val left: typingsJapgolly.winrtUwp.Windows.Services.Maps.Guidance.GuidanceLaneMarkers.left & Double = js.native
        
        /* 8 */ val lightLeft: typingsJapgolly.winrtUwp.Windows.Services.Maps.Guidance.GuidanceLaneMarkers.lightLeft & Double = js.native
        
        /* 1 */ val lightRight: typingsJapgolly.winrtUwp.Windows.Services.Maps.Guidance.GuidanceLaneMarkers.lightRight & Double = js.native
        
        /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Services.Maps.Guidance.GuidanceLaneMarkers.none & Double = js.native
        
        /* 2 */ val right: typingsJapgolly.winrtUwp.Windows.Services.Maps.Guidance.GuidanceLaneMarkers.right & Double = js.native
        
        /* 4 */ val straight: typingsJapgolly.winrtUwp.Windows.Services.Maps.Guidance.GuidanceLaneMarkers.straight & Double = js.native
        
        /* 10 */ val unknown: typingsJapgolly.winrtUwp.Windows.Services.Maps.Guidance.GuidanceLaneMarkers.unknown & Double = js.native
        
        /* 5 */ val uturnLeft: typingsJapgolly.winrtUwp.Windows.Services.Maps.Guidance.GuidanceLaneMarkers.uturnLeft & Double = js.native
        
        /* 9 */ val uturnRight: typingsJapgolly.winrtUwp.Windows.Services.Maps.Guidance.GuidanceLaneMarkers.uturnRight & Double = js.native
      }
    }
  }
  ...
  object Store {
    ...
    open class StoreAcquireLicenseResult ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreAcquireLicenseResult {
      ...
      /* CompleteClass */
      var storePackageLicense: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageLicense = js.native
    }
    ...
    open class StoreAppLicense ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreAppLicense {
      ...
      /* CompleteClass */
      var addOnLicenses: IMapView[String, typingsJapgolly.winrtUwp.Windows.Services.Store.StoreLicense] = js.native
    ...
    open class StoreAvailability ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreAvailability
    ...
    open class StoreCollectionData ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreCollectionData {
    ...
    open class StoreConsumableResult ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreConsumableResult {
    ...
    object StoreConsumableStatus extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Services.Store.StoreConsumableStatus & Double] = js.native
      
      /* 1 */ val insufficentQuantity: typingsJapgolly.winrtUwp.Windows.Services.Store.StoreConsumableStatus.insufficentQuantity & Double = js.native
      
      /* 2 */ val networkError: typingsJapgolly.winrtUwp.Windows.Services.Store.StoreConsumableStatus.networkError & Double = js.native
      
      /* 3 */ val serverError: typingsJapgolly.winrtUwp.Windows.Services.Store.StoreConsumableStatus.serverError & Double = js.native
      
      /* 0 */ val succeeded: typingsJapgolly.winrtUwp.Windows.Services.Store.StoreConsumableStatus.succeeded & Double = js.native
    }
    ...
    open class StoreContext ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreContext
    object StoreContext {
      ...
      /**
        ...
        */
      /* static member */
      inline def getDefault(): typingsJapgolly.winrtUwp.Windows.Services.Store.StoreContext = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefault")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.Services.Store.StoreContext]
      ...
      /**
        ...
        */
      /* static member */
      inline def getForUser(user: User): typingsJapgolly.winrtUwp.Windows.Services.Store.StoreContext = ^.asInstanceOf[js.Dynamic].applyDynamic("getForUser")(user.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Services.Store.StoreContext]
    }
    ...
    object StoreDurationUnit extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Services.Store.StoreDurationUnit & Double] = js.native
      
      /* 2 */ val day: typingsJapgolly.winrtUwp.Windows.Services.Store.StoreDurationUnit.day & Double = js.native
      
      /* 1 */ val hour: typingsJapgolly.winrtUwp.Windows.Services.Store.StoreDurationUnit.hour & Double = js.native
      
      /* 0 */ val minute: typingsJapgolly.winrtUwp.Windows.Services.Store.StoreDurationUnit.minute & Double = js.native
      
      /* 4 */ val month: typingsJapgolly.winrtUwp.Windows.Services.Store.StoreDurationUnit.month & Double = js.native
      
      /* 3 */ val week: typingsJapgolly.winrtUwp.Windows.Services.Store.StoreDurationUnit.week & Double = js.native
      
      /* 5 */ val year: typingsJapgolly.winrtUwp.Windows.Services.Store.StoreDurationUnit.year & Double = js.native
    }
    ...
    open class StoreImage ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreImage {
    ...
    open class StoreLicense ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreLicense {
    ...
    open class StorePackageLicense ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageLicense {
      ...
      /* CompleteClass */
      override def onlicenselost(ev: js.Object & WinRTEvent[typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageLicense]): Unit = js.native
      /** Raised when user no longer has rights to the license on the current device (for example, the user has acquired the license on a different device). */
      /* CompleteClass */
      @JSName("onlicenselost")
      var onlicenselost_Original: TypedEventHandler[typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageLicense, js.Object] = js.native
    ...
    open class StorePackageUpdate ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdate {
    ...
    open class StorePackageUpdateResult ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdateResult {
    ...
    object StorePackageUpdateState extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdateState & Double] = js.native
      
      /* 4 */ val canceled: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdateState.canceled & Double = js.native
      
      /* 3 */ val completed: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdateState.completed & Double = js.native
      
      /* 2 */ val deploying: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdateState.deploying & Double = js.native
      
      /* 1 */ val downloading: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdateState.downloading & Double = js.native
      
      /* 6 */ val errorLowBattery: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdateState.errorLowBattery & Double = js.native
      
      /* 7 */ val errorWiFiRecommended: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdateState.errorWiFiRecommended & Double = js.native
      
      /* 8 */ val errorWiFiRequired: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdateState.errorWiFiRequired & Double = js.native
      
      /* 5 */ val otherError: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdateState.otherError & Double = js.native
      
      /* 0 */ val pending: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePackageUpdateState.pending & Double = js.native
    }
    ...
    open class StorePrice ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StorePrice {
    ...
    open class StoreProduct ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreProduct
    ...
    open class StoreProductPagedQueryResult ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreProductPagedQueryResult {
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def getNextAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Services.Store.StoreProductPagedQueryResult] = js.native
      ...
      /* CompleteClass */
      var products: IMapView[String, typingsJapgolly.winrtUwp.Windows.Services.Store.StoreProduct] = js.native
    }
    ...
    open class StoreProductQueryResult ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreProductQueryResult {
    ...
    open class StoreProductResult ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreProductResult {
      ...
      /* CompleteClass */
      var product: typingsJapgolly.winrtUwp.Windows.Services.Store.StoreProduct = js.native
    }
    ...
    open class StorePurchaseProperties ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StorePurchaseProperties {
    ...
    open class StorePurchaseResult ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StorePurchaseResult {
    ...
    object StorePurchaseStatus extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Services.Store.StorePurchaseStatus & Double] = js.native
      
      /* 1 */ val alreadyPurchased: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePurchaseStatus.alreadyPurchased & Double = js.native
      
      /* 3 */ val networkError: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePurchaseStatus.networkError & Double = js.native
      
      /* 2 */ val notPurchased: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePurchaseStatus.notPurchased & Double = js.native
      
      /* 4 */ val serverError: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePurchaseStatus.serverError & Double = js.native
      
      /* 0 */ val succeeded: typingsJapgolly.winrtUwp.Windows.Services.Store.StorePurchaseStatus.succeeded & Double = js.native
    }
    ...
    open class StoreRequestHelper ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreRequestHelper
    object StoreRequestHelper {
      ...
      inline def sendRequestAsync(
        context: typingsJapgolly.winrtUwp.Windows.Services.Store.StoreContext,
        requestKind: Double,
        parametersAsJson: String
      ): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Services.Store.StoreSendRequestResult] = (^.asInstanceOf[js.Dynamic].applyDynamic("sendRequestAsync")(context.asInstanceOf[js.Any], requestKind.asInstanceOf[js.Any], parametersAsJson.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Services.Store.StoreSendRequestResult]]
    }
    ...
    open class StoreSendRequestResult ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreSendRequestResult {
    ...
    open class StoreSku ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreSku
    ...
    open class StoreSubscriptionInfo ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreSubscriptionInfo {
    ...
    open class StoreVideo ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Services.Store.StoreVideo {
      ...
      /* CompleteClass */
      var previewImage: typingsJapgolly.winrtUwp.Windows.Services.Store.StoreImage = js.native
