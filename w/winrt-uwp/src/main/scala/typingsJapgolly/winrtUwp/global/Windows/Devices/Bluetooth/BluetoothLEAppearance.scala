...
open class BluetoothLEAppearance ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothLEAppearance {
...
object BluetoothLEAppearance {
  ...
  /**
    ...
    */
  /* static member */
  inline def fromParts(appearanceCategory: Double, appearanceSubCategory: Double): typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothLEAppearance = (^.asInstanceOf[js.Dynamic].applyDynamic("fromParts")(appearanceCategory.asInstanceOf[js.Any], appearanceSubCategory.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothLEAppearance]
  ...
  /**
    ...
    */
  /* static member */
  inline def fromRawValue(rawValue: Double): typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothLEAppearance = ^.asInstanceOf[js.Dynamic].applyDynamic("fromRawValue")(rawValue.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothLEAppearance]
}
