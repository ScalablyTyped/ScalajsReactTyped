...
import typingsJapgolly.winrtUwp.Windows.Storage.Provider.CachedFileOptions
import typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateStatus
import typingsJapgolly.winrtUwp.Windows.Storage.Provider.ReadActivationMode
import typingsJapgolly.winrtUwp.Windows.Storage.Provider.WriteActivationMode
...
object Provider {
  ...
  object CachedFileOptions extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Storage.Provider.CachedFileOptions & Double] = js.native
    
    /* 3 */ val denyAccessWhenOffline: typingsJapgolly.winrtUwp.Windows.Storage.Provider.CachedFileOptions.denyAccessWhenOffline & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Storage.Provider.CachedFileOptions.none & Double = js.native
    
    /* 1 */ val requireUpdateOnAccess: typingsJapgolly.winrtUwp.Windows.Storage.Provider.CachedFileOptions.requireUpdateOnAccess & Double = js.native
    
    /* 2 */ val useCachedFileWhenOffline: typingsJapgolly.winrtUwp.Windows.Storage.Provider.CachedFileOptions.useCachedFileWhenOffline & Double = js.native
  }
  ...
  object CachedFileTarget extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Storage.Provider.CachedFileTarget & Double] = js.native
    
    /* 0 */ val local: typingsJapgolly.winrtUwp.Windows.Storage.Provider.CachedFileTarget.local & Double = js.native
    
    /* 1 */ val remote: typingsJapgolly.winrtUwp.Windows.Storage.Provider.CachedFileTarget.remote & Double = js.native
  }
  ...
  open class CachedFileUpdater ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.Provider.CachedFileUpdater
  ...
  open class CachedFileUpdaterUI ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.Provider.CachedFileUpdaterUI
  ...
  open class FileUpdateRequest ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateRequest {
    ...
    /* CompleteClass */
    var file: typingsJapgolly.winrtUwp.Windows.Storage.StorageFile = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getDeferral(): typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateRequestDeferral = js.native
  ...
  open class FileUpdateRequestDeferral ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateRequestDeferral {
  ...
  open class FileUpdateRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateRequestedEventArgs {
    
    /** Gets the details of the requested file update. */
    /* CompleteClass */
    var request: typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateRequest = js.native
  }
  ...
  object FileUpdateStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateStatus & Double] = js.native
    
    /* 1 */ val complete: typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateStatus.complete & Double = js.native
    
    /* 5 */ val completeAndRenamed: typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateStatus.completeAndRenamed & Double = js.native
    
    /* 3 */ val currentlyUnavailable: typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateStatus.currentlyUnavailable & Double = js.native
    
    /* 4 */ val failed: typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateStatus.failed & Double = js.native
    
    /* 0 */ val incomplete: typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateStatus.incomplete & Double = js.native
    
    /* 2 */ val userInputNeeded: typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateStatus.userInputNeeded & Double = js.native
  }
  ...
  object ReadActivationMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Storage.Provider.ReadActivationMode & Double] = js.native
    
    /* 1 */ val beforeAccess: typingsJapgolly.winrtUwp.Windows.Storage.Provider.ReadActivationMode.beforeAccess & Double = js.native
    
    /* 0 */ val notNeeded: typingsJapgolly.winrtUwp.Windows.Storage.Provider.ReadActivationMode.notNeeded & Double = js.native
  }
  ...
  object UIStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Storage.Provider.UIStatus & Double] = js.native
    
    /* 3 */ val complete: typingsJapgolly.winrtUwp.Windows.Storage.Provider.UIStatus.complete & Double = js.native
    
    /* 1 */ val hidden: typingsJapgolly.winrtUwp.Windows.Storage.Provider.UIStatus.hidden & Double = js.native
    
    /* 0 */ val unavailable: typingsJapgolly.winrtUwp.Windows.Storage.Provider.UIStatus.unavailable & Double = js.native
    
    /* 2 */ val visible: typingsJapgolly.winrtUwp.Windows.Storage.Provider.UIStatus.visible & Double = js.native
  }
  ...
  object WriteActivationMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Storage.Provider.WriteActivationMode & Double] = js.native
    
    /* 2 */ val afterWrite: typingsJapgolly.winrtUwp.Windows.Storage.Provider.WriteActivationMode.afterWrite & Double = js.native
    
    /* 1 */ val notNeeded: typingsJapgolly.winrtUwp.Windows.Storage.Provider.WriteActivationMode.notNeeded & Double = js.native
    
    /* 0 */ val readOnly: typingsJapgolly.winrtUwp.Windows.Storage.Provider.WriteActivationMode.readOnly & Double = js.native
  }
}
