...
open class EmailMailboxChangeTracker ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxChangeTracker {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getChangeReader(): typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxChangeReader = js.native
