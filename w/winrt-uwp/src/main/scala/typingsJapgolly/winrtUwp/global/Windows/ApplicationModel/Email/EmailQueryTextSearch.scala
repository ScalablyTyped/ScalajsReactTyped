...
open class EmailQueryTextSearch ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailQueryTextSearch {
  
  /** Gets or sets the fields for an email text search query. */
  /* CompleteClass */
  var fields: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailQuerySearchFields = js.native
  
  /** Gets or sets the scope for an email text search query. */
  /* CompleteClass */
  var searchScope: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailQuerySearchScope = js.native
