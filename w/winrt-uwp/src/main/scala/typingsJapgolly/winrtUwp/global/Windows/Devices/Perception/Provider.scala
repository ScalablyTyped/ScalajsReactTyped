...
import typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.IPerceptionFrameProvider
import typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.IPerceptionFrameProviderManager
import typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionStartFaceAuthenticationHandler
import typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionStopFaceAuthenticationHandler
...
import typingsJapgolly.winrtUwp.Windows.Foundation.Numerics.Quaternion
...
object Provider {
  ...
  open class KnownPerceptionFrameKind ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.KnownPerceptionFrameKind
  ...
  open class PerceptionControlGroup protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionControlGroup {
    /**
  ...
  open class PerceptionCorrelation protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionCorrelation {
    /**
  ...
  open class PerceptionCorrelationGroup protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionCorrelationGroup {
    /**
      ...
      */
    def this(relativeLocations: IIterable[
            typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionCorrelation
          ]) = this()
    
    /** The collection of PerceptionCorrelations describing multiple unique providers in a common coordinate frame. */
    /* CompleteClass */
    var relativeLocations: IVectorView[
        typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionCorrelation
      ] = js.native
  }
  ...
  open class PerceptionFaceAuthenticationGroup protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionFaceAuthenticationGroup {
    /**
  ...
  open class PerceptionFrame ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionFrame {
  ...
  open class PerceptionFrameProviderInfo ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionFrameProviderInfo {
  ...
  open class PerceptionFrameProviderManagerService ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionFrameProviderManagerService
  object PerceptionFrameProviderManagerService {
    ...
    inline def publishFrameForProvider(
      ...
      frame: typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionFrame
    ...
    inline def registerControlGroup(
      ...
      controlGroup: typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionControlGroup
    ...
    inline def registerCorrelationGroup(
      manager: IPerceptionFrameProviderManager,
      correlationGroup: typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionCorrelationGroup
    ...
    inline def registerFaceAuthenticationGroup(
      manager: IPerceptionFrameProviderManager,
      faceAuthenticationGroup: typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionFaceAuthenticationGroup
    ...
    inline def registerFrameProviderInfo(
      manager: IPerceptionFrameProviderManager,
      frameProviderInfo: typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionFrameProviderInfo
  ...
  open class PerceptionPropertyChangeRequest ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionPropertyChangeRequest {
  ...
  open class PerceptionVideoFrameAllocator protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionVideoFrameAllocator {
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def allocateFrame(): typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionFrame = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def copyFromVideoFrame(frame: VideoFrame): typingsJapgolly.winrtUwp.Windows.Devices.Perception.Provider.PerceptionFrame = js.native
  }
}
