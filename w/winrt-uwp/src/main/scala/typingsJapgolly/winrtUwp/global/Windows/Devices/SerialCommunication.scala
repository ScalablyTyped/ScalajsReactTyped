...
import typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialError
import typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialPinChange
...
object SerialCommunication {
  ...
  open class ErrorReceivedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.ErrorReceivedEventArgs {
  ...
  open class PinChangedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.PinChangedEventArgs {
  ...
  open class SerialDevice ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialDevice
  object SerialDevice {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialDevice] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialDevice]]
  ...
  object SerialError extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialError & Double
      ] = js.native
    
    /* 1 */ val bufferOverrun: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialError.bufferOverrun & Double = js.native
    
    /* 0 */ val frame: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialError.frame & Double = js.native
    
    /* 2 */ val receiveFull: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialError.receiveFull & Double = js.native
    
    /* 3 */ val receiveParity: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialError.receiveParity & Double = js.native
    
    /* 4 */ val transmitFull: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialError.transmitFull & Double = js.native
  }
  ...
  object SerialHandshake extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialHandshake & Double
      ] = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialHandshake.none & Double = js.native
    
    /* 1 */ val requestToSend: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialHandshake.requestToSend & Double = js.native
    
    /* 3 */ val requestToSendXOnXOff: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialHandshake.requestToSendXOnXOff & Double = js.native
    
    /* 2 */ val xonXOff: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialHandshake.xonXOff & Double = js.native
  }
  ...
  object SerialParity extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialParity & Double
      ] = js.native
    
    /* 2 */ val even: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialParity.even & Double = js.native
    
    /* 3 */ val mark: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialParity.mark & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialParity.none & Double = js.native
    
    /* 1 */ val odd: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialParity.odd & Double = js.native
    
    /* 4 */ val space: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialParity.space & Double = js.native
  }
  ...
  object SerialPinChange extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialPinChange & Double
      ] = js.native
    
    /* 0 */ val breakSignal: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialPinChange.breakSignal & Double = js.native
    
    /* 1 */ val carrierDetect: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialPinChange.carrierDetect & Double = js.native
    
    /* 2 */ val clearToSend: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialPinChange.clearToSend & Double = js.native
    
    /* 3 */ val dataSetReady: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialPinChange.dataSetReady & Double = js.native
    
    /* 4 */ val ringIndicator: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialPinChange.ringIndicator & Double = js.native
  }
  ...
  object SerialStopBitCount extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialStopBitCount & Double
      ] = js.native
    
    /* 0 */ val one: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialStopBitCount.one & Double = js.native
    
    /* 1 */ val onePointFive: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialStopBitCount.onePointFive & Double = js.native
    
    /* 2 */ val two: typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication.SerialStopBitCount.two & Double = js.native
  }
}
