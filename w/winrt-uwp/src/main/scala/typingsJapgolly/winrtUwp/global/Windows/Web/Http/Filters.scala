...
import typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCacheReadBehavior
import typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCacheWriteBehavior
import typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCookieUsageBehavior
...
object Filters {
  ...
  open class HttpBaseProtocolFilter ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpBaseProtocolFilter {
    ...
    /* CompleteClass */
    var cacheControl: typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCacheControl = js.native
    ...
    /* CompleteClass */
    var cookieManager: typingsJapgolly.winrtUwp.Windows.Web.Http.HttpCookieManager = js.native
    ...
    /* CompleteClass */
    var maxVersion: typingsJapgolly.winrtUwp.Windows.Web.Http.HttpVersion = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def sendRequestAsync(request: typingsJapgolly.winrtUwp.Windows.Web.Http.HttpRequestMessage): IPromiseWithIAsyncOperationWithProgress[typingsJapgolly.winrtUwp.Windows.Web.Http.HttpResponseMessage, HttpProgress] = js.native
  ...
  open class HttpCacheControl ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCacheControl {
  ...
  object HttpCacheReadBehavior extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCacheReadBehavior & Double] = js.native
    
    /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCacheReadBehavior.default & Double = js.native
    
    /* 1 */ val mostRecent: typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCacheReadBehavior.mostRecent & Double = js.native
    
    /* 2 */ val onlyFromCache: typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCacheReadBehavior.onlyFromCache & Double = js.native
  }
  ...
  object HttpCacheWriteBehavior extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCacheWriteBehavior & Double
      ] = js.native
    
    /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCacheWriteBehavior.default & Double = js.native
    
    /* 1 */ val noCache: typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCacheWriteBehavior.noCache & Double = js.native
  }
  ...
  object HttpCookieUsageBehavior extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCookieUsageBehavior & Double
      ] = js.native
    
    /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCookieUsageBehavior.default & Double = js.native
    
    /* 1 */ val noCookies: typingsJapgolly.winrtUwp.Windows.Web.Http.Filters.HttpCookieUsageBehavior.noCookies & Double = js.native
  }
}
