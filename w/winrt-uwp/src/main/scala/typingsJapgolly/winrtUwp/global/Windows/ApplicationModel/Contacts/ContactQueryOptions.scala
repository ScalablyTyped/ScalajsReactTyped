...
open class ContactQueryOptions ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactQueryOptions {
  /**
    * Initializes a new instance of the ContactQueryOptions class.
  ...
  def this(
    text: String,
    fields: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactQuerySearchFields
  ) = this()
  ...
  /* CompleteClass */
  var desiredFields: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactQueryDesiredFields = js.native
  
  /** Gets or sets the desired annotation operations a contact must have to match the query. */
  /* CompleteClass */
  var desiredOperations: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotationOperations = js.native
  ...
  /* CompleteClass */
  var textSearch: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactQueryTextSearch = js.native
}
