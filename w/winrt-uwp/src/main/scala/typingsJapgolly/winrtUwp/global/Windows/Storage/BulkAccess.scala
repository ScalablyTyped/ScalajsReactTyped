...
import typingsJapgolly.winrtUwp.Windows.Storage.Search.IStorageQueryResultBase
...
object BulkAccess {
  ...
  open class FileInformation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.BulkAccess.FileInformation
  ...
  open class FileInformationFactory protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.BulkAccess.FileInformationFactory {
    /**
  ...
  open class FolderInformation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.BulkAccess.FolderInformation
}
