...
open class Appointment ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.Appointment {
  ...
  /* CompleteClass */
  var busyStatus: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentBusyStatus = js.native
  ...
  /* CompleteClass */
  var detailsKind: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentDetailsKind = js.native
  ...
  /* CompleteClass */
  var invitees: IVector[
    typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentInvitee
  ] = js.native
  ...
  /* CompleteClass */
  var organizer: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentOrganizer = js.native
  ...
  /* CompleteClass */
  var recurrence: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentRecurrence = js.native
  ...
  /* CompleteClass */
  var sensitivity: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentSensitivity = js.native
  ...
  /* CompleteClass */
  var userResponse: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentParticipantResponse = js.native
}
