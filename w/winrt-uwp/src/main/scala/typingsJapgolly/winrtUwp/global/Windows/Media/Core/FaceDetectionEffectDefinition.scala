...
open class FaceDetectionEffectDefinition ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.FaceDetectionEffectDefinition {
  ...
  /* CompleteClass */
  var detectionMode: typingsJapgolly.winrtUwp.Windows.Media.Core.FaceDetectionMode = js.native
