...
open class WhiteBalanceControl ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Devices.WhiteBalanceControl {
  ...
  /* CompleteClass */
  var preset: typingsJapgolly.winrtUwp.Windows.Media.Devices.ColorTemperaturePreset = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setPresetAsync(preset: typingsJapgolly.winrtUwp.Windows.Media.Devices.ColorTemperaturePreset): IPromiseWithIAsyncAction = js.native
