...
open class RcsServiceKindSupportedChangedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.RcsServiceKindSupportedChangedEventArgs {
  
  /** Gets the type of the Rich Communication Services (RCS) service. */
  /* CompleteClass */
  var serviceKind: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.RcsServiceKind = js.native
}
