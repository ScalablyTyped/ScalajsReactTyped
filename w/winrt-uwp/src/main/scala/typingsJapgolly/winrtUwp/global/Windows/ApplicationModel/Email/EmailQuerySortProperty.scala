...
object EmailQuerySortProperty extends StObject {
  ...
  def apply(value: Double): js.UndefOr[
    typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailQuerySortProperty & Double
  ] = js.native
  
  /* 0 */ val date: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailQuerySortProperty.date & Double = js.native
}
