...
import typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsFilterRules
...
open class SmsMessageReceivedTrigger protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Background.SmsMessageReceivedTrigger {
  /**
