...
object Editing {
  ...
  open class BackgroundAudioTrack ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Editing.BackgroundAudioTrack {
  ...
  object BackgroundAudioTrack {
    ...
    /**
      ...
      */
    /* static member */
    inline def createFromEmbeddedAudioTrack(embeddedAudioTrack: typingsJapgolly.winrtUwp.Windows.Media.Editing.EmbeddedAudioTrack): typingsJapgolly.winrtUwp.Windows.Media.Editing.BackgroundAudioTrack = ^.asInstanceOf[js.Dynamic].applyDynamic("createFromEmbeddedAudioTrack")(embeddedAudioTrack.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Media.Editing.BackgroundAudioTrack]
    ...
    /**
      ...
      */
    /* static member */
    inline def createFromFileAsync(file: IStorageFile): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Media.Editing.BackgroundAudioTrack] = ^.asInstanceOf[js.Dynamic].applyDynamic("createFromFileAsync")(file.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Media.Editing.BackgroundAudioTrack]]
  }
  ...
  open class EmbeddedAudioTrack ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Editing.EmbeddedAudioTrack {
  ...
  open class MediaClip ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaClip {
    ...
    /* CompleteClass */
    var embeddedAudioTracks: IVectorView[typingsJapgolly.winrtUwp.Windows.Media.Editing.EmbeddedAudioTrack] = js.native
  ...
  object MediaClip {
    ...
    /**
      ...
      */
    /* static member */
    inline def createFromColor(color: Color, originalDuration: Double): typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaClip = (^.asInstanceOf[js.Dynamic].applyDynamic("createFromColor")(color.asInstanceOf[js.Any], originalDuration.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaClip]
    ...
    /**
      ...
      */
    /* static member */
    inline def createFromFileAsync(file: IStorageFile): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaClip] = ^.asInstanceOf[js.Dynamic].applyDynamic("createFromFileAsync")(file.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaClip]]
    ...
    /**
      ...
      */
    /* static member */
    inline def createFromImageFileAsync(file: IStorageFile, originalDuration: Double): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaClip] = (^.asInstanceOf[js.Dynamic].applyDynamic("createFromImageFileAsync")(file.asInstanceOf[js.Any], originalDuration.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaClip]]
    ...
    /**
      ...
      */
    /* static member */
    inline def createFromSurface(surface: IDirect3DSurface, originalDuration: Double): typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaClip = (^.asInstanceOf[js.Dynamic].applyDynamic("createFromSurface")(surface.asInstanceOf[js.Any], originalDuration.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaClip]
  }
  ...
  open class MediaComposition ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaComposition
  object MediaComposition {
    ...
    /**
      ...
      */
    /* static member */
    inline def loadAsync(file: StorageFile): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaComposition] = ^.asInstanceOf[js.Dynamic].applyDynamic("loadAsync")(file.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaComposition]]
  }
  ...
  open class MediaOverlay protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaOverlay {
    /**
      * Initializes a new instance of the MediaOverlay class.
      * @param clip The media clip to be used for the overlay.
      */
    def this(clip: typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaClip) = this()
    /**
      * Initializes a new instance of the MediaOverlay class.
      * @param clip The media clip to be used for the overlay.
      ...
      */
    def this(clip: typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaClip, position: Rect, opacity: Double) = this()
    ...
    /* CompleteClass */
    var clip: typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaClip = js.native
  ...
  open class MediaOverlayLayer ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaOverlayLayer {
    /**
      * Initializes a new instance of the MediaOverlayLayer class.
    ...
    /* CompleteClass */
    var overlays: IVector[typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaOverlay] = js.native
  }
  ...
  object MediaTrimmingPreference extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaTrimmingPreference & Double] = js.native
    
    /* 0 */ val fast: typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaTrimmingPreference.fast & Double = js.native
    
    /* 1 */ val precise: typingsJapgolly.winrtUwp.Windows.Media.Editing.MediaTrimmingPreference.precise & Double = js.native
  }
  ...
  object VideoFramePrecision extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Media.Editing.VideoFramePrecision & Double] = js.native
    
    /* 0 */ val nearestFrame: typingsJapgolly.winrtUwp.Windows.Media.Editing.VideoFramePrecision.nearestFrame & Double = js.native
    
    /* 1 */ val nearestKeyFrame: typingsJapgolly.winrtUwp.Windows.Media.Editing.VideoFramePrecision.nearestKeyFrame & Double = js.native
  }
}
