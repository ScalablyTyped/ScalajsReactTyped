...
open class HttpResponseHeaderCollection ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpResponseHeaderCollection {
  ...
  /* CompleteClass */
  var allow: typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpMethodHeaderValueCollection = js.native
  ...
  /* CompleteClass */
  var cacheControl: typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpCacheDirectiveHeaderValueCollection = js.native
  ...
  /* CompleteClass */
  var connection: typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpConnectionOptionHeaderValueCollection = js.native
  ...
  /* CompleteClass */
  var proxyAuthenticate: typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpChallengeHeaderValueCollection = js.native
  ...
  /* CompleteClass */
  var retryAfter: typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpDateOrDeltaHeaderValue = js.native
  ...
  /* CompleteClass */
  var transferEncoding: typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpTransferCodingHeaderValueCollection = js.native
  ...
  /* CompleteClass */
  var wwwAuthenticate: typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpChallengeHeaderValueCollection = js.native
}
