...
import typingsJapgolly.winrtUwp.Windows.Networking.Connectivity.IPInformation
...
open class HostName protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Networking.HostName {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def isEqual(hostName: typingsJapgolly.winrtUwp.Windows.Networking.HostName): Boolean = js.native
  ...
  /* CompleteClass */
  var `type`: typingsJapgolly.winrtUwp.Windows.Networking.HostNameType = js.native
}
object HostName {
