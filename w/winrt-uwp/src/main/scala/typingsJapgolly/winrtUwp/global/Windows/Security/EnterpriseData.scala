...
import typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionStatus
import typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.EnforcementLevel
import typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus
import typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus
import typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult
import typingsJapgolly.winrtUwp.Windows.Storage.CreationCollisionOption
...
import typingsJapgolly.winrtUwp.winrtUwpStrings.policychanged
import typingsJapgolly.winrtUwp.winrtUwpStrings.protectedaccessresumed
import typingsJapgolly.winrtUwp.winrtUwpStrings.protectedaccesssuspending
import typingsJapgolly.winrtUwp.winrtUwpStrings.protectedcontentrevoked
...
object EnterpriseData {
  ...
  open class BufferProtectUnprotectResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.BufferProtectUnprotectResult {
    ...
    /* CompleteClass */
    var protectionInfo: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionInfo = js.native
  }
  ...
  open class DataProtectionInfo ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionInfo {
  ...
  open class DataProtectionManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionManager
  object DataProtectionManager {
    ...
    /**
      ...
      */
    /* static member */
    inline def getProtectionInfoAsync(protectedData: IBuffer): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionInfo] = ^.asInstanceOf[js.Dynamic].applyDynamic("getProtectionInfoAsync")(protectedData.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionInfo]]
    ...
    /**
      ...
      */
    /* static member */
    inline def getStreamProtectionInfoAsync(protectedStream: IInputStream): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionInfo] = ^.asInstanceOf[js.Dynamic].applyDynamic("getStreamProtectionInfoAsync")(protectedStream.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionInfo]]
    ...
    /**
      ...
      */
    /* static member */
    inline def protectAsync(data: IBuffer, identity: String): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.BufferProtectUnprotectResult
      ] = (^.asInstanceOf[js.Dynamic].applyDynamic("protectAsync")(data.asInstanceOf[js.Any], identity.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.BufferProtectUnprotectResult
      ]]
    ...
    /**
      ...
      */
    /* static member */
    inline def protectStreamAsync(unprotectedStream: IInputStream, identity: String, protectedStream: IOutputStream): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionInfo] = (^.asInstanceOf[js.Dynamic].applyDynamic("protectStreamAsync")(unprotectedStream.asInstanceOf[js.Any], identity.asInstanceOf[js.Any], protectedStream.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionInfo]]
    ...
    /**
      ...
      */
    /* static member */
    inline def unprotectAsync(data: IBuffer): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.BufferProtectUnprotectResult
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("unprotectAsync")(data.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.BufferProtectUnprotectResult
      ]]
    ...
    /**
      ...
      */
    /* static member */
    inline def unprotectStreamAsync(protectedStream: IInputStream, unprotectedStream: IOutputStream): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionInfo] = (^.asInstanceOf[js.Dynamic].applyDynamic("unprotectStreamAsync")(protectedStream.asInstanceOf[js.Any], unprotectedStream.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionInfo]]
  }
  ...
  object DataProtectionStatus extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionStatus & Double
      ] = js.native
    
    /* 5 */ val accessSuspended: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionStatus.accessSuspended & Double = js.native
    
    /* 4 */ val licenseExpired: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionStatus.licenseExpired & Double = js.native
    
    /* 1 */ val `protected`: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionStatus.`protected` & Double = js.native
    
    /* 0 */ val protectedToOtherIdentity: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionStatus.protectedToOtherIdentity & Double = js.native
    
    /* 2 */ val revoked: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionStatus.revoked & Double = js.native
    
    /* 3 */ val unprotected: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.DataProtectionStatus.unprotected & Double = js.native
  }
  ...
  object EnforcementLevel extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.EnforcementLevel & Double
      ] = js.native
    
    /* 3 */ val block: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.EnforcementLevel.block & Double = js.native
    
    /* 0 */ val noProtection: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.EnforcementLevel.noProtection & Double = js.native
    
    /* 2 */ val `override`: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.EnforcementLevel.`override` & Double = js.native
    
    /* 1 */ val silent: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.EnforcementLevel.silent & Double = js.native
  }
  ...
  open class FileProtectionInfo ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionInfo {
  ...
  open class FileProtectionManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionManager
  object FileProtectionManager {
    ...
    inline def createProtectedAndOpenAsync(
      ...
      collisionOption: CreationCollisionOption
        ...
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedFileCreateResult
      ] = (^.asInstanceOf[js.Dynamic].applyDynamic("createProtectedAndOpenAsync")(parentFolder.asInstanceOf[js.Any], desiredName.asInstanceOf[js.Any], identity.asInstanceOf[js.Any], collisionOption.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedFileCreateResult
      ]]
    ...
    /**
      ...
      */
    /* static member */
    inline def getProtectionInfoAsync(source: IStorageItem): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionInfo] = ^.asInstanceOf[js.Dynamic].applyDynamic("getProtectionInfoAsync")(source.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionInfo]]
    ...
    /**
      ...
      */
    /* static member */
    inline def loadFileFromContainerAsync(containerFile: IStorageFile): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedContainerImportResult
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("loadFileFromContainerAsync")(containerFile.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedContainerImportResult
      ]]
    /**
      ...
      */
    /* static member */
    inline def loadFileFromContainerAsync(containerFile: IStorageFile, target: IStorageItem): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedContainerImportResult
      ] = (^.asInstanceOf[js.Dynamic].applyDynamic("loadFileFromContainerAsync")(containerFile.asInstanceOf[js.Any], target.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedContainerImportResult
      ]]
    /**
      * Create an enterprise-protected file in a specified storage item (such as a folder), and load it from a container file.
      ...
      */
    /* static member */
    inline def loadFileFromContainerAsync(containerFile: IStorageFile, target: IStorageItem, collisionOption: NameCollisionOption): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedContainerImportResult
      ] = (^.asInstanceOf[js.Dynamic].applyDynamic("loadFileFromContainerAsync")(containerFile.asInstanceOf[js.Any], target.asInstanceOf[js.Any], collisionOption.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedContainerImportResult
      ]]
    ...
    /**
      ...
      */
    /* static member */
    inline def protectAsync(target: IStorageItem, identity: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionInfo] = (^.asInstanceOf[js.Dynamic].applyDynamic("protectAsync")(target.asInstanceOf[js.Any], identity.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionInfo]]
    ...
    /**
      ...
      */
    /* static member */
    inline def saveFileAsContainerAsync(protectedFile: IStorageFile): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedContainerExportResult
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("saveFileAsContainerAsync")(protectedFile.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedContainerExportResult
      ]]
    /**
      ...
      */
    /* static member */
    inline def saveFileAsContainerAsync(protectedFile: IStorageFile, sharedWithIdentities: IIterable[String]): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedContainerExportResult
      ] = (^.asInstanceOf[js.Dynamic].applyDynamic("saveFileAsContainerAsync")(protectedFile.asInstanceOf[js.Any], sharedWithIdentities.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedContainerExportResult
      ]]
  }
  ...
  object FileProtectionStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus & Double
      ] = js.native
    
    /* 10 */ val accessSuspended: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.accessSuspended & Double = js.native
    
    /* 9 */ val licenseExpired: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.licenseExpired & Double = js.native
    
    /* 7 */ val notProtectable: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.notProtectable & Double = js.native
    
    /* 4 */ val `protected`: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.`protected` & Double = js.native
    
    /* 5 */ val protectedByOtherUser: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.protectedByOtherUser & Double = js.native
    
    /* 6 */ val protectedToOtherEnterprise: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.protectedToOtherEnterprise & Double = js.native
    
    /* 8 */ val protectedToOtherIdentity: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.protectedToOtherIdentity & Double = js.native
    
    /* 3 */ val revoked: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.revoked & Double = js.native
    
    /* 0 */ val undetermined: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.undetermined & Double = js.native
    
    /* 1 */ val unknown: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.unknown & Double = js.native
    
    /* 2 */ val unprotected: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus.unprotected & Double = js.native
  }
  ...
  open class FileRevocationManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileRevocationManager
  ...
  open class ProtectedAccessResumedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedAccessResumedEventArgs {
  ...
  open class ProtectedAccessSuspendingEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedAccessSuspendingEventArgs {
  ...
  open class ProtectedContainerExportResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedContainerExportResult {
  ...
  open class ProtectedContainerImportResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedContainerImportResult {
  ...
  open class ProtectedContentRevokedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedContentRevokedEventArgs {
  ...
  open class ProtectedFileCreateResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedFileCreateResult {
    ...
    /* CompleteClass */
    var protectionInfo: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.FileProtectionInfo = js.native
  ...
  object ProtectedImportExportStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus & Double
      ] = js.native
    
    /* 7 */ val accessSuspended: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.accessSuspended & Double = js.native
    
    /* 6 */ val licenseExpired: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.licenseExpired & Double = js.native
    
    /* 4 */ val notRoamable: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.notRoamable & Double = js.native
    
    /* 0 */ val ok: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.ok & Double = js.native
    
    /* 5 */ val protectedToOtherIdentity: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.protectedToOtherIdentity & Double = js.native
    
    /* 3 */ val revoked: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.revoked & Double = js.native
    
    /* 1 */ val undetermined: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.undetermined & Double = js.native
    
    /* 2 */ val unprotected: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectedImportExportStatus.unprotected & Double = js.native
  }
  ...
  object ProtectionPolicyEvaluationResult extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult & Double
      ] = js.native
    
    /* 0 */ val allowed: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult.allowed & Double = js.native
    
    /* 1 */ val blocked: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult.blocked & Double = js.native
    
    /* 2 */ val consentRequired: typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectionPolicyEvaluationResult.consentRequired & Double = js.native
  }
  ...
  open class ProtectionPolicyManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectionPolicyManager {
  ...
  object ProtectionPolicyManager {
    ...
    /**
      ...
      */
    /* static member */
    inline def createCurrentThreadNetworkContext(identity: String): typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ThreadNetworkContext = ^.asInstanceOf[js.Dynamic].applyDynamic("createCurrentThreadNetworkContext")(identity.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ThreadNetworkContext]
    ...
    /**
      ...
      */
    /* static member */
    inline def getForCurrentView(): typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectionPolicyManager = ^.asInstanceOf[js.Dynamic].applyDynamic("getForCurrentView")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ProtectionPolicyManager]
  ...
  open class ThreadNetworkContext ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.EnterpriseData.ThreadNetworkContext {
