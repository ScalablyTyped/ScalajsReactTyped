...
object Provider {
  ...
  object AddContactResult extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Provider.AddContactResult & Double
      ] = js.native
    
    /* 0 */ val added: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Provider.AddContactResult.added & Double = js.native
    
    /* 1 */ val alreadyAdded: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Provider.AddContactResult.alreadyAdded & Double = js.native
    
    /* 2 */ val unavailable: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Provider.AddContactResult.unavailable & Double = js.native
  }
  ...
  open class ContactPickerUI ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Provider.ContactPickerUI
  ...
  open class ContactRemovedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Provider.ContactRemovedEventArgs {
