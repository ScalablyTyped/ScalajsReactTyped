...
open class ContactCardOptions ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactCardOptions {
  
  /** Gets or sets a value that specifies the type of header to display on the contact card. */
  /* CompleteClass */
  var headerKind: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactCardHeaderKind = js.native
  
  /** Gets or sets a value that indicates which tab to display first on a mini contact card. */
  /* CompleteClass */
  var initialTabKind: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactCardTabKind = js.native
