...
open class AppCaptureSettings ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Capture.AppCaptureSettings {
  
  /** Gets the alternate shortcut key settings. */
  /* CompleteClass */
  var alternateShortcutKeys: typingsJapgolly.winrtUwp.Windows.Media.Capture.AppCaptureAlternateShortcutKeys = js.native
  ...
  /* CompleteClass */
  var historicalBufferLengthUnit: typingsJapgolly.winrtUwp.Windows.Media.Capture.AppCaptureHistoricalBufferLengthUnit = js.native
  ...
  /* CompleteClass */
  var videoEncodingBitrateMode: typingsJapgolly.winrtUwp.Windows.Media.Capture.AppCaptureVideoEncodingBitrateMode = js.native
  
  /** Gets or sets the video encoding resolution mode. */
  /* CompleteClass */
  var videoEncodingResolutionMode: typingsJapgolly.winrtUwp.Windows.Media.Capture.AppCaptureVideoEncodingResolutionMode = js.native
}
