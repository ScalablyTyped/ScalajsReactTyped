...
open class ChatMessageValidationResult ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageValidationResult {
  ...
  /* CompleteClass */
  var status: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageValidationStatus = js.native
}
