...
open class MediaStreamSourceSampleRequest ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSourceSampleRequest {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSourceSampleRequestDeferral = js.native
  ...
  /* CompleteClass */
  var sample: typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSample = js.native
