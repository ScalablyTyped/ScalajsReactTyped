...
open class EmailIrmInfo ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailIrmInfo {
  /**
  ...
  def this(
    expiration: js.Date,
    irmTemplate: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailIrmTemplate
  ) = this()
  ...
  /* CompleteClass */
  var template: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailIrmTemplate = js.native
}
