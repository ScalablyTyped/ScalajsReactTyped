...
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountServerType
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountOtherAppReadAccess
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStoreAccessType
...
object UserDataAccounts {
  ...
  object SystemAccess {
    ...
    open class DeviceAccountConfiguration ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountConfiguration {
    ...
    object DeviceAccountServerType extends StObject {
      ...
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountServerType & Double
          ] = js.native
      
      /* 0 */ val exchange: typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountServerType.exchange & Double = js.native
      
      /* 2 */ val imap: typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountServerType.imap & Double = js.native
      
      /* 1 */ val pop: typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountServerType.pop & Double = js.native
    }
    ...
    open class UserDataAccountSystemAccessManager ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.UserDataAccountSystemAccessManager
    object UserDataAccountSystemAccessManager {
      ...
      inline def addAndShowDeviceAccountsAsync(
        accounts: IIterable[
              typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.SystemAccess.DeviceAccountConfiguration
            ]
  ...
  open class UserDataAccount ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccount {
  ...
  object UserDataAccountContentKinds extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds & Double
      ] = js.native
    
    /* 2 */ val appointment: typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds.appointment & Double = js.native
    
    /* 1 */ val contact: typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds.contact & Double = js.native
    
    /* 0 */ val email: typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountContentKinds.email & Double = js.native
  }
  ...
  open class UserDataAccountManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountManager
  object UserDataAccountManager {
    ...
    /**
      ...
      */
    /* static member */
    inline def requestStoreAsync(storeAccessType: UserDataAccountStoreAccessType): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStore
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("requestStoreAsync")(storeAccessType.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStore
      ]]
  ...
  object UserDataAccountOtherAppReadAccess extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountOtherAppReadAccess & Double
      ] = js.native
    
    /* 1 */ val full: typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountOtherAppReadAccess.full & Double = js.native
    
    /* 0 */ val systemOnly: typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountOtherAppReadAccess.systemOnly & Double = js.native
  }
  ...
  open class UserDataAccountStore ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStore {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def createAccountAsync(userDisplayName: String): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccount
      ] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getAccountAsync(id: String): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccount
      ] = js.native
  }
  ...
  object UserDataAccountStoreAccessType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStoreAccessType & Double
      ] = js.native
    
    /* 0 */ val allAccountsReadOnly: typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStoreAccessType.allAccountsReadOnly & Double = js.native
    
    /* 1 */ val appAccountsReadWrite: typingsJapgolly.winrtUwp.Windows.ApplicationModel.UserDataAccounts.UserDataAccountStoreAccessType.appAccountsReadWrite & Double = js.native
  }
}
