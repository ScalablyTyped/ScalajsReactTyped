...
import typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlRecipient
import typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlTransferType
import typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbEndpointType
import typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbReadOptions
import typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbTransferDirection
import typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbWriteOptions
...
import typingsJapgolly.winrtUwp.anon.Parsed
import typingsJapgolly.winrtUwp.anon.ParsedReturnValue
import typingsJapgolly.winrtUwp.anon.ParsedUsbInterfaceDescriptor
...
object Usb {
  ...
  open class UsbBulkInEndpointDescriptor ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkInEndpointDescriptor {
    ...
    /* CompleteClass */
    var pipe: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkInPipe = js.native
  }
  ...
  open class UsbBulkInPipe ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkInPipe {
    ...
    /* CompleteClass */
    var endpointDescriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkInEndpointDescriptor = js.native
  ...
  open class UsbBulkOutEndpointDescriptor ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkOutEndpointDescriptor {
    ...
    /** Gets the object that represents the pipe that the host opens to communicate with the bulk IN endpoint. */
    /* CompleteClass */
    var pipe: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkOutPipe = js.native
  }
  ...
  open class UsbBulkOutPipe ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkOutPipe {
    ...
    /* CompleteClass */
    var endpointDescriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkOutEndpointDescriptor = js.native
  ...
  open class UsbConfiguration ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbConfiguration {
    
    /** Gets the object that contains the first 9 bytes of the descriptor associated with the USB configuration. */
    /* CompleteClass */
    var configurationDescriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbConfigurationDescriptor = js.native
    
    /** Gets an array of objects that represent the full set of descriptors associated with a USB configuration. */
    /* CompleteClass */
    var descriptors: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDescriptor] = js.native
    
    /** Gets an array of USB interfaces available in the USB configuration. */
    /* CompleteClass */
    var usbInterfaces: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterface] = js.native
  }
  ...
  open class UsbConfigurationDescriptor ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbConfigurationDescriptor {
  ...
  object UsbConfigurationDescriptor {
    ...
    /**
      ...
      */
    /* static member */
    inline def parse(descriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDescriptor): typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbConfigurationDescriptor = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(descriptor.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbConfigurationDescriptor]
    ...
    /**
      ...
      */
    /* static member */
    inline def tryParse(descriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDescriptor): Parsed = ^.asInstanceOf[js.Dynamic].applyDynamic("tryParse")(descriptor.asInstanceOf[js.Any]).asInstanceOf[Parsed]
  }
  ...
  object UsbControlRecipient extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlRecipient & Double] = js.native
    
    /* 4 */ val defaultInterface: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlRecipient.defaultInterface & Double = js.native
    
    /* 0 */ val device: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlRecipient.device & Double = js.native
    
    /* 2 */ val endpoint: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlRecipient.endpoint & Double = js.native
    
    /* 3 */ val other: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlRecipient.other & Double = js.native
    
    /* 1 */ val specifiedInterface: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlRecipient.specifiedInterface & Double = js.native
  }
  ...
  open class UsbControlRequestType ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlRequestType {
  ...
  object UsbControlTransferType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlTransferType & Double] = js.native
    
    /* 1 */ val `class`: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlTransferType.`class` & Double = js.native
    
    /* 0 */ val standard: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlTransferType.standard & Double = js.native
    
    /* 2 */ val vendor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlTransferType.vendor & Double = js.native
  }
  ...
  open class UsbDescriptor ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDescriptor {
  ...
  open class UsbDevice ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDevice
  object UsbDevice {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDevice] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDevice]]
    ...
    /**
      ...
      */
    /* static member */
    inline def getDeviceClassSelector(usbClass: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getDeviceClassSelector")(usbClass.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  open class UsbDeviceClass ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass {
  ...
  open class UsbDeviceClasses ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClasses
  object UsbDeviceClasses {
    ...
    @js.native
    def activeSync: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass = js.native
    inline def activeSync_=(x: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("activeSync")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def cdcControl: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass = js.native
    inline def cdcControl_=(x: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("cdcControl")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def deviceFirmwareUpdate: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass = js.native
    inline def deviceFirmwareUpdate_=(x: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("deviceFirmwareUpdate")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def irda: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass = js.native
    inline def irda_=(x: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("irda")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def measurement: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass = js.native
    inline def measurement_=(x: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("measurement")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def palmSync: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass = js.native
    inline def palmSync_=(x: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("palmSync")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def personalHealthcare: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass = js.native
    inline def personalHealthcare_=(x: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("personalHealthcare")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def physical: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass = js.native
    inline def physical_=(x: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("physical")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def vendorSpecific: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass = js.native
    inline def vendorSpecific_=(x: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceClass): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("vendorSpecific")(x.asInstanceOf[js.Any])
  }
  ...
  open class UsbDeviceDescriptor ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDeviceDescriptor {
  ...
  open class UsbEndpointDescriptor ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbEndpointDescriptor {
    
    /** Gets an object that represents the endpoint descriptor for the USB bulk IN endpoint. */
    /* CompleteClass */
    var asBulkInEndpointDescriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkInEndpointDescriptor = js.native
    
    /** Gets an object that represents the endpoint descriptor for the USB bulk OUT endpoint. */
    /* CompleteClass */
    var asBulkOutEndpointDescriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkOutEndpointDescriptor = js.native
    
    /** Gets an object that represents the endpoint descriptor for the USB interrupt IN endpoint. */
    /* CompleteClass */
    var asInterruptInEndpointDescriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptInEndpointDescriptor = js.native
    
    /** Gets an object that represents the endpoint descriptor for the USB interrupt OUT endpoint. */
    /* CompleteClass */
    var asInterruptOutEndpointDescriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptOutEndpointDescriptor = js.native
  ...
  object UsbEndpointDescriptor {
    ...
    /**
      ...
      */
    /* static member */
    inline def parse(descriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDescriptor): typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbEndpointDescriptor = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(descriptor.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbEndpointDescriptor]
    ...
    /**
      ...
      */
    /* static member */
    inline def tryParse(descriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDescriptor): ParsedReturnValue = ^.asInstanceOf[js.Dynamic].applyDynamic("tryParse")(descriptor.asInstanceOf[js.Any]).asInstanceOf[ParsedReturnValue]
  }
  ...
  object UsbEndpointType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbEndpointType & Double] = js.native
    
    /* 2 */ val bulk: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbEndpointType.bulk & Double = js.native
    
    /* 0 */ val control: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbEndpointType.control & Double = js.native
    
    /* 3 */ val interrupt: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbEndpointType.interrupt & Double = js.native
    
    /* 1 */ val isochronous: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbEndpointType.isochronous & Double = js.native
  }
  ...
  open class UsbInterface ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterface {
    ...
    /* CompleteClass */
    var bulkInPipes: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkInPipe] = js.native
    ...
    /* CompleteClass */
    var bulkOutPipes: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkOutPipe] = js.native
    ...
    /* CompleteClass */
    var interfaceSettings: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterfaceSetting] = js.native
    ...
    /* CompleteClass */
    var interruptInPipes: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptInPipe] = js.native
    ...
    /* CompleteClass */
    var interruptOutPipes: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptOutPipe] = js.native
  }
  ...
  open class UsbInterfaceDescriptor ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterfaceDescriptor {
  ...
  object UsbInterfaceDescriptor {
    ...
    /**
      ...
      */
    /* static member */
    inline def parse(descriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDescriptor): typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterfaceDescriptor = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(descriptor.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterfaceDescriptor]
    ...
    /**
      ...
      */
    /* static member */
    inline def tryParse(descriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbDescriptor): ParsedUsbInterfaceDescriptor = ^.asInstanceOf[js.Dynamic].applyDynamic("tryParse")(descriptor.asInstanceOf[js.Any]).asInstanceOf[ParsedUsbInterfaceDescriptor]
  }
  ...
  open class UsbInterfaceSetting ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterfaceSetting {
    ...
    /* CompleteClass */
    var bulkInEndpoints: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkInEndpointDescriptor] = js.native
    ...
    /* CompleteClass */
    var bulkOutEndpoints: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbBulkOutEndpointDescriptor] = js.native
    ...
    /* CompleteClass */
    var interfaceDescriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterfaceDescriptor = js.native
    ...
    /* CompleteClass */
    var interruptInEndpoints: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptInEndpointDescriptor] = js.native
    ...
    /* CompleteClass */
    var interruptOutEndpoints: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptOutEndpointDescriptor] = js.native
  ...
  open class UsbInterruptInEndpointDescriptor ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptInEndpointDescriptor {
    ...
    /* CompleteClass */
    var pipe: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptInPipe = js.native
  }
  ...
  open class UsbInterruptInEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptInEventArgs {
  ...
  open class UsbInterruptInPipe ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptInPipe
  ...
  open class UsbInterruptOutEndpointDescriptor ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptOutEndpointDescriptor {
    ...
    /* CompleteClass */
    var pipe: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptOutPipe = js.native
  }
  ...
  open class UsbInterruptOutPipe ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptOutPipe {
    ...
    /* CompleteClass */
    var endpointDescriptor: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbInterruptOutEndpointDescriptor = js.native
  ...
  object UsbReadOptions extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbReadOptions & Double] = js.native
    
    /* 4 */ val allowPartialReads: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbReadOptions.allowPartialReads & Double = js.native
    
    /* 1 */ val autoClearStall: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbReadOptions.autoClearStall & Double = js.native
    
    /* 3 */ val ignoreShortPacket: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbReadOptions.ignoreShortPacket & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbReadOptions.none & Double = js.native
    
    /* 2 */ val overrideAutomaticBufferManagement: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbReadOptions.overrideAutomaticBufferManagement & Double = js.native
  }
  ...
  open class UsbSetupPacket ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbSetupPacket {
    /**
    ...
    /* CompleteClass */
    var requestType: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbControlRequestType = js.native
  ...
  object UsbTransferDirection extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbTransferDirection & Double] = js.native
    
    /* 1 */ val in: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbTransferDirection.in & Double = js.native
    
    /* 0 */ val out: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbTransferDirection.out & Double = js.native
  }
  ...
  object UsbWriteOptions extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbWriteOptions & Double] = js.native
    
    /* 1 */ val autoClearStall: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbWriteOptions.autoClearStall & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbWriteOptions.none & Double = js.native
    
    /* 2 */ val shortPacketTerminate: typingsJapgolly.winrtUwp.Windows.Devices.Usb.UsbWriteOptions.shortPacketTerminate & Double = js.native
  }
}
