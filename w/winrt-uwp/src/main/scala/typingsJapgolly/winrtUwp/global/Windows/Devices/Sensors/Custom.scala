...
object Custom {
  ...
  open class CustomSensor ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sensors.Custom.CustomSensor
  object CustomSensor {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIdAsync(sensorId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Sensors.Custom.CustomSensor] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(sensorId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Sensors.Custom.CustomSensor]]
  ...
  open class CustomSensorReading ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sensors.Custom.CustomSensorReading {
  ...
  open class CustomSensorReadingChangedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sensors.Custom.CustomSensorReadingChangedEventArgs {
    
    /** Gets the most recent sensor reading. */
    /* CompleteClass */
    var reading: typingsJapgolly.winrtUwp.Windows.Devices.Sensors.Custom.CustomSensorReading = js.native
  }
}
