...
import typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.CredentialCommandCredentialDeletedHandler
import typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsEdgeLocation
import typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SupportedWebAccountActions
import typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountAction
import typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountCommandInvokedHandler
import typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountProviderCommandInvokedHandler
...
object ApplicationSettings {
  ...
  open class AccountsSettingsPane ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.AccountsSettingsPane
  object AccountsSettingsPane {
    ...
    /**
      ...
      */
    /* static member */
    inline def getForCurrentView(): typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.AccountsSettingsPane = ^.asInstanceOf[js.Dynamic].applyDynamic("getForCurrentView")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.AccountsSettingsPane]
  ...
  open class AccountsSettingsPaneCommandsRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.AccountsSettingsPaneCommandsRequestedEventArgs {
    
    /** Gets the SettingsCommand collection for the account settings pane. */
    /* CompleteClass */
    var commands: IVector[typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsCommand] = js.native
    
    /** Gets the CredentialCommand collection for the account settings pane. */
    /* CompleteClass */
    var credentialCommands: IVector[typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.CredentialCommand] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getDeferral(): typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.AccountsSettingsPaneEventDeferral = js.native
    ...
    /* CompleteClass */
    var webAccountCommands: IVector[typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountCommand] = js.native
    
    /** Gets the WebAccountProviderCommand collection for the account settings pane. */
    /* CompleteClass */
    var webAccountProviderCommands: IVector[
        typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountProviderCommand
      ] = js.native
  }
  ...
  open class AccountsSettingsPaneEventDeferral ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.AccountsSettingsPaneEventDeferral {
  ...
  open class CredentialCommand protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.CredentialCommand {
    /**
    ...
    /* CompleteClass */
    override def credentialDeleted(command: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.CredentialCommand): Unit = js.native
    /** Gets the delegate that's invoked by the account settings pane when the user deletes a credential. */
    /* CompleteClass */
  ...
  open class SettingsCommand protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsCommand {
    /**
  ...
  object SettingsCommand {
    ...
    @js.native
    def accountsCommand: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsCommand = js.native
    inline def accountsCommand_=(x: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsCommand): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("accountsCommand")(x.asInstanceOf[js.Any])
  }
  ...
  object SettingsEdgeLocation extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsEdgeLocation & Double
      ] = js.native
    
    /* 1 */ val left: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsEdgeLocation.left & Double = js.native
    
    /* 0 */ val right: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsEdgeLocation.right & Double = js.native
  }
  ...
  open class SettingsPane ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsPane
  object SettingsPane {
    ...
    /**
      ...
      */
    /* static member */
    inline def getForCurrentView(): typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsPane = ^.asInstanceOf[js.Dynamic].applyDynamic("getForCurrentView")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsPane]
  ...
  open class SettingsPaneCommandsRequest ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsPaneCommandsRequest {
    ...
    /* CompleteClass */
    var applicationCommands: IVector[typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsCommand] = js.native
  }
  ...
  open class SettingsPaneCommandsRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsPaneCommandsRequestedEventArgs {
    
    /** An instance of SettingsPaneCommandsRequest that is made available during the CommandsRequested event. */
    /* CompleteClass */
    var request: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SettingsPaneCommandsRequest = js.native
  }
  ...
  object SupportedWebAccountActions extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SupportedWebAccountActions & Double
      ] = js.native
    
    /* 4 */ val manage: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SupportedWebAccountActions.manage & Double = js.native
    
    /* 5 */ val more: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SupportedWebAccountActions.more & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SupportedWebAccountActions.none & Double = js.native
    
    /* 1 */ val reconnect: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SupportedWebAccountActions.reconnect & Double = js.native
    
    /* 2 */ val remove: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SupportedWebAccountActions.remove & Double = js.native
    
    /* 3 */ val viewDetails: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.SupportedWebAccountActions.viewDetails & Double = js.native
  }
  ...
  object WebAccountAction extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountAction & Double
      ] = js.native
    
    /* 3 */ val manage: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountAction.manage & Double = js.native
    
    /* 4 */ val more: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountAction.more & Double = js.native
    
    /* 0 */ val reconnect: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountAction.reconnect & Double = js.native
    
    /* 1 */ val remove: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountAction.remove & Double = js.native
    
    /* 2 */ val viewDetails: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountAction.viewDetails & Double = js.native
  }
  ...
  open class WebAccountCommand protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountCommand {
    /**
  ...
  open class WebAccountInvokedArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountInvokedArgs {
  ...
  open class WebAccountProviderCommand protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountProviderCommand {
    /**
    ...
    /* CompleteClass */
    override def invoked(command: typingsJapgolly.winrtUwp.Windows.UI.ApplicationSettings.WebAccountProviderCommand): Unit = js.native
    /** Gets the delegate that's invoked when the user selects an account and a specific action in the accounts pane. */
    /* CompleteClass */
    @JSName("invoked")
