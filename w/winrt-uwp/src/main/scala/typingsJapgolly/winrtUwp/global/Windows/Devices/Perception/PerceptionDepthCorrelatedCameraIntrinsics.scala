...
open class PerceptionDepthCorrelatedCameraIntrinsics ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Perception.PerceptionDepthCorrelatedCameraIntrinsics {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def unprojectAllPixelsAtCorrelatedDepthAsync(depthFrame: typingsJapgolly.winrtUwp.Windows.Devices.Perception.PerceptionDepthFrame): Results = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def unprojectRegionPixelsAtCorrelatedDepthAsync(region: Rect, depthFrame: typingsJapgolly.winrtUwp.Windows.Devices.Perception.PerceptionDepthFrame): Results = js.native
}
