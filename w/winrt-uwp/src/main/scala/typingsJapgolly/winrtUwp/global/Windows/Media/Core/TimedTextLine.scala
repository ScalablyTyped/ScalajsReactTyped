...
open class TimedTextLine ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.TimedTextLine {
  
  /** Gets a list of TimedTextSubformat objects that provide formatting for substrings within the TimedTextLine . */
  /* CompleteClass */
  var subformats: IVector[typingsJapgolly.winrtUwp.Windows.Media.Core.TimedTextSubformat] = js.native
