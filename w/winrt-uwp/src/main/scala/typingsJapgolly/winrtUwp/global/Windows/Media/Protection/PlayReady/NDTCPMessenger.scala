...
import typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.INDSendResult
...
open class NDTCPMessenger protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.NDTCPMessenger {
  /**
  ...
  override def sendProximityDetectionResponseAsync(
    pdType: typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.NDProximityDetectionType,
