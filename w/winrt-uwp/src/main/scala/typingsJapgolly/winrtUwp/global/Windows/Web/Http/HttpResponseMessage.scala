...
open class HttpResponseMessage ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Web.Http.HttpResponseMessage {
  /**
    * Initializes a new instance of the HttpResponseMessage class with a specific HttpStatusCode .
    * @param statusCode The status code of the HTTP response.
    */
  def this(statusCode: typingsJapgolly.winrtUwp.Windows.Web.Http.HttpStatusCode) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def ensureSuccessStatusCode(): typingsJapgolly.winrtUwp.Windows.Web.Http.HttpResponseMessage = js.native
  ...
  /* CompleteClass */
  var requestMessage: typingsJapgolly.winrtUwp.Windows.Web.Http.HttpRequestMessage = js.native
  
  /** Gets the source of the data received in the HttpResponseMessage . */
  /* CompleteClass */
  var source: typingsJapgolly.winrtUwp.Windows.Web.Http.HttpResponseMessageSource = js.native
  
  /** Gets or sets the status code of the HTTP response. */
  /* CompleteClass */
  var statusCode: typingsJapgolly.winrtUwp.Windows.Web.Http.HttpStatusCode = js.native
  
  /** Gets or sets the HTTP protocol version used on the HttpResponseMessage object. */
  /* CompleteClass */
  var version: typingsJapgolly.winrtUwp.Windows.Web.Http.HttpVersion = js.native
}
