...
open class RcsManager ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.RcsManager
object RcsManager {
  ...
  /**
    ...
    */
  /* static member */
  inline def getEndUserMessageManager(): typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.RcsEndUserMessageManager = ^.asInstanceOf[js.Dynamic].applyDynamic("getEndUserMessageManager")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.RcsEndUserMessageManager]
  ...
  /**
    ...
    */
  /* static member */
  inline def getTransportAsync(transportId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.RcsTransport] = ^.asInstanceOf[js.Dynamic].applyDynamic("getTransportAsync")(transportId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.RcsTransport]]
  ...
  /**
    ...
    */
  /* static member */
  inline def leaveConversationAsync(conversation: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatConversation): IPromiseWithIAsyncAction = ^.asInstanceOf[js.Dynamic].applyDynamic("leaveConversationAsync")(conversation.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncAction]
}
