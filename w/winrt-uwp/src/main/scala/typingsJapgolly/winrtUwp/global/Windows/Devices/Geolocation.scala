...
import typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.AltitudeReferenceSystem
import typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.BasicGeoposition
import typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceRemovalReason
import typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceState
import typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.MonitoredGeofenceStates
import typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeolocationAccessStatus
import typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeoshapeType
import typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.IGeoshape
import typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionSource
import typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionStatus
...
object Geolocation {
  ...
  object AltitudeReferenceSystem extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.AltitudeReferenceSystem & Double
      ] = js.native
    
    /* 2 */ val ellipsoid: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.AltitudeReferenceSystem.ellipsoid & Double = js.native
    
    /* 3 */ val geoid: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.AltitudeReferenceSystem.geoid & Double = js.native
    
    /* 4 */ val surface: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.AltitudeReferenceSystem.surface & Double = js.native
    
    /* 1 */ val terrain: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.AltitudeReferenceSystem.terrain & Double = js.native
    
    /* 0 */ val unspecified: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.AltitudeReferenceSystem.unspecified & Double = js.native
  }
  ...
  open class CivicAddress ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.CivicAddress {
  ...
  open class GeoboundingBox protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeoboundingBox {
    /**
  ...
  object GeoboundingBox {
    ...
    /**
      ...
      */
    /* static member */
    inline def tryCompute(positions: IIterable[BasicGeoposition]): typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeoboundingBox = ^.asInstanceOf[js.Dynamic].applyDynamic("tryCompute")(positions.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeoboundingBox]
    /**
      ...
      */
    /* static member */
    inline def tryCompute(positions: IIterable[BasicGeoposition], altitudeRefSystem: AltitudeReferenceSystem): typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeoboundingBox = (^.asInstanceOf[js.Dynamic].applyDynamic("tryCompute")(positions.asInstanceOf[js.Any], altitudeRefSystem.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeoboundingBox]
    /**
    ...
    inline def tryCompute(
      ...
      spatialReferenceId: Double
    ): typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeoboundingBox = (^.asInstanceOf[js.Dynamic].applyDynamic("tryCompute")(positions.asInstanceOf[js.Any], altitudeRefSystem.asInstanceOf[js.Any], spatialReferenceId.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeoboundingBox]
  }
  ...
  open class Geocircle protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geocircle {
    /**
  ...
  open class Geocoordinate ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geocoordinate {
    ...
    /* CompleteClass */
    var point: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geopoint = js.native
    ...
    /* CompleteClass */
    var satelliteData: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeocoordinateSatelliteData = js.native
  ...
  open class GeocoordinateSatelliteData ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeocoordinateSatelliteData {
  ...
  object Geofencing {
    ...
    open class Geofence protected ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.Geofence {
      /**
    ...
    open class GeofenceMonitor ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitor
    object GeofenceMonitor {
      ...
      @js.native
      def current: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitor = js.native
      inline def current_=(x: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitor): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("current")(x.asInstanceOf[js.Any])
    }
    ...
    object GeofenceMonitorStatus extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus & Double
          ] = js.native
      
      /* 3 */ val disabled: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus.disabled & Double = js.native
      
      /* 1 */ val initializing: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus.initializing & Double = js.native
      
      /* 2 */ val noData: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus.noData & Double = js.native
      
      /* 5 */ val notAvailable: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus.notAvailable & Double = js.native
      
      /* 4 */ val notInitialized: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus.notInitialized & Double = js.native
      
      /* 0 */ val ready: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus.ready & Double = js.native
    }
    ...
    object GeofenceRemovalReason extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceRemovalReason & Double
          ] = js.native
      
      /* 1 */ val expired: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceRemovalReason.expired & Double = js.native
      
      /* 0 */ val used: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceRemovalReason.used & Double = js.native
    }
    ...
    object GeofenceState extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceState & Double
          ] = js.native
      
      /* 1 */ val entered: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceState.entered & Double = js.native
      
      /* 2 */ val exited: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceState.exited & Double = js.native
      
      /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceState.none & Double = js.native
      
      /* 3 */ val removed: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceState.removed & Double = js.native
    }
    ...
    open class GeofenceStateChangeReport ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.GeofenceStateChangeReport {
      
      /** The Geofence object whose state has changed. */
      /* CompleteClass */
      var geofence: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.Geofence = js.native
      
      /** The position of the Geofence object whose state has changed. */
      /* CompleteClass */
      var geoposition: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geoposition = js.native
    ...
    object MonitoredGeofenceStates extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.MonitoredGeofenceStates & Double
          ] = js.native
      
      /* 1 */ val entered: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.MonitoredGeofenceStates.entered & Double = js.native
      
      /* 2 */ val exited: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.MonitoredGeofenceStates.exited & Double = js.native
      
      /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.MonitoredGeofenceStates.none & Double = js.native
      
      /* 3 */ val removed: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geofencing.MonitoredGeofenceStates.removed & Double = js.native
    }
  }
  ...
  object GeolocationAccessStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeolocationAccessStatus & Double
      ] = js.native
    
    /* 1 */ val allowed: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeolocationAccessStatus.allowed & Double = js.native
    
    /* 2 */ val denied: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeolocationAccessStatus.denied & Double = js.native
    
    /* 0 */ val unspecified: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeolocationAccessStatus.unspecified & Double = js.native
  }
  ...
  open class Geolocator ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geolocator
  object Geolocator {
  ...
  open class Geopath protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geopath {
    /**
  ...
  open class Geopoint protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geopoint {
    /**
  ...
  open class Geoposition ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geoposition {
    
    /** Unsupported API. */
    /* CompleteClass */
    var civicAddress: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.CivicAddress = js.native
    
    /** The latitude and longitude associated with a geographic location. */
    /* CompleteClass */
    var coordinate: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geocoordinate = js.native
    
    /** Represents the venue associated with a geographic location. */
    /* CompleteClass */
    var venueData: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.VenueData = js.native
  }
  ...
  object GeoshapeType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeoshapeType & Double] = js.native
    
    /* 3 */ val geoboundingBox: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeoshapeType.geoboundingBox & Double = js.native
    
    /* 1 */ val geocircle: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeoshapeType.geocircle & Double = js.native
    
    /* 2 */ val geopath: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeoshapeType.geopath & Double = js.native
    
    /* 0 */ val geopoint: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.GeoshapeType.geopoint & Double = js.native
  }
  ...
  object PositionAccuracy extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionAccuracy & Double] = js.native
    
    /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionAccuracy.default & Double = js.native
    
    /* 1 */ val high: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionAccuracy.high & Double = js.native
  }
  ...
  open class PositionChangedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionChangedEventArgs {
    
    /** The location data associated with the PositionChanged event. */
    /* CompleteClass */
    var position: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.Geoposition = js.native
  }
  ...
  object PositionSource extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionSource & Double] = js.native
    
    /* 0 */ val cellular: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionSource.cellular & Double = js.native
    
    /* 3 */ val ipAddress: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionSource.ipAddress & Double = js.native
    
    /* 1 */ val satellite: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionSource.satellite & Double = js.native
    
    /* 4 */ val unknown: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionSource.unknown & Double = js.native
    
    /* 2 */ val wiFi: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionSource.wiFi & Double = js.native
  }
  ...
  object PositionStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionStatus & Double] = js.native
    
    /* 3 */ val disabled: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionStatus.disabled & Double = js.native
    
    /* 1 */ val initializing: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionStatus.initializing & Double = js.native
    
    /* 2 */ val noData: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionStatus.noData & Double = js.native
    
    /* 5 */ val notAvailable: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionStatus.notAvailable & Double = js.native
    
    /* 4 */ val notInitialized: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionStatus.notInitialized & Double = js.native
    
    /* 0 */ val ready: typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.PositionStatus.ready & Double = js.native
  }
  ...
  open class StatusChangedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.StatusChangedEventArgs {
  ...
  open class VenueData ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Geolocation.VenueData {
