...
open class MediaStreamSourceSwitchStreamsRequest ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSourceSwitchStreamsRequest {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSourceSwitchStreamsRequestDeferral = js.native
