...
open class KeypadPressedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Devices.KeypadPressedEventArgs {
  
  /** Returns the value of the keypad button on the device that was pressed. */
  /* CompleteClass */
  var telephonyKey: typingsJapgolly.winrtUwp.Windows.Media.Devices.TelephonyKey = js.native
}
