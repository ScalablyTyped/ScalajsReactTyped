...
import typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerLocationId
import typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerViewMode
...
object Pickers {
  ...
  open class FileExtensionVector ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.FileExtensionVector
  ...
  open class FileOpenPicker ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.FileOpenPicker
  ...
  open class FilePickerFileTypesOrderedMap ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.FilePickerFileTypesOrderedMap {
  ...
  open class FilePickerSelectedFilesArray ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.FilePickerSelectedFilesArray
  ...
  open class FileSavePicker ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.FileSavePicker {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def pickSaveFileAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Storage.StorageFile] = js.native
    ...
    /* CompleteClass */
    var suggestedSaveFile: typingsJapgolly.winrtUwp.Windows.Storage.StorageFile = js.native
  ...
  open class FolderPicker ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.FolderPicker {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def pickSingleFolderAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Storage.StorageFolder] = js.native
  ...
  object PickerLocationId extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerLocationId & Double] = js.native
    
    /* 1 */ val computerFolder: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerLocationId.computerFolder & Double = js.native
    
    /* 2 */ val desktop: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerLocationId.desktop & Double = js.native
    
    /* 0 */ val documentsLibrary: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerLocationId.documentsLibrary & Double = js.native
    
    /* 3 */ val downloads: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerLocationId.downloads & Double = js.native
    
    /* 4 */ val homeGroup: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerLocationId.homeGroup & Double = js.native
    
    /* 5 */ val musicLibrary: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerLocationId.musicLibrary & Double = js.native
    
    /* 8 */ val objects3D: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerLocationId.objects3D & Double = js.native
    
    /* 6 */ val picturesLibrary: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerLocationId.picturesLibrary & Double = js.native
    
    /* 9 */ val unspecified: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerLocationId.unspecified & Double = js.native
    
    /* 7 */ val videosLibrary: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerLocationId.videosLibrary & Double = js.native
  }
  ...
  object PickerViewMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerViewMode & Double] = js.native
    
    /* 0 */ val list: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerViewMode.list & Double = js.native
    
    /* 1 */ val thumbnail: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.PickerViewMode.thumbnail & Double = js.native
  }
  ...
  object Provider {
    ...
    object AddFileResult extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.AddFileResult & Double] = js.native
      
      /* 0 */ val added: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.AddFileResult.added & Double = js.native
      
      /* 1 */ val alreadyAdded: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.AddFileResult.alreadyAdded & Double = js.native
      
      /* 2 */ val notAllowed: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.AddFileResult.notAllowed & Double = js.native
      
      /* 3 */ val unavailable: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.AddFileResult.unavailable & Double = js.native
    }
    ...
    open class FileOpenPickerUI ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.FileOpenPickerUI
    ...
    open class FileRemovedEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.FileRemovedEventArgs {
    ...
    open class FileSavePickerUI ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.FileSavePickerUI
    ...
    object FileSelectionMode extends StObject {
      ...
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.FileSelectionMode & Double
          ] = js.native
      
      /* 1 */ val multiple: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.FileSelectionMode.multiple & Double = js.native
      
      /* 0 */ val single: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.FileSelectionMode.single & Double = js.native
    }
    ...
    open class PickerClosingDeferral ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.PickerClosingDeferral {
    ...
    open class PickerClosingEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.PickerClosingEventArgs {
      
      /** Gets a pickerClosingOperation object that is used to respond to a closing event. */
      /* CompleteClass */
      var closingOperation: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.PickerClosingOperation = js.native
    ...
    open class PickerClosingOperation ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.PickerClosingOperation {
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def getDeferral(): typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.PickerClosingDeferral = js.native
    }
    ...
    object SetFileNameResult extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.SetFileNameResult & Double
          ] = js.native
      
      /* 1 */ val notAllowed: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.SetFileNameResult.notAllowed & Double = js.native
      
      /* 0 */ val succeeded: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.SetFileNameResult.succeeded & Double = js.native
      
      /* 2 */ val unavailable: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.SetFileNameResult.unavailable & Double = js.native
    }
    ...
    open class TargetFileRequest ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.TargetFileRequest {
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def getDeferral(): typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.TargetFileRequestDeferral = js.native
    ...
    open class TargetFileRequestDeferral ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.TargetFileRequestDeferral {
    ...
    open class TargetFileRequestedEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.TargetFileRequestedEventArgs {
      
      /** Gets a targetFileRequest object that is used to respond to a targetfilerequested event. */
      /* CompleteClass */
      var request: typingsJapgolly.winrtUwp.Windows.Storage.Pickers.Provider.TargetFileRequest = js.native
    }
  }
}
