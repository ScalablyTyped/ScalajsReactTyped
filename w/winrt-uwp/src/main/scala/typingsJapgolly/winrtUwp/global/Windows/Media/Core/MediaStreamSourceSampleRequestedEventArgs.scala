...
open class MediaStreamSourceSampleRequestedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSourceSampleRequestedEventArgs {
  
  /** Gets the object that represents the request for a MediaStreamSample . */
  /* CompleteClass */
  var request: typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSourceSampleRequest = js.native
}
