...
import typingsJapgolly.winrtUwp.Windows.UI.StartScreen.ForegroundText
import typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListItemKind
import typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListSystemGroupKind
import typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileOptions
import typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileSize
...
object StartScreen {
  ...
  object ForegroundText extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.UI.StartScreen.ForegroundText & Double] = js.native
    
    /* 0 */ val dark: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.ForegroundText.dark & Double = js.native
    
    /* 1 */ val light: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.ForegroundText.light & Double = js.native
  }
  ...
  open class JumpList ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpList {
    
    /** Gets the list of JumpListItem 's for the jump list. Items is of type IVector(JumpListItem) . */
    /* CompleteClass */
    var items: IVector[typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListItem] = js.native
  ...
  object JumpList {
    ...
    /**
      ...
      */
    /* static member */
    inline def loadCurrentAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpList] = ^.asInstanceOf[js.Dynamic].applyDynamic("loadCurrentAsync")().asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpList]]
  }
  ...
  open class JumpListItem ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListItem {
  ...
  object JumpListItem {
    ...
    /**
      ...
      */
    /* static member */
    inline def createSeparator(): typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListItem = ^.asInstanceOf[js.Dynamic].applyDynamic("createSeparator")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListItem]
    ...
    /**
      ...
      */
    /* static member */
    inline def createWithArguments(args: String, displayName: String): typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListItem = (^.asInstanceOf[js.Dynamic].applyDynamic("createWithArguments")(args.asInstanceOf[js.Any], displayName.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListItem]
  }
  ...
  object JumpListItemKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListItemKind & Double] = js.native
    
    /* 0 */ val arguments: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListItemKind.arguments & Double = js.native
    
    /* 1 */ val separator: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListItemKind.separator & Double = js.native
  }
  ...
  object JumpListSystemGroupKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListSystemGroupKind & Double] = js.native
    
    /* 1 */ val frequent: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListSystemGroupKind.frequent & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListSystemGroupKind.none & Double = js.native
    
    /* 2 */ val recent: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.JumpListSystemGroupKind.recent & Double = js.native
  }
  ...
  open class SecondaryTile ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.StartScreen.SecondaryTile {
    /**
  ...
  open class SecondaryTileVisualElements ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.StartScreen.SecondaryTileVisualElements {
  ...
  object TileOptions extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileOptions & Double] = js.native
    
    /* 3 */ val copyOnDeployment: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileOptions.copyOnDeployment & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileOptions.none & Double = js.native
    
    /* 1 */ val showNameOnLogo: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileOptions.showNameOnLogo & Double = js.native
    
    /* 2 */ val showNameOnWideLogo: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileOptions.showNameOnWideLogo & Double = js.native
  }
  ...
  object TileSize extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileSize & Double] = js.native
    
    /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileSize.default & Double = js.native
    
    /* 3 */ val square150x150: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileSize.square150x150 & Double = js.native
    
    /* 1 */ val square30x30: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileSize.square30x30 & Double = js.native
    
    /* 5 */ val square310x310: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileSize.square310x310 & Double = js.native
    
    /* 7 */ val square44x44: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileSize.square44x44 & Double = js.native
    
    /* 2 */ val square70x70: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileSize.square70x70 & Double = js.native
    
    /* 6 */ val square71x71: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileSize.square71x71 & Double = js.native
    
    /* 4 */ val wide310x150: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.TileSize.wide310x150 & Double = js.native
  }
  ...
  open class VisualElementsRequest ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.StartScreen.VisualElementsRequest {
    ...
    /* CompleteClass */
    var alternateVisualElements: IVectorView[typingsJapgolly.winrtUwp.Windows.UI.StartScreen.SecondaryTileVisualElements] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getDeferral(): typingsJapgolly.winrtUwp.Windows.UI.StartScreen.VisualElementsRequestDeferral = js.native
    ...
    /* CompleteClass */
    var visualElements: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.SecondaryTileVisualElements = js.native
  }
  ...
  open class VisualElementsRequestDeferral ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.StartScreen.VisualElementsRequestDeferral {
  ...
  open class VisualElementsRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.StartScreen.VisualElementsRequestedEventArgs {
    
    /** Gets the VisualElementsRequest object for the event. */
    /* CompleteClass */
    var request: typingsJapgolly.winrtUwp.Windows.UI.StartScreen.VisualElementsRequest = js.native
  }
}
