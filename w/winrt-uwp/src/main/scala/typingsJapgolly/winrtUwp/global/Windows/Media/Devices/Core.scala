...
import typingsJapgolly.winrtUwp.Windows.Foundation.Numerics.Vector2
...
import typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameFlashMode
...
object Core {
  ...
  open class CameraIntrinsics protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.CameraIntrinsics {
    /**
  ...
  open class FrameControlCapabilities ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameControlCapabilities {
    
    /** Gets the exposure capabilities of the capture device for variable photo sequences. */
    /* CompleteClass */
    var exposure: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameExposureCapabilities = js.native
    
    /** Gets the exposure compensation capabilities of the capture device for variable photo sequences. */
    /* CompleteClass */
    var exposureCompensation: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameExposureCompensationCapabilities = js.native
    
    /** Gets the flash capabilities of the capture device for variable photo sequences. */
    /* CompleteClass */
    var flash: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameFlashCapabilities = js.native
    
    /** Gets the focus capabilities of the capture device for variable photo sequences. */
    /* CompleteClass */
    var focus: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameFocusCapabilities = js.native
    
    /** Gets the ISO speed capabilities of the capture device for variable photo sequences. */
    /* CompleteClass */
    var isoSpeed: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameIsoSpeedCapabilities = js.native
  ...
  open class FrameController ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameController {
    
    /** Gets the exposure compensation settings for a frame in a variable photo sequence. */
    /* CompleteClass */
    var exposureCompensationControl: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameExposureCompensationControl = js.native
    
    /** Gets the exposure settings for a frame in a variable photo sequence. */
    /* CompleteClass */
    var exposureControl: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameExposureControl = js.native
    
    /** Gets the flash settings for a frame in a variable photo sequence. */
    /* CompleteClass */
    var flashControl: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameFlashControl = js.native
    
    /** Gets the focus settings for a frame in a variable photo sequence. */
    /* CompleteClass */
    var focusControl: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameFocusControl = js.native
    
    /** Gets the ISO speed settings for a frame in a variable photo sequence. */
    /* CompleteClass */
    var isoSpeedControl: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameIsoSpeedControl = js.native
  ...
  open class FrameExposureCapabilities ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameExposureCapabilities {
  ...
  open class FrameExposureCompensationCapabilities ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameExposureCompensationCapabilities {
  ...
  open class FrameExposureCompensationControl ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameExposureCompensationControl {
  ...
  open class FrameExposureControl ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameExposureControl {
  ...
  open class FrameFlashCapabilities ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameFlashCapabilities {
  ...
  open class FrameFlashControl ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameFlashControl {
  ...
  object FrameFlashMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameFlashMode & Double] = js.native
    
    /* 0 */ val disable: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameFlashMode.disable & Double = js.native
    
    /* 1 */ val enable: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameFlashMode.enable & Double = js.native
    
    /* 2 */ val global: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameFlashMode.global & Double = js.native
  }
  ...
  open class FrameFocusCapabilities ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameFocusCapabilities {
  ...
  open class FrameFocusControl ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameFocusControl {
  ...
  open class FrameIsoSpeedCapabilities ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameIsoSpeedCapabilities {
  ...
  open class FrameIsoSpeedControl ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameIsoSpeedControl {
  ...
  open class VariablePhotoSequenceController ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.VariablePhotoSequenceController {
    
    /** Gets the list of FrameController objects that determine the settings for each frame in a variable photo sequence. */
    /* CompleteClass */
    var desiredFrameControllers: IVector[typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameController] = js.native
    ...
    /* CompleteClass */
    var frameCapabilities: typingsJapgolly.winrtUwp.Windows.Media.Devices.Core.FrameControlCapabilities = js.native
