...
open class SensorDataThresholdTriggerDetails ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Sensors.SensorDataThresholdTriggerDetails {
  ...
  /* CompleteClass */
  var sensorType: typingsJapgolly.winrtUwp.Windows.Devices.Sensors.SensorType = js.native
}
