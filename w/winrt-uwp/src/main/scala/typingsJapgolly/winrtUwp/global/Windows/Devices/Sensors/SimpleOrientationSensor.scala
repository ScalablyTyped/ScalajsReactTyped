...
open class SimpleOrientationSensor ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Sensors.SimpleOrientationSensor
object SimpleOrientationSensor {
  ...
  /**
    ...
    */
  /* static member */
  inline def getDefault(): typingsJapgolly.winrtUwp.Windows.Devices.Sensors.SimpleOrientationSensor = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefault")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Sensors.SimpleOrientationSensor]
}
