...
open class KnownContactField ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.KnownContactField
object KnownContactField {
  ...
  /**
    ...
    */
  /* static member */
  inline def convertNameToType(name: String): typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactFieldType = ^.asInstanceOf[js.Dynamic].applyDynamic("convertNameToType")(name.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactFieldType]
  ...
  /**
    ...
    */
  /* static member */
  inline def convertTypeToName(`type`: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactFieldType): String = ^.asInstanceOf[js.Dynamic].applyDynamic("convertTypeToName")(`type`.asInstanceOf[js.Any]).asInstanceOf[String]
