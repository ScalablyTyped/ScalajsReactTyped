...
import typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cBusSpeed
import typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cSharingMode
import typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cTransferResult
...
object I2c {
  ...
  object I2cBusSpeed extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cBusSpeed & Double] = js.native
    
    /* 1 */ val fastMode: typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cBusSpeed.fastMode & Double = js.native
    
    /* 0 */ val standardMode: typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cBusSpeed.standardMode & Double = js.native
  }
  ...
  open class I2cConnectionSettings protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cConnectionSettings {
    /**
  ...
  open class I2cController ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cController {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getDevice(settings: typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cConnectionSettings): typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cDevice = js.native
  }
  object I2cController {
    ...
    /**
      ...
      */
    /* static member */
    inline def getDefaultAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cController] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultAsync")().asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cController]]
  }
  ...
  open class I2cDevice ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cDevice {
    ...
    /* CompleteClass */
    var connectionSettings: typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cConnectionSettings = js.native
  ...
  object I2cDevice {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIdAsync(deviceId: String, settings: typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cConnectionSettings): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cDevice] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any], settings.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cDevice]]
  ...
  object I2cSharingMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cSharingMode & Double] = js.native
    
    /* 0 */ val exclusive: typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cSharingMode.exclusive & Double = js.native
    
    /* 1 */ val shared: typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cSharingMode.shared & Double = js.native
  }
  ...
  object I2cTransferStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cTransferStatus & Double] = js.native
    
    /* 0 */ val fullTransfer: typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cTransferStatus.fullTransfer & Double = js.native
    
    /* 1 */ val partialTransfer: typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cTransferStatus.partialTransfer & Double = js.native
    
    /* 2 */ val slaveAddressNotAcknowledged: typingsJapgolly.winrtUwp.Windows.Devices.I2c.I2cTransferStatus.slaveAddressNotAcknowledged & Double = js.native
  }
  ...
  object Provider {
    ...
    open class ProviderI2cConnectionSettings ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.I2c.Provider.ProviderI2cConnectionSettings {
