...
open class CryptographicBuffer ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Security.Cryptography.CryptographicBuffer
object CryptographicBuffer {
  ...
  inline def convertBinaryToString(
    encoding: typingsJapgolly.winrtUwp.Windows.Security.Cryptography.BinaryStringEncoding,
    buffer: IBuffer
  ...
  /**
    ...
    */
  /* static member */
  inline def convertStringToBinary(
    value: String,
    encoding: typingsJapgolly.winrtUwp.Windows.Security.Cryptography.BinaryStringEncoding
  ): IBuffer = (^.asInstanceOf[js.Dynamic].applyDynamic("convertStringToBinary")(value.asInstanceOf[js.Any], encoding.asInstanceOf[js.Any])).asInstanceOf[IBuffer]
