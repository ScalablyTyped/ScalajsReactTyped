...
open class OpticalImageStabilizationControl ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Devices.OpticalImageStabilizationControl {
  
  /** Gets or sets a value indicating the current optical image stabilization mode of the capture device. */
  /* CompleteClass */
  var mode: typingsJapgolly.winrtUwp.Windows.Media.Devices.OpticalImageStabilizationMode = js.native
  ...
  /* CompleteClass */
  var supportedModes: IVectorView[typingsJapgolly.winrtUwp.Windows.Media.Devices.OpticalImageStabilizationMode] = js.native
}
