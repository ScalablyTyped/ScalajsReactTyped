...
open class BluetoothLEDevice ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothLEDevice
object BluetoothLEDevice {
  ...
  inline def fromBluetoothAddressAsync(
    ...
    bluetoothAddressType: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothAddressType
  ): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothLEDevice] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromBluetoothAddressAsync")(bluetoothAddress.asInstanceOf[js.Any], bluetoothAddressType.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothLEDevice]]
  ...
  /**
    ...
    */
  /* static member */
  inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothLEDevice] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothLEDevice]]
  ...
  /**
    ...
    */
  /* static member */
  inline def getDeviceSelectorFromAppearance(appearance: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothLEAppearance): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getDeviceSelectorFromAppearance")(appearance.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  /**
    ...
    */
  /* static member */
  inline def getDeviceSelectorFromConnectionStatus(connectionStatus: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothConnectionStatus): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getDeviceSelectorFromConnectionStatus")(connectionStatus.asInstanceOf[js.Any]).asInstanceOf[String]
