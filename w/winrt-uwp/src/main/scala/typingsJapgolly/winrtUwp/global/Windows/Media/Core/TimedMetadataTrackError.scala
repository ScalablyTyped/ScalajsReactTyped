...
open class TimedMetadataTrackError ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.TimedMetadataTrackError {
  
  /** Gets the error code associated with the timed metadata track error. */
  /* CompleteClass */
  var errorCode: typingsJapgolly.winrtUwp.Windows.Media.Core.TimedMetadataTrackErrorCode = js.native
