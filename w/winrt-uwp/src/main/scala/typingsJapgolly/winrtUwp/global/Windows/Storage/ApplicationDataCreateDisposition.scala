...
object ApplicationDataCreateDisposition extends StObject {
  ...
  def apply(value: Double): js.UndefOr[
    typingsJapgolly.winrtUwp.Windows.Storage.ApplicationDataCreateDisposition & Double
  ] = js.native
  
  /* 0 */ val always: typingsJapgolly.winrtUwp.Windows.Storage.ApplicationDataCreateDisposition.always & Double = js.native
  
  /* 1 */ val existing: typingsJapgolly.winrtUwp.Windows.Storage.ApplicationDataCreateDisposition.existing & Double = js.native
}
