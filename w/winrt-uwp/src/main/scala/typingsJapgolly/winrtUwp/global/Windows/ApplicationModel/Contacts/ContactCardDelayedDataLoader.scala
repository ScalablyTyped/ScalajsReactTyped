...
open class ContactCardDelayedDataLoader ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactCardDelayedDataLoader {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setData(contact: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Contact): Unit = js.native
}
