...
import typingsJapgolly.winrtUwp.Windows.System.Power.EnergySaverStatus
import typingsJapgolly.winrtUwp.Windows.System.Power.PowerSupplyStatus
...
object Power {
  ...
  open class BackgroundEnergyManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.Power.BackgroundEnergyManager
  ...
  object BatteryStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.System.Power.BatteryStatus & Double] = js.native
    
    /* 3 */ val charging: typingsJapgolly.winrtUwp.Windows.System.Power.BatteryStatus.charging & Double = js.native
    
    /* 1 */ val discharging: typingsJapgolly.winrtUwp.Windows.System.Power.BatteryStatus.discharging & Double = js.native
    
    /* 2 */ val idle: typingsJapgolly.winrtUwp.Windows.System.Power.BatteryStatus.idle & Double = js.native
    
    /* 0 */ val notPresent: typingsJapgolly.winrtUwp.Windows.System.Power.BatteryStatus.notPresent & Double = js.native
  }
  ...
  object Diagnostics {
    ...
    open class BackgroundEnergyDiagnostics ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.System.Power.Diagnostics.BackgroundEnergyDiagnostics
    ...
    open class ForegroundEnergyDiagnostics ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.System.Power.Diagnostics.ForegroundEnergyDiagnostics
  ...
  object EnergySaverStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.System.Power.EnergySaverStatus & Double] = js.native
    
    /* 0 */ val disabled: typingsJapgolly.winrtUwp.Windows.System.Power.EnergySaverStatus.disabled & Double = js.native
    
    /* 1 */ val off: typingsJapgolly.winrtUwp.Windows.System.Power.EnergySaverStatus.off & Double = js.native
    
    /* 2 */ val on: typingsJapgolly.winrtUwp.Windows.System.Power.EnergySaverStatus.on & Double = js.native
  }
  ...
  open class ForegroundEnergyManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.Power.ForegroundEnergyManager
  ...
  open class PowerManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.Power.PowerManager
  object PowerManager {
  ...
  object PowerSupplyStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.System.Power.PowerSupplyStatus & Double] = js.native
    
    /* 2 */ val adequate: typingsJapgolly.winrtUwp.Windows.System.Power.PowerSupplyStatus.adequate & Double = js.native
    
    /* 1 */ val inadequate: typingsJapgolly.winrtUwp.Windows.System.Power.PowerSupplyStatus.inadequate & Double = js.native
    
    /* 0 */ val notPresent: typingsJapgolly.winrtUwp.Windows.System.Power.PowerSupplyStatus.notPresent & Double = js.native
  }
}
