...
open class Altimeter ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Sensors.Altimeter
object Altimeter {
  ...
  /**
    ...
    */
  /* static member */
  inline def getDefault(): typingsJapgolly.winrtUwp.Windows.Devices.Sensors.Altimeter = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefault")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Sensors.Altimeter]
}
