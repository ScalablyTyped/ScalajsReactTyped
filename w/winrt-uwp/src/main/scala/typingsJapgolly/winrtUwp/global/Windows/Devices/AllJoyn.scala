...
import typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAuthenticationMechanism
import typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynBusAttachmentState
import typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynSessionLostReason
import typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynTrafficType
import typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.IAllJoynAcceptSessionJoiner
...
object AllJoyn {
  ...
  open class AllJoynAboutData ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAboutData {
  ...
  open class AllJoynAboutDataView ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAboutDataView {
  ...
  object AllJoynAboutDataView {
    ...
    inline def getDataBySessionPortAsync(
      uniqueName: String,
      busAttachment: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynBusAttachment,
      sessionPort: Double
    ): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAboutDataView] = (^.asInstanceOf[js.Dynamic].applyDynamic("getDataBySessionPortAsync")(uniqueName.asInstanceOf[js.Any], busAttachment.asInstanceOf[js.Any], sessionPort.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAboutDataView]]
    /**
    ...
    inline def getDataBySessionPortAsync(
      ...
      sessionPort: Double,
      language: Language
    ): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAboutDataView] = (^.asInstanceOf[js.Dynamic].applyDynamic("getDataBySessionPortAsync")(uniqueName.asInstanceOf[js.Any], busAttachment.asInstanceOf[js.Any], sessionPort.asInstanceOf[js.Any], language.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAboutDataView]]
  }
  ...
  open class AllJoynAcceptSessionJoinerEventArgs protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAcceptSessionJoinerEventArgs {
    /**
  ...
  open class AllJoynAuthenticationCompleteEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAuthenticationCompleteEventArgs {
  ...
  object AllJoynAuthenticationMechanism extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAuthenticationMechanism & Double
      ] = js.native
    
    /* 5 */ val ecdheEcdsa: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAuthenticationMechanism.ecdheEcdsa & Double = js.native
    
    /* 3 */ val ecdheNull: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAuthenticationMechanism.ecdheNull & Double = js.native
    
    /* 4 */ val ecdhePsk: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAuthenticationMechanism.ecdhePsk & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAuthenticationMechanism.none & Double = js.native
    
    /* 1 */ val srpAnonymous: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAuthenticationMechanism.srpAnonymous & Double = js.native
    
    /* 2 */ val srpLogon: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynAuthenticationMechanism.srpLogon & Double = js.native
  }
  ...
  open class AllJoynBusAttachment ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynBusAttachment {
    /**
  ...
  object AllJoynBusAttachmentState extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynBusAttachmentState & Double
      ] = js.native
    
    /* 2 */ val connected: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynBusAttachmentState.connected & Double = js.native
    
    /* 1 */ val connecting: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynBusAttachmentState.connecting & Double = js.native
    
    /* 0 */ val disconnected: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynBusAttachmentState.disconnected & Double = js.native
    
    /* 3 */ val disconnecting: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynBusAttachmentState.disconnecting & Double = js.native
  }
  ...
  open class AllJoynBusAttachmentStateChangedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynBusAttachmentStateChangedEventArgs {
  ...
  open class AllJoynCredentials ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynCredentials {
  ...
  open class AllJoynCredentialsRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynCredentialsRequestedEventArgs {
    ...
    /* CompleteClass */
    var credentials: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynCredentials = js.native
  ...
  open class AllJoynCredentialsVerificationRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynCredentialsVerificationRequestedEventArgs {
  ...
  open class AllJoynMessageInfo protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynMessageInfo {
    /**
  ...
  open class AllJoynProducerStoppedEventArgs protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynProducerStoppedEventArgs {
    /**
  ...
  open class AllJoynServiceInfo protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynServiceInfo {
    /**
  ...
  open class AllJoynServiceInfoRemovedEventArgs protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynServiceInfoRemovedEventArgs {
    /**
  ...
  open class AllJoynSessionLostEventArgs protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynSessionLostEventArgs {
    /**
  ...
  object AllJoynSessionLostReason extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynSessionLostReason & Double
      ] = js.native
    
    /* 4 */ val linkTimeout: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynSessionLostReason.linkTimeout & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynSessionLostReason.none & Double = js.native
    
    /* 5 */ val other: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynSessionLostReason.other & Double = js.native
    
    /* 2 */ val producerClosedAbruptly: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynSessionLostReason.producerClosedAbruptly & Double = js.native
    
    /* 1 */ val producerLeftSession: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynSessionLostReason.producerLeftSession & Double = js.native
    
    /* 3 */ val removedByProducer: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynSessionLostReason.removedByProducer & Double = js.native
  }
  ...
  open class AllJoynSessionMemberAddedEventArgs protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynSessionMemberAddedEventArgs {
    /**
  ...
  open class AllJoynSessionMemberRemovedEventArgs protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynSessionMemberRemovedEventArgs {
    /**
  ...
  open class AllJoynStatus ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynStatus
  ...
  object AllJoynTrafficType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynTrafficType & Double] = js.native
    
    /* 1 */ val messages: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynTrafficType.messages & Double = js.native
    
    /* 3 */ val rawReliable: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynTrafficType.rawReliable & Double = js.native
    
    /* 2 */ val rawUnreliable: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynTrafficType.rawUnreliable & Double = js.native
    
    /* 0 */ val unknown: typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynTrafficType.unknown & Double = js.native
  }
  ...
  open class AllJoynWatcherStoppedEventArgs protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.AllJoyn.AllJoynWatcherStoppedEventArgs {
    /**
