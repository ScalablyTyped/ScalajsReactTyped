...
open class PerceptionDepthFrameArrivedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Perception.PerceptionDepthFrameArrivedEventArgs {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def tryOpenFrame(): typingsJapgolly.winrtUwp.Windows.Devices.Perception.PerceptionDepthFrame = js.native
}
