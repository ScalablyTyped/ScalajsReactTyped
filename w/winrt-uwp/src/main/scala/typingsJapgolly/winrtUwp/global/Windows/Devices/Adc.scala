...
import typingsJapgolly.winrtUwp.Windows.Devices.Adc.AdcChannelMode
import typingsJapgolly.winrtUwp.Windows.Devices.Adc.Provider.IAdcProvider
...
object Adc {
  ...
  open class AdcChannel ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Adc.AdcChannel {
    ...
    /* CompleteClass */
    var controller: typingsJapgolly.winrtUwp.Windows.Devices.Adc.AdcController = js.native
  ...
  object AdcChannelMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Adc.AdcChannelMode & Double] = js.native
    
    /* 1 */ val differential: typingsJapgolly.winrtUwp.Windows.Devices.Adc.AdcChannelMode.differential & Double = js.native
    
    /* 0 */ val singleEnded: typingsJapgolly.winrtUwp.Windows.Devices.Adc.AdcChannelMode.singleEnded & Double = js.native
  }
  ...
  open class AdcController ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Adc.AdcController {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def openChannel(channelNumber: Double): typingsJapgolly.winrtUwp.Windows.Devices.Adc.AdcChannel = js.native
  ...
  object AdcController {
    ...
    /**
      ...
      */
    /* static member */
    inline def getDefaultAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Adc.AdcController] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultAsync")().asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Adc.AdcController]]
  }
  ...
  object Provider {
    ...
    object ProviderAdcChannelMode extends StObject {
      ...
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.Adc.Provider.ProviderAdcChannelMode & Double
          ] = js.native
      
      /* 1 */ val differential: typingsJapgolly.winrtUwp.Windows.Devices.Adc.Provider.ProviderAdcChannelMode.differential & Double = js.native
      
      /* 0 */ val singleEnded: typingsJapgolly.winrtUwp.Windows.Devices.Adc.Provider.ProviderAdcChannelMode.singleEnded & Double = js.native
    }
  }
}
