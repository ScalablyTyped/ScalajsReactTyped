...
open class ContactManager ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactManager
object ContactManager {
  ...
  /**
    ...
    */
  /* static member */
  inline def convertContactToVCardAsync(contact: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Contact): IPromiseWithIAsyncOperation[RandomAccessStreamReference] = ^.asInstanceOf[js.Dynamic].applyDynamic("convertContactToVCardAsync")(contact.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[RandomAccessStreamReference]]
  /**
    * Asynchronously converts a Contact to a vCard.
    * @param contact The Contact to convert.
    ...
    */
  /* static member */
  inline def convertContactToVCardAsync(contact: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Contact, maxBytes: Double): IPromiseWithIAsyncOperation[RandomAccessStreamReference] = (^.asInstanceOf[js.Dynamic].applyDynamic("convertContactToVCardAsync")(contact.asInstanceOf[js.Any], maxBytes.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[RandomAccessStreamReference]]
  ...
  /**
    ...
    */
  /* static member */
  inline def convertVCardToContactAsync(vCard: IRandomAccessStreamReference): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Contact] = ^.asInstanceOf[js.Dynamic].applyDynamic("convertVCardToContactAsync")(vCard.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Contact]]
  ...
  /**
    ...
    */
  /* static member */
  inline def requestAnnotationStoreAsync(
    accessType: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotationStoreAccessType
  ): IPromiseWithIAsyncOperation[
    typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotationStore
  ] = ^.asInstanceOf[js.Dynamic].applyDynamic("requestAnnotationStoreAsync")(accessType.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[
    typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotationStore
  ]]
  ...
  /**
    ...
    */
  /* static member */
  inline def requestStoreAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactStore] = ^.asInstanceOf[js.Dynamic].applyDynamic("requestStoreAsync")().asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactStore]]
  /**
    * Retrieves a ContactStore object that enables searching or retrieving contacts on the device.
    ...
    */
  /* static member */
  inline def requestStoreAsync(accessType: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactStoreAccessType): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactStore] = ^.asInstanceOf[js.Dynamic].applyDynamic("requestStoreAsync")(accessType.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactStore]]
  ...
  /**
    ...
    */
  /* static member */
  inline def showContactCard(contact: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Contact, selection: Rect): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("showContactCard")(contact.asInstanceOf[js.Any], selection.asInstanceOf[js.Any])).asInstanceOf[Unit]
  /**
    * Queries the operating system for a user’s contact and shows the contact data in a contact card.
    * @param contact The object that represents the contact that the app wants to display the contact card for.
    * @param selection The Rect is the rectangular area of user selection (for example, pressing a button), around which the operating system displays the contact card, not within that rectangular area. For example, if an app uses a button to show the contact card, pass the Rect of the button so the contact card displays around the button, not overlapping it.
  ...
  inline def showContactCard(
    contact: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Contact,
    selection: Rect,
  ...
  inline def showContactCard(
    ...
    selection: Rect,
    preferredPlacement: Placement,
    contactCardOptions: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactCardOptions
  ...
  inline def showDelayLoadedContactCard(
    ...
    selection: Rect,
    preferredPlacement: Placement
  ): typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactCardDelayedDataLoader = (^.asInstanceOf[js.Dynamic].applyDynamic("showDelayLoadedContactCard")(contact.asInstanceOf[js.Any], selection.asInstanceOf[js.Any], preferredPlacement.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactCardDelayedDataLoader]
  /**
    * Shows a contact card that can be updated later if the contact does not exist in the user’s contact database.
    * @param contact The object that represents the contact that the app wants to display the contact card for.
    * @param selection The Rect is the rectangular area of user selection (for example, pressing a button), around which the operating system displays the contact card, not within that rectangular area. For example, if an app uses a button to show the contact card, pass the Rect of the button so the contact card displays around the button, not overlapping it.
  ...
  inline def showFullContactCard(
    contact: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Contact,
    fullContactCardOptions: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.FullContactCardOptions
  ...
  @js.native
  def systemDisplayNameOrder: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactNameOrder = js.native
  inline def systemDisplayNameOrder_=(x: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactNameOrder): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("systemDisplayNameOrder")(x.asInstanceOf[js.Any])
  
  /** Gets or puts the sort order. */
  /* static member */
  @JSGlobal("Windows.ApplicationModel.Contacts.ContactManager.systemSortOrder")
  @js.native
  def systemSortOrder: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactNameOrder = js.native
  inline def systemSortOrder_=(x: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactNameOrder): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("systemSortOrder")(x.asInstanceOf[js.Any])
}
