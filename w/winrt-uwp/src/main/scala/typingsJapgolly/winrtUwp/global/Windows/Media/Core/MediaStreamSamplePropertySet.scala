...
/* note: abstract class */ @JSGlobal("Windows.Media.Core.MediaStreamSamplePropertySet")
@js.native
open class MediaStreamSamplePropertySet ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSamplePropertySet {
