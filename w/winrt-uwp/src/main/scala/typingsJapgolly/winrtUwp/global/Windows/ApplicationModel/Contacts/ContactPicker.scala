...
open class ContactPicker ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactPicker {
  ...
  /* CompleteClass */
  var desiredFieldsWithContactFieldType: IVector[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactFieldType] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def pickContactAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Contact] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def pickSingleContactAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactInformation] = js.native
  
  /** Controls whether the Contact Picker shows contacts as a complete entity or as a collection of fields. */
  /* CompleteClass */
  var selectionMode: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactSelectionMode = js.native
}
