...
object Collation {
  ...
  open class CharacterGrouping ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Globalization.Collation.CharacterGrouping {
  ...
  open class CharacterGroupings ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Globalization.Collation.CharacterGroupings
}
