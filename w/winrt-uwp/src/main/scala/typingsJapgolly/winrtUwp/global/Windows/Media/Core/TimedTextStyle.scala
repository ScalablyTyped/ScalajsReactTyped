...
open class TimedTextStyle ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.TimedTextStyle {
  ...
  /* CompleteClass */
  var flowDirection: typingsJapgolly.winrtUwp.Windows.Media.Core.TimedTextFlowDirection = js.native
  ...
  /* CompleteClass */
  var fontWeight: typingsJapgolly.winrtUwp.Windows.Media.Core.TimedTextWeight = js.native
  ...
  /* CompleteClass */
  var lineAlignment: typingsJapgolly.winrtUwp.Windows.Media.Core.TimedTextLineAlignment = js.native
