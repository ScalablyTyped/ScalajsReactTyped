...
open class MagneticStripeReaderStatusUpdatedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReaderStatusUpdatedEventArgs {
  ...
  /* CompleteClass */
  var status: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReaderStatus = js.native
}
