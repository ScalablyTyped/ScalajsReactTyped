...
import typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalityRelation
import typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalitySource
import typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalitySynchronousWork
import typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalityTraceLevel
import typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.ErrorOptions
import typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.ILoggingChannel
import typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingLevel
import typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingOpcode
...
object Diagnostics {
  ...
  open class AsyncCausalityTracer ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.AsyncCausalityTracer
  object AsyncCausalityTracer {
    ...
    inline def traceOperationCompletion(
      ...
      platformId: String,
      operationId: Double,
      status: typingsJapgolly.winrtUwp.Windows.Foundation.AsyncStatus
  ...
  object CausalityRelation extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalityRelation & Double
      ] = js.native
    
    /* 0 */ val assignDelegate: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalityRelation.assignDelegate & Double = js.native
    
    /* 3 */ val cancel: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalityRelation.cancel & Double = js.native
    
    /* 2 */ val choice: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalityRelation.choice & Double = js.native
    
    /* 4 */ val error: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalityRelation.error & Double = js.native
    
    /* 1 */ val join: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalityRelation.join & Double = js.native
  }
  ...
  object CausalitySource extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalitySource & Double] = js.native
    
    /* 0 */ val application: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalitySource.application & Double = js.native
    
    /* 1 */ val library: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalitySource.library & Double = js.native
    
    /* 2 */ val system: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalitySource.system & Double = js.native
  }
  ...
  object CausalitySynchronousWork extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalitySynchronousWork & Double
      ] = js.native
    
    /* 0 */ val completionNotification: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalitySynchronousWork.completionNotification & Double = js.native
    
    /* 2 */ val execution: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalitySynchronousWork.execution & Double = js.native
    
    /* 1 */ val progressNotification: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalitySynchronousWork.progressNotification & Double = js.native
  }
  ...
  object CausalityTraceLevel extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalityTraceLevel & Double
      ] = js.native
    
    /* 1 */ val important: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalityTraceLevel.important & Double = js.native
    
    /* 0 */ val required: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalityTraceLevel.required & Double = js.native
    
    /* 2 */ val verbose: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.CausalityTraceLevel.verbose & Double = js.native
  }
  ...
  open class ErrorDetails ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.ErrorDetails {
    ...
    /* CompleteClass */
    var helpUri: typingsJapgolly.winrtUwp.Windows.Foundation.Uri = js.native
  ...
  object ErrorDetails {
    ...
    /**
      ...
      */
    /* static member */
    inline def createFromHResultAsync(errorCode: Double): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.ErrorDetails] = ^.asInstanceOf[js.Dynamic].applyDynamic("createFromHResultAsync")(errorCode.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.ErrorDetails]]
  }
  ...
  object ErrorOptions extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.ErrorOptions & Double] = js.native
    
    /* 2 */ val forceExceptions: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.ErrorOptions.forceExceptions & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.ErrorOptions.none & Double = js.native
    
    /* 1 */ val suppressExceptions: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.ErrorOptions.suppressExceptions & Double = js.native
    
    /* 4 */ val suppressSetErrorInfo: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.ErrorOptions.suppressSetErrorInfo & Double = js.native
    
    /* 3 */ val useSetErrorInfo: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.ErrorOptions.useSetErrorInfo & Double = js.native
  }
  ...
  open class FileLoggingSession protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.FileLoggingSession {
    /**
  ...
  open class LogFileGeneratedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LogFileGeneratedEventArgs {
  ...
  open class LoggingActivity protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingActivity {
    /**
  ...
  open class LoggingChannel protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingChannel {
    /**
    ...
    def this(
      name: String,
      options: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingChannelOptions
    ) = this()
    /**
  ...
  open class LoggingChannelOptions ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingChannelOptions {
    /**
  ...
  object LoggingFieldFormat extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat & Double
      ] = js.native
    
    /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.default & Double = js.native
    
    /* 3 */ val boolean: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.boolean & Double = js.native
    
    /* 16 */ val fileTime: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.fileTime & Double = js.native
    
    /* 4 */ val hexadecimal: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.hexadecimal & Double = js.native
    
    /* 1 */ val hidden: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.hidden & Double = js.native
    
    /* 15 */ val hresult: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.hresult & Double = js.native
    
    /* 8 */ val ipv4Address: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.ipv4Address & Double = js.native
    
    /* 9 */ val ipv6Address: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.ipv6Address & Double = js.native
    
    /* 12 */ val json: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.json & Double = js.native
    
    /* 14 */ val ntStatus: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.ntStatus & Double = js.native
    
    /* 7 */ val port: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.port & Double = js.native
    
    /* 5 */ val processId: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.processId & Double = js.native
    
    /* 17 */ val signed: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.signed & Double = js.native
    
    /* 10 */ val socketAddress: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.socketAddress & Double = js.native
    
    /* 2 */ val string: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.string & Double = js.native
    
    /* 6 */ val threadId: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.threadId & Double = js.native
    
    /* 18 */ val unsigned: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.unsigned & Double = js.native
    
    /* 13 */ val win32Error: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.win32Error & Double = js.native
    
    /* 11 */ val xml: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFieldFormat.xml & Double = js.native
  }
  ...
  open class LoggingFields ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingFields
  ...
  object LoggingLevel extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingLevel & Double] = js.native
    
    /* 4 */ val critical: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingLevel.critical & Double = js.native
    
    /* 3 */ val error: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingLevel.error & Double = js.native
    
    /* 1 */ val information: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingLevel.information & Double = js.native
    
    /* 0 */ val verbose: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingLevel.verbose & Double = js.native
    
    /* 2 */ val warning: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingLevel.warning & Double = js.native
  }
  ...
  object LoggingOpcode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingOpcode & Double] = js.native
    
    /* 0 */ val info: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingOpcode.info & Double = js.native
    
    /* 3 */ val reply: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingOpcode.reply & Double = js.native
    
    /* 4 */ val resume: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingOpcode.resume & Double = js.native
    
    /* 6 */ val send: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingOpcode.send & Double = js.native
    
    /* 1 */ val start: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingOpcode.start & Double = js.native
    
    /* 2 */ val stop: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingOpcode.stop & Double = js.native
    
    /* 5 */ val suspend: typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingOpcode.suspend & Double = js.native
  }
  ...
  open class LoggingOptions ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingOptions {
    /**
  ...
  open class LoggingSession protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.LoggingSession {
    /**
  ...
  open class RuntimeBrokerErrorSettings ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.RuntimeBrokerErrorSettings {
  ...
  open class TracingStatusChangedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Diagnostics.TracingStatusChangedEventArgs {
