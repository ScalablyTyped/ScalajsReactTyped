...
object LocationTriggerType extends StObject {
  ...
  def apply(value: Double): js.UndefOr[
    typingsJapgolly.winrtUwp.Windows.ApplicationModel.Background.LocationTriggerType & Double
  ] = js.native
  
  /* 0 */ val geofence: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Background.LocationTriggerType.geofence & Double = js.native
}
