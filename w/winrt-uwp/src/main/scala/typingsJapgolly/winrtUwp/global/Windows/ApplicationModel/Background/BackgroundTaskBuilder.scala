...
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.Background.IBackgroundCondition
...
open class BackgroundTaskBuilder ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Background.BackgroundTaskBuilder {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def register(): typingsJapgolly.winrtUwp.Windows.ApplicationModel.Background.BackgroundTaskRegistration = js.native
