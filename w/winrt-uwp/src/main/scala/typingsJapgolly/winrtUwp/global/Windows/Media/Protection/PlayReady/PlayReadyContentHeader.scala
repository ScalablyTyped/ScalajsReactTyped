...
open class PlayReadyContentHeader protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyContentHeader {
  /**
  ...
  def this(
    ...
    contentEncryptionAlgorithm: typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyEncryptionAlgorithm,
    licenseAcquisitionUrl: Uri,
    licenseAcquisitionUserInterfaceUrl: Uri,
    customAttributes: String,
    domainServiceId: String
  ...
  /* CompleteClass */
  var decryptorSetup: typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyDecryptorSetup = js.native
  ...
  /* CompleteClass */
  var encryptionType: typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyEncryptionAlgorithm = js.native
  ...
  /* CompleteClass */
  var headerWithEmbeddedUpdates: typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyContentHeader = js.native
