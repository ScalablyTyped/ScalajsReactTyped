...
open class ProvisioningAgent ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.ProvisioningAgent {
  ...
  override def getProvisionedProfile(
    mediaType: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.ProfileMediaType,
    profileName: String
  ): typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.ProvisionedProfile = js.native
  ...
  override def provisionFromXmlDocumentAsync(provisioningXmlDocument: String): IPromiseWithIAsyncOperation[
    typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.ProvisionFromXmlDocumentResults
  ] = js.native
}
object ProvisioningAgent {
  ...
  /**
    ...
    */
  /* static member */
  inline def createFromNetworkAccountId(networkAccountId: String): typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.ProvisioningAgent = ^.asInstanceOf[js.Dynamic].applyDynamic("createFromNetworkAccountId")(networkAccountId.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.ProvisioningAgent]
}
