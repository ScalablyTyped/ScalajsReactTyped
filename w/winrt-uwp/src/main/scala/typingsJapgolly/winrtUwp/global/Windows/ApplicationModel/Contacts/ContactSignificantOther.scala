...
open class ContactSignificantOther ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactSignificantOther {
  ...
  /* CompleteClass */
  var relationship: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactRelationship = js.native
}
