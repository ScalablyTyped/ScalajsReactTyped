...
import typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinEdge
import typingsJapgolly.winrtUwp.Windows.Devices.Gpio.Provider.IGpioProvider
...
object Gpio {
  ...
  open class GpioController ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioController
  object GpioController {
    ...
    /**
      ...
      */
    /* static member */
    inline def getDefault(): typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioController = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefault")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioController]
    ...
    /**
      ...
      */
    /* static member */
    inline def getDefaultAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioController] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultAsync")().asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioController]]
  }
  ...
  object GpioOpenStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioOpenStatus & Double] = js.native
    
    /* 0 */ val pinOpened: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioOpenStatus.pinOpened & Double = js.native
    
    /* 1 */ val pinUnavailable: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioOpenStatus.pinUnavailable & Double = js.native
    
    /* 2 */ val sharingViolation: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioOpenStatus.sharingViolation & Double = js.native
  }
  ...
  open class GpioPin ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPin
  ...
  object GpioPinDriveMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinDriveMode & Double] = js.native
    
    /* 0 */ val input: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinDriveMode.input & Double = js.native
    
    /* 3 */ val inputPullDown: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinDriveMode.inputPullDown & Double = js.native
    
    /* 2 */ val inputPullUp: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinDriveMode.inputPullUp & Double = js.native
    
    /* 1 */ val output: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinDriveMode.output & Double = js.native
    
    /* 4 */ val outputOpenDrain: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinDriveMode.outputOpenDrain & Double = js.native
    
    /* 5 */ val outputOpenDrainPullUp: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinDriveMode.outputOpenDrainPullUp & Double = js.native
    
    /* 6 */ val outputOpenSource: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinDriveMode.outputOpenSource & Double = js.native
    
    /* 7 */ val outputOpenSourcePullDown: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinDriveMode.outputOpenSourcePullDown & Double = js.native
  }
  ...
  object GpioPinEdge extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinEdge & Double] = js.native
    
    /* 0 */ val fallingEdge: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinEdge.fallingEdge & Double = js.native
    
    /* 1 */ val risingEdge: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinEdge.risingEdge & Double = js.native
  }
  ...
  object GpioPinValue extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinValue & Double] = js.native
    
    /* 1 */ val high: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinValue.high & Double = js.native
    
    /* 0 */ val low: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinValue.low & Double = js.native
  }
  ...
  open class GpioPinValueChangedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioPinValueChangedEventArgs {
  ...
  object GpioSharingMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioSharingMode & Double] = js.native
    
    /* 0 */ val exclusive: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioSharingMode.exclusive & Double = js.native
    
    /* 1 */ val sharedReadOnly: typingsJapgolly.winrtUwp.Windows.Devices.Gpio.GpioSharingMode.sharedReadOnly & Double = js.native
  }
  ...
  object Provider {
    ...
    open class GpioPinProviderValueChangedEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.Gpio.Provider.GpioPinProviderValueChangedEventArgs {
