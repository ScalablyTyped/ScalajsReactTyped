...
import typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskCompletion
import typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskDetail
import typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskSourceRequestedHandler
import typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DBufferDescription
import typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMeshVerificationMode
import typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModelUnit
import typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DObjectType
import typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTextureEdgeBehavior
...
object Printing3D {
  ...
  open class Print3DManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DManager
  object Print3DManager {
    ...
    /**
      ...
      */
    /* static member */
    inline def getForCurrentView(): typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DManager = ^.asInstanceOf[js.Dynamic].applyDynamic("getForCurrentView")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DManager]
  ...
  open class Print3DTask ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTask
  ...
  open class Print3DTaskCompletedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskCompletedEventArgs {
  ...
  object Print3DTaskCompletion extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskCompletion & Double
      ] = js.native
    
    /* 0 */ val abandoned: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskCompletion.abandoned & Double = js.native
    
    /* 1 */ val canceled: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskCompletion.canceled & Double = js.native
    
    /* 2 */ val failed: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskCompletion.failed & Double = js.native
    
    /* 3 */ val slicing: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskCompletion.slicing & Double = js.native
    
    /* 4 */ val submitted: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskCompletion.submitted & Double = js.native
  }
  ...
  object Print3DTaskDetail extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskDetail & Double] = js.native
    
    /* 3 */ val invalidMaterialSelection: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskDetail.invalidMaterialSelection & Double = js.native
    
    /* 4 */ val invalidModel: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskDetail.invalidModel & Double = js.native
    
    /* 6 */ val invalidPrintTicket: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskDetail.invalidPrintTicket & Double = js.native
    
    /* 1 */ val modelExceedsPrintBed: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskDetail.modelExceedsPrintBed & Double = js.native
    
    /* 5 */ val modelNotManifold: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskDetail.modelNotManifold & Double = js.native
    
    /* 0 */ val unknown: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskDetail.unknown & Double = js.native
    
    /* 2 */ val uploadFailed: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskDetail.uploadFailed & Double = js.native
  }
  ...
  open class Print3DTaskRequest ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskRequest {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def createTask(title: String, printerId: String, handler: Print3DTaskSourceRequestedHandler): typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTask = js.native
  }
  ...
  open class Print3DTaskRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskRequestedEventArgs {
    
    /** Gets the 3D print job request associated with the Print3DManager . */
    /* CompleteClass */
    var request: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskRequest = js.native
  }
  ...
  open class Print3DTaskSourceChangedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskSourceChangedEventArgs {
    
    /** Gets the updated 3D print package from the workflow. */
    /* CompleteClass */
    var source: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3D3MFPackage = js.native
  }
  ...
  open class Print3DTaskSourceRequestedArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Print3DTaskSourceRequestedArgs {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def setSource(source: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3D3MFPackage): Unit = js.native
  }
  ...
  open class Printing3D3MFPackage ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3D3MFPackage {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def loadModelFromPackageAsync(value: IRandomAccessStream): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModel] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def saveModelToPackageAsync(value: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModel): IPromiseWithIAsyncAction = js.native
    
    /** Gets or sets the textures in the 3D Manufacturing Format (3MF) package. */
    /* CompleteClass */
    var textures: IVector[typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTextureResource] = js.native
    
    /** Gets or sets a thumbnail image that represents the contents of the 3D Manufacturing Format (3MF) package. */
    /* CompleteClass */
    var thumbnail: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTextureResource = js.native
  }
  object Printing3D3MFPackage {
    ...
    /**
      ...
      */
    /* static member */
    inline def loadAsync(value: IRandomAccessStream): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3D3MFPackage] = ^.asInstanceOf[js.Dynamic].applyDynamic("loadAsync")(value.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3D3MFPackage]]
  }
  ...
  open class Printing3DBaseMaterial ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DBaseMaterial {
    
    /** Gets or sets the color of the base material. */
    /* CompleteClass */
    var color: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DColorMaterial = js.native
  ...
  open class Printing3DBaseMaterialGroup protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DBaseMaterialGroup {
    /**
    ...
    /* CompleteClass */
    var bases: IVector[typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DBaseMaterial] = js.native
  ...
  object Printing3DBufferFormat extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DBufferFormat & Double
      ] = js.native
    
    /* 5 */ val printing3DDouble: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DBufferFormat.printing3DDouble & Double = js.native
    
    /* 6 */ val printing3DUInt: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DBufferFormat.printing3DUInt & Double = js.native
    
    /* 1 */ val r32G32B32A32Float: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DBufferFormat.r32G32B32A32Float & Double = js.native
    
    /* 2 */ val r32G32B32A32UInt: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DBufferFormat.r32G32B32A32UInt & Double = js.native
    
    /* 3 */ val r32G32B32Float: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DBufferFormat.r32G32B32Float & Double = js.native
    
    /* 4 */ val r32G32B32UInt: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DBufferFormat.r32G32B32UInt & Double = js.native
    
    /* 0 */ val unknown: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DBufferFormat.unknown & Double = js.native
  }
  ...
  open class Printing3DColorMaterial ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DColorMaterial {
  ...
  open class Printing3DColorMaterialGroup protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DColorMaterialGroup {
    /**
    ...
    /* CompleteClass */
    var colors: IVector[typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DColorMaterial] = js.native
  ...
  open class Printing3DComponent ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DComponent {
    
    /** Gets the other components contained within the component. */
    /* CompleteClass */
    var components: IVector[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DComponentWithMatrix
      ] = js.native
    
    /** Gets or sets the 3D mesh of the component. */
    /* CompleteClass */
    var mesh: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMesh = js.native
  ...
  open class Printing3DComponentWithMatrix ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DComponentWithMatrix {
    ...
    /* CompleteClass */
    var component: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DComponent = js.native
  ...
  open class Printing3DCompositeMaterial ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DCompositeMaterial {
  ...
  open class Printing3DCompositeMaterialGroup protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DCompositeMaterialGroup {
    /**
    ...
    /* CompleteClass */
    var composites: IVector[typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DCompositeMaterial] = js.native
  ...
  open class Printing3DMaterial ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMaterial {
    
    /** Gets all base material groups used in the 3D model. */
    /* CompleteClass */
    var baseGroups: IVector[typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DBaseMaterialGroup] = js.native
    
    /** Gets all color material groups used in the 3D model. */
    /* CompleteClass */
    var colorGroups: IVector[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DColorMaterialGroup
      ] = js.native
    
    /** Gets all composite material groups used in the 3D model. */
    /* CompleteClass */
    var compositeGroups: IVector[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DCompositeMaterialGroup
      ] = js.native
    
    /** Gets all multi-property groups used in the 3D model. */
    /* CompleteClass */
    var multiplePropertyGroups: IVector[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMultiplePropertyMaterialGroup
      ] = js.native
    
    /** Gets all 2D texture material groups used in the 3D model. */
    /* CompleteClass */
    var texture2CoordGroups: IVector[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTexture2CoordMaterialGroup
      ] = js.native
  }
  ...
  open class Printing3DMesh ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMesh {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def verifyAsync(value: Printing3DMeshVerificationMode): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMeshVerificationResult
      ] = js.native
  ...
  object Printing3DMeshVerificationMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMeshVerificationMode & Double
      ] = js.native
    
    /* 1 */ val findAllErrors: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMeshVerificationMode.findAllErrors & Double = js.native
    
    /* 0 */ val findFirstError: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMeshVerificationMode.findFirstError & Double = js.native
  }
  ...
  open class Printing3DMeshVerificationResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMeshVerificationResult {
  ...
  open class Printing3DModel ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModel {
    ...
    /* CompleteClass */
    var build: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DComponent = js.native
    
    /** Gets all 3D Manufacturing Format (3MF) components used in the 3D model. */
    /* CompleteClass */
    var components: IVector[typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DComponent] = js.native
    
    /** Gets or sets the root material container for the 3D model. */
    /* CompleteClass */
    var material: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMaterial = js.native
    
    /** Gets all meshes used in the 3D model. */
    /* CompleteClass */
    var meshes: IVector[typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMesh] = js.native
    ...
    /* CompleteClass */
    var textures: IVector[typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModelTexture] = js.native
  ...
  open class Printing3DModelTexture ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModelTexture {
    
    /** Gets or sets the texture resource used by the texture. */
    /* CompleteClass */
    var textureResource: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTextureResource = js.native
  ...
  object Printing3DModelUnit extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModelUnit & Double
      ] = js.native
    
    /* 3 */ val centimeter: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModelUnit.centimeter & Double = js.native
    
    /* 5 */ val foot: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModelUnit.foot & Double = js.native
    
    /* 4 */ val inch: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModelUnit.inch & Double = js.native
    
    /* 0 */ val meter: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModelUnit.meter & Double = js.native
    
    /* 1 */ val micron: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModelUnit.micron & Double = js.native
    
    /* 2 */ val millimeter: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModelUnit.millimeter & Double = js.native
  }
  ...
  open class Printing3DMultiplePropertyMaterial ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMultiplePropertyMaterial {
  ...
  open class Printing3DMultiplePropertyMaterialGroup protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMultiplePropertyMaterialGroup {
    /**
    ...
    /* CompleteClass */
    var multipleProperties: IVector[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DMultiplePropertyMaterial
      ] = js.native
  }
  ...
  object Printing3DObjectType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DObjectType & Double
      ] = js.native
    
    /* 0 */ val model: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DObjectType.model & Double = js.native
    
    /* 2 */ val others: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DObjectType.others & Double = js.native
    
    /* 1 */ val support: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DObjectType.support & Double = js.native
  }
  ...
  open class Printing3DTexture2CoordMaterial ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTexture2CoordMaterial {
    
    /** Gets or sets the texture used in the 2D texture material. */
    /* CompleteClass */
    var texture: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DModelTexture = js.native
  ...
  open class Printing3DTexture2CoordMaterialGroup protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTexture2CoordMaterialGroup {
    /**
    ...
    /* CompleteClass */
    var texture2Coords: IVector[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTexture2CoordMaterial
      ] = js.native
  }
  ...
  object Printing3DTextureEdgeBehavior extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTextureEdgeBehavior & Double
      ] = js.native
    
    /* 3 */ val clamp: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTextureEdgeBehavior.clamp & Double = js.native
    
    /* 2 */ val mirror: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTextureEdgeBehavior.mirror & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTextureEdgeBehavior.none & Double = js.native
    
    /* 1 */ val wrap: typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTextureEdgeBehavior.wrap & Double = js.native
  }
  ...
  open class Printing3DTextureResource ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Printing3D.Printing3DTextureResource {
