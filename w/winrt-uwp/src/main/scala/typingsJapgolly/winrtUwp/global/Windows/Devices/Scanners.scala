...
import typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerAutoCroppingMode
import typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerColorMode
import typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerFormat
import typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerResolution
import typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerScanSource
...
import typingsJapgolly.winrtUwp.Windows.Graphics.Printing.PrintMediaSize
import typingsJapgolly.winrtUwp.Windows.Graphics.Printing.PrintOrientation
...
object Scanners {
  ...
  open class ImageScanner ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScanner {
    ...
    /* CompleteClass */
    var autoConfiguration: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerAutoConfiguration = js.native
    ...
    /* CompleteClass */
    var feederConfiguration: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerFeederConfiguration = js.native
    
    /** Gets and sets the scan settings of the Flatbed scan unit, like scan resolution and color mode. */
    /* CompleteClass */
    var flatbedConfiguration: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerFlatbedConfiguration = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def scanFilesToFolderAsync(scanSource: ImageScannerScanSource, storageFolder: StorageFolder): IPromiseWithIAsyncOperationWithProgress[typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerScanResult, Double] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def scanPreviewToStreamAsync(scanSource: ImageScannerScanSource, targetStream: IRandomAccessStream): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerPreviewResult] = js.native
  }
  object ImageScanner {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScanner] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScanner]]
  ...
  open class ImageScannerAutoConfiguration ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerAutoConfiguration {
  ...
  object ImageScannerAutoCroppingMode extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerAutoCroppingMode & Double
      ] = js.native
    
    /* 0 */ val disabled: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerAutoCroppingMode.disabled & Double = js.native
    
    /* 2 */ val multipleRegion: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerAutoCroppingMode.multipleRegion & Double = js.native
    
    /* 1 */ val singleRegion: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerAutoCroppingMode.singleRegion & Double = js.native
  }
  ...
  object ImageScannerColorMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerColorMode & Double] = js.native
    
    /* 3 */ val autoColor: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerColorMode.autoColor & Double = js.native
    
    /* 0 */ val color: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerColorMode.color & Double = js.native
    
    /* 1 */ val grayscale: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerColorMode.grayscale & Double = js.native
    
    /* 2 */ val monochrome: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerColorMode.monochrome & Double = js.native
  }
  ...
  open class ImageScannerFeederConfiguration ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerFeederConfiguration {
  ...
  open class ImageScannerFlatbedConfiguration ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerFlatbedConfiguration {
  ...
  object ImageScannerFormat extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerFormat & Double] = js.native
    
    /* 2 */ val deviceIndependentBitmap: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerFormat.deviceIndependentBitmap & Double = js.native
    
    /* 0 */ val jpeg: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerFormat.jpeg & Double = js.native
    
    /* 5 */ val openXps: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerFormat.openXps & Double = js.native
    
    /* 6 */ val pdf: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerFormat.pdf & Double = js.native
    
    /* 1 */ val png: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerFormat.png & Double = js.native
    
    /* 3 */ val tiff: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerFormat.tiff & Double = js.native
    
    /* 4 */ val xps: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerFormat.xps & Double = js.native
  }
  ...
  open class ImageScannerPreviewResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerPreviewResult {
  ...
  open class ImageScannerScanResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerScanResult {
  ...
  object ImageScannerScanSource extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerScanSource & Double
      ] = js.native
    
    /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerScanSource.default & Double = js.native
    
    /* 3 */ val autoConfigured: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerScanSource.autoConfigured & Double = js.native
    
    /* 2 */ val feeder: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerScanSource.feeder & Double = js.native
    
    /* 1 */ val flatbed: typingsJapgolly.winrtUwp.Windows.Devices.Scanners.ImageScannerScanSource.flatbed & Double = js.native
  }
}
