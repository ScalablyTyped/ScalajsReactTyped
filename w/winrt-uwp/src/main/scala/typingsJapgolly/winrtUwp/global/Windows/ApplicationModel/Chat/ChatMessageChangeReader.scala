...
open class ChatMessageChangeReader ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageChangeReader {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def acceptChangesThrough(lastChangeToAcknowledge: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageChange): Unit = js.native
