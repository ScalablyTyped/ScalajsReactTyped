...
open class MobileBroadbandRadioStateChange ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandRadioStateChange {
  ...
  /* CompleteClass */
  var radioState: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandRadioState = js.native
}
