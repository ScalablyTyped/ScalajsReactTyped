...
/* note: abstract class */ @JSGlobal("Windows.Devices.Perception.KnownPerceptionInfraredFrameSourceProperties")
@js.native
open class KnownPerceptionInfraredFrameSourceProperties ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Perception.KnownPerceptionInfraredFrameSourceProperties
object KnownPerceptionInfraredFrameSourceProperties {
  ...
  inline def activeIlluminationEnabled_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("activeIlluminationEnabled")(x.asInstanceOf[js.Any])
  ...
  inline def ambientSubtractionEnabled_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ambientSubtractionEnabled")(x.asInstanceOf[js.Any])
  ...
  inline def interleavedIlluminationEnabled_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("interleavedIlluminationEnabled")(x.asInstanceOf[js.Any])
  ...
  inline def structureLightPatternEnabled_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureLightPatternEnabled")(x.asInstanceOf[js.Any])
}
