...
import typingsJapgolly.winrtUwp.anon.ProductInfoHeaderValue
...
open class HttpProductInfoHeaderValue protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpProductInfoHeaderValue {
  /**
  ...
  /* CompleteClass */
  var product: typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpProductHeaderValue = js.native
}
object HttpProductInfoHeaderValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(input: String): typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpProductInfoHeaderValue = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpProductInfoHeaderValue]
