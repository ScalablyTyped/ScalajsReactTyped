...
import typingsJapgolly.winrtUwp.anon.MediaTypeHeaderValue
...
open class HttpMediaTypeHeaderValue protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpMediaTypeHeaderValue {
  /**
...
object HttpMediaTypeHeaderValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(input: String): typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpMediaTypeHeaderValue = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpMediaTypeHeaderValue]
