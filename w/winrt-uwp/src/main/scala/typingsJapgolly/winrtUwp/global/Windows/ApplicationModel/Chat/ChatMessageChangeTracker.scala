...
open class ChatMessageChangeTracker ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageChangeTracker {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getChangeReader(): typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageChangeReader = js.native
