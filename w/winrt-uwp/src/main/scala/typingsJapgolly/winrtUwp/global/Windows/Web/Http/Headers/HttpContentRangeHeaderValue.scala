...
import typingsJapgolly.winrtUwp.anon.ContentRangeHeaderValue
...
open class HttpContentRangeHeaderValue protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpContentRangeHeaderValue {
  /**
...
object HttpContentRangeHeaderValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(input: String): typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpContentRangeHeaderValue = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpContentRangeHeaderValue]
  ...
  /**
    ...
    */
  /* static member */
  inline def tryParse(input: String): ContentRangeHeaderValue = ^.asInstanceOf[js.Dynamic].applyDynamic("tryParse")(input.asInstanceOf[js.Any]).asInstanceOf[ContentRangeHeaderValue]
}
