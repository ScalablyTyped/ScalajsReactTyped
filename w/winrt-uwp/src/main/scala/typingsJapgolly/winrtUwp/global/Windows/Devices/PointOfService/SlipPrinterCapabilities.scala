...
open class SlipPrinterCapabilities ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.SlipPrinterCapabilities {
  ...
  /* CompleteClass */
  var cartridgeSensors: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinterCartridgeSensors = js.native
  
  /** Gets the color cartridges that the slip printer station can use to print in color. */
  /* CompleteClass */
  var colorCartridgeCapabilities: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinterColorCapabilities = js.native
  ...
  /* CompleteClass */
  var ruledLineCapabilities: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinterRuledLineCapabilities = js.native
  
  /** Gets a list of the directions in which the slip printer station can rotate a barcode when printing. */
  /* CompleteClass */
  var supportedBarcodeRotations: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinterRotation] = js.native
  
  /** Gets a list of the directions in which the slip printer station can rotate a bitmap when printing. */
  /* CompleteClass */
  var supportedBitmapRotations: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinterRotation] = js.native
