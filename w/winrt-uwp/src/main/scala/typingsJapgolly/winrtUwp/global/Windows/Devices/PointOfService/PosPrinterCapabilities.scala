...
/* note: abstract class */ @JSGlobal("Windows.Devices.PointOfService.PosPrinterCapabilities")
@js.native
open class PosPrinterCapabilities ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinterCapabilities {
  ...
  /* CompleteClass */
  var journal: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.JournalPrinterCapabilities = js.native
  ...
  /* CompleteClass */
  var receipt: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.ReceiptPrinterCapabilities = js.native
  
  /** Gets the capabilities of the slip station for the point-of-service printer. */
  /* CompleteClass */
  var slip: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.SlipPrinterCapabilities = js.native
}
