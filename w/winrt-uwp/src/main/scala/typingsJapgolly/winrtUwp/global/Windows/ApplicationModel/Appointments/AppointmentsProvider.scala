...
object AppointmentsProvider {
  ...
  open class AddAppointmentOperation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentsProvider.AddAppointmentOperation {
    
    /** Gets the Appointment info from the activation request. */
    /* CompleteClass */
    var appointmentInformation: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.Appointment = js.native
  ...
  open class AppointmentsProviderLaunchActionVerbs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentsProvider.AppointmentsProviderLaunchActionVerbs
  ...
  open class RemoveAppointmentOperation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentsProvider.RemoveAppointmentOperation {
  ...
  open class ReplaceAppointmentOperation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentsProvider.ReplaceAppointmentOperation {
