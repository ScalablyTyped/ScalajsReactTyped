...
object Diagnostics {
  ...
  open class ProcessCpuUsage ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessCpuUsage {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getReport(): typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessCpuUsageReport = js.native
  }
  ...
  open class ProcessCpuUsageReport ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessCpuUsageReport {
  ...
  open class ProcessDiagnosticInfo ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessDiagnosticInfo {
    
    /** Gets the CPU time used by the process. */
    /* CompleteClass */
    var cpuUsage: typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessCpuUsage = js.native
    
    /** Gets the disk I/O usage of the process. */
    /* CompleteClass */
    var diskUsage: typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessDiskUsage = js.native
    ...
    /* CompleteClass */
    var memoryUsage: typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessMemoryUsage = js.native
    
    /** Gets the ProcessDiagnosticInfo for the parent process. */
    /* CompleteClass */
    var parent: typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessDiagnosticInfo = js.native
  ...
  object ProcessDiagnosticInfo {
    ...
    /**
      ...
      */
    /* static member */
    inline def getForCurrentProcess(): typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessDiagnosticInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("getForCurrentProcess")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessDiagnosticInfo]
    ...
    /**
      ...
      */
    /* static member */
    inline def getForProcesses(): IVectorView[typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessDiagnosticInfo] = ^.asInstanceOf[js.Dynamic].applyDynamic("getForProcesses")().asInstanceOf[IVectorView[typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessDiagnosticInfo]]
  }
  ...
  open class ProcessDiskUsage ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessDiskUsage {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getReport(): typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessDiskUsageReport = js.native
  }
  ...
  open class ProcessDiskUsageReport ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessDiskUsageReport {
  ...
  open class ProcessMemoryUsage ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessMemoryUsage {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getReport(): typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessMemoryUsageReport = js.native
  }
  ...
  open class ProcessMemoryUsageReport ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.System.Diagnostics.ProcessMemoryUsageReport {
