...
import typingsJapgolly.winrtUwp.Windows.Graphics.Printing.IPrintDocumentSource
...
open class PrintTaskSourceRequestedArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Graphics.Printing.PrintTaskSourceRequestedArgs {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsJapgolly.winrtUwp.Windows.Graphics.Printing.PrintTaskSourceRequestedDeferral = js.native
