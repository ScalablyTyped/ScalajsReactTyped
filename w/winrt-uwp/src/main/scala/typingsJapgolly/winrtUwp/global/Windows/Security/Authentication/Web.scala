package typingsJapgolly.winrtUwp.global.Windows.Security.Authentication
...
import typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestPromptType
import typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus
import typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenResponse
import typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.IWebAccountProviderOperation
import typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountClientViewType
import typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind
import typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountScope
import typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountSelectionOptions
import typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.TokenBindingKeyType
import typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions
import typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationStatus
...
object Web {
  ...
  object Core {
    ...
    open class WebAuthenticationCoreManager ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebAuthenticationCoreManager
    object WebAuthenticationCoreManager {
      ...
      /**
        ...
        */
      /* static member */
      inline def getTokenSilentlyAsync(request: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequest): IPromiseWithIAsyncOperation[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestResult
          ] = ^.asInstanceOf[js.Dynamic].applyDynamic("getTokenSilentlyAsync")(request.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestResult
          ]]
      /**
      ...
      inline def getTokenSilentlyAsync(
        request: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequest,
        webAccount: WebAccount
      ): IPromiseWithIAsyncOperation[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestResult
          ] = (^.asInstanceOf[js.Dynamic].applyDynamic("getTokenSilentlyAsync")(request.asInstanceOf[js.Any], webAccount.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestResult
          ]]
      ...
      /**
        ...
        */
      /* static member */
      inline def requestTokenAsync(request: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequest): IPromiseWithIAsyncOperation[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestResult
          ] = ^.asInstanceOf[js.Dynamic].applyDynamic("requestTokenAsync")(request.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestResult
          ]]
      /**
        * Requests a token from a web account provider asynchronously. If needed, the user may be prompted to enter their credentials.
      ...
      inline def requestTokenAsync(
        ...
        webAccount: WebAccount
            ...
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestResult
          ] = (^.asInstanceOf[js.Dynamic].applyDynamic("requestTokenAsync")(request.asInstanceOf[js.Any], webAccount.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestResult
          ]]
    }
    ...
    open class WebProviderError protected ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebProviderError {
      /**
    ...
    open class WebTokenRequest protected ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequest {
      /**
    ...
    object WebTokenRequestPromptType extends StObject {
      ...
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestPromptType & Double
          ] = js.native
      
      /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestPromptType.default & Double = js.native
      
      /* 1 */ val forceAuthentication: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestPromptType.forceAuthentication & Double = js.native
    }
    ...
    open class WebTokenRequestResult ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestResult {
      ...
      /* CompleteClass */
      var responseData: IVectorView[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenResponse
          ] = js.native
      
      /** Gets the error returned by the web provider, if any. */
      /* CompleteClass */
      var responseError: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebProviderError = js.native
    ...
    object WebTokenRequestStatus extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus & Double
          ] = js.native
      
      /* 4 */ val accountProviderNotAvailable: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus.accountProviderNotAvailable & Double = js.native
      
      /* 2 */ val accountSwitch: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus.accountSwitch & Double = js.native
      
      /* 5 */ val providerError: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus.providerError & Double = js.native
      
      /* 0 */ val success: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus.success & Double = js.native
      
      /* 1 */ val userCancel: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus.userCancel & Double = js.native
      
      /* 3 */ val userInteractionRequired: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenRequestStatus.userInteractionRequired & Double = js.native
    }
    ...
    open class WebTokenResponse ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebTokenResponse {
      /**
      ...
      def this(
        token: String,
        webAccount: WebAccount,
        error: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebProviderError
      ) = this()
      ...
      /* CompleteClass */
      var providerError: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Core.WebProviderError = js.native
  ...
  object Provider {
    ...
    open class WebAccountClientView protected ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountClientView {
      /**
    ...
    object WebAccountClientViewType extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountClientViewType & Double
          ] = js.native
      
      /* 1 */ val idAndProperties: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountClientViewType.idAndProperties & Double = js.native
      
      /* 0 */ val idOnly: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountClientViewType.idOnly & Double = js.native
    }
    ...
    open class WebAccountManager ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountManager
    object WebAccountManager {
      ...
      inline def setViewAsync(
        webAccount: WebAccount,
        view: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountClientView
    ...
    open class WebAccountProviderAddAccountOperation ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderAddAccountOperation {
    ...
    open class WebAccountProviderDeleteAccountOperation ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderDeleteAccountOperation {
    ...
    open class WebAccountProviderGetTokenSilentOperation ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderGetTokenSilentOperation
    ...
    open class WebAccountProviderManageAccountOperation ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderManageAccountOperation {
    ...
    object WebAccountProviderOperationKind extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind & Double
          ] = js.native
      
      /* 2 */ val addAccount: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind.addAccount & Double = js.native
      
      /* 4 */ val deleteAccount: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind.deleteAccount & Double = js.native
      
      /* 1 */ val getTokenSilently: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind.getTokenSilently & Double = js.native
      
      /* 3 */ val manageAccount: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind.manageAccount & Double = js.native
      
      /* 0 */ val requestToken: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind.requestToken & Double = js.native
      
      /* 5 */ val retrieveCookies: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind.retrieveCookies & Double = js.native
      
      /* 6 */ val signOutAccount: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderOperationKind.signOutAccount & Double = js.native
    }
    ...
    open class WebAccountProviderRequestTokenOperation ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderRequestTokenOperation {
      ...
      /* CompleteClass */
      var providerRequest: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebProviderTokenRequest = js.native
      
      /** Gets the web provider token responses. */
      /* CompleteClass */
      var providerResponses: IVector[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebProviderTokenResponse
          ] = js.native
    ...
    open class WebAccountProviderRetrieveCookiesOperation ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderRetrieveCookiesOperation {
    ...
    open class WebAccountProviderSignOutAccountOperation ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderSignOutAccountOperation {
    ...
    open class WebAccountProviderTriggerDetails ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountProviderTriggerDetails {
    ...
    object WebAccountScope extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountScope & Double
          ] = js.native
      
      /* 1 */ val perApplication: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountScope.perApplication & Double = js.native
      
      /* 0 */ val perUser: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountScope.perUser & Double = js.native
    }
    ...
    object WebAccountSelectionOptions extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountSelectionOptions & Double
          ] = js.native
      
      /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountSelectionOptions.default & Double = js.native
      
      /* 1 */ val `new`: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebAccountSelectionOptions.`new` & Double = js.native
    }
    ...
    open class WebProviderTokenRequest ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebProviderTokenRequest {
    ...
    open class WebProviderTokenResponse protected ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.Provider.WebProviderTokenResponse {
      /**
  ...
  object TokenBindingKeyType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.TokenBindingKeyType & Double
      ] = js.native
    
    /* 1 */ val ecdsaP256: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.TokenBindingKeyType.ecdsaP256 & Double = js.native
    
    /* 0 */ val rsa2048: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.TokenBindingKeyType.rsa2048 & Double = js.native
  }
  ...
  open class WebAuthenticationBroker ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationBroker
  object WebAuthenticationBroker {
    ...
    /**
      ...
      */
    /* static member */
    inline def authenticateAsync(options: WebAuthenticationOptions, requestUri: Uri): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult
      ] = (^.asInstanceOf[js.Dynamic].applyDynamic("authenticateAsync")(options.asInstanceOf[js.Any], requestUri.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult
      ]]
    /**
      ...
      */
    /* static member */
    inline def authenticateAsync(options: WebAuthenticationOptions, requestUri: Uri, callbackUri: Uri): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult
      ] = (^.asInstanceOf[js.Dynamic].applyDynamic("authenticateAsync")(options.asInstanceOf[js.Any], requestUri.asInstanceOf[js.Any], callbackUri.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult
      ]]
    ...
    /**
      ...
      */
    /* static member */
    inline def authenticateSilentlyAsync(requestUri: Uri): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("authenticateSilentlyAsync")(requestUri.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult
      ]]
    /**
      ...
      */
    /* static member */
    inline def authenticateSilentlyAsync(requestUri: Uri, options: WebAuthenticationOptions): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult
      ] = (^.asInstanceOf[js.Dynamic].applyDynamic("authenticateSilentlyAsync")(requestUri.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult
      ]]
  ...
  object WebAuthenticationOptions extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions & Double
      ] = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.none & Double = js.native
    
    /* 1 */ val silentMode: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.silentMode & Double = js.native
    
    /* 4 */ val useCorporateNetwork: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.useCorporateNetwork & Double = js.native
    
    /* 3 */ val useHttpPost: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.useHttpPost & Double = js.native
    
    /* 2 */ val useTitle: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationOptions.useTitle & Double = js.native
  }
  ...
  open class WebAuthenticationResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationResult {
  ...
  object WebAuthenticationStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationStatus & Double
      ] = js.native
    
    /* 2 */ val errorHttp: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationStatus.errorHttp & Double = js.native
    
    /* 0 */ val success: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationStatus.success & Double = js.native
    
    /* 1 */ val userCancel: typingsJapgolly.winrtUwp.Windows.Security.Authentication.Web.WebAuthenticationStatus.userCancel & Double = js.native
  }
}
