...
open class LowLagPhotoCapture ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Capture.LowLagPhotoCapture {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def captureAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Media.Capture.CapturedPhoto] = js.native
