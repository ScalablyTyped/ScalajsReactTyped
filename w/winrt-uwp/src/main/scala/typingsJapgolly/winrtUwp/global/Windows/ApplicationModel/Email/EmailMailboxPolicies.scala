...
open class EmailMailboxPolicies ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxPolicies {
  ...
  /* CompleteClass */
  var allowedSmimeEncryptionAlgorithmNegotiation: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation = js.native
  ...
  /* CompleteClass */
  var requiredSmimeEncryptionAlgorithm: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxSmimeEncryptionAlgorithm = js.native
  
  /** Gets the required SMIME signing algorithm. */
  /* CompleteClass */
  var requiredSmimeSigningAlgorithm: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxSmimeSigningAlgorithm = js.native
}
