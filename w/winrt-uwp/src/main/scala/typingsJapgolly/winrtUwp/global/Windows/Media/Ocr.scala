...
object Ocr {
  ...
  open class OcrEngine ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Ocr.OcrEngine {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def recognizeAsync(bitmap: SoftwareBitmap): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Media.Ocr.OcrResult] = js.native
  ...
  object OcrEngine {
    ...
    /**
      ...
      */
    /* static member */
    inline def tryCreateFromLanguage(language: Language): typingsJapgolly.winrtUwp.Windows.Media.Ocr.OcrEngine = ^.asInstanceOf[js.Dynamic].applyDynamic("tryCreateFromLanguage")(language.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Media.Ocr.OcrEngine]
    ...
    /**
      ...
      */
    /* static member */
    inline def tryCreateFromUserProfileLanguages(): typingsJapgolly.winrtUwp.Windows.Media.Ocr.OcrEngine = ^.asInstanceOf[js.Dynamic].applyDynamic("tryCreateFromUserProfileLanguages")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.Media.Ocr.OcrEngine]
  }
  ...
  open class OcrLine ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Ocr.OcrLine {
    ...
    /* CompleteClass */
    var words: IVectorView[typingsJapgolly.winrtUwp.Windows.Media.Ocr.OcrWord] = js.native
  }
  ...
  open class OcrResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Ocr.OcrResult {
    ...
    /* CompleteClass */
    var lines: IVectorView[typingsJapgolly.winrtUwp.Windows.Media.Ocr.OcrLine] = js.native
  ...
  open class OcrWord ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Ocr.OcrWord {
