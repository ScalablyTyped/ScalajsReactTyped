...
open class Uri protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Foundation.Uri {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def combineUri(relativeUri: String): typingsJapgolly.winrtUwp.Windows.Foundation.Uri = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def equals(pUri: typingsJapgolly.winrtUwp.Windows.Foundation.Uri): Boolean = js.native
  ...
  /* CompleteClass */
  var queryParsed: typingsJapgolly.winrtUwp.Windows.Foundation.WwwFormUrlDecoder = js.native
