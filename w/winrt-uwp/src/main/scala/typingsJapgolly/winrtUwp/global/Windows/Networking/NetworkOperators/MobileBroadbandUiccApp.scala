...
open class MobileBroadbandUiccApp ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandUiccApp {
  ...
  override def getRecordDetailsAsync(uiccFilePath: IIterable[Double]): IPromiseWithIAsyncOperation[
    typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandUiccAppRecordDetailsResult
  ] = js.native
  ...
  /* CompleteClass */
  var kind: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.UiccAppKind = js.native
  ...
  override def readRecordAsync(uiccFilePath: IIterable[Double], recordIndex: Double): IPromiseWithIAsyncOperation[
    typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandUiccAppReadRecordResult
  ] = js.native
}
