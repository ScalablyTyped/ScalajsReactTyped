...
import typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiMode
import typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiSharingMode
...
object Spi {
  ...
  object Provider {
    ...
    open class ProviderSpiConnectionSettings ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.Spi.Provider.ProviderSpiConnectionSettings {
  ...
  open class SpiBusInfo ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiBusInfo {
  ...
  open class SpiConnectionSettings protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiConnectionSettings {
    /**
  ...
  open class SpiController ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiController {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getDevice(settings: typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiConnectionSettings): typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiDevice = js.native
  }
  object SpiController {
    ...
    /**
      ...
      */
    /* static member */
    inline def getDefaultAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiController] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultAsync")().asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiController]]
  }
  ...
  open class SpiDevice ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiDevice {
    ...
    /* CompleteClass */
    var connectionSettings: typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiConnectionSettings = js.native
  ...
  object SpiDevice {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIdAsync(busId: String, settings: typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiConnectionSettings): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiDevice] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(busId.asInstanceOf[js.Any], settings.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiDevice]]
    ...
    /**
      ...
      */
    /* static member */
    inline def getBusInfo(busId: String): typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiBusInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("getBusInfo")(busId.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiBusInfo]
  ...
  object SpiMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiMode & Double] = js.native
    
    /* 0 */ val mode0: typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiMode.mode0 & Double = js.native
    
    /* 1 */ val mode1: typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiMode.mode1 & Double = js.native
    
    /* 2 */ val mode2: typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiMode.mode2 & Double = js.native
    
    /* 3 */ val mode3: typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiMode.mode3 & Double = js.native
  }
  ...
  object SpiSharingMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiSharingMode & Double] = js.native
    
    /* 0 */ val exclusive: typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiSharingMode.exclusive & Double = js.native
    
    /* 1 */ val shared: typingsJapgolly.winrtUwp.Windows.Devices.Spi.SpiSharingMode.shared & Double = js.native
  }
}
