...
open class PointerPointProperties ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.UI.Input.PointerPointProperties {
  ...
  /* CompleteClass */
  var pointerUpdateKind: typingsJapgolly.winrtUwp.Windows.UI.Input.PointerUpdateKind = js.native
