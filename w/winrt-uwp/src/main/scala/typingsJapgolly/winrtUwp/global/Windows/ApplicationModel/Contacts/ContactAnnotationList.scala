...
/* note: abstract class */ @JSGlobal("Windows.ApplicationModel.Contacts.ContactAnnotationList")
@js.native
open class ContactAnnotationList ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotationList {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def deleteAnnotationAsync(annotation: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotation): IPromiseWithIAsyncAction = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getAnnotationAsync(annotationId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotation] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def trySaveAnnotationAsync(annotation: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotation): IPromiseWithIAsyncOperation[Boolean] = js.native
