...
import typingsJapgolly.winrtUwp.anon.DateOrDeltaHeaderValue
...
open class HttpDateOrDeltaHeaderValue ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpDateOrDeltaHeaderValue {
...
object HttpDateOrDeltaHeaderValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(input: String): typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpDateOrDeltaHeaderValue = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpDateOrDeltaHeaderValue]
