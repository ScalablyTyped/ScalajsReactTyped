...
open class RcsEndUserMessage ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.RcsEndUserMessage {
  
  /** Gets the actions to which the user can respond. */
  /* CompleteClass */
  var actions: IVectorView[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.RcsEndUserMessageAction] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def sendResponseAsync(action: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.RcsEndUserMessageAction): IPromiseWithIAsyncAction = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def sendResponseWithPinAsync(
    action: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.RcsEndUserMessageAction,
    pin: String
