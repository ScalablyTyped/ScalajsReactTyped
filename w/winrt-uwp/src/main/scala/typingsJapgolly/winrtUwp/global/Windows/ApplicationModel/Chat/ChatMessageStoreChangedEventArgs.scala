...
open class ChatMessageStoreChangedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageStoreChangedEventArgs {
  ...
  /* CompleteClass */
  var kind: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatStoreChangedEventKind = js.native
}
