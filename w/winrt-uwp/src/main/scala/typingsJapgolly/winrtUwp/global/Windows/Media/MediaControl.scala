...
import typingsJapgolly.winrtUwp.winrtUwpStrings.channeldownpressed
import typingsJapgolly.winrtUwp.winrtUwpStrings.channeluppressed
import typingsJapgolly.winrtUwp.winrtUwpStrings.fastforwardpressed
import typingsJapgolly.winrtUwp.winrtUwpStrings.nexttrackpressed
import typingsJapgolly.winrtUwp.winrtUwpStrings.pausepressed
import typingsJapgolly.winrtUwp.winrtUwpStrings.playpausetogglepressed
import typingsJapgolly.winrtUwp.winrtUwpStrings.playpressed
import typingsJapgolly.winrtUwp.winrtUwpStrings.previoustrackpressed
import typingsJapgolly.winrtUwp.winrtUwpStrings.recordpressed
import typingsJapgolly.winrtUwp.winrtUwpStrings.rewindpressed
import typingsJapgolly.winrtUwp.winrtUwpStrings.soundlevelchanged
import typingsJapgolly.winrtUwp.winrtUwpStrings.stoppressed
...
open class MediaControl ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.MediaControl
object MediaControl {
  ...
  @js.native
  def soundLevel: typingsJapgolly.winrtUwp.Windows.Media.SoundLevel = js.native
  inline def soundLevel_=(x: typingsJapgolly.winrtUwp.Windows.Media.SoundLevel): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("soundLevel")(x.asInstanceOf[js.Any])
