...
open class ActivatedOperation ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.UI.WebUI.ActivatedOperation {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsJapgolly.winrtUwp.Windows.UI.WebUI.ActivatedDeferral = js.native
}
