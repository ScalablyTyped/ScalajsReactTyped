...
import typingsJapgolly.winrtUwp.anon.CookiePairHeaderValue
...
open class HttpCookiePairHeaderValue protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpCookiePairHeaderValue {
  /**
...
object HttpCookiePairHeaderValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(input: String): typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpCookiePairHeaderValue = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpCookiePairHeaderValue]
