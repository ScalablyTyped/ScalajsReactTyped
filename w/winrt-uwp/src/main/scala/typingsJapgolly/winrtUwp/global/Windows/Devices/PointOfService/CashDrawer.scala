...
open class CashDrawer ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.CashDrawer
object CashDrawer {
  ...
  /**
    ...
    */
  /* static member */
  inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.CashDrawer] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.CashDrawer]]
  ...
  /**
    ...
    */
  /* static member */
  inline def getDefaultAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.CashDrawer] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultAsync")().asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.CashDrawer]]
