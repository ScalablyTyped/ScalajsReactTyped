...
/* note: abstract class */ @JSGlobal("Windows.UI.WebUI.WebUIAppointmentsProviderReplaceAppointmentActivatedEventArgs")
@js.native
open class WebUIAppointmentsProviderReplaceAppointmentActivatedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.UI.WebUI.WebUIAppointmentsProviderReplaceAppointmentActivatedEventArgs {
