...
open class BackgroundWorkCost ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Background.BackgroundWorkCost
object BackgroundWorkCost {
  ...
  @js.native
  def currentBackgroundWorkCost: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Background.BackgroundWorkCostValue = js.native
  inline def currentBackgroundWorkCost_=(x: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Background.BackgroundWorkCostValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("currentBackgroundWorkCost")(x.asInstanceOf[js.Any])
}
