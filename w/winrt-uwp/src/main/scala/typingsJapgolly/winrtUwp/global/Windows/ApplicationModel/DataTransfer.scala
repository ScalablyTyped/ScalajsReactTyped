...
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackageOperation
...
import typingsJapgolly.winrtUwp.anon.Second
import typingsJapgolly.winrtUwp.winrtUwpStrings.contentchanged
...
object DataTransfer {
  ...
  open class Clipboard ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.Clipboard
  object Clipboard {
    ...
    /**
      ...
      */
    /* static member */
    inline def getContent(): typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackageView = ^.asInstanceOf[js.Dynamic].applyDynamic("getContent")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackageView]
    ...
    /**
      ...
      */
    /* static member */
    inline def setContent(content: typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackage): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setContent")(content.asInstanceOf[js.Any]).asInstanceOf[Unit]
  }
  ...
  open class DataPackage ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackage
  ...
  object DataPackageOperation extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackageOperation & Double
      ] = js.native
    
    /* 1 */ val copy: typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackageOperation.copy & Double = js.native
    
    /* 3 */ val link: typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackageOperation.link & Double = js.native
    
    /* 2 */ val move: typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackageOperation.move & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackageOperation.none & Double = js.native
  }
  ...
  open class DataPackagePropertySet ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackagePropertySet {
  ...
  open class DataPackagePropertySetView ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackagePropertySetView {
  ...
  open class DataPackageView ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackageView
  ...
  open class DataProviderDeferral ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataProviderDeferral {
  ...
  open class DataProviderRequest ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataProviderRequest {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getDeferral(): typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataProviderDeferral = js.native
  ...
  open class DataRequest ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataRequest {
    
    /** Sets or gets a DataPackage object that contains the content a user wants to share. */
    /* CompleteClass */
    var data: typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataPackage = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getDeferral(): typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataRequestDeferral = js.native
  }
  ...
  open class DataRequestDeferral ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataRequestDeferral {
  ...
  open class DataRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataRequestedEventArgs {
    
    /** Enables you to get the DataRequest object and either give it data or a failure message. */
    /* CompleteClass */
    var request: typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataRequest = js.native
  }
  ...
  open class DataTransferManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataTransferManager
  object DataTransferManager {
    ...
    /**
      ...
      */
    /* static member */
    inline def getForCurrentView(): typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataTransferManager = ^.asInstanceOf[js.Dynamic].applyDynamic("getForCurrentView")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.DataTransferManager]
  ...
  open class HtmlFormatHelper ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.HtmlFormatHelper
  ...
  open class OperationCompletedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.OperationCompletedEventArgs {
  ...
  object ShareTarget {
    ...
    open class QuickLink ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.ShareTarget.QuickLink {
    ...
    open class ShareOperation ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.ShareTarget.ShareOperation
  }
  ...
  open class SharedStorageAccessManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.SharedStorageAccessManager
  ...
  open class StandardDataFormats ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.StandardDataFormats
  ...
  open class TargetApplicationChosenEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.DataTransfer.TargetApplicationChosenEventArgs {
