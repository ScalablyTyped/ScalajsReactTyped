...
@js.native
open class AudioFrame protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.AudioFrame {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def lockBuffer(mode: typingsJapgolly.winrtUwp.Windows.Media.AudioBufferAccessMode): typingsJapgolly.winrtUwp.Windows.Media.AudioBuffer = js.native
