...
open class BluetoothDevice ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothDevice
object BluetoothDevice {
  ...
  /**
    ...
    */
  /* static member */
  inline def fromBluetoothAddressAsync(address: Double): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothDevice] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromBluetoothAddressAsync")(address.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothDevice]]
  ...
  /**
    ...
    */
  /* static member */
  inline def fromHostNameAsync(hostName: HostName): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothDevice] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromHostNameAsync")(hostName.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothDevice]]
  ...
  /**
    ...
    */
  /* static member */
  inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothDevice] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothDevice]]
  ...
  /**
    ...
    */
  /* static member */
  inline def getDeviceSelectorFromClassOfDevice(classOfDevice: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothClassOfDevice): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getDeviceSelectorFromClassOfDevice")(classOfDevice.asInstanceOf[js.Any]).asInstanceOf[String]
