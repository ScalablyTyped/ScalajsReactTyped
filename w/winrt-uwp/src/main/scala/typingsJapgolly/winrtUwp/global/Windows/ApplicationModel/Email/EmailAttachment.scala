...
open class EmailAttachment ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailAttachment {
  /**
  ...
  /* CompleteClass */
  var downloadState: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailAttachmentDownloadState = js.native
