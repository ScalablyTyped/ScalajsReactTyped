...
open class JapanesePhoneticAnalyzer ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Globalization.JapanesePhoneticAnalyzer
object JapanesePhoneticAnalyzer {
  ...
  /**
    ...
    */
  /* static member */
  inline def getWords(input: String): IVectorView[typingsJapgolly.winrtUwp.Windows.Globalization.JapanesePhoneme] = ^.asInstanceOf[js.Dynamic].applyDynamic("getWords")(input.asInstanceOf[js.Any]).asInstanceOf[IVectorView[typingsJapgolly.winrtUwp.Windows.Globalization.JapanesePhoneme]]
  /**
    ...
    */
  /* static member */
  inline def getWords(input: String, monoRuby: Boolean): IVectorView[typingsJapgolly.winrtUwp.Windows.Globalization.JapanesePhoneme] = (^.asInstanceOf[js.Dynamic].applyDynamic("getWords")(input.asInstanceOf[js.Any], monoRuby.asInstanceOf[js.Any])).asInstanceOf[IVectorView[typingsJapgolly.winrtUwp.Windows.Globalization.JapanesePhoneme]]
}
