...
open class IsoSpeedControl ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Devices.IsoSpeedControl {
  ...
  /* CompleteClass */
  var preset: typingsJapgolly.winrtUwp.Windows.Media.Devices.IsoSpeedPreset = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setPresetAsync(preset: typingsJapgolly.winrtUwp.Windows.Media.Devices.IsoSpeedPreset): IPromiseWithIAsyncAction = js.native
  ...
  /* CompleteClass */
  var supportedPresets: IVectorView[typingsJapgolly.winrtUwp.Windows.Media.Devices.IsoSpeedPreset] = js.native
