...
import typingsJapgolly.winrtUwp.anon.ContentCodingWithQualityHeaderValue
...
@js.native
open class HttpContentCodingWithQualityHeaderValue protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpContentCodingWithQualityHeaderValue {
  /**
...
object HttpContentCodingWithQualityHeaderValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(input: String): typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpContentCodingWithQualityHeaderValue = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpContentCodingWithQualityHeaderValue]
