...
import typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicProperties.notify
import typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattClientCharacteristicConfigurationDescriptorValue
import typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCommunicationStatus
...
object GenericAttributeProfile {
  ...
  open class GattCharacteristic ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristic
  ...
  object GattCharacteristicProperties extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicProperties & Double
      ] = js.native
    
    /* 7 */ val authenticatedSignedWrites: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicProperties.authenticatedSignedWrites & Double = js.native
    
    /* 1 */ val broadcast: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicProperties.broadcast & Double = js.native
    
    /* 8 */ val extendedProperties: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicProperties.extendedProperties & Double = js.native
    
    /* 6 */ val indicate: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicProperties.indicate & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicProperties.none & Double = js.native
    
    /* 5 */ @JSName("notify")
    val notify_ : notify & Double = js.native
    
    /* 2 */ val read: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicProperties.read & Double = js.native
    
    /* 9 */ val reliableWrites: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicProperties.reliableWrites & Double = js.native
    
    /* 10 */ val writableAuxiliaries: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicProperties.writableAuxiliaries & Double = js.native
    
    /* 4 */ val write: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicProperties.write & Double = js.native
    
    /* 3 */ val writeWithoutResponse: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicProperties.writeWithoutResponse & Double = js.native
  }
  ...
  open class GattCharacteristicUuids ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristicUuids
  ...
  object GattClientCharacteristicConfigurationDescriptorValue extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattClientCharacteristicConfigurationDescriptorValue & Double
      ] = js.native
    
    /* 2 */ val indicate: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattClientCharacteristicConfigurationDescriptorValue.indicate & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattClientCharacteristicConfigurationDescriptorValue.none & Double = js.native
    
    /* 1 */ @JSName("notify")
    val notify_ : typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattClientCharacteristicConfigurationDescriptorValue.notify & Double = js.native
  }
  ...
  object GattCommunicationStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCommunicationStatus & Double
      ] = js.native
    
    /* 0 */ val success: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCommunicationStatus.success & Double = js.native
    
    /* 1 */ val unreachable: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCommunicationStatus.unreachable & Double = js.native
  }
  ...
  open class GattDescriptor ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattDescriptor
  ...
  open class GattDescriptorUuids ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattDescriptorUuids
  ...
  open class GattDeviceService ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattDeviceService {
    ...
    /* CompleteClass */
    var device: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.BluetoothLEDevice = js.native
    ...
    override def getAllCharacteristics(): IVectorView[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristic
      ] = js.native
    ...
    override def getAllIncludedServices(): IVectorView[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattDeviceService
      ] = js.native
  ...
  open class GattPresentationFormat ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattPresentationFormat {
  ...
  open class GattPresentationFormatTypes ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattPresentationFormatTypes
  ...
  object GattProtectionLevel extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattProtectionLevel & Double
      ] = js.native
    
    /* 1 */ val authenticationRequired: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattProtectionLevel.authenticationRequired & Double = js.native
    
    /* 3 */ val encryptionAndAuthenticationRequired: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattProtectionLevel.encryptionAndAuthenticationRequired & Double = js.native
    
    /* 2 */ val encryptionRequired: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattProtectionLevel.encryptionRequired & Double = js.native
    
    /* 0 */ val plain: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattProtectionLevel.plain & Double = js.native
  }
  ...
  open class GattReadClientCharacteristicConfigurationDescriptorResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattReadClientCharacteristicConfigurationDescriptorResult {
  ...
  open class GattReadResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattReadResult {
  ...
  open class GattReliableWriteTransaction ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattReliableWriteTransaction {
    ...
    override def writeValue(
      characteristic: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattCharacteristic,
      value: IBuffer
    ): Unit = js.native
  }
  ...
  open class GattServiceUuids ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattServiceUuids
  ...
  open class GattValueChangedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattValueChangedEventArgs {
  ...
  object GattWriteOption extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattWriteOption & Double
      ] = js.native
    
    /* 0 */ val writeWithResponse: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattWriteOption.writeWithResponse & Double = js.native
    
    /* 1 */ val writeWithoutResponse: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.GenericAttributeProfile.GattWriteOption.writeWithoutResponse & Double = js.native
  }
}
