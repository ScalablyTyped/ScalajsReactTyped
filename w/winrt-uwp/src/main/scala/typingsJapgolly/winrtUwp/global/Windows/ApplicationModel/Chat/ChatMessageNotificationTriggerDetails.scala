...
/* note: abstract class */ @JSGlobal("Windows.ApplicationModel.Chat.ChatMessageNotificationTriggerDetails")
@js.native
open class ChatMessageNotificationTriggerDetails ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatMessageNotificationTriggerDetails {
  ...
  /* CompleteClass */
  var chatMessage: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatMessage = js.native
