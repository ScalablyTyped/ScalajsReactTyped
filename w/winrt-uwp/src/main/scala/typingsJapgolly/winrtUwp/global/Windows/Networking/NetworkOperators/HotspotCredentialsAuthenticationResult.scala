...
open class HotspotCredentialsAuthenticationResult ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.HotspotCredentialsAuthenticationResult {
  ...
  /* CompleteClass */
  var responseCode: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.HotspotAuthenticationResponseCode = js.native
}
