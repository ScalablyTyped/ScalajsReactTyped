...
import typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceConfigurationMethod
import typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceIPProtocol
import typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementListenStateDiscoverability
import typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisherStatus
import typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConfigurationMethod
import typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectDeviceSelectorType
import typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectError
import typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectPairingProcedure
...
object WiFiDirect {
  ...
  object Services {
    ...
    open class WiFiDirectService ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectService
    object WiFiDirectService {
      ...
      /**
        ...
        */
      /* static member */
      inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectService] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectService]]
    ...
    object WiFiDirectServiceAdvertisementStatus extends StObject {
      ...
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertisementStatus & Double
          ] = js.native
      
      /* 3 */ val aborted: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertisementStatus.aborted & Double = js.native
      
      /* 0 */ val created: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertisementStatus.created & Double = js.native
      
      /* 1 */ val started: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertisementStatus.started & Double = js.native
      
      /* 2 */ val stopped: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertisementStatus.stopped & Double = js.native
    }
    ...
    open class WiFiDirectServiceAdvertiser protected ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertiser {
      /**
    ...
    open class WiFiDirectServiceAutoAcceptSessionConnectedEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAutoAcceptSessionConnectedEventArgs {
      
      /** Gets the WiFiDirectServiceSession that was created when the connection was automatically accepted. */
      /* CompleteClass */
      var session: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSession = js.native
    ...
    object WiFiDirectServiceConfigurationMethod extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceConfigurationMethod & Double
          ] = js.native
      
      /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceConfigurationMethod.default & Double = js.native
      
      /* 1 */ val pinDisplay: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceConfigurationMethod.pinDisplay & Double = js.native
      
      /* 2 */ val pinEntry: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceConfigurationMethod.pinEntry & Double = js.native
    }
    ...
    object WiFiDirectServiceError extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceError & Double
          ] = js.native
      
      /* 4 */ val noHardware: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceError.noHardware & Double = js.native
      
      /* 1 */ val radioNotAvailable: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceError.radioNotAvailable & Double = js.native
      
      /* 2 */ val resourceInUse: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceError.resourceInUse & Double = js.native
      
      /* 0 */ val success: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceError.success & Double = js.native
      
      /* 3 */ val unsupportedHardware: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceError.unsupportedHardware & Double = js.native
    }
    ...
    object WiFiDirectServiceIPProtocol extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceIPProtocol & Double
          ] = js.native
      
      /* 0 */ val tcp: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceIPProtocol.tcp & Double = js.native
      
      /* 1 */ val udp: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceIPProtocol.udp & Double = js.native
    }
    ...
    open class WiFiDirectServiceProvisioningInfo ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceProvisioningInfo {
    ...
    open class WiFiDirectServiceRemotePortAddedEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceRemotePortAddedEventArgs {
    ...
    open class WiFiDirectServiceSession ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSession
    ...
    open class WiFiDirectServiceSessionDeferredEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionDeferredEventArgs {
    ...
    object WiFiDirectServiceSessionErrorStatus extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionErrorStatus & Double
          ] = js.native
      
      /* 1 */ val disassociated: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionErrorStatus.disassociated & Double = js.native
      
      /* 2 */ val localClose: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionErrorStatus.localClose & Double = js.native
      
      /* 5 */ val noResponseFromRemote: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionErrorStatus.noResponseFromRemote & Double = js.native
      
      /* 0 */ val ok: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionErrorStatus.ok & Double = js.native
      
      /* 3 */ val remoteClose: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionErrorStatus.remoteClose & Double = js.native
      
      /* 4 */ val systemFailure: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionErrorStatus.systemFailure & Double = js.native
    }
    ...
    open class WiFiDirectServiceSessionRequest ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionRequest {
      ...
      /* CompleteClass */
      var provisioningInfo: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceProvisioningInfo = js.native
    ...
    open class WiFiDirectServiceSessionRequestedEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionRequestedEventArgs {
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def getSessionRequest(): typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionRequest = js.native
    }
    ...
    object WiFiDirectServiceSessionStatus extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionStatus & Double
          ] = js.native
      
      /* 0 */ val closed: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionStatus.closed & Double = js.native
      
      /* 1 */ val initiated: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionStatus.initiated & Double = js.native
      
      /* 3 */ val open: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionStatus.open & Double = js.native
      
      /* 2 */ val requested: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSessionStatus.requested & Double = js.native
    }
    ...
    object WiFiDirectServiceStatus extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceStatus & Double
          ] = js.native
      
      /* 0 */ val available: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceStatus.available & Double = js.native
      
      /* 1 */ val busy: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceStatus.busy & Double = js.native
      
      /* 2 */ val custom: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceStatus.custom & Double = js.native
    }
  }
  ...
  open class WiFiDirectAdvertisement ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisement {
    
    /** Information elements to advertise in the Wi-Fi Direct advertisement. */
    /* CompleteClass */
    var informationElements: IVector[typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectInformationElement] = js.native
    ...
    /* CompleteClass */
    var legacySettings: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectLegacySettings = js.native
  ...
  object WiFiDirectAdvertisementListenStateDiscoverability extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementListenStateDiscoverability & Double
      ] = js.native
    
    /* 2 */ val intensive: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementListenStateDiscoverability.intensive & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementListenStateDiscoverability.none & Double = js.native
    
    /* 1 */ val normal: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementListenStateDiscoverability.normal & Double = js.native
  }
  ...
  open class WiFiDirectAdvertisementPublisher ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisher
  ...
  object WiFiDirectAdvertisementPublisherStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisherStatus & Double
      ] = js.native
    
    /* 3 */ val aborted: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisherStatus.aborted & Double = js.native
    
    /* 0 */ val created: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisherStatus.created & Double = js.native
    
    /* 1 */ val started: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisherStatus.started & Double = js.native
    
    /* 2 */ val stopped: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisherStatus.stopped & Double = js.native
  }
  ...
  open class WiFiDirectAdvertisementPublisherStatusChangedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectAdvertisementPublisherStatusChangedEventArgs {
  ...
  object WiFiDirectConfigurationMethod extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConfigurationMethod & Double
      ] = js.native
    
    /* 1 */ val displayPin: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConfigurationMethod.displayPin & Double = js.native
    
    /* 0 */ val providePin: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConfigurationMethod.providePin & Double = js.native
    
    /* 2 */ val pushButton: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConfigurationMethod.pushButton & Double = js.native
  }
  ...
  open class WiFiDirectConnectionListener ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConnectionListener
  ...
  open class WiFiDirectConnectionParameters ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConnectionParameters {
  ...
  open class WiFiDirectConnectionRequest ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConnectionRequest {
  ...
  open class WiFiDirectConnectionRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConnectionRequestedEventArgs {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getConnectionRequest(): typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConnectionRequest = js.native
  }
  ...
  object WiFiDirectConnectionStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConnectionStatus & Double
      ] = js.native
    
    /* 1 */ val connected: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConnectionStatus.connected & Double = js.native
    
    /* 0 */ val disconnected: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConnectionStatus.disconnected & Double = js.native
  }
  ...
  open class WiFiDirectDevice ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectDevice
  object WiFiDirectDevice {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectDevice] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectDevice]]
    /**
    ...
    inline def fromIdAsync(
      deviceId: String,
      connectionParameters: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectConnectionParameters
    ): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectDevice] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any], connectionParameters.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectDevice]]
  ...
  object WiFiDirectDeviceSelectorType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectDeviceSelectorType & Double
      ] = js.native
    
    /* 1 */ val associationEndpoint: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectDeviceSelectorType.associationEndpoint & Double = js.native
    
    /* 0 */ val deviceInterface: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectDeviceSelectorType.deviceInterface & Double = js.native
  }
  ...
  object WiFiDirectError extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectError & Double] = js.native
    
    /* 1 */ val radioNotAvailable: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectError.radioNotAvailable & Double = js.native
    
    /* 2 */ val resourceInUse: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectError.resourceInUse & Double = js.native
    
    /* 0 */ val success: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectError.success & Double = js.native
  }
  ...
  open class WiFiDirectInformationElement ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectInformationElement {
  ...
  object WiFiDirectInformationElement {
    ...
    /**
      ...
      */
    /* static member */
    inline def createFromBuffer(buffer: IBuffer): IVector[typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectInformationElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("createFromBuffer")(buffer.asInstanceOf[js.Any]).asInstanceOf[IVector[typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectInformationElement]]
    ...
    /**
      ...
      */
    /* static member */
    inline def createFromDeviceInformation(deviceInformation: DeviceInformation): IVector[typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectInformationElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("createFromDeviceInformation")(deviceInformation.asInstanceOf[js.Any]).asInstanceOf[IVector[typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectInformationElement]]
  }
  ...
  open class WiFiDirectLegacySettings ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectLegacySettings {
  ...
  object WiFiDirectPairingProcedure extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectPairingProcedure & Double
      ] = js.native
    
    /* 0 */ val groupOwnerNegotiation: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectPairingProcedure.groupOwnerNegotiation & Double = js.native
    
    /* 1 */ val invitation: typingsJapgolly.winrtUwp.Windows.Devices.WiFiDirect.WiFiDirectPairingProcedure.invitation & Double = js.native
  }
}
