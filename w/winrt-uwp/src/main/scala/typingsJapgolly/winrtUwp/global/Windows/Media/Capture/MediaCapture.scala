...
open class MediaCapture ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Capture.MediaCapture
object MediaCapture {
  ...
  /**
    ...
    */
  /* static member */
  inline def findAllVideoProfiles(videoDeviceId: String): IVectorView[typingsJapgolly.winrtUwp.Windows.Media.Capture.MediaCaptureVideoProfile] = ^.asInstanceOf[js.Dynamic].applyDynamic("findAllVideoProfiles")(videoDeviceId.asInstanceOf[js.Any]).asInstanceOf[IVectorView[typingsJapgolly.winrtUwp.Windows.Media.Capture.MediaCaptureVideoProfile]]
  ...
  /**
    ...
    */
  /* static member */
  inline def findConcurrentProfiles(videoDeviceId: String): IVectorView[typingsJapgolly.winrtUwp.Windows.Media.Capture.MediaCaptureVideoProfile] = ^.asInstanceOf[js.Dynamic].applyDynamic("findConcurrentProfiles")(videoDeviceId.asInstanceOf[js.Any]).asInstanceOf[IVectorView[typingsJapgolly.winrtUwp.Windows.Media.Capture.MediaCaptureVideoProfile]]
  ...
  /**
    ...
    */
  /* static member */
  inline def findKnownVideoProfiles(videoDeviceId: String, name: typingsJapgolly.winrtUwp.Windows.Media.Capture.KnownVideoProfile): IVectorView[typingsJapgolly.winrtUwp.Windows.Media.Capture.MediaCaptureVideoProfile] = (^.asInstanceOf[js.Dynamic].applyDynamic("findKnownVideoProfiles")(videoDeviceId.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[IVectorView[typingsJapgolly.winrtUwp.Windows.Media.Capture.MediaCaptureVideoProfile]]
