...
open class CashDrawerOpenedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.CashDrawerOpenedEventArgs {
  
  /** Gets the data associated with the DrawerOpened event. */
  /* CompleteClass */
  var cashDrawer: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.CashDrawer = js.native
}
