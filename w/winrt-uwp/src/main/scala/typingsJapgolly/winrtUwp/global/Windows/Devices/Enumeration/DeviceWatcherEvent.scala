...
open class DeviceWatcherEvent ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Enumeration.DeviceWatcherEvent {
  
  /** Gets the information for the device associated with the DeviceWatcherEvent . */
  /* CompleteClass */
  var deviceInformation: typingsJapgolly.winrtUwp.Windows.Devices.Enumeration.DeviceInformation = js.native
  
  /** Gets updated information for a device updated by the DeviceWatcherEvent . */
  /* CompleteClass */
  var deviceInformationUpdate: typingsJapgolly.winrtUwp.Windows.Devices.Enumeration.DeviceInformationUpdate = js.native
  
  /** Gets the type for the device indicated by the DeviceWatcherEvent . */
  /* CompleteClass */
  var kind: typingsJapgolly.winrtUwp.Windows.Devices.Enumeration.DeviceWatcherEventKind = js.native
}
