...
open class PedometerDataThreshold protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Sensors.PedometerDataThreshold {
  /**
    ...
    */
  def this(sensor: typingsJapgolly.winrtUwp.Windows.Devices.Sensors.Pedometer, stepGoal: Double) = this()
}
