...
/* note: abstract class */ @JSGlobal("Windows.System.ProcessLauncherOptions")
@js.native
open class ProcessLauncherOptions ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.System.ProcessLauncherOptions {
