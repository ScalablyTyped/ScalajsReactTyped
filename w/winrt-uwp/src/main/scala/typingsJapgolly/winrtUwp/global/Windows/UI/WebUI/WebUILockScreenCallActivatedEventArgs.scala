...
/* note: abstract class */ @JSGlobal("Windows.UI.WebUI.WebUILockScreenCallActivatedEventArgs")
@js.native
open class WebUILockScreenCallActivatedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.UI.WebUI.WebUILockScreenCallActivatedEventArgs {
