...
open class CameraCaptureUI ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Capture.CameraCaptureUI {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def captureFileAsync(mode: typingsJapgolly.winrtUwp.Windows.Media.Capture.CameraCaptureUIMode): IPromiseWithIAsyncOperation[StorageFile] = js.native
  ...
  /* CompleteClass */
  var photoSettings: typingsJapgolly.winrtUwp.Windows.Media.Capture.CameraCaptureUIPhotoCaptureSettings = js.native
  ...
  /* CompleteClass */
  var videoSettings: typingsJapgolly.winrtUwp.Windows.Media.Capture.CameraCaptureUIVideoCaptureSettings = js.native
}
