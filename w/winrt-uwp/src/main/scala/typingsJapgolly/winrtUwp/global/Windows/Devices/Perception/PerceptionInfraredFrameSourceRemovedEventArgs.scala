...
open class PerceptionInfraredFrameSourceRemovedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Perception.PerceptionInfraredFrameSourceRemovedEventArgs {
  
  /** Gets the infrared frame source that was removed. */
  /* CompleteClass */
  var frameSource: typingsJapgolly.winrtUwp.Windows.Devices.Perception.PerceptionInfraredFrameSource = js.native
}
