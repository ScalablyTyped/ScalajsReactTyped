...
import typingsJapgolly.winrtUwp.anon.ContentCodingHeaderValue
...
@js.native
open class HttpContentCodingHeaderValue protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpContentCodingHeaderValue {
  /**
...
object HttpContentCodingHeaderValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(input: String): typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpContentCodingHeaderValue = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpContentCodingHeaderValue]
