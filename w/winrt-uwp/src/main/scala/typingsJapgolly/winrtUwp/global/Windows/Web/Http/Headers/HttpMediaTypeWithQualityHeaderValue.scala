...
import typingsJapgolly.winrtUwp.anon.MediaTypeWithQualityHeaderValue
...
open class HttpMediaTypeWithQualityHeaderValue protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpMediaTypeWithQualityHeaderValue {
  /**
...
object HttpMediaTypeWithQualityHeaderValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(input: String): typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpMediaTypeWithQualityHeaderValue = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpMediaTypeWithQualityHeaderValue]
