...
open class MediaStreamSourceStartingRequest ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSourceStartingRequest {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSourceStartingRequestDeferral = js.native
