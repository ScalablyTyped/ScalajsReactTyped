...
open class SetVersionRequest ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Storage.SetVersionRequest {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsJapgolly.winrtUwp.Windows.Storage.SetVersionDeferral = js.native
}
