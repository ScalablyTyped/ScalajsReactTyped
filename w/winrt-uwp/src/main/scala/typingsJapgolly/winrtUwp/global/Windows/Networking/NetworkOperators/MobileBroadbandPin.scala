...
open class MobileBroadbandPin ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPin {
  ...
  override def changeAsync(currentPin: String, newPin: String): IPromiseWithIAsyncOperation[
    typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinOperationResult
  ] = js.native
  ...
  /* CompleteClass */
  var format: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinFormat = js.native
  
  /** Gets the lock state for a mobile broadband PIN. */
  /* CompleteClass */
  var lockState: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinLockState = js.native
  ...
  /* CompleteClass */
  var `type`: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinType = js.native
