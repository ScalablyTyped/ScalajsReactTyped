...
open class EmailMailboxCreateFolderResult ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxCreateFolderResult {
  
  /** Get the newly created folder after a TryCreateFolderAsync operation. */
  /* CompleteClass */
  var folder: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailFolder = js.native
  
  /** Gets the status of a TryCreateFolderAsync operation. */
  /* CompleteClass */
  var status: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxCreateFolderStatus = js.native
}
