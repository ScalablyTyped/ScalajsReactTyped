...
open class ChatRecipientDeliveryInfo ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatRecipientDeliveryInfo {
  ...
  /* CompleteClass */
  var transportErrorCodeCategory: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatTransportErrorCodeCategory = js.native
  
  /** Gets the interpreted error code for the transport. */
  /* CompleteClass */
  var transportInterpretedErrorCode: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatTransportInterpretedErrorCode = js.native
}
