...
import typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapBufferAccessMode
import typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapFlip
import typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapInterpolationMode
import typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPixelFormat
import typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPlaneDescription
import typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapRotation
...
object Imaging {
  ...
  object BitmapAlphaMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapAlphaMode & Double] = js.native
    
    /* 2 */ val ignore: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapAlphaMode.ignore & Double = js.native
    
    /* 0 */ val premultiplied: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapAlphaMode.premultiplied & Double = js.native
    
    /* 1 */ val straight: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapAlphaMode.straight & Double = js.native
  }
  ...
  open class BitmapBuffer ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapBuffer {
  ...
  object BitmapBufferAccessMode extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapBufferAccessMode & Double
      ] = js.native
    
    /* 0 */ val read: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapBufferAccessMode.read & Double = js.native
    
    /* 1 */ val readWrite: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapBufferAccessMode.readWrite & Double = js.native
    
    /* 2 */ val write: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapBufferAccessMode.write & Double = js.native
  }
  ...
  open class BitmapCodecInformation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapCodecInformation {
  ...
  open class BitmapDecoder ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapDecoder
  object BitmapDecoder {
    ...
    /**
      ...
      */
    /* static member */
    inline def createAsync(decoderId: String, stream: IRandomAccessStream): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapDecoder] = (^.asInstanceOf[js.Dynamic].applyDynamic("createAsync")(decoderId.asInstanceOf[js.Any], stream.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapDecoder]]
    /**
      ...
      */
    /* static member */
    inline def createAsync(stream: IRandomAccessStream): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapDecoder] = ^.asInstanceOf[js.Dynamic].applyDynamic("createAsync")(stream.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapDecoder]]
    ...
    /**
      ...
      */
    /* static member */
    inline def getDecoderInformationEnumerator(): IVectorView[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapCodecInformation] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDecoderInformationEnumerator")().asInstanceOf[IVectorView[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapCodecInformation]]
  ...
  open class BitmapEncoder ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder
  object BitmapEncoder {
    ...
    /**
      ...
      */
    /* static member */
    inline def createAsync(encoderId: String, stream: IRandomAccessStream): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder] = (^.asInstanceOf[js.Dynamic].applyDynamic("createAsync")(encoderId.asInstanceOf[js.Any], stream.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder]]
    /**
    ...
    ): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder] = (^.asInstanceOf[js.Dynamic].applyDynamic("createAsync")(encoderId.asInstanceOf[js.Any], stream.asInstanceOf[js.Any], encodingOptions.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder]]
    ...
    /**
      ...
      */
    /* static member */
    inline def createForInPlacePropertyEncodingAsync(bitmapDecoder: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapDecoder): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder] = ^.asInstanceOf[js.Dynamic].applyDynamic("createForInPlacePropertyEncodingAsync")(bitmapDecoder.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder]]
    ...
    inline def createForTranscodingAsync(
      stream: IRandomAccessStream,
      bitmapDecoder: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapDecoder
    ): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder] = (^.asInstanceOf[js.Dynamic].applyDynamic("createForTranscodingAsync")(stream.asInstanceOf[js.Any], bitmapDecoder.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapEncoder]]
    ...
    /**
      ...
      */
    /* static member */
    inline def getEncoderInformationEnumerator(): IVectorView[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapCodecInformation] = ^.asInstanceOf[js.Dynamic].applyDynamic("getEncoderInformationEnumerator")().asInstanceOf[IVectorView[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapCodecInformation]]
  ...
  object BitmapFlip extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapFlip & Double] = js.native
    
    /* 1 */ val horizontal: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapFlip.horizontal & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapFlip.none & Double = js.native
    
    /* 2 */ val vertical: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapFlip.vertical & Double = js.native
  }
  ...
  open class BitmapFrame ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapFrame
  ...
  object BitmapInterpolationMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapInterpolationMode & Double
      ] = js.native
    
    /* 2 */ val cubic: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapInterpolationMode.cubic & Double = js.native
    
    /* 3 */ val fant: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapInterpolationMode.fant & Double = js.native
    
    /* 1 */ val linear: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapInterpolationMode.linear & Double = js.native
    
    /* 0 */ val nearestNeighbor: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapInterpolationMode.nearestNeighbor & Double = js.native
  }
  ...
  object BitmapPixelFormat extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPixelFormat & Double] = js.native
    
    /* 5 */ val bgra8: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPixelFormat.bgra8 & Double = js.native
    
    /* 3 */ val gray16: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPixelFormat.gray16 & Double = js.native
    
    /* 4 */ val gray8: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPixelFormat.gray8 & Double = js.native
    
    /* 6 */ val nv12: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPixelFormat.nv12 & Double = js.native
    
    /* 1 */ val rgba16: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPixelFormat.rgba16 & Double = js.native
    
    /* 2 */ val rgba8: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPixelFormat.rgba8 & Double = js.native
    
    /* 0 */ val unknown: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPixelFormat.unknown & Double = js.native
    
    /* 7 */ val yuy2: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPixelFormat.yuy2 & Double = js.native
  }
  ...
  open class BitmapProperties ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapProperties {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getPropertiesAsync(propertiesToRetrieve: IIterable[String]): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPropertySet] = js.native
  ...
  open class BitmapPropertiesView ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPropertiesView {
  ...
  open class BitmapPropertySet ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapPropertySet
  ...
  object BitmapRotation extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapRotation & Double] = js.native
    
    /* 2 */ val clockwise180Degrees: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapRotation.clockwise180Degrees & Double = js.native
    
    /* 3 */ val clockwise270Degrees: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapRotation.clockwise270Degrees & Double = js.native
    
    /* 1 */ val clockwise90Degrees: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapRotation.clockwise90Degrees & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapRotation.none & Double = js.native
  }
  ...
  open class BitmapTransform ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapTransform {
  ...
  open class BitmapTypedValue protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapTypedValue {
    /**
  ...
  object ColorManagementMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.ColorManagementMode & Double] = js.native
    
    /* 1 */ val colorManageToSRgb: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.ColorManagementMode.colorManageToSRgb & Double = js.native
    
    /* 0 */ val doNotColorManage: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.ColorManagementMode.doNotColorManage & Double = js.native
  }
  ...
  object ExifOrientationMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.ExifOrientationMode & Double] = js.native
    
    /* 0 */ val ignoreExifOrientation: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.ExifOrientationMode.ignoreExifOrientation & Double = js.native
    
    /* 1 */ val respectExifOrientation: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.ExifOrientationMode.respectExifOrientation & Double = js.native
  }
  ...
  open class ImageStream ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.ImageStream {
  ...
  object JpegSubsamplingMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.JpegSubsamplingMode & Double] = js.native
    
    /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.JpegSubsamplingMode.default & Double = js.native
    
    /* 1 */ val y4Cb2Cr0: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.JpegSubsamplingMode.y4Cb2Cr0 & Double = js.native
    
    /* 2 */ val y4Cb2Cr2: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.JpegSubsamplingMode.y4Cb2Cr2 & Double = js.native
    
    /* 3 */ val y4Cb4Cr4: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.JpegSubsamplingMode.y4Cb4Cr4 & Double = js.native
  }
  ...
  open class PixelDataProvider ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.PixelDataProvider {
  ...
  object PngFilterMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.PngFilterMode & Double] = js.native
    
    /* 6 */ val adaptive: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.PngFilterMode.adaptive & Double = js.native
    
    /* 0 */ val automatic: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.PngFilterMode.automatic & Double = js.native
    
    /* 4 */ val average: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.PngFilterMode.average & Double = js.native
    
    /* 1 */ val none: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.PngFilterMode.none & Double = js.native
    
    /* 5 */ val paeth: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.PngFilterMode.paeth & Double = js.native
    
    /* 2 */ val sub: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.PngFilterMode.sub & Double = js.native
    
    /* 3 */ val up: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.PngFilterMode.up & Double = js.native
  }
  ...
  open class SoftwareBitmap protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap {
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def copyTo(bitmap: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap): Unit = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getReadOnlyView(): typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def lockBuffer(mode: BitmapBufferAccessMode): typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.BitmapBuffer = js.native
  ...
  object SoftwareBitmap {
    ...
    /* static member */
    inline def convert(
      source: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap,
      format: BitmapPixelFormat
    ): typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(source.asInstanceOf[js.Any], format.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap]
    /**
    ...
    ): typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(source.asInstanceOf[js.Any], format.asInstanceOf[js.Any], alpha.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap]
    ...
    /**
      ...
      */
    /* static member */
    inline def copy(source: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap): typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap = ^.asInstanceOf[js.Dynamic].applyDynamic("copy")(source.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap]
    ...
    /**
      ...
      */
    /* static member */
    inline def createCopyFromBuffer(source: IBuffer, format: BitmapPixelFormat, width: Double, height: Double): typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap = (^.asInstanceOf[js.Dynamic].applyDynamic("createCopyFromBuffer")(source.asInstanceOf[js.Any], format.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap]
    /**
      * Creates a new SoftwareBitmap by performing a deep copy of the provided buffer. Modifications to the data in the new SoftwareBitmap will not effect the buffer from which it was created.
      * @param source The source buffer from which the copy will be created.
      * @param format The pixel format of the software bitmap.
      ...
      */
    /* static member */
    inline def createCopyFromBuffer(source: IBuffer, format: BitmapPixelFormat, width: Double, height: Double, alpha: BitmapAlphaMode): typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap = (^.asInstanceOf[js.Dynamic].applyDynamic("createCopyFromBuffer")(source.asInstanceOf[js.Any], format.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any], alpha.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap]
    ...
    /**
      ...
      */
    /* static member */
    inline def createCopyFromSurfaceAsync(surface: IDirect3DSurface): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap] = ^.asInstanceOf[js.Dynamic].applyDynamic("createCopyFromSurfaceAsync")(surface.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap]]
    /**
      * Asynchronously creates a new SoftwareBitmap by performing a deep copy of the provided IDirect3DSurface . Modifications to the data in the new SoftwareBitmap will not effect the surface from which it was created.
      * @param surface The source surface from which the copy will be created.
      * @param alpha The alpha mode of the software bitmap.
      ...
      */
    /* static member */
    inline def createCopyFromSurfaceAsync(surface: IDirect3DSurface, alpha: BitmapAlphaMode): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap] = (^.asInstanceOf[js.Dynamic].applyDynamic("createCopyFromSurfaceAsync")(surface.asInstanceOf[js.Any], alpha.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.SoftwareBitmap]]
  }
  ...
  object TiffCompressionMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode & Double] = js.native
    
    /* 0 */ val automatic: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.automatic & Double = js.native
    
    /* 2 */ val ccitt3: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.ccitt3 & Double = js.native
    
    /* 3 */ val ccitt4: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.ccitt4 & Double = js.native
    
    /* 4 */ val lzw: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.lzw & Double = js.native
    
    /* 7 */ val lzwhDifferencing: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.lzwhDifferencing & Double = js.native
    
    /* 1 */ val none: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.none & Double = js.native
    
    /* 5 */ val rle: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.rle & Double = js.native
    
    /* 6 */ val zip: typingsJapgolly.winrtUwp.Windows.Graphics.Imaging.TiffCompressionMode.zip & Double = js.native
  }
}
