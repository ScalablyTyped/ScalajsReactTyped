...
import typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.INDLicenseFetchDescriptor
...
open class NDStreamParserNotifier ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.NDStreamParserNotifier {
  ...
  override def onSampleParsed(
    streamID: Double,
    streamType: typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.NDMediaStreamType,
    streamSample: MediaStreamSample,
    pts: Double,
    ccFormat: typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.NDClosedCaptionFormat,
