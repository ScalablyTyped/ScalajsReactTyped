...
import typingsJapgolly.winrtUwp.Windows.Web.Http.IHttpContent
...
open class HttpRequestMessage ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Web.Http.HttpRequestMessage {
  /**
    ...
    */
  def this(method: typingsJapgolly.winrtUwp.Windows.Web.Http.HttpMethod, uri: Uri) = this()
  ...
  /* CompleteClass */
  var method: typingsJapgolly.winrtUwp.Windows.Web.Http.HttpMethod = js.native
  ...
  /* CompleteClass */
  var transportInformation: typingsJapgolly.winrtUwp.Windows.Web.Http.HttpTransportInformation = js.native
}
