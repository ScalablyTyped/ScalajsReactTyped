...
open class ChatConversationThreadingInfo ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatConversationThreadingInfo {
  ...
  /* CompleteClass */
  var kind: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Chat.ChatConversationThreadingKind = js.native
