...
object Holographic {
  ...
  open class HolographicCamera ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Holographic.HolographicCamera {
  ...
  open class HolographicCameraPose ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Holographic.HolographicCameraPose {
  ...
  open class HolographicCameraRenderingParameters ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Holographic.HolographicCameraRenderingParameters {
  ...
  open class HolographicFrame ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Holographic.HolographicFrame {
  ...
  open class HolographicFramePrediction ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Holographic.HolographicFramePrediction {
  ...
  open class HolographicSpace ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Holographic.HolographicSpace {
  ...
  open class HolographicSpaceCameraAddedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Holographic.HolographicSpaceCameraAddedEventArgs {
  ...
  open class HolographicSpaceCameraRemovedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Holographic.HolographicSpaceCameraRemovedEventArgs {
