...
open class ContactAnnotation ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotation {
  ...
  /* CompleteClass */
  var supportedOperations: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotationOperations = js.native
}
