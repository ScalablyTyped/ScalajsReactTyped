...
open class MediaDevice ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Devices.MediaDevice
object MediaDevice {
  ...
  inline def addEventListener_defaultaudiocapturedevicechanged(
    ...
    listener: TypedEventHandler[
      Any, 
      typingsJapgolly.winrtUwp.Windows.Media.Devices.DefaultAudioCaptureDeviceChangedEventArgs
    ]
  ...
  inline def addEventListener_defaultaudiorenderdevicechanged(
    ...
    listener: TypedEventHandler[
      Any, 
      typingsJapgolly.winrtUwp.Windows.Media.Devices.DefaultAudioRenderDeviceChangedEventArgs
    ]
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("addEventListener")(`type`.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def getDefaultAudioCaptureId(role: typingsJapgolly.winrtUwp.Windows.Media.Devices.AudioDeviceRole): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultAudioCaptureId")(role.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  /**
    ...
    */
  /* static member */
  inline def getDefaultAudioRenderId(role: typingsJapgolly.winrtUwp.Windows.Media.Devices.AudioDeviceRole): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultAudioRenderId")(role.asInstanceOf[js.Any]).asInstanceOf[String]
