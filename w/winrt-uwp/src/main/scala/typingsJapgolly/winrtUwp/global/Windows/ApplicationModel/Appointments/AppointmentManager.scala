...
open class AppointmentManager ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentManager
object AppointmentManager {
  ...
  /**
    ...
    */
  /* static member */
  inline def requestStoreAsync(options: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentStoreAccessType): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentStore] = ^.asInstanceOf[js.Dynamic].applyDynamic("requestStoreAsync")(options.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentStore]]
  ...
  inline def showAddAppointmentAsync(
    appointment: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.Appointment,
    selection: Rect
  ): IPromiseWithIAsyncOperation[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("showAddAppointmentAsync")(appointment.asInstanceOf[js.Any], selection.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[String]]
  /**
    * Shows the Appointments provider Add Appointment UI, to enable the user to add an appointment.
    * @param appointment The object representing the information for the appointment to add.
    * @param selection The Rect is the rectangular area of user selection (for example, pressing a button), around which the operating system displays the Add Appointment UI, not within that rectangular area. For example, if an app uses a button to show the Rect, pass the Rect of the button so the Add Appointment UI displays around the button, not overlapping it.
  ...
  /**
    ...
    */
  /* static member */
  inline def showEditNewAppointmentAsync(appointment: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.Appointment): IPromiseWithIAsyncOperation[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("showEditNewAppointmentAsync")(appointment.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[String]]
