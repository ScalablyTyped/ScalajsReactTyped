...
open class ContactChangeTracker ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactChangeTracker {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getChangeReader(): typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactChangeReader = js.native
