...
open class ComponentLoadFailedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Protection.ComponentLoadFailedEventArgs {
  ...
  /* CompleteClass */
  var information: typingsJapgolly.winrtUwp.Windows.Media.Protection.RevocationAndRenewalInformation = js.native
}
