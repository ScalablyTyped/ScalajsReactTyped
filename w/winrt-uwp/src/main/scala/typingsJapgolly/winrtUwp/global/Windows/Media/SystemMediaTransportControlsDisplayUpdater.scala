...
open class SystemMediaTransportControlsDisplayUpdater ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.SystemMediaTransportControlsDisplayUpdater {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copyFromFileAsync(`type`: typingsJapgolly.winrtUwp.Windows.Media.MediaPlaybackType, source: StorageFile): IPromiseWithIAsyncOperation[Boolean] = js.native
  
  /** Gets the image properties associated with the currently playing media. */
  /* CompleteClass */
  var imageProperties: typingsJapgolly.winrtUwp.Windows.Media.ImageDisplayProperties = js.native
  
  /** Gets the music properties associated with the currently playing media. */
  /* CompleteClass */
  var musicProperties: typingsJapgolly.winrtUwp.Windows.Media.MusicDisplayProperties = js.native
  ...
  /* CompleteClass */
  var `type`: typingsJapgolly.winrtUwp.Windows.Media.MediaPlaybackType = js.native
  ...
  /* CompleteClass */
  var videoProperties: typingsJapgolly.winrtUwp.Windows.Media.VideoDisplayProperties = js.native
}
