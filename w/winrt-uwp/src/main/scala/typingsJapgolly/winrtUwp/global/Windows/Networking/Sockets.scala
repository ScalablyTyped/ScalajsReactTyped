...
import typingsJapgolly.winrtUwp.Windows.Networking.Sockets.BandwidthStatistics
import typingsJapgolly.winrtUwp.Windows.Networking.Sockets.RoundTripTimeStatistics
import typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityKind
import typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityTriggerReason
import typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus
import typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketMessageType
import typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketProtectionLevel
import typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketQualityOfService
...
object Sockets {
  ...
  open class DatagramSocket ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.DatagramSocket
  ...
  open class DatagramSocketControl ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.DatagramSocketControl {
  ...
  open class DatagramSocketInformation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.DatagramSocketInformation {
    
    /** The local IP address associated with a DatagramSocket object. */
    /* CompleteClass */
    var localAddress: typingsJapgolly.winrtUwp.Windows.Networking.HostName = js.native
    ...
    /* CompleteClass */
    var remoteAddress: typingsJapgolly.winrtUwp.Windows.Networking.HostName = js.native
  ...
  open class DatagramSocketMessageReceivedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.DatagramSocketMessageReceivedEventArgs {
  ...
  open class MessageWebSocket ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.MessageWebSocket
  ...
  open class MessageWebSocketControl ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.MessageWebSocketControl {
  ...
  open class MessageWebSocketInformation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.MessageWebSocketInformation {
  ...
  open class MessageWebSocketMessageReceivedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.MessageWebSocketMessageReceivedEventArgs {
  ...
  object SocketActivityConnectedStandbyAction extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityConnectedStandbyAction & Double
      ] = js.native
    
    /* 0 */ val doNotWake: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityConnectedStandbyAction.doNotWake & Double = js.native
    
    /* 1 */ val wake: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityConnectedStandbyAction.wake & Double = js.native
  }
  ...
  open class SocketActivityContext protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityContext {
    /**
  ...
  open class SocketActivityInformation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityInformation {
    
    /** Get the context associated while transferring ownership of the socket. */
    /* CompleteClass */
    var context: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityContext = js.native
    
    /** Based on the socket type, the app can reclaim the ownership of the appropriate DatagramSocket . */
    /* CompleteClass */
    var datagramSocket: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.DatagramSocket = js.native
    ...
    /* CompleteClass */
    var streamSocket: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.StreamSocket = js.native
    
    /** Based on the socket type, the app can reclaim the ownership of the appropriate StreamSocketListener . */
    /* CompleteClass */
    var streamSocketListener: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.StreamSocketListener = js.native
  ...
  object SocketActivityInformation {
    ...
    def allSockets: IMapView[
        String, 
        typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityInformation
      ] = js.native
    inline def allSockets_=(
      x: IMapView[
          String, 
          typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityInformation
        ]
  ...
  object SocketActivityKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityKind & Double] = js.native
    
    /* 2 */ val datagramSocket: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityKind.datagramSocket & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityKind.none & Double = js.native
    
    /* 3 */ val streamSocket: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityKind.streamSocket & Double = js.native
    
    /* 1 */ val streamSocketListener: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityKind.streamSocketListener & Double = js.native
  }
  ...
  open class SocketActivityTriggerDetails ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityTriggerDetails {
    ...
    /* CompleteClass */
    var socketInformation: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityInformation = js.native
  }
  ...
  object SocketActivityTriggerReason extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityTriggerReason & Double
      ] = js.native
    
    /* 2 */ val connectionAccepted: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityTriggerReason.connectionAccepted & Double = js.native
    
    /* 3 */ val keepAliveTimerExpired: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityTriggerReason.keepAliveTimerExpired & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityTriggerReason.none & Double = js.native
    
    /* 1 */ val socketActivity: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityTriggerReason.socketActivity & Double = js.native
    
    /* 4 */ val socketClosed: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketActivityTriggerReason.socketClosed & Double = js.native
  }
  ...
  open class SocketError ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketError
  object SocketError {
  ...
  object SocketErrorStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus & Double] = js.native
    
    /* 10 */ val addressAlreadyInUse: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.addressAlreadyInUse & Double = js.native
    
    /* 4 */ val addressFamilyNotSupported: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.addressFamilyNotSupported & Double = js.native
    
    /* 11 */ val cannotAssignRequestedAddress: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.cannotAssignRequestedAddress & Double = js.native
    
    /* 25 */ val certificateCommonNameIsIncorrect: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.certificateCommonNameIsIncorrect & Double = js.native
    
    /* 23 */ val certificateExpired: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.certificateExpired & Double = js.native
    
    /* 30 */ val certificateIsInvalid: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.certificateIsInvalid & Double = js.native
    
    /* 28 */ val certificateNoRevocationCheck: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.certificateNoRevocationCheck & Double = js.native
    
    /* 29 */ val certificateRevocationServerOffline: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.certificateRevocationServerOffline & Double = js.native
    
    /* 27 */ val certificateRevoked: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.certificateRevoked & Double = js.native
    
    /* 24 */ val certificateUntrustedRoot: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.certificateUntrustedRoot & Double = js.native
    
    /* 26 */ val certificateWrongUsage: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.certificateWrongUsage & Double = js.native
    
    /* 9 */ val classTypeNotFound: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.classTypeNotFound & Double = js.native
    
    /* 12 */ val connectionRefused: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.connectionRefused & Double = js.native
    
    /* 18 */ val connectionResetByPeer: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.connectionResetByPeer & Double = js.native
    
    /* 3 */ val connectionTimedOut: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.connectionTimedOut & Double = js.native
    
    /* 19 */ val hostIsDown: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.hostIsDown & Double = js.native
    
    /* 6 */ val hostNotFound: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.hostNotFound & Double = js.native
    
    /* 2 */ val httpInvalidServerResponse: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.httpInvalidServerResponse & Double = js.native
    
    /* 22 */ val messageTooLong: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.messageTooLong & Double = js.native
    
    /* 16 */ val networkDroppedConnectionOnReset: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.networkDroppedConnectionOnReset & Double = js.native
    
    /* 15 */ val networkIsDown: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.networkIsDown & Double = js.native
    
    /* 13 */ val networkIsUnreachable: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.networkIsUnreachable & Double = js.native
    
    /* 20 */ val noAddressesFound: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.noAddressesFound & Double = js.native
    
    /* 7 */ val noDataRecordOfRequestedType: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.noDataRecordOfRequestedType & Double = js.native
    
    /* 8 */ val nonAuthoritativeHostNotFound: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.nonAuthoritativeHostNotFound & Double = js.native
    
    /* 1 */ val operationAborted: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.operationAborted & Double = js.native
    
    /* 5 */ val socketTypeNotSupported: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.socketTypeNotSupported & Double = js.native
    
    /* 17 */ val softwareCausedConnectionAbort: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.softwareCausedConnectionAbort & Double = js.native
    
    /* 21 */ val tooManyOpenFiles: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.tooManyOpenFiles & Double = js.native
    
    /* 0 */ val unknown: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.unknown & Double = js.native
    
    /* 14 */ val unreachableHost: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketErrorStatus.unreachableHost & Double = js.native
  }
  ...
  object SocketMessageType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketMessageType & Double] = js.native
    
    /* 0 */ val binary: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketMessageType.binary & Double = js.native
    
    /* 1 */ val utf8: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketMessageType.utf8 & Double = js.native
  }
  ...
  object SocketProtectionLevel extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketProtectionLevel & Double
      ] = js.native
    
    /* 3 */ val bluetoothEncryptionAllowNullAuthentication: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketProtectionLevel.bluetoothEncryptionAllowNullAuthentication & Double = js.native
    
    /* 4 */ val bluetoothEncryptionWithAuthentication: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketProtectionLevel.bluetoothEncryptionWithAuthentication & Double = js.native
    
    /* 0 */ val plainSocket: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketProtectionLevel.plainSocket & Double = js.native
    
    /* 1 */ val ssl: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketProtectionLevel.ssl & Double = js.native
    
    /* 5 */ val ssl3AllowWeakEncryption: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketProtectionLevel.ssl3AllowWeakEncryption & Double = js.native
    
    /* 2 */ val sslAllowNullEncryption: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketProtectionLevel.sslAllowNullEncryption & Double = js.native
    
    /* 6 */ val tls10: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketProtectionLevel.tls10 & Double = js.native
    
    /* 7 */ val tls11: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketProtectionLevel.tls11 & Double = js.native
    
    /* 8 */ val tls12: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketProtectionLevel.tls12 & Double = js.native
  }
  ...
  object SocketQualityOfService extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketQualityOfService & Double
      ] = js.native
    
    /* 1 */ val lowLatency: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketQualityOfService.lowLatency & Double = js.native
    
    /* 0 */ val normal: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketQualityOfService.normal & Double = js.native
  }
  ...
  object SocketSslErrorSeverity extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketSslErrorSeverity & Double
      ] = js.native
    
    /* 2 */ val fatal: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketSslErrorSeverity.fatal & Double = js.native
    
    /* 1 */ val ignorable: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketSslErrorSeverity.ignorable & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.SocketSslErrorSeverity.none & Double = js.native
  }
  ...
  open class StreamSocket ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.StreamSocket
  ...
  open class StreamSocketControl ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.StreamSocketControl {
  ...
  open class StreamSocketInformation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.StreamSocketInformation {
  ...
  open class StreamSocketListener ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.StreamSocketListener
  ...
  open class StreamSocketListenerConnectionReceivedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.StreamSocketListenerConnectionReceivedEventArgs {
    
    /** The StreamSocket object created when a connection is received by the StreamSocketListener object. */
    /* CompleteClass */
    var socket: typingsJapgolly.winrtUwp.Windows.Networking.Sockets.StreamSocket = js.native
  }
  ...
  open class StreamSocketListenerControl ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.StreamSocketListenerControl {
  ...
  open class StreamSocketListenerInformation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.StreamSocketListenerInformation {
  ...
  open class StreamWebSocket ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.StreamWebSocket
  ...
  open class StreamWebSocketControl ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.StreamWebSocketControl {
  ...
  open class StreamWebSocketInformation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.StreamWebSocketInformation {
  ...
  open class WebSocketClosedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.WebSocketClosedEventArgs {
  ...
  open class WebSocketError ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.Sockets.WebSocketError
