...
import typingsJapgolly.winrtUwp.anon.ContentDispositionHeaderValue
...
open class HttpContentDispositionHeaderValue protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpContentDispositionHeaderValue {
  /**
...
object HttpContentDispositionHeaderValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(input: String): typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpContentDispositionHeaderValue = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpContentDispositionHeaderValue]
