...
open class EmailMessage ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMessage {
  ...
  /* CompleteClass */
  var attachments: IVector[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailAttachment] = js.native
  
  /** Gets the recipients BCC'd to the email message. */
  /* CompleteClass */
  var bcc: IVector[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailRecipient] = js.native
  ...
  /* CompleteClass */
  var cc: IVector[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailRecipient] = js.native
  ...
  /* CompleteClass */
  var downloadState: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMessageDownloadState = js.native
  ...
  /* CompleteClass */
  var flagState: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailFlagState = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getBodyStream(`type`: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMessageBodyKind): IRandomAccessStreamReference = js.native
  ...
  /* CompleteClass */
  var importance: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailImportance = js.native
  ...
  /* CompleteClass */
  var irmInfo: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailIrmInfo = js.native
  ...
  /* CompleteClass */
  var lastResponseKind: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMessageResponseKind = js.native
  ...
  /* CompleteClass */
  var meetingInfo: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMeetingInfo = js.native
  ...
  /* CompleteClass */
  var sender: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailRecipient = js.native
  ...
  override def setBodyStream(
    `type`: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMessageBodyKind,
  ...
  /* CompleteClass */
  var smimeKind: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMessageSmimeKind = js.native
  ...
  /* CompleteClass */
  var to: IVector[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailRecipient] = js.native
}
