...
object OnlineId {
  ...
  object CredentialPromptType extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.CredentialPromptType & Double
      ] = js.native
    
    /* 2 */ val doNotPrompt: typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.CredentialPromptType.doNotPrompt & Double = js.native
    
    /* 0 */ val promptIfNeeded: typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.CredentialPromptType.promptIfNeeded & Double = js.native
    
    /* 1 */ val retypeCredentials: typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.CredentialPromptType.retypeCredentials & Double = js.native
  }
  ...
  open class OnlineIdAuthenticator ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.OnlineIdAuthenticator
  ...
  open class OnlineIdServiceTicket ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.OnlineIdServiceTicket {
    ...
    /* CompleteClass */
    var request: typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.OnlineIdServiceTicketRequest = js.native
  ...
  open class OnlineIdServiceTicketRequest protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.OnlineIdServiceTicketRequest {
    /**
  ...
  open class SignOutUserOperation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.SignOutUserOperation {
  ...
  open class UserAuthenticationOperation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.UserAuthenticationOperation {
    ...
    override def completed(
      asyncInfo: IAsyncOperation[typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.UserIdentity],
      asyncStatus: AsyncStatus
    ): Unit = js.native
    /** Gets or sets a handler that's called when the operation completes. */
    /* CompleteClass */
    @JSName("completed")
    var completed_Original: AsyncOperationCompletedHandler[typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.UserIdentity] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getResults(): typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.UserIdentity = js.native
  ...
  open class UserIdentity ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.UserIdentity {
    ...
    var tickets: IVectorView[
        typingsJapgolly.winrtUwp.Windows.Security.Authentication.OnlineId.OnlineIdServiceTicket
      ] = js.native
  }
}
