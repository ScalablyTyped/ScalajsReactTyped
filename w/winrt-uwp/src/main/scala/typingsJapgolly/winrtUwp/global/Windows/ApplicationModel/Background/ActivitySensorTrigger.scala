...
import typingsJapgolly.winrtUwp.Windows.Devices.Sensors.ActivityType
...
open class ActivitySensorTrigger protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Background.ActivitySensorTrigger {
  /**
