...
import typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundDownloadProgress
import typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferBehavior
import typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCostPolicy
import typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferPriority
import typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundUploadProgress
...
object BackgroundTransfer {
  ...
  open class BackgroundDownloader ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundDownloader {
    /**
      ...
      */
    def this(completionGroup: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCompletionGroup) = this()
  }
  object BackgroundDownloader {
    ...
    /**
      ...
      */
    /* static member */
    inline def getCurrentDownloadsForTransferGroupAsync(group: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferGroup): IPromiseWithIAsyncOperation[IVectorView[Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getCurrentDownloadsForTransferGroupAsync")(group.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[IVectorView[Any]]]
    ...
    /**
      ...
      */
    /* static member */
    inline def requestUnconstrainedDownloadsAsync(
      operations: IIterable[typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.DownloadOperation]
    ): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.UnconstrainedTransferRequestResult
  ...
  object BackgroundTransferBehavior extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferBehavior & Double
      ] = js.native
    
    /* 0 */ val parallel: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferBehavior.parallel & Double = js.native
    
    /* 1 */ val serialized: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferBehavior.serialized & Double = js.native
  }
  ...
  open class BackgroundTransferCompletionGroup ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCompletionGroup {
  ...
  open class BackgroundTransferCompletionGroupTriggerDetails ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCompletionGroupTriggerDetails {
    
    /** Gets the list of DownloadOperation objects associated with the BackgroundTransferCompletionGroup . */
    /* CompleteClass */
    var downloads: IVectorView[typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.DownloadOperation] = js.native
    
    /** Gets the list of UploadOperation objects associated with the BackgroundTransferCompletionGroup . */
    /* CompleteClass */
    var uploads: IVectorView[typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.UploadOperation] = js.native
  }
  ...
  open class BackgroundTransferContentPart ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferContentPart {
    /**
  ...
  object BackgroundTransferCostPolicy extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCostPolicy & Double
      ] = js.native
    
    /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCostPolicy.default & Double = js.native
    
    /* 2 */ val always: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCostPolicy.always & Double = js.native
    
    /* 1 */ val unrestrictedOnly: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferCostPolicy.unrestrictedOnly & Double = js.native
  }
  ...
  open class BackgroundTransferError ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferError
  ...
  open class BackgroundTransferGroup ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferGroup {
  ...
  object BackgroundTransferGroup {
    ...
    /**
      ...
      */
    /* static member */
    inline def createGroup(name: String): typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferGroup = ^.asInstanceOf[js.Dynamic].applyDynamic("createGroup")(name.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferGroup]
  }
  ...
  object BackgroundTransferPriority extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferPriority & Double
      ] = js.native
    
    /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferPriority.default & Double = js.native
    
    /* 1 */ val high: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferPriority.high & Double = js.native
  }
  ...
  object BackgroundTransferStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus & Double
      ] = js.native
    
    /* 6 */ val canceled: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.canceled & Double = js.native
    
    /* 5 */ val completed: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.completed & Double = js.native
    
    /* 7 */ val error: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.error & Double = js.native
    
    /* 0 */ val idle: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.idle & Double = js.native
    
    /* 2 */ val pausedByApplication: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.pausedByApplication & Double = js.native
    
    /* 3 */ val pausedCostedNetwork: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.pausedCostedNetwork & Double = js.native
    
    /* 4 */ val pausedNoNetwork: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.pausedNoNetwork & Double = js.native
    
    /* 8 */ val pausedSystemPolicy: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.pausedSystemPolicy & Double = js.native
    
    /* 1 */ val running: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferStatus.running & Double = js.native
  }
  ...
  open class BackgroundUploader ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundUploader {
    /**
  ...
  object BackgroundUploader {
    ...
    /**
      ...
      */
    /* static member */
    inline def getCurrentUploadsForTransferGroupAsync(group: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferGroup): IPromiseWithIAsyncOperation[IVectorView[Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getCurrentUploadsForTransferGroupAsync")(group.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[IVectorView[Any]]]
    ...
    /**
      ...
      */
    /* static member */
    inline def requestUnconstrainedUploadsAsync(
      operations: IIterable[typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.UploadOperation]
    ): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.UnconstrainedTransferRequestResult
  ...
  open class ContentPrefetcher ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.ContentPrefetcher
  ...
  open class DownloadOperation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.DownloadOperation {
    ...
    override def attachAsync(): IPromiseWithIAsyncOperationWithProgress[
        typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.DownloadOperation, 
        typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.DownloadOperation
      ] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getResponseInformation(): typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.ResponseInformation = js.native
    ...
    /* CompleteClass */
    var transferGroup: typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.BackgroundTransferGroup = js.native
  }
  ...
  open class ResponseInformation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.ResponseInformation {
  ...
  open class UnconstrainedTransferRequestResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.UnconstrainedTransferRequestResult {
  ...
  open class UploadOperation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.UploadOperation {
    ...
    /* CompleteClass */
    override def attachAsync(): IPromiseWithIAsyncOperationWithProgress[
        typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.UploadOperation, 
        typingsJapgolly.winrtUwp.Windows.Networking.BackgroundTransfer.UploadOperation
      ] = js.native
