...
import typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkRecognitionTarget
import typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.PenTipShape
...
object Inking {
  ...
  open class InkDrawingAttributes ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkDrawingAttributes {
  ...
  open class InkManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkManager
  ...
  object InkManipulationMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkManipulationMode & Double] = js.native
    
    /* 1 */ val erasing: typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkManipulationMode.erasing & Double = js.native
    
    /* 0 */ val inking: typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkManipulationMode.inking & Double = js.native
    
    /* 2 */ val selecting: typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkManipulationMode.selecting & Double = js.native
  }
  ...
  open class InkPoint protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkPoint {
    /**
  ...
  open class InkRecognitionResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkRecognitionResult {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getStrokes(): IVectorView[typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkStroke] = js.native
  ...
  object InkRecognitionTarget extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkRecognitionTarget & Double] = js.native
    
    /* 0 */ val all: typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkRecognitionTarget.all & Double = js.native
    
    /* 2 */ val recent: typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkRecognitionTarget.recent & Double = js.native
    
    /* 1 */ val selected: typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkRecognitionTarget.selected & Double = js.native
  }
  ...
  open class InkRecognizer ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkRecognizer {
  ...
  open class InkRecognizerContainer ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkRecognizerContainer {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getRecognizers(): IVectorView[typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkRecognizer] = js.native
    ...
    override def recognizeAsync(
      strokeCollection: typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkStrokeContainer,
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def setDefaultRecognizer(recognizer: typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkRecognizer): Unit = js.native
  }
  ...
  open class InkStroke ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkStroke {
    ...
    /* CompleteClass */
    var drawingAttributes: typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkDrawingAttributes = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getInkPoints(): IVectorView[typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkPoint] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getRenderingSegments(): IVectorView[typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkStrokeRenderingSegment] = js.native
  ...
  open class InkStrokeBuilder ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkStrokeBuilder {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def appendToStroke(pointerPoint: typingsJapgolly.winrtUwp.Windows.UI.Input.PointerPoint): typingsJapgolly.winrtUwp.Windows.UI.Input.PointerPoint = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def beginStroke(pointerPoint: typingsJapgolly.winrtUwp.Windows.UI.Input.PointerPoint): Unit = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def createStroke(points: IIterable[Point]): typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkStroke = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def createStrokeFromInkPoints(
      inkPoints: IIterable[typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkPoint],
      transform: Matrix3x2
    ): typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkStroke = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def endStroke(pointerPoint: typingsJapgolly.winrtUwp.Windows.UI.Input.PointerPoint): typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkStroke = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def setDefaultDrawingAttributes(drawingAttributes: typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkDrawingAttributes): Unit = js.native
  }
  ...
  open class InkStrokeContainer ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkStrokeContainer {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def addStroke(stroke: typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkStroke): Unit = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def addStrokes(strokes: IIterable[typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkStroke]): Unit = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getRecognitionResults(): IVectorView[typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkRecognitionResult] = js.native
    ...
    override def updateRecognitionResults(
      recognitionResults: IVectorView[typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkRecognitionResult]
    ): Unit = js.native
  }
  ...
  open class InkStrokeRenderingSegment ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.InkStrokeRenderingSegment {
  ...
  object PenTipShape extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.PenTipShape & Double] = js.native
    
    /* 0 */ val circle: typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.PenTipShape.circle & Double = js.native
    
    /* 1 */ val rectangle: typingsJapgolly.winrtUwp.Windows.UI.Input.Inking.PenTipShape.rectangle & Double = js.native
  }
}
