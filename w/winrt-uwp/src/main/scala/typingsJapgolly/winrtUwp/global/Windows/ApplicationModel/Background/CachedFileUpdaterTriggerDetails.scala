...
import typingsJapgolly.winrtUwp.Windows.Storage.Provider.CachedFileTarget
import typingsJapgolly.winrtUwp.Windows.Storage.Provider.FileUpdateRequest
...
open class CachedFileUpdaterTriggerDetails ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Background.CachedFileUpdaterTriggerDetails {
