...
open class CalendarIdentifiers ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Globalization.CalendarIdentifiers
object CalendarIdentifiers {
  ...
  /* static member */
  @JSGlobal("Windows.Globalization.CalendarIdentifiers.persian")
  @js.native
  def persian: String = js.native
  inline def persian_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("persian")(x.asInstanceOf[js.Any])
