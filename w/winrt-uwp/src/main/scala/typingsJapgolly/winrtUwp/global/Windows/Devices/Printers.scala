...
import typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowDetail
import typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus
...
object Printers {
  ...
  object Extensions {
    ...
    open class Print3DWorkflow ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflow
    ...
    object Print3DWorkflowDetail extends StObject {
      ...
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowDetail & Double
          ] = js.native
      
      /* 3 */ val invalidMaterialSelection: typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowDetail.invalidMaterialSelection & Double = js.native
      
      /* 4 */ val invalidModel: typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowDetail.invalidModel & Double = js.native
      
      /* 6 */ val invalidPrintTicket: typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowDetail.invalidPrintTicket & Double = js.native
      
      /* 1 */ val modelExceedsPrintBed: typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowDetail.modelExceedsPrintBed & Double = js.native
      
      /* 5 */ val modelNotManifold: typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowDetail.modelNotManifold & Double = js.native
      
      /* 0 */ val unknown: typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowDetail.unknown & Double = js.native
      
      /* 2 */ val uploadFailed: typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowDetail.uploadFailed & Double = js.native
    }
    ...
    open class Print3DWorkflowPrintRequestedEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowPrintRequestedEventArgs {
    ...
    object Print3DWorkflowStatus extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus & Double
          ] = js.native
      
      /* 0 */ val abandoned: typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.abandoned & Double = js.native
      
      /* 1 */ val canceled: typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.canceled & Double = js.native
      
      /* 2 */ val failed: typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.failed & Double = js.native
      
      /* 3 */ val slicing: typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.slicing & Double = js.native
      
      /* 4 */ val submitted: typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.submitted & Double = js.native
    }
    ...
    open class PrintExtensionContext ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.PrintExtensionContext
    ...
    open class PrintNotificationEventDetails ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.PrintNotificationEventDetails {
    ...
    open class PrintTaskConfiguration ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.PrintTaskConfiguration
    ...
    open class PrintTaskConfigurationSaveRequest ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequest {
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def getDeferral(): typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequestedDeferral = js.native
    ...
    open class PrintTaskConfigurationSaveRequestedDeferral ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequestedDeferral {
    ...
    open class PrintTaskConfigurationSaveRequestedEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequestedEventArgs {
      
      /** Gets the information that is required for updating the print task configuration. */
      /* CompleteClass */
      var request: typingsJapgolly.winrtUwp.Windows.Devices.Printers.Extensions.PrintTaskConfigurationSaveRequest = js.native
    }
  }
  ...
  open class Print3DDevice ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Printers.Print3DDevice {
    
    /** Gets the PrintSchema object for obtaining capabilities and print ticket information. */
    /* CompleteClass */
    var printSchema: typingsJapgolly.winrtUwp.Windows.Devices.Printers.PrintSchema = js.native
  }
  object Print3DDevice {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Printers.Print3DDevice] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Printers.Print3DDevice]]
  ...
  open class PrintSchema ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Printers.PrintSchema {
