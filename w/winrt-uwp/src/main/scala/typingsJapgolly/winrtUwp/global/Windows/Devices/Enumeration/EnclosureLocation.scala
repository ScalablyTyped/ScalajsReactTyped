...
open class EnclosureLocation ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Enumeration.EnclosureLocation {
  ...
  /* CompleteClass */
  var panel: typingsJapgolly.winrtUwp.Windows.Devices.Enumeration.Panel = js.native
}
