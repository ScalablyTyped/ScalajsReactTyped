...
import typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationType
...
object PushNotifications {
  ...
  open class PushNotificationChannel ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationChannel
  ...
  open class PushNotificationChannelManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationChannelManager
  object PushNotificationChannelManager {
    ...
    /**
      ...
      */
    /* static member */
    inline def createPushNotificationChannelForApplicationAsync(): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationChannel
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("createPushNotificationChannelForApplicationAsync")().asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationChannel
      ]]
    /**
      ...
      */
    /* static member */
    inline def createPushNotificationChannelForApplicationAsync(applicationId: String): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationChannel
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("createPushNotificationChannelForApplicationAsync")(applicationId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationChannel
      ]]
    ...
    /**
      ...
      */
    /* static member */
    inline def createPushNotificationChannelForSecondaryTileAsync(tileId: String): IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationChannel
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("createPushNotificationChannelForSecondaryTileAsync")(tileId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[
        typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationChannel
      ]]
  }
  ...
  open class PushNotificationReceivedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationReceivedEventArgs {
  ...
  object PushNotificationType extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationType & Double
      ] = js.native
    
    /* 2 */ val badge: typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationType.badge & Double = js.native
    
    /* 3 */ val raw: typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationType.raw & Double = js.native
    
    /* 1 */ val tile: typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationType.tile & Double = js.native
    
    /* 4 */ val tileFlyout: typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationType.tileFlyout & Double = js.native
    
    /* 0 */ val toast: typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.PushNotificationType.toast & Double = js.native
  }
  ...
  open class RawNotification ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Networking.PushNotifications.RawNotification {
