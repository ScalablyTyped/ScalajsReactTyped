...
open class VideoFrame protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.VideoFrame {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copyToAsync(frame: typingsJapgolly.winrtUwp.Windows.Media.VideoFrame): IPromiseWithIAsyncAction = js.native
