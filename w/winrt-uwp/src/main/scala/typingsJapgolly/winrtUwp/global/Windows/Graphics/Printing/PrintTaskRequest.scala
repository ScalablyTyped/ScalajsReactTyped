...
import typingsJapgolly.winrtUwp.Windows.Graphics.Printing.PrintTaskSourceRequestedHandler
...
open class PrintTaskRequest ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Graphics.Printing.PrintTaskRequest {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createPrintTask(title: String, handler: PrintTaskSourceRequestedHandler): typingsJapgolly.winrtUwp.Windows.Graphics.Printing.PrintTask = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsJapgolly.winrtUwp.Windows.Graphics.Printing.PrintTaskRequestedDeferral = js.native
}
