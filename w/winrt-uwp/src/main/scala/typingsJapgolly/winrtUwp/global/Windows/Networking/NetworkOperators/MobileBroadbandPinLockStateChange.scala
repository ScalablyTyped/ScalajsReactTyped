...
open class MobileBroadbandPinLockStateChange ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinLockStateChange {
  ...
  /* CompleteClass */
  var pinLockState: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinLockState = js.native
  
  /** Gets a value representing the type of PIN involved in a PIN lock state change. */
  /* CompleteClass */
  var pinType: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinType = js.native
}
