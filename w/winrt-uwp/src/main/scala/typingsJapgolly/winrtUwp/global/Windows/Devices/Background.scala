...
object Background {
  ...
  open class DeviceServicingDetails ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Background.DeviceServicingDetails {
  ...
  open class DeviceUseDetails ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Background.DeviceUseDetails {
