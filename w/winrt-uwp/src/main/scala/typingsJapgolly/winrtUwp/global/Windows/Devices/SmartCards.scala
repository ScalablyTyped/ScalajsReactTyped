...
import typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardPinCharacterPolicyOption
import typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardPinResetHandler
import typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReaderKind
import typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardStatus
...
object SmartCards {
  ...
  open class CardAddedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.CardAddedEventArgs {
    
    /** Gets info about the smart card that was inserted into the smart card reader. */
    /* CompleteClass */
    var smartCard: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCard = js.native
  }
  ...
  open class CardRemovedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.CardRemovedEventArgs {
  ...
  open class SmartCard ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCard {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def connectAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardConnection] = js.native
    ...
    /* CompleteClass */
    var reader: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReader = js.native
  }
  ...
  open class SmartCardChallengeContext ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardChallengeContext
  ...
  open class SmartCardConnection ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardConnection {
  ...
  object SmartCardPinCharacterPolicyOption extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardPinCharacterPolicyOption & Double
      ] = js.native
    
    /* 0 */ val allow: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardPinCharacterPolicyOption.allow & Double = js.native
    
    /* 2 */ val disallow: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardPinCharacterPolicyOption.disallow & Double = js.native
    
    /* 1 */ val requireAtLeastOne: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardPinCharacterPolicyOption.requireAtLeastOne & Double = js.native
  }
  ...
  open class SmartCardPinPolicy ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardPinPolicy {
  ...
  open class SmartCardPinResetDeferral ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardPinResetDeferral {
  ...
  open class SmartCardPinResetRequest ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardPinResetRequest {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getDeferral(): typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardPinResetDeferral = js.native
  ...
  open class SmartCardProvisioning ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardProvisioning {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getChallengeContextAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardChallengeContext] = js.native
  ...
  object SmartCardProvisioning {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromSmartCardAsync(card: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCard): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardProvisioning] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromSmartCardAsync")(card.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardProvisioning]]
    ...
    inline def requestVirtualSmartCardCreationAsync(
      ...
      pinPolicy: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardPinPolicy
    ): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardProvisioning] = (^.asInstanceOf[js.Dynamic].applyDynamic("requestVirtualSmartCardCreationAsync")(friendlyName.asInstanceOf[js.Any], administrativeKey.asInstanceOf[js.Any], pinPolicy.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardProvisioning]]
    /* unmapped type */
    /**
    ...
    inline def requestVirtualSmartCardCreationAsync(
      ...
      pinPolicy: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardPinPolicy,
      cardId: String
    ): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardProvisioning] = (^.asInstanceOf[js.Dynamic].applyDynamic("requestVirtualSmartCardCreationAsync")(friendlyName.asInstanceOf[js.Any], administrativeKey.asInstanceOf[js.Any], pinPolicy.asInstanceOf[js.Any], cardId.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardProvisioning]]
    ...
    /**
      ...
      */
    /* static member */
    inline def requestVirtualSmartCardDeletionAsync(card: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCard): IPromiseWithIAsyncOperation[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("requestVirtualSmartCardDeletionAsync")(card.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[Boolean]]
  }
  ...
  open class SmartCardReader ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReader
  object SmartCardReader {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReader] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReader]]
  ...
  object SmartCardReaderKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReaderKind & Double] = js.native
    
    /* 0 */ val any: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReaderKind.any & Double = js.native
    
    /* 1 */ val generic: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReaderKind.generic & Double = js.native
    
    /* 3 */ val nfc: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReaderKind.nfc & Double = js.native
    
    /* 2 */ val tpm: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReaderKind.tpm & Double = js.native
    
    /* 4 */ val uicc: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReaderKind.uicc & Double = js.native
  }
  ...
  object SmartCardReaderStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReaderStatus & Double
      ] = js.native
    
    /* 0 */ val disconnected: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReaderStatus.disconnected & Double = js.native
    
    /* 2 */ val exclusive: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReaderStatus.exclusive & Double = js.native
    
    /* 1 */ val ready: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardReaderStatus.ready & Double = js.native
  }
  ...
  object SmartCardStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardStatus & Double] = js.native
    
    /* 0 */ val disconnected: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardStatus.disconnected & Double = js.native
    
    /* 3 */ val exclusive: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardStatus.exclusive & Double = js.native
    
    /* 1 */ val ready: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardStatus.ready & Double = js.native
    
    /* 2 */ val shared: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardStatus.shared & Double = js.native
    
    /* 4 */ val unresponsive: typingsJapgolly.winrtUwp.Windows.Devices.SmartCards.SmartCardStatus.unresponsive & Double = js.native
  }
}
