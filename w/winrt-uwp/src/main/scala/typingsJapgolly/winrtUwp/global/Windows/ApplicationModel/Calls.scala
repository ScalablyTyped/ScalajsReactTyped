...
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneCallBlockedReason
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineChangeKind
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineProperties
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryMedia
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryOtherAppReadAccess
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryRawAddressKind
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistorySourceIdKind
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStoreAccessType
...
object Calls {
  ...
  object Background {
    ...
    object PhoneCallBlockedReason extends StObject {
      ...
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneCallBlockedReason & Double
          ] = js.native
      
      /* 0 */ val inCallBlockingList: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneCallBlockedReason.inCallBlockingList & Double = js.native
      
      /* 1 */ val privateNumber: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneCallBlockedReason.privateNumber & Double = js.native
      
      /* 2 */ val unknownNumber: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneCallBlockedReason.unknownNumber & Double = js.native
    }
    ...
    open class PhoneCallBlockedTriggerDetails ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneCallBlockedTriggerDetails {
    ...
    open class PhoneCallOriginDataRequestTriggerDetails ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneCallOriginDataRequestTriggerDetails {
    ...
    object PhoneLineChangeKind extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineChangeKind & Double
          ] = js.native
      
      /* 0 */ val added: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineChangeKind.added & Double = js.native
      
      /* 2 */ val propertiesChanged: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineChangeKind.propertiesChanged & Double = js.native
      
      /* 1 */ val removed: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineChangeKind.removed & Double = js.native
    }
    ...
    open class PhoneLineChangedTriggerDetails ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineChangedTriggerDetails {
    ...
    object PhoneLineProperties extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineProperties & Double
          ] = js.native
      
      /* 1 */ val brandingOptions: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineProperties.brandingOptions & Double = js.native
      
      /* 2 */ val canDial: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineProperties.canDial & Double = js.native
      
      /* 3 */ val cellularDetails: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineProperties.cellularDetails & Double = js.native
      
      /* 4 */ val displayColor: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineProperties.displayColor & Double = js.native
      
      /* 5 */ val displayName: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineProperties.displayName & Double = js.native
      
      /* 6 */ val networkName: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineProperties.networkName & Double = js.native
      
      /* 7 */ val networkState: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineProperties.networkState & Double = js.native
      
      /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineProperties.none & Double = js.native
      
      /* 8 */ val transport: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineProperties.transport & Double = js.native
      
      /* 9 */ val voicemail: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneLineProperties.voicemail & Double = js.native
    }
    ...
    open class PhoneNewVoicemailMessageTriggerDetails ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneNewVoicemailMessageTriggerDetails {
    ...
    object PhoneTriggerType extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneTriggerType & Double
          ] = js.native
      
      /* 3 */ val airplaneModeDisabledForEmergencyCall: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneTriggerType.airplaneModeDisabledForEmergencyCall & Double = js.native
      
      /* 5 */ val callBlocked: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneTriggerType.callBlocked & Double = js.native
      
      /* 1 */ val callHistoryChanged: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneTriggerType.callHistoryChanged & Double = js.native
      
      /* 4 */ val callOriginDataRequest: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneTriggerType.callOriginDataRequest & Double = js.native
      
      /* 2 */ val lineChanged: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneTriggerType.lineChanged & Double = js.native
      
      /* 0 */ val newVoicemailMessage: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.Background.PhoneTriggerType.newVoicemailMessage & Double = js.native
    }
  }
  ...
  open class LockScreenCallEndCallDeferral ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.LockScreenCallEndCallDeferral {
  ...
  open class LockScreenCallEndRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.LockScreenCallEndRequestedEventArgs {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getDeferral(): typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.LockScreenCallEndCallDeferral = js.native
  }
  ...
  open class LockScreenCallUI ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.LockScreenCallUI
  ...
  open class PhoneCallHistoryEntry ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntry {
    
    /** Gets or sets the address book information for this phone call. */
    /* CompleteClass */
    var address: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryAddress = js.native
  ...
  open class PhoneCallHistoryEntryAddress ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryAddress {
    /**
  ...
  object PhoneCallHistoryEntryMedia extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryMedia & Double
      ] = js.native
    
    /* 0 */ val audio: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryMedia.audio & Double = js.native
    
    /* 1 */ val video: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryMedia.video & Double = js.native
  }
  ...
  object PhoneCallHistoryEntryOtherAppReadAccess extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryOtherAppReadAccess & Double
      ] = js.native
    
    /* 0 */ val full: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryOtherAppReadAccess.full & Double = js.native
    
    /* 1 */ val systemOnly: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryOtherAppReadAccess.systemOnly & Double = js.native
  }
  ...
  object PhoneCallHistoryEntryQueryDesiredMedia extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia & Double
      ] = js.native
    
    /* 3 */ val all: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia.all & Double = js.native
    
    /* 1 */ val audio: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia.audio & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia.none & Double = js.native
    
    /* 2 */ val video: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryDesiredMedia.video & Double = js.native
  }
  ...
  open class PhoneCallHistoryEntryQueryOptions ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryOptions {
  ...
  object PhoneCallHistoryEntryRawAddressKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryRawAddressKind & Double
      ] = js.native
    
    /* 1 */ val custom: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryRawAddressKind.custom & Double = js.native
    
    /* 0 */ val phoneNumber: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryRawAddressKind.phoneNumber & Double = js.native
  }
  ...
  open class PhoneCallHistoryEntryReader ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryEntryReader {
  ...
  open class PhoneCallHistoryManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryManager
  object PhoneCallHistoryManager {
    ...
    /**
      ...
      */
    /* static member */
    inline def requestStoreAsync(accessType: PhoneCallHistoryStoreAccessType): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStore] = ^.asInstanceOf[js.Dynamic].applyDynamic("requestStoreAsync")(accessType.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStore]]
  }
  ...
  object PhoneCallHistorySourceIdKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistorySourceIdKind & Double
      ] = js.native
    
    /* 0 */ val cellularPhoneLineId: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistorySourceIdKind.cellularPhoneLineId & Double = js.native
    
    /* 1 */ val packageFamilyName: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistorySourceIdKind.packageFamilyName & Double = js.native
  }
  ...
  open class PhoneCallHistoryStore ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStore
  ...
  object PhoneCallHistoryStoreAccessType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStoreAccessType & Double
      ] = js.native
    
    /* 1 */ val allEntriesLimitedReadWrite: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStoreAccessType.allEntriesLimitedReadWrite & Double = js.native
    
    /* 2 */ val allEntriesReadWrite: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStoreAccessType.allEntriesReadWrite & Double = js.native
    
    /* 0 */ val appEntriesReadWrite: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Calls.PhoneCallHistoryStoreAccessType.appEntriesReadWrite & Double = js.native
  }
}
