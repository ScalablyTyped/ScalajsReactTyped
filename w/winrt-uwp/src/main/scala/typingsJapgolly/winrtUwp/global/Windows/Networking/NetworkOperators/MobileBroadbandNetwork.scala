...
open class MobileBroadbandNetwork ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandNetwork {
  ...
  /* CompleteClass */
  var networkRegistrationState: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.NetworkRegistrationState = js.native
  ...
  /* CompleteClass */
  var registeredDataClass: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.DataClasses = js.native
  ...
  /* CompleteClass */
  var registrationUiccApps: IVectorView[
