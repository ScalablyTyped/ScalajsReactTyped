...
open class AppointmentStoreChangedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentStoreChangedEventArgs {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDeferral(): typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentStoreChangedDeferral = js.native
}
