...
import typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags
import typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementPublisherStatus
import typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementType
...
object Advertisement {
  ...
  open class BluetoothLEAdvertisement ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisement {
    
    /** Gets the list of raw data sections. */
    /* CompleteClass */
    var dataSections: IVector[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementDataSection
      ] = js.native
    ...
    override def getManufacturerDataByCompanyId(companyId: Double): IVectorView[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEManufacturerData
      ] = js.native
  ...
  open class BluetoothLEAdvertisementBytePattern ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementBytePattern {
    /**
  ...
  open class BluetoothLEAdvertisementDataSection ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementDataSection {
    /**
  ...
  open class BluetoothLEAdvertisementDataTypes ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementDataTypes
  ...
  open class BluetoothLEAdvertisementFilter ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFilter {
    
    /** A BluetoothLEAdvertisement object that can be applied as filters to received Bluetooth LE advertisements. */
    /* CompleteClass */
    var advertisement: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisement = js.native
    ...
    var bytePatterns: IVector[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementBytePattern
      ] = js.native
  }
  ...
  object BluetoothLEAdvertisementFlags extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags & Double
      ] = js.native
    
    /* 3 */ val classicNotSupported: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags.classicNotSupported & Double = js.native
    
    /* 4 */ val dualModeControllerCapable: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags.dualModeControllerCapable & Double = js.native
    
    /* 5 */ val dualModeHostCapable: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags.dualModeHostCapable & Double = js.native
    
    /* 2 */ val generalDiscoverableMode: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags.generalDiscoverableMode & Double = js.native
    
    /* 1 */ val limitedDiscoverableMode: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags.limitedDiscoverableMode & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFlags.none & Double = js.native
  }
  ...
  open class BluetoothLEAdvertisementPublisher ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementPublisher {
    /**
      ...
      */
    def this(advertisement: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisement) = this()
  }
  ...
  object BluetoothLEAdvertisementPublisherStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementPublisherStatus & Double
      ] = js.native
    
    /* 5 */ val aborted: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementPublisherStatus.aborted & Double = js.native
    
    /* 0 */ val created: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementPublisherStatus.created & Double = js.native
    
    /* 2 */ val started: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementPublisherStatus.started & Double = js.native
    
    /* 4 */ val stopped: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementPublisherStatus.stopped & Double = js.native
    
    /* 3 */ val stopping: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementPublisherStatus.stopping & Double = js.native
    
    /* 1 */ val waiting: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementPublisherStatus.waiting & Double = js.native
  }
  ...
  open class BluetoothLEAdvertisementPublisherStatusChangedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementPublisherStatusChangedEventArgs {
  ...
  open class BluetoothLEAdvertisementReceivedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementReceivedEventArgs {
  ...
  object BluetoothLEAdvertisementType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementType & Double
      ] = js.native
    
    /* 1 */ val connectableDirected: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementType.connectableDirected & Double = js.native
    
    /* 0 */ val connectableUndirected: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementType.connectableUndirected & Double = js.native
    
    /* 3 */ val nonConnectableUndirected: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementType.nonConnectableUndirected & Double = js.native
    
    /* 4 */ val scanResponse: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementType.scanResponse & Double = js.native
    
    /* 2 */ val scannableUndirected: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementType.scannableUndirected & Double = js.native
  }
  ...
  open class BluetoothLEAdvertisementWatcher ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementWatcher {
    /**
      ...
      */
    def this(advertisementFilter: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementFilter) = this()
  }
  ...
  object BluetoothLEAdvertisementWatcherStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementWatcherStatus & Double
      ] = js.native
    
    /* 4 */ val aborted: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementWatcherStatus.aborted & Double = js.native
    
    /* 0 */ val created: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementWatcherStatus.created & Double = js.native
    
    /* 1 */ val started: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementWatcherStatus.started & Double = js.native
    
    /* 3 */ val stopped: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementWatcherStatus.stopped & Double = js.native
    
    /* 2 */ val stopping: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementWatcherStatus.stopping & Double = js.native
  }
  ...
  open class BluetoothLEAdvertisementWatcherStoppedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEAdvertisementWatcherStoppedEventArgs {
  ...
  open class BluetoothLEManufacturerData ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEManufacturerData {
    /**
  ...
  object BluetoothLEScanningMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEScanningMode & Double
      ] = js.native
    
    /* 1 */ val active: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEScanningMode.active & Double = js.native
    
    /* 0 */ val passive: typingsJapgolly.winrtUwp.Windows.Devices.Bluetooth.Advertisement.BluetoothLEScanningMode.passive & Double = js.native
  }
}
