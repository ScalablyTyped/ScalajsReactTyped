...
import typingsJapgolly.winrtUwp.Windows.Media.Capture.WhiteBalanceGain
import typingsJapgolly.winrtUwp.Windows.Media.Devices.CaptureSceneMode
...
/* note: abstract class */ @JSGlobal("Windows.Media.Capture.CapturedFrameControlValues")
@js.native
open class CapturedFrameControlValues ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Capture.CapturedFrameControlValues {
