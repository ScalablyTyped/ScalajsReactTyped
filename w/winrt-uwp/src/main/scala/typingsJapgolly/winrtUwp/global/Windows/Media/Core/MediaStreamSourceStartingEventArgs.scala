...
open class MediaStreamSourceStartingEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSourceStartingEventArgs {
  
  /** Gets the object that represents the request to start accumulating MediaStreamSample data. */
  /* CompleteClass */
  var request: typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSourceStartingRequest = js.native
}
