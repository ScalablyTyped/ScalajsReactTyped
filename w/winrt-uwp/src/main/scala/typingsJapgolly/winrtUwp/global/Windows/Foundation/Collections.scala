...
object Collections {
  ...
  object CollectionChange extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Foundation.Collections.CollectionChange & Double
      ] = js.native
    
    /* 3 */ val itemChanged: typingsJapgolly.winrtUwp.Windows.Foundation.Collections.CollectionChange.itemChanged & Double = js.native
    
    /* 1 */ val itemInserted: typingsJapgolly.winrtUwp.Windows.Foundation.Collections.CollectionChange.itemInserted & Double = js.native
    
    /* 2 */ val itemRemoved: typingsJapgolly.winrtUwp.Windows.Foundation.Collections.CollectionChange.itemRemoved & Double = js.native
    
    /* 0 */ val reset: typingsJapgolly.winrtUwp.Windows.Foundation.Collections.CollectionChange.reset & Double = js.native
  }
  ...
  open class PropertySet ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Collections.PropertySet
  ...
  open class StringMap ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Collections.StringMap
  ...
  open class ValueSet ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Foundation.Collections.ValueSet
}
