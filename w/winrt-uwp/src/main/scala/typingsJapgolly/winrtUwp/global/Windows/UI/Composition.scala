...
object Composition {
  ...
  open class CompositionAnimation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.Composition.CompositionAnimation
  ...
  open class CompositionEasingFunction ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.UI.Composition.CompositionEasingFunction
}
