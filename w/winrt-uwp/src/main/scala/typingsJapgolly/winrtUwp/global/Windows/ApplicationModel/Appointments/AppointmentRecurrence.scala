...
open class AppointmentRecurrence ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentRecurrence {
  ...
  /* CompleteClass */
  var daysOfWeek: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentDaysOfWeek = js.native
  ...
  /* CompleteClass */
  var recurrenceType: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.RecurrenceType = js.native
  ...
  /* CompleteClass */
  var unit: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentRecurrenceUnit = js.native
  ...
  /* CompleteClass */
  var weekOfMonth: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentWeekOfMonth = js.native
}
