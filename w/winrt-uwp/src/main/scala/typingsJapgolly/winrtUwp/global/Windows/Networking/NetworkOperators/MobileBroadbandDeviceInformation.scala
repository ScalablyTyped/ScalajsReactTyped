...
/* note: abstract class */ @JSGlobal("Windows.Networking.NetworkOperators.MobileBroadbandDeviceInformation")
@js.native
open class MobileBroadbandDeviceInformation ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandDeviceInformation {
  ...
  /* CompleteClass */
  var currentRadioState: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandRadioState = js.native
  ...
  /* CompleteClass */
  var dataClasses: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.DataClasses = js.native
  ...
  /* CompleteClass */
  var deviceType: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandDeviceType = js.native
  ...
  /* CompleteClass */
  var networkDeviceStatus: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.NetworkDeviceStatus = js.native
  
  /** Gets a MobileBroadbandPinManager object for the mobile broadband device. */
  /* CompleteClass */
  var pinManager: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinManager = js.native
