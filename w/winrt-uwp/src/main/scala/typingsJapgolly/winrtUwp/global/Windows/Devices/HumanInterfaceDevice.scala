...
import typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidCollectionType
import typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidReportType
...
object HumanInterfaceDevice {
  ...
  open class HidBooleanControl ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidBooleanControl {
    
    /** Retrieves a description of the given Boolean control. */
    /* CompleteClass */
    var controlDescription: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidBooleanControlDescription = js.native
  ...
  open class HidBooleanControlDescription ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidBooleanControlDescription {
    ...
    /* CompleteClass */
    var parentCollections: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidCollection] = js.native
  ...
  open class HidCollection ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidCollection {
  ...
  object HidCollectionType extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidCollectionType & Double
      ] = js.native
    
    /* 1 */ val application: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidCollectionType.application & Double = js.native
    
    /* 2 */ val logical: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidCollectionType.logical & Double = js.native
    
    /* 4 */ val namedArray: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidCollectionType.namedArray & Double = js.native
    
    /* 7 */ val other: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidCollectionType.other & Double = js.native
    
    /* 0 */ val physical: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidCollectionType.physical & Double = js.native
    
    /* 3 */ val report: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidCollectionType.report & Double = js.native
    
    /* 6 */ val usageModifier: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidCollectionType.usageModifier & Double = js.native
    
    /* 5 */ val usageSwitch: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidCollectionType.usageSwitch & Double = js.native
  }
  ...
  open class HidDevice ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidDevice
  object HidDevice {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIdAsync(deviceId: String, accessMode: FileAccessMode): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidDevice] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any], accessMode.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidDevice]]
  ...
  open class HidFeatureReport ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidFeatureReport {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getBooleanControl(usagePage: Double, usageId: Double): typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidBooleanControl = js.native
    ...
    override def getBooleanControlByDescription(
      controlDescription: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidBooleanControlDescription
    ): typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidBooleanControl = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getNumericControl(usagePage: Double, usageId: Double): typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidNumericControl = js.native
    ...
    override def getNumericControlByDescription(
      controlDescription: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidNumericControlDescription
    ): typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidNumericControl = js.native
  ...
  open class HidInputReport ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidInputReport {
    
    /** Retrieves the currently activated Boolean controls for the given HID device. */
    /* CompleteClass */
    var activatedBooleanControls: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidBooleanControl] = js.native
    ...
    /* CompleteClass */
    var transitionedBooleanControls: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidBooleanControl] = js.native
  }
  ...
  open class HidInputReportReceivedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidInputReportReceivedEventArgs {
    
    /** Retrieves the input report. */
    /* CompleteClass */
    var report: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidInputReport = js.native
  }
  ...
  open class HidNumericControl ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidNumericControl {
    
    /** Retrieves a control description for the given numeric control. */
    /* CompleteClass */
    var controlDescription: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidNumericControlDescription = js.native
  ...
  open class HidNumericControlDescription ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidNumericControlDescription {
  ...
  open class HidOutputReport ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidOutputReport {
  ...
  object HidReportType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidReportType & Double
      ] = js.native
    
    /* 2 */ val feature: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidReportType.feature & Double = js.native
    
    /* 0 */ val input: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidReportType.input & Double = js.native
    
    /* 1 */ val output: typingsJapgolly.winrtUwp.Windows.Devices.HumanInterfaceDevice.HidReportType.output & Double = js.native
  }
}
