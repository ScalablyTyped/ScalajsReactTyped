...
open class PlayReadyLicenseIterable ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyLicenseIterable {
  /**
    * Initializes a new instance of the PlayReadyLicenseIterable class.
    ...
    */
  def this(
    contentHeader: typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyContentHeader,
