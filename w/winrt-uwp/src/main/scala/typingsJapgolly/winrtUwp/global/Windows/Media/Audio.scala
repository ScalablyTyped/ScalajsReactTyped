...
import typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus
import typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFileNodeCreationStatus
import typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphCreationStatus
import typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphUnrecoverableError
import typingsJapgolly.winrtUwp.Windows.Media.Audio.IAudioNode
import typingsJapgolly.winrtUwp.Windows.Media.Audio.QuantumSizeSelectionMode
...
object Audio {
  ...
  open class AudioDeviceInputNode ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioDeviceInputNode
  ...
  object AudioDeviceNodeCreationStatus extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus & Double
      ] = js.native
    
    /* 4 */ val accessDenied: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.accessDenied & Double = js.native
    
    /* 1 */ val deviceNotAvailable: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.deviceNotAvailable & Double = js.native
    
    /* 2 */ val formatNotSupported: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.formatNotSupported & Double = js.native
    
    /* 0 */ val success: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.success & Double = js.native
    
    /* 3 */ val unknownFailure: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.unknownFailure & Double = js.native
  }
  ...
  open class AudioDeviceOutputNode ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioDeviceOutputNode {
  ...
  open class AudioFileInputNode ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFileInputNode
  ...
  object AudioFileNodeCreationStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFileNodeCreationStatus & Double
      ] = js.native
    
    /* 1 */ val fileNotFound: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFileNodeCreationStatus.fileNotFound & Double = js.native
    
    /* 3 */ val formatNotSupported: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFileNodeCreationStatus.formatNotSupported & Double = js.native
    
    /* 2 */ val invalidFileType: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFileNodeCreationStatus.invalidFileType & Double = js.native
    
    /* 0 */ val success: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFileNodeCreationStatus.success & Double = js.native
    
    /* 4 */ val unknownFailure: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFileNodeCreationStatus.unknownFailure & Double = js.native
  }
  ...
  open class AudioFileOutputNode ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFileOutputNode {
  ...
  open class AudioFrameCompletedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFrameCompletedEventArgs {
    ...
    /* CompleteClass */
    var frame: typingsJapgolly.winrtUwp.Windows.Media.AudioFrame = js.native
  }
  ...
  open class AudioFrameInputNode ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFrameInputNode
  ...
  open class AudioFrameOutputNode ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFrameOutputNode {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getFrame(): typingsJapgolly.winrtUwp.Windows.Media.AudioFrame = js.native
  ...
  open class AudioGraph ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraph
  object AudioGraph {
    ...
    /**
      ...
      */
    /* static member */
    inline def createAsync(settings: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphSettings): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Media.Audio.CreateAudioGraphResult] = ^.asInstanceOf[js.Dynamic].applyDynamic("createAsync")(settings.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Media.Audio.CreateAudioGraphResult]]
  }
  ...
  open class AudioGraphConnection ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphConnection {
  ...
  object AudioGraphCreationStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphCreationStatus & Double] = js.native
    
    /* 1 */ val deviceNotAvailable: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphCreationStatus.deviceNotAvailable & Double = js.native
    
    /* 2 */ val formatNotSupported: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphCreationStatus.formatNotSupported & Double = js.native
    
    /* 0 */ val success: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphCreationStatus.success & Double = js.native
    
    /* 3 */ val unknownFailure: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphCreationStatus.unknownFailure & Double = js.native
  }
  ...
  open class AudioGraphSettings protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphSettings {
    /**
    ...
    /* CompleteClass */
    var desiredRenderDeviceAudioProcessing: typingsJapgolly.winrtUwp.Windows.Media.AudioProcessing = js.native
  ...
  object AudioGraphUnrecoverableError extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphUnrecoverableError & Double
      ] = js.native
    
    /* 1 */ val audioDeviceLost: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphUnrecoverableError.audioDeviceLost & Double = js.native
    
    /* 2 */ val audioSessionDisconnected: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphUnrecoverableError.audioSessionDisconnected & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphUnrecoverableError.none & Double = js.native
    
    /* 3 */ val unknownFailure: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphUnrecoverableError.unknownFailure & Double = js.native
  }
  ...
  open class AudioGraphUnrecoverableErrorOccurredEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraphUnrecoverableErrorOccurredEventArgs {
  ...
  open class AudioSubmixNode ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioSubmixNode
  ...
  open class CreateAudioDeviceInputNodeResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.CreateAudioDeviceInputNodeResult {
    
    /** Gets the audio device input node. */
    /* CompleteClass */
    var deviceInputNode: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioDeviceInputNode = js.native
  ...
  open class CreateAudioDeviceOutputNodeResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.CreateAudioDeviceOutputNodeResult {
    
    /** Gets the audio device output node. */
    /* CompleteClass */
    var deviceOutputNode: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioDeviceOutputNode = js.native
  ...
  open class CreateAudioFileInputNodeResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.CreateAudioFileInputNodeResult {
    
    /** Gets the audio file input node. */
    /* CompleteClass */
    var fileInputNode: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFileInputNode = js.native
  ...
  open class CreateAudioFileOutputNodeResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.CreateAudioFileOutputNodeResult {
    
    /** Gets the audio file output node. */
    /* CompleteClass */
    var fileOutputNode: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioFileOutputNode = js.native
  ...
  open class CreateAudioGraphResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.CreateAudioGraphResult {
    
    /** Gets the audio graph object. */
    /* CompleteClass */
    var graph: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraph = js.native
  ...
  open class EchoEffectDefinition protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.EchoEffectDefinition {
    /**
      ...
      */
    def this(audioGraph: typingsJapgolly.winrtUwp.Windows.Media.Audio.AudioGraph) = this()
  ...
  open class EqualizerBand ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.EqualizerBand {
  ...
  open class EqualizerEffectDefinition protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.EqualizerEffectDefinition {
    /**
    ...
    /* CompleteClass */
    var bands: IVectorView[typingsJapgolly.winrtUwp.Windows.Media.Audio.EqualizerBand] = js.native
  ...
  open class FrameInputNodeQuantumStartedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.FrameInputNodeQuantumStartedEventArgs {
  ...
  open class LimiterEffectDefinition protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.LimiterEffectDefinition {
    /**
  ...
  object QuantumSizeSelectionMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Media.Audio.QuantumSizeSelectionMode & Double] = js.native
    
    /* 2 */ val closestToDesired: typingsJapgolly.winrtUwp.Windows.Media.Audio.QuantumSizeSelectionMode.closestToDesired & Double = js.native
    
    /* 1 */ val lowestLatency: typingsJapgolly.winrtUwp.Windows.Media.Audio.QuantumSizeSelectionMode.lowestLatency & Double = js.native
    
    /* 0 */ val systemDefault: typingsJapgolly.winrtUwp.Windows.Media.Audio.QuantumSizeSelectionMode.systemDefault & Double = js.native
  }
  ...
  open class ReverbEffectDefinition protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.Audio.ReverbEffectDefinition {
    /**
