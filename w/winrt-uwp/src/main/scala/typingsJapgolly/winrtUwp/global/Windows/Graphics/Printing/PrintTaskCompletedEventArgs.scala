...
open class PrintTaskCompletedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Graphics.Printing.PrintTaskCompletedEventArgs {
  
  /** Gets the completion status of the print task. */
  /* CompleteClass */
  var completion: typingsJapgolly.winrtUwp.Windows.Graphics.Printing.PrintTaskCompletion = js.native
}
