...
open class MediaStreamSourceClosedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSourceClosedEventArgs {
  
  /** Gets the object that represents the notification that the MediaStreamSource has been closed. */
  /* CompleteClass */
  var request: typingsJapgolly.winrtUwp.Windows.Media.Core.MediaStreamSourceClosedRequest = js.native
}
