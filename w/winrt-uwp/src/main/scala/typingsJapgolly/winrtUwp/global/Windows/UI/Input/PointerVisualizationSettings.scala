...
open class PointerVisualizationSettings ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.UI.Input.PointerVisualizationSettings {
...
object PointerVisualizationSettings {
  ...
  /**
    ...
    */
  /* static member */
  inline def getForCurrentView(): typingsJapgolly.winrtUwp.Windows.UI.Input.PointerVisualizationSettings = ^.asInstanceOf[js.Dynamic].applyDynamic("getForCurrentView")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.UI.Input.PointerVisualizationSettings]
}
