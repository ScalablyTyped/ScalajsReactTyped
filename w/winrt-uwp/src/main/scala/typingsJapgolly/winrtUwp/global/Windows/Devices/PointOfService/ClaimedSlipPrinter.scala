...
open class ClaimedSlipPrinter ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.ClaimedSlipPrinter {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def changePrintSide(printSide: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinterPrintSide): Unit = js.native
  ...
  /* CompleteClass */
  var colorCartridge: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinterColorCartridge = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createJob(): typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.SlipPrintJob = js.native
  ...
  /* CompleteClass */
  var printSide: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinterPrintSide = js.native
