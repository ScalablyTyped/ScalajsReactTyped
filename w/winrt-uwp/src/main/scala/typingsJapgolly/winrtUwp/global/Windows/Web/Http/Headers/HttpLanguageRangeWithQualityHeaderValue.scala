...
import typingsJapgolly.winrtUwp.anon.LanguageRangeWithQualityHeaderValue
...
open class HttpLanguageRangeWithQualityHeaderValue protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpLanguageRangeWithQualityHeaderValue {
  /**
...
object HttpLanguageRangeWithQualityHeaderValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(input: String): typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpLanguageRangeWithQualityHeaderValue = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpLanguageRangeWithQualityHeaderValue]
