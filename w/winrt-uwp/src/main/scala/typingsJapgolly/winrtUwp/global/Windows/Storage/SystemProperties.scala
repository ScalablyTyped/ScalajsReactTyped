...
open class SystemProperties ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Storage.SystemProperties
object SystemProperties {
  ...
  @js.native
  def audio: typingsJapgolly.winrtUwp.Windows.Storage.SystemAudioProperties = js.native
  inline def audio_=(x: typingsJapgolly.winrtUwp.Windows.Storage.SystemAudioProperties): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("audio")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def gps: typingsJapgolly.winrtUwp.Windows.Storage.SystemGPSProperties = js.native
  inline def gps_=(x: typingsJapgolly.winrtUwp.Windows.Storage.SystemGPSProperties): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("gps")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def image: typingsJapgolly.winrtUwp.Windows.Storage.SystemImageProperties = js.native
  inline def image_=(x: typingsJapgolly.winrtUwp.Windows.Storage.SystemImageProperties): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("image")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def media: typingsJapgolly.winrtUwp.Windows.Storage.SystemMediaProperties = js.native
  inline def media_=(x: typingsJapgolly.winrtUwp.Windows.Storage.SystemMediaProperties): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("media")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def music: typingsJapgolly.winrtUwp.Windows.Storage.SystemMusicProperties = js.native
  inline def music_=(x: typingsJapgolly.winrtUwp.Windows.Storage.SystemMusicProperties): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("music")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def photo: typingsJapgolly.winrtUwp.Windows.Storage.SystemPhotoProperties = js.native
  inline def photo_=(x: typingsJapgolly.winrtUwp.Windows.Storage.SystemPhotoProperties): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("photo")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def video: typingsJapgolly.winrtUwp.Windows.Storage.SystemVideoProperties = js.native
  inline def video_=(x: typingsJapgolly.winrtUwp.Windows.Storage.SystemVideoProperties): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("video")(x.asInstanceOf[js.Any])
}
