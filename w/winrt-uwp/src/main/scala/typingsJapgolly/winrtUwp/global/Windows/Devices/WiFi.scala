...
import typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiAccessStatus
import typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiConnectionStatus
import typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiNetworkKind
import typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiPhyKind
import typingsJapgolly.winrtUwp.Windows.Foundation.Collections.IVectorView
import typingsJapgolly.winrtUwp.Windows.Foundation.IPromiseWithIAsyncOperation
import typingsJapgolly.winrtUwp.Windows.Networking.Connectivity.NetworkSecuritySettings
...
object WiFi {
  ...
  object WiFiAccessStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiAccessStatus & Double] = js.native
    
    /* 1 */ val allowed: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiAccessStatus.allowed & Double = js.native
    
    /* 3 */ val deniedBySystem: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiAccessStatus.deniedBySystem & Double = js.native
    
    /* 2 */ val deniedByUser: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiAccessStatus.deniedByUser & Double = js.native
    
    /* 0 */ val unspecified: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiAccessStatus.unspecified & Double = js.native
  }
  ...
  open class WiFiAdapter ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiAdapter
  object WiFiAdapter {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiAdapter] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiAdapter]]
  ...
  open class WiFiAvailableNetwork ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiAvailableNetwork {
  ...
  open class WiFiConnectionResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiConnectionResult {
  ...
  object WiFiConnectionStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiConnectionStatus & Double] = js.native
    
    /* 2 */ val accessRevoked: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiConnectionStatus.accessRevoked & Double = js.native
    
    /* 3 */ val invalidCredential: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiConnectionStatus.invalidCredential & Double = js.native
    
    /* 4 */ val networkNotAvailable: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiConnectionStatus.networkNotAvailable & Double = js.native
    
    /* 1 */ val success: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiConnectionStatus.success & Double = js.native
    
    /* 5 */ val timeout: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiConnectionStatus.timeout & Double = js.native
    
    /* 0 */ val unspecifiedFailure: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiConnectionStatus.unspecifiedFailure & Double = js.native
    
    /* 6 */ val unsupportedAuthenticationProtocol: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiConnectionStatus.unsupportedAuthenticationProtocol & Double = js.native
  }
  ...
  object WiFiNetworkKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiNetworkKind & Double] = js.native
    
    /* 2 */ val adhoc: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiNetworkKind.adhoc & Double = js.native
    
    /* 0 */ val any: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiNetworkKind.any & Double = js.native
    
    /* 1 */ val infrastructure: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiNetworkKind.infrastructure & Double = js.native
  }
  ...
  open class WiFiNetworkReport ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiNetworkReport {
    
    /** A list of available networks. */
    /* CompleteClass */
    var availableNetworks: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiAvailableNetwork] = js.native
  ...
  object WiFiPhyKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiPhyKind & Double] = js.native
    
    /* 2 */ val dsss: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiPhyKind.dsss & Double = js.native
    
    /* 6 */ val erp: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiPhyKind.erp & Double = js.native
    
    /* 1 */ val fhss: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiPhyKind.fhss & Double = js.native
    
    /* 5 */ val hrdsss: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiPhyKind.hrdsss & Double = js.native
    
    /* 7 */ val ht: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiPhyKind.ht & Double = js.native
    
    /* 3 */ val irBaseband: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiPhyKind.irBaseband & Double = js.native
    
    /* 4 */ val ofdm: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiPhyKind.ofdm & Double = js.native
    
    /* 0 */ val unknown: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiPhyKind.unknown & Double = js.native
    
    /* 8 */ val vht: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiPhyKind.vht & Double = js.native
  }
  ...
  object WiFiReconnectionKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiReconnectionKind & Double] = js.native
    
    /* 0 */ val automatic: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiReconnectionKind.automatic & Double = js.native
    
    /* 1 */ val manual: typingsJapgolly.winrtUwp.Windows.Devices.WiFi.WiFiReconnectionKind.manual & Double = js.native
  }
