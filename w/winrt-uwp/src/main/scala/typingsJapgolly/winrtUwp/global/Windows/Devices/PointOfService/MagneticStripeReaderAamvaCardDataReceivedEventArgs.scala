...
open class MagneticStripeReaderAamvaCardDataReceivedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReaderAamvaCardDataReceivedEventArgs {
  ...
  /* CompleteClass */
  var report: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReaderReport = js.native
