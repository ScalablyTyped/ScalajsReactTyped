...
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.IContactField
...
open class Contact ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.Contact {
  
  /** Gets the contact addresses for a contact. */
  /* CompleteClass */
  var addresses: IVector[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactAddress] = js.native
  ...
  var connectedServiceAccounts: IVector[
    typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactConnectedServiceAccount
  ] = js.native
  ...
  /* CompleteClass */
  var emails: IVector[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactEmail] = js.native
  ...
  /* CompleteClass */
  var importantDates: IVector[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactDate] = js.native
  ...
  /* CompleteClass */
  var jobInfo: IVector[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactJobInfo] = js.native
  ...
  /* CompleteClass */
  var phones: IVector[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactPhone] = js.native
  ...
  /* CompleteClass */
  var significantOthers: IVector[
    typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactSignificantOther
  ] = js.native
  ...
  /* CompleteClass */
  var websites: IVector[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Contacts.ContactWebsite] = js.native
