...
open class PosPrinter ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinter
object PosPrinter {
  ...
  /**
    ...
    */
  /* static member */
  inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinter] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinter]]
  ...
  /**
    ...
    */
  /* static member */
  inline def getDefaultAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinter] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultAsync")().asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinter]]
