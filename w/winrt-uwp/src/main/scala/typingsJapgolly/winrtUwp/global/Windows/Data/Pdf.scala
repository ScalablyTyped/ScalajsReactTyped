...
object Pdf {
  ...
  open class PdfDocument ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfDocument {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getPage(pageIndex: Double): typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfPage = js.native
  ...
  object PdfDocument {
    ...
    /**
      ...
      */
    /* static member */
    inline def loadFromFileAsync(file: IStorageFile): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfDocument] = ^.asInstanceOf[js.Dynamic].applyDynamic("loadFromFileAsync")(file.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfDocument]]
    /**
      ...
      */
    /* static member */
    inline def loadFromFileAsync(file: IStorageFile, password: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfDocument] = (^.asInstanceOf[js.Dynamic].applyDynamic("loadFromFileAsync")(file.asInstanceOf[js.Any], password.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfDocument]]
    ...
    /**
      ...
      */
    /* static member */
    inline def loadFromStreamAsync(inputStream: IRandomAccessStream): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfDocument] = ^.asInstanceOf[js.Dynamic].applyDynamic("loadFromStreamAsync")(inputStream.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfDocument]]
    /**
      ...
      */
    /* static member */
    inline def loadFromStreamAsync(inputStream: IRandomAccessStream, password: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfDocument] = (^.asInstanceOf[js.Dynamic].applyDynamic("loadFromStreamAsync")(inputStream.asInstanceOf[js.Any], password.asInstanceOf[js.Any])).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfDocument]]
  }
  ...
  open class PdfPage ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfPage
  ...
  open class PdfPageDimensions ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfPageDimensions {
  ...
  open class PdfPageRenderOptions ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfPageRenderOptions {
  ...
  object PdfPageRotation extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfPageRotation & Double] = js.native
    
    /* 0 */ val normal: typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfPageRotation.normal & Double = js.native
    
    /* 2 */ val rotate180: typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfPageRotation.rotate180 & Double = js.native
    
    /* 3 */ val rotate270: typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfPageRotation.rotate270 & Double = js.native
    
    /* 1 */ val rotate90: typingsJapgolly.winrtUwp.Windows.Data.Pdf.PdfPageRotation.rotate90 & Double = js.native
  }
}
