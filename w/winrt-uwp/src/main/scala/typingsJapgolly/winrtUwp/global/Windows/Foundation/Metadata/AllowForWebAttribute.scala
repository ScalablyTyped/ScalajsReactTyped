...
/* note: abstract class */ @JSGlobal("Windows.Foundation.Metadata.AllowForWebAttribute")
@js.native
open class AllowForWebAttribute ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Foundation.Metadata.AllowForWebAttribute
