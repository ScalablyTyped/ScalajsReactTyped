...
open class ReceiptPrinterCapabilities ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.ReceiptPrinterCapabilities {
  ...
  /* CompleteClass */
  var markFeedCapabilities: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.PosPrinterMarkFeedCapabilities = js.native
