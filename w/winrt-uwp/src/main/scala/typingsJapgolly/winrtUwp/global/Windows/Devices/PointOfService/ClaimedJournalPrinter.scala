...
open class ClaimedJournalPrinter ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.ClaimedJournalPrinter {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createJob(): typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.JournalPrintJob = js.native
