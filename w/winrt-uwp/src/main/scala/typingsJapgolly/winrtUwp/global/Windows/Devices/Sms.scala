...
import typingsJapgolly.winrtUwp.Windows.Devices.Sms.ISmsBinaryMessage
import typingsJapgolly.winrtUwp.Windows.Devices.Sms.ISmsMessage
import typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType
import typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDataFormat
import typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsEncoding
import typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsFilterActionType
import typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsGeographicalScope
import typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageClass
import typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageFilter
import typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageType
import typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode
...
object Sms {
  ...
  object CellularClass extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Sms.CellularClass & Double] = js.native
    
    /* 2 */ val cdma: typingsJapgolly.winrtUwp.Windows.Devices.Sms.CellularClass.cdma & Double = js.native
    
    /* 1 */ val gsm: typingsJapgolly.winrtUwp.Windows.Devices.Sms.CellularClass.gsm & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.Sms.CellularClass.none & Double = js.native
  }
  ...
  open class DeleteSmsMessageOperation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.DeleteSmsMessageOperation {
  ...
  open class DeleteSmsMessagesOperation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.DeleteSmsMessagesOperation {
  ...
  open class GetSmsDeviceOperation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.GetSmsDeviceOperation {
    ...
    override def completed(
      asyncInfo: IAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice],
      asyncStatus: AsyncStatus
    ): Unit = js.native
    /** Specifies whether the asynchronous SmsDevice object retrieval operation has completed or not. */
    /* CompleteClass */
    @JSName("completed")
    var completed_Original: AsyncOperationCompletedHandler[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getResults(): typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice = js.native
  ...
  open class GetSmsMessageOperation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.GetSmsMessageOperation {
  ...
  open class GetSmsMessagesOperation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.GetSmsMessagesOperation {
  ...
  open class SendSmsMessageOperation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SendSmsMessageOperation {
  ...
  open class SmsAppMessage ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsAppMessage {
  ...
  open class SmsBinaryMessage ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBinaryMessage {
  ...
  open class SmsBroadcastMessage ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastMessage {
  ...
  object SmsBroadcastType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType & Double] = js.native
    
    /* 4 */ val cmasAmber: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.cmasAmber & Double = js.native
    
    /* 2 */ val cmasExtreme: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.cmasExtreme & Double = js.native
    
    /* 1 */ val cmasPresidential: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.cmasPresidential & Double = js.native
    
    /* 3 */ val cmasSevere: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.cmasSevere & Double = js.native
    
    /* 5 */ val cmasTest: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.cmasTest & Double = js.native
    
    /* 11 */ val etwsEarthquake: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.etwsEarthquake & Double = js.native
    
    /* 12 */ val etwsTsunami: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.etwsTsunami & Double = js.native
    
    /* 13 */ val etwsTsunamiAndEarthquake: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.etwsTsunamiAndEarthquake & Double = js.native
    
    /* 6 */ val euAlert1: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.euAlert1 & Double = js.native
    
    /* 7 */ val euAlert2: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.euAlert2 & Double = js.native
    
    /* 8 */ val euAlert3: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.euAlert3 & Double = js.native
    
    /* 9 */ val euAlertAmber: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.euAlertAmber & Double = js.native
    
    /* 10 */ val euAlertInfo: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.euAlertInfo & Double = js.native
    
    /* 14 */ val latAlertLocal: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.latAlertLocal & Double = js.native
    
    /* 0 */ val other: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastType.other & Double = js.native
  }
  ...
  object SmsDataFormat extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDataFormat & Double] = js.native
    
    /* 3 */ val cdmaDeliver: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDataFormat.cdmaDeliver & Double = js.native
    
    /* 1 */ val cdmaSubmit: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDataFormat.cdmaSubmit & Double = js.native
    
    /* 4 */ val gsmDeliver: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDataFormat.gsmDeliver & Double = js.native
    
    /* 2 */ val gsmSubmit: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDataFormat.gsmSubmit & Double = js.native
    
    /* 0 */ val unknown: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDataFormat.unknown & Double = js.native
  }
  ...
  open class SmsDevice ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice
  object SmsDevice {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice]]
    ...
    /**
      ...
      */
    /* static member */
    inline def fromNetworkAccountIdAsync(networkAccountId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromNetworkAccountIdAsync")(networkAccountId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice]]
    ...
    /**
      ...
      */
    /* static member */
    inline def getDefaultAsync(): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultAsync")().asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice]]
  ...
  open class SmsDevice2 ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice2
  object SmsDevice2 {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromId(deviceId: String): typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice2 = ^.asInstanceOf[js.Dynamic].applyDynamic("fromId")(deviceId.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice2]
    ...
    /**
      ...
      */
    /* static member */
    inline def fromParentId(parentDeviceId: String): typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice2 = ^.asInstanceOf[js.Dynamic].applyDynamic("fromParentId")(parentDeviceId.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice2]
    ...
    /**
      ...
      */
    /* static member */
    inline def getDefault(): typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice2 = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefault")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDevice2]
  ...
  open class SmsDeviceMessageStore ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDeviceMessageStore {
  ...
  object SmsDeviceStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDeviceStatus & Double] = js.native
    
    /* 3 */ val badSim: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDeviceStatus.badSim & Double = js.native
    
    /* 7 */ val deviceBlocked: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDeviceStatus.deviceBlocked & Double = js.native
    
    /* 4 */ val deviceFailure: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDeviceStatus.deviceFailure & Double = js.native
    
    /* 6 */ val deviceLocked: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDeviceStatus.deviceLocked & Double = js.native
    
    /* 0 */ val off: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDeviceStatus.off & Double = js.native
    
    /* 1 */ val ready: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDeviceStatus.ready & Double = js.native
    
    /* 2 */ val simNotInserted: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDeviceStatus.simNotInserted & Double = js.native
    
    /* 5 */ val subscriptionNotActivated: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsDeviceStatus.subscriptionNotActivated & Double = js.native
  }
  ...
  object SmsEncoding extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsEncoding & Double] = js.native
    
    /* 5 */ val eightBit: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsEncoding.eightBit & Double = js.native
    
    /* 4 */ val gsmSevenBit: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsEncoding.gsmSevenBit & Double = js.native
    
    /* 8 */ val ia5: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsEncoding.ia5 & Double = js.native
    
    /* 7 */ val korean: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsEncoding.korean & Double = js.native
    
    /* 6 */ val latin: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsEncoding.latin & Double = js.native
    
    /* 10 */ val latinHebrew: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsEncoding.latinHebrew & Double = js.native
    
    /* 1 */ val optimal: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsEncoding.optimal & Double = js.native
    
    /* 2 */ val sevenBitAscii: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsEncoding.sevenBitAscii & Double = js.native
    
    /* 9 */ val shiftJis: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsEncoding.shiftJis & Double = js.native
    
    /* 3 */ val unicode: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsEncoding.unicode & Double = js.native
    
    /* 0 */ val unknown: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsEncoding.unknown & Double = js.native
  }
  ...
  object SmsFilterActionType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsFilterActionType & Double] = js.native
    
    /* 3 */ val accept: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsFilterActionType.accept & Double = js.native
    
    /* 0 */ val acceptImmediately: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsFilterActionType.acceptImmediately & Double = js.native
    
    /* 1 */ val drop: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsFilterActionType.drop & Double = js.native
    
    /* 2 */ val peek: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsFilterActionType.peek & Double = js.native
  }
  ...
  open class SmsFilterRule protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsFilterRule {
    /**
  ...
  open class SmsFilterRules protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsFilterRules {
    /**
    ...
    /* CompleteClass */
    var rules: IVector[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsFilterRule] = js.native
  }
  ...
  object SmsGeographicalScope extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsGeographicalScope & Double] = js.native
    
    /* 4 */ val cell: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsGeographicalScope.cell & Double = js.native
    
    /* 1 */ val cellWithImmediateDisplay: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsGeographicalScope.cellWithImmediateDisplay & Double = js.native
    
    /* 2 */ val locationArea: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsGeographicalScope.locationArea & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsGeographicalScope.none & Double = js.native
    
    /* 3 */ val plmn: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsGeographicalScope.plmn & Double = js.native
  }
  ...
  object SmsMessageClass extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageClass & Double] = js.native
    
    /* 1 */ val class0: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageClass.class0 & Double = js.native
    
    /* 2 */ val class1: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageClass.class1 & Double = js.native
    
    /* 3 */ val class2: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageClass.class2 & Double = js.native
    
    /* 4 */ val class3: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageClass.class3 & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageClass.none & Double = js.native
  }
  ...
  object SmsMessageFilter extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageFilter & Double] = js.native
    
    /* 0 */ val all: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageFilter.all & Double = js.native
    
    /* 4 */ val draft: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageFilter.draft & Double = js.native
    
    /* 2 */ val read: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageFilter.read & Double = js.native
    
    /* 3 */ val sent: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageFilter.sent & Double = js.native
    
    /* 1 */ val unread: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageFilter.unread & Double = js.native
  }
  ...
  open class SmsMessageReceivedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageReceivedEventArgs {
    ...
    /* CompleteClass */
    var binaryMessage: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBinaryMessage = js.native
    ...
    /* CompleteClass */
    var textMessage: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsTextMessage = js.native
  }
  ...
  open class SmsMessageReceivedTriggerDetails ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageReceivedTriggerDetails {
    ...
    /* CompleteClass */
    var appMessage: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsAppMessage = js.native
    
    /** When MessageType is Broadcast, the message details for the message. */
    /* CompleteClass */
    var broadcastMessage: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBroadcastMessage = js.native
    ...
    /* CompleteClass */
    var statusMessage: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsStatusMessage = js.native
    
    /** When MessageType is Text, the message details for the message. */
    /* CompleteClass */
    var textMessage: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsTextMessage2 = js.native
    
    /** When MessageType is Voicemail, the message details for the message. */
    /* CompleteClass */
    var voicemailMessage: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsVoicemailMessage = js.native
    
    /** When MessageType is Wap, the message details for the message. */
    /* CompleteClass */
    var wapMessage: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsWapMessage = js.native
  }
  ...
  open class SmsMessageRegistration ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageRegistration
  object SmsMessageRegistration {
    ...
    @js.native
    def allRegistrations: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageRegistration] = js.native
    inline def allRegistrations_=(x: IVectorView[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageRegistration]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("allRegistrations")(x.asInstanceOf[js.Any])
    ...
    /**
      ...
      */
    /* static member */
    inline def register(id: String, filterRules: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsFilterRules): typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageRegistration = (^.asInstanceOf[js.Dynamic].applyDynamic("register")(id.asInstanceOf[js.Any], filterRules.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageRegistration]
  }
  ...
  object SmsMessageType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageType & Double] = js.native
    
    /* 3 */ val app: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageType.app & Double = js.native
    
    /* 0 */ val binary: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageType.binary & Double = js.native
    
    /* 4 */ val broadcast: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageType.broadcast & Double = js.native
    
    /* 6 */ val status: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageType.status & Double = js.native
    
    /* 1 */ val text: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageType.text & Double = js.native
    
    /* 5 */ val voicemail: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageType.voicemail & Double = js.native
    
    /* 2 */ val wap: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsMessageType.wap & Double = js.native
  }
  ...
  object SmsModemErrorCode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode & Double] = js.native
    
    /* 4 */ val deviceFailure: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode.deviceFailure & Double = js.native
    
    /* 7 */ val deviceNotReady: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode.deviceNotReady & Double = js.native
    
    /* 11 */ val fixedDialingNumberRestricted: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode.fixedDialingNumberRestricted & Double = js.native
    
    /* 9 */ val invalidSmscAddress: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode.invalidSmscAddress & Double = js.native
    
    /* 5 */ val messageNotEncodedProperly: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode.messageNotEncodedProperly & Double = js.native
    
    /* 6 */ val messageTooLarge: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode.messageTooLarge & Double = js.native
    
    /* 1 */ val messagingNetworkError: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode.messagingNetworkError & Double = js.native
    
    /* 10 */ val networkFailure: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode.networkFailure & Double = js.native
    
    /* 8 */ val networkNotReady: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode.networkNotReady & Double = js.native
    
    /* 0 */ val other: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode.other & Double = js.native
    
    /* 2 */ val smsOperationNotSupportedByDevice: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode.smsOperationNotSupportedByDevice & Double = js.native
    
    /* 3 */ val smsServiceNotSupportedByNetwork: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsModemErrorCode.smsServiceNotSupportedByNetwork & Double = js.native
  }
  ...
  open class SmsReceivedEventDetails ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsReceivedEventDetails {
  ...
  open class SmsSendMessageResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsSendMessageResult {
  ...
  open class SmsStatusMessage ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsStatusMessage {
  ...
  open class SmsTextMessage ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsTextMessage {
  ...
  object SmsTextMessage {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromBinaryData(format: SmsDataFormat, value: js.Array[Double]): typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsTextMessage = (^.asInstanceOf[js.Dynamic].applyDynamic("fromBinaryData")(format.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsTextMessage]
    ...
    /**
      ...
      */
    /* static member */
    inline def fromBinaryMessage(binaryMessage: typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsBinaryMessage): typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsTextMessage = ^.asInstanceOf[js.Dynamic].applyDynamic("fromBinaryMessage")(binaryMessage.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsTextMessage]
  }
  ...
  open class SmsTextMessage2 ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsTextMessage2 {
  ...
  open class SmsVoicemailMessage ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsVoicemailMessage {
  ...
  open class SmsWapMessage ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Sms.SmsWapMessage {
