...
import typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayColorSpace
import typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayPixelEncoding
import typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayOrientations
import typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayPropertiesEventHandler
import typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale
...
object Display {
  ...
  object Core {
    ...
    object HdmiDisplayColorSpace extends StObject {
      ...
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayColorSpace & Double
          ] = js.native
      
      /* 2 */ val bt2020: typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayColorSpace.bt2020 & Double = js.native
      
      /* 3 */ val bt709: typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayColorSpace.bt709 & Double = js.native
      
      /* 1 */ val rgbFull: typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayColorSpace.rgbFull & Double = js.native
      
      /* 0 */ val rgbLimited: typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayColorSpace.rgbLimited & Double = js.native
    }
    ...
    object HdmiDisplayHdrOption extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayHdrOption & Double
          ] = js.native
      
      /* 3 */ val dolbyVisionLowLatency: typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayHdrOption.dolbyVisionLowLatency & Double = js.native
      
      /* 2 */ val eotf2084: typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayHdrOption.eotf2084 & Double = js.native
      
      /* 1 */ val eotfSdr: typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayHdrOption.eotfSdr & Double = js.native
      
      /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayHdrOption.none & Double = js.native
    }
    ...
    open class HdmiDisplayInformation ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayInformation
    object HdmiDisplayInformation {
      ...
      /* static member */
      inline def getForCurrentView(): typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayInformation = ^.asInstanceOf[js.Dynamic].applyDynamic("getForCurrentView")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayInformation]
    }
    ...
    open class HdmiDisplayMode ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayMode {
      ...
      /* CompleteClass */
      override def isEqual(hdmiDisplayMode: typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayMode): Boolean = js.native
    ...
    object HdmiDisplayPixelEncoding extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayPixelEncoding & Double
          ] = js.native
      
      /* 0 */ val rgb444: typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayPixelEncoding.rgb444 & Double = js.native
      
      /* 3 */ val ycc420: typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayPixelEncoding.ycc420 & Double = js.native
      
      /* 2 */ val ycc422: typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayPixelEncoding.ycc422 & Double = js.native
      
      /* 1 */ val ycc444: typingsJapgolly.winrtUwp.Windows.Graphics.Display.Core.HdmiDisplayPixelEncoding.ycc444 & Double = js.native
    }
  }
  ...
  open class DisplayInformation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayInformation
  object DisplayInformation {
    ...
    inline def addEventListener_displaycontentsinvalidated(
      ...
      listener: TypedEventHandler[typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayInformation, Any]
    ...
    /**
      ...
      */
    /* static member */
    inline def getForCurrentView(): typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayInformation = ^.asInstanceOf[js.Dynamic].applyDynamic("getForCurrentView")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayInformation]
    ...
    @js.native
    def ondisplaycontentsinvalidated: TypedEventHandler[typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayInformation, Any] = js.native
    inline def ondisplaycontentsinvalidated_=(x: TypedEventHandler[typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayInformation, Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ondisplaycontentsinvalidated")(x.asInstanceOf[js.Any])
  ...
  object DisplayOrientations extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayOrientations & Double] = js.native
    
    /* 1 */ val landscape: typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayOrientations.landscape & Double = js.native
    
    /* 3 */ val landscapeFlipped: typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayOrientations.landscapeFlipped & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayOrientations.none & Double = js.native
    
    /* 2 */ val portrait: typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayOrientations.portrait & Double = js.native
    
    /* 4 */ val portraitFlipped: typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayOrientations.portraitFlipped & Double = js.native
  }
  ...
  open class DisplayProperties ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Graphics.Display.DisplayProperties
  ...
  object ResolutionScale extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale & Double] = js.native
    
    /* 0 */ val invalid: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.invalid & Double = js.native
    
    /* 1 */ val scale100Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale100Percent & Double = js.native
    
    /* 2 */ val scale120Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale120Percent & Double = js.native
    
    /* 3 */ val scale125Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale125Percent & Double = js.native
    
    /* 4 */ val scale140Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale140Percent & Double = js.native
    
    /* 5 */ val scale150Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale150Percent & Double = js.native
    
    /* 6 */ val scale160Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale160Percent & Double = js.native
    
    /* 7 */ val scale175Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale175Percent & Double = js.native
    
    /* 8 */ val scale180Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale180Percent & Double = js.native
    
    /* 9 */ val scale200Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale200Percent & Double = js.native
    
    /* 10 */ val scale225Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale225Percent & Double = js.native
    
    /* 11 */ val scale250Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale250Percent & Double = js.native
    
    /* 12 */ val scale300Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale300Percent & Double = js.native
    
    /* 13 */ val scale350Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale350Percent & Double = js.native
    
    /* 14 */ val scale400Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale400Percent & Double = js.native
    
    /* 15 */ val scale450Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale450Percent & Double = js.native
    
    /* 16 */ val scale500Percent: typingsJapgolly.winrtUwp.Windows.Graphics.Display.ResolutionScale.scale500Percent & Double = js.native
  }
}
