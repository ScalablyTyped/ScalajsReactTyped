...
open class EmailMailboxChange ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxChange {
  ...
  /* CompleteClass */
  var changeType: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxChangeType = js.native
  ...
  /* CompleteClass */
  var mailboxActions: IVector[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMailboxAction] = js.native
  
  /** Gets the message to which the change applies. */
  /* CompleteClass */
  var message: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMessage = js.native
}
