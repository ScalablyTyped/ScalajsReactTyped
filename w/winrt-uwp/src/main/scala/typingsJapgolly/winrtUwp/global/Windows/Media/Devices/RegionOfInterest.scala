...
open class RegionOfInterest ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Devices.RegionOfInterest {
  ...
  /* CompleteClass */
  var `type`: typingsJapgolly.winrtUwp.Windows.Media.Devices.RegionOfInterestType = js.native
