...
import typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationStatus
import typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType
import typingsJapgolly.winrtUwp.Windows.Storage.Streams.IBuffer
import typingsJapgolly.winrtUwp.Windows.Storage.Streams.IInputStream
import typingsJapgolly.winrtUwp.Windows.Web.Http.HttpClient
...
object Streaming {
  ...
  object Adaptive {
    ...
    open class AdaptiveMediaSource ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSource
    object AdaptiveMediaSource {
      ...
      inline def createFromStreamAsync(stream: IInputStream, uri: Uri, contentType: String): IPromiseWithIAsyncOperation[
            typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationResult
    ...
    open class AdaptiveMediaSourceAdvancedSettings ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceAdvancedSettings {
    ...
    open class AdaptiveMediaSourceCreationResult ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationResult {
      ...
      /* CompleteClass */
      var mediaSource: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSource = js.native
    ...
    object AdaptiveMediaSourceCreationStatus extends StObject {
      ...
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationStatus & Double
          ] = js.native
      
      /* 1 */ val manifestDownloadFailure: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationStatus.manifestDownloadFailure & Double = js.native
      
      /* 2 */ val manifestParseFailure: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationStatus.manifestParseFailure & Double = js.native
      
      /* 0 */ val success: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationStatus.success & Double = js.native
      
      /* 6 */ val unknownFailure: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationStatus.unknownFailure & Double = js.native
      
      /* 3 */ val unsupportedManifestContentType: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationStatus.unsupportedManifestContentType & Double = js.native
      
      /* 5 */ val unsupportedManifestProfile: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationStatus.unsupportedManifestProfile & Double = js.native
      
      /* 4 */ val unsupportedManifestVersion: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceCreationStatus.unsupportedManifestVersion & Double = js.native
    }
    ...
    open class AdaptiveMediaSourceDownloadBitrateChangedEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceDownloadBitrateChangedEventArgs {
    ...
    open class AdaptiveMediaSourceDownloadCompletedEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceDownloadCompletedEventArgs {
    ...
    open class AdaptiveMediaSourceDownloadFailedEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceDownloadFailedEventArgs {
    ...
    open class AdaptiveMediaSourceDownloadRequestedDeferral ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceDownloadRequestedDeferral {
    ...
    open class AdaptiveMediaSourceDownloadRequestedEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceDownloadRequestedEventArgs {
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def getDeferral(): typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceDownloadRequestedDeferral = js.native
      ...
      /* CompleteClass */
      var result: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceDownloadResult = js.native
    }
    ...
    open class AdaptiveMediaSourceDownloadResult ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceDownloadResult {
    ...
    open class AdaptiveMediaSourcePlaybackBitrateChangedEventArgs ()
      extends StObject
         with typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourcePlaybackBitrateChangedEventArgs {
    ...
    object AdaptiveMediaSourceResourceType extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[
            typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType & Double
          ] = js.native
      
      /* 1 */ val initializationSegment: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType.initializationSegment & Double = js.native
      
      /* 4 */ val initializationVector: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType.initializationVector & Double = js.native
      
      /* 3 */ val key: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType.key & Double = js.native
      
      /* 0 */ val manifest: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType.manifest & Double = js.native
      
      /* 2 */ val mediaSegment: typingsJapgolly.winrtUwp.Windows.Media.Streaming.Adaptive.AdaptiveMediaSourceResourceType.mediaSegment & Double = js.native
    }
  }
}
