...
import typingsJapgolly.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentRecurrence
...
open class EmailMeetingInfo ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Email.EmailMeetingInfo {
