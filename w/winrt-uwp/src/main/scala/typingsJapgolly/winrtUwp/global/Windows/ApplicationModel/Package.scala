...
open class Package ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Package {
  
  /** Gets the packages on which the current package depends. */
  /* CompleteClass */
  var dependencies: IVectorView[typingsJapgolly.winrtUwp.Windows.ApplicationModel.Package] = js.native
  ...
  /* CompleteClass */
  var id: typingsJapgolly.winrtUwp.Windows.ApplicationModel.PackageId = js.native
...
object Package {
  ...
  @js.native
  def current: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Package = js.native
  inline def current_=(x: typingsJapgolly.winrtUwp.Windows.ApplicationModel.Package): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("current")(x.asInstanceOf[js.Any])
}
