...
open class FaceDetectedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.FaceDetectedEventArgs {
  
  /** Gets the FaceDetectionEffectFrame associated with a FaceDetected event. */
  /* CompleteClass */
  var resultFrame: typingsJapgolly.winrtUwp.Windows.Media.Core.FaceDetectionEffectFrame = js.native
}
