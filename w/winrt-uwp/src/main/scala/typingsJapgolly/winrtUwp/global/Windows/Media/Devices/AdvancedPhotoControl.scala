...
open class AdvancedPhotoControl ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Devices.AdvancedPhotoControl {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def configure(settings: typingsJapgolly.winrtUwp.Windows.Media.Devices.AdvancedPhotoCaptureSettings): Unit = js.native
  ...
  /* CompleteClass */
  var supportedModes: IVectorView[typingsJapgolly.winrtUwp.Windows.Media.Devices.AdvancedPhotoMode] = js.native
}
