...
open class TimedMetadataTrack protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.TimedMetadataTrack {
  /**
    ...
    */
  def this(id: String, language: String, kind: typingsJapgolly.winrtUwp.Windows.Media.Core.TimedMetadataKind) = this()
}
