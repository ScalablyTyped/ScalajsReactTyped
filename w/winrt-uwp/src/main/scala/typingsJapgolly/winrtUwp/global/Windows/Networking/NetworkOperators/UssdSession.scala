...
open class UssdSession ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.UssdSession {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def sendMessageAndGetReplyAsync(message: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.UssdMessage): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.UssdReply] = js.native
}
object UssdSession {
  ...
  /**
    ...
    */
  /* static member */
  inline def createFromNetworkAccountId(networkAccountId: String): typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.UssdSession = ^.asInstanceOf[js.Dynamic].applyDynamic("createFromNetworkAccountId")(networkAccountId.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.UssdSession]
  ...
  /**
    ...
    */
  /* static member */
  inline def createFromNetworkInterfaceId(networkInterfaceId: String): typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.UssdSession = ^.asInstanceOf[js.Dynamic].applyDynamic("createFromNetworkInterfaceId")(networkInterfaceId.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.UssdSession]
}
