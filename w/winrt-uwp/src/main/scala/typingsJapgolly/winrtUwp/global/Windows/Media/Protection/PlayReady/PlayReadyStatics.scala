...
open class PlayReadyStatics ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyStatics
object PlayReadyStatics {
  ...
  /**
    ...
    */
  /* static member */
  inline def checkSupportedHardware(
    hwdrmFeature: typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.PlayReadyHardwareDRMFeatures
  ): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("checkSupportedHardware")(hwdrmFeature.asInstanceOf[js.Any]).asInstanceOf[Boolean]
