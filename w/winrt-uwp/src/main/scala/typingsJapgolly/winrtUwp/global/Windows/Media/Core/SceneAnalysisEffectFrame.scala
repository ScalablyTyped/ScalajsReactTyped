...
open class SceneAnalysisEffectFrame ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.SceneAnalysisEffectFrame {
  ...
  /* CompleteClass */
  var highDynamicRange: typingsJapgolly.winrtUwp.Windows.Media.Core.HighDynamicRangeOutput = js.native
