...
import typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.INDDownloadEngine
import typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.INDMessenger
import typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.INDStreamParser
...
open class NDClient protected ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Protection.PlayReady.NDClient {
  /**
