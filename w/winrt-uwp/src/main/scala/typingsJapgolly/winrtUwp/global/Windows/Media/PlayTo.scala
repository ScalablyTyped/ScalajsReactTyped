...
import typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionError
import typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionState
...
object PlayTo {
  ...
  open class CurrentTimeChangeRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.CurrentTimeChangeRequestedEventArgs {
  ...
  open class MuteChangeRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.MuteChangeRequestedEventArgs {
  ...
  open class PlayToConnection ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnection
  ...
  object PlayToConnectionError extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionError & Double] = js.native
    
    /* 2 */ val deviceError: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionError.deviceError & Double = js.native
    
    /* 3 */ val deviceLocked: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionError.deviceLocked & Double = js.native
    
    /* 1 */ val deviceNotResponding: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionError.deviceNotResponding & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionError.none & Double = js.native
    
    /* 4 */ val protectedPlaybackFailed: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionError.protectedPlaybackFailed & Double = js.native
  }
  ...
  open class PlayToConnectionErrorEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionErrorEventArgs {
  ...
  object PlayToConnectionState extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionState & Double] = js.native
    
    /* 1 */ val connected: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionState.connected & Double = js.native
    
    /* 0 */ val disconnected: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionState.disconnected & Double = js.native
    
    /* 2 */ val rendering: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionState.rendering & Double = js.native
  }
  ...
  open class PlayToConnectionStateChangedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionStateChangedEventArgs {
  ...
  open class PlayToConnectionTransferredEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnectionTransferredEventArgs {
    
    /** Gets the current Play To source that a connection was transferred to. */
    /* CompleteClass */
    var currentSource: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToSource = js.native
    
    /** Gets the previous Play To source that a connection was transferred from. */
    /* CompleteClass */
    var previousSource: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToSource = js.native
  }
  ...
  open class PlayToManager ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToManager
  object PlayToManager {
    ...
    /**
      ...
      */
    /* static member */
    inline def getForCurrentView(): typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToManager = ^.asInstanceOf[js.Dynamic].applyDynamic("getForCurrentView")().asInstanceOf[typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToManager]
  ...
  open class PlayToReceiver ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToReceiver
  ...
  open class PlayToSource ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToSource {
    
    /** Gets the connection to the Play To target. */
    /* CompleteClass */
    var connection: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToConnection = js.native
    
    /** Gets or sets the next Play To source element. */
    /* CompleteClass */
    var next: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToSource = js.native
  ...
  open class PlayToSourceDeferral ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToSourceDeferral {
  ...
  open class PlayToSourceRequest ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToSourceRequest {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getDeferral(): typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToSourceDeferral = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def setSource(value: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToSource): Unit = js.native
  }
  ...
  open class PlayToSourceRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToSourceRequestedEventArgs {
    
    /** Gets the media object to connect to a Play To target. */
    /* CompleteClass */
    var sourceRequest: typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToSourceRequest = js.native
  }
  ...
  open class PlayToSourceSelectedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlayToSourceSelectedEventArgs {
  ...
  open class PlaybackRateChangeRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.PlaybackRateChangeRequestedEventArgs {
  ...
  open class SourceChangeRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.SourceChangeRequestedEventArgs {
  ...
  open class VolumeChangeRequestedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.PlayTo.VolumeChangeRequestedEventArgs {
