...
open class MobileBroadbandModemConfiguration ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandModemConfiguration {
  ...
  /* CompleteClass */
  var uicc: typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandUicc = js.native
}
