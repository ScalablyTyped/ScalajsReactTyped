...
/* note: abstract class */ @JSGlobal("Windows.ApplicationModel.Activation.ContactMessageActivatedEventArgs")
@js.native
open class ContactMessageActivatedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.ApplicationModel.Activation.ContactMessageActivatedEventArgs {
