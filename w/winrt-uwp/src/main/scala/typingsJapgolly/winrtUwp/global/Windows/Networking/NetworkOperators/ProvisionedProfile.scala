...
import typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.ProfileUsage
...
open class ProvisionedProfile ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Networking.NetworkOperators.ProvisionedProfile {
