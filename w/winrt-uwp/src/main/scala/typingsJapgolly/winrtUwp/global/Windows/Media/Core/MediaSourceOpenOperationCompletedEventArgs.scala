...
open class MediaSourceOpenOperationCompletedEventArgs ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Core.MediaSourceOpenOperationCompletedEventArgs {
  
  /** Represents the error that occurred while asynchronously opening the MediaSource . */
  /* CompleteClass */
  var error: typingsJapgolly.winrtUwp.Windows.Media.Core.MediaSourceError = js.native
}
