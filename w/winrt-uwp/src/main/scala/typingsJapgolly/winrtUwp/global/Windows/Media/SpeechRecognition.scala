...
import typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.ISpeechRecognitionConstraint
import typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionAudioProblem
import typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConfidence
import typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintProbability
import typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintType
import typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus
import typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionScenario
import typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognizerState
...
object SpeechRecognition {
  ...
  open class SpeechContinuousRecognitionCompletedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechContinuousRecognitionCompletedEventArgs {
  ...
  object SpeechContinuousRecognitionMode extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechContinuousRecognitionMode & Double
      ] = js.native
    
    /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechContinuousRecognitionMode.default & Double = js.native
    
    /* 1 */ val pauseOnRecognition: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechContinuousRecognitionMode.pauseOnRecognition & Double = js.native
  }
  ...
  open class SpeechContinuousRecognitionResultGeneratedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechContinuousRecognitionResultGeneratedEventArgs {
    ...
    /* CompleteClass */
    var result: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResult = js.native
  }
  ...
  open class SpeechContinuousRecognitionSession ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechContinuousRecognitionSession
  ...
  object SpeechRecognitionAudioProblem extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionAudioProblem & Double
      ] = js.native
    
    /* 2 */ val noSignal: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionAudioProblem.noSignal & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionAudioProblem.none & Double = js.native
    
    /* 5 */ val tooFast: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionAudioProblem.tooFast & Double = js.native
    
    /* 3 */ val tooLoud: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionAudioProblem.tooLoud & Double = js.native
    
    /* 1 */ val tooNoisy: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionAudioProblem.tooNoisy & Double = js.native
    
    /* 4 */ val tooQuiet: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionAudioProblem.tooQuiet & Double = js.native
    
    /* 6 */ val tooSlow: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionAudioProblem.tooSlow & Double = js.native
  }
  ...
  open class SpeechRecognitionCompilationResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionCompilationResult {
  ...
  object SpeechRecognitionConfidence extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConfidence & Double
      ] = js.native
    
    /* 0 */ val high: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConfidence.high & Double = js.native
    
    /* 2 */ val low: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConfidence.low & Double = js.native
    
    /* 1 */ val medium: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConfidence.medium & Double = js.native
    
    /* 3 */ val rejected: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConfidence.rejected & Double = js.native
  }
  ...
  object SpeechRecognitionConstraintProbability extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintProbability & Double
      ] = js.native
    
    /* 0 */ val default: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintProbability.default & Double = js.native
    
    /* 2 */ val max: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintProbability.max & Double = js.native
    
    /* 1 */ val min: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintProbability.min & Double = js.native
  }
  ...
  object SpeechRecognitionConstraintType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintType & Double
      ] = js.native
    
    /* 2 */ val grammar: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintType.grammar & Double = js.native
    
    /* 1 */ val list: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintType.list & Double = js.native
    
    /* 0 */ val topic: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintType.topic & Double = js.native
    
    /* 3 */ val voiceCommandDefinition: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionConstraintType.voiceCommandDefinition & Double = js.native
  }
  ...
  open class SpeechRecognitionGrammarFileConstraint protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionGrammarFileConstraint {
    /**
  ...
  open class SpeechRecognitionHypothesis ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionHypothesis {
  ...
  open class SpeechRecognitionHypothesisGeneratedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionHypothesisGeneratedEventArgs {
    
    /** Gets a recognition result fragment returned by the speech recognizer during an ongoing dictation session. */
    /* CompleteClass */
    var hypothesis: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionHypothesis = js.native
  }
  ...
  open class SpeechRecognitionListConstraint protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionListConstraint {
    /**
  ...
  open class SpeechRecognitionQualityDegradingEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionQualityDegradingEventArgs {
  ...
  open class SpeechRecognitionResult ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResult {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getAlternates(maxAlternates: Double): IVectorView[typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResult] = js.native
    ...
    /* CompleteClass */
    var semanticInterpretation: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionSemanticInterpretation = js.native
  ...
  object SpeechRecognitionResultStatus extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus & Double
      ] = js.native
    
    /* 4 */ val audioQualityFailure: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus.audioQualityFailure & Double = js.native
    
    /* 3 */ val grammarCompilationFailure: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus.grammarCompilationFailure & Double = js.native
    
    /* 2 */ val grammarLanguageMismatch: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus.grammarLanguageMismatch & Double = js.native
    
    /* 10 */ val microphoneUnavailable: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus.microphoneUnavailable & Double = js.native
    
    /* 9 */ val networkFailure: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus.networkFailure & Double = js.native
    
    /* 8 */ val pauseLimitExceeded: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus.pauseLimitExceeded & Double = js.native
    
    /* 0 */ val success: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus.success & Double = js.native
    
    /* 7 */ val timeoutExceeded: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus.timeoutExceeded & Double = js.native
    
    /* 1 */ val topicLanguageNotSupported: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus.topicLanguageNotSupported & Double = js.native
    
    /* 6 */ val unknown: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus.unknown & Double = js.native
    
    /* 5 */ val userCanceled: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionResultStatus.userCanceled & Double = js.native
  }
  ...
  object SpeechRecognitionScenario extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionScenario & Double
      ] = js.native
    
    /* 1 */ val dictation: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionScenario.dictation & Double = js.native
    
    /* 2 */ val formFilling: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionScenario.formFilling & Double = js.native
    
    /* 0 */ val webSearch: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionScenario.webSearch & Double = js.native
  }
  ...
  open class SpeechRecognitionSemanticInterpretation ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionSemanticInterpretation {
  ...
  open class SpeechRecognitionTopicConstraint protected ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionTopicConstraint {
    /**
  ...
  open class SpeechRecognitionVoiceCommandDefinitionConstraint ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognitionVoiceCommandDefinitionConstraint {
  ...
  open class SpeechRecognizer ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognizer {
    /**
  ...
  object SpeechRecognizerState extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognizerState & Double
      ] = js.native
    
    /* 1 */ val capturing: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognizerState.capturing & Double = js.native
    
    /* 0 */ val idle: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognizerState.idle & Double = js.native
    
    /* 6 */ val paused: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognizerState.paused & Double = js.native
    
    /* 2 */ val processing: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognizerState.processing & Double = js.native
    
    /* 4 */ val soundEnded: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognizerState.soundEnded & Double = js.native
    
    /* 3 */ val soundStarted: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognizerState.soundStarted & Double = js.native
    
    /* 5 */ val speechDetected: typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognizerState.speechDetected & Double = js.native
  }
  ...
  open class SpeechRecognizerStateChangedEventArgs ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognizerStateChangedEventArgs {
  ...
  open class SpeechRecognizerTimeouts ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognizerTimeouts {
  ...
  open class SpeechRecognizerUIOptions ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Media.SpeechRecognition.SpeechRecognizerUIOptions {
