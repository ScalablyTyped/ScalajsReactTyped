...
import typingsJapgolly.winrtUwp.Windows.UI.WebUI.ActivatedEventHandler
import typingsJapgolly.winrtUwp.Windows.UI.WebUI.NavigatedEventHandler
import typingsJapgolly.winrtUwp.Windows.UI.WebUI.ResumingEventHandler
import typingsJapgolly.winrtUwp.Windows.UI.WebUI.SuspendingEventHandler
...
open class WebUIApplication ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.UI.WebUI.WebUIApplication
