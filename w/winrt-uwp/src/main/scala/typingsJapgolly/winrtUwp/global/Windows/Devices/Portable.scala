...
import typingsJapgolly.winrtUwp.Windows.Devices.Portable.ServiceDeviceType
...
object Portable {
  ...
  open class ServiceDevice ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Portable.ServiceDevice
  ...
  object ServiceDeviceType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.winrtUwp.Windows.Devices.Portable.ServiceDeviceType & Double] = js.native
    
    /* 0 */ val calendarService: typingsJapgolly.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.calendarService & Double = js.native
    
    /* 1 */ val contactsService: typingsJapgolly.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.contactsService & Double = js.native
    
    /* 2 */ val deviceStatusService: typingsJapgolly.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.deviceStatusService & Double = js.native
    
    /* 3 */ val notesService: typingsJapgolly.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.notesService & Double = js.native
    
    /* 4 */ val ringtonesService: typingsJapgolly.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.ringtonesService & Double = js.native
    
    /* 5 */ val smsService: typingsJapgolly.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.smsService & Double = js.native
    
    /* 6 */ val tasksService: typingsJapgolly.winrtUwp.Windows.Devices.Portable.ServiceDeviceType.tasksService & Double = js.native
  }
  ...
  open class StorageDevice ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Portable.StorageDevice
