...
open class ClaimedReceiptPrinter ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.ClaimedReceiptPrinter {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createJob(): typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.ReceiptPrintJob = js.native
