...
object Power {
  ...
  open class Battery ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Power.Battery
  object Battery {
    ...
    @js.native
    def aggregateBattery: typingsJapgolly.winrtUwp.Windows.Devices.Power.Battery = js.native
    inline def aggregateBattery_=(x: typingsJapgolly.winrtUwp.Windows.Devices.Power.Battery): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("aggregateBattery")(x.asInstanceOf[js.Any])
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIdAsync(deviceId: String): IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Power.Battery] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIdAsync")(deviceId.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typingsJapgolly.winrtUwp.Windows.Devices.Power.Battery]]
  ...
  open class BatteryReport ()
    extends StObject
       with typingsJapgolly.winrtUwp.Windows.Devices.Power.BatteryReport {
