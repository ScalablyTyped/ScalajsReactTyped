...
open class RevocationAndRenewalItem ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Media.Protection.RevocationAndRenewalItem {
  ...
  /* CompleteClass */
  var reasons: typingsJapgolly.winrtUwp.Windows.Media.Protection.RevocationAndRenewalReasons = js.native
