...
open class CompassReading ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.Sensors.CompassReading {
  
  /** Gets the compass's heading accuracy. */
  /* CompleteClass */
  var headingAccuracy: typingsJapgolly.winrtUwp.Windows.Devices.Sensors.MagnetometerAccuracy = js.native
