...
open class MagneticStripeReaderCapabilities ()
  extends StObject
     with typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReaderCapabilities {
  
  /** Gets the authentication level supported by the device. */
  /* CompleteClass */
  var authenticationLevel: typingsJapgolly.winrtUwp.Windows.Devices.PointOfService.MagneticStripeReaderAuthenticationLevel = js.native
