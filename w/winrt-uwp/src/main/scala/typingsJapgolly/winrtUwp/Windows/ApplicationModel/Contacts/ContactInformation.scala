...
object ContactInformation {
  ...
  inline def apply(
    ...
    getThumbnailAsync: CallbackTo[IPromiseWithIAsyncOperation[IRandomAccessStreamWithContentType]],
  ...
  extension [Self <: ContactInformation](x: Self) {
    ...
    inline def setGetThumbnailAsync(value: CallbackTo[IPromiseWithIAsyncOperation[IRandomAccessStreamWithContentType]]): Self = StObject.set(x, "getThumbnailAsync", value.toJsFn)
