...
import typingsJapgolly.winrtUwp.Windows.Storage.Search.IndexedState
import typingsJapgolly.winrtUwp.Windows.Storage.Search.QueryOptions
import typingsJapgolly.winrtUwp.Windows.Storage.Search.StorageFileQueryResult
import typingsJapgolly.winrtUwp.Windows.Storage.Search.StorageFolderQueryResult
import typingsJapgolly.winrtUwp.Windows.Storage.Search.StorageItemQueryResult
