...
object ChatMessageTransport {
  ...
  extension [Self <: ChatMessageTransport](x: Self) {
    ...
    inline def setRequestSetAsNotificationProviderAsync(value: CallbackTo[IPromiseWithIAsyncAction]): Self = StObject.set(x, "requestSetAsNotificationProviderAsync", value.toJsFn)
