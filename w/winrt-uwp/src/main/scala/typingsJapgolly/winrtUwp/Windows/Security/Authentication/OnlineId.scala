package typingsJapgolly.winrtUwp.Windows.Security.Authentication
...
object OnlineId {
  ...
  object UserAuthenticationOperation {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(cancel = cancel.toJsFn, close = close.toJsFn, completed = js.Any.fromFunction2((t0: /* asyncInfo */ IAsyncOperation[UserIdentity], t1: /* asyncStatus */ AsyncStatus) => (completed(t0, t1)).runNow()), errorCode = errorCode.asInstanceOf[js.Any], getResults = getResults.toJsFn, id = id.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
