...
import typingsJapgolly.winrtUwp.anon.ItemsHttpContentCodingWithQualityHeaderValue
...
trait HttpContentCodingWithQualityHeaderValueCollection
  ...
  def indexOf(value: HttpContentCodingWithQualityHeaderValue, extra: Any*): Index = js.native
  /**
