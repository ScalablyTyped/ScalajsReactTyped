...
object Diagnostics {
  ...
  object ProcessCpuUsage {
    ...
    inline def apply(getReport: CallbackTo[ProcessCpuUsageReport]): ProcessCpuUsage = {
      val __obj = js.Dynamic.literal(getReport = getReport.toJsFn)
      __obj.asInstanceOf[ProcessCpuUsage]
    }
    
    extension [Self <: ProcessCpuUsage](x: Self) {
      
      inline def setGetReport(value: CallbackTo[ProcessCpuUsageReport]): Self = StObject.set(x, "getReport", value.toJsFn)
    }
  }
  ...
  object ProcessDiskUsage {
    ...
    inline def apply(getReport: CallbackTo[ProcessDiskUsageReport]): ProcessDiskUsage = {
      val __obj = js.Dynamic.literal(getReport = getReport.toJsFn)
    ...
    extension [Self <: ProcessDiskUsage](x: Self) {
      ...
      inline def setGetReport(value: CallbackTo[ProcessDiskUsageReport]): Self = StObject.set(x, "getReport", value.toJsFn)
    }
  }
  ...
  object ProcessMemoryUsage {
    ...
    inline def apply(getReport: CallbackTo[ProcessMemoryUsageReport]): ProcessMemoryUsage = {
      val __obj = js.Dynamic.literal(getReport = getReport.toJsFn)
    ...
    extension [Self <: ProcessMemoryUsage](x: Self) {
      ...
      inline def setGetReport(value: CallbackTo[ProcessMemoryUsageReport]): Self = StObject.set(x, "getReport", value.toJsFn)
    }
  }
