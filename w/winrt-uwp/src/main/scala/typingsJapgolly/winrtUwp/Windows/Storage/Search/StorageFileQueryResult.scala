...
import typingsJapgolly.winrtUwp.winrtUwpStrings.contentschanged
import typingsJapgolly.winrtUwp.winrtUwpStrings.optionschanged
...
trait StorageFileQueryResult extends StObject {
  ...
  /**
    ...
    * @return When this method completes successfully, it returns a list (type IVectorView ) of files that are represented by storageFile objects.
    */
  def getFilesAsync(startIndex: Double, maxNumberOfItems: Double): IPromiseWithIAsyncOperation[IVectorView[Any]] = js.native
  ...
  /**
    ...
    */
  def getMatchingPropertiesWithRanges(file: StorageFile): IMap[String, IVectorView[Any]] = js.native
