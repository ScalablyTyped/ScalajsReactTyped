package typingsJapgolly.winrtUwp.Windows.ApplicationModel.Store.Preview.InstallControl
...
import typingsJapgolly.winrtUwp.winrtUwpStrings.itemcompleted
import typingsJapgolly.winrtUwp.winrtUwpStrings.itemstatuschanged
