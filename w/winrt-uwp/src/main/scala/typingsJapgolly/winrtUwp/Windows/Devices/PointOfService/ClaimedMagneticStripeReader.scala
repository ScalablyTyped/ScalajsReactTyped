...
import typingsJapgolly.winrtUwp.winrtUwpStrings.aamvacarddatareceived
import typingsJapgolly.winrtUwp.winrtUwpStrings.bankcarddatareceived
...
import typingsJapgolly.winrtUwp.winrtUwpStrings.vendorspecificdatareceived
