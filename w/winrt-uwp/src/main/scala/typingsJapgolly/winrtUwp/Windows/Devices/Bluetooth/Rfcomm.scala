...
object Rfcomm {
  ...
  object RfcommServiceId {
    ...
    inline def apply(asShortId: CallbackTo[Double], asString: CallbackTo[String], uuid: String): RfcommServiceId = {
      val __obj = js.Dynamic.literal(asShortId = asShortId.toJsFn, asString = asString.toJsFn, uuid = uuid.asInstanceOf[js.Any])
      __obj.asInstanceOf[RfcommServiceId]
    }
    
    extension [Self <: RfcommServiceId](x: Self) {
      
      inline def setAsShortId(value: CallbackTo[Double]): Self = StObject.set(x, "asShortId", value.toJsFn)
