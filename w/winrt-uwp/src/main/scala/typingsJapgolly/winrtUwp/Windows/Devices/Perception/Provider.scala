...
object Provider {
  ...
  object IPerceptionFrameProvider {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(available = available.asInstanceOf[js.Any], close = close.toJsFn, frameProviderInfo = frameProviderInfo.asInstanceOf[js.Any], properties = properties.asInstanceOf[js.Any], setProperty = js.Any.fromFunction1((t0: PerceptionPropertyChangeRequest) => setProperty(t0).runNow()), start = start.toJsFn, stop = stop.toJsFn)
    ...
    extension [Self <: IPerceptionFrameProvider](x: Self) {
      ...
      inline def setSetProperty(value: PerceptionPropertyChangeRequest => Callback): Self = StObject.set(x, "setProperty", js.Any.fromFunction1((t0: PerceptionPropertyChangeRequest) => value(t0).runNow()))
  ...
  object IPerceptionFrameProviderManager {
    ...
    inline def apply(close: Callback, getFrameProvider: PerceptionFrameProviderInfo => IPerceptionFrameProvider): IPerceptionFrameProviderManager = {
      val __obj = js.Dynamic.literal(close = close.toJsFn, getFrameProvider = js.Any.fromFunction1(getFrameProvider))
  ...
  object PerceptionPropertyChangeRequest {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getDeferral = getDeferral.toJsFn, name = name.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
  ...
  object PerceptionVideoFrameAllocator {
    ...
    inline def apply(
      allocateFrame: CallbackTo[PerceptionFrame],
      close: Callback,
      copyFromVideoFrame: VideoFrame => PerceptionFrame
    ): PerceptionVideoFrameAllocator = {
      val __obj = js.Dynamic.literal(allocateFrame = allocateFrame.toJsFn, close = close.toJsFn, copyFromVideoFrame = js.Any.fromFunction1(copyFromVideoFrame))
      __obj.asInstanceOf[PerceptionVideoFrameAllocator]
    }
    
    extension [Self <: PerceptionVideoFrameAllocator](x: Self) {
      
      inline def setAllocateFrame(value: CallbackTo[PerceptionFrame]): Self = StObject.set(x, "allocateFrame", value.toJsFn)
