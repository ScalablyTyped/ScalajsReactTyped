...
object WordsSegmenter {
  ...
  inline def apply(
    ...
    tokenize: (String, Double, WordSegmentsTokenizingHandler) => Callback
  ): WordsSegmenter = {
    val __obj = js.Dynamic.literal(getTokenAt = js.Any.fromFunction2(getTokenAt), getTokens = js.Any.fromFunction1(getTokens), resolvedLanguage = resolvedLanguage.asInstanceOf[js.Any], tokenize = js.Any.fromFunction3((t0: String, t1: Double, t2: WordSegmentsTokenizingHandler) => (tokenize(t0, t1, t2)).runNow()))
  ...
  extension [Self <: WordsSegmenter](x: Self) {
    ...
    inline def setTokenize(value: (String, Double, WordSegmentsTokenizingHandler) => Callback): Self = StObject.set(x, "tokenize", js.Any.fromFunction3((t0: String, t1: Double, t2: WordSegmentsTokenizingHandler) => (value(t0, t1, t2)).runNow()))
  }
}
