...
object Printing3D3MFPackage {
  ...
  inline def apply(
    ...
    saveAsync: CallbackTo[IPromiseWithIAsyncOperation[IRandomAccessStream]],
  ...
  extension [Self <: Printing3D3MFPackage](x: Self) {
    ...
    inline def setSaveAsync(value: CallbackTo[IPromiseWithIAsyncOperation[IRandomAccessStream]]): Self = StObject.set(x, "saveAsync", value.toJsFn)
