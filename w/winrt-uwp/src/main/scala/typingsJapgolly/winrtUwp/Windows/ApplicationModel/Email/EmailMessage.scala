...
object EmailMessage {
  ...
  extension [Self <: EmailMessage](x: Self) {
    ...
    inline def setSetBodyStream(value: (EmailMessageBodyKind, IRandomAccessStreamReference) => Callback): Self = StObject.set(x, "setBodyStream", js.Any.fromFunction2((t0: EmailMessageBodyKind, t1: IRandomAccessStreamReference) => (value(t0, t1)).runNow()))
