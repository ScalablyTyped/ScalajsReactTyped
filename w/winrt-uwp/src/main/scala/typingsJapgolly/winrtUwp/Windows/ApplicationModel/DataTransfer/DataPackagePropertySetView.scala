...
object DataPackagePropertySetView {
  ...
  extension [Self <: DataPackagePropertySetView](x: Self) {
    ...
    inline def setSplit(value: CallbackTo[Second]): Self = StObject.set(x, "split", value.toJsFn)
