...
object PackageStatus {
  ...
  extension [Self <: PackageStatus](x: Self) {
    ...
    inline def setVerifyIsOK(value: CallbackTo[Boolean]): Self = StObject.set(x, "verifyIsOK", value.toJsFn)
  }
}
