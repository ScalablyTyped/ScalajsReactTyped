...
object I2c {
  ...
  object I2cDevice {
    ...
    inline def apply(
      ...
      writeRead: (js.Array[Double], js.Array[Double]) => Callback,
      writeReadPartial: (js.Array[Double], js.Array[Double]) => I2cTransferResult
    ): I2cDevice = {
      val __obj = js.Dynamic.literal(close = close.toJsFn, connectionSettings = connectionSettings.asInstanceOf[js.Any], deviceId = deviceId.asInstanceOf[js.Any], read = js.Any.fromFunction1((t0: js.Array[Double]) => read(t0).runNow()), readPartial = js.Any.fromFunction1(readPartial), write = js.Any.fromFunction1((t0: js.Array[Double]) => write(t0).runNow()), writePartial = js.Any.fromFunction1(writePartial), writeRead = js.Any.fromFunction2((t0: js.Array[Double], t1: js.Array[Double]) => (writeRead(t0, t1)).runNow()), writeReadPartial = js.Any.fromFunction2(writeReadPartial))
    ...
    extension [Self <: I2cDevice](x: Self) {
      ...
      inline def setRead(value: js.Array[Double] => Callback): Self = StObject.set(x, "read", js.Any.fromFunction1((t0: js.Array[Double]) => value(t0).runNow()))
      ...
      inline def setWriteRead(value: (js.Array[Double], js.Array[Double]) => Callback): Self = StObject.set(x, "writeRead", js.Any.fromFunction2((t0: js.Array[Double], t1: js.Array[Double]) => (value(t0, t1)).runNow()))
