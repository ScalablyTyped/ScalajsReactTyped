...
object UploadOperation {
  ...
  inline def apply(
    attachAsync: CallbackTo[IPromiseWithIAsyncOperationWithProgress[UploadOperation, UploadOperation]],
  ...
  extension [Self <: UploadOperation](x: Self) {
    ...
    inline def setStartAsync(value: CallbackTo[IPromiseWithIAsyncOperationWithProgress[UploadOperation, UploadOperation]]): Self = StObject.set(x, "startAsync", value.toJsFn)
