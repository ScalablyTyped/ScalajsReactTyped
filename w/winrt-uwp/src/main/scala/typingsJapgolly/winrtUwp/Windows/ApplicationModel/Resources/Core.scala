...
import typingsJapgolly.winrtUwp.anon.FirstSecond
...
import typingsJapgolly.winrtUwp.anon.ItemsResourceCandidate
import typingsJapgolly.winrtUwp.anon.ItemsResourceQualifier
...
object Core {
  ...
  object ResourceCandidate {
    ...
    inline def apply(
      ...
      getValueAsFileAsync: CallbackTo[IPromiseWithIAsyncOperation[StorageFile]],
      getValueAsStreamAsync: CallbackTo[IPromiseWithIAsyncOperation[IRandomAccessStream]],
      isDefault: Boolean,
      isMatch: Boolean,
    ...
    extension [Self <: ResourceCandidate](x: Self) {
      ...
      inline def setGetValueAsFileAsync(value: CallbackTo[IPromiseWithIAsyncOperation[StorageFile]]): Self = StObject.set(x, "getValueAsFileAsync", value.toJsFn)
      
      inline def setGetValueAsStreamAsync(value: CallbackTo[IPromiseWithIAsyncOperation[IRandomAccessStream]]): Self = StObject.set(x, "getValueAsStreamAsync", value.toJsFn)
  ...
  object ResourceMapIterator {
    ...
    inline def apply(
      ...
      getMany: CallbackTo[ItemsIKeyValuePair],
      hasCurrent: Boolean,
    ...
    extension [Self <: ResourceMapIterator](x: Self) {
      ...
      inline def setGetMany(value: CallbackTo[ItemsIKeyValuePair]): Self = StObject.set(x, "getMany", value.toJsFn)
  ...
  object ResourceMapMapView {
    ...
    inline def apply(
      ...
      size: Double,
      split: CallbackTo[FirstIMapView]
    ): ResourceMapMapView = {
    ...
    extension [Self <: ResourceMapMapView](x: Self) {
      ...
      inline def setSplit(value: CallbackTo[FirstIMapView]): Self = StObject.set(x, "split", value.toJsFn)
    }
  }
  ...
  object ResourceQualifierMapView {
    ...
    inline def apply(
      ...
      size: Double,
      split: CallbackTo[SecondIMapView]
    ...
    extension [Self <: ResourceQualifierMapView](x: Self) {
      ...
      inline def setSplit(value: CallbackTo[SecondIMapView]): Self = StObject.set(x, "split", value.toJsFn)
    }
  }
