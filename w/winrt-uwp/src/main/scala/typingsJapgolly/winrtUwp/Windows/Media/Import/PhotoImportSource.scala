...
object PhotoImportSource {
  ...
  inline def apply(
    ...
    createImportSession: CallbackTo[PhotoImportSession],
    dateTime: js.Date,
    description: String,
    displayName: String,
    id: String,
  ...
  extension [Self <: PhotoImportSource](x: Self) {
    ...
    inline def setCreateImportSession(value: CallbackTo[PhotoImportSession]): Self = StObject.set(x, "createImportSession", value.toJsFn)
