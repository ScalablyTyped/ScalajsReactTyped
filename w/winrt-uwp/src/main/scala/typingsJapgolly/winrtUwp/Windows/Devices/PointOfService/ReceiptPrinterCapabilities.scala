...
object ReceiptPrinterCapabilities {
  ...
  extension [Self <: ReceiptPrinterCapabilities](x: Self) {
    ...
    inline def setIsStampSupported(value: Boolean): Self = StObject.set(x, "isStampSupported", value.asInstanceOf[js.Any])
    
    inline def setIsUnderlineSupported(value: Boolean): Self = StObject.set(x, "isUnderlineSupported", value.asInstanceOf[js.Any])
    
    inline def setMarkFeedCapabilities(value: PosPrinterMarkFeedCapabilities): Self = StObject.set(x, "markFeedCapabilities", value.asInstanceOf[js.Any])
