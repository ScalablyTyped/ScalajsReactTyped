...
object VideoDeviceController {
  ...
  inline def apply(
    ...
    tryGetPowerlineFrequency: CallbackTo[ReturnValueBoolean],
  ...
  extension [Self <: VideoDeviceController](x: Self) {
    ...
    inline def setTryGetPowerlineFrequency(value: CallbackTo[ReturnValueBoolean]): Self = StObject.set(x, "tryGetPowerlineFrequency", value.toJsFn)
