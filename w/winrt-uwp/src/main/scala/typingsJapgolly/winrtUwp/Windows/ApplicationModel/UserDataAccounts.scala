...
object UserDataAccounts {
  ...
  object UserDataAccount {
    ...
    inline def apply(
      ...
      deviceAccountTypeId: String,
      enterpriseId: String,
      findAppointmentCalendarsAsync: CallbackTo[IPromiseWithIAsyncOperation[IVectorView[Any]]],
      findContactAnnotationListsAsync: CallbackTo[IPromiseWithIAsyncOperation[IVectorView[Any]]],
      findContactListsAsync: CallbackTo[IPromiseWithIAsyncOperation[IVectorView[Any]]],
      findEmailMailboxesAsync: CallbackTo[IPromiseWithIAsyncOperation[IVectorView[Any]]],
      ...
      val __obj = js.Dynamic.literal(deleteAsync = deleteAsync.toJsFn, deviceAccountTypeId = deviceAccountTypeId.asInstanceOf[js.Any], enterpriseId = enterpriseId.asInstanceOf[js.Any], findAppointmentCalendarsAsync = findAppointmentCalendarsAsync.toJsFn, findContactAnnotationListsAsync = findContactAnnotationListsAsync.toJsFn, findContactListsAsync = findContactListsAsync.toJsFn, findEmailMailboxesAsync = findEmailMailboxesAsync.toJsFn, icon = icon.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], isProtectedUnderLock = isProtectedUnderLock.asInstanceOf[js.Any], otherAppReadAccess = otherAppReadAccess.asInstanceOf[js.Any], packageFamilyName = packageFamilyName.asInstanceOf[js.Any], saveAsync = saveAsync.toJsFn, userDisplayName = userDisplayName.asInstanceOf[js.Any])
    ...
    extension [Self <: UserDataAccount](x: Self) {
      ...
      inline def setFindAppointmentCalendarsAsync(value: CallbackTo[IPromiseWithIAsyncOperation[IVectorView[Any]]]): Self = StObject.set(x, "findAppointmentCalendarsAsync", value.toJsFn)
      
      inline def setFindContactAnnotationListsAsync(value: CallbackTo[IPromiseWithIAsyncOperation[IVectorView[Any]]]): Self = StObject.set(x, "findContactAnnotationListsAsync", value.toJsFn)
      
      inline def setFindContactListsAsync(value: CallbackTo[IPromiseWithIAsyncOperation[IVectorView[Any]]]): Self = StObject.set(x, "findContactListsAsync", value.toJsFn)
      
      inline def setFindEmailMailboxesAsync(value: CallbackTo[IPromiseWithIAsyncOperation[IVectorView[Any]]]): Self = StObject.set(x, "findEmailMailboxesAsync", value.toJsFn)
  ...
  object UserDataAccountStore {
    ...
    inline def apply(
      ...
      findAccountsAsync: CallbackTo[IPromiseWithIAsyncOperation[IVectorView[Any]]],
      getAccountAsync: String => IPromiseWithIAsyncOperation[UserDataAccount]
    ): UserDataAccountStore = {
      val __obj = js.Dynamic.literal(createAccountAsync = js.Any.fromFunction1(createAccountAsync), findAccountsAsync = findAccountsAsync.toJsFn, getAccountAsync = js.Any.fromFunction1(getAccountAsync))
    ...
    extension [Self <: UserDataAccountStore](x: Self) {
      ...
      inline def setFindAccountsAsync(value: CallbackTo[IPromiseWithIAsyncOperation[IVectorView[Any]]]): Self = StObject.set(x, "findAccountsAsync", value.toJsFn)
