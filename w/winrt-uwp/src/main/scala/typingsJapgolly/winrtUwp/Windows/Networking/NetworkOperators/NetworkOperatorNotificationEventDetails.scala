...
object NetworkOperatorNotificationEventDetails {
  ...
  inline def apply(
    authorizeTethering: (Boolean, String) => Callback,
    encodingType: Double,
    message: String,
