...
import typingsJapgolly.winrtUwp.Windows.Storage.FileAttributes
...
import typingsJapgolly.winrtUwp.Windows.Storage.FileProperties.StorageItemContentProperties
...
import typingsJapgolly.winrtUwp.Windows.Storage.StorageDeleteOption
import typingsJapgolly.winrtUwp.Windows.Storage.StorageFile
import typingsJapgolly.winrtUwp.Windows.Storage.StorageFolder
import typingsJapgolly.winrtUwp.Windows.Storage.StorageItemTypes
import typingsJapgolly.winrtUwp.Windows.Storage.StorageOpenOptions
import typingsJapgolly.winrtUwp.Windows.Storage.StorageProvider
import typingsJapgolly.winrtUwp.Windows.Storage.StorageStreamTransaction
...
import typingsJapgolly.winrtUwp.winrtUwpStrings.propertiesupdated
import typingsJapgolly.winrtUwp.winrtUwpStrings.thumbnailupdated
