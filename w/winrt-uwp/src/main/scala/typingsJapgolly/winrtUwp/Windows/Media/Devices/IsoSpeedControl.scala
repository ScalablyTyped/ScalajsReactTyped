...
object IsoSpeedControl {
  ...
  inline def apply(
    ...
    setAutoAsync: CallbackTo[IPromiseWithIAsyncAction],
  ...
  extension [Self <: IsoSpeedControl](x: Self) {
    ...
    inline def setSetAutoAsync(value: CallbackTo[IPromiseWithIAsyncAction]): Self = StObject.set(x, "setAutoAsync", value.toJsFn)
