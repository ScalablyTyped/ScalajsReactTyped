...
import typingsJapgolly.winrtUwp.Windows.Web.Http.Headers.HttpResponseHeaderCollection
...
object HttpResponseMessage {
  ...
  inline def apply(
    ...
    ensureSuccessStatusCode: CallbackTo[HttpResponseMessage],
  ...
  extension [Self <: HttpResponseMessage](x: Self) {
    ...
    inline def setEnsureSuccessStatusCode(value: CallbackTo[HttpResponseMessage]): Self = StObject.set(x, "ensureSuccessStatusCode", value.toJsFn)
