...
import typingsJapgolly.winrtUwp.winrtUwpStrings.recentenergyusageincreased
import typingsJapgolly.winrtUwp.winrtUwpStrings.recentenergyusagereturnedtolow
