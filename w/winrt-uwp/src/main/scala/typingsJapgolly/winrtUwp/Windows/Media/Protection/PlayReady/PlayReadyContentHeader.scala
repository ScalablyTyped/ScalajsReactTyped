...
object PlayReadyContentHeader {
  ...
  inline def apply(
    ...
    getSerializedHeader: CallbackTo[js.Array[Double]],
  ...
  extension [Self <: PlayReadyContentHeader](x: Self) {
    ...
    inline def setGetSerializedHeader(value: CallbackTo[js.Array[Double]]): Self = StObject.set(x, "getSerializedHeader", value.toJsFn)
