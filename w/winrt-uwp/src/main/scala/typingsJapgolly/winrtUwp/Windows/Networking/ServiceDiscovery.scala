...
import typingsJapgolly.winrtUwp.AnonItemsDnssdServiceInstance
...
object ServiceDiscovery extends js.Object {
  ...
  object Dnssd extends js.Object {
    ...
    object DnssdServiceWatcherStatus extends js.Object {
      ...
      object stopped
        extends TopLevel[
                  typingsJapgolly.winrtUwp.Windows.Networking.ServiceDiscovery.Dnssd.DnssdServiceWatcherStatus.stopped with Double
                ]
