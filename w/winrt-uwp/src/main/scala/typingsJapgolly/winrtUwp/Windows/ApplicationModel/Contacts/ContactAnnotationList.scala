...
object ContactAnnotationList {
  ...
  inline def apply(
    ...
    deleteAsync: CallbackTo[IPromiseWithIAsyncAction],
    findAnnotationsAsync: CallbackTo[IPromiseWithIAsyncOperation[IVectorView[Any]]],
  ...
  extension [Self <: ContactAnnotationList](x: Self) {
    ...
    inline def setDeleteAsync(value: CallbackTo[IPromiseWithIAsyncAction]): Self = StObject.set(x, "deleteAsync", value.toJsFn)
    
    inline def setFindAnnotationsAsync(value: CallbackTo[IPromiseWithIAsyncOperation[IVectorView[Any]]]): Self = StObject.set(x, "findAnnotationsAsync", value.toJsFn)
