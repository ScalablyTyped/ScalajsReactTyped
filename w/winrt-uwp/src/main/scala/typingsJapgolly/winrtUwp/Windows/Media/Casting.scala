...
import typingsJapgolly.winrtUwp.winrtUwpStrings.castingdevicepickerdismissed
import typingsJapgolly.winrtUwp.winrtUwpStrings.castingdeviceselected
...
object Casting {
  ...
  object CastingDevice {
    ...
    inline def apply(
      createCastingConnection: CallbackTo[CastingConnection],
      friendlyName: String,
      getSupportedCastingPlaybackTypesAsync: CallbackTo[IPromiseWithIAsyncOperation[CastingPlaybackTypes]],
      icon: IRandomAccessStreamWithContentType,
      id: String
    ): CastingDevice = {
      val __obj = js.Dynamic.literal(createCastingConnection = createCastingConnection.toJsFn, friendlyName = friendlyName.asInstanceOf[js.Any], getSupportedCastingPlaybackTypesAsync = getSupportedCastingPlaybackTypesAsync.toJsFn, icon = icon.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[CastingDevice]
    }
    
    extension [Self <: CastingDevice](x: Self) {
      
      inline def setCreateCastingConnection(value: CallbackTo[CastingConnection]): Self = StObject.set(x, "createCastingConnection", value.toJsFn)
      
      inline def setFriendlyName(value: String): Self = StObject.set(x, "friendlyName", value.asInstanceOf[js.Any])
      
      inline def setGetSupportedCastingPlaybackTypesAsync(value: CallbackTo[IPromiseWithIAsyncOperation[CastingPlaybackTypes]]): Self = StObject.set(x, "getSupportedCastingPlaybackTypesAsync", value.toJsFn)
