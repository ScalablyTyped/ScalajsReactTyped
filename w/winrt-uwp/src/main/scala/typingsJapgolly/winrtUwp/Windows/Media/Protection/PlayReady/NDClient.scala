...
import typingsJapgolly.winrtUwp.winrtUwpStrings.closedcaptiondatareceived
import typingsJapgolly.winrtUwp.winrtUwpStrings.licensefetchcompleted
import typingsJapgolly.winrtUwp.winrtUwpStrings.proximitydetectioncompleted
import typingsJapgolly.winrtUwp.winrtUwpStrings.registrationcompleted
import typingsJapgolly.winrtUwp.winrtUwpStrings.reregistrationneeded
