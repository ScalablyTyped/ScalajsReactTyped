...
import typingsJapgolly.winrtUwp.winrtUwpStrings.advertisementstatuschanged
import typingsJapgolly.winrtUwp.winrtUwpStrings.autoacceptsessionconnected
import typingsJapgolly.winrtUwp.winrtUwpStrings.sessionrequested
...
trait WiFiDirectServiceAdvertiser extends StObject {
  ...
  def addEventListener_advertisementstatuschanged(`type`: advertisementstatuschanged, listener: TypedEventHandler[WiFiDirectServiceAdvertiser, Any]): Unit = js.native
  @JSName("addEventListener")
  ...
  def onadvertisementstatuschanged(ev: Any & WinRTEvent[WiFiDirectServiceAdvertiser]): Unit = js.native
  /** Event raised when the AdvertisementStatus property value changes. */
  @JSName("onadvertisementstatuschanged")
  var onadvertisementstatuschanged_Original: TypedEventHandler[WiFiDirectServiceAdvertiser, Any] = js.native
  ...
  def removeEventListener_advertisementstatuschanged(`type`: advertisementstatuschanged, listener: TypedEventHandler[WiFiDirectServiceAdvertiser, Any]): Unit = js.native
  @JSName("removeEventListener")
