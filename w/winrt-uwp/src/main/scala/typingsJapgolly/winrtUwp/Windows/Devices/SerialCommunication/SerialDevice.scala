package typingsJapgolly.winrtUwp.Windows.Devices.SerialCommunication
...
import typingsJapgolly.winrtUwp.winrtUwpStrings.errorreceived
import typingsJapgolly.winrtUwp.winrtUwpStrings.pinchanged
