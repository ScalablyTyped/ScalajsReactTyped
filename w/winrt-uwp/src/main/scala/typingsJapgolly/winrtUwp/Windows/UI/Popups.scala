...
object Popups {
  ...
  object MessageDialog {
    ...
    inline def apply(
      ...
      showAsync: CallbackTo[IPromiseWithIAsyncOperation[IUICommand]],
      title: String
    ): MessageDialog = {
    ...
    extension [Self <: MessageDialog](x: Self) {
      ...
      inline def setShowAsync(value: CallbackTo[IPromiseWithIAsyncOperation[IUICommand]]): Self = StObject.set(x, "showAsync", value.toJsFn)
