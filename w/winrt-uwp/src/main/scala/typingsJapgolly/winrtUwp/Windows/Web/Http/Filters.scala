...
object Filters {
  ...
  object IHttpFilter {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(close = close.toJsFn, sendRequestAsync = js.Any.fromFunction1(sendRequestAsync))
