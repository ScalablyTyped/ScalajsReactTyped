...
import typingsJapgolly.winrtUwp.Windows.Media.Capture.Core.VariablePhotoSequenceCapture
import typingsJapgolly.winrtUwp.Windows.Media.Devices.AudioDeviceController
import typingsJapgolly.winrtUwp.Windows.Media.Devices.CameraStreamState
...
import typingsJapgolly.winrtUwp.Windows.Media.IMediaExtension
import typingsJapgolly.winrtUwp.Windows.Media.MediaProperties.IMediaEncodingProperties
import typingsJapgolly.winrtUwp.Windows.Media.MediaProperties.ImageEncodingProperties
import typingsJapgolly.winrtUwp.Windows.Media.MediaProperties.MediaEncodingProfile
import typingsJapgolly.winrtUwp.Windows.Media.MediaProperties.MediaPropertySet
...
import typingsJapgolly.winrtUwp.winrtUwpStrings.camerastreamstatechanged
import typingsJapgolly.winrtUwp.winrtUwpStrings.failed
import typingsJapgolly.winrtUwp.winrtUwpStrings.focuschanged
import typingsJapgolly.winrtUwp.winrtUwpStrings.photoconfirmationcaptured
import typingsJapgolly.winrtUwp.winrtUwpStrings.recordlimitationexceeded
import typingsJapgolly.winrtUwp.winrtUwpStrings.thermalstatuschanged
