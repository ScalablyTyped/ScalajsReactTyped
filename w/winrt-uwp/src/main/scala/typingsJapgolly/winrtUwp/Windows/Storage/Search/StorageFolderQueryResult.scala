...
@js.native
trait StorageFolderQueryResult extends StObject {
  ...
  /**
    ...
    */
  def getFoldersAsync(startIndex: Double, maxNumberOfItems: Double): IPromiseWithIAsyncOperation[IVectorView[Any]] = js.native
