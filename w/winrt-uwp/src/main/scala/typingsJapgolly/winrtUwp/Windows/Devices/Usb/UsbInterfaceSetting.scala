...
object UsbInterfaceSetting {
  ...
  extension [Self <: UsbInterfaceSetting](x: Self) {
    ...
    inline def setSelectSettingAsync(value: CallbackTo[IPromiseWithIAsyncAction]): Self = StObject.set(x, "selectSettingAsync", value.toJsFn)
