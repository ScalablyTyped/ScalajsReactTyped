package typingsJapgolly.winrtUwp.Windows.Graphics.DirectX
...
object Direct3D11 {
  ...
  object IDirect3DSurface {
    ...
    inline def apply(close: Callback, description: Direct3DSurfaceDescription): IDirect3DSurface = {
      val __obj = js.Dynamic.literal(close = close.toJsFn, description = description.asInstanceOf[js.Any])
