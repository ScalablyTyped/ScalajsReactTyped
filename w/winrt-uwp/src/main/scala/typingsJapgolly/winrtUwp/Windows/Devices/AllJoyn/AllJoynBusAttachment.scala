...
import typingsJapgolly.winrtUwp.winrtUwpStrings.authenticationcomplete
import typingsJapgolly.winrtUwp.winrtUwpStrings.credentialsrequested
import typingsJapgolly.winrtUwp.winrtUwpStrings.credentialsverificationrequested
