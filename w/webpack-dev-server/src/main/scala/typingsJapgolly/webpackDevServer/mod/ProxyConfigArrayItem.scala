...
import typingsJapgolly.httpProxyMiddleware.mod.Filter
import typingsJapgolly.httpProxyMiddleware.mod.LogProvider
...
import typingsJapgolly.webpackDevServer.webpackDevServerBooleans.`false`
import typingsJapgolly.webpackDevServer.webpackDevServerStrings.debug
...
import typingsJapgolly.webpackDevServer.webpackDevServerStrings.silent
import typingsJapgolly.webpackDevServer.webpackDevServerStrings.warn
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* Inlined {  path ? :string | std.Array<string>,   context ? :string | std.Array<string> | http-proxy-middleware.http-proxy-middleware.Filter} & http-proxy-middleware.http-proxy-middleware.Config */
...
object ProxyConfigArrayItem {
  ...
  def apply(
    ...
    context: String | js.Array[String] | Filter = null,
