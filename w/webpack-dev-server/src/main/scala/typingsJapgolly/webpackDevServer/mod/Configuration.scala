...
import typingsJapgolly.webpackDevServer.webpackDevServerStrings.only
...
trait Configuration extends StObject {
  ...
  var headers: js.UndefOr[
    org.scalajs.dom.Headers | (js.Function3[
      /* req */ org.scalajs.dom.Request, 
      /* res */ org.scalajs.dom.Response, 
      /* context */ DevMiddlewareContext[org.scalajs.dom.Request, org.scalajs.dom.Response], 
...
object Configuration {
  ...
  extension [Self <: Configuration](x: Self) {
    ...
    inline def setHeaders(
      value: org.scalajs.dom.Headers | (js.Function3[
          /* req */ org.scalajs.dom.Request, 
          /* res */ org.scalajs.dom.Response, 
          /* context */ DevMiddlewareContext[org.scalajs.dom.Request, org.scalajs.dom.Response], 
          org.scalajs.dom.Headers
    ...
    inline def setHeadersFunction3(
      value: (/* req */ org.scalajs.dom.Request, /* res */ org.scalajs.dom.Response, /* context */ DevMiddlewareContext[org.scalajs.dom.Request, org.scalajs.dom.Response]) => org.scalajs.dom.Headers
    ...
    inline def setOnAfterSetupMiddleware(value: /* devServer */ Server => Callback): Self = StObject.set(x, "onAfterSetupMiddleware", js.Any.fromFunction1((t0: /* devServer */ Server) => value(t0).runNow()))
    
    inline def setOnAfterSetupMiddlewareUndefined: Self = StObject.set(x, "onAfterSetupMiddleware", js.undefined)
    
    inline def setOnBeforeSetupMiddleware(value: /* devServer */ Server => Callback): Self = StObject.set(x, "onBeforeSetupMiddleware", js.Any.fromFunction1((t0: /* devServer */ Server) => value(t0).runNow()))
    
    inline def setOnBeforeSetupMiddlewareUndefined: Self = StObject.set(x, "onBeforeSetupMiddleware", js.undefined)
    
    inline def setOnListening(value: /* devServer */ Server => Callback): Self = StObject.set(x, "onListening", js.Any.fromFunction1((t0: /* devServer */ Server) => value(t0).runNow()))
