...
import typingsJapgolly.serveIndex.mod.Options
import typingsJapgolly.webpackDevServer.anon.WatchOptionsaggregateTime
...
trait Static extends StObject {
  ...
  var staticOptions: js.UndefOr[
    typingsJapgolly.serveStatic.mod.ServeStaticOptions[ServerResponse[typingsJapgolly.node.httpMod.IncomingMessage]]
  ] = js.undefined
...
object Static {
  ...
  extension [Self <: Static](x: Self) {
    ...
    inline def setStaticOptions(
      value: typingsJapgolly.serveStatic.mod.ServeStaticOptions[ServerResponse[typingsJapgolly.node.httpMod.IncomingMessage]]
