...
import typingsJapgolly.webpackDevMiddleware.mod.API
import typingsJapgolly.webpackDevMiddleware.mod.Callback
import typingsJapgolly.webpackDevServer.anon.FnCallName
...
trait Server extends StObject {
  ...
  var compiler: typingsJapgolly.webpack.mod.Compiler | typingsJapgolly.webpack.mod.MultiCompiler = js.native
  ...
  def watchFiles(watchPath: String, watchOptions: typingsJapgolly.chokidar.mod.WatchOptions): Unit = js.native
  def watchFiles(watchPath: js.Array[String]): Unit = js.native
  def watchFiles(watchPath: js.Array[String], watchOptions: typingsJapgolly.chokidar.mod.WatchOptions): Unit = js.native
