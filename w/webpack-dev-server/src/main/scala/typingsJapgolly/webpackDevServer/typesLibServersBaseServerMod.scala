...
object typesLibServersBaseServerMod {
  ...
  open class ^ protected ()
    ...
    /**
      ...
      */
    def this(server: typingsJapgolly.webpackDevServer.mod.^) = this()
    ...
    /** @type {import("../Server")} */
    /* CompleteClass */
    var server: typingsJapgolly.webpackDevServer.mod.^ = js.native
  }
  ...
  trait BaseServer extends StObject {
    ...
    /** @type {import("../Server")} */
    var server: typingsJapgolly.webpackDevServer.mod.^
  }
  object BaseServer {
    
    inline def apply(clients: js.Array[ClientConnection], server: typingsJapgolly.webpackDevServer.mod.^): BaseServer = {
    ...
    extension [Self <: BaseServer](x: Self) {
      ...
      inline def setServer(value: typingsJapgolly.webpackDevServer.mod.^): Self = StObject.set(x, "server", value.asInstanceOf[js.Any])
    }
  }
