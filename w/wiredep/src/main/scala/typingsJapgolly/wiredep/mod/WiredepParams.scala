...
object WiredepParams {
  ...
  def apply(
    ...
    onFileUpdated: /* filePath */ String => Callback = null,
    onMainNotFound: /* pkg */ String => Callback = null,
    onPathInjected: /* fileObject */ FileObject => Callback = null,
    ...
    if (!js.isUndefined(devDependencies)) __obj.updateDynamic("devDependencies")(devDependencies.asInstanceOf[js.Any])
    ...
    if (onFileUpdated != null) __obj.updateDynamic("onFileUpdated")(js.Any.fromFunction1((t0: /* filePath */ java.lang.String) => onFileUpdated(t0).runNow()))
    if (onMainNotFound != null) __obj.updateDynamic("onMainNotFound")(js.Any.fromFunction1((t0: /* pkg */ java.lang.String) => onMainNotFound(t0).runNow()))
    if (onPathInjected != null) __obj.updateDynamic("onPathInjected")(js.Any.fromFunction1((t0: /* fileObject */ typingsJapgolly.wiredep.mod.FileObject) => onPathInjected(t0).runNow()))
