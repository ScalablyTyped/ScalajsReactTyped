...
import typingsJapgolly.std.WebGLTexture
import typingsJapgolly.std.WebGLUniformLocation
...
trait WebGL2RenderingContext
  ...
  def beginQuery(target: Double, query: typingsJapgolly.std.WebGLQuery): Unit = js.native
  ...
  def bindBufferRange(
    target: Double,
    index: Double,
    buffer: typingsJapgolly.std.WebGLBuffer,
    offset: Double,
    size: Double
  ): Unit = js.native
  def bindSampler(unit: Double): Unit = js.native
   //[WebGLHandlesContextLoss]
  def bindSampler(unit: Double, sampler: typingsJapgolly.std.WebGLSampler): Unit = js.native
  def bindTransformFeedback(target: Double): Unit = js.native
   //[WebGLHandlesContextLoss]
  def bindTransformFeedback(target: Double, tf: typingsJapgolly.std.WebGLTransformFeedback): Unit = js.native
  def bindVertexArray(): Unit = js.native
   //[WebGLHandlesContextLoss]
  def bindVertexArray(array: typingsJapgolly.std.WebGLVertexArrayObject): Unit = js.native
  /* Framebuffer objects */
  def blitFramebuffer(
    srcX0: Double,
    srcY0: Double,
  ...
  def clientWaitSync(sync: typingsJapgolly.std.WebGLSync, flags: Double, timeout: Double): Double = js.native
  ...
  /* Query Objects */
  def createQuery(): typingsJapgolly.std.WebGLQuery | Null = js.native
  /* Sampler Objects */
  def createSampler(): typingsJapgolly.std.WebGLSampler | Null = js.native
  /* Transform Feedback */
  def createTransformFeedback(): typingsJapgolly.std.WebGLTransformFeedback | Null = js.native
  /* Vertex Array Objects */
  def createVertexArray(): typingsJapgolly.std.WebGLVertexArrayObject | Null = js.native
  def deleteQuery(): Unit = js.native
  def deleteQuery(query: typingsJapgolly.std.WebGLQuery): Unit = js.native
  def deleteSampler(): Unit = js.native
  def deleteSampler(sampler: typingsJapgolly.std.WebGLSampler): Unit = js.native
  def deleteSync(): Unit = js.native
   //[WebGLHandlesContextLoss]
  def deleteSync(sync: typingsJapgolly.std.WebGLSync): Unit = js.native
  def deleteTransformFeedback(): Unit = js.native
  def deleteTransformFeedback(tf: typingsJapgolly.std.WebGLTransformFeedback): Unit = js.native
  def deleteVertexArray(): Unit = js.native
  def deleteVertexArray(vertexArray: typingsJapgolly.std.WebGLVertexArrayObject): Unit = js.native
  ...
  /* Sync objects */
  def fenceSync(condition: Double, flags: Double): typingsJapgolly.std.WebGLSync | Null = js.native
  ...
  def getBufferSubData(target: Double, srcByteOffset: Double, dstBuffer: scala.scalajs.js.typedarray.ArrayBufferView): Unit = js.native
  ...
  def getQuery(target: Double, pname: Double): typingsJapgolly.std.WebGLQuery | Null = js.native
  def getQueryParameter(query: typingsJapgolly.std.WebGLQuery, pname: Double): js.Any = js.native
  def getSamplerParameter(sampler: typingsJapgolly.std.WebGLSampler, pname: Double): js.Any = js.native
  def getSyncParameter(sync: typingsJapgolly.std.WebGLSync, pname: Double): js.Any = js.native
  ...
  def isQuery(query: typingsJapgolly.std.WebGLQuery): Boolean = js.native
  def isSampler(): Boolean = js.native
  def isSampler(sampler: typingsJapgolly.std.WebGLSampler): Boolean = js.native
  def isSync(): Boolean = js.native
  def isSync(sync: typingsJapgolly.std.WebGLSync): Boolean = js.native
  def isTransformFeedback(): Boolean = js.native
  def isTransformFeedback(tf: typingsJapgolly.std.WebGLTransformFeedback): Boolean = js.native
  def isVertexArray(): Boolean = js.native
  def isVertexArray(vertexArray: typingsJapgolly.std.WebGLVertexArrayObject): Boolean = js.native
  ...
  def samplerParameterf(sampler: typingsJapgolly.std.WebGLSampler, pname: Double, param: Double): Unit = js.native
  def samplerParameteri(sampler: typingsJapgolly.std.WebGLSampler, pname: Double, param: Double): Unit = js.native
  def texImage2D(
    target: Double,
    level: Double,
    internalformat: Double,
  ...
  def waitSync(sync: typingsJapgolly.std.WebGLSync, flags: Double, timeout: Double): Unit = js.native
}
