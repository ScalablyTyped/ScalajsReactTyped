...
import typingsJapgolly.webdriverManager.anon.TypeofBinary
import typingsJapgolly.webdriverManager.builtLibBinariesBinaryMod.BinaryMap
import typingsJapgolly.webdriverManager.builtLibBinariesMod.Binary
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object builtLibFilesMod {
  
  @JSImport("webdriver-manager/built/lib/files", "DownloadedBinary")
  @js.native
  open class DownloadedBinary protected ()
    extends typingsJapgolly.webdriverManager.builtLibFilesDownloadedBinaryMod.DownloadedBinary {
  ...
  open class Downloader ()
    extends typingsJapgolly.webdriverManager.builtLibFilesDownloaderMod.Downloader
  /* static members */
  object Downloader {
  ...
  open class FileManager ()
    extends typingsJapgolly.webdriverManager.builtLibFilesFileManagerMod.FileManager
  /* static members */
  object FileManager {
    ...
    /**
      ...
      */
    inline def downloadedBinaries(outputDir: String): BinaryMap[
        typingsJapgolly.webdriverManager.builtLibFilesDownloadedBinaryMod.DownloadedBinary
      ] = ^.asInstanceOf[js.Dynamic].applyDynamic("downloadedBinaries")(outputDir.asInstanceOf[js.Any]).asInstanceOf[BinaryMap[
        typingsJapgolly.webdriverManager.builtLibFilesDownloadedBinaryMod.DownloadedBinary
      ]]
    ...
    /**
      ...
      */
    inline def downloadedVersions_[T /* <: Binary */](binary: T, osType: String, arch: String, existingFiles: js.Array[String]): typingsJapgolly.webdriverManager.builtLibFilesDownloadedBinaryMod.DownloadedBinary = (^.asInstanceOf[js.Dynamic].applyDynamic("downloadedVersions_")(binary.asInstanceOf[js.Any], osType.asInstanceOf[js.Any], arch.asInstanceOf[js.Any], existingFiles.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.webdriverManager.builtLibFilesDownloadedBinaryMod.DownloadedBinary]
