...
import typingsJapgolly.webdriverManager.builtLibBinariesConfigSourceMod.ConfigSource
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object builtLibBinariesBinaryMod {
  
  /* note: abstract class */ @JSImport("webdriver-manager/built/lib/binaries/binary", "Binary")
  @js.native
  ...
  object OS extends StObject {
    ...
    sealed trait Darwin
      extends StObject
         with OS
    /* 2 */ val Darwin: typingsJapgolly.webdriverManager.builtLibBinariesBinaryMod.OS.Darwin & Double = js.native
    
    @js.native
    sealed trait Linux
      extends StObject
         with OS
    /* 1 */ val Linux: typingsJapgolly.webdriverManager.builtLibBinariesBinaryMod.OS.Linux & Double = js.native
    
    @js.native
    sealed trait Windows_NT
      extends StObject
         with OS
    /* 0 */ val Windows_NT: typingsJapgolly.webdriverManager.builtLibBinariesBinaryMod.OS.Windows_NT & Double = js.native
  }
