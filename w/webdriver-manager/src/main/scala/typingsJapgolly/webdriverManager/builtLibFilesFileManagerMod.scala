...
import typingsJapgolly.webdriverManager.builtLibFilesDownloadedBinaryMod.DownloadedBinary
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object builtLibFilesFileManagerMod {
  ...
  object FileManager {
    ...
    /**
      ...
      */
    inline def downloadedBinaries(outputDir: String): BinaryMap[DownloadedBinary] = ^.asInstanceOf[js.Dynamic].applyDynamic("downloadedBinaries")(outputDir.asInstanceOf[js.Any]).asInstanceOf[BinaryMap[DownloadedBinary]]
