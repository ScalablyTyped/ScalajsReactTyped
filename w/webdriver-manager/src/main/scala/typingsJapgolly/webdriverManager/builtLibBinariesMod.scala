...
object builtLibBinariesMod {
  ...
  open class AndroidSDK ()
    extends typingsJapgolly.webdriverManager.builtLibBinariesAndroidSdkMod.AndroidSDK {
  ...
  @js.native
  open class Appium ()
    extends typingsJapgolly.webdriverManager.builtLibBinariesAppiumMod.Appium {
    def this(alternateCDN: String) = this()
  }
  /* static members */
  object Appium {
  ...
  @js.native
  open class Binary ()
    extends typingsJapgolly.webdriverManager.builtLibBinariesBinaryMod.Binary {
  ...
  open class ChromeDriver ()
    extends typingsJapgolly.webdriverManager.builtLibBinariesChromeDriverMod.ChromeDriver {
    def this(opt_alternativeCdn: String) = this()
  }
  /* static members */
  object ChromeDriver {
  ...
  open class GeckoDriver ()
    extends typingsJapgolly.webdriverManager.builtLibBinariesGeckoDriverMod.GeckoDriver {
    def this(opt_alternativeCdn: String) = this()
  }
  /* static members */
  object GeckoDriver {
  ...
  @js.native
  open class IEDriver ()
    extends typingsJapgolly.webdriverManager.builtLibBinariesIedriverMod.IEDriver {
    def this(opt_alternativeCdn: String) = this()
  }
  /* static members */
  object IEDriver {
  ...
  object OS extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.webdriverManager.builtLibBinariesBinaryMod.OS & Double] = js.native
  ...
  open class Standalone ()
    extends typingsJapgolly.webdriverManager.builtLibBinariesStandaloneMod.Standalone {
    def this(opt_alternativeCdn: String) = this()
  }
  /* static members */
  object Standalone {
