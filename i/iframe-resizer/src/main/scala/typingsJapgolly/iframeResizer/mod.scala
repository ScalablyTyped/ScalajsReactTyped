package typingsJapgolly.iframeResizer

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import org.scalajs.dom.EventListenerOptions
import org.scalajs.dom.HTMLElement
import typingsJapgolly.iframeResizer.iframeResizerBooleans.`false`
import typingsJapgolly.iframeResizer.iframeResizerStrings.auto
import typingsJapgolly.iframeResizer.iframeResizerStrings.child
import typingsJapgolly.iframeResizer.iframeResizerStrings.parent
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.iframeResizer.iframeResizerStrings.bodyOffset
    - typingsJapgolly.iframeResizer.iframeResizerStrings.bodyScroll
    - typingsJapgolly.iframeResizer.iframeResizerStrings.documentElementOffset
    - typingsJapgolly.iframeResizer.iframeResizerStrings.documentElementScroll
    - typingsJapgolly.iframeResizer.iframeResizerStrings.max
    - typingsJapgolly.iframeResizer.iframeResizerStrings.min
    - typingsJapgolly.iframeResizer.iframeResizerStrings.grow
    - typingsJapgolly.iframeResizer.iframeResizerStrings.lowestElement
    - typingsJapgolly.iframeResizer.iframeResizerStrings.taggedElement
  */
  trait HeightCalculationMethod extends StObject
  object HeightCalculationMethod {
    
    inline def bodyOffset: typingsJapgolly.iframeResizer.iframeResizerStrings.bodyOffset = "bodyOffset".asInstanceOf[typingsJapgolly.iframeResizer.iframeResizerStrings.bodyOffset]
    
    inline def bodyScroll: typingsJapgolly.iframeResizer.iframeResizerStrings.bodyScroll = "bodyScroll".asInstanceOf[typingsJapgolly.iframeResizer.iframeResizerStrings.bodyScroll]
    
    inline def documentElementOffset: typingsJapgolly.iframeResizer.iframeResizerStrings.documentElementOffset = "documentElementOffset".asInstanceOf[typingsJapgolly.iframeResizer.iframeResizerStrings.documentElementOffset]
    
    inline def documentElementScroll: typingsJapgolly.iframeResizer.iframeResizerStrings.documentElementScroll = "documentElementScroll".asInstanceOf[typingsJapgolly.iframeResizer.iframeResizerStrings.documentElementScroll]
    
    inline def grow: typingsJapgolly.iframeResizer.iframeResizerStrings.grow = "grow".asInstanceOf[typingsJapgolly.iframeResizer.iframeResizerStrings.grow]
    
    inline def lowestElement: typingsJapgolly.iframeResizer.iframeResizerStrings.lowestElement = "lowestElement".asInstanceOf[typingsJapgolly.iframeResizer.iframeResizerStrings.lowestElement]
    
    inline def max: typingsJapgolly.iframeResizer.iframeResizerStrings.max = "max".asInstanceOf[typingsJapgolly.iframeResizer.iframeResizerStrings.max]
    
    inline def min: typingsJapgolly.iframeResizer.iframeResizerStrings.min = "min".asInstanceOf[typingsJapgolly.iframeResizer.iframeResizerStrings.min]
    
    inline def taggedElement: typingsJapgolly.iframeResizer.iframeResizerStrings.taggedElement = "taggedElement".asInstanceOf[typingsJapgolly.iframeResizer.iframeResizerStrings.taggedElement]
  }
  ...
  object IFrameOptions {
    ...
    extension [Self <: IFrameOptions](x: Self) {
      ...
      inline def setClosedCallback(value: /* iframeId */ String => Callback): Self = StObject.set(x, "closedCallback", js.Any.fromFunction1((t0: /* iframeId */ String) => value(t0).runNow()))
      ...
      inline def setInitCallback(value: /* iframe */ IFrameComponent => Callback): Self = StObject.set(x, "initCallback", js.Any.fromFunction1((t0: /* iframe */ IFrameComponent) => value(t0).runNow()))
      ...
      inline def setMessageCallback(value: /* data */ IFrameMessageData => Callback): Self = StObject.set(x, "messageCallback", js.Any.fromFunction1((t0: /* data */ IFrameMessageData) => value(t0).runNow()))
      ...
      inline def setResizedCallback(value: /* data */ IFrameResizedData => Callback): Self = StObject.set(x, "resizedCallback", js.Any.fromFunction1((t0: /* data */ IFrameResizedData) => value(t0).runNow()))
  ...
  object IFramePageOptions {
    ...
    extension [Self <: IFramePageOptions](x: Self) {
      ...
      inline def setHeightCalculationMethodCallbackTo(value: CallbackTo[Double]): Self = StObject.set(x, "heightCalculationMethod", value.toJsFn)
      
      inline def setHeightCalculationMethodUndefined: Self = StObject.set(x, "heightCalculationMethod", js.undefined)
      
      inline def setMessageCallback(value: /* message */ Any => Callback): Self = StObject.set(x, "messageCallback", js.Any.fromFunction1((t0: /* message */ Any) => value(t0).runNow()))
      
      inline def setMessageCallbackUndefined: Self = StObject.set(x, "messageCallback", js.undefined)
      
      inline def setReadyCallback(value: Callback): Self = StObject.set(x, "readyCallback", value.toJsFn)
      ...
      inline def setWidthCalculationMethodCallbackTo(value: CallbackTo[Double]): Self = StObject.set(x, "widthCalculationMethod", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.iframeResizer.iframeResizerStrings.max
    - typingsJapgolly.iframeResizer.iframeResizerStrings.min
    - typingsJapgolly.iframeResizer.iframeResizerStrings.scroll
    - typingsJapgolly.iframeResizer.iframeResizerStrings.rightMostElement
    - typingsJapgolly.iframeResizer.iframeResizerStrings.taggedElement
  */
  ...
  object WidthCalculationMethod {
    ...
    inline def rightMostElement: typingsJapgolly.iframeResizer.iframeResizerStrings.rightMostElement = "rightMostElement".asInstanceOf[typingsJapgolly.iframeResizer.iframeResizerStrings.rightMostElement]
    
    inline def scroll: typingsJapgolly.iframeResizer.iframeResizerStrings.scroll = "scroll".asInstanceOf[typingsJapgolly.iframeResizer.iframeResizerStrings.scroll]
