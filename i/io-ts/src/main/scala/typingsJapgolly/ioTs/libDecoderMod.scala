...
import typingsJapgolly.ioTs.ioTsStrings.Either
import typingsJapgolly.ioTs.libFreeSemigroupMod.FreeSemigroup
import typingsJapgolly.ioTs.libGuardMod.Guard
import typingsJapgolly.ioTs.libKleisliMod.Kleisli
import typingsJapgolly.ioTs.libSchemableMod.Literal
import typingsJapgolly.ioTs.libSchemableMod.Schemable2C
import typingsJapgolly.ioTs.libSchemableMod.WithRefine2C
import typingsJapgolly.ioTs.libSchemableMod.WithUnion2C
import typingsJapgolly.ioTs.libSchemableMod.WithUnknownContainers2C
...
object libDecoderMod {
  ...
  @js.native
  val Alt_ : Alt2[typingsJapgolly.ioTs.libDecoderMod.URI] = js.native
  
  @JSImport("io-ts/lib/Decoder", "Category")
  @js.native
  val Category: Category2[typingsJapgolly.ioTs.libDecoderMod.URI] = js.native
  
  @JSImport("io-ts/lib/Decoder", "Functor")
  @js.native
  val Functor: Functor2[typingsJapgolly.ioTs.libDecoderMod.URI] = js.native
  
  @JSImport("io-ts/lib/Decoder", "Schemable")
  @js.native
  val Schemable: Schemable2C[typingsJapgolly.ioTs.libDecoderMod.URI, Any] = js.native
  ...
  @js.native
  val WithRefine: WithRefine2C[typingsJapgolly.ioTs.libDecoderMod.URI, Any] = js.native
  
  @JSImport("io-ts/lib/Decoder", "WithUnion")
  @js.native
  val WithUnion: WithUnion2C[typingsJapgolly.ioTs.libDecoderMod.URI, Any] = js.native
  
  @JSImport("io-ts/lib/Decoder", "WithUnknownContainers")
  @js.native
  val WithUnknownContainers: WithUnknownContainers2C[typingsJapgolly.ioTs.libDecoderMod.URI, Any] = js.native
  ...
  inline def fromSum[T /* <: String */](tag: T): js.Function1[
    ...
    Decoder[
      typingsJapgolly.ioTs.libKleisliMod.InputOf[
        Either, 
      ...
      typingsJapgolly.ioTs.libKleisliMod.TypeOf[
        Either, 
        /* import warning: importer.ImportType#apply Failed type conversion: std.Record<string, io-ts.io-ts/lib/Decoder.Decoder<any, any>>[keyof std.Record<string, io-ts.io-ts/lib/Decoder.Decoder<any, any>>] */ js.Any
      ]
    ]
  ...
  type DecodeError = FreeSemigroup[typingsJapgolly.ioTs.libDecodeErrorMod.DecodeError[String]]
  
  type Decoder[I, A] = Kleisli[typingsJapgolly.fpTs.libEitherMod.URI, I, DecodeError, A]
  
  type InputOf[D] = typingsJapgolly.ioTs.libKleisliMod.InputOf[typingsJapgolly.fpTs.libEitherMod.URI, D]
  
  type TypeOf[D] = typingsJapgolly.ioTs.libKleisliMod.TypeOf[typingsJapgolly.fpTs.libEitherMod.URI, D]
