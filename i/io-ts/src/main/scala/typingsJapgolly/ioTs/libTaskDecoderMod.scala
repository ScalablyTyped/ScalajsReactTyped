...
import typingsJapgolly.ioTs.ioTsStrings.TaskEither
import typingsJapgolly.ioTs.libDecoderMod.Decoder
...
object libTaskDecoderMod {
  ...
  @js.native
  val Alt_ : Alt2[typingsJapgolly.ioTs.libTaskDecoderMod.URI] = js.native
  
  @JSImport("io-ts/lib/TaskDecoder", "Category")
  @js.native
  val Category: Category2[typingsJapgolly.ioTs.libTaskDecoderMod.URI] = js.native
  
  @JSImport("io-ts/lib/TaskDecoder", "Functor")
  @js.native
  val Functor: Functor2[typingsJapgolly.ioTs.libTaskDecoderMod.URI] = js.native
  
  @JSImport("io-ts/lib/TaskDecoder", "Schemable")
  @js.native
  val Schemable: Schemable2C[typingsJapgolly.ioTs.libTaskDecoderMod.URI, Any] = js.native
  ...
  @js.native
  val WithRefine: WithRefine2C[typingsJapgolly.ioTs.libTaskDecoderMod.URI, Any] = js.native
  
  @JSImport("io-ts/lib/TaskDecoder", "WithUnion")
  @js.native
  val WithUnion: WithUnion2C[typingsJapgolly.ioTs.libTaskDecoderMod.URI, Any] = js.native
  
  @JSImport("io-ts/lib/TaskDecoder", "WithUnknownContainers")
  @js.native
  val WithUnknownContainers: WithUnknownContainers2C[typingsJapgolly.ioTs.libTaskDecoderMod.URI, Any] = js.native
  ...
  inline def failure[A](actual: Any, message: String): TaskEither_[typingsJapgolly.ioTs.libDecoderMod.DecodeError, A] = (^.asInstanceOf[js.Dynamic].applyDynamic("failure")(actual.asInstanceOf[js.Any], message.asInstanceOf[js.Any])).asInstanceOf[TaskEither_[typingsJapgolly.ioTs.libDecoderMod.DecodeError, A]]
  ...
  type DecodeError = typingsJapgolly.ioTs.libDecoderMod.DecodeError
  
  type InputOf[KTD] = typingsJapgolly.ioTs.libKleisliMod.InputOf[typingsJapgolly.fpTs.libTaskEitherMod.URI, KTD]
  
  type TaskDecoder[I, A] = Kleisli[typingsJapgolly.fpTs.libTaskEitherMod.URI, I, DecodeError, A]
  
  type TypeOf[KTD] = typingsJapgolly.ioTs.libKleisliMod.TypeOf[typingsJapgolly.fpTs.libTaskEitherMod.URI, KTD]
