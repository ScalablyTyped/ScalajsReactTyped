...
object libGuardMod {
  ...
  @js.native
  val Schemable: Schemable1[typingsJapgolly.ioTs.libGuardMod.URI] = js.native
  ...
  @js.native
  val WithRefine: WithRefine1[typingsJapgolly.ioTs.libGuardMod.URI] = js.native
  
  @JSImport("io-ts/lib/Guard", "WithUnion")
  @js.native
  val WithUnion: WithUnion1[typingsJapgolly.ioTs.libGuardMod.URI] = js.native
  
  @JSImport("io-ts/lib/Guard", "WithUnknownContainers")
  @js.native
  val WithUnknownContainers: WithUnknownContainers1[typingsJapgolly.ioTs.libGuardMod.URI] = js.native
