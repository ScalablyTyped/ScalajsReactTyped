...
object libEqMod {
  ...
  @js.native
  val Schemable: Schemable1[typingsJapgolly.fpTs.libEqMod.URI] = js.native
  ...
  @js.native
  val WithRefine: WithRefine1[typingsJapgolly.fpTs.libEqMod.URI] = js.native
  
  @JSImport("io-ts/lib/Eq", "WithUnknownContainers")
  @js.native
  val WithUnknownContainers: WithUnknownContainers1[typingsJapgolly.fpTs.libEqMod.URI] = js.native
  ...
  type URI = typingsJapgolly.fpTs.libEqMod.URI
}
