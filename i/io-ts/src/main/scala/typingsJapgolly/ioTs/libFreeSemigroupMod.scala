...
import typingsJapgolly.ioTs.ioTsStrings.Concat
import typingsJapgolly.ioTs.ioTsStrings.Of
...
object libFreeSemigroupMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ioTs.libFreeSemigroupMod.Of_[A]
    - typingsJapgolly.ioTs.libFreeSemigroupMod.Concat_[A]
  */
  trait FreeSemigroup[A] extends StObject
  object FreeSemigroup {
    
    inline def Concat_[A](left: FreeSemigroup[A], right: FreeSemigroup[A]): typingsJapgolly.ioTs.libFreeSemigroupMod.Concat_[A] = {
      val __obj = js.Dynamic.literal(_tag = "Concat", left = left.asInstanceOf[js.Any], right = right.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ioTs.libFreeSemigroupMod.Concat_[A]]
    }
    
    inline def Of_[A](value: A): typingsJapgolly.ioTs.libFreeSemigroupMod.Of_[A] = {
      val __obj = js.Dynamic.literal(_tag = "Of", value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ioTs.libFreeSemigroupMod.Of_[A]]
    }
  }
