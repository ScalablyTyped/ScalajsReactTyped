...
object libEncoderMod {
  ...
  @js.native
  val Category: Category2[typingsJapgolly.ioTs.libEncoderMod.URI] = js.native
  
  @JSImport("io-ts/lib/Encoder", "Contravariant")
  @js.native
  val Contravariant: Contravariant2[typingsJapgolly.ioTs.libEncoderMod.URI] = js.native
