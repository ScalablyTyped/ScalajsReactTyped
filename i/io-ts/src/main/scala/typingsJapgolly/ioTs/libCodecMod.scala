...
import typingsJapgolly.fpTs.libInvariantMod.Invariant3
import typingsJapgolly.ioTs.ioTsStrings.Either
import typingsJapgolly.ioTs.libDecoderMod.DecodeError
import typingsJapgolly.ioTs.libDecoderMod.Decoder
import typingsJapgolly.ioTs.libEncoderMod.Encoder
...
object libCodecMod {
  ...
  @js.native
  val Invariant: Invariant3[typingsJapgolly.ioTs.libCodecMod.URI] = js.native
  ...
  inline def fromSum[T /* <: String */](tag: T): js.Function1[
    ...
    Codec[
      ...
      typingsJapgolly.ioTs.libEncoderMod.OutputOf[
        /* import warning: importer.ImportType#apply Failed type conversion: std.Record<string, io-ts.io-ts/lib/Codec.Codec<any, any, any>>[keyof std.Record<string, io-ts.io-ts/lib/Codec.Codec<any, any, any>>] */ js.Any
      ], 
      typingsJapgolly.ioTs.libEncoderMod.TypeOf[
        /* import warning: importer.ImportType#apply Failed type conversion: std.Record<string, io-ts.io-ts/lib/Codec.Codec<any, any, any>>[keyof std.Record<string, io-ts.io-ts/lib/Codec.Codec<any, any, any>>] */ js.Any
      ]
    ]
  ...
  trait Codec[I, O, A]
    extends StObject
       with Kleisli[typingsJapgolly.fpTs.libEitherMod.URI, I, DecodeError, A]
       with Encoder[O, A]
  object Codec {
  ...
  type InputOf[C] = typingsJapgolly.ioTs.libDecoderMod.InputOf[C]
  
  type OutputOf[C] = typingsJapgolly.ioTs.libEncoderMod.OutputOf[C]
  
  type TypeOf[C] = typingsJapgolly.ioTs.libEncoderMod.TypeOf[C]
