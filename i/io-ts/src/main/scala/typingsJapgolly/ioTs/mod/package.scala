...
import typingsJapgolly.ioTs.mod.^
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.ioTs.mod.InterfaceType[scala.Any, scala.Any, scala.Any, scala.Any]
  - typingsJapgolly.ioTs.mod.StrictType[scala.Any, scala.Any, scala.Any, scala.Any]
  - typingsJapgolly.ioTs.mod.PartialType[scala.Any, scala.Any, scala.Any, scala.Any]
*/
...
type PropsOf[T /* <: typingsJapgolly.ioTs.anon.Props */] = /* import warning: importer.ImportType#apply Failed type conversion: T['props'] */ js.Any
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.ioTs.mod.InterfaceType[typingsJapgolly.ioTs.mod.TaggedProps[Tag], A, O, scala.Any]
  - typingsJapgolly.ioTs.mod.StrictType[typingsJapgolly.ioTs.mod.TaggedProps[Tag], A, O, scala.Any]
  ...
  - typingsJapgolly.ioTs.mod.RecursiveType[scala.Any, A, O, scala.Any]
*/
