...
trait CoreInternalContext extends StObject {
  ...
  var __datetimeFormatters: Map[String, typingsJapgolly.std.Intl.DateTimeFormat]
  
  var __localeChainCache: js.UndefOr[Map[Locale, js.Array[Locale]]] = js.undefined
  
  var __meta: MetaInfo
  
  var __numberFormatters: Map[String, typingsJapgolly.std.Intl.NumberFormat]
...
object CoreInternalContext {
  ...
  inline def apply(
    __datetimeFormatters: Map[String, typingsJapgolly.std.Intl.DateTimeFormat],
    __meta: MetaInfo,
    __numberFormatters: Map[String, typingsJapgolly.std.Intl.NumberFormat]
  ): CoreInternalContext = {
