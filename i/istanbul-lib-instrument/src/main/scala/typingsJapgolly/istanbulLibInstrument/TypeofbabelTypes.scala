...
import typingsJapgolly.babelTypes.AnonRaw
...
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.Ampersand
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.AmpersandAmpersand
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.Asterisk
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.AsteriskAsterisk
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.EqualssignEqualssign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.EqualssignEqualssignEqualssign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.Exclamationmark
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.ExclamationmarkEqualssign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.ExclamationmarkEqualssignEqualssign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.Greaterthansign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.GreaterthansignEqualssign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.GreaterthansignGreaterthansign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.GreaterthansignGreaterthansignGreaterthansign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.Lessthansign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.LessthansignEqualssign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.LessthansignLessthansign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.Percentsign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.Plussign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.PlussignPlussign
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.Slash
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.Tilde
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.Verticalline
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.VerticallineVerticalline
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.^
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.`--`
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.`-_`
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.`var`
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.const
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.constructor
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.delete
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.get
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.in
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.instanceof
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.let
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.method
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.set
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.typeof
import typingsJapgolly.istanbulLibInstrument.istanbulLibInstrumentStrings.void
...
trait TypeofbabelTypes extends js.Object {
  ...
  def TSAnyKeyword(): typingsJapgolly.babelTypes.mod.TSAnyKeyword = js.native
  def TSArrayType(elementType: TSType): typingsJapgolly.babelTypes.mod.TSArrayType = js.native
  def TSAsExpression(expression: Expression, typeAnnotation: TSType): typingsJapgolly.babelTypes.mod.TSAsExpression = js.native
  def TSBooleanKeyword(): typingsJapgolly.babelTypes.mod.TSBooleanKeyword = js.native
  def TSCallSignatureDeclaration(): typingsJapgolly.babelTypes.mod.TSCallSignatureDeclaration = js.native
  def TSCallSignatureDeclaration(typeParameters: TypeParameterDeclaration_): typingsJapgolly.babelTypes.mod.TSCallSignatureDeclaration = js.native
  def TSCallSignatureDeclaration(typeParameters: TypeParameterDeclaration_, parameters: js.Array[Identifier_ | RestElement_]): typingsJapgolly.babelTypes.mod.TSCallSignatureDeclaration = js.native
  def TSCallSignatureDeclaration(
    typeParameters: TypeParameterDeclaration_,
    parameters: js.Array[Identifier_ | RestElement_],
    typeAnnotation: TSTypeAnnotation
  ): typingsJapgolly.babelTypes.mod.TSCallSignatureDeclaration = js.native
  ...
  def TSConstructorType(): typingsJapgolly.babelTypes.mod.TSConstructorType = js.native
  def TSConstructorType(typeParameters: TypeParameterDeclaration_): typingsJapgolly.babelTypes.mod.TSConstructorType = js.native
  def TSConstructorType(typeParameters: TypeParameterDeclaration_, typeAnnotation: TSTypeAnnotation): typingsJapgolly.babelTypes.mod.TSConstructorType = js.native
  def TSDeclareFunction(id: js.UndefOr[scala.Nothing], typeParameters: js.UndefOr[scala.Nothing], params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareFunction = js.native
  ...
  ): typingsJapgolly.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: js.UndefOr[scala.Nothing], typeParameters: Null, params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: js.UndefOr[scala.Nothing], typeParameters: Noop_, params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: js.UndefOr[scala.Nothing], typeParameters: TypeParameterDeclaration_, params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Null, typeParameters: js.UndefOr[scala.Nothing], params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Null, typeParameters: Null, params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Null, typeParameters: Noop_, params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Null, typeParameters: TypeParameterDeclaration_, params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Identifier_, typeParameters: js.UndefOr[scala.Nothing], params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Identifier_, typeParameters: Null, params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Identifier_, typeParameters: Noop_, params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Identifier_, typeParameters: TypeParameterDeclaration_, params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareMethod(
    decorators: js.UndefOr[scala.Nothing],
    key: Expression,
    typeParameters: js.UndefOr[scala.Nothing],
    params: js.Array[LVal]
  ): typingsJapgolly.babelTypes.mod.TSDeclareMethod = js.native
  def TSDeclareMethod(
  ...
  def TSDeclareMethod(decorators: js.Array[Decorator_], key: Expression, typeParameters: Null, params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareMethod = js.native
  def TSDeclareMethod(decorators: js.Array[Decorator_], key: Expression, typeParameters: Noop_, params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareMethod = js.native
  def TSDeclareMethod(
    decorators: js.Array[Decorator_],
    key: Expression,
    typeParameters: TypeParameterDeclaration_,
  ...
  def TSDeclareMethod(decorators: Null, key: Expression, typeParameters: Null, params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareMethod = js.native
  def TSDeclareMethod(decorators: Null, key: Expression, typeParameters: Noop_, params: js.Array[LVal]): typingsJapgolly.babelTypes.mod.TSDeclareMethod = js.native
  def TSDeclareMethod(
    decorators: Null,
    key: Expression,
    typeParameters: TypeParameterDeclaration_,
  ...
  def TSEnumDeclaration(id: Identifier_, members: js.Array[TSEnumMember]): typingsJapgolly.babelTypes.mod.TSEnumDeclaration = js.native
  def TSEnumMember(id: Identifier_): typingsJapgolly.babelTypes.mod.TSEnumMember = js.native
  def TSEnumMember(id: Identifier_, initializer: Expression): typingsJapgolly.babelTypes.mod.TSEnumMember = js.native
  def TSEnumMember(id: StringLiteral_): typingsJapgolly.babelTypes.mod.TSEnumMember = js.native
  def TSEnumMember(id: StringLiteral_, initializer: Expression): typingsJapgolly.babelTypes.mod.TSEnumMember = js.native
  def TSExportAssignment(expression: Expression): typingsJapgolly.babelTypes.mod.TSExportAssignment = js.native
  def TSExpressionWithTypeArguments(expression: TSEntityName): typingsJapgolly.babelTypes.mod.TSExpressionWithTypeArguments = js.native
  def TSExpressionWithTypeArguments(expression: TSEntityName, typeParameters: TypeParameterInstantiation_): typingsJapgolly.babelTypes.mod.TSExpressionWithTypeArguments = js.native
  def TSExternalModuleReference(expression: StringLiteral_): typingsJapgolly.babelTypes.mod.TSExternalModuleReference = js.native
  def TSFunctionType(): typingsJapgolly.babelTypes.mod.TSFunctionType = js.native
  def TSFunctionType(typeParameters: TypeParameterDeclaration_): typingsJapgolly.babelTypes.mod.TSFunctionType = js.native
  def TSFunctionType(typeParameters: TypeParameterDeclaration_, typeAnnotation: TSTypeAnnotation): typingsJapgolly.babelTypes.mod.TSFunctionType = js.native
  def TSImportEqualsDeclaration(id: Identifier_, moduleReference: TSEntityName): typingsJapgolly.babelTypes.mod.TSImportEqualsDeclaration = js.native
  def TSImportEqualsDeclaration(id: Identifier_, moduleReference: TSExternalModuleReference): typingsJapgolly.babelTypes.mod.TSImportEqualsDeclaration = js.native
  def TSIndexSignature(parameters: js.Array[Identifier_]): typingsJapgolly.babelTypes.mod.TSIndexSignature = js.native
  def TSIndexSignature(parameters: js.Array[Identifier_], typeAnnotation: TSTypeAnnotation): typingsJapgolly.babelTypes.mod.TSIndexSignature = js.native
  def TSIndexedAccessType(objectType: TSType, indexType: TSType): typingsJapgolly.babelTypes.mod.TSIndexedAccessType = js.native
  def TSInterfaceBody(body: js.Array[TSTypeElement]): typingsJapgolly.babelTypes.mod.TSInterfaceBody = js.native
  def TSInterfaceDeclaration(
    id: Identifier_,
    typeParameters: js.UndefOr[scala.Nothing],
    extends_ : js.UndefOr[scala.Nothing],
    body: TSInterfaceBody
  ): typingsJapgolly.babelTypes.mod.TSInterfaceDeclaration = js.native
  def TSInterfaceDeclaration(
    id: Identifier_,
    typeParameters: js.UndefOr[scala.Nothing],
  ...
  def TSInterfaceDeclaration(id: Identifier_, typeParameters: js.UndefOr[scala.Nothing], extends_ : Null, body: TSInterfaceBody): typingsJapgolly.babelTypes.mod.TSInterfaceDeclaration = js.native
  def TSInterfaceDeclaration(id: Identifier_, typeParameters: Null, extends_ : js.UndefOr[scala.Nothing], body: TSInterfaceBody): typingsJapgolly.babelTypes.mod.TSInterfaceDeclaration = js.native
  def TSInterfaceDeclaration(
    id: Identifier_,
    typeParameters: Null,
    extends_ : js.Array[TSExpressionWithTypeArguments],
  ...
  def TSInterfaceDeclaration(id: Identifier_, typeParameters: Null, extends_ : Null, body: TSInterfaceBody): typingsJapgolly.babelTypes.mod.TSInterfaceDeclaration = js.native
  def TSInterfaceDeclaration(
    id: Identifier_,
    typeParameters: TypeParameterDeclaration_,
    extends_ : js.UndefOr[scala.Nothing],
  ...
  def TSInterfaceDeclaration(id: Identifier_, typeParameters: TypeParameterDeclaration_, extends_ : Null, body: TSInterfaceBody): typingsJapgolly.babelTypes.mod.TSInterfaceDeclaration = js.native
  def TSIntersectionType(types: js.Array[TSType]): typingsJapgolly.babelTypes.mod.TSIntersectionType = js.native
  def TSLiteralType(literal: BooleanLiteral_): typingsJapgolly.babelTypes.mod.TSLiteralType = js.native
  def TSLiteralType(literal: NumericLiteral_): typingsJapgolly.babelTypes.mod.TSLiteralType = js.native
  def TSLiteralType(literal: StringLiteral_): typingsJapgolly.babelTypes.mod.TSLiteralType = js.native
  def TSMappedType(typeParameter: TypeParameter_): typingsJapgolly.babelTypes.mod.TSMappedType = js.native
  def TSMappedType(typeParameter: TypeParameter_, typeAnnotation: TSType): typingsJapgolly.babelTypes.mod.TSMappedType = js.native
  def TSMethodSignature(key: Expression): typingsJapgolly.babelTypes.mod.TSMethodSignature = js.native
  def TSMethodSignature(key: Expression, typeParameters: TypeParameterDeclaration_): typingsJapgolly.babelTypes.mod.TSMethodSignature = js.native
  def TSMethodSignature(
    key: Expression,
    typeParameters: TypeParameterDeclaration_,
    parameters: js.Array[Identifier_ | RestElement_]
  ): typingsJapgolly.babelTypes.mod.TSMethodSignature = js.native
  def TSMethodSignature(
    key: Expression,
    typeParameters: TypeParameterDeclaration_,
    parameters: js.Array[Identifier_ | RestElement_],
  ...
  def TSModuleBlock(body: js.Array[Statement]): typingsJapgolly.babelTypes.mod.TSModuleBlock = js.native
  def TSModuleDeclaration(id: Identifier_, body: TSModuleBlock): typingsJapgolly.babelTypes.mod.TSModuleDeclaration = js.native
  def TSModuleDeclaration(id: Identifier_, body: typingsJapgolly.babelTypes.mod.TSModuleDeclaration): typingsJapgolly.babelTypes.mod.TSModuleDeclaration = js.native
  def TSModuleDeclaration(id: StringLiteral_, body: TSModuleBlock): typingsJapgolly.babelTypes.mod.TSModuleDeclaration = js.native
  def TSModuleDeclaration(id: StringLiteral_, body: typingsJapgolly.babelTypes.mod.TSModuleDeclaration): typingsJapgolly.babelTypes.mod.TSModuleDeclaration = js.native
  def TSNamespaceExportDeclaration(id: Identifier_): typingsJapgolly.babelTypes.mod.TSNamespaceExportDeclaration = js.native
  def TSNeverKeyword(): typingsJapgolly.babelTypes.mod.TSNeverKeyword = js.native
  def TSNonNullExpression(expression: Expression): typingsJapgolly.babelTypes.mod.TSNonNullExpression = js.native
  def TSNullKeyword(): typingsJapgolly.babelTypes.mod.TSNullKeyword = js.native
  def TSNumberKeyword(): typingsJapgolly.babelTypes.mod.TSNumberKeyword = js.native
  def TSObjectKeyword(): typingsJapgolly.babelTypes.mod.TSObjectKeyword = js.native
  def TSParameterProperty(parameter: AssignmentPattern_): typingsJapgolly.babelTypes.mod.TSParameterProperty = js.native
  def TSParameterProperty(parameter: Identifier_): typingsJapgolly.babelTypes.mod.TSParameterProperty = js.native
  def TSParenthesizedType(typeAnnotation: TSType): typingsJapgolly.babelTypes.mod.TSParenthesizedType = js.native
  def TSPropertySignature(key: Expression): typingsJapgolly.babelTypes.mod.TSPropertySignature = js.native
  def TSPropertySignature(key: Expression, typeAnnotation: TSTypeAnnotation): typingsJapgolly.babelTypes.mod.TSPropertySignature = js.native
  def TSPropertySignature(key: Expression, typeAnnotation: TSTypeAnnotation, initializer: Expression): typingsJapgolly.babelTypes.mod.TSPropertySignature = js.native
  def TSQualifiedName(left: TSEntityName, right: Identifier_): typingsJapgolly.babelTypes.mod.TSQualifiedName = js.native
  def TSStringKeyword(): typingsJapgolly.babelTypes.mod.TSStringKeyword = js.native
  def TSSymbolKeyword(): typingsJapgolly.babelTypes.mod.TSSymbolKeyword = js.native
  def TSThisType(): typingsJapgolly.babelTypes.mod.TSThisType = js.native
  def TSTupleType(elementTypes: js.Array[TSType]): typingsJapgolly.babelTypes.mod.TSTupleType = js.native
  def TSTypeAliasDeclaration(id: Identifier_, typeParameters: js.UndefOr[scala.Nothing], typeAnnotation: TSType): typingsJapgolly.babelTypes.mod.TSTypeAliasDeclaration = js.native
  def TSTypeAliasDeclaration(id: Identifier_, typeParameters: Null, typeAnnotation: TSType): typingsJapgolly.babelTypes.mod.TSTypeAliasDeclaration = js.native
  def TSTypeAliasDeclaration(id: Identifier_, typeParameters: TypeParameterDeclaration_, typeAnnotation: TSType): typingsJapgolly.babelTypes.mod.TSTypeAliasDeclaration = js.native
  def TSTypeAnnotation(typeAnnotation: TSType): typingsJapgolly.babelTypes.mod.TSTypeAnnotation = js.native
  def TSTypeAssertion(typeAnnotation: TSType, expression: Expression): typingsJapgolly.babelTypes.mod.TSTypeAssertion = js.native
  def TSTypeLiteral(members: js.Array[TSTypeElement]): typingsJapgolly.babelTypes.mod.TSTypeLiteral = js.native
  def TSTypeOperator(typeAnnotation: TSType): typingsJapgolly.babelTypes.mod.TSTypeOperator = js.native
  def TSTypeParameter(): typingsJapgolly.babelTypes.mod.TSTypeParameter = js.native
  def TSTypeParameter(constraint: TSType): typingsJapgolly.babelTypes.mod.TSTypeParameter = js.native
  def TSTypeParameter(constraint: TSType, default_ : TSType): typingsJapgolly.babelTypes.mod.TSTypeParameter = js.native
  def TSTypeParameterDeclaration(params: js.Array[TSTypeParameter]): typingsJapgolly.babelTypes.mod.TSTypeParameterDeclaration = js.native
  def TSTypeParameterInstantiation(params: js.Array[TSType]): typingsJapgolly.babelTypes.mod.TSTypeParameterInstantiation = js.native
  def TSTypePredicate(parameterName: Identifier_, typeAnnotation: TSTypeAnnotation): typingsJapgolly.babelTypes.mod.TSTypePredicate = js.native
  def TSTypePredicate(parameterName: TSThisType, typeAnnotation: TSTypeAnnotation): typingsJapgolly.babelTypes.mod.TSTypePredicate = js.native
  def TSTypeQuery(exprName: TSEntityName): typingsJapgolly.babelTypes.mod.TSTypeQuery = js.native
  def TSTypeReference(typeName: TSEntityName): typingsJapgolly.babelTypes.mod.TSTypeReference = js.native
  def TSTypeReference(typeName: TSEntityName, typeParameters: TSTypeParameterInstantiation): typingsJapgolly.babelTypes.mod.TSTypeReference = js.native
  def TSUndefinedKeyword(): typingsJapgolly.babelTypes.mod.TSUndefinedKeyword = js.native
  def TSUnionType(types: js.Array[TSType]): typingsJapgolly.babelTypes.mod.TSUnionType = js.native
  def TSVoidKeyword(): typingsJapgolly.babelTypes.mod.TSVoidKeyword = js.native
