...
object PartialInstrumenterOption {
  ...
  def apply(
    ...
    sourceMapUrlCallback: (/* filename */ String, /* url */ String) => Callback = null
    ...
    if (sourceMapUrlCallback != null) __obj.updateDynamic("sourceMapUrlCallback")(js.Any.fromFunction2((t0: /* filename */ java.lang.String, t1: /* url */ java.lang.String) => sourceMapUrlCallback(t0, t1).runNow()))
