...
object metadataMod {
  ...
  trait HostDecorator
    extends StObject
       with Instantiable0[typingsJapgolly.injectionJs.metadataMod.Host] {
  ...
  trait InjectableDecorator
    extends StObject
       with Instantiable0[typingsJapgolly.injectionJs.metadataMod.Injectable] {
  ...
  trait OptionalDecorator
    extends StObject
       with Instantiable0[typingsJapgolly.injectionJs.metadataMod.Optional] {
  ...
  trait SelfDecorator
    extends StObject
       with Instantiable0[typingsJapgolly.injectionJs.metadataMod.Self] {
  ...
  trait SkipSelfDecorator
    extends StObject
       with Instantiable0[typingsJapgolly.injectionJs.metadataMod.SkipSelf] {
