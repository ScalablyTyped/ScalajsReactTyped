...
import typingsJapgolly.injectionJs.forwardRefMod.ForwardRefFn
import typingsJapgolly.injectionJs.metadataMod.HostDecorator
import typingsJapgolly.injectionJs.metadataMod.InjectDecorator
import typingsJapgolly.injectionJs.metadataMod.InjectableDecorator
import typingsJapgolly.injectionJs.metadataMod.OptionalDecorator
import typingsJapgolly.injectionJs.metadataMod.SelfDecorator
import typingsJapgolly.injectionJs.metadataMod.SkipSelfDecorator
import typingsJapgolly.injectionJs.providerMod.Provider
import typingsJapgolly.injectionJs.reflectiveProviderMod.ReflectiveDependency
import typingsJapgolly.injectionJs.reflectiveProviderMod.ResolvedReflectiveProvider
import typingsJapgolly.injectionJs.utilDecoratorsMod.ClassDefinition
import typingsJapgolly.injectionJs.utilResolveDependenciesMod.Constructor
...
object mod {
  ...
  inline def Class(clsDef: ClassDefinition): typingsJapgolly.injectionJs.facadeTypeMod.Type[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("Class")(clsDef.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.injectionJs.facadeTypeMod.Type[Any]]
  ...
  open class HostCls ()
    extends StObject
       with typingsJapgolly.injectionJs.metadataMod.Host
  ...
  open class InjectCls protected ()
    extends StObject
       with typingsJapgolly.injectionJs.metadataMod.Inject {
  ...
  open class InjectableCls ()
    extends StObject
       with typingsJapgolly.injectionJs.metadataMod.Injectable
  
  @JSImport("injection-js", "InjectionToken")
  @js.native
  open class InjectionToken[T] protected ()
    extends typingsJapgolly.injectionJs.injectionTokenMod.InjectionToken[T] {
  ...
  @js.native
  open class Injector ()
    extends typingsJapgolly.injectionJs.injectorMod.Injector
  /* static members */
  object Injector {
    ...
    @js.native
    def NULL: typingsJapgolly.injectionJs.injectorMod.Injector = js.native
    inline def NULL_=(x: typingsJapgolly.injectionJs.injectorMod.Injector): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NULL")(x.asInstanceOf[js.Any])
  ...
  open class OpaqueToken protected ()
    extends typingsJapgolly.injectionJs.injectionTokenMod.OpaqueToken {
  ...
  open class OptionalCls ()
    extends StObject
       with typingsJapgolly.injectionJs.metadataMod.Optional
  
  /* note: abstract class */ @JSImport("injection-js", "ReflectiveInjector")
  @js.native
  open class ReflectiveInjector ()
    extends typingsJapgolly.injectionJs.reflectiveInjectorMod.ReflectiveInjector
  /* static members */
  object ReflectiveInjector {
    ...
    /**
      ...
      * @experimental
      */
    inline def fromResolvedProviders(providers: js.Array[ResolvedReflectiveProvider]): typingsJapgolly.injectionJs.reflectiveInjectorMod.ReflectiveInjector = ^.asInstanceOf[js.Dynamic].applyDynamic("fromResolvedProviders")(providers.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.injectionJs.reflectiveInjectorMod.ReflectiveInjector]
    inline def fromResolvedProviders(
      providers: js.Array[ResolvedReflectiveProvider],
      parent: typingsJapgolly.injectionJs.injectorMod.Injector
    ): typingsJapgolly.injectionJs.reflectiveInjectorMod.ReflectiveInjector = (^.asInstanceOf[js.Dynamic].applyDynamic("fromResolvedProviders")(providers.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.injectionJs.reflectiveInjectorMod.ReflectiveInjector]
    ...
    /**
      ...
      */
    inline def resolveAndCreate(providers: js.Array[Provider]): typingsJapgolly.injectionJs.reflectiveInjectorMod.ReflectiveInjector = ^.asInstanceOf[js.Dynamic].applyDynamic("resolveAndCreate")(providers.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.injectionJs.reflectiveInjectorMod.ReflectiveInjector]
    inline def resolveAndCreate(providers: js.Array[Provider], parent: typingsJapgolly.injectionJs.injectorMod.Injector): typingsJapgolly.injectionJs.reflectiveInjectorMod.ReflectiveInjector = (^.asInstanceOf[js.Dynamic].applyDynamic("resolveAndCreate")(providers.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.injectionJs.reflectiveInjectorMod.ReflectiveInjector]
  }
  
  @JSImport("injection-js", "ReflectiveKey")
  @js.native
  open class ReflectiveKey protected ()
    extends typingsJapgolly.injectionJs.reflectiveKeyMod.ReflectiveKey {
    /**
      * Private
      */
  ...
  object ReflectiveKey {
    ...
    /**
      ...
      */
    inline def get(token: js.Object): typingsJapgolly.injectionJs.reflectiveKeyMod.ReflectiveKey = ^.asInstanceOf[js.Dynamic].applyDynamic("get")(token.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.injectionJs.reflectiveKeyMod.ReflectiveKey]
  }
  
  @JSImport("injection-js", "ResolvedReflectiveFactory")
  @js.native
  open class ResolvedReflectiveFactory protected ()
    extends typingsJapgolly.injectionJs.reflectiveProviderMod.ResolvedReflectiveFactory {
    def this(
      /**
  ...
  open class SelfCls ()
    extends StObject
       with typingsJapgolly.injectionJs.metadataMod.Self
  ...
  open class SkipSelfCls ()
    extends StObject
       with typingsJapgolly.injectionJs.metadataMod.SkipSelf
  ...
  inline def forwardRef(forwardRefFn: ForwardRefFn): typingsJapgolly.injectionJs.facadeTypeMod.Type[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("forwardRef")(forwardRefFn.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.injectionJs.facadeTypeMod.Type[Any]]
