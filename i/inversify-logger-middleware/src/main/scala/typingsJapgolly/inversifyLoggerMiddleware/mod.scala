...
import typingsJapgolly.inversify.libInterfacesInterfacesMod.interfaces.Middleware
import typingsJapgolly.inversifyLoggerMiddleware.dtsInterfacesInterfacesMod.interfaces.LogEntry
import typingsJapgolly.inversifyLoggerMiddleware.dtsInterfacesInterfacesMod.interfaces.LoggerSettings
