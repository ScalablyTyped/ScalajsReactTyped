package typingsJapgolly.itPipe
...
object mod {
  ...
  inline def pipe[A](first: Source[A]): typingsJapgolly.itStreamTypes.mod.Source[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("pipe")(first.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.itStreamTypes.mod.Source[A]]
  ...
  type Sink[A, B] = (typingsJapgolly.itStreamTypes.mod.Sink[A, B]) | (Duplex[Any, A, B])
  
  type Source[A] = typingsJapgolly.itStreamTypes.mod.Source[A] | js.Function0[typingsJapgolly.itStreamTypes.mod.Source[A]] | (Duplex[A, Any, Any])
  
  type Transform[A, B] = (typingsJapgolly.itStreamTypes.mod.Transform[A, B]) | (Duplex[B, A, Any])
}
