...
import typingsJapgolly.i18next.i18nextStrings.altKey
import typingsJapgolly.i18next.i18nextStrings.ctrlKey
import typingsJapgolly.i18next.i18nextStrings.iframe
import typingsJapgolly.i18next.i18nextStrings.metaKey
import typingsJapgolly.i18next.i18nextStrings.shiftKey
import typingsJapgolly.i18next.i18nextStrings.window
...
object AnonAutoOpen {
  ...
  def apply(
    ...
    onEditorSaved: (/* lng */ Null, /* ns */ String | js.Array[String]) => Callback = null,
    ...
    if (onEditorSaved != null) __obj.updateDynamic("onEditorSaved")(js.Any.fromFunction2((t0: /* lng */ scala.Null, t1: /* ns */ java.lang.String | js.Array[java.lang.String]) => onEditorSaved(t0, t1).runNow()))
