...
package object mod {
  type Callback = js.Function2[/* error */ js.Any, /* t */ typingsJapgolly.i18next.mod.TFunction, scala.Unit]
  ...
  type ExistsFunction[TKeys /* <: java.lang.String */, TInterpolationMap /* <: js.Object */] = js.Function2[
    ...
    /* options */ js.UndefOr[typingsJapgolly.i18next.mod.TOptions[TInterpolationMap]], 
    scala.Boolean
  ]
  type FallbackLng = java.lang.String | js.Array[java.lang.String] | typingsJapgolly.i18next.mod.FallbackLngObjList
  ...
  type MultiReadCallback = js.Function2[
    /* err */ typingsJapgolly.i18next.mod.CallbackError, 
    /* data */ typingsJapgolly.i18next.mod.Resource, 
    scala.Unit
  ]
  type ReadCallback = js.Function2[
    /* err */ typingsJapgolly.i18next.mod.CallbackError, 
    /* data */ typingsJapgolly.i18next.mod.ResourceKey, 
    scala.Unit
  ]
  type Resource = org.scalablytyped.runtime.StringDictionary[typingsJapgolly.i18next.mod.ResourceLanguage]
  type ResourceKey = java.lang.String | org.scalablytyped.runtime.StringDictionary[js.Any]
  type ResourceLanguage = org.scalablytyped.runtime.StringDictionary[typingsJapgolly.i18next.mod.ResourceKey]
  // indexer that is open to any value
  type StringMap = org.scalablytyped.runtime.StringDictionary[js.Any]
  type TFunctionKeys = java.lang.String | typingsJapgolly.std.TemplateStringsArray
  ...
  /**
    ...
    */
  type TOptions[TInterpolationMap /* <: js.Object */] = typingsJapgolly.i18next.mod.TOptionsBase with TInterpolationMap
}
