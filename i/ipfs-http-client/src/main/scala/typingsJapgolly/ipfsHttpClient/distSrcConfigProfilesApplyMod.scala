...
object distSrcConfigProfilesApplyMod {
  ...
  val createApply: Factory[
    js.Function2[
      /* profile */ String, 
      /* options */ js.UndefOr[
        (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_profiles.ProfilesApplyOptions */ Any) & typingsJapgolly.ipfsHttpClient.distSrcTypesMod.HTTPClientExtraOptions
      ], 
      js.Promise[
