...
import typingsJapgolly.ipfsHttpClient.ipfsHttpClientInts.`0`
import typingsJapgolly.ipfsHttpClient.ipfsHttpClientInts.`112`
import typingsJapgolly.ipfsHttpClient.ipfsHttpClientInts.`18`
import typingsJapgolly.ipfsHttpClient.ipfsHttpClientInts.`1`
...
import typingsJapgolly.multiformatsMultiaddr.mod.MultiaddrInput
...
object mod {
  ...
  inline def create(): typingsJapgolly.ipfsHttpClient.distSrcTypesMod.IPFSHTTPClient = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typingsJapgolly.ipfsHttpClient.distSrcTypesMod.IPFSHTTPClient]
  inline def create(options: Options): typingsJapgolly.ipfsHttpClient.distSrcTypesMod.IPFSHTTPClient = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ipfsHttpClient.distSrcTypesMod.IPFSHTTPClient]
  ...
  type EndpointConfig = typingsJapgolly.ipfsHttpClient.distSrcTypesMod.EndpointConfig
  
  type HTTPClientExtraOptions = typingsJapgolly.ipfsHttpClient.distSrcTypesMod.HTTPClientExtraOptions
  
  type IPFSHTTPClient = typingsJapgolly.ipfsHttpClient.distSrcTypesMod.IPFSHTTPClient
  
  type IPLDOptions = typingsJapgolly.ipfsHttpClient.distSrcTypesMod.IPLDOptions
  
  type LoadBaseFn = typingsJapgolly.ipfsHttpClient.distSrcTypesMod.LoadBaseFn
  
  type LoadCodecFn = typingsJapgolly.ipfsHttpClient.distSrcTypesMod.LoadCodecFn
  
  type LoadHasherFn = typingsJapgolly.ipfsHttpClient.distSrcTypesMod.LoadHasherFn
