...
import typingsJapgolly.imageThumbnail.anon.Uri
import typingsJapgolly.imageThumbnail.anon.responseTypebase64Options
import typingsJapgolly.imageThumbnail.anon.responseTypebufferOptions
