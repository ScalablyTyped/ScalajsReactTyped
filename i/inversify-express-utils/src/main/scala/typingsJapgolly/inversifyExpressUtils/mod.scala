...
object mod {
  ...
  open class BaseHttpController ()
    extends typingsJapgolly.inversifyExpressUtils.libBaseHttpControllerMod.BaseHttpController
  
  /* note: abstract class */ @JSImport("inversify-express-utils", "BaseMiddleware")
  @js.native
  open class BaseMiddleware ()
    extends typingsJapgolly.inversifyExpressUtils.libBaseMiddlewareMod.BaseMiddleware
  ...
  object HTTP_VERBS_ENUM extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.inversifyExpressUtils.libConstantsMod.HTTP_VERBS_ENUM & String] = js.native
    
    /* "ALL" */ val all: typingsJapgolly.inversifyExpressUtils.libConstantsMod.HTTP_VERBS_ENUM.all & String = js.native
    
    /* "CONNECT" */ val connect: typingsJapgolly.inversifyExpressUtils.libConstantsMod.HTTP_VERBS_ENUM.connect & String = js.native
    
    /* "DELETE" */ val delete: typingsJapgolly.inversifyExpressUtils.libConstantsMod.HTTP_VERBS_ENUM.delete & String = js.native
    
    /* "GET" */ val get: typingsJapgolly.inversifyExpressUtils.libConstantsMod.HTTP_VERBS_ENUM.get & String = js.native
    
    /* "HEAD" */ val head: typingsJapgolly.inversifyExpressUtils.libConstantsMod.HTTP_VERBS_ENUM.head & String = js.native
    
    /* "OPTIONS" */ val options: typingsJapgolly.inversifyExpressUtils.libConstantsMod.HTTP_VERBS_ENUM.options & String = js.native
    
    /* "PATCH" */ val patch: typingsJapgolly.inversifyExpressUtils.libConstantsMod.HTTP_VERBS_ENUM.patch & String = js.native
    
    /* "POST" */ val post: typingsJapgolly.inversifyExpressUtils.libConstantsMod.HTTP_VERBS_ENUM.post & String = js.native
    
    /* "PROPFIND" */ val propfind: typingsJapgolly.inversifyExpressUtils.libConstantsMod.HTTP_VERBS_ENUM.propfind & String = js.native
    
    /* "PUT" */ val put: typingsJapgolly.inversifyExpressUtils.libConstantsMod.HTTP_VERBS_ENUM.put & String = js.native
    
    /* "TRACE" */ val trace: typingsJapgolly.inversifyExpressUtils.libConstantsMod.HTTP_VERBS_ENUM.trace & String = js.native
  }
  
  /* note: abstract class */ @JSImport("inversify-express-utils", "HttpContent")
  @js.native
  open class HttpContent ()
    extends typingsJapgolly.inversifyExpressUtils.libContentHttpContentMod.HttpContent
  
  @JSImport("inversify-express-utils", "HttpResponseMessage")
  @js.native
  open class HttpResponseMessage ()
    extends typingsJapgolly.inversifyExpressUtils.libHttpResponseMessageMod.HttpResponseMessage {
  ...
  open class InversifyExpressServer protected ()
    extends typingsJapgolly.inversifyExpressUtils.libServerMod.InversifyExpressServer {
    def this(
      container: Container,
  ...
  open class JsonContent protected ()
    extends typingsJapgolly.inversifyExpressUtils.libContentJsonContentMod.JsonContent {
  ...
  object PARAMETER_TYPE extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.inversifyExpressUtils.libConstantsMod.PARAMETER_TYPE & Double] = js.native
    
    /* 4 */ val BODY: typingsJapgolly.inversifyExpressUtils.libConstantsMod.PARAMETER_TYPE.BODY & Double = js.native
    
    /* 6 */ val COOKIES: typingsJapgolly.inversifyExpressUtils.libConstantsMod.PARAMETER_TYPE.COOKIES & Double = js.native
    
    /* 5 */ val HEADERS: typingsJapgolly.inversifyExpressUtils.libConstantsMod.PARAMETER_TYPE.HEADERS & Double = js.native
    
    /* 7 */ val NEXT: typingsJapgolly.inversifyExpressUtils.libConstantsMod.PARAMETER_TYPE.NEXT & Double = js.native
    
    /* 2 */ val PARAMS: typingsJapgolly.inversifyExpressUtils.libConstantsMod.PARAMETER_TYPE.PARAMS & Double = js.native
    
    /* 8 */ val PRINCIPAL: typingsJapgolly.inversifyExpressUtils.libConstantsMod.PARAMETER_TYPE.PRINCIPAL & Double = js.native
    
    /* 3 */ val QUERY: typingsJapgolly.inversifyExpressUtils.libConstantsMod.PARAMETER_TYPE.QUERY & Double = js.native
    
    /* 0 */ val REQUEST: typingsJapgolly.inversifyExpressUtils.libConstantsMod.PARAMETER_TYPE.REQUEST & Double = js.native
    
    /* 1 */ val RESPONSE: typingsJapgolly.inversifyExpressUtils.libConstantsMod.PARAMETER_TYPE.RESPONSE & Double = js.native
  }
  
  @JSImport("inversify-express-utils", "StringContent")
  @js.native
  open class StringContent protected ()
    extends typingsJapgolly.inversifyExpressUtils.libContentStringContentMod.StringContent {
  ...
  object results {
    ...
    open class BadRequestErrorMessageResult protected ()
      extends typingsJapgolly.inversifyExpressUtils.libResultsMod.BadRequestErrorMessageResult {
    ...
    open class BadRequestResult ()
      extends typingsJapgolly.inversifyExpressUtils.libResultsMod.BadRequestResult
    
    @JSImport("inversify-express-utils", "results.ConflictResult")
    @js.native
    open class ConflictResult ()
      extends typingsJapgolly.inversifyExpressUtils.libResultsMod.ConflictResult
    ...
    open class CreatedNegotiatedContentResult[T] protected ()
      extends typingsJapgolly.inversifyExpressUtils.libResultsMod.CreatedNegotiatedContentResult[T] {
    ...
    open class ExceptionResult protected ()
      extends typingsJapgolly.inversifyExpressUtils.libResultsMod.ExceptionResult {
    ...
    open class InternalServerErrorResult ()
      extends typingsJapgolly.inversifyExpressUtils.libResultsMod.InternalServerErrorResult
    
    @JSImport("inversify-express-utils", "results.JsonResult")
    @js.native
    open class JsonResult protected ()
      extends typingsJapgolly.inversifyExpressUtils.libResultsMod.JsonResult {
    ...
    open class NotFoundResult ()
      extends typingsJapgolly.inversifyExpressUtils.libResultsMod.NotFoundResult
    
    @JSImport("inversify-express-utils", "results.OkNegotiatedContentResult")
    @js.native
    open class OkNegotiatedContentResult[T] protected ()
      extends typingsJapgolly.inversifyExpressUtils.libResultsMod.OkNegotiatedContentResult[T] {
    ...
    @js.native
    open class OkResult ()
      extends typingsJapgolly.inversifyExpressUtils.libResultsMod.OkResult
    
    @JSImport("inversify-express-utils", "results.RedirectResult")
    @js.native
    open class RedirectResult protected ()
      extends typingsJapgolly.inversifyExpressUtils.libResultsMod.RedirectResult {
    ...
    open class ResponseMessageResult protected ()
      extends typingsJapgolly.inversifyExpressUtils.libResultsMod.ResponseMessageResult {
      def this(message: typingsJapgolly.inversifyExpressUtils.libHttpResponseMessageMod.HttpResponseMessage) = this()
    }
    
    @JSImport("inversify-express-utils", "results.StatusCodeResult")
    @js.native
    open class StatusCodeResult protected ()
      extends typingsJapgolly.inversifyExpressUtils.libResultsMod.StatusCodeResult {
      def this(statusCode: Double) = this()
    }
  }
}
