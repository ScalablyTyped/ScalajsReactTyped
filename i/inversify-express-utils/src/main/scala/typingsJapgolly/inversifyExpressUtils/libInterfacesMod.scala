...
object libInterfacesMod {
  ...
  object IHttpActionResult {
    ...
    inline def apply(executeAsync: CallbackTo[js.Promise[HttpResponseMessage]]): IHttpActionResult = {
      val __obj = js.Dynamic.literal(executeAsync = executeAsync.toJsFn)
      __obj.asInstanceOf[IHttpActionResult]
    }
    
    extension [Self <: IHttpActionResult](x: Self) {
      
      inline def setExecuteAsync(value: CallbackTo[js.Promise[HttpResponseMessage]]): Self = StObject.set(x, "executeAsync", value.toJsFn)
    }
  }
  ...
  object Principal {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(details = details.asInstanceOf[js.Any], isAuthenticated = isAuthenticated.toJsFn, isInRole = js.Any.fromFunction1(isInRole), isResourceOwner = js.Any.fromFunction1(isResourceOwner))
    ...
    extension [Self <: Principal](x: Self) {
      ...
      inline def setIsAuthenticated(value: CallbackTo[js.Promise[Boolean]]): Self = StObject.set(x, "isAuthenticated", value.toJsFn)
