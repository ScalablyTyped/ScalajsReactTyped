...
import typingsJapgolly.iitc.anon.Attackfrequency
import typingsJapgolly.iitc.anon.Burnout
import typingsJapgolly.iitc.anon.DeployCount
import typingsJapgolly.iitc.anon.Excess
import typingsJapgolly.iitc.anon.Health
import typingsJapgolly.iitc.coreIitctypesMod.IITC.Mod
