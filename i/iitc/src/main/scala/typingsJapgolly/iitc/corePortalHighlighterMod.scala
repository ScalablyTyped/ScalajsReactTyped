...
object corePortalHighlighterMod {
  ...
  object global {
    ...
    object Hightligher {
      ...
      inline def apply(hightlight: Portal => Callback): Hightligher = {
        val __obj = js.Dynamic.literal(hightlight = js.Any.fromFunction1((t0: Portal) => hightlight(t0).runNow()))
        __obj.asInstanceOf[Hightligher]
      }
      
      extension [Self <: Hightligher](x: Self) {
        
        inline def setHightlight(value: Portal => Callback): Self = StObject.set(x, "hightlight", js.Any.fromFunction1((t0: Portal) => value(t0).runNow()))
      }
    }
  }
}
