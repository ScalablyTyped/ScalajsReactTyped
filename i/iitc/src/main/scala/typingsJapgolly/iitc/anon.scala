...
import typingsJapgolly.iitc.coreHooksMod.global.EventPortalDetailLoaded
import typingsJapgolly.iitc.coreHooksMod.global.PortalDetailEnt
import typingsJapgolly.iitc.coreIitctypesMod.IITC.PortalDataDetail
import typingsJapgolly.iitc.coreIitctypesMod.LinkGUID
import typingsJapgolly.iitc.coreIitctypesMod.PortalGUID
import typingsJapgolly.iitc.coreInteltypesMod.Intel.MarkUpPlayer
import typingsJapgolly.iitc.coreInteltypesMod.Intel.MarkUpPortal
import typingsJapgolly.iitc.coreInteltypesMod.Intel.MarkUpText
import typingsJapgolly.iitc.iitcBooleans.`false`
import typingsJapgolly.iitc.iitcBooleans.`true`
import typingsJapgolly.iitc.iitcStrings.ENLIGHTENED
import typingsJapgolly.iitc.iitcStrings.PLAYER_GENERATED
import typingsJapgolly.iitc.iitcStrings.RESISTANCE
import typingsJapgolly.iitc.iitcStrings.SYSTEM_BROADCAST
import typingsJapgolly.iitc.iitcStrings.SYSTEM_NARROWCAST
import typingsJapgolly.iitc.iitcStrings.portal_
