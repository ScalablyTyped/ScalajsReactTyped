package typingsJapgolly.ipaiva
...
import typingsJapgolly.ipaiva.anon.Url
import typingsJapgolly.ipaiva.ipaivaStrings.audio
import typingsJapgolly.ipaiva.ipaivaStrings.completed
import typingsJapgolly.ipaiva.ipaivaStrings.image
import typingsJapgolly.ipaiva.ipaivaStrings.video
...
object mod {
  ...
  object Crate {
    ...
    object DesignNodeEvents {
      ...
      inline def apply(dblclick: (MouseEvent, Node) => Callback): DesignNodeEvents = {
        val __obj = js.Dynamic.literal(dblclick = js.Any.fromFunction2((t0: MouseEvent, t1: Node) => (dblclick(t0, t1)).runNow()))
        __obj.asInstanceOf[DesignNodeEvents]
      }
      
      extension [Self <: DesignNodeEvents](x: Self) {
        
        inline def setDblclick(value: (MouseEvent, Node) => Callback): Self = StObject.set(x, "dblclick", js.Any.fromFunction2((t0: MouseEvent, t1: Node) => (value(t0, t1)).runNow()))
      }
    }
    ...
    object Node {
      ...
      inline def apply(find: String => HTMLElement | Null, inactive: CallbackTo[Node], update: NodeUpdateAttrs => Node): Node = {
        val __obj = js.Dynamic.literal(find = js.Any.fromFunction1(find), inactive = inactive.toJsFn, update = js.Any.fromFunction1(update))
      ...
      extension [Self <: Node](x: Self) {
        ...
        inline def setInactive(value: CallbackTo[Node]): Self = StObject.set(x, "inactive", value.toJsFn)
