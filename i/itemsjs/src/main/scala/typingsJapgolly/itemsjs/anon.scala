...
import typingsJapgolly.itemsjs.mod.Bucket
import typingsJapgolly.itemsjs.mod.SearchAggregation
...
object anon {
  ...
  trait Buckets[I /* <: js.Object */] extends StObject {
    ...
    var buckets: typingsJapgolly.itemsjs.mod.Buckets[I]
  }
  object Buckets {
    
    inline def apply[I /* <: js.Object */](buckets: typingsJapgolly.itemsjs.mod.Buckets[I]): Buckets[I] = {
    ...
    extension [Self <: Buckets[?], I /* <: js.Object */](x: Self & Buckets[I]) {
      ...
      inline def setBuckets(value: typingsJapgolly.itemsjs.mod.Buckets[I]): Self = StObject.set(x, "buckets", value.asInstanceOf[js.Any])
  ...
  trait Data[I /* <: js.Object */, A /* <: String */] extends StObject {
    ...
    var pagination: typingsJapgolly.itemsjs.mod.Pagination
    
    var timings: Facets
  }
  object Data {
    
    inline def apply[I /* <: js.Object */, A /* <: String */](data: Aggregations[I, A], pagination: typingsJapgolly.itemsjs.mod.Pagination, timings: Facets): Data[I, A] = {
    ...
    extension [Self <: Data[?, ?], I /* <: js.Object */, A /* <: String */](x: Self & (Data[I, A])) {
      ...
      inline def setPagination(value: typingsJapgolly.itemsjs.mod.Pagination): Self = StObject.set(x, "pagination", value.asInstanceOf[js.Any])
  ...
  object DataPagination {
    ...
    inline def apply[I /* <: js.Object */](data: Items[I], pagination: typingsJapgolly.itemsjs.mod.Pagination): DataPagination[I] = {
  ...
  object Pagination {
    ...
    inline def apply[I /* <: js.Object */](data: Buckets[I], pagination: typingsJapgolly.itemsjs.mod.Pagination): Pagination[I] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], pagination = pagination.asInstanceOf[js.Any])
