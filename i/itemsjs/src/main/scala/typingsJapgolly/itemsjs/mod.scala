...
import typingsJapgolly.itemsjs.anon.Data
import typingsJapgolly.itemsjs.anon.DataPagination
import typingsJapgolly.itemsjs.itemsjsStrings.count
import typingsJapgolly.itemsjs.itemsjsStrings.term
...
object mod {
  ...
  trait ItemsJs[I /* <: js.Object */, S /* <: String */, A /* <: String */] extends StObject {
    ...
    def aggregation(options: AggregationOptions[A]): typingsJapgolly.itemsjs.anon.Pagination[I] = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.itemsjs.itemsjsStrings.asc
    - typingsJapgolly.itemsjs.itemsjsStrings.desc
  */
  trait Order extends StObject
  object Order {
    
    inline def asc: typingsJapgolly.itemsjs.itemsjsStrings.asc = "asc".asInstanceOf[typingsJapgolly.itemsjs.itemsjsStrings.asc]
    
    inline def desc: typingsJapgolly.itemsjs.itemsjsStrings.desc = "desc".asInstanceOf[typingsJapgolly.itemsjs.itemsjsStrings.desc]
  }
