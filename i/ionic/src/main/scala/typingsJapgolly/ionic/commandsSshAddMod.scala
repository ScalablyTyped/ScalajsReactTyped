...
object commandsSshAddMod {
  ...
  - typingsJapgolly.ionic.definitionsMod.CommandPreRun because var conflicts: env, namespace, project. Inlined preRun */ @JSImport("ionic/commands/ssh/add", "SSHAddCommand")
  @js.native
