...
import typingsJapgolly.ionic.definitionsMod.LogFn
...
object libUtilsLoggerMod {
  ...
  ): WritableStream = (^.asInstanceOf[js.Dynamic].applyDynamic("createPrefixedWriteStream")(log.asInstanceOf[js.Any], prefix.asInstanceOf[js.Any], level.asInstanceOf[js.Any])).asInstanceOf[WritableStream]
}
