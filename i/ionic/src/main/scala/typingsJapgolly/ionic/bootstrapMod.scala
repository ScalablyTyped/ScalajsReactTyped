...
import typingsJapgolly.ionic.ionicStrings.BASE_DIRECTORY_NOT_FOUND
import typingsJapgolly.ionic.ionicStrings.LOCAL_CLI_NOT_FOUND
import typingsJapgolly.ionic.ionicStrings.VERSION_TOO_OLD
