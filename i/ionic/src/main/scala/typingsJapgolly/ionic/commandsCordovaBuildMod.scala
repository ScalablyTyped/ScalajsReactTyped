...
object commandsCordovaBuildMod {
  ...
  - typingsJapgolly.ionic.definitionsMod.CommandPreRun because var conflicts: env, namespace, project. Inlined preRun */ @JSImport("ionic/commands/cordova/build", "BuildCommand")
  @js.native
  open class BuildCommand protected () extends CordovaCommand {
