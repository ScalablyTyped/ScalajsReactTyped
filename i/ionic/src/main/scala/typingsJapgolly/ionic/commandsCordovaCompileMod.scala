...
object commandsCordovaCompileMod {
  ...
  - typingsJapgolly.ionic.definitionsMod.CommandPreRun because var conflicts: env, namespace, project. Inlined preRun */ @JSImport("ionic/commands/cordova/compile", "CompileCommand")
  @js.native
  open class CompileCommand protected () extends CordovaCommand {
