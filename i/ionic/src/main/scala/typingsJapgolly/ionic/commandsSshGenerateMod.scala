...
object commandsSshGenerateMod {
  ...
  - typingsJapgolly.ionic.definitionsMod.CommandPreRun because var conflicts: env, namespace, project. Inlined preRun */ @JSImport("ionic/commands/ssh/generate", "SSHGenerateCommand")
  @js.native
