...
object commandsCordovaRequirementsMod {
  ...
  - typingsJapgolly.ionic.definitionsMod.CommandPreRun because var conflicts: env, namespace, project. Inlined preRun */ @JSImport("ionic/commands/cordova/requirements", "RequirementsCommand")
  @js.native
