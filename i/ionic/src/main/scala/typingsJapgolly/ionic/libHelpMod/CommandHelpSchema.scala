...
import typingsJapgolly.ionicCliFramework.helpMod.CommandHelpSchemaFootnote
import typingsJapgolly.ionicCliFramework.helpMod.CommandHelpSchemaInput
import typingsJapgolly.ionicCliFramework.helpMod.CommandHelpSchemaOption
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait CommandHelpSchema
  extends typingsJapgolly.ionicCliFramework.helpMod.CommandHelpSchema {
  var `type`: String
}
