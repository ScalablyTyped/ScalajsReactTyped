...
import typingsJapgolly.ionic.anon.Host
import typingsJapgolly.sshConfig.mod.SSHConfig
...
object libSshConfigMod {
  ...
  object SSHConfig {
    ...
    @js.native
    open class default ()
      extends typingsJapgolly.sshConfig.mod.default
    ...
    object ELine extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.sshConfig.mod.ELine & Double] = js.native
      
      /* 2 */ val COMMENT: typingsJapgolly.sshConfig.mod.ELine.COMMENT & Double = js.native
      
      /* 1 */ val DIRECTIVE: typingsJapgolly.sshConfig.mod.ELine.DIRECTIVE & Double = js.native
    }
  }
