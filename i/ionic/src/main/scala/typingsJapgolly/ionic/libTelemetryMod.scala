...
object libTelemetryMod {
  ...
  object TelemetryDeps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(client = client.asInstanceOf[js.Any], config = config.asInstanceOf[js.Any], ctx = ctx.asInstanceOf[js.Any], getInfo = getInfo.toJsFn, session = session.asInstanceOf[js.Any])
