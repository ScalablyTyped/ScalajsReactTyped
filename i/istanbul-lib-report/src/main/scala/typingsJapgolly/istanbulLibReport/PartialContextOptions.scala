...
import typingsJapgolly.istanbulLibReport.mod.Summarizers
...
object PartialContextOptions {
  ...
  def apply(
    ...
    dir: String = null,
    sourceFinder: /* filepath */ String => CallbackTo[String] = null,
    ...
    if (sourceFinder != null) __obj.updateDynamic("sourceFinder")(js.Any.fromFunction1((t0: /* filepath */ java.lang.String) => sourceFinder(t0).runNow()))
