...
import typingsJapgolly.infernoCompat.anon.Children
import typingsJapgolly.infernoCompat.anon.ComponentComparator
import typingsJapgolly.infernoCompat.anon.Count
import typingsJapgolly.infernoCompat.anon.Fn0
import typingsJapgolly.infernoCompat.anon.FnCall
import typingsJapgolly.infernoCompat.anon.FnCallChildrenChildFlagsKey
import typingsJapgolly.infernoCompat.anon.FnCallDataEvent
import typingsJapgolly.infernoCompat.anon.FnCallFlagsTypeClassNameChildrenChildFlagsPropsKeyRef
import typingsJapgolly.infernoCompat.anon.FnCallFlagsTypePropsKeyRef
import typingsJapgolly.infernoCompat.anon.FnCallInputParentDOMCallback
import typingsJapgolly.infernoCompat.anon.FnCallObj
import typingsJapgolly.infernoCompat.anon.FnCallParentDOM
import typingsJapgolly.infernoCompat.anon.FnCallRender
import typingsJapgolly.infernoCompat.anon.FnCallTextKey
import typingsJapgolly.infernoCompat.anon.FnCallTypePropsChildren
import typingsJapgolly.infernoCompat.anon.FnCallVNodeToClonePropsChildren
import typingsJapgolly.infernoCompat.anon.TypeofComponent
...
object mod {
  ...
  object default {
    ...
    open class ComponentCls[P, S] ()
      extends typingsJapgolly.inferno.mod.Component[P, S]
    ...
    @js.native
    def PropTypes: typingsJapgolly.infernoCompat.anon.Any = js.native
    inline def PropTypes_=(x: typingsJapgolly.infernoCompat.anon.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PropTypes")(x.asInstanceOf[js.Any])
    
    @JSImport("inferno-compat", "default.PureComponent")
    @js.native
    def PureComponent: Instantiable0[typingsJapgolly.infernoCompat.mod.PureComponent[js.Object, js.Object]] = js.native
  ...
  @js.native
  val Fragment: ExoticComponent[typingsJapgolly.inferno.anon.Children] = js.native
  ...
  object global {
    ...
    object Event {
      ...
      inline def apply(persist: js.Function): typingsJapgolly.infernoCompat.mod.global.Event = {
        val __obj = js.Dynamic.literal(persist = persist.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.infernoCompat.mod.global.Event]
      }
      
      extension [Self <: typingsJapgolly.infernoCompat.mod.global.Event](x: Self) {
