...
object distTypesSrcImageMod {
  ...
  open class AbstractImageQuantizer ()
    extends typingsJapgolly.imageQ.distTypesSrcImageImageQuantizerMod.AbstractImageQuantizer
  
  @JSImport("image-q/dist/types/src/image", "ErrorDiffusionArray")
  @js.native
  open class ErrorDiffusionArray protected ()
    extends typingsJapgolly.imageQ.distTypesSrcImageArrayMod.ErrorDiffusionArray {
  ...
  open class ErrorDiffusionRiemersma protected ()
    extends typingsJapgolly.imageQ.distTypesSrcImageRiemersmaMod.ErrorDiffusionRiemersma {
  ...
  open class NearestColor protected ()
    extends typingsJapgolly.imageQ.distTypesSrcImageNearestColorMod.NearestColor {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
  }
}
