...
object distTypesSrcDistanceMod {
  ...
  open class AbstractDistanceCalculator ()
    extends typingsJapgolly.imageQ.distTypesSrcDistanceDistanceCalculatorMod.AbstractDistanceCalculator
  
  /* note: abstract class */ @JSImport("image-q/dist/types/src/distance", "AbstractEuclidean")
  @js.native
  open class AbstractEuclidean ()
    extends typingsJapgolly.imageQ.distTypesSrcDistanceEuclideanMod.AbstractEuclidean
  
  /* note: abstract class */ @JSImport("image-q/dist/types/src/distance", "AbstractManhattan")
  @js.native
  open class AbstractManhattan ()
    extends typingsJapgolly.imageQ.distTypesSrcDistanceManhattanMod.AbstractManhattan
  
  @JSImport("image-q/dist/types/src/distance", "CIE94GraphicArts")
  @js.native
  open class CIE94GraphicArts ()
    extends typingsJapgolly.imageQ.distTypesSrcDistanceCie94Mod.CIE94GraphicArts
  
  @JSImport("image-q/dist/types/src/distance", "CIE94Textiles")
  @js.native
  open class CIE94Textiles ()
    extends typingsJapgolly.imageQ.distTypesSrcDistanceCie94Mod.CIE94Textiles
  
  @JSImport("image-q/dist/types/src/distance", "CIEDE2000")
  @js.native
  open class CIEDE2000 ()
    extends typingsJapgolly.imageQ.distTypesSrcDistanceCiede2000Mod.CIEDE2000
  /* static members */
  object CIEDE2000 {
  ...
  @js.native
  open class CMetric ()
    extends typingsJapgolly.imageQ.distTypesSrcDistanceCmetricMod.CMetric
  
  @JSImport("image-q/dist/types/src/distance", "Euclidean")
  @js.native
  open class Euclidean ()
    extends typingsJapgolly.imageQ.distTypesSrcDistanceEuclideanMod.Euclidean
  
  @JSImport("image-q/dist/types/src/distance", "EuclideanBT709")
  @js.native
  open class EuclideanBT709 ()
    extends typingsJapgolly.imageQ.distTypesSrcDistanceEuclideanMod.EuclideanBT709
  
  @JSImport("image-q/dist/types/src/distance", "EuclideanBT709NoAlpha")
  @js.native
  open class EuclideanBT709NoAlpha ()
    extends typingsJapgolly.imageQ.distTypesSrcDistanceEuclideanMod.EuclideanBT709NoAlpha
  
  @JSImport("image-q/dist/types/src/distance", "Manhattan")
  @js.native
  open class Manhattan ()
    extends typingsJapgolly.imageQ.distTypesSrcDistanceManhattanMod.Manhattan
  
  @JSImport("image-q/dist/types/src/distance", "ManhattanBT709")
  @js.native
  open class ManhattanBT709 ()
    extends typingsJapgolly.imageQ.distTypesSrcDistanceManhattanMod.ManhattanBT709
  
  @JSImport("image-q/dist/types/src/distance", "ManhattanNommyde")
  @js.native
  open class ManhattanNommyde ()
    extends typingsJapgolly.imageQ.distTypesSrcDistanceManhattanMod.ManhattanNommyde
  
  @JSImport("image-q/dist/types/src/distance", "PNGQuant")
  @js.native
  open class PNGQuant ()
    extends typingsJapgolly.imageQ.distTypesSrcDistancePngQuantMod.PNGQuant
}
