...
object distTypesSrcPaletteMod {
  
  /* note: abstract class */ @JSImport("image-q/dist/types/src/palette", "AbstractPaletteQuantizer")
  @js.native
  open class AbstractPaletteQuantizer ()
    extends typingsJapgolly.imageQ.distTypesSrcPalettePaletteQuantizerMod.AbstractPaletteQuantizer
  
  @JSImport("image-q/dist/types/src/palette", "ColorHistogram")
  @js.native
  open class ColorHistogram protected ()
    extends typingsJapgolly.imageQ.distTypesSrcPaletteRgbquantColorHistogramMod.ColorHistogram {
  ...
  open class NeuQuant protected ()
    extends typingsJapgolly.imageQ.distTypesSrcPaletteNeuquantNeuquantMod.NeuQuant {
  ...
  open class NeuQuantFloat protected ()
    extends typingsJapgolly.imageQ.distTypesSrcPaletteNeuquantNeuquantFloatMod.NeuQuantFloat {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
    def this(colorDistanceCalculator: AbstractDistanceCalculator, colors: Double) = this()
  }
  /* static members */
  ...
  open class RGBQuant protected ()
    extends typingsJapgolly.imageQ.distTypesSrcPaletteRgbquantRgbquantMod.RGBQuant {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
    def this(colorDistanceCalculator: AbstractDistanceCalculator, colors: Double) = this()
  ...
  open class WuColorCube ()
    extends typingsJapgolly.imageQ.distTypesSrcPaletteWuWuQuantMod.WuColorCube
  
  @JSImport("image-q/dist/types/src/palette", "WuQuant")
  @js.native
  open class WuQuant protected ()
    extends typingsJapgolly.imageQ.distTypesSrcPaletteWuWuQuantMod.WuQuant {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
    def this(colorDistanceCalculator: AbstractDistanceCalculator, colors: Double) = this()
    def this(
