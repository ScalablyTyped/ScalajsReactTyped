...
object distTypesSrcUtilsMod {
  ...
  open class HueStatistics protected ()
    extends typingsJapgolly.imageQ.distTypesSrcUtilsHueStatisticsMod.HueStatistics {
  ...
  @js.native
  open class Palette ()
    extends typingsJapgolly.imageQ.distTypesSrcUtilsPaletteMod.Palette
  
  @JSImport("image-q/dist/types/src/utils", "Point")
  @js.native
  open class Point ()
    extends typingsJapgolly.imageQ.distTypesSrcUtilsPointMod.Point
  /* static members */
  object Point {
  ...
  open class PointContainer ()
    extends typingsJapgolly.imageQ.distTypesSrcUtilsPointContainerMod.PointContainer
  /* static members */
  ...
  open class ProgressTracker protected ()
    extends typingsJapgolly.imageQ.distTypesSrcUtilsProgressTrackerMod.ProgressTracker {
