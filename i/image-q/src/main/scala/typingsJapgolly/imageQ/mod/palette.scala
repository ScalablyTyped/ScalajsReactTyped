...
object palette {
  ...
  open class AbstractPaletteQuantizer ()
    extends typingsJapgolly.imageQ.distTypesSrcPaletteMod.AbstractPaletteQuantizer
  
  @JSImport("image-q", "palette.ColorHistogram")
  @js.native
  open class ColorHistogram protected ()
    extends typingsJapgolly.imageQ.distTypesSrcPaletteMod.ColorHistogram {
  ...
  open class NeuQuant protected ()
    extends typingsJapgolly.imageQ.distTypesSrcPaletteMod.NeuQuant {
  ...
  open class NeuQuantFloat protected ()
    extends typingsJapgolly.imageQ.distTypesSrcPaletteMod.NeuQuantFloat {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
    def this(colorDistanceCalculator: AbstractDistanceCalculator, colors: Double) = this()
  }
  /* static members */
  ...
  open class RGBQuant protected ()
    extends typingsJapgolly.imageQ.distTypesSrcPaletteMod.RGBQuant {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
    def this(colorDistanceCalculator: AbstractDistanceCalculator, colors: Double) = this()
  ...
  open class WuColorCube ()
    extends typingsJapgolly.imageQ.distTypesSrcPaletteMod.WuColorCube
  
  @JSImport("image-q", "palette.WuQuant")
  @js.native
  open class WuQuant protected ()
    extends typingsJapgolly.imageQ.distTypesSrcPaletteMod.WuQuant {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
    def this(colorDistanceCalculator: AbstractDistanceCalculator, colors: Double) = this()
    def this(
