...
object SimpleDialog {
  ...
  object Options {
    ...
    inline def apply(text: String, title: String): typingsJapgolly.ibmMobilefirst.WL.SimpleDialog.Options = {
      val __obj = js.Dynamic.literal(text = text.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ibmMobilefirst.WL.SimpleDialog.Options]
    }
    
    extension [Self <: typingsJapgolly.ibmMobilefirst.WL.SimpleDialog.Options](x: Self) {
