...
import typingsJapgolly.ibmMobilefirst.WL.App.ActionReceiverCallback
import typingsJapgolly.ibmMobilefirst.WL.App.BackgroundHandler.Handler
import typingsJapgolly.ibmMobilefirst.WL.App.Callback
import typingsJapgolly.ibmMobilefirst.WL.App.Data
import typingsJapgolly.ibmMobilefirst.WL.App.KeepAliveInBackgroundOptions
import typingsJapgolly.ibmMobilefirst.WL.App.OpenURLOptions
import typingsJapgolly.ibmMobilefirst.WL.Client.ChallengeHandlerAuthenticationOptions
import typingsJapgolly.ibmMobilefirst.WL.Client.ChallengeHandlerSubmitLoginFormOptions
import typingsJapgolly.ibmMobilefirst.WL.Client.ChallengehandlerInvocationData
import typingsJapgolly.ibmMobilefirst.WL.Client.ConnectOptions
import typingsJapgolly.ibmMobilefirst.WL.Client.EventTransmissionPolicy
import typingsJapgolly.ibmMobilefirst.WL.Client.InitOptions
import typingsJapgolly.ibmMobilefirst.WL.Client.ProcedureInvocationData
import typingsJapgolly.ibmMobilefirst.WL.Client.ProcedureInvocationOptions
import typingsJapgolly.ibmMobilefirst.WL.Client.SharedTokenObject
import typingsJapgolly.ibmMobilefirst.WL.Client.UserPreferences
import typingsJapgolly.ibmMobilefirst.WL.Device.NetworkInfo
import typingsJapgolly.ibmMobilefirst.WL.EncryptedCache.StatusHandler
import typingsJapgolly.ibmMobilefirst.WL.Geo.Circle
import typingsJapgolly.ibmMobilefirst.WL.Geo.Coordinate
import typingsJapgolly.ibmMobilefirst.WL.Geo.DistanceOptions
import typingsJapgolly.ibmMobilefirst.WL.Geo.InsideOutsideOptions
import typingsJapgolly.ibmMobilefirst.WL.Headers
import typingsJapgolly.ibmMobilefirst.WL.Options
import typingsJapgolly.ibmMobilefirst.WL.ResponseHandler
import typingsJapgolly.ibmMobilefirst.WL.SecurityUtils.DecryptOptions
import typingsJapgolly.ibmMobilefirst.WL.SecurityUtils.EncryptOptions
import typingsJapgolly.ibmMobilefirst.WL.SecurityUtils.KeygenOptions
import typingsJapgolly.ibmMobilefirst.WL.SimpleDialog.Button
import typingsJapgolly.ibmMobilefirst.WL.TabBar.ItemOptions
import typingsJapgolly.ibmMobilefirst.WL.Trusteer.AssetmentRisks
import typingsJapgolly.ibmMobilefirst.WLAuthorizationManager.RequestObject
...
object global {
  ...
  object WL {
    ...
    open class BusyIndicator ()
      extends StObject
         with typingsJapgolly.ibmMobilefirst.WL.BusyIndicator {
      def this(containerId: String) = this()
      def this(containerId: String, options: typingsJapgolly.ibmMobilefirst.WL.BusyIndicator) = this()
      def this(containerId: Unit, options: typingsJapgolly.ibmMobilefirst.WL.BusyIndicator) = this()
    ...
    object Client {
      ...
      open class AbstractChallengeHandler ()
        extends StObject
           with typingsJapgolly.ibmMobilefirst.WL.Client.AbstractChallengeHandler {
      ...
      inline def createChallengeHandler(realmName: String): typingsJapgolly.ibmMobilefirst.WL.Client.AbstractChallengeHandler = ^.asInstanceOf[js.Dynamic].applyDynamic("createChallengeHandler")(realmName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ibmMobilefirst.WL.Client.AbstractChallengeHandler]
      
      inline def createProvisioningChallengeHandler(realmName: String): typingsJapgolly.ibmMobilefirst.WL.Client.AbstractChallengeHandler = ^.asInstanceOf[js.Dynamic].applyDynamic("createProvisioningChallengeHandler")(realmName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ibmMobilefirst.WL.Client.AbstractChallengeHandler]
      
      inline def createWLChallengeHandler(realName: String): typingsJapgolly.ibmMobilefirst.WL.Client.AbstractChallengeHandler = ^.asInstanceOf[js.Dynamic].applyDynamic("createWLChallengeHandler")(realName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ibmMobilefirst.WL.Client.AbstractChallengeHandler]
      ...
      inline def invokeProcedure(invocationData: ProcedureInvocationData): JQueryDeferred[typingsJapgolly.ibmMobilefirst.WL.Response] = ^.asInstanceOf[js.Dynamic].applyDynamic("invokeProcedure")(invocationData.asInstanceOf[js.Any]).asInstanceOf[JQueryDeferred[typingsJapgolly.ibmMobilefirst.WL.Response]]
      inline def invokeProcedure(invocationData: ProcedureInvocationData, options: ProcedureInvocationOptions): JQueryDeferred[typingsJapgolly.ibmMobilefirst.WL.Response] = (^.asInstanceOf[js.Dynamic].applyDynamic("invokeProcedure")(invocationData.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[JQueryDeferred[typingsJapgolly.ibmMobilefirst.WL.Response]]
      ...
      inline def obtainAccessToken(
        scope: String,
        onSuccess: ResponseHandler[typingsJapgolly.ibmMobilefirst.WL.Response],
        onFailure: ResponseHandler[typingsJapgolly.ibmMobilefirst.WL.FailureResponse]
    ...
    open class FailureResponse ()
      extends StObject
         with typingsJapgolly.ibmMobilefirst.WL.ResponseBase {
    ...
    open class Item ()
      extends StObject
         with typingsJapgolly.ibmMobilefirst.WL.Item {
    ...
    object JSONStore {
      ...
      open class JSONStoreInstance ()
        extends StObject
           with typingsJapgolly.ibmMobilefirst.WL.JSONStore.JSONStoreInstance
      
      /**
        * Creates a query for advanced find. See WL.JSONStore.QueryPart for more information.
        */
      inline def QueryPart(): typingsJapgolly.ibmMobilefirst.WL.JSONStore.QueryPartObj = ^.asInstanceOf[js.Dynamic].applyDynamic("QueryPart")().asInstanceOf[typingsJapgolly.ibmMobilefirst.WL.JSONStore.QueryPartObj]
      
      @JSGlobal("WL.JSONStore.QueryPartObj")
      @js.native
      open class QueryPartObj ()
        extends StObject
           with typingsJapgolly.ibmMobilefirst.WL.JSONStore.QueryPartObj {
      ...
      /**
        ...
        */
      inline def get(collectionName: String): typingsJapgolly.ibmMobilefirst.WL.JSONStore.JSONStoreInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("get")(collectionName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ibmMobilefirst.WL.JSONStore.JSONStoreInstance]
      ...
      inline def init(collections: Any, options: typingsJapgolly.ibmMobilefirst.WL.JSONStore.InitOptions): JQueryDeferred[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("init")(collections.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[JQueryDeferred[Any]]
      
      /**
        * @deprecated since version 5.0.6, it is no longer needed if you use WL.JSONStore.init
        */
      inline def initCollection(name: String, searchFields: Any): typingsJapgolly.ibmMobilefirst.WL.JSONStore.JSONStoreInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("initCollection")(name.asInstanceOf[js.Any], searchFields.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.ibmMobilefirst.WL.JSONStore.JSONStoreInstance]
      inline def initCollection(name: String, searchFields: Any, options: typingsJapgolly.ibmMobilefirst.WL.JSONStore.InitOptions): typingsJapgolly.ibmMobilefirst.WL.JSONStore.JSONStoreInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("initCollection")(name.asInstanceOf[js.Any], searchFields.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.ibmMobilefirst.WL.JSONStore.JSONStoreInstance]
    ...
    open class LogInstance ()
      extends StObject
         with typingsJapgolly.ibmMobilefirst.WL.LogInstance {
    ...
    @JSGlobal("WL.Logger")
    @js.native
    def Logger: typingsJapgolly.ibmMobilefirst.WL.LoggerObject = js.native
    ...
    open class LoggerObject ()
      extends StObject
         with typingsJapgolly.ibmMobilefirst.WL.LoggerObject
    
    inline def Logger_=(x: typingsJapgolly.ibmMobilefirst.WL.LoggerObject): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Logger")(x.asInstanceOf[js.Any])
    ...
    open class Response ()
      extends StObject
         with typingsJapgolly.ibmMobilefirst.WL.Response {
    ...
    object SimpleDialog {
      ...
      inline def show(
        ...
        options: typingsJapgolly.ibmMobilefirst.WL.SimpleDialog.Options
    ...
    object TabBar {
      ...
      inline def addItem(id: String, callback: js.Function, title: String, options: ItemOptions): typingsJapgolly.ibmMobilefirst.WL.TabBarItem = (^.asInstanceOf[js.Dynamic].applyDynamic("addItem")(id.asInstanceOf[js.Any], callback.asInstanceOf[js.Any], title.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.ibmMobilefirst.WL.TabBarItem]
    ...
    open class TabBarItem ()
      extends StObject
         with typingsJapgolly.ibmMobilefirst.WL.TabBarItem
  ...
  open class WLResourceRequest protected ()
    extends StObject
       with typingsJapgolly.ibmMobilefirst.WLResourceRequest {
