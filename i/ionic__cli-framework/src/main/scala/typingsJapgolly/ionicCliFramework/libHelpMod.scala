...
import typingsJapgolly.ionicCliFramework.anon.Colors
import typingsJapgolly.ionicCliFramework.anon.RequiredCommandMetadataCo
import typingsJapgolly.ionicCliFramework.anon.ValueString
...
import typingsJapgolly.ionicCliFramework.definitionsMod.HydratedNamespaceMetadata
...
object libHelpMod {
  ...
  open class HelpFormatter protected () extends StObject {
    ...
    /* protected */ val colors: typingsJapgolly.ionicCliFramework.libColorsMod.Colors = js.native
  ...
  trait CommandHelpFormatterDeps[C /* <: ICommand[C, N, M, I, O] */, N /* <: INamespace[C, N, M, I, O] */, M /* <: CommandMetadata[I, O] */, I /* <: CommandMetadataInput */, O /* <: CommandMetadataOption */] extends StObject {
    ...
    val colors: js.UndefOr[typingsJapgolly.ionicCliFramework.libColorsMod.Colors] = js.undefined
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ionicCliFramework.libHelpMod.CommandHelpSchemaFootnoteText
    - typingsJapgolly.ionicCliFramework.libHelpMod.CommandHelpSchemaFootnoteLink
  */
  trait CommandHelpSchemaFootnote extends StObject
  object CommandHelpSchemaFootnote {
    
    inline def CommandHelpSchemaFootnoteLink(id: String | Double, url: String): typingsJapgolly.ionicCliFramework.libHelpMod.CommandHelpSchemaFootnoteLink = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("link")
      __obj.asInstanceOf[typingsJapgolly.ionicCliFramework.libHelpMod.CommandHelpSchemaFootnoteLink]
    }
    
    inline def CommandHelpSchemaFootnoteText(id: String | Double, text: String): typingsJapgolly.ionicCliFramework.libHelpMod.CommandHelpSchemaFootnoteText = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("text")
      __obj.asInstanceOf[typingsJapgolly.ionicCliFramework.libHelpMod.CommandHelpSchemaFootnoteText]
    }
  }
  ...
  trait CommandHelpSchemaFootnoteText
    ...
    val `type`: typingsJapgolly.ionicCliFramework.ionicCliFrameworkStrings.text
  }
