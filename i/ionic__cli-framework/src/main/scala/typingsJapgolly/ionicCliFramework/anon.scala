...
object anon {
  ...
  trait Colors extends StObject {
    ...
    var colors: js.UndefOr[typingsJapgolly.ionicCliFramework.libColorsMod.Colors] = js.undefined
  }
  object Colors {
    ...
    extension [Self <: Colors](x: Self) {
      ...
      inline def setColors(value: typingsJapgolly.ionicCliFramework.libColorsMod.Colors): Self = StObject.set(x, "colors", value.asInstanceOf[js.Any])
