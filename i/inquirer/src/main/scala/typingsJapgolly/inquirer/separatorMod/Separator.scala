package typingsJapgolly.inquirer.separatorMod

import typingsJapgolly.inquirer.inquirerStrings.separator
import typingsJapgolly.inquirer.mod.ChoiceBase
...
- typingsJapgolly.inquirer.mod.SeparatorOptions because var conflicts: `type`. Inlined line */ trait Separator extends ChoiceBase {
  /**
    * @inheritdoc
    */
