package typingsJapgolly.inquirer.promptMod
...
import typingsJapgolly.inquirer.mod.ui.FetchedAnswer
import typingsJapgolly.inquirer.mod.ui.FetchedQuestion
...
@js.native
trait PromptUI
  extends typingsJapgolly.inquirer.baseUIMod.^ {
  /**
