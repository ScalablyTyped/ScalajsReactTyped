package typingsJapgolly.inquirer.libPromptsBaseMod

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.inquirer.inquirerMod.Answers
import typingsJapgolly.inquirer.inquirerMod.prompts.PromptBase
import typingsJapgolly.inquirer.inquirerMod.prompts.PromptEventPipes
import typingsJapgolly.inquirer.inquirerMod.prompts.PromptOptions
import typingsJapgolly.inquirer.inquirerMod.prompts.PromptState
...
trait Prompt[TQuestion /* <: Question */] extends PromptBase {
  ...
  /**
    ...
    */
  var screen: typingsJapgolly.inquirer.libUtilsScreenDashManagerMod.^
  /**
    * Runs the prompt.
    *
    * @param callback
...
object Prompt {
  ...
  def apply[TQuestion /* <: Question */](
    ...
    handleSubmitEvents: Observable[js.Any] => CallbackTo[PromptEventPipes[js.Any]],
    opt: PromptOptions[TQuestion],
    rl: Interface,
    run: CallbackTo[js.Promise[js.Any]],
    screen: typingsJapgolly.inquirer.libUtilsScreenDashManagerMod.^,
    status: PromptState,
    ...
    __obj.updateDynamic("handleSubmitEvents")(js.Any.fromFunction1((t0: typingsJapgolly.rxjs.rxjsMod.Observable[js.Any]) => handleSubmitEvents(t0).runNow()))
