package typingsJapgolly.inquirer.choicesMod
...
trait Choices[T /* <: Answers */] extends js.Object {
  ...
  /**
    ...
    */
  def filter[TElement /* <: typingsJapgolly.inquirer.choiceMod.^[T] | typingsJapgolly.inquirer.separatorMod.^  */](
    callbackfn: js.Function3[
      /* value */ typingsJapgolly.inquirer.choiceMod.^[T] | typingsJapgolly.inquirer.separatorMod.^ , 
      /* index */ Double, 
      /* array */ js.Array[
        typingsJapgolly.inquirer.choiceMod.^[T] | typingsJapgolly.inquirer.separatorMod.^ 
      ], 
      /* is TElement */ Boolean
    ]
  ...
  ): typingsJapgolly.inquirer.choiceMod.^[T] | typingsJapgolly.inquirer.separatorMod.^  = js.native
  def find(
    predicate: js.Function3[
      /* value */ typingsJapgolly.inquirer.choiceMod.^[T] | typingsJapgolly.inquirer.separatorMod.^ , 
      /* index */ Double, 
  ...
  /**
    ...
    */
  def indexOf(searchElement: typingsJapgolly.inquirer.choiceMod.^[T]): Double = js.native
  def indexOf(searchElement: typingsJapgolly.inquirer.choiceMod.^[T], fromIndex: Double): Double = js.native
  def indexOf(searchElement: typingsJapgolly.inquirer.separatorMod.^): Double = js.native
  def indexOf(searchElement: typingsJapgolly.inquirer.separatorMod.^, fromIndex: Double): Double = js.native
  /**
  ...
  /**
    ...
    */
  def push(items: (typingsJapgolly.inquirer.choiceMod.^[T] | typingsJapgolly.inquirer.separatorMod.^ )*): Double = js.native
  /**
