package typingsJapgolly.inquirer.libUiPromptMod
...
import typingsJapgolly.inquirer.inquirerMod.ui.FetchedAnswer
import typingsJapgolly.inquirer.inquirerMod.ui.FetchedQuestion
...
@js.native
trait PromptUI
  extends typingsJapgolly.inquirer.libUiBaseUIMod.^ {
  /**
