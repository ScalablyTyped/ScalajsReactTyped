package typingsJapgolly.inquirer.libPromptsExpandMod

import typingsJapgolly.inquirer.inquirerMod.prompts.FailedPromptStateData
import typingsJapgolly.inquirer.inquirerMod.prompts.SuccessfulPromptStateData
...
trait ExpandPrompt[TQuestion /* <: Question */]
  extends typingsJapgolly.inquirer.libPromptsBaseMod.^[TQuestion] {
  /**
  ...
  /**
    ...
    */
  var paginator: typingsJapgolly.inquirer.libUtilsPaginatorMod.^ = js.native
  /**
