package typingsJapgolly.inquirer.libObjectsChoicesMod
...
trait Choices[T /* <: Answers */] extends js.Object {
  ...
  /**
    ...
    */
  def filter[TElement /* <: typingsJapgolly.inquirer.libObjectsChoiceMod.^[T] | typingsJapgolly.inquirer.libObjectsSeparatorMod.^  */](
    callbackfn: js.Function3[
      /* value */ typingsJapgolly.inquirer.libObjectsChoiceMod.^[T] | typingsJapgolly.inquirer.libObjectsSeparatorMod.^ , 
      /* index */ Double, 
      /* array */ js.Array[
        typingsJapgolly.inquirer.libObjectsChoiceMod.^[T] | typingsJapgolly.inquirer.libObjectsSeparatorMod.^ 
      ], 
      /* is TElement */ Boolean
    ]
  ...
  ): typingsJapgolly.inquirer.libObjectsChoiceMod.^[T] | typingsJapgolly.inquirer.libObjectsSeparatorMod.^  = js.native
  def find(
    predicate: js.Function3[
      /* value */ typingsJapgolly.inquirer.libObjectsChoiceMod.^[T] | typingsJapgolly.inquirer.libObjectsSeparatorMod.^ , 
      /* index */ Double, 
  ...
  /**
    ...
    */
  def indexOf(searchElement: typingsJapgolly.inquirer.libObjectsChoiceMod.^[T]): Double = js.native
  def indexOf(searchElement: typingsJapgolly.inquirer.libObjectsChoiceMod.^[T], fromIndex: Double): Double = js.native
  def indexOf(searchElement: typingsJapgolly.inquirer.libObjectsSeparatorMod.^): Double = js.native
  def indexOf(searchElement: typingsJapgolly.inquirer.libObjectsSeparatorMod.^, fromIndex: Double): Double = js.native
  /**
  ...
  /**
    ...
    */
  def push(
    items: (typingsJapgolly.inquirer.libObjectsChoiceMod.^[T] | typingsJapgolly.inquirer.libObjectsSeparatorMod.^ )*
  ): Double = js.native
  /**
