...
object default {
  ...
  open class Separator ()
    extends StObject
       with typingsJapgolly.inquirer.mod.inquirer.Separator {
  ...
  object ui {
    ...
    open class BottomBar ()
      extends typingsJapgolly.inquirer.mod.inquirer.ui.BottomBar {
    ...
    open class Prompt[T /* <: Answers */] protected ()
      extends typingsJapgolly.inquirer.mod.inquirer.ui.Prompt[T] {
      /**
