...
import typingsJapgolly.inquirer.anon.Type
...
object libObjectsChoicesMod {
  ...
  trait Choices[T /* <: Answers */] extends StObject {
    ...
    /**
      ...
      */
    def filter[TElement /* <: typingsJapgolly.inquirer.libObjectsChoiceMod.default[T] | typingsJapgolly.inquirer.libObjectsSeparatorMod.default */](
      callbackfn: js.Function3[
          /* value */ typingsJapgolly.inquirer.libObjectsChoiceMod.default[T] | typingsJapgolly.inquirer.libObjectsSeparatorMod.default, 
          /* index */ Double, 
          /* array */ js.Array[
            typingsJapgolly.inquirer.libObjectsChoiceMod.default[T] | typingsJapgolly.inquirer.libObjectsSeparatorMod.default
          ], 
          /* is TElement */ Boolean
        ]
    ...
    ): typingsJapgolly.inquirer.libObjectsChoiceMod.default[T] | typingsJapgolly.inquirer.libObjectsSeparatorMod.default = js.native
    def find(
      predicate: js.Function3[
          /* value */ typingsJapgolly.inquirer.libObjectsChoiceMod.default[T] | typingsJapgolly.inquirer.libObjectsSeparatorMod.default, 
          /* index */ Double, 
    ...
    /**
      ...
      */
    def indexOf(searchElement: typingsJapgolly.inquirer.libObjectsChoiceMod.default[T]): Double = js.native
    def indexOf(searchElement: typingsJapgolly.inquirer.libObjectsChoiceMod.default[T], fromIndex: Double): Double = js.native
    def indexOf(searchElement: typingsJapgolly.inquirer.libObjectsSeparatorMod.default): Double = js.native
    def indexOf(searchElement: typingsJapgolly.inquirer.libObjectsSeparatorMod.default, fromIndex: Double): Double = js.native
    ...
    /**
      ...
      */
    def push(
      items: (typingsJapgolly.inquirer.libObjectsChoiceMod.default[T] | typingsJapgolly.inquirer.libObjectsSeparatorMod.default)*
    ): Double = js.native
