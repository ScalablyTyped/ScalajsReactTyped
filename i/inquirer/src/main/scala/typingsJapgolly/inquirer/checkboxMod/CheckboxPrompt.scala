package typingsJapgolly.inquirer.checkboxMod

import typingsJapgolly.inquirer.mod.prompts.FailedPromptStateData
import typingsJapgolly.inquirer.mod.prompts.SuccessfulPromptStateData
...
trait CheckboxPrompt[TQuestion /* <: Question */]
  extends typingsJapgolly.inquirer.baseMod.^[TQuestion] {
  /**
    * Gets or sets an object for paginating the content.
    */
  var paginator: typingsJapgolly.inquirer.paginatorMod.^ = js.native
  /**
