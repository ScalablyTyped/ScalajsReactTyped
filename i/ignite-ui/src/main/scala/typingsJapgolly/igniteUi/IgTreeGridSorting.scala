...
object IgTreeGridSorting {
  ...
  inline def apply(): IgTreeGridSorting = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IgTreeGridSorting]
  }
  
  extension [Self <: IgTreeGridSorting](x: Self) {
    ...
    inline def setColumnSorted(value: (/* event */ Event, /* ui */ ColumnSortedEventUIParam) => Callback): Self = StObject.set(x, "columnSorted", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ColumnSortedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setColumnSortedUndefined: Self = StObject.set(x, "columnSorted", js.undefined)
    
    inline def setColumnSorting(value: (/* event */ Event, /* ui */ ColumnSortingEventUIParam) => Callback): Self = StObject.set(x, "columnSorting", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ColumnSortingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setModalDialogButtonUnsortClick(value: (/* event */ Event, /* ui */ ModalDialogButtonUnsortClickEventUIParam) => Callback): Self = StObject.set(x, "modalDialogButtonUnsortClick", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ModalDialogButtonUnsortClickEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setModalDialogSortClick(value: (/* event */ Event, /* ui */ ModalDialogSortClickEventUIParam) => Callback): Self = StObject.set(x, "modalDialogSortClick", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ModalDialogSortClickEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setModalDialogSortingChanged(value: (/* event */ Event, /* ui */ ModalDialogSortingChangedEventUIParam) => Callback): Self = StObject.set(x, "modalDialogSortingChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ModalDialogSortingChangedEventUIParam) => (value(t0, t1)).runNow()))
