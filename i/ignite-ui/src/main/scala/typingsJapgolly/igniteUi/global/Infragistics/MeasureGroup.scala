...
@js.native
open class MeasureGroup ()
  extends StObject
     with typingsJapgolly.igniteUi.Infragistics.MeasureGroup {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def catalogName(value: js.Object): String = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def cubeName(value: js.Object): String = js.native
