...
@js.native
open class IgValidatorBaseRule protected ()
  extends StObject
     with typingsJapgolly.igniteUi.Infragistics.IgValidatorBaseRule {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def isValid(options: js.Object, value: js.Object): Boolean = js.native
