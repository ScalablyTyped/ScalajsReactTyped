...
import typingsJapgolly.igniteUi.SelectionCollectionSettings
...
@js.native
open class SelectionCollection protected ()
  extends StObject
     with typingsJapgolly.igniteUi.Infragistics.SelectionCollection {
