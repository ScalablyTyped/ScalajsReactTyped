...
open class Measure ()
  extends StObject
     with typingsJapgolly.igniteUi.Infragistics.Measure {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def aggregatorType(value: js.Object): Double = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def defaultFormatString(value: js.Object): String = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def measureDisplayFolder(value: js.Object): String = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def measureGroupName(value: js.Object): String = js.native
