...
object IgGridSelection {
  ...
  extension [Self <: IgGridSelection](x: Self) {
    ...
    inline def setActiveCellChanging(value: (/* event */ Event, /* ui */ ActiveCellChangingEventUIParam) => Callback): Self = StObject.set(x, "activeCellChanging", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ActiveCellChangingEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setActiveCellChangingUndefined: Self = StObject.set(x, "activeCellChanging", js.undefined)
    
    inline def setActiveRowChanged(value: (/* event */ Event, /* ui */ ActiveRowChangedEventUIParam) => Callback): Self = StObject.set(x, "activeRowChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ActiveRowChangedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setActiveRowChangedUndefined: Self = StObject.set(x, "activeRowChanged", js.undefined)
    
    inline def setActiveRowChanging(value: (/* event */ Event, /* ui */ ActiveRowChangingEventUIParam) => Callback): Self = StObject.set(x, "activeRowChanging", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ActiveRowChangingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setCellSelectionChanged(value: (/* event */ Event, /* ui */ CellSelectionChangedEventUIParam) => Callback): Self = StObject.set(x, "cellSelectionChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ CellSelectionChangedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setCellSelectionChangedUndefined: Self = StObject.set(x, "cellSelectionChanged", js.undefined)
    
    inline def setCellSelectionChanging(value: (/* event */ Event, /* ui */ CellSelectionChangingEventUIParam) => Callback): Self = StObject.set(x, "cellSelectionChanging", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ CellSelectionChangingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setRowSelectionChanged(value: (/* event */ Event, /* ui */ RowSelectionChangedEventUIParam) => Callback): Self = StObject.set(x, "rowSelectionChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ RowSelectionChangedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setRowSelectionChangedUndefined: Self = StObject.set(x, "rowSelectionChanged", js.undefined)
    
    inline def setRowSelectionChanging(value: (/* event */ Event, /* ui */ RowSelectionChangingEventUIParam) => Callback): Self = StObject.set(x, "rowSelectionChanging", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ RowSelectionChangingEventUIParam) => (value(t0, t1)).runNow()))
