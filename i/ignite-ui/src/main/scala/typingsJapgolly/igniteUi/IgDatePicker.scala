...
object IgDatePicker {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    itemSelected: (/* event */ Event_, /* ui */ ItemSelectedEventUIParam) => Callback = null,
    ...
    if (itemSelected != null) __obj.updateDynamic("itemSelected")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ItemSelectedEventUIParam) => itemSelected(t0, t1).runNow()))
