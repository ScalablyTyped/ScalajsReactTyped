...
object IgDatePicker {
  ...
  extension [Self <: IgDatePicker](x: Self) {
    ...
    inline def setItemSelected(value: (/* event */ Event, /* ui */ ItemSelectedEventUIParam) => Callback): Self = StObject.set(x, "itemSelected", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ItemSelectedEventUIParam) => (value(t0, t1)).runNow()))
