...
object IgTree {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    locale: js.Any = null,
    nodeCheckstateChanged: (/* event */ Event_, /* ui */ NodeCheckstateChangedEventUIParam) => Callback = null,
    nodeCheckstateChanging: (/* event */ Event_, /* ui */ NodeCheckstateChangingEventUIParam) => Callback = null,
    nodeClick: (/* event */ Event_, /* ui */ NodeClickEventUIParam) => Callback = null,
    nodeCollapsed: (/* event */ Event_, /* ui */ NodeCollapsedEventUIParam) => Callback = null,
    nodeCollapsing: (/* event */ Event_, /* ui */ NodeCollapsingEventUIParam) => Callback = null,
    nodeDoubleClick: (/* event */ Event_, /* ui */ NodeDoubleClickEventUIParam) => Callback = null,
    nodeDropped: (/* event */ Event_, /* ui */ NodeDroppedEventUIParam) => Callback = null,
    nodeDropping: (/* event */ Event_, /* ui */ NodeDroppingEventUIParam) => Callback = null,
    nodeExpanded: (/* event */ Event_, /* ui */ NodeExpandedEventUIParam) => Callback = null,
    nodeExpanding: (/* event */ Event_, /* ui */ NodeExpandingEventUIParam) => Callback = null,
    nodePopulated: (/* event */ Event_, /* ui */ NodePopulatedEventUIParam) => Callback = null,
    nodePopulating: (/* event */ Event_, /* ui */ NodePopulatingEventUIParam) => Callback = null,
    ...
    selectionChanged: (/* event */ Event_, /* ui */ IgTreeSelectionChangedEventUIParam) => Callback = null,
    selectionChanging: (/* event */ Event_, /* ui */ SelectionChangingEventUIParam) => Callback = null,
    ...
    if (nodeCheckstateChanged != null) __obj.updateDynamic("nodeCheckstateChanged")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.NodeCheckstateChangedEventUIParam) => nodeCheckstateChanged(t0, t1).runNow()))
    if (nodeCheckstateChanging != null) __obj.updateDynamic("nodeCheckstateChanging")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.NodeCheckstateChangingEventUIParam) => nodeCheckstateChanging(t0, t1).runNow()))
    if (nodeClick != null) __obj.updateDynamic("nodeClick")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.NodeClickEventUIParam) => nodeClick(t0, t1).runNow()))
    if (nodeCollapsed != null) __obj.updateDynamic("nodeCollapsed")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.NodeCollapsedEventUIParam) => nodeCollapsed(t0, t1).runNow()))
    if (nodeCollapsing != null) __obj.updateDynamic("nodeCollapsing")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.NodeCollapsingEventUIParam) => nodeCollapsing(t0, t1).runNow()))
    if (nodeDoubleClick != null) __obj.updateDynamic("nodeDoubleClick")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.NodeDoubleClickEventUIParam) => nodeDoubleClick(t0, t1).runNow()))
    if (nodeDropped != null) __obj.updateDynamic("nodeDropped")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.NodeDroppedEventUIParam) => nodeDropped(t0, t1).runNow()))
    if (nodeDropping != null) __obj.updateDynamic("nodeDropping")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.NodeDroppingEventUIParam) => nodeDropping(t0, t1).runNow()))
    if (nodeExpanded != null) __obj.updateDynamic("nodeExpanded")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.NodeExpandedEventUIParam) => nodeExpanded(t0, t1).runNow()))
    if (nodeExpanding != null) __obj.updateDynamic("nodeExpanding")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.NodeExpandingEventUIParam) => nodeExpanding(t0, t1).runNow()))
    if (nodePopulated != null) __obj.updateDynamic("nodePopulated")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.NodePopulatedEventUIParam) => nodePopulated(t0, t1).runNow()))
    if (nodePopulating != null) __obj.updateDynamic("nodePopulating")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.NodePopulatingEventUIParam) => nodePopulating(t0, t1).runNow()))
    ...
    if (selectionChanged != null) __obj.updateDynamic("selectionChanged")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.IgTreeSelectionChangedEventUIParam) => selectionChanged(t0, t1).runNow()))
    if (selectionChanging != null) __obj.updateDynamic("selectionChanging")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.SelectionChangingEventUIParam) => selectionChanging(t0, t1).runNow()))
