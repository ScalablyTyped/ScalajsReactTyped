...
object IgPivotDataSelector {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    dataSelectorRendered: (/* event */ Event_, /* ui */ DataSelectorRenderedEventUIParam) => Callback = null,
    ...
    deferUpdateChanged: (/* event */ Event_, /* ui */ DeferUpdateChangedEventUIParam) => Callback = null,
    ...
    if (dataSelectorRendered != null) __obj.updateDynamic("dataSelectorRendered")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DataSelectorRenderedEventUIParam) => dataSelectorRendered(t0, t1).runNow()))
    ...
    if (deferUpdateChanged != null) __obj.updateDynamic("deferUpdateChanged")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DeferUpdateChangedEventUIParam) => deferUpdateChanged(t0, t1).runNow()))
