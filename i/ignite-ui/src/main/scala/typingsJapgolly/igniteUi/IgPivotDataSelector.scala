...
object IgPivotDataSelector {
  ...
  extension [Self <: IgPivotDataSelector](x: Self) {
    ...
    inline def setDataSelectorRendered(value: (/* event */ Event, /* ui */ DataSelectorRenderedEventUIParam) => Callback): Self = StObject.set(x, "dataSelectorRendered", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ DataSelectorRenderedEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setDeferUpdateChanged(value: (/* event */ Event, /* ui */ DeferUpdateChangedEventUIParam) => Callback): Self = StObject.set(x, "deferUpdateChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ DeferUpdateChangedEventUIParam) => (value(t0, t1)).runNow()))
