...
object IgGridResponsive {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    responsiveColumnHidden: (/* event */ Event_, /* ui */ ResponsiveColumnHiddenEventUIParam) => Callback = null,
    responsiveColumnHiding: (/* event */ Event_, /* ui */ ResponsiveColumnHidingEventUIParam) => Callback = null,
    responsiveColumnShowing: (/* event */ Event_, /* ui */ ResponsiveColumnShowingEventUIParam) => Callback = null,
    responsiveColumnShown: (/* event */ Event_, /* ui */ ResponsiveColumnShownEventUIParam) => Callback = null,
    responsiveModeChanged: (/* event */ Event_, /* ui */ ResponsiveModeChangedEventUIParam) => Callback = null,
    ...
    if (responsiveColumnHidden != null) __obj.updateDynamic("responsiveColumnHidden")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ResponsiveColumnHiddenEventUIParam) => responsiveColumnHidden(t0, t1).runNow()))
    if (responsiveColumnHiding != null) __obj.updateDynamic("responsiveColumnHiding")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ResponsiveColumnHidingEventUIParam) => responsiveColumnHiding(t0, t1).runNow()))
    if (responsiveColumnShowing != null) __obj.updateDynamic("responsiveColumnShowing")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ResponsiveColumnShowingEventUIParam) => responsiveColumnShowing(t0, t1).runNow()))
    if (responsiveColumnShown != null) __obj.updateDynamic("responsiveColumnShown")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ResponsiveColumnShownEventUIParam) => responsiveColumnShown(t0, t1).runNow()))
    if (responsiveModeChanged != null) __obj.updateDynamic("responsiveModeChanged")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ResponsiveModeChangedEventUIParam) => responsiveModeChanged(t0, t1).runNow()))
