...
object IgGridResponsive {
  ...
  extension [Self <: IgGridResponsive](x: Self) {
    ...
    inline def setResponsiveColumnHidden(value: (/* event */ Event, /* ui */ ResponsiveColumnHiddenEventUIParam) => Callback): Self = StObject.set(x, "responsiveColumnHidden", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ResponsiveColumnHiddenEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setResponsiveColumnHiddenUndefined: Self = StObject.set(x, "responsiveColumnHidden", js.undefined)
    
    inline def setResponsiveColumnHiding(value: (/* event */ Event, /* ui */ ResponsiveColumnHidingEventUIParam) => Callback): Self = StObject.set(x, "responsiveColumnHiding", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ResponsiveColumnHidingEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setResponsiveColumnHidingUndefined: Self = StObject.set(x, "responsiveColumnHiding", js.undefined)
    
    inline def setResponsiveColumnShowing(value: (/* event */ Event, /* ui */ ResponsiveColumnShowingEventUIParam) => Callback): Self = StObject.set(x, "responsiveColumnShowing", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ResponsiveColumnShowingEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setResponsiveColumnShowingUndefined: Self = StObject.set(x, "responsiveColumnShowing", js.undefined)
    
    inline def setResponsiveColumnShown(value: (/* event */ Event, /* ui */ ResponsiveColumnShownEventUIParam) => Callback): Self = StObject.set(x, "responsiveColumnShown", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ResponsiveColumnShownEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setResponsiveColumnShownUndefined: Self = StObject.set(x, "responsiveColumnShown", js.undefined)
    
    inline def setResponsiveModeChanged(value: (/* event */ Event, /* ui */ ResponsiveModeChangedEventUIParam) => Callback): Self = StObject.set(x, "responsiveModeChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ResponsiveModeChangedEventUIParam) => (value(t0, t1)).runNow()))
