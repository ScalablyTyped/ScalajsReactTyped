...
object IgGridFiltering {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    dataFiltered: (/* event */ Event_, /* ui */ DataFilteredEventUIParam) => Callback = null,
    dataFiltering: (/* event */ Event_, /* ui */ DataFilteringEventUIParam) => Callback = null,
    dialogWidget: String = null,
    dropDownClosed: (/* event */ Event_, /* ui */ DropDownClosedEventUIParam) => Callback = null,
    dropDownClosing: (/* event */ Event_, /* ui */ DropDownClosingEventUIParam) => Callback = null,
    dropDownOpened: (/* event */ Event_, /* ui */ DropDownOpenedEventUIParam) => Callback = null,
    dropDownOpening: (/* event */ Event_, /* ui */ DropDownOpeningEventUIParam) => Callback = null,
    ...
    filterDialogClosed: (/* event */ Event_, /* ui */ FilterDialogClosedEventUIParam) => Callback = null,
    filterDialogClosing: (/* event */ Event_, /* ui */ FilterDialogClosingEventUIParam) => Callback = null,
    filterDialogColumnDropDownDefaultWidth: String | Double = null,
    filterDialogContainment: String = null,
    filterDialogContentsRendered: (/* event */ Event_, /* ui */ FilterDialogContentsRenderedEventUIParam) => Callback = null,
    filterDialogContentsRendering: (/* event */ Event_, /* ui */ FilterDialogContentsRenderingEventUIParam) => Callback = null,
    filterDialogExprInputDefaultWidth: String | Double = null,
    filterDialogFilterAdded: (/* event */ Event_, /* ui */ FilterDialogFilterAddedEventUIParam) => Callback = null,
    filterDialogFilterAdding: (/* event */ Event_, /* ui */ FilterDialogFilterAddingEventUIParam) => Callback = null,
    ...
    filterDialogFiltering: (/* event */ Event_, /* ui */ FilterDialogFilteringEventUIParam) => Callback = null,
    filterDialogHeight: String | Double = null,
    filterDialogMaxFilterCount: Int | Double = null,
    filterDialogMoving: (/* event */ Event_, /* ui */ FilterDialogMovingEventUIParam) => Callback = null,
    filterDialogOkCancelButtonWidth: String | Double = null,
    filterDialogOpened: (/* event */ Event_, /* ui */ FilterDialogOpenedEventUIParam) => Callback = null,
    filterDialogOpening: (/* event */ Event_, /* ui */ FilterDialogOpeningEventUIParam) => Callback = null,
    ...
    if (dataFiltered != null) __obj.updateDynamic("dataFiltered")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DataFilteredEventUIParam) => dataFiltered(t0, t1).runNow()))
    if (dataFiltering != null) __obj.updateDynamic("dataFiltering")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DataFilteringEventUIParam) => dataFiltering(t0, t1).runNow()))
    if (dialogWidget != null) __obj.updateDynamic("dialogWidget")(dialogWidget.asInstanceOf[js.Any])
    if (dropDownClosed != null) __obj.updateDynamic("dropDownClosed")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DropDownClosedEventUIParam) => dropDownClosed(t0, t1).runNow()))
    if (dropDownClosing != null) __obj.updateDynamic("dropDownClosing")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DropDownClosingEventUIParam) => dropDownClosing(t0, t1).runNow()))
    if (dropDownOpened != null) __obj.updateDynamic("dropDownOpened")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DropDownOpenedEventUIParam) => dropDownOpened(t0, t1).runNow()))
    if (dropDownOpening != null) __obj.updateDynamic("dropDownOpening")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DropDownOpeningEventUIParam) => dropDownOpening(t0, t1).runNow()))
    ...
    if (filterDialogClosed != null) __obj.updateDynamic("filterDialogClosed")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FilterDialogClosedEventUIParam) => filterDialogClosed(t0, t1).runNow()))
    if (filterDialogClosing != null) __obj.updateDynamic("filterDialogClosing")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FilterDialogClosingEventUIParam) => filterDialogClosing(t0, t1).runNow()))
    ...
    if (filterDialogContentsRendered != null) __obj.updateDynamic("filterDialogContentsRendered")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FilterDialogContentsRenderedEventUIParam) => filterDialogContentsRendered(t0, t1).runNow()))
    if (filterDialogContentsRendering != null) __obj.updateDynamic("filterDialogContentsRendering")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FilterDialogContentsRenderingEventUIParam) => filterDialogContentsRendering(t0, t1).runNow()))
    ...
    if (filterDialogFilterAdded != null) __obj.updateDynamic("filterDialogFilterAdded")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FilterDialogFilterAddedEventUIParam) => filterDialogFilterAdded(t0, t1).runNow()))
    if (filterDialogFilterAdding != null) __obj.updateDynamic("filterDialogFilterAdding")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FilterDialogFilterAddingEventUIParam) => filterDialogFilterAdding(t0, t1).runNow()))
    ...
    if (filterDialogFiltering != null) __obj.updateDynamic("filterDialogFiltering")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FilterDialogFilteringEventUIParam) => filterDialogFiltering(t0, t1).runNow()))
    ...
    if (filterDialogMoving != null) __obj.updateDynamic("filterDialogMoving")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FilterDialogMovingEventUIParam) => filterDialogMoving(t0, t1).runNow()))
    ...
    if (filterDialogOpened != null) __obj.updateDynamic("filterDialogOpened")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FilterDialogOpenedEventUIParam) => filterDialogOpened(t0, t1).runNow()))
    if (filterDialogOpening != null) __obj.updateDynamic("filterDialogOpening")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FilterDialogOpeningEventUIParam) => filterDialogOpening(t0, t1).runNow()))
