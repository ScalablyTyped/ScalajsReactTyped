...
object IgDataChartSeries {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    angleMemberPath: Int | Double = null,
    areaFillOpacity: Int | Double = null,
    axisAnnoationFormatLabel: js.Any = null,
    axisAnnotationBackground: String = null,
    axisAnnotationInterpolatedValuePrecision: Int | Double = null,
    axisAnnotationOutline: String = null,
    axisAnnotationPaddingBottom: Int | Double = null,
    axisAnnotationPaddingLeft: Int | Double = null,
    axisAnnotationPaddingRight: Int | Double = null,
    axisAnnotationPaddingTop: Int | Double = null,
    axisAnnotationStrokeThickness: Int | Double = null,
    axisAnnotationTextColor: String = null,
    bandHighlightWidth: Int | Double = null,
    brush: String = null,
    ...
    calloutPaddingBottom: Int | Double = null,
    calloutPaddingLeft: Int | Double = null,
    calloutPaddingRight: Int | Double = null,
    calloutPaddingTop: Int | Double = null,
    calloutPositionPadding: Int | Double = null,
    calloutSeriesSelecting: js.Any = null,
    calloutStrokeThickness: Int | Double = null,
    ...
    heatMaximum: Int | Double = null,
    heatMaximumColor: js.Any = null,
    heatMinimum: Int | Double = null,
    ...
    maximumMarkers: Int | Double = null,
    ...
    trendLineZIndex: Int | Double = null,
    `type`: String = null,
    ...
    xAxisAnnotationInterpolatedValuePrecision: Int | Double = null,
    xAxisAnnotationOutline: String = null,
    xAxisAnnotationPaddingBottom: Int | Double = null,
    xAxisAnnotationPaddingLeft: Int | Double = null,
    xAxisAnnotationPaddingRight: Int | Double = null,
    xAxisAnnotationPaddingTop: Int | Double = null,
    xAxisAnnotationStrokeThickness: Int | Double = null,
    ...
    yAxisAnnotationInterpolatedValuePrecision: Int | Double = null,
    yAxisAnnotationOutline: String = null,
    yAxisAnnotationPaddingBottom: Int | Double = null,
    yAxisAnnotationPaddingLeft: Int | Double = null,
    yAxisAnnotationPaddingRight: Int | Double = null,
    yAxisAnnotationPaddingTop: Int | Double = null,
    yAxisAnnotationStrokeThickness: Int | Double = null,
    ...
    if (!js.isUndefined(clipSeriesToBounds)) __obj.updateDynamic("clipSeriesToBounds")(clipSeriesToBounds.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(expectFunctions)) __obj.updateDynamic("expectFunctions")(expectFunctions.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isAxisAnnotationEnabled)) __obj.updateDynamic("isAxisAnnotationEnabled")(isAxisAnnotationEnabled.asInstanceOf[js.Any])
    if (!js.isUndefined(isCalloutOffsettingEnabled)) __obj.updateDynamic("isCalloutOffsettingEnabled")(isCalloutOffsettingEnabled.asInstanceOf[js.Any])
    if (!js.isUndefined(isCustomCategoryMarkerStyleAllowed)) __obj.updateDynamic("isCustomCategoryMarkerStyleAllowed")(isCustomCategoryMarkerStyleAllowed.asInstanceOf[js.Any])
    if (!js.isUndefined(isCustomCategoryStyleAllowed)) __obj.updateDynamic("isCustomCategoryStyleAllowed")(isCustomCategoryStyleAllowed.asInstanceOf[js.Any])
    if (!js.isUndefined(isDefaultCrosshairDisabled)) __obj.updateDynamic("isDefaultCrosshairDisabled")(isDefaultCrosshairDisabled.asInstanceOf[js.Any])
    if (!js.isUndefined(isDropShadowEnabled)) __obj.updateDynamic("isDropShadowEnabled")(isDropShadowEnabled.asInstanceOf[js.Any])
    if (!js.isUndefined(isHighlightingEnabled)) __obj.updateDynamic("isHighlightingEnabled")(isHighlightingEnabled.asInstanceOf[js.Any])
    if (!js.isUndefined(isTransitionInEnabled)) __obj.updateDynamic("isTransitionInEnabled")(isTransitionInEnabled.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(mouseOverEnabled)) __obj.updateDynamic("mouseOverEnabled")(mouseOverEnabled.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(reverseLegendOrder)) __obj.updateDynamic("reverseLegendOrder")(reverseLegendOrder.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(skipUnknownValues)) __obj.updateDynamic("skipUnknownValues")(skipUnknownValues.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useBruteForce)) __obj.updateDynamic("useBruteForce")(useBruteForce.asInstanceOf[js.Any])
    if (!js.isUndefined(useCartesianInterpolation)) __obj.updateDynamic("useCartesianInterpolation")(useCartesianInterpolation.asInstanceOf[js.Any])
    if (!js.isUndefined(useHighMarkerFidelity)) __obj.updateDynamic("useHighMarkerFidelity")(useHighMarkerFidelity.asInstanceOf[js.Any])
    if (!js.isUndefined(useIndex)) __obj.updateDynamic("useIndex")(useIndex.asInstanceOf[js.Any])
    if (!js.isUndefined(useInterpolation)) __obj.updateDynamic("useInterpolation")(useInterpolation.asInstanceOf[js.Any])
    if (!js.isUndefined(useLegend)) __obj.updateDynamic("useLegend")(useLegend.asInstanceOf[js.Any])
    if (!js.isUndefined(useSingleShadow)) __obj.updateDynamic("useSingleShadow")(useSingleShadow.asInstanceOf[js.Any])
    if (!js.isUndefined(useSquareCutoffStyle)) __obj.updateDynamic("useSquareCutoffStyle")(useSquareCutoffStyle.asInstanceOf[js.Any])
