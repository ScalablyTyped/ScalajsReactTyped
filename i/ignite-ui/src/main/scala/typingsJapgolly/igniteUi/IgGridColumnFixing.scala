...
object IgGridColumnFixing {
  ...
  extension [Self <: IgGridColumnFixing](x: Self) {
    ...
    inline def setColumnFixed(value: (/* event */ Event, /* ui */ ColumnFixedEventUIParam) => Callback): Self = StObject.set(x, "columnFixed", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ColumnFixedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setColumnFixedUndefined: Self = StObject.set(x, "columnFixed", js.undefined)
    
    inline def setColumnFixing(value: (/* event */ Event, /* ui */ ColumnFixingEventUIParam) => Callback): Self = StObject.set(x, "columnFixing", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ColumnFixingEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setColumnFixingRefused(value: (/* event */ Event, /* ui */ ColumnFixingRefusedEventUIParam) => Callback): Self = StObject.set(x, "columnFixingRefused", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ColumnFixingRefusedEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setColumnUnfixed(value: (/* event */ Event, /* ui */ ColumnUnfixedEventUIParam) => Callback): Self = StObject.set(x, "columnUnfixed", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ColumnUnfixedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setColumnUnfixedUndefined: Self = StObject.set(x, "columnUnfixed", js.undefined)
    
    inline def setColumnUnfixing(value: (/* event */ Event, /* ui */ ColumnUnfixingEventUIParam) => Callback): Self = StObject.set(x, "columnUnfixing", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ColumnUnfixingEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setColumnUnfixingRefused(value: (/* event */ Event, /* ui */ ColumnUnfixingRefusedEventUIParam) => Callback): Self = StObject.set(x, "columnUnfixingRefused", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ColumnUnfixingRefusedEventUIParam) => (value(t0, t1)).runNow()))
