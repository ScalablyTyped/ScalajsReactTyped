...
object IgGridSummaries {
  ...
  extension [Self <: IgGridSummaries](x: Self) {
    ...
    inline def setDropDownCancelClicked(value: (/* event */ Event, /* ui */ DropDownCancelClickedEventUIParam) => Callback): Self = StObject.set(x, "dropDownCancelClicked", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ DropDownCancelClickedEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setDropDownOKClicked(value: (/* event */ Event, /* ui */ DropDownOKClickedEventUIParam) => Callback): Self = StObject.set(x, "dropDownOKClicked", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ DropDownOKClickedEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setSummariesCalculated(value: (/* event */ Event, /* ui */ SummariesCalculatedEventUIParam) => Callback): Self = StObject.set(x, "summariesCalculated", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ SummariesCalculatedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setSummariesCalculatedUndefined: Self = StObject.set(x, "summariesCalculated", js.undefined)
    
    inline def setSummariesCalculating(value: (/* event */ Event, /* ui */ SummariesCalculatingEventUIParam) => Callback): Self = StObject.set(x, "summariesCalculating", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ SummariesCalculatingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setSummariesMethodSelectionChanged(value: (/* event */ Event, /* ui */ SummariesMethodSelectionChangedEventUIParam) => Callback): Self = StObject.set(x, "summariesMethodSelectionChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ SummariesMethodSelectionChangedEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setSummariesToggled(value: (/* event */ Event, /* ui */ SummariesToggledEventUIParam) => Callback): Self = StObject.set(x, "summariesToggled", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ SummariesToggledEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setSummariesToggledUndefined: Self = StObject.set(x, "summariesToggled", js.undefined)
    
    inline def setSummariesToggling(value: (/* event */ Event, /* ui */ SummariesTogglingEventUIParam) => Callback): Self = StObject.set(x, "summariesToggling", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ SummariesTogglingEventUIParam) => (value(t0, t1)).runNow()))
