...
object IgGridSummaries {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    dropDownCancelClicked: (/* event */ Event_, /* ui */ DropDownCancelClickedEventUIParam) => Callback = null,
    ...
    dropDownOKClicked: (/* event */ Event_, /* ui */ DropDownOKClickedEventUIParam) => Callback = null,
    ...
    summariesCalculated: (/* event */ Event_, /* ui */ SummariesCalculatedEventUIParam) => Callback = null,
    summariesCalculating: (/* event */ Event_, /* ui */ SummariesCalculatingEventUIParam) => Callback = null,
    summariesHeaderButtonTooltip: String = null,
    summariesMethodSelectionChanged: (/* event */ Event_, /* ui */ SummariesMethodSelectionChangedEventUIParam) => Callback = null,
    summariesResponseKey: String = null,
    summariesToggled: (/* event */ Event_, /* ui */ SummariesToggledEventUIParam) => Callback = null,
    summariesToggling: (/* event */ Event_, /* ui */ SummariesTogglingEventUIParam) => Callback = null,
    ...
    if (dropDownCancelClicked != null) __obj.updateDynamic("dropDownCancelClicked")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DropDownCancelClickedEventUIParam) => dropDownCancelClicked(t0, t1).runNow()))
    ...
    if (dropDownOKClicked != null) __obj.updateDynamic("dropDownOKClicked")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DropDownOKClickedEventUIParam) => dropDownOKClicked(t0, t1).runNow()))
    ...
    if (summariesCalculated != null) __obj.updateDynamic("summariesCalculated")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.SummariesCalculatedEventUIParam) => summariesCalculated(t0, t1).runNow()))
    if (summariesCalculating != null) __obj.updateDynamic("summariesCalculating")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.SummariesCalculatingEventUIParam) => summariesCalculating(t0, t1).runNow()))
    ...
    if (summariesMethodSelectionChanged != null) __obj.updateDynamic("summariesMethodSelectionChanged")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.SummariesMethodSelectionChangedEventUIParam) => summariesMethodSelectionChanged(t0, t1).runNow()))
    if (summariesResponseKey != null) __obj.updateDynamic("summariesResponseKey")(summariesResponseKey.asInstanceOf[js.Any])
    if (summariesToggled != null) __obj.updateDynamic("summariesToggled")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.SummariesToggledEventUIParam) => summariesToggled(t0, t1).runNow()))
    if (summariesToggling != null) __obj.updateDynamic("summariesToggling")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.SummariesTogglingEventUIParam) => summariesToggling(t0, t1).runNow()))
