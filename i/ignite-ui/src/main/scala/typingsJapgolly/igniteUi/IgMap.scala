...
object IgMap {
  ...
  extension [Self <: IgMap](x: Self) {
    ...
    inline def setTriangulationStatusChanged(value: (/* event */ Event, /* ui */ TriangulationStatusChangedEventUIParam) => Callback): Self = StObject.set(x, "triangulationStatusChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ TriangulationStatusChangedEventUIParam) => (value(t0, t1)).runNow()))
