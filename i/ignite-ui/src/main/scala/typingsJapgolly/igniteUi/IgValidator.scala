...
object IgValidator {
  ...
  extension [Self <: IgValidator](x: Self) {
    ...
    inline def setError(value: (/* event */ Event, /* ui */ ErrorEventUIParam) => Callback): Self = StObject.set(x, "error", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ErrorEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setErrorHidden(value: (/* event */ Event, /* ui */ ErrorHiddenEventUIParam) => Callback): Self = StObject.set(x, "errorHidden", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ErrorHiddenEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setErrorHiddenUndefined: Self = StObject.set(x, "errorHidden", js.undefined)
    
    inline def setErrorHiding(value: (/* event */ Event, /* ui */ ErrorHidingEventUIParam) => Callback): Self = StObject.set(x, "errorHiding", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ErrorHidingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setErrorShowing(value: (/* event */ Event, /* ui */ ErrorShowingEventUIParam) => Callback): Self = StObject.set(x, "errorShowing", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ErrorShowingEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setErrorShowingUndefined: Self = StObject.set(x, "errorShowing", js.undefined)
    
    inline def setErrorShown(value: (/* event */ Event, /* ui */ ErrorShownEventUIParam) => Callback): Self = StObject.set(x, "errorShown", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ErrorShownEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setFormError(value: (/* event */ Event, /* ui */ FormErrorEventUIParam) => Callback): Self = StObject.set(x, "formError", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ FormErrorEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setFormErrorUndefined: Self = StObject.set(x, "formError", js.undefined)
    
    inline def setFormSuccess(value: (/* event */ Event, /* ui */ FormSuccessEventUIParam) => Callback): Self = StObject.set(x, "formSuccess", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ FormSuccessEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setFormSuccessUndefined: Self = StObject.set(x, "formSuccess", js.undefined)
    
    inline def setFormValidated(value: (/* event */ Event, /* ui */ FormValidatedEventUIParam) => Callback): Self = StObject.set(x, "formValidated", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ FormValidatedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setFormValidatedUndefined: Self = StObject.set(x, "formValidated", js.undefined)
    
    inline def setFormValidating(value: (/* event */ Event, /* ui */ FormValidatingEventUIParam) => Callback): Self = StObject.set(x, "formValidating", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ FormValidatingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setSuccess(value: (/* event */ Event, /* ui */ SuccessEventUIParam) => Callback): Self = StObject.set(x, "success", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ SuccessEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setSuccessHidden(value: (/* event */ Event, /* ui */ SuccessHiddenEventUIParam) => Callback): Self = StObject.set(x, "successHidden", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ SuccessHiddenEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setSuccessHiddenUndefined: Self = StObject.set(x, "successHidden", js.undefined)
    
    inline def setSuccessHiding(value: (/* event */ Event, /* ui */ SuccessHidingEventUIParam) => Callback): Self = StObject.set(x, "successHiding", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ SuccessHidingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setSuccessShowing(value: (/* event */ Event, /* ui */ SuccessShowingEventUIParam) => Callback): Self = StObject.set(x, "successShowing", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ SuccessShowingEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setSuccessShowingUndefined: Self = StObject.set(x, "successShowing", js.undefined)
    
    inline def setSuccessShown(value: (/* event */ Event, /* ui */ SuccessShownEventUIParam) => Callback): Self = StObject.set(x, "successShown", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ SuccessShownEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setValidated(value: (/* event */ Event, /* ui */ ValidatedEventUIParam) => Callback): Self = StObject.set(x, "validated", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ValidatedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setValidatedUndefined: Self = StObject.set(x, "validated", js.undefined)
    
    inline def setValidating(value: (/* event */ Event, /* ui */ ValidatingEventUIParam) => Callback): Self = StObject.set(x, "validating", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ValidatingEventUIParam) => (value(t0, t1)).runNow()))
