...
object IgValidator {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    error: (/* event */ Event_, /* ui */ ErrorEventUIParam) => Callback = null,
    errorHidden: (/* event */ Event_, /* ui */ ErrorHiddenEventUIParam) => Callback = null,
    errorHiding: (/* event */ Event_, /* ui */ ErrorHidingEventUIParam) => Callback = null,
    errorMessage: String = null,
    errorShowing: (/* event */ Event_, /* ui */ ErrorShowingEventUIParam) => Callback = null,
    errorShown: (/* event */ Event_, /* ui */ ErrorShownEventUIParam) => Callback = null,
    executeAllRules: js.UndefOr[Boolean] = js.undefined,
    fields: js.Array[IgValidatorField] = null,
    formError: (/* event */ Event_, /* ui */ FormErrorEventUIParam) => Callback = null,
    formSuccess: (/* event */ Event_, /* ui */ FormSuccessEventUIParam) => Callback = null,
    formValidated: (/* event */ Event_, /* ui */ FormValidatedEventUIParam) => Callback = null,
    formValidating: (/* event */ Event_, /* ui */ FormValidatingEventUIParam) => Callback = null,
    ...
    success: (/* event */ Event_, /* ui */ SuccessEventUIParam) => Callback = null,
    successHidden: (/* event */ Event_, /* ui */ SuccessHiddenEventUIParam) => Callback = null,
    successHiding: (/* event */ Event_, /* ui */ SuccessHidingEventUIParam) => Callback = null,
    successMessage: String = null,
    successShowing: (/* event */ Event_, /* ui */ SuccessShowingEventUIParam) => Callback = null,
    successShown: (/* event */ Event_, /* ui */ SuccessShownEventUIParam) => Callback = null,
    threshold: Int | Double = null,
    validated: (/* event */ Event_, /* ui */ ValidatedEventUIParam) => Callback = null,
    validating: (/* event */ Event_, /* ui */ ValidatingEventUIParam) => Callback = null,
    ...
    if (error != null) __obj.updateDynamic("error")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ErrorEventUIParam) => error(t0, t1).runNow()))
    if (errorHidden != null) __obj.updateDynamic("errorHidden")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ErrorHiddenEventUIParam) => errorHidden(t0, t1).runNow()))
    if (errorHiding != null) __obj.updateDynamic("errorHiding")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ErrorHidingEventUIParam) => errorHiding(t0, t1).runNow()))
    if (errorMessage != null) __obj.updateDynamic("errorMessage")(errorMessage.asInstanceOf[js.Any])
    if (errorShowing != null) __obj.updateDynamic("errorShowing")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ErrorShowingEventUIParam) => errorShowing(t0, t1).runNow()))
    if (errorShown != null) __obj.updateDynamic("errorShown")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ErrorShownEventUIParam) => errorShown(t0, t1).runNow()))
    if (!js.isUndefined(executeAllRules)) __obj.updateDynamic("executeAllRules")(executeAllRules.asInstanceOf[js.Any])
    if (fields != null) __obj.updateDynamic("fields")(fields.asInstanceOf[js.Any])
    if (formError != null) __obj.updateDynamic("formError")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FormErrorEventUIParam) => formError(t0, t1).runNow()))
    if (formSuccess != null) __obj.updateDynamic("formSuccess")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FormSuccessEventUIParam) => formSuccess(t0, t1).runNow()))
    if (formValidated != null) __obj.updateDynamic("formValidated")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FormValidatedEventUIParam) => formValidated(t0, t1).runNow()))
    if (formValidating != null) __obj.updateDynamic("formValidating")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FormValidatingEventUIParam) => formValidating(t0, t1).runNow()))
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.SuccessEventUIParam) => success(t0, t1).runNow()))
    if (successHidden != null) __obj.updateDynamic("successHidden")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.SuccessHiddenEventUIParam) => successHidden(t0, t1).runNow()))
    if (successHiding != null) __obj.updateDynamic("successHiding")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.SuccessHidingEventUIParam) => successHiding(t0, t1).runNow()))
    if (successMessage != null) __obj.updateDynamic("successMessage")(successMessage.asInstanceOf[js.Any])
    if (successShowing != null) __obj.updateDynamic("successShowing")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.SuccessShowingEventUIParam) => successShowing(t0, t1).runNow()))
    if (successShown != null) __obj.updateDynamic("successShown")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.SuccessShownEventUIParam) => successShown(t0, t1).runNow()))
    if (threshold != null) __obj.updateDynamic("threshold")(threshold.asInstanceOf[js.Any])
    if (validated != null) __obj.updateDynamic("validated")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ValidatedEventUIParam) => validated(t0, t1).runNow()))
    if (validating != null) __obj.updateDynamic("validating")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ValidatingEventUIParam) => validating(t0, t1).runNow()))
