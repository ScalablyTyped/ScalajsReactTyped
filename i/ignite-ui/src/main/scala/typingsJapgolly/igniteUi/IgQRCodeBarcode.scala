...
object IgQRCodeBarcode {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    data: String = null,
    dataChanged: (/* event */ Event_, /* ui */ DataChangedEventUIParam) => Callback = null,
    eciHeaderDisplayMode: String = null,
    eciNumber: Int | Double = null,
    encodingMode: String = null,
    errorCorrectionLevel: String = null,
    errorMessageDisplaying: (/* event */ Event_, /* ui */ ErrorMessageDisplayingEventUIParam) => Callback = null,
    ...
    if (dataChanged != null) __obj.updateDynamic("dataChanged")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DataChangedEventUIParam) => dataChanged(t0, t1).runNow()))
    ...
    if (errorMessageDisplaying != null) __obj.updateDynamic("errorMessageDisplaying")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ErrorMessageDisplayingEventUIParam) => errorMessageDisplaying(t0, t1).runNow()))
