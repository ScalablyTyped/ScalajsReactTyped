...
object IgQRCodeBarcode {
  ...
  extension [Self <: IgQRCodeBarcode](x: Self) {
    ...
    inline def setDataChanged(value: (/* event */ Event, /* ui */ DataChangedEventUIParam) => Callback): Self = StObject.set(x, "dataChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ DataChangedEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setErrorMessageDisplaying(value: (/* event */ Event, /* ui */ ErrorMessageDisplayingEventUIParam) => Callback): Self = StObject.set(x, "errorMessageDisplaying", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ErrorMessageDisplayingEventUIParam) => (value(t0, t1)).runNow()))
