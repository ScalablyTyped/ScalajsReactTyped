...
object IgPivotViewDataSourceOptionsFlatDataOptions {
  ...
  inline def apply(): IgPivotViewDataSourceOptionsFlatDataOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IgPivotViewDataSourceOptionsFlatDataOptions]
  }
  
  extension [Self <: IgPivotViewDataSourceOptionsFlatDataOptions](x: Self) {
    ...
    inline def setMetadata(value: IgPivotViewDataSourceOptionsFlatDataOptionsMetadata): Self = StObject.set(x, "metadata", value.asInstanceOf[js.Any])
