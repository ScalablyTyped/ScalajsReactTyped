...
object IgHierarchicalGrid {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    childGridCreated: (/* event */ Event_, /* ui */ ChildGridCreatedEventUIParam) => Callback = null,
    childGridCreating: (/* event */ Event_, /* ui */ ChildGridCreatingEventUIParam) => Callback = null,
    childGridRendered: (/* event */ Event_, /* ui */ ChildGridRenderedEventUIParam) => Callback = null,
    childrenPopulated: (/* event */ Event_, /* ui */ ChildrenPopulatedEventUIParam) => Callback = null,
    childrenPopulating: (/* event */ Event_, /* ui */ ChildrenPopulatingEventUIParam) => Callback = null,
    ...
    if (childGridCreated != null) __obj.updateDynamic("childGridCreated")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ChildGridCreatedEventUIParam) => childGridCreated(t0, t1).runNow()))
    if (childGridCreating != null) __obj.updateDynamic("childGridCreating")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ChildGridCreatingEventUIParam) => childGridCreating(t0, t1).runNow()))
    if (childGridRendered != null) __obj.updateDynamic("childGridRendered")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ChildGridRenderedEventUIParam) => childGridRendered(t0, t1).runNow()))
    if (childrenPopulated != null) __obj.updateDynamic("childrenPopulated")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ChildrenPopulatedEventUIParam) => childrenPopulated(t0, t1).runNow()))
    if (childrenPopulating != null) __obj.updateDynamic("childrenPopulating")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ChildrenPopulatingEventUIParam) => childrenPopulating(t0, t1).runNow()))
