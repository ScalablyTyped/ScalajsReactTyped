...
object IgZoombar {
  ...
  extension [Self <: IgZoombar](x: Self) {
    ...
    inline def setProviderCreated(value: (/* event */ Event, /* ui */ ProviderCreatedEventUIParam) => Callback): Self = StObject.set(x, "providerCreated", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ProviderCreatedEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setWindowDragEnded(value: (/* event */ Event, /* ui */ WindowDragEndedEventUIParam) => Callback): Self = StObject.set(x, "windowDragEnded", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ WindowDragEndedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setWindowDragEndedUndefined: Self = StObject.set(x, "windowDragEnded", js.undefined)
    
    inline def setWindowDragEnding(value: (/* event */ Event, /* ui */ WindowDragEndingEventUIParam) => Callback): Self = StObject.set(x, "windowDragEnding", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ WindowDragEndingEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setWindowDragEndingUndefined: Self = StObject.set(x, "windowDragEnding", js.undefined)
    
    inline def setWindowDragStarted(value: (/* event */ Event, /* ui */ WindowDragStartedEventUIParam) => Callback): Self = StObject.set(x, "windowDragStarted", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ WindowDragStartedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setWindowDragStartedUndefined: Self = StObject.set(x, "windowDragStarted", js.undefined)
    
    inline def setWindowDragStarting(value: (/* event */ Event, /* ui */ WindowDragStartingEventUIParam) => Callback): Self = StObject.set(x, "windowDragStarting", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ WindowDragStartingEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setWindowDragStartingUndefined: Self = StObject.set(x, "windowDragStarting", js.undefined)
    
    inline def setWindowDragging(value: (/* event */ Event, /* ui */ WindowDraggingEventUIParam) => Callback): Self = StObject.set(x, "windowDragging", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ WindowDraggingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setWindowResizing(value: (/* event */ Event, /* ui */ WindowResizingEventUIParam) => Callback): Self = StObject.set(x, "windowResizing", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ WindowResizingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setZoomChanged(value: (/* event */ Event, /* ui */ ZoomChangedEventUIParam) => Callback): Self = StObject.set(x, "zoomChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ZoomChangedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setZoomChangedUndefined: Self = StObject.set(x, "zoomChanged", js.undefined)
    
    inline def setZoomChanging(value: (/* event */ Event, /* ui */ ZoomChangingEventUIParam) => Callback): Self = StObject.set(x, "zoomChanging", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ZoomChangingEventUIParam) => (value(t0, t1)).runNow()))
