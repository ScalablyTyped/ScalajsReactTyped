...
object IgZoombar {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    providerCreated: (/* event */ Event_, /* ui */ ProviderCreatedEventUIParam) => Callback = null,
    regional: String | js.Object = null,
    tabIndex: Int | Double = null,
    target: String | js.Object = null,
    width: String | Double = null,
    windowDragEnded: (/* event */ Event_, /* ui */ WindowDragEndedEventUIParam) => Callback = null,
    windowDragEnding: (/* event */ Event_, /* ui */ WindowDragEndingEventUIParam) => Callback = null,
    windowDragStarted: (/* event */ Event_, /* ui */ WindowDragStartedEventUIParam) => Callback = null,
    windowDragStarting: (/* event */ Event_, /* ui */ WindowDragStartingEventUIParam) => Callback = null,
    windowDragging: (/* event */ Event_, /* ui */ WindowDraggingEventUIParam) => Callback = null,
    windowPanDuration: Int | Double = null,
    windowResized: (/* event */ Event_, /* ui */ WindowResizedEventUIParam) => Callback = null,
    windowResizing: (/* event */ Event_, /* ui */ WindowResizingEventUIParam) => Callback = null,
    zoomAction: String = null,
    zoomChanged: (/* event */ Event_, /* ui */ ZoomChangedEventUIParam) => Callback = null,
    zoomChanging: (/* event */ Event_, /* ui */ ZoomChangingEventUIParam) => Callback = null,
    ...
    if (providerCreated != null) __obj.updateDynamic("providerCreated")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ProviderCreatedEventUIParam) => providerCreated(t0, t1).runNow()))
    if (regional != null) __obj.updateDynamic("regional")(regional.asInstanceOf[js.Any])
    if (tabIndex != null) __obj.updateDynamic("tabIndex")(tabIndex.asInstanceOf[js.Any])
    if (target != null) __obj.updateDynamic("target")(target.asInstanceOf[js.Any])
    if (width != null) __obj.updateDynamic("width")(width.asInstanceOf[js.Any])
    if (windowDragEnded != null) __obj.updateDynamic("windowDragEnded")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.WindowDragEndedEventUIParam) => windowDragEnded(t0, t1).runNow()))
    if (windowDragEnding != null) __obj.updateDynamic("windowDragEnding")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.WindowDragEndingEventUIParam) => windowDragEnding(t0, t1).runNow()))
    if (windowDragStarted != null) __obj.updateDynamic("windowDragStarted")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.WindowDragStartedEventUIParam) => windowDragStarted(t0, t1).runNow()))
    if (windowDragStarting != null) __obj.updateDynamic("windowDragStarting")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.WindowDragStartingEventUIParam) => windowDragStarting(t0, t1).runNow()))
    if (windowDragging != null) __obj.updateDynamic("windowDragging")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.WindowDraggingEventUIParam) => windowDragging(t0, t1).runNow()))
    ...
    if (windowResizing != null) __obj.updateDynamic("windowResizing")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.WindowResizingEventUIParam) => windowResizing(t0, t1).runNow()))
    if (zoomAction != null) __obj.updateDynamic("zoomAction")(zoomAction.asInstanceOf[js.Any])
    if (zoomChanged != null) __obj.updateDynamic("zoomChanged")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ZoomChangedEventUIParam) => zoomChanged(t0, t1).runNow()))
    if (zoomChanging != null) __obj.updateDynamic("zoomChanging")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ZoomChangingEventUIParam) => zoomChanging(t0, t1).runNow()))
