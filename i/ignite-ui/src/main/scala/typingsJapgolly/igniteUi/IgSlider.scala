...
object IgSlider {
  ...
  extension [Self <: IgSlider](x: Self) {
    ...
    inline def setBookmarkClick(value: (/* event */ Event, /* ui */ BookmarkClickEventUIParam) => Callback): Self = StObject.set(x, "bookmarkClick", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ BookmarkClickEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setBookmarkClickUndefined: Self = StObject.set(x, "bookmarkClick", js.undefined)
    
    inline def setBookmarkHit(value: (/* event */ Event, /* ui */ BookmarkHitEventUIParam) => Callback): Self = StObject.set(x, "bookmarkHit", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ BookmarkHitEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setSlide(value: (/* event */ Event, /* ui */ SlideEventUIParam) => Callback): Self = StObject.set(x, "slide", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ SlideEventUIParam) => (value(t0, t1)).runNow()))
