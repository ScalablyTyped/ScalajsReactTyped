...
object IgDataChart {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    assigningCategoryMarkerStyle: (/* event */ Event_, /* ui */ AssigningCategoryMarkerStyleEventUIParam) => Callback = null,
    assigningCategoryStyle: (/* event */ Event_, /* ui */ AssigningCategoryStyleEventUIParam) => Callback = null,
    autoMarginHeight: Int | Double = null,
    autoMarginWidth: Int | Double = null,
    axes: js.Array[IgDataChartAxes] = null,
    axisRangeChanged: (/* event */ Event_, /* ui */ AxisRangeChangedEventUIParam) => Callback = null,
    ...
    progressiveLoadStatusChanged: (/* event */ Event_, /* ui */ ProgressiveLoadStatusChangedEventUIParam) => Callback = null,
    ...
    typicalBasedOn: (/* event */ Event_, /* ui */ TypicalBasedOnEventUIParam) => Callback = null,
    ...
    if (assigningCategoryMarkerStyle != null) __obj.updateDynamic("assigningCategoryMarkerStyle")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.AssigningCategoryMarkerStyleEventUIParam) => assigningCategoryMarkerStyle(t0, t1).runNow()))
    if (assigningCategoryStyle != null) __obj.updateDynamic("assigningCategoryStyle")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.AssigningCategoryStyleEventUIParam) => assigningCategoryStyle(t0, t1).runNow()))
    ...
    if (axisRangeChanged != null) __obj.updateDynamic("axisRangeChanged")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.AxisRangeChangedEventUIParam) => axisRangeChanged(t0, t1).runNow()))
    ...
    if (progressiveLoadStatusChanged != null) __obj.updateDynamic("progressiveLoadStatusChanged")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ProgressiveLoadStatusChangedEventUIParam) => progressiveLoadStatusChanged(t0, t1).runNow()))
    ...
    if (typicalBasedOn != null) __obj.updateDynamic("typicalBasedOn")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.TypicalBasedOnEventUIParam) => typicalBasedOn(t0, t1).runNow()))
