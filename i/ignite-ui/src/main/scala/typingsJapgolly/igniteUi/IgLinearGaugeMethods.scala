...
object IgLinearGaugeMethods {
  ...
  def apply(
    ...
    needleContainsPoint: (Double, Double) => CallbackTo[Boolean],
    ...
    __obj.updateDynamic("needleContainsPoint")(js.Any.fromFunction2((t0: scala.Double, t1: scala.Double) => needleContainsPoint(t0, t1).runNow()))
