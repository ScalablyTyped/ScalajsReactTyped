...
trait IgFinancialChartMethods extends StObject {
...
object IgFinancialChartMethods {
  ...
  extension [Self <: IgFinancialChartMethods](x: Self) {
    ...
    inline def setId(value: Callback): Self = StObject.set(x, "id", value.toJsFn)
