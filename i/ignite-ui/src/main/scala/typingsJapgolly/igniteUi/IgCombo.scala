...
object IgCombo {
  ...
  extension [Self <: IgCombo](x: Self) {
    ...
    inline def setFiltered(value: (/* event */ Event, /* ui */ FilteredEventUIParam) => Callback): Self = StObject.set(x, "filtered", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ FilteredEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setFilteredUndefined: Self = StObject.set(x, "filtered", js.undefined)
    
    inline def setFiltering(value: (/* event */ Event, /* ui */ FilteringEventUIParam) => Callback): Self = StObject.set(x, "filtering", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ FilteringEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setItemsRendered(value: (/* event */ Event, /* ui */ ItemsRenderedEventUIParam) => Callback): Self = StObject.set(x, "itemsRendered", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ItemsRenderedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setItemsRenderedUndefined: Self = StObject.set(x, "itemsRendered", js.undefined)
    
    inline def setItemsRendering(value: (/* event */ Event, /* ui */ ItemsRenderingEventUIParam) => Callback): Self = StObject.set(x, "itemsRendering", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ItemsRenderingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setSelectionChanged(value: (/* event */ Event, /* ui */ IgComboSelectionChangedEventUIParam) => Callback): Self = StObject.set(x, "selectionChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ IgComboSelectionChangedEventUIParam) => (value(t0, t1)).runNow()))
