...
object IgCombo {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    filtered: (/* event */ Event_, /* ui */ FilteredEventUIParam) => Callback = null,
    filtering: (/* event */ Event_, /* ui */ FilteringEventUIParam) => Callback = null,
    ...
    itemsRendered: (/* event */ Event_, /* ui */ ItemsRenderedEventUIParam) => Callback = null,
    itemsRendering: (/* event */ Event_, /* ui */ ItemsRenderingEventUIParam) => Callback = null,
    ...
    selectionChanged: (/* event */ Event_, /* ui */ IgComboSelectionChangedEventUIParam) => Callback = null,
    ...
    if (filtered != null) __obj.updateDynamic("filtered")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FilteredEventUIParam) => filtered(t0, t1).runNow()))
    if (filtering != null) __obj.updateDynamic("filtering")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FilteringEventUIParam) => filtering(t0, t1).runNow()))
    ...
    if (itemsRendered != null) __obj.updateDynamic("itemsRendered")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ItemsRenderedEventUIParam) => itemsRendered(t0, t1).runNow()))
    if (itemsRendering != null) __obj.updateDynamic("itemsRendering")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ItemsRenderingEventUIParam) => itemsRendering(t0, t1).runNow()))
    ...
    if (selectionChanged != null) __obj.updateDynamic("selectionChanged")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.IgComboSelectionChangedEventUIParam) => selectionChanged(t0, t1).runNow()))
