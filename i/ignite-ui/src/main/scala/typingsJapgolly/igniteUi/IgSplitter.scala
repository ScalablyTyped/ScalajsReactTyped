...
object IgSplitter {
  ...
  extension [Self <: IgSplitter](x: Self) {
    ...
    inline def setLayoutRefreshed(value: (/* event */ Event, /* ui */ LayoutRefreshedEventUIParam) => Callback): Self = StObject.set(x, "layoutRefreshed", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ LayoutRefreshedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setLayoutRefreshedUndefined: Self = StObject.set(x, "layoutRefreshed", js.undefined)
    
    inline def setLayoutRefreshing(value: (/* event */ Event, /* ui */ LayoutRefreshingEventUIParam) => Callback): Self = StObject.set(x, "layoutRefreshing", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ LayoutRefreshingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setResizeEnded(value: (/* event */ Event, /* ui */ ResizeEndedEventUIParam) => Callback): Self = StObject.set(x, "resizeEnded", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ResizeEndedEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setResizeStarted(value: (/* event */ Event, /* ui */ ResizeStartedEventUIParam) => Callback): Self = StObject.set(x, "resizeStarted", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ResizeStartedEventUIParam) => (value(t0, t1)).runNow()))
