...
object IgTreeGrid {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    caption: String = null,
    captionRendered: (/* event */ Event_, /* ui */ CaptionRenderedEventUIParam) => Callback = null,
    captionRendering: (/* event */ Event_, /* ui */ CaptionRenderingEventUIParam) => Callback = null,
    cellClick: (/* event */ Event_, /* ui */ CellClickEventUIParam) => Callback = null,
    cellRightClick: (/* event */ Event_, /* ui */ CellRightClickEventUIParam) => Callback = null,
    ...
    columnsCollectionModified: (/* event */ Event_, /* ui */ ColumnsCollectionModifiedEventUIParam) => Callback = null,
    created: (/* event */ Event_, /* ui */ CreatedEventUIParam) => Callback = null,
    ...
    dataRendered: (/* event */ Event_, /* ui */ DataRenderedEventUIParam) => Callback = null,
    dataRendering: (/* event */ Event_, /* ui */ DataRenderingEventUIParam) => Callback = null,
    ...
    destroyed: (/* event */ Event_, /* ui */ DestroyedEventUIParam) => Callback = null,
    ...
    footerRendered: (/* event */ Event_, /* ui */ FooterRenderedEventUIParam) => Callback = null,
    footerRendering: (/* event */ Event_, /* ui */ FooterRenderingEventUIParam) => Callback = null,
    foreignKey: String = null,
    foreignKeyRootValue: Double | String = null,
    headerCellRendered: (/* event */ Event_, /* ui */ HeaderCellRenderedEventUIParam) => Callback = null,
    headerRendered: (/* event */ Event_, /* ui */ HeaderRenderedEventUIParam) => Callback = null,
    headerRendering: (/* event */ Event_, /* ui */ HeaderRenderingEventUIParam) => Callback = null,
    ...
    requestError: (/* event */ Event_, /* ui */ RequestErrorEventUIParam) => Callback = null,
    requestType: String = null,
    responseContentType: String = null,
    responseDataKey: String = null,
    responseTotalRecCountKey: String = null,
    restSettings: IgTreeGridRestSettings = null,
    rowCollapsed: (/* event */ Event_, /* ui */ RowCollapsedEventUIParam) => Callback = null,
    rowCollapsing: (/* event */ Event_, /* ui */ RowCollapsingEventUIParam) => Callback = null,
    rowExpanded: (/* event */ Event_, /* ui */ RowExpandedEventUIParam) => Callback = null,
    rowExpanding: (/* event */ Event_, /* ui */ RowExpandingEventUIParam) => Callback = null,
    rowVirtualization: js.UndefOr[Boolean] = js.undefined,
    rowsRendered: (/* event */ Event_, /* ui */ RowsRenderedEventUIParam) => Callback = null,
    rowsRendering: (/* event */ Event_, /* ui */ RowsRenderingEventUIParam) => Callback = null,
    schemaGenerated: (/* event */ Event_, /* ui */ SchemaGeneratedEventUIParam) => Callback = null,
    ...
    if (captionRendered != null) __obj.updateDynamic("captionRendered")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.CaptionRenderedEventUIParam) => captionRendered(t0, t1).runNow()))
    if (captionRendering != null) __obj.updateDynamic("captionRendering")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.CaptionRenderingEventUIParam) => captionRendering(t0, t1).runNow()))
    if (cellClick != null) __obj.updateDynamic("cellClick")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.CellClickEventUIParam) => cellClick(t0, t1).runNow()))
    if (cellRightClick != null) __obj.updateDynamic("cellRightClick")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.CellRightClickEventUIParam) => cellRightClick(t0, t1).runNow()))
    ...
    if (columnsCollectionModified != null) __obj.updateDynamic("columnsCollectionModified")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.ColumnsCollectionModifiedEventUIParam) => columnsCollectionModified(t0, t1).runNow()))
    if (created != null) __obj.updateDynamic("created")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.CreatedEventUIParam) => created(t0, t1).runNow()))
    ...
    if (dataRendered != null) __obj.updateDynamic("dataRendered")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DataRenderedEventUIParam) => dataRendered(t0, t1).runNow()))
    if (dataRendering != null) __obj.updateDynamic("dataRendering")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DataRenderingEventUIParam) => dataRendering(t0, t1).runNow()))
    ...
    if (destroyed != null) __obj.updateDynamic("destroyed")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.DestroyedEventUIParam) => destroyed(t0, t1).runNow()))
    ...
    if (footerRendered != null) __obj.updateDynamic("footerRendered")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FooterRenderedEventUIParam) => footerRendered(t0, t1).runNow()))
    if (footerRendering != null) __obj.updateDynamic("footerRendering")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FooterRenderingEventUIParam) => footerRendering(t0, t1).runNow()))
    ...
    if (headerCellRendered != null) __obj.updateDynamic("headerCellRendered")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.HeaderCellRenderedEventUIParam) => headerCellRendered(t0, t1).runNow()))
    if (headerRendered != null) __obj.updateDynamic("headerRendered")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.HeaderRenderedEventUIParam) => headerRendered(t0, t1).runNow()))
    if (headerRendering != null) __obj.updateDynamic("headerRendering")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.HeaderRenderingEventUIParam) => headerRendering(t0, t1).runNow()))
    ...
    if (requestError != null) __obj.updateDynamic("requestError")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.RequestErrorEventUIParam) => requestError(t0, t1).runNow()))
    ...
    if (rowCollapsed != null) __obj.updateDynamic("rowCollapsed")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.RowCollapsedEventUIParam) => rowCollapsed(t0, t1).runNow()))
    if (rowCollapsing != null) __obj.updateDynamic("rowCollapsing")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.RowCollapsingEventUIParam) => rowCollapsing(t0, t1).runNow()))
    if (rowExpanded != null) __obj.updateDynamic("rowExpanded")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.RowExpandedEventUIParam) => rowExpanded(t0, t1).runNow()))
    if (rowExpanding != null) __obj.updateDynamic("rowExpanding")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.RowExpandingEventUIParam) => rowExpanding(t0, t1).runNow()))
    if (!js.isUndefined(rowVirtualization)) __obj.updateDynamic("rowVirtualization")(rowVirtualization.asInstanceOf[js.Any])
    if (rowsRendered != null) __obj.updateDynamic("rowsRendered")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.RowsRenderedEventUIParam) => rowsRendered(t0, t1).runNow()))
    if (rowsRendering != null) __obj.updateDynamic("rowsRendering")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.RowsRenderingEventUIParam) => rowsRendering(t0, t1).runNow()))
    if (schemaGenerated != null) __obj.updateDynamic("schemaGenerated")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.SchemaGeneratedEventUIParam) => schemaGenerated(t0, t1).runNow()))
