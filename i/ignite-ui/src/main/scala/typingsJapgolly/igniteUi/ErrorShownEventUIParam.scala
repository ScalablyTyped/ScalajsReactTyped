...
trait ErrorShownEventUIParam extends js.Object {
  /**
...
object ErrorShownEventUIParam {
  @scala.inline
  def apply(fieldOptions: js.Any = null, message: String = null, owner: js.Any = null, target: String = null): ErrorShownEventUIParam = {
