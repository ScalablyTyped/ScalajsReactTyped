...
object IgLayoutManager {
  ...
  extension [Self <: IgLayoutManager](x: Self) {
    ...
    inline def setInternalResized(value: (/* event */ Event, /* ui */ InternalResizedEventUIParam) => Callback): Self = StObject.set(x, "internalResized", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ InternalResizedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setInternalResizedUndefined: Self = StObject.set(x, "internalResized", js.undefined)
    
    inline def setInternalResizing(value: (/* event */ Event, /* ui */ InternalResizingEventUIParam) => Callback): Self = StObject.set(x, "internalResizing", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ InternalResizingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setItemRendered(value: (/* event */ Event, /* ui */ ItemRenderedEventUIParam) => Callback): Self = StObject.set(x, "itemRendered", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ItemRenderedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setItemRenderedUndefined: Self = StObject.set(x, "itemRendered", js.undefined)
    
    inline def setItemRendering(value: (/* event */ Event, /* ui */ ItemRenderingEventUIParam) => Callback): Self = StObject.set(x, "itemRendering", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ItemRenderingEventUIParam) => (value(t0, t1)).runNow()))
