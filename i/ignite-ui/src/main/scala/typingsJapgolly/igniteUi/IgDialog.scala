...
object IgDialog {
  ...
  extension [Self <: IgDialog](x: Self) {
    ...
    inline def setAnimationEnded(value: (/* event */ Event, /* ui */ AnimationEndedEventUIParam) => Callback): Self = StObject.set(x, "animationEnded", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ AnimationEndedEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setStateChanged(value: (/* event */ Event, /* ui */ StateChangedEventUIParam) => Callback): Self = StObject.set(x, "stateChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ StateChangedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setStateChangedUndefined: Self = StObject.set(x, "stateChanged", js.undefined)
    
    inline def setStateChanging(value: (/* event */ Event, /* ui */ StateChangingEventUIParam) => Callback): Self = StObject.set(x, "stateChanging", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ StateChangingEventUIParam) => (value(t0, t1)).runNow()))
