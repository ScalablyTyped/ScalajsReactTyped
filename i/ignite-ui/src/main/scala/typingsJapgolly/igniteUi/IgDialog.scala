...
object IgDialog {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    animationEnded: (/* event */ Event_, /* ui */ AnimationEndedEventUIParam) => Callback = null,
    ...
    state: String = null,
    stateChanged: (/* event */ Event_, /* ui */ StateChangedEventUIParam) => Callback = null,
    stateChanging: (/* event */ Event_, /* ui */ StateChangingEventUIParam) => Callback = null,
    ...
    if (animationEnded != null) __obj.updateDynamic("animationEnded")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.AnimationEndedEventUIParam) => animationEnded(t0, t1).runNow()))
    ...
    if (stateChanged != null) __obj.updateDynamic("stateChanged")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.StateChangedEventUIParam) => stateChanged(t0, t1).runNow()))
    if (stateChanging != null) __obj.updateDynamic("stateChanging")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.StateChangingEventUIParam) => stateChanging(t0, t1).runNow()))
