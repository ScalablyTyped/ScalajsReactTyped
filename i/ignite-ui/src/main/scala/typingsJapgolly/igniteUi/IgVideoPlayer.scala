...
object IgVideoPlayer {
  ...
  extension [Self <: IgVideoPlayer](x: Self) {
    ...
    inline def setBannerClick(value: (/* event */ Event, /* ui */ BannerClickEventUIParam) => Callback): Self = StObject.set(x, "bannerClick", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ BannerClickEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setBannerClickUndefined: Self = StObject.set(x, "bannerClick", js.undefined)
    
    inline def setBannerHidden(value: (/* event */ Event, /* ui */ BannerHiddenEventUIParam) => Callback): Self = StObject.set(x, "bannerHidden", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ BannerHiddenEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setBannerHiddenUndefined: Self = StObject.set(x, "bannerHidden", js.undefined)
    
    inline def setBannerVisible(value: (/* event */ Event, /* ui */ BannerVisibleEventUIParam) => Callback): Self = StObject.set(x, "bannerVisible", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ BannerVisibleEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setBuffering(value: (/* event */ Event, /* ui */ BufferingEventUIParam) => Callback): Self = StObject.set(x, "buffering", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ BufferingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setEnded(value: (/* event */ Event, /* ui */ EndedEventUIParam) => Callback): Self = StObject.set(x, "ended", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ EndedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setEndedUndefined: Self = StObject.set(x, "ended", js.undefined)
    
    inline def setEnterFullScreen(value: (/* event */ Event, /* ui */ EnterFullScreenEventUIParam) => Callback): Self = StObject.set(x, "enterFullScreen", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ EnterFullScreenEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setEnterFullScreenUndefined: Self = StObject.set(x, "enterFullScreen", js.undefined)
    
    inline def setExitFullScreen(value: (/* event */ Event, /* ui */ ExitFullScreenEventUIParam) => Callback): Self = StObject.set(x, "exitFullScreen", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ExitFullScreenEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setPaused(value: (/* event */ Event, /* ui */ PausedEventUIParam) => Callback): Self = StObject.set(x, "paused", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ PausedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setPausedUndefined: Self = StObject.set(x, "paused", js.undefined)
    
    inline def setPlaying(value: (/* event */ Event, /* ui */ PlayingEventUIParam) => Callback): Self = StObject.set(x, "playing", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ PlayingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setProgress(value: (/* event */ Event, /* ui */ ProgressEventUIParam) => Callback): Self = StObject.set(x, "progress", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ProgressEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setRelatedVideoClick(value: (/* event */ Event, /* ui */ RelatedVideoClickEventUIParam) => Callback): Self = StObject.set(x, "relatedVideoClick", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ RelatedVideoClickEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setWaiting(value: (/* event */ Event, /* ui */ WaitingEventUIParam) => Callback): Self = StObject.set(x, "waiting", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ WaitingEventUIParam) => (value(t0, t1)).runNow()))
