...
object IgGridGroupBy {
  ...
  extension [Self <: IgGridGroupBy](x: Self) {
    ...
    inline def setGroupedColumnsChanged(value: (/* event */ Event, /* ui */ GroupedColumnsChangedEventUIParam) => Callback): Self = StObject.set(x, "groupedColumnsChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ GroupedColumnsChangedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setGroupedColumnsChangedUndefined: Self = StObject.set(x, "groupedColumnsChanged", js.undefined)
    
    inline def setGroupedColumnsChanging(value: (/* event */ Event, /* ui */ GroupedColumnsChangingEventUIParam) => Callback): Self = StObject.set(x, "groupedColumnsChanging", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ GroupedColumnsChangingEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setModalDialogButtonApplyClick(value: (/* event */ Event, /* ui */ ModalDialogButtonApplyClickEventUIParam) => Callback): Self = StObject.set(x, "modalDialogButtonApplyClick", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ModalDialogButtonApplyClickEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setModalDialogButtonResetClick(value: (/* event */ Event, /* ui */ ModalDialogButtonResetClickEventUIParam) => Callback): Self = StObject.set(x, "modalDialogButtonResetClick", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ModalDialogButtonResetClickEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setModalDialogGroupColumn(value: (/* event */ Event, /* ui */ ModalDialogGroupColumnEventUIParam) => Callback): Self = StObject.set(x, "modalDialogGroupColumn", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ModalDialogGroupColumnEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setModalDialogGroupColumnUndefined: Self = StObject.set(x, "modalDialogGroupColumn", js.undefined)
    
    inline def setModalDialogGroupingColumn(value: (/* event */ Event, /* ui */ ModalDialogGroupingColumnEventUIParam) => Callback): Self = StObject.set(x, "modalDialogGroupingColumn", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ModalDialogGroupingColumnEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setModalDialogSortGroupedColumn(value: (/* event */ Event, /* ui */ ModalDialogSortGroupedColumnEventUIParam) => Callback): Self = StObject.set(x, "modalDialogSortGroupedColumn", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ModalDialogSortGroupedColumnEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setModalDialogSortGroupedColumnUndefined: Self = StObject.set(x, "modalDialogSortGroupedColumn", js.undefined)
    
    inline def setModalDialogUngroupColumn(value: (/* event */ Event, /* ui */ ModalDialogUngroupColumnEventUIParam) => Callback): Self = StObject.set(x, "modalDialogUngroupColumn", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ModalDialogUngroupColumnEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setModalDialogUngroupColumnUndefined: Self = StObject.set(x, "modalDialogUngroupColumn", js.undefined)
    
    inline def setModalDialogUngroupingColumn(value: (/* event */ Event, /* ui */ ModalDialogUngroupingColumnEventUIParam) => Callback): Self = StObject.set(x, "modalDialogUngroupingColumn", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ModalDialogUngroupingColumnEventUIParam) => (value(t0, t1)).runNow()))
