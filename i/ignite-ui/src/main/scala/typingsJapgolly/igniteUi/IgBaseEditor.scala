...
object IgBaseEditor {
  ...
  extension [Self <: IgBaseEditor](x: Self) {
    ...
    inline def setBlur(value: (/* event */ Event, /* ui */ BlurEventUIParam) => Callback): Self = StObject.set(x, "blur", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ BlurEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setFocus(value: (/* event */ Event, /* ui */ IgFocusEventUIParam) => Callback): Self = StObject.set(x, "focus", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ IgFocusEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setKeydown(value: (/* event */ Event, /* ui */ KeydownEventUIParam) => Callback): Self = StObject.set(x, "keydown", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ KeydownEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setKeydownUndefined: Self = StObject.set(x, "keydown", js.undefined)
    
    inline def setKeypress(value: (/* event */ Event, /* ui */ KeypressEventUIParam) => Callback): Self = StObject.set(x, "keypress", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ KeypressEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setKeypressUndefined: Self = StObject.set(x, "keypress", js.undefined)
    
    inline def setKeyup(value: (/* event */ Event, /* ui */ KeyupEventUIParam) => Callback): Self = StObject.set(x, "keyup", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ KeyupEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setMousedown(value: (/* event */ Event, /* ui */ MousedownEventUIParam) => Callback): Self = StObject.set(x, "mousedown", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ MousedownEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setMousedownUndefined: Self = StObject.set(x, "mousedown", js.undefined)
    
    inline def setMousemove(value: (/* event */ Event, /* ui */ MousemoveEventUIParam) => Callback): Self = StObject.set(x, "mousemove", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ MousemoveEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setMousemoveUndefined: Self = StObject.set(x, "mousemove", js.undefined)
    
    inline def setMouseout(value: (/* event */ Event, /* ui */ MouseoutEventUIParam) => Callback): Self = StObject.set(x, "mouseout", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ MouseoutEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setMouseoutUndefined: Self = StObject.set(x, "mouseout", js.undefined)
    
    inline def setMouseover(value: (/* event */ Event, /* ui */ MouseoverEventUIParam) => Callback): Self = StObject.set(x, "mouseover", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ MouseoverEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setMouseoverUndefined: Self = StObject.set(x, "mouseover", js.undefined)
    
    inline def setMouseup(value: (/* event */ Event, /* ui */ MouseupEventUIParam) => Callback): Self = StObject.set(x, "mouseup", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ MouseupEventUIParam) => (value(t0, t1)).runNow()))
    ...
    inline def setValueChanged(value: (/* event */ Event, /* ui */ ValueChangedEventUIParam) => Callback): Self = StObject.set(x, "valueChanged", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ValueChangedEventUIParam) => (value(t0, t1)).runNow()))
    
    inline def setValueChangedUndefined: Self = StObject.set(x, "valueChanged", js.undefined)
    
    inline def setValueChanging(value: (/* event */ Event, /* ui */ ValueChangingEventUIParam) => Callback): Self = StObject.set(x, "valueChanging", js.Any.fromFunction2((t0: /* event */ Event, t1: /* ui */ ValueChangingEventUIParam) => (value(t0, t1)).runNow()))
