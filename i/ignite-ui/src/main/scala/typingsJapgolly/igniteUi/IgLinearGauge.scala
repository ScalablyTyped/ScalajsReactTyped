...
object IgLinearGauge {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    alignLabel: (/* event */ Event_, /* ui */ AlignLabelEventUIParam) => Callback = null,
    ...
    formatLabel: (/* event */ Event_, /* ui */ FormatLabelEventUIParam) => Callback = null,
    ...
    if (alignLabel != null) __obj.updateDynamic("alignLabel")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.AlignLabelEventUIParam) => alignLabel(t0, t1).runNow()))
    ...
    if (formatLabel != null) __obj.updateDynamic("formatLabel")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FormatLabelEventUIParam) => formatLabel(t0, t1).runNow()))
