...
object IgUpload {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    cancelAllClicked: (/* event */ Event_, /* ui */ CancelAllClickedEventUIParam) => Callback = null,
    ...
    fileExtensionsValidating: (/* event */ Event_, /* ui */ FileExtensionsValidatingEventUIParam) => Callback = null,
    fileSelected: (/* event */ Event_, /* ui */ FileSelectedEventUIParam) => Callback = null,
    fileSelecting: (/* event */ Event_, /* ui */ FileSelectingEventUIParam) => Callback = null,
    fileSizeDecimalDisplay: Int | Double = null,
    fileSizeMetric: js.Any = null,
    fileUploadAborted: (/* event */ Event_, /* ui */ FileUploadAbortedEventUIParam) => Callback = null,
    fileUploaded: (/* event */ Event_, /* ui */ FileUploadedEventUIParam) => Callback = null,
    fileUploading: (/* event */ Event_, /* ui */ FileUploadingEventUIParam) => Callback = null,
    ...
    onError: (/* event */ Event_, /* ui */ OnErrorEventUIParam) => Callback = null,
    onFormDataSubmit: (/* event */ Event_, /* ui */ OnFormDataSubmitEventUIParam) => Callback = null,
    onXHRLoad: (/* event */ Event_, /* ui */ OnXHRLoadEventUIParam) => Callback = null,
    ...
    if (cancelAllClicked != null) __obj.updateDynamic("cancelAllClicked")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.CancelAllClickedEventUIParam) => cancelAllClicked(t0, t1).runNow()))
    ...
    if (fileExtensionsValidating != null) __obj.updateDynamic("fileExtensionsValidating")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FileExtensionsValidatingEventUIParam) => fileExtensionsValidating(t0, t1).runNow()))
    if (fileSelected != null) __obj.updateDynamic("fileSelected")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FileSelectedEventUIParam) => fileSelected(t0, t1).runNow()))
    if (fileSelecting != null) __obj.updateDynamic("fileSelecting")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FileSelectingEventUIParam) => fileSelecting(t0, t1).runNow()))
    ...
    if (fileUploadAborted != null) __obj.updateDynamic("fileUploadAborted")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FileUploadAbortedEventUIParam) => fileUploadAborted(t0, t1).runNow()))
    if (fileUploaded != null) __obj.updateDynamic("fileUploaded")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FileUploadedEventUIParam) => fileUploaded(t0, t1).runNow()))
    if (fileUploading != null) __obj.updateDynamic("fileUploading")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.FileUploadingEventUIParam) => fileUploading(t0, t1).runNow()))
    ...
    if (onError != null) __obj.updateDynamic("onError")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.OnErrorEventUIParam) => onError(t0, t1).runNow()))
    if (onFormDataSubmit != null) __obj.updateDynamic("onFormDataSubmit")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.OnFormDataSubmitEventUIParam) => onFormDataSubmit(t0, t1).runNow()))
    if (onXHRLoad != null) __obj.updateDynamic("onXHRLoad")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.OnXHRLoadEventUIParam) => onXHRLoad(t0, t1).runNow()))
