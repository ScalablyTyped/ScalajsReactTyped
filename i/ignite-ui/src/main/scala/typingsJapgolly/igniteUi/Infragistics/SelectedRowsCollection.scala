...
object SelectedRowsCollection {
  ...
  extension [Self <: SelectedRowsCollection](x: Self) {
    ...
    inline def setActiveRow(value: Callback): Self = StObject.set(x, "activeRow", value.toJsFn)
    ...
    inline def setSelectedDataRows(value: Callback): Self = StObject.set(x, "selectedDataRows", value.toJsFn)
