...
object DataSchema {
  ...
  inline def apply(
    fields: CallbackTo[js.Array[Any]],
    isEmpty: js.Object => js.Object,
    isObjEmpty: js.Object => js.Object,
    transform: js.Object => js.Object
  ): DataSchema = {
    val __obj = js.Dynamic.literal(fields = fields.toJsFn, isEmpty = js.Any.fromFunction1(isEmpty), isObjEmpty = js.Any.fromFunction1(isObjEmpty), transform = js.Any.fromFunction1(transform))
    __obj.asInstanceOf[DataSchema]
  }
  
  extension [Self <: DataSchema](x: Self) {
    
    inline def setFields(value: CallbackTo[js.Array[Any]]): Self = StObject.set(x, "fields", value.toJsFn)
