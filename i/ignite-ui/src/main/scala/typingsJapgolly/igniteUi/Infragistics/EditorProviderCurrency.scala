...
trait EditorProviderCurrency extends StObject {
...
object EditorProviderCurrency {
  ...
  inline def apply(
    ...
    validator: Callback
  ): EditorProviderCurrency = {
    val __obj = js.Dynamic.literal(createEditor = js.Any.fromFunction6((t0: js.Object, t1: js.Object, t2: js.Object, t3: js.Object, t4: js.Object, t5: js.Object) => (createEditor(t0, t1, t2, t3, t4, t5)).runNow()), destroy = destroy.toJsFn, isValid = isValid.toJsFn, refreshValue = refreshValue.toJsFn, removeFromParent = removeFromParent.toJsFn, setFocus = setFocus.toJsFn, setSize = js.Any.fromFunction2((t0: js.Object, t1: js.Object) => (setSize(t0, t1)).runNow()), textChanged = js.Any.fromFunction2((t0: js.Object, t1: js.Object) => (textChanged(t0, t1)).runNow()), validator = validator.toJsFn)
    __obj.asInstanceOf[EditorProviderCurrency]
  }
  
  extension [Self <: EditorProviderCurrency](x: Self) {
