...
object EditorProviderRating {
  ...
  inline def apply(
    ...
    getEditor: Callback,
    getValue: Callback,
    internalValueChange: (js.Object, js.Object) => Callback,
    isValid: Callback,
  ...
  extension [Self <: EditorProviderRating](x: Self) {
    ...
    inline def setInternalValueChange(value: (js.Object, js.Object) => Callback): Self = StObject.set(x, "internalValueChange", js.Any.fromFunction2((t0: js.Object, t1: js.Object) => (value(t0, t1)).runNow()))
    ...
    inline def setValueChange(value: (js.Object, js.Object) => Callback): Self = StObject.set(x, "valueChange", js.Any.fromFunction2((t0: js.Object, t1: js.Object) => (value(t0, t1)).runNow()))
  }
}
