...
object IgFunnelChart {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    sliceClicked: (/* event */ Event_, /* ui */ SliceClickedEventUIParam) => Callback = null,
    ...
    if (sliceClicked != null) __obj.updateDynamic("sliceClicked")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.std.Event_, t1: /* ui */ typingsJapgolly.igniteUi.SliceClickedEventUIParam) => sliceClicked(t0, t1).runNow()))
