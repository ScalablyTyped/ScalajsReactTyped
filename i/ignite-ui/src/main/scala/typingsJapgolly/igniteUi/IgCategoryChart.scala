...
object IgCategoryChart {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    if (!js.isUndefined(isCategoryHighlightingEnabled)) __obj.updateDynamic("isCategoryHighlightingEnabled")(isCategoryHighlightingEnabled.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isItemHighlightingEnabled)) __obj.updateDynamic("isItemHighlightingEnabled")(isItemHighlightingEnabled.asInstanceOf[js.Any])
