...
object IgPivotDataSelectorDataSourceOptionsXmlaOptions {
  ...
  inline def apply(): IgPivotDataSelectorDataSourceOptionsXmlaOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IgPivotDataSelectorDataSourceOptionsXmlaOptions]
  }
  
  extension [Self <: IgPivotDataSelectorDataSourceOptionsXmlaOptions](x: Self) {
    ...
    inline def setMdxSettings(value: IgPivotDataSelectorDataSourceOptionsXmlaOptionsMdxSettings): Self = StObject.set(x, "mdxSettings", value.asInstanceOf[js.Any])
    ...
    inline def setRequestOptions(value: IgPivotDataSelectorDataSourceOptionsXmlaOptionsRequestOptions): Self = StObject.set(x, "requestOptions", value.asInstanceOf[js.Any])
