...
trait Seq[K, V]
  ...
  /**
    ...
    */
  @JSName("filter")
  def filter_F_V_Seq[F /* <: V */](predicate: js.Function3[/* value */ V, /* key */ K, /* iter */ this.type, /* is F */ Boolean]): typingsJapgolly.immutable.Immutable.Seq[K, F] = js.native
  @JSName("filter")
  def filter_F_V_Seq[F /* <: V */](
    predicate: js.Function3[/* value */ V, /* key */ K, /* iter */ this.type, /* is F */ Boolean],
    context: js.Any
  ): typingsJapgolly.immutable.Immutable.Seq[K, F] = js.native
}
...
object Seq extends js.Object {
  @js.native
  trait Indexed[T]
    extends typingsJapgolly.immutable.Immutable.Seq[Double, T]
       with typingsJapgolly.immutable.Immutable.Collection.Indexed[T]
  
  @js.native
  trait Keyed[K, V]
    extends typingsJapgolly.immutable.Immutable.Seq[K, V]
       with typingsJapgolly.immutable.Immutable.Collection.Keyed[K, V]
  
  @js.native
  trait Set[T]
    extends typingsJapgolly.immutable.Immutable.Seq[T, T]
       with typingsJapgolly.immutable.Immutable.Collection.Set[T]
