...
object get extends js.Object {
  ...
  def apply[K, V](collection: typingsJapgolly.immutable.Immutable.Collection[K, V], key: K): js.UndefOr[V] = js.native
  ...
  def apply[TProps, K /* <: String */](record: typingsJapgolly.immutable.Immutable.Record[TProps], key: K, notSetValue: js.Any): /* import warning: importer.ImportType#apply Failed type conversion: TProps[K] */ js.Any = js.native
  def apply[K, V, NSV](collection: typingsJapgolly.immutable.Immutable.Collection[K, V], key: K, notSetValue: NSV): V | NSV = js.native
}
