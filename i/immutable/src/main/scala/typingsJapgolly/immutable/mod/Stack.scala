...
trait Stack[T] extends Indexed[T] {
  ...
  /**
    ...
    */
  def clear(): typingsJapgolly.immutable.Immutable.Stack[T] = js.native
  /**
  ...
  ): typingsJapgolly.immutable.Immutable.Set_[F] = js.native
  @JSName("filter")
  def filter_F_T_Set_[F /* <: T */](
    predicate: js.Function3[/* value */ T, /* index */ Double, /* iter */ this.type, /* is F */ Boolean],
    context: js.Any
  ...
  /**
    ...
    */
  def pop(): typingsJapgolly.immutable.Immutable.Stack[T] = js.native
  /**
    * Alias for `Stack#unshift` and is not equivalent to `List#push`.
    */
  def push(values: T*): typingsJapgolly.immutable.Immutable.Stack[T] = js.native
  /**
    * Alias for `Stack#unshiftAll`.
    */
  def pushAll(iter: js.Iterable[T]): typingsJapgolly.immutable.Immutable.Stack[T] = js.native
  /**
    ...
    */
  def shift(): typingsJapgolly.immutable.Immutable.Stack[T] = js.native
  /**
    ...
    */
  def unshift(values: T*): typingsJapgolly.immutable.Immutable.Stack[T] = js.native
  /**
    * Like `Stack#unshift`, but accepts a collection rather than varargs.
    *
    * Note: `unshiftAll` can be used in `withMutations`.
    */
  def unshiftAll(iter: js.Iterable[T]): typingsJapgolly.immutable.Immutable.Stack[T] = js.native
  /**
    * @see `Map#wasAltered`
    */
