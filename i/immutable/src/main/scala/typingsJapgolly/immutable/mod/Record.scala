...
trait Record[TProps /* <: js.Object */] extends js.Object {
  ...
  {[ K in keyof TProps ]: any}
    */ typingsJapgolly.immutable.immutableStrings.Record with js.Any = js.native
  /**
...
object Record extends js.Object {
  ...
  trait Factory[TProps /* <: js.Object */]
    extends Instantiable0[typingsJapgolly.immutable.Immutable.Record[TProps] with TProps]
       with Instantiable1[
          (/* values */ Iterable[js.Tuple2[String, js.Any]]) | (/* values */ Partial[TProps]), 
          typingsJapgolly.immutable.Immutable.Record[TProps] with TProps
        ] {
    /**
    ...
    def apply(): typingsJapgolly.immutable.Immutable.Record[TProps] with TProps = js.native
    def apply(values: Iterable[js.Tuple2[String, _]]): typingsJapgolly.immutable.Immutable.Record[TProps] with TProps = js.native
    def apply(values: Partial[TProps]): typingsJapgolly.immutable.Immutable.Record[TProps] with TProps = js.native
  }
