...
trait Set_[T] extends Set[T] {
  ...
  /**
    ...
    */
  @JSName("filter")
  def filter_F_T_Set_[F /* <: T */](predicate: js.Function3[/* value */ T, /* key */ T, /* iter */ this.type, /* is F */ Boolean]): typingsJapgolly.immutable.Immutable.Set_[F] = js.native
  @JSName("filter")
  ...
  def merge[C](collections: js.Iterable[C]*): typingsJapgolly.immutable.Immutable.Set_[T | C] = js.native
  ...
  /**
    ...
    * @alias concat
    */
  def union[C](collections: js.Iterable[C]*): typingsJapgolly.immutable.Immutable.Set_[T | C] = js.native
  /**
    * @see `Map#wasAltered`
    */
