...
object Seq extends js.Object {
  ...
  def apply[T](collection: typingsJapgolly.immutable.Immutable.Collection.Indexed[T]): Indexed[T] = js.native
  def apply[T](collection: typingsJapgolly.immutable.Immutable.Collection.Set[T]): Set[T] = js.native
