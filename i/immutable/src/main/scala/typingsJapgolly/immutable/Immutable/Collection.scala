...
object Collection extends js.Object {
  ...
  trait Indexed[T] extends Collection[Double, T] {
    ...
    def zip(collections: (Collection[_, _])*): typingsJapgolly.immutable.Immutable.Collection.Indexed[_] = js.native
    /**
      ...
      * ```
      */
    def zip[U](other: Collection[_, U]): typingsJapgolly.immutable.Immutable.Collection.Indexed[js.Tuple2[T, U]] = js.native
    def zip[U, V](other: Collection[_, U], other2: Collection[_, V]): typingsJapgolly.immutable.Immutable.Collection.Indexed[js.Tuple3[T, U, V]] = js.native
    def zipAll(collections: (Collection[_, _])*): typingsJapgolly.immutable.Immutable.Collection.Indexed[_] = js.native
    /**
      ...
      * ```
      */
    def zipAll[U](other: Collection[_, U]): typingsJapgolly.immutable.Immutable.Collection.Indexed[js.Tuple2[T, U]] = js.native
    def zipAll[U, V](other: Collection[_, U], other2: Collection[_, V]): typingsJapgolly.immutable.Immutable.Collection.Indexed[js.Tuple3[T, U, V]] = js.native
    def zipWith[Z](zipper: js.Function1[/* repeated */ js.Any, Z], collections: (Collection[_, _])*): typingsJapgolly.immutable.Immutable.Collection.Indexed[Z] = js.native
    /**
      * Returns a Collection of the same type "zipped" with the provided
      ...
      * ```
      */
    def zipWith[U, Z](zipper: js.Function2[/* value */ T, /* otherValue */ U, Z], otherCollection: Collection[_, U]): typingsJapgolly.immutable.Immutable.Collection.Indexed[Z] = js.native
    def zipWith[U, V, Z](
