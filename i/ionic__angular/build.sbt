...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "angular__forms" % "14.2.6-9ce085",
  "org.scalablytyped.japgolly" %%% "angular__platform-browser" % "14.2.6-82cccb",
  "org.scalablytyped.japgolly" %%% "angular__router" % "14.2.6-d0a4e5",
  ...
  "org.scalablytyped.japgolly" %%% "ionic__core" % "6.3.2-68295d",
  "org.scalablytyped.japgolly" %%% "ionicons" % "6.0.3-7d8894",
