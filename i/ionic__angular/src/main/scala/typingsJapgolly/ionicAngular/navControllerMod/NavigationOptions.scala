package typingsJapgolly.ionicAngular.navControllerMod
...
import typingsJapgolly.angularRouter.mod.Params
import typingsJapgolly.angularRouter.mod.QueryParamsHandling
