...
object directivesVirtualScrollVirtualItemMod {
  
  @JSImport("@ionic/angular/directives/virtual-scroll/virtual-item", "VirtualItem")
  @js.native
  open class VirtualItem protected () extends StObject {
  ...
  object VirtualItem {
    ...
    @JSImport("@ionic/angular/directives/virtual-scroll/virtual-item", "VirtualItem.\u0275dir")
    @js.native
    ...
    @JSImport("@ionic/angular/directives/virtual-scroll/virtual-item", "VirtualItem.\u0275fac")
    @js.native
    def ɵfac: ɵɵFactoryDeclaration[VirtualItem, scala.Nothing] = js.native
    inline def ɵfac_=(x: ɵɵFactoryDeclaration[VirtualItem, scala.Nothing]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("\u0275fac")(x.asInstanceOf[js.Any])
  }
}
