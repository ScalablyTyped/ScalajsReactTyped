...
object IonDatetime {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(cancelText = cancelText.asInstanceOf[js.Any], disabled = disabled.asInstanceOf[js.Any], displayFormat = displayFormat.asInstanceOf[js.Any], doneText = doneText.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], readonly = readonly.asInstanceOf[js.Any])
