...
object IonRouteRedirect {
  ...
  def apply(
    from: String,
    onIonRouteRedirectChanged: /* event */ CustomEvent => Callback = null,
    to: String = null
  ): IonRouteRedirect = {
    val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any])
    if (onIonRouteRedirectChanged != null) __obj.updateDynamic("onIonRouteRedirectChanged")(js.Any.fromFunction1((t0: /* event */ org.scalajs.dom.raw.CustomEvent) => onIonRouteRedirectChanged(t0).runNow()))
