...
object IonRouter {
  @scala.inline
  def apply(
    onIonRouteDidChange: /* event */ CustomEvent => Callback = null,
    onIonRouteWillChange: /* event */ CustomEvent => Callback = null,
    root: String = null,
    useHash: js.UndefOr[Boolean] = js.undefined
  ): IonRouter = {
    val __obj = js.Dynamic.literal()
    if (onIonRouteDidChange != null) __obj.updateDynamic("onIonRouteDidChange")(js.Any.fromFunction1((t0: /* event */ org.scalajs.dom.raw.CustomEvent) => onIonRouteDidChange(t0).runNow()))
    if (onIonRouteWillChange != null) __obj.updateDynamic("onIonRouteWillChange")(js.Any.fromFunction1((t0: /* event */ org.scalajs.dom.raw.CustomEvent) => onIonRouteWillChange(t0).runNow()))
