...
import typingsJapgolly.ionicCore.ionicCoreStrings.textarea
...
object distTypesComponentsAlertAlertInterfaceMod {
  
  type AlertAttributes = StringDictionary[Any]
  ...
  trait AlertButton extends StObject {
    ...
    var handler: js.UndefOr[
        js.Function1[/* value */ Any, AlertButtonOverlayHandler | js.Promise[AlertButtonOverlayHandler]]
      ] = js.undefined
    
    var id: js.UndefOr[String] = js.undefined
    
    var role: js.UndefOr[cancel | destructive | String] = js.undefined
  ...
  object AlertButton {
    ...
    extension [Self <: AlertButton](x: Self) {
      ...
      inline def setHandler(value: /* value */ Any => AlertButtonOverlayHandler | js.Promise[AlertButtonOverlayHandler]): Self = StObject.set(x, "handler", js.Any.fromFunction1(value))
      ...
      inline def setRole(value: cancel | destructive | String): Self = StObject.set(x, "role", value.asInstanceOf[js.Any])
  ...
  type AlertButtonOverlayHandler = Boolean | Unit | StringDictionary[Any]
  ...
  object AlertInput {
    ...
    extension [Self <: AlertInput](x: Self) {
      ...
      inline def setHandler(value: AlertInput => Callback): Self = StObject.set(x, "handler", js.Any.fromFunction1((t0: AlertInput) => value(t0).runNow()))
  ...
  type AlertInputAttributes = StringDictionary[Any]
  ...
  type AlertTextareaAttributes = StringDictionary[Any]
}
