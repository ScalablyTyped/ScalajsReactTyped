...
object distTypesComponentsInfiniteScrollInfiniteScrollMod {
  ...
  open class InfiniteScroll ()
    ...
    /* private */ var didFire: Any = js.native
    ...
    /* private */ var isBusy: Any = js.native
    ...
    @JSName("render")
    def render_MInfiniteScroll(): Any = js.native
    
    /* private */ var scrollEl: Any = js.native
    
    /* private */ var thrPc: Any = js.native
    
    /* private */ var thrPx: Any = js.native
