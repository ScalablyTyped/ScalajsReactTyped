...
import typingsJapgolly.ionicCore.distTypesUtilsPlatformMod.PlatformConfig
import typingsJapgolly.ionicCore.mod.Mode
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distTypesUtilsConfigMod {
  ...
  trait IonicConfig extends StObject {
    ...
    var _ael: js.UndefOr[js.Function4[/* el */ Any, /* name */ String, /* cb */ Any, /* opts */ Any, Any]] = js.undefined
    
    var _ce: js.UndefOr[js.Function2[/* eventName */ String, /* opts */ Any, Any]] = js.undefined
    
    var _forceStatusbarPadding: js.UndefOr[Boolean] = js.undefined
    
    var _rel: js.UndefOr[js.Function4[/* el */ Any, /* name */ String, /* cb */ Any, /* opts */ Any, Any]] = js.undefined
    
    var _testing: js.UndefOr[Boolean] = js.undefined
    
    var _zoneGate: js.UndefOr[js.Function1[/* h */ js.Function0[Any], Any]] = js.undefined
    ...
    /**
      ...
      */
    var platform: js.UndefOr[PlatformConfig] = js.undefined
  ...
  object IonicConfig {
    ...
    extension [Self <: IonicConfig](x: Self) {
      ...
      inline def setActionSheetEnter(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "actionSheetEnter", js.Any.fromFunction2(value))
      
      inline def setActionSheetEnterUndefined: Self = StObject.set(x, "actionSheetEnter", js.undefined)
      
      inline def setActionSheetLeave(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "actionSheetLeave", js.Any.fromFunction2(value))
      
      inline def setActionSheetLeaveUndefined: Self = StObject.set(x, "actionSheetLeave", js.undefined)
      
      inline def setAlertEnter(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "alertEnter", js.Any.fromFunction2(value))
      
      inline def setAlertEnterUndefined: Self = StObject.set(x, "alertEnter", js.undefined)
      
      inline def setAlertLeave(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "alertLeave", js.Any.fromFunction2(value))
      ...
      inline def setLoadingEnter(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "loadingEnter", js.Any.fromFunction2(value))
      
      inline def setLoadingEnterUndefined: Self = StObject.set(x, "loadingEnter", js.undefined)
      
      inline def setLoadingLeave(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "loadingLeave", js.Any.fromFunction2(value))
      ...
      inline def setModalEnter(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "modalEnter", js.Any.fromFunction2(value))
      
      inline def setModalEnterUndefined: Self = StObject.set(x, "modalEnter", js.undefined)
      
      inline def setModalLeave(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "modalLeave", js.Any.fromFunction2(value))
      ...
      inline def setNavAnimation(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "navAnimation", js.Any.fromFunction2(value))
      ...
      inline def setPickerEnter(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "pickerEnter", js.Any.fromFunction2(value))
      
      inline def setPickerEnterUndefined: Self = StObject.set(x, "pickerEnter", js.undefined)
      
      inline def setPickerLeave(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "pickerLeave", js.Any.fromFunction2(value))
      
      inline def setPickerLeaveUndefined: Self = StObject.set(x, "pickerLeave", js.undefined)
      
      inline def setPlatform(value: PlatformConfig): Self = StObject.set(x, "platform", value.asInstanceOf[js.Any])
      
      inline def setPlatformUndefined: Self = StObject.set(x, "platform", js.undefined)
      
      inline def setPopoverEnter(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "popoverEnter", js.Any.fromFunction2(value))
      
      inline def setPopoverEnterUndefined: Self = StObject.set(x, "popoverEnter", js.undefined)
      
      inline def setPopoverLeave(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "popoverLeave", js.Any.fromFunction2(value))
      ...
      inline def setToastEnter(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "toastEnter", js.Any.fromFunction2(value))
      
      inline def setToastEnterUndefined: Self = StObject.set(x, "toastEnter", js.undefined)
      
      inline def setToastLeave(value: (/* baseEl */ Any, /* opts */ js.UndefOr[Any]) => Animation): Self = StObject.set(x, "toastLeave", js.Any.fromFunction2(value))
      
      inline def setToastLeaveUndefined: Self = StObject.set(x, "toastLeave", js.undefined)
      
      inline def set_ael(value: (/* el */ Any, /* name */ String, /* cb */ Any, /* opts */ Any) => Any): Self = StObject.set(x, "_ael", js.Any.fromFunction4(value))
      
      inline def set_aelUndefined: Self = StObject.set(x, "_ael", js.undefined)
      
      inline def set_ce(value: (/* eventName */ String, /* opts */ Any) => Any): Self = StObject.set(x, "_ce", js.Any.fromFunction2(value))
      
      inline def set_ceUndefined: Self = StObject.set(x, "_ce", js.undefined)
      ...
      inline def set_rel(value: (/* el */ Any, /* name */ String, /* cb */ Any, /* opts */ Any) => Any): Self = StObject.set(x, "_rel", js.Any.fromFunction4(value))
      ...
      inline def set_zoneGate(value: /* h */ js.Function0[Any] => Any): Self = StObject.set(x, "_zoneGate", js.Any.fromFunction1(value))
