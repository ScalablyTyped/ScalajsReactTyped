...
object distTypesComponentsSelectPopoverSelectPopoverInterfaceMod {
  ...
  trait SelectPopoverOption extends StObject {
    ...
    var handler: js.UndefOr[js.Function1[/* value */ Any, Boolean | Unit | StringDictionary[Any]]] = js.undefined
  ...
  object SelectPopoverOption {
    ...
    extension [Self <: SelectPopoverOption](x: Self) {
      ...
      inline def setHandler(value: /* value */ Any => Boolean | Unit | StringDictionary[Any]): Self = StObject.set(x, "handler", js.Any.fromFunction1(value))
