...
object QueueApi {
  ...
  def apply(
    ...
    __obj.updateDynamic("read")(js.Any.fromFunction1((t0: typingsJapgolly.ionicCore.stencilCoreMod.RafCallback) => read(t0).runNow()))
    __obj.updateDynamic("tick")(js.Any.fromFunction1((t0: typingsJapgolly.ionicCore.stencilCoreMod.RafCallback) => tick(t0).runNow()))
    __obj.updateDynamic("write")(js.Any.fromFunction1((t0: typingsJapgolly.ionicCore.stencilCoreMod.RafCallback) => write(t0).runNow()))
