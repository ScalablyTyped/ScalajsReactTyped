...
object VideoHTMLAttributes {
  ...
  def apply[T](
    ...
    onAbort: /* event */ Event_ => Callback = null,
    ...
    onCanPlay: /* event */ Event_ => Callback = null,
    onCanPlayThrough: /* event */ Event_ => Callback = null,
    ...
    onDurationChange: /* event */ Event_ => Callback = null,
    onEmptied: /* event */ Event_ => Callback = null,
    onEnded: /* event */ Event_ => Callback = null,
    ...
    onInterruptBegin: /* event */ Event_ => Callback = null,
    onInterruptEnd: /* event */ Event_ => Callback = null,
    ...
    onLoadStart: /* event */ Event_ => Callback = null,
    onLoadedData: /* event */ Event_ => Callback = null,
    onLoadedMetaData: /* event */ Event_ => Callback = null,
    ...
    onMozAudioAvailable: /* event */ Event_ => Callback = null,
    onPaste: /* event */ ClipboardEvent => Callback = null,
    onPasteCapture: /* event */ ClipboardEvent => Callback = null,
    onPause: /* event */ Event_ => Callback = null,
    onPlay: /* event */ Event_ => Callback = null,
    onPlaying: /* event */ Event_ => Callback = null,
    ...
    onProgress: /* event */ Event_ => Callback = null,
    onRateChange: /* event */ Event_ => Callback = null,
    ...
    onSeeked: /* event */ Event_ => Callback = null,
    onSeeking: /* event */ Event_ => Callback = null,
    onStalled: /* event */ Event_ => Callback = null,
    onSubmit: /* event */ Event_ => Callback = null,
    onSubmitCapture: /* event */ Event_ => Callback = null,
    onSuspend: /* event */ Event_ => Callback = null,
    onTimeUpdate: /* event */ Event_ => Callback = null,
    ...
    onVolumeChange: /* event */ Event_ => Callback = null,
    onWaiting: /* event */ Event_ => Callback = null,
    ...
    if (onAbort != null) __obj.updateDynamic("onAbort")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onAbort(t0).runNow()))
    ...
    if (onCanPlay != null) __obj.updateDynamic("onCanPlay")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onCanPlay(t0).runNow()))
    if (onCanPlayThrough != null) __obj.updateDynamic("onCanPlayThrough")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onCanPlayThrough(t0).runNow()))
    ...
    if (onDurationChange != null) __obj.updateDynamic("onDurationChange")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onDurationChange(t0).runNow()))
    if (onEmptied != null) __obj.updateDynamic("onEmptied")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onEmptied(t0).runNow()))
    if (onEnded != null) __obj.updateDynamic("onEnded")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onEnded(t0).runNow()))
    ...
    if (onInterruptBegin != null) __obj.updateDynamic("onInterruptBegin")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onInterruptBegin(t0).runNow()))
    if (onInterruptEnd != null) __obj.updateDynamic("onInterruptEnd")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onInterruptEnd(t0).runNow()))
    ...
    if (onLoadStart != null) __obj.updateDynamic("onLoadStart")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onLoadStart(t0).runNow()))
    if (onLoadedData != null) __obj.updateDynamic("onLoadedData")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onLoadedData(t0).runNow()))
    if (onLoadedMetaData != null) __obj.updateDynamic("onLoadedMetaData")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onLoadedMetaData(t0).runNow()))
    ...
    if (onMozAudioAvailable != null) __obj.updateDynamic("onMozAudioAvailable")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onMozAudioAvailable(t0).runNow()))
    ...
    if (onPause != null) __obj.updateDynamic("onPause")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onPause(t0).runNow()))
    if (onPlay != null) __obj.updateDynamic("onPlay")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onPlay(t0).runNow()))
    if (onPlaying != null) __obj.updateDynamic("onPlaying")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onPlaying(t0).runNow()))
    ...
    if (onProgress != null) __obj.updateDynamic("onProgress")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onProgress(t0).runNow()))
    if (onRateChange != null) __obj.updateDynamic("onRateChange")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onRateChange(t0).runNow()))
    ...
    if (onSeeked != null) __obj.updateDynamic("onSeeked")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onSeeked(t0).runNow()))
    if (onSeeking != null) __obj.updateDynamic("onSeeking")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onSeeking(t0).runNow()))
    if (onStalled != null) __obj.updateDynamic("onStalled")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onStalled(t0).runNow()))
    ...
    if (onSuspend != null) __obj.updateDynamic("onSuspend")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onSuspend(t0).runNow()))
    if (onTimeUpdate != null) __obj.updateDynamic("onTimeUpdate")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onTimeUpdate(t0).runNow()))
    ...
    if (onVolumeChange != null) __obj.updateDynamic("onVolumeChange")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onVolumeChange(t0).runNow()))
    if (onWaiting != null) __obj.updateDynamic("onWaiting")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.std.Event_) => onWaiting(t0).runNow()))
