...
object distTypesUtilsInputShimsHacksHideCaretMod {
  ...
  inline def enableHideCaretOnScroll(componentEl: HTMLElement, inputEl: HTMLInputElement, scrollEl: HTMLElement): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("enableHideCaretOnScroll")(componentEl.asInstanceOf[js.Any], inputEl.asInstanceOf[js.Any], scrollEl.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
  ...
  inline def enableHideCaretOnScroll(componentEl: HTMLElement, inputEl: HTMLTextAreaElement, scrollEl: HTMLElement): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("enableHideCaretOnScroll")(componentEl.asInstanceOf[js.Any], inputEl.asInstanceOf[js.Any], scrollEl.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
  inline def enableHideCaretOnScroll(componentEl: HTMLElement, inputEl: Unit, scrollEl: HTMLElement): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("enableHideCaretOnScroll")(componentEl.asInstanceOf[js.Any], inputEl.asInstanceOf[js.Any], scrollEl.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
}
