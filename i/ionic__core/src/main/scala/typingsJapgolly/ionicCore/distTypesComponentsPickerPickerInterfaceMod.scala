...
object distTypesComponentsPickerPickerInterfaceMod {
  
  type PickerAttributes = StringDictionary[Any]
  
  trait PickerButton extends StObject {
    
    var cssClass: js.UndefOr[String | js.Array[String]] = js.undefined
    
    var handler: js.UndefOr[js.Function1[/* value */ Any, Boolean | Unit]] = js.undefined
  ...
  object PickerButton {
    ...
    extension [Self <: PickerButton](x: Self) {
      ...
      inline def setHandler(value: /* value */ Any => Boolean | Unit): Self = StObject.set(x, "handler", js.Any.fromFunction1(value))
  ...
  object PickerColumn {
    ...
    extension [Self <: PickerColumn](x: Self) {
      ...
      inline def setOptionsVarargs(value: PickerColumnOption*): Self = StObject.set(x, "options", js.Array(value*))
