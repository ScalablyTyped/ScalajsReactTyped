...
trait IonBreadcrumbs extends StObject {
  ...
  /**
    ...
    */
  var itemsBeforeCollapse: Double
...
object IonBreadcrumbs {
  ...
  inline def apply(itemsAfterCollapse: Double, itemsBeforeCollapse: Double): IonBreadcrumbs = {
    val __obj = js.Dynamic.literal(itemsAfterCollapse = itemsAfterCollapse.asInstanceOf[js.Any], itemsBeforeCollapse = itemsBeforeCollapse.asInstanceOf[js.Any])
