...
import typingsJapgolly.ionicCore.distTypesComponentsMod.Components.IonActionSheet
import typingsJapgolly.ionicCore.distTypesUtilsOverlaysInterfaceMod.OverlaySelect
