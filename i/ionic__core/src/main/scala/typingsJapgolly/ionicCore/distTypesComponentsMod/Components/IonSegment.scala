...
object IonSegment {
  ...
  inline def apply(disabled: Boolean, scrollable: Boolean, selectOnFocus: Boolean, swipeGesture: Boolean): IonSegment = {
    val __obj = js.Dynamic.literal(disabled = disabled.asInstanceOf[js.Any], scrollable = scrollable.asInstanceOf[js.Any], selectOnFocus = selectOnFocus.asInstanceOf[js.Any], swipeGesture = swipeGesture.asInstanceOf[js.Any])
