...
import typingsJapgolly.ionicCore.distTypesComponentsMod.Components.IonSearchbar
...
- typingsJapgolly.std.HTMLElement because Inheritance from two classes. Inlined accessKeyLabel, offsetWidth, accessKey, offsetTop, innerText, offsetLeft, offsetParent, lang, translate, autocapitalize, dir, outerText, draggable, hidden, inert, title, offsetHeight, attachInternals, click, addEventListener, addEventListener, removeEventListener, removeEventListener, removeEventListener, addEventListener
