...
import typingsJapgolly.ionicCore.distTypesComponentsMod.Components.IonPickerColumnInternal
...
trait HTMLIonPickerColumnInternalElement
  extends StObject
     with IonPickerColumnInternal
     with Element
