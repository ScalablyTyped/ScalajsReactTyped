...
import typingsJapgolly.ionicCore.distTypesComponentsMod.IonFabButtonCustomEvent
...
trait IonFabButton extends StObject {
  ...
  /**
    ...
    */
  var onIonBlur: js.UndefOr[js.Function1[/* event */ IonFabButtonCustomEvent[Unit], Unit]] = js.undefined
  
  /**
    * Emitted when the button has focus.
    */
  var onIonFocus: js.UndefOr[js.Function1[/* event */ IonFabButtonCustomEvent[Unit], Unit]] = js.undefined
...
object IonFabButton {
  ...
  extension [Self <: IonFabButton](x: Self) {
    ...
    inline def setOnIonBlur(value: /* event */ IonFabButtonCustomEvent[Unit] => Callback): Self = StObject.set(x, "onIonBlur", js.Any.fromFunction1((t0: /* event */ IonFabButtonCustomEvent[Unit]) => value(t0).runNow()))
    
    inline def setOnIonBlurUndefined: Self = StObject.set(x, "onIonBlur", js.undefined)
    
    inline def setOnIonFocus(value: /* event */ IonFabButtonCustomEvent[Unit] => Callback): Self = StObject.set(x, "onIonFocus", js.Any.fromFunction1((t0: /* event */ IonFabButtonCustomEvent[Unit]) => value(t0).runNow()))
