...
trait IonBreadcrumb extends StObject {
  ...
  var showCollapsedIndicator: Boolean
...
object IonBreadcrumb {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(active = active.asInstanceOf[js.Any], collapsed = collapsed.asInstanceOf[js.Any], disabled = disabled.asInstanceOf[js.Any], last = last.asInstanceOf[js.Any], routerDirection = routerDirection.asInstanceOf[js.Any], showCollapsedIndicator = showCollapsedIndicator.asInstanceOf[js.Any])
  ...
  extension [Self <: IonBreadcrumb](x: Self) {
    ...
    inline def setShowCollapsedIndicator(value: Boolean): Self = StObject.set(x, "showCollapsedIndicator", value.asInstanceOf[js.Any])
