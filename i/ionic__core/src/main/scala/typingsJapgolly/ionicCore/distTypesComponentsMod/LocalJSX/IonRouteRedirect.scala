...
import typingsJapgolly.ionicCore.distTypesComponentsMod.IonRouteRedirectCustomEvent
...
trait IonRouteRedirect extends StObject {
  ...
  /**
    ...
    */
  var onIonRouteRedirectChanged: js.UndefOr[js.Function1[/* event */ IonRouteRedirectCustomEvent[Any], Unit]] = js.undefined
...
object IonRouteRedirect {
  ...
  extension [Self <: IonRouteRedirect](x: Self) {
    ...
    inline def setOnIonRouteRedirectChanged(value: /* event */ IonRouteRedirectCustomEvent[Any] => Callback): Self = StObject.set(x, "onIonRouteRedirectChanged", js.Any.fromFunction1((t0: /* event */ IonRouteRedirectCustomEvent[Any]) => value(t0).runNow()))
