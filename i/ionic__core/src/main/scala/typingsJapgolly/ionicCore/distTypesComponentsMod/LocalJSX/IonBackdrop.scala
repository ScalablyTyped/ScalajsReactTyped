...
import typingsJapgolly.ionicCore.distTypesComponentsMod.IonBackdropCustomEvent
...
trait IonBackdrop extends StObject {
  ...
  /**
    ...
    */
  var onIonBackdropTap: js.UndefOr[js.Function1[/* event */ IonBackdropCustomEvent[Unit], Unit]] = js.undefined
...
object IonBackdrop {
  ...
  extension [Self <: IonBackdrop](x: Self) {
    ...
    inline def setOnIonBackdropTap(value: /* event */ IonBackdropCustomEvent[Unit] => Callback): Self = StObject.set(x, "onIonBackdropTap", js.Any.fromFunction1((t0: /* event */ IonBackdropCustomEvent[Unit]) => value(t0).runNow()))
