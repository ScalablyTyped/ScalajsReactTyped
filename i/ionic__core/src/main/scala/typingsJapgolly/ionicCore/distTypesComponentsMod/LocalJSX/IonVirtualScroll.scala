...
trait IonVirtualScroll extends StObject {
  ...
  /**
    ...
    */
  var renderFooter: js.UndefOr[js.Function2[/* item */ Any, /* index */ Double, Any]] = js.undefined
  
  /**
    * NOTE: only JSX API for stencil.  Provide a render function for the header to be rendered. Returns a JSX virtual-dom.
    */
  var renderHeader: js.UndefOr[js.Function2[/* item */ Any, /* index */ Double, Any]] = js.undefined
  
  /**
    * NOTE: only JSX API for stencil.  Provide a render function for the items to be rendered. Returns a JSX virtual-dom.
    */
  var renderItem: js.UndefOr[js.Function2[/* item */ Any, /* index */ Double, Any]] = js.undefined
}
object IonVirtualScroll {
  ...
  extension [Self <: IonVirtualScroll](x: Self) {
    ...
    inline def setFooterFn(
      value: (/* item */ Any, /* index */ Double, /* items */ js.Array[Any]) => js.UndefOr[String | Null]
    ...
    inline def setFooterHeight(value: (/* item */ Any, /* index */ Double) => Double): Self = StObject.set(x, "footerHeight", js.Any.fromFunction2(value))
    ...
    inline def setHeaderHeight(value: (/* item */ Any, /* index */ Double) => Double): Self = StObject.set(x, "headerHeight", js.Any.fromFunction2(value))
    
    inline def setHeaderHeightUndefined: Self = StObject.set(x, "headerHeight", js.undefined)
    
    inline def setItemHeight(value: (/* item */ Any, /* index */ Double) => Double): Self = StObject.set(x, "itemHeight", js.Any.fromFunction2(value))
    ...
    inline def setRenderFooter(value: (/* item */ Any, /* index */ Double) => Any): Self = StObject.set(x, "renderFooter", js.Any.fromFunction2(value))
    
    inline def setRenderFooterUndefined: Self = StObject.set(x, "renderFooter", js.undefined)
    
    inline def setRenderHeader(value: (/* item */ Any, /* index */ Double) => Any): Self = StObject.set(x, "renderHeader", js.Any.fromFunction2(value))
    
    inline def setRenderHeaderUndefined: Self = StObject.set(x, "renderHeader", js.undefined)
    
    inline def setRenderItem(value: (/* item */ Any, /* index */ Double) => Any): Self = StObject.set(x, "renderItem", js.Any.fromFunction2(value))
