...
trait IntrinsicElements extends StObject {
  ...
  var `ion-accordion`: IonAccordion
  
  var `ion-accordion-group`: IonAccordionGroup
  ...
  var `ion-breadcrumb`: IonBreadcrumb
  
  var `ion-breadcrumbs`: IonBreadcrumbs
  ...
  var `ion-datetime-button`: IonDatetimeButton
  ...
  var `ion-picker-column-internal`: IonPickerColumnInternal
  
  var `ion-picker-internal`: IonPickerInternal
...
object IntrinsicElements {
  ...
  extension [Self <: IntrinsicElements](x: Self) {
    ...
    inline def `setIon-accordion`(value: IonAccordion): Self = StObject.set(x, "ion-accordion", value.asInstanceOf[js.Any])
    
    inline def `setIon-accordion-group`(value: IonAccordionGroup): Self = StObject.set(x, "ion-accordion-group", value.asInstanceOf[js.Any])
    ...
    inline def `setIon-breadcrumb`(value: IonBreadcrumb): Self = StObject.set(x, "ion-breadcrumb", value.asInstanceOf[js.Any])
    
    inline def `setIon-breadcrumbs`(value: IonBreadcrumbs): Self = StObject.set(x, "ion-breadcrumbs", value.asInstanceOf[js.Any])
    ...
    inline def `setIon-datetime-button`(value: IonDatetimeButton): Self = StObject.set(x, "ion-datetime-button", value.asInstanceOf[js.Any])
    ...
    inline def `setIon-picker-column-internal`(value: IonPickerColumnInternal): Self = StObject.set(x, "ion-picker-column-internal", value.asInstanceOf[js.Any])
    
    inline def `setIon-picker-internal`(value: IonPickerInternal): Self = StObject.set(x, "ion-picker-internal", value.asInstanceOf[js.Any])
