...
import typingsJapgolly.ionicCore.distTypesComponentsMod.IonRouteCustomEvent
...
trait IonRoute extends StObject {
  ...
  /**
    ...
    */
  var onIonRouteDataChanged: js.UndefOr[js.Function1[/* event */ IonRouteCustomEvent[Any], Unit]] = js.undefined
...
object IonRoute {
  ...
  extension [Self <: IonRoute](x: Self) {
    ...
    inline def setOnIonRouteDataChanged(value: /* event */ IonRouteCustomEvent[Any] => Callback): Self = StObject.set(x, "onIonRouteDataChanged", js.Any.fromFunction1((t0: /* event */ IonRouteCustomEvent[Any]) => value(t0).runNow()))
