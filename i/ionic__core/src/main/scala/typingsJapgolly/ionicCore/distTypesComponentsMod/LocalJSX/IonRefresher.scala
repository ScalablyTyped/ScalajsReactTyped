...
import typingsJapgolly.ionicCore.distTypesComponentsMod.IonRefresherCustomEvent
...
trait IonRefresher extends StObject {
  ...
  /**
    ...
    */
  var onIonPull: js.UndefOr[js.Function1[/* event */ IonRefresherCustomEvent[Unit], Unit]] = js.undefined
  ...
  /**
    ...
    */
  var onIonRefresh: js.UndefOr[js.Function1[/* event */ IonRefresherCustomEvent[RefresherEventDetail], Unit]] = js.undefined
  
  /**
    * Emitted when the user begins to start pulling down.
    */
  var onIonStart: js.UndefOr[js.Function1[/* event */ IonRefresherCustomEvent[Unit], Unit]] = js.undefined
...
object IonRefresher {
  ...
  extension [Self <: IonRefresher](x: Self) {
    ...
    inline def setOnIonPull(value: /* event */ IonRefresherCustomEvent[Unit] => Callback): Self = StObject.set(x, "onIonPull", js.Any.fromFunction1((t0: /* event */ IonRefresherCustomEvent[Unit]) => value(t0).runNow()))
    
    inline def setOnIonPullUndefined: Self = StObject.set(x, "onIonPull", js.undefined)
    
    inline def setOnIonRefresh(value: /* event */ IonRefresherCustomEvent[RefresherEventDetail] => Callback): Self = StObject.set(x, "onIonRefresh", js.Any.fromFunction1((t0: /* event */ IonRefresherCustomEvent[RefresherEventDetail]) => value(t0).runNow()))
    
    inline def setOnIonRefreshUndefined: Self = StObject.set(x, "onIonRefresh", js.undefined)
    
    inline def setOnIonStart(value: /* event */ IonRefresherCustomEvent[Unit] => Callback): Self = StObject.set(x, "onIonStart", js.Any.fromFunction1((t0: /* event */ IonRefresherCustomEvent[Unit]) => value(t0).runNow()))
