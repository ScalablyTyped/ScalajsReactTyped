...
import typingsJapgolly.ionicCore.distTypesComponentsMod.IonInfiniteScrollCustomEvent
...
trait IonInfiniteScroll extends StObject {
  ...
  /**
    ...
    */
  var onIonInfinite: js.UndefOr[js.Function1[/* event */ IonInfiniteScrollCustomEvent[Unit], Unit]] = js.undefined
...
object IonInfiniteScroll {
  ...
  extension [Self <: IonInfiniteScroll](x: Self) {
    ...
    inline def setOnIonInfinite(value: /* event */ IonInfiniteScrollCustomEvent[Unit] => Callback): Self = StObject.set(x, "onIonInfinite", js.Any.fromFunction1((t0: /* event */ IonInfiniteScrollCustomEvent[Unit]) => value(t0).runNow()))
