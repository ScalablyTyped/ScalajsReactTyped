...
import typingsJapgolly.ionicCore.ionicCoreStrings.`false`
import typingsJapgolly.ionicCore.ionicCoreStrings.`true`
...
object HTMLAttributes {
  ...
  extension [Self <: HTMLAttributes[?], T](x: Self & HTMLAttributes[T]) {
    ...
    inline def setContentEditable(value: Boolean | String): Self = StObject.set(x, "contentEditable", value.asInstanceOf[js.Any])
