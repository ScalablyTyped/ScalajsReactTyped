...
import typingsJapgolly.ionicCore.distTypesComponentsVirtualScrollVirtualScrollInterfaceMod.Cell
...
import typingsJapgolly.ionicCore.distTypesComponentsVirtualScrollVirtualScrollInterfaceMod.VirtualNode
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distTypesComponentsVirtualScrollVirtualScrollUtilsMod {
  ...
  inline def calcHeightIndex(buf: js.typedarray.Uint32Array, cells: js.Array[Cell], index: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("calcHeightIndex")(buf.asInstanceOf[js.Any], cells.asInstanceOf[js.Any], index.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getRange(heightIndex: js.typedarray.Uint32Array, viewport: Viewport, buffer: Double): Range = (^.asInstanceOf[js.Dynamic].applyDynamic("getRange")(heightIndex.asInstanceOf[js.Any], viewport.asInstanceOf[js.Any], buffer.asInstanceOf[js.Any])).asInstanceOf[Range]
  ...
  inline def positionForIndex(index: Double, cells: js.Array[Cell], heightIndex: js.typedarray.Uint32Array): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("positionForIndex")(index.asInstanceOf[js.Any], cells.asInstanceOf[js.Any], heightIndex.asInstanceOf[js.Any])).asInstanceOf[Double]
  
  inline def resizeBuffer(buf: js.typedarray.Uint32Array, len: Double): js.typedarray.Uint32Array = (^.asInstanceOf[js.Dynamic].applyDynamic("resizeBuffer")(buf.asInstanceOf[js.Any], len.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint32Array]
  inline def resizeBuffer(buf: Unit, len: Double): js.typedarray.Uint32Array = (^.asInstanceOf[js.Dynamic].applyDynamic("resizeBuffer")(buf.asInstanceOf[js.Any], len.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint32Array]
  
  inline def updateVDom(
    dom: js.Array[VirtualNode],
    heightIndex: js.typedarray.Uint32Array,
    cells: js.Array[Cell],
    range: Range
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("updateVDom")(dom.asInstanceOf[js.Any], heightIndex.asInstanceOf[js.Any], cells.asInstanceOf[js.Any], range.asInstanceOf[js.Any])).asInstanceOf[Unit]
