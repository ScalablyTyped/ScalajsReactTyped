...
trait Android extends StObject {
  ...
  def capacitor(win: Any): Boolean
  
  def cordova(win: Any): Boolean
...
object Android {
  ...
  extension [Self <: Android](x: Self) {
    ...
    inline def setCapacitor(value: Any => Boolean): Self = StObject.set(x, "capacitor", js.Any.fromFunction1(value))
    
    inline def setCordova(value: Any => Boolean): Self = StObject.set(x, "cordova", js.Any.fromFunction1(value))
