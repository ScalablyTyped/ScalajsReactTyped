...
trait Bubbles extends StObject {
  ...
  var `lines-sharp`: Lines
  
  var `lines-sharp-small`: Lines
...
object Bubbles {
  ...
  inline def apply(
    ...
    __obj.updateDynamic("lines-sharp")(`lines-sharp`.asInstanceOf[js.Any])
    __obj.updateDynamic("lines-sharp-small")(`lines-sharp-small`.asInstanceOf[js.Any])
  ...
  extension [Self <: Bubbles](x: Self) {
    ...
    inline def `setLines-sharp`(value: Lines): Self = StObject.set(x, "lines-sharp", value.asInstanceOf[js.Any])
    
    inline def `setLines-sharp-small`(value: Lines): Self = StObject.set(x, "lines-sharp-small", value.asInstanceOf[js.Any])
