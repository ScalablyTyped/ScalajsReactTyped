...
object distTypesUtilsKeyboardKeyboardMod {
  ...
  inline def copyVisualViewport(visualViewport: Any): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("copyVisualViewport")(visualViewport.asInstanceOf[js.Any]).asInstanceOf[Any]
  ...
  inline def setKeyboardOpen(win: Window, ev: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setKeyboardOpen")(win.asInstanceOf[js.Any], ev.asInstanceOf[js.Any])).asInstanceOf[Unit]
