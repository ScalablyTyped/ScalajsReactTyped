...
object buildComponentsStaticMod {
  ...
  trait Props[T] extends StObject {
    ...
    /**
      ...
      */
    def children(item: T, index: Double): Node
  ...
  object Props {
    ...
    inline def apply[T](children: (T, Double) => Node, items: js.Array[T]): Props[T] = {
    ...
    extension [Self <: Props[?], T](x: Self & Props[T]) {
      ...
      inline def setChildren(value: (T, Double) => Node): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
