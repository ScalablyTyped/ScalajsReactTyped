...
import typingsJapgolly.ink.buildDomMod.NodeNames
import typingsJapgolly.ink.buildRenderNodeToOutputMod.OutputTransformer
...
object anon {
  ...
  object readonlymarginnumberundef {
    ...
    extension [Self <: readonlymarginnumberundef](x: Self) {
      ...
      inline def setRefFunction1(value: DOMElement | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: DOMElement | Null) => value(t0).runNow()))
