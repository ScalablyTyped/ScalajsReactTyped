...
object buildHooksUseFocusMod {
  ...
  object Output {
    ...
    inline def apply(focus: String => Callback, isFocused: Boolean): Output = {
      val __obj = js.Dynamic.literal(focus = js.Any.fromFunction1((t0: String) => focus(t0).runNow()), isFocused = isFocused.asInstanceOf[js.Any])
