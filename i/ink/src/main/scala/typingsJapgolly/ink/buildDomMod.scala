...
import typingsJapgolly.ink.inkStrings.Numbersigntext
...
object buildDomMod {
  ...
  object DOMElement {
    ...
    extension [Self <: DOMElement](x: Self) {
      ...
      inline def setOnImmediateRender(value: Callback): Self = StObject.set(x, "onImmediateRender", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ink.inkStrings.`ink-root`
    - typingsJapgolly.ink.inkStrings.`ink-box`
    - typingsJapgolly.ink.inkStrings.`ink-text`
    - typingsJapgolly.ink.inkStrings.`ink-virtual-text`
  */
  trait ElementNames extends StObject
  object ElementNames {
    
    inline def `ink-box`: typingsJapgolly.ink.inkStrings.`ink-box` = "ink-box".asInstanceOf[typingsJapgolly.ink.inkStrings.`ink-box`]
    
    inline def `ink-root`: typingsJapgolly.ink.inkStrings.`ink-root` = "ink-root".asInstanceOf[typingsJapgolly.ink.inkStrings.`ink-root`]
    
    inline def `ink-text`: typingsJapgolly.ink.inkStrings.`ink-text` = "ink-text".asInstanceOf[typingsJapgolly.ink.inkStrings.`ink-text`]
    
    inline def `ink-virtual-text`: typingsJapgolly.ink.inkStrings.`ink-virtual-text` = "ink-virtual-text".asInstanceOf[typingsJapgolly.ink.inkStrings.`ink-virtual-text`]
  }
