...
import typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsBasicAuthenticatorMod.Options
...
import typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersJwtTokenManagerMod.JwtTokenManagerOptions
...
object esAuthMod {
  ...
  open class Authenticator ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsMod.Authenticator
  /* static members */
  ...
  open class BasicAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsMod.BasicAuthenticator {
    /**
  ...
  open class BearerTokenAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsMod.BearerTokenAuthenticator {
    /**
      ...
      */
    def this(options: typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsBearerTokenAuthenticatorMod.Options) = this()
  }
  
  @JSImport("ibm-cloud-sdk-core/es/auth", "CloudPakForDataAuthenticator")
  @js.native
  open class CloudPakForDataAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsMod.CloudPakForDataAuthenticator {
    /**
      ...
      *   requests.
      */
    def this(options: typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsCloudPakForDataAuthenticatorMod.Options) = this()
  }
  
  @JSImport("ibm-cloud-sdk-core/es/auth", "ContainerAuthenticator")
  @js.native
  open class ContainerAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsMod.ContainerAuthenticator {
    /**
      *
      ...
      */
    def this(options: typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsContainerAuthenticatorMod.Options) = this()
  }
  
  @JSImport("ibm-cloud-sdk-core/es/auth", "ContainerTokenManager")
  @js.native
  open class ContainerTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersMod.ContainerTokenManager {
    /**
      *
      ...
      * @constructor
      */
    def this(options: typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersContainerTokenManagerMod.Options) = this()
  }
  
  @JSImport("ibm-cloud-sdk-core/es/auth", "Cp4dTokenManager")
  @js.native
  open class Cp4dTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersMod.Cp4dTokenManager {
    /**
      ...
      * @constructor
      */
    def this(options: typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersCp4dTokenManagerMod.Options) = this()
  }
  
  @JSImport("ibm-cloud-sdk-core/es/auth", "IamAuthenticator")
  @js.native
  open class IamAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsMod.IamAuthenticator {
    /**
      *
      ...
      * @throws {Error} When the configuration options are not valid.
      */
    def this(options: typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsIamAuthenticatorMod.Options) = this()
  }
  
  @JSImport("ibm-cloud-sdk-core/es/auth", "IamRequestBasedAuthenticator")
  @js.native
  open class IamRequestBasedAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsMod.IamRequestBasedAuthenticator {
    /**
      *
  ...
  open class IamRequestBasedTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersMod.IamRequestBasedTokenManager {
    /**
      *
      ...
      * @constructor
      */
    def this(options: typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersIamRequestBasedTokenManagerMod.IamRequestOptions) = this()
  }
  
  @JSImport("ibm-cloud-sdk-core/es/auth", "IamTokenManager")
  @js.native
  open class IamTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersMod.IamTokenManager {
    /**
      *
      ...
      * @constructor
      */
    def this(options: typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersIamTokenManagerMod.Options) = this()
  }
  
  @JSImport("ibm-cloud-sdk-core/es/auth", "JwtTokenManager")
  @js.native
  open class JwtTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersMod.JwtTokenManager {
    /**
  ...
  open class NoAuthAuthenticator ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsMod.NoAuthAuthenticator
  
  @JSImport("ibm-cloud-sdk-core/es/auth", "TokenManager")
  @js.native
  open class TokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersMod.TokenManager {
    /**
  ...
  open class TokenRequestBasedAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsMod.TokenRequestBasedAuthenticator {
    /**
  ...
  open class VpcInstanceAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsMod.VpcInstanceAuthenticator {
    /**
      ...
      */
    def this(options: typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsVpcInstanceAuthenticatorMod.Options) = this()
  }
  
  @JSImport("ibm-cloud-sdk-core/es/auth", "VpcInstanceTokenManager")
  @js.native
  open class VpcInstanceTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersMod.VpcInstanceTokenManager {
    /**
      ...
      * @constructor
      */
    def this(options: typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersVpcInstanceTokenManagerMod.Options) = this()
  }
  ...
  inline def getAuthenticatorFromEnvironment(serviceName: String): typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsMod.Authenticator = ^.asInstanceOf[js.Dynamic].applyDynamic("getAuthenticatorFromEnvironment")(serviceName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsMod.Authenticator]
