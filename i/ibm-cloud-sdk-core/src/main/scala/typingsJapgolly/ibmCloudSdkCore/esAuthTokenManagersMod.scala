...
import typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersContainerTokenManagerMod.Options
...
object esAuthTokenManagersMod {
  ...
  open class ContainerTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersContainerTokenManagerMod.ContainerTokenManager {
    /**
      *
  ...
  open class Cp4dTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersCp4dTokenManagerMod.Cp4dTokenManager {
    /**
  ...
  open class IamRequestBasedTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersIamRequestBasedTokenManagerMod.IamRequestBasedTokenManager {
    /**
      *
  ...
  open class IamTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersIamTokenManagerMod.IamTokenManager {
    /**
      *
  ...
  open class JwtTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersJwtTokenManagerMod.JwtTokenManager {
    /**
  ...
  open class TokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersTokenManagerMod.TokenManager {
    /**
  ...
  open class VpcInstanceTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersVpcInstanceTokenManagerMod.VpcInstanceTokenManager {
    /**
