...
object esAuthAuthenticatorsMod {
  ...
  open class Authenticator ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsAuthenticatorMod.Authenticator
  /* static members */
  ...
  open class BasicAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsBasicAuthenticatorMod.BasicAuthenticator {
    /**
  ...
  open class BearerTokenAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsBearerTokenAuthenticatorMod.BearerTokenAuthenticator {
    /**
  ...
  open class CloudPakForDataAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsCloudPakForDataAuthenticatorMod.CloudPakForDataAuthenticator {
    /**
  ...
  open class ContainerAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsContainerAuthenticatorMod.ContainerAuthenticator {
    /**
      *
  ...
  open class IamAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsIamAuthenticatorMod.IamAuthenticator {
    /**
      *
  ...
  open class IamRequestBasedAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsIamRequestBasedAuthenticatorMod.IamRequestBasedAuthenticator {
    /**
      *
  ...
  open class NoAuthAuthenticator ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsNoAuthAuthenticatorMod.NoAuthAuthenticator
  ...
  open class TokenRequestBasedAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsTokenRequestBasedAuthenticatorMod.TokenRequestBasedAuthenticator {
    /**
  ...
  open class VpcInstanceAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsVpcInstanceAuthenticatorMod.VpcInstanceAuthenticator {
    /**
