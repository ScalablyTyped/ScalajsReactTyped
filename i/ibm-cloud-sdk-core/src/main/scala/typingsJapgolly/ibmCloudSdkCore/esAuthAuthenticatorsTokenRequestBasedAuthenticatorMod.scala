...
import typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsAuthenticatorMod.Authenticator
import typingsJapgolly.ibmCloudSdkCore.esAuthTokenManagersMod.JwtTokenManager
