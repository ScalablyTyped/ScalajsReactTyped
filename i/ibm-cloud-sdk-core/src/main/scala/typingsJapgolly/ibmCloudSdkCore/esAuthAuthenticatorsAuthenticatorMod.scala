...
import typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsAuthenticatorInterfaceMod.AuthenticateOptions
import typingsJapgolly.ibmCloudSdkCore.esAuthAuthenticatorsAuthenticatorInterfaceMod.AuthenticatorInterface
