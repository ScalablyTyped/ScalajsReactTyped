...
import typingsJapgolly.ibmCloudSdkCore.esLibBaseServiceMod.UserOptions
import typingsJapgolly.ibmCloudSdkCore.esLibHelperMod.FileObject
import typingsJapgolly.ibmCloudSdkCore.esLibHelperMod.FileWithMetadata
...
object mod {
  ...
  open class Authenticator ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.Authenticator
  /* static members */
  ...
  open class BaseService protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esLibBaseServiceMod.BaseService {
    /**
  ...
  open class BasicAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.BasicAuthenticator {
    /**
  ...
  open class BearerTokenAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.BearerTokenAuthenticator {
    /**
  ...
  open class CloudPakForDataAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.CloudPakForDataAuthenticator {
    /**
  ...
  open class ContainerAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.ContainerAuthenticator {
    /**
      *
  ...
  open class ContainerTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.ContainerTokenManager {
    /**
      *
  ...
  open class Cp4dTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.Cp4dTokenManager {
    /**
  ...
  open class IamAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.IamAuthenticator {
    /**
      *
  ...
  open class IamRequestBasedAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.IamRequestBasedAuthenticator {
    /**
      *
  ...
  open class IamRequestBasedTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.IamRequestBasedTokenManager {
    /**
      *
  ...
  open class IamTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.IamTokenManager {
    /**
      *
  ...
  open class JwtTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.JwtTokenManager {
    /**
  ...
  open class NoAuthAuthenticator ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.NoAuthAuthenticator
  
  @JSImport("ibm-cloud-sdk-core", "TokenManager")
  @js.native
  open class TokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.TokenManager {
    /**
  ...
  open class TokenRequestBasedAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.TokenRequestBasedAuthenticator {
    /**
  ...
  open class VpcInstanceAuthenticator protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.VpcInstanceAuthenticator {
    /**
  ...
  open class VpcInstanceTokenManager protected ()
    extends typingsJapgolly.ibmCloudSdkCore.esAuthMod.VpcInstanceTokenManager {
    /**
