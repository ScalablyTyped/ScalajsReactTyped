package typingsJapgolly.instagramPrivateApi.spamResponseMod

import typingsJapgolly.instagramPrivateApi.instagramPrivateApiBooleans.`true`
import typingsJapgolly.instagramPrivateApi.instagramPrivateApiStrings.fail
import typingsJapgolly.instagramPrivateApi.instagramPrivateApiStrings.feedback_required
