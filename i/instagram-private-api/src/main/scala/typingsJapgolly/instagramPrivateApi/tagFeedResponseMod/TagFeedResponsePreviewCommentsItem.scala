...
trait TagFeedResponsePreviewCommentsItem extends js.Object {
...
object TagFeedResponsePreviewCommentsItem {
  @scala.inline
  def apply(
    bit_flags: Double,
    content_type: String,
    ...
    __obj.asInstanceOf[TagFeedResponsePreviewCommentsItem]
  }
}
