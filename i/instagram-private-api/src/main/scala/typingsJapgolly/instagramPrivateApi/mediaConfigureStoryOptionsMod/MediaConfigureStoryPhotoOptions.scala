...
import typingsJapgolly.instagramPrivateApi.AnonCroporiginalsize
...
import typingsJapgolly.instagramPrivateApi.mediaConfigureOptionsMod.MediaConfigureOptions
