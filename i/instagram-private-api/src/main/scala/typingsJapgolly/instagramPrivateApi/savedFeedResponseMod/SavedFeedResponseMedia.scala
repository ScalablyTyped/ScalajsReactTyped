package typingsJapgolly.instagramPrivateApi.savedFeedResponseMod
...
object SavedFeedResponseMedia {
  ...
  def apply(
    ...
    if (!js.isUndefined(is_external_share_disabled)) __obj.updateDynamic("is_external_share_disabled")(is_external_share_disabled.asInstanceOf[js.Any])
