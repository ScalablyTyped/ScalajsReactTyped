...
import typingsJapgolly.instagramPrivateApi.graphqlRequestOptionsMod.InsightsFriendlyName
import typingsJapgolly.instagramPrivateApi.graphqlRequestOptionsMod.InsightsSurface
