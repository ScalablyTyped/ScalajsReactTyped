...
import typingsJapgolly.instagramPrivateApi.locationRepositoryInfoResponseMod.LocationRepositoryInfoResponseRootObject
import typingsJapgolly.instagramPrivateApi.locationRepositoryStoryResponseMod.LocationRepositoryStoryResponseRootObject
