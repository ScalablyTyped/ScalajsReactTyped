...
import typingsJapgolly.i18nextBrowserLanguagedetector.i18nextBrowserLanguagedetectorStrings.lax
...
import typingsJapgolly.i18nextBrowserLanguagedetector.i18nextBrowserLanguagedetectorStrings.none
import typingsJapgolly.i18nextBrowserLanguagedetector.i18nextBrowserLanguagedetectorStrings.querystring
import typingsJapgolly.i18nextBrowserLanguagedetector.i18nextBrowserLanguagedetectorStrings.sessionStorage
import typingsJapgolly.i18nextBrowserLanguagedetector.i18nextBrowserLanguagedetectorStrings.strict
...
object mod {
  ...
  object CustomDetector {
    ...
    extension [Self <: CustomDetector](x: Self) {
      ...
      inline def setCacheUserLanguage(value: (/* lng */ String, /* options */ DetectorOptions) => Callback): Self = StObject.set(x, "cacheUserLanguage", js.Any.fromFunction2((t0: /* lng */ String, t1: /* options */ DetectorOptions) => (value(t0, t1)).runNow()))
  ...
  trait I18nextBrowserLanguageDetector
    ...
    @JSName("type")
    var type_I18nextBrowserLanguageDetector: typingsJapgolly.i18nextBrowserLanguagedetector.i18nextBrowserLanguagedetectorStrings.languageDetector = js.native
  }
