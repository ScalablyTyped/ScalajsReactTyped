package typingsJapgolly.idyllDocument
...
object mod {
  ...
  trait IdyllDocumentProps extends StObject {
    ...
    /**
      ...
      */
    var errorComponent: js.UndefOr[ElementType] = js.undefined
  ...
  object IdyllDocumentProps {
    ...
    extension [Self <: IdyllDocumentProps](x: Self) {
      ...
      inline def setContext(value: /* context */ Any => Callback): Self = StObject.set(x, "context", js.Any.fromFunction1((t0: /* context */ Any) => value(t0).runNow()))
      ...
      inline def setErrorComponent(value: ElementType): Self = StObject.set(x, "errorComponent", value.asInstanceOf[js.Any])
