...
trait Options extends StObject {
  ...
  /**
    ...
    * Default = MOBILE
    */
  var placeholderNumberType: js.UndefOr[typingsJapgolly.intlTelInput.mod.placeholderNumberType] = js.undefined
...
object Options {
  ...
  extension [Self <: Options](x: Self) {
    ...
    inline def setGeoIpLookup(value: /* callback */ js.Function1[/* countryCode */ String, Unit] => Callback): Self = StObject.set(x, "geoIpLookup", js.Any.fromFunction1((t0: /* callback */ js.Function1[/* countryCode */ String, Unit]) => value(t0).runNow()))
