...
object distSrcApiResourcesPingMod {
  
  object pingResource {
    
    @JSImport("ipfs-http-server/dist/src/api/resources/ping", "pingResource")
    @js.native
    ...
    object options {
      ...
      object validate {
        ...
        object options1 {
          ...
          @JSImport("ipfs-http-server/dist/src/api/resources/ping", "pingResource.options.validate.options_1.allowUnknown")
          @js.native
          val allowUnknown: Boolean = js.native
          
          @JSImport("ipfs-http-server/dist/src/api/resources/ping", "pingResource.options.validate.options_1.stripUnknown")
          @js.native
          val stripUnknown: Boolean = js.native
        }
        
        @JSImport("ipfs-http-server/dist/src/api/resources/ping", "pingResource.options.validate.query")
        @js.native
