...
object distSrcApiResourcesVersionMod {
  
  object versionResource {
    
    @JSImport("ipfs-http-server/dist/src/api/resources/version", "versionResource")
    @js.native
    ...
    object options {
      ...
      object validate {
        ...
        object options1 {
          ...
          @JSImport("ipfs-http-server/dist/src/api/resources/version", "versionResource.options.validate.options_1.allowUnknown")
          @js.native
          val allowUnknown: Boolean = js.native
          
          @JSImport("ipfs-http-server/dist/src/api/resources/version", "versionResource.options.validate.options_1.stripUnknown")
          @js.native
          val stripUnknown: Boolean = js.native
        }
        
        @JSImport("ipfs-http-server/dist/src/api/resources/version", "versionResource.options.validate.query")
        @js.native
