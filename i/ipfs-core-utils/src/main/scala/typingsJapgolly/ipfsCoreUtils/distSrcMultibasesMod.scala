...
import typingsJapgolly.ipfsCoreUtils.anon.Bases
...
object distSrcMultibasesMod {
  ...
  open class Multibases protected () extends StObject {
    ...
    @JSName("_loadBase")
    var _loadBase_Original: typingsJapgolly.ipfsCoreUtils.distSrcTypesMod.LoadBaseFn = js.native
  ...
  type LoadBaseFn = typingsJapgolly.ipfsCoreUtils.distSrcTypesMod.LoadBaseFn
