...
object distSrcFilesNormaliseCandidateMultipleMod {
  ...
  ): AsyncGenerator[typingsJapgolly.ipfsUnixfsImporter.distSrcTypesMod.ImportCandidate, Unit, Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("normaliseCandidateMultiple")(input.asInstanceOf[js.Any], normaliseContent.asInstanceOf[js.Any])).asInstanceOf[AsyncGenerator[typingsJapgolly.ipfsUnixfsImporter.distSrcTypesMod.ImportCandidate, Unit, Unit]]
