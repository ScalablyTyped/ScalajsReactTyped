...
import typingsJapgolly.ipfsCoreUtils.anon.Codecs
...
object distSrcMulticodecsMod {
  ...
  open class Multicodecs protected () extends StObject {
    ...
    @JSName("_loadCodec")
    var _loadCodec_Original: typingsJapgolly.ipfsCoreUtils.distSrcTypesMod.LoadCodecFn = js.native
  ...
  type LoadCodecFn = typingsJapgolly.ipfsCoreUtils.distSrcTypesMod.LoadCodecFn
}
