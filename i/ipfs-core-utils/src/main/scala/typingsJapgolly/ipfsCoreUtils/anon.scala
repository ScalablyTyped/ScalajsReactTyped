...
import typingsJapgolly.ipfsCoreUtils.distSrcMultihashesMod.MultihashHasher
import typingsJapgolly.ipfsCoreUtils.distSrcTypesMod.LoadBaseFn
import typingsJapgolly.ipfsCoreUtils.distSrcTypesMod.LoadCodecFn
import typingsJapgolly.ipfsCoreUtils.distSrcTypesMod.LoadHasherFn
...
object anon {
  ...
  trait Body extends StObject {
    ...
    var headers: org.scalajs.dom.Headers | (Record[String, String])
  ...
  object Body {
    ...
    inline def apply(
      body: FormData,
      headers: org.scalajs.dom.Headers | (Record[String, String]),
      parts: js.Array[End],
      total: Double
    ): Body = {
    ...
    extension [Self <: Body](x: Self) {
      ...
      inline def setHeaders(value: org.scalajs.dom.Headers | (Record[String, String])): Self = StObject.set(x, "headers", value.asInstanceOf[js.Any])
