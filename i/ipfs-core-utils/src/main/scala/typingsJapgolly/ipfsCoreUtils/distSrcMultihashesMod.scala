...
import typingsJapgolly.ipfsCoreUtils.anon.Hashers
...
object distSrcMultihashesMod {
  ...
  open class Multihashes protected () extends StObject {
    ...
    @JSName("_loadHasher")
    var _loadHasher_Original: typingsJapgolly.ipfsCoreUtils.distSrcTypesMod.LoadHasherFn = js.native
  ...
  type LoadHasherFn = typingsJapgolly.ipfsCoreUtils.distSrcTypesMod.LoadHasherFn
