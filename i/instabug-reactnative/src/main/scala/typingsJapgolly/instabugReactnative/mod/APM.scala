...
object APM {
  ...
  object logLevel extends StObject {
    ...
    sealed trait debug
      extends StObject
         with logLevel
    /* 4 */ val debug: typingsJapgolly.instabugReactnative.mod.APM.logLevel.debug & Double = js.native
    
    @js.native
    sealed trait error
      extends StObject
         with logLevel
    /* 1 */ val error: typingsJapgolly.instabugReactnative.mod.APM.logLevel.error & Double = js.native
    
    @js.native
    sealed trait info
      extends StObject
         with logLevel
    /* 3 */ val info: typingsJapgolly.instabugReactnative.mod.APM.logLevel.info & Double = js.native
    
    @js.native
    sealed trait none
      extends StObject
         with logLevel
    /* 0 */ val none: typingsJapgolly.instabugReactnative.mod.APM.logLevel.none & Double = js.native
    
    @js.native
    sealed trait verbose
      extends StObject
         with logLevel
    /* 5 */ val verbose: typingsJapgolly.instabugReactnative.mod.APM.logLevel.verbose & Double = js.native
    
    @js.native
    sealed trait warning
      extends StObject
         with logLevel
    /* 2 */ val warning: typingsJapgolly.instabugReactnative.mod.APM.logLevel.warning & Double = js.native
  }
