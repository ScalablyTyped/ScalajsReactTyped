...
import typingsJapgolly.ipldCar.typesApiMod.CarBufferWriterOptions
...
object typesLibBufferWriterMod {
  ...
  type CID = typingsJapgolly.ipldCar.typesApiMod.CID[Any, Double, Double, Version]
  ...
  trait CarBufferWriter
    extends StObject
       with typingsJapgolly.ipldCar.typesApiMod.CarBufferWriter {
  ...
  type Writer = typingsJapgolly.ipldCar.typesApiMod.CarBufferWriter
}
