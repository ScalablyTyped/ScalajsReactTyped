...
import typingsJapgolly.ipldCar.typesTestCommonMod.TestBlock
...
object anon {
  ...
  trait BlockLength extends StObject {
    ...
    var cid: CID[Any, Double, Double, typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version]
  ...
  object BlockLength {
    ...
    inline def apply(
      blockLength: Double,
      blockOffset: Double,
      cid: CID[Any, Double, Double, typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version],
      length: Double,
      offset: Double
    ): BlockLength = {
    ...
    extension [Self <: BlockLength](x: Self) {
      ...
      inline def setCid(value: CID[Any, Double, Double, typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version]): Self = StObject.set(x, "cid", value.asInstanceOf[js.Any])
  ...
  trait ByteLength extends StObject {
    ...
    var roots: js.UndefOr[
        js.Array[
          typingsJapgolly.multiformats.cidMod.CID[Any, Double, Double, typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version]
        ]
      ] = js.undefined
  }
  object ByteLength {
    ...
    extension [Self <: ByteLength](x: Self) {
      ...
      inline def setRootsVarargs(
        value: (typingsJapgolly.multiformats.cidMod.CID[Any, Double, Double, typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version])*
  ...
  trait Roots extends StObject {
    ...
    var roots: js.Array[typingsJapgolly.ipldCar.typesLibBufferWriterMod.CID]
  }
  object Roots {
    
    inline def apply(roots: js.Array[typingsJapgolly.ipldCar.typesLibBufferWriterMod.CID]): Roots = {
    ...
    extension [Self <: Roots](x: Self) {
      ...
      inline def setRoots(value: js.Array[typingsJapgolly.ipldCar.typesLibBufferWriterMod.CID]): Self = StObject.set(x, "roots", value.asInstanceOf[js.Any])
      
      inline def setRootsVarargs(value: typingsJapgolly.ipldCar.typesLibBufferWriterMod.CID*): Self = StObject.set(x, "roots", js.Array(value*))
    }
  }
