...
object typesLibWriterBrowserMod {
  ...
  open class CarWriter protected ()
    extends StObject
       with typingsJapgolly.ipldCar.typesApiMod.BlockWriter {
    /**
      * @param {CID[]} roots
    ...
    var _encoder: typingsJapgolly.ipldCar.typesLibCodingMod.CarEncoder = js.native
    ...
    /* CompleteClass */
    override def put(block: typingsJapgolly.ipldCar.typesApiMod.Block): js.Promise[Unit] = js.native
  }
  /* static members */
  object CarWriter {
  ...
  type BlockWriter = typingsJapgolly.ipldCar.typesApiMod.BlockWriter
  
  type CarEncoder = typingsJapgolly.ipldCar.typesLibCodingMod.CarEncoder
  
  type IteratorChannel = typingsJapgolly.ipldCar.typesLibCodingMod.IteratorChannel[js.typedarray.Uint8Array]
  
  type WriterChannel = typingsJapgolly.ipldCar.typesApiMod.WriterChannel
}
