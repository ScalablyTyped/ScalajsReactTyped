package typingsJapgolly.ionicons.componentsMod.LocalJSX
...
import typingsJapgolly.ionicons.ioniconsStrings.ios
import typingsJapgolly.ionicons.ioniconsStrings.md
import typingsJapgolly.ionicons.stencilCoreMod.JSXBase.HTMLAttributes
...
object IonIcon {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonIconElement] => Callback = null,
    ...
    if (radiogroup != null) __obj.updateDynamic("radiogroup")(radiogroup.asInstanceOf[js.Any])
    if (ref != null) __obj.updateDynamic("ref")(js.Any.fromFunction1((t0: /* elm */ js.UndefOr[typingsJapgolly.ionicons.componentsMod._Global_.HTMLIonIconElement]) => ref(t0).runNow()))
