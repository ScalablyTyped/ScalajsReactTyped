...
import typingsJapgolly.ionicons.distTypesComponentsMod.Components.IonIcon
import typingsJapgolly.ionicons.distTypesComponentsMod.global.HTMLIonIconElement
import typingsJapgolly.ionicons.distTypesStencilPublicRuntimeMod.JSXBase.HTMLAttributes
...
object distTypesComponentsMod {
  ...
  object global {
    ...
    - typingsJapgolly.ionicons.distTypesStencilPublicRuntimeMod.HTMLStencilElement because Inheritance from two classes. Inlined componentOnReady */ @js.native
    trait HTMLIonIconElement
      extends StObject
         with IonIcon
         with typingsJapgolly.std.Element
  ...
  object LocalJSX {
    ...
    trait IntrinsicElements extends StObject {
      ...
      var `ion-icon`: typingsJapgolly.ionicons.distTypesComponentsMod.LocalJSX.IonIcon
    }
    object IntrinsicElements {
      
      inline def apply(`ion-icon`: typingsJapgolly.ionicons.distTypesComponentsMod.LocalJSX.IonIcon): IntrinsicElements = {
        val __obj = js.Dynamic.literal()
        __obj.updateDynamic("ion-icon")(`ion-icon`.asInstanceOf[js.Any])
      ...
      extension [Self <: IntrinsicElements](x: Self) {
        ...
        inline def `setIon-icon`(value: typingsJapgolly.ionicons.distTypesComponentsMod.LocalJSX.IonIcon): Self = StObject.set(x, "ion-icon", value.asInstanceOf[js.Any])
      }
    }
    ...
    object IonIcon {
      ...
      inline def apply(): typingsJapgolly.ionicons.distTypesComponentsMod.LocalJSX.IonIcon = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.ionicons.distTypesComponentsMod.LocalJSX.IonIcon]
      }
      
      extension [Self <: typingsJapgolly.ionicons.distTypesComponentsMod.LocalJSX.IonIcon](x: Self) {
  ...
  object stencilCoreAugmentingMod {
    ...
    object JSX {
      ...
      trait IntrinsicElements extends StObject {
        ...
        var `ion-icon`: typingsJapgolly.ionicons.distTypesComponentsMod.LocalJSX.IonIcon & HTMLAttributes[HTMLIonIconElement]
      }
      object IntrinsicElements {
        
        inline def apply(
          `ion-icon`: typingsJapgolly.ionicons.distTypesComponentsMod.LocalJSX.IonIcon & HTMLAttributes[HTMLIonIconElement]
        ): IntrinsicElements = {
          val __obj = js.Dynamic.literal()
          __obj.updateDynamic("ion-icon")(`ion-icon`.asInstanceOf[js.Any])
          __obj.asInstanceOf[IntrinsicElements]
        ...
        extension [Self <: IntrinsicElements](x: Self) {
          ...
          inline def `setIon-icon`(
            value: typingsJapgolly.ionicons.distTypesComponentsMod.LocalJSX.IonIcon & HTMLAttributes[HTMLIonIconElement]
