...
object FunctionalUtilities {
  ...
  def apply(
    ...
    __obj.updateDynamic("forEach")(js.Any.fromFunction2((t0: js.Array[typingsJapgolly.ionicons.stencilCoreMod.VNode], t1: js.Function3[
  /* vnode */ typingsJapgolly.ionicons.stencilCoreMod.ChildNode, 
  /* index */ scala.Double, 
  /* array */ js.Array[typingsJapgolly.ionicons.stencilCoreMod.ChildNode], 
  scala.Unit]) => forEach(t0, t1).runNow()))
    __obj.updateDynamic("map")(js.Any.fromFunction2((t0: js.Array[typingsJapgolly.ionicons.stencilCoreMod.VNode], t1: js.Function3[
  /* vnode */ typingsJapgolly.ionicons.stencilCoreMod.ChildNode, 
  /* index */ scala.Double, 
  /* array */ js.Array[typingsJapgolly.ionicons.stencilCoreMod.ChildNode], 
  typingsJapgolly.ionicons.stencilCoreMod.ChildNode]) => map(t0, t1).runNow()))
