...
import typingsJapgolly.idb.idbStrings.next
import typingsJapgolly.idb.idbStrings.nextunique
import typingsJapgolly.idb.idbStrings.prev
import typingsJapgolly.idb.idbStrings.prevunique
...
trait Cursor[TValue, TKey] extends js.Object {
  ...
  def continue(key: typingsJapgolly.std.IDBKeyRange): js.Promise[Cursor[TValue, TKey]] = js.native
  ...
  def continuePrimaryKey(key: typingsJapgolly.std.IDBKeyRange): js.Promise[Cursor[TValue, TKey]] = js.native
  def continuePrimaryKey(key: typingsJapgolly.std.IDBKeyRange, primaryKey: TKey): js.Promise[Cursor[TValue, TKey]] = js.native
