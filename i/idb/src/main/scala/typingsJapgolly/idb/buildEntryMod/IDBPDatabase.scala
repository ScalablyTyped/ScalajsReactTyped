...
trait IDBPDatabase[DBTypes /* <: DBSchema | Any */]
  ...
  /**
    ...
    * @param options
    */
  def transaction[Name /* <: StoreNames[DBTypes] */, Mode /* <: IDBTransactionMode */](storeNames: Name): IDBPTransaction[DBTypes, js.Array[Name], Mode] = js.native
  def transaction[Name /* <: StoreNames[DBTypes] */, Mode /* <: IDBTransactionMode */](storeNames: Name, mode: Mode): IDBPTransaction[DBTypes, js.Array[Name], Mode] = js.native
  def transaction[Name /* <: StoreNames[DBTypes] */, Mode /* <: IDBTransactionMode */](storeNames: Name, mode: Mode, options: IDBTransactionOptions): IDBPTransaction[DBTypes, js.Array[Name], Mode] = js.native
  def transaction[Name /* <: StoreNames[DBTypes] */, Mode /* <: IDBTransactionMode */](storeNames: Name, mode: Unit, options: IDBTransactionOptions): IDBPTransaction[DBTypes, js.Array[Name], Mode] = js.native
  @JSName("transaction")
  def transaction_NamesMode[Names /* <: ArrayLike[StoreNames[DBTypes]] */, Mode /* <: IDBTransactionMode */](storeNames: Names): IDBPTransaction[DBTypes, Names, Mode] = js.native
  @JSName("transaction")
  def transaction_NamesMode[Names /* <: ArrayLike[StoreNames[DBTypes]] */, Mode /* <: IDBTransactionMode */](storeNames: Names, mode: Mode): IDBPTransaction[DBTypes, Names, Mode] = js.native
  @JSName("transaction")
  def transaction_NamesMode[Names /* <: ArrayLike[StoreNames[DBTypes]] */, Mode /* <: IDBTransactionMode */](storeNames: Names, mode: Mode, options: IDBTransactionOptions): IDBPTransaction[DBTypes, Names, Mode] = js.native
  @JSName("transaction")
  def transaction_NamesMode[Names /* <: ArrayLike[StoreNames[DBTypes]] */, Mode /* <: IDBTransactionMode */](storeNames: Names, mode: Unit, options: IDBTransactionOptions): IDBPTransaction[DBTypes, Names, Mode] = js.native
}
