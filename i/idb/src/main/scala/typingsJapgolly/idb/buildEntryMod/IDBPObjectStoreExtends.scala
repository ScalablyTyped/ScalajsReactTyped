...
object IDBPObjectStoreExtends {
  ...
  inline def apply(
    ...
    deleteIndex: /* name */ String => Callback,
    keyPath: String | js.Array[String],
    name: String
  ): IDBPObjectStoreExtends = {
    val __obj = js.Dynamic.literal(autoIncrement = autoIncrement.asInstanceOf[js.Any], deleteIndex = js.Any.fromFunction1((t0: /* name */ String) => deleteIndex(t0).runNow()), keyPath = keyPath.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
  ...
  extension [Self <: IDBPObjectStoreExtends](x: Self) {
    ...
    inline def setDeleteIndex(value: /* name */ String => Callback): Self = StObject.set(x, "deleteIndex", js.Any.fromFunction1((t0: /* name */ String) => value(t0).runNow()))
