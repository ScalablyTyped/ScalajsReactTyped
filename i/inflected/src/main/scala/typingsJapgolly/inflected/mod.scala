package typingsJapgolly.inflected

import org.scalablytyped.runtime.Shortcut
import typingsJapgolly.inflected.mod.Options.Humanize
import typingsJapgolly.inflected.mod.Options.Parameterize
import typingsJapgolly.inflected.mod.Options.Transliterate
