...
object distSrcCommandsDagResolveMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/dag/resolve", JSImport.Default)
  @js.native
  ...
  object Argv {
    ...
    inline def apply(ctx: Context, ref: String, timeout: Double): Argv = {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsDagResolveMod.foo` */
