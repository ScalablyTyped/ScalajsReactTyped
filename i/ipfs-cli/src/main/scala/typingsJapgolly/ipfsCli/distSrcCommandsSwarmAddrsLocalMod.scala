...
object distSrcCommandsSwarmAddrsLocalMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/swarm/addrs/local", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsSwarmAddrsLocalMod.foo` */
