...
object distSrcCommandsObjectLinksMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/object/links", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsObjectLinksMod.foo` */
