...
object distSrcCommandsBootstrapListMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/bootstrap/list", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsBootstrapListMod.foo` */
