...
object distSrcCommandsKeyGenMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/key/gen", JSImport.Default)
  @js.native
  ...
  object Argv {
    ...
    inline def apply(ctx: Context, name: String, size: Double, timeout: Double, `type`: String): Argv = {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsKeyGenMod.foo` */
