...
object distSrcCommandsConfigReplaceMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/config/replace", JSImport.Default)
  @js.native
  ...
  object Argv {
    ...
    inline def apply(ctx: Context, file: String, timeout: Double): Argv = {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsConfigReplaceMod.foo` */
