...
object distSrcCommandsSwarmAddrsMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/swarm/addrs", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsSwarmAddrsMod.foo` */
