...
object distSrcCommandsDhtPutMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/dht/put", JSImport.Default)
  @js.native
  ...
  object Argv {
    ...
    inline def apply(ctx: Context, key: String, timeout: Double, value: String): Argv = {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsDhtPutMod.foo` */
