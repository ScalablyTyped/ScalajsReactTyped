...
import typingsJapgolly.ipfsCli.anon.Cleanup
import typingsJapgolly.ipfsCli.anon.Migrate
import typingsJapgolly.ipfsCli.anon.Nsecs
import typingsJapgolly.ipfsCli.distSrcTypesMod.Print
...
object distSrcUtilsMod {
  ...
  inline def createProgressBar(totalBytes: Double): typingsJapgolly.progress.mod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("createProgressBar")(totalBytes.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.progress.mod.^]
  inline def createProgressBar(totalBytes: Double, output: Any): typingsJapgolly.progress.mod.^ = (^.asInstanceOf[js.Dynamic].applyDynamic("createProgressBar")(totalBytes.asInstanceOf[js.Any], output.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.progress.mod.^]
