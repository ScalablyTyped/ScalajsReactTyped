...
object distSrcCommandsConfigShowMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/config/show", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsConfigShowMod.foo` */
