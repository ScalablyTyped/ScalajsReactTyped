...
import typingsJapgolly.ipns.distSrcPbIpnsMod.IpnsEntry.ValidityType
  ...
  object IpnsEntry {
    ...
    object ValidityType extends StObject {
      ...
      sealed trait EOL
        extends StObject
           with ValidityType
      /* "EOL" */ val EOL: typingsJapgolly.ipns.distSrcPbIpnsMod.IpnsEntry.ValidityType.EOL & String = js.native
