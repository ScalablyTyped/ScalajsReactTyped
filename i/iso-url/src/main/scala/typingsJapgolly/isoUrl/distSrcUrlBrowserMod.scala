package typingsJapgolly.isoUrl
...
object distSrcUrlBrowserMod {
  ...
  open class URLSearchParams ()
    extends StObject
       with typingsJapgolly.std.URLSearchParams {
    def this(init: String) = this()
    def this(init: js.Array[js.Array[String]]) = this()
    def this(init: Record[String, String]) = this()
    def this(init: typingsJapgolly.std.URLSearchParams) = this()
  }
  ...
  open class URLWithLegacySupport () extends StObject {
    ...
    def searchParams: typingsJapgolly.std.URLSearchParams = js.native
