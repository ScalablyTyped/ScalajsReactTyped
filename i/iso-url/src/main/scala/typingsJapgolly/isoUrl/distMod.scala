...
import typingsJapgolly.isoUrl.distSrcUrlMod.URLWithLegacySupport
import typingsJapgolly.isoUrl.isoUrlStrings.httpColonSlashSlashlocalhost
...
object distMod {
  ...
  open class URLSearchParams ()
    extends typingsJapgolly.isoUrl.distSrcUrlMod.URLSearchParams {
