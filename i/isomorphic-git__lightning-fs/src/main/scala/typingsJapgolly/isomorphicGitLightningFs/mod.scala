package typingsJapgolly.isomorphicGitLightningFs

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.isomorphicGitLightningFs.isomorphicGitLightningFsInts.`1`
import typingsJapgolly.isomorphicGitLightningFs.isomorphicGitLightningFsStrings.dir
import typingsJapgolly.isomorphicGitLightningFs.isomorphicGitLightningFsStrings.file
import typingsJapgolly.isomorphicGitLightningFs.isomorphicGitLightningFsStrings.utf8
...
object mod {
  ...
  object Stats {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(ctimeMs = ctimeMs.asInstanceOf[js.Any], dev = 1, gid = 1, ino = ino.asInstanceOf[js.Any], isDirectory = isDirectory.toJsFn, isFile = isFile.toJsFn, isSymbolicLink = isSymbolicLink.toJsFn, mode = mode.asInstanceOf[js.Any], mtimeMs = mtimeMs.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any], uid = 1)
