package typingsJapgolly.isPiped
...
object mod extends Shortcut {
  ...
  @js.native
  val ^ : typingsJapgolly.isPiped.mod.isPiped = js.native
  ...
  type _To = typingsJapgolly.isPiped.mod.isPiped
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: typingsJapgolly.isPiped.mod.isPiped = ^
  ...
  object isPiped {
    ...
    inline def apply(in: Double => IsPipedResult, out: Double => IsPipedResult): typingsJapgolly.isPiped.mod.isPiped = {
      val __obj = js.Dynamic.literal(in = js.Any.fromFunction1(in), out = js.Any.fromFunction1(out))
      __obj.asInstanceOf[typingsJapgolly.isPiped.mod.isPiped]
    }
    
    extension [Self <: typingsJapgolly.isPiped.mod.isPiped](x: Self) {
