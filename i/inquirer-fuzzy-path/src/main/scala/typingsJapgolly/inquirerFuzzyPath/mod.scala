package typingsJapgolly.inquirerFuzzyPath
...
import typingsJapgolly.inquirerFuzzyPath.inquirerFuzzyPathStrings.any
import typingsJapgolly.inquirerFuzzyPath.inquirerFuzzyPathStrings.directory
import typingsJapgolly.inquirerFuzzyPath.inquirerFuzzyPathStrings.file
import typingsJapgolly.inquirerFuzzyPath.inquirerFuzzyPathStrings.fuzzypath
...
object mod {
  ...
  object InquirerFuzzyPath {
    ...
    inline def apply[T /* <: Answers */](onSubmit: String => Callback, search: String => js.Promise[Unit]): InquirerFuzzyPath[T] = {
      val __obj = js.Dynamic.literal(onSubmit = js.Any.fromFunction1((t0: String) => onSubmit(t0).runNow()), search = js.Any.fromFunction1(search))
