...
import typingsJapgolly.i18nJs.i18nJsStrings.number
...
object mod {
  ...
  trait TranslateOptions
    ...
    var defaults: js.UndefOr[
        js.Array[typingsJapgolly.i18nJs.anon.Message | typingsJapgolly.i18nJs.anon.Scope]
      ] = js.undefined
  ...
  object TranslateOptions {
    ...
    extension [Self <: TranslateOptions](x: Self) {
      ...
      inline def setDefaults(value: js.Array[typingsJapgolly.i18nJs.anon.Message | typingsJapgolly.i18nJs.anon.Scope]): Self = StObject.set(x, "defaults", value.asInstanceOf[js.Any])
      
      inline def setDefaultsUndefined: Self = StObject.set(x, "defaults", js.undefined)
      
      inline def setDefaultsVarargs(value: (typingsJapgolly.i18nJs.anon.Message | typingsJapgolly.i18nJs.anon.Scope)*): Self = StObject.set(x, "defaults", js.Array(value*))
