...
import typingsJapgolly.ipfsUnixfs.anon.BlockSizes
...
object mod {
  ...
  open class UnixFS () extends StObject {
    ...
    var mtime: js.UndefOr[typingsJapgolly.ipfsUnixfs.distSrcTypesMod.Mtime] = js.native
  ...
  inline def parseMtime(input: Any): js.UndefOr[typingsJapgolly.ipfsUnixfs.distSrcTypesMod.Mtime] = ^.asInstanceOf[js.Dynamic].applyDynamic("parseMtime")(input.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typingsJapgolly.ipfsUnixfs.distSrcTypesMod.Mtime]]
  
  type Mtime = typingsJapgolly.ipfsUnixfs.distSrcTypesMod.Mtime
  
  type MtimeLike = typingsJapgolly.ipfsUnixfs.distSrcTypesMod.MtimeLike
}
