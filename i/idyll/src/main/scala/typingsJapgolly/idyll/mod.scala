...
import typingsJapgolly.idyll.anon.Compiler
...
object mod {
  ...
  */
  ...
  object ComponentFiles {
    ...
    inline def COMPONENT_DIRS: typingsJapgolly.idyll.idyllStrings.COMPONENT_DIRS = "COMPONENT_DIRS".asInstanceOf[typingsJapgolly.idyll.idyllStrings.COMPONENT_DIRS]
    
    inline def DEFAULT_COMPONENT_DIRS: typingsJapgolly.idyll.idyllStrings.DEFAULT_COMPONENT_DIRS = "DEFAULT_COMPONENT_DIRS".asInstanceOf[typingsJapgolly.idyll.idyllStrings.DEFAULT_COMPONENT_DIRS]
  }
  ...
  trait Options extends StObject {
    ...
    /**
      * Compiler options
      */
    var compiler: js.UndefOr[typingsJapgolly.idyllCompiler.mod.Options] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setCompiler(value: typingsJapgolly.idyllCompiler.mod.Options): Self = StObject.set(x, "compiler", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.idyll.idyllStrings.APP_PATH
    - typingsJapgolly.idyll.idyllStrings.CSS_INPUT_FILE
    - typingsJapgolly.idyll.idyllStrings.DATA_DIR
    - typingsJapgolly.idyll.idyllStrings.HTML_TEMPLATE_FILE
    - typingsJapgolly.idyll.idyllStrings.IDYLL_INPUT_FILE
    - typingsJapgolly.idyll.idyllStrings.INPUT_DIR
    - typingsJapgolly.idyll.idyllStrings.PACKAGE_FILE
    - typingsJapgolly.idyll.idyllStrings.OUTPUT_DIR
    - typingsJapgolly.idyll.idyllStrings.TMP_DIR
    - typingsJapgolly.idyll.idyllStrings.CSS_OUTPUT_FILE
    - typingsJapgolly.idyll.idyllStrings.HTML_OUTPUT_FILE
    - typingsJapgolly.idyll.idyllStrings.JS_OUTPUT_FILE
  */
  trait PredefinedFile extends StObject
  object PredefinedFile {
    
    inline def APP_PATH: typingsJapgolly.idyll.idyllStrings.APP_PATH = "APP_PATH".asInstanceOf[typingsJapgolly.idyll.idyllStrings.APP_PATH]
    
    inline def CSS_INPUT_FILE: typingsJapgolly.idyll.idyllStrings.CSS_INPUT_FILE = "CSS_INPUT_FILE".asInstanceOf[typingsJapgolly.idyll.idyllStrings.CSS_INPUT_FILE]
    
    inline def CSS_OUTPUT_FILE: typingsJapgolly.idyll.idyllStrings.CSS_OUTPUT_FILE = "CSS_OUTPUT_FILE".asInstanceOf[typingsJapgolly.idyll.idyllStrings.CSS_OUTPUT_FILE]
    
    inline def DATA_DIR: typingsJapgolly.idyll.idyllStrings.DATA_DIR = "DATA_DIR".asInstanceOf[typingsJapgolly.idyll.idyllStrings.DATA_DIR]
    
    inline def HTML_OUTPUT_FILE: typingsJapgolly.idyll.idyllStrings.HTML_OUTPUT_FILE = "HTML_OUTPUT_FILE".asInstanceOf[typingsJapgolly.idyll.idyllStrings.HTML_OUTPUT_FILE]
    
    inline def HTML_TEMPLATE_FILE: typingsJapgolly.idyll.idyllStrings.HTML_TEMPLATE_FILE = "HTML_TEMPLATE_FILE".asInstanceOf[typingsJapgolly.idyll.idyllStrings.HTML_TEMPLATE_FILE]
    
    inline def IDYLL_INPUT_FILE: typingsJapgolly.idyll.idyllStrings.IDYLL_INPUT_FILE = "IDYLL_INPUT_FILE".asInstanceOf[typingsJapgolly.idyll.idyllStrings.IDYLL_INPUT_FILE]
    
    inline def INPUT_DIR: typingsJapgolly.idyll.idyllStrings.INPUT_DIR = "INPUT_DIR".asInstanceOf[typingsJapgolly.idyll.idyllStrings.INPUT_DIR]
    
    inline def JS_OUTPUT_FILE: typingsJapgolly.idyll.idyllStrings.JS_OUTPUT_FILE = "JS_OUTPUT_FILE".asInstanceOf[typingsJapgolly.idyll.idyllStrings.JS_OUTPUT_FILE]
    
    inline def OUTPUT_DIR: typingsJapgolly.idyll.idyllStrings.OUTPUT_DIR = "OUTPUT_DIR".asInstanceOf[typingsJapgolly.idyll.idyllStrings.OUTPUT_DIR]
    
    inline def PACKAGE_FILE: typingsJapgolly.idyll.idyllStrings.PACKAGE_FILE = "PACKAGE_FILE".asInstanceOf[typingsJapgolly.idyll.idyllStrings.PACKAGE_FILE]
    
    inline def TMP_DIR: typingsJapgolly.idyll.idyllStrings.TMP_DIR = "TMP_DIR".asInstanceOf[typingsJapgolly.idyll.idyllStrings.TMP_DIR]
  }
}
