package typingsJapgolly.inlineCritical

import typingsJapgolly.inlineCritical.inlineCriticalBooleans.`false`
import typingsJapgolly.inlineCritical.inlineCriticalStrings.body
import typingsJapgolly.inlineCritical.inlineCriticalStrings.head
