...
object anon {
  ...
  object Partiali18nAPI {
    ...
    extension [Self <: Partiali18nAPI](x: Self) {
      ...
      inline def setGetCatalog(value: CallbackTo[GlobalCatalog]): Self = StObject.set(x, "getCatalog", value.toJsFn)
      ...
      inline def setSetLocale(value: /* locale */ String => Callback): Self = StObject.set(x, "setLocale", js.Any.fromFunction1((t0: /* locale */ String) => value(t0).runNow()))
