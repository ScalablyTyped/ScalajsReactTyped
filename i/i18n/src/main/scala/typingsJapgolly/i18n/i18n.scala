...
import typingsJapgolly.i18n.anon.Disable
import typingsJapgolly.i18n.anon.Partiali18nAPI
...
object i18n {
  ...
  object ConfigurationOptions {
    ...
    extension [Self <: ConfigurationOptions](x: Self) {
      ...
      inline def setLogDebugFn(value: /* msg */ String => Callback): Self = StObject.set(x, "logDebugFn", js.Any.fromFunction1((t0: /* msg */ String) => value(t0).runNow()))
      
      inline def setLogDebugFnUndefined: Self = StObject.set(x, "logDebugFn", js.undefined)
      
      inline def setLogErrorFn(value: /* msg */ String => Callback): Self = StObject.set(x, "logErrorFn", js.Any.fromFunction1((t0: /* msg */ String) => value(t0).runNow()))
      
      inline def setLogErrorFnUndefined: Self = StObject.set(x, "logErrorFn", js.undefined)
      
      inline def setLogWarnFn(value: /* msg */ String => Callback): Self = StObject.set(x, "logWarnFn", js.Any.fromFunction1((t0: /* msg */ String) => value(t0).runNow()))
  ...
  trait I18n extends StObject {
    ...
    def init(request: Request, response: typingsJapgolly.i18n.Express.Response): Unit = js.native
    def init(request: Request, response: typingsJapgolly.i18n.Express.Response, next: js.Function0[Unit]): Unit = js.native
    ...
    // tslint:disable-next-line:unified-signatures
    def setLocale(requestOrResponse: Request | typingsJapgolly.i18n.Express.Response, locale: String): Unit = js.native
    def setLocale(
      requestOrResponse: Request | typingsJapgolly.i18n.Express.Response,
      locale: String,
      inheritance: Boolean
    ): Unit = js.native
