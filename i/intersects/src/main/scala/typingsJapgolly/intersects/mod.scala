package typingsJapgolly.intersects
...
object mod {
  ...
  inline def boxPoint(x1: Double, y1: Double, w1: Double, h1: Double, x2: Double, y2: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("boxPoint")(x1.asInstanceOf[js.Any], y1.asInstanceOf[js.Any], w1.asInstanceOf[js.Any], h1.asInstanceOf[js.Any], x2.asInstanceOf[js.Any], y2.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def boxPolygon(xb: Double, yb: Double, wb: Double, hb: Double, points: js.Array[Double]): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("boxPolygon")(xb.asInstanceOf[js.Any], yb.asInstanceOf[js.Any], wb.asInstanceOf[js.Any], hb.asInstanceOf[js.Any], points.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def circleCircle(x1: Double, y1: Double, r1: Double, x2: Double, y2: Double, r2: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("circleCircle")(x1.asInstanceOf[js.Any], y1.asInstanceOf[js.Any], r1.asInstanceOf[js.Any], x2.asInstanceOf[js.Any], y2.asInstanceOf[js.Any], r2.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def circlePoint(x1: Double, y1: Double, r1: Double, x2: Double, y2: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("circlePoint")(x1.asInstanceOf[js.Any], y1.asInstanceOf[js.Any], r1.asInstanceOf[js.Any], x2.asInstanceOf[js.Any], y2.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def circlePolygon(xc: Double, yc: Double, rc: Double, points: js.Array[Double]): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("circlePolygon")(xc.asInstanceOf[js.Any], yc.asInstanceOf[js.Any], rc.asInstanceOf[js.Any], points.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def ellipsePoint(xe: Double, ye: Double, rex: Double, rey: Double, x1: Double, y1: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("ellipsePoint")(xe.asInstanceOf[js.Any], ye.asInstanceOf[js.Any], rex.asInstanceOf[js.Any], rey.asInstanceOf[js.Any], x1.asInstanceOf[js.Any], y1.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def ellipsePolygon(xe: Double, ye: Double, rex: Double, rey: Double, points: js.Array[Double]): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("ellipsePolygon")(xe.asInstanceOf[js.Any], ye.asInstanceOf[js.Any], rex.asInstanceOf[js.Any], rey.asInstanceOf[js.Any], points.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def pointBox(x1: Double, y1: Double, xb: Double, yb: Double, wb: Double, hb: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("pointBox")(x1.asInstanceOf[js.Any], y1.asInstanceOf[js.Any], xb.asInstanceOf[js.Any], yb.asInstanceOf[js.Any], wb.asInstanceOf[js.Any], hb.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def pointCircle(x1: Double, y1: Double, xc: Double, yc: Double, rc: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("pointCircle")(x1.asInstanceOf[js.Any], y1.asInstanceOf[js.Any], xc.asInstanceOf[js.Any], yc.asInstanceOf[js.Any], rc.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def pointEllipse(x1: Double, y1: Double, xe: Double, ye: Double, rex: Double, rey: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("pointEllipse")(x1.asInstanceOf[js.Any], y1.asInstanceOf[js.Any], xe.asInstanceOf[js.Any], ye.asInstanceOf[js.Any], rex.asInstanceOf[js.Any], rey.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def pointLine(xp: Double, yp: Double, x1: Double, y1: Double, x2: Double, y2: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("pointLine")(xp.asInstanceOf[js.Any], yp.asInstanceOf[js.Any], x1.asInstanceOf[js.Any], y1.asInstanceOf[js.Any], x2.asInstanceOf[js.Any], y2.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def pointPolygon(x1: Double, y1: Double, points: js.Array[Double], tolerance: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("pointPolygon")(x1.asInstanceOf[js.Any], y1.asInstanceOf[js.Any], points.asInstanceOf[js.Any], tolerance.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def polygonBox(points: js.Array[Double], x: Double, y: Double, w: Double, h: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("polygonBox")(points.asInstanceOf[js.Any], x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], w.asInstanceOf[js.Any], h.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def polygonCircle(points: js.Array[Double], xc: Double, yc: Double, rc: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("polygonCircle")(points.asInstanceOf[js.Any], xc.asInstanceOf[js.Any], yc.asInstanceOf[js.Any], rc.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def polygonEllipse(points: js.Array[Double], xe: Double, ye: Double, rex: Double, rey: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("polygonEllipse")(points.asInstanceOf[js.Any], xe.asInstanceOf[js.Any], ye.asInstanceOf[js.Any], rex.asInstanceOf[js.Any], rey.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def polygonPoint(points: js.Array[Double], x: Double, y: Double, tolerance: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("polygonPoint")(points.asInstanceOf[js.Any], x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], tolerance.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def polygonPolygon(points1: js.Array[Double], points2: js.Array[Double]): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("polygonPolygon")(points1.asInstanceOf[js.Any], points2.asInstanceOf[js.Any])).asInstanceOf[Boolean]
}
