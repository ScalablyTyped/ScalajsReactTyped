...
import typingsJapgolly.inputmask.AnonBack
import typingsJapgolly.inputmask.inputmaskStrings.number
import typingsJapgolly.inputmask.inputmaskStrings.text
...
object Options {
  ...
  def apply(
    ...
    isComplete: (/* buffer */ js.Array[String], /* opts */ Options) => CallbackTo[Boolean] = null,
    ...
    onBeforeMask: (/* initialValue */ String, /* opts */ Options) => CallbackTo[String] = null,
    onBeforePaste: (/* pastedValue */ String, /* opts */ Options) => CallbackTo[String] = null,
    onBeforeWrite: (/* event */ KeyboardEvent, /* buffer */ js.Array[String], /* caretPos */ Double, /* opts */ Options) => CallbackTo[CommandObject] = null,
    onKeyDown: (/* event */ KeyboardEvent, /* buffer */ js.Array[String], /* caretPos */ Double, /* opts */ Options) => Callback = null,
    onKeyValidation: (/* key */ Double, /* result */ Boolean) => Callback = null,
    onUnMask: (/* maskedValue */ String, /* unmaskedValue */ String) => CallbackTo[String] = null,
    ...
    postValidation: (/* buffer */ js.Array[String], /* pos */ Double, /* currentResult */ CommandObject, /* opts */ Options) => CallbackTo[Boolean | CommandObject] = null,
    preValidation: (/* buffer */ js.Array[String], /* pos */ Double, /* char */ String, /* isSelection */ Boolean, /* opts */ Options) => CallbackTo[Boolean | CommandObject] = null,
    prefix: String = null,
    ...
    if (isComplete != null) __obj.updateDynamic("isComplete")(js.Any.fromFunction2((t0: /* buffer */ js.Array[java.lang.String], t1: /* opts */ typingsJapgolly.inputmask.mod.Options) => isComplete(t0, t1).runNow()))
    ...
    if (onBeforeMask != null) __obj.updateDynamic("onBeforeMask")(js.Any.fromFunction2((t0: /* initialValue */ java.lang.String, t1: /* opts */ typingsJapgolly.inputmask.mod.Options) => onBeforeMask(t0, t1).runNow()))
    if (onBeforePaste != null) __obj.updateDynamic("onBeforePaste")(js.Any.fromFunction2((t0: /* pastedValue */ java.lang.String, t1: /* opts */ typingsJapgolly.inputmask.mod.Options) => onBeforePaste(t0, t1).runNow()))
    if (onBeforeWrite != null) __obj.updateDynamic("onBeforeWrite")(js.Any.fromFunction4((t0: /* event */ org.scalajs.dom.raw.KeyboardEvent, t1: /* buffer */ js.Array[java.lang.String], t2: /* caretPos */ scala.Double, t3: /* opts */ typingsJapgolly.inputmask.mod.Options) => onBeforeWrite(t0, t1, t2, t3).runNow()))
    if (onKeyDown != null) __obj.updateDynamic("onKeyDown")(js.Any.fromFunction4((t0: /* event */ org.scalajs.dom.raw.KeyboardEvent, t1: /* buffer */ js.Array[java.lang.String], t2: /* caretPos */ scala.Double, t3: /* opts */ typingsJapgolly.inputmask.mod.Options) => onKeyDown(t0, t1, t2, t3).runNow()))
    if (onKeyValidation != null) __obj.updateDynamic("onKeyValidation")(js.Any.fromFunction2((t0: /* key */ scala.Double, t1: /* result */ scala.Boolean) => onKeyValidation(t0, t1).runNow()))
    if (onUnMask != null) __obj.updateDynamic("onUnMask")(js.Any.fromFunction2((t0: /* maskedValue */ java.lang.String, t1: /* unmaskedValue */ java.lang.String) => onUnMask(t0, t1).runNow()))
    ...
    if (postValidation != null) __obj.updateDynamic("postValidation")(js.Any.fromFunction4((t0: /* buffer */ js.Array[java.lang.String], t1: /* pos */ scala.Double, t2: /* currentResult */ typingsJapgolly.inputmask.mod.CommandObject, t3: /* opts */ typingsJapgolly.inputmask.mod.Options) => postValidation(t0, t1, t2, t3).runNow()))
    if (preValidation != null) __obj.updateDynamic("preValidation")(js.Any.fromFunction5((t0: /* buffer */ js.Array[java.lang.String], t1: /* pos */ scala.Double, t2: /* char */ java.lang.String, t3: /* isSelection */ scala.Boolean, t4: /* opts */ typingsJapgolly.inputmask.mod.Options) => preValidation(t0, t1, t2, t3, t4).runNow()))
