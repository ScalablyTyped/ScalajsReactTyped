...
import typingsJapgolly.invityApi.invityApiStrings.NONE
import typingsJapgolly.invityApi.invityApiStrings.bankTransfer
...
/* Rewritten from type alias, can be one of: 
  - scala.Double
  - typingsJapgolly.invityApi.invityApiStrings.INCLUDED
  - typingsJapgolly.invityApi.invityApiStrings.UNKNOWN
*/
