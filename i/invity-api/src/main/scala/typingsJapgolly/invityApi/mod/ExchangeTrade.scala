...
import typingsJapgolly.invityApi.anon.Data
import typingsJapgolly.invityApi.invityApiStrings.bestRate
import typingsJapgolly.invityApi.invityApiStrings.favorite
