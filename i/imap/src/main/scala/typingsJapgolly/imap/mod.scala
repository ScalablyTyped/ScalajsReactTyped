package typingsJapgolly.imap

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.imap.anon.New
import typingsJapgolly.imap.anon.Other
...
object mod {
  ...
  object MessageFunctions {
    ...
    inline def apply(
      addFlags: (Any, Any, js.Function1[/* error */ js.Error, Unit]) => Callback,
      addKeywords: (Any, Any, js.Function1[/* error */ js.Error, Unit]) => Callback,
      copy: (Any, String, js.Function1[/* error */ js.Error, Unit]) => Callback,
      delFlags: (Any, Any, js.Function1[/* error */ js.Error, Unit]) => Callback,
      delKeywords: (Any, Any, js.Function1[/* error */ js.Error, Unit]) => Callback,
      fetch: (Any, FetchOptions) => ImapFetch,
      move: (Any, String, js.Function1[/* error */ js.Error, Unit]) => Callback,
      search: (js.Array[Any], js.Function2[/* error */ js.Error, /* uids */ js.Array[Double], Unit]) => Callback,
      serverSupports: String => Boolean,
      setFlags: (Any, Any, js.Function1[/* error */ js.Error, Unit]) => Callback,
      setKeywords: (Any, Any, js.Function1[/* error */ js.Error, Unit]) => Callback,
      sort: (js.Array[SortCriteria], js.Array[Any], js.Function2[/* error */ js.Error, /* uids */ js.Array[Double], Unit]) => Callback
    ): MessageFunctions = {
      val __obj = js.Dynamic.literal(addFlags = js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function1[/* error */ js.Error, Unit]) => (addFlags(t0, t1, t2)).runNow()), addKeywords = js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function1[/* error */ js.Error, Unit]) => (addKeywords(t0, t1, t2)).runNow()), copy = js.Any.fromFunction3((t0: Any, t1: String, t2: js.Function1[/* error */ js.Error, Unit]) => (copy(t0, t1, t2)).runNow()), delFlags = js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function1[/* error */ js.Error, Unit]) => (delFlags(t0, t1, t2)).runNow()), delKeywords = js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function1[/* error */ js.Error, Unit]) => (delKeywords(t0, t1, t2)).runNow()), fetch = js.Any.fromFunction2(fetch), move = js.Any.fromFunction3((t0: Any, t1: String, t2: js.Function1[/* error */ js.Error, Unit]) => (move(t0, t1, t2)).runNow()), search = js.Any.fromFunction2((t0: js.Array[Any], t1: js.Function2[/* error */ js.Error, /* uids */ js.Array[Double], Unit]) => (search(t0, t1)).runNow()), serverSupports = js.Any.fromFunction1(serverSupports), setFlags = js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function1[/* error */ js.Error, Unit]) => (setFlags(t0, t1, t2)).runNow()), setKeywords = js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function1[/* error */ js.Error, Unit]) => (setKeywords(t0, t1, t2)).runNow()), sort = js.Any.fromFunction3((t0: js.Array[SortCriteria], t1: js.Array[Any], t2: js.Function2[/* error */ js.Error, /* uids */ js.Array[Double], Unit]) => (sort(t0, t1, t2)).runNow()))
      __obj.asInstanceOf[MessageFunctions]
    }
    
    extension [Self <: MessageFunctions](x: Self) {
      
      inline def setAddFlags(value: (Any, Any, js.Function1[/* error */ js.Error, Unit]) => Callback): Self = StObject.set(x, "addFlags", js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function1[/* error */ js.Error, Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setAddKeywords(value: (Any, Any, js.Function1[/* error */ js.Error, Unit]) => Callback): Self = StObject.set(x, "addKeywords", js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function1[/* error */ js.Error, Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setCopy(value: (Any, String, js.Function1[/* error */ js.Error, Unit]) => Callback): Self = StObject.set(x, "copy", js.Any.fromFunction3((t0: Any, t1: String, t2: js.Function1[/* error */ js.Error, Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setDelFlags(value: (Any, Any, js.Function1[/* error */ js.Error, Unit]) => Callback): Self = StObject.set(x, "delFlags", js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function1[/* error */ js.Error, Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setDelKeywords(value: (Any, Any, js.Function1[/* error */ js.Error, Unit]) => Callback): Self = StObject.set(x, "delKeywords", js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function1[/* error */ js.Error, Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setFetch(value: (Any, FetchOptions) => ImapFetch): Self = StObject.set(x, "fetch", js.Any.fromFunction2(value))
      
      inline def setMove(value: (Any, String, js.Function1[/* error */ js.Error, Unit]) => Callback): Self = StObject.set(x, "move", js.Any.fromFunction3((t0: Any, t1: String, t2: js.Function1[/* error */ js.Error, Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setSearch(
        value: (js.Array[Any], js.Function2[/* error */ js.Error, /* uids */ js.Array[Double], Unit]) => Callback
      ): Self = StObject.set(x, "search", js.Any.fromFunction2((t0: js.Array[Any], t1: js.Function2[/* error */ js.Error, /* uids */ js.Array[Double], Unit]) => (value(t0, t1)).runNow()))
      
      inline def setServerSupports(value: String => Boolean): Self = StObject.set(x, "serverSupports", js.Any.fromFunction1(value))
      
      inline def setSetFlags(value: (Any, Any, js.Function1[/* error */ js.Error, Unit]) => Callback): Self = StObject.set(x, "setFlags", js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function1[/* error */ js.Error, Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setSetKeywords(value: (Any, Any, js.Function1[/* error */ js.Error, Unit]) => Callback): Self = StObject.set(x, "setKeywords", js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function1[/* error */ js.Error, Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setSort(
        value: (js.Array[SortCriteria], js.Array[Any], js.Function2[/* error */ js.Error, /* uids */ js.Array[Double], Unit]) => Callback
      ): Self = StObject.set(x, "sort", js.Any.fromFunction3((t0: js.Array[SortCriteria], t1: js.Array[Any], t2: js.Function2[/* error */ js.Error, /* uids */ js.Array[Double], Unit]) => (value(t0, t1, t2)).runNow()))
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.imap.imapStrings.ARRIVAL
    - typingsJapgolly.imap.imapStrings.`-ARRIVAL`
    - typingsJapgolly.imap.imapStrings.CC
    - typingsJapgolly.imap.imapStrings.`-CC`
    - typingsJapgolly.imap.imapStrings.DATE
    - typingsJapgolly.imap.imapStrings.`-DATE`
    - typingsJapgolly.imap.imapStrings.FROM
    - typingsJapgolly.imap.imapStrings.`-FROM`
    - typingsJapgolly.imap.imapStrings.SIZE
    - typingsJapgolly.imap.imapStrings.`-SIZE`
    - typingsJapgolly.imap.imapStrings.SUBJECT
    - typingsJapgolly.imap.imapStrings.`-SUBJECT`
    - typingsJapgolly.imap.imapStrings.TO
    - typingsJapgolly.imap.imapStrings.`-TO`
  */
  trait SortCriteria extends StObject
  object SortCriteria {
    
    inline def `-ARRIVAL`: typingsJapgolly.imap.imapStrings.`-ARRIVAL` = "-ARRIVAL".asInstanceOf[typingsJapgolly.imap.imapStrings.`-ARRIVAL`]
    
    inline def `-CC`: typingsJapgolly.imap.imapStrings.`-CC` = "-CC".asInstanceOf[typingsJapgolly.imap.imapStrings.`-CC`]
    
    inline def `-DATE`: typingsJapgolly.imap.imapStrings.`-DATE` = "-DATE".asInstanceOf[typingsJapgolly.imap.imapStrings.`-DATE`]
    
    inline def `-FROM`: typingsJapgolly.imap.imapStrings.`-FROM` = "-FROM".asInstanceOf[typingsJapgolly.imap.imapStrings.`-FROM`]
    
    inline def `-SIZE`: typingsJapgolly.imap.imapStrings.`-SIZE` = "-SIZE".asInstanceOf[typingsJapgolly.imap.imapStrings.`-SIZE`]
    
    inline def `-SUBJECT`: typingsJapgolly.imap.imapStrings.`-SUBJECT` = "-SUBJECT".asInstanceOf[typingsJapgolly.imap.imapStrings.`-SUBJECT`]
    
    inline def `-TO`: typingsJapgolly.imap.imapStrings.`-TO` = "-TO".asInstanceOf[typingsJapgolly.imap.imapStrings.`-TO`]
