...
object IonIconPropsIonicReactPro {
  ...
  extension [Self <: IonIconPropsIonicReactPro](x: Self) {
    ...
    inline def setRefFunction1(value: HTMLIonIconElement | Null => japgolly.scalajs.react.Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: HTMLIonIconElement | Null) => value(t0).runNow()))
