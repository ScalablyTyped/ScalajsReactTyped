...
/* Inlined std.Pick<@ionic/react.@ionic/react/dist/types/components/utils.IonicReactExternalProps</ * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify LocalJSX.IonRouterOutlet * / any & {  basePath :string | undefined,   ref :react.react.RefObject<any> | (instance : any): void | null | undefined,   ionPage :boolean | undefined} & @ionic/react.@ionic/react/dist/types/components/IonicReactProps.IonicReactProps, @ionic/core.@ionic/core/dist/types/components.<global>.HTMLIonRouterOutletElement>, 'hidden' | 'dir' | 'slot' | 'style' | 'title' | 'color' | 'translate' | 'animation' | 'children' | 'animated' | 'mode' | 'class' | 'className' | 'defaultChecked' | 'defaultValue' | 'suppressContentEditableWarning' | 'suppressHydrationWarning' | 'accessKey' | 'contentEditable' | 'contextMenu' | 'draggable' | 'id' | 'lang' | 'placeholder' | 'spellCheck' | 'tabIndex' | 'radioGroup' | 'role' | 'about' | 'datatype' | 'inlist' | 'prefix' | 'property' | 'resource' | 'typeof' | 'vocab' | 'autoCapitalize' | 'autoCorrect' | 'autoSave' | 'itemProp' | 'itemScope' | 'itemType' | 'itemID' | 'itemRef' | 'results' | 'security' | 'unselectable' | 'inputMode' | 'is' | 'aria-activedescendant' | 'aria-atomic' | 'aria-autocomplete' | 'aria-busy' | 'aria-checked' | 'aria-colcount' | 'aria-colindex' | 'aria-colspan' | 'aria-controls' | 'aria-current' | 'aria-describedby' | 'aria-details' | 'aria-disabled' | 'aria-dropeffect' | 'aria-errormessage' | 'aria-expanded' | 'aria-flowto' | 'aria-grabbed' | 'aria-haspopup' | 'aria-hidden' | 'aria-invalid' | 'aria-keyshortcuts' | 'aria-label' | 'aria-labelledby' | 'aria-level' | 'aria-live' | 'aria-modal' | 'aria-multiline' | 'aria-multiselectable' | 'aria-orientation' | 'aria-owns' | 'aria-placeholder' | 'aria-posinset' | 'aria-pressed' | 'aria-readonly' | 'aria-relevant' | 'aria-required' | 'aria-roledescription' | 'aria-rowcount' | 'aria-rowindex' | 'aria-rowspan' | 'aria-selected' | 'aria-setsize' | 'aria-sort' | 'aria-valuemax' | 'aria-valuemin' | 'aria-valuenow' | 'aria-valuetext' | 'dangerouslySetInnerHTML' | 'onCopy' | 'onCopyCapture' | 'onCut' | 'onCutCapture' | 'onPaste' | 'onPasteCapture' | 'onCompositionEnd' | 'onCompositionEndCapture' | 'onCompositionStart' | 'onCompositionStartCapture' | 'onCompositionUpdate' | 'onCompositionUpdateCapture' | 'onFocus' | 'onFocusCapture' | 'onBlur' | 'onBlurCapture' | 'onChange' | 'onChangeCapture' | 'onBeforeInput' | 'onBeforeInputCapture' | 'onInput' | 'onInputCapture' | 'onReset' | 'onResetCapture' | 'onSubmit' | 'onSubmitCapture' | 'onInvalid' | 'onInvalidCapture' | 'onLoad' | 'onLoadCapture' | 'onError' | 'onErrorCapture' | 'onKeyDown' | 'onKeyDownCapture' | 'onKeyPress' | 'onKeyPressCapture' | 'onKeyUp' | 'onKeyUpCapture' | 'onAbort' | 'onAbortCapture' | 'onCanPlay' | 'onCanPlayCapture' | 'onCanPlayThrough' | 'onCanPlayThroughCapture' | 'onDurationChange' | 'onDurationChangeCapture' | 'onEmptied' | 'onEmptiedCapture' | 'onEncrypted' | 'onEncryptedCapture' | 'onEnded' | 'onEndedCapture' | 'onLoadedData' | 'onLoadedDataCapture' | 'onLoadedMetadata' | 'onLoadedMetadataCapture' | 'onLoadStart' | 'onLoadStartCapture' | 'onPause' | 'onPauseCapture' | 'onPlay' | 'onPlayCapture' | 'onPlaying' | 'onPlayingCapture' | 'onProgress' | 'onProgressCapture' | 'onRateChange' | 'onRateChangeCapture' | 'onSeeked' | 'onSeekedCapture' | 'onSeeking' | 'onSeekingCapture' | 'onStalled' | 'onStalledCapture' | 'onSuspend' | 'onSuspendCapture' | 'onTimeUpdate' | 'onTimeUpdateCapture' | 'onVolumeChange' | 'onVolumeChangeCapture' | 'onWaiting' | 'onWaitingCapture' | 'onAuxClick' | 'onAuxClickCapture' | 'onClick' | 'onClickCapture' | 'onContextMenu' | 'onContextMenuCapture' | 'onDoubleClick' | 'onDoubleClickCapture' | 'onDrag' | 'onDragCapture' | 'onDragEnd' | 'onDragEndCapture' | 'onDragEnter' | 'onDragEnterCapture' | 'onDragExit' | 'onDragExitCapture' | 'onDragLeave' | 'onDragLeaveCapture' | 'onDragOver' | 'onDragOverCapture' | 'onDragStart' | 'onDragStartCapture' | 'onDrop' | 'onDropCapture' | 'onMouseDown' | 'onMouseDownCapture' | 'onMouseEnter' | 'onMouseLeave' | 'onMouseMove' | 'onMouseMoveCapture' | 'onMouseOut' | 'onMouseOutCapture' | 'onMouseOver' | 'onMouseOverCapture' | 'onMouseUp' | 'onMouseUpCapture' | 'onSelect' | 'onSelectCapture' | 'onTouchCancel' | 'onTouchCancelCapture' | 'onTouchEnd' | 'onTouchEndCapture' | 'onTouchMove' | 'onTouchMoveCapture' | 'onTouchStart' | 'onTouchStartCapture' | 'onPointerDown' | 'onPointerDownCapture' | 'onPointerMove' | 'onPointerMoveCapture' | 'onPointerUp' | 'onPointerUpCapture' | 'onPointerCancel' | 'onPointerCancelCapture' | 'onPointerEnter' | 'onPointerEnterCapture' | 'onPointerLeave' | 'onPointerLeaveCapture' | 'onPointerOver' | 'onPointerOverCapture' | 'onPointerOut' | 'onPointerOutCapture' | 'onGotPointerCapture' | 'onGotPointerCaptureCapture' | 'onLostPointerCapture' | 'onLostPointerCaptureCapture' | 'onScroll' | 'onScrollCapture' | 'onWheel' | 'onWheelCapture' | 'onAnimationStart' | 'onAnimationStartCapture' | 'onAnimationEnd' | 'onAnimationEndCapture' | 'onAnimationIteration' | 'onAnimationIterationCapture' | 'onTransitionEnd' | 'onTransitionEndCapture' | 'basePath' | 'ionPage'> & react.react.RefAttributes<@ionic/core.@ionic/core/dist/types/components.<global>.HTMLIonRouterOutletElement> */
trait PickIonicReactExternalPro extends StObject {
  
  var about: js.UndefOr[Any] = js.undefined
  
  var accessKey: js.UndefOr[Any] = js.undefined
  
  var animated: js.UndefOr[Any] = js.undefined
  
  var animation: js.UndefOr[Any] = js.undefined
  
  var `aria-activedescendant`: js.UndefOr[Any] = js.undefined
  
  var `aria-atomic`: js.UndefOr[Any] = js.undefined
  
  var `aria-autocomplete`: js.UndefOr[Any] = js.undefined
  
  var `aria-busy`: js.UndefOr[Any] = js.undefined
  
  var `aria-checked`: js.UndefOr[Any] = js.undefined
  
  var `aria-colcount`: js.UndefOr[Any] = js.undefined
  
  var `aria-colindex`: js.UndefOr[Any] = js.undefined
  
  var `aria-colspan`: js.UndefOr[Any] = js.undefined
  
  var `aria-controls`: js.UndefOr[Any] = js.undefined
  
  var `aria-current`: js.UndefOr[Any] = js.undefined
  
  var `aria-describedby`: js.UndefOr[Any] = js.undefined
  
  var `aria-details`: js.UndefOr[Any] = js.undefined
  
  var `aria-disabled`: js.UndefOr[Any] = js.undefined
  
  var `aria-dropeffect`: js.UndefOr[Any] = js.undefined
  
  var `aria-errormessage`: js.UndefOr[Any] = js.undefined
  
  var `aria-expanded`: js.UndefOr[Any] = js.undefined
  
  var `aria-flowto`: js.UndefOr[Any] = js.undefined
  
  var `aria-grabbed`: js.UndefOr[Any] = js.undefined
  
  var `aria-haspopup`: js.UndefOr[Any] = js.undefined
  
  var `aria-hidden`: js.UndefOr[Any] = js.undefined
  
  var `aria-invalid`: js.UndefOr[Any] = js.undefined
  
  var `aria-keyshortcuts`: js.UndefOr[Any] = js.undefined
  
  var `aria-label`: js.UndefOr[Any] = js.undefined
  
  var `aria-labelledby`: js.UndefOr[Any] = js.undefined
  
  var `aria-level`: js.UndefOr[Any] = js.undefined
  
  var `aria-live`: js.UndefOr[Any] = js.undefined
  
  var `aria-modal`: js.UndefOr[Any] = js.undefined
  
  var `aria-multiline`: js.UndefOr[Any] = js.undefined
  
  var `aria-multiselectable`: js.UndefOr[Any] = js.undefined
  
  var `aria-orientation`: js.UndefOr[Any] = js.undefined
  
  var `aria-owns`: js.UndefOr[Any] = js.undefined
  
  var `aria-placeholder`: js.UndefOr[Any] = js.undefined
  
  var `aria-posinset`: js.UndefOr[Any] = js.undefined
  
  var `aria-pressed`: js.UndefOr[Any] = js.undefined
  
  var `aria-readonly`: js.UndefOr[Any] = js.undefined
  
  var `aria-relevant`: js.UndefOr[Any] = js.undefined
  
  var `aria-required`: js.UndefOr[Any] = js.undefined
  
  var `aria-roledescription`: js.UndefOr[Any] = js.undefined
  
  var `aria-rowcount`: js.UndefOr[Any] = js.undefined
  
  var `aria-rowindex`: js.UndefOr[Any] = js.undefined
  
  var `aria-rowspan`: js.UndefOr[Any] = js.undefined
  
  var `aria-selected`: js.UndefOr[Any] = js.undefined
  
  var `aria-setsize`: js.UndefOr[Any] = js.undefined
  
  var `aria-sort`: js.UndefOr[Any] = js.undefined
  
  var `aria-valuemax`: js.UndefOr[Any] = js.undefined
  
  var `aria-valuemin`: js.UndefOr[Any] = js.undefined
  
  var `aria-valuenow`: js.UndefOr[Any] = js.undefined
  
  var `aria-valuetext`: js.UndefOr[Any] = js.undefined
  
  var autoCapitalize: js.UndefOr[Any] = js.undefined
  
  var autoCorrect: js.UndefOr[Any] = js.undefined
  
  var autoSave: js.UndefOr[Any] = js.undefined
  
  var basePath: js.UndefOr[Any] = js.undefined
  ...
  var contentEditable: js.UndefOr[Any] = js.undefined
  
  var contextMenu: js.UndefOr[Any] = js.undefined
  
  var dangerouslySetInnerHTML: js.UndefOr[Any] = js.undefined
  
  var datatype: js.UndefOr[Any] = js.undefined
  
  var defaultChecked: js.UndefOr[Any] = js.undefined
  ...
  var inputMode: js.UndefOr[Any] = js.undefined
  
  var ionPage: js.UndefOr[Any] = js.undefined
  
  var is: js.UndefOr[Any] = js.undefined
  
  var itemID: js.UndefOr[Any] = js.undefined
  
  var itemProp: js.UndefOr[Any] = js.undefined
  
  var itemRef: js.UndefOr[Any] = js.undefined
  
  var itemScope: js.UndefOr[Any] = js.undefined
  
  var itemType: js.UndefOr[Any] = js.undefined
  ...
  var onAbort: js.UndefOr[Any] = js.undefined
  
  var onAbortCapture: js.UndefOr[Any] = js.undefined
  
  var onAnimationEnd: js.UndefOr[Any] = js.undefined
  
  var onAnimationEndCapture: js.UndefOr[Any] = js.undefined
  
  var onAnimationIteration: js.UndefOr[Any] = js.undefined
  
  var onAnimationIterationCapture: js.UndefOr[Any] = js.undefined
  
  var onAnimationStart: js.UndefOr[Any] = js.undefined
  
  var onAnimationStartCapture: js.UndefOr[Any] = js.undefined
  
  var onAuxClick: js.UndefOr[Any] = js.undefined
  
  var onAuxClickCapture: js.UndefOr[Any] = js.undefined
  
  var onBeforeInput: js.UndefOr[Any] = js.undefined
  ...
  var onCanPlay: js.UndefOr[Any] = js.undefined
  
  var onCanPlayCapture: js.UndefOr[Any] = js.undefined
  
  var onCanPlayThrough: js.UndefOr[Any] = js.undefined
  ...
  var onCompositionEnd: js.UndefOr[Any] = js.undefined
  
  var onCompositionEndCapture: js.UndefOr[Any] = js.undefined
  
  var onCompositionStart: js.UndefOr[Any] = js.undefined
  
  var onCompositionStartCapture: js.UndefOr[Any] = js.undefined
  
  var onCompositionUpdate: js.UndefOr[Any] = js.undefined
  ...
  var onInput: js.UndefOr[Any] = js.undefined
  
  var onInputCapture: js.UndefOr[Any] = js.undefined
  
  var onInvalid: js.UndefOr[Any] = js.undefined
  ...
  var onKeyUp: js.UndefOr[Any] = js.undefined
  ...
  var onLoadStart: js.UndefOr[Any] = js.undefined
  
  var onLoadStartCapture: js.UndefOr[Any] = js.undefined
  
  var onLoadedData: js.UndefOr[Any] = js.undefined
  
  var onLoadedDataCapture: js.UndefOr[Any] = js.undefined
  
  var onLoadedMetadata: js.UndefOr[Any] = js.undefined
  ...
  var onMouseDown: js.UndefOr[Any] = js.undefined
  ...
  var onMouseMove: js.UndefOr[Any] = js.undefined
  
  var onMouseMoveCapture: js.UndefOr[Any] = js.undefined
  
  var onMouseOut: js.UndefOr[Any] = js.undefined
  
  var onMouseOutCapture: js.UndefOr[Any] = js.undefined
  
  var onMouseOver: js.UndefOr[Any] = js.undefined
  
  var onMouseOverCapture: js.UndefOr[Any] = js.undefined
  
  var onMouseUp: js.UndefOr[Any] = js.undefined
  
  var onMouseUpCapture: js.UndefOr[Any] = js.undefined
  
  var onPaste: js.UndefOr[Any] = js.undefined
  ...
  var role: js.UndefOr[Any] = js.undefined
  
  var security: js.UndefOr[Any] = js.undefined
  
  var slot: js.UndefOr[Any] = js.undefined
  
  var spellCheck: js.UndefOr[Any] = js.undefined
  
  var style: js.UndefOr[Any] = js.undefined
  
  var suppressContentEditableWarning: js.UndefOr[Any] = js.undefined
  
  var suppressHydrationWarning: js.UndefOr[Any] = js.undefined
  ...
  var typeof: js.UndefOr[Any] = js.undefined
  
  var unselectable: js.UndefOr[Any] = js.undefined
  
  var vocab: js.UndefOr[Any] = js.undefined
}
object PickIonicReactExternalPro {
  ...
  extension [Self <: PickIonicReactExternalPro](x: Self) {
    ...
    inline def setAccessKey(value: Any): Self = StObject.set(x, "accessKey", value.asInstanceOf[js.Any])
    ...
    inline def `setAria-atomic`(value: Any): Self = StObject.set(x, "aria-atomic", value.asInstanceOf[js.Any])
    
    inline def `setAria-atomicUndefined`: Self = StObject.set(x, "aria-atomic", js.undefined)
    
    inline def `setAria-autocomplete`(value: Any): Self = StObject.set(x, "aria-autocomplete", value.asInstanceOf[js.Any])
    
    inline def `setAria-autocompleteUndefined`: Self = StObject.set(x, "aria-autocomplete", js.undefined)
    
    inline def `setAria-busy`(value: Any): Self = StObject.set(x, "aria-busy", value.asInstanceOf[js.Any])
    
    inline def `setAria-busyUndefined`: Self = StObject.set(x, "aria-busy", js.undefined)
    
    inline def `setAria-checked`(value: Any): Self = StObject.set(x, "aria-checked", value.asInstanceOf[js.Any])
    
    inline def `setAria-checkedUndefined`: Self = StObject.set(x, "aria-checked", js.undefined)
    
    inline def `setAria-colcount`(value: Any): Self = StObject.set(x, "aria-colcount", value.asInstanceOf[js.Any])
    
    inline def `setAria-colcountUndefined`: Self = StObject.set(x, "aria-colcount", js.undefined)
    
    inline def `setAria-colindex`(value: Any): Self = StObject.set(x, "aria-colindex", value.asInstanceOf[js.Any])
    
    inline def `setAria-colindexUndefined`: Self = StObject.set(x, "aria-colindex", js.undefined)
    
    inline def `setAria-colspan`(value: Any): Self = StObject.set(x, "aria-colspan", value.asInstanceOf[js.Any])
    
    inline def `setAria-colspanUndefined`: Self = StObject.set(x, "aria-colspan", js.undefined)
    
    inline def `setAria-controls`(value: Any): Self = StObject.set(x, "aria-controls", value.asInstanceOf[js.Any])
    
    inline def `setAria-controlsUndefined`: Self = StObject.set(x, "aria-controls", js.undefined)
    
    inline def `setAria-current`(value: Any): Self = StObject.set(x, "aria-current", value.asInstanceOf[js.Any])
    ...
    inline def `setAria-details`(value: Any): Self = StObject.set(x, "aria-details", value.asInstanceOf[js.Any])
    
    inline def `setAria-detailsUndefined`: Self = StObject.set(x, "aria-details", js.undefined)
    
    inline def `setAria-disabled`(value: Any): Self = StObject.set(x, "aria-disabled", value.asInstanceOf[js.Any])
    
    inline def `setAria-disabledUndefined`: Self = StObject.set(x, "aria-disabled", js.undefined)
    
    inline def `setAria-dropeffect`(value: Any): Self = StObject.set(x, "aria-dropeffect", value.asInstanceOf[js.Any])
    
    inline def `setAria-dropeffectUndefined`: Self = StObject.set(x, "aria-dropeffect", js.undefined)
    
    inline def `setAria-errormessage`(value: Any): Self = StObject.set(x, "aria-errormessage", value.asInstanceOf[js.Any])
    
    inline def `setAria-errormessageUndefined`: Self = StObject.set(x, "aria-errormessage", js.undefined)
    
    inline def `setAria-expanded`(value: Any): Self = StObject.set(x, "aria-expanded", value.asInstanceOf[js.Any])
    
    inline def `setAria-expandedUndefined`: Self = StObject.set(x, "aria-expanded", js.undefined)
    
    inline def `setAria-flowto`(value: Any): Self = StObject.set(x, "aria-flowto", value.asInstanceOf[js.Any])
    
    inline def `setAria-flowtoUndefined`: Self = StObject.set(x, "aria-flowto", js.undefined)
    
    inline def `setAria-grabbed`(value: Any): Self = StObject.set(x, "aria-grabbed", value.asInstanceOf[js.Any])
    
    inline def `setAria-grabbedUndefined`: Self = StObject.set(x, "aria-grabbed", js.undefined)
    
    inline def `setAria-haspopup`(value: Any): Self = StObject.set(x, "aria-haspopup", value.asInstanceOf[js.Any])
    
    inline def `setAria-haspopupUndefined`: Self = StObject.set(x, "aria-haspopup", js.undefined)
    
    inline def `setAria-hidden`(value: Any): Self = StObject.set(x, "aria-hidden", value.asInstanceOf[js.Any])
    
    inline def `setAria-hiddenUndefined`: Self = StObject.set(x, "aria-hidden", js.undefined)
    
    inline def `setAria-invalid`(value: Any): Self = StObject.set(x, "aria-invalid", value.asInstanceOf[js.Any])
    
    inline def `setAria-invalidUndefined`: Self = StObject.set(x, "aria-invalid", js.undefined)
    
    inline def `setAria-keyshortcuts`(value: Any): Self = StObject.set(x, "aria-keyshortcuts", value.asInstanceOf[js.Any])
    
    inline def `setAria-keyshortcutsUndefined`: Self = StObject.set(x, "aria-keyshortcuts", js.undefined)
    
    inline def `setAria-label`(value: Any): Self = StObject.set(x, "aria-label", value.asInstanceOf[js.Any])
    ...
    inline def `setAria-level`(value: Any): Self = StObject.set(x, "aria-level", value.asInstanceOf[js.Any])
    
    inline def `setAria-levelUndefined`: Self = StObject.set(x, "aria-level", js.undefined)
    
    inline def `setAria-live`(value: Any): Self = StObject.set(x, "aria-live", value.asInstanceOf[js.Any])
    
    inline def `setAria-liveUndefined`: Self = StObject.set(x, "aria-live", js.undefined)
    
    inline def `setAria-modal`(value: Any): Self = StObject.set(x, "aria-modal", value.asInstanceOf[js.Any])
    
    inline def `setAria-modalUndefined`: Self = StObject.set(x, "aria-modal", js.undefined)
    
    inline def `setAria-multiline`(value: Any): Self = StObject.set(x, "aria-multiline", value.asInstanceOf[js.Any])
    
    inline def `setAria-multilineUndefined`: Self = StObject.set(x, "aria-multiline", js.undefined)
    
    inline def `setAria-multiselectable`(value: Any): Self = StObject.set(x, "aria-multiselectable", value.asInstanceOf[js.Any])
    
    inline def `setAria-multiselectableUndefined`: Self = StObject.set(x, "aria-multiselectable", js.undefined)
    
    inline def `setAria-orientation`(value: Any): Self = StObject.set(x, "aria-orientation", value.asInstanceOf[js.Any])
    
    inline def `setAria-orientationUndefined`: Self = StObject.set(x, "aria-orientation", js.undefined)
    
    inline def `setAria-owns`(value: Any): Self = StObject.set(x, "aria-owns", value.asInstanceOf[js.Any])
    
    inline def `setAria-ownsUndefined`: Self = StObject.set(x, "aria-owns", js.undefined)
    
    inline def `setAria-placeholder`(value: Any): Self = StObject.set(x, "aria-placeholder", value.asInstanceOf[js.Any])
    
    inline def `setAria-placeholderUndefined`: Self = StObject.set(x, "aria-placeholder", js.undefined)
    
    inline def `setAria-posinset`(value: Any): Self = StObject.set(x, "aria-posinset", value.asInstanceOf[js.Any])
    
    inline def `setAria-posinsetUndefined`: Self = StObject.set(x, "aria-posinset", js.undefined)
    
    inline def `setAria-pressed`(value: Any): Self = StObject.set(x, "aria-pressed", value.asInstanceOf[js.Any])
    
    inline def `setAria-pressedUndefined`: Self = StObject.set(x, "aria-pressed", js.undefined)
    
    inline def `setAria-readonly`(value: Any): Self = StObject.set(x, "aria-readonly", value.asInstanceOf[js.Any])
    
    inline def `setAria-readonlyUndefined`: Self = StObject.set(x, "aria-readonly", js.undefined)
    
    inline def `setAria-relevant`(value: Any): Self = StObject.set(x, "aria-relevant", value.asInstanceOf[js.Any])
    
    inline def `setAria-relevantUndefined`: Self = StObject.set(x, "aria-relevant", js.undefined)
    
    inline def `setAria-required`(value: Any): Self = StObject.set(x, "aria-required", value.asInstanceOf[js.Any])
    
    inline def `setAria-requiredUndefined`: Self = StObject.set(x, "aria-required", js.undefined)
    
    inline def `setAria-roledescription`(value: Any): Self = StObject.set(x, "aria-roledescription", value.asInstanceOf[js.Any])
    
    inline def `setAria-roledescriptionUndefined`: Self = StObject.set(x, "aria-roledescription", js.undefined)
    
    inline def `setAria-rowcount`(value: Any): Self = StObject.set(x, "aria-rowcount", value.asInstanceOf[js.Any])
    
    inline def `setAria-rowcountUndefined`: Self = StObject.set(x, "aria-rowcount", js.undefined)
    
    inline def `setAria-rowindex`(value: Any): Self = StObject.set(x, "aria-rowindex", value.asInstanceOf[js.Any])
    
    inline def `setAria-rowindexUndefined`: Self = StObject.set(x, "aria-rowindex", js.undefined)
    
    inline def `setAria-rowspan`(value: Any): Self = StObject.set(x, "aria-rowspan", value.asInstanceOf[js.Any])
    ...
    inline def `setAria-setsize`(value: Any): Self = StObject.set(x, "aria-setsize", value.asInstanceOf[js.Any])
    
    inline def `setAria-setsizeUndefined`: Self = StObject.set(x, "aria-setsize", js.undefined)
    
    inline def `setAria-sort`(value: Any): Self = StObject.set(x, "aria-sort", value.asInstanceOf[js.Any])
    
    inline def `setAria-sortUndefined`: Self = StObject.set(x, "aria-sort", js.undefined)
    
    inline def `setAria-valuemax`(value: Any): Self = StObject.set(x, "aria-valuemax", value.asInstanceOf[js.Any])
    
    inline def `setAria-valuemaxUndefined`: Self = StObject.set(x, "aria-valuemax", js.undefined)
    
    inline def `setAria-valuemin`(value: Any): Self = StObject.set(x, "aria-valuemin", value.asInstanceOf[js.Any])
    
    inline def `setAria-valueminUndefined`: Self = StObject.set(x, "aria-valuemin", js.undefined)
    
    inline def `setAria-valuenow`(value: Any): Self = StObject.set(x, "aria-valuenow", value.asInstanceOf[js.Any])
    
    inline def `setAria-valuenowUndefined`: Self = StObject.set(x, "aria-valuenow", js.undefined)
    
    inline def `setAria-valuetext`(value: Any): Self = StObject.set(x, "aria-valuetext", value.asInstanceOf[js.Any])
    ...
    inline def setAutoCorrect(value: Any): Self = StObject.set(x, "autoCorrect", value.asInstanceOf[js.Any])
    ...
    inline def setBasePath(value: Any): Self = StObject.set(x, "basePath", value.asInstanceOf[js.Any])
    ...
    inline def setContentEditable(value: Any): Self = StObject.set(x, "contentEditable", value.asInstanceOf[js.Any])
    ...
    inline def setDangerouslySetInnerHTML(value: Any): Self = StObject.set(x, "dangerouslySetInnerHTML", value.asInstanceOf[js.Any])
    ...
    inline def setDefaultChecked(value: Any): Self = StObject.set(x, "defaultChecked", value.asInstanceOf[js.Any])
    ...
    inline def setInputMode(value: Any): Self = StObject.set(x, "inputMode", value.asInstanceOf[js.Any])
    
    inline def setInputModeUndefined: Self = StObject.set(x, "inputMode", js.undefined)
    
    inline def setIonPage(value: Any): Self = StObject.set(x, "ionPage", value.asInstanceOf[js.Any])
    
    inline def setIonPageUndefined: Self = StObject.set(x, "ionPage", js.undefined)
    
    inline def setIs(value: Any): Self = StObject.set(x, "is", value.asInstanceOf[js.Any])
    
    inline def setIsUndefined: Self = StObject.set(x, "is", js.undefined)
    
    inline def setItemID(value: Any): Self = StObject.set(x, "itemID", value.asInstanceOf[js.Any])
    
    inline def setItemIDUndefined: Self = StObject.set(x, "itemID", js.undefined)
    
    inline def setItemProp(value: Any): Self = StObject.set(x, "itemProp", value.asInstanceOf[js.Any])
    
    inline def setItemPropUndefined: Self = StObject.set(x, "itemProp", js.undefined)
    
    inline def setItemRef(value: Any): Self = StObject.set(x, "itemRef", value.asInstanceOf[js.Any])
    
    inline def setItemRefUndefined: Self = StObject.set(x, "itemRef", js.undefined)
    
    inline def setItemScope(value: Any): Self = StObject.set(x, "itemScope", value.asInstanceOf[js.Any])
    
    inline def setItemScopeUndefined: Self = StObject.set(x, "itemScope", js.undefined)
    
    inline def setItemType(value: Any): Self = StObject.set(x, "itemType", value.asInstanceOf[js.Any])
    ...
    inline def setOnAnimationEnd(value: Any): Self = StObject.set(x, "onAnimationEnd", value.asInstanceOf[js.Any])
    ...
    inline def setOnAnimationIteration(value: Any): Self = StObject.set(x, "onAnimationIteration", value.asInstanceOf[js.Any])
    ...
    inline def setOnAnimationStart(value: Any): Self = StObject.set(x, "onAnimationStart", value.asInstanceOf[js.Any])
    ...
    inline def setOnAuxClick(value: Any): Self = StObject.set(x, "onAuxClick", value.asInstanceOf[js.Any])
    ...
    inline def setOnBeforeInput(value: Any): Self = StObject.set(x, "onBeforeInput", value.asInstanceOf[js.Any])
    ...
    inline def setOnCompositionEnd(value: Any): Self = StObject.set(x, "onCompositionEnd", value.asInstanceOf[js.Any])
    ...
    inline def setOnCompositionStart(value: Any): Self = StObject.set(x, "onCompositionStart", value.asInstanceOf[js.Any])
    ...
    inline def setOnCompositionUpdate(value: Any): Self = StObject.set(x, "onCompositionUpdate", value.asInstanceOf[js.Any])
    ...
    inline def setOnCopy(value: Any): Self = StObject.set(x, "onCopy", value.asInstanceOf[js.Any])
    ...
    inline def setOnCut(value: Any): Self = StObject.set(x, "onCut", value.asInstanceOf[js.Any])
    ...
    inline def setOnDoubleClick(value: Any): Self = StObject.set(x, "onDoubleClick", value.asInstanceOf[js.Any])
    ...
    inline def setOnDragExit(value: Any): Self = StObject.set(x, "onDragExit", value.asInstanceOf[js.Any])
    ...
    inline def setOnDragStart(value: Any): Self = StObject.set(x, "onDragStart", value.asInstanceOf[js.Any])
    ...
    inline def setOnEncrypted(value: Any): Self = StObject.set(x, "onEncrypted", value.asInstanceOf[js.Any])
    ...
    inline def setOnInvalid(value: Any): Self = StObject.set(x, "onInvalid", value.asInstanceOf[js.Any])
    ...
    inline def setOnMouseMove(value: Any): Self = StObject.set(x, "onMouseMove", value.asInstanceOf[js.Any])
    ...
    inline def setOnMouseOut(value: Any): Self = StObject.set(x, "onMouseOut", value.asInstanceOf[js.Any])
    ...
    inline def setOnMouseOver(value: Any): Self = StObject.set(x, "onMouseOver", value.asInstanceOf[js.Any])
    ...
    inline def setOnMouseUp(value: Any): Self = StObject.set(x, "onMouseUp", value.asInstanceOf[js.Any])
    ...
    inline def setOnPaste(value: Any): Self = StObject.set(x, "onPaste", value.asInstanceOf[js.Any])
    ...
    inline def setOnPointerCancel(value: Any): Self = StObject.set(x, "onPointerCancel", value.asInstanceOf[js.Any])
    ...
    inline def setOnPointerDown(value: Any): Self = StObject.set(x, "onPointerDown", value.asInstanceOf[js.Any])
    ...
    inline def setOnPointerEnter(value: Any): Self = StObject.set(x, "onPointerEnter", value.asInstanceOf[js.Any])
    ...
    inline def setOnPointerLeave(value: Any): Self = StObject.set(x, "onPointerLeave", value.asInstanceOf[js.Any])
    ...
    inline def setOnPointerMove(value: Any): Self = StObject.set(x, "onPointerMove", value.asInstanceOf[js.Any])
    ...
    inline def setOnPointerOut(value: Any): Self = StObject.set(x, "onPointerOut", value.asInstanceOf[js.Any])
    ...
    inline def setOnPointerOver(value: Any): Self = StObject.set(x, "onPointerOver", value.asInstanceOf[js.Any])
    ...
    inline def setOnPointerUp(value: Any): Self = StObject.set(x, "onPointerUp", value.asInstanceOf[js.Any])
    ...
    inline def setOnTransitionEnd(value: Any): Self = StObject.set(x, "onTransitionEnd", value.asInstanceOf[js.Any])
    ...
    inline def setOnWheel(value: Any): Self = StObject.set(x, "onWheel", value.asInstanceOf[js.Any])
    ...
    inline def setRadioGroup(value: Any): Self = StObject.set(x, "radioGroup", value.asInstanceOf[js.Any])
    
    inline def setRadioGroupUndefined: Self = StObject.set(x, "radioGroup", js.undefined)
    
    inline def setRef(value: Ref[HTMLIonRouterOutletElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: HTMLIonRouterOutletElement | Null => japgolly.scalajs.react.Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: HTMLIonRouterOutletElement | Null) => value(t0).runNow()))
    ...
    inline def setRole(value: Any): Self = StObject.set(x, "role", value.asInstanceOf[js.Any])
    
    inline def setRoleUndefined: Self = StObject.set(x, "role", js.undefined)
    
    inline def setSecurity(value: Any): Self = StObject.set(x, "security", value.asInstanceOf[js.Any])
    ...
    inline def setSpellCheck(value: Any): Self = StObject.set(x, "spellCheck", value.asInstanceOf[js.Any])
    ...
    inline def setSuppressContentEditableWarning(value: Any): Self = StObject.set(x, "suppressContentEditableWarning", value.asInstanceOf[js.Any])
    
    inline def setSuppressContentEditableWarningUndefined: Self = StObject.set(x, "suppressContentEditableWarning", js.undefined)
    
    inline def setSuppressHydrationWarning(value: Any): Self = StObject.set(x, "suppressHydrationWarning", value.asInstanceOf[js.Any])
    ...
    inline def setTypeof(value: Any): Self = StObject.set(x, "typeof", value.asInstanceOf[js.Any])
    
    inline def setTypeofUndefined: Self = StObject.set(x, "typeof", js.undefined)
    
    inline def setUnselectable(value: Any): Self = StObject.set(x, "unselectable", value.asInstanceOf[js.Any])
    
    inline def setUnselectableUndefined: Self = StObject.set(x, "unselectable", js.undefined)
    
    inline def setVocab(value: Any): Self = StObject.set(x, "vocab", value.asInstanceOf[js.Any])
