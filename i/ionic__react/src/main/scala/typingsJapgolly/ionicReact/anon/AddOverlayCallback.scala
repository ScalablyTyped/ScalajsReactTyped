...
import typingsJapgolly.ionicReact.distTypesContextsIonContextMod.IonContextInterface
...
@js.native
trait AddOverlayCallback extends StObject {
  ...
  var addOverlayCallback: js.UndefOr[
    js.Function3[/* id */ String, /* overlay */ Any, /* containerElement */ HTMLDivElement, Unit]
  ] = js.native
  ...
  var ionContext: IonContextInterface = js.native
  
  val props: Props & ReadonlychildrenReactNode = js.native
  
  var refs: StringDictionary[ReactInstance] = js.native
  
  var removeOverlayCallback: js.UndefOr[js.Function1[/* id */ String, Unit]] = js.native
