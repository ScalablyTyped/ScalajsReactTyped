...
trait Dur extends StObject {
  ...
  var playTo: js.UndefOr[
    typingsJapgolly.ionicReact.ionicReactInts.`0` | typingsJapgolly.ionicReact.ionicReactInts.`1`
  ] = js.undefined
...
object Dur {
  ...
  extension [Self <: Dur](x: Self) {
    ...
    inline def setPlayTo(
      value: typingsJapgolly.ionicReact.ionicReactInts.`0` | typingsJapgolly.ionicReact.ionicReactInts.`1`
