...
import typingsJapgolly.ionicReact.anon.`5`
import typingsJapgolly.ionicReact.anon.`6`
...
object distTypesComponentsCreateOverlayComponentMod {
  
  @JSImport("@ionic/react/dist/types/components/createOverlayComponent", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def createOverlayComponent[OverlayComponent /* <: js.Object */, OverlayType /* <: OverlayElement */](tagName: String, controller: `5`[OverlayType]): ForwardRefExoticComponent[
    (PropsWithoutRef[OverlayComponent & ReactOverlayProps & `6`[OverlayType]]) & RefAttributes[OverlayType]
  ...
  inline def createOverlayComponent[OverlayComponent /* <: js.Object */, OverlayType /* <: OverlayElement */](tagName: String, controller: `5`[OverlayType], defineCustomElement: js.Function0[Unit]): ForwardRefExoticComponent[
    (PropsWithoutRef[OverlayComponent & ReactOverlayProps & `6`[OverlayType]]) & RefAttributes[OverlayType]
  ] = (^.asInstanceOf[js.Dynamic].applyDynamic("createOverlayComponent")(tagName.asInstanceOf[js.Any], controller.asInstanceOf[js.Any], defineCustomElement.asInstanceOf[js.Any])).asInstanceOf[ForwardRefExoticComponent[
    (PropsWithoutRef[OverlayComponent & ReactOverlayProps & `6`[OverlayType]]) & RefAttributes[OverlayType]
  ]]
