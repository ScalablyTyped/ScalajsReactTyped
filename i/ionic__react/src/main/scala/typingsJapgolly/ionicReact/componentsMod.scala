...
import typingsJapgolly.ionicReact.ionBackButtonMod.Props
...
object componentsMod extends js.Object {
  ...
  class IonTabs protected ()
    extends typingsJapgolly.ionicReact.ionTabsMod.IonTabs {
    def this(props: typingsJapgolly.ionicReact.ionTabsMod.Props) = this()
  }
  ...
  val IonTabBar: FC[typingsJapgolly.ionicReact.ionTabBarMod.Props] = js.native
