...
object IonSlidesPickHTMLAttribut {
  ...
  def apply(
    ...
    onVolumeChange: ReactEventFrom[HTMLIonSlidesElement with Element] => Callback = null,
    onWaiting: ReactEventFrom[HTMLIonSlidesElement with Element] => Callback = null,
    onWheel: ReactWheelEventFrom[HTMLIonSlidesElement with Element] => Callback = null
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSlidesElement with org.scalajs.dom.raw.Element]) => onVolumeChange(t0).runNow()))
    if (onWaiting != null) __obj.updateDynamic("onWaiting")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSlidesElement with org.scalajs.dom.raw.Element]) => onWaiting(t0).runNow()))
    if (onWheel != null) __obj.updateDynamic("onWheel")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactWheelEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSlidesElement with org.scalajs.dom.raw.Element]) => onWheel(t0).runNow()))
