...
import typingsJapgolly.ionicReact.IonCardHeaderPickHTMLAttr
...
object IonCardHeader {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonCardHeaderPickHTMLAttr, Ref, Unit, IonCardHeaderPickHTMLAttr] = {
  ...
  typingsJapgolly.ionicReact.IonCardHeaderPickHTMLAttr, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonCardHeaderPickHTMLAttr])(children: _*)
  }
