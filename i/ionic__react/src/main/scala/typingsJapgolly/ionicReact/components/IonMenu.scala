...
import typingsJapgolly.ionicReact.IonMenuPickHTMLAttributes
...
object IonMenu {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonMenuPickHTMLAttributes, Ref, Unit, IonMenuPickHTMLAttributes] = {
  ...
  typingsJapgolly.ionicReact.IonMenuPickHTMLAttributes, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonMenuPickHTMLAttributes])(children: _*)
  }
