...
import typingsJapgolly.ionicReact.IonCardContentPickHTMLAtt
...
object IonCardContent {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonCardContentPickHTMLAtt, Ref, Unit, IonCardContentPickHTMLAtt] = {
  ...
  typingsJapgolly.ionicReact.IonCardContentPickHTMLAtt, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonCardContentPickHTMLAtt])(children: _*)
  }
