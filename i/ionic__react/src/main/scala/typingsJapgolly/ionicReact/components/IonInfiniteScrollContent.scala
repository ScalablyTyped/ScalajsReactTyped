...
import typingsJapgolly.ionicReact.IonInfiniteScrollContentP
...
object IonInfiniteScrollContent {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonInfiniteScrollContentP, Ref, Unit, IonInfiniteScrollContentP] = {
  ...
  typingsJapgolly.ionicReact.IonInfiniteScrollContentP, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonInfiniteScrollContentP])(children: _*)
  }
