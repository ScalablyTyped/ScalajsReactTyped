...
import typingsJapgolly.ionicReact.IonSelectPopoverPickHTMLA
...
object IonSelectPopover {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonSelectPopoverPickHTMLA, Ref, Unit, IonSelectPopoverPickHTMLA] = {
  ...
  typingsJapgolly.ionicReact.IonSelectPopoverPickHTMLA, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonSelectPopoverPickHTMLA])(children: _*)
  }
