...
import typingsJapgolly.ionicReact.IonFooterPickHTMLAttribut
...
object IonFooter {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonFooterPickHTMLAttribut, Ref, Unit, IonFooterPickHTMLAttribut] = {
  ...
  typingsJapgolly.ionicReact.IonFooterPickHTMLAttribut, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonFooterPickHTMLAttribut])(children: _*)
  }
