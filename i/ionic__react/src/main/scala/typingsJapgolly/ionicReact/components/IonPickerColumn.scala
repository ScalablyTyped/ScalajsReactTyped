...
import typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement
import typingsJapgolly.ionicCore.pickerInterfaceMod.PickerColumn
import typingsJapgolly.ionicReact.IonPickerColumnPickHTMLAt
...
object IonPickerColumn {
  def apply(
    ...
    lang: String = null,
    onAbort: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onAnimationEnd: ReactAnimationEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onAnimationIteration: ReactAnimationEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onAnimationStart: ReactAnimationEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onAuxClick: ReactMouseEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onBeforeInput: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onBlur: ReactFocusEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onCanPlay: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onCanPlayThrough: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onChange: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onClick: ReactMouseEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onCompositionEnd: ReactCompositionEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onCompositionStart: ReactCompositionEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onCompositionUpdate: ReactCompositionEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onContextMenu: ReactMouseEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onCopy: ReactClipboardEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onCut: ReactClipboardEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onDoubleClick: ReactMouseEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onDrag: ReactDragEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onDragEnd: ReactDragEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onDragEnter: ReactDragEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onDragExit: ReactDragEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onDragLeave: ReactDragEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onDragOver: ReactDragEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onDragStart: ReactDragEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onDrop: ReactDragEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onDurationChange: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onEmptied: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onEncrypted: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onEnded: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onError: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onFocus: ReactFocusEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onInput: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onInvalid: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onKeyDown: ReactKeyboardEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onKeyPress: ReactKeyboardEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onKeyUp: ReactKeyboardEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onLoad: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onLoadStart: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onLoadedData: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onLoadedMetadata: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onMouseDown: ReactMouseEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onMouseEnter: ReactMouseEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onMouseLeave: ReactMouseEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onMouseMove: ReactMouseEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onMouseOut: ReactMouseEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onMouseOver: ReactMouseEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onMouseUp: ReactMouseEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onPaste: ReactClipboardEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onPause: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onPlay: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onPlaying: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onPointerCancel: ReactPointerEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onPointerDown: ReactPointerEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onPointerEnter: ReactPointerEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onPointerLeave: ReactPointerEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onPointerMove: ReactPointerEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onPointerOut: ReactPointerEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onPointerOver: ReactPointerEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onPointerUp: ReactPointerEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onProgress: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onRateChange: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onReset: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onScroll: ReactUIEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onSeeked: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onSeeking: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onSelect: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onStalled: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onSubmit: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onSuspend: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onTimeUpdate: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onTouchCancel: ReactTouchEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onTouchEnd: ReactTouchEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onTouchMove: ReactTouchEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onTouchStart: ReactTouchEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onTransitionEnd: ReactTransitionEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onVolumeChange: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onWaiting: ReactEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    onWheel: ReactWheelEventFrom[HTMLIonPickerColumnElement with Element] => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonPickerColumnPickHTMLAt, Ref, Unit, IonPickerColumnPickHTMLAt] = {
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onAbort(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onAnimationEnd(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onAnimationIteration(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onAnimationStart(t0).runNow()))
    if (onAuxClick != null) __obj.updateDynamic("onAuxClick")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onAuxClick(t0).runNow()))
    if (onBeforeInput != null) __obj.updateDynamic("onBeforeInput")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onBeforeInput(t0).runNow()))
    if (onBlur != null) __obj.updateDynamic("onBlur")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactFocusEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onBlur(t0).runNow()))
    if (onCanPlay != null) __obj.updateDynamic("onCanPlay")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onCanPlay(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onCanPlayThrough(t0).runNow()))
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onChange(t0).runNow()))
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onClick(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onCompositionEnd(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onCompositionStart(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onCompositionUpdate(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onContextMenu(t0).runNow()))
    if (onCopy != null) __obj.updateDynamic("onCopy")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactClipboardEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onCopy(t0).runNow()))
    if (onCut != null) __obj.updateDynamic("onCut")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactClipboardEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onCut(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onDoubleClick(t0).runNow()))
    if (onDrag != null) __obj.updateDynamic("onDrag")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onDrag(t0).runNow()))
    if (onDragEnd != null) __obj.updateDynamic("onDragEnd")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onDragEnd(t0).runNow()))
    if (onDragEnter != null) __obj.updateDynamic("onDragEnter")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onDragEnter(t0).runNow()))
    if (onDragExit != null) __obj.updateDynamic("onDragExit")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onDragExit(t0).runNow()))
    if (onDragLeave != null) __obj.updateDynamic("onDragLeave")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onDragLeave(t0).runNow()))
    if (onDragOver != null) __obj.updateDynamic("onDragOver")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onDragOver(t0).runNow()))
    if (onDragStart != null) __obj.updateDynamic("onDragStart")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onDragStart(t0).runNow()))
    if (onDrop != null) __obj.updateDynamic("onDrop")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onDrop(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onDurationChange(t0).runNow()))
    if (onEmptied != null) __obj.updateDynamic("onEmptied")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onEmptied(t0).runNow()))
    if (onEncrypted != null) __obj.updateDynamic("onEncrypted")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onEncrypted(t0).runNow()))
    if (onEnded != null) __obj.updateDynamic("onEnded")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onEnded(t0).runNow()))
    if (onError != null) __obj.updateDynamic("onError")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onError(t0).runNow()))
    if (onFocus != null) __obj.updateDynamic("onFocus")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactFocusEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onFocus(t0).runNow()))
    if (onInput != null) __obj.updateDynamic("onInput")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onInput(t0).runNow()))
    if (onInvalid != null) __obj.updateDynamic("onInvalid")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onInvalid(t0).runNow()))
    if (onKeyDown != null) __obj.updateDynamic("onKeyDown")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactKeyboardEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onKeyDown(t0).runNow()))
    if (onKeyPress != null) __obj.updateDynamic("onKeyPress")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactKeyboardEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onKeyPress(t0).runNow()))
    if (onKeyUp != null) __obj.updateDynamic("onKeyUp")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactKeyboardEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onKeyUp(t0).runNow()))
    if (onLoad != null) __obj.updateDynamic("onLoad")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onLoad(t0).runNow()))
    if (onLoadStart != null) __obj.updateDynamic("onLoadStart")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onLoadStart(t0).runNow()))
    if (onLoadedData != null) __obj.updateDynamic("onLoadedData")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onLoadedData(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onLoadedMetadata(t0).runNow()))
    if (onMouseDown != null) __obj.updateDynamic("onMouseDown")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onMouseDown(t0).runNow()))
    if (onMouseEnter != null) __obj.updateDynamic("onMouseEnter")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onMouseEnter(t0).runNow()))
    if (onMouseLeave != null) __obj.updateDynamic("onMouseLeave")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onMouseLeave(t0).runNow()))
    if (onMouseMove != null) __obj.updateDynamic("onMouseMove")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onMouseMove(t0).runNow()))
    if (onMouseOut != null) __obj.updateDynamic("onMouseOut")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onMouseOut(t0).runNow()))
    if (onMouseOver != null) __obj.updateDynamic("onMouseOver")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onMouseOver(t0).runNow()))
    if (onMouseUp != null) __obj.updateDynamic("onMouseUp")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onMouseUp(t0).runNow()))
    if (onPaste != null) __obj.updateDynamic("onPaste")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactClipboardEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onPaste(t0).runNow()))
    if (onPause != null) __obj.updateDynamic("onPause")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onPause(t0).runNow()))
    if (onPlay != null) __obj.updateDynamic("onPlay")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onPlay(t0).runNow()))
    if (onPlaying != null) __obj.updateDynamic("onPlaying")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onPlaying(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onPointerCancel(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onPointerDown(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onPointerEnter(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onPointerLeave(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onPointerMove(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onPointerOut(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onPointerOver(t0).runNow()))
    if (onPointerUp != null) __obj.updateDynamic("onPointerUp")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactPointerEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onPointerUp(t0).runNow()))
    if (onProgress != null) __obj.updateDynamic("onProgress")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onProgress(t0).runNow()))
    if (onRateChange != null) __obj.updateDynamic("onRateChange")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onRateChange(t0).runNow()))
    if (onReset != null) __obj.updateDynamic("onReset")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onReset(t0).runNow()))
    if (onScroll != null) __obj.updateDynamic("onScroll")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactUIEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onScroll(t0).runNow()))
    if (onSeeked != null) __obj.updateDynamic("onSeeked")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onSeeked(t0).runNow()))
    if (onSeeking != null) __obj.updateDynamic("onSeeking")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onSeeking(t0).runNow()))
    if (onSelect != null) __obj.updateDynamic("onSelect")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onSelect(t0).runNow()))
    if (onStalled != null) __obj.updateDynamic("onStalled")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onStalled(t0).runNow()))
    if (onSubmit != null) __obj.updateDynamic("onSubmit")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onSubmit(t0).runNow()))
    if (onSuspend != null) __obj.updateDynamic("onSuspend")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onSuspend(t0).runNow()))
    if (onTimeUpdate != null) __obj.updateDynamic("onTimeUpdate")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onTimeUpdate(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onTouchCancel(t0).runNow()))
    if (onTouchEnd != null) __obj.updateDynamic("onTouchEnd")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactTouchEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onTouchEnd(t0).runNow()))
    if (onTouchMove != null) __obj.updateDynamic("onTouchMove")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactTouchEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onTouchMove(t0).runNow()))
    if (onTouchStart != null) __obj.updateDynamic("onTouchStart")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactTouchEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onTouchStart(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onTransitionEnd(t0).runNow()))
    if (onVolumeChange != null) __obj.updateDynamic("onVolumeChange")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onVolumeChange(t0).runNow()))
    if (onWaiting != null) __obj.updateDynamic("onWaiting")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onWaiting(t0).runNow()))
    if (onWheel != null) __obj.updateDynamic("onWheel")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactWheelEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonPickerColumnElement with org.scalajs.dom.raw.Element]) => onWheel(t0).runNow()))
  ...
  typingsJapgolly.ionicReact.IonPickerColumnPickHTMLAt, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonPickerColumnPickHTMLAt])(children: _*)
  }
