...
import typingsJapgolly.ionicReact.IonListHeaderPickHTMLAttr
...
object IonListHeader {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonListHeaderPickHTMLAttr, Ref, Unit, IonListHeaderPickHTMLAttr] = {
  ...
  typingsJapgolly.ionicReact.IonListHeaderPickHTMLAttr, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonListHeaderPickHTMLAttr])(children: _*)
  }
