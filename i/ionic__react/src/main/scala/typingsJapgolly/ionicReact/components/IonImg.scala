...
import typingsJapgolly.ionicReact.IonImgPickHTMLAttributesH
...
object IonImg {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonImgPickHTMLAttributesH, Ref, Unit, IonImgPickHTMLAttributesH] = {
  ...
  typingsJapgolly.ionicReact.IonImgPickHTMLAttributesH, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonImgPickHTMLAttributesH])(children: _*)
  }
