...
import typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement
import typingsJapgolly.ionicCore.segmentSegmentInterfaceMod.SegmentButtonLayout
import typingsJapgolly.ionicReact.IonSegmentButtonPickHTMLA
...
object IonSegmentButton {
  def apply(
    ...
    mode: ios | md = null,
    onAbort: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onAnimationEnd: ReactAnimationEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onAnimationIteration: ReactAnimationEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onAnimationStart: ReactAnimationEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onAuxClick: ReactMouseEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onBeforeInput: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onBlur: ReactFocusEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onCanPlay: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onCanPlayThrough: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onChange: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onClick: ReactMouseEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onCompositionEnd: ReactCompositionEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onCompositionStart: ReactCompositionEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onCompositionUpdate: ReactCompositionEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onContextMenu: ReactMouseEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onCopy: ReactClipboardEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onCut: ReactClipboardEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onDoubleClick: ReactMouseEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onDrag: ReactDragEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onDragEnd: ReactDragEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onDragEnter: ReactDragEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onDragExit: ReactDragEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onDragLeave: ReactDragEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onDragOver: ReactDragEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onDragStart: ReactDragEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onDrop: ReactDragEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onDurationChange: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onEmptied: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onEncrypted: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onEnded: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onError: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onFocus: ReactFocusEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onInput: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onInvalid: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onIonSelect: /* event */ CustomEvent => Callback = null,
    onKeyDown: ReactKeyboardEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onKeyPress: ReactKeyboardEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onKeyUp: ReactKeyboardEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onLoad: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onLoadStart: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onLoadedData: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onLoadedMetadata: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onMouseDown: ReactMouseEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onMouseEnter: ReactMouseEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onMouseLeave: ReactMouseEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onMouseMove: ReactMouseEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onMouseOut: ReactMouseEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onMouseOver: ReactMouseEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onMouseUp: ReactMouseEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onPaste: ReactClipboardEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onPause: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onPlay: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onPlaying: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onPointerCancel: ReactPointerEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onPointerDown: ReactPointerEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onPointerEnter: ReactPointerEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onPointerLeave: ReactPointerEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onPointerMove: ReactPointerEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onPointerOut: ReactPointerEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onPointerOver: ReactPointerEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onPointerUp: ReactPointerEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onProgress: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onRateChange: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onReset: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onScroll: ReactUIEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onSeeked: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onSeeking: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onSelect: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onStalled: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onSubmit: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onSuspend: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onTimeUpdate: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onTouchCancel: ReactTouchEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onTouchEnd: ReactTouchEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onTouchMove: ReactTouchEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onTouchStart: ReactTouchEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onTransitionEnd: ReactTransitionEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onVolumeChange: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onWaiting: ReactEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    onWheel: ReactWheelEventFrom[HTMLIonSegmentButtonElement with Element] => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonSegmentButtonPickHTMLA, Ref, Unit, IonSegmentButtonPickHTMLA] = {
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onAbort(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onAnimationEnd(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onAnimationIteration(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onAnimationStart(t0).runNow()))
    if (onAuxClick != null) __obj.updateDynamic("onAuxClick")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onAuxClick(t0).runNow()))
    if (onBeforeInput != null) __obj.updateDynamic("onBeforeInput")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onBeforeInput(t0).runNow()))
    if (onBlur != null) __obj.updateDynamic("onBlur")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactFocusEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onBlur(t0).runNow()))
    if (onCanPlay != null) __obj.updateDynamic("onCanPlay")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onCanPlay(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onCanPlayThrough(t0).runNow()))
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onChange(t0).runNow()))
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onClick(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onCompositionEnd(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onCompositionStart(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onCompositionUpdate(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onContextMenu(t0).runNow()))
    if (onCopy != null) __obj.updateDynamic("onCopy")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactClipboardEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onCopy(t0).runNow()))
    if (onCut != null) __obj.updateDynamic("onCut")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactClipboardEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onCut(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onDoubleClick(t0).runNow()))
    if (onDrag != null) __obj.updateDynamic("onDrag")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onDrag(t0).runNow()))
    if (onDragEnd != null) __obj.updateDynamic("onDragEnd")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onDragEnd(t0).runNow()))
    if (onDragEnter != null) __obj.updateDynamic("onDragEnter")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onDragEnter(t0).runNow()))
    if (onDragExit != null) __obj.updateDynamic("onDragExit")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onDragExit(t0).runNow()))
    if (onDragLeave != null) __obj.updateDynamic("onDragLeave")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onDragLeave(t0).runNow()))
    if (onDragOver != null) __obj.updateDynamic("onDragOver")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onDragOver(t0).runNow()))
    if (onDragStart != null) __obj.updateDynamic("onDragStart")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onDragStart(t0).runNow()))
    if (onDrop != null) __obj.updateDynamic("onDrop")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactDragEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onDrop(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onDurationChange(t0).runNow()))
    if (onEmptied != null) __obj.updateDynamic("onEmptied")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onEmptied(t0).runNow()))
    if (onEncrypted != null) __obj.updateDynamic("onEncrypted")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onEncrypted(t0).runNow()))
    if (onEnded != null) __obj.updateDynamic("onEnded")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onEnded(t0).runNow()))
    if (onError != null) __obj.updateDynamic("onError")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onError(t0).runNow()))
    if (onFocus != null) __obj.updateDynamic("onFocus")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactFocusEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onFocus(t0).runNow()))
    if (onInput != null) __obj.updateDynamic("onInput")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onInput(t0).runNow()))
    if (onInvalid != null) __obj.updateDynamic("onInvalid")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onInvalid(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onKeyDown(t0).runNow()))
    if (onKeyPress != null) __obj.updateDynamic("onKeyPress")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactKeyboardEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onKeyPress(t0).runNow()))
    if (onKeyUp != null) __obj.updateDynamic("onKeyUp")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactKeyboardEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onKeyUp(t0).runNow()))
    if (onLoad != null) __obj.updateDynamic("onLoad")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onLoad(t0).runNow()))
    if (onLoadStart != null) __obj.updateDynamic("onLoadStart")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onLoadStart(t0).runNow()))
    if (onLoadedData != null) __obj.updateDynamic("onLoadedData")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onLoadedData(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onLoadedMetadata(t0).runNow()))
    if (onMouseDown != null) __obj.updateDynamic("onMouseDown")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onMouseDown(t0).runNow()))
    if (onMouseEnter != null) __obj.updateDynamic("onMouseEnter")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onMouseEnter(t0).runNow()))
    if (onMouseLeave != null) __obj.updateDynamic("onMouseLeave")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onMouseLeave(t0).runNow()))
    if (onMouseMove != null) __obj.updateDynamic("onMouseMove")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onMouseMove(t0).runNow()))
    if (onMouseOut != null) __obj.updateDynamic("onMouseOut")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onMouseOut(t0).runNow()))
    if (onMouseOver != null) __obj.updateDynamic("onMouseOver")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onMouseOver(t0).runNow()))
    if (onMouseUp != null) __obj.updateDynamic("onMouseUp")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onMouseUp(t0).runNow()))
    if (onPaste != null) __obj.updateDynamic("onPaste")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactClipboardEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onPaste(t0).runNow()))
    if (onPause != null) __obj.updateDynamic("onPause")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onPause(t0).runNow()))
    if (onPlay != null) __obj.updateDynamic("onPlay")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onPlay(t0).runNow()))
    if (onPlaying != null) __obj.updateDynamic("onPlaying")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onPlaying(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onPointerCancel(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onPointerDown(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onPointerEnter(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onPointerLeave(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onPointerMove(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onPointerOut(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onPointerOver(t0).runNow()))
    if (onPointerUp != null) __obj.updateDynamic("onPointerUp")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactPointerEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onPointerUp(t0).runNow()))
    if (onProgress != null) __obj.updateDynamic("onProgress")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onProgress(t0).runNow()))
    if (onRateChange != null) __obj.updateDynamic("onRateChange")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onRateChange(t0).runNow()))
    if (onReset != null) __obj.updateDynamic("onReset")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onReset(t0).runNow()))
    if (onScroll != null) __obj.updateDynamic("onScroll")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactUIEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onScroll(t0).runNow()))
    if (onSeeked != null) __obj.updateDynamic("onSeeked")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onSeeked(t0).runNow()))
    if (onSeeking != null) __obj.updateDynamic("onSeeking")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onSeeking(t0).runNow()))
    if (onSelect != null) __obj.updateDynamic("onSelect")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onSelect(t0).runNow()))
    if (onStalled != null) __obj.updateDynamic("onStalled")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onStalled(t0).runNow()))
    if (onSubmit != null) __obj.updateDynamic("onSubmit")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onSubmit(t0).runNow()))
    if (onSuspend != null) __obj.updateDynamic("onSuspend")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onSuspend(t0).runNow()))
    if (onTimeUpdate != null) __obj.updateDynamic("onTimeUpdate")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onTimeUpdate(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onTouchCancel(t0).runNow()))
    if (onTouchEnd != null) __obj.updateDynamic("onTouchEnd")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactTouchEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onTouchEnd(t0).runNow()))
    if (onTouchMove != null) __obj.updateDynamic("onTouchMove")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactTouchEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onTouchMove(t0).runNow()))
    if (onTouchStart != null) __obj.updateDynamic("onTouchStart")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactTouchEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onTouchStart(t0).runNow()))
  ...
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onTransitionEnd(t0).runNow()))
    if (onVolumeChange != null) __obj.updateDynamic("onVolumeChange")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onVolumeChange(t0).runNow()))
    if (onWaiting != null) __obj.updateDynamic("onWaiting")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onWaiting(t0).runNow()))
    if (onWheel != null) __obj.updateDynamic("onWheel")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactWheelEventFrom[
  typingsJapgolly.ionicCore.componentsMod._Global_.HTMLIonSegmentButtonElement with org.scalajs.dom.raw.Element]) => onWheel(t0).runNow()))
  ...
  typingsJapgolly.ionicReact.IonSegmentButtonPickHTMLA, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonSegmentButtonPickHTMLA])(children: _*)
  }
