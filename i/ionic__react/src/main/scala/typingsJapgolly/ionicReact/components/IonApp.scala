...
import typingsJapgolly.ionicReact.IonAppPickHTMLAttributesH
...
object IonApp {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonAppPickHTMLAttributesH, Ref, Unit, IonAppPickHTMLAttributesH] = {
  ...
  typingsJapgolly.ionicReact.IonAppPickHTMLAttributesH, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonAppPickHTMLAttributesH])(children: _*)
  }
