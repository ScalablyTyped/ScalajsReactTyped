...
import typingsJapgolly.ionicReact.IonButtonsPickHTMLAttribu
...
object IonButtons {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonButtonsPickHTMLAttribu, Ref, Unit, IonButtonsPickHTMLAttribu] = {
  ...
  typingsJapgolly.ionicReact.IonButtonsPickHTMLAttribu, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonButtonsPickHTMLAttribu])(children: _*)
  }
