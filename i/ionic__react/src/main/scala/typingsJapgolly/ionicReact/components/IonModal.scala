...
import typingsJapgolly.ionicReact.childrenReactNodeforwarde
...
object IonModal {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[childrenReactNodeforwarde, Ref, Unit, childrenReactNodeforwarde] = {
  ...
  typingsJapgolly.ionicReact.childrenReactNodeforwarde, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.childrenReactNodeforwarde])(children: _*)
  }
