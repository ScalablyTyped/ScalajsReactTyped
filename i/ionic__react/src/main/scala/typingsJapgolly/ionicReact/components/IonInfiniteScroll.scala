...
import typingsJapgolly.ionicReact.IonInfiniteScrollPickHTML
...
object IonInfiniteScroll {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonInfiniteScrollPickHTML, Ref, Unit, IonInfiniteScrollPickHTML] = {
  ...
  typingsJapgolly.ionicReact.IonInfiniteScrollPickHTML, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonInfiniteScrollPickHTML])(children: _*)
  }
