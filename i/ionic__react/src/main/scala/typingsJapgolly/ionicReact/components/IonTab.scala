...
import typingsJapgolly.ionicReact.IonTabPickHTMLAttributesH
...
object IonTab {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonTabPickHTMLAttributesH, Ref, Unit, IonTabPickHTMLAttributesH] = {
  ...
  typingsJapgolly.ionicReact.IonTabPickHTMLAttributesH, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonTabPickHTMLAttributesH])(children: _*)
  }
