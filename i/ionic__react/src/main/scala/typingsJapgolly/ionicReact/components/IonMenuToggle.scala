...
import typingsJapgolly.ionicReact.IonMenuTogglePickHTMLAttr
...
object IonMenuToggle {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonMenuTogglePickHTMLAttr, Ref, Unit, IonMenuTogglePickHTMLAttr] = {
  ...
  typingsJapgolly.ionicReact.IonMenuTogglePickHTMLAttr, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonMenuTogglePickHTMLAttr])(children: _*)
  }
