...
import typingsJapgolly.ionicReact.IonListPickHTMLAttributes
...
object IonList {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonListPickHTMLAttributes, Ref, Unit, IonListPickHTMLAttributes] = {
  ...
  typingsJapgolly.ionicReact.IonListPickHTMLAttributes, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonListPickHTMLAttributes])(children: _*)
  }
