...
import typingsJapgolly.ionicReact.IonHeaderPickHTMLAttribut
...
object IonHeader {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonHeaderPickHTMLAttribut, Ref, Unit, IonHeaderPickHTMLAttribut] = {
  ...
  typingsJapgolly.ionicReact.IonHeaderPickHTMLAttribut, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonHeaderPickHTMLAttribut])(children: _*)
  }
