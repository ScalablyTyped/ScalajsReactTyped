...
import typingsJapgolly.ionicReact.PickHTMLAttributesunknown
...
object IonPage {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PickHTMLAttributesunknown, Ref, Unit, PickHTMLAttributesunknown] = {
  ...
  typingsJapgolly.ionicReact.PickHTMLAttributesunknown, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.PickHTMLAttributesunknown])(children: _*)
  }
