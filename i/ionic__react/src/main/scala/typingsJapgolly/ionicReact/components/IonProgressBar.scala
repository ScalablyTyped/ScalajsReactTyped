...
import typingsJapgolly.ionicReact.IonProgressBarPickHTMLAtt
...
object IonProgressBar {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonProgressBarPickHTMLAtt, Ref, Unit, IonProgressBarPickHTMLAtt] = {
  ...
  typingsJapgolly.ionicReact.IonProgressBarPickHTMLAtt, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonProgressBarPickHTMLAtt])(children: _*)
  }
