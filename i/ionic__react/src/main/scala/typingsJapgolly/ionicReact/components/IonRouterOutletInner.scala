...
import typingsJapgolly.ionicReact.IonRouterOutletPickHTMLAt
...
object IonRouterOutletInner {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonRouterOutletPickHTMLAt, Ref, Unit, IonRouterOutletPickHTMLAt] = {
  ...
  typingsJapgolly.ionicReact.IonRouterOutletPickHTMLAt, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonRouterOutletPickHTMLAt])(children: _*)
  }
