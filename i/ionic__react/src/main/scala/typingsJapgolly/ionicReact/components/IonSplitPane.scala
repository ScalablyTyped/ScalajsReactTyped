...
import typingsJapgolly.ionicReact.IonSplitPanePickHTMLAttri
...
object IonSplitPane {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonSplitPanePickHTMLAttri, Ref, Unit, IonSplitPanePickHTMLAttri] = {
  ...
  typingsJapgolly.ionicReact.IonSplitPanePickHTMLAttri, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonSplitPanePickHTMLAttri])(children: _*)
  }
