...
import typingsJapgolly.ionicReact.IonRefresherPickHTMLAttri
...
object IonRefresher {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonRefresherPickHTMLAttri, Ref, Unit, IonRefresherPickHTMLAttri] = {
  ...
  typingsJapgolly.ionicReact.IonRefresherPickHTMLAttri, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonRefresherPickHTMLAttri])(children: _*)
  }
