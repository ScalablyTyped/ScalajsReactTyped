...
import typingsJapgolly.ionicReact.IonSpinnerPickHTMLAttribu
...
object IonSpinner {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonSpinnerPickHTMLAttribu, Ref, Unit, IonSpinnerPickHTMLAttribu] = {
  ...
  typingsJapgolly.ionicReact.IonSpinnerPickHTMLAttribu, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonSpinnerPickHTMLAttribu])(children: _*)
  }
