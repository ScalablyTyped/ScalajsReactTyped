...
import typingsJapgolly.ionicReact.IonContentPickHTMLAttribu
...
object IonContent {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IonContentPickHTMLAttribu, Ref, Unit, IonContentPickHTMLAttribu] = {
  ...
  typingsJapgolly.ionicReact.IonContentPickHTMLAttribu, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.IonContentPickHTMLAttribu])(children: _*)
  }
