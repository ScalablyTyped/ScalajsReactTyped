...
import typingsJapgolly.ionicReact.childrenReactNodeforwardeAnimated
...
object IonPopover {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[childrenReactNodeforwardeAnimated, Ref, Unit, childrenReactNodeforwardeAnimated] = {
  ...
  typingsJapgolly.ionicReact.childrenReactNodeforwardeAnimated, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.ionicReact.childrenReactNodeforwardeAnimated])(children: _*)
  }
