...
object distTypesRoutingViewItemMod {
  ...
  object ViewItem {
    ...
    inline def apply[T](id: String, mount: Boolean, outletId: String, reactElement: VdomElement): ViewItem[T] = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], mount = mount.asInstanceOf[js.Any], outletId = outletId.asInstanceOf[js.Any], reactElement = reactElement.rawElement.asInstanceOf[js.Any])
    ...
    extension [Self <: ViewItem[?], T](x: Self & ViewItem[T]) {
      ...
      inline def setReactElement(value: VdomElement): Self = StObject.set(x, "reactElement", value.rawElement.asInstanceOf[js.Any])
