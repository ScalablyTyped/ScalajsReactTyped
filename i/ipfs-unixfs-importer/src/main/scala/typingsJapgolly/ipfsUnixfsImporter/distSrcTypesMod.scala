...
import typingsJapgolly.ipfsUnixfs.mod.UnixFS
import typingsJapgolly.ipfsUnixfsImporter.ipfsUnixfsImporterStrings.balanced
import typingsJapgolly.ipfsUnixfsImporter.ipfsUnixfsImporterStrings.file
import typingsJapgolly.ipfsUnixfsImporter.ipfsUnixfsImporterStrings.flat
import typingsJapgolly.ipfsUnixfsImporter.ipfsUnixfsImporterStrings.raw
import typingsJapgolly.ipfsUnixfsImporter.ipfsUnixfsImporterStrings.trickle
...
object distSrcTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ipfsUnixfsImporter.ipfsUnixfsImporterStrings.fixed
    - typingsJapgolly.ipfsUnixfsImporter.ipfsUnixfsImporterStrings.rabin
  */
  trait ChunkerType extends StObject
  object ChunkerType {
    
    inline def fixed: typingsJapgolly.ipfsUnixfsImporter.ipfsUnixfsImporterStrings.fixed = "fixed".asInstanceOf[typingsJapgolly.ipfsUnixfsImporter.ipfsUnixfsImporterStrings.fixed]
    
    inline def rabin: typingsJapgolly.ipfsUnixfsImporter.ipfsUnixfsImporterStrings.rabin = "rabin".asInstanceOf[typingsJapgolly.ipfsUnixfsImporter.ipfsUnixfsImporterStrings.rabin]
  }
  ...
  object ImportResult {
    ...
    inline def apply(cid: CID[Any, Double, Double, Version], size: Double): ImportResult = {
  ...
  object ImporterOptions {
    ...
    inline def apply(
      ...
      onlyHash: Boolean,
      polynomial: Double,
      progress: (/* chunkSize */ Double, /* path */ js.UndefOr[String]) => Callback,
      rawLeaves: Boolean,
      recursive: Boolean,
    ...
    extension [Self <: ImporterOptions](x: Self) {
      ...
      inline def setProgress(value: (/* chunkSize */ Double, /* path */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "progress", js.Any.fromFunction2((t0: /* chunkSize */ Double, t1: /* path */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
  ...
  object InProgressImportResult {
    ...
    inline def apply(cid: CID[Any, Double, Double, Version], size: Double): InProgressImportResult = {
      val __obj = js.Dynamic.literal(cid = cid.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any])
