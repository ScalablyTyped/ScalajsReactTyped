...
import typingsJapgolly.interactjsTypes.anon.Bottom
import typingsJapgolly.interactjsTypes.anon.Buttons
import typingsJapgolly.interactjsTypes.anon.ClientX
import typingsJapgolly.interactjsTypes.anon.Identifier
import typingsJapgolly.interactjsTypes.anon.Set
...
import typingsJapgolly.interactjsTypes.coreTypesMod.CoordsSetMember
...
object utilsPointerUtilsMod {
  ...
  inline def getPointerType(pointer: typingsJapgolly.interactjsTypes.anon.PointerType): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getPointerType")(pointer.asInstanceOf[js.Any]).asInstanceOf[String]
