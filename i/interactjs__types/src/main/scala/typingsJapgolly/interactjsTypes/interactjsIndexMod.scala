...
import typingsJapgolly.interactjsTypes.anon.Install
import typingsJapgolly.interactjsTypes.anon.Listeners
import typingsJapgolly.std.Plugin
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object interactjsIndexMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `interactjsIndexMod.foo` */
