...
object inertiaPluginMod extends Shortcut {
  ...
  open class InertiaState protected () extends StObject {
    ...
    var modification: typingsJapgolly.interactjsTypes.modifiersModificationMod.default = js.native
  ...
  object interactjsCoreInteractionAugmentingMod {
    ...
    object Interaction {
      ...
      inline def apply(): typingsJapgolly.interactjsTypes.inertiaPluginMod.interactjsCoreInteractionAugmentingMod.Interaction = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.interactjsTypes.inertiaPluginMod.interactjsCoreInteractionAugmentingMod.Interaction]
      }
      
      extension [Self <: typingsJapgolly.interactjsTypes.inertiaPluginMod.interactjsCoreInteractionAugmentingMod.Interaction](x: Self) {
