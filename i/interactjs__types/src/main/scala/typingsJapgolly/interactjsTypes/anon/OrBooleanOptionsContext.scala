...
trait OrBooleanOptionsContext extends StObject {
  ...
  var pointerEvents: js.UndefOr[Partial[typingsJapgolly.interactjsTypes.coreOptionsMod.Options] | Boolean] = js.undefined
...
object OrBooleanOptionsContext {
  ...
  extension [Self <: OrBooleanOptionsContext](x: Self) {
    ...
    inline def setPointerEvents(value: Partial[typingsJapgolly.interactjsTypes.coreOptionsMod.Options] | Boolean): Self = StObject.set(x, "pointerEvents", value.asInstanceOf[js.Any])
