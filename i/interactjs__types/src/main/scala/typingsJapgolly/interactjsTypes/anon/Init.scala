...
object Init {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(init = js.Any.fromFunction1((t0: Any) => init(t0).runNow()), isIOS = isIOS.asInstanceOf[js.Any], isIOS7 = isIOS7.asInstanceOf[js.Any], isIe9 = isIe9.asInstanceOf[js.Any], isOperaMobile = isOperaMobile.asInstanceOf[js.Any], pEventTypes = pEventTypes.asInstanceOf[js.Any], prefixedMatchesSelector = "matches", supportsPointerEvent = supportsPointerEvent.asInstanceOf[js.Any], supportsTouch = supportsTouch.asInstanceOf[js.Any], wheelEvent = wheelEvent.asInstanceOf[js.Any])
