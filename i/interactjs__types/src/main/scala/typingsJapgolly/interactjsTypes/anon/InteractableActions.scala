...
@js.native
trait InteractableActions extends StObject {
  ...
  val options: RequiredOptions = js.native
  ...
  def setPerAction(actionName: ActionName, options: OrBooleanOptions): Unit = js.native
