...
/* Inlined std.Required<@interactjs/types.@interactjs/core/types.Rect> & @interactjs/types.@interactjs/core/types.Point */
trait RequiredRectPoint extends StObject {
