...
trait PartialNativePointerEvent extends StObject {
  ...
  var composedPath: js.UndefOr[js.Function0[js.Array[org.scalajs.dom.EventTarget]]] = js.undefined
  
  var ctrlKey: js.UndefOr[Boolean] = js.undefined
  
  var currentTarget: js.UndefOr[org.scalajs.dom.EventTarget | Null] = js.undefined
  ...
  var getCoalescedEvents: js.UndefOr[js.Function0[js.Array[org.scalajs.dom.PointerEvent]]] = js.undefined
  
  var getModifierState: js.UndefOr[js.Function1[/* keyArg */ String, Boolean]] = js.undefined
  
  var getPredictedEvents: js.UndefOr[js.Function0[js.Array[org.scalajs.dom.PointerEvent]]] = js.undefined
  ...
  var srcElement: js.UndefOr[org.scalajs.dom.EventTarget | Null] = js.undefined
  ...
  var target: js.UndefOr[org.scalajs.dom.EventTarget | Null] = js.undefined
...
object PartialNativePointerEvent {
  ...
  extension [Self <: PartialNativePointerEvent](x: Self) {
    ...
    inline def setComposedPath(value: CallbackTo[js.Array[org.scalajs.dom.EventTarget]]): Self = StObject.set(x, "composedPath", value.toJsFn)
    ...
    inline def setGetCoalescedEvents(value: CallbackTo[js.Array[org.scalajs.dom.PointerEvent]]): Self = StObject.set(x, "getCoalescedEvents", value.toJsFn)
    ...
    inline def setGetPredictedEvents(value: CallbackTo[js.Array[org.scalajs.dom.PointerEvent]]): Self = StObject.set(x, "getPredictedEvents", value.toJsFn)
