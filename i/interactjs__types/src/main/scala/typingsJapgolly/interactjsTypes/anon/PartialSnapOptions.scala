...
trait PartialSnapOptions extends StObject {
  ...
  var origin: js.UndefOr[
    RectResolvable[js.Array[typingsJapgolly.interactjsTypes.coreTypesMod.Element]] | Point | Null
  ] = js.undefined
...
object PartialSnapOptions {
  ...
  extension [Self <: PartialSnapOptions](x: Self) {
    ...
    inline def setOrigin(value: RectResolvable[js.Array[typingsJapgolly.interactjsTypes.coreTypesMod.Element]] | Point): Self = StObject.set(x, "origin", value.asInstanceOf[js.Any])
    
    inline def setOriginFunction1(
      value: js.Array[typingsJapgolly.interactjsTypes.coreTypesMod.Element] => typingsJapgolly.interactjsTypes.coreTypesMod.Rect | typingsJapgolly.interactjsTypes.coreTypesMod.Element
