...
trait PartialDropzoneOptionsAccept extends StObject {
  ...
  var accept: js.UndefOr[
    String | typingsJapgolly.interactjsTypes.coreTypesMod.Element | (js.Function1[/* hasDropzoneDraggableElement */ Dropzone, Boolean])
  ] = js.undefined
...
object PartialDropzoneOptionsAccept {
  ...
  extension [Self <: PartialDropzoneOptionsAccept](x: Self) {
    ...
    inline def setAccept(
      value: String | typingsJapgolly.interactjsTypes.coreTypesMod.Element | (js.Function1[/* hasDropzoneDraggableElement */ Dropzone, Boolean])
