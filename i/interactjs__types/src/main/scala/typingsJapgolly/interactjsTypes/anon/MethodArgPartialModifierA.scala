...
trait MethodArgPartialModifierA extends StObject {
  ...
  var startOffset: js.UndefOr[typingsJapgolly.interactjsTypes.coreTypesMod.Rect] = js.undefined
...
object MethodArgPartialModifierA {
  ...
  extension [Self <: MethodArgPartialModifierA](x: Self) {
    ...
    inline def setStartOffset(value: typingsJapgolly.interactjsTypes.coreTypesMod.Rect): Self = StObject.set(x, "startOffset", value.asInstanceOf[js.Any])
