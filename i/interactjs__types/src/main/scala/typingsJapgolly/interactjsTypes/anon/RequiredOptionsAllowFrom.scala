...
trait RequiredOptionsAllowFrom extends StObject {
  ...
  var pointerEvents: PartialOptions
...
object RequiredOptionsAllowFrom {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[RequiredOptionsAllowFrom]
  }
  
  extension [Self <: RequiredOptionsAllowFrom](x: Self) {
    ...
    inline def setPointerEvents(value: PartialOptions): Self = StObject.set(x, "pointerEvents", value.asInstanceOf[js.Any])
