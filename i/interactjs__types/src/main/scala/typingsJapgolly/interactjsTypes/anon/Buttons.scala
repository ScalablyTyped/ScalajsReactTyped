...
object Buttons {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(buttons = buttons.asInstanceOf[js.Any], client = client.asInstanceOf[js.Any], clientX = clientX.asInstanceOf[js.Any], clientY = clientY.asInstanceOf[js.Any], coords = coords.asInstanceOf[js.Any], page = page.asInstanceOf[js.Any], pageX = pageX.asInstanceOf[js.Any], pageY = pageY.asInstanceOf[js.Any], pointerId = pointerId.asInstanceOf[js.Any], pointerType = pointerType.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, target = target.asInstanceOf[js.Any], timeStamp = timeStamp.asInstanceOf[js.Any])
