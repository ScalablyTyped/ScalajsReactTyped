...
@js.native
trait InteractableBackCompatOption extends StObject {
  ...
  val _scopeEvents: /* import warning: importer.ImportType#apply Failed type conversion: @interactjs/types.@interactjs/core/scope.Scope['events'] */ js.Any = js.native
