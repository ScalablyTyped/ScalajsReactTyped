...
trait PartialRectrangenumberund
  ...
  var limits: js.UndefOr[typingsJapgolly.interactjsTypes.coreTypesMod.Rect] = js.undefined
...
object PartialRectrangenumberund {
  ...
  extension [Self <: PartialRectrangenumberund](x: Self) {
    ...
    inline def setLimits(value: typingsJapgolly.interactjsTypes.coreTypesMod.Rect): Self = StObject.set(x, "limits", value.asInstanceOf[js.Any])
