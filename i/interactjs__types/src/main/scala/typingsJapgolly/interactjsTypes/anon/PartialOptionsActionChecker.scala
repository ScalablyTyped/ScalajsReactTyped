...
trait PartialOptionsActionChecker extends StObject {
  ...
  var drop: js.UndefOr[PartialDropzoneOptions] = js.undefined
...
object PartialOptionsActionChecker {
  
  inline def apply(): PartialOptionsActionChecker = {
  ...
  extension [Self <: PartialOptionsActionChecker](x: Self) {
    ...
    inline def setDrop(value: PartialDropzoneOptions): Self = StObject.set(x, "drop", value.asInstanceOf[js.Any])
