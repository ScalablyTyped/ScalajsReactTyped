...
trait RequiredOptionsContext extends StObject {
  ...
  var pointerEvents: Partial[typingsJapgolly.interactjsTypes.coreOptionsMod.Options]
...
object RequiredOptionsContext {
  ...
  inline def apply(
    ...
    drop: Partial[RequiredOptionsContext],
    enabled: Boolean,
    ...
    pointerEvents: Partial[typingsJapgolly.interactjsTypes.coreOptionsMod.Options],
    ...
    __obj.asInstanceOf[RequiredOptionsContext]
  }
  
  extension [Self <: RequiredOptionsContext](x: Self) {
    ...
    inline def setDrop(value: Partial[RequiredOptionsContext]): Self = StObject.set(x, "drop", value.asInstanceOf[js.Any])
