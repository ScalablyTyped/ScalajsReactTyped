...
import typingsJapgolly.interactjsTypes.anon.FnCallInteractableElementActionScope
import typingsJapgolly.interactjsTypes.anon.InteractableActions
import typingsJapgolly.interactjsTypes.anon.InteractableAllowFrom
...
object autoStartBaseMod extends Shortcut {
  ...
  object interactjsCoreScopeAugmentingMod {
    ...
    object Scope {
      ...
      inline def apply(autoStart: AutoStart): typingsJapgolly.interactjsTypes.autoStartBaseMod.interactjsCoreScopeAugmentingMod.Scope = {
        val __obj = js.Dynamic.literal(autoStart = autoStart.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.interactjsTypes.autoStartBaseMod.interactjsCoreScopeAugmentingMod.Scope]
      }
      
      extension [Self <: typingsJapgolly.interactjsTypes.autoStartBaseMod.interactjsCoreScopeAugmentingMod.Scope](x: Self) {
