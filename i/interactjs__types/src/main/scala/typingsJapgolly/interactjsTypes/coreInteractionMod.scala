...
import typingsJapgolly.interactjsTypes.anon.Corrected
import typingsJapgolly.interactjsTypes.anon.CurEventTarget
import typingsJapgolly.interactjsTypes.anon.Distance
import typingsJapgolly.interactjsTypes.anon.Event
import typingsJapgolly.interactjsTypes.anon.EventTarget
import typingsJapgolly.interactjsTypes.anon.FnCall
import typingsJapgolly.interactjsTypes.anon.IEvent
import typingsJapgolly.interactjsTypes.anon.InteractableActions
import typingsJapgolly.interactjsTypes.anon.InteractableInteractableBackCompatOption
...
import typingsJapgolly.interactjsTypes.anon.Options
import typingsJapgolly.interactjsTypes.anon.Pending
import typingsJapgolly.interactjsTypes.anon.Pointer
...
import typingsJapgolly.interactjsTypes.anon.PointerIndex
import typingsJapgolly.interactjsTypes.anon.ScopeFire
import typingsJapgolly.interactjsTypes.anon.SearchDetails
import typingsJapgolly.interactjsTypes.anon.Target
import typingsJapgolly.interactjsTypes.anon.`0`
import typingsJapgolly.interactjsTypes.anon.`1`
import typingsJapgolly.interactjsTypes.anon.`2`
import typingsJapgolly.interactjsTypes.anon.`3`
import typingsJapgolly.interactjsTypes.anon.`4`
...
import typingsJapgolly.interactjsTypes.interactjsTypesStrings.end
import typingsJapgolly.interactjsTypes.interactjsTypesStrings.gesture
import typingsJapgolly.interactjsTypes.interactjsTypesStrings.iEvent
...
import typingsJapgolly.interactjsTypes.interactjsTypesStrings.reflow
...
object coreInteractionMod {
  ...
  open class Interaction[T /* <: ActionName | Null */] protected () extends StObject {
    ...
    @JSName("_scopeFire")
    def _scopeFire_autoStartprepared(name: autoStartColonprepared, arg: typingsJapgolly.interactjsTypes.anon.Interaction): Unit | `false` = js.native
    @JSName("_scopeFire")
    ...
    @JSName("_scopeFire")
    def _scopeFire_interactionsdestroy(name: interactionsColondestroy, arg: typingsJapgolly.interactjsTypes.anon.Interaction): Unit | `false` = js.native
    @JSName("_scopeFire")
    ...
    @JSName("_scopeFire")
    def _scopeFire_interactionsnew(name: interactionsColonnew, arg: typingsJapgolly.interactjsTypes.anon.Interaction): Unit | `false` = js.native
    @JSName("_scopeFire")
    def _scopeFire_interactionsremovepointer(name: `interactionsColonremove-pointer`, arg: typingsJapgolly.interactjsTypes.anon.PointerArgProps): Unit | `false` = js.native
    @JSName("_scopeFire")
    def _scopeFire_interactionsstop(name: interactionsColonstop, arg: typingsJapgolly.interactjsTypes.anon.Interaction): Unit | `false` = js.native
    @JSName("_scopeFire")
    ...
    def _updateLatestPointer(pointer: PointerType, event: PointerEventType, eventTarget: org.scalajs.dom.Node): Unit = js.native
    ...
    def getPointerInfo(pointer: Any): typingsJapgolly.interactjsTypes.corePointerInfoMod.PointerInfo = js.native
    ...
    var modification: js.UndefOr[typingsJapgolly.interactjsTypes.modifiersModificationMod.default] = js.native
    ...
    def pointerDown(pointer: PointerType, event: PointerEventType, eventTarget: org.scalajs.dom.Node): Unit = js.native
    
    var pointerIsDown: Boolean = js.native
    
    def pointerMove(pointer: PointerType, event: PointerEventType, eventTarget: org.scalajs.dom.Node): Unit = js.native
    ...
    var pointers: js.Array[typingsJapgolly.interactjsTypes.corePointerInfoMod.PointerInfo] = js.native
    
    var prepared: ActionProps[T] = js.native
    
    var prevEvent: InteractEvent[T, EventPhase] = js.native
    
    var prevTap: js.UndefOr[org.scalajs.dom.PointerEvent] = js.native
    ...
    def updatePointer(pointer: PointerType, event: PointerEventType, eventTarget: org.scalajs.dom.Node): Double = js.native
    def updatePointer(pointer: PointerType, event: PointerEventType, eventTarget: org.scalajs.dom.Node, down: Boolean): Double = js.native
  }
  
  @JSImport("@interactjs/core/Interaction", "PointerInfo")
  @js.native
  open class PointerInfo protected ()
    extends typingsJapgolly.interactjsTypes.corePointerInfoMod.PointerInfo {
    def this(
      id: Double,
      pointer: PointerType,
      event: PointerEventType,
      downTime: Double,
      downTarget: org.scalajs.dom.Node
    ) = this()
  }
  ...
  object ProxyValues extends StObject {
    ...
    sealed trait _proxy
      extends StObject
         with ProxyValues
    /* "" */ val _proxy: typingsJapgolly.interactjsTypes.coreInteractionMod.ProxyValues._proxy & String = js.native
    
    @js.native
    sealed trait element
      extends StObject
         with ProxyValues
    /* "" */ val element: typingsJapgolly.interactjsTypes.coreInteractionMod.ProxyValues.element & String = js.native
    
    @js.native
    sealed trait interactable
      extends StObject
         with ProxyValues
    /* "" */ val interactable: typingsJapgolly.interactjsTypes.coreInteractionMod.ProxyValues.interactable & String = js.native
    
    @js.native
    sealed trait pointerIsDown
      extends StObject
         with ProxyValues
    /* "" */ val pointerIsDown: typingsJapgolly.interactjsTypes.coreInteractionMod.ProxyValues.pointerIsDown & String = js.native
    
    @js.native
    sealed trait pointerWasMoved
      extends StObject
         with ProxyValues
    /* "" */ val pointerWasMoved: typingsJapgolly.interactjsTypes.coreInteractionMod.ProxyValues.pointerWasMoved & String = js.native
    
    @js.native
    sealed trait prepared
      extends StObject
         with ProxyValues
    /* "" */ val prepared: typingsJapgolly.interactjsTypes.coreInteractionMod.ProxyValues.prepared & String = js.native
  }
  ...
  object interactjsCoreScopeAugmentingMod {
    ...
    trait SignalArgs extends StObject {
      ...
      var `interactionsColonremove-pointer`: typingsJapgolly.interactjsTypes.anon.PointerArgProps
    ...
    object SignalArgs {
      ...
      inline def apply(
        ...
        `interactionsColonremove-pointer`: typingsJapgolly.interactjsTypes.anon.PointerArgProps,
      ...
      extension [Self <: SignalArgs](x: Self) {
        ...
        inline def `setInteractionsColonremove-pointer`(value: typingsJapgolly.interactjsTypes.anon.PointerArgProps): Self = StObject.set(x, "interactions:remove-pointer", value.asInstanceOf[js.Any])
