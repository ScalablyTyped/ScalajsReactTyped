...
object actionsGesturePluginMod extends Shortcut {
  ...
  object interactjsCoreInteractionAugmentingMod {
    ...
    object Interaction {
      ...
      inline def apply(): typingsJapgolly.interactjsTypes.actionsGesturePluginMod.interactjsCoreInteractionAugmentingMod.Interaction = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.interactjsTypes.actionsGesturePluginMod.interactjsCoreInteractionAugmentingMod.Interaction]
      }
      
      extension [Self <: typingsJapgolly.interactjsTypes.actionsGesturePluginMod.interactjsCoreInteractionAugmentingMod.Interaction](x: Self) {
