...
import typingsJapgolly.ioredis.ioredisStrings.all_
...
object builtClusterUtilMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ioredis.ioredisStrings.master_
    - typingsJapgolly.ioredis.ioredisStrings.slave
    - typingsJapgolly.ioredis.ioredisStrings.all_
  */
  ...
  object NodeRole {
    ...
    inline def slave: typingsJapgolly.ioredis.ioredisStrings.slave = "slave".asInstanceOf[typingsJapgolly.ioredis.ioredisStrings.slave]
  }
