...
object mod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.ioredis.builtRedisMod.default {
  ...
  open class AbstractConnector protected ()
    extends typingsJapgolly.ioredis.builtConnectorsAbstractConnectorMod.default {
  ...
  open class Pipeline protected ()
    extends typingsJapgolly.ioredis.builtPipelineMod.default {
  ...
  open class ScanStream protected ()
    extends typingsJapgolly.ioredis.builtScanStreamMod.default {
  ...
  open class SentinelConnector protected ()
    extends typingsJapgolly.ioredis.builtConnectorsSentinelConnectorMod.default {
  ...
  open class SentinelIterator protected ()
    extends typingsJapgolly.ioredis.builtConnectorsSentinelConnectorSentinelIteratorMod.default {
