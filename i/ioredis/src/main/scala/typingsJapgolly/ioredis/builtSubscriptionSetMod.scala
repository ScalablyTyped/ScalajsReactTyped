...
object builtSubscriptionSetMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ioredis.ioredisStrings.subscribe
    - typingsJapgolly.ioredis.ioredisStrings.psubscribe
  */
  trait AddSet extends StObject
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ioredis.ioredisStrings.unsubscribe
    - typingsJapgolly.ioredis.ioredisStrings.punsubscribe
  */
