...
import typingsJapgolly.ioredis.builtRedisRedisOptionsMod.ReconnectOnError
...
object PartialRedisOptions {
  ...
  extension [Self <: PartialRedisOptions](x: Self) {
    ...
    inline def setReconnectOnError(
      value: /* err */ js.Error => Boolean | typingsJapgolly.ioredis.ioredisInts.`1` | typingsJapgolly.ioredis.ioredisInts.`2`
