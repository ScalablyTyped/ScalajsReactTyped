...
import typingsJapgolly.ioredis.anon.Host
import typingsJapgolly.ioredis.anon.Lua
import typingsJapgolly.ioredis.anon.OmitRedisOptionsporthostp
...
object builtClusterClusterOptionsMod {
  ...
  object ClusterOptions {
    ...
    extension [Self <: ClusterOptions](x: Self) {
      ...
      ): Self = StObject.set(x, "dnsLookup", js.Any.fromFunction2((t0: /* hostname */ String, t1: /* callback */ js.Function3[
              /* err */ js.UndefOr[ErrnoException | Null], 
              /* address */ String, 
              /* family */ js.UndefOr[Double], 
              Unit
      ...
      ): Self = StObject.set(x, "resolveSrv", js.Any.fromFunction2((t0: /* hostname */ String, t1: /* callback */ js.Function2[
              /* err */ js.UndefOr[ErrnoException | Null], 
              /* records */ js.UndefOr[js.Array[SrvRecord]], 
              Unit
            ]) => (value(t0, t1)).runNow()))
