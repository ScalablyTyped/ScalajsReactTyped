...
import typingsJapgolly.ioredis.builtTypesMod.CommandItem
import typingsJapgolly.ioredis.builtTypesMod.NetStream
import typingsJapgolly.ioredis.ioredisBooleans.`false`
...
object builtDataHandlerMod {
  ...
  trait Condition extends StObject {
    ...
    var subscriber: `false` | typingsJapgolly.ioredis.builtSubscriptionSetMod.default
  }
  object Condition {
    ...
    inline def apply(
      auth: String,
      select: Double,
      subscriber: `false` | typingsJapgolly.ioredis.builtSubscriptionSetMod.default
    ): Condition = {
    ...
    extension [Self <: Condition](x: Self) {
      ...
      inline def setSubscriber(value: `false` | typingsJapgolly.ioredis.builtSubscriptionSetMod.default): Self = StObject.set(x, "subscriber", value.asInstanceOf[js.Any])
    }
  }
