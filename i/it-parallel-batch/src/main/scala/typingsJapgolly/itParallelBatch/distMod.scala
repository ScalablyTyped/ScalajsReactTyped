package typingsJapgolly.itParallelBatch

import typingsJapgolly.itParallelBatch.itParallelBatchBooleans.`false`
import typingsJapgolly.itParallelBatch.itParallelBatchBooleans.`true`
