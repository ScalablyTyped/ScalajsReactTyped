...
import typingsJapgolly.infiniteScroll.anon.Body
import typingsJapgolly.infiniteScroll.infiniteScrollBooleans.`false`
import typingsJapgolly.infiniteScroll.infiniteScrollBooleans.`true`
import typingsJapgolly.infiniteScroll.infiniteScrollStrings.append
import typingsJapgolly.infiniteScroll.infiniteScrollStrings.error
import typingsJapgolly.infiniteScroll.infiniteScrollStrings.history
import typingsJapgolly.infiniteScroll.infiniteScrollStrings.last
import typingsJapgolly.infiniteScroll.infiniteScrollStrings.load
import typingsJapgolly.infiniteScroll.infiniteScrollStrings.push
import typingsJapgolly.infiniteScroll.infiniteScrollStrings.replace
import typingsJapgolly.infiniteScroll.infiniteScrollStrings.request
import typingsJapgolly.infiniteScroll.infiniteScrollStrings.scrollThreshold
import typingsJapgolly.infiniteScroll.mod.global.JQuery
import typingsJapgolly.isotopeLayout.mod.Isotope
import typingsJapgolly.packery.mod.Packery
...
object mod {
  ...
  trait EventsMap extends StObject {
    ...
    def append(body: Any, path: String, items: NodeList[Node], response: Response): Unit = js.native
  ...
  trait InfiniteScroll extends StObject {
    ...
    def appendItems(items: NodeList[Node]): Unit = js.native
    /**
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.infiniteScroll.infiniteScrollStrings.loadNextPage
    - typingsJapgolly.infiniteScroll.infiniteScrollStrings.appendItems
    - typingsJapgolly.infiniteScroll.infiniteScrollStrings.getPath
    - typingsJapgolly.infiniteScroll.infiniteScrollStrings.getAbsolutePath
    - typingsJapgolly.infiniteScroll.infiniteScrollStrings.option
    - typingsJapgolly.infiniteScroll.infiniteScrollStrings.destroy
  */
  trait Methods extends StObject
  object Methods {
    
    inline def appendItems: typingsJapgolly.infiniteScroll.infiniteScrollStrings.appendItems = "appendItems".asInstanceOf[typingsJapgolly.infiniteScroll.infiniteScrollStrings.appendItems]
    
    inline def destroy: typingsJapgolly.infiniteScroll.infiniteScrollStrings.destroy = "destroy".asInstanceOf[typingsJapgolly.infiniteScroll.infiniteScrollStrings.destroy]
    
    inline def getAbsolutePath: typingsJapgolly.infiniteScroll.infiniteScrollStrings.getAbsolutePath = "getAbsolutePath".asInstanceOf[typingsJapgolly.infiniteScroll.infiniteScrollStrings.getAbsolutePath]
    
    inline def getPath: typingsJapgolly.infiniteScroll.infiniteScrollStrings.getPath = "getPath".asInstanceOf[typingsJapgolly.infiniteScroll.infiniteScrollStrings.getPath]
    
    inline def loadNextPage: typingsJapgolly.infiniteScroll.infiniteScrollStrings.loadNextPage = "loadNextPage".asInstanceOf[typingsJapgolly.infiniteScroll.infiniteScrollStrings.loadNextPage]
    
    inline def option: typingsJapgolly.infiniteScroll.infiniteScrollStrings.option = "option".asInstanceOf[typingsJapgolly.infiniteScroll.infiniteScrollStrings.option]
  }
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      */
    var outlayer: js.UndefOr[typingsJapgolly.masonryLayout.mod.^ | Isotope | Packery] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setFetchOptionsCallbackTo(value: CallbackTo[RequestInit]): Self = StObject.set(x, "fetchOptions", value.toJsFn)
      ...
      inline def setOutlayer(value: typingsJapgolly.masonryLayout.mod.^ | Isotope | Packery): Self = StObject.set(x, "outlayer", value.asInstanceOf[js.Any])
      ...
      inline def setPathCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "path", value.toJsFn)
  ...
  object global {
    ...
    trait JQuery[TElement] extends StObject {
      ...
      /**
        ...
        */
      @JSName("data")
      def data_infiniteScroll(key: typingsJapgolly.infiniteScroll.infiniteScrollStrings.infiniteScroll): InfiniteScroll = js.native
