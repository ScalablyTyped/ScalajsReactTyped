...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.intlMessageformatParser.mod.ILiteralExpectation
  - typingsJapgolly.intlMessageformatParser.mod.IClassExpectation
  - typingsJapgolly.intlMessageformatParser.mod.IAnyExpectation
  - typingsJapgolly.intlMessageformatParser.mod.IEndExpectation
  - typingsJapgolly.intlMessageformatParser.mod.IOtherExpectation
*/
