package typingsJapgolly.incrementalDom
...
object mod extends js.Object {
  ...
  object patch extends js.Object {
    def apply[T](node: typingsJapgolly.std.DocumentFragment, fn: js.Function1[/* data */ T, Unit]): Node = js.native
    def apply[T](node: typingsJapgolly.std.DocumentFragment, fn: js.Function1[/* data */ T, Unit], data: T): Node = js.native
    def apply[T](node: typingsJapgolly.std.Element, fn: js.Function1[/* data */ T, Unit]): Node = js.native
    def apply[T](node: typingsJapgolly.std.Element, fn: js.Function1[/* data */ T, Unit], data: T): Node = js.native
  }
