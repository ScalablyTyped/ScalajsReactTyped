...
object Common {
  ...
  object PreAutoCloseEvent {
    ...
    inline def apply(cancel: Callback, cause: Event, `type`: outsideInteraction | escape): PreAutoCloseEvent = {
      val __obj = js.Dynamic.literal(cancel = cancel.toJsFn, cause = cause.asInstanceOf[js.Any])
  ...
  object SimpleElementView {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(destroy = destroy.toJsFn, destroyed = destroyed.asInstanceOf[js.Any], el = el.asInstanceOf[js.Any], on = js.Any.fromFunction2((t0: destroy, t1: js.Function0[Unit]) => (on(t0, t1)).runNow()))
