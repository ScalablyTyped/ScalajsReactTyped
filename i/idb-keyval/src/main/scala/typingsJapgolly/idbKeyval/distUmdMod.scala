package typingsJapgolly.idbKeyval

import org.scalajs.dom.IDBRequest
import org.scalajs.dom.IDBTransaction
import typingsJapgolly.idbKeyval.mod.UseStore
...
object distUmdMod {
  ...
  inline def promisifyRequest[T](request: IDBRequest[Any, T]): js.Promise[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("promisifyRequest")(request.asInstanceOf[js.Any]).asInstanceOf[js.Promise[T]]
