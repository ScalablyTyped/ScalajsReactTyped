...
import typingsJapgolly.intlUnofficialDurationUnitFormat.anon.CUSTOM
import typingsJapgolly.intlUnofficialDurationUnitFormat.anon.DAY
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.intlUnofficialDurationUnitFormat.mod.DurationUnitFormatUnit
    - typingsJapgolly.intlUnofficialDurationUnitFormat.intlUnofficialDurationUnitFormatStrings.literal
    - typingsJapgolly.intlUnofficialDurationUnitFormat.intlUnofficialDurationUnitFormatStrings.group
    - typingsJapgolly.intlUnofficialDurationUnitFormat.intlUnofficialDurationUnitFormatStrings.unit
  */
