...
trait QueryConfig extends StObject {
  ...
  var frequency: js.UndefOr[typingsJapgolly.itunesconnectanalytics.mod.frequency] = js.undefined
  
  var group: js.UndefOr[QueryGroup] = js.undefined
  
  var measures: js.UndefOr[
    typingsJapgolly.itunesconnectanalytics.mod.measures | js.Array[typingsJapgolly.itunesconnectanalytics.mod.measures]
  ] = js.undefined
