...
object mod {
  ...
  */
  ...
  object CalendarComponentType {
    ...
    inline def VALARM: typingsJapgolly.ical.icalStrings.VALARM = "VALARM".asInstanceOf[typingsJapgolly.ical.icalStrings.VALARM]
    
    inline def VEVENT: typingsJapgolly.ical.icalStrings.VEVENT = "VEVENT".asInstanceOf[typingsJapgolly.ical.icalStrings.VEVENT]
    
    inline def VFREEBUSY: typingsJapgolly.ical.icalStrings.VFREEBUSY = "VFREEBUSY".asInstanceOf[typingsJapgolly.ical.icalStrings.VFREEBUSY]
    
    inline def VJOURNAL: typingsJapgolly.ical.icalStrings.VJOURNAL = "VJOURNAL".asInstanceOf[typingsJapgolly.ical.icalStrings.VJOURNAL]
    
    inline def VTIMEZONE: typingsJapgolly.ical.icalStrings.VTIMEZONE = "VTIMEZONE".asInstanceOf[typingsJapgolly.ical.icalStrings.VTIMEZONE]
    
    inline def VTODO: typingsJapgolly.ical.icalStrings.VTODO = "VTODO".asInstanceOf[typingsJapgolly.ical.icalStrings.VTODO]
  }
  ...
  */
  ...
  object FreeBusyType {
    ...
    inline def BUSY: typingsJapgolly.ical.icalStrings.BUSY = "BUSY".asInstanceOf[typingsJapgolly.ical.icalStrings.BUSY]
    
    inline def FREE: typingsJapgolly.ical.icalStrings.FREE = "FREE".asInstanceOf[typingsJapgolly.ical.icalStrings.FREE]
  }
