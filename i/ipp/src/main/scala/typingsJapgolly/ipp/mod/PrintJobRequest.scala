...
trait PrintJobRequest extends StObject {
  ...
  var `operation-attributes-tag`: typingsJapgolly.ipp.anon.Compression
}
object PrintJobRequest {
  
  inline def apply(data: Buffer, `operation-attributes-tag`: typingsJapgolly.ipp.anon.Compression): PrintJobRequest = {
  ...
  extension [Self <: PrintJobRequest](x: Self) {
    ...
    inline def `setOperation-attributes-tag`(value: typingsJapgolly.ipp.anon.Compression): Self = StObject.set(x, "operation-attributes-tag", value.asInstanceOf[js.Any])
  }
}
