...
trait OperationAttributes extends StObject {
  ...
  var `requested-attributes`: js.UndefOr[
    js.Array[
      /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 589, starting with typingsJapgolly.ipp.mod.RequestedJobAttributeGroups, typingsJapgolly.ipp.mod.RequestedPrinterAttributeGroups, typingsJapgolly.ipp.ippStrings.`chamber-humidity` */ Any
    ]
  ] = js.undefined
...
object OperationAttributes {
  ...
  extension [Self <: OperationAttributes](x: Self) {
    ...
    inline def `setRequested-attributesVarargs`(
      value: (/* import warning: LimitUnionLength.leaveTypeRef Was union type with length 589, starting with typingsJapgolly.ipp.mod.RequestedJobAttributeGroups, typingsJapgolly.ipp.mod.RequestedPrinterAttributeGroups, typingsJapgolly.ipp.ippStrings.`chamber-humidity` */ Any)*
