...
trait PrinterStatus extends StObject {
  ...
  var `document-format-varying-attributes`: js.UndefOr[
    js.Array[
      /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 87, starting with typingsJapgolly.ipp.ippStrings.`chamber-humidity`, typingsJapgolly.ipp.ippStrings.`chamber-temperature`, typingsJapgolly.ipp.ippStrings.`confirmation-sheet-print` */ Any
    ]
  ] = js.undefined
...
object PrinterStatus {
  ...
  extension [Self <: PrinterStatus](x: Self) {
    ...
    inline def `setDocument-format-varying-attributesVarargs`(
      value: (/* import warning: LimitUnionLength.leaveTypeRef Was union type with length 87, starting with typingsJapgolly.ipp.ippStrings.`chamber-humidity`, typingsJapgolly.ipp.ippStrings.`chamber-temperature`, typingsJapgolly.ipp.ippStrings.`confirmation-sheet-print` */ Any)*
