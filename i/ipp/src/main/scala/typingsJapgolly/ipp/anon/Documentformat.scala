...
trait Documentformat extends StObject {
  ...
  var `requested-attributes`: js.UndefOr[
    js.Array[
      /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 385, starting with typingsJapgolly.ipp.mod.RequestedPrinterAttributeGroups, typingsJapgolly.ipp.ippStrings.`accuracy-units-supported`, typingsJapgolly.ipp.ippStrings.`baling-type-supported` */ Any
    ]
  ] = js.undefined
...
object Documentformat {
  ...
  extension [Self <: Documentformat](x: Self) {
    ...
    inline def `setRequested-attributesVarargs`(
      value: (/* import warning: LimitUnionLength.leaveTypeRef Was union type with length 385, starting with typingsJapgolly.ipp.mod.RequestedPrinterAttributeGroups, typingsJapgolly.ipp.ippStrings.`accuracy-units-supported`, typingsJapgolly.ipp.ippStrings.`baling-type-supported` */ Any)*
