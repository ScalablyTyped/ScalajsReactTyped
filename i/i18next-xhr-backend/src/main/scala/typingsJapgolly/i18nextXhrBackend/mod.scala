package typingsJapgolly.i18nextXhrBackend
...
object mod {
  ...
  object BackendOptions {
    ...
    extension [Self <: BackendOptions](x: Self) {
      ...
      inline def setAjax(
        value: (/* url */ String, BackendOptions, /* callback */ AjaxRequestCallback, /* data */ js.Object | String, /* cache */ Boolean) => Callback
      ): Self = StObject.set(x, "ajax", js.Any.fromFunction5((t0: /* url */ String, t1: BackendOptions, t2: /* callback */ AjaxRequestCallback, t3: /* data */ js.Object | String, t4: /* cache */ Boolean) => (value(t0, t1, t2, t3, t4)).runNow()))
  ...
  trait I18NextXhrBackend
    ...
    @JSName("type")
    var type_I18NextXhrBackend: typingsJapgolly.i18nextXhrBackend.i18nextXhrBackendStrings.backend = js.native
  }
