...
import typingsJapgolly.intlMessageformat.anon.Locale
...
object srcCoreMod {
  ...
  object IntlMessageFormat {
    ...
    inline def resolveLocale(locales: String): js.UndefOr[typingsJapgolly.std.Intl.Locale] = ^.asInstanceOf[js.Dynamic].applyDynamic("resolveLocale")(locales.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typingsJapgolly.std.Intl.Locale]]
    inline def resolveLocale(locales: js.Array[String]): js.UndefOr[typingsJapgolly.std.Intl.Locale] = ^.asInstanceOf[js.Dynamic].applyDynamic("resolveLocale")(locales.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typingsJapgolly.std.Intl.Locale]]
  }
