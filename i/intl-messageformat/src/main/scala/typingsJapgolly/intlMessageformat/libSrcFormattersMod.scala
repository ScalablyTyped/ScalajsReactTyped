...
import typingsJapgolly.intlMessageformat.libSrcFormattersMod.PART_TYPE.`object`
import typingsJapgolly.intlMessageformat.libSrcFormattersMod.PART_TYPE.literal
...
object libSrcFormattersMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.intlMessageformat.libSrcFormattersMod.LiteralPart
    - typingsJapgolly.intlMessageformat.libSrcFormattersMod.ObjectPart[T]
  */
  trait MessageFormatPart[T] extends StObject
  object MessageFormatPart {
    
    inline def LiteralPart(`type`: literal, value: String): typingsJapgolly.intlMessageformat.libSrcFormattersMod.LiteralPart = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.intlMessageformat.libSrcFormattersMod.LiteralPart]
    }
    
    inline def ObjectPart[T](`type`: `object`, value: T): typingsJapgolly.intlMessageformat.libSrcFormattersMod.ObjectPart[T] = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.intlMessageformat.libSrcFormattersMod.ObjectPart[T]]
    }
  }
