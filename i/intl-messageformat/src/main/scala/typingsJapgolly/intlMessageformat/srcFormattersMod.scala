...
import typingsJapgolly.intlMessageformat.anon.TypeofDateTimeFormat
import typingsJapgolly.intlMessageformat.anon.TypeofPluralRules
...
import typingsJapgolly.intlMessageformat.srcFormattersMod.PART_TYPE.`object`
import typingsJapgolly.intlMessageformat.srcFormattersMod.PART_TYPE.literal
...
object srcFormattersMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.intlMessageformat.srcFormattersMod.LiteralPart
    - typingsJapgolly.intlMessageformat.srcFormattersMod.ObjectPart[T]
  */
  trait MessageFormatPart[T] extends StObject
  object MessageFormatPart {
    
    inline def LiteralPart(`type`: literal, value: String): typingsJapgolly.intlMessageformat.srcFormattersMod.LiteralPart = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.intlMessageformat.srcFormattersMod.LiteralPart]
    }
    
    inline def ObjectPart[T](`type`: `object`, value: T): typingsJapgolly.intlMessageformat.srcFormattersMod.ObjectPart[T] = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.intlMessageformat.srcFormattersMod.ObjectPart[T]]
    }
  }
