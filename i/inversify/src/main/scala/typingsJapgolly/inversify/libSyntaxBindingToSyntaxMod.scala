...
import typingsJapgolly.inversify.libInterfacesInterfacesMod.interfaces.BindingInWhenOnSyntax
...
object libSyntaxBindingToSyntaxMod {
  ...
  open class BindingToSyntax[T] protected ()
    extends StObject
       with typingsJapgolly.inversify.libInterfacesInterfacesMod.interfaces.BindingToSyntax[T] {
