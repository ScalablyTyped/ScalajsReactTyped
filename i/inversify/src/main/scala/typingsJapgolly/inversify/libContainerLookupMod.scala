...
object libContainerLookupMod {
  ...
  open class Lookup[T] ()
    extends StObject
       with typingsJapgolly.inversify.libInterfacesInterfacesMod.interfaces.Lookup[T] {
    ...
    /* CompleteClass */
    override def removeIntersection(lookup: typingsJapgolly.inversify.libInterfacesInterfacesMod.interfaces.Lookup[T]): Unit = js.native
