...
import typingsJapgolly.intlifyDevtoolsIf.intlifyDevtoolsIfStrings.functionColontranslate
import typingsJapgolly.intlifyDevtoolsIf.intlifyDevtoolsIfStrings.i18nColoninit
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.intlifyDevtoolsIf.intlifyDevtoolsIfStrings.i18nColoninit
    - typingsJapgolly.intlifyDevtoolsIf.intlifyDevtoolsIfStrings.functionColontranslate
  */
