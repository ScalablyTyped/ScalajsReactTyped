...
import typingsJapgolly.irc.anon.Channel
import typingsJapgolly.irc.anon.Created
import typingsJapgolly.irc.mod.handlers.IJoinChannel
import typingsJapgolly.irc.mod.handlers.IPartChannel
import typingsJapgolly.irc.mod.handlers.IRaw
import typingsJapgolly.irc.mod.handlers.IWhois
...
object mod {
  ...
  object CommandType extends StObject {
    ...
    sealed trait error
      extends StObject
         with CommandType
    /* 2 */ val error: typingsJapgolly.irc.mod.CommandType.error & Double = js.native
    
    @js.native
    sealed trait normal
      extends StObject
         with CommandType
    /* 0 */ val normal: typingsJapgolly.irc.mod.CommandType.normal & Double = js.native
    
    @js.native
    sealed trait reply
      extends StObject
         with CommandType
    /* 1 */ val reply: typingsJapgolly.irc.mod.CommandType.reply & Double = js.native
  }
