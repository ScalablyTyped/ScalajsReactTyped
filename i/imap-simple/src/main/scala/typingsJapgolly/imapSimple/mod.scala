package typingsJapgolly.imapSimple

import japgolly.scalajs.react.Callback
import typingsJapgolly.imap.mod.AppendOptions
import typingsJapgolly.imap.mod.Config
import typingsJapgolly.imap.mod.FetchOptions
import typingsJapgolly.imap.mod.ImapMessageAttributes
import typingsJapgolly.imap.mod.ImapMessageBodyInfo
import typingsJapgolly.imap.mod.MailBoxes
...
object mod {
  ...
  open class ImapSimple protected () extends EventEmitter {
    def this(imap: typingsJapgolly.imap.mod.^) = this()
  ...
  object ImapSimpleOptions {
    ...
    extension [Self <: ImapSimpleOptions](x: Self) {
      ...
      inline def setOnexpunge(value: /* seqno */ Double => Callback): Self = StObject.set(x, "onexpunge", js.Any.fromFunction1((t0: /* seqno */ Double) => value(t0).runNow()))
      
      inline def setOnexpungeUndefined: Self = StObject.set(x, "onexpunge", js.undefined)
      
      inline def setOnmail(value: /* numNewMail */ Double => Callback): Self = StObject.set(x, "onmail", js.Any.fromFunction1((t0: /* numNewMail */ Double) => value(t0).runNow()))
      
      inline def setOnmailUndefined: Self = StObject.set(x, "onmail", js.undefined)
      
      inline def setOnupdate(value: (/* seqno */ Double, /* info */ Any) => Callback): Self = StObject.set(x, "onupdate", js.Any.fromFunction2((t0: /* seqno */ Double, t1: /* info */ Any) => (value(t0, t1)).runNow()))
