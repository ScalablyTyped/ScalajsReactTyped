package typingsJapgolly.imagemapster.mod._Global_

import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.AreaRenderingOptions
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.Deselect
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.Get
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.GetOptions
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.Highlight
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.Keys
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.Options
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.Rebind
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.RenderingOptions
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.Resize
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.Select
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.Set
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.SetOptions
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.Snapshot
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.Tooltip
import typingsJapgolly.imagemapster.mod._Global_.ImageMapster.Unbind
