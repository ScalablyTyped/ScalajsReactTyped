...
object Options {
  ...
  def apply(
    ...
    onClick: /* data */ OnClickData => Callback = null,
    onConfigured: /* success */ Boolean => Callback = null,
    onGetList: /* data */ OnGetListData => CallbackTo[JQuery] = null,
    onMouseout: /* data */ OnMouseData => Callback = null,
    onMouseover: /* data */ OnMouseData => Callback = null,
    onShowToolTip: /* data */ OnShowToolTipData => Callback = null,
    onStateChange: /* data */ OnStateChangeData => Callback = null,
    ...
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction1((t0: /* data */ typingsJapgolly.imagemapster.mod._Global_.ImageMapster.OnClickData) => onClick(t0).runNow()))
    if (onConfigured != null) __obj.updateDynamic("onConfigured")(js.Any.fromFunction1((t0: /* success */ scala.Boolean) => onConfigured(t0).runNow()))
    if (onGetList != null) __obj.updateDynamic("onGetList")(js.Any.fromFunction1((t0: /* data */ typingsJapgolly.imagemapster.mod._Global_.ImageMapster.OnGetListData) => onGetList(t0).runNow()))
    if (onMouseout != null) __obj.updateDynamic("onMouseout")(js.Any.fromFunction1((t0: /* data */ typingsJapgolly.imagemapster.mod._Global_.ImageMapster.OnMouseData) => onMouseout(t0).runNow()))
    if (onMouseover != null) __obj.updateDynamic("onMouseover")(js.Any.fromFunction1((t0: /* data */ typingsJapgolly.imagemapster.mod._Global_.ImageMapster.OnMouseData) => onMouseover(t0).runNow()))
    if (onShowToolTip != null) __obj.updateDynamic("onShowToolTip")(js.Any.fromFunction1((t0: /* data */ typingsJapgolly.imagemapster.mod._Global_.ImageMapster.OnShowToolTipData) => onShowToolTip(t0).runNow()))
    if (onStateChange != null) __obj.updateDynamic("onStateChange")(js.Any.fromFunction1((t0: /* data */ typingsJapgolly.imagemapster.mod._Global_.ImageMapster.OnStateChangeData) => onStateChange(t0).runNow()))
