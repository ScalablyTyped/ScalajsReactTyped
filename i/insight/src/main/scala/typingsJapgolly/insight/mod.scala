package typingsJapgolly.insight

import japgolly.scalajs.react.Callback
import typingsJapgolly.insight.mod.insight.IConfigstore
import typingsJapgolly.insight.mod.insight.IEvent
import typingsJapgolly.insight.mod.insight.IOptions
  ...
  object insight {
    ...
    object IConfigstore {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(all = all.asInstanceOf[js.Any], del = js.Any.fromFunction1((t0: String) => del(t0).runNow()), get = js.Any.fromFunction1(get), path = path.asInstanceOf[js.Any], set = js.Any.fromFunction2((t0: String, t1: Any) => (set(t0, t1)).runNow()))
