...
import typingsJapgolly.immer.distTypesTypesExternalMod.Immutable
...
import typingsJapgolly.immer.distUtilsEnvMod.Nothing
...
object mod {
  ...
  @js.native
  open class Immer ()
    extends typingsJapgolly.immer.distInternalMod.Immer {
