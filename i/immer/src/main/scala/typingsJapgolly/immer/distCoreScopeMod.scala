...
import typingsJapgolly.immer.distInternalMod.Immer
...
object distCoreScopeMod {
  ...
  object ImmerScope {
    ...
    extension [Self <: ImmerScope](x: Self) {
      ...
      inline def setPatchListener_(value: (/* patches */ js.Array[Patch], /* inversePatches */ js.Array[Patch]) => Callback): Self = StObject.set(x, "patchListener_", js.Any.fromFunction2((t0: /* patches */ js.Array[Patch], t1: /* inversePatches */ js.Array[Patch]) => (value(t0, t1)).runNow()))
