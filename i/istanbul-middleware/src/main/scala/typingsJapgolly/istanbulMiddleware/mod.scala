...
import typingsJapgolly.istanbulMiddleware.anon.ResetOnGet
...
object mod {
  ...
  inline def createClientHandler(root: String, opts: typingsJapgolly.istanbulMiddleware.anon.Matcher): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("createClientHandler")(root.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  inline def hookLoader(matcherOrRoot: String, opts: typingsJapgolly.istanbulMiddleware.anon.PostLoadHook): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("hookLoader")(matcherOrRoot.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def hookLoader(matcherOrRoot: Matcher, opts: typingsJapgolly.istanbulMiddleware.anon.PostLoadHook): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("hookLoader")(matcherOrRoot.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Unit]
