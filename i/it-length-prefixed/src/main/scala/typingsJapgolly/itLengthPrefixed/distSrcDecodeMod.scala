package typingsJapgolly.itLengthPrefixed

import japgolly.scalajs.react.Callback
import typingsJapgolly.itLengthPrefixed.mod.LengthDecoderFunction
...
object distSrcDecodeMod {
  ...
  object DecoderOptions {
    ...
    extension [Self <: DecoderOptions](x: Self) {
      ...
      inline def setOnData(value: /* data */ Uint8ArrayList => Callback): Self = StObject.set(x, "onData", js.Any.fromFunction1((t0: /* data */ Uint8ArrayList) => value(t0).runNow()))
      
      inline def setOnDataUndefined: Self = StObject.set(x, "onData", js.undefined)
      
      inline def setOnLength(value: /* length */ Double => Callback): Self = StObject.set(x, "onLength", js.Any.fromFunction1((t0: /* length */ Double) => value(t0).runNow()))
