...
import typingsJapgolly.ipfsGrpcServer.anon.Mtime
...
object distSrcUtilsEncodeMtimeMod {
  ...
  inline def encodeMtime(mtime: typingsJapgolly.ipfsUnixfs.distSrcTypesMod.Mtime): Mtime = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeMtime")(mtime.asInstanceOf[js.Any]).asInstanceOf[Mtime]
}
