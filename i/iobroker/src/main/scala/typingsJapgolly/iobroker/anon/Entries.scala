...
import typingsJapgolly.iobroker.mod.global.ioBroker.ChownFileResult
...
object Entries {
  ...
  extension [Self <: Entries](x: Self) {
    ...
    inline def setEntriesVarargs(value: ChownFileResult*): Self = StObject.set(x, "entries", js.Array(value*))
