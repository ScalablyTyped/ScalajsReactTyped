...
object langinLanguagesstringsmar {
  ...
  inline def apply(): langinLanguagesstringsmar = {
  ...
  extension [Self <: langinLanguagesstringsmar](x: Self) {
    ...
    inline def setByOnNull: Self = StObject.set(x, "byOn", null)
    
    inline def setByOnUndefined: Self = StObject.set(x, "byOn", js.undefined)
    ...
    inline def setSmartType(value: String): Self = StObject.set(x, "smartType", value.asInstanceOf[js.Any])
