...
object AdapterOptions {
  ...
  def apply(
    ...
    message: /* obj */ Message => CallbackTo[Unit | js.Promise[Unit]] = null,
    noNamespace: js.UndefOr[Boolean] = js.undefined,
    objectChange: (/* id */ String, /* obj */ js.UndefOr[Object | Null]) => CallbackTo[Unit | js.Promise[Unit]] = null,
    objects: js.UndefOr[Boolean] = js.undefined,
    ready: js.UndefOr[CallbackTo[Unit | js.Promise[Unit]]] = js.undefined,
    stateChange: (/* id */ String, /* obj */ js.UndefOr[State | Null]) => CallbackTo[Unit | js.Promise[Unit]] = null,
    states: js.UndefOr[Boolean] = js.undefined,
    systemConfig: js.UndefOr[Boolean] = js.undefined,
    unload: /* callback */ EmptyCallback => CallbackTo[Unit | js.Promise[Unit]] = null,
    ...
    if (message != null) __obj.updateDynamic("message")(js.Any.fromFunction1((t0: /* obj */ typingsJapgolly.iobroker.mod._Global_.ioBroker.Message) => message(t0).runNow()))
    if (!js.isUndefined(noNamespace)) __obj.updateDynamic("noNamespace")(noNamespace.asInstanceOf[js.Any])
    if (objectChange != null) __obj.updateDynamic("objectChange")(js.Any.fromFunction2((t0: /* id */ java.lang.String, t1: /* obj */ js.UndefOr[typingsJapgolly.iobroker.mod._Global_.ioBroker.Object | scala.Null]) => objectChange(t0, t1).runNow()))
    ...
    if (stateChange != null) __obj.updateDynamic("stateChange")(js.Any.fromFunction2((t0: /* id */ java.lang.String, t1: /* obj */ js.UndefOr[typingsJapgolly.iobroker.mod._Global_.ioBroker.State | scala.Null]) => stateChange(t0, t1).runNow()))
    ...
    if (unload != null) __obj.updateDynamic("unload")(js.Any.fromFunction1((t0: /* callback */ typingsJapgolly.iobroker.mod._Global_.ioBroker.EmptyCallback) => unload(t0).runNow()))
