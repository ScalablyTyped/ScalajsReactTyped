...
object AdapterOptions {
  ...
  extension [Self <: AdapterOptions](x: Self) {
    ...
    inline def setReady(value: CallbackTo[Unit | js.Promise[Unit]]): Self = StObject.set(x, "ready", value.toJsFn)
    ...
    inline def setUnloadCallbackTo(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "unload", value.toJsFn)
    
    inline def setUnloadFunction1(value: /* callback */ EmptyCallback => Callback): Self = StObject.set(x, "unload", js.Any.fromFunction1((t0: /* callback */ EmptyCallback) => value(t0).runNow()))
