...
trait Interval extends StObject {
  ...
  var __ioBrokerBrand: typingsJapgolly.iobroker.iobrokerStrings.Interval
}
object Interval {
  ...
  extension [Self <: Interval](x: Self) {
    ...
    inline def set__ioBrokerBrand(value: typingsJapgolly.iobroker.iobrokerStrings.Interval): Self = StObject.set(x, "__ioBrokerBrand", value.asInstanceOf[js.Any])
  }
}
