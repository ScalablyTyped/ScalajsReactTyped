...
import typingsJapgolly.iobroker.anon.PartialInstanceCommon
...
object PartialInstanceObject {
  ...
  inline def apply(): PartialInstanceObject = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialInstanceObject]
  }
  
  extension [Self <: PartialInstanceObject](x: Self) {
    
    inline def setAcl(value: ObjectACL): Self = StObject.set(x, "acl", value.asInstanceOf[js.Any])
    
    inline def setAclUndefined: Self = StObject.set(x, "acl", js.undefined)
    
    inline def setCommon(value: PartialInstanceCommon): Self = StObject.set(x, "common", value.asInstanceOf[js.Any])
