...
import typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.`unixfs-dir`
import typingsJapgolly.ipldDagPb.mod.PBLink
import typingsJapgolly.ipldDagPb.mod.PBNode
...
object distSrcObjectMod {
  ...
  trait API[OptionExtension] extends StObject {
    ...
    var patch: typingsJapgolly.ipfsCoreTypes.distSrcObjectPatchMod.API[js.Object] = js.native
