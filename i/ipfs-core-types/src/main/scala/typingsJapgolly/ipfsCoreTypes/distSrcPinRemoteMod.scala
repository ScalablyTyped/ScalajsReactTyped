...
object distSrcPinRemoteMod {
  ...
  trait API[OptionExtension] extends StObject {
    ...
    /**
      ...
      */
    var service: typingsJapgolly.ipfsCoreTypes.distSrcPinRemoteServiceMod.API[js.Object]
  }
  object API {
    ...
    inline def apply[OptionExtension](
      ...
      service: typingsJapgolly.ipfsCoreTypes.distSrcPinRemoteServiceMod.API[js.Object]
    ): API[OptionExtension] = {
    ...
    extension [Self <: API[?], OptionExtension](x: Self & API[OptionExtension]) {
      ...
      inline def setService(value: typingsJapgolly.ipfsCoreTypes.distSrcPinRemoteServiceMod.API[js.Object]): Self = StObject.set(x, "service", value.asInstanceOf[js.Any])
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.queued
    - typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.pinning
    - typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.pinned
    - typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.failed
  */
  trait Status extends StObject
  object Status {
    
    inline def failed: typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.failed = "failed".asInstanceOf[typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.failed]
    
    inline def pinned: typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.pinned = "pinned".asInstanceOf[typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.pinned]
    
    inline def pinning: typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.pinning = "pinning".asInstanceOf[typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.pinning]
    
    inline def queued: typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.queued = "queued".asInstanceOf[typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.queued]
  }
}
