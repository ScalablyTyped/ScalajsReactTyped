...
object distSrcPinMod {
  ...
  trait API[OptionExtension] extends StObject {
    ...
    var remote: typingsJapgolly.ipfsCoreTypes.distSrcPinRemoteMod.API[OptionExtension] = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.recursive
    - typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.direct
    - typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.indirect
    - typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.all
  */
  trait PinQueryType extends StObject
  object PinQueryType {
    
    inline def all: typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.all = "all".asInstanceOf[typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.all]
    
    inline def direct: typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.direct = "direct".asInstanceOf[typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.direct]
    
    inline def indirect: typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.indirect = "indirect".asInstanceOf[typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.indirect]
    
    inline def recursive: typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.recursive = "recursive".asInstanceOf[typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.recursive]
  }
