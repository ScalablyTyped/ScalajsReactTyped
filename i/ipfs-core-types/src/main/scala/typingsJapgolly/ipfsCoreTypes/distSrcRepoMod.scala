...
object distSrcRepoMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ipfsCoreTypes.distSrcRepoMod.GCSuccess
    - typingsJapgolly.ipfsCoreTypes.distSrcRepoMod.GCError
  */
  trait GCResult extends StObject
  object GCResult {
    
    inline def GCError(err: js.Error): typingsJapgolly.ipfsCoreTypes.distSrcRepoMod.GCError = {
      val __obj = js.Dynamic.literal(err = err.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ipfsCoreTypes.distSrcRepoMod.GCError]
    }
    
    inline def GCSuccess(cid: CID[Any, Double, Double, Version]): typingsJapgolly.ipfsCoreTypes.distSrcRepoMod.GCSuccess = {
      val __obj = js.Dynamic.literal(cid = cid.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ipfsCoreTypes.distSrcRepoMod.GCSuccess]
    }
  }
