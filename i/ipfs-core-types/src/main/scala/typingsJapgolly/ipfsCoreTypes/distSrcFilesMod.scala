...
import typingsJapgolly.ipfsCoreTypes.distSrcRootMod.AddProgressFn
import typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.AbortOptions
import typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.IPFSPath
import typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.balanced
import typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.directory
import typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.file
import typingsJapgolly.ipfsCoreTypes.ipfsCoreTypesStrings.trickle
import typingsJapgolly.ipfsUnixfs.mod.Mtime
import typingsJapgolly.ipfsUnixfs.mod.MtimeLike
...
object distSrcFilesMod {
  ...
  object WriteOptions {
    ...
    extension [Self <: WriteOptions](x: Self) {
      ...
      inline def setProgress(value: (/* bytes */ Double, /* path */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "progress", js.Any.fromFunction2((t0: /* bytes */ Double, t1: /* path */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
