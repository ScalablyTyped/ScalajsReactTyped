...
object distSrcUtilsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.FileEntry[Content]
    - typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.DirectoryEntry
  */
  trait Entry[Content /* <: AsyncIterable[js.typedarray.Uint8Array] | Blob */] extends StObject
  object Entry {
    
    inline def DirectoryEntry(content: Unit, path: String): typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.DirectoryEntry = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.DirectoryEntry]
    }
    
    inline def FileEntry[Content /* <: AsyncIterable[js.typedarray.Uint8Array] | Blob */](path: String): typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.FileEntry[Content] = {
      val __obj = js.Dynamic.literal(path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.FileEntry[Content]]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.ToFile
    - typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.ToDirectory
    - typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.ToContent
  */
  ...
  object _ImportCandidate {
    ...
    inline def ToDirectory(content: Unit, path: String): typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.ToDirectory = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.ToDirectory]
    }
    
    inline def ToFile(content: ToContent): typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.ToFile = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ipfsCoreTypes.distSrcUtilsMod.ToFile]
    }
  }
}
