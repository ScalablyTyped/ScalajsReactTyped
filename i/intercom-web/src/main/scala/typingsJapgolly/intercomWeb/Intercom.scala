...
import typingsJapgolly.intercomWeb.intercomWebStrings.avatar
...
object Intercom {
  ...
  /* keyof intercom-web.Intercom_.IntercomCommandSignature */ /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.intercomWeb.intercomWebStrings.startTour
    - typingsJapgolly.intercomWeb.intercomWebStrings.showArticle
    - typingsJapgolly.intercomWeb.intercomWebStrings.startSurvey
  */
