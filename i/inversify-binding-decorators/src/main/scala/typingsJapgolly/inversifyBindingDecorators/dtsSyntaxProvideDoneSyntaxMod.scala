...
import typingsJapgolly.inversifyBindingDecorators.dtsInterfacesInterfacesMod.interfaces.BindConstraint
...
object dtsSyntaxProvideDoneSyntaxMod {
  ...
  trait ProvideDoneSyntax
    extends StObject
       with typingsJapgolly.inversifyBindingDecorators.dtsInterfacesInterfacesMod.interfaces.ProvideDoneSyntax {
