package typingsJapgolly.ifvisible
...
object mod extends Shortcut {
  ...
  object OnEveryReturn {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(callback = callback.toJsFn, code = code.asInstanceOf[js.Any], pause = pause.toJsFn, resume = resume.toJsFn, stop = stop.toJsFn)
