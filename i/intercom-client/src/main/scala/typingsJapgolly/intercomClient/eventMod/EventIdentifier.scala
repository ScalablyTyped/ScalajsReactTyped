package typingsJapgolly.intercomClient.eventMod
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.intercomClient.eventMod.IntercomUserIdId
  - typingsJapgolly.intercomClient.eventMod.UserIdId
  - typingsJapgolly.intercomClient.eventMod.EmailIdId
*/
