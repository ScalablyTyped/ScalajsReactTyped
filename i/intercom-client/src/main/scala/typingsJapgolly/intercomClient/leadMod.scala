...
object leadMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.intercomClient.leadMod.LeadIdIdentifier
    - typingsJapgolly.intercomClient.anon.Userid
  */
  trait LeadIdentifier extends StObject
  object LeadIdentifier {
    
    inline def LeadIdIdentifier(id: String): typingsJapgolly.intercomClient.leadMod.LeadIdIdentifier = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.intercomClient.leadMod.LeadIdIdentifier]
    }
  ...
  object List {
    ...
    inline def apply(contacts: js.Array[Lead], pages: Next, total_count: Double): typingsJapgolly.intercomClient.leadMod.List = {
      ...
      __obj.asInstanceOf[typingsJapgolly.intercomClient.leadMod.List]
    }
    
    extension [Self <: typingsJapgolly.intercomClient.leadMod.List](x: Self) {
