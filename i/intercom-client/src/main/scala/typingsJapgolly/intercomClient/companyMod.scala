...
import typingsJapgolly.intercomClient.anon.Id
...
object companyMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.intercomClient.anon.Companyid
  */
  trait CompanyIdentifier extends StObject
  object CompanyIdentifier {
    
    inline def Companyid(company_id: String): typingsJapgolly.intercomClient.anon.Companyid = {
      val __obj = js.Dynamic.literal(company_id = company_id.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.intercomClient.anon.Companyid]
    }
  ...
  object List {
    ...
    inline def apply(companies: js.Array[Company & CompanyIdentifier], pages: Next, total_count: Double): typingsJapgolly.intercomClient.companyMod.List = {
      ...
      __obj.asInstanceOf[typingsJapgolly.intercomClient.companyMod.List]
    }
    
    extension [Self <: typingsJapgolly.intercomClient.companyMod.List](x: Self) {
