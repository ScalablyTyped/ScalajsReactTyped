...
import typingsJapgolly.intercomClient.anon.Perpage
import typingsJapgolly.intercomClient.intercomClientStrings.eventDotlist
...
object eventMod {
  ...
  */
  ...
  object EventIdentifier {
    ...
    inline def EmailIdId(email: String): typingsJapgolly.intercomClient.eventMod.EmailIdId = {
      val __obj = js.Dynamic.literal(email = email.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.intercomClient.eventMod.EmailIdId]
    }
    
    inline def IntercomUserIdId(intercom_user_id: String): typingsJapgolly.intercomClient.eventMod.IntercomUserIdId = {
      val __obj = js.Dynamic.literal(intercom_user_id = intercom_user_id.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.intercomClient.eventMod.IntercomUserIdId]
    }
    
    inline def UserIdId(user_id: String): typingsJapgolly.intercomClient.eventMod.UserIdId = {
      val __obj = js.Dynamic.literal(user_id = user_id.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.intercomClient.eventMod.UserIdId]
    }
  }
  ...
  object List {
    ...
    inline def apply(events: js.Array[Event], pages: Next, total_count: Double): typingsJapgolly.intercomClient.eventMod.List = {
      ...
      __obj.asInstanceOf[typingsJapgolly.intercomClient.eventMod.List]
    }
    
    extension [Self <: typingsJapgolly.intercomClient.eventMod.List](x: Self) {
