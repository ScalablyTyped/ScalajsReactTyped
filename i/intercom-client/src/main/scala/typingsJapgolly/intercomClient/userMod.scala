...
import typingsJapgolly.intercomClient.anon.Companies
import typingsJapgolly.intercomClient.anon.Next
import typingsJapgolly.intercomClient.anon.PartialCompanyremoveboole
import typingsJapgolly.intercomClient.anon.Segments
import typingsJapgolly.intercomClient.anon.Socialprofiles
import typingsJapgolly.intercomClient.anon.Tags
import typingsJapgolly.intercomClient.intercomClientStrings.Twitter
import typingsJapgolly.intercomClient.intercomClientStrings.avatar
import typingsJapgolly.intercomClient.intercomClientStrings.contact
...
object userMod {
  ...
  object List {
    ...
    inline def apply(pages: Next, total_count: Double, users: js.Array[User]): typingsJapgolly.intercomClient.userMod.List = {
      ...
      __obj.asInstanceOf[typingsJapgolly.intercomClient.userMod.List]
    }
    
    extension [Self <: typingsJapgolly.intercomClient.userMod.List](x: Self) {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.intercomClient.userMod.UserIdIdentifier
    - typingsJapgolly.intercomClient.userMod.UserEmailIdentifier
  */
  ...
  object UserIdentifier {
    ...
    inline def UserEmailIdentifier(email: String): typingsJapgolly.intercomClient.userMod.UserEmailIdentifier = {
      val __obj = js.Dynamic.literal(email = email.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.intercomClient.userMod.UserEmailIdentifier]
    }
