...
import typingsJapgolly.ionRangeslider.mod.global.JQuery
...
object mod {
  ...
  object IonRangeSliderOptions {
    ...
    extension [Self <: IonRangeSliderOptions](x: Self) {
      ...
      inline def setOnChange(value: /* obj */ IonRangeSliderEvent => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* obj */ IonRangeSliderEvent) => value(t0).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnFinish(value: /* obj */ IonRangeSliderEvent => Callback): Self = StObject.set(x, "onFinish", js.Any.fromFunction1((t0: /* obj */ IonRangeSliderEvent) => value(t0).runNow()))
      
      inline def setOnFinishUndefined: Self = StObject.set(x, "onFinish", js.undefined)
      
      inline def setOnStart(value: /* obj */ IonRangeSliderEvent => Callback): Self = StObject.set(x, "onStart", js.Any.fromFunction1((t0: /* obj */ IonRangeSliderEvent) => value(t0).runNow()))
      
      inline def setOnStartUndefined: Self = StObject.set(x, "onStart", js.undefined)
      
      inline def setOnUpdate(value: /* obj */ IonRangeSliderEvent => Callback): Self = StObject.set(x, "onUpdate", js.Any.fromFunction1((t0: /* obj */ IonRangeSliderEvent) => value(t0).runNow()))
