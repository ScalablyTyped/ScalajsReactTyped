...
import typingsJapgolly.immutabilityHelper.anon.NoInferenceCustomCommandsBrand
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.immutabilityHelper.anon.Push[T]
    - typingsJapgolly.immutabilityHelper.anon.Unshift[T]
    - typingsJapgolly.immutabilityHelper.anon.Splice[T]
    - org.scalablytyped.runtime.StringDictionary[typingsJapgolly.immutabilityHelper.mod.Spec[T, C]]
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.immutabilityHelper.anon.Add[K, V]
    - typingsJapgolly.immutabilityHelper.anon.Remove[K]
    - org.scalablytyped.runtime.StringDictionary[typingsJapgolly.immutabilityHelper.mod.Spec[V, C]]
  */
  type MapSpec[K, V, C /* <: CustomCommands[js.Object] */] = (_MapSpec[K, V, C]) | (StringDictionary[Spec[V, C]])
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.immutabilityHelper.anon.Toggle[T]
    - typingsJapgolly.immutabilityHelper.anon.Unset[T]
    - typingsJapgolly.immutabilityHelper.anon.Merge[T]
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.immutabilityHelper.anon.AddReadonlyArray[T]
    - typingsJapgolly.immutabilityHelper.anon.RemoveReadonlyArray[T]
  */
  trait SetSpec[T] extends StObject
  object SetSpec {
    
    inline def AddReadonlyArray[T]($add: js.Array[T]): typingsJapgolly.immutabilityHelper.anon.AddReadonlyArray[T] = {
      val __obj = js.Dynamic.literal($add = $add.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.immutabilityHelper.anon.AddReadonlyArray[T]]
    }
    
    inline def RemoveReadonlyArray[T]($remove: js.Array[T]): typingsJapgolly.immutabilityHelper.anon.RemoveReadonlyArray[T] = {
      val __obj = js.Dynamic.literal($remove = $remove.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.immutabilityHelper.anon.RemoveReadonlyArray[T]]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.immutabilityHelper.anon.Set[T]
    - typingsJapgolly.immutabilityHelper.anon.Apply[T]
    - js.Function1[/ * v * / T, T]
  */
  ...
  object _ArraySpec {
    ...
    inline def Push[T]($push: js.Array[T]): typingsJapgolly.immutabilityHelper.anon.Push[T] = {
      val __obj = js.Dynamic.literal($push = $push.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.immutabilityHelper.anon.Push[T]]
    }
    
    inline def Splice[T]($splice: js.Array[(js.Tuple2[Double, js.UndefOr[Double]]) | (Array[Double | T])]): typingsJapgolly.immutabilityHelper.anon.Splice[T] = {
      val __obj = js.Dynamic.literal($splice = $splice.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.immutabilityHelper.anon.Splice[T]]
    }
    
    inline def Unshift[T]($unshift: js.Array[T]): typingsJapgolly.immutabilityHelper.anon.Unshift[T] = {
      val __obj = js.Dynamic.literal($unshift = $unshift.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.immutabilityHelper.anon.Unshift[T]]
    }
  }
  ...
  object _MapSpec {
    ...
    inline def Add[K, V]($add: js.Array[js.Tuple2[K, V]]): typingsJapgolly.immutabilityHelper.anon.Add[K, V] = {
      val __obj = js.Dynamic.literal($add = $add.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.immutabilityHelper.anon.Add[K, V]]
    }
    
    inline def Remove[K]($remove: js.Array[K]): typingsJapgolly.immutabilityHelper.anon.Remove[K] = {
      val __obj = js.Dynamic.literal($remove = $remove.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.immutabilityHelper.anon.Remove[K]]
    }
  }
  ...
  object _ObjectSpec {
    ...
    inline def Merge[T]($merge: Partial[T]): typingsJapgolly.immutabilityHelper.anon.Merge[T] = {
      val __obj = js.Dynamic.literal($merge = $merge.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.immutabilityHelper.anon.Merge[T]]
    }
    
    inline def Toggle[T]($toggle: js.Array[/* keyof T */ String]): typingsJapgolly.immutabilityHelper.anon.Toggle[T] = {
      val __obj = js.Dynamic.literal($toggle = $toggle.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.immutabilityHelper.anon.Toggle[T]]
    }
    
    inline def Unset[T]($unset: js.Array[/* keyof T */ String]): typingsJapgolly.immutabilityHelper.anon.Unset[T] = {
      val __obj = js.Dynamic.literal($unset = $unset.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.immutabilityHelper.anon.Unset[T]]
    }
  }
  ...
  object _Spec {
    ...
    inline def Apply[T]($apply: T => T): typingsJapgolly.immutabilityHelper.anon.Apply[T] = {
      val __obj = js.Dynamic.literal($apply = js.Any.fromFunction1($apply))
      __obj.asInstanceOf[typingsJapgolly.immutabilityHelper.anon.Apply[T]]
    }
    
    inline def Set[T]($set: T): typingsJapgolly.immutabilityHelper.anon.Set[T] = {
      val __obj = js.Dynamic.literal($set = $set.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.immutabilityHelper.anon.Set[T]]
    }
  }
}
