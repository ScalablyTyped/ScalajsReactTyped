...
object mod {
  ...
  inline def statSafe(p: String): js.Promise[js.UndefOr[typingsJapgolly.fsExtra.mod.Stats]] = ^.asInstanceOf[js.Dynamic].applyDynamic("statSafe")(p.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.UndefOr[typingsJapgolly.fsExtra.mod.Stats]]]
  ...
  */
  ...
  object FileNode {
    ...
    inline def DirectoryNode(children: js.Array[FileNode], path: String): typingsJapgolly.ionicUtilsFs.mod.DirectoryNode = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("directory")
      __obj.asInstanceOf[typingsJapgolly.ionicUtilsFs.mod.DirectoryNode]
    }
    
    inline def RegularFileNode(parent: FileNode, path: String): typingsJapgolly.ionicUtilsFs.mod.RegularFileNode = {
      ...
      __obj.asInstanceOf[typingsJapgolly.ionicUtilsFs.mod.RegularFileNode]
    }
  }
  ...
  */
  ...
  object WalkerItem {
    ...
    inline def apply(path: String, stats: typingsJapgolly.fsExtra.mod.Stats): WalkerItem = {
    ...
    extension [Self <: WalkerItem](x: Self) {
      ...
      inline def setStats(value: typingsJapgolly.fsExtra.mod.Stats): Self = StObject.set(x, "stats", value.asInstanceOf[js.Any])
    }
  }
