...
object WalkerOptions {
  @scala.inline
  def apply(pathFilter: /* p */ String => CallbackTo[Boolean] = null): WalkerOptions = {
    val __obj = js.Dynamic.literal()
    if (pathFilter != null) __obj.updateDynamic("pathFilter")(js.Any.fromFunction1((t0: /* p */ java.lang.String) => pathFilter(t0).runNow()))
