...
import typingsJapgolly.ionicUtilsFs.ionicUtilsFsStrings.buffer
...
object promises extends js.Object {
  ...
  /**
    ...
    */
  def readdir(path: PathLike, options: Anon5): js.Promise[js.Array[typingsJapgolly.node.fsMod.Dirent]] = js.native
