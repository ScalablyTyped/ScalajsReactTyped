...
object mod {
  ...
  open class AnimationQueues ()
    extends typingsJapgolly.inferno.distDomUtilsCommonMod.AnimationQueues
  
  @JSImport("inferno", "Component")
  @js.native
  open class Component[P, S] ()
    extends typingsJapgolly.inferno.distCoreComponentMod.Component[P, S] {
  ...
  inline def _M(
    ...
    nextNode: Element,
    lifecycle: js.Array[js.Function],
    animations: typingsJapgolly.inferno.distDomUtilsCommonMod.AnimationQueues
