...
object DialogHTMLAttributes {
  ...
  extension [Self <: DialogHTMLAttributes[?], T](x: Self & DialogHTMLAttributes[T]) {
    ...
    inline def setOnCancelFunction1(value: SemiSyntheticEvent[T] => Callback): Self = StObject.set(x, "onCancel", js.Any.fromFunction1((t0: SemiSyntheticEvent[T]) => value(t0).runNow()))
    ...
    inline def setOnCloseFunction1(value: SemiSyntheticEvent[T] => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: SemiSyntheticEvent[T]) => value(t0).runNow()))
