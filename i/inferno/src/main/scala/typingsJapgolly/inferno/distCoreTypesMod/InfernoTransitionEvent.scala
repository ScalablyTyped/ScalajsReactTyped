...
- typingsJapgolly.std.TransitionEvent because var conflicts: cancelBubble, currentTarget, returnValue. Inlined pseudoElement, propertyName, elapsedTime */ @js.native
