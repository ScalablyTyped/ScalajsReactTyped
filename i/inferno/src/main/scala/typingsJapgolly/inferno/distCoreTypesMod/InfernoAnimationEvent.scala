...
- typingsJapgolly.std.AnimationEvent because var conflicts: cancelBubble, currentTarget, returnValue. Inlined pseudoElement, animationName, elapsedTime */ @js.native
