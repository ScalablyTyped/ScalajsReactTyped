...
import typingsJapgolly.inferno.infernoStrings.button
import typingsJapgolly.inferno.infernoStrings.reset
import typingsJapgolly.inferno.infernoStrings.submit
