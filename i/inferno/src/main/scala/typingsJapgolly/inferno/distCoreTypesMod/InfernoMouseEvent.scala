...
- typingsJapgolly.std.MouseEvent because var conflicts: cancelBubble, currentTarget, returnValue. Inlined x, metaKey, shiftKey, screenY, y, altKey, offsetX, clientY, pageY, screenX, ctrlKey, movementY, movementX, buttons, button, offsetY, pageX, clientX, relatedTarget, getModifierState, initMouseEvent, initMouseEvent */ @js.native
