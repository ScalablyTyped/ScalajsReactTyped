...
import typingsJapgolly.ionicCliFrameworkOutput.anon.PartialLoggerOptions
import typingsJapgolly.ionicCliFrameworkOutput.anon.PartialStreamHandlerOptio
...
object distLoggerMod {
  ...
  object CreateTaggedFormatterOptions {
    ...
    extension [Self <: CreateTaggedFormatterOptions](x: Self) {
      ...
      inline def setPrefixCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "prefix", value.toJsFn)
  ...
  object LoggerHandler {
    ...
    inline def apply(handle: LogRecord => Callback): LoggerHandler = {
      val __obj = js.Dynamic.literal(handle = js.Any.fromFunction1((t0: LogRecord) => handle(t0).runNow()))
    ...
    extension [Self <: LoggerHandler](x: Self) {
      ...
      inline def setHandle(value: LogRecord => Callback): Self = StObject.set(x, "handle", js.Any.fromFunction1((t0: LogRecord) => value(t0).runNow()))
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ionicCliFrameworkOutput.ionicCliFrameworkOutputStrings.DEBUG
    - typingsJapgolly.ionicCliFrameworkOutput.ionicCliFrameworkOutputStrings.INFO
    - typingsJapgolly.ionicCliFrameworkOutput.ionicCliFrameworkOutputStrings.WARN
    - typingsJapgolly.ionicCliFrameworkOutput.ionicCliFrameworkOutputStrings.ERROR
  */
  trait LoggerLevel extends StObject
  object LoggerLevel {
    
    inline def DEBUG: typingsJapgolly.ionicCliFrameworkOutput.ionicCliFrameworkOutputStrings.DEBUG = "DEBUG".asInstanceOf[typingsJapgolly.ionicCliFrameworkOutput.ionicCliFrameworkOutputStrings.DEBUG]
    
    inline def ERROR: typingsJapgolly.ionicCliFrameworkOutput.ionicCliFrameworkOutputStrings.ERROR = "ERROR".asInstanceOf[typingsJapgolly.ionicCliFrameworkOutput.ionicCliFrameworkOutputStrings.ERROR]
    
    inline def INFO: typingsJapgolly.ionicCliFrameworkOutput.ionicCliFrameworkOutputStrings.INFO = "INFO".asInstanceOf[typingsJapgolly.ionicCliFrameworkOutput.ionicCliFrameworkOutputStrings.INFO]
    
    inline def WARN: typingsJapgolly.ionicCliFrameworkOutput.ionicCliFrameworkOutputStrings.WARN = "WARN".asInstanceOf[typingsJapgolly.ionicCliFrameworkOutput.ionicCliFrameworkOutputStrings.WARN]
  }
