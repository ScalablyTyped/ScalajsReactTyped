...
import typingsJapgolly.images.anon.Height
import typingsJapgolly.images.imagesInts.`0`
import typingsJapgolly.images.imagesInts.`1`
import typingsJapgolly.images.imagesInts.`2`
import typingsJapgolly.images.imagesInts.`3`
import typingsJapgolly.images.imagesInts.`4`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.images.imagesStrings.png
    - typingsJapgolly.images.imagesStrings.jpg
    - typingsJapgolly.images.imagesStrings.jpeg
    - typingsJapgolly.images.imagesStrings.gif
    - typingsJapgolly.images.imagesStrings.bmp
    - typingsJapgolly.images.imagesStrings.raw
  */
  trait FILE_TYPE extends StObject
  object FILE_TYPE {
    
    inline def bmp: typingsJapgolly.images.imagesStrings.bmp = "bmp".asInstanceOf[typingsJapgolly.images.imagesStrings.bmp]
    
    inline def gif: typingsJapgolly.images.imagesStrings.gif = "gif".asInstanceOf[typingsJapgolly.images.imagesStrings.gif]
    
    inline def jpeg: typingsJapgolly.images.imagesStrings.jpeg = "jpeg".asInstanceOf[typingsJapgolly.images.imagesStrings.jpeg]
    
    inline def jpg: typingsJapgolly.images.imagesStrings.jpg = "jpg".asInstanceOf[typingsJapgolly.images.imagesStrings.jpg]
    
    inline def png: typingsJapgolly.images.imagesStrings.png = "png".asInstanceOf[typingsJapgolly.images.imagesStrings.png]
    
    inline def raw: typingsJapgolly.images.imagesStrings.raw = "raw".asInstanceOf[typingsJapgolly.images.imagesStrings.raw]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.images.imagesInts.`1`
    - typingsJapgolly.images.imagesInts.`0`
    - typingsJapgolly.images.imagesInts.`2`
    - typingsJapgolly.images.imagesInts.`3`
    - typingsJapgolly.images.imagesInts.`4`
  */
