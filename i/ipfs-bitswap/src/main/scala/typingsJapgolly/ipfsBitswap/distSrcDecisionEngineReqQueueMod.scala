...
import typingsJapgolly.ipfsBitswap.distSrcUtilsSortedMapMod.SortedMap
...
object distSrcDecisionEngineReqQueueMod {
  ...
  open class RequestQueue () extends StObject {
    def this(taskMerger: typingsJapgolly.ipfsBitswap.distSrcDecisionEngineTypesMod.TaskMerger) = this()
    ...
    var _taskMerger: typingsJapgolly.ipfsBitswap.distSrcDecisionEngineTypesMod.TaskMerger = js.native
  ...
  trait PeerTasks extends StObject {
    ...
    var _taskMerger: typingsJapgolly.ipfsBitswap.distSrcDecisionEngineTypesMod.TaskMerger
    ...
    var peerId: typingsJapgolly.libp2pInterfacePeerId.mod.PeerId
  ...
  object PeerTasks {
    ...
    inline def apply(
      ...
      _taskMerger: typingsJapgolly.ipfsBitswap.distSrcDecisionEngineTypesMod.TaskMerger,
      isIdle: CallbackTo[Boolean],
      peerId: typingsJapgolly.libp2pInterfacePeerId.mod.PeerId,
      popTasks: Double => PopTaskResult,
      pushTasks: js.Array[Task] => Callback,
      remove: String => Callback,
      taskDone: Task => Callback
    ): PeerTasks = {
      val __obj = js.Dynamic.literal(_active = _active.asInstanceOf[js.Any], _activeTotalSize = _activeTotalSize.asInstanceOf[js.Any], _pending = _pending.asInstanceOf[js.Any], _pushTask = _pushTask.asInstanceOf[js.Any], _taskHasMoreInfoThanActiveTasks = _taskHasMoreInfoThanActiveTasks.asInstanceOf[js.Any], _taskMerger = _taskMerger.asInstanceOf[js.Any], isIdle = isIdle.toJsFn, peerId = peerId.asInstanceOf[js.Any], popTasks = js.Any.fromFunction1(popTasks), pushTasks = js.Any.fromFunction1((t0: js.Array[Task]) => pushTasks(t0).runNow()), remove = js.Any.fromFunction1((t0: String) => remove(t0).runNow()), taskDone = js.Any.fromFunction1((t0: Task) => taskDone(t0).runNow()))
      __obj.asInstanceOf[PeerTasks]
    }
    
    extension [Self <: PeerTasks](x: Self) {
      
      inline def setIsIdle(value: CallbackTo[Boolean]): Self = StObject.set(x, "isIdle", value.toJsFn)
      
      inline def setPeerId(value: typingsJapgolly.libp2pInterfacePeerId.mod.PeerId): Self = StObject.set(x, "peerId", value.asInstanceOf[js.Any])
      
      inline def setPopTasks(value: Double => PopTaskResult): Self = StObject.set(x, "popTasks", js.Any.fromFunction1(value))
      
      inline def setPushTasks(value: js.Array[Task] => Callback): Self = StObject.set(x, "pushTasks", js.Any.fromFunction1((t0: js.Array[Task]) => value(t0).runNow()))
      
      inline def setRemove(value: String => Callback): Self = StObject.set(x, "remove", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setTaskDone(value: Task => Callback): Self = StObject.set(x, "taskDone", js.Any.fromFunction1((t0: Task) => value(t0).runNow()))
      ...
      inline def set_taskMerger(value: typingsJapgolly.ipfsBitswap.distSrcDecisionEngineTypesMod.TaskMerger): Self = StObject.set(x, "_taskMerger", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait PendingTasks extends StObject {
    ...
    def tasks(): js.Array[typingsJapgolly.ipfsBitswap.distSrcDecisionEngineTypesMod.Task] = js.native
  ...
  trait PopTaskResult extends StObject {
    ...
    var peerId: js.UndefOr[typingsJapgolly.libp2pInterfacePeerId.mod.PeerId] = js.undefined
  ...
  type Task = typingsJapgolly.ipfsBitswap.distSrcDecisionEngineTypesMod.Task
  
  type TaskMerger = typingsJapgolly.ipfsBitswap.distSrcDecisionEngineTypesMod.TaskMerger
}
