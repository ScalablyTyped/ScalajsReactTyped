...
import typingsJapgolly.ipfsBitswap.anon.Cid
import typingsJapgolly.ipfsBitswap.anon.DebuggererrorDebugger
import typingsJapgolly.ipfsBitswap.anon.Exchanged
import typingsJapgolly.ipfsBitswap.anon.MaxSizeReplaceHasWithBlock
import typingsJapgolly.ipfsBitswap.anon.TargetMessageSize
import typingsJapgolly.ipfsBitswap.distSrcDecisionEngineLedgerMod.Ledger
import typingsJapgolly.ipfsBitswap.distSrcDecisionEngineReqQueueMod.RequestQueue
...
object distSrcDecisionEngineMod {
  ...
  type BitswapMessageEntry = typingsJapgolly.ipfsBitswap.distSrcMessageEntryMod.BitswapMessageEntry
