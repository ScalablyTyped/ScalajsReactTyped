...
import typingsJapgolly.ipfsBitswap.anon.B100Only
import typingsJapgolly.ipfsBitswap.anon.DebuggererrorDebugger
import typingsJapgolly.ipfsBitswap.anon.Signal
import typingsJapgolly.ipfsBitswap.distSrcBitswapMod.Bitswap
...
object distSrcNetworkMod {
  ...
  open class Network protected () extends StObject {
    ...
    var _hashLoader: js.UndefOr[typingsJapgolly.ipfsBitswap.distSrcTypesMod.MultihashHasherLoader] = js.native
  ...
  type Connection = typingsJapgolly.libp2pInterfaceConnection.mod.Connection
  
  type Duplex = typingsJapgolly.itStreamTypes.mod.Duplex[js.typedarray.Uint8Array, js.typedarray.Uint8Array, js.Promise[Unit]]
  ...
  type Stream = typingsJapgolly.libp2pInterfaceConnection.mod.Stream
}
