...
import typingsJapgolly.ipfsBitswap.anon.ComputeThrottleTimeout
...
object distSrcStatsStatMod {
  ...
  open class Stat protected () extends EventEmitter {
    ...
    def movingAverages: Record[
        String, 
        Record[Double, typingsJapgolly.vascosantosMovingAverage.mod.IMovingAverage]
      ] = js.native
  ...
  type IMovingAverage = typingsJapgolly.vascosantosMovingAverage.mod.IMovingAverage
