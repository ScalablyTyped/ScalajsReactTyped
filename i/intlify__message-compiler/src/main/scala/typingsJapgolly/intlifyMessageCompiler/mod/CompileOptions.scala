...
- typingsJapgolly.intlifyMessageCompiler.mod.TokenizeOptions because var conflicts: location, onError. Inlined 
- typingsJapgolly.intlifyMessageCompiler.mod.ParserOptions because var conflicts: onError. Inlined location
- typingsJapgolly.intlifyMessageCompiler.mod.CodeGenOptions because var conflicts: onError. Inlined mode, breakLineCode, needIndent, sourceMap, filename */ trait CompileOptions
  extends StObject
