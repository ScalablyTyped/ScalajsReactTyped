package typingsJapgolly.inputFormat.components
...
import typingsJapgolly.inputFormat.reactMod.DefaultInputComponentProps
import typingsJapgolly.inputFormat.reactMod.Props
...
object React {
  ...
  inline def apply(
    ...
    val __props = js.Dynamic.literal(format = js.Any.fromFunction1(format), parse = js.Any.fromFunction2(parse))
    new Builder(js.Array(this.component, __props.asInstanceOf[/* props */ Props[DefaultInputComponentProps]]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def inputComponent(value: DefaultInputComponentProps => Element): this.type = set("inputComponent", js.Any.fromFunction1(value))
  ...
  def withProps(p: /* props */ Props[DefaultInputComponentProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
