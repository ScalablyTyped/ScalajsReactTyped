...
object distSrcFetchMod extends Shortcut {
  
  @JSImport("ipfs-utils/dist/src/fetch", JSImport.Namespace)
  @js.native
  val ^ : Any = js.native
  ...
  /* This means you don't have to write `^`, but can instead just say `distSrcFetchMod.foo` */
