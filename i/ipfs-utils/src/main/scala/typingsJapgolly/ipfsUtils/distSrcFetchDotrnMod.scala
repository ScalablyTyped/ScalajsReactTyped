...
import typingsJapgolly.electronFetch.mod.RequestInfo
import typingsJapgolly.electronFetch.mod.RequestInit
import typingsJapgolly.electronFetch.mod.Response
