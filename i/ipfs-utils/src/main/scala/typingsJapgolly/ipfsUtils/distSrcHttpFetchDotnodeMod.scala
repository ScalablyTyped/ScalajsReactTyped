...
import typingsJapgolly.ipfsUtils.distSrcFetchMod.Response
...
object distSrcHttpFetchDotnodeMod {
  ...
  inline def fetch(url: String, options: typingsJapgolly.ipfsUtils.distSrcTypesMod.FetchOptions): js.Promise[Response] = (^.asInstanceOf[js.Dynamic].applyDynamic("fetch")(url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Response]]
  ...
  inline def fetch(url: Request, options: typingsJapgolly.ipfsUtils.distSrcTypesMod.FetchOptions): js.Promise[Response] = (^.asInstanceOf[js.Dynamic].applyDynamic("fetch")(url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Response]]
