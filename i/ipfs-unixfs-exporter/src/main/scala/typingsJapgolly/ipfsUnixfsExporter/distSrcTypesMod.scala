...
import typingsJapgolly.ipfsUnixfsExporter.ipfsUnixfsExporterStrings.`object`
import typingsJapgolly.ipfsUnixfsExporter.ipfsUnixfsExporterStrings.directory
import typingsJapgolly.ipfsUnixfsExporter.ipfsUnixfsExporterStrings.file
import typingsJapgolly.ipfsUnixfsExporter.ipfsUnixfsExporterStrings.identity
import typingsJapgolly.ipfsUnixfsExporter.ipfsUnixfsExporterStrings.raw
...
object distSrcTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ipfsUnixfsExporter.distSrcTypesMod.UnixFSFile
    - typingsJapgolly.ipfsUnixfsExporter.distSrcTypesMod.UnixFSDirectory
    - typingsJapgolly.ipfsUnixfsExporter.distSrcTypesMod.ObjectNode
    - typingsJapgolly.ipfsUnixfsExporter.distSrcTypesMod.RawNode
    - typingsJapgolly.ipfsUnixfsExporter.distSrcTypesMod.IdentityNode
  */
