...
import typingsJapgolly.html2canvas.html2canvasStrings.`break-word`
import typingsJapgolly.html2canvas.html2canvasStrings.normal
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distTypesCssPropertyDescriptorsOverflowWrapMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.html2canvas.html2canvasStrings.`break-word`
  */
