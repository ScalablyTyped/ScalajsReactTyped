...
import typingsJapgolly.html2canvas.distTypesCssTypesImageMod.GradientColorStop
import typingsJapgolly.html2canvas.distTypesCssTypesImageMod.GradientCorner
import typingsJapgolly.html2canvas.distTypesCssTypesImageMod.UnprocessedGradientColorStop
