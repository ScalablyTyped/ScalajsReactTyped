...
import typingsJapgolly.html2canvas.distTypesCssSyntaxTokenizerMod.CSSToken
...
object distTypesCssSyntaxParserMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.html2canvas.distTypesCssSyntaxParserMod.CSSFunction
    - typingsJapgolly.html2canvas.distTypesCssSyntaxTokenizerMod.CSSToken
    - typingsJapgolly.html2canvas.distTypesCssSyntaxParserMod.CSSBlock
  */
  trait CSSValue extends StObject
  object CSSValue {
    
    inline def CSSBlock(`type`: CSSBlockType, values: js.Array[CSSValue]): typingsJapgolly.html2canvas.distTypesCssSyntaxParserMod.CSSBlock = {
      val __obj = js.Dynamic.literal(values = values.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.html2canvas.distTypesCssSyntaxParserMod.CSSBlock]
    }
    
    inline def CSSFunction(name: String, values: js.Array[CSSValue]): typingsJapgolly.html2canvas.distTypesCssSyntaxParserMod.CSSFunction = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], values = values.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(18)
      __obj.asInstanceOf[typingsJapgolly.html2canvas.distTypesCssSyntaxParserMod.CSSFunction]
    }
