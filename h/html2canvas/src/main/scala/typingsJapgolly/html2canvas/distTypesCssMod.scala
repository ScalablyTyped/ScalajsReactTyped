...
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsBackgroundClipMod.BackgroundClip_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsBackgroundOriginMod.BackgroundOrigin_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsBackgroundPositionMod.BackgroundPosition_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsBackgroundRepeatMod.BackgroundRepeat_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsBackgroundSizeMod.BackgroundSize_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsBorderRadiusMod.BorderRadius
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsBorderStyleMod.BORDER_STYLE
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsBoxShadowMod.BoxShadow_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsContentMod.Content_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsCounterIncrementMod.CounterIncrement_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsCounterResetMod.CounterReset_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsDirectionMod.DIRECTION_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsDisplayMod.Display_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsFloatMod.FLOAT_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsFontFamilyMod.FontFamily_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsFontStyleMod.FONT_STYLE
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsLineBreakMod.LINE_BREAK
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsListStylePositionMod.LIST_STYLE_POSITION
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsListStyleTypeMod.LIST_STYLE_TYPE
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsOverflowMod.OVERFLOW_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsOverflowWrapMod.OVERFLOW_WRAP
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsPaintOrderMod.PaintOrder_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsPositionMod.POSITION_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsQuotesMod.Quotes_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsTextAlignMod.TEXT_ALIGN
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsTextDecorationLineMod.TextDecorationLine_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsTextShadowMod.TextShadow_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsTextTransformMod.TEXT_TRANSFORM
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsTransformMod.Transform_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsTransformOriginMod.TransformOrigin_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsVisibilityMod.VISIBILITY_
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsWordBreakMod.WORD_BREAK
  ...
  open class CSSParsedDeclaration protected () extends StObject {
    ...
    var zIndex: ReturnType[
        js.Function2[
          /* context */ Context, 
          /* token */ CSSValue, 
          typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsZIndexMod.zIndex
        ]
      ] = js.native
  }
