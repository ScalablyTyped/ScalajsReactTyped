...
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsFontStyleMod.FONT_STYLE
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsOverflowWrapMod.OVERFLOW_WRAP
