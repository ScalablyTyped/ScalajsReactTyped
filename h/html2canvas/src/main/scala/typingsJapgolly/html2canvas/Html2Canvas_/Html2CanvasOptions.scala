package typingsJapgolly.html2canvas.Html2Canvas_
...
object Html2CanvasOptions {
  ...
  def apply(
    ...
    if (ignoreElements != null) __obj.updateDynamic("ignoreElements")(js.Any.fromFunction1((t0: /* element */ org.scalajs.dom.raw.HTMLElement) => ignoreElements(t0).runNow()))
    ...
    if (onclone != null) __obj.updateDynamic("onclone")(js.Any.fromFunction1((t0: /* doc */ org.scalajs.dom.raw.HTMLDocument) => onclone(t0).runNow()))
