...
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsBackgroundClipMod.BACKGROUND_CLIP
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsBackgroundOriginMod.BACKGROUND_ORIGIN
import typingsJapgolly.html2canvas.distTypesCssPropertyDescriptorsBackgroundRepeatMod.BACKGROUND_REPEAT
