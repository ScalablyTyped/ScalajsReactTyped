...
import typingsJapgolly.htmlWebpackPlugin.anon.AssetTags
import typingsJapgolly.htmlWebpackPlugin.anon.Assets
import typingsJapgolly.htmlWebpackPlugin.anon.BodyTags
import typingsJapgolly.htmlWebpackPlugin.anon.BodyTagsHeadTags
import typingsJapgolly.htmlWebpackPlugin.anon.DictmetaAttributeName
import typingsJapgolly.htmlWebpackPlugin.anon.Favicon
import typingsJapgolly.htmlWebpackPlugin.anon.Files
import typingsJapgolly.htmlWebpackPlugin.anon.HeadTags
import typingsJapgolly.htmlWebpackPlugin.anon.Html
import typingsJapgolly.htmlWebpackPlugin.anon.OutputName
import typingsJapgolly.htmlWebpackPlugin.htmlWebpackPluginBooleans.`false`
import typingsJapgolly.htmlWebpackPlugin.htmlWebpackPluginBooleans.`true`
...
import typingsJapgolly.htmlWebpackPlugin.htmlWebpackPluginStrings.blocking
import typingsJapgolly.htmlWebpackPlugin.htmlWebpackPluginStrings.body
import typingsJapgolly.htmlWebpackPlugin.htmlWebpackPluginStrings.defer
...
import typingsJapgolly.htmlWebpackPlugin.htmlWebpackPluginStrings.module
...
object mod {
  ...
  object HtmlWebpackPlugin {
    ...
    inline def apply(apply: Compiler => Callback, userOptions: Options, version: Double): HtmlWebpackPlugin = {
      val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1((t0: Compiler) => apply(t0).runNow()), userOptions = userOptions.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
  ...
  type MinifyOptions = typingsJapgolly.htmlMinifierTerser.mod.Options
