...
import typingsJapgolly.hoganJs.anon.HoganOptionsasStringfalse
import typingsJapgolly.hoganJs.anon.HoganOptionsasStringtrue
...
object mod {
  ...
  inline def compile(text: String): HoganTemplate = ^.asInstanceOf[js.Dynamic].applyDynamic("compile")(text.asInstanceOf[js.Any]).asInstanceOf[HoganTemplate]
  ...
  inline def compile_String(text: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("compile")(text.asInstanceOf[js.Any]).asInstanceOf[String]
