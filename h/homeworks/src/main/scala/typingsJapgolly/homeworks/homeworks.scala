...
import typingsJapgolly.homeworks.homeworksStrings.move
import typingsJapgolly.homeworks.homeworksStrings.start
...
object homeworks {
  ...
  object UploadOptions {
    ...
    extension [Self <: UploadOptions](x: Self) {
      ...
      inline def setBeforeStart(value: Callback): Self = StObject.set(x, "beforeStart", value.toJsFn)
      
      inline def setBeforeStartUndefined: Self = StObject.set(x, "beforeStart", js.undefined)
      
      inline def setComplete(value: /* data */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "complete", js.Any.fromFunction1((t0: /* data */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setError(
        value: (/* xhr */ js.UndefOr[Any], /* state */ js.UndefOr[Any], /* error */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "error", js.Any.fromFunction3((t0: /* xhr */ js.UndefOr[Any], t1: /* state */ js.UndefOr[Any], t2: /* error */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setSuccess(
        value: (/* data */ js.UndefOr[Any], /* state */ js.UndefOr[Any], /* xhr */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "success", js.Any.fromFunction3((t0: /* data */ js.UndefOr[Any], t1: /* state */ js.UndefOr[Any], t2: /* xhr */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
