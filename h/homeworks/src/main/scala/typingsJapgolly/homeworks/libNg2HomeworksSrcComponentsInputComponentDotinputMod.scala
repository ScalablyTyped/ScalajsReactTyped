...
import typingsJapgolly.homeworks.libNg2HomeworksSrcCoreManagerMod.HomeworksManager
...
object libNg2HomeworksSrcComponentsInputComponentDotinputMod {
  ...
  open class WorksInput protected ()
    ...
    var onUpdate: EventEmitter[typingsJapgolly.homeworks.homeworks.Event] = js.native
