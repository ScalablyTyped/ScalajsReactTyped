package typingsJapgolly.hapiBoom

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.hapiBoom.hapiBoomStrings._empty
...
object mod {
  ...
  object unauthorized {
    ...
    inline def apply[Data](message: Null, scheme: String): Boom[Data] & MissingAuth = (^.asInstanceOf[js.Dynamic].apply(message.asInstanceOf[js.Any], scheme.asInstanceOf[js.Any])).asInstanceOf[Boom[Data] & MissingAuth]
    inline def apply[Data](message: Null, scheme: String, attributes: String): Boom[Data] & MissingAuth = (^.asInstanceOf[js.Dynamic].apply(message.asInstanceOf[js.Any], scheme.asInstanceOf[js.Any], attributes.asInstanceOf[js.Any])).asInstanceOf[Boom[Data] & MissingAuth]
    inline def apply[Data](message: Null, scheme: String, attributes: Attributes): Boom[Data] & MissingAuth = (^.asInstanceOf[js.Dynamic].apply(message.asInstanceOf[js.Any], scheme.asInstanceOf[js.Any], attributes.asInstanceOf[js.Any])).asInstanceOf[Boom[Data] & MissingAuth]
