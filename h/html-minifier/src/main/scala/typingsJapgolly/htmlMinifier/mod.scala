...
object mod {
  ...
  inline def minify(text: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("minify")(text.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def minify(text: String, options: Options): String = (^.asInstanceOf[js.Dynamic].applyDynamic("minify")(text.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  trait Options extends StObject {
    ...
    var minifyCSS: js.UndefOr[
        Boolean | typingsJapgolly.cleanCss.mod.Options | (js.Function1[/* text */ String, String])
      ] = js.undefined
    ...
    var minifyURLs: js.UndefOr[
        Boolean | typingsJapgolly.relateurl.mod.Options | (js.Function1[/* text */ String, String])
      ] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setMinifyCSS(value: Boolean | typingsJapgolly.cleanCss.mod.Options | (js.Function1[/* text */ String, String])): Self = StObject.set(x, "minifyCSS", value.asInstanceOf[js.Any])
      
      inline def setMinifyCSSFunction1(value: /* text */ String => String): Self = StObject.set(x, "minifyCSS", js.Any.fromFunction1(value))
      
      inline def setMinifyCSSUndefined: Self = StObject.set(x, "minifyCSS", js.undefined)
      
      inline def setMinifyJS(value: Boolean | MinifyOptions | (js.Function2[/* text */ String, /* inline */ Boolean, String])): Self = StObject.set(x, "minifyJS", value.asInstanceOf[js.Any])
      
      inline def setMinifyJSFunction2(value: (/* text */ String, /* inline */ Boolean) => String): Self = StObject.set(x, "minifyJS", js.Any.fromFunction2(value))
      
      inline def setMinifyJSUndefined: Self = StObject.set(x, "minifyJS", js.undefined)
      
      inline def setMinifyURLs(value: Boolean | typingsJapgolly.relateurl.mod.Options | (js.Function1[/* text */ String, String])): Self = StObject.set(x, "minifyURLs", value.asInstanceOf[js.Any])
