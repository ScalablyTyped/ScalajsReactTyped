...
object AnonClose {
  ...
  def apply(
    ...
    if (close != null) __obj.updateDynamic("close")(js.Any.fromFunction1((t0: /* response */ typingsJapgolly.hapiHapi.mod.ResponseObject) => close(t0).runNow()))
    if (marshal != null) __obj.updateDynamic("marshal")(js.Any.fromFunction1((t0: /* response */ typingsJapgolly.hapiHapi.mod.ResponseObject) => marshal(t0).runNow()))
    if (prepare != null) __obj.updateDynamic("prepare")(js.Any.fromFunction1((t0: /* response */ typingsJapgolly.hapiHapi.mod.ResponseObject) => prepare(t0).runNow()))
