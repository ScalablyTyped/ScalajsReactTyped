...
import typingsJapgolly.hapiHapi.hapiHapiStrings.log
import typingsJapgolly.hapiHapi.hapiHapiStrings.request
import typingsJapgolly.hapiHapi.hapiHapiStrings.response
import typingsJapgolly.hapiHapi.hapiHapiStrings.route
import typingsJapgolly.hapiHapi.hapiHapiStrings.start
import typingsJapgolly.hapiHapi.hapiHapiStrings.stop
