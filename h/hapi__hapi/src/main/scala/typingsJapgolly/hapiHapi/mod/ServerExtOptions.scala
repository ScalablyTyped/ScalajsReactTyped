...
import typingsJapgolly.hapiHapi.hapiHapiStrings.plugin
...
trait ServerExtOptions extends StObject {
  ...
  /**
    ...
    */
  var sandbox: js.UndefOr[typingsJapgolly.hapiHapi.hapiHapiStrings.server | plugin] = js.undefined
}
object ServerExtOptions {
  ...
  extension [Self <: ServerExtOptions](x: Self) {
    ...
    inline def setSandbox(value: typingsJapgolly.hapiHapi.hapiHapiStrings.server | plugin): Self = StObject.set(x, "sandbox", value.asInstanceOf[js.Any])
