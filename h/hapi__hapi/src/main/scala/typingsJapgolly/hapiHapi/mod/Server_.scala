...
import typingsJapgolly.hapiCatbox.mod.Policy
import typingsJapgolly.hapiHapi.anon.Apply
import typingsJapgolly.hapiHapi.anon.ApplyExtend
import typingsJapgolly.hapiHapi.anon.EventLoopDelay
import typingsJapgolly.hapiHapi.anon.Extend
import typingsJapgolly.hapiHapi.anon.Timeout
import typingsJapgolly.hapiHapi.anon.Validate
import typingsJapgolly.hapiHapi.anon.`0`
import typingsJapgolly.hapiHapi.hapiHapiStrings.handler
import typingsJapgolly.hapiHapi.hapiHapiStrings.request
import typingsJapgolly.hapiHapi.hapiHapiStrings.socket
import typingsJapgolly.hapiHapi.hapiHapiStrings.tcp
import typingsJapgolly.hapiHapi.hapiHapiStrings.toolkit
...
/**
  ...
  */
open class Server_ () extends StObject {
  ...
  @JSName("decorate")
  def decorate_server(
    `type`: typingsJapgolly.hapiHapi.hapiHapiStrings.server,
    property: DecorateName,
  ...
  /**
    ...
    */
  val decorations: typingsJapgolly.hapiHapi.anon.Request = js.native
  ...
  /**
    ...
    */
  def rules(
    processor: js.Function2[/* rules */ js.Object, /* info */ typingsJapgolly.hapiHapi.anon.Method, js.Object]
  ): Unit = js.native
  def rules(
    processor: js.Function2[/* rules */ js.Object, /* info */ typingsJapgolly.hapiHapi.anon.Method, js.Object],
    options: Validate
