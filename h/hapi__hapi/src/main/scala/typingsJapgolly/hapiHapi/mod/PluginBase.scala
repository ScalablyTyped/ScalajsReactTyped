...
import typingsJapgolly.hapiHapi.AnonHapi
...
object PluginBase {
  @scala.inline
  def apply[T](
    register: (Server, T) => CallbackTo[Unit | js.Promise[Unit]],
    ...
    __obj.updateDynamic("register")(js.Any.fromFunction2((t0: typingsJapgolly.hapiHapi.mod.Server, t1: T) => register(t0, t1).runNow()))
