...
import typingsJapgolly.hapiHapi.anon.Encoding
import typingsJapgolly.hapiHapi.anon.IsCaseSensitive
import typingsJapgolly.hapiHapi.anon.Log
import typingsJapgolly.hapiHapi.anon.MaxEventLoopDelay
import typingsJapgolly.hapiHapi.anon.Parser
...
trait ServerOptions extends StObject {
  ...
  /**
    ...
    */
  var tls: js.UndefOr[
    Boolean | (typingsJapgolly.node.httpsMod.ServerOptions[
...
object ServerOptions {
  ...
  extension [Self <: ServerOptions](x: Self) {
    ...
    inline def setTls(
      value: Boolean | (typingsJapgolly.node.httpsMod.ServerOptions[
          Instantiable1[/* socket */ Socket, typingsJapgolly.node.nodeColonhttpMod.IncomingMessage], 
          Instantiable1[
            /* import warning: RewrittenClass.unapply cls was tparam Request */ /* req */ Any, 
            typingsJapgolly.node.nodeColonhttpMod.ServerResponse[IncomingMessage]
