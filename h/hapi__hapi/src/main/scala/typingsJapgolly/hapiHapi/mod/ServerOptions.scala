...
import typingsJapgolly.hapiHapi.AnonEncoding
import typingsJapgolly.hapiHapi.AnonIsCaseSensitive
import typingsJapgolly.hapiHapi.AnonLog
import typingsJapgolly.hapiHapi.AnonMaxEventLoopDelay
import typingsJapgolly.hapiHapi.AnonParser
import typingsJapgolly.hapiHapi.hapiHapiBooleans.`false`
import typingsJapgolly.hapiMimos.mod.MimosOptions
...
trait ServerOptions extends js.Object {
  ...
  /**
    ...
    */
  var listener: js.UndefOr[typingsJapgolly.node.httpMod.Server] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tls: js.UndefOr[Boolean | typingsJapgolly.node.httpsMod.ServerOptions] = js.undefined
  /**
...
object ServerOptions {
  ...
  def apply(
    ...
    host: String = null,
    listener: typingsJapgolly.node.httpMod.Server = null,
    ...
    tls: Boolean | typingsJapgolly.node.httpsMod.ServerOptions = null,
    uri: String = null
  ): ServerOptions = {
