...
import typingsJapgolly.hapiHapi.AnonApply
import typingsJapgolly.hapiHapi.AnonApplyBoolean
import typingsJapgolly.hapiHapi.AnonApplyExtend
import typingsJapgolly.hapiHapi.AnonEventLoopDelay
import typingsJapgolly.hapiHapi.AnonExtend
import typingsJapgolly.hapiHapi.AnonMethod
import typingsJapgolly.hapiHapi.AnonRequest
import typingsJapgolly.hapiHapi.AnonTimeout
import typingsJapgolly.hapiHapi.AnonValidate
import typingsJapgolly.hapiHapi.hapiHapiStrings.handler
import typingsJapgolly.hapiHapi.hapiHapiStrings.request
import typingsJapgolly.hapiHapi.hapiHapiStrings.server
...
import typingsJapgolly.hapiJoi.mod.Root
