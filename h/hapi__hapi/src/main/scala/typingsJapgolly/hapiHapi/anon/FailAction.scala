...
trait FailAction extends StObject {
  ...
  var failAction: js.UndefOr[typingsJapgolly.hapiHapi.mod.Lifecycle.FailAction] = js.undefined
...
object FailAction {
  ...
  extension [Self <: FailAction](x: Self) {
    ...
    inline def setFailAction(value: typingsJapgolly.hapiHapi.mod.Lifecycle.FailAction): Self = StObject.set(x, "failAction", value.asInstanceOf[js.Any])
    
    inline def setFailActionFunction3(
      value: (/* request */ typingsJapgolly.hapiHapi.mod.Request, /* h */ ResponseToolkit, /* err */ js.UndefOr[js.Error]) => ReturnValue
