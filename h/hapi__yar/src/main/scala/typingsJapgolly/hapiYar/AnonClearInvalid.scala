...
object AnonClearInvalid {
  ...
  def apply(
    ...
    if (customSessionIDGenerator != null) __obj.updateDynamic("customSessionIDGenerator")(js.Any.fromFunction1((t0: /* req */ typingsJapgolly.hapiHapi.mod.Request) => customSessionIDGenerator(t0).runNow()))
