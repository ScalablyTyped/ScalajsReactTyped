...
object howlerStrings {
  ...
  @js.native
  sealed trait loaderror extends StObject
  ...
  @js.native
  sealed trait playerror extends StObject
  inline def playerror: playerror = "playerror".asInstanceOf[playerror]
  ...
  @js.native
  sealed trait unloaded extends StObject
