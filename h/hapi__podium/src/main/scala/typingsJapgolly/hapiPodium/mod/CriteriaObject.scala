...
object CriteriaObject {
  ...
  def apply(
    ...
    if (listener != null) __obj.updateDynamic("listener")(js.Any.fromFunction3((t0: /* data */ js.Any, t1: /* tags */ js.UndefOr[typingsJapgolly.hapiPodium.mod.Tags], t2: /* callback */ js.UndefOr[js.Function0[scala.Unit]]) => listener(t0, t1, t2).runNow()))
