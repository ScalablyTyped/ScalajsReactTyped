package typingsJapgolly.historyEvents
  ...
  object global {
    ...
    object Window {
      ...
      extension [Self <: Window](x: Self) {
        ...
        inline def setOnchangestate(value: Callback): Self = StObject.set(x, "onchangestate", value.toJsFn)
        
        inline def setOnchangestateUndefined: Self = StObject.set(x, "onchangestate", js.undefined)
        
        inline def setOnpushstate(value: Callback): Self = StObject.set(x, "onpushstate", value.toJsFn)
        
        inline def setOnpushstateUndefined: Self = StObject.set(x, "onpushstate", js.undefined)
        
        inline def setOnreplacestate(value: Callback): Self = StObject.set(x, "onreplacestate", value.toJsFn)
