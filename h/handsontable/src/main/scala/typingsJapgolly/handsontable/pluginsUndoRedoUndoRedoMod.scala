...
object pluginsUndoRedoUndoRedoMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.ChangeAction
    - typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.InsertRowAction
    - typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.RemoveRowAction
    - typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.InsertColAction
    - typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.RemoveColAction
    - typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.FilterAction
  */
  trait Action extends StObject
  object Action {
    
    inline def ChangeAction(changes: js.Array[CellChange], selected: js.Array[js.Tuple2[Double, Double]]): typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.ChangeAction = {
      val __obj = js.Dynamic.literal(actionType = "change", changes = changes.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.ChangeAction]
    }
    
    inline def FilterAction(conditionsStack: js.Array[ColumnConditions]): typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.FilterAction = {
      val __obj = js.Dynamic.literal(actionType = "filter", conditionsStack = conditionsStack.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.FilterAction]
    }
    
    inline def InsertColAction(amount: Double, index: Double): typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.InsertColAction = {
      val __obj = js.Dynamic.literal(actionType = "insert_col", amount = amount.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.InsertColAction]
    }
    
    inline def InsertRowAction(amount: Double, index: Double): typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.InsertRowAction = {
      val __obj = js.Dynamic.literal(actionType = "insert_row", amount = amount.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.InsertRowAction]
    }
    ...
    inline def RemoveColAction(
      ...
      __obj.asInstanceOf[typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.RemoveColAction]
    }
    
    inline def RemoveRowAction(data: js.Array[js.Array[CellValue]], index: Double): typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.RemoveRowAction = {
      val __obj = js.Dynamic.literal(actionType = "remove_row", data = data.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.handsontable.pluginsUndoRedoUndoRedoMod.RemoveRowAction]
    }
  }
