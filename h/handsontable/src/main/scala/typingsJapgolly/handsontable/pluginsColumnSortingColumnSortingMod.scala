...
object pluginsColumnSortingColumnSortingMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.handsontable.handsontableStrings.asc
    - typingsJapgolly.handsontable.handsontableStrings.desc
  */
  trait SortOrderType extends StObject
  object SortOrderType {
    
    inline def asc: typingsJapgolly.handsontable.handsontableStrings.asc = "asc".asInstanceOf[typingsJapgolly.handsontable.handsontableStrings.asc]
    
    inline def desc: typingsJapgolly.handsontable.handsontableStrings.desc = "desc".asInstanceOf[typingsJapgolly.handsontable.handsontableStrings.desc]
  }
}
