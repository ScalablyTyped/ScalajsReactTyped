...
import typingsJapgolly.handsontable.anon.Height
...
object pluginsCommentsCommentsMod {
  ...
  trait CommentsRangeObject extends StObject {
    ...
    var from: typingsJapgolly.handsontable.`3rdpartyWalkontableSrcCellCoordsMod`.default
    
    var to: js.UndefOr[typingsJapgolly.handsontable.`3rdpartyWalkontableSrcCellCoordsMod`.default] = js.undefined
  }
  object CommentsRangeObject {
    
    inline def apply(from: typingsJapgolly.handsontable.`3rdpartyWalkontableSrcCellCoordsMod`.default): CommentsRangeObject = {
    ...
    extension [Self <: CommentsRangeObject](x: Self) {
      ...
      inline def setFrom(value: typingsJapgolly.handsontable.`3rdpartyWalkontableSrcCellCoordsMod`.default): Self = StObject.set(x, "from", value.asInstanceOf[js.Any])
      
      inline def setTo(value: typingsJapgolly.handsontable.`3rdpartyWalkontableSrcCellCoordsMod`.default): Self = StObject.set(x, "to", value.asInstanceOf[js.Any])
