...
object pluginsCopyPasteCopyPasteMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.handsontable.handsontableStrings.overwrite
    - typingsJapgolly.handsontable.handsontableStrings.shift_down
    - typingsJapgolly.handsontable.handsontableStrings.shift_right
  */
  trait PasteModeType extends StObject
  object PasteModeType {
    
    inline def overwrite: typingsJapgolly.handsontable.handsontableStrings.overwrite = "overwrite".asInstanceOf[typingsJapgolly.handsontable.handsontableStrings.overwrite]
    
    inline def shift_down: typingsJapgolly.handsontable.handsontableStrings.shift_down = "shift_down".asInstanceOf[typingsJapgolly.handsontable.handsontableStrings.shift_down]
    
    inline def shift_right: typingsJapgolly.handsontable.handsontableStrings.shift_right = "shift_right".asInstanceOf[typingsJapgolly.handsontable.handsontableStrings.shift_right]
  }
