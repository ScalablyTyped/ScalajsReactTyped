...
object pluginsColumnSummaryColumnSummaryMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.handsontable.anon.typesumminmaxcountaverage
    - typingsJapgolly.handsontable.anon.typecustomcustomFunctiont
  */
  trait DetailedSettings extends StObject
  object DetailedSettings {
    
    inline def typecustomcustomFunctiont(customFunction: Endpoint => Double, destinationColumn: Double, destinationRow: Double): typingsJapgolly.handsontable.anon.typecustomcustomFunctiont = {
      ...
      __obj.asInstanceOf[typingsJapgolly.handsontable.anon.typecustomcustomFunctiont]
    }
    
    inline def typesumminmaxcountaverage(destinationColumn: Double, destinationRow: Double, `type`: sum | min | max | count | average): typingsJapgolly.handsontable.anon.typesumminmaxcountaverage = {
      ...
      __obj.asInstanceOf[typingsJapgolly.handsontable.anon.typesumminmaxcountaverage]
    }
  }
