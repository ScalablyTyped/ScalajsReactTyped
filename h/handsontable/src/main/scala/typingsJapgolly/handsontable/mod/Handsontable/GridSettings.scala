...
import typingsJapgolly.handsontable.mod.Handsontable.Hooks.Events
import typingsJapgolly.handsontable.mod.Handsontable._editors.Base
import typingsJapgolly.handsontable.mod.Handsontable.autoColumnSize.Settings
import typingsJapgolly.handsontable.mod.Handsontable.comments.CommentConfig
import typingsJapgolly.handsontable.mod.Handsontable.contextMenu.PredefinedMenuItemKey
import typingsJapgolly.handsontable.mod.Handsontable.nestedHeaders.NestedHeader
...
trait GridSettings extends Events {
  ...
  var autoRowSize: js.UndefOr[typingsJapgolly.handsontable.mod.Handsontable.autoRowSize.Settings | Boolean] = js.undefined
  ...
  var collapsibleColumns: js.UndefOr[
    Boolean | js.Array[typingsJapgolly.handsontable.mod.Handsontable.collapsibleColumns.Settings]
  ] = js.undefined
  var columnHeaderHeight: js.UndefOr[Double | js.Array[js.UndefOr[Double]]] = js.undefined
  var columnSorting: js.UndefOr[Boolean | typingsJapgolly.handsontable.mod.Handsontable.columnSorting.Settings] = js.undefined
  var columnSummary: js.UndefOr[
    js.Array[typingsJapgolly.handsontable.mod.Handsontable.columnSummary.Settings] | js.Function0[js.Array[typingsJapgolly.handsontable.mod.Handsontable.columnSummary.Settings]]
  ] = js.undefined
  ...
  var comments: js.UndefOr[
    Boolean | typingsJapgolly.handsontable.mod.Handsontable.comments.Settings | js.Array[CommentConfig]
  ] = js.undefined
  var contextMenu: js.UndefOr[
    Boolean | js.Array[PredefinedMenuItemKey] | typingsJapgolly.handsontable.mod.Handsontable.contextMenu.Settings
  ] = js.undefined
  var copyPaste: js.UndefOr[Boolean | typingsJapgolly.handsontable.mod.Handsontable.copyPaste.Settings] = js.undefined
  ...
  var customBorders: js.UndefOr[
    Boolean | js.Array[typingsJapgolly.handsontable.mod.Handsontable.customBorders.Settings]
  ] = js.undefined
  ...
  var fillHandle: js.UndefOr[
    Boolean | vertical | horizontal | typingsJapgolly.handsontable.mod.Handsontable.autoFill.Settings
  ] = js.undefined
  ...
  var formulas: js.UndefOr[Boolean | typingsJapgolly.handsontable.mod.Handsontable.formulas.Settings] = js.undefined
  var fragmentSelection: js.UndefOr[Boolean | cell] = js.undefined
  var ganttChart: js.UndefOr[typingsJapgolly.handsontable.mod.Handsontable.ganttChart.Settings] = js.undefined
  var headerTooltips: js.UndefOr[Boolean | typingsJapgolly.handsontable.mod.Handsontable.headerTooltips.Settings] = js.undefined
  var height: js.UndefOr[Double | String | (js.Function0[Double | String])] = js.undefined
  var hiddenColumns: js.UndefOr[Boolean | typingsJapgolly.handsontable.mod.Handsontable.hiddenColumns.Settings] = js.undefined
  var hiddenRows: js.UndefOr[Boolean | typingsJapgolly.handsontable.mod.Handsontable.hiddenRows.Settings] = js.undefined
  ...
  var mergeCells: js.UndefOr[
    Boolean | js.Array[typingsJapgolly.handsontable.mod.Handsontable.mergeCells.Settings]
  ] = js.undefined
  ...
  var multiColumnSorting: js.UndefOr[
    Boolean | typingsJapgolly.handsontable.mod.Handsontable.multiColumnSorting.Settings
  ] = js.undefined
  ...
  var renderer: js.UndefOr[
    RendererType | String | typingsJapgolly.handsontable.mod.Handsontable.renderers.Base
  ] = js.undefined
  ...
  var search: js.UndefOr[Boolean | typingsJapgolly.handsontable.mod.Handsontable.search.Settings] = js.undefined
  ...
  var validator: js.UndefOr[
    typingsJapgolly.handsontable.mod.Handsontable.validators.Base | js.RegExp | ValidatorType | String
  ] = js.undefined
...
object GridSettings {
  ...
  def apply(
    ...
    autoRowSize: typingsJapgolly.handsontable.mod.Handsontable.autoRowSize.Settings | Boolean = null,
    ...
    collapsibleColumns: Boolean | js.Array[typingsJapgolly.handsontable.mod.Handsontable.collapsibleColumns.Settings] = null,
    columnHeaderHeight: Double | js.Array[js.UndefOr[Double]] = null,
    columnSorting: Boolean | typingsJapgolly.handsontable.mod.Handsontable.columnSorting.Settings = null,
    columnSummary: js.Array[typingsJapgolly.handsontable.mod.Handsontable.columnSummary.Settings] | js.Function0[js.Array[typingsJapgolly.handsontable.mod.Handsontable.columnSummary.Settings]] = null,
    columns: js.Array[ColumnSettings] | (js.Function1[/* index */ Double, ColumnSettings]) = null,
    commentedCellClassName: String = null,
    comments: Boolean | typingsJapgolly.handsontable.mod.Handsontable.comments.Settings | js.Array[CommentConfig] = null,
    contextMenu: Boolean | js.Array[PredefinedMenuItemKey] | typingsJapgolly.handsontable.mod.Handsontable.contextMenu.Settings = null,
    copyPaste: Boolean | typingsJapgolly.handsontable.mod.Handsontable.copyPaste.Settings = null,
    ...
    customBorders: Boolean | js.Array[typingsJapgolly.handsontable.mod.Handsontable.customBorders.Settings] = null,
    ...
    dropdownMenu: Boolean | js.Array[PredefinedMenuItemKey] | typingsJapgolly.handsontable.mod.Handsontable.contextMenu.Settings = null,
    ...
    fillHandle: Boolean | vertical | horizontal | typingsJapgolly.handsontable.mod.Handsontable.autoFill.Settings = null,
    ...
    formulas: Boolean | typingsJapgolly.handsontable.mod.Handsontable.formulas.Settings = null,
    fragmentSelection: Boolean | cell = null,
    ganttChart: typingsJapgolly.handsontable.mod.Handsontable.ganttChart.Settings = null,
    headerTooltips: Boolean | typingsJapgolly.handsontable.mod.Handsontable.headerTooltips.Settings = null,
    height: Double | String | (js.Function0[Double | String]) = null,
    hiddenColumns: Boolean | typingsJapgolly.handsontable.mod.Handsontable.hiddenColumns.Settings = null,
    hiddenRows: Boolean | typingsJapgolly.handsontable.mod.Handsontable.hiddenRows.Settings = null,
    ...
    mergeCells: Boolean | js.Array[typingsJapgolly.handsontable.mod.Handsontable.mergeCells.Settings] = null,
    minCols: Int | Double = null,
    minRows: Int | Double = null,
    minSpareCols: Int | Double = null,
    minSpareRows: Int | Double = null,
    multiColumnSorting: Boolean | typingsJapgolly.handsontable.mod.Handsontable.multiColumnSorting.Settings = null,
    ...
    renderer: RendererType | String | typingsJapgolly.handsontable.mod.Handsontable.renderers.Base = null,
    ...
    search: Boolean | typingsJapgolly.handsontable.mod.Handsontable.search.Settings = null,
    ...
    validator: typingsJapgolly.handsontable.mod.Handsontable.validators.Base | js.RegExp | ValidatorType | String = null,
