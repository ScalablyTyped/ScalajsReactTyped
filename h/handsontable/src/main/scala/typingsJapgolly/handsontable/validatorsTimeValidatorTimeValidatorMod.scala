...
object validatorsTimeValidatorTimeValidatorMod {
  
  @JSImport("handsontable/validators/timeValidator/timeValidator", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("handsontable/validators/timeValidator/timeValidator", "VALIDATOR_TYPE")
  @js.native
