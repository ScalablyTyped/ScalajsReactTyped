...
import typingsJapgolly.handsontable.commonMod.LabelOptions
import typingsJapgolly.handsontable.commonMod.NumericFormatOptions
import typingsJapgolly.handsontable.commonMod.RowObject
import typingsJapgolly.handsontable.commonMod.SelectOptionsObject
import typingsJapgolly.handsontable.commonMod.SimpleCellCoords
import typingsJapgolly.handsontable.coreMod.default
import typingsJapgolly.handsontable.editorsMod.BaseEditor
import typingsJapgolly.handsontable.editorsMod.EditorType
import typingsJapgolly.handsontable.handsontableStrings.`non-commercial-and-evaluation`
import typingsJapgolly.handsontable.handsontableStrings.all
import typingsJapgolly.handsontable.handsontableStrings.area
import typingsJapgolly.handsontable.handsontableStrings.auto
import typingsJapgolly.handsontable.handsontableStrings.cell
import typingsJapgolly.handsontable.handsontableStrings.current
import typingsJapgolly.handsontable.handsontableStrings.header
import typingsJapgolly.handsontable.handsontableStrings.horizontal
import typingsJapgolly.handsontable.handsontableStrings.inherit
import typingsJapgolly.handsontable.handsontableStrings.last
import typingsJapgolly.handsontable.handsontableStrings.loose
import typingsJapgolly.handsontable.handsontableStrings.ltr
import typingsJapgolly.handsontable.handsontableStrings.multiple
import typingsJapgolly.handsontable.handsontableStrings.none
import typingsJapgolly.handsontable.handsontableStrings.range
import typingsJapgolly.handsontable.handsontableStrings.rtl
import typingsJapgolly.handsontable.handsontableStrings.single
import typingsJapgolly.handsontable.handsontableStrings.strict
import typingsJapgolly.handsontable.handsontableStrings.vertical
import typingsJapgolly.handsontable.pluginHooksMod.Events
import typingsJapgolly.handsontable.pluginsAutoColumnSizeAutoColumnSizeMod.Settings
import typingsJapgolly.handsontable.pluginsCollapsibleColumnsCollapsibleColumnsMod.DetailedSettings
...
object settingsMod {
  ...
  trait GridSettings
    ...
    var autoRowSize: js.UndefOr[typingsJapgolly.handsontable.pluginsAutoRowSizeAutoRowSizeMod.Settings] = js.undefined
    ...
    var collapsibleColumns: js.UndefOr[
        typingsJapgolly.handsontable.pluginsCollapsibleColumnsCollapsibleColumnsMod.Settings
      ] = js.undefined
    
    var columnHeaderHeight: js.UndefOr[Double | js.Array[js.UndefOr[Double]]] = js.undefined
    
    var columnSorting: js.UndefOr[typingsJapgolly.handsontable.pluginsColumnSortingColumnSortingMod.Settings] = js.undefined
    
    var columnSummary: js.UndefOr[typingsJapgolly.handsontable.pluginsColumnSummaryColumnSummaryMod.Settings] = js.undefined
    ...
    var comments: js.UndefOr[typingsJapgolly.handsontable.pluginsCommentsCommentsMod.Settings] = js.undefined
    
    var contextMenu: js.UndefOr[typingsJapgolly.handsontable.pluginsContextMenuContextMenuMod.Settings] = js.undefined
    
    var copyPaste: js.UndefOr[typingsJapgolly.handsontable.pluginsCopyPasteCopyPasteMod.Settings] = js.undefined
    ...
    var customBorders: js.UndefOr[typingsJapgolly.handsontable.pluginsCustomBordersCustomBordersMod.Settings] = js.undefined
    ...
    var dropdownMenu: js.UndefOr[typingsJapgolly.handsontable.pluginsDropdownMenuDropdownMenuMod.Settings] = js.undefined
    ...
    var enterMoves: js.UndefOr[
        typingsJapgolly.handsontable.`3rdpartyWalkontableSrcCellCoordsMod`.default | SimpleCellCoords | (js.Function1[
          /* event */ KeyboardEvent, 
          typingsJapgolly.handsontable.`3rdpartyWalkontableSrcCellCoordsMod`.default | SimpleCellCoords
        ])
      ] = js.undefined
    
    var fillHandle: js.UndefOr[typingsJapgolly.handsontable.pluginsAutofillAutofillMod.Settings] = js.undefined
    ...
    var formulas: js.UndefOr[typingsJapgolly.handsontable.pluginsFormulasFormulasMod.Settings] = js.undefined
    ...
    var hiddenColumns: js.UndefOr[typingsJapgolly.handsontable.pluginsHiddenColumnsHiddenColumnsMod.Settings] = js.undefined
    
    var hiddenRows: js.UndefOr[typingsJapgolly.handsontable.pluginsHiddenRowsHiddenRowsMod.Settings] = js.undefined
    ...
    var mergeCells: js.UndefOr[typingsJapgolly.handsontable.pluginsMergeCellsMergeCellsMod.Settings] = js.undefined
    ...
    var multiColumnSorting: js.UndefOr[typingsJapgolly.handsontable.pluginsColumnSortingColumnSortingMod.Settings] = js.undefined
    
    var nestedHeaders: js.UndefOr[typingsJapgolly.handsontable.pluginsNestedHeadersNestedHeadersMod.Settings] = js.undefined
    ...
    var search: js.UndefOr[typingsJapgolly.handsontable.pluginsSearchSearchMod.Settings] = js.undefined
  ...
  object GridSettings {
    ...
    extension [Self <: GridSettings](x: Self) {
      ...
      inline def setAutoRowSize(value: typingsJapgolly.handsontable.pluginsAutoRowSizeAutoRowSizeMod.Settings): Self = StObject.set(x, "autoRowSize", value.asInstanceOf[js.Any])
      ...
      inline def setCollapsibleColumns(value: typingsJapgolly.handsontable.pluginsCollapsibleColumnsCollapsibleColumnsMod.Settings): Self = StObject.set(x, "collapsibleColumns", value.asInstanceOf[js.Any])
      ...
      inline def setColumnSorting(value: typingsJapgolly.handsontable.pluginsColumnSortingColumnSortingMod.Settings): Self = StObject.set(x, "columnSorting", value.asInstanceOf[js.Any])
      
      inline def setColumnSortingUndefined: Self = StObject.set(x, "columnSorting", js.undefined)
      
      inline def setColumnSummary(value: typingsJapgolly.handsontable.pluginsColumnSummaryColumnSummaryMod.Settings): Self = StObject.set(x, "columnSummary", value.asInstanceOf[js.Any])
      
      inline def setColumnSummaryCallbackTo(
        value: CallbackTo[
              js.Array[
                typingsJapgolly.handsontable.pluginsColumnSummaryColumnSummaryMod.DetailedSettings
              ]
            ]
      ): Self = StObject.set(x, "columnSummary", value.toJsFn)
      
      inline def setColumnSummaryUndefined: Self = StObject.set(x, "columnSummary", js.undefined)
      
      inline def setColumnSummaryVarargs(value: typingsJapgolly.handsontable.pluginsColumnSummaryColumnSummaryMod.DetailedSettings*): Self = StObject.set(x, "columnSummary", js.Array(value*))
      ...
      inline def setComments(value: typingsJapgolly.handsontable.pluginsCommentsCommentsMod.Settings): Self = StObject.set(x, "comments", value.asInstanceOf[js.Any])
      
      inline def setCommentsUndefined: Self = StObject.set(x, "comments", js.undefined)
      
      inline def setContextMenu(value: typingsJapgolly.handsontable.pluginsContextMenuContextMenuMod.Settings): Self = StObject.set(x, "contextMenu", value.asInstanceOf[js.Any])
      ...
      inline def setCopyPaste(value: typingsJapgolly.handsontable.pluginsCopyPasteCopyPasteMod.Settings): Self = StObject.set(x, "copyPaste", value.asInstanceOf[js.Any])
      ...
      inline def setCustomBorders(value: typingsJapgolly.handsontable.pluginsCustomBordersCustomBordersMod.Settings): Self = StObject.set(x, "customBorders", value.asInstanceOf[js.Any])
      
      inline def setCustomBordersUndefined: Self = StObject.set(x, "customBorders", js.undefined)
      
      inline def setCustomBordersVarargs(value: typingsJapgolly.handsontable.pluginsCustomBordersCustomBordersMod.DetailedSettings*): Self = StObject.set(x, "customBorders", js.Array(value*))
      ...
      inline def setDropdownMenu(value: typingsJapgolly.handsontable.pluginsDropdownMenuDropdownMenuMod.Settings): Self = StObject.set(x, "dropdownMenu", value.asInstanceOf[js.Any])
      ...
      inline def setEnterMoves(
        value: typingsJapgolly.handsontable.`3rdpartyWalkontableSrcCellCoordsMod`.default | SimpleCellCoords | (js.Function1[
              /* event */ KeyboardEvent, 
              typingsJapgolly.handsontable.`3rdpartyWalkontableSrcCellCoordsMod`.default | SimpleCellCoords
            ])
      ...
      inline def setEnterMovesFunction1(
        value: /* event */ KeyboardEvent => typingsJapgolly.handsontable.`3rdpartyWalkontableSrcCellCoordsMod`.default | SimpleCellCoords
      ...
      inline def setFillHandle(value: typingsJapgolly.handsontable.pluginsAutofillAutofillMod.Settings): Self = StObject.set(x, "fillHandle", value.asInstanceOf[js.Any])
      ...
      inline def setFormulas(value: typingsJapgolly.handsontable.pluginsFormulasFormulasMod.Settings): Self = StObject.set(x, "formulas", value.asInstanceOf[js.Any])
      ...
      inline def setHiddenColumns(value: typingsJapgolly.handsontable.pluginsHiddenColumnsHiddenColumnsMod.Settings): Self = StObject.set(x, "hiddenColumns", value.asInstanceOf[js.Any])
      
      inline def setHiddenColumnsUndefined: Self = StObject.set(x, "hiddenColumns", js.undefined)
      
      inline def setHiddenRows(value: typingsJapgolly.handsontable.pluginsHiddenRowsHiddenRowsMod.Settings): Self = StObject.set(x, "hiddenRows", value.asInstanceOf[js.Any])
      ...
      inline def setMergeCells(value: typingsJapgolly.handsontable.pluginsMergeCellsMergeCellsMod.Settings): Self = StObject.set(x, "mergeCells", value.asInstanceOf[js.Any])
      
      inline def setMergeCellsUndefined: Self = StObject.set(x, "mergeCells", js.undefined)
      
      inline def setMergeCellsVarargs(value: typingsJapgolly.handsontable.pluginsMergeCellsMergeCellsMod.DetailedSettings*): Self = StObject.set(x, "mergeCells", js.Array(value*))
      ...
      inline def setMultiColumnSorting(value: typingsJapgolly.handsontable.pluginsColumnSortingColumnSortingMod.Settings): Self = StObject.set(x, "multiColumnSorting", value.asInstanceOf[js.Any])
      
      inline def setMultiColumnSortingUndefined: Self = StObject.set(x, "multiColumnSorting", js.undefined)
      
      inline def setNestedHeaders(value: typingsJapgolly.handsontable.pluginsNestedHeadersNestedHeadersMod.Settings): Self = StObject.set(x, "nestedHeaders", value.asInstanceOf[js.Any])
      
      inline def setNestedHeadersUndefined: Self = StObject.set(x, "nestedHeaders", js.undefined)
      
      inline def setNestedHeadersVarargs(
        value: (js.Array[
              String | typingsJapgolly.handsontable.pluginsNestedHeadersNestedHeadersMod.DetailedSettings
            ])*
      ...
      inline def setSearch(value: typingsJapgolly.handsontable.pluginsSearchSearchMod.Settings): Self = StObject.set(x, "search", value.asInstanceOf[js.Any])
