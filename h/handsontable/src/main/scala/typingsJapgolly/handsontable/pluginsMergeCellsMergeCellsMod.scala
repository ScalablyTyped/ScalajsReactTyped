...
object pluginsMergeCellsMergeCellsMod {
  ...
  open class MergeCells protected () extends BasePlugin {
    ...
    def mergeSelection(cellRange: typingsJapgolly.handsontable.`3rdpartyWalkontableSrcCellRangeMod`.default): Unit = js.native
    ...
    def unmergeSelection(cellRange: typingsJapgolly.handsontable.`3rdpartyWalkontableSrcCellRangeMod`.default): Unit = js.native
  }
