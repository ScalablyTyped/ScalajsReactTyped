...
import typingsJapgolly.handsontable.pluginsColumnSummaryColumnSummaryMod.DetailedSettings
import typingsJapgolly.handsontable.pluginsColumnSummaryColumnSummaryMod.Endpoint
