...
object ServerMethodOptions {
  ...
  def apply(
    ...
    generateKey: /* repeated */ js.Any => CallbackTo[String | Null] = null
  ): ServerMethodOptions = {
    val __obj = js.Dynamic.literal()
    if (bind != null) __obj.updateDynamic("bind")(bind.asInstanceOf[js.Any])
    if (cache != null) __obj.updateDynamic("cache")(cache.asInstanceOf[js.Any])
    if (generateKey != null) __obj.updateDynamic("generateKey")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => generateKey(t0).runNow()))
