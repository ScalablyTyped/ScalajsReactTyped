...
import typingsJapgolly.hapi.hapiStrings.log
import typingsJapgolly.hapi.hapiStrings.request
import typingsJapgolly.hapi.hapiStrings.response
import typingsJapgolly.hapi.hapiStrings.route
