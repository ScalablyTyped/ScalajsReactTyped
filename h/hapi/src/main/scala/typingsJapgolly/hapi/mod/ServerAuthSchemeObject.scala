...
import typingsJapgolly.hapi.AnonPayload
...
object ServerAuthSchemeObject {
  ...
  def apply(
    ...
    __obj.updateDynamic("authenticate")(js.Any.fromFunction2((t0: typingsJapgolly.hapi.mod.Request, t1: typingsJapgolly.hapi.mod.ResponseToolkit) => authenticate(t0, t1).runNow()))
    if (api != null) __obj.updateDynamic("api")(api.asInstanceOf[js.Any])
    if (options != null) __obj.updateDynamic("options")(options.asInstanceOf[js.Any])
    if (payload != null) __obj.updateDynamic("payload")(js.Any.fromFunction2((t0: /* request */ typingsJapgolly.hapi.mod.Request, t1: /* h */ typingsJapgolly.hapi.mod.ResponseToolkit) => payload(t0, t1).runNow()))
    if (response != null) __obj.updateDynamic("response")(js.Any.fromFunction2((t0: /* request */ typingsJapgolly.hapi.mod.Request, t1: /* h */ typingsJapgolly.hapi.mod.ResponseToolkit) => response(t0, t1).runNow()))
    if (verify != null) __obj.updateDynamic("verify")(js.Any.fromFunction1((t0: /* auth */ typingsJapgolly.hapi.mod.RequestAuth) => verify(t0).runNow()))
