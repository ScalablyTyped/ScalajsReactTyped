...
import typingsJapgolly.hapi.anon.Collect
import typingsJapgolly.hapi.anon.FailAction
import typingsJapgolly.hapi.anon.RelativeTo
import typingsJapgolly.hapi.anon.keyinRouteRequestExtTypeR
import typingsJapgolly.hapi.hapiBooleans.`false`
import typingsJapgolly.hapi.mod.Json.StringifyArguments
...
trait RouteOptions extends StObject {
  ...
  /**
    ...
    */
  var timeout: js.UndefOr[typingsJapgolly.hapi.anon.Server] = js.undefined
...
object RouteOptions {
  ...
  extension [Self <: RouteOptions](x: Self) {
    ...
    inline def setTimeout(value: typingsJapgolly.hapi.anon.Server): Self = StObject.set(x, "timeout", value.asInstanceOf[js.Any])
