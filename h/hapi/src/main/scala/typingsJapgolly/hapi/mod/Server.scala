...
import typingsJapgolly.hapi.AnonApply
import typingsJapgolly.hapi.AnonApplyBoolean
import typingsJapgolly.hapi.AnonApplyExtend
import typingsJapgolly.hapi.AnonEventLoopDelay
import typingsJapgolly.hapi.AnonExtend
import typingsJapgolly.hapi.AnonMethod
import typingsJapgolly.hapi.AnonRequest
import typingsJapgolly.hapi.AnonTimeout
import typingsJapgolly.hapi.AnonValidate
...
class Server () extends js.Object {
  ...
  /**
    ...
    */
  var listener: typingsJapgolly.node.httpMod.Server = js.native
  /**
