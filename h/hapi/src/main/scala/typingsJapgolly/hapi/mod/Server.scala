...
import typingsJapgolly.hapi.anon.Apply
import typingsJapgolly.hapi.anon.ApplyExtend
import typingsJapgolly.hapi.anon.Concurrent
import typingsJapgolly.hapi.anon.Extend
import typingsJapgolly.hapi.anon.Timeout
import typingsJapgolly.hapi.anon.Validate
import typingsJapgolly.hapi.anon.`0`
import typingsJapgolly.hapi.hapiStrings.handler
import typingsJapgolly.hapi.hapiStrings.request
import typingsJapgolly.hapi.hapiStrings.server
import typingsJapgolly.hapi.hapiStrings.socket
import typingsJapgolly.hapi.hapiStrings.tcp
import typingsJapgolly.hapi.hapiStrings.toolkit
...
open class Server () extends StObject {
  ...
  /**
    ...
    */
  val decorations: typingsJapgolly.hapi.anon.Request = js.native
  ...
  /**
    ...
    */
  var listener: typingsJapgolly.node.httpMod.Server[
  ...
  /**
    ...
    */
  def rules(
    processor: js.Function2[/* rules */ js.Object, /* info */ typingsJapgolly.hapi.anon.Method, js.Object]
  ): Unit = js.native
  def rules(
    processor: js.Function2[/* rules */ js.Object, /* info */ typingsJapgolly.hapi.anon.Method, js.Object],
    options: Validate
