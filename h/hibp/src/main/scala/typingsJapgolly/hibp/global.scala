...
import typingsJapgolly.hibp.anon.ApiKey
import typingsJapgolly.hibp.anon.BaseUrl
import typingsJapgolly.hibp.anon.Domain
import typingsJapgolly.hibp.anon.Truncate
import typingsJapgolly.hibp.anon.UserAgent
import typingsJapgolly.hibp.mod.Breach_
import typingsJapgolly.hibp.mod.Paste
import typingsJapgolly.hibp.mod.PwnedPasswordSuffixes
import typingsJapgolly.hibp.mod.SearchResults
...
object global {
  ...
  object hibp {
    ...
    open class RateLimitError protected ()
      extends typingsJapgolly.hibp.mod.RateLimitError {
      def this(
