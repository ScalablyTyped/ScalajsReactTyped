...
import typingsJapgolly.hlsParser.mod.types.PartialSegment
...
trait Byterange extends StObject {
  ...
  var byterange: js.UndefOr[typingsJapgolly.hlsParser.mod.Byterange] = js.undefined
...
object Byterange {
  ...
  extension [Self <: Byterange](x: Self) {
    ...
    inline def setByterange(value: typingsJapgolly.hlsParser.mod.Byterange): Self = StObject.set(x, "byterange", value.asInstanceOf[js.Any])
