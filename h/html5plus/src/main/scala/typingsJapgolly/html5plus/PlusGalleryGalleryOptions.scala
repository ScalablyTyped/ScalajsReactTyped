...
import typingsJapgolly.html5plus.html5plusStrings.image
import typingsJapgolly.html5plus.html5plusStrings.none
import typingsJapgolly.html5plus.html5plusStrings.video
...
object PlusGalleryGalleryOptions {
  ...
  def apply(
    ...
    onmaxed: js.UndefOr[Callback] = js.undefined,
    ...
    onmaxed.foreach(p => __obj.updateDynamic("onmaxed")(p.toJsFn))
