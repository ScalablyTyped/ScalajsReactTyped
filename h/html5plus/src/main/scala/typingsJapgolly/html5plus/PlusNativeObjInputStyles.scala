...
object PlusNativeObjInputStyles {
  ...
  extension [Self <: PlusNativeObjInputStyles](x: Self) {
    ...
    inline def setOnBlur(value: /* result */ Any => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: /* result */ Any) => value(t0).runNow()))
    
    inline def setOnBlurUndefined: Self = StObject.set(x, "onBlur", js.undefined)
    
    inline def setOnComplete(value: /* result */ Any => Callback): Self = StObject.set(x, "onComplete", js.Any.fromFunction1((t0: /* result */ Any) => value(t0).runNow()))
    
    inline def setOnCompleteUndefined: Self = StObject.set(x, "onComplete", js.undefined)
    
    inline def setOnFocus(value: /* result */ Any => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: /* result */ Any) => value(t0).runNow()))
