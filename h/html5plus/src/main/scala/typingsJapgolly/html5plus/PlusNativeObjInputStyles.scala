...
import typingsJapgolly.html5plus.html5plusStrings.email
import typingsJapgolly.html5plus.html5plusStrings.number
import typingsJapgolly.html5plus.html5plusStrings.search
import typingsJapgolly.html5plus.html5plusStrings.tel
import typingsJapgolly.html5plus.html5plusStrings.text
import typingsJapgolly.html5plus.html5plusStrings.url
...
object PlusNativeObjInputStyles {
  ...
  def apply(
    ...
    onBlur: /* result */ js.Any => Callback = null,
    onComplete: /* result */ js.Any => Callback = null,
    onFocus: /* result */ js.Any => Callback = null,
    ...
    if (onBlur != null) __obj.updateDynamic("onBlur")(js.Any.fromFunction1((t0: /* result */ js.Any) => onBlur(t0).runNow()))
    if (onComplete != null) __obj.updateDynamic("onComplete")(js.Any.fromFunction1((t0: /* result */ js.Any) => onComplete(t0).runNow()))
    if (onFocus != null) __obj.updateDynamic("onFocus")(js.Any.fromFunction1((t0: /* result */ js.Any) => onFocus(t0).runNow()))
