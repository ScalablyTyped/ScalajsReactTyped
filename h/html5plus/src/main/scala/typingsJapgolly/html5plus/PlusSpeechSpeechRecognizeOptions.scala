...
object PlusSpeechSpeechRecognizeOptions {
  ...
  def apply(
    ...
    onend: /* result */ js.Any => Callback = null,
    onstart: /* result */ js.Any => Callback = null,
    ...
    if (onend != null) __obj.updateDynamic("onend")(js.Any.fromFunction1((t0: /* result */ js.Any) => onend(t0).runNow()))
    if (onstart != null) __obj.updateDynamic("onstart")(js.Any.fromFunction1((t0: /* result */ js.Any) => onstart(t0).runNow()))
