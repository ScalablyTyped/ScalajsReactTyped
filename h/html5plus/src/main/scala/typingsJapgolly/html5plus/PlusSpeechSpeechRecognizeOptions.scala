...
object PlusSpeechSpeechRecognizeOptions {
  ...
  extension [Self <: PlusSpeechSpeechRecognizeOptions](x: Self) {
    ...
    inline def setOnend(value: /* result */ Any => Callback): Self = StObject.set(x, "onend", js.Any.fromFunction1((t0: /* result */ Any) => value(t0).runNow()))
    
    inline def setOnendUndefined: Self = StObject.set(x, "onend", js.undefined)
    
    inline def setOnstart(value: /* result */ Any => Callback): Self = StObject.set(x, "onstart", js.Any.fromFunction1((t0: /* result */ Any) => value(t0).runNow()))
