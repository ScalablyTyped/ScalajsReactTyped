...
import typingsJapgolly.hapiGlue.anon.Plugins
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setPreConnections(value: (/* Server */ Server_, /* next */ js.Function1[/* err */ Any, Unit]) => Callback): Self = StObject.set(x, "preConnections", js.Any.fromFunction2((t0: /* Server */ Server_, t1: /* next */ js.Function1[/* err */ Any, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setPreConnectionsUndefined: Self = StObject.set(x, "preConnections", js.undefined)
      
      inline def setPreRegister(value: (/* Server */ Server_, /* next */ js.Function1[/* err */ Any, Unit]) => Callback): Self = StObject.set(x, "preRegister", js.Any.fromFunction2((t0: /* Server */ Server_, t1: /* next */ js.Function1[/* err */ Any, Unit]) => (value(t0, t1)).runNow()))
