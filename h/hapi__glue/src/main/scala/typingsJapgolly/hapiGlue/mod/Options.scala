...
object Options {
  ...
  def apply(
    ...
    if (preConnections != null) __obj.updateDynamic("preConnections")(js.Any.fromFunction2((t0: /* Server */ typingsJapgolly.hapiHapi.mod.Server, t1: /* next */ js.Function1[/* err */ js.Any, scala.Unit]) => preConnections(t0, t1).runNow()))
    if (preRegister != null) __obj.updateDynamic("preRegister")(js.Any.fromFunction2((t0: /* Server */ typingsJapgolly.hapiHapi.mod.Server, t1: /* next */ js.Function1[/* err */ js.Any, scala.Unit]) => preRegister(t0, t1).runNow()))
