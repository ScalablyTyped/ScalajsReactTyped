package typingsJapgolly.heatmapJs
...
object mod {
  ...
  open class Heatmap[V /* <: String */, X /* <: String */, Y /* <: String */] () extends StObject {
    ...
    /**
      ...
      */
    def getValueAt(point: typingsJapgolly.heatmapJs.anon.X): Double = js.native
  ...
  object BaseHeatmapConfiguration {
    ...
    extension [Self <: BaseHeatmapConfiguration[?], V /* <: String */](x: Self & BaseHeatmapConfiguration[V]) {
      ...
      inline def setOnExtremaChange(value: Callback): Self = StObject.set(x, "onExtremaChange", value.toJsFn)
