...
import typingsJapgolly.hyperformula.typingsCellMod.CellValueDetailedType
...
object typingsInterpreterInterpreterValueMod {
  ...
  object NumberType extends StObject {
    ...
    sealed trait NUMBER_CURRENCY
      extends StObject
         with NumberType
    /* "NUMBER_CURRENCY" */ val NUMBER_CURRENCY: typingsJapgolly.hyperformula.typingsInterpreterInterpreterValueMod.NumberType.NUMBER_CURRENCY & String = js.native
    
    @js.native
    sealed trait NUMBER_DATE
      extends StObject
         with NumberType
    /* "NUMBER_DATE" */ val NUMBER_DATE: typingsJapgolly.hyperformula.typingsInterpreterInterpreterValueMod.NumberType.NUMBER_DATE & String = js.native
    
    @js.native
    sealed trait NUMBER_DATETIME
      extends StObject
         with NumberType
    /* "NUMBER_DATETIME" */ val NUMBER_DATETIME: typingsJapgolly.hyperformula.typingsInterpreterInterpreterValueMod.NumberType.NUMBER_DATETIME & String = js.native
    
    @js.native
    sealed trait NUMBER_PERCENT
      extends StObject
         with NumberType
    /* "NUMBER_PERCENT" */ val NUMBER_PERCENT: typingsJapgolly.hyperformula.typingsInterpreterInterpreterValueMod.NumberType.NUMBER_PERCENT & String = js.native
    
    @js.native
    sealed trait NUMBER_RAW
      extends StObject
         with NumberType
    /* "NUMBER_RAW" */ val NUMBER_RAW: typingsJapgolly.hyperformula.typingsInterpreterInterpreterValueMod.NumberType.NUMBER_RAW & String = js.native
    
    @js.native
    sealed trait NUMBER_TIME
      extends StObject
         with NumberType
    /* "NUMBER_TIME" */ val NUMBER_TIME: typingsJapgolly.hyperformula.typingsInterpreterInterpreterValueMod.NumberType.NUMBER_TIME & String = js.native
  }
