...
import typingsJapgolly.hyperformula.hyperformulaStrings.Space
import typingsJapgolly.hyperformula.hyperformulaStrings.Verticalline
import typingsJapgolly.hyperformula.hyperformulaStrings._empty
import typingsJapgolly.hyperformula.hyperformulaStrings.`false`
import typingsJapgolly.hyperformula.hyperformulaStrings.any
import typingsJapgolly.hyperformula.hyperformulaStrings.lower
import typingsJapgolly.hyperformula.hyperformulaStrings.standard
import typingsJapgolly.hyperformula.hyperformulaStrings.upper
import typingsJapgolly.hyperformula.typingsCellMod.TranslatableErrorType
import typingsJapgolly.hyperformula.typingsDateTimeHelperMod.DateTime
import typingsJapgolly.hyperformula.typingsDateTimeHelperMod.SimpleDate
...
import typingsJapgolly.hyperformula.typingsHelpersLicenseKeyValidatorMod.LicenseKeyValidityState
...
object typingsConfigMod {
  ...
  - typingsJapgolly.hyperformula.typingsParserParserConfigMod.ParserConfig because var conflicts: arrayColumnSeparator, arrayRowSeparator, decimalSeparator, functionArgSeparator, ignoreWhiteSpace, maxColumns, maxRows. Inlined translationPackage, errorMapping */ @JSImport("hyperformula/typings/Config", "Config")
  @js.native
  open class Config ()
    extends StObject
       with ConfigParams {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.hyperformula.hyperformulaStrings.accentSensitive
    - typingsJapgolly.hyperformula.hyperformulaStrings.binarySearchThreshold
    - typingsJapgolly.hyperformula.hyperformulaStrings.caseSensitive
    - typingsJapgolly.hyperformula.hyperformulaStrings.caseFirst
    - typingsJapgolly.hyperformula.hyperformulaStrings.chooseAddressMappingPolicy
    - typingsJapgolly.hyperformula.hyperformulaStrings.currencySymbol
    - typingsJapgolly.hyperformula.hyperformulaStrings.dateFormats
    - typingsJapgolly.hyperformula.hyperformulaStrings.functionArgSeparator
    - typingsJapgolly.hyperformula.hyperformulaStrings.decimalSeparator
    - typingsJapgolly.hyperformula.hyperformulaStrings.evaluateNullToZero
    - typingsJapgolly.hyperformula.hyperformulaStrings.functionPlugins
    - typingsJapgolly.hyperformula.hyperformulaStrings.ignorePunctuation
    - typingsJapgolly.hyperformula.hyperformulaStrings.language
    - typingsJapgolly.hyperformula.hyperformulaStrings.ignoreWhiteSpace
    - typingsJapgolly.hyperformula.hyperformulaStrings.leapYear1900
    - typingsJapgolly.hyperformula.hyperformulaStrings.licenseKey
    - typingsJapgolly.hyperformula.hyperformulaStrings.localeLang
    - typingsJapgolly.hyperformula.hyperformulaStrings.matchWholeCell
    - typingsJapgolly.hyperformula.hyperformulaStrings.arrayColumnSeparator
    - typingsJapgolly.hyperformula.hyperformulaStrings.arrayRowSeparator
    - typingsJapgolly.hyperformula.hyperformulaStrings.maxRows
    - typingsJapgolly.hyperformula.hyperformulaStrings.maxColumns
    - typingsJapgolly.hyperformula.hyperformulaStrings.nullDate
    - typingsJapgolly.hyperformula.hyperformulaStrings.nullYear
    - typingsJapgolly.hyperformula.hyperformulaStrings.precisionEpsilon
    - typingsJapgolly.hyperformula.hyperformulaStrings.precisionRounding
    - typingsJapgolly.hyperformula.hyperformulaStrings.smartRounding
    - typingsJapgolly.hyperformula.hyperformulaStrings.thousandSeparator
    - typingsJapgolly.hyperformula.hyperformulaStrings.timeFormats
    - typingsJapgolly.hyperformula.hyperformulaStrings.useArrayArithmetic
    - typingsJapgolly.hyperformula.hyperformulaStrings.useColumnIndex
    - typingsJapgolly.hyperformula.hyperformulaStrings.useStats
    - typingsJapgolly.hyperformula.hyperformulaStrings.undoLimit
    - typingsJapgolly.hyperformula.hyperformulaStrings.useRegularExpressions
    - typingsJapgolly.hyperformula.hyperformulaStrings.useWildcards
  */
