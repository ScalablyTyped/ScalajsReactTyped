...
trait GreaterThanNumberLessThanUndefined extends StObject {
...
object GreaterThanNumberLessThanUndefined {
  
  inline def apply(argumentType: ArgumentTypes, greaterThan: Double, lessThan: Unit): GreaterThanNumberLessThanUndefined = {
    ...
    __obj.asInstanceOf[GreaterThanNumberLessThanUndefined]
  }
  
  extension [Self <: GreaterThanNumberLessThanUndefined](x: Self) {
