...
import typingsJapgolly.hyperformula.anon.BESSELI
import typingsJapgolly.hyperformula.anon.BETADIST
...
open class StatisticalPlugin protected ()
  extends typingsJapgolly.hyperformula.typingsInterpreterPluginStatisticalPluginMod.StatisticalPlugin {
