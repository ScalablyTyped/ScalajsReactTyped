...
import typingsJapgolly.hyperformula.typingsInterpreterInterpreterValueMod.ExtendedNumber
import typingsJapgolly.hyperformula.typingsInterpreterInterpreterValueMod.InternalNoErrorScalarValue
...
import typingsJapgolly.hyperformula.typingsInterpreterInterpreterValueMod.NumberTypeWithFormat
...
import typingsJapgolly.hyperformula.typingsNumberLiteralHelperMod.NumberLiteralHelper
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object typingsInterpreterArithmeticHelperMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.hyperformula.hyperformulaStrings.nfc
    - typingsJapgolly.hyperformula.hyperformulaStrings.nfd
    - typingsJapgolly.hyperformula.hyperformulaStrings.nfkc
    - typingsJapgolly.hyperformula.hyperformulaStrings.nfkd
  */
  trait NormalizationForm extends StObject
  object NormalizationForm {
    
    inline def nfc: typingsJapgolly.hyperformula.hyperformulaStrings.nfc = "nfc".asInstanceOf[typingsJapgolly.hyperformula.hyperformulaStrings.nfc]
    
    inline def nfd: typingsJapgolly.hyperformula.hyperformulaStrings.nfd = "nfd".asInstanceOf[typingsJapgolly.hyperformula.hyperformulaStrings.nfd]
    
    inline def nfkc: typingsJapgolly.hyperformula.hyperformulaStrings.nfkc = "nfkc".asInstanceOf[typingsJapgolly.hyperformula.hyperformulaStrings.nfkc]
    
    inline def nfkd: typingsJapgolly.hyperformula.hyperformulaStrings.nfkd = "nfkd".asInstanceOf[typingsJapgolly.hyperformula.hyperformulaStrings.nfkd]
  }
