...
import typingsJapgolly.hyperformula.anon.PartialdateTimeDateTimeda
...
object typingsDateTimeHelperMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.hyperformula.typingsDateTimeHelperMod.SimpleTime
    - typingsJapgolly.hyperformula.typingsDateTimeHelperMod.SimpleDate
    - typingsJapgolly.hyperformula.typingsDateTimeHelperMod.SimpleDateTime
  */
  trait DateTime extends StObject
  object DateTime {
    
    inline def SimpleDate(day: Double, month: Double, year: Double): typingsJapgolly.hyperformula.typingsDateTimeHelperMod.SimpleDate = {
      val __obj = js.Dynamic.literal(day = day.asInstanceOf[js.Any], month = month.asInstanceOf[js.Any], year = year.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.hyperformula.typingsDateTimeHelperMod.SimpleDate]
    }
    
    inline def SimpleDateTime(day: Double, hours: Double, minutes: Double, month: Double, seconds: Double, year: Double): typingsJapgolly.hyperformula.typingsDateTimeHelperMod.SimpleDateTime = {
      ...
      __obj.asInstanceOf[typingsJapgolly.hyperformula.typingsDateTimeHelperMod.SimpleDateTime]
    }
    
    inline def SimpleTime(hours: Double, minutes: Double, seconds: Double): typingsJapgolly.hyperformula.typingsDateTimeHelperMod.SimpleTime = {
      ...
      __obj.asInstanceOf[typingsJapgolly.hyperformula.typingsDateTimeHelperMod.SimpleTime]
    }
  }
  ...
  - typingsJapgolly.hyperformula.typingsDateTimeHelperMod.DateTime because Already inherited */ trait SimpleDateTime
    extends StObject
       with SimpleDate
       with SimpleTime
