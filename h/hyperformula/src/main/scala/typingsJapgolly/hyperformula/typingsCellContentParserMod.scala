...
import typingsJapgolly.hyperformula.typingsCellContentParserMod.CellContent.Type
...
object typingsCellContentParserMod {
  ...
  object CellContent {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.hyperformula.typingsCellContentParserMod.CellContent.Number
      - typingsJapgolly.hyperformula.typingsCellContentParserMod.CellContent.String
      - typingsJapgolly.hyperformula.typingsCellContentParserMod.CellContent.Boolean
      - typingsJapgolly.hyperformula.typingsCellContentParserMod.CellContent.Empty
      - typingsJapgolly.hyperformula.typingsCellContentParserMod.CellContent.Formula
      - typingsJapgolly.hyperformula.typingsCellContentParserMod.CellContent.Error
    */
