...
@js.native
open class default ()
  extends typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula
object default {
  ...
  object CellValueType {
    ...
    inline def NUMBER_=(x: typingsJapgolly.hyperformula.typingsCellMod.CellValueJustNumber.NUMBER): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NUMBER")(x.asInstanceOf[js.Any])
  ...
  open class ConfigValueTooBigError protected ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.ConfigValueTooBigError {
  ...
  def ConfigValueTooBigError: Instantiable2[
    /* paramName */ String, 
    /* maximum */ Double, 
    typingsJapgolly.hyperformula.typingsErrorsMod.ConfigValueTooBigError
  ] = js.native
  ...
  def ConfigValueTooSmallError: Instantiable2[
    /* paramName */ String, 
    /* minimum */ Double, 
    typingsJapgolly.hyperformula.typingsErrorsMod.ConfigValueTooSmallError
  ] = js.native
  ...
  open class DetailedCellError protected ()
    extends typingsJapgolly.hyperformula.typingsCellValueMod.DetailedCellError {
    def this(error: typingsJapgolly.hyperformula.typingsCellMod.CellError, value: String) = this()
    def this(error: typingsJapgolly.hyperformula.typingsCellMod.CellError, value: String, address: String) = this()
  }
  /* static member */
  ...
  def DetailedCellError: Instantiable3[
    /* error */ typingsJapgolly.hyperformula.typingsCellMod.CellError, 
    /* value */ String, 
    /* address */ js.UndefOr[String], 
    typingsJapgolly.hyperformula.typingsCellValueMod.DetailedCellError
  ] = js.native
  ...
  @JSImport("hyperformula", "default.EvaluationSuspendedError")
  @js.native
  def EvaluationSuspendedError: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.EvaluationSuspendedError] = js.native
  inline def EvaluationSuspendedError_=(x: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.EvaluationSuspendedError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EvaluationSuspendedError")(x.asInstanceOf[js.Any])
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("hyperformula", "default.ExpectedOneOfValuesError")
  @js.native
  open class ExpectedOneOfValuesError protected ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.ExpectedOneOfValuesError {
  ...
  def ExpectedOneOfValuesError: Instantiable2[
    /* values */ String, 
    /* paramName */ String, 
    typingsJapgolly.hyperformula.typingsErrorsMod.ExpectedOneOfValuesError
  ] = js.native
  ...
  def ExpectedValueOfTypeError: Instantiable2[
    /* expectedType */ String, 
    /* paramName */ String, 
    typingsJapgolly.hyperformula.typingsErrorsMod.ExpectedValueOfTypeError
  ] = js.native
  ...
  open class ExportedCellChange protected ()
    extends typingsJapgolly.hyperformula.typingsExporterMod.ExportedCellChange {
  ...
  open class FunctionPlugin protected ()
    extends typingsJapgolly.hyperformula.typingsInterpreterMod.FunctionPlugin {
  ...
  object HyperFormula {
    ...
    /**
      ...
      * @category Factories
      */
    inline def buildEmpty(): typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula = ^.asInstanceOf[js.Dynamic].applyDynamic("buildEmpty")().asInstanceOf[typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula]
    inline def buildEmpty(configInput: Unit, namedExpressions: js.Array[SerializedNamedExpression]): typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula = (^.asInstanceOf[js.Dynamic].applyDynamic("buildEmpty")(configInput.asInstanceOf[js.Any], namedExpressions.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula]
    inline def buildEmpty(configInput: PartialConfigParams): typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula = ^.asInstanceOf[js.Dynamic].applyDynamic("buildEmpty")(configInput.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula]
    inline def buildEmpty(configInput: PartialConfigParams, namedExpressions: js.Array[SerializedNamedExpression]): typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula = (^.asInstanceOf[js.Dynamic].applyDynamic("buildEmpty")(configInput.asInstanceOf[js.Any], namedExpressions.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula]
    ...
    /**
      ...
      * @category Factories
      */
    inline def buildFromArray(sheet: Sheet): typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula = ^.asInstanceOf[js.Dynamic].applyDynamic("buildFromArray")(sheet.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula]
    inline def buildFromArray(sheet: Sheet, configInput: Unit, namedExpressions: js.Array[SerializedNamedExpression]): typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula = (^.asInstanceOf[js.Dynamic].applyDynamic("buildFromArray")(sheet.asInstanceOf[js.Any], configInput.asInstanceOf[js.Any], namedExpressions.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula]
    inline def buildFromArray(sheet: Sheet, configInput: PartialConfigParams): typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula = (^.asInstanceOf[js.Dynamic].applyDynamic("buildFromArray")(sheet.asInstanceOf[js.Any], configInput.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula]
    inline def buildFromArray(
      sheet: Sheet,
      configInput: PartialConfigParams,
      namedExpressions: js.Array[SerializedNamedExpression]
    ): typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula = (^.asInstanceOf[js.Dynamic].applyDynamic("buildFromArray")(sheet.asInstanceOf[js.Any], configInput.asInstanceOf[js.Any], namedExpressions.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula]
    ...
    /**
      ...
      * @category Factories
      */
    inline def buildFromSheets(sheets: Sheets): typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula = ^.asInstanceOf[js.Dynamic].applyDynamic("buildFromSheets")(sheets.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula]
    inline def buildFromSheets(sheets: Sheets, configInput: Unit, namedExpressions: js.Array[SerializedNamedExpression]): typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula = (^.asInstanceOf[js.Dynamic].applyDynamic("buildFromSheets")(sheets.asInstanceOf[js.Any], configInput.asInstanceOf[js.Any], namedExpressions.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula]
    inline def buildFromSheets(sheets: Sheets, configInput: PartialConfigParams): typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula = (^.asInstanceOf[js.Dynamic].applyDynamic("buildFromSheets")(sheets.asInstanceOf[js.Any], configInput.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula]
    inline def buildFromSheets(
      sheets: Sheets,
      configInput: PartialConfigParams,
      namedExpressions: js.Array[SerializedNamedExpression]
    ): typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula = (^.asInstanceOf[js.Dynamic].applyDynamic("buildFromSheets")(sheets.asInstanceOf[js.Any], configInput.asInstanceOf[js.Any], namedExpressions.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.hyperformula.typingsHyperFormulaMod.HyperFormula]
  ...
  open class InvalidAddressError protected ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.InvalidAddressError {
  ...
  def InvalidAddressError: Instantiable1[
    /* address */ SimpleCellAddress_, 
    typingsJapgolly.hyperformula.typingsErrorsMod.InvalidAddressError
  ] = js.native
  ...
  def InvalidArgumentsError: Instantiable1[
    ...
    typingsJapgolly.hyperformula.typingsErrorsMod.InvalidArgumentsError
  ] = js.native
  ...
  @JSImport("hyperformula", "default.LanguageAlreadyRegisteredError")
  @js.native
  def LanguageAlreadyRegisteredError: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.LanguageAlreadyRegisteredError] = js.native
  inline def LanguageAlreadyRegisteredError_=(x: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.LanguageAlreadyRegisteredError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("LanguageAlreadyRegisteredError")(x.asInstanceOf[js.Any])
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("hyperformula", "default.LanguageNotRegisteredError")
  @js.native
  open class LanguageNotRegisteredError ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.LanguageNotRegisteredError
  /* static member */
  /* was `typeof LanguageNotRegisteredError` */
  @JSImport("hyperformula", "default.LanguageNotRegisteredError")
  @js.native
  def LanguageNotRegisteredError: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.LanguageNotRegisteredError] = js.native
  inline def LanguageNotRegisteredError_=(x: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.LanguageNotRegisteredError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("LanguageNotRegisteredError")(x.asInstanceOf[js.Any])
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("hyperformula", "default.MissingTranslationError")
  @js.native
  open class MissingTranslationError protected ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.MissingTranslationError {
  ...
  @JSImport("hyperformula", "default.MissingTranslationError")
  @js.native
  def MissingTranslationError: Instantiable1[
    /* key */ String, 
    typingsJapgolly.hyperformula.typingsErrorsMod.MissingTranslationError
  ] = js.native
  inline def MissingTranslationError_=(
    x: Instantiable1[
      /* key */ String, 
      typingsJapgolly.hyperformula.typingsErrorsMod.MissingTranslationError
    ]
  ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MissingTranslationError")(x.asInstanceOf[js.Any])
  ...
  def NamedExpressionDoesNotExistError: Instantiable1[
    ...
    typingsJapgolly.hyperformula.typingsErrorsMod.NamedExpressionDoesNotExistError
  ] = js.native
  ...
  def NamedExpressionNameIsAlreadyTakenError: Instantiable1[
    /* expressionName */ String, 
    typingsJapgolly.hyperformula.typingsErrorsMod.NamedExpressionNameIsAlreadyTakenError
  ] = js.native
  ...
  open class NamedExpressionNameIsInvalidError protected ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.NamedExpressionNameIsInvalidError {
    def this(expressionName: String) = this()
  }
  /* static member */
  ...
  def NamedExpressionNameIsInvalidError: Instantiable1[
    /* expressionName */ String, 
    typingsJapgolly.hyperformula.typingsErrorsMod.NamedExpressionNameIsInvalidError
  ] = js.native
  ...
  open class NoOperationToRedoError ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.NoOperationToRedoError
  /* static member */
  /* was `typeof NoOperationToRedoError` */
  @JSImport("hyperformula", "default.NoOperationToRedoError")
  @js.native
  def NoOperationToRedoError: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.NoOperationToRedoError] = js.native
  inline def NoOperationToRedoError_=(x: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.NoOperationToRedoError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NoOperationToRedoError")(x.asInstanceOf[js.Any])
  ...
  @JSImport("hyperformula", "default.NoOperationToUndoError")
  @js.native
  def NoOperationToUndoError: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.NoOperationToUndoError] = js.native
  inline def NoOperationToUndoError_=(x: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.NoOperationToUndoError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NoOperationToUndoError")(x.asInstanceOf[js.Any])
  ...
  @JSImport("hyperformula", "default.NoRelativeAddressesAllowedError")
  @js.native
  def NoRelativeAddressesAllowedError: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.NoRelativeAddressesAllowedError] = js.native
  inline def NoRelativeAddressesAllowedError_=(x: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.NoRelativeAddressesAllowedError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NoRelativeAddressesAllowedError")(x.asInstanceOf[js.Any])
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("hyperformula", "default.NoSheetWithIdError")
  @js.native
  open class NoSheetWithIdError protected ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.NoSheetWithIdError {
  ...
  @JSImport("hyperformula", "default.NoSheetWithIdError")
  @js.native
  def NoSheetWithIdError: Instantiable1[
    /* sheetId */ Double, 
    typingsJapgolly.hyperformula.typingsErrorsMod.NoSheetWithIdError
  ] = js.native
  inline def NoSheetWithIdError_=(
    x: Instantiable1[
      /* sheetId */ Double, 
      typingsJapgolly.hyperformula.typingsErrorsMod.NoSheetWithIdError
    ]
  ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NoSheetWithIdError")(x.asInstanceOf[js.Any])
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("hyperformula", "default.NoSheetWithNameError")
  @js.native
  open class NoSheetWithNameError protected ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.NoSheetWithNameError {
  ...
  @JSImport("hyperformula", "default.NoSheetWithNameError")
  @js.native
  def NoSheetWithNameError: Instantiable1[
    /* sheetName */ String, 
    typingsJapgolly.hyperformula.typingsErrorsMod.NoSheetWithNameError
  ] = js.native
  ...
  open class NotAFormulaError ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.NotAFormulaError
  /* static member */
  /* was `typeof NotAFormulaError` */
  @JSImport("hyperformula", "default.NotAFormulaError")
  @js.native
  def NotAFormulaError: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.NotAFormulaError] = js.native
  inline def NotAFormulaError_=(x: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.NotAFormulaError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NotAFormulaError")(x.asInstanceOf[js.Any])
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("hyperformula", "default.NothingToPasteError")
  @js.native
  open class NothingToPasteError ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.NothingToPasteError
  /* static member */
  /* was `typeof NothingToPasteError` */
  @JSImport("hyperformula", "default.NothingToPasteError")
  @js.native
  def NothingToPasteError: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.NothingToPasteError] = js.native
  inline def NothingToPasteError_=(x: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.NothingToPasteError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NothingToPasteError")(x.asInstanceOf[js.Any])
  ...
  def ProtectedFunctionTranslationError: Instantiable1[
    /* key */ String, 
    typingsJapgolly.hyperformula.typingsErrorsMod.ProtectedFunctionTranslationError
  ] = js.native
  ...
  open class SheetNameAlreadyTakenError protected ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.SheetNameAlreadyTakenError {
    def this(sheetName: String) = this()
  }
  /* static member */
  ...
  def SheetNameAlreadyTakenError: Instantiable1[
    /* sheetName */ String, 
    typingsJapgolly.hyperformula.typingsErrorsMod.SheetNameAlreadyTakenError
  ] = js.native
  ...
  open class SheetSizeLimitExceededError ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.SheetSizeLimitExceededError
  /* static member */
  /* was `typeof SheetSizeLimitExceededError` */
  @JSImport("hyperformula", "default.SheetSizeLimitExceededError")
  @js.native
  def SheetSizeLimitExceededError: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.SheetSizeLimitExceededError] = js.native
  inline def SheetSizeLimitExceededError_=(x: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.SheetSizeLimitExceededError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SheetSizeLimitExceededError")(x.asInstanceOf[js.Any])
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("hyperformula", "default.SourceLocationHasArrayError")
  @js.native
  open class SourceLocationHasArrayError ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.SourceLocationHasArrayError
  /* static member */
  /* was `typeof SourceLocationHasArrayError` */
  @JSImport("hyperformula", "default.SourceLocationHasArrayError")
  @js.native
  def SourceLocationHasArrayError: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.SourceLocationHasArrayError] = js.native
  inline def SourceLocationHasArrayError_=(x: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.SourceLocationHasArrayError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SourceLocationHasArrayError")(x.asInstanceOf[js.Any])
  ...
  @JSImport("hyperformula", "default.TargetLocationHasArrayError")
  @js.native
  def TargetLocationHasArrayError: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.TargetLocationHasArrayError] = js.native
  inline def TargetLocationHasArrayError_=(x: Instantiable0[typingsJapgolly.hyperformula.typingsErrorsMod.TargetLocationHasArrayError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TargetLocationHasArrayError")(x.asInstanceOf[js.Any])
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("hyperformula", "default.UnableToParseError")
  @js.native
  open class UnableToParseError protected ()
    extends typingsJapgolly.hyperformula.typingsErrorsMod.UnableToParseError {
  ...
  @JSImport("hyperformula", "default.UnableToParseError")
  @js.native
  def UnableToParseError: Instantiable1[/* value */ Any, typingsJapgolly.hyperformula.typingsErrorsMod.UnableToParseError] = js.native
  inline def UnableToParseError_=(
    x: Instantiable1[/* value */ Any, typingsJapgolly.hyperformula.typingsErrorsMod.UnableToParseError]
  ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("UnableToParseError")(x.asInstanceOf[js.Any])
}
