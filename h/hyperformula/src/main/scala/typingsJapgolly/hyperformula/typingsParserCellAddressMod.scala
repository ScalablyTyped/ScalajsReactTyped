...
import typingsJapgolly.hyperformula.typingsParserAddressMod.AddressWithRow
...
object typingsParserCellAddressMod {
  ...
  - typingsJapgolly.hyperformula.typingsParserAddressMod.AddressWithSheet because Already inherited
  - typingsJapgolly.hyperformula.typingsParserAddressMod.AddressWithRow because var conflicts: sheet. Inlined row, isRowAbsolute, isRowRelative, shiftedByRows, toSimpleRowAddress */ @JSImport("hyperformula/typings/parser/CellAddress", "CellAddress")
  @js.native
  open class CellAddress protected ()
    ...
    def shiftedByRows(numberOfRows: Double): CellAddress = js.native
    @JSName("shiftedByRows")
    def shiftedByRows_AddressWithRow(rows: Double): AddressWithRow = js.native
  ...
  object CellReferenceType extends StObject {
    ...
    /* "CELL_REFERENCE_ABSOLUTE" */ val CELL_REFERENCE_ABSOLUTE: typingsJapgolly.hyperformula.typingsParserCellAddressMod.CellReferenceType.CELL_REFERENCE_ABSOLUTE & String = js.native
    ...
    sealed trait CELL_REFERENCE_ABSOLUTE_COL
      extends StObject
         with CellReferenceType
    /* "CELL_REFERENCE_ABSOLUTE_COL" */ val CELL_REFERENCE_ABSOLUTE_COL: typingsJapgolly.hyperformula.typingsParserCellAddressMod.CellReferenceType.CELL_REFERENCE_ABSOLUTE_COL & String = js.native
    ...
    sealed trait CELL_REFERENCE_ABSOLUTE_ROW
      extends StObject
         with CellReferenceType
    /* "CELL_REFERENCE_ABSOLUTE_ROW" */ val CELL_REFERENCE_ABSOLUTE_ROW: typingsJapgolly.hyperformula.typingsParserCellAddressMod.CellReferenceType.CELL_REFERENCE_ABSOLUTE_ROW & String = js.native
    ...
    sealed trait CELL_REFERENCE_RELATIVE
      extends StObject
         with CellReferenceType
    /* "CELL_REFERENCE" */ val CELL_REFERENCE_RELATIVE: typingsJapgolly.hyperformula.typingsParserCellAddressMod.CellReferenceType.CELL_REFERENCE_RELATIVE & String = js.native
  }
}
