package typingsJapgolly.halfred
...
object mod {
  ...
  object Resource {
    ...
    inline def apply(
      ...
      validation: CallbackTo[Any],
      validationIssues: CallbackTo[Any]
    ): Resource = {
      val __obj = js.Dynamic.literal(allEmbeddedArrays = allEmbeddedArrays.toJsFn, allEmbeddedResourceArrays = allEmbeddedResourceArrays.toJsFn, allEmbeddedResources = allEmbeddedResources.toJsFn, allLinkArrays = allLinkArrays.toJsFn, allLinks = allLinks.toJsFn, curie = js.Any.fromFunction1(curie), curieArray = curieArray.toJsFn, embedded = js.Any.fromFunction1(embedded), embeddedArray = js.Any.fromFunction1(embeddedArray), embeddedResource = js.Any.fromFunction1(embeddedResource), embeddedResourceArray = js.Any.fromFunction1(embeddedResourceArray), hasCuries = hasCuries.toJsFn, link = js.Any.fromFunction1(link), linkArray = js.Any.fromFunction1(linkArray), original = original.toJsFn, reverseResolveCurie = js.Any.fromFunction1(reverseResolveCurie), validation = validation.toJsFn, validationIssues = validationIssues.toJsFn)
      __obj.asInstanceOf[Resource]
    }
    
    extension [Self <: Resource](x: Self) {
      
      inline def setAllEmbeddedArrays(value: CallbackTo[ResourceCollection]): Self = StObject.set(x, "allEmbeddedArrays", value.toJsFn)
      
      inline def setAllEmbeddedResourceArrays(value: CallbackTo[ResourceCollection]): Self = StObject.set(x, "allEmbeddedResourceArrays", value.toJsFn)
      
      inline def setAllEmbeddedResources(value: CallbackTo[ResourceCollection]): Self = StObject.set(x, "allEmbeddedResources", value.toJsFn)
      
      inline def setAllLinkArrays(value: CallbackTo[LinkCollection]): Self = StObject.set(x, "allLinkArrays", value.toJsFn)
      
      inline def setAllLinks(value: CallbackTo[LinkCollection]): Self = StObject.set(x, "allLinks", value.toJsFn)
      
      inline def setCurie(value: String => Link): Self = StObject.set(x, "curie", js.Any.fromFunction1(value))
      
      inline def setCurieArray(value: CallbackTo[js.Array[Link]]): Self = StObject.set(x, "curieArray", value.toJsFn)
      ...
      inline def setHasCuries(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasCuries", value.toJsFn)
      ...
      inline def setValidation(value: CallbackTo[Any]): Self = StObject.set(x, "validation", value.toJsFn)
      
      inline def setValidationIssues(value: CallbackTo[Any]): Self = StObject.set(x, "validationIssues", value.toJsFn)
    }
  }
