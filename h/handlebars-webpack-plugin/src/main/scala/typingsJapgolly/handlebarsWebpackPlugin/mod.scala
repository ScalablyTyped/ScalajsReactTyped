...
import typingsJapgolly.handlebarsWebpackPlugin.anon.ProjectHelpers
...
object mod {
  ...
  object HandlebarsWebpackPlugin {
    ...
    inline def apply(apply: Compiler => Callback): HandlebarsWebpackPlugin = {
  ...
  trait PluginOptions extends StObject {
    ...
    /**
      ...
      */
    var htmlWebpackPlugin: js.UndefOr[Options | typingsJapgolly.htmlWebpackPlugin.mod.^] = js.undefined
  ...
  object PluginOptions {
    ...
    extension [Self <: PluginOptions](x: Self) {
      ...
      inline def setHtmlWebpackPlugin(value: Options | typingsJapgolly.htmlWebpackPlugin.mod.^): Self = StObject.set(x, "htmlWebpackPlugin", value.asInstanceOf[js.Any])
