...
object Box {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.hedron.mod.Box] {
    ...
    inline def display(
      value: typingsJapgolly.hedron.hedronStrings.`inline` | block | contents | flex | typingsJapgolly.hedron.hedronStrings.grid | `inline-block` | typingsJapgolly.hedron.hedronStrings.none | initial | typingsJapgolly.hedron.hedronStrings.inherit | `inline-flex` | `inline-grid` | `inline-table` | `list-item` | `run-in` | table | `table-caption` | `table-column-group` | `table-header-group` | `table-footer-group` | `table-row-group` | `table-cell` | `table-column` | `table-row`
    ...
    inline def flex(value: String): this.type = set("flex", value.asInstanceOf[js.Any])
    ...
    inline def padding(value: String): this.type = set("padding", value.asInstanceOf[js.Any])
    ...
    inline def shiftDown(value: Boolean): this.type = set("shiftDown", value.asInstanceOf[js.Any])
    
    inline def shiftLeft(value: Boolean): this.type = set("shiftLeft", value.asInstanceOf[js.Any])
    
    inline def shiftRight(value: Boolean): this.type = set("shiftRight", value.asInstanceOf[js.Any])
    
    inline def shiftUp(value: Boolean): this.type = set("shiftUp", value.asInstanceOf[js.Any])
    ...
    inline def visibility(value: visible | hidden | collapse | initial | typingsJapgolly.hedron.hedronStrings.inherit): this.type = set("visibility", value.asInstanceOf[js.Any])
  ...
  def withProps(p: BoxProps & HTMLProps[HTMLElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
