...
object Bounds {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.hedron.mod.Bounds] {
    ...
    inline def direction(
      value: typingsJapgolly.hedron.hedronStrings.horizontal | typingsJapgolly.hedron.hedronStrings.vertical
    ...
    inline def valign(value: top | center | bottom): this.type = set("valign", value.asInstanceOf[js.Any])
  ...
  def withProps(p: BoundsProps & HTMLProps[HTMLElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
