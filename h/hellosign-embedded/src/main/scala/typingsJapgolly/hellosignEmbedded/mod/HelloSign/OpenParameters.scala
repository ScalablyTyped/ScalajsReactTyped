...
object OpenParameters {
  ...
  def apply(
    ...
    messageListener: /* eventData */ MessageEvent => Callback = null,
    ...
    if (messageListener != null) __obj.updateDynamic("messageListener")(js.Any.fromFunction1((t0: /* eventData */ typingsJapgolly.hellosignEmbedded.mod.HelloSign.MessageEvent) => messageListener(t0).runNow()))
