...
object HelloSignStatic {
  ...
  def apply(
    ...
    open: OpenParameters => Callback
  ): HelloSignStatic = {
    val __obj = js.Dynamic.literal(CULTURES = CULTURES.asInstanceOf[js.Any], EVENT_CANCELED = EVENT_CANCELED.asInstanceOf[js.Any], EVENT_DECLINED = EVENT_DECLINED.asInstanceOf[js.Any], EVENT_ERROR = EVENT_ERROR.asInstanceOf[js.Any], EVENT_SENT = EVENT_SENT.asInstanceOf[js.Any], EVENT_SIGNED = EVENT_SIGNED.asInstanceOf[js.Any], EVENT_TEMPLATE_CREATED = EVENT_TEMPLATE_CREATED.asInstanceOf[js.Any])
    __obj.updateDynamic("close")(close.toJsFn)
    __obj.updateDynamic("init")(js.Any.fromFunction1((t0: java.lang.String) => init(t0).runNow()))
    __obj.updateDynamic("open")(js.Any.fromFunction1((t0: typingsJapgolly.hellosignEmbedded.mod.HelloSign.OpenParameters) => open(t0).runNow()))
