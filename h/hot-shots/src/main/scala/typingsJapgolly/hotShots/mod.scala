...
import typingsJapgolly.hotShots.anon.Buffer
import typingsJapgolly.hotShots.hotShotsInts.`0`
import typingsJapgolly.hotShots.hotShotsInts.`1`
import typingsJapgolly.hotShots.hotShotsInts.`2`
import typingsJapgolly.hotShots.hotShotsInts.`3`
import typingsJapgolly.hotShots.hotShotsStrings.error
import typingsJapgolly.hotShots.hotShotsStrings.info
import typingsJapgolly.hotShots.hotShotsStrings.low
import typingsJapgolly.hotShots.hotShotsStrings.normal
import typingsJapgolly.hotShots.hotShotsStrings.stream
import typingsJapgolly.hotShots.hotShotsStrings.success
import typingsJapgolly.hotShots.hotShotsStrings.tcp
import typingsJapgolly.hotShots.hotShotsStrings.udp
import typingsJapgolly.hotShots.hotShotsStrings.uds
import typingsJapgolly.hotShots.hotShotsStrings.warning
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.hotShots.hotShotsInts.`0`
    - typingsJapgolly.hotShots.hotShotsInts.`1`
    - typingsJapgolly.hotShots.hotShotsInts.`2`
    - typingsJapgolly.hotShots.hotShotsInts.`3`
  */
  trait DatadogChecksValues extends StObject
  object DatadogChecksValues {
    
    inline def `0`: typingsJapgolly.hotShots.hotShotsInts.`0` = 0.asInstanceOf[typingsJapgolly.hotShots.hotShotsInts.`0`]
    
    inline def `1`: typingsJapgolly.hotShots.hotShotsInts.`1` = 1.asInstanceOf[typingsJapgolly.hotShots.hotShotsInts.`1`]
    
    inline def `2`: typingsJapgolly.hotShots.hotShotsInts.`2` = 2.asInstanceOf[typingsJapgolly.hotShots.hotShotsInts.`2`]
    
    inline def `3`: typingsJapgolly.hotShots.hotShotsInts.`3` = 3.asInstanceOf[typingsJapgolly.hotShots.hotShotsInts.`3`]
  }
