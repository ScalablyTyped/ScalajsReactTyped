package typingsJapgolly.hapiH2o2.mod.hapiHapiAugmentingMod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.hapiH2o2.mod.ProxyHandlerOptions
...
object ResponseToolkit {
  ...
  def apply(proxy: ProxyHandlerOptions => CallbackTo[js.Promise[ResponseObject]]): ResponseToolkit = {
    ...
    __obj.updateDynamic("proxy")(js.Any.fromFunction1((t0: typingsJapgolly.hapiH2o2.mod.ProxyHandlerOptions) => proxy(t0).runNow()))
