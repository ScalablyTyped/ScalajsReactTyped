package typingsJapgolly.hapiH2o2

import org.scalablytyped.runtime.Shortcut
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.hapiBoom.mod.Boom
import typingsJapgolly.hapiH2o2.hapiH2o2Booleans.`false`
import typingsJapgolly.hapiH2o2.hapiH2o2Strings.http
import typingsJapgolly.hapiH2o2.hapiH2o2Strings.https
import typingsJapgolly.hapiH2o2.hapiH2o2Strings.upstream
...
import typingsJapgolly.hapiHapi.mod.RouteOptions
...
object mod extends Shortcut {
  ...
  object hapiHapiAugmentingMod {
    ...
    object ResponseToolkit {
      ...
      inline def apply(proxy: ProxyHandlerOptions => js.Promise[ResponseObject]): typingsJapgolly.hapiH2o2.mod.hapiHapiAugmentingMod.ResponseToolkit = {
        val __obj = js.Dynamic.literal(proxy = js.Any.fromFunction1(proxy))
        __obj.asInstanceOf[typingsJapgolly.hapiH2o2.mod.hapiHapiAugmentingMod.ResponseToolkit]
      }
      
      extension [Self <: typingsJapgolly.hapiH2o2.mod.hapiHapiAugmentingMod.ResponseToolkit](x: Self) {
