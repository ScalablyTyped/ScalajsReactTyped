...
import typingsJapgolly.htmlparser2.libTokenizerMod.Callbacks
import typingsJapgolly.htmlparser2.libTokenizerMod.default
...
object mod {
  ...
  @js.native
  open class Parser ()
    extends typingsJapgolly.htmlparser2.libParserMod.Parser {
  ...
  inline def createDomStream(cb: js.Function2[/* error */ js.Error | Null, /* dom */ js.Array[ChildNode], Unit]): typingsJapgolly.htmlparser2.libParserMod.Parser = ^.asInstanceOf[js.Dynamic].applyDynamic("createDomStream")(cb.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.htmlparser2.libParserMod.Parser]
  ...
  ): typingsJapgolly.htmlparser2.libParserMod.Parser = (^.asInstanceOf[js.Dynamic].applyDynamic("createDomStream")(cb.asInstanceOf[js.Any], options.asInstanceOf[js.Any], elementCb.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.htmlparser2.libParserMod.Parser]
  inline def createDomStream(
    cb: js.Function2[/* error */ js.Error | Null, /* dom */ js.Array[ChildNode], Unit],
    options: Options
  ): typingsJapgolly.htmlparser2.libParserMod.Parser = (^.asInstanceOf[js.Dynamic].applyDynamic("createDomStream")(cb.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.htmlparser2.libParserMod.Parser]
  inline def createDomStream(
    cb: js.Function2[/* error */ js.Error | Null, /* dom */ js.Array[ChildNode], Unit],
    options: Options,
    elementCb: js.Function1[/* element */ Element, Unit]
