...
object libTokenizerMod {
  ...
  object QuoteType extends StObject {
    ...
    sealed trait Double
      extends StObject
         with QuoteType
    /* 3 */ val Double: typingsJapgolly.htmlparser2.libTokenizerMod.QuoteType.Double & scala.Double = js.native
    
    @js.native
    sealed trait NoValue
      extends StObject
         with QuoteType
    /* 0 */ val NoValue: typingsJapgolly.htmlparser2.libTokenizerMod.QuoteType.NoValue & scala.Double = js.native
    
    @js.native
    sealed trait Single
      extends StObject
         with QuoteType
    /* 2 */ val Single: typingsJapgolly.htmlparser2.libTokenizerMod.QuoteType.Single & scala.Double = js.native
    
    @js.native
    sealed trait Unquoted
      extends StObject
         with QuoteType
    /* 1 */ val Unquoted: typingsJapgolly.htmlparser2.libTokenizerMod.QuoteType.Unquoted & scala.Double = js.native
  }
  ...
  object Callbacks {
    ...
    inline def apply(
      onattribdata: (Double, Double) => Callback,
      onattribend: (QuoteType, Double) => Callback,
      onattribentity: Double => Callback,
      onattribname: (Double, Double) => Callback,
      oncdata: (Double, Double, Double) => Callback,
      onclosetag: (Double, Double) => Callback,
      oncomment: (Double, Double, Double) => Callback,
      ondeclaration: (Double, Double) => Callback,
      onend: Callback,
      onopentagend: Double => Callback,
      onopentagname: (Double, Double) => Callback,
      onprocessinginstruction: (Double, Double) => Callback,
      onselfclosingtag: Double => Callback,
      ontext: (Double, Double) => Callback,
      ontextentity: Double => Callback
    ): Callbacks = {
      val __obj = js.Dynamic.literal(onattribdata = js.Any.fromFunction2((t0: Double, t1: Double) => (onattribdata(t0, t1)).runNow()), onattribend = js.Any.fromFunction2((t0: QuoteType, t1: Double) => (onattribend(t0, t1)).runNow()), onattribentity = js.Any.fromFunction1((t0: Double) => onattribentity(t0).runNow()), onattribname = js.Any.fromFunction2((t0: Double, t1: Double) => (onattribname(t0, t1)).runNow()), oncdata = js.Any.fromFunction3((t0: Double, t1: Double, t2: Double) => (oncdata(t0, t1, t2)).runNow()), onclosetag = js.Any.fromFunction2((t0: Double, t1: Double) => (onclosetag(t0, t1)).runNow()), oncomment = js.Any.fromFunction3((t0: Double, t1: Double, t2: Double) => (oncomment(t0, t1, t2)).runNow()), ondeclaration = js.Any.fromFunction2((t0: Double, t1: Double) => (ondeclaration(t0, t1)).runNow()), onend = onend.toJsFn, onopentagend = js.Any.fromFunction1((t0: Double) => onopentagend(t0).runNow()), onopentagname = js.Any.fromFunction2((t0: Double, t1: Double) => (onopentagname(t0, t1)).runNow()), onprocessinginstruction = js.Any.fromFunction2((t0: Double, t1: Double) => (onprocessinginstruction(t0, t1)).runNow()), onselfclosingtag = js.Any.fromFunction1((t0: Double) => onselfclosingtag(t0).runNow()), ontext = js.Any.fromFunction2((t0: Double, t1: Double) => (ontext(t0, t1)).runNow()), ontextentity = js.Any.fromFunction1((t0: Double) => ontextentity(t0).runNow()))
      __obj.asInstanceOf[Callbacks]
    }
    
    extension [Self <: Callbacks](x: Self) {
      
      inline def setOnattribdata(value: (Double, Double) => Callback): Self = StObject.set(x, "onattribdata", js.Any.fromFunction2((t0: Double, t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setOnattribend(value: (QuoteType, Double) => Callback): Self = StObject.set(x, "onattribend", js.Any.fromFunction2((t0: QuoteType, t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setOnattribentity(value: Double => Callback): Self = StObject.set(x, "onattribentity", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      
      inline def setOnattribname(value: (Double, Double) => Callback): Self = StObject.set(x, "onattribname", js.Any.fromFunction2((t0: Double, t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setOncdata(value: (Double, Double, Double) => Callback): Self = StObject.set(x, "oncdata", js.Any.fromFunction3((t0: Double, t1: Double, t2: Double) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnclosetag(value: (Double, Double) => Callback): Self = StObject.set(x, "onclosetag", js.Any.fromFunction2((t0: Double, t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setOncomment(value: (Double, Double, Double) => Callback): Self = StObject.set(x, "oncomment", js.Any.fromFunction3((t0: Double, t1: Double, t2: Double) => (value(t0, t1, t2)).runNow()))
      
      inline def setOndeclaration(value: (Double, Double) => Callback): Self = StObject.set(x, "ondeclaration", js.Any.fromFunction2((t0: Double, t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setOnend(value: Callback): Self = StObject.set(x, "onend", value.toJsFn)
      
      inline def setOnopentagend(value: Double => Callback): Self = StObject.set(x, "onopentagend", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      
      inline def setOnopentagname(value: (Double, Double) => Callback): Self = StObject.set(x, "onopentagname", js.Any.fromFunction2((t0: Double, t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setOnprocessinginstruction(value: (Double, Double) => Callback): Self = StObject.set(x, "onprocessinginstruction", js.Any.fromFunction2((t0: Double, t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setOnselfclosingtag(value: Double => Callback): Self = StObject.set(x, "onselfclosingtag", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      
      inline def setOntext(value: (Double, Double) => Callback): Self = StObject.set(x, "ontext", js.Any.fromFunction2((t0: Double, t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setOntextentity(value: Double => Callback): Self = StObject.set(x, "ontextentity", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    }
  }
  ...
  object Tokenizer {
    ...
    inline def apply(
      ...
      getSectionStart: CallbackTo[Double],
    ...
    extension [Self <: Tokenizer](x: Self) {
      ...
      inline def setGetSectionStart(value: CallbackTo[Double]): Self = StObject.set(x, "getSectionStart", value.toJsFn)
