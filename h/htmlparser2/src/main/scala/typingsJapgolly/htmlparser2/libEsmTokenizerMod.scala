...
object libEsmTokenizerMod {
  ...
  object QuoteType extends StObject {
    ...
    sealed trait Double
      extends StObject
         with QuoteType
    /* 3 */ val Double: typingsJapgolly.htmlparser2.libEsmTokenizerMod.QuoteType.Double & scala.Double = js.native
    
    @js.native
    sealed trait NoValue
      extends StObject
         with QuoteType
    /* 0 */ val NoValue: typingsJapgolly.htmlparser2.libEsmTokenizerMod.QuoteType.NoValue & scala.Double = js.native
    
    @js.native
    sealed trait Single
      extends StObject
         with QuoteType
    /* 2 */ val Single: typingsJapgolly.htmlparser2.libEsmTokenizerMod.QuoteType.Single & scala.Double = js.native
    
    @js.native
    sealed trait Unquoted
      extends StObject
         with QuoteType
    /* 1 */ val Unquoted: typingsJapgolly.htmlparser2.libEsmTokenizerMod.QuoteType.Unquoted & scala.Double = js.native
  }
