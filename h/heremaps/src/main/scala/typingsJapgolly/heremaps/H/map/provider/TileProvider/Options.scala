package typingsJapgolly.heremaps.H.map.provider.TileProvider
...
object Options {
  @scala.inline
  def apply(
    getCopyrights: (/* rect */ Rect, /* number */ Double) => CallbackTo[js.Array[ICopyright]] = null,
    max: Int | Double = null,
    min: Int | Double = null,
    ...
    if (getCopyrights != null) __obj.updateDynamic("getCopyrights")(js.Any.fromFunction2((t0: /* rect */ typingsJapgolly.heremaps.H.geo.Rect, t1: /* number */ scala.Double) => getCopyrights(t0, t1).runNow()))
