...
import typingsJapgolly.heremaps.H.ui.UnitSystem
...
object Options {
  @scala.inline
  def apply(
    distancemeasurement: typingsJapgolly.heremaps.H.ui.DistanceMeasurement.Options | Boolean = null,
    locale: Localization | String = null,
    mapsettings: typingsJapgolly.heremaps.H.ui.MapSettingsControl.Options | Boolean = null,
    panorama: typingsJapgolly.heremaps.H.ui.Pano.Options | Boolean = null,
    scalebar: typingsJapgolly.heremaps.H.ui.ScaleBar.Options | Boolean = null,
    unitSystem: UnitSystem = null,
    zoom: typingsJapgolly.heremaps.H.ui.ZoomControl.Options | Boolean = null,
    zoomrectangle: typingsJapgolly.heremaps.H.ui.ZoomRectangle.Options | Boolean = null
  ): Options = {
