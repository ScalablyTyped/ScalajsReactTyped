...
object UI {
  ...
  trait Options extends StObject {
    ...
    var distancemeasurement: js.UndefOr[typingsJapgolly.heremaps.H.ui.DistanceMeasurement.Options | Boolean] = js.undefined
    
    var locale: js.UndefOr[Localization | String] = js.undefined
    
    var mapsettings: js.UndefOr[typingsJapgolly.heremaps.H.ui.MapSettingsControl.Options | Boolean] = js.undefined
    
    var panorama: js.UndefOr[typingsJapgolly.heremaps.H.ui.Pano.Options | Boolean] = js.undefined
    
    var scalebar: js.UndefOr[typingsJapgolly.heremaps.H.ui.ScaleBar.Options | Boolean] = js.undefined
    
    var unitSystem: js.UndefOr[UnitSystem] = js.undefined
    
    var zoom: js.UndefOr[typingsJapgolly.heremaps.H.ui.ZoomControl.Options | Boolean] = js.undefined
    
    var zoomrectangle: js.UndefOr[typingsJapgolly.heremaps.H.ui.ZoomRectangle.Options | Boolean] = js.undefined
  }
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setDistancemeasurement(value: typingsJapgolly.heremaps.H.ui.DistanceMeasurement.Options | Boolean): Self = StObject.set(x, "distancemeasurement", value.asInstanceOf[js.Any])
      ...
      inline def setMapsettings(value: typingsJapgolly.heremaps.H.ui.MapSettingsControl.Options | Boolean): Self = StObject.set(x, "mapsettings", value.asInstanceOf[js.Any])
      
      inline def setMapsettingsUndefined: Self = StObject.set(x, "mapsettings", js.undefined)
      
      inline def setPanorama(value: typingsJapgolly.heremaps.H.ui.Pano.Options | Boolean): Self = StObject.set(x, "panorama", value.asInstanceOf[js.Any])
      
      inline def setPanoramaUndefined: Self = StObject.set(x, "panorama", js.undefined)
      
      inline def setScalebar(value: typingsJapgolly.heremaps.H.ui.ScaleBar.Options | Boolean): Self = StObject.set(x, "scalebar", value.asInstanceOf[js.Any])
      ...
      inline def setZoom(value: typingsJapgolly.heremaps.H.ui.ZoomControl.Options | Boolean): Self = StObject.set(x, "zoom", value.asInstanceOf[js.Any])
      
      inline def setZoomUndefined: Self = StObject.set(x, "zoom", js.undefined)
      
      inline def setZoomrectangle(value: typingsJapgolly.heremaps.H.ui.ZoomRectangle.Options | Boolean): Self = StObject.set(x, "zoomrectangle", value.asInstanceOf[js.Any])
