...
import typingsJapgolly.heremaps.H.geo.PixelProjection
import typingsJapgolly.heremaps.H.math.Point
import typingsJapgolly.heremaps.H.math.Size
...
object render {
  ...
  trait RenderingParams extends StObject {
    ...
    /**
      ...
      * @type {H.geo.Rect}
      */
    var bounds: typingsJapgolly.heremaps.H.geo.Rect
  ...
  object RenderingParams {
    ...
    extension [Self <: RenderingParams](x: Self) {
      ...
      inline def setBounds(value: typingsJapgolly.heremaps.H.geo.Rect): Self = StObject.set(x, "bounds", value.asInstanceOf[js.Any])
