...
object DistanceMeasurement {
  ...
  object Options {
    ...
    inline def apply(lineStyle: SpatialStyle | typingsJapgolly.heremaps.H.map.SpatialStyle.Options): Options = {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setDistanceFormatter(value: /* n */ Double => Callback): Self = StObject.set(x, "distanceFormatter", js.Any.fromFunction1((t0: /* n */ Double) => value(t0).runNow()))
      ...
      inline def setLineStyle(value: SpatialStyle | typingsJapgolly.heremaps.H.map.SpatialStyle.Options): Self = StObject.set(x, "lineStyle", value.asInstanceOf[js.Any])
