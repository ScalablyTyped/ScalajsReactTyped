...
import typingsJapgolly.heremaps.H.map.provider.ImageTileProvider
import typingsJapgolly.heremaps.H.service.MapTileService.Info
import typingsJapgolly.heremaps.H.service.MapTileService.Options
