...
import typingsJapgolly.heremaps.H.geo.IProjection
...
import typingsJapgolly.heremaps.H.map.layer.ObjectLayer.OverlaysResponse
...
object layer {
  ...
  trait BaseTileLayer
    ...
    /**
      ...
      */
    def geoRectToRect(geoRect: typingsJapgolly.heremaps.H.geo.Rect): typingsJapgolly.heremaps.H.math.Rect = js.native
    def geoRectToRect(geoRect: typingsJapgolly.heremaps.H.geo.Rect, opt_zoom: Double): typingsJapgolly.heremaps.H.math.Rect = js.native
  ...
  trait IMarkerLayer extends StObject {
    ...
    def requestDomMarkers(
      boundingRect: typingsJapgolly.heremaps.H.geo.Rect,
      zoomLevel: Double,
      cacheOnly: Boolean,
      prioCenter: Point
    ): typingsJapgolly.heremaps.H.map.layer.IMarkerLayer.Response | TiledResponse
  ...
  object IMarkerLayer {
    ...
    inline def apply(
      requestDomMarkers: (typingsJapgolly.heremaps.H.geo.Rect, Double, Boolean, Point) => typingsJapgolly.heremaps.H.map.layer.IMarkerLayer.Response | TiledResponse,
      requestMarkers: (typingsJapgolly.heremaps.H.geo.Rect, Double, Boolean, Point) => typingsJapgolly.heremaps.H.map.layer.IMarkerLayer.Response | TiledResponse
    ): IMarkerLayer = {
    ...
    extension [Self <: IMarkerLayer](x: Self) {
      ...
      inline def setRequestDomMarkers(
        value: (typingsJapgolly.heremaps.H.geo.Rect, Double, Boolean, Point) => typingsJapgolly.heremaps.H.map.layer.IMarkerLayer.Response | TiledResponse
    ...
    object Response {
      ...
      inline def apply(markers: js.Array[AbstractMarker], total: Double): typingsJapgolly.heremaps.H.map.layer.IMarkerLayer.Response = {
        val __obj = js.Dynamic.literal(markers = markers.asInstanceOf[js.Any], total = total.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.heremaps.H.map.layer.IMarkerLayer.Response]
      }
      
      extension [Self <: typingsJapgolly.heremaps.H.map.layer.IMarkerLayer.Response](x: Self) {
  ...
  object ITileLayer {
    ...
    inline def apply(
      ...
      requestTiles: (typingsJapgolly.heremaps.H.geo.Rect, Double, Boolean, Point) => Response
    ): ITileLayer = {
      val __obj = js.Dynamic.literal(cancelTile = js.Any.fromFunction3((t0: Double, t1: Double, t2: Double) => (cancelTile(t0, t1, t2)).runNow()), requestTile = js.Any.fromFunction4(requestTile), requestTiles = js.Any.fromFunction4(requestTiles))
      __obj.asInstanceOf[ITileLayer]
    }
    
    extension [Self <: ITileLayer](x: Self) {
      
      inline def setCancelTile(value: (Double, Double, Double) => Callback): Self = StObject.set(x, "cancelTile", js.Any.fromFunction3((t0: Double, t1: Double, t2: Double) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setRequestTiles(value: (typingsJapgolly.heremaps.H.geo.Rect, Double, Boolean, Point) => Response): Self = StObject.set(x, "requestTiles", js.Any.fromFunction4(value))
    }
  ...
  trait Layer
    ...
    /**
      ...
      */
    def getCopyrights(bounds: typingsJapgolly.heremaps.H.geo.Rect, level: Double): js.Array[ICopyright] = js.native
  ...
  trait ObjectLayer
    ...
    def requestDomMarkers(
      ...
      cacheOnly: Boolean,
      prioCenter: Point
    ): typingsJapgolly.heremaps.H.map.layer.IMarkerLayer.Response | TiledResponse = js.native
    ...
    /**
      ...
      */
    def requestOverlays(
      bounds: typingsJapgolly.heremaps.H.geo.Rect,
      zoomLevel: Double,
      cacheOnly: Boolean,
      prioCenter: Point
