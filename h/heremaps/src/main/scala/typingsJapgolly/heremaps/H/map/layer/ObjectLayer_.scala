...
import typingsJapgolly.heremaps.H.map.layer.ObjectLayer.Options
...
class ObjectLayer_ protected ()
  ...
  /**
    ...
    */
  /* InferMemberOverrides */
  override def requestTiles(boundingRect: Rect, zoomLevel: Double, cacheOnly: Boolean, prioCenter: Point): typingsJapgolly.heremaps.H.map.layer.ITileLayer.Response = js.native
  /**
