...
import typingsJapgolly.heremaps.H.map.Marker
import typingsJapgolly.heremaps.H.map.Object
import typingsJapgolly.heremaps.H.map.Spatial
...
object clustering {
  ...
  object ICluster {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(forEachDataPoint = js.Any.fromFunction1((t0: js.Function1[/* noise */ INoisePoint, Unit]) => forEachDataPoint(t0).runNow()), forEachEntry = js.Any.fromFunction1((t0: js.Function1[/* result */ IResult, Unit]) => forEachEntry(t0).runNow()), getBounds = getBounds.toJsFn, getMaxZoom = getMaxZoom.toJsFn, getMinZoom = getMinZoom.toJsFn, getPosition = getPosition.toJsFn, getWeight = getWeight.toJsFn, isCluster = isCluster.toJsFn)
      __obj.asInstanceOf[ICluster]
    }
    
    extension [Self <: ICluster](x: Self) {
      
      inline def setForEachDataPoint(value: js.Function1[/* noise */ INoisePoint, Unit] => Callback): Self = StObject.set(x, "forEachDataPoint", js.Any.fromFunction1((t0: js.Function1[/* noise */ INoisePoint, Unit]) => value(t0).runNow()))
      
      inline def setForEachEntry(value: js.Function1[/* result */ IResult, Unit] => Callback): Self = StObject.set(x, "forEachEntry", js.Any.fromFunction1((t0: js.Function1[/* result */ IResult, Unit]) => value(t0).runNow()))
      
      inline def setGetBounds(value: CallbackTo[Rect]): Self = StObject.set(x, "getBounds", value.toJsFn)
  ...
  object INoisePoint {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getData = getData.toJsFn, getMinZoom = getMinZoom.toJsFn, getPosition = getPosition.toJsFn, getWeight = getWeight.toJsFn, isCluster = isCluster.toJsFn)
  ...
  object IResult {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getMinZoom = getMinZoom.toJsFn, getPosition = getPosition.toJsFn, getWeight = getWeight.toJsFn, isCluster = isCluster.toJsFn)
