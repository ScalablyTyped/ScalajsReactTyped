...
import typingsJapgolly.heremaps.H.ui.InfoBubble.State
import typingsJapgolly.heremaps.H.ui.base.Element
...
object InfoBubble {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnStateChange(value: /* event */ Event => Callback): Self = StObject.set(x, "onStateChange", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
