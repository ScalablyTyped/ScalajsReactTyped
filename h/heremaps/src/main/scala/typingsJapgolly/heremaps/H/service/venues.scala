...
import typingsJapgolly.heremaps.H.map.Group
...
import typingsJapgolly.heremaps.H.service.venues.TileProvider.Options
...
object venues {
  ...
  object Service {
    ...
    object Options {
      ...
      inline def apply(): typingsJapgolly.heremaps.H.service.venues.Service.Options = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.heremaps.H.service.venues.Service.Options]
      }
      
      extension [Self <: typingsJapgolly.heremaps.H.service.venues.Service.Options](x: Self) {
  ...
  trait Space extends StObject {
    ...
    def initLabelStyle(labelStyle: typingsJapgolly.heremaps.H.map.SpatialStyle.Options): Unit = js.native
  ...
  object TileProvider {
    ...
    object Options {
      ...
      extension [Self <: Options](x: Self) {
        ...
        inline def setOnSpaceCreated(value: /* space */ Space => Callback): Self = StObject.set(x, "onSpaceCreated", js.Any.fromFunction1((t0: /* space */ Space) => value(t0).runNow()))
