...
import typingsJapgolly.heremaps.H.service.Platform.Options
...
class Platform_ protected () extends js.Object {
  ...
  def getEnterpriseRoutingService(opt_options: typingsJapgolly.heremaps.H.service.EnterpriseRoutingService.Options): EnterpriseRoutingService = js.native
  /**
