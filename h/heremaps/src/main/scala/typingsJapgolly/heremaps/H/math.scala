...
object math {
  ...
  object Rect {
    ...
    inline def apply(
      ...
      getBottomRight: CallbackTo[Point],
      getTopLeft: CallbackTo[Point],
      set: (Double, Double, Double, Double) => Callback
    ): Rect = {
      val __obj = js.Dynamic.literal(containsXY = js.Any.fromFunction2(containsXY), getBottomRight = getBottomRight.toJsFn, getTopLeft = getTopLeft.toJsFn, set = js.Any.fromFunction4((t0: Double, t1: Double, t2: Double, t3: Double) => (set(t0, t1, t2, t3)).runNow()))
    ...
    extension [Self <: Rect](x: Self) {
      ...
      inline def setGetBottomRight(value: CallbackTo[Point]): Self = StObject.set(x, "getBottomRight", value.toJsFn)
      
      inline def setGetTopLeft(value: CallbackTo[Point]): Self = StObject.set(x, "getTopLeft", value.toJsFn)
