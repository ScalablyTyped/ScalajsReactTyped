...
import typingsJapgolly.heremaps.H.service.EnterpriseRoutingService.Options
import typingsJapgolly.heremaps.H.service.Platform.DefaultLayersOptions
import typingsJapgolly.heremaps.H.service.metaInfo.Service
...
trait Platform extends StObject {
  ...
  def getGeocodingService(opt_options: typingsJapgolly.heremaps.H.service.GeocodingService.Options): GeocodingService = js.native
  ...
  def getMapTileService(opt_options: typingsJapgolly.heremaps.H.service.MapTileService.Options): MapTileService = js.native
  ...
  def getMetaInfoService(opt_params: typingsJapgolly.heremaps.H.service.metaInfo.Service.Options): Service = js.native
  ...
  def getRoutingService(opt_options: typingsJapgolly.heremaps.H.service.RoutingService.Options): RoutingService = js.native
  ...
  /**
    ...
    */
  def getTrafficService(): typingsJapgolly.heremaps.H.service.traffic.Service = js.native
  def getTrafficService(opt_options: typingsJapgolly.heremaps.H.service.traffic.Service.Options): typingsJapgolly.heremaps.H.service.traffic.Service = js.native
  ...
  /**
    ...
    */
  def getVenueService(): typingsJapgolly.heremaps.H.service.venues.Service = js.native
  def getVenueService(opt_params: typingsJapgolly.heremaps.H.service.venues.Service.Options): typingsJapgolly.heremaps.H.service.venues.Service = js.native
...
object Platform {
  ...
  object Options {
    ...
    inline def apply(apikey: String): typingsJapgolly.heremaps.H.service.Platform.Options = {
      val __obj = js.Dynamic.literal(apikey = apikey.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.heremaps.H.service.Platform.Options]
    }
    
    extension [Self <: typingsJapgolly.heremaps.H.service.Platform.Options](x: Self) {
