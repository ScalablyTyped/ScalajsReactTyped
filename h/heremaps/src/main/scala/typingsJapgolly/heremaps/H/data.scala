...
import typingsJapgolly.heremaps.H.map.layer.ObjectLayer
...
object data {
  ...
  object AbstractReader {
    ...
    /**
      ...
      */
    type Event = typingsJapgolly.heremaps.H.util.Event
  }
    ...
    object Reader {
      ...
      object Options {
        ...
        extension [Self <: Options](x: Self) {
          ...
          inline def setStyle(value: /* mapObject */ Object => Callback): Self = StObject.set(x, "style", js.Any.fromFunction1((t0: /* mapObject */ Object) => value(t0).runNow()))
