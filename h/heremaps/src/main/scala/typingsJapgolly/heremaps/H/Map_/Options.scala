...
import typingsJapgolly.heremaps.H.map.ViewPort.Padding
...
trait Options extends js.Object {
  ...
  var imprint: js.UndefOr[typingsJapgolly.heremaps.H.map.Imprint.Options] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    imprint: typingsJapgolly.heremaps.H.map.Imprint.Options = null,
