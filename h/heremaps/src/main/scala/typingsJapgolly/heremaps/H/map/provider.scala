...
import typingsJapgolly.heremaps.H.map.Object.Type
...
import typingsJapgolly.heremaps.H.util.ICache
import typingsJapgolly.heremaps.H.util.ICancelable
import typingsJapgolly.heremaps.H.util.Job.Priority
...
object provider {
  ...
  object Invalidations {
    ...
    inline def apply(
      ...
      update: (Mark, BitMask) => Callback
    ): Invalidations = {
      val __obj = js.Dynamic.literal(getMark = getMark.toJsFn, isAdd = js.Any.fromFunction1(isAdd), isAny = js.Any.fromFunction1(isAny), isRemove = js.Any.fromFunction1(isRemove), isSpatial = js.Any.fromFunction1(isSpatial), isVisual = js.Any.fromFunction1(isVisual), isZOrder = js.Any.fromFunction1(isZOrder), update = js.Any.fromFunction2((t0: Mark, t1: BitMask) => (update(t0, t1)).runNow()))
    ...
    extension [Self <: Invalidations](x: Self) {
      ...
      inline def setGetMark(value: CallbackTo[Mark]): Self = StObject.set(x, "getMark", value.toJsFn)
      ...
      inline def setUpdate(value: (Mark, BitMask) => Callback): Self = StObject.set(x, "update", js.Any.fromFunction2((t0: Mark, t1: BitMask) => (value(t0, t1)).runNow()))
    }
  ...
  object ImageTileProvider {
    ...
    trait Options extends StObject {
      ...
      var getCopyrights: js.UndefOr[
            js.Function2[/* rect */ typingsJapgolly.heremaps.H.geo.Rect, /* n */ Double, js.Array[ICopyright]]
          ] = js.undefined
    ...
    object Options {
      ...
      extension [Self <: Options](x: Self) {
        ...
        inline def setGetCopyrights(value: (/* rect */ typingsJapgolly.heremaps.H.geo.Rect, /* n */ Double) => js.Array[ICopyright]): Self = StObject.set(x, "getCopyrights", js.Any.fromFunction2(value))
  ...
  trait ObjectProvider
    ...
    def requestDomMarkers(
      geoRect: typingsJapgolly.heremaps.H.geo.Rect,
      zoomLevel: Double,
  ...
  object TileProvider {
    ...
    trait Options extends StObject {
      ...
      var getCopyrights: js.UndefOr[
            js.Function2[
              /* rect */ typingsJapgolly.heremaps.H.geo.Rect, 
              /* number */ Double, 
              js.Array[ICopyright]
            ]
          ] = js.undefined
    ...
    object Options {
      ...
      extension [Self <: Options](x: Self) {
        ...
        inline def setGetCopyrights(
          value: (/* rect */ typingsJapgolly.heremaps.H.geo.Rect, /* number */ Double) => js.Array[ICopyright]
        ): Self = StObject.set(x, "getCopyrights", js.Any.fromFunction2(value))
