...
object geo {
  ...
  object AbstractGeometry {
    ...
    inline def apply(getBoundingBox: CallbackTo[Rect], toGeoJSON: CallbackTo[js.Object]): AbstractGeometry = {
      val __obj = js.Dynamic.literal(getBoundingBox = getBoundingBox.toJsFn, toGeoJSON = toGeoJSON.toJsFn)
      __obj.asInstanceOf[AbstractGeometry]
    }
    
    extension [Self <: AbstractGeometry](x: Self) {
      
      inline def setGetBoundingBox(value: CallbackTo[Rect]): Self = StObject.set(x, "getBoundingBox", value.toJsFn)
      
      inline def setToGeoJSON(value: CallbackTo[js.Object]): Self = StObject.set(x, "toGeoJSON", value.toJsFn)
    }
  }
  ...
  trait PixelProjection extends StObject {
    ...
    /**
      ...
      */
    def geoToPixel(geoPoint: IPoint): typingsJapgolly.heremaps.H.math.IPoint = js.native
    def geoToPixel(geoPoint: IPoint, opt_out: typingsJapgolly.heremaps.H.math.IPoint): typingsJapgolly.heremaps.H.math.IPoint = js.native
    ...
    /**
      ...
      */
    def latLngToPixel(latitude: Double, longitude: Double): typingsJapgolly.heremaps.H.math.Point = js.native
    def latLngToPixel(latitude: Double, longitude: Double, opt_out: typingsJapgolly.heremaps.H.math.IPoint): typingsJapgolly.heremaps.H.math.Point = js.native
    ...
    /**
      ...
      */
    def pixelToGeo(point: typingsJapgolly.heremaps.H.math.IPoint): IPoint = js.native
    def pixelToGeo(point: typingsJapgolly.heremaps.H.math.IPoint, opt_out: IPoint): IPoint = js.native
    ...
    /**
      ...
      */
    def pointToPixel(point: typingsJapgolly.heremaps.H.math.IPoint): typingsJapgolly.heremaps.H.math.Point = js.native
