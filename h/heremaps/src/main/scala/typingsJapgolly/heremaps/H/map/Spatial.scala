...
trait Spatial
  ...
  def setStyle(opt_style: typingsJapgolly.heremaps.H.map.SpatialStyle.Options): Spatial = js.native
}
object Spatial {
  ...
  object Options {
    ...
    inline def apply(): typingsJapgolly.heremaps.H.map.Spatial.Options = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.heremaps.H.map.Spatial.Options]
    }
    
    extension [Self <: typingsJapgolly.heremaps.H.map.Spatial.Options](x: Self) {
