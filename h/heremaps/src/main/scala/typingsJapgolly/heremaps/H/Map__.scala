...
import typingsJapgolly.heremaps.H.Map_.EngineType
...
import typingsJapgolly.heremaps.H.map.Imprint
import typingsJapgolly.heremaps.H.map.Object
import typingsJapgolly.heremaps.H.map.ViewModel
import typingsJapgolly.heremaps.H.map.ViewModel.ILookAtData
import typingsJapgolly.heremaps.H.map.ViewPort
import typingsJapgolly.heremaps.H.map.layer.BaseTileLayer
import typingsJapgolly.heremaps.H.map.layer.Layer
import typingsJapgolly.heremaps.H.map.render.p2d.RenderEngine
import typingsJapgolly.heremaps.H.math.Point
import typingsJapgolly.heremaps.H.util.EventTarget
import typingsJapgolly.heremaps.H.util.ICapturable
import typingsJapgolly.heremaps.H.util.Request
...
class Map__ protected () extends EventTarget {
  ...
  /**
    ...
    * @returns {H.geo.Point}
    */
  def getCenter(): typingsJapgolly.heremaps.H.geo.Point = js.native
  /**
  ...
  /**
    ...
    * @returns {?H.geo.Point}
    */
  def screenToGeo(x: Double, y: Double): typingsJapgolly.heremaps.H.geo.Point = js.native
  /**
