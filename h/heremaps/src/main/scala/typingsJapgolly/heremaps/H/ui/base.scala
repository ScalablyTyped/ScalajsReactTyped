...
object base {
  ...
  trait Container
    ...
    /**
      ...
      */
    def renderInternal(element: org.scalajs.dom.Element, doc: Document): Unit = js.native
    ...
    /**
      ...
      */
    def setDisabled(disabled: Boolean): org.scalajs.dom.Element = js.native
    def setDisabled(disabled: Boolean, opt_force: Boolean): org.scalajs.dom.Element = js.native
