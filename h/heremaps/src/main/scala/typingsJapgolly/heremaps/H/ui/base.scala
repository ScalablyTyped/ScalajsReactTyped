...
object base extends js.Object {
  ...
  class Container () extends EventTarget {
    ...
    /**
      ...
      */
    def setDisabled(disabled: Boolean): org.scalajs.dom.raw.Element = js.native
    def setDisabled(disabled: Boolean, opt_force: Boolean): org.scalajs.dom.raw.Element = js.native
    /**
