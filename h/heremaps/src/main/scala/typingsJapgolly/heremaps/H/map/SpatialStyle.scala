...
import typingsJapgolly.heremaps.H.map.SpatialStyle.LineCap
import typingsJapgolly.heremaps.H.map.SpatialStyle.LineJoin
import typingsJapgolly.heremaps.H.map.SpatialStyle.Options
...
object SpatialStyle {
  ...
  */
  ...
  object LineCap {
    ...
    inline def butt: typingsJapgolly.heremaps.heremapsStrings.butt = "butt".asInstanceOf[typingsJapgolly.heremaps.heremapsStrings.butt]
    
    inline def round: typingsJapgolly.heremaps.heremapsStrings.round = "round".asInstanceOf[typingsJapgolly.heremaps.heremapsStrings.round]
    
    inline def square: typingsJapgolly.heremaps.heremapsStrings.square = "square".asInstanceOf[typingsJapgolly.heremaps.heremapsStrings.square]
  }
  ...
  */
  ...
  object LineJoin {
    ...
    inline def bevel: typingsJapgolly.heremaps.heremapsStrings.bevel = "bevel".asInstanceOf[typingsJapgolly.heremaps.heremapsStrings.bevel]
    
    inline def miter: typingsJapgolly.heremaps.heremapsStrings.miter = "miter".asInstanceOf[typingsJapgolly.heremaps.heremapsStrings.miter]
