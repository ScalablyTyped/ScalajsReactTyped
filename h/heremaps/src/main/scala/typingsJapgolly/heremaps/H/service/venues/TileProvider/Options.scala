package typingsJapgolly.heremaps.H.service.venues.TileProvider

import japgolly.scalajs.react.Callback
import typingsJapgolly.heremaps.H.service.venues.Space
...
object Options {
  @scala.inline
  def apply(
    onSpaceCreated: /* space */ Space => Callback = null,
    pixelRatio: Int | Double = null,
    tileCacheSize: Int | Double = null
  ): Options = {
    val __obj = js.Dynamic.literal()
    if (onSpaceCreated != null) __obj.updateDynamic("onSpaceCreated")(js.Any.fromFunction1((t0: /* space */ typingsJapgolly.heremaps.H.service.venues.Space) => onSpaceCreated(t0).runNow()))
