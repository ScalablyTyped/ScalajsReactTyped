...
import typingsJapgolly.heremaps.H.data.AbstractReader.State
import typingsJapgolly.heremaps.H.data.geojson.Reader.Options
...
object data {
  ...
  open class AbstractReader ()
    extends StObject
       with typingsJapgolly.heremaps.H.data.AbstractReader {
  ...
  object AbstractReader {
    ...
    open class Event protected ()
      ...
      /**
        ...
        */
      def this(
        target: typingsJapgolly.heremaps.H.data.AbstractReader,
        `type`: String,
        state: State,
        message: String
      ) = this()
    ...
    object State extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.heremaps.H.data.AbstractReader.State & Double] = js.native
      
      /* 0 */ val ERROR: typingsJapgolly.heremaps.H.data.AbstractReader.State.ERROR & Double = js.native
      
      /* 1 */ val LOADING: typingsJapgolly.heremaps.H.data.AbstractReader.State.LOADING & Double = js.native
      
      /* 3 */ val READY: typingsJapgolly.heremaps.H.data.AbstractReader.State.READY & Double = js.native
      
      /* 2 */ val VISIT: typingsJapgolly.heremaps.H.data.AbstractReader.State.VISIT & Double = js.native
    }
  }
  ...
  object geojson {
    ...
    open class Reader ()
      extends StObject
         with typingsJapgolly.heremaps.H.data.geojson.Reader {
      def this(opt_url: String) = this()
