...
import typingsJapgolly.heremaps.H.clustering.Provider
...
import typingsJapgolly.heremaps.H.map.provider.MarkerTileProvider
...
object layer {
  ...
  open class BaseTileLayer protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.map.layer.BaseTileLayer {
    /**
      * Constructor
  ...
  open class Layer ()
    extends StObject
       with typingsJapgolly.heremaps.H.map.layer.Layer {
    def this(opt_options: typingsJapgolly.heremaps.H.map.layer.Layer.Options) = this()
  }
  ...
  open class MarkerTileLayer protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.map.layer.MarkerTileLayer {
    /**
      * Constructor
  ...
  open class ObjectLayer protected ()
    ...
    def this(provider: Provider, opt_options: typingsJapgolly.heremaps.H.map.layer.ObjectLayer.Options) = this()
    def this(provider: ObjectProvider, opt_options: typingsJapgolly.heremaps.H.map.layer.ObjectLayer.Options) = this()
    ...
    override def requestTiles(
      ...
      cacheOnly: Boolean,
      prioCenter: Point
    ): typingsJapgolly.heremaps.H.map.layer.ITileLayer.Response = js.native
  }
  ...
  open class TileLayer protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.map.layer.TileLayer {
    /**
      * Constructor
      * @param provider {H.map.provider.TileProvider} - data source for the TileLayer
      * @param opt_options {H.map.layer.ITileLayer.Options=} - additional options
