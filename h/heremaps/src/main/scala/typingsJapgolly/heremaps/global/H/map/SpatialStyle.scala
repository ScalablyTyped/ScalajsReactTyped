...
open class SpatialStyle ()
  extends StObject
     with typingsJapgolly.heremaps.H.map.SpatialStyle {
  def this(opt_options: typingsJapgolly.heremaps.H.map.SpatialStyle) = this()
...
object SpatialStyle {
  ...
  @js.native
  def DEFAULT_STYLE: typingsJapgolly.heremaps.H.map.SpatialStyle = js.native
  inline def DEFAULT_STYLE_=(x: typingsJapgolly.heremaps.H.map.SpatialStyle): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DEFAULT_STYLE")(x.asInstanceOf[js.Any])
