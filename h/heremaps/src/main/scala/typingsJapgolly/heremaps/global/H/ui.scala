...
import typingsJapgolly.heremaps.H.ui.DistanceMeasurement.Options
...
object ui {
  ...
  open class Control ()
    extends StObject
       with typingsJapgolly.heremaps.H.ui.Control
  ...
  open class InfoBubble protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.ui.InfoBubble {
    /**
      * Constructor
    ...
    def this(position: IPoint, opt_options: typingsJapgolly.heremaps.H.ui.InfoBubble.Options) = this()
  }
  object InfoBubble {
    ...
    object State extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.heremaps.H.ui.InfoBubble.State & Double] = js.native
      
      /* 1 */ val CLOSED: typingsJapgolly.heremaps.H.ui.InfoBubble.State.CLOSED & Double = js.native
      
      /* 0 */ val OPEN: typingsJapgolly.heremaps.H.ui.InfoBubble.State.OPEN & Double = js.native
    }
  }
  ...
  object LayoutAlignment extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.heremaps.H.ui.LayoutAlignment & Double] = js.native
    
    /* 10 */ val BOTTOM_CENTER: typingsJapgolly.heremaps.H.ui.LayoutAlignment.BOTTOM_CENTER & Double = js.native
    
    /* 9 */ val BOTTOM_LEFT: typingsJapgolly.heremaps.H.ui.LayoutAlignment.BOTTOM_LEFT & Double = js.native
    
    /* 11 */ val BOTTOM_RIGHT: typingsJapgolly.heremaps.H.ui.LayoutAlignment.BOTTOM_RIGHT & Double = js.native
    
    /* 5 */ val LEFT_BOTTOM: typingsJapgolly.heremaps.H.ui.LayoutAlignment.LEFT_BOTTOM & Double = js.native
    
    /* 4 */ val LEFT_MIDDLE: typingsJapgolly.heremaps.H.ui.LayoutAlignment.LEFT_MIDDLE & Double = js.native
    
    /* 3 */ val LEFT_TOP: typingsJapgolly.heremaps.H.ui.LayoutAlignment.LEFT_TOP & Double = js.native
    
    /* 8 */ val RIGHT_BOTTOM: typingsJapgolly.heremaps.H.ui.LayoutAlignment.RIGHT_BOTTOM & Double = js.native
    
    /* 7 */ val RIGHT_MIDDLE: typingsJapgolly.heremaps.H.ui.LayoutAlignment.RIGHT_MIDDLE & Double = js.native
    
    /* 6 */ val RIGHT_TOP: typingsJapgolly.heremaps.H.ui.LayoutAlignment.RIGHT_TOP & Double = js.native
    
    /* 1 */ val TOP_CENTER: typingsJapgolly.heremaps.H.ui.LayoutAlignment.TOP_CENTER & Double = js.native
    
    /* 0 */ val TOP_LEFT: typingsJapgolly.heremaps.H.ui.LayoutAlignment.TOP_LEFT & Double = js.native
    
    /* 2 */ val TOP_RIGHT: typingsJapgolly.heremaps.H.ui.LayoutAlignment.TOP_RIGHT & Double = js.native
  }
  ...
  open class MapSettingsControl ()
    extends StObject
       with typingsJapgolly.heremaps.H.ui.MapSettingsControl {
    def this(opt_options: typingsJapgolly.heremaps.H.ui.MapSettingsControl.Options) = this()
  }
  ...
  open class Pano ()
    extends StObject
       with typingsJapgolly.heremaps.H.ui.Control {
    def this(opt_options: typingsJapgolly.heremaps.H.ui.Pano.Options) = this()
  }
  ...
  open class ScaleBar ()
    extends StObject
       with typingsJapgolly.heremaps.H.ui.ScaleBar {
    def this(opt_options: typingsJapgolly.heremaps.H.ui.ScaleBar.Options) = this()
  }
  ...
  open class UI protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.ui.UI {
    /**
      * Constructor
      * @param map {H.Map}
    ...
    def this(map: typingsJapgolly.heremaps.H.Map_, opt_options: typingsJapgolly.heremaps.H.ui.UI.Options) = this()
  }
  object UI {
    ...
    inline def createDefault(map: typingsJapgolly.heremaps.H.Map_, mapTypes: DefaultLayers): typingsJapgolly.heremaps.H.ui.UI = (^.asInstanceOf[js.Dynamic].applyDynamic("createDefault")(map.asInstanceOf[js.Any], mapTypes.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.ui.UI]
    inline def createDefault(map: typingsJapgolly.heremaps.H.Map_, mapTypes: DefaultLayers, opt_locale: String): typingsJapgolly.heremaps.H.ui.UI = (^.asInstanceOf[js.Dynamic].applyDynamic("createDefault")(map.asInstanceOf[js.Any], mapTypes.asInstanceOf[js.Any], opt_locale.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.ui.UI]
    inline def createDefault(map: typingsJapgolly.heremaps.H.Map_, mapTypes: DefaultLayers, opt_locale: Localization): typingsJapgolly.heremaps.H.ui.UI = (^.asInstanceOf[js.Dynamic].applyDynamic("createDefault")(map.asInstanceOf[js.Any], mapTypes.asInstanceOf[js.Any], opt_locale.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.ui.UI]
    /**
      ...
      */
    /* static member */
    inline def createDefault(map: typingsJapgolly.heremaps.H.Map_, mapTypes: MapTypes): typingsJapgolly.heremaps.H.ui.UI = (^.asInstanceOf[js.Dynamic].applyDynamic("createDefault")(map.asInstanceOf[js.Any], mapTypes.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.ui.UI]
    inline def createDefault(map: typingsJapgolly.heremaps.H.Map_, mapTypes: MapTypes, opt_locale: String): typingsJapgolly.heremaps.H.ui.UI = (^.asInstanceOf[js.Dynamic].applyDynamic("createDefault")(map.asInstanceOf[js.Any], mapTypes.asInstanceOf[js.Any], opt_locale.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.ui.UI]
    inline def createDefault(map: typingsJapgolly.heremaps.H.Map_, mapTypes: MapTypes, opt_locale: Localization): typingsJapgolly.heremaps.H.ui.UI = (^.asInstanceOf[js.Dynamic].applyDynamic("createDefault")(map.asInstanceOf[js.Any], mapTypes.asInstanceOf[js.Any], opt_locale.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.ui.UI]
  }
  ...
  object UnitSystem extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.heremaps.H.ui.UnitSystem & Double] = js.native
    
    /* 0 */ val IMPERIAL: typingsJapgolly.heremaps.H.ui.UnitSystem.IMPERIAL & Double = js.native
    
    /* 1 */ val METRIC: typingsJapgolly.heremaps.H.ui.UnitSystem.METRIC & Double = js.native
  }
  ...
  open class ZoomControl ()
    extends StObject
       with typingsJapgolly.heremaps.H.ui.ZoomControl {
    def this(opt_options: typingsJapgolly.heremaps.H.ui.ZoomControl.Options) = this()
  }
  ...
  open class ZoomRectangle ()
    extends StObject
       with typingsJapgolly.heremaps.H.ui.Control {
    def this(opt_options: typingsJapgolly.heremaps.H.ui.ZoomRectangle.Options) = this()
  }
  ...
  object base {
    ...
    open class Container ()
      extends StObject
         with typingsJapgolly.heremaps.H.ui.base.Container {
      ...
      def this(
        ...
        opt_children: js.Array[typingsJapgolly.heremaps.H.ui.base.Element]
      ) = this()
      def this(
        opt_elementType: String,
        opt_className: Unit,
    ...
    open class Element ()
      extends StObject
         with typingsJapgolly.heremaps.H.ui.base.Element {
      def this(opt_elementType: String) = this()
      def this(opt_elementType: String, opt_className: String) = this()
      def this(opt_elementType: Unit, opt_className: String) = this()
    }
  ...
  object i18n {
    ...
    open class Localization protected ()
      extends StObject
         with typingsJapgolly.heremaps.H.ui.i18n.Localization {
