...
open class HitArea protected ()
  extends StObject
     with typingsJapgolly.heremaps.H.map.HitArea {
  /**
    * Constructor
...
object HitArea {
  ...
  object ShapeType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.heremaps.H.map.HitArea.ShapeType & Double] = js.native
    
    /* 2 */ val CIRCLE: typingsJapgolly.heremaps.H.map.HitArea.ShapeType.CIRCLE & Double = js.native
    
    /* 0 */ val NONE: typingsJapgolly.heremaps.H.map.HitArea.ShapeType.NONE & Double = js.native
    
    /* 3 */ val POLYGON: typingsJapgolly.heremaps.H.map.HitArea.ShapeType.POLYGON & Double = js.native
    
    /* 1 */ val RECT: typingsJapgolly.heremaps.H.map.HitArea.ShapeType.RECT & Double = js.native
  }
}
