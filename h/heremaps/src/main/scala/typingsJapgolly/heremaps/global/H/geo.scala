...
object geo {
  ...
  open class AbstractGeometry ()
    extends StObject
       with typingsJapgolly.heremaps.H.geo.AbstractGeometry {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getBoundingBox(): typingsJapgolly.heremaps.H.geo.Rect = js.native
  ...
  object AltitudeContext extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.heremaps.H.geo.AltitudeContext & Double] = js.native
    
    /* 1 */ val GL: typingsJapgolly.heremaps.H.geo.AltitudeContext.GL & Double = js.native
    
    /* 2 */ val OL: typingsJapgolly.heremaps.H.geo.AltitudeContext.OL & Double = js.native
    
    /* 4 */ val SB: typingsJapgolly.heremaps.H.geo.AltitudeContext.SB & Double = js.native
    
    /* 3 */ val SL: typingsJapgolly.heremaps.H.geo.AltitudeContext.SL & Double = js.native
    
    /* 5 */ val WE: typingsJapgolly.heremaps.H.geo.AltitudeContext.WE & Double = js.native
    
    /* 6 */ val WG: typingsJapgolly.heremaps.H.geo.AltitudeContext.WG & Double = js.native
    
    /* 0 */ val undefined: typingsJapgolly.heremaps.H.geo.AltitudeContext.undefined & Double = js.native
  }
  ...
  open class LineString ()
    extends StObject
       with typingsJapgolly.heremaps.H.geo.LineString {
  ...
  object LineString {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromLatLngArray(latLngs: js.Array[Double]): typingsJapgolly.heremaps.H.geo.LineString = ^.asInstanceOf[js.Dynamic].applyDynamic("fromLatLngArray")(latLngs.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.heremaps.H.geo.LineString]
  ...
  open class MultiGeometry[T] protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.geo.MultiGeometry[T] {
    /**
  ...
  open class MultiLineString protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.geo.MultiLineString {
    /**
      ...
      */
    def this(lineStrings: js.Array[typingsJapgolly.heremaps.H.geo.LineString]) = this()
  ...
  open class MultiPoint ()
    extends StObject
       with typingsJapgolly.heremaps.H.geo.MultiGeometry[typingsJapgolly.heremaps.H.geo.Point] {
  ...
  open class MultiPolygon ()
    extends StObject
       with typingsJapgolly.heremaps.H.geo.MultiGeometry[typingsJapgolly.heremaps.H.geo.Polygon] {
  ...
  open class PixelProjection ()
    extends StObject
       with typingsJapgolly.heremaps.H.geo.PixelProjection {
  ...
  open class Point protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.geo.Point {
    /**
      * Constructor
      * @property lat {H.geo.Latitude} - The latitude coordinate.
      * @property lng {H.geo.Longitude} - The longitude coordinate.
  ...
  object Point {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIPoint(iPoint: IPoint): typingsJapgolly.heremaps.H.geo.Point = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIPoint")(iPoint.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.heremaps.H.geo.Point]
  ...
  open class Polygon protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.geo.Polygon {
    def this(exterior: typingsJapgolly.heremaps.H.geo.LineString) = this()
    def this(
      exterior: typingsJapgolly.heremaps.H.geo.LineString,
      opt_interiors: js.Array[typingsJapgolly.heremaps.H.geo.LineString]
    ) = this()
  ...
  open class Rect protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.geo.Rect {
    /**
      * Constructor
  ...
  object Rect {
    ...
    /**
      ...
      */
    /* static member */
    inline def coverLatLngAlts(latLngAltArray: js.Array[Double]): typingsJapgolly.heremaps.H.geo.Rect | Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("coverLatLngAlts")(latLngAltArray.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.heremaps.H.geo.Rect | Unit]
    inline def coverLatLngAlts(latLngAltArray: js.Array[Double], opt_skipValidation: Boolean): typingsJapgolly.heremaps.H.geo.Rect | Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("coverLatLngAlts")(latLngAltArray.asInstanceOf[js.Any], opt_skipValidation.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.geo.Rect | Unit]
    ...
    /**
      ...
      */
    /* static member */
    inline def coverPoints(pointArray: js.Array[IPoint]): typingsJapgolly.heremaps.H.geo.Rect = ^.asInstanceOf[js.Dynamic].applyDynamic("coverPoints")(pointArray.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.heremaps.H.geo.Rect]
    inline def coverPoints(pointArray: js.Array[IPoint], opt_skipValidation: Boolean): typingsJapgolly.heremaps.H.geo.Rect = (^.asInstanceOf[js.Dynamic].applyDynamic("coverPoints")(pointArray.asInstanceOf[js.Any], opt_skipValidation.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.geo.Rect]
    ...
    /**
      ...
      */
    /* static member */
    inline def coverRects(rectArray: js.Array[typingsJapgolly.heremaps.H.geo.Rect]): typingsJapgolly.heremaps.H.geo.Rect | Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("coverRects")(rectArray.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.heremaps.H.geo.Rect | Unit]
    inline def coverRects(rectArray: js.Array[typingsJapgolly.heremaps.H.geo.Rect], opt_skipValidation: Boolean): typingsJapgolly.heremaps.H.geo.Rect | Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("coverRects")(rectArray.asInstanceOf[js.Any], opt_skipValidation.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.geo.Rect | Unit]
    ...
    /**
      ...
      */
    /* static member */
    inline def fromPoints(topLeft: IPoint, bottomRight: IPoint): typingsJapgolly.heremaps.H.geo.Rect = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPoints")(topLeft.asInstanceOf[js.Any], bottomRight.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.geo.Rect]
    inline def fromPoints(topLeft: IPoint, bottomRight: IPoint, opt_skipValidation: Boolean): typingsJapgolly.heremaps.H.geo.Rect = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPoints")(topLeft.asInstanceOf[js.Any], bottomRight.asInstanceOf[js.Any], opt_skipValidation.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.geo.Rect]
    ...
    inline def merge(
      ...
      bottomB: Latitude,
      rightB: Longitude,
      opt_out: typingsJapgolly.heremaps.H.geo.Rect
    ): typingsJapgolly.heremaps.H.geo.Rect = (^.asInstanceOf[js.Dynamic].applyDynamic("merge")(topA.asInstanceOf[js.Any], leftA.asInstanceOf[js.Any], bottomA.asInstanceOf[js.Any], rightA.asInstanceOf[js.Any], topB.asInstanceOf[js.Any], leftB.asInstanceOf[js.Any], bottomB.asInstanceOf[js.Any], rightB.asInstanceOf[js.Any], opt_out.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.geo.Rect]
  }
}
