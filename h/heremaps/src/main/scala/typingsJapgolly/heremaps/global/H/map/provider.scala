...
import typingsJapgolly.heremaps.H.map.provider.ImageTileProvider.Options
import typingsJapgolly.heremaps.H.map.provider.Invalidations.Mark
...
object provider {
  ...
  open class ImageTileProvider protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.map.provider.ImageTileProvider {
    /**
      * Constructor
  ...
  open class Invalidations ()
    extends StObject
       with typingsJapgolly.heremaps.H.map.provider.Invalidations {
  ...
  object Invalidations {
    ...
    object Flag extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.heremaps.H.map.provider.Invalidations.Flag & Double] = js.native
      
      /* 3 */ val ADD: typingsJapgolly.heremaps.H.map.provider.Invalidations.Flag.ADD & Double = js.native
      
      /* 0 */ val NONE: typingsJapgolly.heremaps.H.map.provider.Invalidations.Flag.NONE & Double = js.native
      
      /* 4 */ val REMOVE: typingsJapgolly.heremaps.H.map.provider.Invalidations.Flag.REMOVE & Double = js.native
      
      /* 2 */ val SPATIAL: typingsJapgolly.heremaps.H.map.provider.Invalidations.Flag.SPATIAL & Double = js.native
      
      /* 1 */ val VISUAL: typingsJapgolly.heremaps.H.map.provider.Invalidations.Flag.VISUAL & Double = js.native
      
      /* 5 */ val Z_ORDER: typingsJapgolly.heremaps.H.map.provider.Invalidations.Flag.Z_ORDER & Double = js.native
    }
  ...
  open class LocalObjectProvider ()
    extends StObject
       with typingsJapgolly.heremaps.H.map.provider.LocalObjectProvider
  ...
  open class MarkerTileProvider protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.map.provider.MarkerTileProvider {
    /**
      * Constructor
      * @param options {H.map.provider.MarkerTileProvider.Options} - configuration for tile provider
      */
    def this(options: typingsJapgolly.heremaps.H.map.provider.MarkerTileProvider.Options) = this()
  }
  ...
  open class ObjectProvider ()
    extends StObject
       with typingsJapgolly.heremaps.H.map.provider.ObjectProvider {
    def this(opt_options: typingsJapgolly.heremaps.H.map.provider.Provider.Options) = this()
  }
  ...
  open class Provider ()
    extends StObject
       with typingsJapgolly.heremaps.H.map.provider.Provider {
    def this(opt_options: typingsJapgolly.heremaps.H.map.provider.Provider.Options) = this()
  }
  ...
  open class RemoteTileProvider protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.map.provider.RemoteTileProvider {
    /**
      * Constructor
      * @param options {H.map.provider.TileProvider.Options} - The options to instantiate this TileProvider
      */
    def this(options: typingsJapgolly.heremaps.H.map.provider.TileProvider.Options) = this()
  }
  ...
  open class Tile protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.map.provider.Tile {
    /**
      * Constructor
  ...
  open class TileProvider protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.map.provider.TileProvider {
    /**
      * Constructor
      * @param options {H.map.provider.TileProvider.Options} - The options to instantiate this TileProvider
      */
