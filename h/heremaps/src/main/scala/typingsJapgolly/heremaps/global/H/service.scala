...
object service {
  ...
  open class AbstractRestService ()
    extends StObject
       with typingsJapgolly.heremaps.H.service.AbstractRestService {
  ...
  open class EnterpriseRoutingService ()
    extends StObject
       with typingsJapgolly.heremaps.H.service.EnterpriseRoutingService {
    def this(opt_options: typingsJapgolly.heremaps.H.service.EnterpriseRoutingService.Options) = this()
  }
  ...
  open class GeocodingService ()
    extends StObject
       with typingsJapgolly.heremaps.H.service.GeocodingService {
    def this(opt_options: typingsJapgolly.heremaps.H.service.GeocodingService.Options) = this()
  }
  ...
  open class MapTileService ()
    extends StObject
       with typingsJapgolly.heremaps.H.service.MapTileService {
    def this(opt_options: typingsJapgolly.heremaps.H.service.MapTileService.Options) = this()
  }
  ...
  open class PlacesService ()
    extends StObject
       with typingsJapgolly.heremaps.H.service.PlacesService {
    def this(opt_options: typingsJapgolly.heremaps.H.service.PlacesService.Options) = this()
  }
  object PlacesService {
    ...
    object EntryPoint extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.heremaps.H.service.PlacesService.EntryPoint & Double] = js.native
      
      /* 3 */ val AROUND: typingsJapgolly.heremaps.H.service.PlacesService.EntryPoint.AROUND & Double = js.native
      
      /* 5 */ val CATEGORIES: typingsJapgolly.heremaps.H.service.PlacesService.EntryPoint.CATEGORIES & Double = js.native
      
      /* 2 */ val EXPLORE: typingsJapgolly.heremaps.H.service.PlacesService.EntryPoint.EXPLORE & Double = js.native
      
      /* 4 */ val HERE: typingsJapgolly.heremaps.H.service.PlacesService.EntryPoint.HERE & Double = js.native
      
      /* 0 */ val SEARCH: typingsJapgolly.heremaps.H.service.PlacesService.EntryPoint.SEARCH & Double = js.native
      
      /* 1 */ val SUGGEST: typingsJapgolly.heremaps.H.service.PlacesService.EntryPoint.SUGGEST & Double = js.native
    }
  }
  ...
  open class Platform protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.service.Platform {
    /**
      * Constructor
      * @param options {H.service.Platform.Options}
      */
    def this(options: typingsJapgolly.heremaps.H.service.Platform.Options) = this()
  }
  ...
  open class RoutingService ()
    extends StObject
       with typingsJapgolly.heremaps.H.service.RoutingService {
    def this(opt_options: typingsJapgolly.heremaps.H.service.RoutingService.Options) = this()
  }
  ...
  open class Url protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.service.Url {
    /**
      * Constructor
  ...
  object Url {
    ...
    /**
      ...
      */
    /* static member */
    inline def parse(url: String): typingsJapgolly.heremaps.H.service.Url = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(url.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.heremaps.H.service.Url]
    inline def parse(url: String, opt_baseURL: String): typingsJapgolly.heremaps.H.service.Url = (^.asInstanceOf[js.Dynamic].applyDynamic("parse")(url.asInstanceOf[js.Any], opt_baseURL.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.service.Url]
  }
  ...
  object metaInfo {
    ...
    open class Service ()
      extends StObject
         with typingsJapgolly.heremaps.H.service.metaInfo.Service {
      def this(opt_options: typingsJapgolly.heremaps.H.service.metaInfo.Service.Options) = this()
    }
    ...
    open class TileProvider protected ()
      ...
      def this(service: typingsJapgolly.heremaps.H.service.MapTileService) = this()
      /**
        * Constructor
        ...
        */
      def this(service: typingsJapgolly.heremaps.H.service.metaInfo.Service) = this()
      def this(service: typingsJapgolly.heremaps.H.service.MapTileService, opt_params: ServiceParameters) = this()
      def this(service: typingsJapgolly.heremaps.H.service.metaInfo.Service, opt_params: ServiceParameters) = this()
      def this(
        service: typingsJapgolly.heremaps.H.service.MapTileService,
        opt_params: Unit,
        opt_options: typingsJapgolly.heremaps.H.service.metaInfo.TileProvider.Options
      ) = this()
      def this(
        service: typingsJapgolly.heremaps.H.service.MapTileService,
      ...
      def this(
        service: typingsJapgolly.heremaps.H.service.metaInfo.Service,
        opt_params: Unit,
        opt_options: typingsJapgolly.heremaps.H.service.metaInfo.TileProvider.Options
      ) = this()
      def this(
  ...
  object traffic {
    ...
    open class Service ()
      extends StObject
         with typingsJapgolly.heremaps.H.service.traffic.Service {
      def this(opt_options: typingsJapgolly.heremaps.H.service.traffic.Service.Options) = this()
    }
  }
  ...
  object venues {
    ...
    open class Building protected ()
      extends StObject
         with typingsJapgolly.heremaps.H.service.venues.Building {
      /**
        * Constructor
    ...
    open class Floor protected ()
      extends StObject
         with typingsJapgolly.heremaps.H.service.venues.Floor {
      /**
        * Constructor
    ...
    open class Service ()
      extends StObject
         with typingsJapgolly.heremaps.H.service.venues.Service {
      def this(opt_options: typingsJapgolly.heremaps.H.service.venues.Service.Options) = this()
    }
    object Service {
      ...
      object State extends StObject {
        ...
        @JSBracketAccess
        def apply(value: Double): js.UndefOr[typingsJapgolly.heremaps.H.service.venues.Service.State & Double] = js.native
        
        /* 0 */ val ERROR: typingsJapgolly.heremaps.H.service.venues.Service.State.ERROR & Double = js.native
        
        /* 1 */ val INIT: typingsJapgolly.heremaps.H.service.venues.Service.State.INIT & Double = js.native
        
        /* 2 */ val READY: typingsJapgolly.heremaps.H.service.venues.Service.State.READY & Double = js.native
      }
    }
    ...
    open class Space protected ()
      extends StObject
         with typingsJapgolly.heremaps.H.service.venues.Space {
      /**
        * Constructor
    ...
    open class TileProvider protected ()
      extends StObject
         with typingsJapgolly.heremaps.H.service.venues.TileProvider {
      /**
        * Constructor
        * @param service {H.service.venues.Service}
        * @param opt_options {H.service.venues.TileProvider.Options=}
        */
      def this(service: typingsJapgolly.heremaps.H.service.venues.Service) = this()
      def this(
        service: typingsJapgolly.heremaps.H.service.venues.Service,
        opt_options: typingsJapgolly.heremaps.H.service.venues.TileProvider.Options
      ) = this()
    }
    ...
    open class Venue protected ()
      extends StObject
         with typingsJapgolly.heremaps.H.service.venues.Venue {
      /**
        * Constructor
