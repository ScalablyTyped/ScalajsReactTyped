...
import typingsJapgolly.heremaps.H.math.IPoint
...
object math {
  ...
  open class Point protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.math.Point {
    /**
      * Constructor
  ...
  object Point {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromIPoint(iPoint: IPoint): typingsJapgolly.heremaps.H.math.Point = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIPoint")(iPoint.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.heremaps.H.math.Point]
  }
  ...
  open class Rect protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.math.Rect {
    /**
      * Constructor
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getBottomRight(): typingsJapgolly.heremaps.H.math.Point = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getTopLeft(): typingsJapgolly.heremaps.H.math.Point = js.native
  ...
  object Rect {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromPoints(topLeft: IPoint, bottomRight: IPoint): typingsJapgolly.heremaps.H.math.Rect = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPoints")(topLeft.asInstanceOf[js.Any], bottomRight.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heremaps.H.math.Rect]
  }
  ...
  open class Size protected ()
    extends StObject
       with typingsJapgolly.heremaps.H.math.Size {
    /**
      * Constructor
