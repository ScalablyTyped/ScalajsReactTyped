package typingsJapgolly.htmlWebpackTagsPlugin
...
object mod {
  ...
  object HtmlWebpackTagsPlugin {
    ...
    inline def apply(apply: Compiler => Callback): HtmlWebpackTagsPlugin = {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.htmlWebpackTagsPlugin.htmlWebpackTagsPluginStrings.css
    - typingsJapgolly.htmlWebpackTagsPlugin.htmlWebpackTagsPluginStrings.js_
  */
  trait TypeString extends StObject
  object TypeString {
    
    inline def css: typingsJapgolly.htmlWebpackTagsPlugin.htmlWebpackTagsPluginStrings.css = "css".asInstanceOf[typingsJapgolly.htmlWebpackTagsPlugin.htmlWebpackTagsPluginStrings.css]
    
    inline def js_ : typingsJapgolly.htmlWebpackTagsPlugin.htmlWebpackTagsPluginStrings.js_ = "js".asInstanceOf[typingsJapgolly.htmlWebpackTagsPlugin.htmlWebpackTagsPluginStrings.js_]
  }
}
