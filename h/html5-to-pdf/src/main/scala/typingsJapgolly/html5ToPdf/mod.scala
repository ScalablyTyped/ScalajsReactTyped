package typingsJapgolly.html5ToPdf

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.html5ToPdf.html5ToPdfStrings.A3
import typingsJapgolly.html5ToPdf.html5ToPdfStrings.A4
import typingsJapgolly.html5ToPdf.html5ToPdfStrings.Legal
import typingsJapgolly.html5ToPdf.html5ToPdfStrings.Tabloid
import typingsJapgolly.html5ToPdf.html5ToPdfStrings.css
import typingsJapgolly.html5ToPdf.html5ToPdfStrings.js_
import typingsJapgolly.node.bufferMod.global.Buffer
import typingsJapgolly.puppeteer.mod.LaunchOptions
import typingsJapgolly.puppeteer.mod.PDFOptions
...
object mod {
  ...
  object HTML5ToPDF {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(build = build.toJsFn, close = close.toJsFn, includeAssets = includeAssets.toJsFn, parseOptions = js.Any.fromFunction1(parseOptions), start = start.toJsFn)
      __obj.asInstanceOf[HTML5ToPDF]
    }
    
    extension [Self <: HTML5ToPDF](x: Self) {
      
      inline def setBuild(value: CallbackTo[js.Promise[Buffer]]): Self = StObject.set(x, "build", value.toJsFn)
      
      inline def setClose(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "close", value.toJsFn)
      
      inline def setIncludeAssets(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "includeAssets", value.toJsFn)
      
      inline def setParseOptions(value: Options => ParsedOptions): Self = StObject.set(x, "parseOptions", js.Any.fromFunction1(value))
      
      inline def setStart(value: CallbackTo[js.Promise[Page]]): Self = StObject.set(x, "start", value.toJsFn)
    }
  }
