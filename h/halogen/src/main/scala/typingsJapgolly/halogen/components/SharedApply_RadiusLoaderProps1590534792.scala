...
abstract class SharedApply_RadiusLoaderProps1590534792[ComponentRef] () {
  ...
  typingsJapgolly.halogen.mod.RadiusLoaderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.halogen.mod.RadiusLoaderProps])(children: _*)
  }
}
