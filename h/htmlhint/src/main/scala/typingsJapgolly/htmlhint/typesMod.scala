...
import typingsJapgolly.htmlhint.anon.Message
import typingsJapgolly.htmlhint.htmlhintStrings.abs
import typingsJapgolly.htmlhint.htmlhintStrings.dash
import typingsJapgolly.htmlhint.htmlhintStrings.hump
import typingsJapgolly.htmlhint.htmlhintStrings.rel
import typingsJapgolly.htmlhint.htmlhintStrings.space
import typingsJapgolly.htmlhint.htmlhintStrings.space1
import typingsJapgolly.htmlhint.htmlhintStrings.space2
import typingsJapgolly.htmlhint.htmlhintStrings.space3
import typingsJapgolly.htmlhint.htmlhintStrings.space4
import typingsJapgolly.htmlhint.htmlhintStrings.space5
import typingsJapgolly.htmlhint.htmlhintStrings.space6
import typingsJapgolly.htmlhint.htmlhintStrings.space7
import typingsJapgolly.htmlhint.htmlhintStrings.space8
import typingsJapgolly.htmlhint.htmlhintStrings.tab
import typingsJapgolly.htmlhint.htmlhintStrings.underline
import typingsJapgolly.htmlhint.mod.HTMLParser
import typingsJapgolly.htmlhint.mod.Reporter
...
object typesMod {
  ...
  object ReportType extends StObject {
    ...
    sealed trait error
      extends StObject
         with ReportType
    /* "error" */ val error: typingsJapgolly.htmlhint.typesMod.ReportType.error & String = js.native
    
    @js.native
    sealed trait info
      extends StObject
         with ReportType
    /* "info" */ val info: typingsJapgolly.htmlhint.typesMod.ReportType.info & String = js.native
    
    @js.native
    sealed trait warning
      extends StObject
         with ReportType
    /* "warning" */ val warning: typingsJapgolly.htmlhint.typesMod.ReportType.warning & String = js.native
  }
  ...
  object Rule {
    ...
    inline def apply(description: String, id: String, init: (HTMLParser, Reporter, Any) => Callback): Rule = {
      val __obj = js.Dynamic.literal(description = description.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], init = js.Any.fromFunction3((t0: HTMLParser, t1: Reporter, t2: Any) => (init(t0, t1, t2)).runNow()))
    ...
    extension [Self <: Rule](x: Self) {
      ...
      inline def setInit(value: (HTMLParser, Reporter, Any) => Callback): Self = StObject.set(x, "init", js.Any.fromFunction3((t0: HTMLParser, t1: Reporter, t2: Any) => (value(t0, t1, t2)).runNow()))
