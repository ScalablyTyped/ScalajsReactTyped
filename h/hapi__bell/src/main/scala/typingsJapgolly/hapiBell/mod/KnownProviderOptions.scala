...
import typingsJapgolly.hapiBell.AnonExtendedProfile
import typingsJapgolly.hapiBell.AnonUri
...
object KnownProviderOptions {
  ...
  def apply(
    ...
    if (runtimeStateCallback != null) __obj.updateDynamic("runtimeStateCallback")(js.Any.fromFunction1((t0: /* req */ typingsJapgolly.hapiHapi.mod.Request) => runtimeStateCallback(t0).runNow()))
