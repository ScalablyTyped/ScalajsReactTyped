...
import typingsJapgolly.hellosignSdk.anon.Order
...
trait SignatureRequestRequestOptions[Metadata] extends StObject {
...
object SignatureRequestRequestOptions {
  
  inline def apply[Metadata](signers: js.Array[Order]): SignatureRequestRequestOptions[Metadata] = {
