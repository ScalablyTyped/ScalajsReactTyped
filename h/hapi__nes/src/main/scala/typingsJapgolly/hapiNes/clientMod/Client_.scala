...
import typingsJapgolly.hapiNes.AnonCode
import typingsJapgolly.hapiNes.clientMod.Client.ClientConnectOptions
import typingsJapgolly.hapiNes.clientMod.Client.ClientOptions
import typingsJapgolly.hapiNes.clientMod.Client.ClientRequestOptions
import typingsJapgolly.hapiNes.clientMod.Client.Handler
import typingsJapgolly.hapiNes.hapiNesBooleans.`true`
