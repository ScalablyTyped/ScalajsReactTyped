...
import typingsJapgolly.hapiNes.anon.Instantiable
...
object mod extends Shortcut {
  ...
  open class ClientCls protected ()
    extends StObject
       with typingsJapgolly.hapiNes.libClientMod.Client {
    def this(url: String) = this()
    def this(url: String, options: typingsJapgolly.hapiNes.libClientMod.Client.ClientOptions) = this()
  }
  ...
  /**
    ...
    */
  type Client = typingsJapgolly.hapiNes.libClientMod.Client
  
  type ClientConnectOptions = typingsJapgolly.hapiNes.libClientMod.Client.ClientConnectOptions
  
  type ClientOptions = typingsJapgolly.hapiNes.libClientMod.Client.ClientOptions
  
  type ClientRequestOptions = typingsJapgolly.hapiNes.libClientMod.Client.ClientRequestOptions
  
  type ClientSubscribeFlags = typingsJapgolly.hapiNes.libClientMod.Client.ClientSubscribeFlags
  
  type Handler = typingsJapgolly.hapiNes.libClientMod.Client.Handler
  ...
  object ServerSubscriptionOptions {
    ...
    extension [Self <: ServerSubscriptionOptions](x: Self) {
      ...
      inline def setFilter(
        value: (/* path */ String, /* message */ Any, /* options */ ServerSubscriptionOptionsFilterOptions, /* next */ js.Function2[/* isMatch */ Boolean, /* override */ js.UndefOr[Any], Unit]) => Callback
      ): Self = StObject.set(x, "filter", js.Any.fromFunction4((t0: /* path */ String, t1: /* message */ Any, t2: /* options */ ServerSubscriptionOptionsFilterOptions, t3: /* next */ js.Function2[/* isMatch */ Boolean, /* override */ js.UndefOr[Any], Unit]) => (value(t0, t1, t2, t3)).runNow()))
      ...
      inline def setOnUnsubscribeFunction2(value: (/* socket */ Socket, /* path */ String) => Callback): Self = StObject.set(x, "onUnsubscribe", js.Any.fromFunction2((t0: /* socket */ Socket, t1: /* path */ String) => (value(t0, t1)).runNow()))
      
      inline def setOnUnsubscribeFunction3(value: (/* socket */ Socket, /* path */ String, /* params */ Any) => Callback): Self = StObject.set(x, "onUnsubscribe", js.Any.fromFunction3((t0: /* socket */ Socket, t1: /* path */ String, t2: /* params */ Any) => (value(t0, t1, t2)).runNow()))
  ...
  object Socket {
    ...
    inline def apply(
      ...
      disconnect: CallbackTo[js.Promise[Any]],
      id: String,
      publish: (String, Any) => js.Promise[Any],
      revoke: (String, Any) => js.Promise[Any],
      send: Any => js.Promise[Any]
    ): Socket = {
      val __obj = js.Dynamic.literal(app = app.asInstanceOf[js.Any], auth = auth.asInstanceOf[js.Any], disconnect = disconnect.toJsFn, id = id.asInstanceOf[js.Any], publish = js.Any.fromFunction2(publish), revoke = js.Any.fromFunction2(revoke), send = js.Any.fromFunction1(send))
    ...
    extension [Self <: Socket](x: Self) {
      ...
      inline def setDisconnect(value: CallbackTo[js.Promise[Any]]): Self = StObject.set(x, "disconnect", value.toJsFn)
