...
object global {
  ...
  object Heap {
    ...
    // Constructor
    open class ^[T] ()
      extends typingsJapgolly.heap.mod.^[T] {
    ...
    // Build the heap.
    /* static member */
    inline def heapify[T](array: js.Array[T]): typingsJapgolly.heap.mod.Heap[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("heapify")(array.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.heap.mod.Heap[T]]
    inline def heapify[T](array: js.Array[T], cmp: js.Function2[/* a */ T, /* b */ T, Double]): typingsJapgolly.heap.mod.Heap[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("heapify")(array.asInstanceOf[js.Any], cmp.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.heap.mod.Heap[T]]
