...
import typingsJapgolly.hlsJs.mod.AbrController
import typingsJapgolly.hlsJs.mod.AudioStreamController
import typingsJapgolly.hlsJs.mod.AudioTrackController
import typingsJapgolly.hlsJs.mod.BufferController
import typingsJapgolly.hlsJs.mod.CMCD
import typingsJapgolly.hlsJs.mod.CMCDController
import typingsJapgolly.hlsJs.mod.CMCDControllerConfig
import typingsJapgolly.hlsJs.mod.CapLevelController
import typingsJapgolly.hlsJs.mod.CuesInterface
import typingsJapgolly.hlsJs.mod.DRMSystemOptions
import typingsJapgolly.hlsJs.mod.EMEController
import typingsJapgolly.hlsJs.mod.FPSController
import typingsJapgolly.hlsJs.mod.Fragment
import typingsJapgolly.hlsJs.mod.FragmentLoaderConstructor
import typingsJapgolly.hlsJs.mod.FragmentTracker
import typingsJapgolly.hlsJs.mod.Hls
import typingsJapgolly.hlsJs.mod.HlsChunkPerformanceTiming
import typingsJapgolly.hlsJs.mod.HlsConfig
import typingsJapgolly.hlsJs.mod.ILogger
import typingsJapgolly.hlsJs.mod.KeySystems
import typingsJapgolly.hlsJs.mod.Level
import typingsJapgolly.hlsJs.mod.Loader
import typingsJapgolly.hlsJs.mod.LoaderContext
import typingsJapgolly.hlsJs.mod.MediaKeyFunc
import typingsJapgolly.hlsJs.mod.Part
import typingsJapgolly.hlsJs.mod.PlaylistLoaderConstructor
import typingsJapgolly.hlsJs.mod.SubtitleStreamController
import typingsJapgolly.hlsJs.mod.SubtitleTrackController
import typingsJapgolly.hlsJs.mod.TimelineController
...
object anon {
  ...
  object PartialHlsConfig {
    ...
    extension [Self <: PartialHlsConfig](x: Self) {
      ...
      inline def setXhrSetup(value: (/* xhr */ XMLHttpRequest, /* url */ String) => Callback): Self = StObject.set(x, "xhrSetup", js.Any.fromFunction2((t0: /* xhr */ XMLHttpRequest, t1: /* url */ String) => (value(t0, t1)).runNow()))
  ...
  object TypeofCMCDController {
    ...
    inline def apply(
      ...
      toQuery: CMCD => String,
      uuid: CallbackTo[String]
    ): TypeofCMCDController = {
      val __obj = js.Dynamic.literal(appendQueryToUri = js.Any.fromFunction2(appendQueryToUri), serialize = js.Any.fromFunction1(serialize), toHeaders = js.Any.fromFunction1(toHeaders), toQuery = js.Any.fromFunction1(toQuery), uuid = uuid.toJsFn)
