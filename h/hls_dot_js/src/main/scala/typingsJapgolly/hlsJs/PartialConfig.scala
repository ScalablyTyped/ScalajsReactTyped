...
import typingsJapgolly.hlsJs.mod.CustomLoggerObject
import typingsJapgolly.hlsJs.mod.Loader
import typingsJapgolly.hlsJs.mod.LoaderConfig
...
object PartialConfig {
  ...
  def apply(
    ...
    fetchSetup: (/* context */ js.Any, /* initParams */ js.Any) => CallbackTo[Request] = null,
    ...
    xhrSetup: (/* xhr */ XMLHttpRequest, /* url */ String) => Callback = null
  ): PartialConfig = {
    ...
    if (fetchSetup != null) __obj.updateDynamic("fetchSetup")(js.Any.fromFunction2((t0: /* context */ js.Any, t1: /* initParams */ js.Any) => fetchSetup(t0, t1).runNow()))
    ...
    if (xhrSetup != null) __obj.updateDynamic("xhrSetup")(js.Any.fromFunction2((t0: /* xhr */ org.scalajs.dom.raw.XMLHttpRequest, t1: /* url */ java.lang.String) => xhrSetup(t0, t1).runNow()))
