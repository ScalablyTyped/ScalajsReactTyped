...
object LevelSwitchingData {
  ...
  inline def apply(
    ...
    level: Double,
    loadError: Double,
    maxBitrate: CallbackTo[Double],
    realBitrate: Double,
    uri: CallbackTo[String],
    url: js.Array[String],
    urlId: CallbackTo[Double],
    width: Double
  ): LevelSwitchingData = {
    val __obj = js.Dynamic.literal(attrs = attrs.asInstanceOf[js.Any], bitrate = bitrate.asInstanceOf[js.Any], codecSet = codecSet.asInstanceOf[js.Any], constructor = js.Any.fromFunction1(constructor), fragmentError = fragmentError.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], level = level.asInstanceOf[js.Any], loadError = loadError.asInstanceOf[js.Any], maxBitrate = maxBitrate.toJsFn, realBitrate = realBitrate.asInstanceOf[js.Any], uri = uri.toJsFn, url = url.asInstanceOf[js.Any], urlId = urlId.toJsFn, width = width.asInstanceOf[js.Any])
  ...
  extension [Self <: LevelSwitchingData](x: Self) {
    ...
    inline def setMaxBitrate(value: CallbackTo[Double]): Self = StObject.set(x, "maxBitrate", value.toJsFn)
    ...
    inline def setUri(value: CallbackTo[String]): Self = StObject.set(x, "uri", value.toJsFn)
    
    inline def setUrl(value: js.Array[String]): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
    
    inline def setUrlId(value: CallbackTo[Double]): Self = StObject.set(x, "urlId", value.toJsFn)
