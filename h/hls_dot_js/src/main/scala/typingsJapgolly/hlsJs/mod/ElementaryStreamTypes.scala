...
object ElementaryStreamTypes extends StObject {
  ...
  /* "audio" */ val AUDIO: typingsJapgolly.hlsJs.mod.ElementaryStreamTypes.AUDIO & String = js.native
  
  @js.native
  sealed trait AUDIOVIDEO
    extends StObject
       with ElementaryStreamTypes
  /* "audiovideo" */ val AUDIOVIDEO: typingsJapgolly.hlsJs.mod.ElementaryStreamTypes.AUDIOVIDEO & String = js.native
  
  @js.native
  sealed trait VIDEO
    extends StObject
       with ElementaryStreamTypes
  /* "video" */ val VIDEO: typingsJapgolly.hlsJs.mod.ElementaryStreamTypes.VIDEO & String = js.native
}
