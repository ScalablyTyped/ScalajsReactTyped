...
import typingsJapgolly.hlsJs.mod.Events.ERROR
import typingsJapgolly.hlsJs.mod.Events.LEVEL_LOADED
import typingsJapgolly.hlsJs.mod.Events.SUBTITLE_FRAG_PROCESSED
import typingsJapgolly.hlsJs.mod.Events.SUBTITLE_TRACKS_UPDATED
import typingsJapgolly.hlsJs.mod.Events.SUBTITLE_TRACK_LOADED
import typingsJapgolly.hlsJs.mod.Events.SUBTITLE_TRACK_SWITCH
