...
import typingsJapgolly.hlsJs.mod.Events.AUDIO_TRACKS_UPDATED
import typingsJapgolly.hlsJs.mod.Events.AUDIO_TRACK_LOADED
import typingsJapgolly.hlsJs.mod.Events.AUDIO_TRACK_SWITCHING
import typingsJapgolly.hlsJs.mod.Events.BUFFER_CREATED
import typingsJapgolly.hlsJs.mod.Events.FRAG_BUFFERED
import typingsJapgolly.hlsJs.mod.Events.INIT_PTS_FOUND
