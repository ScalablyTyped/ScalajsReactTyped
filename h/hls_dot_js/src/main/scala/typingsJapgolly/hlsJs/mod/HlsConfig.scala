...
import typingsJapgolly.hlsJs.anon.Instantiable
import typingsJapgolly.hlsJs.anon.TypeofCMCDController
import typingsJapgolly.hlsJs.anon.TypeofCapLevelController
