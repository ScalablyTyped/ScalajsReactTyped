...
object TimelineController {
  ...
  inline def apply(
    ...
    _parseIMSC1: Any,
    _parseVTTs: Any,
    addCues: (String, Double, Double, CaptionScreen, js.Array[js.Tuple2[Double, Double]]) => Callback,
    ...
    config: Any,
    createCaptionsTrack: String => Callback,
  ...
  extension [Self <: TimelineController](x: Self) {
    ...
    inline def setCreateCaptionsTrack(value: String => Callback): Self = StObject.set(x, "createCaptionsTrack", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
