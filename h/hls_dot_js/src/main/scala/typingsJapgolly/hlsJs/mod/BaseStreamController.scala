...
import typingsJapgolly.hlsJs.anon.Frag
import typingsJapgolly.hlsJs.hlsJsInts.`0`
import typingsJapgolly.hlsJs.mod.Events.KEY_LOADED
import typingsJapgolly.hlsJs.mod.Events.LEVEL_SWITCHING
import typingsJapgolly.hlsJs.mod.Events.MEDIA_ATTACHED
