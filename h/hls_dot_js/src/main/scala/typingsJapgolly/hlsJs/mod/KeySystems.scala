...
object KeySystems extends StObject {
  ...
  sealed trait PLAYREADY
    extends StObject
       with KeySystems
  /* "com.microsoft.playready" */ val PLAYREADY: typingsJapgolly.hlsJs.mod.KeySystems.PLAYREADY & String = js.native
  
  @js.native
  sealed trait WIDEVINE
    extends StObject
       with KeySystems
  /* "com.widevine.alpha" */ val WIDEVINE: typingsJapgolly.hlsJs.mod.KeySystems.WIDEVINE & String = js.native
}
