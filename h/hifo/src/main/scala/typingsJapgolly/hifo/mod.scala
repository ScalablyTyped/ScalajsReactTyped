...
object mod {
  ...
  /**
    ...
    * // ]
    */
  inline def apply[T](compareFn: CompareFn[T]): typingsJapgolly.hifo.mod.Hifo[T] = ^.asInstanceOf[js.Dynamic].apply(compareFn.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.hifo.mod.Hifo[T]]
  inline def apply[T](compareFn: CompareFn[T], size: Double): typingsJapgolly.hifo.mod.Hifo[T] = (^.asInstanceOf[js.Dynamic].apply(compareFn.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.hifo.mod.Hifo[T]]
  ...
  @JSImport("hifo", "Hifo")
  @js.native
  val Hifo: typingsJapgolly.hifo.mod.Hifo[Any] = js.native
