...
import typingsJapgolly.hapiWreck.anon.PromiseIncomingMessagereq
import typingsJapgolly.hapiWreck.anon.Req
...
import typingsJapgolly.hapiWreck.hapiWreckStrings.request
...
object mod extends Shortcut {
  ...
  trait Client extends StObject {
    ...
    def delete[T](
      uri: String,
      options: typingsJapgolly.hapiWreck.mod.Client.request.Options & typingsJapgolly.hapiWreck.mod.Client.read.Options
  ...
  object Client {
    ...
    object Agents {
      ...
      extension [Self <: Agents](x: Self) {
        ...
        inline def setHttpsAllowUnauthorized(value: typingsJapgolly.node.httpsMod.Agent): Self = StObject.set(x, "httpsAllowUnauthorized", value.asInstanceOf[js.Any])
      }
    }
    ...
    trait Events extends EventEmitter {
      ...
      @JSName("addListener")
      def addListener_request(event: request, listener: typingsJapgolly.hapiWreck.mod.Client.Events.request): this.type = js.native
      @JSName("addListener")
      ...
      @JSName("on")
      def on_request(event: request, listener: typingsJapgolly.hapiWreck.mod.Client.Events.request): this.type = js.native
      @JSName("on")
      ...
      @JSName("once")
      def once_request(event: request, listener: typingsJapgolly.hapiWreck.mod.Client.Events.request): this.type = js.native
      @JSName("once")
    ...
    trait Options
      extends StObject
         with typingsJapgolly.hapiWreck.mod.Client.request.Options
    ...
    object read {
      ...
      object Options {
        ...
        inline def apply(): typingsJapgolly.hapiWreck.mod.Client.read.Options = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsJapgolly.hapiWreck.mod.Client.read.Options]
        }
        
        extension [Self <: typingsJapgolly.hapiWreck.mod.Client.read.Options](x: Self) {
    ...
    object request {
      ...
      trait Options extends StObject {
        ...
        /**
          ...
          */
        val agent: js.UndefOr[Agent | typingsJapgolly.node.httpsMod.Agent | `false`] = js.undefined
        ...
        /**
          ...
          */
        val payload: js.UndefOr[typingsJapgolly.hapiWreck.mod.Client.request.Payload] = js.undefined
      ...
      object Options {
        ...
        inline def apply(): typingsJapgolly.hapiWreck.mod.Client.request.Options = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsJapgolly.hapiWreck.mod.Client.request.Options]
        }
        
        extension [Self <: typingsJapgolly.hapiWreck.mod.Client.request.Options](x: Self) {
          
          inline def setAgent(value: Agent | typingsJapgolly.node.httpsMod.Agent | `false`): Self = StObject.set(x, "agent", value.asInstanceOf[js.Any])
          ...
          inline def setBeforeRedirect(
            value: (/* redirectMethod */ String, /* statusCode */ Double, /* location */ String, /* resHeaders */ Record[String, String], typingsJapgolly.hapiWreck.mod.Client.request.Options, /* next */ js.Function0[Unit]) => Callback
          ): Self = StObject.set(x, "beforeRedirect", js.Any.fromFunction6((t0: /* redirectMethod */ String, t1: /* statusCode */ Double, t2: /* location */ String, t3: /* resHeaders */ Record[String, String], t4: typingsJapgolly.hapiWreck.mod.Client.request.Options, t5: /* next */ js.Function0[Unit]) => (value(t0, t1, t2, t3, t4, t5)).runNow()))
          ...
          inline def setPayload(value: typingsJapgolly.hapiWreck.mod.Client.request.Payload): Self = StObject.set(x, "payload", value.asInstanceOf[js.Any])
          ...
          inline def setRedirected(value: (/* statusCode */ Double, /* location */ String, /* req */ ClientRequest) => Callback): Self = StObject.set(x, "redirected", js.Any.fromFunction3((t0: /* statusCode */ Double, t1: /* location */ String, t2: /* req */ ClientRequest) => (value(t0, t1, t2)).runNow()))
