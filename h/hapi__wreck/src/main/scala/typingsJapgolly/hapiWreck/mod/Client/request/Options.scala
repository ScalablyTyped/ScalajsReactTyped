package typingsJapgolly.hapiWreck.mod.Client.request
...
object Options {
  ...
  def apply(
    ...
    baseUrl: String = null,
    beforeRedirect: (/* redirectMethod */ String, /* statusCode */ Double, /* location */ String, /* resHeaders */ Record[String, String], /* redirectOptions */ Options, /* next */ js.Function0[Unit]) => Callback = null,
    ciphers: String = null,
