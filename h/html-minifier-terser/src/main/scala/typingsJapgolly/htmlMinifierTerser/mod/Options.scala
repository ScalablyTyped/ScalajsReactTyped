package typingsJapgolly.htmlMinifierTerser.mod
...
object Options {
  ...
  def apply(
    ...
    minifyCSS: Boolean | js.Object | (js.Function2[/* text */ String, /* type */ js.UndefOr[String], String]) = null,
    minifyJS: Boolean | js.Object | (js.Function2[/* text */ String, /* inline */ js.UndefOr[Boolean], String]) = null,
    minifyURLs: Boolean | String | js.Object | (js.Function1[/* text */ String, String]) = null,
    ...
    if (!js.isUndefined(continueOnParseError)) __obj.updateDynamic("continueOnParseError")(continueOnParseError.asInstanceOf[js.Any])
