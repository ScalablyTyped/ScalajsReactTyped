...
import typingsJapgolly.hardSourceWebpackPlugin.AnonDirectories
import typingsJapgolly.hardSourceWebpackPlugin.AnonLevel
import typingsJapgolly.hardSourceWebpackPlugin.AnonMaxAge
