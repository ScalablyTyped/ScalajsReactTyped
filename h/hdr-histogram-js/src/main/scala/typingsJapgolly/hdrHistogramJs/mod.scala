...
import typingsJapgolly.hdrHistogramJs.distByteBufferMod.default
import typingsJapgolly.hdrHistogramJs.distHistogramBuilderMod.BuildRequest
import typingsJapgolly.hdrHistogramJs.distHistogramLogWriterMod.Writable
...
object mod {
  ...
  object ByteBuffer {
    ...
    /* static member */
    inline def allocate(): typingsJapgolly.hdrHistogramJs.distByteBufferMod.ByteBuffer = ^.asInstanceOf[js.Dynamic].applyDynamic("allocate")().asInstanceOf[typingsJapgolly.hdrHistogramJs.distByteBufferMod.ByteBuffer]
    inline def allocate(size: Double): typingsJapgolly.hdrHistogramJs.distByteBufferMod.ByteBuffer = ^.asInstanceOf[js.Dynamic].applyDynamic("allocate")(size.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.hdrHistogramJs.distByteBufferMod.ByteBuffer]
  }
  
  @JSImport("hdr-histogram-js", "Float64Histogram")
  @js.native
  open class Float64Histogram protected ()
    extends typingsJapgolly.hdrHistogramJs.distFloat64HistogramMod.default {
    def this(
  ...
  open class HistogramLogReader protected ()
    extends typingsJapgolly.hdrHistogramJs.distHistogramLogReaderMod.default {
  ...
  open class HistogramLogWriter protected ()
    extends typingsJapgolly.hdrHistogramJs.distHistogramLogWriterMod.default {
  ...
  open class Int16Histogram protected ()
    extends typingsJapgolly.hdrHistogramJs.distInt16HistogramMod.default {
    def this(
      lowestDiscernibleValue: Double,
      highestTrackableValue: Double,
      numberOfSignificantValueDigits: Double
  ...
  open class Int32Histogram protected ()
    extends typingsJapgolly.hdrHistogramJs.distInt32HistogramMod.default {
    def this(
      lowestDiscernibleValue: Double,
      highestTrackableValue: Double,
      numberOfSignificantValueDigits: Double
  ...
  open class Int8Histogram protected ()
    extends typingsJapgolly.hdrHistogramJs.distInt8HistogramMod.default {
    def this(
      lowestDiscernibleValue: Double,
      highestTrackableValue: Double,
      numberOfSignificantValueDigits: Double
  ...
  open class JsHistogram protected ()
    extends StObject
       with typingsJapgolly.hdrHistogramJs.distJsHistogramMod.JsHistogram {
    def this(
      lowestDiscernibleValue: Double,
      highestTrackableValue: Double,
      numberOfSignificantValueDigits: Double
  ...
  open class PackedHistogram protected ()
    extends typingsJapgolly.hdrHistogramJs.distPackedHistogramMod.default {
    def this(
      lowestDiscernibleValue: Double,
      highestTrackableValue: Double,
      numberOfSignificantValueDigits: Double
  ...
  /**
    ...
    */
  open class Recorder ()
    extends typingsJapgolly.hdrHistogramJs.distRecorderMod.default {
  ...
  open class WasmHistogram protected ()
    extends typingsJapgolly.hdrHistogramJs.distWasmMod.WasmHistogram {
  ...
  object WasmHistogram {
    ...
    inline def build(): typingsJapgolly.hdrHistogramJs.distWasmMod.WasmHistogram = ^.asInstanceOf[js.Dynamic].applyDynamic("build")().asInstanceOf[typingsJapgolly.hdrHistogramJs.distWasmMod.WasmHistogram]
    inline def build(request: BuildRequest): typingsJapgolly.hdrHistogramJs.distWasmMod.WasmHistogram = ^.asInstanceOf[js.Dynamic].applyDynamic("build")(request.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.hdrHistogramJs.distWasmMod.WasmHistogram]
