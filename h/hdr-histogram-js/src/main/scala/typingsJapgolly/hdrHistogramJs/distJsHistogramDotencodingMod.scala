...
object distJsHistogramDotencodingMod {
  ...
  object hdrHistogramJsDistJsHistogramAugmentingMod {
    ...
    object JsHistogram {
      ...
      inline def apply(encodeIntoCompressedBase64: /* compressionLevel */ js.UndefOr[Double] => String): typingsJapgolly.hdrHistogramJs.distJsHistogramDotencodingMod.hdrHistogramJsDistJsHistogramAugmentingMod.JsHistogram = {
        val __obj = js.Dynamic.literal(encodeIntoCompressedBase64 = js.Any.fromFunction1(encodeIntoCompressedBase64))
        __obj.asInstanceOf[typingsJapgolly.hdrHistogramJs.distJsHistogramDotencodingMod.hdrHistogramJsDistJsHistogramAugmentingMod.JsHistogram]
      }
      
      extension [Self <: typingsJapgolly.hdrHistogramJs.distJsHistogramDotencodingMod.hdrHistogramJsDistJsHistogramAugmentingMod.JsHistogram](x: Self) {
