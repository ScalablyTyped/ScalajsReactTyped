...
import typingsJapgolly.hdrHistogramJs.hdrHistogramJsBooleans.`false`
...
object distHistogramMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.hdrHistogramJs.hdrHistogramJsInts.`8`
    - typingsJapgolly.hdrHistogramJs.hdrHistogramJsInts.`16`
    - typingsJapgolly.hdrHistogramJs.hdrHistogramJsInts.`32`
    - typingsJapgolly.hdrHistogramJs.hdrHistogramJsInts.`64`
    - typingsJapgolly.hdrHistogramJs.hdrHistogramJsStrings.packed
  */
  trait BitBucketSize extends StObject
  object BitBucketSize {
    
    inline def `16`: typingsJapgolly.hdrHistogramJs.hdrHistogramJsInts.`16` = 16.asInstanceOf[typingsJapgolly.hdrHistogramJs.hdrHistogramJsInts.`16`]
    
    inline def `32`: typingsJapgolly.hdrHistogramJs.hdrHistogramJsInts.`32` = 32.asInstanceOf[typingsJapgolly.hdrHistogramJs.hdrHistogramJsInts.`32`]
    
    inline def `64`: typingsJapgolly.hdrHistogramJs.hdrHistogramJsInts.`64` = 64.asInstanceOf[typingsJapgolly.hdrHistogramJs.hdrHistogramJsInts.`64`]
    
    inline def `8`: typingsJapgolly.hdrHistogramJs.hdrHistogramJsInts.`8` = 8.asInstanceOf[typingsJapgolly.hdrHistogramJs.hdrHistogramJsInts.`8`]
    
    inline def packed: typingsJapgolly.hdrHistogramJs.hdrHistogramJsStrings.packed = "packed".asInstanceOf[typingsJapgolly.hdrHistogramJs.hdrHistogramJsStrings.packed]
  }
