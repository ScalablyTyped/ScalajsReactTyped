...
import typingsJapgolly.hapiLab.anon.OmitTestOptionsplan
...
object mod {
  ...
  object script {
    ...
    object Flags {
      ...
      inline def apply(context: Record[String, Any], mustCall: (Any, Double) => Any, note: String => Callback): Flags = {
        val __obj = js.Dynamic.literal(context = context.asInstanceOf[js.Any], mustCall = js.Any.fromFunction2(mustCall), note = js.Any.fromFunction1((t0: String) => note(t0).runNow()))
      ...
      extension [Self <: Flags](x: Self) {
        ...
        inline def setNote(value: String => Callback): Self = StObject.set(x, "note", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
        ...
        inline def setOnUncaughtException(value: /* err */ js.Error => Callback): Self = StObject.set(x, "onUncaughtException", js.Any.fromFunction1((t0: /* err */ js.Error) => value(t0).runNow()))
        
        inline def setOnUncaughtExceptionUndefined: Self = StObject.set(x, "onUncaughtException", js.undefined)
        
        inline def setOnUnhandledRejection(value: /* err */ js.Error => Callback): Self = StObject.set(x, "onUnhandledRejection", js.Any.fromFunction1((t0: /* err */ js.Error) => value(t0).runNow()))
  ...
  object types {
    ...
    object Expect {
      ...
      inline def apply(error: Any => Callback, `type`: Any => Callback): Expect = {
        val __obj = js.Dynamic.literal(error = js.Any.fromFunction1((t0: Any) => error(t0).runNow()))
        __obj.updateDynamic("type")(js.Any.fromFunction1((t0: Any) => `type`(t0).runNow()))
      ...
      extension [Self <: Expect](x: Self) {
        ...
        inline def setType(value: Any => Callback): Self = StObject.set(x, "type", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      }
    }
