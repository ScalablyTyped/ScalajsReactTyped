...
object eventsSiuDoteventMod {
  ...
  trait SIU
    ...
    var AIL: js.UndefOr[typingsJapgolly.hl7.segmentsAilDotsegmentMod.AIL] = js.undefined
    
    var AIP: js.UndefOr[Any] = js.undefined
    
    var AIS: js.UndefOr[typingsJapgolly.hl7.segmentsAisDotsegmentMod.AIS] = js.undefined
