...
import typingsJapgolly.hl7.eventsAdtDoteventMod.ADT
import typingsJapgolly.hl7.eventsOmgDoteventMod.OMG
import typingsJapgolly.hl7.eventsOrmDoteventMod.ORM
import typingsJapgolly.hl7.eventsOruDoteventMod.ORU
import typingsJapgolly.hl7.eventsSiuDoteventMod.SIU
import typingsJapgolly.hl7.segmentsAilDotsegmentMod.AIL
import typingsJapgolly.hl7.segmentsAisDotsegmentMod.AIS
import typingsJapgolly.hl7.segmentsMshDotsegmentMod.MSH
import typingsJapgolly.hl7.segmentsObrDotsegmentMod.OBR
import typingsJapgolly.hl7.segmentsObxDotsegmentMod.OBX
import typingsJapgolly.hl7.segmentsOrcDotsegmentMod.ORC
...
object mod {
  ...
  object hl7 {
    ...
    trait Segment extends StObject {
      ...
      var AIL: typingsJapgolly.hl7.segmentsAilDotsegmentMod.AIL
      
      var AIS: typingsJapgolly.hl7.segmentsAisDotsegmentMod.AIS
      
      var MSH: typingsJapgolly.hl7.segmentsMshDotsegmentMod.MSH
      
      var OBR: typingsJapgolly.hl7.segmentsObrDotsegmentMod.OBR
      
      var OBX: typingsJapgolly.hl7.segmentsObxDotsegmentMod.OBX
      
      var ORC: typingsJapgolly.hl7.segmentsOrcDotsegmentMod.ORC
    ...
    trait TriggerEvent extends StObject {
      ...
      var ADT: typingsJapgolly.hl7.eventsAdtDoteventMod.ADT
      
      var OMG: typingsJapgolly.hl7.eventsOmgDoteventMod.OMG
      
      var ORM: typingsJapgolly.hl7.eventsOrmDoteventMod.ORM
      
      var ORU: typingsJapgolly.hl7.eventsOruDoteventMod.ORU
      
      var SIU: typingsJapgolly.hl7.eventsSiuDoteventMod.SIU
    }
    object TriggerEvent {
