package typingsJapgolly.humanFormat

import typingsJapgolly.humanFormat.mod.FormatOptions
import typingsJapgolly.humanFormat.mod.ParseResult
import typingsJapgolly.humanFormat.mod.ScaleMap
...
object global {
  ...
  object humanFormat {
    ...
    open class Scale protected ()
      extends typingsJapgolly.humanFormat.mod.Scale {
    ...
    object Scale {
      ...
      /* static member */
      inline def create(options: js.Array[String], base: Double, initExp: Double): typingsJapgolly.humanFormat.mod.Scale = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(options.asInstanceOf[js.Any], base.asInstanceOf[js.Any], initExp.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.humanFormat.mod.Scale]
    }
