...
object mod {
  ...
  object Action extends StObject {
    ...
    sealed trait Pop
      extends StObject
         with Action
    /* "POP" */ val Pop: typingsJapgolly.history.mod.Action.Pop & String = js.native
    ...
    sealed trait Push
      extends StObject
         with Action
    /* "PUSH" */ val Push: typingsJapgolly.history.mod.Action.Push & String = js.native
    ...
    sealed trait Replace
      extends StObject
         with Action
    /* "REPLACE" */ val Replace: typingsJapgolly.history.mod.Action.Replace & String = js.native
  }
  ...
  inline def createPath(hasPathnameSearchHash: typingsJapgolly.history.anon.PartialPath): String = ^.asInstanceOf[js.Dynamic].applyDynamic("createPath")(hasPathnameSearchHash.asInstanceOf[js.Any]).asInstanceOf[String]
  
  inline def parsePath(path: String): typingsJapgolly.history.anon.PartialPath = ^.asInstanceOf[js.Dynamic].applyDynamic("parsePath")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.history.anon.PartialPath]
  ...
  type InitialEntry = String | typingsJapgolly.history.anon.PartialLocation
  ...
  type To = String | typingsJapgolly.history.anon.PartialPath
