...
import typingsJapgolly.history.historyNumbers.`false`
...
object History extends js.Object {
  type Hash = String
  type Href = String
  type LocationDescriptor[S] = typingsJapgolly.history.historyMod.History.Path | LocationDescriptorObject[S]
