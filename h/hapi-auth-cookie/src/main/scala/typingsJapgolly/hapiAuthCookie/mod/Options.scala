...
import typingsJapgolly.hapiAuthCookie.ServerStateCookieOptionsn
...
object Options {
  ...
  def apply(
    ...
    if (validateFunc != null) __obj.updateDynamic("validateFunc")(js.Any.fromFunction2((t0: /* request */ js.UndefOr[typingsJapgolly.hapi.mod.Request], t1: /* session */ js.UndefOr[js.Object]) => validateFunc(t0, t1).runNow()))
