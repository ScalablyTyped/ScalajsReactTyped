...
import typingsJapgolly.hapiAuthCookie.anon.Clear
import typingsJapgolly.hapiAuthCookie.anon.RedirectTo
import typingsJapgolly.hapiAuthCookie.anon.ServerStateCookieOptionsn
...
object mod extends Shortcut {
  ...
  object hapiAugmentingMod {
    ...
    object Request {
      ...
      inline def apply(cookieAuth: Clear): typingsJapgolly.hapiAuthCookie.mod.hapiAugmentingMod.Request = {
        val __obj = js.Dynamic.literal(cookieAuth = cookieAuth.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.hapiAuthCookie.mod.hapiAugmentingMod.Request]
      }
      
      extension [Self <: typingsJapgolly.hapiAuthCookie.mod.hapiAugmentingMod.Request](x: Self) {
