...
object runtimeMod extends js.Object {
  ...
  class Exception protected ()
    extends typingsJapgolly.handlebars.Handlebars.Exception {
  ...
  class SafeString protected ()
    extends typingsJapgolly.handlebars.Handlebars.SafeString {
    def this(str: String) = this()
  }
  
  @js.native
  class Visitor ()
    extends typingsJapgolly.handlebars.Handlebars.Visitor
  ...
  object AST extends js.Object {
    val helpers: typingsJapgolly.handlebars.hbs.AST.helpers = js.native
  }
