...
trait MustacheStatement
  ...
  @JSName("type")
  var type_MustacheStatement: typingsJapgolly.handlebars.handlebarsStrings.MustacheStatement
}
object MustacheStatement {
  ...
  extension [Self <: MustacheStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.handlebars.handlebarsStrings.MustacheStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
