...
trait BlockStatement
  ...
  @JSName("type")
  var type_BlockStatement: typingsJapgolly.handlebars.handlebarsStrings.BlockStatement
}
object BlockStatement {
  ...
  extension [Self <: BlockStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.handlebars.handlebarsStrings.BlockStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
