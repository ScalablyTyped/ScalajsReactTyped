...
trait BooleanLiteral
  ...
  @JSName("type")
  var type_BooleanLiteral: typingsJapgolly.handlebars.handlebarsStrings.BooleanLiteral
...
object BooleanLiteral {
  ...
  extension [Self <: BooleanLiteral](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.handlebars.handlebarsStrings.BooleanLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
