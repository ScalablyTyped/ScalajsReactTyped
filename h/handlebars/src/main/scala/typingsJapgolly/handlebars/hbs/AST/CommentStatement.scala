...
trait CommentStatement
  ...
  @JSName("type")
  var type_CommentStatement: typingsJapgolly.handlebars.handlebarsStrings.CommentStatement
...
object CommentStatement {
  ...
  extension [Self <: CommentStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.handlebars.handlebarsStrings.CommentStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
