...
trait PartialStatement
  ...
  @JSName("type")
  var type_PartialStatement: typingsJapgolly.handlebars.handlebarsStrings.PartialStatement
}
object PartialStatement {
  ...
  extension [Self <: PartialStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.handlebars.handlebarsStrings.PartialStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
