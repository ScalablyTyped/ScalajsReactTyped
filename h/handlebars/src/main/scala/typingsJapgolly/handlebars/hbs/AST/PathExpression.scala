...
trait PathExpression
  ...
  @JSName("type")
  var type_PathExpression: typingsJapgolly.handlebars.handlebarsStrings.PathExpression
}
object PathExpression {
  ...
  extension [Self <: PathExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.handlebars.handlebarsStrings.PathExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
