...
trait PartialBlockStatement
  ...
  @JSName("type")
  var type_PartialBlockStatement: typingsJapgolly.handlebars.handlebarsStrings.PartialBlockStatement
}
object PartialBlockStatement {
  ...
  extension [Self <: PartialBlockStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.handlebars.handlebarsStrings.PartialBlockStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
