...
object global {
  ...
  object Handlebars {
    ...
    open class Exception protected ()
      extends StObject
         with typingsJapgolly.handlebars.Handlebars.Exception {
    ...
    open class SafeString protected ()
      extends StObject
         with typingsJapgolly.handlebars.Handlebars.SafeString {
    ...
    open class Visitor ()
      extends StObject
         with typingsJapgolly.handlebars.Handlebars.Visitor
