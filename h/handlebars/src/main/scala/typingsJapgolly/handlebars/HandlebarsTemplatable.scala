...
trait HandlebarsTemplatable extends StObject {
  ...
  def template(context: Any, options: typingsJapgolly.handlebars.Handlebars.RuntimeOptions): String
  @JSName("template")
...
object HandlebarsTemplatable {
  ...
  inline def apply(
    template: (Any, /* options */ js.UndefOr[typingsJapgolly.handlebars.Handlebars.RuntimeOptions]) => String
