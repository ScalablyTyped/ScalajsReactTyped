...
import typingsJapgolly.hoxy.hoxyStrings._empty
...
object anon {
  ...
  trait Typeofcheerio extends StObject {
    ...
    var Cheerio: Instantiable3[
        ...
        /* root */ typingsJapgolly.cheerio.libCheerioMod.Cheerio[Document], 
        /* options */ InternalOptions, 
        typingsJapgolly.cheerio.libCheerioMod.Cheerio[js.Object]
      ] = js.native
    
    var Document: Instantiable1[/* children */ js.Array[ChildNode], typingsJapgolly.cheerio.mod.Document] = js.native
    
    var Element: Instantiable2[
        /* name */ String, 
        /* attribs */ StringDictionary[String], 
        typingsJapgolly.cheerio.mod.Element
      ] = js.native
    
    var Node: Instantiable0[typingsJapgolly.cheerio.mod.Node] = js.native
    ...
    def html(dom: Unit, options: typingsJapgolly.cheerio.libOptionsMod.CheerioOptions): String = js.native
    def html(dom: typingsJapgolly.cheerio.libTypesMod.BasicAcceptedElems[AnyNode]): String = js.native
    def html(
      dom: typingsJapgolly.cheerio.libTypesMod.BasicAcceptedElems[AnyNode],
      options: typingsJapgolly.cheerio.libOptionsMod.CheerioOptions
    ): String = js.native
    def html(options: typingsJapgolly.cheerio.libOptionsMod.CheerioOptions): String = js.native
    ...
    def root(): typingsJapgolly.cheerio.libCheerioMod.Cheerio[Document] = js.native
    
    def text(): String = js.native
    def text(elements: ArrayLike[AnyNode]): String = js.native
    
    def xml(): String = js.native
    def xml(dom: typingsJapgolly.cheerio.libTypesMod.BasicAcceptedElems[AnyNode]): String = js.native
  }
