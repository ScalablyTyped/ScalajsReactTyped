package typingsJapgolly.highchartsNg

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.highcharts.mod.Options
import typingsJapgolly.highchartsNg.anon.CurrentMax
import typingsJapgolly.highchartsNg.anon.Height
import typingsJapgolly.highchartsNg.anon.Text
...
object mod {
  ...
  object global {
    ...
    object HighChartsNGChart {
      ...
      inline def apply(getHighcharts: CallbackTo[Any], options: Options): HighChartsNGChart = {
        val __obj = js.Dynamic.literal(getHighcharts = getHighcharts.toJsFn, options = options.asInstanceOf[js.Any])
        __obj.asInstanceOf[HighChartsNGChart]
      }
      
      extension [Self <: HighChartsNGChart](x: Self) {
        
        inline def setGetHighcharts(value: CallbackTo[Any]): Self = StObject.set(x, "getHighcharts", value.toJsFn)
      }
    }
    ...
    object HighChartsNGConfig {
      ...
      extension [Self <: HighChartsNGConfig](x: Self) {
        ...
        inline def setFunc(
          value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ChartObject */ /* chart */ Any => Callback
        ): Self = StObject.set(x, "func", js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ChartObject */ /* chart */ Any) => value(t0).runNow()))
