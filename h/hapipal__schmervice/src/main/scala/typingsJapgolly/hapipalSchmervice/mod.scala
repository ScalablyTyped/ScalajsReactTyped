package typingsJapgolly.hapipalSchmervice

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.hapiHapi.mod.Plugin
import typingsJapgolly.hapiHapi.mod.ServerMethodOptions
import typingsJapgolly.hapiHapi.mod.ServerOptionsCache
import typingsJapgolly.hapiHapi.mod.Server_
import typingsJapgolly.hapipalSchmervice.hapipalSchmerviceStrings.bind
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - js.Function2[
  / * server * / typingsJapgolly.hapiHapi.mod.Server_, 
  / * options * / js.Object, 
  typingsJapgolly.hapipalSchmervice.mod.ServiceRegistrationObject]
    - typingsJapgolly.hapipalSchmervice.mod.Service
    - js.Array[typingsJapgolly.hapipalSchmervice.mod.Service]
    - typingsJapgolly.hapipalSchmervice.mod.ServiceRegistrationObject
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - scala.Boolean
    - typingsJapgolly.hapipalSchmervice.hapipalSchmerviceStrings.plugin
    - typingsJapgolly.hapipalSchmervice.hapipalSchmerviceStrings.server
  */
