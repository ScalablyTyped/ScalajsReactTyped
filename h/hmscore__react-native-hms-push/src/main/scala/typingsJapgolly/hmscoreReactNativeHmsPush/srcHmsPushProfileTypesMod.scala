...
object srcHmsPushProfileTypesMod {
  ...
  object ProfileTypeEnum extends StObject {
    ...
    /* 2 */ val CUSTOM_PROFILE: typingsJapgolly.hmscoreReactNativeHmsPush.srcHmsPushProfileTypesMod.ProfileTypeEnum.CUSTOM_PROFILE & Double = js.native
    
    @js.native
    sealed trait HUAWEI_PROFILE
      extends StObject
         with ProfileTypeEnum
    /* 1 */ val HUAWEI_PROFILE: typingsJapgolly.hmscoreReactNativeHmsPush.srcHmsPushProfileTypesMod.ProfileTypeEnum.HUAWEI_PROFILE & Double = js.native
    
    @js.native
    sealed trait UNDEFINED_PROFILE
      extends StObject
         with ProfileTypeEnum
    /* -1 */ val UNDEFINED_PROFILE: typingsJapgolly.hmscoreReactNativeHmsPush.srcHmsPushProfileTypesMod.ProfileTypeEnum.UNDEFINED_PROFILE & Double = js.native
  }
