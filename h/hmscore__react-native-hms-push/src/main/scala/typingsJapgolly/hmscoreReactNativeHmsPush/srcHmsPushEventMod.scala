...
import typingsJapgolly.hmscoreReactNativeHmsPush.anon.DataJSON
import typingsJapgolly.hmscoreReactNativeHmsPush.anon.DataJSONString
import typingsJapgolly.hmscoreReactNativeHmsPush.anon.MsgId
import typingsJapgolly.hmscoreReactNativeHmsPush.anon.Result
import typingsJapgolly.hmscoreReactNativeHmsPush.anon.Token
import typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.LOCAL_NOTIFICATION_ACTION_EVENT
import typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.NOTIFICATION_OPENED_EVENT
import typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_MULTI_SENDER_TOKEN_ERROR_EVENT
import typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_MULTI_SENDER_TOKEN_RECEIVED_EVENT
import typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_PUSH_MESSAGE_SENT
import typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_PUSH_MESSAGE_SENT_DELIVERED
import typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_PUSH_MESSAGE_SENT_ERROR
import typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_TOKEN_ERROR_EVENT
import typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_TOKEN_RECEIVED_EVENT
import typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.REMOTE_DATA_MESSAGE_RECEIVED
import typingsJapgolly.hmscoreReactNativeHmsPush.srcRemoteDataMessageMod.RemoteDataMessageObject
import typingsJapgolly.hmscoreReactNativeHmsPush.srcRemoteDataMessageMod.RemoteDataMessageWithExtras
...
object srcHmsPushEventMod {
  ...
  trait HmsPushEvents extends StObject {
    ...
    var LOCAL_NOTIFICATION_ACTION_EVENT: typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.LOCAL_NOTIFICATION_ACTION_EVENT
    
    var NOTIFICATION_OPENED_EVENT: typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.NOTIFICATION_OPENED_EVENT
    
    var ON_MULTI_SENDER_TOKEN_ERROR_EVENT: typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_MULTI_SENDER_TOKEN_ERROR_EVENT
    
    var ON_MULTI_SENDER_TOKEN_RECEIVED_EVENT: typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_MULTI_SENDER_TOKEN_RECEIVED_EVENT
    
    var ON_PUSH_MESSAGE_SENT: typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_PUSH_MESSAGE_SENT
    
    var ON_PUSH_MESSAGE_SENT_DELIVERED: typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_PUSH_MESSAGE_SENT_DELIVERED
    
    var ON_PUSH_MESSAGE_SENT_ERROR: typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_PUSH_MESSAGE_SENT_ERROR
    
    var ON_TOKEN_ERROR_EVENT: typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_TOKEN_ERROR_EVENT
    
    var ON_TOKEN_RECEIVED_EVENT: typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.ON_TOKEN_RECEIVED_EVENT
    
    var REMOTE_DATA_MESSAGE_RECEIVED: typingsJapgolly.hmscoreReactNativeHmsPush.hmscoreReactNativeHmsPushStrings.REMOTE_DATA_MESSAGE_RECEIVED
  }
