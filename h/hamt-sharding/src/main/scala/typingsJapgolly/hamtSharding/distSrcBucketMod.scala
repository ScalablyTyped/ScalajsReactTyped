package typingsJapgolly.hamtSharding

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.hamtSharding.distSrcConsumableHashMod.InfiniteHash
...
object distSrcBucketMod {
  ...
  object SA {
    ...
    inline def apply[B](
      bitField: CallbackTo[js.Array[Double]],
      compactArray: CallbackTo[js.Array[B]],
      find: js.Function1[/* item */ B, Boolean] => js.UndefOr[B],
      get: Double => B,
      length: Double,
      reduce: (js.Function3[Any, /* curr */ B, /* index */ Double, Any], Any) => B,
      set: (Double, B) => Callback,
      unset: Double => Callback
    ): SA[B] = {
      val __obj = js.Dynamic.literal(bitField = bitField.toJsFn, compactArray = compactArray.toJsFn, find = js.Any.fromFunction1(find), get = js.Any.fromFunction1(get), length = length.asInstanceOf[js.Any], reduce = js.Any.fromFunction2(reduce), set = js.Any.fromFunction2((t0: Double, t1: B) => (set(t0, t1)).runNow()), unset = js.Any.fromFunction1((t0: Double) => unset(t0).runNow()))
      __obj.asInstanceOf[SA[B]]
    }
    
    extension [Self <: SA[?], B](x: Self & SA[B]) {
      
      inline def setBitField(value: CallbackTo[js.Array[Double]]): Self = StObject.set(x, "bitField", value.toJsFn)
      
      inline def setCompactArray(value: CallbackTo[js.Array[B]]): Self = StObject.set(x, "compactArray", value.toJsFn)
      ...
      inline def setSet(value: (Double, B) => Callback): Self = StObject.set(x, "set", js.Any.fromFunction2((t0: Double, t1: B) => (value(t0, t1)).runNow()))
      
      inline def setUnset(value: Double => Callback): Self = StObject.set(x, "unset", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    }
  }
}
