...
import typingsJapgolly.hamtSharding.distSrcBucketMod.BucketOptions
...
object mod {
  ...
  open class Bucket[T] protected ()
    extends typingsJapgolly.hamtSharding.distSrcBucketMod.Bucket[T] {
    def this(options: BucketOptions) = this()
    def this(options: BucketOptions, parent: typingsJapgolly.hamtSharding.distSrcBucketMod.Bucket[T]) = this()
    def this(options: BucketOptions, parent: Unit, posAtParent: Double) = this()
    def this(
      options: BucketOptions,
      parent: typingsJapgolly.hamtSharding.distSrcBucketMod.Bucket[T],
      posAtParent: Double
    ) = this()
  }
  
  inline def createHAMT[T](options: UserBucketOptions): typingsJapgolly.hamtSharding.distSrcBucketMod.Bucket[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("createHAMT")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.hamtSharding.distSrcBucketMod.Bucket[T]]
