...
object patternsMnCyrlMod extends Shortcut {
  
  @JSImport("hyphen/patterns/mn-cyrl", JSImport.Namespace)
  @js.native
  val ^ : PatternsDefinition = js.native
  
  type _To = PatternsDefinition
  
  /* This means you don't have to write `^`, but can instead just say `patternsMnCyrlMod.foo` */
