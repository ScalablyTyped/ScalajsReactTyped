...
object patternsIaMod extends Shortcut {
  
  @JSImport("hyphen/patterns/ia", JSImport.Namespace)
  @js.native
  val ^ : PatternsDefinition = js.native
  
  type _To = PatternsDefinition
  
  /* This means you don't have to write `^`, but can instead just say `patternsIaMod.foo` */
