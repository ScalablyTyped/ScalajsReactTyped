...
object patternsSkMod extends Shortcut {
  
  @JSImport("hyphen/patterns/sk", JSImport.Namespace)
  @js.native
  val ^ : PatternsDefinition = js.native
  
  type _To = PatternsDefinition
  
  /* This means you don't have to write `^`, but can instead just say `patternsSkMod.foo` */
