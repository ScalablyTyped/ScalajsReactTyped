...
import typingsJapgolly.hyphen.anon.ReadonlyFactoryOptions
import typingsJapgolly.hyphen.anon.ReadonlyHyphenationOption
import typingsJapgolly.hyphen.anon.ReadonlyPatternsDefinitio
