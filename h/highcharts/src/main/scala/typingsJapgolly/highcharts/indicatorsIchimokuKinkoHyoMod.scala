...
object indicatorsIchimokuKinkoHyoMod {
  
  @JSImport("highcharts/indicators/ichimoku-kinko-hyo", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/ichimoku-kinko-hyo", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/ichimoku-kinko-hyo", "Highcharts.SeriesPalettes")
    @js.native
