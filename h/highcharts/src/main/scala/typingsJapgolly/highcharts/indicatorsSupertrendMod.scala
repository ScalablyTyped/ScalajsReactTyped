...
object indicatorsSupertrendMod {
  
  @JSImport("highcharts/indicators/supertrend", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/supertrend", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/supertrend", "Highcharts.SeriesPalettes")
    @js.native
