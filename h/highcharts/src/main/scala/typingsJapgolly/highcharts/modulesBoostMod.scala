...
object modulesBoostMod {
  
  @JSImport("highcharts/modules/boost", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/boost", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/boost", "Highcharts.SeriesPalettes")
    @js.native
