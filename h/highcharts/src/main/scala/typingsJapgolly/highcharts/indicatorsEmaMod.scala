...
object indicatorsEmaMod {
  
  @JSImport("highcharts/indicators/ema", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/ema", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/ema", "Highcharts.SeriesPalettes")
    @js.native
