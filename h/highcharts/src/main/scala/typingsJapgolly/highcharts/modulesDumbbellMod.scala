...
object modulesDumbbellMod {
  
  @JSImport("highcharts/modules/dumbbell", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/dumbbell", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/dumbbell", "Highcharts.SeriesPalettes")
    @js.native
  ...
  object highchartsAugmentingMod {
    ...
    object Series {
      ...
      inline def apply(markerAttribs: CallbackTo[SVGAttributes]): Series = {
        val __obj = js.Dynamic.literal(markerAttribs = markerAttribs.toJsFn)
        __obj.asInstanceOf[Series]
      }
      
      extension [Self <: Series](x: Self) {
        
        inline def setMarkerAttribs(value: CallbackTo[SVGAttributes]): Self = StObject.set(x, "markerAttribs", value.toJsFn)
      }
    }
  }
}
