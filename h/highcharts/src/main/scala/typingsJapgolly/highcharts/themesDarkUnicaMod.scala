...
object themesDarkUnicaMod {
  
  @JSImport("highcharts/themes/dark-unica", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/themes/dark-unica", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/themes/dark-unica", "Highcharts.SeriesPalettes")
    @js.native
