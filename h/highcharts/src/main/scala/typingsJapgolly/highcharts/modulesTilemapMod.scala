...
object modulesTilemapMod {
  
  @JSImport("highcharts/modules/tilemap", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/tilemap", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/tilemap", "Highcharts.SeriesPalettes")
    @js.native
