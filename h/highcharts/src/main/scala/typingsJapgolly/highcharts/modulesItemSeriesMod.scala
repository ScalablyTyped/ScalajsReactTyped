...
object modulesItemSeriesMod {
  
  @JSImport("highcharts/modules/item-series", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/item-series", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/item-series", "Highcharts.SeriesPalettes")
    @js.native
