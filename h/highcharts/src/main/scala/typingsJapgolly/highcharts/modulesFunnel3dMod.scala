...
object modulesFunnel3dMod {
  
  @JSImport("highcharts/modules/funnel3d", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/funnel3d", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/funnel3d", "Highcharts.SeriesPalettes")
    @js.native
