...
import typingsJapgolly.highcharts.mod.AnnotationControlPointPositionerFunction
import typingsJapgolly.highcharts.mod.AnnotationControllable
import typingsJapgolly.highcharts.mod.AnnotationDraggableValue
import typingsJapgolly.highcharts.mod.AnnotationsAnimationOptions
import typingsJapgolly.highcharts.mod.AnnotationsControlPointStyleOptions
import typingsJapgolly.highcharts.mod.AnnotationsCrookedLineOptions
import typingsJapgolly.highcharts.mod.AnnotationsElliottWaveOptions
import typingsJapgolly.highcharts.mod.AnnotationsEventsOptions
import typingsJapgolly.highcharts.mod.AnnotationsFibonacciOptions
import typingsJapgolly.highcharts.mod.AnnotationsFibonacciTimeZonesOptions
import typingsJapgolly.highcharts.mod.AnnotationsInfinityLineOptions
import typingsJapgolly.highcharts.mod.AnnotationsLabelOptions
import typingsJapgolly.highcharts.mod.AnnotationsLabelsOptions
import typingsJapgolly.highcharts.mod.AnnotationsMeasureOptions
import typingsJapgolly.highcharts.mod.AnnotationsOptions
import typingsJapgolly.highcharts.mod.AnnotationsPitchforkOptions
import typingsJapgolly.highcharts.mod.AnnotationsShapeOptions
import typingsJapgolly.highcharts.mod.AnnotationsShapesOptions
import typingsJapgolly.highcharts.mod.AnnotationsTimeCyclesOptions
import typingsJapgolly.highcharts.mod.AnnotationsTunnelOptions
import typingsJapgolly.highcharts.mod.AnnotationsVerticalLineOptions
...
import typingsJapgolly.highcharts.mod.GradientColorObject
import typingsJapgolly.highcharts.mod.HTMLAttributes
import typingsJapgolly.highcharts.mod.LegendOptions
import typingsJapgolly.highcharts.mod.LonLatArray
import typingsJapgolly.highcharts.mod.MapViewInsetOptions
import typingsJapgolly.highcharts.mod.MapViewInsetsOptions
import typingsJapgolly.highcharts.mod.MapViewProjectionOptions
import typingsJapgolly.highcharts.mod.NavigationAnnotationsControlPointStyleOptions
...
import typingsJapgolly.highcharts.mod.PatternObject
...
import typingsJapgolly.highcharts.mod.SVGPathArray
import typingsJapgolly.highcharts.mod.SVGPathCommand
...
object anon {
  ...
  trait TypeofHighcharts extends StObject {
    ...
    def attr(elem: HTMLElement, keyOrAttribs: String): js.UndefOr[String | Null] = js.native
    def attr(elem: HTMLElement, keyOrAttribs: String, value: String): js.UndefOr[String | Null] = js.native
    def attr(elem: HTMLElement, keyOrAttribs: String, value: Double): js.UndefOr[String | Null] = js.native
    def attr(elem: HTMLElement, keyOrAttribs: Unit, value: String): js.UndefOr[String | Null] = js.native
    def attr(elem: HTMLElement, keyOrAttribs: Unit, value: Double): js.UndefOr[String | Null] = js.native
    def attr(elem: HTMLElement, keyOrAttribs: HTMLAttributes): js.UndefOr[String | Null] = js.native
    def attr(elem: HTMLElement, keyOrAttribs: HTMLAttributes, value: String): js.UndefOr[String | Null] = js.native
    def attr(elem: HTMLElement, keyOrAttribs: HTMLAttributes, value: Double): js.UndefOr[String | Null] = js.native
    def attr(elem: HTMLElement, keyOrAttribs: SVGAttributes): js.UndefOr[String | Null] = js.native
    def attr(elem: HTMLElement, keyOrAttribs: SVGAttributes, value: String): js.UndefOr[String | Null] = js.native
    def attr(elem: HTMLElement, keyOrAttribs: SVGAttributes, value: Double): js.UndefOr[String | Null] = js.native
    def attr(elem: org.scalajs.dom.SVGElement): js.UndefOr[String | Null] = js.native
    def attr(elem: org.scalajs.dom.SVGElement, keyOrAttribs: String): js.UndefOr[String | Null] = js.native
    def attr(elem: org.scalajs.dom.SVGElement, keyOrAttribs: String, value: String): js.UndefOr[String | Null] = js.native
    def attr(elem: org.scalajs.dom.SVGElement, keyOrAttribs: String, value: Double): js.UndefOr[String | Null] = js.native
    def attr(elem: org.scalajs.dom.SVGElement, keyOrAttribs: Unit, value: String): js.UndefOr[String | Null] = js.native
    def attr(elem: org.scalajs.dom.SVGElement, keyOrAttribs: Unit, value: Double): js.UndefOr[String | Null] = js.native
    def attr(elem: org.scalajs.dom.SVGElement, keyOrAttribs: HTMLAttributes): js.UndefOr[String | Null] = js.native
    def attr(elem: org.scalajs.dom.SVGElement, keyOrAttribs: HTMLAttributes, value: String): js.UndefOr[String | Null] = js.native
    def attr(elem: org.scalajs.dom.SVGElement, keyOrAttribs: HTMLAttributes, value: Double): js.UndefOr[String | Null] = js.native
    def attr(elem: org.scalajs.dom.SVGElement, keyOrAttribs: SVGAttributes): js.UndefOr[String | Null] = js.native
    def attr(elem: org.scalajs.dom.SVGElement, keyOrAttribs: SVGAttributes, value: String): js.UndefOr[String | Null] = js.native
    def attr(elem: org.scalajs.dom.SVGElement, keyOrAttribs: SVGAttributes, value: Double): js.UndefOr[String | Null] = js.native
    ...
    def createElement(tag: String, attribs: Unit, styles: Unit, parent: HTMLElement): HTMLElement = js.native
    def createElement(tag: String, attribs: Unit, styles: Unit, parent: HTMLElement, nopad: Boolean): HTMLElement = js.native
    def createElement(tag: String, attribs: Unit, styles: Unit, parent: Unit, nopad: Boolean): HTMLElement = js.native
    def createElement(tag: String, attribs: Unit, styles: CSSObject): HTMLElement = js.native
    def createElement(tag: String, attribs: Unit, styles: CSSObject, parent: HTMLElement): HTMLElement = js.native
    def createElement(tag: String, attribs: Unit, styles: CSSObject, parent: HTMLElement, nopad: Boolean): HTMLElement = js.native
    def createElement(tag: String, attribs: Unit, styles: CSSObject, parent: Unit, nopad: Boolean): HTMLElement = js.native
    def createElement(tag: String, attribs: HTMLAttributes): HTMLElement = js.native
    def createElement(tag: String, attribs: HTMLAttributes, styles: Unit, parent: HTMLElement): HTMLElement = js.native
    def createElement(tag: String, attribs: HTMLAttributes, styles: Unit, parent: HTMLElement, nopad: Boolean): HTMLElement = js.native
    def createElement(tag: String, attribs: HTMLAttributes, styles: Unit, parent: Unit, nopad: Boolean): HTMLElement = js.native
    ...
    def createElement(tag: String, attribs: HTMLAttributes, styles: CSSObject, parent: Unit, nopad: Boolean): HTMLElement = js.native
    
    def css(el: HTMLElement, styles: CSSObject): Unit = js.native
    def css(el: org.scalajs.dom.SVGElement, styles: CSSObject): Unit = js.native
    ...
    def getStyle(el: HTMLElement, prop: String): js.UndefOr[Double | String] = js.native
    def getStyle(el: HTMLElement, prop: String, toInt: Boolean): js.UndefOr[Double | String] = js.native
