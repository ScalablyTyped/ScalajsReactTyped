...
object indicatorsStochasticMod {
  
  @JSImport("highcharts/indicators/stochastic", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/stochastic", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/stochastic", "Highcharts.SeriesPalettes")
    @js.native
