...
import typingsJapgolly.highcharts.anon.TypeofHighchartsAST
...
object highchartsMoreMod {
  ...
  @JSImport("highcharts/highcharts-more", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def default(highcharts: TypeofHighchartsAST): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(highcharts.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/highcharts-more", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/highcharts-more", "Highcharts.SeriesPalettes")
    @js.native
    ...
    /**
      ...
      */
    inline def axisBeforePadding(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("axisBeforePadding")().asInstanceOf[Unit]
    ...
    /**
      ...
      */
    inline def chartDrawChartBox(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("chartDrawChartBox")().asInstanceOf[Unit]
    ...
    /**
      ...
      * radial axis.
      */
    inline def getOffset(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getOffset")().asInstanceOf[Unit]
    ...
    /**
      ...
      */
    inline def getPlotLinePath(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getPlotLinePath")().asInstanceOf[Unit]
    ...
    /**
      ...
      */
    inline def getTitlePosition(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getTitlePosition")().asInstanceOf[Unit]
    ...
    /**
      ...
      */
    inline def onAxisAfterInit(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onAxisAfterInit")().asInstanceOf[Unit]
    
    /**
      * Wrap auto label align to avoid setting axis-wide rotation on radial axes.
      * (#4920)
      */
    inline def onAxisAutoLabelAlign(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onAxisAutoLabelAlign")().asInstanceOf[Unit]
    
    /**
      * Prepare axis translation.
      */
    inline def onAxisInitialAxisTranslation(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onAxisInitialAxisTranslation")().asInstanceOf[Unit]
    
    /**
      * Start the bubble legend creation process.
      */
    inline def onLegendAfterGetAllItems(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onLegendAfterGetAllItems")().asInstanceOf[Unit]
    ...
    /**
      ...
      */
    inline def renderHidden(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("renderHidden")().asInstanceOf[Unit]
