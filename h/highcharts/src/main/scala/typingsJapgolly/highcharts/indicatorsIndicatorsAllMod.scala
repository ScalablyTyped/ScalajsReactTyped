...
object indicatorsIndicatorsAllMod {
  
  @JSImport("highcharts/indicators/indicators-all", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/indicators-all", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/indicators-all", "Highcharts.SeriesPalettes")
    @js.native
