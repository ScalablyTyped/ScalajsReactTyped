...
object modulesParetoMod {
  
  @JSImport("highcharts/modules/pareto", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/pareto", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/pareto", "Highcharts.SeriesPalettes")
    @js.native
