package typingsJapgolly.highcharts.streamgraphMod
...
@JSImport("highcharts/modules/streamgraph", "Highcharts")
@js.native
object Highcharts extends js.Object {
  ...
  def animate(el: typingsJapgolly.highcharts.mod.SVGElement, params: CSSObject): Unit = js.native
  def animate(el: typingsJapgolly.highcharts.mod.SVGElement, params: CSSObject, opt: AnimationOptionsObject): Unit = js.native
  def animate(el: typingsJapgolly.highcharts.mod.SVGElement, params: SVGAttributes): Unit = js.native
  def animate(el: typingsJapgolly.highcharts.mod.SVGElement, params: SVGAttributes, opt: AnimationOptionsObject): Unit = js.native
  ...
  def seriesType(`type`: String, parent: String, options: Dictionary[_]): typingsJapgolly.highcharts.mod.Series = js.native
  def seriesType(`type`: String, parent: String, options: Dictionary[_], props: Dictionary[_]): typingsJapgolly.highcharts.mod.Series = js.native
  def seriesType(
    `type`: String,
    parent: String,
  ...
  ): typingsJapgolly.highcharts.mod.Series = js.native
  def seriesType(`type`: String, parent: String, options: SeriesOptionsType): typingsJapgolly.highcharts.mod.Series = js.native
  def seriesType(`type`: String, parent: String, options: SeriesOptionsType, props: Dictionary[_]): typingsJapgolly.highcharts.mod.Series = js.native
  def seriesType(
    `type`: String,
    parent: String,
  ...
  def stop(el: typingsJapgolly.highcharts.mod.SVGElement): Unit = js.native
  def stop(el: typingsJapgolly.highcharts.mod.SVGElement, prop: String): Unit = js.native
  ...
  object Axis
    extends TopLevel[
          Instantiable2[/* chart */ Chart_, /* options */ AxisOptions, typingsJapgolly.highcharts.mod.Axis]
        ]
  ...
  @js.native
  object Point
    extends TopLevel[Instantiable0[typingsJapgolly.highcharts.mod.Point]]
  
  @js.native
  object Pointer
    extends TopLevel[
          Instantiable2[/* chart */ Chart_, /* options */ Options, typingsJapgolly.highcharts.mod.Pointer]
        ]
  
  @js.native
  object SVGElement
    extends TopLevel[Instantiable0[typingsJapgolly.highcharts.mod.SVGElement]]
  ...
  object Series
    extends TopLevel[
          Instantiable2[
            ...
            typingsJapgolly.highcharts.mod.Series
          ]
        ]
