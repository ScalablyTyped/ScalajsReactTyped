...
object indicatorsRegressionsMod {
  
  @JSImport("highcharts/indicators/regressions", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/regressions", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/regressions", "Highcharts.SeriesPalettes")
    @js.native
