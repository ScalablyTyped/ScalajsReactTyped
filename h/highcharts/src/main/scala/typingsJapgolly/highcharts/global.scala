  ...
  object Highcharts {
    ...
    object AST {
      ...
      /**
        ...
        * the DOM.
        */
      @JSGlobal("Highcharts.AST.allowedAttributes")
      @js.native
      ...
      /**
        ...
        * these strings.
        */
      @JSGlobal("Highcharts.AST.allowedReferences")
      @js.native
      ...
      /**
        ...
        */
      @JSGlobal("Highcharts.AST.allowedTags")
      @js.native
      ...
      /**
        ...
        */
      @JSGlobal("Highcharts.AST.bypassHTMLFiltering")
      @js.native
    ...
    @JSGlobal("Highcharts.Annotation")
    @js.native
    ...
    @JSGlobal("Highcharts.AnnotationControlPoint")
    @js.native
    ...
    @JSGlobal("Highcharts.PlotLineOrBand")
    @js.native
    ...
    @JSGlobal("Highcharts.Point")
    @js.native
    open class Point ()
      extends typingsJapgolly.highcharts.mod.Point
    
    @JSGlobal("Highcharts.Pointer")
    @js.native
    ...
    object Series {
      ...
      /**
        ...
        */
      @JSGlobal("Highcharts.Series.types")
      @js.native
    ...
    @JSGlobal("Highcharts.SeriesPalettes")
    @js.native
    ...
    @JSGlobal("Highcharts.dateFormats")
    @js.native
    ...
    @JSGlobal("Highcharts.defaultOptions")
    @js.native
