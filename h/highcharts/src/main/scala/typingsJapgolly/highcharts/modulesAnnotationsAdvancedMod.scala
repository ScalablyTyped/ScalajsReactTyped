...
import typingsJapgolly.highcharts.mod.Annotation
...
object modulesAnnotationsAdvancedMod {
  
  @JSImport("highcharts/modules/annotations-advanced", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/annotations-advanced", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/annotations-advanced", "Highcharts.SeriesPalettes")
    @js.native
