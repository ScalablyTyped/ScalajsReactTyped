...
import typingsJapgolly.highcharts.mod.PositionObject
...
object modulesMapMod {
  ...
  object highchartsAugmentingMod {
    ...
    object Point {
      ...
      inline def apply(properties: Any, zoomTo: Callback): Point = {
        val __obj = js.Dynamic.literal(properties = properties.asInstanceOf[js.Any], zoomTo = zoomTo.toJsFn)
      ...
      extension [Self <: Point](x: Self) {
        ...
        inline def setZoomTo(value: Callback): Self = StObject.set(x, "zoomTo", value.toJsFn)
      }
    }
