...
object modulesPathfinderMod {
  
  @JSImport("highcharts/modules/pathfinder", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/pathfinder", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/pathfinder", "Highcharts.SeriesPalettes")
    @js.native
