...
object modulesBulletMod {
  
  @JSImport("highcharts/modules/bullet", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/bullet", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/bullet", "Highcharts.SeriesPalettes")
    @js.native
