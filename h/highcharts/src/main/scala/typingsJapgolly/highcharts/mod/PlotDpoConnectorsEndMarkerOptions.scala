...
trait PlotDpoConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotDpoConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDpoConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotDpoConnectorsEndMarkerOptions]
  }
}
