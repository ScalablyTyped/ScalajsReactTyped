...
trait PlotTreemapConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotTreemapConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotTreemapConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotTreemapConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotTreemapConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotTreemapConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotTreemapConnectorsMarkerOptions = null,
    startMarker: PlotTreemapConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotTreemapConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapConnectorsOptions]
  }
}
