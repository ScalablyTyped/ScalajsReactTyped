...
trait PlotTilemapConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotTilemapConnectorsMarkerOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotTilemapConnectorsMarkerOptions]
  }
}
