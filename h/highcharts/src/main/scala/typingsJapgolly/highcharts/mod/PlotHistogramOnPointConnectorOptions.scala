...
trait PlotHistogramOnPointConnectorOptions extends StObject {
...
object PlotHistogramOnPointConnectorOptions {
  
  inline def apply(): PlotHistogramOnPointConnectorOptions = {
