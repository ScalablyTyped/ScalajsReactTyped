...
trait SeriesScatterDataEventsOptions extends js.Object {
  /**
...
object SeriesScatterDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesScatterDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesScatterDataEventsOptions]
  }
}
