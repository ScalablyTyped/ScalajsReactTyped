...
trait PlotMfiTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotMfiTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotMfiTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotMfiTooltipDateTimeLabelFormatsOptions]
  }
}
