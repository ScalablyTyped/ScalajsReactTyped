...
trait PlotBoxplotPointEventsOptions extends js.Object {
  /**
...
object PlotBoxplotPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotBoxplotPointEventsOptions]
  }
}
