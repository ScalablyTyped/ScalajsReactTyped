...
import typingsJapgolly.highcharts.highchartsStrings.aroon
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesAroonOptions
  extends StObject
     with PlotAroonOptions {
...
object SeriesAroonOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | aroon): SeriesAroonOptions = {
  ...
  extension [Self <: SeriesAroonOptions](x: Self) {
    ...
    inline def setType(value: String | aroon): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
