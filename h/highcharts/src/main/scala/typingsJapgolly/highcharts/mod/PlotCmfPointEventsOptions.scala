...
trait PlotCmfPointEventsOptions extends js.Object {
  /**
...
object PlotCmfPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotCmfPointEventsOptions]
  }
}
