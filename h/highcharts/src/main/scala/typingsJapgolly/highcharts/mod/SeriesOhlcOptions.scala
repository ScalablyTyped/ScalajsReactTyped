...
import typingsJapgolly.highcharts.highchartsStrings.ohlc
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesOhlcOptions
  extends StObject
     with PlotOhlcOptions {
...
object SeriesOhlcOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | ohlc): SeriesOhlcOptions = {
  ...
  extension [Self <: SeriesOhlcOptions](x: Self) {
    ...
    inline def setType(value: String | ohlc): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
