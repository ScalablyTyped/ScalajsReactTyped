...
trait SeriesPyramid3dDataEventsOptions extends js.Object {
  /**
...
object SeriesPyramid3dDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesPyramid3dDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesPyramid3dDataEventsOptions]
  }
}
