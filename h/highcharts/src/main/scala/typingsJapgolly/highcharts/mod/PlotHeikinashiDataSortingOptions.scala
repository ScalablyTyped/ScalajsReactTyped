...
trait PlotHeikinashiDataSortingOptions extends StObject {
...
object PlotHeikinashiDataSortingOptions {
  
  inline def apply(): PlotHeikinashiDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeikinashiDataSortingOptions]
  }
  
  extension [Self <: PlotHeikinashiDataSortingOptions](x: Self) {
