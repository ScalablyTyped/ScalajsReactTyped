...
import typingsJapgolly.highcharts.highchartsStrings.abands
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesAbandsOptions
  extends StObject
     with PlotAbandsOptions {
...
object SeriesAbandsOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | abands): SeriesAbandsOptions = {
  ...
  extension [Self <: SeriesAbandsOptions](x: Self) {
    ...
    inline def setType(value: String | abands): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
