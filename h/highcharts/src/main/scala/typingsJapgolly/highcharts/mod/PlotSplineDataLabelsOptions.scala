...
trait PlotSplineDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotSplineDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotSplineDataLabelsOptions {
  
  inline def apply(): PlotSplineDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineDataLabelsOptions]
  }
  
  extension [Self <: PlotSplineDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotSplineDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
