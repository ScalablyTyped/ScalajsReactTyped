...
trait PlotTrendlineDataGroupingOptions extends js.Object {
  /**
...
object PlotTrendlineDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrendlineDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlineDataGroupingOptions]
  }
}
