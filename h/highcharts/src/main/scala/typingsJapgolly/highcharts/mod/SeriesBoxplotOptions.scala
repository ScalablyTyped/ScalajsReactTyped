...
import typingsJapgolly.highcharts.highchartsStrings.boxplot
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesBoxplotOptions
  extends StObject
     with PlotBoxplotOptions {
...
object SeriesBoxplotOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | boxplot): SeriesBoxplotOptions = {
  ...
  extension [Self <: SeriesBoxplotOptions](x: Self) {
    ...
    inline def setType(value: String | boxplot): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
