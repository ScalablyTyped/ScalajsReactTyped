...
trait PlotDisparityindexDataSortingOptions extends StObject {
...
object PlotDisparityindexDataSortingOptions {
  
  inline def apply(): PlotDisparityindexDataSortingOptions = {
