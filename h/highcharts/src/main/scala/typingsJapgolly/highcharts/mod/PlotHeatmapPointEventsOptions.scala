...
trait PlotHeatmapPointEventsOptions extends js.Object {
  /**
...
object PlotHeatmapPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotHeatmapPointEventsOptions]
  }
}
