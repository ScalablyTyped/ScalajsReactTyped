...
trait PlotHeatmapTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotHeatmapTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotHeatmapTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapTooltipDateTimeLabelFormatsOptions]
  }
}
