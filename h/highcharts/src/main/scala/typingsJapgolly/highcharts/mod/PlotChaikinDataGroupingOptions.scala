...
trait PlotChaikinDataGroupingOptions extends js.Object {
  /**
...
object PlotChaikinDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotChaikinDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinDataGroupingOptions]
  }
}
