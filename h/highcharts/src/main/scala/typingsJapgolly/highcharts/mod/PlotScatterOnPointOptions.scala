...
trait PlotScatterOnPointOptions extends StObject {
  ...
  /**
    ...
    */
  var connectorOptions: js.UndefOr[PlotScatterOnPointConnectorOptions | SVGAttributes] = js.undefined
  ...
  /**
    ...
    */
  var position: js.UndefOr[js.Object | PlotScatterOnPointPositionOptions] = js.undefined
}
object PlotScatterOnPointOptions {
  
  inline def apply(): PlotScatterOnPointOptions = {
  ...
  extension [Self <: PlotScatterOnPointOptions](x: Self) {
    ...
    inline def setPosition(value: js.Object | PlotScatterOnPointPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
