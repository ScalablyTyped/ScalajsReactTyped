...
trait PlotCciOnPointPositionOptions extends StObject {
...
object PlotCciOnPointPositionOptions {
  
  inline def apply(): PlotCciOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciOnPointPositionOptions]
  }
  
  extension [Self <: PlotCciOnPointPositionOptions](x: Self) {
