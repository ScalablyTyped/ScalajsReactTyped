...
trait PlotLinearregressionangleDataSortingOptions extends StObject {
...
object PlotLinearregressionangleDataSortingOptions {
  
  inline def apply(): PlotLinearregressionangleDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleDataSortingOptions]
  }
  
  extension [Self <: PlotLinearregressionangleDataSortingOptions](x: Self) {
