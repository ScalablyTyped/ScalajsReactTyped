...
trait PlotHeatmapDataSortingOptions extends StObject {
...
object PlotHeatmapDataSortingOptions {
  
  inline def apply(): PlotHeatmapDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapDataSortingOptions]
  }
  
  extension [Self <: PlotHeatmapDataSortingOptions](x: Self) {
