...
trait PlotFlagsTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotFlagsTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotFlagsTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotFlagsTooltipDateTimeLabelFormatsOptions]
  }
}
