...
trait PlotScatterOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotScatterAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var cluster: js.UndefOr[PlotScatterClusterOptions] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotScatterDataLabelsOptions | js.Array[PlotScatterDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotScatterDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotScatterOnPointOptions] = js.undefined
...
object PlotScatterOptions {
  ...
  inline def apply(): PlotScatterOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterOptions]
  }
  
  extension [Self <: PlotScatterOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotScatterAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setCluster(value: PlotScatterClusterOptions): Self = StObject.set(x, "cluster", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotScatterDataLabelsOptions | js.Array[PlotScatterDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotScatterDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotScatterDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setJitter(value: PlotScatterJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotScatterOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
