...
trait PlotVwapAccessibilityPointOptions extends StObject {
...
object PlotVwapAccessibilityPointOptions {
  
  inline def apply(): PlotVwapAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapAccessibilityPointOptions]
  }
  
  extension [Self <: PlotVwapAccessibilityPointOptions](x: Self) {
