...
trait PlotSmaOnPointPositionOptions extends StObject {
...
object PlotSmaOnPointPositionOptions {
  
  inline def apply(): PlotSmaOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaOnPointPositionOptions]
  }
  
  extension [Self <: PlotSmaOnPointPositionOptions](x: Self) {
