...
trait PlotPolygonOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotPolygonDataLabelsOptions | js.Array[PlotPolygonDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotPolygonDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotPolygonOnPointOptions] = js.undefined
...
object PlotPolygonOptions {
  ...
  inline def apply(): PlotPolygonOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonOptions]
  }
  
  extension [Self <: PlotPolygonOptions](x: Self) {
    ...
    inline def setDataLabels(value: PlotPolygonDataLabelsOptions | js.Array[PlotPolygonDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotPolygonDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotPolygonDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotPolygonOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
