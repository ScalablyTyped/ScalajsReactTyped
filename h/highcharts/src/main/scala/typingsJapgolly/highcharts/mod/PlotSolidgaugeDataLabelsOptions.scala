...
object PlotSolidgaugeDataLabelsOptions {
  ...
  inline def apply(): PlotSolidgaugeDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeDataLabelsOptions]
  }
  
  extension [Self <: PlotSolidgaugeDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotSolidgaugeDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
