...
trait PlotMapbubbleOnPointPositionOptions extends StObject {
...
object PlotMapbubbleOnPointPositionOptions {
  
  inline def apply(): PlotMapbubbleOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleOnPointPositionOptions]
  }
  
  extension [Self <: PlotMapbubbleOnPointPositionOptions](x: Self) {
