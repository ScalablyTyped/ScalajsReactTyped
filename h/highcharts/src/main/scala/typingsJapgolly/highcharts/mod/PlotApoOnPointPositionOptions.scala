...
trait PlotApoOnPointPositionOptions extends StObject {
...
object PlotApoOnPointPositionOptions {
  
  inline def apply(): PlotApoOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoOnPointPositionOptions]
  }
  
  extension [Self <: PlotApoOnPointPositionOptions](x: Self) {
