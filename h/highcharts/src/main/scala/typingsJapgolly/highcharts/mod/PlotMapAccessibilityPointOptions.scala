...
trait PlotMapAccessibilityPointOptions extends StObject {
...
object PlotMapAccessibilityPointOptions {
  
  inline def apply(): PlotMapAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapAccessibilityPointOptions]
  }
  
  extension [Self <: PlotMapAccessibilityPointOptions](x: Self) {
