...
trait PlotTimelineStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotTimelineStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTimelineStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotTimelineStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotTimelineStatesSelectAnimationOptions = null,
  ...
  ): PlotTimelineStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineStatesSelectOptions]
  }
}
