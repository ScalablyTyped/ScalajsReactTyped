...
trait PlotSupertrendOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotSupertrendAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotSupertrendOnPointOptions] = js.undefined
...
object PlotSupertrendOptions {
  ...
  inline def apply(): PlotSupertrendOptions = {
  ...
  extension [Self <: PlotSupertrendOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotSupertrendAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setChangeTrendLine(value: PlotSupertrendChangeTrendLineOptions): Self = StObject.set(x, "changeTrendLine", value.asInstanceOf[js.Any])
    
    inline def setChangeTrendLineUndefined: Self = StObject.set(x, "changeTrendLine", js.undefined)
    ...
    inline def setDataLabels(value: PlotSupertrendDataLabelsOptions | js.Array[PlotSupertrendDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotSupertrendDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotSupertrendDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setFallingTrendColor(value: ColorString | GradientColorObject | PatternObject): Self = StObject.set(x, "fallingTrendColor", value.asInstanceOf[js.Any])
    
    inline def setFallingTrendColorUndefined: Self = StObject.set(x, "fallingTrendColor", js.undefined)
    ...
    inline def setOnPoint(value: js.Object | PlotSupertrendOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotSupertrendParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    inline def setRisingTrendColor(value: ColorString | GradientColorObject | PatternObject): Self = StObject.set(x, "risingTrendColor", value.asInstanceOf[js.Any])
    
    inline def setRisingTrendColorUndefined: Self = StObject.set(x, "risingTrendColor", js.undefined)
