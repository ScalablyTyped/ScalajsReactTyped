...
trait PlotBulletPointEventsOptions extends js.Object {
  /**
...
object PlotBulletPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotBulletPointEventsOptions]
  }
}
