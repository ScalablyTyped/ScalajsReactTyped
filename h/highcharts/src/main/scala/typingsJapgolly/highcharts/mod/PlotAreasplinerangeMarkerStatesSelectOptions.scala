...
trait PlotAreasplinerangeMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAreasplinerangeMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplinerangeMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplinerangeMarkerStatesSelectOptions]
  }
}
