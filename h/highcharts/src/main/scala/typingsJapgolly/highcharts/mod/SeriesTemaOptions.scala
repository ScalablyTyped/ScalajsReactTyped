...
import typingsJapgolly.highcharts.highchartsStrings.tema
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesTemaOptions
  extends StObject
     with PlotTemaOptions {
...
object SeriesTemaOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | tema): SeriesTemaOptions = {
  ...
  extension [Self <: SeriesTemaOptions](x: Self) {
    ...
    inline def setType(value: String | tema): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
