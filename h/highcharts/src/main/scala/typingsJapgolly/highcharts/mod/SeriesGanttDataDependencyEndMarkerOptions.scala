...
trait SeriesGanttDataDependencyEndMarkerOptions extends js.Object {
  /**
...
object SeriesGanttDataDependencyEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesGanttDataDependencyEndMarkerOptions = {
    ...
    __obj.asInstanceOf[SeriesGanttDataDependencyEndMarkerOptions]
  }
}
