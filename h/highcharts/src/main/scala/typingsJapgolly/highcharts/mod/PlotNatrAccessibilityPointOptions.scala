...
trait PlotNatrAccessibilityPointOptions extends StObject {
...
object PlotNatrAccessibilityPointOptions {
  
  inline def apply(): PlotNatrAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrAccessibilityPointOptions]
  }
  
  extension [Self <: PlotNatrAccessibilityPointOptions](x: Self) {
