...
trait PlotWaterfallAccessibilityPointOptions extends StObject {
...
object PlotWaterfallAccessibilityPointOptions {
  
  inline def apply(): PlotWaterfallAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallAccessibilityPointOptions]
  }
  
  extension [Self <: PlotWaterfallAccessibilityPointOptions](x: Self) {
