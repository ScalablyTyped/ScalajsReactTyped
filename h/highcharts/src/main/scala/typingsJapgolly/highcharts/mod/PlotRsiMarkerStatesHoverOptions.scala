...
trait PlotRsiMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotRsiMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRsiMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotRsiMarkerStatesHoverOptions]
  }
}
