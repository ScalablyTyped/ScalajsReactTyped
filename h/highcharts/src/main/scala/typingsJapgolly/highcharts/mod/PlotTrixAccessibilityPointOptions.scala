...
trait PlotTrixAccessibilityPointOptions extends StObject {
...
object PlotTrixAccessibilityPointOptions {
  
  inline def apply(): PlotTrixAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixAccessibilityPointOptions]
  }
  
  extension [Self <: PlotTrixAccessibilityPointOptions](x: Self) {
