...
trait PlotTrendlineStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotTrendlineStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTrendlineStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotTrendlineStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotTrendlineStatesSelectAnimationOptions = null,
    borderColor: ColorString | GradientColorObject | PatternObject = null,
    borderWidth: Int | Double = null,
    color: ColorString | GradientColorObject | PatternObject = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    halo: PlotTrendlineStatesSelectHaloOptions = null,
    lineWidth: Int | Double = null,
    lineWidthPlus: Int | Double = null
  ): PlotTrendlineStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlineStatesSelectOptions]
  }
}
