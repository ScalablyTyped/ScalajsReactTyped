...
trait PlotSmaPointEventsOptions extends js.Object {
  /**
...
object PlotSmaPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotSmaPointEventsOptions]
  }
}
