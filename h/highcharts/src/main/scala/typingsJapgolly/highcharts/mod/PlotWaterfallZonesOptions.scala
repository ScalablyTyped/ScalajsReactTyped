...
trait PlotWaterfallZonesOptions extends js.Object {
  /**
...
object PlotWaterfallZonesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotWaterfallZonesOptions]
  }
}
