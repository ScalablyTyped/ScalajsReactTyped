...
trait PlotPackedbubbleLabelOptions extends js.Object {
  /**
...
object PlotPackedbubbleLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPackedbubbleLabelOptions]
  }
}
