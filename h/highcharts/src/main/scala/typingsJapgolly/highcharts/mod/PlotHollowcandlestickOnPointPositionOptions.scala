...
trait PlotHollowcandlestickOnPointPositionOptions extends StObject {
...
object PlotHollowcandlestickOnPointPositionOptions {
  
  inline def apply(): PlotHollowcandlestickOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickOnPointPositionOptions]
  }
  
  extension [Self <: PlotHollowcandlestickOnPointPositionOptions](x: Self) {
