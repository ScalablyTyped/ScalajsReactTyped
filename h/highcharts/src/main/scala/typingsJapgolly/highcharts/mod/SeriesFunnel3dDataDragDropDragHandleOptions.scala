...
trait SeriesFunnel3dDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesFunnel3dDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesFunnel3dDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesFunnel3dDataDragDropDragHandleOptions]
  }
}
