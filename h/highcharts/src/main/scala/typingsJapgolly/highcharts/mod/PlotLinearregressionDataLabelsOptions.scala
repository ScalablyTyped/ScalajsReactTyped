...
trait PlotLinearregressionDataLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | PlotLinearregressionDataLabelsAnimationOptions | PartialAnimationOptionsOb
  ] = js.undefined
...
object PlotLinearregressionDataLabelsOptions {
  
  inline def apply(): PlotLinearregressionDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionDataLabelsOptions]
  }
  
  extension [Self <: PlotLinearregressionDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotLinearregressionDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
