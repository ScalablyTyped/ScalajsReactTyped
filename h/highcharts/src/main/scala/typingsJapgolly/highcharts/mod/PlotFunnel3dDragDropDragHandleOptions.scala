...
trait PlotFunnel3dDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotFunnel3dDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotFunnel3dDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotFunnel3dDragDropDragHandleOptions]
  }
}
