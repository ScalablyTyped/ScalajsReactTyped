...
trait PlotAroonConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotAroonConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAroonConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotAroonConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotAroonConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotAroonConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotAroonConnectorsMarkerOptions = null,
    startMarker: PlotAroonConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotAroonConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotAroonConnectorsOptions]
  }
}
