...
trait PlotSeriesAccessibilityPointOptions extends StObject {
...
object PlotSeriesAccessibilityPointOptions {
  
  inline def apply(): PlotSeriesAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesAccessibilityPointOptions]
  }
  
  extension [Self <: PlotSeriesAccessibilityPointOptions](x: Self) {
