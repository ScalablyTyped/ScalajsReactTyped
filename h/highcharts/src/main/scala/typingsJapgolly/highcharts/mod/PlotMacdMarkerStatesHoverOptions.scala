...
trait PlotMacdMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotMacdMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMacdMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMacdMarkerStatesHoverOptions]
  }
}
