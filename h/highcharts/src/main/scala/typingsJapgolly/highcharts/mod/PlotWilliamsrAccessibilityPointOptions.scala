...
trait PlotWilliamsrAccessibilityPointOptions extends StObject {
...
object PlotWilliamsrAccessibilityPointOptions {
  
  inline def apply(): PlotWilliamsrAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrAccessibilityPointOptions]
  }
  
  extension [Self <: PlotWilliamsrAccessibilityPointOptions](x: Self) {
