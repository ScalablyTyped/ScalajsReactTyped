...
trait PlotTrendlineOnPointPositionOptions extends StObject {
...
object PlotTrendlineOnPointPositionOptions {
  
  inline def apply(): PlotTrendlineOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineOnPointPositionOptions]
  }
  
  extension [Self <: PlotTrendlineOnPointPositionOptions](x: Self) {
