...
trait PlotPriceenvelopesConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotPriceenvelopesConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPriceenvelopesConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesConnectorsStartMarkerOptions]
  }
}
