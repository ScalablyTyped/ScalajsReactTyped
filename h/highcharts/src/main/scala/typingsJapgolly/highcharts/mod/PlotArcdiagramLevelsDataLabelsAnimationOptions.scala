...
trait PlotArcdiagramLevelsDataLabelsAnimationOptions extends StObject {
...
object PlotArcdiagramLevelsDataLabelsAnimationOptions {
  
  inline def apply(): PlotArcdiagramLevelsDataLabelsAnimationOptions = {
