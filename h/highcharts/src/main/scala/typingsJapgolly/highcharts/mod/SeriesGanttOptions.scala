...
import typingsJapgolly.highcharts.highchartsStrings.gantt
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesGanttOptions
  extends StObject
     with PlotGanttOptions {
  
  /**
    * (Gantt) Data for a Gantt series.
    */
  var data: js.UndefOr[js.Array[GanttPointOptionsObject]] = js.undefined
...
object SeriesGanttOptions {
  ...
  inline def apply(`type`: String | gantt): SeriesGanttOptions = {
  ...
  extension [Self <: SeriesGanttOptions](x: Self) {
    ...
    inline def setDataVarargs(value: GanttPointOptionsObject*): Self = StObject.set(x, "data", js.Array(value*))
    ...
    inline def setType(value: String | gantt): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
