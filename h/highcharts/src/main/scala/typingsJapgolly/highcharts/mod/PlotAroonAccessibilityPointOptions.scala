...
trait PlotAroonAccessibilityPointOptions extends StObject {
...
object PlotAroonAccessibilityPointOptions {
  
  inline def apply(): PlotAroonAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonAccessibilityPointOptions]
  }
  
  extension [Self <: PlotAroonAccessibilityPointOptions](x: Self) {
