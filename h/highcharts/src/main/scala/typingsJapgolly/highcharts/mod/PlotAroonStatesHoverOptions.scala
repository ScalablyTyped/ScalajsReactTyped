...
trait PlotAroonStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAroonStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAroonStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotAroonStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAroonStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotAroonStatesHoverOptions]
  }
}
