...
trait PlotCylinderConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotCylinderConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCylinderConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotCylinderConnectorsStartMarkerOptions]
  }
}
