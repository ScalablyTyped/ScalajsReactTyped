...
import typingsJapgolly.highcharts.highchartsStrings.lollipop
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesLollipopOptions
  extends StObject
     with PlotLollipopOptions {
...
object SeriesLollipopOptions {
  ...
  inline def apply(`type`: String | lollipop): SeriesLollipopOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesLollipopOptions]
  }
  
  extension [Self <: SeriesLollipopOptions](x: Self) {
    ...
    inline def setType(value: String | lollipop): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
