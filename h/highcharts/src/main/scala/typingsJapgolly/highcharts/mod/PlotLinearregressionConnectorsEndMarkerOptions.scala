...
trait PlotLinearregressionConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotLinearregressionConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionConnectorsEndMarkerOptions]
  }
}
