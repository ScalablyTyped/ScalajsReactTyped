...
trait PlotHistogramLabelOptions extends js.Object {
  /**
...
object PlotHistogramLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotHistogramLabelOptions]
  }
}
