...
trait PlotErrorbarPointEventsOptions extends js.Object {
  /**
...
object PlotErrorbarPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotErrorbarPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotErrorbarPointEventsOptions]
  }
}
