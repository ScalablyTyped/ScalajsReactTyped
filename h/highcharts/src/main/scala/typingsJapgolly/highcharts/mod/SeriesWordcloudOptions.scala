...
import typingsJapgolly.highcharts.highchartsStrings.wordcloud
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesWordcloudOptions
  extends StObject
     with PlotWordcloudOptions {
...
object SeriesWordcloudOptions {
  ...
  inline def apply(`type`: String | wordcloud): SeriesWordcloudOptions = {
  ...
  extension [Self <: SeriesWordcloudOptions](x: Self) {
    ...
    inline def setDataVarargs(value: ((js.Tuple2[String, Double]) | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value*))
    ...
    inline def setType(value: String | wordcloud): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
