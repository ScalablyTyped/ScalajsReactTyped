...
trait PlotScatterClusterOptions extends StObject {
  ...
  var events: js.UndefOr[PlotScatterClusterEventsOptions] = js.undefined
  ...
  /**
    ...
    * iterations.
    */
  var layoutAlgorithm: js.UndefOr[PlotScatterClusterLayoutAlgorithmOptions] = js.undefined
  ...
  var states: js.UndefOr[PlotScatterClusterStatesOptions] = js.undefined
  ...
  /**
    ...
    * `className` option.
    */
  var zones: js.UndefOr[js.Array[PlotScatterClusterZonesOptions]] = js.undefined
}
