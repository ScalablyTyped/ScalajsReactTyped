...
trait PlotFunnelOnPointPositionOptions extends StObject {
...
object PlotFunnelOnPointPositionOptions {
  
  inline def apply(): PlotFunnelOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelOnPointPositionOptions]
  }
  
  extension [Self <: PlotFunnelOnPointPositionOptions](x: Self) {
