...
trait PlotDmiDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotDmiDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotDmiDataLabelsOptions {
  
  inline def apply(): PlotDmiDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiDataLabelsOptions]
  }
  
  extension [Self <: PlotDmiDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotDmiDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
