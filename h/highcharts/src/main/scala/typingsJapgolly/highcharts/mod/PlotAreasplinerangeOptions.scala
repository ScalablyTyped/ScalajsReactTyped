...
trait PlotAreasplinerangeOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotAreasplinerangeAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotAreasplinerangeDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotAreasplinerangeOnPointOptions] = js.undefined
...
object PlotAreasplinerangeOptions {
  ...
  inline def apply(): PlotAreasplinerangeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeOptions]
  }
  
  extension [Self <: PlotAreasplinerangeOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotAreasplinerangeAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotAreasplinerangeDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotAreasplinerangeOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
