...
trait PlotErrorbarOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotErrorbarDataLabelsOptions | js.Array[PlotErrorbarDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotErrorbarDataSortingOptions] = js.undefined
...
object PlotErrorbarOptions {
  
  inline def apply(): PlotErrorbarOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarOptions]
  }
  
  extension [Self <: PlotErrorbarOptions](x: Self) {
    ...
    inline def setDataLabels(value: PlotErrorbarDataLabelsOptions | js.Array[PlotErrorbarDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotErrorbarDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotErrorbarDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setMedianColor(value: ColorString | GradientColorObject): Self = StObject.set(x, "medianColor", value.asInstanceOf[js.Any])
    
    inline def setMedianColorUndefined: Self = StObject.set(x, "medianColor", js.undefined)
    ...
    inline def setMedianWidth(value: Double): Self = StObject.set(x, "medianWidth", value.asInstanceOf[js.Any])
    
    inline def setMedianWidthNull: Self = StObject.set(x, "medianWidth", null)
    
    inline def setMedianWidthUndefined: Self = StObject.set(x, "medianWidth", js.undefined)
    ...
    inline def setOnPoint(value: js.Object | PlotErrorbarOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setWhiskerColor(value: ColorString | GradientColorObject | PatternObject): Self = StObject.set(x, "whiskerColor", value.asInstanceOf[js.Any])
    
    inline def setWhiskerColorUndefined: Self = StObject.set(x, "whiskerColor", js.undefined)
    ...
    inline def setWhiskerLength(value: Double | String): Self = StObject.set(x, "whiskerLength", value.asInstanceOf[js.Any])
    
    inline def setWhiskerLengthUndefined: Self = StObject.set(x, "whiskerLength", js.undefined)
