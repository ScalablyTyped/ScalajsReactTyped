...
trait PlotIkhSenkouSpanBStylesOptions extends StObject {
...
object PlotIkhSenkouSpanBStylesOptions {
  ...
  inline def apply(): PlotIkhSenkouSpanBStylesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSenkouSpanBStylesOptions]
  }
  
  extension [Self <: PlotIkhSenkouSpanBStylesOptions](x: Self) {
