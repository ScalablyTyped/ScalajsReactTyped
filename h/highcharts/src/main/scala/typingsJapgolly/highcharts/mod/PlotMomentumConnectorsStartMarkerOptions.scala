...
trait PlotMomentumConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotMomentumConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMomentumConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumConnectorsStartMarkerOptions]
  }
}
