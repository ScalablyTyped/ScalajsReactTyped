...
trait PlotVectorOnPointPositionOptions extends StObject {
...
object PlotVectorOnPointPositionOptions {
  
  inline def apply(): PlotVectorOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorOnPointPositionOptions]
  }
  
  extension [Self <: PlotVectorOnPointPositionOptions](x: Self) {
