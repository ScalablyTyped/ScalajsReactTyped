...
trait PlotObvDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotObvDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotObvDataLabelsOptions {
  
  inline def apply(): PlotObvDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotObvDataLabelsOptions]
  }
  
  extension [Self <: PlotObvDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotObvDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
