...
trait PlotVennTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotVennTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotVennTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotVennTooltipDateTimeLabelFormatsOptions]
  }
}
