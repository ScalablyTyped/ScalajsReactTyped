...
import typingsJapgolly.highcharts.highchartsStrings.dumbbell
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesDumbbellOptions
  extends StObject
     with PlotDumbbellOptions {
...
object SeriesDumbbellOptions {
  
  inline def apply(`type`: String | dumbbell): SeriesDumbbellOptions = {
  ...
  extension [Self <: SeriesDumbbellOptions](x: Self) {
    ...
    inline def setType(value: String | dumbbell): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
