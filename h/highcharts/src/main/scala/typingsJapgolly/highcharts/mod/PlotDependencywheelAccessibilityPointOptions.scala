...
trait PlotDependencywheelAccessibilityPointOptions extends StObject {
...
object PlotDependencywheelAccessibilityPointOptions {
  
  inline def apply(): PlotDependencywheelAccessibilityPointOptions = {
