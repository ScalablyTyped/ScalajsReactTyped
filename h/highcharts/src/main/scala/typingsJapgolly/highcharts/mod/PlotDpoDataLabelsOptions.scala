...
trait PlotDpoDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotDpoDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotDpoDataLabelsOptions {
  ...
  inline def apply(): PlotDpoDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoDataLabelsOptions]
  }
  
  extension [Self <: PlotDpoDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotDpoDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
