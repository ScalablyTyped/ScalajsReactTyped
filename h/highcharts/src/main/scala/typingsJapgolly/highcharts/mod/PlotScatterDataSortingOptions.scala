...
trait PlotScatterDataSortingOptions extends StObject {
...
object PlotScatterDataSortingOptions {
  
  inline def apply(): PlotScatterDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterDataSortingOptions]
  }
  
  extension [Self <: PlotScatterDataSortingOptions](x: Self) {
