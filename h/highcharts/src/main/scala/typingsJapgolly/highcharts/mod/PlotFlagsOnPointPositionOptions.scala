...
trait PlotFlagsOnPointPositionOptions extends StObject {
...
object PlotFlagsOnPointPositionOptions {
  
  inline def apply(): PlotFlagsOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsOnPointPositionOptions]
  }
  
  extension [Self <: PlotFlagsOnPointPositionOptions](x: Self) {
