...
trait PlotBellcurveStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotBellcurveStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotBellcurveStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotBellcurveStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotBellcurveStatesHoverAnimationOptions = null,
  ...
  ): PlotBellcurveStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveStatesHoverOptions]
  }
}
