...
trait PlotMappointDataSortingOptions extends StObject {
...
object PlotMappointDataSortingOptions {
  
  inline def apply(): PlotMappointDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointDataSortingOptions]
  }
  
  extension [Self <: PlotMappointDataSortingOptions](x: Self) {
