...
trait SeriesFlagsDataEventsOptions extends js.Object {
  /**
...
object SeriesFlagsDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesFlagsDataEventsOptions]
  }
}
