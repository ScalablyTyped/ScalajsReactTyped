...
trait PlotWilliamsrConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotWilliamsrConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWilliamsrConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrConnectorsMarkerOptions]
  }
}
