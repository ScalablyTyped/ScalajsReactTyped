...
trait SeriesItemDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesItemDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesItemDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesItemDataDragDropGuideBoxDefaultOptions]
  }
}
