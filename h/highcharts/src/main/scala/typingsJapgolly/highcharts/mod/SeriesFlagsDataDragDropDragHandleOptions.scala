...
trait SeriesFlagsDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesFlagsDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesFlagsDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesFlagsDataDragDropDragHandleOptions]
  }
}
