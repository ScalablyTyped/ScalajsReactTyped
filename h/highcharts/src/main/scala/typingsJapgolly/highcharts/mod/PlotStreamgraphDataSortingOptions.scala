...
trait PlotStreamgraphDataSortingOptions extends StObject {
...
object PlotStreamgraphDataSortingOptions {
  
  inline def apply(): PlotStreamgraphDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphDataSortingOptions]
  }
  
  extension [Self <: PlotStreamgraphDataSortingOptions](x: Self) {
