...
trait PlotApoDataSortingOptions extends StObject {
...
object PlotApoDataSortingOptions {
  
  inline def apply(): PlotApoDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoDataSortingOptions]
  }
  
  extension [Self <: PlotApoDataSortingOptions](x: Self) {
