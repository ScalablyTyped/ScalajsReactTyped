...
trait PlotVwapStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotVwapStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotVwapStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotVwapStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotVwapStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotVwapStatesSelectOptions]
  }
}
