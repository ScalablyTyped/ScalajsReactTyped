...
trait PlotAroonoscillatorMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAroonoscillatorMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonoscillatorMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorMarkerStatesSelectOptions]
  }
}
