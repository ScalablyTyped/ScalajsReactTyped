...
trait PlotPsarTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotPsarTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotPsarTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotPsarTooltipDateTimeLabelFormatsOptions]
  }
}
