...
import typingsJapgolly.highcharts.highchartsStrings.Chart
import typingsJapgolly.highcharts.highchartsStrings.Map
...
object global {
  ...
  trait JQuery extends StObject {
    ...
    def highcharts(className: Chart | Map | typingsJapgolly.highcharts.highchartsStrings.StockChart): JQuery = js.native
    def highcharts(
      className: Chart | Map | typingsJapgolly.highcharts.highchartsStrings.StockChart,
      options: Unit,
      callback: ChartCallbackFunction
    ): JQuery = js.native
    def highcharts(className: Chart | Map | typingsJapgolly.highcharts.highchartsStrings.StockChart, options: Options): JQuery = js.native
    def highcharts(
      className: Chart | Map | typingsJapgolly.highcharts.highchartsStrings.StockChart,
      options: Options,
      callback: ChartCallbackFunction
