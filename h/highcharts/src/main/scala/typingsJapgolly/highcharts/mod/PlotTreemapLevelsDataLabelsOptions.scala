...
trait PlotTreemapLevelsDataLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | PlotTreemapLevelsDataLabelsAnimationOptions | PartialAnimationOptionsOb
  ] = js.undefined
...
object PlotTreemapLevelsDataLabelsOptions {
  ...
  inline def apply(): PlotTreemapLevelsDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapLevelsDataLabelsOptions]
  }
  
  extension [Self <: PlotTreemapLevelsDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotTreemapLevelsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
