...
import typingsJapgolly.highcharts.highchartsStrings.cmf
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesCmfOptions
  extends StObject
     with PlotCmfOptions {
...
object SeriesCmfOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | cmf): SeriesCmfOptions = {
  ...
  extension [Self <: SeriesCmfOptions](x: Self) {
    ...
    inline def setType(value: String | cmf): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
