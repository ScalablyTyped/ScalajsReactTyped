...
trait PlotLinearregressioninterceptOnPointPositionOptions extends StObject {
...
object PlotLinearregressioninterceptOnPointPositionOptions {
  
  inline def apply(): PlotLinearregressioninterceptOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptOnPointPositionOptions]
  }
  
  extension [Self <: PlotLinearregressioninterceptOnPointPositionOptions](x: Self) {
