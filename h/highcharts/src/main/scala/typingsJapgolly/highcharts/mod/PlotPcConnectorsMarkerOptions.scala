...
trait PlotPcConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotPcConnectorsMarkerOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPcConnectorsMarkerOptions]
  }
}
