...
trait PlotXrangeConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotXrangeConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotXrangeConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotXrangeConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotXrangeConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotXrangeConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotXrangeConnectorsMarkerOptions = null,
    startMarker: PlotXrangeConnectorsStartMarkerOptions = null,
    ...
    __obj.asInstanceOf[PlotXrangeConnectorsOptions]
  }
}
