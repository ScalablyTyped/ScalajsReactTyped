...
trait PlotRsiOnPointPositionOptions extends StObject {
...
object PlotRsiOnPointPositionOptions {
  
  inline def apply(): PlotRsiOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiOnPointPositionOptions]
  }
  
  extension [Self <: PlotRsiOnPointPositionOptions](x: Self) {
