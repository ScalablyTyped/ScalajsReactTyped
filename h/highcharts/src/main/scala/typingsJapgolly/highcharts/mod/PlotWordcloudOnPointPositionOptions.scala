...
trait PlotWordcloudOnPointPositionOptions extends StObject {
...
object PlotWordcloudOnPointPositionOptions {
  
  inline def apply(): PlotWordcloudOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudOnPointPositionOptions]
  }
  
  extension [Self <: PlotWordcloudOnPointPositionOptions](x: Self) {
