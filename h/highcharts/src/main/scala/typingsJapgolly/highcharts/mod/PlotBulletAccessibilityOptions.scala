...
trait PlotBulletAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotBulletAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotBulletAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotBulletAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotBulletAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotBulletAccessibilityOptions]
  }
}
