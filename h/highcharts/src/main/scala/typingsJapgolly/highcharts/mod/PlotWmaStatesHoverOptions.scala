...
trait PlotWmaStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotWmaStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotWmaStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotWmaStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotWmaStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotWmaStatesHoverOptions]
  }
}
