...
trait PlotPyramid3dAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPyramid3dAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotPyramid3dAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotPyramid3dAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotPyramid3dAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotPyramid3dAccessibilityOptions]
  }
}
