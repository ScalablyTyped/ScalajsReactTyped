...
trait PlotStochasticOnPointPositionOptions extends StObject {
...
object PlotStochasticOnPointPositionOptions {
  
  inline def apply(): PlotStochasticOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticOnPointPositionOptions]
  }
  
  extension [Self <: PlotStochasticOnPointPositionOptions](x: Self) {
