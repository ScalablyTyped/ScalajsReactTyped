...
trait PlotAoOnPointPositionOptions extends StObject {
...
object PlotAoOnPointPositionOptions {
  
  inline def apply(): PlotAoOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoOnPointPositionOptions]
  }
  
  extension [Self <: PlotAoOnPointPositionOptions](x: Self) {
