...
trait NavigatorXAxisCurrentDateIndicatorLabelOptions extends StObject {
...
object NavigatorXAxisCurrentDateIndicatorLabelOptions {
  
  inline def apply(): NavigatorXAxisCurrentDateIndicatorLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisCurrentDateIndicatorLabelOptions]
  }
  
  extension [Self <: NavigatorXAxisCurrentDateIndicatorLabelOptions](x: Self) {
