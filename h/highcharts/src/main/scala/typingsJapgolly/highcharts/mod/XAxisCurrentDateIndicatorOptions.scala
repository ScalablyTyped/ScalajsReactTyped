...
trait XAxisCurrentDateIndicatorOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[XAxisCurrentDateIndicatorEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[XAxisCurrentDateIndicatorLabelOptions] = js.undefined
  /**
...
object XAxisCurrentDateIndicatorOptions {
  @scala.inline
  def apply(
    ...
    events: XAxisCurrentDateIndicatorEventsOptions = null,
    id: String = null,
    label: XAxisCurrentDateIndicatorLabelOptions = null,
    ...
    __obj.asInstanceOf[XAxisCurrentDateIndicatorOptions]
  }
}
