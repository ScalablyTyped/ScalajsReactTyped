...
trait SeriesBarDataEventsOptions extends js.Object {
  /**
...
object SeriesBarDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesBarDataEventsOptions]
  }
}
