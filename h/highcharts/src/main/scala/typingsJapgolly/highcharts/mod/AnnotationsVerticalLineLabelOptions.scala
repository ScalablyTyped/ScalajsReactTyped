...
trait AnnotationsVerticalLineLabelOptions extends StObject {
...
object AnnotationsVerticalLineLabelOptions {
  ...
  inline def apply(): AnnotationsVerticalLineLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsVerticalLineLabelOptions]
  }
  
  extension [Self <: AnnotationsVerticalLineLabelOptions](x: Self) {
