...
trait PlotVariablepieTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotVariablepieTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotVariablepieTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotVariablepieTooltipDateTimeLabelFormatsOptions]
  }
}
