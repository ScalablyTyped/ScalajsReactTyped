...
trait PlotWaterfallConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotWaterfallConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotWaterfallConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotWaterfallConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotWaterfallConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotWaterfallConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotWaterfallConnectorsMarkerOptions = null,
    startMarker: PlotWaterfallConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotWaterfallConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotWaterfallConnectorsOptions]
  }
}
