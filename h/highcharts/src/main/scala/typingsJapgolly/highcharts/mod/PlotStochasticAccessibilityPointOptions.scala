...
trait PlotStochasticAccessibilityPointOptions extends StObject {
...
object PlotStochasticAccessibilityPointOptions {
  
  inline def apply(): PlotStochasticAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticAccessibilityPointOptions]
  }
  
  extension [Self <: PlotStochasticAccessibilityPointOptions](x: Self) {
