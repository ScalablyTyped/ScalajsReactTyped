...
trait NavigatorXAxisPlotLinesLabelOptions extends StObject {
...
object NavigatorXAxisPlotLinesLabelOptions {
  ...
  inline def apply(): NavigatorXAxisPlotLinesLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisPlotLinesLabelOptions]
  }
  
  extension [Self <: NavigatorXAxisPlotLinesLabelOptions](x: Self) {
