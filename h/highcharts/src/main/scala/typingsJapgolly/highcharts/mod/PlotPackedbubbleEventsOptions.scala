...
trait PlotPackedbubbleEventsOptions extends js.Object {
  /**
...
object PlotPackedbubbleEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPackedbubbleEventsOptions]
  }
}
