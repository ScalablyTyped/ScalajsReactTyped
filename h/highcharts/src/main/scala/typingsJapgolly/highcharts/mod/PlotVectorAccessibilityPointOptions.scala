...
trait PlotVectorAccessibilityPointOptions extends StObject {
...
object PlotVectorAccessibilityPointOptions {
  
  inline def apply(): PlotVectorAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorAccessibilityPointOptions]
  }
  
  extension [Self <: PlotVectorAccessibilityPointOptions](x: Self) {
