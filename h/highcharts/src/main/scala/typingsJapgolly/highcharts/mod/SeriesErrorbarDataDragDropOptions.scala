...
trait SeriesErrorbarDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesErrorbarDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesErrorbarDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesErrorbarDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesErrorbarDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesErrorbarDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesErrorbarDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesErrorbarDataDragDropOptions]
  }
}
