...
trait PlotRsiAccessibilityPointOptions extends StObject {
...
object PlotRsiAccessibilityPointOptions {
  
  inline def apply(): PlotRsiAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiAccessibilityPointOptions]
  }
  
  extension [Self <: PlotRsiAccessibilityPointOptions](x: Self) {
