...
trait PlotHistogramEventsOptions extends js.Object {
  /**
...
object PlotHistogramEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotHistogramEventsOptions]
  }
}
