...
trait PlotCylinderOnPointOptions extends StObject {
  ...
  /**
    ...
    */
  var connectorOptions: js.UndefOr[PlotCylinderOnPointConnectorOptions | SVGAttributes] = js.undefined
  ...
  /**
    ...
    */
  var position: js.UndefOr[js.Object | PlotCylinderOnPointPositionOptions] = js.undefined
}
object PlotCylinderOnPointOptions {
  
  inline def apply(): PlotCylinderOnPointOptions = {
  ...
  extension [Self <: PlotCylinderOnPointOptions](x: Self) {
    ...
    inline def setPosition(value: js.Object | PlotCylinderOnPointPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
