...
trait SeriesBubbleDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesBubbleDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesBubbleDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesBubbleDataDragDropGuideBoxDefaultOptions]
  }
}
