...
trait PlotMaplineAccessibilityPointOptions extends StObject {
...
object PlotMaplineAccessibilityPointOptions {
  
  inline def apply(): PlotMaplineAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineAccessibilityPointOptions]
  }
  
  extension [Self <: PlotMaplineAccessibilityPointOptions](x: Self) {
