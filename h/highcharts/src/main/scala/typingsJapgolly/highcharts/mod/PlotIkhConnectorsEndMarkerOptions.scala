...
trait PlotIkhConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotIkhConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotIkhConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotIkhConnectorsEndMarkerOptions]
  }
}
