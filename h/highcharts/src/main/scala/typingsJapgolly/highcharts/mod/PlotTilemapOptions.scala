...
trait PlotTilemapOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotTilemapDataLabelsOptions | js.Array[PlotTilemapDataLabelsOptions]] = js.undefined
...
object PlotTilemapOptions {
  ...
  inline def apply(): PlotTilemapOptions = {
  ...
  extension [Self <: PlotTilemapOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotTilemapAnimationOptions): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotTilemapDataLabelsOptions | js.Array[PlotTilemapDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    ...
    inline def setTileShape(value: TilemapShapeValue): Self = StObject.set(x, "tileShape", value.asInstanceOf[js.Any])
    
    inline def setTileShapeUndefined: Self = StObject.set(x, "tileShape", js.undefined)
