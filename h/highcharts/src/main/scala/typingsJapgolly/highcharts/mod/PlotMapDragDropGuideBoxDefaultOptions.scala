...
trait PlotMapDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotMapDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotMapDragDropGuideBoxDefaultOptions]
  }
}
