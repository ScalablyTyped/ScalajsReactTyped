...
import typingsJapgolly.highcharts.anon.ReadonlySVGAttributes
import typingsJapgolly.highcharts.highchartsStrings._empty
...
open class Point () extends StObject {
  ...
  var dataGroup: (js.UndefOr[
    typingsJapgolly.highcharts.modulesDatagroupingMod.highchartsAugmentingMod.DataGroupingInfoObject
  ]) & (js.UndefOr[
    typingsJapgolly.highcharts.modulesStockMod.highchartsAugmentingMod.DataGroupingInfoObject
  ]) = js.native
  ...
  /**
    ...
    */
  def sonify(
    options: typingsJapgolly.highcharts.modulesSonificationMod.highchartsAugmentingMod.PointSonifyOptionsObject
  ): Unit = js.native
