...
trait PlotLinearregressionMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressionMarkerStatesOptions] = js.undefined
  /**
...
object PlotLinearregressionMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotLinearregressionMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotLinearregressionMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionMarkerOptions]
  }
}
