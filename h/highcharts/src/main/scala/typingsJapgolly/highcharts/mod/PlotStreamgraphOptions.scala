...
trait PlotStreamgraphOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotStreamgraphDataLabelsOptions | js.Array[PlotStreamgraphDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotStreamgraphDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotStreamgraphOnPointOptions] = js.undefined
...
object PlotStreamgraphOptions {
  ...
  inline def apply(): PlotStreamgraphOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphOptions]
  }
  
  extension [Self <: PlotStreamgraphOptions](x: Self) {
    ...
    inline def setDataLabels(value: PlotStreamgraphDataLabelsOptions | js.Array[PlotStreamgraphDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotStreamgraphDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotStreamgraphDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotStreamgraphOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
