...
trait SeriesVariablepieDataOptions extends js.Object {
  var accessibility: js.UndefOr[SeriesVariablepieDataAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[SeriesVariablepieDataDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[SeriesVariablepieDataEventsOptions] = js.undefined
  /**
...
object SeriesVariablepieDataOptions {
  @scala.inline
  def apply(
    accessibility: SeriesVariablepieDataAccessibilityOptions = null,
    ...
    events: SeriesVariablepieDataEventsOptions = null,
    id: String = null,
    ...
    __obj.asInstanceOf[SeriesVariablepieDataOptions]
  }
}
