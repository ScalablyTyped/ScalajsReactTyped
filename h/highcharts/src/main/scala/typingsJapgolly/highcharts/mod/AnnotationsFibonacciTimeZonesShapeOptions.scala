...
trait AnnotationsFibonacciTimeZonesShapeOptions extends StObject {
...
object AnnotationsFibonacciTimeZonesShapeOptions {
  ...
  inline def apply(): AnnotationsFibonacciTimeZonesShapeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsFibonacciTimeZonesShapeOptions]
  }
  
  extension [Self <: AnnotationsFibonacciTimeZonesShapeOptions](x: Self) {
