...
trait PlotPpoMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPpoMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPpoMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPpoMarkerStatesSelectOptions]
  }
}
