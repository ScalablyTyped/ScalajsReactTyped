...
trait PlotMappointMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMappointMarkerStatesOptions] = js.undefined
  /**
...
object PlotMappointMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMappointMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMappointMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMappointMarkerOptions]
  }
}
