...
trait NavigationAnnotationsFibonacciTimeZonesLabelOptions extends StObject {
...
object NavigationAnnotationsFibonacciTimeZonesLabelOptions {
  
  inline def apply(): NavigationAnnotationsFibonacciTimeZonesLabelOptions = {
