...
trait PlotGaugeOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotGaugeAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var dataLabels: js.UndefOr[PlotGaugeDataLabelsOptions | js.Array[PlotGaugeDataLabelsOptions]] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotGaugeOnPointOptions] = js.undefined
...
object PlotGaugeOptions {
  ...
  inline def apply(): PlotGaugeOptions = {
  ...
  extension [Self <: PlotGaugeOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotGaugeAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotGaugeDataLabelsOptions | js.Array[PlotGaugeDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotGaugeDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDescription(value: String): Self = StObject.set(x, "description", value.asInstanceOf[js.Any])
    
    inline def setDescriptionUndefined: Self = StObject.set(x, "description", js.undefined)
    
    inline def setDial(value: PlotGaugeDialOptions): Self = StObject.set(x, "dial", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotGaugeOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setOvershoot(value: Double): Self = StObject.set(x, "overshoot", value.asInstanceOf[js.Any])
    
    inline def setOvershootUndefined: Self = StObject.set(x, "overshoot", js.undefined)
    
    inline def setPivot(value: PlotGaugePivotOptions): Self = StObject.set(x, "pivot", value.asInstanceOf[js.Any])
