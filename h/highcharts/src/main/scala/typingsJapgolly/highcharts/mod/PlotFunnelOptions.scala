...
trait PlotFunnelOptions extends StObject {
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotFunnelOnPointOptions] = js.undefined
...
object PlotFunnelOptions {
  ...
  inline def apply(): PlotFunnelOptions = {
  ...
  extension [Self <: PlotFunnelOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotFunnelAnimationOptions): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: SeriesPieDataLabelsOptionsObject | js.Array[SeriesPieDataLabelsOptionsObject]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    ...
    inline def setNeckHeight(value: Double | String): Self = StObject.set(x, "neckHeight", value.asInstanceOf[js.Any])
    
    inline def setNeckHeightUndefined: Self = StObject.set(x, "neckHeight", js.undefined)
    
    inline def setNeckWidth(value: Double | String): Self = StObject.set(x, "neckWidth", value.asInstanceOf[js.Any])
    
    inline def setNeckWidthUndefined: Self = StObject.set(x, "neckWidth", js.undefined)
    
    inline def setOnPoint(value: js.Object | PlotFunnelOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
