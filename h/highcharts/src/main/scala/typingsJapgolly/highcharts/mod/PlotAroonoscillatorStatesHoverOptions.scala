...
trait PlotAroonoscillatorStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAroonoscillatorStatesHoverAnimationOptions
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAroonoscillatorStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotAroonoscillatorStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAroonoscillatorStatesHoverAnimationOptions = null,
  ...
  ): PlotAroonoscillatorStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorStatesHoverOptions]
  }
}
