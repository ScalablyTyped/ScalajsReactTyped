...
import typingsJapgolly.highcharts.highchartsStrings.aroonoscillator
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesAroonoscillatorOptions
  extends StObject
...
object SeriesAroonoscillatorOptions {
  ...
  extension [Self <: SeriesAroonoscillatorOptions](x: Self) {
    ...
    inline def setType(value: String | aroonoscillator): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
