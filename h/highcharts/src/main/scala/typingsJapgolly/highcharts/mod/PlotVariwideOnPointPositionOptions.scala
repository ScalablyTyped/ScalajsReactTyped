...
trait PlotVariwideOnPointPositionOptions extends StObject {
...
object PlotVariwideOnPointPositionOptions {
  
  inline def apply(): PlotVariwideOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideOnPointPositionOptions]
  }
  
  extension [Self <: PlotVariwideOnPointPositionOptions](x: Self) {
