...
trait PlotMappointDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotMappointDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMappointDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotMappointDragDropGuideBoxDefaultOptions]
  }
}
