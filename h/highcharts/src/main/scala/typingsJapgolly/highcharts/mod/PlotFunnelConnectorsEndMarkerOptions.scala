...
trait PlotFunnelConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotFunnelConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotFunnelConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotFunnelConnectorsEndMarkerOptions]
  }
}
