...
trait PlotLinearregressionParamsOptions extends StObject {
...
object PlotLinearregressionParamsOptions {
  ...
  inline def apply(): PlotLinearregressionParamsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionParamsOptions]
  }
  
  extension [Self <: PlotLinearregressionParamsOptions](x: Self) {
