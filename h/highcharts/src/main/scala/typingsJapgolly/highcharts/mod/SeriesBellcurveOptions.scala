...
import typingsJapgolly.highcharts.highchartsStrings.bellcurve
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesBellcurveOptions
  extends StObject
     with PlotBellcurveOptions {
...
object SeriesBellcurveOptions {
  ...
  inline def apply(data: Unit, dataParser: Unit, dataURL: Unit, `type`: String | bellcurve): SeriesBellcurveOptions = {
  ...
  extension [Self <: SeriesBellcurveOptions](x: Self) {
    ...
    inline def setType(value: String | bellcurve): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
