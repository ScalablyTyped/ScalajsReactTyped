...
trait PlotLinearregressionslopeZonesOptions extends js.Object {
  /**
...
object PlotLinearregressionslopeZonesOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopeZonesOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeZonesOptions]
  }
}
