...
trait PlotAroonoscillatorMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAroonoscillatorMarkerStatesOptions] = js.undefined
  /**
...
object PlotAroonoscillatorMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAroonoscillatorMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAroonoscillatorMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorMarkerOptions]
  }
}
