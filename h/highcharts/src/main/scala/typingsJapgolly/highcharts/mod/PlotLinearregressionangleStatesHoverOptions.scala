...
trait PlotLinearregressionangleStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressionangleStatesHoverAnimationOptions
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLinearregressionangleStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotLinearregressionangleStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressionangleStatesHoverAnimationOptions = null,
  ...
  ): PlotLinearregressionangleStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleStatesHoverOptions]
  }
}
