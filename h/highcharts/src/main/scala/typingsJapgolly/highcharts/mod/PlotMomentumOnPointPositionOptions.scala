...
trait PlotMomentumOnPointPositionOptions extends StObject {
...
object PlotMomentumOnPointPositionOptions {
  
  inline def apply(): PlotMomentumOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumOnPointPositionOptions]
  }
  
  extension [Self <: PlotMomentumOnPointPositionOptions](x: Self) {
