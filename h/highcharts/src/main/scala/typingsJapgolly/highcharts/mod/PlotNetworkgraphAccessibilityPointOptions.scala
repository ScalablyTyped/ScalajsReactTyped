...
trait PlotNetworkgraphAccessibilityPointOptions extends StObject {
...
object PlotNetworkgraphAccessibilityPointOptions {
  
  inline def apply(): PlotNetworkgraphAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphAccessibilityPointOptions]
  }
  
  extension [Self <: PlotNetworkgraphAccessibilityPointOptions](x: Self) {
