...
trait PlotRsiAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotRsiAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotRsiAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotRsiAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotRsiAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotRsiAccessibilityOptions]
  }
}
