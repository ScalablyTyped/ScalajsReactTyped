...
trait PlotLinearregressionangleMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLinearregressionangleMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionangleMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleMarkerStatesSelectOptions]
  }
}
