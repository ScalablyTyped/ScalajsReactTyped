...
trait PlotEmaAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotEmaAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotEmaAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotEmaAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotEmaAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotEmaAccessibilityOptions]
  }
}
