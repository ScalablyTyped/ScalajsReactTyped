...
trait PlotPivotpointsZonesOptions extends js.Object {
  /**
...
object PlotPivotpointsZonesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPivotpointsZonesOptions]
  }
}
