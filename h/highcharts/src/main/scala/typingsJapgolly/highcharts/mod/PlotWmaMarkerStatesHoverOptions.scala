...
trait PlotWmaMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotWmaMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWmaMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotWmaMarkerStatesHoverOptions]
  }
}
