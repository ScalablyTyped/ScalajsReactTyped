...
trait PlotPyramid3dDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotPyramid3dDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotPyramid3dDataLabelsOptions {
  ...
  inline def apply(): PlotPyramid3dDataLabelsOptions = {
  ...
  extension [Self <: PlotPyramid3dDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotPyramid3dDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
