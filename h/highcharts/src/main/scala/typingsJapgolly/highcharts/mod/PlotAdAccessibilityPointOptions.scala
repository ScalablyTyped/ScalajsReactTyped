...
trait PlotAdAccessibilityPointOptions extends StObject {
...
object PlotAdAccessibilityPointOptions {
  
  inline def apply(): PlotAdAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdAccessibilityPointOptions]
  }
  
  extension [Self <: PlotAdAccessibilityPointOptions](x: Self) {
