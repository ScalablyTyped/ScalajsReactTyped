...
trait PlotAreaOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotAreaAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotAreaDataLabelsOptions | js.Array[PlotAreaDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotAreaDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotAreaOnPointOptions] = js.undefined
...
object PlotAreaOptions {
  ...
  inline def apply(): PlotAreaOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaOptions]
  }
  
  extension [Self <: PlotAreaOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotAreaAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotAreaDataLabelsOptions | js.Array[PlotAreaDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotAreaDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotAreaDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotAreaOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
