...
trait PlotErrorbarConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotErrorbarConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotErrorbarConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotErrorbarConnectorsMarkerOptions]
  }
}
