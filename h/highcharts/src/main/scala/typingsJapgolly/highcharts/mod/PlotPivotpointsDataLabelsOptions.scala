...
trait PlotPivotpointsDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotPivotpointsDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotPivotpointsDataLabelsOptions {
  ...
  inline def apply(): PlotPivotpointsDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsDataLabelsOptions]
  }
  
  extension [Self <: PlotPivotpointsDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotPivotpointsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
