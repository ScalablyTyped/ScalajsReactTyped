...
trait PlotVariablepieConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotVariablepieConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotVariablepieConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotVariablepieConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotVariablepieConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotVariablepieConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotVariablepieConnectorsMarkerOptions = null,
    startMarker: PlotVariablepieConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotVariablepieConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotVariablepieConnectorsOptions]
  }
}
