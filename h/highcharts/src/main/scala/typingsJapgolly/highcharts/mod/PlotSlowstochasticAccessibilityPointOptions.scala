...
trait PlotSlowstochasticAccessibilityPointOptions extends StObject {
...
object PlotSlowstochasticAccessibilityPointOptions {
  
  inline def apply(): PlotSlowstochasticAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticAccessibilityPointOptions]
  }
  
  extension [Self <: PlotSlowstochasticAccessibilityPointOptions](x: Self) {
