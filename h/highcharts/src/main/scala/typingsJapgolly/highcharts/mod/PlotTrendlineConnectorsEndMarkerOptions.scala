...
trait PlotTrendlineConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotTrendlineConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrendlineConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlineConnectorsEndMarkerOptions]
  }
}
