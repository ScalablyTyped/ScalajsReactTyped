...
trait PlotVariwideDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotVariwideDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotVariwideDataLabelsOptions {
  
  inline def apply(): PlotVariwideDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideDataLabelsOptions]
  }
  
  extension [Self <: PlotVariwideDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotVariwideDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
