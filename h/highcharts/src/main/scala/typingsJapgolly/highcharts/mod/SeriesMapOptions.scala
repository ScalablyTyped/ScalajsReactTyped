...
import typingsJapgolly.highcharts.highchartsStrings.map_
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesMapOptions
  extends StObject
     with PlotMapOptions {
...
object SeriesMapOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | map_): SeriesMapOptions = {
  ...
  extension [Self <: SeriesMapOptions](x: Self) {
    ...
    inline def setDataVarargs(value: (Double | (js.Tuple2[String, Double | Null]) | Null | SeriesMapDataOptions)*): Self = StObject.set(x, "data", js.Array(value*))
    ...
    inline def setType(value: String | map_): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
