...
trait SonifyChartOptionsObject extends js.Object {
  ...
  var order: String | (js.Array[
    String | typingsJapgolly.highcharts.sonificationMod.highchartsAugmentingMod.Earcon | (js.Array[
      String | typingsJapgolly.highcharts.sonificationMod.highchartsAugmentingMod.Earcon
    ])
  ])
  /**
