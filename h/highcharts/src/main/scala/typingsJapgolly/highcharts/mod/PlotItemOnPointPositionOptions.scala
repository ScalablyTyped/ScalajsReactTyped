...
trait PlotItemOnPointPositionOptions extends StObject {
...
object PlotItemOnPointPositionOptions {
  
  inline def apply(): PlotItemOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemOnPointPositionOptions]
  }
  
  extension [Self <: PlotItemOnPointPositionOptions](x: Self) {
