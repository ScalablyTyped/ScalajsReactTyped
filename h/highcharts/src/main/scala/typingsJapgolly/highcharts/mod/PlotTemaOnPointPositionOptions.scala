...
trait PlotTemaOnPointPositionOptions extends StObject {
...
object PlotTemaOnPointPositionOptions {
  
  inline def apply(): PlotTemaOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaOnPointPositionOptions]
  }
  
  extension [Self <: PlotTemaOnPointPositionOptions](x: Self) {
