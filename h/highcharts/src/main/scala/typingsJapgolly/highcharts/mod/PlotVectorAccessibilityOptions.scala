...
trait PlotVectorAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotVectorAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotVectorAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotVectorAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotVectorAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotVectorAccessibilityOptions]
  }
}
