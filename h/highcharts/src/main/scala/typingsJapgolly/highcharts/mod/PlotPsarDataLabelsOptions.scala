...
trait PlotPsarDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotPsarDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotPsarDataLabelsOptions {
  ...
  inline def apply(): PlotPsarDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarDataLabelsOptions]
  }
  
  extension [Self <: PlotPsarDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotPsarDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
