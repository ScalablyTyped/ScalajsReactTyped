...
object AccessibilityScreenReaderSectionOptions {
  ...
  extension [Self <: AccessibilityScreenReaderSectionOptions](x: Self) {
    ...
    inline def setOnPlayAsSoundClick(value: /* evt */ MouseEvent => Callback): Self = StObject.set(x, "onPlayAsSoundClick", js.Any.fromFunction1((t0: /* evt */ MouseEvent) => value(t0).runNow()))
    
    inline def setOnPlayAsSoundClickUndefined: Self = StObject.set(x, "onPlayAsSoundClick", js.undefined)
    
    inline def setOnViewDataTableClick(value: /* evt */ MouseEvent => Callback): Self = StObject.set(x, "onViewDataTableClick", js.Any.fromFunction1((t0: /* evt */ MouseEvent) => value(t0).runNow()))
