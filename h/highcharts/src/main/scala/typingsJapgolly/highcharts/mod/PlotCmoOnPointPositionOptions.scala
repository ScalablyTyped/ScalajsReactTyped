...
trait PlotCmoOnPointPositionOptions extends StObject {
...
object PlotCmoOnPointPositionOptions {
  
  inline def apply(): PlotCmoOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoOnPointPositionOptions]
  }
  
  extension [Self <: PlotCmoOnPointPositionOptions](x: Self) {
