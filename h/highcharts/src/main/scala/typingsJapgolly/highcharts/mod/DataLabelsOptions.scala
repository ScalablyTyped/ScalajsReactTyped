...
trait DataLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 52, starting with scala.Boolean, typingsJapgolly.highcharts.mod.SeriesAreaDataDataLabelsAnimationOptions, typingsJapgolly.highcharts.mod.SeriesArearangeDataDataLabelsAnimationOptions */ Any
  ] = js.undefined
...
object DataLabelsOptions {
  ...
  inline def apply(): DataLabelsOptions = {
  ...
  extension [Self <: DataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 52, starting with scala.Boolean, typingsJapgolly.highcharts.mod.SeriesAreaDataDataLabelsAnimationOptions, typingsJapgolly.highcharts.mod.SeriesArearangeDataDataLabelsAnimationOptions */ Any
    ...
    inline def setXHigh(value: Double): Self = StObject.set(x, "xHigh", value.asInstanceOf[js.Any])
    
    inline def setXHighUndefined: Self = StObject.set(x, "xHigh", js.undefined)
    
    inline def setXLow(value: Double): Self = StObject.set(x, "xLow", value.asInstanceOf[js.Any])
    
    inline def setXLowUndefined: Self = StObject.set(x, "xLow", js.undefined)
    
    inline def setXUndefined: Self = StObject.set(x, "x", js.undefined)
    
    inline def setY(value: Double): Self = StObject.set(x, "y", value.asInstanceOf[js.Any])
    
    inline def setYHigh(value: Double): Self = StObject.set(x, "yHigh", value.asInstanceOf[js.Any])
    
    inline def setYHighUndefined: Self = StObject.set(x, "yHigh", js.undefined)
    
    inline def setYLow(value: Double): Self = StObject.set(x, "yLow", value.asInstanceOf[js.Any])
    
    inline def setYLowUndefined: Self = StObject.set(x, "yLow", js.undefined)
