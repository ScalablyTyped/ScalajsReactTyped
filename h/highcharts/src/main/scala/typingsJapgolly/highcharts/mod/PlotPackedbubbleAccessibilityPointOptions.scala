...
trait PlotPackedbubbleAccessibilityPointOptions extends StObject {
...
object PlotPackedbubbleAccessibilityPointOptions {
  
  inline def apply(): PlotPackedbubbleAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleAccessibilityPointOptions]
  }
  
  extension [Self <: PlotPackedbubbleAccessibilityPointOptions](x: Self) {
