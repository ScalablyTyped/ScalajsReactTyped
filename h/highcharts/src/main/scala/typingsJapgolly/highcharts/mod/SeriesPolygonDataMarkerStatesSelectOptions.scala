...
trait SeriesPolygonDataMarkerStatesSelectOptions extends js.Object {
  /**
...
object SeriesPolygonDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesPolygonDataMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[SeriesPolygonDataMarkerStatesSelectOptions]
  }
}
