...
trait SeriesScatterDataDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesScatterDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesScatterDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesScatterDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesScatterDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesScatterDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesScatterDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesScatterDataDragDropOptions]
  }
}
