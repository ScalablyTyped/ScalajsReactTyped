...
trait PlotSupertrendMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotSupertrendMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSupertrendMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendMarkerStatesHoverOptions]
  }
}
