...
import typingsJapgolly.highcharts.highchartsStrings.pyramid
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, treemap, `type`, xAxis, yAxis */ trait SeriesPyramidOptions
  extends PlotPyramidOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[Double | Null | SeriesPyramidDataOptions]] = js.undefined
  /**
    * Not available
    */
