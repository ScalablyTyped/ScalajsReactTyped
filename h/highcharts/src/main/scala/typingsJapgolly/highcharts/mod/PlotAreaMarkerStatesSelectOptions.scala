...
trait PlotAreaMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAreaMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreaMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAreaMarkerStatesSelectOptions]
  }
}
