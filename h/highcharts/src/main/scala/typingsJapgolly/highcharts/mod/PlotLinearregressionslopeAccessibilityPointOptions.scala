...
trait PlotLinearregressionslopeAccessibilityPointOptions extends StObject {
...
object PlotLinearregressionslopeAccessibilityPointOptions {
  
  inline def apply(): PlotLinearregressionslopeAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeAccessibilityPointOptions]
  }
  
  extension [Self <: PlotLinearregressionslopeAccessibilityPointOptions](x: Self) {
