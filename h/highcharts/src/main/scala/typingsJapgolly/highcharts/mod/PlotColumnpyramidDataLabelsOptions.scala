...
trait PlotColumnpyramidDataLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | PlotColumnpyramidDataLabelsAnimationOptions | PartialAnimationOptionsOb
  ] = js.undefined
...
object PlotColumnpyramidDataLabelsOptions {
  
  inline def apply(): PlotColumnpyramidDataLabelsOptions = {
  ...
  extension [Self <: PlotColumnpyramidDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotColumnpyramidDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
