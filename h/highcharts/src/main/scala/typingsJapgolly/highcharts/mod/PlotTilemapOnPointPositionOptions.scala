...
trait PlotTilemapOnPointPositionOptions extends StObject {
...
object PlotTilemapOnPointPositionOptions {
  
  inline def apply(): PlotTilemapOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapOnPointPositionOptions]
  }
  
  extension [Self <: PlotTilemapOnPointPositionOptions](x: Self) {
