...
trait PlotVariwideConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotVariwideConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotVariwideConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotVariwideConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotVariwideConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotVariwideConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotVariwideConnectorsMarkerOptions = null,
    startMarker: PlotVariwideConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotVariwideConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotVariwideConnectorsOptions]
  }
}
