...
trait PlotPolygonAccessibilityPointOptions extends StObject {
...
object PlotPolygonAccessibilityPointOptions {
  
  inline def apply(): PlotPolygonAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonAccessibilityPointOptions]
  }
  
  extension [Self <: PlotPolygonAccessibilityPointOptions](x: Self) {
