...
trait NavigationAnnotationsTimeCyclesShapeOptions extends StObject {
...
object NavigationAnnotationsTimeCyclesShapeOptions {
  
  inline def apply(): NavigationAnnotationsTimeCyclesShapeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigationAnnotationsTimeCyclesShapeOptions]
  }
  
  extension [Self <: NavigationAnnotationsTimeCyclesShapeOptions](x: Self) {
