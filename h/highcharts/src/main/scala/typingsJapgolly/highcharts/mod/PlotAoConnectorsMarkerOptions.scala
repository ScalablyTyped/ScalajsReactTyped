...
trait PlotAoConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotAoConnectorsMarkerOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotAoConnectorsMarkerOptions]
  }
}
