...
trait SeriesColumnrangeDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesColumnrangeDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesColumnrangeDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesColumnrangeDataDragDropDragHandleOptions]
  }
}
