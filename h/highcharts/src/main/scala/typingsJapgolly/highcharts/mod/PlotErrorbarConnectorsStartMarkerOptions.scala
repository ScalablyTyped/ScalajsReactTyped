...
trait PlotErrorbarConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotErrorbarConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotErrorbarConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotErrorbarConnectorsStartMarkerOptions]
  }
}
