...
trait AnnotationsFibonacciTimeZonesLabelOptions extends StObject {
...
object AnnotationsFibonacciTimeZonesLabelOptions {
  ...
  inline def apply(): AnnotationsFibonacciTimeZonesLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsFibonacciTimeZonesLabelOptions]
  }
  
  extension [Self <: AnnotationsFibonacciTimeZonesLabelOptions](x: Self) {
