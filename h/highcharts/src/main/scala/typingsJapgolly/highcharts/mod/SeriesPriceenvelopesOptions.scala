...
import typingsJapgolly.highcharts.highchartsStrings.priceenvelopes
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesPriceenvelopesOptions
  extends StObject
     with PlotPriceenvelopesOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | priceenvelopes
...
object SeriesPriceenvelopesOptions {
  
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | priceenvelopes): SeriesPriceenvelopesOptions = {
    val __obj = js.Dynamic.literal(dataParser = dataParser.asInstanceOf[js.Any], dataURL = dataURL.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesPriceenvelopesOptions]
  }
  
  extension [Self <: SeriesPriceenvelopesOptions](x: Self) {
    ...
    inline def setType(value: String | priceenvelopes): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
