...
trait PlotColumnrangeOnPointPositionOptions extends StObject {
...
object PlotColumnrangeOnPointPositionOptions {
  
  inline def apply(): PlotColumnrangeOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeOnPointPositionOptions]
  }
  
  extension [Self <: PlotColumnrangeOnPointPositionOptions](x: Self) {
