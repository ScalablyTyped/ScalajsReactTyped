...
trait PlotGaugeConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotGaugeConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotGaugeConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotGaugeConnectorsMarkerOptions]
  }
}
