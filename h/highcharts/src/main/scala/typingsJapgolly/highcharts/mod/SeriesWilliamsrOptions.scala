...
import typingsJapgolly.highcharts.highchartsStrings.williamsr
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesWilliamsrOptions
  extends StObject
     with PlotWilliamsrOptions {
...
object SeriesWilliamsrOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | williamsr): SeriesWilliamsrOptions = {
  ...
  extension [Self <: SeriesWilliamsrOptions](x: Self) {
    ...
    inline def setType(value: String | williamsr): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
