...
import typingsJapgolly.highcharts.highchartsStrings.bb
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesBbOptions
  extends StObject
     with PlotBbOptions {
...
object SeriesBbOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | bb): SeriesBbOptions = {
  ...
  extension [Self <: SeriesBbOptions](x: Self) {
    ...
    inline def setType(value: String | bb): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
