...
trait PlotAdOnPointPositionOptions extends StObject {
...
object PlotAdOnPointPositionOptions {
  
  inline def apply(): PlotAdOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdOnPointPositionOptions]
  }
  
  extension [Self <: PlotAdOnPointPositionOptions](x: Self) {
