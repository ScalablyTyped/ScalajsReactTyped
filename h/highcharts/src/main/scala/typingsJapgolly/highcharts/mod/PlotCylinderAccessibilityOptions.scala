...
trait PlotCylinderAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotCylinderAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotCylinderAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotCylinderAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotCylinderAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotCylinderAccessibilityOptions]
  }
}
