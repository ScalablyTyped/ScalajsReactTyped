...
trait PlotSolidgaugeConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotSolidgaugeConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSolidgaugeConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSolidgaugeConnectorsMarkerOptions]
  }
}
