...
trait PlotPriceenvelopesMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotPriceenvelopesMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPriceenvelopesMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesMarkerStatesHoverOptions]
  }
}
