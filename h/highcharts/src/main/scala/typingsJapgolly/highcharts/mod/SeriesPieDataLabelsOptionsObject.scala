...
object SeriesPieDataLabelsOptionsObject {
  ...
  inline def apply(): SeriesPieDataLabelsOptionsObject = {
  ...
  extension [Self <: SeriesPieDataLabelsOptionsObject](x: Self) {
    ...
    inline def setVerticalAlign(value: String | VerticalAlignValue): Self = StObject.set(x, "verticalAlign", value.asInstanceOf[js.Any])
