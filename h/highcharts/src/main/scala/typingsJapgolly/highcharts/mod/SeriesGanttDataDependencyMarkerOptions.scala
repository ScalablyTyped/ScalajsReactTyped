...
trait SeriesGanttDataDependencyMarkerOptions extends js.Object {
  /**
...
object SeriesGanttDataDependencyMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesGanttDataDependencyMarkerOptions = {
    ...
    __obj.asInstanceOf[SeriesGanttDataDependencyMarkerOptions]
  }
}
