...
trait PlotGaugeOnPointPositionOptions extends StObject {
...
object PlotGaugeOnPointPositionOptions {
  
  inline def apply(): PlotGaugeOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeOnPointPositionOptions]
  }
  
  extension [Self <: PlotGaugeOnPointPositionOptions](x: Self) {
