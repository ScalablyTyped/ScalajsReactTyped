...
trait PlotCylinderConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotCylinderConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCylinderConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotCylinderConnectorsMarkerOptions]
  }
}
