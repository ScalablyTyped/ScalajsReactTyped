...
trait PlotPieOnPointPositionOptions extends StObject {
...
object PlotPieOnPointPositionOptions {
  
  inline def apply(): PlotPieOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieOnPointPositionOptions]
  }
  
  extension [Self <: PlotPieOnPointPositionOptions](x: Self) {
