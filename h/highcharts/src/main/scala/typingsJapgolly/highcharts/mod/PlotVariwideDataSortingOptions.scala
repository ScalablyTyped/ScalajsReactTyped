...
trait PlotVariwideDataSortingOptions extends StObject {
...
object PlotVariwideDataSortingOptions {
  ...
  inline def apply(): PlotVariwideDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideDataSortingOptions]
  }
  
  extension [Self <: PlotVariwideDataSortingOptions](x: Self) {
