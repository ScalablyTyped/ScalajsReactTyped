...
trait PlotDisparityindexAccessibilityPointOptions extends StObject {
...
object PlotDisparityindexAccessibilityPointOptions {
  
  inline def apply(): PlotDisparityindexAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexAccessibilityPointOptions]
  }
  
  extension [Self <: PlotDisparityindexAccessibilityPointOptions](x: Self) {
