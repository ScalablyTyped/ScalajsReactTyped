...
trait PlotAdDataGroupingOptions extends js.Object {
  /**
...
object PlotAdDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotAdDataGroupingOptions]
  }
}
