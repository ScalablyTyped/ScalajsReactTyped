...
object PlotSunburstOptions {
  ...
  inline def apply(): PlotSunburstOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstOptions]
  }
  
  extension [Self <: PlotSunburstOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotSunburstAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setLevelSize(value: PlotSunburstLevelSizeOptions): Self = StObject.set(x, "levelSize", value.asInstanceOf[js.Any])
    
    inline def setLevelSizeUndefined: Self = StObject.set(x, "levelSize", js.undefined)
    
    inline def setLevels(value: js.Array[PlotSunburstLevelsOptions]): Self = StObject.set(x, "levels", value.asInstanceOf[js.Any])
