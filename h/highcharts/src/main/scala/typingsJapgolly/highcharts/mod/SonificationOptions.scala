...
trait SonificationOptions extends StObject {
  ...
  var order: String | (js.Array[
    String | typingsJapgolly.highcharts.modulesSonificationMod.highchartsAugmentingMod.Earcon | (js.Array[
      String | typingsJapgolly.highcharts.modulesSonificationMod.highchartsAugmentingMod.Earcon
    ])
  ])
...
object SonificationOptions {
  ...
  extension [Self <: SonificationOptions](x: Self) {
    ...
    inline def setOrderVarargs(
      value: (String | typingsJapgolly.highcharts.modulesSonificationMod.highchartsAugmentingMod.Earcon | (js.Array[
          String | typingsJapgolly.highcharts.modulesSonificationMod.highchartsAugmentingMod.Earcon
        ]))*
