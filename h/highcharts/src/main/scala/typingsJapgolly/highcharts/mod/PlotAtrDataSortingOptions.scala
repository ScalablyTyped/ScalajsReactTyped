...
trait PlotAtrDataSortingOptions extends StObject {
...
object PlotAtrDataSortingOptions {
  
  inline def apply(): PlotAtrDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrDataSortingOptions]
  }
  
  extension [Self <: PlotAtrDataSortingOptions](x: Self) {
