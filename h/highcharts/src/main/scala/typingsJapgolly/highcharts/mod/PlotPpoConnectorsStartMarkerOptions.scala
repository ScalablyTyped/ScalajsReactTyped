...
trait PlotPpoConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotPpoConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPpoConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPpoConnectorsStartMarkerOptions]
  }
}
