...
trait PlotPyramidConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotPyramidConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPyramidConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPyramidConnectorsStartMarkerOptions]
  }
}
