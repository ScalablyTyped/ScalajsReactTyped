...
trait PlotMomentumOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotMomentumAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotMomentumDataLabelsOptions | js.Array[PlotMomentumDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotMomentumDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotMomentumOnPointOptions] = js.undefined
...
object PlotMomentumOptions {
  ...
  inline def apply(): PlotMomentumOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumOptions]
  }
  
  extension [Self <: PlotMomentumOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotMomentumAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotMomentumDataLabelsOptions | js.Array[PlotMomentumDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotMomentumDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotMomentumDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotMomentumOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotMomentumParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
