...
trait PlotEmaDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotEmaDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotEmaDataLabelsOptions {
  ...
  inline def apply(): PlotEmaDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaDataLabelsOptions]
  }
  
  extension [Self <: PlotEmaDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotEmaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
