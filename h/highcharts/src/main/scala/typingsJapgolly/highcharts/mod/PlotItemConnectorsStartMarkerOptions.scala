...
trait PlotItemConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotItemConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotItemConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotItemConnectorsStartMarkerOptions]
  }
}
