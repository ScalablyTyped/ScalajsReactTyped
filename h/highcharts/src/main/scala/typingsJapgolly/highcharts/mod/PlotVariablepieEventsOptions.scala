...
trait PlotVariablepieEventsOptions extends js.Object {
  /**
...
object PlotVariablepieEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotVariablepieEventsOptions]
  }
}
