...
trait PlotPriceenvelopesPointEventsOptions extends js.Object {
  /**
...
object PlotPriceenvelopesPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPriceenvelopesPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesPointEventsOptions]
  }
}
