...
trait PlotPieOptions extends StObject {
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotPieOnPointOptions] = js.undefined
...
object PlotPieOptions {
  ...
  inline def apply(): PlotPieOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieOptions]
  }
  
  extension [Self <: PlotPieOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotPieAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setCenter(value: js.Tuple2[Double | String | Null, Double | String | Null]): Self = StObject.set(x, "center", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotPieOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
