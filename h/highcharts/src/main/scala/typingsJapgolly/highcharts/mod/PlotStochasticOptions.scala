...
trait PlotStochasticOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotStochasticAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotStochasticDataLabelsOptions | js.Array[PlotStochasticDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotStochasticDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotStochasticOnPointOptions] = js.undefined
...
object PlotStochasticOptions {
  
  inline def apply(): PlotStochasticOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticOptions]
  }
  
  extension [Self <: PlotStochasticOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotStochasticAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotStochasticDataLabelsOptions | js.Array[PlotStochasticDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotStochasticDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotStochasticDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotStochasticOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotStochasticParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    inline def setSmoothedLine(value: PlotStochasticSmoothedLineOptions): Self = StObject.set(x, "smoothedLine", value.asInstanceOf[js.Any])
