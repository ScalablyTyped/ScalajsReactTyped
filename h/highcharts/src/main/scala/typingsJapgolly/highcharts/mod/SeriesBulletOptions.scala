...
import typingsJapgolly.highcharts.highchartsStrings.bullet
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesBulletOptions
  extends StObject
     with PlotBulletOptions {
...
object SeriesBulletOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | bullet): SeriesBulletOptions = {
  ...
  extension [Self <: SeriesBulletOptions](x: Self) {
    ...
    inline def setType(value: String | bullet): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
