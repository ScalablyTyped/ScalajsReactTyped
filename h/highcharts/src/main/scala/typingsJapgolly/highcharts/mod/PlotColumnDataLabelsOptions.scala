...
trait PlotColumnDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotColumnDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotColumnDataLabelsOptions {
  ...
  inline def apply(): PlotColumnDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnDataLabelsOptions]
  }
  
  extension [Self <: PlotColumnDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotColumnDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
