...
trait PlotPivotpointsMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPivotpointsMarkerStatesOptions] = js.undefined
  /**
...
object PlotPivotpointsMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPivotpointsMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPivotpointsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsMarkerOptions]
  }
}
