...
import typingsJapgolly.highcharts.highchartsStrings.zigzag
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesZigzagOptions
  extends StObject
     with PlotZigzagOptions {
...
object SeriesZigzagOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | zigzag): SeriesZigzagOptions = {
  ...
  extension [Self <: SeriesZigzagOptions](x: Self) {
    ...
    inline def setType(value: String | zigzag): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
