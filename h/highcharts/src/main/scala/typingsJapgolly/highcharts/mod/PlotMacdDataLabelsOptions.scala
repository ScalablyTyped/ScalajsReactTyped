...
trait PlotMacdDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotMacdDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotMacdDataLabelsOptions {
  
  inline def apply(): PlotMacdDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdDataLabelsOptions]
  }
  
  extension [Self <: PlotMacdDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotMacdDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
