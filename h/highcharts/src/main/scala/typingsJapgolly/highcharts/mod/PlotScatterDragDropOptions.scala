...
trait PlotScatterDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotScatterDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotScatterDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotScatterDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotScatterDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotScatterDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[PlotScatterDragDropOptions]
  }
}
