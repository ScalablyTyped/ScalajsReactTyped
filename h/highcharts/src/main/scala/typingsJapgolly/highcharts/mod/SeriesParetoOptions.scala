...
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, treemap, `type`, xAxis, yAxis */ trait SeriesParetoOptions
  extends PlotParetoOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[(js.Array[Double | String]) | SeriesParetoDataOptions]] = js.undefined
  /**
    * Not available
    */
