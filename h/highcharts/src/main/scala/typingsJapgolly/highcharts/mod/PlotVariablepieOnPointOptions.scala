...
trait PlotVariablepieOnPointOptions extends StObject {
  ...
  /**
    ...
    */
  var connectorOptions: js.UndefOr[PlotVariablepieOnPointConnectorOptions | SVGAttributes] = js.undefined
  ...
  /**
    ...
    */
  var position: js.UndefOr[js.Object | PlotVariablepieOnPointPositionOptions] = js.undefined
}
object PlotVariablepieOnPointOptions {
  
  inline def apply(): PlotVariablepieOnPointOptions = {
  ...
  extension [Self <: PlotVariablepieOnPointOptions](x: Self) {
    ...
    inline def setPosition(value: js.Object | PlotVariablepieOnPointPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
