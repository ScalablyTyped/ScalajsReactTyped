...
trait SeriesXrangeDataConnectEndMarkerOptions extends js.Object {
  /**
...
object SeriesXrangeDataConnectEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesXrangeDataConnectEndMarkerOptions = {
    ...
    __obj.asInstanceOf[SeriesXrangeDataConnectEndMarkerOptions]
  }
}
