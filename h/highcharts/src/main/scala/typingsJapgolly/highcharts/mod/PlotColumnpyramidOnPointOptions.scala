...
trait PlotColumnpyramidOnPointOptions extends StObject {
  ...
  /**
    ...
    */
  var connectorOptions: js.UndefOr[PlotColumnpyramidOnPointConnectorOptions | SVGAttributes] = js.undefined
  ...
  /**
    ...
    */
  var position: js.UndefOr[js.Object | PlotColumnpyramidOnPointPositionOptions] = js.undefined
}
object PlotColumnpyramidOnPointOptions {
  
  inline def apply(): PlotColumnpyramidOnPointOptions = {
  ...
  extension [Self <: PlotColumnpyramidOnPointOptions](x: Self) {
    ...
    inline def setPosition(value: js.Object | PlotColumnpyramidOnPointPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
