...
trait PlotAoTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotAoTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotAoTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotAoTooltipDateTimeLabelFormatsOptions]
  }
}
