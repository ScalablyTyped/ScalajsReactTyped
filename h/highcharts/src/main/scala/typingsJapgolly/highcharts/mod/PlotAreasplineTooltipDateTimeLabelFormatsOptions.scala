...
trait PlotAreasplineTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotAreasplineTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotAreasplineTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineTooltipDateTimeLabelFormatsOptions]
  }
}
