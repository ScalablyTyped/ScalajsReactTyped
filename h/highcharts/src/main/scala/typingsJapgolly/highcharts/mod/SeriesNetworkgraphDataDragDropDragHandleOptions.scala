...
trait SeriesNetworkgraphDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesNetworkgraphDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesNetworkgraphDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesNetworkgraphDataDragDropDragHandleOptions]
  }
}
