...
import typingsJapgolly.highcharts.highchartsStrings.mapbubble
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesMapbubbleOptions
  extends StObject
     with PlotMapbubbleOptions {
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[Double | Null | SeriesMapbubbleDataOptions]] = js.undefined
...
object SeriesMapbubbleOptions {
  
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | mapbubble): SeriesMapbubbleOptions = {
  ...
  extension [Self <: SeriesMapbubbleOptions](x: Self) {
    ...
    inline def setDataVarargs(value: (Double | Null | SeriesMapbubbleDataOptions)*): Self = StObject.set(x, "data", js.Array(value*))
    ...
    inline def setType(value: String | mapbubble): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
