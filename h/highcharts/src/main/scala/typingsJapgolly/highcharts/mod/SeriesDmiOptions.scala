...
import typingsJapgolly.highcharts.highchartsStrings.dmi
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesDmiOptions
  extends StObject
     with PlotDmiOptions {
...
object SeriesDmiOptions {
  
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | dmi): SeriesDmiOptions = {
    val __obj = js.Dynamic.literal(dataParser = dataParser.asInstanceOf[js.Any], dataURL = dataURL.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesDmiOptions]
  }
  
  extension [Self <: SeriesDmiOptions](x: Self) {
    ...
    inline def setType(value: String | dmi): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
