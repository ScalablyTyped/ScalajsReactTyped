...
trait PlotMfiAccessibilityPointOptions extends StObject {
...
object PlotMfiAccessibilityPointOptions {
  
  inline def apply(): PlotMfiAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiAccessibilityPointOptions]
  }
  
  extension [Self <: PlotMfiAccessibilityPointOptions](x: Self) {
