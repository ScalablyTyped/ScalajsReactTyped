...
trait SeriesStreamgraphDataDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesStreamgraphDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesStreamgraphDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesStreamgraphDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesStreamgraphDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesStreamgraphDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesStreamgraphDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesStreamgraphDataDragDropOptions]
  }
}
