...
trait PlotMappointMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMappointMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMappointMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMappointMarkerStatesSelectOptions]
  }
}
