...
trait SeriesMapDataGeometryOptions extends StObject {
...
object SeriesMapDataGeometryOptions {
  
  inline def apply(): SeriesMapDataGeometryOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesMapDataGeometryOptions]
  }
  
  extension [Self <: SeriesMapDataGeometryOptions](x: Self) {
