...
trait PlotKeltnerchannelsConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotKeltnerchannelsConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsConnectorsStartMarkerOptions]
  }
}
