...
object PlotSeriesDataLabelsOptions {
  ...
  inline def apply(): PlotSeriesDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesDataLabelsOptions]
  }
  
  extension [Self <: PlotSeriesDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotSeriesDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
