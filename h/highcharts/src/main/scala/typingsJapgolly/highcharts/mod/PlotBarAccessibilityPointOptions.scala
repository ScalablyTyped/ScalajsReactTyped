...
trait PlotBarAccessibilityPointOptions extends StObject {
...
object PlotBarAccessibilityPointOptions {
  
  inline def apply(): PlotBarAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarAccessibilityPointOptions]
  }
  
  extension [Self <: PlotBarAccessibilityPointOptions](x: Self) {
