...
trait SeriesFunnelDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesFunnelDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesFunnelDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesFunnelDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesFunnelDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesFunnelDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[SeriesFunnelDataDragDropOptions]
  }
}
