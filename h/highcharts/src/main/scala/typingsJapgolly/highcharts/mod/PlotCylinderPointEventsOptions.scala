...
trait PlotCylinderPointEventsOptions extends js.Object {
  /**
...
object PlotCylinderPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCylinderPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotCylinderPointEventsOptions]
  }
}
