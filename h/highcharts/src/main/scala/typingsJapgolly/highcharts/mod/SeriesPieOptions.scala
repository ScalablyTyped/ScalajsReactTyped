...
import typingsJapgolly.highcharts.highchartsStrings.pie
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesPieOptions
  extends StObject
     with PlotPieOptions {
  
  /**
    * (Highcharts, Highmaps) An array of data points for the series. For the
    * `pie` series type, points can be given in the following ways:
    *
...
object SeriesPieOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | pie): SeriesPieOptions = {
  ...
  extension [Self <: SeriesPieOptions](x: Self) {
    ...
    inline def setType(value: String | pie): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
