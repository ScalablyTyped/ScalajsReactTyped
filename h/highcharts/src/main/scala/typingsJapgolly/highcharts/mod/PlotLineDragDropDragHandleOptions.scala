...
trait PlotLineDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotLineDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLineDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotLineDragDropDragHandleOptions]
  }
}
