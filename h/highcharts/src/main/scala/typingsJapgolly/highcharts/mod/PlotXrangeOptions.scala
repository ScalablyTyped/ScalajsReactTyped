...
trait PlotXrangeOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotXrangeAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotXrangeOptions {
  ...
  inline def apply(): PlotXrangeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeOptions]
  }
  
  extension [Self <: PlotXrangeOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotXrangeAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotXrangeDataLabelsOptions | js.Array[PlotXrangeDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    ...
    inline def setPartialFill(value: PlotXrangePartialFillOptions): Self = StObject.set(x, "partialFill", value.asInstanceOf[js.Any])
