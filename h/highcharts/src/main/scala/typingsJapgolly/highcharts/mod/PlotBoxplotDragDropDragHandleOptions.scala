...
trait PlotBoxplotDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotBoxplotDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBoxplotDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotBoxplotDragDropDragHandleOptions]
  }
}
