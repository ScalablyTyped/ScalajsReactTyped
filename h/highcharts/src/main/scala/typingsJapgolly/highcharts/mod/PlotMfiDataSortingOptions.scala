...
trait PlotMfiDataSortingOptions extends StObject {
...
object PlotMfiDataSortingOptions {
  
  inline def apply(): PlotMfiDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiDataSortingOptions]
  }
  
  extension [Self <: PlotMfiDataSortingOptions](x: Self) {
