...
trait PlotWmaAccessibilityPointOptions extends StObject {
...
object PlotWmaAccessibilityPointOptions {
  
  inline def apply(): PlotWmaAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaAccessibilityPointOptions]
  }
  
  extension [Self <: PlotWmaAccessibilityPointOptions](x: Self) {
