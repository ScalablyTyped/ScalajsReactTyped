...
trait PlotWordcloudEventsOptions extends js.Object {
  /**
...
object PlotWordcloudEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotWordcloudEventsOptions]
  }
}
