...
trait PlotTrendlineAccessibilityPointOptions extends StObject {
...
object PlotTrendlineAccessibilityPointOptions {
  
  inline def apply(): PlotTrendlineAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineAccessibilityPointOptions]
  }
  
  extension [Self <: PlotTrendlineAccessibilityPointOptions](x: Self) {
