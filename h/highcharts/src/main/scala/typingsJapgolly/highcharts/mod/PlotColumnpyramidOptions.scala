...
trait PlotColumnpyramidOptions extends StObject {
  ...
  var dataLabels: js.UndefOr[
    PlotColumnpyramidDataLabelsOptions | js.Array[PlotColumnpyramidDataLabelsOptions]
  ] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotColumnpyramidOnPointOptions] = js.undefined
...
object PlotColumnpyramidOptions {
  ...
  inline def apply(): PlotColumnpyramidOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidOptions]
  }
  
  extension [Self <: PlotColumnpyramidOptions](x: Self) {
    ...
    inline def setDataLabels(value: PlotColumnpyramidDataLabelsOptions | js.Array[PlotColumnpyramidDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotColumnpyramidDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotColumnpyramidDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
