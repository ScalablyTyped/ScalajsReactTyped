...
trait PlotStochasticZonesOptions extends js.Object {
  /**
...
object PlotStochasticZonesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotStochasticZonesOptions]
  }
}
