...
trait PlotFunnel3dEventsOptions extends js.Object {
  /**
...
object PlotFunnel3dEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotFunnel3dEventsOptions]
  }
}
