...
trait NavigatorXAxisPlotLinesOptions extends StObject {
...
object NavigatorXAxisPlotLinesOptions {
  ...
  inline def apply(): NavigatorXAxisPlotLinesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisPlotLinesOptions]
  }
  
  extension [Self <: NavigatorXAxisPlotLinesOptions](x: Self) {
    ...
    inline def setEvents(value: NavigatorXAxisPlotLinesEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
