...
trait SeriesPackedBubbleDataLabelsOptionsObject extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotPackedbubbleDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var formatter: js.UndefOr[SeriesPackedBubbleDataLabelsFormatterCallbackFunction] = js.undefined
  ...
  /**
    ...
    * inside long words.
    */
  var style: js.UndefOr[CSSObject | PlotPackedbubbleDataLabelsStyleOptions] = js.undefined
...
object SeriesPackedBubbleDataLabelsOptionsObject {
  ...
  inline def apply(): SeriesPackedBubbleDataLabelsOptionsObject = {
  ...
  extension [Self <: SeriesPackedBubbleDataLabelsOptionsObject](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotPackedbubbleDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setFormatter(value: SeriesPackedBubbleDataLabelsFormatterCallbackFunction): Self = StObject.set(x, "formatter", value.asInstanceOf[js.Any])
    ...
    inline def setParentNodeFormat(value: String): Self = StObject.set(x, "parentNodeFormat", value.asInstanceOf[js.Any])
    
    inline def setParentNodeFormatUndefined: Self = StObject.set(x, "parentNodeFormat", js.undefined)
    
    inline def setParentNodeFormatter(value: SeriesPackedBubbleDataLabelsFormatterCallbackFunction): Self = StObject.set(x, "parentNodeFormatter", value.asInstanceOf[js.Any])
    
    inline def setParentNodeFormatterUndefined: Self = StObject.set(x, "parentNodeFormatter", js.undefined)
    
    inline def setParentNodeTextPath(value: SeriesPackedBubbleDataLabelsTextPathOptionsObject): Self = StObject.set(x, "parentNodeTextPath", value.asInstanceOf[js.Any])
    
    inline def setParentNodeTextPathUndefined: Self = StObject.set(x, "parentNodeTextPath", js.undefined)
    ...
    inline def setStyle(value: CSSObject | PlotPackedbubbleDataLabelsStyleOptions): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
