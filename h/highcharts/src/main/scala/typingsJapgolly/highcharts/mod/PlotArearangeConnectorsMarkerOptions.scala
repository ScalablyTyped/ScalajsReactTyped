...
trait PlotArearangeConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotArearangeConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotArearangeConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeConnectorsMarkerOptions]
  }
}
