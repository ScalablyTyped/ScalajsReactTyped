...
trait PlotAroonoscillatorStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotAroonoscillatorStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAroonoscillatorStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotAroonoscillatorStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotAroonoscillatorStatesSelectAnimationOptions = null,
  ...
  ): PlotAroonoscillatorStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorStatesSelectOptions]
  }
}
