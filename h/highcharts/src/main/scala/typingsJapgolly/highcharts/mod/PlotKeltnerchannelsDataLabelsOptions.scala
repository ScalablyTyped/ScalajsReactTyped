...
object PlotKeltnerchannelsDataLabelsOptions {
  ...
  inline def apply(): PlotKeltnerchannelsDataLabelsOptions = {
  ...
  extension [Self <: PlotKeltnerchannelsDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotKeltnerchannelsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
