...
trait PlotAroonOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotAroonAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotAroonDataLabelsOptions | js.Array[PlotAroonDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotAroonDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotAroonOnPointOptions] = js.undefined
...
object PlotAroonOptions {
  ...
  inline def apply(): PlotAroonOptions = {
  ...
  extension [Self <: PlotAroonOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotAroonAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setAroonDown(value: PlotAroonAroonDownOptions): Self = StObject.set(x, "aroonDown", value.asInstanceOf[js.Any])
    
    inline def setAroonDownUndefined: Self = StObject.set(x, "aroonDown", js.undefined)
    ...
    inline def setDataLabels(value: PlotAroonDataLabelsOptions | js.Array[PlotAroonDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotAroonDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotAroonDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotAroonOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotAroonParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
