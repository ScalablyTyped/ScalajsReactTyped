...
trait PlotHeatmapStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotHeatmapStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotHeatmapStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotHeatmapStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotHeatmapStatesSelectAnimationOptions = null,
  ...
  ): PlotHeatmapStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapStatesSelectOptions]
  }
}
