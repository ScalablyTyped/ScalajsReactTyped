...
trait PlotFunnelAccessibilityPointOptions extends StObject {
...
object PlotFunnelAccessibilityPointOptions {
  
  inline def apply(): PlotFunnelAccessibilityPointOptions = {
