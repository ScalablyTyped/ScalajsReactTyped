...
trait PlotLinearregressionslopeOnPointPositionOptions extends StObject {
...
object PlotLinearregressionslopeOnPointPositionOptions {
  
  inline def apply(): PlotLinearregressionslopeOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeOnPointPositionOptions]
  }
  
  extension [Self <: PlotLinearregressionslopeOnPointPositionOptions](x: Self) {
