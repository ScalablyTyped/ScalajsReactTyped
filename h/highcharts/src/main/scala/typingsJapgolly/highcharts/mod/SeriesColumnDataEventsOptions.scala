...
trait SeriesColumnDataEventsOptions extends js.Object {
  /**
...
object SeriesColumnDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesColumnDataEventsOptions]
  }
}
