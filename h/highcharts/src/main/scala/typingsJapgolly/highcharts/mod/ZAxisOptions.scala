...
object ZAxisOptions {
  ...
  extension [Self <: ZAxisOptions](x: Self) {
    ...
    inline def setEvents(value: ZAxisEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setGrid(value: ZAxisGridOptions): Self = StObject.set(x, "grid", value.asInstanceOf[js.Any])
    ...
    inline def setScrollbar(value: ZAxisScrollbarOptions): Self = StObject.set(x, "scrollbar", value.asInstanceOf[js.Any])
