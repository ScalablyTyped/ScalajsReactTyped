...
trait PlotZigzagAccessibilityPointOptions extends StObject {
...
object PlotZigzagAccessibilityPointOptions {
  
  inline def apply(): PlotZigzagAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagAccessibilityPointOptions]
  }
  
  extension [Self <: PlotZigzagAccessibilityPointOptions](x: Self) {
