...
trait PlotTrixDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotTrixDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotTrixDataLabelsOptions {
  
  inline def apply(): PlotTrixDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixDataLabelsOptions]
  }
  
  extension [Self <: PlotTrixDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotTrixDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
