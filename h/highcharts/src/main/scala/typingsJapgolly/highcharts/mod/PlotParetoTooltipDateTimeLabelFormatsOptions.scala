...
trait PlotParetoTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotParetoTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotParetoTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotParetoTooltipDateTimeLabelFormatsOptions]
  }
}
