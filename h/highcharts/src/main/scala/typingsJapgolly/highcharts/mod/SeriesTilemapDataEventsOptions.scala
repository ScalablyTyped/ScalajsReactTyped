...
trait SeriesTilemapDataEventsOptions extends js.Object {
  /**
...
object SeriesTilemapDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesTilemapDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesTilemapDataEventsOptions]
  }
}
