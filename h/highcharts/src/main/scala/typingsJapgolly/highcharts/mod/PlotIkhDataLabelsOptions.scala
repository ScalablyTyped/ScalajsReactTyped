...
trait PlotIkhDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotIkhDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotIkhDataLabelsOptions {
  
  inline def apply(): PlotIkhDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhDataLabelsOptions]
  }
  
  extension [Self <: PlotIkhDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotIkhDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
