...
import typingsJapgolly.highcharts.highchartsStrings.mapline
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesMaplineOptions
  extends StObject
  ...
  /**
    ...
    */
  var data: js.UndefOr[
    js.Array[Double | (js.Tuple2[String, Double | Null]) | Null | SeriesMaplineDataOptions]
  ] = js.undefined
...
object SeriesMaplineOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | mapline): SeriesMaplineOptions = {
  ...
  extension [Self <: SeriesMaplineOptions](x: Self) {
    
    inline def setData(value: js.Array[Double | (js.Tuple2[String, Double | Null]) | Null | SeriesMaplineDataOptions]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    inline def setDataVarargs(value: (Double | (js.Tuple2[String, Double | Null]) | Null | SeriesMaplineDataOptions)*): Self = StObject.set(x, "data", js.Array(value*))
    ...
    inline def setType(value: String | mapline): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
