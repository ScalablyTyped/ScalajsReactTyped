...
trait PlotItemAccessibilityPointOptions extends StObject {
...
object PlotItemAccessibilityPointOptions {
  
  inline def apply(): PlotItemAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemAccessibilityPointOptions]
  }
  
  extension [Self <: PlotItemAccessibilityPointOptions](x: Self) {
