...
trait PlotBbOnPointPositionOptions extends StObject {
...
object PlotBbOnPointPositionOptions {
  
  inline def apply(): PlotBbOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbOnPointPositionOptions]
  }
  
  extension [Self <: PlotBbOnPointPositionOptions](x: Self) {
