...
trait PlotMfiStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMfiStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMfiStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotMfiStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMfiStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotMfiStatesHoverOptions]
  }
}
