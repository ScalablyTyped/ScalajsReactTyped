...
trait PlotBubbleAccessibilityPointOptions extends StObject {
...
object PlotBubbleAccessibilityPointOptions {
  
  inline def apply(): PlotBubbleAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleAccessibilityPointOptions]
  }
  
  extension [Self <: PlotBubbleAccessibilityPointOptions](x: Self) {
