...
trait PlotMapOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotMapDataLabelsOptions | js.Array[PlotMapDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotMapDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotMapOnPointOptions] = js.undefined
...
object PlotMapOptions {
  ...
  inline def apply(): PlotMapOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapOptions]
  }
  
  extension [Self <: PlotMapOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotMapAnimationOptions): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotMapDataLabelsOptions | js.Array[PlotMapDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotMapDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotMapDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setJitter(value: PlotMapJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotMapOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
