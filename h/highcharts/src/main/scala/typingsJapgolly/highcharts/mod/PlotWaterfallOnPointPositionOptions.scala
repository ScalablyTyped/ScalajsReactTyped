...
trait PlotWaterfallOnPointPositionOptions extends StObject {
...
object PlotWaterfallOnPointPositionOptions {
  
  inline def apply(): PlotWaterfallOnPointPositionOptions = {
