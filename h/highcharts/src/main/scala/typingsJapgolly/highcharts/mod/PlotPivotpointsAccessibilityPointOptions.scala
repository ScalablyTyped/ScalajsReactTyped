...
trait PlotPivotpointsAccessibilityPointOptions extends StObject {
...
object PlotPivotpointsAccessibilityPointOptions {
  
  inline def apply(): PlotPivotpointsAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsAccessibilityPointOptions]
  }
  
  extension [Self <: PlotPivotpointsAccessibilityPointOptions](x: Self) {
