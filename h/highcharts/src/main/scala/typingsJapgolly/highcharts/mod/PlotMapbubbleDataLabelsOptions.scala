...
trait PlotMapbubbleDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotMapbubbleDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotMapbubbleDataLabelsOptions {
  
  inline def apply(): PlotMapbubbleDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleDataLabelsOptions]
  }
  
  extension [Self <: PlotMapbubbleDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotMapbubbleDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
