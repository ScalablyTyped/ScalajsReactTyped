...
trait PlotVennDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotVennDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotVennDataLabelsOptions {
  
  inline def apply(): PlotVennDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennDataLabelsOptions]
  }
  
  extension [Self <: PlotVennDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotVennDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
