...
trait PlotStreamgraphOnPointOptions extends StObject {
  ...
  /**
    ...
    */
  var connectorOptions: js.UndefOr[PlotStreamgraphOnPointConnectorOptions | SVGAttributes] = js.undefined
  ...
  /**
    ...
    */
  var position: js.UndefOr[js.Object | PlotStreamgraphOnPointPositionOptions] = js.undefined
}
object PlotStreamgraphOnPointOptions {
  
  inline def apply(): PlotStreamgraphOnPointOptions = {
  ...
  extension [Self <: PlotStreamgraphOnPointOptions](x: Self) {
    ...
    inline def setPosition(value: js.Object | PlotStreamgraphOnPointPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
