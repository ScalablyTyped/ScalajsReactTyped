...
trait PlotPivotpointsStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotPivotpointsStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPivotpointsStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotPivotpointsStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotPivotpointsStatesSelectAnimationOptions = null,
  ...
  ): PlotPivotpointsStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsStatesSelectOptions]
  }
}
