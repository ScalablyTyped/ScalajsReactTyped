...
trait PlotAbandsStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAbandsStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAbandsStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotAbandsStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAbandsStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotAbandsStatesHoverOptions]
  }
}
