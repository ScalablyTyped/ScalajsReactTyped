...
trait NavigatorYAxisPlotLinesOptions extends StObject {
...
object NavigatorYAxisPlotLinesOptions {
  ...
  inline def apply(): NavigatorYAxisPlotLinesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorYAxisPlotLinesOptions]
  }
  
  extension [Self <: NavigatorYAxisPlotLinesOptions](x: Self) {
    ...
    inline def setEvents(value: NavigatorYAxisPlotLinesEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setLabel(value: NavigatorYAxisPlotLinesLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
