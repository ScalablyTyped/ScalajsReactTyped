...
trait PlotAoDataGroupingOptions extends js.Object {
  /**
...
object PlotAoDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotAoDataGroupingOptions]
  }
}
