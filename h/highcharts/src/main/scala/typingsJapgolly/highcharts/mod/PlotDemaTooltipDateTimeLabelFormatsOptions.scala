...
trait PlotDemaTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotDemaTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotDemaTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotDemaTooltipDateTimeLabelFormatsOptions]
  }
}
