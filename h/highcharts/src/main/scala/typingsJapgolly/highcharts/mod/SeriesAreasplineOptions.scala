...
import typingsJapgolly.highcharts.highchartsStrings.areaspline
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesAreasplineOptions
  extends StObject
     with PlotAreasplineOptions {
...
object SeriesAreasplineOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | areaspline): SeriesAreasplineOptions = {
  ...
  extension [Self <: SeriesAreasplineOptions](x: Self) {
    ...
    inline def setType(value: String | areaspline): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
