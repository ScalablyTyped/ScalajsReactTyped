...
import typingsJapgolly.highcharts.anon.PartialMapViewOptions
...
trait MapView extends StObject {
  ...
  /**
    ...
    */
  def lonLatToPixels(lonLat: typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.MapLonLatObject): js.UndefOr[PositionObject] = js.native
  ...
  /**
    ...
    */
  def lonLatToProjectedUnits(lonLat: typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.MapLonLatObject): typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.ProjectedXY = js.native
  ...
  /**
    ...
    */
  def pixelsToLonLat(pos: PositionObject): js.UndefOr[typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.MapLonLatObject] = js.native
  ...
  /**
    ...
    */
  def projectedUnitsToLonLat(point: typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.Point): js.UndefOr[typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.MapLonLatObject] = js.native
  def projectedUnitsToLonLat(point: typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.ProjectedXY): js.UndefOr[typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.MapLonLatObject] = js.native
