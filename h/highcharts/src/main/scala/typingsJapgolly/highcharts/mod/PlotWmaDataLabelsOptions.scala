...
trait PlotWmaDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotWmaDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotWmaDataLabelsOptions {
  
  inline def apply(): PlotWmaDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaDataLabelsOptions]
  }
  
  extension [Self <: PlotWmaDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotWmaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
