...
trait PlotTimelineOnPointPositionOptions extends StObject {
...
object PlotTimelineOnPointPositionOptions {
  
  inline def apply(): PlotTimelineOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineOnPointPositionOptions]
  }
  
  extension [Self <: PlotTimelineOnPointPositionOptions](x: Self) {
