...
trait PlotChaikinOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotChaikinAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotChaikinDataLabelsOptions | js.Array[PlotChaikinDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotChaikinDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotChaikinOnPointOptions] = js.undefined
...
object PlotChaikinOptions {
  ...
  inline def apply(): PlotChaikinOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinOptions]
  }
  
  extension [Self <: PlotChaikinOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotChaikinAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotChaikinDataLabelsOptions | js.Array[PlotChaikinDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotChaikinDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotChaikinDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotChaikinOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotChaikinParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
