...
trait PlotDumbbellOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotDumbbellAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotDumbbellDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotDumbbellOnPointOptions] = js.undefined
...
object PlotDumbbellOptions {
  
  inline def apply(): PlotDumbbellOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellOptions]
  }
  
  extension [Self <: PlotDumbbellOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotDumbbellAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotDumbbellDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotDumbbellOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
