...
trait PlotPolygonStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotPolygonStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPolygonStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotPolygonStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotPolygonStatesSelectAnimationOptions = null,
  ...
  ): PlotPolygonStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPolygonStatesSelectOptions]
  }
}
