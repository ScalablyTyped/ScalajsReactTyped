...
trait PlotOrganizationAccessibilityPointOptions extends StObject {
...
object PlotOrganizationAccessibilityPointOptions {
  
  inline def apply(): PlotOrganizationAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationAccessibilityPointOptions]
  }
  
  extension [Self <: PlotOrganizationAccessibilityPointOptions](x: Self) {
