...
trait PlotTimelineOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotTimelineAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotTimelineOptions {
  ...
  inline def apply(): PlotTimelineOptions = {
  ...
  extension [Self <: PlotTimelineOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotTimelineAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: TimelineDataLabelsOptionsObject | js.Array[TimelineDataLabelsOptionsObject]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
