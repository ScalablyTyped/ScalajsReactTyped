...
trait PlotVariablepieOnPointPositionOptions extends StObject {
...
object PlotVariablepieOnPointPositionOptions {
  
  inline def apply(): PlotVariablepieOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieOnPointPositionOptions]
  }
  
  extension [Self <: PlotVariablepieOnPointPositionOptions](x: Self) {
