...
trait PlotLinearregressioninterceptMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressioninterceptMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptMarkerStatesSelectOptions]
  }
}
