...
trait PlotNetworkgraphStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotNetworkgraphStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotNetworkgraphStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotNetworkgraphStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotNetworkgraphStatesHoverAnimationOptions = null,
  ...
  ): PlotNetworkgraphStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphStatesHoverOptions]
  }
}
