...
import typingsJapgolly.highcharts.highchartsStrings.tilemap
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesTilemapOptions
  extends StObject
     with PlotTilemapOptions {
...
object SeriesTilemapOptions {
  ...
  extension [Self <: SeriesTilemapOptions](x: Self) {
    ...
    inline def setType(value: String | tilemap): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
