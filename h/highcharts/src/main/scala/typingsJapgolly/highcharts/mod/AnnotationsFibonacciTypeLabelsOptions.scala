...
trait AnnotationsFibonacciTypeLabelsOptions extends StObject {
...
object AnnotationsFibonacciTypeLabelsOptions {
  
  inline def apply(): AnnotationsFibonacciTypeLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsFibonacciTypeLabelsOptions]
  }
  
  extension [Self <: AnnotationsFibonacciTypeLabelsOptions](x: Self) {
