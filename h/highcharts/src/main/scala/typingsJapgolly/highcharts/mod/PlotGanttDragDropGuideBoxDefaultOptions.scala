...
trait PlotGanttDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotGanttDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotGanttDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotGanttDragDropGuideBoxDefaultOptions]
  }
}
