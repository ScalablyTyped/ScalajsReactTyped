...
trait PlotAroonMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAroonMarkerStatesOptions] = js.undefined
  /**
...
object PlotAroonMarkerOptions {
  ...
  def apply(
    ...
    states: PlotAroonMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAroonMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAroonMarkerOptions]
  }
}
