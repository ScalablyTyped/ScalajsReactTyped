...
trait PlotNetworkgraphOnPointPositionOptions extends StObject {
...
object PlotNetworkgraphOnPointPositionOptions {
  
  inline def apply(): PlotNetworkgraphOnPointPositionOptions = {
