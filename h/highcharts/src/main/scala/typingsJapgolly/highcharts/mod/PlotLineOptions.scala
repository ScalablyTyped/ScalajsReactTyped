...
trait PlotLineOptions extends StObject {
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotLineOnPointOptions] = js.undefined
...
object PlotLineOptions {
  ...
  inline def apply(): PlotLineOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineOptions]
  }
  
  extension [Self <: PlotLineOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotLineAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotLineDataLabelsOptions | js.Array[PlotLineDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotLineDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotLineDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotLineOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
