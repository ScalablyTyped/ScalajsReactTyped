...
trait PlotDmiOnPointPositionOptions extends StObject {
...
object PlotDmiOnPointPositionOptions {
  
  inline def apply(): PlotDmiOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiOnPointPositionOptions]
  }
  
  extension [Self <: PlotDmiOnPointPositionOptions](x: Self) {
