...
trait PlotLineOnPointPositionOptions extends StObject {
...
object PlotLineOnPointPositionOptions {
  
  inline def apply(): PlotLineOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineOnPointPositionOptions]
  }
  
  extension [Self <: PlotLineOnPointPositionOptions](x: Self) {
