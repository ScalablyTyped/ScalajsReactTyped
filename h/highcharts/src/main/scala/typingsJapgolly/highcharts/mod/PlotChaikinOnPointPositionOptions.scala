...
trait PlotChaikinOnPointPositionOptions extends StObject {
...
object PlotChaikinOnPointPositionOptions {
  
  inline def apply(): PlotChaikinOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinOnPointPositionOptions]
  }
  
  extension [Self <: PlotChaikinOnPointPositionOptions](x: Self) {
