...
object YAxisLabelsOptions {
  ...
  inline def apply(): YAxisLabelsOptions = {
  ...
  extension [Self <: YAxisLabelsOptions](x: Self) {
    ...
    inline def setLevels(value: js.Array[YAxisLabelsLevelsOptions]): Self = StObject.set(x, "levels", value.asInstanceOf[js.Any])
    
    inline def setLevelsUndefined: Self = StObject.set(x, "levels", js.undefined)
    
    inline def setLevelsVarargs(value: YAxisLabelsLevelsOptions*): Self = StObject.set(x, "levels", js.Array(value*))
    ...
    inline def setSymbol(value: YAxisLabelsSymbolOptions): Self = StObject.set(x, "symbol", value.asInstanceOf[js.Any])
