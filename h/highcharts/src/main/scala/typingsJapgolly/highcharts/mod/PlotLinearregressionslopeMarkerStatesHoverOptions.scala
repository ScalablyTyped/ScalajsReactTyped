...
trait PlotLinearregressionslopeMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotLinearregressionslopeMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopeMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeMarkerStatesHoverOptions]
  }
}
