...
import typingsJapgolly.highcharts.highchartsStrings.linearregression
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesLinearregressionOptions
  extends StObject
     with PlotLinearregressionOptions {
...
object SeriesLinearregressionOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | linearregression): SeriesLinearregressionOptions = {
  ...
  extension [Self <: SeriesLinearregressionOptions](x: Self) {
    ...
    inline def setType(value: String | linearregression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
