...
trait PlotDemaConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotDemaConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotDemaConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotDemaConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotDemaConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotDemaConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotDemaConnectorsMarkerOptions = null,
    startMarker: PlotDemaConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotDemaConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotDemaConnectorsOptions]
  }
}
