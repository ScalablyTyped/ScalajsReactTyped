...
trait PlotZigzagConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotZigzagConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotZigzagConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagConnectorsEndMarkerOptions]
  }
}
