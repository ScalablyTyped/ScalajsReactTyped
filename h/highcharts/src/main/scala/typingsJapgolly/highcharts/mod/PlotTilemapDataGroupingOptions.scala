...
trait PlotTilemapDataGroupingOptions extends js.Object {
  /**
...
object PlotTilemapDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTilemapDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotTilemapDataGroupingOptions]
  }
}
