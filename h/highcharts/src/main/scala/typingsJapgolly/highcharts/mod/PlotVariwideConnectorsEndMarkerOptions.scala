...
trait PlotVariwideConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotVariwideConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVariwideConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVariwideConnectorsEndMarkerOptions]
  }
}
