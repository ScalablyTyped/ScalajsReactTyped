...
trait AnnotationsPitchforkLabelOptions extends StObject {
...
object AnnotationsPitchforkLabelOptions {
  ...
  inline def apply(): AnnotationsPitchforkLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsPitchforkLabelOptions]
  }
  
  extension [Self <: AnnotationsPitchforkLabelOptions](x: Self) {
