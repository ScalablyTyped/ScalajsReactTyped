...
trait PlotPriceenvelopesDataLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | PlotPriceenvelopesDataLabelsAnimationOptions | PartialAnimationOptionsOb
  ] = js.undefined
...
object PlotPriceenvelopesDataLabelsOptions {
  ...
  inline def apply(): PlotPriceenvelopesDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesDataLabelsOptions]
  }
  
  extension [Self <: PlotPriceenvelopesDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotPriceenvelopesDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
