...
trait SeriesVennDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesVennDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesVennDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesVennDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesVennDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesVennDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesVennDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesVennDataDragDropOptions]
  }
}
