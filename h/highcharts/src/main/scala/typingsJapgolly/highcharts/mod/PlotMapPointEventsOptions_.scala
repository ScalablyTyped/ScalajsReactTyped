...
trait PlotMapPointEventsOptions_ extends js.Object {
  /**
...
object PlotMapPointEventsOptions_ {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotMapPointEventsOptions_]
  }
}
