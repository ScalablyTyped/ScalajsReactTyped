...
trait PlotAroonoscillatorOnPointPositionOptions extends StObject {
...
object PlotAroonoscillatorOnPointPositionOptions {
  
  inline def apply(): PlotAroonoscillatorOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorOnPointPositionOptions]
  }
  
  extension [Self <: PlotAroonoscillatorOnPointPositionOptions](x: Self) {
