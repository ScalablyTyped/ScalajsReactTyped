...
trait PlotLollipopAccessibilityPointOptions extends StObject {
...
object PlotLollipopAccessibilityPointOptions {
  
  inline def apply(): PlotLollipopAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopAccessibilityPointOptions]
  }
  
  extension [Self <: PlotLollipopAccessibilityPointOptions](x: Self) {
