...
trait PointInstrumentObject extends js.Object {
  ...
  /**
    ...
    */
  var instrumentMapping: typingsJapgolly.highcharts.sonificationMod.highchartsAugmentingMod.PointInstrumentMappingObject
  /**
    * Options for this instrument.
    */
  var instrumentOptions: js.UndefOr[
    typingsJapgolly.highcharts.sonificationMod.highchartsAugmentingMod.PointInstrumentOptionsObject
  ] = js.undefined
  /**
...
object PointInstrumentObject {
  ...
  def apply(
    ...
    instrumentMapping: typingsJapgolly.highcharts.sonificationMod.highchartsAugmentingMod.PointInstrumentMappingObject,
    instrumentOptions: typingsJapgolly.highcharts.sonificationMod.highchartsAugmentingMod.PointInstrumentOptionsObject = null,
