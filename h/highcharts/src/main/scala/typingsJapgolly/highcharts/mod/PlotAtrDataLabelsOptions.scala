...
trait PlotAtrDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotAtrDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotAtrDataLabelsOptions {
  ...
  inline def apply(): PlotAtrDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrDataLabelsOptions]
  }
  
  extension [Self <: PlotAtrDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotAtrDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
