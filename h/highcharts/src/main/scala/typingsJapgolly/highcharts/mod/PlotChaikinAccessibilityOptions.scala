...
trait PlotChaikinAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotChaikinAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotChaikinAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotChaikinAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotChaikinAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinAccessibilityOptions]
  }
}
