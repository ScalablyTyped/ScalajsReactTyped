...
trait PlotHlcDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotHlcDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotHlcDataLabelsOptions {
  
  inline def apply(): PlotHlcDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcDataLabelsOptions]
  }
  
  extension [Self <: PlotHlcDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotHlcDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
