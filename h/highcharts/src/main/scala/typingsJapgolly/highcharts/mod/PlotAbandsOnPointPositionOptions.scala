...
trait PlotAbandsOnPointPositionOptions extends StObject {
...
object PlotAbandsOnPointPositionOptions {
  
  inline def apply(): PlotAbandsOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsOnPointPositionOptions]
  }
  
  extension [Self <: PlotAbandsOnPointPositionOptions](x: Self) {
