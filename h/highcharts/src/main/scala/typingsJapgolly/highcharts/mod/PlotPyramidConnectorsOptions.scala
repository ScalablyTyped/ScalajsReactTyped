...
trait PlotPyramidConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPyramidConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPyramidConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPyramidConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotPyramidConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotPyramidConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotPyramidConnectorsMarkerOptions = null,
    startMarker: PlotPyramidConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotPyramidConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotPyramidConnectorsOptions]
  }
}
