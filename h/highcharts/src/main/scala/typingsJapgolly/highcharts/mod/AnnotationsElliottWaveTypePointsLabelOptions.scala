...
trait AnnotationsElliottWaveTypePointsLabelOptions extends StObject {
...
object AnnotationsElliottWaveTypePointsLabelOptions {
  ...
  inline def apply(): AnnotationsElliottWaveTypePointsLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsElliottWaveTypePointsLabelOptions]
  }
  
  extension [Self <: AnnotationsElliottWaveTypePointsLabelOptions](x: Self) {
