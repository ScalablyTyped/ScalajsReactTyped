...
trait SeriesArcDiagramDataLabelsOptionsObject extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotArcdiagramDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var formatter: js.UndefOr[SeriesSankeyDataLabelsFormatterCallbackFunction] = js.undefined
...
object SeriesArcDiagramDataLabelsOptionsObject {
  
  inline def apply(): SeriesArcDiagramDataLabelsOptionsObject = {
  ...
  extension [Self <: SeriesArcDiagramDataLabelsOptionsObject](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotArcdiagramDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setFormatter(value: SeriesSankeyDataLabelsFormatterCallbackFunction): Self = StObject.set(x, "formatter", value.asInstanceOf[js.Any])
    ...
    inline def setNodeFormatter(value: SeriesSankeyDataLabelsFormatterCallbackFunction): Self = StObject.set(x, "nodeFormatter", value.asInstanceOf[js.Any])
