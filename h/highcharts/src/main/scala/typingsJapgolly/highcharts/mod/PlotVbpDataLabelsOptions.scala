...
trait PlotVbpDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotVbpDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotVbpDataLabelsOptions {
  ...
  inline def apply(): PlotVbpDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpDataLabelsOptions]
  }
  
  extension [Self <: PlotVbpDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotVbpDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
