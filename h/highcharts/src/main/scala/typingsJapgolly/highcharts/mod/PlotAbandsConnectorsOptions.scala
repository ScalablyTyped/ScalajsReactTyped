...
trait PlotAbandsConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotAbandsConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAbandsConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotAbandsConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotAbandsConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotAbandsConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotAbandsConnectorsMarkerOptions = null,
    startMarker: PlotAbandsConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotAbandsConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsConnectorsOptions]
  }
}
