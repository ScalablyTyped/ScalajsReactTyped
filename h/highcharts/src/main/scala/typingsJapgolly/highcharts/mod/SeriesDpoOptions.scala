...
import typingsJapgolly.highcharts.highchartsStrings.dpo
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesDpoOptions
  extends StObject
     with PlotDpoOptions {
...
object SeriesDpoOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | dpo): SeriesDpoOptions = {
  ...
  extension [Self <: SeriesDpoOptions](x: Self) {
    ...
    inline def setType(value: String | dpo): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
