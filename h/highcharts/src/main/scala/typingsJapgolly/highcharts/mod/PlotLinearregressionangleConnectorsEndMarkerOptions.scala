...
trait PlotLinearregressionangleConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotLinearregressionangleConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionangleConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleConnectorsEndMarkerOptions]
  }
}
