...
trait PlotHeatmapConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotHeatmapConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotHeatmapConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapConnectorsMarkerOptions]
  }
}
