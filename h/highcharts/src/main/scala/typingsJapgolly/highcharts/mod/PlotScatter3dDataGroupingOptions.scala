...
trait PlotScatter3dDataGroupingOptions extends js.Object {
  /**
...
object PlotScatter3dDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatter3dDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dDataGroupingOptions]
  }
}
