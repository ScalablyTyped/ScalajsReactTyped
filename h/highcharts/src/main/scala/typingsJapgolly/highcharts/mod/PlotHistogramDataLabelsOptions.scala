...
trait PlotHistogramDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotHistogramDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotHistogramDataLabelsOptions {
  ...
  inline def apply(): PlotHistogramDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramDataLabelsOptions]
  }
  
  extension [Self <: PlotHistogramDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotHistogramDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
