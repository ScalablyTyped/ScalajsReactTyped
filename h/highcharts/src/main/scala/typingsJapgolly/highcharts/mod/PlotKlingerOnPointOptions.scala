...
trait PlotKlingerOnPointOptions extends StObject {
  ...
  /**
    ...
    */
  var connectorOptions: js.UndefOr[PlotKlingerOnPointConnectorOptions | SVGAttributes] = js.undefined
  ...
  /**
    ...
    */
  var position: js.UndefOr[js.Object | PlotKlingerOnPointPositionOptions] = js.undefined
}
object PlotKlingerOnPointOptions {
  
  inline def apply(): PlotKlingerOnPointOptions = {
  ...
  extension [Self <: PlotKlingerOnPointOptions](x: Self) {
    ...
    inline def setPosition(value: js.Object | PlotKlingerOnPointPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
