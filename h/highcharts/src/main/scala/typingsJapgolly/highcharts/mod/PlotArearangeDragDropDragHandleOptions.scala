...
trait PlotArearangeDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotArearangeDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotArearangeDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeDragDropDragHandleOptions]
  }
}
