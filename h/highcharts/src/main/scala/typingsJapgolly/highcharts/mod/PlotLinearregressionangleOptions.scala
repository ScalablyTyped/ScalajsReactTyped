...
trait PlotLinearregressionangleOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotLinearregressionangleAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  var dataLabels: js.UndefOr[
    PlotLinearregressionangleDataLabelsOptions | js.Array[PlotLinearregressionangleDataLabelsOptions]
  ] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotLinearregressionangleDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotLinearregressionangleOnPointOptions] = js.undefined
...
object PlotLinearregressionangleOptions {
  ...
  inline def apply(): PlotLinearregressionangleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleOptions]
  }
  
  extension [Self <: PlotLinearregressionangleOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotLinearregressionangleAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(
      value: PlotLinearregressionangleDataLabelsOptions | js.Array[PlotLinearregressionangleDataLabelsOptions]
    ): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotLinearregressionangleDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotLinearregressionangleDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotLinearregressionangleOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotLinearregressionangleParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
