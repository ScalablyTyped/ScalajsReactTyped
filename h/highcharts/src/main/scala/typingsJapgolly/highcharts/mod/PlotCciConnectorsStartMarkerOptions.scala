...
trait PlotCciConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotCciConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCciConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotCciConnectorsStartMarkerOptions]
  }
}
