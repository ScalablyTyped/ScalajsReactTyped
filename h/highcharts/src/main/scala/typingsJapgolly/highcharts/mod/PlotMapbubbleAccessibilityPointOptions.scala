...
trait PlotMapbubbleAccessibilityPointOptions extends StObject {
...
object PlotMapbubbleAccessibilityPointOptions {
  
  inline def apply(): PlotMapbubbleAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleAccessibilityPointOptions]
  }
  
  extension [Self <: PlotMapbubbleAccessibilityPointOptions](x: Self) {
