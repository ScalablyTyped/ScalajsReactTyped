...
trait SeriesPackedbubbleDataEventsOptions extends js.Object {
  /**
...
object SeriesPackedbubbleDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesPackedbubbleDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesPackedbubbleDataEventsOptions]
  }
}
