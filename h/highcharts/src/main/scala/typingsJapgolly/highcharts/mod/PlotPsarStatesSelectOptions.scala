...
trait PlotPsarStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotPsarStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPsarStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotPsarStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotPsarStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotPsarStatesSelectOptions]
  }
}
