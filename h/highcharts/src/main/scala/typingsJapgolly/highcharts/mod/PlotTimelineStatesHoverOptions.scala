...
trait PlotTimelineStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotTimelineStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTimelineStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotTimelineStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTimelineStatesHoverAnimationOptions = null,
  ...
  ): PlotTimelineStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineStatesHoverOptions]
  }
}
