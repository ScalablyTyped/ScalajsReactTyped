...
trait PlotSankeyOnPointPositionOptions extends StObject {
...
object PlotSankeyOnPointPositionOptions {
  
  inline def apply(): PlotSankeyOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyOnPointPositionOptions]
  }
  
  extension [Self <: PlotSankeyOnPointPositionOptions](x: Self) {
