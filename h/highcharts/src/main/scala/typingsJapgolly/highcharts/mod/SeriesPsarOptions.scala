...
import typingsJapgolly.highcharts.highchartsStrings.psar
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesPsarOptions
  extends StObject
     with PlotPsarOptions {
...
object SeriesPsarOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | psar): SeriesPsarOptions = {
  ...
  extension [Self <: SeriesPsarOptions](x: Self) {
    ...
    inline def setType(value: String | psar): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
