...
trait PlotTreemapConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotTreemapConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTreemapConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapConnectorsStartMarkerOptions]
  }
}
