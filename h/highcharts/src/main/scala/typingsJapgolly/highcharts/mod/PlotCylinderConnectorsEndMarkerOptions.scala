...
trait PlotCylinderConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotCylinderConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCylinderConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotCylinderConnectorsEndMarkerOptions]
  }
}
