...
trait PlotIkhOnPointPositionOptions extends StObject {
...
object PlotIkhOnPointPositionOptions {
  
  inline def apply(): PlotIkhOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhOnPointPositionOptions]
  }
  
  extension [Self <: PlotIkhOnPointPositionOptions](x: Self) {
