...
trait PlotCylinderDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotCylinderDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotCylinderDataLabelsOptions {
  
  inline def apply(): PlotCylinderDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderDataLabelsOptions]
  }
  
  extension [Self <: PlotCylinderDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotCylinderDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
