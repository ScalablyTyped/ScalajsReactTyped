...
trait PlotFlagsAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotFlagsAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotFlagsAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotFlagsAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotFlagsAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotFlagsAccessibilityOptions]
  }
}
