...
import typingsJapgolly.highcharts.highchartsStrings.atr
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesAtrOptions
  extends StObject
     with PlotAtrOptions {
...
object SeriesAtrOptions {
  
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | atr): SeriesAtrOptions = {
    val __obj = js.Dynamic.literal(dataParser = dataParser.asInstanceOf[js.Any], dataURL = dataURL.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesAtrOptions]
  }
  
  extension [Self <: SeriesAtrOptions](x: Self) {
    ...
    inline def setType(value: String | atr): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
