...
trait SeriesOhlcDataEventsOptions extends js.Object {
  /**
...
object SeriesOhlcDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesOhlcDataEventsOptions]
  }
}
