...
trait PlotBellcurveOnPointPositionOptions extends StObject {
...
object PlotBellcurveOnPointPositionOptions {
  
  inline def apply(): PlotBellcurveOnPointPositionOptions = {
