...
trait PlotRocOnPointPositionOptions extends StObject {
...
object PlotRocOnPointPositionOptions {
  
  inline def apply(): PlotRocOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocOnPointPositionOptions]
  }
  
  extension [Self <: PlotRocOnPointPositionOptions](x: Self) {
