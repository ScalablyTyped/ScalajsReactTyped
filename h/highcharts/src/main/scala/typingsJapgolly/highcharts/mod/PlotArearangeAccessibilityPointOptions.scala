...
trait PlotArearangeAccessibilityPointOptions extends StObject {
...
object PlotArearangeAccessibilityPointOptions {
  
  inline def apply(): PlotArearangeAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeAccessibilityPointOptions]
  }
  
  extension [Self <: PlotArearangeAccessibilityPointOptions](x: Self) {
