...
import typingsJapgolly.highcharts.highchartsStrings.rsi
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesRsiOptions
  extends StObject
     with PlotRsiOptions {
...
object SeriesRsiOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | rsi): SeriesRsiOptions = {
  ...
  extension [Self <: SeriesRsiOptions](x: Self) {
    ...
    inline def setType(value: String | rsi): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
