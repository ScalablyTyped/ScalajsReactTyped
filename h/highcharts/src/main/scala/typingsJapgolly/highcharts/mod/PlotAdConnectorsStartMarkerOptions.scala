...
trait PlotAdConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotAdConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAdConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAdConnectorsStartMarkerOptions]
  }
}
