...
trait PlotMappointMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotMappointMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMappointMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMappointMarkerStatesHoverOptions]
  }
}
