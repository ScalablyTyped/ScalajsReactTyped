...
trait PlotHlcAccessibilityPointOptions extends StObject {
...
object PlotHlcAccessibilityPointOptions {
  
  inline def apply(): PlotHlcAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcAccessibilityPointOptions]
  }
  
  extension [Self <: PlotHlcAccessibilityPointOptions](x: Self) {
