...
trait PlotRsiOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotRsiDataLabelsOptions | js.Array[PlotRsiDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotRsiDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotRsiOnPointOptions] = js.undefined
...
object PlotRsiOptions {
  ...
  inline def apply(): PlotRsiOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiOptions]
  }
  
  extension [Self <: PlotRsiOptions](x: Self) {
    ...
    inline def setDataLabels(value: PlotRsiDataLabelsOptions | js.Array[PlotRsiDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotRsiDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotRsiDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotRsiOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotRsiParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
