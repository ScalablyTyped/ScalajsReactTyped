...
trait PlotGaugeDataLabelsAnimationOptions extends StObject {
...
object PlotGaugeDataLabelsAnimationOptions {
  
  inline def apply(): PlotGaugeDataLabelsAnimationOptions = {
