...
trait PlotScatter3dOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotScatter3dAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotScatter3dDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotScatter3dOnPointOptions] = js.undefined
...
object PlotScatter3dOptions {
  
  inline def apply(): PlotScatter3dOptions = {
  ...
  extension [Self <: PlotScatter3dOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotScatter3dAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotScatter3dDataLabelsOptions | js.Array[PlotScatter3dDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotScatter3dDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotScatter3dDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setJitter(value: PlotScatter3dJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotScatter3dOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
