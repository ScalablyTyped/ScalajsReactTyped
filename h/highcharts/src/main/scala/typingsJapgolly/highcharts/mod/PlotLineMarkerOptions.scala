...
trait PlotLineMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLineMarkerStatesOptions] = js.undefined
  /**
...
object PlotLineMarkerOptions {
  ...
  def apply(
    ...
    states: PlotLineMarkerStatesOptions = null,
    symbol: String = null,
    ...
    __obj.asInstanceOf[PlotLineMarkerOptions]
  }
}
