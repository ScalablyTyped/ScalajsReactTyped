...
trait PlotPpoMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotPpoMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPpoMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPpoMarkerStatesHoverOptions]
  }
}
