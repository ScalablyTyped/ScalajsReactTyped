...
trait PlotDumbbellAccessibilityPointOptions extends StObject {
...
object PlotDumbbellAccessibilityPointOptions {
  
  inline def apply(): PlotDumbbellAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellAccessibilityPointOptions]
  }
  
  extension [Self <: PlotDumbbellAccessibilityPointOptions](x: Self) {
