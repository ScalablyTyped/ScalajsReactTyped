...
trait PlotSunburstBreadcrumbsOptions extends StObject {
  ...
  /**
    ...
    */
  var buttonTheme: js.UndefOr[PlotSunburstBreadcrumbsButtonThemeOptions | SVGAttributes] = js.undefined
  
  var events: js.UndefOr[PlotSunburstBreadcrumbsEventsOptions] = js.undefined
  ...
  /**
    ...
    * position properties.
    */
  var position: js.UndefOr[BreadcrumbsAlignOptions | PlotSunburstBreadcrumbsPositionOptions] = js.undefined
  ...
  /**
    ...
    */
  var separator: js.UndefOr[PlotSunburstBreadcrumbsSeparatorOptions] = js.undefined
...
object PlotSunburstBreadcrumbsOptions {
  
  inline def apply(): PlotSunburstBreadcrumbsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstBreadcrumbsOptions]
  }
  
  extension [Self <: PlotSunburstBreadcrumbsOptions](x: Self) {
    ...
    inline def setButtonTheme(value: PlotSunburstBreadcrumbsButtonThemeOptions | SVGAttributes): Self = StObject.set(x, "buttonTheme", value.asInstanceOf[js.Any])
    
    inline def setButtonThemeUndefined: Self = StObject.set(x, "buttonTheme", js.undefined)
    
    inline def setEvents(value: PlotSunburstBreadcrumbsEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setPosition(value: BreadcrumbsAlignOptions | PlotSunburstBreadcrumbsPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
    ...
    inline def setSeparator(value: PlotSunburstBreadcrumbsSeparatorOptions): Self = StObject.set(x, "separator", value.asInstanceOf[js.Any])
