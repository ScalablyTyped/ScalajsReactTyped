...
trait PlotMacdOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotMacdAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotMacdDataLabelsOptions | js.Array[PlotMacdDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotMacdDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var macdLine: js.UndefOr[PlotMacdMacdLineOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotMacdOnPointOptions] = js.undefined
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotMacdParamsOptions] = js.undefined
  ...
  /**
    ...
    */
  var signalLine: js.UndefOr[PlotMacdSignalLineOptions] = js.undefined
...
object PlotMacdOptions {
  
  inline def apply(): PlotMacdOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdOptions]
  }
  
  extension [Self <: PlotMacdOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotMacdAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotMacdDataLabelsOptions | js.Array[PlotMacdDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotMacdDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotMacdDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setMacdLine(value: PlotMacdMacdLineOptions): Self = StObject.set(x, "macdLine", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotMacdOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotMacdParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    inline def setSignalLine(value: PlotMacdSignalLineOptions): Self = StObject.set(x, "signalLine", value.asInstanceOf[js.Any])
    
    inline def setSignalLineUndefined: Self = StObject.set(x, "signalLine", js.undefined)
