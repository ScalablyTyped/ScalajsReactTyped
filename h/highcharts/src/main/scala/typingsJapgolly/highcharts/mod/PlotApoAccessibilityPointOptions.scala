...
trait PlotApoAccessibilityPointOptions extends StObject {
...
object PlotApoAccessibilityPointOptions {
  
  inline def apply(): PlotApoAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoAccessibilityPointOptions]
  }
  
  extension [Self <: PlotApoAccessibilityPointOptions](x: Self) {
