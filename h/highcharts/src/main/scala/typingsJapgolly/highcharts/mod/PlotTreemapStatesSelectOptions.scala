...
trait PlotTreemapStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotTreemapStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTreemapStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotTreemapStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotTreemapStatesSelectAnimationOptions = null,
  ...
  ): PlotTreemapStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapStatesSelectOptions]
  }
}
