...
trait PlotItemConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotItemConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotItemConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotItemConnectorsEndMarkerOptions]
  }
}
