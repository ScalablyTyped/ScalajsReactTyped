...
trait PlotLinearregressionslopeConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotLinearregressionslopeConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotLinearregressionslopeConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotLinearregressionslopeConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotLinearregressionslopeConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotLinearregressionslopeConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotLinearregressionslopeConnectorsMarkerOptions = null,
    startMarker: PlotLinearregressionslopeConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotLinearregressionslopeConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeConnectorsOptions]
  }
}
