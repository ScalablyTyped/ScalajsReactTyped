...
trait PlotSupertrendAccessibilityPointOptions extends StObject {
...
object PlotSupertrendAccessibilityPointOptions {
  
  inline def apply(): PlotSupertrendAccessibilityPointOptions = {
