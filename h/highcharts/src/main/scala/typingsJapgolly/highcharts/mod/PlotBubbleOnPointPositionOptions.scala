...
trait PlotBubbleOnPointPositionOptions extends StObject {
...
object PlotBubbleOnPointPositionOptions {
  
  inline def apply(): PlotBubbleOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleOnPointPositionOptions]
  }
  
  extension [Self <: PlotBubbleOnPointPositionOptions](x: Self) {
