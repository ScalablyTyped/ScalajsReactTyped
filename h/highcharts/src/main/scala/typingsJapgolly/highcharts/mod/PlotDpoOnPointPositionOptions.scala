...
trait PlotDpoOnPointPositionOptions extends StObject {
...
object PlotDpoOnPointPositionOptions {
  
  inline def apply(): PlotDpoOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoOnPointPositionOptions]
  }
  
  extension [Self <: PlotDpoOnPointPositionOptions](x: Self) {
