...
object TooltipOptions {
  ...
  def apply(
    ...
    positioner: (/* labelWidth */ Double, /* labelHeight */ Double, /* point */ TooltipPositionerPointObject) => CallbackTo[PositionObject] = null,
    ...
    if (positioner != null) __obj.updateDynamic("positioner")(js.Any.fromFunction3((t0: /* labelWidth */ scala.Double, t1: /* labelHeight */ scala.Double, t2: /* point */ typingsJapgolly.highcharts.mod.TooltipPositionerPointObject) => positioner(t0, t1, t2).runNow()))
