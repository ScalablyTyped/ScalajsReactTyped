...
import typingsJapgolly.highcharts.highchartsStrings.chaikin
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesChaikinOptions
  extends StObject
     with PlotChaikinOptions {
...
object SeriesChaikinOptions {
  
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | chaikin): SeriesChaikinOptions = {
  ...
  extension [Self <: SeriesChaikinOptions](x: Self) {
    ...
    inline def setType(value: String | chaikin): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
