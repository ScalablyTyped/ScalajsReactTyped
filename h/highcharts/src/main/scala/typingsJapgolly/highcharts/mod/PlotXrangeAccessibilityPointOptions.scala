...
trait PlotXrangeAccessibilityPointOptions extends StObject {
...
object PlotXrangeAccessibilityPointOptions {
  
  inline def apply(): PlotXrangeAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeAccessibilityPointOptions]
  }
  
  extension [Self <: PlotXrangeAccessibilityPointOptions](x: Self) {
