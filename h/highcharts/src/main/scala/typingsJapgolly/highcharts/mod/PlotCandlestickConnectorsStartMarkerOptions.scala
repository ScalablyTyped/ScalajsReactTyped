...
trait PlotCandlestickConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotCandlestickConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCandlestickConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotCandlestickConnectorsStartMarkerOptions]
  }
}
