...
import typingsJapgolly.highcharts.highchartsStrings.candlestick
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesCandlestickOptions
  extends StObject
     with PlotCandlestickOptions {
...
object SeriesCandlestickOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | candlestick): SeriesCandlestickOptions = {
  ...
  extension [Self <: SeriesCandlestickOptions](x: Self) {
    ...
    inline def setType(value: String | candlestick): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
