...
trait PlotMaplineOptions extends StObject {
  ...
  /**
    ...
    */
  var affectsMapView: js.UndefOr[Boolean] = js.undefined
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotMaplineAnimationOptions] = js.undefined
  ...
  /**
    * (Highmaps) Indicates data is structured as columns instead of rows.
    */
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotMaplineDataLabelsOptions | js.Array[PlotMaplineDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotMaplineDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var jitter: js.UndefOr[PlotMaplineJitterOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotMaplineOnPointOptions] = js.undefined
...
object PlotMaplineOptions {
  ...
  inline def apply(): PlotMaplineOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineOptions]
  }
  
  extension [Self <: PlotMaplineOptions](x: Self) {
    ...
    inline def setAffectsMapView(value: Boolean): Self = StObject.set(x, "affectsMapView", value.asInstanceOf[js.Any])
    
    inline def setAffectsMapViewUndefined: Self = StObject.set(x, "affectsMapView", js.undefined)
    ...
    inline def setAnimation(value: Boolean | PlotMaplineAnimationOptions): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotMaplineDataLabelsOptions | js.Array[PlotMaplineDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotMaplineDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotMaplineDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setJitter(value: PlotMaplineJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
    ...
    inline def setNullInteraction(value: Boolean): Self = StObject.set(x, "nullInteraction", value.asInstanceOf[js.Any])
    
    inline def setNullInteractionUndefined: Self = StObject.set(x, "nullInteraction", js.undefined)
    
    inline def setOnPoint(value: js.Object | PlotMaplineOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
