...
trait PlotSmaDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotSmaDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotSmaDataLabelsOptions {
  
  inline def apply(): PlotSmaDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaDataLabelsOptions]
  }
  
  extension [Self <: PlotSmaDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotSmaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
