...
trait PlotTimelineMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTimelineMarkerStatesOptions] = js.undefined
  /**
...
object PlotTimelineMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotTimelineMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotTimelineMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineMarkerOptions]
  }
}
