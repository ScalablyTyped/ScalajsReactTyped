...
trait PlotAreaAccessibilityPointOptions extends StObject {
...
object PlotAreaAccessibilityPointOptions {
  
  inline def apply(): PlotAreaAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaAccessibilityPointOptions]
  }
  
  extension [Self <: PlotAreaAccessibilityPointOptions](x: Self) {
