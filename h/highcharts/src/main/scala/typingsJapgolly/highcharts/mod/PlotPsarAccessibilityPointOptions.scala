...
trait PlotPsarAccessibilityPointOptions extends StObject {
...
object PlotPsarAccessibilityPointOptions {
  
  inline def apply(): PlotPsarAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarAccessibilityPointOptions]
  }
  
  extension [Self <: PlotPsarAccessibilityPointOptions](x: Self) {
