...
import typingsJapgolly.highcharts.highchartsStrings.vector
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesVectorOptions
  extends StObject
     with PlotVectorOptions {
...
object SeriesVectorOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | vector): SeriesVectorOptions = {
  ...
  extension [Self <: SeriesVectorOptions](x: Self) {
    ...
    inline def setDataVarargs(value: ((js.Tuple4[Double | String, Double, Double, Double]) | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value*))
    ...
    inline def setType(value: String | vector): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
