...
trait PlotOhlcTooltipOptions extends js.Object {
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotOhlcTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotOhlcTooltipOptions {
  ...
  def apply(
    ...
    dateTimeLabelFormats: PlotOhlcTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
