...
trait PlotHistogramOnPointPositionOptions extends StObject {
...
object PlotHistogramOnPointPositionOptions {
  
  inline def apply(): PlotHistogramOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramOnPointPositionOptions]
  }
  
  extension [Self <: PlotHistogramOnPointPositionOptions](x: Self) {
