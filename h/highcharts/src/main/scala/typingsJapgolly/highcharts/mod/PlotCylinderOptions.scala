...
trait PlotCylinderOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotCylinderAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotCylinderDataLabelsOptions | js.Array[PlotCylinderDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotCylinderDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotCylinderOnPointOptions] = js.undefined
...
object PlotCylinderOptions {
  ...
  inline def apply(): PlotCylinderOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderOptions]
  }
  
  extension [Self <: PlotCylinderOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotCylinderAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotCylinderDataLabelsOptions | js.Array[PlotCylinderDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotCylinderDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotCylinderDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotCylinderOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
