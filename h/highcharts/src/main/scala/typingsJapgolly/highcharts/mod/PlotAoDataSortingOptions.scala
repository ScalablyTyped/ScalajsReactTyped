...
trait PlotAoDataSortingOptions extends StObject {
...
object PlotAoDataSortingOptions {
  
  inline def apply(): PlotAoDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoDataSortingOptions]
  }
  
  extension [Self <: PlotAoDataSortingOptions](x: Self) {
