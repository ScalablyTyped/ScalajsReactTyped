...
trait PlotAtrAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotAtrAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotAtrAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotAtrAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotAtrAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotAtrAccessibilityOptions]
  }
}
