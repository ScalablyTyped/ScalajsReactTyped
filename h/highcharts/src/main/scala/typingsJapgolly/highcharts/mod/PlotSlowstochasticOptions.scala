...
trait PlotSlowstochasticOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotSlowstochasticAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  var dataLabels: js.UndefOr[
    PlotSlowstochasticDataLabelsOptions | js.Array[PlotSlowstochasticDataLabelsOptions]
  ] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotSlowstochasticDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotSlowstochasticOnPointOptions] = js.undefined
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotSlowstochasticParamsOptions] = js.undefined
  ...
  /**
    ...
    */
  var smoothedLine: js.UndefOr[PlotSlowstochasticSmoothedLineOptions] = js.undefined
...
object PlotSlowstochasticOptions {
  
  inline def apply(): PlotSlowstochasticOptions = {
  ...
  extension [Self <: PlotSlowstochasticOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotSlowstochasticAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotSlowstochasticDataLabelsOptions | js.Array[PlotSlowstochasticDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotSlowstochasticDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotSlowstochasticDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotSlowstochasticOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotSlowstochasticParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    inline def setSmoothedLine(value: PlotSlowstochasticSmoothedLineOptions): Self = StObject.set(x, "smoothedLine", value.asInstanceOf[js.Any])
    
    inline def setSmoothedLineUndefined: Self = StObject.set(x, "smoothedLine", js.undefined)
