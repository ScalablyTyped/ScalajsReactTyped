...
trait PlotPivotpointsOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotPivotpointsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotPivotpointsOptions {
  ...
  extension [Self <: PlotPivotpointsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotPivotpointsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
