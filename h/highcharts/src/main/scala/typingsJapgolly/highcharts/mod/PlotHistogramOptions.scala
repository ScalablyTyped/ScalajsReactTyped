...
import typingsJapgolly.highcharts.highchartsStrings.`square-root`
import typingsJapgolly.highcharts.highchartsStrings.rice
import typingsJapgolly.highcharts.highchartsStrings.sturges
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait PlotHistogramOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotHistogramAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotHistogramDataLabelsOptions | js.Array[PlotHistogramDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotHistogramDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotHistogramOnPointOptions] = js.undefined
...
object PlotHistogramOptions {
  
  inline def apply(): PlotHistogramOptions = {
  ...
  extension [Self <: PlotHistogramOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotHistogramAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setBinsNumber(value: rice | `square-root` | sturges | Double | js.Function): Self = StObject.set(x, "binsNumber", value.asInstanceOf[js.Any])
    
    inline def setBinsNumberUndefined: Self = StObject.set(x, "binsNumber", js.undefined)
    ...
    inline def setDataLabels(value: PlotHistogramDataLabelsOptions | js.Array[PlotHistogramDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotHistogramDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotHistogramDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotHistogramOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setPointPlacement(value: String): Self = StObject.set(x, "pointPlacement", value.asInstanceOf[js.Any])
