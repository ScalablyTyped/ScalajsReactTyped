...
trait PlotLinearregressioninterceptConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressioninterceptConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptConnectorsMarkerOptions]
  }
}
