...
trait PlotPyramid3dConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPyramid3dConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPyramid3dConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPyramid3dConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotPyramid3dConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotPyramid3dConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotPyramid3dConnectorsMarkerOptions = null,
    startMarker: PlotPyramid3dConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotPyramid3dConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotPyramid3dConnectorsOptions]
  }
}
