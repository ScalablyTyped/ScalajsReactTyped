...
import typingsJapgolly.highcharts.highchartsStrings.hlc
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesHlcOptions
  extends StObject
     with PlotHlcOptions {
...
object SeriesHlcOptions {
  ...
  extension [Self <: SeriesHlcOptions](x: Self) {
    ...
    inline def setDataVarargs(
      value: ((js.Tuple3[Double | String, Double, Double]) | (js.Tuple4[Double | String, Double, Double, Double]) | PointOptionsObject)*
    ...
    inline def setType(value: String | hlc): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
