...
trait PlotHlcOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotHlcAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotHlcDataLabelsOptions | js.Array[PlotHlcDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotHlcDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotHlcOnPointOptions] = js.undefined
...
object PlotHlcOptions {
  
  inline def apply(): PlotHlcOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcOptions]
  }
  
  extension [Self <: PlotHlcOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotHlcAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotHlcDataLabelsOptions | js.Array[PlotHlcDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotHlcDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotHlcDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotHlcOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
