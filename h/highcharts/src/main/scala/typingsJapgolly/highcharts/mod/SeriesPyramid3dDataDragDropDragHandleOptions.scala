...
trait SeriesPyramid3dDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesPyramid3dDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesPyramid3dDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesPyramid3dDataDragDropDragHandleOptions]
  }
}
