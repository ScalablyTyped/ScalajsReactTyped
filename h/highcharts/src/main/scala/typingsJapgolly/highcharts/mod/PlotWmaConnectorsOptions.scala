...
trait PlotWmaConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotWmaConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotWmaConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotWmaConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotWmaConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotWmaConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotWmaConnectorsMarkerOptions = null,
    startMarker: PlotWmaConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotWmaConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotWmaConnectorsOptions]
  }
}
