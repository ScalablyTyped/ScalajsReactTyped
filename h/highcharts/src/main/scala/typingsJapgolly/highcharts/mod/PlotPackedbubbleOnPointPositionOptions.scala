...
trait PlotPackedbubbleOnPointPositionOptions extends StObject {
...
object PlotPackedbubbleOnPointPositionOptions {
  
  inline def apply(): PlotPackedbubbleOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleOnPointPositionOptions]
  }
  
  extension [Self <: PlotPackedbubbleOnPointPositionOptions](x: Self) {
