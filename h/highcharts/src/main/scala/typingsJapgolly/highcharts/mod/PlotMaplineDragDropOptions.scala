...
trait PlotMaplineDragDropOptions extends js.Object {
  /**
    * (Highmaps) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotMaplineDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotMaplineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotMaplineDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotMaplineDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotMaplineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotMaplineDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotMaplineDragDropOptions]
  }
}
