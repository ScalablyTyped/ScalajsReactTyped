...
trait SeriesPyramid3dDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesPyramid3dDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesPyramid3dDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesPyramid3dDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesPyramid3dDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesPyramid3dDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesPyramid3dDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesPyramid3dDataDragDropOptions]
  }
}
