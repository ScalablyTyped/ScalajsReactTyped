...
trait PlotCmoDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotCmoDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotCmoDataLabelsOptions {
  
  inline def apply(): PlotCmoDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoDataLabelsOptions]
  }
  
  extension [Self <: PlotCmoDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotCmoDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
