...
trait PlotScatter3dOnPointPositionOptions extends StObject {
...
object PlotScatter3dOnPointPositionOptions {
  
  inline def apply(): PlotScatter3dOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dOnPointPositionOptions]
  }
  
  extension [Self <: PlotScatter3dOnPointPositionOptions](x: Self) {
