...
import typingsJapgolly.highcharts.highchartsStrings.linearregressionangle
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesLinearregressionangleOptions
  extends StObject
     with PlotLinearregressionangleOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | linearregressionangle
...
object SeriesLinearregressionangleOptions {
  
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | linearregressionangle): SeriesLinearregressionangleOptions = {
    val __obj = js.Dynamic.literal(dataParser = dataParser.asInstanceOf[js.Any], dataURL = dataURL.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesLinearregressionangleOptions]
  }
  
  extension [Self <: SeriesLinearregressionangleOptions](x: Self) {
    ...
    inline def setType(value: String | linearregressionangle): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
