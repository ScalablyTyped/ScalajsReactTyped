...
trait PlotPyramid3dOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotPyramid3dDataLabelsOptions | js.Array[PlotPyramid3dDataLabelsOptions]] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotPyramid3dOnPointOptions] = js.undefined
...
object PlotPyramid3dOptions {
  ...
  inline def apply(): PlotPyramid3dOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dOptions]
  }
  
  extension [Self <: PlotPyramid3dOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotPyramid3dAnimationOptions): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotPyramid3dDataLabelsOptions | js.Array[PlotPyramid3dDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotPyramid3dDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    ...
    inline def setOnPoint(value: js.Object | PlotPyramid3dOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
