...
trait PlotMacdPointEventsOptions extends js.Object {
  /**
...
object PlotMacdPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotMacdPointEventsOptions]
  }
}
