...
trait PlotSeriesDataSortingOptions extends StObject {
...
object PlotSeriesDataSortingOptions {
  
  inline def apply(): PlotSeriesDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesDataSortingOptions]
  }
  
  extension [Self <: PlotSeriesDataSortingOptions](x: Self) {
