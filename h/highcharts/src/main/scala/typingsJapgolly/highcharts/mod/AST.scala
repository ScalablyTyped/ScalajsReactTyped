...
open class AST protected () extends StObject {
  ...
  /**
    ...
    */
  def addToDOM(parent: HTMLElement): HTMLElement | org.scalajs.dom.SVGElement = js.native
  def addToDOM(parent: org.scalajs.dom.SVGElement): HTMLElement | org.scalajs.dom.SVGElement = js.native
  ...
  /**
    ...
    *        Markup string
    */
  def setElementHTML(el: HTMLElement, html: String): Unit = js.native
  def setElementHTML(el: org.scalajs.dom.SVGElement, html: String): Unit = js.native
}
/* static members */
object AST {
