...
trait PlotApoDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotApoDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotApoDataLabelsOptions {
  
  inline def apply(): PlotApoDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoDataLabelsOptions]
  }
  
  extension [Self <: PlotApoDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotApoDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
