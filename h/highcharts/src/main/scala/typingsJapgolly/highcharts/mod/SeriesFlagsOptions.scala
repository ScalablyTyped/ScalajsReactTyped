...
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesFlagsOptions
  extends StObject
...
object SeriesFlagsOptions {
  ...
  extension [Self <: SeriesFlagsOptions](x: Self) {
