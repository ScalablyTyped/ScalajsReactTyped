...
trait PlotWilliamsrOnPointPositionOptions extends StObject {
...
object PlotWilliamsrOnPointPositionOptions {
  
  inline def apply(): PlotWilliamsrOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrOnPointPositionOptions]
  }
  
  extension [Self <: PlotWilliamsrOnPointPositionOptions](x: Self) {
