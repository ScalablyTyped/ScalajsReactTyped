...
trait PlotAreasplinerangeAccessibilityPointOptions extends StObject {
...
object PlotAreasplinerangeAccessibilityPointOptions {
  
  inline def apply(): PlotAreasplinerangeAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeAccessibilityPointOptions]
  }
  
  extension [Self <: PlotAreasplinerangeAccessibilityPointOptions](x: Self) {
