...
trait PlotBubbleMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotBubbleMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBubbleMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotBubbleMarkerStatesHoverOptions]
  }
}
