...
trait PlotAreaPointEventsOptions extends js.Object {
  /**
...
object PlotAreaPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotAreaPointEventsOptions]
  }
}
