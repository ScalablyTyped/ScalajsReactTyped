...
trait PlotXrangeOnPointPositionOptions extends StObject {
...
object PlotXrangeOnPointPositionOptions {
  
  inline def apply(): PlotXrangeOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeOnPointPositionOptions]
  }
  
  extension [Self <: PlotXrangeOnPointPositionOptions](x: Self) {
