...
trait PlotPcDataGroupingOptions extends js.Object {
  /**
...
object PlotPcDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPcDataGroupingOptions]
  }
}
