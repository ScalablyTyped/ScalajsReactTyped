...
trait PlotDemaAccessibilityPointOptions extends StObject {
...
object PlotDemaAccessibilityPointOptions {
  
  inline def apply(): PlotDemaAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaAccessibilityPointOptions]
  }
  
  extension [Self <: PlotDemaAccessibilityPointOptions](x: Self) {
