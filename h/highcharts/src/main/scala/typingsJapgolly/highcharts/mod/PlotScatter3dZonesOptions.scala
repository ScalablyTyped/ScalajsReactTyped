...
trait PlotScatter3dZonesOptions extends js.Object {
  /**
...
object PlotScatter3dZonesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotScatter3dZonesOptions]
  }
}
