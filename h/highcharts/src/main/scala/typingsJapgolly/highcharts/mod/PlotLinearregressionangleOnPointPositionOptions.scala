...
trait PlotLinearregressionangleOnPointPositionOptions extends StObject {
...
object PlotLinearregressionangleOnPointPositionOptions {
  
  inline def apply(): PlotLinearregressionangleOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleOnPointPositionOptions]
  }
  
  extension [Self <: PlotLinearregressionangleOnPointPositionOptions](x: Self) {
