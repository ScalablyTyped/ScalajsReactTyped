...
trait PlotDisparityindexDataLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | PlotDisparityindexDataLabelsAnimationOptions | PartialAnimationOptionsOb
  ] = js.undefined
...
object PlotDisparityindexDataLabelsOptions {
  
  inline def apply(): PlotDisparityindexDataLabelsOptions = {
  ...
  extension [Self <: PlotDisparityindexDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotDisparityindexDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
