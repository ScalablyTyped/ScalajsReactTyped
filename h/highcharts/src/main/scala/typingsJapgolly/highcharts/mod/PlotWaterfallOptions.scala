...
trait PlotWaterfallOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotWaterfallAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotWaterfallDataSortingOptions] = js.undefined
...
object PlotWaterfallOptions {
  ...
  inline def apply(): PlotWaterfallOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallOptions]
  }
  
  extension [Self <: PlotWaterfallOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotWaterfallAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotWaterfallDataLabelsOptions | js.Array[PlotWaterfallDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
