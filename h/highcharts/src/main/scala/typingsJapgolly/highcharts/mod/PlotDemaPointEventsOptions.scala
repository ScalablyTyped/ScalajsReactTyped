...
trait PlotDemaPointEventsOptions extends js.Object {
  /**
...
object PlotDemaPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotDemaPointEventsOptions]
  }
}
