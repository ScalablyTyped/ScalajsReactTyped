...
trait SeriesOrganizationDataEventsOptions extends js.Object {
  /**
...
object SeriesOrganizationDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesOrganizationDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesOrganizationDataEventsOptions]
  }
}
