...
import typingsJapgolly.highcharts.highchartsStrings.momentum
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesMomentumOptions
  extends StObject
     with PlotMomentumOptions {
...
object SeriesMomentumOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | momentum): SeriesMomentumOptions = {
  ...
  extension [Self <: SeriesMomentumOptions](x: Self) {
    ...
    inline def setType(value: String | momentum): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
