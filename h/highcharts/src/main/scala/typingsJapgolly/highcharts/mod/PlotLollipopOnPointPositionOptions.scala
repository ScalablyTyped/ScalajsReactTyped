...
trait PlotLollipopOnPointPositionOptions extends StObject {
...
object PlotLollipopOnPointPositionOptions {
  
  inline def apply(): PlotLollipopOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopOnPointPositionOptions]
  }
  
  extension [Self <: PlotLollipopOnPointPositionOptions](x: Self) {
