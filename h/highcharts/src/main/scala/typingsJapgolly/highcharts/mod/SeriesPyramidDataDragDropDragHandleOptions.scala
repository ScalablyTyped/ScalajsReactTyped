...
trait SeriesPyramidDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesPyramidDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesPyramidDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesPyramidDataDragDropDragHandleOptions]
  }
}
