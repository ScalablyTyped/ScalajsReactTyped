...
trait PlotWindbarbAccessibilityPointOptions extends StObject {
...
object PlotWindbarbAccessibilityPointOptions {
  
  inline def apply(): PlotWindbarbAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbAccessibilityPointOptions]
  }
  
  extension [Self <: PlotWindbarbAccessibilityPointOptions](x: Self) {
