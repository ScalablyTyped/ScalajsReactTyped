...
trait PlotHlcOnPointPositionOptions extends StObject {
...
object PlotHlcOnPointPositionOptions {
  
  inline def apply(): PlotHlcOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcOnPointPositionOptions]
  }
  
  extension [Self <: PlotHlcOnPointPositionOptions](x: Self) {
