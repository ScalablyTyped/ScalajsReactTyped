...
trait PlotSplineStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotSplineStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSplineStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotSplineStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotSplineStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotSplineStatesSelectOptions]
  }
}
