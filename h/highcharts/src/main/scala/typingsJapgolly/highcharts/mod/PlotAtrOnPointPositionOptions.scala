...
trait PlotAtrOnPointPositionOptions extends StObject {
...
object PlotAtrOnPointPositionOptions {
  
  inline def apply(): PlotAtrOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrOnPointPositionOptions]
  }
  
  extension [Self <: PlotAtrOnPointPositionOptions](x: Self) {
