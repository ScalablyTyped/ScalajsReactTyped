...
trait PlotCmfMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotCmfMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCmfMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotCmfMarkerStatesHoverOptions]
  }
}
