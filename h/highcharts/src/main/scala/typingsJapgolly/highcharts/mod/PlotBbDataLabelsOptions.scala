...
trait PlotBbDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotBbDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotBbDataLabelsOptions {
  
  inline def apply(): PlotBbDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbDataLabelsOptions]
  }
  
  extension [Self <: PlotBbDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotBbDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
