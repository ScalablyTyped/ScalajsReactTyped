...
trait PlotTemaConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotTemaConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTemaConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTemaConnectorsStartMarkerOptions]
  }
}
