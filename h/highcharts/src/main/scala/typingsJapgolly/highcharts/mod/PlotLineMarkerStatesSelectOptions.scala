...
trait PlotLineMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLineMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLineMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLineMarkerStatesSelectOptions]
  }
}
