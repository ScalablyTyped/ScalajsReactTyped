...
object ChartParallelAxesOptions {
  ...
  inline def apply(): ChartParallelAxesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesOptions]
  }
  
  extension [Self <: ChartParallelAxesOptions](x: Self) {
    ...
    inline def setEvents(value: ChartParallelAxesEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setResize(value: ChartParallelAxesResizeOptions): Self = StObject.set(x, "resize", value.asInstanceOf[js.Any])
    ...
    inline def setTitle(value: ChartParallelAxesTitleOptions): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
