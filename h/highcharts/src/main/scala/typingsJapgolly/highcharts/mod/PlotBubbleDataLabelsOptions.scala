...
trait PlotBubbleDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotBubbleDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotBubbleDataLabelsOptions {
  
  inline def apply(): PlotBubbleDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleDataLabelsOptions]
  }
  
  extension [Self <: PlotBubbleDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotBubbleDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
