...
trait PlotCandlestickOnPointPositionOptions extends StObject {
...
object PlotCandlestickOnPointPositionOptions {
  
  inline def apply(): PlotCandlestickOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickOnPointPositionOptions]
  }
  
  extension [Self <: PlotCandlestickOnPointPositionOptions](x: Self) {
