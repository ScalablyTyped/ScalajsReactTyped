...
trait PlotCandlestickZonesOptions extends js.Object {
  /**
...
object PlotCandlestickZonesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotCandlestickZonesOptions]
  }
}
