...
trait PlotPpoOnPointPositionOptions extends StObject {
...
object PlotPpoOnPointPositionOptions {
  
  inline def apply(): PlotPpoOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoOnPointPositionOptions]
  }
  
  extension [Self <: PlotPpoOnPointPositionOptions](x: Self) {
