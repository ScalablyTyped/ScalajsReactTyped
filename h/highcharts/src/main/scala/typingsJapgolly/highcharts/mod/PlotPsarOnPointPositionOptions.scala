...
trait PlotPsarOnPointPositionOptions extends StObject {
...
object PlotPsarOnPointPositionOptions {
  
  inline def apply(): PlotPsarOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarOnPointPositionOptions]
  }
  
  extension [Self <: PlotPsarOnPointPositionOptions](x: Self) {
