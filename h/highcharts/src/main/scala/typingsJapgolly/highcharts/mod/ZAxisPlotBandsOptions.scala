...
object ZAxisPlotBandsOptions {
  ...
  inline def apply(): ZAxisPlotBandsOptions = {
  ...
  extension [Self <: ZAxisPlotBandsOptions](x: Self) {
    ...
    inline def setEvents(value: ZAxisPlotBandsEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setLabel(value: ZAxisPlotBandsLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
