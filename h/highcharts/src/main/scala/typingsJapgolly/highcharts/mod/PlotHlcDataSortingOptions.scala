...
trait PlotHlcDataSortingOptions extends StObject {
...
object PlotHlcDataSortingOptions {
  
  inline def apply(): PlotHlcDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcDataSortingOptions]
  }
  
  extension [Self <: PlotHlcDataSortingOptions](x: Self) {
