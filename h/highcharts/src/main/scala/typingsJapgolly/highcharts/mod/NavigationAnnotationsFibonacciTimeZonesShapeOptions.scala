...
trait NavigationAnnotationsFibonacciTimeZonesShapeOptions extends StObject {
...
object NavigationAnnotationsFibonacciTimeZonesShapeOptions {
  
  inline def apply(): NavigationAnnotationsFibonacciTimeZonesShapeOptions = {
