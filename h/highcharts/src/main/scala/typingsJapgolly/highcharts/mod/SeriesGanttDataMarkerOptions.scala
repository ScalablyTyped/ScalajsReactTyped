...
trait SeriesGanttDataMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesGanttDataMarkerStatesOptions] = js.undefined
  /**
...
object SeriesGanttDataMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: SeriesGanttDataMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): SeriesGanttDataMarkerOptions = {
    ...
    __obj.asInstanceOf[SeriesGanttDataMarkerOptions]
  }
}
