...
trait PlotHistogramAccessibilityPointOptions extends StObject {
...
object PlotHistogramAccessibilityPointOptions {
  
  inline def apply(): PlotHistogramAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramAccessibilityPointOptions]
  }
  
  extension [Self <: PlotHistogramAccessibilityPointOptions](x: Self) {
