...
trait PlotVennOnPointPositionOptions extends StObject {
...
object PlotVennOnPointPositionOptions {
  
  inline def apply(): PlotVennOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennOnPointPositionOptions]
  }
  
  extension [Self <: PlotVennOnPointPositionOptions](x: Self) {
