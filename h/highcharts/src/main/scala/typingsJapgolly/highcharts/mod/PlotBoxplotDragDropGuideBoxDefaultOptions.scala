...
trait PlotBoxplotDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotBoxplotDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBoxplotDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotBoxplotDragDropGuideBoxDefaultOptions]
  }
}
