...
trait PlotStreamgraphMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotStreamgraphMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStreamgraphMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphMarkerStatesSelectOptions]
  }
}
