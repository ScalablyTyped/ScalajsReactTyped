...
trait PlotTemaTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotTemaTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotTemaTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotTemaTooltipDateTimeLabelFormatsOptions]
  }
}
