...
trait PlotPcDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotPcDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotPcDataLabelsOptions {
  ...
  inline def apply(): PlotPcDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcDataLabelsOptions]
  }
  
  extension [Self <: PlotPcDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotPcDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
