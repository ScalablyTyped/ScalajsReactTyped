...
trait PlotScatterMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotScatterMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatterMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotScatterMarkerStatesSelectOptions]
  }
}
