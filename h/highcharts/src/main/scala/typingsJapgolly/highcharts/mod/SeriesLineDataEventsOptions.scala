...
trait SeriesLineDataEventsOptions extends js.Object {
  /**
...
object SeriesLineDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesLineDataEventsOptions]
  }
}
