...
object DataOptions {
  @scala.inline
  def apply(
    beforeParse: /* csv */ String => CallbackTo[String] = null,
    columns: js.Array[js.Array[DataValueType]] = null,
    columnsURL: String = null,
    complete: /* chartOptions */ Options => Callback = null,
    csv: String = null,
    csvURL: String = null,
    ...
    parseDate: /* dateValue */ String => CallbackTo[Double] = null,
    parsed: /* columns */ js.Array[js.Array[js.Any]] => CallbackTo[js.UndefOr[Boolean]] = null,
    ...
    if (beforeParse != null) __obj.updateDynamic("beforeParse")(js.Any.fromFunction1((t0: /* csv */ java.lang.String) => beforeParse(t0).runNow()))
    if (columns != null) __obj.updateDynamic("columns")(columns.asInstanceOf[js.Any])
    if (columnsURL != null) __obj.updateDynamic("columnsURL")(columnsURL.asInstanceOf[js.Any])
    if (complete != null) __obj.updateDynamic("complete")(js.Any.fromFunction1((t0: /* chartOptions */ typingsJapgolly.highcharts.mod.Options) => complete(t0).runNow()))
    ...
    if (parseDate != null) __obj.updateDynamic("parseDate")(js.Any.fromFunction1((t0: /* dateValue */ java.lang.String) => parseDate(t0).runNow()))
    if (parsed != null) __obj.updateDynamic("parsed")(js.Any.fromFunction1((t0: /* columns */ js.Array[js.Array[js.Any]]) => parsed(t0).runNow()))
