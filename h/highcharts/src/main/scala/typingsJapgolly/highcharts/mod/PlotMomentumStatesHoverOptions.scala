...
trait PlotMomentumStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMomentumStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMomentumStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotMomentumStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMomentumStatesHoverAnimationOptions = null,
  ...
  ): PlotMomentumStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumStatesHoverOptions]
  }
}
