...
trait PlotMomentumDataSortingOptions extends StObject {
...
object PlotMomentumDataSortingOptions {
  
  inline def apply(): PlotMomentumDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumDataSortingOptions]
  }
  
  extension [Self <: PlotMomentumDataSortingOptions](x: Self) {
