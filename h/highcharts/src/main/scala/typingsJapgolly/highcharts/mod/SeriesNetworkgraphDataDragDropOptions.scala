...
trait SeriesNetworkgraphDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesNetworkgraphDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesNetworkgraphDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesNetworkgraphDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesNetworkgraphDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesNetworkgraphDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesNetworkgraphDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesNetworkgraphDataDragDropOptions]
  }
}
