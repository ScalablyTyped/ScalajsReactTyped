...
trait PlotRsiConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotRsiConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotRsiConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotRsiConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotRsiConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotRsiConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotRsiConnectorsMarkerOptions = null,
    startMarker: PlotRsiConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotRsiConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotRsiConnectorsOptions]
  }
}
