...
trait PlotPcConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPcConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPcConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPcConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotPcConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotPcConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotPcConnectorsMarkerOptions = null,
    startMarker: PlotPcConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotPcConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotPcConnectorsOptions]
  }
}
