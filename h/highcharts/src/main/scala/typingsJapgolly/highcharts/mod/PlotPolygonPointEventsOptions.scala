...
trait PlotPolygonPointEventsOptions extends js.Object {
  /**
...
object PlotPolygonPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPolygonPointEventsOptions]
  }
}
