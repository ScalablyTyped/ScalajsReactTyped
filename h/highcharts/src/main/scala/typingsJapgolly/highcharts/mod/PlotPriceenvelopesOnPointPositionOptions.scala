...
trait PlotPriceenvelopesOnPointPositionOptions extends StObject {
...
object PlotPriceenvelopesOnPointPositionOptions {
  
  inline def apply(): PlotPriceenvelopesOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesOnPointPositionOptions]
  }
  
  extension [Self <: PlotPriceenvelopesOnPointPositionOptions](x: Self) {
