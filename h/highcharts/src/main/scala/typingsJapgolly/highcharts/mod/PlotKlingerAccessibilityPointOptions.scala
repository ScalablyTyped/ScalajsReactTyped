...
trait PlotKlingerAccessibilityPointOptions extends StObject {
...
object PlotKlingerAccessibilityPointOptions {
  
  inline def apply(): PlotKlingerAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerAccessibilityPointOptions]
  }
  
  extension [Self <: PlotKlingerAccessibilityPointOptions](x: Self) {
