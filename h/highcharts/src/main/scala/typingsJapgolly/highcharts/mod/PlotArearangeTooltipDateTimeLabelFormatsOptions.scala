...
trait PlotArearangeTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotArearangeTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotArearangeTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeTooltipDateTimeLabelFormatsOptions]
  }
}
