...
trait PlotIkhAccessibilityPointOptions extends StObject {
...
object PlotIkhAccessibilityPointOptions {
  
  inline def apply(): PlotIkhAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhAccessibilityPointOptions]
  }
  
  extension [Self <: PlotIkhAccessibilityPointOptions](x: Self) {
