...
trait TimelineDataLabelsFormatterContextObject
  extends StObject
     with PointLabelObject
object TimelineDataLabelsFormatterContextObject {
  
  inline def apply(colorIndex: Double, percentage: Double, point: Point, series: Series): TimelineDataLabelsFormatterContextObject = {
