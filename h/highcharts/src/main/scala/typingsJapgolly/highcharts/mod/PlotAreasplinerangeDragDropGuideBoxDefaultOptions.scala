...
trait PlotAreasplinerangeDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotAreasplinerangeDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplinerangeDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplinerangeDragDropGuideBoxDefaultOptions]
  }
}
