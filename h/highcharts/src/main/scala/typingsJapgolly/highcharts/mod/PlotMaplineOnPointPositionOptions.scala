...
trait PlotMaplineOnPointPositionOptions extends StObject {
...
object PlotMaplineOnPointPositionOptions {
  
  inline def apply(): PlotMaplineOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineOnPointPositionOptions]
  }
  
  extension [Self <: PlotMaplineOnPointPositionOptions](x: Self) {
