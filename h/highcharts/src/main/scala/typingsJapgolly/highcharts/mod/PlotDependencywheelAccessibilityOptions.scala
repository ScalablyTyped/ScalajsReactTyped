...
trait PlotDependencywheelAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotDependencywheelAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotDependencywheelAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotDependencywheelAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotDependencywheelAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotDependencywheelAccessibilityOptions]
  }
}
