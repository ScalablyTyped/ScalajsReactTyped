...
trait PlotColumnrangePointEventsOptions extends js.Object {
  /**
...
object PlotColumnrangePointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotColumnrangePointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotColumnrangePointEventsOptions]
  }
}
