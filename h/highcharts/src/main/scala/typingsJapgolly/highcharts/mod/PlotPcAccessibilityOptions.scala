...
trait PlotPcAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPcAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotPcAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotPcAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotPcAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotPcAccessibilityOptions]
  }
}
