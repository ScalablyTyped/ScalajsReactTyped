...
trait SeriesLineDataDragDropOptions extends StObject {
  ...
  var guideBox: js.UndefOr[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 52, starting with typingsJapgolly.highcharts.mod.SeriesAreaDataDragDropGuideBoxOptions, typingsJapgolly.highcharts.mod.SeriesArearangeDataDragDropGuideBoxOptions, typingsJapgolly.highcharts.mod.SeriesAreasplineDataDragDropGuideBoxOptions */ Any
  ] = js.undefined
...
object SeriesLineDataDragDropOptions {
  ...
  extension [Self <: SeriesLineDataDragDropOptions](x: Self) {
    ...
    inline def setGuideBox(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 52, starting with typingsJapgolly.highcharts.mod.SeriesAreaDataDragDropGuideBoxOptions, typingsJapgolly.highcharts.mod.SeriesArearangeDataDragDropGuideBoxOptions, typingsJapgolly.highcharts.mod.SeriesAreasplineDataDragDropGuideBoxOptions */ Any
