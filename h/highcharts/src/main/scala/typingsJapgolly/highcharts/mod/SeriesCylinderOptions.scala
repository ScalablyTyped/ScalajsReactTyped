...
import typingsJapgolly.highcharts.highchartsStrings.cylinder
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesCylinderOptions
  extends StObject
     with PlotCylinderOptions {
...
object SeriesCylinderOptions {
  ...
  inline def apply(`type`: String | cylinder): SeriesCylinderOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesCylinderOptions]
  }
  
  extension [Self <: SeriesCylinderOptions](x: Self) {
    ...
    inline def setType(value: String | cylinder): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
