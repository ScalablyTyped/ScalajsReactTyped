...
trait PlotLinearregressionslopeEventsOptions extends js.Object {
  /**
...
object PlotLinearregressionslopeEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopeEventsOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeEventsOptions]
  }
}
