...
trait PlotScatter3dConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotScatter3dConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotScatter3dConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotScatter3dConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotScatter3dConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotScatter3dConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotScatter3dConnectorsMarkerOptions = null,
    startMarker: PlotScatter3dConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotScatter3dConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dConnectorsOptions]
  }
}
