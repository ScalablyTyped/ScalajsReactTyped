...
import typingsJapgolly.highcharts.highchartsStrings.vbp
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesVbpOptions
  extends StObject
     with PlotVbpOptions {
...
object SeriesVbpOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | vbp): SeriesVbpOptions = {
  ...
  extension [Self <: SeriesVbpOptions](x: Self) {
    ...
    inline def setType(value: String | vbp): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
