...
trait PlotAtrConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotAtrConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAtrConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotAtrConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotAtrConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotAtrConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotAtrConnectorsMarkerOptions = null,
    startMarker: PlotAtrConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotAtrConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotAtrConnectorsOptions]
  }
}
