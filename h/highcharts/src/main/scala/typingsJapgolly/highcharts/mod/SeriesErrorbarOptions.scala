...
import typingsJapgolly.highcharts.highchartsStrings.errorbar
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesErrorbarOptions
  extends StObject
     with PlotErrorbarOptions {
...
object SeriesErrorbarOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | errorbar): SeriesErrorbarOptions = {
  ...
  extension [Self <: SeriesErrorbarOptions](x: Self) {
    ...
    inline def setType(value: String | errorbar): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
