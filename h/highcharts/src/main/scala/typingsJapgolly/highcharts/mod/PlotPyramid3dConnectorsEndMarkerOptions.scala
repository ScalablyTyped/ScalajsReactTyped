...
trait PlotPyramid3dConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotPyramid3dConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPyramid3dConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPyramid3dConnectorsEndMarkerOptions]
  }
}
