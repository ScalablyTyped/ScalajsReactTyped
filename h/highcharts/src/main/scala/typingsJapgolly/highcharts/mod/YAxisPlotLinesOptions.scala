...
object YAxisPlotLinesOptions {
  ...
  inline def apply(): YAxisPlotLinesOptions = {
  ...
  extension [Self <: YAxisPlotLinesOptions](x: Self) {
    ...
    inline def setEvents(value: YAxisPlotLinesEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setLabel(value: YAxisPlotLinesLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
