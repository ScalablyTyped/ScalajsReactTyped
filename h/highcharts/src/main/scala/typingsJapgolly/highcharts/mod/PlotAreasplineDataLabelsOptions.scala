...
trait PlotAreasplineDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotAreasplineDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotAreasplineDataLabelsOptions {
  ...
  inline def apply(): PlotAreasplineDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineDataLabelsOptions]
  }
  
  extension [Self <: PlotAreasplineDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotAreasplineDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
