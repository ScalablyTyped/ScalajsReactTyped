...
trait PlotOrganizationConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotOrganizationConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotOrganizationConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotOrganizationConnectorsEndMarkerOptions]
  }
}
