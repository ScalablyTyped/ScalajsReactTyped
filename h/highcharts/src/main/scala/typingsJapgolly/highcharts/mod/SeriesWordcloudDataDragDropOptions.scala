...
trait SeriesWordcloudDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesWordcloudDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesWordcloudDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesWordcloudDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesWordcloudDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesWordcloudDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesWordcloudDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesWordcloudDataDragDropOptions]
  }
}
