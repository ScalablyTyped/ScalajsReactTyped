...
trait PlotMappointConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotMappointConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMappointConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMappointConnectorsStartMarkerOptions]
  }
}
