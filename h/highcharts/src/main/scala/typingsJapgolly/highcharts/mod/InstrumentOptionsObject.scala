...
trait InstrumentOptionsObject extends StObject {
  ...
  var oscillator: js.UndefOr[
    typingsJapgolly.highcharts.modulesSonificationMod.highchartsAugmentingMod.OscillatorOptionsObject
  ] = js.undefined
...
object InstrumentOptionsObject {
  ...
  extension [Self <: InstrumentOptionsObject](x: Self) {
    ...
    inline def setOscillator(
      value: typingsJapgolly.highcharts.modulesSonificationMod.highchartsAugmentingMod.OscillatorOptionsObject
    ): Self = StObject.set(x, "oscillator", value.asInstanceOf[js.Any])
