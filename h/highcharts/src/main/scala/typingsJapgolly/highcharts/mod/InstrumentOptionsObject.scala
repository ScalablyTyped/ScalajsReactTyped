...
trait InstrumentOptionsObject extends js.Object {
  ...
  var oscillator: js.UndefOr[
    typingsJapgolly.highcharts.sonificationMod.highchartsAugmentingMod.OscillatorOptionsObject
  ] = js.undefined
  /**
...
object InstrumentOptionsObject {
  ...
  def apply(
    ...
    id: String = null,
    oscillator: typingsJapgolly.highcharts.sonificationMod.highchartsAugmentingMod.OscillatorOptionsObject = null,
