...
trait PlotErrorbarDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotErrorbarDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotErrorbarDataLabelsOptions {
  ...
  inline def apply(): PlotErrorbarDataLabelsOptions = {
  ...
  extension [Self <: PlotErrorbarDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotErrorbarDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
