...
trait PlotMapConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotMapConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMapConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotMapConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotMapConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotMapConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotMapConnectorsMarkerOptions = null,
    startMarker: PlotMapConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotMapConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotMapConnectorsOptions]
  }
}
