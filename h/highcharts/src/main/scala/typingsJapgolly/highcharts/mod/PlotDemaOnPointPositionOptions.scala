...
trait PlotDemaOnPointPositionOptions extends StObject {
...
object PlotDemaOnPointPositionOptions {
  
  inline def apply(): PlotDemaOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaOnPointPositionOptions]
  }
  
  extension [Self <: PlotDemaOnPointPositionOptions](x: Self) {
