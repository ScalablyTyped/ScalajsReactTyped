...
trait PlotLineConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotLineConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLineConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLineConnectorsStartMarkerOptions]
  }
}
