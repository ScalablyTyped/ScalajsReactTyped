...
trait PlotBellcurveOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotBellcurveAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotBellcurveDataLabelsOptions | js.Array[PlotBellcurveDataLabelsOptions]] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotBellcurveOnPointOptions] = js.undefined
...
object PlotBellcurveOptions {
  ...
  inline def apply(): PlotBellcurveOptions = {
  ...
  extension [Self <: PlotBellcurveOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotBellcurveAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotBellcurveDataLabelsOptions | js.Array[PlotBellcurveDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotBellcurveDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotBellcurveDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setIntervals(value: Double): Self = StObject.set(x, "intervals", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotBellcurveOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setPointsInInterval(value: Double): Self = StObject.set(x, "pointsInInterval", value.asInstanceOf[js.Any])
    
    inline def setPointsInIntervalUndefined: Self = StObject.set(x, "pointsInInterval", js.undefined)
