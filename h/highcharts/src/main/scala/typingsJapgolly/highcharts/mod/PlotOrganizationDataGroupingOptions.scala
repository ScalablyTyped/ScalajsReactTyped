...
trait PlotOrganizationDataGroupingOptions extends js.Object {
  /**
...
object PlotOrganizationDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotOrganizationDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotOrganizationDataGroupingOptions]
  }
}
