...
trait PlotSplineOnPointPositionOptions extends StObject {
...
object PlotSplineOnPointPositionOptions {
  
  inline def apply(): PlotSplineOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineOnPointPositionOptions]
  }
  
  extension [Self <: PlotSplineOnPointPositionOptions](x: Self) {
