...
trait PlotFunnel3dAccessibilityPointOptions extends StObject {
...
object PlotFunnel3dAccessibilityPointOptions {
  
  inline def apply(): PlotFunnel3dAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dAccessibilityPointOptions]
  }
  
  extension [Self <: PlotFunnel3dAccessibilityPointOptions](x: Self) {
