...
trait PlotHeatmapOnPointOptions extends StObject {
  ...
  /**
    ...
    */
  var connectorOptions: js.UndefOr[PlotHeatmapOnPointConnectorOptions | SVGAttributes] = js.undefined
  ...
  /**
    ...
    */
  var position: js.UndefOr[js.Object | PlotHeatmapOnPointPositionOptions] = js.undefined
}
object PlotHeatmapOnPointOptions {
  
  inline def apply(): PlotHeatmapOnPointOptions = {
  ...
  extension [Self <: PlotHeatmapOnPointOptions](x: Self) {
    ...
    inline def setPosition(value: js.Object | PlotHeatmapOnPointPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
