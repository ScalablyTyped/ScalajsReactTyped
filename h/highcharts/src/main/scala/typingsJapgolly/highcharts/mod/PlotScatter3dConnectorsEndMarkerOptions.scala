...
trait PlotScatter3dConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotScatter3dConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatter3dConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dConnectorsEndMarkerOptions]
  }
}
