...
trait PlotMacdAccessibilityPointOptions extends StObject {
...
object PlotMacdAccessibilityPointOptions {
  
  inline def apply(): PlotMacdAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdAccessibilityPointOptions]
  }
  
  extension [Self <: PlotMacdAccessibilityPointOptions](x: Self) {
