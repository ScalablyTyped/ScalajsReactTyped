...
trait PlotBulletDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotBulletDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotBulletDataLabelsOptions {
  ...
  inline def apply(): PlotBulletDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletDataLabelsOptions]
  }
  
  extension [Self <: PlotBulletDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotBulletDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
