...
trait PlotVariwideOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotVariwideAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotVariwideDataLabelsOptions | js.Array[PlotVariwideDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotVariwideDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotVariwideOnPointOptions] = js.undefined
...
object PlotVariwideOptions {
  
  inline def apply(): PlotVariwideOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideOptions]
  }
  
  extension [Self <: PlotVariwideOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotVariwideAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotVariwideDataLabelsOptions | js.Array[PlotVariwideDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotVariwideDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotVariwideDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotVariwideOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
