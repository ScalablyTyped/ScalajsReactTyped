...
trait PlotAreasplinerangePointEventsOptions extends js.Object {
  /**
...
object PlotAreasplinerangePointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplinerangePointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplinerangePointEventsOptions]
  }
}
