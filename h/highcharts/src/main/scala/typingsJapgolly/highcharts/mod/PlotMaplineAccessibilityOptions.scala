...
trait PlotMaplineAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotMaplineAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotMaplineAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotMaplineAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotMaplineAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotMaplineAccessibilityOptions]
  }
}
