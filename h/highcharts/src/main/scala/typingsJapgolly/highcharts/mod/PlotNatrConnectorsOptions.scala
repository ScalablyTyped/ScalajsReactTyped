...
trait PlotNatrConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotNatrConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotNatrConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotNatrConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotNatrConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotNatrConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotNatrConnectorsMarkerOptions = null,
    startMarker: PlotNatrConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotNatrConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotNatrConnectorsOptions]
  }
}
