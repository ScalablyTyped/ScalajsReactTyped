...
trait PlotStreamgraphDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotStreamgraphDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotStreamgraphDataLabelsOptions {
  ...
  inline def apply(): PlotStreamgraphDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphDataLabelsOptions]
  }
  
  extension [Self <: PlotStreamgraphDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotStreamgraphDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
