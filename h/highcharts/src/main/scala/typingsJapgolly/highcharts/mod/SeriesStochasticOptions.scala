...
import typingsJapgolly.highcharts.highchartsStrings.stochastic
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesStochasticOptions
  extends StObject
     with PlotStochasticOptions {
...
object SeriesStochasticOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | stochastic): SeriesStochasticOptions = {
  ...
  extension [Self <: SeriesStochasticOptions](x: Self) {
    ...
    inline def setType(value: String | stochastic): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
