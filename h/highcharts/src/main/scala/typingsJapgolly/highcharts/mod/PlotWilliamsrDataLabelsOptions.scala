...
trait PlotWilliamsrDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotWilliamsrDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotWilliamsrDataLabelsOptions {
  
  inline def apply(): PlotWilliamsrDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrDataLabelsOptions]
  }
  
  extension [Self <: PlotWilliamsrDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotWilliamsrDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
