...
trait PlotSplineAccessibilityPointOptions extends StObject {
...
object PlotSplineAccessibilityPointOptions {
  
  inline def apply(): PlotSplineAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineAccessibilityPointOptions]
  }
  
  extension [Self <: PlotSplineAccessibilityPointOptions](x: Self) {
