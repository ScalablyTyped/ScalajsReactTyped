...
trait SeriesAreasplinerangeDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesAreasplinerangeDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesAreasplinerangeDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesAreasplinerangeDataDragDropDragHandleOptions]
  }
}
