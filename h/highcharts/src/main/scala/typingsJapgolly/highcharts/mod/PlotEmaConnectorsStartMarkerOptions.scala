...
trait PlotEmaConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotEmaConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotEmaConnectorsStartMarkerOptions]
  }
}
