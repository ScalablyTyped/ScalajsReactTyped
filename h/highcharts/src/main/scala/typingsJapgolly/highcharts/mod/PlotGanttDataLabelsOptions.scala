...
trait PlotGanttDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotGanttDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotGanttDataLabelsOptions {
  ...
  inline def apply(): PlotGanttDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttDataLabelsOptions]
  }
  
  extension [Self <: PlotGanttDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotGanttDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
