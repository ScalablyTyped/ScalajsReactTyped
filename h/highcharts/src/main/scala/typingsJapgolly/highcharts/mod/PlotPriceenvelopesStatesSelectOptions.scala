...
trait PlotPriceenvelopesStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotPriceenvelopesStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPriceenvelopesStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotPriceenvelopesStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotPriceenvelopesStatesSelectAnimationOptions = null,
  ...
  ): PlotPriceenvelopesStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesStatesSelectOptions]
  }
}
