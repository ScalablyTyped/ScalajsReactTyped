...
trait PlotAreasplinerangeAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotAreasplinerangeAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotAreasplinerangeAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotAreasplinerangeAccessibilityKeyboardNavigationOptions = null,
    ...
    __obj.asInstanceOf[PlotAreasplinerangeAccessibilityOptions]
  }
}
