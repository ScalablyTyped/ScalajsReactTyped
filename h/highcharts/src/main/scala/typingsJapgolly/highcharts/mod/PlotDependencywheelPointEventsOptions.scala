...
trait PlotDependencywheelPointEventsOptions extends js.Object {
  /**
...
object PlotDependencywheelPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDependencywheelPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotDependencywheelPointEventsOptions]
  }
}
