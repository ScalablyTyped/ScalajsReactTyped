...
trait PlotAreasplinerangeConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotAreasplinerangeConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplinerangeConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplinerangeConnectorsStartMarkerOptions]
  }
}
