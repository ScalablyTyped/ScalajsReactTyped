...
trait PlotDemaDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotDemaDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotDemaDataLabelsOptions {
  
  inline def apply(): PlotDemaDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaDataLabelsOptions]
  }
  
  extension [Self <: PlotDemaDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotDemaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
