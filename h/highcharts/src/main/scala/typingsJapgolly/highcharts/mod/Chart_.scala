...
import typingsJapgolly.highcharts.boostMod.highchartsAugmentingMod.Chart
...
class Chart_ protected () extends js.Object {
  ...
  /**
    ...
    */
  var data: js.UndefOr[typingsJapgolly.highcharts.dataMod.highchartsAugmentingMod.Data] = js.native
  /**
  ...
  /**
    ...
    */
  def fromLatLonToPoint(latLon: typingsJapgolly.highcharts.mapMod.highchartsAugmentingMod.MapLatLonObject): typingsJapgolly.highcharts.mapMod.highchartsAugmentingMod.MapCoordinateObject = js.native
  /**
    ...
    */
  def fromPointToLatLon(point: typingsJapgolly.highcharts.mapMod.highchartsAugmentingMod.MapCoordinateObject): js.UndefOr[typingsJapgolly.highcharts.mapMod.highchartsAugmentingMod.MapLatLonObject] = js.native
  def fromPointToLatLon(point: typingsJapgolly.highcharts.mapMod.highchartsAugmentingMod.Point): js.UndefOr[typingsJapgolly.highcharts.mapMod.highchartsAugmentingMod.MapLatLonObject] = js.native
  /**
  ...
  /**
    ...
    */
  def getCurrentSonifyPoints(): js.Array[typingsJapgolly.highcharts.sonificationMod.highchartsAugmentingMod.Point] = js.native
  /**
  ...
  def setSonifyCursor(points: js.Array[typingsJapgolly.highcharts.sonificationMod.highchartsAugmentingMod.Point]): Unit = js.native
  /**
    ...
    */
  def setSonifyCursor(points: typingsJapgolly.highcharts.sonificationMod.highchartsAugmentingMod.Point): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def sonify(
    options: typingsJapgolly.highcharts.sonificationMod.highchartsAugmentingMod.SonifyChartOptionsObject
  ): Unit = js.native
  /**
  ...
  def transformFromLatLon(
    latLon: typingsJapgolly.highcharts.mapMod.highchartsAugmentingMod.MapLatLonObject,
    transform: js.Any
  ): typingsJapgolly.highcharts.mapMod.highchartsAugmentingMod.MapCoordinateObject = js.native
  /**
  ...
  def transformToLatLon(
    point: typingsJapgolly.highcharts.mapMod.highchartsAugmentingMod.MapCoordinateObject,
    transform: js.Any
  ): js.UndefOr[typingsJapgolly.highcharts.mapMod.highchartsAugmentingMod.MapLatLonObject] = js.native
  def transformToLatLon(point: typingsJapgolly.highcharts.mapMod.highchartsAugmentingMod.Point, transform: js.Any): js.UndefOr[typingsJapgolly.highcharts.mapMod.highchartsAugmentingMod.MapLatLonObject] = js.native
  /**
