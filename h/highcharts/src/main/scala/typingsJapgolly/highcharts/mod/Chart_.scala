...
import typingsJapgolly.highcharts.modulesBoostCanvasMod.highchartsAugmentingMod.Chart
...
open class Chart_ protected () extends StObject {
  ...
  def addSeriesAsDrilldown(
    point: typingsJapgolly.highcharts.modulesDrilldownMod.highchartsAugmentingMod.Point,
  ...
  /**
    ...
    */
  var data: js.UndefOr[typingsJapgolly.highcharts.modulesDataMod.highchartsAugmentingMod.Data] = js.native
  ...
  /**
    ...
    */
  def fromLatLonToPoint(lonLat: typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.MapLonLatObject): typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.ProjectedXY = js.native
  ...
  /**
    ...
    */
  def fromPointToLatLon(point: typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.Point): js.UndefOr[typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.MapLonLatObject] = js.native
  def fromPointToLatLon(point: typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.ProjectedXY): js.UndefOr[typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.MapLonLatObject] = js.native
  
  var fullscreen: typingsJapgolly.highcharts.modulesExportingMod.highchartsAugmentingMod.Fullscreen & (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Fullscreen */ Any) = js.native
  ...
  /**
    ...
    */
  def getCurrentSonifyPoints(): js.Array[typingsJapgolly.highcharts.modulesSonificationMod.highchartsAugmentingMod.Point] = js.native
  ...
  /**
    ...
    * @return true if the chart is in series boost mode
    */
  def isChartSeriesBoosting(chart: typingsJapgolly.highcharts.modulesBoostMod.highchartsAugmentingMod.Chart): Boolean = js.native
  ...
  def setSonifyCursor(points: js.Array[typingsJapgolly.highcharts.modulesSonificationMod.highchartsAugmentingMod.Point]): Unit = js.native
  /**
    ...
    */
  def setSonifyCursor(points: typingsJapgolly.highcharts.modulesSonificationMod.highchartsAugmentingMod.Point): Unit = js.native
  ...
  def sonify(
    options: typingsJapgolly.highcharts.modulesSonificationMod.highchartsAugmentingMod.SonificationOptions
  ): Unit = js.native
  ...
  /**
    ...
    */
  def transformFromLatLon(
    latLon: typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.MapLonLatObject,
    transform: Any
  ): typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.ProjectedXY = js.native
  ...
  /**
    ...
    * @return An object with `lat` and `lon` properties.
    */
  def transformToLatLon(point: typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.Point, transform: Any): js.UndefOr[typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.MapLonLatObject] = js.native
  def transformToLatLon(
    point: typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.ProjectedXY,
    transform: Any
  ): js.UndefOr[typingsJapgolly.highcharts.modulesMapMod.highchartsAugmentingMod.MapLonLatObject] = js.native
