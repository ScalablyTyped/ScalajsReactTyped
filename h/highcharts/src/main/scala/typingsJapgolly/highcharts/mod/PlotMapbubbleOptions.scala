...
trait PlotMapbubbleOptions extends js.Object {
  /**
    * (Highmaps) Accessibility options for a series. Requires the accessibility
    * module.
    */
  var accessibility: js.UndefOr[js.Object | PlotMapbubbleAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMapbubbleAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotMapbubbleConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotMapbubbleDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotMapbubbleDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotMapbubbleEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    * `area`.
    */
  var label: js.UndefOr[PlotMapbubbleLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotMapbubbleLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotMapbubbleLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMapbubbleMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var point: js.UndefOr[PlotMapbubblePointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotMapbubbleStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    * in the pointFormat.
    */
  var tooltip: js.UndefOr[PlotMapbubbleTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotMapbubbleZonesOptions]] = js.undefined
}
