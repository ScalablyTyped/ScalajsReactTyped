...
trait PlotMapbubbleOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotMapbubbleDataLabelsOptions | js.Array[PlotMapbubbleDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotMapbubbleDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var jitter: js.UndefOr[PlotMapbubbleJitterOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotMapbubbleOnPointOptions] = js.undefined
...
object PlotMapbubbleOptions {
  
  inline def apply(): PlotMapbubbleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleOptions]
  }
  
  extension [Self <: PlotMapbubbleOptions](x: Self) {
    ...
    inline def setDataLabels(value: PlotMapbubbleDataLabelsOptions | js.Array[PlotMapbubbleDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotMapbubbleDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotMapbubbleDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setDisplayNegative(value: Boolean): Self = StObject.set(x, "displayNegative", value.asInstanceOf[js.Any])
    
    inline def setDisplayNegativeUndefined: Self = StObject.set(x, "displayNegative", js.undefined)
    ...
    inline def setJitter(value: PlotMapbubbleJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotMapbubbleOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
