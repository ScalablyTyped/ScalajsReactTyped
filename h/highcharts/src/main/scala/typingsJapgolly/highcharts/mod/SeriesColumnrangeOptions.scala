...
import typingsJapgolly.highcharts.highchartsStrings.columnrange
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesColumnrangeOptions
  extends StObject
     with PlotColumnrangeOptions {
...
object SeriesColumnrangeOptions {
  
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | columnrange): SeriesColumnrangeOptions = {
    val __obj = js.Dynamic.literal(dataParser = dataParser.asInstanceOf[js.Any], dataURL = dataURL.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesColumnrangeOptions]
  }
  
  extension [Self <: SeriesColumnrangeOptions](x: Self) {
    ...
    inline def setType(value: String | columnrange): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
