...
trait PlotTrixMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTrixMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrixMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTrixMarkerStatesSelectOptions]
  }
}
