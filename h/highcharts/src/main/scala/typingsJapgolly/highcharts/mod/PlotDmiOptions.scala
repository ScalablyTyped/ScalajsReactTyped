...
trait PlotDmiOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotDmiAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotDmiDataLabelsOptions | js.Array[PlotDmiDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotDmiDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var minusDILine: js.UndefOr[PlotDmiMinusDILineOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotDmiOnPointOptions] = js.undefined
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotDmiParamsOptions] = js.undefined
  
  /**
    * (Highstock) +DI line options.
    */
  var plusDILine: js.UndefOr[PlotDmiPlusDILineOptions] = js.undefined
...
object PlotDmiOptions {
  
  inline def apply(): PlotDmiOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiOptions]
  }
  
  extension [Self <: PlotDmiOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotDmiAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotDmiDataLabelsOptions | js.Array[PlotDmiDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotDmiDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotDmiDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setMinusDILine(value: PlotDmiMinusDILineOptions): Self = StObject.set(x, "minusDILine", value.asInstanceOf[js.Any])
    
    inline def setMinusDILineUndefined: Self = StObject.set(x, "minusDILine", js.undefined)
    ...
    inline def setOnPoint(value: js.Object | PlotDmiOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotDmiParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    
    inline def setParamsUndefined: Self = StObject.set(x, "params", js.undefined)
    
    inline def setPlusDILine(value: PlotDmiPlusDILineOptions): Self = StObject.set(x, "plusDILine", value.asInstanceOf[js.Any])
    
    inline def setPlusDILineUndefined: Self = StObject.set(x, "plusDILine", js.undefined)
