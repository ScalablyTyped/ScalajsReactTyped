...
trait PlotPackedbubbleTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotPackedbubbleTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotPackedbubbleTooltipOptions {
  @scala.inline
  def apply(
    changeDecimals: Int | Double = null,
    dateTimeLabelFormats: PlotPackedbubbleTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
  ...
  ): PlotPackedbubbleTooltipOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleTooltipOptions]
  }
}
