...
trait PlotSunburstConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotSunburstConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSunburstConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSunburstConnectorsStartMarkerOptions]
  }
}
