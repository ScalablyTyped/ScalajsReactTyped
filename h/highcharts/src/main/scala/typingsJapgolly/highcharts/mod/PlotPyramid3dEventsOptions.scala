...
trait PlotPyramid3dEventsOptions extends js.Object {
  /**
...
object PlotPyramid3dEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPyramid3dEventsOptions]
  }
}
