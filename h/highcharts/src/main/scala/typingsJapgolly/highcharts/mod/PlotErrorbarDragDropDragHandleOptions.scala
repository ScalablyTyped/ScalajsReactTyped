...
trait PlotErrorbarDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotErrorbarDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotErrorbarDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotErrorbarDragDropDragHandleOptions]
  }
}
