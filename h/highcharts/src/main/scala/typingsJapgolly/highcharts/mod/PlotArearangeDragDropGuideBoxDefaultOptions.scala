...
trait PlotArearangeDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotArearangeDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotArearangeDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeDragDropGuideBoxDefaultOptions]
  }
}
