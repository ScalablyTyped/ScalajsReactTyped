...
trait PlotTreemapBreadcrumbsPositionOptions extends StObject {
...
object PlotTreemapBreadcrumbsPositionOptions {
  
  inline def apply(): PlotTreemapBreadcrumbsPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapBreadcrumbsPositionOptions]
  }
  
  extension [Self <: PlotTreemapBreadcrumbsPositionOptions](x: Self) {
