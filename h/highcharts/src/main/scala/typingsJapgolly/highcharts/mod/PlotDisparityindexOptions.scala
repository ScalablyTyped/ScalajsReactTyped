...
trait PlotDisparityindexOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotDisparityindexAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  var dataLabels: js.UndefOr[
    PlotDisparityindexDataLabelsOptions | js.Array[PlotDisparityindexDataLabelsOptions]
  ] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotDisparityindexDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotDisparityindexOnPointOptions] = js.undefined
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotDisparityindexParamsOptions] = js.undefined
...
object PlotDisparityindexOptions {
  
  inline def apply(): PlotDisparityindexOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexOptions]
  }
  
  extension [Self <: PlotDisparityindexOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotDisparityindexAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotDisparityindexDataLabelsOptions | js.Array[PlotDisparityindexDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotDisparityindexDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotDisparityindexDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotDisparityindexOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotDisparityindexParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
