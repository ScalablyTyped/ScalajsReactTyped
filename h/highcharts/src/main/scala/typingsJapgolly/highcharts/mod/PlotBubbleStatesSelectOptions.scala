...
trait PlotBubbleStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotBubbleStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotBubbleStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotBubbleStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotBubbleStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotBubbleStatesSelectOptions]
  }
}
