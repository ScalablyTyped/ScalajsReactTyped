...
trait PlotArearangeMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotArearangeMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotArearangeMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeMarkerStatesHoverOptions]
  }
}
