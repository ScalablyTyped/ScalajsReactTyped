...
object modulesDotplotMod {
  
  @JSImport("highcharts/modules/dotplot", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/dotplot", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/dotplot", "Highcharts.SeriesPalettes")
    @js.native
