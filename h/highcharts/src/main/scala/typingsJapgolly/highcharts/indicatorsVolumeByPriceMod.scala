...
object indicatorsVolumeByPriceMod {
  
  @JSImport("highcharts/indicators/volume-by-price", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/volume-by-price", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/volume-by-price", "Highcharts.SeriesPalettes")
    @js.native
