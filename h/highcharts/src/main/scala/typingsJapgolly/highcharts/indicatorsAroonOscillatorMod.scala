...
object indicatorsAroonOscillatorMod {
  
  @JSImport("highcharts/indicators/aroon-oscillator", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/aroon-oscillator", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/aroon-oscillator", "Highcharts.SeriesPalettes")
    @js.native
