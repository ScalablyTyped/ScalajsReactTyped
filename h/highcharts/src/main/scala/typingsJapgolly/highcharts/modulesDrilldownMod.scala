...
object modulesDrilldownMod {
  ...
  object highchartsAugmentingMod {
    ...
    object Chart {
      ...
      inline def apply(addSeriesAsDrilldown: (Point, SeriesOptionsType) => Callback, drillUp: Callback): Chart = {
        val __obj = js.Dynamic.literal(addSeriesAsDrilldown = js.Any.fromFunction2((t0: Point, t1: SeriesOptionsType) => (addSeriesAsDrilldown(t0, t1)).runNow()), drillUp = drillUp.toJsFn)
        __obj.asInstanceOf[Chart]
      }
      
      extension [Self <: Chart](x: Self) {
        
        inline def setAddSeriesAsDrilldown(value: (Point, SeriesOptionsType) => Callback): Self = StObject.set(x, "addSeriesAsDrilldown", js.Any.fromFunction2((t0: Point, t1: SeriesOptionsType) => (value(t0, t1)).runNow()))
    ...
    object Point {
      ...
      inline def apply(doDrilldown: Callback): Point = {
        val __obj = js.Dynamic.literal(doDrilldown = doDrilldown.toJsFn)
        __obj.asInstanceOf[Point]
      }
      
      extension [Self <: Point](x: Self) {
        
        inline def setDoDrilldown(value: Callback): Self = StObject.set(x, "doDrilldown", value.toJsFn)
      }
    }
