...
object themesSkiesMod {
  
  @JSImport("highcharts/themes/skies", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/themes/skies", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/themes/skies", "Highcharts.SeriesPalettes")
    @js.native
