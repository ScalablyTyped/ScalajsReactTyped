...
object Request {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(header = header.asInstanceOf[js.Any], method = method.asInstanceOf[js.Any], param = param.asInstanceOf[js.Any], send = js.Any.fromFunction1((t0: js.Function1[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_info.RequestResponse */ /* response */ Any, 
      Unit
    ]) => send(t0).runNow()), timeout = timeout.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
  ...
  extension [Self <: Request](x: Self) {
    ...
    ): Self = StObject.set(x, "send", js.Any.fromFunction1((t0: js.Function1[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_info.RequestResponse */ /* response */ Any, 
          Unit
        ]) => value(t0).runNow()))
