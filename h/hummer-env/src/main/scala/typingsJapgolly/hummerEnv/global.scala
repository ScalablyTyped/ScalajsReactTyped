...
import typingsJapgolly.hummerEnv.anon.AddEventListener
import typingsJapgolly.hummerEnv.anon.Animated
import typingsJapgolly.hummerEnv.anon.AppName
import typingsJapgolly.hummerEnv.anon.Easing
import typingsJapgolly.hummerEnv.hummerEnvStrings.end
import typingsJapgolly.hummerEnv.hummerEnvStrings.start
...
object global {
  ...
  open class BasicAnimation[T /* <: /* keyof / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_info.animationTypeMap * / any */ String */] protected ()
    extends StObject
       with typingsJapgolly.hummerEnv.BasicAnimation[
  ...
  open class Button ()
    extends StObject
       with typingsJapgolly.hummerEnv.Button
  ...
  open class CanvasView ()
    extends StObject
       with typingsJapgolly.hummerEnv.CanvasView {
  ...
  open class Dialog ()
    extends StObject
       with typingsJapgolly.hummerEnv.Dialog
  ...
  open class HorizontalScroller ()
    extends StObject
       with typingsJapgolly.hummerEnv.HorizontalScroller {
  ...
  open class Image ()
    extends StObject
       with typingsJapgolly.hummerEnv.Image
  ...
  open class Input ()
    extends StObject
       with typingsJapgolly.hummerEnv.Input
  ...
  open class KeyframeAnimation[T /* <: /* keyof / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_info.animationTypeMap * / any */ String */] protected ()
    extends StObject
       with typingsJapgolly.hummerEnv.KeyframeAnimation[
          /* import warning: importer.ImportType#apply Failed type conversion: / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_info.animationTypeMap * / any[T] */ js.Any
        ] {
    /**
      * @param animationType:    "position" | "scale" | "scaleX" | "scaleY" | "rotationX" | "rotationY" | "rotationZ" | "opacity" | "backgroundColor" | "width" | "height";
  ...
  open class List ()
    extends StObject
       with typingsJapgolly.hummerEnv.List
  ...
  open class Location ()
    extends StObject
       with typingsJapgolly.hummerEnv.Location
  ...
  open class Request ()
    extends StObject
       with typingsJapgolly.hummerEnv.Request {
  ...
  open class Scroller ()
    extends StObject
       with typingsJapgolly.hummerEnv.Scroller {
  ...
  open class Switch ()
    extends StObject
       with typingsJapgolly.hummerEnv.Switch
  ...
  open class Text ()
    extends StObject
       with typingsJapgolly.hummerEnv.Text
  ...
  open class TextArea ()
    extends StObject
       with typingsJapgolly.hummerEnv.TextArea
  ...
  open class View ()
    extends StObject
       with typingsJapgolly.hummerEnv.View {
    def this(id: String) = this()
  ...
  open class ViewPager ()
    extends StObject
       with typingsJapgolly.hummerEnv.ViewPager
  ...
  open class WebSocket protected ()
    extends StObject
       with typingsJapgolly.hummerEnv.WebSocket {
