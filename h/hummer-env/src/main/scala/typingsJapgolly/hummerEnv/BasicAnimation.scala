...
object BasicAnimation {
  ...
  inline def apply[V](
    ...
    val __obj = js.Dynamic.literal(delay = delay.asInstanceOf[js.Any], duration = duration.asInstanceOf[js.Any], easing = easing.asInstanceOf[js.Any], on = js.Any.fromFunction2((t0: start | end, t1: js.Function0[Unit]) => (on(t0, t1)).runNow()), repeatCount = repeatCount.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
