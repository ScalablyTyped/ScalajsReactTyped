...
object KeyframeAnimation {
  ...
  inline def apply[V](
    ...
    on: (start | end, js.Function0[Unit]) => Callback,
    repeatCount: Double
  ): KeyframeAnimation[V] = {
    val __obj = js.Dynamic.literal(delay = delay.asInstanceOf[js.Any], duration = duration.asInstanceOf[js.Any], easing = easing.asInstanceOf[js.Any], keyframes = keyframes.asInstanceOf[js.Any], on = js.Any.fromFunction2((t0: start | end, t1: js.Function0[Unit]) => (on(t0, t1)).runNow()), repeatCount = repeatCount.asInstanceOf[js.Any])
  ...
  extension [Self <: KeyframeAnimation[?], V](x: Self & KeyframeAnimation[V]) {
    ...
    inline def setOn(value: (start | end, js.Function0[Unit]) => Callback): Self = StObject.set(x, "on", js.Any.fromFunction2((t0: start | end, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
