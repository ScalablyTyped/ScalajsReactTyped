package typingsJapgolly.hapiAddress.mod
...
object ip {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.hapiAddress.hapiAddressStrings.optional
    - typingsJapgolly.hapiAddress.hapiAddressStrings.required
    - typingsJapgolly.hapiAddress.hapiAddressStrings.forbidden
  */
  trait Cidr extends StObject
  object Cidr {
    
    inline def forbidden: typingsJapgolly.hapiAddress.hapiAddressStrings.forbidden = "forbidden".asInstanceOf[typingsJapgolly.hapiAddress.hapiAddressStrings.forbidden]
    
    inline def optional: typingsJapgolly.hapiAddress.hapiAddressStrings.optional = "optional".asInstanceOf[typingsJapgolly.hapiAddress.hapiAddressStrings.optional]
    
    inline def required: typingsJapgolly.hapiAddress.hapiAddressStrings.required = "required".asInstanceOf[typingsJapgolly.hapiAddress.hapiAddressStrings.required]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.hapiAddress.hapiAddressStrings.ipv4
    - typingsJapgolly.hapiAddress.hapiAddressStrings.ipv6
    - typingsJapgolly.hapiAddress.hapiAddressStrings.ipvfuture
  */
  trait Version extends StObject
  object Version {
    
    inline def ipv4: typingsJapgolly.hapiAddress.hapiAddressStrings.ipv4 = "ipv4".asInstanceOf[typingsJapgolly.hapiAddress.hapiAddressStrings.ipv4]
    
    inline def ipv6: typingsJapgolly.hapiAddress.hapiAddressStrings.ipv6 = "ipv6".asInstanceOf[typingsJapgolly.hapiAddress.hapiAddressStrings.ipv6]
    
    inline def ipvfuture: typingsJapgolly.hapiAddress.hapiAddressStrings.ipvfuture = "ipvfuture".asInstanceOf[typingsJapgolly.hapiAddress.hapiAddressStrings.ipvfuture]
  }
}
