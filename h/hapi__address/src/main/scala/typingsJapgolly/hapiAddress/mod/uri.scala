...
import typingsJapgolly.hapiAddress.mod.uri.Options.Relative
import typingsJapgolly.hapiHoek.mod.ts.XOR
...
object uri {
  ...
  object Options {
    ...
    object Options {
      ...
      inline def apply(): typingsJapgolly.hapiAddress.mod.uri.Options.Options = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.hapiAddress.mod.uri.Options.Options]
      }
      
      extension [Self <: typingsJapgolly.hapiAddress.mod.uri.Options.Options](x: Self) {
  ...
  type Options = XOR[typingsJapgolly.hapiAddress.mod.uri.Options.Options, Relative]
}
