...
object global {
  ...
  open class HammerInput protected ()
    extends StObject
       with typingsJapgolly.hammerjs.HammerInput {
  ...
  open class TouchAction protected ()
    extends StObject
       with typingsJapgolly.hammerjs.TouchAction {
    ...
    /* CompleteClass */
    override def preventDefaults(input: typingsJapgolly.hammerjs.HammerInput): Unit = js.native
