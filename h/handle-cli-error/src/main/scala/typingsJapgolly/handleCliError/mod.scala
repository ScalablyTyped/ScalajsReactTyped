package typingsJapgolly.handleCliError

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.chalkString.mod.Styles
import typingsJapgolly.handleCliError.anon.OmitOptionsclasses
import typingsJapgolly.handleCliError.handleCliErrorStrings._empty
...
object mod {
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      */
    val icon: js.UndefOr[
        /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 230, starting with typingsJapgolly.handleCliError.handleCliErrorStrings.tick, typingsJapgolly.handleCliError.handleCliErrorStrings.info, typingsJapgolly.handleCliError.handleCliErrorStrings.warning */ Any
      ] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setIcon(
        value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 230, starting with typingsJapgolly.handleCliError.handleCliErrorStrings.tick, typingsJapgolly.handleCliError.handleCliErrorStrings.info, typingsJapgolly.handleCliError.handleCliErrorStrings.warning */ Any
