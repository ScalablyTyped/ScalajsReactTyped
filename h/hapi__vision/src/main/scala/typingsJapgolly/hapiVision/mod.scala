package typingsJapgolly.hapiVision
...
import typingsJapgolly.hapiVision.anon.Context
import typingsJapgolly.hapiVision.hapiVisionStrings.async
import typingsJapgolly.hapiVision.hapiVisionStrings.sync
...
object mod extends Shortcut {
  ...
  object NpmModule {
    ...
    extension [Self <: NpmModule](x: Self) {
      ...
      inline def setCompileFunction3(value: (/* template */ String, /* options */ Any, /* next */ ServerViewCompileNext) => Callback): Self = StObject.set(x, "compile", js.Any.fromFunction3((t0: /* template */ String, t1: /* options */ Any, t2: /* next */ ServerViewCompileNext) => (value(t0, t1, t2)).runNow()))
      
      inline def setPrepare(
        value: (/* config */ EngineConfigurationObject, /* next */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "prepare", js.Any.fromFunction2((t0: /* config */ EngineConfigurationObject, t1: /* next */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
      
      inline def setPrepareUndefined: Self = StObject.set(x, "prepare", js.undefined)
      
      inline def setRegisterHelper(value: (/* name */ String, /* helper */ js.Function1[/* repeated */ Any, Any]) => Callback): Self = StObject.set(x, "registerHelper", js.Any.fromFunction2((t0: /* name */ String, t1: /* helper */ js.Function1[/* repeated */ Any, Any]) => (value(t0, t1)).runNow()))
      
      inline def setRegisterHelperUndefined: Self = StObject.set(x, "registerHelper", js.undefined)
      
      inline def setRegisterPartial(value: (/* name */ String, /* src */ String) => Callback): Self = StObject.set(x, "registerPartial", js.Any.fromFunction2((t0: /* name */ String, t1: /* src */ String) => (value(t0, t1)).runNow()))
  ...
  object ViewManager {
    ...
    inline def apply(
      registerHelper: (String, js.Function1[/* repeated */ Any, Any]) => Callback,
      render: (/* template */ String, /* context */ js.UndefOr[Any], /* options */ js.UndefOr[ServerViewsConfiguration]) => js.Promise[String]
    ): ViewManager = {
      val __obj = js.Dynamic.literal(registerHelper = js.Any.fromFunction2((t0: String, t1: js.Function1[/* repeated */ Any, Any]) => (registerHelper(t0, t1)).runNow()), render = js.Any.fromFunction3(render))
      __obj.asInstanceOf[ViewManager]
    }
    
    extension [Self <: ViewManager](x: Self) {
      
      inline def setRegisterHelper(value: (String, js.Function1[/* repeated */ Any, Any]) => Callback): Self = StObject.set(x, "registerHelper", js.Any.fromFunction2((t0: String, t1: js.Function1[/* repeated */ Any, Any]) => (value(t0, t1)).runNow()))
  ...
  object hapiHapiAugmentingMod {
    ...
    object Request {
      ...
      inline def apply(
        getViewsManager: CallbackTo[ViewManager],
        render: (/* template */ String, /* context */ js.UndefOr[Any], /* options */ js.UndefOr[ServerViewsConfiguration]) => js.Promise[String]
      ): typingsJapgolly.hapiVision.mod.hapiHapiAugmentingMod.Request = {
        val __obj = js.Dynamic.literal(getViewsManager = getViewsManager.toJsFn, render = js.Any.fromFunction3(render))
        __obj.asInstanceOf[typingsJapgolly.hapiVision.mod.hapiHapiAugmentingMod.Request]
      }
      
      extension [Self <: typingsJapgolly.hapiVision.mod.hapiHapiAugmentingMod.Request](x: Self) {
        
        inline def setGetViewsManager(value: CallbackTo[ViewManager]): Self = StObject.set(x, "getViewsManager", value.toJsFn)
    ...
    object Server {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(getViewsManager = getViewsManager.toJsFn, render = js.Any.fromFunction3(render), views = js.Any.fromFunction1(views))
