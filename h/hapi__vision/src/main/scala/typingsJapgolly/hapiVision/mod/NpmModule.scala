package typingsJapgolly.hapiVision.mod
...
object NpmModule {
  ...
  def apply(
    ...
    if (prepare != null) __obj.updateDynamic("prepare")(js.Any.fromFunction2((t0: /* config */ typingsJapgolly.hapiVision.mod.EngineConfigurationObject, t1: /* next */ js.Function1[/* err */ js.UndefOr[js.Error], scala.Unit]) => prepare(t0, t1).runNow()))
