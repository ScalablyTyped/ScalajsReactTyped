...
package object mod {
  ...
  type RenderMethod = js.Function3[
    ...
    /* options */ js.UndefOr[typingsJapgolly.hapiVision.mod.ServerViewsConfiguration], 
    js.Promise[java.lang.String]
  ]
  type RuntimeOptions = js.Object
  type ServerViewCompile = typingsJapgolly.hapiVision.mod.ServerViewCompileSync | typingsJapgolly.hapiVision.mod.ServerViewCompileAsync
  type ServerViewCompileAsync = js.Function3[
    /* template */ java.lang.String, 
    /* options */ js.Any, 
    /* next */ typingsJapgolly.hapiVision.mod.ServerViewCompileNext, 
    scala.Unit
  ]
