...
import typingsJapgolly.hippyReact.anon.EndEdgePos
import typingsJapgolly.hippyReact.anon.Right
...
trait WaterfallViewProps extends StObject {
  ...
  var renderBanner: js.UndefOr[js.Function0[japgolly.scalajs.react.facade.React.Element]] = js.undefined
  ...
  /**
    ...
    */
  var renderItem: js.UndefOr[js.Function1[/* data */ DataItem, japgolly.scalajs.react.facade.React.Element]] = js.undefined
...
object WaterfallViewProps {
  ...
  extension [Self <: WaterfallViewProps](x: Self) {
    ...
    inline def setOnExposureReport(value: Callback): Self = StObject.set(x, "onExposureReport", value.toJsFn)
    ...
    inline def setOnInitialListReady(value: Callback): Self = StObject.set(x, "onInitialListReady", value.toJsFn)
    
    inline def setOnInitialListReadyUndefined: Self = StObject.set(x, "onInitialListReady", js.undefined)
    
    inline def setOnItemLayout(value: (/* evt */ LayoutEvent, /* index */ Double) => Callback): Self = StObject.set(x, "onItemLayout", js.Any.fromFunction2((t0: /* evt */ LayoutEvent, t1: /* index */ Double) => (value(t0, t1)).runNow()))
    
    inline def setOnItemLayoutUndefined: Self = StObject.set(x, "onItemLayout", js.undefined)
    
    inline def setOnScroll(value: /* evt */ EndEdgePos => Callback): Self = StObject.set(x, "onScroll", js.Any.fromFunction1((t0: /* evt */ EndEdgePos) => value(t0).runNow()))
    ...
    inline def setRenderBanner(value: CallbackTo[japgolly.scalajs.react.facade.React.Element]): Self = StObject.set(x, "renderBanner", value.toJsFn)
    
    inline def setRenderBannerUndefined: Self = StObject.set(x, "renderBanner", js.undefined)
    
    inline def setRenderItem(value: /* data */ DataItem => japgolly.scalajs.react.facade.React.Element): Self = StObject.set(x, "renderItem", js.Any.fromFunction1(value))
