...
import typingsJapgolly.hippyReact.hippyReactBooleans.`false`
...
object ViewProps {
  ...
  extension [Self <: ViewProps](x: Self) {
    ...
    inline def setOnFocus(value: /* evt */ FocusEvent => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: /* evt */ FocusEvent) => value(t0).runNow()))
