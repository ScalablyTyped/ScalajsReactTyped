...
import typingsJapgolly.hippyReact.anon.ContentInset
...
object ScrollViewProps {
  ...
  extension [Self <: ScrollViewProps](x: Self) {
    ...
    inline def setOnScroll(value: /* evt */ ContentInset => Callback): Self = StObject.set(x, "onScroll", js.Any.fromFunction1((t0: /* evt */ ContentInset) => value(t0).runNow()))
