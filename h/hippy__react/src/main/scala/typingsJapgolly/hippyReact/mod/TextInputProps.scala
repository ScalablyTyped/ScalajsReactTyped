...
import typingsJapgolly.hippyReact.anon.NativeEventContentSize
import typingsJapgolly.hippyReact.anon.NativeEventSelection
import typingsJapgolly.hippyReact.hippyReactStrings.`phone-pad`
import typingsJapgolly.hippyReact.hippyReactStrings.default
import typingsJapgolly.hippyReact.hippyReactStrings.done
import typingsJapgolly.hippyReact.hippyReactStrings.email
import typingsJapgolly.hippyReact.hippyReactStrings.go
import typingsJapgolly.hippyReact.hippyReactStrings.next
import typingsJapgolly.hippyReact.hippyReactStrings.numeric
import typingsJapgolly.hippyReact.hippyReactStrings.password
import typingsJapgolly.hippyReact.hippyReactStrings.search
import typingsJapgolly.hippyReact.hippyReactStrings.send
...
object TextInputProps {
  ...
  extension [Self <: TextInputProps](x: Self) {
    ...
    inline def setOnContentSizeChange(value: /* evt */ NativeEventContentSize => Callback): Self = StObject.set(x, "onContentSizeChange", js.Any.fromFunction1((t0: /* evt */ NativeEventContentSize) => value(t0).runNow()))
    
    inline def setOnContentSizeChangeUndefined: Self = StObject.set(x, "onContentSizeChange", js.undefined)
    
    inline def setOnEndEditing(value: Callback): Self = StObject.set(x, "onEndEditing", value.toJsFn)
    
    inline def setOnEndEditingUndefined: Self = StObject.set(x, "onEndEditing", js.undefined)
    
    inline def setOnKeyboardWillShow(value: /* evt */ KeyboardWillShowEvent => Callback): Self = StObject.set(x, "onKeyboardWillShow", js.Any.fromFunction1((t0: /* evt */ KeyboardWillShowEvent) => value(t0).runNow()))
    
    inline def setOnKeyboardWillShowUndefined: Self = StObject.set(x, "onKeyboardWillShow", js.undefined)
    
    inline def setOnSelectionChange(value: /* evt */ NativeEventSelection => Callback): Self = StObject.set(x, "onSelectionChange", js.Any.fromFunction1((t0: /* evt */ NativeEventSelection) => value(t0).runNow()))
