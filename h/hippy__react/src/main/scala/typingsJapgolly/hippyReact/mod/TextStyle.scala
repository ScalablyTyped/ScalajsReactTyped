...
import typingsJapgolly.hippyReact.hippyReactStrings.auto
import typingsJapgolly.hippyReact.hippyReactStrings.center
import typingsJapgolly.hippyReact.hippyReactStrings.justify
...
- typingsJapgolly.hippyReact.mod.Style because Already inherited */ trait TextStyle
  extends StObject
     with ViewStyle {
