...
object mod extends Shortcut {
  ...
  trait ProxyHandlerOptions extends StObject {
    ...
    var onResponse: js.UndefOr[
        js.ThisFunction6[
          /* this */ RouteOptions, 
          /* err */ Null | typingsJapgolly.boom.mod.^[Any], 
          /* res */ IncomingMessage, 
          /* req */ Request, 
          /* h */ ResponseToolkit, 
          /* settings */ this.type, 
  ...
  object hapiAugmentingMod {
    ...
    object ResponseToolkit {
      ...
      inline def apply(proxy: ProxyHandlerOptions => js.Promise[ResponseObject]): typingsJapgolly.h2o2.mod.hapiAugmentingMod.ResponseToolkit = {
        val __obj = js.Dynamic.literal(proxy = js.Any.fromFunction1(proxy))
        __obj.asInstanceOf[typingsJapgolly.h2o2.mod.hapiAugmentingMod.ResponseToolkit]
      }
      
      extension [Self <: typingsJapgolly.h2o2.mod.hapiAugmentingMod.ResponseToolkit](x: Self) {
