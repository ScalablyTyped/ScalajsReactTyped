package typingsJapgolly.httpCacheSemantics
...
object mod {
  ...
  object CachePolicy {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(responseHeaders = responseHeaders.toJsFn, revalidatedPolicy = js.Any.fromFunction2(revalidatedPolicy), revalidationHeaders = js.Any.fromFunction1(revalidationHeaders), satisfiesWithoutRevalidation = js.Any.fromFunction1(satisfiesWithoutRevalidation), storable = storable.toJsFn, timeToLive = timeToLive.toJsFn, toObject = toObject.toJsFn)
      __obj.asInstanceOf[CachePolicy]
    }
    
    extension [Self <: CachePolicy](x: Self) {
      
      inline def setResponseHeaders(value: CallbackTo[Headers]): Self = StObject.set(x, "responseHeaders", value.toJsFn)
      ...
      inline def setStorable(value: CallbackTo[Boolean]): Self = StObject.set(x, "storable", value.toJsFn)
      
      inline def setTimeToLive(value: CallbackTo[Double]): Self = StObject.set(x, "timeToLive", value.toJsFn)
      
      inline def setToObject(value: CallbackTo[CachePolicyObject]): Self = StObject.set(x, "toObject", value.toJsFn)
    }
  }
