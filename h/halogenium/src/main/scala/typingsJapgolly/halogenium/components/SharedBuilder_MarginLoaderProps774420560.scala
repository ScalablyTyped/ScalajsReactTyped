...
@scala.inline
open class SharedBuilder_MarginLoaderProps774420560[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def margin(value: Double | String): this.type = set("margin", value.asInstanceOf[js.Any])
