...
import typingsJapgolly.hapiAuthJwt2.anon.Credentials
...
object mod extends Shortcut {
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      */
    var key: js.UndefOr[
        String | js.Array[String] | Buffer | (js.Function1[/* decodedToken */ Any, js.Promise[typingsJapgolly.hapiAuthJwt2.anon.ExtraInfo]])
      ] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setKey(
        value: String | js.Array[String] | Buffer | (js.Function1[/* decodedToken */ Any, js.Promise[typingsJapgolly.hapiAuthJwt2.anon.ExtraInfo]])
      ): Self = StObject.set(x, "key", value.asInstanceOf[js.Any])
      
      inline def setKeyFunction1(value: /* decodedToken */ Any => js.Promise[typingsJapgolly.hapiAuthJwt2.anon.ExtraInfo]): Self = StObject.set(x, "key", js.Any.fromFunction1(value))
      ...
      inline def setResponseFunc(
        value: (/* request */ Request, /* reply */ js.Function2[/* err */ Any, /* response */ ResponseObject, Unit]) => Callback
      ): Self = StObject.set(x, "responseFunc", js.Any.fromFunction2((t0: /* request */ Request, t1: /* reply */ js.Function2[/* err */ Any, /* response */ ResponseObject, Unit]) => (value(t0, t1)).runNow()))
