...
object anon {
  ...
  trait ExtraInfo extends StObject {
    ...
    var extraInfo: js.UndefOr[typingsJapgolly.hapiAuthJwt2.mod.ExtraInfo] = js.undefined
  ...
  object ExtraInfo {
    ...
    extension [Self <: ExtraInfo](x: Self) {
      ...
      inline def setExtraInfo(value: typingsJapgolly.hapiAuthJwt2.mod.ExtraInfo): Self = StObject.set(x, "extraInfo", value.asInstanceOf[js.Any])
