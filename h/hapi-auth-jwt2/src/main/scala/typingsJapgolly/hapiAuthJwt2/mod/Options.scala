...
import typingsJapgolly.hapiAuthJwt2.AnonExtraInfo
...
object Options {
  @scala.inline
  def apply(
    validate: (js.Object, Request, ResponseToolkit) => CallbackTo[ValidationResult | js.Promise[ValidationResult]],
    ...
    customExtractionFunc: /* request */ Request => CallbackTo[String] = null,
    errorFunc: /* ctx */ ErrorContext => CallbackTo[ErrorContext] = null,
    ...
    responseFunc: (/* request */ Request, /* reply */ js.Function2[/* err */ js.Any, /* response */ ResponseObject, Unit]) => Callback = null,
    tokenType: String = null,
    urlKey: String | Boolean = null,
    verifyOptions: VerifyOptions = null
  ): Options = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("validate")(js.Any.fromFunction3((t0: js.Object, t1: typingsJapgolly.hapiHapi.mod.Request, t2: typingsJapgolly.hapiHapi.mod.ResponseToolkit) => validate(t0, t1, t2).runNow()))
    ...
    if (customExtractionFunc != null) __obj.updateDynamic("customExtractionFunc")(js.Any.fromFunction1((t0: /* request */ typingsJapgolly.hapiHapi.mod.Request) => customExtractionFunc(t0).runNow()))
    if (errorFunc != null) __obj.updateDynamic("errorFunc")(js.Any.fromFunction1((t0: /* ctx */ typingsJapgolly.hapiAuthJwt2.mod.ErrorContext) => errorFunc(t0).runNow()))
    ...
    if (responseFunc != null) __obj.updateDynamic("responseFunc")(js.Any.fromFunction2((t0: /* request */ typingsJapgolly.hapiHapi.mod.Request, t1: /* reply */ js.Function2[
  /* err */ js.Any, 
  /* response */ typingsJapgolly.hapiHapi.mod.ResponseObject, 
  scala.Unit]) => responseFunc(t0, t1).runNow()))
