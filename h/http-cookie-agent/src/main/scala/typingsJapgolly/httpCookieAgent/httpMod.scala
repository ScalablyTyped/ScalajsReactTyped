...
import typingsJapgolly.node.nodeColonhttpMod.Agent
...
object httpMod {
  ...
  val HttpsCookieAgent: Instantiable1[
    /* options */ typingsJapgolly.node.httpsMod.AgentOptions & CookieAgentOptions, 
    CookieAgent[typingsJapgolly.node.nodeColonhttpsMod.Agent]
  ] = js.native
  
  @JSImport("http-cookie-agent/http", "MixedCookieAgent")
  @js.native
  val MixedCookieAgent: Instantiable1[
    /* options */ AgentOptions & typingsJapgolly.node.httpsMod.AgentOptions & CookieAgentOptions, 
    CookieAgent[typingsJapgolly.node.nodeColonhttpsMod.Agent]
  ] = js.native
