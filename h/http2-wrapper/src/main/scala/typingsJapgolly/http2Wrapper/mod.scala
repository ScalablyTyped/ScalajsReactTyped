...
import typingsJapgolly.http2Wrapper.anon.AgentOptionsproxyOptionsP
import typingsJapgolly.http2Wrapper.anon.AgentOptionsproxyOptionsPALPNProtocols
import typingsJapgolly.http2Wrapper.anon.AgentOptionsproxyOptionsPMaxCachedTlsSessions
import typingsJapgolly.http2Wrapper.anon.CreateResolveProtocol
import typingsJapgolly.http2Wrapper.anon.Http
import typingsJapgolly.http2Wrapper.http2WrapperBooleans.`false`
...
import typingsJapgolly.node.http2Mod.ClientSessionRequestOptions
...
object mod {
  ...
  open class Http2ServerRequest protected ()
    extends typingsJapgolly.node.http2Mod.Http2ServerRequest {
    def this(
  ...
  open class Http2ServerResponse protected ()
    extends typingsJapgolly.node.http2Mod.Http2ServerResponse {
  ...
  @js.native
  val auto: (RequestFunction[js.Promise[typingsJapgolly.node.httpMod.ClientRequest], AutoRequestOptions]) & CreateResolveProtocol = js.native
  ...
  inline def connect(
    ...
    listener: js.Function2[
      ...
      /* socket */ Socket | typingsJapgolly.node.nodeColontlsMod.TLSSocket, 
      Unit
    ]
  ...
  @js.native
  val get: RequestFunction[typingsJapgolly.node.httpMod.ClientRequest, RequestOptions] = js.native
  ...
  @js.native
  val request: RequestFunction[typingsJapgolly.node.httpMod.ClientRequest, RequestOptions] = js.native
  ...
  object PromiseListeners {
    ...
    inline def apply(reject: js.Error => Callback, resolve: Any => Callback): PromiseListeners = {
  ...
  type RequestFunction[T, O] = (js.Function3[
    ...
    /* callback */ js.UndefOr[js.Function1[/* response */ typingsJapgolly.node.httpMod.IncomingMessage, Unit]], 
    T
  ]) & (js.Function2[
    /* url */ String | URL_, 
    /* callback */ js.UndefOr[js.Function1[/* response */ typingsJapgolly.node.httpMod.IncomingMessage, Unit]], 
