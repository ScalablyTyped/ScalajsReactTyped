...
import typingsJapgolly.http2Wrapper.http2WrapperStrings.fifo
import typingsJapgolly.http2Wrapper.http2WrapperStrings.lifo
import typingsJapgolly.http2Wrapper.mod.AutoRequestOptions
import typingsJapgolly.http2Wrapper.mod.ProxyOptions
import typingsJapgolly.http2Wrapper.mod.ResolveProtocolConnectFunction
import typingsJapgolly.http2Wrapper.mod.ResolveProtocolFunction
import typingsJapgolly.http2Wrapper.mod.ResolveProtocolResult
...
object anon {
  ...
  trait Http extends StObject {
    ...
    var http2: js.UndefOr[typingsJapgolly.http2Wrapper.mod.Agent | `false`] = js.undefined
    
    var https: js.UndefOr[typingsJapgolly.node.httpsMod.Agent | `false`] = js.undefined
  }
  object Http {
    ...
    extension [Self <: Http](x: Self) {
      ...
      inline def setHttp2(value: typingsJapgolly.http2Wrapper.mod.Agent | `false`): Self = StObject.set(x, "http2", value.asInstanceOf[js.Any])
      
      inline def setHttp2Undefined: Self = StObject.set(x, "http2", js.undefined)
      
      inline def setHttpUndefined: Self = StObject.set(x, "http", js.undefined)
      
      inline def setHttps(value: typingsJapgolly.node.httpsMod.Agent | `false`): Self = StObject.set(x, "https", value.asInstanceOf[js.Any])
