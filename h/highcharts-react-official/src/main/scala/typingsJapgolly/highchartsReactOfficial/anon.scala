...
import typingsJapgolly.highcharts.mod.AST
...
import typingsJapgolly.highcharts.mod.SVGRenderer
...
object anon {
  ...
  trait TypeofSeries
    ...
    /**
      ...
      */
    var types: Dictionary[typingsJapgolly.highcharts.anon.TypeofSeries] = js.native
  }
}
