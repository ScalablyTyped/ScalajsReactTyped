...
import typingsJapgolly.hydraBox.anon.ResourceclownfacePromiseG
import typingsJapgolly.hydraBox.apiMod.Api
import typingsJapgolly.hydraBox.middlewareMod.Options
...
object mod {
  ...
  @js.native
  def Api: typingsJapgolly.hydraBox.apiMod.Api[DatasetCore[Quad, Quad]] = js.native
  ...
  object PropertyResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(dataset = dataset.toJsFn, prefetchDataset = prefetchDataset.asInstanceOf[js.Any], property = property.asInstanceOf[js.Any], quadStream = quadStream.toJsFn, term = term.asInstanceOf[js.Any], types = types.asInstanceOf[js.Any])
  ...
  object Resource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(dataset = dataset.toJsFn, prefetchDataset = prefetchDataset.asInstanceOf[js.Any], quadStream = quadStream.toJsFn, term = term.asInstanceOf[js.Any], types = types.asInstanceOf[js.Any])
