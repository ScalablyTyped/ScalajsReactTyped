...
import typingsJapgolly.hermesProfileTransformer.distTypesPhasesMod.EventsPhase
...
trait SharedEventProperties extends StObject {
  ...
  /**
    ...
    */
  var args: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ key in string ]: any} */ js.Any
  ] = js.undefined
