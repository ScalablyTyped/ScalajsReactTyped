...
import typingsJapgolly.hermesProfileTransformer.distTypesEventInterfacesMod.SharedEventProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distTypesHermesProfileMod {
  
  trait HermesCPUProfile extends StObject {
    
    var samples: js.Array[HermesSample]
    
    var stackFrames: /* import warning: importer.ImportType#apply Failed type conversion: {[ key in string ]: hermes-profile-transformer.hermes-profile-transformer/dist/types/HermesProfile.HermesStackFrame} */ js.Any
  ...
  object HermesCPUProfile {
    ...
    extension [Self <: HermesCPUProfile](x: Self) {
      ...
      inline def setStackFrames(
        value: /* import warning: importer.ImportType#apply Failed type conversion: {[ key in string ]: hermes-profile-transformer.hermes-profile-transformer/dist/types/HermesProfile.HermesStackFrame} */ js.Any
