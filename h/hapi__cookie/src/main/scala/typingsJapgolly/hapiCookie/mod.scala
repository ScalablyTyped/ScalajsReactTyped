...
import typingsJapgolly.hapiCookie.anon.Clear
import typingsJapgolly.hapiCookie.anon.RedirectTo
import typingsJapgolly.hapiCookie.anon.ServerStateCookieOptionsn
...
object mod extends Shortcut {
  ...
  object hapiHapiAugmentingMod {
    ...
    object Request {
      ...
      inline def apply(cookieAuth: Clear): typingsJapgolly.hapiCookie.mod.hapiHapiAugmentingMod.Request = {
        val __obj = js.Dynamic.literal(cookieAuth = cookieAuth.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.hapiCookie.mod.hapiHapiAugmentingMod.Request]
      }
      
      extension [Self <: typingsJapgolly.hapiCookie.mod.hapiHapiAugmentingMod.Request](x: Self) {
