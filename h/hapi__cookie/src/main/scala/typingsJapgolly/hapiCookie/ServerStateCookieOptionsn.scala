...
import typingsJapgolly.hapiHapi.AnonIntegrity
...
object ServerStateCookieOptionsn {
  ...
  def apply(
    ...
    if (autoValue != null) __obj.updateDynamic("autoValue")(js.Any.fromFunction1((t0: /* request */ typingsJapgolly.hapiHapi.mod.Request) => autoValue(t0).runNow()))
