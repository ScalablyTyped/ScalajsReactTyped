package typingsJapgolly.hapiCookie.mod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.hapiCookie.ServerStateCookieOptionsn
...
object Options {
  ...
  def apply(
    ...
    validateFunc: (/* request */ js.UndefOr[Request], /* session */ js.UndefOr[js.Object]) => CallbackTo[js.Promise[ValidateResponse]] = null
  ): Options = {
    ...
    if (validateFunc != null) __obj.updateDynamic("validateFunc")(js.Any.fromFunction2((t0: /* request */ js.UndefOr[typingsJapgolly.hapiHapi.mod.Request], t1: /* session */ js.UndefOr[js.Object]) => validateFunc(t0, t1).runNow()))
