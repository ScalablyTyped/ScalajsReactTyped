package typingsJapgolly.handlebarsHelpers
...
import typingsJapgolly.handlebars.hbs.AST.helpers
...
object anon {
  ...
  trait TypeofAST extends StObject {
    ...
    val helpers: typingsJapgolly.handlebars.hbs.AST.helpers
  }
  object TypeofAST {
  ...
  trait TypeofHandlebars extends StObject {
    ...
    def create(): typingsJapgolly.handlebars.anon.TypeofHandlebars = js.native
    ...
    def noConflict(): typingsJapgolly.handlebars.anon.TypeofHandlebars = js.native
