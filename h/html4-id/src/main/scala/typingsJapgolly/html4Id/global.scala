package typingsJapgolly.html4Id
...
object global {
  ...
  /**
    ...
    */
  inline def idify(input: String): String = js.Dynamic.global.applyDynamic("idify")(input.asInstanceOf[js.Any]).asInstanceOf[String]
}
