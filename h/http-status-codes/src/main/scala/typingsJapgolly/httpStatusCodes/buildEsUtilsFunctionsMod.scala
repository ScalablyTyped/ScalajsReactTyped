...
object buildEsUtilsFunctionsMod {
  
  @JSImport("http-status-codes/build/es/utils-functions", JSImport.Namespace)
  @js.native
  ...
  @JSImport("http-status-codes/build/es/utils-functions", "getStatusText")
  @js.native
