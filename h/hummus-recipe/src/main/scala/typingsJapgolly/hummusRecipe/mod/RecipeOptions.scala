...
import typingsJapgolly.hummusRecipe.hummusRecipeStrings.cmyk
import typingsJapgolly.hummusRecipe.hummusRecipeStrings.grey
import typingsJapgolly.hummusRecipe.hummusRecipeStrings.rgb
