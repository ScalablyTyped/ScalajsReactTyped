...
import typingsJapgolly.heicConvert.heicConvertStrings.JPEG
import typingsJapgolly.heicConvert.heicConvertStrings.PNG
...
object mod {
  ...
  object Convertible {
    ...
    inline def apply(convert: CallbackTo[js.Promise[js.typedarray.ArrayBuffer]]): Convertible = {
      val __obj = js.Dynamic.literal(convert = convert.toJsFn)
      __obj.asInstanceOf[Convertible]
    }
    
    extension [Self <: Convertible](x: Self) {
      
      inline def setConvert(value: CallbackTo[js.Promise[js.typedarray.ArrayBuffer]]): Self = StObject.set(x, "convert", value.toJsFn)
    }
  }
}
