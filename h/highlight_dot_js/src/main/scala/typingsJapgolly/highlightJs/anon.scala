...
import typingsJapgolly.highlightJs.highlightJsStrings.second_best
import typingsJapgolly.highlightJs.highlightJsStrings.self
import typingsJapgolly.highlightJs.mod.CallbackResponse
import typingsJapgolly.highlightJs.mod.CompiledMode
import typingsJapgolly.highlightJs.mod.Emitter
import typingsJapgolly.highlightJs.mod.EmitterConstructor
import typingsJapgolly.highlightJs.mod.HighlightResult
import typingsJapgolly.highlightJs.mod.Mode
import typingsJapgolly.highlightJs.mod.ModeCallback
import typingsJapgolly.highlightJs.mod.RegexEitherOptions
import typingsJapgolly.highlightJs.mod.illegalData
...
object anon {
  ...
  trait OmitHighlightResultsecond extends StObject {
    ...
    var _top: js.UndefOr[typingsJapgolly.highlightJs.mod.Language | CompiledMode] = js.undefined
  ...
  object OmitHighlightResultsecond {
    ...
    extension [Self <: OmitHighlightResultsecond](x: Self) {
      ...
      inline def set_top(value: typingsJapgolly.highlightJs.mod.Language | CompiledMode): Self = StObject.set(x, "_top", value.asInstanceOf[js.Any])
