...
import typingsJapgolly.highlightJs.anon.AnyNumberOfTimes
import typingsJapgolly.highlightJs.anon.LanguageName
import typingsJapgolly.highlightJs.anon.PartialHLJSOptions
