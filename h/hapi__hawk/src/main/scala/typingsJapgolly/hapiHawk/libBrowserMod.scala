...
import typingsJapgolly.cryptoJs.anon.Hasher
import typingsJapgolly.cryptoJs.anon.PartialCipherParams
import typingsJapgolly.cryptoJs.mod.BlockCipherMode
import typingsJapgolly.cryptoJs.mod.CipherHelper
import typingsJapgolly.cryptoJs.mod.CipherOption
import typingsJapgolly.cryptoJs.mod.CipherParams
import typingsJapgolly.cryptoJs.mod.CipherStatic
import typingsJapgolly.cryptoJs.mod.Encoder
import typingsJapgolly.cryptoJs.mod.Format_
import typingsJapgolly.cryptoJs.mod.HasherHelper
import typingsJapgolly.cryptoJs.mod.HasherStatic
import typingsJapgolly.cryptoJs.mod.HmacHasherHelper
...
import typingsJapgolly.cryptoJs.mod.X64Word
import typingsJapgolly.cryptoJs.mod.X64WordArray
import typingsJapgolly.hapiHawk.libBrowserMod.utils.ParsedUri
    ...
    object utils {
      ...
      object algo {
        ...
        /**
          ...
          */
        /* note: abstract class */ @JSImport("@hapi/hawk/lib/browser", "crypto.utils.algo.EvpKDF")
        @js.native
        open class EvpKDF ()
          extends typingsJapgolly.cryptoJs.mod.algo.EvpKDF
        object EvpKDF {
          ...
          /**
            ...
            */
          /* static member */
          inline def create(): typingsJapgolly.cryptoJs.mod.global.CryptoJS.algo.EvpKDF = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.algo.EvpKDF]
          inline def create(cfg: Hasher): typingsJapgolly.cryptoJs.mod.global.CryptoJS.algo.EvpKDF = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(cfg.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.algo.EvpKDF]
        }
        
        /**
          * HMAC algorithm.
          */
        /* note: abstract class */ @JSImport("@hapi/hawk/lib/browser", "crypto.utils.algo.HMAC")
        @js.native
        open class HMAC ()
          extends typingsJapgolly.cryptoJs.mod.algo.HMAC
        object HMAC {
          ...
          inline def create(hasher: HasherStatic, key: String): typingsJapgolly.cryptoJs.mod.global.CryptoJS.algo.HMAC = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(hasher.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.algo.HMAC]
          /**
            ...
            */
          /* static member */
          inline def create(hasher: HasherStatic, key: WordArray): typingsJapgolly.cryptoJs.mod.global.CryptoJS.algo.HMAC = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(hasher.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.algo.HMAC]
        }
        ...
        /**
          ...
          */
        /* note: abstract class */ @JSImport("@hapi/hawk/lib/browser", "crypto.utils.algo.PBKDF2")
        @js.native
        open class PBKDF2 ()
          extends typingsJapgolly.cryptoJs.mod.algo.PBKDF2
        object PBKDF2 {
          ...
          /**
            ...
            */
          /* static member */
          inline def create(): typingsJapgolly.cryptoJs.mod.global.CryptoJS.algo.PBKDF2 = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.algo.PBKDF2]
          inline def create(cfg: KDFOption): typingsJapgolly.cryptoJs.mod.global.CryptoJS.algo.PBKDF2 = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(cfg.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.algo.PBKDF2]
        }
      ...
      object lib {
        ...
        object Cipher {
          ...
          /**
            ...
            */
          inline def createHelper(cipher: typingsJapgolly.cryptoJs.mod.Cipher): CipherHelper = ^.asInstanceOf[js.Dynamic].applyDynamic("_createHelper")(cipher.asInstanceOf[js.Any]).asInstanceOf[CipherHelper]
        }
        ...
        object CipherParams {
          ...
          /**
            ...
            *     });
            */
          inline def create(cipherParams: PartialCipherParams): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(cipherParams.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams]
        }
        ...
        object PasswordBasedCipher {
          ...
          inline def decrypt(cipher: CipherStatic, ciphertext: String, password: String): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray = (^.asInstanceOf[js.Dynamic].applyDynamic("decrypt")(cipher.asInstanceOf[js.Any], ciphertext.asInstanceOf[js.Any], password.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray]
          inline def decrypt(cipher: CipherStatic, ciphertext: String, password: String, cfg: CipherOption): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray = (^.asInstanceOf[js.Dynamic].applyDynamic("decrypt")(cipher.asInstanceOf[js.Any], ciphertext.asInstanceOf[js.Any], password.asInstanceOf[js.Any], cfg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray]
          /**
          ...
          inline def decrypt(
            cipher: CipherStatic,
            ciphertext: typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams,
            password: String
          ): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray = (^.asInstanceOf[js.Dynamic].applyDynamic("decrypt")(cipher.asInstanceOf[js.Any], ciphertext.asInstanceOf[js.Any], password.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray]
          inline def decrypt(
            cipher: CipherStatic,
            ciphertext: typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams,
            password: String,
            cfg: CipherOption
          ): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray = (^.asInstanceOf[js.Dynamic].applyDynamic("decrypt")(cipher.asInstanceOf[js.Any], ciphertext.asInstanceOf[js.Any], password.asInstanceOf[js.Any], cfg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray]
          
          inline def encrypt(cipher: CipherStatic, message: String, password: String): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams = (^.asInstanceOf[js.Dynamic].applyDynamic("encrypt")(cipher.asInstanceOf[js.Any], message.asInstanceOf[js.Any], password.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams]
          inline def encrypt(cipher: CipherStatic, message: String, password: String, cfg: CipherOption): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams = (^.asInstanceOf[js.Dynamic].applyDynamic("encrypt")(cipher.asInstanceOf[js.Any], message.asInstanceOf[js.Any], password.asInstanceOf[js.Any], cfg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams]
          /**
          ...
          inline def encrypt(
            cipher: CipherStatic,
            message: typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray,
            password: String
          ): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams = (^.asInstanceOf[js.Dynamic].applyDynamic("encrypt")(cipher.asInstanceOf[js.Any], message.asInstanceOf[js.Any], password.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams]
          inline def encrypt(
            cipher: CipherStatic,
            message: typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray,
            password: String,
            cfg: CipherOption
          ): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams = (^.asInstanceOf[js.Dynamic].applyDynamic("encrypt")(cipher.asInstanceOf[js.Any], message.asInstanceOf[js.Any], password.asInstanceOf[js.Any], cfg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams]
        }
        ...
        object SerializableCipher {
          ...
          inline def decrypt(
            cipher: CipherStatic,
            ciphertext: String,
            key: typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray
          ): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams = (^.asInstanceOf[js.Dynamic].applyDynamic("decrypt")(cipher.asInstanceOf[js.Any], ciphertext.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams]
          inline def decrypt(
            cipher: CipherStatic,
            ciphertext: String,
            key: typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray,
            cfg: CipherOption
          ): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams = (^.asInstanceOf[js.Dynamic].applyDynamic("decrypt")(cipher.asInstanceOf[js.Any], ciphertext.asInstanceOf[js.Any], key.asInstanceOf[js.Any], cfg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams]
          /**
          ...
          inline def decrypt(
            cipher: CipherStatic,
            ciphertext: typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray,
            key: typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray
          ): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams = (^.asInstanceOf[js.Dynamic].applyDynamic("decrypt")(cipher.asInstanceOf[js.Any], ciphertext.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams]
          inline def decrypt(
            cipher: CipherStatic,
          ...
          inline def encrypt(
            ...
            message: String,
            key: typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray
          ): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams = (^.asInstanceOf[js.Dynamic].applyDynamic("encrypt")(cipher.asInstanceOf[js.Any], message.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams]
          inline def encrypt(
            cipher: CipherStatic,
            message: String,
            key: typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray,
            cfg: CipherOption
          ): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams = (^.asInstanceOf[js.Dynamic].applyDynamic("encrypt")(cipher.asInstanceOf[js.Any], message.asInstanceOf[js.Any], key.asInstanceOf[js.Any], cfg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams]
          /**
            * Encrypts a message.
            *
            * @param cipher The cipher algorithm to use.
          ...
          inline def parse(ciphertext: String, format: Format_): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams = (^.asInstanceOf[js.Dynamic].applyDynamic("_parse")(ciphertext.asInstanceOf[js.Any], format.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams]
          /**
            ...
            */
          inline def parse(ciphertext: typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams, format: Format_): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams = (^.asInstanceOf[js.Dynamic].applyDynamic("_parse")(ciphertext.asInstanceOf[js.Any], format.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.CipherParams]
        }
        ...
        object WordArray {
          ...
          /**
            ...
            */
          inline def create(): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray]
          inline def create(words: js.Array[Double]): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(words.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray]
          inline def create(words: js.Array[Double], sigBytes: Double): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(words.asInstanceOf[js.Any], sigBytes.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray]
          inline def create(words: Unit, sigBytes: Double): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(words.asInstanceOf[js.Any], sigBytes.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray]
          ...
          /**
            ...
            */
          inline def random(nBytes: Double): typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray = ^.asInstanceOf[js.Dynamic].applyDynamic("random")(nBytes.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.cryptoJs.mod.global.CryptoJS.lib.WordArray]
        }
      }
