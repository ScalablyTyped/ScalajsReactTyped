...
import typingsJapgolly.hellojs.AnonCode
...
trait HelloJSUtils extends js.Object {
  ...
  def append(node: String, attr: js.UndefOr[scala.Nothing], target: typingsJapgolly.std.HTMLElement): HTMLElement = js.native
  def append(node: String, attr: js.Object, target: String): HTMLElement = js.native
  def append(node: String, attr: js.Object, target: typingsJapgolly.std.HTMLElement): HTMLElement = js.native
  def append(node: String, attr: Null, target: String): HTMLElement = js.native
  def append(node: String, attr: Null, target: typingsJapgolly.std.HTMLElement): HTMLElement = js.native
  def append(node: typingsJapgolly.std.HTMLElement, attr: js.UndefOr[scala.Nothing], target: String): HTMLElement = js.native
  def append(
  ...
  def append(node: typingsJapgolly.std.HTMLElement, attr: js.Object, target: String): HTMLElement = js.native
  def append(node: typingsJapgolly.std.HTMLElement, attr: js.Object, target: typingsJapgolly.std.HTMLElement): HTMLElement = js.native
  def append(node: typingsJapgolly.std.HTMLElement, attr: Null, target: String): HTMLElement = js.native
  def append(node: typingsJapgolly.std.HTMLElement, attr: Null, target: typingsJapgolly.std.HTMLElement): HTMLElement = js.native
