...
object HelloJSServiceDef {
  ...
  def apply(
    ...
    xhr: (/* p */ js.Any, /* query */ js.Any) => Callback = null
  ): HelloJSServiceDef = {
    ...
    if (login != null) __obj.updateDynamic("login")(js.Any.fromFunction1((t0: /* p */ js.Any) => login(t0).runNow()))
    ...
    if (xhr != null) __obj.updateDynamic("xhr")(js.Any.fromFunction2((t0: /* p */ js.Any, t1: /* query */ js.Any) => xhr(t0, t1).runNow()))
