...
object ^ extends js.Object {
  ...
  def createIcon(svg: String, options: typingsJapgolly.heremaps.H.map.Icon.Options): Icon = js.native
  def createIcon(svg: js.Array[_]): Icon = js.native
  def createIcon(svg: js.Array[_], options: typingsJapgolly.heremaps.H.map.Icon.Options): Icon = js.native
  /**
