package typingsJapgolly.heredatalens

import org.scalajs.dom.HTMLCanvasElement
import typingsJapgolly.heredatalens.H.datalens.HeatmapLayer.Aggregation
import typingsJapgolly.heredatalens.H.datalens.HeatmapLayer.InputScale
import typingsJapgolly.heredatalens.H.datalens.HeatmapLayer.Options
import typingsJapgolly.heredatalens.H.datalens.HeatmapLayer.Row
...
import typingsJapgolly.heredatalens.H.datalens.RasterLayer.TilePoint
...
import typingsJapgolly.heremaps.H.util.Cache
  ...
  object H {
    ...
    object datalens {
      ...
      open class HeatmapLayer protected ()
        extends StObject
           with typingsJapgolly.heredatalens.H.datalens.HeatmapLayer {
        /**
          * Constructor
          * @param provider - Source of tiled data
          * @param options - Configuration for data processing and rendering
          */
        def this(provider: typingsJapgolly.heredatalens.H.datalens.QueryTileProvider, options: Options) = this()
      ...
      object HeatmapLayer {
        ...
        object Aggregation_ extends StObject {
          ...
          /* 1 */ val AVERAGE: typingsJapgolly.heredatalens.H.datalens.HeatmapLayer.Aggregation.AVERAGE & Double = js.native
          
          /* 0 */ val SUM: typingsJapgolly.heredatalens.H.datalens.HeatmapLayer.Aggregation.SUM & Double = js.native
        }
        ...
        object InputScale_ extends StObject {
          ...
          /* 0 */ val DB: typingsJapgolly.heredatalens.H.datalens.HeatmapLayer.InputScale.DB & Double = js.native
          
          /* 1 */ val LINEAR: typingsJapgolly.heredatalens.H.datalens.HeatmapLayer.InputScale.LINEAR & Double = js.native
          
          /* 2 */ val LOG: typingsJapgolly.heredatalens.H.datalens.HeatmapLayer.InputScale.LOG & Double = js.native
        }
      ...
      open class ObjectLayer protected ()
        extends StObject
           with typingsJapgolly.heredatalens.H.datalens.ObjectLayer {
        def this(
          provider: typingsJapgolly.heredatalens.H.datalens.Provider,
          options: typingsJapgolly.heredatalens.H.datalens.ObjectLayer.Options
        ) = this()
        def this(
          provider: typingsJapgolly.heredatalens.H.datalens.QueryProvider,
          options: typingsJapgolly.heredatalens.H.datalens.ObjectLayer.Options
        ) = this()
        def this(
          provider: typingsJapgolly.heredatalens.H.datalens.QueryTileProvider,
          options: typingsJapgolly.heredatalens.H.datalens.ObjectLayer.Options
        ) = this()
        /**
          * Constructor
          ...
          */
        def this(provider: RemoteTileProvider, options: typingsJapgolly.heredatalens.H.datalens.ObjectLayer.Options) = this()
      ...
      object ObjectLayer {
        ...
        inline def createIcon(svg: String, options: typingsJapgolly.heremaps.H.map.Icon.Options): Icon = (^.asInstanceOf[js.Dynamic].applyDynamic("createIcon")(svg.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Icon]
        ...
        inline def createIcon(svg: js.Array[Any], options: typingsJapgolly.heremaps.H.map.Icon.Options): Icon = (^.asInstanceOf[js.Dynamic].applyDynamic("createIcon")(svg.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Icon]
        
        /**
          * Default value for dataToRows callback option. It represents each row as an object where property names correspond to data column names.
          */
        /* static member */
        inline def defaultDataToRows(data: Data): js.Array[typingsJapgolly.heredatalens.H.datalens.ObjectLayer.Row] = ^.asInstanceOf[js.Dynamic].applyDynamic("defaultDataToRows")(data.asInstanceOf[js.Any]).asInstanceOf[js.Array[typingsJapgolly.heredatalens.H.datalens.ObjectLayer.Row]]
      ...
      open class Provider ()
        extends StObject
           with typingsJapgolly.heredatalens.H.datalens.Provider {
        def this(data: Data) = this()
        def this(data: Unit, options: typingsJapgolly.heremaps.H.map.provider.Provider.Options) = this()
        def this(data: Data, options: typingsJapgolly.heremaps.H.map.provider.Provider.Options) = this()
      }
      ...
      open class QueryProvider protected ()
        extends StObject
           with typingsJapgolly.heredatalens.H.datalens.QueryProvider {
        /**
          * Constructor
          ...
          */
        def this(data: Data) = this()
        def this(data: Data, options: typingsJapgolly.heredatalens.H.datalens.QueryProvider.Options) = this()
      }
      ...
      open class QueryTileProvider protected ()
        extends StObject
           with typingsJapgolly.heredatalens.H.datalens.QueryTileProvider {
        /**
          * Constructor
          * @param service - Data Lens REST API service
          * @param options - Configures source query and data accessibility parameters
          */
        def this(
          service: typingsJapgolly.heredatalens.H.datalens.Service,
          options: typingsJapgolly.heredatalens.H.datalens.QueryTileProvider.Options
        ) = this()
      }
      ...
      open class RasterLayer ()
        extends StObject
           with typingsJapgolly.heredatalens.H.datalens.RasterLayer {
      ...
      open class RawDataProvider protected ()
        extends StObject
           with typingsJapgolly.heredatalens.H.datalens.RawDataProvider {
        /**
          * Constructor
          * @param options - Configures options
          */
        def this(options: typingsJapgolly.heredatalens.H.datalens.RawDataProvider.Options) = this()
      }
      ...
      open class Service ()
        extends StObject
           with typingsJapgolly.heredatalens.H.datalens.Service {
        def this(options: typingsJapgolly.heredatalens.H.datalens.Service.Options) = this()
      }
      ...
      open class SpatialLayer protected ()
        extends StObject
           with typingsJapgolly.heredatalens.H.datalens.SpatialLayer {
        /**
          * Constructor
          ...
          */
        def this(
          dataProvider: typingsJapgolly.heredatalens.H.datalens.Provider,
          spatialProvider: typingsJapgolly.heredatalens.H.datalens.SpatialTileProvider,
          options: typingsJapgolly.heredatalens.H.datalens.SpatialLayer.Options
        ) = this()
      ...
      open class SpatialTileProvider protected ()
        extends StObject
           with typingsJapgolly.heredatalens.H.datalens.SpatialTileProvider {
        /**
          * Constructor
          * @param service - Data Lens REST API service
        ...
        def this(
          service: typingsJapgolly.heredatalens.H.datalens.Service,
          options: typingsJapgolly.heredatalens.H.datalens.SpatialTileProvider.Options
        ) = this()
      }
