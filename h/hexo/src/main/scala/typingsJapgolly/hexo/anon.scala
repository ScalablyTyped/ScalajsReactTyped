...
object anon {
  ...
  trait Console extends StObject {
    ...
    /**
      ...
      */
    val console: typingsJapgolly.hexo.mod.extend.Console
  ...
  object Console {
    ...
    inline def apply(
      console: typingsJapgolly.hexo.mod.extend.Console,
      deployer: Deployer,
      filter: Filter,
      generator: Generator,
      helper: Helper,
    ...
    extension [Self <: Console](x: Self) {
      ...
      inline def setConsole(value: typingsJapgolly.hexo.mod.extend.Console): Self = StObject.set(x, "console", value.asInstanceOf[js.Any])
