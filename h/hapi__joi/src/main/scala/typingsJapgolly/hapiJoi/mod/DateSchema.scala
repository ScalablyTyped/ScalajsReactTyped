...
import typingsJapgolly.hapiJoi.hapiJoiStrings.javascript
import typingsJapgolly.hapiJoi.hapiJoiStrings.now
import typingsJapgolly.hapiJoi.hapiJoiStrings.unix
