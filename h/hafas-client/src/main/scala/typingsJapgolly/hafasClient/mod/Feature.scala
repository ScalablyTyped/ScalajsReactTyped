...
trait Feature extends StObject {
  ...
  var `type`: typingsJapgolly.hafasClient.hafasClientStrings.Feature
}
object Feature {
  ...
  extension [Self <: Feature](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.hafasClient.hafasClientStrings.Feature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
