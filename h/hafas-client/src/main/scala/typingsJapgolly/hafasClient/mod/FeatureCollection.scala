...
trait FeatureCollection extends StObject {
  ...
  var `type`: typingsJapgolly.hafasClient.hafasClientStrings.FeatureCollection
}
object FeatureCollection {
  ...
  extension [Self <: FeatureCollection](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.hafasClient.hafasClientStrings.FeatureCollection): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
