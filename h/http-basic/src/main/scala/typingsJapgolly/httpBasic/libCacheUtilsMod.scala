...
object libCacheUtilsMod {
  ...
  inline def canCache[T](res: typingsJapgolly.httpResponseObject.mod.^[T]): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("canCache")(res.asInstanceOf[js.Any]).asInstanceOf[Boolean]
