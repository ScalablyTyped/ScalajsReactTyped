...
object libCacheControlUtilsMod {
  ...
  inline def cachePolicy[T](res: typingsJapgolly.httpResponseObject.mod.^[T]): Policy | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("cachePolicy")(res.asInstanceOf[js.Any]).asInstanceOf[Policy | Null]
  ...
  inline def isCacheable[T](res: typingsJapgolly.httpResponseObject.mod.^[T]): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCacheable")(res.asInstanceOf[js.Any]).asInstanceOf[Boolean]
