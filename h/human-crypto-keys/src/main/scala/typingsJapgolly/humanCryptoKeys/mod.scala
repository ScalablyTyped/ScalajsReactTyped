package typingsJapgolly.humanCryptoKeys

import typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.ed25519
import typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.rsa
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.modulusLength
    - typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.ed25519
    - typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.rsa
    - typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.method
    - typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.id
    - typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.publicExponent
  */
  trait Algorithm extends StObject
  object Algorithm {
    
    inline def ed25519: typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.ed25519 = "ed25519".asInstanceOf[typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.ed25519]
    
    inline def id: typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.id = "id".asInstanceOf[typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.id]
    
    inline def method: typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.method = "method".asInstanceOf[typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.method]
    
    inline def modulusLength: typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.modulusLength = "modulusLength".asInstanceOf[typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.modulusLength]
    
    inline def publicExponent: typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.publicExponent = "publicExponent".asInstanceOf[typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.publicExponent]
    
    inline def rsa: typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.rsa = "rsa".asInstanceOf[typingsJapgolly.humanCryptoKeys.humanCryptoKeysStrings.rsa]
  }
