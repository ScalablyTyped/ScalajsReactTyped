package typingsJapgolly.hapiMimos.mod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.mimeDb.mod.DataStructure
...
object MimosOptionsValue {
  ...
  def apply(
    ...
    predicate: /* mime */ MimosOptionsValue => CallbackTo[MimosOptionsValue] = null,
    source: String = null,
    `type`: String = null
  ): MimosOptionsValue = {
    ...
    if (predicate != null) __obj.updateDynamic("predicate")(js.Any.fromFunction1((t0: /* mime */ typingsJapgolly.hapiMimos.mod.MimosOptionsValue) => predicate(t0).runNow()))
