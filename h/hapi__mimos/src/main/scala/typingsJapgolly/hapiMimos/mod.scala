package typingsJapgolly.hapiMimos

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.hapiMimos.hapiMimosStrings.`mime-db`
import typingsJapgolly.hapiMimos.hapiMimosStrings.mimos
import typingsJapgolly.hapiMimos.mod.MimeDb.MimeEntry
import typingsJapgolly.hapiMimos.mod.MimeDb.MimeSource
...
object mod {
  ...
  object MimeDb {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.hapiMimos.hapiMimosStrings.iana
      - typingsJapgolly.hapiMimos.hapiMimosStrings.apache
      - typingsJapgolly.hapiMimos.hapiMimosStrings.nginx
    */
    trait MimeSource extends StObject
    object MimeSource {
      
      inline def apache: typingsJapgolly.hapiMimos.hapiMimosStrings.apache = "apache".asInstanceOf[typingsJapgolly.hapiMimos.hapiMimosStrings.apache]
      
      inline def iana: typingsJapgolly.hapiMimos.hapiMimosStrings.iana = "iana".asInstanceOf[typingsJapgolly.hapiMimos.hapiMimosStrings.iana]
      
      inline def nginx: typingsJapgolly.hapiMimos.hapiMimosStrings.nginx = "nginx".asInstanceOf[typingsJapgolly.hapiMimos.hapiMimosStrings.nginx]
    }
  }
