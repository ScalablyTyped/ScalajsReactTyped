...
import typingsJapgolly.hasha.hashaStrings.buffer
import typingsJapgolly.hasha.hashaStrings.md5
import typingsJapgolly.hasha.hashaStrings.sha1
import typingsJapgolly.hasha.hashaStrings.sha256
import typingsJapgolly.hasha.hashaStrings.sha512
...
object mod {
  ...
  */
  ...
  object HashaEncoding {
    ...
    inline def base64: typingsJapgolly.hasha.hashaStrings.base64 = "base64".asInstanceOf[typingsJapgolly.hasha.hashaStrings.base64]
    
    inline def buffer: typingsJapgolly.hasha.hashaStrings.buffer = "buffer".asInstanceOf[typingsJapgolly.hasha.hashaStrings.buffer]
    
    inline def hex: typingsJapgolly.hasha.hashaStrings.hex = "hex".asInstanceOf[typingsJapgolly.hasha.hashaStrings.hex]
    
    inline def latin1: typingsJapgolly.hasha.hashaStrings.latin1 = "latin1".asInstanceOf[typingsJapgolly.hasha.hashaStrings.latin1]
  }
