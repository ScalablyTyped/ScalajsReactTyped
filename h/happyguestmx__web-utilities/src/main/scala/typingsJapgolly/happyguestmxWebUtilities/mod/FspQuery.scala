...
import typingsJapgolly.happyguestmxWebUtilities.happyguestmxWebUtilitiesStrings.asc
import typingsJapgolly.happyguestmxWebUtilities.happyguestmxWebUtilitiesStrings.desc
