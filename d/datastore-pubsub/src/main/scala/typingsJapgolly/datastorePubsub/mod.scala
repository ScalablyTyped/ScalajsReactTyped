package typingsJapgolly.datastorePubsub
...
object mod {
  ...
  open class PubSubDatastore protected () extends BaseDatastore {
    ...
    def this(
      ...
      validator: ValidateFn,
      selector: SelectFn,
      subscriptionKeyFn: typingsJapgolly.datastorePubsub.distSrcTypesMod.SubscriptionKeyFn
    ) = this()
    ...
    var _handleSubscriptionKeyFn: js.UndefOr[typingsJapgolly.datastorePubsub.distSrcTypesMod.SubscriptionKeyFn] = js.native
    ...
    /**
      ...
      */
    def _onMessage(evt: CustomEvent): js.Promise[Unit] = js.native
    ...
    def _storeIfSubscriptionIsBetter(
      ...
      options: typingsJapgolly.libp2pInterfaces.mod.AbortOptions
    ...
    def get(key: js.typedarray.Uint8Array, options: typingsJapgolly.libp2pInterfaces.mod.AbortOptions): js.Promise[js.typedarray.Uint8Array] = js.native
  ...
  type AbortOptions = typingsJapgolly.libp2pInterfaces.mod.AbortOptions
  
  type PeerId = typingsJapgolly.libp2pInterfacePeerId.mod.PeerId
  
  type PubSubMessage = Message
  
  type SubscriptionKeyFn = typingsJapgolly.datastorePubsub.distSrcTypesMod.SubscriptionKeyFn
}
