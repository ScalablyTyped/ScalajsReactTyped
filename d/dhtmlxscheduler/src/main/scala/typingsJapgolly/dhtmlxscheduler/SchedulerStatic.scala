...
trait SchedulerStatic extends js.Object {
  ...
  def init(container: typingsJapgolly.std.HTMLElement, date: js.Date): Unit = js.native
  def init(container: typingsJapgolly.std.HTMLElement, date: js.Date, view: String): Unit = js.native
  /**
  ...
  /**
  	...
  	*/
  def unmarkTimespan(divs: typingsJapgolly.std.HTMLElement): Unit = js.native
  /**
