...
object UseMultipleSelectionProps {
  ...
  extension [Self <: UseMultipleSelectionProps[?], Item](x: Self & UseMultipleSelectionProps[Item]) {
    ...
    inline def setOnActiveIndexChange(value: /* changes */ UseMultipleSelectionStateChange[Item] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onActiveIndexChange", js.Any.fromFunction1((t0: /* changes */ UseMultipleSelectionStateChange[Item]) => value(t0).runNow()))
    
    inline def setOnActiveIndexChangeUndefined: Self = StObject.set(x, "onActiveIndexChange", js.undefined)
    
    inline def setOnSelectedItemsChange(value: /* changes */ UseMultipleSelectionStateChange[Item] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onSelectedItemsChange", js.Any.fromFunction1((t0: /* changes */ UseMultipleSelectionStateChange[Item]) => value(t0).runNow()))
    
    inline def setOnSelectedItemsChangeUndefined: Self = StObject.set(x, "onSelectedItemsChange", js.undefined)
    
    inline def setOnStateChange(value: /* changes */ UseMultipleSelectionStateChange[Item] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onStateChange", js.Any.fromFunction1((t0: /* changes */ UseMultipleSelectionStateChange[Item]) => value(t0).runNow()))
