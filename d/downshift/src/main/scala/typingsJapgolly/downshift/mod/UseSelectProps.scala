...
object UseSelectProps {
  ...
  extension [Self <: UseSelectProps[?], Item](x: Self & UseSelectProps[Item]) {
    ...
    inline def setOnHighlightedIndexChange(value: /* changes */ UseSelectStateChange[Item] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onHighlightedIndexChange", js.Any.fromFunction1((t0: /* changes */ UseSelectStateChange[Item]) => value(t0).runNow()))
    
    inline def setOnHighlightedIndexChangeUndefined: Self = StObject.set(x, "onHighlightedIndexChange", js.undefined)
    
    inline def setOnIsOpenChange(value: /* changes */ UseSelectStateChange[Item] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onIsOpenChange", js.Any.fromFunction1((t0: /* changes */ UseSelectStateChange[Item]) => value(t0).runNow()))
    
    inline def setOnIsOpenChangeUndefined: Self = StObject.set(x, "onIsOpenChange", js.undefined)
    
    inline def setOnSelectedItemChange(value: /* changes */ UseSelectStateChange[Item] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onSelectedItemChange", js.Any.fromFunction1((t0: /* changes */ UseSelectStateChange[Item]) => value(t0).runNow()))
    
    inline def setOnSelectedItemChangeUndefined: Self = StObject.set(x, "onSelectedItemChange", js.undefined)
    
    inline def setOnStateChange(value: /* changes */ UseSelectStateChange[Item] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onStateChange", js.Any.fromFunction1((t0: /* changes */ UseSelectStateChange[Item]) => value(t0).runNow()))
