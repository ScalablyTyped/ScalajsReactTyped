...
object DownshiftProps {
  ...
  extension [Self <: DownshiftProps[?], Item](x: Self & DownshiftProps[Item]) {
    ...
    inline def setChildren(value: /* options */ ControllerStateAndHelpers[Item] => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    ...
    inline def setOnChange(
      value: (/* selectedItem */ Item | Null, /* stateAndHelpers */ ControllerStateAndHelpers[Item]) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* selectedItem */ Item | Null, t1: /* stateAndHelpers */ ControllerStateAndHelpers[Item]) => (value(t0, t1)).runNow()))
    
    inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
    
    inline def setOnInputValueChange(
      value: (/* inputValue */ String, /* stateAndHelpers */ ControllerStateAndHelpers[Item]) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "onInputValueChange", js.Any.fromFunction2((t0: /* inputValue */ String, t1: /* stateAndHelpers */ ControllerStateAndHelpers[Item]) => (value(t0, t1)).runNow()))
    
    inline def setOnInputValueChangeUndefined: Self = StObject.set(x, "onInputValueChange", js.undefined)
    
    inline def setOnOuterClick(value: /* stateAndHelpers */ ControllerStateAndHelpers[Item] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onOuterClick", js.Any.fromFunction1((t0: /* stateAndHelpers */ ControllerStateAndHelpers[Item]) => value(t0).runNow()))
    
    inline def setOnOuterClickUndefined: Self = StObject.set(x, "onOuterClick", js.undefined)
    
    inline def setOnSelect(
      value: (/* selectedItem */ Item | Null, /* stateAndHelpers */ ControllerStateAndHelpers[Item]) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "onSelect", js.Any.fromFunction2((t0: /* selectedItem */ Item | Null, t1: /* stateAndHelpers */ ControllerStateAndHelpers[Item]) => (value(t0, t1)).runNow()))
    
    inline def setOnSelectUndefined: Self = StObject.set(x, "onSelect", js.undefined)
    
    inline def setOnStateChange(
      value: (/* options */ StateChangeOptions[Item], /* stateAndHelpers */ ControllerStateAndHelpers[Item]) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "onStateChange", js.Any.fromFunction2((t0: /* options */ StateChangeOptions[Item], t1: /* stateAndHelpers */ ControllerStateAndHelpers[Item]) => (value(t0, t1)).runNow()))
    
    inline def setOnStateChangeUndefined: Self = StObject.set(x, "onStateChange", js.undefined)
    
    inline def setOnUserAction(
      value: (/* options */ StateChangeOptions[Item], /* stateAndHelpers */ ControllerStateAndHelpers[Item]) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "onUserAction", js.Any.fromFunction2((t0: /* options */ StateChangeOptions[Item], t1: /* stateAndHelpers */ ControllerStateAndHelpers[Item]) => (value(t0, t1)).runNow()))
