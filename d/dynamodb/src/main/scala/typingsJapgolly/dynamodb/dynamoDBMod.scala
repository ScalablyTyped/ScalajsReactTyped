...
object dynamoDBMod {
  ...
  */
  ...
  object DynamoDbSet {
    ...
    inline def BinarySet(values: js.Array[binaryType]): typingsJapgolly.dynamodb.dynamoDBMod.BinarySet = {
      val __obj = js.Dynamic.literal(values = values.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("Binary")
      __obj.asInstanceOf[typingsJapgolly.dynamodb.dynamoDBMod.BinarySet]
    }
    
    inline def NumberSet(values: js.Array[Double]): typingsJapgolly.dynamodb.dynamoDBMod.NumberSet = {
      val __obj = js.Dynamic.literal(values = values.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("Number")
      __obj.asInstanceOf[typingsJapgolly.dynamodb.dynamoDBMod.NumberSet]
    }
    
    inline def StringSet(values: js.Array[String]): typingsJapgolly.dynamodb.dynamoDBMod.StringSet = {
      val __obj = js.Dynamic.literal(values = values.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("String")
      __obj.asInstanceOf[typingsJapgolly.dynamodb.dynamoDBMod.StringSet]
    }
  }
  ...
  trait StringSet
    ...
    var `type`: typingsJapgolly.dynamodb.dynamodbStrings.String
  ...
  object StringSet {
    ...
    extension [Self <: StringSet](x: Self) {
      ...
      inline def setType(value: typingsJapgolly.dynamodb.dynamodbStrings.String): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
