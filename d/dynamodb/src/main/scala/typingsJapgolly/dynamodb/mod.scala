...
import typingsJapgolly.dynamodb.anon.ReadCapacity
import typingsJapgolly.dynamodb.callbackMod.Callback
import typingsJapgolly.dynamodb.dynamoDBMod.DocumentClient
import typingsJapgolly.dynamodb.dynamoDBMod.DynamoDB
import typingsJapgolly.dynamodb.dynamoDBMod.DynamoDbSet
import typingsJapgolly.dynamodb.dynamoDBMod.Projection
import typingsJapgolly.dynamodb.dynamodbStrings.global
import typingsJapgolly.dynamodb.dynamodbStrings.local
