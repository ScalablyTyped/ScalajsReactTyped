...
import typingsJapgolly.dynamodb.anon.CapacityUnits
import typingsJapgolly.dynamodb.anon.Dynamodb
import typingsJapgolly.dynamodb.callbackMod.Callback
import typingsJapgolly.dynamodb.modelMod.Model.OperationOptions
