...
object mod extends js.Object {
  ...
  def addClass(element: typingsJapgolly.std.Element, className: String): Unit = js.native
  ...
  def hasClass(element: typingsJapgolly.std.Element, className: String): Boolean = js.native
  ...
  def querySelectorAll(element: typingsJapgolly.std.HTMLElement, selector: String): js.Array[HTMLElement] = js.native
  def removeClass(element: typingsJapgolly.std.Element, className: String): Unit = js.native
  ...
  def toggleClass(element: typingsJapgolly.std.Element, className: String): Unit = js.native
