...
object cjsAddEventListenerMod {
  ...
  type EventHandler[K /* <: /* keyof std.HTMLElementEventMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 100, starting with typingsJapgolly.domHelpers.domHelpersStrings.fullscreenchange, typingsJapgolly.domHelpers.domHelpersStrings.fullscreenerror, typingsJapgolly.domHelpers.domHelpersStrings.copy */ Any */] = js.ThisFunction1[
    /* this */ HTMLElement, 
  ...
  @js.native
  trait TaggedEventHandler[K /* <: /* keyof std.HTMLElementEventMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 100, starting with typingsJapgolly.domHelpers.domHelpersStrings.fullscreenchange, typingsJapgolly.domHelpers.domHelpersStrings.fullscreenerror, typingsJapgolly.domHelpers.domHelpersStrings.copy */ Any */] extends EventHandler[K] {
