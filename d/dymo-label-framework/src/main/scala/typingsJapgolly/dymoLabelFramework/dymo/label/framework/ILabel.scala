...
object ILabel {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(getAddressBarcodePosition = js.Any.fromFunction1(getAddressBarcodePosition), getAddressObjectCount = getAddressObjectCount.toJsFn, getAddressText = js.Any.fromFunction1(getAddressText), getLabelXml = getLabelXml.toJsFn, getObjectNames = getObjectNames.toJsFn, getObjectText = js.Any.fromFunction1(getObjectText), print = js.Any.fromFunction3((t0: String, t1: String, t2: String) => (print(t0, t1, t2)).runNow()), printAndPollStatus = js.Any.fromFunction5(printAndPollStatus), render = js.Any.fromFunction2(render), setAddressBarcodePosition = js.Any.fromFunction2(setAddressBarcodePosition), setAddressText = js.Any.fromFunction2(setAddressText), setObjectText = js.Any.fromFunction2(setObjectText))
  ...
  extension [Self <: ILabel](x: Self) {
    ...
    inline def setGetAddressObjectCount(value: CallbackTo[Double]): Self = StObject.set(x, "getAddressObjectCount", value.toJsFn)
    
    inline def setGetAddressText(value: Double => String): Self = StObject.set(x, "getAddressText", js.Any.fromFunction1(value))
    
    inline def setGetLabelXml(value: CallbackTo[String]): Self = StObject.set(x, "getLabelXml", value.toJsFn)
    
    inline def setGetObjectNames(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "getObjectNames", value.toJsFn)
    
    inline def setGetObjectText(value: String => String): Self = StObject.set(x, "getObjectText", js.Any.fromFunction1(value))
    
    inline def setPrint(value: (String, String, String) => Callback): Self = StObject.set(x, "print", js.Any.fromFunction3((t0: String, t1: String, t2: String) => (value(t0, t1, t2)).runNow()))
