...
object Options {
  ...
  def apply(
    ...
    exclude: /* instance */ PackageInstanceProperties => CallbackTo[Boolean] = null,
    ...
    if (exclude != null) __obj.updateDynamic("exclude")(js.Any.fromFunction1((t0: /* instance */ typingsJapgolly.duplicatePackageCheckerWebpackPlugin.mod.PackageInstanceProperties) => exclude(t0).runNow()))
