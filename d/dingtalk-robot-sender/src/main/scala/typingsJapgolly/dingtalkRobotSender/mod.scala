...
import typingsJapgolly.dingtalkRobotSender.anon.AtMobiles
import typingsJapgolly.dingtalkRobotSender.anon.BtnOrientation
import typingsJapgolly.dingtalkRobotSender.anon.Content
import typingsJapgolly.dingtalkRobotSender.anon.IsAtAll
import typingsJapgolly.dingtalkRobotSender.anon.MessageURL_
import typingsJapgolly.dingtalkRobotSender.anon.MessageUrl
...
object mod {
  ...
  */
  ...
  object MessageType {
    ...
    inline def ActionCard(actionCard: BtnOrientation): typingsJapgolly.dingtalkRobotSender.mod.Message.ActionCard = {
      val __obj = js.Dynamic.literal(actionCard = actionCard.asInstanceOf[js.Any], msgtype = "actionCard")
      __obj.asInstanceOf[typingsJapgolly.dingtalkRobotSender.mod.Message.ActionCard]
    }
    
    inline def FeedCardItem(feedCard: MessageURL_): typingsJapgolly.dingtalkRobotSender.mod.Message.FeedCardItem = {
      val __obj = js.Dynamic.literal(feedCard = feedCard.asInstanceOf[js.Any], msgtype = "feedCard")
      __obj.asInstanceOf[typingsJapgolly.dingtalkRobotSender.mod.Message.FeedCardItem]
    }
    
    inline def Link(link: MessageUrl): typingsJapgolly.dingtalkRobotSender.mod.Message.Link = {
      val __obj = js.Dynamic.literal(link = link.asInstanceOf[js.Any], msgtype = "link")
      __obj.asInstanceOf[typingsJapgolly.dingtalkRobotSender.mod.Message.Link]
    }
    
    inline def Markdown(markdown: IsAtAll): typingsJapgolly.dingtalkRobotSender.mod.Message.Markdown = {
      val __obj = js.Dynamic.literal(markdown = markdown.asInstanceOf[js.Any], msgtype = "markdown")
      __obj.asInstanceOf[typingsJapgolly.dingtalkRobotSender.mod.Message.Markdown]
    }
    
    inline def Text(text: Content): typingsJapgolly.dingtalkRobotSender.mod.Message.Text = {
      val __obj = js.Dynamic.literal(msgtype = "text", text = text.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.dingtalkRobotSender.mod.Message.Text]
    }
  }
