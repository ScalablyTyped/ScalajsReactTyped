...
import typingsJapgolly.dojo.dojoStrings.centerIndicator
import typingsJapgolly.dojo.dojoStrings.color
import typingsJapgolly.dojo.dojoStrings.duration
import typingsJapgolly.dojo.dojoStrings.image
import typingsJapgolly.dojo.dojoStrings.imageText
import typingsJapgolly.dojo.dojoStrings.opacity
...
import typingsJapgolly.dojo.dojoStrings.text
import typingsJapgolly.dojo.dojoStrings.zIndex
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget.Standby")
@js.native
