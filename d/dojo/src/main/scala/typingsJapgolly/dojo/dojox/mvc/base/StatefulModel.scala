...
import typingsJapgolly.dojo.dojo.store.DataStore
import typingsJapgolly.dojo.dojoStrings.data
...
import typingsJapgolly.dojo.dojoStrings.valid
...
/**
  ...
  */
@JSGlobal("dojox.mvc._base.StatefulModel")
@js.native
