...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.calendar.MobileVerticalRenderer")
@js.native
class MobileVerticalRenderer () extends WidgetBase {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_MobileVerticalRenderer: String = js.native
  /**
