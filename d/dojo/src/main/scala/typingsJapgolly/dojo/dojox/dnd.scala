...
object dnd extends js.Object {
  ...
  class Selector protected ()
    extends typingsJapgolly.dojo.dojo.dnd.Selector {
    ...
    /**
      ...
      * @param node Node to deselect (id or DOM Node)
      */
    def deselectNode(node: typingsJapgolly.std.HTMLElement): js.Function = js.native
    /**
    ...
    /**
      ...
      * @param node Node to check (id or DOM Node)
      */
    def isSelected(node: typingsJapgolly.std.HTMLElement): js.Any = js.native
    /**
    ...
    /**
      ...
      * @param add               OptionalIf true, node is added to selection, otherwise currentselection is removed, and node will be the only selection.
      */
    def selectNode(node: typingsJapgolly.std.HTMLElement, add: Boolean): js.Function = js.native
    /**
