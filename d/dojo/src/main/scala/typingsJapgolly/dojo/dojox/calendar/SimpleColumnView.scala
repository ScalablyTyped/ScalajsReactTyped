...
import typingsJapgolly.dojo.dojoStrings.columnHeaderDatePattern
import typingsJapgolly.dojo.dojoStrings.horizontalGap
import typingsJapgolly.dojo.dojoStrings.hourSize
import typingsJapgolly.dojo.dojoStrings.maxHours
import typingsJapgolly.dojo.dojoStrings.minColumnWidth
import typingsJapgolly.dojo.dojoStrings.minHours
import typingsJapgolly.dojo.dojoStrings.percentOverlap
import typingsJapgolly.dojo.dojoStrings.renderData
import typingsJapgolly.dojo.dojoStrings.rowHeaderFirstLabelOffset
import typingsJapgolly.dojo.dojoStrings.rowHeaderGridSlotDuration
import typingsJapgolly.dojo.dojoStrings.rowHeaderLabelOffset
import typingsJapgolly.dojo.dojoStrings.rowHeaderLabelSlotDuration
import typingsJapgolly.dojo.dojoStrings.rowHeaderTimePattern
import typingsJapgolly.dojo.dojoStrings.scrollBarRTLPosition
import typingsJapgolly.dojo.dojoStrings.searchContainerNode
import typingsJapgolly.dojo.dojoStrings.showTimeIndicator
import typingsJapgolly.dojo.dojoStrings.startDate
import typingsJapgolly.dojo.dojoStrings.startTimeOfDay
import typingsJapgolly.dojo.dojoStrings.styleGridCellFunc
import typingsJapgolly.dojo.dojoStrings.subColumns
import typingsJapgolly.dojo.dojoStrings.templatePath
import typingsJapgolly.dojo.dojoStrings.templateString
import typingsJapgolly.dojo.dojoStrings.timeIndicatorRefreshInterval
import typingsJapgolly.dojo.dojoStrings.timeSlotDuration
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.calendar.SimpleColumnView")
@js.native
class SimpleColumnView () extends ViewBase {
  ...
  /**
    ...
    */
  def defaultStyleGridCell(node: HTMLElement, date: js.Date, hours: Double, minutes: Double, renderData: js.Object): js.Any = js.native
  /**
  ...
  /**
    ...
    * @param renderData The render data object.
    */
  def styleGridCell(node: HTMLElement, date: js.Date, hours: js.Any, minutes: js.Any, renderData: js.Object): Unit = js.native
  /**
