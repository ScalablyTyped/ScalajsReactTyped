...
package object mvc {
  type Bind = typingsJapgolly.dojo.dojox.mvc.Bind_
  /**
  ...
  type StatefulModel = typingsJapgolly.dojo.dojox.mvc.StatefulModel_
  type at = typingsJapgolly.dojo.dojox.mvc.at_
  /**
    ...
    * @param w The widget.
    */
  type atBindingExtension = js.Function1[/* w */ js.Array[typingsJapgolly.dojo.dijit.WidgetBase], scala.Unit]
  type atBindingMixin = typingsJapgolly.dojo.dojox.mvc.atBindingMixin_
  type base = typingsJapgolly.dojo.dojox.mvc.base_
  /**
  ...
  type sync = js.Function5[
    /* source */ typingsJapgolly.dojo.dojo.Stateful, 
    /* sourceProp */ java.lang.String, 
    /* target */ typingsJapgolly.dojo.dojo.Stateful, 
