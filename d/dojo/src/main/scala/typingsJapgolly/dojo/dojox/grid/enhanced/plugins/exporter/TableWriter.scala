package typingsJapgolly.dojo.dojox.grid.enhanced.plugins.exporter
...
/**
  ...
  */
@JSGlobal("dojox.grid.enhanced.plugins.exporter.TableWriter")
@js.native
class TableWriter () extends ExportWriter {
