...
import typingsJapgolly.dojo.dojoStrings.emptyLabel
...
import typingsJapgolly.dojo.dojoStrings.message
import typingsJapgolly.dojo.dojoStrings.multiCharSearchDuration
import typingsJapgolly.dojo.dojoStrings.required
import typingsJapgolly.dojo.dojoStrings.state
import typingsJapgolly.dojo.dojoStrings.tooltipPosition
...
- typingsJapgolly.dojo.dijit.KeyNavMixin because Inheritance from two classes. Inlined childSelector, focusedChild, multiCharSearchDuration, focus, focusChild, focusFirstChild, focusLastChild, onKeyboardSearch
- typingsJapgolly.dojo.dijit.HasDropDown because Inheritance from two classes. Inlined autoWidth, dropDown, dropDownPosition, forceWidth, maxHeight, buildRendering, closeDropDown, destroy, isLoaded, loadAndOpenDropDown, loadDropDown, openDropDown, postCreate, toggleDropDown */ @JSGlobal("dojox.form.DropDownSelect")
@js.native
class DropDownSelect_ ()
  extends typingsJapgolly.dojo.dijit.form.FormSelectWidget {
  ...
  /**
    ...
    * @param node
    */
  def childSelector(node: typingsJapgolly.std.HTMLElement): js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def focusChild(widget: WidgetBase): Unit = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("isValid")
  def isValid_MDropDownSelect_(isFocused: Boolean): Boolean = js.native
  /**
