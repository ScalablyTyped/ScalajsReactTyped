...
import typingsJapgolly.dojo.dojoStrings.errMsg
import typingsJapgolly.dojo.dojoStrings.flashFieldName
import typingsJapgolly.dojo.dojoStrings.focusedClass
...
import typingsJapgolly.dojo.dojoStrings.preventCache
import typingsJapgolly.dojo.dojoStrings.scrollOnFocus
import typingsJapgolly.dojo.dojoStrings.serverTimeout
import typingsJapgolly.dojo.dojoStrings.showInput
import typingsJapgolly.dojo.dojoStrings.showLabel
...
import typingsJapgolly.dojo.dojoStrings.uploadOnSelect
import typingsJapgolly.dojo.dojoStrings.uploadType
import typingsJapgolly.dojo.dojoStrings.url
import typingsJapgolly.dojo.dojoStrings.value
import typingsJapgolly.dojo.dojox.form.uploader.Base
...
- typingsJapgolly.dojo.dijit.AttachMixin because Already inherited
- typingsJapgolly.dojo.dijit.FocusMixin because Already inherited
- typingsJapgolly.dojo.dijit.OnDijitClickMixin because Already inherited
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Already inherited
- typingsJapgolly.dojo.dijit.Widget because Already inherited
- typingsJapgolly.dojo.dijit.form.ButtonMixin because Inheritance from two classes. Inlined 
- typingsJapgolly.dojo.dijit.form.FormWidget because Inheritance from two classes. Inlined create
- typingsJapgolly.dojo.dojox.form.uploader.Flash because Inheritance from two classes. Inlined deferredUploading, devMode, isDebug, preventCache, serverTimeout, skipServerCheck, swfPath, flashReset, getFlashFileList, onFileChange, onFileProgress, onLoad, onReady
- typingsJapgolly.dojo.dojox.form.uploader.IFrame because Inheritance from two classes. Inlined uploadIFrame
- typingsJapgolly.dojo.dojox.form.uploader._HTML5 because Inheritance from two classes. Inlined errMsg, uploadType, addDropTarget, createXhr, upload
