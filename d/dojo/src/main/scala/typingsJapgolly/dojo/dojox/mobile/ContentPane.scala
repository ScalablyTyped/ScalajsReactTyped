...
import typingsJapgolly.dojo.dojoStrings.`lazy`
import typingsJapgolly.dojo.dojoStrings.content
import typingsJapgolly.dojo.dojoStrings.executeScripts
import typingsJapgolly.dojo.dojoStrings.href
import typingsJapgolly.dojo.dojoStrings.parseOnLoad
import typingsJapgolly.dojo.dojoStrings.prog
...
- typingsJapgolly.dojo.dojox.mobile.ExecScriptMixin because Inheritance from two classes. Inlined 
- typingsJapgolly.dojo.dojox.mobile.ContentPaneMixin because Inheritance from two classes. Inlined content, executeScripts, href, `lazy`, parseOnLoad, prog, errorHandler, execScript, load, loadHandler, onLoad */ @JSGlobal("dojox.mobile.ContentPane")
@js.native
