...
import typingsJapgolly.dojo.dojoStrings.baseLayerType
import typingsJapgolly.dojo.dojoStrings.initialLocation
import typingsJapgolly.dojo.dojoStrings.map
import typingsJapgolly.dojo.dojoStrings.style
import typingsJapgolly.dojo.dojoStrings.touchHandler
