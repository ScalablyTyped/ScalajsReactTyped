...
import typingsJapgolly.dojo.dojoStrings.arrow
import typingsJapgolly.dojo.dojoStrings.defaultColor
import typingsJapgolly.dojo.dojoStrings.light
import typingsJapgolly.dojo.dojoStrings.selColor
