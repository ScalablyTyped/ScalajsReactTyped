...
import typingsJapgolly.dojo.dojoStrings.ChildSwapViewProperties
import typingsJapgolly.dojo.dojoStrings.height
import typingsJapgolly.dojo.dojoStrings.itemWidth
import typingsJapgolly.dojo.dojoStrings.navButton
import typingsJapgolly.dojo.dojoStrings.numVisible
import typingsJapgolly.dojo.dojoStrings.pageIndicator
...
- typingsJapgolly.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.mobile.Carousel")
@js.native
