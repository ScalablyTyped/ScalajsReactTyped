package typingsJapgolly.dojo.dojox.app.widgets
...
import typingsJapgolly.dojo.dojoStrings.scrollable
...
- typingsJapgolly.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.app.widgets.Container")
@js.native
