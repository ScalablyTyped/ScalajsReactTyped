package typingsJapgolly.dojo.dojox.image
...
import typingsJapgolly.dojo.dojoStrings.cellMargin
import typingsJapgolly.dojo.dojoStrings.cellSize
import typingsJapgolly.dojo.dojoStrings.children
import typingsJapgolly.dojo.dojoStrings.cols
import typingsJapgolly.dojo.dojoStrings.delay
import typingsJapgolly.dojo.dojoStrings.easing
import typingsJapgolly.dojo.dojoStrings.rows
...
import typingsJapgolly.dojo.dojoStrings.threads
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.image.Badge")
@js.native
