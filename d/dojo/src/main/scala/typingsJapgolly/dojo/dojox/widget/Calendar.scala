...
- typingsJapgolly.dojo.dojox.widget.CalendarMonthYear because Inheritance from two classes. Inlined 
- typingsJapgolly.dojo.dojox.widget.CalendarDay because Inheritance from two classes. Inlined parent */ @JSGlobal("dojox.widget.Calendar")
@js.native
