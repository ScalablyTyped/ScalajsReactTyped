package typingsJapgolly.dojo.dojox.gfx.vmlAttach
...
class Surface () extends js.Object {
  ...
  /**
    ...
    * @param surface
    */
  def onLoad(surface: typingsJapgolly.dojo.dojox.gfx.shape.Surface): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def remove(shape: typingsJapgolly.dojo.dojox.gfx.shape.Shape, silently: Boolean): js.Function = js.native
  /**
