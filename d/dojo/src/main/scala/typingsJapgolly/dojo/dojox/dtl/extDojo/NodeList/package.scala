package typingsJapgolly.dojo.dojox.dtl.extDojo
...
package object NodeList {
  /**
    ...
    * @param args
    */
  type addClassFx = js.Function2[/* cssClass */ js.Any, /* args */ js.Any, typingsJapgolly.dojo.AnonType]
  /**
  ...
  /**
    ...
    * @param args
    */
  type removeClassFx = js.Function2[/* cssClass */ js.Any, /* args */ js.Any, typingsJapgolly.dojo.AnonType]
  /**
