...
import typingsJapgolly.dojo.dojoStrings.buttonCancel
import typingsJapgolly.dojo.dojoStrings.noRemindButton
import typingsJapgolly.dojo.dojoStrings.notifications
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget.UpgradeBar")
@js.native
class UpgradeBar protected () extends WidgetBase {
