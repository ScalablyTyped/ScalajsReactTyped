...
- typingsJapgolly.dojo.dojox.app.ViewBase because Inheritance from two classes. Inlined afterActivate, afterDeactivate, beforeActivate, beforeDeactivate, init, load, start
- typingsJapgolly.dojo.dijit.Destroyable because Inheritance from two classes. Inlined destroy, destroy, own
- typingsJapgolly.dojo.dijit.WidgetsInTemplateMixin because Inheritance from two classes. Inlined contextRequire, widgetsInTemplate, startup */ @JSGlobal("dojox.app.View")
@js.native
