...
import typingsJapgolly.dojo.dojoStrings.editableMixinClass
import typingsJapgolly.dojo.dojoStrings.filterBoxClass
import typingsJapgolly.dojo.dojoStrings.iconBase
import typingsJapgolly.dojo.dojoStrings.iconPos
import typingsJapgolly.dojo.dojoStrings.select
import typingsJapgolly.dojo.dojoStrings.stateful
import typingsJapgolly.dojo.dojoStrings.style
import typingsJapgolly.dojo.dojoStrings.syncWithViews
...
- typingsJapgolly.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.mobile.RoundRectList")
@js.native
