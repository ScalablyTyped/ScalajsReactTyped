...
import typingsJapgolly.dojo.dojoStrings.`data-mvc-bindings`
import typingsJapgolly.dojo.dojoStrings.dataBindAttr
...
- typingsJapgolly.dojo.dojox.mvc.atBindingMixin because Inheritance from two classes. Inlined `data-mvc-bindings`, dataBindAttr, mixin */ @JSGlobal("dojox.mvc._base._Controller")
@js.native
