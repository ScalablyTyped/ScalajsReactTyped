package typingsJapgolly.dojo.dojox.editor.plugins.StatusBar
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.editor.plugins.StatusBar._StatusBar")
@js.native
class StatusBar () extends Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_StatusBar: String = js.native
  /**
