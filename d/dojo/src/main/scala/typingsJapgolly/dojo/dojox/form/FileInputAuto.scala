...
import typingsJapgolly.dojo.dojoStrings.blurDelay
import typingsJapgolly.dojo.dojoStrings.duration
import typingsJapgolly.dojo.dojoStrings.triggerEvent
import typingsJapgolly.dojo.dojoStrings.uploadMessage
