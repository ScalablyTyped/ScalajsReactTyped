...
package object mobile {
  type Accordion = typingsJapgolly.dojo.dojox.mobile.Accordion_
  type Carousel = typingsJapgolly.dojo.dojox.mobile.Carousel_
  /**
  ...
  type ListItem = typingsJapgolly.dojo.dojox.mobile.ListItem_
  /**
  ...
  type i18n = typingsJapgolly.dojo.dojox.mobile.i18n_
  /**
  ...
  type viewRegistry = typingsJapgolly.dojo.dojox.mobile.viewRegistry_
}
