...
import typingsJapgolly.dojo.dojoStrings.closeButtonClass
import typingsJapgolly.dojo.dojoStrings.left
import typingsJapgolly.dojo.dojoStrings.modal
import typingsJapgolly.dojo.dojoStrings.tabIndex
import typingsJapgolly.dojo.dojoStrings.top
