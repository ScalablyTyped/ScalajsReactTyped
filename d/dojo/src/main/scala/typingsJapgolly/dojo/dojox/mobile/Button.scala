...
- typingsJapgolly.dojo.dijit.form.ButtonMixin because Inheritance from two classes. Inlined label, postCreate, onClick
- typingsJapgolly.dojo.dijit.form.FormWidgetMixin because Inheritance from two classes. Inlined alt, `aria-label`, disabled, intermediateChanges, name, scrollOnFocus, tabIndex, `type`, value, compare, create, destroy, focus, isFocusable, onChange */ @JSGlobal("dojox.mobile.Button")
@js.native
