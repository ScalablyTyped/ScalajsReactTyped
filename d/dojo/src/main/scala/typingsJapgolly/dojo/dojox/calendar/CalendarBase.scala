...
import typingsJapgolly.dojo.dojoStrings.allDayAttr
import typingsJapgolly.dojo.dojoStrings.animateRange
import typingsJapgolly.dojo.dojoStrings.animationRangeDuration
import typingsJapgolly.dojo.dojoStrings.attachScope
import typingsJapgolly.dojo.dojoStrings.columnView
import typingsJapgolly.dojo.dojoStrings.columnViewProps
import typingsJapgolly.dojo.dojoStrings.contextRequire
import typingsJapgolly.dojo.dojoStrings.createItemFunc
import typingsJapgolly.dojo.dojoStrings.createOnGridClick
import typingsJapgolly.dojo.dojoStrings.cssClassFunc
import typingsJapgolly.dojo.dojoStrings.currentView
import typingsJapgolly.dojo.dojoStrings.date
import typingsJapgolly.dojo.dojoStrings.dateInterval
import typingsJapgolly.dojo.dojoStrings.dateIntervalSteps
import typingsJapgolly.dojo.dojoStrings.datePackage
import typingsJapgolly.dojo.dojoStrings.decodeDate
import typingsJapgolly.dojo.dojoStrings.displayedItemsInvalidated
import typingsJapgolly.dojo.dojoStrings.editable
import typingsJapgolly.dojo.dojoStrings.encodeDate
import typingsJapgolly.dojo.dojoStrings.endDate
import typingsJapgolly.dojo.dojoStrings.endTimeAttr
import typingsJapgolly.dojo.dojoStrings.firstDayOfWeek
import typingsJapgolly.dojo.dojoStrings.formatItemTimeFunc
import typingsJapgolly.dojo.dojoStrings.hoveredItem
import typingsJapgolly.dojo.dojoStrings.invalidRendering
import typingsJapgolly.dojo.dojoStrings.invalidatingProperties
import typingsJapgolly.dojo.dojoStrings.matrixView
import typingsJapgolly.dojo.dojoStrings.matrixViewProps
import typingsJapgolly.dojo.dojoStrings.maxDate
import typingsJapgolly.dojo.dojoStrings.minDate
...
import typingsJapgolly.dojo.dojoStrings.startTimeAttr
import typingsJapgolly.dojo.dojoStrings.store
import typingsJapgolly.dojo.dojoStrings.style
import typingsJapgolly.dojo.dojoStrings.subColumnAttr
import typingsJapgolly.dojo.dojoStrings.summaryAttr
import typingsJapgolly.dojo.dojoStrings.templatePath
import typingsJapgolly.dojo.dojoStrings.templateString
import typingsJapgolly.dojo.dojoStrings.viewChangeDuration
import typingsJapgolly.dojo.dojoStrings.viewContainer
import typingsJapgolly.dojo.dojoStrings.views
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.calendar.CalendarBase")
@js.native
class CalendarBase protected () extends WidgetBase {
  ...
  @JSName("get")
  def get_endDate(property: endDate): js.Date = js.native
  @JSName("get")
  ...
  @JSName("get")
  def get_maxDate(property: maxDate): js.Date = js.native
  @JSName("get")
  def get_minDate(property: minDate): js.Date = js.native
  @JSName("get")
  ...
  @JSName("set")
  def set_endDate(property: endDate, value: js.Date): Unit = js.native
  @JSName("set")
  ...
  @JSName("set")
  def set_maxDate(property: maxDate, value: js.Date): Unit = js.native
  @JSName("set")
  def set_minDate(property: minDate, value: js.Date): Unit = js.native
  @JSName("set")
