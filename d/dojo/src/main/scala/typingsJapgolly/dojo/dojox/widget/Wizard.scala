...
import typingsJapgolly.dojo.dojoStrings.cancelButtonLabel
import typingsJapgolly.dojo.dojoStrings.cancelFunction
import typingsJapgolly.dojo.dojoStrings.contextRequire
import typingsJapgolly.dojo.dojoStrings.doneButtonLabel
import typingsJapgolly.dojo.dojoStrings.hideDisabled
import typingsJapgolly.dojo.dojoStrings.nextButtonLabel
import typingsJapgolly.dojo.dojoStrings.previousButtonLabel
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget.Wizard")
@js.native
