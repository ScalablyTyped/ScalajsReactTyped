...
import typingsJapgolly.dojo.dojoStrings.defaultWidth
import typingsJapgolly.dojo.dojoStrings.firstScroll
import typingsJapgolly.dojo.dojoStrings.lastTop
import typingsJapgolly.dojo.dojoStrings.marginBottom
import typingsJapgolly.dojo.dojoStrings.rowPad
...
import typingsJapgolly.dojo.dojoStrings.viewWidth
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.grid._View")
@js.native
