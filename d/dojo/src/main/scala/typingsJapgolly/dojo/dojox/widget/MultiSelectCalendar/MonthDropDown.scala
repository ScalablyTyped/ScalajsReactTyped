package typingsJapgolly.dojo.dojox.widget.MultiSelectCalendar
...
import typingsJapgolly.dojo.dojoStrings.months
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget.MultiSelectCalendar._MonthDropDown")
@js.native
