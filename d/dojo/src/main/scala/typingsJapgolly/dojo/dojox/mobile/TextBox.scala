...
import typingsJapgolly.dojo.dojoStrings.`aria-label`
...
import typingsJapgolly.dojo.dojoStrings.intermediateChanges
...
import typingsJapgolly.dojo.dojoStrings.scrollOnFocus
...
- typingsJapgolly.dojo.dijit.form.FormWidgetMixin because Inheritance from two classes. Inlined 
- typingsJapgolly.dojo.dijit.form.TextBoxMixin because Inheritance from two classes. Inlined displayedValue, lowercase, maxLength, placeHolder, propercase, selectOnClick, trim, uppercase, filter, format, parse, selectInputText, onInput
- typingsJapgolly.dojo.dijit.form.FormValueMixin because Inheritance from two classes. Inlined alt, `aria-label`, disabled, intermediateChanges, name, readOnly, scrollOnFocus, tabIndex, `type`, value, compare, create, destroy, focus, isFocusable, postCreate, reset, undo, onChange */ @JSGlobal("dojox.mobile.TextBox")
@js.native
