...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.form.uploader._Base")
@js.native
class Base () extends Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_Base: String = js.native
  /**
