...
import typingsJapgolly.dojo.dojoStrings.displayedYears
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget._CalendarYearView")
@js.native
class CalendarYearView () extends CalendarView {
