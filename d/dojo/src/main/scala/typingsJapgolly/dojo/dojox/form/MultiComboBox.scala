...
import typingsJapgolly.dojo.dijit.form.ValidationTextBox
import typingsJapgolly.dojo.dojoStrings.autoComplete
import typingsJapgolly.dojo.dojoStrings.autoWidth
import typingsJapgolly.dojo.dojoStrings.delimiter
import typingsJapgolly.dojo.dojoStrings.dropDown
import typingsJapgolly.dojo.dojoStrings.dropDownPosition
import typingsJapgolly.dojo.dojoStrings.fetchProperties
import typingsJapgolly.dojo.dojoStrings.forceWidth
import typingsJapgolly.dojo.dojoStrings.hasDownArrow
import typingsJapgolly.dojo.dojoStrings.highlightMatch
import typingsJapgolly.dojo.dojoStrings.ignoreCase
import typingsJapgolly.dojo.dojoStrings.item
import typingsJapgolly.dojo.dojoStrings.labelAttr
import typingsJapgolly.dojo.dojoStrings.labelType
import typingsJapgolly.dojo.dojoStrings.maxHeight
import typingsJapgolly.dojo.dojoStrings.pageSize
import typingsJapgolly.dojo.dojoStrings.query
import typingsJapgolly.dojo.dojoStrings.queryExpr
import typingsJapgolly.dojo.dojoStrings.searchAttr
import typingsJapgolly.dojo.dojoStrings.searchDelay
...
- typingsJapgolly.dojo.dijit.form.SearchMixin because Inheritance from two classes. Inlined 
- typingsJapgolly.dojo.dijit.FocusMixin because Already inherited
- typingsJapgolly.dojo.dijit.form.AutoCompleterMixin because Inheritance from two classes. Inlined 
- typingsJapgolly.dojo.dijit.HasDropDown because Inheritance from two classes. Inlined 
...
class MultiComboBox () extends ValidationTextBox {
  ...
  /**
    ...
    */
  @JSName("value")
  var value_MultiComboBox: String = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("isValid")
  def isValid_MMultiComboBox(isFocused: Boolean): js.Any = js.native
  /**
