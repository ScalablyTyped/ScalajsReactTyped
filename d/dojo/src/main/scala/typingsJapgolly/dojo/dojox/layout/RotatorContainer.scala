...
import typingsJapgolly.dojo.dijit.layout.StackContainer
import typingsJapgolly.dojo.dojoStrings.attachScope
import typingsJapgolly.dojo.dojoStrings.autoStart
import typingsJapgolly.dojo.dojoStrings.contextRequire
import typingsJapgolly.dojo.dojoStrings.cycles
import typingsJapgolly.dojo.dojoStrings.pagerClass
import typingsJapgolly.dojo.dojoStrings.pagerId
import typingsJapgolly.dojo.dojoStrings.pauseOnManualChange
import typingsJapgolly.dojo.dojoStrings.reverse
import typingsJapgolly.dojo.dojoStrings.searchContainerNode
import typingsJapgolly.dojo.dojoStrings.showTabs
import typingsJapgolly.dojo.dojoStrings.suspendOnHover
import typingsJapgolly.dojo.dojoStrings.templatePath
import typingsJapgolly.dojo.dojoStrings.templateString
import typingsJapgolly.dojo.dojoStrings.transition
import typingsJapgolly.dojo.dojoStrings.transitionDelay
import typingsJapgolly.dojo.dojoStrings.transitionDuration
...
- typingsJapgolly.dojo.dijit.Templated because Inheritance from two classes. Inlined attachScope, contextRequire, searchContainerNode, templatePath, templateString, widgetsInTemplate, buildRendering, destroyRendering, startup, getCachedTemplate */ @JSGlobal("dojox.layout.RotatorContainer")
@js.native
