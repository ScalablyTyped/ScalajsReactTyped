package typingsJapgolly.dojo.dojox.form.uploader

import org.scalajs.dom.raw.HTMLElement
import typingsJapgolly.dojo.AnonUnwatch
import typingsJapgolly.dojo.dojoStrings.headerFilename
import typingsJapgolly.dojo.dojoStrings.headerFilesize
import typingsJapgolly.dojo.dojoStrings.headerIndex
import typingsJapgolly.dojo.dojoStrings.headerType
import typingsJapgolly.dojo.dojoStrings.rowAmt
import typingsJapgolly.dojo.dojoStrings.uploaderId
...
class FileList () extends Base {
  ...
  @JSName("get")
  def get_uploader(property: typingsJapgolly.dojo.dojoStrings.uploader): js.Object = js.native
  @JSName("get")
  ...
  @JSName("set")
  def set_uploader(property: typingsJapgolly.dojo.dojoStrings.uploader, value: js.Object): Unit = js.native
  @JSName("set")
  ...
  @JSName("watch")
  def watch_uploader(
    property: typingsJapgolly.dojo.dojoStrings.uploader,
    callback: js.Function3[
      /* property */ js.UndefOr[String], 
