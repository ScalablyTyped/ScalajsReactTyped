...
import typingsJapgolly.dojo.dojoStrings.iconNext
import typingsJapgolly.dojo.dojoStrings.iconPage
import typingsJapgolly.dojo.dojoStrings.iconPageActive
import typingsJapgolly.dojo.dojoStrings.iconPrevious
import typingsJapgolly.dojo.dojoStrings.itemSpace
import typingsJapgolly.dojo.dojoStrings.itemsPage
import typingsJapgolly.dojo.dojoStrings.orientation
import typingsJapgolly.dojo.dojoStrings.pagerPos
import typingsJapgolly.dojo.dojoStrings.resizeChildren
import typingsJapgolly.dojo.dojoStrings.searchContainerNode
import typingsJapgolly.dojo.dojoStrings.statusPos
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget.Pager")
@js.native
