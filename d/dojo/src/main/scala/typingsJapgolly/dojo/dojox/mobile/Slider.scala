...
import typingsJapgolly.dojo.dojoStrings.flip
import typingsJapgolly.dojo.dojoStrings.halo
import typingsJapgolly.dojo.dojoStrings.intermediateChanges
import typingsJapgolly.dojo.dojoStrings.max
import typingsJapgolly.dojo.dojoStrings.min
...
import typingsJapgolly.dojo.dojoStrings.step
...
- typingsJapgolly.dojo.dijit.form.FormValueMixin because Inheritance from two classes. Inlined alt, `aria-label`, disabled, intermediateChanges, name, readOnly, scrollOnFocus, tabIndex, `type`, value, compare, create, destroy, focus, isFocusable, postCreate, reset, undo, onChange */ @JSGlobal("dojox.mobile.Slider")
@js.native
