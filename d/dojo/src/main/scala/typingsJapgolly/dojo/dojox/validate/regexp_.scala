...
object regexp_ {
  ...
  def apply(
    ca: js.Object,
    emailAddress: js.Object => CallbackTo[String],
    emailAddressList: js.Object => CallbackTo[String],
    host: js.Object => CallbackTo[String],
    ipAddress: js.Object => CallbackTo[String],
    numberFormat: js.Object => CallbackTo[js.Any],
    url: js.Object => CallbackTo[String],
    us: js.Object
  ): regexp_ = {
    val __obj = js.Dynamic.literal(ca = ca.asInstanceOf[js.Any], us = us.asInstanceOf[js.Any])
    __obj.updateDynamic("emailAddress")(js.Any.fromFunction1((t0: js.Object) => emailAddress(t0).runNow()))
    __obj.updateDynamic("emailAddressList")(js.Any.fromFunction1((t0: js.Object) => emailAddressList(t0).runNow()))
    __obj.updateDynamic("host")(js.Any.fromFunction1((t0: js.Object) => host(t0).runNow()))
    __obj.updateDynamic("ipAddress")(js.Any.fromFunction1((t0: js.Object) => ipAddress(t0).runNow()))
    __obj.updateDynamic("numberFormat")(js.Any.fromFunction1((t0: js.Object) => numberFormat(t0).runNow()))
    __obj.updateDynamic("url")(js.Any.fromFunction1((t0: js.Object) => url(t0).runNow()))
