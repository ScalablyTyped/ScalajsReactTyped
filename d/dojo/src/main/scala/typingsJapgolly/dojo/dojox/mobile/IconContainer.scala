...
import typingsJapgolly.dojo.dojoStrings.defaultIcon
...
import typingsJapgolly.dojo.dojoStrings.iconItemPaneClass
import typingsJapgolly.dojo.dojoStrings.iconItemPaneContainerClass
import typingsJapgolly.dojo.dojoStrings.iconItemPaneContainerProps
import typingsJapgolly.dojo.dojoStrings.iconItemPaneProps
import typingsJapgolly.dojo.dojoStrings.iconPos
import typingsJapgolly.dojo.dojoStrings.label
import typingsJapgolly.dojo.dojoStrings.pressedIconOpacity
import typingsJapgolly.dojo.dojoStrings.single
...
- typingsJapgolly.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.mobile.IconContainer")
@js.native
