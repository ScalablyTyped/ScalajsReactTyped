...
import typingsJapgolly.dojo.dojoStrings.slotClasses
import typingsJapgolly.dojo.dojoStrings.slotOrder
import typingsJapgolly.dojo.dojoStrings.slotProps
...
- typingsJapgolly.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.mobile._PickerBase")
@js.native
