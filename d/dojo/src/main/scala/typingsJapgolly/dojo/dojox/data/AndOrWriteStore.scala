...
import typingsJapgolly.dojo.dojo.data.ItemFileWriteStore
...
- typingsJapgolly.dojo.dojo.Evented because Already inherited
- typingsJapgolly.dojo.dojo.data.ItemFileReadStore because Already inherited
