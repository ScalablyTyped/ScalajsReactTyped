...
import typingsJapgolly.dojo.dojoStrings.columnIndex
import typingsJapgolly.dojo.dojoStrings.date
import typingsJapgolly.dojo.dojoStrings.down
import typingsJapgolly.dojo.dojoStrings.items
import typingsJapgolly.dojo.dojoStrings.owner
import typingsJapgolly.dojo.dojoStrings.rowIndex
...
import typingsJapgolly.dojo.dojoStrings.up
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.calendar.ExpandRenderer")
@js.native
class ExpandRenderer () extends WidgetBase {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_ExpandRenderer: String = js.native
  /**
  ...
  @JSName("get")
  def get_rowIndex(property: rowIndex): Double = js.native
  @JSName("get")
  ...
  @JSName("get")
  def get_up(property: up): Boolean = js.native
  /**
  ...
  @JSName("set")
  def set_rowIndex(property: rowIndex, value: Double): Unit = js.native
  @JSName("set")
  ...
  @JSName("set")
  def set_up(property: up, value: Boolean): Unit = js.native
  @JSName("watch")
