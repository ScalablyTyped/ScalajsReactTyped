...
object lighting {
  ...
  def apply(
    Model: Callback,
    add: (js.Any, js.Any) => CallbackTo[Object],
    addColor: (js.Any, js.Any) => CallbackTo[Object],
    black: CallbackTo[Object],
    ...
    multiplyColor: (js.Any, js.Any) => CallbackTo[Object],
    ...
    saturateColor: js.Any => CallbackTo[Object],
    scale: (js.Any, js.Any) => CallbackTo[Object],
    scaleColor: (js.Any, js.Any) => CallbackTo[Object],
    specular: (js.Any, js.Any, js.Any, js.Any) => CallbackTo[js.Any],
    toStdColor: js.Any => CallbackTo[Object],
    white: CallbackTo[Object]
  ): lighting = {
