...
import typingsJapgolly.dojo.dojoStrings.footerText
import typingsJapgolly.dojo.dojoStrings.headerText
...
- typingsJapgolly.dojo.dijit.Contained because Inheritance from two classes. Inlined getIndexInParent, getNextSibling, getPreviousSibling */ @JSGlobal("dojox.mobile.CarouselItem")
@js.native
