...
import typingsJapgolly.dojo.dojoStrings.animate
import typingsJapgolly.dojo.dojoStrings.node
import typingsJapgolly.dojo.dojoStrings.opacity
import typingsJapgolly.dojo.dojoStrings.shadowOffset
import typingsJapgolly.dojo.dojoStrings.shadowPng
import typingsJapgolly.dojo.dojoStrings.shadowThickness
...
class Shadow () extends Widget {
  ...
  @JSName("set")
  def set_style(property: typingsJapgolly.dojo.dojoStrings.style, value: String): Unit = js.native
  @JSName("watch")
  def watch_animate(
    property: animate,
