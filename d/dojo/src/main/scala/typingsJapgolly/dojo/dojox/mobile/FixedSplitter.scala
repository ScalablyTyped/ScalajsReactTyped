...
import typingsJapgolly.dojo.dojoStrings.screenSizeAware
import typingsJapgolly.dojo.dojoStrings.screenSizeAwareClass
import typingsJapgolly.dojo.dojoStrings.style
import typingsJapgolly.dojo.dojoStrings.variablePane
...
- typingsJapgolly.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.mobile.FixedSplitter")
@js.native
