...
import typingsJapgolly.dojo.dojoStrings.easeIn
import typingsJapgolly.dojo.dojoStrings.easeOut
import typingsJapgolly.dojo.dojoStrings.previewOnDblClick
import typingsJapgolly.dojo.dojoStrings.previewOpacity
import typingsJapgolly.dojo.dojoStrings.searchContainerNode
import typingsJapgolly.dojo.dojoStrings.startExpanded
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.layout.ExpandoPane")
@js.native
class ExpandoPane ()
