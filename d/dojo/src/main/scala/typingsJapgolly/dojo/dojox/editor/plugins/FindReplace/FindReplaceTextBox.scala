...
import typingsJapgolly.dojo.dojoStrings.textId
import typingsJapgolly.dojo.dojoStrings.toolTip
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.editor.plugins.FindReplace._FindReplaceTextBox")
@js.native
