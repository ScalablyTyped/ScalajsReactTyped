...
import typingsJapgolly.dojo.dojoStrings.areaAttr
import typingsJapgolly.dojo.dojoStrings.colorAttr
import typingsJapgolly.dojo.dojoStrings.colorModel
import typingsJapgolly.dojo.dojoStrings.groupAttrs
import typingsJapgolly.dojo.dojoStrings.groupFuncs
import typingsJapgolly.dojo.dojoStrings.invalidRendering
import typingsJapgolly.dojo.dojoStrings.invalidatingProperties
import typingsJapgolly.dojo.dojoStrings.itemToRenderer
import typingsJapgolly.dojo.dojoStrings.labelAttr
import typingsJapgolly.dojo.dojoStrings.labelThreshold
import typingsJapgolly.dojo.dojoStrings.query
import typingsJapgolly.dojo.dojoStrings.queryOptions
import typingsJapgolly.dojo.dojoStrings.rootItem
...
import typingsJapgolly.dojo.dojoStrings.tooltipAttr
...
- typingsJapgolly.dojo.dojox.widget.Invalidating because Inheritance from two classes. Inlined invalidatingProperties, set_invalidatingProperties, get_invalidatingProperties, watch_invalidatingProperties, invalidRendering, set_invalidRendering, get_invalidRendering, watch_invalidRendering, addInvalidatingProperties, get, invalidateRendering, postscript, refreshRendering, set, validateRendering, watch */ @JSGlobal("dojox.treemap.TreeMap")
@js.native
class TreeMap () extends WidgetBase {
  /**
