...
import typingsJapgolly.dojo.dojox.date.islamic.Date
...
object islamic {
  ...
  def apply(
    ...
    __obj.updateDynamic("add")(js.Any.fromFunction3((t0: typingsJapgolly.dojo.dojox.date.islamic.Date, t1: java.lang.String, t2: scala.Double) => add(t0, t1, t2).runNow()))
    __obj.updateDynamic("compare")(js.Any.fromFunction3((t0: typingsJapgolly.dojo.dojox.date.islamic.Date, t1: typingsJapgolly.dojo.dojox.date.islamic.Date, t2: java.lang.String) => compare(t0, t1, t2).runNow()))
    __obj.updateDynamic("difference")(js.Any.fromFunction3((t0: typingsJapgolly.dojo.dojox.date.islamic.Date, t1: typingsJapgolly.dojo.dojox.date.islamic.Date, t2: java.lang.String) => difference(t0, t1, t2).runNow()))
    __obj.updateDynamic("getDaysInMonth")(js.Any.fromFunction1((t0: typingsJapgolly.dojo.dojox.date.islamic.Date) => getDaysInMonth(t0).runNow()))
