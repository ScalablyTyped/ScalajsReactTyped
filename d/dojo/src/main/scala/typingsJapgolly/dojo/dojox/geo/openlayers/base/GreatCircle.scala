...
trait GreatCircle extends js.Object {
  ...
  def toGeometryFeature(
    p1: typingsJapgolly.dojo.dojox.geo.openlayers.Point,
    p2: typingsJapgolly.dojo.dojox.geo.openlayers.Point,
    increment: Double
  ): js.Any
  /**
...
object GreatCircle {
  ...
  def apply(
    ...
    RAD2DEG: Double,
    TOLERANCE: Double,
    toGeometryFeature: (typingsJapgolly.dojo.dojox.geo.openlayers.Point, typingsJapgolly.dojo.dojox.geo.openlayers.Point, Double) => CallbackTo[js.Any],
    toLineString: (typingsJapgolly.dojo.dojox.geo.openlayers.Point, typingsJapgolly.dojo.dojox.geo.openlayers.Point, Double) => CallbackTo[js.Any],
    toPointArray: (typingsJapgolly.dojo.dojox.geo.openlayers.Point, typingsJapgolly.dojo.dojox.geo.openlayers.Point, Double) => CallbackTo[js.Array[js.Any]]
  ): GreatCircle = {
