...
class GeometryFeature protected ()
  extends typingsJapgolly.dojo.dojox.geo.openlayers.Feature {
  def this(geometry: typingsJapgolly.dojo.dojox.geo.openlayers.Geometry) = this()
  /**
    ...
    */
  def createShape(s: Surface, g: typingsJapgolly.dojo.dojox.geo.openlayers.Geometry): js.Any = js.native
  /**
  ...
  def render(g: typingsJapgolly.dojo.dojox.geo.openlayers.Geometry): Unit = js.native
  /**
    * Renders a geometry collection.
    *
    * @param g               OptionalThe geometry to render.
    */
  def renderCollection(g: typingsJapgolly.dojo.dojox.geo.openlayers.Geometry): Unit = js.native
  /**
    * Renders a line string geometry.
    *
    * @param g               OptionalThe geometry to render.
    */
  def renderLineString(g: typingsJapgolly.dojo.dojox.geo.openlayers.Geometry): Unit = js.native
  /**
    * Renders a point geometry.
    *
    * @param g               OptionalThe geometry to render, or the current instance geometry if not specified.
    */
  def renderPoint(g: typingsJapgolly.dojo.dojox.geo.openlayers.Point): Unit = js.native
  /**
