...
import typingsJapgolly.dojo.dojoStrings.checked
import typingsJapgolly.dojo.dojoStrings.readOnly
import typingsJapgolly.dojo.dojoStrings.stateValue
import typingsJapgolly.dojo.dojoStrings.states
...
- typingsJapgolly.dojo.dijit.form.ToggleButtonMixin because Inheritance from two classes. Inlined checked, postCreate, reset */ @JSGlobal("dojox.form.TriStateCheckBox")
@js.native
