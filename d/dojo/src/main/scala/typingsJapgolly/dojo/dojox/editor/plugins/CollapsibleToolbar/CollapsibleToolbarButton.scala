package typingsJapgolly.dojo.dojox.editor.plugins.CollapsibleToolbar
...
import typingsJapgolly.dojo.dojoStrings.buttonClass
...
import typingsJapgolly.dojo.dojoStrings.textClass
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.editor.plugins.CollapsibleToolbar._CollapsibleToolbarButton")
@js.native
