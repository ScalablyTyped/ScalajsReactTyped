...
import typingsJapgolly.dojo.dojoStrings.defaultType
import typingsJapgolly.dojo.dojoStrings.duration
import typingsJapgolly.dojo.dojoStrings.messageTopic
import typingsJapgolly.dojo.dojoStrings.messageTypes
import typingsJapgolly.dojo.dojoStrings.positionDirection
import typingsJapgolly.dojo.dojoStrings.positionDirectionTypes
import typingsJapgolly.dojo.dojoStrings.searchContainerNode
import typingsJapgolly.dojo.dojoStrings.separator
import typingsJapgolly.dojo.dojoStrings.slideDuration
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget.Toaster")
@js.native
