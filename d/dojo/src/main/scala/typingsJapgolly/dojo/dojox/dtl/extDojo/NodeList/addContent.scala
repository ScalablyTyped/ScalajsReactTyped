...
trait addContent extends js.Object {
  ...
  def apply(content: typingsJapgolly.dojo.dojo.NodeList, position: String): js.Function = js.native
  def apply(content: typingsJapgolly.dojo.dojo.NodeList, position: Double): js.Function = js.native
