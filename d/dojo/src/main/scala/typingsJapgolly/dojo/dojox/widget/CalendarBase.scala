...
import typingsJapgolly.dojo.dojoStrings.footerFormat
...
import typingsJapgolly.dojo.dojoStrings.useFx
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget._CalendarBase")
@js.native
class CalendarBase () extends WidgetBase {
  /**
