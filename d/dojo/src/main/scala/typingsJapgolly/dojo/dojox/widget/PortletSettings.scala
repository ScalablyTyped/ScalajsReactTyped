...
import typingsJapgolly.dojo.dojoStrings.portletIconClass
import typingsJapgolly.dojo.dojoStrings.portletIconHoverClass
...
class PortletSettings () extends ContentPane {
  ...
  @JSName("watch")
  def watch_portletIconClass(
    property: portletIconClass,
