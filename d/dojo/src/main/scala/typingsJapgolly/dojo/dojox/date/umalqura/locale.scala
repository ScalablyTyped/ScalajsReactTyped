package typingsJapgolly.dojo.dojox.date.umalqura
...
object locale {
  ...
  def apply(
    ...
    __obj.updateDynamic("format")(js.Any.fromFunction2((t0: typingsJapgolly.dojo.dojox.date.umalqura.Date, t1: js.Object) => format(t0, t1).runNow()))
    __obj.updateDynamic("getNames")(js.Any.fromFunction5((t0: java.lang.String, t1: java.lang.String, t2: java.lang.String, t3: java.lang.String, t4: typingsJapgolly.dojo.dojox.date.umalqura.Date) => getNames(t0, t1, t2, t3, t4).runNow()))
