...
- typingsJapgolly.dojo.dojox.charting.plot2d.PlotEvents because Inheritance from two classes. Inlined connect, connect, destroy, events, fireEvent, plotEvent, raiseEvent, resetEvents */ @JSGlobal("dojox.charting.plot2d.Default")
@js.native
class Default protected () extends CartesianBase {
  ...
  /**
    ...
    * @param indexed
    */
  def buildSegments(i: js.Any, indexed: js.Any): js.Array[_] = js.native
  /**
  ...
  /**
    ...
    * @param params
    */
  def createPath(run: js.Any, creator: js.Any, params: js.Any): js.Any = js.native
  /**
