...
- typingsJapgolly.dojo.dijit.form.ComboBoxMenuMixin because Inheritance from two classes. Inlined buildRendering, clearResultList, createOptions, getHighlightedOption, highlightFirstOption, highlightLastOption, postMixInProperties, onChange, onClick, onPage
- typingsJapgolly.dojo.dojox.mobile.ListTouchMixin because Inheritance from two classes. Inlined selected, postCreate, selectFirstNode, selectLastNode, selectNextNode, selectPreviousNode */ @JSGlobal("dojox.mobile._ComboBoxMenu")
@js.native
