...
import typingsJapgolly.dojo.dojoStrings.numPanes
import typingsJapgolly.dojo.dojoStrings.searchDelay
import typingsJapgolly.dojo.dojoStrings.value
import typingsJapgolly.dojo.dojoStrings.valueItem
...
- typingsJapgolly.dojo.dijit.HasDropDown because Inheritance from two classes. Inlined autoWidth, dropDown, dropDownPosition, forceWidth, maxHeight, buildRendering, closeDropDown, destroy, isLoaded, loadAndOpenDropDown, loadDropDown, openDropDown, postCreate, toggleDropDown */ @JSGlobal("dojox.form.FilePickerTextBox")
@js.native
