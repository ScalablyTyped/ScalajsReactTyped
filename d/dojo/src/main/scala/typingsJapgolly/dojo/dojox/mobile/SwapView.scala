...
class SwapView protected () extends View {
  ...
  /**
    ...
    */
  def goTo(dir: Double, moveTo: String): Unit = js.native
  /**
  ...
  /**
    ...
    * @param node
    */
  def isSwapView(node: HTMLElement): js.Any = js.native
  /**
  ...
  /**
    ...
    * @param to
    */
  def scrollTo(to: js.Object): Unit = js.native
  /**
  ...
  def slideTo(to: js.Object, duration: Double, easing: String, fake_pos: js.Object): Unit = js.native
  /**
