...
import typingsJapgolly.dojo.dojoStrings.dyeClass
import typingsJapgolly.dojo.dojoStrings.hovering
import typingsJapgolly.dojo.dojoStrings.palette
import typingsJapgolly.dojo.dojoStrings.paletteClass
import typingsJapgolly.dojo.dojoStrings.searchContainerNode
import typingsJapgolly.dojo.dojoStrings.showCode
import typingsJapgolly.dojo.dojoStrings.showEntityName
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.editor.plugins.EntityPalette")
@js.native
