...
- typingsJapgolly.dojo.dojox.mobile.ExecScriptMixin because Inheritance from two classes. Inlined execScript */ @JSGlobal("dojox.mobile.dh.HtmlScriptContentHandler")
@js.native
