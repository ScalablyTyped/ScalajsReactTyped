...
import typingsJapgolly.dojo.dojoStrings.getStatefulOptions
...
/**
  ...
  *
  */
@JSGlobal("dojox.mvc.EditModelRefController")
@js.native
class EditModelRefController () extends ModelRefController {
  /**
