package typingsJapgolly.dojo.dojox.json
...
object ref {
  @scala.inline
  def apply(
    fromJson: (String, js.Object) => CallbackTo[js.Any],
    refAttribute: String,
    resolveJson: (js.Object, js.Object) => CallbackTo[js.Any],
    serializeFunctions: Boolean,
    toJson: (js.Object, Boolean, js.Object, js.Object) => CallbackTo[js.Any]
  ): ref = {
    val __obj = js.Dynamic.literal(refAttribute = refAttribute.asInstanceOf[js.Any], serializeFunctions = serializeFunctions.asInstanceOf[js.Any])
    __obj.updateDynamic("fromJson")(js.Any.fromFunction2((t0: java.lang.String, t1: js.Object) => fromJson(t0, t1).runNow()))
    __obj.updateDynamic("resolveJson")(js.Any.fromFunction2((t0: js.Object, t1: js.Object) => resolveJson(t0, t1).runNow()))
    __obj.updateDynamic("toJson")(js.Any.fromFunction4((t0: js.Object, t1: scala.Boolean, t2: js.Object, t3: js.Object) => toJson(t0, t1, t2, t3).runNow()))
