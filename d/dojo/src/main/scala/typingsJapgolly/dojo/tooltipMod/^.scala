package typingsJapgolly.dojo.tooltipMod
...
import typingsJapgolly.dojo.dijit.Tooltip
...
object ^
  extends TopLevel[
      Instantiable0[Tooltip] with (Instantiable1[/* params */ js.Object, Tooltip]) with (Instantiable2[/* params */ js.Object, /* srcNodeRef */ typingsJapgolly.std.HTMLElement, Tooltip])
    ] {
  /**
  ...
  var _MasterTooltip: Instantiable2[
    ...
    typingsJapgolly.dojo.dijit.Tooltip.MasterTooltip
  ] = js.native
  /**
