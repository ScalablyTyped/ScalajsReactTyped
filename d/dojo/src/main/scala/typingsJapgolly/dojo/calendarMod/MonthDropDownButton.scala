package typingsJapgolly.dojo.calendarMod
...
/**
  ...
  */
@JSImport("dijit/Calendar", "_MonthDropDownButton")
@js.native
class MonthDropDownButton ()
  extends typingsJapgolly.dojo.dijit.Calendar.MonthDropDownButton {
