...
import typingsJapgolly.dojo.dojoStrings.buttonWidget
import typingsJapgolly.dojo.dojoStrings.contentWidget
...
- typingsJapgolly.dojo.dijit.CssStateMixin because Inheritance from two classes. Inlined active, cssStateNodes, hovering */ @JSGlobal("dijit.layout.AccordionContainer._InnerContainer")
@js.native
