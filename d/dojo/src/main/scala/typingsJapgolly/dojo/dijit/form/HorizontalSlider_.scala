...
import typingsJapgolly.dojo.dojoStrings.clickSelect
import typingsJapgolly.dojo.dojoStrings.discreteValues
import typingsJapgolly.dojo.dojoStrings.maximum
import typingsJapgolly.dojo.dojoStrings.minimum
import typingsJapgolly.dojo.dojoStrings.pageIncrement
import typingsJapgolly.dojo.dojoStrings.showButtons
...
- typingsJapgolly.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dijit.form.HorizontalSlider")
@js.native
