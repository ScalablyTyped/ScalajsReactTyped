...
import typingsJapgolly.dojo.dojoStrings.indeterminate
...
import typingsJapgolly.dojo.dojoStrings.places
import typingsJapgolly.dojo.dojoStrings.progress
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.ProgressBar")
@js.native
