package typingsJapgolly.dojo.dijit.layout.AccordionContainer
...
import typingsJapgolly.dojo.dojoStrings.iconClassAttr
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.layout.AccordionContainer._Button")
@js.native
