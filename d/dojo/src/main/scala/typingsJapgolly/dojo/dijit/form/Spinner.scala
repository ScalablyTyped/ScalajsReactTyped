...
import typingsJapgolly.dojo.dojoStrings.largeDelta
import typingsJapgolly.dojo.dojoStrings.minimumTimeout
import typingsJapgolly.dojo.dojoStrings.smallDelta
