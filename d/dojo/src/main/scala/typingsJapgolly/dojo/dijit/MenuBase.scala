...
import typingsJapgolly.dojo.dojo.keys
import typingsJapgolly.dojo.dojoStrings.activated
import typingsJapgolly.dojo.dojoStrings.active
import typingsJapgolly.dojo.dojoStrings.attachScope
import typingsJapgolly.dojo.dojoStrings.autoFocus
...
import typingsJapgolly.dojo.dojoStrings.parentMenu
import typingsJapgolly.dojo.dojoStrings.passivePopupDelay
import typingsJapgolly.dojo.dojoStrings.popupDelay
...
- typingsJapgolly.dojo.dijit.Container because Inheritance from two classes. Inlined 
- typingsJapgolly.dojo.dijit.KeyNavMixin because Inheritance from two classes. Inlined 
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit._MenuBase")
@js.native
