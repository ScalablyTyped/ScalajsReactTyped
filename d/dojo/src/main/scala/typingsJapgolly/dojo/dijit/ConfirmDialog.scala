...
import typingsJapgolly.dojo.dojoStrings.actionBarTemplate
import typingsJapgolly.dojo.dojoStrings.buttonCancel
import typingsJapgolly.dojo.dojoStrings.buttonOk
...
- typingsJapgolly.dojo.dijit.ConfirmDialogMixin because Inheritance from two classes. Inlined actionBarTemplate, buttonCancel, buttonOk, contextRequire, widgetsInTemplate, startup */ @JSGlobal("dijit.ConfirmDialog")
@js.native
