...
import typingsJapgolly.dojo.dojoStrings.connectId
import typingsJapgolly.dojo.dojoStrings.defaultPosition
import typingsJapgolly.dojo.dojoStrings.label
import typingsJapgolly.dojo.dojoStrings.position
import typingsJapgolly.dojo.dojoStrings.selector
import typingsJapgolly.dojo.dojoStrings.showDelay
...
class Tooltip_ () extends Widget {
  ...
  /**
    ...
    * @param node             
    */
  def addTarget(node: typingsJapgolly.std.HTMLElement): Unit = js.native
  /**
  ...
  /**
    ...
    * @param node             
    */
  def removeTarget(node: typingsJapgolly.std.HTMLElement): Unit = js.native
  @JSName("set")
