...
import typingsJapgolly.dojo.dojoStrings.buttonWidgetCloseClass
import typingsJapgolly.dojo.dojoStrings.closeButton
import typingsJapgolly.dojo.dojoStrings.containerId
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.layout.StackController")
@js.native
