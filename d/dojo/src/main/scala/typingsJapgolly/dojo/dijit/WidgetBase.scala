...
import typingsJapgolly.dojo.dojoStrings.`class`
import typingsJapgolly.dojo.dojoStrings.attributeMap
import typingsJapgolly.dojo.dojoStrings.baseClass
import typingsJapgolly.dojo.dojoStrings.containerNode
import typingsJapgolly.dojo.dojoStrings.dir
import typingsJapgolly.dojo.dojoStrings.domNode
import typingsJapgolly.dojo.dojoStrings.focused
import typingsJapgolly.dojo.dojoStrings.id
import typingsJapgolly.dojo.dojoStrings.lang
import typingsJapgolly.dojo.dojoStrings.ownerDocument
import typingsJapgolly.dojo.dojoStrings.srcNodeRef
import typingsJapgolly.dojo.dojoStrings.style
import typingsJapgolly.dojo.dojoStrings.title
import typingsJapgolly.dojo.dojoStrings.tooltip_
...
- typingsJapgolly.dojo.dijit.Destroyable because Inheritance from two classes. Inlined destroy, destroy, own */ @JSGlobal("dijit._WidgetBase")
@js.native
class WidgetBase () extends Stateful {
  ...
  /**
    ...
    * @param position               OptionalIf reference is a widget (or id of widget), and that widget has an ".addChild" method,it will be called passing this widget instance into that method, supplying the optionalposition index passed.  In this case position (if specified) should be an integer.If reference is a DOMNode (or id matching a DOMNode but not a widget),the position argument can be a numeric index or a string"first", "last", "before", or "after", same as dojo/dom-construct::place().             
    */
  def placeAt(reference: typingsJapgolly.std.HTMLElement): js.Any = js.native
