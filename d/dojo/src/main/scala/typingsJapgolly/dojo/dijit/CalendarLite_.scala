...
import typingsJapgolly.dojo.dojoStrings.dateTemplateString
import typingsJapgolly.dojo.dojoStrings.dayWidth
import typingsJapgolly.dojo.dojoStrings.dowTemplateString
...
import typingsJapgolly.dojo.dojoStrings.weekTemplateString
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.CalendarLite")
@js.native
