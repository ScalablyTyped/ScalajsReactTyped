...
import typingsJapgolly.dojo.dojoStrings.tabStripClass
import typingsJapgolly.dojo.dojoStrings.useMenu
import typingsJapgolly.dojo.dojoStrings.useSlider
...
- typingsJapgolly.dojo.dijit.WidgetsInTemplateMixin because Inheritance from two classes. Inlined contextRequire, widgetsInTemplate, startup */ @JSGlobal("dijit.layout.ScrollingTabController")
@js.native
