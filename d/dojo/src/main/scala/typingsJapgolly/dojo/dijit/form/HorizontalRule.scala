...
import typingsJapgolly.dojo.dojoStrings.count
import typingsJapgolly.dojo.dojoStrings.ruleStyle
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.form.HorizontalRule")
@js.native
