package typingsJapgolly.dojo.dijit.layout.BorderContainer
...
import typingsJapgolly.dojo.dojoStrings.child
import typingsJapgolly.dojo.dojoStrings.container
import typingsJapgolly.dojo.dojoStrings.live
import typingsJapgolly.dojo.dojoStrings.region
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.layout.BorderContainer._Splitter")
@js.native
