...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.layout.BorderContainer._Gutter")
@js.native
class Gutter () extends Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_Gutter: String = js.native
  /**
