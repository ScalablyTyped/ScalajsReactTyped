...
/**
  * Permalink: http://dojotoolkit.org/api/1.9/dijit/Dialog.html
  *
...
- typingsJapgolly.dojo.dijit.DialogMixin because Inheritance from two classes. Inlined execute, onCancel, onExecute
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.Dialog")
@js.native
class Dialog_ () extends ContentPane {
  ...
  /**
    ...
    */
  @JSName("isValid")
  def isValid_MDialog_(): Boolean = js.native
  /**
