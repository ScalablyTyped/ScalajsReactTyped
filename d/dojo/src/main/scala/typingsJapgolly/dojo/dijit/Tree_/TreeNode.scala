package typingsJapgolly.dojo.dijit.Tree_
...
import typingsJapgolly.dojo.dojoStrings.indent
import typingsJapgolly.dojo.dojoStrings.isExpanded
import typingsJapgolly.dojo.dojoStrings.isTreeNode
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.Tree._TreeNode")
@js.native
