...
trait main_ extends js.Object {
  ...
  /**
    ...
    * @param doc               Optional            
    */
  def getFirstInTabbingOrder(root: typingsJapgolly.std.HTMLElement, doc: HTMLDocument): js.Any = js.native
  /**
  ...
  /**
    ...
    * @param doc               Optional            
    */
  def getLastInTabbingOrder(root: typingsJapgolly.std.HTMLElement, doc: HTMLDocument): js.Any = js.native
  /**
