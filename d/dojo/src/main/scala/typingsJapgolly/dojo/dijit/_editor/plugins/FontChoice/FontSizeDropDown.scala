...
import typingsJapgolly.dojo.dojoStrings.comboClass
import typingsJapgolly.dojo.dojoStrings.command
...
import typingsJapgolly.dojo.dojoStrings.values
...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit._editor.plugins.FontChoice._FontSizeDropDown")
@js.native
