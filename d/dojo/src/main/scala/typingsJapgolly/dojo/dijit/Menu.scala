...
import typingsJapgolly.dojo.dojoStrings.contextMenuForWindow
import typingsJapgolly.dojo.dojoStrings.currentTarget
import typingsJapgolly.dojo.dojoStrings.leftClickToOpen
import typingsJapgolly.dojo.dojoStrings.refocus
import typingsJapgolly.dojo.dojoStrings.selector
import typingsJapgolly.dojo.dojoStrings.targetNodeIds
...
class Menu () extends DropDownMenu {
  ...
  /**
    ...
    * @param node             
    */
  def bindDomNode(node: typingsJapgolly.std.HTMLElement): Unit = js.native
  /**
  ...
  /**
    ...
    * @param nodeName             
    */
  def unBindDomNode(nodeName: typingsJapgolly.std.HTMLElement): Unit = js.native
  @JSName("watch")
