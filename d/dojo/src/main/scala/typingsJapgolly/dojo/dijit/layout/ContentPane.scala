...
import typingsJapgolly.dojo.dojoStrings.extractContent
import typingsJapgolly.dojo.dojoStrings.href
import typingsJapgolly.dojo.dojoStrings.ioArgs
...
import typingsJapgolly.dojo.dojoStrings.parserScope
import typingsJapgolly.dojo.dojoStrings.preload
import typingsJapgolly.dojo.dojoStrings.preventCache
import typingsJapgolly.dojo.dojoStrings.refreshOnShow
import typingsJapgolly.dojo.dojoStrings.stopParser
...
- typingsJapgolly.dojo.dijit.layout.ContentPaneResizeMixin because Inheritance from two classes. Inlined doLayout, isLayoutContainer, resize, startup
- typingsJapgolly.dojo.dijit.Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dijit.layout.ContentPane")
@js.native
class ContentPane () extends Widget {
  ...
  /**
    ...
    * @param data             
    */
  def setContent(data: typingsJapgolly.std.HTMLElement): Unit = js.native
  /**
    * Deprecated.   Use set('content', ...) instead.
    * 
    * @param data             
