...
- typingsJapgolly.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.Tooltip._MasterTooltip")
@js.native
class MasterTooltip () extends Widget {
  ...
  def show(
    innerHTML: String,
    aroundNode: typingsJapgolly.std.HTMLElement,
    position: js.Array[String],
    rtl: Boolean,
    textDir: String
  ): Unit = js.native
