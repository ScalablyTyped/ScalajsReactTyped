...
@js.native
object storeMod extends TopLevel[TypeofStore with Instantiable0[Store]] {
  /**
  ...
  @js.native
  class PutDirectives ()
    extends typingsJapgolly.dojo.dojo.store.api.Store.PutDirectives
  ...
  @js.native
  class QueryOptions ()
    extends typingsJapgolly.dojo.dojo.store.api.Store.QueryOptions
  ...
  @js.native
  class QueryResults ()
    extends typingsJapgolly.dojo.dojo.store.api.Store.QueryResults
  ...
  class SortInformation ()
    extends typingsJapgolly.dojo.dojo.store.api.Store.SortInformation
  ...
  @js.native
  class Transaction ()
    extends typingsJapgolly.dojo.dojo.store.api.Store.Transaction
