...
object script {
  @scala.inline
  def apply(
    attach: (js.Any, js.Any, js.Any) => Callback,
    get: js.Object => CallbackTo[js.Any],
    remove: (js.Any, js.Any) => Callback
  ): script = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("attach")(js.Any.fromFunction3((t0: js.Any, t1: js.Any, t2: js.Any) => attach(t0, t1, t2).runNow()))
    __obj.updateDynamic("get")(js.Any.fromFunction1((t0: js.Object) => get(t0).runNow()))
    __obj.updateDynamic("remove")(js.Any.fromFunction2((t0: js.Any, t1: js.Any) => remove(t0, t1).runNow()))
