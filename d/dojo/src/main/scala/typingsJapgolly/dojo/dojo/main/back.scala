...
object back {
  @scala.inline
  def apply(
    addToHistory: js.Object => Callback,
    getHash: CallbackTo[js.Any],
    goBack: Callback,
    goForward: Callback,
    init: Callback
  ): back = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("addToHistory")(js.Any.fromFunction1((t0: js.Object) => addToHistory(t0).runNow()))
    __obj.updateDynamic("getHash")(getHash.toJsFn)
    __obj.updateDynamic("goBack")(goBack.toJsFn)
    __obj.updateDynamic("goForward")(goForward.toJsFn)
