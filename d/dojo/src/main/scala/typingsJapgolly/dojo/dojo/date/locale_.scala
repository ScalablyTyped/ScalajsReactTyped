package typingsJapgolly.dojo.dojo.date
...
trait locale_ extends js.Object {
  ...
  /**
    ...
    */
  def format(dateObject: js.Date): js.Any = js.native
  def format(dateObject: js.Date, options: js.Object): js.Any = js.native
  /**
  ...
  def isWeekend(dateObject: js.Date): Boolean = js.native
  def isWeekend(dateObject: js.Date, locale: String): Boolean = js.native
  /**
