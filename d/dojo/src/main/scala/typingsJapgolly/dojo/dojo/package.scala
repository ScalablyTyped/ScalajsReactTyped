...
package object dojo {
  type NodeList = typingsJapgolly.dojo.dojo.NodeList_
  /**
  ...
  type currency = typingsJapgolly.dojo.dojo.currency_
  type date = typingsJapgolly.dojo.dojo.date_
  type domProp = typingsJapgolly.dojo.dojo.domProp_
  type gears = typingsJapgolly.dojo.dojo.gears_
  /**
  ...
  type html = typingsJapgolly.dojo.dojo.html_
  type i18n = typingsJapgolly.dojo.dojo.i18n_
  type main = typingsJapgolly.dojo.dojo.main_
  type number = typingsJapgolly.dojo.dojo.number_
  /**
  ...
  type request = typingsJapgolly.dojo.dojo.request_
  type robot = typingsJapgolly.dojo.dojo.robot_
  type robotx = typingsJapgolly.dojo.dojo.robotx_
  /**
    ...
    *
    */
  type router = typingsJapgolly.dojo.dojo.router.RouterBase
  /**
  ...
  type when = js.Function4[
    /* value */ js.Any | typingsJapgolly.dojo.dojo.promise.Promise[js.Any], 
    /* callback */ typingsJapgolly.dojo.dojo.promise.Callback[js.Any, js.Any], 
    /* errback */ js.UndefOr[js.Any], 
    /* progback */ js.UndefOr[js.Any], 
    js.Any | typingsJapgolly.dojo.dojo.promise.Promise[js.Any]
  ]
}
