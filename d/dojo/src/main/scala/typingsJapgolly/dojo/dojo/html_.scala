...
trait html_ extends js.Object {
  ...
  /**
    ...
    * @param params               OptionalOptional flags/properties to configure the content-setting. See dojo/html/_ContentSetter
    */
  def set(node: HTMLElement, cont: typingsJapgolly.std.HTMLElement): js.Any = js.native
  def set(node: HTMLElement, cont: typingsJapgolly.std.HTMLElement, params: js.Object): js.Any = js.native
}
