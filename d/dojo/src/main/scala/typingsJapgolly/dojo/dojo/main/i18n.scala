...
object i18n {
  ...
  def apply(
    cache: js.Object,
    dynamic: Boolean,
    getL10nName: (js.Any, js.Any, js.Any) => CallbackTo[String],
    getLocalization: (js.Any, js.Any, js.Any) => CallbackTo[js.Any],
    load: (js.Any, js.Any, js.Any) => Callback,
    normalize: (js.Any, js.Any) => CallbackTo[js.Any],
    normalizeLocale: js.Any => CallbackTo[js.Any],
    unitTests: js.Array[_]
  ): i18n = {
    val __obj = js.Dynamic.literal(cache = cache.asInstanceOf[js.Any], dynamic = dynamic.asInstanceOf[js.Any], unitTests = unitTests.asInstanceOf[js.Any])
    __obj.updateDynamic("getL10nName")(js.Any.fromFunction3((t0: js.Any, t1: js.Any, t2: js.Any) => getL10nName(t0, t1, t2).runNow()))
    __obj.updateDynamic("getLocalization")(js.Any.fromFunction3((t0: js.Any, t1: js.Any, t2: js.Any) => getLocalization(t0, t1, t2).runNow()))
    ...
    __obj.updateDynamic("normalizeLocale")(js.Any.fromFunction1((t0: js.Any) => normalizeLocale(t0).runNow()))
