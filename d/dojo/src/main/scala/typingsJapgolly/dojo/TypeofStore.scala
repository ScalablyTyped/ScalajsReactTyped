...
import typingsJapgolly.dojo.dojo.store.api.Store.PutDirectives
import typingsJapgolly.dojo.dojo.store.api.Store.QueryOptions
...
trait TypeofStore extends js.Object {
  /**
    ...
    *
    */
  var PutDirectives: Instantiable0[typingsJapgolly.dojo.dojo.store.api.Store.PutDirectives]
  /**
    ...
    *
    */
  var QueryOptions: Instantiable0[typingsJapgolly.dojo.dojo.store.api.Store.QueryOptions]
  /**
    ...
    *
    */
  var QueryResults: Instantiable0[typingsJapgolly.dojo.dojo.store.api.Store.QueryResults]
  /**
    ...
    *
    */
  var SortInformation: Instantiable0[typingsJapgolly.dojo.dojo.store.api.Store.SortInformation]
  /**
    ...
    *
    */
  var Transaction: Instantiable0[typingsJapgolly.dojo.dojo.store.api.Store.Transaction]
}
