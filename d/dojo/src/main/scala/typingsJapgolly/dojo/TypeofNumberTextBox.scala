...
import typingsJapgolly.dojo.dijit.form.NumberTextBox.Constraints
import typingsJapgolly.dojo.dijit.form.NumberTextBox.Mixin
...
trait TypeofNumberTextBox extends js.Object {
  /**
    ...
    * 
    */
  var Mixin: Instantiable0[typingsJapgolly.dojo.dijit.form.NumberTextBox.Mixin]
  /**
