...
object Decorators {
  ...
  trait CompositeDraftDecorator extends StObject {
    ...
    def getDecorations(block: ContentBlock, contentState: ContentState): typingsJapgolly.immutable.mod.List[String]
  ...
  object CompositeDraftDecorator {
    ...
    inline def apply(
      ...
      getDecorations: (ContentBlock, ContentState) => typingsJapgolly.immutable.mod.List[String],
    ...
    extension [Self <: CompositeDraftDecorator](x: Self) {
      ...
      inline def setGetDecorations(value: (ContentBlock, ContentState) => typingsJapgolly.immutable.mod.List[String]): Self = StObject.set(x, "getDecorations", js.Any.fromFunction2(value))
  ...
  object DraftDecorator {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(component = component.asInstanceOf[js.Any], strategy = js.Any.fromFunction3((t0: ContentBlock, t1: js.Function2[/* start */ Double, /* end */ Double, Unit], t2: ContentState) => (strategy(t0, t1, t2)).runNow()))
    ...
    extension [Self <: DraftDecorator](x: Self) {
      ...
      inline def setStrategy(
        value: (ContentBlock, js.Function2[/* start */ Double, /* end */ Double, Unit], ContentState) => Callback
      ): Self = StObject.set(x, "strategy", js.Any.fromFunction3((t0: ContentBlock, t1: js.Function2[/* start */ Double, /* end */ Double, Unit], t2: ContentState) => (value(t0, t1, t2)).runNow()))
    }
  }
