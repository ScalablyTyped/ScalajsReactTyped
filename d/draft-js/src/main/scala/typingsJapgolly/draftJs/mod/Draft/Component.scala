package typingsJapgolly.draftJs.mod.Draft
...
import typingsJapgolly.draftJs.anon.Html
...
import typingsJapgolly.draftJs.mod.Draft.Model.ImmutableData.DraftBlockRenderConfig
...
import typingsJapgolly.draftJs.mod.SyntheticEvent
...
object Component {
  ...
  object Base {
    ...
    @js.native
    trait DraftEditor
      extends typingsJapgolly.react.mod.Component[DraftEditorProps, js.Object, Any] {
    ...
    trait DraftEditorProps extends StObject {
      ...
      var handleReturn: js.UndefOr[
            js.Function2[
              ReactKeyboardEventFrom[js.Object & Element], 
              /* editorState */ EditorState, 
              DraftHandleValue
            ]
          ] = js.undefined
      ...
      /**
        ...
        * be invoked.
        */
      var keyBindingFn: js.UndefOr[js.Function1[ReactKeyboardEventFrom[js.Object & Element], EditorCommand | Null]] = js.undefined
      ...
      var onCopy: js.UndefOr[
            js.Function2[
              ...
              ReactClipboardEventFrom[js.Object & Element], 
              Unit
            ]
          ] = js.undefined
      ...
      var onDownArrow: js.UndefOr[js.Function1[ReactKeyboardEventFrom[js.Object & Element], Unit]] = js.undefined
      
      // Non-cancelable event triggers.
      var onEscape: js.UndefOr[js.Function1[ReactKeyboardEventFrom[js.Object & Element], Unit]] = js.undefined
      
      var onFocus: js.UndefOr[js.Function1[/* e */ SyntheticEvent, Unit]] = js.undefined
      
      var onLeftArrow: js.UndefOr[js.Function1[ReactKeyboardEventFrom[js.Object & Element], Unit]] = js.undefined
      
      var onRightArrow: js.UndefOr[js.Function1[ReactKeyboardEventFrom[js.Object & Element], Unit]] = js.undefined
      
      var onTab: js.UndefOr[js.Function1[ReactKeyboardEventFrom[js.Object & Element], Unit]] = js.undefined
      
      var onUpArrow: js.UndefOr[js.Function1[ReactKeyboardEventFrom[js.Object & Element], Unit]] = js.undefined
    ...
    object DraftEditorProps {
      ...
      inline def apply(editorState: EditorState, onChange: EditorState => Callback): DraftEditorProps = {
        val __obj = js.Dynamic.literal(editorState = editorState.asInstanceOf[js.Any], onChange = js.Any.fromFunction1((t0: EditorState) => onChange(t0).runNow()))
      ...
      extension [Self <: DraftEditorProps](x: Self) {
        ...
        inline def setHandleReturn(
          value: (ReactKeyboardEventFrom[js.Object & Element], /* editorState */ EditorState) => DraftHandleValue
        ): Self = StObject.set(x, "handleReturn", js.Any.fromFunction2(value))
        
        inline def setHandleReturnUndefined: Self = StObject.set(x, "handleReturn", js.undefined)
        
        inline def setKeyBindingFn(value: ReactKeyboardEventFrom[js.Object & Element] => EditorCommand | Null): Self = StObject.set(x, "keyBindingFn", js.Any.fromFunction1(value))
        
        inline def setKeyBindingFnUndefined: Self = StObject.set(x, "keyBindingFn", js.undefined)
        
        inline def setOnBlur(value: /* e */ SyntheticEvent => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: /* e */ SyntheticEvent) => value(t0).runNow()))
        
        inline def setOnBlurUndefined: Self = StObject.set(x, "onBlur", js.undefined)
        
        inline def setOnChange(value: EditorState => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: EditorState) => value(t0).runNow()))
        
        inline def setOnCopy(
          value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Editor */ /* editor */ Any, ReactClipboardEventFrom[js.Object & Element]) => Callback
        ): Self = StObject.set(x, "onCopy", js.Any.fromFunction2((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Editor */ /* editor */ Any, t1: ReactClipboardEventFrom[js.Object & Element]) => (value(t0, t1)).runNow()))
        
        inline def setOnCopyUndefined: Self = StObject.set(x, "onCopy", js.undefined)
        
        inline def setOnCut(
          value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Editor */ /* editor */ Any, ReactClipboardEventFrom[js.Object & Element]) => Callback
        ): Self = StObject.set(x, "onCut", js.Any.fromFunction2((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Editor */ /* editor */ Any, t1: ReactClipboardEventFrom[js.Object & Element]) => (value(t0, t1)).runNow()))
        
        inline def setOnCutUndefined: Self = StObject.set(x, "onCut", js.undefined)
        
        inline def setOnDownArrow(value: ReactKeyboardEventFrom[js.Object & Element] => Callback): Self = StObject.set(x, "onDownArrow", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[js.Object & Element]) => value(t0).runNow()))
        
        inline def setOnDownArrowUndefined: Self = StObject.set(x, "onDownArrow", js.undefined)
        
        inline def setOnEscape(value: ReactKeyboardEventFrom[js.Object & Element] => Callback): Self = StObject.set(x, "onEscape", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[js.Object & Element]) => value(t0).runNow()))
        
        inline def setOnEscapeUndefined: Self = StObject.set(x, "onEscape", js.undefined)
        
        inline def setOnFocus(value: /* e */ SyntheticEvent => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: /* e */ SyntheticEvent) => value(t0).runNow()))
        
        inline def setOnFocusUndefined: Self = StObject.set(x, "onFocus", js.undefined)
        
        inline def setOnLeftArrow(value: ReactKeyboardEventFrom[js.Object & Element] => Callback): Self = StObject.set(x, "onLeftArrow", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[js.Object & Element]) => value(t0).runNow()))
        
        inline def setOnLeftArrowUndefined: Self = StObject.set(x, "onLeftArrow", js.undefined)
        
        inline def setOnRightArrow(value: ReactKeyboardEventFrom[js.Object & Element] => Callback): Self = StObject.set(x, "onRightArrow", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[js.Object & Element]) => value(t0).runNow()))
        
        inline def setOnRightArrowUndefined: Self = StObject.set(x, "onRightArrow", js.undefined)
        
        inline def setOnTab(value: ReactKeyboardEventFrom[js.Object & Element] => Callback): Self = StObject.set(x, "onTab", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[js.Object & Element]) => value(t0).runNow()))
        
        inline def setOnTabUndefined: Self = StObject.set(x, "onTab", js.undefined)
        
        inline def setOnUpArrow(value: ReactKeyboardEventFrom[js.Object & Element] => Callback): Self = StObject.set(x, "onUpArrow", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[js.Object & Element]) => value(t0).runNow()))
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.draftJs.draftJsStrings.left
      - typingsJapgolly.draftJs.draftJsStrings.center
      - typingsJapgolly.draftJs.draftJsStrings.right
    */
    trait DraftTextAlignment extends StObject
    object DraftTextAlignment {
      
      inline def center: typingsJapgolly.draftJs.draftJsStrings.center = "center".asInstanceOf[typingsJapgolly.draftJs.draftJsStrings.center]
      
      inline def left: typingsJapgolly.draftJs.draftJsStrings.left = "left".asInstanceOf[typingsJapgolly.draftJs.draftJsStrings.left]
      
      inline def right: typingsJapgolly.draftJs.draftJsStrings.right = "right".asInstanceOf[typingsJapgolly.draftJs.draftJsStrings.right]
    }
    
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.draftJs.draftJsStrings.LTR
      - typingsJapgolly.draftJs.draftJsStrings.RTL
      - typingsJapgolly.draftJs.draftJsStrings.NEUTRAL
    */
    trait DraftTextDirectionality extends StObject
    object DraftTextDirectionality {
      
      inline def LTR: typingsJapgolly.draftJs.draftJsStrings.LTR = "LTR".asInstanceOf[typingsJapgolly.draftJs.draftJsStrings.LTR]
      
      inline def NEUTRAL: typingsJapgolly.draftJs.draftJsStrings.NEUTRAL = "NEUTRAL".asInstanceOf[typingsJapgolly.draftJs.draftJsStrings.NEUTRAL]
      
      inline def RTL: typingsJapgolly.draftJs.draftJsStrings.RTL = "RTL".asInstanceOf[typingsJapgolly.draftJs.draftJsStrings.RTL]
    }
  ...
  object Components {
    ...
    type DraftEditorBlock = japgolly.scalajs.react.facade.React.Component[Any & js.Object, js.Object]
  }
