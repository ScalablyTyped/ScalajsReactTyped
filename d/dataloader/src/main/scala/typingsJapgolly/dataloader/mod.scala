...
object mod {
  ...
  object CacheMap {
    ...
    inline def apply[K, V](clear: CallbackTo[Any], delete: K => Any, get: K => V | Unit, set: (K, V) => Any): CacheMap[K, V] = {
      val __obj = js.Dynamic.literal(clear = clear.toJsFn, delete = js.Any.fromFunction1(delete), get = js.Any.fromFunction1(get), set = js.Any.fromFunction2(set))
  ...
  object Options {
    ...
    extension [Self <: Options[?, ?, ?], K, V, C](x: Self & (Options[K, V, C])) {
      ...
      inline def setBatchScheduleFn(value: /* callback */ js.Function0[Unit] => Callback): Self = StObject.set(x, "batchScheduleFn", js.Any.fromFunction1((t0: /* callback */ js.Function0[Unit]) => value(t0).runNow()))
