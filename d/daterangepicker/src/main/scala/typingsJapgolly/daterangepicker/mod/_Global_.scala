...
import typingsJapgolly.daterangepicker.AnonDefaultOptions
...
object _Global_ extends js.Object {
  ...
  trait JQuery extends js.Object {
    ...
    @JSName("data")
    def data_daterangepicker(key: typingsJapgolly.daterangepicker.daterangepickerStrings.daterangepicker): js.UndefOr[daterangepicker] = js.native
