...
import typingsJapgolly.daterangepicker.anon.DefaultOptions
import typingsJapgolly.daterangepicker.anon.RequiredLocale
import typingsJapgolly.daterangepicker.daterangepickerBooleans.`false`
import typingsJapgolly.daterangepicker.daterangepickerStrings.auto
...
import typingsJapgolly.daterangepicker.mod.global.JQuery
...
object mod {
  ...
  open class ^ protected ()
    extends StObject
       with typingsJapgolly.daterangepicker.mod.daterangepicker {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.daterangepicker.daterangepickerStrings.showDotdaterangepicker
    - typingsJapgolly.daterangepicker.daterangepickerStrings.hideDotdaterangepicker
    - typingsJapgolly.daterangepicker.daterangepickerStrings.showCalendarDotdaterangepicker
    - typingsJapgolly.daterangepicker.daterangepickerStrings.hideCalendarDotdaterangepicker
    - typingsJapgolly.daterangepicker.daterangepickerStrings.applyDotdaterangepicker
    - typingsJapgolly.daterangepicker.daterangepickerStrings.cancelDotdaterangepicker
  */
  trait DatepickerEvents extends StObject
  object DatepickerEvents {
    
    inline def applyDotdaterangepicker: typingsJapgolly.daterangepicker.daterangepickerStrings.applyDotdaterangepicker = "apply.daterangepicker".asInstanceOf[typingsJapgolly.daterangepicker.daterangepickerStrings.applyDotdaterangepicker]
    
    inline def cancelDotdaterangepicker: typingsJapgolly.daterangepicker.daterangepickerStrings.cancelDotdaterangepicker = "cancel.daterangepicker".asInstanceOf[typingsJapgolly.daterangepicker.daterangepickerStrings.cancelDotdaterangepicker]
    
    inline def hideCalendarDotdaterangepicker: typingsJapgolly.daterangepicker.daterangepickerStrings.hideCalendarDotdaterangepicker = "hideCalendar.daterangepicker".asInstanceOf[typingsJapgolly.daterangepicker.daterangepickerStrings.hideCalendarDotdaterangepicker]
    
    inline def hideDotdaterangepicker: typingsJapgolly.daterangepicker.daterangepickerStrings.hideDotdaterangepicker = "hide.daterangepicker".asInstanceOf[typingsJapgolly.daterangepicker.daterangepickerStrings.hideDotdaterangepicker]
    
    inline def showCalendarDotdaterangepicker: typingsJapgolly.daterangepicker.daterangepickerStrings.showCalendarDotdaterangepicker = "showCalendar.daterangepicker".asInstanceOf[typingsJapgolly.daterangepicker.daterangepickerStrings.showCalendarDotdaterangepicker]
    
    inline def showDotdaterangepicker: typingsJapgolly.daterangepicker.daterangepickerStrings.showDotdaterangepicker = "show.daterangepicker".asInstanceOf[typingsJapgolly.daterangepicker.daterangepickerStrings.showDotdaterangepicker]
  }
  ...
  object daterangepicker {
    ...
    inline def apply(
      ...
      startDate: Moment
    ): typingsJapgolly.daterangepicker.mod.daterangepicker = {
      val __obj = js.Dynamic.literal(container = container.asInstanceOf[js.Any], endDate = endDate.asInstanceOf[js.Any], remove = remove.toJsFn, setEndDate = js.Any.fromFunction1((t0: DateOrString) => setEndDate(t0).runNow()), setStartDate = js.Any.fromFunction1((t0: DateOrString) => setStartDate(t0).runNow()), startDate = startDate.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.daterangepicker.mod.daterangepicker]
    }
    
    extension [Self <: typingsJapgolly.daterangepicker.mod.daterangepicker](x: Self) {
      ...
      inline def setSetEndDate(value: DateOrString => Callback): Self = StObject.set(x, "setEndDate", js.Any.fromFunction1((t0: DateOrString) => value(t0).runNow()))
      
      inline def setSetStartDate(value: DateOrString => Callback): Self = StObject.set(x, "setStartDate", js.Any.fromFunction1((t0: DateOrString) => value(t0).runNow()))
  ...
  object global {
    ...
    trait JQuery extends StObject {
      ...
      @JSName("data")
      def data_daterangepicker(key: typingsJapgolly.daterangepicker.daterangepickerStrings.daterangepicker): js.UndefOr[typingsJapgolly.daterangepicker.mod.daterangepicker]
    ...
    object JQuery {
      ...
      inline def apply(
        data: typingsJapgolly.daterangepicker.daterangepickerStrings.daterangepicker => js.UndefOr[typingsJapgolly.daterangepicker.mod.daterangepicker],
      ...
      extension [Self <: JQuery](x: Self) {
        ...
        inline def setData(
          value: typingsJapgolly.daterangepicker.daterangepickerStrings.daterangepicker => js.UndefOr[typingsJapgolly.daterangepicker.mod.daterangepicker]
