...
object declarationsValidateMod {
  ...
  object default {
    ...
    /**
      ...
      * @returns {void}
      */
    inline def apply(schema: typingsJapgolly.jsonSchema.mod.JSONSchema4, options: Any): Unit = (^.asInstanceOf[js.Dynamic].apply(schema.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def apply(
    ...
    inline def apply(schema: typingsJapgolly.jsonSchema.mod.JSONSchema6, options: Any): Unit = (^.asInstanceOf[js.Dynamic].apply(schema.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def apply(
      schema: typingsJapgolly.jsonSchema.mod.JSONSchema6,
      options: Any,
      configuration: ValidationErrorConfiguration
    ): Unit = (^.asInstanceOf[js.Dynamic].apply(schema.asInstanceOf[js.Any], options.asInstanceOf[js.Any], configuration.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def apply(schema: typingsJapgolly.jsonSchema.mod.JSONSchema7, options: Any): Unit = (^.asInstanceOf[js.Dynamic].apply(schema.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def apply(
