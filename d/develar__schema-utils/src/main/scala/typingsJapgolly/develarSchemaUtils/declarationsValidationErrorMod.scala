...
import typingsJapgolly.develarSchemaUtils.anon.Children
import typingsJapgolly.develarSchemaUtils.anon.ErrorObjectstringRecordst
...
object declarationsValidationErrorMod {
  ...
  open class default protected ()
    ...
    def this(errors: js.Array[ErrorObjectstringRecordst], schema: typingsJapgolly.jsonSchema.mod.JSONSchema6) = this()
    def this(errors: js.Array[ErrorObjectstringRecordst], schema: typingsJapgolly.jsonSchema.mod.JSONSchema7) = this()
    def this(
      errors: js.Array[ErrorObjectstringRecordst],
      schema: JSONSchema4,
      configuration: typingsJapgolly.develarSchemaUtils.declarationsValidateMod.ValidationErrorConfiguration
    ) = this()
    def this(
      errors: js.Array[ErrorObjectstringRecordst],
  ...
  type Schema = JSONSchema4 | typingsJapgolly.jsonSchema.mod.JSONSchema6 | typingsJapgolly.jsonSchema.mod.JSONSchema7
  ...
  trait ValidationError
    ...
    def formatSchema(schema: typingsJapgolly.jsonSchema.mod.JSONSchema6): String = js.native
    def formatSchema(schema: typingsJapgolly.jsonSchema.mod.JSONSchema6, prevSchemas: js.Array[js.Object]): String = js.native
    def formatSchema(schema: typingsJapgolly.jsonSchema.mod.JSONSchema7): String = js.native
    def formatSchema(schema: typingsJapgolly.jsonSchema.mod.JSONSchema7, prevSchemas: js.Array[js.Object]): String = js.native
    ...
    /**
      ...
      * @returns {Schema}
      */
    def getSchemaPart(path: String): JSONSchema4 | typingsJapgolly.jsonSchema.mod.JSONSchema6 | typingsJapgolly.jsonSchema.mod.JSONSchema7 = js.native
    ...
    def getSchemaPartDescription(schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema6): String = js.native
    def getSchemaPartDescription(schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema7): String = js.native
    ...
    def getSchemaPartText(schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema6): String = js.native
    def getSchemaPartText(schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema6, additionalPath: js.Array[String]): String = js.native
    def getSchemaPartText(
      schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema6,
      additionalPath: js.Array[String],
      needDot: Boolean
    ): String = js.native
    def getSchemaPartText(schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema6, additionalPath: Boolean): String = js.native
    def getSchemaPartText(schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema6, additionalPath: Boolean, needDot: Boolean): String = js.native
    def getSchemaPartText(schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema6, additionalPath: Unit, needDot: Boolean): String = js.native
    def getSchemaPartText(schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema7): String = js.native
    def getSchemaPartText(schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema7, additionalPath: js.Array[String]): String = js.native
    def getSchemaPartText(
      schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema7,
      additionalPath: js.Array[String],
      needDot: Boolean
    ): String = js.native
    def getSchemaPartText(schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema7, additionalPath: Boolean): String = js.native
    def getSchemaPartText(schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema7, additionalPath: Boolean, needDot: Boolean): String = js.native
    def getSchemaPartText(schemaPart: typingsJapgolly.jsonSchema.mod.JSONSchema7, additionalPath: Unit, needDot: Boolean): String = js.native
  ...
  trait ValidationErrorConfiguration extends StObject {
    ...
    var postFormatter: js.UndefOr[typingsJapgolly.develarSchemaUtils.declarationsValidateMod.PostFormatter] = js.undefined
  }
