package typingsJapgolly.discordRpc

import japgolly.scalajs.react.CallbackTo
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.discordRpc.anon.AutoThreshold
import typingsJapgolly.discordRpc.anon.Capacity
import typingsJapgolly.discordRpc.anon.Code
import typingsJapgolly.discordRpc.anon.Device
import typingsJapgolly.discordRpc.anon.Force
import typingsJapgolly.discordRpc.anon.Id
import typingsJapgolly.discordRpc.anon.Label
import typingsJapgolly.discordRpc.anon.Left
import typingsJapgolly.discordRpc.anon.Name
import typingsJapgolly.discordRpc.anon.Timeout
import typingsJapgolly.discordRpc.discordRpcStrings.AUDIO_INPUT
import typingsJapgolly.discordRpc.discordRpcStrings.AUDIO_OUTPUT
import typingsJapgolly.discordRpc.discordRpcStrings.VIDEO_INPUT
import typingsJapgolly.discordRpc.discordRpcStrings.consent
import typingsJapgolly.discordRpc.discordRpcStrings.ipc
import typingsJapgolly.discordRpc.discordRpcStrings.none
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.discordRpc.discordRpcStrings.CURRENT_USER_UPDATE
    - typingsJapgolly.discordRpc.discordRpcStrings.GUILD_STATUS
    - typingsJapgolly.discordRpc.discordRpcStrings.GUILD_CREATE
    - typingsJapgolly.discordRpc.discordRpcStrings.CHANNEL_CREATE
    - typingsJapgolly.discordRpc.discordRpcStrings.RELATIONSHIP_UPDATE
    - typingsJapgolly.discordRpc.discordRpcStrings.VOICE_CHANNEL_SELECT
    - typingsJapgolly.discordRpc.discordRpcStrings.VOICE_STATE_CREATE
    - typingsJapgolly.discordRpc.discordRpcStrings.VOICE_STATE_DELETE
    - typingsJapgolly.discordRpc.discordRpcStrings.VOICE_STATE_UPDATE
    - typingsJapgolly.discordRpc.discordRpcStrings.VOICE_SETTINGS_UPDATE
    - typingsJapgolly.discordRpc.discordRpcStrings.VOICE_SETTINGS_UPDATE_2
    - typingsJapgolly.discordRpc.discordRpcStrings.VOICE_CONNECTION_STATUS
    - typingsJapgolly.discordRpc.discordRpcStrings.SPEAKING_START
    - typingsJapgolly.discordRpc.discordRpcStrings.SPEAKING_STOP
    - typingsJapgolly.discordRpc.discordRpcStrings.GAME_JOIN
    - typingsJapgolly.discordRpc.discordRpcStrings.GAME_SPECTATE
    - typingsJapgolly.discordRpc.discordRpcStrings.ACTIVITY_JOIN
    - typingsJapgolly.discordRpc.discordRpcStrings.ACTIVITY_JOIN_REQUEST
    - typingsJapgolly.discordRpc.discordRpcStrings.ACTIVITY_SPECTATE
    - typingsJapgolly.discordRpc.discordRpcStrings.ACTIVITY_INVITE
    - typingsJapgolly.discordRpc.discordRpcStrings.NOTIFICATION_CREATE
    - typingsJapgolly.discordRpc.discordRpcStrings.MESSAGE_CREATE
    - typingsJapgolly.discordRpc.discordRpcStrings.MESSAGE_UPDATE
    - typingsJapgolly.discordRpc.discordRpcStrings.MESSAGE_DELETE
    - typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_DELETE
    - typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_UPDATE
    - typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_MEMBER_CONNECT
    - typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_MEMBER_DISCONNECT
    - typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_MEMBER_UPDATE
    - typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_MESSAGE
    - typingsJapgolly.discordRpc.discordRpcStrings.CAPTURE_SHORTCUT_CHANGE
    - typingsJapgolly.discordRpc.discordRpcStrings.OVERLAY
    - typingsJapgolly.discordRpc.discordRpcStrings.OVERLAY_UPDATE
    - typingsJapgolly.discordRpc.discordRpcStrings.ENTITLEMENT_CREATE
    - typingsJapgolly.discordRpc.discordRpcStrings.ENTITLEMENT_DELETE
    - typingsJapgolly.discordRpc.discordRpcStrings.USER_ACHIEVEMENT_UPDATE
    - typingsJapgolly.discordRpc.discordRpcStrings.READY
    - typingsJapgolly.discordRpc.discordRpcStrings.ERROR
  */
  trait RPCEvents extends StObject
  object RPCEvents {
    
    inline def ACTIVITY_INVITE: typingsJapgolly.discordRpc.discordRpcStrings.ACTIVITY_INVITE = "ACTIVITY_INVITE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.ACTIVITY_INVITE]
    
    inline def ACTIVITY_JOIN: typingsJapgolly.discordRpc.discordRpcStrings.ACTIVITY_JOIN = "ACTIVITY_JOIN".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.ACTIVITY_JOIN]
    
    inline def ACTIVITY_JOIN_REQUEST: typingsJapgolly.discordRpc.discordRpcStrings.ACTIVITY_JOIN_REQUEST = "ACTIVITY_JOIN_REQUEST".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.ACTIVITY_JOIN_REQUEST]
    
    inline def ACTIVITY_SPECTATE: typingsJapgolly.discordRpc.discordRpcStrings.ACTIVITY_SPECTATE = "ACTIVITY_SPECTATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.ACTIVITY_SPECTATE]
    
    inline def CAPTURE_SHORTCUT_CHANGE: typingsJapgolly.discordRpc.discordRpcStrings.CAPTURE_SHORTCUT_CHANGE = "CAPTURE_SHORTCUT_CHANGE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.CAPTURE_SHORTCUT_CHANGE]
    
    inline def CHANNEL_CREATE: typingsJapgolly.discordRpc.discordRpcStrings.CHANNEL_CREATE = "CHANNEL_CREATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.CHANNEL_CREATE]
    
    inline def CURRENT_USER_UPDATE: typingsJapgolly.discordRpc.discordRpcStrings.CURRENT_USER_UPDATE = "CURRENT_USER_UPDATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.CURRENT_USER_UPDATE]
    
    inline def ENTITLEMENT_CREATE: typingsJapgolly.discordRpc.discordRpcStrings.ENTITLEMENT_CREATE = "ENTITLEMENT_CREATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.ENTITLEMENT_CREATE]
    
    inline def ENTITLEMENT_DELETE: typingsJapgolly.discordRpc.discordRpcStrings.ENTITLEMENT_DELETE = "ENTITLEMENT_DELETE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.ENTITLEMENT_DELETE]
    
    inline def ERROR: typingsJapgolly.discordRpc.discordRpcStrings.ERROR = "ERROR".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.ERROR]
    
    inline def GAME_JOIN: typingsJapgolly.discordRpc.discordRpcStrings.GAME_JOIN = "GAME_JOIN".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.GAME_JOIN]
    
    inline def GAME_SPECTATE: typingsJapgolly.discordRpc.discordRpcStrings.GAME_SPECTATE = "GAME_SPECTATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.GAME_SPECTATE]
    
    inline def GUILD_CREATE: typingsJapgolly.discordRpc.discordRpcStrings.GUILD_CREATE = "GUILD_CREATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.GUILD_CREATE]
    
    inline def GUILD_STATUS: typingsJapgolly.discordRpc.discordRpcStrings.GUILD_STATUS = "GUILD_STATUS".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.GUILD_STATUS]
    
    inline def LOBBY_DELETE: typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_DELETE = "LOBBY_DELETE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_DELETE]
    
    inline def LOBBY_MEMBER_CONNECT: typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_MEMBER_CONNECT = "LOBBY_MEMBER_CONNECT".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_MEMBER_CONNECT]
    
    inline def LOBBY_MEMBER_DISCONNECT: typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_MEMBER_DISCONNECT = "LOBBY_MEMBER_DISCONNECT".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_MEMBER_DISCONNECT]
    
    inline def LOBBY_MEMBER_UPDATE: typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_MEMBER_UPDATE = "LOBBY_MEMBER_UPDATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_MEMBER_UPDATE]
    
    inline def LOBBY_MESSAGE: typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_MESSAGE = "LOBBY_MESSAGE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_MESSAGE]
    
    inline def LOBBY_UPDATE: typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_UPDATE = "LOBBY_UPDATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.LOBBY_UPDATE]
    
    inline def MESSAGE_CREATE: typingsJapgolly.discordRpc.discordRpcStrings.MESSAGE_CREATE = "MESSAGE_CREATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.MESSAGE_CREATE]
    
    inline def MESSAGE_DELETE: typingsJapgolly.discordRpc.discordRpcStrings.MESSAGE_DELETE = "MESSAGE_DELETE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.MESSAGE_DELETE]
    
    inline def MESSAGE_UPDATE: typingsJapgolly.discordRpc.discordRpcStrings.MESSAGE_UPDATE = "MESSAGE_UPDATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.MESSAGE_UPDATE]
    
    inline def NOTIFICATION_CREATE: typingsJapgolly.discordRpc.discordRpcStrings.NOTIFICATION_CREATE = "NOTIFICATION_CREATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.NOTIFICATION_CREATE]
    
    inline def OVERLAY: typingsJapgolly.discordRpc.discordRpcStrings.OVERLAY = "OVERLAY".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.OVERLAY]
    
    inline def OVERLAY_UPDATE: typingsJapgolly.discordRpc.discordRpcStrings.OVERLAY_UPDATE = "OVERLAY_UPDATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.OVERLAY_UPDATE]
    
    inline def READY: typingsJapgolly.discordRpc.discordRpcStrings.READY = "READY".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.READY]
    
    inline def RELATIONSHIP_UPDATE: typingsJapgolly.discordRpc.discordRpcStrings.RELATIONSHIP_UPDATE = "RELATIONSHIP_UPDATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.RELATIONSHIP_UPDATE]
    
    inline def SPEAKING_START: typingsJapgolly.discordRpc.discordRpcStrings.SPEAKING_START = "SPEAKING_START".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.SPEAKING_START]
    
    inline def SPEAKING_STOP: typingsJapgolly.discordRpc.discordRpcStrings.SPEAKING_STOP = "SPEAKING_STOP".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.SPEAKING_STOP]
    
    inline def USER_ACHIEVEMENT_UPDATE: typingsJapgolly.discordRpc.discordRpcStrings.USER_ACHIEVEMENT_UPDATE = "USER_ACHIEVEMENT_UPDATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.USER_ACHIEVEMENT_UPDATE]
    
    inline def VOICE_CHANNEL_SELECT: typingsJapgolly.discordRpc.discordRpcStrings.VOICE_CHANNEL_SELECT = "VOICE_CHANNEL_SELECT".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.VOICE_CHANNEL_SELECT]
    
    inline def VOICE_CONNECTION_STATUS: typingsJapgolly.discordRpc.discordRpcStrings.VOICE_CONNECTION_STATUS = "VOICE_CONNECTION_STATUS".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.VOICE_CONNECTION_STATUS]
    
    inline def VOICE_SETTINGS_UPDATE: typingsJapgolly.discordRpc.discordRpcStrings.VOICE_SETTINGS_UPDATE = "VOICE_SETTINGS_UPDATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.VOICE_SETTINGS_UPDATE]
    
    inline def VOICE_SETTINGS_UPDATE_2: typingsJapgolly.discordRpc.discordRpcStrings.VOICE_SETTINGS_UPDATE_2 = "VOICE_SETTINGS_UPDATE_2".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.VOICE_SETTINGS_UPDATE_2]
    
    inline def VOICE_STATE_CREATE: typingsJapgolly.discordRpc.discordRpcStrings.VOICE_STATE_CREATE = "VOICE_STATE_CREATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.VOICE_STATE_CREATE]
    
    inline def VOICE_STATE_DELETE: typingsJapgolly.discordRpc.discordRpcStrings.VOICE_STATE_DELETE = "VOICE_STATE_DELETE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.VOICE_STATE_DELETE]
    
    inline def VOICE_STATE_UPDATE: typingsJapgolly.discordRpc.discordRpcStrings.VOICE_STATE_UPDATE = "VOICE_STATE_UPDATE".asInstanceOf[typingsJapgolly.discordRpc.discordRpcStrings.VOICE_STATE_UPDATE]
  }
  ...
  object Subscription {
    ...
    inline def apply(unsubscribe: CallbackTo[js.Promise[Boolean]]): Subscription = {
    ...
    extension [Self <: Subscription](x: Self) {
      ...
      inline def setUnsubscribe(value: CallbackTo[js.Promise[Boolean]]): Self = StObject.set(x, "unsubscribe", value.toJsFn)
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.discordRpc.discordRpcStrings.ready_
    - typingsJapgolly.discordRpc.discordRpcStrings.connected
    - typingsJapgolly.discordRpc.discordRpcStrings.disconnected
    - java.lang.String
  */
