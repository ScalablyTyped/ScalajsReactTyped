...
import typingsJapgolly.discordRpc.AnonName
import typingsJapgolly.discordRpc.discordRpcStrings.audioinput
import typingsJapgolly.discordRpc.discordRpcStrings.audiooutput
import typingsJapgolly.discordRpc.discordRpcStrings.videoinput
