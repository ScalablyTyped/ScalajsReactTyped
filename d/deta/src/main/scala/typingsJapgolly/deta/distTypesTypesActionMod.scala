...
object distTypesTypesActionMod {
  ...
  object ActionTypes extends StObject {
    ...
    sealed trait Append
      extends StObject
         with ActionTypes
    /* "append" */ val Append: typingsJapgolly.deta.distTypesTypesActionMod.ActionTypes.Append & String = js.native
    
    @js.native
    sealed trait Increment
      extends StObject
         with ActionTypes
    /* "increment" */ val Increment: typingsJapgolly.deta.distTypesTypesActionMod.ActionTypes.Increment & String = js.native
    
    @js.native
    sealed trait Prepend
      extends StObject
         with ActionTypes
    /* "prepend" */ val Prepend: typingsJapgolly.deta.distTypesTypesActionMod.ActionTypes.Prepend & String = js.native
    
    @js.native
    sealed trait Set
      extends StObject
         with ActionTypes
    /* "set" */ val Set: typingsJapgolly.deta.distTypesTypesActionMod.ActionTypes.Set & String = js.native
    
    @js.native
    sealed trait Trim
      extends StObject
         with ActionTypes
    /* "trim" */ val Trim: typingsJapgolly.deta.distTypesTypesActionMod.ActionTypes.Trim & String = js.native
  }
}
