...
object distTypesTypesKeyMod {
  ...
  object KeyType extends StObject {
    ...
    sealed trait AuthToken
      extends StObject
         with KeyType
    /* 0 */ val AuthToken: typingsJapgolly.deta.distTypesTypesKeyMod.KeyType.AuthToken & Double = js.native
    
    @js.native
    sealed trait ProjectKey
      extends StObject
         with KeyType
    /* 1 */ val ProjectKey: typingsJapgolly.deta.distTypesTypesKeyMod.KeyType.ProjectKey & Double = js.native
  }
}
