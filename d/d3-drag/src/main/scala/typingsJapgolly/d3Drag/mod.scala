package typingsJapgolly.d3Drag
...
import typingsJapgolly.d3Drag.d3DragStrings.drag
import typingsJapgolly.d3Drag.d3DragStrings.end
import typingsJapgolly.d3Drag.d3DragStrings.mouse
import typingsJapgolly.d3Drag.d3DragStrings.start
...
object mod {
  ...
  inline def drag[GElement /* <: Element */, Datum](): DragBehavior[GElement, Datum, Datum | SubjectPosition] = ^.asInstanceOf[js.Dynamic].applyDynamic("drag")().asInstanceOf[DragBehavior[GElement, Datum, Datum | SubjectPosition]]
  ...
  inline def drag_GElementDatumSubject[GElement /* <: Element */, Datum, Subject](): DragBehavior[GElement, Datum, Subject] = ^.asInstanceOf[js.Dynamic].applyDynamic("drag")().asInstanceOf[DragBehavior[GElement, Datum, Subject]]
  
  @js.native
  trait D3DragEvent[GElement /* <: Element */, Datum, Subject] extends StObject {
