...
object PlaceholderParser {
  ...
  extension [Self <: PlaceholderParser](x: Self) {
    ...
    inline def setPlaceholderParser(value: (/* index */ Double, /* data */ Percentage) => Callback): Self = StObject.set(x, "placeholderParser", js.Any.fromFunction2((t0: /* index */ Double, t1: /* data */ Percentage) => (value(t0, t1)).runNow()))
