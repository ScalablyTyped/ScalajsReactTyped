package typingsJapgolly.denodeify
...
object mod {
  ...
  inline def apply[A, B, C, D, E, F, G, H, R](fn: F8[A, B, C, D, E, F, G, H, R]): js.Function8[
    ...
    /* h */ H, 
    js.Promise[R]
  ] = ^.asInstanceOf[js.Dynamic].apply(fn.asInstanceOf[js.Any]).asInstanceOf[js.Function8[
    /* a */ A, 
    /* b */ B, 
    /* c */ C, 
    /* d */ D, 
  ...
  inline def apply[A, B, C, D, E, F, G, H, R](fn: F8[A, B, C, D, E, F, G, H, R], transformer: M): js.Function8[
    ...
    /* h */ H, 
    js.Promise[R]
  ] = (^.asInstanceOf[js.Dynamic].apply(fn.asInstanceOf[js.Any], transformer.asInstanceOf[js.Any])).asInstanceOf[js.Function8[
    /* a */ A, 
    /* b */ B, 
    /* c */ C, 
    /* d */ D, 
