...
import typingsJapgolly.docxTemplates.docxTemplatesStrings.errors
import typingsJapgolly.docxTemplates.docxTemplatesStrings.success
import typingsJapgolly.docxTemplates.libProcessTemplateMod.ReportOutput
import typingsJapgolly.docxTemplates.libTypesMod.BufferStatus
...
import typingsJapgolly.sax.mod.QualifiedAttribute
...
object anon {
  ...
  trait Dictkey
    extends StObject
       with /* key */ StringDictionary[typingsJapgolly.docxTemplates.libBundledMod.QualifiedAttribute | String] {
  ...
  trait Htmls
    ...
    var htmls: typingsJapgolly.docxTemplates.libTypesMod.Htmls
  ...
  object Htmls {
    ...
    inline def apply(htmls: typingsJapgolly.docxTemplates.libTypesMod.Htmls, images: Images, links: Links, report: Node): Htmls = {
    ...
    extension [Self <: Htmls](x: Self) {
      ...
      inline def setHtmls(value: typingsJapgolly.docxTemplates.libTypesMod.Htmls): Self = StObject.set(x, "htmls", value.asInstanceOf[js.Any])
