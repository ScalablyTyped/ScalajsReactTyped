...
import typingsJapgolly.docxTemplates.anon.Dictkey
import typingsJapgolly.docxTemplates.anon.ModifiedSandbox
import typingsJapgolly.docxTemplates.docxTemplatesBooleans.`false`
import typingsJapgolly.docxTemplates.docxTemplatesBooleans.`true`
...
object libBundledMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.docxTemplates.docxTemplatesStrings.QUERY
    - typingsJapgolly.docxTemplates.docxTemplatesStrings.CMD_NODE
    - typingsJapgolly.docxTemplates.docxTemplatesStrings.ALIAS
    - typingsJapgolly.docxTemplates.docxTemplatesStrings.FOR
    - typingsJapgolly.docxTemplates.docxTemplatesStrings.`END-FOR`
    - typingsJapgolly.docxTemplates.docxTemplatesStrings.IF
    - typingsJapgolly.docxTemplates.docxTemplatesStrings.`END-IF`
    - typingsJapgolly.docxTemplates.docxTemplatesStrings.INS
    - typingsJapgolly.docxTemplates.docxTemplatesStrings.EXEC
    - typingsJapgolly.docxTemplates.docxTemplatesStrings.IMAGE
    - typingsJapgolly.docxTemplates.docxTemplatesStrings.LINK
    - typingsJapgolly.docxTemplates.docxTemplatesStrings.HTML
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.docxTemplates.libBundledMod.TextNode
    - typingsJapgolly.docxTemplates.libBundledMod.NonTextNode
  */
  trait Node extends StObject
  object Node {
    
    inline def NonTextNode(_attrs: Dictkey, _children: js.Array[Node], _tag: String): typingsJapgolly.docxTemplates.libBundledMod.NonTextNode = {
      ...
      __obj.asInstanceOf[typingsJapgolly.docxTemplates.libBundledMod.NonTextNode]
    }
    
    inline def TextNode(_children: js.Array[Node], _text: String): typingsJapgolly.docxTemplates.libBundledMod.TextNode = {
      val __obj = js.Dynamic.literal(_children = _children.asInstanceOf[js.Any], _fTextNode = true, _text = _text.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.docxTemplates.libBundledMod.TextNode]
    }
  }
