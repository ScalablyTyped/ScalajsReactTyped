...
import typingsJapgolly.dexie.AnonInstantiableTError
...
trait Promise[T] extends js.Object {
  ...
  val toStringTag: typingsJapgolly.dexie.dexieStrings.Promise = js.native
  ...
  /**
    ...
    */
  @JSName("catch")
  def catch_TResult[TResult](errorName: String, onrejected: js.Function1[/* reason */ js.Error, TResult | js.Thenable[TResult]]): Promise[T | TResult] = js.native
  @JSName("catch")
