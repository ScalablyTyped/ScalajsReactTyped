...
import typingsJapgolly.dexie.anon.Name
import typingsJapgolly.dexie.anon.Stack
...
object Dexie extends Shortcut {
  ...
  open class AbortError ()
    extends StObject
       with typingsJapgolly.dexie.mod.DexieError {
  ...
  open class BulkError ()
    extends StObject
       with typingsJapgolly.dexie.mod.BulkError {
    def this(msg: String) = this()
  ...
  open class ModifyError ()
    extends StObject
       with typingsJapgolly.dexie.mod.ModifyError {
    def this(msg: String) = this()
