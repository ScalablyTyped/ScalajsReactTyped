...
import typingsJapgolly.djangoBananas.anon.RequestInterceptor
import typingsJapgolly.djangoBananas.mod.^
...
inline def useAdmin(context: typingsJapgolly.djangoBananas.mod.AdminContext): AdminInterface = ^.asInstanceOf[js.Dynamic].applyDynamic("useAdmin")(context.asInstanceOf[js.Any]).asInstanceOf[AdminInterface]
