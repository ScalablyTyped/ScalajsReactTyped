...
object mod {
  ...
  open class Delaunay[P] protected ()
    extends typingsJapgolly.d3Delaunay.mod.Delaunay[P] {
    /**
  ...
  open class FormatSpecifier_ protected ()
    extends typingsJapgolly.d3Format.mod.FormatSpecifier_ {
    /**
  ...
  open class Voronoi[P] ()
    extends typingsJapgolly.d3Delaunay.mod.Voronoi[P]
  
  @JSImport("d3", "ZoomTransform")
  @js.native
  open class ZoomTransform_ protected ()
    extends typingsJapgolly.d3Zoom.mod.ZoomTransform_ {
    /**
