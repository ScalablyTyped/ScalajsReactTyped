...
import typingsJapgolly.dayzed.anon.OmitPropschildrenrender
import typingsJapgolly.dayzed.dayzedInts.`0`
import typingsJapgolly.dayzed.dayzedInts.`10`
import typingsJapgolly.dayzed.dayzedInts.`11`
...
import typingsJapgolly.dayzed.dayzedInts.`7`
import typingsJapgolly.dayzed.dayzedInts.`8`
import typingsJapgolly.dayzed.dayzedInts.`9`
...
object mod {
  ...
  trait Props extends StObject {
    ...
    def onDateSelected(selectedDate: DateObj, event: ReactEventFrom[org.scalajs.dom.Element]): Unit
  ...
  object Props {
    ...
    inline def apply(onDateSelected: (DateObj, ReactEventFrom[org.scalajs.dom.Element]) => Callback): Props = {
      val __obj = js.Dynamic.literal(onDateSelected = js.Any.fromFunction2((t0: DateObj, t1: ReactEventFrom[org.scalajs.dom.Element]) => (onDateSelected(t0, t1)).runNow()))
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setOnDateSelected(value: (DateObj, ReactEventFrom[org.scalajs.dom.Element]) => Callback): Self = StObject.set(x, "onDateSelected", js.Any.fromFunction2((t0: DateObj, t1: ReactEventFrom[org.scalajs.dom.Element]) => (value(t0, t1)).runNow()))
      ...
      inline def setRender(value: /* renderProps */ RenderProps => Node): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
  ...
  type RenderFn = js.Function1[/* renderProps */ RenderProps, Node]
