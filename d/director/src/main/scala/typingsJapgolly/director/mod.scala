package typingsJapgolly.director

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.director.anon.Allow
import typingsJapgolly.director.anon.Method
import typingsJapgolly.director.anon.Only
import typingsJapgolly.director.anon.RemoveContentHeaders
import typingsJapgolly.director.directorBooleans.`false`
import typingsJapgolly.director.directorInts.`304`
import typingsJapgolly.director.directorInts.`400`
import typingsJapgolly.director.directorInts.`401`
import typingsJapgolly.director.directorInts.`403`
import typingsJapgolly.director.directorInts.`404`
import typingsJapgolly.director.directorInts.`405`
import typingsJapgolly.director.directorInts.`406`
import typingsJapgolly.director.directorInts.`501`
import typingsJapgolly.director.directorStrings.`method not allowedDot`
import typingsJapgolly.director.directorStrings.backward
import typingsJapgolly.director.directorStrings.forward
...
object mod {
  ...
  object http {
    ...
    open class BadRequest ()
      ...
      var body: typingsJapgolly.director.anon.Error = js.native
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.director.directorStrings.options
      - typingsJapgolly.director.directorStrings.get
      - typingsJapgolly.director.directorStrings.post
      - typingsJapgolly.director.directorStrings.put
      - typingsJapgolly.director.directorStrings.delete
      - typingsJapgolly.director.directorStrings.trace
      - typingsJapgolly.director.directorStrings.connect
      - typingsJapgolly.director.directorStrings.propfind
      - typingsJapgolly.director.directorStrings.proppatch
      - typingsJapgolly.director.directorStrings.mkcol
      - typingsJapgolly.director.directorStrings.copy
      - typingsJapgolly.director.directorStrings.move
      - typingsJapgolly.director.directorStrings.lock
      - typingsJapgolly.director.directorStrings.unlock
      - typingsJapgolly.director.directorStrings.`version-control`
      - typingsJapgolly.director.directorStrings.report
      - typingsJapgolly.director.directorStrings.checkout
      - typingsJapgolly.director.directorStrings.checkin
      - typingsJapgolly.director.directorStrings.uncheckout
      - typingsJapgolly.director.directorStrings.mkworkspace
      - typingsJapgolly.director.directorStrings.update
      - typingsJapgolly.director.directorStrings.label
      - typingsJapgolly.director.directorStrings.merge
      - typingsJapgolly.director.directorStrings.`baseline-control`
      - typingsJapgolly.director.directorStrings.mkactivity
      - typingsJapgolly.director.directorStrings.orderpatch
      - typingsJapgolly.director.directorStrings.acl
      - typingsJapgolly.director.directorStrings.search
      - typingsJapgolly.director.directorStrings.patch
      - typingsJapgolly.director.directorStrings.before
      - typingsJapgolly.director.directorStrings.after
    */
