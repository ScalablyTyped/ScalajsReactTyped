...
object mod {
  ...
  object Queue_ {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(abort = abort.toJsFn, await = js.Any.fromFunction1(await), awaitAll = js.Any.fromFunction1(awaitAll), defer = js.Any.fromFunction2(defer))
      __obj.asInstanceOf[Queue_]
    }
    
    extension [Self <: Queue_](x: Self) {
      
      inline def setAbort(value: CallbackTo[Queue_]): Self = StObject.set(x, "abort", value.toJsFn)
