package typingsJapgolly.daumPostcode

import japgolly.scalajs.react.Callback
import org.scalajs.dom.HTMLElement
import typingsJapgolly.daumPostcode.daumPostcodeInts.`0`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`10`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`11`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`12`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`13`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`14`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`15`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`16`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`17`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`18`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`19`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`1`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`20`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`2`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`3`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`4`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`5`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`6`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`7`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`8`
import typingsJapgolly.daumPostcode.daumPostcodeInts.`9`
import typingsJapgolly.daumPostcode.daumPostcodeStrings.E
import typingsJapgolly.daumPostcode.daumPostcodeStrings.J
import typingsJapgolly.daumPostcode.daumPostcodeStrings.K
import typingsJapgolly.daumPostcode.daumPostcodeStrings.N
import typingsJapgolly.daumPostcode.daumPostcodeStrings.R
import typingsJapgolly.daumPostcode.daumPostcodeStrings.Y
import typingsJapgolly.daumPostcode.daumPostcodeStrings._empty
...
object daum {
  ...
  object PostcodeOptions {
    ...
    extension [Self <: PostcodeOptions](x: Self) {
      ...
      inline def setOnclose(value: /* state */ PostcodeState => Callback): Self = StObject.set(x, "onclose", js.Any.fromFunction1((t0: /* state */ PostcodeState) => value(t0).runNow()))
      
      inline def setOncloseUndefined: Self = StObject.set(x, "onclose", js.undefined)
      
      inline def setOncomplete(value: /* data */ PostcodeData => Callback): Self = StObject.set(x, "oncomplete", js.Any.fromFunction1((t0: /* data */ PostcodeData) => value(t0).runNow()))
      
      inline def setOncompleteUndefined: Self = StObject.set(x, "oncomplete", js.undefined)
      
      inline def setOnresize(value: /* size */ PostcodeSize => Callback): Self = StObject.set(x, "onresize", js.Any.fromFunction1((t0: /* size */ PostcodeSize) => value(t0).runNow()))
      
      inline def setOnresizeUndefined: Self = StObject.set(x, "onresize", js.undefined)
      
      inline def setOnsearch(value: /* data */ PostcodeSearchData => Callback): Self = StObject.set(x, "onsearch", js.Any.fromFunction1((t0: /* data */ PostcodeSearchData) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.daumPostcode.daumPostcodeStrings.COMPLETE_CLOSE
    - typingsJapgolly.daumPostcode.daumPostcodeStrings.FORCE_CLOSE
  */
  trait PostcodeState extends StObject
  object PostcodeState {
    
    inline def COMPLETE_CLOSE: typingsJapgolly.daumPostcode.daumPostcodeStrings.COMPLETE_CLOSE = "COMPLETE_CLOSE".asInstanceOf[typingsJapgolly.daumPostcode.daumPostcodeStrings.COMPLETE_CLOSE]
    
    inline def FORCE_CLOSE: typingsJapgolly.daumPostcode.daumPostcodeStrings.FORCE_CLOSE = "FORCE_CLOSE".asInstanceOf[typingsJapgolly.daumPostcode.daumPostcodeStrings.FORCE_CLOSE]
  }
