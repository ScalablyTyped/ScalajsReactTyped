...
import typingsJapgolly.ddTrace.ddTraceStrings.agent
import typingsJapgolly.ddTrace.ddTraceStrings.log
import typingsJapgolly.ddTrace.mod.TransportRequestParams
import typingsJapgolly.ddTrace.mod.anyObject
import typingsJapgolly.ddTrace.mod.plugins.ExecutionArgs
...
object anon {
  ...
  trait Execute extends StObject {
    ...
    var execute: js.UndefOr[
        js.Function3[
          /* span */ js.UndefOr[typingsJapgolly.ddTrace.mod.Span], 
  ...
  object Execute {
    ...
    extension [Self <: Execute](x: Self) {
      ...
      inline def setExecute(
        value: (/* span */ js.UndefOr[typingsJapgolly.ddTrace.mod.Span], /* args */ js.UndefOr[ExecutionArgs], /* res */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "execute", js.Any.fromFunction3((t0: /* span */ js.UndefOr[typingsJapgolly.ddTrace.mod.Span], t1: /* args */ js.UndefOr[ExecutionArgs], t2: /* res */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
      
      inline def setExecuteUndefined: Self = StObject.set(x, "execute", js.undefined)
      
      inline def setParse(
        value: (/* span */ js.UndefOr[typingsJapgolly.ddTrace.mod.Span], /* source */ js.UndefOr[Any], /* document */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "parse", js.Any.fromFunction3((t0: /* span */ js.UndefOr[typingsJapgolly.ddTrace.mod.Span], t1: /* source */ js.UndefOr[Any], t2: /* document */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
      
      inline def setParseUndefined: Self = StObject.set(x, "parse", js.undefined)
      
      inline def setValidate(
        value: (/* span */ js.UndefOr[typingsJapgolly.ddTrace.mod.Span], /* document */ js.UndefOr[Any], /* errors */ js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "validate", js.Any.fromFunction3((t0: /* span */ js.UndefOr[typingsJapgolly.ddTrace.mod.Span], t1: /* document */ js.UndefOr[Any], t2: /* errors */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
