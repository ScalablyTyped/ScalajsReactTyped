...
object JsonOptions {
  ...
  def apply(
    ...
    stringifyReplacer: (/* key */ String, /* value */ js.Any) => CallbackTo[js.Any] = null,
    ...
    if (stringifyReplacer != null) __obj.updateDynamic("stringifyReplacer")(js.Any.fromFunction2((t0: /* key */ java.lang.String, t1: /* value */ js.Any) => stringifyReplacer(t0, t1).runNow()))
