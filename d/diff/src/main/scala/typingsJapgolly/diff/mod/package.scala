...
import typingsJapgolly.diff.anon.Strict
import typingsJapgolly.diff.diffInts.`-1`
import typingsJapgolly.diff.diffInts.`0`
import typingsJapgolly.diff.diffInts.`1`
import typingsJapgolly.diff.mod.^
...
type Callback = js.Function2[/* err */ Unit, /* value */ js.UndefOr[js.Array[Change]], Unit]
