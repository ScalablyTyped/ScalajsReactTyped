...
import typingsJapgolly.diff.diffInts.`1`
import typingsJapgolly.diff.mod.ApplyPatchOptions
import typingsJapgolly.diff.mod.ApplyPatchesOptions
import typingsJapgolly.diff.mod.ArrayChange
import typingsJapgolly.diff.mod.ArrayOptions
import typingsJapgolly.diff.mod.BaseOptions
import typingsJapgolly.diff.mod.Callback
import typingsJapgolly.diff.mod.CallbackOptions
import typingsJapgolly.diff.mod.Change
import typingsJapgolly.diff.mod.JsonOptions
import typingsJapgolly.diff.mod.LinesOptions
import typingsJapgolly.diff.mod.ParsedDiff
import typingsJapgolly.diff.mod.PatchOptions
import typingsJapgolly.diff.mod.WordsOptions
...
object global {
  ...
  object Diff {
    ...
    @js.native
    open class Diff ()
      extends typingsJapgolly.diff.mod.Diff
