...
import typingsJapgolly.d3Fetch.d3FetchStrings.a
import typingsJapgolly.d3Fetch.d3FetchStrings.async
import typingsJapgolly.d3Fetch.d3FetchStrings.auto
import typingsJapgolly.d3Fetch.d3FetchStrings.fullscreenchange
import typingsJapgolly.d3Fetch.d3FetchStrings.httpColonSlashSlashwwwDotw3DotorgSlash1999Slashxhtml
import typingsJapgolly.d3Fetch.d3FetchStrings.sync
...
object PartialHTMLImageElement {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PartialHTMLImageElement, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PartialHTMLImageElement, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    if (addEventListener != null) __obj.updateDynamic("addEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.d3Fetch.d3FetchStrings.fullscreenchange, t1: /* listener */ js.ThisFunction1[
  typingsJapgolly.d3Fetch.PartialHTMLImageElement, 
  ...
  js.Any]) => addEventListener(t0, t1).runNow()))
    ...
    if (closest != null) __obj.updateDynamic("closest")(js.Any.fromFunction1((t0: typingsJapgolly.d3Fetch.d3FetchStrings.a) => closest(t0).runNow()))
    ...
    if (getElementsByTagName != null) __obj.updateDynamic("getElementsByTagName")(js.Any.fromFunction1((t0: typingsJapgolly.d3Fetch.d3FetchStrings.a) => getElementsByTagName(t0).runNow()))
    if (getElementsByTagNameNS != null) __obj.updateDynamic("getElementsByTagNameNS")(js.Any.fromFunction2((t0: typingsJapgolly.d3Fetch.d3FetchStrings.httpColonSlashSlashwwwDotw3DotorgSlash1999Slashxhtml, t1: /* localName */ java.lang.String) => getElementsByTagNameNS(t0, t1).runNow()))
    ...
    if (querySelector != null) __obj.updateDynamic("querySelector")(js.Any.fromFunction1((t0: typingsJapgolly.d3Fetch.d3FetchStrings.a) => querySelector(t0).runNow()))
    if (querySelectorAll != null) __obj.updateDynamic("querySelectorAll")(js.Any.fromFunction1((t0: typingsJapgolly.d3Fetch.d3FetchStrings.a) => querySelectorAll(t0).runNow()))
    ...
    if (removeEventListener != null) __obj.updateDynamic("removeEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.d3Fetch.d3FetchStrings.fullscreenchange, t1: /* listener */ js.ThisFunction1[
  typingsJapgolly.d3Fetch.PartialHTMLImageElement, 
  /* ev */ typingsJapgolly.std.Event_, 
