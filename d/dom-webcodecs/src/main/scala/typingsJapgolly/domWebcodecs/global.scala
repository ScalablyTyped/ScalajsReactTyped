...
object global {
  ...
  open class AudioData protected ()
    extends StObject
       with typingsJapgolly.domWebcodecs.AudioData {
  ...
  open class AudioDecoder protected ()
    extends StObject
       with typingsJapgolly.domWebcodecs.AudioDecoder {
    ...
    /* CompleteClass */
    override def decode(chunk: typingsJapgolly.domWebcodecs.EncodedAudioChunk): Unit = js.native
  ...
  open class AudioEncoder protected ()
    extends StObject
       with typingsJapgolly.domWebcodecs.AudioEncoder {
    ...
    /* CompleteClass */
    override def encode(data: typingsJapgolly.domWebcodecs.AudioData): Unit = js.native
  ...
  open class EncodedAudioChunk protected ()
    extends StObject
       with typingsJapgolly.domWebcodecs.EncodedAudioChunk {
  ...
  open class EncodedVideoChunk protected ()
    extends StObject
       with typingsJapgolly.domWebcodecs.EncodedVideoChunk {
  ...
  open class ImageDecoder protected ()
    extends StObject
       with typingsJapgolly.domWebcodecs.ImageDecoder {
  ...
  open class ImageTrack ()
    extends StObject
       with typingsJapgolly.domWebcodecs.ImageTrack {
  ...
  open class ImageTrackList ()
    extends StObject
       with typingsJapgolly.domWebcodecs.ImageTrackList {
    ...
    /* CompleteClass */
    override val selectedTrack: typingsJapgolly.domWebcodecs.ImageTrack | Null = js.native
  }
  ...
  open class VideoColorSpace ()
    extends StObject
       with typingsJapgolly.domWebcodecs.VideoColorSpace {
  ...
  open class VideoDecoder protected ()
    extends StObject
       with typingsJapgolly.domWebcodecs.VideoDecoder {
    ...
    /* CompleteClass */
    override def decode(chunk: typingsJapgolly.domWebcodecs.EncodedVideoChunk): Unit = js.native
  ...
  open class VideoEncoder protected ()
    extends StObject
       with typingsJapgolly.domWebcodecs.VideoEncoder {
  ...
  open class VideoFrame protected ()
    extends StObject
       with typingsJapgolly.domWebcodecs.VideoFrame {
