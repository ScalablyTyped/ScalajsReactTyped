...
object AudioDecoderInit {
  ...
  inline def apply(error: /* error */ DOMException => Callback, output: /* output */ AudioData => Callback): AudioDecoderInit = {
    val __obj = js.Dynamic.literal(error = js.Any.fromFunction1((t0: /* error */ DOMException) => error(t0).runNow()), output = js.Any.fromFunction1((t0: /* output */ AudioData) => output(t0).runNow()))
  ...
  extension [Self <: AudioDecoderInit](x: Self) {
    ...
    inline def setOutput(value: /* output */ AudioData => Callback): Self = StObject.set(x, "output", js.Any.fromFunction1((t0: /* output */ AudioData) => value(t0).runNow()))
  }
}
