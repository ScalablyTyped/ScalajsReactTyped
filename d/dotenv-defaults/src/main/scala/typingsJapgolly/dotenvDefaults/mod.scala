package typingsJapgolly.dotenvDefaults

import typingsJapgolly.dotenv.mod.DotenvConfigOptions
import typingsJapgolly.dotenv.mod.DotenvConfigOutput
import typingsJapgolly.dotenv.mod.DotenvParseOutput
...
object mod {
  ...
  object dotenvAugmentingMod {
    ...
    object DotenvConfigOptions {
      ...
      inline def apply(): typingsJapgolly.dotenvDefaults.mod.dotenvAugmentingMod.DotenvConfigOptions = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.dotenvDefaults.mod.dotenvAugmentingMod.DotenvConfigOptions]
      }
      
      extension [Self <: typingsJapgolly.dotenvDefaults.mod.dotenvAugmentingMod.DotenvConfigOptions](x: Self) {
