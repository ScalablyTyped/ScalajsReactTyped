package typingsJapgolly.d3DashBrush

import org.scalajs.dom.raw.SVGGElement
import typingsJapgolly.d3DashBrush.d3DashBrushMod.BrushBehavior
import typingsJapgolly.d3DashBrush.d3DashBrushMod.BrushSelection
import typingsJapgolly.d3DashBrush.d3DashBrushStrings.brush
import typingsJapgolly.d3DashBrush.d3DashBrushStrings.end
import typingsJapgolly.d3DashBrush.d3DashBrushStrings.start
import typingsJapgolly.d3DashSelection.d3DashSelectionMod.Selection
import typingsJapgolly.d3DashSelection.d3DashSelectionMod.TransitionLike
import typingsJapgolly.d3DashSelection.d3DashSelectionMod.ValueFn
...
object d3DashBrushMod extends js.Object {
  ...
  trait BrushBehavior[Datum] extends js.Object {
    ...
    def extent(
      extent: ValueFn[
          typingsJapgolly.std.SVGGElement, 
          Datum, 
    ...
    /**
      ...
      */
    def filter(filterFn: ValueFn[typingsJapgolly.std.SVGGElement, Datum, Boolean]): this.type = js.native
    /**
    ...
    /**
      ...
      */
    def move(group: Selection[typingsJapgolly.std.SVGGElement, Datum, _, _]): Unit = js.native
    /**
      ...
      */
    def move(group: Selection[typingsJapgolly.std.SVGGElement, Datum, _, _], selection: BrushSelection): Unit = js.native
    /**
      * Sets the active selection of the brush on the specified SVG G element(s) selection
      ...
      */
    def move(
      group: Selection[typingsJapgolly.std.SVGGElement, Datum, _, _],
      selection: ValueFn[typingsJapgolly.std.SVGGElement, Datum, BrushSelection]
    ): Unit = js.native
    /**
      ...
      * for a y-brush, it must be defined as [y0, y1].
      */
    def move(group: TransitionLike[typingsJapgolly.std.SVGGElement, Datum], selection: BrushSelection): Unit = js.native
    /**
      * Sets the active selection of the brush on the specified SVG G element(s) transition
      ...
      */
    def move(
      group: TransitionLike[typingsJapgolly.std.SVGGElement, Datum],
      selection: ValueFn[typingsJapgolly.std.SVGGElement, Datum, BrushSelection]
    ): Unit = js.native
    /**
    ...
    /**
      ...
      */
    def on(typenames: String, listener: ValueFn[typingsJapgolly.std.SVGGElement, Datum, Unit]): this.type = js.native
    /**
