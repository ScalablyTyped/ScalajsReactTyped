...
object mod extends Shortcut {
  ...
  trait ProgressProps extends StObject {
    ...
    var onViewport: js.UndefOr[js.Function1[/* element */ Element, Unit | Null]] = js.undefined
  ...
  object ProgressProps {
    ...
    extension [Self <: ProgressProps](x: Self) {
      ...
      inline def setOnViewport(value: /* element */ Element => Unit | Null): Self = StObject.set(x, "onViewport", js.Any.fromFunction1(value))
