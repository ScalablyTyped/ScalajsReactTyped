...
object global {
  ...
  object preciseDiff {
    ...
    @JSGlobal("preciseDiff")
    @js.native
    val ^ : js.Any = js.native
    
    @JSGlobal("preciseDiff.Dayjs")
    @js.native
    open class Dayjs ()
      extends typingsJapgolly.dayjsPreciseRange.mod.Dayjs {
    ...
    object dayjsMod {
      ...
      ): typingsJapgolly.dayjsPreciseRange.mod.dayjsAugmentingMod.PreciseRangeValueObject = (^.asInstanceOf[js.Dynamic].applyDynamic("preciseDiff")(d1.asInstanceOf[js.Any], d2.asInstanceOf[js.Any], returnValueObject.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.dayjsPreciseRange.mod.dayjsAugmentingMod.PreciseRangeValueObject]
      ...
      trait Dayjs extends StObject {
        ...
        @JSName("preciseDiff")
        def preciseDiff_true(d2: typingsJapgolly.dayjsPreciseRange.mod.dayjsAugmentingMod.Dayjs, returnValueObject: `true`): typingsJapgolly.dayjsPreciseRange.mod.dayjsAugmentingMod.PreciseRangeValueObject = js.native
      }
