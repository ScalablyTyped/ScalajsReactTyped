...
object Options {
  ...
  extension [Self <: Options](x: Self) {
    ...
    inline def setOnGotoSubmit(value: CallbackTo[Any]): Self = StObject.set(x, "onGotoSubmit", value.toJsFn)
    
    inline def setPageAliasFunction(value: CallbackTo[Any]): Self = StObject.set(x, "pageAliasFunction", value.toJsFn)
