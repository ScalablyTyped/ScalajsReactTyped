...
import typingsJapgolly.divaJs.handlersMod.ViewHandler
import typingsJapgolly.divaJs.imageManifestMod.default
...
object Settings {
  ...
  inline def apply(
    ...
    oldZoomLevel: Double,
    onGotoSubmit: CallbackTo[Any],
    options: Options,
    outerElement: HTMLElement,
    outerObject: HTMLElement,
    pageAliasFunction: CallbackTo[Any],
    ...
    renderer: typingsJapgolly.divaJs.rendererMod.default,
    resizeTimer: Double,
    ...
    viewport: typingsJapgolly.divaJs.viewportMod.default,
