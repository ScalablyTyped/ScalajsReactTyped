...
trait SourceProvider extends StObject {
  ...
  var titles: js.Array[typingsJapgolly.divaJs.anon.Dimensions]
...
object SourceProvider {
  ...
  inline def apply(
    cols: Double,
    rows: Double,
    titles: js.Array[typingsJapgolly.divaJs.anon.Dimensions],
    zoomLevel: Double
  ): SourceProvider = {
  ...
  extension [Self <: SourceProvider](x: Self) {
    ...
    inline def setTitles(value: js.Array[typingsJapgolly.divaJs.anon.Dimensions]): Self = StObject.set(x, "titles", value.asInstanceOf[js.Any])
    
    inline def setTitlesVarargs(value: typingsJapgolly.divaJs.anon.Dimensions*): Self = StObject.set(x, "titles", js.Array(value*))
