...
trait ViewerState extends StObject {
  ...
  var renderer: typingsJapgolly.divaJs.rendererMod.default
  ...
  var viewport: typingsJapgolly.divaJs.viewportMod.default
...
object ViewerState {
  ...
  extension [Self <: ViewerState](x: Self) {
    ...
    inline def setRenderer(value: typingsJapgolly.divaJs.rendererMod.default): Self = StObject.set(x, "renderer", value.asInstanceOf[js.Any])
    ...
    inline def setViewport(value: typingsJapgolly.divaJs.viewportMod.default): Self = StObject.set(x, "viewport", value.asInstanceOf[js.Any])
