...
import typingsJapgolly.divaJs.anon.Height
import typingsJapgolly.divaJs.anon.IncludePadding
import typingsJapgolly.divaJs.anon.Left
import typingsJapgolly.divaJs.anon.PartialOptionsobjectDatas
...
object mod {
  ...
  object DivaState {
    ...
    inline def apply(toolbar: Null, viewerCore: typingsJapgolly.divaJs.viewerCoreMod.default): DivaState = {
    ...
    extension [Self <: DivaState](x: Self) {
      ...
      inline def setViewerCore(value: typingsJapgolly.divaJs.viewerCoreMod.default): Self = StObject.set(x, "viewerCore", value.asInstanceOf[js.Any])
    }
  }
}
