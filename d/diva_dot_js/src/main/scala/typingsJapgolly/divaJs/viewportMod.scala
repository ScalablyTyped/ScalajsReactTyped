...
import typingsJapgolly.divaJs.anon.IntersectionTolerance
...
object viewportMod {
  ...
  object Viewport {
    ...
    extension [Self <: Viewport](x: Self) {
      ...
      inline def setSetInnerDimensions(value: Dimensions => Callback): Self = StObject.set(x, "setInnerDimensions", js.Any.fromFunction1((t0: Dimensions) => value(t0).runNow()))
