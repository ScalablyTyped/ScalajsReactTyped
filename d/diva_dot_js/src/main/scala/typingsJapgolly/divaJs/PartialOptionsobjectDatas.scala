...
object PartialOptionsobjectDatas {
  ...
  def apply(
    ...
    onGotoSubmit: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    pageAliasFunction: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    onGotoSubmit.foreach(p => __obj.updateDynamic("onGotoSubmit")(p.toJsFn))
    pageAliasFunction.foreach(p => __obj.updateDynamic("pageAliasFunction")(p.toJsFn))
