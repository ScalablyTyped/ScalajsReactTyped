...
trait GanttStatic extends js.Object {
  ...
  /**
  	...
  	*/
  def event(node: typingsJapgolly.std.HTMLElement, event: String, handler: GanttCallback): Unit = js.native
  def event(node: typingsJapgolly.std.HTMLElement, event: String, handler: GanttCallback, options: js.Any): Unit = js.native
  ...
  /**
  	...
  	*/
  def eventRemove(node: typingsJapgolly.std.HTMLElement, event: String, handler: GanttCallback): Unit = js.native
  def eventRemove(node: typingsJapgolly.std.HTMLElement, event: String, handler: GanttCallback, options: js.Any): Unit = js.native
  /**
  ...
  def init(container: typingsJapgolly.std.HTMLElement): Unit = js.native
  def init(container: typingsJapgolly.std.HTMLElement, from: js.Date): Unit = js.native
  def init(container: typingsJapgolly.std.HTMLElement, from: js.Date, to: js.Date): Unit = js.native
  /**
