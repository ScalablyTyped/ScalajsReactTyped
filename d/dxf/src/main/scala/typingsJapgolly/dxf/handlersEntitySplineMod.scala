...
object handlersEntitySplineMod {
  ...
  object SplineTypeFlag extends StObject {
    ...
    sealed trait CLOSED
      extends StObject
         with SplineTypeFlag
    /* 1 */ val CLOSED: typingsJapgolly.dxf.handlersEntitySplineMod.SplineTypeFlag.CLOSED & Double = js.native
    
    @js.native
    sealed trait LINEAR
      extends StObject
         with SplineTypeFlag
    /* 16 */ val LINEAR: typingsJapgolly.dxf.handlersEntitySplineMod.SplineTypeFlag.LINEAR & Double = js.native
    
    @js.native
    sealed trait PERIODIC
      extends StObject
         with SplineTypeFlag
    /* 2 */ val PERIODIC: typingsJapgolly.dxf.handlersEntitySplineMod.SplineTypeFlag.PERIODIC & Double = js.native
    
    @js.native
    sealed trait PLANAR
      extends StObject
         with SplineTypeFlag
    /* 8 */ val PLANAR: typingsJapgolly.dxf.handlersEntitySplineMod.SplineTypeFlag.PLANAR & Double = js.native
    
    @js.native
    sealed trait RATIONAL
      extends StObject
         with SplineTypeFlag
    /* 4 */ val RATIONAL: typingsJapgolly.dxf.handlersEntitySplineMod.SplineTypeFlag.RATIONAL & Double = js.native
  }
