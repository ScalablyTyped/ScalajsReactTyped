package typingsJapgolly.detectPort
...
object mod extends Shortcut {
  ...
  object PortConfig {
    ...
    extension [Self <: PortConfig](x: Self) {
      ...
      inline def setCallback(value: (/* err */ js.Error, /* _port */ Double) => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* err */ js.Error, t1: /* _port */ Double) => (value(t0, t1)).runNow()))
