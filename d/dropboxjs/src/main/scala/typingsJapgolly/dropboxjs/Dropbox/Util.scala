...
import typingsJapgolly.dropboxjs.AnonCancelable
...
object Util extends js.Object {
  ...
  class Xhr protected () extends js.Object {
    ...
    def setFileField(fieldName: String, fileName: String, fileData: typingsJapgolly.std.File): Unit = js.native
    def setFileField(fieldName: String, fileName: String, fileData: typingsJapgolly.std.File, contentType: String): Unit = js.native
