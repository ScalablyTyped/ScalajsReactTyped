...
object File {
  ...
  object CopyReference {
    ...
    inline def apply(expiresAt: js.Date, tag: String, toJSON: CallbackTo[js.Object]): CopyReference = {
      val __obj = js.Dynamic.literal(expiresAt = expiresAt.asInstanceOf[js.Any], tag = tag.asInstanceOf[js.Any], toJSON = toJSON.toJsFn)
  ...
  object ShareUrl {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(expiresAt = expiresAt.asInstanceOf[js.Any], isDirect = isDirect.asInstanceOf[js.Any], isPreview = isPreview.asInstanceOf[js.Any], toJSON = toJSON.toJsFn, url = url.asInstanceOf[js.Any])
