...
object global {
  ...
  object Dropzone {
    ...
    open class ^ protected ()
      extends typingsJapgolly.dropzone.mod.^ {
    ...
    /* static member */
    inline def discover(): js.Array[typingsJapgolly.dropzone.mod.Dropzone] = ^.asInstanceOf[js.Dynamic].applyDynamic("discover")().asInstanceOf[js.Array[typingsJapgolly.dropzone.mod.Dropzone]]
    ...
    /* static member */
    inline def forElement(element: String): typingsJapgolly.dropzone.mod.Dropzone = ^.asInstanceOf[js.Dynamic].applyDynamic("forElement")(element.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.dropzone.mod.Dropzone]
    inline def forElement(element: HTMLElement): typingsJapgolly.dropzone.mod.Dropzone = ^.asInstanceOf[js.Dynamic].applyDynamic("forElement")(element.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.dropzone.mod.Dropzone]
    ...
    @js.native
    def instances: js.Array[typingsJapgolly.dropzone.mod.Dropzone] = js.native
    inline def instances_=(x: js.Array[typingsJapgolly.dropzone.mod.Dropzone]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("instances")(x.asInstanceOf[js.Any])
