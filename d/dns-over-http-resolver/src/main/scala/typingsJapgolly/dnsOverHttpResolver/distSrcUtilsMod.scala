package typingsJapgolly.dnsOverHttpResolver
...
object distSrcUtilsMod {
  ...
  trait DNSJSON extends StObject {
    ...
    var Answer: js.Array[typingsJapgolly.dnsOverHttpResolver.distSrcUtilsMod.Answer]
    
    var Question: js.Array[typingsJapgolly.dnsOverHttpResolver.distSrcUtilsMod.Question]
  }
  object DNSJSON {
