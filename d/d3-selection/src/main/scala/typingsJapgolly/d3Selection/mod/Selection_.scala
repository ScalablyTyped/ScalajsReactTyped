...
import typingsJapgolly.d3Selection.d3SelectionStrings.important
...
trait Selection_[GElement /* <: BaseType */, Datum, PElement /* <: BaseType */, PDatum] extends js.Object {
  ...
  /**
    ...
    */
  @JSName("datum")
  def datum_Selection_(): Selection_[GElement, js.UndefOr[scala.Nothing], PElement, PDatum] = js.native
  /**
