...
object mod {
  ...
  inline def create[K /* <: /* keyof d3-selection.anon.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 170, starting with typingsJapgolly.d3Selection.d3SelectionStrings.a, typingsJapgolly.d3Selection.d3SelectionStrings.abbr, typingsJapgolly.d3Selection.d3SelectionStrings.address */ Any */](name: K): Selection_[
  ...
  inline def creator[K /* <: /* keyof d3-selection.anon.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 170, starting with typingsJapgolly.d3Selection.d3SelectionStrings.a, typingsJapgolly.d3Selection.d3SelectionStrings.abbr, typingsJapgolly.d3Selection.d3SelectionStrings.address */ Any */](name: K): js.ThisFunction0[
    /* this */ BaseType, 
    /* import warning: importer.ImportType#apply Failed type conversion: d3-selection.anon.ElementTagNameMap[K] */ js.Any
  ...
  trait EnterElement extends StObject {
    ...
    def querySelectorAll(selectors: String): NodeList[Element & Node]
  }
  object EnterElement {
    ...
    inline def apply(
      ...
      querySelectorAll: String => NodeList[Element & Node]
    ): EnterElement = {
    ...
    extension [Self <: EnterElement](x: Self) {
      ...
      inline def setQuerySelectorAll(value: String => NodeList[Element & Node]): Self = StObject.set(x, "querySelectorAll", js.Any.fromFunction1(value))
    }
  }
  ...
  trait Selection_[GElement /* <: BaseType */, Datum, PElement /* <: BaseType */, PDatum] extends StObject {
    ...
    /**
      ...
      */
    def append[K /* <: /* keyof d3-selection.anon.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 170, starting with typingsJapgolly.d3Selection.d3SelectionStrings.a, typingsJapgolly.d3Selection.d3SelectionStrings.abbr, typingsJapgolly.d3Selection.d3SelectionStrings.address */ Any */](`type`: K): Selection_[
        /* import warning: importer.ImportType#apply Failed type conversion: d3-selection.anon.ElementTagNameMap[K] */ js.Any, 
        Datum, 
        PElement, 
        PDatum
    ...
    /**
      ...
      */
    def insert[K /* <: /* keyof d3-selection.anon.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 170, starting with typingsJapgolly.d3Selection.d3SelectionStrings.a, typingsJapgolly.d3Selection.d3SelectionStrings.abbr, typingsJapgolly.d3Selection.d3SelectionStrings.address */ Any */](`type`: K): Selection_[
        /* import warning: importer.ImportType#apply Failed type conversion: d3-selection.anon.ElementTagNameMap[K] */ js.Any, 
        Datum, 
        PElement, 
        PDatum
    ...
    /**
      ...
      */
    def join[K /* <: /* keyof d3-selection.anon.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 170, starting with typingsJapgolly.d3Selection.d3SelectionStrings.a, typingsJapgolly.d3Selection.d3SelectionStrings.abbr, typingsJapgolly.d3Selection.d3SelectionStrings.address */ Any */, OldDatum](enter: K): Selection_[
        GElement | (/* import warning: importer.ImportType#apply Failed type conversion: d3-selection.anon.ElementTagNameMap[K] */ js.Any), 
        Datum, 
        PElement, 
        PDatum
      ] = js.native
    def join[K /* <: /* keyof d3-selection.anon.ElementTagNameMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 170, starting with typingsJapgolly.d3Selection.d3SelectionStrings.a, typingsJapgolly.d3Selection.d3SelectionStrings.abbr, typingsJapgolly.d3Selection.d3SelectionStrings.address */ Any */, OldDatum](
      enter: K,
      update: js.Function1[
