...
import typingsJapgolly.desmos.Desmos.ExpressionState
...
import typingsJapgolly.desmos.desmosStrings.expression
...
trait Color
  ...
  var dragMode: js.UndefOr[
    typingsJapgolly.desmos.desmosStrings.X | typingsJapgolly.desmos.desmosStrings.Y | typingsJapgolly.desmos.desmosStrings.XY | NONE | typingsJapgolly.desmos.desmosStrings.AUTO
  ] = js.undefined
  ...
  /**
    ...
    */
  var labelOrientation: js.UndefOr[typingsJapgolly.desmos.desmosStrings.ABOVE | BELOW | LEFT | RIGHT | DEFAULT] = js.undefined
  
  /**
    * Sets the size of a point's text label. See LabelSizes.
    */
  var labelSize: js.UndefOr[SMALL | MEDIUM | typingsJapgolly.desmos.desmosStrings.LARGE] = js.undefined
  ...
  var lineStyle: js.UndefOr[
    POINT | OPEN | typingsJapgolly.desmos.desmosStrings.CROSS | SOLID | DASHED | DOTTED
  ] = js.undefined
...
object Color {
  ...
  extension [Self <: Color](x: Self) {
    ...
    inline def setDragMode(
      value: typingsJapgolly.desmos.desmosStrings.X | typingsJapgolly.desmos.desmosStrings.Y | typingsJapgolly.desmos.desmosStrings.XY | NONE | typingsJapgolly.desmos.desmosStrings.AUTO
    ...
    inline def setLabelOrientation(value: typingsJapgolly.desmos.desmosStrings.ABOVE | BELOW | LEFT | RIGHT | DEFAULT): Self = StObject.set(x, "labelOrientation", value.asInstanceOf[js.Any])
    
    inline def setLabelOrientationUndefined: Self = StObject.set(x, "labelOrientation", js.undefined)
    
    inline def setLabelSize(value: SMALL | MEDIUM | typingsJapgolly.desmos.desmosStrings.LARGE): Self = StObject.set(x, "labelSize", value.asInstanceOf[js.Any])
    ...
    inline def setLineStyle(value: POINT | OPEN | typingsJapgolly.desmos.desmosStrings.CROSS | SOLID | DASHED | DOTTED): Self = StObject.set(x, "lineStyle", value.asInstanceOf[js.Any])
    ...
    inline def setPointStyle(value: POINT | OPEN | typingsJapgolly.desmos.desmosStrings.CROSS | SOLID | DASHED | DOTTED): Self = StObject.set(x, "pointStyle", value.asInstanceOf[js.Any])
