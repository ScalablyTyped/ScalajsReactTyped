...
import typingsJapgolly.deku.mod.Dispatch
import typingsJapgolly.deku.mod.Model
import typingsJapgolly.deku.mod.Render
import typingsJapgolly.deku.mod.Thunk
import typingsJapgolly.deku.mod.VirtualElement
...
object global {
  ...
  object deku {
    ...
    object diff {
      ...
      @js.native
      open class Actions ()
        extends typingsJapgolly.deku.mod.diff.Actions
      object Actions {
        ...
        /* static member */
        inline def `case`(pat: Any, action: typingsJapgolly.deku.mod.diff.Actions): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("case")(pat.asInstanceOf[js.Any], action.asInstanceOf[js.Any])).asInstanceOf[Any]
        
        /* static member */
        inline def insertBefore(a: Double): typingsJapgolly.deku.mod.diff.Actions = ^.asInstanceOf[js.Dynamic].applyDynamic("insertBefore")(a.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.deku.mod.diff.Actions]
        
        /* static member */
        inline def insertChild(a: Any, b: Double, c: String): typingsJapgolly.deku.mod.diff.Actions = (^.asInstanceOf[js.Dynamic].applyDynamic("insertChild")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], c.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.deku.mod.diff.Actions]
        
        /* static member */
        inline def removeAttribute(a: String, b: Any): typingsJapgolly.deku.mod.diff.Actions = (^.asInstanceOf[js.Dynamic].applyDynamic("removeAttribute")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.deku.mod.diff.Actions]
        
        /* static member */
        inline def removeChild(a: Double): typingsJapgolly.deku.mod.diff.Actions = ^.asInstanceOf[js.Dynamic].applyDynamic("removeChild")(a.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.deku.mod.diff.Actions]
        
        /* static member */
        inline def removeNode(a: Any): typingsJapgolly.deku.mod.diff.Actions = ^.asInstanceOf[js.Dynamic].applyDynamic("removeNode")(a.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.deku.mod.diff.Actions]
        
        /* static member */
        inline def replaceNode(a: Any, b: Any, c: String): typingsJapgolly.deku.mod.diff.Actions = (^.asInstanceOf[js.Dynamic].applyDynamic("replaceNode")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], c.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.deku.mod.diff.Actions]
        
        /* static member */
        inline def sameNode(): typingsJapgolly.deku.mod.diff.Actions = ^.asInstanceOf[js.Dynamic].applyDynamic("sameNode")().asInstanceOf[typingsJapgolly.deku.mod.diff.Actions]
        
        /* static member */
        inline def setAttribute(a: String, b: Any, c: Any): typingsJapgolly.deku.mod.diff.Actions = (^.asInstanceOf[js.Dynamic].applyDynamic("setAttribute")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], c.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.deku.mod.diff.Actions]
        
        /* static member */
        inline def updateChild(a: Double, b: js.Array[Any]): typingsJapgolly.deku.mod.diff.Actions = (^.asInstanceOf[js.Dynamic].applyDynamic("updateChild")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.deku.mod.diff.Actions]
        
        /* static member */
        inline def updateChildren(a: js.Array[Any]): typingsJapgolly.deku.mod.diff.Actions = ^.asInstanceOf[js.Dynamic].applyDynamic("updateChildren")(a.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.deku.mod.diff.Actions]
        
        /* static member */
        inline def updateThunk(a: Any, b: Any, c: String): typingsJapgolly.deku.mod.diff.Actions = (^.asInstanceOf[js.Dynamic].applyDynamic("updateThunk")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], c.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.deku.mod.diff.Actions]
      }
