...
@js.native
trait AreaRadial[Datum] extends js.Object {
  /**
  ...
  /**
    ...
    */
  @JSName("endAngle")
  def endAngle_This(): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def lineEndAngle(): LineRadial[Datum] = js.native
  /**
    * Returns a new radial line generator that has this radial area generator’s current defined accessor, curve and context.
    ...
    */
  def lineInnerRadius(): LineRadial[Datum] = js.native
  /**
    * Returns a new radial line generator that has this radial area generator’s current defined accessor, curve and context.
    ...
    */
  def lineOuterRadius(): LineRadial[Datum] = js.native
  /**
    * Returns a new radial line generator that has this radial area generator’s current defined accessor, curve and context.
    * The line’s angle accessor is this area’s start angle accessor, and the line’s radius accessor is this area’s inner radius accessor.
    */
  def lineStartAngle(): LineRadial[Datum] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("outerRadius")
  def outerRadius_This(): this.type = js.native
  /**
