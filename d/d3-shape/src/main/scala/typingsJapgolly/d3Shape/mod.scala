...
object mod {
  ...
  object CurveGenerator {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(areaEnd = areaEnd.toJsFn, areaStart = areaStart.toJsFn, lineEnd = lineEnd.toJsFn, lineStart = lineStart.toJsFn, point = js.Any.fromFunction2((t0: Double, t1: Double) => (point(t0, t1)).runNow()))
      __obj.asInstanceOf[CurveGenerator]
    }
    
    extension [Self <: CurveGenerator](x: Self) {
      
      inline def setAreaEnd(value: Callback): Self = StObject.set(x, "areaEnd", value.toJsFn)
      
      inline def setAreaStart(value: Callback): Self = StObject.set(x, "areaStart", value.toJsFn)
    }
  }
  ...
  object CurveGeneratorLineOnly {
    ...
    inline def apply(lineEnd: Callback, lineStart: Callback, point: (Double, Double) => Callback): CurveGeneratorLineOnly = {
      val __obj = js.Dynamic.literal(lineEnd = lineEnd.toJsFn, lineStart = lineStart.toJsFn, point = js.Any.fromFunction2((t0: Double, t1: Double) => (point(t0, t1)).runNow()))
      __obj.asInstanceOf[CurveGeneratorLineOnly]
    }
    
    extension [Self <: CurveGeneratorLineOnly](x: Self) {
      
      inline def setLineEnd(value: Callback): Self = StObject.set(x, "lineEnd", value.toJsFn)
      
      inline def setLineStart(value: Callback): Self = StObject.set(x, "lineStart", value.toJsFn)
      
      inline def setPoint(value: (Double, Double) => Callback): Self = StObject.set(x, "point", js.Any.fromFunction2((t0: Double, t1: Double) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object SymbolType {
    ...
    inline def apply(draw: (CanvasPathD3Shape, Double) => Callback): SymbolType = {
      val __obj = js.Dynamic.literal(draw = js.Any.fromFunction2((t0: CanvasPathD3Shape, t1: Double) => (draw(t0, t1)).runNow()))
      __obj.asInstanceOf[SymbolType]
    }
    
    extension [Self <: SymbolType](x: Self) {
      
      inline def setDraw(value: (CanvasPathD3Shape, Double) => Callback): Self = StObject.set(x, "draw", js.Any.fromFunction2((t0: CanvasPathD3Shape, t1: Double) => (value(t0, t1)).runNow()))
    }
  }
