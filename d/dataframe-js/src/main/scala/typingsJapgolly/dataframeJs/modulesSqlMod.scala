...
object modulesSqlMod {
  ...
  trait SQL extends StObject {
    ...
    /**
      ...
      * df.sql.register('tmp');
      */
    def register(tableName: String): typingsJapgolly.dataframeJs.dataframeMod.default = js.native
    def register(tableName: String, overwrite: Boolean): typingsJapgolly.dataframeJs.dataframeMod.default = js.native
  }
}
