...
object dataframeMod {
  ...
  trait DataFrame extends StObject {
    ...
    /**
      ...
      * df.find({'column1': 3})
      */
    def find(condition: js.Function0[typingsJapgolly.dataframeJs.rowMod.default | (Record[String, Any])]): typingsJapgolly.dataframeJs.rowMod.default = js.native
    ...
    /**
      ...
      * df2.getRow(1)
      */
    def getRow(): typingsJapgolly.dataframeJs.rowMod.default = js.native
    def getRow(index: Double): typingsJapgolly.dataframeJs.rowMod.default = js.native
    ...
    def push(rows: typingsJapgolly.dataframeJs.rowMod.default): DataFrame = js.native
