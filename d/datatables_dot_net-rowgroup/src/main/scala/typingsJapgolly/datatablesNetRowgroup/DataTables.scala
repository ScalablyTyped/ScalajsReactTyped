package typingsJapgolly.datatablesNetRowgroup
...
object DataTables {
  ...
  object Api {
    ...
    inline def apply(rowGroup: CallbackTo[RowGroupApi]): Api = {
      val __obj = js.Dynamic.literal(rowGroup = rowGroup.toJsFn)
      __obj.asInstanceOf[Api]
    }
    
    extension [Self <: Api](x: Self) {
      
      inline def setRowGroup(value: CallbackTo[RowGroupApi]): Self = StObject.set(x, "rowGroup", value.toJsFn)
    }
  }
