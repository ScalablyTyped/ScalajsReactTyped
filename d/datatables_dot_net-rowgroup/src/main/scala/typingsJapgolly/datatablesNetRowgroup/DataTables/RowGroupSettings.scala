...
object RowGroupSettings {
  ...
  def apply(
    ...
    endRender: (/* rows */ Api, /* group */ String) => CallbackTo[String | HTMLElement | JQuery] = null,
    startRender: (/* rows */ Api, /* group */ String) => CallbackTo[String | HTMLElement | JQuery] = null
  ): RowGroupSettings = {
    ...
    if (endRender != null) __obj.updateDynamic("endRender")(js.Any.fromFunction2((t0: /* rows */ typingsJapgolly.datatablesNetRowgroup.DataTables.Api, t1: /* group */ java.lang.String) => endRender(t0, t1).runNow()))
    if (startRender != null) __obj.updateDynamic("startRender")(js.Any.fromFunction2((t0: /* rows */ typingsJapgolly.datatablesNetRowgroup.DataTables.Api, t1: /* group */ java.lang.String) => startRender(t0, t1).runNow()))
