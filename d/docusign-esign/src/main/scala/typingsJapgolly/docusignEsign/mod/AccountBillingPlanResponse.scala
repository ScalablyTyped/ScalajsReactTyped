...
object AccountBillingPlanResponse {
  ...
  inline def apply(): AccountBillingPlanResponse = {
  ...
  extension [Self <: AccountBillingPlanResponse](x: Self) {
    ...
    inline def setBillingPlan(value: AccountBillingPlan): Self = StObject.set(x, "billingPlan", value.asInstanceOf[js.Any])
    
    inline def setBillingPlanUndefined: Self = StObject.set(x, "billingPlan", js.undefined)
    
    inline def setCreditCardInformation(value: CreditCardInformation): Self = StObject.set(x, "creditCardInformation", value.asInstanceOf[js.Any])
    
    inline def setCreditCardInformationUndefined: Self = StObject.set(x, "creditCardInformation", js.undefined)
    
    inline def setDirectDebitProcessorInformation(value: DirectDebitProcessorInformation): Self = StObject.set(x, "directDebitProcessorInformation", value.asInstanceOf[js.Any])
