...
trait Tabs extends StObject {
  ...
  /**
    ...
    */
  var listTabs: js.UndefOr[js.Array[typingsJapgolly.docusignEsign.mod.List]] = js.undefined
  ...
  /**
    ...
    */
  var numberTabs: js.UndefOr[js.Array[// tslint:disable-next-line: ban-types
  Number]] = js.undefined
...
object Tabs {
  ...
  extension [Self <: Tabs](x: Self) {
    ...
    inline def setListTabs(value: js.Array[typingsJapgolly.docusignEsign.mod.List]): Self = StObject.set(x, "listTabs", value.asInstanceOf[js.Any])
    
    inline def setListTabsUndefined: Self = StObject.set(x, "listTabs", js.undefined)
    
    inline def setListTabsVarargs(value: typingsJapgolly.docusignEsign.mod.List*): Self = StObject.set(x, "listTabs", js.Array(value*))
    ...
    inline def setNumberTabs(value: js.Array[// tslint:disable-next-line: ban-types
    ...
    inline def setNumberTabsVarargs(value: (// tslint:disable-next-line: ban-types
    Number)*): Self = StObject.set(x, "numberTabs", js.Array(value*))
