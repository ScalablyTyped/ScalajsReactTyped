...
trait TabGroup extends StObject {
  ...
  /**
    ...
    */
  var groupLabelMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.undefined
  
  /**
    * The rule that is selected by default when a user is adding validation for a tab group in the UI.
    */
  var groupRule: js.UndefOr[String] = js.undefined
  
  /**
    * Metadata that indicates whether the `groupRule` property is editable.
    */
  var groupRuleMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.undefined
  ...
  /**
    ...
    */
  var maximumAllowed: js.UndefOr[String] = js.undefined
  
  /**
    * Metadata that indicates whether the `maximumAllowed` property is editable.
    */
  var maximumAllowedMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.undefined
  ...
  /**
    ...
    */
  var minimumRequired: js.UndefOr[String] = js.undefined
  
  /**
    * Metadata that indicates whether the `minimumRequired` property is editable.
    */
  var minimumRequiredMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.undefined
  ...
  /**
    ...
    * - `envelope` (default)
    */
  var tabScope: js.UndefOr[String] = js.undefined
  
  /**
    * Metadata that indicates whether the `tabScope` property is editable.
    */
  var tabScopeMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.undefined
...
object TabGroup {
  ...
  extension [Self <: TabGroup](x: Self) {
    ...
    inline def setGroupLabelMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "groupLabelMetadata", value.asInstanceOf[js.Any])
    
    inline def setGroupLabelMetadataUndefined: Self = StObject.set(x, "groupLabelMetadata", js.undefined)
    
    inline def setGroupLabelUndefined: Self = StObject.set(x, "groupLabel", js.undefined)
    
    inline def setGroupRule(value: String): Self = StObject.set(x, "groupRule", value.asInstanceOf[js.Any])
    
    inline def setGroupRuleMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "groupRuleMetadata", value.asInstanceOf[js.Any])
    
    inline def setGroupRuleMetadataUndefined: Self = StObject.set(x, "groupRuleMetadata", js.undefined)
    ...
    inline def setMaximumAllowed(value: String): Self = StObject.set(x, "maximumAllowed", value.asInstanceOf[js.Any])
    
    inline def setMaximumAllowedMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "maximumAllowedMetadata", value.asInstanceOf[js.Any])
    
    inline def setMaximumAllowedMetadataUndefined: Self = StObject.set(x, "maximumAllowedMetadata", js.undefined)
    
    inline def setMaximumAllowedUndefined: Self = StObject.set(x, "maximumAllowed", js.undefined)
    ...
    inline def setMinimumRequired(value: String): Self = StObject.set(x, "minimumRequired", value.asInstanceOf[js.Any])
    
    inline def setMinimumRequiredMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "minimumRequiredMetadata", value.asInstanceOf[js.Any])
    
    inline def setMinimumRequiredMetadataUndefined: Self = StObject.set(x, "minimumRequiredMetadata", js.undefined)
    
    inline def setMinimumRequiredUndefined: Self = StObject.set(x, "minimumRequired", js.undefined)
    ...
    inline def setTabScope(value: String): Self = StObject.set(x, "tabScope", value.asInstanceOf[js.Any])
    
    inline def setTabScopeMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "tabScopeMetadata", value.asInstanceOf[js.Any])
    
    inline def setTabScopeMetadataUndefined: Self = StObject.set(x, "tabScopeMetadata", js.undefined)
    
    inline def setTabScopeUndefined: Self = StObject.set(x, "tabScope", js.undefined)
