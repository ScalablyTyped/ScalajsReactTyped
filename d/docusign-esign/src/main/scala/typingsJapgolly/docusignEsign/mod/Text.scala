...
trait Text extends StObject {
  ...
  /**
    ...
    */
  var formulaMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.undefined
  ...
  /**
    ...
    */
  var isPaymentAmount: js.UndefOr[String] = js.undefined
  
  /**
    * Metadata that indicates whether the `isPaymentAmount` property is editable.
    */
  var isPaymentAmountMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.undefined
...
object Text {
  ...
  extension [Self <: Text](x: Self) {
    ...
    inline def setFormulaMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "formulaMetadata", value.asInstanceOf[js.Any])
    
    inline def setFormulaMetadataUndefined: Self = StObject.set(x, "formulaMetadata", js.undefined)
    ...
    inline def setIsPaymentAmount(value: String): Self = StObject.set(x, "isPaymentAmount", value.asInstanceOf[js.Any])
    
    inline def setIsPaymentAmountMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "isPaymentAmountMetadata", value.asInstanceOf[js.Any])
    
    inline def setIsPaymentAmountMetadataUndefined: Self = StObject.set(x, "isPaymentAmountMetadata", js.undefined)
    
    inline def setIsPaymentAmountUndefined: Self = StObject.set(x, "isPaymentAmount", js.undefined)
