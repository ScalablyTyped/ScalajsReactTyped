...
@js.native
open class BillingApi () extends StObject {
  ...
  def getPlan(accountId: String, optsOrCallback: Any): js.Promise[AccountBillingPlanResponse] = js.native
  def getPlan(accountId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[AccountBillingPlanResponse] = js.native
  ...
  def listInvoices(accountId: String, optsOrCallback: Any): js.Promise[BillingInvoicesResponse] = js.native
  def listInvoices(accountId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[BillingInvoicesResponse] = js.native
  ...
  def listPayments(accountId: String, optsOrCallback: Any): js.Promise[BillingPaymentsResponse] = js.native
  def listPayments(accountId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[BillingPaymentsResponse] = js.native
  ...
  def makePayment(accountId: String, optsOrCallback: Any): js.Promise[BillingPaymentResponse] = js.native
  def makePayment(accountId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[BillingPaymentResponse] = js.native
  ...
  def purchaseEnvelopes(accountId: String, optsOrCallback: Any): js.Promise[Unit] = js.native
  def purchaseEnvelopes(accountId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[Unit] = js.native
  ...
  def updateDowngradeAccountBillingPlan(accountId: String, optsOrCallback: Any): js.Promise[DowngradePlanUpdateResponse] = js.native
  def updateDowngradeAccountBillingPlan(accountId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[DowngradePlanUpdateResponse] = js.native
  ...
  def updatePlan(accountId: String, optsOrCallback: Any): js.Promise[BillingPlanUpdateResponse] = js.native
  def updatePlan(accountId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[BillingPlanUpdateResponse] = js.native
