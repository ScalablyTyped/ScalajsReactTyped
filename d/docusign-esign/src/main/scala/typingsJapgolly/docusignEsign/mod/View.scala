...
trait View extends StObject {
  ...
  /**
    ...
    */
  var requiredRead: js.UndefOr[String] = js.undefined
...
object View {
  ...
  extension [Self <: View](x: Self) {
    ...
    inline def setRequiredRead(value: String): Self = StObject.set(x, "requiredRead", value.asInstanceOf[js.Any])
    
    inline def setRequiredReadUndefined: Self = StObject.set(x, "requiredRead", js.undefined)
