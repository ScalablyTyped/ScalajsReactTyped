...
object List {
  ...
  inline def apply(): typingsJapgolly.docusignEsign.mod.List = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[typingsJapgolly.docusignEsign.mod.List]
  }
  
  extension [Self <: typingsJapgolly.docusignEsign.mod.List](x: Self) {
