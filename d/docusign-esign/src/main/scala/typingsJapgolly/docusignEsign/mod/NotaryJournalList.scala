...
trait NotaryJournalList extends StObject {
  ...
  var notaryJournals: js.UndefOr[js.Array[NotaryJournal]] = js.undefined
...
object NotaryJournalList {
  ...
  inline def apply(): NotaryJournalList = {
  ...
  extension [Self <: NotaryJournalList](x: Self) {
    ...
    inline def setNotaryJournals(value: js.Array[NotaryJournal]): Self = StObject.set(x, "notaryJournals", value.asInstanceOf[js.Any])
