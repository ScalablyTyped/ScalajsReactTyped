...
trait UserInformationList extends StObject {
...
object UserInformationList {
  ...
  inline def apply(): UserInformationList = {
  ...
  extension [Self <: UserInformationList](x: Self) {
    ...
    inline def setUsersVarargs(value: UserInformation*): Self = StObject.set(x, "users", js.Array(value*))
  }
}
