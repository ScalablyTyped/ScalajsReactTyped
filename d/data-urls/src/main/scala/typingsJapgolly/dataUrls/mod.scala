...
object mod {
  ...
  trait DataURL extends StObject {
    ...
    var mimeType: typingsJapgolly.whatwgMimetype.mod.^
  }
  object DataURL {
    
    inline def apply(body: js.typedarray.Uint8Array, mimeType: typingsJapgolly.whatwgMimetype.mod.^): DataURL = {
    ...
    extension [Self <: DataURL](x: Self) {
      ...
      inline def setMimeType(value: typingsJapgolly.whatwgMimetype.mod.^): Self = StObject.set(x, "mimeType", value.asInstanceOf[js.Any])
    }
  }
}
