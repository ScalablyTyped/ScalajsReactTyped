...
import typingsJapgolly.dompurify.dompurifyBooleans.`true`
...
trait ConfigRETURNDOMFRAGMENTtr extends js.Object {
  ...
  var RETURN_DOM_FRAGMENT: js.UndefOr[Boolean with `true`] = js.undefined
...
object ConfigRETURNDOMFRAGMENTtr {
  ...
  def apply(
    ...
    RETURN_DOM_FRAGMENT: js.UndefOr[Boolean with `true`] = js.undefined,
