...
object StaticRouter {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[StaticRouterProps, typingsJapgolly.dva.routerMod.StaticRouter, Unit, StaticRouterProps] = {
  ...
  typingsJapgolly.dva.routerMod.StaticRouter](this.componentImport)
