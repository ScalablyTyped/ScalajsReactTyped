...
object NavLink {
  def apply[S](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[NavLinkProps[S], typingsJapgolly.dva.routerMod.NavLink[S], Unit, NavLinkProps[S]] = {
  ...
  typingsJapgolly.dva.routerMod.NavLink[S]](this.componentImport)
