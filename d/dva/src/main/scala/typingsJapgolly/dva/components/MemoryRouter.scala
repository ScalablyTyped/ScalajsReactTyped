...
object MemoryRouter {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MemoryRouterProps, typingsJapgolly.dva.routerMod.MemoryRouter, Unit, MemoryRouterProps] = {
  ...
  typingsJapgolly.dva.routerMod.MemoryRouter](this.componentImport)
