...
object PlayerOptions {
  ...
  def apply(
    ...
    onload: /* state */ PlayerState => Callback = null,
    ...
    if (onload != null) __obj.updateDynamic("onload")(js.Any.fromFunction1((t0: /* state */ typingsJapgolly.deezerSdk.DeezerSdk.PlayerState) => onload(t0).runNow()))
