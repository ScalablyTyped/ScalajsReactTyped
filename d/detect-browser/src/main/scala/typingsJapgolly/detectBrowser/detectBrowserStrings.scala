...
import typingsJapgolly.detectBrowser.mod.Browser
import typingsJapgolly.detectBrowser.mod.DetectedInfoType
import typingsJapgolly.detectBrowser.mod.OperatingSystem
