...
object mod {
  ...
  @JSImport("domexception", "ABORT_ERR")
  @js.native
  ...
  open class Class ()
    ...
    def this(message: String, name: String) = this()
    def this(message: Unit, name: String) = this()
  ...
  @JSImport("domexception", "DATA_CLONE_ERR")
  @js.native
  val DATA_CLONE_ERR: Double = js.native
  
  @JSImport("domexception", "DOMSTRING_SIZE_ERR")
  @js.native
  val DOMSTRING_SIZE_ERR: Double = js.native
  
  @JSImport("domexception", "HIERARCHY_REQUEST_ERR")
  @js.native
  val HIERARCHY_REQUEST_ERR: Double = js.native
  
  @JSImport("domexception", "INDEX_SIZE_ERR")
  @js.native
  val INDEX_SIZE_ERR: Double = js.native
  
  @JSImport("domexception", "INUSE_ATTRIBUTE_ERR")
  @js.native
  val INUSE_ATTRIBUTE_ERR: Double = js.native
  
  @JSImport("domexception", "INVALID_ACCESS_ERR")
  @js.native
  val INVALID_ACCESS_ERR: Double = js.native
  
  @JSImport("domexception", "INVALID_CHARACTER_ERR")
  @js.native
  val INVALID_CHARACTER_ERR: Double = js.native
  
  @JSImport("domexception", "INVALID_MODIFICATION_ERR")
  @js.native
  val INVALID_MODIFICATION_ERR: Double = js.native
  
  @JSImport("domexception", "INVALID_NODE_TYPE_ERR")
  @js.native
  val INVALID_NODE_TYPE_ERR: Double = js.native
  
  @JSImport("domexception", "INVALID_STATE_ERR")
  @js.native
  val INVALID_STATE_ERR: Double = js.native
  
  @JSImport("domexception", "NAMESPACE_ERR")
  @js.native
  val NAMESPACE_ERR: Double = js.native
  
  @JSImport("domexception", "NETWORK_ERR")
  @js.native
  val NETWORK_ERR: Double = js.native
  
  @JSImport("domexception", "NOT_FOUND_ERR")
  @js.native
  val NOT_FOUND_ERR: Double = js.native
  
  @JSImport("domexception", "NOT_SUPPORTED_ERR")
  @js.native
  val NOT_SUPPORTED_ERR: Double = js.native
  
  @JSImport("domexception", "NO_DATA_ALLOWED_ERR")
  @js.native
  val NO_DATA_ALLOWED_ERR: Double = js.native
  
  @JSImport("domexception", "NO_MODIFICATION_ALLOWED_ERR")
  @js.native
  val NO_MODIFICATION_ALLOWED_ERR: Double = js.native
  
  @JSImport("domexception", "QUOTA_EXCEEDED_ERR")
  @js.native
  val QUOTA_EXCEEDED_ERR: Double = js.native
  
  @JSImport("domexception", "SECURITY_ERR")
  @js.native
  val SECURITY_ERR: Double = js.native
  
  @JSImport("domexception", "SYNTAX_ERR")
  @js.native
  val SYNTAX_ERR: Double = js.native
  
  @JSImport("domexception", "TIMEOUT_ERR")
  @js.native
  val TIMEOUT_ERR: Double = js.native
  
  @JSImport("domexception", "TYPE_MISMATCH_ERR")
  @js.native
  val TYPE_MISMATCH_ERR: Double = js.native
  
  @JSImport("domexception", "URL_MISMATCH_ERR")
  @js.native
  val URL_MISMATCH_ERR: Double = js.native
  
  @JSImport("domexception", "VALIDATION_ERR")
  @js.native
  val VALIDATION_ERR: Double = js.native
  
  @JSImport("domexception", "WRONG_DOCUMENT_ERR")
  @js.native
  val WRONG_DOCUMENT_ERR: Double = js.native
  
  // Type from: https://github.com/microsoft/TypeScript/blob/main/src/lib/dom.generated.d.ts
  /**
