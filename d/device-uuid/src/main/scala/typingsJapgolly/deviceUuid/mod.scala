package typingsJapgolly.deviceUuid

import typingsJapgolly.deviceUuid.deviceUuidBooleans.`false`
import typingsJapgolly.deviceUuid.deviceUuidStrings.CaptiveNetwork
import typingsJapgolly.deviceUuid.deviceUuidStrings.Silk
...
object mod {
  ...
  open class DeviceUUID () extends StObject {
    ...
    var Agent: typingsJapgolly.deviceUuid.mod.Agent = js.native
