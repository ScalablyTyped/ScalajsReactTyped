...
object bxSliderOptions {
  ...
  extension [Self <: bxSliderOptions](x: Self) {
    ...
    inline def setBuildPager(value: /* slideIndex */ Double => Callback): Self = StObject.set(x, "buildPager", js.Any.fromFunction1((t0: /* slideIndex */ Double) => value(t0).runNow()))
    ...
    inline def setOnSlideAfter(
      value: (/* $slideElement */ js.UndefOr[JQuery], /* oldIndex */ js.UndefOr[Double], /* newIndex */ js.UndefOr[Double]) => Callback
    ): Self = StObject.set(x, "onSlideAfter", js.Any.fromFunction3((t0: /* $slideElement */ js.UndefOr[JQuery], t1: /* oldIndex */ js.UndefOr[Double], t2: /* newIndex */ js.UndefOr[Double]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnSlideAfterUndefined: Self = StObject.set(x, "onSlideAfter", js.undefined)
    
    inline def setOnSlideBefore(
      value: (/* $slideElement */ js.UndefOr[JQuery], /* oldIndex */ js.UndefOr[Double], /* newIndex */ js.UndefOr[Double]) => Callback
    ): Self = StObject.set(x, "onSlideBefore", js.Any.fromFunction3((t0: /* $slideElement */ js.UndefOr[JQuery], t1: /* oldIndex */ js.UndefOr[Double], t2: /* newIndex */ js.UndefOr[Double]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnSlideBeforeUndefined: Self = StObject.set(x, "onSlideBefore", js.undefined)
    
    inline def setOnSlideNext(
      value: (/* $slideElement */ js.UndefOr[JQuery], /* oldIndex */ js.UndefOr[Double], /* newIndex */ js.UndefOr[Double]) => Callback
    ): Self = StObject.set(x, "onSlideNext", js.Any.fromFunction3((t0: /* $slideElement */ js.UndefOr[JQuery], t1: /* oldIndex */ js.UndefOr[Double], t2: /* newIndex */ js.UndefOr[Double]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnSlideNextUndefined: Self = StObject.set(x, "onSlideNext", js.undefined)
    
    inline def setOnSlidePrev(
      value: (/* $slideElement */ js.UndefOr[JQuery], /* oldIndex */ js.UndefOr[Double], /* newIndex */ js.UndefOr[Double]) => Callback
    ): Self = StObject.set(x, "onSlidePrev", js.Any.fromFunction3((t0: /* $slideElement */ js.UndefOr[JQuery], t1: /* oldIndex */ js.UndefOr[Double], t2: /* newIndex */ js.UndefOr[Double]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnSlidePrevUndefined: Self = StObject.set(x, "onSlidePrev", js.undefined)
    
    inline def setOnSliderLoad(value: /* currentIndex */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "onSliderLoad", js.Any.fromFunction1((t0: /* currentIndex */ js.UndefOr[Double]) => value(t0).runNow()))
    
    inline def setOnSliderLoadUndefined: Self = StObject.set(x, "onSliderLoad", js.undefined)
    
    inline def setOnSliderResize(value: /* currentIndex */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "onSliderResize", js.Any.fromFunction1((t0: /* currentIndex */ js.UndefOr[Double]) => value(t0).runNow()))
