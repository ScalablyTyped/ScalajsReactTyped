...
object bxSliderOptions {
  ...
  def apply(
    ...
    buildPager: /* slideIndex */ Double => Callback = null,
    ...
    onSlideAfter: (/* $slideElement */ js.UndefOr[JQuery], /* oldIndex */ js.UndefOr[Double], /* newIndex */ js.UndefOr[Double]) => Callback = null,
    onSlideBefore: (/* $slideElement */ js.UndefOr[JQuery], /* oldIndex */ js.UndefOr[Double], /* newIndex */ js.UndefOr[Double]) => Callback = null,
    onSlideNext: (/* $slideElement */ js.UndefOr[JQuery], /* oldIndex */ js.UndefOr[Double], /* newIndex */ js.UndefOr[Double]) => Callback = null,
    onSlidePrev: (/* $slideElement */ js.UndefOr[JQuery], /* oldIndex */ js.UndefOr[Double], /* newIndex */ js.UndefOr[Double]) => Callback = null,
    onSliderLoad: /* currentIndex */ js.UndefOr[Double] => Callback = null,
    onSliderResize: /* currentIndex */ js.UndefOr[Double] => Callback = null,
    ...
    if (buildPager != null) __obj.updateDynamic("buildPager")(js.Any.fromFunction1((t0: /* slideIndex */ scala.Double) => buildPager(t0).runNow()))
    ...
    if (onSlideAfter != null) __obj.updateDynamic("onSlideAfter")(js.Any.fromFunction3((t0: /* $slideElement */ js.UndefOr[typingsJapgolly.dwBxslider4.JQuery], t1: /* oldIndex */ js.UndefOr[scala.Double], t2: /* newIndex */ js.UndefOr[scala.Double]) => onSlideAfter(t0, t1, t2).runNow()))
    if (onSlideBefore != null) __obj.updateDynamic("onSlideBefore")(js.Any.fromFunction3((t0: /* $slideElement */ js.UndefOr[typingsJapgolly.dwBxslider4.JQuery], t1: /* oldIndex */ js.UndefOr[scala.Double], t2: /* newIndex */ js.UndefOr[scala.Double]) => onSlideBefore(t0, t1, t2).runNow()))
    if (onSlideNext != null) __obj.updateDynamic("onSlideNext")(js.Any.fromFunction3((t0: /* $slideElement */ js.UndefOr[typingsJapgolly.dwBxslider4.JQuery], t1: /* oldIndex */ js.UndefOr[scala.Double], t2: /* newIndex */ js.UndefOr[scala.Double]) => onSlideNext(t0, t1, t2).runNow()))
    if (onSlidePrev != null) __obj.updateDynamic("onSlidePrev")(js.Any.fromFunction3((t0: /* $slideElement */ js.UndefOr[typingsJapgolly.dwBxslider4.JQuery], t1: /* oldIndex */ js.UndefOr[scala.Double], t2: /* newIndex */ js.UndefOr[scala.Double]) => onSlidePrev(t0, t1, t2).runNow()))
    if (onSliderLoad != null) __obj.updateDynamic("onSliderLoad")(js.Any.fromFunction1((t0: /* currentIndex */ js.UndefOr[scala.Double]) => onSliderLoad(t0).runNow()))
    if (onSliderResize != null) __obj.updateDynamic("onSliderResize")(js.Any.fromFunction1((t0: /* currentIndex */ js.UndefOr[scala.Double]) => onSliderResize(t0).runNow()))
