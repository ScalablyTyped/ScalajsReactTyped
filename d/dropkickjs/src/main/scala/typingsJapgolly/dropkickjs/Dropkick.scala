...
class Dropkick protected () extends js.Object {
  ...
  def add(value: typingsJapgolly.std.Node): Unit = js.native
  def add(value: typingsJapgolly.std.Node, before: String): Unit = js.native
  def add(value: typingsJapgolly.std.Node, before: Double): Unit = js.native
