...
import typingsJapgolly.doublearray.anon.All
...
object doublearray {
  ...
  object DoubleArray {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(bc = bc.asInstanceOf[js.Any], calc = calc.toJsFn, commonPrefixSearch = js.Any.fromFunction1(commonPrefixSearch), contain = js.Any.fromFunction1(contain), dump = dump.toJsFn, lookup = js.Any.fromFunction1(lookup), size = size.toJsFn, traverse = js.Any.fromFunction2(traverse))
    ...
    extension [Self <: DoubleArray](x: Self) {
      ...
      inline def setCalc(value: CallbackTo[All]): Self = StObject.set(x, "calc", value.toJsFn)
