package typingsJapgolly.duoWebSdk.mod
...
object InitOptions {
  ...
  def apply(
    ...
    submit_callback: /* duo_form */ HTMLFormElement => Callback = null
  ): InitOptions = {
    ...
    if (submit_callback != null) __obj.updateDynamic("submit_callback")(js.Any.fromFunction1((t0: /* duo_form */ org.scalajs.dom.raw.HTMLFormElement) => submit_callback(t0).runNow()))
