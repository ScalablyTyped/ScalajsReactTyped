package typingsJapgolly.duoWebSdk
...
object mod {
  ...
  inline def isDuoMessage(event: MessageEvent): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("_isDuoMessage")(event.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  object InitOptions {
    ...
    extension [Self <: InitOptions](x: Self) {
      ...
      inline def setSubmit_callback(value: /* duo_form */ HTMLFormElement => Callback): Self = StObject.set(x, "submit_callback", js.Any.fromFunction1((t0: /* duo_form */ HTMLFormElement) => value(t0).runNow()))
