...
import typingsJapgolly.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Sessions.DetectIntentCallback
import typingsJapgolly.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Sessions.StreamingDetectIntentCallback
