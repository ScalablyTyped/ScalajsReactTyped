...
/**
  ...
  */
open class ListEntityTypesRequest ()
  extends StObject
...
object ListEntityTypesRequest {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): ListEntityTypesRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ListEntityTypesRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): ListEntityTypesRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ListEntityTypesRequest]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): ListEntityTypesRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ListEntityTypesRequest]
  /**
  ...
  /**
    ...
    */
  /* static member */
  inline def fromObject(`object`: StringDictionary[Any]): ListEntityTypesRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ListEntityTypesRequest]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: ListEntityTypesRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: ListEntityTypesRequest, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
