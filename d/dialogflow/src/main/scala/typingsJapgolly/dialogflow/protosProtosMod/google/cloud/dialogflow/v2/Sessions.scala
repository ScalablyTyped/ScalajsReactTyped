...
import typingsJapgolly.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.Sessions.DetectIntentCallback
import typingsJapgolly.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.Sessions.StreamingDetectIntentCallback
