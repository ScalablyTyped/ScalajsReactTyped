...
import typingsJapgolly.dialogflow.protosProtosMod.google.protobuf.SourceCodeInfo.ILocation
...
object SourceCodeInfo {
  ...
  object Location {
    ...
    /**
      ...
      */
    /* static member */
    inline def create(): org.scalajs.dom.Location = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[org.scalajs.dom.Location]
    inline def create(properties: ILocation): org.scalajs.dom.Location = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[org.scalajs.dom.Location]
    
    inline def decode(reader: js.typedarray.Uint8Array): org.scalajs.dom.Location = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[org.scalajs.dom.Location]
    inline def decode(reader: js.typedarray.Uint8Array, length: Double): org.scalajs.dom.Location = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[org.scalajs.dom.Location]
    /**
      ...
      */
    /* static member */
    inline def decode(reader: Reader): org.scalajs.dom.Location = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[org.scalajs.dom.Location]
    inline def decode(reader: Reader, length: Double): org.scalajs.dom.Location = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[org.scalajs.dom.Location]
    
    inline def decodeDelimited(reader: js.typedarray.Uint8Array): org.scalajs.dom.Location = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[org.scalajs.dom.Location]
    /**
      ...
      */
    /* static member */
    inline def decodeDelimited(reader: Reader): org.scalajs.dom.Location = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[org.scalajs.dom.Location]
    ...
    /**
      ...
      */
    /* static member */
    inline def fromObject(`object`: StringDictionary[scala.Any]): org.scalajs.dom.Location = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[org.scalajs.dom.Location]
    ...
    /**
      ...
      */
    /* static member */
    inline def toObject(message: org.scalajs.dom.Location): StringDictionary[scala.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[scala.Any]]
    inline def toObject(message: org.scalajs.dom.Location, options: IConversionOptions): StringDictionary[scala.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[scala.Any]]
