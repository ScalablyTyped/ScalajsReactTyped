...
object FileOptions {
  ...
  object OptimizeMode extends StObject {
    ...
    sealed trait CODE_SIZE
      extends StObject
         with OptimizeMode
    /* 2 */ val CODE_SIZE: typingsJapgolly.dialogflow.protosProtosMod.google.protobuf.FileOptions.OptimizeMode.CODE_SIZE & Double = js.native
    
    @js.native
    sealed trait LITE_RUNTIME
      extends StObject
         with OptimizeMode
    /* 3 */ val LITE_RUNTIME: typingsJapgolly.dialogflow.protosProtosMod.google.protobuf.FileOptions.OptimizeMode.LITE_RUNTIME & Double = js.native
    
    @js.native
    sealed trait SPEED
      extends StObject
         with OptimizeMode
    /* 1 */ val SPEED: typingsJapgolly.dialogflow.protosProtosMod.google.protobuf.FileOptions.OptimizeMode.SPEED & Double = js.native
  }
