...
import typingsJapgolly.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.EntityType.AutoExpansionMode
import typingsJapgolly.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.EntityType.IEntity
import typingsJapgolly.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.EntityType.Kind
...
object EntityType {
  ...
  object AutoExpansionMode extends StObject {
    ...
    /* 1 */ val AUTO_EXPANSION_MODE_DEFAULT: typingsJapgolly.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.EntityType.AutoExpansionMode.AUTO_EXPANSION_MODE_DEFAULT & Double = js.native
    
    @js.native
    sealed trait AUTO_EXPANSION_MODE_UNSPECIFIED
      extends StObject
         with AutoExpansionMode
    /* 0 */ val AUTO_EXPANSION_MODE_UNSPECIFIED: typingsJapgolly.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.EntityType.AutoExpansionMode.AUTO_EXPANSION_MODE_UNSPECIFIED & Double = js.native
  }
  ...
  object Kind extends StObject {
    ...
    sealed trait KIND_LIST
      extends StObject
         with Kind
    /* 2 */ val KIND_LIST: typingsJapgolly.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.EntityType.Kind.KIND_LIST & Double = js.native
    
    @js.native
    sealed trait KIND_MAP
      extends StObject
         with Kind
    /* 1 */ val KIND_MAP: typingsJapgolly.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.EntityType.Kind.KIND_MAP & Double = js.native
    
    @js.native
    sealed trait KIND_REGEXP
      extends StObject
         with Kind
    /* 3 */ val KIND_REGEXP: typingsJapgolly.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.EntityType.Kind.KIND_REGEXP & Double = js.native
    
    @js.native
    sealed trait KIND_UNSPECIFIED
      extends StObject
         with Kind
    /* 0 */ val KIND_UNSPECIFIED: typingsJapgolly.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.EntityType.Kind.KIND_UNSPECIFIED & Double = js.native
  }
