...
object IAgent {
  ...
  extension [Self <: IAgent](x: Self) {
    ...
    inline def setMatchMode(
      value: MatchMode | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.Agent.MatchMode * / any */ String)
    ...
    inline def setTier(
      value: Tier | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.Agent.Tier * / any */ String)
