...
import typingsJapgolly.dialogflow.protosProtosMod.google.api.IResourceDescriptor
import typingsJapgolly.dialogflow.protosProtosMod.google.protobuf.FileOptions.OptimizeMode
