...
/**
  ...
  */
open class GetKnowledgeBaseRequest ()
  extends StObject
...
object GetKnowledgeBaseRequest {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): GetKnowledgeBaseRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[GetKnowledgeBaseRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): GetKnowledgeBaseRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[GetKnowledgeBaseRequest]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): GetKnowledgeBaseRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[GetKnowledgeBaseRequest]
  /**
  ...
  /**
    ...
    */
  /* static member */
  inline def fromObject(`object`: StringDictionary[Any]): GetKnowledgeBaseRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[GetKnowledgeBaseRequest]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: GetKnowledgeBaseRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: GetKnowledgeBaseRequest, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
