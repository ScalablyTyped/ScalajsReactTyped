...
import typingsJapgolly.dialogflow.protosProtosMod.google.api.IHttpRule
import typingsJapgolly.dialogflow.protosProtosMod.google.longrunning.IOperationInfo
