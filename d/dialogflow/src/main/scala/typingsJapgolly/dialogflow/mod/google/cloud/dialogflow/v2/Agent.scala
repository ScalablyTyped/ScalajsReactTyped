...
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.Agent.ApiVersion
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.Agent.MatchMode
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.Agent.Tier
