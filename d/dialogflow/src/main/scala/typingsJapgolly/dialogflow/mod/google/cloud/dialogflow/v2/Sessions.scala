...
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.Sessions.DetectIntentCallback
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.Sessions.StreamingDetectIntentCallback
