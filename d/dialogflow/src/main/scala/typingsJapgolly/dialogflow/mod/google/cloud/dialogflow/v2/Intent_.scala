...
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.Intent.IFollowupIntentInfo
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.Intent.IMessage
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.Intent.IParameter
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.Intent.ITrainingPhrase
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.Intent.Message.Platform
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.Intent.WebhookState
